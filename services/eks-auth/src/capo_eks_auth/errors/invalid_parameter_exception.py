"""Generated from Smithy shape ``com.amazonaws.eksauth#InvalidParameterException``."""
...
class InvalidParameterException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.eksauth#InvalidParameterException``."""
