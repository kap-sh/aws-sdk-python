...
class AssumeRoleForPodIdentityResponse(TypedDict):
    ...
    pod_identity_association: "aws_sdk_eks_auth.types.pod_identity_association.PodIdentityAssociation"
...
def serialize_json(value: AssumeRoleForPodIdentityResponse) -> dict:
    ...
    import aws_sdk_eks_auth.types.pod_identity_association
    out["podIdentityAssociation"] = aws_sdk_eks_auth.types.pod_identity_association.serialize_json(value["pod_identity_association"])
    import aws_sdk_eks_auth.types.assumed_role_user
    out["assumedRoleUser"] = aws_sdk_eks_auth.types.assumed_role_user.serialize_json(value["assumed_role_user"])
    import aws_sdk_eks_auth.types.credentials
    out["credentials"] = aws_sdk_eks_auth.types.credentials.serialize_json(value["credentials"])
    return out
...
def deserialize_json(data: dict) -> AssumeRoleForPodIdentityResponse:
    ...
    if "subject" in data:
        import aws_sdk_eks_auth.types.subject
        out["subject"] = aws_sdk_eks_auth.types.subject.deserialize_json(data["subject"])
    else:
    ...
    if "podIdentityAssociation" in data:
        import aws_sdk_eks_auth.types.pod_identity_association
        out["pod_identity_association"] = aws_sdk_eks_auth.types.pod_identity_association.deserialize_json(data["podIdentityAssociation"])
    else:
        raise DeserializationError("AssumeRoleForPodIdentityResponse.pod_identity_association required")
    if "assumedRoleUser" in data:
        import aws_sdk_eks_auth.types.assumed_role_user
        out["assumed_role_user"] = aws_sdk_eks_auth.types.assumed_role_user.deserialize_json(data["assumedRoleUser"])
    else:
        raise DeserializationError("AssumeRoleForPodIdentityResponse.assumed_role_user required")
    if "credentials" in data:
        import aws_sdk_eks_auth.types.credentials
        out["credentials"] = aws_sdk_eks_auth.types.credentials.deserialize_json(data["credentials"])
    else:
        raise DeserializationError("AssumeRoleForPodIdentityResponse.credentials required")
    return out