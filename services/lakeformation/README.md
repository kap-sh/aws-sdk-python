...
```
pip install aws-sdk-lakeformation
```

## Usage

```python
from aws_sdk_lakeformation import AsyncLakeFormationClient
...
```python
from aws_sdk_lakeformation import AsyncLakeFormationClient
from aws_sdk_lakeformation.error import AccessDeniedException
