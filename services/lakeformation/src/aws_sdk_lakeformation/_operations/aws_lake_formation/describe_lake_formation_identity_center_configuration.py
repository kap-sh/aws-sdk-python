...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.describe_lake_formation_identity_center_configuration_response.DescribeLakeFormationIdentityCenterConfigurationResponse = aws_sdk_lakeformation.types.describe_lake_formation_identity_center_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.describe_lake_formation_identity_center_configuration_request.DescribeLakeFormationIdentityCenterConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.describe_lake_formation_identity_center_configuration_request.serialize_json(
            input_
        )
    ).encode()
