...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.describe_lake_formation_identity_center_configuration_request.DescribeLakeFormationIdentityCenterConfigurationRequest,
) -> zapros.Request:
