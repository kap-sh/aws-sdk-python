...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.delete_lf_tag_response.DeleteLFTagResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.delete_lf_tag_request.DeleteLFTagRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.delete_lf_tag_request.serialize_json(input)
    ).encode()
