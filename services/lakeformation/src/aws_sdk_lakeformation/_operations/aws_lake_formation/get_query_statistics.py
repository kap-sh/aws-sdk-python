...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.get_query_statistics_request.GetQueryStatisticsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_query_statistics_request.serialize_json(input)
    ).encode()
