...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.start_query_planning_response.StartQueryPlanningResponse = aws_sdk_lakeformation.types.start_query_planning_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.start_query_planning_request.StartQueryPlanningRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.start_query_planning_request.serialize_json(input_)
    ).encode()
