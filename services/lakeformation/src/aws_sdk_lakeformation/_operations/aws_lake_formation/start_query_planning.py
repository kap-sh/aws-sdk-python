...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.start_query_planning_request.StartQueryPlanningRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.start_query_planning_request.serialize_json(input)
    ).encode()
