...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.grant_permissions_response.GrantPermissionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.grant_permissions_request.GrantPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.grant_permissions_request.serialize_json(input_)
    ).encode()
