...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.grant_permissions_request.GrantPermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.grant_permissions_request.serialize_json(input)
    ).encode()
