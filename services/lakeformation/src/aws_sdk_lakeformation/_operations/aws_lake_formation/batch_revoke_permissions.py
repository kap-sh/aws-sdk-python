...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.batch_revoke_permissions_response.BatchRevokePermissionsResponse = aws_sdk_lakeformation.types.batch_revoke_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.batch_revoke_permissions_request.BatchRevokePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.batch_revoke_permissions_request.serialize_json(
            input_
        )
    ).encode()
