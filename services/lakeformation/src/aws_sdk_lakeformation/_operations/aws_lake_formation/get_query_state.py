...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.get_query_state_response.GetQueryStateResponse = (
        aws_sdk_lakeformation.types.get_query_state_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.get_query_state_request.GetQueryStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_query_state_request.serialize_json(input_)
    ).encode()
