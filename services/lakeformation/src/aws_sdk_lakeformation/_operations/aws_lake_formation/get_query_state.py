...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.get_query_state_request.GetQueryStateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_query_state_request.serialize_json(input)
    ).encode()
