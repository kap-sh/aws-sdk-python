...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.add_lf_tags_to_resource_request.AddLFTagsToResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.add_lf_tags_to_resource_request.serialize_json(
            input_
        )
    ).encode()
