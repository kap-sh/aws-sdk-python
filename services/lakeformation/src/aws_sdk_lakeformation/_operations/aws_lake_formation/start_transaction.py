...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.start_transaction_response.StartTransactionResponse = aws_sdk_lakeformation.types.start_transaction_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.start_transaction_request.StartTransactionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.start_transaction_request.serialize_json(input)
    ).encode()
