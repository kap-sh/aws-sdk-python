...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AlreadyExistsException":
            import aws_sdk_lakeformation.errors.already_exists_exception

            raise aws_sdk_lakeformation.errors.already_exists_exception.AlreadyExistsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.create_lake_formation_identity_center_configuration_response.CreateLakeFormationIdentityCenterConfigurationResponse = aws_sdk_lakeformation.types.create_lake_formation_identity_center_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.create_lake_formation_identity_center_configuration_request.CreateLakeFormationIdentityCenterConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.create_lake_formation_identity_center_configuration_request.serialize_json(
            input_
        )
    ).encode()
