...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.get_data_lake_settings_response.GetDataLakeSettingsResponse = aws_sdk_lakeformation.types.get_data_lake_settings_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.get_data_lake_settings_request.GetDataLakeSettingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_data_lake_settings_request.serialize_json(input)
    ).encode()
