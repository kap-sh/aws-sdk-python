...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.list_permissions_response.ListPermissionsResponse = aws_sdk_lakeformation.types.list_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.list_permissions_request.ListPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.list_permissions_request.serialize_json(input_)
    ).encode()
