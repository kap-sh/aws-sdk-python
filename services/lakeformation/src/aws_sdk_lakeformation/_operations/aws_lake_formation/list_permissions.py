...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.list_permissions_request.ListPermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.list_permissions_request.serialize_json(input)
    ).encode()
