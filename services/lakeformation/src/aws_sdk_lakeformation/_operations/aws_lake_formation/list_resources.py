...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.list_resources_response.ListResourcesResponse = (
        aws_sdk_lakeformation.types.list_resources_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.list_resources_request.ListResourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.list_resources_request.serialize_json(input)
    ).encode()
