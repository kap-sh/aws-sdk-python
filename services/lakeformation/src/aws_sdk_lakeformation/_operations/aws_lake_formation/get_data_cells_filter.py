...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.get_data_cells_filter_request.GetDataCellsFilterRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_data_cells_filter_request.serialize_json(input)
    ).encode()
