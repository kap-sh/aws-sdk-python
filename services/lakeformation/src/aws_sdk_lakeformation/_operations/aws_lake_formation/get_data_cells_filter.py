...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.get_data_cells_filter_response.GetDataCellsFilterResponse = aws_sdk_lakeformation.types.get_data_cells_filter_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.get_data_cells_filter_request.GetDataCellsFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_data_cells_filter_request.serialize_json(input_)
    ).encode()
