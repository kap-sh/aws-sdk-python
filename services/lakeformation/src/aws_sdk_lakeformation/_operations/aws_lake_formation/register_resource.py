...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.register_resource_request.RegisterResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.register_resource_request.serialize_json(input)
    ).encode()
