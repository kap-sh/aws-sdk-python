...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.list_lake_formation_opt_ins_response.ListLakeFormationOptInsResponse = aws_sdk_lakeformation.types.list_lake_formation_opt_ins_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.list_lake_formation_opt_ins_request.ListLakeFormationOptInsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
