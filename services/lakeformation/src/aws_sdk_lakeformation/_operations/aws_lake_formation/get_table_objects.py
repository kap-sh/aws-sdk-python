...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.get_table_objects_request.GetTableObjectsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_table_objects_request.serialize_json(input)
    ).encode()
