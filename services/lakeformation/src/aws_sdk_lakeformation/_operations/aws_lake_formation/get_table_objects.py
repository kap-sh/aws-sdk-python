...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotReadyException":
            import aws_sdk_lakeformation.errors.resource_not_ready_exception

            raise aws_sdk_lakeformation.errors.resource_not_ready_exception.ResourceNotReadyException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.get_table_objects_response.GetTableObjectsResponse = aws_sdk_lakeformation.types.get_table_objects_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.get_table_objects_request.GetTableObjectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_table_objects_request.serialize_json(input_)
    ).encode()
