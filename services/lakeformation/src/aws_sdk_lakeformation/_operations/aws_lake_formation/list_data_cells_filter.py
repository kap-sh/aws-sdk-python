...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.list_data_cells_filter_response.ListDataCellsFilterResponse = aws_sdk_lakeformation.types.list_data_cells_filter_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.list_data_cells_filter_request.ListDataCellsFilterRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.list_data_cells_filter_request.serialize_json(input)
    ).encode()
