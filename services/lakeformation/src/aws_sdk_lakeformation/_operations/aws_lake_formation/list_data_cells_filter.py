...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.list_data_cells_filter_request.ListDataCellsFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.list_data_cells_filter_request.serialize_json(
            input_
        )
    ).encode()
