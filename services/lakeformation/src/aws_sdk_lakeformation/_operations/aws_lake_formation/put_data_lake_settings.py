...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.put_data_lake_settings_request.PutDataLakeSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.put_data_lake_settings_request.serialize_json(
            input_
        )
    ).encode()
