...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.put_data_lake_settings_response.PutDataLakeSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.put_data_lake_settings_request.PutDataLakeSettingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.put_data_lake_settings_request.serialize_json(input)
    ).encode()
