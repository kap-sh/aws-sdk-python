...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.update_table_objects_request.UpdateTableObjectsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.update_table_objects_request.serialize_json(input)
    ).encode()
