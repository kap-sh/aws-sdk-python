...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.update_table_objects_response.UpdateTableObjectsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.update_table_objects_request.UpdateTableObjectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.update_table_objects_request.serialize_json(input_)
    ).encode()
