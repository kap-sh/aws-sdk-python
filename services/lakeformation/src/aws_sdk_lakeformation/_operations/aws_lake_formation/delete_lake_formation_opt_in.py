...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.delete_lake_formation_opt_in_response.DeleteLakeFormationOptInResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.delete_lake_formation_opt_in_request.DeleteLakeFormationOptInRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.delete_lake_formation_opt_in_request.serialize_json(
            input_
        )
    ).encode()
