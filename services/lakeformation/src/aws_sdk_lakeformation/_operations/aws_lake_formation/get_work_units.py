...
import aws_sdk_lakeformation.errors.work_units_not_ready_yet_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WorkUnitsNotReadyYetException":
            raise aws_sdk_lakeformation.errors.work_units_not_ready_yet_exception.WorkUnitsNotReadyYetException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.get_work_units_response.GetWorkUnitsResponse = (
        aws_sdk_lakeformation.types.get_work_units_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.get_work_units_request.GetWorkUnitsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_work_units_request.serialize_json(input_)
    ).encode()
