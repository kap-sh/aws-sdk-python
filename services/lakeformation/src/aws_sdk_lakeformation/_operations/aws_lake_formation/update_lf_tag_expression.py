...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.update_lf_tag_expression_response.UpdateLFTagExpressionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.update_lf_tag_expression_request.UpdateLFTagExpressionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.update_lf_tag_expression_request.serialize_json(
            input_
        )
    ).encode()
