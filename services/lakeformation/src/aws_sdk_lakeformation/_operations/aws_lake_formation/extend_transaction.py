...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.extend_transaction_request.ExtendTransactionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.extend_transaction_request.serialize_json(input)
    ).encode()
