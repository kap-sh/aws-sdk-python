...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.extend_transaction_request.ExtendTransactionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.extend_transaction_request.serialize_json(input_)
    ).encode()
