...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.cancel_transaction_request.CancelTransactionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.cancel_transaction_request.serialize_json(input)
    ).encode()
