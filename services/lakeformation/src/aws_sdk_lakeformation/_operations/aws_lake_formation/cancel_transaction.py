...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.cancel_transaction_response.CancelTransactionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.cancel_transaction_request.CancelTransactionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.cancel_transaction_request.serialize_json(input_)
    ).encode()
