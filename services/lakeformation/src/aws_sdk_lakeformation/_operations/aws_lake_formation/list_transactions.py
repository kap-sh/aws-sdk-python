...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.list_transactions_response.ListTransactionsResponse = aws_sdk_lakeformation.types.list_transactions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.list_transactions_request.ListTransactionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.list_transactions_request.serialize_json(input_)
    ).encode()
