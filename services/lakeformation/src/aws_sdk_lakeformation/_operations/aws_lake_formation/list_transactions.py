...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.list_transactions_request.ListTransactionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.list_transactions_request.serialize_json(input)
    ).encode()
