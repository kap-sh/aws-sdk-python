...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.update_data_cells_filter_response.UpdateDataCellsFilterResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.update_data_cells_filter_request.UpdateDataCellsFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.update_data_cells_filter_request.serialize_json(
            input_
        )
    ).encode()
