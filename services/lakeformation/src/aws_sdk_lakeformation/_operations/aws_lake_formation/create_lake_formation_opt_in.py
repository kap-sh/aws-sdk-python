"""Generated from Smithy shape ``com.amazonaws.lakeformation#CreateLakeFormationOptIn``."""
...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.create_lake_formation_opt_in_response.CreateLakeFormationOptInResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.create_lake_formation_opt_in_request.CreateLakeFormationOptInRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.create_lake_formation_opt_in_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_lake_formation_opt_in(
