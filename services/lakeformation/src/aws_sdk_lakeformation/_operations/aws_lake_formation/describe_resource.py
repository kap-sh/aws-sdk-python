...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.describe_resource_request.DescribeResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.describe_resource_request.serialize_json(input)
    ).encode()
