...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.describe_resource_response.DescribeResourceResponse = aws_sdk_lakeformation.types.describe_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.describe_resource_request.DescribeResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.describe_resource_request.serialize_json(input_)
    ).encode()
