...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.create_lf_tag_response.CreateLFTagResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.create_lf_tag_request.CreateLFTagRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.create_lf_tag_request.serialize_json(input_)
    ).encode()
