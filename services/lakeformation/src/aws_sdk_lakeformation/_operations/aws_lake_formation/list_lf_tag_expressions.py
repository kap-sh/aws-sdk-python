...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.list_lf_tag_expressions_response.ListLFTagExpressionsResponse = aws_sdk_lakeformation.types.list_lf_tag_expressions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.list_lf_tag_expressions_request.ListLFTagExpressionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.list_lf_tag_expressions_request.serialize_json(
            input_
        )
    ).encode()
