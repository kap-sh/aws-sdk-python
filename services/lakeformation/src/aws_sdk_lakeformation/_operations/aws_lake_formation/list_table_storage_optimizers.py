"""Generated from Smithy shape ``com.amazonaws.lakeformation#ListTableStorageOptimizers``."""
...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.list_table_storage_optimizers_response.ListTableStorageOptimizersResponse = aws_sdk_lakeformation.types.list_table_storage_optimizers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.list_table_storage_optimizers_request.ListTableStorageOptimizersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListTableStorageOptimizers"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_lakeformation.types.list_table_storage_optimizers_request

    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.list_table_storage_optimizers_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_table_storage_optimizers(
