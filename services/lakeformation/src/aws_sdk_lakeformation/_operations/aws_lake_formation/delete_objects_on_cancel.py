...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.delete_objects_on_cancel_response.DeleteObjectsOnCancelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.delete_objects_on_cancel_request.DeleteObjectsOnCancelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.delete_objects_on_cancel_request.serialize_json(
            input_
        )
    ).encode()
