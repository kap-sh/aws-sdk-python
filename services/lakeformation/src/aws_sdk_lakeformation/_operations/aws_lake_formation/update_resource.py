...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.update_resource_request.UpdateResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.update_resource_request.serialize_json(input)
    ).encode()
