...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.get_temporary_glue_table_credentials_response.GetTemporaryGlueTableCredentialsResponse = aws_sdk_lakeformation.types.get_temporary_glue_table_credentials_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.get_temporary_glue_table_credentials_request.GetTemporaryGlueTableCredentialsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_temporary_glue_table_credentials_request.serialize_json(
            input_
        )
    ).encode()
