...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.update_table_storage_optimizer_response.UpdateTableStorageOptimizerResponse = aws_sdk_lakeformation.types.update_table_storage_optimizer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.update_table_storage_optimizer_request.UpdateTableStorageOptimizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.update_table_storage_optimizer_request.serialize_json(
            input_
        )
    ).encode()
