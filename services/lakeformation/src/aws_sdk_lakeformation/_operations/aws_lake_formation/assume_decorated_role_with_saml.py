...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.assume_decorated_role_with_saml_response.AssumeDecoratedRoleWithSAMLResponse = aws_sdk_lakeformation.types.assume_decorated_role_with_saml_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.assume_decorated_role_with_saml_request.AssumeDecoratedRoleWithSAMLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
