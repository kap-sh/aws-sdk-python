...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.search_tables_by_lf_tags_response.SearchTablesByLFTagsResponse = aws_sdk_lakeformation.types.search_tables_by_lf_tags_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.search_tables_by_lf_tags_request.SearchTablesByLFTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.search_tables_by_lf_tags_request.serialize_json(
            input_
        )
    ).encode()
