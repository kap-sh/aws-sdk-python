...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.get_data_lake_principal_response.GetDataLakePrincipalResponse = aws_sdk_lakeformation.types.get_data_lake_principal_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.get_data_lake_principal_request.GetDataLakePrincipalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
