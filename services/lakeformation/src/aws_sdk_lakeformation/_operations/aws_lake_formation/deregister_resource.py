...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.deregister_resource_response.DeregisterResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.deregister_resource_request.DeregisterResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.deregister_resource_request.serialize_json(input_)
    ).encode()
