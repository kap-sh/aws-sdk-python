...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.deregister_resource_request.DeregisterResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.deregister_resource_request.serialize_json(input)
    ).encode()
