"""Generated from Smithy shape ``com.amazonaws.lakeformation#RemoveLFTagsFromResource``."""
...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.remove_lf_tags_from_resource_response.RemoveLFTagsFromResourceResponse = aws_sdk_lakeformation.types.remove_lf_tags_from_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.remove_lf_tags_from_resource_request.RemoveLFTagsFromResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/RemoveLFTagsFromResource"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_lakeformation.types.remove_lf_tags_from_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.remove_lf_tags_from_resource_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_remove_lf_tags_from_resource(
