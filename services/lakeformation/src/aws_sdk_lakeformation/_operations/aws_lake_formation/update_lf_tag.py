...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.update_lf_tag_response.UpdateLFTagResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.update_lf_tag_request.UpdateLFTagRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.update_lf_tag_request.serialize_json(input_)
    ).encode()
