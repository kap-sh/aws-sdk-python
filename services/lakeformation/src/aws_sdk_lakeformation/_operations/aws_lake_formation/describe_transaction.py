...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.describe_transaction_response.DescribeTransactionResponse = aws_sdk_lakeformation.types.describe_transaction_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.describe_transaction_request.DescribeTransactionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.describe_transaction_request.serialize_json(input_)
    ).encode()
