...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.describe_transaction_request.DescribeTransactionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.describe_transaction_request.serialize_json(input)
    ).encode()
