...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.revoke_permissions_response.RevokePermissionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.revoke_permissions_request.RevokePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.revoke_permissions_request.serialize_json(input_)
    ).encode()
