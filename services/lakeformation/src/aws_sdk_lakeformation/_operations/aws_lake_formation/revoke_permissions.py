...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.revoke_permissions_request.RevokePermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.revoke_permissions_request.serialize_json(input)
    ).encode()
