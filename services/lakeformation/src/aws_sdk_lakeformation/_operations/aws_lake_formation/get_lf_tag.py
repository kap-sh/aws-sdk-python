...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.get_lf_tag_response.GetLFTagResponse = (
        aws_sdk_lakeformation.types.get_lf_tag_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.get_lf_tag_request.GetLFTagRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_lf_tag_request.serialize_json(input_)
    ).encode()
...
def get_lf_tag(
    ...
    aws_sdk_lakeformation.types.get_lf_tag_response.GetLFTagResponse, zapros.Response
]:
