...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.search_databases_by_lf_tags_response.SearchDatabasesByLFTagsResponse = aws_sdk_lakeformation.types.search_databases_by_lf_tags_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.search_databases_by_lf_tags_request.SearchDatabasesByLFTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.search_databases_by_lf_tags_request.serialize_json(
            input_
        )
    ).encode()
