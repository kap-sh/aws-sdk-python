...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.get_lf_tag_expression_response.GetLFTagExpressionResponse = aws_sdk_lakeformation.types.get_lf_tag_expression_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.get_lf_tag_expression_request.GetLFTagExpressionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_lf_tag_expression_request.serialize_json(input_)
    ).encode()
