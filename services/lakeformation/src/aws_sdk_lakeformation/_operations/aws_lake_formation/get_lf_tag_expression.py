...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.get_lf_tag_expression_request.GetLFTagExpressionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_lf_tag_expression_request.serialize_json(input)
    ).encode()
