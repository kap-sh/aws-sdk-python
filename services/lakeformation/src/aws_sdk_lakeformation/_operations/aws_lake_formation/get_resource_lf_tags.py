"""Generated from Smithy shape ``com.amazonaws.lakeformation#GetResourceLFTags``."""
...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.get_resource_lf_tags_response.GetResourceLFTagsResponse = aws_sdk_lakeformation.types.get_resource_lf_tags_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.get_resource_lf_tags_request.GetResourceLFTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetResourceLFTags"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_lakeformation.types.get_resource_lf_tags_request

    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_resource_lf_tags_request.serialize_json(input_)
    ).encode()
...
async def async_get_resource_lf_tags(
