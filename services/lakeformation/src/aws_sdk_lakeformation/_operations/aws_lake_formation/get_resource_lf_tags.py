...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.get_resource_lf_tags_request.GetResourceLFTagsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_resource_lf_tags_request.serialize_json(input)
    ).encode()
