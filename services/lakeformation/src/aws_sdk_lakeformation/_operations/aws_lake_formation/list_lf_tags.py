...
def handle_response(
    ...
    out: aws_sdk_lakeformation.types.list_lf_tags_response.ListLFTagsResponse = (
        aws_sdk_lakeformation.types.list_lf_tags_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lakeformation.types.list_lf_tags_request.ListLFTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.list_lf_tags_request.serialize_json(input_)
    ).encode()
