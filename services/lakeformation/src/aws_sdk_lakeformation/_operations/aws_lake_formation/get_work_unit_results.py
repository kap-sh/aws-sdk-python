...
def build_request(
    ...
    input: aws_sdk_lakeformation.types.get_work_unit_results_request.GetWorkUnitResultsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lakeformation.types.get_work_unit_results_request.serialize_json(input)
    ).encode()
