"""Generated from Smithy shape ``com.amazonaws.lakeformation#WorkUnitsNotReadyYetException``."""
...
class WorkUnitsNotReadyYetException_(TypedDict, closed=True):
    message: NotRequired["aws_sdk_lakeformation.types.message_string.MessageString"]
    """<p>A message describing the error.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: WorkUnitsNotReadyYetException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class WorkUnitsNotReadyYetException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lakeformation#WorkUnitsNotReadyYetException``."""
