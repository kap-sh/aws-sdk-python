...
if TYPE_CHECKING:
    ...
    import aws_sdk_lakeformation.types.row_filter
...
class DataCellsFilter(TypedDict, closed=True):
    ...
    version_id: NotRequired["aws_sdk_lakeformation.types.version_string.VersionString"]
...
def serialize_json(value: DataCellsFilter) -> dict:
    ...
    if "row_filter" in value:
        ...
        out["RowFilter"] = aws_sdk_lakeformation.types.row_filter.serialize_json(
            value["row_filter"]
        )
...
def deserialize_json(data: dict) -> DataCellsFilter:
    ...
    if "RowFilter" in data:
        ...
        out["row_filter"] = aws_sdk_lakeformation.types.row_filter.deserialize_json(
            data["RowFilter"]
        )
