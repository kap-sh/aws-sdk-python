...
if TYPE_CHECKING:
    import aws_sdk_lakeformation.types.application_arn
    ...
    import aws_sdk_lakeformation.types.ram_resource_share_arn
    import aws_sdk_lakeformation.types.service_integration_list


class DescribeLakeFormationIdentityCenterConfigurationResponse(TypedDict):
    ...
    application_arn: NotRequired[
        "aws_sdk_lakeformation.types.application_arn.ApplicationArn"
    ]
    ...
    resource_share: NotRequired[
        "aws_sdk_lakeformation.types.ram_resource_share_arn.RAMResourceShareArn"
    ]
