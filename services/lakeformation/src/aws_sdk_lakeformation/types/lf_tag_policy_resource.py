...
if TYPE_CHECKING:
    ...
    import aws_sdk_lakeformation.types.resource_type


class LFTagPolicyResource(TypedDict):
    catalog_id: NotRequired[
        "aws_sdk_lakeformation.types.catalog_id_string.CatalogIdString"
    ]
    """<p>The identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your Lake Formation environment. </p>"""
    resource_type: "aws_sdk_lakeformation.types.resource_type.ResourceType"
    ...
    expression_name: NotRequired["aws_sdk_lakeformation.types.name_string.NameString"]
...
def serialize_json(value: LFTagPolicyResource) -> dict:
    ...
    out["ResourceType"] = aws_sdk_lakeformation.types.resource_type.serialize_json(
        value["resource_type"]
    )
    import aws_sdk_lakeformation.types.expression
...
def deserialize_json(data: dict) -> LFTagPolicyResource:
    ...
    if "ResourceType" in data:
        ...
        out["resource_type"] = (
            aws_sdk_lakeformation.types.resource_type.deserialize_json(
                data["ResourceType"]
            )
        )
    else:
