...
class GetTemporaryDataLocationCredentialsResponse(TypedDict):
    credentials: NotRequired[
        "aws_sdk_lakeformation.types.temporary_credentials.TemporaryCredentials"
    ]
...
def serialize_json(value: GetTemporaryDataLocationCredentialsResponse) -> dict:
    ...
    if "credentials" in value:
        ...
        out["Credentials"] = (
            aws_sdk_lakeformation.types.temporary_credentials.serialize_json(
                value["credentials"]
            )
        )
...
def deserialize_json(data: dict) -> GetTemporaryDataLocationCredentialsResponse:
    ...
    if "Credentials" in data:
        ...
        out["credentials"] = (
            aws_sdk_lakeformation.types.temporary_credentials.deserialize_json(
                data["Credentials"]
            )
        )
