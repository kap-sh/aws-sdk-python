...
if TYPE_CHECKING:
    import aws_sdk_lakeformation.types.context_key
    import aws_sdk_lakeformation.types.context_value

AdditionalContextMap: TypeAlias = dict[
    "aws_sdk_lakeformation.types.context_key.ContextKey",
    "aws_sdk_lakeformation.types.context_value.ContextValue",
]
