...
class ListTransactionsRequest(TypedDict):
...
def serialize_json(value: ListTransactionsRequest) -> dict:
    ...
    if "status_filter" in value:
        ...
        out["StatusFilter"] = (
            aws_sdk_lakeformation.types.transaction_status_filter.serialize_json(
                value["status_filter"]
            )
        )
...
def deserialize_json(data: dict) -> ListTransactionsRequest:
    ...
    if "StatusFilter" in data:
        ...
        out["status_filter"] = (
            aws_sdk_lakeformation.types.transaction_status_filter.deserialize_json(
                data["StatusFilter"]
            )
        )
