"""Generated from Smithy shape ``com.amazonaws.lakeformation#GetDataLakePrincipal``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.get_data_lake_principal_response.GetDataLakePrincipalResponse = capo_lakeformation.types.get_data_lake_principal_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetDataLakePrincipal"
    params: dict[str, str] = {}
...
async def async_get_data_lake_principal(
