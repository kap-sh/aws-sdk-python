"""Generated from Smithy shape ``com.amazonaws.lakeformation#GetTableObjects``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.get_table_objects_response.GetTableObjectsResponse = (
        capo_lakeformation.types.get_table_objects_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetTableObjects"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_lakeformation.types.get_table_objects_request.serialize_json(input_)
    ).encode()
...
async def async_get_table_objects(
