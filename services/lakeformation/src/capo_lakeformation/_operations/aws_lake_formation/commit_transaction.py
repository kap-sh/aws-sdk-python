"""Generated from Smithy shape ``com.amazonaws.lakeformation#CommitTransaction``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.commit_transaction_response.CommitTransactionResponse = capo_lakeformation.types.commit_transaction_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.commit_transaction_request.serialize_json(input_)
    ).encode()
