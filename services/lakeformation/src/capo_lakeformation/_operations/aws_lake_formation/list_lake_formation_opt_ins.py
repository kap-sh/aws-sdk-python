"""Generated from Smithy shape ``com.amazonaws.lakeformation#ListLakeFormationOptIns``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.list_lake_formation_opt_ins_response.ListLakeFormationOptInsResponse = capo_lakeformation.types.list_lake_formation_opt_ins_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.list_lake_formation_opt_ins_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_lake_formation_opt_ins(
