...
import capo_lakeformation.errors.statistics_not_ready_yet_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StatisticsNotReadyYetException":
            raise capo_lakeformation.errors.statistics_not_ready_yet_exception.StatisticsNotReadyYetException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_lakeformation.types.get_query_statistics_response.GetQueryStatisticsResponse = capo_lakeformation.types.get_query_statistics_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.get_query_statistics_request.serialize_json(input_)
    ).encode()
