"""Generated from Smithy shape ``com.amazonaws.lakeformation#GetDataLakeSettings``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.get_data_lake_settings_response.GetDataLakeSettingsResponse = capo_lakeformation.types.get_data_lake_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.get_data_lake_settings_request.serialize_json(input_)
    ).encode()
...
async def async_get_data_lake_settings(
