"""Generated from Smithy shape ``com.amazonaws.lakeformation#AssumeDecoratedRoleWithSAML``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.assume_decorated_role_with_saml_response.AssumeDecoratedRoleWithSAMLResponse = capo_lakeformation.types.assume_decorated_role_with_saml_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.assume_decorated_role_with_saml_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_assume_decorated_role_with_saml(
