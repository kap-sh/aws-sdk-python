...
import capo_lakeformation.errors.resource_number_limit_exceeded_exception
...
def handle_response(
    ...
    out: capo_lakeformation.types.create_data_cells_filter_response.CreateDataCellsFilterResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.create_data_cells_filter_request.serialize_json(input_)
    ).encode()
