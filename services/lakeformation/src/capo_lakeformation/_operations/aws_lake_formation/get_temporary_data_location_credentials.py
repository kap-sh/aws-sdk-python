...
import capo_lakeformation.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_lakeformation.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_lakeformation.types.get_temporary_data_location_credentials_response.GetTemporaryDataLocationCredentialsResponse = capo_lakeformation.types.get_temporary_data_location_credentials_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.get_temporary_data_location_credentials_request.serialize_json(
            input_
        )
    ).encode()
