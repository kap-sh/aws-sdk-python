"""Generated from Smithy shape ``com.amazonaws.lakeformation#ListResources``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.list_resources_response.ListResourcesResponse = (
        capo_lakeformation.types.list_resources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.list_resources_request.serialize_json(input_)
    ).encode()
