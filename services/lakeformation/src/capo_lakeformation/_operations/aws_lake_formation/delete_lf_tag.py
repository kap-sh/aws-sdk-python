"""Generated from Smithy shape ``com.amazonaws.lakeformation#DeleteLFTag``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.delete_lf_tag_response.DeleteLFTagResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.delete_lf_tag_request.serialize_json(input_)
    ).encode()
...
def delete_lf_tag(
    ...
    capo_lakeformation.types.delete_lf_tag_response.DeleteLFTagResponse, zapros.Response
]:
