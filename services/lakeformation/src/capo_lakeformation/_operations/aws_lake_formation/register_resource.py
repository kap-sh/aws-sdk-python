...
def handle_response(
    ...
    out: capo_lakeformation.types.register_resource_response.RegisterResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.register_resource_request.serialize_json(input_)
    ).encode()
