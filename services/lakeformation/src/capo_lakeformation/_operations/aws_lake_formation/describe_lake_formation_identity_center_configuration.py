"""Generated from Smithy shape ``com.amazonaws.lakeformation#DescribeLakeFormationIdentityCenterConfiguration``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.describe_lake_formation_identity_center_configuration_response.DescribeLakeFormationIdentityCenterConfigurationResponse = capo_lakeformation.types.describe_lake_formation_identity_center_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DescribeLakeFormationIdentityCenterConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_lakeformation.types.describe_lake_formation_identity_center_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_describe_lake_formation_identity_center_configuration(
