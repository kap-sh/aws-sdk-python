"""Generated from Smithy shape ``com.amazonaws.lakeformation#StartTransaction``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.start_transaction_response.StartTransactionResponse = capo_lakeformation.types.start_transaction_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.start_transaction_request.serialize_json(input_)
    ).encode()
