"""Generated from Smithy shape ``com.amazonaws.lakeformation#InternalServiceException``."""
...
class InternalServiceException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lakeformation#InternalServiceException``."""
