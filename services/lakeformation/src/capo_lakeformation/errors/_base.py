...
class LakeFormationError(Exception):
    """Base class for all LakeFormation service errors."""


class ServiceError(LakeFormationError):
...
class SerializationError(LakeFormationError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LakeFormationError):
...
class WaiterFailedError(LakeFormationError):
...
class WaiterTimeoutError(LakeFormationError):
