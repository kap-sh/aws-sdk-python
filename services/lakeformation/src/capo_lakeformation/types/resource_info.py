...
class ResourceInfo(TypedDict, closed=True):
    resource_arn: NotRequired[
        "capo_lakeformation.types.resource_arn_string.ResourceArnString"
    ]
    ...
    verification_status: NotRequired[
        "capo_lakeformation.types.verification_status.VerificationStatus"
    ]
...
def serialize_json(value: ResourceInfo) -> dict:
    ...
    if "verification_status" in value:
        ...
        out["VerificationStatus"] = (
            capo_lakeformation.types.verification_status.serialize_json(
...
def deserialize_json(data: dict) -> ResourceInfo:
    ...
    if "VerificationStatus" in data:
        ...
        out["verification_status"] = (
            capo_lakeformation.types.verification_status.deserialize_json(
