"""Generated from Smithy shape ``com.amazonaws.applicationinsights#TooManyTagsException``."""
...
class TooManyTagsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.applicationinsights#TooManyTagsException``."""
