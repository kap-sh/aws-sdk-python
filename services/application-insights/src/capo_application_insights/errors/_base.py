...
class ApplicationInsightsError(Exception):
    """Base class for all ApplicationInsights service errors."""


class ServiceError(ApplicationInsightsError):
...
class SerializationError(ApplicationInsightsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ApplicationInsightsError):
...
class WaiterFailedError(ApplicationInsightsError):
...
class WaiterTimeoutError(ApplicationInsightsError):
