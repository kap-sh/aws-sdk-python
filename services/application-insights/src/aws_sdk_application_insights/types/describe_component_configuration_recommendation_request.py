...
class DescribeComponentConfigurationRecommendationRequest(TypedDict):
    resource_group_name: (
...
def serialize_aws_json_1_1(
    ...
    if "recommendation_type" in value:
        ...
        out["RecommendationType"] = (
            aws_sdk_application_insights.types.recommendation_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "RecommendationType" in data:
        ...
        out["recommendation_type"] = (
            aws_sdk_application_insights.types.recommendation_type.deserialize_aws_json_1_1(
