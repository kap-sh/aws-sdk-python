"""Generated from Smithy shape ``com.amazonaws.applicationinsights#DescribeComponentConfigurationRequest``."""
...
class DescribeComponentConfigurationRequest(TypedDict, closed=True):
    resource_group_name: (
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeComponentConfigurationRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeComponentConfigurationRequest:
    out: DescribeComponentConfigurationRequest = {}  # type: ignore[typeddict-item]
    if "ResourceGroupName" in data:
        out["resource_group_name"] = data["ResourceGroupName"]
    else:
        raise DeserializationError(
            "DescribeComponentConfigurationRequest.resource_group_name required"
        )
    if "ComponentName" in data:
        out["component_name"] = data["ComponentName"]
    else:
        raise DeserializationError(
            "DescribeComponentConfigurationRequest.component_name required"
        )
