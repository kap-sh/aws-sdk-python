...
if TYPE_CHECKING:
    import aws_sdk_application_insights.types.application_info_list
...
class ListApplicationsResponse(TypedDict):
    application_info_list: NotRequired[
        "aws_sdk_application_insights.types.application_info_list.ApplicationInfoList"
    ]
...
def serialize_aws_json_1_1(value: ListApplicationsResponse) -> dict:
    ...
    if "application_info_list" in value:
        ...
        out["ApplicationInfoList"] = (
            aws_sdk_application_insights.types.application_info_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListApplicationsResponse:
    ...
    if "ApplicationInfoList" in data:
        ...
        out["application_info_list"] = (
            aws_sdk_application_insights.types.application_info_list.deserialize_aws_json_1_1(
