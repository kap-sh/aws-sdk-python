...
if TYPE_CHECKING:
    import aws_sdk_application_insights.types.observation_list


class RelatedObservations(TypedDict):
    observation_list: NotRequired[
        "aws_sdk_application_insights.types.observation_list.ObservationList"
    ]
...
def serialize_aws_json_1_1(value: RelatedObservations) -> dict:
    ...
    if "observation_list" in value:
        ...
        out["ObservationList"] = (
            aws_sdk_application_insights.types.observation_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RelatedObservations:
    ...
    if "ObservationList" in data:
        ...
        out["observation_list"] = (
            aws_sdk_application_insights.types.observation_list.deserialize_aws_json_1_1(
