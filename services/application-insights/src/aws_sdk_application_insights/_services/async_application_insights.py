...
from aws_sdk_application_insights._services._aws_config import aaws_config
...
class AsyncApplicationInsightsClientConfig(TypedDict, total=False):
...
class AsyncApplicationInsightsClient:
    ...
    async def add_workload(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.add_workload_request.AddWorkloadRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.add_workload_response.AddWorkloadResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.add_workload.async_add_workload(
    ...
    async def create_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.create_application_request.CreateApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.create_application_response.CreateApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.create_application.async_create_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_component(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.create_component_request.CreateComponentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.create_component_response.CreateComponentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.create_component.async_create_component(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_log_pattern(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.create_log_pattern_request.CreateLogPatternRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.create_log_pattern_response.CreateLogPatternResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.create_log_pattern.async_create_log_pattern(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.delete_application_request.DeleteApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.delete_application_response.DeleteApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.delete_application.async_delete_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_component(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.delete_component_request.DeleteComponentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.delete_component_response.DeleteComponentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.delete_component.async_delete_component(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_log_pattern(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.delete_log_pattern_request.DeleteLogPatternRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.delete_log_pattern_response.DeleteLogPatternResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.delete_log_pattern.async_delete_log_pattern(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.describe_application_request.DescribeApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.describe_application_response.DescribeApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.describe_application.async_describe_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_component(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.describe_component_request.DescribeComponentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.describe_component_response.DescribeComponentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.describe_component.async_describe_component(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_component_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.describe_component_configuration_request.DescribeComponentConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.describe_component_configuration_response.DescribeComponentConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.describe_component_configuration.async_describe_component_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_component_configuration_recommendation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.describe_component_configuration_recommendation_request.DescribeComponentConfigurationRecommendationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.describe_component_configuration_recommendation_response.DescribeComponentConfigurationRecommendationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.describe_component_configuration_recommendation.async_describe_component_configuration_recommendation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_log_pattern(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.describe_log_pattern_request.DescribeLogPatternRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.describe_log_pattern_response.DescribeLogPatternResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.describe_log_pattern.async_describe_log_pattern(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_observation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.describe_observation_request.DescribeObservationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.describe_observation_response.DescribeObservationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.describe_observation.async_describe_observation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_problem(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.describe_problem_request.DescribeProblemRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.describe_problem_response.DescribeProblemResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.describe_problem.async_describe_problem(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_problem_observations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.describe_problem_observations_request.DescribeProblemObservationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.describe_problem_observations_response.DescribeProblemObservationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.describe_problem_observations.async_describe_problem_observations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_workload(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.describe_workload_request.DescribeWorkloadRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.describe_workload_response.DescribeWorkloadResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.describe_workload.async_describe_workload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_applications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.list_applications_request.ListApplicationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.list_applications_response.ListApplicationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.list_applications.async_list_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_components(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.list_components_request.ListComponentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.list_components_response.ListComponentsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.list_components.async_list_components(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_configuration_history(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.list_configuration_history_request.ListConfigurationHistoryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.list_configuration_history_response.ListConfigurationHistoryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.list_configuration_history.async_list_configuration_history(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_log_patterns(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.list_log_patterns_request.ListLogPatternsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.list_log_patterns_response.ListLogPatternsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.list_log_patterns.async_list_log_patterns(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_log_pattern_sets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.list_log_pattern_sets_request.ListLogPatternSetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.list_log_pattern_sets_response.ListLogPatternSetsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.list_log_pattern_sets.async_list_log_pattern_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_problems(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.list_problems_request.ListProblemsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.list_problems_response.ListProblemsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.list_problems.async_list_problems(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_workloads(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.list_workloads_request.ListWorkloadsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.list_workloads_response.ListWorkloadsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.list_workloads.async_list_workloads(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_workload(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.remove_workload_request.RemoveWorkloadRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.remove_workload_response.RemoveWorkloadResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.remove_workload.async_remove_workload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.update_application_request.UpdateApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.update_application_response.UpdateApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.update_application.async_update_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_component(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.update_component_request.UpdateComponentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.update_component_response.UpdateComponentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.update_component.async_update_component(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_component_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.update_component_configuration_request.UpdateComponentConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.update_component_configuration_response.UpdateComponentConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.update_component_configuration.async_update_component_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_log_pattern(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.update_log_pattern_request.UpdateLogPatternRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.update_log_pattern_response.UpdateLogPatternResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.update_log_pattern.async_update_log_pattern(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_problem(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.update_problem_request.UpdateProblemRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.update_problem_response.UpdateProblemResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.update_problem.async_update_problem(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_workload(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_application_insights.types.update_workload_request.UpdateWorkloadRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_application_insights.types.update_workload_response.UpdateWorkloadResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_application_insights._operations.ec2_windows_barley_service.update_workload.async_update_workload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
