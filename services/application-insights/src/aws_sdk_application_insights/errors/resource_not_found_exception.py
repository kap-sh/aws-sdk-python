"""Generated from Smithy shape ``com.amazonaws.applicationinsights#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.applicationinsights#ResourceNotFoundException``."""
