"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.resiliencehub#ValidationException``."""
