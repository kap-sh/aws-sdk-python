...
class resiliencehubError(Exception):
    """Base class for all resiliencehub service errors."""


class ServiceError(resiliencehubError):
...
class SerializationError(resiliencehubError):
    """Raised when a value cannot be serialized."""


class DeserializationError(resiliencehubError):
...
class WaiterFailedError(resiliencehubError):
...
class WaiterTimeoutError(resiliencehubError):
