...
class ResourceError(TypedDict, closed=True):
    logical_resource_id: NotRequired["capo_resiliencehub.types.string255.String255"]
    """<p>Identifier of the logical resource. </p>"""
    physical_resource_id: NotRequired["capo_resiliencehub.types.string255.String255"]
    """<p>Identifier of the physical resource. </p>"""
    reason: NotRequired["capo_resiliencehub.types.error_message.ErrorMessage"]
