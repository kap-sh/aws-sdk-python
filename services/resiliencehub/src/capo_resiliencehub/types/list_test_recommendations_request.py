"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListTestRecommendationsRequest``."""
...
class ListTestRecommendationsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListTestRecommendationsRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListTestRecommendationsRequest:
    out: ListTestRecommendationsRequest = {}  # type: ignore[typeddict-item]
    ...
    if "assessmentArn" in data:
        ...
        raise DeserializationError(
            "ListTestRecommendationsRequest.assessment_arn required"
        )
    return out
