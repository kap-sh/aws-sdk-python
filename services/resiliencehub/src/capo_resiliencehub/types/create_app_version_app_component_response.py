"""Generated from Smithy shape ``com.amazonaws.resiliencehub#CreateAppVersionAppComponentResponse``."""
...
class CreateAppVersionAppComponentResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateAppVersionAppComponentResponse) -> dict:
    out: dict = {}
