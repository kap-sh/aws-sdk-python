"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListAppComponentRecommendationsRequest``."""
...
class ListAppComponentRecommendationsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListAppComponentRecommendationsRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListAppComponentRecommendationsRequest:
    out: ListAppComponentRecommendationsRequest = {}  # type: ignore[typeddict-item]
    if "assessmentArn" in data:
        out["assessment_arn"] = data["assessmentArn"]
    else:
        raise DeserializationError(
            "ListAppComponentRecommendationsRequest.assessment_arn required"
        )
