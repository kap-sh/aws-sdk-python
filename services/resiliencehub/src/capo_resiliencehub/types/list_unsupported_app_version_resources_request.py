"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListUnsupportedAppVersionResourcesRequest``."""
...
class ListUnsupportedAppVersionResourcesRequest(TypedDict, closed=True):
    ...
    resolution_id: NotRequired["capo_resiliencehub.types.string255.String255"]
...
# --- restJson1 ser/de ---
def serialize_json(value: ListUnsupportedAppVersionResourcesRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListUnsupportedAppVersionResourcesRequest:
    out: ListUnsupportedAppVersionResourcesRequest = {}  # type: ignore[typeddict-item]
    if "appArn" in data:
        out["app_arn"] = data["appArn"]
    else:
        raise DeserializationError(
            "ListUnsupportedAppVersionResourcesRequest.app_arn required"
        )
    if "appVersion" in data:
        out["app_version"] = data["appVersion"]
    else:
        raise DeserializationError(
            "ListUnsupportedAppVersionResourcesRequest.app_version required"
        )
