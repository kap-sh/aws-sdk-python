...
def handle_response(
    ...
    out: capo_resiliencehub.types.start_app_assessment_response.StartAppAssessmentResponse = capo_resiliencehub.types.start_app_assessment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.start_app_assessment_request.serialize_json(input_)
    ).encode()
