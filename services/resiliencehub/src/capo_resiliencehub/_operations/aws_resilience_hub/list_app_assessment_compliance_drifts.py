"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListAppAssessmentComplianceDrifts``."""
...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_app_assessment_compliance_drifts_response.ListAppAssessmentComplianceDriftsResponse = capo_resiliencehub.types.list_app_assessment_compliance_drifts_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/list-app-assessment-compliance-drifts"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.list_app_assessment_compliance_drifts_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_app_assessment_compliance_drifts(
