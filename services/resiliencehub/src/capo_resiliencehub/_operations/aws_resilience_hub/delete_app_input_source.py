"""Generated from Smithy shape ``com.amazonaws.resiliencehub#DeleteAppInputSource``."""
...
def handle_response(
    ...
    out: capo_resiliencehub.types.delete_app_input_source_response.DeleteAppInputSourceResponse = capo_resiliencehub.types.delete_app_input_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.delete_app_input_source_request.serialize_json(input_)
    ).encode()
...
async def async_delete_app_input_source(
