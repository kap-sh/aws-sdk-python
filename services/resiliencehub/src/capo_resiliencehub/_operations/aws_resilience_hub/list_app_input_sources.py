...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_app_input_sources_response.ListAppInputSourcesResponse = capo_resiliencehub.types.list_app_input_sources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.list_app_input_sources_request.serialize_json(input_)
    ).encode()
