"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListAppAssessments``."""
...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_app_assessments_response.ListAppAssessmentsResponse = capo_resiliencehub.types.list_app_assessments_response.deserialize_json(
