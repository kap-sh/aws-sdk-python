"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListRecommendationTemplates``."""
...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_recommendation_templates_response.ListRecommendationTemplatesResponse = capo_resiliencehub.types.list_recommendation_templates_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/list-recommendation-templates"
    params: dict[str, str] = {}
    if "assessment_arn" in input_:
        params["assessmentArn"] = str(input_["assessment_arn"])
    if "reverse_order" in input_:
        params["reverseOrder"] = str(input_["reverse_order"])
    if "status" in input_:
        params["status"] = str(input_["status"])
    if "recommendation_template_arn" in input_:
        params["recommendationTemplateArn"] = str(input_["recommendation_template_arn"])
    if "name" in input_:
...
async def async_list_recommendation_templates(
