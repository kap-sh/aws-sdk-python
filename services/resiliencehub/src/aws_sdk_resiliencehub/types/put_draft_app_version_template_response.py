"""Generated from Smithy shape ``com.amazonaws.resiliencehub#PutDraftAppVersionTemplateResponse``."""
...
class PutDraftAppVersionTemplateResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: PutDraftAppVersionTemplateResponse) -> dict:
    out: dict = {}
    if "app_arn" in value:
