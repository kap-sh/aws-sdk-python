...
class ListMetricsRequest(TypedDict):
    ...
    fields: NotRequired["aws_sdk_resiliencehub.types.field_list.FieldList"]
    """<p>Indicates the list of fields in the data source.</p>"""
    data_source: NotRequired["aws_sdk_resiliencehub.types.string255.String255"]
    """<p>Indicates the data source of the metrics.</p>"""
    conditions: NotRequired["aws_sdk_resiliencehub.types.condition_list.ConditionList"]
    """<p>Indicates the list of all the conditions that were applied on the metrics.</p>"""
    sorts: NotRequired["aws_sdk_resiliencehub.types.sort_list.SortList"]
...
def serialize_json(value: ListMetricsRequest) -> dict:
    ...
    if "fields" in value:
        ...
        out["fields"] = aws_sdk_resiliencehub.types.field_list.serialize_json(
            value["fields"]
        )
    ...
    if "conditions" in value:
        ...
        out["conditions"] = aws_sdk_resiliencehub.types.condition_list.serialize_json(
            value["conditions"]
        )
    if "sorts" in value:
        import aws_sdk_resiliencehub.types.sort_list

        out["sorts"] = aws_sdk_resiliencehub.types.sort_list.serialize_json(
            value["sorts"]
        )
    return out
...
def deserialize_json(data: dict) -> ListMetricsRequest:
    ...
    if "fields" in data:
        ...
        out["fields"] = aws_sdk_resiliencehub.types.field_list.deserialize_json(
            data["fields"]
        )
    ...
    if "conditions" in data:
        ...
        out["conditions"] = aws_sdk_resiliencehub.types.condition_list.deserialize_json(
            data["conditions"]
        )
    if "sorts" in data:
        import aws_sdk_resiliencehub.types.sort_list

        out["sorts"] = aws_sdk_resiliencehub.types.sort_list.deserialize_json(
            data["sorts"]
        )
    return out
