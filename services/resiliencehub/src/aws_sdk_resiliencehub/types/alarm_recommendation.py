...
if TYPE_CHECKING:
    import aws_sdk_resiliencehub.types.alarm_type
...
class AlarmRecommendation(TypedDict):
    ...
    name: "aws_sdk_resiliencehub.types.string500.String500"
    ...
    type: "aws_sdk_resiliencehub.types.alarm_type.AlarmType"
...
def serialize_json(value: AlarmRecommendation) -> dict:
    ...
    out["type"] = aws_sdk_resiliencehub.types.alarm_type.serialize_json(value["type"])
...
def deserialize_json(data: dict) -> AlarmRecommendation:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_resiliencehub.types.alarm_type.deserialize_json(
            data["type"]
        )
    else:
