...
if TYPE_CHECKING:
    ...
    import aws_sdk_resiliencehub.types.physical_identifier_type
    import aws_sdk_resiliencehub.types.string255


class PhysicalResourceId(TypedDict):
    identifier: "aws_sdk_resiliencehub.types.string255.String255"
    """<p>Identifier of the physical resource.</p>"""
    type: "aws_sdk_resiliencehub.types.physical_identifier_type.PhysicalIdentifierType"
...
def serialize_json(value: PhysicalResourceId) -> dict:
    ...
    out["type"] = aws_sdk_resiliencehub.types.physical_identifier_type.serialize_json(
        value["type"]
    )
...
def deserialize_json(data: dict) -> PhysicalResourceId:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_resiliencehub.types.physical_identifier_type.deserialize_json(
                data["type"]
            )
        )
    else:
