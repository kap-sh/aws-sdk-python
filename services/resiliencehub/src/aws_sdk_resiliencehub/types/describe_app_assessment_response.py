...
class DescribeAppAssessmentResponse(TypedDict):
    assessment: "aws_sdk_resiliencehub.types.app_assessment.AppAssessment"
...
def serialize_json(value: DescribeAppAssessmentResponse) -> dict:
    ...
    out["assessment"] = aws_sdk_resiliencehub.types.app_assessment.serialize_json(
        value["assessment"]
    )
    return out
...
def deserialize_json(data: dict) -> DescribeAppAssessmentResponse:
    ...
    if "assessment" in data:
        ...
        out["assessment"] = aws_sdk_resiliencehub.types.app_assessment.deserialize_json(
            data["assessment"]
        )
    else:
