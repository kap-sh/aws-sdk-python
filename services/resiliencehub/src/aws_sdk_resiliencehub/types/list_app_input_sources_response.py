...
class ListAppInputSourcesResponse(TypedDict):
    app_input_sources: (
        "aws_sdk_resiliencehub.types.app_input_source_list.AppInputSourceList"
    )
...
def serialize_json(value: ListAppInputSourcesResponse) -> dict:
    ...
    out["appInputSources"] = (
        aws_sdk_resiliencehub.types.app_input_source_list.serialize_json(
...
def deserialize_json(data: dict) -> ListAppInputSourcesResponse:
    ...
    if "appInputSources" in data:
        ...
        out["app_input_sources"] = (
            aws_sdk_resiliencehub.types.app_input_source_list.deserialize_json(
