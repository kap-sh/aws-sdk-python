...
class DisruptionCompliance(TypedDict):
    achievable_rto_in_secs: "aws_sdk_resiliencehub.types.seconds.Seconds"
    """<p>The Recovery Time Objective (RTO) that is achievable, in seconds</p>"""
    current_rto_in_secs: "aws_sdk_resiliencehub.types.seconds.Seconds"
    """<p>The current RTO, in seconds.</p>"""
    rto_reference_id: NotRequired["aws_sdk_resiliencehub.types.string500.String500"]
    """<p>Reference identifier of the RTO.</p>"""
    rto_description: NotRequired["aws_sdk_resiliencehub.types.string500.String500"]
    """<p>The RTO description.</p>"""
    current_rpo_in_secs: "aws_sdk_resiliencehub.types.seconds.Seconds"
    """<p>The current RPO, in seconds.</p>"""
    rpo_reference_id: NotRequired["aws_sdk_resiliencehub.types.string500.String500"]
    """<p>Reference identifier of the RPO .</p>"""
    rpo_description: NotRequired["aws_sdk_resiliencehub.types.string500.String500"]
    """<p>The RPO description.</p>"""
    compliance_status: "aws_sdk_resiliencehub.types.compliance_status.ComplianceStatus"
    """<p>The current status of compliance for the resiliency policy.</p>"""
    achievable_rpo_in_secs: "aws_sdk_resiliencehub.types.seconds.Seconds"
