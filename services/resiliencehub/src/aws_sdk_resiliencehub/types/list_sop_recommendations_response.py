...
class ListSopRecommendationsResponse(TypedDict):
    ...
    sop_recommendations: (
        "aws_sdk_resiliencehub.types.sop_recommendation_list.SopRecommendationList"
    )
...
def serialize_json(value: ListSopRecommendationsResponse) -> dict:
    ...
    out["sopRecommendations"] = (
        aws_sdk_resiliencehub.types.sop_recommendation_list.serialize_json(
...
def deserialize_json(data: dict) -> ListSopRecommendationsResponse:
    ...
    if "sopRecommendations" in data:
        ...
        out["sop_recommendations"] = (
            aws_sdk_resiliencehub.types.sop_recommendation_list.deserialize_json(
