...
if TYPE_CHECKING:
    ...
    import aws_sdk_resiliencehub.types.eks_namespace


class EksSourceClusterNamespace(TypedDict):
    ...
    namespace: "aws_sdk_resiliencehub.types.eks_namespace.EksNamespace"
