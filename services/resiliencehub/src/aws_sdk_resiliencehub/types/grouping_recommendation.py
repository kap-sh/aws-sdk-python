...
if TYPE_CHECKING:
    ...
    import aws_sdk_resiliencehub.types.grouping_app_component
    import aws_sdk_resiliencehub.types.grouping_recommendation_confidence_level
    import aws_sdk_resiliencehub.types.grouping_recommendation_rejection_reason
    import aws_sdk_resiliencehub.types.grouping_recommendation_status_type
    import aws_sdk_resiliencehub.types.grouping_resource_list
...
class GroupingRecommendation(TypedDict, closed=True):
    ...
    grouping_app_component: (
        "aws_sdk_resiliencehub.types.grouping_app_component.GroupingAppComponent"
    )
    """<p>Indicates the name of the recommended Application Component (AppComponent).</p>"""
    resources: "aws_sdk_resiliencehub.types.grouping_resource_list.GroupingResourceList"
    ...
    recommendation_reasons: "aws_sdk_resiliencehub.types.string255_list.String255List"
    """<p>Indicates all the reasons available for rejecting a grouping recommendation.</p>"""
    status: "aws_sdk_resiliencehub.types.grouping_recommendation_status_type.GroupingRecommendationStatusType"
    """<p>Indicates the status of grouping resources into AppComponents.</p>"""
    confidence_level: "aws_sdk_resiliencehub.types.grouping_recommendation_confidence_level.GroupingRecommendationConfidenceLevel"
...
def serialize_json(value: GroupingRecommendation) -> dict:
    ...
    out["groupingAppComponent"] = (
        aws_sdk_resiliencehub.types.grouping_app_component.serialize_json(
    ...
    out["resources"] = (
        aws_sdk_resiliencehub.types.grouping_resource_list.serialize_json(
            value["resources"]
        )
    )
    ...
    out["status"] = (
        aws_sdk_resiliencehub.types.grouping_recommendation_status_type.serialize_json(
            value["status"]
        )
    )
    import aws_sdk_resiliencehub.types.grouping_recommendation_confidence_level
    ...
    out["confidenceLevel"] = (
        aws_sdk_resiliencehub.types.grouping_recommendation_confidence_level.serialize_json(
...
def deserialize_json(data: dict) -> GroupingRecommendation:
    ...
    if "groupingAppComponent" in data:
        ...
        out["grouping_app_component"] = (
            aws_sdk_resiliencehub.types.grouping_app_component.deserialize_json(
    ...
    if "resources" in data:
        ...
        out["resources"] = (
            aws_sdk_resiliencehub.types.grouping_resource_list.deserialize_json(
                data["resources"]
            )
        )
    else:
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_resiliencehub.types.grouping_recommendation_status_type.deserialize_json(
                data["status"]
            )
        )
    else:
    ...
    if "confidenceLevel" in data:
        ...
        out["confidence_level"] = (
            aws_sdk_resiliencehub.types.grouping_recommendation_confidence_level.deserialize_json(
