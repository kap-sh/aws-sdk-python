...
if TYPE_CHECKING:
    import aws_sdk_resiliencehub.types.iam_role_arn_list
    import aws_sdk_resiliencehub.types.iam_role_name
...
class PermissionModel(TypedDict, closed=True):
    ...
    invoker_role_name: NotRequired[
        "aws_sdk_resiliencehub.types.iam_role_name.IamRoleName"
    ]
    ...
    cross_account_role_arns: NotRequired[
        "aws_sdk_resiliencehub.types.iam_role_arn_list.IamRoleArnList"
    ]
...
def serialize_json(value: PermissionModel) -> dict:
    ...
    out["type"] = aws_sdk_resiliencehub.types.permission_model_type.serialize_json(
        value["type"]
    )
    ...
    if "cross_account_role_arns" in value:
        ...
        out["crossAccountRoleArns"] = (
            aws_sdk_resiliencehub.types.iam_role_arn_list.serialize_json(
...
def deserialize_json(data: dict) -> PermissionModel:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_resiliencehub.types.permission_model_type.deserialize_json(
                data["type"]
            )
        )
    else:
    ...
    if "crossAccountRoleArns" in data:
        ...
        out["cross_account_role_arns"] = (
            aws_sdk_resiliencehub.types.iam_role_arn_list.deserialize_json(
