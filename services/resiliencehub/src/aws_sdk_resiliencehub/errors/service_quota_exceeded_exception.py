"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.resiliencehub#ServiceQuotaExceededException``."""
