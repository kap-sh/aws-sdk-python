...
if TYPE_CHECKING:
    import aws_sdk_resiliencehub.types.resource_id
    import aws_sdk_resiliencehub.types.resource_type
...
class ResourceNotFoundException_(TypedDict, closed=True):
    ...
    resource_id: NotRequired["aws_sdk_resiliencehub.types.resource_id.ResourceId"]
    """<p>The identifier of the resource that the exception applies to.</p>"""
    resource_type: NotRequired["aws_sdk_resiliencehub.types.resource_type.ResourceType"]
