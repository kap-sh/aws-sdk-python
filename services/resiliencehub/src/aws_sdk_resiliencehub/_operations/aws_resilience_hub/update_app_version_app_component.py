...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.update_app_version_app_component_response.UpdateAppVersionAppComponentResponse = aws_sdk_resiliencehub.types.update_app_version_app_component_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.update_app_version_app_component_request.UpdateAppVersionAppComponentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.update_app_version_app_component_request.serialize_json(
            input_
        )
    ).encode()
