...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_app_version_resource_mappings_response.ListAppVersionResourceMappingsResponse = aws_sdk_resiliencehub.types.list_app_version_resource_mappings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_app_version_resource_mappings_request.ListAppVersionResourceMappingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_app_version_resource_mappings_request.serialize_json(
            input_
        )
    ).encode()
