...
def build_request(
    ...
    input: aws_sdk_resiliencehub.types.update_app_version_request.UpdateAppVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.update_app_version_request.serialize_json(input)
    ).encode()
