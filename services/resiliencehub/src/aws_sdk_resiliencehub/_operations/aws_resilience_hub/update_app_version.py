"""Generated from Smithy shape ``com.amazonaws.resiliencehub#UpdateAppVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.update_app_version_response.UpdateAppVersionResponse = aws_sdk_resiliencehub.types.update_app_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.update_app_version_request.UpdateAppVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/update-app-version"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehub.types.update_app_version_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.update_app_version_request.serialize_json(input_)
    ).encode()
...
async def async_update_app_version(
