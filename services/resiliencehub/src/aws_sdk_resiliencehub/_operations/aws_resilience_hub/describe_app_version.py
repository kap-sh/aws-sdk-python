...
def build_request(
    ...
    input: aws_sdk_resiliencehub.types.describe_app_version_request.DescribeAppVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.describe_app_version_request.serialize_json(input)
    ).encode()
