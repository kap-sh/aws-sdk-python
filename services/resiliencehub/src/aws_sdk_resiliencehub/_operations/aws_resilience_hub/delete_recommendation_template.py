"""Generated from Smithy shape ``com.amazonaws.resiliencehub#DeleteRecommendationTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.delete_recommendation_template_response.DeleteRecommendationTemplateResponse = aws_sdk_resiliencehub.types.delete_recommendation_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.delete_recommendation_template_request.DeleteRecommendationTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/delete-recommendation-template"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehub.types.delete_recommendation_template_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.delete_recommendation_template_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_delete_recommendation_template(
