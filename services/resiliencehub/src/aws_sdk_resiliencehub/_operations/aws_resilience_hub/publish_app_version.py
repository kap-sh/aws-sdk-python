"""Generated from Smithy shape ``com.amazonaws.resiliencehub#PublishAppVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.publish_app_version_response.PublishAppVersionResponse = aws_sdk_resiliencehub.types.publish_app_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_resiliencehub.types.publish_app_version_request.PublishAppVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.publish_app_version_request.serialize_json(input)
    ).encode()
...
async def async_publish_app_version(
