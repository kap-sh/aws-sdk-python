...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.update_app_version_resource_response.UpdateAppVersionResourceResponse = aws_sdk_resiliencehub.types.update_app_version_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.update_app_version_resource_request.UpdateAppVersionResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.update_app_version_resource_request.serialize_json(
            input_
        )
    ).encode()
