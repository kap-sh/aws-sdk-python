...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.reject_resource_grouping_recommendations_response.RejectResourceGroupingRecommendationsResponse = aws_sdk_resiliencehub.types.reject_resource_grouping_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.reject_resource_grouping_recommendations_request.RejectResourceGroupingRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.reject_resource_grouping_recommendations_request.serialize_json(
            input_
        )
    ).encode()
