...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_test_recommendations_response.ListTestRecommendationsResponse = aws_sdk_resiliencehub.types.list_test_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_test_recommendations_request.ListTestRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_test_recommendations_request.serialize_json(
            input_
        )
    ).encode()
