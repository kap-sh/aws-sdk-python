"""Generated from Smithy shape ``com.amazonaws.resiliencehub#CreateAppVersionAppComponent``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.create_app_version_app_component_response.CreateAppVersionAppComponentResponse = aws_sdk_resiliencehub.types.create_app_version_app_component_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.create_app_version_app_component_request.CreateAppVersionAppComponentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_app_version_app_component(
