"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListResourceGroupingRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_resource_grouping_recommendations_response.ListResourceGroupingRecommendationsResponse = aws_sdk_resiliencehub.types.list_resource_grouping_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_resource_grouping_recommendations_request.ListResourceGroupingRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-resource-grouping-recommendations"
    params: dict[str, str] = {}
...
async def async_list_resource_grouping_recommendations(
