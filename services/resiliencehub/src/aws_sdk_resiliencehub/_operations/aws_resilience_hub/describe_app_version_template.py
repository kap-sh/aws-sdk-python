...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.describe_app_version_template_response.DescribeAppVersionTemplateResponse = aws_sdk_resiliencehub.types.describe_app_version_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.describe_app_version_template_request.DescribeAppVersionTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.describe_app_version_template_request.serialize_json(
            input_
        )
    ).encode()
