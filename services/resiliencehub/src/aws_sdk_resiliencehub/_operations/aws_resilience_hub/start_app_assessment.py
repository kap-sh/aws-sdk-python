"""Generated from Smithy shape ``com.amazonaws.resiliencehub#StartAppAssessment``."""
...
import aws_sdk_resiliencehub.types.app_assessment
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.start_app_assessment_response.StartAppAssessmentResponse = aws_sdk_resiliencehub.types.start_app_assessment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.start_app_assessment_request.StartAppAssessmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/start-app-assessment"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.start_app_assessment_request.serialize_json(input_)
    ).encode()
...
async def async_start_app_assessment(
