...
def build_request(
    ...
    input: aws_sdk_resiliencehub.types.start_app_assessment_request.StartAppAssessmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.start_app_assessment_request.serialize_json(input)
    ).encode()
