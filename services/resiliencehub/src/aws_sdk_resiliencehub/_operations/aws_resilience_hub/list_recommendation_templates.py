...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_recommendation_templates_response.ListRecommendationTemplatesResponse = aws_sdk_resiliencehub.types.list_recommendation_templates_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_resiliencehub.types.list_recommendation_templates_request.ListRecommendationTemplatesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "assessment_arn" in input:
        params["assessmentArn"] = str(input["assessment_arn"])
    if "reverse_order" in input:
        params["reverseOrder"] = str(input["reverse_order"])
    if "status" in input:
        params["status"] = str(input["status"])
    if "recommendation_template_arn" in input:
        params["recommendationTemplateArn"] = str(input["recommendation_template_arn"])
    if "name" in input:
