...
import aws_sdk_resiliencehub.types.row_list
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_metrics_response.ListMetricsResponse = (
        aws_sdk_resiliencehub.types.list_metrics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_metrics_request.ListMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_metrics_request.serialize_json(input_)
    ).encode()
