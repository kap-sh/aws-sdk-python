"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListSuggestedResiliencyPolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_suggested_resiliency_policies_response.ListSuggestedResiliencyPoliciesResponse = aws_sdk_resiliencehub.types.list_suggested_resiliency_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_suggested_resiliency_policies_request.ListSuggestedResiliencyPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-suggested-resiliency-policies"
    params: dict[str, str] = {}
...
async def async_list_suggested_resiliency_policies(
