...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.describe_app_assessment_response.DescribeAppAssessmentResponse = aws_sdk_resiliencehub.types.describe_app_assessment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.describe_app_assessment_request.DescribeAppAssessmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.describe_app_assessment_request.serialize_json(
            input_
        )
    ).encode()
