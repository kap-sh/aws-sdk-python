...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_alarm_recommendations_response.ListAlarmRecommendationsResponse = aws_sdk_resiliencehub.types.list_alarm_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_alarm_recommendations_request.ListAlarmRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_alarm_recommendations_request.serialize_json(
            input_
        )
    ).encode()
