"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListAppVersionResources``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_app_version_resources_response.ListAppVersionResourcesResponse = aws_sdk_resiliencehub.types.list_app_version_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_app_version_resources_request.ListAppVersionResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-app-version-resources"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehub.types.list_app_version_resources_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_app_version_resources_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_app_version_resources(
