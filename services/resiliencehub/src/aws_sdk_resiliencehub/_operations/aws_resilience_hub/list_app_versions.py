...
def build_request(
    ...
    input: aws_sdk_resiliencehub.types.list_app_versions_request.ListAppVersionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_app_versions_request.serialize_json(input)
    ).encode()
