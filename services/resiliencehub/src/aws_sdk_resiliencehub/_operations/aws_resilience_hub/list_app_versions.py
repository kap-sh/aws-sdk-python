...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_app_versions_response.ListAppVersionsResponse = aws_sdk_resiliencehub.types.list_app_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_app_versions_request.ListAppVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_app_versions_request.serialize_json(input_)
    ).encode()
