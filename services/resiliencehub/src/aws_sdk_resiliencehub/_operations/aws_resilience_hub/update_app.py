"""Generated from Smithy shape ``com.amazonaws.resiliencehub#UpdateApp``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.update_app_response.UpdateAppResponse = (
        aws_sdk_resiliencehub.types.update_app_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.update_app_request.UpdateAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/update-app"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehub.types.update_app_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.update_app_request.serialize_json(input_)
    ).encode()
...
def update_app(
    ...
    aws_sdk_resiliencehub.types.update_app_response.UpdateAppResponse, zapros.Response
]:
