...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.create_recommendation_template_response.CreateRecommendationTemplateResponse = aws_sdk_resiliencehub.types.create_recommendation_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.create_recommendation_template_request.CreateRecommendationTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.create_recommendation_template_request.serialize_json(
            input_
        )
    ).encode()
