...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.batch_update_recommendation_status_response.BatchUpdateRecommendationStatusResponse = aws_sdk_resiliencehub.types.batch_update_recommendation_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.batch_update_recommendation_status_request.BatchUpdateRecommendationStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.batch_update_recommendation_status_request.serialize_json(
            input_
        )
    ).encode()
