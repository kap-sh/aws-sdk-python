...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.describe_draft_app_version_resources_import_status_response.DescribeDraftAppVersionResourcesImportStatusResponse = aws_sdk_resiliencehub.types.describe_draft_app_version_resources_import_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.describe_draft_app_version_resources_import_status_request.DescribeDraftAppVersionResourcesImportStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.describe_draft_app_version_resources_import_status_request.serialize_json(
            input_
        )
    ).encode()
