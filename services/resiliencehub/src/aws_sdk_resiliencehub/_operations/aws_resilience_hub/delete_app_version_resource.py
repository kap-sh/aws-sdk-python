...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.delete_app_version_resource_response.DeleteAppVersionResourceResponse = aws_sdk_resiliencehub.types.delete_app_version_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.delete_app_version_resource_request.DeleteAppVersionResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.delete_app_version_resource_request.serialize_json(
            input_
        )
    ).encode()
