"""Generated from Smithy shape ``com.amazonaws.resiliencehub#CreateApp``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.create_app_response.CreateAppResponse = (
        aws_sdk_resiliencehub.types.create_app_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.create_app_request.CreateAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/create-app"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.create_app_request.serialize_json(input_)
    ).encode()
...
def create_app(
    ...
    aws_sdk_resiliencehub.types.create_app_response.CreateAppResponse, zapros.Response
]:
