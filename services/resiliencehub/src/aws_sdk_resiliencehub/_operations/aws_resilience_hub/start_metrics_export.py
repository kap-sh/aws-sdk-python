...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.start_metrics_export_response.StartMetricsExportResponse = aws_sdk_resiliencehub.types.start_metrics_export_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.start_metrics_export_request.StartMetricsExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.start_metrics_export_request.serialize_json(input_)
    ).encode()
