...
def build_request(
    ...
    input: aws_sdk_resiliencehub.types.start_metrics_export_request.StartMetricsExportRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.start_metrics_export_request.serialize_json(input)
    ).encode()
