"""Generated from Smithy shape ``com.amazonaws.resiliencehub#DescribeAppVersionResource``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.describe_app_version_resource_response.DescribeAppVersionResourceResponse = aws_sdk_resiliencehub.types.describe_app_version_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.describe_app_version_resource_request.DescribeAppVersionResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/describe-app-version-resource"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehub.types.describe_app_version_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.describe_app_version_resource_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_describe_app_version_resource(
