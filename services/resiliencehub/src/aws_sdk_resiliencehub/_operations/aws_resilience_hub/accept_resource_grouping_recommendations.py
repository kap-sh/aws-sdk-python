...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.accept_resource_grouping_recommendations_response.AcceptResourceGroupingRecommendationsResponse = aws_sdk_resiliencehub.types.accept_resource_grouping_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.accept_resource_grouping_recommendations_request.AcceptResourceGroupingRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.accept_resource_grouping_recommendations_request.serialize_json(
            input_
        )
    ).encode()
