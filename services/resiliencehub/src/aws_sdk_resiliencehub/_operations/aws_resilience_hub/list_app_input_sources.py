...
def build_request(
    ...
    input: aws_sdk_resiliencehub.types.list_app_input_sources_request.ListAppInputSourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_app_input_sources_request.serialize_json(input)
    ).encode()
