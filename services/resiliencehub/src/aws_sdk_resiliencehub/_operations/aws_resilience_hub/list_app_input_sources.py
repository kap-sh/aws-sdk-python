"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListAppInputSources``."""
...
import aws_sdk_resiliencehub.types.app_input_source_list
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_app_input_sources_response.ListAppInputSourcesResponse = aws_sdk_resiliencehub.types.list_app_input_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_app_input_sources_request.ListAppInputSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-app-input-sources"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehub.types.list_app_input_sources_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_app_input_sources_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_app_input_sources(
