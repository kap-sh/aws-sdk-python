...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.describe_app_version_resources_resolution_status_response.DescribeAppVersionResourcesResolutionStatusResponse = aws_sdk_resiliencehub.types.describe_app_version_resources_resolution_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.describe_app_version_resources_resolution_status_request.DescribeAppVersionResourcesResolutionStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.describe_app_version_resources_resolution_status_request.serialize_json(
            input_
        )
    ).encode()
