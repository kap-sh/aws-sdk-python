...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_app_version_app_components_response.ListAppVersionAppComponentsResponse = aws_sdk_resiliencehub.types.list_app_version_app_components_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_app_version_app_components_request.ListAppVersionAppComponentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_app_version_app_components_request.serialize_json(
            input_
        )
    ).encode()
