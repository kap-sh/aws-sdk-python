...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.delete_app_version_app_component_response.DeleteAppVersionAppComponentResponse = aws_sdk_resiliencehub.types.delete_app_version_app_component_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.delete_app_version_app_component_request.DeleteAppVersionAppComponentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.delete_app_version_app_component_request.serialize_json(
            input_
        )
    ).encode()
