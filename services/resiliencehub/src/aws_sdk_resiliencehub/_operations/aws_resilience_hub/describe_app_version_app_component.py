"""Generated from Smithy shape ``com.amazonaws.resiliencehub#DescribeAppVersionAppComponent``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.describe_app_version_app_component_response.DescribeAppVersionAppComponentResponse = aws_sdk_resiliencehub.types.describe_app_version_app_component_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.describe_app_version_app_component_request.DescribeAppVersionAppComponentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/describe-app-version-app-component"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehub.types.describe_app_version_app_component_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.describe_app_version_app_component_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_describe_app_version_app_component(
