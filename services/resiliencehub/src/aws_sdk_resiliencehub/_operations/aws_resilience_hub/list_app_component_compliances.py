"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListAppComponentCompliances``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_app_component_compliances_response.ListAppComponentCompliancesResponse = aws_sdk_resiliencehub.types.list_app_component_compliances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_app_component_compliances_request.ListAppComponentCompliancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-app-component-compliances"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehub.types.list_app_component_compliances_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_app_component_compliances_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_app_component_compliances(
