...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.delete_app_response.DeleteAppResponse = (
        aws_sdk_resiliencehub.types.delete_app_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.delete_app_request.DeleteAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.delete_app_request.serialize_json(input_)
    ).encode()
...
def delete_app(
    ...
    aws_sdk_resiliencehub.types.delete_app_response.DeleteAppResponse, zapros.Response
]:
