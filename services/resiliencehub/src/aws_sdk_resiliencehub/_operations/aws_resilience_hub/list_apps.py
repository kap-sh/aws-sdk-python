...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_apps_response.ListAppsResponse = (
        aws_sdk_resiliencehub.types.list_apps_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_resiliencehub.types.list_apps_request.ListAppsRequest,
) -> zapros.Request:
    ...
    if "from_last_assessment_time" in input:
        params["fromLastAssessmentTime"] = str(input["from_last_assessment_time"])
    if "to_last_assessment_time" in input:
        params["toLastAssessmentTime"] = str(input["to_last_assessment_time"])
    if "reverse_order" in input:
        params["reverseOrder"] = str(input["reverse_order"])
    if "aws_application_arn" in input:
        params["awsApplicationArn"] = str(input["aws_application_arn"])
...
def list_apps(
    ...
    aws_sdk_resiliencehub.types.list_apps_response.ListAppsResponse, zapros.Response
]:
