...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.delete_app_assessment_response.DeleteAppAssessmentResponse = aws_sdk_resiliencehub.types.delete_app_assessment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.delete_app_assessment_request.DeleteAppAssessmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.delete_app_assessment_request.serialize_json(input_)
    ).encode()
