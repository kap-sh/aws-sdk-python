...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.update_resiliency_policy_response.UpdateResiliencyPolicyResponse = aws_sdk_resiliencehub.types.update_resiliency_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.update_resiliency_policy_request.UpdateResiliencyPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.update_resiliency_policy_request.serialize_json(
            input_
        )
    ).encode()
