...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.put_draft_app_version_template_response.PutDraftAppVersionTemplateResponse = aws_sdk_resiliencehub.types.put_draft_app_version_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.put_draft_app_version_template_request.PutDraftAppVersionTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.put_draft_app_version_template_request.serialize_json(
            input_
        )
    ).encode()
