...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.describe_metrics_export_response.DescribeMetricsExportResponse = aws_sdk_resiliencehub.types.describe_metrics_export_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.describe_metrics_export_request.DescribeMetricsExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.describe_metrics_export_request.serialize_json(
            input_
        )
    ).encode()
