...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_app_assessment_compliance_drifts_response.ListAppAssessmentComplianceDriftsResponse = aws_sdk_resiliencehub.types.list_app_assessment_compliance_drifts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_app_assessment_compliance_drifts_request.ListAppAssessmentComplianceDriftsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_app_assessment_compliance_drifts_request.serialize_json(
            input_
        )
    ).encode()
