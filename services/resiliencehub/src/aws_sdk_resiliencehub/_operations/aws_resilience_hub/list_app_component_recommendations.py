...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_app_component_recommendations_response.ListAppComponentRecommendationsResponse = aws_sdk_resiliencehub.types.list_app_component_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_app_component_recommendations_request.ListAppComponentRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_app_component_recommendations_request.serialize_json(
            input_
        )
    ).encode()
