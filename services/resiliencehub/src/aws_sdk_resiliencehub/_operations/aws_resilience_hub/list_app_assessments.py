...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_app_assessments_response.ListAppAssessmentsResponse = aws_sdk_resiliencehub.types.list_app_assessments_response.deserialize_json(
