...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.import_resources_to_draft_app_version_response.ImportResourcesToDraftAppVersionResponse = aws_sdk_resiliencehub.types.import_resources_to_draft_app_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.import_resources_to_draft_app_version_request.ImportResourcesToDraftAppVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.import_resources_to_draft_app_version_request.serialize_json(
            input_
        )
    ).encode()
