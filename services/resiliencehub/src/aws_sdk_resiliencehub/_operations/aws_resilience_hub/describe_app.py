...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.describe_app_response.DescribeAppResponse = (
        aws_sdk_resiliencehub.types.describe_app_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.describe_app_request.DescribeAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.describe_app_request.serialize_json(input_)
    ).encode()
