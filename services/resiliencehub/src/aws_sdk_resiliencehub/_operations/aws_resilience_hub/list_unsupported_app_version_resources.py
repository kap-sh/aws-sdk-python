...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_unsupported_app_version_resources_response.ListUnsupportedAppVersionResourcesResponse = aws_sdk_resiliencehub.types.list_unsupported_app_version_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.list_unsupported_app_version_resources_request.ListUnsupportedAppVersionResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehub.types.list_unsupported_app_version_resources_request.serialize_json(
            input_
        )
    ).encode()
