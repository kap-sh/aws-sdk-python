"""Generated from Smithy shape ``com.amazonaws.resiliencehub#CreateAppVersionResource``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.create_app_version_resource_response.CreateAppVersionResourceResponse = aws_sdk_resiliencehub.types.create_app_version_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.create_app_version_resource_request.CreateAppVersionResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_app_version_resource(
