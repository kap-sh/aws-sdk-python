...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.list_resiliency_policies_response.ListResiliencyPoliciesResponse = aws_sdk_resiliencehub.types.list_resiliency_policies_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_resiliencehub.types.list_resiliency_policies_request.ListResiliencyPoliciesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "policy_name" in input:
        params["policyName"] = str(input["policy_name"])
