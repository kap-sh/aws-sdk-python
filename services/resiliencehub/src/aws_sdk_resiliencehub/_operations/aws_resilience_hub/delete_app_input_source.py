...
def handle_response(
    ...
    out: aws_sdk_resiliencehub.types.delete_app_input_source_response.DeleteAppInputSourceResponse = aws_sdk_resiliencehub.types.delete_app_input_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehub.types.delete_app_input_source_request.DeleteAppInputSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
