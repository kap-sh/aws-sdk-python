...
class ConfigurationOptionsDescription(TypedDict, closed=True):
    ...
    options: NotRequired[
        "capo_elastic_beanstalk.types.configuration_option_descriptions_list.ConfigurationOptionDescriptionsList"
    ]
...
def deserialize_query(el: Element) -> ConfigurationOptionsDescription:
    ...
    if child_options is not None:
        ...
        out["options"] = (
            capo_elastic_beanstalk.types.configuration_option_descriptions_list.deserialize_query(
                child_options
            )
        )
    return out
