...
class InstanceHealthSummary(TypedDict, closed=True):
    ...
    ok: NotRequired["capo_elastic_beanstalk.types.nullable_integer.NullableInteger"]
    """<p> <b>Green.</b> An instance is passing health checks and the health agent is not reporting any problems.</p>"""
    info: NotRequired["capo_elastic_beanstalk.types.nullable_integer.NullableInteger"]
    ...
    severe: NotRequired["capo_elastic_beanstalk.types.nullable_integer.NullableInteger"]
