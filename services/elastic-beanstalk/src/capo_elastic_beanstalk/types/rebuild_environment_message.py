"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#RebuildEnvironmentMessage``."""
...
class RebuildEnvironmentMessage(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: RebuildEnvironmentMessage, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> RebuildEnvironmentMessage:
    out: RebuildEnvironmentMessage = {}  # type: ignore[typeddict-item]
