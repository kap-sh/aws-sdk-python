...
class ManagedAction(TypedDict, closed=True):
    ...
    status: NotRequired["capo_elastic_beanstalk.types.action_status.ActionStatus"]
    ...
    window_start_time: NotRequired["capo_elastic_beanstalk.types.timestamp.Timestamp"]
...
def deserialize_query(el: Element) -> ManagedAction:
    ...
    if child_status is not None:
        ...
        out["status"] = capo_elastic_beanstalk.types.action_status.deserialize_query(
            child_status
        )
    ...
    if child_window_start_time is not None:
        ...
        out["window_start_time"] = (
            capo_elastic_beanstalk.types.timestamp.deserialize_query(
