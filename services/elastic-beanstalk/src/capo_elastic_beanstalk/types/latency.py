...
if TYPE_CHECKING:
    import capo_elastic_beanstalk.types.nullable_double


class Latency(TypedDict, closed=True):
    p999: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    """<p>The average latency for the slowest 0.1 percent of requests over the last 10 seconds.</p>"""
    p99: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    """<p>The average latency for the slowest 1 percent of requests over the last 10 seconds.</p>"""
    p95: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    """<p>The average latency for the slowest 5 percent of requests over the last 10 seconds.</p>"""
    p90: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    """<p>The average latency for the slowest 10 percent of requests over the last 10 seconds.</p>"""
    p85: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    """<p>The average latency for the slowest 15 percent of requests over the last 10 seconds.</p>"""
    p75: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    """<p>The average latency for the slowest 25 percent of requests over the last 10 seconds.</p>"""
    p50: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    """<p>The average latency for the slowest 50 percent of requests over the last 10 seconds.</p>"""
    p10: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
