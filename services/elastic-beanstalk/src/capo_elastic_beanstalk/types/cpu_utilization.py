...
class CPUUtilization(TypedDict, closed=True):
    user: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    """<p>Percentage of time that the CPU has spent in the <code>User</code> state over the last 10 seconds.</p>"""
    nice: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    ...
    system: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    ...
    idle: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    """<p>Percentage of time that the CPU has spent in the <code>Idle</code> state over the last 10 seconds.</p>"""
    io_wait: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    ...
    irq: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    ...
    soft_irq: NotRequired["capo_elastic_beanstalk.types.nullable_double.NullableDouble"]
    ...
    privileged: NotRequired[
        "capo_elastic_beanstalk.types.nullable_double.NullableDouble"
    ]
