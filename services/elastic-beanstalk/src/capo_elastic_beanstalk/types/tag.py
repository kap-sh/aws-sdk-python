...
if TYPE_CHECKING:
    ...
    import capo_elastic_beanstalk.types.tag_value


class Tag(TypedDict, closed=True):
    key: NotRequired["capo_elastic_beanstalk.types.tag_key.TagKey"]
    """<p>The key of the tag.</p>"""
    value: NotRequired["capo_elastic_beanstalk.types.tag_value.TagValue"]
