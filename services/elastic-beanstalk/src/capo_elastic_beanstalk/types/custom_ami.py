...
if TYPE_CHECKING:
    import capo_elastic_beanstalk.types.image_id
    import capo_elastic_beanstalk.types.virtualization_type


class CustomAmi(TypedDict, closed=True):
    virtualization_type: NotRequired[
        "capo_elastic_beanstalk.types.virtualization_type.VirtualizationType"
    ]
    """<p>The type of virtualization used to create the custom AMI.</p>"""
    image_id: NotRequired["capo_elastic_beanstalk.types.image_id.ImageId"]
