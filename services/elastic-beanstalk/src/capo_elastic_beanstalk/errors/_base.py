...
class ElasticBeanstalkError(Exception):
    """Base class for all ElasticBeanstalk service errors."""


class ServiceError(ElasticBeanstalkError):
...
class SerializationError(ElasticBeanstalkError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ElasticBeanstalkError):
...
class WaiterFailedError(ElasticBeanstalkError):
...
class WaiterTimeoutError(ElasticBeanstalkError):
