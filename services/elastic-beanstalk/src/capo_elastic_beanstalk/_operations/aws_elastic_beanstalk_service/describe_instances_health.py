"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeInstancesHealth``."""
...
import capo_elastic_beanstalk.errors.invalid_request_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRequestException":
            raise capo_elastic_beanstalk.errors.invalid_request_exception.InvalidRequestException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeInstancesHealthResult")
    out: capo_elastic_beanstalk.types.describe_instances_health_result.DescribeInstancesHealthResult = capo_elastic_beanstalk.types.describe_instances_health_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeInstancesHealth"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.describe_instances_health_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_instances_health(
