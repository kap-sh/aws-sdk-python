"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#UpdateApplication``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdateApplicationResult")
...
def build_request(
    ...
    pairs.append(("Action", "UpdateApplication"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.update_application_message.serialize_query(
        input_, pairs, ""
    )
