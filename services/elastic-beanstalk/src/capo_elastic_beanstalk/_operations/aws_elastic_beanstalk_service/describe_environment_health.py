"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeEnvironmentHealth``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeEnvironmentHealthResult")
    out: capo_elastic_beanstalk.types.describe_environment_health_result.DescribeEnvironmentHealthResult = capo_elastic_beanstalk.types.describe_environment_health_result.deserialize_query(
...
def build_request(
    ...
    capo_elastic_beanstalk.types.describe_environment_health_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_environment_health(
