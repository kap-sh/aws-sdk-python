"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#CreateConfigurationTemplate``."""
...
import capo_elastic_beanstalk.errors.too_many_buckets_exception
import capo_elastic_beanstalk.errors.too_many_configuration_templates_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyBucketsException":
            raise capo_elastic_beanstalk.errors.too_many_buckets_exception.TooManyBucketsException.from_query(
                root
            )
        case "TooManyConfigurationTemplatesException":
            raise capo_elastic_beanstalk.errors.too_many_configuration_templates_exception.TooManyConfigurationTemplatesException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateConfigurationTemplateResult")
    out: capo_elastic_beanstalk.types.configuration_settings_description.ConfigurationSettingsDescription = capo_elastic_beanstalk.types.configuration_settings_description.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateConfigurationTemplate"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.create_configuration_template_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_configuration_template(
