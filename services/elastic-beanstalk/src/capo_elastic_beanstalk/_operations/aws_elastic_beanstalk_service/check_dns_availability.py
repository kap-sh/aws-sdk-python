"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#CheckDNSAvailability``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CheckDNSAvailabilityResult")
    out: capo_elastic_beanstalk.types.check_dns_availability_result_message.CheckDNSAvailabilityResultMessage = capo_elastic_beanstalk.types.check_dns_availability_result_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CheckDNSAvailability"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.check_dns_availability_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_check_dns_availability(
