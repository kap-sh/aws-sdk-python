"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#SwapEnvironmentCNAMEs``."""
...
def build_request(
    ...
    pairs.append(("Action", "SwapEnvironmentCNAMEs"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.swap_environment_cnam_es_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_swap_environment_cnam_es(
