"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DeleteConfigurationTemplate``."""
...
def build_request(
    ...
    pairs.append(("Action", "DeleteConfigurationTemplate"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.delete_configuration_template_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_configuration_template(
