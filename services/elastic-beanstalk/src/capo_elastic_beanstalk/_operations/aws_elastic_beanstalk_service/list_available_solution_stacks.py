"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#ListAvailableSolutionStacks``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListAvailableSolutionStacksResult")
    out: capo_elastic_beanstalk.types.list_available_solution_stacks_result_message.ListAvailableSolutionStacksResultMessage = capo_elastic_beanstalk.types.list_available_solution_stacks_result_message.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "ListAvailableSolutionStacks"))
...
async def async_list_available_solution_stacks(
