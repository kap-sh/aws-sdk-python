"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#CreatePlatformVersion``."""
...
import capo_elastic_beanstalk.errors.too_many_platforms_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyPlatformsException":
            raise capo_elastic_beanstalk.errors.too_many_platforms_exception.TooManyPlatformsException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreatePlatformVersionResult")
    out: capo_elastic_beanstalk.types.create_platform_version_result.CreatePlatformVersionResult = capo_elastic_beanstalk.types.create_platform_version_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreatePlatformVersion"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.create_platform_version_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_platform_version(
