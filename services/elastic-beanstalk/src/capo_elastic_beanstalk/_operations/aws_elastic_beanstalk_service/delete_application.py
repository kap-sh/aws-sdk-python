"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DeleteApplication``."""
...
def build_request(
    ...
    pairs.append(("Action", "DeleteApplication"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.delete_application_message.serialize_query(
        input_, pairs, ""
    )
