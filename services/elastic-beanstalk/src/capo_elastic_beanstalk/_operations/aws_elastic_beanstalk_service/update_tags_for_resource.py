"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#UpdateTagsForResource``."""
...
import capo_elastic_beanstalk.errors.resource_not_found_exception
import capo_elastic_beanstalk.errors.resource_type_not_supported_exception
import capo_elastic_beanstalk.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_elastic_beanstalk.errors.resource_not_found_exception.ResourceNotFoundException.from_query(
                root
            )
        case "ResourceTypeNotSupportedException":
            raise capo_elastic_beanstalk.errors.resource_type_not_supported_exception.ResourceTypeNotSupportedException.from_query(
                root
            )
        case "TooManyTagsException":
            raise capo_elastic_beanstalk.errors.too_many_tags_exception.TooManyTagsException.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    pairs.append(("Action", "UpdateTagsForResource"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.update_tags_for_resource_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_update_tags_for_resource(
