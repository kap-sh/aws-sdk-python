"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#CreateApplicationVersion``."""
...
import capo_elastic_beanstalk.errors.code_build_not_in_service_region_exception
import capo_elastic_beanstalk.errors.insufficient_privileges_exception
import capo_elastic_beanstalk.errors.s3_location_not_in_service_region_exception
import capo_elastic_beanstalk.errors.too_many_application_versions_exception
import capo_elastic_beanstalk.errors.too_many_applications_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CodeBuildNotInServiceRegionException":
            raise capo_elastic_beanstalk.errors.code_build_not_in_service_region_exception.CodeBuildNotInServiceRegionException.from_query(
                root
            )
        ...
        case "S3LocationNotInServiceRegionException":
            raise capo_elastic_beanstalk.errors.s3_location_not_in_service_region_exception.S3LocationNotInServiceRegionException.from_query(
                root
            )
        case "TooManyApplicationsException":
            raise capo_elastic_beanstalk.errors.too_many_applications_exception.TooManyApplicationsException.from_query(
                root
            )
        case "TooManyApplicationVersionsException":
            raise capo_elastic_beanstalk.errors.too_many_application_versions_exception.TooManyApplicationVersionsException.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    pairs.append(("Action", "CreateApplicationVersion"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.create_application_version_message.serialize_query(
        input_, pairs, ""
    )
