"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#AbortEnvironmentUpdate``."""
...
def build_request(
    ...
    pairs.append(("Action", "AbortEnvironmentUpdate"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.abort_environment_update_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_abort_environment_update(
