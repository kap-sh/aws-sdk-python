"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeAccountAttributes``."""
...
def handle_response(
    ...
    out: capo_elastic_beanstalk.types.describe_account_attributes_result.DescribeAccountAttributesResult = capo_elastic_beanstalk.types.describe_account_attributes_result.deserialize_query(
