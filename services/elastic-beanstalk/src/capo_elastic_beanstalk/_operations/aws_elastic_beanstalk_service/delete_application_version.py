"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DeleteApplicationVersion``."""
...
import capo_elastic_beanstalk.errors.source_bundle_deletion_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SourceBundleDeletionException":
            raise capo_elastic_beanstalk.errors.source_bundle_deletion_exception.SourceBundleDeletionException.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    pairs.append(("Action", "DeleteApplicationVersion"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.delete_application_version_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_application_version(
