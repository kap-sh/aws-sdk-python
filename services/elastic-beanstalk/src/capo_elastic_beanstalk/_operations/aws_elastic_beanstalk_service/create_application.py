"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#CreateApplication``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateApplicationResult")
    out: capo_elastic_beanstalk.types.application_description_message.ApplicationDescriptionMessage = capo_elastic_beanstalk.types.application_description_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateApplication"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.create_application_message.serialize_query(
        input_, pairs, ""
    )
