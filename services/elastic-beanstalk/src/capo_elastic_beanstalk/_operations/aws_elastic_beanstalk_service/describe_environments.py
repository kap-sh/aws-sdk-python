"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeEnvironments``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeEnvironmentsResult")
    out: capo_elastic_beanstalk.types.environment_descriptions_message.EnvironmentDescriptionsMessage = capo_elastic_beanstalk.types.environment_descriptions_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeEnvironments"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.describe_environments_message.serialize_query(
        input_, pairs, ""
    )
