"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#InvalidRequestException``."""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: InvalidRequestException_, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "message" in value:
        pairs.append((f"{prefix}.message", str(value["message"])))


def deserialize_query(el: Element) -> InvalidRequestException_:
...
class InvalidRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticbeanstalk#InvalidRequestException``."""
    ...
    @classmethod
    def from_query(cls, el: Element) -> "InvalidRequestException":
