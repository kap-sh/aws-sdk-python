...
from ._services.async_elastic_beanstalk import (
    AsyncElasticBeanstalkClient as AsyncElasticBeanstalkClient,
)
from ._services.elastic_beanstalk import (
    ElasticBeanstalkClient as ElasticBeanstalkClient,
)
