...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.configuration_settings_validation_messages.ConfigurationSettingsValidationMessages = aws_sdk_elastic_beanstalk.types.configuration_settings_validation_messages.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.validate_configuration_settings_message.ValidateConfigurationSettingsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.validate_configuration_settings_message.serialize_query(
        input_, pairs, ""
    )
