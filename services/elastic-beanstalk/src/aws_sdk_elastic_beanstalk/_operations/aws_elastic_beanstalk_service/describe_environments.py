...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.environment_descriptions_message.EnvironmentDescriptionsMessage = aws_sdk_elastic_beanstalk.types.environment_descriptions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_environments_message.DescribeEnvironmentsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.describe_environments_message.serialize_query(
        input_, pairs, ""
    )
