...
import aws_sdk_elastic_beanstalk.errors.too_many_platforms_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyPlatformsException":
            raise aws_sdk_elastic_beanstalk.errors.too_many_platforms_exception.TooManyPlatformsException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.create_platform_version_result.CreatePlatformVersionResult = aws_sdk_elastic_beanstalk.types.create_platform_version_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.create_platform_version_request.CreatePlatformVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.create_platform_version_request.serialize_query(
        input_, pairs, ""
    )
