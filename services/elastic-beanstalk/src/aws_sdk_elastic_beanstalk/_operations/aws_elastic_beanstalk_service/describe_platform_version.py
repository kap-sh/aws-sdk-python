...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.describe_platform_version_result.DescribePlatformVersionResult = aws_sdk_elastic_beanstalk.types.describe_platform_version_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_platform_version_request.DescribePlatformVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.describe_platform_version_request.serialize_query(
        input_, pairs, ""
    )
