...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.compose_environments_message.ComposeEnvironmentsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.compose_environments_message.serialize_query(
        input_, pairs, ""
    )
