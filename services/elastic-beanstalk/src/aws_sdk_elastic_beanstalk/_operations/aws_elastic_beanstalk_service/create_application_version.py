...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.create_application_version_message.CreateApplicationVersionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.create_application_version_message.serialize_query(
        input_, pairs, ""
    )
