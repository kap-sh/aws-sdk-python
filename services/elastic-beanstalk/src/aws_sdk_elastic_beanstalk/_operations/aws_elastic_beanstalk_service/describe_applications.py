...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.application_descriptions_message.ApplicationDescriptionsMessage = aws_sdk_elastic_beanstalk.types.application_descriptions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_applications_message.DescribeApplicationsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.describe_applications_message.serialize_query(
        input_, pairs, ""
    )
