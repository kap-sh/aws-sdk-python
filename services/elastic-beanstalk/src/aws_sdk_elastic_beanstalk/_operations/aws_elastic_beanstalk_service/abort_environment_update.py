...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.abort_environment_update_message.AbortEnvironmentUpdateMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.abort_environment_update_message.serialize_query(
        input_, pairs, ""
    )
