"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#RestartAppServer``."""
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.restart_app_server_message.RestartAppServerMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RestartAppServer"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_elastic_beanstalk.types.restart_app_server_message

    aws_sdk_elastic_beanstalk.types.restart_app_server_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_restart_app_server(
