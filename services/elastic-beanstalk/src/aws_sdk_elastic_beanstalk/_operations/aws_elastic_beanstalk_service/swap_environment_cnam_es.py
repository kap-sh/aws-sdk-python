...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.swap_environment_cnam_es_message.SwapEnvironmentCNAMEsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.swap_environment_cnam_es_message.serialize_query(
        input_, pairs, ""
    )
