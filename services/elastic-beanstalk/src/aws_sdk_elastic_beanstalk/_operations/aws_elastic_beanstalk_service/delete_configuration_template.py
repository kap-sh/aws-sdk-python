...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.delete_configuration_template_message.DeleteConfigurationTemplateMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.delete_configuration_template_message.serialize_query(
        input_, pairs, ""
    )
