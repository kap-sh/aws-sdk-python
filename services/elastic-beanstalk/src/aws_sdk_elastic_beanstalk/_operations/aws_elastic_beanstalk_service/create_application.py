...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.application_description_message.ApplicationDescriptionMessage = aws_sdk_elastic_beanstalk.types.application_description_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.create_application_message.CreateApplicationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.create_application_message.serialize_query(
        input_, pairs, ""
    )
