...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.list_available_solution_stacks_result_message.ListAvailableSolutionStacksResultMessage = aws_sdk_elastic_beanstalk.types.list_available_solution_stacks_result_message.deserialize_query(
