...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRequestException":
            import aws_sdk_elastic_beanstalk.errors.invalid_request_exception

            raise aws_sdk_elastic_beanstalk.errors.invalid_request_exception.InvalidRequestException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.describe_instances_health_result.DescribeInstancesHealthResult = aws_sdk_elastic_beanstalk.types.describe_instances_health_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_instances_health_request.DescribeInstancesHealthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.describe_instances_health_request.serialize_query(
        input_, pairs, ""
    )
