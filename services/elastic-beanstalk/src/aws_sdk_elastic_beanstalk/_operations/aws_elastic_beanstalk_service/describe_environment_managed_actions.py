...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.describe_environment_managed_actions_result.DescribeEnvironmentManagedActionsResult = aws_sdk_elastic_beanstalk.types.describe_environment_managed_actions_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_environment_managed_actions_request.DescribeEnvironmentManagedActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.describe_environment_managed_actions_request.serialize_query(
        input_, pairs, ""
    )
