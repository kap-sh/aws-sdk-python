...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ManagedActionInvalidStateException":
            import aws_sdk_elastic_beanstalk.errors.managed_action_invalid_state_exception

            raise aws_sdk_elastic_beanstalk.errors.managed_action_invalid_state_exception.ManagedActionInvalidStateException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.apply_environment_managed_action_result.ApplyEnvironmentManagedActionResult = aws_sdk_elastic_beanstalk.types.apply_environment_managed_action_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.apply_environment_managed_action_request.ApplyEnvironmentManagedActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
