...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.list_platform_branches_result.ListPlatformBranchesResult = aws_sdk_elastic_beanstalk.types.list_platform_branches_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.list_platform_branches_request.ListPlatformBranchesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.list_platform_branches_request.serialize_query(
        input_, pairs, ""
    )
