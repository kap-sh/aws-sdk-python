...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.update_application_message.UpdateApplicationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.update_application_message.serialize_query(
        input_, pairs, ""
    )
