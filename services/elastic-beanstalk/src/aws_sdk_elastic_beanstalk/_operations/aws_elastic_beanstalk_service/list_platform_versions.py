...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.list_platform_versions_result.ListPlatformVersionsResult = aws_sdk_elastic_beanstalk.types.list_platform_versions_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.list_platform_versions_request.ListPlatformVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
