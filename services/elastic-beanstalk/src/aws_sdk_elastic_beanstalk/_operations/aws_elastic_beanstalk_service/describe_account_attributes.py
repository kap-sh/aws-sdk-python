...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.describe_account_attributes_result.DescribeAccountAttributesResult = aws_sdk_elastic_beanstalk.types.describe_account_attributes_result.deserialize_query(
