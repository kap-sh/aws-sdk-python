"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DisassociateEnvironmentOperationsRole``."""
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.disassociate_environment_operations_role_message.DisassociateEnvironmentOperationsRoleMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisassociateEnvironmentOperationsRole"))
    pairs.append(("Version", "2010-12-01"))
    aws_sdk_elastic_beanstalk.types.disassociate_environment_operations_role_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_disassociate_environment_operations_role(
