...
import aws_sdk_elastic_beanstalk.types.configuration_settings_description_list
...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.configuration_settings_descriptions.ConfigurationSettingsDescriptions = aws_sdk_elastic_beanstalk.types.configuration_settings_descriptions.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_configuration_settings_message.DescribeConfigurationSettingsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
