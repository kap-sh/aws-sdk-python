"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#RebuildEnvironment``."""
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.rebuild_environment_message.RebuildEnvironmentMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RebuildEnvironment"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_elastic_beanstalk.types.rebuild_environment_message

    aws_sdk_elastic_beanstalk.types.rebuild_environment_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_rebuild_environment(
