...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.check_dns_availability_result_message.CheckDNSAvailabilityResultMessage = aws_sdk_elastic_beanstalk.types.check_dns_availability_result_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.check_dns_availability_message.CheckDNSAvailabilityMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.check_dns_availability_message.serialize_query(
        input_, pairs, ""
    )
