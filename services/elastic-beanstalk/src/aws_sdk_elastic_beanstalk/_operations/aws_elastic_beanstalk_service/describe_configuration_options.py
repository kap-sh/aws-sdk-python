...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.configuration_options_description.ConfigurationOptionsDescription = aws_sdk_elastic_beanstalk.types.configuration_options_description.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_configuration_options_message.DescribeConfigurationOptionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.describe_configuration_options_message.serialize_query(
        input_, pairs, ""
    )
