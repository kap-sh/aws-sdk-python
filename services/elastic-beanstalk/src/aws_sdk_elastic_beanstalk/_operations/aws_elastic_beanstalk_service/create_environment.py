...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyEnvironmentsException":
            import aws_sdk_elastic_beanstalk.errors.too_many_environments_exception

            raise aws_sdk_elastic_beanstalk.errors.too_many_environments_exception.TooManyEnvironmentsException.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.create_environment_message.CreateEnvironmentMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.create_environment_message.serialize_query(
        input_, pairs, ""
    )
