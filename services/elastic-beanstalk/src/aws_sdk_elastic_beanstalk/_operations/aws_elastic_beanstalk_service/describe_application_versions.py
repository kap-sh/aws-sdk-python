...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.application_version_descriptions_message.ApplicationVersionDescriptionsMessage = aws_sdk_elastic_beanstalk.types.application_version_descriptions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_application_versions_message.DescribeApplicationVersionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.describe_application_versions_message.serialize_query(
        input_, pairs, ""
    )
