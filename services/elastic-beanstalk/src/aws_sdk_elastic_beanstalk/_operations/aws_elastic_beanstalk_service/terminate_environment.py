"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#TerminateEnvironment``."""
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.terminate_environment_message.TerminateEnvironmentMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "TerminateEnvironment"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_elastic_beanstalk.types.terminate_environment_message

    aws_sdk_elastic_beanstalk.types.terminate_environment_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_terminate_environment(
