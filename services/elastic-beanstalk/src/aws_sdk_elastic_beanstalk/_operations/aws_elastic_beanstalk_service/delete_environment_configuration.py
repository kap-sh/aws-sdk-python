"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DeleteEnvironmentConfiguration``."""
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.delete_environment_configuration_message.DeleteEnvironmentConfigurationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteEnvironmentConfiguration"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_elastic_beanstalk.types.delete_environment_configuration_message

    aws_sdk_elastic_beanstalk.types.delete_environment_configuration_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_environment_configuration(
