...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.retrieve_environment_info_result_message.RetrieveEnvironmentInfoResultMessage = aws_sdk_elastic_beanstalk.types.retrieve_environment_info_result_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.retrieve_environment_info_message.RetrieveEnvironmentInfoMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.retrieve_environment_info_message.serialize_query(
        input_, pairs, ""
    )
