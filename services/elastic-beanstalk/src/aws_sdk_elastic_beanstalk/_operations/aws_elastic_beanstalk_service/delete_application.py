...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.delete_application_message.DeleteApplicationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.delete_application_message.serialize_query(
        input_, pairs, ""
    )
