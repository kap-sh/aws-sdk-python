...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.describe_environment_managed_action_history_result.DescribeEnvironmentManagedActionHistoryResult = aws_sdk_elastic_beanstalk.types.describe_environment_managed_action_history_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_environment_managed_action_history_request.DescribeEnvironmentManagedActionHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.describe_environment_managed_action_history_request.serialize_query(
        input_, pairs, ""
    )
