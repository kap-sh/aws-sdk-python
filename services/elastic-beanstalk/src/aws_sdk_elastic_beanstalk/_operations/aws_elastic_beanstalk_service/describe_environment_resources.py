"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeEnvironmentResources``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeEnvironmentResourcesResult")
    out: aws_sdk_elastic_beanstalk.types.environment_resource_descriptions_message.EnvironmentResourceDescriptionsMessage = aws_sdk_elastic_beanstalk.types.environment_resource_descriptions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_environment_resources_message.DescribeEnvironmentResourcesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeEnvironmentResources"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_elastic_beanstalk.types.describe_environment_resources_message

    aws_sdk_elastic_beanstalk.types.describe_environment_resources_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_environment_resources(
