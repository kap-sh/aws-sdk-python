...
import aws_sdk_elastic_beanstalk.errors.too_many_buckets_exception
import aws_sdk_elastic_beanstalk.errors.too_many_configuration_templates_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyBucketsException":
            raise aws_sdk_elastic_beanstalk.errors.too_many_buckets_exception.TooManyBucketsException.from_query(
                root
            )
        case "TooManyConfigurationTemplatesException":
            raise aws_sdk_elastic_beanstalk.errors.too_many_configuration_templates_exception.TooManyConfigurationTemplatesException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.configuration_settings_description.ConfigurationSettingsDescription = aws_sdk_elastic_beanstalk.types.configuration_settings_description.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.create_configuration_template_message.CreateConfigurationTemplateMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.create_configuration_template_message.serialize_query(
        input_, pairs, ""
    )
