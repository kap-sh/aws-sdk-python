...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.describe_events_message.DescribeEventsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.describe_events_message.serialize_query(
        input_, pairs, ""
    )
