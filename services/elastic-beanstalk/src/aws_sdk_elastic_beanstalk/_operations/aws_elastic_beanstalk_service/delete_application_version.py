...
import aws_sdk_elastic_beanstalk.errors.source_bundle_deletion_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SourceBundleDeletionException":
            raise aws_sdk_elastic_beanstalk.errors.source_bundle_deletion_exception.SourceBundleDeletionException.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.delete_application_version_message.DeleteApplicationVersionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.delete_application_version_message.serialize_query(
        input_, pairs, ""
    )
