...
def handle_response(
    ...
    out: aws_sdk_elastic_beanstalk.types.application_resource_lifecycle_description_message.ApplicationResourceLifecycleDescriptionMessage = aws_sdk_elastic_beanstalk.types.application_resource_lifecycle_description_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_beanstalk.types.update_application_resource_lifecycle_message.UpdateApplicationResourceLifecycleMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_beanstalk.types.update_application_resource_lifecycle_message.serialize_query(
        input_, pairs, ""
    )
