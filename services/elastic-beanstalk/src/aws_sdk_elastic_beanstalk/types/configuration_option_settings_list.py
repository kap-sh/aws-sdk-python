...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.configuration_option_setting

ConfigurationOptionSettingsList: TypeAlias = list[
    "aws_sdk_elastic_beanstalk.types.configuration_option_setting.ConfigurationOptionSetting"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_beanstalk.types.configuration_option_setting.serialize_query(
...
def deserialize_query(el: Element) -> ConfigurationOptionSettingsList:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_beanstalk.types.configuration_option_setting.deserialize_query(
                child
            )
        )
    return out
