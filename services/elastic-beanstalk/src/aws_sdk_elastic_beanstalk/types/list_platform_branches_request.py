...
class ListPlatformBranchesRequest(TypedDict):
    filters: NotRequired["aws_sdk_elastic_beanstalk.types.search_filters.SearchFilters"]
...
def serialize_query(
    ...
    if "filters" in value:
        ...
        aws_sdk_elastic_beanstalk.types.search_filters.serialize_query(
...
def deserialize_query(el: Element) -> ListPlatformBranchesRequest:
    ...
    if child_filters is not None:
        ...
        out["filters"] = (
            aws_sdk_elastic_beanstalk.types.search_filters.deserialize_query(
                child_filters
            )
        )
