...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.application_version_lifecycle_config
    import aws_sdk_elastic_beanstalk.types.string


class ApplicationResourceLifecycleConfig(TypedDict):
    service_role: NotRequired["aws_sdk_elastic_beanstalk.types.string.String"]
    ...
    version_lifecycle_config: NotRequired[
        "aws_sdk_elastic_beanstalk.types.application_version_lifecycle_config.ApplicationVersionLifecycleConfig"
    ]
...
def serialize_query(
    ...
    if "version_lifecycle_config" in value:
        ...
        aws_sdk_elastic_beanstalk.types.application_version_lifecycle_config.serialize_query(
...
def deserialize_query(el: Element) -> ApplicationResourceLifecycleConfig:
    ...
    if child_version_lifecycle_config is not None:
        ...
        out["version_lifecycle_config"] = (
            aws_sdk_elastic_beanstalk.types.application_version_lifecycle_config.deserialize_query(
