...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.resource_quota


class ResourceQuotas(TypedDict):
    application_quota: NotRequired[
        "aws_sdk_elastic_beanstalk.types.resource_quota.ResourceQuota"
    ]
...
def serialize_query(
    ...
    if "application_quota" in value:
        ...
        aws_sdk_elastic_beanstalk.types.resource_quota.serialize_query(
...
def deserialize_query(el: Element) -> ResourceQuotas:
    ...
    if child_application_quota is not None:
        ...
        out["application_quota"] = (
            aws_sdk_elastic_beanstalk.types.resource_quota.deserialize_query(
