...
class DescribeEnvironmentsMessage(TypedDict):
...
def serialize_query(
    ...
    if "environment_ids" in value:
        ...
        aws_sdk_elastic_beanstalk.types.environment_id_list.serialize_query(
            value["environment_ids"], pairs, f"{prefix}.EnvironmentIds"
        )
    if "environment_names" in value:
        import aws_sdk_elastic_beanstalk.types.environment_names_list

        aws_sdk_elastic_beanstalk.types.environment_names_list.serialize_query(
    ...
    if "included_deleted_back_to" in value:
        ...
        aws_sdk_elastic_beanstalk.types.include_deleted_back_to.serialize_query(
...
def deserialize_query(el: Element) -> DescribeEnvironmentsMessage:
    ...
    if child_environment_ids is not None:
        ...
        out["environment_ids"] = (
            aws_sdk_elastic_beanstalk.types.environment_id_list.deserialize_query(
    ...
    if child_environment_names is not None:
        ...
        out["environment_names"] = (
            aws_sdk_elastic_beanstalk.types.environment_names_list.deserialize_query(
    ...
    if child_included_deleted_back_to is not None:
        ...
        out["included_deleted_back_to"] = (
            aws_sdk_elastic_beanstalk.types.include_deleted_back_to.deserialize_query(
