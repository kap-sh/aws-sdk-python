...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.boxed_boolean
    import aws_sdk_elastic_beanstalk.types.boxed_int


class MaxCountRule(TypedDict):
    ...
    max_count: NotRequired["aws_sdk_elastic_beanstalk.types.boxed_int.BoxedInt"]
    """<p>Specify the maximum number of application versions to retain.</p>"""
    delete_source_from_s3: NotRequired[
        "aws_sdk_elastic_beanstalk.types.boxed_boolean.BoxedBoolean"
    ]
