...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.deployment_timestamp
    import aws_sdk_elastic_beanstalk.types.nullable_long
    import aws_sdk_elastic_beanstalk.types.string


class Deployment(TypedDict, closed=True):
    version_label: NotRequired["aws_sdk_elastic_beanstalk.types.string.String"]
    """<p>The version label of the application version in the deployment.</p>"""
    deployment_id: NotRequired[
        "aws_sdk_elastic_beanstalk.types.nullable_long.NullableLong"
    ]
    ...
    deployment_time: NotRequired[
        "aws_sdk_elastic_beanstalk.types.deployment_timestamp.DeploymentTimestamp"
    ]
...
def serialize_query(
    ...
    if "deployment_time" in value:
        ...
        aws_sdk_elastic_beanstalk.types.deployment_timestamp.serialize_query(
...
def deserialize_query(el: Element) -> Deployment:
    ...
    if child_deployment_time is not None:
        ...
        out["deployment_time"] = (
            aws_sdk_elastic_beanstalk.types.deployment_timestamp.deserialize_query(
