...
if TYPE_CHECKING:
    ...
    import aws_sdk_elastic_beanstalk.types.branch_order
...
class PlatformBranchSummary(TypedDict):
    ...
    branch_name: NotRequired["aws_sdk_elastic_beanstalk.types.branch_name.BranchName"]
    ...
    branch_order: "aws_sdk_elastic_beanstalk.types.branch_order.BranchOrder"
