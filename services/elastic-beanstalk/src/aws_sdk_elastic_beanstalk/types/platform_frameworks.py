...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.platform_framework

PlatformFrameworks: TypeAlias = list[
    "aws_sdk_elastic_beanstalk.types.platform_framework.PlatformFramework"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_beanstalk.types.platform_framework.serialize_query(
...
def deserialize_query(el: Element) -> PlatformFrameworks:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_beanstalk.types.platform_framework.deserialize_query(child)
        )
    return out
