...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.platform_filter_operator
    import aws_sdk_elastic_beanstalk.types.platform_filter_type
    import aws_sdk_elastic_beanstalk.types.platform_filter_value_list


class PlatformFilter(TypedDict):
    type: NotRequired[
        "aws_sdk_elastic_beanstalk.types.platform_filter_type.PlatformFilterType"
    ]
    ...
    operator: NotRequired[
        "aws_sdk_elastic_beanstalk.types.platform_filter_operator.PlatformFilterOperator"
    ]
    ...
    values: NotRequired[
        "aws_sdk_elastic_beanstalk.types.platform_filter_value_list.PlatformFilterValueList"
    ]
...
def serialize_query(
    ...
    if "values" in value:
        ...
        aws_sdk_elastic_beanstalk.types.platform_filter_value_list.serialize_query(
...
def deserialize_query(el: Element) -> PlatformFilter:
    ...
    if child_values is not None:
        ...
        out["values"] = (
            aws_sdk_elastic_beanstalk.types.platform_filter_value_list.deserialize_query(
                child_values
            )
        )
    return out
