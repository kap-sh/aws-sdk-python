...
class ListPlatformVersionsRequest(TypedDict):
    filters: NotRequired[
...
def serialize_query(
    ...
    if "filters" in value:
        ...
        aws_sdk_elastic_beanstalk.types.platform_filters.serialize_query(
...
def deserialize_query(el: Element) -> ListPlatformVersionsRequest:
    ...
    if child_filters is not None:
        ...
        out["filters"] = (
            aws_sdk_elastic_beanstalk.types.platform_filters.deserialize_query(
                child_filters
            )
        )
