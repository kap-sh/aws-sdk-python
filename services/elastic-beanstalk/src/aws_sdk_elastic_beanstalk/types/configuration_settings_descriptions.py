...
class ConfigurationSettingsDescriptions(TypedDict):
    configuration_settings: NotRequired[
        "aws_sdk_elastic_beanstalk.types.configuration_settings_description_list.ConfigurationSettingsDescriptionList"
    ]
...
def serialize_query(
    ...
    if "configuration_settings" in value:
        ...
        aws_sdk_elastic_beanstalk.types.configuration_settings_description_list.serialize_query(
...
def deserialize_query(el: Element) -> ConfigurationSettingsDescriptions:
    ...
    if child_configuration_settings is not None:
        ...
        out["configuration_settings"] = (
            aws_sdk_elastic_beanstalk.types.configuration_settings_description_list.deserialize_query(
