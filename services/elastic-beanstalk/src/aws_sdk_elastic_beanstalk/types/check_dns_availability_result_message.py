...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.cname_availability
    import aws_sdk_elastic_beanstalk.types.dns_cname


class CheckDNSAvailabilityResultMessage(TypedDict):
    available: NotRequired[
        "aws_sdk_elastic_beanstalk.types.cname_availability.CnameAvailability"
    ]
    ...
    fully_qualified_cname: NotRequired[
        "aws_sdk_elastic_beanstalk.types.dns_cname.DNSCname"
    ]
