...
class DescribeEnvironmentHealthRequest(TypedDict):
...
def serialize_query(
    ...
    if "attribute_names" in value:
        ...
        aws_sdk_elastic_beanstalk.types.environment_health_attributes.serialize_query(
...
def deserialize_query(el: Element) -> DescribeEnvironmentHealthRequest:
    ...
    if child_attribute_names is not None:
        ...
        out["attribute_names"] = (
            aws_sdk_elastic_beanstalk.types.environment_health_attributes.deserialize_query(
