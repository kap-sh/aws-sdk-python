...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.abortable_operation_in_progress
    ...
    import aws_sdk_elastic_beanstalk.types.dns_cname
    import aws_sdk_elastic_beanstalk.types.endpoint_url
    import aws_sdk_elastic_beanstalk.types.environment_arn
...
class EnvironmentDescription(TypedDict):
    ...
    endpoint_url: NotRequired[
        "aws_sdk_elastic_beanstalk.types.endpoint_url.EndpointURL"
    ]
    ...
    cname: NotRequired["aws_sdk_elastic_beanstalk.types.dns_cname.DNSCname"]
    ...
    status: NotRequired[
        "aws_sdk_elastic_beanstalk.types.environment_status.EnvironmentStatus"
    ]
    ...
    abortable_operation_in_progress: NotRequired[
        "aws_sdk_elastic_beanstalk.types.abortable_operation_in_progress.AbortableOperationInProgress"
    ]
    ...
    environment_links: NotRequired[
        "aws_sdk_elastic_beanstalk.types.environment_links.EnvironmentLinks"
    ]
    """<p>A list of links to other environments in the same group.</p>"""
    environment_arn: NotRequired[
        "aws_sdk_elastic_beanstalk.types.environment_arn.EnvironmentArn"
    ]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_elastic_beanstalk.types.environment_status.serialize_query(
    ...
    if "health_status" in value:
        ...
        aws_sdk_elastic_beanstalk.types.environment_health_status.serialize_query(
            value["health_status"], pairs, f"{prefix}.HealthStatus"
        )
    if "resources" in value:
        import aws_sdk_elastic_beanstalk.types.environment_resources_description

        aws_sdk_elastic_beanstalk.types.environment_resources_description.serialize_query(
    ...
    if "environment_links" in value:
        ...
        aws_sdk_elastic_beanstalk.types.environment_links.serialize_query(
...
def deserialize_query(el: Element) -> EnvironmentDescription:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_elastic_beanstalk.types.environment_status.deserialize_query(
                child_status
            )
        )
    ...
    if child_health_status is not None:
        ...
        out["health_status"] = (
            aws_sdk_elastic_beanstalk.types.environment_health_status.deserialize_query(
                child_health_status
            )
        )
    ...
    if child_resources is not None:
        ...
        out["resources"] = (
            aws_sdk_elastic_beanstalk.types.environment_resources_description.deserialize_query(
                child_resources
            )
        )
    ...
    if child_environment_links is not None:
        ...
        out["environment_links"] = (
            aws_sdk_elastic_beanstalk.types.environment_links.deserialize_query(
