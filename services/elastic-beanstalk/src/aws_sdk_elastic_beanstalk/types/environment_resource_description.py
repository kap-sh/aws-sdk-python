...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.auto_scaling_group_list
    import aws_sdk_elastic_beanstalk.types.environment_name
    import aws_sdk_elastic_beanstalk.types.instance_list
    import aws_sdk_elastic_beanstalk.types.launch_configuration_list
    import aws_sdk_elastic_beanstalk.types.launch_template_list
    import aws_sdk_elastic_beanstalk.types.load_balancer_list
    import aws_sdk_elastic_beanstalk.types.queue_list
    import aws_sdk_elastic_beanstalk.types.trigger_list


class EnvironmentResourceDescription(TypedDict):
    ...
    auto_scaling_groups: NotRequired[
        "aws_sdk_elastic_beanstalk.types.auto_scaling_group_list.AutoScalingGroupList"
    ]
    """<p> The <code>AutoScalingGroups</code> used by this environment. </p>"""
    instances: NotRequired["aws_sdk_elastic_beanstalk.types.instance_list.InstanceList"]
    """<p>The Amazon EC2 instances used by this environment.</p>"""
    launch_configurations: NotRequired[
        "aws_sdk_elastic_beanstalk.types.launch_configuration_list.LaunchConfigurationList"
    ]
    """<p>The Auto Scaling launch configurations in use by this environment.</p>"""
    launch_templates: NotRequired[
        "aws_sdk_elastic_beanstalk.types.launch_template_list.LaunchTemplateList"
    ]
    """<p>The Amazon EC2 launch templates in use by this environment.</p>"""
    load_balancers: NotRequired[
        "aws_sdk_elastic_beanstalk.types.load_balancer_list.LoadBalancerList"
    ]
    """<p>The LoadBalancers in use by this environment.</p>"""
    triggers: NotRequired["aws_sdk_elastic_beanstalk.types.trigger_list.TriggerList"]
    """<p>The <code>AutoScaling</code> triggers in use by this environment. </p>"""
    queues: NotRequired["aws_sdk_elastic_beanstalk.types.queue_list.QueueList"]
...
def serialize_query(
    ...
    if "auto_scaling_groups" in value:
        ...
        aws_sdk_elastic_beanstalk.types.auto_scaling_group_list.serialize_query(
            value["auto_scaling_groups"], pairs, f"{prefix}.AutoScalingGroups"
        )
    if "instances" in value:
        import aws_sdk_elastic_beanstalk.types.instance_list

        aws_sdk_elastic_beanstalk.types.instance_list.serialize_query(
            value["instances"], pairs, f"{prefix}.Instances"
        )
    if "launch_configurations" in value:
        import aws_sdk_elastic_beanstalk.types.launch_configuration_list

        aws_sdk_elastic_beanstalk.types.launch_configuration_list.serialize_query(
            value["launch_configurations"], pairs, f"{prefix}.LaunchConfigurations"
        )
    if "launch_templates" in value:
        import aws_sdk_elastic_beanstalk.types.launch_template_list

        aws_sdk_elastic_beanstalk.types.launch_template_list.serialize_query(
            value["launch_templates"], pairs, f"{prefix}.LaunchTemplates"
        )
    if "load_balancers" in value:
        import aws_sdk_elastic_beanstalk.types.load_balancer_list

        aws_sdk_elastic_beanstalk.types.load_balancer_list.serialize_query(
            value["load_balancers"], pairs, f"{prefix}.LoadBalancers"
        )
    if "triggers" in value:
        import aws_sdk_elastic_beanstalk.types.trigger_list

        aws_sdk_elastic_beanstalk.types.trigger_list.serialize_query(
            value["triggers"], pairs, f"{prefix}.Triggers"
        )
    if "queues" in value:
        import aws_sdk_elastic_beanstalk.types.queue_list

        aws_sdk_elastic_beanstalk.types.queue_list.serialize_query(
...
def deserialize_query(el: Element) -> EnvironmentResourceDescription:
    ...
    if child_auto_scaling_groups is not None:
        ...
        out["auto_scaling_groups"] = (
            aws_sdk_elastic_beanstalk.types.auto_scaling_group_list.deserialize_query(
    ...
    if child_instances is not None:
        ...
        out["instances"] = (
            aws_sdk_elastic_beanstalk.types.instance_list.deserialize_query(
                child_instances
            )
        )
    ...
    if child_launch_configurations is not None:
        ...
        out["launch_configurations"] = (
            aws_sdk_elastic_beanstalk.types.launch_configuration_list.deserialize_query(
    ...
    if child_launch_templates is not None:
        ...
        out["launch_templates"] = (
            aws_sdk_elastic_beanstalk.types.launch_template_list.deserialize_query(
    ...
    if child_load_balancers is not None:
        ...
        out["load_balancers"] = (
            aws_sdk_elastic_beanstalk.types.load_balancer_list.deserialize_query(
    ...
    if child_triggers is not None:
        ...
        out["triggers"] = (
            aws_sdk_elastic_beanstalk.types.trigger_list.deserialize_query(
                child_triggers
            )
        )
    ...
    if child_queues is not None:
        ...
        out["queues"] = aws_sdk_elastic_beanstalk.types.queue_list.deserialize_query(
            child_queues
        )
    return out
