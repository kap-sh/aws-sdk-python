...
if TYPE_CHECKING:
    ...
    import aws_sdk_elastic_beanstalk.types.compute_type
    import aws_sdk_elastic_beanstalk.types.non_empty_string
    import aws_sdk_elastic_beanstalk.types.string


class BuildConfiguration(TypedDict):
    artifact_name: NotRequired["aws_sdk_elastic_beanstalk.types.string.String"]
    ...
    code_build_service_role: (
        "aws_sdk_elastic_beanstalk.types.non_empty_string.NonEmptyString"
    )
    ...
    compute_type: NotRequired[
        "aws_sdk_elastic_beanstalk.types.compute_type.ComputeType"
    ]
    ...
    image: "aws_sdk_elastic_beanstalk.types.non_empty_string.NonEmptyString"
    """<p>The ID of the Docker image to use for this build project.</p>"""
    timeout_in_minutes: NotRequired[
        "aws_sdk_elastic_beanstalk.types.boxed_int.BoxedInt"
    ]
...
def serialize_query(
    ...
    if "compute_type" in value:
        ...
        aws_sdk_elastic_beanstalk.types.compute_type.serialize_query(
...
def deserialize_query(el: Element) -> BuildConfiguration:
    ...
    if child_compute_type is not None:
        ...
        out["compute_type"] = (
            aws_sdk_elastic_beanstalk.types.compute_type.deserialize_query(
                child_compute_type
            )
        )
