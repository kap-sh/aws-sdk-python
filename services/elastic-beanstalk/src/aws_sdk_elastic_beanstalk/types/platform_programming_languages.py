...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.platform_programming_language

PlatformProgrammingLanguages: TypeAlias = list[
    "aws_sdk_elastic_beanstalk.types.platform_programming_language.PlatformProgrammingLanguage"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_beanstalk.types.platform_programming_language.serialize_query(
...
def deserialize_query(el: Element) -> PlatformProgrammingLanguages:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_beanstalk.types.platform_programming_language.deserialize_query(
                child
            )
        )
    return out
