...
if TYPE_CHECKING:
    import aws_sdk_elastic_beanstalk.types.integer
    import aws_sdk_elastic_beanstalk.types.string


class Listener(TypedDict, closed=True):
    protocol: NotRequired["aws_sdk_elastic_beanstalk.types.string.String"]
    """<p>The protocol that is used by the Listener.</p>"""
    port: "aws_sdk_elastic_beanstalk.types.integer.Integer"
