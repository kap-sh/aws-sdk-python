...
from aws_sdk_elastic_beanstalk._services._aws_config import aaws_config
...
class AsyncElasticBeanstalkClientConfig(TypedDict, total=False, closed=True):
...
class AsyncElasticBeanstalkClient:
    ...
    def __init__(
        ...
        self._config = AsyncElasticBeanstalkClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: AsyncElasticBeanstalkClientConfig = config_overrides or {}
    ...
    async def abort_environment_update(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.abort_environment_update(environment_name='my-env')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.abort_environment_update_message.AbortEnvironmentUpdateMessage]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.abort_environment_update.async_abort_environment_update(
    ...
    async def apply_environment_managed_action(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.apply_environment_managed_action_request.ApplyEnvironmentManagedActionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.apply_environment_managed_action_result.ApplyEnvironmentManagedActionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.apply_environment_managed_action.async_apply_environment_managed_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_environment_operations_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.associate_environment_operations_role_message.AssociateEnvironmentOperationsRoleMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.associate_environment_operations_role.async_associate_environment_operations_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def check_dns_availability(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.check_dns_availability(cname_prefix='my-cname')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.check_dns_availability_message.CheckDNSAvailabilityMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.check_dns_availability_result_message.CheckDNSAvailabilityResultMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.check_dns_availability.async_check_dns_availability(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def compose_environments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.compose_environments_message.ComposeEnvironmentsMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.environment_descriptions_message.EnvironmentDescriptionsMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.compose_environments.async_compose_environments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_application(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_application(application_name='my-app', description='my application')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.create_application_message.CreateApplicationMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.application_description_message.ApplicationDescriptionMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.create_application.async_create_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_application_version(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_application_version(application_name='my-app', version_label='v1', description='my-app-v1', source_bundle={'S3Bucket': 'my-bucket', 'S3Key': 'sample.war'}, auto_create_application=True, process=True)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.create_application_version_message.CreateApplicationVersionMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.application_version_description_message.ApplicationVersionDescriptionMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.create_application_version.async_create_application_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_configuration_template(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_configuration_template(application_name='my-app', template_name='my-app-v1', environment_id='e-rpqsewtp2j')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.create_configuration_template_message.CreateConfigurationTemplateMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.configuration_settings_description.ConfigurationSettingsDescription"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.create_configuration_template.async_create_configuration_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_environment(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_environment(application_name='my-app', environment_name='my-env', cname_prefix='my-app', version_label='v1', solution_stack_name='64bit Amazon Linux 2015.03 v2.0.0 running Tomcat 8 Java 8')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.create_environment_message.CreateEnvironmentMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.environment_description.EnvironmentDescription"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.create_environment.async_create_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_platform_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.create_platform_version_request.CreatePlatformVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.create_platform_version_result.CreatePlatformVersionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.create_platform_version.async_create_platform_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_storage_location(
        ...
        Examples:
            ...
            >>> await client.create_storage_location()
        """
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.create_storage_location.async_create_storage_location(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_application(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_application(application_name='my-app')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.delete_application_message.DeleteApplicationMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.delete_application.async_delete_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_application_version(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_application_version(application_name='my-app', version_label='22a0-stage-150819_182129', delete_source_bundle=True)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.delete_application_version_message.DeleteApplicationVersionMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.delete_application_version.async_delete_application_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_configuration_template(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_configuration_template(application_name='my-app', template_name='my-template')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.delete_configuration_template_message.DeleteConfigurationTemplateMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.delete_configuration_template.async_delete_configuration_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_environment_configuration(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_environment_configuration(application_name='my-app', environment_name='my-env')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.delete_environment_configuration_message.DeleteEnvironmentConfigurationMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.delete_environment_configuration.async_delete_environment_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_platform_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.delete_platform_version_request.DeletePlatformVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.delete_platform_version_result.DeletePlatformVersionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.delete_platform_version.async_delete_platform_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_attributes(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_account_attributes.async_describe_account_attributes(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_applications(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_applications()
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_applications_message.DescribeApplicationsMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.application_descriptions_message.ApplicationDescriptionsMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_applications.async_describe_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_application_versions(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_application_versions(application_name='my-app', version_labels=['v2'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_application_versions_message.DescribeApplicationVersionsMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.application_version_descriptions_message.ApplicationVersionDescriptionsMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_application_versions.async_describe_application_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_configuration_options(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_configuration_options(application_name='my-app', environment_name='my-env')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_configuration_options_message.DescribeConfigurationOptionsMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.configuration_options_description.ConfigurationOptionsDescription"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_configuration_options.async_describe_configuration_options(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_configuration_settings(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_configuration_settings(application_name='my-app', environment_name='my-env')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_configuration_settings_message.DescribeConfigurationSettingsMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.configuration_settings_descriptions.ConfigurationSettingsDescriptions"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_configuration_settings.async_describe_configuration_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_environment_health(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_environment_health(environment_name='my-env', attribute_names=['All'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_environment_health_request.DescribeEnvironmentHealthRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.describe_environment_health_result.DescribeEnvironmentHealthResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_environment_health.async_describe_environment_health(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_environment_managed_action_history(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_environment_managed_action_history_request.DescribeEnvironmentManagedActionHistoryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.describe_environment_managed_action_history_result.DescribeEnvironmentManagedActionHistoryResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_environment_managed_action_history.async_describe_environment_managed_action_history(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_elastic_beanstalk.types.managed_action_history_item.ManagedActionHistoryItem]":
        _token = next_token
        while True:
            _response = await self.describe_environment_managed_action_history(
    ...
    async def describe_environment_managed_actions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_environment_managed_actions_request.DescribeEnvironmentManagedActionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.describe_environment_managed_actions_result.DescribeEnvironmentManagedActionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_environment_managed_actions.async_describe_environment_managed_actions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_environment_resources(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_environment_resources(environment_name='my-env')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_environment_resources_message.DescribeEnvironmentResourcesMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.environment_resource_descriptions_message.EnvironmentResourceDescriptionsMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_environment_resources.async_describe_environment_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_environments(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_environments(environment_names=['my-env'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_environments_message.DescribeEnvironmentsMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.environment_descriptions_message.EnvironmentDescriptionsMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_environments.async_describe_environments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_events(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_events(environment_name='my-env')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_events_message.DescribeEventsMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.event_descriptions_message.EventDescriptionsMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_events.async_describe_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_events(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_elastic_beanstalk.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_elastic_beanstalk.types.event_description.EventDescription]":
        _token = next_token
        while True:
    ...
    async def describe_instances_health(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_instances_health(environment_name='my-env', attribute_names=['All'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_instances_health_request.DescribeInstancesHealthRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.describe_instances_health_result.DescribeInstancesHealthResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_instances_health.async_describe_instances_health(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_platform_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.describe_platform_version_request.DescribePlatformVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.describe_platform_version_result.DescribePlatformVersionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.describe_platform_version.async_describe_platform_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_environment_operations_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.disassociate_environment_operations_role_message.DisassociateEnvironmentOperationsRoleMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.disassociate_environment_operations_role.async_disassociate_environment_operations_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_available_solution_stacks(
        ...
        Examples:
            ...
            >>> await client.list_available_solution_stacks()
        """
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.list_available_solution_stacks.async_list_available_solution_stacks(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_platform_branches(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.list_platform_branches_request.ListPlatformBranchesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.list_platform_branches_result.ListPlatformBranchesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.list_platform_branches.async_list_platform_branches(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_platform_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.list_platform_versions_request.ListPlatformVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.list_platform_versions_result.ListPlatformVersionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.list_platform_versions.async_list_platform_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_platform_versions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_elastic_beanstalk.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_elastic_beanstalk.types.platform_summary.PlatformSummary]":
        _token = next_token
        while True:
            _response = await self.list_platform_versions(
                config_overrides=config_overrides,
                filters=filters,
                max_records=max_records,
                next_token=_token,
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.list_tags_for_resource_message.ListTagsForResourceMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.resource_tags_description_message.ResourceTagsDescriptionMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rebuild_environment(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.rebuild_environment(environment_name='my-env')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.rebuild_environment_message.RebuildEnvironmentMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.rebuild_environment.async_rebuild_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def request_environment_info(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.request_environment_info(environment_name='my-env', info_type='tail')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.request_environment_info_message.RequestEnvironmentInfoMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.request_environment_info.async_request_environment_info(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def restart_app_server(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.restart_app_server(environment_name='my-env')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.restart_app_server_message.RestartAppServerMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.restart_app_server.async_restart_app_server(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def retrieve_environment_info(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.retrieve_environment_info(environment_name='my-env', info_type='tail')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.retrieve_environment_info_message.RetrieveEnvironmentInfoMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.retrieve_environment_info_result_message.RetrieveEnvironmentInfoResultMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.retrieve_environment_info.async_retrieve_environment_info(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def swap_environment_cnam_es(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.swap_environment_cnam_es(source_environment_name='my-env-blue', destination_environment_name='my-env-green')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.swap_environment_cnam_es_message.SwapEnvironmentCNAMEsMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.swap_environment_cnam_es.async_swap_environment_cnam_es(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def terminate_environment(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.terminate_environment(environment_name='my-env')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.terminate_environment_message.TerminateEnvironmentMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.environment_description.EnvironmentDescription"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.terminate_environment.async_terminate_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_application(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_application(application_name='my-app', description='my Elastic Beanstalk application')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.update_application_message.UpdateApplicationMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.application_description_message.ApplicationDescriptionMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.update_application.async_update_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_application_resource_lifecycle(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.update_application_resource_lifecycle_message.UpdateApplicationResourceLifecycleMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.application_resource_lifecycle_description_message.ApplicationResourceLifecycleDescriptionMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.update_application_resource_lifecycle.async_update_application_resource_lifecycle(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_application_version(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_application_version(application_name='my-app', version_label='22a0-stage-150819_185942', description='new description')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.update_application_version_message.UpdateApplicationVersionMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.application_version_description_message.ApplicationVersionDescriptionMessage"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.update_application_version.async_update_application_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_configuration_template(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_configuration_template(application_name='my-app', template_name='my-template', options_to_remove=[{'Namespace': 'aws:elasticbeanstalk:healthreporting:system', 'OptionName': 'ConfigDocument'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.update_configuration_template_message.UpdateConfigurationTemplateMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.configuration_settings_description.ConfigurationSettingsDescription"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.update_configuration_template.async_update_configuration_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_environment(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_environment(environment_name='my-env', version_label='v2')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.update_environment_message.UpdateEnvironmentMessage]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_beanstalk.types.environment_description.EnvironmentDescription"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.update_environment.async_update_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_beanstalk.types.update_tags_for_resource_message.UpdateTagsForResourceMessage]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.update_tags_for_resource.async_update_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_beanstalk._operations.aws_elastic_beanstalk_service.validate_configuration_settings.async_validate_configuration_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
