...
```
pip install aws-sdk-elastic-beanstalk
```

## Usage

```python
from aws_sdk_elastic_beanstalk import AsyncElasticBeanstalkClient
...
```python
from aws_sdk_elastic_beanstalk import AsyncElasticBeanstalkClient
from aws_sdk_elastic_beanstalk.error import InsufficientPrivilegesException
