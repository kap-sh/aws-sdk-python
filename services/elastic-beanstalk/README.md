...
```
pip install capo-elastic-beanstalk
```

## Usage

```python
from capo_elastic_beanstalk import AsyncElasticBeanstalkClient
...
```python
from capo_elastic_beanstalk import AsyncElasticBeanstalkClient
from capo_elastic_beanstalk.error import InsufficientPrivilegesException
