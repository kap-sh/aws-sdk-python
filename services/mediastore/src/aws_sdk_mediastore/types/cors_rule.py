...
if TYPE_CHECKING:
    import aws_sdk_mediastore.types.allowed_headers
    import aws_sdk_mediastore.types.allowed_methods
    import aws_sdk_mediastore.types.allowed_origins
    import aws_sdk_mediastore.types.expose_headers
...
class CorsRule(TypedDict, closed=True):
    ...
    allowed_methods: NotRequired[
        "aws_sdk_mediastore.types.allowed_methods.AllowedMethods"
    ]
    ...
    allowed_headers: "aws_sdk_mediastore.types.allowed_headers.AllowedHeaders"
    ...
    max_age_seconds: "aws_sdk_mediastore.types.max_age_seconds.MaxAgeSeconds"
    ...
    expose_headers: NotRequired["aws_sdk_mediastore.types.expose_headers.ExposeHeaders"]
...
def serialize_aws_json_1_1(value: CorsRule) -> dict:
    ...
    out["AllowedOrigins"] = (
        aws_sdk_mediastore.types.allowed_origins.serialize_aws_json_1_1(
    ...
    if "allowed_methods" in value:
        ...
        out["AllowedMethods"] = (
            aws_sdk_mediastore.types.allowed_methods.serialize_aws_json_1_1(
    ...
    out["AllowedHeaders"] = (
        aws_sdk_mediastore.types.allowed_headers.serialize_aws_json_1_1(
    ...
    if "expose_headers" in value:
        ...
        out["ExposeHeaders"] = (
            aws_sdk_mediastore.types.expose_headers.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CorsRule:
    ...
    if "AllowedOrigins" in data:
        ...
        out["allowed_origins"] = (
            aws_sdk_mediastore.types.allowed_origins.deserialize_aws_json_1_1(
                data["AllowedOrigins"]
            )
        )
    else:
    ...
    if "AllowedMethods" in data:
        ...
        out["allowed_methods"] = (
            aws_sdk_mediastore.types.allowed_methods.deserialize_aws_json_1_1(
                data["AllowedMethods"]
            )
        )
    if "AllowedHeaders" in data:
        ...
        out["allowed_headers"] = (
            aws_sdk_mediastore.types.allowed_headers.deserialize_aws_json_1_1(
                data["AllowedHeaders"]
            )
        )
    else:
    ...
    if "ExposeHeaders" in data:
        ...
        out["expose_headers"] = (
            aws_sdk_mediastore.types.expose_headers.deserialize_aws_json_1_1(
                data["ExposeHeaders"]
            )
        )
    return out
