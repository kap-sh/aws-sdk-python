"""Generated from Smithy shape ``com.amazonaws.mediastore#GetLifecyclePolicy``."""
...
import aws_sdk_mediastore.errors.policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyNotFoundException":
            raise aws_sdk_mediastore.errors.policy_not_found_exception.PolicyNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.get_lifecycle_policy_output.GetLifecyclePolicyOutput = aws_sdk_mediastore.types.get_lifecycle_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.get_lifecycle_policy_input.GetLifecyclePolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.get_lifecycle_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
