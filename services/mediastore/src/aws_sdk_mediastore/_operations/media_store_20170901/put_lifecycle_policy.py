...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.put_lifecycle_policy_output.PutLifecyclePolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.put_lifecycle_policy_input.PutLifecyclePolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.put_lifecycle_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
