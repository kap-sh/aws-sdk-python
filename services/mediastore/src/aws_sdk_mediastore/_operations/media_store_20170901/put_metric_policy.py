...
def build_request(
    ...
    input: aws_sdk_mediastore.types.put_metric_policy_input.PutMetricPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.put_metric_policy_input.serialize_aws_json_1_1(input)
    ).encode()
