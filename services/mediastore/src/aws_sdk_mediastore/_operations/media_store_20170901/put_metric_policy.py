"""Generated from Smithy shape ``com.amazonaws.mediastore#PutMetricPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.put_metric_policy_output.PutMetricPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.put_metric_policy_input.PutMetricPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MediaStore_20170901.PutMetricPolicy"
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.put_metric_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_put_metric_policy(
