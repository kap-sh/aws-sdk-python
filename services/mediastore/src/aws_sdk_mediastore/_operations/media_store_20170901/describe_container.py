"""Generated from Smithy shape ``com.amazonaws.mediastore#DescribeContainer``."""
...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.describe_container_output.DescribeContainerOutput = (
        aws_sdk_mediastore.types.describe_container_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.describe_container_input.DescribeContainerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.describe_container_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_container(
