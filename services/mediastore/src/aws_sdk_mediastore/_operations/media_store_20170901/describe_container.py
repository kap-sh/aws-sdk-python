...
def build_request(
    ...
    input: aws_sdk_mediastore.types.describe_container_input.DescribeContainerInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.describe_container_input.serialize_aws_json_1_1(input)
    ).encode()
