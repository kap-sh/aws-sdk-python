...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.delete_metric_policy_output.DeleteMetricPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.delete_metric_policy_input.DeleteMetricPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.delete_metric_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
