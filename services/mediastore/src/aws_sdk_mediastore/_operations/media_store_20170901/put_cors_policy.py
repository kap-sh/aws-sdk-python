"""Generated from Smithy shape ``com.amazonaws.mediastore#PutCorsPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.put_cors_policy_output.PutCorsPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.put_cors_policy_input.PutCorsPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.put_cors_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_cors_policy(
    ...
    aws_sdk_mediastore.types.put_cors_policy_output.PutCorsPolicyOutput, zapros.Response
]:
...
async def async_put_cors_policy(
