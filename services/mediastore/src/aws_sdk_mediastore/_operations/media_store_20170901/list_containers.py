"""Generated from Smithy shape ``com.amazonaws.mediastore#ListContainers``."""
...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.list_containers_output.ListContainersOutput = (
        aws_sdk_mediastore.types.list_containers_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.list_containers_input.ListContainersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.list_containers_input.serialize_aws_json_1_1(input_)
    ).encode()
