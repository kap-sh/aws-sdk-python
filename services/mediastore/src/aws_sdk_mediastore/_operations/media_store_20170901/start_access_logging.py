...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.start_access_logging_output.StartAccessLoggingOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.start_access_logging_input.StartAccessLoggingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.start_access_logging_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
