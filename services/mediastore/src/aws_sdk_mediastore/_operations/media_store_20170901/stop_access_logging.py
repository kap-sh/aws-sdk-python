...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.stop_access_logging_output.StopAccessLoggingOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_mediastore.types.stop_access_logging_input.StopAccessLoggingInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.stop_access_logging_input.serialize_aws_json_1_1(input)
    ).encode()
