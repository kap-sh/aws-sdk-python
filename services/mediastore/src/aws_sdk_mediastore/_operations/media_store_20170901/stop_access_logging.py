...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.stop_access_logging_input.StopAccessLoggingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.stop_access_logging_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
