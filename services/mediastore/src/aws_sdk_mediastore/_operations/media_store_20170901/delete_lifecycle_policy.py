"""Generated from Smithy shape ``com.amazonaws.mediastore#DeleteLifecyclePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.delete_lifecycle_policy_output.DeleteLifecyclePolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.delete_lifecycle_policy_input.DeleteLifecyclePolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
