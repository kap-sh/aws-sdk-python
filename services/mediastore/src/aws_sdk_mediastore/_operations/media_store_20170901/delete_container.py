"""Generated from Smithy shape ``com.amazonaws.mediastore#DeleteContainer``."""
...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.delete_container_output.DeleteContainerOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.delete_container_input.DeleteContainerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.delete_container_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_container(
