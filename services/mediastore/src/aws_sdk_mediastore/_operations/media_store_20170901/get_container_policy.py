"""Generated from Smithy shape ``com.amazonaws.mediastore#GetContainerPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.get_container_policy_output.GetContainerPolicyOutput = aws_sdk_mediastore.types.get_container_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.get_container_policy_input.GetContainerPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.get_container_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_container_policy(
