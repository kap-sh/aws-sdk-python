...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.put_container_policy_output.PutContainerPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.put_container_policy_input.PutContainerPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.put_container_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
