"""Generated from Smithy shape ``com.amazonaws.mediastore#DeleteCorsPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.delete_cors_policy_output.DeleteCorsPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.delete_cors_policy_input.DeleteCorsPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.delete_cors_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_cors_policy(
