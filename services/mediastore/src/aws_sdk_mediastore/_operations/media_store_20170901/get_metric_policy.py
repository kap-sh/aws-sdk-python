...
def handle_response(
    ...
    out: aws_sdk_mediastore.types.get_metric_policy_output.GetMetricPolicyOutput = (
        aws_sdk_mediastore.types.get_metric_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mediastore.types.get_metric_policy_input.GetMetricPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediastore.types.get_metric_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
