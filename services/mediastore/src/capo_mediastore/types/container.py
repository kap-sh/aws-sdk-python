...
if TYPE_CHECKING:
    import capo_mediastore.types.container_access_logging_enabled
    ...
    import capo_mediastore.types.endpoint
    import capo_mediastore.types.time_stamp


class Container(TypedDict, closed=True):
    endpoint: NotRequired["capo_mediastore.types.endpoint.Endpoint"]
    ...
    creation_time: NotRequired["capo_mediastore.types.time_stamp.TimeStamp"]
    """<p>Unix timestamp.</p>"""
    arn: NotRequired["capo_mediastore.types.container_arn.ContainerARN"]
    ...
    name: NotRequired["capo_mediastore.types.container_name.ContainerName"]
    """<p>The name of the container.</p>"""
    status: NotRequired["capo_mediastore.types.container_status.ContainerStatus"]
    ...
    access_logging_enabled: NotRequired[
        "capo_mediastore.types.container_access_logging_enabled.ContainerAccessLoggingEnabled"
    ]
...
def serialize_aws_json_1_1(value: Container) -> dict:
    ...
    if "creation_time" in value:
        ...
        out["CreationTime"] = capo_mediastore.types.time_stamp.serialize_aws_json_1_1(
            value["creation_time"]
        )
    if "arn" in value:
        out["ARN"] = value["arn"]
    ...
    if "status" in value:
        ...
        out["Status"] = capo_mediastore.types.container_status.serialize_aws_json_1_1(
            value["status"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> Container:
    ...
    if "CreationTime" in data:
        ...
        out["creation_time"] = (
            capo_mediastore.types.time_stamp.deserialize_aws_json_1_1(
                data["CreationTime"]
            )
        )
    if "ARN" in data:
