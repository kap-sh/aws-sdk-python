...
import capo_mediastore.errors.cors_policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CorsPolicyNotFoundException":
            raise capo_mediastore.errors.cors_policy_not_found_exception.CorsPolicyNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_mediastore.types.delete_cors_policy_output.DeleteCorsPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.delete_cors_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
