...
def handle_response(
    ...
    out: capo_mediastore.types.get_container_policy_output.GetContainerPolicyOutput = (
        capo_mediastore.types.get_container_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.get_container_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
