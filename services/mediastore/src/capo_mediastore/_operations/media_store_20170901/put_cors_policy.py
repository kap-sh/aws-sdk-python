...
def handle_response(
    ...
    out: capo_mediastore.types.put_cors_policy_output.PutCorsPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.put_cors_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_cors_policy(
    ...
    capo_mediastore.types.put_cors_policy_output.PutCorsPolicyOutput, zapros.Response
]:
