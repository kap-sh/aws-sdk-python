...
def handle_response(
    ...
    out: capo_mediastore.types.describe_container_output.DescribeContainerOutput = (
        capo_mediastore.types.describe_container_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.describe_container_input.serialize_aws_json_1_1(input_)
    ).encode()
