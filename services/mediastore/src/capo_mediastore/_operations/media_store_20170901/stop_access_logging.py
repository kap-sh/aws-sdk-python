"""Generated from Smithy shape ``com.amazonaws.mediastore#StopAccessLogging``."""
...
def handle_response(
    ...
    out: capo_mediastore.types.stop_access_logging_output.StopAccessLoggingOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.stop_access_logging_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_stop_access_logging(
