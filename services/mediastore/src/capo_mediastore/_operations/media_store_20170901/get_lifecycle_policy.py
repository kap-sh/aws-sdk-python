...
def handle_response(
    ...
    out: capo_mediastore.types.get_lifecycle_policy_output.GetLifecyclePolicyOutput = (
        capo_mediastore.types.get_lifecycle_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.get_lifecycle_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
