"""Generated from Smithy shape ``com.amazonaws.mediastore#GetMetricPolicy``."""
...
import capo_mediastore.errors.policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyNotFoundException":
            raise capo_mediastore.errors.policy_not_found_exception.PolicyNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_mediastore.types.get_metric_policy_output.GetMetricPolicyOutput = (
        capo_mediastore.types.get_metric_policy_output.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_mediastore._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "MediaStore_20170901.GetMetricPolicy"
    body: bytes | None = json.dumps(
        capo_mediastore.types.get_metric_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_metric_policy(
