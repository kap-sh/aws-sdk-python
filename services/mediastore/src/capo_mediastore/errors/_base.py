...
class MediaStoreError(Exception):
    """Base class for all MediaStore service errors."""


class ServiceError(MediaStoreError):
...
class SerializationError(MediaStoreError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MediaStoreError):
...
class WaiterFailedError(MediaStoreError):
...
class WaiterTimeoutError(MediaStoreError):
