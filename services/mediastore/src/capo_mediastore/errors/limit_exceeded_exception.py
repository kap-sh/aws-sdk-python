"""Generated from Smithy shape ``com.amazonaws.mediastore#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediastore#LimitExceededException``."""
