...
class DescribeLocationFsxOntapResponse(TypedDict, closed=True):
    ...
    protocol: NotRequired["aws_sdk_datasync.types.fsx_protocol.FsxProtocol"]
    ...
    storage_virtual_machine_arn: NotRequired[
        "aws_sdk_datasync.types.storage_virtual_machine_arn.StorageVirtualMachineArn"
    ]
    ...
    fsx_filesystem_arn: NotRequired[
        "aws_sdk_datasync.types.fsx_filesystem_arn.FsxFilesystemArn"
    ]
...
def serialize_aws_json_1_1(value: DescribeLocationFsxOntapResponse) -> dict:
    ...
    if "protocol" in value:
        ...
        out["Protocol"] = aws_sdk_datasync.types.fsx_protocol.serialize_aws_json_1_1(
            value["protocol"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeLocationFsxOntapResponse:
    ...
    if "Protocol" in data:
        ...
        out["protocol"] = aws_sdk_datasync.types.fsx_protocol.deserialize_aws_json_1_1(
            data["Protocol"]
        )
