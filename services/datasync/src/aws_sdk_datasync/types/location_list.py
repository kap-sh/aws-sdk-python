...
LocationList: TypeAlias = list[
    "aws_sdk_datasync.types.location_list_entry.LocationListEntry"
]
...
def serialize_aws_json_1_1(value: LocationList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_datasync.types.location_list_entry.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> LocationList:
    ...
    for item in data:
        out.append(
            aws_sdk_datasync.types.location_list_entry.deserialize_aws_json_1_1(item)
        )
    return out
