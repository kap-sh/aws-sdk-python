...
class DataSyncError(Exception):
    """Base class for all DataSync service errors."""


class ServiceError(DataSyncError):
...
class SerializationError(DataSyncError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DataSyncError):
...
class WaiterFailedError(DataSyncError):
...
class WaiterTimeoutError(DataSyncError):
