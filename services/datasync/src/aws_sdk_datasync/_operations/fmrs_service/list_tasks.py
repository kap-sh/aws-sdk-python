...
def handle_response(
    ...
    out: aws_sdk_datasync.types.list_tasks_response.ListTasksResponse = (
        aws_sdk_datasync.types.list_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.list_tasks_request.ListTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.list_tasks_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_tasks(
    ...
    aws_sdk_datasync.types.list_tasks_response.ListTasksResponse, zapros.Response
]:
