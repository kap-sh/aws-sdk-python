...
def handle_response(
    ...
    out: aws_sdk_datasync.types.create_location_efs_response.CreateLocationEfsResponse = aws_sdk_datasync.types.create_location_efs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_datasync.types.create_location_efs_request.CreateLocationEfsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_location_efs_request.serialize_aws_json_1_1(input)
    ).encode()
