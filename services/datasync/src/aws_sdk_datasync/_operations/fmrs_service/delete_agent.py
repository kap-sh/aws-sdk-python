...
def handle_response(
    ...
    out: aws_sdk_datasync.types.delete_agent_response.DeleteAgentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.delete_agent_request.DeleteAgentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.delete_agent_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_agent(
    ...
    aws_sdk_datasync.types.delete_agent_response.DeleteAgentResponse, zapros.Response
]:
