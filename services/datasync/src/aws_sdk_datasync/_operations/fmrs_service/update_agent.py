...
def handle_response(
    ...
    out: aws_sdk_datasync.types.update_agent_response.UpdateAgentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.update_agent_request.UpdateAgentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.update_agent_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_agent(
    ...
    aws_sdk_datasync.types.update_agent_response.UpdateAgentResponse, zapros.Response
]:
