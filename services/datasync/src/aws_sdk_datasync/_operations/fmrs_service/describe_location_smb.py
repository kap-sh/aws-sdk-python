...
def handle_response(
    ...
    out: aws_sdk_datasync.types.describe_location_smb_response.DescribeLocationSmbResponse = aws_sdk_datasync.types.describe_location_smb_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.describe_location_smb_request.DescribeLocationSmbRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.describe_location_smb_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
