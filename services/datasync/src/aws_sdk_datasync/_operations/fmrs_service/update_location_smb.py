...
def handle_response(
    ...
    out: aws_sdk_datasync.types.update_location_smb_response.UpdateLocationSmbResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_datasync.types.update_location_smb_request.UpdateLocationSmbRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.update_location_smb_request.serialize_aws_json_1_1(input)
    ).encode()
