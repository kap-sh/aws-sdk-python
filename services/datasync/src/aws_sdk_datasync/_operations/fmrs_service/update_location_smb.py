...
def build_request(
    ...
    input_: aws_sdk_datasync.types.update_location_smb_request.UpdateLocationSmbRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.update_location_smb_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
