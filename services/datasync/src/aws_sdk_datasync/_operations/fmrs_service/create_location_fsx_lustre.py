...
def handle_response(
    ...
    out: aws_sdk_datasync.types.create_location_fsx_lustre_response.CreateLocationFsxLustreResponse = aws_sdk_datasync.types.create_location_fsx_lustre_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.create_location_fsx_lustre_request.CreateLocationFsxLustreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_location_fsx_lustre_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
