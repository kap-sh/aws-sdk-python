...
def handle_response(
    ...
    out: aws_sdk_datasync.types.describe_location_s3_response.DescribeLocationS3Response = aws_sdk_datasync.types.describe_location_s3_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.describe_location_s3_request.DescribeLocationS3Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.describe_location_s3_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
