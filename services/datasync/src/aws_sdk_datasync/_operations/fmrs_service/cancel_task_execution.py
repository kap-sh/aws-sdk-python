...
def handle_response(
    ...
    out: aws_sdk_datasync.types.cancel_task_execution_response.CancelTaskExecutionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.cancel_task_execution_request.CancelTaskExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.cancel_task_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
