"""Generated from Smithy shape ``com.amazonaws.datasync#StartTaskExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.start_task_execution_response.StartTaskExecutionResponse = aws_sdk_datasync.types.start_task_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.start_task_execution_request.StartTaskExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.start_task_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_task_execution(
