"""Generated from Smithy shape ``com.amazonaws.datasync#CreateTask``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.create_task_response.CreateTaskResponse = (
        aws_sdk_datasync.types.create_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.create_task_request.CreateTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_task_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_task(
    ...
    aws_sdk_datasync.types.create_task_response.CreateTaskResponse, zapros.Response
]:
