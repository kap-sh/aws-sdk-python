...
def handle_response(
    ...
    out: aws_sdk_datasync.types.list_locations_response.ListLocationsResponse = (
        aws_sdk_datasync.types.list_locations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.list_locations_request.ListLocationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.list_locations_request.serialize_aws_json_1_1(input_)
    ).encode()
