...
def handle_response(
    ...
    out: aws_sdk_datasync.types.create_location_fsx_windows_response.CreateLocationFsxWindowsResponse = aws_sdk_datasync.types.create_location_fsx_windows_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.create_location_fsx_windows_request.CreateLocationFsxWindowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_location_fsx_windows_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
