"""Generated from Smithy shape ``com.amazonaws.datasync#TagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_datasync.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
