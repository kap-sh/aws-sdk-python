"""Generated from Smithy shape ``com.amazonaws.datasync#UpdateLocationNfs``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.update_location_nfs_response.UpdateLocationNfsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_datasync.types.update_location_nfs_request.UpdateLocationNfsRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "FmrsService.UpdateLocationNfs"
    import aws_sdk_datasync.types.update_location_nfs_request

    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.update_location_nfs_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_update_location_nfs(
