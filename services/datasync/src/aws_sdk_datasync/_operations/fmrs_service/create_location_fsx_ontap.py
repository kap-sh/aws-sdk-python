...
def handle_response(
    ...
    out: aws_sdk_datasync.types.create_location_fsx_ontap_response.CreateLocationFsxOntapResponse = aws_sdk_datasync.types.create_location_fsx_ontap_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.create_location_fsx_ontap_request.CreateLocationFsxOntapRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_location_fsx_ontap_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
