...
def handle_response(
    ...
    out: aws_sdk_datasync.types.update_location_azure_blob_response.UpdateLocationAzureBlobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.update_location_azure_blob_request.UpdateLocationAzureBlobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.update_location_azure_blob_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
