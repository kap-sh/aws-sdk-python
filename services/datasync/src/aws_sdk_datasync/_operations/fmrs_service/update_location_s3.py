...
def build_request(
    ...
    input: aws_sdk_datasync.types.update_location_s3_request.UpdateLocationS3Request,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.update_location_s3_request.serialize_aws_json_1_1(input)
    ).encode()
