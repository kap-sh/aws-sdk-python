"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeTask``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.describe_task_response.DescribeTaskResponse = (
        aws_sdk_datasync.types.describe_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.describe_task_request.DescribeTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.describe_task_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_task(
    ...
    aws_sdk_datasync.types.describe_task_response.DescribeTaskResponse, zapros.Response
]:
