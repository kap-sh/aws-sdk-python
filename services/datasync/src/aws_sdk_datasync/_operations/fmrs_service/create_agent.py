"""Generated from Smithy shape ``com.amazonaws.datasync#CreateAgent``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.create_agent_response.CreateAgentResponse = (
        aws_sdk_datasync.types.create_agent_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.create_agent_request.CreateAgentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_agent_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_agent(
    ...
    aws_sdk_datasync.types.create_agent_response.CreateAgentResponse, zapros.Response
]:
