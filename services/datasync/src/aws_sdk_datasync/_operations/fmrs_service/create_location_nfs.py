...
def build_request(
    ...
    input_: aws_sdk_datasync.types.create_location_nfs_request.CreateLocationNfsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_location_nfs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
