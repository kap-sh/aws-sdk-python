"""Generated from Smithy shape ``com.amazonaws.datasync#CreateLocationSmb``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.create_location_smb_response.CreateLocationSmbResponse = aws_sdk_datasync.types.create_location_smb_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_datasync.types.create_location_smb_request.CreateLocationSmbRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_location_smb_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_create_location_smb(
