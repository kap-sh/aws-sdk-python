...
def handle_response(
    ...
    out: aws_sdk_datasync.types.update_location_object_storage_response.UpdateLocationObjectStorageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.update_location_object_storage_request.UpdateLocationObjectStorageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.update_location_object_storage_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
