"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeLocationHdfs``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.describe_location_hdfs_response.DescribeLocationHdfsResponse = aws_sdk_datasync.types.describe_location_hdfs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.describe_location_hdfs_request.DescribeLocationHdfsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "FmrsService.DescribeLocationHdfs"
    import aws_sdk_datasync.types.describe_location_hdfs_request

    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.describe_location_hdfs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_location_hdfs(
