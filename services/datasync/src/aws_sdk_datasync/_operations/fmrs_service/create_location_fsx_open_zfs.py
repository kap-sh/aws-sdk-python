...
def handle_response(
    ...
    out: aws_sdk_datasync.types.create_location_fsx_open_zfs_response.CreateLocationFsxOpenZfsResponse = aws_sdk_datasync.types.create_location_fsx_open_zfs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.create_location_fsx_open_zfs_request.CreateLocationFsxOpenZfsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_location_fsx_open_zfs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
