...
def handle_response(
    ...
    out: aws_sdk_datasync.types.update_location_efs_response.UpdateLocationEfsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_datasync.types.update_location_efs_request.UpdateLocationEfsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.update_location_efs_request.serialize_aws_json_1_1(input)
    ).encode()
