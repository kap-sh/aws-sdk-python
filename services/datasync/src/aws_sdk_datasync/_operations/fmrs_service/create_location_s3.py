...
def build_request(
    ...
    input: aws_sdk_datasync.types.create_location_s3_request.CreateLocationS3Request,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_location_s3_request.serialize_aws_json_1_1(input)
    ).encode()
