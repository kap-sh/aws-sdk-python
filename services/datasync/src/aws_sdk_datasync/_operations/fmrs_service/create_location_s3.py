"""Generated from Smithy shape ``com.amazonaws.datasync#CreateLocationS3``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.create_location_s3_response.CreateLocationS3Response = (
        aws_sdk_datasync.types.create_location_s3_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.create_location_s3_request.CreateLocationS3Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_location_s3_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_location_s3(
