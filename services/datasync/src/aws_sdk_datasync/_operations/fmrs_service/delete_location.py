...
def handle_response(
    ...
    out: aws_sdk_datasync.types.delete_location_response.DeleteLocationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.delete_location_request.DeleteLocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.delete_location_request.serialize_aws_json_1_1(input_)
    ).encode()
