...
def handle_response(
    ...
    out: aws_sdk_datasync.types.describe_location_fsx_open_zfs_response.DescribeLocationFsxOpenZfsResponse = aws_sdk_datasync.types.describe_location_fsx_open_zfs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.describe_location_fsx_open_zfs_request.DescribeLocationFsxOpenZfsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.describe_location_fsx_open_zfs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
