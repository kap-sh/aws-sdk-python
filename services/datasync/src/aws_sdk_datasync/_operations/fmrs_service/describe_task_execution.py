"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeTaskExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.describe_task_execution_response.DescribeTaskExecutionResponse = aws_sdk_datasync.types.describe_task_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.describe_task_execution_request.DescribeTaskExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.describe_task_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_task_execution(
