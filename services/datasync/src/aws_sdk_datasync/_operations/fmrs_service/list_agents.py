...
def handle_response(
    ...
    out: aws_sdk_datasync.types.list_agents_response.ListAgentsResponse = (
        aws_sdk_datasync.types.list_agents_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.list_agents_request.ListAgentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.list_agents_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_agents(
    ...
    aws_sdk_datasync.types.list_agents_response.ListAgentsResponse, zapros.Response
]:
