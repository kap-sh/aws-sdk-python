...
def handle_response(
    ...
    out: aws_sdk_datasync.types.create_location_hdfs_response.CreateLocationHdfsResponse = aws_sdk_datasync.types.create_location_hdfs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.create_location_hdfs_request.CreateLocationHdfsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.create_location_hdfs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
