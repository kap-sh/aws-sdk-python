...
def handle_response(
    ...
    out: aws_sdk_datasync.types.update_location_fsx_lustre_response.UpdateLocationFsxLustreResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.update_location_fsx_lustre_request.UpdateLocationFsxLustreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.update_location_fsx_lustre_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
