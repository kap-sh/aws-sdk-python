"""Generated from Smithy shape ``com.amazonaws.datasync#DeleteTask``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.delete_task_response.DeleteTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.delete_task_request.DeleteTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.delete_task_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_task(
    ...
    aws_sdk_datasync.types.delete_task_response.DeleteTaskResponse, zapros.Response
]:
