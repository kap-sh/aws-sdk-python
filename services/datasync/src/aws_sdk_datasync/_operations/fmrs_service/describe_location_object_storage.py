...
def handle_response(
    ...
    out: aws_sdk_datasync.types.describe_location_object_storage_response.DescribeLocationObjectStorageResponse = aws_sdk_datasync.types.describe_location_object_storage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.describe_location_object_storage_request.DescribeLocationObjectStorageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.describe_location_object_storage_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
