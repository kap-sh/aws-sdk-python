...
def handle_response(
    ...
    out: aws_sdk_datasync.types.describe_location_azure_blob_response.DescribeLocationAzureBlobResponse = aws_sdk_datasync.types.describe_location_azure_blob_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.describe_location_azure_blob_request.DescribeLocationAzureBlobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.describe_location_azure_blob_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
