"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeLocationFsxLustre``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.describe_location_fsx_lustre_response.DescribeLocationFsxLustreResponse = aws_sdk_datasync.types.describe_location_fsx_lustre_response.deserialize_aws_json_1_1(
...
def get_signer(
...
) -> aws_sdk_datasync._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_datasync._auth._sigv4.build_sigv4_auth_scheme(
                "datasync", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_datasync._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.describe_location_fsx_lustre_request.DescribeLocationFsxLustreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "FmrsService.DescribeLocationFsxLustre"
    import aws_sdk_datasync.types.describe_location_fsx_lustre_request

    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.describe_location_fsx_lustre_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_location_fsx_lustre(
