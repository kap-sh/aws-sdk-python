"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeLocationFsxOntap``."""
...
def handle_response(
    ...
    out: aws_sdk_datasync.types.describe_location_fsx_ontap_response.DescribeLocationFsxOntapResponse = aws_sdk_datasync.types.describe_location_fsx_ontap_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.describe_location_fsx_ontap_request.DescribeLocationFsxOntapRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "FmrsService.DescribeLocationFsxOntap"
    import aws_sdk_datasync.types.describe_location_fsx_ontap_request

    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.describe_location_fsx_ontap_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_location_fsx_ontap(
