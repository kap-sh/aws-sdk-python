...
def handle_response(
    ...
    out: aws_sdk_datasync.types.list_task_executions_response.ListTaskExecutionsResponse = aws_sdk_datasync.types.list_task_executions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_datasync.types.list_task_executions_request.ListTaskExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datasync.types.list_task_executions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
