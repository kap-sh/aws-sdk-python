...
class TaskExecutionResultDetail(TypedDict, closed=True):
    ...
    r"""<p>The status of the <code>PREPARING</code> step for your task execution. For more information, see <a href=\"https://docs.aws.amazon.com/datasync/latest/userguide/run-task.html#understand-task-execution-statuses\">Task execution statuses</a>.</p>"""
    ...
    r"""<p>The time in milliseconds that your task execution was in the <code>TRANSFERRING</code> step. For more information, see <a href=\"https://docs.aws.amazon.com/datasync/latest/userguide/run-task.html#understand-task-execution-statuses\">Task execution statuses</a>.</p> <p>For Enhanced mode tasks, the value is always <code>0</code>. For more information, see <a href=\"https://docs.aws.amazon.com/datasync/latest/userguide/how-datasync-transfer-works.html#how-datasync-transfers\">How DataSync transfers your data</a>.</p>"""
    transfer_status: NotRequired["capo_datasync.types.phase_status.PhaseStatus"]
    r"""<p>The status of the <code>TRANSFERRING</code> step for your task execution. For more information, see <a href=\"https://docs.aws.amazon.com/datasync/latest/userguide/run-task.html#understand-task-execution-statuses\">Task execution statuses</a>.</p>"""
    verify_duration: NotRequired["capo_datasync.types.duration.Duration"]
    r"""<p>The time in milliseconds that your task execution was in the <code>VERIFYING</code> step. For more information, see <a href=\"https://docs.aws.amazon.com/datasync/latest/userguide/run-task.html#understand-task-execution-statuses\">Task execution statuses</a>.</p> <p>For Enhanced mode tasks, the value is always <code>0</code>. For more information, see <a href=\"https://docs.aws.amazon.com/datasync/latest/userguide/how-datasync-transfer-works.html#how-verifying-works\">How DataSync verifies your data's integrity</a>.</p>"""
    verify_status: NotRequired["capo_datasync.types.phase_status.PhaseStatus"]
    r"""<p>The status of the <code>VERIFYING</code> step for your task execution. For more information, see <a href=\"https://docs.aws.amazon.com/datasync/latest/userguide/run-task.html#understand-task-execution-statuses\">Task execution statuses</a>.</p>"""
    error_code: NotRequired["capo_datasync.types.string.string"]
    r"""<p>An error that DataSync encountered during your task execution. You can use this information to help <a href=\"https://docs.aws.amazon.com/datasync/latest/userguide/troubleshooting-datasync-locations-tasks.html\">troubleshoot issues</a>.</p>"""
    error_detail: NotRequired["capo_datasync.types.string.string"]
    r"""<p>The detailed description of an error that DataSync encountered during your task execution. You can use this information to help <a href=\"https://docs.aws.amazon.com/datasync/latest/userguide/troubleshooting-datasync-locations-tasks.html\">troubleshoot issues</a>. </p>"""
