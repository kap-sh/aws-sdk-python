"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeLocationAzureBlob``."""
...
def handle_response(
    ...
    out: capo_datasync.types.describe_location_azure_blob_response.DescribeLocationAzureBlobResponse = capo_datasync.types.describe_location_azure_blob_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.DescribeLocationAzureBlob"
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_location_azure_blob_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_location_azure_blob(
