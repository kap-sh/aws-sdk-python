"""Generated from Smithy shape ``com.amazonaws.datasync#ListTasks``."""
...
def handle_response(
    ...
    out: capo_datasync.types.list_tasks_response.ListTasksResponse = (
        capo_datasync.types.list_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.list_tasks_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_tasks(
    ...
    input_: capo_datasync.types.list_tasks_request.ListTasksRequest,
) -> tuple[capo_datasync.types.list_tasks_response.ListTasksResponse, zapros.Response]:
