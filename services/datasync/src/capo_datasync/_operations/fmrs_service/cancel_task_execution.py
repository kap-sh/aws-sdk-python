"""Generated from Smithy shape ``com.amazonaws.datasync#CancelTaskExecution``."""
...
def handle_response(
    ...
    out: capo_datasync.types.cancel_task_execution_response.CancelTaskExecutionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.cancel_task_execution_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_cancel_task_execution(
