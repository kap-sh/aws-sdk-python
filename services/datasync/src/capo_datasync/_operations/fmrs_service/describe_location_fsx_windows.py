"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeLocationFsxWindows``."""
...
def handle_response(
    ...
    out: capo_datasync.types.describe_location_fsx_windows_response.DescribeLocationFsxWindowsResponse = capo_datasync.types.describe_location_fsx_windows_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_datasync._auth._sigv4.build_sigv4_auth_scheme(
                "datasync", options.region
            )
        )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.DescribeLocationFsxWindows"
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_location_fsx_windows_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_location_fsx_windows(
