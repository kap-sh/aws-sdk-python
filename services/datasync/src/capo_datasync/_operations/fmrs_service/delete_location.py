"""Generated from Smithy shape ``com.amazonaws.datasync#DeleteLocation``."""
...
def handle_response(
    ...
    out: capo_datasync.types.delete_location_response.DeleteLocationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.delete_location_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_location(
    ...
    capo_datasync.types.delete_location_response.DeleteLocationResponse, zapros.Response
]:
