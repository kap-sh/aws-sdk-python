...
def handle_response(
    ...
    out: capo_datasync.types.create_location_smb_response.CreateLocationSmbResponse = (
        capo_datasync.types.create_location_smb_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.create_location_smb_request.serialize_aws_json_1_1(input_)
    ).encode()
