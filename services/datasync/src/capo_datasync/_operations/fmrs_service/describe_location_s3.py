"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeLocationS3``."""
...
def handle_response(
    ...
    out: capo_datasync.types.describe_location_s3_response.DescribeLocationS3Response = capo_datasync.types.describe_location_s3_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_location_s3_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_location_s3(
