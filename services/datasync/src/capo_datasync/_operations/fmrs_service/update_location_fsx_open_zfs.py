"""Generated from Smithy shape ``com.amazonaws.datasync#UpdateLocationFsxOpenZfs``."""
...
def handle_response(
    ...
    out: capo_datasync.types.update_location_fsx_open_zfs_response.UpdateLocationFsxOpenZfsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.UpdateLocationFsxOpenZfs"
    body: bytes | None = json.dumps(
        capo_datasync.types.update_location_fsx_open_zfs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_location_fsx_open_zfs(
