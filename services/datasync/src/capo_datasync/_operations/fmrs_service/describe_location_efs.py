"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeLocationEfs``."""
...
def handle_response(
    ...
    out: capo_datasync.types.describe_location_efs_response.DescribeLocationEfsResponse = capo_datasync.types.describe_location_efs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_location_efs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_location_efs(
