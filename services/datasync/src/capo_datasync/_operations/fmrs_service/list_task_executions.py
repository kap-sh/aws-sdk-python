"""Generated from Smithy shape ``com.amazonaws.datasync#ListTaskExecutions``."""
...
import capo_datasync.types.task_execution_list
...
def handle_response(
    ...
    out: capo_datasync.types.list_task_executions_response.ListTaskExecutionsResponse = capo_datasync.types.list_task_executions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.list_task_executions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_task_executions(
