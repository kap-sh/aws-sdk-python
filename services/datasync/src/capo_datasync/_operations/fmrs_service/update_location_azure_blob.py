"""Generated from Smithy shape ``com.amazonaws.datasync#UpdateLocationAzureBlob``."""
...
def handle_response(
    ...
    out: capo_datasync.types.update_location_azure_blob_response.UpdateLocationAzureBlobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.UpdateLocationAzureBlob"
    body: bytes | None = json.dumps(
        capo_datasync.types.update_location_azure_blob_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_location_azure_blob(
