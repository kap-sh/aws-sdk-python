"""Generated from Smithy shape ``com.amazonaws.datasync#CreateLocationAzureBlob``."""
...
def handle_response(
    ...
    out: capo_datasync.types.create_location_azure_blob_response.CreateLocationAzureBlobResponse = capo_datasync.types.create_location_azure_blob_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.CreateLocationAzureBlob"
    body: bytes | None = json.dumps(
        capo_datasync.types.create_location_azure_blob_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_location_azure_blob(
