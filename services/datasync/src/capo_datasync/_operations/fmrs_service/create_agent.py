...
def handle_response(
    ...
    out: capo_datasync.types.create_agent_response.CreateAgentResponse = (
        capo_datasync.types.create_agent_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.create_agent_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_agent(
    ...
    capo_datasync.types.create_agent_response.CreateAgentResponse, zapros.Response
]:
