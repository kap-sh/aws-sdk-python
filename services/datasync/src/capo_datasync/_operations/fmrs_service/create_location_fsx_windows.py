"""Generated from Smithy shape ``com.amazonaws.datasync#CreateLocationFsxWindows``."""
...
def handle_response(
    ...
    out: capo_datasync.types.create_location_fsx_windows_response.CreateLocationFsxWindowsResponse = capo_datasync.types.create_location_fsx_windows_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.CreateLocationFsxWindows"
    body: bytes | None = json.dumps(
        capo_datasync.types.create_location_fsx_windows_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_location_fsx_windows(
