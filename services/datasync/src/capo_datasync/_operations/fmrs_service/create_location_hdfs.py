"""Generated from Smithy shape ``com.amazonaws.datasync#CreateLocationHdfs``."""
...
def handle_response(
    ...
    out: capo_datasync.types.create_location_hdfs_response.CreateLocationHdfsResponse = capo_datasync.types.create_location_hdfs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.CreateLocationHdfs"
    body: bytes | None = json.dumps(
        capo_datasync.types.create_location_hdfs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_location_hdfs(
