"""Generated from Smithy shape ``com.amazonaws.datasync#UpdateLocationFsxOntap``."""
...
def handle_response(
    ...
    out: capo_datasync.types.update_location_fsx_ontap_response.UpdateLocationFsxOntapResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.UpdateLocationFsxOntap"
    body: bytes | None = json.dumps(
        capo_datasync.types.update_location_fsx_ontap_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_location_fsx_ontap(
