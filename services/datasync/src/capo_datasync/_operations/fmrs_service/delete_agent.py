"""Generated from Smithy shape ``com.amazonaws.datasync#DeleteAgent``."""
...
def handle_response(
    ...
    out: capo_datasync.types.delete_agent_response.DeleteAgentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.delete_agent_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_agent(
    ...
    capo_datasync.types.delete_agent_response.DeleteAgentResponse, zapros.Response
]:
