"""Generated from Smithy shape ``com.amazonaws.datasync#ListLocations``."""
...
def handle_response(
    ...
    out: capo_datasync.types.list_locations_response.ListLocationsResponse = (
        capo_datasync.types.list_locations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.list_locations_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_locations(
    ...
    capo_datasync.types.list_locations_response.ListLocationsResponse, zapros.Response
]:
