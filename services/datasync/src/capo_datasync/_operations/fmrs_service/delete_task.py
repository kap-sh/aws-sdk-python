...
def handle_response(
    ...
    out: capo_datasync.types.delete_task_response.DeleteTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.delete_task_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_task(
    ...
    capo_datasync.types.delete_task_response.DeleteTaskResponse, zapros.Response
]:
