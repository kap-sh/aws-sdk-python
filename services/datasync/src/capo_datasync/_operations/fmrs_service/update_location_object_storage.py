"""Generated from Smithy shape ``com.amazonaws.datasync#UpdateLocationObjectStorage``."""
...
def handle_response(
    ...
    out: capo_datasync.types.update_location_object_storage_response.UpdateLocationObjectStorageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.UpdateLocationObjectStorage"
    body: bytes | None = json.dumps(
        capo_datasync.types.update_location_object_storage_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_location_object_storage(
