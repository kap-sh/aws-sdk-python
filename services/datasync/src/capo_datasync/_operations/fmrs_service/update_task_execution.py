"""Generated from Smithy shape ``com.amazonaws.datasync#UpdateTaskExecution``."""
...
def handle_response(
    ...
    out: capo_datasync.types.update_task_execution_response.UpdateTaskExecutionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.UpdateTaskExecution"
    body: bytes | None = json.dumps(
        capo_datasync.types.update_task_execution_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_task_execution(
