...
class GreengrassV2Error(Exception):
    """Base class for all GreengrassV2 service errors."""


class ServiceError(GreengrassV2Error):
...
class SerializationError(GreengrassV2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(GreengrassV2Error):
...
class WaiterFailedError(GreengrassV2Error):
...
class WaiterTimeoutError(GreengrassV2Error):
