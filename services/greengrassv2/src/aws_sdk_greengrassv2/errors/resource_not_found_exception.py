"""Generated from Smithy shape ``com.amazonaws.greengrassv2#ResourceNotFoundException``."""
...
class ResourceNotFoundException_(TypedDict, closed=True):
    ...
    resource_id: "aws_sdk_greengrassv2.types.string.String"
    """<p>The ID of the resource that isn't found.</p>"""
    resource_type: "aws_sdk_greengrassv2.types.string.String"
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.greengrassv2#ResourceNotFoundException``."""
