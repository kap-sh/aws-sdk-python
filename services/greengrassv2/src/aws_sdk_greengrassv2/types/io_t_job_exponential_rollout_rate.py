...
if TYPE_CHECKING:
    import aws_sdk_greengrassv2.types.io_t_job_rate_increase_criteria
    import aws_sdk_greengrassv2.types.io_t_job_rollout_base_rate_per_minute
...
class IoTJobExponentialRolloutRate(TypedDict):
    ...
    rate_increase_criteria: "aws_sdk_greengrassv2.types.io_t_job_rate_increase_criteria.IoTJobRateIncreaseCriteria"
...
def serialize_json(value: IoTJobExponentialRolloutRate) -> dict:
    ...
    out["rateIncreaseCriteria"] = (
        aws_sdk_greengrassv2.types.io_t_job_rate_increase_criteria.serialize_json(
...
def deserialize_json(data: dict) -> IoTJobExponentialRolloutRate:
    ...
    if "rateIncreaseCriteria" in data:
        ...
        out["rate_increase_criteria"] = (
            aws_sdk_greengrassv2.types.io_t_job_rate_increase_criteria.deserialize_json(
