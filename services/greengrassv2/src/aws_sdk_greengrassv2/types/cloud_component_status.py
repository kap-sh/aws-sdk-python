...
if TYPE_CHECKING:
    ...
    import aws_sdk_greengrassv2.types.string_map
...
class CloudComponentStatus(TypedDict, closed=True):
    ...
    errors: NotRequired["aws_sdk_greengrassv2.types.string_map.StringMap"]
...
def serialize_json(value: CloudComponentStatus) -> dict:
    ...
    if "component_state" in value:
        ...
        out["componentState"] = (
            aws_sdk_greengrassv2.types.cloud_component_state.serialize_json(
    ...
    if "errors" in value:
        ...
        out["errors"] = aws_sdk_greengrassv2.types.string_map.serialize_json(
            value["errors"]
        )
...
def deserialize_json(data: dict) -> CloudComponentStatus:
    ...
    if "componentState" in data:
        ...
        out["component_state"] = (
            aws_sdk_greengrassv2.types.cloud_component_state.deserialize_json(
                data["componentState"]
            )
        )
    if "message" in data:
    ...
    if "errors" in data:
        ...
        out["errors"] = aws_sdk_greengrassv2.types.string_map.deserialize_json(
            data["errors"]
        )
