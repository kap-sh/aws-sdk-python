...
if TYPE_CHECKING:
    ...
    import aws_sdk_greengrassv2.types.io_t_job_executions_rollout_config
...
class DeploymentIoTJobConfiguration(TypedDict, closed=True):
    ...
    abort_config: NotRequired[
        "aws_sdk_greengrassv2.types.io_t_job_abort_config.IoTJobAbortConfig"
    ]
    ...
    timeout_config: NotRequired[
        "aws_sdk_greengrassv2.types.io_t_job_timeout_config.IoTJobTimeoutConfig"
    ]
...
def serialize_json(value: DeploymentIoTJobConfiguration) -> dict:
    ...
    if "job_executions_rollout_config" in value:
        ...
        out["jobExecutionsRolloutConfig"] = (
            aws_sdk_greengrassv2.types.io_t_job_executions_rollout_config.serialize_json(
    ...
    if "abort_config" in value:
        ...
        out["abortConfig"] = (
            aws_sdk_greengrassv2.types.io_t_job_abort_config.serialize_json(
                value["abort_config"]
            )
        )
    if "timeout_config" in value:
        ...
        out["timeoutConfig"] = (
            aws_sdk_greengrassv2.types.io_t_job_timeout_config.serialize_json(
...
def deserialize_json(data: dict) -> DeploymentIoTJobConfiguration:
    ...
    if "jobExecutionsRolloutConfig" in data:
        ...
        out["job_executions_rollout_config"] = (
            aws_sdk_greengrassv2.types.io_t_job_executions_rollout_config.deserialize_json(
    ...
    if "abortConfig" in data:
        ...
        out["abort_config"] = (
            aws_sdk_greengrassv2.types.io_t_job_abort_config.deserialize_json(
                data["abortConfig"]
            )
        )
    if "timeoutConfig" in data:
        ...
        out["timeout_config"] = (
            aws_sdk_greengrassv2.types.io_t_job_timeout_config.deserialize_json(
                data["timeoutConfig"]
            )
        )
    return out
