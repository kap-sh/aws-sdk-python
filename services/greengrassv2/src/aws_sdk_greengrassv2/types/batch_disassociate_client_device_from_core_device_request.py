...
class BatchDisassociateClientDeviceFromCoreDeviceRequest(TypedDict):
    entries: NotRequired[
...
def serialize_json(value: BatchDisassociateClientDeviceFromCoreDeviceRequest) -> dict:
    ...
    if "entries" in value:
        ...
        out["entries"] = (
            aws_sdk_greengrassv2.types.disassociate_client_device_from_core_device_entry_list.serialize_json(
                value["entries"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> BatchDisassociateClientDeviceFromCoreDeviceRequest:
    ...
    if "entries" in data:
        ...
        out["entries"] = (
            aws_sdk_greengrassv2.types.disassociate_client_device_from_core_device_entry_list.deserialize_json(
                data["entries"]
            )
        )
    return out
