...
if TYPE_CHECKING:
    import aws_sdk_greengrassv2.types.effective_deployment_error_type

EffectiveDeploymentErrorTypeList: TypeAlias = list[
    "aws_sdk_greengrassv2.types.effective_deployment_error_type.EffectiveDeploymentErrorType"
]
