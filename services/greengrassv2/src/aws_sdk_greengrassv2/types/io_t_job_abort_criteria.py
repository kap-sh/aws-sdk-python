...
if TYPE_CHECKING:
    import aws_sdk_greengrassv2.types.io_t_job_abort_action
    import aws_sdk_greengrassv2.types.io_t_job_abort_threshold_percentage
    import aws_sdk_greengrassv2.types.io_t_job_execution_failure_type
...
class IoTJobAbortCriteria(TypedDict, closed=True):
    ...
    threshold_percentage: "aws_sdk_greengrassv2.types.io_t_job_abort_threshold_percentage.IoTJobAbortThresholdPercentage"
    ...
    min_number_of_executed_things: "aws_sdk_greengrassv2.types.io_t_job_minimum_number_of_executed_things.IoTJobMinimumNumberOfExecutedThings"
...
def serialize_json(value: IoTJobAbortCriteria) -> dict:
    ...
    out["failureType"] = (
        aws_sdk_greengrassv2.types.io_t_job_execution_failure_type.serialize_json(
            value["failure_type"]
        )
    )
    import aws_sdk_greengrassv2.types.io_t_job_abort_action

    out["action"] = aws_sdk_greengrassv2.types.io_t_job_abort_action.serialize_json(
        value["action"]
    )
...
def deserialize_json(data: dict) -> IoTJobAbortCriteria:
    ...
    if "failureType" in data:
        ...
        out["failure_type"] = (
            aws_sdk_greengrassv2.types.io_t_job_execution_failure_type.deserialize_json(
                data["failureType"]
            )
        )
    else:
    ...
    if "action" in data:
        ...
        out["action"] = (
            aws_sdk_greengrassv2.types.io_t_job_abort_action.deserialize_json(
                data["action"]
            )
        )
    else:
