...
from aws_sdk_greengrassv2._services._aws_config import aws_config
...
class GreengrassV2ClientConfig(TypedDict, total=False, closed=True):
...
class GreengrassV2Client:
    ...
    def __init__(
        ...
        self._config = GreengrassV2ClientConfig(
            {
