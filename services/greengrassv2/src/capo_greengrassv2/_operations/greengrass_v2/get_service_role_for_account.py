"""Generated from Smithy shape ``com.amazonaws.greengrassv2#GetServiceRoleForAccount``."""
...
def handle_response(
    ...
    out: capo_greengrassv2.types.get_service_role_for_account_response.GetServiceRoleForAccountResponse = capo_greengrassv2.types.get_service_role_for_account_response.deserialize_json(
