...
import capo_greengrassv2.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_greengrassv2.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_greengrassv2.types.cancel_deployment_response.CancelDeploymentResponse = (
        capo_greengrassv2.types.cancel_deployment_response.deserialize_json(
