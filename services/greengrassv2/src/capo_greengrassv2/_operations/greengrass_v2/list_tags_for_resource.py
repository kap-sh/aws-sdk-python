...
def handle_response(
    ...
    out: capo_greengrassv2.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_greengrassv2.types.list_tags_for_resource_response.deserialize_json(
