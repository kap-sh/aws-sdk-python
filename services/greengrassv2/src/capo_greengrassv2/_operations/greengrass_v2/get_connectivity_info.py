...
def handle_response(
    ...
    out: capo_greengrassv2.types.get_connectivity_info_response.GetConnectivityInfoResponse = capo_greengrassv2.types.get_connectivity_info_response.deserialize_json(
