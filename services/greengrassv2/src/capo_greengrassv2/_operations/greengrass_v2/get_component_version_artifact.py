...
def handle_response(
    ...
    out: capo_greengrassv2.types.get_component_version_artifact_response.GetComponentVersionArtifactResponse = capo_greengrassv2.types.get_component_version_artifact_response.deserialize_json(
