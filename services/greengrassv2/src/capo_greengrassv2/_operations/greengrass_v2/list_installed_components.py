...
def handle_response(
    ...
    out: capo_greengrassv2.types.list_installed_components_response.ListInstalledComponentsResponse = capo_greengrassv2.types.list_installed_components_response.deserialize_json(
