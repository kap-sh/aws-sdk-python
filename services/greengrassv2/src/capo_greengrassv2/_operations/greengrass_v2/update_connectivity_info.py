...
def handle_response(
    ...
    out: capo_greengrassv2.types.update_connectivity_info_response.UpdateConnectivityInfoResponse = capo_greengrassv2.types.update_connectivity_info_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrassv2.types.update_connectivity_info_request.serialize_json(input_)
    ).encode()
