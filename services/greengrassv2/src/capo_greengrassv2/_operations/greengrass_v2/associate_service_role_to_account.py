...
def handle_response(
    ...
    out: capo_greengrassv2.types.associate_service_role_to_account_response.AssociateServiceRoleToAccountResponse = capo_greengrassv2.types.associate_service_role_to_account_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrassv2.types.associate_service_role_to_account_request.serialize_json(
            input_
        )
    ).encode()
