...
class ResolveComponentCandidatesRequest(TypedDict, closed=True):
...
def serialize_json(value: ResolveComponentCandidatesRequest) -> dict:
    ...
    if "platform" in value:
        ...
        out["platform"] = capo_greengrassv2.types.component_platform.serialize_json(
            value["platform"]
        )
    if "component_candidates" in value:
        ...
        out["componentCandidates"] = (
            capo_greengrassv2.types.component_candidate_list.serialize_json(
...
def deserialize_json(data: dict) -> ResolveComponentCandidatesRequest:
    ...
    if "componentCandidates" in data:
        ...
        out["component_candidates"] = (
            capo_greengrassv2.types.component_candidate_list.deserialize_json(
