...
if TYPE_CHECKING:
    import capo_greengrassv2.types.io_t_job_in_progress_timeout_in_minutes


class IoTJobTimeoutConfig(TypedDict, closed=True):
    in_progress_timeout_in_minutes: NotRequired[
        "capo_greengrassv2.types.io_t_job_in_progress_timeout_in_minutes.IoTJobInProgressTimeoutInMinutes"
    ]
