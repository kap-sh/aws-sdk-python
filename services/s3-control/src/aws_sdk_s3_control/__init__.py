...
from ._services.async_s3_control import AsyncS3ControlClient as AsyncS3ControlClient
from ._services.s3_control import S3ControlClient as S3ControlClient
