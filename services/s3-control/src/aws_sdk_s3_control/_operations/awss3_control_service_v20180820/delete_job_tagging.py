"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteJobTagging``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.delete_job_tagging_result.DeleteJobTaggingResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.delete_job_tagging_request.DeleteJobTaggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_job_tagging(
