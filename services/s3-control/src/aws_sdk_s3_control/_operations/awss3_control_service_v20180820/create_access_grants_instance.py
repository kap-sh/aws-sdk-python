...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.create_access_grants_instance_result.CreateAccessGrantsInstanceResult = aws_sdk_s3_control.types.create_access_grants_instance_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.create_access_grants_instance_request.CreateAccessGrantsInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
