...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.list_storage_lens_groups_result.ListStorageLensGroupsResult = aws_sdk_s3_control.types.list_storage_lens_groups_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.list_storage_lens_groups_request.ListStorageLensGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
