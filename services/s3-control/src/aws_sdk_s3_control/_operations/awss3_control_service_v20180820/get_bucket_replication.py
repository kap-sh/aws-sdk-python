...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_bucket_replication_result.GetBucketReplicationResult = aws_sdk_s3_control.types.get_bucket_replication_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_bucket_replication_request.GetBucketReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
