...
def build_request(
    ...
    input: aws_sdk_s3_control.types.put_storage_lens_configuration_request.PutStorageLensConfigurationRequest,
) -> zapros.Request:
    ...
    if "storage_lens_configuration" in input:
        ...
        aws_sdk_s3_control.types.storage_lens_configuration.serialize_xml(
            input["storage_lens_configuration"], root, "StorageLensConfiguration"
        )
    if "tags" in input:
