...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_bucket_lifecycle_configuration_result.GetBucketLifecycleConfigurationResult = aws_sdk_s3_control.types.get_bucket_lifecycle_configuration_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_bucket_lifecycle_configuration_request.GetBucketLifecycleConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
