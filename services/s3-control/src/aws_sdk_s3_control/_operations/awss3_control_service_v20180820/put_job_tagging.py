...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            import aws_sdk_s3_control.errors.too_many_tags_exception

            raise aws_sdk_s3_control.errors.too_many_tags_exception.TooManyTagsException.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.put_job_tagging_result.PutJobTaggingResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.put_job_tagging_request.PutJobTaggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def put_job_tagging(
    ...
    aws_sdk_s3_control.types.put_job_tagging_result.PutJobTaggingResult, zapros.Response
]:
