...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_storage_lens_group_result.GetStorageLensGroupResult = {
        "storage_lens_group": aws_sdk_s3_control.types.storage_lens_group.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_storage_lens_group_request.GetStorageLensGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
