"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteMultiRegionAccessPoint``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.delete_multi_region_access_point_result.DeleteMultiRegionAccessPointResult = aws_sdk_s3_control.types.delete_multi_region_access_point_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.delete_multi_region_access_point_request.DeleteMultiRegionAccessPointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/async-requests/mrap/delete"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    if "account_id" in input_:
        headers["x-amz-account-id"] = str(input_["account_id"])
    root = Element("DeleteMultiRegionAccessPointRequest")
...
async def async_delete_multi_region_access_point(
