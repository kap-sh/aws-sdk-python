...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.describe_job_result.DescribeJobResult = (
        aws_sdk_s3_control.types.describe_job_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.describe_job_request.DescribeJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_job(
    ...
    aws_sdk_s3_control.types.describe_job_result.DescribeJobResult, zapros.Response
]:
