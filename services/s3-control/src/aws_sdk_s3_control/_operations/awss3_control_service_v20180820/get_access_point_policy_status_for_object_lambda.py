...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_access_point_policy_status_for_object_lambda_result.GetAccessPointPolicyStatusForObjectLambdaResult = aws_sdk_s3_control.types.get_access_point_policy_status_for_object_lambda_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_access_point_policy_status_for_object_lambda_request.GetAccessPointPolicyStatusForObjectLambdaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
