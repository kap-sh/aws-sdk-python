...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.list_access_points_for_object_lambda_result.ListAccessPointsForObjectLambdaResult = aws_sdk_s3_control.types.list_access_points_for_object_lambda_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.list_access_points_for_object_lambda_request.ListAccessPointsForObjectLambdaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
