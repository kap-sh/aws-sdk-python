...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.create_access_point_for_object_lambda_result.CreateAccessPointForObjectLambdaResult = aws_sdk_s3_control.types.create_access_point_for_object_lambda_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.create_access_point_for_object_lambda_request.CreateAccessPointForObjectLambdaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
