"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteAccessPointScope``."""
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.delete_access_point_scope_request.DeleteAccessPointScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_access_point_scope(
