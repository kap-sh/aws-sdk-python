"""Generated from Smithy shape ``com.amazonaws.s3control#PutAccessPointScope``."""
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.put_access_point_scope_request.PutAccessPointScopeRequest,
) -> zapros.Request:
    ...
    if "scope" in input:
        ...
        aws_sdk_s3_control.types.scope.serialize_xml(input["scope"], root, "Scope")
...
async def async_put_access_point_scope(
