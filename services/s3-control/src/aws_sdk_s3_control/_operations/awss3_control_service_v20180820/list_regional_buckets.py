...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.list_regional_buckets_result.ListRegionalBucketsResult = aws_sdk_s3_control.types.list_regional_buckets_result.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.list_regional_buckets_request.ListRegionalBucketsRequest,
) -> zapros.Request:
