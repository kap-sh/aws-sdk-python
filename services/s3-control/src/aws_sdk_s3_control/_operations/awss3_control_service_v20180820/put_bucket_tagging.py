"""Generated from Smithy shape ``com.amazonaws.s3control#PutBucketTagging``."""
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.put_bucket_tagging_request.PutBucketTaggingRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/bucket/{Bucket}/tagging"
...
async def async_put_bucket_tagging(
