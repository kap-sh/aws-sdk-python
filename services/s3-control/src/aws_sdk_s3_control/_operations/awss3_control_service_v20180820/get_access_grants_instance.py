"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessGrantsInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_access_grants_instance_result.GetAccessGrantsInstanceResult = aws_sdk_s3_control.types.get_access_grants_instance_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_access_grants_instance_request.GetAccessGrantsInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_access_grants_instance(
