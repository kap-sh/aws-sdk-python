...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_storage_lens_configuration_tagging_result.GetStorageLensConfigurationTaggingResult = aws_sdk_s3_control.types.get_storage_lens_configuration_tagging_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_storage_lens_configuration_tagging_request.GetStorageLensConfigurationTaggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
