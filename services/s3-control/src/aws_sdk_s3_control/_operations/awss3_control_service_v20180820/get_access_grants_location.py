...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_access_grants_location_result.GetAccessGrantsLocationResult = aws_sdk_s3_control.types.get_access_grants_location_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_access_grants_location_request.GetAccessGrantsLocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
