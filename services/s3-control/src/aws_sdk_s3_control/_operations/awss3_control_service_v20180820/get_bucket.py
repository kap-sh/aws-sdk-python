"""Generated from Smithy shape ``com.amazonaws.s3control#GetBucket``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_bucket_result.GetBucketResult = (
        aws_sdk_s3_control.types.get_bucket_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_bucket_request.GetBucketRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_bucket(
    ...
    input_: aws_sdk_s3_control.types.get_bucket_request.GetBucketRequest,
) -> tuple[aws_sdk_s3_control.types.get_bucket_result.GetBucketResult, zapros.Response]:
