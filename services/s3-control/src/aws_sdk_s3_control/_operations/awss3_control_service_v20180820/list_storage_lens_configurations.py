"""Generated from Smithy shape ``com.amazonaws.s3control#ListStorageLensConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.list_storage_lens_configurations_result.ListStorageLensConfigurationsResult = aws_sdk_s3_control.types.list_storage_lens_configurations_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.list_storage_lens_configurations_request.ListStorageLensConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/storagelens"
    params: dict[str, str] = {}
...
async def async_list_storage_lens_configurations(
