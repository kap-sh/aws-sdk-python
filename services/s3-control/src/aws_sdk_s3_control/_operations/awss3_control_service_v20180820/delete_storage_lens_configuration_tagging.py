"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteStorageLensConfigurationTagging``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.delete_storage_lens_configuration_tagging_result.DeleteStorageLensConfigurationTaggingResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.delete_storage_lens_configuration_tagging_request.DeleteStorageLensConfigurationTaggingRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/storagelens/{ConfigId}/tagging"
    url = url.replace("{ConfigId}", quote(str(input["config_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_storage_lens_configuration_tagging(
