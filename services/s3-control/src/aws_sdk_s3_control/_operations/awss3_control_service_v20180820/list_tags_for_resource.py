...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.list_tags_for_resource_result.ListTagsForResourceResult = aws_sdk_s3_control.types.list_tags_for_resource_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
