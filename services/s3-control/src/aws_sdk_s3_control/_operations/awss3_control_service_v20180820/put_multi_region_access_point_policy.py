"""Generated from Smithy shape ``com.amazonaws.s3control#PutMultiRegionAccessPointPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.put_multi_region_access_point_policy_result.PutMultiRegionAccessPointPolicyResult = aws_sdk_s3_control.types.put_multi_region_access_point_policy_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.put_multi_region_access_point_policy_request.PutMultiRegionAccessPointPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/async-requests/mrap/put-policy"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    if "account_id" in input_:
        headers["x-amz-account-id"] = str(input_["account_id"])
    root = Element("PutMultiRegionAccessPointPolicyRequest")
...
async def async_put_multi_region_access_point_policy(
