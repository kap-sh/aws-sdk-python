...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_access_grant_result.GetAccessGrantResult = (
        aws_sdk_s3_control.types.get_access_grant_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_access_grant_request.GetAccessGrantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{AccessGrantId}", quote(str(input_["access_grant_id"]), safe=""))
    params: dict[str, str] = {}
