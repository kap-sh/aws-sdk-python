...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_bucket_policy_result.GetBucketPolicyResult = (
        aws_sdk_s3_control.types.get_bucket_policy_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_bucket_policy_request.GetBucketPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
