...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.create_access_grants_location_result.CreateAccessGrantsLocationResult = aws_sdk_s3_control.types.create_access_grants_location_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.create_access_grants_location_request.CreateAccessGrantsLocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
