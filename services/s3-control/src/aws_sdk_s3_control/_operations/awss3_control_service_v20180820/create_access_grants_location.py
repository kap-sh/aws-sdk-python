...
def build_request(
    ...
    input: aws_sdk_s3_control.types.create_access_grants_location_request.CreateAccessGrantsLocationRequest,
) -> zapros.Request:
    ...
    if "location_scope" in input:
        SubElement(root, "LocationScope").text = str(input["location_scope"])
