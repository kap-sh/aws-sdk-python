"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessPointConfigurationForObjectLambda``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_access_point_configuration_for_object_lambda_result.GetAccessPointConfigurationForObjectLambdaResult = aws_sdk_s3_control.types.get_access_point_configuration_for_object_lambda_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_access_point_configuration_for_object_lambda_request.GetAccessPointConfigurationForObjectLambdaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_access_point_configuration_for_object_lambda(
