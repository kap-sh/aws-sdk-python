...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_access_point_policy_status_result.GetAccessPointPolicyStatusResult = aws_sdk_s3_control.types.get_access_point_policy_status_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_access_point_policy_status_request.GetAccessPointPolicyStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
