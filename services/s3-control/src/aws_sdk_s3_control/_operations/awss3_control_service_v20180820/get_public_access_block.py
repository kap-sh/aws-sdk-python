...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "NoSuchPublicAccessBlockConfiguration":
            import aws_sdk_s3_control.errors.no_such_public_access_block_configuration

            raise aws_sdk_s3_control.errors.no_such_public_access_block_configuration.NoSuchPublicAccessBlockConfiguration.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_public_access_block_output.GetPublicAccessBlockOutput = {
        "public_access_block_configuration": aws_sdk_s3_control.types.public_access_block_configuration.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_public_access_block_request.GetPublicAccessBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
