...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.list_access_grants_instances_result.ListAccessGrantsInstancesResult = aws_sdk_s3_control.types.list_access_grants_instances_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.list_access_grants_instances_request.ListAccessGrantsInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
