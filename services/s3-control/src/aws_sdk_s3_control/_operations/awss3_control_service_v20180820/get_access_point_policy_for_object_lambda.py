...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_access_point_policy_for_object_lambda_result.GetAccessPointPolicyForObjectLambdaResult = aws_sdk_s3_control.types.get_access_point_policy_for_object_lambda_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_access_point_policy_for_object_lambda_request.GetAccessPointPolicyForObjectLambdaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
