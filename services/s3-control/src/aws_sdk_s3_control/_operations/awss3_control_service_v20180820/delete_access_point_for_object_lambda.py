"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteAccessPointForObjectLambda``."""
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.delete_access_point_for_object_lambda_request.DeleteAccessPointForObjectLambdaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_access_point_for_object_lambda(
