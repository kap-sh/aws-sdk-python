...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.list_caller_access_grants_result.ListCallerAccessGrantsResult = aws_sdk_s3_control.types.list_caller_access_grants_result.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.list_caller_access_grants_request.ListCallerAccessGrantsRequest,
) -> zapros.Request:
    ...
    params["allowedByApplication"] = str(input.get("allowed_by_application", False))
