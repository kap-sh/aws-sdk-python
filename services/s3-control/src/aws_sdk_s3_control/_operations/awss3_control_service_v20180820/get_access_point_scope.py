...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_access_point_scope_result.GetAccessPointScopeResult = aws_sdk_s3_control.types.get_access_point_scope_result.deserialize_xml(
