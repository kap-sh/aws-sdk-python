...
def build_request(
    ...
    input: aws_sdk_s3_control.types.describe_multi_region_access_point_operation_request.DescribeMultiRegionAccessPointOperationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{RequestTokenARN+}", quote(str(input["request_token_arn"]), safe="/")
    )
    params: dict[str, str] = {}
