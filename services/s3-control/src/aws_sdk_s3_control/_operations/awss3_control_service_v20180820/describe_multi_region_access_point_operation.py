...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.describe_multi_region_access_point_operation_result.DescribeMultiRegionAccessPointOperationResult = aws_sdk_s3_control.types.describe_multi_region_access_point_operation_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.describe_multi_region_access_point_operation_request.DescribeMultiRegionAccessPointOperationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{RequestTokenARN+}", quote(str(input_["request_token_arn"]), safe="/")
    )
    params: dict[str, str] = {}
