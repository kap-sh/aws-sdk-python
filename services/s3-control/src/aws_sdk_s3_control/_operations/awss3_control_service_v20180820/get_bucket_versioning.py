...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_bucket_versioning_result.GetBucketVersioningResult = aws_sdk_s3_control.types.get_bucket_versioning_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_bucket_versioning_request.GetBucketVersioningRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
