...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.put_storage_lens_configuration_tagging_result.PutStorageLensConfigurationTaggingResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.put_storage_lens_configuration_tagging_request.PutStorageLensConfigurationTaggingRequest,
) -> zapros.Request:
