"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessGrantsInstanceForPrefix``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_access_grants_instance_for_prefix_result.GetAccessGrantsInstanceForPrefixResult = aws_sdk_s3_control.types.get_access_grants_instance_for_prefix_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_access_grants_instance_for_prefix_request.GetAccessGrantsInstanceForPrefixRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/accessgrantsinstance/prefix"
    params: dict[str, str] = {}
    if "s3_prefix" in input_:
        params["s3prefix"] = str(input_["s3_prefix"])
...
async def async_get_access_grants_instance_for_prefix(
