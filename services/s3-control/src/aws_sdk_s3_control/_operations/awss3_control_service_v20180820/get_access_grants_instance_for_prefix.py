...
def build_request(
    ...
    input: aws_sdk_s3_control.types.get_access_grants_instance_for_prefix_request.GetAccessGrantsInstanceForPrefixRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "s3_prefix" in input:
        params["s3prefix"] = str(input["s3_prefix"])
