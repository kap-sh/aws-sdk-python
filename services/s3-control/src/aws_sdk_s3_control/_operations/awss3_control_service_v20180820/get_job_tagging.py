...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_job_tagging_result.GetJobTaggingResult = (
        aws_sdk_s3_control.types.get_job_tagging_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_job_tagging_request.GetJobTaggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_job_tagging(
    ...
    aws_sdk_s3_control.types.get_job_tagging_result.GetJobTaggingResult, zapros.Response
]:
