"""Generated from Smithy shape ``com.amazonaws.s3control#PutPublicAccessBlock``."""
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.put_public_access_block_request.PutPublicAccessBlockRequest,
) -> zapros.Request:
