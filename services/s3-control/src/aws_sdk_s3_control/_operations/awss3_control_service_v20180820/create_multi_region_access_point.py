...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.create_multi_region_access_point_result.CreateMultiRegionAccessPointResult = aws_sdk_s3_control.types.create_multi_region_access_point_result.deserialize_xml(
