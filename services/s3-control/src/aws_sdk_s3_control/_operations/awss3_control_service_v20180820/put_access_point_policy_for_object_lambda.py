"""Generated from Smithy shape ``com.amazonaws.s3control#PutAccessPointPolicyForObjectLambda``."""
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.put_access_point_policy_for_object_lambda_request.PutAccessPointPolicyForObjectLambdaRequest,
) -> zapros.Request:
    ...
    root = Element("PutAccessPointPolicyForObjectLambdaRequest")
    if "policy" in input:
...
async def async_put_access_point_policy_for_object_lambda(
