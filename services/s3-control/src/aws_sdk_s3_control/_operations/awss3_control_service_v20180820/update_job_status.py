...
def build_request(
    ...
    input: aws_sdk_s3_control.types.update_job_status_request.UpdateJobStatusRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "requested_job_status" in input:
        params["requestedJobStatus"] = str(input["requested_job_status"])
    if "status_update_reason" in input:
        params["statusUpdateReason"] = str(input["status_update_reason"])
