"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteAccessGrantsInstanceResourcePolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.delete_access_grants_instance_resource_policy_request.DeleteAccessGrantsInstanceResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_access_grants_instance_resource_policy(
