...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_bucket_tagging_result.GetBucketTaggingResult = (
        aws_sdk_s3_control.types.get_bucket_tagging_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_bucket_tagging_request.GetBucketTaggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
