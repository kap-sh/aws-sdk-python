...
def build_request(
    ...
    input: aws_sdk_s3_control.types.list_access_points_for_directory_buckets_request.ListAccessPointsForDirectoryBucketsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "directory_bucket" in input:
        params["directoryBucket"] = str(input["directory_bucket"])
