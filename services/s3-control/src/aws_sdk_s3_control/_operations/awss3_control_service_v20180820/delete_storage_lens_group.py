"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteStorageLensGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.delete_storage_lens_group_request.DeleteStorageLensGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_storage_lens_group(
