"""Generated from Smithy shape ``com.amazonaws.s3control#ListAccessGrantsLocations``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.list_access_grants_locations_result.ListAccessGrantsLocationsResult = aws_sdk_s3_control.types.list_access_grants_locations_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.list_access_grants_locations_request.ListAccessGrantsLocationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/accessgrantsinstance/locations"
    params: dict[str, str] = {}
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    params["maxResults"] = str(input_.get("max_results", 0))
    if "location_scope" in input_:
        params["locationscope"] = str(input_["location_scope"])
...
async def async_list_access_grants_locations(
