"""Generated from Smithy shape ``com.amazonaws.s3control#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.untag_resource_result.UntagResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def untag_resource(
    ...
    aws_sdk_s3_control.types.untag_resource_result.UntagResourceResult, zapros.Response
]:
