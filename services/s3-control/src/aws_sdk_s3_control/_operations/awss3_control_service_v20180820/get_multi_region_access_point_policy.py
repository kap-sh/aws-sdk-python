...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_multi_region_access_point_policy_result.GetMultiRegionAccessPointPolicyResult = aws_sdk_s3_control.types.get_multi_region_access_point_policy_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_multi_region_access_point_policy_request.GetMultiRegionAccessPointPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
