...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_multi_region_access_point_routes_result.GetMultiRegionAccessPointRoutesResult = aws_sdk_s3_control.types.get_multi_region_access_point_routes_result.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.get_multi_region_access_point_routes_request.GetMultiRegionAccessPointRoutesRequest,
) -> zapros.Request:
    ...
    url = url.replace("{Mrap+}", quote(str(input["mrap"]), safe="/"))
    params: dict[str, str] = {}
