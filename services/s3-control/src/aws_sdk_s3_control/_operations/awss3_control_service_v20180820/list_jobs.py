...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNextTokenException":
            import aws_sdk_s3_control.errors.invalid_next_token_exception

            raise aws_sdk_s3_control.errors.invalid_next_token_exception.InvalidNextTokenException.from_xml(
                root
            )
        case "InvalidRequestException":
            import aws_sdk_s3_control.errors.invalid_request_exception

            raise aws_sdk_s3_control.errors.invalid_request_exception.InvalidRequestException.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.list_jobs_result.ListJobsResult = (
        aws_sdk_s3_control.types.list_jobs_result.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.list_jobs_request.ListJobsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "job_statuses" in input:
        params["jobStatuses"] = str(input["job_statuses"])
...
def list_jobs(
    ...
    input: aws_sdk_s3_control.types.list_jobs_request.ListJobsRequest,
) -> tuple[aws_sdk_s3_control.types.list_jobs_result.ListJobsResult, zapros.Response]:
