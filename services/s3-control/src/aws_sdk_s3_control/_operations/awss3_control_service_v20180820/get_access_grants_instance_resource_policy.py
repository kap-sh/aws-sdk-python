"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessGrantsInstanceResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_access_grants_instance_resource_policy_result.GetAccessGrantsInstanceResourcePolicyResult = aws_sdk_s3_control.types.get_access_grants_instance_resource_policy_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_access_grants_instance_resource_policy_request.GetAccessGrantsInstanceResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_access_grants_instance_resource_policy(
