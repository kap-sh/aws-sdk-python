"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteBucketTagging``."""
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.delete_bucket_tagging_request.DeleteBucketTaggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_bucket_tagging(
