"""Generated from Smithy shape ``com.amazonaws.s3control#UpdateJobPriority``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.update_job_priority_result.UpdateJobPriorityResult = (
        aws_sdk_s3_control.types.update_job_priority_result.deserialize_xml(
