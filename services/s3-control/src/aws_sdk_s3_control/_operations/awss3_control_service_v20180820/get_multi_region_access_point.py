...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_multi_region_access_point_result.GetMultiRegionAccessPointResult = aws_sdk_s3_control.types.get_multi_region_access_point_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_multi_region_access_point_request.GetMultiRegionAccessPointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
