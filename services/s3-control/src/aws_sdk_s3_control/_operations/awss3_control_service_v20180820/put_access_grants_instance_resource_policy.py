"""Generated from Smithy shape ``com.amazonaws.s3control#PutAccessGrantsInstanceResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.put_access_grants_instance_resource_policy_result.PutAccessGrantsInstanceResourcePolicyResult = aws_sdk_s3_control.types.put_access_grants_instance_resource_policy_result.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_s3_control.types.put_access_grants_instance_resource_policy_request.PutAccessGrantsInstanceResourcePolicyRequest,
) -> zapros.Request:
    ...
    if "policy" in input:
        SubElement(root, "Policy").text = str(input["policy"])
    if "organization" in input:
        SubElement(root, "Organization").text = str(input["organization"])
...
async def async_put_access_grants_instance_resource_policy(
