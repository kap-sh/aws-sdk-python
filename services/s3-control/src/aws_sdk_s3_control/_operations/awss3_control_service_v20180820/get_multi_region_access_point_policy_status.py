"""Generated from Smithy shape ``com.amazonaws.s3control#GetMultiRegionAccessPointPolicyStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_s3_control.types.get_multi_region_access_point_policy_status_result.GetMultiRegionAccessPointPolicyStatusResult = aws_sdk_s3_control.types.get_multi_region_access_point_policy_status_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3_control.types.get_multi_region_access_point_policy_status_request.GetMultiRegionAccessPointPolicyStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/mrap/instances/{Name+}/policystatus"
...
async def async_get_multi_region_access_point_policy_status(
