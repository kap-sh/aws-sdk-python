...
class S3ControlClientConfig(TypedDict, total=False):
...
class S3ControlClient:
    ...
    def associate_access_grants_identity_center(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.associate_access_grants_identity_center_request.AssociateAccessGrantsIdentityCenterRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.associate_access_grants_identity_center

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.associate_access_grants_identity_center.associate_access_grants_identity_center(
    ...
    def create_access_grant(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.create_access_grant_request.CreateAccessGrantRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.create_access_grant_result.CreateAccessGrantResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.create_access_grant.create_access_grant(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_access_grants_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.create_access_grants_instance_request.CreateAccessGrantsInstanceRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.create_access_grants_instance_result.CreateAccessGrantsInstanceResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.create_access_grants_instance.create_access_grants_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_access_grants_location(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.create_access_grants_location_request.CreateAccessGrantsLocationRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.create_access_grants_location_result.CreateAccessGrantsLocationResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.create_access_grants_location.create_access_grants_location(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_access_point(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.create_access_point_request.CreateAccessPointRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.create_access_point_result.CreateAccessPointResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.create_access_point.create_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_access_point_for_object_lambda(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.create_access_point_for_object_lambda_request.CreateAccessPointForObjectLambdaRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.create_access_point_for_object_lambda_result.CreateAccessPointForObjectLambdaResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.create_access_point_for_object_lambda.create_access_point_for_object_lambda(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_bucket(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.create_bucket_request.CreateBucketRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.create_bucket_result.CreateBucketResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.create_bucket.create_bucket(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.create_job_request.CreateJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.create_job_result.CreateJobResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.create_job.create_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_multi_region_access_point(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.create_multi_region_access_point_request.CreateMultiRegionAccessPointRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.create_multi_region_access_point_result.CreateMultiRegionAccessPointResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.create_multi_region_access_point.create_multi_region_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_storage_lens_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.create_storage_lens_group_request.CreateStorageLensGroupRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.create_storage_lens_group

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.create_storage_lens_group.create_storage_lens_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_grant(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_access_grant_request.DeleteAccessGrantRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_grant

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_grant.delete_access_grant(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_grants_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_access_grants_instance_request.DeleteAccessGrantsInstanceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_grants_instance

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_grants_instance.delete_access_grants_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_grants_instance_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_access_grants_instance_resource_policy_request.DeleteAccessGrantsInstanceResourcePolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_grants_instance_resource_policy

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_grants_instance_resource_policy.delete_access_grants_instance_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_grants_location(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_access_grants_location_request.DeleteAccessGrantsLocationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_grants_location

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_grants_location.delete_access_grants_location(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_point(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_access_point_request.DeleteAccessPointRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_point

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_point.delete_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_point_for_object_lambda(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_access_point_for_object_lambda_request.DeleteAccessPointForObjectLambdaRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_point_for_object_lambda

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_point_for_object_lambda.delete_access_point_for_object_lambda(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_point_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_access_point_policy_request.DeleteAccessPointPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_point_policy

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_point_policy.delete_access_point_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_point_policy_for_object_lambda(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_access_point_policy_for_object_lambda_request.DeleteAccessPointPolicyForObjectLambdaRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_point_policy_for_object_lambda

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_point_policy_for_object_lambda.delete_access_point_policy_for_object_lambda(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_point_scope(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_access_point_scope_request.DeleteAccessPointScopeRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_point_scope

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_access_point_scope.delete_access_point_scope(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_bucket(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_bucket_request.DeleteBucketRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_bucket

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_bucket.delete_bucket(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_bucket_lifecycle_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_bucket_lifecycle_configuration_request.DeleteBucketLifecycleConfigurationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_bucket_lifecycle_configuration

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_bucket_lifecycle_configuration.delete_bucket_lifecycle_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_bucket_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_bucket_policy_request.DeleteBucketPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_bucket_policy

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_bucket_policy.delete_bucket_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_bucket_replication(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_bucket_replication_request.DeleteBucketReplicationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_bucket_replication

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_bucket_replication.delete_bucket_replication(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_bucket_tagging(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_bucket_tagging_request.DeleteBucketTaggingRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_bucket_tagging

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_bucket_tagging.delete_bucket_tagging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_job_tagging(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_job_tagging_request.DeleteJobTaggingRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.delete_job_tagging_result.DeleteJobTaggingResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_job_tagging.delete_job_tagging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_multi_region_access_point(
        ...
        *,
        ...
        """<note> <p>This operation is not supported by directory buckets.</p> </note> <p>Deletes a Multi-Region Access Point. This action does not delete the buckets associated with the Multi-Region Access Point, only the Multi-Region Access Point itself.</p> <p>This action will always be routed to the US West (Oregon) Region. For more information about the restrictions around working with Multi-Region Access Points, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/MultiRegionAccessPointRestrictions.html\">Multi-Region Access Point restrictions and limitations</a> in the <i>Amazon S3 User Guide</i>.</p> <p>This request is asynchronous, meaning that you might receive a response before the command has completed. When this request provides a response, it provides a token that you can use to monitor the status of the request with <code>DescribeMultiRegionAccessPointOperation</code>.</p> <p>The following actions are related to <code>DeleteMultiRegionAccessPoint</code>:</p> <ul> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_CreateMultiRegionAccessPoint.html\">CreateMultiRegionAccessPoint</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_DescribeMultiRegionAccessPointOperation.html\">DescribeMultiRegionAccessPointOperation</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_GetMultiRegionAccessPoint.html\">GetMultiRegionAccessPoint</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_ListMultiRegionAccessPoints.html\">ListMultiRegionAccessPoints</a> </p> </li> </ul>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_multi_region_access_point_request.DeleteMultiRegionAccessPointRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.delete_multi_region_access_point_result.DeleteMultiRegionAccessPointResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_multi_region_access_point.delete_multi_region_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_public_access_block(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_public_access_block_request.DeletePublicAccessBlockRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_public_access_block

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_public_access_block.delete_public_access_block(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_storage_lens_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_storage_lens_configuration_request.DeleteStorageLensConfigurationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_storage_lens_configuration

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_storage_lens_configuration.delete_storage_lens_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_storage_lens_configuration_tagging(
        ...
        *,
        ...
        """<note> <p>This operation is not supported by directory buckets.</p> </note> <p>Deletes the Amazon S3 Storage Lens configuration tags. For more information about S3 Storage Lens, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/dev/storage_lens.html\">Assessing your storage activity and usage with Amazon S3 Storage Lens </a> in the <i>Amazon S3 User Guide</i>.</p> <note> <p>To use this action, you must have permission to perform the <code>s3:DeleteStorageLensConfigurationTagging</code> action. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/dev/storage_lens_iam_permissions.html\">Setting permissions to use Amazon S3 Storage Lens</a> in the <i>Amazon S3 User Guide</i>.</p> </note>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_storage_lens_configuration_tagging_request.DeleteStorageLensConfigurationTaggingRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.delete_storage_lens_configuration_tagging_result.DeleteStorageLensConfigurationTaggingResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_storage_lens_configuration_tagging.delete_storage_lens_configuration_tagging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_storage_lens_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.delete_storage_lens_group_request.DeleteStorageLensGroupRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_storage_lens_group

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.delete_storage_lens_group.delete_storage_lens_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.describe_job_request.DescribeJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.describe_job_result.DescribeJobResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.describe_job.describe_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_multi_region_access_point_operation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.describe_multi_region_access_point_operation_request.DescribeMultiRegionAccessPointOperationRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.describe_multi_region_access_point_operation_result.DescribeMultiRegionAccessPointOperationResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.describe_multi_region_access_point_operation.describe_multi_region_access_point_operation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def dissociate_access_grants_identity_center(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.dissociate_access_grants_identity_center_request.DissociateAccessGrantsIdentityCenterRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.dissociate_access_grants_identity_center

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.dissociate_access_grants_identity_center.dissociate_access_grants_identity_center(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_grant(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_grant_request.GetAccessGrantRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_grant_result.GetAccessGrantResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_grant.get_access_grant(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_grants_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_grants_instance_request.GetAccessGrantsInstanceRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_grants_instance_result.GetAccessGrantsInstanceResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_grants_instance.get_access_grants_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_grants_instance_for_prefix(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_grants_instance_for_prefix_request.GetAccessGrantsInstanceForPrefixRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_grants_instance_for_prefix_result.GetAccessGrantsInstanceForPrefixResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_grants_instance_for_prefix.get_access_grants_instance_for_prefix(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_grants_instance_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_grants_instance_resource_policy_request.GetAccessGrantsInstanceResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_grants_instance_resource_policy_result.GetAccessGrantsInstanceResourcePolicyResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_grants_instance_resource_policy.get_access_grants_instance_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_grants_location(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_grants_location_request.GetAccessGrantsLocationRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_grants_location_result.GetAccessGrantsLocationResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_grants_location.get_access_grants_location(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_point(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_point_request.GetAccessPointRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_point_result.GetAccessPointResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_point.get_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_point_configuration_for_object_lambda(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_point_configuration_for_object_lambda_request.GetAccessPointConfigurationForObjectLambdaRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_point_configuration_for_object_lambda_result.GetAccessPointConfigurationForObjectLambdaResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_point_configuration_for_object_lambda.get_access_point_configuration_for_object_lambda(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_point_for_object_lambda(
        ...
        *,
        ...
        """<note> <p>This operation is not supported by directory buckets.</p> </note> <p>Returns configuration information about the specified Object Lambda Access Point</p> <p>The following actions are related to <code>GetAccessPointForObjectLambda</code>:</p> <ul> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_CreateAccessPointForObjectLambda.html\">CreateAccessPointForObjectLambda</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_DeleteAccessPointForObjectLambda.html\">DeleteAccessPointForObjectLambda</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_ListAccessPointsForObjectLambda.html\">ListAccessPointsForObjectLambda</a> </p> </li> </ul>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_point_for_object_lambda_request.GetAccessPointForObjectLambdaRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_point_for_object_lambda_result.GetAccessPointForObjectLambdaResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_point_for_object_lambda.get_access_point_for_object_lambda(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_point_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_point_policy_request.GetAccessPointPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_point_policy_result.GetAccessPointPolicyResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_point_policy.get_access_point_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_point_policy_for_object_lambda(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_point_policy_for_object_lambda_request.GetAccessPointPolicyForObjectLambdaRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_point_policy_for_object_lambda_result.GetAccessPointPolicyForObjectLambdaResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_point_policy_for_object_lambda.get_access_point_policy_for_object_lambda(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_point_policy_status(
        ...
        *,
        ...
        """<note> <p>This operation is not supported by directory buckets.</p> </note> <p>Indicates whether the specified access point currently has a policy that allows public access. For more information about public access through access points, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-points.html\">Managing Data Access with Amazon S3 access points</a> in the <i>Amazon S3 User Guide</i>.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_point_policy_status_request.GetAccessPointPolicyStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_point_policy_status_result.GetAccessPointPolicyStatusResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_point_policy_status.get_access_point_policy_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_point_policy_status_for_object_lambda(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_point_policy_status_for_object_lambda_request.GetAccessPointPolicyStatusForObjectLambdaRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_point_policy_status_for_object_lambda_result.GetAccessPointPolicyStatusForObjectLambdaResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_point_policy_status_for_object_lambda.get_access_point_policy_status_for_object_lambda(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_point_scope(
        ...
        *,
        ...
        """<p> Returns the access point scope for a directory bucket.</p> <p>To use this operation, you must have the permission to perform the <code>s3express:GetAccessPointScope</code> action.</p> <p>For information about REST API errors, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/ErrorResponses.html#RESTErrorResponses\">REST error responses</a>.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_access_point_scope_request.GetAccessPointScopeRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_access_point_scope_result.GetAccessPointScopeResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_access_point_scope.get_access_point_scope(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_bucket(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_bucket_request.GetBucketRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_bucket_result.GetBucketResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_bucket.get_bucket(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_bucket_lifecycle_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_bucket_lifecycle_configuration_request.GetBucketLifecycleConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_bucket_lifecycle_configuration_result.GetBucketLifecycleConfigurationResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_bucket_lifecycle_configuration.get_bucket_lifecycle_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_bucket_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_bucket_policy_request.GetBucketPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_bucket_policy_result.GetBucketPolicyResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_bucket_policy.get_bucket_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_bucket_replication(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_bucket_replication_request.GetBucketReplicationRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_bucket_replication_result.GetBucketReplicationResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_bucket_replication.get_bucket_replication(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_bucket_tagging(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_bucket_tagging_request.GetBucketTaggingRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_bucket_tagging_result.GetBucketTaggingResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_bucket_tagging.get_bucket_tagging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_bucket_versioning(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_bucket_versioning_request.GetBucketVersioningRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_bucket_versioning_result.GetBucketVersioningResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_bucket_versioning.get_bucket_versioning(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_data_access(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_data_access_request.GetDataAccessRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_data_access_result.GetDataAccessResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_data_access.get_data_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_job_tagging(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_job_tagging_request.GetJobTaggingRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_job_tagging_result.GetJobTaggingResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_job_tagging.get_job_tagging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_multi_region_access_point(
        ...
        *,
        ...
        """<note> <p>This operation is not supported by directory buckets.</p> </note> <p>Returns configuration information about the specified Multi-Region Access Point.</p> <p>This action will always be routed to the US West (Oregon) Region. For more information about the restrictions around working with Multi-Region Access Points, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/MultiRegionAccessPointRestrictions.html\">Multi-Region Access Point restrictions and limitations</a> in the <i>Amazon S3 User Guide</i>.</p> <p>The following actions are related to <code>GetMultiRegionAccessPoint</code>:</p> <ul> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_CreateMultiRegionAccessPoint.html\">CreateMultiRegionAccessPoint</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_DeleteMultiRegionAccessPoint.html\">DeleteMultiRegionAccessPoint</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_DescribeMultiRegionAccessPointOperation.html\">DescribeMultiRegionAccessPointOperation</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_ListMultiRegionAccessPoints.html\">ListMultiRegionAccessPoints</a> </p> </li> </ul>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_multi_region_access_point_request.GetMultiRegionAccessPointRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_multi_region_access_point_result.GetMultiRegionAccessPointResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_multi_region_access_point.get_multi_region_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_multi_region_access_point_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_multi_region_access_point_policy_request.GetMultiRegionAccessPointPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_multi_region_access_point_policy_result.GetMultiRegionAccessPointPolicyResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_multi_region_access_point_policy.get_multi_region_access_point_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_multi_region_access_point_policy_status(
        ...
        *,
        ...
        """<note> <p>This operation is not supported by directory buckets.</p> </note> <p>Indicates whether the specified Multi-Region Access Point has an access control policy that allows public access.</p> <p>This action will always be routed to the US West (Oregon) Region. For more information about the restrictions around working with Multi-Region Access Points, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/MultiRegionAccessPointRestrictions.html\">Multi-Region Access Point restrictions and limitations</a> in the <i>Amazon S3 User Guide</i>.</p> <p>The following actions are related to <code>GetMultiRegionAccessPointPolicyStatus</code>:</p> <ul> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_GetMultiRegionAccessPointPolicy.html\">GetMultiRegionAccessPointPolicy</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_PutMultiRegionAccessPointPolicy.html\">PutMultiRegionAccessPointPolicy</a> </p> </li> </ul>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_multi_region_access_point_policy_status_request.GetMultiRegionAccessPointPolicyStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_multi_region_access_point_policy_status_result.GetMultiRegionAccessPointPolicyStatusResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_multi_region_access_point_policy_status.get_multi_region_access_point_policy_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_multi_region_access_point_routes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_multi_region_access_point_routes_request.GetMultiRegionAccessPointRoutesRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_multi_region_access_point_routes_result.GetMultiRegionAccessPointRoutesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_multi_region_access_point_routes.get_multi_region_access_point_routes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_public_access_block(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_public_access_block_request.GetPublicAccessBlockRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_public_access_block_output.GetPublicAccessBlockOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_public_access_block.get_public_access_block(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_storage_lens_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_storage_lens_configuration_request.GetStorageLensConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_storage_lens_configuration_result.GetStorageLensConfigurationResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_storage_lens_configuration.get_storage_lens_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_storage_lens_configuration_tagging(
        ...
        *,
        ...
        """<note> <p>This operation is not supported by directory buckets.</p> </note> <p>Gets the tags of Amazon S3 Storage Lens configuration. For more information about S3 Storage Lens, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/dev/storage_lens.html\">Assessing your storage activity and usage with Amazon S3 Storage Lens </a> in the <i>Amazon S3 User Guide</i>.</p> <note> <p>To use this action, you must have permission to perform the <code>s3:GetStorageLensConfigurationTagging</code> action. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/dev/storage_lens_iam_permissions.html\">Setting permissions to use Amazon S3 Storage Lens</a> in the <i>Amazon S3 User Guide</i>.</p> </note>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_storage_lens_configuration_tagging_request.GetStorageLensConfigurationTaggingRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_storage_lens_configuration_tagging_result.GetStorageLensConfigurationTaggingResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_storage_lens_configuration_tagging.get_storage_lens_configuration_tagging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_storage_lens_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.get_storage_lens_group_request.GetStorageLensGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.get_storage_lens_group_result.GetStorageLensGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.get_storage_lens_group.get_storage_lens_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_access_grants(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_access_grants_request.ListAccessGrantsRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_access_grants_result.ListAccessGrantsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_access_grants.list_access_grants(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_access_grants_instances(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_access_grants_instances_request.ListAccessGrantsInstancesRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_access_grants_instances_result.ListAccessGrantsInstancesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_access_grants_instances.list_access_grants_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_access_grants_locations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_access_grants_locations_request.ListAccessGrantsLocationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_access_grants_locations_result.ListAccessGrantsLocationsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_access_grants_locations.list_access_grants_locations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_access_points(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_access_points_request.ListAccessPointsRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_access_points_result.ListAccessPointsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_access_points.list_access_points(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_access_points_for_directory_buckets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_access_points_for_directory_buckets_request.ListAccessPointsForDirectoryBucketsRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_access_points_for_directory_buckets_result.ListAccessPointsForDirectoryBucketsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_access_points_for_directory_buckets.list_access_points_for_directory_buckets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_access_points_for_directory_buckets(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_s3_control.types.max_results.MaxResults"] = None,
    ) -> "Iterator[aws_sdk_s3_control.types.access_point.AccessPoint]":
        _token = next_token
        while True:
    ...
    def list_access_points_for_object_lambda(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_access_points_for_object_lambda_request.ListAccessPointsForObjectLambdaRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_access_points_for_object_lambda_result.ListAccessPointsForObjectLambdaResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_access_points_for_object_lambda.list_access_points_for_object_lambda(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_access_points_for_object_lambda(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_s3_control.types.max_results.MaxResults"] = None,
    ) -> "Iterator[aws_sdk_s3_control.types.object_lambda_access_point.ObjectLambdaAccessPoint]":
        _token = next_token
        while True:
    ...
    def list_caller_access_grants(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_caller_access_grants_request.ListCallerAccessGrantsRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_caller_access_grants_result.ListCallerAccessGrantsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_caller_access_grants.list_caller_access_grants(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_s3_control.types.list_caller_access_grants_entry.ListCallerAccessGrantsEntry]":
        _token = next_token
        while True:
    ...
    def list_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_jobs_request.ListJobsRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_jobs_result.ListJobsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_jobs.list_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_multi_region_access_points(
        ...
        *,
        ...
        """<note> <p>This operation is not supported by directory buckets.</p> </note> <p>Returns a list of the Multi-Region Access Points currently associated with the specified Amazon Web Services account. Each call can return up to 100 Multi-Region Access Points, the maximum number of Multi-Region Access Points that can be associated with a single account.</p> <p>This action will always be routed to the US West (Oregon) Region. For more information about the restrictions around working with Multi-Region Access Points, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/MultiRegionAccessPointRestrictions.html\">Multi-Region Access Point restrictions and limitations</a> in the <i>Amazon S3 User Guide</i>.</p> <p>The following actions are related to <code>ListMultiRegionAccessPoint</code>:</p> <ul> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_CreateMultiRegionAccessPoint.html\">CreateMultiRegionAccessPoint</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_DeleteMultiRegionAccessPoint.html\">DeleteMultiRegionAccessPoint</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_DescribeMultiRegionAccessPointOperation.html\">DescribeMultiRegionAccessPointOperation</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_GetMultiRegionAccessPoint.html\">GetMultiRegionAccessPoint</a> </p> </li> </ul>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_multi_region_access_points_request.ListMultiRegionAccessPointsRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_multi_region_access_points_result.ListMultiRegionAccessPointsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_multi_region_access_points.list_multi_region_access_points(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_regional_buckets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_regional_buckets_request.ListRegionalBucketsRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_regional_buckets_result.ListRegionalBucketsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_regional_buckets.list_regional_buckets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_storage_lens_configurations(
        ...
        *,
        ...
        """<note> <p>This operation is not supported by directory buckets.</p> </note> <p>Gets a list of Amazon S3 Storage Lens configurations. For more information about S3 Storage Lens, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/dev/storage_lens.html\">Assessing your storage activity and usage with Amazon S3 Storage Lens </a> in the <i>Amazon S3 User Guide</i>.</p> <note> <p>To use this action, you must have permission to perform the <code>s3:ListStorageLensConfigurations</code> action. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/dev/storage_lens_iam_permissions.html\">Setting permissions to use Amazon S3 Storage Lens</a> in the <i>Amazon S3 User Guide</i>.</p> </note>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_storage_lens_configurations_request.ListStorageLensConfigurationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_storage_lens_configurations_result.ListStorageLensConfigurationsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_storage_lens_configurations.list_storage_lens_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_storage_lens_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_storage_lens_groups_request.ListStorageLensGroupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_storage_lens_groups_result.ListStorageLensGroupsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_storage_lens_groups.list_storage_lens_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.list_tags_for_resource_result.ListTagsForResourceResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_access_grants_instance_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_access_grants_instance_resource_policy_request.PutAccessGrantsInstanceResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.put_access_grants_instance_resource_policy_result.PutAccessGrantsInstanceResourcePolicyResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_access_grants_instance_resource_policy.put_access_grants_instance_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_access_point_configuration_for_object_lambda(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_access_point_configuration_for_object_lambda_request.PutAccessPointConfigurationForObjectLambdaRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_access_point_configuration_for_object_lambda

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_access_point_configuration_for_object_lambda.put_access_point_configuration_for_object_lambda(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_access_point_policy(
        ...
        *,
        ...
        """<p>Associates an access policy with the specified access point. Each access point can have only one policy, so a request made to this API replaces any existing policy associated with the specified access point.</p> <p></p> <p>All Amazon S3 on Outposts REST API requests for this action require an additional parameter of <code>x-amz-outpost-id</code> to be passed with the request. In addition, you must use an S3 on Outposts endpoint hostname prefix instead of <code>s3-control</code>. For an example of the request syntax for Amazon S3 on Outposts that uses the S3 on Outposts endpoint hostname prefix and the <code>x-amz-outpost-id</code> derived by using the access point ARN, see the <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_PutAccessPointPolicy.html#API_control_PutAccessPointPolicy_Examples\">Examples</a> section.</p> <p>The following actions are related to <code>PutAccessPointPolicy</code>:</p> <ul> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_GetAccessPointPolicy.html\">GetAccessPointPolicy</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_DeleteAccessPointPolicy.html\">DeleteAccessPointPolicy</a> </p> </li> </ul>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_access_point_policy_request.PutAccessPointPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_access_point_policy

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_access_point_policy.put_access_point_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_access_point_policy_for_object_lambda(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_access_point_policy_for_object_lambda_request.PutAccessPointPolicyForObjectLambdaRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_access_point_policy_for_object_lambda

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_access_point_policy_for_object_lambda.put_access_point_policy_for_object_lambda(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_access_point_scope(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_access_point_scope_request.PutAccessPointScopeRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_access_point_scope

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_access_point_scope.put_access_point_scope(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_bucket_lifecycle_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_bucket_lifecycle_configuration_request.PutBucketLifecycleConfigurationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_bucket_lifecycle_configuration

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_bucket_lifecycle_configuration.put_bucket_lifecycle_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_bucket_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_bucket_policy_request.PutBucketPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_bucket_policy

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_bucket_policy.put_bucket_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_bucket_replication(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_bucket_replication_request.PutBucketReplicationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_bucket_replication

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_bucket_replication.put_bucket_replication(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_bucket_tagging(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_bucket_tagging_request.PutBucketTaggingRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_bucket_tagging

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_bucket_tagging.put_bucket_tagging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_bucket_versioning(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_bucket_versioning_request.PutBucketVersioningRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_bucket_versioning

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_bucket_versioning.put_bucket_versioning(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_job_tagging(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_job_tagging_request.PutJobTaggingRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.put_job_tagging_result.PutJobTaggingResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_job_tagging.put_job_tagging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_multi_region_access_point_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_multi_region_access_point_policy_request.PutMultiRegionAccessPointPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.put_multi_region_access_point_policy_result.PutMultiRegionAccessPointPolicyResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_multi_region_access_point_policy.put_multi_region_access_point_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_public_access_block(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_public_access_block_request.PutPublicAccessBlockRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_public_access_block

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_public_access_block.put_public_access_block(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_storage_lens_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_storage_lens_configuration_request.PutStorageLensConfigurationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_storage_lens_configuration

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_storage_lens_configuration.put_storage_lens_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_storage_lens_configuration_tagging(
        ...
        *,
        ...
        """<note> <p>This operation is not supported by directory buckets.</p> </note> <p>Put or replace tags on an existing Amazon S3 Storage Lens configuration. For more information about S3 Storage Lens, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/dev/storage_lens.html\">Assessing your storage activity and usage with Amazon S3 Storage Lens </a> in the <i>Amazon S3 User Guide</i>.</p> <note> <p>To use this action, you must have permission to perform the <code>s3:PutStorageLensConfigurationTagging</code> action. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/dev/storage_lens_iam_permissions.html\">Setting permissions to use Amazon S3 Storage Lens</a> in the <i>Amazon S3 User Guide</i>.</p> </note>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.put_storage_lens_configuration_tagging_request.PutStorageLensConfigurationTaggingRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.put_storage_lens_configuration_tagging_result.PutStorageLensConfigurationTaggingResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.put_storage_lens_configuration_tagging.put_storage_lens_configuration_tagging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def submit_multi_region_access_point_routes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.submit_multi_region_access_point_routes_request.SubmitMultiRegionAccessPointRoutesRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.submit_multi_region_access_point_routes_result.SubmitMultiRegionAccessPointRoutesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.submit_multi_region_access_point_routes.submit_multi_region_access_point_routes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.tag_resource_result.TagResourceResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.untag_resource_result.UntagResourceResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_access_grants_location(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.update_access_grants_location_request.UpdateAccessGrantsLocationRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.update_access_grants_location_result.UpdateAccessGrantsLocationResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.update_access_grants_location.update_access_grants_location(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_job_priority(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.update_job_priority_request.UpdateJobPriorityRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.update_job_priority_result.UpdateJobPriorityResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.update_job_priority.update_job_priority(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_job_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.update_job_status_request.UpdateJobStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_s3_control.types.update_job_status_result.UpdateJobStatusResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.update_job_status.update_job_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_storage_lens_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_s3_control.types.update_storage_lens_group_request.UpdateStorageLensGroupRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_s3_control._operations.awss3_control_service_v20180820.update_storage_lens_group

            output, http_response = (
                aws_sdk_s3_control._operations.awss3_control_service_v20180820.update_storage_lens_group.update_storage_lens_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
