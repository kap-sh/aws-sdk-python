...
if TYPE_CHECKING:
    import aws_sdk_s3_control.types.region

RegionCreationList: TypeAlias = list["aws_sdk_s3_control.types.region.Region"]
...
def serialize_xml(value: RegionCreationList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.region.serialize_xml(item, el, "Region")
...
def deserialize_xml(el: Element) -> RegionCreationList:
    ...
    for child in el.findall("Region"):
        out.append(aws_sdk_s3_control.types.region.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: RegionCreationList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.region.serialize_xml(item, parent, tag)
