...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3_control.types.storage_lens_group_list


class ListStorageLensGroupsResult(TypedDict):
    ...
    storage_lens_group_list: NotRequired[
        "aws_sdk_s3_control.types.storage_lens_group_list.StorageLensGroupList"
    ]
...
def serialize_xml(
    ...
    if "storage_lens_group_list" in value:
        ...
        aws_sdk_s3_control.types.storage_lens_group_list.serialize_xml_flat(
...
def deserialize_xml(el: Element) -> ListStorageLensGroupsResult:
    ...
    if el.find("StorageLensGroup") is not None:
        ...
        out["storage_lens_group_list"] = (
            aws_sdk_s3_control.types.storage_lens_group_list.deserialize_xml_flat(
                el, "StorageLensGroup"
            )
        )
    return out
