...
if TYPE_CHECKING:
    import aws_sdk_s3_control.types.multi_region_access_point_report_list
    import aws_sdk_s3_control.types.non_empty_max_length1024_string


class ListMultiRegionAccessPointsResult(TypedDict):
    access_points: NotRequired[
        "aws_sdk_s3_control.types.multi_region_access_point_report_list.MultiRegionAccessPointReportList"
    ]
...
def serialize_xml(
    ...
    if "access_points" in value:
        ...
        aws_sdk_s3_control.types.multi_region_access_point_report_list.serialize_xml(
...
def deserialize_xml(el: Element) -> ListMultiRegionAccessPointsResult:
    ...
    if child_access_points is not None:
        ...
        out["access_points"] = (
            aws_sdk_s3_control.types.multi_region_access_point_report_list.deserialize_xml(
                child_access_points
            )
        )
