...
if TYPE_CHECKING:
    import aws_sdk_s3_control.types.list_storage_lens_group_entry

StorageLensGroupList: TypeAlias = list[
    "aws_sdk_s3_control.types.list_storage_lens_group_entry.ListStorageLensGroupEntry"
]
...
def serialize_xml(value: StorageLensGroupList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.list_storage_lens_group_entry.serialize_xml(
...
def deserialize_xml(el: Element) -> StorageLensGroupList:
    ...
    for child in el.findall("StorageLensGroup"):
        out.append(
            aws_sdk_s3_control.types.list_storage_lens_group_entry.deserialize_xml(
                child
            )
        )
    return out
