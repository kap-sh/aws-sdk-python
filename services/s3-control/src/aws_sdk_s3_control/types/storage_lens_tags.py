...
if TYPE_CHECKING:
    import aws_sdk_s3_control.types.storage_lens_tag

StorageLensTags: TypeAlias = list[
    "aws_sdk_s3_control.types.storage_lens_tag.StorageLensTag"
]
...
def serialize_xml(value: StorageLensTags, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.storage_lens_tag.serialize_xml(item, el, "Tag")
...
def deserialize_xml(el: Element) -> StorageLensTags:
    ...
    for child in el.findall("Tag"):
        out.append(aws_sdk_s3_control.types.storage_lens_tag.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: StorageLensTags, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.storage_lens_tag.serialize_xml(item, parent, tag)
