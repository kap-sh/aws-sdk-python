"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessGrantResult``."""
...
class GetAccessGrantResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: GetAccessGrantResult, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> GetAccessGrantResult:
    out: GetAccessGrantResult = {}  # type: ignore[typeddict-item]
