...
if TYPE_CHECKING:
    import aws_sdk_s3_control.types.multi_region_access_point_route

RouteList: TypeAlias = list[
    "aws_sdk_s3_control.types.multi_region_access_point_route.MultiRegionAccessPointRoute"
]
...
def serialize_xml(value: RouteList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.multi_region_access_point_route.serialize_xml(
            item, el, "Route"
        )
...
def deserialize_xml(el: Element) -> RouteList:
    ...
    for child in el.findall("Route"):
        out.append(
            aws_sdk_s3_control.types.multi_region_access_point_route.deserialize_xml(
                child
            )
        )
    return out
