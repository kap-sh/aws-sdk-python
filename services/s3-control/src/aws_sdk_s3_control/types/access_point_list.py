...
AccessPointList: TypeAlias = list["aws_sdk_s3_control.types.access_point.AccessPoint"]
...
def serialize_xml(value: AccessPointList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.access_point.serialize_xml(item, el, "AccessPoint")
...
def deserialize_xml(el: Element) -> AccessPointList:
    ...
    for child in el.findall("AccessPoint"):
        out.append(aws_sdk_s3_control.types.access_point.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: AccessPointList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.access_point.serialize_xml(item, parent, tag)
