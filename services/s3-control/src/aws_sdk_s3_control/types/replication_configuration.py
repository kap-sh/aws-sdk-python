...
if TYPE_CHECKING:
    import aws_sdk_s3_control.types.replication_rules
...
def serialize_xml(value: ReplicationConfiguration, parent: Element, tag: str) -> None:
    ...
    aws_sdk_s3_control.types.replication_rules.serialize_xml(
...
def deserialize_xml(el: Element) -> ReplicationConfiguration:
    ...
    if child_rules is not None:
        ...
        out["rules"] = aws_sdk_s3_control.types.replication_rules.deserialize_xml(
            child_rules
        )
    else:
