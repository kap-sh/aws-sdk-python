...
class NoncurrentVersionTransition(TypedDict):
    ...
    storage_class: NotRequired[
        "aws_sdk_s3_control.types.transition_storage_class.TransitionStorageClass"
    ]
...
def serialize_xml(
    ...
    if "storage_class" in value:
        ...
        aws_sdk_s3_control.types.transition_storage_class.serialize_xml(
...
def deserialize_xml(el: Element) -> NoncurrentVersionTransition:
    ...
    if child_storage_class is not None:
        ...
        out["storage_class"] = (
            aws_sdk_s3_control.types.transition_storage_class.deserialize_xml(
                child_storage_class
            )
        )
    return out
