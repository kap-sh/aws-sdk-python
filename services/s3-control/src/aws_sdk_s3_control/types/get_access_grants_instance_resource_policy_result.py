"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessGrantsInstanceResourcePolicyResult``."""
...
class GetAccessGrantsInstanceResourcePolicyResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: GetAccessGrantsInstanceResourcePolicyResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> GetAccessGrantsInstanceResourcePolicyResult:
    out: GetAccessGrantsInstanceResourcePolicyResult = {}  # type: ignore[typeddict-item]
