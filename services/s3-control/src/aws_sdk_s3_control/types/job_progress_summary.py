...
if TYPE_CHECKING:
    import aws_sdk_s3_control.types.job_number_of_tasks_failed
    import aws_sdk_s3_control.types.job_number_of_tasks_succeeded
    import aws_sdk_s3_control.types.job_timers
    import aws_sdk_s3_control.types.job_total_number_of_tasks


class JobProgressSummary(TypedDict):
    total_number_of_tasks: NotRequired[
        "aws_sdk_s3_control.types.job_total_number_of_tasks.JobTotalNumberOfTasks"
    ]
    """<p></p>"""
    number_of_tasks_succeeded: NotRequired[
        "aws_sdk_s3_control.types.job_number_of_tasks_succeeded.JobNumberOfTasksSucceeded"
    ]
    """<p></p>"""
    number_of_tasks_failed: NotRequired[
        "aws_sdk_s3_control.types.job_number_of_tasks_failed.JobNumberOfTasksFailed"
    ]
    """<p></p>"""
    timers: NotRequired["aws_sdk_s3_control.types.job_timers.JobTimers"]
...
def serialize_xml(value: JobProgressSummary, parent: Element, tag: str) -> None:
    ...
    if "timers" in value:
        ...
        aws_sdk_s3_control.types.job_timers.serialize_xml(value["timers"], el, "Timers")
...
def deserialize_xml(el: Element) -> JobProgressSummary:
    ...
    if child_timers is not None:
        ...
        out["timers"] = aws_sdk_s3_control.types.job_timers.deserialize_xml(
            child_timers
        )
    return out
