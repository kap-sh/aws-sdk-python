...
class GetAccessPointResult(TypedDict):
    name: NotRequired["aws_sdk_s3_control.types.access_point_name.AccessPointName"]
    """<p>The name of the specified access point.</p>"""
    bucket: NotRequired[
        "aws_sdk_s3_control.types.access_point_bucket_name.AccessPointBucketName"
    ]
    """<p>The name of the bucket associated with the specified access point.</p>"""
    network_origin: NotRequired["aws_sdk_s3_control.types.network_origin.NetworkOrigin"]
    ...
    endpoints: NotRequired["aws_sdk_s3_control.types.endpoints.Endpoints"]
...
def serialize_xml(value: GetAccessPointResult, parent: Element, tag: str) -> None:
    ...
    if "endpoints" in value:
        ...
        aws_sdk_s3_control.types.endpoints.serialize_xml(
...
def deserialize_xml(el: Element) -> GetAccessPointResult:
    ...
    if child_endpoints is not None:
        ...
        out["endpoints"] = aws_sdk_s3_control.types.endpoints.deserialize_xml(
            child_endpoints
        )
