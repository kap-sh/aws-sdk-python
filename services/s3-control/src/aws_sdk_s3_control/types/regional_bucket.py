...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3_control.types.public_access_block_enabled
...
class RegionalBucket(TypedDict):
    ...
    public_access_block_enabled: (
        "aws_sdk_s3_control.types.public_access_block_enabled.PublicAccessBlockEnabled"
    )
    """<p></p>"""
    creation_date: "aws_sdk_s3_control.types.creation_date.CreationDate"
