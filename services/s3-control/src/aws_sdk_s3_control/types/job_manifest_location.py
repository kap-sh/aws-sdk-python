...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3_control.types.s3_key_arn_string
    import aws_sdk_s3_control.types.s3_object_version_id
...
class JobManifestLocation(TypedDict, closed=True):
    ...
    e_tag: "aws_sdk_s3_control.types.non_empty_max_length1024_string.NonEmptyMaxLength1024String"
