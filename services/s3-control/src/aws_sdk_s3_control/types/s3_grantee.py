...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3_control.types.s3_grantee_type_identifier


class S3Grantee(TypedDict):
    type_identifier: NotRequired[
        "aws_sdk_s3_control.types.s3_grantee_type_identifier.S3GranteeTypeIdentifier"
    ]
    """<p></p>"""
...
def serialize_xml(value: S3Grantee, parent: Element, tag: str) -> None:
    ...
    if "type_identifier" in value:
        ...
        aws_sdk_s3_control.types.s3_grantee_type_identifier.serialize_xml(
...
def deserialize_xml(el: Element) -> S3Grantee:
    ...
    if child_type_identifier is not None:
        ...
        out["type_identifier"] = (
            aws_sdk_s3_control.types.s3_grantee_type_identifier.deserialize_xml(
