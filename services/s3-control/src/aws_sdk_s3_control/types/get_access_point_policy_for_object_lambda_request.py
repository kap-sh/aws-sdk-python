...
# --- restXml ser/de ---
def serialize_xml(
    value: GetAccessPointPolicyForObjectLambdaRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> GetAccessPointPolicyForObjectLambdaRequest:
    out: GetAccessPointPolicyForObjectLambdaRequest = {}  # type: ignore[typeddict-item]
    return out
