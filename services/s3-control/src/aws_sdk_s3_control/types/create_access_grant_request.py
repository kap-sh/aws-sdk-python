...
class CreateAccessGrantRequest(TypedDict):
    ...
    s3_prefix_type: NotRequired["aws_sdk_s3_control.types.s3_prefix_type.S3PrefixType"]
...
def deserialize_xml(el: Element) -> CreateAccessGrantRequest:
    ...
    if child_s3_prefix_type is not None:
        ...
        out["s3_prefix_type"] = aws_sdk_s3_control.types.s3_prefix_type.deserialize_xml(
