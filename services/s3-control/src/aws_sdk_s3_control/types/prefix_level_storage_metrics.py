...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3_control.types.selection_criteria


class PrefixLevelStorageMetrics(TypedDict):
    ...
    selection_criteria: NotRequired[
        "aws_sdk_s3_control.types.selection_criteria.SelectionCriteria"
    ]
...
def serialize_xml(value: PrefixLevelStorageMetrics, parent: Element, tag: str) -> None:
    ...
    if "selection_criteria" in value:
        ...
        aws_sdk_s3_control.types.selection_criteria.serialize_xml(
...
def deserialize_xml(el: Element) -> PrefixLevelStorageMetrics:
    ...
    if child_selection_criteria is not None:
        ...
        out["selection_criteria"] = (
            aws_sdk_s3_control.types.selection_criteria.deserialize_xml(
