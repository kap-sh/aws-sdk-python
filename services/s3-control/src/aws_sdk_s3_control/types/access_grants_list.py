...
if TYPE_CHECKING:
    import aws_sdk_s3_control.types.list_access_grant_entry

AccessGrantsList: TypeAlias = list[
    "aws_sdk_s3_control.types.list_access_grant_entry.ListAccessGrantEntry"
]
...
def serialize_xml(value: AccessGrantsList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.list_access_grant_entry.serialize_xml(
            item, el, "AccessGrant"
        )
...
def deserialize_xml(el: Element) -> AccessGrantsList:
    ...
    for child in el.findall("AccessGrant"):
        out.append(
            aws_sdk_s3_control.types.list_access_grant_entry.deserialize_xml(child)
        )
    return out
