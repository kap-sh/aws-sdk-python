...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3_control.types.non_empty_max_length2048_string
    import aws_sdk_s3_control.types.s3_canned_access_control_list
    import aws_sdk_s3_control.types.s3_checksum_algorithm
    import aws_sdk_s3_control.types.s3_grant_list
    import aws_sdk_s3_control.types.s3_metadata_directive
    import aws_sdk_s3_control.types.s3_object_lock_legal_hold_status
    import aws_sdk_s3_control.types.s3_object_lock_mode
    import aws_sdk_s3_control.types.s3_object_metadata
    import aws_sdk_s3_control.types.s3_regional_or_s3_express_bucket_arn_string
...
class S3CopyObjectOperation(TypedDict):
    target_resource: NotRequired[
        "aws_sdk_s3_control.types.s3_regional_or_s3_express_bucket_arn_string.S3RegionalOrS3ExpressBucketArnString"
    ]
    ...
    access_control_grants: NotRequired[
        "aws_sdk_s3_control.types.s3_grant_list.S3GrantList"
    ]
    """<p></p> <note> <p>This functionality is not supported by directory buckets.</p> </note>"""
    metadata_directive: NotRequired[
        "aws_sdk_s3_control.types.s3_metadata_directive.S3MetadataDirective"
    ]
    """<p></p>"""
    modified_since_constraint: NotRequired[
        "aws_sdk_s3_control.types.time_stamp.TimeStamp"
    ]
    """<p></p>"""
    new_object_metadata: NotRequired[
        "aws_sdk_s3_control.types.s3_object_metadata.S3ObjectMetadata"
    ]
    ...
    new_object_tagging: NotRequired["aws_sdk_s3_control.types.s3_tag_set.S3TagSet"]
    ...
    redirect_location: NotRequired[
        "aws_sdk_s3_control.types.non_empty_max_length2048_string.NonEmptyMaxLength2048String"
    ]
    ...
    requester_pays: "aws_sdk_s3_control.types.boolean.Boolean"
    """<p></p> <note> <p>This functionality is not supported by directory buckets.</p> </note>"""
    ...
    object_lock_legal_hold_status: NotRequired[
        "aws_sdk_s3_control.types.s3_object_lock_legal_hold_status.S3ObjectLockLegalHoldStatus"
    ]
    ...
    object_lock_mode: NotRequired[
        "aws_sdk_s3_control.types.s3_object_lock_mode.S3ObjectLockMode"
    ]
    ...
    bucket_key_enabled: "aws_sdk_s3_control.types.boolean.Boolean"
    ...
    checksum_algorithm: NotRequired[
        "aws_sdk_s3_control.types.s3_checksum_algorithm.S3ChecksumAlgorithm"
    ]
...
def serialize_xml(value: S3CopyObjectOperation, parent: Element, tag: str) -> None:
    ...
    if "metadata_directive" in value:
        ...
        aws_sdk_s3_control.types.s3_metadata_directive.serialize_xml(
    ...
    if "new_object_metadata" in value:
        ...
        aws_sdk_s3_control.types.s3_object_metadata.serialize_xml(
    ...
    if "storage_class" in value:
        ...
        aws_sdk_s3_control.types.s3_storage_class.serialize_xml(
    ...
    if "object_lock_mode" in value:
        ...
        aws_sdk_s3_control.types.s3_object_lock_mode.serialize_xml(
    ...
    if "checksum_algorithm" in value:
        ...
        aws_sdk_s3_control.types.s3_checksum_algorithm.serialize_xml(
...
def deserialize_xml(el: Element) -> S3CopyObjectOperation:
    ...
    if child_access_control_grants is not None:
        ...
        out["access_control_grants"] = (
            aws_sdk_s3_control.types.s3_grant_list.deserialize_xml(
    ...
    if child_metadata_directive is not None:
        ...
        out["metadata_directive"] = (
            aws_sdk_s3_control.types.s3_metadata_directive.deserialize_xml(
    ...
    if child_modified_since_constraint is not None:
        ...
        out["modified_since_constraint"] = (
            aws_sdk_s3_control.types.time_stamp.deserialize_xml(
    ...
    if child_new_object_metadata is not None:
        ...
        out["new_object_metadata"] = (
            aws_sdk_s3_control.types.s3_object_metadata.deserialize_xml(
    ...
    if child_new_object_tagging is not None:
        ...
        out["new_object_tagging"] = aws_sdk_s3_control.types.s3_tag_set.deserialize_xml(
    ...
    if child_storage_class is not None:
        ...
        out["storage_class"] = (
            aws_sdk_s3_control.types.s3_storage_class.deserialize_xml(
                child_storage_class
            )
        )
    ...
    if child_object_lock_mode is not None:
        ...
        out["object_lock_mode"] = (
            aws_sdk_s3_control.types.s3_object_lock_mode.deserialize_xml(
    ...
    if child_checksum_algorithm is not None:
        ...
        out["checksum_algorithm"] = (
            aws_sdk_s3_control.types.s3_checksum_algorithm.deserialize_xml(
