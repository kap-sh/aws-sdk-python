"""Generated from Smithy shape ``com.amazonaws.s3control#ListAccessGrantEntry``."""
...
class ListAccessGrantEntry(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: ListAccessGrantEntry, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> ListAccessGrantEntry:
    out: ListAccessGrantEntry = {}  # type: ignore[typeddict-item]
