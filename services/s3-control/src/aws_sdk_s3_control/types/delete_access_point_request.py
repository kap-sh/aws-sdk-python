"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteAccessPointRequest``."""
...
# --- restXml ser/de ---
def serialize_xml(value: DeleteAccessPointRequest, parent: Element, tag: str) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> DeleteAccessPointRequest:
