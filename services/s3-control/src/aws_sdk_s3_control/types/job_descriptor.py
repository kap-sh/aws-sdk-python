...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3_control.types.job_arn
    import aws_sdk_s3_control.types.job_creation_time
    import aws_sdk_s3_control.types.job_failure_list
    ...
    import aws_sdk_s3_control.types.s3_generated_manifest_descriptor
    import aws_sdk_s3_control.types.suspended_cause
    import aws_sdk_s3_control.types.suspended_date


class JobDescriptor(TypedDict):
    ...
    job_arn: NotRequired["aws_sdk_s3_control.types.job_arn.JobArn"]
    ...
    operation: NotRequired["aws_sdk_s3_control.types.job_operation.JobOperation"]
    ...
    failure_reasons: NotRequired[
        "aws_sdk_s3_control.types.job_failure_list.JobFailureList"
    ]
    """<p>If the specified job failed, this field contains information describing the failure.</p>"""
    report: NotRequired["aws_sdk_s3_control.types.job_report.JobReport"]
    ...
    role_arn: NotRequired["aws_sdk_s3_control.types.iam_role_arn.IAMRoleArn"]
    """<p>The Amazon Resource Name (ARN) for the Identity and Access Management (IAM) role assigned to run the tasks for this job.</p>"""
    suspended_date: NotRequired["aws_sdk_s3_control.types.suspended_date.SuspendedDate"]
    """<p>The timestamp when this job was suspended, if it has been suspended.</p>"""
    suspended_cause: NotRequired[
        "aws_sdk_s3_control.types.suspended_cause.SuspendedCause"
    ]
    ...
    generated_manifest_descriptor: NotRequired[
        "aws_sdk_s3_control.types.s3_generated_manifest_descriptor.S3GeneratedManifestDescriptor"
    ]
...
def serialize_xml(value: JobDescriptor, parent: Element, tag: str) -> None:
    ...
    if "failure_reasons" in value:
        ...
        aws_sdk_s3_control.types.job_failure_list.serialize_xml(
    ...
    if "suspended_date" in value:
        ...
        aws_sdk_s3_control.types.suspended_date.serialize_xml(
    ...
    if "generated_manifest_descriptor" in value:
        ...
        aws_sdk_s3_control.types.s3_generated_manifest_descriptor.serialize_xml(
...
def deserialize_xml(el: Element) -> JobDescriptor:
    ...
    if child_failure_reasons is not None:
        ...
        out["failure_reasons"] = (
            aws_sdk_s3_control.types.job_failure_list.deserialize_xml(
    ...
    if child_suspended_date is not None:
        ...
        out["suspended_date"] = aws_sdk_s3_control.types.suspended_date.deserialize_xml(
    ...
    if child_generated_manifest_descriptor is not None:
        ...
        out["generated_manifest_descriptor"] = (
            aws_sdk_s3_control.types.s3_generated_manifest_descriptor.deserialize_xml(
