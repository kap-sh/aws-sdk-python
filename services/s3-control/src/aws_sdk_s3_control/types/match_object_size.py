...
if TYPE_CHECKING:
    import aws_sdk_s3_control.types.object_size_value


class MatchObjectSize(TypedDict):
    bytes_greater_than: "aws_sdk_s3_control.types.object_size_value.ObjectSizeValue"
    """<p> Specifies the minimum object size in Bytes. The value must be a positive number, greater than 0 and less than 50 TB. </p>"""
    bytes_less_than: "aws_sdk_s3_control.types.object_size_value.ObjectSizeValue"
