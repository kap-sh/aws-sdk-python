...
class GetDataAccessRequest(TypedDict):
    ...
    privilege: NotRequired["aws_sdk_s3_control.types.privilege.Privilege"]
    ...
    target_type: NotRequired["aws_sdk_s3_control.types.s3_prefix_type.S3PrefixType"]
    ...
    audit_context: NotRequired["aws_sdk_s3_control.types.audit_context.AuditContext"]
