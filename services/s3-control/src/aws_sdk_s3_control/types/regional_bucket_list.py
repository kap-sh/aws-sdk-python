...
if TYPE_CHECKING:
    import aws_sdk_s3_control.types.regional_bucket

RegionalBucketList: TypeAlias = list[
    "aws_sdk_s3_control.types.regional_bucket.RegionalBucket"
]
...
def serialize_xml(value: RegionalBucketList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.regional_bucket.serialize_xml(
            item, el, "RegionalBucket"
        )
...
def deserialize_xml(el: Element) -> RegionalBucketList:
    ...
    for child in el.findall("RegionalBucket"):
        out.append(aws_sdk_s3_control.types.regional_bucket.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: RegionalBucketList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3_control.types.regional_bucket.serialize_xml(item, parent, tag)
