"""Generated from Smithy shape ``com.amazonaws.s3control#ListAccessPointsForObjectLambda``."""
...
import capo_s3_control.types.object_lambda_access_point_list
...
def handle_response(
    ...
    out: capo_s3_control.types.list_access_points_for_object_lambda_result.ListAccessPointsForObjectLambdaResult = capo_s3_control.types.list_access_points_for_object_lambda_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/accesspointforobjectlambda"
    params: dict[str, str] = {}
...
async def async_list_access_points_for_object_lambda(
