"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessPointForObjectLambda``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_point_for_object_lambda_result.GetAccessPointForObjectLambdaResult = capo_s3_control.types.get_access_point_for_object_lambda_result.deserialize_xml(
...
async def async_get_access_point_for_object_lambda(
