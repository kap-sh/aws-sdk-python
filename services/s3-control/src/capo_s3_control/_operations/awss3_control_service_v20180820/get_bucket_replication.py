"""Generated from Smithy shape ``com.amazonaws.s3control#GetBucketReplication``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_bucket_replication_result.GetBucketReplicationResult = capo_s3_control.types.get_bucket_replication_result.deserialize_xml(
