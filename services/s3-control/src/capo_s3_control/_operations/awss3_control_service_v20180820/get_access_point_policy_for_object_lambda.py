"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessPointPolicyForObjectLambda``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_point_policy_for_object_lambda_result.GetAccessPointPolicyForObjectLambdaResult = capo_s3_control.types.get_access_point_policy_for_object_lambda_result.deserialize_xml(
...
async def async_get_access_point_policy_for_object_lambda(
