"""Generated from Smithy shape ``com.amazonaws.s3control#ListAccessPoints``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.list_access_points_result.ListAccessPointsResult = (
        capo_s3_control.types.list_access_points_result.deserialize_xml(
