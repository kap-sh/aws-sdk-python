"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessPoint``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_point_result.GetAccessPointResult = (
        capo_s3_control.types.get_access_point_result.deserialize_xml(
...
def get_access_point(
    ...
    capo_s3_control.types.get_access_point_result.GetAccessPointResult, zapros.Response
]:
...
async def async_get_access_point(
