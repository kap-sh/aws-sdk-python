"""Generated from Smithy shape ``com.amazonaws.s3control#ListCallerAccessGrants``."""
...
import capo_s3_control.types.caller_access_grants_list
...
def handle_response(
    ...
    out: capo_s3_control.types.list_caller_access_grants_result.ListCallerAccessGrantsResult = capo_s3_control.types.list_caller_access_grants_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/accessgrantsinstance/caller/grants"
    params: dict[str, str] = {}
    ...
    params["allowedByApplication"] = str(input_.get("allowed_by_application", False))
...
async def async_list_caller_access_grants(
