"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessPointScope``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_point_scope_result.GetAccessPointScopeResult = capo_s3_control.types.get_access_point_scope_result.deserialize_xml(
