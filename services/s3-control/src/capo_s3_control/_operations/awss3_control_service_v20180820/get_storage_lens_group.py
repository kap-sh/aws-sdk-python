"""Generated from Smithy shape ``com.amazonaws.s3control#GetStorageLensGroup``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_storage_lens_group_result.GetStorageLensGroupResult = {
        "storage_lens_group": capo_s3_control.types.storage_lens_group.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/storagelensgroup/{Name}"
...
async def async_get_storage_lens_group(
