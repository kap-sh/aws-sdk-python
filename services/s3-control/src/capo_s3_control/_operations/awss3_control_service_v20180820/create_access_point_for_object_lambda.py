"""Generated from Smithy shape ``com.amazonaws.s3control#CreateAccessPointForObjectLambda``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.create_access_point_for_object_lambda_result.CreateAccessPointForObjectLambdaResult = capo_s3_control.types.create_access_point_for_object_lambda_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/accesspointforobjectlambda/{Name}"
...
async def async_create_access_point_for_object_lambda(
