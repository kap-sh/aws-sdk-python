"""Generated from Smithy shape ``com.amazonaws.s3control#GetBucketVersioning``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_bucket_versioning_result.GetBucketVersioningResult = capo_s3_control.types.get_bucket_versioning_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/bucket/{Bucket}/versioning"
...
async def async_get_bucket_versioning(
