"""Generated from Smithy shape ``com.amazonaws.s3control#GetBucketLifecycleConfiguration``."""
...
import capo_s3_control.types.lifecycle_rules
...
def handle_response(
    ...
    out: capo_s3_control.types.get_bucket_lifecycle_configuration_result.GetBucketLifecycleConfigurationResult = capo_s3_control.types.get_bucket_lifecycle_configuration_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/bucket/{Bucket}/lifecycleconfiguration"
...
async def async_get_bucket_lifecycle_configuration(
