"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessGrantsLocation``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_grants_location_result.GetAccessGrantsLocationResult = capo_s3_control.types.get_access_grants_location_result.deserialize_xml(
...
async def async_get_access_grants_location(
