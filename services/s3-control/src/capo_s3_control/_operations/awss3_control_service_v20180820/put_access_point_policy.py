"""Generated from Smithy shape ``com.amazonaws.s3control#PutAccessPointPolicy``."""
...
def build_request(
    ...
    root = Element("PutAccessPointPolicyRequest")
    if "policy" in input_:
...
async def async_put_access_point_policy(
