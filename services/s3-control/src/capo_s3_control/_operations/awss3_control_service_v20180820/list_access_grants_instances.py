"""Generated from Smithy shape ``com.amazonaws.s3control#ListAccessGrantsInstances``."""
...
import capo_s3_control.types.access_grants_instances_list
...
def handle_response(
    ...
    out: capo_s3_control.types.list_access_grants_instances_result.ListAccessGrantsInstancesResult = capo_s3_control.types.list_access_grants_instances_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/accessgrantsinstances"
    params: dict[str, str] = {}
...
async def async_list_access_grants_instances(
