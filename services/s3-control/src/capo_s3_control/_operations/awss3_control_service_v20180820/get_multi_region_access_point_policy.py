"""Generated from Smithy shape ``com.amazonaws.s3control#GetMultiRegionAccessPointPolicy``."""
...
import capo_s3_control.types.multi_region_access_point_policy_document
...
def handle_response(
    ...
    out: capo_s3_control.types.get_multi_region_access_point_policy_result.GetMultiRegionAccessPointPolicyResult = capo_s3_control.types.get_multi_region_access_point_policy_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/mrap/instances/{Name+}/policy"
...
async def async_get_multi_region_access_point_policy(
