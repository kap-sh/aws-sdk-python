"""Generated from Smithy shape ``com.amazonaws.s3control#GetPublicAccessBlock``."""
...
import capo_s3_control.errors.no_such_public_access_block_configuration
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "NoSuchPublicAccessBlockConfiguration":
            raise capo_s3_control.errors.no_such_public_access_block_configuration.NoSuchPublicAccessBlockConfiguration.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_s3_control.types.get_public_access_block_output.GetPublicAccessBlockOutput = {
        "public_access_block_configuration": capo_s3_control.types.public_access_block_configuration.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/configuration/publicAccessBlock"
    params: dict[str, str] = {}
...
async def async_get_public_access_block(
