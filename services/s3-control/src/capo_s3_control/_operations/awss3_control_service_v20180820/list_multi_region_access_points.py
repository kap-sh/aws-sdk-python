...
def handle_response(
    ...
    out: capo_s3_control.types.list_multi_region_access_points_result.ListMultiRegionAccessPointsResult = capo_s3_control.types.list_multi_region_access_points_result.deserialize_xml(
