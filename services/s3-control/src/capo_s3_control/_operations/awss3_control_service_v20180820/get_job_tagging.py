"""Generated from Smithy shape ``com.amazonaws.s3control#GetJobTagging``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_job_tagging_result.GetJobTaggingResult = (
        capo_s3_control.types.get_job_tagging_result.deserialize_xml(
...
def get_job_tagging(
    ...
    capo_s3_control.types.get_job_tagging_result.GetJobTaggingResult, zapros.Response
]:
...
async def async_get_job_tagging(
