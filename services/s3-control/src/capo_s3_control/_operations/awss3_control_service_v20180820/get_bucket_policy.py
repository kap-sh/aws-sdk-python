"""Generated from Smithy shape ``com.amazonaws.s3control#GetBucketPolicy``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_bucket_policy_result.GetBucketPolicyResult = (
        capo_s3_control.types.get_bucket_policy_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/bucket/{Bucket}/policy"
...
async def async_get_bucket_policy(
