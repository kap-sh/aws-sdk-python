...
import capo_s3_control.types.access_point_list
...
def handle_response(
    ...
    out: capo_s3_control.types.list_access_points_for_directory_buckets_result.ListAccessPointsForDirectoryBucketsResult = capo_s3_control.types.list_access_points_for_directory_buckets_result.deserialize_xml(
