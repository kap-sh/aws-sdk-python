"""Generated from Smithy shape ``com.amazonaws.s3control#DescribeJob``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.describe_job_result.DescribeJobResult = (
        capo_s3_control.types.describe_job_result.deserialize_xml(
...
def describe_job(
    ...
    capo_s3_control.types.describe_job_result.DescribeJobResult, zapros.Response
]:
