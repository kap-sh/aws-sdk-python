"""Generated from Smithy shape ``com.amazonaws.s3control#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.list_tags_for_resource_result.ListTagsForResourceResult = capo_s3_control.types.list_tags_for_resource_result.deserialize_xml(
