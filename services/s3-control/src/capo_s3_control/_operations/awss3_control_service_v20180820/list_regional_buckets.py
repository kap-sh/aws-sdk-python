"""Generated from Smithy shape ``com.amazonaws.s3control#ListRegionalBuckets``."""
...
import capo_s3_control.types.regional_bucket_list
...
def handle_response(
    ...
    out: capo_s3_control.types.list_regional_buckets_result.ListRegionalBucketsResult = capo_s3_control.types.list_regional_buckets_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/bucket"
    params: dict[str, str] = {}
...
async def async_list_regional_buckets(
