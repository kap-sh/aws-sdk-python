"""Generated from Smithy shape ``com.amazonaws.s3control#PutBucketPolicy``."""
...
def build_request(
    ...
    headers["x-amz-confirm-remove-self-bucket-access"] = str(
        input_.get("confirm_remove_self_bucket_access", False)
    )
    root = Element("PutBucketPolicyRequest")
    if "policy" in input_:
