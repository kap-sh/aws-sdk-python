"""Generated from Smithy shape ``com.amazonaws.s3control#GetMultiRegionAccessPointRoutes``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_multi_region_access_point_routes_result.GetMultiRegionAccessPointRoutesResult = capo_s3_control.types.get_multi_region_access_point_routes_result.deserialize_xml(
...
async def async_get_multi_region_access_point_routes(
