"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteStorageLensConfiguration``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/storagelens/{ConfigId}"
...
async def async_delete_storage_lens_configuration(
