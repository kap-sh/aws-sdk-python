"""Generated from Smithy shape ``com.amazonaws.s3control#GetMultiRegionAccessPoint``."""
...
import capo_s3_control.types.multi_region_access_point_report
...
def handle_response(
    ...
    out: capo_s3_control.types.get_multi_region_access_point_result.GetMultiRegionAccessPointResult = capo_s3_control.types.get_multi_region_access_point_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20180820/mrap/instances/{Name+}"
...
async def async_get_multi_region_access_point(
