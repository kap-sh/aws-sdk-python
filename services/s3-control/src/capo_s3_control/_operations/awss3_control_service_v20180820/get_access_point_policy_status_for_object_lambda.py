"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessPointPolicyStatusForObjectLambda``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_point_policy_status_for_object_lambda_result.GetAccessPointPolicyStatusForObjectLambdaResult = capo_s3_control.types.get_access_point_policy_status_for_object_lambda_result.deserialize_xml(
...
async def async_get_access_point_policy_status_for_object_lambda(
