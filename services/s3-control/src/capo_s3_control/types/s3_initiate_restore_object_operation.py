...
if TYPE_CHECKING:
    import capo_s3_control.types.s3_expiration_in_days
    import capo_s3_control.types.s3_glacier_job_tier


class S3InitiateRestoreObjectOperation(TypedDict, closed=True):
    expiration_in_days: NotRequired[
        "capo_s3_control.types.s3_expiration_in_days.S3ExpirationInDays"
    ]
    ...
    glacier_job_tier: NotRequired[
        "capo_s3_control.types.s3_glacier_job_tier.S3GlacierJobTier"
    ]
...
def serialize_xml(
    ...
    if "glacier_job_tier" in value:
        ...
        capo_s3_control.types.s3_glacier_job_tier.serialize_xml(
...
def deserialize_xml(el: Element) -> S3InitiateRestoreObjectOperation:
    ...
    if child_glacier_job_tier is not None:
        ...
        out["glacier_job_tier"] = (
            capo_s3_control.types.s3_glacier_job_tier.deserialize_xml(
