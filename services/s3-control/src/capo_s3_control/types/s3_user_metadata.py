"""Generated from Smithy shape ``com.amazonaws.s3control#S3UserMetadata``."""
...
# --- restXml ser/de ---
def serialize_xml(
    input_to_serialize: S3UserMetadata, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> S3UserMetadata:
    out: S3UserMetadata = {}
...
def deserialize_xml_flat(parent: Element, tag: str) -> S3UserMetadata:
    out: S3UserMetadata = {}
