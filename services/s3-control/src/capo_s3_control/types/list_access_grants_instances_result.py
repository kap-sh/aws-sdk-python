...
class ListAccessGrantsInstancesResult(TypedDict, closed=True):
    ...
    access_grants_instances_list: NotRequired[
        "capo_s3_control.types.access_grants_instances_list.AccessGrantsInstancesList"
    ]
...
def serialize_xml(
    ...
    if "access_grants_instances_list" in value:
        ...
        capo_s3_control.types.access_grants_instances_list.serialize_xml(
...
def deserialize_xml(el: Element) -> ListAccessGrantsInstancesResult:
    ...
    if child_access_grants_instances_list is not None:
        ...
        out["access_grants_instances_list"] = (
            capo_s3_control.types.access_grants_instances_list.deserialize_xml(
