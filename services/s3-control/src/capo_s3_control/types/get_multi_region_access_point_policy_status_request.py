"""Generated from Smithy shape ``com.amazonaws.s3control#GetMultiRegionAccessPointPolicyStatusRequest``."""
...
class GetMultiRegionAccessPointPolicyStatusRequest(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: GetMultiRegionAccessPointPolicyStatusRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> GetMultiRegionAccessPointPolicyStatusRequest:
    out: GetMultiRegionAccessPointPolicyStatusRequest = {}  # type: ignore[typeddict-item]
    return out
