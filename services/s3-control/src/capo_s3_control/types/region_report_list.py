...
if TYPE_CHECKING:
    import capo_s3_control.types.region_report

RegionReportList: TypeAlias = list["capo_s3_control.types.region_report.RegionReport"]
...
def serialize_xml(value: RegionReportList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3_control.types.region_report.serialize_xml(item, el, "Region")
...
def deserialize_xml(el: Element) -> RegionReportList:
    ...
    for child in el.findall("Region"):
        out.append(capo_s3_control.types.region_report.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: RegionReportList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3_control.types.region_report.serialize_xml(item, parent, tag)
