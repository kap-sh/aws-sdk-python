"""Generated from Smithy shape ``com.amazonaws.s3control#AdvancedDataProtectionMetrics``."""
...
class AdvancedDataProtectionMetrics(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: AdvancedDataProtectionMetrics, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> AdvancedDataProtectionMetrics:
    out: AdvancedDataProtectionMetrics = {}  # type: ignore[typeddict-item]
