...
if TYPE_CHECKING:
    import capo_s3_control.types.noncurrent_version_transition

NoncurrentVersionTransitionList: TypeAlias = list[
    "capo_s3_control.types.noncurrent_version_transition.NoncurrentVersionTransition"
]
...
def serialize_xml(
    ...
    for item in value:
        ...
        capo_s3_control.types.noncurrent_version_transition.serialize_xml(
...
def deserialize_xml(el: Element) -> NoncurrentVersionTransitionList:
    ...
    for child in el.findall("NoncurrentVersionTransition"):
        out.append(
            capo_s3_control.types.noncurrent_version_transition.deserialize_xml(child)
        )
    return out
