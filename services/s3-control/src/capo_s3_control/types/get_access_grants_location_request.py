"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessGrantsLocationRequest``."""
...
class GetAccessGrantsLocationRequest(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: GetAccessGrantsLocationRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> GetAccessGrantsLocationRequest:
    out: GetAccessGrantsLocationRequest = {}  # type: ignore[typeddict-item]
    return out
