...
if TYPE_CHECKING:
    import capo_s3_control.types.activity_metrics
    import capo_s3_control.types.advanced_cost_optimization_metrics
    import capo_s3_control.types.advanced_data_protection_metrics
    import capo_s3_control.types.advanced_performance_metrics
    import capo_s3_control.types.bucket_level
    import capo_s3_control.types.detailed_status_codes_metrics
    import capo_s3_control.types.storage_lens_group_level


class AccountLevel(TypedDict, closed=True):
    activity_metrics: NotRequired[
        "capo_s3_control.types.activity_metrics.ActivityMetrics"
    ]
    """<p>A container element for S3 Storage Lens activity metrics.</p>"""
    bucket_level: "capo_s3_control.types.bucket_level.BucketLevel"
    """<p>A container element for the S3 Storage Lens bucket-level configuration.</p>"""
    advanced_cost_optimization_metrics: NotRequired[
        "capo_s3_control.types.advanced_cost_optimization_metrics.AdvancedCostOptimizationMetrics"
    ]
...
def serialize_xml(value: AccountLevel, parent: Element, tag: str) -> None:
    ...
    if "activity_metrics" in value:
        ...
        capo_s3_control.types.activity_metrics.serialize_xml(
            value["activity_metrics"], el, "ActivityMetrics"
        )
    import capo_s3_control.types.bucket_level

    capo_s3_control.types.bucket_level.serialize_xml(
        value["bucket_level"], el, "BucketLevel"
    )
    if "advanced_cost_optimization_metrics" in value:
        import capo_s3_control.types.advanced_cost_optimization_metrics

        capo_s3_control.types.advanced_cost_optimization_metrics.serialize_xml(
    ...
    if "advanced_data_protection_metrics" in value:
        ...
        capo_s3_control.types.advanced_data_protection_metrics.serialize_xml(
...
def deserialize_xml(el: Element) -> AccountLevel:
    ...
    if child_activity_metrics is not None:
        ...
        out["activity_metrics"] = (
            capo_s3_control.types.activity_metrics.deserialize_xml(
    ...
    if child_bucket_level is not None:
        ...
        out["bucket_level"] = capo_s3_control.types.bucket_level.deserialize_xml(
            child_bucket_level
        )
    else:
    ...
    if child_advanced_cost_optimization_metrics is not None:
        ...
        out["advanced_cost_optimization_metrics"] = (
            capo_s3_control.types.advanced_cost_optimization_metrics.deserialize_xml(
    ...
    if child_advanced_data_protection_metrics is not None:
        ...
        out["advanced_data_protection_metrics"] = (
            capo_s3_control.types.advanced_data_protection_metrics.deserialize_xml(
    ...
    if child_detailed_status_codes_metrics is not None:
        ...
        out["detailed_status_codes_metrics"] = (
            capo_s3_control.types.detailed_status_codes_metrics.deserialize_xml(
    ...
    if child_advanced_performance_metrics is not None:
        ...
        out["advanced_performance_metrics"] = (
            capo_s3_control.types.advanced_performance_metrics.deserialize_xml(
    ...
    if child_storage_lens_group_level is not None:
        ...
        out["storage_lens_group_level"] = (
            capo_s3_control.types.storage_lens_group_level.deserialize_xml(
