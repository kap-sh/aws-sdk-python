"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessGrantsLocationResult``."""
...
class GetAccessGrantsLocationResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: GetAccessGrantsLocationResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> GetAccessGrantsLocationResult:
    out: GetAccessGrantsLocationResult = {}  # type: ignore[typeddict-item]
