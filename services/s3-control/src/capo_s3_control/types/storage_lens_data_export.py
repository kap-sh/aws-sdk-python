...
if TYPE_CHECKING:
    import capo_s3_control.types.cloud_watch_metrics
    import capo_s3_control.types.s3_bucket_destination
    import capo_s3_control.types.storage_lens_table_destination


class StorageLensDataExport(TypedDict, closed=True):
    s3_bucket_destination: NotRequired[
        "capo_s3_control.types.s3_bucket_destination.S3BucketDestination"
    ]
    ...
    cloud_watch_metrics: NotRequired[
        "capo_s3_control.types.cloud_watch_metrics.CloudWatchMetrics"
    ]
    ...
    storage_lens_table_destination: NotRequired[
        "capo_s3_control.types.storage_lens_table_destination.StorageLensTableDestination"
    ]
...
def serialize_xml(value: StorageLensDataExport, parent: Element, tag: str) -> None:
    ...
    if "s3_bucket_destination" in value:
        ...
        capo_s3_control.types.s3_bucket_destination.serialize_xml(
            value["s3_bucket_destination"], el, "S3BucketDestination"
        )
    if "cloud_watch_metrics" in value:
        import capo_s3_control.types.cloud_watch_metrics

        capo_s3_control.types.cloud_watch_metrics.serialize_xml(
            value["cloud_watch_metrics"], el, "CloudWatchMetrics"
        )
    if "storage_lens_table_destination" in value:
        import capo_s3_control.types.storage_lens_table_destination

        capo_s3_control.types.storage_lens_table_destination.serialize_xml(
...
def deserialize_xml(el: Element) -> StorageLensDataExport:
    ...
    if child_s3_bucket_destination is not None:
        ...
        out["s3_bucket_destination"] = (
            capo_s3_control.types.s3_bucket_destination.deserialize_xml(
    ...
    if child_cloud_watch_metrics is not None:
        ...
        out["cloud_watch_metrics"] = (
            capo_s3_control.types.cloud_watch_metrics.deserialize_xml(
    ...
    if child_storage_lens_table_destination is not None:
        ...
        out["storage_lens_table_destination"] = (
            capo_s3_control.types.storage_lens_table_destination.deserialize_xml(
