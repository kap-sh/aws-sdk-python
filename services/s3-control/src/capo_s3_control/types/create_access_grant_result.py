...
if TYPE_CHECKING:
    import capo_s3_control.types.access_grant_arn
...
class CreateAccessGrantResult(TypedDict, closed=True):
    ...
    access_grant_id: NotRequired["capo_s3_control.types.access_grant_id.AccessGrantId"]
    ...
    access_grant_arn: NotRequired[
        "capo_s3_control.types.access_grant_arn.AccessGrantArn"
    ]
    ...
    permission: NotRequired["capo_s3_control.types.permission.Permission"]
    ...
    grant_scope: NotRequired["capo_s3_control.types.s3_prefix.S3Prefix"]
