...
if TYPE_CHECKING:
    import capo_s3_control.types.multi_region_access_point_regional_response_list


class MultiRegionAccessPointsAsyncResponse(TypedDict, closed=True):
    regions: NotRequired[
        "capo_s3_control.types.multi_region_access_point_regional_response_list.MultiRegionAccessPointRegionalResponseList"
    ]
...
def serialize_xml(
    ...
    if "regions" in value:
        ...
        capo_s3_control.types.multi_region_access_point_regional_response_list.serialize_xml(
...
def deserialize_xml(el: Element) -> MultiRegionAccessPointsAsyncResponse:
    ...
    if child_regions is not None:
        ...
        out["regions"] = (
            capo_s3_control.types.multi_region_access_point_regional_response_list.deserialize_xml(
                child_regions
            )
        )
    return out
