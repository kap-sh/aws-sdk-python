"""Generated from Smithy shape ``com.amazonaws.s3control#ListAccessGrantsInstanceEntry``."""
...
class ListAccessGrantsInstanceEntry(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: ListAccessGrantsInstanceEntry, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> ListAccessGrantsInstanceEntry:
    out: ListAccessGrantsInstanceEntry = {}  # type: ignore[typeddict-item]
