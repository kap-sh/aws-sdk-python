...
if TYPE_CHECKING:
    import capo_s3_control.types.async_creation_timestamp
    import capo_s3_control.types.async_operation_name
    import capo_s3_control.types.async_request_parameters
    import capo_s3_control.types.async_request_status
    import capo_s3_control.types.async_request_token_arn
    import capo_s3_control.types.async_response_details


class AsyncOperation(TypedDict, closed=True):
    creation_time: NotRequired[
        "capo_s3_control.types.async_creation_timestamp.AsyncCreationTimestamp"
    ]
    """<p>The time that the request was sent to the service.</p>"""
    operation: NotRequired[
        "capo_s3_control.types.async_operation_name.AsyncOperationName"
    ]
    ...
    request_parameters: NotRequired[
        "capo_s3_control.types.async_request_parameters.AsyncRequestParameters"
    ]
    """<p>The parameters associated with the request.</p>"""
    request_status: NotRequired[
        "capo_s3_control.types.async_request_status.AsyncRequestStatus"
    ]
    """<p>The current status of the request.</p>"""
    response_details: NotRequired[
        "capo_s3_control.types.async_response_details.AsyncResponseDetails"
    ]
...
def serialize_xml(value: AsyncOperation, parent: Element, tag: str) -> None:
    ...
    if "creation_time" in value:
        ...
        capo_s3_control.types.async_creation_timestamp.serialize_xml(
            value["creation_time"], el, "CreationTime"
        )
    if "operation" in value:
        import capo_s3_control.types.async_operation_name

        capo_s3_control.types.async_operation_name.serialize_xml(
    ...
    if "request_parameters" in value:
        ...
        capo_s3_control.types.async_request_parameters.serialize_xml(
    ...
    if "response_details" in value:
        ...
        capo_s3_control.types.async_response_details.serialize_xml(
...
def deserialize_xml(el: Element) -> AsyncOperation:
    ...
    if child_creation_time is not None:
        ...
        out["creation_time"] = (
            capo_s3_control.types.async_creation_timestamp.deserialize_xml(
                child_creation_time
            )
        )
    ...
    if child_operation is not None:
        ...
        out["operation"] = capo_s3_control.types.async_operation_name.deserialize_xml(
            child_operation
        )
    ...
    if child_request_parameters is not None:
        ...
        out["request_parameters"] = (
            capo_s3_control.types.async_request_parameters.deserialize_xml(
    ...
    if child_response_details is not None:
        ...
        out["response_details"] = (
            capo_s3_control.types.async_response_details.deserialize_xml(
