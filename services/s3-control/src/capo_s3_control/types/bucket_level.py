...
if TYPE_CHECKING:
    ...
    import capo_s3_control.types.prefix_level


class BucketLevel(TypedDict, closed=True):
    ...
    prefix_level: NotRequired["capo_s3_control.types.prefix_level.PrefixLevel"]
...
def serialize_xml(value: BucketLevel, parent: Element, tag: str) -> None:
    ...
    if "prefix_level" in value:
        ...
        capo_s3_control.types.prefix_level.serialize_xml(
...
def deserialize_xml(el: Element) -> BucketLevel:
    ...
    if child_prefix_level is not None:
        ...
        out["prefix_level"] = capo_s3_control.types.prefix_level.deserialize_xml(
            child_prefix_level
        )
