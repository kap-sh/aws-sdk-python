...
class DescribeMultiRegionAccessPointOperationResult(TypedDict, closed=True):
    async_operation: NotRequired["capo_s3_control.types.async_operation.AsyncOperation"]
...
def serialize_xml(
    ...
    if "async_operation" in value:
        ...
        capo_s3_control.types.async_operation.serialize_xml(
...
def deserialize_xml(el: Element) -> DescribeMultiRegionAccessPointOperationResult:
    ...
    if child_async_operation is not None:
        ...
        out["async_operation"] = capo_s3_control.types.async_operation.deserialize_xml(
