...
class GetMultiRegionAccessPointRoutesResult(TypedDict, closed=True):
    mrap: NotRequired[
        "capo_s3_control.types.multi_region_access_point_id.MultiRegionAccessPointId"
    ]
    """<p>The Multi-Region Access Point ARN.</p>"""
    routes: NotRequired["capo_s3_control.types.route_list.RouteList"]
...
def serialize_xml(
    ...
    if "routes" in value:
        ...
        capo_s3_control.types.route_list.serialize_xml(value["routes"], el, "Routes")
...
def deserialize_xml(el: Element) -> GetMultiRegionAccessPointRoutesResult:
    ...
    if child_routes is not None:
        ...
        out["routes"] = capo_s3_control.types.route_list.deserialize_xml(child_routes)
    return out
