...
if TYPE_CHECKING:
    ...
    import capo_s3_control.types.operation_name


class JobListDescriptor(TypedDict, closed=True):
    ...
    operation: NotRequired["capo_s3_control.types.operation_name.OperationName"]
...
def serialize_xml(value: JobListDescriptor, parent: Element, tag: str) -> None:
    ...
    if "operation" in value:
        ...
        capo_s3_control.types.operation_name.serialize_xml(
...
def deserialize_xml(el: Element) -> JobListDescriptor:
    ...
    if child_operation is not None:
        ...
        out["operation"] = capo_s3_control.types.operation_name.deserialize_xml(
            child_operation
        )
