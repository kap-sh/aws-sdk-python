"""Generated from Smithy shape ``com.amazonaws.s3control#DeleteBucketTaggingRequest``."""
...
class DeleteBucketTaggingRequest(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: DeleteBucketTaggingRequest, parent: Element, tag: str) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> DeleteBucketTaggingRequest:
    out: DeleteBucketTaggingRequest = {}  # type: ignore[typeddict-item]
    return out
