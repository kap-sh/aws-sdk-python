...
if TYPE_CHECKING:
    ...
    import capo_s3_control.types.mfa_delete


class VersioningConfiguration(TypedDict, closed=True):
    mfa_delete: NotRequired["capo_s3_control.types.mfa_delete.MFADelete"]
...
def serialize_xml(value: VersioningConfiguration, parent: Element, tag: str) -> None:
    ...
    if "mfa_delete" in value:
        ...
        capo_s3_control.types.mfa_delete.serialize_xml(
...
def deserialize_xml(el: Element) -> VersioningConfiguration:
    ...
    if child_mfa_delete is not None:
        ...
        out["mfa_delete"] = capo_s3_control.types.mfa_delete.deserialize_xml(
            child_mfa_delete
        )
