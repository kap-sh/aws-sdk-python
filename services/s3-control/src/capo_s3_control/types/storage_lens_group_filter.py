...
if TYPE_CHECKING:
    ...
    import capo_s3_control.types.storage_lens_group_and_operator
    import capo_s3_control.types.storage_lens_group_or_operator
...
StorageLensGroupFilter = TypedDict(
    "StorageLensGroupFilter",
    {
        ...
        "and": NotRequired[
            "capo_s3_control.types.storage_lens_group_and_operator.StorageLensGroupAndOperator"
        ],
        "or": NotRequired[
            "capo_s3_control.types.storage_lens_group_or_operator.StorageLensGroupOrOperator"
        ],
    },
    closed=True,
)
...
def serialize_xml(value: StorageLensGroupFilter, parent: Element, tag: str) -> None:
    ...
    if "and" in value:
        ...
        capo_s3_control.types.storage_lens_group_and_operator.serialize_xml(
            value["and"], el, "And"
        )
    if "or" in value:
        import capo_s3_control.types.storage_lens_group_or_operator

        capo_s3_control.types.storage_lens_group_or_operator.serialize_xml(
            value["or"], el, "Or"
        )
...
def deserialize_xml(el: Element) -> StorageLensGroupFilter:
    ...
    if child_and is not None:
        ...
        out["and"] = (
            capo_s3_control.types.storage_lens_group_and_operator.deserialize_xml(
                child_and
            )
        )
    child_or = el.find("Or")
    if child_or is not None:
        ...
        out["or"] = (
            capo_s3_control.types.storage_lens_group_or_operator.deserialize_xml(
                child_or
            )
        )
    return out
