...
if TYPE_CHECKING:
    import capo_s3_control.types.s3_access_control_policy


class S3SetObjectAclOperation(TypedDict, closed=True):
    access_control_policy: NotRequired[
        "capo_s3_control.types.s3_access_control_policy.S3AccessControlPolicy"
    ]
    """<p></p>"""
...
def serialize_xml(value: S3SetObjectAclOperation, parent: Element, tag: str) -> None:
    ...
    if "access_control_policy" in value:
        ...
        capo_s3_control.types.s3_access_control_policy.serialize_xml(
...
def deserialize_xml(el: Element) -> S3SetObjectAclOperation:
    ...
    if child_access_control_policy is not None:
        ...
        out["access_control_policy"] = (
            capo_s3_control.types.s3_access_control_policy.deserialize_xml(
