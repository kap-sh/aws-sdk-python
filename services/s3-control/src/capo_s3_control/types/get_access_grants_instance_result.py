"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessGrantsInstanceResult``."""
...
class GetAccessGrantsInstanceResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: GetAccessGrantsInstanceResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> GetAccessGrantsInstanceResult:
    out: GetAccessGrantsInstanceResult = {}  # type: ignore[typeddict-item]
