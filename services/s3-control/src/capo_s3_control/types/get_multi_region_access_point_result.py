...
class GetMultiRegionAccessPointResult(TypedDict, closed=True):
    access_point: NotRequired[
        "capo_s3_control.types.multi_region_access_point_report.MultiRegionAccessPointReport"
    ]
...
def serialize_xml(
    ...
    if "access_point" in value:
        ...
        capo_s3_control.types.multi_region_access_point_report.serialize_xml(
...
def deserialize_xml(el: Element) -> GetMultiRegionAccessPointResult:
    ...
    if child_access_point is not None:
        ...
        out["access_point"] = (
            capo_s3_control.types.multi_region_access_point_report.deserialize_xml(
                child_access_point
            )
        )
    return out
