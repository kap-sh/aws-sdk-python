...
class GetMultiRegionAccessPointPolicyStatusResult(TypedDict, closed=True):
    established: NotRequired["capo_s3_control.types.policy_status.PolicyStatus"]
...
def deserialize_xml(el: Element) -> GetMultiRegionAccessPointPolicyStatusResult:
    ...
    if child_established is not None:
        ...
        out["established"] = capo_s3_control.types.policy_status.deserialize_xml(
            child_established
        )
    return out
