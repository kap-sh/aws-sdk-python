...
if TYPE_CHECKING:
    import capo_s3_control.types.async_error_details
    import capo_s3_control.types.multi_region_access_points_async_response


class AsyncResponseDetails(TypedDict, closed=True):
    multi_region_access_point_details: NotRequired[
        "capo_s3_control.types.multi_region_access_points_async_response.MultiRegionAccessPointsAsyncResponse"
    ]
...
def serialize_xml(value: AsyncResponseDetails, parent: Element, tag: str) -> None:
    ...
    if "multi_region_access_point_details" in value:
        ...
        capo_s3_control.types.multi_region_access_points_async_response.serialize_xml(
    ...
    if "error_details" in value:
        ...
        capo_s3_control.types.async_error_details.serialize_xml(
...
def deserialize_xml(el: Element) -> AsyncResponseDetails:
    ...
    if child_multi_region_access_point_details is not None:
        ...
        out["multi_region_access_point_details"] = (
            capo_s3_control.types.multi_region_access_points_async_response.deserialize_xml(
    ...
    if child_error_details is not None:
        ...
        out["error_details"] = (
            capo_s3_control.types.async_error_details.deserialize_xml(
                child_error_details
            )
        )
    return out
