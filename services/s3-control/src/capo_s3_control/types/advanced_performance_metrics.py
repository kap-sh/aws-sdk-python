"""Generated from Smithy shape ``com.amazonaws.s3control#AdvancedPerformanceMetrics``."""
...
class AdvancedPerformanceMetrics(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: AdvancedPerformanceMetrics, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> AdvancedPerformanceMetrics:
    out: AdvancedPerformanceMetrics = {}  # type: ignore[typeddict-item]
