...
if TYPE_CHECKING:
    import capo_s3_control.types.s3_access_control_list
    import capo_s3_control.types.s3_canned_access_control_list


class S3AccessControlPolicy(TypedDict, closed=True):
    access_control_list: NotRequired[
        "capo_s3_control.types.s3_access_control_list.S3AccessControlList"
    ]
    """<p></p>"""
...
def serialize_xml(value: S3AccessControlPolicy, parent: Element, tag: str) -> None:
    ...
    if "access_control_list" in value:
        ...
        capo_s3_control.types.s3_access_control_list.serialize_xml(
...
def deserialize_xml(el: Element) -> S3AccessControlPolicy:
    ...
    if child_access_control_list is not None:
        ...
        out["access_control_list"] = (
            capo_s3_control.types.s3_access_control_list.deserialize_xml(
