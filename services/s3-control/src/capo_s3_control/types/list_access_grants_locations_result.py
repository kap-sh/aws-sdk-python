...
class ListAccessGrantsLocationsResult(TypedDict, closed=True):
    ...
    access_grants_locations_list: NotRequired[
        "capo_s3_control.types.access_grants_locations_list.AccessGrantsLocationsList"
    ]
...
def serialize_xml(
    ...
    if "access_grants_locations_list" in value:
        ...
        capo_s3_control.types.access_grants_locations_list.serialize_xml(
...
def deserialize_xml(el: Element) -> ListAccessGrantsLocationsResult:
    ...
    if child_access_grants_locations_list is not None:
        ...
        out["access_grants_locations_list"] = (
            capo_s3_control.types.access_grants_locations_list.deserialize_xml(
