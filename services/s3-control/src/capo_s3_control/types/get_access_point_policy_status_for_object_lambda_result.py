...
class GetAccessPointPolicyStatusForObjectLambdaResult(TypedDict, closed=True):
    policy_status: NotRequired["capo_s3_control.types.policy_status.PolicyStatus"]
...
def serialize_xml(
    ...
    if "policy_status" in value:
        ...
        capo_s3_control.types.policy_status.serialize_xml(
...
def deserialize_xml(el: Element) -> GetAccessPointPolicyStatusForObjectLambdaResult:
    ...
    if child_policy_status is not None:
        ...
        out["policy_status"] = capo_s3_control.types.policy_status.deserialize_xml(
            child_policy_status
        )
    return out
