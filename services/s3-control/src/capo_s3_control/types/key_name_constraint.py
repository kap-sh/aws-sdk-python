...
if TYPE_CHECKING:
    import capo_s3_control.types.non_empty_max_length1024_string_list


class KeyNameConstraint(TypedDict, closed=True):
    match_any_prefix: NotRequired[
        "capo_s3_control.types.non_empty_max_length1024_string_list.NonEmptyMaxLength1024StringList"
    ]
...
def serialize_xml(value: KeyNameConstraint, parent: Element, tag: str) -> None:
    ...
    if "match_any_prefix" in value:
        ...
        capo_s3_control.types.non_empty_max_length1024_string_list.serialize_xml(
...
def deserialize_xml(el: Element) -> KeyNameConstraint:
    ...
    if child_match_any_prefix is not None:
        ...
        out["match_any_prefix"] = (
            capo_s3_control.types.non_empty_max_length1024_string_list.deserialize_xml(
