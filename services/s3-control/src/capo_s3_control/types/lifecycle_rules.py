...
if TYPE_CHECKING:
    import capo_s3_control.types.lifecycle_rule

LifecycleRules: TypeAlias = list["capo_s3_control.types.lifecycle_rule.LifecycleRule"]
...
def serialize_xml(value: LifecycleRules, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3_control.types.lifecycle_rule.serialize_xml(item, el, "Rule")
...
def deserialize_xml(el: Element) -> LifecycleRules:
    ...
    for child in el.findall("Rule"):
        out.append(capo_s3_control.types.lifecycle_rule.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: LifecycleRules, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3_control.types.lifecycle_rule.serialize_xml(item, parent, tag)
