...
if TYPE_CHECKING:
    import capo_s3_control.types.lambda_invoke_operation
    import capo_s3_control.types.s3_compute_object_checksum_operation
    import capo_s3_control.types.s3_copy_object_operation
    import capo_s3_control.types.s3_delete_object_tagging_operation
    import capo_s3_control.types.s3_initiate_restore_object_operation
    import capo_s3_control.types.s3_replicate_object_operation
    import capo_s3_control.types.s3_set_object_acl_operation
    import capo_s3_control.types.s3_set_object_legal_hold_operation
    import capo_s3_control.types.s3_set_object_retention_operation
    import capo_s3_control.types.s3_set_object_tagging_operation
    import capo_s3_control.types.s3_update_object_encryption_operation


class JobOperation(TypedDict, closed=True):
    lambda_invoke: NotRequired[
        "capo_s3_control.types.lambda_invoke_operation.LambdaInvokeOperation"
    ]
    """<p>Directs the specified job to invoke an Lambda function on every object in the manifest.</p>"""
    s3_put_object_copy: NotRequired[
        "capo_s3_control.types.s3_copy_object_operation.S3CopyObjectOperation"
    ]
    """<p>Directs the specified job to run a PUT Copy object call on every object in the manifest.</p>"""
    s3_put_object_acl: NotRequired[
        "capo_s3_control.types.s3_set_object_acl_operation.S3SetObjectAclOperation"
    ]
    ...
    s3_put_object_tagging: NotRequired[
        "capo_s3_control.types.s3_set_object_tagging_operation.S3SetObjectTaggingOperation"
    ]
    ...
    s3_delete_object_tagging: NotRequired[
        "capo_s3_control.types.s3_delete_object_tagging_operation.S3DeleteObjectTaggingOperation"
    ]
    ...
    s3_initiate_restore_object: NotRequired[
        "capo_s3_control.types.s3_initiate_restore_object_operation.S3InitiateRestoreObjectOperation"
    ]
    ...
    s3_put_object_legal_hold: NotRequired[
        "capo_s3_control.types.s3_set_object_legal_hold_operation.S3SetObjectLegalHoldOperation"
    ]
    s3_put_object_retention: NotRequired[
        "capo_s3_control.types.s3_set_object_retention_operation.S3SetObjectRetentionOperation"
    ]
    s3_replicate_object: NotRequired[
        "capo_s3_control.types.s3_replicate_object_operation.S3ReplicateObjectOperation"
    ]
    ...
    s3_compute_object_checksum: NotRequired[
        "capo_s3_control.types.s3_compute_object_checksum_operation.S3ComputeObjectChecksumOperation"
    ]
    ...
    s3_update_object_encryption: NotRequired[
        "capo_s3_control.types.s3_update_object_encryption_operation.S3UpdateObjectEncryptionOperation"
    ]
...
def deserialize_xml(el: Element) -> JobOperation:
    ...
    if child_lambda_invoke is not None:
        ...
        out["lambda_invoke"] = (
            capo_s3_control.types.lambda_invoke_operation.deserialize_xml(
                child_lambda_invoke
            )
        )
    ...
    if child_s3_put_object_copy is not None:
        ...
        out["s3_put_object_copy"] = (
            capo_s3_control.types.s3_copy_object_operation.deserialize_xml(
    ...
    if child_s3_put_object_acl is not None:
        ...
        out["s3_put_object_acl"] = (
            capo_s3_control.types.s3_set_object_acl_operation.deserialize_xml(
    ...
    if child_s3_put_object_tagging is not None:
        ...
        out["s3_put_object_tagging"] = (
            capo_s3_control.types.s3_set_object_tagging_operation.deserialize_xml(
    ...
    if child_s3_delete_object_tagging is not None:
        ...
        out["s3_delete_object_tagging"] = (
            capo_s3_control.types.s3_delete_object_tagging_operation.deserialize_xml(
    ...
    if child_s3_initiate_restore_object is not None:
        ...
        out["s3_initiate_restore_object"] = (
            capo_s3_control.types.s3_initiate_restore_object_operation.deserialize_xml(
    ...
    if child_s3_put_object_legal_hold is not None:
        ...
        out["s3_put_object_legal_hold"] = (
            capo_s3_control.types.s3_set_object_legal_hold_operation.deserialize_xml(
    ...
    if child_s3_put_object_retention is not None:
        ...
        out["s3_put_object_retention"] = (
            capo_s3_control.types.s3_set_object_retention_operation.deserialize_xml(
    ...
    if child_s3_replicate_object is not None:
        ...
        out["s3_replicate_object"] = (
            capo_s3_control.types.s3_replicate_object_operation.deserialize_xml(
    ...
    if child_s3_compute_object_checksum is not None:
        ...
        out["s3_compute_object_checksum"] = (
            capo_s3_control.types.s3_compute_object_checksum_operation.deserialize_xml(
    ...
    if child_s3_update_object_encryption is not None:
        ...
        out["s3_update_object_encryption"] = (
            capo_s3_control.types.s3_update_object_encryption_operation.deserialize_xml(
