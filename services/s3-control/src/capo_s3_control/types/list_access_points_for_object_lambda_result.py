...
class ListAccessPointsForObjectLambdaResult(TypedDict, closed=True):
    object_lambda_access_point_list: NotRequired[
        "capo_s3_control.types.object_lambda_access_point_list.ObjectLambdaAccessPointList"
    ]
...
def serialize_xml(
    ...
    if "object_lambda_access_point_list" in value:
        ...
        capo_s3_control.types.object_lambda_access_point_list.serialize_xml(
...
def deserialize_xml(el: Element) -> ListAccessPointsForObjectLambdaResult:
    ...
    if child_object_lambda_access_point_list is not None:
        ...
        out["object_lambda_access_point_list"] = (
            capo_s3_control.types.object_lambda_access_point_list.deserialize_xml(
