"""Generated from Smithy shape ``com.amazonaws.s3control#ListAccessGrantsLocationsEntry``."""
...
class ListAccessGrantsLocationsEntry(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: ListAccessGrantsLocationsEntry, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> ListAccessGrantsLocationsEntry:
    out: ListAccessGrantsLocationsEntry = {}  # type: ignore[typeddict-item]
