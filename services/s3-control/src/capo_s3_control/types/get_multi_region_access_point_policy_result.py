...
class GetMultiRegionAccessPointPolicyResult(TypedDict, closed=True):
    policy: NotRequired[
        "capo_s3_control.types.multi_region_access_point_policy_document.MultiRegionAccessPointPolicyDocument"
    ]
...
def serialize_xml(
    ...
    if "policy" in value:
        ...
        capo_s3_control.types.multi_region_access_point_policy_document.serialize_xml(
...
def deserialize_xml(el: Element) -> GetMultiRegionAccessPointPolicyResult:
    ...
    if child_policy is not None:
        ...
        out["policy"] = (
            capo_s3_control.types.multi_region_access_point_policy_document.deserialize_xml(
                child_policy
            )
        )
    return out
