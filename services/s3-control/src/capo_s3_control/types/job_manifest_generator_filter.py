...
if TYPE_CHECKING:
    ...
    import capo_s3_control.types.key_name_constraint
    import capo_s3_control.types.object_creation_time
    import capo_s3_control.types.object_encryption_filter_list
    import capo_s3_control.types.object_size_greater_than_bytes
    import capo_s3_control.types.object_size_less_than_bytes
    import capo_s3_control.types.replication_status_filter_list
    import capo_s3_control.types.storage_class_list


class JobManifestGeneratorFilter(TypedDict, closed=True):
    eligible_for_replication: NotRequired["capo_s3_control.types.boolean.Boolean"]
    ...
    created_after: NotRequired[
        "capo_s3_control.types.object_creation_time.ObjectCreationTime"
    ]
    ...
    object_replication_statuses: NotRequired[
        "capo_s3_control.types.replication_status_filter_list.ReplicationStatusFilterList"
    ]
    ...
    key_name_constraint: NotRequired[
        "capo_s3_control.types.key_name_constraint.KeyNameConstraint"
    ]
    ...
    match_any_storage_class: NotRequired[
        "capo_s3_control.types.storage_class_list.StorageClassList"
    ]
    ...
    match_any_object_encryption: NotRequired[
        "capo_s3_control.types.object_encryption_filter_list.ObjectEncryptionFilterList"
    ]
...
def serialize_xml(value: JobManifestGeneratorFilter, parent: Element, tag: str) -> None:
    ...
    if "created_after" in value:
        ...
        capo_s3_control.types.object_creation_time.serialize_xml(
    ...
    if "object_replication_statuses" in value:
        ...
        capo_s3_control.types.replication_status_filter_list.serialize_xml(
            value["object_replication_statuses"], el, "ObjectReplicationStatuses"
        )
    if "key_name_constraint" in value:
        import capo_s3_control.types.key_name_constraint

        capo_s3_control.types.key_name_constraint.serialize_xml(
    ...
    if "match_any_storage_class" in value:
        ...
        capo_s3_control.types.storage_class_list.serialize_xml(
            value["match_any_storage_class"], el, "MatchAnyStorageClass"
        )
    if "match_any_object_encryption" in value:
        import capo_s3_control.types.object_encryption_filter_list

        capo_s3_control.types.object_encryption_filter_list.serialize_xml(
...
def deserialize_xml(el: Element) -> JobManifestGeneratorFilter:
    ...
    if child_created_after is not None:
        ...
        out["created_after"] = (
            capo_s3_control.types.object_creation_time.deserialize_xml(
                child_created_after
            )
        )
    ...
    if child_object_replication_statuses is not None:
        ...
        out["object_replication_statuses"] = (
            capo_s3_control.types.replication_status_filter_list.deserialize_xml(
    ...
    if child_key_name_constraint is not None:
        ...
        out["key_name_constraint"] = (
            capo_s3_control.types.key_name_constraint.deserialize_xml(
    ...
    if child_match_any_storage_class is not None:
        ...
        out["match_any_storage_class"] = (
            capo_s3_control.types.storage_class_list.deserialize_xml(
    ...
    if child_match_any_object_encryption is not None:
        ...
        out["match_any_object_encryption"] = (
            capo_s3_control.types.object_encryption_filter_list.deserialize_xml(
