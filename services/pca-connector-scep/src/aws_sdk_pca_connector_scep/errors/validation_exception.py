...
if TYPE_CHECKING:
    import aws_sdk_pca_connector_scep.types.validation_exception_reason


class ValidationException_(TypedDict, closed=True):
    message: "str"
    reason: NotRequired[
        "aws_sdk_pca_connector_scep.types.validation_exception_reason.ValidationExceptionReason"
    ]
...
def serialize_json(value: ValidationException_) -> dict:
    ...
    if "reason" in value:
        ...
        out["Reason"] = (
            aws_sdk_pca_connector_scep.types.validation_exception_reason.serialize_json(
                value["reason"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ValidationException_:
    ...
    if "Reason" in data:
        ...
        out["reason"] = (
            aws_sdk_pca_connector_scep.types.validation_exception_reason.deserialize_json(
                data["Reason"]
            )
        )
    return out
