...
from aws_sdk_pca_connector_scep._auth._identity import Credentials
from aws_sdk_pca_connector_scep._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
...
from aws_sdk_pca_connector_scep._services._aws_config import aws_config
...
if TYPE_CHECKING:
    import aws_sdk_pca_connector_scep.types.list_tags_for_resource_request
    import aws_sdk_pca_connector_scep.types.list_tags_for_resource_response
...
class PcaConnectorScepClient:
    ...
    def __init__(
        ...
        self._config = PcaConnectorScepClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: PcaConnectorScepClientConfig = config_overrides or {}
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pca_connector_scep.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_pca_connector_scep.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_pca_connector_scep._operations.pca_connector_scep.list_tags_for_resource

            output, http_response = (
                aws_sdk_pca_connector_scep._operations.pca_connector_scep.list_tags_for_resource.list_tags_for_resource(
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pca_connector_scep.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_pca_connector_scep._operations.pca_connector_scep.tag_resource

            output, http_response = (
                aws_sdk_pca_connector_scep._operations.pca_connector_scep.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pca_connector_scep.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_pca_connector_scep._operations.pca_connector_scep.untag_resource

            output, http_response = (
                aws_sdk_pca_connector_scep._operations.pca_connector_scep.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
