...
from aws_sdk_pca_connector_scep._services._aws_config import aaws_config
...
class AsyncPcaConnectorScepClientConfig(TypedDict, total=False):
...
class AsyncPcaConnectorScepClient:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_pca_connector_scep.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_pca_connector_scep.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_pca_connector_scep._operations.pca_connector_scep.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_pca_connector_scep.types.tag_resource_request.TagResourceRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_pca_connector_scep._operations.pca_connector_scep.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_pca_connector_scep.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_pca_connector_scep._operations.pca_connector_scep.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
