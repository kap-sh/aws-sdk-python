...
if TYPE_CHECKING:
    ...
    import capo_pca_connector_scep.types.sensitive_string


class Challenge(TypedDict, closed=True):
    ...
    password: NotRequired[
        "capo_pca_connector_scep.types.sensitive_string.SensitiveString"
    ]
