...
class PcaConnectorScepError(Exception):
    """Base class for all PcaConnectorScep service errors."""


class ServiceError(PcaConnectorScepError):
...
class SerializationError(PcaConnectorScepError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PcaConnectorScepError):
...
class WaiterFailedError(PcaConnectorScepError):
...
class WaiterTimeoutError(PcaConnectorScepError):
