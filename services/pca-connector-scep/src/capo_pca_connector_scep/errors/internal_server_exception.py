"""Generated from Smithy shape ``com.amazonaws.pcaconnectorscep#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.pcaconnectorscep#InternalServerException``."""
