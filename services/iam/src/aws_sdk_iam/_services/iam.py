...
from aws_sdk_iam._services._aws_config import aws_config
...
class IAMClientConfig(TypedDict, total=False, closed=True):
...
class IAMClient:
    ...
    def operation_options(
        ...
        overrides: IAMClientConfig = config_overrides or {}
    ...
    def accept_delegation_request(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.accept_delegation_request_request.AcceptDelegationRequestRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.accept_delegation_request

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.accept_delegation_request.accept_delegation_request(
    ...
    def add_client_id_to_open_id_connect_provider(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.add_client_id_to_open_id_connect_provider(client_id='my-application-ID', open_id_connect_provider_arn='arn:aws:iam::123456789012:oidc-provider/server.example.com')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.add_client_id_to_open_id_connect_provider_request.AddClientIDToOpenIDConnectProviderRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.add_client_id_to_open_id_connect_provider

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.add_client_id_to_open_id_connect_provider.add_client_id_to_open_id_connect_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def add_role_to_instance_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.add_role_to_instance_profile(role_name='S3Access', instance_profile_name='Webserver')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.add_role_to_instance_profile_request.AddRoleToInstanceProfileRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.add_role_to_instance_profile

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.add_role_to_instance_profile.add_role_to_instance_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def add_user_to_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.add_user_to_group(user_name='Bob', group_name='Admins')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.add_user_to_group_request.AddUserToGroupRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.add_user_to_group

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.add_user_to_group.add_user_to_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def associate_delegation_request(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.associate_delegation_request_request.AssociateDelegationRequestRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.associate_delegation_request

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.associate_delegation_request.associate_delegation_request(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def attach_group_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.attach_group_policy(group_name='Finance', policy_arn='arn:aws:iam::aws:policy/ReadOnlyAccess')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.attach_group_policy_request.AttachGroupPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.attach_group_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.attach_group_policy.attach_group_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def attach_role_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.attach_role_policy(role_name='ReadOnlyRole', policy_arn='arn:aws:iam::aws:policy/ReadOnlyAccess')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.attach_role_policy_request.AttachRolePolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.attach_role_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.attach_role_policy.attach_role_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def attach_user_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.attach_user_policy(user_name='Alice', policy_arn='arn:aws:iam::aws:policy/AdministratorAccess')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.attach_user_policy_request.AttachUserPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.attach_user_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.attach_user_policy.attach_user_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def change_password(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.change_password(new_password=']35d/{pB9Fo9wJ', old_password='3s0K_;xh4~8XXI')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.change_password_request.ChangePasswordRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.change_password

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.change_password.change_password(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_access_key(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_access_key(user_name='Bob')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_access_key_request.CreateAccessKeyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_access_key_response.CreateAccessKeyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_access_key.create_access_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_account_alias(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_account_alias(account_alias='examplecorp')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_account_alias_request.CreateAccountAliasRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.create_account_alias

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_account_alias.create_account_alias(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_delegation_request(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_delegation_request_request.CreateDelegationRequestRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_delegation_request_response.CreateDelegationRequestResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_delegation_request.create_delegation_request(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_group(group_name='Admins')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_group_request.CreateGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_group_response.CreateGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_group.create_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_instance_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_instance_profile(instance_profile_name='Webserver')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_instance_profile_request.CreateInstanceProfileRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_instance_profile_response.CreateInstanceProfileResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_instance_profile.create_instance_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_login_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_login_profile(user_name='Bob', password='h]6EszR}vJ*m', password_reset_required=True)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_login_profile_request.CreateLoginProfileRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_login_profile_response.CreateLoginProfileResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_login_profile.create_login_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_open_id_connect_provider(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_open_id_connect_provider(client_id_list=['my-application-id'], thumbprint_list=['3768084dfb3d2b68b7897bf5f565da8efEXAMPLE'], url='https://server.example.com')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_open_id_connect_provider_request.CreateOpenIDConnectProviderRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_open_id_connect_provider_response.CreateOpenIDConnectProviderResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_open_id_connect_provider.create_open_id_connect_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_policy_request.CreatePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_policy_response.CreatePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_policy.create_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_policy_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_policy_version_request.CreatePolicyVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_policy_version_response.CreatePolicyVersionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_policy_version.create_policy_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_role(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_role(assume_role_policy_document='<Stringified-JSON>', path='/', role_name='Test-Role')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_role_request.CreateRoleRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_role_response.CreateRoleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_role.create_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_saml_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_saml_provider_request.CreateSAMLProviderRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_saml_provider_response.CreateSAMLProviderResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_saml_provider.create_saml_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_service_linked_role(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_service_linked_role_request.CreateServiceLinkedRoleRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_service_linked_role_response.CreateServiceLinkedRoleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_service_linked_role.create_service_linked_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_service_specific_credential(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_service_specific_credential_request.CreateServiceSpecificCredentialRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_service_specific_credential_response.CreateServiceSpecificCredentialResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_service_specific_credential.create_service_specific_credential(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_user(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_user(user_name='Bob')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_user_request.CreateUserRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_user_response.CreateUserResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_user.create_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_virtual_mfa_device(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.create_virtual_mfa_device_request.CreateVirtualMFADeviceRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.create_virtual_mfa_device_response.CreateVirtualMFADeviceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.create_virtual_mfa_device.create_virtual_mfa_device(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deactivate_mfa_device(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.deactivate_mfa_device_request.DeactivateMFADeviceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.deactivate_mfa_device

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.deactivate_mfa_device.deactivate_mfa_device(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_key(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_access_key(user_name='Bob', access_key_id='AKIDPMS9RO4H3FEXAMPLE')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_access_key_request.DeleteAccessKeyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_access_key

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_access_key.delete_access_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_account_alias(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_account_alias(account_alias='mycompany')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_account_alias_request.DeleteAccountAliasRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_account_alias

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_account_alias.delete_account_alias(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_account_password_policy(
        ...
        def _handler(req: "OperationRequest[None]") -> OperationResponse[None]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_account_password_policy.delete_account_password_policy(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_group_request.DeleteGroupRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_group

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_group.delete_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_group_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_group_policy(group_name='Admins', policy_name='ExamplePolicy')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_group_policy_request.DeleteGroupPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_group_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_group_policy.delete_group_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_instance_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_instance_profile(instance_profile_name='ExampleInstanceProfile')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_instance_profile_request.DeleteInstanceProfileRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_instance_profile

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_instance_profile.delete_instance_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_login_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_login_profile(user_name='Bob')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_login_profile_request.DeleteLoginProfileRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_login_profile

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_login_profile.delete_login_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_open_id_connect_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_open_id_connect_provider_request.DeleteOpenIDConnectProviderRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_open_id_connect_provider

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_open_id_connect_provider.delete_open_id_connect_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_policy_request.DeletePolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_policy.delete_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_policy_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_policy_version_request.DeletePolicyVersionRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_policy_version

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_policy_version.delete_policy_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_role(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_role(role_name='Test-Role')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_role_request.DeleteRoleRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_role

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_role.delete_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_role_permissions_boundary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_role_permissions_boundary_request.DeleteRolePermissionsBoundaryRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_role_permissions_boundary

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_role_permissions_boundary.delete_role_permissions_boundary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_role_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_role_policy(role_name='Test-Role', policy_name='ExamplePolicy')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_role_policy_request.DeleteRolePolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_role_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_role_policy.delete_role_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_saml_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_saml_provider_request.DeleteSAMLProviderRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_saml_provider

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_saml_provider.delete_saml_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_server_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_server_certificate_request.DeleteServerCertificateRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_server_certificate

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_server_certificate.delete_server_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_service_linked_role(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_service_linked_role_request.DeleteServiceLinkedRoleRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.delete_service_linked_role_response.DeleteServiceLinkedRoleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_service_linked_role.delete_service_linked_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_service_specific_credential(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_service_specific_credential_request.DeleteServiceSpecificCredentialRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_service_specific_credential

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_service_specific_credential.delete_service_specific_credential(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_signing_certificate(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_signing_certificate(user_name='Anika', certificate_id='TA7SMP42TDN5Z26OBPJE7EXAMPLE')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_signing_certificate_request.DeleteSigningCertificateRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_signing_certificate

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_signing_certificate.delete_signing_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_ssh_public_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_ssh_public_key_request.DeleteSSHPublicKeyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_ssh_public_key

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_ssh_public_key.delete_ssh_public_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_user(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_user(user_name='Bob')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_user_request.DeleteUserRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_user

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_user.delete_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_user_permissions_boundary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_user_permissions_boundary_request.DeleteUserPermissionsBoundaryRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_user_permissions_boundary

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_user_permissions_boundary.delete_user_permissions_boundary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_user_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_user_policy(user_name='Juan', policy_name='ExamplePolicy')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_user_policy_request.DeleteUserPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_user_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_user_policy.delete_user_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_virtual_mfa_device(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_virtual_mfa_device(serial_number='arn:aws:iam::123456789012:mfa/ExampleName')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.delete_virtual_mfa_device_request.DeleteVirtualMFADeviceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.delete_virtual_mfa_device

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.delete_virtual_mfa_device.delete_virtual_mfa_device(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def detach_group_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.detach_group_policy_request.DetachGroupPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.detach_group_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.detach_group_policy.detach_group_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def detach_role_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.detach_role_policy_request.DetachRolePolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.detach_role_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.detach_role_policy.detach_role_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def detach_user_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.detach_user_policy_request.DetachUserPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.detach_user_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.detach_user_policy.detach_user_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_organizations_root_credentials_management(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.disable_organizations_root_credentials_management_request.DisableOrganizationsRootCredentialsManagementRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.disable_organizations_root_credentials_management_response.DisableOrganizationsRootCredentialsManagementResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.disable_organizations_root_credentials_management.disable_organizations_root_credentials_management(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_organizations_root_sessions(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.disable_organizations_root_sessions_request.DisableOrganizationsRootSessionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.disable_organizations_root_sessions_response.DisableOrganizationsRootSessionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.disable_organizations_root_sessions.disable_organizations_root_sessions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_outbound_web_identity_federation(
        ...
        def _handler(req: "OperationRequest[None]") -> OperationResponse[None]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.disable_outbound_web_identity_federation.disable_outbound_web_identity_federation(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_mfa_device(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.enable_mfa_device_request.EnableMFADeviceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.enable_mfa_device

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.enable_mfa_device.enable_mfa_device(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_organizations_root_credentials_management(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.enable_organizations_root_credentials_management_request.EnableOrganizationsRootCredentialsManagementRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.enable_organizations_root_credentials_management_response.EnableOrganizationsRootCredentialsManagementResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.enable_organizations_root_credentials_management.enable_organizations_root_credentials_management(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_organizations_root_sessions(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.enable_organizations_root_sessions_request.EnableOrganizationsRootSessionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.enable_organizations_root_sessions_response.EnableOrganizationsRootSessionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.enable_organizations_root_sessions.enable_organizations_root_sessions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_outbound_web_identity_federation(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.enable_outbound_web_identity_federation.enable_outbound_web_identity_federation(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_credential_report(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.generate_credential_report.generate_credential_report(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_organizations_access_report(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.generate_organizations_access_report(entity_path='o-a1b2c3d4e5/r-f6g7h8i9j0example/ou-1a2b3c-k9l8m7n6o5example')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.generate_organizations_access_report_request.GenerateOrganizationsAccessReportRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.generate_organizations_access_report_response.GenerateOrganizationsAccessReportResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.generate_organizations_access_report.generate_organizations_access_report(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_service_last_accessed_details(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.generate_service_last_accessed_details(arn='arn:aws:iam::123456789012:policy/ExamplePolicy1')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.generate_service_last_accessed_details_request.GenerateServiceLastAccessedDetailsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.generate_service_last_accessed_details_response.GenerateServiceLastAccessedDetailsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.generate_service_last_accessed_details.generate_service_last_accessed_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_key_last_used(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_access_key_last_used_request.GetAccessKeyLastUsedRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_access_key_last_used_response.GetAccessKeyLastUsedResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_access_key_last_used.get_access_key_last_used(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_account_authorization_details(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_account_authorization_details_request.GetAccountAuthorizationDetailsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_account_authorization_details_response.GetAccountAuthorizationDetailsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_account_authorization_details.get_account_authorization_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_account_password_policy(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_account_password_policy.get_account_password_policy(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_account_summary(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_account_summary.get_account_summary(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_context_keys_for_custom_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_context_keys_for_custom_policy_request.GetContextKeysForCustomPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_context_keys_for_policy_response.GetContextKeysForPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_context_keys_for_custom_policy.get_context_keys_for_custom_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_context_keys_for_principal_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_context_keys_for_principal_policy_request.GetContextKeysForPrincipalPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_context_keys_for_policy_response.GetContextKeysForPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_context_keys_for_principal_policy.get_context_keys_for_principal_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_credential_report(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_credential_report.get_credential_report(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_delegation_request(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_delegation_request_request.GetDelegationRequestRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_delegation_request_response.GetDelegationRequestResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_delegation_request.get_delegation_request(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_group_request.GetGroupRequest]",
        ) -> OperationResponse["aws_sdk_iam.types.get_group_response.GetGroupResponse"]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.get_group

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_group.get_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_group(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.user.User]":
        _token = marker
        while True:
            _response = self.get_group(
                group_name,
    ...
    def get_group_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_group_policy_request.GetGroupPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_group_policy_response.GetGroupPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_group_policy.get_group_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_human_readable_summary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_human_readable_summary_request.GetHumanReadableSummaryRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_human_readable_summary_response.GetHumanReadableSummaryResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_human_readable_summary.get_human_readable_summary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_instance_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_instance_profile(instance_profile_name='ExampleInstanceProfile')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_instance_profile_request.GetInstanceProfileRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_instance_profile_response.GetInstanceProfileResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_instance_profile.get_instance_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def wait_until_instance_profile_exists(
        ...
        *,
        ...
        while True:
            ...
            try:
                op_output = self.get_instance_profile(  # noqa: F841
    ...
    def get_login_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_login_profile(user_name='Anika')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_login_profile_request.GetLoginProfileRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_login_profile_response.GetLoginProfileResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_login_profile.get_login_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_mfa_device(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_mfa_device_request.GetMFADeviceRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_mfa_device_response.GetMFADeviceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_mfa_device.get_mfa_device(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_open_id_connect_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_open_id_connect_provider_request.GetOpenIDConnectProviderRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_open_id_connect_provider_response.GetOpenIDConnectProviderResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_open_id_connect_provider.get_open_id_connect_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_organizations_access_report(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_organizations_access_report(job_id='examplea-1234-b567-cde8-90fg123abcd4')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_organizations_access_report_request.GetOrganizationsAccessReportRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_organizations_access_report_response.GetOrganizationsAccessReportResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_organizations_access_report.get_organizations_access_report(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_outbound_web_identity_federation_info(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_outbound_web_identity_federation_info.get_outbound_web_identity_federation_info(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_policy_request.GetPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_policy_response.GetPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_policy.get_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def wait_until_policy_exists(
        ...
        *,
        ...
        while True:
            ...
            op_error: ServiceError | None = None
            try:
                op_output = self.get_policy(  # noqa: F841
    ...
    def get_policy_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_policy_version_request.GetPolicyVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_policy_version_response.GetPolicyVersionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_policy_version.get_policy_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_role(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_role(role_name='Test-Role')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_role_request.GetRoleRequest]",
        ) -> OperationResponse["aws_sdk_iam.types.get_role_response.GetRoleResponse"]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.get_role

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_role.get_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def wait_until_role_exists(
        ...
        *,
        ...
        while True:
            ...
            op_error: ServiceError | None = None
            try:
                op_output = self.get_role(  # noqa: F841
    ...
    def get_role_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_role_policy_request.GetRolePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_role_policy_response.GetRolePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_role_policy.get_role_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_saml_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_saml_provider_request.GetSAMLProviderRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_saml_provider_response.GetSAMLProviderResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_saml_provider.get_saml_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_server_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_server_certificate_request.GetServerCertificateRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_server_certificate_response.GetServerCertificateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_server_certificate.get_server_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_service_last_accessed_details(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_service_last_accessed_details(job_id='examplef-1305-c245-eba4-71fe298bcda7')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_service_last_accessed_details_request.GetServiceLastAccessedDetailsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_service_last_accessed_details_response.GetServiceLastAccessedDetailsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_service_last_accessed_details.get_service_last_accessed_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_service_last_accessed_details_with_entities(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_service_last_accessed_details_with_entities(job_id='examplef-1305-c245-eba4-71fe298bcda7', service_namespace='iam')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_service_last_accessed_details_with_entities_request.GetServiceLastAccessedDetailsWithEntitiesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_service_last_accessed_details_with_entities_response.GetServiceLastAccessedDetailsWithEntitiesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_service_last_accessed_details_with_entities.get_service_last_accessed_details_with_entities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_service_linked_role_deletion_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_service_linked_role_deletion_status_request.GetServiceLinkedRoleDeletionStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_service_linked_role_deletion_status_response.GetServiceLinkedRoleDeletionStatusResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_service_linked_role_deletion_status.get_service_linked_role_deletion_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_ssh_public_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_ssh_public_key_request.GetSSHPublicKeyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_ssh_public_key_response.GetSSHPublicKeyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_ssh_public_key.get_ssh_public_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_user(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_user(user_name='Bob')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_user_request.GetUserRequest]",
        ) -> OperationResponse["aws_sdk_iam.types.get_user_response.GetUserResponse"]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.get_user

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_user.get_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def wait_until_user_exists(
        ...
        *,
        ...
        while True:
            ...
            op_error: ServiceError | None = None
            try:
                op_output = self.get_user(  # noqa: F841
    ...
    def get_user_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.get_user_policy_request.GetUserPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.get_user_policy_response.GetUserPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.get_user_policy.get_user_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_access_keys(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_access_keys(user_name='Alice')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_access_keys_request.ListAccessKeysRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_access_keys_response.ListAccessKeysResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_access_keys.list_access_keys(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_access_keys(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.access_key_metadata.AccessKeyMetadata]":
        _token = marker
        while True:
            _response = self.list_access_keys(
                config_overrides=config_overrides,
                user_name=user_name,
                marker=_token,
                max_items=max_items,
    ...
    def list_account_aliases(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_account_aliases_request.ListAccountAliasesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_account_aliases_response.ListAccountAliasesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_account_aliases.list_account_aliases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_account_aliases(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.account_alias_type.accountAliasType]":
        _token = marker
        while True:
            _response = self.list_account_aliases(
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
            )
    ...
    def list_attached_group_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_attached_group_policies_request.ListAttachedGroupPoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_attached_group_policies_response.ListAttachedGroupPoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_attached_group_policies.list_attached_group_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_attached_group_policies(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.attached_policy.AttachedPolicy]":
        _token = marker
        while True:
            _response = self.list_attached_group_policies(
                group_name,
                config_overrides=config_overrides,
    ...
    def list_attached_role_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_attached_role_policies_request.ListAttachedRolePoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_attached_role_policies_response.ListAttachedRolePoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_attached_role_policies.list_attached_role_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_attached_role_policies(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_attached_role_policies(
                role_name,
                config_overrides=config_overrides,
                path_prefix=path_prefix,
                marker=_token,
    ...
    def list_attached_user_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_attached_user_policies_request.ListAttachedUserPoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_attached_user_policies_response.ListAttachedUserPoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_attached_user_policies.list_attached_user_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_attached_user_policies(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_attached_user_policies(
                user_name,
                config_overrides=config_overrides,
                path_prefix=path_prefix,
                marker=_token,
    ...
    def list_delegation_requests(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_delegation_requests_request.ListDelegationRequestsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_delegation_requests_response.ListDelegationRequestsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_delegation_requests.list_delegation_requests(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_entities_for_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_entities_for_policy_request.ListEntitiesForPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_entities_for_policy_response.ListEntitiesForPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_entities_for_policy.list_entities_for_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_group_policies(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_group_policies(group_name='Admins')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_group_policies_request.ListGroupPoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_group_policies_response.ListGroupPoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_group_policies.list_group_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_group_policies(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.policy_name_type.policyNameType]":
        _token = marker
        while True:
            _response = self.list_group_policies(
                group_name,
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
    ...
    def list_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_groups_request.ListGroupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_groups_response.ListGroupsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_groups.list_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_groups(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.group.Group]":
        _token = marker
        while True:
    ...
    def list_groups_for_user(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_groups_for_user(user_name='Bob')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_groups_for_user_request.ListGroupsForUserRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_groups_for_user_response.ListGroupsForUserResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_groups_for_user.list_groups_for_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_groups_for_user(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_groups_for_user(
                user_name,
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
    ...
    def list_instance_profiles(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_instance_profiles_request.ListInstanceProfilesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_instance_profiles_response.ListInstanceProfilesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_instance_profiles.list_instance_profiles(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_instance_profiles(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.instance_profile.InstanceProfile]":
        _token = marker
        while True:
            _response = self.list_instance_profiles(
                config_overrides=config_overrides,
                path_prefix=path_prefix,
                marker=_token,
                max_items=max_items,
    ...
    def list_instance_profiles_for_role(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_instance_profiles_for_role_request.ListInstanceProfilesForRoleRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_instance_profiles_for_role_response.ListInstanceProfilesForRoleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_instance_profiles_for_role.list_instance_profiles_for_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_instance_profiles_for_role(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_instance_profiles_for_role(
                role_name,
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
    ...
    def list_instance_profile_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_instance_profile_tags_request.ListInstanceProfileTagsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_instance_profile_tags_response.ListInstanceProfileTagsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_instance_profile_tags.list_instance_profile_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_instance_profile_tags(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.tag.Tag]":
        _token = marker
        while True:
            _response = self.list_instance_profile_tags(
    ...
    def list_mfa_devices(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_mfa_devices_request.ListMFADevicesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_mfa_devices_response.ListMFADevicesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_mfa_devices.list_mfa_devices(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_mfa_devices(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.mfa_device.MFADevice]":
        _token = marker
        while True:
            _response = self.list_mfa_devices(
                config_overrides=config_overrides,
                user_name=user_name,
                marker=_token,
                max_items=max_items,
    ...
    def list_mfa_device_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_mfa_device_tags_request.ListMFADeviceTagsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_mfa_device_tags_response.ListMFADeviceTagsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_mfa_device_tags.list_mfa_device_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_mfa_device_tags(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_mfa_device_tags(
                serial_number,
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
    ...
    def list_open_id_connect_providers(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_open_id_connect_providers_request.ListOpenIDConnectProvidersRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_open_id_connect_providers_response.ListOpenIDConnectProvidersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_open_id_connect_providers.list_open_id_connect_providers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_open_id_connect_provider_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_open_id_connect_provider_tags_request.ListOpenIDConnectProviderTagsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_open_id_connect_provider_tags_response.ListOpenIDConnectProviderTagsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_open_id_connect_provider_tags.list_open_id_connect_provider_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_open_id_connect_provider_tags(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_open_id_connect_provider_tags(
    ...
    def list_organizations_features(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_organizations_features_request.ListOrganizationsFeaturesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_organizations_features_response.ListOrganizationsFeaturesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_organizations_features.list_organizations_features(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_policies_request.ListPoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_policies_response.ListPoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_policies.list_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_policies(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.policy.Policy]":
        _token = marker
        while True:
    ...
    def list_policies_granting_service_access(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_policies_granting_service_access(arn='arn:aws:iam::123456789012:user/ExampleUser01', service_namespaces=['iam', 'ec2'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_policies_granting_service_access_request.ListPoliciesGrantingServiceAccessRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_policies_granting_service_access_response.ListPoliciesGrantingServiceAccessResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_policies_granting_service_access.list_policies_granting_service_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_policy_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_policy_tags_request.ListPolicyTagsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_policy_tags_response.ListPolicyTagsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_policy_tags.list_policy_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_policy_tags(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_policy_tags(
                policy_arn,
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
    ...
    def list_policy_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_policy_versions_request.ListPolicyVersionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_policy_versions_response.ListPolicyVersionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_policy_versions.list_policy_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_policy_versions(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.policy_version.PolicyVersion]":
        _token = marker
        while True:
    ...
    def list_role_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_role_policies_request.ListRolePoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_role_policies_response.ListRolePoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_role_policies.list_role_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_role_policies(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_role_policies(
                role_name,
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
    ...
    def list_roles(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_roles_request.ListRolesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_roles_response.ListRolesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_roles.list_roles(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_roles(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.role.Role]":
        _token = marker
        while True:
            _response = self.list_roles(
                config_overrides=config_overrides,
                path_prefix=path_prefix,
                marker=_token,
                max_items=max_items,
    ...
    def list_role_tags(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_role_tags(role_name='taggedrole1')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_role_tags_request.ListRoleTagsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_role_tags_response.ListRoleTagsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_role_tags.list_role_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_saml_providers(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_saml_providers_request.ListSAMLProvidersRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_saml_providers_response.ListSAMLProvidersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_saml_providers.list_saml_providers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_saml_provider_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_saml_provider_tags_request.ListSAMLProviderTagsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_saml_provider_tags_response.ListSAMLProviderTagsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_saml_provider_tags.list_saml_provider_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_saml_provider_tags(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_saml_provider_tags(
                saml_provider_arn,
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
    ...
    def list_server_certificates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_server_certificates_request.ListServerCertificatesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_server_certificates_response.ListServerCertificatesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_server_certificates.list_server_certificates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_server_certificates(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.server_certificate_metadata.ServerCertificateMetadata]":
        _token = marker
        while True:
            _response = self.list_server_certificates(
                config_overrides=config_overrides,
                path_prefix=path_prefix,
                marker=_token,
                max_items=max_items,
    ...
    def list_server_certificate_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_server_certificate_tags_request.ListServerCertificateTagsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_server_certificate_tags_response.ListServerCertificateTagsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_server_certificate_tags.list_server_certificate_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_server_certificate_tags(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_server_certificate_tags(
    ...
    def list_service_specific_credentials(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_service_specific_credentials_request.ListServiceSpecificCredentialsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_service_specific_credentials_response.ListServiceSpecificCredentialsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_service_specific_credentials.list_service_specific_credentials(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_signing_certificates(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_signing_certificates(user_name='Bob')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_signing_certificates_request.ListSigningCertificatesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_signing_certificates_response.ListSigningCertificatesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_signing_certificates.list_signing_certificates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_signing_certificates(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.signing_certificate.SigningCertificate]":
        _token = marker
        while True:
            _response = self.list_signing_certificates(
                config_overrides=config_overrides,
                user_name=user_name,
                marker=_token,
                max_items=max_items,
    ...
    def list_ssh_public_keys(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_ssh_public_keys_request.ListSSHPublicKeysRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_ssh_public_keys_response.ListSSHPublicKeysResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_ssh_public_keys.list_ssh_public_keys(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_ssh_public_keys(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.ssh_public_key_metadata.SSHPublicKeyMetadata]":
        _token = marker
        while True:
            _response = self.list_ssh_public_keys(
                config_overrides=config_overrides,
                user_name=user_name,
                marker=_token,
                max_items=max_items,
    ...
    def list_user_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_user_policies_request.ListUserPoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_user_policies_response.ListUserPoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_user_policies.list_user_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_user_policies(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.list_user_policies(
                user_name,
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
    ...
    def list_users(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_users_request.ListUsersRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_users_response.ListUsersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_users.list_users(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_user_tags(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_user_tags(user_name='anika')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_user_tags_request.ListUserTagsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_user_tags_response.ListUserTagsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_user_tags.list_user_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_virtual_mfa_devices(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.list_virtual_mfa_devices_request.ListVirtualMFADevicesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.list_virtual_mfa_devices_response.ListVirtualMFADevicesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.list_virtual_mfa_devices.list_virtual_mfa_devices(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_virtual_mfa_devices(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.virtual_mfa_device.VirtualMFADevice]":
        _token = marker
        while True:
            _response = self.list_virtual_mfa_devices(
                config_overrides=config_overrides,
    ...
    def put_group_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.put_group_policy(group_name='PowerUsers', policy_name='IAMReadAccess', policy_document='{"Version":"2012-10-17","Statement":{"Effect":"Allow","Action":["iam:Get*","iam:List*","iam:Generate*"],"Resource":"*"}}')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.put_group_policy_request.PutGroupPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.put_group_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.put_group_policy.put_group_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_role_permissions_boundary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.put_role_permissions_boundary_request.PutRolePermissionsBoundaryRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.put_role_permissions_boundary

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.put_role_permissions_boundary.put_role_permissions_boundary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_role_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.put_role_policy(role_name='S3Access', policy_name='S3AccessPolicy', policy_document='{"Version":"2012-10-17","Statement":{"Effect":"Allow","Action":"s3:*","Resource":"*"}}')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.put_role_policy_request.PutRolePolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.put_role_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.put_role_policy.put_role_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_user_permissions_boundary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.put_user_permissions_boundary_request.PutUserPermissionsBoundaryRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.put_user_permissions_boundary

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.put_user_permissions_boundary.put_user_permissions_boundary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_user_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.put_user_policy(user_name='Bob', policy_name='AllAccessPolicy', policy_document='{"Version":"2012-10-17","Statement":{"Effect":"Allow","Action":"*","Resource":"*"}}')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.put_user_policy_request.PutUserPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.put_user_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.put_user_policy.put_user_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reject_delegation_request(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.reject_delegation_request_request.RejectDelegationRequestRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.reject_delegation_request

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.reject_delegation_request.reject_delegation_request(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_client_id_from_open_id_connect_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.remove_client_id_from_open_id_connect_provider_request.RemoveClientIDFromOpenIDConnectProviderRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.remove_client_id_from_open_id_connect_provider

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.remove_client_id_from_open_id_connect_provider.remove_client_id_from_open_id_connect_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_role_from_instance_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.remove_role_from_instance_profile(role_name='Test-Role', instance_profile_name='ExampleInstanceProfile')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.remove_role_from_instance_profile_request.RemoveRoleFromInstanceProfileRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.remove_role_from_instance_profile

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.remove_role_from_instance_profile.remove_role_from_instance_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_user_from_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.remove_user_from_group(user_name='Bob', group_name='Admins')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.remove_user_from_group_request.RemoveUserFromGroupRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.remove_user_from_group

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.remove_user_from_group.remove_user_from_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reset_service_specific_credential(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.reset_service_specific_credential_request.ResetServiceSpecificCredentialRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.reset_service_specific_credential_response.ResetServiceSpecificCredentialResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.reset_service_specific_credential.reset_service_specific_credential(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def resync_mfa_device(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.resync_mfa_device_request.ResyncMFADeviceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.resync_mfa_device

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.resync_mfa_device.resync_mfa_device(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_delegation_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.send_delegation_token_request.SendDelegationTokenRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.send_delegation_token

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.send_delegation_token.send_delegation_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_default_policy_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.set_default_policy_version_request.SetDefaultPolicyVersionRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.set_default_policy_version

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.set_default_policy_version.set_default_policy_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_security_token_service_preferences(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.set_security_token_service_preferences(global_endpoint_token_version='v2Token')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.set_security_token_service_preferences_request.SetSecurityTokenServicePreferencesRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.set_security_token_service_preferences

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.set_security_token_service_preferences.set_security_token_service_preferences(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def simulate_custom_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.simulate_custom_policy_request.SimulateCustomPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.simulate_policy_response.SimulatePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.simulate_custom_policy.simulate_custom_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_simulate_custom_policy(
        ...
        *,
        ...
        max_items: Optional["aws_sdk_iam.types.max_items_type.maxItemsType"] = None,
        marker: Optional["aws_sdk_iam.types.marker_type.markerType"] = None,
    ) -> "Iterator[aws_sdk_iam.types.evaluation_result.EvaluationResult]":
        _token = marker
        while True:
            _response = self.simulate_custom_policy(
                policy_input_list,
                action_names,
                config_overrides=config_overrides,
    ...
    def simulate_principal_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.simulate_principal_policy_request.SimulatePrincipalPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.simulate_policy_response.SimulatePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.simulate_principal_policy.simulate_principal_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_simulate_principal_policy(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = self.simulate_principal_policy(
                policy_source_arn,
                action_names,
                config_overrides=config_overrides,
    ...
    def tag_instance_profile(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.tag_instance_profile_request.TagInstanceProfileRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.tag_instance_profile

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.tag_instance_profile.tag_instance_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_mfa_device(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.tag_mfa_device_request.TagMFADeviceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.tag_mfa_device

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.tag_mfa_device.tag_mfa_device(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_open_id_connect_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.tag_open_id_connect_provider_request.TagOpenIDConnectProviderRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.tag_open_id_connect_provider

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.tag_open_id_connect_provider.tag_open_id_connect_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.tag_policy_request.TagPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.tag_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.tag_policy.tag_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_role(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.tag_role(role_name='taggedrole', tags=[{'Key': 'Dept', 'Value': 'Accounting'}, {'Key': 'CostCenter', 'Value': '12345'}])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.tag_role_request.TagRoleRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.tag_role

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.tag_role.tag_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_saml_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.tag_saml_provider_request.TagSAMLProviderRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.tag_saml_provider

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.tag_saml_provider.tag_saml_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_server_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.tag_server_certificate_request.TagServerCertificateRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.tag_server_certificate

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.tag_server_certificate.tag_server_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_user(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.tag_user(user_name='anika', tags=[{'Key': 'Dept', 'Value': 'Accounting'}, {'Key': 'CostCenter', 'Value': '12345'}])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.tag_user_request.TagUserRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.tag_user

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.tag_user.tag_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_instance_profile(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.untag_instance_profile_request.UntagInstanceProfileRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.untag_instance_profile

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.untag_instance_profile.untag_instance_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_mfa_device(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.untag_mfa_device_request.UntagMFADeviceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.untag_mfa_device

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.untag_mfa_device.untag_mfa_device(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_open_id_connect_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.untag_open_id_connect_provider_request.UntagOpenIDConnectProviderRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.untag_open_id_connect_provider

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.untag_open_id_connect_provider.untag_open_id_connect_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.untag_policy_request.UntagPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.untag_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.untag_policy.untag_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_role(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.untag_role(role_name='taggedrole', tag_keys=['Dept'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.untag_role_request.UntagRoleRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.untag_role

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.untag_role.untag_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_saml_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.untag_saml_provider_request.UntagSAMLProviderRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.untag_saml_provider

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.untag_saml_provider.untag_saml_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_server_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.untag_server_certificate_request.UntagServerCertificateRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.untag_server_certificate

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.untag_server_certificate.untag_server_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_user(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.untag_user(user_name='anika', tag_keys=['Dept'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.untag_user_request.UntagUserRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.untag_user

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.untag_user.untag_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_access_key(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_access_key(user_name='Bob', status='Inactive', access_key_id='AKIAIOSFODNN7EXAMPLE')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_access_key_request.UpdateAccessKeyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_access_key

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_access_key.update_access_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_account_password_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_account_password_policy(minimum_password_length=8, require_numbers=True)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_account_password_policy_request.UpdateAccountPasswordPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_account_password_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_account_password_policy.update_account_password_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_assume_role_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_assume_role_policy(policy_document='{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Principal":{"Service":["ec2.amazonaws.com"]},"Action":["sts:AssumeRole"]}]}', role_name='S3AccessForEC2Instances')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_assume_role_policy_request.UpdateAssumeRolePolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_assume_role_policy

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_assume_role_policy.update_assume_role_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_delegation_request(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_delegation_request_request.UpdateDelegationRequestRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_delegation_request

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_delegation_request.update_delegation_request(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_group(group_name='Test', new_group_name='Test-1')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_group_request.UpdateGroupRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_group

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_group.update_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_login_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_login_profile(user_name='Bob', password='SomeKindOfPassword123!@#')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_login_profile_request.UpdateLoginProfileRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_login_profile

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_login_profile.update_login_profile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_open_id_connect_provider_thumbprint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_open_id_connect_provider_thumbprint_request.UpdateOpenIDConnectProviderThumbprintRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_open_id_connect_provider_thumbprint

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_open_id_connect_provider_thumbprint.update_open_id_connect_provider_thumbprint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_role(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_role_request.UpdateRoleRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.update_role_response.UpdateRoleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_role.update_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_role_description(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_role_description_request.UpdateRoleDescriptionRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.update_role_description_response.UpdateRoleDescriptionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_role_description.update_role_description(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_saml_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_saml_provider_request.UpdateSAMLProviderRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.update_saml_provider_response.UpdateSAMLProviderResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_saml_provider.update_saml_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_server_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_server_certificate_request.UpdateServerCertificateRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_server_certificate

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_server_certificate.update_server_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_service_specific_credential(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_service_specific_credential_request.UpdateServiceSpecificCredentialRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_service_specific_credential

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_service_specific_credential.update_service_specific_credential(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_signing_certificate(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_signing_certificate(user_name='Bob', certificate_id='TA7SMP42TDN5Z26OBPJE7EXAMPLE', status='Inactive')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_signing_certificate_request.UpdateSigningCertificateRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_signing_certificate

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_signing_certificate.update_signing_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_ssh_public_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_ssh_public_key_request.UpdateSSHPublicKeyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_ssh_public_key

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_ssh_public_key.update_ssh_public_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_user(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_user(user_name='Bob', new_user_name='Robert')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.update_user_request.UpdateUserRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iam._operations.aws_identity_management_v20100508.update_user

            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.update_user.update_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def upload_server_certificate(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.upload_server_certificate(server_certificate_name='ProdServerCert', path='/company/servercerts/', certificate_body='-----BEGIN CERTIFICATE-----<a very long certificate text string>-----END CERTIFICATE-----', private_key='-----BEGIN DSA PRIVATE KEY-----<a very long private key string>-----END DSA PRIVATE KEY-----')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.upload_server_certificate_request.UploadServerCertificateRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.upload_server_certificate_response.UploadServerCertificateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.upload_server_certificate.upload_server_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def upload_signing_certificate(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.upload_signing_certificate(user_name='Bob', certificate_body='-----BEGIN CERTIFICATE-----<certificate-body>-----END CERTIFICATE-----')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.upload_signing_certificate_request.UploadSigningCertificateRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.upload_signing_certificate_response.UploadSigningCertificateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.upload_signing_certificate.upload_signing_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def upload_ssh_public_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iam.types.upload_ssh_public_key_request.UploadSSHPublicKeyRequest]",
        ) -> OperationResponse[
            "aws_sdk_iam.types.upload_ssh_public_key_response.UploadSSHPublicKeyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iam._operations.aws_identity_management_v20100508.upload_ssh_public_key.upload_ssh_public_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
