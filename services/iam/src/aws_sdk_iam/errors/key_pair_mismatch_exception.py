...
if TYPE_CHECKING:
    import aws_sdk_iam.types.key_pair_mismatch_message


class KeyPairMismatchException_(TypedDict):
    message: NotRequired[
        "aws_sdk_iam.types.key_pair_mismatch_message.keyPairMismatchMessage"
    ]
