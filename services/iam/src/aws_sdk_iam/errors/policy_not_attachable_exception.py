...
if TYPE_CHECKING:
    import aws_sdk_iam.types.policy_not_attachable_message


class PolicyNotAttachableException_(TypedDict):
    message: NotRequired[
        "aws_sdk_iam.types.policy_not_attachable_message.policyNotAttachableMessage"
    ]
