...
if TYPE_CHECKING:
    import aws_sdk_iam.types.password_policy_violation_message


class PasswordPolicyViolationException_(TypedDict):
    message: NotRequired[
        "aws_sdk_iam.types.password_policy_violation_message.passwordPolicyViolationMessage"
    ]
