...
class IAMError(Exception):
    """Base class for all IAM service errors."""


class ServiceError(IAMError):
...
class SerializationError(IAMError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IAMError):
...
class WaiterFailedError(IAMError):
...
class WaiterTimeoutError(IAMError):
