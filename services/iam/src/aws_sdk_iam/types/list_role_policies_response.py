"""Generated from Smithy shape ``com.amazonaws.iam#ListRolePoliciesResponse``."""
...
class ListRolePoliciesResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListRolePoliciesResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
    import aws_sdk_iam.types.policy_name_list_type
...
def deserialize_query(el: Element) -> ListRolePoliciesResponse:
    out: ListRolePoliciesResponse = {}  # type: ignore[typeddict-item]
    ...
    if child_policy_names is not None:
        ...
        raise DeserializationError("ListRolePoliciesResponse.policy_names required")
