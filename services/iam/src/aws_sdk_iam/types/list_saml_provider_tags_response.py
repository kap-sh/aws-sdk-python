"""Generated from Smithy shape ``com.amazonaws.iam#ListSAMLProviderTagsResponse``."""
...
class ListSAMLProviderTagsResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListSAMLProviderTagsResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
    import aws_sdk_iam.types.tag_list_type
...
def deserialize_query(el: Element) -> ListSAMLProviderTagsResponse:
    out: ListSAMLProviderTagsResponse = {}  # type: ignore[typeddict-item]
    ...
    if child_tags is not None:
        ...
        raise DeserializationError("ListSAMLProviderTagsResponse.tags required")
