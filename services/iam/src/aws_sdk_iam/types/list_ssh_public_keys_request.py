...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListSSHPublicKeysRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListSSHPublicKeysRequest:
    out: ListSSHPublicKeysRequest = {}  # type: ignore[typeddict-item]
