"""Generated from Smithy shape ``com.amazonaws.iam#DisableOrganizationsRootCredentialsManagementResponse``."""
...
class DisableOrganizationsRootCredentialsManagementResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DisableOrganizationsRootCredentialsManagementResponse,
...
def deserialize_query(
    ...
    out: DisableOrganizationsRootCredentialsManagementResponse = {}  # type: ignore[typeddict-item]
