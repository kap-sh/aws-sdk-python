"""Generated from Smithy shape ``com.amazonaws.iam#ListInstanceProfilesResponse``."""
...
class ListInstanceProfilesResponse(TypedDict, closed=True):
    instance_profiles: (
...
def deserialize_query(el: Element) -> ListInstanceProfilesResponse:
    out: ListInstanceProfilesResponse = {}  # type: ignore[typeddict-item]
    ...
    if child_instance_profiles is not None:
        ...
        raise DeserializationError(
            "ListInstanceProfilesResponse.instance_profiles required"
        )
