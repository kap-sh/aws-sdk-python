"""Generated from Smithy shape ``com.amazonaws.iam#ListRoleTagsResponse``."""
...
class ListRoleTagsResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListRoleTagsResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
    import aws_sdk_iam.types.tag_list_type
...
def deserialize_query(el: Element) -> ListRoleTagsResponse:
    out: ListRoleTagsResponse = {}  # type: ignore[typeddict-item]
    ...
    if child_tags is not None:
        ...
        raise DeserializationError("ListRoleTagsResponse.tags required")
