...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListAttachedUserPoliciesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListAttachedUserPoliciesRequest:
    out: ListAttachedUserPoliciesRequest = {}  # type: ignore[typeddict-item]
    child_user_name = el.find("UserName")
    if child_user_name is not None:
        out["user_name"] = str(child_user_name.text or "")
    else:
        raise DeserializationError("ListAttachedUserPoliciesRequest.user_name required")
