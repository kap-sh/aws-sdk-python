...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListAccountAliasesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "marker" in value:
...
def deserialize_query(el: Element) -> ListAccountAliasesRequest:
    out: ListAccountAliasesRequest = {}  # type: ignore[typeddict-item]
