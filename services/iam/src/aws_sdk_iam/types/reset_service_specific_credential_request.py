...
# --- awsQuery ser/de ---
def serialize_query(
    value: ResetServiceSpecificCredentialRequest,
...
def deserialize_query(el: Element) -> ResetServiceSpecificCredentialRequest:
    out: ResetServiceSpecificCredentialRequest = {}  # type: ignore[typeddict-item]
    ...
    if child_service_specific_credential_id is not None:
        ...
        raise DeserializationError(
            "ResetServiceSpecificCredentialRequest.service_specific_credential_id required"
        )
    return out
