"""Generated from Smithy shape ``com.amazonaws.iam#EnableOrganizationsRootCredentialsManagementResponse``."""
...
class EnableOrganizationsRootCredentialsManagementResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: EnableOrganizationsRootCredentialsManagementResponse,
...
def deserialize_query(
    ...
    out: EnableOrganizationsRootCredentialsManagementResponse = {}  # type: ignore[typeddict-item]
