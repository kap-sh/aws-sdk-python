"""Generated from Smithy shape ``com.amazonaws.iam#ListUserTagsResponse``."""
...
class ListUserTagsResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListUserTagsResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
    import aws_sdk_iam.types.tag_list_type
...
def deserialize_query(el: Element) -> ListUserTagsResponse:
    out: ListUserTagsResponse = {}  # type: ignore[typeddict-item]
    ...
    if child_tags is not None:
        ...
        raise DeserializationError("ListUserTagsResponse.tags required")
