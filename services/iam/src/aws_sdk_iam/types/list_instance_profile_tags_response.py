"""Generated from Smithy shape ``com.amazonaws.iam#ListInstanceProfileTagsResponse``."""
...
class ListInstanceProfileTagsResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListInstanceProfileTagsResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
    import aws_sdk_iam.types.tag_list_type
...
def deserialize_query(el: Element) -> ListInstanceProfileTagsResponse:
    out: ListInstanceProfileTagsResponse = {}  # type: ignore[typeddict-item]
    ...
    if child_tags is not None:
        ...
        raise DeserializationError("ListInstanceProfileTagsResponse.tags required")
