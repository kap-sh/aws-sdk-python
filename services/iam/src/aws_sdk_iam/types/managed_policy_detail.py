...
class ManagedPolicyDetail(TypedDict):
...
def serialize_query(
    ...
    if "policy_version_list" in value:
        ...
        aws_sdk_iam.types.policy_document_version_list_type.serialize_query(
...
def deserialize_query(el: Element) -> ManagedPolicyDetail:
    ...
    if child_policy_version_list is not None:
        ...
        out["policy_version_list"] = (
            aws_sdk_iam.types.policy_document_version_list_type.deserialize_query(
