...
class ListVirtualMFADevicesResponse(TypedDict):
    virtual_mfa_devices: (
        "aws_sdk_iam.types.virtual_mfa_device_list_type.virtualMFADeviceListType"
    )
...
def serialize_query(
    ...
    aws_sdk_iam.types.virtual_mfa_device_list_type.serialize_query(
...
def deserialize_query(el: Element) -> ListVirtualMFADevicesResponse:
    ...
    if child_virtual_mfa_devices is not None:
        ...
        out["virtual_mfa_devices"] = (
            aws_sdk_iam.types.virtual_mfa_device_list_type.deserialize_query(
