"""Generated from Smithy shape ``com.amazonaws.iam#ListMFADevicesRequest``."""
...
class ListMFADevicesRequest(TypedDict, closed=True):
    user_name: NotRequired[
        "aws_sdk_iam.types.existing_user_name_type.existingUserNameType"
    ]
    r"""<p>The name of the user whose MFA devices you want to list.</p> <p>This parameter allows (through its <a href=\"http://wikipedia.org/wiki/regex\">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>"""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListMFADevicesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListMFADevicesRequest:
    out: ListMFADevicesRequest = {}  # type: ignore[typeddict-item]
