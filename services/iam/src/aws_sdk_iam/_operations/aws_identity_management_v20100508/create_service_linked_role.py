...
def handle_response(
    ...
    out: aws_sdk_iam.types.create_service_linked_role_response.CreateServiceLinkedRoleResponse = aws_sdk_iam.types.create_service_linked_role_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.create_service_linked_role_request.CreateServiceLinkedRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
