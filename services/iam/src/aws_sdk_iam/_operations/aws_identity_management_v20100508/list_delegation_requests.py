"""Generated from Smithy shape ``com.amazonaws.iam#ListDelegationRequests``."""
...
import aws_sdk_iam.types.delegation_requests_list_type
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListDelegationRequestsResult")
    out: aws_sdk_iam.types.list_delegation_requests_response.ListDelegationRequestsResponse = aws_sdk_iam.types.list_delegation_requests_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_delegation_requests_request.ListDelegationRequestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListDelegationRequests"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_delegation_requests_request

    aws_sdk_iam.types.list_delegation_requests_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_delegation_requests(
