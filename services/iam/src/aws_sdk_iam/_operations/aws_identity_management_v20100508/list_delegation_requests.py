...
def build_request(
    ...
    input: aws_sdk_iam.types.list_delegation_requests_request.ListDelegationRequestsRequest,
) -> zapros.Request:
    ...
    aws_sdk_iam.types.list_delegation_requests_request.serialize_query(input, pairs, "")
