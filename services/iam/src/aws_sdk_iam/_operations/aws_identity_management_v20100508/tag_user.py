...
def build_request(
    ...
    input_: aws_sdk_iam.types.tag_user_request.TagUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "TagUser"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.tag_user_request

    aws_sdk_iam.types.tag_user_request.serialize_query(input_, pairs, "")
...
def tag_user(
    options: OperationOptions, input_: aws_sdk_iam.types.tag_user_request.TagUserRequest
