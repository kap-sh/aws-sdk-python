...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetServerCertificateResult")
    out: aws_sdk_iam.types.get_server_certificate_response.GetServerCertificateResponse = aws_sdk_iam.types.get_server_certificate_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_server_certificate_request.GetServerCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetServerCertificate"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.get_server_certificate_request.serialize_query(input_, pairs, "")
