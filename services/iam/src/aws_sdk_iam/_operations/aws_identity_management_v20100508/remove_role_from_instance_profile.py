...
def build_request(
    ...
    input_: aws_sdk_iam.types.remove_role_from_instance_profile_request.RemoveRoleFromInstanceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RemoveRoleFromInstanceProfile"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.remove_role_from_instance_profile_request

    aws_sdk_iam.types.remove_role_from_instance_profile_request.serialize_query(
        input_, pairs, ""
    )
