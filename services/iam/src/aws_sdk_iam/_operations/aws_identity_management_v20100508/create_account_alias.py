...
def build_request(
    ...
    input_: aws_sdk_iam.types.create_account_alias_request.CreateAccountAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.create_account_alias_request.serialize_query(input_, pairs, "")
