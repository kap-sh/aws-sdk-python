"""Generated from Smithy shape ``com.amazonaws.iam#GetUserPolicy``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetUserPolicyResult")
    out: aws_sdk_iam.types.get_user_policy_response.GetUserPolicyResponse = (
        aws_sdk_iam.types.get_user_policy_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_user_policy_request.GetUserPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetUserPolicy"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.get_user_policy_request

    aws_sdk_iam.types.get_user_policy_request.serialize_query(input_, pairs, "")
...
def get_user_policy(
    ...
    aws_sdk_iam.types.get_user_policy_response.GetUserPolicyResponse, zapros.Response
]:
...
async def async_get_user_policy(
