...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListMFADeviceTagsResult")
    out: aws_sdk_iam.types.list_mfa_device_tags_response.ListMFADeviceTagsResponse = (
        aws_sdk_iam.types.list_mfa_device_tags_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_mfa_device_tags_request.ListMFADeviceTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListMFADeviceTags"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_mfa_device_tags_request

    aws_sdk_iam.types.list_mfa_device_tags_request.serialize_query(input_, pairs, "")
