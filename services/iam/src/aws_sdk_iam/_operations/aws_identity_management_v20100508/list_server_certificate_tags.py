...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListServerCertificateTagsResult")
    out: aws_sdk_iam.types.list_server_certificate_tags_response.ListServerCertificateTagsResponse = aws_sdk_iam.types.list_server_certificate_tags_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_server_certificate_tags_request.ListServerCertificateTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListServerCertificateTags"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_server_certificate_tags_request

    aws_sdk_iam.types.list_server_certificate_tags_request.serialize_query(
        input_, pairs, ""
    )
