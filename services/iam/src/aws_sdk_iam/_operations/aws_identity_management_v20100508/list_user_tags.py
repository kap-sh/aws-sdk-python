...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListUserTagsResult")
    out: aws_sdk_iam.types.list_user_tags_response.ListUserTagsResponse = (
        aws_sdk_iam.types.list_user_tags_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_user_tags_request.ListUserTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListUserTags"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_user_tags_request

    aws_sdk_iam.types.list_user_tags_request.serialize_query(input_, pairs, "")
