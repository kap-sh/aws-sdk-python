...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetOrganizationsAccessReportResult")
    out: aws_sdk_iam.types.get_organizations_access_report_response.GetOrganizationsAccessReportResponse = aws_sdk_iam.types.get_organizations_access_report_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_organizations_access_report_request.GetOrganizationsAccessReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetOrganizationsAccessReport"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.get_organizations_access_report_request

    aws_sdk_iam.types.get_organizations_access_report_request.serialize_query(
        input_, pairs, ""
    )
