...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListGroupsForUserResult")
    out: aws_sdk_iam.types.list_groups_for_user_response.ListGroupsForUserResponse = (
        aws_sdk_iam.types.list_groups_for_user_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_groups_for_user_request.ListGroupsForUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListGroupsForUser"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_groups_for_user_request

    aws_sdk_iam.types.list_groups_for_user_request.serialize_query(input_, pairs, "")
