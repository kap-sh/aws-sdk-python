"""Generated from Smithy shape ``com.amazonaws.iam#DeletePolicyVersion``."""
...
def build_request(
    ...
    input: aws_sdk_iam.types.delete_policy_version_request.DeletePolicyVersionRequest,
) -> zapros.Request:
    ...
    aws_sdk_iam.types.delete_policy_version_request.serialize_query(input, pairs, "")
