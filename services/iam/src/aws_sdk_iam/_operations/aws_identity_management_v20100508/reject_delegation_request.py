...
def build_request(
    ...
    input_: aws_sdk_iam.types.reject_delegation_request_request.RejectDelegationRequestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.reject_delegation_request_request.serialize_query(
        input_, pairs, ""
    )
