...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_role_policy_response.GetRolePolicyResponse = (
        aws_sdk_iam.types.get_role_policy_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_role_policy_request.GetRolePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.get_role_policy_request.serialize_query(input_, pairs, "")
...
def get_role_policy(
    ...
    aws_sdk_iam.types.get_role_policy_response.GetRolePolicyResponse, zapros.Response
]:
