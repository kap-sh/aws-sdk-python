...
def build_request(
    ...
    input_: aws_sdk_iam.types.detach_user_policy_request.DetachUserPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DetachUserPolicy"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.detach_user_policy_request

    aws_sdk_iam.types.detach_user_policy_request.serialize_query(input_, pairs, "")
