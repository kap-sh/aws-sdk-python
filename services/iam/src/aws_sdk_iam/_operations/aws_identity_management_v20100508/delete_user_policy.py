...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_user_policy_request.DeleteUserPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteUserPolicy"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.delete_user_policy_request

    aws_sdk_iam.types.delete_user_policy_request.serialize_query(input_, pairs, "")
