...
def handle_response(
    ...
    out: aws_sdk_iam.types.create_user_response.CreateUserResponse = (
        aws_sdk_iam.types.create_user_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.create_user_request.CreateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.create_user_request.serialize_query(input_, pairs, "")
