...
def build_request(
    ...
    input: aws_sdk_iam.types.send_delegation_token_request.SendDelegationTokenRequest,
) -> zapros.Request:
    ...
    aws_sdk_iam.types.send_delegation_token_request.serialize_query(input, pairs, "")
