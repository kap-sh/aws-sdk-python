...
def build_request(
    ...
    input_: aws_sdk_iam.types.send_delegation_token_request.SendDelegationTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.send_delegation_token_request.serialize_query(input_, pairs, "")
