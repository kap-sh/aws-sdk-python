...
def handle_response(
    ...
    out: aws_sdk_iam.types.create_group_response.CreateGroupResponse = (
        aws_sdk_iam.types.create_group_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.create_group_request.CreateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.create_group_request.serialize_query(input_, pairs, "")
