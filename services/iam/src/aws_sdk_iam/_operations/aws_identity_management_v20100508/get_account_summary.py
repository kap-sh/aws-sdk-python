...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetAccountSummaryResult")
    out: aws_sdk_iam.types.get_account_summary_response.GetAccountSummaryResponse = (
        aws_sdk_iam.types.get_account_summary_response.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "GetAccountSummary"))
