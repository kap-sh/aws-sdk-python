...
def build_request(
    ...
    input_: aws_sdk_iam.types.update_server_certificate_request.UpdateServerCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateServerCertificate"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.update_server_certificate_request

    aws_sdk_iam.types.update_server_certificate_request.serialize_query(
        input_, pairs, ""
    )
