...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_human_readable_summary_response.GetHumanReadableSummaryResponse = aws_sdk_iam.types.get_human_readable_summary_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_human_readable_summary_request.GetHumanReadableSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.get_human_readable_summary_request.serialize_query(
        input_, pairs, ""
    )
