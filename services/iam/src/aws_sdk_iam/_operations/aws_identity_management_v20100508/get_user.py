...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_user_response.GetUserResponse = (
        aws_sdk_iam.types.get_user_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_user_request.GetUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.get_user_request.serialize_query(input_, pairs, "")
...
def get_user(
    options: OperationOptions, input_: aws_sdk_iam.types.get_user_request.GetUserRequest
