...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_service_last_accessed_details_with_entities_response.GetServiceLastAccessedDetailsWithEntitiesResponse = aws_sdk_iam.types.get_service_last_accessed_details_with_entities_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_service_last_accessed_details_with_entities_request.GetServiceLastAccessedDetailsWithEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
