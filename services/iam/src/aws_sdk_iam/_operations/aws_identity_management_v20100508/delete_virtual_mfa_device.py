...
import aws_sdk_iam.errors.delete_conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DeleteConflictException":
            raise aws_sdk_iam.errors.delete_conflict_exception.DeleteConflictException.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_virtual_mfa_device_request.DeleteVirtualMFADeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.delete_virtual_mfa_device_request.serialize_query(
        input_, pairs, ""
    )
