"""Generated from Smithy shape ``com.amazonaws.iam#DeleteInstanceProfile``."""
...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_instance_profile_request.DeleteInstanceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteInstanceProfile"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.delete_instance_profile_request.serialize_query(input_, pairs, "")
