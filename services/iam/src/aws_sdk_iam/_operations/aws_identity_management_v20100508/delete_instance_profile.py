...
def build_request(
    ...
    input: aws_sdk_iam.types.delete_instance_profile_request.DeleteInstanceProfileRequest,
) -> zapros.Request:
    ...
    aws_sdk_iam.types.delete_instance_profile_request.serialize_query(input, pairs, "")
