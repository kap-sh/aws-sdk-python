...
def build_request(
    ...
    input_: aws_sdk_iam.types.detach_group_policy_request.DetachGroupPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DetachGroupPolicy"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.detach_group_policy_request.serialize_query(input_, pairs, "")
