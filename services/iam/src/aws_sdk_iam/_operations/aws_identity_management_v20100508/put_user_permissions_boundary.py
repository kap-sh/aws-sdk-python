...
def build_request(
    ...
    input_: aws_sdk_iam.types.put_user_permissions_boundary_request.PutUserPermissionsBoundaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "PutUserPermissionsBoundary"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.put_user_permissions_boundary_request.serialize_query(
        input_, pairs, ""
    )
