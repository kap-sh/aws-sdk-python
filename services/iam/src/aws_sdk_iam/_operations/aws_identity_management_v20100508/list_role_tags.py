...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListRoleTagsResult")
    out: aws_sdk_iam.types.list_role_tags_response.ListRoleTagsResponse = (
        aws_sdk_iam.types.list_role_tags_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_role_tags_request.ListRoleTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListRoleTags"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_role_tags_request

    aws_sdk_iam.types.list_role_tags_request.serialize_query(input_, pairs, "")
