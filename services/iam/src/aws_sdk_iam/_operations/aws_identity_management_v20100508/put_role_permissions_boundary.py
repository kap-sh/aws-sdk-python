...
def build_request(
    ...
    input_: aws_sdk_iam.types.put_role_permissions_boundary_request.PutRolePermissionsBoundaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "PutRolePermissionsBoundary"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.put_role_permissions_boundary_request

    aws_sdk_iam.types.put_role_permissions_boundary_request.serialize_query(
        input_, pairs, ""
    )
