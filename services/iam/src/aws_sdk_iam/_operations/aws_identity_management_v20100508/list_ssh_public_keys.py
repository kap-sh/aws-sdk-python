...
def handle_response(
    ...
    out: aws_sdk_iam.types.list_ssh_public_keys_response.ListSSHPublicKeysResponse = (
        aws_sdk_iam.types.list_ssh_public_keys_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_ssh_public_keys_request.ListSSHPublicKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.list_ssh_public_keys_request.serialize_query(input_, pairs, "")
