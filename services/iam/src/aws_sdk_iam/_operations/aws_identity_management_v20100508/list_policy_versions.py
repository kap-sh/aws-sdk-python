...
import aws_sdk_iam.types.policy_document_version_list_type
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListPolicyVersionsResult")
    out: aws_sdk_iam.types.list_policy_versions_response.ListPolicyVersionsResponse = (
        aws_sdk_iam.types.list_policy_versions_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_policy_versions_request.ListPolicyVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListPolicyVersions"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.list_policy_versions_request.serialize_query(input_, pairs, "")
