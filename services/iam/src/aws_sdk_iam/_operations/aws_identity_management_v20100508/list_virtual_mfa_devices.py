...
import aws_sdk_iam.types.virtual_mfa_device_list_type
...
def handle_response(
    ...
    out: aws_sdk_iam.types.list_virtual_mfa_devices_response.ListVirtualMFADevicesResponse = aws_sdk_iam.types.list_virtual_mfa_devices_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_virtual_mfa_devices_request.ListVirtualMFADevicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.list_virtual_mfa_devices_request.serialize_query(
        input_, pairs, ""
    )
