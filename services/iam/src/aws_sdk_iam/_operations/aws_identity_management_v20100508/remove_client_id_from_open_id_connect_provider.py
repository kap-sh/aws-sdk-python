"""Generated from Smithy shape ``com.amazonaws.iam#RemoveClientIDFromOpenIDConnectProvider``."""
...
def build_request(
    ...
    input_: aws_sdk_iam.types.remove_client_id_from_open_id_connect_provider_request.RemoveClientIDFromOpenIDConnectProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RemoveClientIDFromOpenIDConnectProvider"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.remove_client_id_from_open_id_connect_provider_request

    aws_sdk_iam.types.remove_client_id_from_open_id_connect_provider_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_remove_client_id_from_open_id_connect_provider(
