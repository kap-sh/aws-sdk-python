...
def handle_response(
    ...
    out: aws_sdk_iam.types.list_mfa_devices_response.ListMFADevicesResponse = (
        aws_sdk_iam.types.list_mfa_devices_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_mfa_devices_request.ListMFADevicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.list_mfa_devices_request.serialize_query(input_, pairs, "")
