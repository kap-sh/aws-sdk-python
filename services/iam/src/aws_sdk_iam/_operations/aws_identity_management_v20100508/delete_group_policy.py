"""Generated from Smithy shape ``com.amazonaws.iam#DeleteGroupPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_group_policy_request.DeleteGroupPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteGroupPolicy"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.delete_group_policy_request.serialize_query(input_, pairs, "")
...
async def async_delete_group_policy(
