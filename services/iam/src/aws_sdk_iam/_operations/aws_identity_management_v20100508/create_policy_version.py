...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreatePolicyVersionResult")
    out: aws_sdk_iam.types.create_policy_version_response.CreatePolicyVersionResponse = aws_sdk_iam.types.create_policy_version_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.create_policy_version_request.CreatePolicyVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreatePolicyVersion"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.create_policy_version_request.serialize_query(input_, pairs, "")
