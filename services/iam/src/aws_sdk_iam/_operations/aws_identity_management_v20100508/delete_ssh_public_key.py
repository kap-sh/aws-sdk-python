...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_ssh_public_key_request.DeleteSSHPublicKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteSSHPublicKey"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.delete_ssh_public_key_request

    aws_sdk_iam.types.delete_ssh_public_key_request.serialize_query(input_, pairs, "")
