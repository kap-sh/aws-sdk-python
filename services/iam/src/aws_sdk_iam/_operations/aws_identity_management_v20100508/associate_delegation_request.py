"""Generated from Smithy shape ``com.amazonaws.iam#AssociateDelegationRequest``."""
...
def build_request(
    ...
    input_: aws_sdk_iam.types.associate_delegation_request_request.AssociateDelegationRequestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AssociateDelegationRequest"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.associate_delegation_request_request

    aws_sdk_iam.types.associate_delegation_request_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_associate_delegation_request(
