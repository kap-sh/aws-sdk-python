...
def handle_response(
    ...
    out: aws_sdk_iam.types.list_instance_profile_tags_response.ListInstanceProfileTagsResponse = aws_sdk_iam.types.list_instance_profile_tags_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_instance_profile_tags_request.ListInstanceProfileTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.list_instance_profile_tags_request.serialize_query(
        input_, pairs, ""
    )
