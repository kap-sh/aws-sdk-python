...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_policy_response.GetPolicyResponse = (
        aws_sdk_iam.types.get_policy_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_policy_request.GetPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.get_policy_request.serialize_query(input_, pairs, "")
