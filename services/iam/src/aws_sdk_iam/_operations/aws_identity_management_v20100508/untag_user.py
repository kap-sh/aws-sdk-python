...
def build_request(
    ...
    input_: aws_sdk_iam.types.untag_user_request.UntagUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UntagUser"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.untag_user_request

    aws_sdk_iam.types.untag_user_request.serialize_query(input_, pairs, "")
