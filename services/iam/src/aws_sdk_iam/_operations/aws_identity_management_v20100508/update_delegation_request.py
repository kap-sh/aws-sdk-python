...
def build_request(
    ...
    input_: aws_sdk_iam.types.update_delegation_request_request.UpdateDelegationRequestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.update_delegation_request_request.serialize_query(
        input_, pairs, ""
    )
