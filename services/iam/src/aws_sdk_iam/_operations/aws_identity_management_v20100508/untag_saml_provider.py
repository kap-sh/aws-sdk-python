...
def build_request(
    ...
    input_: aws_sdk_iam.types.untag_saml_provider_request.UntagSAMLProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.untag_saml_provider_request.serialize_query(input_, pairs, "")
