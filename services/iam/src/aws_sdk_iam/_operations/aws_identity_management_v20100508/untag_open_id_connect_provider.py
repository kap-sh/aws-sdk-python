...
def build_request(
    ...
    input_: aws_sdk_iam.types.untag_open_id_connect_provider_request.UntagOpenIDConnectProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UntagOpenIDConnectProvider"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.untag_open_id_connect_provider_request.serialize_query(
        input_, pairs, ""
    )
