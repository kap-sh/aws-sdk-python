...
def build_request(
    ...
    input_: aws_sdk_iam.types.untag_instance_profile_request.UntagInstanceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.untag_instance_profile_request.serialize_query(input_, pairs, "")
