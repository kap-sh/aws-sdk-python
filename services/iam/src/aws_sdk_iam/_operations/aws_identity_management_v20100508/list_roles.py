...
def handle_response(
    ...
    out: aws_sdk_iam.types.list_roles_response.ListRolesResponse = (
        aws_sdk_iam.types.list_roles_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_roles_request.ListRolesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.list_roles_request.serialize_query(input_, pairs, "")
