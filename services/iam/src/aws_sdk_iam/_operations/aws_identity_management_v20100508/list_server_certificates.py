...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListServerCertificatesResult")
    out: aws_sdk_iam.types.list_server_certificates_response.ListServerCertificatesResponse = aws_sdk_iam.types.list_server_certificates_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_server_certificates_request.ListServerCertificatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListServerCertificates"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.list_server_certificates_request.serialize_query(
        input_, pairs, ""
    )
