"""Generated from Smithy shape ``com.amazonaws.iam#DeleteRole``."""
...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_role_request.DeleteRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteRole"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.delete_role_request

    aws_sdk_iam.types.delete_role_request.serialize_query(input_, pairs, "")
