...
def handle_response(
    ...
    out: aws_sdk_iam.types.list_service_specific_credentials_response.ListServiceSpecificCredentialsResponse = aws_sdk_iam.types.list_service_specific_credentials_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_service_specific_credentials_request.ListServiceSpecificCredentialsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.list_service_specific_credentials_request.serialize_query(
        input_, pairs, ""
    )
