...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_open_id_connect_provider_response.GetOpenIDConnectProviderResponse = aws_sdk_iam.types.get_open_id_connect_provider_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_open_id_connect_provider_request.GetOpenIDConnectProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.get_open_id_connect_provider_request.serialize_query(
        input_, pairs, ""
    )
