...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_account_alias_request.DeleteAccountAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteAccountAlias"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.delete_account_alias_request

    aws_sdk_iam.types.delete_account_alias_request.serialize_query(input_, pairs, "")
