...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListPolicyTagsResult")
    out: aws_sdk_iam.types.list_policy_tags_response.ListPolicyTagsResponse = (
        aws_sdk_iam.types.list_policy_tags_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_policy_tags_request.ListPolicyTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
