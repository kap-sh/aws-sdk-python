...
def handle_response(
    ...
    out: aws_sdk_iam.types.create_login_profile_response.CreateLoginProfileResponse = (
        aws_sdk_iam.types.create_login_profile_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.create_login_profile_request.CreateLoginProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.create_login_profile_request.serialize_query(input_, pairs, "")
