...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_role_permissions_boundary_request.DeleteRolePermissionsBoundaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteRolePermissionsBoundary"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.delete_role_permissions_boundary_request

    aws_sdk_iam.types.delete_role_permissions_boundary_request.serialize_query(
        input_, pairs, ""
    )
