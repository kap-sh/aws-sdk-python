...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListSAMLProvidersResult")
    out: aws_sdk_iam.types.list_saml_providers_response.ListSAMLProvidersResponse = (
        aws_sdk_iam.types.list_saml_providers_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_saml_providers_request.ListSAMLProvidersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListSAMLProviders"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_saml_providers_request

    aws_sdk_iam.types.list_saml_providers_request.serialize_query(input_, pairs, "")
