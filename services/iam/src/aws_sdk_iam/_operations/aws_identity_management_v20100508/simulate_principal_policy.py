"""Generated from Smithy shape ``com.amazonaws.iam#SimulatePrincipalPolicy``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyEvaluationException":
            import aws_sdk_iam.errors.policy_evaluation_exception

            raise aws_sdk_iam.errors.policy_evaluation_exception.PolicyEvaluationException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SimulatePrincipalPolicyResult")
    out: aws_sdk_iam.types.simulate_policy_response.SimulatePolicyResponse = (
        aws_sdk_iam.types.simulate_policy_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.simulate_principal_policy_request.SimulatePrincipalPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_simulate_principal_policy(
