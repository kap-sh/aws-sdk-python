"""Generated from Smithy shape ``com.amazonaws.iam#UploadSigningCertificate``."""
...
def build_request(
    ...
    input_: aws_sdk_iam.types.upload_signing_certificate_request.UploadSigningCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UploadSigningCertificate"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.upload_signing_certificate_request

    aws_sdk_iam.types.upload_signing_certificate_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_upload_signing_certificate(
