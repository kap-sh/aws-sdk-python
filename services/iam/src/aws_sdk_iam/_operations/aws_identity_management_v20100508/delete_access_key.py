...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_access_key_request.DeleteAccessKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteAccessKey"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.delete_access_key_request.serialize_query(input_, pairs, "")
