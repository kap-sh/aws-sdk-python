...
def build_request(
    ...
    input_: aws_sdk_iam.types.update_assume_role_policy_request.UpdateAssumeRolePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateAssumeRolePolicy"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.update_assume_role_policy_request

    aws_sdk_iam.types.update_assume_role_policy_request.serialize_query(
        input_, pairs, ""
    )
