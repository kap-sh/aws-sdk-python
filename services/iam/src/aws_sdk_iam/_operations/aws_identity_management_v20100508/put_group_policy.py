...
def build_request(
    ...
    input_: aws_sdk_iam.types.put_group_policy_request.PutGroupPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "PutGroupPolicy"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.put_group_policy_request

    aws_sdk_iam.types.put_group_policy_request.serialize_query(input_, pairs, "")
