...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListAttachedRolePoliciesResult")
    out: aws_sdk_iam.types.list_attached_role_policies_response.ListAttachedRolePoliciesResponse = aws_sdk_iam.types.list_attached_role_policies_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_attached_role_policies_request.ListAttachedRolePoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListAttachedRolePolicies"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_attached_role_policies_request

    aws_sdk_iam.types.list_attached_role_policies_request.serialize_query(
        input_, pairs, ""
    )
