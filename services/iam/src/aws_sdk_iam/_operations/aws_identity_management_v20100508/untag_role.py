...
def build_request(
    ...
    input_: aws_sdk_iam.types.untag_role_request.UntagRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UntagRole"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.untag_role_request

    aws_sdk_iam.types.untag_role_request.serialize_query(input_, pairs, "")
