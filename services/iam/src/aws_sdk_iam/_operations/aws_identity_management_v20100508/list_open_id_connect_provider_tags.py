...
def handle_response(
    ...
    out: aws_sdk_iam.types.list_open_id_connect_provider_tags_response.ListOpenIDConnectProviderTagsResponse = aws_sdk_iam.types.list_open_id_connect_provider_tags_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_open_id_connect_provider_tags_request.ListOpenIDConnectProviderTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.list_open_id_connect_provider_tags_request.serialize_query(
        input_, pairs, ""
    )
