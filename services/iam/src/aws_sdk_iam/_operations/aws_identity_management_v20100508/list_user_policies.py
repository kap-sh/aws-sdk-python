...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListUserPoliciesResult")
    out: aws_sdk_iam.types.list_user_policies_response.ListUserPoliciesResponse = (
        aws_sdk_iam.types.list_user_policies_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_user_policies_request.ListUserPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListUserPolicies"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_user_policies_request

    aws_sdk_iam.types.list_user_policies_request.serialize_query(input_, pairs, "")
