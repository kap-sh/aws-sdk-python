...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdateSAMLProviderResult")
    out: aws_sdk_iam.types.update_saml_provider_response.UpdateSAMLProviderResponse = (
        aws_sdk_iam.types.update_saml_provider_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.update_saml_provider_request.UpdateSAMLProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateSAMLProvider"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.update_saml_provider_request

    aws_sdk_iam.types.update_saml_provider_request.serialize_query(input_, pairs, "")
