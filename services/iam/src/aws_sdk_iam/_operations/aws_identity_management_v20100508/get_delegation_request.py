...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetDelegationRequestResult")
    out: aws_sdk_iam.types.get_delegation_request_response.GetDelegationRequestResponse = aws_sdk_iam.types.get_delegation_request_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_delegation_request_request.GetDelegationRequestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetDelegationRequest"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.get_delegation_request_request

    aws_sdk_iam.types.get_delegation_request_request.serialize_query(input_, pairs, "")
