...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceNotSupportedException":
            import aws_sdk_iam.errors.service_not_supported_exception

            raise aws_sdk_iam.errors.service_not_supported_exception.ServiceNotSupportedException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_iam.types.create_service_specific_credential_response.CreateServiceSpecificCredentialResponse = aws_sdk_iam.types.create_service_specific_credential_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.create_service_specific_credential_request.CreateServiceSpecificCredentialRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.create_service_specific_credential_request.serialize_query(
        input_, pairs, ""
    )
