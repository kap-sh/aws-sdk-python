...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdateRoleDescriptionResult")
    out: aws_sdk_iam.types.update_role_description_response.UpdateRoleDescriptionResponse = aws_sdk_iam.types.update_role_description_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.update_role_description_request.UpdateRoleDescriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateRoleDescription"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.update_role_description_request

    aws_sdk_iam.types.update_role_description_request.serialize_query(input_, pairs, "")
