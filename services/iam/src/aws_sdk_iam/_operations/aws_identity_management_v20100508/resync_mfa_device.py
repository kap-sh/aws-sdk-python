...
def build_request(
    ...
    input_: aws_sdk_iam.types.resync_mfa_device_request.ResyncMFADeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ResyncMFADevice"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.resync_mfa_device_request

    aws_sdk_iam.types.resync_mfa_device_request.serialize_query(input_, pairs, "")
