...
import aws_sdk_iam.types.group_detail_list_type
import aws_sdk_iam.types.managed_policy_detail_list_type
import aws_sdk_iam.types.role_detail_list_type
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetAccountAuthorizationDetailsResult")
    out: aws_sdk_iam.types.get_account_authorization_details_response.GetAccountAuthorizationDetailsResponse = aws_sdk_iam.types.get_account_authorization_details_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_account_authorization_details_request.GetAccountAuthorizationDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetAccountAuthorizationDetails"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.get_account_authorization_details_request.serialize_query(
        input_, pairs, ""
    )
