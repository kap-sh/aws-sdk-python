...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_role_response.GetRoleResponse = (
        aws_sdk_iam.types.get_role_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_role_request.GetRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.get_role_request.serialize_query(input_, pairs, "")
...
def get_role(
    options: OperationOptions, input_: aws_sdk_iam.types.get_role_request.GetRoleRequest
