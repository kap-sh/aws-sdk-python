...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_ssh_public_key_response.GetSSHPublicKeyResponse = (
        aws_sdk_iam.types.get_ssh_public_key_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_ssh_public_key_request.GetSSHPublicKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.get_ssh_public_key_request.serialize_query(input_, pairs, "")
