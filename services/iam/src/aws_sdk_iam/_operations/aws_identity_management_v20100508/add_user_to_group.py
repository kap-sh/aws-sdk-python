...
def build_request(
    ...
    input_: aws_sdk_iam.types.add_user_to_group_request.AddUserToGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AddUserToGroup"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.add_user_to_group_request

    aws_sdk_iam.types.add_user_to_group_request.serialize_query(input_, pairs, "")
