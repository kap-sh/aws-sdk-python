...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetAccountPasswordPolicyResult")
    out: aws_sdk_iam.types.get_account_password_policy_response.GetAccountPasswordPolicyResponse = aws_sdk_iam.types.get_account_password_policy_response.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "GetAccountPasswordPolicy"))
