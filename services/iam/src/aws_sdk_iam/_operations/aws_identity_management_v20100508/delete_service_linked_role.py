...
def handle_response(
    ...
    out: aws_sdk_iam.types.delete_service_linked_role_response.DeleteServiceLinkedRoleResponse = aws_sdk_iam.types.delete_service_linked_role_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_service_linked_role_request.DeleteServiceLinkedRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.delete_service_linked_role_request.serialize_query(
        input_, pairs, ""
    )
