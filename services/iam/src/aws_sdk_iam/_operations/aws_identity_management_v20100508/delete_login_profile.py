...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_login_profile_request.DeleteLoginProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteLoginProfile"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.delete_login_profile_request

    aws_sdk_iam.types.delete_login_profile_request.serialize_query(input_, pairs, "")
