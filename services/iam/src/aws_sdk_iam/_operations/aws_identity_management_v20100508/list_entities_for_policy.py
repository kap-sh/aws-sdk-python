...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListEntitiesForPolicyResult")
    out: aws_sdk_iam.types.list_entities_for_policy_response.ListEntitiesForPolicyResponse = aws_sdk_iam.types.list_entities_for_policy_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_entities_for_policy_request.ListEntitiesForPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
