...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListAccountAliasesResult")
    out: aws_sdk_iam.types.list_account_aliases_response.ListAccountAliasesResponse = (
        aws_sdk_iam.types.list_account_aliases_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_account_aliases_request.ListAccountAliasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListAccountAliases"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.list_account_aliases_request.serialize_query(input_, pairs, "")
