...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_policy_version_response.GetPolicyVersionResponse = (
        aws_sdk_iam.types.get_policy_version_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_policy_version_request.GetPolicyVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.get_policy_version_request.serialize_query(input_, pairs, "")
