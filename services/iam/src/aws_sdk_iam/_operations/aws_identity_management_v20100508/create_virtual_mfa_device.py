...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateVirtualMFADeviceResult")
    out: aws_sdk_iam.types.create_virtual_mfa_device_response.CreateVirtualMFADeviceResponse = aws_sdk_iam.types.create_virtual_mfa_device_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.create_virtual_mfa_device_request.CreateVirtualMFADeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
