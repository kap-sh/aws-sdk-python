...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListInstanceProfilesForRoleResult")
    out: aws_sdk_iam.types.list_instance_profiles_for_role_response.ListInstanceProfilesForRoleResponse = aws_sdk_iam.types.list_instance_profiles_for_role_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_instance_profiles_for_role_request.ListInstanceProfilesForRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListInstanceProfilesForRole"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_instance_profiles_for_role_request

    aws_sdk_iam.types.list_instance_profiles_for_role_request.serialize_query(
        input_, pairs, ""
    )
