...
def build_request(
    ...
    input: aws_sdk_iam.types.list_saml_provider_tags_request.ListSAMLProviderTagsRequest,
) -> zapros.Request:
    ...
    aws_sdk_iam.types.list_saml_provider_tags_request.serialize_query(input, pairs, "")
