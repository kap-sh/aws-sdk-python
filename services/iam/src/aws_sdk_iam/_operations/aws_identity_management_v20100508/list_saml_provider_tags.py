"""Generated from Smithy shape ``com.amazonaws.iam#ListSAMLProviderTags``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListSAMLProviderTagsResult")
    out: aws_sdk_iam.types.list_saml_provider_tags_response.ListSAMLProviderTagsResponse = aws_sdk_iam.types.list_saml_provider_tags_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_saml_provider_tags_request.ListSAMLProviderTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListSAMLProviderTags"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_saml_provider_tags_request

    aws_sdk_iam.types.list_saml_provider_tags_request.serialize_query(input_, pairs, "")
...
async def async_list_saml_provider_tags(
