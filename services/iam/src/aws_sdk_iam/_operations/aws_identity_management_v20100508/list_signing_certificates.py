"""Generated from Smithy shape ``com.amazonaws.iam#ListSigningCertificates``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListSigningCertificatesResult")
    out: aws_sdk_iam.types.list_signing_certificates_response.ListSigningCertificatesResponse = aws_sdk_iam.types.list_signing_certificates_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_signing_certificates_request.ListSigningCertificatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListSigningCertificates"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_signing_certificates_request

    aws_sdk_iam.types.list_signing_certificates_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_signing_certificates(
