...
def handle_response(
    ...
    out: aws_sdk_iam.types.list_groups_response.ListGroupsResponse = (
        aws_sdk_iam.types.list_groups_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_groups_request.ListGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.list_groups_request.serialize_query(input_, pairs, "")
