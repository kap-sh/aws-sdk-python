...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidAuthenticationCodeException":
            import aws_sdk_iam.errors.invalid_authentication_code_exception

            raise aws_sdk_iam.errors.invalid_authentication_code_exception.InvalidAuthenticationCodeException.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_iam.types.enable_mfa_device_request.EnableMFADeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "EnableMFADevice"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.enable_mfa_device_request

    aws_sdk_iam.types.enable_mfa_device_request.serialize_query(input_, pairs, "")
