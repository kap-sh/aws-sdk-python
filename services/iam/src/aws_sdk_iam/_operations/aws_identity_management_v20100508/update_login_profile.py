...
def build_request(
    ...
    input: aws_sdk_iam.types.update_login_profile_request.UpdateLoginProfileRequest,
) -> zapros.Request:
    ...
    aws_sdk_iam.types.update_login_profile_request.serialize_query(input, pairs, "")
