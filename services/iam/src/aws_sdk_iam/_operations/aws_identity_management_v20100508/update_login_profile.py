"""Generated from Smithy shape ``com.amazonaws.iam#UpdateLoginProfile``."""
...
def build_request(
    ...
    input_: aws_sdk_iam.types.update_login_profile_request.UpdateLoginProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateLoginProfile"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.update_login_profile_request.serialize_query(input_, pairs, "")
...
async def async_update_login_profile(
