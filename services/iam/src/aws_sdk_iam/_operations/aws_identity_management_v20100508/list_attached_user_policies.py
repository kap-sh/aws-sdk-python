"""Generated from Smithy shape ``com.amazonaws.iam#ListAttachedUserPolicies``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListAttachedUserPoliciesResult")
    out: aws_sdk_iam.types.list_attached_user_policies_response.ListAttachedUserPoliciesResponse = aws_sdk_iam.types.list_attached_user_policies_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_attached_user_policies_request.ListAttachedUserPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListAttachedUserPolicies"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_attached_user_policies_request

    aws_sdk_iam.types.list_attached_user_policies_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_attached_user_policies(
