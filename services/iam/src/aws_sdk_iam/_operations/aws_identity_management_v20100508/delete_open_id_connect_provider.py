"""Generated from Smithy shape ``com.amazonaws.iam#DeleteOpenIDConnectProvider``."""
...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_open_id_connect_provider_request.DeleteOpenIDConnectProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteOpenIDConnectProvider"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.delete_open_id_connect_provider_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_open_id_connect_provider(
