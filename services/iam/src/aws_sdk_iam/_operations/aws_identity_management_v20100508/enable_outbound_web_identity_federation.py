...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "FeatureEnabledException":
            import aws_sdk_iam.errors.feature_enabled_exception

            raise aws_sdk_iam.errors.feature_enabled_exception.FeatureEnabledException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_iam.types.enable_outbound_web_identity_federation_response.EnableOutboundWebIdentityFederationResponse = aws_sdk_iam.types.enable_outbound_web_identity_federation_response.deserialize_query(
