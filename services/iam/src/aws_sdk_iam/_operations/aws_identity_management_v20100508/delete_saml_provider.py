...
def build_request(
    ...
    input_: aws_sdk_iam.types.delete_saml_provider_request.DeleteSAMLProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteSAMLProvider"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.delete_saml_provider_request

    aws_sdk_iam.types.delete_saml_provider_request.serialize_query(input_, pairs, "")
