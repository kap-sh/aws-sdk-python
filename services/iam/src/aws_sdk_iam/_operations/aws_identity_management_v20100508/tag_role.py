...
def build_request(
    ...
    input_: aws_sdk_iam.types.tag_role_request.TagRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.tag_role_request.serialize_query(input_, pairs, "")
...
def tag_role(
    options: OperationOptions, input_: aws_sdk_iam.types.tag_role_request.TagRoleRequest
