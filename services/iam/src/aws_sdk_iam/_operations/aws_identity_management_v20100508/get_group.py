...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_group_response.GetGroupResponse = (
        aws_sdk_iam.types.get_group_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_group_request.GetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.get_group_request.serialize_query(input_, pairs, "")
