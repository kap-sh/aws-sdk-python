"""Generated from Smithy shape ``com.amazonaws.iam#UpdateAccessKey``."""
...
def build_request(
    ...
    input_: aws_sdk_iam.types.update_access_key_request.UpdateAccessKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateAccessKey"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.update_access_key_request

    aws_sdk_iam.types.update_access_key_request.serialize_query(input_, pairs, "")
...
async def async_update_access_key(
