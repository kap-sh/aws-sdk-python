...
def handle_response(
    ...
    out: aws_sdk_iam.types.get_mfa_device_response.GetMFADeviceResponse = (
        aws_sdk_iam.types.get_mfa_device_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_mfa_device_request.GetMFADeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.get_mfa_device_request.serialize_query(input_, pairs, "")
...
def get_mfa_device(
    ...
    aws_sdk_iam.types.get_mfa_device_response.GetMFADeviceResponse, zapros.Response
]:
