...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetInstanceProfileResult")
    out: aws_sdk_iam.types.get_instance_profile_response.GetInstanceProfileResponse = (
        aws_sdk_iam.types.get_instance_profile_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.get_instance_profile_request.GetInstanceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetInstanceProfile"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.get_instance_profile_request.serialize_query(input_, pairs, "")
