...
def handle_response(
    ...
    out: aws_sdk_iam.types.list_instance_profiles_response.ListInstanceProfilesResponse = aws_sdk_iam.types.list_instance_profiles_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_instance_profiles_request.ListInstanceProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.list_instance_profiles_request.serialize_query(input_, pairs, "")
