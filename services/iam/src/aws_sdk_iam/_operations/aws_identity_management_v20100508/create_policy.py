"""Generated from Smithy shape ``com.amazonaws.iam#CreatePolicy``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreatePolicyResult")
    out: aws_sdk_iam.types.create_policy_response.CreatePolicyResponse = (
        aws_sdk_iam.types.create_policy_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.create_policy_request.CreatePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreatePolicy"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.create_policy_request.serialize_query(input_, pairs, "")
...
def create_policy(
    ...
    aws_sdk_iam.types.create_policy_response.CreatePolicyResponse, zapros.Response
]:
