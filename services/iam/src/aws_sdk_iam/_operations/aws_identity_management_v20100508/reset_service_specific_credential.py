...
def build_request(
    ...
    input_: aws_sdk_iam.types.reset_service_specific_credential_request.ResetServiceSpecificCredentialRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ResetServiceSpecificCredential"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.reset_service_specific_credential_request

    aws_sdk_iam.types.reset_service_specific_credential_request.serialize_query(
        input_, pairs, ""
    )
