...
def handle_response(
    ...
    out: aws_sdk_iam.types.update_role_response.UpdateRoleResponse = (
        aws_sdk_iam.types.update_role_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.update_role_request.UpdateRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.update_role_request.serialize_query(input_, pairs, "")
