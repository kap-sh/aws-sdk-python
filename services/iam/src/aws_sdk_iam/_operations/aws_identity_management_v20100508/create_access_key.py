...
def handle_response(
    ...
    out: aws_sdk_iam.types.create_access_key_response.CreateAccessKeyResponse = (
        aws_sdk_iam.types.create_access_key_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.create_access_key_request.CreateAccessKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.create_access_key_request.serialize_query(input_, pairs, "")
