...
def build_request(
    ...
    input_: aws_sdk_iam.types.simulate_custom_policy_request.SimulateCustomPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.simulate_custom_policy_request.serialize_query(input_, pairs, "")
