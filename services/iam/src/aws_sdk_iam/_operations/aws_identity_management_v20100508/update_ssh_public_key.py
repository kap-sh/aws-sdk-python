...
def build_request(
    ...
    input_: aws_sdk_iam.types.update_ssh_public_key_request.UpdateSSHPublicKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateSSHPublicKey"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.update_ssh_public_key_request

    aws_sdk_iam.types.update_ssh_public_key_request.serialize_query(input_, pairs, "")
