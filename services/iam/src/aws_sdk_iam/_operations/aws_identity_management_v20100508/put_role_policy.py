...
def build_request(
    ...
    input_: aws_sdk_iam.types.put_role_policy_request.PutRolePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "PutRolePolicy"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.put_role_policy_request

    aws_sdk_iam.types.put_role_policy_request.serialize_query(input_, pairs, "")
