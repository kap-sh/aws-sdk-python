...
def build_request(
    ...
    input_: aws_sdk_iam.types.attach_group_policy_request.AttachGroupPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.attach_group_policy_request.serialize_query(input_, pairs, "")
