...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListAccessKeysResult")
    out: aws_sdk_iam.types.list_access_keys_response.ListAccessKeysResponse = (
        aws_sdk_iam.types.list_access_keys_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_access_keys_request.ListAccessKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListAccessKeys"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.list_access_keys_request

    aws_sdk_iam.types.list_access_keys_request.serialize_query(input_, pairs, "")
