...
def build_request(
    ...
    input_: aws_sdk_iam.types.tag_server_certificate_request.TagServerCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.tag_server_certificate_request.serialize_query(input_, pairs, "")
