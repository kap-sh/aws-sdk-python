"""Generated from Smithy shape ``com.amazonaws.iam#ListAttachedGroupPolicies``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListAttachedGroupPoliciesResult")
    out: aws_sdk_iam.types.list_attached_group_policies_response.ListAttachedGroupPoliciesResponse = aws_sdk_iam.types.list_attached_group_policies_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_attached_group_policies_request.ListAttachedGroupPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListAttachedGroupPolicies"))
    pairs.append(("Version", "2010-05-08"))
    aws_sdk_iam.types.list_attached_group_policies_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_attached_group_policies(
