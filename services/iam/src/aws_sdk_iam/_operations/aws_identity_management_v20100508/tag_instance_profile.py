...
def build_request(
    ...
    input_: aws_sdk_iam.types.tag_instance_profile_request.TagInstanceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "TagInstanceProfile"))
    pairs.append(("Version", "2010-05-08"))
    import aws_sdk_iam.types.tag_instance_profile_request

    aws_sdk_iam.types.tag_instance_profile_request.serialize_query(input_, pairs, "")
