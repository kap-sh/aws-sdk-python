...
def handle_response(
    ...
    out: aws_sdk_iam.types.list_role_policies_response.ListRolePoliciesResponse = (
        aws_sdk_iam.types.list_role_policies_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_iam.types.list_role_policies_request.ListRolePoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_iam.types.list_role_policies_request.serialize_query(input_, pairs, "")
