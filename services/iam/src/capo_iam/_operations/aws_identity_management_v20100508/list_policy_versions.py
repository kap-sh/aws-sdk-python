...
def handle_response(
    ...
    out: capo_iam.types.list_policy_versions_response.ListPolicyVersionsResponse = (
        capo_iam.types.list_policy_versions_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_policy_versions_request.serialize_query(input_, pairs, "")
