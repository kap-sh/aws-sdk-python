...
def handle_response(
    ...
    out: capo_iam.types.update_role_description_response.UpdateRoleDescriptionResponse = capo_iam.types.update_role_description_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.update_role_description_request.serialize_query(input_, pairs, "")
