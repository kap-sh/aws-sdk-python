...
def handle_response(
    ...
    out: capo_iam.types.list_policies_response.ListPoliciesResponse = (
        capo_iam.types.list_policies_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_policies_request.serialize_query(input_, pairs, "")
...
def list_policies(
    ...
    input_: capo_iam.types.list_policies_request.ListPoliciesRequest,
) -> tuple[capo_iam.types.list_policies_response.ListPoliciesResponse, zapros.Response]:
