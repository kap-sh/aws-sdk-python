...
def handle_response(
    ...
    out: capo_iam.types.list_users_response.ListUsersResponse = (
        capo_iam.types.list_users_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_users_request.serialize_query(input_, pairs, "")
...
def list_users(
    ...
    input_: capo_iam.types.list_users_request.ListUsersRequest,
) -> tuple[capo_iam.types.list_users_response.ListUsersResponse, zapros.Response]:
