...
def handle_response(
    ...
    out: capo_iam.types.list_entities_for_policy_response.ListEntitiesForPolicyResponse = capo_iam.types.list_entities_for_policy_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_entities_for_policy_request.serialize_query(input_, pairs, "")
