...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ReportGenerationLimitExceeded":
            raise capo_iam.errors.report_generation_limit_exceeded_exception.ReportGenerationLimitExceededException.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_iam.types.generate_organizations_access_report_response.GenerateOrganizationsAccessReportResponse = capo_iam.types.generate_organizations_access_report_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.generate_organizations_access_report_request.serialize_query(
        input_, pairs, ""
    )
