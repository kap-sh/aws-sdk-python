"""Generated from Smithy shape ``com.amazonaws.iam#GetRolePolicy``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetRolePolicyResult")
    out: capo_iam.types.get_role_policy_response.GetRolePolicyResponse = (
        capo_iam.types.get_role_policy_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetRolePolicy"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.get_role_policy_request.serialize_query(input_, pairs, "")
...
def get_role_policy(
    ...
    capo_iam.types.get_role_policy_response.GetRolePolicyResponse, zapros.Response
]:
...
async def async_get_role_policy(
