...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetSSHPublicKeyResult")
    out: capo_iam.types.get_ssh_public_key_response.GetSSHPublicKeyResponse = (
        capo_iam.types.get_ssh_public_key_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetSSHPublicKey"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.get_ssh_public_key_request.serialize_query(input_, pairs, "")
...
def get_ssh_public_key(
    ...
    capo_iam.types.get_ssh_public_key_response.GetSSHPublicKeyResponse, zapros.Response
]:
