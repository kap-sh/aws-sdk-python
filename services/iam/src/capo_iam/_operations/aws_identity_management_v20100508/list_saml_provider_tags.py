...
def handle_response(
    ...
    out: capo_iam.types.list_saml_provider_tags_response.ListSAMLProviderTagsResponse = capo_iam.types.list_saml_provider_tags_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_saml_provider_tags_request.serialize_query(input_, pairs, "")
