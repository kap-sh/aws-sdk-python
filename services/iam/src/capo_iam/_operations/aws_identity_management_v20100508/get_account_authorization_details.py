...
def handle_response(
    ...
    out: capo_iam.types.get_account_authorization_details_response.GetAccountAuthorizationDetailsResponse = capo_iam.types.get_account_authorization_details_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_account_authorization_details_request.serialize_query(
        input_, pairs, ""
    )
