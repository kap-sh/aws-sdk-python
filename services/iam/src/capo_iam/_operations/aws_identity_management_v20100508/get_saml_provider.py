...
def handle_response(
    ...
    out: capo_iam.types.get_saml_provider_response.GetSAMLProviderResponse = (
        capo_iam.types.get_saml_provider_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_saml_provider_request.serialize_query(input_, pairs, "")
...
def get_saml_provider(
    ...
    capo_iam.types.get_saml_provider_response.GetSAMLProviderResponse, zapros.Response
]:
