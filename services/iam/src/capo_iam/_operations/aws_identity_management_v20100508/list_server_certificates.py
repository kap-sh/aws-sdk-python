...
def handle_response(
    ...
    out: capo_iam.types.list_server_certificates_response.ListServerCertificatesResponse = capo_iam.types.list_server_certificates_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_server_certificates_request.serialize_query(input_, pairs, "")
