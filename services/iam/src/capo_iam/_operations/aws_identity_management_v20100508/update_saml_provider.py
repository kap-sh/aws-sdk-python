...
def handle_response(
    ...
    out: capo_iam.types.update_saml_provider_response.UpdateSAMLProviderResponse = (
        capo_iam.types.update_saml_provider_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.update_saml_provider_request.serialize_query(input_, pairs, "")
