"""Generated from Smithy shape ``com.amazonaws.iam#GetRoleTemplateVersion``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetRoleTemplateVersionResult")
    out: capo_iam.types.get_role_template_version_response.GetRoleTemplateVersionResponse = capo_iam.types.get_role_template_version_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetRoleTemplateVersion"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.get_role_template_version_request.serialize_query(input_, pairs, "")
...
async def async_get_role_template_version(
