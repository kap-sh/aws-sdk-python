...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListSSHPublicKeysResult")
    out: capo_iam.types.list_ssh_public_keys_response.ListSSHPublicKeysResponse = (
        capo_iam.types.list_ssh_public_keys_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListSSHPublicKeys"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.list_ssh_public_keys_request.serialize_query(input_, pairs, "")
