...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetHumanReadableSummaryResult")
    out: capo_iam.types.get_human_readable_summary_response.GetHumanReadableSummaryResponse = capo_iam.types.get_human_readable_summary_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetHumanReadableSummary"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.get_human_readable_summary_request.serialize_query(input_, pairs, "")
