...
def handle_response(
    ...
    out: capo_iam.types.list_server_certificate_tags_response.ListServerCertificateTagsResponse = capo_iam.types.list_server_certificate_tags_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_server_certificate_tags_request.serialize_query(
        input_, pairs, ""
    )
