...
def handle_response(
    ...
    out: capo_iam.types.get_delegation_request_response.GetDelegationRequestResponse = (
        capo_iam.types.get_delegation_request_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_delegation_request_request.serialize_query(input_, pairs, "")
