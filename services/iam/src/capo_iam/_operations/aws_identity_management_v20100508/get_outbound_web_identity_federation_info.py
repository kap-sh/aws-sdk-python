...
def handle_response(
    ...
    out: capo_iam.types.get_outbound_web_identity_federation_info_response.GetOutboundWebIdentityFederationInfoResponse = capo_iam.types.get_outbound_web_identity_federation_info_response.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "GetOutboundWebIdentityFederationInfo"))
