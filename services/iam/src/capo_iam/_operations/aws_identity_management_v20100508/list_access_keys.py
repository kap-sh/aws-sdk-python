...
def handle_response(
    ...
    out: capo_iam.types.list_access_keys_response.ListAccessKeysResponse = (
        capo_iam.types.list_access_keys_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_access_keys_request.serialize_query(input_, pairs, "")
...
def list_access_keys(
    ...
    capo_iam.types.list_access_keys_response.ListAccessKeysResponse, zapros.Response
]:
