...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdateRoleResult")
    out: capo_iam.types.update_role_response.UpdateRoleResponse = (
        capo_iam.types.update_role_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "UpdateRole"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.update_role_request.serialize_query(input_, pairs, "")
...
def update_role(
    ...
    input_: capo_iam.types.update_role_request.UpdateRoleRequest,
) -> tuple[capo_iam.types.update_role_response.UpdateRoleResponse, zapros.Response]:
