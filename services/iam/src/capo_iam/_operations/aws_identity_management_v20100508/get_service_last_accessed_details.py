...
def handle_response(
    ...
    out: capo_iam.types.get_service_last_accessed_details_response.GetServiceLastAccessedDetailsResponse = capo_iam.types.get_service_last_accessed_details_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_service_last_accessed_details_request.serialize_query(
        input_, pairs, ""
    )
