...
def handle_response(
    ...
    out: capo_iam.types.list_account_aliases_response.ListAccountAliasesResponse = (
        capo_iam.types.list_account_aliases_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_account_aliases_request.serialize_query(input_, pairs, "")
