...
def handle_response(
    ...
    out: capo_iam.types.list_policy_tags_response.ListPolicyTagsResponse = (
        capo_iam.types.list_policy_tags_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_policy_tags_request.serialize_query(input_, pairs, "")
...
def list_policy_tags(
    ...
    capo_iam.types.list_policy_tags_response.ListPolicyTagsResponse, zapros.Response
]:
