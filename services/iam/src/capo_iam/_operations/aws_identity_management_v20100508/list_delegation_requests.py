...
def handle_response(
    ...
    out: capo_iam.types.list_delegation_requests_response.ListDelegationRequestsResponse = capo_iam.types.list_delegation_requests_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_delegation_requests_request.serialize_query(input_, pairs, "")
