...
def handle_response(
    ...
    out: capo_iam.types.disable_organizations_root_sessions_response.DisableOrganizationsRootSessionsResponse = capo_iam.types.disable_organizations_root_sessions_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.disable_organizations_root_sessions_request.serialize_query(
        input_, pairs, ""
    )
