...
def handle_response(
    ...
    out: capo_iam.types.get_instance_profile_response.GetInstanceProfileResponse = (
        capo_iam.types.get_instance_profile_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_instance_profile_request.serialize_query(input_, pairs, "")
