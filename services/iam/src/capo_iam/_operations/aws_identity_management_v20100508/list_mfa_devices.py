...
import capo_iam.types.mfa_device_list_type
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListMFADevicesResult")
    out: capo_iam.types.list_mfa_devices_response.ListMFADevicesResponse = (
        capo_iam.types.list_mfa_devices_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListMFADevices"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.list_mfa_devices_request.serialize_query(input_, pairs, "")
...
def list_mfa_devices(
    ...
    capo_iam.types.list_mfa_devices_response.ListMFADevicesResponse, zapros.Response
]:
