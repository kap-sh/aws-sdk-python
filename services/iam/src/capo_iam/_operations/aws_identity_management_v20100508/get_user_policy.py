...
def handle_response(
    ...
    out: capo_iam.types.get_user_policy_response.GetUserPolicyResponse = (
        capo_iam.types.get_user_policy_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_user_policy_request.serialize_query(input_, pairs, "")
...
def get_user_policy(
    ...
    capo_iam.types.get_user_policy_response.GetUserPolicyResponse, zapros.Response
]:
