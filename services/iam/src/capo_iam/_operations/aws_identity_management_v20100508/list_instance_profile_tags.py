...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListInstanceProfileTagsResult")
    out: capo_iam.types.list_instance_profile_tags_response.ListInstanceProfileTagsResponse = capo_iam.types.list_instance_profile_tags_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListInstanceProfileTags"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.list_instance_profile_tags_request.serialize_query(input_, pairs, "")
