...
def handle_response(
    ...
    out: capo_iam.types.list_user_tags_response.ListUserTagsResponse = (
        capo_iam.types.list_user_tags_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_user_tags_request.serialize_query(input_, pairs, "")
...
def list_user_tags(
    ...
    capo_iam.types.list_user_tags_response.ListUserTagsResponse, zapros.Response
]:
