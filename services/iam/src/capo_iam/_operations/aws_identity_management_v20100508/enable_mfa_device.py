...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidAuthenticationCode":
            raise capo_iam.errors.invalid_authentication_code_exception.InvalidAuthenticationCodeException.from_query(
                error_el, message
            )
        case "LimitExceeded":
...
def build_request(
    ...
    capo_iam.types.enable_mfa_device_request.serialize_query(input_, pairs, "")
