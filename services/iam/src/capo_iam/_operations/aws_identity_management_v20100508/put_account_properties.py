"""Generated from Smithy shape ``com.amazonaws.iam#PutAccountProperties``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("PutAccountPropertiesResult")
    out: capo_iam.types.put_account_properties_response.PutAccountPropertiesResponse = (
        capo_iam.types.put_account_properties_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "PutAccountProperties"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.put_account_properties_request.serialize_query(input_, pairs, "")
...
async def async_put_account_properties(
