...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListInstanceProfilesResult")
    out: capo_iam.types.list_instance_profiles_response.ListInstanceProfilesResponse = (
        capo_iam.types.list_instance_profiles_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListInstanceProfiles"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.list_instance_profiles_request.serialize_query(input_, pairs, "")
