...
def handle_response(
    ...
    out: capo_iam.types.get_server_certificate_response.GetServerCertificateResponse = (
        capo_iam.types.get_server_certificate_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_server_certificate_request.serialize_query(input_, pairs, "")
