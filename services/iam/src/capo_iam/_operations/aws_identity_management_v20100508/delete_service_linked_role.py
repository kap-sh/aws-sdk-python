...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteServiceLinkedRoleResult")
    out: capo_iam.types.delete_service_linked_role_response.DeleteServiceLinkedRoleResponse = capo_iam.types.delete_service_linked_role_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteServiceLinkedRole"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.delete_service_linked_role_request.serialize_query(input_, pairs, "")
