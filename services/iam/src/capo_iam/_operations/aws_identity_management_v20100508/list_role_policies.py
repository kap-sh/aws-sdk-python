"""Generated from Smithy shape ``com.amazonaws.iam#ListRolePolicies``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListRolePoliciesResult")
    out: capo_iam.types.list_role_policies_response.ListRolePoliciesResponse = (
        capo_iam.types.list_role_policies_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListRolePolicies"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.list_role_policies_request.serialize_query(input_, pairs, "")
...
def list_role_policies(
    ...
    capo_iam.types.list_role_policies_response.ListRolePoliciesResponse, zapros.Response
]:
...
async def async_list_role_policies(
