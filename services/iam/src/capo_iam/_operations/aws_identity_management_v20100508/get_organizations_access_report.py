...
def handle_response(
    ...
    out: capo_iam.types.get_organizations_access_report_response.GetOrganizationsAccessReportResponse = capo_iam.types.get_organizations_access_report_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_organizations_access_report_request.serialize_query(
        input_, pairs, ""
    )
