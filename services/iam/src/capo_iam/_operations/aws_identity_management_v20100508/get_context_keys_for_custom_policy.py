...
def handle_response(
    ...
    out: capo_iam.types.get_context_keys_for_policy_response.GetContextKeysForPolicyResponse = capo_iam.types.get_context_keys_for_policy_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_context_keys_for_custom_policy_request.serialize_query(
        input_, pairs, ""
    )
