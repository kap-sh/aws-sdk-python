...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GenerateCredentialReportResult")
    out: capo_iam.types.generate_credential_report_response.GenerateCredentialReportResponse = capo_iam.types.generate_credential_report_response.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "GenerateCredentialReport"))
