...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetServiceLastAccessedDetailsWithEntitiesResult")
    out: capo_iam.types.get_service_last_accessed_details_with_entities_response.GetServiceLastAccessedDetailsWithEntitiesResponse = capo_iam.types.get_service_last_accessed_details_with_entities_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_service_last_accessed_details_with_entities_request.serialize_query(
        input_, pairs, ""
    )
