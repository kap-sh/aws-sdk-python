...
def handle_response(
    ...
    out: capo_iam.types.list_group_policies_response.ListGroupPoliciesResponse = (
        capo_iam.types.list_group_policies_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_group_policies_request.serialize_query(input_, pairs, "")
