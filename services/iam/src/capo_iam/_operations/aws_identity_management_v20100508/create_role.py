...
def handle_response(
    ...
    out: capo_iam.types.create_role_response.CreateRoleResponse = (
        capo_iam.types.create_role_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.create_role_request.serialize_query(input_, pairs, "")
...
def create_role(
    ...
    input_: capo_iam.types.create_role_request.CreateRoleRequest,
) -> tuple[capo_iam.types.create_role_response.CreateRoleResponse, zapros.Response]:
