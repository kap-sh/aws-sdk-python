...
def handle_response(
    ...
    out: capo_iam.types.list_policies_granting_service_access_response.ListPoliciesGrantingServiceAccessResponse = capo_iam.types.list_policies_granting_service_access_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_policies_granting_service_access_request.serialize_query(
        input_, pairs, ""
    )
