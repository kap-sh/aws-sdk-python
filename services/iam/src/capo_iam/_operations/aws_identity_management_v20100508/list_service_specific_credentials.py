...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListServiceSpecificCredentialsResult")
    out: capo_iam.types.list_service_specific_credentials_response.ListServiceSpecificCredentialsResponse = capo_iam.types.list_service_specific_credentials_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListServiceSpecificCredentials"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.list_service_specific_credentials_request.serialize_query(
        input_, pairs, ""
    )
