"""Generated from Smithy shape ``com.amazonaws.iam#TagMFADevice``."""
...
def build_request(
    ...
    pairs.append(("Action", "TagMFADevice"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.tag_mfa_device_request.serialize_query(input_, pairs, "")
...
async def async_tag_mfa_device(
