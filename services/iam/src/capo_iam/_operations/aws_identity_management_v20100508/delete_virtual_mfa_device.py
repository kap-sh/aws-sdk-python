...
import capo_iam.errors.delete_conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DeleteConflict":
            raise capo_iam.errors.delete_conflict_exception.DeleteConflictException.from_query(
                error_el, message
            )
        case "LimitExceeded":
...
def build_request(
    ...
    pairs.append(("Action", "DeleteVirtualMFADevice"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.delete_virtual_mfa_device_request.serialize_query(input_, pairs, "")
