...
def handle_response(
    ...
    out: capo_iam.types.list_attached_group_policies_response.ListAttachedGroupPoliciesResponse = capo_iam.types.list_attached_group_policies_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_attached_group_policies_request.serialize_query(
        input_, pairs, ""
    )
