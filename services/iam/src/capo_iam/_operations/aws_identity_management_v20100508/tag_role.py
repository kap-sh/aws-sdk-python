...
def build_request(
    ...
    pairs.append(("Action", "TagRole"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.tag_role_request.serialize_query(input_, pairs, "")
...
def tag_role(
    options: OperationOptions, input_: capo_iam.types.tag_role_request.TagRoleRequest
