...
def handle_response(
    ...
    out: capo_iam.types.get_login_profile_response.GetLoginProfileResponse = (
        capo_iam.types.get_login_profile_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_login_profile_request.serialize_query(input_, pairs, "")
...
def get_login_profile(
    ...
    capo_iam.types.get_login_profile_response.GetLoginProfileResponse, zapros.Response
]:
