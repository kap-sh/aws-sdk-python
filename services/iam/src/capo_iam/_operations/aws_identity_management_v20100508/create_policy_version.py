...
def handle_response(
    ...
    out: capo_iam.types.create_policy_version_response.CreatePolicyVersionResponse = (
        capo_iam.types.create_policy_version_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.create_policy_version_request.serialize_query(input_, pairs, "")
