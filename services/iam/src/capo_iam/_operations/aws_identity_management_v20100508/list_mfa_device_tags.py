...
def handle_response(
    ...
    out: capo_iam.types.list_mfa_device_tags_response.ListMFADeviceTagsResponse = (
        capo_iam.types.list_mfa_device_tags_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_mfa_device_tags_request.serialize_query(input_, pairs, "")
