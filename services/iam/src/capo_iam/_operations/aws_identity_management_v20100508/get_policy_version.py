...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetPolicyVersionResult")
    out: capo_iam.types.get_policy_version_response.GetPolicyVersionResponse = (
        capo_iam.types.get_policy_version_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetPolicyVersion"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.get_policy_version_request.serialize_query(input_, pairs, "")
...
def get_policy_version(
    ...
    capo_iam.types.get_policy_version_response.GetPolicyVersionResponse, zapros.Response
]:
