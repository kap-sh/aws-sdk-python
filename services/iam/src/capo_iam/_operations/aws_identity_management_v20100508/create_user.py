...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentModificationException":
            raise capo_iam.errors.concurrent_modification_exception.ConcurrentModificationException.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_iam.types.create_user_response.CreateUserResponse = (
        capo_iam.types.create_user_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateUser"))
...
def create_user(
    ...
    input_: capo_iam.types.create_user_request.CreateUserRequest,
) -> tuple[capo_iam.types.create_user_response.CreateUserResponse, zapros.Response]:
