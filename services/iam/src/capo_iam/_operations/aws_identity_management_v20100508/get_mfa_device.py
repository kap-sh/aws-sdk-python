"""Generated from Smithy shape ``com.amazonaws.iam#GetMFADevice``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetMFADeviceResult")
    out: capo_iam.types.get_mfa_device_response.GetMFADeviceResponse = (
        capo_iam.types.get_mfa_device_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetMFADevice"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.get_mfa_device_request.serialize_query(input_, pairs, "")
...
def get_mfa_device(
    ...
    capo_iam.types.get_mfa_device_response.GetMFADeviceResponse, zapros.Response
]:
...
async def async_get_mfa_device(
