...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListOpenIDConnectProviderTagsResult")
    out: capo_iam.types.list_open_id_connect_provider_tags_response.ListOpenIDConnectProviderTagsResponse = capo_iam.types.list_open_id_connect_provider_tags_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListOpenIDConnectProviderTags"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.list_open_id_connect_provider_tags_request.serialize_query(
        input_, pairs, ""
    )
