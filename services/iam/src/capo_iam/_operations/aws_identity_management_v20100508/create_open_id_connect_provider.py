...
import capo_iam.errors.open_id_idp_communication_error_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OpenIdIdpCommunicationError":
            raise capo_iam.errors.open_id_idp_communication_error_exception.OpenIdIdpCommunicationErrorException.from_query(
                error_el, message
            )
        case "ServiceFailure":
...
def handle_response(
    ...
    out: capo_iam.types.create_open_id_connect_provider_response.CreateOpenIDConnectProviderResponse = capo_iam.types.create_open_id_connect_provider_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.create_open_id_connect_provider_request.serialize_query(
        input_, pairs, ""
    )
