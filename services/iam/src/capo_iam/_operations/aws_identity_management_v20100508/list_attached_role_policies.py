...
def handle_response(
    ...
    out: capo_iam.types.list_attached_role_policies_response.ListAttachedRolePoliciesResponse = capo_iam.types.list_attached_role_policies_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_attached_role_policies_request.serialize_query(
        input_, pairs, ""
    )
