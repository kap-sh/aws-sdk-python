...
def handle_response(
    ...
    out: capo_iam.types.list_instance_profiles_for_role_response.ListInstanceProfilesForRoleResponse = capo_iam.types.list_instance_profiles_for_role_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_instance_profiles_for_role_request.serialize_query(
        input_, pairs, ""
    )
