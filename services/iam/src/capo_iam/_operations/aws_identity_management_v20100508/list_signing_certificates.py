...
def handle_response(
    ...
    out: capo_iam.types.list_signing_certificates_response.ListSigningCertificatesResponse = capo_iam.types.list_signing_certificates_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_signing_certificates_request.serialize_query(input_, pairs, "")
