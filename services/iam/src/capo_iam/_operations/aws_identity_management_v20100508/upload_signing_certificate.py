...
import capo_iam.errors.duplicate_certificate_exception
import capo_iam.errors.entity_already_exists_exception
import capo_iam.errors.invalid_certificate_exception
import capo_iam.errors.limit_exceeded_exception
import capo_iam.errors.malformed_certificate_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicateCertificate":
            raise capo_iam.errors.duplicate_certificate_exception.DuplicateCertificateException.from_query(
                error_el, message
            )
        ...
        case "InvalidCertificate":
            raise capo_iam.errors.invalid_certificate_exception.InvalidCertificateException.from_query(
                error_el, message
            )
        case "LimitExceeded":
        ...
        case "MalformedCertificate":
            raise capo_iam.errors.malformed_certificate_exception.MalformedCertificateException.from_query(
                error_el, message
            )
        case "NoSuchEntity":
...
def handle_response(
    ...
    out: capo_iam.types.upload_signing_certificate_response.UploadSigningCertificateResponse = capo_iam.types.upload_signing_certificate_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.upload_signing_certificate_request.serialize_query(input_, pairs, "")
