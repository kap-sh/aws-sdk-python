...
def handle_response(
    ...
    out: capo_iam.types.get_group_policy_response.GetGroupPolicyResponse = (
        capo_iam.types.get_group_policy_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_group_policy_request.serialize_query(input_, pairs, "")
...
def get_group_policy(
    ...
    capo_iam.types.get_group_policy_response.GetGroupPolicyResponse, zapros.Response
]:
