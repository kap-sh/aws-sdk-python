...
def handle_response(
    ...
    out: capo_iam.types.list_open_id_connect_providers_response.ListOpenIDConnectProvidersResponse = capo_iam.types.list_open_id_connect_providers_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_open_id_connect_providers_request.serialize_query(
        input_, pairs, ""
    )
