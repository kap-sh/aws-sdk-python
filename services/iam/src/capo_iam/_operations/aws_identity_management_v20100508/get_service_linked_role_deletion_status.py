...
def handle_response(
    ...
    out: capo_iam.types.get_service_linked_role_deletion_status_response.GetServiceLinkedRoleDeletionStatusResponse = capo_iam.types.get_service_linked_role_deletion_status_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_service_linked_role_deletion_status_request.serialize_query(
        input_, pairs, ""
    )
