...
def handle_response(
    ...
    out: capo_iam.types.get_user_response.GetUserResponse = (
        capo_iam.types.get_user_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetUser"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.get_user_request.serialize_query(input_, pairs, "")
...
def get_user(
    options: OperationOptions, input_: capo_iam.types.get_user_request.GetUserRequest
) -> tuple[capo_iam.types.get_user_response.GetUserResponse, zapros.Response]:
