...
def handle_response(
    ...
    out: capo_iam.types.get_account_password_policy_response.GetAccountPasswordPolicyResponse = capo_iam.types.get_account_password_policy_response.deserialize_query(
