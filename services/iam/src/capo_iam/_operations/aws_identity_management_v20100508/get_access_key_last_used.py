...
def handle_response(
    ...
    out: capo_iam.types.get_access_key_last_used_response.GetAccessKeyLastUsedResponse = capo_iam.types.get_access_key_last_used_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.get_access_key_last_used_request.serialize_query(input_, pairs, "")
