...
def handle_response(
    ...
    out: capo_iam.types.list_user_policies_response.ListUserPoliciesResponse = (
        capo_iam.types.list_user_policies_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_user_policies_request.serialize_query(input_, pairs, "")
...
def list_user_policies(
    ...
    capo_iam.types.list_user_policies_response.ListUserPoliciesResponse, zapros.Response
]:
