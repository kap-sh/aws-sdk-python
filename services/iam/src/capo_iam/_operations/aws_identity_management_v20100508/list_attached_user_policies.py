...
def handle_response(
    ...
    out: capo_iam.types.list_attached_user_policies_response.ListAttachedUserPoliciesResponse = capo_iam.types.list_attached_user_policies_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_attached_user_policies_request.serialize_query(
        input_, pairs, ""
    )
