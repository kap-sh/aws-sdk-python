...
def handle_response(
    ...
    out: capo_iam.types.create_delegation_request_response.CreateDelegationRequestResponse = capo_iam.types.create_delegation_request_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.create_delegation_request_request.serialize_query(input_, pairs, "")
