...
def handle_response(
    ...
    out: capo_iam.types.list_groups_for_user_response.ListGroupsForUserResponse = (
        capo_iam.types.list_groups_for_user_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_groups_for_user_request.serialize_query(input_, pairs, "")
