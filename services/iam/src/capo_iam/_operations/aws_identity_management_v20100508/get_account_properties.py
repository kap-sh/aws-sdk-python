"""Generated from Smithy shape ``com.amazonaws.iam#GetAccountProperties``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetAccountPropertiesResult")
    out: capo_iam.types.get_account_properties_response.GetAccountPropertiesResponse = (
        capo_iam.types.get_account_properties_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetAccountProperties"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.get_account_properties_request.serialize_query(input_, pairs, "")
...
async def async_get_account_properties(
