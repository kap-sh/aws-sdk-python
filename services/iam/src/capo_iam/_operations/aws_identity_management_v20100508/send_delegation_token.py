"""Generated from Smithy shape ``com.amazonaws.iam#SendDelegationToken``."""
...
def build_request(
    ...
    pairs.append(("Action", "SendDelegationToken"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.send_delegation_token_request.serialize_query(input_, pairs, "")
...
async def async_send_delegation_token(
