...
def handle_response(
    ...
    out: capo_iam.types.disable_organizations_root_credentials_management_response.DisableOrganizationsRootCredentialsManagementResponse = capo_iam.types.disable_organizations_root_credentials_management_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.disable_organizations_root_credentials_management_request.serialize_query(
        input_, pairs, ""
    )
