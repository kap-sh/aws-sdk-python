...
def handle_response(
    ...
    out: capo_iam.types.create_policy_response.CreatePolicyResponse = (
        capo_iam.types.create_policy_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.create_policy_request.serialize_query(input_, pairs, "")
...
def create_policy(
    ...
    input_: capo_iam.types.create_policy_request.CreatePolicyRequest,
) -> tuple[capo_iam.types.create_policy_response.CreatePolicyResponse, zapros.Response]:
