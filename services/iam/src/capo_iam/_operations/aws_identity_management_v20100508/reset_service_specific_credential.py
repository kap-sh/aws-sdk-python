...
def handle_response(
    ...
    out: capo_iam.types.reset_service_specific_credential_response.ResetServiceSpecificCredentialResponse = capo_iam.types.reset_service_specific_credential_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.reset_service_specific_credential_request.serialize_query(
        input_, pairs, ""
    )
