...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateAccessKeyResult")
    out: capo_iam.types.create_access_key_response.CreateAccessKeyResponse = (
        capo_iam.types.create_access_key_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateAccessKey"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.create_access_key_request.serialize_query(input_, pairs, "")
...
def create_access_key(
    ...
    capo_iam.types.create_access_key_response.CreateAccessKeyResponse, zapros.Response
]:
