...
def handle_response(
    ...
    out: capo_iam.types.list_role_tags_response.ListRoleTagsResponse = (
        capo_iam.types.list_role_tags_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_role_tags_request.serialize_query(input_, pairs, "")
...
def list_role_tags(
    ...
    capo_iam.types.list_role_tags_response.ListRoleTagsResponse, zapros.Response
]:
