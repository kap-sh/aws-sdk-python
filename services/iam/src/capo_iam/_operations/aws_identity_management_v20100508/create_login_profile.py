...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateLoginProfileResult")
    out: capo_iam.types.create_login_profile_response.CreateLoginProfileResponse = (
        capo_iam.types.create_login_profile_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateLoginProfile"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.create_login_profile_request.serialize_query(input_, pairs, "")
