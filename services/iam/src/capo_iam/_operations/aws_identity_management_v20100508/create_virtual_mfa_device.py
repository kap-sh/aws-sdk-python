...
def handle_response(
    ...
    out: capo_iam.types.create_virtual_mfa_device_response.CreateVirtualMFADeviceResponse = capo_iam.types.create_virtual_mfa_device_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.create_virtual_mfa_device_request.serialize_query(input_, pairs, "")
