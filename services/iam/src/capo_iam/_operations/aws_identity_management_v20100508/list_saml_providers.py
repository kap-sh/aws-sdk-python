...
def handle_response(
    ...
    out: capo_iam.types.list_saml_providers_response.ListSAMLProvidersResponse = (
        capo_iam.types.list_saml_providers_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_saml_providers_request.serialize_query(input_, pairs, "")
