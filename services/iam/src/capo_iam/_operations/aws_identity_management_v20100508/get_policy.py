...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetPolicyResult")
    out: capo_iam.types.get_policy_response.GetPolicyResponse = (
        capo_iam.types.get_policy_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetPolicy"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.get_policy_request.serialize_query(input_, pairs, "")
...
def get_policy(
    ...
    input_: capo_iam.types.get_policy_request.GetPolicyRequest,
) -> tuple[capo_iam.types.get_policy_response.GetPolicyResponse, zapros.Response]:
