...
import capo_iam.errors.policy_not_attachable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyNotAttachable":
            raise capo_iam.errors.policy_not_attachable_exception.PolicyNotAttachableException.from_query(
                error_el, message
            )
        case "ServiceFailure":
...
def build_request(
    ...
    pairs.append(("Action", "AttachGroupPolicy"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.attach_group_policy_request.serialize_query(input_, pairs, "")
