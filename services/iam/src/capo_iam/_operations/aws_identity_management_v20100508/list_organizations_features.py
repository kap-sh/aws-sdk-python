...
def handle_response(
    ...
    out: capo_iam.types.list_organizations_features_response.ListOrganizationsFeaturesResponse = capo_iam.types.list_organizations_features_response.deserialize_query(
...
def build_request(
    ...
    capo_iam.types.list_organizations_features_request.serialize_query(
        input_, pairs, ""
    )
