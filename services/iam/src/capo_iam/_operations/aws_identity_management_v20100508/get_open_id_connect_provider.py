"""Generated from Smithy shape ``com.amazonaws.iam#GetOpenIDConnectProvider``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetOpenIDConnectProviderResult")
    out: capo_iam.types.get_open_id_connect_provider_response.GetOpenIDConnectProviderResponse = capo_iam.types.get_open_id_connect_provider_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetOpenIDConnectProvider"))
    pairs.append(("Version", "2010-05-08"))
    capo_iam.types.get_open_id_connect_provider_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_open_id_connect_provider(
