"""Generated from Smithy shape ``com.amazonaws.iam#ListServerCertificateTagsRequest``."""
...
class ListServerCertificateTagsRequest(TypedDict, closed=True):
    server_certificate_name: (
        "capo_iam.types.server_certificate_name_type.serverCertificateNameType"
    )
    r"""<p>The name of the IAM server certificate whose tags you want to see.</p> <p>This parameter allows (through its <a href=\"http://wikipedia.org/wiki/regex\">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>"""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListServerCertificateTagsRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListServerCertificateTagsRequest:
    out: ListServerCertificateTagsRequest = {}  # type: ignore[typeddict-item]
    ...
    if child_server_certificate_name is not None:
        ...
        raise DeserializationError(
            "ListServerCertificateTagsRequest.server_certificate_name required"
        )
