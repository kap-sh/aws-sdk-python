"""Generated from Smithy shape ``com.amazonaws.iam#ListAttachedGroupPoliciesResponse``."""
...
class ListAttachedGroupPoliciesResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListAttachedGroupPoliciesResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListAttachedGroupPoliciesResponse:
    out: ListAttachedGroupPoliciesResponse = {}  # type: ignore[typeddict-item]
