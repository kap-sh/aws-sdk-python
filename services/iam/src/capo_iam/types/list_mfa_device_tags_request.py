...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListMFADeviceTagsRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListMFADeviceTagsRequest:
    out: ListMFADeviceTagsRequest = {}  # type: ignore[typeddict-item]
    ...
    if child_serial_number is not None:
        ...
        raise DeserializationError("ListMFADeviceTagsRequest.serial_number required")
