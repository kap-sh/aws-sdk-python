...
if TYPE_CHECKING:
    import capo_iam.types.certification_key_type
    import capo_iam.types.certification_value_type

CertificationMapType: TypeAlias = dict[
    "capo_iam.types.certification_key_type.CertificationKeyType",
    "capo_iam.types.certification_value_type.CertificationValueType",
]
