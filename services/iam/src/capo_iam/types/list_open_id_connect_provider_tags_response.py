"""Generated from Smithy shape ``com.amazonaws.iam#ListOpenIDConnectProviderTagsResponse``."""
...
class ListOpenIDConnectProviderTagsResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListOpenIDConnectProviderTagsResponse,
...
def deserialize_query(el: Element) -> ListOpenIDConnectProviderTagsResponse:
    out: ListOpenIDConnectProviderTagsResponse = {}  # type: ignore[typeddict-item]
    ...
    if child_tags is not None:
        ...
        raise DeserializationError(
            "ListOpenIDConnectProviderTagsResponse.tags required"
        )
