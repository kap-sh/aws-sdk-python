...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListRolesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListRolesRequest:
    out: ListRolesRequest = {}  # type: ignore[typeddict-item]
