...
class GetAccountAuthorizationDetailsResponse(TypedDict, closed=True):
    user_detail_list: NotRequired[
        "capo_iam.types.user_detail_list_type.userDetailListType"
    ]
    """<p>A list containing information about IAM users.</p>"""
    group_detail_list: NotRequired[
        "capo_iam.types.group_detail_list_type.groupDetailListType"
    ]
    """<p>A list containing information about IAM groups.</p>"""
    role_detail_list: NotRequired[
        "capo_iam.types.role_detail_list_type.roleDetailListType"
    ]
    """<p>A list containing information about IAM roles.</p>"""
    policies: NotRequired[
        "capo_iam.types.managed_policy_detail_list_type.ManagedPolicyDetailListType"
    ]
...
def deserialize_query(el: Element) -> GetAccountAuthorizationDetailsResponse:
    ...
    if child_user_detail_list is not None:
        ...
        out["user_detail_list"] = (
            capo_iam.types.user_detail_list_type.deserialize_query(
    ...
    if child_group_detail_list is not None:
        ...
        out["group_detail_list"] = (
            capo_iam.types.group_detail_list_type.deserialize_query(
    ...
    if child_role_detail_list is not None:
        ...
        out["role_detail_list"] = (
            capo_iam.types.role_detail_list_type.deserialize_query(
    ...
    if child_policies is not None:
        ...
        out["policies"] = (
            capo_iam.types.managed_policy_detail_list_type.deserialize_query(
                child_policies
            )
        )
