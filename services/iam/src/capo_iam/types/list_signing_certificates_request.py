"""Generated from Smithy shape ``com.amazonaws.iam#ListSigningCertificatesRequest``."""
...
class ListSigningCertificatesRequest(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListSigningCertificatesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListSigningCertificatesRequest:
    out: ListSigningCertificatesRequest = {}  # type: ignore[typeddict-item]
