"""Generated from Smithy shape ``com.amazonaws.iam#ListMFADeviceTagsResponse``."""
...
class ListMFADeviceTagsResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListMFADeviceTagsResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
    import capo_iam.types.tag_list_type
...
def deserialize_query(el: Element) -> ListMFADeviceTagsResponse:
    out: ListMFADeviceTagsResponse = {}  # type: ignore[typeddict-item]
    ...
    if child_tags is not None:
        ...
        raise DeserializationError("ListMFADeviceTagsResponse.tags required")
