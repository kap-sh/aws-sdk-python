...
class ListSAMLProvidersResponse(TypedDict, closed=True):
    saml_provider_list: NotRequired[
        "capo_iam.types.saml_provider_list_type.SAMLProviderListType"
    ]
...
def deserialize_query(el: Element) -> ListSAMLProvidersResponse:
    ...
    if child_saml_provider_list is not None:
        ...
        out["saml_provider_list"] = (
            capo_iam.types.saml_provider_list_type.deserialize_query(
