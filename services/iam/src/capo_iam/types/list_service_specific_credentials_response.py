...
class ListServiceSpecificCredentialsResponse(TypedDict, closed=True):
    service_specific_credentials: NotRequired[
        "capo_iam.types.service_specific_credentials_list_type.ServiceSpecificCredentialsListType"
    ]
...
def deserialize_query(el: Element) -> ListServiceSpecificCredentialsResponse:
    ...
    if child_service_specific_credentials is not None:
        ...
        out["service_specific_credentials"] = (
            capo_iam.types.service_specific_credentials_list_type.deserialize_query(
