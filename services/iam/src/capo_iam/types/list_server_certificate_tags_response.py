"""Generated from Smithy shape ``com.amazonaws.iam#ListServerCertificateTagsResponse``."""
...
class ListServerCertificateTagsResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListServerCertificateTagsResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
    import capo_iam.types.tag_list_type
...
def deserialize_query(el: Element) -> ListServerCertificateTagsResponse:
    out: ListServerCertificateTagsResponse = {}  # type: ignore[typeddict-item]
    ...
    if child_tags is not None:
        ...
        raise DeserializationError("ListServerCertificateTagsResponse.tags required")
