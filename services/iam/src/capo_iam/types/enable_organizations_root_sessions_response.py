"""Generated from Smithy shape ``com.amazonaws.iam#EnableOrganizationsRootSessionsResponse``."""
...
class EnableOrganizationsRootSessionsResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: EnableOrganizationsRootSessionsResponse,
...
def deserialize_query(el: Element) -> EnableOrganizationsRootSessionsResponse:
    out: EnableOrganizationsRootSessionsResponse = {}  # type: ignore[typeddict-item]
