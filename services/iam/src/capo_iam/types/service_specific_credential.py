...
if TYPE_CHECKING:
    ...
    import capo_iam.types.service_credential_secret
    import capo_iam.types.service_name
    import capo_iam.types.service_password
...
class ServiceSpecificCredential(TypedDict, closed=True):
    ...
    service_password: "capo_iam.types.service_password.servicePassword"
    ...
    service_credential_secret: NotRequired[
        "capo_iam.types.service_credential_secret.serviceCredentialSecret"
    ]
