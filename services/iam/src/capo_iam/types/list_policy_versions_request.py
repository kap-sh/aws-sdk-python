"""Generated from Smithy shape ``com.amazonaws.iam#ListPolicyVersionsRequest``."""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListPolicyVersionsRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListPolicyVersionsRequest:
    ...
    if child_policy_arn is not None:
        ...
        raise DeserializationError("ListPolicyVersionsRequest.policy_arn required")
