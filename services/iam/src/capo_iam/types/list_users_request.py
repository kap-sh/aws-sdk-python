"""Generated from Smithy shape ``com.amazonaws.iam#ListUsersRequest``."""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListUsersRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListUsersRequest:
