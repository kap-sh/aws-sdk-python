        ...
        if _locals["PartitionResult"] is not None:
            ...
            if string_equals(
                ...
                if p.UseFIPS is True:
                    if p.UseDualStack is True:
                        return Endpoint(
                            url=interpolate(
                                "https://iam-fips.global.api.aws", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is True:
                        return Endpoint(
                            url=interpolate("https://iam.us-gov.api.aws", p, _locals),
                            properties={
                                "authSchemes": [
                                    {
                                        "name": interpolate("sigv4", p, _locals),
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://iam.us-gov.amazonaws.com", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://iam.us-iso-east-1.c2s.ic.gov", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is True:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://iam-fips.us-iso-east-1.c2s.ic.gov", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://iam.us-isob-east-1.sc2s.sgov.gov", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://iam.us-isof-south-1.csp.hci.ic.gov", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
