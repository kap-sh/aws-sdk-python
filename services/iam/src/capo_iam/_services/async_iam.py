...
from capo_iam._async import anysleep
from capo_iam._auth._identity import Credentials
from capo_iam._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
    StaticAwsCredentialsProvider,
    default_aws_credentials_chain,
)
from capo_iam._auth._zapros_handler import AuthMiddleware
from capo_iam._pagination import resolve_path as _resolve_path
from capo_iam._services._aws_config import aaws_config
...
from capo_iam.errors import ServiceError, WaiterTimeoutError

if TYPE_CHECKING:
    import capo_iam.types.accept_delegation_request_request
    ...
    import capo_iam.types.add_user_to_group_request
    import capo_iam.types.all_users
    ...
    import capo_iam.types.associate_delegation_request_request
    import capo_iam.types.attach_group_policy_request
    import capo_iam.types.attach_role_policy_request
    import capo_iam.types.attach_user_policy_request
    ...
    import capo_iam.types.certificate_chain_type
    ...
    import capo_iam.types.create_access_key_request
    import capo_iam.types.create_access_key_response
    import capo_iam.types.create_account_alias_request
    import capo_iam.types.create_delegation_request_request
    import capo_iam.types.create_delegation_request_response
    import capo_iam.types.create_group_request
    import capo_iam.types.create_group_response
    import capo_iam.types.create_instance_profile_request
    import capo_iam.types.create_instance_profile_response
    import capo_iam.types.create_login_profile_request
    import capo_iam.types.create_login_profile_response
    import capo_iam.types.create_open_id_connect_provider_request
    import capo_iam.types.create_open_id_connect_provider_response
    import capo_iam.types.create_policy_request
    import capo_iam.types.create_policy_response
    import capo_iam.types.create_policy_version_request
    import capo_iam.types.create_policy_version_response
    import capo_iam.types.create_role_request
    import capo_iam.types.create_role_response
    import capo_iam.types.create_saml_provider_request
    import capo_iam.types.create_saml_provider_response
    import capo_iam.types.create_service_linked_role_request
    import capo_iam.types.create_service_linked_role_response
    import capo_iam.types.create_service_specific_credential_request
    import capo_iam.types.create_service_specific_credential_response
    import capo_iam.types.create_user_request
    import capo_iam.types.create_user_response
    import capo_iam.types.create_virtual_mfa_device_request
    import capo_iam.types.create_virtual_mfa_device_response
    import capo_iam.types.credential_age_days
    import capo_iam.types.custom_suffix_type
    import capo_iam.types.deactivate_mfa_device_request
    ...
    import capo_iam.types.delete_access_key_request
    import capo_iam.types.delete_account_alias_request
    import capo_iam.types.delete_group_policy_request
    import capo_iam.types.delete_group_request
    import capo_iam.types.delete_instance_profile_request
    import capo_iam.types.delete_login_profile_request
    import capo_iam.types.delete_open_id_connect_provider_request
    import capo_iam.types.delete_policy_request
    import capo_iam.types.delete_policy_version_request
    import capo_iam.types.delete_role_permissions_boundary_request
    import capo_iam.types.delete_role_policy_request
    import capo_iam.types.delete_role_request
    import capo_iam.types.delete_saml_provider_request
    import capo_iam.types.delete_server_certificate_request
    import capo_iam.types.delete_service_linked_role_request
    import capo_iam.types.delete_service_linked_role_response
    import capo_iam.types.delete_service_specific_credential_request
    import capo_iam.types.delete_signing_certificate_request
    import capo_iam.types.delete_ssh_public_key_request
    import capo_iam.types.delete_user_permissions_boundary_request
    import capo_iam.types.delete_user_policy_request
    import capo_iam.types.delete_user_request
    import capo_iam.types.delete_virtual_mfa_device_request
    import capo_iam.types.deletion_task_id_type
    import capo_iam.types.detach_group_policy_request
    import capo_iam.types.detach_role_policy_request
    import capo_iam.types.detach_user_policy_request
    import capo_iam.types.disable_organizations_root_credentials_management_request
    import capo_iam.types.disable_organizations_root_credentials_management_response
    import capo_iam.types.disable_organizations_root_sessions_request
    import capo_iam.types.disable_organizations_root_sessions_response
    import capo_iam.types.enable_mfa_device_request
    import capo_iam.types.enable_organizations_root_credentials_management_request
    import capo_iam.types.enable_organizations_root_credentials_management_response
    import capo_iam.types.enable_organizations_root_sessions_request
    import capo_iam.types.enable_organizations_root_sessions_response
    import capo_iam.types.enable_outbound_web_identity_federation_response
    import capo_iam.types.encoding_type
    ...
    import capo_iam.types.generate_credential_report_response
    ...
    import capo_iam.types.generate_service_last_accessed_details_request
    import capo_iam.types.generate_service_last_accessed_details_response
    ...
    import capo_iam.types.get_context_keys_for_principal_policy_request
    import capo_iam.types.get_credential_report_response
    import capo_iam.types.get_delegation_request_request
    import capo_iam.types.get_delegation_request_response
    import capo_iam.types.get_group_policy_request
    import capo_iam.types.get_group_policy_response
    import capo_iam.types.get_group_request
    import capo_iam.types.get_group_response
    import capo_iam.types.get_human_readable_summary_request
    import capo_iam.types.get_human_readable_summary_response
    import capo_iam.types.get_instance_profile_request
    import capo_iam.types.get_instance_profile_response
    import capo_iam.types.get_login_profile_request
    import capo_iam.types.get_login_profile_response
    import capo_iam.types.get_mfa_device_request
    import capo_iam.types.get_mfa_device_response
    import capo_iam.types.get_open_id_connect_provider_request
    import capo_iam.types.get_open_id_connect_provider_response
    import capo_iam.types.get_organizations_access_report_request
    import capo_iam.types.get_organizations_access_report_response
    import capo_iam.types.get_outbound_web_identity_federation_info_response
    import capo_iam.types.get_policy_request
    import capo_iam.types.get_policy_response
    import capo_iam.types.get_policy_version_request
    import capo_iam.types.get_policy_version_response
    import capo_iam.types.get_role_policy_request
    ...
    import capo_iam.types.get_server_certificate_response
    import capo_iam.types.get_service_last_accessed_details_request
    import capo_iam.types.get_service_last_accessed_details_response
    import capo_iam.types.get_service_last_accessed_details_with_entities_request
    import capo_iam.types.get_service_last_accessed_details_with_entities_response
    import capo_iam.types.get_service_linked_role_deletion_status_request
    import capo_iam.types.get_service_linked_role_deletion_status_response
    import capo_iam.types.get_ssh_public_key_request
    import capo_iam.types.get_ssh_public_key_response
    import capo_iam.types.get_user_policy_request
    import capo_iam.types.get_user_policy_response
    import capo_iam.types.get_user_request
    import capo_iam.types.get_user_response
    ...
    import capo_iam.types.list_account_aliases_request
    import capo_iam.types.list_account_aliases_response
    import capo_iam.types.list_attached_group_policies_request
    import capo_iam.types.list_attached_group_policies_response
    import capo_iam.types.list_attached_role_policies_request
    import capo_iam.types.list_attached_role_policies_response
    import capo_iam.types.list_attached_user_policies_request
    import capo_iam.types.list_attached_user_policies_response
    import capo_iam.types.list_delegation_requests_request
    import capo_iam.types.list_delegation_requests_response
    import capo_iam.types.list_entities_for_policy_request
    import capo_iam.types.list_entities_for_policy_response
    import capo_iam.types.list_group_policies_request
    import capo_iam.types.list_group_policies_response
    import capo_iam.types.list_groups_for_user_request
    import capo_iam.types.list_groups_for_user_response
    import capo_iam.types.list_groups_request
    import capo_iam.types.list_groups_response
    import capo_iam.types.list_instance_profile_tags_request
    import capo_iam.types.list_instance_profile_tags_response
    import capo_iam.types.list_instance_profiles_for_role_request
    import capo_iam.types.list_instance_profiles_for_role_response
    import capo_iam.types.list_instance_profiles_request
    import capo_iam.types.list_instance_profiles_response
    import capo_iam.types.list_mfa_device_tags_request
    import capo_iam.types.list_mfa_device_tags_response
    import capo_iam.types.list_mfa_devices_request
    import capo_iam.types.list_mfa_devices_response
    import capo_iam.types.list_open_id_connect_provider_tags_request
    import capo_iam.types.list_open_id_connect_provider_tags_response
    import capo_iam.types.list_open_id_connect_providers_request
    import capo_iam.types.list_open_id_connect_providers_response
    import capo_iam.types.list_organizations_features_request
    import capo_iam.types.list_organizations_features_response
    import capo_iam.types.list_policies_granting_service_access_request
    import capo_iam.types.list_policies_granting_service_access_response
    import capo_iam.types.list_policies_request
    import capo_iam.types.list_policies_response
    import capo_iam.types.list_policy_tags_request
    import capo_iam.types.list_policy_tags_response
    import capo_iam.types.list_policy_versions_request
    import capo_iam.types.list_policy_versions_response
    import capo_iam.types.list_role_policies_request
    import capo_iam.types.list_role_policies_response
    import capo_iam.types.list_role_tags_request
    import capo_iam.types.list_role_tags_response
    import capo_iam.types.list_roles_request
    import capo_iam.types.list_roles_response
    import capo_iam.types.list_saml_provider_tags_request
    import capo_iam.types.list_saml_provider_tags_response
    import capo_iam.types.list_saml_providers_request
    import capo_iam.types.list_saml_providers_response
    import capo_iam.types.list_server_certificate_tags_request
    import capo_iam.types.list_server_certificate_tags_response
    import capo_iam.types.list_server_certificates_request
    import capo_iam.types.list_server_certificates_response
    import capo_iam.types.list_service_specific_credentials_request
    import capo_iam.types.list_service_specific_credentials_response
    import capo_iam.types.list_signing_certificates_request
    import capo_iam.types.list_signing_certificates_response
    import capo_iam.types.list_ssh_public_keys_request
    import capo_iam.types.list_ssh_public_keys_response
    import capo_iam.types.list_user_policies_request
    import capo_iam.types.list_user_policies_response
    import capo_iam.types.list_user_tags_request
    import capo_iam.types.list_user_tags_response
    import capo_iam.types.list_users_request
    import capo_iam.types.list_users_response
    ...
    import capo_iam.types.put_user_permissions_boundary_request
    import capo_iam.types.put_user_policy_request
    import capo_iam.types.redirect_url_type
    import capo_iam.types.reject_delegation_request_request
    import capo_iam.types.remove_client_id_from_open_id_connect_provider_request
    import capo_iam.types.remove_role_from_instance_profile_request
    import capo_iam.types.remove_user_from_group_request
    import capo_iam.types.request_message_type
    import capo_iam.types.requestor_workflow_id_type
    import capo_iam.types.reset_service_specific_credential_request
    import capo_iam.types.reset_service_specific_credential_response
    ...
    import capo_iam.types.resync_mfa_device_request
    ...
    import capo_iam.types.send_delegation_token_request
    ...
    import capo_iam.types.tag_instance_profile_request
    import capo_iam.types.tag_key_list_type
    import capo_iam.types.tag_list_type
    import capo_iam.types.tag_mfa_device_request
    import capo_iam.types.tag_open_id_connect_provider_request
    import capo_iam.types.tag_policy_request
    import capo_iam.types.tag_role_request
    import capo_iam.types.tag_saml_provider_request
    import capo_iam.types.tag_server_certificate_request
    import capo_iam.types.tag_user_request
    import capo_iam.types.thumbprint_list_type
    import capo_iam.types.untag_instance_profile_request
    import capo_iam.types.untag_mfa_device_request
    import capo_iam.types.untag_open_id_connect_provider_request
    import capo_iam.types.untag_policy_request
    import capo_iam.types.untag_role_request
    import capo_iam.types.untag_saml_provider_request
    import capo_iam.types.untag_server_certificate_request
    import capo_iam.types.untag_user_request
    import capo_iam.types.update_access_key_request
    import capo_iam.types.update_account_password_policy_request
    import capo_iam.types.update_assume_role_policy_request
    import capo_iam.types.update_delegation_request_request
    import capo_iam.types.update_group_request
    import capo_iam.types.update_login_profile_request
    import capo_iam.types.update_open_id_connect_provider_thumbprint_request
    import capo_iam.types.update_role_description_request
    import capo_iam.types.update_role_description_response
    import capo_iam.types.update_role_request
    import capo_iam.types.update_role_response
    import capo_iam.types.update_saml_provider_request
    import capo_iam.types.update_saml_provider_response
    import capo_iam.types.update_server_certificate_request
    import capo_iam.types.update_service_specific_credential_request
    import capo_iam.types.update_signing_certificate_request
    import capo_iam.types.update_ssh_public_key_request
    import capo_iam.types.update_user_request
    import capo_iam.types.upload_server_certificate_request
    import capo_iam.types.upload_server_certificate_response
    import capo_iam.types.upload_signing_certificate_request
    import capo_iam.types.upload_signing_certificate_response
    import capo_iam.types.upload_ssh_public_key_request
    import capo_iam.types.upload_ssh_public_key_response
...
class AsyncIAMClient:
    ...
    def __init__(
        ...
        self._config = AsyncIAMClientConfig(
            {
    ...
    async def accept_delegation_request(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.accept_delegation_request_request.AcceptDelegationRequestRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.accept_delegation_request

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.accept_delegation_request.async_accept_delegation_request(
    ...
    async def acquire_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.acquire_role_request.AcquireRoleRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.acquire_role_response.AcquireRoleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.acquire_role.async_acquire_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def add_client_id_to_open_id_connect_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.add_client_id_to_open_id_connect_provider_request.AddClientIDToOpenIDConnectProviderRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.add_client_id_to_open_id_connect_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.add_client_id_to_open_id_connect_provider.async_add_client_id_to_open_id_connect_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def add_role_to_instance_profile(
        self,
        instance_profile_name: "capo_iam.types.instance_profile_name_type.instanceProfileNameType",
        ...
        *,
        ...
        Raises:
            ...
            capo_iam.errors.no_such_entity_exception.NoSuchEntityException: <p>The request was rejected because it referenced a resource entity that does not exist. The error message describes the resource.</p>
            capo_iam.errors.service_failure_exception.ServiceFailureException: <p>The request processing has failed because of an unknown error, exception or failure.</p>
            capo_iam.errors.unmodifiable_entity_exception.UnmodifiableEntityException: <p>The request was rejected because service-linked roles are protected Amazon Web Services resources. Only the service that depends on the service-linked role can modify or delete the role on your behalf. The error message includes the name of the service that depends on this service-linked role. You must request the change through that service.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.add_role_to_instance_profile_request.AddRoleToInstanceProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.add_role_to_instance_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.add_role_to_instance_profile.async_add_role_to_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def add_user_to_group(
        ...
        *,
        ...
        r"""<p>Adds the specified user to the specified group.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.add_user_to_group_request.AddUserToGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.add_user_to_group

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.add_user_to_group.async_add_user_to_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_delegation_request(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.associate_delegation_request_request.AssociateDelegationRequestRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.associate_delegation_request

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.associate_delegation_request.async_associate_delegation_request(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_group_policy(
        ...
        *,
        ...
        Raises:
            ...
            capo_iam.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because it attempted to create resources beyond the current Amazon Web Services account limits. The error message describes the limit exceeded.</p>
            capo_iam.errors.no_such_entity_exception.NoSuchEntityException: <p>The request was rejected because it referenced a resource entity that does not exist. The error message describes the resource.</p>
            capo_iam.errors.policy_not_attachable_exception.PolicyNotAttachableException: <p>The request failed because Amazon Web Services service role policies can only be attached to the service-linked role for that service.</p>
            capo_iam.errors.service_failure_exception.ServiceFailureException: <p>The request processing has failed because of an unknown error, exception or failure.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.attach_group_policy_request.AttachGroupPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.attach_group_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.attach_group_policy.async_attach_group_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_role_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.attach_role_policy_request.AttachRolePolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.attach_role_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.attach_role_policy.async_attach_role_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_user_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.attach_user_policy_request.AttachUserPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.attach_user_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.attach_user_policy.async_attach_user_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def change_password(
        ...
        *,
        ...
        Raises:
            capo_iam.errors.entity_temporarily_unmodifiable_exception.EntityTemporarilyUnmodifiableException: <p>The request was rejected because it referenced an entity that is temporarily unmodifiable, such as a user name that was deleted and then recreated. The error indicates that the request is likely to succeed if you try again after waiting several minutes. The error message describes the entity.</p>
            capo_iam.errors.invalid_user_type_exception.InvalidUserTypeException: <p>The request was rejected because the type of user for the transaction was incorrect.</p>
            capo_iam.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because it attempted to create resources beyond the current Amazon Web Services account limits. The error message describes the limit exceeded.</p>
            capo_iam.errors.no_such_entity_exception.NoSuchEntityException: <p>The request was rejected because it referenced a resource entity that does not exist. The error message describes the resource.</p>
            capo_iam.errors.password_policy_violation_exception.PasswordPolicyViolationException: <p>The request was rejected because the provided password did not meet the requirements imposed by the account password policy.</p>
            capo_iam.errors.service_failure_exception.ServiceFailureException: <p>The request processing has failed because of an unknown error, exception or failure.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.change_password_request.ChangePasswordRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.change_password

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.change_password.async_change_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_access_key(
        ...
        *,
    ...
    ) -> "capo_iam.types.create_access_key_response.CreateAccessKeyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_access_key_request.CreateAccessKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_access_key_response.CreateAccessKeyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_access_key

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_access_key.async_create_access_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_account_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_account_alias_request.CreateAccountAliasRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.create_account_alias

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_account_alias.async_create_account_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_delegation_request(
        self,
        description: "capo_iam.types.delegation_request_description_type.delegationRequestDescriptionType",
        permissions: "capo_iam.types.delegation_permission.DelegationPermission",
        requestor_workflow_id: "capo_iam.types.requestor_workflow_id_type.requestorWorkflowIdType",
        notification_channel: "capo_iam.types.notification_channel_type.notificationChannelType",
        session_duration: "capo_iam.types.session_duration_type.sessionDurationType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        owner_account_id: Optional[
            "capo_iam.types.account_id_type.accountIdType"
        ] = None,
        request_message: Optional[
            "capo_iam.types.request_message_type.requestMessageType"
        ] = None,
        redirect_url: Optional[
            "capo_iam.types.redirect_url_type.redirectUrlType"
        ] = None,
        only_send_by_owner: Optional["capo_iam.types.boolean_type.booleanType"] = None,
    ) -> "capo_iam.types.create_delegation_request_response.CreateDelegationRequestResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_delegation_request_request.CreateDelegationRequestRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_delegation_request_response.CreateDelegationRequestResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_delegation_request

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_delegation_request.async_create_delegation_request(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_group(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        path: Optional["capo_iam.types.path_type.pathType"] = None,
    ) -> "capo_iam.types.create_group_response.CreateGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_group_request.CreateGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_group_response.CreateGroupResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_group

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_group.async_create_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_instance_profile(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        path: Optional["capo_iam.types.path_type.pathType"] = None,
        tags: Optional["capo_iam.types.tag_list_type.tagListType"] = None,
    ) -> (
        "capo_iam.types.create_instance_profile_response.CreateInstanceProfileResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_instance_profile_request.CreateInstanceProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_instance_profile_response.CreateInstanceProfileResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_instance_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_instance_profile.async_create_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_login_profile(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        user_name: Optional["capo_iam.types.user_name_type.userNameType"] = None,
        password: Optional["capo_iam.types.password_type.passwordType"] = None,
        password_reset_required: Optional[
            "capo_iam.types.boolean_type.booleanType"
        ] = None,
    ) -> "capo_iam.types.create_login_profile_response.CreateLoginProfileResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_login_profile_request.CreateLoginProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_login_profile_response.CreateLoginProfileResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_login_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_login_profile.async_create_login_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_open_id_connect_provider(
        self,
        url: "capo_iam.types.open_id_connect_provider_url_type.OpenIDConnectProviderUrlType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        client_id_list: Optional[
            "capo_iam.types.client_id_list_type.clientIDListType"
        ] = None,
        thumbprint_list: Optional[
            "capo_iam.types.thumbprint_list_type.thumbprintListType"
        ] = None,
        tags: Optional["capo_iam.types.tag_list_type.tagListType"] = None,
    ) -> "capo_iam.types.create_open_id_connect_provider_response.CreateOpenIDConnectProviderResponse":
        ...
        Raises:
            ...
            capo_iam.errors.invalid_input_exception.InvalidInputException: <p>The request was rejected because an invalid or out-of-range value was supplied for an input parameter.</p>
            capo_iam.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because it attempted to create resources beyond the current Amazon Web Services account limits. The error message describes the limit exceeded.</p>
            capo_iam.errors.open_id_idp_communication_error_exception.OpenIdIdpCommunicationErrorException: <p>The request failed because IAM cannot connect to the OpenID Connect identity provider URL.</p>
            capo_iam.errors.service_failure_exception.ServiceFailureException: <p>The request processing has failed because of an unknown error, exception or failure.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_open_id_connect_provider_request.CreateOpenIDConnectProviderRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_open_id_connect_provider_response.CreateOpenIDConnectProviderResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_open_id_connect_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_open_id_connect_provider.async_create_open_id_connect_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_policy(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        path: Optional["capo_iam.types.policy_path_type.policyPathType"] = None,
        description: Optional[
            "capo_iam.types.policy_description_type.policyDescriptionType"
        ] = None,
        tags: Optional["capo_iam.types.tag_list_type.tagListType"] = None,
    ) -> "capo_iam.types.create_policy_response.CreatePolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_policy_request.CreatePolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_policy_response.CreatePolicyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_policy.async_create_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_policy_version(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        set_as_default: Optional["capo_iam.types.boolean_type.booleanType"] = None,
    ) -> "capo_iam.types.create_policy_version_response.CreatePolicyVersionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_policy_version_request.CreatePolicyVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_policy_version_response.CreatePolicyVersionResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_policy_version

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_policy_version.async_create_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_role(
        self,
        role_name: "capo_iam.types.role_name_type.roleNameType",
        assume_role_policy_document: "capo_iam.types.policy_document_type.policyDocumentType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        path: Optional["capo_iam.types.path_type.pathType"] = None,
        description: Optional[
            "capo_iam.types.role_description_type.roleDescriptionType"
        ] = None,
        max_session_duration: Optional[
            "capo_iam.types.role_max_session_duration_type.roleMaxSessionDurationType"
        ] = None,
        permissions_boundary: Optional["capo_iam.types.arn_type.arnType"] = None,
        tags: Optional["capo_iam.types.tag_list_type.tagListType"] = None,
    ) -> "capo_iam.types.create_role_response.CreateRoleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_role_request.CreateRoleRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_role_response.CreateRoleResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_role

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_role.async_create_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_saml_provider(
        self,
        saml_metadata_document: "capo_iam.types.saml_metadata_document_type.SAMLMetadataDocumentType",
        ...
        *,
        ...
        add_private_key: Optional[
            "capo_iam.types.private_key_type.privateKeyType"
        ] = None,
    ) -> "capo_iam.types.create_saml_provider_response.CreateSAMLProviderResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_saml_provider_request.CreateSAMLProviderRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_saml_provider_response.CreateSAMLProviderResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_saml_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_saml_provider.async_create_saml_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_service_linked_role(
        self,
        aws_service_name: "capo_iam.types.group_name_type.groupNameType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        description: Optional[
            "capo_iam.types.role_description_type.roleDescriptionType"
        ...
        custom_suffix: Optional[
            "capo_iam.types.custom_suffix_type.customSuffixType"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_service_linked_role_request.CreateServiceLinkedRoleRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_service_linked_role_response.CreateServiceLinkedRoleResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_service_linked_role

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_service_linked_role.async_create_service_linked_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_service_specific_credential(
        ...
        *,
        ...
        Raises:
            capo_iam.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because it attempted to create resources beyond the current Amazon Web Services account limits. The error message describes the limit exceeded.</p>
            capo_iam.errors.no_such_entity_exception.NoSuchEntityException: <p>The request was rejected because it referenced a resource entity that does not exist. The error message describes the resource.</p>
            capo_iam.errors.service_not_supported_exception.ServiceNotSupportedException: <p>The specified service does not support service-specific credentials.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_service_specific_credential_request.CreateServiceSpecificCredentialRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_service_specific_credential_response.CreateServiceSpecificCredentialResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_service_specific_credential

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_service_specific_credential.async_create_service_specific_credential(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_user(
        ...
        *,
        ...
        permissions_boundary: Optional["capo_iam.types.arn_type.arnType"] = None,
        tags: Optional["capo_iam.types.tag_list_type.tagListType"] = None,
    ) -> "capo_iam.types.create_user_response.CreateUserResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_user_request.CreateUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_user_response.CreateUserResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_user

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_user.async_create_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_virtual_mfa_device(
        self,
        virtual_mfa_device_name: "capo_iam.types.virtual_mfa_device_name.virtualMFADeviceName",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        path: Optional["capo_iam.types.path_type.pathType"] = None,
        tags: Optional["capo_iam.types.tag_list_type.tagListType"] = None,
    ) -> "capo_iam.types.create_virtual_mfa_device_response.CreateVirtualMFADeviceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.create_virtual_mfa_device_request.CreateVirtualMFADeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.create_virtual_mfa_device_response.CreateVirtualMFADeviceResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.create_virtual_mfa_device

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.create_virtual_mfa_device.async_create_virtual_mfa_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deactivate_mfa_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.deactivate_mfa_device_request.DeactivateMFADeviceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.deactivate_mfa_device

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.deactivate_mfa_device.async_deactivate_mfa_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_access_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_access_key_request.DeleteAccessKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_access_key

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_access_key.async_delete_access_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_account_alias(
        ...
        *,
        ...
        r"""<p> Deletes the specified Amazon Web Services account alias. For information about using an Amazon Web Services account alias, see <a href=\"https://docs.aws.amazon.com/signin/latest/userguide/CreateAccountAlias.html\">Creating, deleting, and listing an Amazon Web Services account alias</a> in the <i>Amazon Web Services Sign-In User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_account_alias_request.DeleteAccountAliasRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_account_alias

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_account_alias.async_delete_account_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_account_password_policy(
        ...
        async def _handler(
            ...
            import capo_iam._operations.aws_identity_management_v20100508.delete_account_password_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_account_password_policy.async_delete_account_password_policy(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_group(
        ...
        *,
        ...
        r"""<p>Deletes the specified IAM group. The group must not contain any users or have any attached policies.</p>
        ...
        Raises:
            capo_iam.errors.delete_conflict_exception.DeleteConflictException: <p>The request was rejected because it attempted to delete a resource that has attached subordinate entities. The error message describes these entities.</p>
            capo_iam.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because it attempted to create resources beyond the current Amazon Web Services account limits. The error message describes the limit exceeded.</p>
            capo_iam.errors.no_such_entity_exception.NoSuchEntityException: <p>The request was rejected because it referenced a resource entity that does not exist. The error message describes the resource.</p>
            capo_iam.errors.service_failure_exception.ServiceFailureException: <p>The request processing has failed because of an unknown error, exception or failure.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_group_request.DeleteGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_group

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_group.async_delete_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_group_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_group_policy_request.DeleteGroupPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_group_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_group_policy.async_delete_group_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_instance_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_instance_profile_request.DeleteInstanceProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_instance_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_instance_profile.async_delete_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_login_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_login_profile_request.DeleteLoginProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_login_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_login_profile.async_delete_login_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_open_id_connect_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_open_id_connect_provider_request.DeleteOpenIDConnectProviderRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_open_id_connect_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_open_id_connect_provider.async_delete_open_id_connect_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_policy_request.DeletePolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_policy.async_delete_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_policy_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_policy_version_request.DeletePolicyVersionRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_policy_version

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_policy_version.async_delete_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_role_request.DeleteRoleRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_role

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_role.async_delete_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_role_permissions_boundary(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_role_permissions_boundary_request.DeleteRolePermissionsBoundaryRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_role_permissions_boundary

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_role_permissions_boundary.async_delete_role_permissions_boundary(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_role_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_role_policy_request.DeleteRolePolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_role_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_role_policy.async_delete_role_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_saml_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_saml_provider_request.DeleteSAMLProviderRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_saml_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_saml_provider.async_delete_saml_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_server_certificate(
        self,
        server_certificate_name: "capo_iam.types.server_certificate_name_type.serverCertificateNameType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_server_certificate_request.DeleteServerCertificateRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_server_certificate

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_server_certificate.async_delete_server_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_service_linked_role(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.delete_service_linked_role_response.DeleteServiceLinkedRoleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_service_linked_role_request.DeleteServiceLinkedRoleRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.delete_service_linked_role_response.DeleteServiceLinkedRoleResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_service_linked_role

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_service_linked_role.async_delete_service_linked_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_service_specific_credential(
        self,
        service_specific_credential_id: "capo_iam.types.service_specific_credential_id.serviceSpecificCredentialId",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        user_name: Optional["capo_iam.types.user_name_type.userNameType"] = None,
    ) -> None:
        r"""<p>Deletes the specified service-specific credential.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_service_specific_credential_request.DeleteServiceSpecificCredentialRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_service_specific_credential

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_service_specific_credential.async_delete_service_specific_credential(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_signing_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_signing_certificate_request.DeleteSigningCertificateRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_signing_certificate

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_signing_certificate.async_delete_signing_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_ssh_public_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_ssh_public_key_request.DeleteSSHPublicKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_ssh_public_key

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_ssh_public_key.async_delete_ssh_public_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_user_request.DeleteUserRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_user

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_user.async_delete_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_permissions_boundary(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_user_permissions_boundary_request.DeleteUserPermissionsBoundaryRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_user_permissions_boundary

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_user_permissions_boundary.async_delete_user_permissions_boundary(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_user_policy_request.DeleteUserPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_user_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_user_policy.async_delete_user_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_virtual_mfa_device(
        ...
        *,
        ...
        r"""<p>Deletes a virtual MFA device.</p> <note> <p> You must deactivate a user's virtual MFA device before you can delete it. For information about deactivating MFA devices, see <a href=\"https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeactivateMFADevice.html\">DeactivateMFADevice</a>. </p> </note>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.delete_virtual_mfa_device_request.DeleteVirtualMFADeviceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.delete_virtual_mfa_device

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.delete_virtual_mfa_device.async_delete_virtual_mfa_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_group_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.detach_group_policy_request.DetachGroupPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.detach_group_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.detach_group_policy.async_detach_group_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_role_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.detach_role_policy_request.DetachRolePolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.detach_role_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.detach_role_policy.async_detach_role_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_user_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.detach_user_policy_request.DetachUserPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.detach_user_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.detach_user_policy.async_detach_user_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_organizations_root_credentials_management(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.disable_organizations_root_credentials_management_response.DisableOrganizationsRootCredentialsManagementResponse":
        ...
        Raises:
            capo_iam.errors.account_not_management_or_delegated_administrator_exception.AccountNotManagementOrDelegatedAdministratorException: <p>The request was rejected because the account making the request is not the management account or delegated administrator account for <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_root-user.html#id_root-user-access-management\">centralized root access</a>.</p>
            capo_iam.errors.organization_not_found_exception.OrganizationNotFoundException: <p>The request was rejected because no organization is associated with your account.</p>
            capo_iam.errors.organization_not_in_all_features_mode_exception.OrganizationNotInAllFeaturesModeException: <p>The request was rejected because your organization does not have All features enabled. For more information, see <a href=\"https://docs.aws.amazon.com/organizations/latest/userguide/orgs_getting-started_concepts.html#feature-set\">Available feature sets</a> in the <i>Organizations User Guide</i>.</p>
            capo_iam.errors.service_access_not_enabled_exception.ServiceAccessNotEnabledException: <p>The request was rejected because trusted access is not enabled for IAM in Organizations. For details, see IAM and Organizations in the <i>Organizations User Guide</i>.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.disable_organizations_root_credentials_management_request.DisableOrganizationsRootCredentialsManagementRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.disable_organizations_root_credentials_management_response.DisableOrganizationsRootCredentialsManagementResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.disable_organizations_root_credentials_management

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.disable_organizations_root_credentials_management.async_disable_organizations_root_credentials_management(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_organizations_root_sessions(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.disable_organizations_root_sessions_response.DisableOrganizationsRootSessionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.disable_organizations_root_sessions_request.DisableOrganizationsRootSessionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.disable_organizations_root_sessions_response.DisableOrganizationsRootSessionsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.disable_organizations_root_sessions

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.disable_organizations_root_sessions.async_disable_organizations_root_sessions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_outbound_web_identity_federation(
        ...
        Raises:
            capo_iam.errors.feature_disabled_exception.FeatureDisabledException: <p>The request failed because outbound identity federation is already disabled for your Amazon Web Services account. You cannot disable the feature multiple times</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        async def _handler(
            ...
            import capo_iam._operations.aws_identity_management_v20100508.disable_outbound_web_identity_federation

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.disable_outbound_web_identity_federation.async_disable_outbound_web_identity_federation(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_mfa_device(
        ...
        user_name: "capo_iam.types.existing_user_name_type.existingUserNameType",
        serial_number: "capo_iam.types.serial_number_type.serialNumberType",
        authentication_code1: "capo_iam.types.authentication_code_type.authenticationCodeType",
        authentication_code2: "capo_iam.types.authentication_code_type.authenticationCodeType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> None:
        r"""<p>Enables the specified MFA device and associates it with the specified IAM user. When enabled, the MFA device is required for every subsequent login by the IAM user associated with the device.</p>
        ...
        Raises:
            ...
            capo_iam.errors.entity_already_exists_exception.EntityAlreadyExistsException: <p>The request was rejected because it attempted to create a resource that already exists.</p>
            capo_iam.errors.entity_temporarily_unmodifiable_exception.EntityTemporarilyUnmodifiableException: <p>The request was rejected because it referenced an entity that is temporarily unmodifiable, such as a user name that was deleted and then recreated. The error indicates that the request is likely to succeed if you try again after waiting several minutes. The error message describes the entity.</p>
            capo_iam.errors.invalid_authentication_code_exception.InvalidAuthenticationCodeException: <p>The request was rejected because the authentication code was not recognized. The error message describes the specific error.</p>
            capo_iam.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because it attempted to create resources beyond the current Amazon Web Services account limits. The error message describes the limit exceeded.</p>
            capo_iam.errors.no_such_entity_exception.NoSuchEntityException: <p>The request was rejected because it referenced a resource entity that does not exist. The error message describes the resource.</p>
            capo_iam.errors.service_failure_exception.ServiceFailureException: <p>The request processing has failed because of an unknown error, exception or failure.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.enable_mfa_device_request.EnableMFADeviceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.enable_mfa_device

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.enable_mfa_device.async_enable_mfa_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_organizations_root_credentials_management(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.enable_organizations_root_credentials_management_response.EnableOrganizationsRootCredentialsManagementResponse":
        ...
        Raises:
            capo_iam.errors.account_not_management_or_delegated_administrator_exception.AccountNotManagementOrDelegatedAdministratorException: <p>The request was rejected because the account making the request is not the management account or delegated administrator account for <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_root-user.html#id_root-user-access-management\">centralized root access</a>.</p>
            capo_iam.errors.caller_is_not_management_account_exception.CallerIsNotManagementAccountException: <p>The request was rejected because the account making the request is not the management account for the organization.</p>
            capo_iam.errors.organization_not_found_exception.OrganizationNotFoundException: <p>The request was rejected because no organization is associated with your account.</p>
            capo_iam.errors.organization_not_in_all_features_mode_exception.OrganizationNotInAllFeaturesModeException: <p>The request was rejected because your organization does not have All features enabled. For more information, see <a href=\"https://docs.aws.amazon.com/organizations/latest/userguide/orgs_getting-started_concepts.html#feature-set\">Available feature sets</a> in the <i>Organizations User Guide</i>.</p>
            capo_iam.errors.service_access_not_enabled_exception.ServiceAccessNotEnabledException: <p>The request was rejected because trusted access is not enabled for IAM in Organizations. For details, see IAM and Organizations in the <i>Organizations User Guide</i>.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.enable_organizations_root_credentials_management_request.EnableOrganizationsRootCredentialsManagementRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.enable_organizations_root_credentials_management_response.EnableOrganizationsRootCredentialsManagementResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.enable_organizations_root_credentials_management

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.enable_organizations_root_credentials_management.async_enable_organizations_root_credentials_management(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_organizations_root_sessions(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.enable_organizations_root_sessions_response.EnableOrganizationsRootSessionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.enable_organizations_root_sessions_request.EnableOrganizationsRootSessionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.enable_organizations_root_sessions_response.EnableOrganizationsRootSessionsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.enable_organizations_root_sessions

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.enable_organizations_root_sessions.async_enable_organizations_root_sessions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_outbound_web_identity_federation(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.enable_outbound_web_identity_federation_response.EnableOutboundWebIdentityFederationResponse":
        ...
        async def _handler(
            ...
            import capo_iam._operations.aws_identity_management_v20100508.enable_outbound_web_identity_federation

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.enable_outbound_web_identity_federation.async_enable_outbound_web_identity_federation(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_credential_report(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.generate_credential_report_response.GenerateCredentialReportResponse":
        ...
        async def _handler(
            ...
            import capo_iam._operations.aws_identity_management_v20100508.generate_credential_report

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.generate_credential_report.async_generate_credential_report(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_organizations_access_report(
        self,
        entity_path: "capo_iam.types.organizations_entity_path_type.organizationsEntityPathType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        organizations_policy_id: Optional[
            "capo_iam.types.organizations_policy_id_type.organizationsPolicyIdType"
        ] = None,
    ) -> "capo_iam.types.generate_organizations_access_report_response.GenerateOrganizationsAccessReportResponse":
        ...
        Raises:
            capo_iam.errors.report_generation_limit_exceeded_exception.ReportGenerationLimitExceededException: <p>The request failed because the maximum number of concurrent requests for this account are already running.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.generate_organizations_access_report_request.GenerateOrganizationsAccessReportRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.generate_organizations_access_report_response.GenerateOrganizationsAccessReportResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.generate_organizations_access_report

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.generate_organizations_access_report.async_generate_organizations_access_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_service_last_accessed_details(
        ...
        *,
    ...
    ) -> "capo_iam.types.generate_service_last_accessed_details_response.GenerateServiceLastAccessedDetailsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.generate_service_last_accessed_details_request.GenerateServiceLastAccessedDetailsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.generate_service_last_accessed_details_response.GenerateServiceLastAccessedDetailsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.generate_service_last_accessed_details

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.generate_service_last_accessed_details.async_generate_service_last_accessed_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_access_key_last_used(
        ...
        *,
        ...
        "capo_iam.types.get_access_key_last_used_response.GetAccessKeyLastUsedResponse"
    ):
        r"""<p>Retrieves information about when the specified access key was last used. The information includes the date and time of last use, along with the Amazon Web Services service and Region that were specified in the last request made with that key.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_access_key_last_used_request.GetAccessKeyLastUsedRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_access_key_last_used_response.GetAccessKeyLastUsedResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_access_key_last_used

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_access_key_last_used.async_get_access_key_last_used(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_authorization_details(
        ...
        *,
    ...
    ) -> "capo_iam.types.get_account_authorization_details_response.GetAccountAuthorizationDetailsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_account_authorization_details_request.GetAccountAuthorizationDetailsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_account_authorization_details_response.GetAccountAuthorizationDetailsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_account_authorization_details

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_account_authorization_details.async_get_account_authorization_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_password_policy(
        ...
        async def _handler(
            ...
            import capo_iam._operations.aws_identity_management_v20100508.get_account_password_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_account_password_policy.async_get_account_password_policy(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_properties(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_account_properties_request.GetAccountPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_account_properties_response.GetAccountPropertiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_account_properties.async_get_account_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_summary(
        ...
        async def _handler(
            ...
            import capo_iam._operations.aws_identity_management_v20100508.get_account_summary

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_account_summary.async_get_account_summary(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_context_keys_for_custom_policy(
        self,
        policy_input_list: "capo_iam.types.simulation_policy_list_type.SimulationPolicyListType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_context_keys_for_custom_policy_request.GetContextKeysForCustomPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_context_keys_for_policy_response.GetContextKeysForPolicyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_context_keys_for_custom_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_context_keys_for_custom_policy.async_get_context_keys_for_custom_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_context_keys_for_principal_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_context_keys_for_principal_policy_request.GetContextKeysForPrincipalPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_context_keys_for_policy_response.GetContextKeysForPolicyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_context_keys_for_principal_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_context_keys_for_principal_policy.async_get_context_keys_for_principal_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_credential_report(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.get_credential_report_response.GetCredentialReportResponse":
        ...
        async def _handler(
            ...
            import capo_iam._operations.aws_identity_management_v20100508.get_credential_report

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_credential_report.async_get_credential_report(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_delegation_request(
        ...
        *,
    ...
    ) -> "capo_iam.types.get_delegation_request_response.GetDelegationRequestResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_delegation_request_request.GetDelegationRequestRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_delegation_request_response.GetDelegationRequestResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_delegation_request

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_delegation_request.async_get_delegation_request(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_group(
        ...
        *,
        ...
        r"""<p> Returns a list of IAM users that are in the specified IAM group. You can paginate the results using the <code>MaxItems</code> and <code>Marker</code> parameters.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_group_request.GetGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_group_response.GetGroupResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_group

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_group.async_get_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_group(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.user.User]":
        _token = marker
        while True:
    ...
    async def get_group_policy(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_group_policy_response.GetGroupPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_group_policy_request.GetGroupPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_group_policy_response.GetGroupPolicyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_group_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_group_policy.async_get_group_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_human_readable_summary(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        locale: Optional["capo_iam.types.locale_type.localeType"] = None,
    ) -> "capo_iam.types.get_human_readable_summary_response.GetHumanReadableSummaryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_human_readable_summary_request.GetHumanReadableSummaryRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_human_readable_summary_response.GetHumanReadableSummaryResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_human_readable_summary

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_human_readable_summary.async_get_human_readable_summary(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_instance_profile(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_instance_profile_response.GetInstanceProfileResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_instance_profile_request.GetInstanceProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_instance_profile_response.GetInstanceProfileResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_instance_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_instance_profile.async_get_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def wait_until_instance_profile_exists(
        ...
        *,
        ...
        r"""Wait for instance_profile_exists.
        ...
        attempt = 0
        while True:
            op_output: "capo_iam.types.get_instance_profile_response.GetInstanceProfileResponse | None" = None
    ...
    async def get_login_profile(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        user_name: Optional["capo_iam.types.user_name_type.userNameType"] = None,
    ) -> "capo_iam.types.get_login_profile_response.GetLoginProfileResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_login_profile_request.GetLoginProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_login_profile_response.GetLoginProfileResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_login_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_login_profile.async_get_login_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_mfa_device(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        user_name: Optional["capo_iam.types.user_name_type.userNameType"] = None,
    ) -> "capo_iam.types.get_mfa_device_response.GetMFADeviceResponse":
        r"""<p>Retrieves information about an MFA device for a specified user.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_mfa_device_request.GetMFADeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_mfa_device_response.GetMFADeviceResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_mfa_device

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_mfa_device.async_get_mfa_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_open_id_connect_provider(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_open_id_connect_provider_response.GetOpenIDConnectProviderResponse":
        r"""<p>Returns information about the specified OpenID Connect (OIDC) provider resource object in IAM.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_open_id_connect_provider_request.GetOpenIDConnectProviderRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_open_id_connect_provider_response.GetOpenIDConnectProviderResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_open_id_connect_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_open_id_connect_provider.async_get_open_id_connect_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_organizations_access_report(
        ...
        *,
        ...
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        sort_key: Optional["capo_iam.types.sort_key_type.sortKeyType"] = None,
    ) -> "capo_iam.types.get_organizations_access_report_response.GetOrganizationsAccessReportResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_organizations_access_report_request.GetOrganizationsAccessReportRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_organizations_access_report_response.GetOrganizationsAccessReportResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_organizations_access_report

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_organizations_access_report.async_get_organizations_access_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_outbound_web_identity_federation_info(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.get_outbound_web_identity_federation_info_response.GetOutboundWebIdentityFederationInfoResponse":
        ...
        async def _handler(
            ...
            import capo_iam._operations.aws_identity_management_v20100508.get_outbound_web_identity_federation_info

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_outbound_web_identity_federation_info.async_get_outbound_web_identity_federation_info(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_policy(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_policy_response.GetPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_policy_request.GetPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_policy_response.GetPolicyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_policy.async_get_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def wait_until_policy_exists(
        ...
        *,
        ...
        attempt = 0
        while True:
            op_output: "capo_iam.types.get_policy_response.GetPolicyResponse | None" = (
                None
            )
            op_error: ServiceError | None = None
            try:
    ...
    async def get_policy_version(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_policy_version_response.GetPolicyVersionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_policy_version_request.GetPolicyVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_policy_version_response.GetPolicyVersionResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_policy_version

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_policy_version.async_get_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_role(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_role_response.GetRoleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_role_request.GetRoleRequest]",
        ) -> AsyncOperationResponse["capo_iam.types.get_role_response.GetRoleResponse"]:
            import capo_iam._operations.aws_identity_management_v20100508.get_role

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_role.async_get_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def wait_until_role_exists(
        ...
        *,
        ...
        attempt = 0
        while True:
            op_output: "capo_iam.types.get_role_response.GetRoleResponse | None" = None
            op_error: ServiceError | None = None
            try:
    ...
    async def get_role_policy(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_role_policy_response.GetRolePolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_role_policy_request.GetRolePolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_role_policy_response.GetRolePolicyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_role_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_role_policy.async_get_role_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_role_template_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_role_template_version_request.GetRoleTemplateVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_role_template_version_response.GetRoleTemplateVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_role_template_version.async_get_role_template_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_saml_provider(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_saml_provider_response.GetSAMLProviderResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_saml_provider_request.GetSAMLProviderRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_saml_provider_response.GetSAMLProviderResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_saml_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_saml_provider.async_get_saml_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_server_certificate(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_server_certificate_response.GetServerCertificateResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_server_certificate_request.GetServerCertificateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_server_certificate_response.GetServerCertificateResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_server_certificate

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_server_certificate.async_get_server_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_service_last_accessed_details(
        ...
        *,
        ...
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
    ) -> "capo_iam.types.get_service_last_accessed_details_response.GetServiceLastAccessedDetailsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_service_last_accessed_details_request.GetServiceLastAccessedDetailsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_service_last_accessed_details_response.GetServiceLastAccessedDetailsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_service_last_accessed_details

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_service_last_accessed_details.async_get_service_last_accessed_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_service_last_accessed_details_with_entities(
        ...
        *,
        ...
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
    ) -> "capo_iam.types.get_service_last_accessed_details_with_entities_response.GetServiceLastAccessedDetailsWithEntitiesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_service_last_accessed_details_with_entities_request.GetServiceLastAccessedDetailsWithEntitiesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_service_last_accessed_details_with_entities_response.GetServiceLastAccessedDetailsWithEntitiesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_service_last_accessed_details_with_entities

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_service_last_accessed_details_with_entities.async_get_service_last_accessed_details_with_entities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_service_linked_role_deletion_status(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_service_linked_role_deletion_status_response.GetServiceLinkedRoleDeletionStatusResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_service_linked_role_deletion_status_request.GetServiceLinkedRoleDeletionStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_service_linked_role_deletion_status_response.GetServiceLinkedRoleDeletionStatusResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_service_linked_role_deletion_status

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_service_linked_role_deletion_status.async_get_service_linked_role_deletion_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_ssh_public_key(
        ...
        user_name: "capo_iam.types.user_name_type.userNameType",
        ssh_public_key_id: "capo_iam.types.public_key_id_type.publicKeyIdType",
        encoding: "capo_iam.types.encoding_type.encodingType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_ssh_public_key_response.GetSSHPublicKeyResponse":
        ...
        Raises:
            capo_iam.errors.no_such_entity_exception.NoSuchEntityException: <p>The request was rejected because it referenced a resource entity that does not exist. The error message describes the resource.</p>
            capo_iam.errors.unrecognized_public_key_encoding_exception.UnrecognizedPublicKeyEncodingException: <p>The request was rejected because the public key encoding format is unsupported or unrecognized.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_ssh_public_key_request.GetSSHPublicKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_ssh_public_key_response.GetSSHPublicKeyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_ssh_public_key

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_ssh_public_key.async_get_ssh_public_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_user(
        ...
        *,
    ...
    ) -> "capo_iam.types.get_user_response.GetUserResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_user_request.GetUserRequest]",
        ) -> AsyncOperationResponse["capo_iam.types.get_user_response.GetUserResponse"]:
            import capo_iam._operations.aws_identity_management_v20100508.get_user

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_user.async_get_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def wait_until_user_exists(
        ...
        *,
        ...
        attempt = 0
        while True:
            op_output: "capo_iam.types.get_user_response.GetUserResponse | None" = None
            op_error: ServiceError | None = None
            try:
    ...
    async def get_user_policy(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.get_user_policy_response.GetUserPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.get_user_policy_request.GetUserPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.get_user_policy_response.GetUserPolicyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.get_user_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.get_user_policy.async_get_user_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_access_keys(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_access_keys_response.ListAccessKeysResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_access_keys_request.ListAccessKeysRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_access_keys_response.ListAccessKeysResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_access_keys

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_access_keys.async_list_access_keys(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_access_keys(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.access_key_metadata.AccessKeyMetadata]":
        _token = marker
        while True:
    ...
    async def list_account_aliases(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_account_aliases_request.ListAccountAliasesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_account_aliases_response.ListAccountAliasesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_account_aliases

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_account_aliases.async_list_account_aliases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_account_aliases(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.account_alias_type.accountAliasType]":
        _token = marker
        while True:
    ...
    async def list_attached_group_policies(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        path_prefix: Optional["capo_iam.types.policy_path_type.policyPathType"] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_attached_group_policies_response.ListAttachedGroupPoliciesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_attached_group_policies_request.ListAttachedGroupPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_attached_group_policies_response.ListAttachedGroupPoliciesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_attached_group_policies

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_attached_group_policies.async_list_attached_group_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_attached_group_policies(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.attached_policy.AttachedPolicy]":
        _token = marker
        while True:
    ...
    async def list_attached_role_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_attached_role_policies_request.ListAttachedRolePoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_attached_role_policies_response.ListAttachedRolePoliciesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_attached_role_policies

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_attached_role_policies.async_list_attached_role_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_attached_user_policies(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_attached_user_policies_response.ListAttachedUserPoliciesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_attached_user_policies_request.ListAttachedUserPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_attached_user_policies_response.ListAttachedUserPoliciesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_attached_user_policies

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_attached_user_policies.async_list_attached_user_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_delegation_requests(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        owner_id: Optional["capo_iam.types.owner_id_type.ownerIdType"] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_delegation_requests_response.ListDelegationRequestsResponse":
        r"""<p>Lists delegation requests based on the specified criteria.</p> <p>If a delegation request has no owner, even if it is assigned to a specific account, it will not be part of the <code>ListDelegationRequests</code> output for that account.</p> <p> For more details, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies-temporary-delegation.html#temporary-delegation-managing-permissions\"> Managing Permissions for Delegation Requests</a>. </p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_delegation_requests_request.ListDelegationRequestsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_delegation_requests_response.ListDelegationRequestsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_delegation_requests

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_delegation_requests.async_list_delegation_requests(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_entities_for_policy(
        ...
        *,
        ...
        "capo_iam.types.list_entities_for_policy_response.ListEntitiesForPolicyResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_entities_for_policy_request.ListEntitiesForPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_entities_for_policy_response.ListEntitiesForPolicyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_entities_for_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_entities_for_policy.async_list_entities_for_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_group_policies(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_group_policies_response.ListGroupPoliciesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_group_policies_request.ListGroupPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_group_policies_response.ListGroupPoliciesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_group_policies

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_group_policies.async_list_group_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_group_policies(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.policy_name_type.policyNameType]":
        _token = marker
        while True:
    ...
    async def list_groups(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        path_prefix: Optional["capo_iam.types.path_prefix_type.pathPrefixType"] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_groups_response.ListGroupsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_groups_request.ListGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_groups_response.ListGroupsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_groups

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_groups.async_list_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_groups(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.group.Group]":
        _token = marker
        while True:
    ...
    async def list_groups_for_user(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_groups_for_user_response.ListGroupsForUserResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_groups_for_user_request.ListGroupsForUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_groups_for_user_response.ListGroupsForUserResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_groups_for_user

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_groups_for_user.async_list_groups_for_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_instance_profiles(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_instance_profiles_response.ListInstanceProfilesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_instance_profiles_request.ListInstanceProfilesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_instance_profiles_response.ListInstanceProfilesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_instance_profiles

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_instance_profiles.async_list_instance_profiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_instance_profiles(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.instance_profile.InstanceProfile]":
        _token = marker
        while True:
    ...
    async def list_instance_profiles_for_role(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_instance_profiles_for_role_response.ListInstanceProfilesForRoleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_instance_profiles_for_role_request.ListInstanceProfilesForRoleRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_instance_profiles_for_role_response.ListInstanceProfilesForRoleResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_instance_profiles_for_role

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_instance_profiles_for_role.async_list_instance_profiles_for_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_instance_profile_tags(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_instance_profile_tags_response.ListInstanceProfileTagsResponse":
        r"""<p>Lists the tags that are attached to the specified IAM instance profile. The returned list of tags is sorted by tag key. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_instance_profile_tags_request.ListInstanceProfileTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_instance_profile_tags_response.ListInstanceProfileTagsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_instance_profile_tags

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_instance_profile_tags.async_list_instance_profile_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_instance_profile_tags(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.tag.Tag]":
        _token = marker
        while True:
    ...
    async def list_mfa_devices(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_mfa_devices_response.ListMFADevicesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_mfa_devices_request.ListMFADevicesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_mfa_devices_response.ListMFADevicesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_mfa_devices

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_mfa_devices.async_list_mfa_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_mfa_devices(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.mfa_device.MFADevice]":
        _token = marker
        while True:
    ...
    async def list_mfa_device_tags(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_mfa_device_tags_response.ListMFADeviceTagsResponse":
        r"""<p>Lists the tags that are attached to the specified IAM virtual multi-factor authentication (MFA) device. The returned list of tags is sorted by tag key. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_mfa_device_tags_request.ListMFADeviceTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_mfa_device_tags_response.ListMFADeviceTagsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_mfa_device_tags

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_mfa_device_tags.async_list_mfa_device_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_open_id_connect_providers(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.list_open_id_connect_providers_response.ListOpenIDConnectProvidersResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_open_id_connect_providers_request.ListOpenIDConnectProvidersRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_open_id_connect_providers_response.ListOpenIDConnectProvidersResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_open_id_connect_providers

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_open_id_connect_providers.async_list_open_id_connect_providers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_open_id_connect_provider_tags(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_open_id_connect_provider_tags_response.ListOpenIDConnectProviderTagsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_open_id_connect_provider_tags_request.ListOpenIDConnectProviderTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_open_id_connect_provider_tags_response.ListOpenIDConnectProviderTagsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_open_id_connect_provider_tags

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_open_id_connect_provider_tags.async_list_open_id_connect_provider_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_organizations_features(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.list_organizations_features_response.ListOrganizationsFeaturesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_organizations_features_request.ListOrganizationsFeaturesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_organizations_features_response.ListOrganizationsFeaturesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_organizations_features

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_organizations_features.async_list_organizations_features(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_policies(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        scope: Optional["capo_iam.types.policy_scope_type.policyScopeType"] = None,
        only_attached: Optional["capo_iam.types.boolean_type.booleanType"] = None,
        path_prefix: Optional["capo_iam.types.policy_path_type.policyPathType"] = None,
        policy_usage_filter: Optional[
            "capo_iam.types.policy_usage_type.PolicyUsageType"
        ] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_policies_response.ListPoliciesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_policies_request.ListPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_policies_response.ListPoliciesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_policies

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_policies.async_list_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_policies(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.policy.Policy]":
        _token = marker
        while True:
    ...
    async def list_policies_granting_service_access(
        self,
        arn: "capo_iam.types.arn_type.arnType",
        service_namespaces: "capo_iam.types.service_namespace_list_type.serviceNamespaceListType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
    ) -> "capo_iam.types.list_policies_granting_service_access_response.ListPoliciesGrantingServiceAccessResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_policies_granting_service_access_request.ListPoliciesGrantingServiceAccessRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_policies_granting_service_access_response.ListPoliciesGrantingServiceAccessResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_policies_granting_service_access

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_policies_granting_service_access.async_list_policies_granting_service_access(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_policy_tags(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_policy_tags_response.ListPolicyTagsResponse":
        r"""<p>Lists the tags that are attached to the specified IAM customer managed policy. The returned list of tags is sorted by tag key. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_policy_tags_request.ListPolicyTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_policy_tags_response.ListPolicyTagsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_policy_tags

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_policy_tags.async_list_policy_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_policy_versions(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_policy_versions_response.ListPolicyVersionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_policy_versions_request.ListPolicyVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_policy_versions_response.ListPolicyVersionsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_policy_versions

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_policy_versions.async_list_policy_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_policy_versions(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.policy_version.PolicyVersion]":
        _token = marker
        while True:
    ...
    async def list_role_policies(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_role_policies_response.ListRolePoliciesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_role_policies_request.ListRolePoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_role_policies_response.ListRolePoliciesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_role_policies

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_role_policies.async_list_role_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_roles(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_roles_response.ListRolesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_roles_request.ListRolesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_roles_response.ListRolesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_roles

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_roles.async_list_roles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_roles(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.role.Role]":
        _token = marker
        while True:
    ...
    async def list_role_tags(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_role_tags_response.ListRoleTagsResponse":
        r"""<p>Lists the tags that are attached to the specified role. The returned list of tags is sorted by tag key. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_role_tags_request.ListRoleTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_role_tags_response.ListRoleTagsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_role_tags

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_role_tags.async_list_role_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_saml_providers(
        self, *, config_overrides: Optional[AsyncIAMClientConfig] = None
    ) -> "capo_iam.types.list_saml_providers_response.ListSAMLProvidersResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_saml_providers_request.ListSAMLProvidersRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_saml_providers_response.ListSAMLProvidersResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_saml_providers

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_saml_providers.async_list_saml_providers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_saml_provider_tags(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_saml_provider_tags_response.ListSAMLProviderTagsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_saml_provider_tags_request.ListSAMLProviderTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_saml_provider_tags_response.ListSAMLProviderTagsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_saml_provider_tags

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_saml_provider_tags.async_list_saml_provider_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_server_certificates(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_server_certificates_response.ListServerCertificatesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_server_certificates_request.ListServerCertificatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_server_certificates_response.ListServerCertificatesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_server_certificates

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_server_certificates.async_list_server_certificates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_server_certificates(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.server_certificate_metadata.ServerCertificateMetadata]":
        _token = marker
        while True:
    ...
    async def list_server_certificate_tags(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_server_certificate_tags_response.ListServerCertificateTagsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_server_certificate_tags_request.ListServerCertificateTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_server_certificate_tags_response.ListServerCertificateTagsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_server_certificate_tags

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_server_certificate_tags.async_list_server_certificate_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_service_specific_credentials(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        user_name: Optional["capo_iam.types.user_name_type.userNameType"] = None,
        service_name: Optional["capo_iam.types.service_name.serviceName"] = None,
        all_users: Optional["capo_iam.types.all_users.allUsers"] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_service_specific_credentials_request.ListServiceSpecificCredentialsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_service_specific_credentials_response.ListServiceSpecificCredentialsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_service_specific_credentials

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_service_specific_credentials.async_list_service_specific_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_signing_certificates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_signing_certificates_request.ListSigningCertificatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_signing_certificates_response.ListSigningCertificatesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_signing_certificates

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_signing_certificates.async_list_signing_certificates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_signing_certificates(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.signing_certificate.SigningCertificate]":
        _token = marker
        while True:
    ...
    async def list_ssh_public_keys(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_ssh_public_keys_response.ListSSHPublicKeysResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_ssh_public_keys_request.ListSSHPublicKeysRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_ssh_public_keys_response.ListSSHPublicKeysResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_ssh_public_keys

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_ssh_public_keys.async_list_ssh_public_keys(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_ssh_public_keys(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.ssh_public_key_metadata.SSHPublicKeyMetadata]":
        _token = marker
        while True:
    ...
    async def list_user_policies(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_user_policies_response.ListUserPoliciesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_user_policies_request.ListUserPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_user_policies_response.ListUserPoliciesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_user_policies

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_user_policies.async_list_user_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_users(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_users_response.ListUsersResponse":
        r"""<p>Lists the IAM users that have the specified path prefix. If no path prefix is specified, the operation returns all users in the Amazon Web Services account. If there are none, the operation returns an empty list.</p> <note> <p>IAM resource-listing operations return a subset of the available attributes for the resource. This operation does not return the following attributes, even though they are an attribute of the returned object:</p> <ul> <li> <p>PermissionsBoundary</p> </li> <li> <p>Tags</p> </li> </ul> <p>To view all of the information for a user, see <a href=\"https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetUser.html\">GetUser</a>.</p> </note> <p>You can paginate the results using the <code>MaxItems</code> and <code>Marker</code> parameters.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_users_request.ListUsersRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_users_response.ListUsersResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_users

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_users.async_list_users(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_user_tags(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "capo_iam.types.list_user_tags_response.ListUserTagsResponse":
        r"""<p>Lists the tags that are attached to the specified IAM user. The returned list of tags is sorted by tag key. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_user_tags_request.ListUserTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_user_tags_response.ListUserTagsResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_user_tags

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_user_tags.async_list_user_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_virtual_mfa_devices(
        ...
        *,
        ...
        assignment_status: Optional[
            "capo_iam.types.assignment_status_type.assignmentStatusType"
        ] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> (
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.list_virtual_mfa_devices_request.ListVirtualMFADevicesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.list_virtual_mfa_devices_response.ListVirtualMFADevicesResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.list_virtual_mfa_devices

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.list_virtual_mfa_devices.async_list_virtual_mfa_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_virtual_mfa_devices(
        ...
        *,
        ...
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
    ) -> "AsyncIterator[capo_iam.types.virtual_mfa_device.VirtualMFADevice]":
        _token = marker
        while True:
    ...
    async def put_account_properties(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.put_account_properties_request.PutAccountPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.put_account_properties_response.PutAccountPropertiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.put_account_properties.async_put_account_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_group_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.put_group_policy_request.PutGroupPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.put_group_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.put_group_policy.async_put_group_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_role_permissions_boundary(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.put_role_permissions_boundary_request.PutRolePermissionsBoundaryRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.put_role_permissions_boundary

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.put_role_permissions_boundary.async_put_role_permissions_boundary(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_role_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.put_role_policy_request.PutRolePolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.put_role_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.put_role_policy.async_put_role_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_user_permissions_boundary(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.put_user_permissions_boundary_request.PutUserPermissionsBoundaryRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.put_user_permissions_boundary

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.put_user_permissions_boundary.async_put_user_permissions_boundary(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_user_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.put_user_policy_request.PutUserPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.put_user_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.put_user_policy.async_put_user_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reject_delegation_request(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.reject_delegation_request_request.RejectDelegationRequestRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.reject_delegation_request

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.reject_delegation_request.async_reject_delegation_request(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_client_id_from_open_id_connect_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.remove_client_id_from_open_id_connect_provider_request.RemoveClientIDFromOpenIDConnectProviderRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.remove_client_id_from_open_id_connect_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.remove_client_id_from_open_id_connect_provider.async_remove_client_id_from_open_id_connect_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_role_from_instance_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.remove_role_from_instance_profile_request.RemoveRoleFromInstanceProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.remove_role_from_instance_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.remove_role_from_instance_profile.async_remove_role_from_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_user_from_group(
        ...
        *,
        ...
        r"""<p>Removes the specified user from the specified group.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.remove_user_from_group_request.RemoveUserFromGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.remove_user_from_group

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.remove_user_from_group.async_remove_user_from_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reset_service_specific_credential(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        user_name: Optional["capo_iam.types.user_name_type.userNameType"] = None,
    ) -> "capo_iam.types.reset_service_specific_credential_response.ResetServiceSpecificCredentialResponse":
        r"""<p>Resets the password for a service-specific credential. The new password is Amazon Web Services generated and cryptographically strong. It cannot be configured by the user. Resetting the password immediately invalidates the previous password associated with this user.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.reset_service_specific_credential_request.ResetServiceSpecificCredentialRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.reset_service_specific_credential_response.ResetServiceSpecificCredentialResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.reset_service_specific_credential

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.reset_service_specific_credential.async_reset_service_specific_credential(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def resync_mfa_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.resync_mfa_device_request.ResyncMFADeviceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.resync_mfa_device

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.resync_mfa_device.async_resync_mfa_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_delegation_token(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.send_delegation_token_request.SendDelegationTokenRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.send_delegation_token

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.send_delegation_token.async_send_delegation_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_default_policy_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.set_default_policy_version_request.SetDefaultPolicyVersionRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.set_default_policy_version

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.set_default_policy_version.async_set_default_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_security_token_service_preferences(
        self,
        global_endpoint_token_version: "capo_iam.types.global_endpoint_token_version.globalEndpointTokenVersion",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.set_security_token_service_preferences_request.SetSecurityTokenServicePreferencesRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.set_security_token_service_preferences

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.set_security_token_service_preferences.async_set_security_token_service_preferences(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def simulate_custom_policy(
        ...
        *,
        ...
        Raises:
            capo_iam.errors.invalid_input_exception.InvalidInputException: <p>The request was rejected because an invalid or out-of-range value was supplied for an input parameter.</p>
            capo_iam.errors.policy_evaluation_exception.PolicyEvaluationException: <p>The request failed because a provided policy could not be successfully evaluated. An additional detailed message indicates the source of the failure.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.simulate_custom_policy_request.SimulateCustomPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.simulate_policy_response.SimulatePolicyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.simulate_custom_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.simulate_custom_policy.async_simulate_custom_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_simulate_custom_policy(
        ...
        *,
        ...
        max_items: Optional["capo_iam.types.max_items_type.maxItemsType"] = None,
        marker: Optional["capo_iam.types.marker_type.markerType"] = None,
    ) -> "AsyncIterator[capo_iam.types.evaluation_result.EvaluationResult]":
        _token = marker
        while True:
    ...
    async def simulate_principal_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.simulate_principal_policy_request.SimulatePrincipalPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.simulate_policy_response.SimulatePolicyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.simulate_principal_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.simulate_principal_policy.async_simulate_principal_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_instance_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.tag_instance_profile_request.TagInstanceProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.tag_instance_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.tag_instance_profile.async_tag_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_mfa_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.tag_mfa_device_request.TagMFADeviceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.tag_mfa_device

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.tag_mfa_device.async_tag_mfa_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_open_id_connect_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.tag_open_id_connect_provider_request.TagOpenIDConnectProviderRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.tag_open_id_connect_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.tag_open_id_connect_provider.async_tag_open_id_connect_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.tag_policy_request.TagPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.tag_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.tag_policy.async_tag_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.tag_role_request.TagRoleRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.tag_role

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.tag_role.async_tag_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_saml_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.tag_saml_provider_request.TagSAMLProviderRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.tag_saml_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.tag_saml_provider.async_tag_saml_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_server_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.tag_server_certificate_request.TagServerCertificateRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.tag_server_certificate

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.tag_server_certificate.async_tag_server_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.tag_user_request.TagUserRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.tag_user

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.tag_user.async_tag_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_instance_profile(
        ...
        *,
        ...
        r"""<p>Removes the specified tags from the IAM instance profile. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.untag_instance_profile_request.UntagInstanceProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.untag_instance_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.untag_instance_profile.async_untag_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_mfa_device(
        ...
        *,
        ...
        r"""<p>Removes the specified tags from the IAM virtual multi-factor authentication (MFA) device. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.untag_mfa_device_request.UntagMFADeviceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.untag_mfa_device

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.untag_mfa_device.async_untag_mfa_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_open_id_connect_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.untag_open_id_connect_provider_request.UntagOpenIDConnectProviderRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.untag_open_id_connect_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.untag_open_id_connect_provider.async_untag_open_id_connect_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_policy(
        ...
        *,
        ...
        r"""<p>Removes the specified tags from the customer managed policy. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.untag_policy_request.UntagPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.untag_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.untag_policy.async_untag_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_role(
        ...
        *,
        ...
        r"""<p>Removes the specified tags from the role. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.untag_role_request.UntagRoleRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.untag_role

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.untag_role.async_untag_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_saml_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.untag_saml_provider_request.UntagSAMLProviderRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.untag_saml_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.untag_saml_provider.async_untag_saml_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_server_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.untag_server_certificate_request.UntagServerCertificateRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.untag_server_certificate

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.untag_server_certificate.async_untag_server_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_user(
        ...
        *,
        ...
        r"""<p>Removes the specified tags from the user. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.untag_user_request.UntagUserRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.untag_user

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.untag_user.async_untag_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_access_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_access_key_request.UpdateAccessKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_access_key

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_access_key.async_update_access_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account_password_policy(
        ...
        *,
        ...
        require_symbols: Optional["capo_iam.types.boolean_type.booleanType"] = None,
        require_numbers: Optional["capo_iam.types.boolean_type.booleanType"] = None,
        ...
        hard_expiry: Optional[
            "capo_iam.types.boolean_object_type.booleanObjectType"
        ] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_account_password_policy_request.UpdateAccountPasswordPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_account_password_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_account_password_policy.async_update_account_password_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_assume_role_policy(
        ...
        *,
        ...
        r"""<p>Updates the policy that grants an IAM entity permission to assume a role. This is typically referred to as the \"role trust policy\". For more information about roles, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/roles-toplevel.html\">Using roles to delegate permissions and federate identities</a>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_assume_role_policy_request.UpdateAssumeRolePolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_assume_role_policy

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_assume_role_policy.async_update_assume_role_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_delegation_request(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_delegation_request_request.UpdateDelegationRequestRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_delegation_request

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_delegation_request.async_update_delegation_request(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_group(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        new_path: Optional["capo_iam.types.path_type.pathType"] = None,
        new_group_name: Optional["capo_iam.types.group_name_type.groupNameType"] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_group_request.UpdateGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_group

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_group.async_update_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_login_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_login_profile_request.UpdateLoginProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_login_profile

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_login_profile.async_update_login_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_open_id_connect_provider_thumbprint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_open_id_connect_provider_thumbprint_request.UpdateOpenIDConnectProviderThumbprintRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_open_id_connect_provider_thumbprint

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_open_id_connect_provider_thumbprint.async_update_open_id_connect_provider_thumbprint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_role(
        ...
        *,
    ...
    ) -> "capo_iam.types.update_role_response.UpdateRoleResponse":
        r"""<p>Updates the description or maximum session duration setting of a role.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_role_request.UpdateRoleRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.update_role_response.UpdateRoleResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.update_role

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_role.async_update_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_role_description(
        ...
        *,
        ...
        "capo_iam.types.update_role_description_response.UpdateRoleDescriptionResponse"
    ):
        r"""<p>Use <a href=\"https://docs.aws.amazon.com/IAM/latest/APIReference/API_UpdateRole.html\">UpdateRole</a> instead.</p> <p>Modifies only the description of a role. This operation performs the same function as the <code>Description</code> parameter in the <code>UpdateRole</code> operation.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_role_description_request.UpdateRoleDescriptionRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.update_role_description_response.UpdateRoleDescriptionResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.update_role_description

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_role_description.async_update_role_description(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_saml_provider(
        ...
        *,
    ...
    ) -> "capo_iam.types.update_saml_provider_response.UpdateSAMLProviderResponse":
        r"""<p>Updates the metadata document, SAML encryption settings, and private keys for an existing SAML provider. To rotate private keys, add your new private key and then remove the old key in a separate request.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_saml_provider_request.UpdateSAMLProviderRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.update_saml_provider_response.UpdateSAMLProviderResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.update_saml_provider

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_saml_provider.async_update_saml_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_server_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_server_certificate_request.UpdateServerCertificateRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_server_certificate

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_server_certificate.async_update_server_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_service_specific_credential(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_service_specific_credential_request.UpdateServiceSpecificCredentialRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_service_specific_credential

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_service_specific_credential.async_update_service_specific_credential(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_signing_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_signing_certificate_request.UpdateSigningCertificateRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_signing_certificate

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_signing_certificate.async_update_signing_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_ssh_public_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_ssh_public_key_request.UpdateSSHPublicKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_ssh_public_key

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_ssh_public_key.async_update_ssh_public_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        new_path: Optional["capo_iam.types.path_type.pathType"] = None,
        new_user_name: Optional["capo_iam.types.user_name_type.userNameType"] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.update_user_request.UpdateUserRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_iam._operations.aws_identity_management_v20100508.update_user

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.update_user.async_update_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def upload_server_certificate(
        ...
        private_key: "capo_iam.types.private_key_type.privateKeyType",
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
        path: Optional["capo_iam.types.path_type.pathType"] = None,
        certificate_chain: Optional[
            "capo_iam.types.certificate_chain_type.certificateChainType"
        ] = None,
        tags: Optional["capo_iam.types.tag_list_type.tagListType"] = None,
    ) -> "capo_iam.types.upload_server_certificate_response.UploadServerCertificateResponse":
        ...
        Raises:
            ...
            capo_iam.errors.entity_already_exists_exception.EntityAlreadyExistsException: <p>The request was rejected because it attempted to create a resource that already exists.</p>
            capo_iam.errors.invalid_input_exception.InvalidInputException: <p>The request was rejected because an invalid or out-of-range value was supplied for an input parameter.</p>
            capo_iam.errors.key_pair_mismatch_exception.KeyPairMismatchException: <p>The request was rejected because the public key certificate and the private key do not match.</p>
            capo_iam.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because it attempted to create resources beyond the current Amazon Web Services account limits. The error message describes the limit exceeded.</p>
            capo_iam.errors.malformed_certificate_exception.MalformedCertificateException: <p>The request was rejected because the certificate was malformed or expired. The error message describes the specific error.</p>
            capo_iam.errors.service_failure_exception.ServiceFailureException: <p>The request processing has failed because of an unknown error, exception or failure.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.upload_server_certificate_request.UploadServerCertificateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.upload_server_certificate_response.UploadServerCertificateResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.upload_server_certificate

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.upload_server_certificate.async_upload_server_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def upload_signing_certificate(
        ...
        *,
    ...
    ) -> "capo_iam.types.upload_signing_certificate_response.UploadSigningCertificateResponse":
        ...
        Raises:
            capo_iam.errors.concurrent_modification_exception.ConcurrentModificationException: <p>The request was rejected because multiple requests to change this object were submitted simultaneously. Wait a few minutes and submit your request again.</p>
            capo_iam.errors.duplicate_certificate_exception.DuplicateCertificateException: <p>The request was rejected because the same certificate is associated with an IAM user in the account.</p>
            capo_iam.errors.entity_already_exists_exception.EntityAlreadyExistsException: <p>The request was rejected because it attempted to create a resource that already exists.</p>
            capo_iam.errors.invalid_certificate_exception.InvalidCertificateException: <p>The request was rejected because the certificate is invalid.</p>
            capo_iam.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because it attempted to create resources beyond the current Amazon Web Services account limits. The error message describes the limit exceeded.</p>
            capo_iam.errors.malformed_certificate_exception.MalformedCertificateException: <p>The request was rejected because the certificate was malformed or expired. The error message describes the specific error.</p>
            capo_iam.errors.no_such_entity_exception.NoSuchEntityException: <p>The request was rejected because it referenced a resource entity that does not exist. The error message describes the resource.</p>
            capo_iam.errors.service_failure_exception.ServiceFailureException: <p>The request processing has failed because of an unknown error, exception or failure.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.upload_signing_certificate_request.UploadSigningCertificateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.upload_signing_certificate_response.UploadSigningCertificateResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.upload_signing_certificate

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.upload_signing_certificate.async_upload_signing_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def upload_ssh_public_key(
        ...
        *,
        config_overrides: Optional[AsyncIAMClientConfig] = None,
    ) -> "capo_iam.types.upload_ssh_public_key_response.UploadSSHPublicKeyResponse":
        ...
        Raises:
            capo_iam.errors.duplicate_ssh_public_key_exception.DuplicateSSHPublicKeyException: <p>The request was rejected because the SSH public key is already associated with the specified IAM user.</p>
            capo_iam.errors.invalid_public_key_exception.InvalidPublicKeyException: <p>The request was rejected because the public key is malformed or otherwise invalid.</p>
            capo_iam.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because it attempted to create resources beyond the current Amazon Web Services account limits. The error message describes the limit exceeded.</p>
            capo_iam.errors.no_such_entity_exception.NoSuchEntityException: <p>The request was rejected because it referenced a resource entity that does not exist. The error message describes the resource.</p>
            capo_iam.errors.unrecognized_public_key_encoding_exception.UnrecognizedPublicKeyEncodingException: <p>The request was rejected because the public key encoding format is unsupported or unrecognized.</p>
            capo_iam.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iam.types.upload_ssh_public_key_request.UploadSSHPublicKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_iam.types.upload_ssh_public_key_response.UploadSSHPublicKeyResponse"
        ]:
            import capo_iam._operations.aws_identity_management_v20100508.upload_ssh_public_key

            (
                output,
                http_response,
            ) = await capo_iam._operations.aws_identity_management_v20100508.upload_ssh_public_key.async_upload_ssh_public_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
