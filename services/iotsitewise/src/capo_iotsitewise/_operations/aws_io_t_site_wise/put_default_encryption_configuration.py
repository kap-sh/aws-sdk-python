"""Generated from Smithy shape ``com.amazonaws.iotsitewise#PutDefaultEncryptionConfiguration``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.put_default_encryption_configuration_response.PutDefaultEncryptionConfigurationResponse = capo_iotsitewise.types.put_default_encryption_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.put_default_encryption_configuration_request.serialize_json(
            input_
        )
    ).encode()
