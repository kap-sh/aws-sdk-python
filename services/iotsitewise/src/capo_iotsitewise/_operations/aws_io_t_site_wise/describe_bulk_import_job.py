"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeBulkImportJob``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_bulk_import_job_response.DescribeBulkImportJobResponse = capo_iotsitewise.types.describe_bulk_import_job_response.deserialize_json(
...
async def async_describe_bulk_import_job(
