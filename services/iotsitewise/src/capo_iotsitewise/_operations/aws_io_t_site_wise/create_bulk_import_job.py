"""Generated from Smithy shape ``com.amazonaws.iotsitewise#CreateBulkImportJob``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_bulk_import_job_response.CreateBulkImportJobResponse = capo_iotsitewise.types.create_bulk_import_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_bulk_import_job_request.serialize_json(input_)
    ).encode()
...
async def async_create_bulk_import_job(
