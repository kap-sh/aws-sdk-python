...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_portals_response.ListPortalsResponse = (
        capo_iotsitewise.types.list_portals_response.deserialize_json(
...
def list_portals(
    ...
    capo_iotsitewise.types.list_portals_response.ListPortalsResponse, zapros.Response
]:
