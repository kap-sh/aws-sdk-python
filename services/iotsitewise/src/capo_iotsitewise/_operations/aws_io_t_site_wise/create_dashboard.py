"""Generated from Smithy shape ``com.amazonaws.iotsitewise#CreateDashboard``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_dashboard_response.CreateDashboardResponse = (
        capo_iotsitewise.types.create_dashboard_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_dashboard_request.serialize_json(input_)
    ).encode()
