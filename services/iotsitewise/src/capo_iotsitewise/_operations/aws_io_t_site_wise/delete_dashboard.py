"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DeleteDashboard``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.delete_dashboard_response.DeleteDashboardResponse = {}  # type: ignore[typeddict-item]
    return out
