...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_computation_model_data_binding_usages_response.ListComputationModelDataBindingUsagesResponse = capo_iotsitewise.types.list_computation_model_data_binding_usages_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.list_computation_model_data_binding_usages_request.serialize_json(
            input_
        )
    ).encode()
