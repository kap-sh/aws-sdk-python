...
import capo_iotsitewise.types.asset_property_summaries
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_asset_properties_response.ListAssetPropertiesResponse = capo_iotsitewise.types.list_asset_properties_response.deserialize_json(
