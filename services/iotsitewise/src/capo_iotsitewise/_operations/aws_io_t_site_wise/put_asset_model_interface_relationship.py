...
def handle_response(
    ...
    out: capo_iotsitewise.types.put_asset_model_interface_relationship_response.PutAssetModelInterfaceRelationshipResponse = capo_iotsitewise.types.put_asset_model_interface_relationship_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.put_asset_model_interface_relationship_request.serialize_json(
            input_
        )
    ).encode()
