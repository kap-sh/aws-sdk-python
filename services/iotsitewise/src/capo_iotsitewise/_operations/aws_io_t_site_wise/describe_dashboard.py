"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeDashboard``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_dashboard_response.DescribeDashboardResponse = capo_iotsitewise.types.describe_dashboard_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/dashboards/{dashboardId}"
...
async def async_describe_dashboard(
