"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListProjectAssets``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_project_assets_response.ListProjectAssetsResponse = capo_iotsitewise.types.list_project_assets_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/projects/{projectId}/assets"
...
async def async_list_project_assets(
