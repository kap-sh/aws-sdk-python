"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeLoggingOptions``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_logging_options_response.DescribeLoggingOptionsResponse = capo_iotsitewise.types.describe_logging_options_response.deserialize_json(
