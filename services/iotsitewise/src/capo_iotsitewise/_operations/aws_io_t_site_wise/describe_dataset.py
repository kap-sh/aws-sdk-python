"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeDataset``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_dataset_response.DescribeDatasetResponse = (
        capo_iotsitewise.types.describe_dataset_response.deserialize_json(
