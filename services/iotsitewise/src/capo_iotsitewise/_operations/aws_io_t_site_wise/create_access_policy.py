...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_access_policy_response.CreateAccessPolicyResponse = capo_iotsitewise.types.create_access_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_access_policy_request.serialize_json(input_)
    ).encode()
