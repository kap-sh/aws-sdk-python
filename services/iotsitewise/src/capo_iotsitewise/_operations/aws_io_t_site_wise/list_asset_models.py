"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListAssetModels``."""
...
import capo_iotsitewise.types.asset_model_summaries
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_asset_models_response.ListAssetModelsResponse = (
        capo_iotsitewise.types.list_asset_models_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/asset-models"
    params: dict[str, str] = {}
    if "asset_model_types" in input_:
        params["assetModelTypes"] = str(input_["asset_model_types"])
...
async def async_list_asset_models(
