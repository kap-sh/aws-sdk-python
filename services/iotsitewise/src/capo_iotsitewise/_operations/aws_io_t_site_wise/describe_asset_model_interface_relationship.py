"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeAssetModelInterfaceRelationship``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_asset_model_interface_relationship_response.DescribeAssetModelInterfaceRelationshipResponse = capo_iotsitewise.types.describe_asset_model_interface_relationship_response.deserialize_json(
...
async def async_describe_asset_model_interface_relationship(
