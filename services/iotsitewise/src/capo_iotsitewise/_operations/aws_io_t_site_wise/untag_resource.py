...
import capo_iotsitewise.errors.unauthorized_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnauthorizedException":
            raise capo_iotsitewise.errors.unauthorized_exception.UnauthorizedException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_iotsitewise.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
