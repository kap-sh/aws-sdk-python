"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListBulkImportJobs``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_bulk_import_jobs_response.ListBulkImportJobsResponse = capo_iotsitewise.types.list_bulk_import_jobs_response.deserialize_json(
...
async def async_list_bulk_import_jobs(
