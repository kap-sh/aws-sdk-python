"""Generated from Smithy shape ``com.amazonaws.iotsitewise#UpdateDashboard``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.update_dashboard_response.UpdateDashboardResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.update_dashboard_request.serialize_json(input_)
    ).encode()
