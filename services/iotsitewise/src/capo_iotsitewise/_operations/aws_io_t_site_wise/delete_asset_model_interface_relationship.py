"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DeleteAssetModelInterfaceRelationship``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.delete_asset_model_interface_relationship_response.DeleteAssetModelInterfaceRelationshipResponse = capo_iotsitewise.types.delete_asset_model_interface_relationship_response.deserialize_json(
...
async def async_delete_asset_model_interface_relationship(
