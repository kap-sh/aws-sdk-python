"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListActions``."""
...
import capo_iotsitewise.types.action_summaries
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_actions_response.ListActionsResponse = (
        capo_iotsitewise.types.list_actions_response.deserialize_json(
...
def list_actions(
    ...
    capo_iotsitewise.types.list_actions_response.ListActionsResponse, zapros.Response
]:
