"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListDatasets``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_datasets_response.ListDatasetsResponse = (
        capo_iotsitewise.types.list_datasets_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "source_type" in input_:
        params["sourceType"] = str(input_["source_type"])
...
def list_datasets(
    ...
    capo_iotsitewise.types.list_datasets_response.ListDatasetsResponse, zapros.Response
]:
