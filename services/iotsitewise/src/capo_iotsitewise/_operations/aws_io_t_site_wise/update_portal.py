...
def handle_response(
    ...
    out: capo_iotsitewise.types.update_portal_response.UpdatePortalResponse = (
        capo_iotsitewise.types.update_portal_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.update_portal_request.serialize_json(input_)
    ).encode()
...
def update_portal(
    ...
    capo_iotsitewise.types.update_portal_response.UpdatePortalResponse, zapros.Response
]:
