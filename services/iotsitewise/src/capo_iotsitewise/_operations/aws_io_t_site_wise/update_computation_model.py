...
def handle_response(
    ...
    out: capo_iotsitewise.types.update_computation_model_response.UpdateComputationModelResponse = capo_iotsitewise.types.update_computation_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.update_computation_model_request.serialize_json(input_)
    ).encode()
