...
def handle_response(
    ...
    out: capo_iotsitewise.types.batch_put_asset_property_value_response.BatchPutAssetPropertyValueResponse = capo_iotsitewise.types.batch_put_asset_property_value_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.batch_put_asset_property_value_request.serialize_json(
            input_
        )
    ).encode()
