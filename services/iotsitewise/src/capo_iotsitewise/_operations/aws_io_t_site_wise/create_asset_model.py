"""Generated from Smithy shape ``com.amazonaws.iotsitewise#CreateAssetModel``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_asset_model_response.CreateAssetModelResponse = (
        capo_iotsitewise.types.create_asset_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_asset_model_request.serialize_json(input_)
    ).encode()
...
async def async_create_asset_model(
