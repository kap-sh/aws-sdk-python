...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_asset_property_response.DescribeAssetPropertyResponse = capo_iotsitewise.types.describe_asset_property_response.deserialize_json(
