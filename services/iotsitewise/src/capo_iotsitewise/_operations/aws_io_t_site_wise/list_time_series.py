"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListTimeSeries``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_time_series_response.ListTimeSeriesResponse = (
        capo_iotsitewise.types.list_time_series_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/timeseries"
    params: dict[str, str] = {}
    ...
    if "alias_prefix" in input_:
        params["aliasPrefix"] = str(input_["alias_prefix"])
    if "time_series_type" in input_:
        params["timeSeriesType"] = str(input_["time_series_type"])
...
async def async_list_time_series(
