"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeAssetModel``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_asset_model_response.DescribeAssetModelResponse = capo_iotsitewise.types.describe_asset_model_response.deserialize_json(
...
async def async_describe_asset_model(
