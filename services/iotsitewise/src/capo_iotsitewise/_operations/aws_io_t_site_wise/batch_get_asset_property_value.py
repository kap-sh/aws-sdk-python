"""Generated from Smithy shape ``com.amazonaws.iotsitewise#BatchGetAssetPropertyValue``."""
...
import capo_iotsitewise.types.batch_get_asset_property_value_error_entries
...
import capo_iotsitewise.types.batch_get_asset_property_value_skipped_entries
import capo_iotsitewise.types.batch_get_asset_property_value_success_entries
...
def handle_response(
    ...
    out: capo_iotsitewise.types.batch_get_asset_property_value_response.BatchGetAssetPropertyValueResponse = capo_iotsitewise.types.batch_get_asset_property_value_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/properties/batch/latest"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.batch_get_asset_property_value_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_get_asset_property_value(
