"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeComputationModelExecutionSummary``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_computation_model_execution_summary_response.DescribeComputationModelExecutionSummaryResponse = capo_iotsitewise.types.describe_computation_model_execution_summary_response.deserialize_json(
...
async def async_describe_computation_model_execution_summary(
