...
def handle_response(
    ...
    out: capo_iotsitewise.types.batch_get_asset_property_aggregates_response.BatchGetAssetPropertyAggregatesResponse = capo_iotsitewise.types.batch_get_asset_property_aggregates_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.batch_get_asset_property_aggregates_request.serialize_json(
            input_
        )
    ).encode()
