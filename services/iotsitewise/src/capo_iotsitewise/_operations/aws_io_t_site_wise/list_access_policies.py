"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListAccessPolicies``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_access_policies_response.ListAccessPoliciesResponse = capo_iotsitewise.types.list_access_policies_response.deserialize_json(
