"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DeleteComputationModel``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.delete_computation_model_response.DeleteComputationModelResponse = capo_iotsitewise.types.delete_computation_model_response.deserialize_json(
...
async def async_delete_computation_model(
