...
def handle_response(
    ...
    out: capo_iotsitewise.types.get_asset_property_value_history_response.GetAssetPropertyValueHistoryResponse = capo_iotsitewise.types.get_asset_property_value_history_response.deserialize_json(
