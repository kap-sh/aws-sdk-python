...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_asset_model_composite_model_response.DescribeAssetModelCompositeModelResponse = capo_iotsitewise.types.describe_asset_model_composite_model_response.deserialize_json(
