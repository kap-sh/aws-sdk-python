"""Generated from Smithy shape ``com.amazonaws.iotsitewise#CreateAsset``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_asset_response.CreateAssetResponse = (
        capo_iotsitewise.types.create_asset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_asset_request.serialize_json(input_)
    ).encode()
...
def create_asset(
    ...
    capo_iotsitewise.types.create_asset_response.CreateAssetResponse, zapros.Response
]:
