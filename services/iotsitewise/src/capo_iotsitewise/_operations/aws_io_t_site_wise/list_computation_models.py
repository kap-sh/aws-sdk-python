"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListComputationModels``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_computation_models_response.ListComputationModelsResponse = capo_iotsitewise.types.list_computation_models_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/computation-models"
    params: dict[str, str] = {}
    if "computation_model_type" in input_:
        params["computationModelType"] = str(input_["computation_model_type"])
...
async def async_list_computation_models(
