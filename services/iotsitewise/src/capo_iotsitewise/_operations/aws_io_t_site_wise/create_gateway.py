...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_gateway_response.CreateGatewayResponse = (
        capo_iotsitewise.types.create_gateway_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_gateway_request.serialize_json(input_)
    ).encode()
