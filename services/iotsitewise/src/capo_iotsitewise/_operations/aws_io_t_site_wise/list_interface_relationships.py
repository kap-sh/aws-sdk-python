"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListInterfaceRelationships``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_interface_relationships_response.ListInterfaceRelationshipsResponse = capo_iotsitewise.types.list_interface_relationships_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/interface/{interfaceAssetModelId}/asset-models"
    url = url.replace(
...
async def async_list_interface_relationships(
