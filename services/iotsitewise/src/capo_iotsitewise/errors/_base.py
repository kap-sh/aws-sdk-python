...
class IoTSiteWiseError(Exception):
    """Base class for all IoTSiteWise service errors."""


class ServiceError(IoTSiteWiseError):
...
class SerializationError(IoTSiteWiseError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTSiteWiseError):
...
class WaiterFailedError(IoTSiteWiseError):
...
class WaiterTimeoutError(IoTSiteWiseError):
