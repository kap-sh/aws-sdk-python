...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteComputationModelRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteComputationModelRequest:
    out: DeleteComputationModelRequest = {}  # type: ignore[typeddict-item]
    return out
