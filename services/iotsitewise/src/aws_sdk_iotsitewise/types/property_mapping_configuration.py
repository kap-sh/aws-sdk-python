...
if TYPE_CHECKING:
    ...
    import aws_sdk_iotsitewise.types.match_by_property_name
...
class PropertyMappingConfiguration(TypedDict):
    ...
    create_missing_property: (
        "aws_sdk_iotsitewise.types.create_missing_property.CreateMissingProperty"
    )
    ...
    overrides: NotRequired[
        "aws_sdk_iotsitewise.types.property_mappings.PropertyMappings"
    ]
...
def serialize_json(value: PropertyMappingConfiguration) -> dict:
    ...
    if "overrides" in value:
        ...
        out["overrides"] = aws_sdk_iotsitewise.types.property_mappings.serialize_json(
            value["overrides"]
        )
    return out
...
def deserialize_json(data: dict) -> PropertyMappingConfiguration:
    ...
    if "overrides" in data:
        ...
        out["overrides"] = aws_sdk_iotsitewise.types.property_mappings.deserialize_json(
            data["overrides"]
        )
    return out
