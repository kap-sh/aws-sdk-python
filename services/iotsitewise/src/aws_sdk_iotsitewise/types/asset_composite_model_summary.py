...
class AssetCompositeModelSummary(TypedDict):
    ...
    path: "aws_sdk_iotsitewise.types.asset_composite_model_path.AssetCompositeModelPath"
...
def serialize_json(value: AssetCompositeModelSummary) -> dict:
    ...
    out["path"] = aws_sdk_iotsitewise.types.asset_composite_model_path.serialize_json(
        value["path"]
    )
    return out
