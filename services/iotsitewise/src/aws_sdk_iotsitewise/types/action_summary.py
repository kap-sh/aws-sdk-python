...
class ActionSummary(TypedDict, closed=True):
    action_id: NotRequired["aws_sdk_iotsitewise.types.id.ID"]
    """<p>The ID of the action.</p>"""
    action_definition_id: NotRequired["aws_sdk_iotsitewise.types.id.ID"]
    """<p>The ID of the action definition.</p>"""
    target_resource: NotRequired[
        "aws_sdk_iotsitewise.types.target_resource.TargetResource"
    ]
...
def serialize_json(value: ActionSummary) -> dict:
    ...
    if "target_resource" in value:
        ...
        out["targetResource"] = (
            aws_sdk_iotsitewise.types.target_resource.serialize_json(
