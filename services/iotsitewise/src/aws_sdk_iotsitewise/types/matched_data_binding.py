...
if TYPE_CHECKING:
    import aws_sdk_iotsitewise.types.data_binding_value


class MatchedDataBinding(TypedDict):
    value: "aws_sdk_iotsitewise.types.data_binding_value.DataBindingValue"
...
def serialize_json(value: MatchedDataBinding) -> dict:
    ...
    out["value"] = aws_sdk_iotsitewise.types.data_binding_value.serialize_json(
        value["value"]
    )
    return out
...
def deserialize_json(data: dict) -> MatchedDataBinding:
    ...
    if "value" in data:
        ...
        out["value"] = aws_sdk_iotsitewise.types.data_binding_value.deserialize_json(
            data["value"]
        )
    else:
