...
class CreateAssetModelRequest(TypedDict):
    ...
    asset_model_id: NotRequired["aws_sdk_iotsitewise.types.id.ID"]
...
def serialize_json(value: CreateAssetModelRequest) -> dict:
    ...
    if "asset_model_hierarchies" in value:
        ...
        out["assetModelHierarchies"] = (
            aws_sdk_iotsitewise.types.asset_model_hierarchy_definitions.serialize_json(
    ...
    if "asset_model_composite_models" in value:
        ...
        out["assetModelCompositeModels"] = (
            aws_sdk_iotsitewise.types.asset_model_composite_model_definitions.serialize_json(
...
def deserialize_json(data: dict) -> CreateAssetModelRequest:
    ...
    if "assetModelHierarchies" in data:
        ...
        out["asset_model_hierarchies"] = (
            aws_sdk_iotsitewise.types.asset_model_hierarchy_definitions.deserialize_json(
    ...
    if "assetModelCompositeModels" in data:
        ...
        out["asset_model_composite_models"] = (
            aws_sdk_iotsitewise.types.asset_model_composite_model_definitions.deserialize_json(
