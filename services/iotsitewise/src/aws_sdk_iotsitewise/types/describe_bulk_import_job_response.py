...
class DescribeBulkImportJobResponse(TypedDict):
    ...
    job_creation_date: "aws_sdk_iotsitewise.types.timestamp.Timestamp"
    """<p>The date the job was created, in Unix epoch TIME.</p>"""
    job_last_update_date: "aws_sdk_iotsitewise.types.timestamp.Timestamp"
...
def serialize_json(value: DescribeBulkImportJobResponse) -> dict:
    ...
    out["jobCreationDate"] = aws_sdk_iotsitewise.types.timestamp.serialize_json(
        value["job_creation_date"]
    )
    import aws_sdk_iotsitewise.types.timestamp

    out["jobLastUpdateDate"] = aws_sdk_iotsitewise.types.timestamp.serialize_json(
...
def deserialize_json(data: dict) -> DescribeBulkImportJobResponse:
    ...
    if "jobCreationDate" in data:
        ...
        out["job_creation_date"] = aws_sdk_iotsitewise.types.timestamp.deserialize_json(
