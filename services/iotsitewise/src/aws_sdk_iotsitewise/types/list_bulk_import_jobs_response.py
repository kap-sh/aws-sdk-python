...
if TYPE_CHECKING:
    import aws_sdk_iotsitewise.types.job_summaries
    import aws_sdk_iotsitewise.types.next_token


class ListBulkImportJobsResponse(TypedDict):
    job_summaries: "aws_sdk_iotsitewise.types.job_summaries.JobSummaries"
...
def serialize_json(value: ListBulkImportJobsResponse) -> dict:
    ...
    out["jobSummaries"] = aws_sdk_iotsitewise.types.job_summaries.serialize_json(
        value["job_summaries"]
    )
...
def deserialize_json(data: dict) -> ListBulkImportJobsResponse:
    ...
    if "jobSummaries" in data:
        ...
        out["job_summaries"] = aws_sdk_iotsitewise.types.job_summaries.deserialize_json(
            data["jobSummaries"]
        )
    else:
