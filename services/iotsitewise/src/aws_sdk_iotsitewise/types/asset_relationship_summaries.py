...
AssetRelationshipSummaries: TypeAlias = list[
    "aws_sdk_iotsitewise.types.asset_relationship_summary.AssetRelationshipSummary"
]
...
def serialize_json(value: AssetRelationshipSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_iotsitewise.types.asset_relationship_summary.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> AssetRelationshipSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_iotsitewise.types.asset_relationship_summary.deserialize_json(item)
        )
    return out
