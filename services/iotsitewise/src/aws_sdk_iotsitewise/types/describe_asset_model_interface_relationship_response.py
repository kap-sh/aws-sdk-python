...
if TYPE_CHECKING:
    import aws_sdk_iotsitewise.types.hierarchy_mappings
    import aws_sdk_iotsitewise.types.id
    import aws_sdk_iotsitewise.types.property_mappings


class DescribeAssetModelInterfaceRelationshipResponse(TypedDict):
    ...
    property_mappings: "aws_sdk_iotsitewise.types.property_mappings.PropertyMappings"
    """<p>A list of property mappings between the interface asset model and the asset model where the interface is applied.</p>"""
    hierarchy_mappings: "aws_sdk_iotsitewise.types.hierarchy_mappings.HierarchyMappings"
...
def serialize_json(value: DescribeAssetModelInterfaceRelationshipResponse) -> dict:
    ...
    out["propertyMappings"] = (
        aws_sdk_iotsitewise.types.property_mappings.serialize_json(
    ...
    out["hierarchyMappings"] = (
        aws_sdk_iotsitewise.types.hierarchy_mappings.serialize_json(
...
def deserialize_json(data: dict) -> DescribeAssetModelInterfaceRelationshipResponse:
    ...
    if "propertyMappings" in data:
        ...
        out["property_mappings"] = (
            aws_sdk_iotsitewise.types.property_mappings.deserialize_json(
    ...
    if "hierarchyMappings" in data:
        ...
        out["hierarchy_mappings"] = (
            aws_sdk_iotsitewise.types.hierarchy_mappings.deserialize_json(
