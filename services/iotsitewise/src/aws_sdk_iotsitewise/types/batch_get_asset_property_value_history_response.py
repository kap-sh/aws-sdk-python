...
class BatchGetAssetPropertyValueHistoryResponse(TypedDict):
    error_entries: "aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_error_entries.BatchGetAssetPropertyValueHistoryErrorEntries"
    ...
    success_entries: "aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_success_entries.BatchGetAssetPropertyValueHistorySuccessEntries"
    ...
    skipped_entries: "aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_skipped_entries.BatchGetAssetPropertyValueHistorySkippedEntries"
...
def serialize_json(value: BatchGetAssetPropertyValueHistoryResponse) -> dict:
    ...
    out["errorEntries"] = (
        aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_error_entries.serialize_json(
            value["error_entries"]
        )
    )
    import aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_success_entries
    ...
    out["successEntries"] = (
        aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_success_entries.serialize_json(
    ...
    out["skippedEntries"] = (
        aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_skipped_entries.serialize_json(
...
def deserialize_json(data: dict) -> BatchGetAssetPropertyValueHistoryResponse:
    ...
    if "errorEntries" in data:
        ...
        out["error_entries"] = (
            aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_error_entries.deserialize_json(
                data["errorEntries"]
            )
        )
    else:
    ...
    if "successEntries" in data:
        ...
        out["success_entries"] = (
            aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_success_entries.deserialize_json(
                data["successEntries"]
            )
        )
    else:
    ...
    if "skippedEntries" in data:
        ...
        out["skipped_entries"] = (
            aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_skipped_entries.deserialize_json(
                data["skippedEntries"]
            )
        )
    else:
