...
class AssetCompositeModel(TypedDict):
    ...
    properties: "aws_sdk_iotsitewise.types.asset_properties.AssetProperties"
...
def serialize_json(value: AssetCompositeModel) -> dict:
    ...
    out["properties"] = aws_sdk_iotsitewise.types.asset_properties.serialize_json(
        value["properties"]
    )
    if "id" in value:
        out["id"] = value["id"]
...
def deserialize_json(data: dict) -> AssetCompositeModel:
    ...
    if "properties" in data:
        ...
        out["properties"] = aws_sdk_iotsitewise.types.asset_properties.deserialize_json(
            data["properties"]
        )
    else:
