...
if TYPE_CHECKING:
    ...
    import aws_sdk_iotsitewise.types.metric_processing_config
    import aws_sdk_iotsitewise.types.metric_window
...
class Metric(TypedDict):
    ...
    window: "aws_sdk_iotsitewise.types.metric_window.MetricWindow"
    ...
    processing_config: NotRequired[
        "aws_sdk_iotsitewise.types.metric_processing_config.MetricProcessingConfig"
    ]
...
def serialize_json(value: Metric) -> dict:
    ...
    out["window"] = aws_sdk_iotsitewise.types.metric_window.serialize_json(
        value["window"]
    )
    if "processing_config" in value:
        ...
        out["processingConfig"] = (
            aws_sdk_iotsitewise.types.metric_processing_config.serialize_json(
...
def deserialize_json(data: dict) -> Metric:
    ...
    if "window" in data:
        ...
        out["window"] = aws_sdk_iotsitewise.types.metric_window.deserialize_json(
            data["window"]
        )
    else:
    ...
    if "processingConfig" in data:
        ...
        out["processing_config"] = (
            aws_sdk_iotsitewise.types.metric_processing_config.deserialize_json(
