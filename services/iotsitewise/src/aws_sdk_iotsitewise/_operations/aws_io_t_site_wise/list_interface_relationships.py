...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_interface_relationships_response.ListInterfaceRelationshipsResponse = aws_sdk_iotsitewise.types.list_interface_relationships_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_interface_relationships_request.ListInterfaceRelationshipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
