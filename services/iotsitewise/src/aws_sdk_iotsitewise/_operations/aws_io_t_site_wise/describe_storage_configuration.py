"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeStorageConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_storage_configuration_response.DescribeStorageConfigurationResponse = aws_sdk_iotsitewise.types.describe_storage_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_storage_configuration_request.DescribeStorageConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_storage_configuration(
