...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_associated_assets_request.ListAssociatedAssetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "hierarchy_id" in input_:
        params["hierarchyId"] = str(input_["hierarchy_id"])
    if "traversal_direction" in input_:
        params["traversalDirection"] = str(input_["traversal_direction"])
