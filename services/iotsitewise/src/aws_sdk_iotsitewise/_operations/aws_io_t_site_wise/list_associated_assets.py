...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_associated_assets_response.ListAssociatedAssetsResponse = aws_sdk_iotsitewise.types.list_associated_assets_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.list_associated_assets_request.ListAssociatedAssetsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "hierarchy_id" in input:
        params["hierarchyId"] = str(input["hierarchy_id"])
    if "traversal_direction" in input:
        params["traversalDirection"] = str(input["traversal_direction"])
