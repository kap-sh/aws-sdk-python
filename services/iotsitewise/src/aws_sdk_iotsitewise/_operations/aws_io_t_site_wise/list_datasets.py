...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_datasets_response.ListDatasetsResponse = (
        aws_sdk_iotsitewise.types.list_datasets_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.list_datasets_request.ListDatasetsRequest,
) -> zapros.Request:
    ...
    if "source_type" in input:
        params["sourceType"] = str(input["source_type"])
