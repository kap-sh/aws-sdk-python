"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListExecutions``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_executions_response.ListExecutionsResponse = (
        aws_sdk_iotsitewise.types.list_executions_response.deserialize_json(
