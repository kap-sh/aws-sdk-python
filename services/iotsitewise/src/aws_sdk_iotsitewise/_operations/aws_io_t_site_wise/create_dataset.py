"""Generated from Smithy shape ``com.amazonaws.iotsitewise#CreateDataset``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.create_dataset_response.CreateDatasetResponse = (
        aws_sdk_iotsitewise.types.create_dataset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.create_dataset_request.CreateDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_dataset_request.serialize_json(input_)
    ).encode()
