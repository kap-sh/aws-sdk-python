...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_computation_models_response.ListComputationModelsResponse = aws_sdk_iotsitewise.types.list_computation_models_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.list_computation_models_request.ListComputationModelsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "computation_model_type" in input:
        params["computationModelType"] = str(input["computation_model_type"])
