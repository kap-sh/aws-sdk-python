...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_request.BatchGetAssetPropertyValueHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.batch_get_asset_property_value_history_request.serialize_json(
            input_
        )
    ).encode()
