"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeGateway``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_gateway_response.DescribeGatewayResponse = (
        aws_sdk_iotsitewise.types.describe_gateway_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.describe_gateway_request.DescribeGatewayRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/20200301/gateways/{gatewayId}"
