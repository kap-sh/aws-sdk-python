"""Generated from Smithy shape ``com.amazonaws.iotsitewise#AssociateAssets``."""
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.associate_assets_request.AssociateAssetsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/assets/{assetId}/associate"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.associate_assets_request.serialize_json(input)
    ).encode()
...
async def async_associate_assets(
