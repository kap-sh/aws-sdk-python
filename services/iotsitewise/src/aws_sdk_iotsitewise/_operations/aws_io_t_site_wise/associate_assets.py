...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.associate_assets_request.AssociateAssetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.associate_assets_request.serialize_json(input_)
    ).encode()
