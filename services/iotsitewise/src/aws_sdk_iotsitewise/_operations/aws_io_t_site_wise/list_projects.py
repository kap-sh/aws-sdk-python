"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListProjects``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_projects_response.ListProjectsResponse = (
        aws_sdk_iotsitewise.types.list_projects_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_projects_request.ListProjectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "portal_id" in input_:
        params["portalId"] = str(input_["portal_id"])
