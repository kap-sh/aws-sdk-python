...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_computation_model_resolve_to_resources_response.ListComputationModelResolveToResourcesResponse = aws_sdk_iotsitewise.types.list_computation_model_resolve_to_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_computation_model_resolve_to_resources_request.ListComputationModelResolveToResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
