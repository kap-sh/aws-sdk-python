"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListComputationModelDataBindingUsages``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_computation_model_data_binding_usages_response.ListComputationModelDataBindingUsagesResponse = aws_sdk_iotsitewise.types.list_computation_model_data_binding_usages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_computation_model_data_binding_usages_request.ListComputationModelDataBindingUsagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/computation-models/data-binding-usages"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iotsitewise.types.list_computation_model_data_binding_usages_request

    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.list_computation_model_data_binding_usages_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_computation_model_data_binding_usages(
