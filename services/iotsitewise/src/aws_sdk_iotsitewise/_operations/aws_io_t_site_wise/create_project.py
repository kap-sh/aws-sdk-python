...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.create_project_response.CreateProjectResponse = (
        aws_sdk_iotsitewise.types.create_project_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.create_project_request.CreateProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_project_request.serialize_json(input_)
    ).encode()
