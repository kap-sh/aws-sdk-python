...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.delete_asset_model_interface_relationship_response.DeleteAssetModelInterfaceRelationshipResponse = aws_sdk_iotsitewise.types.delete_asset_model_interface_relationship_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.delete_asset_model_interface_relationship_request.DeleteAssetModelInterfaceRelationshipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
