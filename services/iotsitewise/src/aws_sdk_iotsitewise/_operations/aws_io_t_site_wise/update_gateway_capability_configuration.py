...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.update_gateway_capability_configuration_response.UpdateGatewayCapabilityConfigurationResponse = aws_sdk_iotsitewise.types.update_gateway_capability_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.update_gateway_capability_configuration_request.UpdateGatewayCapabilityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_gateway_capability_configuration_request.serialize_json(
            input_
        )
    ).encode()
