...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.delete_asset_response.DeleteAssetResponse = (
        aws_sdk_iotsitewise.types.delete_asset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.delete_asset_request.DeleteAssetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_asset(
    ...
    aws_sdk_iotsitewise.types.delete_asset_response.DeleteAssetResponse, zapros.Response
]:
