...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_asset_model_response.DescribeAssetModelResponse = aws_sdk_iotsitewise.types.describe_asset_model_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.describe_asset_model_request.DescribeAssetModelRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    params["excludeProperties"] = str(input.get("exclude_properties", False))
