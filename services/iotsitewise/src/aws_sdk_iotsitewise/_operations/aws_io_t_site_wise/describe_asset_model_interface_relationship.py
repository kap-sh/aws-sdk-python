...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_asset_model_interface_relationship_response.DescribeAssetModelInterfaceRelationshipResponse = aws_sdk_iotsitewise.types.describe_asset_model_interface_relationship_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_asset_model_interface_relationship_request.DescribeAssetModelInterfaceRelationshipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
