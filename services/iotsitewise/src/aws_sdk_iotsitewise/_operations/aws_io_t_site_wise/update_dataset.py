"""Generated from Smithy shape ``com.amazonaws.iotsitewise#UpdateDataset``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.update_dataset_response.UpdateDatasetResponse = (
        aws_sdk_iotsitewise.types.update_dataset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.update_dataset_request.UpdateDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_dataset_request.serialize_json(input_)
    ).encode()
