...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.update_project_response.UpdateProjectResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.update_project_request.UpdateProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_project_request.serialize_json(input_)
    ).encode()
