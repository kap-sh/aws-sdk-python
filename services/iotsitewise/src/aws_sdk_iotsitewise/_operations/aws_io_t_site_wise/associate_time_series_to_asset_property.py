...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.associate_time_series_to_asset_property_request.AssociateTimeSeriesToAssetPropertyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.associate_time_series_to_asset_property_request.serialize_json(
            input_
        )
    ).encode()
