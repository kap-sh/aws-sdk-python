"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribePortal``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_portal_response.DescribePortalResponse = (
        aws_sdk_iotsitewise.types.describe_portal_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_portal_request.DescribePortalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_portal(
