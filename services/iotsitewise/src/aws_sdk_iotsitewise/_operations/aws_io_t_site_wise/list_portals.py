"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListPortals``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_portals_response.ListPortalsResponse = (
        aws_sdk_iotsitewise.types.list_portals_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_portals_request.ListPortalsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_portals(
    ...
    aws_sdk_iotsitewise.types.list_portals_response.ListPortalsResponse, zapros.Response
]:
