...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_asset_models_response.ListAssetModelsResponse = aws_sdk_iotsitewise.types.list_asset_models_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.list_asset_models_request.ListAssetModelsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "asset_model_types" in input:
        params["assetModelTypes"] = str(input["asset_model_types"])
