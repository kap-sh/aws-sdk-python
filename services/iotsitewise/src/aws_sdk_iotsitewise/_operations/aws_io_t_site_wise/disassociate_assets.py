"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DisassociateAssets``."""
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.disassociate_assets_request.DisassociateAssetsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/assets/{assetId}/disassociate"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.disassociate_assets_request.serialize_json(input)
    ).encode()
...
async def async_disassociate_assets(
