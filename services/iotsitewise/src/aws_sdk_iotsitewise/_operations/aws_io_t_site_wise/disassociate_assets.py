...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.disassociate_assets_request.DisassociateAssetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.disassociate_assets_request.serialize_json(input_)
    ).encode()
