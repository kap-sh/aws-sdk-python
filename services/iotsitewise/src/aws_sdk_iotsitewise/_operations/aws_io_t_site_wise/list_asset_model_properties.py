"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListAssetModelProperties``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_asset_model_properties_response.ListAssetModelPropertiesResponse = aws_sdk_iotsitewise.types.list_asset_model_properties_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.list_asset_model_properties_request.ListAssetModelPropertiesRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/asset-models/{assetModelId}/properties"
    ...
    if "filter" in input:
        params["filter"] = str(input["filter"])
...
async def async_list_asset_model_properties(
