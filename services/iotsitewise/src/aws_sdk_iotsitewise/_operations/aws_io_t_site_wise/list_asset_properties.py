"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListAssetProperties``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_asset_properties_response.ListAssetPropertiesResponse = aws_sdk_iotsitewise.types.list_asset_properties_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.list_asset_properties_request.ListAssetPropertiesRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/assets/{assetId}/properties"
...
async def async_list_asset_properties(
