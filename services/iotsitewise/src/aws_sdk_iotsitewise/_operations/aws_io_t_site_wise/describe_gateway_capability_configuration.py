...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.describe_gateway_capability_configuration_request.DescribeGatewayCapabilityConfigurationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{capabilityNamespace}", quote(str(input["capability_namespace"]), safe="")
    )
    params: dict[str, str] = {}
