...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_gateway_capability_configuration_response.DescribeGatewayCapabilityConfigurationResponse = aws_sdk_iotsitewise.types.describe_gateway_capability_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_gateway_capability_configuration_request.DescribeGatewayCapabilityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{capabilityNamespace}", quote(str(input_["capability_namespace"]), safe="")
    )
    params: dict[str, str] = {}
