"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DeleteAssetModel``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.delete_asset_model_response.DeleteAssetModelResponse = aws_sdk_iotsitewise.types.delete_asset_model_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.delete_asset_model_request.DeleteAssetModelRequest,
) -> zapros.Request:
...
async def async_delete_asset_model(
