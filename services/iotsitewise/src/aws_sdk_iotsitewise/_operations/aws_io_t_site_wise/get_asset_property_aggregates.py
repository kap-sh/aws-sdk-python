...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.get_asset_property_aggregates_response.GetAssetPropertyAggregatesResponse = aws_sdk_iotsitewise.types.get_asset_property_aggregates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.get_asset_property_aggregates_request.GetAssetPropertyAggregatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "aggregate_types" in input_:
        params["aggregateTypes"] = str(input_["aggregate_types"])
