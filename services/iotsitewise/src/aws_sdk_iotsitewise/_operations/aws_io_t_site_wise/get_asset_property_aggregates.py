...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.get_asset_property_aggregates_request.GetAssetPropertyAggregatesRequest,
) -> zapros.Request:
    ...
    if "aggregate_types" in input:
        params["aggregateTypes"] = str(input["aggregate_types"])
