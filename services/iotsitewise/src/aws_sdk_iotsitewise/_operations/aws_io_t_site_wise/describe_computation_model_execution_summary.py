...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_computation_model_execution_summary_response.DescribeComputationModelExecutionSummaryResponse = aws_sdk_iotsitewise.types.describe_computation_model_execution_summary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_computation_model_execution_summary_request.DescribeComputationModelExecutionSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
