...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_asset_relationships_response.ListAssetRelationshipsResponse = aws_sdk_iotsitewise.types.list_asset_relationships_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.list_asset_relationships_request.ListAssetRelationshipsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "traversal_type" in input:
        params["traversalType"] = str(input["traversal_type"])
