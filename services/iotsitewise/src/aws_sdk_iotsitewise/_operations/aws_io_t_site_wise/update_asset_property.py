...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.update_asset_property_request.UpdateAssetPropertyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_asset_property_request.serialize_json(input)
    ).encode()
