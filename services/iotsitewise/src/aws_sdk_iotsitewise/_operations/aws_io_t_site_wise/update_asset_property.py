...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.update_asset_property_request.UpdateAssetPropertyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_asset_property_request.serialize_json(input_)
    ).encode()
