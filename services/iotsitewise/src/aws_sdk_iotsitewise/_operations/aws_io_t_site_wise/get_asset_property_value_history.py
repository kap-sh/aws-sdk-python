"""Generated from Smithy shape ``com.amazonaws.iotsitewise#GetAssetPropertyValueHistory``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.get_asset_property_value_history_response.GetAssetPropertyValueHistoryResponse = aws_sdk_iotsitewise.types.get_asset_property_value_history_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.get_asset_property_value_history_request.GetAssetPropertyValueHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/properties/history"
    params: dict[str, str] = {}
    ...
    if "qualities" in input_:
        params["qualities"] = str(input_["qualities"])
    if "time_ordering" in input_:
        params["timeOrdering"] = str(input_["time_ordering"])
...
async def async_get_asset_property_value_history(
