...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_bulk_import_job_response.DescribeBulkImportJobResponse = aws_sdk_iotsitewise.types.describe_bulk_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_bulk_import_job_request.DescribeBulkImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
