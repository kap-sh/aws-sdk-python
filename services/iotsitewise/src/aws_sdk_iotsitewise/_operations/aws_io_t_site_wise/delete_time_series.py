"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DeleteTimeSeries``."""
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.delete_time_series_request.DeleteTimeSeriesRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/timeseries/delete"
    params: dict[str, str] = {}
    if "alias" in input:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.delete_time_series_request.serialize_json(input)
    ).encode()
...
async def async_delete_time_series(
