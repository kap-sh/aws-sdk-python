...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_actions_response.ListActionsResponse = (
        aws_sdk_iotsitewise.types.list_actions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_actions_request.ListActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_actions(
    ...
    aws_sdk_iotsitewise.types.list_actions_response.ListActionsResponse, zapros.Response
]:
