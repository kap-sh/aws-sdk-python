"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DeleteProject``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.delete_project_response.DeleteProjectResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.delete_project_request.DeleteProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
