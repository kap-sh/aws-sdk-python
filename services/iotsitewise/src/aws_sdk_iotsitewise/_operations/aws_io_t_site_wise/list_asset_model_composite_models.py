"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListAssetModelCompositeModels``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_asset_model_composite_models_response.ListAssetModelCompositeModelsResponse = aws_sdk_iotsitewise.types.list_asset_model_composite_models_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.list_asset_model_composite_models_request.ListAssetModelCompositeModelsRequest,
) -> zapros.Request:
...
async def async_list_asset_model_composite_models(
