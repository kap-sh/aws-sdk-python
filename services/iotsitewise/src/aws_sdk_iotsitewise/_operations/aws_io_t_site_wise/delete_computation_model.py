...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.delete_computation_model_response.DeleteComputationModelResponse = aws_sdk_iotsitewise.types.delete_computation_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.delete_computation_model_request.DeleteComputationModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
