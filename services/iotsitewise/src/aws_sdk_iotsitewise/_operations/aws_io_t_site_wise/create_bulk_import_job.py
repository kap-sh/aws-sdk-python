...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.create_bulk_import_job_response.CreateBulkImportJobResponse = aws_sdk_iotsitewise.types.create_bulk_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.create_bulk_import_job_request.CreateBulkImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_bulk_import_job_request.serialize_json(input_)
    ).encode()
