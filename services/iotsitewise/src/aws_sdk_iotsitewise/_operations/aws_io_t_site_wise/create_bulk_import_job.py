...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.create_bulk_import_job_request.CreateBulkImportJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_bulk_import_job_request.serialize_json(input)
    ).encode()
