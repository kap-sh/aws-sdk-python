"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ExecuteQuery``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            ...
            raise aws_sdk_iotsitewise.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
        ...
        case "QueryTimeoutException":
            import aws_sdk_iotsitewise.errors.query_timeout_exception

            raise aws_sdk_iotsitewise.errors.query_timeout_exception.QueryTimeoutException.from_json(
                data
            )
        ...
        case "ValidationException":
            import aws_sdk_iotsitewise.errors.validation_exception

            raise aws_sdk_iotsitewise.errors.validation_exception.ValidationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.execute_query_response.ExecuteQueryResponse = (
        aws_sdk_iotsitewise.types.execute_query_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.execute_query_request.ExecuteQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/queries/execution"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iotsitewise.types.execute_query_request

    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.execute_query_request.serialize_json(input_)
    ).encode()
