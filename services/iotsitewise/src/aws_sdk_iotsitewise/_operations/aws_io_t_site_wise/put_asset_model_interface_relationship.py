"""Generated from Smithy shape ``com.amazonaws.iotsitewise#PutAssetModelInterfaceRelationship``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.put_asset_model_interface_relationship_response.PutAssetModelInterfaceRelationshipResponse = aws_sdk_iotsitewise.types.put_asset_model_interface_relationship_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.put_asset_model_interface_relationship_request.PutAssetModelInterfaceRelationshipRequest,
) -> zapros.Request:
    ...
    url = url.replace("{assetModelId}", quote(str(input["asset_model_id"]), safe=""))
    url = url.replace(
        "{interfaceAssetModelId}",
        quote(str(input["interface_asset_model_id"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.put_asset_model_interface_relationship_request.serialize_json(
            input
        )
    ).encode()
...
async def async_put_asset_model_interface_relationship(
