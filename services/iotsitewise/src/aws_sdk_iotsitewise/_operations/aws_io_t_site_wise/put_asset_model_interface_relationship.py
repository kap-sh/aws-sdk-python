...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.put_asset_model_interface_relationship_request.PutAssetModelInterfaceRelationshipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["interface_asset_model_id"]), safe=""),
    )
    params: dict[str, str] = {}
