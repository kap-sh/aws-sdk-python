"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeComputationModel``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_computation_model_response.DescribeComputationModelResponse = aws_sdk_iotsitewise.types.describe_computation_model_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.describe_computation_model_request.DescribeComputationModelRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/computation-models/{computationModelId}"
    url = url.replace(
        "{computationModelId}", quote(str(input["computation_model_id"]), safe="")
    )
    params: dict[str, str] = {}
    if "computation_model_version" in input:
        params["computationModelVersion"] = str(input["computation_model_version"])
...
async def async_describe_computation_model(
