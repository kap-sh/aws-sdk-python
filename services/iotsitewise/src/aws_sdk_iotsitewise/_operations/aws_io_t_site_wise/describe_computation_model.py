...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_computation_model_request.DescribeComputationModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "computation_model_version" in input_:
        params["computationModelVersion"] = str(input_["computation_model_version"])
