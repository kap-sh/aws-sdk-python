"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeAccessPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_access_policy_response.DescribeAccessPolicyResponse = aws_sdk_iotsitewise.types.describe_access_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_access_policy_request.DescribeAccessPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_access_policy(
