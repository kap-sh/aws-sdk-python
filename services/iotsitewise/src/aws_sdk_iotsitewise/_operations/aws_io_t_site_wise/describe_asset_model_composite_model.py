"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeAssetModelCompositeModel``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_asset_model_composite_model_response.DescribeAssetModelCompositeModelResponse = aws_sdk_iotsitewise.types.describe_asset_model_composite_model_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.describe_asset_model_composite_model_request.DescribeAssetModelCompositeModelRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["asset_model_composite_model_id"]), safe=""),
    )
    params: dict[str, str] = {}
    if "asset_model_version" in input:
        params["assetModelVersion"] = str(input["asset_model_version"])
...
async def async_describe_asset_model_composite_model(
