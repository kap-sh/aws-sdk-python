...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_asset_model_composite_model_request.DescribeAssetModelCompositeModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["asset_model_composite_model_id"]), safe=""),
    )
    params: dict[str, str] = {}
    if "asset_model_version" in input_:
        params["assetModelVersion"] = str(input_["asset_model_version"])
