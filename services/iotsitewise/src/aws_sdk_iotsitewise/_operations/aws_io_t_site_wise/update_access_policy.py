...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.update_access_policy_request.UpdateAccessPolicyRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{accessPolicyId}", quote(str(input["access_policy_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_access_policy_request.serialize_json(input)
    ).encode()
