...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.put_logging_options_response.PutLoggingOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.put_logging_options_request.PutLoggingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.put_logging_options_request.serialize_json(input_)
    ).encode()
