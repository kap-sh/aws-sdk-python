...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.put_logging_options_request.PutLoggingOptionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.put_logging_options_request.serialize_json(input)
    ).encode()
