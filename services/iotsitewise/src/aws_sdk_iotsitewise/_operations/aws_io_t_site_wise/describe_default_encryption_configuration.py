"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeDefaultEncryptionConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_default_encryption_configuration_response.DescribeDefaultEncryptionConfigurationResponse = aws_sdk_iotsitewise.types.describe_default_encryption_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_default_encryption_configuration_request.DescribeDefaultEncryptionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_default_encryption_configuration(
