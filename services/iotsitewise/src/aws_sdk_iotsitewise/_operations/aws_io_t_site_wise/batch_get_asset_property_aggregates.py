"""Generated from Smithy shape ``com.amazonaws.iotsitewise#BatchGetAssetPropertyAggregates``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.batch_get_asset_property_aggregates_response.BatchGetAssetPropertyAggregatesResponse = aws_sdk_iotsitewise.types.batch_get_asset_property_aggregates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.batch_get_asset_property_aggregates_request.BatchGetAssetPropertyAggregatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/properties/batch/aggregates"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iotsitewise.types.batch_get_asset_property_aggregates_request

    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.batch_get_asset_property_aggregates_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_get_asset_property_aggregates(
