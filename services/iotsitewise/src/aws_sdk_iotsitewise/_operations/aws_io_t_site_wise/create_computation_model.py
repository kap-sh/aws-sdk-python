...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.create_computation_model_response.CreateComputationModelResponse = aws_sdk_iotsitewise.types.create_computation_model_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.create_computation_model_request.CreateComputationModelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_computation_model_request.serialize_json(input)
    ).encode()
