...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.create_computation_model_request.CreateComputationModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_computation_model_request.serialize_json(
            input_
        )
    ).encode()
