...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.batch_disassociate_project_assets_request.BatchDisassociateProjectAssetsRequest,
) -> zapros.Request:
    ...
    url = url.replace("{projectId}", quote(str(input["project_id"]), safe=""))
    params: dict[str, str] = {}
