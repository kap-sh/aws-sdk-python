...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_logging_options_response.DescribeLoggingOptionsResponse = aws_sdk_iotsitewise.types.describe_logging_options_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_logging_options_request.DescribeLoggingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
