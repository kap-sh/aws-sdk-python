...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_composition_relationships_response.ListCompositionRelationshipsResponse = aws_sdk_iotsitewise.types.list_composition_relationships_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_composition_relationships_request.ListCompositionRelationshipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
