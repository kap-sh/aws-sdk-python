"""Generated from Smithy shape ``com.amazonaws.iotsitewise#UpdateAsset``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.update_asset_response.UpdateAssetResponse = (
        aws_sdk_iotsitewise.types.update_asset_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.update_asset_request.UpdateAssetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_asset_request.serialize_json(input)
    ).encode()
...
def update_asset(
    ...
    aws_sdk_iotsitewise.types.update_asset_response.UpdateAssetResponse, zapros.Response
]:
