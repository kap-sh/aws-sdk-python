...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_project_assets_response.ListProjectAssetsResponse = aws_sdk_iotsitewise.types.list_project_assets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_project_assets_request.ListProjectAssetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
