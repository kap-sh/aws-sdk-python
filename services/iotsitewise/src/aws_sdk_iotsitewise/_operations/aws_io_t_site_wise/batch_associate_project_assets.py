...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.batch_associate_project_assets_response.BatchAssociateProjectAssetsResponse = aws_sdk_iotsitewise.types.batch_associate_project_assets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.batch_associate_project_assets_request.BatchAssociateProjectAssetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.batch_associate_project_assets_request.serialize_json(
            input_
        )
    ).encode()
