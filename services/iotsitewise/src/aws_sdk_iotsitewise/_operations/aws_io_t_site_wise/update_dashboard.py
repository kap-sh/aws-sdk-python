...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.update_dashboard_request.UpdateDashboardRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_dashboard_request.serialize_json(input)
    ).encode()
