...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.update_dashboard_response.UpdateDashboardResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.update_dashboard_request.UpdateDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_dashboard_request.serialize_json(input_)
    ).encode()
