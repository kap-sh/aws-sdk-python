"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DeletePortal``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.delete_portal_response.DeletePortalResponse = (
        aws_sdk_iotsitewise.types.delete_portal_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.delete_portal_request.DeletePortalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
