"""Generated from Smithy shape ``com.amazonaws.iotsitewise#UpdateComputationModel``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.update_computation_model_response.UpdateComputationModelResponse = aws_sdk_iotsitewise.types.update_computation_model_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.update_computation_model_request.UpdateComputationModelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_computation_model_request.serialize_json(input)
    ).encode()
...
async def async_update_computation_model(
