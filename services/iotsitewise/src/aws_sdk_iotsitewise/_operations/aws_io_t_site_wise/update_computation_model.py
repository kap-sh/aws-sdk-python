...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.update_computation_model_request.UpdateComputationModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_computation_model_request.serialize_json(
            input_
        )
    ).encode()
