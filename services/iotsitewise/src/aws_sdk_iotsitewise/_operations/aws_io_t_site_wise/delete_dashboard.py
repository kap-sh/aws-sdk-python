...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.delete_dashboard_response.DeleteDashboardResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.delete_dashboard_request.DeleteDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
