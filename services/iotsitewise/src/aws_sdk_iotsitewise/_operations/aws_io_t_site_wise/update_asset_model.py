...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.update_asset_model_response.UpdateAssetModelResponse = aws_sdk_iotsitewise.types.update_asset_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.update_asset_model_request.UpdateAssetModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_asset_model_request.serialize_json(input_)
    ).encode()
