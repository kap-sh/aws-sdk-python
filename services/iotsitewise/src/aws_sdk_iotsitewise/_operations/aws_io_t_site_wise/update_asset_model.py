...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.update_asset_model_request.UpdateAssetModelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_asset_model_request.serialize_json(input)
    ).encode()
