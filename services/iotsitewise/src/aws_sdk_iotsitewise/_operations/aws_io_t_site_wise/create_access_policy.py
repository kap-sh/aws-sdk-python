...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.create_access_policy_request.CreateAccessPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_access_policy_request.serialize_json(input)
    ).encode()
