"""Generated from Smithy shape ``com.amazonaws.iotsitewise#CreateAccessPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.create_access_policy_response.CreateAccessPolicyResponse = aws_sdk_iotsitewise.types.create_access_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.create_access_policy_request.CreateAccessPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_access_policy_request.serialize_json(input_)
    ).encode()
