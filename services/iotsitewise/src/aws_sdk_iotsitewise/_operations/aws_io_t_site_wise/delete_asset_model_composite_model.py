...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.delete_asset_model_composite_model_response.DeleteAssetModelCompositeModelResponse = aws_sdk_iotsitewise.types.delete_asset_model_composite_model_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.delete_asset_model_composite_model_request.DeleteAssetModelCompositeModelRequest,
) -> zapros.Request:
    ...
    if "match_for_version_type" in input:
        headers["Match-For-Version-Type"] = str(input["match_for_version_type"])
    body: bytes | None = b""
