...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.put_default_encryption_configuration_response.PutDefaultEncryptionConfigurationResponse = aws_sdk_iotsitewise.types.put_default_encryption_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.put_default_encryption_configuration_request.PutDefaultEncryptionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.put_default_encryption_configuration_request.serialize_json(
            input_
        )
    ).encode()
