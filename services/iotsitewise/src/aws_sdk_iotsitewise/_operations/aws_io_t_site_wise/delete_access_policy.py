"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DeleteAccessPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.delete_access_policy_response.DeleteAccessPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.delete_access_policy_request.DeleteAccessPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
