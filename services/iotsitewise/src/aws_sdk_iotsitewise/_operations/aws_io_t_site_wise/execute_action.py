...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.execute_action_response.ExecuteActionResponse = (
        aws_sdk_iotsitewise.types.execute_action_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.execute_action_request.ExecuteActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.execute_action_request.serialize_json(input_)
    ).encode()
