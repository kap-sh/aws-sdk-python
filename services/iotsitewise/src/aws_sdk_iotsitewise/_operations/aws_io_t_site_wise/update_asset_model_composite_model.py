...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.update_asset_model_composite_model_response.UpdateAssetModelCompositeModelResponse = aws_sdk_iotsitewise.types.update_asset_model_composite_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.update_asset_model_composite_model_request.UpdateAssetModelCompositeModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.update_asset_model_composite_model_request.serialize_json(
            input_
        )
    ).encode()
