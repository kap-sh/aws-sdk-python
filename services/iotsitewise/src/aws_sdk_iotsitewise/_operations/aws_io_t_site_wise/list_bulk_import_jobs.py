...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_bulk_import_jobs_response.ListBulkImportJobsResponse = aws_sdk_iotsitewise.types.list_bulk_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_bulk_import_jobs_request.ListBulkImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
