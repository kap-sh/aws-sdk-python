"""Generated from Smithy shape ``com.amazonaws.iotsitewise#BatchPutAssetPropertyValue``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.batch_put_asset_property_value_response.BatchPutAssetPropertyValueResponse = aws_sdk_iotsitewise.types.batch_put_asset_property_value_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.batch_put_asset_property_value_request.BatchPutAssetPropertyValueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_batch_put_asset_property_value(
