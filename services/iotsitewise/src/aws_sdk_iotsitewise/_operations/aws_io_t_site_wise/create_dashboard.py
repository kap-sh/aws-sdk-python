...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.create_dashboard_response.CreateDashboardResponse = (
        aws_sdk_iotsitewise.types.create_dashboard_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.create_dashboard_request.CreateDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_dashboard_request.serialize_json(input_)
    ).encode()
