...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.create_dashboard_request.CreateDashboardRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_dashboard_request.serialize_json(input)
    ).encode()
