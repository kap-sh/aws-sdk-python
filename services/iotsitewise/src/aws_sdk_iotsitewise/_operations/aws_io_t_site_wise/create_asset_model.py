...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.create_asset_model_response.CreateAssetModelResponse = aws_sdk_iotsitewise.types.create_asset_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.create_asset_model_request.CreateAssetModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_asset_model_request.serialize_json(input_)
    ).encode()
