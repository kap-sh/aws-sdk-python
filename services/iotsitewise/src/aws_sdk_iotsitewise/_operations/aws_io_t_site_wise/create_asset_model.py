...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.create_asset_model_request.CreateAssetModelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.create_asset_model_request.serialize_json(input)
    ).encode()
