"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeTimeSeries``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_time_series_response.DescribeTimeSeriesResponse = aws_sdk_iotsitewise.types.describe_time_series_response.deserialize_json(
