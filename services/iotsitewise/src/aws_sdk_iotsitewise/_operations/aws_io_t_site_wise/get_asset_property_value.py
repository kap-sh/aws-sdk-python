...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.get_asset_property_value_response.GetAssetPropertyValueResponse = aws_sdk_iotsitewise.types.get_asset_property_value_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.get_asset_property_value_request.GetAssetPropertyValueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
