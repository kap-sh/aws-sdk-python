...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_asset_composite_model_request.DescribeAssetCompositeModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["asset_composite_model_id"]), safe=""),
    )
    params: dict[str, str] = {}
