"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeAssetCompositeModel``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_asset_composite_model_response.DescribeAssetCompositeModelResponse = aws_sdk_iotsitewise.types.describe_asset_composite_model_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.describe_asset_composite_model_request.DescribeAssetCompositeModelRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["asset_composite_model_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_describe_asset_composite_model(
