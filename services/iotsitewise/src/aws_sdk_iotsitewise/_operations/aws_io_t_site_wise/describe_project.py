"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeProject``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_project_response.DescribeProjectResponse = (
        aws_sdk_iotsitewise.types.describe_project_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_project_request.DescribeProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/projects/{projectId}"
