"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeAssetProperty``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_asset_property_response.DescribeAssetPropertyResponse = aws_sdk_iotsitewise.types.describe_asset_property_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.describe_asset_property_request.DescribeAssetPropertyRequest,
) -> zapros.Request:
    ...
    url = url.replace("{propertyId}", quote(str(input["property_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_describe_asset_property(
