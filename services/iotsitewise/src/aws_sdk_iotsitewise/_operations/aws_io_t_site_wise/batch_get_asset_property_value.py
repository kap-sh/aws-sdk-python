...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.batch_get_asset_property_value_response.BatchGetAssetPropertyValueResponse = aws_sdk_iotsitewise.types.batch_get_asset_property_value_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.batch_get_asset_property_value_request.BatchGetAssetPropertyValueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.batch_get_asset_property_value_request.serialize_json(
            input_
        )
    ).encode()
