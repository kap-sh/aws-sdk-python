"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeAction``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_action_response.DescribeActionResponse = (
        aws_sdk_iotsitewise.types.describe_action_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_action_request.DescribeActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/actions/{actionId}"
    url = url.replace("{actionId}", quote(str(input_["action_id"]), safe=""))
    params: dict[str, str] = {}
