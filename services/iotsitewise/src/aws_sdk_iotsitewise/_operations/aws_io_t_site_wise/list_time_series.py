...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_time_series_response.ListTimeSeriesResponse = (
        aws_sdk_iotsitewise.types.list_time_series_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iotsitewise.types.list_time_series_request.ListTimeSeriesRequest,
) -> zapros.Request:
    ...
    if "alias_prefix" in input:
        params["aliasPrefix"] = str(input["alias_prefix"])
    if "time_series_type" in input:
        params["timeSeriesType"] = str(input["time_series_type"])
