"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListDashboards``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_dashboards_response.ListDashboardsResponse = (
        aws_sdk_iotsitewise.types.list_dashboards_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_dashboards_request.ListDashboardsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/dashboards"
    params: dict[str, str] = {}
    if "project_id" in input_:
        params["projectId"] = str(input_["project_id"])
