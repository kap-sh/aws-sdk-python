"""Generated from Smithy shape ``com.amazonaws.iotsitewise#PutStorageConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.put_storage_configuration_response.PutStorageConfigurationResponse = aws_sdk_iotsitewise.types.put_storage_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.put_storage_configuration_request.PutStorageConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/configuration/account/storage"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iotsitewise.types.put_storage_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.put_storage_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_storage_configuration(
