...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.disassociate_time_series_from_asset_property_request.DisassociateTimeSeriesFromAssetPropertyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotsitewise.types.disassociate_time_series_from_asset_property_request.serialize_json(
            input_
        )
    ).encode()
