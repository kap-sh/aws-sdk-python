"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListAssets``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.list_assets_response.ListAssetsResponse = (
        aws_sdk_iotsitewise.types.list_assets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.list_assets_request.ListAssetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "asset_model_id" in input_:
        params["assetModelId"] = str(input_["asset_model_id"])
    if "filter" in input_:
...
def list_assets(
    ...
    aws_sdk_iotsitewise.types.list_assets_response.ListAssetsResponse, zapros.Response
]:
