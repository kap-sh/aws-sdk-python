"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_iotsitewise.types.describe_execution_response.DescribeExecutionResponse = aws_sdk_iotsitewise.types.describe_execution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iotsitewise.types.describe_execution_request.DescribeExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/executions/{executionId}"
