"""Generated from Smithy shape ``com.amazonaws.uxc#GetAccountCustomizations``."""
...
def build_request(
    ...
    input_: aws_sdk_uxc.types.get_account_customizations_input.GetAccountCustomizationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_account_customizations(
