...
def handle_response(
    ...
    out: aws_sdk_uxc.types.list_services_output.ListServicesOutput = (
        aws_sdk_uxc.types.list_services_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_uxc.types.list_services_input.ListServicesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_services(
    ...
    input_: aws_sdk_uxc.types.list_services_input.ListServicesInput,
) -> tuple[aws_sdk_uxc.types.list_services_output.ListServicesOutput, zapros.Response]:
