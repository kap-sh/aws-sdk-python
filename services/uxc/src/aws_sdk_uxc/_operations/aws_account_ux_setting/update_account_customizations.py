...
def handle_response(
    ...
    out: aws_sdk_uxc.types.update_account_customizations_output.UpdateAccountCustomizationsOutput = aws_sdk_uxc.types.update_account_customizations_output.deserialize_json(
...
def get_signer(
...
) -> aws_sdk_uxc._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_uxc._auth._sigv4.build_sigv4_auth_scheme("uxc", options.region)
        )
        if sigv4_config is not None:
            return aws_sdk_uxc._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input: aws_sdk_uxc.types.update_account_customizations_input.UpdateAccountCustomizationsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_uxc.types.update_account_customizations_input.serialize_json(input)
    ).encode()
