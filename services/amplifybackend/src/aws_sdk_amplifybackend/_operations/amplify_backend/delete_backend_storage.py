"""Generated from Smithy shape ``com.amazonaws.amplifybackend#DeleteBackendStorage``."""
...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.delete_backend_storage_response.DeleteBackendStorageResponse = aws_sdk_amplifybackend.types.delete_backend_storage_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.delete_backend_storage_request.DeleteBackendStorageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.delete_backend_storage_request.serialize_json(
            input
        )
    ).encode()
...
async def async_delete_backend_storage(
