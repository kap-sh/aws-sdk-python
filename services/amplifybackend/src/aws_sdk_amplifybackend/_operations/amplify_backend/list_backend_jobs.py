...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.list_backend_jobs_request.ListBackendJobsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.list_backend_jobs_request.serialize_json(input)
    ).encode()
