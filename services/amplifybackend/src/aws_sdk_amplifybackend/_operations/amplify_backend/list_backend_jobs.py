...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.list_backend_jobs_response.ListBackendJobsResponse = aws_sdk_amplifybackend.types.list_backend_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.list_backend_jobs_request.ListBackendJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.list_backend_jobs_request.serialize_json(input_)
    ).encode()
