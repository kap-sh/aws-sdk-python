...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.update_backend_storage_response.UpdateBackendStorageResponse = aws_sdk_amplifybackend.types.update_backend_storage_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.update_backend_storage_request.UpdateBackendStorageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.update_backend_storage_request.serialize_json(
            input_
        )
    ).encode()
