"""Generated from Smithy shape ``com.amazonaws.amplifybackend#UpdateBackendAuth``."""
...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.update_backend_auth_response.UpdateBackendAuthResponse = aws_sdk_amplifybackend.types.update_backend_auth_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.update_backend_auth_request.UpdateBackendAuthRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/backend/{AppId}/auth/{BackendEnvironmentName}"
    url = url.replace("{AppId}", quote(str(input["app_id"]), safe=""))
    url = url.replace(
        "{BackendEnvironmentName}",
        quote(str(input["backend_environment_name"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.update_backend_auth_request.serialize_json(input)
    ).encode()
...
async def async_update_backend_auth(
