...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.create_backend_api_response.CreateBackendAPIResponse = aws_sdk_amplifybackend.types.create_backend_api_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.create_backend_api_request.CreateBackendAPIRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.create_backend_api_request.serialize_json(input_)
    ).encode()
