...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.create_backend_api_request.CreateBackendAPIRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.create_backend_api_request.serialize_json(input)
    ).encode()
