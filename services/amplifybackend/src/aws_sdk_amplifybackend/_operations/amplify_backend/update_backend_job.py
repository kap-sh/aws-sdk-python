...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.update_backend_job_request.UpdateBackendJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.update_backend_job_request.serialize_json(input)
    ).encode()
