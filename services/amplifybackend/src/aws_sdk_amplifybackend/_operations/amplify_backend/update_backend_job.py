...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.update_backend_job_response.UpdateBackendJobResponse = aws_sdk_amplifybackend.types.update_backend_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.update_backend_job_request.UpdateBackendJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.update_backend_job_request.serialize_json(input_)
    ).encode()
