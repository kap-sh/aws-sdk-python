...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.delete_backend_response.DeleteBackendResponse = (
        aws_sdk_amplifybackend.types.delete_backend_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.delete_backend_request.DeleteBackendRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
