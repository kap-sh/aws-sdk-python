"""Generated from Smithy shape ``com.amazonaws.amplifybackend#GetBackendStorage``."""
...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.get_backend_storage_response.GetBackendStorageResponse = aws_sdk_amplifybackend.types.get_backend_storage_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.get_backend_storage_request.GetBackendStorageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.get_backend_storage_request.serialize_json(input)
    ).encode()
...
async def async_get_backend_storage(
