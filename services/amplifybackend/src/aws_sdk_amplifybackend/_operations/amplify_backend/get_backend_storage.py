...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.get_backend_storage_request.GetBackendStorageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.get_backend_storage_request.serialize_json(input_)
    ).encode()
