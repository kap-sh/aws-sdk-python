...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.create_backend_response.CreateBackendResponse = (
        aws_sdk_amplifybackend.types.create_backend_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.create_backend_request.CreateBackendRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.create_backend_request.serialize_json(input_)
    ).encode()
