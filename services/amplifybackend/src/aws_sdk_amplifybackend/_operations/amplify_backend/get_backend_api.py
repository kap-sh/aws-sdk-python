...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.get_backend_api_response.GetBackendAPIResponse = (
        aws_sdk_amplifybackend.types.get_backend_api_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.get_backend_api_request.GetBackendAPIRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.get_backend_api_request.serialize_json(input)
    ).encode()
