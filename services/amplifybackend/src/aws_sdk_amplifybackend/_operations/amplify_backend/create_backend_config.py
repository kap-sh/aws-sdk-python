...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.create_backend_config_request.CreateBackendConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.create_backend_config_request.serialize_json(
            input_
        )
    ).encode()
