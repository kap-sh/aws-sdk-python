...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.create_backend_config_response.CreateBackendConfigResponse = aws_sdk_amplifybackend.types.create_backend_config_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.create_backend_config_request.CreateBackendConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.create_backend_config_request.serialize_json(input)
    ).encode()
