...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.delete_backend_auth_request.DeleteBackendAuthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.delete_backend_auth_request.serialize_json(input_)
    ).encode()
