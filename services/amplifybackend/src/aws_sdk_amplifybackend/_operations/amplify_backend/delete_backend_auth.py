"""Generated from Smithy shape ``com.amazonaws.amplifybackend#DeleteBackendAuth``."""
...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.delete_backend_auth_response.DeleteBackendAuthResponse = aws_sdk_amplifybackend.types.delete_backend_auth_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.delete_backend_auth_request.DeleteBackendAuthRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.delete_backend_auth_request.serialize_json(input)
    ).encode()
...
async def async_delete_backend_auth(
