"""Generated from Smithy shape ``com.amazonaws.amplifybackend#RemoveBackendConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.remove_backend_config_response.RemoveBackendConfigResponse = aws_sdk_amplifybackend.types.remove_backend_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.remove_backend_config_request.RemoveBackendConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/backend/{AppId}/config/remove"
...
async def async_remove_backend_config(
