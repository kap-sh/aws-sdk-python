...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.import_backend_storage_response.ImportBackendStorageResponse = aws_sdk_amplifybackend.types.import_backend_storage_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.import_backend_storage_request.ImportBackendStorageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.import_backend_storage_request.serialize_json(
            input_
        )
    ).encode()
