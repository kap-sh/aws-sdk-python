...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.import_backend_auth_request.ImportBackendAuthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.import_backend_auth_request.serialize_json(input_)
    ).encode()
