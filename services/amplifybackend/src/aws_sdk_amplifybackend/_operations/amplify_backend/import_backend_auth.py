"""Generated from Smithy shape ``com.amazonaws.amplifybackend#ImportBackendAuth``."""
...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.import_backend_auth_response.ImportBackendAuthResponse = aws_sdk_amplifybackend.types.import_backend_auth_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.import_backend_auth_request.ImportBackendAuthRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.import_backend_auth_request.serialize_json(input)
    ).encode()
...
async def async_import_backend_auth(
