"""Generated from Smithy shape ``com.amazonaws.amplifybackend#GetToken``."""
...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.get_token_response.GetTokenResponse = (
        aws_sdk_amplifybackend.types.get_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.get_token_request.GetTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/backend/{AppId}/challenge/{SessionId}"
...
def get_token(
    ...
    aws_sdk_amplifybackend.types.get_token_response.GetTokenResponse, zapros.Response
]:
