...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.create_backend_auth_request.CreateBackendAuthRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.create_backend_auth_request.serialize_json(input)
    ).encode()
