...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.create_backend_auth_response.CreateBackendAuthResponse = aws_sdk_amplifybackend.types.create_backend_auth_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.create_backend_auth_request.CreateBackendAuthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.create_backend_auth_request.serialize_json(input_)
    ).encode()
