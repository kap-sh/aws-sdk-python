"""Generated from Smithy shape ``com.amazonaws.amplifybackend#GetBackendAPIModels``."""
...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.get_backend_api_models_response.GetBackendAPIModelsResponse = aws_sdk_amplifybackend.types.get_backend_api_models_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.get_backend_api_models_request.GetBackendAPIModelsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.get_backend_api_models_request.serialize_json(
            input
        )
    ).encode()
...
async def async_get_backend_api_models(
