...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.update_backend_config_request.UpdateBackendConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.update_backend_config_request.serialize_json(
            input_
        )
    ).encode()
