...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.update_backend_config_response.UpdateBackendConfigResponse = aws_sdk_amplifybackend.types.update_backend_config_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.update_backend_config_request.UpdateBackendConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.update_backend_config_request.serialize_json(input)
    ).encode()
