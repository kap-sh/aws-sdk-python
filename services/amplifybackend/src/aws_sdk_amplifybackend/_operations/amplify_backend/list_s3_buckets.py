...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.list_s3_buckets_request.ListS3BucketsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.list_s3_buckets_request.serialize_json(input)
    ).encode()
