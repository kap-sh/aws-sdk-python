...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.list_s3_buckets_response.ListS3BucketsResponse = (
        aws_sdk_amplifybackend.types.list_s3_buckets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.list_s3_buckets_request.ListS3BucketsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.list_s3_buckets_request.serialize_json(input_)
    ).encode()
