...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.get_backend_auth_response.GetBackendAuthResponse = aws_sdk_amplifybackend.types.get_backend_auth_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.get_backend_auth_request.GetBackendAuthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.get_backend_auth_request.serialize_json(input_)
    ).encode()
