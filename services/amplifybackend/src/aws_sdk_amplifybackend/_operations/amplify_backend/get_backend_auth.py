...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.get_backend_auth_request.GetBackendAuthRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.get_backend_auth_request.serialize_json(input)
    ).encode()
