"""Generated from Smithy shape ``com.amazonaws.amplifybackend#CreateToken``."""
...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.create_token_response.CreateTokenResponse = (
        aws_sdk_amplifybackend.types.create_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.create_token_request.CreateTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/backend/{AppId}/challenge"
