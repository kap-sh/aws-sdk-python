...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.delete_token_response.DeleteTokenResponse = (
        aws_sdk_amplifybackend.types.delete_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.delete_token_request.DeleteTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
