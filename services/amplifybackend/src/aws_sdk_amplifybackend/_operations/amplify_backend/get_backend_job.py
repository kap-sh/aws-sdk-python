...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.get_backend_job_response.GetBackendJobResponse = (
        aws_sdk_amplifybackend.types.get_backend_job_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.get_backend_job_request.GetBackendJobRequest,
) -> zapros.Request:
