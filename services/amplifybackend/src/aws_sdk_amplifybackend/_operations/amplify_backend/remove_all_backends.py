...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.remove_all_backends_response.RemoveAllBackendsResponse = aws_sdk_amplifybackend.types.remove_all_backends_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.remove_all_backends_request.RemoveAllBackendsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.remove_all_backends_request.serialize_json(input_)
    ).encode()
