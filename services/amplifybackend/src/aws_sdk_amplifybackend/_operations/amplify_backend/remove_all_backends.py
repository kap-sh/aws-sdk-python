...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.remove_all_backends_request.RemoveAllBackendsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.remove_all_backends_request.serialize_json(input)
    ).encode()
