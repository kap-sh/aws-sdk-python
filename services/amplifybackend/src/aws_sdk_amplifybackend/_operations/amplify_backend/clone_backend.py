...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.clone_backend_response.CloneBackendResponse = (
        aws_sdk_amplifybackend.types.clone_backend_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.clone_backend_request.CloneBackendRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.clone_backend_request.serialize_json(input)
    ).encode()
