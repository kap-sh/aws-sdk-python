...
def handle_response(
    ...
    out: aws_sdk_amplifybackend.types.delete_backend_api_response.DeleteBackendAPIResponse = aws_sdk_amplifybackend.types.delete_backend_api_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifybackend.types.delete_backend_api_request.DeleteBackendAPIRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.delete_backend_api_request.serialize_json(input_)
    ).encode()
