...
def build_request(
    ...
    input: aws_sdk_amplifybackend.types.delete_backend_api_request.DeleteBackendAPIRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifybackend.types.delete_backend_api_request.serialize_json(input)
    ).encode()
