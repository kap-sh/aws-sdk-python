...
from aws_sdk_amplifybackend._services._aws_config import aws_config
...
class AmplifyBackendClientConfig(TypedDict, total=False):
...
class AmplifyBackendClient:
    ...
    def clone_backend(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.clone_backend_request.CloneBackendRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.clone_backend_response.CloneBackendResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.clone_backend.clone_backend(
    ...
    def create_backend(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.create_backend_request.CreateBackendRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.create_backend_response.CreateBackendResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.create_backend.create_backend(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_backend_api(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.create_backend_api_request.CreateBackendAPIRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.create_backend_api_response.CreateBackendAPIResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.create_backend_api.create_backend_api(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_backend_auth(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.create_backend_auth_request.CreateBackendAuthRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.create_backend_auth_response.CreateBackendAuthResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.create_backend_auth.create_backend_auth(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_backend_config(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.create_backend_config_request.CreateBackendConfigRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.create_backend_config_response.CreateBackendConfigResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.create_backend_config.create_backend_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_backend_storage(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.create_backend_storage_request.CreateBackendStorageRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.create_backend_storage_response.CreateBackendStorageResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.create_backend_storage.create_backend_storage(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.create_token_request.CreateTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.create_token_response.CreateTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.create_token.create_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_backend(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.delete_backend_request.DeleteBackendRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.delete_backend_response.DeleteBackendResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.delete_backend.delete_backend(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_backend_api(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.delete_backend_api_request.DeleteBackendAPIRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.delete_backend_api_response.DeleteBackendAPIResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.delete_backend_api.delete_backend_api(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_backend_auth(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.delete_backend_auth_request.DeleteBackendAuthRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.delete_backend_auth_response.DeleteBackendAuthResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.delete_backend_auth.delete_backend_auth(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_backend_storage(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.delete_backend_storage_request.DeleteBackendStorageRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.delete_backend_storage_response.DeleteBackendStorageResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.delete_backend_storage.delete_backend_storage(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.delete_token_request.DeleteTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.delete_token_response.DeleteTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.delete_token.delete_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_backend_api_models(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.generate_backend_api_models_request.GenerateBackendAPIModelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.generate_backend_api_models_response.GenerateBackendAPIModelsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.generate_backend_api_models.generate_backend_api_models(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_backend(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.get_backend_request.GetBackendRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.get_backend_response.GetBackendResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.get_backend.get_backend(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_backend_api(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.get_backend_api_request.GetBackendAPIRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.get_backend_api_response.GetBackendAPIResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.get_backend_api.get_backend_api(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_backend_api_models(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.get_backend_api_models_request.GetBackendAPIModelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.get_backend_api_models_response.GetBackendAPIModelsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.get_backend_api_models.get_backend_api_models(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_backend_auth(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.get_backend_auth_request.GetBackendAuthRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.get_backend_auth_response.GetBackendAuthResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.get_backend_auth.get_backend_auth(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_backend_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.get_backend_job_request.GetBackendJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.get_backend_job_response.GetBackendJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.get_backend_job.get_backend_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_backend_storage(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.get_backend_storage_request.GetBackendStorageRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.get_backend_storage_response.GetBackendStorageResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.get_backend_storage.get_backend_storage(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.get_token_request.GetTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.get_token_response.GetTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.get_token.get_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_backend_auth(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.import_backend_auth_request.ImportBackendAuthRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.import_backend_auth_response.ImportBackendAuthResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.import_backend_auth.import_backend_auth(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_backend_storage(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.import_backend_storage_request.ImportBackendStorageRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.import_backend_storage_response.ImportBackendStorageResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.import_backend_storage.import_backend_storage(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_backend_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.list_backend_jobs_request.ListBackendJobsRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.list_backend_jobs_response.ListBackendJobsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.list_backend_jobs.list_backend_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_s3_buckets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.list_s3_buckets_request.ListS3BucketsRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.list_s3_buckets_response.ListS3BucketsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.list_s3_buckets.list_s3_buckets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_all_backends(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.remove_all_backends_request.RemoveAllBackendsRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.remove_all_backends_response.RemoveAllBackendsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.remove_all_backends.remove_all_backends(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_backend_config(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.remove_backend_config_request.RemoveBackendConfigRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.remove_backend_config_response.RemoveBackendConfigResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.remove_backend_config.remove_backend_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_backend_api(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.update_backend_api_request.UpdateBackendAPIRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.update_backend_api_response.UpdateBackendAPIResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.update_backend_api.update_backend_api(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_backend_auth(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.update_backend_auth_request.UpdateBackendAuthRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.update_backend_auth_response.UpdateBackendAuthResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.update_backend_auth.update_backend_auth(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_backend_config(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.update_backend_config_request.UpdateBackendConfigRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.update_backend_config_response.UpdateBackendConfigResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.update_backend_config.update_backend_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_backend_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.update_backend_job_request.UpdateBackendJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.update_backend_job_response.UpdateBackendJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.update_backend_job.update_backend_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_backend_storage(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amplifybackend.types.update_backend_storage_request.UpdateBackendStorageRequest]",
        ) -> OperationResponse[
            "aws_sdk_amplifybackend.types.update_backend_storage_response.UpdateBackendStorageResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_amplifybackend._operations.amplify_backend.update_backend_storage.update_backend_storage(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
