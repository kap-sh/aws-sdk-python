...
class UpdateBackendJobResponse(TypedDict):
    ...
    create_time: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
    ...
    update_time: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
