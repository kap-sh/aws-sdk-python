"""Generated from Smithy shape ``com.amazonaws.amplifybackend#RemoveAllBackendsResponse``."""
...
class RemoveAllBackendsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: RemoveAllBackendsResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
