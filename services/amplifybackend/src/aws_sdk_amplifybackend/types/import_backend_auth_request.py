...
class ImportBackendAuthRequest(TypedDict):
    ...
    identity_pool_id: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
    """<p>The ID of the Amazon Cognito identity pool.</p>"""
    native_client_id: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
    """<p>The ID of the Amazon Cognito native client.</p>"""
    user_pool_id: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
    """<p>The ID of the Amazon Cognito user pool.</p>"""
    web_client_id: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
