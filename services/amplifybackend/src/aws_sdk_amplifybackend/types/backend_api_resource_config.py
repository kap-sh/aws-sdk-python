...
if TYPE_CHECKING:
    ...
    import aws_sdk_amplifybackend.types.backend_api_conflict_resolution
    import aws_sdk_amplifybackend.types.list_of_backend_api_auth_type


class BackendAPIResourceConfig(TypedDict):
    additional_auth_types: NotRequired[
        "aws_sdk_amplifybackend.types.list_of_backend_api_auth_type.ListOfBackendAPIAuthType"
    ]
    """<p>Additional authentication methods used to interact with your data models.</p>"""
    api_name: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
    ...
    conflict_resolution: NotRequired[
        "aws_sdk_amplifybackend.types.backend_api_conflict_resolution.BackendAPIConflictResolution"
    ]
    ...
    service: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
    """<p>The service used to provision and interact with the data model.</p>"""
    transform_schema: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
...
def serialize_json(value: BackendAPIResourceConfig) -> dict:
    ...
    if "additional_auth_types" in value:
        ...
        out["additionalAuthTypes"] = (
            aws_sdk_amplifybackend.types.list_of_backend_api_auth_type.serialize_json(
    ...
    if "conflict_resolution" in value:
        ...
        out["conflictResolution"] = (
            aws_sdk_amplifybackend.types.backend_api_conflict_resolution.serialize_json(
    ...
    if "default_auth_type" in value:
        ...
        out["defaultAuthType"] = (
            aws_sdk_amplifybackend.types.backend_api_auth_type.serialize_json(
...
def deserialize_json(data: dict) -> BackendAPIResourceConfig:
    ...
    if "additionalAuthTypes" in data:
        ...
        out["additional_auth_types"] = (
            aws_sdk_amplifybackend.types.list_of_backend_api_auth_type.deserialize_json(
    ...
    if "conflictResolution" in data:
        ...
        out["conflict_resolution"] = (
            aws_sdk_amplifybackend.types.backend_api_conflict_resolution.deserialize_json(
    ...
    if "defaultAuthType" in data:
        ...
        out["default_auth_type"] = (
            aws_sdk_amplifybackend.types.backend_api_auth_type.deserialize_json(
