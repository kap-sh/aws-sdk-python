...
class GetTokenResponse(TypedDict, closed=True):
    ...
    """<p>The app ID.</p>"""
    challenge_code: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
    """<p>The one-time challenge code for authenticating into the Amplify Admin UI.</p>"""
    session_id: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
    """<p>A unique ID provided when creating a new challenge token.</p>"""
    ttl: NotRequired["aws_sdk_amplifybackend.types.__string.__string"]
