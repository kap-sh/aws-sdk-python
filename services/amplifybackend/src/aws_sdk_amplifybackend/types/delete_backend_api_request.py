"""Generated from Smithy shape ``com.amazonaws.amplifybackend#DeleteBackendAPIRequest``."""
...
class DeleteBackendAPIRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteBackendAPIRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DeleteBackendAPIRequest:
    out: DeleteBackendAPIRequest = {}  # type: ignore[typeddict-item]
