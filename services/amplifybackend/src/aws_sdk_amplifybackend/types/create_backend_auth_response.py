"""Generated from Smithy shape ``com.amazonaws.amplifybackend#CreateBackendAuthResponse``."""
...
class CreateBackendAuthResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateBackendAuthResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> CreateBackendAuthResponse:
    out: CreateBackendAuthResponse = {}  # type: ignore[typeddict-item]
    if "appId" in data:
