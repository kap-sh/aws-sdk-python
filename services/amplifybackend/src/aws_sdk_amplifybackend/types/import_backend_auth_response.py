"""Generated from Smithy shape ``com.amazonaws.amplifybackend#ImportBackendAuthResponse``."""
...
class ImportBackendAuthResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ImportBackendAuthResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> ImportBackendAuthResponse:
    out: ImportBackendAuthResponse = {}  # type: ignore[typeddict-item]
    if "appId" in data:
