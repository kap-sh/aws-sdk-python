...
class AmplifyBackendError(Exception):
    """Base class for all AmplifyBackend service errors."""


class ServiceError(AmplifyBackendError):
...
class SerializationError(AmplifyBackendError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AmplifyBackendError):
...
class WaiterFailedError(AmplifyBackendError):
...
class WaiterTimeoutError(AmplifyBackendError):
