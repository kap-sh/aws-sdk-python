"""Generated from Smithy shape ``com.amazonaws.amplifybackend#CreateBackendAPIResponse``."""
...
class CreateBackendAPIResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateBackendAPIResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> CreateBackendAPIResponse:
    out: CreateBackendAPIResponse = {}  # type: ignore[typeddict-item]
    if "appId" in data:
