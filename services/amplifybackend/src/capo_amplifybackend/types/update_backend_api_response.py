"""Generated from Smithy shape ``com.amazonaws.amplifybackend#UpdateBackendAPIResponse``."""
...
class UpdateBackendAPIResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateBackendAPIResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> UpdateBackendAPIResponse:
    out: UpdateBackendAPIResponse = {}  # type: ignore[typeddict-item]
    if "appId" in data:
