...
class GetBackendResponse(TypedDict, closed=True):
    amplify_feature_flags: NotRequired["capo_amplifybackend.types.__string.__string"]
    """<p>A stringified version of the cli.json file for your Amplify project.</p>"""
    amplify_meta_config: NotRequired["capo_amplifybackend.types.__string.__string"]
    ...
    """<p>The app ID.</p>"""
    app_name: NotRequired["capo_amplifybackend.types.__string.__string"]
