...
def serialize_json(value: UpdateBackendStorageRequest) -> dict:
    ...
    if "resource_config" in value:
        ...
        out["resourceConfig"] = (
            capo_amplifybackend.types.update_backend_storage_resource_config.serialize_json(
...
def deserialize_json(data: dict) -> UpdateBackendStorageRequest:
    ...
    if "resourceConfig" in data:
        ...
        out["resource_config"] = (
            capo_amplifybackend.types.update_backend_storage_resource_config.deserialize_json(
                data["resourceConfig"]
            )
        )
