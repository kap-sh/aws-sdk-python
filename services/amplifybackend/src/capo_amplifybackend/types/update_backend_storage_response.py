"""Generated from Smithy shape ``com.amazonaws.amplifybackend#UpdateBackendStorageResponse``."""
...
class UpdateBackendStorageResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateBackendStorageResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> UpdateBackendStorageResponse:
    out: UpdateBackendStorageResponse = {}  # type: ignore[typeddict-item]
    if "appId" in data:
