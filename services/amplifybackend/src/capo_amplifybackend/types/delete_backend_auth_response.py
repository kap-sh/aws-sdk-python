"""Generated from Smithy shape ``com.amazonaws.amplifybackend#DeleteBackendAuthResponse``."""
...
class DeleteBackendAuthResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteBackendAuthResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> DeleteBackendAuthResponse:
    out: DeleteBackendAuthResponse = {}  # type: ignore[typeddict-item]
    if "appId" in data:
