"""Generated from Smithy shape ``com.amazonaws.amplifybackend#ImportBackendStorageResponse``."""
...
class ImportBackendStorageResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ImportBackendStorageResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> ImportBackendStorageResponse:
    out: ImportBackendStorageResponse = {}  # type: ignore[typeddict-item]
    if "appId" in data:
