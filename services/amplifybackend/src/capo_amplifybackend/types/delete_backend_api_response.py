"""Generated from Smithy shape ``com.amazonaws.amplifybackend#DeleteBackendAPIResponse``."""
...
class DeleteBackendAPIResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteBackendAPIResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> DeleteBackendAPIResponse:
    out: DeleteBackendAPIResponse = {}  # type: ignore[typeddict-item]
    if "appId" in data:
