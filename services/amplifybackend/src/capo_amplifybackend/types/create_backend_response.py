"""Generated from Smithy shape ``com.amazonaws.amplifybackend#CreateBackendResponse``."""
...
class CreateBackendResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateBackendResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> CreateBackendResponse:
    out: CreateBackendResponse = {}  # type: ignore[typeddict-item]
    if "appId" in data:
