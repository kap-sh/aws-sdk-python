"""Generated from Smithy shape ``com.amazonaws.amplifybackend#GetBackendJobResponse``."""
...
class GetBackendJobResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetBackendJobResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> GetBackendJobResponse:
    out: GetBackendJobResponse = {}  # type: ignore[typeddict-item]
    if "appId" in data:
