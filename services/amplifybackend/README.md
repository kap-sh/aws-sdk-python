...
```
pip install aws-sdk-amplifybackend
```

## Usage

```python
from aws_sdk_amplifybackend import AsyncAmplifyBackendClient
...
```python
from aws_sdk_amplifybackend import AsyncAmplifyBackendClient
from aws_sdk_amplifybackend.error import BadRequestException
