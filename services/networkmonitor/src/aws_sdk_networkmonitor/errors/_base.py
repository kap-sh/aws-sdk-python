...
class NetworkMonitorError(Exception):
    """Base class for all NetworkMonitor service errors."""


class ServiceError(NetworkMonitorError):
...
class SerializationError(NetworkMonitorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(NetworkMonitorError):
...
class WaiterFailedError(NetworkMonitorError):
...
class WaiterTimeoutError(NetworkMonitorError):
