...
class CreateMonitorProbeInput(TypedDict, closed=True):
    ...
    probe_tags: NotRequired["aws_sdk_networkmonitor.types.tag_map.TagMap"]
...
def serialize_json(value: CreateMonitorProbeInput) -> dict:
    ...
    if "probe_tags" in value:
        ...
        out["probeTags"] = aws_sdk_networkmonitor.types.tag_map.serialize_json(
            value["probe_tags"]
        )
    return out
...
def deserialize_json(data: dict) -> CreateMonitorProbeInput:
    ...
    if "probeTags" in data:
        ...
        out["probe_tags"] = aws_sdk_networkmonitor.types.tag_map.deserialize_json(
            data["probeTags"]
        )
    return out
