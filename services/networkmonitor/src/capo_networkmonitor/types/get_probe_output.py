...
# --- restJson1 ser/de ---
def serialize_json(value: GetProbeOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetProbeOutput:
    out: GetProbeOutput = {}  # type: ignore[typeddict-item]
    if "probeId" in data:
    ...
    if "sourceArn" in data:
        ...
        raise DeserializationError("GetProbeOutput.source_arn required")
    if "destination" in data:
        out["destination"] = data["destination"]
    else:
        raise DeserializationError("GetProbeOutput.destination required")
    ...
    if "protocol" in data:
        ...
        raise DeserializationError("GetProbeOutput.protocol required")
