...
from capo_networkmonitor._resources.network_monitor.probe_resource import (
    AsyncProbeResource,
)
from capo_networkmonitor._services._aws_config import aaws_config
...
class AsyncNetworkMonitorClient:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_networkmonitor.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_networkmonitor.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_networkmonitor._operations.network_monitor.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_networkmonitor.types.list_tags_for_resource_input.ListTagsForResourceInput = {}  # type: ignore[typeddict-item]
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_networkmonitor.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_networkmonitor.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_networkmonitor._operations.network_monitor.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_networkmonitor.types.tag_resource_input.TagResourceInput = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_networkmonitor.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_networkmonitor.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_networkmonitor._operations.network_monitor.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_networkmonitor.types.untag_resource_input.UntagResourceInput = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
