"""Generated from Smithy shape ``com.amazonaws.networkmonitor#GetMonitor``."""
...
def handle_response(
    ...
    out: capo_networkmonitor.types.get_monitor_output.GetMonitorOutput = (
        capo_networkmonitor.types.get_monitor_output.deserialize_json(
...
def get_monitor(
    ...
    capo_networkmonitor.types.get_monitor_output.GetMonitorOutput, zapros.Response
]:
