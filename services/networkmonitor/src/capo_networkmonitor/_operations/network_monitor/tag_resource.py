...
import capo_networkmonitor.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_networkmonitor.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_networkmonitor.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmonitor.types.tag_resource_input.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_networkmonitor.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
