"""Generated from Smithy shape ``com.amazonaws.networkmonitor#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_networkmonitor.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_networkmonitor.types.list_tags_for_resource_output.deserialize_json(
