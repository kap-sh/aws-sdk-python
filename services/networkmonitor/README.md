...
```
pip install aws-sdk-networkmonitor
```

## Usage

```python
from aws_sdk_networkmonitor import AsyncNetworkMonitorClient


async def main():
    async with AsyncNetworkMonitorClient() as s3:
...
```python
from aws_sdk_networkmonitor import AsyncNetworkMonitorClient
from aws_sdk_networkmonitor.error import AccessDeniedException
