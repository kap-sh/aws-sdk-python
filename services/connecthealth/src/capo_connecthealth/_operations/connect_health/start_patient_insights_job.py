...
import capo_connecthealth.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_connecthealth.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_connecthealth.types.start_patient_insights_job_response.StartPatientInsightsJobResponse = capo_connecthealth.types.start_patient_insights_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connecthealth.types.start_patient_insights_job_request.serialize_json(
            input_
        )
    ).encode()
