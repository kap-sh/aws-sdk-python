"""Generated from Smithy shape ``com.amazonaws.connecthealth#GetPatientInsightsJob``."""
...
def handle_response(
    ...
    out: capo_connecthealth.types.get_patient_insights_job_response.GetPatientInsightsJobResponse = capo_connecthealth.types.get_patient_insights_job_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domain/{domainId}/patient-insights-job/{jobId}"
...
async def async_get_patient_insights_job(
