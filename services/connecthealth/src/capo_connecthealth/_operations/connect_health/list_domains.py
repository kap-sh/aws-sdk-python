...
def handle_response(
    ...
    out: capo_connecthealth.types.list_domains_output.ListDomainsOutput = (
        capo_connecthealth.types.list_domains_output.deserialize_json(
...
def list_domains(
    ...
    capo_connecthealth.types.list_domains_output.ListDomainsOutput, zapros.Response
]:
