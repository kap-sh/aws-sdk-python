"""Generated from Smithy shape ``com.amazonaws.connecthealth#ListSubscriptions``."""
...
def handle_response(
    ...
    out: capo_connecthealth.types.list_subscriptions_output.ListSubscriptionsOutput = (
        capo_connecthealth.types.list_subscriptions_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{domainId}/subscriptions"
