"""Generated from Smithy shape ``com.amazonaws.connecthealth#GetMedicalScribeListeningSession``."""
...
def handle_response(
    ...
    out: capo_connecthealth.types.get_medical_scribe_listening_session_output.GetMedicalScribeListeningSessionOutput = capo_connecthealth.types.get_medical_scribe_listening_session_output.deserialize_json(
...
async def async_get_medical_scribe_listening_session(
