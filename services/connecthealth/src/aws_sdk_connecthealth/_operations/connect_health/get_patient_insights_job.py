...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_connecthealth.types.get_patient_insights_job_response.GetPatientInsightsJobResponse:
    import aws_sdk_connecthealth.types.get_patient_insights_job_response
    out: aws_sdk_connecthealth.types.get_patient_insights_job_response.GetPatientInsightsJobResponse = aws_sdk_connecthealth.types.get_patient_insights_job_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_connecthealth.types.get_patient_insights_job_request.GetPatientInsightsJobRequest) -> zapros.Request:
...
def get_patient_insights_job(options: OperationOptions, input: aws_sdk_connecthealth.types.get_patient_insights_job_request.GetPatientInsightsJobRequest) -> tuple[aws_sdk_connecthealth.types.get_patient_insights_job_response.GetPatientInsightsJobResponse, zapros.Response]:
...
async def async_get_patient_insights_job(options: AsyncOperationOptions, input: aws_sdk_connecthealth.types.get_patient_insights_job_request.GetPatientInsightsJobRequest) -> tuple[aws_sdk_connecthealth.types.get_patient_insights_job_response.GetPatientInsightsJobResponse, zapros.Response]:
