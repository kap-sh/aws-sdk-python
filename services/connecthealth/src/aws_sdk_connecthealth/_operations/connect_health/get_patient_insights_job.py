...
def handle_response(
    ...
    out: aws_sdk_connecthealth.types.get_patient_insights_job_response.GetPatientInsightsJobResponse = aws_sdk_connecthealth.types.get_patient_insights_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connecthealth.types.get_patient_insights_job_request.GetPatientInsightsJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
