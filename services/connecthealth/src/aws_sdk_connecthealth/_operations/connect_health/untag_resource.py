"""Generated from Smithy shape ``com.amazonaws.connecthealth#UntagResource``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_connecthealth.types.untag_resource_input.UntagResourceInput) -> zapros.Request:
...
def untag_resource(options: OperationOptions, input: aws_sdk_connecthealth.types.untag_resource_input.UntagResourceInput) -> tuple[None, zapros.Response]:
...
async def async_untag_resource(options: AsyncOperationOptions, input: aws_sdk_connecthealth.types.untag_resource_input.UntagResourceInput) -> tuple[None, zapros.Response]:
