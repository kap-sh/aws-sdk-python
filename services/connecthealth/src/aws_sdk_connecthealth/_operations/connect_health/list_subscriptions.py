...
def handle_response(
    ...
    out: aws_sdk_connecthealth.types.list_subscriptions_output.ListSubscriptionsOutput = aws_sdk_connecthealth.types.list_subscriptions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connecthealth.types.list_subscriptions_input.ListSubscriptionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
