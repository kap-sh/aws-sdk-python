...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_connecthealth.types.list_subscriptions_output.ListSubscriptionsOutput:
    import aws_sdk_connecthealth.types.list_subscriptions_output
    out: aws_sdk_connecthealth.types.list_subscriptions_output.ListSubscriptionsOutput = aws_sdk_connecthealth.types.list_subscriptions_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_connecthealth.types.list_subscriptions_input.ListSubscriptionsInput) -> zapros.Request:
...
def list_subscriptions(options: OperationOptions, input: aws_sdk_connecthealth.types.list_subscriptions_input.ListSubscriptionsInput) -> tuple[aws_sdk_connecthealth.types.list_subscriptions_output.ListSubscriptionsOutput, zapros.Response]:
...
async def async_list_subscriptions(options: AsyncOperationOptions, input: aws_sdk_connecthealth.types.list_subscriptions_input.ListSubscriptionsInput) -> tuple[aws_sdk_connecthealth.types.list_subscriptions_output.ListSubscriptionsOutput, zapros.Response]:
