...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_connecthealth.types.list_domains_output.ListDomainsOutput:
    import aws_sdk_connecthealth.types.list_domains_output
    out: aws_sdk_connecthealth.types.list_domains_output.ListDomainsOutput = aws_sdk_connecthealth.types.list_domains_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_connecthealth.types.list_domains_input.ListDomainsInput) -> zapros.Request:
...
def list_domains(options: OperationOptions, input: aws_sdk_connecthealth.types.list_domains_input.ListDomainsInput) -> tuple[aws_sdk_connecthealth.types.list_domains_output.ListDomainsOutput, zapros.Response]:
...
async def async_list_domains(options: AsyncOperationOptions, input: aws_sdk_connecthealth.types.list_domains_input.ListDomainsInput) -> tuple[aws_sdk_connecthealth.types.list_domains_output.ListDomainsOutput, zapros.Response]:
