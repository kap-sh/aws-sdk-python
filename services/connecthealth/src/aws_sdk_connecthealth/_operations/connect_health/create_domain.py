...
def build_request(
    ...
    input_: aws_sdk_connecthealth.types.create_domain_input.CreateDomainInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connecthealth.types.create_domain_input.serialize_json(input_)
    ).encode()
...
def create_domain(
    ...
    aws_sdk_connecthealth.types.create_domain_output.CreateDomainOutput, zapros.Response
]:
