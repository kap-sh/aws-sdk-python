"""Generated from Smithy shape ``com.amazonaws.connecthealth#CreateDomain``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ServiceQuotaExceededException":
            ...
            raise aws_sdk_connecthealth.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(data)
        case _:
            raise UnknownServiceError(code=code, message=message, response=response)

def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_connecthealth.types.create_domain_output.CreateDomainOutput:
    import aws_sdk_connecthealth.types.create_domain_output
    out: aws_sdk_connecthealth.types.create_domain_output.CreateDomainOutput = aws_sdk_connecthealth.types.create_domain_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_connecthealth.types.create_domain_input.CreateDomainInput) -> zapros.Request:
    ...
    import aws_sdk_connecthealth.types.create_domain_input
    body: bytes | None = json.dumps(aws_sdk_connecthealth.types.create_domain_input.serialize_json(input)).encode()
...
def create_domain(options: OperationOptions, input: aws_sdk_connecthealth.types.create_domain_input.CreateDomainInput) -> tuple[aws_sdk_connecthealth.types.create_domain_output.CreateDomainOutput, zapros.Response]:
...
async def async_create_domain(options: AsyncOperationOptions, input: aws_sdk_connecthealth.types.create_domain_input.CreateDomainInput) -> tuple[aws_sdk_connecthealth.types.create_domain_output.CreateDomainOutput, zapros.Response]:
