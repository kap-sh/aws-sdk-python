"""Generated from Smithy shape ``com.amazonaws.connecthealth#GetSubscription``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_connecthealth.types.get_subscription_output.GetSubscriptionOutput:
    import aws_sdk_connecthealth.types.get_subscription_output
    out: aws_sdk_connecthealth.types.get_subscription_output.GetSubscriptionOutput = aws_sdk_connecthealth.types.get_subscription_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_connecthealth.types.get_subscription_input.GetSubscriptionInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/domains/{domainId}/subscriptions/{subscriptionId}"
...
def get_subscription(options: OperationOptions, input: aws_sdk_connecthealth.types.get_subscription_input.GetSubscriptionInput) -> tuple[aws_sdk_connecthealth.types.get_subscription_output.GetSubscriptionOutput, zapros.Response]:
...
async def async_get_subscription(options: AsyncOperationOptions, input: aws_sdk_connecthealth.types.get_subscription_input.GetSubscriptionInput) -> tuple[aws_sdk_connecthealth.types.get_subscription_output.GetSubscriptionOutput, zapros.Response]:
