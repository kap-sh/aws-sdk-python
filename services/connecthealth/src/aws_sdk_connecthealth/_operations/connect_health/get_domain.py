...
def handle_response(
    ...
    out: aws_sdk_connecthealth.types.get_domain_output.GetDomainOutput = (
        aws_sdk_connecthealth.types.get_domain_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connecthealth.types.get_domain_input.GetDomainInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_domain(
    ...
    aws_sdk_connecthealth.types.get_domain_output.GetDomainOutput, zapros.Response
]:
