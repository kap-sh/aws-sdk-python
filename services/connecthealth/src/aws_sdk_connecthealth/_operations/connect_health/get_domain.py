...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_connecthealth.types.get_domain_output.GetDomainOutput:
    import aws_sdk_connecthealth.types.get_domain_output
    out: aws_sdk_connecthealth.types.get_domain_output.GetDomainOutput = aws_sdk_connecthealth.types.get_domain_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_connecthealth.types.get_domain_input.GetDomainInput) -> zapros.Request:
...
def get_domain(options: OperationOptions, input: aws_sdk_connecthealth.types.get_domain_input.GetDomainInput) -> tuple[aws_sdk_connecthealth.types.get_domain_output.GetDomainOutput, zapros.Response]:
...
async def async_get_domain(options: AsyncOperationOptions, input: aws_sdk_connecthealth.types.get_domain_input.GetDomainInput) -> tuple[aws_sdk_connecthealth.types.get_domain_output.GetDomainOutput, zapros.Response]:
