...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_connecthealth.types.create_subscription_output.CreateSubscriptionOutput:
    import aws_sdk_connecthealth.types.create_subscription_output
    out: aws_sdk_connecthealth.types.create_subscription_output.CreateSubscriptionOutput = aws_sdk_connecthealth.types.create_subscription_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_connecthealth.types.create_subscription_input.CreateSubscriptionInput) -> zapros.Request:
...
def create_subscription(options: OperationOptions, input: aws_sdk_connecthealth.types.create_subscription_input.CreateSubscriptionInput) -> tuple[aws_sdk_connecthealth.types.create_subscription_output.CreateSubscriptionOutput, zapros.Response]:
...
async def async_create_subscription(options: AsyncOperationOptions, input: aws_sdk_connecthealth.types.create_subscription_input.CreateSubscriptionInput) -> tuple[aws_sdk_connecthealth.types.create_subscription_output.CreateSubscriptionOutput, zapros.Response]:
