...
def handle_response(
    ...
    out: aws_sdk_connecthealth.types.create_subscription_output.CreateSubscriptionOutput = aws_sdk_connecthealth.types.create_subscription_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connecthealth.types.create_subscription_input.CreateSubscriptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
