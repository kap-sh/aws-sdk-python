...
def handle_response(
    ...
    out: aws_sdk_connecthealth.types.delete_domain_output.DeleteDomainOutput = (
        aws_sdk_connecthealth.types.delete_domain_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connecthealth.types.delete_domain_input.DeleteDomainInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_domain(
    ...
    aws_sdk_connecthealth.types.delete_domain_output.DeleteDomainOutput, zapros.Response
]:
