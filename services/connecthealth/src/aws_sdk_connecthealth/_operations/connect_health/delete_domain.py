...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_connecthealth.types.delete_domain_output.DeleteDomainOutput:
    import aws_sdk_connecthealth.types.delete_domain_output
    out: aws_sdk_connecthealth.types.delete_domain_output.DeleteDomainOutput = aws_sdk_connecthealth.types.delete_domain_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_connecthealth.types.delete_domain_input.DeleteDomainInput) -> zapros.Request:
...
def delete_domain(options: OperationOptions, input: aws_sdk_connecthealth.types.delete_domain_input.DeleteDomainInput) -> tuple[aws_sdk_connecthealth.types.delete_domain_output.DeleteDomainOutput, zapros.Response]:
...
async def async_delete_domain(options: AsyncOperationOptions, input: aws_sdk_connecthealth.types.delete_domain_input.DeleteDomainInput) -> tuple[aws_sdk_connecthealth.types.delete_domain_output.DeleteDomainOutput, zapros.Response]:
