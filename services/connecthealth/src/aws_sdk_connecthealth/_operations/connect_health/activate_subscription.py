...
def handle_response(
    ...
    out: aws_sdk_connecthealth.types.activate_subscription_output.ActivateSubscriptionOutput = aws_sdk_connecthealth.types.activate_subscription_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connecthealth.types.activate_subscription_input.ActivateSubscriptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
