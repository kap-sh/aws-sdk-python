"""Generated from Smithy shape ``com.amazonaws.connecthealth#ActivateSubscription``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_connecthealth.types.activate_subscription_output.ActivateSubscriptionOutput:
    import aws_sdk_connecthealth.types.activate_subscription_output
    out: aws_sdk_connecthealth.types.activate_subscription_output.ActivateSubscriptionOutput = aws_sdk_connecthealth.types.activate_subscription_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_connecthealth.types.activate_subscription_input.ActivateSubscriptionInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/domains/{domainId}/subscriptions/{subscriptionId}/activate"
...
def activate_subscription(options: OperationOptions, input: aws_sdk_connecthealth.types.activate_subscription_input.ActivateSubscriptionInput) -> tuple[aws_sdk_connecthealth.types.activate_subscription_output.ActivateSubscriptionOutput, zapros.Response]:
...
async def async_activate_subscription(options: AsyncOperationOptions, input: aws_sdk_connecthealth.types.activate_subscription_input.ActivateSubscriptionInput) -> tuple[aws_sdk_connecthealth.types.activate_subscription_output.ActivateSubscriptionOutput, zapros.Response]:
