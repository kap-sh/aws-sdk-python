...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_connecthealth.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connecthealth.types.start_patient_insights_job_response.StartPatientInsightsJobResponse = aws_sdk_connecthealth.types.start_patient_insights_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connecthealth.types.start_patient_insights_job_request.StartPatientInsightsJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connecthealth.types.start_patient_insights_job_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_patient_insights_job(
