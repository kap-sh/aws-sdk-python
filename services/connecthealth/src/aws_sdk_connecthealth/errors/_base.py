...
class ConnectHealthError(Exception):
    """Base class for all ConnectHealth service errors."""

class ServiceError(ConnectHealthError):
...
class SerializationError(ConnectHealthError):
    """Raised when a value cannot be serialized."""

class DeserializationError(ConnectHealthError):
...
class WaiterFailedError(ConnectHealthError):
...
class WaiterTimeoutError(ConnectHealthError):
