...
if TYPE_CHECKING:
    import aws_sdk_connecthealth.types.pronouns
    import aws_sdk_connecthealth.types.sensitive_iso_date_string
    import aws_sdk_connecthealth.types.sensitive_non_empty_string


class PatientInsightsPatientContext(TypedDict):
    patient_id: (
    ...
    date_of_birth: NotRequired[
        "aws_sdk_connecthealth.types.sensitive_iso_date_string.SensitiveIsoDateString"
    ]
    """<p>Date of birth of the patient.</p>"""
    pronouns: NotRequired["aws_sdk_connecthealth.types.pronouns.Pronouns"]
...
def serialize_json(value: PatientInsightsPatientContext) -> dict:
    ...
    if "pronouns" in value:
        ...
        out["pronouns"] = aws_sdk_connecthealth.types.pronouns.serialize_json(
            value["pronouns"]
        )
    return out
...
def deserialize_json(data: dict) -> PatientInsightsPatientContext:
    ...
    if "pronouns" in data:
        ...
        out["pronouns"] = aws_sdk_connecthealth.types.pronouns.deserialize_json(
            data["pronouns"]
        )
    return out
