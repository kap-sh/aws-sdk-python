...
if TYPE_CHECKING:
    import aws_sdk_connecthealth.types.encryption_type
...
def serialize_json(value: EncryptionContext) -> dict:
    ...
    out["encryptionType"] = aws_sdk_connecthealth.types.encryption_type.serialize_json(
...
def deserialize_json(data: dict) -> EncryptionContext:
    ...
    if "encryptionType" in data:
        ...
        out["encryption_type"] = (
            aws_sdk_connecthealth.types.encryption_type.deserialize_json(
                data["encryptionType"]
            )
        )
    else:
