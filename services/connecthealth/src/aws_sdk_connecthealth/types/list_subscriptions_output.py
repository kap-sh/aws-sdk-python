...
if TYPE_CHECKING:
    import aws_sdk_connecthealth.types.subscription_list


class ListSubscriptionsOutput(TypedDict):
    subscriptions: "aws_sdk_connecthealth.types.subscription_list.SubscriptionList"
...
def serialize_json(value: ListSubscriptionsOutput) -> dict:
    ...
    out["subscriptions"] = aws_sdk_connecthealth.types.subscription_list.serialize_json(
        value["subscriptions"]
    )
...
def deserialize_json(data: dict) -> ListSubscriptionsOutput:
    ...
    if "subscriptions" in data:
        ...
        out["subscriptions"] = (
            aws_sdk_connecthealth.types.subscription_list.deserialize_json(
                data["subscriptions"]
            )
        )
    else:
