...
class ClinicalNoteGenerationResult(TypedDict):
    note_result: NotRequired[
        "aws_sdk_connecthealth.types.artifact_details.ArtifactDetails"
    ]
...
def serialize_json(value: ClinicalNoteGenerationResult) -> dict:
    ...
    if "note_result" in value:
        ...
        out["noteResult"] = aws_sdk_connecthealth.types.artifact_details.serialize_json(
            value["note_result"]
        )
    if "transcript_result" in value:
        ...
        out["transcriptResult"] = (
            aws_sdk_connecthealth.types.artifact_details.serialize_json(
...
def deserialize_json(data: dict) -> ClinicalNoteGenerationResult:
    ...
    if "noteResult" in data:
        ...
        out["note_result"] = (
            aws_sdk_connecthealth.types.artifact_details.deserialize_json(
                data["noteResult"]
            )
        )
