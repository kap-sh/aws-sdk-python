...
class ActivateSubscriptionOutput(TypedDict):
    subscription: NotRequired["aws_sdk_connecthealth.types.subscription_description.SubscriptionDescription"]
    """<p/>"""
...
def serialize_json(value: ActivateSubscriptionOutput) -> dict:
    ...
    if "subscription" in value:
        import aws_sdk_connecthealth.types.subscription_description
        out["subscription"] = aws_sdk_connecthealth.types.subscription_description.serialize_json(value["subscription"])
    return out
...
def deserialize_json(data: dict) -> ActivateSubscriptionOutput:
    ...
    if "subscription" in data:
        import aws_sdk_connecthealth.types.subscription_description
        out["subscription"] = aws_sdk_connecthealth.types.subscription_description.deserialize_json(data["subscription"])
    return out