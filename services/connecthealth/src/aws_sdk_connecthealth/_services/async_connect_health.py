...
from aws_sdk_connecthealth._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_connecthealth._async import anysleep
import time
...
class AsyncConnectHealthClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, use_fips: bool | None = None, endpoint: str | None = None, region: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncConnectHealthClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "use_fips": use_fips, "endpoint": endpoint, "region": region, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
    ...
    async def activate_subscription(self, domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", subscription_id: "aws_sdk_connecthealth.types.subscription_id.SubscriptionId", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> "aws_sdk_connecthealth.types.activate_subscription_output.ActivateSubscriptionOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.activate_subscription_input.ActivateSubscriptionInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.activate_subscription_output.ActivateSubscriptionOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.activate_subscription
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.activate_subscription.async_activate_subscription(req.options, req.input)
    ...
    async def create_domain(self, name: "aws_sdk_connecthealth.types.domain_name.DomainName", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None, kms_key_arn: Optional["aws_sdk_connecthealth.types.kms_key_arn.KmsKeyArn"] = None, web_app_setup_configuration: Optional["aws_sdk_connecthealth.types.create_web_app_configuration.CreateWebAppConfiguration"] = None, tags: Optional["aws_sdk_connecthealth.types.tag_map.TagMap"] = None) -> "aws_sdk_connecthealth.types.create_domain_output.CreateDomainOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.create_domain_input.CreateDomainInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.create_domain_output.CreateDomainOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.create_domain
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.create_domain.async_create_domain(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def create_subscription(self, domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> "aws_sdk_connecthealth.types.create_subscription_output.CreateSubscriptionOutput":
        """<p>Creates a new Subscription within a Domain for billing and user management.</p>

        Args:
            domain_id: <p>The unique identifier of the parent Domain.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.create_subscription_input.CreateSubscriptionInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.create_subscription_output.CreateSubscriptionOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.create_subscription
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.create_subscription.async_create_subscription(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def deactivate_subscription(self, domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", subscription_id: "aws_sdk_connecthealth.types.subscription_id.SubscriptionId", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> "aws_sdk_connecthealth.types.deactivate_subscription_output.DeactivateSubscriptionOutput":
        ...
        Args:
            ...
            subscription_id: <p>The unique identifier of the Subscription.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.deactivate_subscription_input.DeactivateSubscriptionInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.deactivate_subscription_output.DeactivateSubscriptionOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.deactivate_subscription
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.deactivate_subscription.async_deactivate_subscription(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_domain(self, domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> "aws_sdk_connecthealth.types.delete_domain_output.DeleteDomainOutput":
        """<p>Deletes a Domain and all associated resources.</p>

        Args:
            domain_id: <p>The id of the Domain to delete</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.delete_domain_input.DeleteDomainInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.delete_domain_output.DeleteDomainOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.delete_domain
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.delete_domain.async_delete_domain(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_domain(self, domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> "aws_sdk_connecthealth.types.get_domain_output.GetDomainOutput":
        """<p>Retrieves information about a Domain.</p>

        Args:
            domain_id: <p>The id of the Domain to get</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.get_domain_input.GetDomainInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.get_domain_output.GetDomainOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.get_domain
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.get_domain.async_get_domain(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_medical_scribe_listening_session(self, session_id: "aws_sdk_connecthealth.types.scribe_session_id.ScribeSessionId", domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", subscription_id: "aws_sdk_connecthealth.types.subscription_id.SubscriptionId", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> "aws_sdk_connecthealth.types.get_medical_scribe_listening_session_output.GetMedicalScribeListeningSessionOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.get_medical_scribe_listening_session_input.GetMedicalScribeListeningSessionInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.get_medical_scribe_listening_session_output.GetMedicalScribeListeningSessionOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.get_medical_scribe_listening_session
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.get_medical_scribe_listening_session.async_get_medical_scribe_listening_session(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_patient_insights_job(self, domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", job_id: "aws_sdk_connecthealth.types.job_id.JobId", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> "aws_sdk_connecthealth.types.get_patient_insights_job_response.GetPatientInsightsJobResponse":
        ...
        Args:
            ...
            job_id: <p/>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.get_patient_insights_job_request.GetPatientInsightsJobRequest]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.get_patient_insights_job_response.GetPatientInsightsJobResponse"]:
            import aws_sdk_connecthealth._operations.connect_health.get_patient_insights_job
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.get_patient_insights_job.async_get_patient_insights_job(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_subscription(self, domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", subscription_id: "aws_sdk_connecthealth.types.subscription_id.SubscriptionId", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> "aws_sdk_connecthealth.types.get_subscription_output.GetSubscriptionOutput":
        ...
        Args:
            ...
            subscription_id: <p>The unique identifier of the Subscription.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.get_subscription_input.GetSubscriptionInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.get_subscription_output.GetSubscriptionOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.get_subscription
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.get_subscription.async_get_subscription(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def list_domains(self, *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None, status: Optional["aws_sdk_connecthealth.types.domain_status.DomainStatus"] = None, max_results: Optional[int] = None, next_token: Optional[str] = None) -> "aws_sdk_connecthealth.types.list_domains_output.ListDomainsOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.list_domains_input.ListDomainsInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.list_domains_output.ListDomainsOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.list_domains
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.list_domains.async_list_domains(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_domains(self, *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None, status: Optional["aws_sdk_connecthealth.types.domain_status.DomainStatus"] = None, max_results: Optional[int] = None, next_token: Optional[str] = None) -> "AsyncIterator[aws_sdk_connecthealth.types.domain_summary.DomainSummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def list_subscriptions(self, domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None, max_results: Optional[int] = None, next_token: Optional[str] = None) -> "aws_sdk_connecthealth.types.list_subscriptions_output.ListSubscriptionsOutput":
        ...
        Args:
            ...
            next_token: <p>Token for pagination.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.list_subscriptions_input.ListSubscriptionsInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.list_subscriptions_output.ListSubscriptionsOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.list_subscriptions
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.list_subscriptions.async_list_subscriptions(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_subscriptions(self, domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None, max_results: Optional[int] = None, next_token: Optional[str] = None) -> "AsyncIterator[aws_sdk_connecthealth.types.subscription_description.SubscriptionDescription]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def list_tags_for_resource(self, resource_arn: str, *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> "aws_sdk_connecthealth.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        """<p>Lists the tags associated with the specified resource</p>

        Args:
            resource_arn: <p>The ARN of the resource to list tags for</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.list_tags_for_resource_input.ListTagsForResourceInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.list_tags_for_resource_output.ListTagsForResourceOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.list_tags_for_resource
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def start_medical_scribe_listening_session(self, session_id: "aws_sdk_connecthealth.types.scribe_session_id.ScribeSessionId", domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", subscription_id: "aws_sdk_connecthealth.types.subscription_id.SubscriptionId", language_code: "aws_sdk_connecthealth.types.medical_scribe_language_code.MedicalScribeLanguageCode", media_sample_rate_hertz: "aws_sdk_connecthealth.types.medical_scribe_media_sample_rate_hertz.MedicalScribeMediaSampleRateHertz", media_encoding: "aws_sdk_connecthealth.types.medical_scribe_media_encoding.MedicalScribeMediaEncoding", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None, input_stream: Optional[AsyncIterator[bytes] | bytes] = None) -> "aws_sdk_connecthealth.types.start_medical_scribe_listening_session_output.StartMedicalScribeListeningSessionOutput":
        ...
        Args:
            ...
            input_stream: <p/>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.start_medical_scribe_listening_session_input.StartMedicalScribeListeningSessionInput]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.start_medical_scribe_listening_session_output.StartMedicalScribeListeningSessionOutput"]:
            import aws_sdk_connecthealth._operations.connect_health.start_medical_scribe_listening_session
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.start_medical_scribe_listening_session.async_start_medical_scribe_listening_session(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_patient_insights_job(self, domain_id: "aws_sdk_connecthealth.types.domain_id.DomainId", patient_context: "aws_sdk_connecthealth.types.patient_insights_patient_context.PatientInsightsPatientContext", insights_context: "aws_sdk_connecthealth.types.insights_context.InsightsContext", encounter_context: "aws_sdk_connecthealth.types.patient_insights_encounter_context.PatientInsightsEncounterContext", user_context: "aws_sdk_connecthealth.types.user_context.UserContext", input_data_config: "aws_sdk_connecthealth.types.input_data_config.InputDataConfig", output_data_config: "aws_sdk_connecthealth.types.output_data_config.OutputDataConfig", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None, client_token: Optional["aws_sdk_connecthealth.types.non_empty_string.NonEmptyString"] = None) -> "aws_sdk_connecthealth.types.start_patient_insights_job_response.StartPatientInsightsJobResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.start_patient_insights_job_request.StartPatientInsightsJobRequest]') -> AsyncOperationResponse["aws_sdk_connecthealth.types.start_patient_insights_job_response.StartPatientInsightsJobResponse"]:
            import aws_sdk_connecthealth._operations.connect_health.start_patient_insights_job
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.start_patient_insights_job.async_start_patient_insights_job(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def tag_resource(self, resource_arn: str, tags: "aws_sdk_connecthealth.types.tag_map.TagMap", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.tag_resource_input.TagResourceInput]') -> AsyncOperationResponse[None]:
            import aws_sdk_connecthealth._operations.connect_health.tag_resource
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: str, tag_keys: "aws_sdk_connecthealth.types.tag_key_list.TagKeyList", *, config_overrides: Optional[AsyncConnectHealthClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_connecthealth.types.untag_resource_input.UntagResourceInput]') -> AsyncOperationResponse[None]:
            import aws_sdk_connecthealth._operations.connect_health.untag_resource
            output, http_response = await aws_sdk_connecthealth._operations.connect_health.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
