...
```
pip install aws-sdk-qconnect
```

## Usage

```python
from aws_sdk_qconnect import AsyncQConnectClient


async def main():
    async with AsyncQConnectClient() as s3:
...
```python
from aws_sdk_qconnect import AsyncQConnectClient
from aws_sdk_qconnect.error import ResourceNotFoundException
