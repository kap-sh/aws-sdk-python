...
class QConnectError(Exception):
    """Base class for all QConnect service errors."""


class ServiceError(QConnectError):
...
class SerializationError(QConnectError):
    """Raised when a value cannot be serialized."""


class DeserializationError(QConnectError):
...
class WaiterFailedError(QConnectError):
...
class WaiterTimeoutError(QConnectError):
