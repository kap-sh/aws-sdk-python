...
if TYPE_CHECKING:
    import aws_sdk_qconnect.types.quick_response_content


class _QuickResponseDataProvider_content(TypedDict):
    content: "aws_sdk_qconnect.types.quick_response_content.QuickResponseContent"
