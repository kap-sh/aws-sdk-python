"""Generated from Smithy shape ``com.amazonaws.qconnect#PushFCMMessageTemplateContent``."""
...
class PushFCMMessageTemplateContent(TypedDict, closed=True):
    title: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: PushFCMMessageTemplateContent) -> dict:
    out: dict = {}
    if "title" in value:
...
def deserialize_json(data: dict) -> PushFCMMessageTemplateContent:
    out: PushFCMMessageTemplateContent = {}  # type: ignore[typeddict-item]
    if "title" in data:
