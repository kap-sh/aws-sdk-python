...
if TYPE_CHECKING:
    ...
    import aws_sdk_qconnect.types.suggested_messages_list
    import aws_sdk_qconnect.types.uuid_with_qualifier


class AnswerRecommendationAIAgentConfiguration(TypedDict):
...
def serialize_json(value: AnswerRecommendationAIAgentConfiguration) -> dict:
    ...
    if "suggested_messages" in value:
        ...
        out["suggestedMessages"] = (
            aws_sdk_qconnect.types.suggested_messages_list.serialize_json(
...
def deserialize_json(data: dict) -> AnswerRecommendationAIAgentConfiguration:
    ...
    if "suggestedMessages" in data:
        ...
        out["suggested_messages"] = (
            aws_sdk_qconnect.types.suggested_messages_list.deserialize_json(
