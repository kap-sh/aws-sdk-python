"""Generated from Smithy shape ``com.amazonaws.qconnect#ListContentAssociationsRequest``."""
...
class ListContentAssociationsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListContentAssociationsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListContentAssociationsRequest:
    out: ListContentAssociationsRequest = {}  # type: ignore[typeddict-item]
    return out
