...
if TYPE_CHECKING:
    import aws_sdk_qconnect.types.case_summarization_chunk_data_details
    import aws_sdk_qconnect.types.content_data_details
    import aws_sdk_qconnect.types.email_generative_answer_chunk_data_details
    import aws_sdk_qconnect.types.email_overview_chunk_data_details
    import aws_sdk_qconnect.types.email_response_chunk_data_details
    import aws_sdk_qconnect.types.generative_chunk_data_details
    import aws_sdk_qconnect.types.generative_data_details
    import aws_sdk_qconnect.types.intent_detected_data_details
    import aws_sdk_qconnect.types.notes_chunk_data_details
    import aws_sdk_qconnect.types.notes_data_details
    import aws_sdk_qconnect.types.source_content_data_details
...
def serialize_json(value: DataDetails) -> dict:
    if "contentData" in value:
        ...
        return {
            "contentData": aws_sdk_qconnect.types.content_data_details.serialize_json(
                value["contentData"]
            )
        }
        ...
        return {
            "generativeData": aws_sdk_qconnect.types.generative_data_details.serialize_json(
        ...
        return {
            "intentDetectedData": aws_sdk_qconnect.types.intent_detected_data_details.serialize_json(
        ...
        return {
            "sourceContentData": aws_sdk_qconnect.types.source_content_data_details.serialize_json(
        ...
        return {
            "generativeChunkData": aws_sdk_qconnect.types.generative_chunk_data_details.serialize_json(
        ...
        return {
            "emailResponseChunkData": aws_sdk_qconnect.types.email_response_chunk_data_details.serialize_json(
        ...
        return {
            "emailOverviewChunkData": aws_sdk_qconnect.types.email_overview_chunk_data_details.serialize_json(
        ...
        return {
            "emailGenerativeAnswerChunkData": aws_sdk_qconnect.types.email_generative_answer_chunk_data_details.serialize_json(
        ...
        return {
            "caseSummarizationChunkData": aws_sdk_qconnect.types.case_summarization_chunk_data_details.serialize_json(
        ...
        return {
            "suggestedMessageData": aws_sdk_qconnect.types.suggested_message_data_details.serialize_json(
        ...
        return {
            "notesData": aws_sdk_qconnect.types.notes_data_details.serialize_json(
                value["notesData"]
            )
        }
        ...
        return {
            "notesChunkData": aws_sdk_qconnect.types.notes_chunk_data_details.serialize_json(
...
def deserialize_json(data: dict) -> DataDetails:
    if "contentData" in data:
        ...
        return {
            "contentData": aws_sdk_qconnect.types.content_data_details.deserialize_json(
                data["contentData"]
            )
        }
        ...
        return {
            "generativeData": aws_sdk_qconnect.types.generative_data_details.deserialize_json(
                data["generativeData"]
            )
        }
        ...
        return {
            "intentDetectedData": aws_sdk_qconnect.types.intent_detected_data_details.deserialize_json(
        ...
        return {
            "sourceContentData": aws_sdk_qconnect.types.source_content_data_details.deserialize_json(
        ...
        return {
            "generativeChunkData": aws_sdk_qconnect.types.generative_chunk_data_details.deserialize_json(
        ...
        return {
            "emailResponseChunkData": aws_sdk_qconnect.types.email_response_chunk_data_details.deserialize_json(
        ...
        return {
            "emailOverviewChunkData": aws_sdk_qconnect.types.email_overview_chunk_data_details.deserialize_json(
        ...
        return {
            "emailGenerativeAnswerChunkData": aws_sdk_qconnect.types.email_generative_answer_chunk_data_details.deserialize_json(
        ...
        return {
            "caseSummarizationChunkData": aws_sdk_qconnect.types.case_summarization_chunk_data_details.deserialize_json(
        ...
        return {
            "suggestedMessageData": aws_sdk_qconnect.types.suggested_message_data_details.deserialize_json(
        ...
        return {
            "notesData": aws_sdk_qconnect.types.notes_data_details.deserialize_json(
                data["notesData"]
            )
        }
        ...
        return {
            "notesChunkData": aws_sdk_qconnect.types.notes_chunk_data_details.deserialize_json(
                data["notesChunkData"]
            )
        }
    else:
