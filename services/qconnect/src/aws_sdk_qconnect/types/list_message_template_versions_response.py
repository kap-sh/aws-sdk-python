...
if TYPE_CHECKING:
    import aws_sdk_qconnect.types.message_template_version_summary_list
    import aws_sdk_qconnect.types.next_token


class ListMessageTemplateVersionsResponse(TypedDict):
    message_template_version_summaries: "aws_sdk_qconnect.types.message_template_version_summary_list.MessageTemplateVersionSummaryList"
...
def serialize_json(value: ListMessageTemplateVersionsResponse) -> dict:
    ...
    out["messageTemplateVersionSummaries"] = (
        aws_sdk_qconnect.types.message_template_version_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListMessageTemplateVersionsResponse:
    ...
    if "messageTemplateVersionSummaries" in data:
        ...
        out["message_template_version_summaries"] = (
            aws_sdk_qconnect.types.message_template_version_summary_list.deserialize_json(
