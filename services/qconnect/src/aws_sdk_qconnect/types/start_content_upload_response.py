...
if TYPE_CHECKING:
    ...
    import aws_sdk_qconnect.types.headers
...
class StartContentUploadResponse(TypedDict, closed=True):
    ...
    headers_to_include: "aws_sdk_qconnect.types.headers.Headers"
...
def serialize_json(value: StartContentUploadResponse) -> dict:
    ...
    out["headersToInclude"] = aws_sdk_qconnect.types.headers.serialize_json(
...
def deserialize_json(data: dict) -> StartContentUploadResponse:
    ...
    if "headersToInclude" in data:
        ...
        out["headers_to_include"] = aws_sdk_qconnect.types.headers.deserialize_json(
