...
class NotifyRecommendationsReceivedResponse(TypedDict, closed=True):
    ...
    errors: NotRequired[
        "aws_sdk_qconnect.types.notify_recommendations_received_error_list.NotifyRecommendationsReceivedErrorList"
    ]
...
def serialize_json(value: NotifyRecommendationsReceivedResponse) -> dict:
    ...
    if "errors" in value:
        ...
        out["errors"] = (
            aws_sdk_qconnect.types.notify_recommendations_received_error_list.serialize_json(
                value["errors"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> NotifyRecommendationsReceivedResponse:
    ...
    if "errors" in data:
        ...
        out["errors"] = (
            aws_sdk_qconnect.types.notify_recommendations_received_error_list.deserialize_json(
                data["errors"]
            )
        )
    return out
