"""Generated from Smithy shape ``com.amazonaws.qconnect#DeleteAIAgentRequest``."""
...
class DeleteAIAgentRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteAIAgentRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteAIAgentRequest:
    out: DeleteAIAgentRequest = {}  # type: ignore[typeddict-item]
    return out
