...
if TYPE_CHECKING:
    import aws_sdk_qconnect.types.quick_response_content_provider


class QuickResponseContents(TypedDict):
    plain_text: NotRequired[
        "aws_sdk_qconnect.types.quick_response_content_provider.QuickResponseContentProvider"
    ]
...
def serialize_json(value: QuickResponseContents) -> dict:
    ...
    if "plain_text" in value:
        ...
        out["plainText"] = (
            aws_sdk_qconnect.types.quick_response_content_provider.serialize_json(
                value["plain_text"]
            )
        )
...
def deserialize_json(data: dict) -> QuickResponseContents:
    ...
    if "plainText" in data:
        ...
        out["plain_text"] = (
            aws_sdk_qconnect.types.quick_response_content_provider.deserialize_json(
                data["plainText"]
            )
        )
    if "markdown" in data:
