...
if TYPE_CHECKING:
    import aws_sdk_qconnect.types.message_template_query_operator
    import aws_sdk_qconnect.types.message_template_query_value_list
    import aws_sdk_qconnect.types.non_empty_string
    import aws_sdk_qconnect.types.priority


class MessageTemplateQueryField(TypedDict):
    ...
    values: "aws_sdk_qconnect.types.message_template_query_value_list.MessageTemplateQueryValueList"
    """<p>The values of the attribute to query the message templates by.</p>"""
    operator: "aws_sdk_qconnect.types.message_template_query_operator.MessageTemplateQueryOperator"
    ...
    priority: NotRequired["aws_sdk_qconnect.types.priority.Priority"]
...
def serialize_json(value: MessageTemplateQueryField) -> dict:
    ...
    out["values"] = (
        aws_sdk_qconnect.types.message_template_query_value_list.serialize_json(
            value["values"]
        )
    )
...
def deserialize_json(data: dict) -> MessageTemplateQueryField:
    ...
    if "values" in data:
        ...
        out["values"] = (
            aws_sdk_qconnect.types.message_template_query_value_list.deserialize_json(
                data["values"]
            )
        )
    else:
