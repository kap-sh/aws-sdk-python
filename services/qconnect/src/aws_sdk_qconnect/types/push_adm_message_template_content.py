"""Generated from Smithy shape ``com.amazonaws.qconnect#PushADMMessageTemplateContent``."""
...
class PushADMMessageTemplateContent(TypedDict, closed=True):
    title: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: PushADMMessageTemplateContent) -> dict:
    out: dict = {}
    if "title" in value:
...
def deserialize_json(data: dict) -> PushADMMessageTemplateContent:
    out: PushADMMessageTemplateContent = {}  # type: ignore[typeddict-item]
    if "title" in data:
