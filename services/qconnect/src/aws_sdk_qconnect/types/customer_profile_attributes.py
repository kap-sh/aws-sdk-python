...
class CustomerProfileAttributes(TypedDict):
    ...
    custom: NotRequired["aws_sdk_qconnect.types.custom_attributes.CustomAttributes"]
...
def serialize_json(value: CustomerProfileAttributes) -> dict:
    ...
    if "custom" in value:
        ...
        out["custom"] = aws_sdk_qconnect.types.custom_attributes.serialize_json(
            value["custom"]
        )
    return out
...
def deserialize_json(data: dict) -> CustomerProfileAttributes:
    ...
    if "custom" in data:
        ...
        out["custom"] = aws_sdk_qconnect.types.custom_attributes.deserialize_json(
            data["custom"]
        )
    return out
