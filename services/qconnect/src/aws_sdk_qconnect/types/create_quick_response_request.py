"""Generated from Smithy shape ``com.amazonaws.qconnect#CreateQuickResponseRequest``."""
...
class CreateQuickResponseRequest(TypedDict):
...
def serialize_json(value: CreateQuickResponseRequest) -> dict:
    ...
    out["content"] = aws_sdk_qconnect.types.quick_response_data_provider.serialize_json(
        value["content"]
    )
