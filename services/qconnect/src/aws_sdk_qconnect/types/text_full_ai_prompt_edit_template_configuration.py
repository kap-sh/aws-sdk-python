...
if TYPE_CHECKING:
    import aws_sdk_qconnect.types.text_ai_prompt


class TextFullAIPromptEditTemplateConfiguration(TypedDict):
    text: "aws_sdk_qconnect.types.text_ai_prompt.TextAIPrompt"
