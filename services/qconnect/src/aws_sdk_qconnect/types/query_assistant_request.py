...
class QueryAssistantRequest(TypedDict):
    ...
    session_id: NotRequired["aws_sdk_qconnect.types.uuid_or_arn.UuidOrArn"]
...
def serialize_json(value: QueryAssistantRequest) -> dict:
    ...
    if "query_condition" in value:
        ...
        out["queryCondition"] = (
            aws_sdk_qconnect.types.query_condition_expression.serialize_json(
    ...
    if "query_input_data" in value:
        ...
        out["queryInputData"] = aws_sdk_qconnect.types.query_input_data.serialize_json(
...
def deserialize_json(data: dict) -> QueryAssistantRequest:
    ...
    if "queryCondition" in data:
        ...
        out["query_condition"] = (
            aws_sdk_qconnect.types.query_condition_expression.deserialize_json(
                data["queryCondition"]
            )
        )
    if "queryInputData" in data:
        ...
        out["query_input_data"] = (
            aws_sdk_qconnect.types.query_input_data.deserialize_json(
                data["queryInputData"]
            )
        )
