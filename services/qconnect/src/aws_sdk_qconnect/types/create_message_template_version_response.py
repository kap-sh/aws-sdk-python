...
class CreateMessageTemplateVersionResponse(TypedDict):
    message_template: NotRequired[
        "aws_sdk_qconnect.types.extended_message_template_data.ExtendedMessageTemplateData"
    ]
...
def serialize_json(value: CreateMessageTemplateVersionResponse) -> dict:
    ...
    if "message_template" in value:
        ...
        out["messageTemplate"] = (
            aws_sdk_qconnect.types.extended_message_template_data.serialize_json(
...
def deserialize_json(data: dict) -> CreateMessageTemplateVersionResponse:
    ...
    if "messageTemplate" in data:
        ...
        out["message_template"] = (
            aws_sdk_qconnect.types.extended_message_template_data.deserialize_json(
