...
class GetContentSummaryResponse(TypedDict):
    content_summary: NotRequired[
        "aws_sdk_qconnect.types.content_summary.ContentSummary"
    ]
...
def serialize_json(value: GetContentSummaryResponse) -> dict:
    ...
    if "content_summary" in value:
        ...
        out["contentSummary"] = aws_sdk_qconnect.types.content_summary.serialize_json(
...
def deserialize_json(data: dict) -> GetContentSummaryResponse:
    ...
    if "contentSummary" in data:
        ...
        out["content_summary"] = (
            aws_sdk_qconnect.types.content_summary.deserialize_json(
                data["contentSummary"]
            )
        )
    return out
