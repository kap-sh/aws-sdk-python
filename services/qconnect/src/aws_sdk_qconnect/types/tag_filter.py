...
if TYPE_CHECKING:
    import aws_sdk_qconnect.types.and_conditions
    import aws_sdk_qconnect.types.or_conditions
...
def serialize_json(value: TagFilter) -> dict:
    if "tagCondition" in value:
        ...
        return {
            "tagCondition": aws_sdk_qconnect.types.tag_condition.serialize_json(
                value["tagCondition"]
            )
        }
        ...
        return {
            "andConditions": aws_sdk_qconnect.types.and_conditions.serialize_json(
                value["andConditions"]
            )
        }
        ...
        return {
            "orConditions": aws_sdk_qconnect.types.or_conditions.serialize_json(
                value["orConditions"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> TagFilter:
    if "tagCondition" in data:
        ...
        return {
            "tagCondition": aws_sdk_qconnect.types.tag_condition.deserialize_json(
                data["tagCondition"]
            )
        }
        ...
        return {
            "andConditions": aws_sdk_qconnect.types.and_conditions.deserialize_json(
                data["andConditions"]
            )
        }
        ...
        return {
            "orConditions": aws_sdk_qconnect.types.or_conditions.deserialize_json(
                data["orConditions"]
            )
        }
    else:
