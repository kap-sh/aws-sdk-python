...
if TYPE_CHECKING:
    ...
    import aws_sdk_qconnect.types.knowledge_source
...
def serialize_json(value: RetrievalConfiguration) -> dict:
    ...
    out["knowledgeSource"] = aws_sdk_qconnect.types.knowledge_source.serialize_json(
    ...
    if "filter" in value:
        ...
        out["filter"] = (
            aws_sdk_qconnect.types.retrieval_filter_configuration.serialize_json(
                value["filter"]
            )
        )
...
def deserialize_json(data: dict) -> RetrievalConfiguration:
    ...
    if "knowledgeSource" in data:
        ...
        out["knowledge_source"] = (
            aws_sdk_qconnect.types.knowledge_source.deserialize_json(
    ...
    if "filter" in data:
        ...
        out["filter"] = (
            aws_sdk_qconnect.types.retrieval_filter_configuration.deserialize_json(
                data["filter"]
            )
        )
