"""Generated from Smithy shape ``com.amazonaws.qconnect#RecommendationTrigger``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_qconnect.types.recommendation_source_type
    import aws_sdk_qconnect.types.recommendation_trigger_data
    import aws_sdk_qconnect.types.recommendation_trigger_type
    import aws_sdk_qconnect.types.uuid


class RecommendationTrigger(TypedDict):
    id: "aws_sdk_qconnect.types.uuid.Uuid"
    """<p>The identifier of the recommendation trigger.</p>"""
    type: "aws_sdk_qconnect.types.recommendation_trigger_type.RecommendationTriggerType"
    """<p>The type of recommendation trigger.</p>"""
    source: "aws_sdk_qconnect.types.recommendation_source_type.RecommendationSourceType"
    ...
    data: "aws_sdk_qconnect.types.recommendation_trigger_data.RecommendationTriggerData"
...
def serialize_json(value: RecommendationTrigger) -> dict:
    ...
    out["data"] = aws_sdk_qconnect.types.recommendation_trigger_data.serialize_json(
        value["data"]
    )
    import aws_sdk_qconnect.types.recommendation_id_list
...
def deserialize_json(data: dict) -> RecommendationTrigger:
    ...
    if "data" in data:
        ...
        out["data"] = (
            aws_sdk_qconnect.types.recommendation_trigger_data.deserialize_json(
                data["data"]
            )
        )
    else:
