...
if TYPE_CHECKING:
    ...
    import aws_sdk_qconnect.types.session_integration_configuration
...
class SessionData(TypedDict, closed=True):
    ...
    integration_configuration: NotRequired[
        "aws_sdk_qconnect.types.session_integration_configuration.SessionIntegrationConfiguration"
    ]
...
def serialize_json(value: SessionData) -> dict:
    ...
    if "integration_configuration" in value:
        ...
        out["integrationConfiguration"] = (
            aws_sdk_qconnect.types.session_integration_configuration.serialize_json(
...
def deserialize_json(data: dict) -> SessionData:
    ...
    if "integrationConfiguration" in data:
        ...
        out["integration_configuration"] = (
            aws_sdk_qconnect.types.session_integration_configuration.deserialize_json(
