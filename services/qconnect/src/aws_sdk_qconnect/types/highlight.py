...
if TYPE_CHECKING:
    import aws_sdk_qconnect.types.highlight_offset


class Highlight(TypedDict):
    begin_offset_inclusive: "aws_sdk_qconnect.types.highlight_offset.HighlightOffset"
    """<p>The offset for the start of the highlight.</p>"""
    end_offset_exclusive: "aws_sdk_qconnect.types.highlight_offset.HighlightOffset"
