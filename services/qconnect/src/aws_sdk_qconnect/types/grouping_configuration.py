...
def serialize_json(value: GroupingConfiguration) -> dict:
    ...
    if "values" in value:
        ...
        out["values"] = aws_sdk_qconnect.types.grouping_values.serialize_json(
            value["values"]
        )
    return out
...
def deserialize_json(data: dict) -> GroupingConfiguration:
    ...
    if "values" in data:
        ...
        out["values"] = aws_sdk_qconnect.types.grouping_values.deserialize_json(
            data["values"]
        )
    return out
