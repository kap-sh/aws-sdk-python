...
if TYPE_CHECKING:
    ...
    import aws_sdk_qconnect.types.object_fields_list


class AppIntegrationsConfiguration(TypedDict):
    app_integration_arn: "aws_sdk_qconnect.types.generic_arn.GenericArn"
    ...
    object_fields: NotRequired[
        "aws_sdk_qconnect.types.object_fields_list.ObjectFieldsList"
    ]
...
def serialize_json(value: AppIntegrationsConfiguration) -> dict:
    ...
    if "object_fields" in value:
        ...
        out["objectFields"] = aws_sdk_qconnect.types.object_fields_list.serialize_json(
            value["object_fields"]
        )
    return out
...
def deserialize_json(data: dict) -> AppIntegrationsConfiguration:
    ...
    if "objectFields" in data:
        ...
        out["object_fields"] = (
            aws_sdk_qconnect.types.object_fields_list.deserialize_json(
                data["objectFields"]
            )
        )
    return out
