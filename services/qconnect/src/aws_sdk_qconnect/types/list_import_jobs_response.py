...
class ListImportJobsResponse(TypedDict):
    import_job_summaries: "aws_sdk_qconnect.types.import_job_list.ImportJobList"
...
def serialize_json(value: ListImportJobsResponse) -> dict:
    ...
    out["importJobSummaries"] = aws_sdk_qconnect.types.import_job_list.serialize_json(
...
def deserialize_json(data: dict) -> ListImportJobsResponse:
    ...
    if "importJobSummaries" in data:
        ...
        out["import_job_summaries"] = (
            aws_sdk_qconnect.types.import_job_list.deserialize_json(
