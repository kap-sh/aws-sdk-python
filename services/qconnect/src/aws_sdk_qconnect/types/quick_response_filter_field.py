...
if TYPE_CHECKING:
    ...
    import aws_sdk_qconnect.types.quick_response_filter_operator
    import aws_sdk_qconnect.types.quick_response_filter_value_list


class QuickResponseFilterField(TypedDict):
    ...
    values: NotRequired[
        "aws_sdk_qconnect.types.quick_response_filter_value_list.QuickResponseFilterValueList"
    ]
    """<p>The values of attribute field to filter the quick response by.</p>"""
    operator: "aws_sdk_qconnect.types.quick_response_filter_operator.QuickResponseFilterOperator"
...
def serialize_json(value: QuickResponseFilterField) -> dict:
    ...
    if "values" in value:
        ...
        out["values"] = (
            aws_sdk_qconnect.types.quick_response_filter_value_list.serialize_json(
                value["values"]
            )
        )
...
def deserialize_json(data: dict) -> QuickResponseFilterField:
    ...
    if "values" in data:
        ...
        out["values"] = (
            aws_sdk_qconnect.types.quick_response_filter_value_list.deserialize_json(
                data["values"]
            )
        )
    if "operator" in data:
