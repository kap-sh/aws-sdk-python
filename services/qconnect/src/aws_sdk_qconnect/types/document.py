...
class Document(TypedDict, closed=True):
    content_reference: "aws_sdk_qconnect.types.content_reference.ContentReference"
...
def serialize_json(value: Document) -> dict:
    ...
    out["contentReference"] = aws_sdk_qconnect.types.content_reference.serialize_json(
...
def deserialize_json(data: dict) -> Document:
    ...
    if "contentReference" in data:
        ...
        out["content_reference"] = (
            aws_sdk_qconnect.types.content_reference.deserialize_json(
