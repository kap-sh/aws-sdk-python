"""Generated from Smithy shape ``com.amazonaws.qconnect#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.qconnect#ResourceNotFoundException``."""
