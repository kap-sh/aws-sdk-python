...
class CreateContentRequest(TypedDict, closed=True):
    ...
    r"""<p>The name of the content. Each piece of content in a knowledge base must have a unique name. You can retrieve a piece of content using only its knowledge base and its name with the <a href=\"https://docs.aws.amazon.com/amazon-q-connect/latest/APIReference/API_SearchContent.html\">SearchContent</a> API.</p>"""
    title: NotRequired["capo_qconnect.types.content_title.ContentTitle"]
    """<p>The title of the content. If not set, the title is equal to the name.</p>"""
    override_link_out_uri: NotRequired["capo_qconnect.types.uri.Uri"]
