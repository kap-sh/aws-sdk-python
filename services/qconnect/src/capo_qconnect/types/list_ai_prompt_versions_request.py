"""Generated from Smithy shape ``com.amazonaws.qconnect#ListAIPromptVersionsRequest``."""
...
class ListAIPromptVersionsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListAIPromptVersionsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListAIPromptVersionsRequest:
    out: ListAIPromptVersionsRequest = {}  # type: ignore[typeddict-item]
    return out
