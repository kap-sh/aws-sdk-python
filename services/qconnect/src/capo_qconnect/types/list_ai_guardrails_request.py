"""Generated from Smithy shape ``com.amazonaws.qconnect#ListAIGuardrailsRequest``."""
...
class ListAIGuardrailsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListAIGuardrailsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListAIGuardrailsRequest:
    out: ListAIGuardrailsRequest = {}  # type: ignore[typeddict-item]
    return out
