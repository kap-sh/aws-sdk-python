"""Generated from Smithy shape ``com.amazonaws.qconnect#GetContentSummaryResponse``."""
...
class GetContentSummaryResponse(TypedDict, closed=True):
    content_summary: NotRequired["capo_qconnect.types.content_summary.ContentSummary"]
...
def serialize_json(value: GetContentSummaryResponse) -> dict:
    ...
    if "content_summary" in value:
        ...
        out["contentSummary"] = capo_qconnect.types.content_summary.serialize_json(
...
def deserialize_json(data: dict) -> GetContentSummaryResponse:
    ...
    if "contentSummary" in data:
        ...
        out["content_summary"] = capo_qconnect.types.content_summary.deserialize_json(
            data["contentSummary"]
        )
    return out
