"""Generated from Smithy shape ``com.amazonaws.qconnect#AppIntegrationsConfiguration``."""
...
if TYPE_CHECKING:
    ...
    import capo_qconnect.types.object_fields_list


class AppIntegrationsConfiguration(TypedDict, closed=True):
    app_integration_arn: "capo_qconnect.types.generic_arn.GenericArn"
...
def serialize_json(value: AppIntegrationsConfiguration) -> dict:
    ...
    if "object_fields" in value:
        ...
        out["objectFields"] = capo_qconnect.types.object_fields_list.serialize_json(
            value["object_fields"]
        )
    return out
...
def deserialize_json(data: dict) -> AppIntegrationsConfiguration:
    ...
    if "objectFields" in data:
        ...
        out["object_fields"] = capo_qconnect.types.object_fields_list.deserialize_json(
            data["objectFields"]
        )
    return out
