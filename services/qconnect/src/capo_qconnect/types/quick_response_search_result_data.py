"""Generated from Smithy shape ``com.amazonaws.qconnect#QuickResponseSearchResultData``."""
...
if TYPE_CHECKING:
    ...
    import capo_qconnect.types.contact_attribute_keys
    ...
    import capo_qconnect.types.quick_response_status
...
class QuickResponseSearchResultData(TypedDict, closed=True):
    quick_response_arn: "capo_qconnect.types.arn.Arn"
    """<p>The Amazon Resource Name (ARN) of the quick response.</p>"""
    quick_response_id: "capo_qconnect.types.uuid.Uuid"
    ...
    content_type: "capo_qconnect.types.quick_response_type.QuickResponseType"
    ...
    status: "capo_qconnect.types.quick_response_status.QuickResponseStatus"
    """<p>The resource status of the quick response.</p>"""
    contents: "capo_qconnect.types.quick_response_contents.QuickResponseContents"
    ...
    shortcut_key: NotRequired["capo_qconnect.types.short_cut_key.ShortCutKey"]
    ...
    attributes_not_interpolated: NotRequired[
        "capo_qconnect.types.contact_attribute_keys.ContactAttributeKeys"
    ]
...
def serialize_json(value: QuickResponseSearchResultData) -> dict:
    ...
    out["contents"] = capo_qconnect.types.quick_response_contents.serialize_json(
        value["contents"]
    )
    ...
    if "channels" in value:
        ...
        out["channels"] = capo_qconnect.types.channels.serialize_json(value["channels"])
    ...
    if "attributes_not_interpolated" in value:
        ...
        out["attributesNotInterpolated"] = (
            capo_qconnect.types.contact_attribute_keys.serialize_json(
...
def deserialize_json(data: dict) -> QuickResponseSearchResultData:
    ...
    if "attributesNotInterpolated" in data:
        ...
        out["attributes_not_interpolated"] = (
            capo_qconnect.types.contact_attribute_keys.deserialize_json(
