"""Generated from Smithy shape ``com.amazonaws.qconnect#UpdateAIGuardrailRequest``."""
...
class UpdateAIGuardrailRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateAIGuardrailRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateAIGuardrailRequest:
    out: UpdateAIGuardrailRequest = {}  # type: ignore[typeddict-item]
