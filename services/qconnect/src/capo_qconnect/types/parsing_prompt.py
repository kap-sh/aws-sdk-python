"""Generated from Smithy shape ``com.amazonaws.qconnect#ParsingPrompt``."""
...
if TYPE_CHECKING:
    import capo_qconnect.types.parsing_prompt_text


class ParsingPrompt(TypedDict, closed=True):
    parsing_prompt_text: "capo_qconnect.types.parsing_prompt_text.ParsingPromptText"
