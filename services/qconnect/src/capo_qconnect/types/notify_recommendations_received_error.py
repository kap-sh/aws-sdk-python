...
if TYPE_CHECKING:
    import capo_qconnect.types.notify_recommendations_received_error_message
...
class NotifyRecommendationsReceivedError(TypedDict, closed=True):
    ...
    message: NotRequired[
        "capo_qconnect.types.notify_recommendations_received_error_message.NotifyRecommendationsReceivedErrorMessage"
    ]
