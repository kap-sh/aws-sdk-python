...
def handle_response(
    ...
    out: capo_qconnect.types.delete_ai_agent_response.DeleteAIAgentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_ai_agent(
    ...
    capo_qconnect.types.delete_ai_agent_response.DeleteAIAgentResponse, zapros.Response
]:
