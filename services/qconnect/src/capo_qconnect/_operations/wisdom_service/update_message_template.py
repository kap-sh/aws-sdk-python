...
def handle_response(
    ...
    out: capo_qconnect.types.update_message_template_response.UpdateMessageTemplateResponse = capo_qconnect.types.update_message_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.update_message_template_request.serialize_json(input_)
    ).encode()
