"""Generated from Smithy shape ``com.amazonaws.qconnect#CreateAssistant``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.create_assistant_response.CreateAssistantResponse = (
        capo_qconnect.types.create_assistant_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_assistant_request.serialize_json(input_)
    ).encode()
