"""Generated from Smithy shape ``com.amazonaws.qconnect#StartContentUpload``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.start_content_upload_response.StartContentUploadResponse = capo_qconnect.types.start_content_upload_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.start_content_upload_request.serialize_json(input_)
    ).encode()
