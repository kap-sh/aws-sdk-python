...
def handle_response(
    ...
    out: capo_qconnect.types.create_quick_response_response.CreateQuickResponseResponse = capo_qconnect.types.create_quick_response_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_quick_response_request.serialize_json(input_)
    ).encode()
