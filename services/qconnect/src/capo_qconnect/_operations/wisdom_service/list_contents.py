"""Generated from Smithy shape ``com.amazonaws.qconnect#ListContents``."""
...
import capo_qconnect.types.content_summary_list
...
def handle_response(
    ...
    out: capo_qconnect.types.list_contents_response.ListContentsResponse = (
        capo_qconnect.types.list_contents_response.deserialize_json(
...
def list_contents(
    ...
    capo_qconnect.types.list_contents_response.ListContentsResponse, zapros.Response
]:
