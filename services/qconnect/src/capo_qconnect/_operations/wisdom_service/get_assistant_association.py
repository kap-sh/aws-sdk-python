...
def handle_response(
    ...
    out: capo_qconnect.types.get_assistant_association_response.GetAssistantAssociationResponse = capo_qconnect.types.get_assistant_association_response.deserialize_json(
