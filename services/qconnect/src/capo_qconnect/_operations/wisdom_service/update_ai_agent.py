...
def handle_response(
    ...
    out: capo_qconnect.types.update_ai_agent_response.UpdateAIAgentResponse = (
        capo_qconnect.types.update_ai_agent_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.update_ai_agent_request.serialize_json(input_)
    ).encode()
...
def update_ai_agent(
    ...
    capo_qconnect.types.update_ai_agent_response.UpdateAIAgentResponse, zapros.Response
]:
