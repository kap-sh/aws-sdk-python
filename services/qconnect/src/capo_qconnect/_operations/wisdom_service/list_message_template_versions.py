"""Generated from Smithy shape ``com.amazonaws.qconnect#ListMessageTemplateVersions``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.list_message_template_versions_response.ListMessageTemplateVersionsResponse = capo_qconnect.types.list_message_template_versions_response.deserialize_json(
...
async def async_list_message_template_versions(
