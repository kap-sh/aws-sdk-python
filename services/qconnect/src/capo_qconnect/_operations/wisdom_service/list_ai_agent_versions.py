...
def handle_response(
    ...
    out: capo_qconnect.types.list_ai_agent_versions_response.ListAIAgentVersionsResponse = capo_qconnect.types.list_ai_agent_versions_response.deserialize_json(
