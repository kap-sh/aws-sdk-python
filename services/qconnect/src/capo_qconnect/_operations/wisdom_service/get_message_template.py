"""Generated from Smithy shape ``com.amazonaws.qconnect#GetMessageTemplate``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.get_message_template_response.GetMessageTemplateResponse = capo_qconnect.types.get_message_template_response.deserialize_json(
...
async def async_get_message_template(
