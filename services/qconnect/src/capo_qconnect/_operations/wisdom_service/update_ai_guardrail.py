"""Generated from Smithy shape ``com.amazonaws.qconnect#UpdateAIGuardrail``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.update_ai_guardrail_response.UpdateAIGuardrailResponse = (
        capo_qconnect.types.update_ai_guardrail_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.update_ai_guardrail_request.serialize_json(input_)
    ).encode()
...
async def async_update_ai_guardrail(
