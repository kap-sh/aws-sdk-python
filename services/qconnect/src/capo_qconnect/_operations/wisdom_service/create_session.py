"""Generated from Smithy shape ``com.amazonaws.qconnect#CreateSession``."""
...
import capo_qconnect.errors.dependency_failed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DependencyFailedException":
            raise capo_qconnect.errors.dependency_failed_exception.DependencyFailedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_qconnect.types.create_session_response.CreateSessionResponse = (
        capo_qconnect.types.create_session_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_session_request.serialize_json(input_)
    ).encode()
...
def create_session(
    ...
    capo_qconnect.types.create_session_response.CreateSessionResponse, zapros.Response
]:
