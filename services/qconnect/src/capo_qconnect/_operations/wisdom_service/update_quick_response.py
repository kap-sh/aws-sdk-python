"""Generated from Smithy shape ``com.amazonaws.qconnect#UpdateQuickResponse``."""
...
import capo_qconnect.errors.precondition_failed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PreconditionFailedException":
            raise capo_qconnect.errors.precondition_failed_exception.PreconditionFailedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_qconnect.types.update_quick_response_response.UpdateQuickResponseResponse = capo_qconnect.types.update_quick_response_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.update_quick_response_request.serialize_json(input_)
    ).encode()
