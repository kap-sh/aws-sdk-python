...
def handle_response(
    ...
    out: capo_qconnect.types.put_feedback_response.PutFeedbackResponse = (
        capo_qconnect.types.put_feedback_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.put_feedback_request.serialize_json(input_)
    ).encode()
...
def put_feedback(
    ...
    capo_qconnect.types.put_feedback_response.PutFeedbackResponse, zapros.Response
]:
