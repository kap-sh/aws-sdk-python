"""Generated from Smithy shape ``com.amazonaws.qconnect#CreateMessageTemplateAttachment``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.create_message_template_attachment_response.CreateMessageTemplateAttachmentResponse = capo_qconnect.types.create_message_template_attachment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_message_template_attachment_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_message_template_attachment(
