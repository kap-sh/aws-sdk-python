"""Generated from Smithy shape ``com.amazonaws.qconnect#CreateAIAgentVersion``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.create_ai_agent_version_response.CreateAIAgentVersionResponse = capo_qconnect.types.create_ai_agent_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_ai_agent_version_request.serialize_json(input_)
    ).encode()
...
async def async_create_ai_agent_version(
