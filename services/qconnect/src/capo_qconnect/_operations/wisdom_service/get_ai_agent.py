...
def handle_response(
    ...
    out: capo_qconnect.types.get_ai_agent_response.GetAIAgentResponse = (
        capo_qconnect.types.get_ai_agent_response.deserialize_json(
...
def get_ai_agent(
    ...
    capo_qconnect.types.get_ai_agent_response.GetAIAgentResponse, zapros.Response
]:
