...
def handle_response(
    ...
    out: capo_qconnect.types.list_assistant_associations_response.ListAssistantAssociationsResponse = capo_qconnect.types.list_assistant_associations_response.deserialize_json(
