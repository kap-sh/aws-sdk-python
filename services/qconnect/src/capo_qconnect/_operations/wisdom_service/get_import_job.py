"""Generated from Smithy shape ``com.amazonaws.qconnect#GetImportJob``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.get_import_job_response.GetImportJobResponse = (
        capo_qconnect.types.get_import_job_response.deserialize_json(
...
def get_import_job(
    ...
    capo_qconnect.types.get_import_job_response.GetImportJobResponse, zapros.Response
]:
