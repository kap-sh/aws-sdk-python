"""Generated from Smithy shape ``com.amazonaws.qconnect#StartImportJob``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.start_import_job_response.StartImportJobResponse = (
        capo_qconnect.types.start_import_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.start_import_job_request.serialize_json(input_)
    ).encode()
