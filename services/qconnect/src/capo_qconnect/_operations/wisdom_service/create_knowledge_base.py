"""Generated from Smithy shape ``com.amazonaws.qconnect#CreateKnowledgeBase``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.create_knowledge_base_response.CreateKnowledgeBaseResponse = capo_qconnect.types.create_knowledge_base_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_knowledge_base_request.serialize_json(input_)
    ).encode()
