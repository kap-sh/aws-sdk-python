"""Generated from Smithy shape ``com.amazonaws.qconnect#CreateAssistantAssociation``."""
...
import capo_qconnect.types.assistant_association_data
...
def handle_response(
    ...
    out: capo_qconnect.types.create_assistant_association_response.CreateAssistantAssociationResponse = capo_qconnect.types.create_assistant_association_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_assistant_association_request.serialize_json(input_)
    ).encode()
...
async def async_create_assistant_association(
