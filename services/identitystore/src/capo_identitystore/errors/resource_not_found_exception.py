...
class ResourceNotFoundException_(TypedDict, closed=True):
    resource_type: NotRequired["capo_identitystore.types.resource_type.ResourceType"]
    ...
    resource_id: NotRequired["capo_identitystore.types.resource_id.ResourceId"]
    ...
    reason: NotRequired[
        "capo_identitystore.types.resource_not_found_exception_reason.ResourceNotFoundExceptionReason"
    ]
...
def serialize_aws_json_1_1(value: ResourceNotFoundException_) -> dict:
    ...
    if "resource_type" in value:
        ...
        out["ResourceType"] = (
            capo_identitystore.types.resource_type.serialize_aws_json_1_1(
                value["resource_type"]
            )
        )
    ...
    if "reason" in value:
        ...
        out["Reason"] = (
            capo_identitystore.types.resource_not_found_exception_reason.serialize_aws_json_1_1(
                value["reason"]
            )
        )
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> ResourceNotFoundException_:
    ...
    if "ResourceType" in data:
        ...
        out["resource_type"] = (
            capo_identitystore.types.resource_type.deserialize_aws_json_1_1(
                data["ResourceType"]
            )
        )
    ...
    if "Reason" in data:
        ...
        out["reason"] = (
            capo_identitystore.types.resource_not_found_exception_reason.deserialize_aws_json_1_1(
                data["Reason"]
            )
        )
    if "Message" in data:
