...
class identitystoreError(Exception):
    """Base class for all identitystore service errors."""


class ServiceError(identitystoreError):
...
class SerializationError(identitystoreError):
    """Raised when a value cannot be serialized."""


class DeserializationError(identitystoreError):
...
class WaiterFailedError(identitystoreError):
...
class WaiterTimeoutError(identitystoreError):
