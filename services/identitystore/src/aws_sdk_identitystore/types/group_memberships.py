...
GroupMemberships: TypeAlias = list[
    "aws_sdk_identitystore.types.group_membership.GroupMembership"
]
...
def serialize_aws_json_1_1(value: GroupMemberships) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_identitystore.types.group_membership.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> GroupMemberships:
    ...
    for item in data:
        out.append(
            aws_sdk_identitystore.types.group_membership.deserialize_aws_json_1_1(item)
        )
    return out
