...
def serialize_aws_json_1_1(value: AlternateIdentifier) -> dict:
    if "ExternalId" in value:
        ...
        return {
            "ExternalId": aws_sdk_identitystore.types.external_id.serialize_aws_json_1_1(
                value["ExternalId"]
            )
        }
        ...
        return {
            "UniqueAttribute": aws_sdk_identitystore.types.unique_attribute.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AlternateIdentifier:
    if "ExternalId" in data:
        ...
        return {
            "ExternalId": aws_sdk_identitystore.types.external_id.deserialize_aws_json_1_1(
                data["ExternalId"]
            )
        }
        ...
        return {
            "UniqueAttribute": aws_sdk_identitystore.types.unique_attribute.deserialize_aws_json_1_1(
