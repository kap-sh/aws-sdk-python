...
class ControlCatalogError(Exception):
    """Base class for all ControlCatalog service errors."""


class ServiceError(ControlCatalogError):
...
class SerializationError(ControlCatalogError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ControlCatalogError):
...
class WaiterFailedError(ControlCatalogError):
...
class WaiterTimeoutError(ControlCatalogError):
