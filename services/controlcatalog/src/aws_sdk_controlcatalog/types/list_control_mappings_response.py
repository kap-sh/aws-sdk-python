...
class ListControlMappingsResponse(TypedDict):
    control_mappings: "aws_sdk_controlcatalog.types.control_mappings.ControlMappings"
...
def serialize_json(value: ListControlMappingsResponse) -> dict:
    ...
    out["ControlMappings"] = (
        aws_sdk_controlcatalog.types.control_mappings.serialize_json(
...
def deserialize_json(data: dict) -> ListControlMappingsResponse:
    ...
    if "ControlMappings" in data:
        ...
        out["control_mappings"] = (
            aws_sdk_controlcatalog.types.control_mappings.deserialize_json(
