...
class CommonControlFilter(TypedDict):
    objectives: NotRequired["aws_sdk_controlcatalog.types.objective_resource_filter_list.ObjectiveResourceFilterList"]
...
def serialize_json(value: CommonControlFilter) -> dict:
    ...
    if "objectives" in value:
        import aws_sdk_controlcatalog.types.objective_resource_filter_list
        out["Objectives"] = aws_sdk_controlcatalog.types.objective_resource_filter_list.serialize_json(value["objectives"])
    return out
...
def deserialize_json(data: dict) -> CommonControlFilter:
    ...
    if "Objectives" in data:
        import aws_sdk_controlcatalog.types.objective_resource_filter_list
        out["objectives"] = aws_sdk_controlcatalog.types.objective_resource_filter_list.deserialize_json(data["Objectives"])
    return out