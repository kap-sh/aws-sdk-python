...
if TYPE_CHECKING:
    ...
    import aws_sdk_controlcatalog.types.implementation_summary
    import aws_sdk_controlcatalog.types.parameter_requirement_summary


class ControlSummary(TypedDict):
    ...
    behavior: NotRequired[
        "aws_sdk_controlcatalog.types.control_behavior.ControlBehavior"
    ]
    ...
    implementation: NotRequired[
        "aws_sdk_controlcatalog.types.implementation_summary.ImplementationSummary"
    ]
...
def serialize_json(value: ControlSummary) -> dict:
    ...
    if "implementation" in value:
        ...
        out["Implementation"] = (
            aws_sdk_controlcatalog.types.implementation_summary.serialize_json(
...
def deserialize_json(data: dict) -> ControlSummary:
    ...
    if "Implementation" in data:
        ...
        out["implementation"] = (
            aws_sdk_controlcatalog.types.implementation_summary.deserialize_json(
                data["Implementation"]
            )
        )
