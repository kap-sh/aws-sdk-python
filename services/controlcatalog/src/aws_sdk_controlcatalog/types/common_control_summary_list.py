...
CommonControlSummaryList: TypeAlias = list[
    "aws_sdk_controlcatalog.types.common_control_summary.CommonControlSummary"
]
...
def serialize_json(value: CommonControlSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_controlcatalog.types.common_control_summary.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> CommonControlSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_controlcatalog.types.common_control_summary.deserialize_json(item)
        )
    return out
