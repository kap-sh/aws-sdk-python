...
from aws_sdk_controlcatalog._services._aws_config import aaws_config
...
class AsyncControlCatalogClientConfig(TypedDict, total=False):
...
class AsyncControlCatalogClient:
    ...
    async def list_control_mappings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_controlcatalog.types.list_control_mappings_request.ListControlMappingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_controlcatalog.types.list_control_mappings_response.ListControlMappingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_controlcatalog._operations.control_catalog.list_control_mappings.async_list_control_mappings(
    ...
    ) -> "AsyncIterator[aws_sdk_controlcatalog.types.control_mapping.ControlMapping]":
        _token = next_token
        while True:
