...
from aws_sdk_controlcatalog._auth._identity import Credentials
from aws_sdk_controlcatalog._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
...
from aws_sdk_controlcatalog._services._aws_config import aws_config
...
if TYPE_CHECKING:
    ...
    import aws_sdk_controlcatalog.types.list_control_mappings_response
...
class ControlCatalogClientConfig(TypedDict, total=False):
...
class ControlCatalogClient:
    ...
    def list_control_mappings(
        ...
        *,
    ...
    ) -> "aws_sdk_controlcatalog.types.list_control_mappings_response.ListControlMappingsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_controlcatalog.types.list_control_mappings_request.ListControlMappingsRequest]",
        ) -> OperationResponse[
            "aws_sdk_controlcatalog.types.list_control_mappings_response.ListControlMappingsResponse"
        ]:
            import aws_sdk_controlcatalog._operations.control_catalog.list_control_mappings

            output, http_response = (
                aws_sdk_controlcatalog._operations.control_catalog.list_control_mappings.list_control_mappings(
    ...
    ) -> "Iterator[aws_sdk_controlcatalog.types.control_mapping.ControlMapping]":
        _token = next_token
        while True:
