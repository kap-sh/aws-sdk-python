"""Generated from Smithy shape ``com.amazonaws.controlcatalog#ListControlMappings``."""
...
def handle_response(
    ...
    out: capo_controlcatalog.types.list_control_mappings_response.ListControlMappingsResponse = capo_controlcatalog.types.list_control_mappings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/list-control-mappings"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_controlcatalog.types.list_control_mappings_request.serialize_json(input_)
    ).encode()
...
async def async_list_control_mappings(
