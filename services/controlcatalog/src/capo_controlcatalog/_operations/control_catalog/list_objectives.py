...
def handle_response(
    ...
    out: capo_controlcatalog.types.list_objectives_response.ListObjectivesResponse = (
        capo_controlcatalog.types.list_objectives_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controlcatalog.types.list_objectives_request.serialize_json(input_)
    ).encode()
