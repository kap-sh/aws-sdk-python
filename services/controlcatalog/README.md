...
```
pip install aws-sdk-controlcatalog
```

## Usage

```python
from aws_sdk_controlcatalog import AsyncControlCatalogClient
...
```python
from aws_sdk_controlcatalog import AsyncControlCatalogClient
from aws_sdk_controlcatalog.error import AccessDeniedException
