...
if TYPE_CHECKING:
    ...
    import aws_sdk_ecr.types.layer_size_in_bytes
...
class Layer(TypedDict):
    ...
    layer_availability: NotRequired[
        "aws_sdk_ecr.types.layer_availability.LayerAvailability"
    ]
    """<p>The availability status of the image layer.</p>"""
    layer_size: NotRequired["aws_sdk_ecr.types.layer_size_in_bytes.LayerSizeInBytes"]
    """<p>The size, in bytes, of the image layer.</p>"""
    media_type: NotRequired["aws_sdk_ecr.types.media_type.MediaType"]
...
def serialize_aws_json_1_1(value: Layer) -> dict:
    ...
    if "layer_availability" in value:
        ...
        out["layerAvailability"] = (
            aws_sdk_ecr.types.layer_availability.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Layer:
    ...
    if "layerAvailability" in data:
        ...
        out["layer_availability"] = (
            aws_sdk_ecr.types.layer_availability.deserialize_aws_json_1_1(
