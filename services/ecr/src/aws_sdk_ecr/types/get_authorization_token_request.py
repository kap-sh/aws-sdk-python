...
def serialize_aws_json_1_1(value: GetAuthorizationTokenRequest) -> dict:
    ...
    if "registry_ids" in value:
        ...
        out["registryIds"] = (
            aws_sdk_ecr.types.get_authorization_token_registry_id_list.serialize_aws_json_1_1(
                value["registry_ids"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetAuthorizationTokenRequest:
    ...
    if "registryIds" in data:
        ...
        out["registry_ids"] = (
            aws_sdk_ecr.types.get_authorization_token_registry_id_list.deserialize_aws_json_1_1(
                data["registryIds"]
            )
        )
    return out
