...
class DescribeImagesRequest(TypedDict):
    ...
    filter: NotRequired["aws_sdk_ecr.types.describe_images_filter.DescribeImagesFilter"]
...
def serialize_aws_json_1_1(value: DescribeImagesRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["filter"] = aws_sdk_ecr.types.describe_images_filter.serialize_aws_json_1_1(
            value["filter"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeImagesRequest:
    ...
    if "filter" in data:
        ...
        out["filter"] = (
            aws_sdk_ecr.types.describe_images_filter.deserialize_aws_json_1_1(
                data["filter"]
            )
        )
    return out
