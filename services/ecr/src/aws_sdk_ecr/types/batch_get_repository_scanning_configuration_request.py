...
class BatchGetRepositoryScanningConfigurationRequest(TypedDict):
...
def serialize_aws_json_1_1(
    ...
    out["repositoryNames"] = (
        aws_sdk_ecr.types.scanning_configuration_repository_name_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "repositoryNames" in data:
        ...
        out["repository_names"] = (
            aws_sdk_ecr.types.scanning_configuration_repository_name_list.deserialize_aws_json_1_1(
