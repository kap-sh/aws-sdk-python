...
if TYPE_CHECKING:
    import aws_sdk_ecr.types.replication_rule_list


class ReplicationConfiguration(TypedDict):
    rules: "aws_sdk_ecr.types.replication_rule_list.ReplicationRuleList"
...
def serialize_aws_json_1_1(value: ReplicationConfiguration) -> dict:
    ...
    out["rules"] = aws_sdk_ecr.types.replication_rule_list.serialize_aws_json_1_1(
        value["rules"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ReplicationConfiguration:
    ...
    if "rules" in data:
        ...
        out["rules"] = aws_sdk_ecr.types.replication_rule_list.deserialize_aws_json_1_1(
            data["rules"]
        )
    else:
