...
if TYPE_CHECKING:
    import aws_sdk_ecr.types.scanning_repository_filter

ScanningRepositoryFilterList: TypeAlias = list[
    "aws_sdk_ecr.types.scanning_repository_filter.ScanningRepositoryFilter"
]
...
def serialize_aws_json_1_1(value: ScanningRepositoryFilterList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_ecr.types.scanning_repository_filter.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ScanningRepositoryFilterList:
    ...
    for item in data:
        out.append(
            aws_sdk_ecr.types.scanning_repository_filter.deserialize_aws_json_1_1(item)
        )
    return out
