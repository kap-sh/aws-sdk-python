...
if TYPE_CHECKING:
    import aws_sdk_ecr.types.image_detail_list
    import aws_sdk_ecr.types.next_token


class DescribeImagesResponse(TypedDict):
    image_details: NotRequired["aws_sdk_ecr.types.image_detail_list.ImageDetailList"]
...
def serialize_aws_json_1_1(value: DescribeImagesResponse) -> dict:
    ...
    if "image_details" in value:
        ...
        out["imageDetails"] = (
            aws_sdk_ecr.types.image_detail_list.serialize_aws_json_1_1(
                value["image_details"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeImagesResponse:
    ...
    if "imageDetails" in data:
        ...
        out["image_details"] = (
            aws_sdk_ecr.types.image_detail_list.deserialize_aws_json_1_1(
                data["imageDetails"]
            )
        )
