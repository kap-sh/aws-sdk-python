...
if TYPE_CHECKING:
    import aws_sdk_ecr.types.image_replication_status

ImageReplicationStatusList: TypeAlias = list[
    "aws_sdk_ecr.types.image_replication_status.ImageReplicationStatus"
]
...
def serialize_aws_json_1_1(value: ImageReplicationStatusList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_ecr.types.image_replication_status.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ImageReplicationStatusList:
    ...
    for item in data:
        out.append(
            aws_sdk_ecr.types.image_replication_status.deserialize_aws_json_1_1(item)
        )
    return out
