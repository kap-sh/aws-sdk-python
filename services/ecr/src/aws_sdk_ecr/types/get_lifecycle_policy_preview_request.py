...
class GetLifecyclePolicyPreviewRequest(TypedDict):
...
def serialize_aws_json_1_1(value: GetLifecyclePolicyPreviewRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["filter"] = (
            aws_sdk_ecr.types.lifecycle_policy_preview_filter.serialize_aws_json_1_1(
                value["filter"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetLifecyclePolicyPreviewRequest:
    ...
    if "filter" in data:
        ...
        out["filter"] = (
            aws_sdk_ecr.types.lifecycle_policy_preview_filter.deserialize_aws_json_1_1(
                data["filter"]
            )
        )
    return out
