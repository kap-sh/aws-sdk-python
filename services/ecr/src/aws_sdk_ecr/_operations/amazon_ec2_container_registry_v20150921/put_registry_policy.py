"""Generated from Smithy shape ``com.amazonaws.ecr#PutRegistryPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.put_registry_policy_response.PutRegistryPolicyResponse = (
        aws_sdk_ecr.types.put_registry_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.put_registry_policy_request.PutRegistryPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerRegistry_V20150921.PutRegistryPolicy"
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.put_registry_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_put_registry_policy(
