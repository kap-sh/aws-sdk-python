"""Generated from Smithy shape ``com.amazonaws.ecr#DescribeImages``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.describe_images_response.DescribeImagesResponse = (
        aws_sdk_ecr.types.describe_images_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ecr.types.describe_images_request.DescribeImagesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.describe_images_request.serialize_aws_json_1_1(input)
    ).encode()
...
def describe_images(
    ...
    aws_sdk_ecr.types.describe_images_response.DescribeImagesResponse, zapros.Response
]:
