...
def build_request(
    ...
    input_: aws_sdk_ecr.types.update_pull_through_cache_rule_request.UpdatePullThroughCacheRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.update_pull_through_cache_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
