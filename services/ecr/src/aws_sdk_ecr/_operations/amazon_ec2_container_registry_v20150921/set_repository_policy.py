...
def build_request(
    ...
    input: aws_sdk_ecr.types.set_repository_policy_request.SetRepositoryPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.set_repository_policy_request.serialize_aws_json_1_1(input)
    ).encode()
