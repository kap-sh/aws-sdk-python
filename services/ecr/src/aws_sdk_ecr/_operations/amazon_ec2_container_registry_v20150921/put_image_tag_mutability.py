...
def build_request(
    ...
    input_: aws_sdk_ecr.types.put_image_tag_mutability_request.PutImageTagMutabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.put_image_tag_mutability_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
