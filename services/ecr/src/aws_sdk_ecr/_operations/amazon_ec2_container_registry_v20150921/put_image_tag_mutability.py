"""Generated from Smithy shape ``com.amazonaws.ecr#PutImageTagMutability``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.put_image_tag_mutability_response.PutImageTagMutabilityResponse = aws_sdk_ecr.types.put_image_tag_mutability_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ecr.types.put_image_tag_mutability_request.PutImageTagMutabilityRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.put_image_tag_mutability_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_put_image_tag_mutability(
