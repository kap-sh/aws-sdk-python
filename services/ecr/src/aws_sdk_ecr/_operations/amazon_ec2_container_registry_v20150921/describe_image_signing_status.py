"""Generated from Smithy shape ``com.amazonaws.ecr#DescribeImageSigningStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.describe_image_signing_status_response.DescribeImageSigningStatusResponse = aws_sdk_ecr.types.describe_image_signing_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.describe_image_signing_status_request.DescribeImageSigningStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.describe_image_signing_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_image_signing_status(
