"""Generated from Smithy shape ``com.amazonaws.ecr#PutImageScanningConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.put_image_scanning_configuration_response.PutImageScanningConfigurationResponse = aws_sdk_ecr.types.put_image_scanning_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.put_image_scanning_configuration_request.PutImageScanningConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.put_image_scanning_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_image_scanning_configuration(
