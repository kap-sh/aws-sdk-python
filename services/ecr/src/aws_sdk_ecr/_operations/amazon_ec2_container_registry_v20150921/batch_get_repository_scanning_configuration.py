...
def handle_response(
    ...
    out: aws_sdk_ecr.types.batch_get_repository_scanning_configuration_response.BatchGetRepositoryScanningConfigurationResponse = aws_sdk_ecr.types.batch_get_repository_scanning_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.batch_get_repository_scanning_configuration_request.BatchGetRepositoryScanningConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.batch_get_repository_scanning_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
