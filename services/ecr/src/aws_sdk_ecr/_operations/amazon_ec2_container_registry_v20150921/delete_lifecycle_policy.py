...
def build_request(
    ...
    input: aws_sdk_ecr.types.delete_lifecycle_policy_request.DeleteLifecyclePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.delete_lifecycle_policy_request.serialize_aws_json_1_1(input)
    ).encode()
