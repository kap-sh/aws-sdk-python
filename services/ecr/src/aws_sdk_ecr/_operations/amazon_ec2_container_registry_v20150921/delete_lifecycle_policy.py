"""Generated from Smithy shape ``com.amazonaws.ecr#DeleteLifecyclePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse = aws_sdk_ecr.types.delete_lifecycle_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.delete_lifecycle_policy_request.DeleteLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.delete_lifecycle_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_lifecycle_policy(
