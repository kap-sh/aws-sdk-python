...
import aws_sdk_ecr.errors.lifecycle_policy_not_found_exception
import aws_sdk_ecr.errors.lifecycle_policy_preview_in_progress_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LifecyclePolicyNotFoundException":
            raise aws_sdk_ecr.errors.lifecycle_policy_not_found_exception.LifecyclePolicyNotFoundException.from_aws_json_1_1(
                data
            )
        case "LifecyclePolicyPreviewInProgressException":
            raise aws_sdk_ecr.errors.lifecycle_policy_preview_in_progress_exception.LifecyclePolicyPreviewInProgressException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.start_lifecycle_policy_preview_response.StartLifecyclePolicyPreviewResponse = aws_sdk_ecr.types.start_lifecycle_policy_preview_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.start_lifecycle_policy_preview_request.StartLifecyclePolicyPreviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.start_lifecycle_policy_preview_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
