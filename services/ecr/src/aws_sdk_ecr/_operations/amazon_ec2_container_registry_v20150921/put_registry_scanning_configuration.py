...
import aws_sdk_ecr.errors.blocked_by_organization_policy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BlockedByOrganizationPolicyException":
            raise aws_sdk_ecr.errors.blocked_by_organization_policy_exception.BlockedByOrganizationPolicyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.put_registry_scanning_configuration_response.PutRegistryScanningConfigurationResponse = aws_sdk_ecr.types.put_registry_scanning_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.put_registry_scanning_configuration_request.PutRegistryScanningConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
