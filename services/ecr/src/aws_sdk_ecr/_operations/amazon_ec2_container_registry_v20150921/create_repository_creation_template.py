...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TemplateAlreadyExistsException":
            import aws_sdk_ecr.errors.template_already_exists_exception

            raise aws_sdk_ecr.errors.template_already_exists_exception.TemplateAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.create_repository_creation_template_response.CreateRepositoryCreationTemplateResponse = aws_sdk_ecr.types.create_repository_creation_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.create_repository_creation_template_request.CreateRepositoryCreationTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.create_repository_creation_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
