"""Generated from Smithy shape ``com.amazonaws.ecr#DescribePullThroughCacheRules``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.describe_pull_through_cache_rules_response.DescribePullThroughCacheRulesResponse = aws_sdk_ecr.types.describe_pull_through_cache_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.describe_pull_through_cache_rules_request.DescribePullThroughCacheRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.describe_pull_through_cache_rules_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_pull_through_cache_rules(
