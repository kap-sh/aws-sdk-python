"""Generated from Smithy shape ``com.amazonaws.ecr#GetAuthorizationToken``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.get_authorization_token_response.GetAuthorizationTokenResponse = aws_sdk_ecr.types.get_authorization_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ecr.types.get_authorization_token_request.GetAuthorizationTokenRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.get_authorization_token_request.serialize_aws_json_1_1(input)
    ).encode()
