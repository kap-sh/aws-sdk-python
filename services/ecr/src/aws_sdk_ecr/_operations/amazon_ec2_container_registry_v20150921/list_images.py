"""Generated from Smithy shape ``com.amazonaws.ecr#ListImages``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.list_images_response.ListImagesResponse = (
        aws_sdk_ecr.types.list_images_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.list_images_request.ListImagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.list_images_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_images(
    ...
    input_: aws_sdk_ecr.types.list_images_request.ListImagesRequest,
) -> tuple[aws_sdk_ecr.types.list_images_response.ListImagesResponse, zapros.Response]:
