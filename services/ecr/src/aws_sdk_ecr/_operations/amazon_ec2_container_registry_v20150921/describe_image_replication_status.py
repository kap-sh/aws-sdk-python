"""Generated from Smithy shape ``com.amazonaws.ecr#DescribeImageReplicationStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.describe_image_replication_status_response.DescribeImageReplicationStatusResponse = aws_sdk_ecr.types.describe_image_replication_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.describe_image_replication_status_request.DescribeImageReplicationStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_image_replication_status(
