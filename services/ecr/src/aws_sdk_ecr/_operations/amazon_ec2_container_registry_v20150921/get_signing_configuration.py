"""Generated from Smithy shape ``com.amazonaws.ecr#GetSigningConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.get_signing_configuration_response.GetSigningConfigurationResponse = aws_sdk_ecr.types.get_signing_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.get_signing_configuration_request.GetSigningConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_signing_configuration(
