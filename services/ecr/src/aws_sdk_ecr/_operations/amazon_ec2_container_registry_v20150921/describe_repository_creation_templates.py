"""Generated from Smithy shape ``com.amazonaws.ecr#DescribeRepositoryCreationTemplates``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.describe_repository_creation_templates_response.DescribeRepositoryCreationTemplatesResponse = aws_sdk_ecr.types.describe_repository_creation_templates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.describe_repository_creation_templates_request.DescribeRepositoryCreationTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_repository_creation_templates(
