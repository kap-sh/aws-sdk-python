"""Generated from Smithy shape ``com.amazonaws.ecr#DescribeRegistry``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.describe_registry_response.DescribeRegistryResponse = (
        aws_sdk_ecr.types.describe_registry_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.describe_registry_request.DescribeRegistryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerRegistry_V20150921.DescribeRegistry"
    body: bytes | None = b""
...
async def async_describe_registry(
