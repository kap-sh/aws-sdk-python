"""Generated from Smithy shape ``com.amazonaws.ecr#ValidatePullThroughCacheRule``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.validate_pull_through_cache_rule_response.ValidatePullThroughCacheRuleResponse = aws_sdk_ecr.types.validate_pull_through_cache_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.validate_pull_through_cache_rule_request.ValidatePullThroughCacheRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.validate_pull_through_cache_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_validate_pull_through_cache_rule(
