"""Generated from Smithy shape ``com.amazonaws.ecr#PutLifecyclePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.put_lifecycle_policy_response.PutLifecyclePolicyResponse = (
        aws_sdk_ecr.types.put_lifecycle_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.put_lifecycle_policy_request.PutLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.put_lifecycle_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
