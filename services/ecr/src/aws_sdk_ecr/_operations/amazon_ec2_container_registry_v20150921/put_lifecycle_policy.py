...
def build_request(
    ...
    input: aws_sdk_ecr.types.put_lifecycle_policy_request.PutLifecyclePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.put_lifecycle_policy_request.serialize_aws_json_1_1(input)
    ).encode()
