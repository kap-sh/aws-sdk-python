"""Generated from Smithy shape ``com.amazonaws.ecr#PutReplicationConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.put_replication_configuration_response.PutReplicationConfigurationResponse = aws_sdk_ecr.types.put_replication_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.put_replication_configuration_request.PutReplicationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.put_replication_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_replication_configuration(
