...
def handle_response(
    ...
    out: aws_sdk_ecr.types.get_registry_scanning_configuration_response.GetRegistryScanningConfigurationResponse = aws_sdk_ecr.types.get_registry_scanning_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.get_registry_scanning_configuration_request.GetRegistryScanningConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
