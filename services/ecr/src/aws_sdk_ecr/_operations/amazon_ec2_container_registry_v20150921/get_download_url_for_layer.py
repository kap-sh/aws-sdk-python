"""Generated from Smithy shape ``com.amazonaws.ecr#GetDownloadUrlForLayer``."""
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.get_download_url_for_layer_request.GetDownloadUrlForLayerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_download_url_for_layer(
