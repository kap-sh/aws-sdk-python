...
def build_request(
    ...
    input: aws_sdk_ecr.types.get_lifecycle_policy_request.GetLifecyclePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.get_lifecycle_policy_request.serialize_aws_json_1_1(input)
    ).encode()
