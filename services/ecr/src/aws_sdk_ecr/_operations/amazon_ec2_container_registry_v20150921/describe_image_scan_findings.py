"""Generated from Smithy shape ``com.amazonaws.ecr#DescribeImageScanFindings``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ScanNotFoundException":
            import aws_sdk_ecr.errors.scan_not_found_exception

            raise aws_sdk_ecr.errors.scan_not_found_exception.ScanNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.describe_image_scan_findings_response.DescribeImageScanFindingsResponse = aws_sdk_ecr.types.describe_image_scan_findings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.describe_image_scan_findings_request.DescribeImageScanFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_image_scan_findings(
