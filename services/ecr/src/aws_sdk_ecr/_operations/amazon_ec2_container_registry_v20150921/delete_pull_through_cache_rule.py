...
def handle_response(
    ...
    out: aws_sdk_ecr.types.delete_pull_through_cache_rule_response.DeletePullThroughCacheRuleResponse = aws_sdk_ecr.types.delete_pull_through_cache_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.delete_pull_through_cache_rule_request.DeletePullThroughCacheRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
