...
def build_request(
    ...
    input_: aws_sdk_ecr.types.update_image_storage_class_request.UpdateImageStorageClassRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.update_image_storage_class_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
