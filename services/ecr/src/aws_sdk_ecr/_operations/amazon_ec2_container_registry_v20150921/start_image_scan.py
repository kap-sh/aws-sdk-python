...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ImageArchivedException":
            import aws_sdk_ecr.errors.image_archived_exception

            raise aws_sdk_ecr.errors.image_archived_exception.ImageArchivedException.from_aws_json_1_1(
                data
            )
        ...
        case "UnsupportedImageTypeException":
            import aws_sdk_ecr.errors.unsupported_image_type_exception

            raise aws_sdk_ecr.errors.unsupported_image_type_exception.UnsupportedImageTypeException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.start_image_scan_response.StartImageScanResponse = (
        aws_sdk_ecr.types.start_image_scan_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ecr.types.start_image_scan_request.StartImageScanRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.start_image_scan_request.serialize_aws_json_1_1(input)
    ).encode()
...
def start_image_scan(
    ...
    aws_sdk_ecr.types.start_image_scan_response.StartImageScanResponse, zapros.Response
]:
