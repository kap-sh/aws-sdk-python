"""Generated from Smithy shape ``com.amazonaws.ecr#DescribeRepositories``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr.types.describe_repositories_response.DescribeRepositoriesResponse = aws_sdk_ecr.types.describe_repositories_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr.types.describe_repositories_request.DescribeRepositoriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.describe_repositories_request.serialize_aws_json_1_1(input_)
    ).encode()
