...
def build_request(
    ...
    input: aws_sdk_ecr.types.describe_repositories_request.DescribeRepositoriesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr.types.describe_repositories_request.serialize_aws_json_1_1(input)
    ).encode()
