...
class ExclusionNotFoundException_(TypedDict):
...
class ExclusionNotFoundException(ServiceError):
    ...
    def __init__(self, data: ExclusionNotFoundException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "ExclusionNotFoundException":
