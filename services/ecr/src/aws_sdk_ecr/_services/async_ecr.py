...
from aws_sdk_ecr._auth._zapros_handler import AuthMiddleware
from aws_sdk_ecr._pagination import resolve_path as _resolve_path
from aws_sdk_ecr._services._aws_config import aaws_config
from aws_sdk_ecr._services._pipeline import (
    AsyncInterceptor,
...
if TYPE_CHECKING:
    ...
    import aws_sdk_ecr.types.batch_check_layer_availability_response
    import aws_sdk_ecr.types.batch_delete_image_request
    import aws_sdk_ecr.types.batch_delete_image_response
    import aws_sdk_ecr.types.batch_get_image_request
    import aws_sdk_ecr.types.batch_get_image_response
    import aws_sdk_ecr.types.batch_get_repository_scanning_configuration_request
    import aws_sdk_ecr.types.batch_get_repository_scanning_configuration_response
    import aws_sdk_ecr.types.batched_operation_layer_digest_list
    import aws_sdk_ecr.types.complete_layer_upload_request
    import aws_sdk_ecr.types.complete_layer_upload_response
    import aws_sdk_ecr.types.create_pull_through_cache_rule_request
    import aws_sdk_ecr.types.create_pull_through_cache_rule_response
    import aws_sdk_ecr.types.create_repository_creation_template_request
    import aws_sdk_ecr.types.create_repository_creation_template_response
    import aws_sdk_ecr.types.create_repository_request
    import aws_sdk_ecr.types.create_repository_response
    import aws_sdk_ecr.types.credential_arn
    import aws_sdk_ecr.types.custom_role_arn
    import aws_sdk_ecr.types.delete_lifecycle_policy_request
    import aws_sdk_ecr.types.delete_lifecycle_policy_response
    import aws_sdk_ecr.types.delete_pull_through_cache_rule_request
    import aws_sdk_ecr.types.delete_pull_through_cache_rule_response
    import aws_sdk_ecr.types.delete_registry_policy_request
    import aws_sdk_ecr.types.delete_registry_policy_response
    import aws_sdk_ecr.types.delete_repository_creation_template_request
    import aws_sdk_ecr.types.delete_repository_creation_template_response
    import aws_sdk_ecr.types.delete_repository_policy_request
    import aws_sdk_ecr.types.delete_repository_policy_response
    import aws_sdk_ecr.types.delete_repository_request
    import aws_sdk_ecr.types.delete_repository_response
    import aws_sdk_ecr.types.delete_signing_configuration_request
    import aws_sdk_ecr.types.delete_signing_configuration_response
    import aws_sdk_ecr.types.deregister_pull_time_update_exclusion_request
    import aws_sdk_ecr.types.deregister_pull_time_update_exclusion_response
    import aws_sdk_ecr.types.describe_image_replication_status_request
    import aws_sdk_ecr.types.describe_image_replication_status_response
    import aws_sdk_ecr.types.describe_image_scan_findings_request
    import aws_sdk_ecr.types.describe_image_scan_findings_response
    import aws_sdk_ecr.types.describe_image_signing_status_request
    import aws_sdk_ecr.types.describe_image_signing_status_response
    import aws_sdk_ecr.types.describe_images_filter
    import aws_sdk_ecr.types.describe_images_request
    import aws_sdk_ecr.types.describe_images_response
    import aws_sdk_ecr.types.describe_pull_through_cache_rules_request
    import aws_sdk_ecr.types.describe_pull_through_cache_rules_response
    import aws_sdk_ecr.types.describe_registry_request
    import aws_sdk_ecr.types.describe_registry_response
    import aws_sdk_ecr.types.describe_repositories_request
    import aws_sdk_ecr.types.describe_repositories_response
    import aws_sdk_ecr.types.describe_repository_creation_templates_request
    import aws_sdk_ecr.types.describe_repository_creation_templates_response
    ...
    import aws_sdk_ecr.types.get_account_setting_request
    import aws_sdk_ecr.types.get_account_setting_response
    import aws_sdk_ecr.types.get_authorization_token_registry_id_list
    import aws_sdk_ecr.types.get_authorization_token_request
    import aws_sdk_ecr.types.get_authorization_token_response
    ...
    import aws_sdk_ecr.types.get_lifecycle_policy_preview_response
    import aws_sdk_ecr.types.get_lifecycle_policy_request
    import aws_sdk_ecr.types.get_lifecycle_policy_response
    import aws_sdk_ecr.types.get_registry_policy_request
    import aws_sdk_ecr.types.get_registry_policy_response
    import aws_sdk_ecr.types.get_registry_scanning_configuration_request
    import aws_sdk_ecr.types.get_registry_scanning_configuration_response
    import aws_sdk_ecr.types.get_repository_policy_request
    import aws_sdk_ecr.types.get_repository_policy_response
    import aws_sdk_ecr.types.get_signing_configuration_request
    import aws_sdk_ecr.types.get_signing_configuration_response
    import aws_sdk_ecr.types.image_detail
    ...
    import aws_sdk_ecr.types.initiate_layer_upload_request
    import aws_sdk_ecr.types.initiate_layer_upload_response
    import aws_sdk_ecr.types.layer_digest
    import aws_sdk_ecr.types.layer_digest_list
    import aws_sdk_ecr.types.layer_part_blob
    import aws_sdk_ecr.types.lifecycle_policy_preview_filter
    ...
    import aws_sdk_ecr.types.lifecycle_preview_max_results
    import aws_sdk_ecr.types.list_image_referrers_filter
    import aws_sdk_ecr.types.list_image_referrers_request
    import aws_sdk_ecr.types.list_image_referrers_response
    import aws_sdk_ecr.types.list_images_filter
    import aws_sdk_ecr.types.list_images_request
    import aws_sdk_ecr.types.list_images_response
    import aws_sdk_ecr.types.list_pull_time_update_exclusions_request
    import aws_sdk_ecr.types.list_pull_time_update_exclusions_response
    import aws_sdk_ecr.types.list_tags_for_resource_request
    import aws_sdk_ecr.types.list_tags_for_resource_response
    ...
    import aws_sdk_ecr.types.pull_through_cache_rule_repository_prefix_list
    import aws_sdk_ecr.types.put_account_setting_request
    import aws_sdk_ecr.types.put_account_setting_response
    import aws_sdk_ecr.types.put_image_request
    import aws_sdk_ecr.types.put_image_response
    import aws_sdk_ecr.types.put_image_scanning_configuration_request
    import aws_sdk_ecr.types.put_image_scanning_configuration_response
    import aws_sdk_ecr.types.put_image_tag_mutability_request
    import aws_sdk_ecr.types.put_image_tag_mutability_response
    import aws_sdk_ecr.types.put_lifecycle_policy_request
    import aws_sdk_ecr.types.put_lifecycle_policy_response
    import aws_sdk_ecr.types.put_registry_policy_request
    import aws_sdk_ecr.types.put_registry_policy_response
    import aws_sdk_ecr.types.put_registry_scanning_configuration_request
    import aws_sdk_ecr.types.put_registry_scanning_configuration_response
    import aws_sdk_ecr.types.put_replication_configuration_request
    import aws_sdk_ecr.types.put_replication_configuration_response
    import aws_sdk_ecr.types.put_signing_configuration_request
    import aws_sdk_ecr.types.put_signing_configuration_response
    import aws_sdk_ecr.types.rct_applied_for_list
    import aws_sdk_ecr.types.register_pull_time_update_exclusion_request
    import aws_sdk_ecr.types.register_pull_time_update_exclusion_response
    ...
    import aws_sdk_ecr.types.scanning_configuration_repository_name_list
    import aws_sdk_ecr.types.set_repository_policy_request
    import aws_sdk_ecr.types.set_repository_policy_response
    import aws_sdk_ecr.types.signing_configuration
    import aws_sdk_ecr.types.start_image_scan_request
    import aws_sdk_ecr.types.start_image_scan_response
    import aws_sdk_ecr.types.start_lifecycle_policy_preview_request
    import aws_sdk_ecr.types.start_lifecycle_policy_preview_response
    import aws_sdk_ecr.types.subject_identifier
    import aws_sdk_ecr.types.tag_key_list
    import aws_sdk_ecr.types.tag_list
    import aws_sdk_ecr.types.tag_resource_request
    import aws_sdk_ecr.types.tag_resource_response
    ...
    import aws_sdk_ecr.types.update_repository_creation_template_request
    import aws_sdk_ecr.types.update_repository_creation_template_response
    import aws_sdk_ecr.types.upload_id
    import aws_sdk_ecr.types.upload_layer_part_request
    import aws_sdk_ecr.types.upload_layer_part_response
    import aws_sdk_ecr.types.upstream_registry
    import aws_sdk_ecr.types.url
    import aws_sdk_ecr.types.validate_pull_through_cache_rule_request
    import aws_sdk_ecr.types.validate_pull_through_cache_rule_response


class AsyncECRClientConfig(TypedDict, total=False, closed=True):
...
class AsyncECRClient:
    ...
    async def batch_check_layer_availability(
        ...
        *,
    ...
    ) -> "aws_sdk_ecr.types.batch_check_layer_availability_response.BatchCheckLayerAvailabilityResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.batch_check_layer_availability_request.BatchCheckLayerAvailabilityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.batch_check_layer_availability_response.BatchCheckLayerAvailabilityResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.batch_check_layer_availability

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.batch_check_layer_availability.async_batch_check_layer_availability(
    ...
    async def batch_delete_image(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.batch_delete_image_response.BatchDeleteImageResponse":
        ...
        Examples:
            ...
            >>> await client.batch_delete_image(repository_name='ubuntu', image_ids=[{'imageTag': 'precise'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.batch_delete_image_request.BatchDeleteImageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.batch_delete_image_response.BatchDeleteImageResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.batch_delete_image

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.batch_delete_image.async_batch_delete_image(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_image(
        ...
        *,
        ...
        accepted_media_types: Optional[
            "aws_sdk_ecr.types.media_type_list.MediaTypeList"
        ] = None,
    ) -> "aws_sdk_ecr.types.batch_get_image_response.BatchGetImageResponse":
        ...
        Examples:
            ...
            >>> await client.batch_get_image(repository_name='ubuntu', image_ids=[{'imageTag': 'precise'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.batch_get_image_request.BatchGetImageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.batch_get_image_response.BatchGetImageResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.batch_get_image

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.batch_get_image.async_batch_get_image(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_repository_scanning_configuration(
        self,
        repository_names: "aws_sdk_ecr.types.scanning_configuration_repository_name_list.ScanningConfigurationRepositoryNameList",
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
    ) -> "aws_sdk_ecr.types.batch_get_repository_scanning_configuration_response.BatchGetRepositoryScanningConfigurationResponse":
        ...
        Raises:
            ...
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.batch_get_repository_scanning_configuration_request.BatchGetRepositoryScanningConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.batch_get_repository_scanning_configuration_response.BatchGetRepositoryScanningConfigurationResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.batch_get_repository_scanning_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.batch_get_repository_scanning_configuration.async_batch_get_repository_scanning_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def complete_layer_upload(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.complete_layer_upload_response.CompleteLayerUploadResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.empty_upload_exception.EmptyUploadException: <p>The specified layer upload does not contain any layer parts.</p>
            aws_sdk_ecr.errors.invalid_layer_exception.InvalidLayerException: <p>The layer digest calculation performed by Amazon ECR upon receipt of the image layer does not match the digest specified.</p>
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.kms_exception.KmsException: <p>The operation failed due to a KMS exception.</p>
            aws_sdk_ecr.errors.layer_already_exists_exception.LayerAlreadyExistsException: <p>The image layer already exists in the associated repository.</p>
            aws_sdk_ecr.errors.layer_part_too_small_exception.LayerPartTooSmallException: <p>Layer parts must be at least 5 MiB in size.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.upload_not_found_exception.UploadNotFoundException: <p>The upload could not be found, or the specified upload ID is not valid for this repository.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.complete_layer_upload_request.CompleteLayerUploadRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.complete_layer_upload_response.CompleteLayerUploadResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.complete_layer_upload

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.complete_layer_upload.async_complete_layer_upload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_pull_through_cache_rule(
        ...
        *,
        ...
        credential_arn: Optional[
            "aws_sdk_ecr.types.credential_arn.CredentialArn"
        ] = None,
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.limit_exceeded_exception.LimitExceededException: <p>The operation did not succeed because it would have exceeded a service limit for your account. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECR/latest/userguide/service-quotas.html\">Amazon ECR service quotas</a> in the Amazon Elastic Container Registry User Guide.</p>
            aws_sdk_ecr.errors.pull_through_cache_rule_already_exists_exception.PullThroughCacheRuleAlreadyExistsException: <p>A pull through cache rule with these settings already exists for the private registry.</p>
            aws_sdk_ecr.errors.secret_not_found_exception.SecretNotFoundException: <p>The ARN of the secret specified in the pull through cache rule was not found. Update the pull through cache rule with a valid secret ARN and try again.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.unable_to_access_secret_exception.UnableToAccessSecretException: <p>The secret is unable to be accessed. Verify the resource permissions for the secret and try again.</p>
            aws_sdk_ecr.errors.unable_to_decrypt_secret_value_exception.UnableToDecryptSecretValueException: <p>The secret is accessible but is unable to be decrypted. Verify the resource permisisons and try again.</p>
            aws_sdk_ecr.errors.unsupported_upstream_registry_exception.UnsupportedUpstreamRegistryException: <p>The specified upstream registry isn't supported.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.create_pull_through_cache_rule_request.CreatePullThroughCacheRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.create_pull_through_cache_rule_response.CreatePullThroughCacheRuleResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.create_pull_through_cache_rule

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.create_pull_through_cache_rule.async_create_pull_through_cache_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_repository(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
        tags: Optional["aws_sdk_ecr.types.tag_list.TagList"] = None,
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.invalid_tag_parameter_exception.InvalidTagParameterException: <p>An invalid parameter has been specified. Tag keys can have a maximum character length of 128 characters, and tag values can have a maximum length of 256 characters.</p>
            aws_sdk_ecr.errors.kms_exception.KmsException: <p>The operation failed due to a KMS exception.</p>
            aws_sdk_ecr.errors.limit_exceeded_exception.LimitExceededException: <p>The operation did not succeed because it would have exceeded a service limit for your account. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECR/latest/userguide/service-quotas.html\">Amazon ECR service quotas</a> in the Amazon Elastic Container Registry User Guide.</p>
            aws_sdk_ecr.errors.repository_already_exists_exception.RepositoryAlreadyExistsException: <p>The specified repository already exists in the specified registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.too_many_tags_exception.TooManyTagsException: <p>The list of tags on the repository is over the limit. The maximum number of tags that can be applied to a repository is 50.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        Examples:
            ...
            >>> await client.create_repository(repository_name='project-a/nginx-web-app')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.create_repository_request.CreateRepositoryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.create_repository_response.CreateRepositoryResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.create_repository

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.create_repository.async_create_repository(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_repository_creation_template(
        ...
        applied_for: "aws_sdk_ecr.types.rct_applied_for_list.RCTAppliedForList",
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        ...
        resource_tags: Optional["aws_sdk_ecr.types.tag_list.TagList"] = None,
        image_tag_mutability: Optional[
            "aws_sdk_ecr.types.image_tag_mutability.ImageTagMutability"
        ] = None,
        image_tag_mutability_exclusion_filters: Optional[
        ...
        Raises:
            ...
            aws_sdk_ecr.errors.limit_exceeded_exception.LimitExceededException: <p>The operation did not succeed because it would have exceeded a service limit for your account. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECR/latest/userguide/service-quotas.html\">Amazon ECR service quotas</a> in the Amazon Elastic Container Registry User Guide.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.template_already_exists_exception.TemplateAlreadyExistsException: <p>The repository creation template already exists. Specify a unique prefix and try again.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.create_repository_creation_template_request.CreateRepositoryCreationTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.create_repository_creation_template_response.CreateRepositoryCreationTemplateResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.create_repository_creation_template

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.create_repository_creation_template.async_create_repository_creation_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_lifecycle_policy(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.lifecycle_policy_not_found_exception.LifecyclePolicyNotFoundException: <p>The lifecycle policy could not be found, and no policy is set to the repository.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.delete_lifecycle_policy_request.DeleteLifecyclePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_lifecycle_policy

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_lifecycle_policy.async_delete_lifecycle_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_pull_through_cache_rule(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.delete_pull_through_cache_rule_response.DeletePullThroughCacheRuleResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.pull_through_cache_rule_not_found_exception.PullThroughCacheRuleNotFoundException: <p>The pull through cache rule was not found. Specify a valid pull through cache rule and try again.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.delete_pull_through_cache_rule_request.DeletePullThroughCacheRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.delete_pull_through_cache_rule_response.DeletePullThroughCacheRuleResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_pull_through_cache_rule

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_pull_through_cache_rule.async_delete_pull_through_cache_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_registry_policy(
        ...
        "aws_sdk_ecr.types.delete_registry_policy_response.DeleteRegistryPolicyResponse"
    ):
        """<p>Deletes the registry permissions policy.</p>

        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.registry_policy_not_found_exception.RegistryPolicyNotFoundException: <p>The registry doesn't have an associated registry policy.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.delete_registry_policy_request.DeleteRegistryPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.delete_registry_policy_response.DeleteRegistryPolicyResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_registry_policy

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_registry_policy.async_delete_registry_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_repository(
        ...
        *,
    ...
    ) -> "aws_sdk_ecr.types.delete_repository_response.DeleteRepositoryResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.kms_exception.KmsException: <p>The operation failed due to a KMS exception.</p>
            aws_sdk_ecr.errors.repository_not_empty_exception.RepositoryNotEmptyException: <p>The specified repository contains images. To delete a repository that contains images, you must force the deletion with the <code>force</code> parameter.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        Examples:
            ...
            >>> await client.delete_repository(repository_name='ubuntu', force=True)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.delete_repository_request.DeleteRepositoryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.delete_repository_response.DeleteRepositoryResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_repository

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_repository.async_delete_repository(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_repository_creation_template(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
    ) -> "aws_sdk_ecr.types.delete_repository_creation_template_response.DeleteRepositoryCreationTemplateResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.template_not_found_exception.TemplateNotFoundException: <p>The specified repository creation template can't be found. Verify the registry ID and prefix and try again.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.delete_repository_creation_template_request.DeleteRepositoryCreationTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.delete_repository_creation_template_response.DeleteRepositoryCreationTemplateResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_repository_creation_template

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_repository_creation_template.async_delete_repository_creation_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_repository_policy(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.delete_repository_policy_response.DeleteRepositoryPolicyResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.repository_policy_not_found_exception.RepositoryPolicyNotFoundException: <p>The specified repository and registry combination does not have an associated repository policy.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        Examples:
            ...
            >>> await client.delete_repository_policy(repository_name='ubuntu')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.delete_repository_policy_request.DeleteRepositoryPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.delete_repository_policy_response.DeleteRepositoryPolicyResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_repository_policy

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_repository_policy.async_delete_repository_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_signing_configuration(
        ...
        Raises:
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.signing_configuration_not_found_exception.SigningConfigurationNotFoundException: <p>The specified signing configuration was not found. This occurs when attempting to retrieve or delete a signing configuration that does not exist.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        async def _handler(
            ...
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_signing_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.delete_signing_configuration.async_delete_signing_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_pull_time_update_exclusion(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
    ) -> "aws_sdk_ecr.types.deregister_pull_time_update_exclusion_response.DeregisterPullTimeUpdateExclusionResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.exclusion_not_found_exception.ExclusionNotFoundException: <p>The specified pull time update exclusion was not found.</p>
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.limit_exceeded_exception.LimitExceededException: <p>The operation did not succeed because it would have exceeded a service limit for your account. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECR/latest/userguide/service-quotas.html\">Amazon ECR service quotas</a> in the Amazon Elastic Container Registry User Guide.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
        ...
        Examples:
            ...
            >>> await client.deregister_pull_time_update_exclusion(principal_arn='arn:aws:iam::012345678910:role/ECRAccess')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.deregister_pull_time_update_exclusion_request.DeregisterPullTimeUpdateExclusionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.deregister_pull_time_update_exclusion_response.DeregisterPullTimeUpdateExclusionResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.deregister_pull_time_update_exclusion

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.deregister_pull_time_update_exclusion.async_deregister_pull_time_update_exclusion(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_image_replication_status(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.describe_image_replication_status_response.DescribeImageReplicationStatusResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.image_not_found_exception.ImageNotFoundException: <p>The image requested does not exist in the specified repository.</p>
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.describe_image_replication_status_request.DescribeImageReplicationStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.describe_image_replication_status_response.DescribeImageReplicationStatusResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_image_replication_status

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_image_replication_status.async_describe_image_replication_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_images(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ecr.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_ecr.types.max_results.MaxResults"] = None,
        filter: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.describe_images_request.DescribeImagesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.describe_images_response.DescribeImagesResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_images

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_images.async_describe_images(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_ecr.types.image_detail.ImageDetail]":
        _token = next_token
        while True:
    ...
    async def describe_image_scan_findings(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ecr.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_ecr.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_ecr.types.describe_image_scan_findings_response.DescribeImageScanFindingsResponse":
        ...
        Raises:
            ...
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.scan_not_found_exception.ScanNotFoundException: <p>The specified image scan could not be found. Ensure that image scanning is enabled on the repository and try again.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.describe_image_scan_findings_request.DescribeImageScanFindingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.describe_image_scan_findings_response.DescribeImageScanFindingsResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_image_scan_findings

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_image_scan_findings.async_describe_image_scan_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_image_signing_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.describe_image_signing_status_request.DescribeImageSigningStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.describe_image_signing_status_response.DescribeImageSigningStatusResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_image_signing_status

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_image_signing_status.async_describe_image_signing_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_pull_through_cache_rules(
        ...
        *,
        ...
        ecr_repository_prefixes: Optional[
            "aws_sdk_ecr.types.pull_through_cache_rule_repository_prefix_list.PullThroughCacheRuleRepositoryPrefixList"
        ] = None,
        next_token: Optional["aws_sdk_ecr.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_ecr.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_ecr.types.describe_pull_through_cache_rules_response.DescribePullThroughCacheRulesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.describe_pull_through_cache_rules_request.DescribePullThroughCacheRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.describe_pull_through_cache_rules_response.DescribePullThroughCacheRulesResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_pull_through_cache_rules

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_pull_through_cache_rules.async_describe_pull_through_cache_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_pull_through_cache_rules(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_ecr.types.pull_through_cache_rule.PullThroughCacheRule]"
    ):
        _token = next_token
        while True:
            _response = await self.describe_pull_through_cache_rules(
                config_overrides=config_overrides,
                registry_id=registry_id,
    ...
    async def describe_registry(
        self, *, config_overrides: Optional[AsyncECRClientConfig] = None
    ) -> "aws_sdk_ecr.types.describe_registry_response.DescribeRegistryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.describe_registry_request.DescribeRegistryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.describe_registry_response.DescribeRegistryResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_registry

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_registry.async_describe_registry(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_repositories(
        ...
        *,
        ...
        "aws_sdk_ecr.types.describe_repositories_response.DescribeRepositoriesResponse"
    ):
        ...
        Examples:
            ...
            >>> await client.describe_repositories()
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.describe_repositories_request.DescribeRepositoriesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.describe_repositories_response.DescribeRepositoriesResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_repositories

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_repositories.async_describe_repositories(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_repositories(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ecr.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_ecr.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_ecr.types.repository.Repository]":
        _token = next_token
        while True:
    ...
    async def describe_repository_creation_templates(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        prefixes: Optional["aws_sdk_ecr.types.prefix_list.PrefixList"] = None,
        next_token: Optional["aws_sdk_ecr.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_ecr.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_ecr.types.describe_repository_creation_templates_response.DescribeRepositoryCreationTemplatesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.describe_repository_creation_templates_request.DescribeRepositoryCreationTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.describe_repository_creation_templates_response.DescribeRepositoryCreationTemplatesResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_repository_creation_templates

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.describe_repository_creation_templates.async_describe_repository_creation_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_repository_creation_templates(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ecr.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_ecr.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_ecr.types.repository_creation_template.RepositoryCreationTemplate]":
        _token = next_token
        while True:
            _response = await self.describe_repository_creation_templates(
                config_overrides=config_overrides,
                prefixes=prefixes,
                next_token=_token,
                max_results=max_results,
    ...
    async def get_account_setting(
        self,
        name: "aws_sdk_ecr.types.account_setting_name.AccountSettingName",
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
    ) -> "aws_sdk_ecr.types.get_account_setting_response.GetAccountSettingResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.get_account_setting_request.GetAccountSettingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.get_account_setting_response.GetAccountSettingResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_account_setting

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_account_setting.async_get_account_setting(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_authorization_token(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.get_authorization_token_request.GetAuthorizationTokenRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.get_authorization_token_response.GetAuthorizationTokenResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_authorization_token

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_authorization_token.async_get_authorization_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_download_url_for_layer(
        ...
        *,
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.layer_inaccessible_exception.LayerInaccessibleException: <p>The specified layer is not available because it is not associated with an image. Unassociated image layers may be cleaned up at any time.</p>
            aws_sdk_ecr.errors.layers_not_found_exception.LayersNotFoundException: <p>The specified layers could not be found, or the specified layer is not valid for this repository.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.unable_to_get_upstream_layer_exception.UnableToGetUpstreamLayerException: <p>There was an issue getting the upstream layer matching the pull through cache rule.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.get_download_url_for_layer_request.GetDownloadUrlForLayerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.get_download_url_for_layer_response.GetDownloadUrlForLayerResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_download_url_for_layer

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_download_url_for_layer.async_get_download_url_for_layer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_lifecycle_policy(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.get_lifecycle_policy_response.GetLifecyclePolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.get_lifecycle_policy_request.GetLifecyclePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.get_lifecycle_policy_response.GetLifecyclePolicyResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_lifecycle_policy

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_lifecycle_policy.async_get_lifecycle_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_lifecycle_policy_preview(
        ...
        *,
        ...
        max_results: Optional[
            "aws_sdk_ecr.types.lifecycle_preview_max_results.LifecyclePreviewMaxResults"
        ] = None,
        filter: Optional[
            "aws_sdk_ecr.types.lifecycle_policy_preview_filter.LifecyclePolicyPreviewFilter"
        ] = None,
    ) -> "aws_sdk_ecr.types.get_lifecycle_policy_preview_response.GetLifecyclePolicyPreviewResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.lifecycle_policy_preview_not_found_exception.LifecyclePolicyPreviewNotFoundException: <p>There is no dry run for this repository.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.get_lifecycle_policy_preview_request.GetLifecyclePolicyPreviewRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.get_lifecycle_policy_preview_response.GetLifecyclePolicyPreviewResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_lifecycle_policy_preview

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_lifecycle_policy_preview.async_get_lifecycle_policy_preview(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_ecr.types.lifecycle_policy_preview_result.LifecyclePolicyPreviewResult]":
        _token = next_token
        while True:
            _response = await self.get_lifecycle_policy_preview(
                repository_name,
                config_overrides=config_overrides,
                registry_id=registry_id,
                image_ids=image_ids,
    ...
    async def get_registry_policy(
        self, *, config_overrides: Optional[AsyncECRClientConfig] = None
    ) -> "aws_sdk_ecr.types.get_registry_policy_response.GetRegistryPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.get_registry_policy_request.GetRegistryPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.get_registry_policy_response.GetRegistryPolicyResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_registry_policy

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_registry_policy.async_get_registry_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_registry_scanning_configuration(
        self, *, config_overrides: Optional[AsyncECRClientConfig] = None
    ) -> "aws_sdk_ecr.types.get_registry_scanning_configuration_response.GetRegistryScanningConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.get_registry_scanning_configuration_request.GetRegistryScanningConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.get_registry_scanning_configuration_response.GetRegistryScanningConfigurationResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_registry_scanning_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_registry_scanning_configuration.async_get_registry_scanning_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_repository_policy(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.get_repository_policy_response.GetRepositoryPolicyResponse":
        ...
        Examples:
            ...
            >>> await client.get_repository_policy(repository_name='ubuntu')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.get_repository_policy_request.GetRepositoryPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.get_repository_policy_response.GetRepositoryPolicyResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_repository_policy

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_repository_policy.async_get_repository_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_signing_configuration(
        ...
        async def _handler(
            ...
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_signing_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.get_signing_configuration.async_get_signing_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def initiate_layer_upload(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.initiate_layer_upload_response.InitiateLayerUploadResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.initiate_layer_upload_request.InitiateLayerUploadRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.initiate_layer_upload_response.InitiateLayerUploadResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.initiate_layer_upload

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.initiate_layer_upload.async_initiate_layer_upload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_image_referrers(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ecr.types.next_token.NextToken"] = None,
        max_results: Optional[
            "aws_sdk_ecr.types.fifty_max_results.FiftyMaxResults"
        ] = None,
    ) -> "aws_sdk_ecr.types.list_image_referrers_response.ListImageReferrersResponse":
        ...
        Examples:
            ...
            >>> await client.list_image_referrers(repository_name='sample-repo', subject_id={'imageDigest': 'sha256:943e640159415616581703a53fa4ed87e96740655fd67daf2d2146a35337bce5'}, filter={'artifactStatus': 'ANY'})
            ...
            >>> await client.list_image_referrers(repository_name='sample-repo', subject_id={'imageDigest': 'sha256:943e640159415616581703a53fa4ed87e96740655fd67daf2d2146a35337bce5'})
            ...
            >>> await client.list_image_referrers(repository_name='sample-repo', subject_id={'imageDigest': 'sha256:943e640159415616581703a53fa4ed87e96740655fd67daf2d2146a35337bce5'}, filter={'artifactTypes': ['application/vnd.dev.sigstore.bundle.v0.3+json']})
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.list_image_referrers_request.ListImageReferrersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.list_image_referrers_response.ListImageReferrersResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.list_image_referrers

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.list_image_referrers.async_list_image_referrers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_images(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_ecr.types.max_results.MaxResults"] = None,
        filter: Optional[
            "aws_sdk_ecr.types.list_images_filter.ListImagesFilter"
        ] = None,
    ) -> "aws_sdk_ecr.types.list_images_response.ListImagesResponse":
        ...
        Examples:
            ...
            >>> await client.list_images(repository_name='ubuntu')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.list_images_request.ListImagesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.list_images_response.ListImagesResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.list_images

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.list_images.async_list_images(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_ecr.types.image_identifier.ImageIdentifier]":
        _token = next_token
        while True:
    ...
    async def list_pull_time_update_exclusions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_ecr.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_ecr.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_ecr.types.list_pull_time_update_exclusions_response.ListPullTimeUpdateExclusionsResponse":
        ...
        Examples:
            ...
            >>> await client.list_pull_time_update_exclusions()
            ...
            >>> await client.list_pull_time_update_exclusions(max_results=2)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.list_pull_time_update_exclusions_request.ListPullTimeUpdateExclusionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.list_pull_time_update_exclusions_response.ListPullTimeUpdateExclusionsResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.list_pull_time_update_exclusions

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.list_pull_time_update_exclusions.async_list_pull_time_update_exclusions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        "aws_sdk_ecr.types.list_tags_for_resource_response.ListTagsForResourceResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.list_tags_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_account_setting(
        self,
        name: "aws_sdk_ecr.types.account_setting_name.AccountSettingName",
        value: "aws_sdk_ecr.types.account_setting_value.AccountSettingValue",
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
    ) -> "aws_sdk_ecr.types.put_account_setting_response.PutAccountSettingResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.put_account_setting_request.PutAccountSettingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.put_account_setting_response.PutAccountSettingResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_account_setting

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_account_setting.async_put_account_setting(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_image(
        ...
        *,
        ...
        image_manifest_media_type: Optional[
            "aws_sdk_ecr.types.media_type.MediaType"
        ] = None,
        image_tag: Optional["aws_sdk_ecr.types.image_tag.ImageTag"] = None,
        image_digest: Optional["aws_sdk_ecr.types.image_digest.ImageDigest"] = None,
    ) -> "aws_sdk_ecr.types.put_image_response.PutImageResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.image_already_exists_exception.ImageAlreadyExistsException: <p>The specified image has already been pushed, and there were no changes to the manifest or image tag after the last push.</p>
            aws_sdk_ecr.errors.image_digest_does_not_match_exception.ImageDigestDoesNotMatchException: <p>The specified image digest does not match the digest that Amazon ECR calculated for the image.</p>
            aws_sdk_ecr.errors.image_tag_already_exists_exception.ImageTagAlreadyExistsException: <p>The specified image is tagged with a tag that already exists. The repository is configured for tag immutability.</p>
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.kms_exception.KmsException: <p>The operation failed due to a KMS exception.</p>
            aws_sdk_ecr.errors.layers_not_found_exception.LayersNotFoundException: <p>The specified layers could not be found, or the specified layer is not valid for this repository.</p>
            aws_sdk_ecr.errors.limit_exceeded_exception.LimitExceededException: <p>The operation did not succeed because it would have exceeded a service limit for your account. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECR/latest/userguide/service-quotas.html\">Amazon ECR service quotas</a> in the Amazon Elastic Container Registry User Guide.</p>
            aws_sdk_ecr.errors.referenced_images_not_found_exception.ReferencedImagesNotFoundException: <p>The manifest list is referencing an image that does not exist.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.put_image_request.PutImageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.put_image_response.PutImageResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_image

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_image.async_put_image(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_image_scanning_configuration(
        self,
        repository_name: "aws_sdk_ecr.types.repository_name.RepositoryName",
        image_scanning_configuration: "aws_sdk_ecr.types.image_scanning_configuration.ImageScanningConfiguration",
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.put_image_scanning_configuration_response.PutImageScanningConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.put_image_scanning_configuration_request.PutImageScanningConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.put_image_scanning_configuration_response.PutImageScanningConfigurationResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_image_scanning_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_image_scanning_configuration.async_put_image_scanning_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_image_tag_mutability(
        self,
        repository_name: "aws_sdk_ecr.types.repository_name.RepositoryName",
        image_tag_mutability: "aws_sdk_ecr.types.image_tag_mutability.ImageTagMutability",
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
        image_tag_mutability_exclusion_filters: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.put_image_tag_mutability_request.PutImageTagMutabilityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.put_image_tag_mutability_response.PutImageTagMutabilityResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_image_tag_mutability

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_image_tag_mutability.async_put_image_tag_mutability(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_lifecycle_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.put_lifecycle_policy_request.PutLifecyclePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.put_lifecycle_policy_response.PutLifecyclePolicyResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_lifecycle_policy

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_lifecycle_policy.async_put_lifecycle_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_registry_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.put_registry_policy_request.PutRegistryPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.put_registry_policy_response.PutRegistryPolicyResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_registry_policy

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_registry_policy.async_put_registry_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_registry_scanning_configuration(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        scan_type: Optional["aws_sdk_ecr.types.scan_type.ScanType"] = None,
        rules: Optional[
            "aws_sdk_ecr.types.registry_scanning_rule_list.RegistryScanningRuleList"
        ] = None,
    ) -> "aws_sdk_ecr.types.put_registry_scanning_configuration_response.PutRegistryScanningConfigurationResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.blocked_by_organization_policy_exception.BlockedByOrganizationPolicyException: <p>The operation did not succeed because the account is managed by a organization policy.</p>
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.put_registry_scanning_configuration_request.PutRegistryScanningConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.put_registry_scanning_configuration_response.PutRegistryScanningConfigurationResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_registry_scanning_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_registry_scanning_configuration.async_put_registry_scanning_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_replication_configuration(
        self,
        replication_configuration: "aws_sdk_ecr.types.replication_configuration.ReplicationConfiguration",
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.put_replication_configuration_request.PutReplicationConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.put_replication_configuration_response.PutReplicationConfigurationResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_replication_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_replication_configuration.async_put_replication_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_signing_configuration(
        self,
        signing_configuration: "aws_sdk_ecr.types.signing_configuration.SigningConfiguration",
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.put_signing_configuration_request.PutSigningConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.put_signing_configuration_response.PutSigningConfigurationResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_signing_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.put_signing_configuration.async_put_signing_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_pull_time_update_exclusion(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
    ) -> "aws_sdk_ecr.types.register_pull_time_update_exclusion_response.RegisterPullTimeUpdateExclusionResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.exclusion_already_exists_exception.ExclusionAlreadyExistsException: <p>The specified pull time update exclusion already exists for the registry.</p>
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.limit_exceeded_exception.LimitExceededException: <p>The operation did not succeed because it would have exceeded a service limit for your account. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECR/latest/userguide/service-quotas.html\">Amazon ECR service quotas</a> in the Amazon Elastic Container Registry User Guide.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.register_pull_time_update_exclusion_request.RegisterPullTimeUpdateExclusionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.register_pull_time_update_exclusion_response.RegisterPullTimeUpdateExclusionResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.register_pull_time_update_exclusion

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.register_pull_time_update_exclusion.async_register_pull_time_update_exclusion(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_repository_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.set_repository_policy_request.SetRepositoryPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.set_repository_policy_response.SetRepositoryPolicyResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.set_repository_policy

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.set_repository_policy.async_set_repository_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_image_scan(
        ...
        *,
        ...
        Raises:
            aws_sdk_ecr.errors.image_archived_exception.ImageArchivedException: <p>The specified image is archived and cannot be scanned.</p>
            aws_sdk_ecr.errors.image_not_found_exception.ImageNotFoundException: <p>The image requested does not exist in the specified repository.</p>
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.limit_exceeded_exception.LimitExceededException: <p>The operation did not succeed because it would have exceeded a service limit for your account. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECR/latest/userguide/service-quotas.html\">Amazon ECR service quotas</a> in the Amazon Elastic Container Registry User Guide.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.unsupported_image_type_exception.UnsupportedImageTypeException: <p>The image is of a type that cannot be scanned.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.start_image_scan_request.StartImageScanRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.start_image_scan_response.StartImageScanResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.start_image_scan

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.start_image_scan.async_start_image_scan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_lifecycle_policy_preview(
        ...
        *,
    ...
    ) -> "aws_sdk_ecr.types.start_lifecycle_policy_preview_response.StartLifecyclePolicyPreviewResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.lifecycle_policy_not_found_exception.LifecyclePolicyNotFoundException: <p>The lifecycle policy could not be found, and no policy is set to the repository.</p>
            aws_sdk_ecr.errors.lifecycle_policy_preview_in_progress_exception.LifecyclePolicyPreviewInProgressException: <p>The previous lifecycle policy preview request has not completed. Wait and try again.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
            aws_sdk_ecr.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.start_lifecycle_policy_preview_request.StartLifecyclePolicyPreviewRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.start_lifecycle_policy_preview_response.StartLifecyclePolicyPreviewResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.start_lifecycle_policy_preview

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.start_lifecycle_policy_preview.async_start_lifecycle_policy_preview(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
    ) -> "aws_sdk_ecr.types.tag_resource_response.TagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.tag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        self,
        resource_arn: "aws_sdk_ecr.types.arn.Arn",
        tag_keys: "aws_sdk_ecr.types.tag_key_list.TagKeyList",
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.untag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_image_storage_class(
        ...
        *,
        ...
        Raises:
            aws_sdk_ecr.errors.image_not_found_exception.ImageNotFoundException: <p>The image requested does not exist in the specified repository.</p>
            aws_sdk_ecr.errors.image_storage_class_update_not_supported_exception.ImageStorageClassUpdateNotSupportedException: <p>The requested image storage class update is not supported.</p>
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
            aws_sdk_ecr.errors.server_exception.ServerException: <p>These errors are usually caused by a server-side issue.</p>
            aws_sdk_ecr.errors.validation_exception.ValidationException: <p>There was an exception validating this request.</p>
        ...
        Examples:
            ...
            >>> await client.update_image_storage_class(registry_id='724772093679', repository_name='hello-repository', image_id={'imageDigest': 'sha256:0b1a4e0c81c434fa7928e5c4a2651a521ebabc4ff200c65f7e25b99373efca3b'}, target_storage_class='ARCHIVE')
            ...
            >>> await client.update_image_storage_class(registry_id='724772093679', repository_name='hello-repository', image_id={'imageDigest': 'sha256:0b1a4e0c81c434fa7928e5c4a2651a521ebabc4ff200c65f7e25b99373efca3b'}, target_storage_class='STANDARD')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.update_image_storage_class_request.UpdateImageStorageClassRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.update_image_storage_class_response.UpdateImageStorageClassResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.update_image_storage_class

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.update_image_storage_class.async_update_image_storage_class(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_pull_through_cache_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.update_pull_through_cache_rule_request.UpdatePullThroughCacheRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.update_pull_through_cache_rule_response.UpdatePullThroughCacheRuleResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.update_pull_through_cache_rule

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.update_pull_through_cache_rule.async_update_pull_through_cache_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_repository_creation_template(
        ...
        *,
        ...
        applied_for: Optional[
            "aws_sdk_ecr.types.rct_applied_for_list.RCTAppliedForList"
        ] = None,
        custom_role_arn: Optional[
            "aws_sdk_ecr.types.custom_role_arn.CustomRoleArn"
        ] = None,
    ) -> "aws_sdk_ecr.types.update_repository_creation_template_response.UpdateRepositoryCreationTemplateResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.update_repository_creation_template_request.UpdateRepositoryCreationTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.update_repository_creation_template_response.UpdateRepositoryCreationTemplateResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.update_repository_creation_template

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.update_repository_creation_template.async_update_repository_creation_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def upload_layer_part(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.upload_layer_part_response.UploadLayerPartResponse":
        ...
        Raises:
            aws_sdk_ecr.errors.invalid_layer_part_exception.InvalidLayerPartException: <p>The layer part size is not valid, or the first byte specified is not consecutive to the last byte of a previous layer part upload.</p>
            aws_sdk_ecr.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter is invalid. Review the available parameters for the API request.</p>
            aws_sdk_ecr.errors.kms_exception.KmsException: <p>The operation failed due to a KMS exception.</p>
            aws_sdk_ecr.errors.limit_exceeded_exception.LimitExceededException: <p>The operation did not succeed because it would have exceeded a service limit for your account. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECR/latest/userguide/service-quotas.html\">Amazon ECR service quotas</a> in the Amazon Elastic Container Registry User Guide.</p>
            aws_sdk_ecr.errors.repository_not_found_exception.RepositoryNotFoundException: <p>The specified repository could not be found. Check the spelling of the specified repository and ensure that you are performing operations on the correct registry.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.upload_layer_part_request.UploadLayerPartRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.upload_layer_part_response.UploadLayerPartResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.upload_layer_part

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.upload_layer_part.async_upload_layer_part(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_pull_through_cache_rule(
        ...
        *,
        config_overrides: Optional[AsyncECRClientConfig] = None,
        registry_id: Optional["aws_sdk_ecr.types.registry_id.RegistryId"] = None,
    ) -> "aws_sdk_ecr.types.validate_pull_through_cache_rule_response.ValidatePullThroughCacheRuleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecr.types.validate_pull_through_cache_rule_request.ValidatePullThroughCacheRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecr.types.validate_pull_through_cache_rule_response.ValidatePullThroughCacheRuleResponse"
        ]:
            import aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.validate_pull_through_cache_rule

            (
                output,
                http_response,
            ) = await aws_sdk_ecr._operations.amazon_ec2_container_registry_v20150921.validate_pull_through_cache_rule.async_validate_pull_through_cache_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
