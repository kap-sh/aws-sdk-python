"""Generated from Smithy shape ``com.amazonaws.ecr#GetRegistryPolicy``."""
...
import capo_ecr.errors.registry_policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RegistryPolicyNotFoundException":
            raise capo_ecr.errors.registry_policy_not_found_exception.RegistryPolicyNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.get_registry_policy_response.GetRegistryPolicyResponse = (
        capo_ecr.types.get_registry_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerRegistry_V20150921.GetRegistryPolicy"
    body: bytes | None = json.dumps(
        capo_ecr.types.get_registry_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_registry_policy(
