...
def handle_response(
    ...
    out: capo_ecr.types.initiate_layer_upload_response.InitiateLayerUploadResponse = (
        capo_ecr.types.initiate_layer_upload_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.initiate_layer_upload_request.serialize_aws_json_1_1(input_)
    ).encode()
