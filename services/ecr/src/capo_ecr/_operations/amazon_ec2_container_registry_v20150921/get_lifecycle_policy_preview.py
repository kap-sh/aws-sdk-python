...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LifecyclePolicyPreviewNotFoundException":
            raise capo_ecr.errors.lifecycle_policy_preview_not_found_exception.LifecyclePolicyPreviewNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.get_lifecycle_policy_preview_response.GetLifecyclePolicyPreviewResponse = capo_ecr.types.get_lifecycle_policy_preview_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.get_lifecycle_policy_preview_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
