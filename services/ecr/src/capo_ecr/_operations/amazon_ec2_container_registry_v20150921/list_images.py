...
def handle_response(
    ...
    out: capo_ecr.types.list_images_response.ListImagesResponse = (
        capo_ecr.types.list_images_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.list_images_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_images(
    ...
    input_: capo_ecr.types.list_images_request.ListImagesRequest,
) -> tuple[capo_ecr.types.list_images_response.ListImagesResponse, zapros.Response]:
