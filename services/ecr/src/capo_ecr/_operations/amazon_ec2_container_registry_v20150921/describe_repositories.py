...
def handle_response(
    ...
    out: capo_ecr.types.describe_repositories_response.DescribeRepositoriesResponse = (
        capo_ecr.types.describe_repositories_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.describe_repositories_request.serialize_aws_json_1_1(input_)
    ).encode()
