...
def handle_response(
    ...
    out: capo_ecr.types.describe_registry_response.DescribeRegistryResponse = (
        capo_ecr.types.describe_registry_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.describe_registry_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_registry(
    ...
    capo_ecr.types.describe_registry_response.DescribeRegistryResponse, zapros.Response
]:
