...
import capo_ecr.errors.unable_to_list_upstream_image_referrers_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnableToListUpstreamImageReferrersException":
            raise capo_ecr.errors.unable_to_list_upstream_image_referrers_exception.UnableToListUpstreamImageReferrersException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.list_image_referrers_response.ListImageReferrersResponse = (
        capo_ecr.types.list_image_referrers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.list_image_referrers_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
