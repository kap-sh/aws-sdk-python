"""Generated from Smithy shape ``com.amazonaws.ecr#GetRegistryScanningConfiguration``."""
...
def handle_response(
    ...
    out: capo_ecr.types.get_registry_scanning_configuration_response.GetRegistryScanningConfigurationResponse = capo_ecr.types.get_registry_scanning_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.get_registry_scanning_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_registry_scanning_configuration(
