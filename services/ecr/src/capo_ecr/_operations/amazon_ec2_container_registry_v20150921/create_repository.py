...
import capo_ecr.errors.repository_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RepositoryAlreadyExistsException":
            raise capo_ecr.errors.repository_already_exists_exception.RepositoryAlreadyExistsException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.create_repository_response.CreateRepositoryResponse = (
        capo_ecr.types.create_repository_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.create_repository_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_repository(
    ...
    capo_ecr.types.create_repository_response.CreateRepositoryResponse, zapros.Response
]:
