...
import capo_ecr.errors.signing_configuration_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SigningConfigurationNotFoundException":
            raise capo_ecr.errors.signing_configuration_not_found_exception.SigningConfigurationNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.delete_signing_configuration_response.DeleteSigningConfigurationResponse = capo_ecr.types.delete_signing_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.delete_signing_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
