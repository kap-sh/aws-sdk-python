"""Generated from Smithy shape ``com.amazonaws.ecr#DeleteRepository``."""
...
import capo_ecr.errors.repository_not_empty_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RepositoryNotEmptyException":
            raise capo_ecr.errors.repository_not_empty_exception.RepositoryNotEmptyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_ecr.types.delete_repository_response.DeleteRepositoryResponse = (
        capo_ecr.types.delete_repository_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.delete_repository_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_repository(
    ...
    capo_ecr.types.delete_repository_response.DeleteRepositoryResponse, zapros.Response
]:
