...
import capo_ecr.errors.empty_upload_exception
import capo_ecr.errors.invalid_layer_exception
import capo_ecr.errors.invalid_parameter_exception
import capo_ecr.errors.kms_exception
import capo_ecr.errors.layer_already_exists_exception
import capo_ecr.errors.layer_part_too_small_exception
import capo_ecr.errors.repository_not_found_exception
import capo_ecr.errors.server_exception
import capo_ecr.errors.upload_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "EmptyUploadException":
            raise capo_ecr.errors.empty_upload_exception.EmptyUploadException.from_aws_json_1_1(
                data
            )
        case "InvalidLayerException":
            raise capo_ecr.errors.invalid_layer_exception.InvalidLayerException.from_aws_json_1_1(
                data
            )
        ...
        case "LayerAlreadyExistsException":
            raise capo_ecr.errors.layer_already_exists_exception.LayerAlreadyExistsException.from_aws_json_1_1(
                data
            )
        case "LayerPartTooSmallException":
            raise capo_ecr.errors.layer_part_too_small_exception.LayerPartTooSmallException.from_aws_json_1_1(
                data
            )
        ...
        case "UploadNotFoundException":
            raise capo_ecr.errors.upload_not_found_exception.UploadNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_ecr.types.complete_layer_upload_response.CompleteLayerUploadResponse = (
        capo_ecr.types.complete_layer_upload_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.complete_layer_upload_request.serialize_aws_json_1_1(input_)
    ).encode()
