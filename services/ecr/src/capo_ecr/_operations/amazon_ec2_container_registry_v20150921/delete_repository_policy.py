"""Generated from Smithy shape ``com.amazonaws.ecr#DeleteRepositoryPolicy``."""
...
import capo_ecr.errors.repository_policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RepositoryPolicyNotFoundException":
            raise capo_ecr.errors.repository_policy_not_found_exception.RepositoryPolicyNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.delete_repository_policy_response.DeleteRepositoryPolicyResponse = capo_ecr.types.delete_repository_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.delete_repository_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
