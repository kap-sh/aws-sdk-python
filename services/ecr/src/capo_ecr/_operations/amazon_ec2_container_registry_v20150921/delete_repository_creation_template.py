...
def handle_response(
    ...
    out: capo_ecr.types.delete_repository_creation_template_response.DeleteRepositoryCreationTemplateResponse = capo_ecr.types.delete_repository_creation_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.delete_repository_creation_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
