...
def handle_response(
    ...
    out: capo_ecr.types.describe_repository_creation_templates_response.DescribeRepositoryCreationTemplatesResponse = capo_ecr.types.describe_repository_creation_templates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.describe_repository_creation_templates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
