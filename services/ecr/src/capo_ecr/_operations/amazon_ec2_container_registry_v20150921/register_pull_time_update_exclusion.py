...
import capo_ecr.errors.exclusion_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ExclusionAlreadyExistsException":
            raise capo_ecr.errors.exclusion_already_exists_exception.ExclusionAlreadyExistsException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.register_pull_time_update_exclusion_response.RegisterPullTimeUpdateExclusionResponse = capo_ecr.types.register_pull_time_update_exclusion_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.register_pull_time_update_exclusion_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
