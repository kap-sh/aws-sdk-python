...
def handle_response(
    ...
    out: capo_ecr.types.put_registry_policy_response.PutRegistryPolicyResponse = (
        capo_ecr.types.put_registry_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.put_registry_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
