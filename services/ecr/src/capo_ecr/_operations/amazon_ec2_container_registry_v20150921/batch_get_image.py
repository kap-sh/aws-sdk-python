...
import capo_ecr.errors.unable_to_get_upstream_image_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnableToGetUpstreamImageException":
            raise capo_ecr.errors.unable_to_get_upstream_image_exception.UnableToGetUpstreamImageException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ecr.types.batch_get_image_response.BatchGetImageResponse = (
        capo_ecr.types.batch_get_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.batch_get_image_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def batch_get_image(
    ...
    capo_ecr.types.batch_get_image_response.BatchGetImageResponse, zapros.Response
]:
