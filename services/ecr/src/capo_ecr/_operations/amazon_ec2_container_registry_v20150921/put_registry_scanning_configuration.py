"""Generated from Smithy shape ``com.amazonaws.ecr#PutRegistryScanningConfiguration``."""
...
import capo_ecr.errors.blocked_by_organization_policy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BlockedByOrganizationPolicyException":
            raise capo_ecr.errors.blocked_by_organization_policy_exception.BlockedByOrganizationPolicyException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.put_registry_scanning_configuration_response.PutRegistryScanningConfigurationResponse = capo_ecr.types.put_registry_scanning_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.put_registry_scanning_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_registry_scanning_configuration(
