...
def handle_response(
    ...
    out: capo_ecr.types.get_signing_configuration_response.GetSigningConfigurationResponse = capo_ecr.types.get_signing_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.get_signing_configuration_request.serialize_aws_json_1_1(input_)
    ).encode()
