"""Generated from Smithy shape ``com.amazonaws.ecr#ListPullTimeUpdateExclusions``."""
...
def handle_response(
    ...
    out: capo_ecr.types.list_pull_time_update_exclusions_response.ListPullTimeUpdateExclusionsResponse = capo_ecr.types.list_pull_time_update_exclusions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.list_pull_time_update_exclusions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_pull_time_update_exclusions(
