...
import capo_ecr.errors.layer_inaccessible_exception
...
import capo_ecr.errors.unable_to_get_upstream_layer_exception
...
def handle_response(
    ...
    out: capo_ecr.types.get_download_url_for_layer_response.GetDownloadUrlForLayerResponse = capo_ecr.types.get_download_url_for_layer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.get_download_url_for_layer_request.serialize_aws_json_1_1(input_)
    ).encode()
