"""Generated from Smithy shape ``com.amazonaws.ecr#PutImage``."""
...
import capo_ecr.errors.image_already_exists_exception
import capo_ecr.errors.image_digest_does_not_match_exception
import capo_ecr.errors.image_tag_already_exists_exception
import capo_ecr.errors.invalid_parameter_exception
import capo_ecr.errors.kms_exception
import capo_ecr.errors.layers_not_found_exception
import capo_ecr.errors.limit_exceeded_exception
import capo_ecr.errors.referenced_images_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ImageAlreadyExistsException":
            raise capo_ecr.errors.image_already_exists_exception.ImageAlreadyExistsException.from_aws_json_1_1(
                data, message
            )
        case "ImageDigestDoesNotMatchException":
            raise capo_ecr.errors.image_digest_does_not_match_exception.ImageDigestDoesNotMatchException.from_aws_json_1_1(
                data, message
            )
        case "ImageTagAlreadyExistsException":
            raise capo_ecr.errors.image_tag_already_exists_exception.ImageTagAlreadyExistsException.from_aws_json_1_1(
                data, message
            )
        ...
        case "KmsException":
            raise capo_ecr.errors.kms_exception.KmsException.from_aws_json_1_1(
                data, message
            )
        ...
        case "ReferencedImagesNotFoundException":
            raise capo_ecr.errors.referenced_images_not_found_exception.ReferencedImagesNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.put_image_response.PutImageResponse = (
        capo_ecr.types.put_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.put_image_request.serialize_aws_json_1_1(input_), allow_nan=False
    ).encode()
...
def put_image(
    options: OperationOptions, input_: capo_ecr.types.put_image_request.PutImageRequest
) -> tuple[capo_ecr.types.put_image_response.PutImageResponse, zapros.Response]:
