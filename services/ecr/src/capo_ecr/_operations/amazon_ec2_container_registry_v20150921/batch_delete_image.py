...
def handle_response(
    ...
    out: capo_ecr.types.batch_delete_image_response.BatchDeleteImageResponse = (
        capo_ecr.types.batch_delete_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.batch_delete_image_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def batch_delete_image(
    ...
    capo_ecr.types.batch_delete_image_response.BatchDeleteImageResponse, zapros.Response
]:
