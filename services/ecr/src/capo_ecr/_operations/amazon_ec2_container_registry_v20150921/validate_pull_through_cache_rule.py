...
def handle_response(
    ...
    out: capo_ecr.types.validate_pull_through_cache_rule_response.ValidatePullThroughCacheRuleResponse = capo_ecr.types.validate_pull_through_cache_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.validate_pull_through_cache_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
