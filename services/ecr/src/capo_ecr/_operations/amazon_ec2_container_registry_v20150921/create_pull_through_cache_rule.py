"""Generated from Smithy shape ``com.amazonaws.ecr#CreatePullThroughCacheRule``."""
...
import capo_ecr.errors.pull_through_cache_rule_already_exists_exception
import capo_ecr.errors.secret_not_found_exception
import capo_ecr.errors.server_exception
import capo_ecr.errors.unable_to_access_secret_exception
import capo_ecr.errors.unable_to_decrypt_secret_value_exception
import capo_ecr.errors.unsupported_upstream_registry_exception
...
def handle_response(
    ...
    out: capo_ecr.types.create_pull_through_cache_rule_response.CreatePullThroughCacheRuleResponse = capo_ecr.types.create_pull_through_cache_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.create_pull_through_cache_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_pull_through_cache_rule(
