"""Generated from Smithy shape ``com.amazonaws.ecr#UpdatePullThroughCacheRule``."""
...
def handle_response(
    ...
    out: capo_ecr.types.update_pull_through_cache_rule_response.UpdatePullThroughCacheRuleResponse = capo_ecr.types.update_pull_through_cache_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.update_pull_through_cache_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_pull_through_cache_rule(
