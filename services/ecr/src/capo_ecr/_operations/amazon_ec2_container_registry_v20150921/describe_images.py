...
def handle_response(
    ...
    out: capo_ecr.types.describe_images_response.DescribeImagesResponse = (
        capo_ecr.types.describe_images_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.describe_images_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_images(
    ...
    capo_ecr.types.describe_images_response.DescribeImagesResponse, zapros.Response
]:
