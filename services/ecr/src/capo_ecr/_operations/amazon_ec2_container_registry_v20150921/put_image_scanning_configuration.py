...
def handle_response(
    ...
    out: capo_ecr.types.put_image_scanning_configuration_response.PutImageScanningConfigurationResponse = capo_ecr.types.put_image_scanning_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.put_image_scanning_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
