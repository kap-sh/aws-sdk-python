...
def handle_response(
    ...
    out: capo_ecr.types.batch_check_layer_availability_response.BatchCheckLayerAvailabilityResponse = capo_ecr.types.batch_check_layer_availability_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.batch_check_layer_availability_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
