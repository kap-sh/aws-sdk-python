...
import capo_ecr.errors.template_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TemplateNotFoundException":
            raise capo_ecr.errors.template_not_found_exception.TemplateNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.update_repository_creation_template_response.UpdateRepositoryCreationTemplateResponse = capo_ecr.types.update_repository_creation_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.update_repository_creation_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
