...
import capo_ecr.errors.scan_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ScanNotFoundException":
            raise capo_ecr.errors.scan_not_found_exception.ScanNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.describe_image_scan_findings_response.DescribeImageScanFindingsResponse = capo_ecr.types.describe_image_scan_findings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.describe_image_scan_findings_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
