...
def handle_response(
    ...
    out: capo_ecr.types.get_lifecycle_policy_response.GetLifecyclePolicyResponse = (
        capo_ecr.types.get_lifecycle_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.get_lifecycle_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
