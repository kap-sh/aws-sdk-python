...
def handle_response(
    ...
    out: capo_ecr.types.describe_image_replication_status_response.DescribeImageReplicationStatusResponse = capo_ecr.types.describe_image_replication_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.describe_image_replication_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
