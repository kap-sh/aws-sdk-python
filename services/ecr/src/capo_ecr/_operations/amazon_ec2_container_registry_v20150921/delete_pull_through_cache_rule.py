"""Generated from Smithy shape ``com.amazonaws.ecr#DeletePullThroughCacheRule``."""
...
def handle_response(
    ...
    out: capo_ecr.types.delete_pull_through_cache_rule_response.DeletePullThroughCacheRuleResponse = capo_ecr.types.delete_pull_through_cache_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.delete_pull_through_cache_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_pull_through_cache_rule(
