"""Generated from Smithy shape ``com.amazonaws.ecr#StartImageScan``."""
...
import capo_ecr.errors.image_archived_exception
...
import capo_ecr.errors.unsupported_image_type_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ImageArchivedException":
            raise capo_ecr.errors.image_archived_exception.ImageArchivedException.from_aws_json_1_1(
                data, message
            )
        ...
        case "UnsupportedImageTypeException":
            raise capo_ecr.errors.unsupported_image_type_exception.UnsupportedImageTypeException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.start_image_scan_response.StartImageScanResponse = (
        capo_ecr.types.start_image_scan_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.start_image_scan_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_image_scan(
    ...
    capo_ecr.types.start_image_scan_response.StartImageScanResponse, zapros.Response
]:
...
async def async_start_image_scan(
