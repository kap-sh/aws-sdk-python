"""Generated from Smithy shape ``com.amazonaws.ecr#GetRepositoryPolicy``."""
...
def handle_response(
    ...
    out: capo_ecr.types.get_repository_policy_response.GetRepositoryPolicyResponse = (
        capo_ecr.types.get_repository_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.get_repository_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
