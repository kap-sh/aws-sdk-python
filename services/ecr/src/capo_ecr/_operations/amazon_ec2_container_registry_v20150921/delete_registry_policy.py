...
def handle_response(
    ...
    out: capo_ecr.types.delete_registry_policy_response.DeleteRegistryPolicyResponse = (
        capo_ecr.types.delete_registry_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.delete_registry_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
