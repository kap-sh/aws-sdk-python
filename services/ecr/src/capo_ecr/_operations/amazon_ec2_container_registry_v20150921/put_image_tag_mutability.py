...
def handle_response(
    ...
    out: capo_ecr.types.put_image_tag_mutability_response.PutImageTagMutabilityResponse = capo_ecr.types.put_image_tag_mutability_response.deserialize_aws_json_1_1(
