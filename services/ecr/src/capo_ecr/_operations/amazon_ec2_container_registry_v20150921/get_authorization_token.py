...
def handle_response(
    ...
    out: capo_ecr.types.get_authorization_token_response.GetAuthorizationTokenResponse = capo_ecr.types.get_authorization_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.get_authorization_token_request.serialize_aws_json_1_1(input_)
    ).encode()
