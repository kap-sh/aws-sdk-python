...
import capo_ecr.errors.pull_through_cache_rule_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PullThroughCacheRuleNotFoundException":
            raise capo_ecr.errors.pull_through_cache_rule_not_found_exception.PullThroughCacheRuleNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecr.types.describe_pull_through_cache_rules_response.DescribePullThroughCacheRulesResponse = capo_ecr.types.describe_pull_through_cache_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.describe_pull_through_cache_rules_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
