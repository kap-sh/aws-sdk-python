...
def handle_response(
    ...
    out: capo_ecr.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse = capo_ecr.types.delete_lifecycle_policy_response.deserialize_aws_json_1_1(
