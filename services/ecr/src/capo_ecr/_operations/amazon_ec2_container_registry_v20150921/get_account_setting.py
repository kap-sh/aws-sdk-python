...
def handle_response(
    ...
    out: capo_ecr.types.get_account_setting_response.GetAccountSettingResponse = (
        capo_ecr.types.get_account_setting_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecr.types.get_account_setting_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
