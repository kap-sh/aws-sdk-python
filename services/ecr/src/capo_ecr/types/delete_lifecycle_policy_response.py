"""Generated from Smithy shape ``com.amazonaws.ecr#DeleteLifecyclePolicyResponse``."""
...
class DeleteLifecyclePolicyResponse(TypedDict, closed=True):
    ...
    last_evaluated_at: NotRequired[
        "capo_ecr.types.evaluation_timestamp.EvaluationTimestamp"
    ]
    """<p>The time stamp of the last time that the lifecycle policy was run.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteLifecyclePolicyResponse) -> dict:
    out: dict = {}
    ...
    if "last_evaluated_at" in value:
        ...
        out["lastEvaluatedAt"] = (
            capo_ecr.types.evaluation_timestamp.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DeleteLifecyclePolicyResponse:
    ...
    if "lastEvaluatedAt" in data:
        ...
        out["last_evaluated_at"] = (
            capo_ecr.types.evaluation_timestamp.deserialize_aws_json_1_1(
