"""Generated from Smithy shape ``com.amazonaws.ecr#CreatePullThroughCacheRuleResponse``."""
...
class CreatePullThroughCacheRuleResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreatePullThroughCacheRuleResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreatePullThroughCacheRuleResponse:
    out: CreatePullThroughCacheRuleResponse = {}  # type: ignore[typeddict-item]
