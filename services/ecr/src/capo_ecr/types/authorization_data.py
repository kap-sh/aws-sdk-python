...
if TYPE_CHECKING:
    import capo_ecr.types.base64
    import capo_ecr.types.expiration_timestamp
    import capo_ecr.types.proxy_endpoint


class AuthorizationData(TypedDict, closed=True):
    authorization_token: NotRequired["capo_ecr.types.base64.Base64"]
    ...
    expires_at: NotRequired["capo_ecr.types.expiration_timestamp.ExpirationTimestamp"]
    ...
    proxy_endpoint: NotRequired["capo_ecr.types.proxy_endpoint.ProxyEndpoint"]
...
def serialize_aws_json_1_1(value: AuthorizationData) -> dict:
    ...
    if "expires_at" in value:
        ...
        out["expiresAt"] = capo_ecr.types.expiration_timestamp.serialize_aws_json_1_1(
            value["expires_at"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> AuthorizationData:
    ...
    if "expiresAt" in data:
        ...
        out["expires_at"] = (
            capo_ecr.types.expiration_timestamp.deserialize_aws_json_1_1(
                data["expiresAt"]
            )
        )
