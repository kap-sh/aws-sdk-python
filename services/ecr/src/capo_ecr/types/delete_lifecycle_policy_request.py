"""Generated from Smithy shape ``com.amazonaws.ecr#DeleteLifecyclePolicyRequest``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteLifecyclePolicyRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteLifecyclePolicyRequest:
    ...
    if "repositoryName" in data:
        ...
        raise DeserializationError(
            "DeleteLifecyclePolicyRequest.repository_name required"
        )
    return out
