"""Generated from Smithy shape ``com.amazonaws.ecr#Tag``."""
...
if TYPE_CHECKING:
    import capo_ecr.types.tag_key
    import capo_ecr.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_ecr.types.tag_key.TagKey"
    ...
    value: "capo_ecr.types.tag_value.TagValue"
