...
if TYPE_CHECKING:
    ...
    import capo_ecr.types.image_size_in_bytes
...
class ImageDetail(TypedDict, closed=True):
    ...
    image_size_in_bytes: NotRequired[
        "capo_ecr.types.image_size_in_bytes.ImageSizeInBytes"
    ]
    ...
    image_scan_findings_summary: NotRequired[
        "capo_ecr.types.image_scan_findings_summary.ImageScanFindingsSummary"
    ]
    """<p>A summary of the last completed image scan.</p>"""
    image_manifest_media_type: NotRequired["capo_ecr.types.media_type.MediaType"]
    """<p>The media type of the image manifest.</p>"""
    artifact_media_type: NotRequired["capo_ecr.types.media_type.MediaType"]
    """<p>The artifact media type of the image.</p>"""
    last_recorded_pull_time: NotRequired[
        "capo_ecr.types.recorded_pull_timestamp.RecordedPullTimestamp"
    ]
    ...
    subject_manifest_digest: NotRequired["capo_ecr.types.image_digest.ImageDigest"]
    ...
    last_archived_at: NotRequired[
        "capo_ecr.types.last_archived_at_timestamp.LastArchivedAtTimestamp"
    ]
    ...
    last_activated_at: NotRequired[
        "capo_ecr.types.last_activated_at_timestamp.LastActivatedAtTimestamp"
    ]
...
def serialize_aws_json_1_1(value: ImageDetail) -> dict:
    ...
    if "image_scan_findings_summary" in value:
        ...
        out["imageScanFindingsSummary"] = (
            capo_ecr.types.image_scan_findings_summary.serialize_aws_json_1_1(
    ...
    if "last_recorded_pull_time" in value:
        ...
        out["lastRecordedPullTime"] = (
            capo_ecr.types.recorded_pull_timestamp.serialize_aws_json_1_1(
    ...
    if "last_archived_at" in value:
        ...
        out["lastArchivedAt"] = (
            capo_ecr.types.last_archived_at_timestamp.serialize_aws_json_1_1(
    ...
    if "last_activated_at" in value:
        ...
        out["lastActivatedAt"] = (
            capo_ecr.types.last_activated_at_timestamp.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ImageDetail:
    ...
    if "imageScanFindingsSummary" in data:
        ...
        out["image_scan_findings_summary"] = (
            capo_ecr.types.image_scan_findings_summary.deserialize_aws_json_1_1(
    ...
    if "lastRecordedPullTime" in data:
        ...
        out["last_recorded_pull_time"] = (
            capo_ecr.types.recorded_pull_timestamp.deserialize_aws_json_1_1(
    ...
    if "lastArchivedAt" in data:
        ...
        out["last_archived_at"] = (
            capo_ecr.types.last_archived_at_timestamp.deserialize_aws_json_1_1(
                data["lastArchivedAt"]
            )
        )
    if "lastActivatedAt" in data:
        ...
        out["last_activated_at"] = (
            capo_ecr.types.last_activated_at_timestamp.deserialize_aws_json_1_1(
