...
class RepositoryCreationTemplate(TypedDict, closed=True):
    prefix: NotRequired["capo_ecr.types.prefix.Prefix"]
    ...
    created_at: NotRequired["capo_ecr.types.date.Date"]
...
def serialize_aws_json_1_1(value: RepositoryCreationTemplate) -> dict:
    ...
    if "created_at" in value:
        ...
        out["createdAt"] = capo_ecr.types.date.serialize_aws_json_1_1(
            value["created_at"]
        )
