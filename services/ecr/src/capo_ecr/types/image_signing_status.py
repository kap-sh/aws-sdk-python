...
def serialize_aws_json_1_1(value: ImageSigningStatus) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = capo_ecr.types.signing_status.serialize_aws_json_1_1(
            value["status"]
        )
    return out
