...
if TYPE_CHECKING:
    ...
    import capo_ecr.types.layer_failure_reason
...
class LayerFailure(TypedDict, closed=True):
    ...
    failure_code: NotRequired["capo_ecr.types.layer_failure_code.LayerFailureCode"]
    """<p>The failure code associated with the failure.</p>"""
    failure_reason: NotRequired[
        "capo_ecr.types.layer_failure_reason.LayerFailureReason"
    ]
...
def serialize_aws_json_1_1(value: LayerFailure) -> dict:
    ...
    if "failure_code" in value:
        ...
        out["failureCode"] = capo_ecr.types.layer_failure_code.serialize_aws_json_1_1(
            value["failure_code"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> LayerFailure:
    ...
    if data.get("failureCode") is not None:
        ...
        out["failure_code"] = (
            capo_ecr.types.layer_failure_code.deserialize_aws_json_1_1(
                data["failureCode"]
            )
        )
