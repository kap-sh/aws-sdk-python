...
if TYPE_CHECKING:
    import capo_ecr.types.transitioning_image_total_count

TransitioningImageTotalCounts: TypeAlias = list[
    "capo_ecr.types.transitioning_image_total_count.TransitioningImageTotalCount"
]
...
def serialize_aws_json_1_1(value: TransitioningImageTotalCounts) -> list:
    ...
    for item in value:
        out.append(
            capo_ecr.types.transitioning_image_total_count.serialize_aws_json_1_1(item)
        )
    return out
