...
if TYPE_CHECKING:
    import capo_ecr.types.signing_rule

SigningRuleList: TypeAlias = list["capo_ecr.types.signing_rule.SigningRule"]
...
def serialize_aws_json_1_1(value: SigningRuleList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_ecr.types.signing_rule.serialize_aws_json_1_1(item))
    return out
