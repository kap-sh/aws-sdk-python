"""Generated from Smithy shape ``com.amazonaws.ecr#LayerAlreadyExistsException``."""
...
class LayerAlreadyExistsException_(TypedDict, closed=True):
...
class LayerAlreadyExistsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ecr#LayerAlreadyExistsException``."""

    code: str | None = "LayerAlreadyExistsException"

    def __init__(self, data: LayerAlreadyExistsException_, message: str | None = None):
        super().__init__(
            "client",
