"""Generated from Smithy shape ``com.amazonaws.ecr#ImageDigestDoesNotMatchException``."""
...
class ImageDigestDoesNotMatchException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ecr#ImageDigestDoesNotMatchException``."""
