"""Generated from Smithy shape ``com.amazonaws.configservice#ConformancePackTemplateValidationException``."""
...
class ConformancePackTemplateValidationException_(TypedDict, closed=True):
    message: NotRequired["capo_config_service.types.error_message.ErrorMessage"]
    """<p>Error executing the command</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ConformancePackTemplateValidationException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class ConformancePackTemplateValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.configservice#ConformancePackTemplateValidationException``."""
