"""Generated from Smithy shape ``com.amazonaws.configservice#TooManyTagsException``."""
...
class TooManyTagsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.configservice#TooManyTagsException``."""
