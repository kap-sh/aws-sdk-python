...
if TYPE_CHECKING:
    ...
    import capo_config_service.types.integer
...
class AggregateConformancePackCompliance(TypedDict, closed=True):
    ...
    compliant_rule_count: "capo_config_service.types.integer.Integer"
    """<p>The number of compliant Config Rules.</p>"""
    non_compliant_rule_count: "capo_config_service.types.integer.Integer"
    """<p>The number of noncompliant Config Rules.</p>"""
    total_rule_count: "capo_config_service.types.integer.Integer"
