...
class SourceDetail(TypedDict, closed=True):
    event_source: NotRequired["capo_config_service.types.event_source.EventSource"]
    ...
    message_type: NotRequired["capo_config_service.types.message_type.MessageType"]
...
def serialize_aws_json_1_1(value: SourceDetail) -> dict:
    ...
    if "event_source" in value:
        ...
        out["EventSource"] = (
            capo_config_service.types.event_source.serialize_aws_json_1_1(
                value["event_source"]
            )
        )
    if "message_type" in value:
        ...
        out["MessageType"] = (
            capo_config_service.types.message_type.serialize_aws_json_1_1(
                value["message_type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> SourceDetail:
    ...
    if "EventSource" in data:
        ...
        out["event_source"] = (
            capo_config_service.types.event_source.deserialize_aws_json_1_1(
                data["EventSource"]
            )
        )
    if "MessageType" in data:
        ...
        out["message_type"] = (
            capo_config_service.types.message_type.deserialize_aws_json_1_1(
                data["MessageType"]
            )
        )
