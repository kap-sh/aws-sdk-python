...
if TYPE_CHECKING:
    ...
    import capo_config_service.types.retention_configuration_list


class DescribeRetentionConfigurationsResponse(TypedDict, closed=True):
    retention_configurations: NotRequired[
        "capo_config_service.types.retention_configuration_list.RetentionConfigurationList"
    ]
...
def serialize_aws_json_1_1(value: DescribeRetentionConfigurationsResponse) -> dict:
    ...
    if "retention_configurations" in value:
        ...
        out["RetentionConfigurations"] = (
            capo_config_service.types.retention_configuration_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeRetentionConfigurationsResponse:
    ...
    if "RetentionConfigurations" in data:
        ...
        out["retention_configurations"] = (
            capo_config_service.types.retention_configuration_list.deserialize_aws_json_1_1(
