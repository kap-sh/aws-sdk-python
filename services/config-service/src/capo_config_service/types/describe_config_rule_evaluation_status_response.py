...
if TYPE_CHECKING:
    import capo_config_service.types.config_rule_evaluation_status_list
    import capo_config_service.types.string


class DescribeConfigRuleEvaluationStatusResponse(TypedDict, closed=True):
    config_rules_evaluation_status: NotRequired[
        "capo_config_service.types.config_rule_evaluation_status_list.ConfigRuleEvaluationStatusList"
    ]
...
def serialize_aws_json_1_1(value: DescribeConfigRuleEvaluationStatusResponse) -> dict:
    ...
    if "config_rules_evaluation_status" in value:
        ...
        out["ConfigRulesEvaluationStatus"] = (
            capo_config_service.types.config_rule_evaluation_status_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeConfigRuleEvaluationStatusResponse:
    ...
    if "ConfigRulesEvaluationStatus" in data:
        ...
        out["config_rules_evaluation_status"] = (
            capo_config_service.types.config_rule_evaluation_status_list.deserialize_aws_json_1_1(
