...
class EvaluationModeConfiguration(TypedDict, closed=True):
    mode: NotRequired["capo_config_service.types.evaluation_mode.EvaluationMode"]
...
def serialize_aws_json_1_1(value: EvaluationModeConfiguration) -> dict:
    ...
    if "mode" in value:
        ...
        out["Mode"] = capo_config_service.types.evaluation_mode.serialize_aws_json_1_1(
            value["mode"]
        )
    return out
