...
if TYPE_CHECKING:
    import capo_config_service.types.aggregate_conformance_pack_compliance_count
...
class AggregateConformancePackComplianceSummary(TypedDict, closed=True):
    compliance_summary: NotRequired[
        "capo_config_service.types.aggregate_conformance_pack_compliance_count.AggregateConformancePackComplianceCount"
    ]
...
def serialize_aws_json_1_1(value: AggregateConformancePackComplianceSummary) -> dict:
    ...
    if "compliance_summary" in value:
        ...
        out["ComplianceSummary"] = (
            capo_config_service.types.aggregate_conformance_pack_compliance_count.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AggregateConformancePackComplianceSummary:
    ...
    if "ComplianceSummary" in data:
        ...
        out["compliance_summary"] = (
            capo_config_service.types.aggregate_conformance_pack_compliance_count.deserialize_aws_json_1_1(
