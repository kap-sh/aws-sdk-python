...
class Scope(TypedDict, closed=True):
    compliance_resource_types: NotRequired[
        "capo_config_service.types.compliance_resource_types.ComplianceResourceTypes"
    ]
    ...
    service_principals: NotRequired[
        "capo_config_service.types.service_principals.ServicePrincipals"
    ]
...
def serialize_aws_json_1_1(value: Scope) -> dict:
    ...
    if "compliance_resource_types" in value:
        ...
        out["ComplianceResourceTypes"] = (
            capo_config_service.types.compliance_resource_types.serialize_aws_json_1_1(
    ...
    if "service_principals" in value:
        ...
        out["ServicePrincipals"] = (
            capo_config_service.types.service_principals.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Scope:
    ...
    if "ComplianceResourceTypes" in data:
        ...
        out["compliance_resource_types"] = (
            capo_config_service.types.compliance_resource_types.deserialize_aws_json_1_1(
    ...
    if "ServicePrincipals" in data:
        ...
        out["service_principals"] = (
            capo_config_service.types.service_principals.deserialize_aws_json_1_1(
