...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetCustomRulePolicyResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetCustomRulePolicyResponse:
    out: GetCustomRulePolicyResponse = {}  # type: ignore[typeddict-item]
