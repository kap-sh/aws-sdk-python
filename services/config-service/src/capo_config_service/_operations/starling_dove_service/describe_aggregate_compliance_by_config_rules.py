"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeAggregateComplianceByConfigRules``."""
...
def handle_response(
    ...
    out: capo_config_service.types.describe_aggregate_compliance_by_config_rules_response.DescribeAggregateComplianceByConfigRulesResponse = capo_config_service.types.describe_aggregate_compliance_by_config_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_aggregate_compliance_by_config_rules_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_aggregate_compliance_by_config_rules(
