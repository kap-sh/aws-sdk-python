"""Generated from Smithy shape ``com.amazonaws.configservice#GetComplianceSummaryByConfigRule``."""
...
def handle_response(
    ...
    out: capo_config_service.types.get_compliance_summary_by_config_rule_response.GetComplianceSummaryByConfigRuleResponse = capo_config_service.types.get_compliance_summary_by_config_rule_response.deserialize_aws_json_1_1(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetComplianceSummaryByConfigRule"
    body: bytes | None = b""
...
async def async_get_compliance_summary_by_config_rule(
