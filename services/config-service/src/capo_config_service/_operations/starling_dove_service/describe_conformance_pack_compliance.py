"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeConformancePackCompliance``."""
...
import capo_config_service.errors.no_such_config_rule_in_conformance_pack_exception
import capo_config_service.errors.no_such_conformance_pack_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchConfigRuleInConformancePackException":
            raise capo_config_service.errors.no_such_config_rule_in_conformance_pack_exception.NoSuchConfigRuleInConformancePackException.from_aws_json_1_1(
                data
            )
        case "NoSuchConformancePackException":
            raise capo_config_service.errors.no_such_conformance_pack_exception.NoSuchConformancePackException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_config_service.types.describe_conformance_pack_compliance_response.DescribeConformancePackComplianceResponse = capo_config_service.types.describe_conformance_pack_compliance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribeConformancePackCompliance"
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_conformance_pack_compliance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_conformance_pack_compliance(
