...
def handle_response(
    ...
    out: capo_config_service.types.list_discovered_resources_response.ListDiscoveredResourcesResponse = capo_config_service.types.list_discovered_resources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.list_discovered_resources_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
