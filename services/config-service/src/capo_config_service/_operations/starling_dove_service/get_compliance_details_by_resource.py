"""Generated from Smithy shape ``com.amazonaws.configservice#GetComplianceDetailsByResource``."""
...
def handle_response(
    ...
    out: capo_config_service.types.get_compliance_details_by_resource_response.GetComplianceDetailsByResourceResponse = capo_config_service.types.get_compliance_details_by_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetComplianceDetailsByResource"
    body: bytes | None = json.dumps(
        capo_config_service.types.get_compliance_details_by_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_compliance_details_by_resource(
