"""Generated from Smithy shape ``com.amazonaws.configservice#StartConfigRulesEvaluation``."""
...
import capo_config_service.errors.no_such_config_rule_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchConfigRuleException":
            raise capo_config_service.errors.no_such_config_rule_exception.NoSuchConfigRuleException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.start_config_rules_evaluation_response.StartConfigRulesEvaluationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.start_config_rules_evaluation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_config_rules_evaluation(
