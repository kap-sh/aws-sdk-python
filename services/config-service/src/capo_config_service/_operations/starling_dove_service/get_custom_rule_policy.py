"""Generated from Smithy shape ``com.amazonaws.configservice#GetCustomRulePolicy``."""
...
def handle_response(
    ...
    out: capo_config_service.types.get_custom_rule_policy_response.GetCustomRulePolicyResponse = capo_config_service.types.get_custom_rule_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetCustomRulePolicy"
    body: bytes | None = json.dumps(
        capo_config_service.types.get_custom_rule_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_custom_rule_policy(
