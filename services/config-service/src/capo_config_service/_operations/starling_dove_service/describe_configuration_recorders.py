...
def handle_response(
    ...
    out: capo_config_service.types.describe_configuration_recorders_response.DescribeConfigurationRecordersResponse = capo_config_service.types.describe_configuration_recorders_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_configuration_recorders_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
