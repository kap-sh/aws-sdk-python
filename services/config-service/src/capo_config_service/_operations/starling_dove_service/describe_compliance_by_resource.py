"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeComplianceByResource``."""
...
import capo_config_service.types.compliance_by_resources
...
def handle_response(
    ...
    out: capo_config_service.types.describe_compliance_by_resource_response.DescribeComplianceByResourceResponse = capo_config_service.types.describe_compliance_by_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_compliance_by_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_compliance_by_resource(
