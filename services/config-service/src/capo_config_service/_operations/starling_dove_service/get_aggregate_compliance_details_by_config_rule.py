"""Generated from Smithy shape ``com.amazonaws.configservice#GetAggregateComplianceDetailsByConfigRule``."""
...
def handle_response(
    ...
    out: capo_config_service.types.get_aggregate_compliance_details_by_config_rule_response.GetAggregateComplianceDetailsByConfigRuleResponse = capo_config_service.types.get_aggregate_compliance_details_by_config_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.get_aggregate_compliance_details_by_config_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_aggregate_compliance_details_by_config_rule(
