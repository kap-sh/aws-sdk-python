"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeConfigurationRecorderStatus``."""
...
def handle_response(
    ...
    out: capo_config_service.types.describe_configuration_recorder_status_response.DescribeConfigurationRecorderStatusResponse = capo_config_service.types.describe_configuration_recorder_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_configuration_recorder_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_configuration_recorder_status(
