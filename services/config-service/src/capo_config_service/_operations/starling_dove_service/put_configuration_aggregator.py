...
import capo_config_service.errors.invalid_role_exception
import capo_config_service.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRoleException":
            raise capo_config_service.errors.invalid_role_exception.InvalidRoleException.from_aws_json_1_1(
                data
            )
        case "LimitExceededException":
            raise capo_config_service.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.put_configuration_aggregator_response.PutConfigurationAggregatorResponse = capo_config_service.types.put_configuration_aggregator_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_configuration_aggregator_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
