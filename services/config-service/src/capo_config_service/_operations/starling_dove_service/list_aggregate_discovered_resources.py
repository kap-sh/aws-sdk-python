"""Generated from Smithy shape ``com.amazonaws.configservice#ListAggregateDiscoveredResources``."""
...
import capo_config_service.types.discovered_resource_identifier_list
...
def handle_response(
    ...
    out: capo_config_service.types.list_aggregate_discovered_resources_response.ListAggregateDiscoveredResourcesResponse = capo_config_service.types.list_aggregate_discovered_resources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.ListAggregateDiscoveredResources"
    body: bytes | None = json.dumps(
        capo_config_service.types.list_aggregate_discovered_resources_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_aggregate_discovered_resources(
