"""Generated from Smithy shape ``com.amazonaws.configservice#PutAggregationAuthorization``."""
...
def handle_response(
    ...
    out: capo_config_service.types.put_aggregation_authorization_response.PutAggregationAuthorizationResponse = capo_config_service.types.put_aggregation_authorization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_aggregation_authorization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_aggregation_authorization(
