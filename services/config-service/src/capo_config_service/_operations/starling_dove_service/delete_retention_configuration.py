"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteRetentionConfiguration``."""
...
import capo_config_service.errors.no_such_retention_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchRetentionConfigurationException":
            raise capo_config_service.errors.no_such_retention_configuration_exception.NoSuchRetentionConfigurationException.from_aws_json_1_1(
                data
            )
        case _:
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.delete_retention_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_retention_configuration(
