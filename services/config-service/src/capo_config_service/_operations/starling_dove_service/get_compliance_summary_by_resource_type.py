"""Generated from Smithy shape ``com.amazonaws.configservice#GetComplianceSummaryByResourceType``."""
...
import capo_config_service.types.compliance_summaries_by_resource_type
...
def handle_response(
    ...
    out: capo_config_service.types.get_compliance_summary_by_resource_type_response.GetComplianceSummaryByResourceTypeResponse = capo_config_service.types.get_compliance_summary_by_resource_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetComplianceSummaryByResourceType"
    body: bytes | None = json.dumps(
        capo_config_service.types.get_compliance_summary_by_resource_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_compliance_summary_by_resource_type(
