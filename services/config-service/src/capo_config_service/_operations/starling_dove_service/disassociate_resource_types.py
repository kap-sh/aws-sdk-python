"""Generated from Smithy shape ``com.amazonaws.configservice#DisassociateResourceTypes``."""
...
def handle_response(
    ...
    out: capo_config_service.types.disassociate_resource_types_response.DisassociateResourceTypesResponse = capo_config_service.types.disassociate_resource_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DisassociateResourceTypes"
    body: bytes | None = json.dumps(
        capo_config_service.types.disassociate_resource_types_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_resource_types(
