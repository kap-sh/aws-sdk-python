"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeAggregationAuthorizations``."""
...
def handle_response(
    ...
    out: capo_config_service.types.describe_aggregation_authorizations_response.DescribeAggregationAuthorizationsResponse = capo_config_service.types.describe_aggregation_authorizations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribeAggregationAuthorizations"
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_aggregation_authorizations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_aggregation_authorizations(
