"""Generated from Smithy shape ``com.amazonaws.configservice#SelectAggregateResourceConfig``."""
...
import capo_config_service.errors.invalid_expression_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidExpressionException":
            raise capo_config_service.errors.invalid_expression_exception.InvalidExpressionException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.select_aggregate_resource_config_response.SelectAggregateResourceConfigResponse = capo_config_service.types.select_aggregate_resource_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.SelectAggregateResourceConfig"
    body: bytes | None = json.dumps(
        capo_config_service.types.select_aggregate_resource_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_select_aggregate_resource_config(
