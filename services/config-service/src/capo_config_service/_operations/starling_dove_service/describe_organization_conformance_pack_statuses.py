"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeOrganizationConformancePackStatuses``."""
...
import capo_config_service.errors.no_such_organization_conformance_pack_exception
...
import capo_config_service.types.organization_conformance_pack_statuses
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchOrganizationConformancePackException":
            raise capo_config_service.errors.no_such_organization_conformance_pack_exception.NoSuchOrganizationConformancePackException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.describe_organization_conformance_pack_statuses_response.DescribeOrganizationConformancePackStatusesResponse = capo_config_service.types.describe_organization_conformance_pack_statuses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_organization_conformance_pack_statuses_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_organization_conformance_pack_statuses(
