"""Generated from Smithy shape ``com.amazonaws.configservice#PutRemediationConfigurations``."""
...
def handle_response(
    ...
    out: capo_config_service.types.put_remediation_configurations_response.PutRemediationConfigurationsResponse = capo_config_service.types.put_remediation_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_remediation_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_remediation_configurations(
