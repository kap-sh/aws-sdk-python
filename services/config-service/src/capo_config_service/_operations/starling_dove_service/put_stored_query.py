...
import capo_config_service.errors.resource_concurrent_modification_exception
import capo_config_service.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceConcurrentModificationException":
            raise capo_config_service.errors.resource_concurrent_modification_exception.ResourceConcurrentModificationException.from_aws_json_1_1(
                data
            )
        case "TooManyTagsException":
            raise capo_config_service.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.put_stored_query_response.PutStoredQueryResponse = (
        capo_config_service.types.put_stored_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_stored_query_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
