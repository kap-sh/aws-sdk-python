"""Generated from Smithy shape ``com.amazonaws.configservice#PutEvaluations``."""
...
import capo_config_service.errors.invalid_result_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResultTokenException":
            raise capo_config_service.errors.invalid_result_token_exception.InvalidResultTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.put_evaluations_response.PutEvaluationsResponse = (
        capo_config_service.types.put_evaluations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_evaluations_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_put_evaluations(
