"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeOrganizationConfigRules``."""
...
import capo_config_service.errors.no_such_organization_config_rule_exception
...
import capo_config_service.types.organization_config_rules
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchOrganizationConfigRuleException":
            raise capo_config_service.errors.no_such_organization_config_rule_exception.NoSuchOrganizationConfigRuleException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.describe_organization_config_rules_response.DescribeOrganizationConfigRulesResponse = capo_config_service.types.describe_organization_config_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribeOrganizationConfigRules"
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_organization_config_rules_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_organization_config_rules(
