"""Generated from Smithy shape ``com.amazonaws.configservice#StartResourceEvaluation``."""
...
import capo_config_service.errors.idempotent_parameter_mismatch
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "IdempotentParameterMismatch":
            raise capo_config_service.errors.idempotent_parameter_mismatch.IdempotentParameterMismatch.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.start_resource_evaluation_response.StartResourceEvaluationResponse = capo_config_service.types.start_resource_evaluation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.StartResourceEvaluation"
    body: bytes | None = json.dumps(
        capo_config_service.types.start_resource_evaluation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_resource_evaluation(
