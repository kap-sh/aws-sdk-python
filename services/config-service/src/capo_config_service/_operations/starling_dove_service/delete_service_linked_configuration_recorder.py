...
import capo_config_service.errors.conflict_exception
import capo_config_service.errors.no_such_configuration_recorder_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise capo_config_service.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        case "NoSuchConfigurationRecorderException":
            raise capo_config_service.errors.no_such_configuration_recorder_exception.NoSuchConfigurationRecorderException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.delete_service_linked_configuration_recorder_response.DeleteServiceLinkedConfigurationRecorderResponse = capo_config_service.types.delete_service_linked_configuration_recorder_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.delete_service_linked_configuration_recorder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
