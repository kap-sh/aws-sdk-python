"""Generated from Smithy shape ``com.amazonaws.configservice#GetConformancePackComplianceSummary``."""
...
def handle_response(
    ...
    out: capo_config_service.types.get_conformance_pack_compliance_summary_response.GetConformancePackComplianceSummaryResponse = capo_config_service.types.get_conformance_pack_compliance_summary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetConformancePackComplianceSummary"
    body: bytes | None = json.dumps(
        capo_config_service.types.get_conformance_pack_compliance_summary_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_conformance_pack_compliance_summary(
