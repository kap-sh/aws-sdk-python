"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeConfigurationAggregatorSourcesStatus``."""
...
import capo_config_service.errors.no_such_configuration_aggregator_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchConfigurationAggregatorException":
            raise capo_config_service.errors.no_such_configuration_aggregator_exception.NoSuchConfigurationAggregatorException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_config_service.types.describe_configuration_aggregator_sources_status_response.DescribeConfigurationAggregatorSourcesStatusResponse = capo_config_service.types.describe_configuration_aggregator_sources_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_configuration_aggregator_sources_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_configuration_aggregator_sources_status(
