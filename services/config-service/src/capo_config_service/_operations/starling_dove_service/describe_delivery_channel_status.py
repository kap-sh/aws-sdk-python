"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeDeliveryChannelStatus``."""
...
import capo_config_service.types.delivery_channel_status_list
...
def handle_response(
    ...
    out: capo_config_service.types.describe_delivery_channel_status_response.DescribeDeliveryChannelStatusResponse = capo_config_service.types.describe_delivery_channel_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_delivery_channel_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_delivery_channel_status(
