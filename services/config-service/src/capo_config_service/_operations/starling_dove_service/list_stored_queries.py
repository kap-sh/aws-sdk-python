...
def handle_response(
    ...
    out: capo_config_service.types.list_stored_queries_response.ListStoredQueriesResponse = capo_config_service.types.list_stored_queries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.list_stored_queries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
