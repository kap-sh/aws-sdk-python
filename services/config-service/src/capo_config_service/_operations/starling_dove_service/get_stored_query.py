"""Generated from Smithy shape ``com.amazonaws.configservice#GetStoredQuery``."""
...
import capo_config_service.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceNotFoundException":
            raise capo_config_service.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.get_stored_query_response.GetStoredQueryResponse = (
        capo_config_service.types.get_stored_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetStoredQuery"
    body: bytes | None = json.dumps(
        capo_config_service.types.get_stored_query_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_stored_query(
