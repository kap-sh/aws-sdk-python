"""Generated from Smithy shape ``com.amazonaws.configservice#PutRetentionConfiguration``."""
...
import capo_config_service.errors.max_number_of_retention_configurations_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MaxNumberOfRetentionConfigurationsExceededException":
            raise capo_config_service.errors.max_number_of_retention_configurations_exceeded_exception.MaxNumberOfRetentionConfigurationsExceededException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_config_service.types.put_retention_configuration_response.PutRetentionConfigurationResponse = capo_config_service.types.put_retention_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_retention_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_retention_configuration(
