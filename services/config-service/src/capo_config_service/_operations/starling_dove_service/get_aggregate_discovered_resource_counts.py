"""Generated from Smithy shape ``com.amazonaws.configservice#GetAggregateDiscoveredResourceCounts``."""
...
def handle_response(
    ...
    out: capo_config_service.types.get_aggregate_discovered_resource_counts_response.GetAggregateDiscoveredResourceCountsResponse = capo_config_service.types.get_aggregate_discovered_resource_counts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetAggregateDiscoveredResourceCounts"
    body: bytes | None = json.dumps(
        capo_config_service.types.get_aggregate_discovered_resource_counts_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_aggregate_discovered_resource_counts(
