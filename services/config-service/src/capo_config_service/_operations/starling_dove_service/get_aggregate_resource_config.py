"""Generated from Smithy shape ``com.amazonaws.configservice#GetAggregateResourceConfig``."""
...
import capo_config_service.errors.oversized_configuration_item_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OversizedConfigurationItemException":
            raise capo_config_service.errors.oversized_configuration_item_exception.OversizedConfigurationItemException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_config_service.types.get_aggregate_resource_config_response.GetAggregateResourceConfigResponse = capo_config_service.types.get_aggregate_resource_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.get_aggregate_resource_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_aggregate_resource_config(
