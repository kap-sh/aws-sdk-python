"""Generated from Smithy shape ``com.amazonaws.configservice#GetOrganizationCustomRulePolicy``."""
...
def handle_response(
    ...
    out: capo_config_service.types.get_organization_custom_rule_policy_response.GetOrganizationCustomRulePolicyResponse = capo_config_service.types.get_organization_custom_rule_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetOrganizationCustomRulePolicy"
    body: bytes | None = json.dumps(
        capo_config_service.types.get_organization_custom_rule_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_organization_custom_rule_policy(
