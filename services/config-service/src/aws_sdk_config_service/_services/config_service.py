...
from aws_sdk_config_service._services._aws_config import aws_config
...
class ConfigServiceClient:
    ...
    def describe_config_rule_evaluation_status(
        ...
        *,
        ...
        r"""<p>Returns status information for each of your Config managed rules. The status includes information such as the last time Config invoked the rule, the last time Config failed to invoke the rule, and the related error for the last failure.</p>
    ...
    def describe_config_rules(
        ...
        *,
        ...
        r"""<p>Returns details about your Config rules.</p>
