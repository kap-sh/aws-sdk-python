"""Generated from Smithy shape ``com.amazonaws.configservice#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.configservice#ValidationException``."""
