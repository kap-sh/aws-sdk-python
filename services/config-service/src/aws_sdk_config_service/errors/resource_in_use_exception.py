"""Generated from Smithy shape ``com.amazonaws.configservice#ResourceInUseException``."""
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.configservice#ResourceInUseException``."""
