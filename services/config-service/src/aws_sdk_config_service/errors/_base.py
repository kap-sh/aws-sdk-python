...
class ConfigServiceError(Exception):
    """Base class for all ConfigService service errors."""


class ServiceError(ConfigServiceError):
...
class SerializationError(ConfigServiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ConfigServiceError):
...
class WaiterFailedError(ConfigServiceError):
...
class WaiterTimeoutError(ConfigServiceError):
