...
def handle_response(
    ...
    out: aws_sdk_config_service.types.put_remediation_exceptions_response.PutRemediationExceptionsResponse = aws_sdk_config_service.types.put_remediation_exceptions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.put_remediation_exceptions_request.PutRemediationExceptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.put_remediation_exceptions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
