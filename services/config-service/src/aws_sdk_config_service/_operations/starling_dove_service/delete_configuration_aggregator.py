"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteConfigurationAggregator``."""
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.delete_configuration_aggregator_request.DeleteConfigurationAggregatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.delete_configuration_aggregator_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_configuration_aggregator(
