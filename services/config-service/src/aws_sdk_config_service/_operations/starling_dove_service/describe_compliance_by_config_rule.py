...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_compliance_by_config_rule_response.DescribeComplianceByConfigRuleResponse = aws_sdk_config_service.types.describe_compliance_by_config_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_compliance_by_config_rule_request.DescribeComplianceByConfigRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_compliance_by_config_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
