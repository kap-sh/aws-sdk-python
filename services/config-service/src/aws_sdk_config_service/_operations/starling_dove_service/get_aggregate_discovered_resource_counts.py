...
def handle_response(
    ...
    out: aws_sdk_config_service.types.get_aggregate_discovered_resource_counts_response.GetAggregateDiscoveredResourceCountsResponse = aws_sdk_config_service.types.get_aggregate_discovered_resource_counts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_aggregate_discovered_resource_counts_request.GetAggregateDiscoveredResourceCountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_aggregate_discovered_resource_counts_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
