"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteConfigurationRecorder``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnmodifiableEntityException":
            import aws_sdk_config_service.errors.unmodifiable_entity_exception

            raise aws_sdk_config_service.errors.unmodifiable_entity_exception.UnmodifiableEntityException.from_aws_json_1_1(
                data
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.delete_configuration_recorder_request.DeleteConfigurationRecorderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.delete_configuration_recorder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_configuration_recorder(
