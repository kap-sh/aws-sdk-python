...
import aws_sdk_config_service.types.evaluation_results
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.get_compliance_details_by_resource_response.GetComplianceDetailsByResourceResponse = aws_sdk_config_service.types.get_compliance_details_by_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_compliance_details_by_resource_request.GetComplianceDetailsByResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_compliance_details_by_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
