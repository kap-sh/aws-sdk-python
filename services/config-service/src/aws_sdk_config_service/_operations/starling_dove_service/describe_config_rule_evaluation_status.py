...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_config_rule_evaluation_status_response.DescribeConfigRuleEvaluationStatusResponse = aws_sdk_config_service.types.describe_config_rule_evaluation_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_config_rule_evaluation_status_request.DescribeConfigRuleEvaluationStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_config_rule_evaluation_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
