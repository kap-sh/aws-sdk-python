"""Generated from Smithy shape ``com.amazonaws.configservice#ListConfigurationRecorders``."""
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.list_configuration_recorders_request.ListConfigurationRecordersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.ListConfigurationRecorders"
    import aws_sdk_config_service.types.list_configuration_recorders_request

    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.list_configuration_recorders_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_configuration_recorders(
