"""Generated from Smithy shape ``com.amazonaws.configservice#StopConfigurationRecorder``."""
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.stop_configuration_recorder_request.StopConfigurationRecorderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.stop_configuration_recorder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_configuration_recorder(
