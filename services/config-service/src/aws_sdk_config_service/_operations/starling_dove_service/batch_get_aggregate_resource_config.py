"""Generated from Smithy shape ``com.amazonaws.configservice#BatchGetAggregateResourceConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.batch_get_aggregate_resource_config_response.BatchGetAggregateResourceConfigResponse = aws_sdk_config_service.types.batch_get_aggregate_resource_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.batch_get_aggregate_resource_config_request.BatchGetAggregateResourceConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.BatchGetAggregateResourceConfig"
    import aws_sdk_config_service.types.batch_get_aggregate_resource_config_request

    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.batch_get_aggregate_resource_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_get_aggregate_resource_config(
