"""Generated from Smithy shape ``com.amazonaws.configservice#PutStoredQuery``."""
...
import aws_sdk_config_service.errors.resource_concurrent_modification_exception
import aws_sdk_config_service.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceConcurrentModificationException":
            raise aws_sdk_config_service.errors.resource_concurrent_modification_exception.ResourceConcurrentModificationException.from_aws_json_1_1(
                data
            )
        case "TooManyTagsException":
            raise aws_sdk_config_service.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.put_stored_query_response.PutStoredQueryResponse = aws_sdk_config_service.types.put_stored_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.put_stored_query_request.PutStoredQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.PutStoredQuery"
    import aws_sdk_config_service.types.put_stored_query_request

    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.put_stored_query_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_stored_query(
