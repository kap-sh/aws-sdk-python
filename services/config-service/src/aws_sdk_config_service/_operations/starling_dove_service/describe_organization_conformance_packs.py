"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeOrganizationConformancePacks``."""
...
import aws_sdk_config_service.errors.no_such_organization_conformance_pack_exception
...
import aws_sdk_config_service.types.organization_conformance_packs
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchOrganizationConformancePackException":
            raise aws_sdk_config_service.errors.no_such_organization_conformance_pack_exception.NoSuchOrganizationConformancePackException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_organization_conformance_packs_response.DescribeOrganizationConformancePacksResponse = aws_sdk_config_service.types.describe_organization_conformance_packs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_organization_conformance_packs_request.DescribeOrganizationConformancePacksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribeOrganizationConformancePacks"
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_organization_conformance_packs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_organization_conformance_packs(
