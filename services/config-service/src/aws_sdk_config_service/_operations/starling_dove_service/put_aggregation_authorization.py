...
def handle_response(
    ...
    out: aws_sdk_config_service.types.put_aggregation_authorization_response.PutAggregationAuthorizationResponse = aws_sdk_config_service.types.put_aggregation_authorization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.put_aggregation_authorization_request.PutAggregationAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.put_aggregation_authorization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
