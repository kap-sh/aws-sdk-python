"""Generated from Smithy shape ``com.amazonaws.configservice#PutExternalEvaluation``."""
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.put_external_evaluation_response.PutExternalEvaluationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.put_external_evaluation_request.PutExternalEvaluationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.PutExternalEvaluation"
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.put_external_evaluation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_external_evaluation(
