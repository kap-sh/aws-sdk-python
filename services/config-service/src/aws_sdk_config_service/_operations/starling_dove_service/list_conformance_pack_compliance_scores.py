...
def handle_response(
    ...
    out: aws_sdk_config_service.types.list_conformance_pack_compliance_scores_response.ListConformancePackComplianceScoresResponse = aws_sdk_config_service.types.list_conformance_pack_compliance_scores_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.list_conformance_pack_compliance_scores_request.ListConformancePackComplianceScoresRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.list_conformance_pack_compliance_scores_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
