...
import aws_sdk_config_service.types.conformance_pack_compliance_summary_list
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.get_conformance_pack_compliance_summary_response.GetConformancePackComplianceSummaryResponse = aws_sdk_config_service.types.get_conformance_pack_compliance_summary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_conformance_pack_compliance_summary_request.GetConformancePackComplianceSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_conformance_pack_compliance_summary_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
