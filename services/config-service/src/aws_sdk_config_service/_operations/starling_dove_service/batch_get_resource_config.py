...
def handle_response(
    ...
    out: aws_sdk_config_service.types.batch_get_resource_config_response.BatchGetResourceConfigResponse = aws_sdk_config_service.types.batch_get_resource_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.batch_get_resource_config_request.BatchGetResourceConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.batch_get_resource_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
