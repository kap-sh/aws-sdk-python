...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResultTokenException":
            import aws_sdk_config_service.errors.invalid_result_token_exception

            raise aws_sdk_config_service.errors.invalid_result_token_exception.InvalidResultTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.put_evaluations_response.PutEvaluationsResponse = aws_sdk_config_service.types.put_evaluations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.put_evaluations_request.PutEvaluationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.put_evaluations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
