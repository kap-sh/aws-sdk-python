"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteResourceConfig``."""
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.delete_resource_config_request.DeleteResourceConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.delete_resource_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_resource_config(
