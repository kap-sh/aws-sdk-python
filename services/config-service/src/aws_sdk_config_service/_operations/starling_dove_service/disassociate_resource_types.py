...
def handle_response(
    ...
    out: aws_sdk_config_service.types.disassociate_resource_types_response.DisassociateResourceTypesResponse = aws_sdk_config_service.types.disassociate_resource_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.disassociate_resource_types_request.DisassociateResourceTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.disassociate_resource_types_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
