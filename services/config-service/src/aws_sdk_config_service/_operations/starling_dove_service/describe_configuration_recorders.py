"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeConfigurationRecorders``."""
...
import aws_sdk_config_service.types.configuration_recorder_list
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_configuration_recorders_response.DescribeConfigurationRecordersResponse = aws_sdk_config_service.types.describe_configuration_recorders_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_configuration_recorders_request.DescribeConfigurationRecordersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_configuration_recorders_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_configuration_recorders(
