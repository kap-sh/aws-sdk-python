"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeDeliveryChannels``."""
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_delivery_channels_response.DescribeDeliveryChannelsResponse = aws_sdk_config_service.types.describe_delivery_channels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_delivery_channels_request.DescribeDeliveryChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_delivery_channels_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_delivery_channels(
