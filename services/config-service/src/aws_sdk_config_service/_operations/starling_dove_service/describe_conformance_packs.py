"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeConformancePacks``."""
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_conformance_packs_response.DescribeConformancePacksResponse = aws_sdk_config_service.types.describe_conformance_packs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_conformance_packs_request.DescribeConformancePacksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_conformance_packs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_conformance_packs(
