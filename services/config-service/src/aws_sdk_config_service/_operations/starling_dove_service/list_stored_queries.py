"""Generated from Smithy shape ``com.amazonaws.configservice#ListStoredQueries``."""
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.list_stored_queries_response.ListStoredQueriesResponse = aws_sdk_config_service.types.list_stored_queries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.list_stored_queries_request.ListStoredQueriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.ListStoredQueries"
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.list_stored_queries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_stored_queries(
