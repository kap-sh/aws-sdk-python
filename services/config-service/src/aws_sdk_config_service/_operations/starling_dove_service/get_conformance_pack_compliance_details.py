...
def handle_response(
    ...
    out: aws_sdk_config_service.types.get_conformance_pack_compliance_details_response.GetConformancePackComplianceDetailsResponse = aws_sdk_config_service.types.get_conformance_pack_compliance_details_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_conformance_pack_compliance_details_request.GetConformancePackComplianceDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_conformance_pack_compliance_details_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
