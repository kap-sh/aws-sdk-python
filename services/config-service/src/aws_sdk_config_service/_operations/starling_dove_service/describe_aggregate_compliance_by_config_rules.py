...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_aggregate_compliance_by_config_rules_response.DescribeAggregateComplianceByConfigRulesResponse = aws_sdk_config_service.types.describe_aggregate_compliance_by_config_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_aggregate_compliance_by_config_rules_request.DescribeAggregateComplianceByConfigRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_aggregate_compliance_by_config_rules_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
