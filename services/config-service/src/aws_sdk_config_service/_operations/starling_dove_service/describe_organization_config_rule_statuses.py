"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeOrganizationConfigRuleStatuses``."""
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_organization_config_rule_statuses_response.DescribeOrganizationConfigRuleStatusesResponse = aws_sdk_config_service.types.describe_organization_config_rule_statuses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_organization_config_rule_statuses_request.DescribeOrganizationConfigRuleStatusesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_organization_config_rule_statuses_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_organization_config_rule_statuses(
