"""Generated from Smithy shape ``com.amazonaws.configservice#GetOrganizationConformancePackDetailedStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.get_organization_conformance_pack_detailed_status_response.GetOrganizationConformancePackDetailedStatusResponse = aws_sdk_config_service.types.get_organization_conformance_pack_detailed_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_organization_conformance_pack_detailed_status_request.GetOrganizationConformancePackDetailedStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_organization_conformance_pack_detailed_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_organization_conformance_pack_detailed_status(
