...
def handle_response(
    ...
    out: aws_sdk_config_service.types.put_service_linked_configuration_recorder_response.PutServiceLinkedConfigurationRecorderResponse = aws_sdk_config_service.types.put_service_linked_configuration_recorder_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.put_service_linked_configuration_recorder_request.PutServiceLinkedConfigurationRecorderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
