"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteServiceLinkedConfigurationRecorder``."""
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.delete_service_linked_configuration_recorder_response.DeleteServiceLinkedConfigurationRecorderResponse = aws_sdk_config_service.types.delete_service_linked_configuration_recorder_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.delete_service_linked_configuration_recorder_request.DeleteServiceLinkedConfigurationRecorderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_service_linked_configuration_recorder(
