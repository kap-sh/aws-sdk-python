"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeRetentionConfigurations``."""
...
import aws_sdk_config_service.errors.no_such_retention_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchRetentionConfigurationException":
            raise aws_sdk_config_service.errors.no_such_retention_configuration_exception.NoSuchRetentionConfigurationException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_retention_configurations_response.DescribeRetentionConfigurationsResponse = aws_sdk_config_service.types.describe_retention_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_retention_configurations_request.DescribeRetentionConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribeRetentionConfigurations"
    import aws_sdk_config_service.types.describe_retention_configurations_request

    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_retention_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_retention_configurations(
