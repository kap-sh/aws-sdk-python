...
def handle_response(
    ...
    out: aws_sdk_config_service.types.get_compliance_summary_by_resource_type_response.GetComplianceSummaryByResourceTypeResponse = aws_sdk_config_service.types.get_compliance_summary_by_resource_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_compliance_summary_by_resource_type_request.GetComplianceSummaryByResourceTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_compliance_summary_by_resource_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
