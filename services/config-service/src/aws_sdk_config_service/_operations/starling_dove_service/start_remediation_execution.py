"""Generated from Smithy shape ``com.amazonaws.configservice#StartRemediationExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.start_remediation_execution_response.StartRemediationExecutionResponse = aws_sdk_config_service.types.start_remediation_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.start_remediation_execution_request.StartRemediationExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.start_remediation_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_remediation_execution(
