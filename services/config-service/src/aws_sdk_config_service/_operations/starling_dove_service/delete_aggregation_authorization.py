"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteAggregationAuthorization``."""
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.delete_aggregation_authorization_request.DeleteAggregationAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DeleteAggregationAuthorization"
    import aws_sdk_config_service.types.delete_aggregation_authorization_request

    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.delete_aggregation_authorization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_aggregation_authorization(
