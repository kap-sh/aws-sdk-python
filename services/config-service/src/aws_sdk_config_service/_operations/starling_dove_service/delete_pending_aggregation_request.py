...
def build_request(
    ...
    input_: aws_sdk_config_service.types.delete_pending_aggregation_request_request.DeletePendingAggregationRequestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.delete_pending_aggregation_request_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
