...
def handle_response(
    ...
    out: aws_sdk_config_service.types.delete_evaluation_results_response.DeleteEvaluationResultsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.delete_evaluation_results_request.DeleteEvaluationResultsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.delete_evaluation_results_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
