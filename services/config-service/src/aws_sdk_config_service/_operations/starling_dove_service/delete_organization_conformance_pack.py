...
def build_request(
    ...
    input_: aws_sdk_config_service.types.delete_organization_conformance_pack_request.DeleteOrganizationConformancePackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.delete_organization_conformance_pack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
