"""Generated from Smithy shape ``com.amazonaws.configservice#DescribePendingAggregationRequests``."""
...
import aws_sdk_config_service.types.pending_aggregation_request_list
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_pending_aggregation_requests_response.DescribePendingAggregationRequestsResponse = aws_sdk_config_service.types.describe_pending_aggregation_requests_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_pending_aggregation_requests_request.DescribePendingAggregationRequestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribePendingAggregationRequests"
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_pending_aggregation_requests_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_pending_aggregation_requests(
