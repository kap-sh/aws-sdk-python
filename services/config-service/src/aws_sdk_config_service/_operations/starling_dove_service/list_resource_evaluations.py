...
def handle_response(
    ...
    out: aws_sdk_config_service.types.list_resource_evaluations_response.ListResourceEvaluationsResponse = aws_sdk_config_service.types.list_resource_evaluations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.list_resource_evaluations_request.ListResourceEvaluationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.list_resource_evaluations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
