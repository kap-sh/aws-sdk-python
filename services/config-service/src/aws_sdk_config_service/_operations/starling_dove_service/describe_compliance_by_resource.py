...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_compliance_by_resource_response.DescribeComplianceByResourceResponse = aws_sdk_config_service.types.describe_compliance_by_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_compliance_by_resource_request.DescribeComplianceByResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_compliance_by_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
