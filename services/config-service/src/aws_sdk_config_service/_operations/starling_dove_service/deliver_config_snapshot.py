...
def handle_response(
    ...
    out: aws_sdk_config_service.types.deliver_config_snapshot_response.DeliverConfigSnapshotResponse = aws_sdk_config_service.types.deliver_config_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.deliver_config_snapshot_request.DeliverConfigSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.deliver_config_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
