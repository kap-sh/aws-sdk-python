...
def handle_response(
    ...
    out: aws_sdk_config_service.types.start_config_rules_evaluation_response.StartConfigRulesEvaluationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.start_config_rules_evaluation_request.StartConfigRulesEvaluationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.start_config_rules_evaluation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
