...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_aggregate_compliance_by_conformance_packs_response.DescribeAggregateComplianceByConformancePacksResponse = aws_sdk_config_service.types.describe_aggregate_compliance_by_conformance_packs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_aggregate_compliance_by_conformance_packs_request.DescribeAggregateComplianceByConformancePacksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
