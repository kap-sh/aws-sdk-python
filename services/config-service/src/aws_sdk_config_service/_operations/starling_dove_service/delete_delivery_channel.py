"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteDeliveryChannel``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "LastDeliveryChannelDeleteFailedException":
            import aws_sdk_config_service.errors.last_delivery_channel_delete_failed_exception

            raise aws_sdk_config_service.errors.last_delivery_channel_delete_failed_exception.LastDeliveryChannelDeleteFailedException.from_aws_json_1_1(
                data
            )
        case "NoSuchDeliveryChannelException":
            import aws_sdk_config_service.errors.no_such_delivery_channel_exception

            raise aws_sdk_config_service.errors.no_such_delivery_channel_exception.NoSuchDeliveryChannelException.from_aws_json_1_1(
                data
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.delete_delivery_channel_request.DeleteDeliveryChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.delete_delivery_channel_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_delivery_channel(
