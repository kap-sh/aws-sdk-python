...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_configuration_aggregator_sources_status_response.DescribeConfigurationAggregatorSourcesStatusResponse = aws_sdk_config_service.types.describe_configuration_aggregator_sources_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_configuration_aggregator_sources_status_request.DescribeConfigurationAggregatorSourcesStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_configuration_aggregator_sources_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
