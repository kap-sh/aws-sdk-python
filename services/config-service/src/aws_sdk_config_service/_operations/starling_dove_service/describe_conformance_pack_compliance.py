...
import aws_sdk_config_service.errors.no_such_config_rule_in_conformance_pack_exception
import aws_sdk_config_service.errors.no_such_conformance_pack_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchConfigRuleInConformancePackException":
            raise aws_sdk_config_service.errors.no_such_config_rule_in_conformance_pack_exception.NoSuchConfigRuleInConformancePackException.from_aws_json_1_1(
                data
            )
        case "NoSuchConformancePackException":
            raise aws_sdk_config_service.errors.no_such_conformance_pack_exception.NoSuchConformancePackException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_conformance_pack_compliance_response.DescribeConformancePackComplianceResponse = aws_sdk_config_service.types.describe_conformance_pack_compliance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_conformance_pack_compliance_request.DescribeConformancePackComplianceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_conformance_pack_compliance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
