...
def handle_response(
    ...
    out: aws_sdk_config_service.types.list_aggregate_discovered_resources_response.ListAggregateDiscoveredResourcesResponse = aws_sdk_config_service.types.list_aggregate_discovered_resources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.list_aggregate_discovered_resources_request.ListAggregateDiscoveredResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.list_aggregate_discovered_resources_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
