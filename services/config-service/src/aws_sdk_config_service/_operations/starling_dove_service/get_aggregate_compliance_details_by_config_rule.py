...
def handle_response(
    ...
    out: aws_sdk_config_service.types.get_aggregate_compliance_details_by_config_rule_response.GetAggregateComplianceDetailsByConfigRuleResponse = aws_sdk_config_service.types.get_aggregate_compliance_details_by_config_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_aggregate_compliance_details_by_config_rule_request.GetAggregateComplianceDetailsByConfigRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_aggregate_compliance_details_by_config_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
