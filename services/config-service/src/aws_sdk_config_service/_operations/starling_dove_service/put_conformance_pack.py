"""Generated from Smithy shape ``com.amazonaws.configservice#PutConformancePack``."""
...
import aws_sdk_config_service.errors.conformance_pack_template_validation_exception
...
import aws_sdk_config_service.errors.max_number_of_conformance_packs_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConformancePackTemplateValidationException":
            raise aws_sdk_config_service.errors.conformance_pack_template_validation_exception.ConformancePackTemplateValidationException.from_aws_json_1_1(
                data
            )
        ...
        case "MaxNumberOfConformancePacksExceededException":
            raise aws_sdk_config_service.errors.max_number_of_conformance_packs_exceeded_exception.MaxNumberOfConformancePacksExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.put_conformance_pack_response.PutConformancePackResponse = aws_sdk_config_service.types.put_conformance_pack_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.put_conformance_pack_request.PutConformancePackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_put_conformance_pack(
