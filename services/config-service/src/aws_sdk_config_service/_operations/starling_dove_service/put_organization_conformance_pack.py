"""Generated from Smithy shape ``com.amazonaws.configservice#PutOrganizationConformancePack``."""
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.put_organization_conformance_pack_request.PutOrganizationConformancePackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.PutOrganizationConformancePack"
    import aws_sdk_config_service.types.put_organization_conformance_pack_request

    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.put_organization_conformance_pack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_organization_conformance_pack(
