...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_aggregation_authorizations_response.DescribeAggregationAuthorizationsResponse = aws_sdk_config_service.types.describe_aggregation_authorizations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_aggregation_authorizations_request.DescribeAggregationAuthorizationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_aggregation_authorizations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
