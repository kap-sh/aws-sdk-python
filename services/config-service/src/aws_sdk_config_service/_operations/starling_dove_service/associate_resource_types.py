"""Generated from Smithy shape ``com.amazonaws.configservice#AssociateResourceTypes``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            import aws_sdk_config_service.errors.conflict_exception

            raise aws_sdk_config_service.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        case "NoSuchConfigurationRecorderException":
            import aws_sdk_config_service.errors.no_such_configuration_recorder_exception

            raise aws_sdk_config_service.errors.no_such_configuration_recorder_exception.NoSuchConfigurationRecorderException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.associate_resource_types_response.AssociateResourceTypesResponse = aws_sdk_config_service.types.associate_resource_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.associate_resource_types_request.AssociateResourceTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.AssociateResourceTypes"
    import aws_sdk_config_service.types.associate_resource_types_request

    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.associate_resource_types_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_resource_types(
