...
def build_request(
    ...
    input_: aws_sdk_config_service.types.put_config_rule_request.PutConfigRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.put_config_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
