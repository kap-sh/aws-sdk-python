...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidConfigurationRecorderNameException":
            import aws_sdk_config_service.errors.invalid_configuration_recorder_name_exception

            raise aws_sdk_config_service.errors.invalid_configuration_recorder_name_exception.InvalidConfigurationRecorderNameException.from_aws_json_1_1(
                data
            )
        case "InvalidRecordingGroupException":
            import aws_sdk_config_service.errors.invalid_recording_group_exception

            raise aws_sdk_config_service.errors.invalid_recording_group_exception.InvalidRecordingGroupException.from_aws_json_1_1(
                data
            )
        ...
        case "MaxNumberOfConfigurationRecordersExceededException":
            import aws_sdk_config_service.errors.max_number_of_configuration_recorders_exceeded_exception

            raise aws_sdk_config_service.errors.max_number_of_configuration_recorders_exceeded_exception.MaxNumberOfConfigurationRecordersExceededException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.put_configuration_recorder_request.PutConfigurationRecorderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.put_configuration_recorder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
