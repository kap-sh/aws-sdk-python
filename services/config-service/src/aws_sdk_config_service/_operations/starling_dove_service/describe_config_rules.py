...
import aws_sdk_config_service.errors.no_such_config_rule_exception
import aws_sdk_config_service.types.config_rule_names
import aws_sdk_config_service.types.config_rules
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchConfigRuleException":
            raise aws_sdk_config_service.errors.no_such_config_rule_exception.NoSuchConfigRuleException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.describe_config_rules_response.DescribeConfigRulesResponse = aws_sdk_config_service.types.describe_config_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.describe_config_rules_request.DescribeConfigRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.describe_config_rules_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
