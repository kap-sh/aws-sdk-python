"""Generated from Smithy shape ``com.amazonaws.configservice#GetResourceEvaluationSummary``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceNotFoundException":
            import aws_sdk_config_service.errors.resource_not_found_exception

            raise aws_sdk_config_service.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.get_resource_evaluation_summary_response.GetResourceEvaluationSummaryResponse = aws_sdk_config_service.types.get_resource_evaluation_summary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_resource_evaluation_summary_request.GetResourceEvaluationSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetResourceEvaluationSummary"
    import aws_sdk_config_service.types.get_resource_evaluation_summary_request

    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_resource_evaluation_summary_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_resource_evaluation_summary(
