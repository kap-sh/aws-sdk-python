"""Generated from Smithy shape ``com.amazonaws.configservice#GetOrganizationConfigRuleDetailedStatus``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchOrganizationConfigRuleException":
            import aws_sdk_config_service.errors.no_such_organization_config_rule_exception

            raise aws_sdk_config_service.errors.no_such_organization_config_rule_exception.NoSuchOrganizationConfigRuleException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.get_organization_config_rule_detailed_status_response.GetOrganizationConfigRuleDetailedStatusResponse = aws_sdk_config_service.types.get_organization_config_rule_detailed_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_organization_config_rule_detailed_status_request.GetOrganizationConfigRuleDetailedStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_organization_config_rule_detailed_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_organization_config_rule_detailed_status(
