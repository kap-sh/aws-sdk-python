...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_aggregate_resource_config_request.GetAggregateResourceConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_aggregate_resource_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
