...
def handle_response(
    ...
    out: aws_sdk_config_service.types.get_organization_custom_rule_policy_response.GetOrganizationCustomRulePolicyResponse = aws_sdk_config_service.types.get_organization_custom_rule_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.get_organization_custom_rule_policy_request.GetOrganizationCustomRulePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.get_organization_custom_rule_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
