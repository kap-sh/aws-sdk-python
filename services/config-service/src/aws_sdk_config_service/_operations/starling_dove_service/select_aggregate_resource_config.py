...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidExpressionException":
            import aws_sdk_config_service.errors.invalid_expression_exception

            raise aws_sdk_config_service.errors.invalid_expression_exception.InvalidExpressionException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.select_aggregate_resource_config_response.SelectAggregateResourceConfigResponse = aws_sdk_config_service.types.select_aggregate_resource_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.select_aggregate_resource_config_request.SelectAggregateResourceConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.select_aggregate_resource_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
