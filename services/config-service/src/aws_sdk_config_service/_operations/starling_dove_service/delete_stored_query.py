...
def handle_response(
    ...
    out: aws_sdk_config_service.types.delete_stored_query_response.DeleteStoredQueryResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.delete_stored_query_request.DeleteStoredQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.delete_stored_query_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
