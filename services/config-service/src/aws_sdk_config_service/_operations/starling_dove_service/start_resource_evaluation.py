...
import aws_sdk_config_service.errors.idempotent_parameter_mismatch
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "IdempotentParameterMismatch":
            raise aws_sdk_config_service.errors.idempotent_parameter_mismatch.IdempotentParameterMismatch.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_config_service.types.start_resource_evaluation_response.StartResourceEvaluationResponse = aws_sdk_config_service.types.start_resource_evaluation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_config_service.types.start_resource_evaluation_request.StartResourceEvaluationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_config_service.types.start_resource_evaluation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
