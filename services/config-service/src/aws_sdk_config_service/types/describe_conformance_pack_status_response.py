...
if TYPE_CHECKING:
    import aws_sdk_config_service.types.conformance_pack_status_details_list
    import aws_sdk_config_service.types.next_token


class DescribeConformancePackStatusResponse(TypedDict):
    conformance_pack_status_details: NotRequired[
        "aws_sdk_config_service.types.conformance_pack_status_details_list.ConformancePackStatusDetailsList"
    ]
...
def serialize_aws_json_1_1(value: DescribeConformancePackStatusResponse) -> dict:
    ...
    if "conformance_pack_status_details" in value:
        ...
        out["ConformancePackStatusDetails"] = (
            aws_sdk_config_service.types.conformance_pack_status_details_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeConformancePackStatusResponse:
    ...
    if "ConformancePackStatusDetails" in data:
        ...
        out["conformance_pack_status_details"] = (
            aws_sdk_config_service.types.conformance_pack_status_details_list.deserialize_aws_json_1_1(
