...
ConfigurationRecorderSummaries: TypeAlias = list[
    "aws_sdk_config_service.types.configuration_recorder_summary.ConfigurationRecorderSummary"
]
...
def serialize_aws_json_1_1(value: ConfigurationRecorderSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_config_service.types.configuration_recorder_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ConfigurationRecorderSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_config_service.types.configuration_recorder_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
