...
def serialize_aws_json_1_1(value: RecordingStrategy) -> dict:
    ...
    if "use_only" in value:
        ...
        out["useOnly"] = (
            aws_sdk_config_service.types.recording_strategy_type.serialize_aws_json_1_1(
                value["use_only"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> RecordingStrategy:
    ...
    if "useOnly" in data:
        ...
        out["use_only"] = (
            aws_sdk_config_service.types.recording_strategy_type.deserialize_aws_json_1_1(
                data["useOnly"]
            )
        )
    return out
