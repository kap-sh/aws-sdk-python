...
def serialize_aws_json_1_1(value: GetAggregateDiscoveredResourceCountsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_config_service.types.resource_count_filters.serialize_aws_json_1_1(
                value["filters"]
            )
        )
    if "group_by_key" in value:
        ...
        out["GroupByKey"] = (
            aws_sdk_config_service.types.resource_count_group_key.serialize_aws_json_1_1(
                value["group_by_key"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetAggregateDiscoveredResourceCountsRequest:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_config_service.types.resource_count_filters.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
    if "GroupByKey" in data:
        ...
        out["group_by_key"] = (
            aws_sdk_config_service.types.resource_count_group_key.deserialize_aws_json_1_1(
                data["GroupByKey"]
            )
        )
    if "Limit" in data:
