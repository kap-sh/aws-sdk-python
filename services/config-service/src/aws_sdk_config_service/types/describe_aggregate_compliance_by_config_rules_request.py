...
class DescribeAggregateComplianceByConfigRulesRequest(TypedDict):
    ...
    limit: "aws_sdk_config_service.types.group_by_api_limit.GroupByAPILimit"
...
def serialize_aws_json_1_1(
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_config_service.types.config_rule_compliance_filters.serialize_aws_json_1_1(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_1(
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_config_service.types.config_rule_compliance_filters.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
    if "Limit" in data:
