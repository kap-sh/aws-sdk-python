...
if TYPE_CHECKING:
    import aws_sdk_config_service.types.compliance_by_config_rules
    import aws_sdk_config_service.types.string


class DescribeComplianceByConfigRuleResponse(TypedDict):
    compliance_by_config_rules: NotRequired[
        "aws_sdk_config_service.types.compliance_by_config_rules.ComplianceByConfigRules"
    ]
...
def serialize_aws_json_1_1(value: DescribeComplianceByConfigRuleResponse) -> dict:
    ...
    if "compliance_by_config_rules" in value:
        ...
        out["ComplianceByConfigRules"] = (
            aws_sdk_config_service.types.compliance_by_config_rules.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeComplianceByConfigRuleResponse:
    ...
    if "ComplianceByConfigRules" in data:
        ...
        out["compliance_by_config_rules"] = (
            aws_sdk_config_service.types.compliance_by_config_rules.deserialize_aws_json_1_1(
