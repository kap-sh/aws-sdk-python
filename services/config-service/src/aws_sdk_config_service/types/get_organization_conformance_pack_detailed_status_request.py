...
class GetOrganizationConformancePackDetailedStatusRequest(TypedDict):
...
def serialize_aws_json_1_1(
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_config_service.types.organization_resource_detailed_status_filters.serialize_aws_json_1_1(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_1(
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_config_service.types.organization_resource_detailed_status_filters.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
    if "Limit" in data:
