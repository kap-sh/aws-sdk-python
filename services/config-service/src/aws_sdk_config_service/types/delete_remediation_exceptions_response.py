...
class DeleteRemediationExceptionsResponse(TypedDict):
    failed_batches: NotRequired[
        "aws_sdk_config_service.types.failed_delete_remediation_exceptions_batches.FailedDeleteRemediationExceptionsBatches"
    ]
...
def serialize_aws_json_1_1(value: DeleteRemediationExceptionsResponse) -> dict:
    ...
    if "failed_batches" in value:
        ...
        out["FailedBatches"] = (
            aws_sdk_config_service.types.failed_delete_remediation_exceptions_batches.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DeleteRemediationExceptionsResponse:
    ...
    if "FailedBatches" in data:
        ...
        out["failed_batches"] = (
            aws_sdk_config_service.types.failed_delete_remediation_exceptions_batches.deserialize_aws_json_1_1(
                data["FailedBatches"]
            )
        )
    return out
