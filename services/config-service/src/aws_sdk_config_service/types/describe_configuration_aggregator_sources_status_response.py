...
def serialize_aws_json_1_1(
    ...
    if "aggregated_source_status_list" in value:
        ...
        out["AggregatedSourceStatusList"] = (
            aws_sdk_config_service.types.aggregated_source_status_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "AggregatedSourceStatusList" in data:
        ...
        out["aggregated_source_status_list"] = (
            aws_sdk_config_service.types.aggregated_source_status_list.deserialize_aws_json_1_1(
