...
AggregateEvaluationResultList: TypeAlias = list[
    "aws_sdk_config_service.types.aggregate_evaluation_result.AggregateEvaluationResult"
]
...
def serialize_aws_json_1_1(value: AggregateEvaluationResultList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_config_service.types.aggregate_evaluation_result.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AggregateEvaluationResultList:
    ...
    for item in data:
        out.append(
            aws_sdk_config_service.types.aggregate_evaluation_result.deserialize_aws_json_1_1(
                item
            )
        )
    return out
