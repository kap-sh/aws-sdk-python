...
class DescribeConformancePackComplianceRequest(TypedDict):
    ...
    limit: "aws_sdk_config_service.types.describe_conformance_pack_compliance_limit.DescribeConformancePackComplianceLimit"
...
def serialize_aws_json_1_1(value: DescribeConformancePackComplianceRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_config_service.types.conformance_pack_compliance_filters.serialize_aws_json_1_1(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeConformancePackComplianceRequest:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_config_service.types.conformance_pack_compliance_filters.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
    if "Limit" in data:
