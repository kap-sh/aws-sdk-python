...
class OrganizationResourceDetailedStatusFilters(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_config_service.types.organization_resource_detailed_status.OrganizationResourceDetailedStatus"
    ]
