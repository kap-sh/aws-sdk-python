...
if TYPE_CHECKING:
    import aws_sdk_config_service.types.aggregate_compliance_by_config_rule_list
    import aws_sdk_config_service.types.next_token


class DescribeAggregateComplianceByConfigRulesResponse(TypedDict):
    aggregate_compliance_by_config_rules: NotRequired[
        "aws_sdk_config_service.types.aggregate_compliance_by_config_rule_list.AggregateComplianceByConfigRuleList"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "aggregate_compliance_by_config_rules" in value:
        ...
        out["AggregateComplianceByConfigRules"] = (
            aws_sdk_config_service.types.aggregate_compliance_by_config_rule_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "AggregateComplianceByConfigRules" in data:
        ...
        out["aggregate_compliance_by_config_rules"] = (
            aws_sdk_config_service.types.aggregate_compliance_by_config_rule_list.deserialize_aws_json_1_1(
