...
EvaluationResults: TypeAlias = list[
    "aws_sdk_config_service.types.evaluation_result.EvaluationResult"
]
...
def serialize_aws_json_1_1(value: EvaluationResults) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_config_service.types.evaluation_result.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> EvaluationResults:
    ...
    for item in data:
        out.append(
            aws_sdk_config_service.types.evaluation_result.deserialize_aws_json_1_1(
                item
            )
        )
    return out
