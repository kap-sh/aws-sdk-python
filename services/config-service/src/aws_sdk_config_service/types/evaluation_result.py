...
class EvaluationResult(TypedDict, closed=True):
    evaluation_result_identifier: NotRequired[
        "aws_sdk_config_service.types.evaluation_result_identifier.EvaluationResultIdentifier"
    ]
    ...
    result_recorded_time: NotRequired["aws_sdk_config_service.types.date.Date"]
    """<p>The time when Config recorded the evaluation result.</p>"""
    config_rule_invoked_time: NotRequired["aws_sdk_config_service.types.date.Date"]
    ...
    result_token: NotRequired["aws_sdk_config_service.types.string.String"]
