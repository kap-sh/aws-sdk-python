...
if TYPE_CHECKING:
    ...
    import aws_sdk_config_service.types.recording_group
    import aws_sdk_config_service.types.recording_mode
...
class ConfigurationRecorder(TypedDict):
    arn: NotRequired[
    ...
    recording_mode: NotRequired[
        "aws_sdk_config_service.types.recording_mode.RecordingMode"
    ]
    ...
    recording_scope: NotRequired[
        "aws_sdk_config_service.types.recording_scope.RecordingScope"
    ]
...
def serialize_aws_json_1_1(value: ConfigurationRecorder) -> dict:
    ...
    if "recording_group" in value:
        ...
        out["recordingGroup"] = (
            aws_sdk_config_service.types.recording_group.serialize_aws_json_1_1(
    ...
    if "recording_mode" in value:
        ...
        out["recordingMode"] = (
            aws_sdk_config_service.types.recording_mode.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ConfigurationRecorder:
    ...
    if "recordingGroup" in data:
        ...
        out["recording_group"] = (
            aws_sdk_config_service.types.recording_group.deserialize_aws_json_1_1(
                data["recordingGroup"]
            )
        )
    if "recordingMode" in data:
        ...
        out["recording_mode"] = (
            aws_sdk_config_service.types.recording_mode.deserialize_aws_json_1_1(
                data["recordingMode"]
            )
        )
