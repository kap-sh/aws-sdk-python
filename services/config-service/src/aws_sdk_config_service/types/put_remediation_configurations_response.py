...
class PutRemediationConfigurationsResponse(TypedDict):
    failed_batches: NotRequired[
        "aws_sdk_config_service.types.failed_remediation_batches.FailedRemediationBatches"
    ]
...
def serialize_aws_json_1_1(value: PutRemediationConfigurationsResponse) -> dict:
    ...
    if "failed_batches" in value:
        ...
        out["FailedBatches"] = (
            aws_sdk_config_service.types.failed_remediation_batches.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> PutRemediationConfigurationsResponse:
    ...
    if "FailedBatches" in data:
        ...
        out["failed_batches"] = (
            aws_sdk_config_service.types.failed_remediation_batches.deserialize_aws_json_1_1(
                data["FailedBatches"]
            )
        )
    return out
