...
class DescribeConfigRulesResponse(TypedDict):
    config_rules: NotRequired["aws_sdk_config_service.types.config_rules.ConfigRules"]
...
def serialize_aws_json_1_1(value: DescribeConfigRulesResponse) -> dict:
    ...
    if "config_rules" in value:
        ...
        out["ConfigRules"] = (
            aws_sdk_config_service.types.config_rules.serialize_aws_json_1_1(
                value["config_rules"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeConfigRulesResponse:
    ...
    if "ConfigRules" in data:
        ...
        out["config_rules"] = (
            aws_sdk_config_service.types.config_rules.deserialize_aws_json_1_1(
                data["ConfigRules"]
            )
        )
