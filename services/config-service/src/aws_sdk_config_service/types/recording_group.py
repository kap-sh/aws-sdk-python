...
if TYPE_CHECKING:
    ...
    import aws_sdk_config_service.types.exclusion_by_resource_types
    import aws_sdk_config_service.types.include_global_resource_types
    import aws_sdk_config_service.types.recording_strategy
...
class RecordingGroup(TypedDict, closed=True):
    ...
    exclusion_by_resource_types: NotRequired[
        "aws_sdk_config_service.types.exclusion_by_resource_types.ExclusionByResourceTypes"
    ]
    ...
    recording_strategy: NotRequired[
        "aws_sdk_config_service.types.recording_strategy.RecordingStrategy"
    ]
...
def serialize_aws_json_1_1(value: RecordingGroup) -> dict:
    ...
    if "exclusion_by_resource_types" in value:
        ...
        out["exclusionByResourceTypes"] = (
            aws_sdk_config_service.types.exclusion_by_resource_types.serialize_aws_json_1_1(
    ...
    if "recording_strategy" in value:
        ...
        out["recordingStrategy"] = (
            aws_sdk_config_service.types.recording_strategy.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RecordingGroup:
    ...
    if "exclusionByResourceTypes" in data:
        ...
        out["exclusion_by_resource_types"] = (
            aws_sdk_config_service.types.exclusion_by_resource_types.deserialize_aws_json_1_1(
    ...
    if "recordingStrategy" in data:
        ...
        out["recording_strategy"] = (
            aws_sdk_config_service.types.recording_strategy.deserialize_aws_json_1_1(
