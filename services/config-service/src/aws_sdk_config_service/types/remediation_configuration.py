...
if TYPE_CHECKING:
    import aws_sdk_config_service.types.auto_remediation_attempt_seconds
    import aws_sdk_config_service.types.auto_remediation_attempts
    import aws_sdk_config_service.types.boolean
    import aws_sdk_config_service.types.config_rule_name
    import aws_sdk_config_service.types.execution_controls
    import aws_sdk_config_service.types.remediation_parameters
    import aws_sdk_config_service.types.remediation_target_type
...
class RemediationConfiguration(TypedDict):
    config_rule_name: "aws_sdk_config_service.types.config_rule_name.ConfigRuleName"
    """<p>The name of the Config rule.</p>"""
    target_type: (
        "aws_sdk_config_service.types.remediation_target_type.RemediationTargetType"
    )
    ...
    target_version: NotRequired["aws_sdk_config_service.types.string.String"]
    ...
    parameters: NotRequired[
        "aws_sdk_config_service.types.remediation_parameters.RemediationParameters"
    ]
    """<p>An object of the RemediationParameterValue.</p>"""
    resource_type: NotRequired["aws_sdk_config_service.types.string.String"]
    """<p>The type of a resource. </p>"""
    automatic: "aws_sdk_config_service.types.boolean.Boolean"
    """<p>The remediation is triggered automatically.</p>"""
    execution_controls: NotRequired[
        "aws_sdk_config_service.types.execution_controls.ExecutionControls"
    ]
    """<p>An ExecutionControls object.</p>"""
    maximum_automatic_attempts: NotRequired[
        "aws_sdk_config_service.types.auto_remediation_attempts.AutoRemediationAttempts"
    ]
    ...
    retry_attempt_seconds: NotRequired[
        "aws_sdk_config_service.types.auto_remediation_attempt_seconds.AutoRemediationAttemptSeconds"
    ]
...
def serialize_aws_json_1_1(value: RemediationConfiguration) -> dict:
    ...
    out["TargetType"] = (
        aws_sdk_config_service.types.remediation_target_type.serialize_aws_json_1_1(
            value["target_type"]
        )
    )
    ...
    if "parameters" in value:
        ...
        out["Parameters"] = (
            aws_sdk_config_service.types.remediation_parameters.serialize_aws_json_1_1(
                value["parameters"]
            )
        )
    ...
    if "execution_controls" in value:
        ...
        out["ExecutionControls"] = (
            aws_sdk_config_service.types.execution_controls.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RemediationConfiguration:
    ...
    if "TargetType" in data:
        ...
        out["target_type"] = (
            aws_sdk_config_service.types.remediation_target_type.deserialize_aws_json_1_1(
                data["TargetType"]
            )
        )
    else:
    ...
    if "Parameters" in data:
        ...
        out["parameters"] = (
            aws_sdk_config_service.types.remediation_parameters.deserialize_aws_json_1_1(
                data["Parameters"]
            )
        )
    ...
    if "ExecutionControls" in data:
        ...
        out["execution_controls"] = (
            aws_sdk_config_service.types.execution_controls.deserialize_aws_json_1_1(
