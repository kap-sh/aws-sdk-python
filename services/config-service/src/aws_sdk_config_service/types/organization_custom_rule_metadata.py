...
if TYPE_CHECKING:
    ...
    import aws_sdk_config_service.types.organization_config_rule_trigger_types
...
class OrganizationCustomRuleMetadata(TypedDict):
    ...
    organization_config_rule_trigger_types: "aws_sdk_config_service.types.organization_config_rule_trigger_types.OrganizationConfigRuleTriggerTypes"
...
def serialize_aws_json_1_1(value: OrganizationCustomRuleMetadata) -> dict:
    ...
    out["OrganizationConfigRuleTriggerTypes"] = (
        aws_sdk_config_service.types.organization_config_rule_trigger_types.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OrganizationCustomRuleMetadata:
    ...
    if "OrganizationConfigRuleTriggerTypes" in data:
        ...
        out["organization_config_rule_trigger_types"] = (
            aws_sdk_config_service.types.organization_config_rule_trigger_types.deserialize_aws_json_1_1(
