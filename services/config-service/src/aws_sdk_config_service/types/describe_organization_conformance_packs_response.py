...
class DescribeOrganizationConformancePacksResponse(TypedDict):
    organization_conformance_packs: NotRequired[
        "aws_sdk_config_service.types.organization_conformance_packs.OrganizationConformancePacks"
    ]
...
def serialize_aws_json_1_1(value: DescribeOrganizationConformancePacksResponse) -> dict:
    ...
    if "organization_conformance_packs" in value:
        ...
        out["OrganizationConformancePacks"] = (
            aws_sdk_config_service.types.organization_conformance_packs.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "OrganizationConformancePacks" in data:
        ...
        out["organization_conformance_packs"] = (
            aws_sdk_config_service.types.organization_conformance_packs.deserialize_aws_json_1_1(
