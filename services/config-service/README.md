...
```
pip install aws-sdk-config-service
```

## Usage

```python
from aws_sdk_config_service import AsyncConfigServiceClient
...
```python
from aws_sdk_config_service import AsyncConfigServiceClient
from aws_sdk_config_service.error import ConflictException
