"""Generated from Smithy shape ``com.amazonaws.aiops#CreateInvestigationGroup``."""
...
import capo_aiops.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_aiops.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_aiops.types.create_investigation_group_output.CreateInvestigationGroupOutput = capo_aiops.types.create_investigation_group_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_aiops.types.create_investigation_group_input.serialize_json(input_)
    ).encode()
...
async def async_create_investigation_group(
