"""Generated from Smithy shape ``com.amazonaws.aiops#UpdateInvestigationGroup``."""
...
def handle_response(
    ...
    out: capo_aiops.types.update_investigation_group_output.UpdateInvestigationGroupOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_aiops.types.update_investigation_group_request.serialize_json(input_)
    ).encode()
...
async def async_update_investigation_group(
