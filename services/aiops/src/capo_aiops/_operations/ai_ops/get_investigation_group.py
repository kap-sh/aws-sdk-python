"""Generated from Smithy shape ``com.amazonaws.aiops#GetInvestigationGroup``."""
...
def handle_response(
    ...
    out: capo_aiops.types.get_investigation_group_response.GetInvestigationGroupResponse = capo_aiops.types.get_investigation_group_response.deserialize_json(
...
async def async_get_investigation_group(
