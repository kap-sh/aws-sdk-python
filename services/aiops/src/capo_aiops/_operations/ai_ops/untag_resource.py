...
def handle_response(
    ...
    out: capo_aiops.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_aiops.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
