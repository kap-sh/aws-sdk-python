"""Generated from Smithy shape ``com.amazonaws.aiops#GetInvestigationGroupPolicy``."""
...
def handle_response(
    ...
    out: capo_aiops.types.get_investigation_group_policy_response.GetInvestigationGroupPolicyResponse = capo_aiops.types.get_investigation_group_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/investigationGroups/{identifier}/policy"
...
async def async_get_investigation_group_policy(
