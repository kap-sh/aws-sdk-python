"""Generated from Smithy shape ``com.amazonaws.aiops#DeleteInvestigationGroupPolicy``."""
...
def handle_response(
    ...
    out: capo_aiops.types.delete_investigation_group_policy_output.DeleteInvestigationGroupPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_investigation_group_policy(
