"""Generated from Smithy shape ``com.amazonaws.aiops#ListTagsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_aiops.types.list_tags_for_resource_output.ListTagsForResourceOutput = (
        aws_sdk_aiops.types.list_tags_for_resource_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_aiops.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
