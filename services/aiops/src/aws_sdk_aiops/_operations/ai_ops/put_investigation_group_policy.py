...
def handle_response(
    ...
    out: aws_sdk_aiops.types.put_investigation_group_policy_response.PutInvestigationGroupPolicyResponse = aws_sdk_aiops.types.put_investigation_group_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_aiops.types.put_investigation_group_policy_request.PutInvestigationGroupPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_aiops.types.put_investigation_group_policy_request.serialize_json(input)
    ).encode()
