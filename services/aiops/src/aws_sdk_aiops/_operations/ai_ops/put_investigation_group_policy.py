...
def build_request(
    ...
    input_: aws_sdk_aiops.types.put_investigation_group_policy_request.PutInvestigationGroupPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_aiops.types.put_investigation_group_policy_request.serialize_json(
            input_
        )
    ).encode()
