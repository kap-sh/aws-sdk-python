"""Generated from Smithy shape ``com.amazonaws.aiops#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_aiops.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def get_signer(
...
) -> aws_sdk_aiops._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_aiops._auth._sigv4.build_sigv4_auth_scheme(
                "aiops", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_aiops._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_aiops.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def untag_resource(
    ...
    aws_sdk_aiops.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
