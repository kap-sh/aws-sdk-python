"""Generated from Smithy shape ``com.amazonaws.aiops#DeleteInvestigationGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_aiops.types.delete_investigation_group_request.DeleteInvestigationGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/investigationGroups/{identifier}"
...
async def async_delete_investigation_group(
