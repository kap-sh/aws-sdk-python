...
def handle_response(
    ...
    out: aws_sdk_aiops.types.get_investigation_group_response.GetInvestigationGroupResponse = aws_sdk_aiops.types.get_investigation_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_aiops.types.get_investigation_group_request.GetInvestigationGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
