...
def build_request(
    ...
    input: aws_sdk_aiops.types.create_investigation_group_input.CreateInvestigationGroupInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_aiops.types.create_investigation_group_input.serialize_json(input)
    ).encode()
