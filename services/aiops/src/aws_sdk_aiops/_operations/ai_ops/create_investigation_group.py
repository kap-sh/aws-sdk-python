...
def build_request(
    ...
    input_: aws_sdk_aiops.types.create_investigation_group_input.CreateInvestigationGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_aiops.types.create_investigation_group_input.serialize_json(input_)
    ).encode()
