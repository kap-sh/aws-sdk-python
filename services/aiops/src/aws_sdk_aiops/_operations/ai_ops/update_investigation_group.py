...
def handle_response(
    ...
    out: aws_sdk_aiops.types.update_investigation_group_output.UpdateInvestigationGroupOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_aiops.types.update_investigation_group_request.UpdateInvestigationGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_aiops.types.update_investigation_group_request.serialize_json(input_)
    ).encode()
