...
def build_request(
    ...
    input: aws_sdk_aiops.types.update_investigation_group_request.UpdateInvestigationGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_aiops.types.update_investigation_group_request.serialize_json(input)
    ).encode()
