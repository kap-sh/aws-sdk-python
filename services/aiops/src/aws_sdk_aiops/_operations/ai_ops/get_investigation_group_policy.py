...
def handle_response(
    ...
    out: aws_sdk_aiops.types.get_investigation_group_policy_response.GetInvestigationGroupPolicyResponse = aws_sdk_aiops.types.get_investigation_group_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_aiops.types.get_investigation_group_policy_request.GetInvestigationGroupPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
