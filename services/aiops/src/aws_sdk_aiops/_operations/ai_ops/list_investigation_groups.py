...
def handle_response(
    ...
    out: aws_sdk_aiops.types.list_investigation_groups_output.ListInvestigationGroupsOutput = aws_sdk_aiops.types.list_investigation_groups_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_aiops.types.list_investigation_groups_input.ListInvestigationGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
