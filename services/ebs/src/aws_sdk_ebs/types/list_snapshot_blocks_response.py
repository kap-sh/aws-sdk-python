...
class ListSnapshotBlocksResponse(TypedDict):
    blocks: NotRequired["aws_sdk_ebs.types.blocks.Blocks"]
...
def serialize_json(value: ListSnapshotBlocksResponse) -> dict:
    ...
    if "blocks" in value:
        ...
        out["Blocks"] = aws_sdk_ebs.types.blocks.serialize_json(value["blocks"])
...
def deserialize_json(data: dict) -> ListSnapshotBlocksResponse:
    ...
    if "Blocks" in data:
        ...
        out["blocks"] = aws_sdk_ebs.types.blocks.deserialize_json(data["Blocks"])
