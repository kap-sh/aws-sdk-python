...
class StartSnapshotRequest(TypedDict, closed=True):
    ...
    client_token: NotRequired["aws_sdk_ebs.types.idempotency_token.IdempotencyToken"]
    ...
    encrypted: NotRequired["aws_sdk_ebs.types.boolean.Boolean"]
    ...
    timeout: NotRequired["aws_sdk_ebs.types.timeout.Timeout"]
