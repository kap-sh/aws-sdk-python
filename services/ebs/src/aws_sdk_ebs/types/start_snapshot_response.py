...
if TYPE_CHECKING:
    ...
    import aws_sdk_ebs.types.owner_id
...
class StartSnapshotResponse(TypedDict):
    ...
    owner_id: NotRequired["aws_sdk_ebs.types.owner_id.OwnerId"]
    """<p>The Amazon Web Services account ID of the snapshot owner.</p>"""
    status: NotRequired["aws_sdk_ebs.types.status.Status"]
    """<p>The status of the snapshot.</p>"""
    start_time: NotRequired["aws_sdk_ebs.types.time_stamp.TimeStamp"]
    ...
    sse_type: NotRequired["aws_sdk_ebs.types.sse_type.SSEType"]
...
def serialize_json(value: StartSnapshotResponse) -> dict:
    ...
    if "start_time" in value:
        ...
        out["StartTime"] = aws_sdk_ebs.types.time_stamp.serialize_json(
            value["start_time"]
        )
    ...
    if "tags" in value:
        ...
        out["Tags"] = aws_sdk_ebs.types.tags.serialize_json(value["tags"])
    ...
    if "sse_type" in value:
        ...
        out["SseType"] = aws_sdk_ebs.types.sse_type.serialize_json(value["sse_type"])
    return out
...
def deserialize_json(data: dict) -> StartSnapshotResponse:
    ...
    if "StartTime" in data:
        ...
        out["start_time"] = aws_sdk_ebs.types.time_stamp.deserialize_json(
            data["StartTime"]
        )
    ...
    if "Tags" in data:
        ...
        out["tags"] = aws_sdk_ebs.types.tags.deserialize_json(data["Tags"])
    ...
    if "SseType" in data:
        ...
        out["sse_type"] = aws_sdk_ebs.types.sse_type.deserialize_json(data["SseType"])
    return out
