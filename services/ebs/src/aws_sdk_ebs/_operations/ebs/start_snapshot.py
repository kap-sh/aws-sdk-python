...
def build_request(
    ...
    input_: aws_sdk_ebs.types.start_snapshot_request.StartSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ebs.types.start_snapshot_request.serialize_json(input_)
    ).encode()
...
def start_snapshot(
    ...
    aws_sdk_ebs.types.start_snapshot_response.StartSnapshotResponse, zapros.Response
]:
