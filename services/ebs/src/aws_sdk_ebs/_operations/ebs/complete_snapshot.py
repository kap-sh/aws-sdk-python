"""Generated from Smithy shape ``com.amazonaws.ebs#CompleteSnapshot``."""
...
def handle_response(
    ...
    out: aws_sdk_ebs.types.complete_snapshot_response.CompleteSnapshotResponse = (
        aws_sdk_ebs.types.complete_snapshot_response.deserialize_json(
