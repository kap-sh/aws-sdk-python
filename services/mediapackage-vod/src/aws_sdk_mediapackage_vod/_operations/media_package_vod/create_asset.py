"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#CreateAsset``."""
...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.create_asset_response.CreateAssetResponse = (
        aws_sdk_mediapackage_vod.types.create_asset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.create_asset_request.CreateAssetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediapackage_vod.types.create_asset_request.serialize_json(input_)
    ).encode()
