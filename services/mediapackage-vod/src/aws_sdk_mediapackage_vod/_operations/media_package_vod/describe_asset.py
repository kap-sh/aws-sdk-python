...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.describe_asset_response.DescribeAssetResponse = aws_sdk_mediapackage_vod.types.describe_asset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.describe_asset_request.DescribeAssetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
