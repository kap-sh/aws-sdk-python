"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#DeletePackagingGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.delete_packaging_group_response.DeletePackagingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.delete_packaging_group_request.DeletePackagingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_packaging_group(
