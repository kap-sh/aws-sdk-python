"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#ListPackagingGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.list_packaging_groups_response.ListPackagingGroupsResponse = aws_sdk_mediapackage_vod.types.list_packaging_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.list_packaging_groups_request.ListPackagingGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_packaging_groups(
