...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.create_packaging_group_response.CreatePackagingGroupResponse = aws_sdk_mediapackage_vod.types.create_packaging_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.create_packaging_group_request.CreatePackagingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
