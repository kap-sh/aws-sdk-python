...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.delete_packaging_configuration_response.DeletePackagingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.delete_packaging_configuration_request.DeletePackagingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
