...
def build_request(
    ...
    input: aws_sdk_mediapackage_vod.types.configure_logs_request.ConfigureLogsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediapackage_vod.types.configure_logs_request.serialize_json(input)
    ).encode()
