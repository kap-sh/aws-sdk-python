...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.configure_logs_response.ConfigureLogsResponse = aws_sdk_mediapackage_vod.types.configure_logs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.configure_logs_request.ConfigureLogsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediapackage_vod.types.configure_logs_request.serialize_json(input_)
    ).encode()
