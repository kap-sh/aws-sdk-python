...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.update_packaging_group_response.UpdatePackagingGroupResponse = aws_sdk_mediapackage_vod.types.update_packaging_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.update_packaging_group_request.UpdatePackagingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediapackage_vod.types.update_packaging_group_request.serialize_json(
            input_
        )
    ).encode()
