...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.create_packaging_configuration_response.CreatePackagingConfigurationResponse = aws_sdk_mediapackage_vod.types.create_packaging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.create_packaging_configuration_request.CreatePackagingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediapackage_vod.types.create_packaging_configuration_request.serialize_json(
            input_
        )
    ).encode()
