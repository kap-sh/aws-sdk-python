...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.list_assets_response.ListAssetsResponse = (
        aws_sdk_mediapackage_vod.types.list_assets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.list_assets_request.ListAssetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
