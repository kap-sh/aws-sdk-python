"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#UntagResource``."""
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
