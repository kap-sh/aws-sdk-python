"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#DescribePackagingConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.describe_packaging_configuration_response.DescribePackagingConfigurationResponse = aws_sdk_mediapackage_vod.types.describe_packaging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.describe_packaging_configuration_request.DescribePackagingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/packaging_configurations/{Id}"
...
async def async_describe_packaging_configuration(
