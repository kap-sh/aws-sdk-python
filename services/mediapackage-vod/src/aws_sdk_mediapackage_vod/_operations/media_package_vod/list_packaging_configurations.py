...
def handle_response(
    ...
    out: aws_sdk_mediapackage_vod.types.list_packaging_configurations_response.ListPackagingConfigurationsResponse = aws_sdk_mediapackage_vod.types.list_packaging_configurations_response.deserialize_json(
...
def get_signer(
...
) -> aws_sdk_mediapackage_vod._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_mediapackage_vod._auth._sigv4.build_sigv4_auth_scheme(
                "mediapackage-vod", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_mediapackage_vod._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_mediapackage_vod.types.list_packaging_configurations_request.ListPackagingConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
