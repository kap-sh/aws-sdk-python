...
def build_request(
    ...
    input: aws_sdk_mediapackage_vod.types.list_packaging_configurations_request.ListPackagingConfigurationsRequest,
) -> zapros.Request:
    ...
    if "packaging_group_id" in input:
        params["packagingGroupId"] = str(input["packaging_group_id"])
