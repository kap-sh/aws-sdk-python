"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#UnprocessableEntityException``."""
...
class UnprocessableEntityException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediapackagevod#UnprocessableEntityException``."""
