...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediapackage_vod.types.cmaf_encryption


class CmafPackage(TypedDict, closed=True):
    encryption: NotRequired[
        "aws_sdk_mediapackage_vod.types.cmaf_encryption.CmafEncryption"
    ]
...
def serialize_json(value: CmafPackage) -> dict:
    ...
    if "encryption" in value:
        ...
        out["encryption"] = (
            aws_sdk_mediapackage_vod.types.cmaf_encryption.serialize_json(
                value["encryption"]
            )
        )
...
def deserialize_json(data: dict) -> CmafPackage:
    ...
    if "encryption" in data:
        ...
        out["encryption"] = (
            aws_sdk_mediapackage_vod.types.cmaf_encryption.deserialize_json(
                data["encryption"]
            )
        )
