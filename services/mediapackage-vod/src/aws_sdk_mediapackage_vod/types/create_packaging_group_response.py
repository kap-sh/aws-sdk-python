"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#CreatePackagingGroupResponse``."""
...
class CreatePackagingGroupResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreatePackagingGroupResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreatePackagingGroupResponse:
    out: CreatePackagingGroupResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
