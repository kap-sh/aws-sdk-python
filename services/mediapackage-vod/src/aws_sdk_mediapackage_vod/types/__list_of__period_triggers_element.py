...
if TYPE_CHECKING:
    import aws_sdk_mediapackage_vod.types.__period_triggers_element

__listOf__PeriodTriggersElement: TypeAlias = list[
    "aws_sdk_mediapackage_vod.types.__period_triggers_element.__PeriodTriggersElement"
]
...
def serialize_json(value: __listOf__PeriodTriggersElement) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_mediapackage_vod.types.__period_triggers_element.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> __listOf__PeriodTriggersElement:
    ...
    for item in data:
        out.append(
            aws_sdk_mediapackage_vod.types.__period_triggers_element.deserialize_json(
                item
            )
        )
    return out
