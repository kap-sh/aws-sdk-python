...
if TYPE_CHECKING:
    import capo_mediapackage_vod.types.__list_of_egress_endpoint
...
class CreateAssetResponse(TypedDict, closed=True):
    ...
    egress_endpoints: NotRequired[
        "capo_mediapackage_vod.types.__list_of_egress_endpoint.__listOfEgressEndpoint"
    ]
...
def serialize_json(value: CreateAssetResponse) -> dict:
    ...
    if "egress_endpoints" in value:
        ...
        out["egressEndpoints"] = (
            capo_mediapackage_vod.types.__list_of_egress_endpoint.serialize_json(
...
def deserialize_json(data: dict) -> CreateAssetResponse:
    ...
    if "egressEndpoints" in data:
        ...
        out["egress_endpoints"] = (
            capo_mediapackage_vod.types.__list_of_egress_endpoint.deserialize_json(
