"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#DescribePackagingGroupResponse``."""
...
class DescribePackagingGroupResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribePackagingGroupResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribePackagingGroupResponse:
    out: DescribePackagingGroupResponse = {}  # type: ignore[typeddict-item]
