"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#Authorization``."""
...
class Authorization(TypedDict, closed=True):
    cdn_identifier_secret: NotRequired["capo_mediapackage_vod.types.__string.__string"]
    """The Amazon Resource Name (ARN) for the secret in AWS Secrets Manager that is used for CDN authorization."""
    secrets_role_arn: NotRequired["capo_mediapackage_vod.types.__string.__string"]
