...
class MediaPackageVodError(Exception):
    """Base class for all MediaPackageVod service errors."""


class ServiceError(MediaPackageVodError):
...
class SerializationError(MediaPackageVodError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MediaPackageVodError):
...
class WaiterFailedError(MediaPackageVodError):
...
class WaiterTimeoutError(MediaPackageVodError):
