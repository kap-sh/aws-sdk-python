"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#ServiceUnavailableException``."""
...
class ServiceUnavailableException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediapackagevod#ServiceUnavailableException``."""
