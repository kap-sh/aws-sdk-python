"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#ForbiddenException``."""
...
class ForbiddenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediapackagevod#ForbiddenException``."""
