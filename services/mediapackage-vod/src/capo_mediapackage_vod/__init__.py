...
from ._services.async_media_package_vod import (
    AsyncMediaPackageVodClient as AsyncMediaPackageVodClient,
)
from ._services.media_package_vod import MediaPackageVodClient as MediaPackageVodClient
