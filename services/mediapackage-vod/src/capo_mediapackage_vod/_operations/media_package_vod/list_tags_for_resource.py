"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#ListTagsForResource``."""
...
import capo_mediapackage_vod.types.list_tags_for_resource_request
import capo_mediapackage_vod.types.list_tags_for_resource_response
...
) -> capo_mediapackage_vod.types.list_tags_for_resource_response.ListTagsForResourceResponse:
    out: capo_mediapackage_vod.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_mediapackage_vod.types.list_tags_for_resource_response.deserialize_json(
