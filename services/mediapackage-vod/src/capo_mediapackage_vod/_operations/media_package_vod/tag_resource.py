"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#TagResource``."""
...
import capo_mediapackage_vod.types.tag_resource_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediapackage_vod.types.tag_resource_request.serialize_json(input_)
    ).encode()
