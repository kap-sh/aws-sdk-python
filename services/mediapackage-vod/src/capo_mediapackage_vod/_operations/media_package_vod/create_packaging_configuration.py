"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#CreatePackagingConfiguration``."""
...
import capo_mediapackage_vod.types.create_packaging_configuration_request
import capo_mediapackage_vod.types.create_packaging_configuration_response
...
def handle_response(
    ...
    out: capo_mediapackage_vod.types.create_packaging_configuration_response.CreatePackagingConfigurationResponse = capo_mediapackage_vod.types.create_packaging_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediapackage_vod.types.create_packaging_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_packaging_configuration(
