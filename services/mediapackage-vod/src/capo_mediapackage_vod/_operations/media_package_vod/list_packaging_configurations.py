"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#ListPackagingConfigurations``."""
...
import capo_mediapackage_vod.types.list_packaging_configurations_request
import capo_mediapackage_vod.types.list_packaging_configurations_response
...
) -> capo_mediapackage_vod.types.list_packaging_configurations_response.ListPackagingConfigurationsResponse:
    out: capo_mediapackage_vod.types.list_packaging_configurations_response.ListPackagingConfigurationsResponse = capo_mediapackage_vod.types.list_packaging_configurations_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_mediapackage_vod._auth._sigv4.build_sigv4_auth_scheme(
                "mediapackage-vod", options.region
            )
        )
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/packaging_configurations"
    params: dict[str, str] = {}
    if "max_results" in input_:
        params["maxResults"] = str(input_["max_results"])
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "packaging_group_id" in input_:
        params["packagingGroupId"] = str(input_["packaging_group_id"])
...
async def async_list_packaging_configurations(
