"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#DescribePackagingGroup``."""
...
import capo_mediapackage_vod.types.describe_packaging_group_request
import capo_mediapackage_vod.types.describe_packaging_group_response
...
) -> capo_mediapackage_vod.types.describe_packaging_group_response.DescribePackagingGroupResponse:
    out: capo_mediapackage_vod.types.describe_packaging_group_response.DescribePackagingGroupResponse = capo_mediapackage_vod.types.describe_packaging_group_response.deserialize_json(
...
async def async_describe_packaging_group(
