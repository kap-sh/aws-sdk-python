"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#ListAssets``."""
...
import capo_mediapackage_vod.types.__list_of_asset_shallow
import capo_mediapackage_vod.types.list_assets_request
import capo_mediapackage_vod.types.list_assets_response
...
) -> capo_mediapackage_vod.types.list_assets_response.ListAssetsResponse:
    out: capo_mediapackage_vod.types.list_assets_response.ListAssetsResponse = (
        capo_mediapackage_vod.types.list_assets_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/assets"
    params: dict[str, str] = {}
...
def list_assets(
    ...
    capo_mediapackage_vod.types.list_assets_response.ListAssetsResponse, zapros.Response
]:
