"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#DeletePackagingConfiguration``."""
...
import capo_mediapackage_vod.types.delete_packaging_configuration_request
import capo_mediapackage_vod.types.delete_packaging_configuration_response
...
) -> capo_mediapackage_vod.types.delete_packaging_configuration_response.DeletePackagingConfigurationResponse:
    out: capo_mediapackage_vod.types.delete_packaging_configuration_response.DeletePackagingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_packaging_configuration(
