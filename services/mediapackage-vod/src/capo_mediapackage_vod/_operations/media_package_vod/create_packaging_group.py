"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#CreatePackagingGroup``."""
...
import capo_mediapackage_vod.types.create_packaging_group_request
import capo_mediapackage_vod.types.create_packaging_group_response
...
def handle_response(
    ...
    out: capo_mediapackage_vod.types.create_packaging_group_response.CreatePackagingGroupResponse = capo_mediapackage_vod.types.create_packaging_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediapackage_vod.types.create_packaging_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_packaging_group(
