...
if TYPE_CHECKING:
    import aws_sdk_appflow.types.data_pull_mode
    import aws_sdk_appflow.types.date
    import aws_sdk_appflow.types.flow_error_deactivation_threshold
    import aws_sdk_appflow.types.schedule_expression
    import aws_sdk_appflow.types.schedule_offset
...
class ScheduledTriggerProperties(TypedDict):
    ...
    schedule_start_time: NotRequired["aws_sdk_appflow.types.date.Date"]
    ...
    schedule_end_time: NotRequired["aws_sdk_appflow.types.date.Date"]
    ...
    timezone: NotRequired["aws_sdk_appflow.types.timezone.Timezone"]
    ...
    schedule_offset: NotRequired["aws_sdk_appflow.types.schedule_offset.ScheduleOffset"]
    """<p> Specifies the optional offset that is added to the time interval for a schedule-triggered flow. </p>"""
    first_execution_from: NotRequired["aws_sdk_appflow.types.date.Date"]
    ...
    flow_error_deactivation_threshold: NotRequired[
        "aws_sdk_appflow.types.flow_error_deactivation_threshold.FlowErrorDeactivationThreshold"
    ]
...
def serialize_json(value: ScheduledTriggerProperties) -> dict:
    ...
    if "data_pull_mode" in value:
        ...
        out["dataPullMode"] = aws_sdk_appflow.types.data_pull_mode.serialize_json(
            value["data_pull_mode"]
        )
    if "schedule_start_time" in value:
        import aws_sdk_appflow.types.date

        out["scheduleStartTime"] = aws_sdk_appflow.types.date.serialize_json(
            value["schedule_start_time"]
        )
    if "schedule_end_time" in value:
        import aws_sdk_appflow.types.date

        out["scheduleEndTime"] = aws_sdk_appflow.types.date.serialize_json(
    ...
    if "first_execution_from" in value:
        ...
        out["firstExecutionFrom"] = aws_sdk_appflow.types.date.serialize_json(
...
def deserialize_json(data: dict) -> ScheduledTriggerProperties:
    ...
    if "dataPullMode" in data:
        ...
        out["data_pull_mode"] = aws_sdk_appflow.types.data_pull_mode.deserialize_json(
            data["dataPullMode"]
        )
    if "scheduleStartTime" in data:
        import aws_sdk_appflow.types.date

        out["schedule_start_time"] = aws_sdk_appflow.types.date.deserialize_json(
            data["scheduleStartTime"]
        )
    if "scheduleEndTime" in data:
        import aws_sdk_appflow.types.date

        out["schedule_end_time"] = aws_sdk_appflow.types.date.deserialize_json(
    ...
    if "firstExecutionFrom" in data:
        ...
        out["first_execution_from"] = aws_sdk_appflow.types.date.deserialize_json(
