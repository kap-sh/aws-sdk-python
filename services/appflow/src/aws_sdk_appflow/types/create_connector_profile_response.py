"""Generated from Smithy shape ``com.amazonaws.appflow#CreateConnectorProfileResponse``."""
...
class CreateConnectorProfileResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateConnectorProfileResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateConnectorProfileResponse:
    out: CreateConnectorProfileResponse = {}  # type: ignore[typeddict-item]
