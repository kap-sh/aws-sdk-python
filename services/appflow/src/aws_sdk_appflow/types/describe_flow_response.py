...
if TYPE_CHECKING:
    ...
    import aws_sdk_appflow.types.flow_status_message
...
class DescribeFlowResponse(TypedDict, closed=True):
    ...
    flow_status_message: NotRequired[
        "aws_sdk_appflow.types.flow_status_message.FlowStatusMessage"
    ]
    ...
    source_flow_config: NotRequired[
        "aws_sdk_appflow.types.source_flow_config.SourceFlowConfig"
    ]
    ...
    trigger_config: NotRequired["aws_sdk_appflow.types.trigger_config.TriggerConfig"]
    """<p> The trigger settings that determine how and when the flow runs. </p>"""
    tasks: NotRequired["aws_sdk_appflow.types.tasks.Tasks"]
    ...
    schema_version: NotRequired["aws_sdk_appflow.types.long.Long"]
...
def serialize_json(value: DescribeFlowResponse) -> dict:
    ...
    if "source_flow_config" in value:
        ...
        out["sourceFlowConfig"] = (
            aws_sdk_appflow.types.source_flow_config.serialize_json(
