...
if TYPE_CHECKING:
    ...
    import aws_sdk_appflow.types.java_boolean
    import aws_sdk_appflow.types.prefix_config


class S3OutputFormatConfig(TypedDict):
    ...
    prefix_config: NotRequired["aws_sdk_appflow.types.prefix_config.PrefixConfig"]
