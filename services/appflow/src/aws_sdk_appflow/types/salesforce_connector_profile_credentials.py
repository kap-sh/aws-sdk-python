...
if TYPE_CHECKING:
    ...
    import aws_sdk_appflow.types.jwt_token
    import aws_sdk_appflow.types.o_auth2_grant_type
    import aws_sdk_appflow.types.refresh_token


class SalesforceConnectorProfileCredentials(TypedDict):
    ...
    jwt_token: NotRequired["aws_sdk_appflow.types.jwt_token.JwtToken"]
...
def serialize_json(value: SalesforceConnectorProfileCredentials) -> dict:
    ...
    if "o_auth2_grant_type" in value:
        ...
        out["oAuth2GrantType"] = (
            aws_sdk_appflow.types.o_auth2_grant_type.serialize_json(
