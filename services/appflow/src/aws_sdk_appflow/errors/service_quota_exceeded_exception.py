"""Generated from Smithy shape ``com.amazonaws.appflow#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.appflow#ServiceQuotaExceededException``."""
