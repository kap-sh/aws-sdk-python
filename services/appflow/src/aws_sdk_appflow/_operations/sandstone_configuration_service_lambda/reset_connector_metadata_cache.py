...
def handle_response(
    ...
    out: aws_sdk_appflow.types.reset_connector_metadata_cache_response.ResetConnectorMetadataCacheResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.reset_connector_metadata_cache_request.ResetConnectorMetadataCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.reset_connector_metadata_cache_request.serialize_json(
            input_
        )
    ).encode()
