...
def handle_response(
    ...
    out: aws_sdk_appflow.types.list_flows_response.ListFlowsResponse = (
        aws_sdk_appflow.types.list_flows_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.list_flows_request.ListFlowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.list_flows_request.serialize_json(input_)
    ).encode()
...
def list_flows(
    ...
    aws_sdk_appflow.types.list_flows_response.ListFlowsResponse, zapros.Response
]:
