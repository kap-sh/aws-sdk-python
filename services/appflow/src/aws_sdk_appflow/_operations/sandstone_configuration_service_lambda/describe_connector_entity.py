...
def handle_response(
    ...
    out: aws_sdk_appflow.types.describe_connector_entity_response.DescribeConnectorEntityResponse = aws_sdk_appflow.types.describe_connector_entity_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_appflow.types.describe_connector_entity_request.DescribeConnectorEntityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.describe_connector_entity_request.serialize_json(input)
    ).encode()
