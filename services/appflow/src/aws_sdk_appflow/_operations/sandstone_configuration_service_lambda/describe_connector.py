"""Generated from Smithy shape ``com.amazonaws.appflow#DescribeConnector``."""
...
def handle_response(
    ...
    out: aws_sdk_appflow.types.describe_connector_response.DescribeConnectorResponse = (
        aws_sdk_appflow.types.describe_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.describe_connector_request.DescribeConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/describe-connector"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_appflow.types.describe_connector_request

    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.describe_connector_request.serialize_json(input_)
    ).encode()
