...
def handle_response(
    ...
    out: aws_sdk_appflow.types.describe_flow_response.DescribeFlowResponse = (
        aws_sdk_appflow.types.describe_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.describe_flow_request.DescribeFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.describe_flow_request.serialize_json(input_)
    ).encode()
...
def describe_flow(
    ...
    aws_sdk_appflow.types.describe_flow_response.DescribeFlowResponse, zapros.Response
]:
