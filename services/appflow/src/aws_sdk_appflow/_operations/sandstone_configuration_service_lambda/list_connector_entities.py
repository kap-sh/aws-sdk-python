"""Generated from Smithy shape ``com.amazonaws.appflow#ListConnectorEntities``."""
...
def handle_response(
    ...
    out: aws_sdk_appflow.types.list_connector_entities_response.ListConnectorEntitiesResponse = aws_sdk_appflow.types.list_connector_entities_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.list_connector_entities_request.ListConnectorEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-connector-entities"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.list_connector_entities_request.serialize_json(input_)
    ).encode()
...
async def async_list_connector_entities(
