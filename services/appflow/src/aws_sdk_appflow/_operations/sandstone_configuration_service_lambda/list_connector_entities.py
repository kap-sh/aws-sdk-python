...
def build_request(
    ...
    input: aws_sdk_appflow.types.list_connector_entities_request.ListConnectorEntitiesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.list_connector_entities_request.serialize_json(input)
    ).encode()
