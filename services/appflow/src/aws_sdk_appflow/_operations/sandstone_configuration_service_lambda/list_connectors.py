...
def handle_response(
    ...
    out: aws_sdk_appflow.types.list_connectors_response.ListConnectorsResponse = (
        aws_sdk_appflow.types.list_connectors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.list_connectors_request.ListConnectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.list_connectors_request.serialize_json(input_)
    ).encode()
