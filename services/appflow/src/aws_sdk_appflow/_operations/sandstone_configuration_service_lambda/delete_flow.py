"""Generated from Smithy shape ``com.amazonaws.appflow#DeleteFlow``."""
...
def handle_response(
    ...
    out: aws_sdk_appflow.types.delete_flow_response.DeleteFlowResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.delete_flow_request.DeleteFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/delete-flow"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_appflow.types.delete_flow_request

    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.delete_flow_request.serialize_json(input_)
    ).encode()
...
def delete_flow(
    ...
    aws_sdk_appflow.types.delete_flow_response.DeleteFlowResponse, zapros.Response
]:
