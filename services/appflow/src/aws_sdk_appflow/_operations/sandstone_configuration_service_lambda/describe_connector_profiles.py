...
def handle_response(
    ...
    out: aws_sdk_appflow.types.describe_connector_profiles_response.DescribeConnectorProfilesResponse = aws_sdk_appflow.types.describe_connector_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.describe_connector_profiles_request.DescribeConnectorProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.describe_connector_profiles_request.serialize_json(input_)
    ).encode()
