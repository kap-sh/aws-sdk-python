...
def handle_response(
    ...
    out: aws_sdk_appflow.types.start_flow_response.StartFlowResponse = (
        aws_sdk_appflow.types.start_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.start_flow_request.StartFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.start_flow_request.serialize_json(input_)
    ).encode()
...
def start_flow(
    ...
    aws_sdk_appflow.types.start_flow_response.StartFlowResponse, zapros.Response
]:
