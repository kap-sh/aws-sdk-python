...
def handle_response(
    ...
    out: aws_sdk_appflow.types.cancel_flow_executions_response.CancelFlowExecutionsResponse = aws_sdk_appflow.types.cancel_flow_executions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.cancel_flow_executions_request.CancelFlowExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.cancel_flow_executions_request.serialize_json(input_)
    ).encode()
