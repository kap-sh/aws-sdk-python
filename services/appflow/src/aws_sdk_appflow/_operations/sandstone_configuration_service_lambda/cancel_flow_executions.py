...
def build_request(
    ...
    input: aws_sdk_appflow.types.cancel_flow_executions_request.CancelFlowExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.cancel_flow_executions_request.serialize_json(input)
    ).encode()
