"""Generated from Smithy shape ``com.amazonaws.appflow#DescribeConnectors``."""
...
def handle_response(
    ...
    out: aws_sdk_appflow.types.describe_connectors_response.DescribeConnectorsResponse = aws_sdk_appflow.types.describe_connectors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.describe_connectors_request.DescribeConnectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/describe-connectors"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_appflow.types.describe_connectors_request

    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.describe_connectors_request.serialize_json(input_)
    ).encode()
...
async def async_describe_connectors(
