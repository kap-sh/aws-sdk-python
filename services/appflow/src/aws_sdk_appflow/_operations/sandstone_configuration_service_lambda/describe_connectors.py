...
def build_request(
    ...
    input: aws_sdk_appflow.types.describe_connectors_request.DescribeConnectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.describe_connectors_request.serialize_json(input)
    ).encode()
