...
def handle_response(
    ...
    out: aws_sdk_appflow.types.register_connector_response.RegisterConnectorResponse = (
        aws_sdk_appflow.types.register_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.register_connector_request.RegisterConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.register_connector_request.serialize_json(input_)
    ).encode()
