...
def handle_response(
    ...
    out: aws_sdk_appflow.types.describe_flow_execution_records_response.DescribeFlowExecutionRecordsResponse = aws_sdk_appflow.types.describe_flow_execution_records_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.describe_flow_execution_records_request.DescribeFlowExecutionRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.describe_flow_execution_records_request.serialize_json(
            input_
        )
    ).encode()
