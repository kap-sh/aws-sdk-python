...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedOperationException":
            import aws_sdk_appflow.errors.unsupported_operation_exception

            raise aws_sdk_appflow.errors.unsupported_operation_exception.UnsupportedOperationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_appflow.types.stop_flow_response.StopFlowResponse = (
        aws_sdk_appflow.types.stop_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.stop_flow_request.StopFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.stop_flow_request.serialize_json(input_)
    ).encode()
...
def stop_flow(
    ...
    input_: aws_sdk_appflow.types.stop_flow_request.StopFlowRequest,
) -> tuple[aws_sdk_appflow.types.stop_flow_response.StopFlowResponse, zapros.Response]:
