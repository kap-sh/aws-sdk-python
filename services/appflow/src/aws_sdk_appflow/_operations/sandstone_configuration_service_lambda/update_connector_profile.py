...
def build_request(
    ...
    input_: aws_sdk_appflow.types.update_connector_profile_request.UpdateConnectorProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.update_connector_profile_request.serialize_json(input_)
    ).encode()
