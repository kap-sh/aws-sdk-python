...
def build_request(
    ...
    input: aws_sdk_appflow.types.create_connector_profile_request.CreateConnectorProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.create_connector_profile_request.serialize_json(input)
    ).encode()
