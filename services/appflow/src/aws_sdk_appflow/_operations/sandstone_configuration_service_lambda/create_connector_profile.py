"""Generated from Smithy shape ``com.amazonaws.appflow#CreateConnectorProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_appflow.types.create_connector_profile_response.CreateConnectorProfileResponse = aws_sdk_appflow.types.create_connector_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.create_connector_profile_request.CreateConnectorProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/create-connector-profile"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.create_connector_profile_request.serialize_json(input_)
    ).encode()
...
async def async_create_connector_profile(
