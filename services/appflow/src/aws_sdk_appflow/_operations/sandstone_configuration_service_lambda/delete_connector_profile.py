...
def build_request(
    ...
    input: aws_sdk_appflow.types.delete_connector_profile_request.DeleteConnectorProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.delete_connector_profile_request.serialize_json(input)
    ).encode()
