...
def handle_response(
    ...
    out: aws_sdk_appflow.types.delete_connector_profile_response.DeleteConnectorProfileResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.delete_connector_profile_request.DeleteConnectorProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.delete_connector_profile_request.serialize_json(input_)
    ).encode()
