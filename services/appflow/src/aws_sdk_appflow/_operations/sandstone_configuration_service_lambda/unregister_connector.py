...
def build_request(
    ...
    input: aws_sdk_appflow.types.unregister_connector_request.UnregisterConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.unregister_connector_request.serialize_json(input)
    ).encode()
