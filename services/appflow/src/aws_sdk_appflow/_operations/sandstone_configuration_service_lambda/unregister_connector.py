...
def handle_response(
    ...
    out: aws_sdk_appflow.types.unregister_connector_response.UnregisterConnectorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.unregister_connector_request.UnregisterConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.unregister_connector_request.serialize_json(input_)
    ).encode()
