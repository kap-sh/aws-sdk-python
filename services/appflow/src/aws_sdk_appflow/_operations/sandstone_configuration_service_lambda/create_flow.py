"""Generated from Smithy shape ``com.amazonaws.appflow#CreateFlow``."""
...
def handle_response(
    ...
    out: aws_sdk_appflow.types.create_flow_response.CreateFlowResponse = (
        aws_sdk_appflow.types.create_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.create_flow_request.CreateFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/create-flow"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_appflow.types.create_flow_request

    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.create_flow_request.serialize_json(input_)
    ).encode()
...
def create_flow(
    ...
    aws_sdk_appflow.types.create_flow_response.CreateFlowResponse, zapros.Response
]:
