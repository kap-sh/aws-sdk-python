...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            import aws_sdk_appflow.errors.access_denied_exception

            raise aws_sdk_appflow.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
        ...
        case "ConnectorServerException":
            import aws_sdk_appflow.errors.connector_server_exception

            raise aws_sdk_appflow.errors.connector_server_exception.ConnectorServerException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_appflow.errors.service_quota_exceeded_exception

            raise aws_sdk_appflow.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case "ThrottlingException":
            import aws_sdk_appflow.errors.throttling_exception

            raise aws_sdk_appflow.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_appflow.types.update_connector_registration_response.UpdateConnectorRegistrationResponse = aws_sdk_appflow.types.update_connector_registration_response.deserialize_json(
...
def get_signer(
...
) -> aws_sdk_appflow._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_appflow._auth._sigv4.build_sigv4_auth_scheme(
                "appflow", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_appflow._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_appflow.types.update_connector_registration_request.UpdateConnectorRegistrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appflow.types.update_connector_registration_request.serialize_json(
            input_
        )
    ).encode()
