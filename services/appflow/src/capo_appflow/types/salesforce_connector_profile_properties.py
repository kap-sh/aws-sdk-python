...
class SalesforceConnectorProfileProperties(TypedDict, closed=True):
    instance_url: NotRequired["capo_appflow.types.instance_url.InstanceUrl"]
    """<p> The location of the Salesforce resource. </p>"""
    is_sandbox_environment: "capo_appflow.types.boolean.Boolean"
    ...
    use_private_link_for_metadata_and_authorization: (
        "capo_appflow.types.boolean.Boolean"
    )
