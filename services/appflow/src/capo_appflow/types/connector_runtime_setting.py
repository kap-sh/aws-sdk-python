...
if TYPE_CHECKING:
    ...
    import capo_appflow.types.connector_runtime_setting_data_type
    import capo_appflow.types.connector_runtime_setting_scope
...
class ConnectorRuntimeSetting(TypedDict, closed=True):
    ...
    data_type: NotRequired[
        "capo_appflow.types.connector_runtime_setting_data_type.ConnectorRuntimeSettingDataType"
    ]
    ...
    scope: NotRequired[
        "capo_appflow.types.connector_runtime_setting_scope.ConnectorRuntimeSettingScope"
    ]
    """<p>Indicates the scope of the connector runtime setting.</p>"""
    connector_supplied_value_options: NotRequired[
        "capo_appflow.types.connector_supplied_value_option_list.ConnectorSuppliedValueOptionList"
    ]
...
def serialize_json(value: ConnectorRuntimeSetting) -> dict:
    ...
    if "connector_supplied_value_options" in value:
        ...
        out["connectorSuppliedValueOptions"] = (
            capo_appflow.types.connector_supplied_value_option_list.serialize_json(
...
def deserialize_json(data: dict) -> ConnectorRuntimeSetting:
    ...
    if "connectorSuppliedValueOptions" in data:
        ...
        out["connector_supplied_value_options"] = (
            capo_appflow.types.connector_supplied_value_option_list.deserialize_json(
