...
if TYPE_CHECKING:
    import capo_appflow.types.custom_property_key
    import capo_appflow.types.custom_property_value

TokenUrlCustomProperties: TypeAlias = dict[
    "capo_appflow.types.custom_property_key.CustomPropertyKey",
    "capo_appflow.types.custom_property_value.CustomPropertyValue",
]
