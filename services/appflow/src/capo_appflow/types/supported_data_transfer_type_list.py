...
if TYPE_CHECKING:
    import capo_appflow.types.supported_data_transfer_type

SupportedDataTransferTypeList: TypeAlias = list[
    "capo_appflow.types.supported_data_transfer_type.SupportedDataTransferType"
]
...
def serialize_json(value: SupportedDataTransferTypeList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_appflow.types.supported_data_transfer_type.serialize_json(item))
    return out
