...
class FlowDefinition(TypedDict, closed=True):
    ...
    trigger_type: NotRequired["capo_appflow.types.trigger_type.TriggerType"]
...
def serialize_json(value: FlowDefinition) -> dict:
    ...
    if "source_connector_type" in value:
        ...
        out["sourceConnectorType"] = capo_appflow.types.connector_type.serialize_json(
    ...
    if "destination_connector_type" in value:
        ...
        out["destinationConnectorType"] = (
            capo_appflow.types.connector_type.serialize_json(
...
def deserialize_json(data: dict) -> FlowDefinition:
    ...
    if "sourceConnectorType" in data:
        ...
        out["source_connector_type"] = (
            capo_appflow.types.connector_type.deserialize_json(
