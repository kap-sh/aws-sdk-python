"""Generated from Smithy shape ``com.amazonaws.appflow#DescribeFlow``."""
...
def handle_response(
    ...
    out: capo_appflow.types.describe_flow_response.DescribeFlowResponse = (
        capo_appflow.types.describe_flow_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/describe-flow"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_appflow.types.describe_flow_request.serialize_json(input_)
    ).encode()
...
def describe_flow(
    ...
    capo_appflow.types.describe_flow_response.DescribeFlowResponse, zapros.Response
]:
