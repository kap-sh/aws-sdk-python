"""Generated from Smithy shape ``com.amazonaws.appflow#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_appflow.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_appflow.types.list_tags_for_resource_response.deserialize_json(
