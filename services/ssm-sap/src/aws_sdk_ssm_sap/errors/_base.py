...
class SsmSapError(Exception):
    """Base class for all SsmSap service errors."""


class ServiceError(SsmSapError):
...
class SerializationError(SsmSapError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SsmSapError):
...
class WaiterFailedError(SsmSapError):
...
class WaiterTimeoutError(SsmSapError):
