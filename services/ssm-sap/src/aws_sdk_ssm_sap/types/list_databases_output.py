...
class ListDatabasesOutput(TypedDict):
    databases: NotRequired[
        "aws_sdk_ssm_sap.types.database_summary_list.DatabaseSummaryList"
    ]
...
def serialize_json(value: ListDatabasesOutput) -> dict:
    ...
    if "databases" in value:
        ...
        out["Databases"] = aws_sdk_ssm_sap.types.database_summary_list.serialize_json(
            value["databases"]
        )
...
def deserialize_json(data: dict) -> ListDatabasesOutput:
    ...
    if "Databases" in data:
        ...
        out["databases"] = aws_sdk_ssm_sap.types.database_summary_list.deserialize_json(
            data["Databases"]
        )
