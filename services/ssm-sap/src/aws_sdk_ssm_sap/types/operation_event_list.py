...
OperationEventList: TypeAlias = list[
    "aws_sdk_ssm_sap.types.operation_event.OperationEvent"
]
...
def serialize_json(value: OperationEventList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_ssm_sap.types.operation_event.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> OperationEventList:
    ...
    for item in data:
        out.append(aws_sdk_ssm_sap.types.operation_event.deserialize_json(item))
    return out
