...
class ListOperationEventsOutput(TypedDict):
    operation_events: NotRequired[
        "aws_sdk_ssm_sap.types.operation_event_list.OperationEventList"
    ]
...
def serialize_json(value: ListOperationEventsOutput) -> dict:
    ...
    if "operation_events" in value:
        ...
        out["OperationEvents"] = (
            aws_sdk_ssm_sap.types.operation_event_list.serialize_json(
...
def deserialize_json(data: dict) -> ListOperationEventsOutput:
    ...
    if "OperationEvents" in data:
        ...
        out["operation_events"] = (
            aws_sdk_ssm_sap.types.operation_event_list.deserialize_json(
