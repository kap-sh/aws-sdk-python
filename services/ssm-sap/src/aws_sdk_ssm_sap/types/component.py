...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm_sap.types.associated_host
    import aws_sdk_ssm_sap.types.component_id
    import aws_sdk_ssm_sap.types.component_id_list
    import aws_sdk_ssm_sap.types.component_status
    import aws_sdk_ssm_sap.types.component_type
    import aws_sdk_ssm_sap.types.database_connection
    import aws_sdk_ssm_sap.types.database_id_list
    import aws_sdk_ssm_sap.types.host_list
    import aws_sdk_ssm_sap.types.resilience
...
class Component(TypedDict, closed=True):
    ...
    parent_component: NotRequired["aws_sdk_ssm_sap.types.component_id.ComponentId"]
    ...
    child_components: NotRequired[
        "aws_sdk_ssm_sap.types.component_id_list.ComponentIdList"
    ]
    ...
    status: NotRequired["aws_sdk_ssm_sap.types.component_status.ComponentStatus"]
    ...
    resilience: NotRequired["aws_sdk_ssm_sap.types.resilience.Resilience"]
    """<p>Details of the SAP HANA system replication for the component.</p>"""
    associated_host: NotRequired["aws_sdk_ssm_sap.types.associated_host.AssociatedHost"]
    """<p>The associated host of the component.</p>"""
    databases: NotRequired["aws_sdk_ssm_sap.types.database_id_list.DatabaseIdList"]
    """<p>The SAP HANA databases of the component.</p>"""
    hosts: NotRequired["aws_sdk_ssm_sap.types.host_list.HostList"]
    ...
    database_connection: NotRequired[
        "aws_sdk_ssm_sap.types.database_connection.DatabaseConnection"
    ]
...
def serialize_json(value: Component) -> dict:
    ...
    if "child_components" in value:
        ...
        out["ChildComponents"] = aws_sdk_ssm_sap.types.component_id_list.serialize_json(
    ...
    if "status" in value:
        ...
        out["Status"] = aws_sdk_ssm_sap.types.component_status.serialize_json(
            value["status"]
        )
    ...
    if "resilience" in value:
        ...
        out["Resilience"] = aws_sdk_ssm_sap.types.resilience.serialize_json(
            value["resilience"]
        )
    if "associated_host" in value:
        import aws_sdk_ssm_sap.types.associated_host

        out["AssociatedHost"] = aws_sdk_ssm_sap.types.associated_host.serialize_json(
            value["associated_host"]
        )
    if "databases" in value:
        import aws_sdk_ssm_sap.types.database_id_list

        out["Databases"] = aws_sdk_ssm_sap.types.database_id_list.serialize_json(
            value["databases"]
        )
    if "hosts" in value:
        import aws_sdk_ssm_sap.types.host_list

        out["Hosts"] = aws_sdk_ssm_sap.types.host_list.serialize_json(value["hosts"])
    ...
    if "database_connection" in value:
        ...
        out["DatabaseConnection"] = (
            aws_sdk_ssm_sap.types.database_connection.serialize_json(
...
def deserialize_json(data: dict) -> Component:
    ...
    if "ChildComponents" in data:
        ...
        out["child_components"] = (
            aws_sdk_ssm_sap.types.component_id_list.deserialize_json(
    ...
    if "Status" in data:
        ...
        out["status"] = aws_sdk_ssm_sap.types.component_status.deserialize_json(
            data["Status"]
        )
    ...
    if "Resilience" in data:
        ...
        out["resilience"] = aws_sdk_ssm_sap.types.resilience.deserialize_json(
            data["Resilience"]
        )
    if "AssociatedHost" in data:
        import aws_sdk_ssm_sap.types.associated_host

        out["associated_host"] = aws_sdk_ssm_sap.types.associated_host.deserialize_json(
            data["AssociatedHost"]
        )
    if "Databases" in data:
        import aws_sdk_ssm_sap.types.database_id_list

        out["databases"] = aws_sdk_ssm_sap.types.database_id_list.deserialize_json(
            data["Databases"]
        )
    if "Hosts" in data:
        import aws_sdk_ssm_sap.types.host_list

        out["hosts"] = aws_sdk_ssm_sap.types.host_list.deserialize_json(data["Hosts"])
    ...
    if "DatabaseConnection" in data:
        ...
        out["database_connection"] = (
            aws_sdk_ssm_sap.types.database_connection.deserialize_json(
