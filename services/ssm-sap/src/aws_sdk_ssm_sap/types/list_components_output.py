...
class ListComponentsOutput(TypedDict):
    components: NotRequired[
        "aws_sdk_ssm_sap.types.component_summary_list.ComponentSummaryList"
    ]
...
def serialize_json(value: ListComponentsOutput) -> dict:
    ...
    if "components" in value:
        ...
        out["Components"] = aws_sdk_ssm_sap.types.component_summary_list.serialize_json(
            value["components"]
        )
...
def deserialize_json(data: dict) -> ListComponentsOutput:
    ...
    if "Components" in data:
        ...
        out["components"] = (
            aws_sdk_ssm_sap.types.component_summary_list.deserialize_json(
                data["Components"]
            )
        )
