...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm_sap.types.rule_status_counts


class ConfigurationCheckOperation(TypedDict):
    ...
    rule_status_counts: NotRequired[
        "aws_sdk_ssm_sap.types.rule_status_counts.RuleStatusCounts"
    ]
...
def serialize_json(value: ConfigurationCheckOperation) -> dict:
    ...
    if "configuration_check_id" in value:
        ...
        out["ConfigurationCheckId"] = (
            aws_sdk_ssm_sap.types.configuration_check_type.serialize_json(
    ...
    if "rule_status_counts" in value:
        ...
        out["RuleStatusCounts"] = (
            aws_sdk_ssm_sap.types.rule_status_counts.serialize_json(
...
def deserialize_json(data: dict) -> ConfigurationCheckOperation:
    ...
    if "ConfigurationCheckId" in data:
        ...
        out["configuration_check_id"] = (
            aws_sdk_ssm_sap.types.configuration_check_type.deserialize_json(
    ...
    if "RuleStatusCounts" in data:
        ...
        out["rule_status_counts"] = (
            aws_sdk_ssm_sap.types.rule_status_counts.deserialize_json(
