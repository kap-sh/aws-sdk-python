...
from capo_ssm_sap._services._aws_config import aws_config
...
class SsmSapClientConfig(TypedDict, total=False, closed=True):
...
class SsmSapClient:
    ...
    def __init__(
        ...
        self._config = SsmSapClientConfig(
            {
    ...
    def delete_resource_permission(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.delete_resource_permission_input.DeleteResourcePermissionInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.delete_resource_permission_output.DeleteResourcePermissionOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.delete_resource_permission.delete_resource_permission(
    ...
    def deregister_application(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.deregister_application_input.DeregisterApplicationInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.deregister_application_output.DeregisterApplicationOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.deregister_application.deregister_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_application(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.get_application_input.GetApplicationInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.get_application_output.GetApplicationOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.get_application.get_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_component(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.get_component_input.GetComponentInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.get_component_output.GetComponentOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.get_component.get_component(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_configuration_check_operation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.get_configuration_check_operation_input.GetConfigurationCheckOperationInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.get_configuration_check_operation_output.GetConfigurationCheckOperationOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.get_configuration_check_operation.get_configuration_check_operation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_database(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.get_database_input.GetDatabaseInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.get_database_output.GetDatabaseOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.get_database.get_database(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_operation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.get_operation_input.GetOperationInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.get_operation_output.GetOperationOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.get_operation.get_operation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_permission(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.get_resource_permission_input.GetResourcePermissionInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.get_resource_permission_output.GetResourcePermissionOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.get_resource_permission.get_resource_permission(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_applications(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.list_applications_input.ListApplicationsInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.list_applications_output.ListApplicationsOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.list_applications.list_applications(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_applications(
        ...
        *,
        ...
        max_results: Optional["capo_ssm_sap.types.max_results.MaxResults"] = None,
        filters: Optional["capo_ssm_sap.types.filter_list.FilterList"] = None,
    ) -> "Iterator[capo_ssm_sap.types.application_summary.ApplicationSummary]":
        _token = next_token
        while True:
    ...
    def list_components(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.list_components_input.ListComponentsInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.list_components_output.ListComponentsOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.list_components.list_components(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_components(
        ...
        *,
        ...
        next_token: Optional["capo_ssm_sap.types.next_token.NextToken"] = None,
        max_results: Optional["capo_ssm_sap.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_ssm_sap.types.component_summary.ComponentSummary]":
        _token = next_token
        while True:
    ...
    def list_configuration_check_definitions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.list_configuration_check_definitions_input.ListConfigurationCheckDefinitionsInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.list_configuration_check_definitions_output.ListConfigurationCheckDefinitionsOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.list_configuration_check_definitions.list_configuration_check_definitions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_configuration_check_definitions(
        ...
        *,
        ...
        max_results: Optional["capo_ssm_sap.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_ssm_sap.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_ssm_sap.types.configuration_check_definition.ConfigurationCheckDefinition]":
        _token = next_token
        while True:
    ...
    def list_configuration_check_operations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.list_configuration_check_operations_input.ListConfigurationCheckOperationsInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.list_configuration_check_operations_output.ListConfigurationCheckOperationsOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.list_configuration_check_operations.list_configuration_check_operations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_configuration_check_operations(
        ...
        *,
        ...
        next_token: Optional["capo_ssm_sap.types.next_token.NextToken"] = None,
        filters: Optional["capo_ssm_sap.types.filter_list.FilterList"] = None,
    ) -> "Iterator[capo_ssm_sap.types.configuration_check_operation.ConfigurationCheckOperation]":
        _token = next_token
        while True:
    ...
    def list_databases(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.list_databases_input.ListDatabasesInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.list_databases_output.ListDatabasesOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.list_databases.list_databases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_databases(
        ...
        *,
        ...
        next_token: Optional["capo_ssm_sap.types.next_token.NextToken"] = None,
        max_results: Optional["capo_ssm_sap.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_ssm_sap.types.database_summary.DatabaseSummary]":
        _token = next_token
        while True:
    ...
    def list_operation_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.list_operation_events_input.ListOperationEventsInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.list_operation_events_output.ListOperationEventsOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.list_operation_events.list_operation_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_operation_events(
        ...
        *,
        ...
        next_token: Optional["capo_ssm_sap.types.next_token.NextToken"] = None,
        filters: Optional["capo_ssm_sap.types.filter_list.FilterList"] = None,
    ) -> "Iterator[capo_ssm_sap.types.operation_event.OperationEvent]":
        _token = next_token
        while True:
    ...
    def list_operations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.list_operations_input.ListOperationsInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.list_operations_output.ListOperationsOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.list_operations.list_operations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_operations(
        ...
        *,
        ...
        next_token: Optional["capo_ssm_sap.types.next_token.NextToken"] = None,
        filters: Optional["capo_ssm_sap.types.filter_list.FilterList"] = None,
    ) -> "Iterator[capo_ssm_sap.types.operation.Operation]":
        _token = next_token
        while True:
    ...
    def list_sub_check_results(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.list_sub_check_results_input.ListSubCheckResultsInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.list_sub_check_results_output.ListSubCheckResultsOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.list_sub_check_results.list_sub_check_results(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_sub_check_results(
        ...
        *,
        ...
        max_results: Optional["capo_ssm_sap.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_ssm_sap.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_ssm_sap.types.sub_check_result.SubCheckResult]":
        _token = next_token
        while True:
    ...
    def list_sub_check_rule_results(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.list_sub_check_rule_results_input.ListSubCheckRuleResultsInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.list_sub_check_rule_results_output.ListSubCheckRuleResultsOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.list_sub_check_rule_results.list_sub_check_rule_results(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_sub_check_rule_results(
        ...
        *,
        ...
        max_results: Optional["capo_ssm_sap.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_ssm_sap.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_ssm_sap.types.rule_result.RuleResult]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_resource_permission(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.put_resource_permission_input.PutResourcePermissionInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.put_resource_permission_output.PutResourcePermissionOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.put_resource_permission.put_resource_permission(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_application(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.register_application_input.RegisterApplicationInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.register_application_output.RegisterApplicationOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.register_application.register_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_application(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.start_application_input.StartApplicationInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.start_application_output.StartApplicationOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.start_application.start_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_application_refresh(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.start_application_refresh_input.StartApplicationRefreshInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.start_application_refresh_output.StartApplicationRefreshOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.start_application_refresh.start_application_refresh(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_configuration_checks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.start_configuration_checks_input.StartConfigurationChecksInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.start_configuration_checks_output.StartConfigurationChecksOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.start_configuration_checks.start_configuration_checks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_application(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.stop_application_input.StopApplicationInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.stop_application_output.StopApplicationOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.stop_application.stop_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_application_settings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_ssm_sap.types.update_application_settings_input.UpdateApplicationSettingsInput]",
        ) -> OperationResponse[
            "capo_ssm_sap.types.update_application_settings_output.UpdateApplicationSettingsOutput"
        ]:
            ...
            output, http_response = (
                capo_ssm_sap._operations.ssm_sap.update_application_settings.update_application_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
