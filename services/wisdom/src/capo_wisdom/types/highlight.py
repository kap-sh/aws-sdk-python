...
if TYPE_CHECKING:
    import capo_wisdom.types.highlight_offset


class Highlight(TypedDict, closed=True):
    begin_offset_inclusive: "capo_wisdom.types.highlight_offset.HighlightOffset"
    """<p>The offset for the start of the highlight.</p>"""
    end_offset_exclusive: "capo_wisdom.types.highlight_offset.HighlightOffset"
