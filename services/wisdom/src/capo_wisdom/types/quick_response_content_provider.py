...
if TYPE_CHECKING:
    import capo_wisdom.types.quick_response_content


class _QuickResponseContentProvider_content(TypedDict, closed=True):
    content: "capo_wisdom.types.quick_response_content.QuickResponseContent"
