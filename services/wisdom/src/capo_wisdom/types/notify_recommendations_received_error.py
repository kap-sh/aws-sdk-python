...
if TYPE_CHECKING:
    import capo_wisdom.types.notify_recommendations_received_error_message
...
class NotifyRecommendationsReceivedError(TypedDict, closed=True):
    ...
    message: NotRequired[
        "capo_wisdom.types.notify_recommendations_received_error_message.NotifyRecommendationsReceivedErrorMessage"
    ]
