...
from capo_wisdom._resources.wisdom_service.assistant import Assistant
from capo_wisdom._resources.wisdom_service.knowledge_base import KnowledgeBase
from capo_wisdom._services._aws_config import aws_config
...
class WisdomClientConfig(TypedDict, total=False, closed=True):
...
class WisdomClient:
    ...
    def __init__(
        ...
        self._config = WisdomClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: WisdomClientConfig = config_overrides or {}
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.list_tags_for_resource.list_tags_for_resource(
        ...
        input_: capo_wisdom.types.list_tags_for_resource_request.ListTagsForResourceRequest = {}  # type: ignore[typeddict-item]
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_wisdom.types.tag_resource_request.TagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_wisdom.types.untag_resource_request.UntagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
