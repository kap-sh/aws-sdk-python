...
import capo_wisdom.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_wisdom.errors.too_many_tags_exception.TooManyTagsException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_wisdom.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_wisdom.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
