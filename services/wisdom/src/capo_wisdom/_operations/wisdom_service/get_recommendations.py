"""Generated from Smithy shape ``com.amazonaws.wisdom#GetRecommendations``."""
...
def handle_response(
    ...
    out: capo_wisdom.types.get_recommendations_response.GetRecommendationsResponse = (
        capo_wisdom.types.get_recommendations_response.deserialize_json(
