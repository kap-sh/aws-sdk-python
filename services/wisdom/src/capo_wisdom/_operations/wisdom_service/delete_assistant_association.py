"""Generated from Smithy shape ``com.amazonaws.wisdom#DeleteAssistantAssociation``."""
...
def handle_response(
    ...
    out: capo_wisdom.types.delete_assistant_association_response.DeleteAssistantAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
