...
def handle_response(
    ...
    out: capo_wisdom.types.get_import_job_response.GetImportJobResponse = (
        capo_wisdom.types.get_import_job_response.deserialize_json(
...
def get_import_job(
    ...
    capo_wisdom.types.get_import_job_response.GetImportJobResponse, zapros.Response
]:
