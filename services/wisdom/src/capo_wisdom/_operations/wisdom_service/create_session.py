...
def handle_response(
    ...
    out: capo_wisdom.types.create_session_response.CreateSessionResponse = (
        capo_wisdom.types.create_session_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.create_session_request.serialize_json(input_)
    ).encode()
...
def create_session(
    ...
    capo_wisdom.types.create_session_response.CreateSessionResponse, zapros.Response
]:
