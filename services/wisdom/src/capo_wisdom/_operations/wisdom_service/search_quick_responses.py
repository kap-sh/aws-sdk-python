...
def handle_response(
    ...
    out: capo_wisdom.types.search_quick_responses_response.SearchQuickResponsesResponse = capo_wisdom.types.search_quick_responses_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.search_quick_responses_request.serialize_json(input_)
    ).encode()
