...
def handle_response(
    ...
    out: capo_wisdom.types.get_content_response.GetContentResponse = (
        capo_wisdom.types.get_content_response.deserialize_json(
...
def get_content(
    ...
    input_: capo_wisdom.types.get_content_request.GetContentRequest,
) -> tuple[capo_wisdom.types.get_content_response.GetContentResponse, zapros.Response]:
