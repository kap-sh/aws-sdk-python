...
import capo_wisdom.errors.precondition_failed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PreconditionFailedException":
            raise capo_wisdom.errors.precondition_failed_exception.PreconditionFailedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_wisdom.types.update_content_response.UpdateContentResponse = (
        capo_wisdom.types.update_content_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.update_content_request.serialize_json(input_)
    ).encode()
...
def update_content(
    ...
    capo_wisdom.types.update_content_response.UpdateContentResponse, zapros.Response
]:
