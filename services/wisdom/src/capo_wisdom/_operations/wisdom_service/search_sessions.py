"""Generated from Smithy shape ``com.amazonaws.wisdom#SearchSessions``."""
...
import capo_wisdom.types.session_summaries
...
def handle_response(
    ...
    out: capo_wisdom.types.search_sessions_response.SearchSessionsResponse = (
        capo_wisdom.types.search_sessions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.search_sessions_request.serialize_json(input_)
    ).encode()
...
def search_sessions(
    ...
    capo_wisdom.types.search_sessions_response.SearchSessionsResponse, zapros.Response
]:
