...
def handle_response(
    ...
    out: capo_wisdom.types.start_content_upload_response.StartContentUploadResponse = (
        capo_wisdom.types.start_content_upload_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.start_content_upload_request.serialize_json(input_)
    ).encode()
