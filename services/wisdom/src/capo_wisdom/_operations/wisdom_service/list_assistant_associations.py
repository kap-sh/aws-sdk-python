"""Generated from Smithy shape ``com.amazonaws.wisdom#ListAssistantAssociations``."""
...
import capo_wisdom.types.assistant_association_summary_list
...
def handle_response(
    ...
    out: capo_wisdom.types.list_assistant_associations_response.ListAssistantAssociationsResponse = capo_wisdom.types.list_assistant_associations_response.deserialize_json(
