"""Generated from Smithy shape ``com.amazonaws.wisdom#UntagResource``."""
...
def handle_response(
    ...
    out: capo_wisdom.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_wisdom.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
