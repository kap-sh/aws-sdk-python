"""Generated from Smithy shape ``com.amazonaws.wisdom#CreateAssistant``."""
...
def handle_response(
    ...
    out: capo_wisdom.types.create_assistant_response.CreateAssistantResponse = (
        capo_wisdom.types.create_assistant_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.create_assistant_request.serialize_json(input_)
    ).encode()
...
def create_assistant(
    ...
    capo_wisdom.types.create_assistant_response.CreateAssistantResponse, zapros.Response
]:
