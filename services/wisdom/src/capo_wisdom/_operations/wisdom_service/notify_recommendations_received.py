...
import capo_wisdom.types.notify_recommendations_received_error_list
...
def handle_response(
    ...
    out: capo_wisdom.types.notify_recommendations_received_response.NotifyRecommendationsReceivedResponse = capo_wisdom.types.notify_recommendations_received_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.notify_recommendations_received_request.serialize_json(input_)
    ).encode()
