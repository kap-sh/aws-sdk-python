"""Generated from Smithy shape ``com.amazonaws.wisdom#GetContentSummary``."""
...
def handle_response(
    ...
    out: capo_wisdom.types.get_content_summary_response.GetContentSummaryResponse = (
        capo_wisdom.types.get_content_summary_response.deserialize_json(
...
async def async_get_content_summary(
