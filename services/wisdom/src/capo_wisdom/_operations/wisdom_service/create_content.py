...
import capo_wisdom.errors.conflict_exception
import capo_wisdom.errors.resource_not_found_exception
import capo_wisdom.errors.service_quota_exceeded_exception
...
from capo_wisdom._services._pipeline import AsyncOperationOptions, OperationOptions
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_wisdom.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_wisdom.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_wisdom.types.create_content_response.CreateContentResponse = (
        capo_wisdom.types.create_content_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_wisdom._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.create_content_request.serialize_json(input_)
    ).encode()
...
def create_content(
    ...
    capo_wisdom.types.create_content_response.CreateContentResponse, zapros.Response
]:
