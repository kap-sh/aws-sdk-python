...
def handle_response(
    ...
    out: capo_wisdom.types.search_content_response.SearchContentResponse = (
        capo_wisdom.types.search_content_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.search_content_request.serialize_json(input_)
    ).encode()
...
def search_content(
    ...
    capo_wisdom.types.search_content_response.SearchContentResponse, zapros.Response
]:
