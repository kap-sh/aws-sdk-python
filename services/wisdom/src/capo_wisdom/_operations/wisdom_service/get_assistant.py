...
def handle_response(
    ...
    out: capo_wisdom.types.get_assistant_response.GetAssistantResponse = (
        capo_wisdom.types.get_assistant_response.deserialize_json(
...
def get_assistant(
    ...
    capo_wisdom.types.get_assistant_response.GetAssistantResponse, zapros.Response
]:
