...
class WisdomError(Exception):
    """Base class for all Wisdom service errors."""


class ServiceError(WisdomError):
...
class SerializationError(WisdomError):
    """Raised when a value cannot be serialized."""


class DeserializationError(WisdomError):
...
class WaiterFailedError(WisdomError):
...
class WaiterTimeoutError(WisdomError):
