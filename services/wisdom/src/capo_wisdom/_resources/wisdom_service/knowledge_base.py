...
class KnowledgeBase:
    ...
    def create(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.create_knowledge_base_request.CreateKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.create_knowledge_base_response.CreateKnowledgeBaseResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.create_knowledge_base.create_knowledge_base(
    ...
    def read(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.get_knowledge_base_request.GetKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.get_knowledge_base_response.GetKnowledgeBaseResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.get_knowledge_base.get_knowledge_base(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.delete_knowledge_base_request.DeleteKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.delete_knowledge_base.delete_knowledge_base(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.list_knowledge_bases_request.ListKnowledgeBasesRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.list_knowledge_bases_response.ListKnowledgeBasesResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.list_knowledge_bases.list_knowledge_bases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_import_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.delete_import_job_request.DeleteImportJobRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.delete_import_job_response.DeleteImportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.delete_import_job.delete_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_import_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.get_import_job_request.GetImportJobRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.get_import_job_response.GetImportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.get_import_job.get_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_import_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.list_import_jobs_request.ListImportJobsRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.list_import_jobs_response.ListImportJobsResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.list_import_jobs.list_import_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_knowledge_base_template_uri(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.remove_knowledge_base_template_uri_request.RemoveKnowledgeBaseTemplateUriRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.remove_knowledge_base_template_uri_response.RemoveKnowledgeBaseTemplateUriResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.remove_knowledge_base_template_uri.remove_knowledge_base_template_uri(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def search_content(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.search_content_request.SearchContentRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.search_content_response.SearchContentResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.search_content.search_content(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def search_quick_responses(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.search_quick_responses_request.SearchQuickResponsesRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.search_quick_responses_response.SearchQuickResponsesResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.search_quick_responses.search_quick_responses(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_content_upload(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.start_content_upload_request.StartContentUploadRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.start_content_upload_response.StartContentUploadResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.start_content_upload.start_content_upload(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_import_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.start_import_job_request.StartImportJobRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.start_import_job_response.StartImportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.start_import_job.start_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_knowledge_base_template_uri(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_wisdom.types.update_knowledge_base_template_uri_request.UpdateKnowledgeBaseTemplateUriRequest]",
        ) -> OperationResponse[
            "capo_wisdom.types.update_knowledge_base_template_uri_response.UpdateKnowledgeBaseTemplateUriResponse"
        ]:
            ...
            output, http_response = (
                capo_wisdom._operations.wisdom_service.update_knowledge_base_template_uri.update_knowledge_base_template_uri(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
