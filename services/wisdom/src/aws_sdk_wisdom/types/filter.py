...
if TYPE_CHECKING:
    import aws_sdk_wisdom.types.filter_field
    import aws_sdk_wisdom.types.filter_operator
    import aws_sdk_wisdom.types.non_empty_string


class Filter(TypedDict, closed=True):
    field: "aws_sdk_wisdom.types.filter_field.FilterField"
    """<p>The field on which to filter.</p>"""
    operator: "aws_sdk_wisdom.types.filter_operator.FilterOperator"
    """<p>The operator to use for comparing the field’s value with the provided value.</p>"""
    value: "aws_sdk_wisdom.types.non_empty_string.NonEmptyString"
