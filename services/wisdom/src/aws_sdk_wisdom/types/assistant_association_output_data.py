...
def serialize_json(value: AssistantAssociationOutputData) -> dict:
    if "knowledgeBaseAssociation" in value:
        ...
        return {
            "knowledgeBaseAssociation": aws_sdk_wisdom.types.knowledge_base_association_data.serialize_json(
...
def deserialize_json(data: dict) -> AssistantAssociationOutputData:
    if "knowledgeBaseAssociation" in data:
        ...
        return {
            "knowledgeBaseAssociation": aws_sdk_wisdom.types.knowledge_base_association_data.deserialize_json(
