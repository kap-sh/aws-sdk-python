...
AssistantAssociationInputData: TypeAlias = _AssistantAssociationInputData_knowledgeBaseId
...
def deserialize_json(data: dict) -> AssistantAssociationInputData:
    if "knowledgeBaseId" in data:
        ...
        raise DeserializationError("AssistantAssociationInputData: no recognized variant key")