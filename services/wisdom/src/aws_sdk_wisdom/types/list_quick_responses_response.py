...
class ListQuickResponsesResponse(TypedDict):
    quick_response_summaries: (
        "aws_sdk_wisdom.types.quick_response_summary_list.QuickResponseSummaryList"
    )
...
def serialize_json(value: ListQuickResponsesResponse) -> dict:
    ...
    out["quickResponseSummaries"] = (
        aws_sdk_wisdom.types.quick_response_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListQuickResponsesResponse:
    ...
    if "quickResponseSummaries" in data:
        ...
        out["quick_response_summaries"] = (
            aws_sdk_wisdom.types.quick_response_summary_list.deserialize_json(
