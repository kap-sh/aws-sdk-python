...
QuickResponseSearchResultsList: TypeAlias = list[
    "aws_sdk_wisdom.types.quick_response_search_result_data.QuickResponseSearchResultData"
]
...
def serialize_json(value: QuickResponseSearchResultsList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_wisdom.types.quick_response_search_result_data.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> QuickResponseSearchResultsList:
    ...
    for item in data:
        out.append(
            aws_sdk_wisdom.types.quick_response_search_result_data.deserialize_json(
                item
            )
        )
    return out
