...
if TYPE_CHECKING:
    ...
    import aws_sdk_wisdom.types.recommendation_type
    import aws_sdk_wisdom.types.relevance_level
...
class RecommendationData(TypedDict, closed=True):
    ...
    relevance_level: NotRequired["aws_sdk_wisdom.types.relevance_level.RelevanceLevel"]
    """<p>The relevance level of the recommendation.</p>"""
    type: NotRequired["aws_sdk_wisdom.types.recommendation_type.RecommendationType"]
