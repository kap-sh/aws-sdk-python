...
if TYPE_CHECKING:
    ...
    import aws_sdk_wisdom.types.session_summaries


class SearchSessionsResponse(TypedDict, closed=True):
    session_summaries: "aws_sdk_wisdom.types.session_summaries.SessionSummaries"
...
def serialize_json(value: SearchSessionsResponse) -> dict:
    ...
    out["sessionSummaries"] = aws_sdk_wisdom.types.session_summaries.serialize_json(
...
def deserialize_json(data: dict) -> SearchSessionsResponse:
    ...
    if "sessionSummaries" in data:
        ...
        out["session_summaries"] = (
            aws_sdk_wisdom.types.session_summaries.deserialize_json(
