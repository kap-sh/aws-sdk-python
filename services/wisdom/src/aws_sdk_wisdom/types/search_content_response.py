...
class SearchContentResponse(TypedDict):
    content_summaries: "aws_sdk_wisdom.types.content_summary_list.ContentSummaryList"
...
def serialize_json(value: SearchContentResponse) -> dict:
    ...
    out["contentSummaries"] = aws_sdk_wisdom.types.content_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> SearchContentResponse:
    ...
    if "contentSummaries" in data:
        ...
        out["content_summaries"] = (
            aws_sdk_wisdom.types.content_summary_list.deserialize_json(
