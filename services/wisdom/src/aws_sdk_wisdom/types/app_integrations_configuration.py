...
class AppIntegrationsConfiguration(TypedDict):
    ...
    object_fields: NotRequired["aws_sdk_wisdom.types.object_fields_list.ObjectFieldsList"]
...
def serialize_json(value: AppIntegrationsConfiguration) -> dict:
    ...
    if "object_fields" in value:
        import aws_sdk_wisdom.types.object_fields_list
        out["objectFields"] = aws_sdk_wisdom.types.object_fields_list.serialize_json(value["object_fields"])
    return out
...
def deserialize_json(data: dict) -> AppIntegrationsConfiguration:
    ...
    if "appIntegrationArn" in data:
        ...
        raise DeserializationError("AppIntegrationsConfiguration.app_integration_arn required")
    if "objectFields" in data:
        import aws_sdk_wisdom.types.object_fields_list
        out["object_fields"] = aws_sdk_wisdom.types.object_fields_list.deserialize_json(data["objectFields"])
    return out