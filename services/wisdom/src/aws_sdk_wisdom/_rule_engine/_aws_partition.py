...
_PARTITION_AWS: dict[str, Any] = {'dnsSuffix': 'amazonaws.com',
 'dualStackDnsSuffix': 'api.aws',
 'implicitGlobalRegion': 'us-east-1',
 'name': 'aws',
 'supportsDualStack': True,
 'supportsFIPS': True}
_PARTITION_AWS_CN: dict[str, Any] = {'dnsSuffix': 'amazonaws.com.cn',
 'dualStackDnsSuffix': 'api.amazonwebservices.com.cn',
 'implicitGlobalRegion': 'cn-northwest-1',
 'name': 'aws-cn',
 'supportsDualStack': True,
 'supportsFIPS': True}
_PARTITION_AWS_EUSC: dict[str, Any] = {'dnsSuffix': 'amazonaws.eu',
 'dualStackDnsSuffix': 'api.amazonwebservices.eu',
 'implicitGlobalRegion': 'eusc-de-east-1',
 'name': 'aws-eusc',
 'supportsDualStack': True,
 'supportsFIPS': True}
_PARTITION_AWS_ISO: dict[str, Any] = {'dnsSuffix': 'c2s.ic.gov',
 'dualStackDnsSuffix': 'api.aws.ic.gov',
 'implicitGlobalRegion': 'us-iso-east-1',
 'name': 'aws-iso',
 'supportsDualStack': True,
 'supportsFIPS': True}
_PARTITION_AWS_ISO_B: dict[str, Any] = {'dnsSuffix': 'sc2s.sgov.gov',
 'dualStackDnsSuffix': 'api.aws.scloud',
 'implicitGlobalRegion': 'us-isob-east-1',
 'name': 'aws-iso-b',
 'supportsDualStack': True,
 'supportsFIPS': True}
_PARTITION_AWS_ISO_E: dict[str, Any] = {'dnsSuffix': 'cloud.adc-e.uk',
 'dualStackDnsSuffix': 'api.cloud-aws.adc-e.uk',
 'implicitGlobalRegion': 'eu-isoe-west-1',
 'name': 'aws-iso-e',
 'supportsDualStack': True,
 'supportsFIPS': True}
_PARTITION_AWS_ISO_F: dict[str, Any] = {'dnsSuffix': 'csp.hci.ic.gov',
 'dualStackDnsSuffix': 'api.aws.hci.ic.gov',
 'implicitGlobalRegion': 'us-isof-south-1',
 'name': 'aws-iso-f',
 'supportsDualStack': True,
 'supportsFIPS': True}
_PARTITION_AWS_US_GOV: dict[str, Any] = {'dnsSuffix': 'amazonaws.com',
 'dualStackDnsSuffix': 'api.aws',
