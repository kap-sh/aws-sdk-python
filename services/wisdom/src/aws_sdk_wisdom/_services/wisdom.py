...
from aws_sdk_wisdom._services._aws_config import aws_config
...
class WisdomClientConfig(TypedDict, total=False):
...
class WisdomClient:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_wisdom.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_wisdom.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_wisdom._operations.wisdom_service.list_tags_for_resource.list_tags_for_resource(
    ...
    def tag_resource(
        ...
        *,
        ...
        Raises:
            aws_sdk_wisdom.errors.resource_not_found_exception.ResourceNotFoundException: <p>The specified resource does not exist.</p>
            aws_sdk_wisdom.errors.too_many_tags_exception.TooManyTagsException: <p>Amazon Connect Wisdom throws this exception if you have too many tags in your tag set.</p>
            aws_sdk_wisdom.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_wisdom.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_wisdom.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_wisdom._operations.wisdom_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_wisdom.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_wisdom.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_wisdom._operations.wisdom_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
