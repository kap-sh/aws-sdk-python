...
```
pip install aws-sdk-wisdom
```

## Usage

```python
from aws_sdk_wisdom import AsyncWisdomClient


async def main():
    async with AsyncWisdomClient() as s3:
...
```python
from aws_sdk_wisdom import AsyncWisdomClient
from aws_sdk_wisdom.error import ResourceNotFoundException
