...
if TYPE_CHECKING:
    ...
    import capo_drs.types.failback_launch_type
    import capo_drs.types.failback_state
...
class RecoveryInstanceFailback(TypedDict, closed=True):
    failback_client_id: NotRequired["capo_drs.types.bounded_string.BoundedString"]
    """<p>The ID of the failback client that this Recovery Instance is associated with.</p>"""
    failback_job_id: NotRequired["capo_drs.types.job_id.JobID"]
    ...
    state: NotRequired["capo_drs.types.failback_state.FailbackState"]
    ...
    failback_launch_type: NotRequired[
        "capo_drs.types.failback_launch_type.FailbackLaunchType"
    ]
