...
if TYPE_CHECKING:
    ...
    import capo_drs.types.iso8601_duration_string
...
class LifeCycle(TypedDict, closed=True):
    ...
    elapsed_replication_duration: NotRequired[
        "capo_drs.types.iso8601_duration_string.ISO8601DurationString"
    ]
    ...
    last_launch: NotRequired[
        "capo_drs.types.life_cycle_last_launch.LifeCycleLastLaunch"
    ]
...
def serialize_json(value: LifeCycle) -> dict:
    ...
    if "last_launch" in value:
        ...
        out["lastLaunch"] = capo_drs.types.life_cycle_last_launch.serialize_json(
            value["last_launch"]
        )
    return out
