...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.stop_failback_request.StopFailbackRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.stop_failback_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.stop_failback_request.serialize_json(input)).encode()
...
def stop_failback(options: OperationOptions, input: aws_sdk_drs.types.stop_failback_request.StopFailbackRequest) -> tuple[None, zapros.Response]:
...
async def async_stop_failback(options: AsyncOperationOptions, input: aws_sdk_drs.types.stop_failback_request.StopFailbackRequest) -> tuple[None, zapros.Response]:
