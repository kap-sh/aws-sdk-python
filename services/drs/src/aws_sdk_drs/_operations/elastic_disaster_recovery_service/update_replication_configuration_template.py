...
def build_request(
    ...
    input_: aws_sdk_drs.types.update_replication_configuration_template_request.UpdateReplicationConfigurationTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.update_replication_configuration_template_request.serialize_json(
            input_
        )
    ).encode()
