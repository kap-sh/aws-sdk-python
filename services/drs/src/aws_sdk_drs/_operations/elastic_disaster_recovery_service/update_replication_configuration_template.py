...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.update_replication_configuration_template_request.UpdateReplicationConfigurationTemplateRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.update_replication_configuration_template_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.update_replication_configuration_template_request.serialize_json(input)).encode()
...
def update_replication_configuration_template(options: OperationOptions, input: aws_sdk_drs.types.update_replication_configuration_template_request.UpdateReplicationConfigurationTemplateRequest) -> tuple[aws_sdk_drs.types.replication_configuration_template.ReplicationConfigurationTemplate, zapros.Response]:
