...
def handle_response(
    ...
    out: aws_sdk_drs.types.create_extended_source_server_response.CreateExtendedSourceServerResponse = aws_sdk_drs.types.create_extended_source_server_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.create_extended_source_server_request.CreateExtendedSourceServerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.create_extended_source_server_request.serialize_json(input_)
    ).encode()
