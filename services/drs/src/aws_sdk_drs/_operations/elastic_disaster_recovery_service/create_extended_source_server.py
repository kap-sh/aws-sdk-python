...
def build_request(
    ...
    input: aws_sdk_drs.types.create_extended_source_server_request.CreateExtendedSourceServerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.create_extended_source_server_request.serialize_json(input)
    ).encode()
