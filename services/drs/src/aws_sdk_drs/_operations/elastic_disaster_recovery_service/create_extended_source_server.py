...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.create_extended_source_server_response.CreateExtendedSourceServerResponse:
    import aws_sdk_drs.types.create_extended_source_server_response
    out: aws_sdk_drs.types.create_extended_source_server_response.CreateExtendedSourceServerResponse = aws_sdk_drs.types.create_extended_source_server_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.create_extended_source_server_request.CreateExtendedSourceServerRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.create_extended_source_server_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.create_extended_source_server_request.serialize_json(input)).encode()
...
def create_extended_source_server(options: OperationOptions, input: aws_sdk_drs.types.create_extended_source_server_request.CreateExtendedSourceServerRequest) -> tuple[aws_sdk_drs.types.create_extended_source_server_response.CreateExtendedSourceServerResponse, zapros.Response]:
...
async def async_create_extended_source_server(options: AsyncOperationOptions, input: aws_sdk_drs.types.create_extended_source_server_request.CreateExtendedSourceServerRequest) -> tuple[aws_sdk_drs.types.create_extended_source_server_response.CreateExtendedSourceServerResponse, zapros.Response]:
