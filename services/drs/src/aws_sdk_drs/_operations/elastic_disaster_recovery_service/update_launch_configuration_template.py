"""Generated from Smithy shape ``com.amazonaws.drs#UpdateLaunchConfigurationTemplate``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.update_launch_configuration_template_response.UpdateLaunchConfigurationTemplateResponse:
    import aws_sdk_drs.types.update_launch_configuration_template_response
    out: aws_sdk_drs.types.update_launch_configuration_template_response.UpdateLaunchConfigurationTemplateResponse = aws_sdk_drs.types.update_launch_configuration_template_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.update_launch_configuration_template_request.UpdateLaunchConfigurationTemplateRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.update_launch_configuration_template_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.update_launch_configuration_template_request.serialize_json(input)).encode()
...
def update_launch_configuration_template(options: OperationOptions, input: aws_sdk_drs.types.update_launch_configuration_template_request.UpdateLaunchConfigurationTemplateRequest) -> tuple[aws_sdk_drs.types.update_launch_configuration_template_response.UpdateLaunchConfigurationTemplateResponse, zapros.Response]:
...
async def async_update_launch_configuration_template(options: AsyncOperationOptions, input: aws_sdk_drs.types.update_launch_configuration_template_request.UpdateLaunchConfigurationTemplateRequest) -> tuple[aws_sdk_drs.types.update_launch_configuration_template_response.UpdateLaunchConfigurationTemplateResponse, zapros.Response]:
