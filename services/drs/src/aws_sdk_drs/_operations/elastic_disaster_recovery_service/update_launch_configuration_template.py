...
) -> aws_sdk_drs.types.update_launch_configuration_template_response.UpdateLaunchConfigurationTemplateResponse:
    out: aws_sdk_drs.types.update_launch_configuration_template_response.UpdateLaunchConfigurationTemplateResponse = aws_sdk_drs.types.update_launch_configuration_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.update_launch_configuration_template_request.UpdateLaunchConfigurationTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.update_launch_configuration_template_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_launch_configuration_template(
