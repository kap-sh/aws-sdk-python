...
def handle_response(
    ...
    out: aws_sdk_drs.types.start_replication_response.StartReplicationResponse = (
        aws_sdk_drs.types.start_replication_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.start_replication_request.StartReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.start_replication_request.serialize_json(input_)
    ).encode()
