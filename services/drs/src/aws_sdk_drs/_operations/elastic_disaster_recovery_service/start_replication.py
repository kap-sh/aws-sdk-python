...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.start_replication_response.StartReplicationResponse:
    import aws_sdk_drs.types.start_replication_response
    out: aws_sdk_drs.types.start_replication_response.StartReplicationResponse = aws_sdk_drs.types.start_replication_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.start_replication_request.StartReplicationRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.start_replication_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.start_replication_request.serialize_json(input)).encode()
...
def start_replication(options: OperationOptions, input: aws_sdk_drs.types.start_replication_request.StartReplicationRequest) -> tuple[aws_sdk_drs.types.start_replication_response.StartReplicationResponse, zapros.Response]:
...
async def async_start_replication(options: AsyncOperationOptions, input: aws_sdk_drs.types.start_replication_request.StartReplicationRequest) -> tuple[aws_sdk_drs.types.start_replication_response.StartReplicationResponse, zapros.Response]:
