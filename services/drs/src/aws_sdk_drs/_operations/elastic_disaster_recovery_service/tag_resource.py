"""Generated from Smithy shape ``com.amazonaws.drs#TagResource``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.tag_resource_request.TagResourceRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.tag_resource_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.tag_resource_request.serialize_json(input)).encode()
...
def tag_resource(options: OperationOptions, input: aws_sdk_drs.types.tag_resource_request.TagResourceRequest) -> tuple[None, zapros.Response]:
...
async def async_tag_resource(options: AsyncOperationOptions, input: aws_sdk_drs.types.tag_resource_request.TagResourceRequest) -> tuple[None, zapros.Response]:
