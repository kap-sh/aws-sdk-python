...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.initialize_service_response.InitializeServiceResponse:
    out: aws_sdk_drs.types.initialize_service_response.InitializeServiceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.initialize_service_request.InitializeServiceRequest) -> zapros.Request:
...
def initialize_service(options: OperationOptions, input: aws_sdk_drs.types.initialize_service_request.InitializeServiceRequest) -> tuple[aws_sdk_drs.types.initialize_service_response.InitializeServiceResponse, zapros.Response]:
...
async def async_initialize_service(options: AsyncOperationOptions, input: aws_sdk_drs.types.initialize_service_request.InitializeServiceRequest) -> tuple[aws_sdk_drs.types.initialize_service_response.InitializeServiceResponse, zapros.Response]:
