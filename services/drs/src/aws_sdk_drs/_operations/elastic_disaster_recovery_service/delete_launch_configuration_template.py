...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.delete_launch_configuration_template_response.DeleteLaunchConfigurationTemplateResponse:
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.delete_launch_configuration_template_request.DeleteLaunchConfigurationTemplateRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.delete_launch_configuration_template_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.delete_launch_configuration_template_request.serialize_json(input)).encode()
...
def delete_launch_configuration_template(options: OperationOptions, input: aws_sdk_drs.types.delete_launch_configuration_template_request.DeleteLaunchConfigurationTemplateRequest) -> tuple[aws_sdk_drs.types.delete_launch_configuration_template_response.DeleteLaunchConfigurationTemplateResponse, zapros.Response]:
...
async def async_delete_launch_configuration_template(options: AsyncOperationOptions, input: aws_sdk_drs.types.delete_launch_configuration_template_request.DeleteLaunchConfigurationTemplateRequest) -> tuple[aws_sdk_drs.types.delete_launch_configuration_template_response.DeleteLaunchConfigurationTemplateResponse, zapros.Response]:
