...
def build_request(
    ...
    input: aws_sdk_drs.types.list_extensible_source_servers_request.ListExtensibleSourceServersRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.list_extensible_source_servers_request.serialize_json(input)
    ).encode()
