...
def handle_response(
    ...
    out: aws_sdk_drs.types.list_extensible_source_servers_response.ListExtensibleSourceServersResponse = aws_sdk_drs.types.list_extensible_source_servers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.list_extensible_source_servers_request.ListExtensibleSourceServersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.list_extensible_source_servers_request.serialize_json(input_)
    ).encode()
