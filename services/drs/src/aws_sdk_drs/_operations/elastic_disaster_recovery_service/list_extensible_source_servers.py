...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.list_extensible_source_servers_response.ListExtensibleSourceServersResponse:
    import aws_sdk_drs.types.list_extensible_source_servers_response
    out: aws_sdk_drs.types.list_extensible_source_servers_response.ListExtensibleSourceServersResponse = aws_sdk_drs.types.list_extensible_source_servers_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.list_extensible_source_servers_request.ListExtensibleSourceServersRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.list_extensible_source_servers_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.list_extensible_source_servers_request.serialize_json(input)).encode()
...
def list_extensible_source_servers(options: OperationOptions, input: aws_sdk_drs.types.list_extensible_source_servers_request.ListExtensibleSourceServersRequest) -> tuple[aws_sdk_drs.types.list_extensible_source_servers_response.ListExtensibleSourceServersResponse, zapros.Response]:
...
async def async_list_extensible_source_servers(options: AsyncOperationOptions, input: aws_sdk_drs.types.list_extensible_source_servers_request.ListExtensibleSourceServersRequest) -> tuple[aws_sdk_drs.types.list_extensible_source_servers_response.ListExtensibleSourceServersResponse, zapros.Response]:
