...
def handle_response(
    ...
    out: aws_sdk_drs.types.create_source_network_response.CreateSourceNetworkResponse = aws_sdk_drs.types.create_source_network_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_drs.types.create_source_network_request.CreateSourceNetworkRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.create_source_network_request.serialize_json(input)
    ).encode()
