...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.create_source_network_response.CreateSourceNetworkResponse:
    import aws_sdk_drs.types.create_source_network_response
    out: aws_sdk_drs.types.create_source_network_response.CreateSourceNetworkResponse = aws_sdk_drs.types.create_source_network_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.create_source_network_request.CreateSourceNetworkRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.create_source_network_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.create_source_network_request.serialize_json(input)).encode()
...
def create_source_network(options: OperationOptions, input: aws_sdk_drs.types.create_source_network_request.CreateSourceNetworkRequest) -> tuple[aws_sdk_drs.types.create_source_network_response.CreateSourceNetworkResponse, zapros.Response]:
...
async def async_create_source_network(options: AsyncOperationOptions, input: aws_sdk_drs.types.create_source_network_request.CreateSourceNetworkRequest) -> tuple[aws_sdk_drs.types.create_source_network_response.CreateSourceNetworkResponse, zapros.Response]:
