"""Generated from Smithy shape ``com.amazonaws.drs#DescribeReplicationConfigurationTemplates``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.describe_replication_configuration_templates_response.DescribeReplicationConfigurationTemplatesResponse:
    import aws_sdk_drs.types.describe_replication_configuration_templates_response
    out: aws_sdk_drs.types.describe_replication_configuration_templates_response.DescribeReplicationConfigurationTemplatesResponse = aws_sdk_drs.types.describe_replication_configuration_templates_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.describe_replication_configuration_templates_request.DescribeReplicationConfigurationTemplatesRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/DescribeReplicationConfigurationTemplates"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_drs.types.describe_replication_configuration_templates_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.describe_replication_configuration_templates_request.serialize_json(input)).encode()
...
def describe_replication_configuration_templates(options: OperationOptions, input: aws_sdk_drs.types.describe_replication_configuration_templates_request.DescribeReplicationConfigurationTemplatesRequest) -> tuple[aws_sdk_drs.types.describe_replication_configuration_templates_response.DescribeReplicationConfigurationTemplatesResponse, zapros.Response]:
...
async def async_describe_replication_configuration_templates(options: AsyncOperationOptions, input: aws_sdk_drs.types.describe_replication_configuration_templates_request.DescribeReplicationConfigurationTemplatesRequest) -> tuple[aws_sdk_drs.types.describe_replication_configuration_templates_response.DescribeReplicationConfigurationTemplatesResponse, zapros.Response]:
