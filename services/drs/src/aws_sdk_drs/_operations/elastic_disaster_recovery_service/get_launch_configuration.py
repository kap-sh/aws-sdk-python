...
def build_request(
    ...
    input_: aws_sdk_drs.types.get_launch_configuration_request.GetLaunchConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.get_launch_configuration_request.serialize_json(input_)
    ).encode()
