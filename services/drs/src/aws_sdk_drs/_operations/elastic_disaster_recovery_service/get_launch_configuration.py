...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.get_launch_configuration_request.GetLaunchConfigurationRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.get_launch_configuration_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.get_launch_configuration_request.serialize_json(input)).encode()
...
def get_launch_configuration(options: OperationOptions, input: aws_sdk_drs.types.get_launch_configuration_request.GetLaunchConfigurationRequest) -> tuple[aws_sdk_drs.types.launch_configuration.LaunchConfiguration, zapros.Response]:
...
async def async_get_launch_configuration(options: AsyncOperationOptions, input: aws_sdk_drs.types.get_launch_configuration_request.GetLaunchConfigurationRequest) -> tuple[aws_sdk_drs.types.launch_configuration.LaunchConfiguration, zapros.Response]:
