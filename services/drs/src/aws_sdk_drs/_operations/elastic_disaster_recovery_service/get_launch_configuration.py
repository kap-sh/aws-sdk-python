...
def build_request(
    ...
    input: aws_sdk_drs.types.get_launch_configuration_request.GetLaunchConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.get_launch_configuration_request.serialize_json(input)
    ).encode()
