...
def handle_response(
    ...
    out: aws_sdk_drs.types.describe_job_log_items_response.DescribeJobLogItemsResponse = aws_sdk_drs.types.describe_job_log_items_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_drs.types.describe_job_log_items_request.DescribeJobLogItemsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.describe_job_log_items_request.serialize_json(input)
    ).encode()
