...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.describe_job_log_items_response.DescribeJobLogItemsResponse:
    import aws_sdk_drs.types.describe_job_log_items_response
    out: aws_sdk_drs.types.describe_job_log_items_response.DescribeJobLogItemsResponse = aws_sdk_drs.types.describe_job_log_items_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.describe_job_log_items_request.DescribeJobLogItemsRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.describe_job_log_items_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.describe_job_log_items_request.serialize_json(input)).encode()
...
def describe_job_log_items(options: OperationOptions, input: aws_sdk_drs.types.describe_job_log_items_request.DescribeJobLogItemsRequest) -> tuple[aws_sdk_drs.types.describe_job_log_items_response.DescribeJobLogItemsResponse, zapros.Response]:
...
async def async_describe_job_log_items(options: AsyncOperationOptions, input: aws_sdk_drs.types.describe_job_log_items_request.DescribeJobLogItemsRequest) -> tuple[aws_sdk_drs.types.describe_job_log_items_response.DescribeJobLogItemsResponse, zapros.Response]:
