...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.disconnect_recovery_instance_request.DisconnectRecoveryInstanceRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.disconnect_recovery_instance_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.disconnect_recovery_instance_request.serialize_json(input)).encode()
...
def disconnect_recovery_instance(options: OperationOptions, input: aws_sdk_drs.types.disconnect_recovery_instance_request.DisconnectRecoveryInstanceRequest) -> tuple[None, zapros.Response]:
...
async def async_disconnect_recovery_instance(options: AsyncOperationOptions, input: aws_sdk_drs.types.disconnect_recovery_instance_request.DisconnectRecoveryInstanceRequest) -> tuple[None, zapros.Response]:
