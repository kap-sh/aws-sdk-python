...
def build_request(
    ...
    input: aws_sdk_drs.types.disconnect_recovery_instance_request.DisconnectRecoveryInstanceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.disconnect_recovery_instance_request.serialize_json(input)
    ).encode()
