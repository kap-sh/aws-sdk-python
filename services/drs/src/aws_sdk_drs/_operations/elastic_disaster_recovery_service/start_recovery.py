"""Generated from Smithy shape ``com.amazonaws.drs#StartRecovery``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.start_recovery_response.StartRecoveryResponse:
    import aws_sdk_drs.types.start_recovery_response
    out: aws_sdk_drs.types.start_recovery_response.StartRecoveryResponse = aws_sdk_drs.types.start_recovery_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.start_recovery_request.StartRecoveryRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/StartRecovery"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_drs.types.start_recovery_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.start_recovery_request.serialize_json(input)).encode()
...
def start_recovery(options: OperationOptions, input: aws_sdk_drs.types.start_recovery_request.StartRecoveryRequest) -> tuple[aws_sdk_drs.types.start_recovery_response.StartRecoveryResponse, zapros.Response]:
...
async def async_start_recovery(options: AsyncOperationOptions, input: aws_sdk_drs.types.start_recovery_request.StartRecoveryRequest) -> tuple[aws_sdk_drs.types.start_recovery_response.StartRecoveryResponse, zapros.Response]:
