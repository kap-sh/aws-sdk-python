...
def handle_response(
    ...
    out: aws_sdk_drs.types.start_recovery_response.StartRecoveryResponse = (
        aws_sdk_drs.types.start_recovery_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.start_recovery_request.StartRecoveryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.start_recovery_request.serialize_json(input_)
    ).encode()
...
def start_recovery(
    ...
    aws_sdk_drs.types.start_recovery_response.StartRecoveryResponse, zapros.Response
]:
...
async def async_start_recovery(
