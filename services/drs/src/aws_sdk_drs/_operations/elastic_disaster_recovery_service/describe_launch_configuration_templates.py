...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.describe_launch_configuration_templates_response.DescribeLaunchConfigurationTemplatesResponse:
    import aws_sdk_drs.types.describe_launch_configuration_templates_response
    out: aws_sdk_drs.types.describe_launch_configuration_templates_response.DescribeLaunchConfigurationTemplatesResponse = aws_sdk_drs.types.describe_launch_configuration_templates_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.describe_launch_configuration_templates_request.DescribeLaunchConfigurationTemplatesRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.describe_launch_configuration_templates_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.describe_launch_configuration_templates_request.serialize_json(input)).encode()
...
def describe_launch_configuration_templates(options: OperationOptions, input: aws_sdk_drs.types.describe_launch_configuration_templates_request.DescribeLaunchConfigurationTemplatesRequest) -> tuple[aws_sdk_drs.types.describe_launch_configuration_templates_response.DescribeLaunchConfigurationTemplatesResponse, zapros.Response]:
...
async def async_describe_launch_configuration_templates(options: AsyncOperationOptions, input: aws_sdk_drs.types.describe_launch_configuration_templates_request.DescribeLaunchConfigurationTemplatesRequest) -> tuple[aws_sdk_drs.types.describe_launch_configuration_templates_response.DescribeLaunchConfigurationTemplatesResponse, zapros.Response]:
