...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.list_launch_actions_response.ListLaunchActionsResponse:
    import aws_sdk_drs.types.list_launch_actions_response
    out: aws_sdk_drs.types.list_launch_actions_response.ListLaunchActionsResponse = aws_sdk_drs.types.list_launch_actions_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.list_launch_actions_request.ListLaunchActionsRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.list_launch_actions_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.list_launch_actions_request.serialize_json(input)).encode()
...
def list_launch_actions(options: OperationOptions, input: aws_sdk_drs.types.list_launch_actions_request.ListLaunchActionsRequest) -> tuple[aws_sdk_drs.types.list_launch_actions_response.ListLaunchActionsResponse, zapros.Response]:
...
async def async_list_launch_actions(options: AsyncOperationOptions, input: aws_sdk_drs.types.list_launch_actions_request.ListLaunchActionsRequest) -> tuple[aws_sdk_drs.types.list_launch_actions_response.ListLaunchActionsResponse, zapros.Response]:
