...
def handle_response(
    ...
    out: aws_sdk_drs.types.list_launch_actions_response.ListLaunchActionsResponse = (
        aws_sdk_drs.types.list_launch_actions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.list_launch_actions_request.ListLaunchActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.list_launch_actions_request.serialize_json(input_)
    ).encode()
