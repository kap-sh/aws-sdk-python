...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.delete_source_network_response.DeleteSourceNetworkResponse:
    out: aws_sdk_drs.types.delete_source_network_response.DeleteSourceNetworkResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.delete_source_network_request.DeleteSourceNetworkRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.delete_source_network_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.delete_source_network_request.serialize_json(input)).encode()
...
def delete_source_network(options: OperationOptions, input: aws_sdk_drs.types.delete_source_network_request.DeleteSourceNetworkRequest) -> tuple[aws_sdk_drs.types.delete_source_network_response.DeleteSourceNetworkResponse, zapros.Response]:
...
async def async_delete_source_network(options: AsyncOperationOptions, input: aws_sdk_drs.types.delete_source_network_request.DeleteSourceNetworkRequest) -> tuple[aws_sdk_drs.types.delete_source_network_response.DeleteSourceNetworkResponse, zapros.Response]:
