...
def build_request(
    ...
    input_: aws_sdk_drs.types.delete_source_network_request.DeleteSourceNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.delete_source_network_request.serialize_json(input_)
    ).encode()
