...
def handle_response(
    ...
    out: aws_sdk_drs.types.launch_configuration.LaunchConfiguration = (
        aws_sdk_drs.types.launch_configuration.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.update_launch_configuration_request.UpdateLaunchConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.update_launch_configuration_request.serialize_json(input_)
    ).encode()
...
def update_launch_configuration(
    ...
    input_: aws_sdk_drs.types.update_launch_configuration_request.UpdateLaunchConfigurationRequest,
) -> tuple[aws_sdk_drs.types.launch_configuration.LaunchConfiguration, zapros.Response]:
...
async def async_update_launch_configuration(
