...
def build_request(
    ...
    input: aws_sdk_drs.types.update_launch_configuration_request.UpdateLaunchConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.update_launch_configuration_request.serialize_json(input)
    ).encode()
