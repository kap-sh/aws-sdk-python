"""Generated from Smithy shape ``com.amazonaws.drs#UpdateLaunchConfiguration``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.launch_configuration.LaunchConfiguration:
    import aws_sdk_drs.types.launch_configuration
    out: aws_sdk_drs.types.launch_configuration.LaunchConfiguration = aws_sdk_drs.types.launch_configuration.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.update_launch_configuration_request.UpdateLaunchConfigurationRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.update_launch_configuration_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.update_launch_configuration_request.serialize_json(input)).encode()
...
def update_launch_configuration(options: OperationOptions, input: aws_sdk_drs.types.update_launch_configuration_request.UpdateLaunchConfigurationRequest) -> tuple[aws_sdk_drs.types.launch_configuration.LaunchConfiguration, zapros.Response]:
...
async def async_update_launch_configuration(options: AsyncOperationOptions, input: aws_sdk_drs.types.update_launch_configuration_request.UpdateLaunchConfigurationRequest) -> tuple[aws_sdk_drs.types.launch_configuration.LaunchConfiguration, zapros.Response]:
