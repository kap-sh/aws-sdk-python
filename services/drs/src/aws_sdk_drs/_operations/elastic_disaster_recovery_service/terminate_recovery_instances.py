...
def handle_response(
    ...
    out: aws_sdk_drs.types.terminate_recovery_instances_response.TerminateRecoveryInstancesResponse = aws_sdk_drs.types.terminate_recovery_instances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.terminate_recovery_instances_request.TerminateRecoveryInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.terminate_recovery_instances_request.serialize_json(input_)
    ).encode()
