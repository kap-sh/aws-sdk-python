...
def build_request(
    ...
    input: aws_sdk_drs.types.terminate_recovery_instances_request.TerminateRecoveryInstancesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.terminate_recovery_instances_request.serialize_json(input)
    ).encode()
