...
def handle_response(
    ...
    out: aws_sdk_drs.types.reverse_replication_response.ReverseReplicationResponse = (
        aws_sdk_drs.types.reverse_replication_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_drs.types.reverse_replication_request.ReverseReplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.reverse_replication_request.serialize_json(input)
    ).encode()
