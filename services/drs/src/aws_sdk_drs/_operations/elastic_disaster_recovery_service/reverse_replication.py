...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.reverse_replication_response.ReverseReplicationResponse:
    import aws_sdk_drs.types.reverse_replication_response
    out: aws_sdk_drs.types.reverse_replication_response.ReverseReplicationResponse = aws_sdk_drs.types.reverse_replication_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.reverse_replication_request.ReverseReplicationRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.reverse_replication_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.reverse_replication_request.serialize_json(input)).encode()
...
def reverse_replication(options: OperationOptions, input: aws_sdk_drs.types.reverse_replication_request.ReverseReplicationRequest) -> tuple[aws_sdk_drs.types.reverse_replication_response.ReverseReplicationResponse, zapros.Response]:
...
async def async_reverse_replication(options: AsyncOperationOptions, input: aws_sdk_drs.types.reverse_replication_request.ReverseReplicationRequest) -> tuple[aws_sdk_drs.types.reverse_replication_response.ReverseReplicationResponse, zapros.Response]:
