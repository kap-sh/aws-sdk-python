...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.describe_recovery_snapshots_response.DescribeRecoverySnapshotsResponse:
    import aws_sdk_drs.types.describe_recovery_snapshots_response
    out: aws_sdk_drs.types.describe_recovery_snapshots_response.DescribeRecoverySnapshotsResponse = aws_sdk_drs.types.describe_recovery_snapshots_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.describe_recovery_snapshots_request.DescribeRecoverySnapshotsRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.describe_recovery_snapshots_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.describe_recovery_snapshots_request.serialize_json(input)).encode()
...
def describe_recovery_snapshots(options: OperationOptions, input: aws_sdk_drs.types.describe_recovery_snapshots_request.DescribeRecoverySnapshotsRequest) -> tuple[aws_sdk_drs.types.describe_recovery_snapshots_response.DescribeRecoverySnapshotsResponse, zapros.Response]:
...
async def async_describe_recovery_snapshots(options: AsyncOperationOptions, input: aws_sdk_drs.types.describe_recovery_snapshots_request.DescribeRecoverySnapshotsRequest) -> tuple[aws_sdk_drs.types.describe_recovery_snapshots_response.DescribeRecoverySnapshotsResponse, zapros.Response]:
