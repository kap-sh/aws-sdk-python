...
def handle_response(
    ...
    out: aws_sdk_drs.types.describe_recovery_snapshots_response.DescribeRecoverySnapshotsResponse = aws_sdk_drs.types.describe_recovery_snapshots_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.describe_recovery_snapshots_request.DescribeRecoverySnapshotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.describe_recovery_snapshots_request.serialize_json(input_)
    ).encode()
