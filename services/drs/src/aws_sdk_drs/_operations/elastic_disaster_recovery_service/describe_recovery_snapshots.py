...
def build_request(
    ...
    input: aws_sdk_drs.types.describe_recovery_snapshots_request.DescribeRecoverySnapshotsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.describe_recovery_snapshots_request.serialize_json(input)
    ).encode()
