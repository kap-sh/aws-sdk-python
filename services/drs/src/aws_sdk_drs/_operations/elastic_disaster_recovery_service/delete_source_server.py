...
def build_request(
    ...
    input_: aws_sdk_drs.types.delete_source_server_request.DeleteSourceServerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.delete_source_server_request.serialize_json(input_)
    ).encode()
...
async def async_delete_source_server(
