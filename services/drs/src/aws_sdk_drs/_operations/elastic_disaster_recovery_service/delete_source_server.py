"""Generated from Smithy shape ``com.amazonaws.drs#DeleteSourceServer``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.delete_source_server_response.DeleteSourceServerResponse:
    out: aws_sdk_drs.types.delete_source_server_response.DeleteSourceServerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.delete_source_server_request.DeleteSourceServerRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.delete_source_server_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.delete_source_server_request.serialize_json(input)).encode()
...
def delete_source_server(options: OperationOptions, input: aws_sdk_drs.types.delete_source_server_request.DeleteSourceServerRequest) -> tuple[aws_sdk_drs.types.delete_source_server_response.DeleteSourceServerResponse, zapros.Response]:
...
async def async_delete_source_server(options: AsyncOperationOptions, input: aws_sdk_drs.types.delete_source_server_request.DeleteSourceServerRequest) -> tuple[aws_sdk_drs.types.delete_source_server_response.DeleteSourceServerResponse, zapros.Response]:
