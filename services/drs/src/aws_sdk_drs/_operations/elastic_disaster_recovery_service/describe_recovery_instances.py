...
def build_request(
    ...
    input: aws_sdk_drs.types.describe_recovery_instances_request.DescribeRecoveryInstancesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.describe_recovery_instances_request.serialize_json(input)
    ).encode()
