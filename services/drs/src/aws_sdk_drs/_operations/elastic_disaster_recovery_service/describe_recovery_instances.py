...
) -> aws_sdk_drs.types.describe_recovery_instances_response.DescribeRecoveryInstancesResponse:
    out: aws_sdk_drs.types.describe_recovery_instances_response.DescribeRecoveryInstancesResponse = aws_sdk_drs.types.describe_recovery_instances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.describe_recovery_instances_request.DescribeRecoveryInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.describe_recovery_instances_request.serialize_json(input_)
    ).encode()
