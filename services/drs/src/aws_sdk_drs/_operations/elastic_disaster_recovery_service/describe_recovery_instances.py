"""Generated from Smithy shape ``com.amazonaws.drs#DescribeRecoveryInstances``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.describe_recovery_instances_response.DescribeRecoveryInstancesResponse:
    import aws_sdk_drs.types.describe_recovery_instances_response
    out: aws_sdk_drs.types.describe_recovery_instances_response.DescribeRecoveryInstancesResponse = aws_sdk_drs.types.describe_recovery_instances_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.describe_recovery_instances_request.DescribeRecoveryInstancesRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/DescribeRecoveryInstances"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_drs.types.describe_recovery_instances_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.describe_recovery_instances_request.serialize_json(input)).encode()
...
def describe_recovery_instances(options: OperationOptions, input: aws_sdk_drs.types.describe_recovery_instances_request.DescribeRecoveryInstancesRequest) -> tuple[aws_sdk_drs.types.describe_recovery_instances_response.DescribeRecoveryInstancesResponse, zapros.Response]:
...
async def async_describe_recovery_instances(options: AsyncOperationOptions, input: aws_sdk_drs.types.describe_recovery_instances_request.DescribeRecoveryInstancesRequest) -> tuple[aws_sdk_drs.types.describe_recovery_instances_response.DescribeRecoveryInstancesResponse, zapros.Response]:
