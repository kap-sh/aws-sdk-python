...
) -> aws_sdk_drs.types.get_failback_replication_configuration_response.GetFailbackReplicationConfigurationResponse:
    out: aws_sdk_drs.types.get_failback_replication_configuration_response.GetFailbackReplicationConfigurationResponse = aws_sdk_drs.types.get_failback_replication_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.get_failback_replication_configuration_request.GetFailbackReplicationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.get_failback_replication_configuration_request.serialize_json(
            input_
        )
    ).encode()
