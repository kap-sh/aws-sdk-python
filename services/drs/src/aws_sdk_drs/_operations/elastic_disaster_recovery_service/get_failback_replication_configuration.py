"""Generated from Smithy shape ``com.amazonaws.drs#GetFailbackReplicationConfiguration``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.get_failback_replication_configuration_response.GetFailbackReplicationConfigurationResponse:
    import aws_sdk_drs.types.get_failback_replication_configuration_response
    out: aws_sdk_drs.types.get_failback_replication_configuration_response.GetFailbackReplicationConfigurationResponse = aws_sdk_drs.types.get_failback_replication_configuration_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.get_failback_replication_configuration_request.GetFailbackReplicationConfigurationRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/GetFailbackReplicationConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_drs.types.get_failback_replication_configuration_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.get_failback_replication_configuration_request.serialize_json(input)).encode()
...
def get_failback_replication_configuration(options: OperationOptions, input: aws_sdk_drs.types.get_failback_replication_configuration_request.GetFailbackReplicationConfigurationRequest) -> tuple[aws_sdk_drs.types.get_failback_replication_configuration_response.GetFailbackReplicationConfigurationResponse, zapros.Response]:
...
async def async_get_failback_replication_configuration(options: AsyncOperationOptions, input: aws_sdk_drs.types.get_failback_replication_configuration_request.GetFailbackReplicationConfigurationRequest) -> tuple[aws_sdk_drs.types.get_failback_replication_configuration_response.GetFailbackReplicationConfigurationResponse, zapros.Response]:
