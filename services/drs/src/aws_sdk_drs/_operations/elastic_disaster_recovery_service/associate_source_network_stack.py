...
def handle_response(
    ...
    out: aws_sdk_drs.types.associate_source_network_stack_response.AssociateSourceNetworkStackResponse = aws_sdk_drs.types.associate_source_network_stack_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.associate_source_network_stack_request.AssociateSourceNetworkStackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.associate_source_network_stack_request.serialize_json(input_)
    ).encode()
