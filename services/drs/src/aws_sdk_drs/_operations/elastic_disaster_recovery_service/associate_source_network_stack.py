...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            ...
            raise aws_sdk_drs.errors.conflict_exception.ConflictException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.associate_source_network_stack_response.AssociateSourceNetworkStackResponse:
    import aws_sdk_drs.types.associate_source_network_stack_response
    out: aws_sdk_drs.types.associate_source_network_stack_response.AssociateSourceNetworkStackResponse = aws_sdk_drs.types.associate_source_network_stack_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.associate_source_network_stack_request.AssociateSourceNetworkStackRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.associate_source_network_stack_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.associate_source_network_stack_request.serialize_json(input)).encode()
...
def associate_source_network_stack(options: OperationOptions, input: aws_sdk_drs.types.associate_source_network_stack_request.AssociateSourceNetworkStackRequest) -> tuple[aws_sdk_drs.types.associate_source_network_stack_response.AssociateSourceNetworkStackResponse, zapros.Response]:
...
async def async_associate_source_network_stack(options: AsyncOperationOptions, input: aws_sdk_drs.types.associate_source_network_stack_request.AssociateSourceNetworkStackRequest) -> tuple[aws_sdk_drs.types.associate_source_network_stack_response.AssociateSourceNetworkStackResponse, zapros.Response]:
