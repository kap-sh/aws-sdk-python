...
def build_request(
    ...
    input: aws_sdk_drs.types.associate_source_network_stack_request.AssociateSourceNetworkStackRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.associate_source_network_stack_request.serialize_json(input)
    ).encode()
