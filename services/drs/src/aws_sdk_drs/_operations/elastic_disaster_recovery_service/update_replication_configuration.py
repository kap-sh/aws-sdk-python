...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.update_replication_configuration_request.UpdateReplicationConfigurationRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.update_replication_configuration_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.update_replication_configuration_request.serialize_json(input)).encode()
...
def update_replication_configuration(options: OperationOptions, input: aws_sdk_drs.types.update_replication_configuration_request.UpdateReplicationConfigurationRequest) -> tuple[aws_sdk_drs.types.replication_configuration.ReplicationConfiguration, zapros.Response]:
...
async def async_update_replication_configuration(options: AsyncOperationOptions, input: aws_sdk_drs.types.update_replication_configuration_request.UpdateReplicationConfigurationRequest) -> tuple[aws_sdk_drs.types.replication_configuration.ReplicationConfiguration, zapros.Response]:
