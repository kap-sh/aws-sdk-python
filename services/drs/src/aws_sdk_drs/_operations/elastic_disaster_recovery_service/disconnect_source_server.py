...
def build_request(
    ...
    input: aws_sdk_drs.types.disconnect_source_server_request.DisconnectSourceServerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.disconnect_source_server_request.serialize_json(input)
    ).encode()
