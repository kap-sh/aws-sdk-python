...
def handle_response(
    ...
    out: aws_sdk_drs.types.source_server.SourceServer = (
        aws_sdk_drs.types.source_server.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_drs.types.source_server.SourceServer = (
        aws_sdk_drs.types.source_server.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.disconnect_source_server_request.DisconnectSourceServerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.disconnect_source_server_request.serialize_json(input_)
    ).encode()
...
def disconnect_source_server(
    ...
    input_: aws_sdk_drs.types.disconnect_source_server_request.DisconnectSourceServerRequest,
) -> tuple[aws_sdk_drs.types.source_server.SourceServer, zapros.Response]:
