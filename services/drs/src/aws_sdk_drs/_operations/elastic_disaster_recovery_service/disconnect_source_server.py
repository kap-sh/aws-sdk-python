...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.disconnect_source_server_request.DisconnectSourceServerRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.disconnect_source_server_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.disconnect_source_server_request.serialize_json(input)).encode()
...
def disconnect_source_server(options: OperationOptions, input: aws_sdk_drs.types.disconnect_source_server_request.DisconnectSourceServerRequest) -> tuple[aws_sdk_drs.types.source_server.SourceServer, zapros.Response]:
...
async def async_disconnect_source_server(options: AsyncOperationOptions, input: aws_sdk_drs.types.disconnect_source_server_request.DisconnectSourceServerRequest) -> tuple[aws_sdk_drs.types.source_server.SourceServer, zapros.Response]:
