...
def handle_response(
    ...
    out: aws_sdk_drs.types.start_source_network_replication_response.StartSourceNetworkReplicationResponse = aws_sdk_drs.types.start_source_network_replication_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_drs.types.start_source_network_replication_request.StartSourceNetworkReplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.start_source_network_replication_request.serialize_json(input)
    ).encode()
...
async def async_start_source_network_replication(
