"""Generated from Smithy shape ``com.amazonaws.drs#StartSourceNetworkReplication``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.start_source_network_replication_response.StartSourceNetworkReplicationResponse:
    import aws_sdk_drs.types.start_source_network_replication_response
    out: aws_sdk_drs.types.start_source_network_replication_response.StartSourceNetworkReplicationResponse = aws_sdk_drs.types.start_source_network_replication_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.start_source_network_replication_request.StartSourceNetworkReplicationRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/StartSourceNetworkReplication"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_drs.types.start_source_network_replication_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.start_source_network_replication_request.serialize_json(input)).encode()
...
def start_source_network_replication(options: OperationOptions, input: aws_sdk_drs.types.start_source_network_replication_request.StartSourceNetworkReplicationRequest) -> tuple[aws_sdk_drs.types.start_source_network_replication_response.StartSourceNetworkReplicationResponse, zapros.Response]:
...
async def async_start_source_network_replication(options: AsyncOperationOptions, input: aws_sdk_drs.types.start_source_network_replication_request.StartSourceNetworkReplicationRequest) -> tuple[aws_sdk_drs.types.start_source_network_replication_response.StartSourceNetworkReplicationResponse, zapros.Response]:
