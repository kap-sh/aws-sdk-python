...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.replication_configuration.ReplicationConfiguration:
    import aws_sdk_drs.types.replication_configuration
    out: aws_sdk_drs.types.replication_configuration.ReplicationConfiguration = aws_sdk_drs.types.replication_configuration.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.get_replication_configuration_request.GetReplicationConfigurationRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.get_replication_configuration_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.get_replication_configuration_request.serialize_json(input)).encode()
...
def get_replication_configuration(options: OperationOptions, input: aws_sdk_drs.types.get_replication_configuration_request.GetReplicationConfigurationRequest) -> tuple[aws_sdk_drs.types.replication_configuration.ReplicationConfiguration, zapros.Response]:
...
async def async_get_replication_configuration(options: AsyncOperationOptions, input: aws_sdk_drs.types.get_replication_configuration_request.GetReplicationConfigurationRequest) -> tuple[aws_sdk_drs.types.replication_configuration.ReplicationConfiguration, zapros.Response]:
