...
def handle_response(
    ...
    out: aws_sdk_drs.types.replication_configuration.ReplicationConfiguration = (
        aws_sdk_drs.types.replication_configuration.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.get_replication_configuration_request.GetReplicationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.get_replication_configuration_request.serialize_json(input_)
    ).encode()
