...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.update_failback_replication_configuration_request.UpdateFailbackReplicationConfigurationRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.update_failback_replication_configuration_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.update_failback_replication_configuration_request.serialize_json(input)).encode()
...
def update_failback_replication_configuration(options: OperationOptions, input: aws_sdk_drs.types.update_failback_replication_configuration_request.UpdateFailbackReplicationConfigurationRequest) -> tuple[None, zapros.Response]:
...
async def async_update_failback_replication_configuration(options: AsyncOperationOptions, input: aws_sdk_drs.types.update_failback_replication_configuration_request.UpdateFailbackReplicationConfigurationRequest) -> tuple[None, zapros.Response]:
