...
def handle_response(
    ...
    out: aws_sdk_drs.types.describe_source_networks_response.DescribeSourceNetworksResponse = aws_sdk_drs.types.describe_source_networks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.describe_source_networks_request.DescribeSourceNetworksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.describe_source_networks_request.serialize_json(input_)
    ).encode()
