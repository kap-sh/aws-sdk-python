...
def build_request(
    ...
    input: aws_sdk_drs.types.describe_source_networks_request.DescribeSourceNetworksRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.describe_source_networks_request.serialize_json(input)
    ).encode()
