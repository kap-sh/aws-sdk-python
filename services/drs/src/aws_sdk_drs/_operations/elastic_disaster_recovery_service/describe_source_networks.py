...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.describe_source_networks_response.DescribeSourceNetworksResponse:
    import aws_sdk_drs.types.describe_source_networks_response
    out: aws_sdk_drs.types.describe_source_networks_response.DescribeSourceNetworksResponse = aws_sdk_drs.types.describe_source_networks_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.describe_source_networks_request.DescribeSourceNetworksRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.describe_source_networks_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.describe_source_networks_request.serialize_json(input)).encode()
...
def describe_source_networks(options: OperationOptions, input: aws_sdk_drs.types.describe_source_networks_request.DescribeSourceNetworksRequest) -> tuple[aws_sdk_drs.types.describe_source_networks_response.DescribeSourceNetworksResponse, zapros.Response]:
...
async def async_describe_source_networks(options: AsyncOperationOptions, input: aws_sdk_drs.types.describe_source_networks_request.DescribeSourceNetworksRequest) -> tuple[aws_sdk_drs.types.describe_source_networks_response.DescribeSourceNetworksResponse, zapros.Response]:
