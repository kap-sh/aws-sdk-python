...
def build_request(
    ...
    input: aws_sdk_drs.types.delete_launch_action_request.DeleteLaunchActionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.delete_launch_action_request.serialize_json(input)
    ).encode()
...
async def async_delete_launch_action(
