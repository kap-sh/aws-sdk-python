"""Generated from Smithy shape ``com.amazonaws.drs#DeleteLaunchAction``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.delete_launch_action_response.DeleteLaunchActionResponse:
    out: aws_sdk_drs.types.delete_launch_action_response.DeleteLaunchActionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.delete_launch_action_request.DeleteLaunchActionRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.delete_launch_action_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.delete_launch_action_request.serialize_json(input)).encode()
...
def delete_launch_action(options: OperationOptions, input: aws_sdk_drs.types.delete_launch_action_request.DeleteLaunchActionRequest) -> tuple[aws_sdk_drs.types.delete_launch_action_response.DeleteLaunchActionResponse, zapros.Response]:
...
async def async_delete_launch_action(options: AsyncOperationOptions, input: aws_sdk_drs.types.delete_launch_action_request.DeleteLaunchActionRequest) -> tuple[aws_sdk_drs.types.delete_launch_action_response.DeleteLaunchActionResponse, zapros.Response]:
