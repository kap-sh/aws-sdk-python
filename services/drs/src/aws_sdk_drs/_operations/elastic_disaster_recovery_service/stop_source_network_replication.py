...
def handle_response(
    ...
    out: aws_sdk_drs.types.stop_source_network_replication_response.StopSourceNetworkReplicationResponse = aws_sdk_drs.types.stop_source_network_replication_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.stop_source_network_replication_request.StopSourceNetworkReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.stop_source_network_replication_request.serialize_json(input_)
    ).encode()
