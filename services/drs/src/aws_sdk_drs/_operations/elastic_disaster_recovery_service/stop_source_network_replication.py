...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.stop_source_network_replication_response.StopSourceNetworkReplicationResponse:
    import aws_sdk_drs.types.stop_source_network_replication_response
    out: aws_sdk_drs.types.stop_source_network_replication_response.StopSourceNetworkReplicationResponse = aws_sdk_drs.types.stop_source_network_replication_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.stop_source_network_replication_request.StopSourceNetworkReplicationRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.stop_source_network_replication_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.stop_source_network_replication_request.serialize_json(input)).encode()
...
def stop_source_network_replication(options: OperationOptions, input: aws_sdk_drs.types.stop_source_network_replication_request.StopSourceNetworkReplicationRequest) -> tuple[aws_sdk_drs.types.stop_source_network_replication_response.StopSourceNetworkReplicationResponse, zapros.Response]:
...
async def async_stop_source_network_replication(options: AsyncOperationOptions, input: aws_sdk_drs.types.stop_source_network_replication_request.StopSourceNetworkReplicationRequest) -> tuple[aws_sdk_drs.types.stop_source_network_replication_response.StopSourceNetworkReplicationResponse, zapros.Response]:
