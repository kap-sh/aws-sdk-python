...
def build_request(
    ...
    input: aws_sdk_drs.types.stop_source_network_replication_request.StopSourceNetworkReplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.stop_source_network_replication_request.serialize_json(input)
    ).encode()
