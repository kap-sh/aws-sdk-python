...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.untag_resource_request.UntagResourceRequest) -> zapros.Request:
...
def untag_resource(options: OperationOptions, input: aws_sdk_drs.types.untag_resource_request.UntagResourceRequest) -> tuple[None, zapros.Response]:
...
async def async_untag_resource(options: AsyncOperationOptions, input: aws_sdk_drs.types.untag_resource_request.UntagResourceRequest) -> tuple[None, zapros.Response]:
