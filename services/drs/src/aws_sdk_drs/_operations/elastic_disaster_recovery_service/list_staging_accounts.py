...
def handle_response(
    ...
    out: aws_sdk_drs.types.list_staging_accounts_response.ListStagingAccountsResponse = aws_sdk_drs.types.list_staging_accounts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.list_staging_accounts_request.ListStagingAccountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
