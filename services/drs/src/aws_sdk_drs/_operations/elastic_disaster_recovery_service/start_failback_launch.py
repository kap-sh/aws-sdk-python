...
) -> aws_sdk_drs.types.start_failback_launch_response.StartFailbackLaunchResponse:
    import aws_sdk_drs.types.start_failback_launch_response

    out: aws_sdk_drs.types.start_failback_launch_response.StartFailbackLaunchResponse = aws_sdk_drs.types.start_failback_launch_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.start_failback_launch_request.StartFailbackLaunchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.start_failback_launch_request.serialize_json(input_)
    ).encode()
...
async def async_start_failback_launch(
