"""Generated from Smithy shape ``com.amazonaws.drs#StartFailbackLaunch``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.start_failback_launch_response.StartFailbackLaunchResponse:
    import aws_sdk_drs.types.start_failback_launch_response
    out: aws_sdk_drs.types.start_failback_launch_response.StartFailbackLaunchResponse = aws_sdk_drs.types.start_failback_launch_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.start_failback_launch_request.StartFailbackLaunchRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/StartFailbackLaunch"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_drs.types.start_failback_launch_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.start_failback_launch_request.serialize_json(input)).encode()
...
def start_failback_launch(options: OperationOptions, input: aws_sdk_drs.types.start_failback_launch_request.StartFailbackLaunchRequest) -> tuple[aws_sdk_drs.types.start_failback_launch_response.StartFailbackLaunchResponse, zapros.Response]:
...
async def async_start_failback_launch(options: AsyncOperationOptions, input: aws_sdk_drs.types.start_failback_launch_request.StartFailbackLaunchRequest) -> tuple[aws_sdk_drs.types.start_failback_launch_response.StartFailbackLaunchResponse, zapros.Response]:
