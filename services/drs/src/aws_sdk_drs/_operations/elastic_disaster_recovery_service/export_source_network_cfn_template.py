...
def handle_response(
    ...
    out: aws_sdk_drs.types.export_source_network_cfn_template_response.ExportSourceNetworkCfnTemplateResponse = aws_sdk_drs.types.export_source_network_cfn_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.export_source_network_cfn_template_request.ExportSourceNetworkCfnTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.export_source_network_cfn_template_request.serialize_json(
            input_
        )
    ).encode()
