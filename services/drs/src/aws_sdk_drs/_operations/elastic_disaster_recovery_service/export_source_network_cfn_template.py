...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.export_source_network_cfn_template_response.ExportSourceNetworkCfnTemplateResponse:
    import aws_sdk_drs.types.export_source_network_cfn_template_response
    out: aws_sdk_drs.types.export_source_network_cfn_template_response.ExportSourceNetworkCfnTemplateResponse = aws_sdk_drs.types.export_source_network_cfn_template_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.export_source_network_cfn_template_request.ExportSourceNetworkCfnTemplateRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.export_source_network_cfn_template_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.export_source_network_cfn_template_request.serialize_json(input)).encode()
...
def export_source_network_cfn_template(options: OperationOptions, input: aws_sdk_drs.types.export_source_network_cfn_template_request.ExportSourceNetworkCfnTemplateRequest) -> tuple[aws_sdk_drs.types.export_source_network_cfn_template_response.ExportSourceNetworkCfnTemplateResponse, zapros.Response]:
...
async def async_export_source_network_cfn_template(options: AsyncOperationOptions, input: aws_sdk_drs.types.export_source_network_cfn_template_request.ExportSourceNetworkCfnTemplateRequest) -> tuple[aws_sdk_drs.types.export_source_network_cfn_template_response.ExportSourceNetworkCfnTemplateResponse, zapros.Response]:
