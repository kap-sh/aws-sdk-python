"""Generated from Smithy shape ``com.amazonaws.drs#DeleteReplicationConfigurationTemplate``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.delete_replication_configuration_template_response.DeleteReplicationConfigurationTemplateResponse:
    out: aws_sdk_drs.types.delete_replication_configuration_template_response.DeleteReplicationConfigurationTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.delete_replication_configuration_template_request.DeleteReplicationConfigurationTemplateRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/DeleteReplicationConfigurationTemplate"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_drs.types.delete_replication_configuration_template_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.delete_replication_configuration_template_request.serialize_json(input)).encode()
...
def delete_replication_configuration_template(options: OperationOptions, input: aws_sdk_drs.types.delete_replication_configuration_template_request.DeleteReplicationConfigurationTemplateRequest) -> tuple[aws_sdk_drs.types.delete_replication_configuration_template_response.DeleteReplicationConfigurationTemplateResponse, zapros.Response]:
...
async def async_delete_replication_configuration_template(options: AsyncOperationOptions, input: aws_sdk_drs.types.delete_replication_configuration_template_request.DeleteReplicationConfigurationTemplateRequest) -> tuple[aws_sdk_drs.types.delete_replication_configuration_template_response.DeleteReplicationConfigurationTemplateResponse, zapros.Response]:
