...
def handle_response(
    ...
    out: aws_sdk_drs.types.start_source_network_recovery_response.StartSourceNetworkRecoveryResponse = aws_sdk_drs.types.start_source_network_recovery_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.start_source_network_recovery_request.StartSourceNetworkRecoveryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.start_source_network_recovery_request.serialize_json(input_)
    ).encode()
