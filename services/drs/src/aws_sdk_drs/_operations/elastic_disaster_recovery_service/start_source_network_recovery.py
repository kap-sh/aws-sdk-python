...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.start_source_network_recovery_response.StartSourceNetworkRecoveryResponse:
    import aws_sdk_drs.types.start_source_network_recovery_response
    out: aws_sdk_drs.types.start_source_network_recovery_response.StartSourceNetworkRecoveryResponse = aws_sdk_drs.types.start_source_network_recovery_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.start_source_network_recovery_request.StartSourceNetworkRecoveryRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.start_source_network_recovery_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.start_source_network_recovery_request.serialize_json(input)).encode()
...
def start_source_network_recovery(options: OperationOptions, input: aws_sdk_drs.types.start_source_network_recovery_request.StartSourceNetworkRecoveryRequest) -> tuple[aws_sdk_drs.types.start_source_network_recovery_response.StartSourceNetworkRecoveryResponse, zapros.Response]:
...
async def async_start_source_network_recovery(options: AsyncOperationOptions, input: aws_sdk_drs.types.start_source_network_recovery_request.StartSourceNetworkRecoveryRequest) -> tuple[aws_sdk_drs.types.start_source_network_recovery_response.StartSourceNetworkRecoveryResponse, zapros.Response]:
