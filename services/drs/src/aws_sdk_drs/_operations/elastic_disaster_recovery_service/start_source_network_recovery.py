...
def build_request(
    ...
    input: aws_sdk_drs.types.start_source_network_recovery_request.StartSourceNetworkRecoveryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.start_source_network_recovery_request.serialize_json(input)
    ).encode()
