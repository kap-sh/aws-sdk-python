...
def handle_response(
    ...
    out: aws_sdk_drs.types.describe_jobs_response.DescribeJobsResponse = (
        aws_sdk_drs.types.describe_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.describe_jobs_request.DescribeJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.describe_jobs_request.serialize_json(input_)
    ).encode()
...
def describe_jobs(
    ...
    aws_sdk_drs.types.describe_jobs_response.DescribeJobsResponse, zapros.Response
]:
