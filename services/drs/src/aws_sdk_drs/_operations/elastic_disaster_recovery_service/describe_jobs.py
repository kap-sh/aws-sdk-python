...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.describe_jobs_response.DescribeJobsResponse:
    import aws_sdk_drs.types.describe_jobs_response
    out: aws_sdk_drs.types.describe_jobs_response.DescribeJobsResponse = aws_sdk_drs.types.describe_jobs_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.describe_jobs_request.DescribeJobsRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.describe_jobs_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.describe_jobs_request.serialize_json(input)).encode()
...
def describe_jobs(options: OperationOptions, input: aws_sdk_drs.types.describe_jobs_request.DescribeJobsRequest) -> tuple[aws_sdk_drs.types.describe_jobs_response.DescribeJobsResponse, zapros.Response]:
...
async def async_describe_jobs(options: AsyncOperationOptions, input: aws_sdk_drs.types.describe_jobs_request.DescribeJobsRequest) -> tuple[aws_sdk_drs.types.describe_jobs_response.DescribeJobsResponse, zapros.Response]:
