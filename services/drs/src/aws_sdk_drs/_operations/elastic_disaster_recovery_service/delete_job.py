...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.delete_job_response.DeleteJobResponse:
    out: aws_sdk_drs.types.delete_job_response.DeleteJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.delete_job_request.DeleteJobRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.delete_job_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.delete_job_request.serialize_json(input)).encode()
...
def delete_job(options: OperationOptions, input: aws_sdk_drs.types.delete_job_request.DeleteJobRequest) -> tuple[aws_sdk_drs.types.delete_job_response.DeleteJobResponse, zapros.Response]:
...
async def async_delete_job(options: AsyncOperationOptions, input: aws_sdk_drs.types.delete_job_request.DeleteJobRequest) -> tuple[aws_sdk_drs.types.delete_job_response.DeleteJobResponse, zapros.Response]:
