...
def handle_response(
    ...
    out: aws_sdk_drs.types.put_launch_action_response.PutLaunchActionResponse = (
        aws_sdk_drs.types.put_launch_action_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.put_launch_action_request.PutLaunchActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.put_launch_action_request.serialize_json(input_)
    ).encode()
