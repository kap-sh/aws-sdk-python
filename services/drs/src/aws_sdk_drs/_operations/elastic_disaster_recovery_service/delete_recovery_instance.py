...
def build_request(
    ...
    input_: aws_sdk_drs.types.delete_recovery_instance_request.DeleteRecoveryInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.delete_recovery_instance_request.serialize_json(input_)
    ).encode()
...
async def async_delete_recovery_instance(
