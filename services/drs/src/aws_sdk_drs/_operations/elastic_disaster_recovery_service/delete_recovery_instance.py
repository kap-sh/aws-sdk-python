"""Generated from Smithy shape ``com.amazonaws.drs#DeleteRecoveryInstance``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.delete_recovery_instance_request.DeleteRecoveryInstanceRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/DeleteRecoveryInstance"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_drs.types.delete_recovery_instance_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.delete_recovery_instance_request.serialize_json(input)).encode()
...
def delete_recovery_instance(options: OperationOptions, input: aws_sdk_drs.types.delete_recovery_instance_request.DeleteRecoveryInstanceRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_recovery_instance(options: AsyncOperationOptions, input: aws_sdk_drs.types.delete_recovery_instance_request.DeleteRecoveryInstanceRequest) -> tuple[None, zapros.Response]:
