...
def build_request(
    ...
    input: aws_sdk_drs.types.delete_recovery_instance_request.DeleteRecoveryInstanceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.delete_recovery_instance_request.serialize_json(input)
    ).encode()
