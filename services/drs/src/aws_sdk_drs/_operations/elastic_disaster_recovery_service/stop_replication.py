...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.stop_replication_response.StopReplicationResponse:
    import aws_sdk_drs.types.stop_replication_response
    out: aws_sdk_drs.types.stop_replication_response.StopReplicationResponse = aws_sdk_drs.types.stop_replication_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.stop_replication_request.StopReplicationRequest) -> zapros.Request:
    ...
    import aws_sdk_drs.types.stop_replication_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.stop_replication_request.serialize_json(input)).encode()
...
def stop_replication(options: OperationOptions, input: aws_sdk_drs.types.stop_replication_request.StopReplicationRequest) -> tuple[aws_sdk_drs.types.stop_replication_response.StopReplicationResponse, zapros.Response]:
...
async def async_stop_replication(options: AsyncOperationOptions, input: aws_sdk_drs.types.stop_replication_request.StopReplicationRequest) -> tuple[aws_sdk_drs.types.stop_replication_response.StopReplicationResponse, zapros.Response]:
