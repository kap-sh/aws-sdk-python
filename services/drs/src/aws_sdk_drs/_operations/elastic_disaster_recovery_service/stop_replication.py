...
def handle_response(
    ...
    out: aws_sdk_drs.types.stop_replication_response.StopReplicationResponse = (
        aws_sdk_drs.types.stop_replication_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_drs.types.stop_replication_request.StopReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_drs.types.stop_replication_request.serialize_json(input_)
    ).encode()
...
def stop_replication(
    ...
    aws_sdk_drs.types.stop_replication_response.StopReplicationResponse, zapros.Response
]:
