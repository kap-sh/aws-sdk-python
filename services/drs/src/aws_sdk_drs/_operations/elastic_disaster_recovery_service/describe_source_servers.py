"""Generated from Smithy shape ``com.amazonaws.drs#DescribeSourceServers``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_drs.types.describe_source_servers_response.DescribeSourceServersResponse:
    import aws_sdk_drs.types.describe_source_servers_response
    out: aws_sdk_drs.types.describe_source_servers_response.DescribeSourceServersResponse = aws_sdk_drs.types.describe_source_servers_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_drs.types.describe_source_servers_request.DescribeSourceServersRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/DescribeSourceServers"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_drs.types.describe_source_servers_request
    body: bytes | None = json.dumps(aws_sdk_drs.types.describe_source_servers_request.serialize_json(input)).encode()
...
def describe_source_servers(options: OperationOptions, input: aws_sdk_drs.types.describe_source_servers_request.DescribeSourceServersRequest) -> tuple[aws_sdk_drs.types.describe_source_servers_response.DescribeSourceServersResponse, zapros.Response]:
...
async def async_describe_source_servers(options: AsyncOperationOptions, input: aws_sdk_drs.types.describe_source_servers_request.DescribeSourceServersRequest) -> tuple[aws_sdk_drs.types.describe_source_servers_response.DescribeSourceServersResponse, zapros.Response]:
