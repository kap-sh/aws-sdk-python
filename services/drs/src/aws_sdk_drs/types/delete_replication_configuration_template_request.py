...
def serialize_json(value: DeleteReplicationConfigurationTemplateRequest) -> dict:
    out: dict = {}
    out["replicationConfigurationTemplateID"] = value["replication_configuration_template_id"]
    return out
...
def deserialize_json(data: dict) -> DeleteReplicationConfigurationTemplateRequest:
    ...
    if "replicationConfigurationTemplateID" in data:
        out["replication_configuration_template_id"] = data["replicationConfigurationTemplateID"]
    else:
        raise DeserializationError("DeleteReplicationConfigurationTemplateRequest.replication_configuration_template_id required")
    return out