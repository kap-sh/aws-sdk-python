...
class RecoveryInstanceDataReplicationInitiation(TypedDict):
    ...
    steps: NotRequired[
        "aws_sdk_drs.types.recovery_instance_data_replication_initiation_steps.RecoveryInstanceDataReplicationInitiationSteps"
    ]
...
def serialize_json(value: RecoveryInstanceDataReplicationInitiation) -> dict:
    ...
    if "steps" in value:
        ...
        out["steps"] = (
            aws_sdk_drs.types.recovery_instance_data_replication_initiation_steps.serialize_json(
                value["steps"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> RecoveryInstanceDataReplicationInitiation:
    ...
    if "steps" in data:
        ...
        out["steps"] = (
            aws_sdk_drs.types.recovery_instance_data_replication_initiation_steps.deserialize_json(
                data["steps"]
            )
        )
    return out
