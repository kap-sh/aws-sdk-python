...
class ListLaunchActionsRequest(TypedDict):
    ...
    filters: NotRequired["aws_sdk_drs.types.launch_actions_request_filters.LaunchActionsRequestFilters"]
...
def serialize_json(value: ListLaunchActionsRequest) -> dict:
    ...
    if "filters" in value:
        import aws_sdk_drs.types.launch_actions_request_filters
        out["filters"] = aws_sdk_drs.types.launch_actions_request_filters.serialize_json(value["filters"])
...
def deserialize_json(data: dict) -> ListLaunchActionsRequest:
    ...
    if "filters" in data:
        import aws_sdk_drs.types.launch_actions_request_filters
        out["filters"] = aws_sdk_drs.types.launch_actions_request_filters.deserialize_json(data["filters"])
