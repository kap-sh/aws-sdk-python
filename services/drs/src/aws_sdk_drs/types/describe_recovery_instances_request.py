...
class DescribeRecoveryInstancesRequest(TypedDict):
    filters: NotRequired["aws_sdk_drs.types.describe_recovery_instances_request_filters.DescribeRecoveryInstancesRequestFilters"]
...
def serialize_json(value: DescribeRecoveryInstancesRequest) -> dict:
    ...
    if "filters" in value:
        import aws_sdk_drs.types.describe_recovery_instances_request_filters
        out["filters"] = aws_sdk_drs.types.describe_recovery_instances_request_filters.serialize_json(value["filters"])
...
def deserialize_json(data: dict) -> DescribeRecoveryInstancesRequest:
    ...
    if "filters" in data:
        import aws_sdk_drs.types.describe_recovery_instances_request_filters
        out["filters"] = aws_sdk_drs.types.describe_recovery_instances_request_filters.deserialize_json(data["filters"])
