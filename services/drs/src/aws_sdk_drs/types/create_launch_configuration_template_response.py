...
class CreateLaunchConfigurationTemplateResponse(TypedDict):
    launch_configuration_template: NotRequired["aws_sdk_drs.types.launch_configuration_template.LaunchConfigurationTemplate"]
...
def serialize_json(value: CreateLaunchConfigurationTemplateResponse) -> dict:
    ...
    if "launch_configuration_template" in value:
        import aws_sdk_drs.types.launch_configuration_template
        out["launchConfigurationTemplate"] = aws_sdk_drs.types.launch_configuration_template.serialize_json(value["launch_configuration_template"])
    return out
...
def deserialize_json(data: dict) -> CreateLaunchConfigurationTemplateResponse:
    ...
    if "launchConfigurationTemplate" in data:
        import aws_sdk_drs.types.launch_configuration_template
        out["launch_configuration_template"] = aws_sdk_drs.types.launch_configuration_template.deserialize_json(data["launchConfigurationTemplate"])
    return out