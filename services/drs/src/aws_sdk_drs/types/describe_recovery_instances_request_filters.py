...
class DescribeRecoveryInstancesRequestFilters(TypedDict, closed=True):
    ...
    source_server_i_ds: NotRequired[
        "aws_sdk_drs.types.source_server_i_ds.SourceServerIDs"
    ]
...
def serialize_json(value: DescribeRecoveryInstancesRequestFilters) -> dict:
    ...
    if "recovery_instance_i_ds" in value:
        ...
        out["recoveryInstanceIDs"] = (
            aws_sdk_drs.types.recovery_instance_i_ds.serialize_json(
    ...
    if "source_server_i_ds" in value:
        ...
        out["sourceServerIDs"] = aws_sdk_drs.types.source_server_i_ds.serialize_json(
...
def deserialize_json(data: dict) -> DescribeRecoveryInstancesRequestFilters:
    ...
    if "recoveryInstanceIDs" in data:
        ...
        out["recovery_instance_i_ds"] = (
            aws_sdk_drs.types.recovery_instance_i_ds.deserialize_json(
    ...
    if "sourceServerIDs" in data:
        ...
        out["source_server_i_ds"] = (
            aws_sdk_drs.types.source_server_i_ds.deserialize_json(
