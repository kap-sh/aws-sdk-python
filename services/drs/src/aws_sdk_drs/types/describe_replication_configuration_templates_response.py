...
class DescribeReplicationConfigurationTemplatesResponse(TypedDict):
    items: NotRequired["aws_sdk_drs.types.replication_configuration_templates.ReplicationConfigurationTemplates"]
...
def serialize_json(value: DescribeReplicationConfigurationTemplatesResponse) -> dict:
    ...
    if "items" in value:
        import aws_sdk_drs.types.replication_configuration_templates
        out["items"] = aws_sdk_drs.types.replication_configuration_templates.serialize_json(value["items"])
...
def deserialize_json(data: dict) -> DescribeReplicationConfigurationTemplatesResponse:
    ...
    if "items" in data:
        import aws_sdk_drs.types.replication_configuration_templates
        out["items"] = aws_sdk_drs.types.replication_configuration_templates.deserialize_json(data["items"])
