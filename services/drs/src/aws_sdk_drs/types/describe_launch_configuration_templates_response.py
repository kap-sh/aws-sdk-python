...
class DescribeLaunchConfigurationTemplatesResponse(TypedDict):
    items: NotRequired["aws_sdk_drs.types.launch_configuration_templates.LaunchConfigurationTemplates"]
...
def serialize_json(value: DescribeLaunchConfigurationTemplatesResponse) -> dict:
    ...
    if "items" in value:
        import aws_sdk_drs.types.launch_configuration_templates
        out["items"] = aws_sdk_drs.types.launch_configuration_templates.serialize_json(value["items"])
...
def deserialize_json(data: dict) -> DescribeLaunchConfigurationTemplatesResponse:
    ...
    if "items" in data:
        import aws_sdk_drs.types.launch_configuration_templates
        out["items"] = aws_sdk_drs.types.launch_configuration_templates.deserialize_json(data["items"])
