...
class RecoveryInstanceProperties(TypedDict):
    ...
    disks: NotRequired[
        "aws_sdk_drs.types.recovery_instance_disks.RecoveryInstanceDisks"
    ]
...
def serialize_json(value: RecoveryInstanceProperties) -> dict:
    ...
    if "disks" in value:
        ...
        out["disks"] = aws_sdk_drs.types.recovery_instance_disks.serialize_json(
            value["disks"]
        )
    if "cpus" in value:
        import aws_sdk_drs.types.cpus
...
def deserialize_json(data: dict) -> RecoveryInstanceProperties:
    ...
    if "disks" in data:
        ...
        out["disks"] = aws_sdk_drs.types.recovery_instance_disks.deserialize_json(
            data["disks"]
        )
    if "cpus" in data:
        import aws_sdk_drs.types.cpus
