...
class DescribeSourceNetworksRequest(TypedDict):
    filters: NotRequired["aws_sdk_drs.types.describe_source_networks_request_filters.DescribeSourceNetworksRequestFilters"]
...
def serialize_json(value: DescribeSourceNetworksRequest) -> dict:
    ...
    if "filters" in value:
        import aws_sdk_drs.types.describe_source_networks_request_filters
        out["filters"] = aws_sdk_drs.types.describe_source_networks_request_filters.serialize_json(value["filters"])
...
def deserialize_json(data: dict) -> DescribeSourceNetworksRequest:
    ...
    if "filters" in data:
        import aws_sdk_drs.types.describe_source_networks_request_filters
        out["filters"] = aws_sdk_drs.types.describe_source_networks_request_filters.deserialize_json(data["filters"])
