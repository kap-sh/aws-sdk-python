...
if TYPE_CHECKING:
    ...
    import aws_sdk_drs.types.recovery_life_cycle
    import aws_sdk_drs.types.replication_status
    import aws_sdk_drs.types.sensitive_bounded_string
    import aws_sdk_drs.types.source_network_id
    import aws_sdk_drs.types.tags_map
    import aws_sdk_drs.types.vpc_id


class SourceNetwork(TypedDict):
    source_network_id: NotRequired[
        "aws_sdk_drs.types.source_network_id.SourceNetworkID"
    ]
    """<p>Source Network ID.</p>"""
    source_vpc_id: NotRequired["aws_sdk_drs.types.vpc_id.VpcID"]
    ...
    replication_status: NotRequired[
        "aws_sdk_drs.types.replication_status.ReplicationStatus"
    ]
    ...
    replication_status_details: NotRequired[
        "aws_sdk_drs.types.sensitive_bounded_string.SensitiveBoundedString"
    ]
    ...
    source_region: NotRequired["aws_sdk_drs.types.aws_region.AwsRegion"]
    """<p>Region containing the VPC protected by the Source Network.</p>"""
    source_account_id: NotRequired["aws_sdk_drs.types.account_id.AccountID"]
    """<p>Account ID containing the VPC protected by the Source Network.</p>"""
    last_recovery: NotRequired[
        "aws_sdk_drs.types.recovery_life_cycle.RecoveryLifeCycle"
    ]
    """<p>An object containing information regarding the last recovery of the Source Network.</p>"""
    launched_vpc_id: NotRequired["aws_sdk_drs.types.vpc_id.VpcID"]
...
def serialize_json(value: SourceNetwork) -> dict:
    ...
    if "last_recovery" in value:
        ...
        out["lastRecovery"] = aws_sdk_drs.types.recovery_life_cycle.serialize_json(
            value["last_recovery"]
        )
...
def deserialize_json(data: dict) -> SourceNetwork:
    ...
    if "lastRecovery" in data:
        ...
        out["last_recovery"] = aws_sdk_drs.types.recovery_life_cycle.deserialize_json(
            data["lastRecovery"]
        )
