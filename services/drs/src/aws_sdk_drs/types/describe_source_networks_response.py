...
def serialize_json(value: DescribeSourceNetworksResponse) -> dict:
    ...
    if "items" in value:
        import aws_sdk_drs.types.source_networks_list
        out["items"] = aws_sdk_drs.types.source_networks_list.serialize_json(value["items"])
...
def deserialize_json(data: dict) -> DescribeSourceNetworksResponse:
    ...
    if "items" in data:
        import aws_sdk_drs.types.source_networks_list
        out["items"] = aws_sdk_drs.types.source_networks_list.deserialize_json(data["items"])
