...
class ParticipatingResource(TypedDict):
    participating_resource_id: NotRequired["aws_sdk_drs.types.participating_resource_id.ParticipatingResourceID"]
...
def serialize_json(value: ParticipatingResource) -> dict:
    ...
    if "participating_resource_id" in value:
        import aws_sdk_drs.types.participating_resource_id
        out["participatingResourceID"] = aws_sdk_drs.types.participating_resource_id.serialize_json(value["participating_resource_id"])
...
def deserialize_json(data: dict) -> ParticipatingResource:
    ...
    if "participatingResourceID" in data:
        import aws_sdk_drs.types.participating_resource_id
        out["participating_resource_id"] = aws_sdk_drs.types.participating_resource_id.deserialize_json(data["participatingResourceID"])
