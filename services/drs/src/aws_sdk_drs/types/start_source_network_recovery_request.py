...
def serialize_json(value: StartSourceNetworkRecoveryRequest) -> dict:
    ...
    out["sourceNetworks"] = (
        aws_sdk_drs.types.start_source_network_recovery_request_network_entries.serialize_json(
...
def deserialize_json(data: dict) -> StartSourceNetworkRecoveryRequest:
    ...
    if "sourceNetworks" in data:
        ...
        out["source_networks"] = (
            aws_sdk_drs.types.start_source_network_recovery_request_network_entries.deserialize_json(
                data["sourceNetworks"]
            )
        )
    else:
