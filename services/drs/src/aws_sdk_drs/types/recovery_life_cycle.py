...
if TYPE_CHECKING:
    ...
    import aws_sdk_drs.types.recovery_result


class RecoveryLifeCycle(TypedDict):
    ...
    last_recovery_result: NotRequired[
        "aws_sdk_drs.types.recovery_result.RecoveryResult"
    ]
...
def serialize_json(value: RecoveryLifeCycle) -> dict:
    ...
    if "api_call_date_time" in value:
        import aws_sdk_drs.types._prelude.timestamp

        out["apiCallDateTime"] = aws_sdk_drs.types._prelude.timestamp.serialize_json(
...
def deserialize_json(data: dict) -> RecoveryLifeCycle:
    ...
    if "apiCallDateTime" in data:
        ...
        out["api_call_date_time"] = (
            aws_sdk_drs.types._prelude.timestamp.deserialize_json(
