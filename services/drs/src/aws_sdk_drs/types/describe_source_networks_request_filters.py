...
if TYPE_CHECKING:
    ...
    import aws_sdk_drs.types.describe_source_networks_request_filters_i_ds

class DescribeSourceNetworksRequestFilters(TypedDict):
    source_network_i_ds: NotRequired["aws_sdk_drs.types.describe_source_networks_request_filters_i_ds.DescribeSourceNetworksRequestFiltersIDs"]
...
def serialize_json(value: DescribeSourceNetworksRequestFilters) -> dict:
    ...
    if "source_network_i_ds" in value:
        import aws_sdk_drs.types.describe_source_networks_request_filters_i_ds
        out["sourceNetworkIDs"] = aws_sdk_drs.types.describe_source_networks_request_filters_i_ds.serialize_json(value["source_network_i_ds"])
...
def deserialize_json(data: dict) -> DescribeSourceNetworksRequestFilters:
    ...
    if "sourceNetworkIDs" in data:
        import aws_sdk_drs.types.describe_source_networks_request_filters_i_ds
        out["source_network_i_ds"] = aws_sdk_drs.types.describe_source_networks_request_filters_i_ds.deserialize_json(data["sourceNetworkIDs"])
