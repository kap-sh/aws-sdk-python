...
LaunchActionParameters: TypeAlias = dict["aws_sdk_drs.types.launch_action_parameter_name.LaunchActionParameterName", "aws_sdk_drs.types.launch_action_parameter.LaunchActionParameter"]
