...
class LaunchConfigurationTemplateResource:
    ...
    def create(
        ...
        *,
        ...
        export_bucket_arn: Optional["aws_sdk_drs.types.arn.ARN"] = None,
        post_launch_enabled: Optional[bool] = None,
        launch_into_source_instance: Optional[bool] = None,
    ) -> "aws_sdk_drs.types.create_launch_configuration_template_response.CreateLaunchConfigurationTemplateResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.create_launch_configuration_template_request.CreateLaunchConfigurationTemplateRequest]",
        ) -> OperationResponse[
            "aws_sdk_drs.types.create_launch_configuration_template_response.CreateLaunchConfigurationTemplateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.create_launch_configuration_template.create_launch_configuration_template(
        ...
        input_: aws_sdk_drs.types.create_launch_configuration_template_request.CreateLaunchConfigurationTemplateRequest = {}  # type: ignore[typeddict-item]
        if tags is not None:
            input_["tags"] = tags
    ...
    def update(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.update_launch_configuration_template_request.UpdateLaunchConfigurationTemplateRequest]",
        ) -> OperationResponse[
            "aws_sdk_drs.types.update_launch_configuration_template_response.UpdateLaunchConfigurationTemplateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.update_launch_configuration_template.update_launch_configuration_template(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_drs.types.update_launch_configuration_template_request.UpdateLaunchConfigurationTemplateRequest = {}  # type: ignore[typeddict-item]
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.delete_launch_configuration_template_request.DeleteLaunchConfigurationTemplateRequest]",
        ) -> OperationResponse[
            "aws_sdk_drs.types.delete_launch_configuration_template_response.DeleteLaunchConfigurationTemplateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.delete_launch_configuration_template.delete_launch_configuration_template(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_drs.types.delete_launch_configuration_template_request.DeleteLaunchConfigurationTemplateRequest = {}  # type: ignore[typeddict-item]
        input_["launch_configuration_template_id"] = launch_configuration_template_id
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_drs.types.describe_launch_configuration_templates_response.DescribeLaunchConfigurationTemplatesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.describe_launch_configuration_templates_request.DescribeLaunchConfigurationTemplatesRequest]",
        ) -> OperationResponse[
            "aws_sdk_drs.types.describe_launch_configuration_templates_response.DescribeLaunchConfigurationTemplatesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.describe_launch_configuration_templates.describe_launch_configuration_templates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_drs.types.describe_launch_configuration_templates_request.DescribeLaunchConfigurationTemplatesRequest = {}  # type: ignore[typeddict-item]
...
class AsyncLaunchConfigurationTemplateResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.create_launch_configuration_template_request.CreateLaunchConfigurationTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_drs.types.create_launch_configuration_template_response.CreateLaunchConfigurationTemplateResponse"
        ]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.create_launch_configuration_template
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.create_launch_configuration_template.async_create_launch_configuration_template(
                req.options, req.input
            )
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.update_launch_configuration_template_request.UpdateLaunchConfigurationTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_drs.types.update_launch_configuration_template_response.UpdateLaunchConfigurationTemplateResponse"
        ]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.update_launch_configuration_template
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.update_launch_configuration_template.async_update_launch_configuration_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.delete_launch_configuration_template_request.DeleteLaunchConfigurationTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_drs.types.delete_launch_configuration_template_response.DeleteLaunchConfigurationTemplateResponse"
        ]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.delete_launch_configuration_template
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.delete_launch_configuration_template.async_delete_launch_configuration_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.describe_launch_configuration_templates_request.DescribeLaunchConfigurationTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_drs.types.describe_launch_configuration_templates_response.DescribeLaunchConfigurationTemplatesResponse"
        ]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.describe_launch_configuration_templates
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.describe_launch_configuration_templates.async_describe_launch_configuration_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
