...
class RecoveryInstanceResource:
    ...
    def list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.describe_recovery_instances_request.DescribeRecoveryInstancesRequest]",
        ) -> OperationResponse[
            "aws_sdk_drs.types.describe_recovery_instances_response.DescribeRecoveryInstancesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.describe_recovery_instances.describe_recovery_instances(
    ...
    def delete_recovery_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.delete_recovery_instance_request.DeleteRecoveryInstanceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.delete_recovery_instance

            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.delete_recovery_instance.delete_recovery_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disconnect_recovery_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.disconnect_recovery_instance_request.DisconnectRecoveryInstanceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.disconnect_recovery_instance

            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.disconnect_recovery_instance.disconnect_recovery_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_failback_replication_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.get_failback_replication_configuration_request.GetFailbackReplicationConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_drs.types.get_failback_replication_configuration_response.GetFailbackReplicationConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.get_failback_replication_configuration.get_failback_replication_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reverse_replication(
        ...
        *,
        config_overrides: Optional[drsClientConfig] = None,
    ) -> "aws_sdk_drs.types.reverse_replication_response.ReverseReplicationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.reverse_replication_request.ReverseReplicationRequest]",
        ) -> OperationResponse[
            "aws_sdk_drs.types.reverse_replication_response.ReverseReplicationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.reverse_replication.reverse_replication(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_failback(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.stop_failback_request.StopFailbackRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.stop_failback

            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.stop_failback.stop_failback(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_failback_replication_configuration(
        ...
        *,
        config_overrides: Optional[drsClientConfig] = None,
        name: Optional["aws_sdk_drs.types.bounded_string.BoundedString"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.update_failback_replication_configuration_request.UpdateFailbackReplicationConfigurationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.update_failback_replication_configuration

            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.update_failback_replication_configuration.update_failback_replication_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_failback_launch(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.start_failback_launch_request.StartFailbackLaunchRequest]",
        ) -> OperationResponse[
            "aws_sdk_drs.types.start_failback_launch_response.StartFailbackLaunchResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.start_failback_launch.start_failback_launch(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def terminate_recovery_instances(
        ...
        *,
        config_overrides: Optional[drsClientConfig] = None,
    ) -> "aws_sdk_drs.types.terminate_recovery_instances_response.TerminateRecoveryInstancesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_drs.types.terminate_recovery_instances_request.TerminateRecoveryInstancesRequest]",
        ) -> OperationResponse[
            "aws_sdk_drs.types.terminate_recovery_instances_response.TerminateRecoveryInstancesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_drs._operations.elastic_disaster_recovery_service.terminate_recovery_instances.terminate_recovery_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncRecoveryInstanceResource:
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.describe_recovery_instances_request.DescribeRecoveryInstancesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_drs.types.describe_recovery_instances_response.DescribeRecoveryInstancesResponse"
        ]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.describe_recovery_instances
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.describe_recovery_instances.async_describe_recovery_instances(
                req.options, req.input
            )
    ...
    async def delete_recovery_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.delete_recovery_instance_request.DeleteRecoveryInstanceRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.delete_recovery_instance.async_delete_recovery_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disconnect_recovery_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.disconnect_recovery_instance_request.DisconnectRecoveryInstanceRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.disconnect_recovery_instance
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.disconnect_recovery_instance.async_disconnect_recovery_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_failback_replication_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.get_failback_replication_configuration_request.GetFailbackReplicationConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_drs.types.get_failback_replication_configuration_response.GetFailbackReplicationConfigurationResponse"
        ]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.get_failback_replication_configuration
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.get_failback_replication_configuration.async_get_failback_replication_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reverse_replication(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.reverse_replication_request.ReverseReplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_drs.types.reverse_replication_response.ReverseReplicationResponse"
        ]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.reverse_replication
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.reverse_replication.async_reverse_replication(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_failback(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.stop_failback_request.StopFailbackRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.stop_failback
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.stop_failback.async_stop_failback(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_failback_replication_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.update_failback_replication_configuration_request.UpdateFailbackReplicationConfigurationRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.update_failback_replication_configuration
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.update_failback_replication_configuration.async_update_failback_replication_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_failback_launch(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.start_failback_launch_request.StartFailbackLaunchRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_drs.types.start_failback_launch_response.StartFailbackLaunchResponse"
        ]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.start_failback_launch
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.start_failback_launch.async_start_failback_launch(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def terminate_recovery_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_drs.types.terminate_recovery_instances_request.TerminateRecoveryInstancesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_drs.types.terminate_recovery_instances_response.TerminateRecoveryInstancesResponse"
        ]:
            import aws_sdk_drs._operations.elastic_disaster_recovery_service.terminate_recovery_instances
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_drs._operations.elastic_disaster_recovery_service.terminate_recovery_instances.async_terminate_recovery_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
