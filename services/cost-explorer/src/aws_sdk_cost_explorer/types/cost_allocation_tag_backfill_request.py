...
class CostAllocationTagBackfillRequest(TypedDict, closed=True):
    ...
    backfill_status: NotRequired[
        "aws_sdk_cost_explorer.types.cost_allocation_tag_backfill_status.CostAllocationTagBackfillStatus"
    ]
...
def serialize_aws_json_1_1(value: CostAllocationTagBackfillRequest) -> dict:
    ...
    if "backfill_status" in value:
        ...
        out["BackfillStatus"] = (
            aws_sdk_cost_explorer.types.cost_allocation_tag_backfill_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CostAllocationTagBackfillRequest:
    ...
    if "BackfillStatus" in data:
        ...
        out["backfill_status"] = (
            aws_sdk_cost_explorer.types.cost_allocation_tag_backfill_status.deserialize_aws_json_1_1(
                data["BackfillStatus"]
            )
        )
