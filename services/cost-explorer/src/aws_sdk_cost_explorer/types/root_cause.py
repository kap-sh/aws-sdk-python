...
class RootCause(TypedDict, closed=True):
    ...
    usage_type: NotRequired["aws_sdk_cost_explorer.types.generic_string.GenericString"]
    """<p>The <code>UsageType</code> value that's associated with the cost anomaly. </p>"""
    impact: NotRequired["aws_sdk_cost_explorer.types.root_cause_impact.RootCauseImpact"]
...
def serialize_aws_json_1_1(value: RootCause) -> dict:
    ...
    if "impact" in value:
        ...
        out["Impact"] = (
            aws_sdk_cost_explorer.types.root_cause_impact.serialize_aws_json_1_1(
                value["impact"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> RootCause:
    ...
    if "Impact" in data:
        ...
        out["impact"] = (
            aws_sdk_cost_explorer.types.root_cause_impact.deserialize_aws_json_1_1(
                data["Impact"]
            )
        )
    return out
