"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetCostComparisonDriversRequest``."""
...
class GetCostComparisonDriversRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetCostComparisonDriversRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetCostComparisonDriversRequest:
    out: GetCostComparisonDriversRequest = {}  # type: ignore[typeddict-item]
    ...
    if "BaselineTimePeriod" in data:
        ...
        raise DeserializationError(
            "GetCostComparisonDriversRequest.baseline_time_period required"
        )
    if "ComparisonTimePeriod" in data:
        ...
        raise DeserializationError(
            "GetCostComparisonDriversRequest.comparison_time_period required"
        )
    if "MetricForComparison" in data:
        out["metric_for_comparison"] = data["MetricForComparison"]
    else:
        raise DeserializationError(
            "GetCostComparisonDriversRequest.metric_for_comparison required"
        )
    if "Filter" in data:
        import aws_sdk_cost_explorer.types.expression
