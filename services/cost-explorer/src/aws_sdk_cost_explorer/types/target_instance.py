...
class TargetInstance(TypedDict):
    ...
    default_target_instance: (
        "aws_sdk_cost_explorer.types.generic_boolean.GenericBoolean"
    )
    ...
    platform_differences: NotRequired[
        "aws_sdk_cost_explorer.types.platform_differences.PlatformDifferences"
    ]
...
def serialize_aws_json_1_1(value: TargetInstance) -> dict:
    ...
    if "platform_differences" in value:
        ...
        out["PlatformDifferences"] = (
            aws_sdk_cost_explorer.types.platform_differences.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TargetInstance:
    ...
    if "PlatformDifferences" in data:
        ...
        out["platform_differences"] = (
            aws_sdk_cost_explorer.types.platform_differences.deserialize_aws_json_1_1(
