...
class AnomalySubscription(TypedDict):
    ...
    monitor_arn_list: "aws_sdk_cost_explorer.types.monitor_arn_list.MonitorArnList"
    """<p>A list of cost anomaly monitors. </p>"""
    subscribers: "aws_sdk_cost_explorer.types.subscribers.Subscribers"
    ...
    subscription_name: "aws_sdk_cost_explorer.types.generic_string.GenericString"
...
def serialize_aws_json_1_1(value: AnomalySubscription) -> dict:
    ...
    out["Subscribers"] = aws_sdk_cost_explorer.types.subscribers.serialize_aws_json_1_1(
        value["subscribers"]
    )
