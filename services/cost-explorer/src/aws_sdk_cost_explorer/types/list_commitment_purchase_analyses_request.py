...
class ListCommitmentPurchaseAnalysesRequest(TypedDict):
    ...
    page_size: "aws_sdk_cost_explorer.types.analyses_page_size.AnalysesPageSize"
    """<p>The number of analyses that you want returned in a single response object.</p>"""
    analysis_ids: NotRequired["aws_sdk_cost_explorer.types.analysis_ids.AnalysisIds"]
...
def serialize_aws_json_1_1(value: ListCommitmentPurchaseAnalysesRequest) -> dict:
    ...
    if "analysis_status" in value:
        ...
        out["AnalysisStatus"] = (
            aws_sdk_cost_explorer.types.analysis_status.serialize_aws_json_1_1(
    ...
    if "analysis_ids" in value:
        ...
        out["AnalysisIds"] = (
            aws_sdk_cost_explorer.types.analysis_ids.serialize_aws_json_1_1(
                value["analysis_ids"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListCommitmentPurchaseAnalysesRequest:
    ...
    if "AnalysisStatus" in data:
        ...
        out["analysis_status"] = (
            aws_sdk_cost_explorer.types.analysis_status.deserialize_aws_json_1_1(
                data["AnalysisStatus"]
            )
        )
    ...
    if "AnalysisIds" in data:
        ...
        out["analysis_ids"] = (
            aws_sdk_cost_explorer.types.analysis_ids.deserialize_aws_json_1_1(
                data["AnalysisIds"]
            )
        )
    return out
