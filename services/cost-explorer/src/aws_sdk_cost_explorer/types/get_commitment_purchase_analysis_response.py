...
class GetCommitmentPurchaseAnalysisResponse(TypedDict):
    ...
    analysis_status: "aws_sdk_cost_explorer.types.analysis_status.AnalysisStatus"
    ...
    analysis_details: NotRequired[
        "aws_sdk_cost_explorer.types.analysis_details.AnalysisDetails"
    ]
...
def serialize_aws_json_1_1(value: GetCommitmentPurchaseAnalysisResponse) -> dict:
    ...
    if "analysis_details" in value:
        ...
        out["AnalysisDetails"] = (
            aws_sdk_cost_explorer.types.analysis_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetCommitmentPurchaseAnalysisResponse:
    ...
    if "AnalysisDetails" in data:
        ...
        out["analysis_details"] = (
            aws_sdk_cost_explorer.types.analysis_details.deserialize_aws_json_1_1(
