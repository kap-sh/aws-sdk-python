...
if TYPE_CHECKING:
    import aws_sdk_cost_explorer.types.anomaly_subscriptions
    import aws_sdk_cost_explorer.types.next_page_token


class GetAnomalySubscriptionsResponse(TypedDict):
    anomaly_subscriptions: (
        "aws_sdk_cost_explorer.types.anomaly_subscriptions.AnomalySubscriptions"
    )
...
def serialize_aws_json_1_1(value: GetAnomalySubscriptionsResponse) -> dict:
    ...
    out["AnomalySubscriptions"] = (
        aws_sdk_cost_explorer.types.anomaly_subscriptions.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetAnomalySubscriptionsResponse:
    ...
    if "AnomalySubscriptions" in data:
        ...
        out["anomaly_subscriptions"] = (
            aws_sdk_cost_explorer.types.anomaly_subscriptions.deserialize_aws_json_1_1(
