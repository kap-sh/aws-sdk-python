...
class AnalysisSummary(TypedDict, closed=True):
    ...
    error_code: NotRequired["aws_sdk_cost_explorer.types.error_code.ErrorCode"]
    """<p>The error code used for the analysis.</p>"""
    analysis_id: NotRequired["aws_sdk_cost_explorer.types.analysis_id.AnalysisId"]
    ...
    commitment_purchase_analysis_configuration: NotRequired[
        "aws_sdk_cost_explorer.types.commitment_purchase_analysis_configuration.CommitmentPurchaseAnalysisConfiguration"
    ]
...
def serialize_aws_json_1_1(value: AnalysisSummary) -> dict:
    ...
    if "error_code" in value:
        ...
        out["ErrorCode"] = (
            aws_sdk_cost_explorer.types.error_code.serialize_aws_json_1_1(
                value["error_code"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> AnalysisSummary:
    ...
    if "ErrorCode" in data:
        ...
        out["error_code"] = (
            aws_sdk_cost_explorer.types.error_code.deserialize_aws_json_1_1(
                data["ErrorCode"]
            )
        )
