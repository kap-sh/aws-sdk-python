...
if TYPE_CHECKING:
    ...
    import aws_sdk_cost_explorer.types.resource_details
    import aws_sdk_cost_explorer.types.resource_utilization
    import aws_sdk_cost_explorer.types.tag_values_list


class CurrentInstance(TypedDict):
    resource_id: NotRequired["aws_sdk_cost_explorer.types.generic_string.GenericString"]
    ...
    tags: NotRequired["aws_sdk_cost_explorer.types.tag_values_list.TagValuesList"]
    """<p>Cost allocation resource tags that are applied to the instance.</p>"""
    resource_details: NotRequired[
        "aws_sdk_cost_explorer.types.resource_details.ResourceDetails"
    ]
    """<p>Details about the resource and utilization.</p>"""
    resource_utilization: NotRequired[
        "aws_sdk_cost_explorer.types.resource_utilization.ResourceUtilization"
    ]
...
def serialize_aws_json_1_1(value: CurrentInstance) -> dict:
    ...
    if "tags" in value:
        ...
        out["Tags"] = (
            aws_sdk_cost_explorer.types.tag_values_list.serialize_aws_json_1_1(
                value["tags"]
            )
        )
    if "resource_details" in value:
        ...
        out["ResourceDetails"] = (
            aws_sdk_cost_explorer.types.resource_details.serialize_aws_json_1_1(
    ...
    if "resource_utilization" in value:
        ...
        out["ResourceUtilization"] = (
            aws_sdk_cost_explorer.types.resource_utilization.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CurrentInstance:
    ...
    if "Tags" in data:
        ...
        out["tags"] = (
            aws_sdk_cost_explorer.types.tag_values_list.deserialize_aws_json_1_1(
                data["Tags"]
            )
        )
    if "ResourceDetails" in data:
        ...
        out["resource_details"] = (
            aws_sdk_cost_explorer.types.resource_details.deserialize_aws_json_1_1(
    ...
    if "ResourceUtilization" in data:
        ...
        out["resource_utilization"] = (
            aws_sdk_cost_explorer.types.resource_utilization.deserialize_aws_json_1_1(
