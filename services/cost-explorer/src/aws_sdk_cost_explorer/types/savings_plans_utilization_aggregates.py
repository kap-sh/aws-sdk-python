...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: SavingsPlansUtilizationAggregates) -> dict:
    out: dict = {}
    import aws_sdk_cost_explorer.types.savings_plans_utilization
...
def deserialize_aws_json_1_1(data: dict) -> SavingsPlansUtilizationAggregates:
    out: SavingsPlansUtilizationAggregates = {}  # type: ignore[typeddict-item]
    if "Utilization" in data:
        ...
        raise DeserializationError(
            "SavingsPlansUtilizationAggregates.utilization required"
        )
    if "Savings" in data:
        import aws_sdk_cost_explorer.types.savings_plans_savings
