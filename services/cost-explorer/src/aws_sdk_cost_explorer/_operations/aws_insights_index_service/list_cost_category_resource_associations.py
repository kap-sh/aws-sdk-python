"""Generated from Smithy shape ``com.amazonaws.costexplorer#ListCostCategoryResourceAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.list_cost_category_resource_associations_response.ListCostCategoryResourceAssociationsResponse = aws_sdk_cost_explorer.types.list_cost_category_resource_associations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.list_cost_category_resource_associations_request.ListCostCategoryResourceAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_cost_category_resource_associations(
