"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetCostAndUsageWithResources``."""
...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_cost_and_usage_with_resources_response.GetCostAndUsageWithResourcesResponse = aws_sdk_cost_explorer.types.get_cost_and_usage_with_resources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_cost_and_usage_with_resources_request.GetCostAndUsageWithResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.GetCostAndUsageWithResources"
    import aws_sdk_cost_explorer.types.get_cost_and_usage_with_resources_request

    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_cost_and_usage_with_resources_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_cost_and_usage_with_resources(
