...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnresolvableUsageUnitException":
            import aws_sdk_cost_explorer.errors.unresolvable_usage_unit_exception

            raise aws_sdk_cost_explorer.errors.unresolvable_usage_unit_exception.UnresolvableUsageUnitException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_usage_forecast_response.GetUsageForecastResponse = aws_sdk_cost_explorer.types.get_usage_forecast_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_usage_forecast_request.GetUsageForecastRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_usage_forecast_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
