...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_reservation_purchase_recommendation_response.GetReservationPurchaseRecommendationResponse = aws_sdk_cost_explorer.types.get_reservation_purchase_recommendation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_reservation_purchase_recommendation_request.GetReservationPurchaseRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
