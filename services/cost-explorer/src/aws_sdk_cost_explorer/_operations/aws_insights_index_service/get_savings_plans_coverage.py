"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetSavingsPlansCoverage``."""
...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_savings_plans_coverage_response.GetSavingsPlansCoverageResponse = aws_sdk_cost_explorer.types.get_savings_plans_coverage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_savings_plans_coverage_request.GetSavingsPlansCoverageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_savings_plans_coverage(
