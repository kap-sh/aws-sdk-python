...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_response.ListSavingsPlansPurchaseRecommendationGenerationResponse = aws_sdk_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_request.ListSavingsPlansPurchaseRecommendationGenerationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
