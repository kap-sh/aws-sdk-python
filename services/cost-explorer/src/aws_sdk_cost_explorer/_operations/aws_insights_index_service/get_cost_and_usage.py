...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_cost_and_usage_response.GetCostAndUsageResponse = aws_sdk_cost_explorer.types.get_cost_and_usage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_cost_and_usage_request.GetCostAndUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_cost_and_usage_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
