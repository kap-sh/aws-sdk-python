"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetCostAndUsageComparisons``."""
...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_cost_and_usage_comparisons_response.GetCostAndUsageComparisonsResponse = aws_sdk_cost_explorer.types.get_cost_and_usage_comparisons_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_cost_and_usage_comparisons_request.GetCostAndUsageComparisonsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.GetCostAndUsageComparisons"
    import aws_sdk_cost_explorer.types.get_cost_and_usage_comparisons_request

    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_cost_and_usage_comparisons_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_cost_and_usage_comparisons(
