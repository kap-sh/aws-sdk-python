...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_savings_plans_purchase_recommendation_response.GetSavingsPlansPurchaseRecommendationResponse = aws_sdk_cost_explorer.types.get_savings_plans_purchase_recommendation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_savings_plans_purchase_recommendation_request.GetSavingsPlansPurchaseRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_savings_plans_purchase_recommendation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
