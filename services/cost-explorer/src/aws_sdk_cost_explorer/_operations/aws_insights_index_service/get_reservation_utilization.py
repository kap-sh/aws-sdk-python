"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetReservationUtilization``."""
...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_reservation_utilization_response.GetReservationUtilizationResponse = aws_sdk_cost_explorer.types.get_reservation_utilization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_reservation_utilization_request.GetReservationUtilizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_reservation_utilization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_reservation_utilization(
