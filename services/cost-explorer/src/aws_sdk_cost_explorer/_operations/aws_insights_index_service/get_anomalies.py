...
def build_request(
    ...
    input: aws_sdk_cost_explorer.types.get_anomalies_request.GetAnomaliesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_anomalies_request.serialize_aws_json_1_1(input)
    ).encode()
