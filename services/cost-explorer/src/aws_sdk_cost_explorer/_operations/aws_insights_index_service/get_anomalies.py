...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_anomalies_request.GetAnomaliesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_anomalies_request.serialize_aws_json_1_1(input_)
    ).encode()
