"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetCostComparisonDrivers``."""
...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_cost_comparison_drivers_response.GetCostComparisonDriversResponse = aws_sdk_cost_explorer.types.get_cost_comparison_drivers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_cost_comparison_drivers_request.GetCostComparisonDriversRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.GetCostComparisonDrivers"
    import aws_sdk_cost_explorer.types.get_cost_comparison_drivers_request

    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_cost_comparison_drivers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_cost_comparison_drivers(
