"""Generated from Smithy shape ``com.amazonaws.costexplorer#UpdateCostAllocationTagsStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.update_cost_allocation_tags_status_response.UpdateCostAllocationTagsStatusResponse = aws_sdk_cost_explorer.types.update_cost_allocation_tags_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.update_cost_allocation_tags_status_request.UpdateCostAllocationTagsStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_cost_allocation_tags_status(
