...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_cost_categories_response.GetCostCategoriesResponse = aws_sdk_cost_explorer.types.get_cost_categories_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_cost_categories_request.GetCostCategoriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_cost_categories_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
