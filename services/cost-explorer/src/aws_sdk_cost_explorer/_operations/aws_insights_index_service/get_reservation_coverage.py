...
def handle_response(
    ...
    out: aws_sdk_cost_explorer.types.get_reservation_coverage_response.GetReservationCoverageResponse = aws_sdk_cost_explorer.types.get_reservation_coverage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_reservation_coverage_request.GetReservationCoverageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_reservation_coverage_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
