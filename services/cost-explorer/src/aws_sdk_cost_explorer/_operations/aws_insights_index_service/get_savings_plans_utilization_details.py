"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetSavingsPlansUtilizationDetails``."""
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_savings_plans_utilization_details_request.GetSavingsPlansUtilizationDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_savings_plans_utilization_details(
