"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetTags``."""
...
def build_request(
    ...
    input_: aws_sdk_cost_explorer.types.get_tags_request.GetTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cost_explorer.types.get_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_tags(
    ...
    aws_sdk_cost_explorer.types.get_tags_response.GetTagsResponse, zapros.Response
]:
