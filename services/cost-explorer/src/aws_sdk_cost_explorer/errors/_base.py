...
class CostExplorerError(Exception):
    """Base class for all CostExplorer service errors."""


class ServiceError(CostExplorerError):
...
class SerializationError(CostExplorerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CostExplorerError):
...
class WaiterFailedError(CostExplorerError):
...
class WaiterTimeoutError(CostExplorerError):
