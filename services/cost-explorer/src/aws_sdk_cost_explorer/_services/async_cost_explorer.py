...
from aws_sdk_cost_explorer._pagination import resolve_path as _resolve_path
from aws_sdk_cost_explorer._services._aws_config import aaws_config
from aws_sdk_cost_explorer._services._pipeline import (
    AsyncInterceptor,
...
if TYPE_CHECKING:
    ...
    import aws_sdk_cost_explorer.types.analyses_page_size
    import aws_sdk_cost_explorer.types.analysis_id
    import aws_sdk_cost_explorer.types.analysis_ids
    import aws_sdk_cost_explorer.types.analysis_status
    ...
    import aws_sdk_cost_explorer.types.cost_comparison_drivers_max_results
    import aws_sdk_cost_explorer.types.create_anomaly_monitor_request
    import aws_sdk_cost_explorer.types.create_anomaly_monitor_response
    import aws_sdk_cost_explorer.types.create_anomaly_subscription_request
    import aws_sdk_cost_explorer.types.create_anomaly_subscription_response
    import aws_sdk_cost_explorer.types.create_cost_category_definition_request
    import aws_sdk_cost_explorer.types.create_cost_category_definition_response
    import aws_sdk_cost_explorer.types.date_interval
    import aws_sdk_cost_explorer.types.delete_anomaly_monitor_request
    import aws_sdk_cost_explorer.types.delete_anomaly_monitor_response
    import aws_sdk_cost_explorer.types.delete_anomaly_subscription_request
    import aws_sdk_cost_explorer.types.delete_anomaly_subscription_response
    import aws_sdk_cost_explorer.types.delete_cost_category_definition_request
    import aws_sdk_cost_explorer.types.delete_cost_category_definition_response
    import aws_sdk_cost_explorer.types.describe_cost_category_definition_request
    import aws_sdk_cost_explorer.types.describe_cost_category_definition_response
    ...
    import aws_sdk_cost_explorer.types.generation_summary
    ...
    import aws_sdk_cost_explorer.types.get_anomaly_monitors_request
    import aws_sdk_cost_explorer.types.get_anomaly_monitors_response
    import aws_sdk_cost_explorer.types.get_anomaly_subscriptions_request
    import aws_sdk_cost_explorer.types.get_anomaly_subscriptions_response
    import aws_sdk_cost_explorer.types.get_approximate_usage_records_request
    import aws_sdk_cost_explorer.types.get_approximate_usage_records_response
    import aws_sdk_cost_explorer.types.get_commitment_purchase_analysis_request
    import aws_sdk_cost_explorer.types.get_commitment_purchase_analysis_response
    import aws_sdk_cost_explorer.types.get_cost_and_usage_comparisons_request
    import aws_sdk_cost_explorer.types.get_cost_and_usage_comparisons_response
    import aws_sdk_cost_explorer.types.get_cost_and_usage_request
    import aws_sdk_cost_explorer.types.get_cost_and_usage_response
    import aws_sdk_cost_explorer.types.get_cost_and_usage_with_resources_request
    import aws_sdk_cost_explorer.types.get_cost_and_usage_with_resources_response
    import aws_sdk_cost_explorer.types.get_cost_categories_request
    import aws_sdk_cost_explorer.types.get_cost_categories_response
    import aws_sdk_cost_explorer.types.get_cost_comparison_drivers_request
    import aws_sdk_cost_explorer.types.get_cost_comparison_drivers_response
    import aws_sdk_cost_explorer.types.get_cost_forecast_request
    import aws_sdk_cost_explorer.types.get_cost_forecast_response
    import aws_sdk_cost_explorer.types.get_dimension_values_request
    import aws_sdk_cost_explorer.types.get_dimension_values_response
    import aws_sdk_cost_explorer.types.get_reservation_coverage_request
    import aws_sdk_cost_explorer.types.get_reservation_coverage_response
    import aws_sdk_cost_explorer.types.get_reservation_purchase_recommendation_request
    import aws_sdk_cost_explorer.types.get_reservation_purchase_recommendation_response
    import aws_sdk_cost_explorer.types.get_reservation_utilization_request
    import aws_sdk_cost_explorer.types.get_reservation_utilization_response
    import aws_sdk_cost_explorer.types.get_rightsizing_recommendation_request
    import aws_sdk_cost_explorer.types.get_rightsizing_recommendation_response
    import aws_sdk_cost_explorer.types.get_savings_plan_purchase_recommendation_details_request
    import aws_sdk_cost_explorer.types.get_savings_plan_purchase_recommendation_details_response
    import aws_sdk_cost_explorer.types.get_savings_plans_coverage_request
    import aws_sdk_cost_explorer.types.get_savings_plans_coverage_response
    import aws_sdk_cost_explorer.types.get_savings_plans_purchase_recommendation_request
    import aws_sdk_cost_explorer.types.get_savings_plans_purchase_recommendation_response
    ...
    import aws_sdk_cost_explorer.types.get_savings_plans_utilization_request
    import aws_sdk_cost_explorer.types.get_savings_plans_utilization_response
    import aws_sdk_cost_explorer.types.get_tags_request
    import aws_sdk_cost_explorer.types.get_tags_response
    import aws_sdk_cost_explorer.types.get_usage_forecast_request
    import aws_sdk_cost_explorer.types.get_usage_forecast_response
    import aws_sdk_cost_explorer.types.granularity
    import aws_sdk_cost_explorer.types.group_definitions
    import aws_sdk_cost_explorer.types.list_commitment_purchase_analyses_request
    import aws_sdk_cost_explorer.types.list_commitment_purchase_analyses_response
    import aws_sdk_cost_explorer.types.list_cost_allocation_tag_backfill_history_request
    import aws_sdk_cost_explorer.types.list_cost_allocation_tag_backfill_history_response
    import aws_sdk_cost_explorer.types.list_cost_allocation_tags_request
    import aws_sdk_cost_explorer.types.list_cost_allocation_tags_response
    import aws_sdk_cost_explorer.types.list_cost_category_definitions_request
    import aws_sdk_cost_explorer.types.list_cost_category_definitions_response
    import aws_sdk_cost_explorer.types.list_cost_category_resource_associations_request
    import aws_sdk_cost_explorer.types.list_cost_category_resource_associations_response
    import aws_sdk_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_request
    import aws_sdk_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_response
    import aws_sdk_cost_explorer.types.list_tags_for_resource_request
    import aws_sdk_cost_explorer.types.list_tags_for_resource_response
    ...
    import aws_sdk_cost_explorer.types.provide_anomaly_feedback_request
    import aws_sdk_cost_explorer.types.provide_anomaly_feedback_response
    ...
    import aws_sdk_cost_explorer.types.reservation_purchase_recommendation
    ...
    import aws_sdk_cost_explorer.types.start_commitment_purchase_analysis_request
    import aws_sdk_cost_explorer.types.start_commitment_purchase_analysis_response
    import aws_sdk_cost_explorer.types.start_cost_allocation_tag_backfill_request
    import aws_sdk_cost_explorer.types.start_cost_allocation_tag_backfill_response
    import aws_sdk_cost_explorer.types.start_savings_plans_purchase_recommendation_generation_request
    import aws_sdk_cost_explorer.types.start_savings_plans_purchase_recommendation_generation_response
    ...
    import aws_sdk_cost_explorer.types.tag_resource_request
    import aws_sdk_cost_explorer.types.tag_resource_response
    import aws_sdk_cost_explorer.types.term_in_years
    import aws_sdk_cost_explorer.types.total_impact_filter
    import aws_sdk_cost_explorer.types.untag_resource_request
    import aws_sdk_cost_explorer.types.untag_resource_response
    import aws_sdk_cost_explorer.types.update_anomaly_monitor_request
    import aws_sdk_cost_explorer.types.update_anomaly_monitor_response
    import aws_sdk_cost_explorer.types.update_anomaly_subscription_request
    import aws_sdk_cost_explorer.types.update_anomaly_subscription_response
    import aws_sdk_cost_explorer.types.update_cost_allocation_tags_status_request
    import aws_sdk_cost_explorer.types.update_cost_allocation_tags_status_response
...
class AsyncCostExplorerClientConfig(TypedDict, total=False, closed=True):
...
class AsyncCostExplorerClient:
    ...
    async def create_anomaly_monitor(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.create_anomaly_monitor_request.CreateAnomalyMonitorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.create_anomaly_monitor_response.CreateAnomalyMonitorResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.create_anomaly_monitor

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.create_anomaly_monitor.async_create_anomaly_monitor(
    ...
    async def create_anomaly_subscription(
        self,
        anomaly_subscription: "aws_sdk_cost_explorer.types.anomaly_subscription.AnomalySubscription",
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
        resource_tags: Optional[
            "aws_sdk_cost_explorer.types.resource_tag_list.ResourceTagList"
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.create_anomaly_subscription_request.CreateAnomalySubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.create_anomaly_subscription_response.CreateAnomalySubscriptionResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.create_anomaly_subscription

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.create_anomaly_subscription.async_create_anomaly_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_cost_category_definition(
        ...
        rule_version: "aws_sdk_cost_explorer.types.cost_category_rule_version.CostCategoryRuleVersion",
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.create_cost_category_definition_request.CreateCostCategoryDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.create_cost_category_definition_response.CreateCostCategoryDefinitionResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.create_cost_category_definition

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.create_cost_category_definition.async_create_cost_category_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_anomaly_monitor(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
    ) -> "aws_sdk_cost_explorer.types.delete_anomaly_monitor_response.DeleteAnomalyMonitorResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.delete_anomaly_monitor_request.DeleteAnomalyMonitorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.delete_anomaly_monitor_response.DeleteAnomalyMonitorResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.delete_anomaly_monitor

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.delete_anomaly_monitor.async_delete_anomaly_monitor(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_anomaly_subscription(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
    ) -> "aws_sdk_cost_explorer.types.delete_anomaly_subscription_response.DeleteAnomalySubscriptionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.delete_anomaly_subscription_request.DeleteAnomalySubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.delete_anomaly_subscription_response.DeleteAnomalySubscriptionResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.delete_anomaly_subscription

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.delete_anomaly_subscription.async_delete_anomaly_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_cost_category_definition(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
    ) -> "aws_sdk_cost_explorer.types.delete_cost_category_definition_response.DeleteCostCategoryDefinitionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.delete_cost_category_definition_request.DeleteCostCategoryDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.delete_cost_category_definition_response.DeleteCostCategoryDefinitionResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.delete_cost_category_definition

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.delete_cost_category_definition.async_delete_cost_category_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_cost_category_definition(
        ...
        *,
    ...
    ) -> "aws_sdk_cost_explorer.types.describe_cost_category_definition_response.DescribeCostCategoryDefinitionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.describe_cost_category_definition_request.DescribeCostCategoryDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.describe_cost_category_definition_response.DescribeCostCategoryDefinitionResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.describe_cost_category_definition

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.describe_cost_category_definition.async_describe_cost_category_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_anomalies(
        self,
        date_interval: "aws_sdk_cost_explorer.types.anomaly_date_interval.AnomalyDateInterval",
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
        ...
        max_results: Optional["aws_sdk_cost_explorer.types.page_size.PageSize"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_anomalies_request.GetAnomaliesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_anomalies_response.GetAnomaliesResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_anomalies

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_anomalies.async_get_anomalies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_anomalies(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_cost_explorer.types.page_size.PageSize"] = None,
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.anomaly.Anomaly]":
        _token = next_page_token
        while True:
            _response = await self.get_anomalies(
                date_interval,
    ...
    async def get_anomaly_monitors(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
        monitor_arn_list: Optional["aws_sdk_cost_explorer.types.values.Values"] = None,
        next_page_token: Optional[
            "aws_sdk_cost_explorer.types.next_page_token.NextPageToken"
        ] = None,
        max_results: Optional["aws_sdk_cost_explorer.types.page_size.PageSize"] = None,
    ) -> "aws_sdk_cost_explorer.types.get_anomaly_monitors_response.GetAnomalyMonitorsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_anomaly_monitors_request.GetAnomalyMonitorsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_anomaly_monitors_response.GetAnomalyMonitorsResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_anomaly_monitors

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_anomaly_monitors.async_get_anomaly_monitors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_anomaly_monitors(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_cost_explorer.types.page_size.PageSize"] = None,
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.anomaly_monitor.AnomalyMonitor]":
        _token = next_page_token
        while True:
            _response = await self.get_anomaly_monitors(
                config_overrides=config_overrides,
    ...
    async def get_anomaly_subscriptions(
        ...
        *,
        ...
        subscription_arn_list: Optional[
            "aws_sdk_cost_explorer.types.values.Values"
        ] = None,
        monitor_arn: Optional[
            "aws_sdk_cost_explorer.types.generic_string.GenericString"
        ] = None,
        ...
        max_results: Optional["aws_sdk_cost_explorer.types.page_size.PageSize"] = None,
    ) -> "aws_sdk_cost_explorer.types.get_anomaly_subscriptions_response.GetAnomalySubscriptionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_anomaly_subscriptions_request.GetAnomalySubscriptionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_anomaly_subscriptions_response.GetAnomalySubscriptionsResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_anomaly_subscriptions

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_anomaly_subscriptions.async_get_anomaly_subscriptions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_anomaly_subscriptions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_cost_explorer.types.page_size.PageSize"] = None,
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.anomaly_subscription.AnomalySubscription]":
        _token = next_page_token
        while True:
            _response = await self.get_anomaly_subscriptions(
                config_overrides=config_overrides,
    ...
    async def get_approximate_usage_records(
        ...
        approximation_dimension: "aws_sdk_cost_explorer.types.approximation_dimension.ApproximationDimension",
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
        services: Optional[
            "aws_sdk_cost_explorer.types.usage_services.UsageServices"
        ] = None,
    ) -> "aws_sdk_cost_explorer.types.get_approximate_usage_records_response.GetApproximateUsageRecordsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_approximate_usage_records_request.GetApproximateUsageRecordsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_approximate_usage_records_response.GetApproximateUsageRecordsResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_approximate_usage_records

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_approximate_usage_records.async_get_approximate_usage_records(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_commitment_purchase_analysis(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
    ) -> "aws_sdk_cost_explorer.types.get_commitment_purchase_analysis_response.GetCommitmentPurchaseAnalysisResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_commitment_purchase_analysis_request.GetCommitmentPurchaseAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_commitment_purchase_analysis_response.GetCommitmentPurchaseAnalysisResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_commitment_purchase_analysis

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_commitment_purchase_analysis.async_get_commitment_purchase_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_cost_and_usage(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
        filter: Optional["aws_sdk_cost_explorer.types.expression.Expression"] = None,
        group_by: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_cost_and_usage_request.GetCostAndUsageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_cost_and_usage_response.GetCostAndUsageResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_and_usage

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_and_usage.async_get_cost_and_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_cost_and_usage_comparisons(
        ...
        *,
    ...
    ) -> "aws_sdk_cost_explorer.types.get_cost_and_usage_comparisons_response.GetCostAndUsageComparisonsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_cost_and_usage_comparisons_request.GetCostAndUsageComparisonsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_cost_and_usage_comparisons_response.GetCostAndUsageComparisonsResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_and_usage_comparisons

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_and_usage_comparisons.async_get_cost_and_usage_comparisons(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.cost_and_usage_comparison.CostAndUsageComparison]":
        _token = next_page_token
        while True:
            _response = await self.get_cost_and_usage_comparisons(
    ...
    async def get_cost_and_usage_with_resources(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
        metrics: Optional[
            "aws_sdk_cost_explorer.types.metric_names.MetricNames"
        ] = None,
        group_by: Optional[
            "aws_sdk_cost_explorer.types.group_definitions.GroupDefinitions"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_cost_and_usage_with_resources_request.GetCostAndUsageWithResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_cost_and_usage_with_resources_response.GetCostAndUsageWithResourcesResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_and_usage_with_resources

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_and_usage_with_resources.async_get_cost_and_usage_with_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_cost_categories(
        ...
        *,
        ...
        search_string: Optional[
            "aws_sdk_cost_explorer.types.search_string.SearchString"
        ] = None,
        ...
        filter: Optional["aws_sdk_cost_explorer.types.expression.Expression"] = None,
        sort_by: Optional[
            "aws_sdk_cost_explorer.types.sort_definitions.SortDefinitions"
        ] = None,
        billing_view_arn: Optional[
            "aws_sdk_cost_explorer.types.billing_view_arn.BillingViewArn"
        ] = None,
    ...
    ) -> "aws_sdk_cost_explorer.types.get_cost_categories_response.GetCostCategoriesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_cost_categories_request.GetCostCategoriesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_cost_categories_response.GetCostCategoriesResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_categories

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_categories.async_get_cost_categories(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_cost_comparison_drivers(
        ...
        *,
        ...
        max_results: Optional[
            "aws_sdk_cost_explorer.types.cost_comparison_drivers_max_results.CostComparisonDriversMaxResults"
        ] = None,
        next_page_token: Optional[
            "aws_sdk_cost_explorer.types.next_page_token.NextPageToken"
        ] = None,
    ) -> "aws_sdk_cost_explorer.types.get_cost_comparison_drivers_response.GetCostComparisonDriversResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_cost_comparison_drivers_request.GetCostComparisonDriversRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_cost_comparison_drivers_response.GetCostComparisonDriversResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_comparison_drivers

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_comparison_drivers.async_get_cost_comparison_drivers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.cost_comparison_driver.CostComparisonDriver]":
        _token = next_page_token
        while True:
            _response = await self.get_cost_comparison_drivers(
                baseline_time_period,
                comparison_time_period,
                metric_for_comparison,
                config_overrides=config_overrides,
    ...
    async def get_cost_forecast(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_cost_forecast_request.GetCostForecastRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_cost_forecast_response.GetCostForecastResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_forecast

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_cost_forecast.async_get_cost_forecast(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_dimension_values(
        ...
        *,
        ...
        context: Optional["aws_sdk_cost_explorer.types.context.Context"] = None,
        filter: Optional["aws_sdk_cost_explorer.types.expression.Expression"] = None,
        sort_by: Optional[
            "aws_sdk_cost_explorer.types.sort_definitions.SortDefinitions"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_dimension_values_request.GetDimensionValuesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_dimension_values_response.GetDimensionValuesResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_dimension_values

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_dimension_values.async_get_dimension_values(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_reservation_coverage(
        ...
        *,
        ...
        granularity: Optional[
            "aws_sdk_cost_explorer.types.granularity.Granularity"
        ] = None,
        filter: Optional["aws_sdk_cost_explorer.types.expression.Expression"] = None,
        metrics: Optional[
            "aws_sdk_cost_explorer.types.metric_names.MetricNames"
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_reservation_coverage_request.GetReservationCoverageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_reservation_coverage_response.GetReservationCoverageResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_reservation_coverage

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_reservation_coverage.async_get_reservation_coverage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_reservation_purchase_recommendation(
        ...
        *,
        ...
        account_scope: Optional[
            "aws_sdk_cost_explorer.types.account_scope.AccountScope"
        ] = None,
        ...
        term_in_years: Optional[
            "aws_sdk_cost_explorer.types.term_in_years.TermInYears"
        ] = None,
    ...
    ) -> "aws_sdk_cost_explorer.types.get_reservation_purchase_recommendation_response.GetReservationPurchaseRecommendationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_reservation_purchase_recommendation_request.GetReservationPurchaseRecommendationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_reservation_purchase_recommendation_response.GetReservationPurchaseRecommendationResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_reservation_purchase_recommendation

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_reservation_purchase_recommendation.async_get_reservation_purchase_recommendation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.reservation_purchase_recommendation.ReservationPurchaseRecommendation]":
        _token = next_page_token
        while True:
            _response = await self.get_reservation_purchase_recommendation(
                service,
                config_overrides=config_overrides,
    ...
    async def get_reservation_utilization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_reservation_utilization_request.GetReservationUtilizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_reservation_utilization_response.GetReservationUtilizationResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_reservation_utilization

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_reservation_utilization.async_get_reservation_utilization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_rightsizing_recommendation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_rightsizing_recommendation_request.GetRightsizingRecommendationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_rightsizing_recommendation_response.GetRightsizingRecommendationResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_rightsizing_recommendation

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_rightsizing_recommendation.async_get_rightsizing_recommendation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.rightsizing_recommendation.RightsizingRecommendation]":
        _token = next_page_token
        while True:
            _response = await self.get_rightsizing_recommendation(
                service,
                config_overrides=config_overrides,
                filter=filter,
    ...
    async def get_savings_plan_purchase_recommendation_details(
        self,
        recommendation_detail_id: "aws_sdk_cost_explorer.types.recommendation_detail_id.RecommendationDetailId",
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
    ) -> "aws_sdk_cost_explorer.types.get_savings_plan_purchase_recommendation_details_response.GetSavingsPlanPurchaseRecommendationDetailsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_savings_plan_purchase_recommendation_details_request.GetSavingsPlanPurchaseRecommendationDetailsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_savings_plan_purchase_recommendation_details_response.GetSavingsPlanPurchaseRecommendationDetailsResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_savings_plan_purchase_recommendation_details

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_savings_plan_purchase_recommendation_details.async_get_savings_plan_purchase_recommendation_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_savings_plans_coverage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_savings_plans_coverage_request.GetSavingsPlansCoverageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_savings_plans_coverage_response.GetSavingsPlansCoverageResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_savings_plans_coverage

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_savings_plans_coverage.async_get_savings_plans_coverage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_savings_plans_purchase_recommendation(
        ...
        lookback_period_in_days: "aws_sdk_cost_explorer.types.lookback_period_in_days.LookbackPeriodInDays",
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
        account_scope: Optional[
            "aws_sdk_cost_explorer.types.account_scope.AccountScope"
        ...
        filter: Optional["aws_sdk_cost_explorer.types.expression.Expression"] = None,
    ) -> "aws_sdk_cost_explorer.types.get_savings_plans_purchase_recommendation_response.GetSavingsPlansPurchaseRecommendationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_savings_plans_purchase_recommendation_request.GetSavingsPlansPurchaseRecommendationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_savings_plans_purchase_recommendation_response.GetSavingsPlansPurchaseRecommendationResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_savings_plans_purchase_recommendation

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_savings_plans_purchase_recommendation.async_get_savings_plans_purchase_recommendation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_savings_plans_utilization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_savings_plans_utilization_request.GetSavingsPlansUtilizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_savings_plans_utilization_response.GetSavingsPlansUtilizationResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_savings_plans_utilization

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_savings_plans_utilization.async_get_savings_plans_utilization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_savings_plans_utilization_details(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_savings_plans_utilization_details_request.GetSavingsPlansUtilizationDetailsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_savings_plans_utilization_details_response.GetSavingsPlansUtilizationDetailsResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_savings_plans_utilization_details

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_savings_plans_utilization_details.async_get_savings_plans_utilization_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_tags(
        ...
        *,
        ...
        tag_key: Optional["aws_sdk_cost_explorer.types.tag_key.TagKey"] = None,
        filter: Optional["aws_sdk_cost_explorer.types.expression.Expression"] = None,
        sort_by: Optional[
            "aws_sdk_cost_explorer.types.sort_definitions.SortDefinitions"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_tags_request.GetTagsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_tags_response.GetTagsResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_tags

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_tags.async_get_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_usage_forecast(
        ...
        *,
    ...
    ) -> "aws_sdk_cost_explorer.types.get_usage_forecast_response.GetUsageForecastResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.get_usage_forecast_request.GetUsageForecastRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.get_usage_forecast_response.GetUsageForecastResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.get_usage_forecast

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.get_usage_forecast.async_get_usage_forecast(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_commitment_purchase_analyses(
        ...
        *,
        ...
        analysis_status: Optional[
            "aws_sdk_cost_explorer.types.analysis_status.AnalysisStatus"
        ] = None,
        next_page_token: Optional[
            "aws_sdk_cost_explorer.types.next_page_token.NextPageToken"
        ] = None,
        page_size: Optional[
            "aws_sdk_cost_explorer.types.analyses_page_size.AnalysesPageSize"
        ] = None,
        analysis_ids: Optional[
            "aws_sdk_cost_explorer.types.analysis_ids.AnalysisIds"
        ] = None,
    ) -> "aws_sdk_cost_explorer.types.list_commitment_purchase_analyses_response.ListCommitmentPurchaseAnalysesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.list_commitment_purchase_analyses_request.ListCommitmentPurchaseAnalysesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.list_commitment_purchase_analyses_response.ListCommitmentPurchaseAnalysesResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.list_commitment_purchase_analyses

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.list_commitment_purchase_analyses.async_list_commitment_purchase_analyses(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.analysis_summary.AnalysisSummary]":
        _token = next_page_token
        while True:
            _response = await self.list_commitment_purchase_analyses(
                config_overrides=config_overrides,
    ...
    async def list_cost_allocation_tag_backfill_history(
        ...
        *,
    ...
    ) -> "aws_sdk_cost_explorer.types.list_cost_allocation_tag_backfill_history_response.ListCostAllocationTagBackfillHistoryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.list_cost_allocation_tag_backfill_history_request.ListCostAllocationTagBackfillHistoryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.list_cost_allocation_tag_backfill_history_response.ListCostAllocationTagBackfillHistoryResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.list_cost_allocation_tag_backfill_history

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.list_cost_allocation_tag_backfill_history.async_list_cost_allocation_tag_backfill_history(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.cost_allocation_tag_backfill_request.CostAllocationTagBackfillRequest]":
        _token = next_token
        while True:
            _response = await self.list_cost_allocation_tag_backfill_history(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    async def list_cost_allocation_tags(
        ...
        *,
    ...
    ) -> "aws_sdk_cost_explorer.types.list_cost_allocation_tags_response.ListCostAllocationTagsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.list_cost_allocation_tags_request.ListCostAllocationTagsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.list_cost_allocation_tags_response.ListCostAllocationTagsResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.list_cost_allocation_tags

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.list_cost_allocation_tags.async_list_cost_allocation_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.cost_allocation_tag.CostAllocationTag]":
        _token = next_token
        while True:
            _response = await self.list_cost_allocation_tags(
                config_overrides=config_overrides,
                status=status,
                tag_keys=tag_keys,
                type=type,
    ...
    async def list_cost_category_definitions(
        ...
        *,
    ...
    ) -> "aws_sdk_cost_explorer.types.list_cost_category_definitions_response.ListCostCategoryDefinitionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.list_cost_category_definitions_request.ListCostCategoryDefinitionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.list_cost_category_definitions_response.ListCostCategoryDefinitionsResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.list_cost_category_definitions

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.list_cost_category_definitions.async_list_cost_category_definitions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.cost_category_reference.CostCategoryReference]":
        _token = next_token
        while True:
            _response = await self.list_cost_category_definitions(
                config_overrides=config_overrides,
    ...
    async def list_cost_category_resource_associations(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
        cost_category_arn: Optional["aws_sdk_cost_explorer.types.arn.Arn"] = None,
        next_token: Optional[
            "aws_sdk_cost_explorer.types.next_page_token.NextPageToken"
        ] = None,
        max_results: Optional[
    ...
    ) -> "aws_sdk_cost_explorer.types.list_cost_category_resource_associations_response.ListCostCategoryResourceAssociationsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.list_cost_category_resource_associations_request.ListCostCategoryResourceAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.list_cost_category_resource_associations_response.ListCostCategoryResourceAssociationsResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.list_cost_category_resource_associations

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.list_cost_category_resource_associations.async_list_cost_category_resource_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.cost_category_resource_association.CostCategoryResourceAssociation]":
        _token = next_token
        while True:
            _response = await self.list_cost_category_resource_associations(
                config_overrides=config_overrides,
    ...
    async def list_savings_plans_purchase_recommendation_generation(
        ...
        *,
    ...
    ) -> "aws_sdk_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_response.ListSavingsPlansPurchaseRecommendationGenerationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_request.ListSavingsPlansPurchaseRecommendationGenerationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_response.ListSavingsPlansPurchaseRecommendationGenerationResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.list_savings_plans_purchase_recommendation_generation

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.list_savings_plans_purchase_recommendation_generation.async_list_savings_plans_purchase_recommendation_generation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_cost_explorer.types.generation_summary.GenerationSummary]":
        _token = next_page_token
        while True:
            _response = (
                await self.list_savings_plans_purchase_recommendation_generation(
                    config_overrides=config_overrides,
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.list_tags_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def provide_anomaly_feedback(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
    ) -> "aws_sdk_cost_explorer.types.provide_anomaly_feedback_response.ProvideAnomalyFeedbackResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.provide_anomaly_feedback_request.ProvideAnomalyFeedbackRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.provide_anomaly_feedback_response.ProvideAnomalyFeedbackResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.provide_anomaly_feedback

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.provide_anomaly_feedback.async_provide_anomaly_feedback(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_commitment_purchase_analysis(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
    ) -> "aws_sdk_cost_explorer.types.start_commitment_purchase_analysis_response.StartCommitmentPurchaseAnalysisResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.start_commitment_purchase_analysis_request.StartCommitmentPurchaseAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.start_commitment_purchase_analysis_response.StartCommitmentPurchaseAnalysisResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.start_commitment_purchase_analysis

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.start_commitment_purchase_analysis.async_start_commitment_purchase_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_cost_allocation_tag_backfill(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
    ) -> "aws_sdk_cost_explorer.types.start_cost_allocation_tag_backfill_response.StartCostAllocationTagBackfillResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.start_cost_allocation_tag_backfill_request.StartCostAllocationTagBackfillRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.start_cost_allocation_tag_backfill_response.StartCostAllocationTagBackfillResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.start_cost_allocation_tag_backfill

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.start_cost_allocation_tag_backfill.async_start_cost_allocation_tag_backfill(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_savings_plans_purchase_recommendation_generation(
        ...
        async def _handler(
            ...
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.start_savings_plans_purchase_recommendation_generation

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.start_savings_plans_purchase_recommendation_generation.async_start_savings_plans_purchase_recommendation_generation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.tag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        self,
        resource_arn: "aws_sdk_cost_explorer.types.arn.Arn",
        resource_tag_keys: "aws_sdk_cost_explorer.types.resource_tag_key_list.ResourceTagKeyList",
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.untag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_anomaly_monitor(
        ...
        *,
    ...
    ) -> "aws_sdk_cost_explorer.types.update_anomaly_monitor_response.UpdateAnomalyMonitorResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.update_anomaly_monitor_request.UpdateAnomalyMonitorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.update_anomaly_monitor_response.UpdateAnomalyMonitorResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.update_anomaly_monitor

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.update_anomaly_monitor.async_update_anomaly_monitor(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_anomaly_subscription(
        ...
        *,
        ...
        subscribers: Optional[
            "aws_sdk_cost_explorer.types.subscribers.Subscribers"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.update_anomaly_subscription_request.UpdateAnomalySubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.update_anomaly_subscription_response.UpdateAnomalySubscriptionResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.update_anomaly_subscription

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.update_anomaly_subscription.async_update_anomaly_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cost_allocation_tags_status(
        ...
        *,
        config_overrides: Optional[AsyncCostExplorerClientConfig] = None,
    ) -> "aws_sdk_cost_explorer.types.update_cost_allocation_tags_status_response.UpdateCostAllocationTagsStatusResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.update_cost_allocation_tags_status_request.UpdateCostAllocationTagsStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.update_cost_allocation_tags_status_response.UpdateCostAllocationTagsStatusResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.update_cost_allocation_tags_status

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.update_cost_allocation_tags_status.async_update_cost_allocation_tags_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cost_category_definition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cost_explorer.types.update_cost_category_definition_request.UpdateCostCategoryDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cost_explorer.types.update_cost_category_definition_response.UpdateCostCategoryDefinitionResponse"
        ]:
            import aws_sdk_cost_explorer._operations.aws_insights_index_service.update_cost_category_definition

            (
                output,
                http_response,
            ) = await aws_sdk_cost_explorer._operations.aws_insights_index_service.update_cost_category_definition.async_update_cost_category_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
