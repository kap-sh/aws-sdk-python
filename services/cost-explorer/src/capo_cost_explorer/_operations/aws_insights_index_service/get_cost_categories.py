"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetCostCategories``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_cost_categories_response.GetCostCategoriesResponse = capo_cost_explorer.types.get_cost_categories_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.GetCostCategories"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_cost_categories_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_cost_categories(
