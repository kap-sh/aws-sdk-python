"""Generated from Smithy shape ``com.amazonaws.costexplorer#ProvideAnomalyFeedback``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.provide_anomaly_feedback_response.ProvideAnomalyFeedbackResponse = capo_cost_explorer.types.provide_anomaly_feedback_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.ProvideAnomalyFeedback"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.provide_anomaly_feedback_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_provide_anomaly_feedback(
