"""Generated from Smithy shape ``com.amazonaws.costexplorer#DescribeCostCategoryDefinition``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.describe_cost_category_definition_response.DescribeCostCategoryDefinitionResponse = capo_cost_explorer.types.describe_cost_category_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.DescribeCostCategoryDefinition"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.describe_cost_category_definition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_cost_category_definition(
