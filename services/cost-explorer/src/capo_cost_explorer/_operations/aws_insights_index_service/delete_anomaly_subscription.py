"""Generated from Smithy shape ``com.amazonaws.costexplorer#DeleteAnomalySubscription``."""
...
import capo_cost_explorer.errors.unknown_subscription_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnknownSubscriptionException":
            raise capo_cost_explorer.errors.unknown_subscription_exception.UnknownSubscriptionException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_cost_explorer.types.delete_anomaly_subscription_response.DeleteAnomalySubscriptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.DeleteAnomalySubscription"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.delete_anomaly_subscription_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_anomaly_subscription(
