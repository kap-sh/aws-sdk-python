...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_savings_plan_purchase_recommendation_details_response.GetSavingsPlanPurchaseRecommendationDetailsResponse = capo_cost_explorer.types.get_savings_plan_purchase_recommendation_details_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_savings_plan_purchase_recommendation_details_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
