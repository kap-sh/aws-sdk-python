"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetDimensionValues``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_dimension_values_response.GetDimensionValuesResponse = capo_cost_explorer.types.get_dimension_values_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_dimension_values_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_dimension_values(
