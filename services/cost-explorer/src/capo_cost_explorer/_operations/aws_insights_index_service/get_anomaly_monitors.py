...
import capo_cost_explorer.errors.unknown_monitor_exception
import capo_cost_explorer.types.anomaly_monitors
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnknownMonitorException":
            raise capo_cost_explorer.errors.unknown_monitor_exception.UnknownMonitorException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_anomaly_monitors_response.GetAnomalyMonitorsResponse = capo_cost_explorer.types.get_anomaly_monitors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_anomaly_monitors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
