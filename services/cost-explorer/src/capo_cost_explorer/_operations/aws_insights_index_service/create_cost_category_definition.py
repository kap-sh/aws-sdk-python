...
import capo_cost_explorer.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_cost_explorer.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_cost_explorer.types.create_cost_category_definition_response.CreateCostCategoryDefinitionResponse = capo_cost_explorer.types.create_cost_category_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.create_cost_category_definition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
