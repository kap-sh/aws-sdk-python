...
def handle_response(
    ...
    out: capo_cost_explorer.types.list_cost_category_resource_associations_response.ListCostCategoryResourceAssociationsResponse = capo_cost_explorer.types.list_cost_category_resource_associations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.list_cost_category_resource_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
