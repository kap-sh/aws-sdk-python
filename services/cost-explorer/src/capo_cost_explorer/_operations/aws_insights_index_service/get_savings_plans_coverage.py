...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_savings_plans_coverage_response.GetSavingsPlansCoverageResponse = capo_cost_explorer.types.get_savings_plans_coverage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_savings_plans_coverage_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
