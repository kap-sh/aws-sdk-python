"""Generated from Smithy shape ``com.amazonaws.costexplorer#ListCostAllocationTagBackfillHistory``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.list_cost_allocation_tag_backfill_history_response.ListCostAllocationTagBackfillHistoryResponse = capo_cost_explorer.types.list_cost_allocation_tag_backfill_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.list_cost_allocation_tag_backfill_history_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_cost_allocation_tag_backfill_history(
