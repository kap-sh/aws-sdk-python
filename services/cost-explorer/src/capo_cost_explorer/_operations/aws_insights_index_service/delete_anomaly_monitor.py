"""Generated from Smithy shape ``com.amazonaws.costexplorer#DeleteAnomalyMonitor``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.delete_anomaly_monitor_response.DeleteAnomalyMonitorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.DeleteAnomalyMonitor"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.delete_anomaly_monitor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_anomaly_monitor(
