...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_cost_and_usage_comparisons_response.GetCostAndUsageComparisonsResponse = capo_cost_explorer.types.get_cost_and_usage_comparisons_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_cost_and_usage_comparisons_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
