...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_cost_comparison_drivers_response.GetCostComparisonDriversResponse = capo_cost_explorer.types.get_cost_comparison_drivers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_cost_comparison_drivers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
