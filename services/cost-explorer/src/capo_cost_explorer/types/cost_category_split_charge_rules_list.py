...
if TYPE_CHECKING:
    import capo_cost_explorer.types.cost_category_split_charge_rule

CostCategorySplitChargeRulesList: TypeAlias = list[
    "capo_cost_explorer.types.cost_category_split_charge_rule.CostCategorySplitChargeRule"
]
...
def serialize_aws_json_1_1(value: CostCategorySplitChargeRulesList) -> list:
    ...
    for item in value:
        out.append(
            capo_cost_explorer.types.cost_category_split_charge_rule.serialize_aws_json_1_1(
                item
            )
        )
    return out
