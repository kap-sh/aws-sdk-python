...
class EC2Specification(TypedDict, closed=True):
    offering_class: NotRequired["capo_cost_explorer.types.offering_class.OfferingClass"]
...
def serialize_aws_json_1_1(value: EC2Specification) -> dict:
    ...
    if "offering_class" in value:
        ...
        out["OfferingClass"] = (
            capo_cost_explorer.types.offering_class.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EC2Specification:
    ...
    if "OfferingClass" in data:
        ...
        out["offering_class"] = (
            capo_cost_explorer.types.offering_class.deserialize_aws_json_1_1(
                data["OfferingClass"]
            )
        )
    return out
