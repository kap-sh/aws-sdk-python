...
if TYPE_CHECKING:
    ...
    import capo_cost_explorer.types.savings_plans_coverage_data
...
class SavingsPlansCoverage(TypedDict, closed=True):
    ...
    coverage: NotRequired[
        "capo_cost_explorer.types.savings_plans_coverage_data.SavingsPlansCoverageData"
    ]
...
def serialize_aws_json_1_1(value: SavingsPlansCoverage) -> dict:
    ...
    if "coverage" in value:
        ...
        out["Coverage"] = (
            capo_cost_explorer.types.savings_plans_coverage_data.serialize_aws_json_1_1(
                value["coverage"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> SavingsPlansCoverage:
    ...
    if "Coverage" in data:
        ...
        out["coverage"] = (
            capo_cost_explorer.types.savings_plans_coverage_data.deserialize_aws_json_1_1(
                data["Coverage"]
            )
        )
