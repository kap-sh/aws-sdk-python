...
if TYPE_CHECKING:
    import capo_cost_explorer.types.on_demand_cost


class CoverageCost(TypedDict, closed=True):
    on_demand_cost: NotRequired["capo_cost_explorer.types.on_demand_cost.OnDemandCost"]
