...
class CostCategoryInheritedValueDimension(TypedDict, closed=True):
    dimension_name: NotRequired[
        "capo_cost_explorer.types.cost_category_inherited_value_dimension_name.CostCategoryInheritedValueDimensionName"
    ]
    ...
    dimension_key: NotRequired["capo_cost_explorer.types.generic_string.GenericString"]
...
def serialize_aws_json_1_1(value: CostCategoryInheritedValueDimension) -> dict:
    ...
    if "dimension_name" in value:
        ...
        out["DimensionName"] = (
            capo_cost_explorer.types.cost_category_inherited_value_dimension_name.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CostCategoryInheritedValueDimension:
    ...
    if "DimensionName" in data:
        ...
        out["dimension_name"] = (
            capo_cost_explorer.types.cost_category_inherited_value_dimension_name.deserialize_aws_json_1_1(
                data["DimensionName"]
            )
        )
