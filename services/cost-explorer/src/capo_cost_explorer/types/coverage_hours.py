...
if TYPE_CHECKING:
    import capo_cost_explorer.types.coverage_hours_percentage
    import capo_cost_explorer.types.on_demand_hours
    import capo_cost_explorer.types.reserved_hours
    import capo_cost_explorer.types.total_running_hours


class CoverageHours(TypedDict, closed=True):
    on_demand_hours: NotRequired[
        "capo_cost_explorer.types.on_demand_hours.OnDemandHours"
    ]
    """<p>The number of instance running hours that On-Demand Instances covered.</p>"""
    reserved_hours: NotRequired["capo_cost_explorer.types.reserved_hours.ReservedHours"]
    """<p>The number of instance running hours that reservations covered.</p>"""
    total_running_hours: NotRequired[
        "capo_cost_explorer.types.total_running_hours.TotalRunningHours"
    ]
    """<p>The total instance usage, in hours.</p>"""
    coverage_hours_percentage: NotRequired[
        "capo_cost_explorer.types.coverage_hours_percentage.CoverageHoursPercentage"
    ]
