...
class GetAnomaliesRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_1(value: GetAnomaliesRequest) -> dict:
    ...
    out["DateInterval"] = (
        capo_cost_explorer.types.anomaly_date_interval.serialize_aws_json_1_1(
            value["date_interval"]
        )
    )
    ...
    if "total_impact" in value:
        ...
        out["TotalImpact"] = (
            capo_cost_explorer.types.total_impact_filter.serialize_aws_json_1_1(
                value["total_impact"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetAnomaliesRequest:
    ...
    if "DateInterval" in data:
        ...
        out["date_interval"] = (
            capo_cost_explorer.types.anomaly_date_interval.deserialize_aws_json_1_1(
                data["DateInterval"]
            )
        )
    else:
    ...
    if "TotalImpact" in data:
        ...
        out["total_impact"] = (
            capo_cost_explorer.types.total_impact_filter.deserialize_aws_json_1_1(
                data["TotalImpact"]
            )
        )
