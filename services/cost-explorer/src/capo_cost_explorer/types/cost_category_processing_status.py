...
class CostCategoryProcessingStatus(TypedDict, closed=True):
    component: NotRequired[
        "capo_cost_explorer.types.cost_category_status_component.CostCategoryStatusComponent"
    ]
    """<p>The Cost Management product name of the applied status. </p>"""
    status: NotRequired[
        "capo_cost_explorer.types.cost_category_status.CostCategoryStatus"
    ]
...
def serialize_aws_json_1_1(value: CostCategoryProcessingStatus) -> dict:
    ...
    if "component" in value:
        ...
        out["Component"] = (
            capo_cost_explorer.types.cost_category_status_component.serialize_aws_json_1_1(
                value["component"]
            )
        )
    if "status" in value:
        ...
        out["Status"] = (
            capo_cost_explorer.types.cost_category_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CostCategoryProcessingStatus:
    ...
    if "Component" in data:
        ...
        out["component"] = (
            capo_cost_explorer.types.cost_category_status_component.deserialize_aws_json_1_1(
                data["Component"]
            )
        )
    if "Status" in data:
        ...
        out["status"] = (
            capo_cost_explorer.types.cost_category_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    return out
