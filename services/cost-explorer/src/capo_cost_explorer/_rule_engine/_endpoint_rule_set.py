        ...
        if _locals["PartitionResult"] is not None:
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is True:
                        return Endpoint(
                            url=interpolate("https://ce.us-east-1.api.aws", p, _locals),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://ce.us-iso-east-1.c2s.ic.gov", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://ce.us-isob-east-1.sc2s.sgov.gov", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://ce.eu-isoe-west-1.cloud.adc-e.uk", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://ce.us-isof-south-1.csp.hci.ic.gov", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
