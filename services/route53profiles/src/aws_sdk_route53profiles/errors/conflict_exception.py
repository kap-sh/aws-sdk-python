"""Generated from Smithy shape ``com.amazonaws.route53profiles#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.route53profiles#ConflictException``."""
