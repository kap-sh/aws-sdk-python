...
class Route53ProfilesError(Exception):
    """Base class for all Route53Profiles service errors."""


class ServiceError(Route53ProfilesError):
...
class SerializationError(Route53ProfilesError):
    """Raised when a value cannot be serialized."""


class DeserializationError(Route53ProfilesError):
...
class WaiterFailedError(Route53ProfilesError):
...
class WaiterTimeoutError(Route53ProfilesError):
