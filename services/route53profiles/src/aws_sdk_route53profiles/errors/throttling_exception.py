"""Generated from Smithy shape ``com.amazonaws.route53profiles#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.route53profiles#ThrottlingException``."""
