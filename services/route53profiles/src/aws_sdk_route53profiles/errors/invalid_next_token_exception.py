"""Generated from Smithy shape ``com.amazonaws.route53profiles#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.route53profiles#InvalidNextTokenException``."""
