...
def handle_response(
    ...
    out: aws_sdk_mwaa_serverless.types.delete_workflow_response.DeleteWorkflowResponse = aws_sdk_mwaa_serverless.types.delete_workflow_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_mwaa_serverless.types.delete_workflow_request.DeleteWorkflowRequest,
) -> zapros.Request:
