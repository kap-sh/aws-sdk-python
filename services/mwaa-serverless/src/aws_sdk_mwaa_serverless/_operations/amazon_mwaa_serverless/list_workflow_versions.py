...
def handle_response(
    ...
    out: aws_sdk_mwaa_serverless.types.list_workflow_versions_response.ListWorkflowVersionsResponse = aws_sdk_mwaa_serverless.types.list_workflow_versions_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mwaa_serverless.types.list_workflow_versions_request.ListWorkflowVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
