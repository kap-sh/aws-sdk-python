...
def handle_response(
    ...
    out: aws_sdk_mwaa_serverless.types.get_task_instance_response.GetTaskInstanceResponse = aws_sdk_mwaa_serverless.types.get_task_instance_response.deserialize_aws_json_1_0(
