...
def handle_response(
    ...
    out: aws_sdk_mwaa_serverless.types.stop_workflow_run_response.StopWorkflowRunResponse = aws_sdk_mwaa_serverless.types.stop_workflow_run_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mwaa_serverless.types.stop_workflow_run_request.StopWorkflowRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
