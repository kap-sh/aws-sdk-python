...
def handle_response(
    ...
    out: aws_sdk_mwaa_serverless.types.list_task_instances_response.ListTaskInstancesResponse = aws_sdk_mwaa_serverless.types.list_task_instances_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mwaa_serverless.types.list_task_instances_request.ListTaskInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
