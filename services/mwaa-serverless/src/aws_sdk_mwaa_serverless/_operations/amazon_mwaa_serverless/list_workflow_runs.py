...
def handle_response(
    ...
    out: aws_sdk_mwaa_serverless.types.list_workflow_runs_response.ListWorkflowRunsResponse = aws_sdk_mwaa_serverless.types.list_workflow_runs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_mwaa_serverless.types.list_workflow_runs_request.ListWorkflowRunsRequest,
) -> zapros.Request:
    ...
    if "workflow_version" in input:
        params["workflowVersion"] = str(input["workflow_version"])
