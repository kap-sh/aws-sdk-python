"""Generated from Smithy shape ``com.amazonaws.mwaaserverless#ListTagsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_mwaa_serverless.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_mwaa_serverless.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mwaa_serverless.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMWAAServerless.ListTagsForResource"
    body: bytes | None = b""
