"""Generated from Smithy shape ``com.amazonaws.mwaaserverless#CreateWorkflow``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_mwaa_serverless.errors.conflict_exception

            raise aws_sdk_mwaa_serverless.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_mwaa_serverless.errors.service_quota_exceeded_exception

            raise aws_sdk_mwaa_serverless.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_mwaa_serverless.types.create_workflow_response.CreateWorkflowResponse = aws_sdk_mwaa_serverless.types.create_workflow_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mwaa_serverless.types.create_workflow_request.CreateWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workflows"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "AmazonMWAAServerless.CreateWorkflow"
    import aws_sdk_mwaa_serverless.types.create_workflow_request

    body: bytes | None = json.dumps(
        aws_sdk_mwaa_serverless.types.create_workflow_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
