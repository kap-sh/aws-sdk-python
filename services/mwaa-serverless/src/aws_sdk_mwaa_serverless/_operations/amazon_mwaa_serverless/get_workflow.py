...
def handle_response(
    ...
    out: aws_sdk_mwaa_serverless.types.get_workflow_response.GetWorkflowResponse = (
        aws_sdk_mwaa_serverless.types.get_workflow_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_mwaa_serverless.types.get_workflow_request.GetWorkflowRequest,
) -> zapros.Request:
