"""Generated from Smithy shape ``com.amazonaws.mwaaserverless#ListWorkflows``."""
...
def handle_response(
    ...
    out: aws_sdk_mwaa_serverless.types.list_workflows_response.ListWorkflowsResponse = (
        aws_sdk_mwaa_serverless.types.list_workflows_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mwaa_serverless.types.list_workflows_request.ListWorkflowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMWAAServerless.ListWorkflows"
    body: bytes | None = b""
