...
if TYPE_CHECKING:
    ...
    import aws_sdk_mwaa_serverless.types.task_instance_ids
...
class WorkflowRunDetail(TypedDict):
    ...
    task_instances: NotRequired[
        "aws_sdk_mwaa_serverless.types.task_instance_ids.TaskInstanceIds"
    ]
...
def serialize_aws_json_1_0(value: WorkflowRunDetail) -> dict:
    ...
    if "task_instances" in value:
        ...
        out["TaskInstances"] = (
            aws_sdk_mwaa_serverless.types.task_instance_ids.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> WorkflowRunDetail:
    ...
    if "TaskInstances" in data:
        ...
        out["task_instances"] = (
            aws_sdk_mwaa_serverless.types.task_instance_ids.deserialize_aws_json_1_0(
                data["TaskInstances"]
            )
        )
    if "RunState" in data:
