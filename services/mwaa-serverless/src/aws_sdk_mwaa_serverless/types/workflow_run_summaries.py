...
WorkflowRunSummaries: TypeAlias = list[
    "aws_sdk_mwaa_serverless.types.workflow_run_summary.WorkflowRunSummary"
]
...
def serialize_aws_json_1_0(value: WorkflowRunSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_mwaa_serverless.types.workflow_run_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> WorkflowRunSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_mwaa_serverless.types.workflow_run_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
