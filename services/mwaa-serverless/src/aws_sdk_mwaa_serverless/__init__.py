...
from ._services.async_mwaa_serverless import (
    AsyncMWAAServerlessClient as AsyncMWAAServerlessClient,
)
from ._services.mwaa_serverless import MWAAServerlessClient as MWAAServerlessClient
