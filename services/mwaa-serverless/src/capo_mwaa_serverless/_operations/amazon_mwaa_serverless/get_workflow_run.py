...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.get_workflow_run_response.GetWorkflowRunResponse = (
        capo_mwaa_serverless.types.get_workflow_run_response.deserialize_aws_json_1_0(
