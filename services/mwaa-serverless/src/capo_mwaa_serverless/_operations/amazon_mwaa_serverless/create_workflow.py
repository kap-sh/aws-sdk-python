...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.create_workflow_response.CreateWorkflowResponse = (
        capo_mwaa_serverless.types.create_workflow_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mwaa_serverless.types.create_workflow_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
