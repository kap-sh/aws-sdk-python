...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_mwaa_serverless.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
