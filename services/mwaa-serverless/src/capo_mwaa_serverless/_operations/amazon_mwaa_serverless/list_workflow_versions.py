"""Generated from Smithy shape ``com.amazonaws.mwaaserverless#ListWorkflowVersions``."""
...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.list_workflow_versions_response.ListWorkflowVersionsResponse = capo_mwaa_serverless.types.list_workflow_versions_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/workflows/{WorkflowArn}/versions"
    ...
    headers["X-Amz-Target"] = "AmazonMWAAServerless.ListWorkflowVersions"
    body: bytes | None = b""
