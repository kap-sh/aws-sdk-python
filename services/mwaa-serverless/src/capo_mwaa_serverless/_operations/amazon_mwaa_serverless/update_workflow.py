"""Generated from Smithy shape ``com.amazonaws.mwaaserverless#UpdateWorkflow``."""
...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.update_workflow_response.UpdateWorkflowResponse = (
        capo_mwaa_serverless.types.update_workflow_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMWAAServerless.UpdateWorkflow"
    body: bytes | None = json.dumps(
        capo_mwaa_serverless.types.update_workflow_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
