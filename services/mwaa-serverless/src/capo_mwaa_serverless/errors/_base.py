...
class MWAAServerlessError(Exception):
    """Base class for all MWAAServerless service errors."""


class ServiceError(MWAAServerlessError):
...
class SerializationError(MWAAServerlessError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MWAAServerlessError):
...
class WaiterFailedError(MWAAServerlessError):
...
class WaiterTimeoutError(MWAAServerlessError):
