...
```
pip install aws-sdk-mwaa-serverless
```

## Usage

```python
from aws_sdk_mwaa_serverless import AsyncMWAAServerlessClient


async def main():
    async with AsyncMWAAServerlessClient() as s3:
...
```python
from aws_sdk_mwaa_serverless import AsyncMWAAServerlessClient
from aws_sdk_mwaa_serverless.error import AccessDeniedException
