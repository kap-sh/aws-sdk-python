...
class forecastqueryError(Exception):
    """Base class for all forecastquery service errors."""


class ServiceError(forecastqueryError):
...
class SerializationError(forecastqueryError):
    """Raised when a value cannot be serialized."""


class DeserializationError(forecastqueryError):
...
class WaiterFailedError(forecastqueryError):
...
class WaiterTimeoutError(forecastqueryError):
