"""Generated from Smithy shape ``com.amazonaws.forecastquery#ResourceInUseException``."""
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.forecastquery#ResourceInUseException``."""
