"""Generated from Smithy shape ``com.amazonaws.forecastquery#LimitExceededException``."""

from typing import TYPE_CHECKING

from typing_extensions import NotRequired, TypedDict

from capo_forecastquery.errors import ServiceError

if TYPE_CHECKING:
    import capo_forecastquery.types.error_message


class LimitExceededException_(TypedDict, closed=True):
    message: NotRequired["capo_forecastquery.types.error_message.ErrorMessage"]
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.forecastquery#LimitExceededException``."""
