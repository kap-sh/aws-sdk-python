...
from ._services.async_forecastquery import (
    AsyncforecastqueryClient as AsyncforecastqueryClient,
)
from ._services.forecastquery import forecastqueryClient as forecastqueryClient
