...
from aws_sdk_forecastquery.errors import DeserializationError
...
class QueryWhatIfForecastRequest(TypedDict):
    ...
    start_date: NotRequired["aws_sdk_forecastquery.types.date_time.DateTime"]
...
def serialize_aws_json_1_1(value: QueryWhatIfForecastRequest) -> dict:
    ...
    out["Filters"] = aws_sdk_forecastquery.types.filters.serialize_aws_json_1_1(
        value["filters"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> QueryWhatIfForecastRequest:
    ...
    if "Filters" in data:
        ...
        out["filters"] = aws_sdk_forecastquery.types.filters.deserialize_aws_json_1_1(
            data["Filters"]
        )
    else:
