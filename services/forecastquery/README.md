...
```
pip install aws-sdk-forecastquery
```

## Usage

```python
from aws_sdk_forecastquery import AsyncforecastqueryClient
...
```python
from aws_sdk_forecastquery import AsyncforecastqueryClient
from aws_sdk_forecastquery.error import InvalidInputException
