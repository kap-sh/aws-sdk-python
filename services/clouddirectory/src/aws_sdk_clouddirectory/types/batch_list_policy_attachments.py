"""Generated from Smithy shape ``com.amazonaws.clouddirectory#BatchListPolicyAttachments``."""
...
class BatchListPolicyAttachments(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: BatchListPolicyAttachments) -> dict:
    out: dict = {}
    import aws_sdk_clouddirectory.types.object_reference
