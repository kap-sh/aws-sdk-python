...
class ListTagsForResourceResponse(TypedDict, closed=True):
    tags: NotRequired["aws_sdk_clouddirectory.types.tag_list.TagList"]
...
def serialize_json(value: ListTagsForResourceResponse) -> dict:
    ...
    if "tags" in value:
        ...
        out["Tags"] = aws_sdk_clouddirectory.types.tag_list.serialize_json(
            value["tags"]
        )
...
def deserialize_json(data: dict) -> ListTagsForResourceResponse:
    ...
    if "Tags" in data:
        ...
        out["tags"] = aws_sdk_clouddirectory.types.tag_list.deserialize_json(
            data["Tags"]
        )
