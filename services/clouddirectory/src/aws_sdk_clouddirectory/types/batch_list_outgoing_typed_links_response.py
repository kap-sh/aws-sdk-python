"""Generated from Smithy shape ``com.amazonaws.clouddirectory#BatchListOutgoingTypedLinksResponse``."""
...
class BatchListOutgoingTypedLinksResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: BatchListOutgoingTypedLinksResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> BatchListOutgoingTypedLinksResponse:
    out: BatchListOutgoingTypedLinksResponse = {}  # type: ignore[typeddict-item]
