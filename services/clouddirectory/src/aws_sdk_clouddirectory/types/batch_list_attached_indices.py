"""Generated from Smithy shape ``com.amazonaws.clouddirectory#BatchListAttachedIndices``."""
...
class BatchListAttachedIndices(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: BatchListAttachedIndices) -> dict:
    out: dict = {}
    import aws_sdk_clouddirectory.types.object_reference
...
def deserialize_json(data: dict) -> BatchListAttachedIndices:
    out: BatchListAttachedIndices = {}  # type: ignore[typeddict-item]
    if "TargetReference" in data:
        ...
        raise DeserializationError("BatchListAttachedIndices.target_reference required")
