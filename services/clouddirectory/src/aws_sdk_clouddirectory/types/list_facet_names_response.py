...
class ListFacetNamesResponse(TypedDict):
    facet_names: NotRequired[
        "aws_sdk_clouddirectory.types.facet_name_list.FacetNameList"
    ]
...
def serialize_json(value: ListFacetNamesResponse) -> dict:
    ...
    if "facet_names" in value:
        ...
        out["FacetNames"] = aws_sdk_clouddirectory.types.facet_name_list.serialize_json(
            value["facet_names"]
        )
...
def deserialize_json(data: dict) -> ListFacetNamesResponse:
    ...
    if "FacetNames" in data:
        ...
        out["facet_names"] = (
            aws_sdk_clouddirectory.types.facet_name_list.deserialize_json(
                data["FacetNames"]
            )
        )
