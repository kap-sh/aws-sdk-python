"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListIncomingTypedLinksRequest``."""
...
class ListIncomingTypedLinksRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListIncomingTypedLinksRequest) -> dict:
    out: dict = {}
    import aws_sdk_clouddirectory.types.object_reference
...
def deserialize_json(data: dict) -> ListIncomingTypedLinksRequest:
    out: ListIncomingTypedLinksRequest = {}  # type: ignore[typeddict-item]
    if "ObjectReference" in data:
        ...
        raise DeserializationError(
            "ListIncomingTypedLinksRequest.object_reference required"
        )
