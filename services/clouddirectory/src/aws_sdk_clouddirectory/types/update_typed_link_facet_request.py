...
class UpdateTypedLinkFacetRequest(TypedDict):
...
def serialize_json(value: UpdateTypedLinkFacetRequest) -> dict:
    ...
    out["AttributeUpdates"] = (
        aws_sdk_clouddirectory.types.typed_link_facet_attribute_update_list.serialize_json(
...
def deserialize_json(data: dict) -> UpdateTypedLinkFacetRequest:
    ...
    if "AttributeUpdates" in data:
        ...
        out["attribute_updates"] = (
            aws_sdk_clouddirectory.types.typed_link_facet_attribute_update_list.deserialize_json(
