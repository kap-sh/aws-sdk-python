"""Generated from Smithy shape ``com.amazonaws.clouddirectory#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.clouddirectory#LimitExceededException``."""
