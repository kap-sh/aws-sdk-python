...
class FacetAlreadyExistsException_(TypedDict):
    message: NotRequired[
...
class FacetAlreadyExistsException(ServiceError):
    ...
    def __init__(self, data: FacetAlreadyExistsException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_json(cls, data: dict) -> "FacetAlreadyExistsException":
