...
class CloudDirectoryError(Exception):
    """Base class for all CloudDirectory service errors."""


class ServiceError(CloudDirectoryError):
...
class SerializationError(CloudDirectoryError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudDirectoryError):
...
class WaiterFailedError(CloudDirectoryError):
...
class WaiterTimeoutError(CloudDirectoryError):
