"""Generated from Smithy shape ``com.amazonaws.clouddirectory#BatchWrite``."""
...
import aws_sdk_clouddirectory.errors.batch_write_exception
...
import aws_sdk_clouddirectory.types.batch_write_operation_response_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BatchWriteException":
            raise aws_sdk_clouddirectory.errors.batch_write_exception.BatchWriteException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.batch_write_response.BatchWriteResponse = (
        aws_sdk_clouddirectory.types.batch_write_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.batch_write_request.BatchWriteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/batchwrite"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.batch_write_request.serialize_json(input_)
    ).encode()
