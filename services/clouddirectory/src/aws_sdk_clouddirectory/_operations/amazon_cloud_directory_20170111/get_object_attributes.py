"""Generated from Smithy shape ``com.amazonaws.clouddirectory#GetObjectAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.get_object_attributes_response.GetObjectAttributesResponse = aws_sdk_clouddirectory.types.get_object_attributes_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.get_object_attributes_request.GetObjectAttributesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.get_object_attributes_request.serialize_json(input)
    ).encode()
