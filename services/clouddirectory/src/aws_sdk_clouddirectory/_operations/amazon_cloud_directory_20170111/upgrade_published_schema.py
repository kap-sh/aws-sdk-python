...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.upgrade_published_schema_response.UpgradePublishedSchemaResponse = aws_sdk_clouddirectory.types.upgrade_published_schema_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.upgrade_published_schema_request.UpgradePublishedSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.upgrade_published_schema_request.serialize_json(
            input_
        )
    ).encode()
