"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ApplySchema``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.apply_schema_response.ApplySchemaResponse = (
        aws_sdk_clouddirectory.types.apply_schema_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.apply_schema_request.ApplySchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/schema/apply"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.apply_schema_request.serialize_json(input_)
    ).encode()
