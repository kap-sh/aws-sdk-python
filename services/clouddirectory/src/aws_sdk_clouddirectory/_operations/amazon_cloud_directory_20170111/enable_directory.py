...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.enable_directory_response.EnableDirectoryResponse = aws_sdk_clouddirectory.types.enable_directory_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.enable_directory_request.EnableDirectoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
