...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.attach_to_index_request.AttachToIndexRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.attach_to_index_request.serialize_json(input)
    ).encode()
