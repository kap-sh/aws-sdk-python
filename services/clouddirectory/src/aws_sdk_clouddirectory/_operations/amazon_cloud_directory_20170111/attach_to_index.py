...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.attach_to_index_request.AttachToIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.attach_to_index_request.serialize_json(input_)
    ).encode()
