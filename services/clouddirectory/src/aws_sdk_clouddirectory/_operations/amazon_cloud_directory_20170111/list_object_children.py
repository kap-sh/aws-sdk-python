"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListObjectChildren``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotNodeException":
            import aws_sdk_clouddirectory.errors.not_node_exception

            raise aws_sdk_clouddirectory.errors.not_node_exception.NotNodeException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_object_children_response.ListObjectChildrenResponse = aws_sdk_clouddirectory.types.list_object_children_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_object_children_request.ListObjectChildrenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/object/children"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_object_children_request.serialize_json(input_)
    ).encode()
...
async def async_list_object_children(
