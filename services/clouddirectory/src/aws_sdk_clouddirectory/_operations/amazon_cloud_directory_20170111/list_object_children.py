...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.list_object_children_request.ListObjectChildrenRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_object_children_request.serialize_json(input)
    ).encode()
