"""Generated from Smithy shape ``com.amazonaws.clouddirectory#CreateObject``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedIndexTypeException":
            import aws_sdk_clouddirectory.errors.unsupported_index_type_exception

            raise aws_sdk_clouddirectory.errors.unsupported_index_type_exception.UnsupportedIndexTypeException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.create_object_response.CreateObjectResponse = (
        aws_sdk_clouddirectory.types.create_object_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.create_object_request.CreateObjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/object"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.create_object_request.serialize_json(input_)
    ).encode()
