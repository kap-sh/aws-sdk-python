...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_index_response.ListIndexResponse = (
        aws_sdk_clouddirectory.types.list_index_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_index_request.ListIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_index_request.serialize_json(input_)
    ).encode()
...
def list_index(
    ...
    aws_sdk_clouddirectory.types.list_index_response.ListIndexResponse, zapros.Response
]:
