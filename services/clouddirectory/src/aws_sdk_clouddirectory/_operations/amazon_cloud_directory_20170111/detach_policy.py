...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.detach_policy_response.DetachPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.detach_policy_request.DetachPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.detach_policy_request.serialize_json(input_)
    ).encode()
