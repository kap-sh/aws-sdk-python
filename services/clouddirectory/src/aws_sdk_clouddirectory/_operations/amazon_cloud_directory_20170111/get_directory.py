...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.get_directory_response.GetDirectoryResponse = (
        aws_sdk_clouddirectory.types.get_directory_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.get_directory_request.GetDirectoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
