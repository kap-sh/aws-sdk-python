"""Generated from Smithy shape ``com.amazonaws.clouddirectory#UpgradeAppliedSchema``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IncompatibleSchemaException":
            import aws_sdk_clouddirectory.errors.incompatible_schema_exception

            raise aws_sdk_clouddirectory.errors.incompatible_schema_exception.IncompatibleSchemaException.from_json(
                data
            )
        ...
        case "SchemaAlreadyExistsException":
            import aws_sdk_clouddirectory.errors.schema_already_exists_exception

            raise aws_sdk_clouddirectory.errors.schema_already_exists_exception.SchemaAlreadyExistsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.upgrade_applied_schema_response.UpgradeAppliedSchemaResponse = aws_sdk_clouddirectory.types.upgrade_applied_schema_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.upgrade_applied_schema_request.UpgradeAppliedSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_upgrade_applied_schema(
