...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_published_schema_arns_response.ListPublishedSchemaArnsResponse = aws_sdk_clouddirectory.types.list_published_schema_arns_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_published_schema_arns_request.ListPublishedSchemaArnsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_published_schema_arns_request.serialize_json(
            input_
        )
    ).encode()
