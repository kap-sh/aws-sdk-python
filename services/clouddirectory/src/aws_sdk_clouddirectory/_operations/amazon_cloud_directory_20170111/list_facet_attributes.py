"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListFacetAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_facet_attributes_response.ListFacetAttributesResponse = aws_sdk_clouddirectory.types.list_facet_attributes_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.list_facet_attributes_request.ListFacetAttributesRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/facet/attributes"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_facet_attributes_request.serialize_json(input)
    ).encode()
...
async def async_list_facet_attributes(
