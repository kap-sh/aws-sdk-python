...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_facet_attributes_request.ListFacetAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_facet_attributes_request.serialize_json(
            input_
        )
    ).encode()
