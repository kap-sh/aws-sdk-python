...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.batch_read_response.BatchReadResponse = (
        aws_sdk_clouddirectory.types.batch_read_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.batch_read_request.BatchReadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.batch_read_request.serialize_json(input_)
    ).encode()
...
def batch_read(
    ...
    aws_sdk_clouddirectory.types.batch_read_response.BatchReadResponse, zapros.Response
]:
