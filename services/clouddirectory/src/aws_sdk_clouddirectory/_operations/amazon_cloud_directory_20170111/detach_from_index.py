...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.detach_from_index_request.DetachFromIndexRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.detach_from_index_request.serialize_json(input)
    ).encode()
