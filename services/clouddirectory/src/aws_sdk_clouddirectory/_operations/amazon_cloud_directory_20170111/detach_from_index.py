...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ObjectAlreadyDetachedException":
            import aws_sdk_clouddirectory.errors.object_already_detached_exception

            raise aws_sdk_clouddirectory.errors.object_already_detached_exception.ObjectAlreadyDetachedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.detach_from_index_response.DetachFromIndexResponse = aws_sdk_clouddirectory.types.detach_from_index_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.detach_from_index_request.DetachFromIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.detach_from_index_request.serialize_json(input_)
    ).encode()
