...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.list_directories_request.ListDirectoriesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_directories_request.serialize_json(input)
    ).encode()
