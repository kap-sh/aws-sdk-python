...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_directories_response.ListDirectoriesResponse = aws_sdk_clouddirectory.types.list_directories_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_directories_request.ListDirectoriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_directories_request.serialize_json(input_)
    ).encode()
