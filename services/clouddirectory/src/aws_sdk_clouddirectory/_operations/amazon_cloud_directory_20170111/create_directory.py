...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.create_directory_request.CreateDirectoryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.create_directory_request.serialize_json(input)
    ).encode()
