"""Generated from Smithy shape ``com.amazonaws.clouddirectory#CreateDirectory``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryAlreadyExistsException":
            import aws_sdk_clouddirectory.errors.directory_already_exists_exception

            raise aws_sdk_clouddirectory.errors.directory_already_exists_exception.DirectoryAlreadyExistsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.create_directory_response.CreateDirectoryResponse = aws_sdk_clouddirectory.types.create_directory_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.create_directory_request.CreateDirectoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/directory/create"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.create_directory_request.serialize_json(input_)
    ).encode()
