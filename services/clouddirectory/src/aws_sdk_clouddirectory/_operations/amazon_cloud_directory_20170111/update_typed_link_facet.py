...
import aws_sdk_clouddirectory.errors.invalid_facet_update_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidFacetUpdateException":
            raise aws_sdk_clouddirectory.errors.invalid_facet_update_exception.InvalidFacetUpdateException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.update_typed_link_facet_response.UpdateTypedLinkFacetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.update_typed_link_facet_request.UpdateTypedLinkFacetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.update_typed_link_facet_request.serialize_json(
            input_
        )
    ).encode()
