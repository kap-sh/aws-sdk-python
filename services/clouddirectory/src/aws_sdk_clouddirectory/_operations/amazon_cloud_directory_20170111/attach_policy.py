"""Generated from Smithy shape ``com.amazonaws.clouddirectory#AttachPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.attach_policy_response.AttachPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.attach_policy_request.AttachPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/policy/attach"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.attach_policy_request.serialize_json(input_)
    ).encode()
