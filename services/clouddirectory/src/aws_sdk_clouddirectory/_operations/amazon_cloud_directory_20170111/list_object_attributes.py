...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_object_attributes_response.ListObjectAttributesResponse = aws_sdk_clouddirectory.types.list_object_attributes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_object_attributes_request.ListObjectAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_object_attributes_request.serialize_json(
            input_
        )
    ).encode()
