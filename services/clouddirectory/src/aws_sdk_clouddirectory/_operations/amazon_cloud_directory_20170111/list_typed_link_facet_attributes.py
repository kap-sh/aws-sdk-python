...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_typed_link_facet_attributes_response.ListTypedLinkFacetAttributesResponse = aws_sdk_clouddirectory.types.list_typed_link_facet_attributes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_typed_link_facet_attributes_request.ListTypedLinkFacetAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_typed_link_facet_attributes_request.serialize_json(
            input_
        )
    ).encode()
