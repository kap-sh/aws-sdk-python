"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListAttachedIndices``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_attached_indices_response.ListAttachedIndicesResponse = aws_sdk_clouddirectory.types.list_attached_indices_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.list_attached_indices_request.ListAttachedIndicesRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/object/indices"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_attached_indices_request.serialize_json(input)
    ).encode()
...
async def async_list_attached_indices(
