...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.create_schema_response.CreateSchemaResponse = (
        aws_sdk_clouddirectory.types.create_schema_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.create_schema_request.CreateSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.create_schema_request.serialize_json(input_)
    ).encode()
