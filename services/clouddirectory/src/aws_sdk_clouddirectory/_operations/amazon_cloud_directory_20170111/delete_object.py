...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ObjectNotDetachedException":
            import aws_sdk_clouddirectory.errors.object_not_detached_exception

            raise aws_sdk_clouddirectory.errors.object_not_detached_exception.ObjectNotDetachedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.delete_object_response.DeleteObjectResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.delete_object_request.DeleteObjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.delete_object_request.serialize_json(input_)
    ).encode()
