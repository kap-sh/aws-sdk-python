...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.get_applied_schema_version_response.GetAppliedSchemaVersionResponse = aws_sdk_clouddirectory.types.get_applied_schema_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.get_applied_schema_version_request.GetAppliedSchemaVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.get_applied_schema_version_request.serialize_json(
            input_
        )
    ).encode()
