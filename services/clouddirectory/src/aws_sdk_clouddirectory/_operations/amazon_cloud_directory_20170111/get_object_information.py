"""Generated from Smithy shape ``com.amazonaws.clouddirectory#GetObjectInformation``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.get_object_information_response.GetObjectInformationResponse = aws_sdk_clouddirectory.types.get_object_information_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.get_object_information_request.GetObjectInformationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/object/information"
    )
    params: dict[str, str] = {}
...
async def async_get_object_information(
