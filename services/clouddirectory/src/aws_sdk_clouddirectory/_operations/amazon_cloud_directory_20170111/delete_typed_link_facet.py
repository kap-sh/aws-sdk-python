...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.delete_typed_link_facet_response.DeleteTypedLinkFacetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.delete_typed_link_facet_request.DeleteTypedLinkFacetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.delete_typed_link_facet_request.serialize_json(
            input_
        )
    ).encode()
