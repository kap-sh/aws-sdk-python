...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.list_object_policies_request.ListObjectPoliciesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_object_policies_request.serialize_json(input)
    ).encode()
