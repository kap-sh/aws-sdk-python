...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_object_policies_response.ListObjectPoliciesResponse = aws_sdk_clouddirectory.types.list_object_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_object_policies_request.ListObjectPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_object_policies_request.serialize_json(input_)
    ).encode()
