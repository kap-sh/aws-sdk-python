...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_object_parents_request.ListObjectParentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_object_parents_request.serialize_json(input_)
    ).encode()
