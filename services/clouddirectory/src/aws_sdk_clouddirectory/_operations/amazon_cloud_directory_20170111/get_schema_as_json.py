...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.get_schema_as_json_response.GetSchemaAsJsonResponse = aws_sdk_clouddirectory.types.get_schema_as_json_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.get_schema_as_json_request.GetSchemaAsJsonRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
