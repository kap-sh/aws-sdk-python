...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.put_schema_from_json_request.PutSchemaFromJsonRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.put_schema_from_json_request.serialize_json(input)
    ).encode()
