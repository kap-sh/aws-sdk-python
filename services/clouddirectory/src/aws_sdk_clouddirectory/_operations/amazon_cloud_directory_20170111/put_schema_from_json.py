"""Generated from Smithy shape ``com.amazonaws.clouddirectory#PutSchemaFromJson``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRuleException":
            import aws_sdk_clouddirectory.errors.invalid_rule_exception

            raise aws_sdk_clouddirectory.errors.invalid_rule_exception.InvalidRuleException.from_json(
                data
            )
        case "InvalidSchemaDocException":
            import aws_sdk_clouddirectory.errors.invalid_schema_doc_exception

            raise aws_sdk_clouddirectory.errors.invalid_schema_doc_exception.InvalidSchemaDocException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.put_schema_from_json_response.PutSchemaFromJsonResponse = aws_sdk_clouddirectory.types.put_schema_from_json_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.put_schema_from_json_request.PutSchemaFromJsonRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/schema/json"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.put_schema_from_json_request.serialize_json(input_)
    ).encode()
...
async def async_put_schema_from_json(
