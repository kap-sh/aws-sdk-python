"""Generated from Smithy shape ``com.amazonaws.clouddirectory#RemoveFacetFromObject``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.remove_facet_from_object_response.RemoveFacetFromObjectResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.remove_facet_from_object_request.RemoveFacetFromObjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.remove_facet_from_object_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_remove_facet_from_object(
