...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.add_facet_to_object_request.AddFacetToObjectRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.add_facet_to_object_request.serialize_json(input)
    ).encode()
