"""Generated from Smithy shape ``com.amazonaws.clouddirectory#AddFacetToObject``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.add_facet_to_object_response.AddFacetToObjectResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.add_facet_to_object_request.AddFacetToObjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/object/facets"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.add_facet_to_object_request.serialize_json(input_)
    ).encode()
...
async def async_add_facet_to_object(
