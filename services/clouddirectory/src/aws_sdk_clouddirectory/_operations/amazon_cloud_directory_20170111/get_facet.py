...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.get_facet_response.GetFacetResponse = (
        aws_sdk_clouddirectory.types.get_facet_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.get_facet_request.GetFacetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.get_facet_request.serialize_json(input_)
    ).encode()
...
def get_facet(
    ...
    aws_sdk_clouddirectory.types.get_facet_response.GetFacetResponse, zapros.Response
]:
