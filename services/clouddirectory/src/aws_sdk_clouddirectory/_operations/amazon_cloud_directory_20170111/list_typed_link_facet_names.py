...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_typed_link_facet_names_response.ListTypedLinkFacetNamesResponse = aws_sdk_clouddirectory.types.list_typed_link_facet_names_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_typed_link_facet_names_request.ListTypedLinkFacetNamesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_typed_link_facet_names_request.serialize_json(
            input_
        )
    ).encode()
