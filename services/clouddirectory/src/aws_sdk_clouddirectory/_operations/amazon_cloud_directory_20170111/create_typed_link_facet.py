...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.create_typed_link_facet_response.CreateTypedLinkFacetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.create_typed_link_facet_request.CreateTypedLinkFacetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.create_typed_link_facet_request.serialize_json(
            input_
        )
    ).encode()
