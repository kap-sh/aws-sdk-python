...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.update_facet_response.UpdateFacetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.update_facet_request.UpdateFacetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.update_facet_request.serialize_json(input_)
    ).encode()
