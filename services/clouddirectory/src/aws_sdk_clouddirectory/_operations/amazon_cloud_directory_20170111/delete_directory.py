"""Generated from Smithy shape ``com.amazonaws.clouddirectory#DeleteDirectory``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryDeletedException":
            import aws_sdk_clouddirectory.errors.directory_deleted_exception

            raise aws_sdk_clouddirectory.errors.directory_deleted_exception.DirectoryDeletedException.from_json(
                data
            )
        case "DirectoryNotDisabledException":
            import aws_sdk_clouddirectory.errors.directory_not_disabled_exception

            raise aws_sdk_clouddirectory.errors.directory_not_disabled_exception.DirectoryNotDisabledException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.delete_directory_response.DeleteDirectoryResponse = aws_sdk_clouddirectory.types.delete_directory_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.delete_directory_request.DeleteDirectoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/directory"
    params: dict[str, str] = {}
...
async def async_delete_directory(
