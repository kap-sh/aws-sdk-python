...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_outgoing_typed_links_response.ListOutgoingTypedLinksResponse = aws_sdk_clouddirectory.types.list_outgoing_typed_links_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_outgoing_typed_links_request.ListOutgoingTypedLinksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_outgoing_typed_links_request.serialize_json(
            input_
        )
    ).encode()
