...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.get_link_attributes_request.GetLinkAttributesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.get_link_attributes_request.serialize_json(input)
    ).encode()
