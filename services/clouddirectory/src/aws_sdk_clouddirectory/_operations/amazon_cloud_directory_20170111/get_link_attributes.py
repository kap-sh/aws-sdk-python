...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.get_link_attributes_response.GetLinkAttributesResponse = aws_sdk_clouddirectory.types.get_link_attributes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.get_link_attributes_request.GetLinkAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.get_link_attributes_request.serialize_json(input_)
    ).encode()
