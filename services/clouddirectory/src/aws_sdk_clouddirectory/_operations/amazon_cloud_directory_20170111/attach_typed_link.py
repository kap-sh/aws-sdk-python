...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.attach_typed_link_response.AttachTypedLinkResponse = aws_sdk_clouddirectory.types.attach_typed_link_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.attach_typed_link_request.AttachTypedLinkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.attach_typed_link_request.serialize_json(input_)
    ).encode()
