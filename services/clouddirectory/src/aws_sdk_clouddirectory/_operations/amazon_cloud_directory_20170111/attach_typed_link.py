...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.attach_typed_link_request.AttachTypedLinkRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.attach_typed_link_request.serialize_json(input)
    ).encode()
