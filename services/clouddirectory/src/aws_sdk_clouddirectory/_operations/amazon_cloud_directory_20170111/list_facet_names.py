...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.list_facet_names_request.ListFacetNamesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_facet_names_request.serialize_json(input)
    ).encode()
