"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListFacetNames``."""
...
import aws_sdk_clouddirectory.types.facet_name_list
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_facet_names_response.ListFacetNamesResponse = aws_sdk_clouddirectory.types.list_facet_names_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_facet_names_request.ListFacetNamesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/facet/list"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_facet_names_request.serialize_json(input_)
    ).encode()
...
async def async_list_facet_names(
