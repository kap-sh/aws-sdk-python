"""Generated from Smithy shape ``com.amazonaws.clouddirectory#DisableDirectory``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.disable_directory_response.DisableDirectoryResponse = aws_sdk_clouddirectory.types.disable_directory_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.disable_directory_request.DisableDirectoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/directory/disable"
    )
    params: dict[str, str] = {}
...
async def async_disable_directory(
