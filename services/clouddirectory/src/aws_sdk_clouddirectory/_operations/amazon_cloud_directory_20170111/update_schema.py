"""Generated from Smithy shape ``com.amazonaws.clouddirectory#UpdateSchema``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.update_schema_response.UpdateSchemaResponse = (
        aws_sdk_clouddirectory.types.update_schema_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.update_schema_request.UpdateSchemaRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/schema/update"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.update_schema_request.serialize_json(input)
    ).encode()
