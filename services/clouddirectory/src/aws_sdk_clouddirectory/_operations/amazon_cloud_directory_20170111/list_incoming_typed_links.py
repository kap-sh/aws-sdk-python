"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListIncomingTypedLinks``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_incoming_typed_links_response.ListIncomingTypedLinksResponse = aws_sdk_clouddirectory.types.list_incoming_typed_links_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_incoming_typed_links_request.ListIncomingTypedLinksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/typedlink/incoming"
    )
    params: dict[str, str] = {}
...
async def async_list_incoming_typed_links(
