...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.attach_object_response.AttachObjectResponse = (
        aws_sdk_clouddirectory.types.attach_object_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.attach_object_request.AttachObjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.attach_object_request.serialize_json(input_)
    ).encode()
