...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SchemaAlreadyPublishedException":
            import aws_sdk_clouddirectory.errors.schema_already_published_exception

            raise aws_sdk_clouddirectory.errors.schema_already_published_exception.SchemaAlreadyPublishedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.publish_schema_response.PublishSchemaResponse = (
        aws_sdk_clouddirectory.types.publish_schema_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_clouddirectory.types.publish_schema_request.PublishSchemaRequest,
) -> zapros.Request:
    ...
    if "development_schema_arn" in input:
        headers["x-amz-data-partition"] = str(input["development_schema_arn"])
    import aws_sdk_clouddirectory.types.publish_schema_request

    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.publish_schema_request.serialize_json(input)
    ).encode()
