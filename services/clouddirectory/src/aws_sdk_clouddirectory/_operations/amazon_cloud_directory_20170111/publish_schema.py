...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.publish_schema_request.PublishSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.publish_schema_request.serialize_json(input_)
    ).encode()
