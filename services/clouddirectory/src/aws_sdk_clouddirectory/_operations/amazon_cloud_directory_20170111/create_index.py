...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.create_index_response.CreateIndexResponse = (
        aws_sdk_clouddirectory.types.create_index_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.create_index_request.CreateIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.create_index_request.serialize_json(input_)
    ).encode()
