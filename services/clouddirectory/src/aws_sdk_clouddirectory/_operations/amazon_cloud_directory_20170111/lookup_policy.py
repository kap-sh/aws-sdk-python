...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.lookup_policy_response.LookupPolicyResponse = (
        aws_sdk_clouddirectory.types.lookup_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.lookup_policy_request.LookupPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.lookup_policy_request.serialize_json(input_)
    ).encode()
