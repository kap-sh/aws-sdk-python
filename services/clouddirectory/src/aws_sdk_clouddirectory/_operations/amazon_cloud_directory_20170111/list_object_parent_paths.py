...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_object_parent_paths_response.ListObjectParentPathsResponse = aws_sdk_clouddirectory.types.list_object_parent_paths_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_object_parent_paths_request.ListObjectParentPathsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_object_parent_paths_request.serialize_json(
            input_
        )
    ).encode()
