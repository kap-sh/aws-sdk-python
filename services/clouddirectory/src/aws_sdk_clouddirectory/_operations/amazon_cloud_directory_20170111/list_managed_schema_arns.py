...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_managed_schema_arns_response.ListManagedSchemaArnsResponse = aws_sdk_clouddirectory.types.list_managed_schema_arns_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_managed_schema_arns_request.ListManagedSchemaArnsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_managed_schema_arns_request.serialize_json(
            input_
        )
    ).encode()
