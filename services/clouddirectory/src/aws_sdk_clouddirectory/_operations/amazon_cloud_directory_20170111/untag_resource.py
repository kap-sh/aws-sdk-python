"""Generated from Smithy shape ``com.amazonaws.clouddirectory#UntagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTaggingRequestException":
            import aws_sdk_clouddirectory.errors.invalid_tagging_request_exception

            raise aws_sdk_clouddirectory.errors.invalid_tagging_request_exception.InvalidTaggingRequestException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/tags/remove"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_clouddirectory.types.untag_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.untag_resource_request.serialize_json(input_)
    ).encode()
