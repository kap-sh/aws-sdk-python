"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListDevelopmentSchemaArns``."""
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.list_development_schema_arns_response.ListDevelopmentSchemaArnsResponse = aws_sdk_clouddirectory.types.list_development_schema_arns_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.list_development_schema_arns_request.ListDevelopmentSchemaArnsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/schema/development"
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_clouddirectory.types.list_development_schema_arns_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_development_schema_arns(
