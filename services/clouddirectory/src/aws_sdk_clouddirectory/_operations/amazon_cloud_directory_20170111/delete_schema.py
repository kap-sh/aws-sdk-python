"""Generated from Smithy shape ``com.amazonaws.clouddirectory#DeleteSchema``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StillContainsLinksException":
            import aws_sdk_clouddirectory.errors.still_contains_links_exception

            raise aws_sdk_clouddirectory.errors.still_contains_links_exception.StillContainsLinksException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_clouddirectory.types.delete_schema_response.DeleteSchemaResponse = (
        aws_sdk_clouddirectory.types.delete_schema_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_clouddirectory.types.delete_schema_request.DeleteSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/schema"
    params: dict[str, str] = {}
