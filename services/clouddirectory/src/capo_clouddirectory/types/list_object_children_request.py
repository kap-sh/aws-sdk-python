"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListObjectChildrenRequest``."""
...
class ListObjectChildrenRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListObjectChildrenRequest) -> dict:
    out: dict = {}
    import capo_clouddirectory.types.object_reference
...
def deserialize_json(data: dict) -> ListObjectChildrenRequest:
    out: ListObjectChildrenRequest = {}  # type: ignore[typeddict-item]
    if "ObjectReference" in data:
        ...
        raise DeserializationError(
            "ListObjectChildrenRequest.object_reference required"
        )
