"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListObjectPoliciesRequest``."""
...
class ListObjectPoliciesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListObjectPoliciesRequest) -> dict:
    out: dict = {}
    import capo_clouddirectory.types.object_reference
...
def deserialize_json(data: dict) -> ListObjectPoliciesRequest:
    out: ListObjectPoliciesRequest = {}  # type: ignore[typeddict-item]
    if "ObjectReference" in data:
        ...
        raise DeserializationError(
            "ListObjectPoliciesRequest.object_reference required"
        )
