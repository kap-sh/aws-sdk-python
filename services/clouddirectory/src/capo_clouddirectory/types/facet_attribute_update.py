...
class FacetAttributeUpdate(TypedDict, closed=True):
    attribute: NotRequired["capo_clouddirectory.types.facet_attribute.FacetAttribute"]
    """<p>The attribute to update.</p>"""
    action: NotRequired["capo_clouddirectory.types.update_action_type.UpdateActionType"]
...
def serialize_json(value: FacetAttributeUpdate) -> dict:
    ...
    if "attribute" in value:
        ...
        out["Attribute"] = capo_clouddirectory.types.facet_attribute.serialize_json(
            value["attribute"]
        )
    if "action" in value:
        import capo_clouddirectory.types.update_action_type
