...
from ._services.async_cloud_directory import (
    AsyncCloudDirectoryClient as AsyncCloudDirectoryClient,
)
from ._services.cloud_directory import CloudDirectoryClient as CloudDirectoryClient
