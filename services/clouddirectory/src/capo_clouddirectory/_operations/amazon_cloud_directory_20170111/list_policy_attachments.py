...
import capo_clouddirectory.errors.not_policy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotPolicyException":
            raise capo_clouddirectory.errors.not_policy_exception.NotPolicyException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_policy_attachments_response.ListPolicyAttachmentsResponse = capo_clouddirectory.types.list_policy_attachments_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_policy_attachments_request.serialize_json(input_)
    ).encode()
