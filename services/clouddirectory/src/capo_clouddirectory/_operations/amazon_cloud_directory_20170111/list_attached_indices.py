...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_attached_indices_response.ListAttachedIndicesResponse = capo_clouddirectory.types.list_attached_indices_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_attached_indices_request.serialize_json(input_)
    ).encode()
