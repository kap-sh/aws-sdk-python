"""Generated from Smithy shape ``com.amazonaws.clouddirectory#GetLinkAttributes``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.get_link_attributes_response.GetLinkAttributesResponse = capo_clouddirectory.types.get_link_attributes_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.get_link_attributes_request.serialize_json(input_)
    ).encode()
...
async def async_get_link_attributes(
