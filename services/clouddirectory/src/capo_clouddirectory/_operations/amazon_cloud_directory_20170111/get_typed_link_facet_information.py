...
def handle_response(
    ...
    out: capo_clouddirectory.types.get_typed_link_facet_information_response.GetTypedLinkFacetInformationResponse = capo_clouddirectory.types.get_typed_link_facet_information_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.get_typed_link_facet_information_request.serialize_json(
            input_
        )
    ).encode()
