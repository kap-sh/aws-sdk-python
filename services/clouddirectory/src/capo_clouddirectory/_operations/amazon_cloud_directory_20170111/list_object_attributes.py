"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListObjectAttributes``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_object_attributes_response.ListObjectAttributesResponse = capo_clouddirectory.types.list_object_attributes_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/object/attributes"
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_object_attributes_request.serialize_json(input_)
    ).encode()
...
async def async_list_object_attributes(
