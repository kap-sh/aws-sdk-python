"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListIndex``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_index_response.ListIndexResponse = (
        capo_clouddirectory.types.list_index_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/index/targets"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_index_request.serialize_json(input_)
    ).encode()
...
def list_index(
    ...
    capo_clouddirectory.types.list_index_response.ListIndexResponse, zapros.Response
]:
