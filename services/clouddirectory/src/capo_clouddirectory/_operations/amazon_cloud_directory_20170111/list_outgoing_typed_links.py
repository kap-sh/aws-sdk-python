"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListOutgoingTypedLinks``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_outgoing_typed_links_response.ListOutgoingTypedLinksResponse = capo_clouddirectory.types.list_outgoing_typed_links_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/typedlink/outgoing"
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_outgoing_typed_links_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_outgoing_typed_links(
