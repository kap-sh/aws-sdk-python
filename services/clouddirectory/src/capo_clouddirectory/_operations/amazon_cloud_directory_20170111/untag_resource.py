...
import capo_clouddirectory.errors.invalid_tagging_request_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTaggingRequestException":
            raise capo_clouddirectory.errors.invalid_tagging_request_exception.InvalidTaggingRequestException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_clouddirectory.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.untag_resource_request.serialize_json(input_)
    ).encode()
