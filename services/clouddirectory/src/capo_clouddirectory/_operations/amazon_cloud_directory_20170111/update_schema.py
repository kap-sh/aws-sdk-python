...
def handle_response(
    ...
    out: capo_clouddirectory.types.update_schema_response.UpdateSchemaResponse = (
        capo_clouddirectory.types.update_schema_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.update_schema_request.serialize_json(input_)
    ).encode()
