...
import capo_clouddirectory.errors.invalid_schema_doc_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidSchemaDocException":
            raise capo_clouddirectory.errors.invalid_schema_doc_exception.InvalidSchemaDocException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_clouddirectory.types.put_schema_from_json_response.PutSchemaFromJsonResponse = capo_clouddirectory.types.put_schema_from_json_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.put_schema_from_json_request.serialize_json(input_)
    ).encode()
