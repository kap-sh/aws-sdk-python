"""Generated from Smithy shape ``com.amazonaws.clouddirectory#EnableDirectory``."""
...
import capo_clouddirectory.errors.directory_deleted_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryDeletedException":
            raise capo_clouddirectory.errors.directory_deleted_exception.DirectoryDeletedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_clouddirectory.types.enable_directory_response.EnableDirectoryResponse = (
        capo_clouddirectory.types.enable_directory_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/directory/enable"
    params: dict[str, str] = {}
...
async def async_enable_directory(
