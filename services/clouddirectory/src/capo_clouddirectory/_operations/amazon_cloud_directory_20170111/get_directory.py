"""Generated from Smithy shape ``com.amazonaws.clouddirectory#GetDirectory``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.get_directory_response.GetDirectoryResponse = (
        capo_clouddirectory.types.get_directory_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/directory/get"
    params: dict[str, str] = {}
