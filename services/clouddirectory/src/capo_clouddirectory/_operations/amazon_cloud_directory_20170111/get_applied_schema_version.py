"""Generated from Smithy shape ``com.amazonaws.clouddirectory#GetAppliedSchemaVersion``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.get_applied_schema_version_response.GetAppliedSchemaVersionResponse = capo_clouddirectory.types.get_applied_schema_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.get_applied_schema_version_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_applied_schema_version(
