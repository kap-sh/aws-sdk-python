"""Generated from Smithy shape ``com.amazonaws.clouddirectory#UpdateLinkAttributes``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.update_link_attributes_response.UpdateLinkAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.update_link_attributes_request.serialize_json(input_)
    ).encode()
...
async def async_update_link_attributes(
