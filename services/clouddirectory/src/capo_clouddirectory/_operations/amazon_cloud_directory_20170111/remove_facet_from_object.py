...
def handle_response(
    ...
    out: capo_clouddirectory.types.remove_facet_from_object_response.RemoveFacetFromObjectResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.remove_facet_from_object_request.serialize_json(
            input_
        )
    ).encode()
