...
import capo_clouddirectory.errors.directory_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryAlreadyExistsException":
            raise capo_clouddirectory.errors.directory_already_exists_exception.DirectoryAlreadyExistsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_clouddirectory.types.create_directory_response.CreateDirectoryResponse = (
        capo_clouddirectory.types.create_directory_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.create_directory_request.serialize_json(input_)
    ).encode()
