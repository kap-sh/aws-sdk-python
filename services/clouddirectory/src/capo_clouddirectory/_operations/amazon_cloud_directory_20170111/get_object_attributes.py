...
def handle_response(
    ...
    out: capo_clouddirectory.types.get_object_attributes_response.GetObjectAttributesResponse = capo_clouddirectory.types.get_object_attributes_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.get_object_attributes_request.serialize_json(input_)
    ).encode()
