"""Generated from Smithy shape ``com.amazonaws.clouddirectory#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.clouddirectory#AccessDeniedException``."""
