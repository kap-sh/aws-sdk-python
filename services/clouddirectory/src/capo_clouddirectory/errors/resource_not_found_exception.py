"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.clouddirectory#ResourceNotFoundException``."""
