...
from aws_sdk_sts._auth._zapros_handler import AuthMiddleware
from aws_sdk_sts._services._aws_config import aaws_config
from aws_sdk_sts._services._pipeline import (
    AsyncInterceptor,
...
if TYPE_CHECKING:
    ...
    import aws_sdk_sts.types.assume_role_request
    import aws_sdk_sts.types.assume_role_response
    import aws_sdk_sts.types.assume_role_with_saml_request
    import aws_sdk_sts.types.assume_role_with_saml_response
    ...
    import aws_sdk_sts.types.assume_root_request
    import aws_sdk_sts.types.assume_root_response
    import aws_sdk_sts.types.client_token_type
    import aws_sdk_sts.types.decode_authorization_message_request
    import aws_sdk_sts.types.decode_authorization_message_response
    ...
    import aws_sdk_sts.types.get_access_key_info_request
    import aws_sdk_sts.types.get_access_key_info_response
    import aws_sdk_sts.types.get_caller_identity_request
    import aws_sdk_sts.types.get_caller_identity_response
    ...
    import aws_sdk_sts.types.get_federation_token_response
    import aws_sdk_sts.types.get_session_token_request
    import aws_sdk_sts.types.get_session_token_response
    import aws_sdk_sts.types.get_web_identity_token_request
    import aws_sdk_sts.types.get_web_identity_token_response
    import aws_sdk_sts.types.jwt_algorithm_type
    import aws_sdk_sts.types.policy_descriptor_list_type
    import aws_sdk_sts.types.policy_descriptor_type
    ...
    import aws_sdk_sts.types.root_duration_seconds_type
    import aws_sdk_sts.types.saml_assertion_type
    ...
    import aws_sdk_sts.types.target_principal_type
    ...
    import aws_sdk_sts.types.web_identity_token_audience_list_type
...
class AsyncSTSClient:
    ...
    async def assume_role(
        ...
        *,
        ...
        tags: Optional["aws_sdk_sts.types.tag_list_type.tagListType"] = None,
        transitive_tag_keys: Optional[
            "aws_sdk_sts.types.tag_key_list_type.tagKeyListType"
        ] = None,
        external_id: Optional[
            "aws_sdk_sts.types.external_id_type.externalIdType"
        ] = None,
        serial_number: Optional[
            "aws_sdk_sts.types.serial_number_type.serialNumberType"
        ] = None,
        token_code: Optional["aws_sdk_sts.types.token_code_type.tokenCodeType"] = None,
    ...
    ) -> "aws_sdk_sts.types.assume_role_response.AssumeRoleResponse":
        ...
        Raises:
            aws_sdk_sts.errors.expired_token_exception.ExpiredTokenException: <p>The web identity token that was passed is expired or is not valid. Get a new identity token from the identity provider and then retry the request.</p>
            aws_sdk_sts.errors.malformed_policy_document_exception.MalformedPolicyDocumentException: <p>The request was rejected because the policy document was malformed. The error message describes the specific error.</p>
            aws_sdk_sts.errors.packed_policy_too_large_exception.PackedPolicyTooLargeException: <p>The request was rejected because the total packed size of the session policies and session tags combined was too large. An Amazon Web Services conversion compresses the session policy document, session policy ARNs, and session tags into a packed binary format that has a separate limit. The error message indicates by percentage how close the policies and tags are to the upper size limit. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_session-tags.html\">Passing Session Tags in STS</a> in the <i>IAM User Guide</i>.</p> <p>You could receive this error even though you meet other defined session policy and session tag limits. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html#reference_iam-limits-entity-length\">IAM and STS Entity Character Limits</a> in the <i>IAM User Guide</i>.</p>
            aws_sdk_sts.errors.region_disabled_exception.RegionDisabledException: <p>STS is not activated in the requested region for the account that is being asked to generate credentials. The account administrator must use the IAM console to activate STS in that region. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html#sts-regions-activate-deactivate\">Activating and Deactivating STS in an Amazon Web Services Region</a> in the <i>IAM User Guide</i>.</p>
            aws_sdk_sts.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.assume_role_request.AssumeRoleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.assume_role_response.AssumeRoleResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_role

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_role.async_assume_role(
    ...
    async def assume_role_with_saml(
        self,
        role_arn: "aws_sdk_sts.types.arn_type.arnType",
        principal_arn: "aws_sdk_sts.types.arn_type.arnType",
        saml_assertion: "aws_sdk_sts.types.saml_assertion_type.SAMLAssertionType",
        *,
        config_overrides: Optional[AsyncSTSClientConfig] = None,
        policy_arns: Optional[
            "aws_sdk_sts.types.policy_descriptor_list_type.policyDescriptorListType"
    ...
    ) -> "aws_sdk_sts.types.assume_role_with_saml_response.AssumeRoleWithSAMLResponse":
        ...
        Raises:
            aws_sdk_sts.errors.expired_token_exception.ExpiredTokenException: <p>The web identity token that was passed is expired or is not valid. Get a new identity token from the identity provider and then retry the request.</p>
            aws_sdk_sts.errors.idp_rejected_claim_exception.IDPRejectedClaimException: <p>The identity provider (IdP) reported that authentication failed. This might be because the claim is invalid.</p> <p>If this error is returned for the <code>AssumeRoleWithWebIdentity</code> operation, it can also mean that the claim has expired or has been explicitly revoked. </p>
            aws_sdk_sts.errors.invalid_identity_token_exception.InvalidIdentityTokenException: <p>The web identity token that was passed could not be validated by Amazon Web Services. Get a new identity token from the identity provider and then retry the request.</p>
            aws_sdk_sts.errors.malformed_policy_document_exception.MalformedPolicyDocumentException: <p>The request was rejected because the policy document was malformed. The error message describes the specific error.</p>
            aws_sdk_sts.errors.packed_policy_too_large_exception.PackedPolicyTooLargeException: <p>The request was rejected because the total packed size of the session policies and session tags combined was too large. An Amazon Web Services conversion compresses the session policy document, session policy ARNs, and session tags into a packed binary format that has a separate limit. The error message indicates by percentage how close the policies and tags are to the upper size limit. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_session-tags.html\">Passing Session Tags in STS</a> in the <i>IAM User Guide</i>.</p> <p>You could receive this error even though you meet other defined session policy and session tag limits. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html#reference_iam-limits-entity-length\">IAM and STS Entity Character Limits</a> in the <i>IAM User Guide</i>.</p>
            aws_sdk_sts.errors.region_disabled_exception.RegionDisabledException: <p>STS is not activated in the requested region for the account that is being asked to generate credentials. The account administrator must use the IAM console to activate STS in that region. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html#sts-regions-activate-deactivate\">Activating and Deactivating STS in an Amazon Web Services Region</a> in the <i>IAM User Guide</i>.</p>
            aws_sdk_sts.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.assume_role_with_saml_request.AssumeRoleWithSAMLRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.assume_role_with_saml_response.AssumeRoleWithSAMLResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_role_with_saml

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_role_with_saml.async_assume_role_with_saml(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def assume_role_with_web_identity(
        ...
        *,
        config_overrides: Optional[AsyncSTSClientConfig] = None,
        provider_id: Optional["aws_sdk_sts.types.url_type.urlType"] = None,
        policy_arns: Optional[
            "aws_sdk_sts.types.policy_descriptor_list_type.policyDescriptorListType"
        ] = None,
        policy: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.assume_role_with_web_identity_request.AssumeRoleWithWebIdentityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.assume_role_with_web_identity_response.AssumeRoleWithWebIdentityResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_role_with_web_identity

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_role_with_web_identity.async_assume_role_with_web_identity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def assume_root(
        self,
        target_principal: "aws_sdk_sts.types.target_principal_type.TargetPrincipalType",
        task_policy_arn: "aws_sdk_sts.types.policy_descriptor_type.PolicyDescriptorType",
        *,
        config_overrides: Optional[AsyncSTSClientConfig] = None,
        duration_seconds: Optional[
            "aws_sdk_sts.types.root_duration_seconds_type.RootDurationSecondsType"
        ] = None,
    ) -> "aws_sdk_sts.types.assume_root_response.AssumeRootResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.assume_root_request.AssumeRootRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.assume_root_response.AssumeRootResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_root

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_root.async_assume_root(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def decode_authorization_message(
        ...
        *,
        config_overrides: Optional[AsyncSTSClientConfig] = None,
    ) -> "aws_sdk_sts.types.decode_authorization_message_response.DecodeAuthorizationMessageResponse":
        ...
        Raises:
            aws_sdk_sts.errors.invalid_authorization_message_exception.InvalidAuthorizationMessageException: <p>The error returned if the message passed to <code>DecodeAuthorizationMessage</code> was invalid. This can happen if the token contains invalid characters, such as line breaks, or if the message has expired.</p>
            aws_sdk_sts.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.decode_authorization_message_request.DecodeAuthorizationMessageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.decode_authorization_message_response.DecodeAuthorizationMessageResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.decode_authorization_message

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.decode_authorization_message.async_decode_authorization_message(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_access_key_info(
        ...
        *,
        config_overrides: Optional[AsyncSTSClientConfig] = None,
    ) -> "aws_sdk_sts.types.get_access_key_info_response.GetAccessKeyInfoResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.get_access_key_info_request.GetAccessKeyInfoRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.get_access_key_info_response.GetAccessKeyInfoResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.get_access_key_info

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.get_access_key_info.async_get_access_key_info(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_caller_identity(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.get_caller_identity_request.GetCallerIdentityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.get_caller_identity_response.GetCallerIdentityResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.get_caller_identity

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.get_caller_identity.async_get_caller_identity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_delegated_access_token(
        ...
        *,
        ...
        Raises:
            aws_sdk_sts.errors.expired_trade_in_token_exception.ExpiredTradeInTokenException: <p>The trade-in token provided in the request has expired and can no longer be exchanged for credentials. Request a new token and retry the operation.</p>
            aws_sdk_sts.errors.packed_policy_too_large_exception.PackedPolicyTooLargeException: <p>The request was rejected because the total packed size of the session policies and session tags combined was too large. An Amazon Web Services conversion compresses the session policy document, session policy ARNs, and session tags into a packed binary format that has a separate limit. The error message indicates by percentage how close the policies and tags are to the upper size limit. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_session-tags.html\">Passing Session Tags in STS</a> in the <i>IAM User Guide</i>.</p> <p>You could receive this error even though you meet other defined session policy and session tag limits. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html#reference_iam-limits-entity-length\">IAM and STS Entity Character Limits</a> in the <i>IAM User Guide</i>.</p>
            aws_sdk_sts.errors.region_disabled_exception.RegionDisabledException: <p>STS is not activated in the requested region for the account that is being asked to generate credentials. The account administrator must use the IAM console to activate STS in that region. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html#sts-regions-activate-deactivate\">Activating and Deactivating STS in an Amazon Web Services Region</a> in the <i>IAM User Guide</i>.</p>
            aws_sdk_sts.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.get_delegated_access_token_request.GetDelegatedAccessTokenRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.get_delegated_access_token_response.GetDelegatedAccessTokenResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.get_delegated_access_token

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.get_delegated_access_token.async_get_delegated_access_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_federation_token(
        ...
        *,
        ...
        tags: Optional["aws_sdk_sts.types.tag_list_type.tagListType"] = None,
    ) -> "aws_sdk_sts.types.get_federation_token_response.GetFederationTokenResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.get_federation_token_request.GetFederationTokenRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.get_federation_token_response.GetFederationTokenResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.get_federation_token

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.get_federation_token.async_get_federation_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_session_token(
        ...
        *,
        ...
        token_code: Optional["aws_sdk_sts.types.token_code_type.tokenCodeType"] = None,
    ) -> "aws_sdk_sts.types.get_session_token_response.GetSessionTokenResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.get_session_token_request.GetSessionTokenRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.get_session_token_response.GetSessionTokenResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.get_session_token

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.get_session_token.async_get_session_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_web_identity_token(
        ...
        signing_algorithm: "aws_sdk_sts.types.jwt_algorithm_type.jwtAlgorithmType",
        *,
        config_overrides: Optional[AsyncSTSClientConfig] = None,
        duration_seconds: Optional[
            "aws_sdk_sts.types.web_identity_token_duration_seconds_type.webIdentityTokenDurationSecondsType"
        ] = None,
        tags: Optional["aws_sdk_sts.types.tag_list_type.tagListType"] = None,
    ) -> (
        ...
        Raises:
            aws_sdk_sts.errors.jwt_payload_size_exceeded_exception.JWTPayloadSizeExceededException: <p>The requested token payload size exceeds the maximum allowed size. Reduce the number of request tags included in the <code>GetWebIdentityToken</code> API call to reduce the token payload size.</p>
            aws_sdk_sts.errors.outbound_web_identity_federation_disabled_exception.OutboundWebIdentityFederationDisabledException: <p>The outbound web identity federation feature is not enabled for this account. To use this feature, you must first enable it through the Amazon Web Services Management Console or API.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sts.types.get_web_identity_token_request.GetWebIdentityTokenRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sts.types.get_web_identity_token_response.GetWebIdentityTokenResponse"
        ]:
            import aws_sdk_sts._operations.aws_security_token_service_v20110615.get_web_identity_token

            (
                output,
                http_response,
            ) = await aws_sdk_sts._operations.aws_security_token_service_v20110615.get_web_identity_token.async_get_web_identity_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
