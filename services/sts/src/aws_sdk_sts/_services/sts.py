...
from aws_sdk_sts._services._aws_config import aws_config
...
class STSClientConfig(TypedDict, total=False):
...
class STSClient:
    ...
    def assume_role(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.assume_role_request.AssumeRoleRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.assume_role_response.AssumeRoleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_role.assume_role(
    ...
    def assume_role_with_saml(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.assume_role_with_saml_request.AssumeRoleWithSAMLRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.assume_role_with_saml_response.AssumeRoleWithSAMLResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_role_with_saml.assume_role_with_saml(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def assume_role_with_web_identity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.assume_role_with_web_identity_request.AssumeRoleWithWebIdentityRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.assume_role_with_web_identity_response.AssumeRoleWithWebIdentityResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_role_with_web_identity.assume_role_with_web_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def assume_root(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.assume_root_request.AssumeRootRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.assume_root_response.AssumeRootResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.assume_root.assume_root(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def decode_authorization_message(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.decode_authorization_message_request.DecodeAuthorizationMessageRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.decode_authorization_message_response.DecodeAuthorizationMessageResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.decode_authorization_message.decode_authorization_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_key_info(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.get_access_key_info_request.GetAccessKeyInfoRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.get_access_key_info_response.GetAccessKeyInfoResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.get_access_key_info.get_access_key_info(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_caller_identity(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.get_caller_identity_request.GetCallerIdentityRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.get_caller_identity_response.GetCallerIdentityResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.get_caller_identity.get_caller_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_delegated_access_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.get_delegated_access_token_request.GetDelegatedAccessTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.get_delegated_access_token_response.GetDelegatedAccessTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.get_delegated_access_token.get_delegated_access_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_federation_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.get_federation_token_request.GetFederationTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.get_federation_token_response.GetFederationTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.get_federation_token.get_federation_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_session_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.get_session_token_request.GetSessionTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.get_session_token_response.GetSessionTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.get_session_token.get_session_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_web_identity_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sts.types.get_web_identity_token_request.GetWebIdentityTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_sts.types.get_web_identity_token_response.GetWebIdentityTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sts._operations.aws_security_token_service_v20110615.get_web_identity_token.get_web_identity_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
