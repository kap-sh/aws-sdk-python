...
policyDescriptorListType: TypeAlias = list[
    "aws_sdk_sts.types.policy_descriptor_type.PolicyDescriptorType"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_sts.types.policy_descriptor_type.serialize_query(
...
def deserialize_query(el: Element) -> policyDescriptorListType:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_sts.types.policy_descriptor_type.deserialize_query(child))
    return out
