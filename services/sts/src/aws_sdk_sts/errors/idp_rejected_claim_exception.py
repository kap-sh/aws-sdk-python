...
if TYPE_CHECKING:
    import aws_sdk_sts.types.idp_rejected_claim_message


class IDPRejectedClaimException_(TypedDict):
    message: NotRequired[
        "aws_sdk_sts.types.idp_rejected_claim_message.idpRejectedClaimMessage"
    ]
