...
class STSError(Exception):
    """Base class for all STS service errors."""


class ServiceError(STSError):
...
class SerializationError(STSError):
    """Raised when a value cannot be serialized."""


class DeserializationError(STSError):
...
class WaiterFailedError(STSError):
...
class WaiterTimeoutError(STSError):
