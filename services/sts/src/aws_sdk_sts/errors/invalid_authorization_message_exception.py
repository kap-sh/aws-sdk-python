...
if TYPE_CHECKING:
    import aws_sdk_sts.types.invalid_authorization_message


class InvalidAuthorizationMessageException_(TypedDict):
    message: NotRequired[
        "aws_sdk_sts.types.invalid_authorization_message.invalidAuthorizationMessage"
    ]
