...
if TYPE_CHECKING:
    import aws_sdk_sts.types.outbound_web_identity_federation_disabled_exception2


class OutboundWebIdentityFederationDisabledException_(TypedDict):
    message: NotRequired[
        "aws_sdk_sts.types.outbound_web_identity_federation_disabled_exception2.OutboundWebIdentityFederationDisabledException2"
    ]
