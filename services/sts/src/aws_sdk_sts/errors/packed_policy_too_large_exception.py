...
if TYPE_CHECKING:
    import aws_sdk_sts.types.packed_policy_too_large_message


class PackedPolicyTooLargeException_(TypedDict):
    message: NotRequired[
        "aws_sdk_sts.types.packed_policy_too_large_message.packedPolicyTooLargeMessage"
    ]
