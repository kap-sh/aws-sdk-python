...
if TYPE_CHECKING:
    import aws_sdk_sts.types.session_duration_escalation_exception2


class SessionDurationEscalationException_(TypedDict):
    message: NotRequired[
        "aws_sdk_sts.types.session_duration_escalation_exception2.SessionDurationEscalationException2"
    ]
