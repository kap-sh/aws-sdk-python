"""Generated from Smithy shape ``com.amazonaws.sts#AssumeRoot``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("AssumeRootResult")
    out: aws_sdk_sts.types.assume_root_response.AssumeRootResponse = (
        aws_sdk_sts.types.assume_root_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sts.types.assume_root_request.AssumeRootRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AssumeRoot"))
    pairs.append(("Version", "2011-06-15"))
    import aws_sdk_sts.types.assume_root_request

    aws_sdk_sts.types.assume_root_request.serialize_query(input_, pairs, "")
...
def assume_root(
    ...
    input_: aws_sdk_sts.types.assume_root_request.AssumeRootRequest,
) -> tuple[aws_sdk_sts.types.assume_root_response.AssumeRootResponse, zapros.Response]:
