...
def build_request(
    ...
    input_: aws_sdk_sts.types.get_delegated_access_token_request.GetDelegatedAccessTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sts.types.get_delegated_access_token_request.serialize_query(
        input_, pairs, ""
    )
