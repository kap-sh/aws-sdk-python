...
def handle_response(
    ...
    out: aws_sdk_sts.types.get_session_token_response.GetSessionTokenResponse = (
        aws_sdk_sts.types.get_session_token_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sts.types.get_session_token_request.GetSessionTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sts.types.get_session_token_request.serialize_query(input_, pairs, "")
