...
def build_request(
    ...
    input: aws_sdk_sts.types.assume_role_with_saml_request.AssumeRoleWithSAMLRequest,
) -> zapros.Request:
    ...
    aws_sdk_sts.types.assume_role_with_saml_request.serialize_query(input, pairs, "")
