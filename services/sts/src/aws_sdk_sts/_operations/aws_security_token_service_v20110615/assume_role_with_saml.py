...
def handle_response(
    ...
    out: aws_sdk_sts.types.assume_role_with_saml_response.AssumeRoleWithSAMLResponse = (
        aws_sdk_sts.types.assume_role_with_saml_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sts.types.assume_role_with_saml_request.AssumeRoleWithSAMLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sts.types.assume_role_with_saml_request.serialize_query(input_, pairs, "")
