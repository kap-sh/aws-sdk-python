...
def handle_response(
    ...
    out: aws_sdk_sts.types.get_federation_token_response.GetFederationTokenResponse = (
        aws_sdk_sts.types.get_federation_token_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_sts.types.get_federation_token_request.GetFederationTokenRequest,
) -> zapros.Request:
    ...
    aws_sdk_sts.types.get_federation_token_request.serialize_query(input, pairs, "")
