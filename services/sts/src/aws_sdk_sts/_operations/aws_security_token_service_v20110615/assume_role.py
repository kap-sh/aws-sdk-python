"""Generated from Smithy shape ``com.amazonaws.sts#AssumeRole``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("AssumeRoleResult")
    out: aws_sdk_sts.types.assume_role_response.AssumeRoleResponse = (
        aws_sdk_sts.types.assume_role_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sts.types.assume_role_request.AssumeRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AssumeRole"))
    pairs.append(("Version", "2011-06-15"))
    import aws_sdk_sts.types.assume_role_request

    aws_sdk_sts.types.assume_role_request.serialize_query(input_, pairs, "")
...
def assume_role(
    ...
    input_: aws_sdk_sts.types.assume_role_request.AssumeRoleRequest,
) -> tuple[aws_sdk_sts.types.assume_role_response.AssumeRoleResponse, zapros.Response]:
