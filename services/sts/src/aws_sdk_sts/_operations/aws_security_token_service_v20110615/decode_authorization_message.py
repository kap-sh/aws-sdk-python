...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidAuthorizationMessageException":
            import aws_sdk_sts.errors.invalid_authorization_message_exception

            raise aws_sdk_sts.errors.invalid_authorization_message_exception.InvalidAuthorizationMessageException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_sts.types.decode_authorization_message_response.DecodeAuthorizationMessageResponse = aws_sdk_sts.types.decode_authorization_message_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sts.types.decode_authorization_message_request.DecodeAuthorizationMessageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
