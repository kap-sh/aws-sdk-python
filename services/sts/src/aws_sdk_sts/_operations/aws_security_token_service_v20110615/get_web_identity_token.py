...
def build_request(
    ...
    input: aws_sdk_sts.types.get_web_identity_token_request.GetWebIdentityTokenRequest,
) -> zapros.Request:
    ...
    aws_sdk_sts.types.get_web_identity_token_request.serialize_query(input, pairs, "")
