...
if TYPE_CHECKING:
    import capo_sts.types.web_identity_token_audience_string_type

webIdentityTokenAudienceListType: TypeAlias = list[
    "capo_sts.types.web_identity_token_audience_string_type.webIdentityTokenAudienceStringType"
]
