...
from capo_sts._services._aws_config import aws_config
...
class STSClientConfig(TypedDict, total=False, closed=True):
...
class STSClient:
    ...
    def operation_options(
        self, config_overrides: Optional[STSClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: STSClientConfig = config_overrides or {}
    ...
    def assume_role(
        ...
        *,
        config_overrides: Optional[STSClientConfig] = None,
        ...
        Examples:
            ...
            >>> client.assume_role(role_arn='arn:aws:iam::123456789012:role/demo', role_session_name='testAssumeRoleSession', policy='escaped-JSON-IAM-POLICY', tags=[{'Key': 'Project', 'Value': 'Unicorn'}, {'Key': 'Team', 'Value': 'Automation'}, {'Key': 'Cost-Center', 'Value': '12345'}], transitive_tag_keys=['Project', 'Cost-Center'], external_id='123ABC')
        """

        def _handler(
            req: "OperationRequest[capo_sts.types.assume_role_request.AssumeRoleRequest]",
        ) -> OperationResponse[
            "capo_sts.types.assume_role_response.AssumeRoleResponse"
        ]:
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.assume_role.assume_role(
    ...
    def assume_role_with_saml(
        ...
        *,
        ...
        def _handler(
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.assume_role_with_saml.assume_role_with_saml(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def assume_role_with_web_identity(
        ...
        *,
        ...
        def _handler(
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.assume_role_with_web_identity.assume_role_with_web_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def assume_root(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.assume_root(target_principal='111122223333', task_policy_arn={'arn': 'arn:aws:iam::aws:policy/root-task/S3UnlockBucketPolicy'}, duration_seconds=900)
        """

        def _handler(
            req: "OperationRequest[capo_sts.types.assume_root_request.AssumeRootRequest]",
        ) -> OperationResponse[
            "capo_sts.types.assume_root_response.AssumeRootResponse"
        ]:
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.assume_root.assume_root(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def decode_authorization_message(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.decode_authorization_message(encoded_message='<encoded-message>')
        """

        def _handler(
            req: "OperationRequest[capo_sts.types.decode_authorization_message_request.DecodeAuthorizationMessageRequest]",
        ) -> OperationResponse[
            "capo_sts.types.decode_authorization_message_response.DecodeAuthorizationMessageResponse"
        ]:
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.decode_authorization_message.decode_authorization_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_key_info(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sts.types.get_access_key_info_request.GetAccessKeyInfoRequest]",
        ) -> OperationResponse[
            "capo_sts.types.get_access_key_info_response.GetAccessKeyInfoResponse"
        ]:
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.get_access_key_info.get_access_key_info(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_caller_identity(
        ...
        def _handler(
            req: "OperationRequest[capo_sts.types.get_caller_identity_request.GetCallerIdentityRequest]",
        ) -> OperationResponse[
            "capo_sts.types.get_caller_identity_response.GetCallerIdentityResponse"
        ]:
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.get_caller_identity.get_caller_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_delegated_access_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sts.types.get_delegated_access_token_request.GetDelegatedAccessTokenRequest]",
        ) -> OperationResponse[
            "capo_sts.types.get_delegated_access_token_response.GetDelegatedAccessTokenResponse"
        ]:
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.get_delegated_access_token.get_delegated_access_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_federation_token(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_federation_token(name='testFedUserSession', policy='escaped-JSON-IAM-POLICY', duration_seconds=3600, tags=[{'Key': 'Project', 'Value': 'Pegasus'}, {'Key': 'Cost-Center', 'Value': '98765'}])
        """

        def _handler(
            req: "OperationRequest[capo_sts.types.get_federation_token_request.GetFederationTokenRequest]",
        ) -> OperationResponse[
            "capo_sts.types.get_federation_token_response.GetFederationTokenResponse"
        ]:
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.get_federation_token.get_federation_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_session_token(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_session_token(duration_seconds=3600, serial_number='YourMFASerialNumber', token_code='123456')
        """

        def _handler(
            req: "OperationRequest[capo_sts.types.get_session_token_request.GetSessionTokenRequest]",
        ) -> OperationResponse[
            "capo_sts.types.get_session_token_response.GetSessionTokenResponse"
        ]:
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.get_session_token.get_session_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_web_identity_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sts.types.get_web_identity_token_request.GetWebIdentityTokenRequest]",
        ) -> OperationResponse[
            "capo_sts.types.get_web_identity_token_response.GetWebIdentityTokenResponse"
        ]:
            ...
            output, http_response = (
                capo_sts._operations.aws_security_token_service_v20110615.get_web_identity_token.get_web_identity_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
