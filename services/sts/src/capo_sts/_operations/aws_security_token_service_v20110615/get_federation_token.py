"""Generated from Smithy shape ``com.amazonaws.sts#GetFederationToken``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetFederationTokenResult")
    out: capo_sts.types.get_federation_token_response.GetFederationTokenResponse = (
        capo_sts.types.get_federation_token_response.deserialize_query(
...
def build_request(
    ...
    capo_sts.types.get_federation_token_request.serialize_query(input_, pairs, "")
...
async def async_get_federation_token(
