"""Generated from Smithy shape ``com.amazonaws.sts#GetAccessKeyInfo``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetAccessKeyInfoResult")
    out: capo_sts.types.get_access_key_info_response.GetAccessKeyInfoResponse = (
        capo_sts.types.get_access_key_info_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetAccessKeyInfo"))
    pairs.append(("Version", "2011-06-15"))
    capo_sts.types.get_access_key_info_request.serialize_query(input_, pairs, "")
...
async def async_get_access_key_info(
