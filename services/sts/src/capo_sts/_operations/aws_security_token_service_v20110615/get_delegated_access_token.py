"""Generated from Smithy shape ``com.amazonaws.sts#GetDelegatedAccessToken``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ExpiredTradeInTokenException":
            raise capo_sts.errors.expired_trade_in_token_exception.ExpiredTradeInTokenException.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_sts.types.get_delegated_access_token_response.GetDelegatedAccessTokenResponse = capo_sts.types.get_delegated_access_token_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetDelegatedAccessToken"))
    pairs.append(("Version", "2011-06-15"))
    capo_sts.types.get_delegated_access_token_request.serialize_query(input_, pairs, "")
...
async def async_get_delegated_access_token(
