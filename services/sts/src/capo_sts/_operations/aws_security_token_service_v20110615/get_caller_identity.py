"""Generated from Smithy shape ``com.amazonaws.sts#GetCallerIdentity``."""
...
def handle_response(
    ...
    out: capo_sts.types.get_caller_identity_response.GetCallerIdentityResponse = (
        capo_sts.types.get_caller_identity_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetCallerIdentity"))
    pairs.append(("Version", "2011-06-15"))
    capo_sts.types.get_caller_identity_request.serialize_query(input_, pairs, "")
