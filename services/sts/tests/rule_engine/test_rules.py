...
from capo_sts._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_useglobalendpoint_with_legacy_region__ap():
    """UseGlobalEndpoint with legacy region `ap-northeast-1`"""
    params = EndpointParams(Region='ap-northeast-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__ap():
    """UseGlobalEndpoint with legacy region `ap-south-1`"""
    params = EndpointParams(Region='ap-south-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__ap():
    """UseGlobalEndpoint with legacy region `ap-southeast-1`"""
    params = EndpointParams(Region='ap-southeast-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__ap():
    """UseGlobalEndpoint with legacy region `ap-southeast-2`"""
    params = EndpointParams(Region='ap-southeast-2', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__aw():
    """UseGlobalEndpoint with legacy region `aws-global`"""
    params = EndpointParams(Region='aws-global', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__ca():
    """UseGlobalEndpoint with legacy region `ca-central-1`"""
    params = EndpointParams(Region='ca-central-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__eu():
    """UseGlobalEndpoint with legacy region `eu-central-1`"""
    params = EndpointParams(Region='eu-central-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__eu():
    """UseGlobalEndpoint with legacy region `eu-north-1`"""
    params = EndpointParams(Region='eu-north-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__eu():
    """UseGlobalEndpoint with legacy region `eu-west-1`"""
    params = EndpointParams(Region='eu-west-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__eu():
    """UseGlobalEndpoint with legacy region `eu-west-2`"""
    params = EndpointParams(Region='eu-west-2', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__eu():
    """UseGlobalEndpoint with legacy region `eu-west-3`"""
    params = EndpointParams(Region='eu-west-3', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__sa():
    """UseGlobalEndpoint with legacy region `sa-east-1`"""
    params = EndpointParams(Region='sa-east-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__us():
    """UseGlobalEndpoint with legacy region `us-east-1`"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__us():
    """UseGlobalEndpoint with legacy region `us-east-2`"""
    params = EndpointParams(Region='us-east-2', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__us():
    """UseGlobalEndpoint with legacy region `us-west-1`"""
    params = EndpointParams(Region='us-west-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_legacy_region__us():
    """UseGlobalEndpoint with legacy region `us-west-2`"""
    params = EndpointParams(Region='us-west-2', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.amazonaws.com'

def test_useglobalendpoint_with_non_legacy_region():
    """UseGlobalEndpoint with Non-legacy region `us-east-3`"""
    params = EndpointParams(Region='us-east-3', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True)
    result = resolve(params)
    assert result.url == 'https://sts.us-east-3.amazonaws.com'

def test_useglobalendpoint_with_legacy_region_and():
    """UseGlobalEndpoint with legacy region and custom endpoint"""
    params = EndpointParams(Region='us-west-1', UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=True, Endpoint='https://example.com')
    result = resolve(params)
    assert result.url == 'https://example.com'

def test_useglobalendpoint_with_unset_region_and_():
    """UseGlobalEndpoint with unset region and custom endpoint"""
    params = EndpointParams(UseFIPS=False, UseDualStack=False, UseGlobalEndpoint=False, Endpoint='https://example.com')
    result = resolve(params)
    assert result.url == 'https://example.com'