...
```
pip install aws-sdk-chime-sdk-voice
```

## Usage

```python
from aws_sdk_chime_sdk_voice import AsyncChimeSDKVoiceClient
...
```python
from aws_sdk_chime_sdk_voice import AsyncChimeSDKVoiceClient
from aws_sdk_chime_sdk_voice.error import AccessDeniedException
