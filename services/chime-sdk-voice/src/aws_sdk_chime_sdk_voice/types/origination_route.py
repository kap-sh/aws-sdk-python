...
if TYPE_CHECKING:
    ...
    import aws_sdk_chime_sdk_voice.types.origination_route_protocol
    import aws_sdk_chime_sdk_voice.types.origination_route_weight
    import aws_sdk_chime_sdk_voice.types.port
...
class OriginationRoute(TypedDict):
    ...
    protocol: NotRequired[
        "aws_sdk_chime_sdk_voice.types.origination_route_protocol.OriginationRouteProtocol"
    ]
    ...
    priority: NotRequired[
        "aws_sdk_chime_sdk_voice.types.origination_route_priority.OriginationRoutePriority"
    ]
    """<p>The priority associated with the host, with 1 being the highest priority. Higher priority hosts are attempted first.</p>"""
    weight: NotRequired[
        "aws_sdk_chime_sdk_voice.types.origination_route_weight.OriginationRouteWeight"
    ]
...
def serialize_json(value: OriginationRoute) -> dict:
    ...
    if "protocol" in value:
        ...
        out["Protocol"] = (
            aws_sdk_chime_sdk_voice.types.origination_route_protocol.serialize_json(
                value["protocol"]
            )
        )
...
def deserialize_json(data: dict) -> OriginationRoute:
    ...
    if "Protocol" in data:
        ...
        out["protocol"] = (
            aws_sdk_chime_sdk_voice.types.origination_route_protocol.deserialize_json(
                data["Protocol"]
            )
        )
    if "Priority" in data:
