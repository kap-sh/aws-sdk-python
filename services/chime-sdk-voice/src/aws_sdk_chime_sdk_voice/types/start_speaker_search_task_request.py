...
class StartSpeakerSearchTaskRequest(TypedDict):
    voice_connector_id: (
    ...
    call_leg: NotRequired["aws_sdk_chime_sdk_voice.types.call_leg_type.CallLegType"]
...
def serialize_json(value: StartSpeakerSearchTaskRequest) -> dict:
    ...
    if "call_leg" in value:
        ...
        out["CallLeg"] = aws_sdk_chime_sdk_voice.types.call_leg_type.serialize_json(
            value["call_leg"]
        )
    return out
...
def deserialize_json(data: dict) -> StartSpeakerSearchTaskRequest:
    ...
    if "CallLeg" in data:
        ...
        out["call_leg"] = aws_sdk_chime_sdk_voice.types.call_leg_type.deserialize_json(
            data["CallLeg"]
        )
    return out
