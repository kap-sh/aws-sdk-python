...
if TYPE_CHECKING:
    ...
    import aws_sdk_chime_sdk_voice.types.voice_connector_item_priority


class VoiceConnectorItem(TypedDict):
    voice_connector_id: "aws_sdk_chime_sdk_voice.types.non_empty_string.NonEmptyString"
    """<p>The Voice Connector ID.</p>"""
    priority: "aws_sdk_chime_sdk_voice.types.voice_connector_item_priority.VoiceConnectorItemPriority"
