"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DeleteVoiceConnectorProxy``."""
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.delete_voice_connector_proxy_request.DeleteVoiceConnectorProxyRequest,
) -> zapros.Request:
...
async def async_delete_voice_connector_proxy(
