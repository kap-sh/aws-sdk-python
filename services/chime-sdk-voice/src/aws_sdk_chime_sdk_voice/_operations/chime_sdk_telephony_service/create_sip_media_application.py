...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.create_sip_media_application_response.CreateSipMediaApplicationResponse = aws_sdk_chime_sdk_voice.types.create_sip_media_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.create_sip_media_application_request.CreateSipMediaApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.create_sip_media_application_request.serialize_json(
            input_
        )
    ).encode()
