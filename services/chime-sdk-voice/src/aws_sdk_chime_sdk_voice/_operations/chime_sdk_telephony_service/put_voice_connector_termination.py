"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#PutVoiceConnectorTermination``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.put_voice_connector_termination_response.PutVoiceConnectorTerminationResponse = aws_sdk_chime_sdk_voice.types.put_voice_connector_termination_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.put_voice_connector_termination_request.PutVoiceConnectorTerminationRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/voice-connectors/{VoiceConnectorId}/termination"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.put_voice_connector_termination_request.serialize_json(
            input
        )
    ).encode()
...
async def async_put_voice_connector_termination(
