...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_voice_connector_termination_credentials_response.ListVoiceConnectorTerminationCredentialsResponse = aws_sdk_chime_sdk_voice.types.list_voice_connector_termination_credentials_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.list_voice_connector_termination_credentials_request.ListVoiceConnectorTerminationCredentialsRequest,
) -> zapros.Request:
