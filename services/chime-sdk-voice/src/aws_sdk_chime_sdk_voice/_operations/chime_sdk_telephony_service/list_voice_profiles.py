...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_voice_profiles_response.ListVoiceProfilesResponse = aws_sdk_chime_sdk_voice.types.list_voice_profiles_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.list_voice_profiles_request.ListVoiceProfilesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "voice_profile_domain_id" in input:
        params["voice-profile-domain-id"] = str(input["voice_profile_domain_id"])
