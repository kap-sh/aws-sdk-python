...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.update_voice_profile_domain_request.UpdateVoiceProfileDomainRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{VoiceProfileDomainId}", quote(str(input["voice_profile_domain_id"]), safe="")
    )
    params: dict[str, str] = {}
