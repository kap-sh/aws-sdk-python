...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.update_voice_connector_group_response.UpdateVoiceConnectorGroupResponse = aws_sdk_chime_sdk_voice.types.update_voice_connector_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.update_voice_connector_group_request.UpdateVoiceConnectorGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.update_voice_connector_group_request.serialize_json(
            input_
        )
    ).encode()
