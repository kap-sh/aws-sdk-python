...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_group_request.AssociatePhoneNumbersWithVoiceConnectorGroupRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["voice_connector_group_id"]), safe=""),
    )
    params: dict[str, str] = {}
