"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#AssociatePhoneNumbersWithVoiceConnectorGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_group_response.AssociatePhoneNumbersWithVoiceConnectorGroupResponse = aws_sdk_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_group_request.AssociatePhoneNumbersWithVoiceConnectorGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_phone_numbers_with_voice_connector_group(
