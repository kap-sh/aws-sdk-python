"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#StopSpeakerSearchTask``."""
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.stop_speaker_search_task_request.StopSpeakerSearchTaskRequest,
) -> zapros.Request:
