...
import aws_sdk_chime_sdk_voice.types.sip_media_application_list
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_sip_media_applications_response.ListSipMediaApplicationsResponse = aws_sdk_chime_sdk_voice.types.list_sip_media_applications_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.list_sip_media_applications_request.ListSipMediaApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
