"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#UpdateVoiceProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.update_voice_profile_response.UpdateVoiceProfileResponse = aws_sdk_chime_sdk_voice.types.update_voice_profile_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.update_voice_profile_request.UpdateVoiceProfileRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/voice-profiles/{VoiceProfileId}"
    url = url.replace(
        "{VoiceProfileId}", quote(str(input["voice_profile_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.update_voice_profile_request.serialize_json(input)
    ).encode()
