"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListPhoneNumbers``."""
...
import aws_sdk_chime_sdk_voice.types.phone_number_list
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_phone_numbers_response.ListPhoneNumbersResponse = aws_sdk_chime_sdk_voice.types.list_phone_numbers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.list_phone_numbers_request.ListPhoneNumbersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/phone-numbers"
    params: dict[str, str] = {}
    if "status" in input_:
        params["status"] = str(input_["status"])
    if "product_type" in input_:
        params["product-type"] = str(input_["product_type"])
    if "filter_name" in input_:
        params["filter-name"] = str(input_["filter_name"])
    if "filter_value" in input_:
        params["filter-value"] = str(input_["filter_value"])
...
async def async_list_phone_numbers(
