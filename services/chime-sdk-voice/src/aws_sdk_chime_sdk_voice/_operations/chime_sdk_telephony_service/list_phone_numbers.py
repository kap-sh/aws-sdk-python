...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.list_phone_numbers_request.ListPhoneNumbersRequest,
) -> zapros.Request:
    ...
    if "filter_name" in input:
        params["filter-name"] = str(input["filter_name"])
    if "filter_value" in input:
        params["filter-value"] = str(input["filter_value"])
