...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.get_phone_number_order_request.GetPhoneNumberOrderRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{PhoneNumberOrderId}", quote(str(input["phone_number_order_id"]), safe="")
    )
    params: dict[str, str] = {}
