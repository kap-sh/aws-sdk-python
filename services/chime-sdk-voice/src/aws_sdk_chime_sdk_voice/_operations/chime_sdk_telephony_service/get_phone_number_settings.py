"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetPhoneNumberSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_phone_number_settings_response.GetPhoneNumberSettingsResponse = aws_sdk_chime_sdk_voice.types.get_phone_number_settings_response.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/settings/phone-number"
    params: dict[str, str] = {}
...
async def async_get_phone_number_settings(
