"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DeleteVoiceConnectorTerminationCredentials``."""
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.delete_voice_connector_termination_credentials_request.DeleteVoiceConnectorTerminationCredentialsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.delete_voice_connector_termination_credentials_request.serialize_json(
            input
        )
    ).encode()
...
async def async_delete_voice_connector_termination_credentials(
