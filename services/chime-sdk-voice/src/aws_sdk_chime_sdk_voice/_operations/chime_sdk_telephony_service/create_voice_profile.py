...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.create_voice_profile_response.CreateVoiceProfileResponse = aws_sdk_chime_sdk_voice.types.create_voice_profile_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.create_voice_profile_request.CreateVoiceProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.create_voice_profile_request.serialize_json(input)
    ).encode()
