...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.update_phone_number_request.UpdatePhoneNumberRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.update_phone_number_request.serialize_json(input)
    ).encode()
