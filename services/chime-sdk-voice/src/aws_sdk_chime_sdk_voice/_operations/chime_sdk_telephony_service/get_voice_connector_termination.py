"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceConnectorTermination``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_connector_termination_response.GetVoiceConnectorTerminationResponse = aws_sdk_chime_sdk_voice.types.get_voice_connector_termination_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.get_voice_connector_termination_request.GetVoiceConnectorTerminationRequest,
) -> zapros.Request:
...
async def async_get_voice_connector_termination(
