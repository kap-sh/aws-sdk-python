...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.create_voice_connector_group_response.CreateVoiceConnectorGroupResponse = aws_sdk_chime_sdk_voice.types.create_voice_connector_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.create_voice_connector_group_request.CreateVoiceConnectorGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.create_voice_connector_group_request.serialize_json(
            input_
        )
    ).encode()
