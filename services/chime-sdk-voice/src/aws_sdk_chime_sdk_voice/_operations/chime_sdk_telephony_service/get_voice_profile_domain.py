"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceProfileDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_profile_domain_response.GetVoiceProfileDomainResponse = aws_sdk_chime_sdk_voice.types.get_voice_profile_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_voice_profile_domain_request.GetVoiceProfileDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_voice_profile_domain(
