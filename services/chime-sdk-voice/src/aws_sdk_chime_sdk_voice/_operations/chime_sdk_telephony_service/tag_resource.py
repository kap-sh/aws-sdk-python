"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#TagResource``."""
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.tag_resource_request.serialize_json(input_)
    ).encode()
