...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_proxy_sessions_response.ListProxySessionsResponse = aws_sdk_chime_sdk_voice.types.list_proxy_sessions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.list_proxy_sessions_request.ListProxySessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
