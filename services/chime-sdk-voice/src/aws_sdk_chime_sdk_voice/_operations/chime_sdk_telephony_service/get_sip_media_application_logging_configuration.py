"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetSipMediaApplicationLoggingConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_sip_media_application_logging_configuration_response.GetSipMediaApplicationLoggingConfigurationResponse = aws_sdk_chime_sdk_voice.types.get_sip_media_application_logging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_sip_media_application_logging_configuration_request.GetSipMediaApplicationLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_sip_media_application_logging_configuration(
