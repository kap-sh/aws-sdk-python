...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_sip_media_application_response.GetSipMediaApplicationResponse = aws_sdk_chime_sdk_voice.types.get_sip_media_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_sip_media_application_request.GetSipMediaApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
