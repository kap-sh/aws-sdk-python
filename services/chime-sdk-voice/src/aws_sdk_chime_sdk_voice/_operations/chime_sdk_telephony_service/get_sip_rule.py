...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_sip_rule_response.GetSipRuleResponse = (
        aws_sdk_chime_sdk_voice.types.get_sip_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_sip_rule_request.GetSipRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
