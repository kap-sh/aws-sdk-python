...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.validate_e911_address_response.ValidateE911AddressResponse = aws_sdk_chime_sdk_voice.types.validate_e911_address_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.validate_e911_address_request.ValidateE911AddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.validate_e911_address_request.serialize_json(
            input_
        )
    ).encode()
