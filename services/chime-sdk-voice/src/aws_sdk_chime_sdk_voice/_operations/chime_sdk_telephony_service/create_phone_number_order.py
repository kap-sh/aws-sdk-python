...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.create_phone_number_order_response.CreatePhoneNumberOrderResponse = aws_sdk_chime_sdk_voice.types.create_phone_number_order_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.create_phone_number_order_request.CreatePhoneNumberOrderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.create_phone_number_order_request.serialize_json(
            input_
        )
    ).encode()
