"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#UpdateSipRule``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.update_sip_rule_response.UpdateSipRuleResponse = aws_sdk_chime_sdk_voice.types.update_sip_rule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.update_sip_rule_request.UpdateSipRuleRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/sip-rules/{SipRuleId}"
    url = url.replace("{SipRuleId}", quote(str(input["sip_rule_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_chime_sdk_voice.types.update_sip_rule_request

    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.update_sip_rule_request.serialize_json(input)
    ).encode()
...
async def async_update_sip_rule(
