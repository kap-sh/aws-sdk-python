...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_connector_origination_response.GetVoiceConnectorOriginationResponse = aws_sdk_chime_sdk_voice.types.get_voice_connector_origination_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.get_voice_connector_origination_request.GetVoiceConnectorOriginationRequest,
) -> zapros.Request:
