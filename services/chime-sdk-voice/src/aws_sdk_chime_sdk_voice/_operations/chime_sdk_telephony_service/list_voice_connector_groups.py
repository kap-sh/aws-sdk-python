...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_voice_connector_groups_response.ListVoiceConnectorGroupsResponse = aws_sdk_chime_sdk_voice.types.list_voice_connector_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.list_voice_connector_groups_request.ListVoiceConnectorGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
