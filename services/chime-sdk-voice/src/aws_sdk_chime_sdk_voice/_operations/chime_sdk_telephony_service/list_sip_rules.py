...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_sip_rules_response.ListSipRulesResponse = (
        aws_sdk_chime_sdk_voice.types.list_sip_rules_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.list_sip_rules_request.ListSipRulesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "sip_media_application_id" in input:
        params["sip-media-application"] = str(input["sip_media_application_id"])
