...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.create_proxy_session_response.CreateProxySessionResponse = aws_sdk_chime_sdk_voice.types.create_proxy_session_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.create_proxy_session_request.CreateProxySessionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.create_proxy_session_request.serialize_json(input)
    ).encode()
