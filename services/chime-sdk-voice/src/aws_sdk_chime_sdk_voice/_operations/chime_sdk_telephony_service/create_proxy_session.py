...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.create_proxy_session_request.CreateProxySessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.create_proxy_session_request.serialize_json(
            input_
        )
    ).encode()
