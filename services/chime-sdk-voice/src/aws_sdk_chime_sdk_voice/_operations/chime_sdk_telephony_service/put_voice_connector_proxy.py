...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.put_voice_connector_proxy_response.PutVoiceConnectorProxyResponse = aws_sdk_chime_sdk_voice.types.put_voice_connector_proxy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.put_voice_connector_proxy_request.PutVoiceConnectorProxyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.put_voice_connector_proxy_request.serialize_json(
            input_
        )
    ).encode()
