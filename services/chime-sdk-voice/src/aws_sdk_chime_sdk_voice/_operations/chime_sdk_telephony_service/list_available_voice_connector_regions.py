...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_available_voice_connector_regions_response.ListAvailableVoiceConnectorRegionsResponse = aws_sdk_chime_sdk_voice.types.list_available_voice_connector_regions_response.deserialize_json(
