"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListSupportedPhoneNumberCountries``."""
...
import aws_sdk_chime_sdk_voice.types.phone_number_countries_list
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_supported_phone_number_countries_response.ListSupportedPhoneNumberCountriesResponse = aws_sdk_chime_sdk_voice.types.list_supported_phone_number_countries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.list_supported_phone_number_countries_request.ListSupportedPhoneNumberCountriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/phone-number-countries"
    params: dict[str, str] = {}
    if "product_type" in input_:
        params["product-type"] = str(input_["product_type"])
...
async def async_list_supported_phone_number_countries(
