...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.list_supported_phone_number_countries_request.ListSupportedPhoneNumberCountriesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "product_type" in input:
        params["product-type"] = str(input["product_type"])
