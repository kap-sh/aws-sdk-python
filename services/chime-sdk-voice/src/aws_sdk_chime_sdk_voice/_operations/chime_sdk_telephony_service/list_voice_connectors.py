...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_voice_connectors_response.ListVoiceConnectorsResponse = aws_sdk_chime_sdk_voice.types.list_voice_connectors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.list_voice_connectors_request.ListVoiceConnectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
