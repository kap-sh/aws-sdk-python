...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_connector_logging_configuration_response.GetVoiceConnectorLoggingConfigurationResponse = aws_sdk_chime_sdk_voice.types.get_voice_connector_logging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_voice_connector_logging_configuration_request.GetVoiceConnectorLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
