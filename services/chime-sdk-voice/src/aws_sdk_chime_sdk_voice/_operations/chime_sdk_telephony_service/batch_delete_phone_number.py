...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.batch_delete_phone_number_response.BatchDeletePhoneNumberResponse = aws_sdk_chime_sdk_voice.types.batch_delete_phone_number_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.batch_delete_phone_number_request.BatchDeletePhoneNumberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.batch_delete_phone_number_request.serialize_json(
            input_
        )
    ).encode()
