...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_connector_external_systems_configuration_response.GetVoiceConnectorExternalSystemsConfigurationResponse = aws_sdk_chime_sdk_voice.types.get_voice_connector_external_systems_configuration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.get_voice_connector_external_systems_configuration_request.GetVoiceConnectorExternalSystemsConfigurationRequest,
) -> zapros.Request:
