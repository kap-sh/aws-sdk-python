...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_connector_termination_health_response.GetVoiceConnectorTerminationHealthResponse = aws_sdk_chime_sdk_voice.types.get_voice_connector_termination_health_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_voice_connector_termination_health_request.GetVoiceConnectorTerminationHealthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
