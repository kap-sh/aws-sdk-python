...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.update_sip_media_application_call_request.UpdateSipMediaApplicationCallRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{TransactionId}", quote(str(input_["transaction_id"]), safe=""))
    params: dict[str, str] = {}
