...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_proxy_session_response.GetProxySessionResponse = aws_sdk_chime_sdk_voice.types.get_proxy_session_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.get_proxy_session_request.GetProxySessionRequest,
) -> zapros.Request:
