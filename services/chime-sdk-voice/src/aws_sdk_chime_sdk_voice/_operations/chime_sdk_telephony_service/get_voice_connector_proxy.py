"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceConnectorProxy``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_connector_proxy_response.GetVoiceConnectorProxyResponse = aws_sdk_chime_sdk_voice.types.get_voice_connector_proxy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.get_voice_connector_proxy_request.GetVoiceConnectorProxyRequest,
) -> zapros.Request:
...
async def async_get_voice_connector_proxy(
