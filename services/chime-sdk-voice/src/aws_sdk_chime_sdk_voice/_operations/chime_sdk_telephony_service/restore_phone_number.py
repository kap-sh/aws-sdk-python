...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.restore_phone_number_response.RestorePhoneNumberResponse = aws_sdk_chime_sdk_voice.types.restore_phone_number_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.restore_phone_number_request.RestorePhoneNumberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
