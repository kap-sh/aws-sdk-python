...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.put_voice_connector_logging_configuration_response.PutVoiceConnectorLoggingConfigurationResponse = aws_sdk_chime_sdk_voice.types.put_voice_connector_logging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.put_voice_connector_logging_configuration_request.PutVoiceConnectorLoggingConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.put_voice_connector_logging_configuration_request.serialize_json(
            input
        )
    ).encode()
