...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.put_voice_connector_termination_credentials_request.PutVoiceConnectorTerminationCredentialsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.put_voice_connector_termination_credentials_request.serialize_json(
            input_
        )
    ).encode()
