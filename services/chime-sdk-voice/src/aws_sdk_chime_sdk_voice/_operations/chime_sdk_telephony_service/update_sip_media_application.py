"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#UpdateSipMediaApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.update_sip_media_application_response.UpdateSipMediaApplicationResponse = aws_sdk_chime_sdk_voice.types.update_sip_media_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.update_sip_media_application_request.UpdateSipMediaApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_sip_media_application(
