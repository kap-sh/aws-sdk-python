...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_response.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse = aws_sdk_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_request.DisassociatePhoneNumbersFromVoiceConnectorGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_request.serialize_json(
            input_
        )
    ).encode()
