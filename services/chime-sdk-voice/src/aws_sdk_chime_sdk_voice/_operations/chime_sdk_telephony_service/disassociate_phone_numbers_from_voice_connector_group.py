...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_request.DisassociatePhoneNumbersFromVoiceConnectorGroupRequest,
) -> zapros.Request:
