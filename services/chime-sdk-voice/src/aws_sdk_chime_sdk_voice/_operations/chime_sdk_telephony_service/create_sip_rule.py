...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.create_sip_rule_request.CreateSipRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.create_sip_rule_request.serialize_json(input)
    ).encode()
