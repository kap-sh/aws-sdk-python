...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.create_sip_rule_response.CreateSipRuleResponse = aws_sdk_chime_sdk_voice.types.create_sip_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.create_sip_rule_request.CreateSipRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.create_sip_rule_request.serialize_json(input_)
    ).encode()
