"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#StartSpeakerSearchTask``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.start_speaker_search_task_response.StartSpeakerSearchTaskResponse = aws_sdk_chime_sdk_voice.types.start_speaker_search_task_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.start_speaker_search_task_request.StartSpeakerSearchTaskRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.start_speaker_search_task_request.serialize_json(
            input
        )
    ).encode()
