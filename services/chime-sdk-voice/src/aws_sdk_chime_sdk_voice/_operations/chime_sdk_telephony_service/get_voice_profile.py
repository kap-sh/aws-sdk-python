...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_profile_response.GetVoiceProfileResponse = aws_sdk_chime_sdk_voice.types.get_voice_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_voice_profile_request.GetVoiceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
