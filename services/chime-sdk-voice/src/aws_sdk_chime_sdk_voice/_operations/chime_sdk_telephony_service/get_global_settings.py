...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_global_settings_response.GetGlobalSettingsResponse = aws_sdk_chime_sdk_voice.types.get_global_settings_response.deserialize_json(
