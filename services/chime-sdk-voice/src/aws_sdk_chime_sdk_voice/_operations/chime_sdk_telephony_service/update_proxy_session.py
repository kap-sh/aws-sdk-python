...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.update_proxy_session_response.UpdateProxySessionResponse = aws_sdk_chime_sdk_voice.types.update_proxy_session_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.update_proxy_session_request.UpdateProxySessionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ProxySessionId}", quote(str(input["proxy_session_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.update_proxy_session_request.serialize_json(input)
    ).encode()
