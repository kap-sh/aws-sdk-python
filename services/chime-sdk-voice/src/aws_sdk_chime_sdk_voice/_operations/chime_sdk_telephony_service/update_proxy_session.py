...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.update_proxy_session_request.UpdateProxySessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.update_proxy_session_request.serialize_json(
            input_
        )
    ).encode()
