...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_speaker_search_task_response.GetSpeakerSearchTaskResponse = aws_sdk_chime_sdk_voice.types.get_speaker_search_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_speaker_search_task_request.GetSpeakerSearchTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
