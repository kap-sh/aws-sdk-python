...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_tone_analysis_task_response.GetVoiceToneAnalysisTaskResponse = aws_sdk_chime_sdk_voice.types.get_voice_tone_analysis_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_voice_tone_analysis_task_request.GetVoiceToneAnalysisTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
