...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.get_voice_tone_analysis_task_request.GetVoiceToneAnalysisTaskRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "is_caller" in input:
        params["isCaller"] = str(input["is_caller"])
