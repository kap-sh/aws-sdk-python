"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceConnectorStreamingConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_connector_streaming_configuration_response.GetVoiceConnectorStreamingConfigurationResponse = aws_sdk_chime_sdk_voice.types.get_voice_connector_streaming_configuration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.get_voice_connector_streaming_configuration_request.GetVoiceConnectorStreamingConfigurationRequest,
) -> zapros.Request:
...
async def async_get_voice_connector_streaming_configuration(
