...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.put_sip_media_application_alexa_skill_configuration_response.PutSipMediaApplicationAlexaSkillConfigurationResponse = aws_sdk_chime_sdk_voice.types.put_sip_media_application_alexa_skill_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.put_sip_media_application_alexa_skill_configuration_request.PutSipMediaApplicationAlexaSkillConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.put_sip_media_application_alexa_skill_configuration_request.serialize_json(
            input_
        )
    ).encode()
