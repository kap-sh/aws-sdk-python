...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.search_available_phone_numbers_response.SearchAvailablePhoneNumbersResponse = aws_sdk_chime_sdk_voice.types.search_available_phone_numbers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.search_available_phone_numbers_request.SearchAvailablePhoneNumbersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
