"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DeleteSipRule``."""
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.delete_sip_rule_request.DeleteSipRuleRequest,
) -> zapros.Request:
...
async def async_delete_sip_rule(
