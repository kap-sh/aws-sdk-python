...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_connector_response.GetVoiceConnectorResponse = aws_sdk_chime_sdk_voice.types.get_voice_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_voice_connector_request.GetVoiceConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
