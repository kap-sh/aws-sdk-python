...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.create_voice_profile_domain_response.CreateVoiceProfileDomainResponse = aws_sdk_chime_sdk_voice.types.create_voice_profile_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.create_voice_profile_domain_request.CreateVoiceProfileDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.create_voice_profile_domain_request.serialize_json(
            input_
        )
    ).encode()
