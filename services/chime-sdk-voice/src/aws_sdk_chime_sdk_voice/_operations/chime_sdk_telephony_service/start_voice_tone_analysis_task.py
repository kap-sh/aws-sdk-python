...
def build_request(
    ...
    input: aws_sdk_chime_sdk_voice.types.start_voice_tone_analysis_task_request.StartVoiceToneAnalysisTaskRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{VoiceConnectorId}", quote(str(input["voice_connector_id"]), safe="")
    )
    params: dict[str, str] = {}
