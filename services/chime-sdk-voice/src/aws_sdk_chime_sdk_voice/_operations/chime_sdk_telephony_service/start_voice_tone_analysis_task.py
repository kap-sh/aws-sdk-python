...
import aws_sdk_chime_sdk_voice.errors.conflict_exception
import aws_sdk_chime_sdk_voice.errors.forbidden_exception
import aws_sdk_chime_sdk_voice.errors.gone_exception
...
import aws_sdk_chime_sdk_voice.errors.unprocessable_entity_exception
...
import aws_sdk_chime_sdk_voice.types.voice_tone_analysis_task
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_chime_sdk_voice.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "GoneException":
            raise aws_sdk_chime_sdk_voice.errors.gone_exception.GoneException.from_json(
                data
            )
        ...
        case "UnprocessableEntityException":
            raise aws_sdk_chime_sdk_voice.errors.unprocessable_entity_exception.UnprocessableEntityException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.start_voice_tone_analysis_task_response.StartVoiceToneAnalysisTaskResponse = aws_sdk_chime_sdk_voice.types.start_voice_tone_analysis_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.start_voice_tone_analysis_task_request.StartVoiceToneAnalysisTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.start_voice_tone_analysis_task_request.serialize_json(
            input_
        )
    ).encode()
