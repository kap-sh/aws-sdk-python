"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListVoiceProfileDomains``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_voice_profile_domains_response.ListVoiceProfileDomainsResponse = aws_sdk_chime_sdk_voice.types.list_voice_profile_domains_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.list_voice_profile_domains_request.ListVoiceProfileDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/voice-profile-domains"
    params: dict[str, str] = {}
...
async def async_list_voice_profile_domains(
