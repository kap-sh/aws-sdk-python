...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_connector_emergency_calling_configuration_response.GetVoiceConnectorEmergencyCallingConfigurationResponse = aws_sdk_chime_sdk_voice.types.get_voice_connector_emergency_calling_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_voice_connector_emergency_calling_configuration_request.GetVoiceConnectorEmergencyCallingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
