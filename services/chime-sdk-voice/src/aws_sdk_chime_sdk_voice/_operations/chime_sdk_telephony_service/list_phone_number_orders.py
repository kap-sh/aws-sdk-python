...
import aws_sdk_chime_sdk_voice.types.phone_number_order_list
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.list_phone_number_orders_response.ListPhoneNumberOrdersResponse = aws_sdk_chime_sdk_voice.types.list_phone_number_orders_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.list_phone_number_orders_request.ListPhoneNumberOrdersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
