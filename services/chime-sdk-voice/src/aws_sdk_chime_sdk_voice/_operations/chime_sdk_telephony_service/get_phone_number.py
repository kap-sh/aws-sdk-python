...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_phone_number_response.GetPhoneNumberResponse = aws_sdk_chime_sdk_voice.types.get_phone_number_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_phone_number_request.GetPhoneNumberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
