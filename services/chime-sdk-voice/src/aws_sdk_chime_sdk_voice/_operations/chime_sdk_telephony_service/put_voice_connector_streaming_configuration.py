...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.put_voice_connector_streaming_configuration_response.PutVoiceConnectorStreamingConfigurationResponse = aws_sdk_chime_sdk_voice.types.put_voice_connector_streaming_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.put_voice_connector_streaming_configuration_request.PutVoiceConnectorStreamingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.put_voice_connector_streaming_configuration_request.serialize_json(
            input_
        )
    ).encode()
