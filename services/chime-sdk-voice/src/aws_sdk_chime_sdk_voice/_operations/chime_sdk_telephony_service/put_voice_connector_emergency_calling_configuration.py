...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_response.PutVoiceConnectorEmergencyCallingConfigurationResponse = aws_sdk_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_request.PutVoiceConnectorEmergencyCallingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_request.serialize_json(
            input_
        )
    ).encode()
