...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_voice.types.get_voice_connector_group_response.GetVoiceConnectorGroupResponse = aws_sdk_chime_sdk_voice.types.get_voice_connector_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_voice.types.get_voice_connector_group_request.GetVoiceConnectorGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
