...
class ChimeSDKVoiceError(Exception):
    """Base class for all ChimeSDKVoice service errors."""


class ServiceError(ChimeSDKVoiceError):
...
class SerializationError(ChimeSDKVoiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ChimeSDKVoiceError):
...
class WaiterFailedError(ChimeSDKVoiceError):
...
class WaiterTimeoutError(ChimeSDKVoiceError):
