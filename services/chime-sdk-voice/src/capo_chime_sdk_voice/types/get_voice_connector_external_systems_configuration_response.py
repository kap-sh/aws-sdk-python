...
class GetVoiceConnectorExternalSystemsConfigurationResponse(TypedDict, closed=True):
    external_systems_configuration: NotRequired[
        "capo_chime_sdk_voice.types.external_systems_configuration.ExternalSystemsConfiguration"
    ]
...
def serialize_json(
    ...
    if "external_systems_configuration" in value:
        ...
        out["ExternalSystemsConfiguration"] = (
            capo_chime_sdk_voice.types.external_systems_configuration.serialize_json(
...
def deserialize_json(
    ...
    if "ExternalSystemsConfiguration" in data:
        ...
        out["external_systems_configuration"] = (
            capo_chime_sdk_voice.types.external_systems_configuration.deserialize_json(
