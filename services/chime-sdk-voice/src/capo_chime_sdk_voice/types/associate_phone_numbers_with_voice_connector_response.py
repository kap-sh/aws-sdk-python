"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#AssociatePhoneNumbersWithVoiceConnectorResponse``."""
...
class AssociatePhoneNumbersWithVoiceConnectorResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: AssociatePhoneNumbersWithVoiceConnectorResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> AssociatePhoneNumbersWithVoiceConnectorResponse:
    out: AssociatePhoneNumbersWithVoiceConnectorResponse = {}  # type: ignore[typeddict-item]
