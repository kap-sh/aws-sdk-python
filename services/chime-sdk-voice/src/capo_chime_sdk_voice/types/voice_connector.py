...
class VoiceConnector(TypedDict, closed=True):
    ...
    name: NotRequired[
        "capo_chime_sdk_voice.types.voice_connector_name.VoiceConnectorName"
    ]
    """<p>The Voice Connector's name.</p>"""
    outbound_host_name: NotRequired["capo_chime_sdk_voice.types.string.String"]
    """<p>The outbound host name for the Voice Connector.</p>"""
    require_encryption: NotRequired["capo_chime_sdk_voice.types.boolean.Boolean"]
    ...
    integration_type: NotRequired[
        "capo_chime_sdk_voice.types.voice_connector_integration_type.VoiceConnectorIntegrationType"
    ]
...
def serialize_json(value: VoiceConnector) -> dict:
    ...
    if "aws_region" in value:
        ...
        out["AwsRegion"] = (
            capo_chime_sdk_voice.types.voice_connector_aws_region.serialize_json(
                value["aws_region"]
            )
        )
    if "name" in value:
    ...
    if "integration_type" in value:
        ...
        out["IntegrationType"] = (
            capo_chime_sdk_voice.types.voice_connector_integration_type.serialize_json(
    ...
    if "network_type" in value:
        ...
        out["NetworkType"] = capo_chime_sdk_voice.types.network_type.serialize_json(
            value["network_type"]
        )
    return out
...
def deserialize_json(data: dict) -> VoiceConnector:
    ...
    if "AwsRegion" in data:
        ...
        out["aws_region"] = (
            capo_chime_sdk_voice.types.voice_connector_aws_region.deserialize_json(
                data["AwsRegion"]
            )
        )
    if "Name" in data:
    ...
    if "IntegrationType" in data:
        ...
        out["integration_type"] = (
            capo_chime_sdk_voice.types.voice_connector_integration_type.deserialize_json(
