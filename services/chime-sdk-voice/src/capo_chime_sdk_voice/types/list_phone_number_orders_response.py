"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListPhoneNumberOrdersResponse``."""
...
if TYPE_CHECKING:
    import capo_chime_sdk_voice.types.phone_number_order_list
...
class ListPhoneNumberOrdersResponse(TypedDict, closed=True):
    phone_number_orders: NotRequired[
        "capo_chime_sdk_voice.types.phone_number_order_list.PhoneNumberOrderList"
    ]
...
def serialize_json(value: ListPhoneNumberOrdersResponse) -> dict:
    ...
    if "phone_number_orders" in value:
        ...
        out["PhoneNumberOrders"] = (
            capo_chime_sdk_voice.types.phone_number_order_list.serialize_json(
...
def deserialize_json(data: dict) -> ListPhoneNumberOrdersResponse:
    ...
    if "PhoneNumberOrders" in data:
        ...
        out["phone_number_orders"] = (
            capo_chime_sdk_voice.types.phone_number_order_list.deserialize_json(
