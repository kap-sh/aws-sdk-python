"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DisassociatePhoneNumbersFromVoiceConnectorResponse``."""
...
class DisassociatePhoneNumbersFromVoiceConnectorResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DisassociatePhoneNumbersFromVoiceConnectorResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DisassociatePhoneNumbersFromVoiceConnectorResponse:
    out: DisassociatePhoneNumbersFromVoiceConnectorResponse = {}  # type: ignore[typeddict-item]
