"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#PutVoiceConnectorEmergencyCallingConfiguration``."""
...
import capo_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_request
import capo_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_response
...
) -> capo_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_response.PutVoiceConnectorEmergencyCallingConfigurationResponse:
    out: capo_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_response.PutVoiceConnectorEmergencyCallingConfigurationResponse = capo_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_voice_connector_emergency_calling_configuration(
