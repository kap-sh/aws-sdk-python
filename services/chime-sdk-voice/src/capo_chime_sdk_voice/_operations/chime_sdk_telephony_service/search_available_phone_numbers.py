"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#SearchAvailablePhoneNumbers``."""
...
import capo_chime_sdk_voice.types.search_available_phone_numbers_request
import capo_chime_sdk_voice.types.search_available_phone_numbers_response
...
) -> capo_chime_sdk_voice.types.search_available_phone_numbers_response.SearchAvailablePhoneNumbersResponse:
    out: capo_chime_sdk_voice.types.search_available_phone_numbers_response.SearchAvailablePhoneNumbersResponse = capo_chime_sdk_voice.types.search_available_phone_numbers_response.deserialize_json(
