"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceConnectorTerminationHealth``."""
...
import capo_chime_sdk_voice.types.get_voice_connector_termination_health_request
import capo_chime_sdk_voice.types.get_voice_connector_termination_health_response
import capo_chime_sdk_voice.types.termination_health
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_voice_connector_termination_health_response.GetVoiceConnectorTerminationHealthResponse = capo_chime_sdk_voice.types.get_voice_connector_termination_health_response.deserialize_json(
...
async def async_get_voice_connector_termination_health(
