"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetPhoneNumber``."""
...
import capo_chime_sdk_voice.types.get_phone_number_request
import capo_chime_sdk_voice.types.get_phone_number_response
...
) -> capo_chime_sdk_voice.types.get_phone_number_response.GetPhoneNumberResponse:
    out: capo_chime_sdk_voice.types.get_phone_number_response.GetPhoneNumberResponse = (
        capo_chime_sdk_voice.types.get_phone_number_response.deserialize_json(
...
async def async_get_phone_number(
