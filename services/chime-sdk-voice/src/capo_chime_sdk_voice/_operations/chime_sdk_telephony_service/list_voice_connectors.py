"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListVoiceConnectors``."""
...
import capo_chime_sdk_voice.types.list_voice_connectors_request
import capo_chime_sdk_voice.types.list_voice_connectors_response
...
) -> capo_chime_sdk_voice.types.list_voice_connectors_response.ListVoiceConnectorsResponse:
    out: capo_chime_sdk_voice.types.list_voice_connectors_response.ListVoiceConnectorsResponse = capo_chime_sdk_voice.types.list_voice_connectors_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/voice-connectors"
    params: dict[str, str] = {}
...
async def async_list_voice_connectors(
