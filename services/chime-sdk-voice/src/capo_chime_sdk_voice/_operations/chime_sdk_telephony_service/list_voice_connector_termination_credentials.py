"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListVoiceConnectorTerminationCredentials``."""
...
import capo_chime_sdk_voice.types.list_voice_connector_termination_credentials_request
import capo_chime_sdk_voice.types.list_voice_connector_termination_credentials_response
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.list_voice_connector_termination_credentials_response.ListVoiceConnectorTerminationCredentialsResponse = capo_chime_sdk_voice.types.list_voice_connector_termination_credentials_response.deserialize_json(
...
async def async_list_voice_connector_termination_credentials(
