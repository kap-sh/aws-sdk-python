"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#UpdateVoiceConnector``."""
...
import capo_chime_sdk_voice.types.update_voice_connector_request
import capo_chime_sdk_voice.types.update_voice_connector_response
...
) -> capo_chime_sdk_voice.types.update_voice_connector_response.UpdateVoiceConnectorResponse:
    out: capo_chime_sdk_voice.types.update_voice_connector_response.UpdateVoiceConnectorResponse = capo_chime_sdk_voice.types.update_voice_connector_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/voice-connectors/{VoiceConnectorId}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.update_voice_connector_request.serialize_json(input_)
    ).encode()
...
async def async_update_voice_connector(
