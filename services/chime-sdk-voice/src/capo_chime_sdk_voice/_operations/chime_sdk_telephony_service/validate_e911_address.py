"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ValidateE911Address``."""
...
import capo_chime_sdk_voice.types.validate_e911_address_request
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.validate_e911_address_response.ValidateE911AddressResponse = capo_chime_sdk_voice.types.validate_e911_address_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/emergency-calling/address"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.validate_e911_address_request.serialize_json(input_)
    ).encode()
...
async def async_validate_e911_address(
