"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetProxySession``."""
...
import capo_chime_sdk_voice.types.get_proxy_session_request
import capo_chime_sdk_voice.types.get_proxy_session_response
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_proxy_session_response.GetProxySessionResponse = capo_chime_sdk_voice.types.get_proxy_session_response.deserialize_json(
...
async def async_get_proxy_session(
