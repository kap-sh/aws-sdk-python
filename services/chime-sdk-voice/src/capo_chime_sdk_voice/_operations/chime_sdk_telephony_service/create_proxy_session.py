"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#CreateProxySession``."""
...
import capo_chime_sdk_voice.types.create_proxy_session_request
import capo_chime_sdk_voice.types.create_proxy_session_response
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.create_proxy_session_response.CreateProxySessionResponse = capo_chime_sdk_voice.types.create_proxy_session_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/voice-connectors/{VoiceConnectorId}/proxy-sessions"
    )
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.create_proxy_session_request.serialize_json(input_)
    ).encode()
...
async def async_create_proxy_session(
