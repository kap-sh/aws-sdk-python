"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DeleteVoiceConnectorGroup``."""
...
import capo_chime_sdk_voice.types.delete_voice_connector_group_request
...
async def async_delete_voice_connector_group(
