"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#UpdateVoiceConnectorGroup``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.update_voice_connector_group_response.UpdateVoiceConnectorGroupResponse = capo_chime_sdk_voice.types.update_voice_connector_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.update_voice_connector_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_voice_connector_group(
