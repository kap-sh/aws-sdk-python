"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#PutVoiceConnectorLoggingConfiguration``."""
...
import capo_chime_sdk_voice.types.put_voice_connector_logging_configuration_request
import capo_chime_sdk_voice.types.put_voice_connector_logging_configuration_response
...
) -> capo_chime_sdk_voice.types.put_voice_connector_logging_configuration_response.PutVoiceConnectorLoggingConfigurationResponse:
    out: capo_chime_sdk_voice.types.put_voice_connector_logging_configuration_response.PutVoiceConnectorLoggingConfigurationResponse = capo_chime_sdk_voice.types.put_voice_connector_logging_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.put_voice_connector_logging_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_voice_connector_logging_configuration(
