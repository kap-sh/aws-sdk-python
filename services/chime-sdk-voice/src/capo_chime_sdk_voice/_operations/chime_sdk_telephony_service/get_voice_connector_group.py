"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceConnectorGroup``."""
...
import capo_chime_sdk_voice.types.get_voice_connector_group_request
import capo_chime_sdk_voice.types.get_voice_connector_group_response
...
) -> capo_chime_sdk_voice.types.get_voice_connector_group_response.GetVoiceConnectorGroupResponse:
    out: capo_chime_sdk_voice.types.get_voice_connector_group_response.GetVoiceConnectorGroupResponse = capo_chime_sdk_voice.types.get_voice_connector_group_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/voice-connector-groups/{VoiceConnectorGroupId}"
    url = url.replace(
...
async def async_get_voice_connector_group(
