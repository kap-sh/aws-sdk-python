"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListAvailableVoiceConnectorRegions``."""
...
import capo_chime_sdk_voice.types.list_available_voice_connector_regions_response
...
) -> capo_chime_sdk_voice.types.list_available_voice_connector_regions_response.ListAvailableVoiceConnectorRegionsResponse:
    out: capo_chime_sdk_voice.types.list_available_voice_connector_regions_response.ListAvailableVoiceConnectorRegionsResponse = capo_chime_sdk_voice.types.list_available_voice_connector_regions_response.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/voice-connector-regions"
    params: dict[str, str] = {}
...
async def async_list_available_voice_connector_regions(
