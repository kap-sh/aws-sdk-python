"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DeleteProxySession``."""
...
import capo_chime_sdk_voice.types.delete_proxy_session_request
...
async def async_delete_proxy_session(
