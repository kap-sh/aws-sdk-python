"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceConnectorLoggingConfiguration``."""
...
import capo_chime_sdk_voice.types.get_voice_connector_logging_configuration_request
import capo_chime_sdk_voice.types.get_voice_connector_logging_configuration_response
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_voice_connector_logging_configuration_response.GetVoiceConnectorLoggingConfigurationResponse = capo_chime_sdk_voice.types.get_voice_connector_logging_configuration_response.deserialize_json(
...
async def async_get_voice_connector_logging_configuration(
