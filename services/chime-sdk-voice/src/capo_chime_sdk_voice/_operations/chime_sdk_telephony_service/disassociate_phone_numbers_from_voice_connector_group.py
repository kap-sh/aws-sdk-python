"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DisassociatePhoneNumbersFromVoiceConnectorGroup``."""
...
import capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_request
import capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_response
...
) -> capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_response.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse:
    out: capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_response.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse = capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["voice_connector_group_id"]), safe=""),
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_phone_numbers_from_voice_connector_group(
