"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#UntagResource``."""
...
import capo_chime_sdk_voice.types.tag_key_list
import capo_chime_sdk_voice.types.untag_resource_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.untag_resource_request.serialize_json(input_)
    ).encode()
