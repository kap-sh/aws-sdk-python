"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListVoiceProfiles``."""
...
import capo_chime_sdk_voice.types.list_voice_profiles_request
import capo_chime_sdk_voice.types.list_voice_profiles_response
...
) -> capo_chime_sdk_voice.types.list_voice_profiles_response.ListVoiceProfilesResponse:
    out: capo_chime_sdk_voice.types.list_voice_profiles_response.ListVoiceProfilesResponse = capo_chime_sdk_voice.types.list_voice_profiles_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "voice_profile_domain_id" in input_:
        params["voice-profile-domain-id"] = str(input_["voice_profile_domain_id"])
...
async def async_list_voice_profiles(
