"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#BatchDeletePhoneNumber``."""
...
import capo_chime_sdk_voice.types.batch_delete_phone_number_request
import capo_chime_sdk_voice.types.batch_delete_phone_number_response
import capo_chime_sdk_voice.types.non_empty_string_list
...
) -> capo_chime_sdk_voice.types.batch_delete_phone_number_response.BatchDeletePhoneNumberResponse:
    out: capo_chime_sdk_voice.types.batch_delete_phone_number_response.BatchDeletePhoneNumberResponse = capo_chime_sdk_voice.types.batch_delete_phone_number_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/phone-numbers?operation=batch-delete"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.batch_delete_phone_number_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_delete_phone_number(
