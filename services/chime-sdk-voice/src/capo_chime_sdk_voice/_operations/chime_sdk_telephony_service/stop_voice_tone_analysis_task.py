"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#StopVoiceToneAnalysisTask``."""
...
import capo_chime_sdk_voice.types.stop_voice_tone_analysis_task_request
