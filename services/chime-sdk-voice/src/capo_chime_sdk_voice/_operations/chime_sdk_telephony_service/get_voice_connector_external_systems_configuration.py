"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceConnectorExternalSystemsConfiguration``."""
...
import capo_chime_sdk_voice.types.get_voice_connector_external_systems_configuration_request
import capo_chime_sdk_voice.types.get_voice_connector_external_systems_configuration_response
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_voice_connector_external_systems_configuration_response.GetVoiceConnectorExternalSystemsConfigurationResponse = capo_chime_sdk_voice.types.get_voice_connector_external_systems_configuration_response.deserialize_json(
...
async def async_get_voice_connector_external_systems_configuration(
