"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#CreatePhoneNumberOrder``."""
...
import capo_chime_sdk_voice.types.create_phone_number_order_request
import capo_chime_sdk_voice.types.create_phone_number_order_response
...
) -> capo_chime_sdk_voice.types.create_phone_number_order_response.CreatePhoneNumberOrderResponse:
    out: capo_chime_sdk_voice.types.create_phone_number_order_response.CreatePhoneNumberOrderResponse = capo_chime_sdk_voice.types.create_phone_number_order_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/phone-number-orders"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.create_phone_number_order_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_phone_number_order(
