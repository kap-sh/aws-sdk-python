"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DeleteSipMediaApplication``."""
...
import capo_chime_sdk_voice.types.delete_sip_media_application_request
...
async def async_delete_sip_media_application(
