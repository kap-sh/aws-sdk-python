"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetSipMediaApplication``."""
...
import capo_chime_sdk_voice.types.get_sip_media_application_request
import capo_chime_sdk_voice.types.get_sip_media_application_response
...
) -> capo_chime_sdk_voice.types.get_sip_media_application_response.GetSipMediaApplicationResponse:
    out: capo_chime_sdk_voice.types.get_sip_media_application_response.GetSipMediaApplicationResponse = capo_chime_sdk_voice.types.get_sip_media_application_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sip-media-applications/{SipMediaApplicationId}"
    url = url.replace(
...
async def async_get_sip_media_application(
