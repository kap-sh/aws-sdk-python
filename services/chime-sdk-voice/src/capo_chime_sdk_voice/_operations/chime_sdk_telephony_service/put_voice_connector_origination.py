"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#PutVoiceConnectorOrigination``."""
...
import capo_chime_sdk_voice.types.put_voice_connector_origination_request
import capo_chime_sdk_voice.types.put_voice_connector_origination_response
...
) -> capo_chime_sdk_voice.types.put_voice_connector_origination_response.PutVoiceConnectorOriginationResponse:
    out: capo_chime_sdk_voice.types.put_voice_connector_origination_response.PutVoiceConnectorOriginationResponse = capo_chime_sdk_voice.types.put_voice_connector_origination_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/voice-connectors/{VoiceConnectorId}/origination"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.put_voice_connector_origination_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_voice_connector_origination(
