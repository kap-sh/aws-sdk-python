"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListProxySessions``."""
...
import capo_chime_sdk_voice.types.list_proxy_sessions_request
import capo_chime_sdk_voice.types.list_proxy_sessions_response
import capo_chime_sdk_voice.types.proxy_session_status
import capo_chime_sdk_voice.types.proxy_sessions
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.list_proxy_sessions_response.ListProxySessionsResponse = capo_chime_sdk_voice.types.list_proxy_sessions_response.deserialize_json(
...
async def async_list_proxy_sessions(
