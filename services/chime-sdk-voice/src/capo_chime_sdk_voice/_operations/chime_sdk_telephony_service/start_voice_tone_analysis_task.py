"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#StartVoiceToneAnalysisTask``."""
...
import capo_chime_sdk_voice.errors.conflict_exception
...
import capo_chime_sdk_voice.errors.unprocessable_entity_exception
import capo_chime_sdk_voice.types.language_code
import capo_chime_sdk_voice.types.start_voice_tone_analysis_task_request
import capo_chime_sdk_voice.types.start_voice_tone_analysis_task_response
import capo_chime_sdk_voice.types.voice_tone_analysis_task
from capo_chime_sdk_voice._protocol.errors import parse_error_metadata_json
from capo_chime_sdk_voice._rule_engine._endpoint_rule_set import EndpointParams, resolve
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_chime_sdk_voice.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ResourceLimitExceededException":
            raise capo_chime_sdk_voice.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_json(
                data
            )
        ...
        case "UnprocessableEntityException":
            raise capo_chime_sdk_voice.errors.unprocessable_entity_exception.UnprocessableEntityException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.start_voice_tone_analysis_task_response.StartVoiceToneAnalysisTaskResponse = capo_chime_sdk_voice.types.start_voice_tone_analysis_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.start_voice_tone_analysis_task_request.serialize_json(
            input_
        )
    ).encode()
