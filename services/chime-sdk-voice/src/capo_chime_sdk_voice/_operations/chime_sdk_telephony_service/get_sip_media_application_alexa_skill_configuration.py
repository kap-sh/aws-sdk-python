"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetSipMediaApplicationAlexaSkillConfiguration``."""
...
import capo_chime_sdk_voice.types.get_sip_media_application_alexa_skill_configuration_request
import capo_chime_sdk_voice.types.get_sip_media_application_alexa_skill_configuration_response
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_sip_media_application_alexa_skill_configuration_response.GetSipMediaApplicationAlexaSkillConfigurationResponse = capo_chime_sdk_voice.types.get_sip_media_application_alexa_skill_configuration_response.deserialize_json(
...
async def async_get_sip_media_application_alexa_skill_configuration(
