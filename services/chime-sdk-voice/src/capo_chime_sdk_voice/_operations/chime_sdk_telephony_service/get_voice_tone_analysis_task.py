"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceToneAnalysisTask``."""
...
import capo_chime_sdk_voice.types.get_voice_tone_analysis_task_request
import capo_chime_sdk_voice.types.get_voice_tone_analysis_task_response
...
) -> capo_chime_sdk_voice.types.get_voice_tone_analysis_task_response.GetVoiceToneAnalysisTaskResponse:
    out: capo_chime_sdk_voice.types.get_voice_tone_analysis_task_response.GetVoiceToneAnalysisTaskResponse = capo_chime_sdk_voice.types.get_voice_tone_analysis_task_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "is_caller" in input_:
        params["isCaller"] = str(input_["is_caller"])
