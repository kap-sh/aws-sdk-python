"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#PutVoiceConnectorProxy``."""
...
import capo_chime_sdk_voice.types.put_voice_connector_proxy_request
import capo_chime_sdk_voice.types.put_voice_connector_proxy_response
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.put_voice_connector_proxy_response.PutVoiceConnectorProxyResponse = capo_chime_sdk_voice.types.put_voice_connector_proxy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.put_voice_connector_proxy_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_voice_connector_proxy(
