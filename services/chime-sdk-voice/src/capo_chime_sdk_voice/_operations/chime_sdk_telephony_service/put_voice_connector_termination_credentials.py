"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#PutVoiceConnectorTerminationCredentials``."""
...
import capo_chime_sdk_voice.types.put_voice_connector_termination_credentials_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.put_voice_connector_termination_credentials_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_voice_connector_termination_credentials(
