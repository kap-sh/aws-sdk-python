"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DeleteVoiceProfileDomain``."""
...
import capo_chime_sdk_voice.types.delete_voice_profile_domain_request
...
async def async_delete_voice_profile_domain(
