"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#CreateVoiceConnectorGroup``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.create_voice_connector_group_response.CreateVoiceConnectorGroupResponse = capo_chime_sdk_voice.types.create_voice_connector_group_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/voice-connector-groups"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.create_voice_connector_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_voice_connector_group(
