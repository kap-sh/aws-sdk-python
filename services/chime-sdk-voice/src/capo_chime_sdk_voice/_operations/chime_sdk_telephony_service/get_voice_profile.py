"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceProfile``."""
...
import capo_chime_sdk_voice.types.get_voice_profile_request
import capo_chime_sdk_voice.types.get_voice_profile_response
...
) -> capo_chime_sdk_voice.types.get_voice_profile_response.GetVoiceProfileResponse:
    out: capo_chime_sdk_voice.types.get_voice_profile_response.GetVoiceProfileResponse = capo_chime_sdk_voice.types.get_voice_profile_response.deserialize_json(
...
async def async_get_voice_profile(
