"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#AssociatePhoneNumbersWithVoiceConnector``."""
...
import capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_request
import capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_response
...
) -> capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_response.AssociatePhoneNumbersWithVoiceConnectorResponse:
    out: capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_response.AssociatePhoneNumbersWithVoiceConnectorResponse = capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_phone_numbers_with_voice_connector(
