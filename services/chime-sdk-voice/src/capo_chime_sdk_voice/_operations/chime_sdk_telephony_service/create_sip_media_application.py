"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#CreateSipMediaApplication``."""
...
import capo_chime_sdk_voice.types.create_sip_media_application_request
import capo_chime_sdk_voice.types.create_sip_media_application_response
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.create_sip_media_application_response.CreateSipMediaApplicationResponse = capo_chime_sdk_voice.types.create_sip_media_application_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sip-media-applications"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.create_sip_media_application_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_sip_media_application(
