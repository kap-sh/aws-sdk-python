"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#UpdateProxySession``."""
...
import capo_chime_sdk_voice.types.update_proxy_session_request
import capo_chime_sdk_voice.types.update_proxy_session_response
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.update_proxy_session_response.UpdateProxySessionResponse = capo_chime_sdk_voice.types.update_proxy_session_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{ProxySessionId}", quote(str(input_["proxy_session_id"]), safe="")
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.update_proxy_session_request.serialize_json(input_)
    ).encode()
...
async def async_update_proxy_session(
