"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#UpdateGlobalSettings``."""
...
import capo_chime_sdk_voice.types.update_global_settings_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.update_global_settings_request.serialize_json(input_)
    ).encode()
