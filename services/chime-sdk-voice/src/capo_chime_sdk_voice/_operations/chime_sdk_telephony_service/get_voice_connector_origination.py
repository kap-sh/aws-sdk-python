"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceConnectorOrigination``."""
...
import capo_chime_sdk_voice.types.get_voice_connector_origination_request
import capo_chime_sdk_voice.types.get_voice_connector_origination_response
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_voice_connector_origination_response.GetVoiceConnectorOriginationResponse = capo_chime_sdk_voice.types.get_voice_connector_origination_response.deserialize_json(
...
async def async_get_voice_connector_origination(
