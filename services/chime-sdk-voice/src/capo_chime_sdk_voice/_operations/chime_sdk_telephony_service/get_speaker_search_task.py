"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetSpeakerSearchTask``."""
...
import capo_chime_sdk_voice.types.get_speaker_search_task_request
import capo_chime_sdk_voice.types.get_speaker_search_task_response
...
) -> capo_chime_sdk_voice.types.get_speaker_search_task_response.GetSpeakerSearchTaskResponse:
    out: capo_chime_sdk_voice.types.get_speaker_search_task_response.GetSpeakerSearchTaskResponse = capo_chime_sdk_voice.types.get_speaker_search_task_response.deserialize_json(
...
async def async_get_speaker_search_task(
