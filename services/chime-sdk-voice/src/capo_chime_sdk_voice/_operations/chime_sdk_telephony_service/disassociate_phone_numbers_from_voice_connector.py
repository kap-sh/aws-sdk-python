"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DisassociatePhoneNumbersFromVoiceConnector``."""
...
import capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_request
import capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_response
...
) -> capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_response.DisassociatePhoneNumbersFromVoiceConnectorResponse:
    out: capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_response.DisassociatePhoneNumbersFromVoiceConnectorResponse = capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_phone_numbers_from_voice_connector(
