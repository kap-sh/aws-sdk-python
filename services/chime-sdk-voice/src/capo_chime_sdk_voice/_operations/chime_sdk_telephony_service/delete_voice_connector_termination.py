"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DeleteVoiceConnectorTermination``."""
...
import capo_chime_sdk_voice.types.delete_voice_connector_termination_request
...
async def async_delete_voice_connector_termination(
