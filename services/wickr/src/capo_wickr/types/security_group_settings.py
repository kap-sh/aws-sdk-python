...
class SecurityGroupSettings(TypedDict, closed=True):
    ...
    atak_package_values: NotRequired[
        "capo_wickr.types.security_group_string_list.SecurityGroupStringList"
    ]
    """<p>Configuration values for ATAK (Android Team Awareness Kit) package integration, when ATAK is enabled.</p>"""
    calling: NotRequired["capo_wickr.types.calling_settings.CallingSettings"]
    ...
    password_requirements: NotRequired[
        "capo_wickr.types.password_requirements.PasswordRequirements"
    ]
    ...
    shredder: NotRequired["capo_wickr.types.shredder_settings.ShredderSettings"]
...
def serialize_json(value: SecurityGroupSettings) -> dict:
    ...
    if "atak_package_values" in value:
        ...
        out["atakPackageValues"] = (
            capo_wickr.types.security_group_string_list.serialize_json(
    ...
    if "calling" in value:
        ...
        out["calling"] = capo_wickr.types.calling_settings.serialize_json(
            value["calling"]
        )
    ...
    if "password_requirements" in value:
        ...
        out["passwordRequirements"] = (
            capo_wickr.types.password_requirements.serialize_json(
    ...
    if "shredder" in value:
        ...
        out["shredder"] = capo_wickr.types.shredder_settings.serialize_json(
            value["shredder"]
        )
...
def deserialize_json(data: dict) -> SecurityGroupSettings:
    ...
    if "atakPackageValues" in data:
        ...
        out["atak_package_values"] = (
            capo_wickr.types.security_group_string_list.deserialize_json(
    ...
    if "passwordRequirements" in data:
        ...
        out["password_requirements"] = (
            capo_wickr.types.password_requirements.deserialize_json(
