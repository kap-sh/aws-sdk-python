"""Generated from Smithy shape ``com.amazonaws.wickr#DeleteNetwork``."""
...
def handle_response(
    ...
    out: capo_wickr.types.delete_network_response.DeleteNetworkResponse = (
        capo_wickr.types.delete_network_response.deserialize_json(
...
def delete_network(
    ...
    capo_wickr.types.delete_network_response.DeleteNetworkResponse, zapros.Response
]:
...
async def async_delete_network(
