"""Generated from Smithy shape ``com.amazonaws.wickr#UpdateUser``."""
...
def handle_response(
    ...
    out: capo_wickr.types.update_user_response.UpdateUserResponse = (
        capo_wickr.types.update_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.update_user_request.serialize_json(input_)
    ).encode()
...
def update_user(
    ...
    input_: capo_wickr.types.update_user_request.UpdateUserRequest,
) -> tuple[capo_wickr.types.update_user_response.UpdateUserResponse, zapros.Response]:
