"""Generated from Smithy shape ``com.amazonaws.wickr#CreateDataRetentionBotChallenge``."""
...
def handle_response(
    ...
    out: capo_wickr.types.create_data_retention_bot_challenge_response.CreateDataRetentionBotChallengeResponse = capo_wickr.types.create_data_retention_bot_challenge_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/networks/{networkId}/data-retention-bots/challenge"
    )
...
async def async_create_data_retention_bot_challenge(
