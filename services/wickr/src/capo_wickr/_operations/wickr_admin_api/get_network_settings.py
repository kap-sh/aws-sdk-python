"""Generated from Smithy shape ``com.amazonaws.wickr#GetNetworkSettings``."""
...
def handle_response(
    ...
    out: capo_wickr.types.get_network_settings_response.GetNetworkSettingsResponse = (
        capo_wickr.types.get_network_settings_response.deserialize_json(
