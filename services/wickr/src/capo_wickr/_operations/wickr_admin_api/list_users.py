"""Generated from Smithy shape ``com.amazonaws.wickr#ListUsers``."""
...
def handle_response(
    ...
    out: capo_wickr.types.list_users_response.ListUsersResponse = (
        capo_wickr.types.list_users_response.deserialize_json(
...
def list_users(
    ...
    input_: capo_wickr.types.list_users_request.ListUsersRequest,
) -> tuple[capo_wickr.types.list_users_response.ListUsersResponse, zapros.Response]:
