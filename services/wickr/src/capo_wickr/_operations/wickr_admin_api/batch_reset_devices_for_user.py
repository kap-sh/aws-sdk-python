"""Generated from Smithy shape ``com.amazonaws.wickr#BatchResetDevicesForUser``."""
...
def handle_response(
    ...
    out: capo_wickr.types.batch_reset_devices_for_user_response.BatchResetDevicesForUserResponse = capo_wickr.types.batch_reset_devices_for_user_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{networkId}/users/{userId}/devices"
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.batch_reset_devices_for_user_request.serialize_json(input_)
    ).encode()
...
async def async_batch_reset_devices_for_user(
