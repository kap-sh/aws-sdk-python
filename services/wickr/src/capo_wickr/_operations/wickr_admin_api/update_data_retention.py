"""Generated from Smithy shape ``com.amazonaws.wickr#UpdateDataRetention``."""
...
def handle_response(
    ...
    out: capo_wickr.types.update_data_retention_response.UpdateDataRetentionResponse = (
        capo_wickr.types.update_data_retention_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.update_data_retention_request.serialize_json(input_)
    ).encode()
