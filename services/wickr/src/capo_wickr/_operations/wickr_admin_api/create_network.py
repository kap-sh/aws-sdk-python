"""Generated from Smithy shape ``com.amazonaws.wickr#CreateNetwork``."""
...
def handle_response(
    ...
    out: capo_wickr.types.create_network_response.CreateNetworkResponse = (
        capo_wickr.types.create_network_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.create_network_request.serialize_json(input_)
    ).encode()
...
def create_network(
    ...
    capo_wickr.types.create_network_response.CreateNetworkResponse, zapros.Response
]:
