"""Generated from Smithy shape ``com.amazonaws.wickr#ListDevicesForUser``."""
...
def handle_response(
    ...
    out: capo_wickr.types.list_devices_for_user_response.ListDevicesForUserResponse = (
        capo_wickr.types.list_devices_for_user_response.deserialize_json(
...
async def async_list_devices_for_user(
