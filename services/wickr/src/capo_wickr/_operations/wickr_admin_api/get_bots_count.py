"""Generated from Smithy shape ``com.amazonaws.wickr#GetBotsCount``."""
...
def handle_response(
    ...
    out: capo_wickr.types.get_bots_count_response.GetBotsCountResponse = (
        capo_wickr.types.get_bots_count_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{networkId}/bots/count"
...
def get_bots_count(
    ...
    capo_wickr.types.get_bots_count_response.GetBotsCountResponse, zapros.Response
]:
...
async def async_get_bots_count(
