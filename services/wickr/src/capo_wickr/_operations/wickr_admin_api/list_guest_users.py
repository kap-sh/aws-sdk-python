"""Generated from Smithy shape ``com.amazonaws.wickr#ListGuestUsers``."""
...
def handle_response(
    ...
    out: capo_wickr.types.list_guest_users_response.ListGuestUsersResponse = (
        capo_wickr.types.list_guest_users_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{networkId}/guest-users"
    ...
    if "billing_period" in input_:
        params["billingPeriod"] = str(input_["billing_period"])
...
def list_guest_users(
    ...
    capo_wickr.types.list_guest_users_response.ListGuestUsersResponse, zapros.Response
]:
...
async def async_list_guest_users(
