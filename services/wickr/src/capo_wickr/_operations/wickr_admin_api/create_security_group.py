"""Generated from Smithy shape ``com.amazonaws.wickr#CreateSecurityGroup``."""
...
def handle_response(
    ...
    out: capo_wickr.types.create_security_group_response.CreateSecurityGroupResponse = (
        capo_wickr.types.create_security_group_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{networkId}/security-groups"
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.create_security_group_request.serialize_json(input_)
    ).encode()
