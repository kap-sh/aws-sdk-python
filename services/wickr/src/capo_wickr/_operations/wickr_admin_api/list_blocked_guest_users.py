"""Generated from Smithy shape ``com.amazonaws.wickr#ListBlockedGuestUsers``."""
...
def handle_response(
    ...
    out: capo_wickr.types.list_blocked_guest_users_response.ListBlockedGuestUsersResponse = capo_wickr.types.list_blocked_guest_users_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{networkId}/guest-users/blocklist"
...
async def async_list_blocked_guest_users(
