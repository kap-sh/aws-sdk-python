...
class WickrError(Exception):
    """Base class for all Wickr service errors."""


class ServiceError(WickrError):
...
class SerializationError(WickrError):
    """Raised when a value cannot be serialized."""


class DeserializationError(WickrError):
...
class WaiterFailedError(WickrError):
...
class WaiterTimeoutError(WickrError):
