...
def handle_response(
    ...
    out: aws_sdk_wickr.types.update_bot_response.UpdateBotResponse = (
        aws_sdk_wickr.types.update_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.update_bot_request.UpdateBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.update_bot_request.serialize_json(input_)
    ).encode()
...
def update_bot(
    ...
    input_: aws_sdk_wickr.types.update_bot_request.UpdateBotRequest,
) -> tuple[aws_sdk_wickr.types.update_bot_response.UpdateBotResponse, zapros.Response]:
