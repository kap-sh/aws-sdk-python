"""Generated from Smithy shape ``com.amazonaws.wickr#DeleteBot``."""
...
def handle_response(
    ...
    out: aws_sdk_wickr.types.delete_bot_response.DeleteBotResponse = (
        aws_sdk_wickr.types.delete_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.delete_bot_request.DeleteBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_bot(
    ...
    input_: aws_sdk_wickr.types.delete_bot_request.DeleteBotRequest,
) -> tuple[aws_sdk_wickr.types.delete_bot_response.DeleteBotResponse, zapros.Response]:
