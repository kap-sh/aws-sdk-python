...
def handle_response(
    ...
    out: aws_sdk_wickr.types.list_blocked_guest_users_response.ListBlockedGuestUsersResponse = aws_sdk_wickr.types.list_blocked_guest_users_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.list_blocked_guest_users_request.ListBlockedGuestUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
