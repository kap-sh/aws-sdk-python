...
def handle_response(
    ...
    out: aws_sdk_wickr.types.update_network_response.UpdateNetworkResponse = (
        aws_sdk_wickr.types.update_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.update_network_request.UpdateNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.update_network_request.serialize_json(input_)
    ).encode()
...
def update_network(
    ...
    aws_sdk_wickr.types.update_network_response.UpdateNetworkResponse, zapros.Response
]:
