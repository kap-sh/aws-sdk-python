...
def handle_response(
    ...
    out: aws_sdk_wickr.types.create_data_retention_bot_challenge_response.CreateDataRetentionBotChallengeResponse = aws_sdk_wickr.types.create_data_retention_bot_challenge_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.create_data_retention_bot_challenge_request.CreateDataRetentionBotChallengeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
