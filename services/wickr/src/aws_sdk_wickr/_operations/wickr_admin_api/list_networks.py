"""Generated from Smithy shape ``com.amazonaws.wickr#ListNetworks``."""
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.list_networks_request.ListNetworksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_networks(
    ...
    aws_sdk_wickr.types.list_networks_response.ListNetworksResponse, zapros.Response
]:
