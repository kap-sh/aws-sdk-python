...
def handle_response(
    ...
    out: aws_sdk_wickr.types.register_oidc_config_test_response.RegisterOidcConfigTestResponse = aws_sdk_wickr.types.register_oidc_config_test_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.register_oidc_config_test_request.RegisterOidcConfigTestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.register_oidc_config_test_request.serialize_json(input_)
    ).encode()
