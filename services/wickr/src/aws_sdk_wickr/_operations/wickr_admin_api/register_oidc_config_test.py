...
def build_request(
    ...
    input: aws_sdk_wickr.types.register_oidc_config_test_request.RegisterOidcConfigTestRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.register_oidc_config_test_request.serialize_json(input)
    ).encode()
