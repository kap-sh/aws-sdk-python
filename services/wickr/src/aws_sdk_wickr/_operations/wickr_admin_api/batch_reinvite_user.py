"""Generated from Smithy shape ``com.amazonaws.wickr#BatchReinviteUser``."""
...
def handle_response(
    ...
    out: aws_sdk_wickr.types.batch_reinvite_user_response.BatchReinviteUserResponse = (
        aws_sdk_wickr.types.batch_reinvite_user_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wickr.types.batch_reinvite_user_request.BatchReinviteUserRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/networks/{networkId}/users/re-invite"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.batch_reinvite_user_request.serialize_json(input)
    ).encode()
...
async def async_batch_reinvite_user(
