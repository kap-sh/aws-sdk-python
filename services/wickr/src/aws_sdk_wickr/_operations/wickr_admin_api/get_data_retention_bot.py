...
def handle_response(
    ...
    out: aws_sdk_wickr.types.get_data_retention_bot_response.GetDataRetentionBotResponse = aws_sdk_wickr.types.get_data_retention_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.get_data_retention_bot_request.GetDataRetentionBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
