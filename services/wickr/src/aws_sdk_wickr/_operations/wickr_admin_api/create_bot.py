...
def handle_response(
    ...
    out: aws_sdk_wickr.types.create_bot_response.CreateBotResponse = (
        aws_sdk_wickr.types.create_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.create_bot_request.CreateBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.create_bot_request.serialize_json(input_)
    ).encode()
...
def create_bot(
    ...
    input_: aws_sdk_wickr.types.create_bot_request.CreateBotRequest,
) -> tuple[aws_sdk_wickr.types.create_bot_response.CreateBotResponse, zapros.Response]:
