...
def handle_response(
    ...
    out: aws_sdk_wickr.types.batch_create_user_response.BatchCreateUserResponse = (
        aws_sdk_wickr.types.batch_create_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.batch_create_user_request.BatchCreateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.batch_create_user_request.serialize_json(input_)
    ).encode()
