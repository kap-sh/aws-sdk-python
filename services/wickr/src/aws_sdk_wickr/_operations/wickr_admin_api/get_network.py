...
def handle_response(
    ...
    out: aws_sdk_wickr.types.get_network_response.GetNetworkResponse = (
        aws_sdk_wickr.types.get_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.get_network_request.GetNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_network(
    ...
    aws_sdk_wickr.types.get_network_response.GetNetworkResponse, zapros.Response
]:
