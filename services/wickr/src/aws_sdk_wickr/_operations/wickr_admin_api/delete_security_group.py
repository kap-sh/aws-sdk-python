"""Generated from Smithy shape ``com.amazonaws.wickr#DeleteSecurityGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_wickr.types.delete_security_group_response.DeleteSecurityGroupResponse = aws_sdk_wickr.types.delete_security_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.delete_security_group_request.DeleteSecurityGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
