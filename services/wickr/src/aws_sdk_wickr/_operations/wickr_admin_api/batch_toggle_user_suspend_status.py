...
def handle_response(
    ...
    out: aws_sdk_wickr.types.batch_toggle_user_suspend_status_response.BatchToggleUserSuspendStatusResponse = aws_sdk_wickr.types.batch_toggle_user_suspend_status_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wickr.types.batch_toggle_user_suspend_status_request.BatchToggleUserSuspendStatusRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "suspend" in input:
        params["suspend"] = str(input["suspend"])
