...
def handle_response(
    ...
    out: aws_sdk_wickr.types.create_data_retention_bot_response.CreateDataRetentionBotResponse = aws_sdk_wickr.types.create_data_retention_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.create_data_retention_bot_request.CreateDataRetentionBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
