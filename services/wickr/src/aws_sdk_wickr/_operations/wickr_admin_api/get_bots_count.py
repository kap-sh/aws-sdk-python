...
def handle_response(
    ...
    out: aws_sdk_wickr.types.get_bots_count_response.GetBotsCountResponse = (
        aws_sdk_wickr.types.get_bots_count_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.get_bots_count_request.GetBotsCountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_bots_count(
    ...
    aws_sdk_wickr.types.get_bots_count_response.GetBotsCountResponse, zapros.Response
]:
