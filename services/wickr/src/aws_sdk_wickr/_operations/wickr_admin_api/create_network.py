...
def handle_response(
    ...
    out: aws_sdk_wickr.types.create_network_response.CreateNetworkResponse = (
        aws_sdk_wickr.types.create_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.create_network_request.CreateNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.create_network_request.serialize_json(input_)
    ).encode()
...
def create_network(
    ...
    aws_sdk_wickr.types.create_network_response.CreateNetworkResponse, zapros.Response
]:
