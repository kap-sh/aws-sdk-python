"""Generated from Smithy shape ``com.amazonaws.wickr#GetBot``."""
...
def handle_response(
    ...
    out: aws_sdk_wickr.types.get_bot_response.GetBotResponse = (
        aws_sdk_wickr.types.get_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.get_bot_request.GetBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{networkId}/bots/{botId}"
...
def get_bot(
    options: OperationOptions, input_: aws_sdk_wickr.types.get_bot_request.GetBotRequest
) -> tuple[aws_sdk_wickr.types.get_bot_response.GetBotResponse, zapros.Response]:
