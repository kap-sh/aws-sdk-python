...
def handle_response(
    ...
    out: aws_sdk_wickr.types.get_network_settings_response.GetNetworkSettingsResponse = aws_sdk_wickr.types.get_network_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.get_network_settings_request.GetNetworkSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
