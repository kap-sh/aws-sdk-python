"""Generated from Smithy shape ``com.amazonaws.wickr#GetOpentdfConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_wickr.types.get_opentdf_config_response.GetOpentdfConfigResponse = (
        aws_sdk_wickr.types.get_opentdf_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.get_opentdf_config_request.GetOpentdfConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_opentdf_config(
