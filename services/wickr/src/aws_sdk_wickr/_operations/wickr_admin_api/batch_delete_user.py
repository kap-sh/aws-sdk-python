"""Generated from Smithy shape ``com.amazonaws.wickr#BatchDeleteUser``."""
...
def handle_response(
    ...
    out: aws_sdk_wickr.types.batch_delete_user_response.BatchDeleteUserResponse = (
        aws_sdk_wickr.types.batch_delete_user_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wickr.types.batch_delete_user_request.BatchDeleteUserRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/networks/{networkId}/users/batch-delete"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.batch_delete_user_request.serialize_json(input)
    ).encode()
...
async def async_batch_delete_user(
