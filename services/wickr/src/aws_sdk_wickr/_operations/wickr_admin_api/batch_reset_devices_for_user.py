...
def build_request(
    ...
    input: aws_sdk_wickr.types.batch_reset_devices_for_user_request.BatchResetDevicesForUserRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.batch_reset_devices_for_user_request.serialize_json(input)
    ).encode()
