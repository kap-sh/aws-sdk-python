...
def handle_response(
    ...
    out: aws_sdk_wickr.types.batch_reset_devices_for_user_response.BatchResetDevicesForUserResponse = aws_sdk_wickr.types.batch_reset_devices_for_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.batch_reset_devices_for_user_request.BatchResetDevicesForUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.batch_reset_devices_for_user_request.serialize_json(input_)
    ).encode()
