...
def handle_response(
    ...
    out: aws_sdk_wickr.types.list_security_group_users_response.ListSecurityGroupUsersResponse = aws_sdk_wickr.types.list_security_group_users_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.list_security_group_users_request.ListSecurityGroupUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
