...
def handle_response(
    ...
    out: aws_sdk_wickr.types.create_security_group_response.CreateSecurityGroupResponse = aws_sdk_wickr.types.create_security_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.create_security_group_request.CreateSecurityGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.create_security_group_request.serialize_json(input_)
    ).encode()
