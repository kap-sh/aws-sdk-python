...
def build_request(
    ...
    input_: aws_sdk_wickr.types.update_network_settings_request.UpdateNetworkSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.update_network_settings_request.serialize_json(input_)
    ).encode()
