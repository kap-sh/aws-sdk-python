...
def build_request(
    ...
    input: aws_sdk_wickr.types.update_network_settings_request.UpdateNetworkSettingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.update_network_settings_request.serialize_json(input)
    ).encode()
