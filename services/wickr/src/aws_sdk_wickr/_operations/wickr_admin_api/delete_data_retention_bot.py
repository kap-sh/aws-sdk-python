...
def handle_response(
    ...
    out: aws_sdk_wickr.types.delete_data_retention_bot_response.DeleteDataRetentionBotResponse = aws_sdk_wickr.types.delete_data_retention_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.delete_data_retention_bot_request.DeleteDataRetentionBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
