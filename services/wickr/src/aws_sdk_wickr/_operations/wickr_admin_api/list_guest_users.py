...
def handle_response(
    ...
    out: aws_sdk_wickr.types.list_guest_users_response.ListGuestUsersResponse = (
        aws_sdk_wickr.types.list_guest_users_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.list_guest_users_request.ListGuestUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
