...
def handle_response(
    ...
    out: aws_sdk_wickr.types.get_users_count_response.GetUsersCountResponse = (
        aws_sdk_wickr.types.get_users_count_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.get_users_count_request.GetUsersCountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_users_count(
    ...
    aws_sdk_wickr.types.get_users_count_response.GetUsersCountResponse, zapros.Response
]:
