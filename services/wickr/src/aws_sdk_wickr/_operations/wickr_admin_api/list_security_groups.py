...
def handle_response(
    ...
    out: aws_sdk_wickr.types.list_security_groups_response.ListSecurityGroupsResponse = aws_sdk_wickr.types.list_security_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.list_security_groups_request.ListSecurityGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
