"""Generated from Smithy shape ``com.amazonaws.wickr#GetGuestUserHistoryCount``."""
...
def handle_response(
    ...
    out: aws_sdk_wickr.types.get_guest_user_history_count_response.GetGuestUserHistoryCountResponse = aws_sdk_wickr.types.get_guest_user_history_count_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.get_guest_user_history_count_request.GetGuestUserHistoryCountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{networkId}/guest-users/count"
...
async def async_get_guest_user_history_count(
