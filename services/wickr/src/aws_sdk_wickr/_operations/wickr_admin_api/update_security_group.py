...
def build_request(
    ...
    input: aws_sdk_wickr.types.update_security_group_request.UpdateSecurityGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.update_security_group_request.serialize_json(input)
    ).encode()
