...
def handle_response(
    ...
    out: aws_sdk_wickr.types.update_data_retention_response.UpdateDataRetentionResponse = aws_sdk_wickr.types.update_data_retention_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.update_data_retention_request.UpdateDataRetentionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.update_data_retention_request.serialize_json(input_)
    ).encode()
