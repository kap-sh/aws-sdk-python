...
def build_request(
    ...
    input: aws_sdk_wickr.types.update_data_retention_request.UpdateDataRetentionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.update_data_retention_request.serialize_json(input)
    ).encode()
