...
def handle_response(
    ...
    out: aws_sdk_wickr.types.list_bots_response.ListBotsResponse = (
        aws_sdk_wickr.types.list_bots_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wickr.types.list_bots_request.ListBotsRequest,
) -> zapros.Request:
...
def list_bots(
    ...
    input: aws_sdk_wickr.types.list_bots_request.ListBotsRequest,
) -> tuple[aws_sdk_wickr.types.list_bots_response.ListBotsResponse, zapros.Response]:
