...
def build_request(
    ...
    input_: aws_sdk_wickr.types.batch_lookup_user_uname_request.BatchLookupUserUnameRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wickr.types.batch_lookup_user_uname_request.serialize_json(input_)
    ).encode()
