...
def handle_response(
    ...
    out: aws_sdk_wickr.types.delete_network_response.DeleteNetworkResponse = (
        aws_sdk_wickr.types.delete_network_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wickr.types.delete_network_request.DeleteNetworkRequest,
) -> zapros.Request:
...
def delete_network(
    ...
    aws_sdk_wickr.types.delete_network_response.DeleteNetworkResponse, zapros.Response
]:
