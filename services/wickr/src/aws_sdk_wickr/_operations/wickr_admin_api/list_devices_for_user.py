...
import aws_sdk_wickr.types.devices
...
def handle_response(
    ...
    out: aws_sdk_wickr.types.list_devices_for_user_response.ListDevicesForUserResponse = aws_sdk_wickr.types.list_devices_for_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wickr.types.list_devices_for_user_request.ListDevicesForUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
