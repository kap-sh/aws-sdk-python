...
class ListDevicesForUserResponse(TypedDict):
    ...
    devices: "aws_sdk_wickr.types.devices.Devices"
...
def serialize_json(value: ListDevicesForUserResponse) -> dict:
    ...
    out["devices"] = aws_sdk_wickr.types.devices.serialize_json(value["devices"])
    return out
...
def deserialize_json(data: dict) -> ListDevicesForUserResponse:
    ...
    if "devices" in data:
        ...
        out["devices"] = aws_sdk_wickr.types.devices.deserialize_json(data["devices"])
    else:
