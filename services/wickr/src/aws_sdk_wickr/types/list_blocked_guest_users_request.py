"""Generated from Smithy shape ``com.amazonaws.wickr#ListBlockedGuestUsersRequest``."""
...
class ListBlockedGuestUsersRequest(TypedDict, closed=True):
    ...
    admin: NotRequired["aws_sdk_wickr.types.generic_string.GenericString"]
...
# --- restJson1 ser/de ---
def serialize_json(value: ListBlockedGuestUsersRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListBlockedGuestUsersRequest:
    out: ListBlockedGuestUsersRequest = {}  # type: ignore[typeddict-item]
    return out
