...
class RegisterOidcConfigTestResponse(TypedDict):
    ...
    response_types_supported: NotRequired["aws_sdk_wickr.types.string_list.StringList"]
    """<p>The OAuth response types supported by the OIDC provider.</p>"""
    scopes_supported: NotRequired["aws_sdk_wickr.types.string_list.StringList"]
    """<p>The OAuth scopes supported by the OIDC provider.</p>"""
    issuer: NotRequired["aws_sdk_wickr.types.generic_string.GenericString"]
    ...
    end_session_endpoint: NotRequired[
        "aws_sdk_wickr.types.generic_string.GenericString"
    ]
    """<p>The end session endpoint URL for logging out users from the OIDC provider.</p>"""
    logout_endpoint: NotRequired["aws_sdk_wickr.types.generic_string.GenericString"]
    """<p>The logout endpoint URL for terminating user sessions.</p>"""
    grant_types_supported: NotRequired["aws_sdk_wickr.types.string_list.StringList"]
    """<p>The OAuth grant types supported by the OIDC provider.</p>"""
    revocation_endpoint: NotRequired["aws_sdk_wickr.types.generic_string.GenericString"]
    """<p>The token revocation endpoint URL for invalidating tokens.</p>"""
    token_endpoint_auth_methods_supported: NotRequired[
        "aws_sdk_wickr.types.string_list.StringList"
    ]
...
def serialize_json(value: RegisterOidcConfigTestResponse) -> dict:
    ...
    if "response_types_supported" in value:
        ...
        out["responseTypesSupported"] = aws_sdk_wickr.types.string_list.serialize_json(
            value["response_types_supported"]
        )
    if "scopes_supported" in value:
        import aws_sdk_wickr.types.string_list

        out["scopesSupported"] = aws_sdk_wickr.types.string_list.serialize_json(
    ...
    if "grant_types_supported" in value:
        ...
        out["grantTypesSupported"] = aws_sdk_wickr.types.string_list.serialize_json(
    ...
    if "token_endpoint_auth_methods_supported" in value:
        ...
        out["tokenEndpointAuthMethodsSupported"] = (
            aws_sdk_wickr.types.string_list.serialize_json(
...
def deserialize_json(data: dict) -> RegisterOidcConfigTestResponse:
    ...
    if "responseTypesSupported" in data:
        ...
        out["response_types_supported"] = (
            aws_sdk_wickr.types.string_list.deserialize_json(
    ...
    if "scopesSupported" in data:
        ...
        out["scopes_supported"] = aws_sdk_wickr.types.string_list.deserialize_json(
    ...
    if "grantTypesSupported" in data:
        ...
        out["grant_types_supported"] = aws_sdk_wickr.types.string_list.deserialize_json(
