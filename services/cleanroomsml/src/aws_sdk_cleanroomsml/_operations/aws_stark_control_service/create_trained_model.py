...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalServiceException":
            ...
            raise aws_sdk_cleanroomsml.errors.internal_service_exception.InternalServiceException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.create_trained_model_response.CreateTrainedModelResponse = aws_sdk_cleanroomsml.types.create_trained_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.create_trained_model_request.CreateTrainedModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.create_trained_model_request.serialize_json(input_)
    ).encode()
