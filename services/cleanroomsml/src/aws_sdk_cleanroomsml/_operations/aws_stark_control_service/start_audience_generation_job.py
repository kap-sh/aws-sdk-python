"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#StartAudienceGenerationJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.start_audience_generation_job_response.StartAudienceGenerationJobResponse:
    import aws_sdk_cleanroomsml.types.start_audience_generation_job_response
    out: aws_sdk_cleanroomsml.types.start_audience_generation_job_response.StartAudienceGenerationJobResponse = aws_sdk_cleanroomsml.types.start_audience_generation_job_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.start_audience_generation_job_request.StartAudienceGenerationJobRequest) -> zapros.Request:
    ...
    import aws_sdk_cleanroomsml.types.start_audience_generation_job_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.start_audience_generation_job_request.serialize_json(input)).encode()
...
def start_audience_generation_job(options: OperationOptions, input: aws_sdk_cleanroomsml.types.start_audience_generation_job_request.StartAudienceGenerationJobRequest) -> tuple[aws_sdk_cleanroomsml.types.start_audience_generation_job_response.StartAudienceGenerationJobResponse, zapros.Response]:
...
async def async_start_audience_generation_job(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.start_audience_generation_job_request.StartAudienceGenerationJobRequest) -> tuple[aws_sdk_cleanroomsml.types.start_audience_generation_job_response.StartAudienceGenerationJobResponse, zapros.Response]:
