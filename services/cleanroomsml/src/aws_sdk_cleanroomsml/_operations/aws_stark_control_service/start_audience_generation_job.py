...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.start_audience_generation_job_response.StartAudienceGenerationJobResponse = aws_sdk_cleanroomsml.types.start_audience_generation_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.start_audience_generation_job_request.StartAudienceGenerationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_start_audience_generation_job(
