...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.create_configured_model_algorithm_response.CreateConfiguredModelAlgorithmResponse = aws_sdk_cleanroomsml.types.create_configured_model_algorithm_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.create_configured_model_algorithm_request.CreateConfiguredModelAlgorithmRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.create_configured_model_algorithm_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_configured_model_algorithm(
