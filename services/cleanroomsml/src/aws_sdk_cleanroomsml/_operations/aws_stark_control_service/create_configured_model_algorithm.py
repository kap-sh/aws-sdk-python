"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#CreateConfiguredModelAlgorithm``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.create_configured_model_algorithm_response.CreateConfiguredModelAlgorithmResponse:
    import aws_sdk_cleanroomsml.types.create_configured_model_algorithm_response
    out: aws_sdk_cleanroomsml.types.create_configured_model_algorithm_response.CreateConfiguredModelAlgorithmResponse = aws_sdk_cleanroomsml.types.create_configured_model_algorithm_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.create_configured_model_algorithm_request.CreateConfiguredModelAlgorithmRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/configured-model-algorithms"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_cleanroomsml.types.create_configured_model_algorithm_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.create_configured_model_algorithm_request.serialize_json(input)).encode()
...
def create_configured_model_algorithm(options: OperationOptions, input: aws_sdk_cleanroomsml.types.create_configured_model_algorithm_request.CreateConfiguredModelAlgorithmRequest) -> tuple[aws_sdk_cleanroomsml.types.create_configured_model_algorithm_response.CreateConfiguredModelAlgorithmResponse, zapros.Response]:
