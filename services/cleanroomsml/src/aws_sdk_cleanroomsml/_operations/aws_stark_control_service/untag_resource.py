"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#UntagResource``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.untag_resource_response.UntagResourceResponse:
    out: aws_sdk_cleanroomsml.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.untag_resource_request.UntagResourceRequest) -> zapros.Request:
...
def untag_resource(options: OperationOptions, input: aws_sdk_cleanroomsml.types.untag_resource_request.UntagResourceRequest) -> tuple[aws_sdk_cleanroomsml.types.untag_resource_response.UntagResourceResponse, zapros.Response]:
...
async def async_untag_resource(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.untag_resource_request.UntagResourceRequest) -> tuple[aws_sdk_cleanroomsml.types.untag_resource_response.UntagResourceResponse, zapros.Response]:
