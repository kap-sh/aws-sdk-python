...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.get_trained_model_response.GetTrainedModelResponse:
    import aws_sdk_cleanroomsml.types.get_trained_model_response
    out: aws_sdk_cleanroomsml.types.get_trained_model_response.GetTrainedModelResponse = aws_sdk_cleanroomsml.types.get_trained_model_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_trained_model_request.GetTrainedModelRequest) -> zapros.Request:
...
def get_trained_model(options: OperationOptions, input: aws_sdk_cleanroomsml.types.get_trained_model_request.GetTrainedModelRequest) -> tuple[aws_sdk_cleanroomsml.types.get_trained_model_response.GetTrainedModelResponse, zapros.Response]:
...
async def async_get_trained_model(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_trained_model_request.GetTrainedModelRequest) -> tuple[aws_sdk_cleanroomsml.types.get_trained_model_response.GetTrainedModelResponse, zapros.Response]:
