...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_trained_model_response.GetTrainedModelResponse = aws_sdk_cleanroomsml.types.get_trained_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.get_trained_model_request.GetTrainedModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
