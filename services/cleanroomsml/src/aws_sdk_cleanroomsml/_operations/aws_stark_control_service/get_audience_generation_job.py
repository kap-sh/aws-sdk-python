...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.get_audience_generation_job_response.GetAudienceGenerationJobResponse:
    import aws_sdk_cleanroomsml.types.get_audience_generation_job_response
    out: aws_sdk_cleanroomsml.types.get_audience_generation_job_response.GetAudienceGenerationJobResponse = aws_sdk_cleanroomsml.types.get_audience_generation_job_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_audience_generation_job_request.GetAudienceGenerationJobRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/audience-generation-job/{audienceGenerationJobArn}"
    url = url.replace("{audienceGenerationJobArn}", quote(str(input["audience_generation_job_arn"]), safe=""))
    params: dict[str, str] = {}
...
def get_audience_generation_job(options: OperationOptions, input: aws_sdk_cleanroomsml.types.get_audience_generation_job_request.GetAudienceGenerationJobRequest) -> tuple[aws_sdk_cleanroomsml.types.get_audience_generation_job_response.GetAudienceGenerationJobResponse, zapros.Response]:
...
async def async_get_audience_generation_job(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_audience_generation_job_request.GetAudienceGenerationJobRequest) -> tuple[aws_sdk_cleanroomsml.types.get_audience_generation_job_response.GetAudienceGenerationJobResponse, zapros.Response]:
