...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_audience_generation_job_response.GetAudienceGenerationJobResponse = aws_sdk_cleanroomsml.types.get_audience_generation_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.get_audience_generation_job_request.GetAudienceGenerationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["audience_generation_job_arn"]), safe=""),
    )
    params: dict[str, str] = {}
