...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_audience_generation_jobs_response.ListAudienceGenerationJobsResponse = aws_sdk_cleanroomsml.types.list_audience_generation_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_audience_generation_jobs_request.ListAudienceGenerationJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "configured_audience_model_arn" in input_:
        params["configuredAudienceModelArn"] = str(
            input_["configured_audience_model_arn"]
        )
    if "collaboration_id" in input_:
        params["collaborationId"] = str(input_["collaboration_id"])
...
async def async_list_audience_generation_jobs(
