"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListAudienceGenerationJobs``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_audience_generation_jobs_response.ListAudienceGenerationJobsResponse:
    import aws_sdk_cleanroomsml.types.list_audience_generation_jobs_response
    out: aws_sdk_cleanroomsml.types.list_audience_generation_jobs_response.ListAudienceGenerationJobsResponse = aws_sdk_cleanroomsml.types.list_audience_generation_jobs_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_audience_generation_jobs_request.ListAudienceGenerationJobsRequest) -> zapros.Request:
    ...
    if "configured_audience_model_arn" in input:
        params["configuredAudienceModelArn"] = str(input["configured_audience_model_arn"])
    if "collaboration_id" in input:
        params["collaborationId"] = str(input["collaboration_id"])
...
def list_audience_generation_jobs(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_audience_generation_jobs_request.ListAudienceGenerationJobsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_audience_generation_jobs_response.ListAudienceGenerationJobsResponse, zapros.Response]:
...
async def async_list_audience_generation_jobs(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_audience_generation_jobs_request.ListAudienceGenerationJobsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_audience_generation_jobs_response.ListAudienceGenerationJobsResponse, zapros.Response]:
