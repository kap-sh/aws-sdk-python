...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_audience_models_response.ListAudienceModelsResponse:
    import aws_sdk_cleanroomsml.types.list_audience_models_response
    out: aws_sdk_cleanroomsml.types.list_audience_models_response.ListAudienceModelsResponse = aws_sdk_cleanroomsml.types.list_audience_models_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_audience_models_request.ListAudienceModelsRequest) -> zapros.Request:
...
def list_audience_models(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_audience_models_request.ListAudienceModelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_audience_models_response.ListAudienceModelsResponse, zapros.Response]:
...
async def async_list_audience_models(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_audience_models_request.ListAudienceModelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_audience_models_response.ListAudienceModelsResponse, zapros.Response]:
