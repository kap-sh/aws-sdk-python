...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_audience_models_response.ListAudienceModelsResponse = aws_sdk_cleanroomsml.types.list_audience_models_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_audience_models_request.ListAudienceModelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
