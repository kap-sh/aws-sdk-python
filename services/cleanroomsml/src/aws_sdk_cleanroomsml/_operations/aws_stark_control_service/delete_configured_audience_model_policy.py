...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_configured_audience_model_policy_request.DeleteConfiguredAudienceModelPolicyRequest) -> zapros.Request:
...
def delete_configured_audience_model_policy(options: OperationOptions, input: aws_sdk_cleanroomsml.types.delete_configured_audience_model_policy_request.DeleteConfiguredAudienceModelPolicyRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_configured_audience_model_policy(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_configured_audience_model_policy_request.DeleteConfiguredAudienceModelPolicyRequest) -> tuple[None, zapros.Response]:
