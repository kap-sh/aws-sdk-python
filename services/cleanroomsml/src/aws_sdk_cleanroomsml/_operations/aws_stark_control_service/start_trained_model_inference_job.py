...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.StartTrainedModelInferenceJobResponse = aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.start_trained_model_inference_job_request.StartTrainedModelInferenceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_start_trained_model_inference_job(
