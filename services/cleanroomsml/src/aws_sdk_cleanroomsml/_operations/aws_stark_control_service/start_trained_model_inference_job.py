"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#StartTrainedModelInferenceJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.StartTrainedModelInferenceJobResponse:
    import aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response
    out: aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.StartTrainedModelInferenceJobResponse = aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.start_trained_model_inference_job_request.StartTrainedModelInferenceJobRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/trained-model-inference-jobs"
    url = url.replace("{membershipIdentifier}", quote(str(input["membership_identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_cleanroomsml.types.start_trained_model_inference_job_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.start_trained_model_inference_job_request.serialize_json(input)).encode()
...
def start_trained_model_inference_job(options: OperationOptions, input: aws_sdk_cleanroomsml.types.start_trained_model_inference_job_request.StartTrainedModelInferenceJobRequest) -> tuple[aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.StartTrainedModelInferenceJobResponse, zapros.Response]:
...
async def async_start_trained_model_inference_job(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.start_trained_model_inference_job_request.StartTrainedModelInferenceJobRequest) -> tuple[aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.StartTrainedModelInferenceJobResponse, zapros.Response]:
