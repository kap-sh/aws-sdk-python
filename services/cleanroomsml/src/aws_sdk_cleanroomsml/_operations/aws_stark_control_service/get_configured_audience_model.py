"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetConfiguredAudienceModel``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.get_configured_audience_model_response.GetConfiguredAudienceModelResponse:
    import aws_sdk_cleanroomsml.types.get_configured_audience_model_response
    out: aws_sdk_cleanroomsml.types.get_configured_audience_model_response.GetConfiguredAudienceModelResponse = aws_sdk_cleanroomsml.types.get_configured_audience_model_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_audience_model_request.GetConfiguredAudienceModelRequest) -> zapros.Request:
...
def get_configured_audience_model(options: OperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_audience_model_request.GetConfiguredAudienceModelRequest) -> tuple[aws_sdk_cleanroomsml.types.get_configured_audience_model_response.GetConfiguredAudienceModelResponse, zapros.Response]:
...
async def async_get_configured_audience_model(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_audience_model_request.GetConfiguredAudienceModelRequest) -> tuple[aws_sdk_cleanroomsml.types.get_configured_audience_model_response.GetConfiguredAudienceModelResponse, zapros.Response]:
