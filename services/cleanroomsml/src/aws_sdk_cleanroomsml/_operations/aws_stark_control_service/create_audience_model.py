...
def build_request(
    ...
    input: aws_sdk_cleanroomsml.types.create_audience_model_request.CreateAudienceModelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.create_audience_model_request.serialize_json(input)
    ).encode()
