"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#CreateAudienceModel``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.create_audience_model_response.CreateAudienceModelResponse:
    import aws_sdk_cleanroomsml.types.create_audience_model_response
    out: aws_sdk_cleanroomsml.types.create_audience_model_response.CreateAudienceModelResponse = aws_sdk_cleanroomsml.types.create_audience_model_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.create_audience_model_request.CreateAudienceModelRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/audience-model"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_cleanroomsml.types.create_audience_model_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.create_audience_model_request.serialize_json(input)).encode()
...
def create_audience_model(options: OperationOptions, input: aws_sdk_cleanroomsml.types.create_audience_model_request.CreateAudienceModelRequest) -> tuple[aws_sdk_cleanroomsml.types.create_audience_model_response.CreateAudienceModelResponse, zapros.Response]:
...
async def async_create_audience_model(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.create_audience_model_request.CreateAudienceModelRequest) -> tuple[aws_sdk_cleanroomsml.types.create_audience_model_response.CreateAudienceModelResponse, zapros.Response]:
