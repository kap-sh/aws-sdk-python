...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_ml_input_channels_response.ListMLInputChannelsResponse:
    import aws_sdk_cleanroomsml.types.list_ml_input_channels_response
    out: aws_sdk_cleanroomsml.types.list_ml_input_channels_response.ListMLInputChannelsResponse = aws_sdk_cleanroomsml.types.list_ml_input_channels_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_ml_input_channels_request.ListMLInputChannelsRequest) -> zapros.Request:
...
def list_ml_input_channels(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_ml_input_channels_request.ListMLInputChannelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_ml_input_channels_response.ListMLInputChannelsResponse, zapros.Response]:
...
async def async_list_ml_input_channels(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_ml_input_channels_request.ListMLInputChannelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_ml_input_channels_response.ListMLInputChannelsResponse, zapros.Response]:
