...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_ml_input_channels_response.ListMLInputChannelsResponse = aws_sdk_cleanroomsml.types.list_ml_input_channels_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_ml_input_channels_request.ListMLInputChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
