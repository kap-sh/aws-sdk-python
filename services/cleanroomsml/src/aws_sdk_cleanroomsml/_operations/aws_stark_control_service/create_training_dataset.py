...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.create_training_dataset_response.CreateTrainingDatasetResponse:
    import aws_sdk_cleanroomsml.types.create_training_dataset_response
    out: aws_sdk_cleanroomsml.types.create_training_dataset_response.CreateTrainingDatasetResponse = aws_sdk_cleanroomsml.types.create_training_dataset_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.create_training_dataset_request.CreateTrainingDatasetRequest) -> zapros.Request:
    ...
    import aws_sdk_cleanroomsml.types.create_training_dataset_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.create_training_dataset_request.serialize_json(input)).encode()
...
def create_training_dataset(options: OperationOptions, input: aws_sdk_cleanroomsml.types.create_training_dataset_request.CreateTrainingDatasetRequest) -> tuple[aws_sdk_cleanroomsml.types.create_training_dataset_response.CreateTrainingDatasetResponse, zapros.Response]:
...
async def async_create_training_dataset(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.create_training_dataset_request.CreateTrainingDatasetRequest) -> tuple[aws_sdk_cleanroomsml.types.create_training_dataset_response.CreateTrainingDatasetResponse, zapros.Response]:
