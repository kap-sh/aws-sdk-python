...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.create_training_dataset_request.CreateTrainingDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.create_training_dataset_request.serialize_json(
            input_
        )
    ).encode()
