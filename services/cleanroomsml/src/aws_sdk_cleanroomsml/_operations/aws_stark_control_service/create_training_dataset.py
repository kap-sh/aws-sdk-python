...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.create_training_dataset_response.CreateTrainingDatasetResponse = aws_sdk_cleanroomsml.types.create_training_dataset_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cleanroomsml.types.create_training_dataset_request.CreateTrainingDatasetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.create_training_dataset_request.serialize_json(input)
    ).encode()
