...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_collaboration_ml_input_channel_response.GetCollaborationMLInputChannelResponse = aws_sdk_cleanroomsml.types.get_collaboration_ml_input_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.get_collaboration_ml_input_channel_request.GetCollaborationMLInputChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{mlInputChannelArn}", quote(str(input_["ml_input_channel_arn"]), safe="")
    )
    url = url.replace(
...
async def async_get_collaboration_ml_input_channel(
