"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetMLConfiguration``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.get_ml_configuration_response.GetMLConfigurationResponse:
    import aws_sdk_cleanroomsml.types.get_ml_configuration_response
    out: aws_sdk_cleanroomsml.types.get_ml_configuration_response.GetMLConfigurationResponse = aws_sdk_cleanroomsml.types.get_ml_configuration_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_ml_configuration_request.GetMLConfigurationRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/ml-configurations"
...
def get_ml_configuration(options: OperationOptions, input: aws_sdk_cleanroomsml.types.get_ml_configuration_request.GetMLConfigurationRequest) -> tuple[aws_sdk_cleanroomsml.types.get_ml_configuration_response.GetMLConfigurationResponse, zapros.Response]:
...
async def async_get_ml_configuration(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_ml_configuration_request.GetMLConfigurationRequest) -> tuple[aws_sdk_cleanroomsml.types.get_ml_configuration_response.GetMLConfigurationResponse, zapros.Response]:
