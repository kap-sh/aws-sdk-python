...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_ml_configuration_response.GetMLConfigurationResponse = aws_sdk_cleanroomsml.types.get_ml_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.get_ml_configuration_request.GetMLConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_ml_configuration(
