...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            ...
            raise aws_sdk_cleanroomsml.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case "ThrottlingException":
            import aws_sdk_cleanroomsml.errors.throttling_exception

            raise aws_sdk_cleanroomsml.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.create_configured_model_algorithm_association_response.CreateConfiguredModelAlgorithmAssociationResponse = aws_sdk_cleanroomsml.types.create_configured_model_algorithm_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.create_configured_model_algorithm_association_request.CreateConfiguredModelAlgorithmAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.create_configured_model_algorithm_association_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_configured_model_algorithm_association(
