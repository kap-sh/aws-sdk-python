...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_audience_export_jobs_request.ListAudienceExportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "audience_generation_job_arn" in input_:
        params["audienceGenerationJobArn"] = str(input_["audience_generation_job_arn"])
