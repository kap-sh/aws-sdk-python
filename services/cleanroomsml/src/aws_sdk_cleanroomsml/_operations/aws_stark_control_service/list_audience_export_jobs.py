...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.ListAudienceExportJobsResponse = aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cleanroomsml.types.list_audience_export_jobs_request.ListAudienceExportJobsRequest,
) -> zapros.Request:
