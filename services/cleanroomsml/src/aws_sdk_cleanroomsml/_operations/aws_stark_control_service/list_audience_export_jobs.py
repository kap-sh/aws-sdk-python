...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.ListAudienceExportJobsResponse:
    import aws_sdk_cleanroomsml.types.list_audience_export_jobs_response
    out: aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.ListAudienceExportJobsResponse = aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_audience_export_jobs_request.ListAudienceExportJobsRequest) -> zapros.Request:
    ...
    if "audience_generation_job_arn" in input:
        params["audienceGenerationJobArn"] = str(input["audience_generation_job_arn"])
...
def list_audience_export_jobs(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_audience_export_jobs_request.ListAudienceExportJobsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.ListAudienceExportJobsResponse, zapros.Response]:
...
async def async_list_audience_export_jobs(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_audience_export_jobs_request.ListAudienceExportJobsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.ListAudienceExportJobsResponse, zapros.Response]:
