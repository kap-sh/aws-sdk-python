...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_collaboration_trained_model_export_jobs_response.ListCollaborationTrainedModelExportJobsResponse = aws_sdk_cleanroomsml.types.list_collaboration_trained_model_export_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_collaboration_trained_model_export_jobs_request.ListCollaborationTrainedModelExportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
