...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_configured_audience_models_response.ListConfiguredAudienceModelsResponse = aws_sdk_cleanroomsml.types.list_configured_audience_models_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_configured_audience_models_request.ListConfiguredAudienceModelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_configured_audience_models(
