"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListConfiguredAudienceModels``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_configured_audience_models_response.ListConfiguredAudienceModelsResponse:
    import aws_sdk_cleanroomsml.types.list_configured_audience_models_response
    out: aws_sdk_cleanroomsml.types.list_configured_audience_models_response.ListConfiguredAudienceModelsResponse = aws_sdk_cleanroomsml.types.list_configured_audience_models_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_configured_audience_models_request.ListConfiguredAudienceModelsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/configured-audience-model"
    params: dict[str, str] = {}
...
def list_configured_audience_models(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_configured_audience_models_request.ListConfiguredAudienceModelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_configured_audience_models_response.ListConfiguredAudienceModelsResponse, zapros.Response]:
...
async def async_list_configured_audience_models(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_configured_audience_models_request.ListConfiguredAudienceModelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_configured_audience_models_response.ListConfiguredAudienceModelsResponse, zapros.Response]:
