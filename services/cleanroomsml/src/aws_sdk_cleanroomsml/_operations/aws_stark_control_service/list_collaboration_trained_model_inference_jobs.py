...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_collaboration_trained_model_inference_jobs_response.ListCollaborationTrainedModelInferenceJobsResponse = aws_sdk_cleanroomsml.types.list_collaboration_trained_model_inference_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_collaboration_trained_model_inference_jobs_request.ListCollaborationTrainedModelInferenceJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
