...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.update_configured_audience_model_response.UpdateConfiguredAudienceModelResponse = aws_sdk_cleanroomsml.types.update_configured_audience_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.update_configured_audience_model_request.UpdateConfiguredAudienceModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.update_configured_audience_model_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_configured_audience_model(
