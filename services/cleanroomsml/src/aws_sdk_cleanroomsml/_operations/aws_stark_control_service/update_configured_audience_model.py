"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#UpdateConfiguredAudienceModel``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.update_configured_audience_model_response.UpdateConfiguredAudienceModelResponse:
    import aws_sdk_cleanroomsml.types.update_configured_audience_model_response
    out: aws_sdk_cleanroomsml.types.update_configured_audience_model_response.UpdateConfiguredAudienceModelResponse = aws_sdk_cleanroomsml.types.update_configured_audience_model_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.update_configured_audience_model_request.UpdateConfiguredAudienceModelRequest) -> zapros.Request:
    ...
    import aws_sdk_cleanroomsml.types.update_configured_audience_model_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.update_configured_audience_model_request.serialize_json(input)).encode()
...
def update_configured_audience_model(options: OperationOptions, input: aws_sdk_cleanroomsml.types.update_configured_audience_model_request.UpdateConfiguredAudienceModelRequest) -> tuple[aws_sdk_cleanroomsml.types.update_configured_audience_model_response.UpdateConfiguredAudienceModelResponse, zapros.Response]:
