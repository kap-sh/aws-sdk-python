"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#DeleteMLInputChannelData``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_ml_input_channel_data_request.DeleteMLInputChannelDataRequest) -> zapros.Request:
...
def delete_ml_input_channel_data(options: OperationOptions, input: aws_sdk_cleanroomsml.types.delete_ml_input_channel_data_request.DeleteMLInputChannelDataRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_ml_input_channel_data(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_ml_input_channel_data_request.DeleteMLInputChannelDataRequest) -> tuple[None, zapros.Response]:
