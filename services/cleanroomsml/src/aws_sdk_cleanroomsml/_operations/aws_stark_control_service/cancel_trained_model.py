...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.cancel_trained_model_request.CancelTrainedModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "version_identifier" in input_:
        params["versionIdentifier"] = str(input_["version_identifier"])
...
async def async_cancel_trained_model(
