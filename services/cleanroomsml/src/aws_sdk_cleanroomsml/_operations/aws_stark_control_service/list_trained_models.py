"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListTrainedModels``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_trained_models_response.ListTrainedModelsResponse:
    import aws_sdk_cleanroomsml.types.list_trained_models_response
    out: aws_sdk_cleanroomsml.types.list_trained_models_response.ListTrainedModelsResponse = aws_sdk_cleanroomsml.types.list_trained_models_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_trained_models_request.ListTrainedModelsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/trained-models"
...
def list_trained_models(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_trained_models_request.ListTrainedModelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_trained_models_response.ListTrainedModelsResponse, zapros.Response]:
...
async def async_list_trained_models(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_trained_models_request.ListTrainedModelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_trained_models_response.ListTrainedModelsResponse, zapros.Response]:
