...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_trained_models_response.ListTrainedModelsResponse = aws_sdk_cleanroomsml.types.list_trained_models_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_trained_models_request.ListTrainedModelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/trained-models"
    )
    url = url.replace(
...
async def async_list_trained_models(
