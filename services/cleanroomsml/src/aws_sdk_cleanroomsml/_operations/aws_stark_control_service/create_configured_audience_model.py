...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.create_configured_audience_model_response.CreateConfiguredAudienceModelResponse:
    import aws_sdk_cleanroomsml.types.create_configured_audience_model_response
    out: aws_sdk_cleanroomsml.types.create_configured_audience_model_response.CreateConfiguredAudienceModelResponse = aws_sdk_cleanroomsml.types.create_configured_audience_model_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.create_configured_audience_model_request.CreateConfiguredAudienceModelRequest) -> zapros.Request:
    ...
    import aws_sdk_cleanroomsml.types.create_configured_audience_model_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.create_configured_audience_model_request.serialize_json(input)).encode()
