...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_collaboration_configured_model_algorithm_association_response.GetCollaborationConfiguredModelAlgorithmAssociationResponse = aws_sdk_cleanroomsml.types.get_collaboration_configured_model_algorithm_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.get_collaboration_configured_model_algorithm_association_request.GetCollaborationConfiguredModelAlgorithmAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
