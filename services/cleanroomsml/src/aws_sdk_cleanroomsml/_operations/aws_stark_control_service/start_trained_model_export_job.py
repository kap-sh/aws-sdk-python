...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.start_trained_model_export_job_request.StartTrainedModelExportJobRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/trained-models/{trainedModelArn}/export-jobs"
    ...
    import aws_sdk_cleanroomsml.types.start_trained_model_export_job_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.start_trained_model_export_job_request.serialize_json(input)).encode()
...
def start_trained_model_export_job(options: OperationOptions, input: aws_sdk_cleanroomsml.types.start_trained_model_export_job_request.StartTrainedModelExportJobRequest) -> tuple[None, zapros.Response]:
...
async def async_start_trained_model_export_job(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.start_trained_model_export_job_request.StartTrainedModelExportJobRequest) -> tuple[None, zapros.Response]:
