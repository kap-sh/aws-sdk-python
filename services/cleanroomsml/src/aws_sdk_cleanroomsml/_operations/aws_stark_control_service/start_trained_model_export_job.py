...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.start_trained_model_export_job_request.StartTrainedModelExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.start_trained_model_export_job_request.serialize_json(
            input_
        )
    ).encode()
