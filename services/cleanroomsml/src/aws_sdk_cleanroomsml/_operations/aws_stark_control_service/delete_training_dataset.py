...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_training_dataset_request.DeleteTrainingDatasetRequest) -> zapros.Request:
...
def delete_training_dataset(options: OperationOptions, input: aws_sdk_cleanroomsml.types.delete_training_dataset_request.DeleteTrainingDatasetRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_training_dataset(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_training_dataset_request.DeleteTrainingDatasetRequest) -> tuple[None, zapros.Response]:
