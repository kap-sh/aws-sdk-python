...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_response.GetConfiguredModelAlgorithmAssociationResponse = aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_request.GetConfiguredModelAlgorithmAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["configured_model_algorithm_association_arn"]), safe=""),
    )
    url = url.replace(
...
async def async_get_configured_model_algorithm_association(
