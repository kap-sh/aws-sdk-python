"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetConfiguredModelAlgorithmAssociation``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_response.GetConfiguredModelAlgorithmAssociationResponse:
    import aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_response
    out: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_response.GetConfiguredModelAlgorithmAssociationResponse = aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_request.GetConfiguredModelAlgorithmAssociationRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/configured-model-algorithm-associations/{configuredModelAlgorithmAssociationArn}"
    url = url.replace("{configuredModelAlgorithmAssociationArn}", quote(str(input["configured_model_algorithm_association_arn"]), safe=""))
...
def get_configured_model_algorithm_association(options: OperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_request.GetConfiguredModelAlgorithmAssociationRequest) -> tuple[aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_response.GetConfiguredModelAlgorithmAssociationResponse, zapros.Response]:
...
async def async_get_configured_model_algorithm_association(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_request.GetConfiguredModelAlgorithmAssociationRequest) -> tuple[aws_sdk_cleanroomsml.types.get_configured_model_algorithm_association_response.GetConfiguredModelAlgorithmAssociationResponse, zapros.Response]:
