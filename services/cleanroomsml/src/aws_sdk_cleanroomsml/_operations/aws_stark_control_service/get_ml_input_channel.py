"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetMLInputChannel``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.get_ml_input_channel_response.GetMLInputChannelResponse:
    import aws_sdk_cleanroomsml.types.get_ml_input_channel_response
    out: aws_sdk_cleanroomsml.types.get_ml_input_channel_response.GetMLInputChannelResponse = aws_sdk_cleanroomsml.types.get_ml_input_channel_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_ml_input_channel_request.GetMLInputChannelRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/ml-input-channels/{mlInputChannelArn}"
    url = url.replace("{mlInputChannelArn}", quote(str(input["ml_input_channel_arn"]), safe=""))
...
def get_ml_input_channel(options: OperationOptions, input: aws_sdk_cleanroomsml.types.get_ml_input_channel_request.GetMLInputChannelRequest) -> tuple[aws_sdk_cleanroomsml.types.get_ml_input_channel_response.GetMLInputChannelResponse, zapros.Response]:
...
async def async_get_ml_input_channel(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_ml_input_channel_request.GetMLInputChannelRequest) -> tuple[aws_sdk_cleanroomsml.types.get_ml_input_channel_response.GetMLInputChannelResponse, zapros.Response]:
