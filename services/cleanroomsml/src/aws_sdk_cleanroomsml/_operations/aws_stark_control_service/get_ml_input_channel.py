...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_ml_input_channel_response.GetMLInputChannelResponse = aws_sdk_cleanroomsml.types.get_ml_input_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.get_ml_input_channel_request.GetMLInputChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_ml_input_channel(
