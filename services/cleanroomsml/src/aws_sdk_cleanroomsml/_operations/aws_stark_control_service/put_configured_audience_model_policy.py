...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response.PutConfiguredAudienceModelPolicyResponse = aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_request.PutConfiguredAudienceModelPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_configured_audience_model_policy(
