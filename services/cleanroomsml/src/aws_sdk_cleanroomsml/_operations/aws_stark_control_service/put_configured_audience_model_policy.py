"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#PutConfiguredAudienceModelPolicy``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response.PutConfiguredAudienceModelPolicyResponse:
    import aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response
    out: aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response.PutConfiguredAudienceModelPolicyResponse = aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_request.PutConfiguredAudienceModelPolicyRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/configured-audience-model/{configuredAudienceModelArn}/policy"
    url = url.replace("{configuredAudienceModelArn}", quote(str(input["configured_audience_model_arn"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_request.serialize_json(input)).encode()
...
def put_configured_audience_model_policy(options: OperationOptions, input: aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_request.PutConfiguredAudienceModelPolicyRequest) -> tuple[aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response.PutConfiguredAudienceModelPolicyResponse, zapros.Response]:
...
async def async_put_configured_audience_model_policy(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_request.PutConfiguredAudienceModelPolicyRequest) -> tuple[aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response.PutConfiguredAudienceModelPolicyResponse, zapros.Response]:
