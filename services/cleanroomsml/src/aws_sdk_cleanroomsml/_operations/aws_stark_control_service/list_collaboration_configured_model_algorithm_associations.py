...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_collaboration_configured_model_algorithm_associations_response.ListCollaborationConfiguredModelAlgorithmAssociationsResponse = aws_sdk_cleanroomsml.types.list_collaboration_configured_model_algorithm_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_collaboration_configured_model_algorithm_associations_request.ListCollaborationConfiguredModelAlgorithmAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
