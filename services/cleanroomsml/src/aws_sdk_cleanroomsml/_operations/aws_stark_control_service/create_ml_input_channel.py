...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.create_ml_input_channel_request.CreateMLInputChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.create_ml_input_channel_request.serialize_json(
            input_
        )
    ).encode()
