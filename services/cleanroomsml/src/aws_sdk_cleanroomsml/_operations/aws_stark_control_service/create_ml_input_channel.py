...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.create_ml_input_channel_response.CreateMLInputChannelResponse:
    import aws_sdk_cleanroomsml.types.create_ml_input_channel_response
    out: aws_sdk_cleanroomsml.types.create_ml_input_channel_response.CreateMLInputChannelResponse = aws_sdk_cleanroomsml.types.create_ml_input_channel_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.create_ml_input_channel_request.CreateMLInputChannelRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/ml-input-channels"
    url = url.replace("{membershipIdentifier}", quote(str(input["membership_identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_cleanroomsml.types.create_ml_input_channel_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.create_ml_input_channel_request.serialize_json(input)).encode()
...
def create_ml_input_channel(options: OperationOptions, input: aws_sdk_cleanroomsml.types.create_ml_input_channel_request.CreateMLInputChannelRequest) -> tuple[aws_sdk_cleanroomsml.types.create_ml_input_channel_response.CreateMLInputChannelResponse, zapros.Response]:
...
async def async_create_ml_input_channel(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.create_ml_input_channel_request.CreateMLInputChannelRequest) -> tuple[aws_sdk_cleanroomsml.types.create_ml_input_channel_response.CreateMLInputChannelResponse, zapros.Response]:
