...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.create_ml_input_channel_response.CreateMLInputChannelResponse = aws_sdk_cleanroomsml.types.create_ml_input_channel_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cleanroomsml.types.create_ml_input_channel_request.CreateMLInputChannelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.create_ml_input_channel_request.serialize_json(input)
    ).encode()
