...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_audience_generation_job_request.DeleteAudienceGenerationJobRequest) -> zapros.Request:
...
def delete_audience_generation_job(options: OperationOptions, input: aws_sdk_cleanroomsml.types.delete_audience_generation_job_request.DeleteAudienceGenerationJobRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_audience_generation_job(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_audience_generation_job_request.DeleteAudienceGenerationJobRequest) -> tuple[None, zapros.Response]:
