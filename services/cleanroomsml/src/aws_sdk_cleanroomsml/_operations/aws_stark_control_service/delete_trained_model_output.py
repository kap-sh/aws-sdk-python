...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_trained_model_output_request.DeleteTrainedModelOutputRequest) -> zapros.Request:
...
def delete_trained_model_output(options: OperationOptions, input: aws_sdk_cleanroomsml.types.delete_trained_model_output_request.DeleteTrainedModelOutputRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_trained_model_output(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_trained_model_output_request.DeleteTrainedModelOutputRequest) -> tuple[None, zapros.Response]:
