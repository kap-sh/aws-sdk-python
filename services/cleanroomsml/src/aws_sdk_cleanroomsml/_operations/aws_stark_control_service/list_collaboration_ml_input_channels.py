"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListCollaborationMLInputChannels``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_response.ListCollaborationMLInputChannelsResponse:
    import aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_response
    out: aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_response.ListCollaborationMLInputChannelsResponse = aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_request.ListCollaborationMLInputChannelsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/collaborations/{collaborationIdentifier}/ml-input-channels"
...
def list_collaboration_ml_input_channels(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_request.ListCollaborationMLInputChannelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_response.ListCollaborationMLInputChannelsResponse, zapros.Response]:
...
async def async_list_collaboration_ml_input_channels(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_request.ListCollaborationMLInputChannelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_response.ListCollaborationMLInputChannelsResponse, zapros.Response]:
