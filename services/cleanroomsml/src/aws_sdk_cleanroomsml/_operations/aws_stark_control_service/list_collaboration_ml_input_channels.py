...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_response.ListCollaborationMLInputChannelsResponse = aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_request.ListCollaborationMLInputChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_collaboration_ml_input_channels(
