...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_collaboration_trained_model_response.GetCollaborationTrainedModelResponse = aws_sdk_cleanroomsml.types.get_collaboration_trained_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.get_collaboration_trained_model_request.GetCollaborationTrainedModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
