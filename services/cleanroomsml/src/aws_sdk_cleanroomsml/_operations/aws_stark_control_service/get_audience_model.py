...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_audience_model_response.GetAudienceModelResponse = aws_sdk_cleanroomsml.types.get_audience_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.get_audience_model_request.GetAudienceModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
