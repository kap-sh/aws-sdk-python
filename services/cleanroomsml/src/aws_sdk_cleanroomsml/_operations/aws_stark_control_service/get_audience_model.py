...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.get_audience_model_response.GetAudienceModelResponse:
    import aws_sdk_cleanroomsml.types.get_audience_model_response
    out: aws_sdk_cleanroomsml.types.get_audience_model_response.GetAudienceModelResponse = aws_sdk_cleanroomsml.types.get_audience_model_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_audience_model_request.GetAudienceModelRequest) -> zapros.Request:
...
def get_audience_model(options: OperationOptions, input: aws_sdk_cleanroomsml.types.get_audience_model_request.GetAudienceModelRequest) -> tuple[aws_sdk_cleanroomsml.types.get_audience_model_response.GetAudienceModelResponse, zapros.Response]:
...
async def async_get_audience_model(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_audience_model_request.GetAudienceModelRequest) -> tuple[aws_sdk_cleanroomsml.types.get_audience_model_response.GetAudienceModelResponse, zapros.Response]:
