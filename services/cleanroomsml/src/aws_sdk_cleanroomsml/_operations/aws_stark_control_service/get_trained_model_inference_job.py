...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_trained_model_inference_job_response.GetTrainedModelInferenceJobResponse = aws_sdk_cleanroomsml.types.get_trained_model_inference_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.get_trained_model_inference_job_request.GetTrainedModelInferenceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
