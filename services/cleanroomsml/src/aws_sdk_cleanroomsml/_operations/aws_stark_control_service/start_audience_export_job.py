...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.start_audience_export_job_request.StartAudienceExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.start_audience_export_job_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_audience_export_job(
