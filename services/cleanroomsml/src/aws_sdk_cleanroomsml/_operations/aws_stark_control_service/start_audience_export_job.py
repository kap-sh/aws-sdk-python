"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#StartAudienceExportJob``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.start_audience_export_job_request.StartAudienceExportJobRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/audience-export-job"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_cleanroomsml.types.start_audience_export_job_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.start_audience_export_job_request.serialize_json(input)).encode()
...
def start_audience_export_job(options: OperationOptions, input: aws_sdk_cleanroomsml.types.start_audience_export_job_request.StartAudienceExportJobRequest) -> tuple[None, zapros.Response]:
...
async def async_start_audience_export_job(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.start_audience_export_job_request.StartAudienceExportJobRequest) -> tuple[None, zapros.Response]:
