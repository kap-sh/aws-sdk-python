"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetConfiguredAudienceModelPolicy``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_response.GetConfiguredAudienceModelPolicyResponse:
    import aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_response
    out: aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_response.GetConfiguredAudienceModelPolicyResponse = aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_request.GetConfiguredAudienceModelPolicyRequest) -> zapros.Request:
...
def get_configured_audience_model_policy(options: OperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_request.GetConfiguredAudienceModelPolicyRequest) -> tuple[aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_response.GetConfiguredAudienceModelPolicyResponse, zapros.Response]:
...
async def async_get_configured_audience_model_policy(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_request.GetConfiguredAudienceModelPolicyRequest) -> tuple[aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_response.GetConfiguredAudienceModelPolicyResponse, zapros.Response]:
