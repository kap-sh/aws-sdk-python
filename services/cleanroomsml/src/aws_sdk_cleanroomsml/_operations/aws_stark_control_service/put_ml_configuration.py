...
def build_request(
    ...
    input: aws_sdk_cleanroomsml.types.put_ml_configuration_request.PutMLConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.put_ml_configuration_request.serialize_json(input)
    ).encode()
