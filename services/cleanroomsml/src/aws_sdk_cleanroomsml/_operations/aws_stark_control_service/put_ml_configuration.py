...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.put_ml_configuration_request.PutMLConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanroomsml.types.put_ml_configuration_request.serialize_json(input_)
    ).encode()
...
async def async_put_ml_configuration(
