"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#PutMLConfiguration``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.put_ml_configuration_request.PutMLConfigurationRequest) -> zapros.Request:
    ...
    import aws_sdk_cleanroomsml.types.put_ml_configuration_request
    body: bytes | None = json.dumps(aws_sdk_cleanroomsml.types.put_ml_configuration_request.serialize_json(input)).encode()
...
def put_ml_configuration(options: OperationOptions, input: aws_sdk_cleanroomsml.types.put_ml_configuration_request.PutMLConfigurationRequest) -> tuple[None, zapros.Response]:
...
async def async_put_ml_configuration(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.put_ml_configuration_request.PutMLConfigurationRequest) -> tuple[None, zapros.Response]:
