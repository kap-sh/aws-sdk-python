"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#DeleteAudienceModel``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_audience_model_request.DeleteAudienceModelRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/audience-model/{audienceModelArn}"
    url = url.replace("{audienceModelArn}", quote(str(input["audience_model_arn"]), safe=""))
    params: dict[str, str] = {}
...
def delete_audience_model(options: OperationOptions, input: aws_sdk_cleanroomsml.types.delete_audience_model_request.DeleteAudienceModelRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_audience_model(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_audience_model_request.DeleteAudienceModelRequest) -> tuple[None, zapros.Response]:
