...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response.GetConfiguredModelAlgorithmResponse:
    import aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response
    out: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response.GetConfiguredModelAlgorithmResponse = aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_request.GetConfiguredModelAlgorithmRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/configured-model-algorithms/{configuredModelAlgorithmArn}"
    url = url.replace("{configuredModelAlgorithmArn}", quote(str(input["configured_model_algorithm_arn"]), safe=""))
    params: dict[str, str] = {}
...
def get_configured_model_algorithm(options: OperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_request.GetConfiguredModelAlgorithmRequest) -> tuple[aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response.GetConfiguredModelAlgorithmResponse, zapros.Response]:
...
async def async_get_configured_model_algorithm(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_request.GetConfiguredModelAlgorithmRequest) -> tuple[aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response.GetConfiguredModelAlgorithmResponse, zapros.Response]:
