...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response.GetConfiguredModelAlgorithmResponse = aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_request.GetConfiguredModelAlgorithmRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["configured_model_algorithm_arn"]), safe=""),
    )
    params: dict[str, str] = {}
