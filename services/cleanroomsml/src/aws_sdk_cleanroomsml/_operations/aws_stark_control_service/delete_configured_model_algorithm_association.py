...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_configured_model_algorithm_association_request.DeleteConfiguredModelAlgorithmAssociationRequest) -> zapros.Request:
...
def delete_configured_model_algorithm_association(options: OperationOptions, input: aws_sdk_cleanroomsml.types.delete_configured_model_algorithm_association_request.DeleteConfiguredModelAlgorithmAssociationRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_configured_model_algorithm_association(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_configured_model_algorithm_association_request.DeleteConfiguredModelAlgorithmAssociationRequest) -> tuple[None, zapros.Response]:
