"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#CancelTrainedModelInferenceJob``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.cancel_trained_model_inference_job_request.CancelTrainedModelInferenceJobRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/trained-model-inference-jobs/{trainedModelInferenceJobArn}"
    url = url.replace("{membershipIdentifier}", quote(str(input["membership_identifier"]), safe=""))
    url = url.replace("{trainedModelInferenceJobArn}", quote(str(input["trained_model_inference_job_arn"]), safe=""))
    params: dict[str, str] = {}
...
def cancel_trained_model_inference_job(options: OperationOptions, input: aws_sdk_cleanroomsml.types.cancel_trained_model_inference_job_request.CancelTrainedModelInferenceJobRequest) -> tuple[None, zapros.Response]:
...
async def async_cancel_trained_model_inference_job(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.cancel_trained_model_inference_job_request.CancelTrainedModelInferenceJobRequest) -> tuple[None, zapros.Response]:
