...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_configured_model_algorithm_request.DeleteConfiguredModelAlgorithmRequest) -> zapros.Request:
...
def delete_configured_model_algorithm(options: OperationOptions, input: aws_sdk_cleanroomsml.types.delete_configured_model_algorithm_request.DeleteConfiguredModelAlgorithmRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_configured_model_algorithm(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_configured_model_algorithm_request.DeleteConfiguredModelAlgorithmRequest) -> tuple[None, zapros.Response]:
