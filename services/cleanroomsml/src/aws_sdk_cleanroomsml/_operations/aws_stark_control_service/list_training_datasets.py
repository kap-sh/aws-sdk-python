...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_training_datasets_response.ListTrainingDatasetsResponse = aws_sdk_cleanroomsml.types.list_training_datasets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_training_datasets_request.ListTrainingDatasetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_training_datasets(
