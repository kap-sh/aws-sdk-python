"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListTrainingDatasets``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_training_datasets_response.ListTrainingDatasetsResponse:
    import aws_sdk_cleanroomsml.types.list_training_datasets_response
    out: aws_sdk_cleanroomsml.types.list_training_datasets_response.ListTrainingDatasetsResponse = aws_sdk_cleanroomsml.types.list_training_datasets_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_training_datasets_request.ListTrainingDatasetsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/training-dataset"
    params: dict[str, str] = {}
...
def list_training_datasets(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_training_datasets_request.ListTrainingDatasetsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_training_datasets_response.ListTrainingDatasetsResponse, zapros.Response]:
...
async def async_list_training_datasets(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_training_datasets_request.ListTrainingDatasetsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_training_datasets_response.ListTrainingDatasetsResponse, zapros.Response]:
