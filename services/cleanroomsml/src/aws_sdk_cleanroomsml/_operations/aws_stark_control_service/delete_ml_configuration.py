...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_ml_configuration_request.DeleteMLConfigurationRequest) -> zapros.Request:
...
def delete_ml_configuration(options: OperationOptions, input: aws_sdk_cleanroomsml.types.delete_ml_configuration_request.DeleteMLConfigurationRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_ml_configuration(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.delete_ml_configuration_request.DeleteMLConfigurationRequest) -> tuple[None, zapros.Response]:
