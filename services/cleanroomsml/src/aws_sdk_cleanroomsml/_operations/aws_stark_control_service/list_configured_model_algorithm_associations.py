...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_configured_model_algorithm_associations_response.ListConfiguredModelAlgorithmAssociationsResponse = aws_sdk_cleanroomsml.types.list_configured_model_algorithm_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_configured_model_algorithm_associations_request.ListConfiguredModelAlgorithmAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_configured_model_algorithm_associations(
