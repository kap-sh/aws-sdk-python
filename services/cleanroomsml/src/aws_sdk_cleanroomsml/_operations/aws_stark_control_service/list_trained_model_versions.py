...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_trained_model_versions_response.ListTrainedModelVersionsResponse:
    import aws_sdk_cleanroomsml.types.list_trained_model_versions_response
    out: aws_sdk_cleanroomsml.types.list_trained_model_versions_response.ListTrainedModelVersionsResponse = aws_sdk_cleanroomsml.types.list_trained_model_versions_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_trained_model_versions_request.ListTrainedModelVersionsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/trained-models/{trainedModelArn}/versions"
...
def list_trained_model_versions(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_trained_model_versions_request.ListTrainedModelVersionsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_trained_model_versions_response.ListTrainedModelVersionsResponse, zapros.Response]:
...
async def async_list_trained_model_versions(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_trained_model_versions_request.ListTrainedModelVersionsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_trained_model_versions_response.ListTrainedModelVersionsResponse, zapros.Response]:
