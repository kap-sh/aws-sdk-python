...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_trained_model_versions_response.ListTrainedModelVersionsResponse = aws_sdk_cleanroomsml.types.list_trained_model_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_trained_model_versions_request.ListTrainedModelVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
