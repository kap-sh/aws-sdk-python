...
import aws_sdk_cleanroomsml.types.trained_model_inference_job_list
...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_trained_model_inference_jobs_response.ListTrainedModelInferenceJobsResponse = aws_sdk_cleanroomsml.types.list_trained_model_inference_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_trained_model_inference_jobs_request.ListTrainedModelInferenceJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "trained_model_arn" in input_:
        params["trainedModelArn"] = str(input_["trained_model_arn"])
    if "trained_model_version_identifier" in input_:
        params["trainedModelVersionIdentifier"] = str(
...
async def async_list_trained_model_inference_jobs(
