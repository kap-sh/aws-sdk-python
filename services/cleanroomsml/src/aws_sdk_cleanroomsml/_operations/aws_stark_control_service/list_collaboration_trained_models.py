...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_collaboration_trained_models_response.ListCollaborationTrainedModelsResponse = aws_sdk_cleanroomsml.types.list_collaboration_trained_models_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_collaboration_trained_models_request.ListCollaborationTrainedModelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
