...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_collaboration_trained_models_response.ListCollaborationTrainedModelsResponse:
    import aws_sdk_cleanroomsml.types.list_collaboration_trained_models_response
    out: aws_sdk_cleanroomsml.types.list_collaboration_trained_models_response.ListCollaborationTrainedModelsResponse = aws_sdk_cleanroomsml.types.list_collaboration_trained_models_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_collaboration_trained_models_request.ListCollaborationTrainedModelsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/collaborations/{collaborationIdentifier}/trained-models"
...
def list_collaboration_trained_models(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_collaboration_trained_models_request.ListCollaborationTrainedModelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_collaboration_trained_models_response.ListCollaborationTrainedModelsResponse, zapros.Response]:
...
async def async_list_collaboration_trained_models(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_collaboration_trained_models_request.ListCollaborationTrainedModelsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_collaboration_trained_models_response.ListCollaborationTrainedModelsResponse, zapros.Response]:
