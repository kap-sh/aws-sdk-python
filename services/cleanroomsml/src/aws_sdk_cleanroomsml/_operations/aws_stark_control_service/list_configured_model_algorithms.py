...
def handle_response(
    ...
    out: aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response.ListConfiguredModelAlgorithmsResponse = aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanroomsml.types.list_configured_model_algorithms_request.ListConfiguredModelAlgorithmsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_configured_model_algorithms(
