"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListConfiguredModelAlgorithms``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response.ListConfiguredModelAlgorithmsResponse:
    import aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response
    out: aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response.ListConfiguredModelAlgorithmsResponse = aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_configured_model_algorithms_request.ListConfiguredModelAlgorithmsRequest) -> zapros.Request:
...
def list_configured_model_algorithms(options: OperationOptions, input: aws_sdk_cleanroomsml.types.list_configured_model_algorithms_request.ListConfiguredModelAlgorithmsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response.ListConfiguredModelAlgorithmsResponse, zapros.Response]:
...
async def async_list_configured_model_algorithms(options: AsyncOperationOptions, input: aws_sdk_cleanroomsml.types.list_configured_model_algorithms_request.ListConfiguredModelAlgorithmsRequest) -> tuple[aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response.ListConfiguredModelAlgorithmsResponse, zapros.Response]:
