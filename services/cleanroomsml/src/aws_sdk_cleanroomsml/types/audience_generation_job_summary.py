...
if TYPE_CHECKING:
    ...
    import aws_sdk_cleanroomsml.types.audience_generation_job_status
...
class AudienceGenerationJobSummary(TypedDict):
    ...
    status: "aws_sdk_cleanroomsml.types.audience_generation_job_status.AudienceGenerationJobStatus"
    ...
    started_by: NotRequired["aws_sdk_cleanroomsml.types.account_id.AccountId"]
...
def serialize_json(value: AudienceGenerationJobSummary) -> dict:
    ...
    out["status"] = (
        aws_sdk_cleanroomsml.types.audience_generation_job_status.serialize_json(
            value["status"]
        )
    )
...
def deserialize_json(data: dict) -> AudienceGenerationJobSummary:
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_cleanroomsml.types.audience_generation_job_status.deserialize_json(
                data["status"]
            )
        )
    else:
