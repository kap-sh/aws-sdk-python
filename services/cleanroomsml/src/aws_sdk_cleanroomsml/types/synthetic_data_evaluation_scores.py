...
if TYPE_CHECKING:
    import aws_sdk_cleanroomsml.types.data_privacy_scores


class SyntheticDataEvaluationScores(TypedDict):
    data_privacy_scores: (
        "aws_sdk_cleanroomsml.types.data_privacy_scores.DataPrivacyScores"
    )
...
def serialize_json(value: SyntheticDataEvaluationScores) -> dict:
    ...
    out["dataPrivacyScores"] = (
        aws_sdk_cleanroomsml.types.data_privacy_scores.serialize_json(
...
def deserialize_json(data: dict) -> SyntheticDataEvaluationScores:
    ...
    if "dataPrivacyScores" in data:
        ...
        out["data_privacy_scores"] = (
            aws_sdk_cleanroomsml.types.data_privacy_scores.deserialize_json(
