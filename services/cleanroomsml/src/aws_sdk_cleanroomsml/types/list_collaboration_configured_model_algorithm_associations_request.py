"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListCollaborationConfiguredModelAlgorithmAssociationsRequest``."""
...
class ListCollaborationConfiguredModelAlgorithmAssociationsRequest(TypedDict):
...
# --- restJson1 ser/de ---
def serialize_json(
    value: ListCollaborationConfiguredModelAlgorithmAssociationsRequest,
) -> dict:
    out: dict = {}
    return out
...
def deserialize_json(
    ...
    out: ListCollaborationConfiguredModelAlgorithmAssociationsRequest = {}  # type: ignore[typeddict-item]
    return out
