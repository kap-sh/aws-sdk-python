...
if TYPE_CHECKING:
    import aws_sdk_cleanroomsml.types.trained_model_export_file_type_list
...
def serialize_json(value: TrainedModelExportsConfigurationPolicy) -> dict:
    ...
    out["maxSize"] = (
        aws_sdk_cleanroomsml.types.trained_model_exports_max_size.serialize_json(
            value["max_size"]
        )
    )
    import aws_sdk_cleanroomsml.types.trained_model_export_file_type_list
    ...
    out["filesToExport"] = (
        aws_sdk_cleanroomsml.types.trained_model_export_file_type_list.serialize_json(
...
def deserialize_json(data: dict) -> TrainedModelExportsConfigurationPolicy:
    ...
    if "maxSize" in data:
        ...
        out["max_size"] = (
            aws_sdk_cleanroomsml.types.trained_model_exports_max_size.deserialize_json(
                data["maxSize"]
            )
        )
    else:
    ...
    if "filesToExport" in data:
        ...
        out["files_to_export"] = (
            aws_sdk_cleanroomsml.types.trained_model_export_file_type_list.deserialize_json(
                data["filesToExport"]
            )
        )
    else:
