...
class ProtectedQuerySQLParameters(TypedDict, closed=True):
    ...
    analysis_template_arn: NotRequired[
        "aws_sdk_cleanroomsml.types.analysis_template_arn.AnalysisTemplateArn"
    ]
    """<p>The Amazon Resource Name (ARN) associated with the analysis template within a collaboration.</p>"""
    parameters: NotRequired["aws_sdk_cleanroomsml.types.parameter_map.ParameterMap"]
...
def serialize_json(value: ProtectedQuerySQLParameters) -> dict:
    ...
    if "parameters" in value:
        ...
        out["parameters"] = aws_sdk_cleanroomsml.types.parameter_map.serialize_json(
            value["parameters"]
        )
    return out
...
def deserialize_json(data: dict) -> ProtectedQuerySQLParameters:
    ...
    if "parameters" in data:
        ...
        out["parameters"] = aws_sdk_cleanroomsml.types.parameter_map.deserialize_json(
            data["parameters"]
        )
    return out
