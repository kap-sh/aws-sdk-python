...
if TYPE_CHECKING:
    ...
    import aws_sdk_cleanroomsml.types.trained_model_export_job_status
    import aws_sdk_cleanroomsml.types.trained_model_export_output_configuration
    import aws_sdk_cleanroomsml.types.uuid


class CollaborationTrainedModelExportJobSummary(TypedDict):
    ...
    status: "aws_sdk_cleanroomsml.types.trained_model_export_job_status.TrainedModelExportJobStatus"
...
def serialize_json(value: CollaborationTrainedModelExportJobSummary) -> dict:
    ...
    out["status"] = (
        aws_sdk_cleanroomsml.types.trained_model_export_job_status.serialize_json(
            value["status"]
        )
    )
...
def deserialize_json(data: dict) -> CollaborationTrainedModelExportJobSummary:
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_cleanroomsml.types.trained_model_export_job_status.deserialize_json(
                data["status"]
            )
        )
    else:
