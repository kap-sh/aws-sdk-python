...
if TYPE_CHECKING:
    ...
    import aws_sdk_cleanroomsml.types.audience_quality_metrics
...
class GetAudienceGenerationJobResponse(TypedDict):
    ...
    seed_audience: NotRequired[
        "aws_sdk_cleanroomsml.types.audience_generation_job_data_source.AudienceGenerationJobDataSource"
    ]
    ...
    metrics: NotRequired[
        "aws_sdk_cleanroomsml.types.audience_quality_metrics.AudienceQualityMetrics"
    ]
...
def serialize_json(value: GetAudienceGenerationJobResponse) -> dict:
    ...
    if "metrics" in value:
        ...
        out["metrics"] = (
            aws_sdk_cleanroomsml.types.audience_quality_metrics.serialize_json(
                value["metrics"]
            )
        )
...
def deserialize_json(data: dict) -> GetAudienceGenerationJobResponse:
    ...
    if "metrics" in data:
        ...
        out["metrics"] = (
            aws_sdk_cleanroomsml.types.audience_quality_metrics.deserialize_json(
                data["metrics"]
            )
        )
