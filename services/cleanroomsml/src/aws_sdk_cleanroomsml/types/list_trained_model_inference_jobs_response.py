...
class ListTrainedModelInferenceJobsResponse(TypedDict):
    ...
    trained_model_inference_jobs: "aws_sdk_cleanroomsml.types.trained_model_inference_job_list.TrainedModelInferenceJobList"
...
def serialize_json(value: ListTrainedModelInferenceJobsResponse) -> dict:
    ...
    out["trainedModelInferenceJobs"] = (
        aws_sdk_cleanroomsml.types.trained_model_inference_job_list.serialize_json(
...
def deserialize_json(data: dict) -> ListTrainedModelInferenceJobsResponse:
    ...
    if "trainedModelInferenceJobs" in data:
        ...
        out["trained_model_inference_jobs"] = (
            aws_sdk_cleanroomsml.types.trained_model_inference_job_list.deserialize_json(
