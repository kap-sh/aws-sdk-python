...
if TYPE_CHECKING:
    import aws_sdk_cleanroomsml.types.ml_synthetic_data_parameters
...
class SyntheticDataConfiguration(TypedDict, closed=True):
    ...
    synthetic_data_evaluation_scores: NotRequired[
        "aws_sdk_cleanroomsml.types.synthetic_data_evaluation_scores.SyntheticDataEvaluationScores"
    ]
...
def serialize_json(value: SyntheticDataConfiguration) -> dict:
    ...
    out["syntheticDataParameters"] = (
        aws_sdk_cleanroomsml.types.ml_synthetic_data_parameters.serialize_json(
    ...
    if "synthetic_data_evaluation_scores" in value:
        ...
        out["syntheticDataEvaluationScores"] = (
            aws_sdk_cleanroomsml.types.synthetic_data_evaluation_scores.serialize_json(
...
def deserialize_json(data: dict) -> SyntheticDataConfiguration:
    ...
    if "syntheticDataParameters" in data:
        ...
        out["synthetic_data_parameters"] = (
            aws_sdk_cleanroomsml.types.ml_synthetic_data_parameters.deserialize_json(
    ...
    if "syntheticDataEvaluationScores" in data:
        ...
        out["synthetic_data_evaluation_scores"] = (
            aws_sdk_cleanroomsml.types.synthetic_data_evaluation_scores.deserialize_json(
