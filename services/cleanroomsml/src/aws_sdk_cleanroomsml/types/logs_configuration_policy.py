...
if TYPE_CHECKING:
    import aws_sdk_cleanroomsml.types.account_id_list
    import aws_sdk_cleanroomsml.types.log_redaction_configuration
    import aws_sdk_cleanroomsml.types.log_type


class LogsConfigurationPolicy(TypedDict):
    allowed_account_ids: "aws_sdk_cleanroomsml.types.account_id_list.AccountIdList"
    ...
    log_type: "aws_sdk_cleanroomsml.types.log_type.LogType"
    ...
    log_redaction_configuration: NotRequired[
        "aws_sdk_cleanroomsml.types.log_redaction_configuration.LogRedactionConfiguration"
    ]
...
def serialize_json(value: LogsConfigurationPolicy) -> dict:
    ...
    out["allowedAccountIds"] = (
        aws_sdk_cleanroomsml.types.account_id_list.serialize_json(
    ...
    out["logType"] = aws_sdk_cleanroomsml.types.log_type.serialize_json(
    ...
    if "log_redaction_configuration" in value:
        ...
        out["logRedactionConfiguration"] = (
            aws_sdk_cleanroomsml.types.log_redaction_configuration.serialize_json(
...
def deserialize_json(data: dict) -> LogsConfigurationPolicy:
    ...
    if "allowedAccountIds" in data:
        ...
        out["allowed_account_ids"] = (
            aws_sdk_cleanroomsml.types.account_id_list.deserialize_json(
    ...
    if "logType" in data:
        ...
        out["log_type"] = aws_sdk_cleanroomsml.types.log_type.deserialize_json(
            data["logType"]
        )
    else:
        out["log_type"] = "ALL"
    if "logRedactionConfiguration" in data:
        ...
        out["log_redaction_configuration"] = (
            aws_sdk_cleanroomsml.types.log_redaction_configuration.deserialize_json(
