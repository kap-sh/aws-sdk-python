...
CollaborationConfiguredModelAlgorithmAssociationList: TypeAlias = list[
    "aws_sdk_cleanroomsml.types.collaboration_configured_model_algorithm_association_summary.CollaborationConfiguredModelAlgorithmAssociationSummary"
]
...
def serialize_json(value: CollaborationConfiguredModelAlgorithmAssociationList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cleanroomsml.types.collaboration_configured_model_algorithm_association_summary.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(
    ...
    for item in data:
        out.append(
            aws_sdk_cleanroomsml.types.collaboration_configured_model_algorithm_association_summary.deserialize_json(
                item
            )
        )
    return out
