...
from aws_sdk_cleanroomsml._services._aws_config import aws_config
...
class CleanRoomsMLClient:
    ...
    def list_collaboration_configured_model_algorithm_associations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.list_collaboration_configured_model_algorithm_associations_request.ListCollaborationConfiguredModelAlgorithmAssociationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.list_collaboration_configured_model_algorithm_associations_response.ListCollaborationConfiguredModelAlgorithmAssociationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_collaboration_configured_model_algorithm_associations.list_collaboration_configured_model_algorithm_associations(
    ...
    ) -> "Iterator[aws_sdk_cleanroomsml.types.collaboration_configured_model_algorithm_association_summary.CollaborationConfiguredModelAlgorithmAssociationSummary]":
        _token = next_token
        while True:
    ...
    def list_collaboration_ml_input_channels(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_request.ListCollaborationMLInputChannelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.list_collaboration_ml_input_channels_response.ListCollaborationMLInputChannelsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_collaboration_ml_input_channels.list_collaboration_ml_input_channels(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cleanroomsml.types.collaboration_ml_input_channel_summary.CollaborationMLInputChannelSummary]":
        _token = next_token
        while True:
    ...
    def list_collaboration_trained_model_export_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.list_collaboration_trained_model_export_jobs_request.ListCollaborationTrainedModelExportJobsRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.list_collaboration_trained_model_export_jobs_response.ListCollaborationTrainedModelExportJobsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_collaboration_trained_model_export_jobs.list_collaboration_trained_model_export_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cleanroomsml.types.collaboration_trained_model_export_job_summary.CollaborationTrainedModelExportJobSummary]":
        _token = next_token
        while True:
    ...
    def list_collaboration_trained_model_inference_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.list_collaboration_trained_model_inference_jobs_request.ListCollaborationTrainedModelInferenceJobsRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.list_collaboration_trained_model_inference_jobs_response.ListCollaborationTrainedModelInferenceJobsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_collaboration_trained_model_inference_jobs.list_collaboration_trained_model_inference_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cleanroomsml.types.collaboration_trained_model_inference_job_summary.CollaborationTrainedModelInferenceJobSummary]":
        _token = next_token
        while True:
    ...
    def list_collaboration_trained_models(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.list_collaboration_trained_models_request.ListCollaborationTrainedModelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.list_collaboration_trained_models_response.ListCollaborationTrainedModelsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_collaboration_trained_models.list_collaboration_trained_models(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cleanroomsml.types.collaboration_trained_model_summary.CollaborationTrainedModelSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
