...
class AudienceExportJob:
    ...
    def create(self, name: "aws_sdk_cleanroomsml.types.name_string.NameString", audience_generation_job_arn: "aws_sdk_cleanroomsml.types.audience_generation_job_arn.AudienceGenerationJobArn", audience_size: "aws_sdk_cleanroomsml.types.audience_size.AudienceSize", *, config_overrides: Optional[CleanRoomsMLClientConfig] = None, description: Optional["aws_sdk_cleanroomsml.types.resource_description.ResourceDescription"] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cleanroomsml.types.start_audience_export_job_request.StartAudienceExportJobRequest]') -> OperationResponse[None]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.start_audience_export_job
            output, http_response = aws_sdk_cleanroomsml._operations.aws_stark_control_service.start_audience_export_job.start_audience_export_job(req.options, req.input)
    ...
    def list(self, *, config_overrides: Optional[CleanRoomsMLClientConfig] = None, next_token: Optional["aws_sdk_cleanroomsml.types.next_token.NextToken"] = None, max_results: Optional["aws_sdk_cleanroomsml.types.max_results.MaxResults"] = None, audience_generation_job_arn: Optional["aws_sdk_cleanroomsml.types.audience_generation_job_arn.AudienceGenerationJobArn"] = None) -> "aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.ListAudienceExportJobsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cleanroomsml.types.list_audience_export_jobs_request.ListAudienceExportJobsRequest]') -> OperationResponse["aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.ListAudienceExportJobsResponse"]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_audience_export_jobs
            output, http_response = aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_audience_export_jobs.list_audience_export_jobs(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
...
class AsyncAudienceExportJob:
    def __init__(self, service: AsyncCleanRoomsMLClient) -> None:
        self._service = service
    async def create(self, name: "aws_sdk_cleanroomsml.types.name_string.NameString", audience_generation_job_arn: "aws_sdk_cleanroomsml.types.audience_generation_job_arn.AudienceGenerationJobArn", audience_size: "aws_sdk_cleanroomsml.types.audience_size.AudienceSize", *, config_overrides: Optional[AsyncCleanRoomsMLClientConfig] = None, description: Optional["aws_sdk_cleanroomsml.types.resource_description.ResourceDescription"] = None) -> None:
        """<p>Export an audience of a specified size after you have generated an audience.</p>
        ...
        Args:
            ...
            description: <p>The description of the audience export job.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cleanroomsml.types.start_audience_export_job_request.StartAudienceExportJobRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.start_audience_export_job
            output, http_response = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.start_audience_export_job.async_start_audience_export_job(req.options, req.input)
    ...
    async def list(self, *, config_overrides: Optional[AsyncCleanRoomsMLClientConfig] = None, next_token: Optional["aws_sdk_cleanroomsml.types.next_token.NextToken"] = None, max_results: Optional["aws_sdk_cleanroomsml.types.max_results.MaxResults"] = None, audience_generation_job_arn: Optional["aws_sdk_cleanroomsml.types.audience_generation_job_arn.AudienceGenerationJobArn"] = None) -> "aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.ListAudienceExportJobsResponse":
        ...
        Args:
            ...
            audience_generation_job_arn: <p>The Amazon Resource Name (ARN) of the audience generation job that you are interested in.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cleanroomsml.types.list_audience_export_jobs_request.ListAudienceExportJobsRequest]') -> AsyncOperationResponse["aws_sdk_cleanroomsml.types.list_audience_export_jobs_response.ListAudienceExportJobsResponse"]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_audience_export_jobs
            output, http_response = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_audience_export_jobs.async_list_audience_export_jobs(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
