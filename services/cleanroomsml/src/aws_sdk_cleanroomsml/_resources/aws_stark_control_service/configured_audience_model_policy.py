...
class ConfiguredAudienceModelPolicy:
    ...
    def put(
        ...
        configured_audience_model_policy: "aws_sdk_cleanroomsml.types.resource_policy.ResourcePolicy",
        *,
        config_overrides: Optional[CleanRoomsMLClientConfig] = None,
        previous_policy_hash: Optional["aws_sdk_cleanroomsml.types.hash.Hash"] = None,
        policy_existence_condition: Optional[
            "aws_sdk_cleanroomsml.types.policy_existence_condition.PolicyExistenceCondition"
        ] = None,
    ) -> "aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response.PutConfiguredAudienceModelPolicyResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_request.PutConfiguredAudienceModelPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response.PutConfiguredAudienceModelPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.put_configured_audience_model_policy.put_configured_audience_model_policy(
    ...
    def read(
        ...
        *,
        config_overrides: Optional[CleanRoomsMLClientConfig] = None,
    ) -> "aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_response.GetConfiguredAudienceModelPolicyResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_request.GetConfiguredAudienceModelPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_response.GetConfiguredAudienceModelPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_configured_audience_model_policy.get_configured_audience_model_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.delete_configured_audience_model_policy_request.DeleteConfiguredAudienceModelPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.delete_configured_audience_model_policy

            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.delete_configured_audience_model_policy.delete_configured_audience_model_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncConfiguredAudienceModelPolicy:
    ...
    async def put(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_request.PutConfiguredAudienceModelPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanroomsml.types.put_configured_audience_model_policy_response.PutConfiguredAudienceModelPolicyResponse"
        ]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.put_configured_audience_model_policy
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.put_configured_audience_model_policy.async_put_configured_audience_model_policy(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_request.GetConfiguredAudienceModelPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanroomsml.types.get_configured_audience_model_policy_response.GetConfiguredAudienceModelPolicyResponse"
        ]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_configured_audience_model_policy
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_configured_audience_model_policy.async_get_configured_audience_model_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.delete_configured_audience_model_policy_request.DeleteConfiguredAudienceModelPolicyRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.delete_configured_audience_model_policy.async_delete_configured_audience_model_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
