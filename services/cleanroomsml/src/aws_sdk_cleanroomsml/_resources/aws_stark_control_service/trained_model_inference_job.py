...
class TrainedModelInferenceJob:
    ...
    def create(self, membership_identifier: "aws_sdk_cleanroomsml.types.uuid.UUID", name: "aws_sdk_cleanroomsml.types.name_string.NameString", trained_model_arn: "aws_sdk_cleanroomsml.types.trained_model_arn.TrainedModelArn", resource_config: "aws_sdk_cleanroomsml.types.inference_resource_config.InferenceResourceConfig", output_configuration: "aws_sdk_cleanroomsml.types.inference_output_configuration.InferenceOutputConfiguration", data_source: "aws_sdk_cleanroomsml.types.model_inference_data_source.ModelInferenceDataSource", *, config_overrides: Optional[CleanRoomsMLClientConfig] = None, trained_model_version_identifier: Optional["aws_sdk_cleanroomsml.types.uuid.UUID"] = None, configured_model_algorithm_association_arn: Optional["aws_sdk_cleanroomsml.types.configured_model_algorithm_association_arn.ConfiguredModelAlgorithmAssociationArn"] = None, description: Optional["aws_sdk_cleanroomsml.types.resource_description.ResourceDescription"] = None, container_execution_parameters: Optional["aws_sdk_cleanroomsml.types.inference_container_execution_parameters.InferenceContainerExecutionParameters"] = None, environment: Optional["aws_sdk_cleanroomsml.types.inference_environment_map.InferenceEnvironmentMap"] = None, kms_key_arn: Optional["aws_sdk_cleanroomsml.types.kms_key_arn.KmsKeyArn"] = None, tags: Optional["aws_sdk_cleanroomsml.types.tag_map.TagMap"] = None, ml_model_inference_payer_account_id: Optional["aws_sdk_cleanroomsml.types.account_id.AccountId"] = None) -> "aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.StartTrainedModelInferenceJobResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cleanroomsml.types.start_trained_model_inference_job_request.StartTrainedModelInferenceJobRequest]') -> OperationResponse["aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.StartTrainedModelInferenceJobResponse"]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.start_trained_model_inference_job
            output, http_response = aws_sdk_cleanroomsml._operations.aws_stark_control_service.start_trained_model_inference_job.start_trained_model_inference_job(req.options, req.input)
        ...
        if ml_model_inference_payer_account_id is not None:
            input["ml_model_inference_payer_account_id"] = ml_model_inference_payer_account_id

        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def read(self, membership_identifier: "aws_sdk_cleanroomsml.types.uuid.UUID", trained_model_inference_job_arn: "aws_sdk_cleanroomsml.types.trained_model_inference_job_arn.TrainedModelInferenceJobArn", *, config_overrides: Optional[CleanRoomsMLClientConfig] = None) -> "aws_sdk_cleanroomsml.types.get_trained_model_inference_job_response.GetTrainedModelInferenceJobResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cleanroomsml.types.get_trained_model_inference_job_request.GetTrainedModelInferenceJobRequest]') -> OperationResponse["aws_sdk_cleanroomsml.types.get_trained_model_inference_job_response.GetTrainedModelInferenceJobResponse"]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_trained_model_inference_job
            output, http_response = aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_trained_model_inference_job.get_trained_model_inference_job(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list(self, membership_identifier: "aws_sdk_cleanroomsml.types.uuid.UUID", *, config_overrides: Optional[CleanRoomsMLClientConfig] = None, next_token: Optional["aws_sdk_cleanroomsml.types.next_token.NextToken"] = None, max_results: Optional["aws_sdk_cleanroomsml.types.max_results.MaxResults"] = None, trained_model_arn: Optional["aws_sdk_cleanroomsml.types.trained_model_arn.TrainedModelArn"] = None, trained_model_version_identifier: Optional["aws_sdk_cleanroomsml.types.uuid.UUID"] = None) -> "aws_sdk_cleanroomsml.types.list_trained_model_inference_jobs_response.ListTrainedModelInferenceJobsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cleanroomsml.types.list_trained_model_inference_jobs_request.ListTrainedModelInferenceJobsRequest]') -> OperationResponse["aws_sdk_cleanroomsml.types.list_trained_model_inference_jobs_response.ListTrainedModelInferenceJobsResponse"]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_trained_model_inference_jobs
            output, http_response = aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_trained_model_inference_jobs.list_trained_model_inference_jobs(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def cancel_trained_model_inference_job(self, membership_identifier: "aws_sdk_cleanroomsml.types.uuid.UUID", trained_model_inference_job_arn: "aws_sdk_cleanroomsml.types.trained_model_inference_job_arn.TrainedModelInferenceJobArn", *, config_overrides: Optional[CleanRoomsMLClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cleanroomsml.types.cancel_trained_model_inference_job_request.CancelTrainedModelInferenceJobRequest]') -> OperationResponse[None]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.cancel_trained_model_inference_job
            output, http_response = aws_sdk_cleanroomsml._operations.aws_stark_control_service.cancel_trained_model_inference_job.cancel_trained_model_inference_job(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
...
class AsyncTrainedModelInferenceJob:
    def __init__(self, service: AsyncCleanRoomsMLClient) -> None:
        self._service = service
    async def create(self, membership_identifier: "aws_sdk_cleanroomsml.types.uuid.UUID", name: "aws_sdk_cleanroomsml.types.name_string.NameString", trained_model_arn: "aws_sdk_cleanroomsml.types.trained_model_arn.TrainedModelArn", resource_config: "aws_sdk_cleanroomsml.types.inference_resource_config.InferenceResourceConfig", output_configuration: "aws_sdk_cleanroomsml.types.inference_output_configuration.InferenceOutputConfiguration", data_source: "aws_sdk_cleanroomsml.types.model_inference_data_source.ModelInferenceDataSource", *, config_overrides: Optional[AsyncCleanRoomsMLClientConfig] = None, trained_model_version_identifier: Optional["aws_sdk_cleanroomsml.types.uuid.UUID"] = None, configured_model_algorithm_association_arn: Optional["aws_sdk_cleanroomsml.types.configured_model_algorithm_association_arn.ConfiguredModelAlgorithmAssociationArn"] = None, description: Optional["aws_sdk_cleanroomsml.types.resource_description.ResourceDescription"] = None, container_execution_parameters: Optional["aws_sdk_cleanroomsml.types.inference_container_execution_parameters.InferenceContainerExecutionParameters"] = None, environment: Optional["aws_sdk_cleanroomsml.types.inference_environment_map.InferenceEnvironmentMap"] = None, kms_key_arn: Optional["aws_sdk_cleanroomsml.types.kms_key_arn.KmsKeyArn"] = None, tags: Optional["aws_sdk_cleanroomsml.types.tag_map.TagMap"] = None, ml_model_inference_payer_account_id: Optional["aws_sdk_cleanroomsml.types.account_id.AccountId"] = None) -> "aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.StartTrainedModelInferenceJobResponse":
        """<p>Defines the information necessary to begin a trained model inference job.</p>
        ...
        Args:
            ...
            ml_model_inference_payer_account_id: <p>The account ID of the member that is responsible for paying for model inference costs.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cleanroomsml.types.start_trained_model_inference_job_request.StartTrainedModelInferenceJobRequest]') -> AsyncOperationResponse["aws_sdk_cleanroomsml.types.start_trained_model_inference_job_response.StartTrainedModelInferenceJobResponse"]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.start_trained_model_inference_job
            output, http_response = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.start_trained_model_inference_job.async_start_trained_model_inference_job(req.options, req.input)
        ...
        return response.output
    async def read(self, membership_identifier: "aws_sdk_cleanroomsml.types.uuid.UUID", trained_model_inference_job_arn: "aws_sdk_cleanroomsml.types.trained_model_inference_job_arn.TrainedModelInferenceJobArn", *, config_overrides: Optional[AsyncCleanRoomsMLClientConfig] = None) -> "aws_sdk_cleanroomsml.types.get_trained_model_inference_job_response.GetTrainedModelInferenceJobResponse":
        """<p>Returns information about a trained model inference job.</p>
        ...
        Args:
            ...
            trained_model_inference_job_arn: <p>Provides the Amazon Resource Name (ARN) of the trained model inference job that you are interested in.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cleanroomsml.types.get_trained_model_inference_job_request.GetTrainedModelInferenceJobRequest]') -> AsyncOperationResponse["aws_sdk_cleanroomsml.types.get_trained_model_inference_job_response.GetTrainedModelInferenceJobResponse"]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_trained_model_inference_job
            output, http_response = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_trained_model_inference_job.async_get_trained_model_inference_job(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(self, membership_identifier: "aws_sdk_cleanroomsml.types.uuid.UUID", *, config_overrides: Optional[AsyncCleanRoomsMLClientConfig] = None, next_token: Optional["aws_sdk_cleanroomsml.types.next_token.NextToken"] = None, max_results: Optional["aws_sdk_cleanroomsml.types.max_results.MaxResults"] = None, trained_model_arn: Optional["aws_sdk_cleanroomsml.types.trained_model_arn.TrainedModelArn"] = None, trained_model_version_identifier: Optional["aws_sdk_cleanroomsml.types.uuid.UUID"] = None) -> "aws_sdk_cleanroomsml.types.list_trained_model_inference_jobs_response.ListTrainedModelInferenceJobsResponse":
        ...
        Args:
            ...
            trained_model_version_identifier: <p>The version identifier of the trained model to filter inference jobs by. When specified, only inference jobs that used this specific version of the trained model are returned.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cleanroomsml.types.list_trained_model_inference_jobs_request.ListTrainedModelInferenceJobsRequest]') -> AsyncOperationResponse["aws_sdk_cleanroomsml.types.list_trained_model_inference_jobs_response.ListTrainedModelInferenceJobsResponse"]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_trained_model_inference_jobs
            output, http_response = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_trained_model_inference_jobs.async_list_trained_model_inference_jobs(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def cancel_trained_model_inference_job(self, membership_identifier: "aws_sdk_cleanroomsml.types.uuid.UUID", trained_model_inference_job_arn: "aws_sdk_cleanroomsml.types.trained_model_inference_job_arn.TrainedModelInferenceJobArn", *, config_overrides: Optional[AsyncCleanRoomsMLClientConfig] = None) -> None:
        """<p>Submits a request to cancel a trained model inference job.</p>
        ...
        Args:
            ...
            trained_model_inference_job_arn: <p>The Amazon Resource Name (ARN) of the trained model inference job that you want to cancel.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cleanroomsml.types.cancel_trained_model_inference_job_request.CancelTrainedModelInferenceJobRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.cancel_trained_model_inference_job
            output, http_response = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.cancel_trained_model_inference_job.async_cancel_trained_model_inference_job(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
