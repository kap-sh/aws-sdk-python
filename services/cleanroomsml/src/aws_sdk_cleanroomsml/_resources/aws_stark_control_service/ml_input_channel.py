...
class MLInputChannel:
    ...
    def create(
        ...
        *,
    ...
    ) -> "aws_sdk_cleanroomsml.types.create_ml_input_channel_response.CreateMLInputChannelResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.create_ml_input_channel_request.CreateMLInputChannelRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.create_ml_input_channel_response.CreateMLInputChannelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.create_ml_input_channel.create_ml_input_channel(
    ...
    def read(
        self,
        ml_input_channel_arn: "aws_sdk_cleanroomsml.types.ml_input_channel_arn.MLInputChannelArn",
        membership_identifier: "aws_sdk_cleanroomsml.types.uuid.UUID",
        *,
        config_overrides: Optional[CleanRoomsMLClientConfig] = None,
    ) -> "aws_sdk_cleanroomsml.types.get_ml_input_channel_response.GetMLInputChannelResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.get_ml_input_channel_request.GetMLInputChannelRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.get_ml_input_channel_response.GetMLInputChannelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_ml_input_channel.get_ml_input_channel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.delete_ml_input_channel_data_request.DeleteMLInputChannelDataRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.delete_ml_input_channel_data

            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.delete_ml_input_channel_data.delete_ml_input_channel_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_cleanroomsml.types.list_ml_input_channels_response.ListMLInputChannelsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.list_ml_input_channels_request.ListMLInputChannelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.list_ml_input_channels_response.ListMLInputChannelsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_ml_input_channels.list_ml_input_channels(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_collaboration_ml_input_channel(
        ...
        *,
        config_overrides: Optional[CleanRoomsMLClientConfig] = None,
    ) -> "aws_sdk_cleanroomsml.types.get_collaboration_ml_input_channel_response.GetCollaborationMLInputChannelResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.get_collaboration_ml_input_channel_request.GetCollaborationMLInputChannelRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.get_collaboration_ml_input_channel_response.GetCollaborationMLInputChannelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_collaboration_ml_input_channel.get_collaboration_ml_input_channel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncMLInputChannel:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.create_ml_input_channel_request.CreateMLInputChannelRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanroomsml.types.create_ml_input_channel_response.CreateMLInputChannelResponse"
        ]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.create_ml_input_channel
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.create_ml_input_channel.async_create_ml_input_channel(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.get_ml_input_channel_request.GetMLInputChannelRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanroomsml.types.get_ml_input_channel_response.GetMLInputChannelResponse"
        ]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_ml_input_channel
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_ml_input_channel.async_get_ml_input_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.delete_ml_input_channel_data_request.DeleteMLInputChannelDataRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.delete_ml_input_channel_data.async_delete_ml_input_channel_data(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.list_ml_input_channels_request.ListMLInputChannelsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanroomsml.types.list_ml_input_channels_response.ListMLInputChannelsResponse"
        ]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_ml_input_channels
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_ml_input_channels.async_list_ml_input_channels(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_collaboration_ml_input_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.get_collaboration_ml_input_channel_request.GetCollaborationMLInputChannelRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanroomsml.types.get_collaboration_ml_input_channel_response.GetCollaborationMLInputChannelResponse"
        ]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_collaboration_ml_input_channel
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_collaboration_ml_input_channel.async_get_collaboration_ml_input_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
