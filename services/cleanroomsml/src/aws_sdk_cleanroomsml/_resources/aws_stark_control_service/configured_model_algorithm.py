...
class ConfiguredModelAlgorithm:
    ...
    def create(
        ...
        *,
    ...
    ) -> "aws_sdk_cleanroomsml.types.create_configured_model_algorithm_response.CreateConfiguredModelAlgorithmResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.create_configured_model_algorithm_request.CreateConfiguredModelAlgorithmRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.create_configured_model_algorithm_response.CreateConfiguredModelAlgorithmResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.create_configured_model_algorithm.create_configured_model_algorithm(
        ...
        input_: aws_sdk_cleanroomsml.types.create_configured_model_algorithm_request.CreateConfiguredModelAlgorithmRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
    ...
    def read(
        ...
        *,
        config_overrides: Optional[CleanRoomsMLClientConfig] = None,
    ) -> "aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response.GetConfiguredModelAlgorithmResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.get_configured_model_algorithm_request.GetConfiguredModelAlgorithmRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response.GetConfiguredModelAlgorithmResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_configured_model_algorithm.get_configured_model_algorithm(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_cleanroomsml.types.get_configured_model_algorithm_request.GetConfiguredModelAlgorithmRequest = {}  # type: ignore[typeddict-item]
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.delete_configured_model_algorithm_request.DeleteConfiguredModelAlgorithmRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.delete_configured_model_algorithm

            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.delete_configured_model_algorithm.delete_configured_model_algorithm(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_cleanroomsml.types.delete_configured_model_algorithm_request.DeleteConfiguredModelAlgorithmRequest = {}  # type: ignore[typeddict-item]
        input_["configured_model_algorithm_arn"] = configured_model_algorithm_arn
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response.ListConfiguredModelAlgorithmsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanroomsml.types.list_configured_model_algorithms_request.ListConfiguredModelAlgorithmsRequest]",
        ) -> OperationResponse[
            "aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response.ListConfiguredModelAlgorithmsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_configured_model_algorithms.list_configured_model_algorithms(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_cleanroomsml.types.list_configured_model_algorithms_request.ListConfiguredModelAlgorithmsRequest = {}  # type: ignore[typeddict-item]
...
class AsyncConfiguredModelAlgorithm:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.create_configured_model_algorithm_request.CreateConfiguredModelAlgorithmRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanroomsml.types.create_configured_model_algorithm_response.CreateConfiguredModelAlgorithmResponse"
        ]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.create_configured_model_algorithm
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.create_configured_model_algorithm.async_create_configured_model_algorithm(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.get_configured_model_algorithm_request.GetConfiguredModelAlgorithmRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanroomsml.types.get_configured_model_algorithm_response.GetConfiguredModelAlgorithmResponse"
        ]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_configured_model_algorithm
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.get_configured_model_algorithm.async_get_configured_model_algorithm(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.delete_configured_model_algorithm_request.DeleteConfiguredModelAlgorithmRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.delete_configured_model_algorithm.async_delete_configured_model_algorithm(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanroomsml.types.list_configured_model_algorithms_request.ListConfiguredModelAlgorithmsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanroomsml.types.list_configured_model_algorithms_response.ListConfiguredModelAlgorithmsResponse"
        ]:
            import aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_configured_model_algorithms
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanroomsml._operations.aws_stark_control_service.list_configured_model_algorithms.async_list_configured_model_algorithms(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
