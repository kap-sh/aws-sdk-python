"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cleanroomsml#ResourceNotFoundException``."""
