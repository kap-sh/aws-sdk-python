...
class CleanRoomsMLError(Exception):
    """Base class for all CleanRoomsML service errors."""


class ServiceError(CleanRoomsMLError):
...
class SerializationError(CleanRoomsMLError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CleanRoomsMLError):
...
class WaiterFailedError(CleanRoomsMLError):
...
class WaiterTimeoutError(CleanRoomsMLError):
