...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_audience_generation_jobs_response.ListAudienceGenerationJobsResponse = capo_cleanroomsml.types.list_audience_generation_jobs_response.deserialize_json(
