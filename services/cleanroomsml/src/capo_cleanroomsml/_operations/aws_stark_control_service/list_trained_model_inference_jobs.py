...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_trained_model_inference_jobs_response.ListTrainedModelInferenceJobsResponse = capo_cleanroomsml.types.list_trained_model_inference_jobs_response.deserialize_json(
