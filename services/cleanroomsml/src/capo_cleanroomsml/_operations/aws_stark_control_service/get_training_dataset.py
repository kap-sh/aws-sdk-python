...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_training_dataset_response.GetTrainingDatasetResponse = capo_cleanroomsml.types.get_training_dataset_response.deserialize_json(
