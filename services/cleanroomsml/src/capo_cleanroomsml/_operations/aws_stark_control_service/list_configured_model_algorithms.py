...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_configured_model_algorithms_response.ListConfiguredModelAlgorithmsResponse = capo_cleanroomsml.types.list_configured_model_algorithms_response.deserialize_json(
