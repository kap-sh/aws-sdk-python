...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_configured_model_algorithm_association_response.GetConfiguredModelAlgorithmAssociationResponse = capo_cleanroomsml.types.get_configured_model_algorithm_association_response.deserialize_json(
