...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_configured_audience_model_policy_response.GetConfiguredAudienceModelPolicyResponse = capo_cleanroomsml.types.get_configured_audience_model_policy_response.deserialize_json(
