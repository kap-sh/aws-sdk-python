"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetConfiguredModelAlgorithm``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_configured_model_algorithm_response.GetConfiguredModelAlgorithmResponse = capo_cleanroomsml.types.get_configured_model_algorithm_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["configured_model_algorithm_arn"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_configured_model_algorithm(
