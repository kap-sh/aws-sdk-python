"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetAudienceModel``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_audience_model_response.GetAudienceModelResponse = capo_cleanroomsml.types.get_audience_model_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{audienceModelArn}", quote(str(input_["audience_model_arn"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_get_audience_model(
