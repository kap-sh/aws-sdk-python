"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetTrainedModelInferenceJob``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_trained_model_inference_job_response.GetTrainedModelInferenceJobResponse = capo_cleanroomsml.types.get_trained_model_inference_job_response.deserialize_json(
...
async def async_get_trained_model_inference_job(
