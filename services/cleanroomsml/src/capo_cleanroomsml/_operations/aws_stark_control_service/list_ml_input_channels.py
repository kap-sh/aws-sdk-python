"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListMLInputChannels``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_ml_input_channels_response.ListMLInputChannelsResponse = capo_cleanroomsml.types.list_ml_input_channels_response.deserialize_json(
...
async def async_list_ml_input_channels(
