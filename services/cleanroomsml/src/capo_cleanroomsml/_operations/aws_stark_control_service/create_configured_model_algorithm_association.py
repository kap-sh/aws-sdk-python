...
def handle_response(
    ...
    out: capo_cleanroomsml.types.create_configured_model_algorithm_association_response.CreateConfiguredModelAlgorithmAssociationResponse = capo_cleanroomsml.types.create_configured_model_algorithm_association_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.create_configured_model_algorithm_association_request.serialize_json(
            input_
        )
    ).encode()
