...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_collaboration_ml_input_channel_response.GetCollaborationMLInputChannelResponse = capo_cleanroomsml.types.get_collaboration_ml_input_channel_response.deserialize_json(
