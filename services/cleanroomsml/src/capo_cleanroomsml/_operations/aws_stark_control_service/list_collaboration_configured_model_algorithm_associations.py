"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListCollaborationConfiguredModelAlgorithmAssociations``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_collaboration_configured_model_algorithm_associations_response.ListCollaborationConfiguredModelAlgorithmAssociationsResponse = capo_cleanroomsml.types.list_collaboration_configured_model_algorithm_associations_response.deserialize_json(
...
async def async_list_collaboration_configured_model_algorithm_associations(
