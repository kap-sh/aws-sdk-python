"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListCollaborationTrainedModelExportJobs``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_collaboration_trained_model_export_jobs_response.ListCollaborationTrainedModelExportJobsResponse = capo_cleanroomsml.types.list_collaboration_trained_model_export_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{trainedModelArn}", quote(str(input_["trained_model_arn"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_list_collaboration_trained_model_export_jobs(
