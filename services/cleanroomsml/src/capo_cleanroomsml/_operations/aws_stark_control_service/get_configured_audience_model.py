...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_configured_audience_model_response.GetConfiguredAudienceModelResponse = capo_cleanroomsml.types.get_configured_audience_model_response.deserialize_json(
