"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#CreateMLInputChannel``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.create_ml_input_channel_response.CreateMLInputChannelResponse = capo_cleanroomsml.types.create_ml_input_channel_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.create_ml_input_channel_request.serialize_json(input_)
    ).encode()
...
async def async_create_ml_input_channel(
