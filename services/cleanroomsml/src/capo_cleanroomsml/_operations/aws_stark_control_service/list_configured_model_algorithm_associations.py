...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_configured_model_algorithm_associations_response.ListConfiguredModelAlgorithmAssociationsResponse = capo_cleanroomsml.types.list_configured_model_algorithm_associations_response.deserialize_json(
