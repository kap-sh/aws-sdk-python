...
def handle_response(
    ...
    out: capo_cleanroomsml.types.update_configured_audience_model_response.UpdateConfiguredAudienceModelResponse = capo_cleanroomsml.types.update_configured_audience_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.update_configured_audience_model_request.serialize_json(
            input_
        )
    ).encode()
