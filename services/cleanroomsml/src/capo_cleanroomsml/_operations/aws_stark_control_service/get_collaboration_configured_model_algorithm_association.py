"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetCollaborationConfiguredModelAlgorithmAssociation``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_collaboration_configured_model_algorithm_association_response.GetCollaborationConfiguredModelAlgorithmAssociationResponse = capo_cleanroomsml.types.get_collaboration_configured_model_algorithm_association_response.deserialize_json(
...
async def async_get_collaboration_configured_model_algorithm_association(
