"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetTrainedModel``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_trained_model_response.GetTrainedModelResponse = (
        capo_cleanroomsml.types.get_trained_model_response.deserialize_json(
...
async def async_get_trained_model(
