"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#CreateTrainedModel``."""
...
import capo_cleanroomsml.errors.internal_service_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalServiceException":
            raise capo_cleanroomsml.errors.internal_service_exception.InternalServiceException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.create_trained_model_response.CreateTrainedModelResponse = capo_cleanroomsml.types.create_trained_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.create_trained_model_request.serialize_json(input_)
    ).encode()
...
async def async_create_trained_model(
