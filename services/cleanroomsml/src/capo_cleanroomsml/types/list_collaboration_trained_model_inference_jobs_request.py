"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListCollaborationTrainedModelInferenceJobsRequest``."""
...
class ListCollaborationTrainedModelInferenceJobsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListCollaborationTrainedModelInferenceJobsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListCollaborationTrainedModelInferenceJobsRequest:
    out: ListCollaborationTrainedModelInferenceJobsRequest = {}  # type: ignore[typeddict-item]
    return out
