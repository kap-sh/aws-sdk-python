...
class ListRoomsRequest(TypedDict, closed=True):
    ...
    max_results: NotRequired["capo_ivschat.types.max_room_results.MaxRoomResults"]
    """<p>Maximum number of rooms to return. Default: 50.</p>"""
    message_review_handler_uri: NotRequired["capo_ivschat.types.lambda_arn.LambdaArn"]
