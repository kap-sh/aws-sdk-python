...
class ivschatError(Exception):
    """Base class for all ivschat service errors."""


class ServiceError(ivschatError):
...
class SerializationError(ivschatError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ivschatError):
...
class WaiterFailedError(ivschatError):
...
class WaiterTimeoutError(ivschatError):
