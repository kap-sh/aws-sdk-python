...
def serialize_json(value: CreateChatTokenRequest) -> dict:
    ...
    if "capabilities" in value:
        ...
        out["capabilities"] = (
            aws_sdk_ivschat.types.chat_token_capabilities.serialize_json(
                value["capabilities"]
            )
        )
    ...
    if "attributes" in value:
        ...
        out["attributes"] = aws_sdk_ivschat.types.chat_token_attributes.serialize_json(
            value["attributes"]
        )
    return out
...
def deserialize_json(data: dict) -> CreateChatTokenRequest:
    ...
    if "capabilities" in data:
        ...
        out["capabilities"] = (
            aws_sdk_ivschat.types.chat_token_capabilities.deserialize_json(
                data["capabilities"]
            )
        )
    ...
    if "attributes" in data:
        ...
        out["attributes"] = (
            aws_sdk_ivschat.types.chat_token_attributes.deserialize_json(
                data["attributes"]
            )
        )
    return out
