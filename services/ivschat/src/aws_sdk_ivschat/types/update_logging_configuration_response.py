"""Generated from Smithy shape ``com.amazonaws.ivschat#UpdateLoggingConfigurationResponse``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_ivschat.types.update_logging_configuration_state
...
class UpdateLoggingConfigurationResponse(TypedDict):
    ...
    state: NotRequired[
        "aws_sdk_ivschat.types.update_logging_configuration_state.UpdateLoggingConfigurationState"
    ]
