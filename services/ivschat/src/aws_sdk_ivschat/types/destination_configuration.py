...
if TYPE_CHECKING:
    import aws_sdk_ivschat.types.cloud_watch_logs_destination_configuration
    import aws_sdk_ivschat.types.firehose_destination_configuration
...
def serialize_json(value: DestinationConfiguration) -> dict:
    if "s3" in value:
        ...
        return {
            "s3": aws_sdk_ivschat.types.s3_destination_configuration.serialize_json(
                value["s3"]
            )
        }
        ...
        return {
            "cloudWatchLogs": aws_sdk_ivschat.types.cloud_watch_logs_destination_configuration.serialize_json(
        ...
        return {
            "firehose": aws_sdk_ivschat.types.firehose_destination_configuration.serialize_json(
                value["firehose"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> DestinationConfiguration:
    if "s3" in data:
        ...
        return {
            "s3": aws_sdk_ivschat.types.s3_destination_configuration.deserialize_json(
                data["s3"]
            )
        }
        ...
        return {
            "cloudWatchLogs": aws_sdk_ivschat.types.cloud_watch_logs_destination_configuration.deserialize_json(
                data["cloudWatchLogs"]
            )
        }
        ...
        return {
            "firehose": aws_sdk_ivschat.types.firehose_destination_configuration.deserialize_json(
                data["firehose"]
            )
        }
    else:
