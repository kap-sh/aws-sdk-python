"""Generated from Smithy shape ``com.amazonaws.ivschat#DeleteMessage``."""
...
import aws_sdk_ivschat.errors.throttling_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ThrottlingException":
            raise aws_sdk_ivschat.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ivschat.types.delete_message_response.DeleteMessageResponse = (
        aws_sdk_ivschat.types.delete_message_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.delete_message_request.DeleteMessageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteMessage"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.delete_message_request.serialize_json(input_)
    ).encode()
...
def delete_message(
    ...
    aws_sdk_ivschat.types.delete_message_response.DeleteMessageResponse, zapros.Response
]:
