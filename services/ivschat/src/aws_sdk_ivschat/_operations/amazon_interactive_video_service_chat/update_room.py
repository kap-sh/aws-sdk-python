"""Generated from Smithy shape ``com.amazonaws.ivschat#UpdateRoom``."""
...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.update_room_request.UpdateRoomRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/UpdateRoom"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivschat.types.update_room_request

    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.update_room_request.serialize_json(input_)
    ).encode()
...
def update_room(
    ...
    aws_sdk_ivschat.types.update_room_response.UpdateRoomResponse, zapros.Response
]:
