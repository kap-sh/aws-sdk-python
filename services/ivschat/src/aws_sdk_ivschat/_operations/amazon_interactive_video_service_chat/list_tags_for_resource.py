"""Generated from Smithy shape ``com.amazonaws.ivschat#ListTagsForResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InternalServerException":
            import aws_sdk_ivschat.errors.internal_server_exception

            raise aws_sdk_ivschat.errors.internal_server_exception.InternalServerException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ivschat.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_ivschat.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
