...
def handle_response(
    ...
    out: aws_sdk_ivschat.types.update_logging_configuration_response.UpdateLoggingConfigurationResponse = aws_sdk_ivschat.types.update_logging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_ivschat.types.update_logging_configuration_request.UpdateLoggingConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.update_logging_configuration_request.serialize_json(input)
    ).encode()
