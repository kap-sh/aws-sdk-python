...
def handle_response(
    ...
    out: aws_sdk_ivschat.types.create_chat_token_response.CreateChatTokenResponse = (
        aws_sdk_ivschat.types.create_chat_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.create_chat_token_request.CreateChatTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.create_chat_token_request.serialize_json(input_)
    ).encode()
