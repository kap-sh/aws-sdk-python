...
def handle_response(
    ...
    out: aws_sdk_ivschat.types.disconnect_user_response.DisconnectUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.disconnect_user_request.DisconnectUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.disconnect_user_request.serialize_json(input_)
    ).encode()
