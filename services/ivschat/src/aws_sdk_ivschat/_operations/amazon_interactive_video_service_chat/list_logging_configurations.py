...
def build_request(
    ...
    input: aws_sdk_ivschat.types.list_logging_configurations_request.ListLoggingConfigurationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.list_logging_configurations_request.serialize_json(input)
    ).encode()
