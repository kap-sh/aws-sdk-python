...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.list_logging_configurations_request.ListLoggingConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.list_logging_configurations_request.serialize_json(input_)
    ).encode()
