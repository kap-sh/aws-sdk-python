...
def build_request(
    ...
    input: aws_sdk_ivschat.types.get_logging_configuration_request.GetLoggingConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.get_logging_configuration_request.serialize_json(input)
    ).encode()
