...
def handle_response(
    ...
    out: aws_sdk_ivschat.types.create_room_response.CreateRoomResponse = (
        aws_sdk_ivschat.types.create_room_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.create_room_request.CreateRoomRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.create_room_request.serialize_json(input_)
    ).encode()
...
def create_room(
    ...
    aws_sdk_ivschat.types.create_room_response.CreateRoomResponse, zapros.Response
]:
