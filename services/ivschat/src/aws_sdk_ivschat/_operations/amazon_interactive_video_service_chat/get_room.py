...
def handle_response(
    ...
    out: aws_sdk_ivschat.types.get_room_response.GetRoomResponse = (
        aws_sdk_ivschat.types.get_room_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.get_room_request.GetRoomRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.get_room_request.serialize_json(input_)
    ).encode()
...
def get_room(
    ...
    input_: aws_sdk_ivschat.types.get_room_request.GetRoomRequest,
) -> tuple[aws_sdk_ivschat.types.get_room_response.GetRoomResponse, zapros.Response]:
