"""Generated from Smithy shape ``com.amazonaws.ivschat#DeleteRoom``."""
...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.delete_room_request.DeleteRoomRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteRoom"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivschat.types.delete_room_request

    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.delete_room_request.serialize_json(input_)
    ).encode()
