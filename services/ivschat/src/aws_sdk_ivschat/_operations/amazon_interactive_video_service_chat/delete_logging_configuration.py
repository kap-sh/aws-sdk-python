...
def build_request(
    ...
    input: aws_sdk_ivschat.types.delete_logging_configuration_request.DeleteLoggingConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.delete_logging_configuration_request.serialize_json(input)
    ).encode()
