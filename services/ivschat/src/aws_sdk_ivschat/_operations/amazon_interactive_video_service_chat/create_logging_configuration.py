"""Generated from Smithy shape ``com.amazonaws.ivschat#CreateLoggingConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_ivschat.errors.conflict_exception

            raise aws_sdk_ivschat.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_ivschat.errors.service_quota_exceeded_exception

            raise aws_sdk_ivschat.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ivschat.types.create_logging_configuration_response.CreateLoggingConfigurationResponse = aws_sdk_ivschat.types.create_logging_configuration_response.deserialize_json(
...
def get_signer(
...
) -> aws_sdk_ivschat._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_ivschat._auth._sigv4.build_sigv4_auth_scheme(
                "ivschat", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_ivschat._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input: aws_sdk_ivschat.types.create_logging_configuration_request.CreateLoggingConfigurationRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/CreateLoggingConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivschat.types.create_logging_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.create_logging_configuration_request.serialize_json(input)
    ).encode()
...
async def async_create_logging_configuration(
