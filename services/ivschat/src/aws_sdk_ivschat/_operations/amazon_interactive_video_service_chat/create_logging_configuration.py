...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.create_logging_configuration_request.CreateLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.create_logging_configuration_request.serialize_json(
            input_
        )
    ).encode()
