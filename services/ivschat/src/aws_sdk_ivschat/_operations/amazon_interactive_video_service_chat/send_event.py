"""Generated from Smithy shape ``com.amazonaws.ivschat#SendEvent``."""
...
def handle_response(
    ...
    out: aws_sdk_ivschat.types.send_event_response.SendEventResponse = (
        aws_sdk_ivschat.types.send_event_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.send_event_request.SendEventRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/SendEvent"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivschat.types.send_event_request

    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.send_event_request.serialize_json(input_)
    ).encode()
...
def send_event(
    ...
    aws_sdk_ivschat.types.send_event_response.SendEventResponse, zapros.Response
]:
