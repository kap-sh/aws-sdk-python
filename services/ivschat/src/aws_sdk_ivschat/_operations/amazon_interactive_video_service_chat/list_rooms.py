"""Generated from Smithy shape ``com.amazonaws.ivschat#ListRooms``."""
...
def handle_response(
    ...
    out: aws_sdk_ivschat.types.list_rooms_response.ListRoomsResponse = (
        aws_sdk_ivschat.types.list_rooms_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivschat.types.list_rooms_request.ListRoomsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListRooms"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivschat.types.list_rooms_request

    body: bytes | None = json.dumps(
        aws_sdk_ivschat.types.list_rooms_request.serialize_json(input_)
    ).encode()
...
def list_rooms(
    ...
    aws_sdk_ivschat.types.list_rooms_response.ListRoomsResponse, zapros.Response
]:
