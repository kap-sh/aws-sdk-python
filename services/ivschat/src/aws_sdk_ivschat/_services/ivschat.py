...
from aws_sdk_ivschat._services._aws_config import aws_config
...
class ivschatClientConfig(TypedDict, total=False):
...
class ivschatClient:
    ...
    def create_chat_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.create_chat_token_request.CreateChatTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.create_chat_token_response.CreateChatTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.create_chat_token.create_chat_token(
    ...
    def create_logging_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.create_logging_configuration_request.CreateLoggingConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.create_logging_configuration_response.CreateLoggingConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.create_logging_configuration.create_logging_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_room(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.create_room_request.CreateRoomRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.create_room_response.CreateRoomResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.create_room.create_room(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_logging_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.delete_logging_configuration_request.DeleteLoggingConfigurationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.delete_logging_configuration

            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.delete_logging_configuration.delete_logging_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_message(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.delete_message_request.DeleteMessageRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.delete_message_response.DeleteMessageResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.delete_message.delete_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_room(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.delete_room_request.DeleteRoomRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.delete_room

            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.delete_room.delete_room(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disconnect_user(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.disconnect_user_request.DisconnectUserRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.disconnect_user_response.DisconnectUserResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.disconnect_user.disconnect_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_logging_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.get_logging_configuration_request.GetLoggingConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.get_logging_configuration_response.GetLoggingConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.get_logging_configuration.get_logging_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_room(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.get_room_request.GetRoomRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.get_room_response.GetRoomResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.get_room.get_room(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_logging_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.list_logging_configurations_request.ListLoggingConfigurationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.list_logging_configurations_response.ListLoggingConfigurationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.list_logging_configurations.list_logging_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_rooms(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.list_rooms_request.ListRoomsRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.list_rooms_response.ListRoomsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.list_rooms.list_rooms(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_event(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.send_event_request.SendEventRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.send_event_response.SendEventResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.send_event.send_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_logging_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.update_logging_configuration_request.UpdateLoggingConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.update_logging_configuration_response.UpdateLoggingConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.update_logging_configuration.update_logging_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_room(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ivschat.types.update_room_request.UpdateRoomRequest]",
        ) -> OperationResponse[
            "aws_sdk_ivschat.types.update_room_response.UpdateRoomResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ivschat._operations.amazon_interactive_video_service_chat.update_room.update_room(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
