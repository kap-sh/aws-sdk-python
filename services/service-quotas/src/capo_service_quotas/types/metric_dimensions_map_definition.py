...
if TYPE_CHECKING:
    import capo_service_quotas.types.metric_dimension_name
    import capo_service_quotas.types.metric_dimension_value

MetricDimensionsMapDefinition: TypeAlias = dict[
    "capo_service_quotas.types.metric_dimension_name.MetricDimensionName",
    "capo_service_quotas.types.metric_dimension_value.MetricDimensionValue",
]
