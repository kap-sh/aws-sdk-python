...
if TYPE_CHECKING:
    ...
    import capo_service_quotas.types.service_info_list_definition
...
class ListServicesResponse(TypedDict, closed=True):
    ...
    services: NotRequired[
        "capo_service_quotas.types.service_info_list_definition.ServiceInfoListDefinition"
    ]
...
def serialize_aws_json_1_1(value: ListServicesResponse) -> dict:
    ...
    if "services" in value:
        ...
        out["Services"] = (
            capo_service_quotas.types.service_info_list_definition.serialize_aws_json_1_1(
                value["services"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListServicesResponse:
    ...
    if "Services" in data:
        ...
        out["services"] = (
            capo_service_quotas.types.service_info_list_definition.deserialize_aws_json_1_1(
                data["Services"]
            )
        )
    return out
