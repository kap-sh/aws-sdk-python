"""Generated from Smithy shape ``com.amazonaws.servicequotas#ListServiceQuotasRequest``."""
...
class ListServiceQuotasRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListServiceQuotasRequest) -> dict:
    out: dict = {}
