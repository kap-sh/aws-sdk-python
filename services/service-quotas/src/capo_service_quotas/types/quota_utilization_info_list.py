...
if TYPE_CHECKING:
    import capo_service_quotas.types.quota_utilization_info

QuotaUtilizationInfoList: TypeAlias = list[
    "capo_service_quotas.types.quota_utilization_info.QuotaUtilizationInfo"
]
...
def serialize_aws_json_1_1(value: QuotaUtilizationInfoList) -> list:
    ...
    for item in value:
        out.append(
            capo_service_quotas.types.quota_utilization_info.serialize_aws_json_1_1(
                item
            )
        )
    return out
