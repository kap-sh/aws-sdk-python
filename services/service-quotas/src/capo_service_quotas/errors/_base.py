...
class ServiceQuotasError(Exception):
    """Base class for all ServiceQuotas service errors."""


class ServiceError(ServiceQuotasError):
...
class SerializationError(ServiceQuotasError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ServiceQuotasError):
...
class WaiterFailedError(ServiceQuotasError):
...
class WaiterTimeoutError(ServiceQuotasError):
