"""Generated from Smithy shape ``com.amazonaws.servicequotas#OrganizationNotInAllFeaturesModeException``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: OrganizationNotInAllFeaturesModeException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class OrganizationNotInAllFeaturesModeException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.servicequotas#OrganizationNotInAllFeaturesModeException``."""
