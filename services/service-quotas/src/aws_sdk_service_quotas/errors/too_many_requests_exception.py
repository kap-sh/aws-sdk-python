"""Generated from Smithy shape ``com.amazonaws.servicequotas#TooManyRequestsException``."""
...
class TooManyRequestsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.servicequotas#TooManyRequestsException``."""
