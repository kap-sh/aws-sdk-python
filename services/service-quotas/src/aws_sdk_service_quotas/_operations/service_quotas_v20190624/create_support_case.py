...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourceStateException":
            import aws_sdk_service_quotas.errors.invalid_resource_state_exception

            raise aws_sdk_service_quotas.errors.invalid_resource_state_exception.InvalidResourceStateException.from_aws_json_1_1(
                data
            )
        ...
        case "ResourceAlreadyExistsException":
            import aws_sdk_service_quotas.errors.resource_already_exists_exception

            raise aws_sdk_service_quotas.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.create_support_case_response.CreateSupportCaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def get_signer(
...
) -> aws_sdk_service_quotas._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_service_quotas._auth._sigv4.build_sigv4_auth_scheme(
                "servicequotas", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_service_quotas._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.create_support_case_request.CreateSupportCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.create_support_case_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
