"""Generated from Smithy shape ``com.amazonaws.servicequotas#DisassociateServiceQuotaTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.disassociate_service_quota_template_response.DisassociateServiceQuotaTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.disassociate_service_quota_template_request.DisassociateServiceQuotaTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ServiceQuotasV20190624.DisassociateServiceQuotaTemplate"
    body: bytes | None = b""
...
async def async_disassociate_service_quota_template(
