...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.get_service_quota_response.GetServiceQuotaResponse = aws_sdk_service_quotas.types.get_service_quota_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.get_service_quota_request.GetServiceQuotaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.get_service_quota_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
