...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.request_service_quota_increase_response.RequestServiceQuotaIncreaseResponse = aws_sdk_service_quotas.types.request_service_quota_increase_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.request_service_quota_increase_request.RequestServiceQuotaIncreaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.request_service_quota_increase_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
