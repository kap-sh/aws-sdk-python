...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.get_quota_utilization_report_response.GetQuotaUtilizationReportResponse = aws_sdk_service_quotas.types.get_quota_utilization_report_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.get_quota_utilization_report_request.GetQuotaUtilizationReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.get_quota_utilization_report_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
