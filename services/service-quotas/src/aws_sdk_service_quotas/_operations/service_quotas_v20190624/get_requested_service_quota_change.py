"""Generated from Smithy shape ``com.amazonaws.servicequotas#GetRequestedServiceQuotaChange``."""
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.get_requested_service_quota_change_response.GetRequestedServiceQuotaChangeResponse = aws_sdk_service_quotas.types.get_requested_service_quota_change_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.get_requested_service_quota_change_request.GetRequestedServiceQuotaChangeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ServiceQuotasV20190624.GetRequestedServiceQuotaChange"
    import aws_sdk_service_quotas.types.get_requested_service_quota_change_request

    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.get_requested_service_quota_change_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_requested_service_quota_change(
