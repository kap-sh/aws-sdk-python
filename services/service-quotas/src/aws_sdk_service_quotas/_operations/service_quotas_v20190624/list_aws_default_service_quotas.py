...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPaginationTokenException":
            import aws_sdk_service_quotas.errors.invalid_pagination_token_exception

            raise aws_sdk_service_quotas.errors.invalid_pagination_token_exception.InvalidPaginationTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.list_aws_default_service_quotas_response.ListAWSDefaultServiceQuotasResponse = aws_sdk_service_quotas.types.list_aws_default_service_quotas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.list_aws_default_service_quotas_request.ListAWSDefaultServiceQuotasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.list_aws_default_service_quotas_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
