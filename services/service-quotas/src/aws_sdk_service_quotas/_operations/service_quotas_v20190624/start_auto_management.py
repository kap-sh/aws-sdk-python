...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.start_auto_management_response.StartAutoManagementResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.start_auto_management_request.StartAutoManagementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.start_auto_management_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
