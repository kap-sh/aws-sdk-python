...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.start_quota_utilization_report_response.StartQuotaUtilizationReportResponse = aws_sdk_service_quotas.types.start_quota_utilization_report_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.start_quota_utilization_report_request.StartQuotaUtilizationReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
