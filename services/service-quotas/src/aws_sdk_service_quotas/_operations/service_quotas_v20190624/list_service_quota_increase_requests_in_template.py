...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.list_service_quota_increase_requests_in_template_response.ListServiceQuotaIncreaseRequestsInTemplateResponse = aws_sdk_service_quotas.types.list_service_quota_increase_requests_in_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.list_service_quota_increase_requests_in_template_request.ListServiceQuotaIncreaseRequestsInTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.list_service_quota_increase_requests_in_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
