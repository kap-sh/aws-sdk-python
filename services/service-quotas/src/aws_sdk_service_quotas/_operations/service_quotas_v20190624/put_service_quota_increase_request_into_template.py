"""Generated from Smithy shape ``com.amazonaws.servicequotas#PutServiceQuotaIncreaseRequestIntoTemplate``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "QuotaExceededException":
            import aws_sdk_service_quotas.errors.quota_exceeded_exception

            raise aws_sdk_service_quotas.errors.quota_exceeded_exception.QuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.put_service_quota_increase_request_into_template_response.PutServiceQuotaIncreaseRequestIntoTemplateResponse = aws_sdk_service_quotas.types.put_service_quota_increase_request_into_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.put_service_quota_increase_request_into_template_request.PutServiceQuotaIncreaseRequestIntoTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_put_service_quota_increase_request_into_template(
