...
import aws_sdk_service_quotas.errors.tag_policy_violation_exception
import aws_sdk_service_quotas.errors.too_many_requests_exception
import aws_sdk_service_quotas.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TagPolicyViolationException":
            raise aws_sdk_service_quotas.errors.tag_policy_violation_exception.TagPolicyViolationException.from_aws_json_1_1(
                data
            )
        ...
        case "TooManyTagsException":
            raise aws_sdk_service_quotas.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
