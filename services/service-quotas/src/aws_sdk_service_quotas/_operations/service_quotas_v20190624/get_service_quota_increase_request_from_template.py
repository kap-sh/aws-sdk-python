...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.get_service_quota_increase_request_from_template_response.GetServiceQuotaIncreaseRequestFromTemplateResponse = aws_sdk_service_quotas.types.get_service_quota_increase_request_from_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.get_service_quota_increase_request_from_template_request.GetServiceQuotaIncreaseRequestFromTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.get_service_quota_increase_request_from_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
