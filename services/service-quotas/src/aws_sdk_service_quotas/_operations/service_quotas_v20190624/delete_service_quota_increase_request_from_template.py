"""Generated from Smithy shape ``com.amazonaws.servicequotas#DeleteServiceQuotaIncreaseRequestFromTemplate``."""
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.delete_service_quota_increase_request_from_template_request.DeleteServiceQuotaIncreaseRequestFromTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.delete_service_quota_increase_request_from_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_service_quota_increase_request_from_template(
