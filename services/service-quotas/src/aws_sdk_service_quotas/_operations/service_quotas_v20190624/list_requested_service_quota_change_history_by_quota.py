...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.list_requested_service_quota_change_history_by_quota_response.ListRequestedServiceQuotaChangeHistoryByQuotaResponse = aws_sdk_service_quotas.types.list_requested_service_quota_change_history_by_quota_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.list_requested_service_quota_change_history_by_quota_request.ListRequestedServiceQuotaChangeHistoryByQuotaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.list_requested_service_quota_change_history_by_quota_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
