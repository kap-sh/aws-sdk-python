"""Generated from Smithy shape ``com.amazonaws.servicequotas#ListServiceQuotas``."""
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.list_service_quotas_response.ListServiceQuotasResponse = aws_sdk_service_quotas.types.list_service_quotas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.list_service_quotas_request.ListServiceQuotasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.list_service_quotas_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_service_quotas(
