...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OrganizationNotInAllFeaturesModeException":
            import aws_sdk_service_quotas.errors.organization_not_in_all_features_mode_exception

            raise aws_sdk_service_quotas.errors.organization_not_in_all_features_mode_exception.OrganizationNotInAllFeaturesModeException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.associate_service_quota_template_response.AssociateServiceQuotaTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.associate_service_quota_template_request.AssociateServiceQuotaTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
