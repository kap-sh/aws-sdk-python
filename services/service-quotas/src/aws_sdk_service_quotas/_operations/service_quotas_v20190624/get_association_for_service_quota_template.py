"""Generated from Smithy shape ``com.amazonaws.servicequotas#GetAssociationForServiceQuotaTemplate``."""
...
import aws_sdk_service_quotas.errors.service_quota_template_not_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaTemplateNotInUseException":
            raise aws_sdk_service_quotas.errors.service_quota_template_not_in_use_exception.ServiceQuotaTemplateNotInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.get_association_for_service_quota_template_response.GetAssociationForServiceQuotaTemplateResponse = aws_sdk_service_quotas.types.get_association_for_service_quota_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.get_association_for_service_quota_template_request.GetAssociationForServiceQuotaTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_association_for_service_quota_template(
