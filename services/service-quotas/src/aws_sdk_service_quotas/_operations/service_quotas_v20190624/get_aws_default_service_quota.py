...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.get_aws_default_service_quota_response.GetAWSDefaultServiceQuotaResponse = aws_sdk_service_quotas.types.get_aws_default_service_quota_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.get_aws_default_service_quota_request.GetAWSDefaultServiceQuotaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.get_aws_default_service_quota_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
