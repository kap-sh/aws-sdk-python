...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.get_auto_management_configuration_response.GetAutoManagementConfigurationResponse = aws_sdk_service_quotas.types.get_auto_management_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.get_auto_management_configuration_request.GetAutoManagementConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
