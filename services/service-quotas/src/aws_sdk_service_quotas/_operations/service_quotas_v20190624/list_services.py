...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.list_services_request.ListServicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.list_services_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
