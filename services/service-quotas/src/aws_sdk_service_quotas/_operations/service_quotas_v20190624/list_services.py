"""Generated from Smithy shape ``com.amazonaws.servicequotas#ListServices``."""
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.list_services_response.ListServicesResponse = (
        aws_sdk_service_quotas.types.list_services_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_service_quotas.types.list_services_request.ListServicesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_quotas.types.list_services_request.serialize_aws_json_1_1(input)
    ).encode()
