"""Generated from Smithy shape ``com.amazonaws.servicequotas#ListRequestedServiceQuotaChangeHistory``."""
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.list_requested_service_quota_change_history_response.ListRequestedServiceQuotaChangeHistoryResponse = aws_sdk_service_quotas.types.list_requested_service_quota_change_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.list_requested_service_quota_change_history_request.ListRequestedServiceQuotaChangeHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_requested_service_quota_change_history(
