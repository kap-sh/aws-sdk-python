...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.update_auto_management_response.UpdateAutoManagementResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.update_auto_management_request.UpdateAutoManagementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
