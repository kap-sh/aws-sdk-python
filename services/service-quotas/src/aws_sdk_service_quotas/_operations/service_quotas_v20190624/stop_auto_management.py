"""Generated from Smithy shape ``com.amazonaws.servicequotas#StopAutoManagement``."""
...
def handle_response(
    ...
    out: aws_sdk_service_quotas.types.stop_auto_management_response.StopAutoManagementResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_quotas.types.stop_auto_management_request.StopAutoManagementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ServiceQuotasV20190624.StopAutoManagement"
    body: bytes | None = b""
...
async def async_stop_auto_management(
