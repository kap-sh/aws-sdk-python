...
from ._services.async_service_quotas import (
    AsyncServiceQuotasClient as AsyncServiceQuotasClient,
)
from ._services.service_quotas import ServiceQuotasClient as ServiceQuotasClient
