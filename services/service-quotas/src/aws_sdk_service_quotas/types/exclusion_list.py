...
if TYPE_CHECKING:
    import aws_sdk_service_quotas.types.excluded_quota_list
...
ExclusionList: TypeAlias = dict[
    ...
    "aws_sdk_service_quotas.types.excluded_quota_list.ExcludedQuotaList",
]
...
def serialize_aws_json_1_1(input_to_serialize: ExclusionList) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            aws_sdk_service_quotas.types.excluded_quota_list.serialize_aws_json_1_1(
                value
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ExclusionList:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_service_quotas.types.excluded_quota_list.deserialize_aws_json_1_1(
                value
            )
        )
    return out
