"""Generated from Smithy shape ``com.amazonaws.servicequotas#ListAWSDefaultServiceQuotasResponse``."""
...
class ListAWSDefaultServiceQuotasResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListAWSDefaultServiceQuotasResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListAWSDefaultServiceQuotasResponse:
    out: ListAWSDefaultServiceQuotasResponse = {}  # type: ignore[typeddict-item]
