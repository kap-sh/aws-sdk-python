...
if TYPE_CHECKING:
    import aws_sdk_service_quotas.types.applied_value
    import aws_sdk_service_quotas.types.default_value
    ...
    import aws_sdk_service_quotas.types.utilization_pct


class QuotaUtilizationInfo(TypedDict):
    ...
    utilization: NotRequired[
        "aws_sdk_service_quotas.types.utilization_pct.UtilizationPct"
    ]
    ...
    default_value: NotRequired[
        "aws_sdk_service_quotas.types.default_value.DefaultValue"
    ]
    """<p>The default value of the quota.</p>"""
    applied_value: NotRequired[
        "aws_sdk_service_quotas.types.applied_value.AppliedValue"
    ]
