...
```
pip install aws-sdk-direct-connect
```

## Usage

```python
from aws_sdk_direct_connect import AsyncDirectConnectClient
...
```python
from aws_sdk_direct_connect import AsyncDirectConnectClient
from aws_sdk_direct_connect.error import DirectConnectClientException
