...
class DirectConnectError(Exception):
    """Base class for all DirectConnect service errors."""


class ServiceError(DirectConnectError):
...
class SerializationError(DirectConnectError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DirectConnectError):
...
class WaiterFailedError(DirectConnectError):
...
class WaiterTimeoutError(DirectConnectError):
