...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.interconnects.Interconnects = (
        aws_sdk_direct_connect.types.interconnects.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_interconnects_request.DescribeInterconnectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_interconnects_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
def describe_interconnects(
    ...
    input_: aws_sdk_direct_connect.types.describe_interconnects_request.DescribeInterconnectsRequest,
) -> tuple[aws_sdk_direct_connect.types.interconnects.Interconnects, zapros.Response]:
