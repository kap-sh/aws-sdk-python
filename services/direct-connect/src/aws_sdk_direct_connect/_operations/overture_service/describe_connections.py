"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeConnections``."""
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_connections_request.DescribeConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_connections_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_connections(
