...
def build_request(
    ...
    input: aws_sdk_direct_connect.types.describe_direct_connect_gateway_association_proposals_request.DescribeDirectConnectGatewayAssociationProposalsRequest,
) -> zapros.Request:
