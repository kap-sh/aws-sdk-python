...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.start_bgp_failover_test_response.StartBgpFailoverTestResponse = aws_sdk_direct_connect.types.start_bgp_failover_test_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.start_bgp_failover_test_request.StartBgpFailoverTestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.start_bgp_failover_test_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
