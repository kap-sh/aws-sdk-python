"""Generated from Smithy shape ``com.amazonaws.directconnect#CreateDirectConnectGateway``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.create_direct_connect_gateway_result.CreateDirectConnectGatewayResult = aws_sdk_direct_connect.types.create_direct_connect_gateway_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.create_direct_connect_gateway_request.CreateDirectConnectGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.create_direct_connect_gateway_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_direct_connect_gateway(
