"""Generated from Smithy shape ``com.amazonaws.directconnect#ConfirmCustomerAgreement``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.confirm_customer_agreement_response.ConfirmCustomerAgreementResponse = aws_sdk_direct_connect.types.confirm_customer_agreement_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.confirm_customer_agreement_request.ConfirmCustomerAgreementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OvertureService.ConfirmCustomerAgreement"
    import aws_sdk_direct_connect.types.confirm_customer_agreement_request

    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.confirm_customer_agreement_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_confirm_customer_agreement(
