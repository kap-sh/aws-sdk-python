"""Generated from Smithy shape ``com.amazonaws.directconnect#AllocatePrivateVirtualInterface``."""
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.allocate_private_virtual_interface_request.AllocatePrivateVirtualInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.allocate_private_virtual_interface_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
def allocate_private_virtual_interface(
    ...
    aws_sdk_direct_connect.types.virtual_interface.VirtualInterface, zapros.Response
]:
...
async def async_allocate_private_virtual_interface(
