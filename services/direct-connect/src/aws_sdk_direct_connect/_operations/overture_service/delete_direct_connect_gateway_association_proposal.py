...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.delete_direct_connect_gateway_association_proposal_result.DeleteDirectConnectGatewayAssociationProposalResult = aws_sdk_direct_connect.types.delete_direct_connect_gateway_association_proposal_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.delete_direct_connect_gateway_association_proposal_request.DeleteDirectConnectGatewayAssociationProposalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
