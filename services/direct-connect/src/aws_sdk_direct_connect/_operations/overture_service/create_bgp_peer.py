...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.create_bgp_peer_response.CreateBGPPeerResponse = (
        aws_sdk_direct_connect.types.create_bgp_peer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.create_bgp_peer_request.CreateBGPPeerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.create_bgp_peer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
