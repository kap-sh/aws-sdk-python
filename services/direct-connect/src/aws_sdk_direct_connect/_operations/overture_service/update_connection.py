"""Generated from Smithy shape ``com.amazonaws.directconnect#UpdateConnection``."""
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.update_connection_request.UpdateConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OvertureService.UpdateConnection"
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.update_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
