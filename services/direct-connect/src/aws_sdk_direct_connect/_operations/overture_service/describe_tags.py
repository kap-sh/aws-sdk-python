...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_tags_request.DescribeTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_tags_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
