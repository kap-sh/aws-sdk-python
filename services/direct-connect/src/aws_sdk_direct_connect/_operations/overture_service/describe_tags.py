"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeTags``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.describe_tags_response.DescribeTagsResponse = (
        aws_sdk_direct_connect.types.describe_tags_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_direct_connect.types.describe_tags_request.DescribeTagsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_tags_request.serialize_aws_json_1_1(input)
    ).encode()
