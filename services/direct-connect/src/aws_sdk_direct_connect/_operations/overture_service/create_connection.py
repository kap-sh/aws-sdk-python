"""Generated from Smithy shape ``com.amazonaws.directconnect#CreateConnection``."""
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.create_connection_request.CreateConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.create_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
