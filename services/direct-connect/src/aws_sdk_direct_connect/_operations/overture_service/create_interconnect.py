...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.create_interconnect_request.CreateInterconnectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.create_interconnect_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
def create_interconnect(
    ...
    input_: aws_sdk_direct_connect.types.create_interconnect_request.CreateInterconnectRequest,
) -> tuple[aws_sdk_direct_connect.types.interconnect.Interconnect, zapros.Response]:
