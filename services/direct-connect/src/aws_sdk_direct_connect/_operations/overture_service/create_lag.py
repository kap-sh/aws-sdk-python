"""Generated from Smithy shape ``com.amazonaws.directconnect#CreateLag``."""
...
def handle_response(response: zapros.Response) -> aws_sdk_direct_connect.types.lag.Lag:
    out: aws_sdk_direct_connect.types.lag.Lag = (
        aws_sdk_direct_connect.types.lag.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.create_lag_request.CreateLagRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def create_lag(
    ...
    input_: aws_sdk_direct_connect.types.create_lag_request.CreateLagRequest,
) -> tuple[aws_sdk_direct_connect.types.lag.Lag, zapros.Response]:
