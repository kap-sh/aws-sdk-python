"""Generated from Smithy shape ``com.amazonaws.directconnect#AssociateConnectionWithLag``."""
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.associate_connection_with_lag_request.AssociateConnectionWithLagRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.associate_connection_with_lag_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_connection_with_lag(
