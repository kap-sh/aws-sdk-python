...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.disassociate_mac_sec_key_response.DisassociateMacSecKeyResponse = aws_sdk_direct_connect.types.disassociate_mac_sec_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.disassociate_mac_sec_key_request.DisassociateMacSecKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.disassociate_mac_sec_key_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
