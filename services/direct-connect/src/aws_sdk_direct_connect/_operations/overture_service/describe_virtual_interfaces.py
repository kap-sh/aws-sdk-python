...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.virtual_interfaces.VirtualInterfaces = (
        aws_sdk_direct_connect.types.virtual_interfaces.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_virtual_interfaces_request.DescribeVirtualInterfacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_virtual_interfaces_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
def describe_virtual_interfaces(
    ...
    aws_sdk_direct_connect.types.virtual_interfaces.VirtualInterfaces, zapros.Response
]:
