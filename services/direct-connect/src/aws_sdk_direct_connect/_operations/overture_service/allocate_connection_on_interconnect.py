"""Generated from Smithy shape ``com.amazonaws.directconnect#AllocateConnectionOnInterconnect``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.connection.Connection = (
        aws_sdk_direct_connect.types.connection.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.allocate_connection_on_interconnect_request.AllocateConnectionOnInterconnectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.allocate_connection_on_interconnect_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
def allocate_connection_on_interconnect(
    ...
    input_: aws_sdk_direct_connect.types.allocate_connection_on_interconnect_request.AllocateConnectionOnInterconnectRequest,
) -> tuple[aws_sdk_direct_connect.types.connection.Connection, zapros.Response]:
...
async def async_allocate_connection_on_interconnect(
