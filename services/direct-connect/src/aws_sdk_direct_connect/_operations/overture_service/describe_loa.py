...
def handle_response(response: zapros.Response) -> aws_sdk_direct_connect.types.loa.Loa:
    out: aws_sdk_direct_connect.types.loa.Loa = (
        aws_sdk_direct_connect.types.loa.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_loa_request.DescribeLoaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_loa_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_loa(
    ...
    input_: aws_sdk_direct_connect.types.describe_loa_request.DescribeLoaRequest,
) -> tuple[aws_sdk_direct_connect.types.loa.Loa, zapros.Response]:
