...
def build_request(
    ...
    input: aws_sdk_direct_connect.types.describe_loa_request.DescribeLoaRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_loa_request.serialize_aws_json_1_1(input)
    ).encode()
