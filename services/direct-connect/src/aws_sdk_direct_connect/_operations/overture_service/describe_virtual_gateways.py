...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.virtual_gateways.VirtualGateways = (
        aws_sdk_direct_connect.types.virtual_gateways.deserialize_aws_json_1_1(
...
def describe_virtual_gateways(
    ...
    aws_sdk_direct_connect.types.virtual_gateways.VirtualGateways, zapros.Response
]:
