...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.create_direct_connect_gateway_association_proposal_result.CreateDirectConnectGatewayAssociationProposalResult = aws_sdk_direct_connect.types.create_direct_connect_gateway_association_proposal_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.create_direct_connect_gateway_association_proposal_request.CreateDirectConnectGatewayAssociationProposalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.create_direct_connect_gateway_association_proposal_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
