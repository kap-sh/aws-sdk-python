...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_lags_request.DescribeLagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_lags_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
