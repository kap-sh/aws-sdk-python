...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.lags.Lags = (
        aws_sdk_direct_connect.types.lags.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_direct_connect.types.describe_lags_request.DescribeLagsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_lags_request.serialize_aws_json_1_1(input)
    ).encode()
...
def describe_lags(
    ...
    input: aws_sdk_direct_connect.types.describe_lags_request.DescribeLagsRequest,
) -> tuple[aws_sdk_direct_connect.types.lags.Lags, zapros.Response]:
