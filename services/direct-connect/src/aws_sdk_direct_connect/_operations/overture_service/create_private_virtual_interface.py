...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.create_private_virtual_interface_request.CreatePrivateVirtualInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.create_private_virtual_interface_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
