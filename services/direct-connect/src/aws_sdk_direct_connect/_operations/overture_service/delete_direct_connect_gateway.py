"""Generated from Smithy shape ``com.amazonaws.directconnect#DeleteDirectConnectGateway``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.delete_direct_connect_gateway_result.DeleteDirectConnectGatewayResult = aws_sdk_direct_connect.types.delete_direct_connect_gateway_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.delete_direct_connect_gateway_request.DeleteDirectConnectGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.delete_direct_connect_gateway_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_direct_connect_gateway(
