...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.describe_router_configuration_response.DescribeRouterConfigurationResponse = aws_sdk_direct_connect.types.describe_router_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_router_configuration_request.DescribeRouterConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_router_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
