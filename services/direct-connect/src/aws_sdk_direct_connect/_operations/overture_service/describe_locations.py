...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.locations.Locations = (
        aws_sdk_direct_connect.types.locations.deserialize_aws_json_1_1(
...
) -> tuple[aws_sdk_direct_connect.types.locations.Locations, zapros.Response]:
