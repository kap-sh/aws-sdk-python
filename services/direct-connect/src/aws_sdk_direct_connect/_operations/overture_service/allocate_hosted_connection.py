...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.allocate_hosted_connection_request.AllocateHostedConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.allocate_hosted_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
