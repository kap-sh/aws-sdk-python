...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.describe_direct_connect_gateway_associations_result.DescribeDirectConnectGatewayAssociationsResult = aws_sdk_direct_connect.types.describe_direct_connect_gateway_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_direct_connect_gateway_associations_request.DescribeDirectConnectGatewayAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_direct_connect_gateway_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
