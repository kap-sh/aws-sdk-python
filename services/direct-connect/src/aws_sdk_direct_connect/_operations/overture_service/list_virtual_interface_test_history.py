...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.list_virtual_interface_test_history_response.ListVirtualInterfaceTestHistoryResponse = aws_sdk_direct_connect.types.list_virtual_interface_test_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.list_virtual_interface_test_history_request.ListVirtualInterfaceTestHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.list_virtual_interface_test_history_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
