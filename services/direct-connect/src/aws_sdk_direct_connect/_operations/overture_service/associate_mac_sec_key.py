...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.associate_mac_sec_key_response.AssociateMacSecKeyResponse = aws_sdk_direct_connect.types.associate_mac_sec_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.associate_mac_sec_key_request.AssociateMacSecKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.associate_mac_sec_key_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
