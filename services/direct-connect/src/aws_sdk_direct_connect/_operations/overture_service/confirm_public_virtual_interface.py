"""Generated from Smithy shape ``com.amazonaws.directconnect#ConfirmPublicVirtualInterface``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.confirm_public_virtual_interface_response.ConfirmPublicVirtualInterfaceResponse = aws_sdk_direct_connect.types.confirm_public_virtual_interface_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.confirm_public_virtual_interface_request.ConfirmPublicVirtualInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.confirm_public_virtual_interface_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_confirm_public_virtual_interface(
