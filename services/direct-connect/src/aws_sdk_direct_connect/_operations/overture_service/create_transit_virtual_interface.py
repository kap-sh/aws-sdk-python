"""Generated from Smithy shape ``com.amazonaws.directconnect#CreateTransitVirtualInterface``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.create_transit_virtual_interface_result.CreateTransitVirtualInterfaceResult = aws_sdk_direct_connect.types.create_transit_virtual_interface_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.create_transit_virtual_interface_request.CreateTransitVirtualInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.create_transit_virtual_interface_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_transit_virtual_interface(
