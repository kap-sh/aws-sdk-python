...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.describe_direct_connect_gateway_attachments_result.DescribeDirectConnectGatewayAttachmentsResult = aws_sdk_direct_connect.types.describe_direct_connect_gateway_attachments_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_direct_connect_gateway_attachments_request.DescribeDirectConnectGatewayAttachmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_direct_connect_gateway_attachments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
