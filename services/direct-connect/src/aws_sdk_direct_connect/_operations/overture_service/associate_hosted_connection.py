"""Generated from Smithy shape ``com.amazonaws.directconnect#AssociateHostedConnection``."""
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.associate_hosted_connection_request.AssociateHostedConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.associate_hosted_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_hosted_connection(
