"""Generated from Smithy shape ``com.amazonaws.directconnect#UpdateDirectConnectGateway``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.update_direct_connect_gateway_response.UpdateDirectConnectGatewayResponse = aws_sdk_direct_connect.types.update_direct_connect_gateway_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.update_direct_connect_gateway_request.UpdateDirectConnectGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OvertureService.UpdateDirectConnectGateway"
    import aws_sdk_direct_connect.types.update_direct_connect_gateway_request

    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.update_direct_connect_gateway_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_direct_connect_gateway(
