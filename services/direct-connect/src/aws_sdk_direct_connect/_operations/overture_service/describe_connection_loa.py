...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.describe_connection_loa_response.DescribeConnectionLoaResponse = aws_sdk_direct_connect.types.describe_connection_loa_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_connection_loa_request.DescribeConnectionLoaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_connection_loa_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
