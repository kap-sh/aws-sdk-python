"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeHostedConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.connections.Connections = (
        aws_sdk_direct_connect.types.connections.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_hosted_connections_request.DescribeHostedConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_hosted_connections_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
def describe_hosted_connections(
    ...
    input_: aws_sdk_direct_connect.types.describe_hosted_connections_request.DescribeHostedConnectionsRequest,
) -> tuple[aws_sdk_direct_connect.types.connections.Connections, zapros.Response]:
...
async def async_describe_hosted_connections(
