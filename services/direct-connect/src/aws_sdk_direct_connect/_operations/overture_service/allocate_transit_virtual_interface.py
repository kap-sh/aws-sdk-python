"""Generated from Smithy shape ``com.amazonaws.directconnect#AllocateTransitVirtualInterface``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.allocate_transit_virtual_interface_result.AllocateTransitVirtualInterfaceResult = aws_sdk_direct_connect.types.allocate_transit_virtual_interface_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.allocate_transit_virtual_interface_request.AllocateTransitVirtualInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.allocate_transit_virtual_interface_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_allocate_transit_virtual_interface(
