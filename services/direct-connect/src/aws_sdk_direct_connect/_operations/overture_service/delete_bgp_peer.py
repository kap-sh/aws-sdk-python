...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.delete_bgp_peer_response.DeleteBGPPeerResponse = (
        aws_sdk_direct_connect.types.delete_bgp_peer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.delete_bgp_peer_request.DeleteBGPPeerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.delete_bgp_peer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
