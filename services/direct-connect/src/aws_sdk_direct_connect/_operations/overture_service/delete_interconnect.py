...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.delete_interconnect_response.DeleteInterconnectResponse = aws_sdk_direct_connect.types.delete_interconnect_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.delete_interconnect_request.DeleteInterconnectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.delete_interconnect_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
