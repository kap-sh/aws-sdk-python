...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.describe_direct_connect_gateways_result.DescribeDirectConnectGatewaysResult = aws_sdk_direct_connect.types.describe_direct_connect_gateways_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.describe_direct_connect_gateways_request.DescribeDirectConnectGatewaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.describe_direct_connect_gateways_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
