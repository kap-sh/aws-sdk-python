"""Generated from Smithy shape ``com.amazonaws.directconnect#ConfirmConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.confirm_connection_response.ConfirmConnectionResponse = aws_sdk_direct_connect.types.confirm_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.confirm_connection_request.ConfirmConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.confirm_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_confirm_connection(
