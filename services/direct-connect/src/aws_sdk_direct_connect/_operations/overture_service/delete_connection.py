"""Generated from Smithy shape ``com.amazonaws.directconnect#DeleteConnection``."""
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.delete_connection_request.DeleteConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.delete_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
