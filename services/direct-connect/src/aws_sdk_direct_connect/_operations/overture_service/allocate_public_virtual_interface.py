"""Generated from Smithy shape ``com.amazonaws.directconnect#AllocatePublicVirtualInterface``."""
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.allocate_public_virtual_interface_request.AllocatePublicVirtualInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.allocate_public_virtual_interface_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_allocate_public_virtual_interface(
