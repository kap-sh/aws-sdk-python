"""Generated from Smithy shape ``com.amazonaws.directconnect#DisassociateConnectionFromLag``."""
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.disassociate_connection_from_lag_request.DisassociateConnectionFromLagRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.disassociate_connection_from_lag_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_connection_from_lag(
