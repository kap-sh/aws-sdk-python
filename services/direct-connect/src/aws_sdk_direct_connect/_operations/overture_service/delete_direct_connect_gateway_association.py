"""Generated from Smithy shape ``com.amazonaws.directconnect#DeleteDirectConnectGatewayAssociation``."""
...
def handle_response(
    ...
    out: aws_sdk_direct_connect.types.delete_direct_connect_gateway_association_result.DeleteDirectConnectGatewayAssociationResult = aws_sdk_direct_connect.types.delete_direct_connect_gateway_association_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_direct_connect.types.delete_direct_connect_gateway_association_request.DeleteDirectConnectGatewayAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_direct_connect.types.delete_direct_connect_gateway_association_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_direct_connect_gateway_association(
