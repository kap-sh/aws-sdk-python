...
if TYPE_CHECKING:
    ...
    import aws_sdk_direct_connect.types.bgp_peer_state
    import aws_sdk_direct_connect.types.bgp_status
...
class BGPPeer(TypedDict, closed=True):
    ...
    bgp_peer_state: NotRequired[
        "aws_sdk_direct_connect.types.bgp_peer_state.BGPPeerState"
    ]
    ...
    bgp_status: NotRequired["aws_sdk_direct_connect.types.bgp_status.BGPStatus"]
...
def serialize_aws_json_1_1(value: BGPPeer) -> dict:
    ...
    if "bgp_peer_state" in value:
        ...
        out["bgpPeerState"] = (
            aws_sdk_direct_connect.types.bgp_peer_state.serialize_aws_json_1_1(
    ...
    if "bgp_status" in value:
        ...
        out["bgpStatus"] = (
            aws_sdk_direct_connect.types.bgp_status.serialize_aws_json_1_1(
                value["bgp_status"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> BGPPeer:
    ...
    if "bgpPeerState" in data:
        ...
        out["bgp_peer_state"] = (
            aws_sdk_direct_connect.types.bgp_peer_state.deserialize_aws_json_1_1(
                data["bgpPeerState"]
            )
        )
    if "bgpStatus" in data:
        ...
        out["bgp_status"] = (
            aws_sdk_direct_connect.types.bgp_status.deserialize_aws_json_1_1(
                data["bgpStatus"]
            )
        )
