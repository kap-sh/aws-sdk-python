...
if TYPE_CHECKING:
    import aws_sdk_direct_connect.types.associated_core_network
    ...
    import aws_sdk_direct_connect.types.direct_connect_gateway_association_state
    ...
    import aws_sdk_direct_connect.types.virtual_gateway_region


class DirectConnectGatewayAssociation(TypedDict):
    ...
    association_state: NotRequired[
        "aws_sdk_direct_connect.types.direct_connect_gateway_association_state.DirectConnectGatewayAssociationState"
    ]
    ...
    associated_core_network: NotRequired[
        "aws_sdk_direct_connect.types.associated_core_network.AssociatedCoreNetwork"
    ]
    ...
    virtual_gateway_region: NotRequired[
        "aws_sdk_direct_connect.types.virtual_gateway_region.VirtualGatewayRegion"
    ]
...
def serialize_aws_json_1_1(value: DirectConnectGatewayAssociation) -> dict:
    ...
    if "association_state" in value:
        ...
        out["associationState"] = (
            aws_sdk_direct_connect.types.direct_connect_gateway_association_state.serialize_aws_json_1_1(
    ...
    if "associated_core_network" in value:
        ...
        out["associatedCoreNetwork"] = (
            aws_sdk_direct_connect.types.associated_core_network.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DirectConnectGatewayAssociation:
    ...
    if "associationState" in data:
        ...
        out["association_state"] = (
            aws_sdk_direct_connect.types.direct_connect_gateway_association_state.deserialize_aws_json_1_1(
    ...
    if "associatedCoreNetwork" in data:
        ...
        out["associated_core_network"] = (
            aws_sdk_direct_connect.types.associated_core_network.deserialize_aws_json_1_1(
