"""Generated from Smithy shape ``com.amazonaws.directconnect#DeleteVirtualInterfaceResponse``."""
...
class DeleteVirtualInterfaceResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteVirtualInterfaceResponse) -> dict:
    out: dict = {}
