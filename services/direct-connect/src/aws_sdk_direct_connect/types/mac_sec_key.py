...
if TYPE_CHECKING:
    ...
    import aws_sdk_direct_connect.types.start_on_date
...
class MacSecKey(TypedDict):
    ...
    state: NotRequired["aws_sdk_direct_connect.types.state.State"]
    ...
    start_on: NotRequired["aws_sdk_direct_connect.types.start_on_date.StartOnDate"]
