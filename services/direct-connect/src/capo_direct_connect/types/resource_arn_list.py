"""Generated from Smithy shape ``com.amazonaws.directconnect#ResourceArnList``."""
...
ResourceArnList: TypeAlias = list["capo_direct_connect.types.resource_arn.ResourceArn"]
