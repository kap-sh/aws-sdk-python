"""Generated from Smithy shape ``com.amazonaws.directconnect#TooManyTagsException``."""
...
class TooManyTagsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.directconnect#TooManyTagsException``."""
