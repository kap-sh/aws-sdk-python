"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeLags``."""
...
def handle_response(response: zapros.Response) -> capo_direct_connect.types.lags.Lags:
    out: capo_direct_connect.types.lags.Lags = (
        capo_direct_connect.types.lags.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_lags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_lags(
    ...
    input_: capo_direct_connect.types.describe_lags_request.DescribeLagsRequest,
) -> tuple[capo_direct_connect.types.lags.Lags, zapros.Response]:
