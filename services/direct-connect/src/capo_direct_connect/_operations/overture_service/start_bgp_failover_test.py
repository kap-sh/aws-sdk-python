"""Generated from Smithy shape ``com.amazonaws.directconnect#StartBgpFailoverTest``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.start_bgp_failover_test_response.StartBgpFailoverTestResponse = capo_direct_connect.types.start_bgp_failover_test_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OvertureService.StartBgpFailoverTest"
    body: bytes | None = json.dumps(
        capo_direct_connect.types.start_bgp_failover_test_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_bgp_failover_test(
