"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeRouterConfiguration``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.describe_router_configuration_response.DescribeRouterConfigurationResponse = capo_direct_connect.types.describe_router_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OvertureService.DescribeRouterConfiguration"
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_router_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_router_configuration(
