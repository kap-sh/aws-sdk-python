"""Generated from Smithy shape ``com.amazonaws.directconnect#AllocateHostedConnection``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_direct_connect.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_direct_connect.types.connection.Connection = (
        capo_direct_connect.types.connection.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.allocate_hosted_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
def allocate_hosted_connection(
    ...
    input_: capo_direct_connect.types.allocate_hosted_connection_request.AllocateHostedConnectionRequest,
) -> tuple[capo_direct_connect.types.connection.Connection, zapros.Response]:
...
async def async_allocate_hosted_connection(
