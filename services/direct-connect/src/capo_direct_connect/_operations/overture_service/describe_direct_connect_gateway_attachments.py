"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeDirectConnectGatewayAttachments``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.describe_direct_connect_gateway_attachments_result.DescribeDirectConnectGatewayAttachmentsResult = capo_direct_connect.types.describe_direct_connect_gateway_attachments_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_direct_connect_gateway_attachments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_direct_connect_gateway_attachments(
