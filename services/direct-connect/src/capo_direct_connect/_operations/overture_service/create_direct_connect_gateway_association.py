...
def handle_response(
    ...
    out: capo_direct_connect.types.create_direct_connect_gateway_association_result.CreateDirectConnectGatewayAssociationResult = capo_direct_connect.types.create_direct_connect_gateway_association_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.create_direct_connect_gateway_association_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
