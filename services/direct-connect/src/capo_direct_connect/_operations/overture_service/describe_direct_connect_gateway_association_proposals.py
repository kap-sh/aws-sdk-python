"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeDirectConnectGatewayAssociationProposals``."""
...
import capo_direct_connect.types.direct_connect_gateway_association_proposal_list
...
def handle_response(
    ...
    out: capo_direct_connect.types.describe_direct_connect_gateway_association_proposals_result.DescribeDirectConnectGatewayAssociationProposalsResult = capo_direct_connect.types.describe_direct_connect_gateway_association_proposals_result.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_direct_connect._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_direct_connect_gateway_association_proposals_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_direct_connect_gateway_association_proposals(
