"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeVirtualGateways``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.virtual_gateways.VirtualGateways = (
        capo_direct_connect.types.virtual_gateways.deserialize_aws_json_1_1(
...
) -> tuple[capo_direct_connect.types.virtual_gateways.VirtualGateways, zapros.Response]:
...
async def async_describe_virtual_gateways(
