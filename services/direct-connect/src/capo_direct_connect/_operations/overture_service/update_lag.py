"""Generated from Smithy shape ``com.amazonaws.directconnect#UpdateLag``."""
...
def handle_response(response: zapros.Response) -> capo_direct_connect.types.lag.Lag:
    out: capo_direct_connect.types.lag.Lag = (
        capo_direct_connect.types.lag.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.update_lag_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_lag(
    ...
    input_: capo_direct_connect.types.update_lag_request.UpdateLagRequest,
) -> tuple[capo_direct_connect.types.lag.Lag, zapros.Response]:
