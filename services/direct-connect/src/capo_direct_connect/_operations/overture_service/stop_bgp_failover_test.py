"""Generated from Smithy shape ``com.amazonaws.directconnect#StopBgpFailoverTest``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.stop_bgp_failover_test_response.StopBgpFailoverTestResponse = capo_direct_connect.types.stop_bgp_failover_test_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OvertureService.StopBgpFailoverTest"
    body: bytes | None = json.dumps(
        capo_direct_connect.types.stop_bgp_failover_test_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_bgp_failover_test(
