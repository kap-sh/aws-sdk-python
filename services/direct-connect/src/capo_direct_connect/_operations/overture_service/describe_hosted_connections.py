...
def handle_response(
    ...
    out: capo_direct_connect.types.connections.Connections = (
        capo_direct_connect.types.connections.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_hosted_connections_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
def describe_hosted_connections(
    ...
    input_: capo_direct_connect.types.describe_hosted_connections_request.DescribeHostedConnectionsRequest,
) -> tuple[capo_direct_connect.types.connections.Connections, zapros.Response]:
