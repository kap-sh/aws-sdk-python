"""Generated from Smithy shape ``com.amazonaws.directconnect#CreateBGPPeer``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.create_bgp_peer_response.CreateBGPPeerResponse = (
        capo_direct_connect.types.create_bgp_peer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.create_bgp_peer_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_bgp_peer(
