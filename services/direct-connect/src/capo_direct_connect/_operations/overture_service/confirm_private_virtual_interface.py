"""Generated from Smithy shape ``com.amazonaws.directconnect#ConfirmPrivateVirtualInterface``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.confirm_private_virtual_interface_response.ConfirmPrivateVirtualInterfaceResponse = capo_direct_connect.types.confirm_private_virtual_interface_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.confirm_private_virtual_interface_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_confirm_private_virtual_interface(
