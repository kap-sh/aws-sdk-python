"""Generated from Smithy shape ``com.amazonaws.directconnect#DeleteVirtualInterface``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.delete_virtual_interface_response.DeleteVirtualInterfaceResponse = capo_direct_connect.types.delete_virtual_interface_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.delete_virtual_interface_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_virtual_interface(
