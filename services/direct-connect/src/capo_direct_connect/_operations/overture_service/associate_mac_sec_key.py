"""Generated from Smithy shape ``com.amazonaws.directconnect#AssociateMacSecKey``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.associate_mac_sec_key_response.AssociateMacSecKeyResponse = capo_direct_connect.types.associate_mac_sec_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OvertureService.AssociateMacSecKey"
    body: bytes | None = json.dumps(
        capo_direct_connect.types.associate_mac_sec_key_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_mac_sec_key(
