"""Generated from Smithy shape ``com.amazonaws.directconnect#DeleteInterconnect``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.delete_interconnect_response.DeleteInterconnectResponse = capo_direct_connect.types.delete_interconnect_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.delete_interconnect_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_interconnect(
