...
class AsyncPanoramaClientConfig(TypedDict, total=False, closed=True):
...
class AsyncPanoramaClient:
    ...
    def __init__(
        ...
        self._config = AsyncPanoramaClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncPanoramaClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncPanoramaClientConfig = config_overrides or {}
    ...
    async def create_application_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.create_application_instance_request.CreateApplicationInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.create_application_instance_response.CreateApplicationInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.create_application_instance.async_create_application_instance(
    ...
    async def create_job_for_devices(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.create_job_for_devices_request.CreateJobForDevicesRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.create_job_for_devices_response.CreateJobForDevicesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.create_job_for_devices.async_create_job_for_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_node_from_template_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.create_node_from_template_job_request.CreateNodeFromTemplateJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.create_node_from_template_job_response.CreateNodeFromTemplateJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.create_node_from_template_job.async_create_node_from_template_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.create_package_request.CreatePackageRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.create_package_response.CreatePackageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.create_package.async_create_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_package_import_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.create_package_import_job_request.CreatePackageImportJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.create_package_import_job_response.CreatePackageImportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.create_package_import_job.async_create_package_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.delete_device_request.DeleteDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.delete_device_response.DeleteDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.delete_device.async_delete_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.delete_package_request.DeletePackageRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.delete_package_response.DeletePackageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.delete_package.async_delete_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_package_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.deregister_package_version_request.DeregisterPackageVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.deregister_package_version_response.DeregisterPackageVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.deregister_package_version.async_deregister_package_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_application_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.describe_application_instance_request.DescribeApplicationInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.describe_application_instance_response.DescribeApplicationInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.describe_application_instance.async_describe_application_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_application_instance_details(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.describe_application_instance_details_request.DescribeApplicationInstanceDetailsRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.describe_application_instance_details_response.DescribeApplicationInstanceDetailsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.describe_application_instance_details.async_describe_application_instance_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.describe_device_request.DescribeDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.describe_device_response.DescribeDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.describe_device.async_describe_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_device_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.describe_device_job_request.DescribeDeviceJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.describe_device_job_response.DescribeDeviceJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.describe_device_job.async_describe_device_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_node(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.describe_node_request.DescribeNodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.describe_node_response.DescribeNodeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.describe_node.async_describe_node(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_node_from_template_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.describe_node_from_template_job_request.DescribeNodeFromTemplateJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.describe_node_from_template_job_response.DescribeNodeFromTemplateJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.describe_node_from_template_job.async_describe_node_from_template_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.describe_package_request.DescribePackageRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.describe_package_response.DescribePackageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.describe_package.async_describe_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_package_import_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.describe_package_import_job_request.DescribePackageImportJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.describe_package_import_job_response.DescribePackageImportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.describe_package_import_job.async_describe_package_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_package_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.describe_package_version_request.DescribePackageVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.describe_package_version_response.DescribePackageVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.describe_package_version.async_describe_package_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_application_instance_dependencies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.list_application_instance_dependencies_request.ListApplicationInstanceDependenciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.list_application_instance_dependencies_response.ListApplicationInstanceDependenciesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.list_application_instance_dependencies.async_list_application_instance_dependencies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_application_instance_node_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.list_application_instance_node_instances_request.ListApplicationInstanceNodeInstancesRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.list_application_instance_node_instances_response.ListApplicationInstanceNodeInstancesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.list_application_instance_node_instances.async_list_application_instance_node_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_application_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.list_application_instances_request.ListApplicationInstancesRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.list_application_instances_response.ListApplicationInstancesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.list_application_instances.async_list_application_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_devices(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.list_devices_request.ListDevicesRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.list_devices_response.ListDevicesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.list_devices.async_list_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_devices_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.list_devices_jobs_request.ListDevicesJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.list_devices_jobs_response.ListDevicesJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.list_devices_jobs.async_list_devices_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_node_from_template_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.list_node_from_template_jobs_request.ListNodeFromTemplateJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.list_node_from_template_jobs_response.ListNodeFromTemplateJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.list_node_from_template_jobs.async_list_node_from_template_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_nodes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.list_nodes_request.ListNodesRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.list_nodes_response.ListNodesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.list_nodes.async_list_nodes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_package_import_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.list_package_import_jobs_request.ListPackageImportJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.list_package_import_jobs_response.ListPackageImportJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.list_package_import_jobs.async_list_package_import_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_packages(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.list_packages_request.ListPackagesRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.list_packages_response.ListPackagesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.list_packages.async_list_packages(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def provision_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.provision_device_request.ProvisionDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.provision_device_response.ProvisionDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.provision_device.async_provision_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_package_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.register_package_version_request.RegisterPackageVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.register_package_version_response.RegisterPackageVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.register_package_version.async_register_package_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_application_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.remove_application_instance_request.RemoveApplicationInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.remove_application_instance_response.RemoveApplicationInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.remove_application_instance.async_remove_application_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def signal_application_instance_node_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.signal_application_instance_node_instances_request.SignalApplicationInstanceNodeInstancesRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.signal_application_instance_node_instances_response.SignalApplicationInstanceNodeInstancesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.signal_application_instance_node_instances.async_signal_application_instance_node_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_device_metadata(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_panorama.types.update_device_metadata_request.UpdateDeviceMetadataRequest]",
        ) -> AsyncOperationResponse[
            "capo_panorama.types.update_device_metadata_response.UpdateDeviceMetadataResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_panorama._operations.omni_cloud_service_lambda.update_device_metadata.async_update_device_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
