...
import capo_panorama.types.device_list
...
def handle_response(
    ...
    out: capo_panorama.types.list_devices_response.ListDevicesResponse = (
        capo_panorama.types.list_devices_response.deserialize_json(
...
def list_devices(
    ...
    capo_panorama.types.list_devices_response.ListDevicesResponse, zapros.Response
]:
