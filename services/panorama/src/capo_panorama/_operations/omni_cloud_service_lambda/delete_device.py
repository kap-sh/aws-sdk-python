"""Generated from Smithy shape ``com.amazonaws.panorama#DeleteDevice``."""
...
def handle_response(
    ...
    out: capo_panorama.types.delete_device_response.DeleteDeviceResponse = (
        capo_panorama.types.delete_device_response.deserialize_json(
...
def delete_device(
    ...
    capo_panorama.types.delete_device_response.DeleteDeviceResponse, zapros.Response
]:
