"""Generated from Smithy shape ``com.amazonaws.panorama#DescribeNode``."""
...
def handle_response(
    ...
    out: capo_panorama.types.describe_node_response.DescribeNodeResponse = (
        capo_panorama.types.describe_node_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/nodes/{NodeId}"
...
def describe_node(
    ...
    capo_panorama.types.describe_node_response.DescribeNodeResponse, zapros.Response
]:
