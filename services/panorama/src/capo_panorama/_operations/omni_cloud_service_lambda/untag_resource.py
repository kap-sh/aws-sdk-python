"""Generated from Smithy shape ``com.amazonaws.panorama#UntagResource``."""
...
def handle_response(
    ...
    out: capo_panorama.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_panorama.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
