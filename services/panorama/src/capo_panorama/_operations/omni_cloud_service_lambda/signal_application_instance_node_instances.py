...
import capo_panorama.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_panorama.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_panorama.types.signal_application_instance_node_instances_response.SignalApplicationInstanceNodeInstancesResponse = capo_panorama.types.signal_application_instance_node_instances_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_panorama.types.signal_application_instance_node_instances_request.serialize_json(
            input_
        )
    ).encode()
