"""Generated from Smithy shape ``com.amazonaws.panorama#DescribePackageImportJob``."""
...
def handle_response(
    ...
    out: capo_panorama.types.describe_package_import_job_response.DescribePackageImportJobResponse = capo_panorama.types.describe_package_import_job_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/packages/import-jobs/{JobId}"
...
async def async_describe_package_import_job(
