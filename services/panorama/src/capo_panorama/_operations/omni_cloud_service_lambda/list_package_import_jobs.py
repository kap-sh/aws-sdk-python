"""Generated from Smithy shape ``com.amazonaws.panorama#ListPackageImportJobs``."""
...
def handle_response(
    ...
    out: capo_panorama.types.list_package_import_jobs_response.ListPackageImportJobsResponse = capo_panorama.types.list_package_import_jobs_response.deserialize_json(
...
async def async_list_package_import_jobs(
