...
def handle_response(
    ...
    out: capo_panorama.types.describe_application_instance_response.DescribeApplicationInstanceResponse = capo_panorama.types.describe_application_instance_response.deserialize_json(
