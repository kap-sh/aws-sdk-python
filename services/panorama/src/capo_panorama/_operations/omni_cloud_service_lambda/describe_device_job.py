"""Generated from Smithy shape ``com.amazonaws.panorama#DescribeDeviceJob``."""
...
def handle_response(
    ...
    out: capo_panorama.types.describe_device_job_response.DescribeDeviceJobResponse = (
        capo_panorama.types.describe_device_job_response.deserialize_json(
...
async def async_describe_device_job(
