"""Generated from Smithy shape ``com.amazonaws.panorama#ProvisionDevice``."""
...
def handle_response(
    ...
    out: capo_panorama.types.provision_device_response.ProvisionDeviceResponse = (
        capo_panorama.types.provision_device_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_panorama.types.provision_device_request.serialize_json(input_)
    ).encode()
