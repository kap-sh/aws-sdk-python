"""Generated from Smithy shape ``com.amazonaws.panorama#ListDevicesJobs``."""
...
def handle_response(
    ...
    out: capo_panorama.types.list_devices_jobs_response.ListDevicesJobsResponse = (
        capo_panorama.types.list_devices_jobs_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "device_id" in input_:
        params["DeviceId"] = str(input_["device_id"])
...
async def async_list_devices_jobs(
