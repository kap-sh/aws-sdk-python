"""Generated from Smithy shape ``com.amazonaws.panorama#DescribePackage``."""
...
def handle_response(
    ...
    out: capo_panorama.types.describe_package_response.DescribePackageResponse = (
        capo_panorama.types.describe_package_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/packages/metadata/{PackageId}"
...
async def async_describe_package(
