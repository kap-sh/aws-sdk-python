...
class PanoramaError(Exception):
    """Base class for all Panorama service errors."""


class ServiceError(PanoramaError):
...
class SerializationError(PanoramaError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PanoramaError):
...
class WaiterFailedError(PanoramaError):
...
class WaiterTimeoutError(PanoramaError):
