...
if TYPE_CHECKING:
    ...
    import aws_sdk_panorama.types.update_created_time
    import aws_sdk_panorama.types.update_progress


class DescribeDeviceJobResponse(TypedDict):
    job_id: NotRequired["aws_sdk_panorama.types.job_id.JobId"]
    """<p>The job's ID.</p>"""
    device_id: NotRequired["aws_sdk_panorama.types.device_id.DeviceId"]
    """<p>The device's ID.</p>"""
    device_arn: NotRequired["aws_sdk_panorama.types.device_arn.DeviceArn"]
    """<p>The device's ARN.</p>"""
    device_name: NotRequired["aws_sdk_panorama.types.device_name.DeviceName"]
    """<p>The device's name.</p>"""
    device_type: NotRequired["aws_sdk_panorama.types.device_type.DeviceType"]
    ...
    created_time: NotRequired[
        "aws_sdk_panorama.types.update_created_time.UpdateCreatedTime"
    ]
...
def serialize_json(value: DescribeDeviceJobResponse) -> dict:
    ...
    if "created_time" in value:
        ...
        out["CreatedTime"] = aws_sdk_panorama.types.update_created_time.serialize_json(
            value["created_time"]
        )
...
def deserialize_json(data: dict) -> DescribeDeviceJobResponse:
    ...
    if "CreatedTime" in data:
        ...
        out["created_time"] = (
            aws_sdk_panorama.types.update_created_time.deserialize_json(
                data["CreatedTime"]
            )
        )
    if "JobType" in data:
