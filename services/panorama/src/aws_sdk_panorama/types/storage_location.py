...
if TYPE_CHECKING:
    import aws_sdk_panorama.types.bucket
...
class StorageLocation(TypedDict, closed=True):
    ...
    generated_prefix_location: "aws_sdk_panorama.types.object.Object"
    """<p>The location's generated prefix.</p>"""
    binary_prefix_location: "aws_sdk_panorama.types.object.Object"
    """<p>The location's binary prefix.</p>"""
    manifest_prefix_location: "aws_sdk_panorama.types.object.Object"
