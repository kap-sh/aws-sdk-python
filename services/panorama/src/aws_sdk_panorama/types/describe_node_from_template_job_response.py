...
class DescribeNodeFromTemplateJobResponse(TypedDict):
    ...
    status_message: "aws_sdk_panorama.types.node_from_template_job_status_message.NodeFromTemplateJobStatusMessage"
