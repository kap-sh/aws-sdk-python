...
class ListApplicationInstanceNodeInstancesResponse(TypedDict):
    node_instances: NotRequired["aws_sdk_panorama.types.node_instances.NodeInstances"]
...
def serialize_json(value: ListApplicationInstanceNodeInstancesResponse) -> dict:
    ...
    if "node_instances" in value:
        ...
        out["NodeInstances"] = aws_sdk_panorama.types.node_instances.serialize_json(
...
def deserialize_json(data: dict) -> ListApplicationInstanceNodeInstancesResponse:
    ...
    if "NodeInstances" in data:
        ...
        out["node_instances"] = aws_sdk_panorama.types.node_instances.deserialize_json(
            data["NodeInstances"]
        )
