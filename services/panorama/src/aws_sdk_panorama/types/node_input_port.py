...
if TYPE_CHECKING:
    ...
    import aws_sdk_panorama.types.max_connections
    import aws_sdk_panorama.types.port_default_value
    import aws_sdk_panorama.types.port_name
...
class NodeInputPort(TypedDict):
    ...
    type: NotRequired["aws_sdk_panorama.types.port_type.PortType"]
    """<p>The input port's type.</p>"""
    default_value: NotRequired[
        "aws_sdk_panorama.types.port_default_value.PortDefaultValue"
    ]
    """<p>The input port's default value.</p>"""
    max_connections: "aws_sdk_panorama.types.max_connections.MaxConnections"
