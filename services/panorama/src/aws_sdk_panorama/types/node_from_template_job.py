...
if TYPE_CHECKING:
    ...
    import aws_sdk_panorama.types.node_from_template_job_status
    import aws_sdk_panorama.types.node_from_template_job_status_message
...
class NodeFromTemplateJob(TypedDict, closed=True):
    ...
    status: NotRequired[
        "aws_sdk_panorama.types.node_from_template_job_status.NodeFromTemplateJobStatus"
    ]
    """<p>The job's status.</p>"""
    status_message: NotRequired[
        "aws_sdk_panorama.types.node_from_template_job_status_message.NodeFromTemplateJobStatusMessage"
    ]
