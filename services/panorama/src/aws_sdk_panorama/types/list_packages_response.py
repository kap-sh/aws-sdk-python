...
if TYPE_CHECKING:
    ...
    import aws_sdk_panorama.types.package_list


class ListPackagesResponse(TypedDict, closed=True):
    packages: NotRequired["aws_sdk_panorama.types.package_list.PackageList"]
...
def serialize_json(value: ListPackagesResponse) -> dict:
    ...
    if "packages" in value:
        ...
        out["Packages"] = aws_sdk_panorama.types.package_list.serialize_json(
            value["packages"]
        )
...
def deserialize_json(data: dict) -> ListPackagesResponse:
    ...
    if "Packages" in data:
        ...
        out["packages"] = aws_sdk_panorama.types.package_list.deserialize_json(
            data["Packages"]
        )
