...
def build_request(
    ...
    input: aws_sdk_panorama.types.create_package_import_job_request.CreatePackageImportJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.create_package_import_job_request.serialize_json(input)
    ).encode()
