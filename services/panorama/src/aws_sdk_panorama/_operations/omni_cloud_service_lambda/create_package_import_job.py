"""Generated from Smithy shape ``com.amazonaws.panorama#CreatePackageImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_panorama.types.create_package_import_job_response.CreatePackageImportJobResponse = aws_sdk_panorama.types.create_package_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.create_package_import_job_request.CreatePackageImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/packages/import-jobs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.create_package_import_job_request.serialize_json(input_)
    ).encode()
...
async def async_create_package_import_job(
