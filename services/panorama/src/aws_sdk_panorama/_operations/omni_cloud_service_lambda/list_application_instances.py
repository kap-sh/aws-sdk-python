"""Generated from Smithy shape ``com.amazonaws.panorama#ListApplicationInstances``."""
...
def handle_response(
    ...
    out: aws_sdk_panorama.types.list_application_instances_response.ListApplicationInstancesResponse = aws_sdk_panorama.types.list_application_instances_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_panorama.types.list_application_instances_request.ListApplicationInstancesRequest,
) -> zapros.Request:
    ...
    if "device_id" in input:
        params["deviceId"] = str(input["device_id"])
...
async def async_list_application_instances(
