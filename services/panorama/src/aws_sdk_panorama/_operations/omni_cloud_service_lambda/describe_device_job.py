...
def handle_response(
    ...
    out: aws_sdk_panorama.types.describe_device_job_response.DescribeDeviceJobResponse = aws_sdk_panorama.types.describe_device_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.describe_device_job_request.DescribeDeviceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
