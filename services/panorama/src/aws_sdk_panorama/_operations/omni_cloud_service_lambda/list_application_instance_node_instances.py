"""Generated from Smithy shape ``com.amazonaws.panorama#ListApplicationInstanceNodeInstances``."""
...
import aws_sdk_panorama.types.node_instances
...
def handle_response(
    ...
    out: aws_sdk_panorama.types.list_application_instance_node_instances_response.ListApplicationInstanceNodeInstancesResponse = aws_sdk_panorama.types.list_application_instance_node_instances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.list_application_instance_node_instances_request.ListApplicationInstanceNodeInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_application_instance_node_instances(
