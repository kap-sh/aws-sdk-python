...
def handle_response(
    ...
    out: aws_sdk_panorama.types.describe_node_response.DescribeNodeResponse = (
        aws_sdk_panorama.types.describe_node_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.describe_node_request.DescribeNodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_node(
    ...
    aws_sdk_panorama.types.describe_node_response.DescribeNodeResponse, zapros.Response
]:
