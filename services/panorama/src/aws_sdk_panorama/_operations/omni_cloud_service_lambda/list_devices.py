...
def build_request(
    ...
    input: aws_sdk_panorama.types.list_devices_request.ListDevicesRequest,
) -> zapros.Request:
    ...
    if "name_filter" in input:
        params["NameFilter"] = str(input["name_filter"])
    if "device_aggregated_status_filter" in input:
        params["DeviceAggregatedStatusFilter"] = str(
            input["device_aggregated_status_filter"]
        )
