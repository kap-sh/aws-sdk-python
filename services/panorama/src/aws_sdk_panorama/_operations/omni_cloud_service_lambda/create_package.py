...
def handle_response(
    ...
    out: aws_sdk_panorama.types.create_package_response.CreatePackageResponse = (
        aws_sdk_panorama.types.create_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.create_package_request.CreatePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.create_package_request.serialize_json(input_)
    ).encode()
