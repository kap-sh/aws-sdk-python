"""Generated from Smithy shape ``com.amazonaws.panorama#DescribeApplicationInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_panorama.types.describe_application_instance_response.DescribeApplicationInstanceResponse = aws_sdk_panorama.types.describe_application_instance_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_panorama.types.describe_application_instance_request.DescribeApplicationInstanceRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/application-instances/{ApplicationInstanceId}"
    url = url.replace(
...
async def async_describe_application_instance(
