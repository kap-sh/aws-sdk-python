"""Generated from Smithy shape ``com.amazonaws.panorama#DescribeNodeFromTemplateJob``."""
...
def handle_response(
    ...
    out: aws_sdk_panorama.types.describe_node_from_template_job_response.DescribeNodeFromTemplateJobResponse = aws_sdk_panorama.types.describe_node_from_template_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.describe_node_from_template_job_request.DescribeNodeFromTemplateJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/packages/template-job/{JobId}"
...
async def async_describe_node_from_template_job(
