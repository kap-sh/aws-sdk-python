...
def handle_response(
    ...
    out: aws_sdk_panorama.types.list_packages_response.ListPackagesResponse = (
        aws_sdk_panorama.types.list_packages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.list_packages_request.ListPackagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_packages(
    ...
    aws_sdk_panorama.types.list_packages_response.ListPackagesResponse, zapros.Response
]:
