...
def handle_response(
    ...
    out: aws_sdk_panorama.types.remove_application_instance_response.RemoveApplicationInstanceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.remove_application_instance_request.RemoveApplicationInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
