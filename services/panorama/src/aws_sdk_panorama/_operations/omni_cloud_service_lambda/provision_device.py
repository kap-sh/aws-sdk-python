...
def handle_response(
    ...
    out: aws_sdk_panorama.types.provision_device_response.ProvisionDeviceResponse = (
        aws_sdk_panorama.types.provision_device_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.provision_device_request.ProvisionDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.provision_device_request.serialize_json(input_)
    ).encode()
