...
def handle_response(
    ...
    out: aws_sdk_panorama.types.describe_package_response.DescribePackageResponse = (
        aws_sdk_panorama.types.describe_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.describe_package_request.DescribePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
