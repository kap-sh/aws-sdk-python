...
def handle_response(
    ...
    out: aws_sdk_panorama.types.list_nodes_response.ListNodesResponse = (
        aws_sdk_panorama.types.list_nodes_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_panorama.types.list_nodes_request.ListNodesRequest,
) -> zapros.Request:
    ...
    if "package_name" in input:
        params["packageName"] = str(input["package_name"])
    if "package_version" in input:
        params["packageVersion"] = str(input["package_version"])
    if "patch_version" in input:
        params["patchVersion"] = str(input["patch_version"])
...
def list_nodes(
    ...
    aws_sdk_panorama.types.list_nodes_response.ListNodesResponse, zapros.Response
]:
