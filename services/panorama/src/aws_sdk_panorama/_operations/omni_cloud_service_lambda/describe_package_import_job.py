...
def handle_response(
    ...
    out: aws_sdk_panorama.types.describe_package_import_job_response.DescribePackageImportJobResponse = aws_sdk_panorama.types.describe_package_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.describe_package_import_job_request.DescribePackageImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
