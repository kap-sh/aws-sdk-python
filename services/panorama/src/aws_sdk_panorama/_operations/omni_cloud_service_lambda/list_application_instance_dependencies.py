...
def handle_response(
    ...
    out: aws_sdk_panorama.types.list_application_instance_dependencies_response.ListApplicationInstanceDependenciesResponse = aws_sdk_panorama.types.list_application_instance_dependencies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.list_application_instance_dependencies_request.ListApplicationInstanceDependenciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
