...
def handle_response(
    ...
    out: aws_sdk_panorama.types.describe_device_response.DescribeDeviceResponse = (
        aws_sdk_panorama.types.describe_device_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.describe_device_request.DescribeDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
