...
def handle_response(
    ...
    out: aws_sdk_panorama.types.describe_package_version_response.DescribePackageVersionResponse = aws_sdk_panorama.types.describe_package_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.describe_package_version_request.DescribePackageVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
