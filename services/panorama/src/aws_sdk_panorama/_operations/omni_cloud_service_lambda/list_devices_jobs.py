...
def handle_response(
    ...
    out: aws_sdk_panorama.types.list_devices_jobs_response.ListDevicesJobsResponse = (
        aws_sdk_panorama.types.list_devices_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.list_devices_jobs_request.ListDevicesJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
