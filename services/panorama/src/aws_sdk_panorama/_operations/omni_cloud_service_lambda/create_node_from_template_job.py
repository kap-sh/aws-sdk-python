...
def handle_response(
    ...
    out: aws_sdk_panorama.types.create_node_from_template_job_response.CreateNodeFromTemplateJobResponse = aws_sdk_panorama.types.create_node_from_template_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.create_node_from_template_job_request.CreateNodeFromTemplateJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.create_node_from_template_job_request.serialize_json(
            input_
        )
    ).encode()
