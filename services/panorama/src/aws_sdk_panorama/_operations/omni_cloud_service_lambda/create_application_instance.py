...
def handle_response(
    ...
    out: aws_sdk_panorama.types.create_application_instance_response.CreateApplicationInstanceResponse = aws_sdk_panorama.types.create_application_instance_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_panorama.types.create_application_instance_request.CreateApplicationInstanceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.create_application_instance_request.serialize_json(input)
    ).encode()
