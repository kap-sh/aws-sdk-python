...
def build_request(
    ...
    input_: aws_sdk_panorama.types.create_application_instance_request.CreateApplicationInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.create_application_instance_request.serialize_json(
            input_
        )
    ).encode()
