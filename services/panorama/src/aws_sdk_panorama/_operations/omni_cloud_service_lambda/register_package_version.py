...
def handle_response(
    ...
    out: aws_sdk_panorama.types.register_package_version_response.RegisterPackageVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.register_package_version_request.RegisterPackageVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.register_package_version_request.serialize_json(input_)
    ).encode()
