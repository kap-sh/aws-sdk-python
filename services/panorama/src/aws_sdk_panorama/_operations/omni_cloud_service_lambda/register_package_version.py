...
def build_request(
    ...
    input: aws_sdk_panorama.types.register_package_version_request.RegisterPackageVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.register_package_version_request.serialize_json(input)
    ).encode()
