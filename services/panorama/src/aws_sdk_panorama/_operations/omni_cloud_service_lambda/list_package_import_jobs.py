...
def handle_response(
    ...
    out: aws_sdk_panorama.types.list_package_import_jobs_response.ListPackageImportJobsResponse = aws_sdk_panorama.types.list_package_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.list_package_import_jobs_request.ListPackageImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
