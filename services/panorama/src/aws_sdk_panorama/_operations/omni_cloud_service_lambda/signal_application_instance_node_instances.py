...
def build_request(
    ...
    input_: aws_sdk_panorama.types.signal_application_instance_node_instances_request.SignalApplicationInstanceNodeInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["application_instance_id"]), safe=""),
    )
    params: dict[str, str] = {}
