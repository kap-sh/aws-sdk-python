"""Generated from Smithy shape ``com.amazonaws.panorama#SignalApplicationInstanceNodeInstances``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_panorama.errors.service_quota_exceeded_exception

            raise aws_sdk_panorama.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_panorama.types.signal_application_instance_node_instances_response.SignalApplicationInstanceNodeInstancesResponse = aws_sdk_panorama.types.signal_application_instance_node_instances_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_panorama.types.signal_application_instance_node_instances_request.SignalApplicationInstanceNodeInstancesRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ApplicationInstanceId}", quote(str(input["application_instance_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.signal_application_instance_node_instances_request.serialize_json(
            input
        )
    ).encode()
...
async def async_signal_application_instance_node_instances(
