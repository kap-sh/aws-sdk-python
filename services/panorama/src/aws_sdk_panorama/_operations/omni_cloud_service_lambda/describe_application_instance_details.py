...
def handle_response(
    ...
    out: aws_sdk_panorama.types.describe_application_instance_details_response.DescribeApplicationInstanceDetailsResponse = aws_sdk_panorama.types.describe_application_instance_details_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.describe_application_instance_details_request.DescribeApplicationInstanceDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
