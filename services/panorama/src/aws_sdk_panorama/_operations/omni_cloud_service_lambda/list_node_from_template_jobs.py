...
def handle_response(
    ...
    out: aws_sdk_panorama.types.list_node_from_template_jobs_response.ListNodeFromTemplateJobsResponse = aws_sdk_panorama.types.list_node_from_template_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.list_node_from_template_jobs_request.ListNodeFromTemplateJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
