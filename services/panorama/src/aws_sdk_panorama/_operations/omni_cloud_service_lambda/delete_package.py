...
def handle_response(
    ...
    out: aws_sdk_panorama.types.delete_package_response.DeletePackageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.delete_package_request.DeletePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
