...
def build_request(
    ...
    input: aws_sdk_panorama.types.update_device_metadata_request.UpdateDeviceMetadataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.update_device_metadata_request.serialize_json(input)
    ).encode()
