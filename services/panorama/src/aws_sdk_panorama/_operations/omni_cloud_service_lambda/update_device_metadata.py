...
def handle_response(
    ...
    out: aws_sdk_panorama.types.update_device_metadata_response.UpdateDeviceMetadataResponse = aws_sdk_panorama.types.update_device_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_panorama.types.update_device_metadata_request.UpdateDeviceMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.update_device_metadata_request.serialize_json(input_)
    ).encode()
