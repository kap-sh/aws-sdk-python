"""Generated from Smithy shape ``com.amazonaws.panorama#CreateJobForDevices``."""
...
def handle_response(
    ...
    out: aws_sdk_panorama.types.create_job_for_devices_response.CreateJobForDevicesResponse = aws_sdk_panorama.types.create_job_for_devices_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_panorama.types.create_job_for_devices_request.CreateJobForDevicesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_panorama.types.create_job_for_devices_request.serialize_json(input)
    ).encode()
...
async def async_create_job_for_devices(
