...
```
pip install aws-sdk-bcm-dashboards
```

## Usage

```python
from aws_sdk_bcm_dashboards import AsyncBCMDashboardsClient
...
```python
from aws_sdk_bcm_dashboards import AsyncBCMDashboardsClient
from aws_sdk_bcm_dashboards.error import AccessDeniedException
