...
def handle_response(
    ...
    out: aws_sdk_bcm_dashboards.types.execute_scheduled_report_response.ExecuteScheduledReportResponse = aws_sdk_bcm_dashboards.types.execute_scheduled_report_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_dashboards.types.execute_scheduled_report_request.ExecuteScheduledReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
