"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#UpdateDashboard``."""
...
def handle_response(
    ...
    out: aws_sdk_bcm_dashboards.types.update_dashboard_response.UpdateDashboardResponse = aws_sdk_bcm_dashboards.types.update_dashboard_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_dashboards.types.update_dashboard_request.UpdateDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSBCMDashboardsService.UpdateDashboard"
    import aws_sdk_bcm_dashboards.types.update_dashboard_request

    body: bytes | None = json.dumps(
        aws_sdk_bcm_dashboards.types.update_dashboard_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
