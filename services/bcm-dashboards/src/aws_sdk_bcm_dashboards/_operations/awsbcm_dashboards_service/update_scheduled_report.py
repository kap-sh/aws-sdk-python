"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#UpdateScheduledReport``."""
...
import aws_sdk_bcm_dashboards.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_bcm_dashboards.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_bcm_dashboards.types.update_scheduled_report_response.UpdateScheduledReportResponse = aws_sdk_bcm_dashboards.types.update_scheduled_report_response.deserialize_aws_json_1_0(
...
def get_signer(
...
) -> aws_sdk_bcm_dashboards._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_bcm_dashboards._auth._sigv4.build_sigv4_auth_scheme(
                "bcm-dashboards", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_bcm_dashboards._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_bcm_dashboards.types.update_scheduled_report_request.UpdateScheduledReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSBCMDashboardsService.UpdateScheduledReport"
    body: bytes | None = json.dumps(
        aws_sdk_bcm_dashboards.types.update_scheduled_report_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_scheduled_report(
