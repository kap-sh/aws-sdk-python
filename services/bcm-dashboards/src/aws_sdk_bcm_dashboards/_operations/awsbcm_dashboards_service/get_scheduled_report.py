"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#GetScheduledReport``."""
...
def handle_response(
    ...
    out: aws_sdk_bcm_dashboards.types.get_scheduled_report_response.GetScheduledReportResponse = aws_sdk_bcm_dashboards.types.get_scheduled_report_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_dashboards.types.get_scheduled_report_request.GetScheduledReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSBCMDashboardsService.GetScheduledReport"
    import aws_sdk_bcm_dashboards.types.get_scheduled_report_request

    body: bytes | None = json.dumps(
        aws_sdk_bcm_dashboards.types.get_scheduled_report_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_scheduled_report(
