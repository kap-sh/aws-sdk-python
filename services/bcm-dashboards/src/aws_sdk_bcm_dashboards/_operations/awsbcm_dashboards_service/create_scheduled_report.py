...
import aws_sdk_bcm_dashboards.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_bcm_dashboards.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_bcm_dashboards.types.create_scheduled_report_response.CreateScheduledReportResponse = aws_sdk_bcm_dashboards.types.create_scheduled_report_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_dashboards.types.create_scheduled_report_request.CreateScheduledReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_dashboards.types.create_scheduled_report_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
