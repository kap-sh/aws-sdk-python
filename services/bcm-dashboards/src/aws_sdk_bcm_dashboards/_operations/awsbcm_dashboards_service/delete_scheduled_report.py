"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#DeleteScheduledReport``."""
...
def handle_response(
    ...
    out: aws_sdk_bcm_dashboards.types.delete_scheduled_report_response.DeleteScheduledReportResponse = aws_sdk_bcm_dashboards.types.delete_scheduled_report_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_dashboards.types.delete_scheduled_report_request.DeleteScheduledReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSBCMDashboardsService.DeleteScheduledReport"
    import aws_sdk_bcm_dashboards.types.delete_scheduled_report_request

    body: bytes | None = json.dumps(
        aws_sdk_bcm_dashboards.types.delete_scheduled_report_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_scheduled_report(
