...
def handle_response(
    ...
    out: aws_sdk_bcm_dashboards.types.delete_dashboard_response.DeleteDashboardResponse = aws_sdk_bcm_dashboards.types.delete_dashboard_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_dashboards.types.delete_dashboard_request.DeleteDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_dashboards.types.delete_dashboard_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
