...
def build_request(
    ...
    input: aws_sdk_bcm_dashboards.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_dashboards.types.tag_resource_request.serialize_aws_json_1_0(input)
    ).encode()
