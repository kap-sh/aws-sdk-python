...
def handle_response(
    ...
    out: aws_sdk_bcm_dashboards.types.list_scheduled_reports_response.ListScheduledReportsResponse = aws_sdk_bcm_dashboards.types.list_scheduled_reports_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_dashboards.types.list_scheduled_reports_request.ListScheduledReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
