"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#ListDashboards``."""
...
def handle_response(
    ...
    out: aws_sdk_bcm_dashboards.types.list_dashboards_response.ListDashboardsResponse = aws_sdk_bcm_dashboards.types.list_dashboards_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_dashboards.types.list_dashboards_request.ListDashboardsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSBCMDashboardsService.ListDashboards"
    body: bytes | None = json.dumps(
        aws_sdk_bcm_dashboards.types.list_dashboards_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
