"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#GetDashboard``."""
...
def handle_response(
    ...
    out: aws_sdk_bcm_dashboards.types.get_dashboard_response.GetDashboardResponse = (
        aws_sdk_bcm_dashboards.types.get_dashboard_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_bcm_dashboards.types.get_dashboard_request.GetDashboardRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSBCMDashboardsService.GetDashboard"
    import aws_sdk_bcm_dashboards.types.get_dashboard_request

    body: bytes | None = json.dumps(
        aws_sdk_bcm_dashboards.types.get_dashboard_request.serialize_aws_json_1_0(input)
    ).encode()
