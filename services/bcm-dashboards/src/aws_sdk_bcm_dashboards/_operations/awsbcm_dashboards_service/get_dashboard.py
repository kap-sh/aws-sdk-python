...
def build_request(
    ...
    input_: aws_sdk_bcm_dashboards.types.get_dashboard_request.GetDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_dashboards.types.get_dashboard_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
