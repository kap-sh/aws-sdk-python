    ...
    if p.Region is not None:
        ...
        if _locals["PartitionResult"] is not None:
            if p.UseFIPS is True:
                return Endpoint(
                    url=interpolate(
                        "https://bcm-dashboards-fips.{PartitionResult#implicitGlobalRegion}.{PartitionResult#dualStackDnsSuffix}",
                        p,
                        _locals,
                    ),
                    properties={
            ...
            return Endpoint(
                url=interpolate(
                    "https://bcm-dashboards.{PartitionResult#implicitGlobalRegion}.{PartitionResult#dualStackDnsSuffix}",
                    p,
                    _locals,
                ),
                properties={
