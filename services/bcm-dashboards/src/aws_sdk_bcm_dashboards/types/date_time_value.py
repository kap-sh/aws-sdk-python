...
if TYPE_CHECKING:
    import aws_sdk_bcm_dashboards.types.date_time_type
...
def serialize_aws_json_1_0(value: DateTimeValue) -> dict:
    ...
    out["type"] = aws_sdk_bcm_dashboards.types.date_time_type.serialize_aws_json_1_0(
        value["type"]
    )
...
def deserialize_aws_json_1_0(data: dict) -> DateTimeValue:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_bcm_dashboards.types.date_time_type.deserialize_aws_json_1_0(
                data["type"]
            )
        )
    else:
