...
if TYPE_CHECKING:
    ...
    import aws_sdk_bcm_dashboards.types.schedule_period
...
class ScheduleConfig(TypedDict, closed=True):
    ...
    schedule_period: NotRequired[
        "aws_sdk_bcm_dashboards.types.schedule_period.SchedulePeriod"
    ]
    """<p>The time period during which the schedule is active.</p>"""
    state: NotRequired["aws_sdk_bcm_dashboards.types.schedule_state.ScheduleState"]
...
def serialize_aws_json_1_0(value: ScheduleConfig) -> dict:
    ...
    if "schedule_period" in value:
        ...
        out["schedulePeriod"] = (
            aws_sdk_bcm_dashboards.types.schedule_period.serialize_aws_json_1_0(
    ...
    if "state" in value:
        ...
        out["state"] = (
            aws_sdk_bcm_dashboards.types.schedule_state.serialize_aws_json_1_0(
                value["state"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ScheduleConfig:
    ...
    if "schedulePeriod" in data:
        ...
        out["schedule_period"] = (
            aws_sdk_bcm_dashboards.types.schedule_period.deserialize_aws_json_1_0(
                data["schedulePeriod"]
            )
        )
    if "state" in data:
