...
ScheduledReportSummaryList: TypeAlias = list[
    "aws_sdk_bcm_dashboards.types.scheduled_report_summary.ScheduledReportSummary"
]
...
def serialize_aws_json_1_0(value: ScheduledReportSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_bcm_dashboards.types.scheduled_report_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ScheduledReportSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_bcm_dashboards.types.scheduled_report_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
