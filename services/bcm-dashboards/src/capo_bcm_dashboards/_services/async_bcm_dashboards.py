...
from capo_bcm_dashboards._services._aws_config import aaws_config
...
class AsyncBCMDashboardsClientConfig(TypedDict, total=False, closed=True):
...
class AsyncBCMDashboardsClient:
    ...
    async def create_dashboard(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.create_dashboard_request.CreateDashboardRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.create_dashboard_response.CreateDashboardResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.create_dashboard.async_create_dashboard(
    ...
    async def create_scheduled_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.create_scheduled_report_request.CreateScheduledReportRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.create_scheduled_report_response.CreateScheduledReportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.create_scheduled_report.async_create_scheduled_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_dashboard(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.delete_dashboard_request.DeleteDashboardRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.delete_dashboard_response.DeleteDashboardResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.delete_dashboard.async_delete_dashboard(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_scheduled_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.delete_scheduled_report_request.DeleteScheduledReportRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.delete_scheduled_report_response.DeleteScheduledReportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.delete_scheduled_report.async_delete_scheduled_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def execute_scheduled_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.execute_scheduled_report_request.ExecuteScheduledReportRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.execute_scheduled_report_response.ExecuteScheduledReportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.execute_scheduled_report.async_execute_scheduled_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_dashboard(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.get_dashboard_request.GetDashboardRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.get_dashboard_response.GetDashboardResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.get_dashboard.async_get_dashboard(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.get_resource_policy_request.GetResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.get_resource_policy_response.GetResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.get_resource_policy.async_get_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_scheduled_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.get_scheduled_report_request.GetScheduledReportRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.get_scheduled_report_response.GetScheduledReportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.get_scheduled_report.async_get_scheduled_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_dashboards(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.list_dashboards_request.ListDashboardsRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.list_dashboards_response.ListDashboardsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.list_dashboards.async_list_dashboards(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_bcm_dashboards.types.dashboard_reference.DashboardReference]":
        _token = next_token
        while True:
    ...
    async def list_scheduled_reports(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.list_scheduled_reports_request.ListScheduledReportsRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.list_scheduled_reports_response.ListScheduledReportsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.list_scheduled_reports.async_list_scheduled_reports(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_bcm_dashboards.types.scheduled_report_summary.ScheduledReportSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_dashboard(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.update_dashboard_request.UpdateDashboardRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.update_dashboard_response.UpdateDashboardResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.update_dashboard.async_update_dashboard(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_scheduled_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bcm_dashboards.types.update_scheduled_report_request.UpdateScheduledReportRequest]",
        ) -> AsyncOperationResponse[
            "capo_bcm_dashboards.types.update_scheduled_report_response.UpdateScheduledReportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bcm_dashboards._operations.awsbcm_dashboards_service.update_scheduled_report.async_update_scheduled_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
