...
class BCMDashboardsError(Exception):
    """Base class for all BCMDashboards service errors."""


class ServiceError(BCMDashboardsError):
...
class SerializationError(BCMDashboardsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BCMDashboardsError):
...
class WaiterFailedError(BCMDashboardsError):
...
class WaiterTimeoutError(BCMDashboardsError):
