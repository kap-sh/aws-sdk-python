"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#DeleteDashboard``."""
...
def handle_response(
    ...
    out: capo_bcm_dashboards.types.delete_dashboard_response.DeleteDashboardResponse = (
        capo_bcm_dashboards.types.delete_dashboard_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBCMDashboardsService.DeleteDashboard"
    body: bytes | None = json.dumps(
        capo_bcm_dashboards.types.delete_dashboard_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
