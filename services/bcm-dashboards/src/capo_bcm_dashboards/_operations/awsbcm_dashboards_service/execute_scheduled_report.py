"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#ExecuteScheduledReport``."""
...
def handle_response(
    ...
    out: capo_bcm_dashboards.types.execute_scheduled_report_response.ExecuteScheduledReportResponse = capo_bcm_dashboards.types.execute_scheduled_report_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_dashboards.types.execute_scheduled_report_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_execute_scheduled_report(
