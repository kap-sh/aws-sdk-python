...
import capo_bcm_dashboards.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_bcm_dashboards.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_bcm_dashboards.types.update_scheduled_report_response.UpdateScheduledReportResponse = capo_bcm_dashboards.types.update_scheduled_report_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_dashboards.types.update_scheduled_report_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
