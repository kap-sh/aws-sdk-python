"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#ListScheduledReports``."""
...
def handle_response(
    ...
    out: capo_bcm_dashboards.types.list_scheduled_reports_response.ListScheduledReportsResponse = capo_bcm_dashboards.types.list_scheduled_reports_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_dashboards.types.list_scheduled_reports_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_scheduled_reports(
