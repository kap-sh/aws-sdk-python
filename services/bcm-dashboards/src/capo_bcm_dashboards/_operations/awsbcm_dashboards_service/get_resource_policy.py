"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_bcm_dashboards.types.get_resource_policy_response.GetResourcePolicyResponse = capo_bcm_dashboards.types.get_resource_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBCMDashboardsService.GetResourcePolicy"
    body: bytes | None = json.dumps(
        capo_bcm_dashboards.types.get_resource_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
