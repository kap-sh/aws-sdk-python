...
class InvokeBlueprintOptimizationAsyncRequest(TypedDict):
...
def serialize_json(value: InvokeBlueprintOptimizationAsyncRequest) -> dict:
    ...
    out["blueprint"] = (
        aws_sdk_bedrock_data_automation.types.blueprint_optimization_object.serialize_json(
            value["blueprint"]
        )
    )
    import aws_sdk_bedrock_data_automation.types.blueprint_optimization_samples
...
def deserialize_json(data: dict) -> InvokeBlueprintOptimizationAsyncRequest:
    ...
    if "blueprint" in data:
        ...
        out["blueprint"] = (
            aws_sdk_bedrock_data_automation.types.blueprint_optimization_object.deserialize_json(
                data["blueprint"]
            )
        )
    else:
