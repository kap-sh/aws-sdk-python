"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#ValidationExceptionField``."""
...
class ValidationExceptionField(TypedDict, closed=True):
    name: "aws_sdk_bedrock_data_automation.types.non_blank_string.NonBlankString"
    message: "aws_sdk_bedrock_data_automation.types.non_blank_string.NonBlankString"
