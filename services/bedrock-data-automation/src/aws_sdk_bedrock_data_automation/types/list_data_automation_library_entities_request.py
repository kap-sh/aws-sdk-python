"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#ListDataAutomationLibraryEntitiesRequest``."""
...
class ListDataAutomationLibraryEntitiesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListDataAutomationLibraryEntitiesRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListDataAutomationLibraryEntitiesRequest:
    out: ListDataAutomationLibraryEntitiesRequest = {}  # type: ignore[typeddict-item]
