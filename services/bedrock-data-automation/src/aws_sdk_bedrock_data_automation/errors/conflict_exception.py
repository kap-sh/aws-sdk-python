"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockdataautomation#ConflictException``."""
