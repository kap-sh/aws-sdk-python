...
if TYPE_CHECKING:
    import capo_bedrock_data_automation.types.event_bridge_configuration


class NotificationConfiguration(TypedDict, closed=True):
    event_bridge_configuration: "capo_bedrock_data_automation.types.event_bridge_configuration.EventBridgeConfiguration"
...
def serialize_json(value: NotificationConfiguration) -> dict:
    ...
    out["eventBridgeConfiguration"] = (
        capo_bedrock_data_automation.types.event_bridge_configuration.serialize_json(
...
def deserialize_json(data: dict) -> NotificationConfiguration:
    ...
    if data.get("eventBridgeConfiguration") is not None:
        ...
        out["event_bridge_configuration"] = (
            capo_bedrock_data_automation.types.event_bridge_configuration.deserialize_json(
