...
class GetDataAutomationLibraryIngestionJobResponse(TypedDict, closed=True):
    job: NotRequired[
        "capo_bedrock_data_automation.types.data_automation_library_ingestion_job.DataAutomationLibraryIngestionJob"
    ]
...
def serialize_json(value: GetDataAutomationLibraryIngestionJobResponse) -> dict:
    ...
    if "job" in value:
        ...
        out["job"] = (
            capo_bedrock_data_automation.types.data_automation_library_ingestion_job.serialize_json(
                value["job"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> GetDataAutomationLibraryIngestionJobResponse:
    ...
    if "job" in data:
        ...
        out["job"] = (
            capo_bedrock_data_automation.types.data_automation_library_ingestion_job.deserialize_json(
                data["job"]
            )
        )
    return out
