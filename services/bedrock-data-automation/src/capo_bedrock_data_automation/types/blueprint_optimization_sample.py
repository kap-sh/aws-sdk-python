...
class BlueprintOptimizationSample(TypedDict, closed=True):
    asset_s3_object: "capo_bedrock_data_automation.types.s3_object.S3Object"
    """S3 Object of the asset"""
    ground_truth_s3_object: "capo_bedrock_data_automation.types.s3_object.S3Object"
...
def serialize_json(value: BlueprintOptimizationSample) -> dict:
    ...
    out["assetS3Object"] = capo_bedrock_data_automation.types.s3_object.serialize_json(
        value["asset_s3_object"]
    )
    import capo_bedrock_data_automation.types.s3_object

    out["groundTruthS3Object"] = (
        capo_bedrock_data_automation.types.s3_object.serialize_json(
