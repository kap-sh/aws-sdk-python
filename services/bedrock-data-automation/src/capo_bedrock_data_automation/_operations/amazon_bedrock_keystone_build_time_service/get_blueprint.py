...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.get_blueprint_response.GetBlueprintResponse = capo_bedrock_data_automation.types.get_blueprint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.get_blueprint_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
