"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#TagResource``."""
...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.tag_resource_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
