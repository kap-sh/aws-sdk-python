"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#CreateDataAutomationProject``."""
...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.create_data_automation_project_response.CreateDataAutomationProjectResponse = capo_bedrock_data_automation.types.create_data_automation_project_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.create_data_automation_project_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_data_automation_project(
