...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.get_data_automation_library_entity_response.GetDataAutomationLibraryEntityResponse = capo_bedrock_data_automation.types.get_data_automation_library_entity_response.deserialize_json(
