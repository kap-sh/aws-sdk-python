...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.list_blueprints_response.ListBlueprintsResponse = capo_bedrock_data_automation.types.list_blueprints_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.list_blueprints_request.serialize_json(
            input_
        )
    ).encode()
