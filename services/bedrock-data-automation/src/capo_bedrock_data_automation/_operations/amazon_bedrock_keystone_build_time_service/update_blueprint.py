...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.update_blueprint_response.UpdateBlueprintResponse = capo_bedrock_data_automation.types.update_blueprint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.update_blueprint_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
