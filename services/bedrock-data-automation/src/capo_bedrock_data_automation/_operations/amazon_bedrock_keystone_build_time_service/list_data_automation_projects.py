"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#ListDataAutomationProjects``."""
...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.list_data_automation_projects_response.ListDataAutomationProjectsResponse = capo_bedrock_data_automation.types.list_data_automation_projects_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.list_data_automation_projects_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_data_automation_projects(
