...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.copy_blueprint_stage_response.CopyBlueprintStageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.copy_blueprint_stage_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
