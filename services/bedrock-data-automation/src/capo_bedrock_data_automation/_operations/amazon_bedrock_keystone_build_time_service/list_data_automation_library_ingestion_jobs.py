...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.list_data_automation_library_ingestion_jobs_response.ListDataAutomationLibraryIngestionJobsResponse = capo_bedrock_data_automation.types.list_data_automation_library_ingestion_jobs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.list_data_automation_library_ingestion_jobs_request.serialize_json(
            input_
        )
    ).encode()
