...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.get_data_automation_project_response.GetDataAutomationProjectResponse = capo_bedrock_data_automation.types.get_data_automation_project_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.get_data_automation_project_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
