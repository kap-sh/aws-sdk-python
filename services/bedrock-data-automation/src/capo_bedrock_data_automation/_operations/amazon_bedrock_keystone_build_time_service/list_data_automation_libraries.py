...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.list_data_automation_libraries_response.ListDataAutomationLibrariesResponse = capo_bedrock_data_automation.types.list_data_automation_libraries_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.list_data_automation_libraries_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
