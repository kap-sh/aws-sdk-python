...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.delete_data_automation_library_response.DeleteDataAutomationLibraryResponse = capo_bedrock_data_automation.types.delete_data_automation_library_response.deserialize_json(
