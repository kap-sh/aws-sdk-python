"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#CreateBlueprintVersion``."""
...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.create_blueprint_version_response.CreateBlueprintVersionResponse = capo_bedrock_data_automation.types.create_blueprint_version_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/blueprints/{blueprintArn}/versions/"
    url = url.replace("{blueprintArn}", quote(input_["blueprint_arn"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.create_blueprint_version_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_blueprint_version(
