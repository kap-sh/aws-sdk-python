...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.update_data_automation_library_response.UpdateDataAutomationLibraryResponse = capo_bedrock_data_automation.types.update_data_automation_library_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.update_data_automation_library_request.serialize_json(
            input_
        )
    ).encode()
