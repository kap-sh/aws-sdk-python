"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#GetDataAutomationLibraryIngestionJob``."""
...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.get_data_automation_library_ingestion_job_response.GetDataAutomationLibraryIngestionJobResponse = capo_bedrock_data_automation.types.get_data_automation_library_ingestion_job_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{jobArn}", quote(str(input_["job_arn"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_data_automation_library_ingestion_job(
