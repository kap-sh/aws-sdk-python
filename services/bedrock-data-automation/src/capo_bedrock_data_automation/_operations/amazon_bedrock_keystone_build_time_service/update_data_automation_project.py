...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.update_data_automation_project_response.UpdateDataAutomationProjectResponse = capo_bedrock_data_automation.types.update_data_automation_project_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.update_data_automation_project_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
