...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.delete_blueprint_response.DeleteBlueprintResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    if "blueprint_version" in input_:
        params.append(("blueprintVersion", input_["blueprint_version"]))
