...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.get_data_automation_library_response.GetDataAutomationLibraryResponse = capo_bedrock_data_automation.types.get_data_automation_library_response.deserialize_json(
