...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.list_data_automation_library_entities_response.ListDataAutomationLibraryEntitiesResponse = capo_bedrock_data_automation.types.list_data_automation_library_entities_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{entityType}",
        quote(
            capo_bedrock_data_automation.types.entity_type.serialize_json(
                input_["entity_type"]
            ),
            safe="",
        ),
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.list_data_automation_library_entities_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
