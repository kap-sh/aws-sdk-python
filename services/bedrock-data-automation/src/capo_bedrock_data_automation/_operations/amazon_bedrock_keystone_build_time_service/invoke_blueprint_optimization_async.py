...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.invoke_blueprint_optimization_async_response.InvokeBlueprintOptimizationAsyncResponse = capo_bedrock_data_automation.types.invoke_blueprint_optimization_async_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation.types.invoke_blueprint_optimization_async_request.serialize_json(
            input_
        )
    ).encode()
