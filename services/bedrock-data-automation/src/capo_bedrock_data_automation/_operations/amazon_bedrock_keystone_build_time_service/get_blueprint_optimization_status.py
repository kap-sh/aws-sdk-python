"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#GetBlueprintOptimizationStatus``."""
...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.get_blueprint_optimization_status_response.GetBlueprintOptimizationStatusResponse = capo_bedrock_data_automation.types.get_blueprint_optimization_status_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/getBlueprintOptimizationStatus/{invocationArn}"
    url = url.replace("{invocationArn}", quote(input_["invocation_arn"], safe=""))
...
async def async_get_blueprint_optimization_status(
