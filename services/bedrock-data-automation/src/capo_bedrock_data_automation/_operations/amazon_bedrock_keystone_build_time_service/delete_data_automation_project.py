"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#DeleteDataAutomationProject``."""
...
def handle_response(
    ...
    out: capo_bedrock_data_automation.types.delete_data_automation_project_response.DeleteDataAutomationProjectResponse = capo_bedrock_data_automation.types.delete_data_automation_project_response.deserialize_json(
...
async def async_delete_data_automation_project(
