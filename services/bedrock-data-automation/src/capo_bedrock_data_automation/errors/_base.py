...
class BedrockDataAutomationError(Exception):
    """Base class for all BedrockDataAutomation service errors."""


class ServiceError(BedrockDataAutomationError):
...
class SerializationError(BedrockDataAutomationError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BedrockDataAutomationError):
...
class WaiterFailedError(BedrockDataAutomationError):
...
class WaiterTimeoutError(BedrockDataAutomationError):
