...
class NetworkManagerError(Exception):
    """Base class for all NetworkManager service errors."""


class ServiceError(NetworkManagerError):
...
class SerializationError(NetworkManagerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(NetworkManagerError):
...
class WaiterFailedError(NetworkManagerError):
...
class WaiterTimeoutError(NetworkManagerError):
