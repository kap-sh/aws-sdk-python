...
class TransitGatewayConnectPeerAssociation(TypedDict, closed=True):
    transit_gateway_connect_peer_arn: NotRequired[
        "capo_networkmanager.types.transit_gateway_connect_peer_arn.TransitGatewayConnectPeerArn"
    ]
    ...
    state: NotRequired[
        "capo_networkmanager.types.transit_gateway_connect_peer_association_state.TransitGatewayConnectPeerAssociationState"
    ]
...
def serialize_json(value: TransitGatewayConnectPeerAssociation) -> dict:
    ...
    if "state" in value:
        ...
        out["State"] = (
            capo_networkmanager.types.transit_gateway_connect_peer_association_state.serialize_json(
                value["state"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> TransitGatewayConnectPeerAssociation:
    ...
    if "State" in data:
        ...
        out["state"] = (
            capo_networkmanager.types.transit_gateway_connect_peer_association_state.deserialize_json(
                data["State"]
            )
        )
    return out
