"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetNetworkResourceRelationshipsRequest``."""
...
class GetNetworkResourceRelationshipsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetNetworkResourceRelationshipsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetNetworkResourceRelationshipsRequest:
    out: GetNetworkResourceRelationshipsRequest = {}  # type: ignore[typeddict-item]
    return out
