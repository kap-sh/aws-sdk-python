"""Generated from Smithy shape ``com.amazonaws.networkmanager#PutAttachmentRoutingPolicyLabelResponse``."""
...
class PutAttachmentRoutingPolicyLabelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: PutAttachmentRoutingPolicyLabelResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> PutAttachmentRoutingPolicyLabelResponse:
    out: PutAttachmentRoutingPolicyLabelResponse = {}  # type: ignore[typeddict-item]
