...
if TYPE_CHECKING:
    ...
    import capo_networkmanager.types.organization_aws_service_access_status
    import capo_networkmanager.types.organization_id
    import capo_networkmanager.types.slr_deployment_status


class OrganizationStatus(TypedDict, closed=True):
    organization_id: NotRequired[
        "capo_networkmanager.types.organization_id.OrganizationId"
    ]
    """<p>The ID of an Amazon Web Services Organization.</p>"""
    organization_aws_service_access_status: NotRequired[
        "capo_networkmanager.types.organization_aws_service_access_status.OrganizationAwsServiceAccessStatus"
    ]
    ...
    account_status_list: NotRequired[
        "capo_networkmanager.types.account_status_list.AccountStatusList"
    ]
...
def serialize_json(value: OrganizationStatus) -> dict:
    ...
    if "account_status_list" in value:
        ...
        out["AccountStatusList"] = (
            capo_networkmanager.types.account_status_list.serialize_json(
...
def deserialize_json(data: dict) -> OrganizationStatus:
    ...
    if "AccountStatusList" in data:
        ...
        out["account_status_list"] = (
            capo_networkmanager.types.account_status_list.deserialize_json(
