"""Generated from Smithy shape ``com.amazonaws.networkmanager#ListCoreNetworkRoutingInformation``."""
...
import capo_networkmanager.types.list_core_network_routing_information_request
import capo_networkmanager.types.list_core_network_routing_information_response
...
) -> capo_networkmanager.types.list_core_network_routing_information_response.ListCoreNetworkRoutingInformationResponse:
    out: capo_networkmanager.types.list_core_network_routing_information_response.ListCoreNetworkRoutingInformationResponse = capo_networkmanager.types.list_core_network_routing_information_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.list_core_network_routing_information_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_core_network_routing_information(
