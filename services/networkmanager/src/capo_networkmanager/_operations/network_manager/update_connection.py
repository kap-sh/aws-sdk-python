"""Generated from Smithy shape ``com.amazonaws.networkmanager#UpdateConnection``."""
...
import capo_networkmanager.types.update_connection_request
import capo_networkmanager.types.update_connection_response
...
) -> capo_networkmanager.types.update_connection_response.UpdateConnectionResponse:
    out: capo_networkmanager.types.update_connection_response.UpdateConnectionResponse = capo_networkmanager.types.update_connection_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.update_connection_request.serialize_json(input_)
    ).encode()
