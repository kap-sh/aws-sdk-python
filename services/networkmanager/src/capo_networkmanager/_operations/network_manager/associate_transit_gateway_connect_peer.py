"""Generated from Smithy shape ``com.amazonaws.networkmanager#AssociateTransitGatewayConnectPeer``."""
...
import capo_networkmanager.errors.service_quota_exceeded_exception
import capo_networkmanager.errors.throttling_exception
import capo_networkmanager.errors.validation_exception
import capo_networkmanager.types.associate_transit_gateway_connect_peer_request
import capo_networkmanager.types.associate_transit_gateway_connect_peer_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_networkmanager.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
) -> capo_networkmanager.types.associate_transit_gateway_connect_peer_response.AssociateTransitGatewayConnectPeerResponse:
    out: capo_networkmanager.types.associate_transit_gateway_connect_peer_response.AssociateTransitGatewayConnectPeerResponse = capo_networkmanager.types.associate_transit_gateway_connect_peer_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_networkmanager._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.associate_transit_gateway_connect_peer_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_transit_gateway_connect_peer(
