"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeleteSite``."""
...
import capo_networkmanager.types.delete_site_request
import capo_networkmanager.types.delete_site_response
...
) -> capo_networkmanager.types.delete_site_response.DeleteSiteResponse:
    out: capo_networkmanager.types.delete_site_response.DeleteSiteResponse = (
        capo_networkmanager.types.delete_site_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/global-networks/{GlobalNetworkId}/sites/{SiteId}"
    url = url.replace(
...
def delete_site(
    ...
    capo_networkmanager.types.delete_site_response.DeleteSiteResponse, zapros.Response
]:
