"""Generated from Smithy shape ``com.amazonaws.networkmanager#ListPeerings``."""
...
import capo_networkmanager.types.list_peerings_request
import capo_networkmanager.types.list_peerings_response
import capo_networkmanager.types.peering_list
...
) -> capo_networkmanager.types.list_peerings_response.ListPeeringsResponse:
    out: capo_networkmanager.types.list_peerings_response.ListPeeringsResponse = (
        capo_networkmanager.types.list_peerings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/peerings"
    params: dict[str, str] = {}
    if "core_network_id" in input_:
        params["coreNetworkId"] = str(input_["core_network_id"])
    if "peering_type" in input_:
        params["peeringType"] = str(input_["peering_type"])
    if "edge_location" in input_:
        params["edgeLocation"] = str(input_["edge_location"])
    if "state" in input_:
