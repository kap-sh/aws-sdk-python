"""Generated from Smithy shape ``com.amazonaws.networkmanager#UpdateDevice``."""
...
import capo_networkmanager.types.update_device_request
import capo_networkmanager.types.update_device_response
...
) -> capo_networkmanager.types.update_device_response.UpdateDeviceResponse:
    out: capo_networkmanager.types.update_device_response.UpdateDeviceResponse = (
        capo_networkmanager.types.update_device_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.update_device_request.serialize_json(input_)
    ).encode()
