"""Generated from Smithy shape ``com.amazonaws.networkmanager#RegisterTransitGateway``."""
...
import capo_networkmanager.types.register_transit_gateway_request
import capo_networkmanager.types.register_transit_gateway_response
...
) -> capo_networkmanager.types.register_transit_gateway_response.RegisterTransitGatewayResponse:
    out: capo_networkmanager.types.register_transit_gateway_response.RegisterTransitGatewayResponse = capo_networkmanager.types.register_transit_gateway_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.register_transit_gateway_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_register_transit_gateway(
