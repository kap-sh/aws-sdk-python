"""Generated from Smithy shape ``com.amazonaws.networkmanager#RestoreCoreNetworkPolicyVersion``."""
...
import capo_networkmanager.types.restore_core_network_policy_version_request
import capo_networkmanager.types.restore_core_network_policy_version_response
...
) -> capo_networkmanager.types.restore_core_network_policy_version_response.RestoreCoreNetworkPolicyVersionResponse:
    out: capo_networkmanager.types.restore_core_network_policy_version_response.RestoreCoreNetworkPolicyVersionResponse = capo_networkmanager.types.restore_core_network_policy_version_response.deserialize_json(
...
async def async_restore_core_network_policy_version(
