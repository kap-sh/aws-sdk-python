"""Generated from Smithy shape ``com.amazonaws.networkmanager#StartRouteAnalysis``."""
...
import capo_networkmanager.types.start_route_analysis_request
import capo_networkmanager.types.start_route_analysis_response
...
) -> capo_networkmanager.types.start_route_analysis_response.StartRouteAnalysisResponse:
    out: capo_networkmanager.types.start_route_analysis_response.StartRouteAnalysisResponse = capo_networkmanager.types.start_route_analysis_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/global-networks/{GlobalNetworkId}/route-analyses"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.start_route_analysis_request.serialize_json(input_)
    ).encode()
...
async def async_start_route_analysis(
