"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetDevices``."""
...
import capo_networkmanager.types.device_list
import capo_networkmanager.types.get_devices_request
import capo_networkmanager.types.get_devices_response
...
) -> capo_networkmanager.types.get_devices_response.GetDevicesResponse:
    out: capo_networkmanager.types.get_devices_response.GetDevicesResponse = (
        capo_networkmanager.types.get_devices_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/global-networks/{GlobalNetworkId}/devices"
    url = url.replace(
        "{GlobalNetworkId}", quote(str(input_["global_network_id"]), safe="")
    )
    params: dict[str, str] = {}
    if "device_ids" in input_:
        params["deviceIds"] = str(input_["device_ids"])
    if "site_id" in input_:
        params["siteId"] = str(input_["site_id"])
...
def get_devices(
    ...
    capo_networkmanager.types.get_devices_response.GetDevicesResponse, zapros.Response
]:
