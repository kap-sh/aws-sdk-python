"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetNetworkResourceCounts``."""
...
import capo_networkmanager.types.get_network_resource_counts_request
import capo_networkmanager.types.get_network_resource_counts_response
...
) -> capo_networkmanager.types.get_network_resource_counts_response.GetNetworkResourceCountsResponse:
    out: capo_networkmanager.types.get_network_resource_counts_response.GetNetworkResourceCountsResponse = capo_networkmanager.types.get_network_resource_counts_response.deserialize_json(
