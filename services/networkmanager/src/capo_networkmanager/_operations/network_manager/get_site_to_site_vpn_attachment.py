"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetSiteToSiteVpnAttachment``."""
...
import capo_networkmanager.types.get_site_to_site_vpn_attachment_request
import capo_networkmanager.types.get_site_to_site_vpn_attachment_response
...
) -> capo_networkmanager.types.get_site_to_site_vpn_attachment_response.GetSiteToSiteVpnAttachmentResponse:
    out: capo_networkmanager.types.get_site_to_site_vpn_attachment_response.GetSiteToSiteVpnAttachmentResponse = capo_networkmanager.types.get_site_to_site_vpn_attachment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/site-to-site-vpn-attachments/{AttachmentId}"
...
async def async_get_site_to_site_vpn_attachment(
