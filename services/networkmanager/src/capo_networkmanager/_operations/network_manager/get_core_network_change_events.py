"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetCoreNetworkChangeEvents``."""
...
import capo_networkmanager.types.core_network_change_event_list
import capo_networkmanager.types.get_core_network_change_events_request
import capo_networkmanager.types.get_core_network_change_events_response
...
) -> capo_networkmanager.types.get_core_network_change_events_response.GetCoreNetworkChangeEventsResponse:
    out: capo_networkmanager.types.get_core_network_change_events_response.GetCoreNetworkChangeEventsResponse = capo_networkmanager.types.get_core_network_change_events_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{PolicyVersionId}", quote(str(input_["policy_version_id"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_get_core_network_change_events(
