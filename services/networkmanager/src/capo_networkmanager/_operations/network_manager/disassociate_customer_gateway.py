"""Generated from Smithy shape ``com.amazonaws.networkmanager#DisassociateCustomerGateway``."""
...
import capo_networkmanager.types.disassociate_customer_gateway_request
import capo_networkmanager.types.disassociate_customer_gateway_response
...
) -> capo_networkmanager.types.disassociate_customer_gateway_response.DisassociateCustomerGatewayResponse:
    out: capo_networkmanager.types.disassociate_customer_gateway_response.DisassociateCustomerGatewayResponse = capo_networkmanager.types.disassociate_customer_gateway_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{CustomerGatewayArn}", quote(str(input_["customer_gateway_arn"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_disassociate_customer_gateway(
