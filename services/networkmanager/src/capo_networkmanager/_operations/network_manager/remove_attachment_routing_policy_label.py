"""Generated from Smithy shape ``com.amazonaws.networkmanager#RemoveAttachmentRoutingPolicyLabel``."""
...
import capo_networkmanager.types.remove_attachment_routing_policy_label_request
import capo_networkmanager.types.remove_attachment_routing_policy_label_response
...
) -> capo_networkmanager.types.remove_attachment_routing_policy_label_response.RemoveAttachmentRoutingPolicyLabelResponse:
    out: capo_networkmanager.types.remove_attachment_routing_policy_label_response.RemoveAttachmentRoutingPolicyLabelResponse = capo_networkmanager.types.remove_attachment_routing_policy_label_response.deserialize_json(
