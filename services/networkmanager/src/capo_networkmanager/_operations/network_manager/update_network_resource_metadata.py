"""Generated from Smithy shape ``com.amazonaws.networkmanager#UpdateNetworkResourceMetadata``."""
...
import capo_networkmanager.types.update_network_resource_metadata_request
import capo_networkmanager.types.update_network_resource_metadata_response
...
) -> capo_networkmanager.types.update_network_resource_metadata_response.UpdateNetworkResourceMetadataResponse:
    out: capo_networkmanager.types.update_network_resource_metadata_response.UpdateNetworkResourceMetadataResponse = capo_networkmanager.types.update_network_resource_metadata_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.update_network_resource_metadata_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_network_resource_metadata(
