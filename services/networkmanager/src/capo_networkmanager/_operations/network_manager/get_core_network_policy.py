"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetCoreNetworkPolicy``."""
...
import capo_networkmanager.types.get_core_network_policy_request
import capo_networkmanager.types.get_core_network_policy_response
...
) -> capo_networkmanager.types.get_core_network_policy_response.GetCoreNetworkPolicyResponse:
    out: capo_networkmanager.types.get_core_network_policy_response.GetCoreNetworkPolicyResponse = capo_networkmanager.types.get_core_network_policy_response.deserialize_json(
