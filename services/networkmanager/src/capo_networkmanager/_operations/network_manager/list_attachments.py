"""Generated from Smithy shape ``com.amazonaws.networkmanager#ListAttachments``."""
...
import capo_networkmanager.types.list_attachments_request
import capo_networkmanager.types.list_attachments_response
...
) -> capo_networkmanager.types.list_attachments_response.ListAttachmentsResponse:
    out: capo_networkmanager.types.list_attachments_response.ListAttachmentsResponse = (
        capo_networkmanager.types.list_attachments_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/attachments"
    params: dict[str, str] = {}
    if "core_network_id" in input_:
        params["coreNetworkId"] = str(input_["core_network_id"])
    if "attachment_type" in input_:
        params["attachmentType"] = str(input_["attachment_type"])
...
async def async_list_attachments(
