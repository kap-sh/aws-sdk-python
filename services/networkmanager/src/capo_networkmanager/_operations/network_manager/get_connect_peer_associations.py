"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetConnectPeerAssociations``."""
...
import capo_networkmanager.types.get_connect_peer_associations_request
import capo_networkmanager.types.get_connect_peer_associations_response
...
) -> capo_networkmanager.types.get_connect_peer_associations_response.GetConnectPeerAssociationsResponse:
    out: capo_networkmanager.types.get_connect_peer_associations_response.GetConnectPeerAssociationsResponse = capo_networkmanager.types.get_connect_peer_associations_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "connect_peer_ids" in input_:
        params["connectPeerIds"] = str(input_["connect_peer_ids"])
...
async def async_get_connect_peer_associations(
