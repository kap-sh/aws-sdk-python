"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetResourcePolicy``."""
...
import capo_networkmanager.types.get_resource_policy_request
import capo_networkmanager.types.get_resource_policy_response
...
) -> capo_networkmanager.types.get_resource_policy_response.GetResourcePolicyResponse:
    out: capo_networkmanager.types.get_resource_policy_response.GetResourcePolicyResponse = capo_networkmanager.types.get_resource_policy_response.deserialize_json(
