"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetDirectConnectGatewayAttachment``."""
...
import capo_networkmanager.types.get_direct_connect_gateway_attachment_request
import capo_networkmanager.types.get_direct_connect_gateway_attachment_response
...
) -> capo_networkmanager.types.get_direct_connect_gateway_attachment_response.GetDirectConnectGatewayAttachmentResponse:
    out: capo_networkmanager.types.get_direct_connect_gateway_attachment_response.GetDirectConnectGatewayAttachmentResponse = capo_networkmanager.types.get_direct_connect_gateway_attachment_response.deserialize_json(
...
async def async_get_direct_connect_gateway_attachment(
