"""Generated from Smithy shape ``com.amazonaws.networkmanager#DescribeGlobalNetworks``."""
...
import capo_networkmanager.types.describe_global_networks_request
import capo_networkmanager.types.describe_global_networks_response
...
) -> capo_networkmanager.types.describe_global_networks_response.DescribeGlobalNetworksResponse:
    out: capo_networkmanager.types.describe_global_networks_response.DescribeGlobalNetworksResponse = capo_networkmanager.types.describe_global_networks_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/global-networks"
    params: dict[str, str] = {}
    if "global_network_ids" in input_:
        params["globalNetworkIds"] = str(input_["global_network_ids"])
...
async def async_describe_global_networks(
