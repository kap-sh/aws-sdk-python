"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateConnectPeer``."""
...
import capo_networkmanager.types.create_connect_peer_request
import capo_networkmanager.types.create_connect_peer_response
...
) -> capo_networkmanager.types.create_connect_peer_response.CreateConnectPeerResponse:
    out: capo_networkmanager.types.create_connect_peer_response.CreateConnectPeerResponse = capo_networkmanager.types.create_connect_peer_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_connect_peer_request.serialize_json(input_)
    ).encode()
...
async def async_create_connect_peer(
