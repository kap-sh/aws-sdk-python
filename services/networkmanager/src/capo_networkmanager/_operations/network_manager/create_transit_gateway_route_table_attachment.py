"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateTransitGatewayRouteTableAttachment``."""
...
import capo_networkmanager.types.create_transit_gateway_route_table_attachment_request
import capo_networkmanager.types.create_transit_gateway_route_table_attachment_response
...
) -> capo_networkmanager.types.create_transit_gateway_route_table_attachment_response.CreateTransitGatewayRouteTableAttachmentResponse:
    out: capo_networkmanager.types.create_transit_gateway_route_table_attachment_response.CreateTransitGatewayRouteTableAttachmentResponse = capo_networkmanager.types.create_transit_gateway_route_table_attachment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/transit-gateway-route-table-attachments"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_transit_gateway_route_table_attachment_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_transit_gateway_route_table_attachment(
