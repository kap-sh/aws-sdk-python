"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeleteAttachment``."""
...
import capo_networkmanager.types.delete_attachment_request
import capo_networkmanager.types.delete_attachment_response
...
) -> capo_networkmanager.types.delete_attachment_response.DeleteAttachmentResponse:
    out: capo_networkmanager.types.delete_attachment_response.DeleteAttachmentResponse = capo_networkmanager.types.delete_attachment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/attachments/{AttachmentId}"
