"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetNetworkRoutes``."""
...
import capo_networkmanager.types.get_network_routes_request
import capo_networkmanager.types.get_network_routes_response
...
) -> capo_networkmanager.types.get_network_routes_response.GetNetworkRoutesResponse:
    out: capo_networkmanager.types.get_network_routes_response.GetNetworkRoutesResponse = capo_networkmanager.types.get_network_routes_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/global-networks/{GlobalNetworkId}/network-routes"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.get_network_routes_request.serialize_json(input_)
    ).encode()
...
async def async_get_network_routes(
