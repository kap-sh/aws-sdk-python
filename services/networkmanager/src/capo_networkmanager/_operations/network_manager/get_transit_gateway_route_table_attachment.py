"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetTransitGatewayRouteTableAttachment``."""
...
import capo_networkmanager.types.get_transit_gateway_route_table_attachment_request
import capo_networkmanager.types.get_transit_gateway_route_table_attachment_response
...
) -> capo_networkmanager.types.get_transit_gateway_route_table_attachment_response.GetTransitGatewayRouteTableAttachmentResponse:
    out: capo_networkmanager.types.get_transit_gateway_route_table_attachment_response.GetTransitGatewayRouteTableAttachmentResponse = capo_networkmanager.types.get_transit_gateway_route_table_attachment_response.deserialize_json(
...
async def async_get_transit_gateway_route_table_attachment(
