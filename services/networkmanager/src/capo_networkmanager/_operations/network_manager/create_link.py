"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateLink``."""
...
import capo_networkmanager.types.create_link_request
import capo_networkmanager.types.create_link_response
...
) -> capo_networkmanager.types.create_link_response.CreateLinkResponse:
    out: capo_networkmanager.types.create_link_response.CreateLinkResponse = (
        capo_networkmanager.types.create_link_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/global-networks/{GlobalNetworkId}/links"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_link_request.serialize_json(input_)
    ).encode()
...
def create_link(
    ...
    capo_networkmanager.types.create_link_response.CreateLinkResponse, zapros.Response
]:
