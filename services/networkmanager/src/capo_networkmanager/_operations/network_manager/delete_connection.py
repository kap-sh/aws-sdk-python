"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeleteConnection``."""
...
import capo_networkmanager.types.delete_connection_request
import capo_networkmanager.types.delete_connection_response
...
) -> capo_networkmanager.types.delete_connection_response.DeleteConnectionResponse:
    out: capo_networkmanager.types.delete_connection_response.DeleteConnectionResponse = capo_networkmanager.types.delete_connection_response.deserialize_json(
