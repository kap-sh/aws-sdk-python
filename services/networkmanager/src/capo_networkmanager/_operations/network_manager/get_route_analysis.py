"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetRouteAnalysis``."""
...
import capo_networkmanager.types.get_route_analysis_request
import capo_networkmanager.types.get_route_analysis_response
...
) -> capo_networkmanager.types.get_route_analysis_response.GetRouteAnalysisResponse:
    out: capo_networkmanager.types.get_route_analysis_response.GetRouteAnalysisResponse = capo_networkmanager.types.get_route_analysis_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{RouteAnalysisId}", quote(str(input_["route_analysis_id"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_get_route_analysis(
