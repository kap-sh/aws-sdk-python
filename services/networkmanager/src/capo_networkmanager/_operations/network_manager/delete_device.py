"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeleteDevice``."""
...
import capo_networkmanager.types.delete_device_request
import capo_networkmanager.types.delete_device_response
...
) -> capo_networkmanager.types.delete_device_response.DeleteDeviceResponse:
    out: capo_networkmanager.types.delete_device_response.DeleteDeviceResponse = (
        capo_networkmanager.types.delete_device_response.deserialize_json(
