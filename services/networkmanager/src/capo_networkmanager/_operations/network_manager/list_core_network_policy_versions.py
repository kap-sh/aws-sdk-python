"""Generated from Smithy shape ``com.amazonaws.networkmanager#ListCoreNetworkPolicyVersions``."""
...
import capo_networkmanager.types.list_core_network_policy_versions_request
import capo_networkmanager.types.list_core_network_policy_versions_response
...
) -> capo_networkmanager.types.list_core_network_policy_versions_response.ListCoreNetworkPolicyVersionsResponse:
    out: capo_networkmanager.types.list_core_network_policy_versions_response.ListCoreNetworkPolicyVersionsResponse = capo_networkmanager.types.list_core_network_policy_versions_response.deserialize_json(
...
async def async_list_core_network_policy_versions(
