"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetTransitGatewayPeering``."""
...
import capo_networkmanager.types.get_transit_gateway_peering_request
import capo_networkmanager.types.get_transit_gateway_peering_response
...
) -> capo_networkmanager.types.get_transit_gateway_peering_response.GetTransitGatewayPeeringResponse:
    out: capo_networkmanager.types.get_transit_gateway_peering_response.GetTransitGatewayPeeringResponse = capo_networkmanager.types.get_transit_gateway_peering_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/transit-gateway-peerings/{PeeringId}"
    url = url.replace("{PeeringId}", quote(str(input_["peering_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_transit_gateway_peering(
