"""Generated from Smithy shape ``com.amazonaws.networkmanager#UpdateLink``."""
...
import capo_networkmanager.types.update_link_request
import capo_networkmanager.types.update_link_response
...
) -> capo_networkmanager.types.update_link_response.UpdateLinkResponse:
    out: capo_networkmanager.types.update_link_response.UpdateLinkResponse = (
        capo_networkmanager.types.update_link_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/global-networks/{GlobalNetworkId}/links/{LinkId}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.update_link_request.serialize_json(input_)
    ).encode()
...
def update_link(
    ...
    capo_networkmanager.types.update_link_response.UpdateLinkResponse, zapros.Response
]:
