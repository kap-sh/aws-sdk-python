"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateDirectConnectGatewayAttachment``."""
...
import capo_networkmanager.types.create_direct_connect_gateway_attachment_request
import capo_networkmanager.types.create_direct_connect_gateway_attachment_response
...
) -> capo_networkmanager.types.create_direct_connect_gateway_attachment_response.CreateDirectConnectGatewayAttachmentResponse:
    out: capo_networkmanager.types.create_direct_connect_gateway_attachment_response.CreateDirectConnectGatewayAttachmentResponse = capo_networkmanager.types.create_direct_connect_gateway_attachment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/direct-connect-gateway-attachments"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_direct_connect_gateway_attachment_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_direct_connect_gateway_attachment(
