"""Generated from Smithy shape ``com.amazonaws.networkmanager#DisassociateTransitGatewayConnectPeer``."""
...
import capo_networkmanager.types.disassociate_transit_gateway_connect_peer_request
import capo_networkmanager.types.disassociate_transit_gateway_connect_peer_response
...
) -> capo_networkmanager.types.disassociate_transit_gateway_connect_peer_response.DisassociateTransitGatewayConnectPeerResponse:
    out: capo_networkmanager.types.disassociate_transit_gateway_connect_peer_response.DisassociateTransitGatewayConnectPeerResponse = capo_networkmanager.types.disassociate_transit_gateway_connect_peer_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["transit_gateway_connect_peer_arn"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_disassociate_transit_gateway_connect_peer(
