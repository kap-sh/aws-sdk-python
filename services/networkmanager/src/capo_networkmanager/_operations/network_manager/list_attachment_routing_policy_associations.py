"""Generated from Smithy shape ``com.amazonaws.networkmanager#ListAttachmentRoutingPolicyAssociations``."""
...
import capo_networkmanager.types.list_attachment_routing_policy_associations_request
import capo_networkmanager.types.list_attachment_routing_policy_associations_response
...
) -> capo_networkmanager.types.list_attachment_routing_policy_associations_response.ListAttachmentRoutingPolicyAssociationsResponse:
    out: capo_networkmanager.types.list_attachment_routing_policy_associations_response.ListAttachmentRoutingPolicyAssociationsResponse = capo_networkmanager.types.list_attachment_routing_policy_associations_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/routing-policy-label/core-network/{CoreNetworkId}"
    )
    url = url.replace("{CoreNetworkId}", quote(str(input_["core_network_id"]), safe=""))
    params: dict[str, str] = {}
    if "attachment_id" in input_:
        params["attachmentId"] = str(input_["attachment_id"])
...
async def async_list_attachment_routing_policy_associations(
