"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetTransitGatewayRegistrations``."""
...
import capo_networkmanager.types.get_transit_gateway_registrations_request
import capo_networkmanager.types.get_transit_gateway_registrations_response
import capo_networkmanager.types.transit_gateway_arn_list
import capo_networkmanager.types.transit_gateway_registration_list
...
) -> capo_networkmanager.types.get_transit_gateway_registrations_response.GetTransitGatewayRegistrationsResponse:
    out: capo_networkmanager.types.get_transit_gateway_registrations_response.GetTransitGatewayRegistrationsResponse = capo_networkmanager.types.get_transit_gateway_registrations_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "transit_gateway_arns" in input_:
        params["transitGatewayArns"] = str(input_["transit_gateway_arns"])
...
async def async_get_transit_gateway_registrations(
