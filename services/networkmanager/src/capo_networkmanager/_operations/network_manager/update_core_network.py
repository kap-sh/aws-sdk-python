"""Generated from Smithy shape ``com.amazonaws.networkmanager#UpdateCoreNetwork``."""
...
import capo_networkmanager.types.update_core_network_request
import capo_networkmanager.types.update_core_network_response
...
) -> capo_networkmanager.types.update_core_network_response.UpdateCoreNetworkResponse:
    out: capo_networkmanager.types.update_core_network_response.UpdateCoreNetworkResponse = capo_networkmanager.types.update_core_network_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/core-networks/{CoreNetworkId}"
    url = url.replace("{CoreNetworkId}", quote(str(input_["core_network_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_networkmanager.types.update_core_network_request.serialize_json(input_)
    ).encode()
...
async def async_update_core_network(
