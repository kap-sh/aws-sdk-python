"""Generated from Smithy shape ``com.amazonaws.networkmanager#AssociateLink``."""
...
import capo_networkmanager.types.associate_link_request
import capo_networkmanager.types.associate_link_response
...
) -> capo_networkmanager.types.associate_link_response.AssociateLinkResponse:
    out: capo_networkmanager.types.associate_link_response.AssociateLinkResponse = (
        capo_networkmanager.types.associate_link_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.associate_link_request.serialize_json(input_)
    ).encode()
...
async def async_associate_link(
