"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetLinks``."""
...
import capo_networkmanager.types.get_links_request
import capo_networkmanager.types.get_links_response
...
) -> capo_networkmanager.types.get_links_response.GetLinksResponse:
    out: capo_networkmanager.types.get_links_response.GetLinksResponse = (
        capo_networkmanager.types.get_links_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "link_ids" in input_:
        params["linkIds"] = str(input_["link_ids"])
...
def get_links(
    ...
    capo_networkmanager.types.get_links_response.GetLinksResponse, zapros.Response
]:
