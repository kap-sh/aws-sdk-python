"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateSite``."""
...
import capo_networkmanager.types.create_site_request
import capo_networkmanager.types.create_site_response
...
) -> capo_networkmanager.types.create_site_response.CreateSiteResponse:
    out: capo_networkmanager.types.create_site_response.CreateSiteResponse = (
        capo_networkmanager.types.create_site_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/global-networks/{GlobalNetworkId}/sites"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_site_request.serialize_json(input_)
    ).encode()
...
def create_site(
    ...
    capo_networkmanager.types.create_site_response.CreateSiteResponse, zapros.Response
]:
