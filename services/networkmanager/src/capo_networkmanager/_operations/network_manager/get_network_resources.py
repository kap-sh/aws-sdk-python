"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetNetworkResources``."""
...
import capo_networkmanager.types.get_network_resources_request
import capo_networkmanager.types.get_network_resources_response
...
def handle_response(
    ...
    capo_networkmanager.types.get_network_resources_response.GetNetworkResourcesResponse
):
    out: capo_networkmanager.types.get_network_resources_response.GetNetworkResourcesResponse = capo_networkmanager.types.get_network_resources_response.deserialize_json(
