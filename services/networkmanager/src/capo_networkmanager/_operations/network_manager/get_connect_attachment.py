"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetConnectAttachment``."""
...
import capo_networkmanager.types.get_connect_attachment_request
import capo_networkmanager.types.get_connect_attachment_response
...
) -> capo_networkmanager.types.get_connect_attachment_response.GetConnectAttachmentResponse:
    out: capo_networkmanager.types.get_connect_attachment_response.GetConnectAttachmentResponse = capo_networkmanager.types.get_connect_attachment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/connect-attachments/{AttachmentId}"
...
async def async_get_connect_attachment(
