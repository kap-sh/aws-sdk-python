"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetCoreNetworkChangeSet``."""
...
import capo_networkmanager.types.get_core_network_change_set_request
import capo_networkmanager.types.get_core_network_change_set_response
...
) -> capo_networkmanager.types.get_core_network_change_set_response.GetCoreNetworkChangeSetResponse:
    out: capo_networkmanager.types.get_core_network_change_set_response.GetCoreNetworkChangeSetResponse = capo_networkmanager.types.get_core_network_change_set_response.deserialize_json(
...
async def async_get_core_network_change_set(
