"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateConnectAttachment``."""
...
import capo_networkmanager.types.create_connect_attachment_request
import capo_networkmanager.types.create_connect_attachment_response
...
) -> capo_networkmanager.types.create_connect_attachment_response.CreateConnectAttachmentResponse:
    out: capo_networkmanager.types.create_connect_attachment_response.CreateConnectAttachmentResponse = capo_networkmanager.types.create_connect_attachment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/connect-attachments"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_connect_attachment_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_connect_attachment(
