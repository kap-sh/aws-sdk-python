"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetCoreNetworkPolicyResponse``."""
...
class GetCoreNetworkPolicyResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetCoreNetworkPolicyResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetCoreNetworkPolicyResponse:
    out: GetCoreNetworkPolicyResponse = {}  # type: ignore[typeddict-item]
