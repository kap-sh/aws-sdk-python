...
if TYPE_CHECKING:
    import aws_sdk_networkmanager.types.reason_context_map
    import aws_sdk_networkmanager.types.route_analysis_completion_reason_code
    import aws_sdk_networkmanager.types.route_analysis_completion_result_code


class RouteAnalysisCompletion(TypedDict):
    result_code: NotRequired[
        "aws_sdk_networkmanager.types.route_analysis_completion_result_code.RouteAnalysisCompletionResultCode"
    ]
    """<p>The result of the analysis. If the status is <code>NOT_CONNECTED</code>, check the reason code.</p>"""
    reason_code: NotRequired[
        "aws_sdk_networkmanager.types.route_analysis_completion_reason_code.RouteAnalysisCompletionReasonCode"
    ]
    ...
    reason_context: NotRequired[
        "aws_sdk_networkmanager.types.reason_context_map.ReasonContextMap"
    ]
...
def serialize_json(value: RouteAnalysisCompletion) -> dict:
    ...
    if "result_code" in value:
        ...
        out["ResultCode"] = (
            aws_sdk_networkmanager.types.route_analysis_completion_result_code.serialize_json(
                value["result_code"]
            )
        )
    if "reason_code" in value:
        ...
        out["ReasonCode"] = (
            aws_sdk_networkmanager.types.route_analysis_completion_reason_code.serialize_json(
                value["reason_code"]
            )
        )
    if "reason_context" in value:
        ...
        out["ReasonContext"] = (
            aws_sdk_networkmanager.types.reason_context_map.serialize_json(
...
def deserialize_json(data: dict) -> RouteAnalysisCompletion:
    ...
    if "ResultCode" in data:
        ...
        out["result_code"] = (
            aws_sdk_networkmanager.types.route_analysis_completion_result_code.deserialize_json(
                data["ResultCode"]
            )
        )
    if "ReasonCode" in data:
        ...
        out["reason_code"] = (
            aws_sdk_networkmanager.types.route_analysis_completion_reason_code.deserialize_json(
                data["ReasonCode"]
            )
        )
    if "ReasonContext" in data:
        ...
        out["reason_context"] = (
            aws_sdk_networkmanager.types.reason_context_map.deserialize_json(
                data["ReasonContext"]
            )
        )
    return out
