...
if TYPE_CHECKING:
    import aws_sdk_networkmanager.types.attachment_routing_policy_associations_list
    import aws_sdk_networkmanager.types.next_token


class ListAttachmentRoutingPolicyAssociationsResponse(TypedDict):
    attachment_routing_policy_associations: NotRequired[
        "aws_sdk_networkmanager.types.attachment_routing_policy_associations_list.AttachmentRoutingPolicyAssociationsList"
    ]
...
def serialize_json(value: ListAttachmentRoutingPolicyAssociationsResponse) -> dict:
    ...
    if "attachment_routing_policy_associations" in value:
        ...
        out["AttachmentRoutingPolicyAssociations"] = (
            aws_sdk_networkmanager.types.attachment_routing_policy_associations_list.serialize_json(
...
def deserialize_json(data: dict) -> ListAttachmentRoutingPolicyAssociationsResponse:
    ...
    if "AttachmentRoutingPolicyAssociations" in data:
        ...
        out["attachment_routing_policy_associations"] = (
            aws_sdk_networkmanager.types.attachment_routing_policy_associations_list.deserialize_json(
