...
if TYPE_CHECKING:
    import aws_sdk_networkmanager.types.attachment_error_list
    ...
    import aws_sdk_networkmanager.types.network_function_group_name
    import aws_sdk_networkmanager.types.proposed_network_function_group_change
    import aws_sdk_networkmanager.types.proposed_segment_change
...
class Attachment(TypedDict):
    ...
    network_function_group_name: NotRequired[
        "aws_sdk_networkmanager.types.network_function_group_name.NetworkFunctionGroupName"
    ]
    ...
    proposed_segment_change: NotRequired[
        "aws_sdk_networkmanager.types.proposed_segment_change.ProposedSegmentChange"
    ]
    """<p>The attachment to move from one segment to another.</p>"""
    proposed_network_function_group_change: NotRequired[
        "aws_sdk_networkmanager.types.proposed_network_function_group_change.ProposedNetworkFunctionGroupChange"
    ]
    ...
    updated_at: NotRequired["aws_sdk_networkmanager.types.date_time.DateTime"]
    """<p>The timestamp when the attachment was last updated.</p>"""
    last_modification_errors: NotRequired[
        "aws_sdk_networkmanager.types.attachment_error_list.AttachmentErrorList"
    ]
...
def serialize_json(value: Attachment) -> dict:
    ...
    if "attachment_type" in value:
        ...
        out["AttachmentType"] = (
            aws_sdk_networkmanager.types.attachment_type.serialize_json(
    ...
    if "state" in value:
        ...
        out["State"] = aws_sdk_networkmanager.types.attachment_state.serialize_json(
            value["state"]
        )
    ...
    if "proposed_segment_change" in value:
        ...
        out["ProposedSegmentChange"] = (
            aws_sdk_networkmanager.types.proposed_segment_change.serialize_json(
    ...
    if "proposed_network_function_group_change" in value:
        ...
        out["ProposedNetworkFunctionGroupChange"] = (
            aws_sdk_networkmanager.types.proposed_network_function_group_change.serialize_json(
    ...
    if "updated_at" in value:
        ...
        out["UpdatedAt"] = aws_sdk_networkmanager.types.date_time.serialize_json(
            value["updated_at"]
        )
    if "last_modification_errors" in value:
        ...
        out["LastModificationErrors"] = (
            aws_sdk_networkmanager.types.attachment_error_list.serialize_json(
...
def deserialize_json(data: dict) -> Attachment:
    ...
    if "AttachmentType" in data:
        ...
        out["attachment_type"] = (
            aws_sdk_networkmanager.types.attachment_type.deserialize_json(
                data["AttachmentType"]
            )
        )
    if "State" in data:
        ...
        out["state"] = aws_sdk_networkmanager.types.attachment_state.deserialize_json(
            data["State"]
        )
    ...
    if "ProposedSegmentChange" in data:
        ...
        out["proposed_segment_change"] = (
            aws_sdk_networkmanager.types.proposed_segment_change.deserialize_json(
    ...
    if "ProposedNetworkFunctionGroupChange" in data:
        ...
        out["proposed_network_function_group_change"] = (
            aws_sdk_networkmanager.types.proposed_network_function_group_change.deserialize_json(
    ...
    if "UpdatedAt" in data:
        ...
        out["updated_at"] = aws_sdk_networkmanager.types.date_time.deserialize_json(
            data["UpdatedAt"]
        )
    if "LastModificationErrors" in data:
        ...
        out["last_modification_errors"] = (
            aws_sdk_networkmanager.types.attachment_error_list.deserialize_json(
