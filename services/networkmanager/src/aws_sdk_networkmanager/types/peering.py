...
if TYPE_CHECKING:
    ...
    import aws_sdk_networkmanager.types.peering_error_list
...
class Peering(TypedDict):
    ...
    last_modification_errors: NotRequired[
        "aws_sdk_networkmanager.types.peering_error_list.PeeringErrorList"
    ]
...
def serialize_json(value: Peering) -> dict:
    ...
    if "peering_type" in value:
        ...
        out["PeeringType"] = aws_sdk_networkmanager.types.peering_type.serialize_json(
            value["peering_type"]
        )
    if "state" in value:
        import aws_sdk_networkmanager.types.peering_state

        out["State"] = aws_sdk_networkmanager.types.peering_state.serialize_json(
            value["state"]
        )
    ...
    if "last_modification_errors" in value:
        ...
        out["LastModificationErrors"] = (
            aws_sdk_networkmanager.types.peering_error_list.serialize_json(
...
def deserialize_json(data: dict) -> Peering:
    ...
    if "PeeringType" in data:
        ...
        out["peering_type"] = (
            aws_sdk_networkmanager.types.peering_type.deserialize_json(
                data["PeeringType"]
            )
        )
    if "State" in data:
        ...
        out["state"] = aws_sdk_networkmanager.types.peering_state.deserialize_json(
            data["State"]
        )
    ...
    if "LastModificationErrors" in data:
        ...
        out["last_modification_errors"] = (
            aws_sdk_networkmanager.types.peering_error_list.deserialize_json(
