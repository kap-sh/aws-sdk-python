...
if TYPE_CHECKING:
    ...
    import aws_sdk_networkmanager.types.connection_health
...
class NetworkTelemetry(TypedDict, closed=True):
    ...
    """<p>The address.</p>"""
    health: NotRequired[
        "aws_sdk_networkmanager.types.connection_health.ConnectionHealth"
    ]
...
def serialize_json(value: NetworkTelemetry) -> dict:
    ...
    if "health" in value:
        ...
        out["Health"] = aws_sdk_networkmanager.types.connection_health.serialize_json(
            value["health"]
        )
    return out
...
def deserialize_json(data: dict) -> NetworkTelemetry:
    ...
    if "Health" in data:
        ...
        out["health"] = aws_sdk_networkmanager.types.connection_health.deserialize_json(
            data["Health"]
        )
    return out
