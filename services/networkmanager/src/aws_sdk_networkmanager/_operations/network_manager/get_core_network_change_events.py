...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_core_network_change_events_response.GetCoreNetworkChangeEventsResponse = aws_sdk_networkmanager.types.get_core_network_change_events_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_core_network_change_events_request.GetCoreNetworkChangeEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
