"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetNetworkResourceRelationships``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_network_resource_relationships_response.GetNetworkResourceRelationshipsResponse = aws_sdk_networkmanager.types.get_network_resource_relationships_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_network_resource_relationships_request.GetNetworkResourceRelationshipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_network_resource_relationships(
