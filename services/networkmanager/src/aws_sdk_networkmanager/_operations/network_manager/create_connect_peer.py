...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_connect_peer_response.CreateConnectPeerResponse = aws_sdk_networkmanager.types.create_connect_peer_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.create_connect_peer_request.CreateConnectPeerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_connect_peer_request.serialize_json(input)
    ).encode()
