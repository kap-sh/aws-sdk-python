"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateSiteToSiteVpnAttachment``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_site_to_site_vpn_attachment_response.CreateSiteToSiteVpnAttachmentResponse = aws_sdk_networkmanager.types.create_site_to_site_vpn_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_site_to_site_vpn_attachment_request.CreateSiteToSiteVpnAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_site_to_site_vpn_attachment(
