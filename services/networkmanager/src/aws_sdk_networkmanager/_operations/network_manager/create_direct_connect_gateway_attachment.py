...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_direct_connect_gateway_attachment_response.CreateDirectConnectGatewayAttachmentResponse = aws_sdk_networkmanager.types.create_direct_connect_gateway_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_direct_connect_gateway_attachment_request.CreateDirectConnectGatewayAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_direct_connect_gateway_attachment_request.serialize_json(
            input_
        )
    ).encode()
