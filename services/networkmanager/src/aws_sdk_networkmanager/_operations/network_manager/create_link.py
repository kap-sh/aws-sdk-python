...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_link_response.CreateLinkResponse = (
        aws_sdk_networkmanager.types.create_link_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.create_link_request.CreateLinkRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_link_request.serialize_json(input)
    ).encode()
