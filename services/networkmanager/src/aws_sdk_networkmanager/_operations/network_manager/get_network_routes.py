...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_network_routes_response.GetNetworkRoutesResponse = aws_sdk_networkmanager.types.get_network_routes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_network_routes_request.GetNetworkRoutesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.get_network_routes_request.serialize_json(input_)
    ).encode()
