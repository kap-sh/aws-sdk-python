...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.get_network_routes_request.GetNetworkRoutesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.get_network_routes_request.serialize_json(input)
    ).encode()
