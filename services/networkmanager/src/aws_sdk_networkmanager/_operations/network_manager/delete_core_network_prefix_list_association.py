...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.delete_core_network_prefix_list_association_request.DeleteCoreNetworkPrefixListAssociationRequest,
) -> zapros.Request:
    ...
    url = url.replace("{PrefixListArn}", quote(str(input["prefix_list_arn"]), safe=""))
    params: dict[str, str] = {}
