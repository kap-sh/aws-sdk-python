"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeleteCoreNetworkPrefixListAssociation``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_core_network_prefix_list_association_response.DeleteCoreNetworkPrefixListAssociationResponse = aws_sdk_networkmanager.types.delete_core_network_prefix_list_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.delete_core_network_prefix_list_association_request.DeleteCoreNetworkPrefixListAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{PrefixListArn}", quote(str(input_["prefix_list_arn"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_core_network_prefix_list_association(
