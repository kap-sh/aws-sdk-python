"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeleteLink``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_link_response.DeleteLinkResponse = (
        aws_sdk_networkmanager.types.delete_link_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.delete_link_request.DeleteLinkRequest,
) -> zapros.Request:
