...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.register_transit_gateway_response.RegisterTransitGatewayResponse = aws_sdk_networkmanager.types.register_transit_gateway_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.register_transit_gateway_request.RegisterTransitGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.register_transit_gateway_request.serialize_json(
            input_
        )
    ).encode()
