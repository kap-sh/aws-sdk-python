...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_transit_gateway_registrations_response.GetTransitGatewayRegistrationsResponse = aws_sdk_networkmanager.types.get_transit_gateway_registrations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_transit_gateway_registrations_request.GetTransitGatewayRegistrationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
