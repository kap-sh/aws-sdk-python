...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.get_transit_gateway_registrations_request.GetTransitGatewayRegistrationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "transit_gateway_arns" in input:
        params["transitGatewayArns"] = str(input["transit_gateway_arns"])
