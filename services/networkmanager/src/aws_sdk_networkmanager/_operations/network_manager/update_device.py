...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.update_device_response.UpdateDeviceResponse = (
        aws_sdk_networkmanager.types.update_device_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.update_device_request.UpdateDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.update_device_request.serialize_json(input_)
    ).encode()
