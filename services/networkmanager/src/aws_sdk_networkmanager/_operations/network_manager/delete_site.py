...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_site_response.DeleteSiteResponse = (
        aws_sdk_networkmanager.types.delete_site_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.delete_site_request.DeleteSiteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
