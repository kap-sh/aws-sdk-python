...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_route_analysis_response.GetRouteAnalysisResponse = aws_sdk_networkmanager.types.get_route_analysis_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_route_analysis_request.GetRouteAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
