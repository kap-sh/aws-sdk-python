"""Generated from Smithy shape ``com.amazonaws.networkmanager#AssociateConnectPeer``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.associate_connect_peer_response.AssociateConnectPeerResponse = aws_sdk_networkmanager.types.associate_connect_peer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.associate_connect_peer_request.AssociateConnectPeerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.associate_connect_peer_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_connect_peer(
