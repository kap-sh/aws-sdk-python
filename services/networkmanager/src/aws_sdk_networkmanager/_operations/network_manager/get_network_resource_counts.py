...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_network_resource_counts_response.GetNetworkResourceCountsResponse = aws_sdk_networkmanager.types.get_network_resource_counts_response.deserialize_json(
