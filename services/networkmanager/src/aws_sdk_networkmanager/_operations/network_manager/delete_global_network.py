"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeleteGlobalNetwork``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_global_network_response.DeleteGlobalNetworkResponse = aws_sdk_networkmanager.types.delete_global_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.delete_global_network_request.DeleteGlobalNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_global_network(
