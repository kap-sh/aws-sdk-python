...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_network_resources_response.GetNetworkResourcesResponse = aws_sdk_networkmanager.types.get_network_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_network_resources_request.GetNetworkResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
