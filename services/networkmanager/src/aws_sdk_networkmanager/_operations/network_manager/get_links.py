...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_links_response.GetLinksResponse = (
        aws_sdk_networkmanager.types.get_links_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.get_links_request.GetLinksRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "link_ids" in input:
        params["linkIds"] = str(input["link_ids"])
    if "site_id" in input:
        params["siteId"] = str(input["site_id"])
    if "type" in input:
        params["type"] = str(input["type"])
    if "provider" in input:
        params["provider"] = str(input["provider"])
...
def get_links(
    ...
    aws_sdk_networkmanager.types.get_links_response.GetLinksResponse, zapros.Response
]:
