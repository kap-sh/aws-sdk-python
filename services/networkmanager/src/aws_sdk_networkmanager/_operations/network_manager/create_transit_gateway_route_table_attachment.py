...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_transit_gateway_route_table_attachment_response.CreateTransitGatewayRouteTableAttachmentResponse = aws_sdk_networkmanager.types.create_transit_gateway_route_table_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_transit_gateway_route_table_attachment_request.CreateTransitGatewayRouteTableAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_transit_gateway_route_table_attachment_request.serialize_json(
            input_
        )
    ).encode()
