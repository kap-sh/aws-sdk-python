"""Generated from Smithy shape ``com.amazonaws.networkmanager#DisassociateLink``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.disassociate_link_response.DisassociateLinkResponse = aws_sdk_networkmanager.types.disassociate_link_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.disassociate_link_request.DisassociateLinkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_link(
