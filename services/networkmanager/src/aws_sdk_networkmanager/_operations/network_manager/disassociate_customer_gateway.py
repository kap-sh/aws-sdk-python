...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.disassociate_customer_gateway_response.DisassociateCustomerGatewayResponse = aws_sdk_networkmanager.types.disassociate_customer_gateway_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.disassociate_customer_gateway_request.DisassociateCustomerGatewayRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{CustomerGatewayArn}", quote(str(input["customer_gateway_arn"]), safe="")
    )
    params: dict[str, str] = {}
