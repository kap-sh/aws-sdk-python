"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetLinkAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_link_associations_response.GetLinkAssociationsResponse = aws_sdk_networkmanager.types.get_link_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_link_associations_request.GetLinkAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "link_id" in input_:
        params["linkId"] = str(input_["link_id"])
...
async def async_get_link_associations(
