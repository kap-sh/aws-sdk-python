"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetVpcAttachment``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_vpc_attachment_response.GetVpcAttachmentResponse = aws_sdk_networkmanager.types.get_vpc_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_vpc_attachment_request.GetVpcAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_vpc_attachment(
