...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.create_core_network_request.CreateCoreNetworkRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_core_network_request.serialize_json(input)
    ).encode()
