"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateCoreNetwork``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CoreNetworkPolicyException":
            import aws_sdk_networkmanager.errors.core_network_policy_exception

            raise aws_sdk_networkmanager.errors.core_network_policy_exception.CoreNetworkPolicyException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_networkmanager.errors.service_quota_exceeded_exception

            raise aws_sdk_networkmanager.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_core_network_response.CreateCoreNetworkResponse = aws_sdk_networkmanager.types.create_core_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_core_network_request.CreateCoreNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/core-networks"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_networkmanager.types.create_core_network_request

    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_core_network_request.serialize_json(input_)
    ).encode()
...
async def async_create_core_network(
