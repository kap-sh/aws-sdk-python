...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_connection_response.DeleteConnectionResponse = aws_sdk_networkmanager.types.delete_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.delete_connection_request.DeleteConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
