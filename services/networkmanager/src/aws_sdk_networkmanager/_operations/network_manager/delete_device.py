...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_device_response.DeleteDeviceResponse = (
        aws_sdk_networkmanager.types.delete_device_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.delete_device_request.DeleteDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
