...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.update_global_network_request.UpdateGlobalNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.update_global_network_request.serialize_json(
            input_
        )
    ).encode()
