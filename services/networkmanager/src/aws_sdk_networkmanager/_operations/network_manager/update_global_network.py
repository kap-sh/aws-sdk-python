...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.update_global_network_response.UpdateGlobalNetworkResponse = aws_sdk_networkmanager.types.update_global_network_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.update_global_network_request.UpdateGlobalNetworkRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.update_global_network_request.serialize_json(input)
    ).encode()
