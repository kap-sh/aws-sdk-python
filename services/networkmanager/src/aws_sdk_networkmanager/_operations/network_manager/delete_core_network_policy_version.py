...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.delete_core_network_policy_version_request.DeleteCoreNetworkPolicyVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{PolicyVersionId}", quote(str(input["policy_version_id"]), safe="")
    )
    params: dict[str, str] = {}
