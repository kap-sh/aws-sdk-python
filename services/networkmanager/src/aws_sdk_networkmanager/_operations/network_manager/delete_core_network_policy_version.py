"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeleteCoreNetworkPolicyVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_core_network_policy_version_response.DeleteCoreNetworkPolicyVersionResponse = aws_sdk_networkmanager.types.delete_core_network_policy_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.delete_core_network_policy_version_request.DeleteCoreNetworkPolicyVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_core_network_policy_version(
