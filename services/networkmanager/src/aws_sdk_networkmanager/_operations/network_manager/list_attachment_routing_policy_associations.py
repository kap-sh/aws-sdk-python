...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.list_attachment_routing_policy_associations_response.ListAttachmentRoutingPolicyAssociationsResponse = aws_sdk_networkmanager.types.list_attachment_routing_policy_associations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.list_attachment_routing_policy_associations_request.ListAttachmentRoutingPolicyAssociationsRequest,
) -> zapros.Request:
    ...
    if "attachment_id" in input:
        params["attachmentId"] = str(input["attachment_id"])
