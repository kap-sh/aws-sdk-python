...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.list_core_network_prefix_list_associations_request.ListCoreNetworkPrefixListAssociationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "prefix_list_arn" in input:
        params["prefixListArn"] = str(input["prefix_list_arn"])
