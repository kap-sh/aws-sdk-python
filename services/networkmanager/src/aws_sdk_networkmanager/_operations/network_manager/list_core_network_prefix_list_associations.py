"""Generated from Smithy shape ``com.amazonaws.networkmanager#ListCoreNetworkPrefixListAssociations``."""
...
import aws_sdk_networkmanager.types.prefix_list_association_list
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.list_core_network_prefix_list_associations_response.ListCoreNetworkPrefixListAssociationsResponse = aws_sdk_networkmanager.types.list_core_network_prefix_list_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.list_core_network_prefix_list_associations_request.ListCoreNetworkPrefixListAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prefix-list/core-network/{CoreNetworkId}"
    url = url.replace("{CoreNetworkId}", quote(str(input_["core_network_id"]), safe=""))
    params: dict[str, str] = {}
    if "prefix_list_arn" in input_:
        params["prefixListArn"] = str(input_["prefix_list_arn"])
...
async def async_list_core_network_prefix_list_associations(
