...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_customer_gateway_associations_request.GetCustomerGatewayAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "customer_gateway_arns" in input_:
        params["customerGatewayArns"] = str(input_["customer_gateway_arns"])
