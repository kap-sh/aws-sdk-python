...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_customer_gateway_associations_response.GetCustomerGatewayAssociationsResponse = aws_sdk_networkmanager.types.get_customer_gateway_associations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.get_customer_gateway_associations_request.GetCustomerGatewayAssociationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "customer_gateway_arns" in input:
        params["customerGatewayArns"] = str(input["customer_gateway_arns"])
