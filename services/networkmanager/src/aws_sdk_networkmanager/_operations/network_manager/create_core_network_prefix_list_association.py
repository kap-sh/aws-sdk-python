...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_core_network_prefix_list_association_response.CreateCoreNetworkPrefixListAssociationResponse = aws_sdk_networkmanager.types.create_core_network_prefix_list_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_core_network_prefix_list_association_request.CreateCoreNetworkPrefixListAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_core_network_prefix_list_association_request.serialize_json(
            input_
        )
    ).encode()
