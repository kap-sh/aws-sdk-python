...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.associate_link_request.AssociateLinkRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.associate_link_request.serialize_json(input)
    ).encode()
