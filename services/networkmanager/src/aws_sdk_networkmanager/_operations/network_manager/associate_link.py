...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.associate_link_response.AssociateLinkResponse = (
        aws_sdk_networkmanager.types.associate_link_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.associate_link_request.AssociateLinkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.associate_link_request.serialize_json(input_)
    ).encode()
