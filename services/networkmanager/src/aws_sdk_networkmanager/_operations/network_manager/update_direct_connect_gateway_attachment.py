...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.update_direct_connect_gateway_attachment_response.UpdateDirectConnectGatewayAttachmentResponse = aws_sdk_networkmanager.types.update_direct_connect_gateway_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.update_direct_connect_gateway_attachment_request.UpdateDirectConnectGatewayAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
