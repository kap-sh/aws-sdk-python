...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_resource_policy_response.DeleteResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.delete_resource_policy_request.DeleteResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
