...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_sites_response.GetSitesResponse = (
        aws_sdk_networkmanager.types.get_sites_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_sites_request.GetSitesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_sites(
    ...
    aws_sdk_networkmanager.types.get_sites_response.GetSitesResponse, zapros.Response
]:
