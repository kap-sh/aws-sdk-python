...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_core_network_change_set_response.GetCoreNetworkChangeSetResponse = aws_sdk_networkmanager.types.get_core_network_change_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_core_network_change_set_request.GetCoreNetworkChangeSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
