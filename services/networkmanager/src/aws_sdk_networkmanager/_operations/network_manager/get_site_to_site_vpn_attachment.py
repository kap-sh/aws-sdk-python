...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_site_to_site_vpn_attachment_response.GetSiteToSiteVpnAttachmentResponse = aws_sdk_networkmanager.types.get_site_to_site_vpn_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_site_to_site_vpn_attachment_request.GetSiteToSiteVpnAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
