...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_core_network_response.GetCoreNetworkResponse = aws_sdk_networkmanager.types.get_core_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_core_network_request.GetCoreNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
