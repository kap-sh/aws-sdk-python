...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_connections_response.GetConnectionsResponse = aws_sdk_networkmanager.types.get_connections_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.get_connections_request.GetConnectionsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "connection_ids" in input:
        params["connectionIds"] = str(input["connection_ids"])
