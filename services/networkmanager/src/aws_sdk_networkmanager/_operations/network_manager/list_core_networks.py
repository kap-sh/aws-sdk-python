"""Generated from Smithy shape ``com.amazonaws.networkmanager#ListCoreNetworks``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.list_core_networks_response.ListCoreNetworksResponse = aws_sdk_networkmanager.types.list_core_networks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.list_core_networks_request.ListCoreNetworksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_core_networks(
