"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateVpcAttachment``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_vpc_attachment_response.CreateVpcAttachmentResponse = aws_sdk_networkmanager.types.create_vpc_attachment_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.create_vpc_attachment_request.CreateVpcAttachmentRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/vpc-attachments"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_networkmanager.types.create_vpc_attachment_request

    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_vpc_attachment_request.serialize_json(input)
    ).encode()
...
async def async_create_vpc_attachment(
