...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_vpc_attachment_request.CreateVpcAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_vpc_attachment_request.serialize_json(
            input_
        )
    ).encode()
