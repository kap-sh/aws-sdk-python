...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.describe_global_networks_response.DescribeGlobalNetworksResponse = aws_sdk_networkmanager.types.describe_global_networks_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.describe_global_networks_request.DescribeGlobalNetworksRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "global_network_ids" in input:
        params["globalNetworkIds"] = str(input["global_network_ids"])
