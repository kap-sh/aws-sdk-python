"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeleteCoreNetwork``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_core_network_response.DeleteCoreNetworkResponse = aws_sdk_networkmanager.types.delete_core_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.delete_core_network_request.DeleteCoreNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_core_network(
