...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.update_connection_response.UpdateConnectionResponse = aws_sdk_networkmanager.types.update_connection_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.update_connection_request.UpdateConnectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.update_connection_request.serialize_json(input)
    ).encode()
