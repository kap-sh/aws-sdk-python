...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.list_organization_service_access_status_response.ListOrganizationServiceAccessStatusResponse = aws_sdk_networkmanager.types.list_organization_service_access_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.list_organization_service_access_status_request.ListOrganizationServiceAccessStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
