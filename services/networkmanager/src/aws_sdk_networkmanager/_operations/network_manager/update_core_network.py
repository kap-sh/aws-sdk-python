...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.update_core_network_response.UpdateCoreNetworkResponse = aws_sdk_networkmanager.types.update_core_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.update_core_network_request.UpdateCoreNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.update_core_network_request.serialize_json(input_)
    ).encode()
