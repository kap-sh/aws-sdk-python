...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.update_core_network_request.UpdateCoreNetworkRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.update_core_network_request.serialize_json(input)
    ).encode()
