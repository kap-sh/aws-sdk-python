...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_global_network_request.CreateGlobalNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_global_network_request.serialize_json(
            input_
        )
    ).encode()
