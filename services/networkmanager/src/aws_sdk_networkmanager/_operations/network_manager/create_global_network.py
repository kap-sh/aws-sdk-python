"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateGlobalNetwork``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_global_network_response.CreateGlobalNetworkResponse = aws_sdk_networkmanager.types.create_global_network_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.create_global_network_request.CreateGlobalNetworkRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_global_network_request.serialize_json(input)
    ).encode()
...
async def async_create_global_network(
