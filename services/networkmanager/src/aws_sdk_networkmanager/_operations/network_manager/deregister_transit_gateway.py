...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.deregister_transit_gateway_response.DeregisterTransitGatewayResponse = aws_sdk_networkmanager.types.deregister_transit_gateway_response.deserialize_json(
