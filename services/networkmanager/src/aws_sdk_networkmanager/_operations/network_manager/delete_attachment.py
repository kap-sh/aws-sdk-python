...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_attachment_response.DeleteAttachmentResponse = aws_sdk_networkmanager.types.delete_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.delete_attachment_request.DeleteAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
