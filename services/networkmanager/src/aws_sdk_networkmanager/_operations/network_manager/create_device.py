"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateDevice``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_device_response.CreateDeviceResponse = (
        aws_sdk_networkmanager.types.create_device_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_device_request.CreateDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_device_request.serialize_json(input_)
    ).encode()
