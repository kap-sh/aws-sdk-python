...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_transit_gateway_peering_response.GetTransitGatewayPeeringResponse = aws_sdk_networkmanager.types.get_transit_gateway_peering_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.get_transit_gateway_peering_request.GetTransitGatewayPeeringRequest,
) -> zapros.Request:
    ...
    url = url.replace("{PeeringId}", quote(str(input["peering_id"]), safe=""))
    params: dict[str, str] = {}
