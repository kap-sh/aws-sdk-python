...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.list_peerings_response.ListPeeringsResponse = (
        aws_sdk_networkmanager.types.list_peerings_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.list_peerings_request.ListPeeringsRequest,
) -> zapros.Request:
    ...
    if "peering_type" in input:
        params["peeringType"] = str(input["peering_type"])
