...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.list_core_network_routing_information_response.ListCoreNetworkRoutingInformationResponse = aws_sdk_networkmanager.types.list_core_network_routing_information_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.list_core_network_routing_information_request.ListCoreNetworkRoutingInformationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.list_core_network_routing_information_request.serialize_json(
            input_
        )
    ).encode()
