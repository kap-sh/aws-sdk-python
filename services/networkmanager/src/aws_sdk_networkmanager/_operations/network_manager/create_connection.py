...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.create_connection_request.CreateConnectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_connection_request.serialize_json(input)
    ).encode()
