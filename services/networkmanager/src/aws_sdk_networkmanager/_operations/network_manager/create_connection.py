...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_connection_response.CreateConnectionResponse = aws_sdk_networkmanager.types.create_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_connection_request.CreateConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_connection_request.serialize_json(input_)
    ).encode()
