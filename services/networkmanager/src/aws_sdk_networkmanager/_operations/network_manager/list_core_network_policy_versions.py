...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.list_core_network_policy_versions_response.ListCoreNetworkPolicyVersionsResponse = aws_sdk_networkmanager.types.list_core_network_policy_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.list_core_network_policy_versions_request.ListCoreNetworkPolicyVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
