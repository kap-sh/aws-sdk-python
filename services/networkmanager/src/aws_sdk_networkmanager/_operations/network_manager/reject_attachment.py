...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.reject_attachment_response.RejectAttachmentResponse = aws_sdk_networkmanager.types.reject_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.reject_attachment_request.RejectAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
