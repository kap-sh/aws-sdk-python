...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.update_network_resource_metadata_response.UpdateNetworkResourceMetadataResponse = aws_sdk_networkmanager.types.update_network_resource_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.update_network_resource_metadata_request.UpdateNetworkResourceMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.update_network_resource_metadata_request.serialize_json(
            input_
        )
    ).encode()
