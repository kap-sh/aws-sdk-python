...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.start_route_analysis_request.StartRouteAnalysisRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.start_route_analysis_request.serialize_json(input)
    ).encode()
