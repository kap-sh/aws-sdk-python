...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.start_route_analysis_response.StartRouteAnalysisResponse = aws_sdk_networkmanager.types.start_route_analysis_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.start_route_analysis_request.StartRouteAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.start_route_analysis_request.serialize_json(input_)
    ).encode()
