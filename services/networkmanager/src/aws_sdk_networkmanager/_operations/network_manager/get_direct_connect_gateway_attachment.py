...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_direct_connect_gateway_attachment_response.GetDirectConnectGatewayAttachmentResponse = aws_sdk_networkmanager.types.get_direct_connect_gateway_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_direct_connect_gateway_attachment_request.GetDirectConnectGatewayAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
