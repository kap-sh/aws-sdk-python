...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.delete_connect_peer_request.DeleteConnectPeerRequest,
) -> zapros.Request:
    ...
    url = url.replace("{ConnectPeerId}", quote(str(input["connect_peer_id"]), safe=""))
    params: dict[str, str] = {}
