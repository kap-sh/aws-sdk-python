...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.delete_peering_response.DeletePeeringResponse = (
        aws_sdk_networkmanager.types.delete_peering_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.delete_peering_request.DeletePeeringRequest,
) -> zapros.Request:
