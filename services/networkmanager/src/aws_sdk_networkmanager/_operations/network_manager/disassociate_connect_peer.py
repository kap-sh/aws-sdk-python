"""Generated from Smithy shape ``com.amazonaws.networkmanager#DisassociateConnectPeer``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.disassociate_connect_peer_response.DisassociateConnectPeerResponse = aws_sdk_networkmanager.types.disassociate_connect_peer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.disassociate_connect_peer_request.DisassociateConnectPeerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_connect_peer(
