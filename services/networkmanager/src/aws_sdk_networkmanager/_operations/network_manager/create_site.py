...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_site_response.CreateSiteResponse = (
        aws_sdk_networkmanager.types.create_site_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_site_request.CreateSiteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_site_request.serialize_json(input_)
    ).encode()
