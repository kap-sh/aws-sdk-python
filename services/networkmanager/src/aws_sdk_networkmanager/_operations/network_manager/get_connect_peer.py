...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_connect_peer_response.GetConnectPeerResponse = aws_sdk_networkmanager.types.get_connect_peer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_connect_peer_request.GetConnectPeerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
