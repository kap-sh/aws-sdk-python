...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.execute_core_network_change_set_response.ExecuteCoreNetworkChangeSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.execute_core_network_change_set_request.ExecuteCoreNetworkChangeSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
