...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_connect_attachment_response.GetConnectAttachmentResponse = aws_sdk_networkmanager.types.get_connect_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_connect_attachment_request.GetConnectAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
