...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.list_attachments_response.ListAttachmentsResponse = aws_sdk_networkmanager.types.list_attachments_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.list_attachments_request.ListAttachmentsRequest,
) -> zapros.Request:
    ...
    if "attachment_type" in input:
        params["attachmentType"] = str(input["attachment_type"])
    if "edge_location" in input:
        params["edgeLocation"] = str(input["edge_location"])
    if "state" in input:
