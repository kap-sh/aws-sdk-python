...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_connect_peer_associations_response.GetConnectPeerAssociationsResponse = aws_sdk_networkmanager.types.get_connect_peer_associations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.get_connect_peer_associations_request.GetConnectPeerAssociationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "connect_peer_ids" in input:
        params["connectPeerIds"] = str(input["connect_peer_ids"])
