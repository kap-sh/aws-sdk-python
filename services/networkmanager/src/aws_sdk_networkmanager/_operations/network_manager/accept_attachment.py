"""Generated from Smithy shape ``com.amazonaws.networkmanager#AcceptAttachment``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.accept_attachment_response.AcceptAttachmentResponse = aws_sdk_networkmanager.types.accept_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.accept_attachment_request.AcceptAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/attachments/{AttachmentId}/accept"
...
async def async_accept_attachment(
