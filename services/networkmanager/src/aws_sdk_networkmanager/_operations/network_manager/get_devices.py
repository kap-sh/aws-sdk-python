...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_devices_response.GetDevicesResponse = (
        aws_sdk_networkmanager.types.get_devices_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_devices_request.GetDevicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
