...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.get_transit_gateway_connect_peer_associations_request.GetTransitGatewayConnectPeerAssociationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "transit_gateway_connect_peer_arns" in input:
