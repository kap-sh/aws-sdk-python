"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetTransitGatewayConnectPeerAssociations``."""
...
import aws_sdk_networkmanager.types.transit_gateway_connect_peer_association_list
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_transit_gateway_connect_peer_associations_response.GetTransitGatewayConnectPeerAssociationsResponse = aws_sdk_networkmanager.types.get_transit_gateway_connect_peer_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_transit_gateway_connect_peer_associations_request.GetTransitGatewayConnectPeerAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "transit_gateway_connect_peer_arns" in input_:
        params["transitGatewayConnectPeerArns"] = str(
...
async def async_get_transit_gateway_connect_peer_associations(
