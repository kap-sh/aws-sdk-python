"""Generated from Smithy shape ``com.amazonaws.networkmanager#PutResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.put_resource_policy_response.PutResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.put_resource_policy_request.serialize_json(input_)
    ).encode()
