...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.remove_attachment_routing_policy_label_response.RemoveAttachmentRoutingPolicyLabelResponse = aws_sdk_networkmanager.types.remove_attachment_routing_policy_label_response.deserialize_json(
