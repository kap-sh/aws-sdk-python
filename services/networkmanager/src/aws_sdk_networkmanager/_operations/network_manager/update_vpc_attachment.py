...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.update_vpc_attachment_request.UpdateVpcAttachmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.update_vpc_attachment_request.serialize_json(input)
    ).encode()
