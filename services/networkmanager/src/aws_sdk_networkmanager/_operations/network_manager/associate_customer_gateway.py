"""Generated from Smithy shape ``com.amazonaws.networkmanager#AssociateCustomerGateway``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.associate_customer_gateway_response.AssociateCustomerGatewayResponse = aws_sdk_networkmanager.types.associate_customer_gateway_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.associate_customer_gateway_request.AssociateCustomerGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.associate_customer_gateway_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_customer_gateway(
