...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_resource_policy_response.GetResourcePolicyResponse = aws_sdk_networkmanager.types.get_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_resource_policy_request.GetResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
