"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateTransitGatewayPeering``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_transit_gateway_peering_response.CreateTransitGatewayPeeringResponse = aws_sdk_networkmanager.types.create_transit_gateway_peering_response.deserialize_json(
