...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.update_link_response.UpdateLinkResponse = (
        aws_sdk_networkmanager.types.update_link_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.update_link_request.UpdateLinkRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.update_link_request.serialize_json(input)
    ).encode()
