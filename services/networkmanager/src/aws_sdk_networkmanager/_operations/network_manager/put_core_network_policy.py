...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.put_core_network_policy_response.PutCoreNetworkPolicyResponse = aws_sdk_networkmanager.types.put_core_network_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.put_core_network_policy_request.PutCoreNetworkPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.put_core_network_policy_request.serialize_json(
            input_
        )
    ).encode()
