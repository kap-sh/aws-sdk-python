...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.create_connect_attachment_response.CreateConnectAttachmentResponse = aws_sdk_networkmanager.types.create_connect_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.create_connect_attachment_request.CreateConnectAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.create_connect_attachment_request.serialize_json(
            input_
        )
    ).encode()
