...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.start_organization_service_access_update_response.StartOrganizationServiceAccessUpdateResponse = aws_sdk_networkmanager.types.start_organization_service_access_update_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.start_organization_service_access_update_request.StartOrganizationServiceAccessUpdateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.start_organization_service_access_update_request.serialize_json(
            input_
        )
    ).encode()
