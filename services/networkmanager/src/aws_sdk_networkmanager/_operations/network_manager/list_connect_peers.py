...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.list_connect_peers_request.ListConnectPeersRequest,
) -> zapros.Request:
    ...
    if "connect_attachment_id" in input:
        params["connectAttachmentId"] = str(input["connect_attachment_id"])
