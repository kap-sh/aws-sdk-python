"""Generated from Smithy shape ``com.amazonaws.networkmanager#ListConnectPeers``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.list_connect_peers_response.ListConnectPeersResponse = aws_sdk_networkmanager.types.list_connect_peers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.list_connect_peers_request.ListConnectPeersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "connect_attachment_id" in input_:
        params["connectAttachmentId"] = str(input_["connect_attachment_id"])
...
async def async_list_connect_peers(
