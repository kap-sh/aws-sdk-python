...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_core_network_policy_response.GetCoreNetworkPolicyResponse = aws_sdk_networkmanager.types.get_core_network_policy_response.deserialize_json(
