...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.get_transit_gateway_route_table_attachment_response.GetTransitGatewayRouteTableAttachmentResponse = aws_sdk_networkmanager.types.get_transit_gateway_route_table_attachment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.get_transit_gateway_route_table_attachment_request.GetTransitGatewayRouteTableAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
