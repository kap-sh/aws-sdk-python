"""Generated from Smithy shape ``com.amazonaws.networkmanager#UpdateSite``."""
...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.update_site_response.UpdateSiteResponse = (
        aws_sdk_networkmanager.types.update_site_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.update_site_request.UpdateSiteRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.update_site_request.serialize_json(input)
    ).encode()
