...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.restore_core_network_policy_version_response.RestoreCoreNetworkPolicyVersionResponse = aws_sdk_networkmanager.types.restore_core_network_policy_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.restore_core_network_policy_version_request.RestoreCoreNetworkPolicyVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
