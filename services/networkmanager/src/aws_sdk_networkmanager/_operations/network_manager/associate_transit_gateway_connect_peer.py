...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.associate_transit_gateway_connect_peer_response.AssociateTransitGatewayConnectPeerResponse = aws_sdk_networkmanager.types.associate_transit_gateway_connect_peer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkmanager.types.associate_transit_gateway_connect_peer_request.AssociateTransitGatewayConnectPeerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkmanager.types.associate_transit_gateway_connect_peer_request.serialize_json(
            input_
        )
    ).encode()
