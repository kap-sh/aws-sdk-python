...
def handle_response(
    ...
    out: aws_sdk_networkmanager.types.disassociate_transit_gateway_connect_peer_response.DisassociateTransitGatewayConnectPeerResponse = aws_sdk_networkmanager.types.disassociate_transit_gateway_connect_peer_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkmanager.types.disassociate_transit_gateway_connect_peer_request.DisassociateTransitGatewayConnectPeerRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["transit_gateway_connect_peer_arn"]), safe=""),
    )
    params: dict[str, str] = {}
