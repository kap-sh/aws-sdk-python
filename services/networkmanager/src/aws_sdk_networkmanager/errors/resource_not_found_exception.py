...
if TYPE_CHECKING:
    import aws_sdk_networkmanager.types.exception_context_map
...
class ResourceNotFoundException_(TypedDict):
    ...
    context: NotRequired[
        "aws_sdk_networkmanager.types.exception_context_map.ExceptionContextMap"
    ]
...
def serialize_json(value: ResourceNotFoundException_) -> dict:
    ...
    if "context" in value:
        ...
        out["Context"] = (
            aws_sdk_networkmanager.types.exception_context_map.serialize_json(
                value["context"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ResourceNotFoundException_:
    ...
    if "Context" in data:
        ...
        out["context"] = (
            aws_sdk_networkmanager.types.exception_context_map.deserialize_json(
                data["Context"]
            )
        )
    return out
