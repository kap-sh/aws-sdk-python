...
class ListBillScenariosResponse(TypedDict, closed=True):
    items: NotRequired[
        "capo_bcm_pricing_calculator.types.bill_scenario_summaries.BillScenarioSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListBillScenariosResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            capo_bcm_pricing_calculator.types.bill_scenario_summaries.serialize_aws_json_1_0(
                value["items"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListBillScenariosResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            capo_bcm_pricing_calculator.types.bill_scenario_summaries.deserialize_aws_json_1_0(
                data["items"]
            )
        )
