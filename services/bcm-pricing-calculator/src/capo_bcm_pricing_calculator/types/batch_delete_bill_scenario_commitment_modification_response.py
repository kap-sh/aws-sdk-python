...
if TYPE_CHECKING:
    import capo_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_errors


class BatchDeleteBillScenarioCommitmentModificationResponse(TypedDict, closed=True):
    errors: NotRequired[
        "capo_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_errors.BatchDeleteBillScenarioCommitmentModificationErrors"
    ]
...
def serialize_aws_json_1_0(
    ...
    if "errors" in value:
        ...
        out["errors"] = (
            capo_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_errors.serialize_aws_json_1_0(
                value["errors"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(
    ...
    if "errors" in data:
        ...
        out["errors"] = (
            capo_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_errors.deserialize_aws_json_1_0(
                data["errors"]
            )
        )
    return out
