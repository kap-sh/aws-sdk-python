...
if TYPE_CHECKING:
    ...
    import capo_bcm_pricing_calculator.types.workload_estimate_update_usage_error_code


class BatchDeleteWorkloadEstimateUsageError(TypedDict, closed=True):
    ...
    error_code: NotRequired[
        "capo_bcm_pricing_calculator.types.workload_estimate_update_usage_error_code.WorkloadEstimateUpdateUsageErrorCode"
    ]
...
def serialize_aws_json_1_0(value: BatchDeleteWorkloadEstimateUsageError) -> dict:
    ...
    if "error_code" in value:
        ...
        out["errorCode"] = (
            capo_bcm_pricing_calculator.types.workload_estimate_update_usage_error_code.serialize_aws_json_1_0(
                value["error_code"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchDeleteWorkloadEstimateUsageError:
    ...
    if "errorCode" in data:
        ...
        out["error_code"] = (
            capo_bcm_pricing_calculator.types.workload_estimate_update_usage_error_code.deserialize_aws_json_1_0(
                data["errorCode"]
            )
        )
    return out
