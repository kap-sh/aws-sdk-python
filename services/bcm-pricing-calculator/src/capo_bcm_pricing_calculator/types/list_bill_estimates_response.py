...
class ListBillEstimatesResponse(TypedDict, closed=True):
    items: NotRequired[
        "capo_bcm_pricing_calculator.types.bill_estimate_summaries.BillEstimateSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListBillEstimatesResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            capo_bcm_pricing_calculator.types.bill_estimate_summaries.serialize_aws_json_1_0(
                value["items"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListBillEstimatesResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            capo_bcm_pricing_calculator.types.bill_estimate_summaries.deserialize_aws_json_1_0(
                data["items"]
            )
        )
