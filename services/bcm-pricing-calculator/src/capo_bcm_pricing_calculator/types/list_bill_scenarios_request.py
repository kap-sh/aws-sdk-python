...
class ListBillScenariosRequest(TypedDict, closed=True):
    filters: NotRequired[
...
def serialize_aws_json_1_0(value: ListBillScenariosRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            capo_bcm_pricing_calculator.types.list_bill_scenarios_filters.serialize_aws_json_1_0(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListBillScenariosRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            capo_bcm_pricing_calculator.types.list_bill_scenarios_filters.deserialize_aws_json_1_0(
                data["filters"]
            )
        )
