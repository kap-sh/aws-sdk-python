...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.delete_bill_estimate_response.DeleteBillEstimateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.delete_bill_estimate_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
