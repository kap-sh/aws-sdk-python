"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#BatchUpdateWorkloadEstimateUsage``."""
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.batch_update_workload_estimate_usage_response.BatchUpdateWorkloadEstimateUsageResponse = capo_bcm_pricing_calculator.types.batch_update_workload_estimate_usage_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBCMPricingCalculator.BatchUpdateWorkloadEstimateUsage"
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.batch_update_workload_estimate_usage_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_batch_update_workload_estimate_usage(
