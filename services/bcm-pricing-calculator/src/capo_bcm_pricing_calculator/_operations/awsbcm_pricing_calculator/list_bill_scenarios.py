"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#ListBillScenarios``."""
...
import capo_bcm_pricing_calculator.types.bill_scenario_summaries
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.list_bill_scenarios_response.ListBillScenariosResponse = capo_bcm_pricing_calculator.types.list_bill_scenarios_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBCMPricingCalculator.ListBillScenarios"
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.list_bill_scenarios_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_bill_scenarios(
