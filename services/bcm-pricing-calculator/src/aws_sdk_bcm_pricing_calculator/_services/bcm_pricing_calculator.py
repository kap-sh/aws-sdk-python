...
from aws_sdk_bcm_pricing_calculator._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class BCMPricingCalculatorClient:
    ...
    def __init__(self, http_handler: BaseHandler | None = None, operation_interceptors: Iterable[Interceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, use_fips: bool | None = None, endpoint: str | None = None, region: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = BCMPricingCalculatorClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "use_fips": use_fips, "endpoint": endpoint, "region": region, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[BCMPricingCalculatorClientConfig] = None) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
    ...
    def get_preferences(self, *, config_overrides: Optional[BCMPricingCalculatorClientConfig] = None) -> "aws_sdk_bcm_pricing_calculator.types.get_preferences_response.GetPreferencesResponse":
        """<p> Retrieves the current preferences for Pricing Calculator. </p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_bcm_pricing_calculator.types.get_preferences_request.GetPreferencesRequest]') -> OperationResponse["aws_sdk_bcm_pricing_calculator.types.get_preferences_response.GetPreferencesResponse"]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.get_preferences
            output, http_response = aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.get_preferences.get_preferences(req.options, req.input)
    ...
    def list_tags_for_resource(self, arn: "aws_sdk_bcm_pricing_calculator.types.arn.Arn", *, config_overrides: Optional[BCMPricingCalculatorClientConfig] = None) -> "aws_sdk_bcm_pricing_calculator.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bcm_pricing_calculator.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> OperationResponse["aws_sdk_bcm_pricing_calculator.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.list_tags_for_resource
            output, http_response = aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def tag_resource(self, arn: "aws_sdk_bcm_pricing_calculator.types.arn.Arn", tags: "aws_sdk_bcm_pricing_calculator.types.tags.Tags", *, config_overrides: Optional[BCMPricingCalculatorClientConfig] = None) -> "aws_sdk_bcm_pricing_calculator.types.tag_resource_response.TagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bcm_pricing_calculator.types.tag_resource_request.TagResourceRequest]') -> OperationResponse["aws_sdk_bcm_pricing_calculator.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.tag_resource
            output, http_response = aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, arn: "aws_sdk_bcm_pricing_calculator.types.arn.Arn", tag_keys: "aws_sdk_bcm_pricing_calculator.types.resource_tag_keys.ResourceTagKeys", *, config_overrides: Optional[BCMPricingCalculatorClientConfig] = None) -> "aws_sdk_bcm_pricing_calculator.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bcm_pricing_calculator.types.untag_resource_request.UntagResourceRequest]') -> OperationResponse["aws_sdk_bcm_pricing_calculator.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.untag_resource
            output, http_response = aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def update_preferences(self, *, config_overrides: Optional[BCMPricingCalculatorClientConfig] = None, management_account_rate_type_selections: Optional["aws_sdk_bcm_pricing_calculator.types.rate_types.RateTypes"] = None, member_account_rate_type_selections: Optional["aws_sdk_bcm_pricing_calculator.types.rate_types.RateTypes"] = None, standalone_account_rate_type_selections: Optional["aws_sdk_bcm_pricing_calculator.types.rate_types.RateTypes"] = None) -> "aws_sdk_bcm_pricing_calculator.types.update_preferences_response.UpdatePreferencesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bcm_pricing_calculator.types.update_preferences_request.UpdatePreferencesRequest]') -> OperationResponse["aws_sdk_bcm_pricing_calculator.types.update_preferences_response.UpdatePreferencesResponse"]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.update_preferences
            output, http_response = aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.update_preferences.update_preferences(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
