...
if TYPE_CHECKING:
    import aws_sdk_bcm_pricing_calculator.types.list_usage_filter_name
    import aws_sdk_bcm_pricing_calculator.types.list_usage_filter_values
    import aws_sdk_bcm_pricing_calculator.types.match_option


class ListUsageFilter(TypedDict):
    name: "aws_sdk_bcm_pricing_calculator.types.list_usage_filter_name.ListUsageFilterName"
    """<p> The name of the filter attribute. </p>"""
    values: "aws_sdk_bcm_pricing_calculator.types.list_usage_filter_values.ListUsageFilterValues"
...
def serialize_aws_json_1_0(value: ListUsageFilter) -> dict:
    ...
    out["name"] = (
        aws_sdk_bcm_pricing_calculator.types.list_usage_filter_name.serialize_aws_json_1_0(
            value["name"]
        )
    )
    import aws_sdk_bcm_pricing_calculator.types.list_usage_filter_values
    ...
    out["values"] = (
        aws_sdk_bcm_pricing_calculator.types.list_usage_filter_values.serialize_aws_json_1_0(
            value["values"]
        )
    )
...
def deserialize_aws_json_1_0(data: dict) -> ListUsageFilter:
    ...
    if "name" in data:
        ...
        out["name"] = (
            aws_sdk_bcm_pricing_calculator.types.list_usage_filter_name.deserialize_aws_json_1_0(
                data["name"]
            )
        )
    else:
    ...
    if "values" in data:
        ...
        out["values"] = (
            aws_sdk_bcm_pricing_calculator.types.list_usage_filter_values.deserialize_aws_json_1_0(
                data["values"]
            )
        )
    else:
