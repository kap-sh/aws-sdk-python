...
BatchUpdateWorkloadEstimateUsageEntries: TypeAlias = list[
    "aws_sdk_bcm_pricing_calculator.types.batch_update_workload_estimate_usage_entry.BatchUpdateWorkloadEstimateUsageEntry"
]
...
def serialize_aws_json_1_0(value: BatchUpdateWorkloadEstimateUsageEntries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_bcm_pricing_calculator.types.batch_update_workload_estimate_usage_entry.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> BatchUpdateWorkloadEstimateUsageEntries:
    ...
    for item in data:
        out.append(
            aws_sdk_bcm_pricing_calculator.types.batch_update_workload_estimate_usage_entry.deserialize_aws_json_1_0(
                item
            )
        )
    return out
