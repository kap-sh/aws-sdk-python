...
def serialize_aws_json_1_0(value: BatchUpdateWorkloadEstimateUsageRequest) -> dict:
    ...
    out["usage"] = (
        aws_sdk_bcm_pricing_calculator.types.batch_update_workload_estimate_usage_entries.serialize_aws_json_1_0(
            value["usage"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchUpdateWorkloadEstimateUsageRequest:
    ...
    if "usage" in data:
        ...
        out["usage"] = (
            aws_sdk_bcm_pricing_calculator.types.batch_update_workload_estimate_usage_entries.deserialize_aws_json_1_0(
                data["usage"]
            )
        )
    else:
