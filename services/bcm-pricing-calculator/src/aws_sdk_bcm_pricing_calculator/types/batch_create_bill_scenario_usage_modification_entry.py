...
class BatchCreateBillScenarioUsageModificationEntry(TypedDict):
    ...
    amounts: NotRequired[
        "aws_sdk_bcm_pricing_calculator.types.usage_amounts.UsageAmounts"
    ]
...
def serialize_aws_json_1_0(
    ...
    if "amounts" in value:
        ...
        out["amounts"] = (
            aws_sdk_bcm_pricing_calculator.types.usage_amounts.serialize_aws_json_1_0(
                value["amounts"]
            )
        )
...
def deserialize_aws_json_1_0(
    ...
    if "amounts" in data:
        ...
        out["amounts"] = (
            aws_sdk_bcm_pricing_calculator.types.usage_amounts.deserialize_aws_json_1_0(
                data["amounts"]
            )
        )
