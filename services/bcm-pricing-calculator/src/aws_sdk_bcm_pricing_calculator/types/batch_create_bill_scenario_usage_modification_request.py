...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: BatchCreateBillScenarioUsageModificationRequest) -> dict:
    out: dict = {}
    out["billScenarioId"] = value["bill_scenario_id"]
    import aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_entries
    out["usageModifications"] = aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_entries.serialize_aws_json_1_0(value["usage_modifications"])
    return out


def deserialize_aws_json_1_0(data: dict) -> BatchCreateBillScenarioUsageModificationRequest:
    ...
    if "billScenarioId" in data:
        ...
        raise DeserializationError("BatchCreateBillScenarioUsageModificationRequest.bill_scenario_id required")
    if "usageModifications" in data:
        import aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_entries
        out["usage_modifications"] = aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_entries.deserialize_aws_json_1_0(data["usageModifications"])
    else:
        raise DeserializationError("BatchCreateBillScenarioUsageModificationRequest.usage_modifications required")
    return out