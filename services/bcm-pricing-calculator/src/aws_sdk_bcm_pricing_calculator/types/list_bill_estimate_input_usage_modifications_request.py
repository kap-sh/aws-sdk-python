"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#ListBillEstimateInputUsageModificationsRequest``."""
...
class ListBillEstimateInputUsageModificationsRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_0(
    value: ListBillEstimateInputUsageModificationsRequest,
) -> dict:
    out: dict = {}
