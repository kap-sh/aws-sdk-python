...
class ListBillEstimateLineItemsRequest(TypedDict):
    ...
    filters: NotRequired[
        "aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_line_items_filters.ListBillEstimateLineItemsFilters"
    ]
...
def serialize_aws_json_1_0(value: ListBillEstimateLineItemsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_line_items_filters.serialize_aws_json_1_0(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListBillEstimateLineItemsRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_line_items_filters.deserialize_aws_json_1_0(
                data["filters"]
            )
        )
