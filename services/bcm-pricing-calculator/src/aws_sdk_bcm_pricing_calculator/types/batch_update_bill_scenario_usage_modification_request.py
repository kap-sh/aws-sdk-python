...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: BatchUpdateBillScenarioUsageModificationRequest) -> dict:
    out: dict = {}
    out["billScenarioId"] = value["bill_scenario_id"]
    import aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_usage_modification_entries
    out["usageModifications"] = aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_usage_modification_entries.serialize_aws_json_1_0(value["usage_modifications"])
    return out


def deserialize_aws_json_1_0(data: dict) -> BatchUpdateBillScenarioUsageModificationRequest:
    ...
    if "billScenarioId" in data:
        ...
        raise DeserializationError("BatchUpdateBillScenarioUsageModificationRequest.bill_scenario_id required")
    if "usageModifications" in data:
        import aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_usage_modification_entries
        out["usage_modifications"] = aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_usage_modification_entries.deserialize_aws_json_1_0(data["usageModifications"])
    else:
        raise DeserializationError("BatchUpdateBillScenarioUsageModificationRequest.usage_modifications required")
    return out