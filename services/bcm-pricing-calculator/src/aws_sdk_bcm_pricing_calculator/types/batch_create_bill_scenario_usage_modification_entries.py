...
BatchCreateBillScenarioUsageModificationEntries: TypeAlias = list[
    "aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_entry.BatchCreateBillScenarioUsageModificationEntry"
]
...
def serialize_aws_json_1_0(
    ...
    for item in value:
        out.append(
            aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_entry.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(
    ...
    for item in data:
        out.append(
            aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_entry.deserialize_aws_json_1_0(
                item
            )
        )
    return out
