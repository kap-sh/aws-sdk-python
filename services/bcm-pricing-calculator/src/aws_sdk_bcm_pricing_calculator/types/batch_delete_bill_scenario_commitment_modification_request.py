...
def serialize_aws_json_1_0(
    ...
    out["ids"] = (
        aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_entries.serialize_aws_json_1_0(
            value["ids"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(
    ...
    if "ids" in data:
        ...
        out["ids"] = (
            aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_entries.deserialize_aws_json_1_0(
                data["ids"]
            )
        )
    else:
