...
BillEstimateCommitmentSummaries: TypeAlias = list[
    "aws_sdk_bcm_pricing_calculator.types.bill_estimate_commitment_summary.BillEstimateCommitmentSummary"
]
...
def serialize_aws_json_1_0(value: BillEstimateCommitmentSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_bcm_pricing_calculator.types.bill_estimate_commitment_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> BillEstimateCommitmentSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_bcm_pricing_calculator.types.bill_estimate_commitment_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
