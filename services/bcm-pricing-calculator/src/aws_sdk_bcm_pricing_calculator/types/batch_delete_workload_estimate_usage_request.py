...
def serialize_aws_json_1_0(value: BatchDeleteWorkloadEstimateUsageRequest) -> dict:
    ...
    out["ids"] = (
        aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_entries.serialize_aws_json_1_0(
            value["ids"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchDeleteWorkloadEstimateUsageRequest:
    ...
    if "ids" in data:
        ...
        out["ids"] = (
            aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_entries.deserialize_aws_json_1_0(
                data["ids"]
            )
        )
    else:
