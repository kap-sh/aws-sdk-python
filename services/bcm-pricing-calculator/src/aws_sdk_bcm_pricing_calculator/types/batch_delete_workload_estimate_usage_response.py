...
class BatchDeleteWorkloadEstimateUsageResponse(TypedDict):
    errors: NotRequired["aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_errors.BatchDeleteWorkloadEstimateUsageErrors"]
...
def serialize_aws_json_1_0(value: BatchDeleteWorkloadEstimateUsageResponse) -> dict:
    ...
    if "errors" in value:
        import aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_errors
        out["errors"] = aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_errors.serialize_aws_json_1_0(value["errors"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchDeleteWorkloadEstimateUsageResponse:
    ...
    if "errors" in data:
        import aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_errors
        out["errors"] = aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_errors.deserialize_aws_json_1_0(data["errors"])
    return out