...
class ListWorkloadEstimatesRequest(TypedDict):
    ...
    filters: NotRequired[
        "aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_filters.ListWorkloadEstimatesFilters"
    ]
...
def serialize_aws_json_1_0(value: ListWorkloadEstimatesRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_filters.serialize_aws_json_1_0(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListWorkloadEstimatesRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_filters.deserialize_aws_json_1_0(
                data["filters"]
            )
        )
