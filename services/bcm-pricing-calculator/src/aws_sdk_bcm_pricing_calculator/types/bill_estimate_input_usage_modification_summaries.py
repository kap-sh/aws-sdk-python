...
BillEstimateInputUsageModificationSummaries: TypeAlias = list[
    "aws_sdk_bcm_pricing_calculator.types.bill_estimate_input_usage_modification_summary.BillEstimateInputUsageModificationSummary"
]
...
def serialize_aws_json_1_0(value: BillEstimateInputUsageModificationSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_bcm_pricing_calculator.types.bill_estimate_input_usage_modification_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> BillEstimateInputUsageModificationSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_bcm_pricing_calculator.types.bill_estimate_input_usage_modification_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
