...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: BatchDeleteBillScenarioUsageModificationRequest) -> dict:
    out: dict = {}
    out["billScenarioId"] = value["bill_scenario_id"]
    import aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_usage_modification_entries
    out["ids"] = aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_usage_modification_entries.serialize_aws_json_1_0(value["ids"])
    return out


def deserialize_aws_json_1_0(data: dict) -> BatchDeleteBillScenarioUsageModificationRequest:
    ...
    if "billScenarioId" in data:
        ...
        raise DeserializationError("BatchDeleteBillScenarioUsageModificationRequest.bill_scenario_id required")
    if "ids" in data:
        import aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_usage_modification_entries
        out["ids"] = aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_usage_modification_entries.deserialize_aws_json_1_0(data["ids"])
    else:
        raise DeserializationError("BatchDeleteBillScenarioUsageModificationRequest.ids required")
    return out