...
class BatchCreateWorkloadEstimateUsageRequest(TypedDict):
...
def serialize_aws_json_1_0(value: BatchCreateWorkloadEstimateUsageRequest) -> dict:
    ...
    import aws_sdk_bcm_pricing_calculator.types.batch_create_workload_estimate_usage_entries
    out["usage"] = aws_sdk_bcm_pricing_calculator.types.batch_create_workload_estimate_usage_entries.serialize_aws_json_1_0(value["usage"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchCreateWorkloadEstimateUsageRequest:
    ...
    if "workloadEstimateId" in data:
        ...
        raise DeserializationError("BatchCreateWorkloadEstimateUsageRequest.workload_estimate_id required")
    if "usage" in data:
        import aws_sdk_bcm_pricing_calculator.types.batch_create_workload_estimate_usage_entries
        out["usage"] = aws_sdk_bcm_pricing_calculator.types.batch_create_workload_estimate_usage_entries.deserialize_aws_json_1_0(data["usage"])
    else:
        raise DeserializationError("BatchCreateWorkloadEstimateUsageRequest.usage required")
    return out