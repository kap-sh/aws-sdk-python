...
if TYPE_CHECKING:
    import aws_sdk_bcm_pricing_calculator.types.bill_estimate_commitment_summaries
    import aws_sdk_bcm_pricing_calculator.types.next_page_token


class ListBillEstimateCommitmentsResponse(TypedDict):
    items: NotRequired[
        "aws_sdk_bcm_pricing_calculator.types.bill_estimate_commitment_summaries.BillEstimateCommitmentSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListBillEstimateCommitmentsResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            aws_sdk_bcm_pricing_calculator.types.bill_estimate_commitment_summaries.serialize_aws_json_1_0(
                value["items"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListBillEstimateCommitmentsResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_bcm_pricing_calculator.types.bill_estimate_commitment_summaries.deserialize_aws_json_1_0(
                data["items"]
            )
        )
