...
class BatchUpdateBillScenarioCommitmentModificationResponse(TypedDict, closed=True):
    ...
    errors: NotRequired[
        "aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_errors.BatchUpdateBillScenarioCommitmentModificationErrors"
    ]
...
def serialize_aws_json_1_0(
    ...
    if "errors" in value:
        ...
        out["errors"] = (
            aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_errors.serialize_aws_json_1_0(
                value["errors"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(
    ...
    if "errors" in data:
        ...
        out["errors"] = (
            aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_errors.deserialize_aws_json_1_0(
                data["errors"]
            )
        )
    return out
