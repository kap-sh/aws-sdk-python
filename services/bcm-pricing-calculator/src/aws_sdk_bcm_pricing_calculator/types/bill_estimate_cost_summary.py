...
class BillEstimateCostSummary(TypedDict):
    ...
    service_cost_differences: NotRequired[
        "aws_sdk_bcm_pricing_calculator.types.service_cost_difference_map.ServiceCostDifferenceMap"
    ]
...
def serialize_aws_json_1_0(value: BillEstimateCostSummary) -> dict:
    ...
    if "service_cost_differences" in value:
        ...
        out["serviceCostDifferences"] = (
            aws_sdk_bcm_pricing_calculator.types.service_cost_difference_map.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> BillEstimateCostSummary:
    ...
    if "serviceCostDifferences" in data:
        ...
        out["service_cost_differences"] = (
            aws_sdk_bcm_pricing_calculator.types.service_cost_difference_map.deserialize_aws_json_1_0(
