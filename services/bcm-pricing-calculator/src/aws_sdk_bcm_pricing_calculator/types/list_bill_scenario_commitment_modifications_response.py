...
def serialize_aws_json_1_0(
    ...
    if "items" in value:
        ...
        out["items"] = (
            aws_sdk_bcm_pricing_calculator.types.bill_scenario_commitment_modification_items.serialize_aws_json_1_0(
                value["items"]
            )
        )
...
def deserialize_aws_json_1_0(
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_bcm_pricing_calculator.types.bill_scenario_commitment_modification_items.deserialize_aws_json_1_0(
                data["items"]
            )
        )
