...
BatchCreateWorkloadEstimateUsageCode: TypeAlias = Literal["BAD_REQUEST", "NOT_FOUND", "CONFLICT", "INTERNAL_SERVER_ERROR",]
...
def deserialize_aws_json_1_0(data: str) -> BatchCreateWorkloadEstimateUsageCode:
    if data not in _VALUES:
        raise DeserializationError(f"unknown BatchCreateWorkloadEstimateUsageCode value: {data!r}")
