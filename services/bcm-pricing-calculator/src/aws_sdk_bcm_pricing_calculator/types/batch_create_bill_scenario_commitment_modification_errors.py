...
BatchCreateBillScenarioCommitmentModificationErrors: TypeAlias = list[
    "aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_commitment_modification_error.BatchCreateBillScenarioCommitmentModificationError"
]
...
def serialize_aws_json_1_0(
    ...
    for item in value:
        out.append(
            aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_commitment_modification_error.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(
    ...
    for item in data:
        out.append(
            aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_commitment_modification_error.deserialize_aws_json_1_0(
                item
            )
        )
    return out
