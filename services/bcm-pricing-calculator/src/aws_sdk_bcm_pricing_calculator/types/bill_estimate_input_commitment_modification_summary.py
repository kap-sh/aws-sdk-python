...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: BillEstimateInputCommitmentModificationSummary) -> dict:
    out: dict = {}
    if "id" in value:
        out["id"] = value["id"]
    if "group" in value:
...
def deserialize_aws_json_1_0(data: dict) -> BillEstimateInputCommitmentModificationSummary:
