...
class BatchUpdateBillScenarioCommitmentModificationEntry(TypedDict):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: BatchUpdateBillScenarioCommitmentModificationEntry) -> dict:
    out: dict = {}
    out["id"] = value["id"]
    if "group" in value:
...
def deserialize_aws_json_1_0(data: dict) -> BatchUpdateBillScenarioCommitmentModificationEntry:
    out: BatchUpdateBillScenarioCommitmentModificationEntry = {}  # type: ignore[typeddict-item]
    if "id" in data:
        out["id"] = data["id"]
    else:
        raise DeserializationError("BatchUpdateBillScenarioCommitmentModificationEntry.id required")
    if "group" in data:
