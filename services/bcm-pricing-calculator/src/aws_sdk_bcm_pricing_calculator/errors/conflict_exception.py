"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bcmpricingcalculator#ConflictException``."""
