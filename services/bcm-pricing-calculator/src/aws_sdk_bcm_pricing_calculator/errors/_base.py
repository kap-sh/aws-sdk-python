...
class BCMPricingCalculatorError(Exception):
    """Base class for all BCMPricingCalculator service errors."""

class ServiceError(BCMPricingCalculatorError):
...
class SerializationError(BCMPricingCalculatorError):
    """Raised when a value cannot be serialized."""

class DeserializationError(BCMPricingCalculatorError):
...
class WaiterFailedError(BCMPricingCalculatorError):
...
class WaiterTimeoutError(BCMPricingCalculatorError):
