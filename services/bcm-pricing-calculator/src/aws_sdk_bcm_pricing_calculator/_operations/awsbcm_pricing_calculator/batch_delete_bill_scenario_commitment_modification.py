...
def build_request(
    ...
    input: aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_request.BatchDeleteBillScenarioCommitmentModificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
