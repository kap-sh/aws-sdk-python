...
) -> aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_response.BatchDeleteBillScenarioCommitmentModificationResponse:
    out: aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_response.BatchDeleteBillScenarioCommitmentModificationResponse = aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_request.BatchDeleteBillScenarioCommitmentModificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
