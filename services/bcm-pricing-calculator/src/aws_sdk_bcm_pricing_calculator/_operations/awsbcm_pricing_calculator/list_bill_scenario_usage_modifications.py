...
) -> aws_sdk_bcm_pricing_calculator.types.list_bill_scenario_usage_modifications_response.ListBillScenarioUsageModificationsResponse:
    out: aws_sdk_bcm_pricing_calculator.types.list_bill_scenario_usage_modifications_response.ListBillScenarioUsageModificationsResponse = aws_sdk_bcm_pricing_calculator.types.list_bill_scenario_usage_modifications_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.list_bill_scenario_usage_modifications_request.ListBillScenarioUsageModificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
