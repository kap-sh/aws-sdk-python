...
def handle_response(
    ...
    out: aws_sdk_bcm_pricing_calculator.types.get_preferences_response.GetPreferencesResponse = aws_sdk_bcm_pricing_calculator.types.get_preferences_response.deserialize_aws_json_1_0(
