...
) -> aws_sdk_bcm_pricing_calculator.types.delete_bill_estimate_response.DeleteBillEstimateResponse:
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.delete_bill_estimate_request.DeleteBillEstimateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_bill_estimate(
