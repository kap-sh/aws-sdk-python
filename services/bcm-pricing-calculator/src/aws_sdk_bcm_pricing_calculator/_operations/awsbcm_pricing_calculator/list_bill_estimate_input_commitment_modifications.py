...
import aws_sdk_bcm_pricing_calculator.types.bill_estimate_input_commitment_modification_summaries
...
) -> aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_commitment_modifications_response.ListBillEstimateInputCommitmentModificationsResponse:
    out: aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_commitment_modifications_response.ListBillEstimateInputCommitmentModificationsResponse = aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_commitment_modifications_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_commitment_modifications_request.ListBillEstimateInputCommitmentModificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_commitment_modifications_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_bill_estimate_input_commitment_modifications(
