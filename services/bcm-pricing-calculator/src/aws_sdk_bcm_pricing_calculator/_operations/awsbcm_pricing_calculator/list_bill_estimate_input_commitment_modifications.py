...
def build_request(
    ...
    input: aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_commitment_modifications_request.ListBillEstimateInputCommitmentModificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
