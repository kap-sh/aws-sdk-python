...
) -> aws_sdk_bcm_pricing_calculator.types.batch_create_workload_estimate_usage_response.BatchCreateWorkloadEstimateUsageResponse:
    out: aws_sdk_bcm_pricing_calculator.types.batch_create_workload_estimate_usage_response.BatchCreateWorkloadEstimateUsageResponse = aws_sdk_bcm_pricing_calculator.types.batch_create_workload_estimate_usage_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.batch_create_workload_estimate_usage_request.BatchCreateWorkloadEstimateUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
