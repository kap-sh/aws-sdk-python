...
import aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_line_items_filters
...
) -> aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_line_items_response.ListBillEstimateLineItemsResponse:
    out: aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_line_items_response.ListBillEstimateLineItemsResponse = aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_line_items_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_line_items_request.ListBillEstimateLineItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_line_items_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
