...
def handle_response(
    ...
    out: aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_commitment_modification_response.BatchCreateBillScenarioCommitmentModificationResponse = aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_commitment_modification_response.deserialize_aws_json_1_0(
