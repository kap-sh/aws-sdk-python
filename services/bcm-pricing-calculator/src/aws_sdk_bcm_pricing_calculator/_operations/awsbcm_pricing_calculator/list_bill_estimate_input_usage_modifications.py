...
) -> aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_usage_modifications_response.ListBillEstimateInputUsageModificationsResponse:
    out: aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_usage_modifications_response.ListBillEstimateInputUsageModificationsResponse = aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_usage_modifications_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_usage_modifications_request.ListBillEstimateInputUsageModificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_input_usage_modifications_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
