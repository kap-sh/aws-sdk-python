...
) -> aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_response.BatchDeleteWorkloadEstimateUsageResponse:
    out: aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_response.BatchDeleteWorkloadEstimateUsageResponse = aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_request.BatchDeleteWorkloadEstimateUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
