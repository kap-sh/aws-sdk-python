...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.untag_resource_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
