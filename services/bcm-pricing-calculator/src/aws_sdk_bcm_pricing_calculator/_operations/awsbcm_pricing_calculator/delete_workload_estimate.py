...
) -> aws_sdk_bcm_pricing_calculator.types.delete_workload_estimate_response.DeleteWorkloadEstimateResponse:
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.delete_workload_estimate_request.DeleteWorkloadEstimateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.delete_workload_estimate_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_workload_estimate(
