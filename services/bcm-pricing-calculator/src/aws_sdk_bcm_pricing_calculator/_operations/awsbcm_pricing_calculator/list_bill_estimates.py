...
def handle_response(
    ...
    out: aws_sdk_bcm_pricing_calculator.types.list_bill_estimates_response.ListBillEstimatesResponse = aws_sdk_bcm_pricing_calculator.types.list_bill_estimates_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.list_bill_estimates_request.ListBillEstimatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.list_bill_estimates_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
