...
def handle_response(
    ...
    out: aws_sdk_bcm_pricing_calculator.types.update_preferences_response.UpdatePreferencesResponse = aws_sdk_bcm_pricing_calculator.types.update_preferences_response.deserialize_aws_json_1_0(
