...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            ...
            raise aws_sdk_bcm_pricing_calculator.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
        case _:
...
) -> aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_usage_modification_response.BatchDeleteBillScenarioUsageModificationResponse:
    import aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_usage_modification_response

    out: aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_usage_modification_response.BatchDeleteBillScenarioUsageModificationResponse = aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_usage_modification_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_usage_modification_request.BatchDeleteBillScenarioUsageModificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.batch_delete_bill_scenario_usage_modification_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_batch_delete_bill_scenario_usage_modification(
