...
) -> aws_sdk_bcm_pricing_calculator.types.list_bill_scenario_commitment_modifications_response.ListBillScenarioCommitmentModificationsResponse:
    import aws_sdk_bcm_pricing_calculator.types.list_bill_scenario_commitment_modifications_response

    out: aws_sdk_bcm_pricing_calculator.types.list_bill_scenario_commitment_modifications_response.ListBillScenarioCommitmentModificationsResponse = aws_sdk_bcm_pricing_calculator.types.list_bill_scenario_commitment_modifications_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.list_bill_scenario_commitment_modifications_request.ListBillScenarioCommitmentModificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.list_bill_scenario_commitment_modifications_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
