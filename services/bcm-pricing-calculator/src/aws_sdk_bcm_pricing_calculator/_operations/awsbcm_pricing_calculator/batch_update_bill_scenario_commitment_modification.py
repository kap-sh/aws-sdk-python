...
) -> aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_response.BatchUpdateBillScenarioCommitmentModificationResponse:
    import aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_response

    out: aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_response.BatchUpdateBillScenarioCommitmentModificationResponse = aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_request.BatchUpdateBillScenarioCommitmentModificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_batch_update_bill_scenario_commitment_modification(
