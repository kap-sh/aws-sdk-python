...
def build_request(
    ...
    input: aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_request.BatchUpdateBillScenarioCommitmentModificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
