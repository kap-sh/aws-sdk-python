...
) -> aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_commitments_response.ListBillEstimateCommitmentsResponse:
    out: aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_commitments_response.ListBillEstimateCommitmentsResponse = aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_commitments_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_commitments_request.ListBillEstimateCommitmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.list_bill_estimate_commitments_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
