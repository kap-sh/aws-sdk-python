...
) -> aws_sdk_bcm_pricing_calculator.types.list_workload_estimate_usage_response.ListWorkloadEstimateUsageResponse:
    out: aws_sdk_bcm_pricing_calculator.types.list_workload_estimate_usage_response.ListWorkloadEstimateUsageResponse = aws_sdk_bcm_pricing_calculator.types.list_workload_estimate_usage_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.list_workload_estimate_usage_request.ListWorkloadEstimateUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.list_workload_estimate_usage_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
