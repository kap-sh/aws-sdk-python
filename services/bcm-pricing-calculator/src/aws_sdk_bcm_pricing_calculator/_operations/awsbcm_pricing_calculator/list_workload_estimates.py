...
def handle_response(
    ...
    out: aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_response.ListWorkloadEstimatesResponse = aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_request.ListWorkloadEstimatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
