...
) -> aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_usage_modification_response.BatchUpdateBillScenarioUsageModificationResponse:
    out: aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_usage_modification_response.BatchUpdateBillScenarioUsageModificationResponse = aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_usage_modification_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_usage_modification_request.BatchUpdateBillScenarioUsageModificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.batch_update_bill_scenario_usage_modification_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
