...
) -> aws_sdk_bcm_pricing_calculator.types.create_bill_estimate_response.CreateBillEstimateResponse:
    out: aws_sdk_bcm_pricing_calculator.types.create_bill_estimate_response.CreateBillEstimateResponse = aws_sdk_bcm_pricing_calculator.types.create_bill_estimate_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.create_bill_estimate_request.CreateBillEstimateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_bill_estimate(
