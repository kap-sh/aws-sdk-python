...
) -> aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_response.BatchCreateBillScenarioUsageModificationResponse:
    out: aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_response.BatchCreateBillScenarioUsageModificationResponse = aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_request.BatchCreateBillScenarioUsageModificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
