...
) -> aws_sdk_bcm_pricing_calculator.types.get_workload_estimate_response.GetWorkloadEstimateResponse:
    import aws_sdk_bcm_pricing_calculator.types.get_workload_estimate_response

    out: aws_sdk_bcm_pricing_calculator.types.get_workload_estimate_response.GetWorkloadEstimateResponse = aws_sdk_bcm_pricing_calculator.types.get_workload_estimate_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.get_workload_estimate_request.GetWorkloadEstimateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.get_workload_estimate_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_workload_estimate(
