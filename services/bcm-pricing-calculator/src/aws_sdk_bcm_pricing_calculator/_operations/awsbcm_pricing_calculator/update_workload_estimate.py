...
) -> aws_sdk_bcm_pricing_calculator.types.update_workload_estimate_response.UpdateWorkloadEstimateResponse:
    out: aws_sdk_bcm_pricing_calculator.types.update_workload_estimate_response.UpdateWorkloadEstimateResponse = aws_sdk_bcm_pricing_calculator.types.update_workload_estimate_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.update_workload_estimate_request.UpdateWorkloadEstimateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.update_workload_estimate_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_workload_estimate(
