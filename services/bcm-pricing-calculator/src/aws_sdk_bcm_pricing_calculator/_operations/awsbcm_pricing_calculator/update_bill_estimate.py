...
) -> aws_sdk_bcm_pricing_calculator.types.update_bill_estimate_response.UpdateBillEstimateResponse:
    out: aws_sdk_bcm_pricing_calculator.types.update_bill_estimate_response.UpdateBillEstimateResponse = aws_sdk_bcm_pricing_calculator.types.update_bill_estimate_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_bcm_pricing_calculator.types.update_bill_estimate_request.UpdateBillEstimateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_pricing_calculator.types.update_bill_estimate_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_bill_estimate(
