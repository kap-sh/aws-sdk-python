...
class BillEstimate:
    ...
    def create(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bcm_pricing_calculator.types.create_bill_estimate_request.CreateBillEstimateRequest]",
        ) -> OperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.create_bill_estimate_response.CreateBillEstimateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.create_bill_estimate.create_bill_estimate(
    ...
    def read(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bcm_pricing_calculator.types.get_bill_estimate_request.GetBillEstimateRequest]",
        ) -> OperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.get_bill_estimate_response.GetBillEstimateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.get_bill_estimate.get_bill_estimate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bcm_pricing_calculator.types.update_bill_estimate_request.UpdateBillEstimateRequest]",
        ) -> OperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.update_bill_estimate_response.UpdateBillEstimateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.update_bill_estimate.update_bill_estimate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bcm_pricing_calculator.types.delete_bill_estimate_request.DeleteBillEstimateRequest]",
        ) -> OperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.delete_bill_estimate_response.DeleteBillEstimateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.delete_bill_estimate.delete_bill_estimate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_bcm_pricing_calculator.types.list_bill_estimates_response.ListBillEstimatesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bcm_pricing_calculator.types.list_bill_estimates_request.ListBillEstimatesRequest]",
        ) -> OperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.list_bill_estimates_response.ListBillEstimatesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.list_bill_estimates.list_bill_estimates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncBillEstimate:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_pricing_calculator.types.create_bill_estimate_request.CreateBillEstimateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.create_bill_estimate_response.CreateBillEstimateResponse"
        ]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.create_bill_estimate
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.create_bill_estimate.async_create_bill_estimate(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_pricing_calculator.types.get_bill_estimate_request.GetBillEstimateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.get_bill_estimate_response.GetBillEstimateResponse"
        ]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.get_bill_estimate
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.get_bill_estimate.async_get_bill_estimate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_pricing_calculator.types.update_bill_estimate_request.UpdateBillEstimateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.update_bill_estimate_response.UpdateBillEstimateResponse"
        ]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.update_bill_estimate
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.update_bill_estimate.async_update_bill_estimate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_pricing_calculator.types.delete_bill_estimate_request.DeleteBillEstimateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.delete_bill_estimate_response.DeleteBillEstimateResponse"
        ]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.delete_bill_estimate
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.delete_bill_estimate.async_delete_bill_estimate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_pricing_calculator.types.list_bill_estimates_request.ListBillEstimatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.list_bill_estimates_response.ListBillEstimatesResponse"
        ]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.list_bill_estimates
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.list_bill_estimates.async_list_bill_estimates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
