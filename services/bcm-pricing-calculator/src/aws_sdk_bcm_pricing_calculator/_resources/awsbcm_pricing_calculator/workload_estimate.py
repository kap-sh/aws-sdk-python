...
class WorkloadEstimate:
    ...
    def create(
        ...
        *,
    ...
    ) -> "aws_sdk_bcm_pricing_calculator.types.create_workload_estimate_response.CreateWorkloadEstimateResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bcm_pricing_calculator.types.create_workload_estimate_request.CreateWorkloadEstimateRequest]",
        ) -> OperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.create_workload_estimate_response.CreateWorkloadEstimateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.create_workload_estimate.create_workload_estimate(
    ...
    def read(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bcm_pricing_calculator.types.get_workload_estimate_request.GetWorkloadEstimateRequest]",
        ) -> OperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.get_workload_estimate_response.GetWorkloadEstimateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.get_workload_estimate.get_workload_estimate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bcm_pricing_calculator.types.update_workload_estimate_request.UpdateWorkloadEstimateRequest]",
        ) -> OperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.update_workload_estimate_response.UpdateWorkloadEstimateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.update_workload_estimate.update_workload_estimate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bcm_pricing_calculator.types.delete_workload_estimate_request.DeleteWorkloadEstimateRequest]",
        ) -> OperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.delete_workload_estimate_response.DeleteWorkloadEstimateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.delete_workload_estimate.delete_workload_estimate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_response.ListWorkloadEstimatesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_request.ListWorkloadEstimatesRequest]",
        ) -> OperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_response.ListWorkloadEstimatesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.list_workload_estimates.list_workload_estimates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncWorkloadEstimate:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_pricing_calculator.types.create_workload_estimate_request.CreateWorkloadEstimateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.create_workload_estimate_response.CreateWorkloadEstimateResponse"
        ]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.create_workload_estimate
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.create_workload_estimate.async_create_workload_estimate(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_pricing_calculator.types.get_workload_estimate_request.GetWorkloadEstimateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.get_workload_estimate_response.GetWorkloadEstimateResponse"
        ]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.get_workload_estimate
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.get_workload_estimate.async_get_workload_estimate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_pricing_calculator.types.update_workload_estimate_request.UpdateWorkloadEstimateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.update_workload_estimate_response.UpdateWorkloadEstimateResponse"
        ]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.update_workload_estimate
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.update_workload_estimate.async_update_workload_estimate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_pricing_calculator.types.delete_workload_estimate_request.DeleteWorkloadEstimateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.delete_workload_estimate_response.DeleteWorkloadEstimateResponse"
        ]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.delete_workload_estimate
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.delete_workload_estimate.async_delete_workload_estimate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_request.ListWorkloadEstimatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_pricing_calculator.types.list_workload_estimates_response.ListWorkloadEstimatesResponse"
        ]:
            import aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.list_workload_estimates
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_pricing_calculator._operations.awsbcm_pricing_calculator.list_workload_estimates.async_list_workload_estimates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
