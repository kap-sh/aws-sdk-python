"""Generated from Smithy shape ``com.amazonaws.route53#InvalidArgument``."""
...
class InvalidArgument_(TypedDict, closed=True):
...
class InvalidArgument(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.route53#InvalidArgument``."""

    code: str | None = "InvalidArgument"

    def __init__(self, data: InvalidArgument_, message: str | None = None):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_xml(cls, el: Element, message: str | None = None) -> "InvalidArgument":
