...
if TYPE_CHECKING:
    import capo_route_53.types.hosted_zone_summary

HostedZoneSummaries: TypeAlias = list[
    "capo_route_53.types.hosted_zone_summary.HostedZoneSummary"
]
...
def serialize_xml(value: HostedZoneSummaries, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_route_53.types.hosted_zone_summary.serialize_xml(
...
def deserialize_xml(el: Element) -> HostedZoneSummaries:
    ...
    for child in el.findall("HostedZoneSummary"):
        out.append(capo_route_53.types.hosted_zone_summary.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: HostedZoneSummaries, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_route_53.types.hosted_zone_summary.serialize_xml(item, parent, tag)
