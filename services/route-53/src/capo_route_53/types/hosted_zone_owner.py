...
if TYPE_CHECKING:
    import capo_route_53.types.aws_account_id
    import capo_route_53.types.hosted_zone_owning_service


class HostedZoneOwner(TypedDict, closed=True):
    owning_account: NotRequired["capo_route_53.types.aws_account_id.AWSAccountID"]
    ...
    owning_service: NotRequired[
        "capo_route_53.types.hosted_zone_owning_service.HostedZoneOwningService"
    ]
