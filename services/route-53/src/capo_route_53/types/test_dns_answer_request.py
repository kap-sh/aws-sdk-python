...
class TestDNSAnswerRequest(TypedDict, closed=True):
    ...
    resolver_ip: NotRequired["capo_route_53.types.ip_address.IPAddress"]
    ...
    edns0_client_subnet_ip: NotRequired["capo_route_53.types.ip_address.IPAddress"]
    ...
    edns0_client_subnet_mask: NotRequired["capo_route_53.types.subnet_mask.SubnetMask"]
