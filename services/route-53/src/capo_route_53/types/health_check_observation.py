...
if TYPE_CHECKING:
    ...
    import capo_route_53.types.status_report


class HealthCheckObservation(TypedDict, closed=True):
    region: NotRequired["capo_route_53.types.health_check_region.HealthCheckRegion"]
    ...
    status_report: NotRequired["capo_route_53.types.status_report.StatusReport"]
...
def serialize_xml(value: HealthCheckObservation, parent: Element, tag: str) -> None:
    ...
    if "region" in value:
        ...
        capo_route_53.types.health_check_region.serialize_xml(
    ...
    if "status_report" in value:
        ...
        capo_route_53.types.status_report.serialize_xml(
...
def deserialize_xml(el: Element) -> HealthCheckObservation:
    ...
    if child_region is not None:
        ...
        out["region"] = capo_route_53.types.health_check_region.deserialize_xml(
            child_region
        )
    ...
    if child_status_report is not None:
        ...
        out["status_report"] = capo_route_53.types.status_report.deserialize_xml(
            child_status_report
        )
    return out
