...
if TYPE_CHECKING:
    import capo_route_53.types.alias_target
    import capo_route_53.types.cidr_routing_config
    import capo_route_53.types.dns_name
    import capo_route_53.types.geo_location
    import capo_route_53.types.geo_proximity_location
    import capo_route_53.types.health_check_id
    import capo_route_53.types.resource_record_set_failover
    import capo_route_53.types.resource_record_set_identifier
    import capo_route_53.types.resource_record_set_multi_value_answer
    import capo_route_53.types.resource_record_set_region
    import capo_route_53.types.resource_record_set_weight
    import capo_route_53.types.resource_records
...
class ResourceRecordSet(TypedDict, closed=True):
    ...
    weight: NotRequired[
        "capo_route_53.types.resource_record_set_weight.ResourceRecordSetWeight"
    ]
    ...
    region: NotRequired[
        "capo_route_53.types.resource_record_set_region.ResourceRecordSetRegion"
    ]
    ...
    geo_location: NotRequired["capo_route_53.types.geo_location.GeoLocation"]
    ...
    failover: NotRequired[
        "capo_route_53.types.resource_record_set_failover.ResourceRecordSetFailover"
    ]
    ...
    multi_value_answer: NotRequired[
        "capo_route_53.types.resource_record_set_multi_value_answer.ResourceRecordSetMultiValueAnswer"
    ]
    ...
    ttl: NotRequired["capo_route_53.types.ttl.TTL"]
    ...
    resource_records: NotRequired[
        "capo_route_53.types.resource_records.ResourceRecords"
    ]
    ...
    alias_target: NotRequired["capo_route_53.types.alias_target.AliasTarget"]
    ...
    health_check_id: NotRequired["capo_route_53.types.health_check_id.HealthCheckId"]
    ...
    traffic_policy_instance_id: NotRequired[
        "capo_route_53.types.traffic_policy_instance_id.TrafficPolicyInstanceId"
    ]
    ...
    cidr_routing_config: NotRequired[
        "capo_route_53.types.cidr_routing_config.CidrRoutingConfig"
    ]
    geo_proximity_location: NotRequired[
        "capo_route_53.types.geo_proximity_location.GeoProximityLocation"
    ]
...
def serialize_xml(value: ResourceRecordSet, parent: Element, tag: str) -> None:
    ...
    if "region" in value:
        ...
        capo_route_53.types.resource_record_set_region.serialize_xml(
            value["region"], el, "Region"
        )
    if "geo_location" in value:
        import capo_route_53.types.geo_location

        capo_route_53.types.geo_location.serialize_xml(
            value["geo_location"], el, "GeoLocation"
        )
    if "failover" in value:
        import capo_route_53.types.resource_record_set_failover

        capo_route_53.types.resource_record_set_failover.serialize_xml(
    ...
    if "resource_records" in value:
        ...
        capo_route_53.types.resource_records.serialize_xml(
            value["resource_records"], el, "ResourceRecords"
        )
    if "alias_target" in value:
        import capo_route_53.types.alias_target

        capo_route_53.types.alias_target.serialize_xml(
    ...
    if "cidr_routing_config" in value:
        ...
        capo_route_53.types.cidr_routing_config.serialize_xml(
            value["cidr_routing_config"], el, "CidrRoutingConfig"
        )
    if "geo_proximity_location" in value:
        import capo_route_53.types.geo_proximity_location

        capo_route_53.types.geo_proximity_location.serialize_xml(
...
def deserialize_xml(el: Element) -> ResourceRecordSet:
    ...
    if child_region is not None:
        ...
        out["region"] = capo_route_53.types.resource_record_set_region.deserialize_xml(
            child_region
        )
    ...
    if child_geo_location is not None:
        ...
        out["geo_location"] = capo_route_53.types.geo_location.deserialize_xml(
            child_geo_location
        )
    ...
    if child_failover is not None:
        ...
        out["failover"] = (
            capo_route_53.types.resource_record_set_failover.deserialize_xml(
                child_failover
            )
        )
    ...
    if child_resource_records is not None:
        ...
        out["resource_records"] = capo_route_53.types.resource_records.deserialize_xml(
    ...
    if child_alias_target is not None:
        ...
        out["alias_target"] = capo_route_53.types.alias_target.deserialize_xml(
            child_alias_target
        )
    ...
    if child_cidr_routing_config is not None:
        ...
        out["cidr_routing_config"] = (
            capo_route_53.types.cidr_routing_config.deserialize_xml(
    ...
    if child_geo_proximity_location is not None:
        ...
        out["geo_proximity_location"] = (
            capo_route_53.types.geo_proximity_location.deserialize_xml(
