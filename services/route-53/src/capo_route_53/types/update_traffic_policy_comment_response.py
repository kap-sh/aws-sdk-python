"""Generated from Smithy shape ``com.amazonaws.route53#UpdateTrafficPolicyCommentResponse``."""
...
class UpdateTrafficPolicyCommentResponse(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: UpdateTrafficPolicyCommentResponse, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> UpdateTrafficPolicyCommentResponse:
    out: UpdateTrafficPolicyCommentResponse = {}  # type: ignore[typeddict-item]
    ...
    if child_traffic_policy is not None:
        ...
        raise DeserializationError(
            "UpdateTrafficPolicyCommentResponse.traffic_policy required"
        )
    return out
