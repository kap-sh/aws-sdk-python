...
class ListHostedZonesRequest(TypedDict, closed=True):
    ...
    delegation_set_id: NotRequired["capo_route_53.types.resource_id.ResourceId"]
    ...
    hosted_zone_type: NotRequired["capo_route_53.types.hosted_zone_type.HostedZoneType"]
