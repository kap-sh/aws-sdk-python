...
HealthChecks: TypeAlias = list["capo_route_53.types.health_check.HealthCheck"]
...
def serialize_xml(value: HealthChecks, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_route_53.types.health_check.serialize_xml(item, el, "HealthCheck")
...
def deserialize_xml(el: Element) -> HealthChecks:
    ...
    for child in el.findall("HealthCheck"):
        out.append(capo_route_53.types.health_check.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: HealthChecks, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_route_53.types.health_check.serialize_xml(item, parent, tag)
