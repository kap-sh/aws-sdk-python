...
if TYPE_CHECKING:
    import capo_route_53.types.cidr_location_name_default_allowed


class LocationSummary(TypedDict, closed=True):
    location_name: NotRequired[
        "capo_route_53.types.cidr_location_name_default_allowed.CidrLocationNameDefaultAllowed"
    ]
