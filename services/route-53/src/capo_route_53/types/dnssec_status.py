...
if TYPE_CHECKING:
    import capo_route_53.types.serve_signature
    import capo_route_53.types.signing_key_status_message


class DNSSECStatus(TypedDict, closed=True):
    serve_signature: NotRequired["capo_route_53.types.serve_signature.ServeSignature"]
    ...
    status_message: NotRequired[
        "capo_route_53.types.signing_key_status_message.SigningKeyStatusMessage"
    ]
