...
class ListTagsForResourceResponse(TypedDict, closed=True):
    resource_tag_set: "capo_route_53.types.resource_tag_set.ResourceTagSet"
...
def serialize_xml(
    ...
    capo_route_53.types.resource_tag_set.serialize_xml(
...
def deserialize_xml(el: Element) -> ListTagsForResourceResponse:
    ...
    if child_resource_tag_set is not None:
        ...
        out["resource_tag_set"] = capo_route_53.types.resource_tag_set.deserialize_xml(
