...
CidrBlockSummaries: TypeAlias = list[
    "capo_route_53.types.cidr_block_summary.CidrBlockSummary"
]
...
def serialize_xml(value: CidrBlockSummaries, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_route_53.types.cidr_block_summary.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> CidrBlockSummaries:
    ...
    for child in el.findall("member"):
        out.append(capo_route_53.types.cidr_block_summary.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: CidrBlockSummaries, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_route_53.types.cidr_block_summary.serialize_xml(item, parent, tag)
