...
class ResourceTagSet(TypedDict, closed=True):
    resource_type: NotRequired["capo_route_53.types.tag_resource_type.TagResourceType"]
    ...
    resource_id: NotRequired["capo_route_53.types.tag_resource_id.TagResourceId"]
    """<p>The ID for the specified resource.</p>"""
    tags: NotRequired["capo_route_53.types.tag_list.TagList"]
...
def serialize_xml(value: ResourceTagSet, parent: Element, tag: str) -> None:
    ...
    if "resource_type" in value:
        ...
        capo_route_53.types.tag_resource_type.serialize_xml(
    ...
    if "tags" in value:
        ...
        capo_route_53.types.tag_list.serialize_xml(value["tags"], el, "Tags")
...
def deserialize_xml(el: Element) -> ResourceTagSet:
    ...
    if child_resource_type is not None:
        ...
        out["resource_type"] = capo_route_53.types.tag_resource_type.deserialize_xml(
            child_resource_type
        )
    ...
    if child_tags is not None:
        ...
        out["tags"] = capo_route_53.types.tag_list.deserialize_xml(child_tags)
    return out
