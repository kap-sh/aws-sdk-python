...
class ListCidrCollectionsResponse(TypedDict, closed=True):
    ...
    cidr_collections: NotRequired[
        "capo_route_53.types.collection_summaries.CollectionSummaries"
    ]
...
def serialize_xml(
    ...
    if "cidr_collections" in value:
        ...
        capo_route_53.types.collection_summaries.serialize_xml(
...
def deserialize_xml(el: Element) -> ListCidrCollectionsResponse:
    ...
    if child_cidr_collections is not None:
        ...
        out["cidr_collections"] = (
            capo_route_53.types.collection_summaries.deserialize_xml(
