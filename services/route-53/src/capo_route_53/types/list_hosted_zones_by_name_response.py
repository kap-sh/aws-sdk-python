...
class ListHostedZonesByNameResponse(TypedDict, closed=True):
    ...
    next_dns_name: NotRequired["capo_route_53.types.dns_name.DNSName"]
    ...
    next_hosted_zone_id: NotRequired["capo_route_53.types.resource_id.ResourceId"]
