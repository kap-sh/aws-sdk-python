"""Generated from Smithy shape ``com.amazonaws.route53#CreateTrafficPolicyResponse``."""
...
# --- restXml ser/de ---
def serialize_xml(
    value: CreateTrafficPolicyResponse, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> CreateTrafficPolicyResponse:
    ...
    if child_traffic_policy is not None:
        ...
        raise DeserializationError(
            "CreateTrafficPolicyResponse.traffic_policy required"
        )
    return out
