"""Generated from Smithy shape ``com.amazonaws.route53#ListCidrLocations``."""
...
STATUS_CODE_TO_CODE = {400: "InvalidInput", 404: "NoSuchCidrCollectionException"}
...
def handle_response(
    ...
    out: capo_route_53.types.list_cidr_locations_response.ListCidrLocationsResponse = (
        capo_route_53.types.list_cidr_locations_response.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/cidrcollection/{CollectionId}"
...
async def async_list_cidr_locations(
