...
STATUS_CODE_TO_CODE = {400: "InvalidInput", 404: "NoSuchQueryLoggingConfig"}
...
def handle_response(
    ...
    out: capo_route_53.types.get_query_logging_config_response.GetQueryLoggingConfigResponse = capo_route_53.types.get_query_logging_config_response.deserialize_xml(
