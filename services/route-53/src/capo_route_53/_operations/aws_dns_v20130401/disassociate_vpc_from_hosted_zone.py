...
import capo_route_53.errors.last_vpc_association
import capo_route_53.errors.no_such_hosted_zone
import capo_route_53.errors.vpc_association_not_found
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LastVPCAssociation":
            raise capo_route_53.errors.last_vpc_association.LastVPCAssociation.from_xml(
                error_el, message
            )
        ...
        case "VPCAssociationNotFound":
            raise capo_route_53.errors.vpc_association_not_found.VPCAssociationNotFound.from_xml(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_route_53.types.disassociate_vpc_from_hosted_zone_response.DisassociateVPCFromHostedZoneResponse = capo_route_53.types.disassociate_vpc_from_hosted_zone_response.deserialize_xml(
