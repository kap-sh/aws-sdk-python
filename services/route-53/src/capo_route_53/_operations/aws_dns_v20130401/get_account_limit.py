...
def handle_response(
    ...
    out: capo_route_53.types.get_account_limit_response.GetAccountLimitResponse = (
        capo_route_53.types.get_account_limit_response.deserialize_xml(
...
def build_request(
    ...
    url = url.replace(
        "{Type}",
        quote(
            capo_route_53.types.account_limit_type.to_xml_text(input_["type"]), safe=""
        ),
    )
