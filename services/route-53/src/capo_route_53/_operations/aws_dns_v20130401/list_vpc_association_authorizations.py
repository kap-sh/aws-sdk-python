...
def handle_response(
    ...
    out: capo_route_53.types.list_vpc_association_authorizations_response.ListVPCAssociationAuthorizationsResponse = capo_route_53.types.list_vpc_association_authorizations_response.deserialize_xml(
