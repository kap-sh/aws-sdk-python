...
STATUS_CODE_TO_CODE = {400: "InvalidInput", 404: "NoSuchHealthCheck"}
...
def handle_response(
    ...
    out: capo_route_53.types.get_health_check_status_response.GetHealthCheckStatusResponse = capo_route_53.types.get_health_check_status_response.deserialize_xml(
