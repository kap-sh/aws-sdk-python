...
def handle_response(
    ...
    out: capo_route_53.types.activate_key_signing_key_response.ActivateKeySigningKeyResponse = capo_route_53.types.activate_key_signing_key_response.deserialize_xml(
