...
STATUS_CODE_TO_CODE = {404: "NoSuchTrafficPolicyInstance"}
...
def handle_response(
    ...
    out: capo_route_53.types.delete_traffic_policy_instance_response.DeleteTrafficPolicyInstanceResponse = {}  # type: ignore[typeddict-item]
    return out
