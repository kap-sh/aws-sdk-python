"""Generated from Smithy shape ``com.amazonaws.route53#ListTagsForResources``."""
...
import capo_route_53.types.resource_tag_set_list
...
def handle_response(
    ...
    out: capo_route_53.types.list_tags_for_resources_response.ListTagsForResourcesResponse = capo_route_53.types.list_tags_for_resources_response.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/tags/{ResourceType}"
    url = url.replace(
        "{ResourceType}",
        quote(
    ...
    if "resource_ids" in input_:
        capo_route_53.types.tag_resource_id_list.serialize_xml(
