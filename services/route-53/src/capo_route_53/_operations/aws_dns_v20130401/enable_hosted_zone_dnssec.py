...
import capo_route_53.errors.key_signing_key_with_active_status_not_found
...
def handle_response(
    ...
    out: capo_route_53.types.enable_hosted_zone_dnssec_response.EnableHostedZoneDNSSECResponse = capo_route_53.types.enable_hosted_zone_dnssec_response.deserialize_xml(
