...
import capo_route_53.errors.cidr_collection_in_use_exception
...
STATUS_CODE_TO_CODE = {404: "NoSuchCidrCollectionException"}
...
def handle_response(
    ...
    out: capo_route_53.types.delete_cidr_collection_response.DeleteCidrCollectionResponse = {}  # type: ignore[typeddict-item]
    return out
