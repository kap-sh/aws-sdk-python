...
def handle_response(
    ...
    out: capo_route_53.types.disable_hosted_zone_dnssec_response.DisableHostedZoneDNSSECResponse = capo_route_53.types.disable_hosted_zone_dnssec_response.deserialize_xml(
