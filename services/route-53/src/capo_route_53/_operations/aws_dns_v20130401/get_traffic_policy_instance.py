"""Generated from Smithy shape ``com.amazonaws.route53#GetTrafficPolicyInstance``."""
...
def handle_response(
    ...
    out: capo_route_53.types.get_traffic_policy_instance_response.GetTrafficPolicyInstanceResponse = capo_route_53.types.get_traffic_policy_instance_response.deserialize_xml(
...
async def async_get_traffic_policy_instance(
