"""Generated from Smithy shape ``com.amazonaws.route53#DeleteReusableDelegationSet``."""
...
import capo_route_53.errors.delegation_set_in_use
...
def handle_response(
    ...
    out: capo_route_53.types.delete_reusable_delegation_set_response.DeleteReusableDelegationSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_reusable_delegation_set(
