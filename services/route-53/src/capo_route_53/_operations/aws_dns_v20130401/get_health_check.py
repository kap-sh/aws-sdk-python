"""Generated from Smithy shape ``com.amazonaws.route53#GetHealthCheck``."""
...
import capo_route_53.errors.incompatible_version
...
STATUS_CODE_TO_CODE = {404: "NoSuchHealthCheck"}
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "IncompatibleVersion":
            raise capo_route_53.errors.incompatible_version.IncompatibleVersion.from_xml(
                error_el, message
            )
        case "InvalidInput":
...
def handle_response(
    ...
    out: capo_route_53.types.get_health_check_response.GetHealthCheckResponse = (
        capo_route_53.types.get_health_check_response.deserialize_xml(
...
async def async_get_health_check(
