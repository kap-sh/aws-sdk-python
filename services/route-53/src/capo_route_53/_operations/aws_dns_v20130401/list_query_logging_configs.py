"""Generated from Smithy shape ``com.amazonaws.route53#ListQueryLoggingConfigs``."""
...
import capo_route_53.types.query_logging_configs
...
def handle_response(
    ...
    out: capo_route_53.types.list_query_logging_configs_response.ListQueryLoggingConfigsResponse = capo_route_53.types.list_query_logging_configs_response.deserialize_xml(
...
def build_request(
    ...
    if "hosted_zone_id" in input_:
        params.append(("hostedzoneid", input_["hosted_zone_id"]))
...
async def async_list_query_logging_configs(
