...
def handle_response(
    ...
    out: capo_route_53.types.get_hosted_zone_response.GetHostedZoneResponse = (
        capo_route_53.types.get_hosted_zone_response.deserialize_xml(
...
def get_hosted_zone(
    ...
    capo_route_53.types.get_hosted_zone_response.GetHostedZoneResponse, zapros.Response
]:
