"""Generated from Smithy shape ``com.amazonaws.route53#CreateTrafficPolicyVersion``."""
...
import capo_route_53.errors.too_many_traffic_policy_versions_for_current_policy
...
async def async_create_traffic_policy_version(
