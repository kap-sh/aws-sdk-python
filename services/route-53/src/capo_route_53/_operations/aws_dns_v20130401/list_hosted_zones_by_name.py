...
def handle_response(
    ...
    out: capo_route_53.types.list_hosted_zones_by_name_response.ListHostedZonesByNameResponse = capo_route_53.types.list_hosted_zones_by_name_response.deserialize_xml(
...
def build_request(
    ...
    if "dns_name" in input_:
        params.append(("dnsname", input_["dns_name"]))
