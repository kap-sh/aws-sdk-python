"""Generated from Smithy shape ``com.amazonaws.route53#DeleteVPCAssociationAuthorization``."""
...
import capo_route_53.errors.vpc_association_authorization_not_found
...
def handle_response(
    ...
    out: capo_route_53.types.delete_vpc_association_authorization_response.DeleteVPCAssociationAuthorizationResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_vpc_association_authorization(
