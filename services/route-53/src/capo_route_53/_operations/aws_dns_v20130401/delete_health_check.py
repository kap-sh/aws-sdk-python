...
import capo_route_53.errors.health_check_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "HealthCheckInUse":
            raise capo_route_53.errors.health_check_in_use.HealthCheckInUse.from_xml(
                error_el, message
            )
        case "InvalidInput":
...
def handle_response(
    ...
    out: capo_route_53.types.delete_health_check_response.DeleteHealthCheckResponse = {}  # type: ignore[typeddict-item]
    return out
