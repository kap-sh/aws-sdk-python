"""Generated from Smithy shape ``com.amazonaws.route53#ListTrafficPolicyInstancesByPolicy``."""
...
def handle_response(
    ...
    out: capo_route_53.types.list_traffic_policy_instances_by_policy_response.ListTrafficPolicyInstancesByPolicyResponse = capo_route_53.types.list_traffic_policy_instances_by_policy_response.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/trafficpolicyinstances/trafficpolicy"
    params: list[tuple[str, str]] = []
    if "traffic_policy_id" in input_:
        params.append(("id", input_["traffic_policy_id"]))
    if "traffic_policy_version" in input_:
        params.append(("version", str(input_["traffic_policy_version"])))
    if "hosted_zone_id_marker" in input_:
        params.append(("hostedzoneid", input_["hosted_zone_id_marker"]))
...
async def async_list_traffic_policy_instances_by_policy(
