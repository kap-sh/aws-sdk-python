...
def handle_response(
    ...
    out: capo_route_53.types.list_traffic_policy_instances_by_hosted_zone_response.ListTrafficPolicyInstancesByHostedZoneResponse = capo_route_53.types.list_traffic_policy_instances_by_hosted_zone_response.deserialize_xml(
