...
def handle_response(
    ...
    out: capo_route_53.types.update_traffic_policy_comment_response.UpdateTrafficPolicyCommentResponse = capo_route_53.types.update_traffic_policy_comment_response.deserialize_xml(
