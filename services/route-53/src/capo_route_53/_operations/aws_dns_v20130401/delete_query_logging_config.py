...
import capo_route_53.errors.no_such_query_logging_config
...
STATUS_CODE_TO_CODE = {404: "NoSuchQueryLoggingConfig"}
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchQueryLoggingConfig":
            raise capo_route_53.errors.no_such_query_logging_config.NoSuchQueryLoggingConfig.from_xml(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_route_53.types.delete_query_logging_config_response.DeleteQueryLoggingConfigResponse = {}  # type: ignore[typeddict-item]
    return out
