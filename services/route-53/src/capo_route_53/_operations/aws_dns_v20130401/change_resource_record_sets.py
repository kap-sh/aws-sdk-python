...
import capo_route_53.errors.invalid_change_batch
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidChangeBatch":
            raise capo_route_53.errors.invalid_change_batch.InvalidChangeBatch.from_xml(
                error_el, message
            )
        case "InvalidInput":
...
def handle_response(
    ...
    out: capo_route_53.types.change_resource_record_sets_response.ChangeResourceRecordSetsResponse = capo_route_53.types.change_resource_record_sets_response.deserialize_xml(
