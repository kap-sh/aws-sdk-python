"""Generated from Smithy shape ``com.amazonaws.route53#GetGeoLocation``."""
...
import capo_route_53.errors.no_such_geo_location
...
STATUS_CODE_TO_CODE = {400: "InvalidInput", 404: "NoSuchGeoLocation"}
...
def handle_response(
    ...
    out: capo_route_53.types.get_geo_location_response.GetGeoLocationResponse = (
        capo_route_53.types.get_geo_location_response.deserialize_xml(
...
async def async_get_geo_location(
