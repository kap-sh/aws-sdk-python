"""Generated from Smithy shape ``com.amazonaws.route53#ListCidrCollections``."""
...
import capo_route_53.types.collection_summaries
...
def handle_response(
    ...
    out: capo_route_53.types.list_cidr_collections_response.ListCidrCollectionsResponse = capo_route_53.types.list_cidr_collections_response.deserialize_xml(
...
async def async_list_cidr_collections(
