"""Generated from Smithy shape ``com.amazonaws.route53#DeleteTrafficPolicy``."""
...
import capo_route_53.errors.traffic_policy_in_use
...
STATUS_CODE_TO_CODE = {404: "NoSuchTrafficPolicy"}
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TrafficPolicyInUse":
            raise capo_route_53.errors.traffic_policy_in_use.TrafficPolicyInUse.from_xml(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_route_53.types.delete_traffic_policy_response.DeleteTrafficPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
