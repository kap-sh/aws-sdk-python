"""Generated from Smithy shape ``com.amazonaws.route53#ListTrafficPolicyInstances``."""
...
STATUS_CODE_TO_CODE = {400: "InvalidInput", 404: "NoSuchTrafficPolicyInstance"}
...
def handle_response(
    ...
    out: capo_route_53.types.list_traffic_policy_instances_response.ListTrafficPolicyInstancesResponse = capo_route_53.types.list_traffic_policy_instances_response.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/trafficpolicyinstances"
...
async def async_list_traffic_policy_instances(
