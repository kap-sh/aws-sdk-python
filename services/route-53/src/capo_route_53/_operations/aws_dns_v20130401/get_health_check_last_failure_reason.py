...
def handle_response(
    ...
    out: capo_route_53.types.get_health_check_last_failure_reason_response.GetHealthCheckLastFailureReasonResponse = capo_route_53.types.get_health_check_last_failure_reason_response.deserialize_xml(
