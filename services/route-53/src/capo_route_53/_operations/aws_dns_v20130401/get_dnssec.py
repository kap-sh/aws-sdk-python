...
def handle_response(
    ...
    out: capo_route_53.types.get_dnssec_response.GetDNSSECResponse = (
        capo_route_53.types.get_dnssec_response.deserialize_xml(
...
def get_dnssec(
    ...
    input_: capo_route_53.types.get_dnssec_request.GetDNSSECRequest,
) -> tuple[capo_route_53.types.get_dnssec_response.GetDNSSECResponse, zapros.Response]:
