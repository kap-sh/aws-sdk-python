"""Generated from Smithy shape ``com.amazonaws.route53#DeleteHostedZone``."""
...
import capo_route_53.errors.hosted_zone_not_empty
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "HostedZoneNotEmpty":
            raise capo_route_53.errors.hosted_zone_not_empty.HostedZoneNotEmpty.from_xml(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_route_53.types.delete_hosted_zone_response.DeleteHostedZoneResponse = (
        capo_route_53.types.delete_hosted_zone_response.deserialize_xml(
...
async def async_delete_hosted_zone(
