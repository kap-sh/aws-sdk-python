...
import capo_route_53.errors.no_such_change
...
STATUS_CODE_TO_CODE = {400: "InvalidInput", 404: "NoSuchChange"}
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchChange":
            raise capo_route_53.errors.no_such_change.NoSuchChange.from_xml(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_route_53.types.get_change_response.GetChangeResponse = (
        capo_route_53.types.get_change_response.deserialize_xml(
...
def build_request(
    ...
    input_: capo_route_53.types.get_change_request.GetChangeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_change(
    ...
    input_: capo_route_53.types.get_change_request.GetChangeRequest,
) -> tuple[capo_route_53.types.get_change_response.GetChangeResponse, zapros.Response]:
