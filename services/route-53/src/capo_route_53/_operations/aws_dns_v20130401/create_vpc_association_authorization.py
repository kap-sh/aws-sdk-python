...
import capo_route_53.errors.too_many_vpc_association_authorizations
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyVPCAssociationAuthorizations":
            raise capo_route_53.errors.too_many_vpc_association_authorizations.TooManyVPCAssociationAuthorizations.from_xml(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_route_53.types.create_vpc_association_authorization_response.CreateVPCAssociationAuthorizationResponse = capo_route_53.types.create_vpc_association_authorization_response.deserialize_xml(
