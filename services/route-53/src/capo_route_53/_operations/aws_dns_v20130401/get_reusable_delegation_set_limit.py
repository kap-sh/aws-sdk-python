"""Generated from Smithy shape ``com.amazonaws.route53#GetReusableDelegationSetLimit``."""
...
def handle_response(
    ...
    out: capo_route_53.types.get_reusable_delegation_set_limit_response.GetReusableDelegationSetLimitResponse = capo_route_53.types.get_reusable_delegation_set_limit_response.deserialize_xml(
...
def build_request(
    ...
    url = url.replace(
        "{Type}",
        quote(
            capo_route_53.types.reusable_delegation_set_limit_type.to_xml_text(
                input_["type"]
            ),
            safe="",
        ),
    )
    url = url.replace("{DelegationSetId}", quote(input_["delegation_set_id"], safe=""))
...
async def async_get_reusable_delegation_set_limit(
