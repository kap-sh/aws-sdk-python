"""Generated from Smithy shape ``com.amazonaws.route53#CreateHostedZone``."""
...
import capo_route_53.errors.hosted_zone_already_exists
import capo_route_53.errors.invalid_domain_name
...
import capo_route_53.errors.too_many_hosted_zones
...
STATUS_CODE_TO_CODE = {409: "HostedZoneAlreadyExists"}
...
def handle_response(
    ...
    out: capo_route_53.types.create_hosted_zone_response.CreateHostedZoneResponse = (
        capo_route_53.types.create_hosted_zone_response.deserialize_xml(
...
async def async_create_hosted_zone(
