...
def handle_response(
    ...
    out: capo_route_53.types.get_traffic_policy_instance_count_response.GetTrafficPolicyInstanceCountResponse = capo_route_53.types.get_traffic_policy_instance_count_response.deserialize_xml(
