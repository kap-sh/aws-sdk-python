"""Generated from Smithy shape ``com.amazonaws.route53#ChangeCidrCollection``."""
...
import capo_route_53.errors.cidr_block_in_use_exception
import capo_route_53.errors.cidr_collection_version_mismatch_exception
...
def handle_response(
    ...
    out: capo_route_53.types.change_cidr_collection_response.ChangeCidrCollectionResponse = capo_route_53.types.change_cidr_collection_response.deserialize_xml(
...
def build_request(
    ...
    if "changes" in input_:
        capo_route_53.types.cidr_collection_changes.serialize_xml(
