...
import capo_route_53.types.traffic_policy_summaries
...
def handle_response(
    ...
    out: capo_route_53.types.list_traffic_policies_response.ListTrafficPoliciesResponse = capo_route_53.types.list_traffic_policies_response.deserialize_xml(
...
def build_request(
    ...
    if "traffic_policy_id_marker" in input_:
        params.append(("trafficpolicyid", input_["traffic_policy_id_marker"]))
