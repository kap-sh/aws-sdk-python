...
def handle_response(
    ...
    out: capo_route_53.types.get_health_check_count_response.GetHealthCheckCountResponse = capo_route_53.types.get_health_check_count_response.deserialize_xml(
