"""Generated from Smithy shape ``com.amazonaws.route53#DeleteKeySigningKey``."""
...
STATUS_CODE_TO_CODE = {404: "NoSuchKeySigningKey"}
...
def handle_response(
    ...
    out: capo_route_53.types.delete_key_signing_key_response.DeleteKeySigningKeyResponse = capo_route_53.types.delete_key_signing_key_response.deserialize_xml(
...
async def async_delete_key_signing_key(
