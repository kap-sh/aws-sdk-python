...
class ChangeTagsForResourceRequest(TypedDict):
    ...
    add_tags: NotRequired["aws_sdk_route_53.types.tag_list.TagList"]
    ...
    remove_tag_keys: NotRequired["aws_sdk_route_53.types.tag_key_list.TagKeyList"]
...
def serialize_xml(
    ...
    if "add_tags" in value:
        ...
        aws_sdk_route_53.types.tag_list.serialize_xml(value["add_tags"], el, "AddTags")
...
def deserialize_xml(el: Element) -> ChangeTagsForResourceRequest:
    ...
    if child_add_tags is not None:
        ...
        out["add_tags"] = aws_sdk_route_53.types.tag_list.deserialize_xml(
            child_add_tags
        )
    ...
    if child_remove_tag_keys is not None:
        ...
        out["remove_tag_keys"] = aws_sdk_route_53.types.tag_key_list.deserialize_xml(
