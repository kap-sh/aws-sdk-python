...
class UpdateHealthCheckRequest(TypedDict):
...
def deserialize_xml(el: Element) -> UpdateHealthCheckRequest:
    ...
    if child_reset_elements is not None:
        ...
        out["reset_elements"] = (
            aws_sdk_route_53.types.resettable_element_name_list.deserialize_xml(
