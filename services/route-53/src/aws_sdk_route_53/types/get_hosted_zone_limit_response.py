...
class GetHostedZoneLimitResponse(TypedDict):
    limit: "aws_sdk_route_53.types.hosted_zone_limit.HostedZoneLimit"
...
def serialize_xml(value: GetHostedZoneLimitResponse, parent: Element, tag: str) -> None:
    ...
    aws_sdk_route_53.types.hosted_zone_limit.serialize_xml(value["limit"], el, "Limit")
...
def deserialize_xml(el: Element) -> GetHostedZoneLimitResponse:
    ...
    if child_limit is not None:
        ...
        out["limit"] = aws_sdk_route_53.types.hosted_zone_limit.deserialize_xml(
            child_limit
        )
    else:
