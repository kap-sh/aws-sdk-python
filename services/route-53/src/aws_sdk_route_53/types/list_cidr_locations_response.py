...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.location_summaries
    import aws_sdk_route_53.types.pagination_token


class ListCidrLocationsResponse(TypedDict):
    ...
    cidr_locations: NotRequired[
        "aws_sdk_route_53.types.location_summaries.LocationSummaries"
    ]
...
def serialize_xml(value: ListCidrLocationsResponse, parent: Element, tag: str) -> None:
    ...
    if "cidr_locations" in value:
        ...
        aws_sdk_route_53.types.location_summaries.serialize_xml(
...
def deserialize_xml(el: Element) -> ListCidrLocationsResponse:
    ...
    if child_cidr_locations is not None:
        ...
        out["cidr_locations"] = (
            aws_sdk_route_53.types.location_summaries.deserialize_xml(
