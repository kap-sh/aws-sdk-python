...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.aws_region
    import aws_sdk_route_53.types.bias
    import aws_sdk_route_53.types.coordinates
    import aws_sdk_route_53.types.local_zone_group


class GeoProximityLocation(TypedDict):
    aws_region: NotRequired["aws_sdk_route_53.types.aws_region.AWSRegion"]
...
def serialize_xml(value: GeoProximityLocation, parent: Element, tag: str) -> None:
    ...
    if "coordinates" in value:
        ...
        aws_sdk_route_53.types.coordinates.serialize_xml(
...
def deserialize_xml(el: Element) -> GeoProximityLocation:
    ...
    if child_coordinates is not None:
        ...
        out["coordinates"] = aws_sdk_route_53.types.coordinates.deserialize_xml(
            child_coordinates
        )
