...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.resettable_element_name

ResettableElementNameList: TypeAlias = list[
    "aws_sdk_route_53.types.resettable_element_name.ResettableElementName"
]
...
def serialize_xml(value: ResettableElementNameList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_route_53.types.resettable_element_name.serialize_xml(
...
def deserialize_xml(el: Element) -> ResettableElementNameList:
    ...
    for child in el.findall("ResettableElementName"):
        out.append(
            aws_sdk_route_53.types.resettable_element_name.deserialize_xml(child)
        )
    return out
...
def serialize_xml_flat(
    ...
    for item in value:
        ...
        aws_sdk_route_53.types.resettable_element_name.serialize_xml(item, parent, tag)
