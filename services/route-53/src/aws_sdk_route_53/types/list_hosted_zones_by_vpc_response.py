...
class ListHostedZonesByVPCResponse(TypedDict):
    hosted_zone_summaries: (
        "aws_sdk_route_53.types.hosted_zone_summaries.HostedZoneSummaries"
    )
...
def serialize_xml(
    ...
    aws_sdk_route_53.types.hosted_zone_summaries.serialize_xml(
...
def deserialize_xml(el: Element) -> ListHostedZonesByVPCResponse:
    ...
    if child_hosted_zone_summaries is not None:
        ...
        out["hosted_zone_summaries"] = (
            aws_sdk_route_53.types.hosted_zone_summaries.deserialize_xml(
