...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.collection_summary

CollectionSummaries: TypeAlias = list[
    "aws_sdk_route_53.types.collection_summary.CollectionSummary"
]
...
def serialize_xml(value: CollectionSummaries, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_route_53.types.collection_summary.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> CollectionSummaries:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_route_53.types.collection_summary.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: CollectionSummaries, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_route_53.types.collection_summary.serialize_xml(item, parent, tag)
