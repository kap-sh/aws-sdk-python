...
class ListResourceRecordSetsRequest(TypedDict, closed=True):
    ...
    start_record_type: NotRequired["aws_sdk_route_53.types.rr_type.RRType"]
    ...
    start_record_identifier: NotRequired[
...
# --- restXml ser/de ---
def serialize_xml(
    value: ListResourceRecordSetsRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> ListResourceRecordSetsRequest:
    out: ListResourceRecordSetsRequest = {}  # type: ignore[typeddict-item]
    return out
