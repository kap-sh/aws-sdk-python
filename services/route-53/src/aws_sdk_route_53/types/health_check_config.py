...
class HealthCheckConfig(TypedDict):
    ...
    fully_qualified_domain_name: NotRequired[
        "aws_sdk_route_53.types.fully_qualified_domain_name.FullyQualifiedDomainName"
    ]
    ...
    search_string: NotRequired["aws_sdk_route_53.types.search_string.SearchString"]
    ...
    request_interval: NotRequired[
        "aws_sdk_route_53.types.request_interval.RequestInterval"
    ]
    ...
    inverted: NotRequired["aws_sdk_route_53.types.inverted.Inverted"]
    ...
    enable_sni: NotRequired["aws_sdk_route_53.types.enable_sni.EnableSNI"]
    ...
    regions: NotRequired[
        "aws_sdk_route_53.types.health_check_region_list.HealthCheckRegionList"
    ]
    ...
    alarm_identifier: NotRequired[
        "aws_sdk_route_53.types.alarm_identifier.AlarmIdentifier"
    ]
    ...
    insufficient_data_health_status: NotRequired[
        "aws_sdk_route_53.types.insufficient_data_health_status.InsufficientDataHealthStatus"
    ]
    ...
    routing_control_arn: NotRequired[
        "aws_sdk_route_53.types.routing_control_arn.RoutingControlArn"
    ]
    r"""<p>The Amazon Resource Name (ARN) for the Route 53 Application Recovery Controller routing control.</p> <p>For more information about Route 53 Application Recovery Controller, see <a href=\"https://docs.aws.amazon.com/r53recovery/latest/dg/what-is-route-53-recovery.html\">Route 53 Application Recovery Controller Developer Guide.</a>.</p>"""
...
def serialize_xml(value: HealthCheckConfig, parent: Element, tag: str) -> None:
    ...
    aws_sdk_route_53.types.health_check_type.serialize_xml(value["type"], el, "Type")
...
def deserialize_xml(el: Element) -> HealthCheckConfig:
    ...
    if child_type is not None:
        ...
        out["type"] = aws_sdk_route_53.types.health_check_type.deserialize_xml(
            child_type
        )
    else:
    ...
    if child_child_health_checks is not None:
        ...
        out["child_health_checks"] = (
            aws_sdk_route_53.types.child_health_check_list.deserialize_xml(
    ...
    if child_regions is not None:
        ...
        out["regions"] = (
            aws_sdk_route_53.types.health_check_region_list.deserialize_xml(
                child_regions
            )
        )
    ...
    if child_alarm_identifier is not None:
        ...
        out["alarm_identifier"] = (
            aws_sdk_route_53.types.alarm_identifier.deserialize_xml(
    ...
    if child_insufficient_data_health_status is not None:
        ...
        out["insufficient_data_health_status"] = (
            aws_sdk_route_53.types.insufficient_data_health_status.deserialize_xml(
