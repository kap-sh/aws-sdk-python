...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.arn
...
class CidrCollection(TypedDict):
    ...
    name: NotRequired["aws_sdk_route_53.types.collection_name.CollectionName"]
    """<p>The name of a CIDR collection.</p>"""
    version: NotRequired["aws_sdk_route_53.types.collection_version.CollectionVersion"]
