...
class ListCidrBlocksResponse(TypedDict):
    ...
    cidr_blocks: NotRequired[
        "aws_sdk_route_53.types.cidr_block_summaries.CidrBlockSummaries"
    ]
...
def serialize_xml(value: ListCidrBlocksResponse, parent: Element, tag: str) -> None:
    ...
    if "cidr_blocks" in value:
        ...
        aws_sdk_route_53.types.cidr_block_summaries.serialize_xml(
...
def deserialize_xml(el: Element) -> ListCidrBlocksResponse:
    ...
    if child_cidr_blocks is not None:
        ...
        out["cidr_blocks"] = (
            aws_sdk_route_53.types.cidr_block_summaries.deserialize_xml(
                child_cidr_blocks
            )
        )
    return out
