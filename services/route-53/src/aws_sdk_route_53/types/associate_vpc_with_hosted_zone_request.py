...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.associate_vpc_comment
    import aws_sdk_route_53.types.resource_id
    import aws_sdk_route_53.types.vpc


class AssociateVPCWithHostedZoneRequest(TypedDict):
    ...
    comment: NotRequired[
        "aws_sdk_route_53.types.associate_vpc_comment.AssociateVPCComment"
    ]
