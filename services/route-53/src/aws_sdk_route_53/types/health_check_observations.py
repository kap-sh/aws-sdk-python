...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.health_check_observation

HealthCheckObservations: TypeAlias = list[
    "aws_sdk_route_53.types.health_check_observation.HealthCheckObservation"
]
...
def serialize_xml(value: HealthCheckObservations, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_route_53.types.health_check_observation.serialize_xml(
...
def deserialize_xml(el: Element) -> HealthCheckObservations:
    ...
    for child in el.findall("HealthCheckObservation"):
        out.append(
            aws_sdk_route_53.types.health_check_observation.deserialize_xml(child)
        )
    return out
...
def serialize_xml_flat(
    ...
    for item in value:
        ...
        aws_sdk_route_53.types.health_check_observation.serialize_xml(item, parent, tag)
