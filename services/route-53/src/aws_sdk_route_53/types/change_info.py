...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.change_status
...
def serialize_xml(value: ChangeInfo, parent: Element, tag: str) -> None:
    ...
    aws_sdk_route_53.types.change_status.serialize_xml(value["status"], el, "Status")
    import aws_sdk_route_53.types.time_stamp
...
def deserialize_xml(el: Element) -> ChangeInfo:
    ...
    if child_status is not None:
        ...
        out["status"] = aws_sdk_route_53.types.change_status.deserialize_xml(
            child_status
        )
    else:
    ...
    if child_submitted_at is not None:
        ...
        out["submitted_at"] = aws_sdk_route_53.types.time_stamp.deserialize_xml(
            child_submitted_at
        )
    else:
