...
from aws_sdk_route_53._async import anysleep
from aws_sdk_route_53.errors import ServiceError

if TYPE_CHECKING:
    from aws_sdk_route_53._auth._identity import Credentials
    from aws_sdk_route_53._auth._providers import IdentityProvider
