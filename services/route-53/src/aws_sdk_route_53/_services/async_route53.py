...
from aws_sdk_route_53._pagination import resolve_path as _resolve_path
from aws_sdk_route_53._services._pipeline import (
    AsyncInterceptor,
...
if TYPE_CHECKING:
    ...
    import aws_sdk_route_53.types.cidr_nonce
    ...
    import aws_sdk_route_53.types.create_traffic_policy_instance_request
    import aws_sdk_route_53.types.create_traffic_policy_instance_response
    ...
    import aws_sdk_route_53.types.deactivate_key_signing_key_request
    import aws_sdk_route_53.types.deactivate_key_signing_key_response
    ...
    import aws_sdk_route_53.types.delete_health_check_request
    import aws_sdk_route_53.types.delete_health_check_response
    import aws_sdk_route_53.types.delete_hosted_zone_request
    import aws_sdk_route_53.types.delete_hosted_zone_response
    import aws_sdk_route_53.types.delete_key_signing_key_request
    import aws_sdk_route_53.types.delete_key_signing_key_response
    ...
    import aws_sdk_route_53.types.delete_traffic_policy_request
    import aws_sdk_route_53.types.delete_traffic_policy_response
    import aws_sdk_route_53.types.delete_vpc_association_authorization_request
    import aws_sdk_route_53.types.delete_vpc_association_authorization_response
    ...
    import aws_sdk_route_53.types.get_checker_ip_ranges_request
    import aws_sdk_route_53.types.get_checker_ip_ranges_response
    import aws_sdk_route_53.types.get_dnssec_request
    import aws_sdk_route_53.types.get_dnssec_response
    ...
    import aws_sdk_route_53.types.get_health_check_last_failure_reason_request
    import aws_sdk_route_53.types.get_health_check_last_failure_reason_response
    ...
    import aws_sdk_route_53.types.get_hosted_zone_count_request
    import aws_sdk_route_53.types.get_hosted_zone_count_response
    ...
    import aws_sdk_route_53.types.get_reusable_delegation_set_limit_request
    import aws_sdk_route_53.types.get_reusable_delegation_set_limit_response
    ...
    import aws_sdk_route_53.types.get_traffic_policy_instance_request
    import aws_sdk_route_53.types.get_traffic_policy_instance_response
    ...
    import aws_sdk_route_53.types.list_cidr_blocks_request
    import aws_sdk_route_53.types.list_cidr_blocks_response
    import aws_sdk_route_53.types.list_cidr_collections_request
    import aws_sdk_route_53.types.list_cidr_collections_response
    import aws_sdk_route_53.types.list_cidr_locations_request
    import aws_sdk_route_53.types.list_cidr_locations_response
    ...
    import aws_sdk_route_53.types.list_hosted_zones_request
    import aws_sdk_route_53.types.list_hosted_zones_response
    import aws_sdk_route_53.types.list_query_logging_configs_request
    import aws_sdk_route_53.types.list_query_logging_configs_response
    ...
    import aws_sdk_route_53.types.list_reusable_delegation_sets_request
    import aws_sdk_route_53.types.list_reusable_delegation_sets_response
    ...
    import aws_sdk_route_53.types.list_traffic_policy_instances_request
    import aws_sdk_route_53.types.list_traffic_policy_instances_response
    import aws_sdk_route_53.types.list_traffic_policy_versions_request
    import aws_sdk_route_53.types.list_traffic_policy_versions_response
    ...
    import aws_sdk_route_53.types.update_hosted_zone_features_request
    import aws_sdk_route_53.types.update_hosted_zone_features_response
...
class AsyncRoute53ClientConfig(TypedDict, total=False):
...
class AsyncRoute53Client:
    ...
    def __init__(
        ...
        self._config = AsyncRoute53ClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: AsyncRoute53ClientConfig = config_overrides or {}
    ...
    async def activate_key_signing_key(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.activate_key_signing_key_request.ActivateKeySigningKeyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.activate_key_signing_key_response.ActivateKeySigningKeyResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.activate_key_signing_key

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.activate_key_signing_key.async_activate_key_signing_key(
    ...
    async def associate_vpc_with_hosted_zone(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.associate_vpc_with_hosted_zone(hosted_zone_id='Z3M3LMPEXAMPLE', vpc={'VPCId': 'vpc-1a2b3c4d', 'VPCRegion': 'us-east-2'}, comment='')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.associate_vpc_with_hosted_zone_request.AssociateVPCWithHostedZoneRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.associate_vpc_with_hosted_zone_response.AssociateVPCWithHostedZoneResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.associate_vpc_with_hosted_zone

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.associate_vpc_with_hosted_zone.async_associate_vpc_with_hosted_zone(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def change_cidr_collection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.change_cidr_collection_request.ChangeCidrCollectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.change_cidr_collection_response.ChangeCidrCollectionResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.change_cidr_collection

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.change_cidr_collection.async_change_cidr_collection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def change_resource_record_sets(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.change_resource_record_sets(hosted_zone_id='Z3M3LMPEXAMPLE', change_batch={'Comment': 'CloudFront distribution for example.com', 'Changes': [{'Action': 'CREATE', 'ResourceRecordSet': {'Name': 'example.com', 'Type': 'A', 'AliasTarget': {'HostedZoneId': 'Z2FDTNDATAQYW2', 'DNSName': 'd123rk29d0stfj.cloudfront.net', 'EvaluateTargetHealth': False}}}]})
            ...
            >>> await client.change_resource_record_sets(hosted_zone_id='Z3M3LMPEXAMPLE', change_batch={'Comment': 'Web server for example.com', 'Changes': [{'Action': 'CREATE', 'ResourceRecordSet': {'Name': 'example.com', 'Type': 'A', 'TTL': 60, 'ResourceRecords': [{'Value': '192.0.2.44'}]}}]})
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.change_resource_record_sets_request.ChangeResourceRecordSetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.change_resource_record_sets_response.ChangeResourceRecordSetsResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.change_resource_record_sets

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.change_resource_record_sets.async_change_resource_record_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def change_tags_for_resource(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
        add_tags: Optional["aws_sdk_route_53.types.tag_list.TagList"] = None,
        remove_tag_keys: Optional[
            "aws_sdk_route_53.types.tag_key_list.TagKeyList"
        ] = None,
        ...
        Examples:
            ...
            >>> await client.change_tags_for_resource(resource_type='hostedzone', resource_id='Z3M3LMPEXAMPLE', add_tags=[{'Key': 'apex', 'Value': '3874'}, {'Key': 'acme', 'Value': '4938'}], remove_tag_keys=['Nadir'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.change_tags_for_resource_request.ChangeTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.change_tags_for_resource_response.ChangeTagsForResourceResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.change_tags_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.change_tags_for_resource.async_change_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_cidr_collection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.create_cidr_collection_request.CreateCidrCollectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.create_cidr_collection_response.CreateCidrCollectionResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.create_cidr_collection

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.create_cidr_collection.async_create_cidr_collection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_health_check(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.create_health_check_request.CreateHealthCheckRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.create_health_check_response.CreateHealthCheckResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.create_health_check

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.create_health_check.async_create_health_check(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_hosted_zone(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.create_hosted_zone_request.CreateHostedZoneRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.create_hosted_zone_response.CreateHostedZoneResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.create_hosted_zone

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.create_hosted_zone.async_create_hosted_zone(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_key_signing_key(
        ...
        caller_reference: "aws_sdk_route_53.types.nonce.Nonce",
        hosted_zone_id: "aws_sdk_route_53.types.resource_id.ResourceId",
        key_management_service_arn: "aws_sdk_route_53.types.signing_key_string.SigningKeyString",
        name: "aws_sdk_route_53.types.signing_key_name.SigningKeyName",
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.create_key_signing_key_request.CreateKeySigningKeyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.create_key_signing_key_response.CreateKeySigningKeyResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.create_key_signing_key

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.create_key_signing_key.async_create_key_signing_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_query_logging_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.create_query_logging_config_request.CreateQueryLoggingConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.create_query_logging_config_response.CreateQueryLoggingConfigResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.create_query_logging_config

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.create_query_logging_config.async_create_query_logging_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_reusable_delegation_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.create_reusable_delegation_set_request.CreateReusableDelegationSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.create_reusable_delegation_set_response.CreateReusableDelegationSetResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.create_reusable_delegation_set

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.create_reusable_delegation_set.async_create_reusable_delegation_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_traffic_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.create_traffic_policy_request.CreateTrafficPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.create_traffic_policy_response.CreateTrafficPolicyResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.create_traffic_policy

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.create_traffic_policy.async_create_traffic_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_traffic_policy_instance(
        ...
        traffic_policy_version: "aws_sdk_route_53.types.traffic_policy_version.TrafficPolicyVersion",
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.create_traffic_policy_instance_request.CreateTrafficPolicyInstanceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.create_traffic_policy_instance_response.CreateTrafficPolicyInstanceResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.create_traffic_policy_instance

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.create_traffic_policy_instance.async_create_traffic_policy_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_traffic_policy_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.create_traffic_policy_version_request.CreateTrafficPolicyVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.create_traffic_policy_version_response.CreateTrafficPolicyVersionResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.create_traffic_policy_version

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.create_traffic_policy_version.async_create_traffic_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_vpc_association_authorization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.create_vpc_association_authorization_request.CreateVPCAssociationAuthorizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.create_vpc_association_authorization_response.CreateVPCAssociationAuthorizationResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.create_vpc_association_authorization

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.create_vpc_association_authorization.async_create_vpc_association_authorization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deactivate_key_signing_key(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
    ) -> "aws_sdk_route_53.types.deactivate_key_signing_key_response.DeactivateKeySigningKeyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.deactivate_key_signing_key_request.DeactivateKeySigningKeyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.deactivate_key_signing_key_response.DeactivateKeySigningKeyResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.deactivate_key_signing_key

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.deactivate_key_signing_key.async_deactivate_key_signing_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_cidr_collection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.delete_cidr_collection_request.DeleteCidrCollectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.delete_cidr_collection_response.DeleteCidrCollectionResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.delete_cidr_collection

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.delete_cidr_collection.async_delete_cidr_collection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_health_check(
        ...
        *,
        ...
        "aws_sdk_route_53.types.delete_health_check_response.DeleteHealthCheckResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.delete_health_check_request.DeleteHealthCheckRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.delete_health_check_response.DeleteHealthCheckResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.delete_health_check

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.delete_health_check.async_delete_health_check(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_hosted_zone(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
    ) -> "aws_sdk_route_53.types.delete_hosted_zone_response.DeleteHostedZoneResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.delete_hosted_zone_request.DeleteHostedZoneRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.delete_hosted_zone_response.DeleteHostedZoneResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.delete_hosted_zone

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.delete_hosted_zone.async_delete_hosted_zone(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_key_signing_key(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
    ) -> "aws_sdk_route_53.types.delete_key_signing_key_response.DeleteKeySigningKeyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.delete_key_signing_key_request.DeleteKeySigningKeyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.delete_key_signing_key_response.DeleteKeySigningKeyResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.delete_key_signing_key

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.delete_key_signing_key.async_delete_key_signing_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_query_logging_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.delete_query_logging_config_request.DeleteQueryLoggingConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.delete_query_logging_config_response.DeleteQueryLoggingConfigResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.delete_query_logging_config

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.delete_query_logging_config.async_delete_query_logging_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_reusable_delegation_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.delete_reusable_delegation_set_request.DeleteReusableDelegationSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.delete_reusable_delegation_set_response.DeleteReusableDelegationSetResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.delete_reusable_delegation_set

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.delete_reusable_delegation_set.async_delete_reusable_delegation_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_traffic_policy(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
    ) -> "aws_sdk_route_53.types.delete_traffic_policy_response.DeleteTrafficPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.delete_traffic_policy_request.DeleteTrafficPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.delete_traffic_policy_response.DeleteTrafficPolicyResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.delete_traffic_policy

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.delete_traffic_policy.async_delete_traffic_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_traffic_policy_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.delete_traffic_policy_instance_request.DeleteTrafficPolicyInstanceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.delete_traffic_policy_instance_response.DeleteTrafficPolicyInstanceResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.delete_traffic_policy_instance

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.delete_traffic_policy_instance.async_delete_traffic_policy_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_vpc_association_authorization(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
    ) -> "aws_sdk_route_53.types.delete_vpc_association_authorization_response.DeleteVPCAssociationAuthorizationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.delete_vpc_association_authorization_request.DeleteVPCAssociationAuthorizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.delete_vpc_association_authorization_response.DeleteVPCAssociationAuthorizationResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.delete_vpc_association_authorization

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.delete_vpc_association_authorization.async_delete_vpc_association_authorization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_hosted_zone_dnssec(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.disable_hosted_zone_dnssec_request.DisableHostedZoneDNSSECRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.disable_hosted_zone_dnssec_response.DisableHostedZoneDNSSECResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.disable_hosted_zone_dnssec

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.disable_hosted_zone_dnssec.async_disable_hosted_zone_dnssec(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_vpc_from_hosted_zone(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.disassociate_vpc_from_hosted_zone_request.DisassociateVPCFromHostedZoneRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.disassociate_vpc_from_hosted_zone_response.DisassociateVPCFromHostedZoneResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.disassociate_vpc_from_hosted_zone

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.disassociate_vpc_from_hosted_zone.async_disassociate_vpc_from_hosted_zone(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_hosted_zone_dnssec(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.enable_hosted_zone_dnssec_request.EnableHostedZoneDNSSECRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.enable_hosted_zone_dnssec_response.EnableHostedZoneDNSSECResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.enable_hosted_zone_dnssec

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.enable_hosted_zone_dnssec.async_enable_hosted_zone_dnssec(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_limit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_account_limit_request.GetAccountLimitRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_account_limit_response.GetAccountLimitResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_account_limit

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_account_limit.async_get_account_limit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_change(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_change_request.GetChangeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_change_response.GetChangeResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_change

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_change.async_get_change(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_checker_ip_ranges(
        ...
        async def _handler(
            ...
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_checker_ip_ranges

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_checker_ip_ranges.async_get_checker_ip_ranges(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_dnssec(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
    ) -> "aws_sdk_route_53.types.get_dnssec_response.GetDNSSECResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_dnssec_request.GetDNSSECRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_dnssec_response.GetDNSSECResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_dnssec

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_dnssec.async_get_dnssec(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_geo_location(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_geo_location_request.GetGeoLocationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_geo_location_response.GetGeoLocationResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_geo_location

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_geo_location.async_get_geo_location(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_health_check(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_health_check_request.GetHealthCheckRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_health_check_response.GetHealthCheckResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check.async_get_health_check(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_health_check_count(
        ...
        async def _handler(
            ...
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check_count

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check_count.async_get_health_check_count(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_health_check_last_failure_reason(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
    ) -> "aws_sdk_route_53.types.get_health_check_last_failure_reason_response.GetHealthCheckLastFailureReasonResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_health_check_last_failure_reason_request.GetHealthCheckLastFailureReasonRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_health_check_last_failure_reason_response.GetHealthCheckLastFailureReasonResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check_last_failure_reason

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check_last_failure_reason.async_get_health_check_last_failure_reason(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_health_check_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_health_check_status_request.GetHealthCheckStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_health_check_status_response.GetHealthCheckStatusResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check_status

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check_status.async_get_health_check_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_hosted_zone(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_hosted_zone(id='Z3M3LMPEXAMPLE')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_hosted_zone_request.GetHostedZoneRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_hosted_zone_response.GetHostedZoneResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_hosted_zone

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_hosted_zone.async_get_hosted_zone(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_hosted_zone_count(
        ...
        async def _handler(
            ...
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_hosted_zone_count

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_hosted_zone_count.async_get_hosted_zone_count(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_hosted_zone_limit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_hosted_zone_limit_request.GetHostedZoneLimitRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_hosted_zone_limit_response.GetHostedZoneLimitResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_hosted_zone_limit

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_hosted_zone_limit.async_get_hosted_zone_limit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_query_logging_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_query_logging_config_request.GetQueryLoggingConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_query_logging_config_response.GetQueryLoggingConfigResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_query_logging_config

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_query_logging_config.async_get_query_logging_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_reusable_delegation_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_reusable_delegation_set_request.GetReusableDelegationSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_reusable_delegation_set_response.GetReusableDelegationSetResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_reusable_delegation_set

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_reusable_delegation_set.async_get_reusable_delegation_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_reusable_delegation_set_limit(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
    ) -> "aws_sdk_route_53.types.get_reusable_delegation_set_limit_response.GetReusableDelegationSetLimitResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_reusable_delegation_set_limit_request.GetReusableDelegationSetLimitRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_reusable_delegation_set_limit_response.GetReusableDelegationSetLimitResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_reusable_delegation_set_limit

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_reusable_delegation_set_limit.async_get_reusable_delegation_set_limit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_traffic_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_traffic_policy_request.GetTrafficPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_traffic_policy_response.GetTrafficPolicyResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_traffic_policy

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_traffic_policy.async_get_traffic_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_traffic_policy_instance(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
    ) -> "aws_sdk_route_53.types.get_traffic_policy_instance_response.GetTrafficPolicyInstanceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.get_traffic_policy_instance_request.GetTrafficPolicyInstanceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.get_traffic_policy_instance_response.GetTrafficPolicyInstanceResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_traffic_policy_instance

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_traffic_policy_instance.async_get_traffic_policy_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_traffic_policy_instance_count(
        ...
        async def _handler(
            ...
            import aws_sdk_route_53._operations.aws_dns_v20130401.get_traffic_policy_instance_count

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.get_traffic_policy_instance_count.async_get_traffic_policy_instance_count(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_cidr_blocks(
        ...
        *,
        ...
        next_token: Optional[
            "aws_sdk_route_53.types.pagination_token.PaginationToken"
        ] = None,
        max_results: Optional[int] = None,
    ) -> "aws_sdk_route_53.types.list_cidr_blocks_response.ListCidrBlocksResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_cidr_blocks_request.ListCidrBlocksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_cidr_blocks_response.ListCidrBlocksResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_cidr_blocks

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_cidr_blocks.async_list_cidr_blocks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_cidr_blocks(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[aws_sdk_route_53.types.cidr_block_summary.CidrBlockSummary]":
        _token = next_token
        while True:
            _response = await self.list_cidr_blocks(
                collection_id,
    ...
    async def list_cidr_collections(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "aws_sdk_route_53.types.list_cidr_collections_response.ListCidrCollectionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_cidr_collections_request.ListCidrCollectionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_cidr_collections_response.ListCidrCollectionsResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_cidr_collections

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_cidr_collections.async_list_cidr_collections(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_cidr_collections(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[aws_sdk_route_53.types.collection_summary.CollectionSummary]":
        _token = next_token
        while True:
            _response = await self.list_cidr_collections(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    async def list_cidr_locations(
        ...
        *,
        ...
        "aws_sdk_route_53.types.list_cidr_locations_response.ListCidrLocationsResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_cidr_locations_request.ListCidrLocationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_cidr_locations_response.ListCidrLocationsResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_cidr_locations

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_cidr_locations.async_list_cidr_locations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_cidr_locations(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[aws_sdk_route_53.types.location_summary.LocationSummary]":
        _token = next_token
        while True:
            _response = await self.list_cidr_locations(
                collection_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_geo_locations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_geo_locations_request.ListGeoLocationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_geo_locations_response.ListGeoLocationsResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_geo_locations

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_geo_locations.async_list_geo_locations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_health_checks(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
        marker: Optional["aws_sdk_route_53.types.page_marker.PageMarker"] = None,
        max_items: Optional[int] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_health_checks_request.ListHealthChecksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_health_checks_response.ListHealthChecksResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_health_checks

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_health_checks.async_list_health_checks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_health_checks(
        ...
        *,
        ...
        marker: Optional["aws_sdk_route_53.types.page_marker.PageMarker"] = None,
        max_items: Optional[int] = None,
    ) -> "AsyncIterator[aws_sdk_route_53.types.health_check.HealthCheck]":
        _token = marker
        while True:
            _response = await self.list_health_checks(
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
            )
    ...
    async def list_hosted_zones(
        ...
        *,
    ...
    ) -> "aws_sdk_route_53.types.list_hosted_zones_response.ListHostedZonesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_hosted_zones_request.ListHostedZonesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_hosted_zones_response.ListHostedZonesResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_hosted_zones

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_hosted_zones.async_list_hosted_zones(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_route_53.types.hosted_zone.HostedZone]":
        _token = marker
        while True:
            _response = await self.list_hosted_zones(
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
    ...
    async def list_hosted_zones_by_name(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
        dns_name: Optional["aws_sdk_route_53.types.dns_name.DNSName"] = None,
        hosted_zone_id: Optional[
            "aws_sdk_route_53.types.resource_id.ResourceId"
        ] = None,
        max_items: Optional[int] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_hosted_zones_by_name_request.ListHostedZonesByNameRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_hosted_zones_by_name_response.ListHostedZonesByNameResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_hosted_zones_by_name

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_hosted_zones_by_name.async_list_hosted_zones_by_name(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_hosted_zones_by_vpc(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_hosted_zones_by_vpc_request.ListHostedZonesByVPCRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_hosted_zones_by_vpc_response.ListHostedZonesByVPCResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_hosted_zones_by_vpc

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_hosted_zones_by_vpc.async_list_hosted_zones_by_vpc(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_query_logging_configs(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "aws_sdk_route_53.types.list_query_logging_configs_response.ListQueryLoggingConfigsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_query_logging_configs_request.ListQueryLoggingConfigsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_query_logging_configs_response.ListQueryLoggingConfigsResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_query_logging_configs

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_query_logging_configs.async_list_query_logging_configs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_query_logging_configs(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_route_53.types.query_logging_config.QueryLoggingConfig]"
    ):
        _token = next_token
        while True:
            _response = await self.list_query_logging_configs(
                config_overrides=config_overrides,
    ...
    async def list_resource_record_sets(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
        start_record_name: Optional["aws_sdk_route_53.types.dns_name.DNSName"] = None,
        start_record_type: Optional["aws_sdk_route_53.types.rr_type.RRType"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_resource_record_sets_request.ListResourceRecordSetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_resource_record_sets_response.ListResourceRecordSetsResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_resource_record_sets

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_resource_record_sets.async_list_resource_record_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_reusable_delegation_sets(
        ...
        *,
        ...
        marker: Optional["aws_sdk_route_53.types.page_marker.PageMarker"] = None,
        max_items: Optional[int] = None,
    ) -> "aws_sdk_route_53.types.list_reusable_delegation_sets_response.ListReusableDelegationSetsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_reusable_delegation_sets_request.ListReusableDelegationSetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_reusable_delegation_sets_response.ListReusableDelegationSetsResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_reusable_delegation_sets

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_reusable_delegation_sets.async_list_reusable_delegation_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_tags_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_tags_for_resources_request.ListTagsForResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_tags_for_resources_response.ListTagsForResourcesResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_tags_for_resources

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_tags_for_resources.async_list_tags_for_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_traffic_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_traffic_policies_request.ListTrafficPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_traffic_policies_response.ListTrafficPoliciesResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policies

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policies.async_list_traffic_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_traffic_policy_instances(
        ...
        *,
        ...
        max_items: Optional[int] = None,
    ) -> "aws_sdk_route_53.types.list_traffic_policy_instances_response.ListTrafficPolicyInstancesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_traffic_policy_instances_request.ListTrafficPolicyInstancesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_traffic_policy_instances_response.ListTrafficPolicyInstancesResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_instances

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_instances.async_list_traffic_policy_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_traffic_policy_instances_by_hosted_zone(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_traffic_policy_instances_by_hosted_zone_request.ListTrafficPolicyInstancesByHostedZoneRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_traffic_policy_instances_by_hosted_zone_response.ListTrafficPolicyInstancesByHostedZoneResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_instances_by_hosted_zone

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_instances_by_hosted_zone.async_list_traffic_policy_instances_by_hosted_zone(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_traffic_policy_instances_by_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_traffic_policy_instances_by_policy_request.ListTrafficPolicyInstancesByPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_traffic_policy_instances_by_policy_response.ListTrafficPolicyInstancesByPolicyResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_instances_by_policy

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_instances_by_policy.async_list_traffic_policy_instances_by_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_traffic_policy_versions(
        ...
        *,
        ...
        traffic_policy_version_marker: Optional[
            "aws_sdk_route_53.types.traffic_policy_version_marker.TrafficPolicyVersionMarker"
        ] = None,
        max_items: Optional[int] = None,
    ) -> "aws_sdk_route_53.types.list_traffic_policy_versions_response.ListTrafficPolicyVersionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_traffic_policy_versions_request.ListTrafficPolicyVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_traffic_policy_versions_response.ListTrafficPolicyVersionsResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_versions

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_versions.async_list_traffic_policy_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_vpc_association_authorizations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.list_vpc_association_authorizations_request.ListVPCAssociationAuthorizationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.list_vpc_association_authorizations_response.ListVPCAssociationAuthorizationsResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.list_vpc_association_authorizations

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.list_vpc_association_authorizations.async_list_vpc_association_authorizations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_dns_answer(
        ...
        *,
        config_overrides: Optional[AsyncRoute53ClientConfig] = None,
        resolver_ip: Optional["aws_sdk_route_53.types.ip_address.IPAddress"] = None,
        edns0_client_subnet_ip: Optional[
            "aws_sdk_route_53.types.ip_address.IPAddress"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.test_dns_answer_request.TestDNSAnswerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.test_dns_answer_response.TestDNSAnswerResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.test_dns_answer

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.test_dns_answer.async_test_dns_answer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_health_check(
        ...
        *,
        ...
        ip_address: Optional["aws_sdk_route_53.types.ip_address.IPAddress"] = None,
        port: Optional["aws_sdk_route_53.types.port.Port"] = None,
        resource_path: Optional[
            "aws_sdk_route_53.types.resource_path.ResourcePath"
        ] = None,
        ...
        search_string: Optional[
            "aws_sdk_route_53.types.search_string.SearchString"
        ] = None,
        failure_threshold: Optional[
            "aws_sdk_route_53.types.failure_threshold.FailureThreshold"
        ] = None,
        inverted: Optional["aws_sdk_route_53.types.inverted.Inverted"] = None,
        disabled: Optional["aws_sdk_route_53.types.disabled.Disabled"] = None,
        ...
        enable_sni: Optional["aws_sdk_route_53.types.enable_sni.EnableSNI"] = None,
        regions: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.update_health_check_request.UpdateHealthCheckRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.update_health_check_response.UpdateHealthCheckResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.update_health_check

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.update_health_check.async_update_health_check(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_hosted_zone_comment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.update_hosted_zone_comment_request.UpdateHostedZoneCommentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.update_hosted_zone_comment_response.UpdateHostedZoneCommentResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.update_hosted_zone_comment

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.update_hosted_zone_comment.async_update_hosted_zone_comment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_hosted_zone_features(
        ...
        *,
    ...
    ) -> "aws_sdk_route_53.types.update_hosted_zone_features_response.UpdateHostedZoneFeaturesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.update_hosted_zone_features_request.UpdateHostedZoneFeaturesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.update_hosted_zone_features_response.UpdateHostedZoneFeaturesResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.update_hosted_zone_features

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.update_hosted_zone_features.async_update_hosted_zone_features(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_traffic_policy_comment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.update_traffic_policy_comment_request.UpdateTrafficPolicyCommentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.update_traffic_policy_comment_response.UpdateTrafficPolicyCommentResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.update_traffic_policy_comment

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.update_traffic_policy_comment.async_update_traffic_policy_comment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_traffic_policy_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route_53.types.update_traffic_policy_instance_request.UpdateTrafficPolicyInstanceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route_53.types.update_traffic_policy_instance_response.UpdateTrafficPolicyInstanceResponse"
        ]:
            import aws_sdk_route_53._operations.aws_dns_v20130401.update_traffic_policy_instance

            (
                output,
                http_response,
            ) = await aws_sdk_route_53._operations.aws_dns_v20130401.update_traffic_policy_instance.async_update_traffic_policy_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
