...
class Route53ClientConfig(TypedDict, total=False):
...
class Route53Client:
    ...
    def __init__(
        ...
        self.config = Route53ClientConfig(
            {
    ...
    def activate_key_signing_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.activate_key_signing_key_request.ActivateKeySigningKeyRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.activate_key_signing_key_response.ActivateKeySigningKeyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.activate_key_signing_key.activate_key_signing_key(
    ...
    def associate_vpc_with_hosted_zone(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.associate_vpc_with_hosted_zone_request.AssociateVPCWithHostedZoneRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.associate_vpc_with_hosted_zone_response.AssociateVPCWithHostedZoneResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.associate_vpc_with_hosted_zone.associate_vpc_with_hosted_zone(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def change_cidr_collection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.change_cidr_collection_request.ChangeCidrCollectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.change_cidr_collection_response.ChangeCidrCollectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.change_cidr_collection.change_cidr_collection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def change_resource_record_sets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.change_resource_record_sets_request.ChangeResourceRecordSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.change_resource_record_sets_response.ChangeResourceRecordSetsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.change_resource_record_sets.change_resource_record_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def change_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.change_tags_for_resource_request.ChangeTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.change_tags_for_resource_response.ChangeTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.change_tags_for_resource.change_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cidr_collection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.create_cidr_collection_request.CreateCidrCollectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.create_cidr_collection_response.CreateCidrCollectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.create_cidr_collection.create_cidr_collection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_health_check(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.create_health_check_request.CreateHealthCheckRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.create_health_check_response.CreateHealthCheckResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.create_health_check.create_health_check(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_hosted_zone(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.create_hosted_zone_request.CreateHostedZoneRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.create_hosted_zone_response.CreateHostedZoneResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.create_hosted_zone.create_hosted_zone(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_key_signing_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.create_key_signing_key_request.CreateKeySigningKeyRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.create_key_signing_key_response.CreateKeySigningKeyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.create_key_signing_key.create_key_signing_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_query_logging_config(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.create_query_logging_config_request.CreateQueryLoggingConfigRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.create_query_logging_config_response.CreateQueryLoggingConfigResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.create_query_logging_config.create_query_logging_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_reusable_delegation_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.create_reusable_delegation_set_request.CreateReusableDelegationSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.create_reusable_delegation_set_response.CreateReusableDelegationSetResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.create_reusable_delegation_set.create_reusable_delegation_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_traffic_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.create_traffic_policy_request.CreateTrafficPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.create_traffic_policy_response.CreateTrafficPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.create_traffic_policy.create_traffic_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_traffic_policy_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.create_traffic_policy_instance_request.CreateTrafficPolicyInstanceRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.create_traffic_policy_instance_response.CreateTrafficPolicyInstanceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.create_traffic_policy_instance.create_traffic_policy_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_traffic_policy_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.create_traffic_policy_version_request.CreateTrafficPolicyVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.create_traffic_policy_version_response.CreateTrafficPolicyVersionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.create_traffic_policy_version.create_traffic_policy_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_vpc_association_authorization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.create_vpc_association_authorization_request.CreateVPCAssociationAuthorizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.create_vpc_association_authorization_response.CreateVPCAssociationAuthorizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.create_vpc_association_authorization.create_vpc_association_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deactivate_key_signing_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.deactivate_key_signing_key_request.DeactivateKeySigningKeyRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.deactivate_key_signing_key_response.DeactivateKeySigningKeyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.deactivate_key_signing_key.deactivate_key_signing_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cidr_collection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.delete_cidr_collection_request.DeleteCidrCollectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.delete_cidr_collection_response.DeleteCidrCollectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.delete_cidr_collection.delete_cidr_collection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_health_check(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.delete_health_check_request.DeleteHealthCheckRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.delete_health_check_response.DeleteHealthCheckResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.delete_health_check.delete_health_check(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_hosted_zone(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.delete_hosted_zone_request.DeleteHostedZoneRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.delete_hosted_zone_response.DeleteHostedZoneResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.delete_hosted_zone.delete_hosted_zone(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_key_signing_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.delete_key_signing_key_request.DeleteKeySigningKeyRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.delete_key_signing_key_response.DeleteKeySigningKeyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.delete_key_signing_key.delete_key_signing_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_query_logging_config(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.delete_query_logging_config_request.DeleteQueryLoggingConfigRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.delete_query_logging_config_response.DeleteQueryLoggingConfigResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.delete_query_logging_config.delete_query_logging_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_reusable_delegation_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.delete_reusable_delegation_set_request.DeleteReusableDelegationSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.delete_reusable_delegation_set_response.DeleteReusableDelegationSetResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.delete_reusable_delegation_set.delete_reusable_delegation_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_traffic_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.delete_traffic_policy_request.DeleteTrafficPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.delete_traffic_policy_response.DeleteTrafficPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.delete_traffic_policy.delete_traffic_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_traffic_policy_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.delete_traffic_policy_instance_request.DeleteTrafficPolicyInstanceRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.delete_traffic_policy_instance_response.DeleteTrafficPolicyInstanceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.delete_traffic_policy_instance.delete_traffic_policy_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_vpc_association_authorization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.delete_vpc_association_authorization_request.DeleteVPCAssociationAuthorizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.delete_vpc_association_authorization_response.DeleteVPCAssociationAuthorizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.delete_vpc_association_authorization.delete_vpc_association_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_hosted_zone_dnssec(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.disable_hosted_zone_dnssec_request.DisableHostedZoneDNSSECRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.disable_hosted_zone_dnssec_response.DisableHostedZoneDNSSECResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.disable_hosted_zone_dnssec.disable_hosted_zone_dnssec(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_vpc_from_hosted_zone(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.disassociate_vpc_from_hosted_zone_request.DisassociateVPCFromHostedZoneRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.disassociate_vpc_from_hosted_zone_response.DisassociateVPCFromHostedZoneResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.disassociate_vpc_from_hosted_zone.disassociate_vpc_from_hosted_zone(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_hosted_zone_dnssec(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.enable_hosted_zone_dnssec_request.EnableHostedZoneDNSSECRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.enable_hosted_zone_dnssec_response.EnableHostedZoneDNSSECResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.enable_hosted_zone_dnssec.enable_hosted_zone_dnssec(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_account_limit(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_account_limit_request.GetAccountLimitRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_account_limit_response.GetAccountLimitResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_account_limit.get_account_limit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_change(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_change_request.GetChangeRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_change_response.GetChangeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_change.get_change(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_checker_ip_ranges(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_checker_ip_ranges_request.GetCheckerIpRangesRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_checker_ip_ranges_response.GetCheckerIpRangesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_checker_ip_ranges.get_checker_ip_ranges(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_dnssec(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_dnssec_request.GetDNSSECRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_dnssec_response.GetDNSSECResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_dnssec.get_dnssec(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_geo_location(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_geo_location_request.GetGeoLocationRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_geo_location_response.GetGeoLocationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_geo_location.get_geo_location(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_health_check(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_health_check_request.GetHealthCheckRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_health_check_response.GetHealthCheckResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check.get_health_check(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_health_check_count(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_health_check_count_request.GetHealthCheckCountRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_health_check_count_response.GetHealthCheckCountResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check_count.get_health_check_count(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_health_check_last_failure_reason(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_health_check_last_failure_reason_request.GetHealthCheckLastFailureReasonRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_health_check_last_failure_reason_response.GetHealthCheckLastFailureReasonResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check_last_failure_reason.get_health_check_last_failure_reason(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_health_check_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_health_check_status_request.GetHealthCheckStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_health_check_status_response.GetHealthCheckStatusResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_health_check_status.get_health_check_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_hosted_zone(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_hosted_zone_request.GetHostedZoneRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_hosted_zone_response.GetHostedZoneResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_hosted_zone.get_hosted_zone(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_hosted_zone_count(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_hosted_zone_count_request.GetHostedZoneCountRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_hosted_zone_count_response.GetHostedZoneCountResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_hosted_zone_count.get_hosted_zone_count(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_hosted_zone_limit(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_hosted_zone_limit_request.GetHostedZoneLimitRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_hosted_zone_limit_response.GetHostedZoneLimitResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_hosted_zone_limit.get_hosted_zone_limit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_query_logging_config(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_query_logging_config_request.GetQueryLoggingConfigRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_query_logging_config_response.GetQueryLoggingConfigResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_query_logging_config.get_query_logging_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_reusable_delegation_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_reusable_delegation_set_request.GetReusableDelegationSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_reusable_delegation_set_response.GetReusableDelegationSetResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_reusable_delegation_set.get_reusable_delegation_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_reusable_delegation_set_limit(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_reusable_delegation_set_limit_request.GetReusableDelegationSetLimitRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_reusable_delegation_set_limit_response.GetReusableDelegationSetLimitResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_reusable_delegation_set_limit.get_reusable_delegation_set_limit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_traffic_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_traffic_policy_request.GetTrafficPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_traffic_policy_response.GetTrafficPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_traffic_policy.get_traffic_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_traffic_policy_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_traffic_policy_instance_request.GetTrafficPolicyInstanceRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_traffic_policy_instance_response.GetTrafficPolicyInstanceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_traffic_policy_instance.get_traffic_policy_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_traffic_policy_instance_count(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.get_traffic_policy_instance_count_request.GetTrafficPolicyInstanceCountRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.get_traffic_policy_instance_count_response.GetTrafficPolicyInstanceCountResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.get_traffic_policy_instance_count.get_traffic_policy_instance_count(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_cidr_blocks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_cidr_blocks_request.ListCidrBlocksRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_cidr_blocks_response.ListCidrBlocksResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_cidr_blocks.list_cidr_blocks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_cidr_blocks(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[aws_sdk_route_53.types.cidr_block_summary.CidrBlockSummary]":
        _token = next_token
        while True:
    ...
    def list_cidr_collections(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_cidr_collections_request.ListCidrCollectionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_cidr_collections_response.ListCidrCollectionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_cidr_collections.list_cidr_collections(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_cidr_collections(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[aws_sdk_route_53.types.collection_summary.CollectionSummary]":
        _token = next_token
        while True:
    ...
    def list_cidr_locations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_cidr_locations_request.ListCidrLocationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_cidr_locations_response.ListCidrLocationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_cidr_locations.list_cidr_locations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_cidr_locations(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[aws_sdk_route_53.types.location_summary.LocationSummary]":
        _token = next_token
        while True:
    ...
    def list_geo_locations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_geo_locations_request.ListGeoLocationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_geo_locations_response.ListGeoLocationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_geo_locations.list_geo_locations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_health_checks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_health_checks_request.ListHealthChecksRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_health_checks_response.ListHealthChecksResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_health_checks.list_health_checks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_health_checks(
        ...
        *,
        ...
        marker: Optional["aws_sdk_route_53.types.page_marker.PageMarker"] = None,
        max_items: Optional[int] = None,
    ) -> "Iterator[aws_sdk_route_53.types.health_check.HealthCheck]":
        _token = marker
        while True:
    ...
    def list_hosted_zones(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_hosted_zones_request.ListHostedZonesRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_hosted_zones_response.ListHostedZonesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_hosted_zones.list_hosted_zones(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_route_53.types.hosted_zone.HostedZone]":
        _token = marker
        while True:
    ...
    def list_hosted_zones_by_name(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_hosted_zones_by_name_request.ListHostedZonesByNameRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_hosted_zones_by_name_response.ListHostedZonesByNameResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_hosted_zones_by_name.list_hosted_zones_by_name(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_hosted_zones_by_vpc(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_hosted_zones_by_vpc_request.ListHostedZonesByVPCRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_hosted_zones_by_vpc_response.ListHostedZonesByVPCResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_hosted_zones_by_vpc.list_hosted_zones_by_vpc(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_query_logging_configs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_query_logging_configs_request.ListQueryLoggingConfigsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_query_logging_configs_response.ListQueryLoggingConfigsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_query_logging_configs.list_query_logging_configs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_query_logging_configs(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[aws_sdk_route_53.types.query_logging_config.QueryLoggingConfig]":
        _token = next_token
        while True:
    ...
    def list_resource_record_sets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_resource_record_sets_request.ListResourceRecordSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_resource_record_sets_response.ListResourceRecordSetsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_resource_record_sets.list_resource_record_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_reusable_delegation_sets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_reusable_delegation_sets_request.ListReusableDelegationSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_reusable_delegation_sets_response.ListReusableDelegationSetsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_reusable_delegation_sets.list_reusable_delegation_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_tags_for_resources_request.ListTagsForResourcesRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_tags_for_resources_response.ListTagsForResourcesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_tags_for_resources.list_tags_for_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_traffic_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_traffic_policies_request.ListTrafficPoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_traffic_policies_response.ListTrafficPoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policies.list_traffic_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_traffic_policy_instances(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_traffic_policy_instances_request.ListTrafficPolicyInstancesRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_traffic_policy_instances_response.ListTrafficPolicyInstancesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_instances.list_traffic_policy_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_traffic_policy_instances_by_hosted_zone(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_traffic_policy_instances_by_hosted_zone_request.ListTrafficPolicyInstancesByHostedZoneRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_traffic_policy_instances_by_hosted_zone_response.ListTrafficPolicyInstancesByHostedZoneResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_instances_by_hosted_zone.list_traffic_policy_instances_by_hosted_zone(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_traffic_policy_instances_by_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_traffic_policy_instances_by_policy_request.ListTrafficPolicyInstancesByPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_traffic_policy_instances_by_policy_response.ListTrafficPolicyInstancesByPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_instances_by_policy.list_traffic_policy_instances_by_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_traffic_policy_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_traffic_policy_versions_request.ListTrafficPolicyVersionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_traffic_policy_versions_response.ListTrafficPolicyVersionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_traffic_policy_versions.list_traffic_policy_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_vpc_association_authorizations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.list_vpc_association_authorizations_request.ListVPCAssociationAuthorizationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.list_vpc_association_authorizations_response.ListVPCAssociationAuthorizationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.list_vpc_association_authorizations.list_vpc_association_authorizations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_dns_answer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.test_dns_answer_request.TestDNSAnswerRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.test_dns_answer_response.TestDNSAnswerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.test_dns_answer.test_dns_answer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_health_check(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.update_health_check_request.UpdateHealthCheckRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.update_health_check_response.UpdateHealthCheckResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.update_health_check.update_health_check(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_hosted_zone_comment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.update_hosted_zone_comment_request.UpdateHostedZoneCommentRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.update_hosted_zone_comment_response.UpdateHostedZoneCommentResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.update_hosted_zone_comment.update_hosted_zone_comment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_hosted_zone_features(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.update_hosted_zone_features_request.UpdateHostedZoneFeaturesRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.update_hosted_zone_features_response.UpdateHostedZoneFeaturesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.update_hosted_zone_features.update_hosted_zone_features(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_traffic_policy_comment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.update_traffic_policy_comment_request.UpdateTrafficPolicyCommentRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.update_traffic_policy_comment_response.UpdateTrafficPolicyCommentResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.update_traffic_policy_comment.update_traffic_policy_comment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_traffic_policy_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route_53.types.update_traffic_policy_instance_request.UpdateTrafficPolicyInstanceRequest]",
        ) -> OperationResponse[
            "aws_sdk_route_53.types.update_traffic_policy_instance_response.UpdateTrafficPolicyInstanceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route_53._operations.aws_dns_v20130401.update_traffic_policy_instance.update_traffic_policy_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
