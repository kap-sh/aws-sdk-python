...
class Route53Error(Exception):
    """Base class for all Route53 service errors."""


class ServiceError(Route53Error):
...
class SerializationError(Route53Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(Route53Error):
...
class WaiterFailedError(Route53Error):
...
class WaiterTimeoutError(Route53Error):
