...
class VPCAssociationAuthorizationNotFound_(TypedDict):
...
class VPCAssociationAuthorizationNotFound(ServiceError):
    ...
    def __init__(self, data: VPCAssociationAuthorizationNotFound_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_xml(cls, el: Element) -> "VPCAssociationAuthorizationNotFound":
