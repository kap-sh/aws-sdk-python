...
def handle_response(
    ...
    out: aws_sdk_route_53.types.list_cidr_collections_response.ListCidrCollectionsResponse = aws_sdk_route_53.types.list_cidr_collections_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.list_cidr_collections_request.ListCidrCollectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
