"""Generated from Smithy shape ``com.amazonaws.route53#GetHealthCheckLastFailureReason``."""
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.get_health_check_last_failure_reason_response.GetHealthCheckLastFailureReasonResponse = aws_sdk_route_53.types.get_health_check_last_failure_reason_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_health_check_last_failure_reason_request.GetHealthCheckLastFailureReasonRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_health_check_last_failure_reason(
