"""Generated from Smithy shape ``com.amazonaws.route53#ListHealthChecks``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.list_health_checks_request
    import aws_sdk_route_53.types.list_health_checks_response
...
) -> aws_sdk_route_53.types.list_health_checks_response.ListHealthChecksResponse:
    import aws_sdk_route_53.types.list_health_checks_response

    out: aws_sdk_route_53.types.list_health_checks_response.ListHealthChecksResponse = (
        aws_sdk_route_53.types.list_health_checks_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.list_health_checks_request.ListHealthChecksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_health_checks(
