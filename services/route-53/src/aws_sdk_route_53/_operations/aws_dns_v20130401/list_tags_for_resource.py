...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.list_tags_for_resource_request
    import aws_sdk_route_53.types.list_tags_for_resource_response
...
) -> aws_sdk_route_53.types.list_tags_for_resource_response.ListTagsForResourceResponse:
    import aws_sdk_route_53.types.list_tags_for_resource_response

    out: aws_sdk_route_53.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_route_53.types.list_tags_for_resource_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
