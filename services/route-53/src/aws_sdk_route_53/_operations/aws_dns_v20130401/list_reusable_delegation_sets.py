...
def handle_response(
    ...
    out: aws_sdk_route_53.types.list_reusable_delegation_sets_response.ListReusableDelegationSetsResponse = aws_sdk_route_53.types.list_reusable_delegation_sets_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.list_reusable_delegation_sets_request.ListReusableDelegationSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
