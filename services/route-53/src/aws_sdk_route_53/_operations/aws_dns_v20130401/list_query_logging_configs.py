...
def handle_response(
    ...
    out: aws_sdk_route_53.types.list_query_logging_configs_response.ListQueryLoggingConfigsResponse = aws_sdk_route_53.types.list_query_logging_configs_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.list_query_logging_configs_request.ListQueryLoggingConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
