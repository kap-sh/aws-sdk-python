...
import aws_sdk_route_53.errors.vpc_association_authorization_not_found
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "VPCAssociationAuthorizationNotFound":
            raise aws_sdk_route_53.errors.vpc_association_authorization_not_found.VPCAssociationAuthorizationNotFound.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.delete_vpc_association_authorization_response.DeleteVPCAssociationAuthorizationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.delete_vpc_association_authorization_request.DeleteVPCAssociationAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
