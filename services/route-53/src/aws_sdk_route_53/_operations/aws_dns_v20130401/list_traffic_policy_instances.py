...
def handle_response(
    ...
    out: aws_sdk_route_53.types.list_traffic_policy_instances_response.ListTrafficPolicyInstancesResponse = aws_sdk_route_53.types.list_traffic_policy_instances_response.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_route_53.types.list_traffic_policy_instances_request.ListTrafficPolicyInstancesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "hosted_zone_id_marker" in input:
        params["hostedzoneid"] = str(input["hosted_zone_id_marker"])
