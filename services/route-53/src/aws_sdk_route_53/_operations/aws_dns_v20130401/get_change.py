"""Generated from Smithy shape ``com.amazonaws.route53#GetChange``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.get_change_request
    import aws_sdk_route_53.types.get_change_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchChange":
            import aws_sdk_route_53.errors.no_such_change

            raise aws_sdk_route_53.errors.no_such_change.NoSuchChange.from_xml(root)
        case _:
...
) -> aws_sdk_route_53.types.get_change_response.GetChangeResponse:
    import aws_sdk_route_53.types.get_change_response

    out: aws_sdk_route_53.types.get_change_response.GetChangeResponse = (
        aws_sdk_route_53.types.get_change_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_change_request.GetChangeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/change/{Id}"
...
def get_change(
    ...
    aws_sdk_route_53.types.get_change_response.GetChangeResponse, zapros.Response
]:
