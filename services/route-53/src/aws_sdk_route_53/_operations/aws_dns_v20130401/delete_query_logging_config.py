"""Generated from Smithy shape ``com.amazonaws.route53#DeleteQueryLoggingConfig``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.delete_query_logging_config_request
    import aws_sdk_route_53.types.delete_query_logging_config_response
...
) -> aws_sdk_route_53.types.delete_query_logging_config_response.DeleteQueryLoggingConfigResponse:
    out: aws_sdk_route_53.types.delete_query_logging_config_response.DeleteQueryLoggingConfigResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.delete_query_logging_config_request.DeleteQueryLoggingConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_query_logging_config(
