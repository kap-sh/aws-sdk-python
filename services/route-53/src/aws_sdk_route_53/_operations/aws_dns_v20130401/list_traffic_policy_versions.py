...
def handle_response(
    ...
    out: aws_sdk_route_53.types.list_traffic_policy_versions_response.ListTrafficPolicyVersionsResponse = aws_sdk_route_53.types.list_traffic_policy_versions_response.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_route_53.types.list_traffic_policy_versions_request.ListTrafficPolicyVersionsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "traffic_policy_version_marker" in input:
        params["trafficpolicyversion"] = str(input["traffic_policy_version_marker"])
