...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "KeySigningKeyInUse":
            import aws_sdk_route_53.errors.key_signing_key_in_use

            raise aws_sdk_route_53.errors.key_signing_key_in_use.KeySigningKeyInUse.from_xml(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.deactivate_key_signing_key_response.DeactivateKeySigningKeyResponse = aws_sdk_route_53.types.deactivate_key_signing_key_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.deactivate_key_signing_key_request.DeactivateKeySigningKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
