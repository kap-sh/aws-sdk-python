...
def handle_response(
    ...
    out: aws_sdk_route_53.types.get_checker_ip_ranges_response.GetCheckerIpRangesResponse = aws_sdk_route_53.types.get_checker_ip_ranges_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_checker_ip_ranges_request.GetCheckerIpRangesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
