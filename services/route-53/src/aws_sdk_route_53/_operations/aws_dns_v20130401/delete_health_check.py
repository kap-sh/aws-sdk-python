"""Generated from Smithy shape ``com.amazonaws.route53#DeleteHealthCheck``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "HealthCheckInUse":
            import aws_sdk_route_53.errors.health_check_in_use

            raise aws_sdk_route_53.errors.health_check_in_use.HealthCheckInUse.from_xml(
                root
            )
        case "InvalidInput":
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.delete_health_check_response.DeleteHealthCheckResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.delete_health_check_request.DeleteHealthCheckRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_health_check(
