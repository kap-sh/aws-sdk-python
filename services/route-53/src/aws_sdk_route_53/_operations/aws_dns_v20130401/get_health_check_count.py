"""Generated from Smithy shape ``com.amazonaws.route53#GetHealthCheckCount``."""
...
import aws_sdk_route_53.types.get_health_check_count_request
import aws_sdk_route_53.types.get_health_check_count_response
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.get_health_check_count_response.GetHealthCheckCountResponse = aws_sdk_route_53.types.get_health_check_count_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_health_check_count_request.GetHealthCheckCountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/healthcheckcount"
    params: dict[str, str] = {}
...
async def async_get_health_check_count(
