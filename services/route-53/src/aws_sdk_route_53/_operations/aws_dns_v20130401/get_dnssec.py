"""Generated from Smithy shape ``com.amazonaws.route53#GetDNSSEC``."""
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.get_dnssec_response.GetDNSSECResponse = (
        aws_sdk_route_53.types.get_dnssec_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_dnssec_request.GetDNSSECRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/hostedzone/{HostedZoneId}/dnssec"
...
def get_dnssec(
    ...
    aws_sdk_route_53.types.get_dnssec_response.GetDNSSECResponse, zapros.Response
]:
