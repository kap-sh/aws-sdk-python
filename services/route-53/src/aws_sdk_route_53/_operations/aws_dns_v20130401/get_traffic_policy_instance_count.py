"""Generated from Smithy shape ``com.amazonaws.route53#GetTrafficPolicyInstanceCount``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.get_traffic_policy_instance_count_request
    import aws_sdk_route_53.types.get_traffic_policy_instance_count_response
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.get_traffic_policy_instance_count_response.GetTrafficPolicyInstanceCountResponse = aws_sdk_route_53.types.get_traffic_policy_instance_count_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_traffic_policy_instance_count_request.GetTrafficPolicyInstanceCountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/trafficpolicyinstancecount"
    params: dict[str, str] = {}
...
async def async_get_traffic_policy_instance_count(
