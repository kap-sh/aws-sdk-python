...
def handle_response(
    ...
    out: aws_sdk_route_53.types.list_cidr_locations_response.ListCidrLocationsResponse = aws_sdk_route_53.types.list_cidr_locations_response.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_route_53.types.list_cidr_locations_request.ListCidrLocationsRequest,
) -> zapros.Request:
