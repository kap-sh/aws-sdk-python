...
def build_request(
    ...
    input: aws_sdk_route_53.types.update_traffic_policy_comment_request.UpdateTrafficPolicyCommentRequest,
) -> zapros.Request:
    ...
    url = url.replace("{Version}", quote(str(input["version"]), safe=""))
    params: dict[str, str] = {}
