...
def handle_response(
    ...
    out: aws_sdk_route_53.types.delete_key_signing_key_response.DeleteKeySigningKeyResponse = aws_sdk_route_53.types.delete_key_signing_key_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.delete_key_signing_key_request.DeleteKeySigningKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
