"""Generated from Smithy shape ``com.amazonaws.route53#DeleteCidrCollection``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.delete_cidr_collection_request
    import aws_sdk_route_53.types.delete_cidr_collection_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CidrCollectionInUseException":
            import aws_sdk_route_53.errors.cidr_collection_in_use_exception

            raise aws_sdk_route_53.errors.cidr_collection_in_use_exception.CidrCollectionInUseException.from_xml(
                root
            )
...
def handle_response(
    ...
    aws_sdk_route_53.types.delete_cidr_collection_response.DeleteCidrCollectionResponse
):
    out: aws_sdk_route_53.types.delete_cidr_collection_response.DeleteCidrCollectionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.delete_cidr_collection_request.DeleteCidrCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_cidr_collection(
