"""Generated from Smithy shape ``com.amazonaws.route53#ListGeoLocations``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.list_geo_locations_request
    import aws_sdk_route_53.types.list_geo_locations_response
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.list_geo_locations_response.ListGeoLocationsResponse = (
        aws_sdk_route_53.types.list_geo_locations_response.deserialize_xml(
