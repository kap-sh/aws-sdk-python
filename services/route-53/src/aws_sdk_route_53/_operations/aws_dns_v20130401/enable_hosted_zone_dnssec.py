"""Generated from Smithy shape ``com.amazonaws.route53#EnableHostedZoneDNSSEC``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.enable_hosted_zone_dnssec_request
    import aws_sdk_route_53.types.enable_hosted_zone_dnssec_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "HostedZonePartiallyDelegated":
            import aws_sdk_route_53.errors.hosted_zone_partially_delegated

            raise aws_sdk_route_53.errors.hosted_zone_partially_delegated.HostedZonePartiallyDelegated.from_xml(
                root
            )
        ...
        case "KeySigningKeyWithActiveStatusNotFound":
            import aws_sdk_route_53.errors.key_signing_key_with_active_status_not_found

            raise aws_sdk_route_53.errors.key_signing_key_with_active_status_not_found.KeySigningKeyWithActiveStatusNotFound.from_xml(
                root
            )
...
) -> aws_sdk_route_53.types.enable_hosted_zone_dnssec_response.EnableHostedZoneDNSSECResponse:
    import aws_sdk_route_53.types.enable_hosted_zone_dnssec_response

    out: aws_sdk_route_53.types.enable_hosted_zone_dnssec_response.EnableHostedZoneDNSSECResponse = aws_sdk_route_53.types.enable_hosted_zone_dnssec_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.enable_hosted_zone_dnssec_request.EnableHostedZoneDNSSECRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_enable_hosted_zone_dnssec(
