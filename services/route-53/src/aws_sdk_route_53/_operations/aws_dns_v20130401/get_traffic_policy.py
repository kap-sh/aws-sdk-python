"""Generated from Smithy shape ``com.amazonaws.route53#GetTrafficPolicy``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.get_traffic_policy_request
    import aws_sdk_route_53.types.get_traffic_policy_response
...
) -> aws_sdk_route_53.types.get_traffic_policy_response.GetTrafficPolicyResponse:
    import aws_sdk_route_53.types.get_traffic_policy_response

    out: aws_sdk_route_53.types.get_traffic_policy_response.GetTrafficPolicyResponse = (
        aws_sdk_route_53.types.get_traffic_policy_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_traffic_policy_request.GetTrafficPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
