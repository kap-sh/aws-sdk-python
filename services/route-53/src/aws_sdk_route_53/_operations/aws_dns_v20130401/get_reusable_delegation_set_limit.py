...
import aws_sdk_route_53.types.reusable_delegation_set_limit
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.get_reusable_delegation_set_limit_response.GetReusableDelegationSetLimitResponse = aws_sdk_route_53.types.get_reusable_delegation_set_limit_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_reusable_delegation_set_limit_request.GetReusableDelegationSetLimitRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
