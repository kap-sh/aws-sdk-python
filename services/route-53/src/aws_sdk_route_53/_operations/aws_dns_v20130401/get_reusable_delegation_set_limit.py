...
def build_request(
    ...
    input: aws_sdk_route_53.types.get_reusable_delegation_set_limit_request.GetReusableDelegationSetLimitRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{DelegationSetId}", quote(str(input["delegation_set_id"]), safe="")
    )
    params: dict[str, str] = {}
