"""Generated from Smithy shape ``com.amazonaws.route53#GetHostedZone``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.get_hosted_zone_request
    import aws_sdk_route_53.types.get_hosted_zone_response
...
) -> aws_sdk_route_53.types.get_hosted_zone_response.GetHostedZoneResponse:
    import aws_sdk_route_53.types.get_hosted_zone_response

    out: aws_sdk_route_53.types.get_hosted_zone_response.GetHostedZoneResponse = (
        aws_sdk_route_53.types.get_hosted_zone_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_hosted_zone_request.GetHostedZoneRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_hosted_zone(
