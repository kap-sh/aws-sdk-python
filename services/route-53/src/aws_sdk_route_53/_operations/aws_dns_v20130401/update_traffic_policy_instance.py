...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.update_traffic_policy_instance_request
    import aws_sdk_route_53.types.update_traffic_policy_instance_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictingTypes":
            import aws_sdk_route_53.errors.conflicting_types

            raise aws_sdk_route_53.errors.conflicting_types.ConflictingTypes.from_xml(
                root
            )
        case "InvalidInput":
...
) -> aws_sdk_route_53.types.update_traffic_policy_instance_response.UpdateTrafficPolicyInstanceResponse:
    import aws_sdk_route_53.types.update_traffic_policy_instance_response

    out: aws_sdk_route_53.types.update_traffic_policy_instance_response.UpdateTrafficPolicyInstanceResponse = aws_sdk_route_53.types.update_traffic_policy_instance_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.update_traffic_policy_instance_request.UpdateTrafficPolicyInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
