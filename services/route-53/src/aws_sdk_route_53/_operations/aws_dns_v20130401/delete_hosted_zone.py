...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "HostedZoneNotEmpty":
            import aws_sdk_route_53.errors.hosted_zone_not_empty

            raise aws_sdk_route_53.errors.hosted_zone_not_empty.HostedZoneNotEmpty.from_xml(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.delete_hosted_zone_response.DeleteHostedZoneResponse = (
        aws_sdk_route_53.types.delete_hosted_zone_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.delete_hosted_zone_request.DeleteHostedZoneRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
