...
def handle_response(
    ...
    out: aws_sdk_route_53.types.get_traffic_policy_instance_response.GetTrafficPolicyInstanceResponse = aws_sdk_route_53.types.get_traffic_policy_instance_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_traffic_policy_instance_request.GetTrafficPolicyInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
