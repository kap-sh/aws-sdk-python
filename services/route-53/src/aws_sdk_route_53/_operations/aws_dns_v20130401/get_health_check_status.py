"""Generated from Smithy shape ``com.amazonaws.route53#GetHealthCheckStatus``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.get_health_check_status_request
    import aws_sdk_route_53.types.get_health_check_status_response
...
def handle_response(
    ...
    aws_sdk_route_53.types.get_health_check_status_response.GetHealthCheckStatusResponse
):
    import aws_sdk_route_53.types.get_health_check_status_response

    out: aws_sdk_route_53.types.get_health_check_status_response.GetHealthCheckStatusResponse = aws_sdk_route_53.types.get_health_check_status_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_health_check_status_request.GetHealthCheckStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/healthcheck/{HealthCheckId}/status"
...
async def async_get_health_check_status(
