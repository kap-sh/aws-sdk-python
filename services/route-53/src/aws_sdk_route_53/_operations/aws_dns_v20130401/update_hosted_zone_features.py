...
def handle_response(
    ...
    out: aws_sdk_route_53.types.update_hosted_zone_features_response.UpdateHostedZoneFeaturesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_route_53.types.update_hosted_zone_features_request.UpdateHostedZoneFeaturesRequest,
) -> zapros.Request:
    ...
    if "enable_accelerated_recovery" in input:
        SubElement(root, "EnableAcceleratedRecovery").text = str(
            input["enable_accelerated_recovery"]
        )
