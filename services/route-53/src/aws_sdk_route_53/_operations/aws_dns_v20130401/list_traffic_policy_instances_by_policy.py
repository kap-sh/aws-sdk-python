...
def build_request(
    ...
    input: aws_sdk_route_53.types.list_traffic_policy_instances_by_policy_request.ListTrafficPolicyInstancesByPolicyRequest,
) -> zapros.Request:
    ...
    if "traffic_policy_id" in input:
        params["id"] = str(input["traffic_policy_id"])
    if "traffic_policy_version" in input:
        params["version"] = str(input["traffic_policy_version"])
