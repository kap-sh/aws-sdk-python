"""Generated from Smithy shape ``com.amazonaws.route53#GetHostedZoneCount``."""
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.get_hosted_zone_count_response.GetHostedZoneCountResponse = aws_sdk_route_53.types.get_hosted_zone_count_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_hosted_zone_count_request.GetHostedZoneCountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/hostedzonecount"
    params: dict[str, str] = {}
...
async def async_get_hosted_zone_count(
