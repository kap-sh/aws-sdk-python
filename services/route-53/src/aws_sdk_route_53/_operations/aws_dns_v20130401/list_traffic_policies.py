"""Generated from Smithy shape ``com.amazonaws.route53#ListTrafficPolicies``."""
...
import aws_sdk_route_53.types.list_traffic_policies_request
import aws_sdk_route_53.types.list_traffic_policies_response
...
) -> aws_sdk_route_53.types.list_traffic_policies_response.ListTrafficPoliciesResponse:
    out: aws_sdk_route_53.types.list_traffic_policies_response.ListTrafficPoliciesResponse = aws_sdk_route_53.types.list_traffic_policies_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.list_traffic_policies_request.ListTrafficPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2013-04-01/trafficpolicies"
    params: dict[str, str] = {}
    if "traffic_policy_id_marker" in input_:
        params["trafficpolicyid"] = str(input_["traffic_policy_id_marker"])
...
async def async_list_traffic_policies(
