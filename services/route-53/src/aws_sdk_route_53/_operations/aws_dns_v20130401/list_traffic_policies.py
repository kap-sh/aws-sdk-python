...
def build_request(
    ...
    input: aws_sdk_route_53.types.list_traffic_policies_request.ListTrafficPoliciesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "traffic_policy_id_marker" in input:
        params["trafficpolicyid"] = str(input["traffic_policy_id_marker"])
