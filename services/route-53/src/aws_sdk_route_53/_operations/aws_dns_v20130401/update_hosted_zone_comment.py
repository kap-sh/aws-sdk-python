...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.update_hosted_zone_comment_request
    import aws_sdk_route_53.types.update_hosted_zone_comment_response
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.update_hosted_zone_comment_response.UpdateHostedZoneCommentResponse = aws_sdk_route_53.types.update_hosted_zone_comment_response.deserialize_xml(
