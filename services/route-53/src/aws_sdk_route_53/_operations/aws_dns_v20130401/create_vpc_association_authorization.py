...
def build_request(
    ...
    input: aws_sdk_route_53.types.create_vpc_association_authorization_request.CreateVPCAssociationAuthorizationRequest,
) -> zapros.Request:
    ...
    if "vpc" in input:
        ...
        aws_sdk_route_53.types.vpc.serialize_xml(input["vpc"], root, "VPC")
