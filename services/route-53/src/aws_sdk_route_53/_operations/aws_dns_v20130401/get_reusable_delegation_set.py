...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.get_reusable_delegation_set_request
    import aws_sdk_route_53.types.get_reusable_delegation_set_response
...
) -> aws_sdk_route_53.types.get_reusable_delegation_set_response.GetReusableDelegationSetResponse:
    import aws_sdk_route_53.types.get_reusable_delegation_set_response

    out: aws_sdk_route_53.types.get_reusable_delegation_set_response.GetReusableDelegationSetResponse = aws_sdk_route_53.types.get_reusable_delegation_set_response.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_route_53.types.get_reusable_delegation_set_request.GetReusableDelegationSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
