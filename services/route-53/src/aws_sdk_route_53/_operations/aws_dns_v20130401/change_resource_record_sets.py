"""Generated from Smithy shape ``com.amazonaws.route53#ChangeResourceRecordSets``."""
...
if TYPE_CHECKING:
    import aws_sdk_route_53.types.change_resource_record_sets_request
    import aws_sdk_route_53.types.change_resource_record_sets_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidChangeBatch":
            import aws_sdk_route_53.errors.invalid_change_batch

            raise aws_sdk_route_53.errors.invalid_change_batch.InvalidChangeBatch.from_xml(
                root
            )
        case "InvalidInput":
...
def handle_response(
    ...
    out: aws_sdk_route_53.types.change_resource_record_sets_response.ChangeResourceRecordSetsResponse = aws_sdk_route_53.types.change_resource_record_sets_response.deserialize_xml(
