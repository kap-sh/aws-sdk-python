...
from aws_sdk_route_53._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://route53-fips.global.api.aws'

def test_for_region_us_east_1_with_fips_enabled_a():
    """For region us-east-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://route53-fips.amazonaws.com'
...
def test_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://route53.global.api.aws'

def test_for_region_us_east_1_with_fips_disabled_():
    """For region us-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://route53.amazonaws.com'
...
def test_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://route53-fips.api.amazonwebservices.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://route53-fips.amazonaws.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://route53.global.api.amazonwebservices.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://route53.amazonaws.com.cn'
...
def test_for_region_eusc_de_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://route53-fips.amazonaws.eu'
...
def test_for_region_eusc_de_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://route53.amazonaws.eu'
...
def test_for_region_us_iso_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://route53-fips.c2s.ic.gov'
...
def test_for_region_us_iso_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://route53.c2s.ic.gov'
...
def test_for_region_us_isob_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://route53-fips.sc2s.sgov.gov'
...
def test_for_region_us_isob_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://route53.sc2s.sgov.gov'
...
def test_for_region_eu_isoe_west_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://route53-fips.cloud.adc-e.uk'
...
def test_for_region_eu_isoe_west_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://route53.cloud.adc-e.uk'
...
def test_for_region_us_isof_south_1_with_fips_ena():
    ...
    result = resolve(params)
    assert result.url == 'https://route53-fips.csp.hci.ic.gov'
...
def test_for_region_us_isof_south_1_with_fips_dis():
    ...
    result = resolve(params)
    assert result.url == 'https://route53.csp.hci.ic.gov'
...
def test_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://route53.us-gov.api.aws'
...
def test_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://route53.us-gov.amazonaws.com'
