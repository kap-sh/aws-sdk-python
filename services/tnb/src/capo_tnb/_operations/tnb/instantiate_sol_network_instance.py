"""Generated from Smithy shape ``com.amazonaws.tnb#InstantiateSolNetworkInstance``."""
...
import capo_tnb.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_tnb.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_tnb.types.instantiate_sol_network_instance_output.InstantiateSolNetworkInstanceOutput = capo_tnb.types.instantiate_sol_network_instance_output.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_tnb._auth._sigv4.build_sigv4_auth_scheme("tnb", options.region)
        )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_tnb.types.instantiate_sol_network_instance_input.serialize_json(input_)
    ).encode()
...
async def async_instantiate_sol_network_instance(
