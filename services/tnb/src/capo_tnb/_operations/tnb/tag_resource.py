"""Generated from Smithy shape ``com.amazonaws.tnb#TagResource``."""
...
def handle_response(
    ...
    out: capo_tnb.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_tnb.types.tag_resource_input.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: capo_tnb.types.tag_resource_input.TagResourceInput,
) -> tuple[capo_tnb.types.tag_resource_output.TagResourceOutput, zapros.Response]:
