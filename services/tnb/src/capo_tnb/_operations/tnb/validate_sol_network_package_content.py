...
import capo_tnb.types.validate_sol_network_package_content_metadata
...
def handle_response(
    ...
    out: capo_tnb.types.validate_sol_network_package_content_output.ValidateSolNetworkPackageContentOutput = capo_tnb.types.validate_sol_network_package_content_output.deserialize_json(
...
def build_request(
    ...
    if "file" in input_:
        body: bytes | None = json.dumps(
            capo_tnb.types.sensitive_blob.serialize_json(input_["file"])
        ).encode()
