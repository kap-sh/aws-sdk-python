"""Generated from Smithy shape ``com.amazonaws.tnb#GetSolNetworkPackage``."""
...
def handle_response(
    ...
    out: capo_tnb.types.get_sol_network_package_output.GetSolNetworkPackageOutput = (
        capo_tnb.types.get_sol_network_package_output.deserialize_json(
...
async def async_get_sol_network_package(
