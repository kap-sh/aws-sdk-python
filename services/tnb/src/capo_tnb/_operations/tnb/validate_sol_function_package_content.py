...
def handle_response(
    ...
    out: capo_tnb.types.validate_sol_function_package_content_output.ValidateSolFunctionPackageContentOutput = capo_tnb.types.validate_sol_function_package_content_output.deserialize_json(
