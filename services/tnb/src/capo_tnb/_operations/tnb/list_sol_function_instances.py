...
def handle_response(
    ...
    out: capo_tnb.types.list_sol_function_instances_output.ListSolFunctionInstancesOutput = capo_tnb.types.list_sol_function_instances_output.deserialize_json(
