...
import capo_tnb.types.list_sol_network_operations_resources
...
def handle_response(
    ...
    out: capo_tnb.types.list_sol_network_operations_output.ListSolNetworkOperationsOutput = capo_tnb.types.list_sol_network_operations_output.deserialize_json(
