"""Generated from Smithy shape ``com.amazonaws.tnb#ListSolFunctionPackages``."""
...
import capo_tnb.types.list_sol_function_package_resources
...
def handle_response(
    ...
    out: capo_tnb.types.list_sol_function_packages_output.ListSolFunctionPackagesOutput = capo_tnb.types.list_sol_function_packages_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sol/vnfpkgm/v1/vnf_packages"
    params: dict[str, str] = {}
...
async def async_list_sol_function_packages(
