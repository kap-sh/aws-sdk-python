"""Generated from Smithy shape ``com.amazonaws.tnb#DeleteSolNetworkInstance``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sol/nslcm/v1/ns_instances/{nsInstanceId}"
...
async def async_delete_sol_network_instance(
