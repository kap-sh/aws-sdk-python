"""Generated from Smithy shape ``com.amazonaws.tnb#PutSolNetworkPackageContent``."""
...
def handle_response(
    ...
    out: capo_tnb.types.put_sol_network_package_content_output.PutSolNetworkPackageContentOutput = capo_tnb.types.put_sol_network_package_content_output.deserialize_json(
...
async def async_put_sol_network_package_content(
