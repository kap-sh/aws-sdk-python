...
class tnbError(Exception):
    """Base class for all tnb service errors."""


class ServiceError(tnbError):
...
class SerializationError(tnbError):
    """Raised when a value cannot be serialized."""


class DeserializationError(tnbError):
...
class WaiterFailedError(tnbError):
...
class WaiterTimeoutError(tnbError):
