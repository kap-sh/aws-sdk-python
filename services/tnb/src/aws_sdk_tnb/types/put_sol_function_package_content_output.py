...
if TYPE_CHECKING:
    import aws_sdk_tnb.types.put_sol_function_package_content_metadata
    import aws_sdk_tnb.types.vnf_pkg_id
    import aws_sdk_tnb.types.vnfd_id


class PutSolFunctionPackageContentOutput(TypedDict):
    ...
    metadata: "aws_sdk_tnb.types.put_sol_function_package_content_metadata.PutSolFunctionPackageContentMetadata"
...
def serialize_json(value: PutSolFunctionPackageContentOutput) -> dict:
    ...
    out["metadata"] = (
        aws_sdk_tnb.types.put_sol_function_package_content_metadata.serialize_json(
            value["metadata"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> PutSolFunctionPackageContentOutput:
    ...
    if "metadata" in data:
        ...
        out["metadata"] = (
            aws_sdk_tnb.types.put_sol_function_package_content_metadata.deserialize_json(
                data["metadata"]
            )
        )
    else:
