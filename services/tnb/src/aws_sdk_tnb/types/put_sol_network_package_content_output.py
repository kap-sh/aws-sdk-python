...
if TYPE_CHECKING:
    ...
    import aws_sdk_tnb.types.put_sol_network_package_content_metadata
    import aws_sdk_tnb.types.vnf_pkg_id_list


class PutSolNetworkPackageContentOutput(TypedDict):
    ...
    metadata: "aws_sdk_tnb.types.put_sol_network_package_content_metadata.PutSolNetworkPackageContentMetadata"
...
def serialize_json(value: PutSolNetworkPackageContentOutput) -> dict:
    ...
    out["metadata"] = (
        aws_sdk_tnb.types.put_sol_network_package_content_metadata.serialize_json(
            value["metadata"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> PutSolNetworkPackageContentOutput:
    ...
    if "metadata" in data:
        ...
        out["metadata"] = (
            aws_sdk_tnb.types.put_sol_network_package_content_metadata.deserialize_json(
                data["metadata"]
            )
        )
    else:
