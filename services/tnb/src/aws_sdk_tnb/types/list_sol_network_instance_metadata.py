"""Generated from Smithy shape ``com.amazonaws.tnb#ListSolNetworkInstanceMetadata``."""
...
class ListSolNetworkInstanceMetadata(TypedDict, closed=True):
...
def deserialize_json(data: dict) -> ListSolNetworkInstanceMetadata:
    ...
    if "lastModified" in data:
        ...
        raise DeserializationError(
            "ListSolNetworkInstanceMetadata.last_modified required"
        )
    return out
