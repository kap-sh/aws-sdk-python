"""Generated from Smithy shape ``com.amazonaws.tnb#AccessDeniedException``."""

from typing import TypedDict
from aws_sdk_tnb.errors import DeserializationError
from aws_sdk_tnb.errors import ServiceError
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.tnb#AccessDeniedException``."""
