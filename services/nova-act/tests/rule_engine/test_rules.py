...
from aws_sdk_nova_act._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.us-east-1.api.aws'

def test_for_region_us_east_1_with_fips_enabled_a():
    """For region us-east-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.us-east-1.amazonaws.com'
...
def test_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act.us-east-1.api.aws'

def test_for_region_us_east_1_with_fips_disabled_():
    """For region us-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://nova-act.us-east-1.amazonaws.com'
...
def test_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.cn-northwest-1.amazonaws.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act.cn-northwest-1.amazonaws.com.cn'
...
def test_for_region_eusc_de_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.eusc-de-east-1.amazonaws.eu'
...
def test_for_region_eusc_de_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act.eusc-de-east-1.amazonaws.eu'
...
def test_for_region_us_iso_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.us-iso-east-1.c2s.ic.gov'
...
def test_for_region_us_iso_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act.us-iso-east-1.c2s.ic.gov'
...
def test_for_region_us_isob_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.us-isob-east-1.sc2s.sgov.gov'
...
def test_for_region_us_isob_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act.us-isob-east-1.sc2s.sgov.gov'
...
def test_for_region_eu_isoe_west_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.eu-isoe-west-1.cloud.adc-e.uk'
...
def test_for_region_eu_isoe_west_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act.eu-isoe-west-1.cloud.adc-e.uk'
...
def test_for_region_us_isof_south_1_with_fips_ena():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.us-isof-south-1.csp.hci.ic.gov'
...
def test_for_region_us_isof_south_1_with_fips_dis():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act.us-isof-south-1.csp.hci.ic.gov'
...
def test_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.us-gov-west-1.api.aws'
...
def test_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act-fips.us-gov-west-1.amazonaws.com'
...
def test_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act.us-gov-west-1.api.aws'
...
def test_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://nova-act.us-gov-west-1.amazonaws.com'
