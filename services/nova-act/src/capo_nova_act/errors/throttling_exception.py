...
class ThrottlingException_(TypedDict, closed=True):
    ...
    service_code: NotRequired["capo_nova_act.types.non_blank_string.NonBlankString"]
    """<p>The service code where throttling occurred.</p>"""
    quota_code: NotRequired["capo_nova_act.types.non_blank_string.NonBlankString"]
