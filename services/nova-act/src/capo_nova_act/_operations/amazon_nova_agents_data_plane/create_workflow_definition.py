"""Generated from Smithy shape ``com.amazonaws.novaact#CreateWorkflowDefinition``."""
...
def handle_response(
    ...
    out: capo_nova_act.types.create_workflow_definition_response.CreateWorkflowDefinitionResponse = capo_nova_act.types.create_workflow_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_nova_act.types.create_workflow_definition_request.serialize_json(input_)
    ).encode()
