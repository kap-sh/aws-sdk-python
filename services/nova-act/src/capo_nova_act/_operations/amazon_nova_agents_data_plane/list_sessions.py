"""Generated from Smithy shape ``com.amazonaws.novaact#ListSessions``."""
...
def handle_response(
    ...
    out: capo_nova_act.types.list_sessions_response.ListSessionsResponse = (
        capo_nova_act.types.list_sessions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_nova_act.types.list_sessions_request.serialize_json(input_)
    ).encode()
...
def list_sessions(
    ...
    capo_nova_act.types.list_sessions_response.ListSessionsResponse, zapros.Response
]:
