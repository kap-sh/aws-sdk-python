...
import capo_nova_act.types.workflow_definition_summaries
...
def handle_response(
    ...
    out: capo_nova_act.types.list_workflow_definitions_response.ListWorkflowDefinitionsResponse = capo_nova_act.types.list_workflow_definitions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_nova_act.types.list_workflow_definitions_request.serialize_json(input_)
    ).encode()
