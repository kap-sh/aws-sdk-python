"""Generated from Smithy shape ``com.amazonaws.novaact#UpdateWorkflowRun``."""
...
def handle_response(
    ...
    out: capo_nova_act.types.update_workflow_run_response.UpdateWorkflowRunResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_nova_act.types.update_workflow_run_request.serialize_json(input_)
    ).encode()
...
async def async_update_workflow_run(
