"""Generated from Smithy shape ``com.amazonaws.novaact#InvokeActStep``."""
...
import capo_nova_act.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_nova_act.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_nova_act.types.invoke_act_step_response.InvokeActStepResponse = (
        capo_nova_act.types.invoke_act_step_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_nova_act.types.invoke_act_step_request.serialize_json(input_)
    ).encode()
...
def invoke_act_step(
    ...
    capo_nova_act.types.invoke_act_step_response.InvokeActStepResponse, zapros.Response
]:
...
async def async_invoke_act_step(
