...
def handle_response(
    ...
    out: capo_nova_act.types.create_workflow_run_response.CreateWorkflowRunResponse = (
        capo_nova_act.types.create_workflow_run_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_nova_act.types.create_workflow_run_request.serialize_json(input_)
    ).encode()
