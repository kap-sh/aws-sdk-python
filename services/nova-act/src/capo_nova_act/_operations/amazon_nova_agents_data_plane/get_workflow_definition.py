...
def handle_response(
    ...
    out: capo_nova_act.types.get_workflow_definition_response.GetWorkflowDefinitionResponse = capo_nova_act.types.get_workflow_definition_response.deserialize_json(
