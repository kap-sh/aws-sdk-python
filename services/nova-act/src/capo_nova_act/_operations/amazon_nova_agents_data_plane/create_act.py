...
def handle_response(
    ...
    out: capo_nova_act.types.create_act_response.CreateActResponse = (
        capo_nova_act.types.create_act_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_nova_act.types.create_act_request.serialize_json(input_)
    ).encode()
...
def create_act(
    ...
    input_: capo_nova_act.types.create_act_request.CreateActRequest,
) -> tuple[capo_nova_act.types.create_act_response.CreateActResponse, zapros.Response]:
