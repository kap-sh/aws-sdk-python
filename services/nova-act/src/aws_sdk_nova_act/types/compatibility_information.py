...
if TYPE_CHECKING:
    import aws_sdk_nova_act.types.model_id_list
...
class CompatibilityInformation(TypedDict, closed=True):
    ...
    message: NotRequired["aws_sdk_nova_act.types.non_blank_string.NonBlankString"]
...
def serialize_json(value: CompatibilityInformation) -> dict:
    ...
    out["supportedModelIds"] = aws_sdk_nova_act.types.model_id_list.serialize_json(
...
def deserialize_json(data: dict) -> CompatibilityInformation:
    ...
    if "supportedModelIds" in data:
        ...
        out["supported_model_ids"] = (
            aws_sdk_nova_act.types.model_id_list.deserialize_json(
