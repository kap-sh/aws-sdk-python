"""Generated from Smithy shape ``com.amazonaws.novaact#ThrottlingException``."""
...
class ThrottlingException_(TypedDict, closed=True):
    ...
    service_code: NotRequired["aws_sdk_nova_act.types.non_blank_string.NonBlankString"]
    """<p>The service code where throttling occurred.</p>"""
    quota_code: NotRequired["aws_sdk_nova_act.types.non_blank_string.NonBlankString"]
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.novaact#ThrottlingException``."""
