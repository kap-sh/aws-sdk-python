...
if TYPE_CHECKING:
    import aws_sdk_nova_act.types.internal_server_exception_reason
...
class InternalServerException_(TypedDict, closed=True):
    ...
    reason: NotRequired[
        "aws_sdk_nova_act.types.internal_server_exception_reason.InternalServerExceptionReason"
    ]
...
def serialize_json(value: InternalServerException_) -> dict:
    ...
    if "reason" in value:
        ...
        out["reason"] = (
            aws_sdk_nova_act.types.internal_server_exception_reason.serialize_json(
                value["reason"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> InternalServerException_:
    ...
    if "reason" in data:
        ...
        out["reason"] = (
            aws_sdk_nova_act.types.internal_server_exception_reason.deserialize_json(
                data["reason"]
            )
        )
    return out
