...
class AsyncBackupSearchClient:
    ...
    def __init__(
        ...
        self.config = AsyncBackupSearchClientConfig(
            {
    ...
    async def list_search_job_backups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_backupsearch.types.list_search_job_backups_input.ListSearchJobBackupsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_backupsearch.types.list_search_job_backups_output.ListSearchJobBackupsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_backupsearch._operations.cryo_backup_search_service.list_search_job_backups.async_list_search_job_backups(
    ...
    async def iter_list_search_job_backups(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[aws_sdk_backupsearch.types.search_job_backups_result.SearchJobBackupsResult]":
        _token = next_token
        while True:
    ...
    async def list_search_job_results(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_backupsearch.types.list_search_job_results_input.ListSearchJobResultsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_backupsearch.types.list_search_job_results_output.ListSearchJobResultsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_backupsearch._operations.cryo_backup_search_service.list_search_job_results.async_list_search_job_results(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_backupsearch.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_backupsearch.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_backupsearch._operations.cryo_backup_search_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_backupsearch.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_backupsearch.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_backupsearch._operations.cryo_backup_search_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_backupsearch.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_backupsearch.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_backupsearch._operations.cryo_backup_search_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
