...
def handle_response(
    ...
    out: aws_sdk_backupsearch.types.list_search_job_backups_output.ListSearchJobBackupsOutput = aws_sdk_backupsearch.types.list_search_job_backups_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backupsearch.types.list_search_job_backups_input.ListSearchJobBackupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
