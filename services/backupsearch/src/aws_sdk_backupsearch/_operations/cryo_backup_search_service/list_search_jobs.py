...
def handle_response(
    ...
    out: aws_sdk_backupsearch.types.list_search_jobs_output.ListSearchJobsOutput = (
        aws_sdk_backupsearch.types.list_search_jobs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backupsearch.types.list_search_jobs_input.ListSearchJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
