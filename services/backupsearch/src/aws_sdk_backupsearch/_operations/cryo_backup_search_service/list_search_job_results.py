...
def handle_response(
    ...
    out: aws_sdk_backupsearch.types.list_search_job_results_output.ListSearchJobResultsOutput = aws_sdk_backupsearch.types.list_search_job_results_output.deserialize_json(
