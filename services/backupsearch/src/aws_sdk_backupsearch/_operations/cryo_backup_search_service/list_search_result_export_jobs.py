...
def handle_response(
    ...
    out: aws_sdk_backupsearch.types.list_search_result_export_jobs_output.ListSearchResultExportJobsOutput = aws_sdk_backupsearch.types.list_search_result_export_jobs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backupsearch.types.list_search_result_export_jobs_input.ListSearchResultExportJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
