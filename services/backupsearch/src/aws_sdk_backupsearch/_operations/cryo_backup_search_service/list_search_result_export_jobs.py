...
def build_request(
    ...
    input: aws_sdk_backupsearch.types.list_search_result_export_jobs_input.ListSearchResultExportJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "search_job_identifier" in input:
        params["SearchJobIdentifier"] = str(input["search_job_identifier"])
