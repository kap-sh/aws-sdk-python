...
def handle_response(
    ...
    out: aws_sdk_backupsearch.types.start_search_job_output.StartSearchJobOutput = (
        aws_sdk_backupsearch.types.start_search_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backupsearch.types.start_search_job_input.StartSearchJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backupsearch.types.start_search_job_input.serialize_json(input_)
    ).encode()
