"""Generated from Smithy shape ``com.amazonaws.backupsearch#GetSearchJob``."""
...
def handle_response(
    ...
    out: aws_sdk_backupsearch.types.get_search_job_output.GetSearchJobOutput = (
        aws_sdk_backupsearch.types.get_search_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backupsearch.types.get_search_job_input.GetSearchJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-jobs/{SearchJobIdentifier}"
    url = url.replace(
...
def get_search_job(
    ...
    aws_sdk_backupsearch.types.get_search_job_output.GetSearchJobOutput, zapros.Response
]:
...
async def async_get_search_job(
