...
if TYPE_CHECKING:
    ...
    import aws_sdk_backupsearch.types.current_search_progress
...
class GetSearchJobOutput(TypedDict):
    ...
    current_search_progress: NotRequired[
        "aws_sdk_backupsearch.types.current_search_progress.CurrentSearchProgress"
    ]
    ...
    status: "aws_sdk_backupsearch.types.search_job_state.SearchJobState"
    ...
    item_filters: "aws_sdk_backupsearch.types.item_filters.ItemFilters"
    ...
    search_job_arn: "aws_sdk_backupsearch.types.search_job_arn.SearchJobArn"
...
def serialize_json(value: GetSearchJobOutput) -> dict:
    ...
    if "current_search_progress" in value:
        ...
        out["CurrentSearchProgress"] = (
            aws_sdk_backupsearch.types.current_search_progress.serialize_json(
    ...
    out["SearchScope"] = aws_sdk_backupsearch.types.search_scope.serialize_json(
        value["search_scope"]
    )
    import aws_sdk_backupsearch.types.item_filters

    out["ItemFilters"] = aws_sdk_backupsearch.types.item_filters.serialize_json(
        value["item_filters"]
    )
    import aws_sdk_backupsearch.types._prelude.timestamp

    out["CreationTime"] = aws_sdk_backupsearch.types._prelude.timestamp.serialize_json(
        value["creation_time"]
    )
...
def deserialize_json(data: dict) -> GetSearchJobOutput:
    ...
    if "CurrentSearchProgress" in data:
        ...
        out["current_search_progress"] = (
            aws_sdk_backupsearch.types.current_search_progress.deserialize_json(
    ...
    if "SearchScope" in data:
        ...
        out["search_scope"] = aws_sdk_backupsearch.types.search_scope.deserialize_json(
            data["SearchScope"]
        )
    else:
    ...
    if "ItemFilters" in data:
        ...
        out["item_filters"] = aws_sdk_backupsearch.types.item_filters.deserialize_json(
            data["ItemFilters"]
        )
    else:
