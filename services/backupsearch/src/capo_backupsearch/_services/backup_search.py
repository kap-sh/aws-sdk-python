...
from capo_backupsearch._resources.cryo_backup_search_service.search_job import SearchJob
from capo_backupsearch._resources.cryo_backup_search_service.search_result_export_job import (
    SearchResultExportJob,
)
from capo_backupsearch._services._aws_config import aws_config
...
class BackupSearchClientConfig(TypedDict, total=False, closed=True):
...
class BackupSearchClient:
    ...
    def __init__(
        ...
        self._config = BackupSearchClientConfig(
            {
    ...
    def list_search_job_backups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_backupsearch.types.list_search_job_backups_input.ListSearchJobBackupsInput]",
        ) -> OperationResponse[
            "capo_backupsearch.types.list_search_job_backups_output.ListSearchJobBackupsOutput"
        ]:
            ...
            output, http_response = (
                capo_backupsearch._operations.cryo_backup_search_service.list_search_job_backups.list_search_job_backups(
    ...
    def iter_list_search_job_backups(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_backupsearch.types.search_job_backups_result.SearchJobBackupsResult]":
        _token = next_token
        while True:
    ...
    def list_search_job_results(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_backupsearch.types.list_search_job_results_input.ListSearchJobResultsInput]",
        ) -> OperationResponse[
            "capo_backupsearch.types.list_search_job_results_output.ListSearchJobResultsOutput"
        ]:
            ...
            output, http_response = (
                capo_backupsearch._operations.cryo_backup_search_service.list_search_job_results.list_search_job_results(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_backupsearch.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_backupsearch.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_backupsearch._operations.cryo_backup_search_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_backupsearch.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_backupsearch.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_backupsearch._operations.cryo_backup_search_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_backupsearch.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_backupsearch.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_backupsearch._operations.cryo_backup_search_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
