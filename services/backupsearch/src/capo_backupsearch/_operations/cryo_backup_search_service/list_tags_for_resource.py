"""Generated from Smithy shape ``com.amazonaws.backupsearch#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_backupsearch.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_backupsearch.types.list_tags_for_resource_response.deserialize_json(
