"""Generated from Smithy shape ``com.amazonaws.backupsearch#ListSearchResultExportJobs``."""
...
import capo_backupsearch.errors.service_quota_exceeded_exception
...
import capo_backupsearch.types.export_job_summaries
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_backupsearch.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_backupsearch.types.list_search_result_export_jobs_output.ListSearchResultExportJobsOutput = capo_backupsearch.types.list_search_result_export_jobs_output.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_backupsearch._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    if "search_job_identifier" in input_:
        params["SearchJobIdentifier"] = str(input_["search_job_identifier"])
...
async def async_list_search_result_export_jobs(
