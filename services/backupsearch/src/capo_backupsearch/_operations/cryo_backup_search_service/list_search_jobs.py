"""Generated from Smithy shape ``com.amazonaws.backupsearch#ListSearchJobs``."""
...
def handle_response(
    ...
    out: capo_backupsearch.types.list_search_jobs_output.ListSearchJobsOutput = (
        capo_backupsearch.types.list_search_jobs_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/search-jobs"
    params: dict[str, str] = {}
...
async def async_list_search_jobs(
