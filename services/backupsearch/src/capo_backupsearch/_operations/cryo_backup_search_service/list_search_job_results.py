"""Generated from Smithy shape ``com.amazonaws.backupsearch#ListSearchJobResults``."""
...
import capo_backupsearch.types.results
...
def handle_response(
    ...
    out: capo_backupsearch.types.list_search_job_results_output.ListSearchJobResultsOutput = capo_backupsearch.types.list_search_job_results_output.deserialize_json(
