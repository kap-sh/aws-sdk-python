"""Generated from Smithy shape ``com.amazonaws.backupsearch#StopSearchJob``."""
...
import capo_backupsearch.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_backupsearch.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_backupsearch.types.stop_search_job_output.StopSearchJobOutput = {}  # type: ignore[typeddict-item]
    return out
...
def stop_search_job(
    ...
    capo_backupsearch.types.stop_search_job_output.StopSearchJobOutput, zapros.Response
]:
