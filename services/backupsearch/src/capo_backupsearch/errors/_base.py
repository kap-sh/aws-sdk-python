...
class BackupSearchError(Exception):
    """Base class for all BackupSearch service errors."""


class ServiceError(BackupSearchError):
...
class SerializationError(BackupSearchError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BackupSearchError):
...
class WaiterFailedError(BackupSearchError):
...
class WaiterTimeoutError(BackupSearchError):
