...
```
pip install capo-personalize-events
```

## Usage

```python
from capo_personalize_events import AsyncPersonalizeEventsClient
...
```python
from capo_personalize_events import AsyncPersonalizeEventsClient
from capo_personalize_events.error import InvalidInputException
