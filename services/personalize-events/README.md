...
```
pip install aws-sdk-personalize-events
```

## Usage

```python
from aws_sdk_personalize_events import AsyncPersonalizeEventsClient
...
```python
from aws_sdk_personalize_events import AsyncPersonalizeEventsClient
from aws_sdk_personalize_events.error import InvalidInputException
