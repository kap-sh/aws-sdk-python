...
class PersonalizeEventsError(Exception):
    """Base class for all PersonalizeEvents service errors."""


class ServiceError(PersonalizeEventsError):
...
class SerializationError(PersonalizeEventsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PersonalizeEventsError):
...
class WaiterFailedError(PersonalizeEventsError):
...
class WaiterTimeoutError(PersonalizeEventsError):
