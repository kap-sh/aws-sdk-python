...
if TYPE_CHECKING:
    ...
    import aws_sdk_personalize_events.types.action_impression
    ...
    import aws_sdk_personalize_events.types.synthesized_json_action_interaction_properties
...
def serialize_json(value: ActionInteraction) -> dict:
    ...
    out["timestamp"] = aws_sdk_personalize_events.types.date.serialize_json(
        value["timestamp"]
    )
    ...
    if "impression" in value:
        ...
        out["impression"] = (
            aws_sdk_personalize_events.types.action_impression.serialize_json(
                value["impression"]
            )
        )
...
def deserialize_json(data: dict) -> ActionInteraction:
    ...
    if "timestamp" in data:
        ...
        out["timestamp"] = aws_sdk_personalize_events.types.date.deserialize_json(
            data["timestamp"]
        )
    else:
    ...
    if "impression" in data:
        ...
        out["impression"] = (
            aws_sdk_personalize_events.types.action_impression.deserialize_json(
                data["impression"]
            )
        )
