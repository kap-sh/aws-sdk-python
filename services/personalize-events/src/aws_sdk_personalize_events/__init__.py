...
from ._services.async_personalize_events import (
    AsyncPersonalizeEventsClient as AsyncPersonalizeEventsClient,
)
from ._services.personalize_events import (
    PersonalizeEventsClient as PersonalizeEventsClient,
)
