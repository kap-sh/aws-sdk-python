...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.delete_ingestion_destination_response.DeleteIngestionDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.delete_ingestion_destination_request.DeleteIngestionDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
