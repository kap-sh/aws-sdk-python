...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.delete_app_authorization_response.DeleteAppAuthorizationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.delete_app_authorization_request.DeleteAppAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
