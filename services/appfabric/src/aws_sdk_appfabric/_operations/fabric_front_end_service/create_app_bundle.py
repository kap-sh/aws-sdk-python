"""Generated from Smithy shape ``com.amazonaws.appfabric#CreateAppBundle``."""
...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.create_app_bundle_response.CreateAppBundleResponse = (
        aws_sdk_appfabric.types.create_app_bundle_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.create_app_bundle_request.CreateAppBundleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appfabric.types.create_app_bundle_request.serialize_json(input_)
    ).encode()
...
async def async_create_app_bundle(
