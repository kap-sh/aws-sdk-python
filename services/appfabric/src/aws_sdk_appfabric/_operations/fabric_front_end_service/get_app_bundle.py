...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.get_app_bundle_response.GetAppBundleResponse = (
        aws_sdk_appfabric.types.get_app_bundle_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.get_app_bundle_request.GetAppBundleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
