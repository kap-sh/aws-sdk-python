...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.create_ingestion_destination_response.CreateIngestionDestinationResponse = aws_sdk_appfabric.types.create_ingestion_destination_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.create_ingestion_destination_request.CreateIngestionDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appfabric.types.create_ingestion_destination_request.serialize_json(
            input_
        )
    ).encode()
