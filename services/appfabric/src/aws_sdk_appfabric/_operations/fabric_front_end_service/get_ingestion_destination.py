...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.get_ingestion_destination_response.GetIngestionDestinationResponse = aws_sdk_appfabric.types.get_ingestion_destination_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.get_ingestion_destination_request.GetIngestionDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
