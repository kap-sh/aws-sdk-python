...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.get_ingestion_response.GetIngestionResponse = (
        aws_sdk_appfabric.types.get_ingestion_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.get_ingestion_request.GetIngestionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_ingestion(
    ...
    aws_sdk_appfabric.types.get_ingestion_response.GetIngestionResponse, zapros.Response
]:
