...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.list_ingestions_response.ListIngestionsResponse = (
        aws_sdk_appfabric.types.list_ingestions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.list_ingestions_request.ListIngestionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
