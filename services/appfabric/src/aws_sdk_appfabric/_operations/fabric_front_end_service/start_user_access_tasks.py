...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.start_user_access_tasks_response.StartUserAccessTasksResponse = aws_sdk_appfabric.types.start_user_access_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.start_user_access_tasks_request.StartUserAccessTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appfabric.types.start_user_access_tasks_request.serialize_json(input_)
    ).encode()
