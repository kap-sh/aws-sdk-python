...
def build_request(
    ...
    input: aws_sdk_appfabric.types.start_user_access_tasks_request.StartUserAccessTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appfabric.types.start_user_access_tasks_request.serialize_json(input)
    ).encode()
