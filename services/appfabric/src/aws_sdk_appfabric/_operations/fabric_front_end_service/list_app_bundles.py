...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.list_app_bundles_response.ListAppBundlesResponse = (
        aws_sdk_appfabric.types.list_app_bundles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.list_app_bundles_request.ListAppBundlesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
