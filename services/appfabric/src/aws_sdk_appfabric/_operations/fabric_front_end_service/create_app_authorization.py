...
import aws_sdk_appfabric.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_appfabric.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.create_app_authorization_response.CreateAppAuthorizationResponse = aws_sdk_appfabric.types.create_app_authorization_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.create_app_authorization_request.CreateAppAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appfabric.types.create_app_authorization_request.serialize_json(input_)
    ).encode()
