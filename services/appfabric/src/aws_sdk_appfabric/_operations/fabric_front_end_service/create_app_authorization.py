...
def build_request(
    ...
    input: aws_sdk_appfabric.types.create_app_authorization_request.CreateAppAuthorizationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appfabric.types.create_app_authorization_request.serialize_json(input)
    ).encode()
