...
def build_request(
    ...
    input: aws_sdk_appfabric.types.update_app_authorization_request.UpdateAppAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appfabric.types.update_app_authorization_request.serialize_json(input)
    ).encode()
