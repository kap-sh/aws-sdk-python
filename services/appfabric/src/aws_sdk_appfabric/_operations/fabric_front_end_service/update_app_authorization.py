...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.update_app_authorization_response.UpdateAppAuthorizationResponse = aws_sdk_appfabric.types.update_app_authorization_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.update_app_authorization_request.UpdateAppAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appfabric.types.update_app_authorization_request.serialize_json(input_)
    ).encode()
