...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.start_ingestion_response.StartIngestionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.start_ingestion_request.StartIngestionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
