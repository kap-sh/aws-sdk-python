...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.update_ingestion_destination_response.UpdateIngestionDestinationResponse = aws_sdk_appfabric.types.update_ingestion_destination_response.deserialize_json(
