...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.delete_app_bundle_response.DeleteAppBundleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.delete_app_bundle_request.DeleteAppBundleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
