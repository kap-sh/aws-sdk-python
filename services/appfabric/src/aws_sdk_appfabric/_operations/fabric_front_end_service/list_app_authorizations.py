...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.list_app_authorizations_response.ListAppAuthorizationsResponse = aws_sdk_appfabric.types.list_app_authorizations_response.deserialize_json(
