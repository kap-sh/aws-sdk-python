...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.batch_get_user_access_tasks_response.BatchGetUserAccessTasksResponse = aws_sdk_appfabric.types.batch_get_user_access_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.batch_get_user_access_tasks_request.BatchGetUserAccessTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appfabric.types.batch_get_user_access_tasks_request.serialize_json(
            input_
        )
    ).encode()
