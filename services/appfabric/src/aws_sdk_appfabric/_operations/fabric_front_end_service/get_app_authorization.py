...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.get_app_authorization_response.GetAppAuthorizationResponse = aws_sdk_appfabric.types.get_app_authorization_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.get_app_authorization_request.GetAppAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
