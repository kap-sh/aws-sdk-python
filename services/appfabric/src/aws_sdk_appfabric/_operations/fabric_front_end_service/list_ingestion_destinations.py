...
import aws_sdk_appfabric.types.ingestion_destination_list
...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.list_ingestion_destinations_response.ListIngestionDestinationsResponse = aws_sdk_appfabric.types.list_ingestion_destinations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.list_ingestion_destinations_request.ListIngestionDestinationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
