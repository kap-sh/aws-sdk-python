"""Generated from Smithy shape ``com.amazonaws.appfabric#ConnectAppAuthorization``."""
...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.connect_app_authorization_response.ConnectAppAuthorizationResponse = aws_sdk_appfabric.types.connect_app_authorization_response.deserialize_json(
