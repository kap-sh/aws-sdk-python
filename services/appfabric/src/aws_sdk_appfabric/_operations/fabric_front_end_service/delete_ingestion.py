...
def handle_response(
    ...
    out: aws_sdk_appfabric.types.delete_ingestion_response.DeleteIngestionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appfabric.types.delete_ingestion_request.DeleteIngestionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
