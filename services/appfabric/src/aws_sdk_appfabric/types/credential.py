...
if TYPE_CHECKING:
    import aws_sdk_appfabric.types.api_key_credential
...
def serialize_json(value: Credential) -> dict:
    if "oauth2Credential" in value:
        ...
        return {
            "oauth2Credential": aws_sdk_appfabric.types.oauth2_credential.serialize_json(
        ...
        return {
            "apiKeyCredential": aws_sdk_appfabric.types.api_key_credential.serialize_json(
...
def deserialize_json(data: dict) -> Credential:
    if "oauth2Credential" in data:
        ...
        return {
            "oauth2Credential": aws_sdk_appfabric.types.oauth2_credential.deserialize_json(
        ...
        return {
            "apiKeyCredential": aws_sdk_appfabric.types.api_key_credential.deserialize_json(
