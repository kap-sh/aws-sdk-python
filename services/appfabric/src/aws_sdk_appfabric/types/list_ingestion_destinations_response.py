...
class ListIngestionDestinationsResponse(TypedDict):
    ingestion_destinations: (
        "aws_sdk_appfabric.types.ingestion_destination_list.IngestionDestinationList"
    )
...
def serialize_json(value: ListIngestionDestinationsResponse) -> dict:
    ...
    out["ingestionDestinations"] = (
        aws_sdk_appfabric.types.ingestion_destination_list.serialize_json(
...
def deserialize_json(data: dict) -> ListIngestionDestinationsResponse:
    ...
    if "ingestionDestinations" in data:
        ...
        out["ingestion_destinations"] = (
            aws_sdk_appfabric.types.ingestion_destination_list.deserialize_json(
