...
# --- restJson1 ser/de ---
def serialize_json(value: ListAppAuthorizationsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListAppAuthorizationsRequest:
    out: ListAppAuthorizationsRequest = {}  # type: ignore[typeddict-item]
    return out
