"""Generated from Smithy shape ``com.amazonaws.appfabric#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.appfabric#ServiceQuotaExceededException``."""
