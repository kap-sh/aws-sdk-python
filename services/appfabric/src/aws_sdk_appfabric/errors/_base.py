...
class AppFabricError(Exception):
    """Base class for all AppFabric service errors."""


class ServiceError(AppFabricError):
...
class SerializationError(AppFabricError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AppFabricError):
...
class WaiterFailedError(AppFabricError):
...
class WaiterTimeoutError(AppFabricError):
