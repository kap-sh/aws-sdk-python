...
from aws_sdk_sqs._auth._zapros_handler import AuthMiddleware
from aws_sdk_sqs._pagination import resolve_path as _resolve_path
from aws_sdk_sqs._services._aws_config import aws_config
from aws_sdk_sqs._services._pipeline import (
    Interceptor,
    OperationOptions,
    OperationRequest,
    OperationResponse,
...
if TYPE_CHECKING:
    ...
    import aws_sdk_sqs.types.add_permission_request
    ...
    import aws_sdk_sqs.types.change_message_visibility_request
    import aws_sdk_sqs.types.create_queue_request
    import aws_sdk_sqs.types.create_queue_result
    import aws_sdk_sqs.types.delete_message_batch_request
    import aws_sdk_sqs.types.delete_message_batch_request_entry_list
    import aws_sdk_sqs.types.delete_message_batch_result
    import aws_sdk_sqs.types.delete_message_request
    import aws_sdk_sqs.types.delete_queue_request
    import aws_sdk_sqs.types.get_queue_attributes_request
    import aws_sdk_sqs.types.get_queue_attributes_result
    import aws_sdk_sqs.types.get_queue_url_request
    import aws_sdk_sqs.types.get_queue_url_result
    import aws_sdk_sqs.types.list_dead_letter_source_queues_request
    import aws_sdk_sqs.types.list_dead_letter_source_queues_result
    import aws_sdk_sqs.types.list_message_move_tasks_request
    import aws_sdk_sqs.types.list_message_move_tasks_result
    import aws_sdk_sqs.types.list_queue_tags_request
    import aws_sdk_sqs.types.list_queue_tags_result
    import aws_sdk_sqs.types.list_queues_request
    import aws_sdk_sqs.types.list_queues_result
    ...
    import aws_sdk_sqs.types.purge_queue_request
    import aws_sdk_sqs.types.queue_attribute_map
    import aws_sdk_sqs.types.receive_message_request
    import aws_sdk_sqs.types.receive_message_result
    ...
    import aws_sdk_sqs.types.tag_queue_request
    import aws_sdk_sqs.types.token
    import aws_sdk_sqs.types.untag_queue_request
...
class SQSClient:
    ...
    def add_permission(
        ...
        *,
        ...
        Raises:
            aws_sdk_sqs.errors.invalid_address.InvalidAddress: <p>The specified ID is invalid.</p>
            aws_sdk_sqs.errors.invalid_security.InvalidSecurity: <p>The request was not made over HTTPS or did not use SigV4 for signing.</p>
            aws_sdk_sqs.errors.over_limit.OverLimit: <p>The specified action violates a limit. For example, <code>ReceiveMessage</code> returns this error if the maximum number of in flight messages is reached and <code>AddPermission</code> returns this error if the maximum number of permissions for the queue is reached.</p>
            aws_sdk_sqs.errors.queue_does_not_exist.QueueDoesNotExist: <p>Ensure that the <code>QueueUrl</code> is correct and that the queue has not been deleted.</p>
            aws_sdk_sqs.errors.request_throttled.RequestThrottled: <p>The request was denied due to request throttling.</p> <ul> <li> <p>Exceeds the permitted request rate for the queue or for the recipient of the request.</p> </li> <li> <p>Ensure that the request rate is within the Amazon SQS limits for sending messages. For more information, see <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-quotas.html#quotas-requests\">Amazon SQS quotas</a> in the <i>Amazon SQS Developer Guide</i>.</p> </li> </ul>
            aws_sdk_sqs.errors.unsupported_operation.UnsupportedOperation: <p>Error code 400. Unsupported operation.</p>
            aws_sdk_sqs.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.add_permission_request.AddPermissionRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sqs._operations.amazon_sqs.add_permission

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.add_permission.add_permission(
    ...
    def cancel_message_move_task(
        self,
        task_handle: "aws_sdk_sqs.types.string.String",
        *,
        config_overrides: Optional[SQSClientConfig] = None,
    ) -> (
        ...
        Raises:
            ...
            aws_sdk_sqs.errors.invalid_security.InvalidSecurity: <p>The request was not made over HTTPS or did not use SigV4 for signing.</p>
            aws_sdk_sqs.errors.request_throttled.RequestThrottled: <p>The request was denied due to request throttling.</p> <ul> <li> <p>Exceeds the permitted request rate for the queue or for the recipient of the request.</p> </li> <li> <p>Ensure that the request rate is within the Amazon SQS limits for sending messages. For more information, see <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-quotas.html#quotas-requests\">Amazon SQS quotas</a> in the <i>Amazon SQS Developer Guide</i>.</p> </li> </ul>
            aws_sdk_sqs.errors.resource_not_found_exception.ResourceNotFoundException: <p>One or more specified resources don't exist.</p>
            aws_sdk_sqs.errors.unsupported_operation.UnsupportedOperation: <p>Error code 400. Unsupported operation.</p>
            aws_sdk_sqs.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.cancel_message_move_task_request.CancelMessageMoveTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.cancel_message_move_task_result.CancelMessageMoveTaskResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.cancel_message_move_task

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.cancel_message_move_task.cancel_message_move_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def change_message_visibility(
        ...
        *,
        ...
        Raises:
            aws_sdk_sqs.errors.invalid_address.InvalidAddress: <p>The specified ID is invalid.</p>
            aws_sdk_sqs.errors.invalid_security.InvalidSecurity: <p>The request was not made over HTTPS or did not use SigV4 for signing.</p>
            aws_sdk_sqs.errors.message_not_inflight.MessageNotInflight: <p>The specified message isn't in flight.</p>
            aws_sdk_sqs.errors.queue_does_not_exist.QueueDoesNotExist: <p>Ensure that the <code>QueueUrl</code> is correct and that the queue has not been deleted.</p>
            aws_sdk_sqs.errors.receipt_handle_is_invalid.ReceiptHandleIsInvalid: <p>The specified receipt handle isn't valid.</p>
            aws_sdk_sqs.errors.request_throttled.RequestThrottled: <p>The request was denied due to request throttling.</p> <ul> <li> <p>Exceeds the permitted request rate for the queue or for the recipient of the request.</p> </li> <li> <p>Ensure that the request rate is within the Amazon SQS limits for sending messages. For more information, see <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-quotas.html#quotas-requests\">Amazon SQS quotas</a> in the <i>Amazon SQS Developer Guide</i>.</p> </li> </ul>
            aws_sdk_sqs.errors.unsupported_operation.UnsupportedOperation: <p>Error code 400. Unsupported operation.</p>
            aws_sdk_sqs.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.change_message_visibility_request.ChangeMessageVisibilityRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sqs._operations.amazon_sqs.change_message_visibility

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.change_message_visibility.change_message_visibility(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def change_message_visibility_batch(
        ...
        *,
        ...
        Raises:
            aws_sdk_sqs.errors.batch_entry_ids_not_distinct.BatchEntryIdsNotDistinct: <p>Two or more batch entries in the request have the same <code>Id</code>.</p>
            aws_sdk_sqs.errors.empty_batch_request.EmptyBatchRequest: <p>The batch request doesn't contain any entries.</p>
            aws_sdk_sqs.errors.invalid_address.InvalidAddress: <p>The specified ID is invalid.</p>
            aws_sdk_sqs.errors.invalid_batch_entry_id.InvalidBatchEntryId: <p>The <code>Id</code> of a batch entry in a batch request doesn't abide by the specification.</p>
            aws_sdk_sqs.errors.invalid_security.InvalidSecurity: <p>The request was not made over HTTPS or did not use SigV4 for signing.</p>
            aws_sdk_sqs.errors.queue_does_not_exist.QueueDoesNotExist: <p>Ensure that the <code>QueueUrl</code> is correct and that the queue has not been deleted.</p>
            aws_sdk_sqs.errors.request_throttled.RequestThrottled: <p>The request was denied due to request throttling.</p> <ul> <li> <p>Exceeds the permitted request rate for the queue or for the recipient of the request.</p> </li> <li> <p>Ensure that the request rate is within the Amazon SQS limits for sending messages. For more information, see <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-quotas.html#quotas-requests\">Amazon SQS quotas</a> in the <i>Amazon SQS Developer Guide</i>.</p> </li> </ul>
            aws_sdk_sqs.errors.too_many_entries_in_batch_request.TooManyEntriesInBatchRequest: <p>The batch request contains more entries than permissible. For Amazon SQS, the maximum number of entries you can include in a single <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/APIReference/API_SendMessageBatch.html\">SendMessageBatch</a>, <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/APIReference/API_DeleteMessageBatch.html\">DeleteMessageBatch</a>, or <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/APIReference/API_ChangeMessageVisibilityBatch.html\">ChangeMessageVisibilityBatch</a> request is 10.</p>
            aws_sdk_sqs.errors.unsupported_operation.UnsupportedOperation: <p>Error code 400. Unsupported operation.</p>
            aws_sdk_sqs.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.change_message_visibility_batch_request.ChangeMessageVisibilityBatchRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.change_message_visibility_batch_result.ChangeMessageVisibilityBatchResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.change_message_visibility_batch

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.change_message_visibility_batch.change_message_visibility_batch(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_queue(
        ...
        *,
        config_overrides: Optional[SQSClientConfig] = None,
        attributes: Optional[
            "aws_sdk_sqs.types.queue_attribute_map.QueueAttributeMap"
        ] = None,
        tags: Optional["aws_sdk_sqs.types.tag_map.TagMap"] = None,
        ...
        Raises:
            aws_sdk_sqs.errors.invalid_address.InvalidAddress: <p>The specified ID is invalid.</p>
            aws_sdk_sqs.errors.invalid_attribute_name.InvalidAttributeName: <p>The specified attribute doesn't exist.</p>
            aws_sdk_sqs.errors.invalid_attribute_value.InvalidAttributeValue: <p>A queue attribute value is invalid.</p>
            aws_sdk_sqs.errors.invalid_security.InvalidSecurity: <p>The request was not made over HTTPS or did not use SigV4 for signing.</p>
            aws_sdk_sqs.errors.queue_deleted_recently.QueueDeletedRecently: <p>You must wait 60 seconds after deleting a queue before you can create another queue with the same name.</p>
            aws_sdk_sqs.errors.queue_name_exists.QueueNameExists: <p>A queue with this name already exists. Amazon SQS returns this error only if the request includes attributes whose values differ from those of the existing queue.</p>
            aws_sdk_sqs.errors.request_throttled.RequestThrottled: <p>The request was denied due to request throttling.</p> <ul> <li> <p>Exceeds the permitted request rate for the queue or for the recipient of the request.</p> </li> <li> <p>Ensure that the request rate is within the Amazon SQS limits for sending messages. For more information, see <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-quotas.html#quotas-requests\">Amazon SQS quotas</a> in the <i>Amazon SQS Developer Guide</i>.</p> </li> </ul>
            aws_sdk_sqs.errors.unsupported_operation.UnsupportedOperation: <p>Error code 400. Unsupported operation.</p>
            aws_sdk_sqs.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.create_queue_request.CreateQueueRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.create_queue_result.CreateQueueResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.create_queue

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.create_queue.create_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_message(
        ...
        *,
        ...
        Raises:
            aws_sdk_sqs.errors.invalid_address.InvalidAddress: <p>The specified ID is invalid.</p>
            aws_sdk_sqs.errors.invalid_id_format.InvalidIdFormat: <p>The specified receipt handle isn't valid for the current version.</p>
            aws_sdk_sqs.errors.invalid_security.InvalidSecurity: <p>The request was not made over HTTPS or did not use SigV4 for signing.</p>
            aws_sdk_sqs.errors.queue_does_not_exist.QueueDoesNotExist: <p>Ensure that the <code>QueueUrl</code> is correct and that the queue has not been deleted.</p>
            aws_sdk_sqs.errors.receipt_handle_is_invalid.ReceiptHandleIsInvalid: <p>The specified receipt handle isn't valid.</p>
            aws_sdk_sqs.errors.request_throttled.RequestThrottled: <p>The request was denied due to request throttling.</p> <ul> <li> <p>Exceeds the permitted request rate for the queue or for the recipient of the request.</p> </li> <li> <p>Ensure that the request rate is within the Amazon SQS limits for sending messages. For more information, see <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-quotas.html#quotas-requests\">Amazon SQS quotas</a> in the <i>Amazon SQS Developer Guide</i>.</p> </li> </ul>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.delete_message_request.DeleteMessageRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sqs._operations.amazon_sqs.delete_message

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.delete_message.delete_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_message_batch(
        ...
        *,
        config_overrides: Optional[SQSClientConfig] = None,
    ) -> "aws_sdk_sqs.types.delete_message_batch_result.DeleteMessageBatchResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.delete_message_batch_request.DeleteMessageBatchRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.delete_message_batch_result.DeleteMessageBatchResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.delete_message_batch

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.delete_message_batch.delete_message_batch(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_queue(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.delete_queue_request.DeleteQueueRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sqs._operations.amazon_sqs.delete_queue

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.delete_queue.delete_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_queue_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.get_queue_attributes_request.GetQueueAttributesRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.get_queue_attributes_result.GetQueueAttributesResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.get_queue_attributes

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.get_queue_attributes.get_queue_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_queue_url(
        ...
        *,
        config_overrides: Optional[SQSClientConfig] = None,
        queue_owner_aws_account_id: Optional["aws_sdk_sqs.types.string.String"] = None,
    ) -> "aws_sdk_sqs.types.get_queue_url_result.GetQueueUrlResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.get_queue_url_request.GetQueueUrlRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.get_queue_url_result.GetQueueUrlResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.get_queue_url

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.get_queue_url.get_queue_url(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_dead_letter_source_queues(
        ...
        *,
        config_overrides: Optional[SQSClientConfig] = None,
        next_token: Optional["aws_sdk_sqs.types.token.Token"] = None,
        max_results: Optional["aws_sdk_sqs.types.boxed_integer.BoxedInteger"] = None,
    ) -> "aws_sdk_sqs.types.list_dead_letter_source_queues_result.ListDeadLetterSourceQueuesResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.list_dead_letter_source_queues_request.ListDeadLetterSourceQueuesRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.list_dead_letter_source_queues_result.ListDeadLetterSourceQueuesResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.list_dead_letter_source_queues

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.list_dead_letter_source_queues.list_dead_letter_source_queues(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_dead_letter_source_queues(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_sqs.types.token.Token"] = None,
        max_results: Optional["aws_sdk_sqs.types.boxed_integer.BoxedInteger"] = None,
    ) -> "Iterator[aws_sdk_sqs.types.string.String]":
        _token = next_token
        while True:
    ...
    def list_message_move_tasks(
        ...
        *,
    ...
    ) -> "aws_sdk_sqs.types.list_message_move_tasks_result.ListMessageMoveTasksResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.list_message_move_tasks_request.ListMessageMoveTasksRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.list_message_move_tasks_result.ListMessageMoveTasksResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.list_message_move_tasks

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.list_message_move_tasks.list_message_move_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_queues(
        ...
        *,
        config_overrides: Optional[SQSClientConfig] = None,
        queue_name_prefix: Optional["aws_sdk_sqs.types.string.String"] = None,
        next_token: Optional["aws_sdk_sqs.types.token.Token"] = None,
        max_results: Optional["aws_sdk_sqs.types.boxed_integer.BoxedInteger"] = None,
    ) -> "aws_sdk_sqs.types.list_queues_result.ListQueuesResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.list_queues_request.ListQueuesRequest]",
        ) -> OperationResponse["aws_sdk_sqs.types.list_queues_result.ListQueuesResult"]:
            import aws_sdk_sqs._operations.amazon_sqs.list_queues

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.list_queues.list_queues(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_queue_tags(
        ...
        *,
        config_overrides: Optional[SQSClientConfig] = None,
    ) -> "aws_sdk_sqs.types.list_queue_tags_result.ListQueueTagsResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.list_queue_tags_request.ListQueueTagsRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.list_queue_tags_result.ListQueueTagsResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.list_queue_tags

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.list_queue_tags.list_queue_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def purge_queue(
        ...
        *,
        ...
        Raises:
            aws_sdk_sqs.errors.invalid_address.InvalidAddress: <p>The specified ID is invalid.</p>
            aws_sdk_sqs.errors.invalid_security.InvalidSecurity: <p>The request was not made over HTTPS or did not use SigV4 for signing.</p>
            aws_sdk_sqs.errors.purge_queue_in_progress.PurgeQueueInProgress: <p>Indicates that the specified queue previously received a <code>PurgeQueue</code> request within the last 60 seconds (the time it can take to delete the messages in the queue).</p>
            aws_sdk_sqs.errors.queue_does_not_exist.QueueDoesNotExist: <p>Ensure that the <code>QueueUrl</code> is correct and that the queue has not been deleted.</p>
            aws_sdk_sqs.errors.request_throttled.RequestThrottled: <p>The request was denied due to request throttling.</p> <ul> <li> <p>Exceeds the permitted request rate for the queue or for the recipient of the request.</p> </li> <li> <p>Ensure that the request rate is within the Amazon SQS limits for sending messages. For more information, see <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-quotas.html#quotas-requests\">Amazon SQS quotas</a> in the <i>Amazon SQS Developer Guide</i>.</p> </li> </ul>
            aws_sdk_sqs.errors.unsupported_operation.UnsupportedOperation: <p>Error code 400. Unsupported operation.</p>
            aws_sdk_sqs.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.purge_queue_request.PurgeQueueRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sqs._operations.amazon_sqs.purge_queue

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.purge_queue.purge_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def receive_message(
        ...
        *,
        ...
        receive_request_attempt_id: Optional["aws_sdk_sqs.types.string.String"] = None,
    ) -> "aws_sdk_sqs.types.receive_message_result.ReceiveMessageResult":
        ...
        Raises:
            aws_sdk_sqs.errors.invalid_address.InvalidAddress: <p>The specified ID is invalid.</p>
            aws_sdk_sqs.errors.invalid_security.InvalidSecurity: <p>The request was not made over HTTPS or did not use SigV4 for signing.</p>
            aws_sdk_sqs.errors.kms_access_denied.KmsAccessDenied: <p>The caller doesn't have the required KMS access.</p>
            aws_sdk_sqs.errors.kms_disabled.KmsDisabled: <p>The request was denied due to request throttling.</p>
            aws_sdk_sqs.errors.kms_invalid_key_usage.KmsInvalidKeyUsage: <p>The request was rejected for one of the following reasons:</p> <ul> <li> <p>The KeyUsage value of the KMS key is incompatible with the API operation.</p> </li> <li> <p>The encryption algorithm or signing algorithm specified for the operation is incompatible with the type of key material in the KMS key (KeySpec).</p> </li> </ul>
            aws_sdk_sqs.errors.kms_invalid_state.KmsInvalidState: <p>The request was rejected because the state of the specified resource is not valid for this request.</p>
            aws_sdk_sqs.errors.kms_not_found.KmsNotFound: <p>The request was rejected because the specified entity or resource could not be found. </p>
            aws_sdk_sqs.errors.kms_opt_in_required.KmsOptInRequired: <p>The request was rejected because the specified key policy isn't syntactically or semantically correct.</p>
            aws_sdk_sqs.errors.kms_throttled.KmsThrottled: <p>Amazon Web Services KMS throttles requests for the following conditions.</p>
            aws_sdk_sqs.errors.over_limit.OverLimit: <p>The specified action violates a limit. For example, <code>ReceiveMessage</code> returns this error if the maximum number of in flight messages is reached and <code>AddPermission</code> returns this error if the maximum number of permissions for the queue is reached.</p>
            aws_sdk_sqs.errors.queue_does_not_exist.QueueDoesNotExist: <p>Ensure that the <code>QueueUrl</code> is correct and that the queue has not been deleted.</p>
            aws_sdk_sqs.errors.request_throttled.RequestThrottled: <p>The request was denied due to request throttling.</p> <ul> <li> <p>Exceeds the permitted request rate for the queue or for the recipient of the request.</p> </li> <li> <p>Ensure that the request rate is within the Amazon SQS limits for sending messages. For more information, see <a href=\"https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-quotas.html#quotas-requests\">Amazon SQS quotas</a> in the <i>Amazon SQS Developer Guide</i>.</p> </li> </ul>
            aws_sdk_sqs.errors.unsupported_operation.UnsupportedOperation: <p>Error code 400. Unsupported operation.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.receive_message_request.ReceiveMessageRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.receive_message_result.ReceiveMessageResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.receive_message

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.receive_message.receive_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_permission(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.remove_permission_request.RemovePermissionRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sqs._operations.amazon_sqs.remove_permission

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.remove_permission.remove_permission(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_message(
        ...
        *,
        ...
        message_deduplication_id: Optional["aws_sdk_sqs.types.string.String"] = None,
        message_group_id: Optional["aws_sdk_sqs.types.string.String"] = None,
        ...
        Raises:
            aws_sdk_sqs.errors.invalid_address.InvalidAddress: <p>The specified ID is invalid.</p>
            aws_sdk_sqs.errors.invalid_message_contents.InvalidMessageContents: <p>The message contains characters outside the allowed set.</p>
            aws_sdk_sqs.errors.invalid_security.InvalidSecurity: <p>The request was not made over HTTPS or did not use SigV4 for signing.</p>
            aws_sdk_sqs.errors.kms_access_denied.KmsAccessDenied: <p>The caller doesn't have the required KMS access.</p>
            aws_sdk_sqs.errors.kms_disabled.KmsDisabled: <p>The request was denied due to request throttling.</p>
            aws_sdk_sqs.errors.kms_invalid_key_usage.KmsInvalidKeyUsage: <p>The request was rejected for one of the following reasons:</p> <ul> <li> <p>The KeyUsage value of the KMS key is incompatible with the API operation.</p> </li> <li> <p>The encryption algorithm or signing algorithm specified for the operation is incompatible with the type of key material in the KMS key (KeySpec).</p> </li> </ul>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.send_message_request.SendMessageRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.send_message_result.SendMessageResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.send_message

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.send_message.send_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_message_batch(
        ...
        *,
        ...
        Raises:
            aws_sdk_sqs.errors.batch_entry_ids_not_distinct.BatchEntryIdsNotDistinct: <p>Two or more batch entries in the request have the same <code>Id</code>.</p>
            aws_sdk_sqs.errors.batch_request_too_long.BatchRequestTooLong: <p>The length of all the messages put together is more than the limit.</p>
            aws_sdk_sqs.errors.empty_batch_request.EmptyBatchRequest: <p>The batch request doesn't contain any entries.</p>
            aws_sdk_sqs.errors.invalid_address.InvalidAddress: <p>The specified ID is invalid.</p>
            aws_sdk_sqs.errors.invalid_batch_entry_id.InvalidBatchEntryId: <p>The <code>Id</code> of a batch entry in a batch request doesn't abide by the specification.</p>
            aws_sdk_sqs.errors.invalid_security.InvalidSecurity: <p>The request was not made over HTTPS or did not use SigV4 for signing.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.send_message_batch_request.SendMessageBatchRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.send_message_batch_result.SendMessageBatchResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.send_message_batch

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.send_message_batch.send_message_batch(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_queue_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.set_queue_attributes_request.SetQueueAttributesRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sqs._operations.amazon_sqs.set_queue_attributes

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.set_queue_attributes.set_queue_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_message_move_task(
        ...
        *,
        config_overrides: Optional[SQSClientConfig] = None,
        destination_arn: Optional["aws_sdk_sqs.types.string.String"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.start_message_move_task_request.StartMessageMoveTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_sqs.types.start_message_move_task_result.StartMessageMoveTaskResult"
        ]:
            import aws_sdk_sqs._operations.amazon_sqs.start_message_move_task

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.start_message_move_task.start_message_move_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_queue(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.tag_queue_request.TagQueueRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sqs._operations.amazon_sqs.tag_queue

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.tag_queue.tag_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_queue(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sqs.types.untag_queue_request.UntagQueueRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sqs._operations.amazon_sqs.untag_queue

            output, http_response = (
                aws_sdk_sqs._operations.amazon_sqs.untag_queue.untag_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
