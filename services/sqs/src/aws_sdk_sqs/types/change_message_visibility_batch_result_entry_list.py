...
if TYPE_CHECKING:
    import aws_sdk_sqs.types.change_message_visibility_batch_result_entry

ChangeMessageVisibilityBatchResultEntryList: TypeAlias = list[
    "aws_sdk_sqs.types.change_message_visibility_batch_result_entry.ChangeMessageVisibilityBatchResultEntry"
]
...
def serialize_aws_json_1_0(value: ChangeMessageVisibilityBatchResultEntryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sqs.types.change_message_visibility_batch_result_entry.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ChangeMessageVisibilityBatchResultEntryList:
    ...
    for item in data:
        out.append(
            aws_sdk_sqs.types.change_message_visibility_batch_result_entry.deserialize_aws_json_1_0(
                item
            )
        )
    return out
