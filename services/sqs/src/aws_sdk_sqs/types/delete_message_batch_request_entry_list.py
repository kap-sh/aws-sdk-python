...
if TYPE_CHECKING:
    import aws_sdk_sqs.types.delete_message_batch_request_entry

DeleteMessageBatchRequestEntryList: TypeAlias = list[
    "aws_sdk_sqs.types.delete_message_batch_request_entry.DeleteMessageBatchRequestEntry"
]
...
def serialize_aws_json_1_0(value: DeleteMessageBatchRequestEntryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sqs.types.delete_message_batch_request_entry.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> DeleteMessageBatchRequestEntryList:
    ...
    for item in data:
        out.append(
            aws_sdk_sqs.types.delete_message_batch_request_entry.deserialize_aws_json_1_0(
                item
            )
        )
    return out
