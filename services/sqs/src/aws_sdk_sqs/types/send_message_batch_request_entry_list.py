...
if TYPE_CHECKING:
    import aws_sdk_sqs.types.send_message_batch_request_entry

SendMessageBatchRequestEntryList: TypeAlias = list[
    "aws_sdk_sqs.types.send_message_batch_request_entry.SendMessageBatchRequestEntry"
]
...
def serialize_aws_json_1_0(value: SendMessageBatchRequestEntryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sqs.types.send_message_batch_request_entry.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> SendMessageBatchRequestEntryList:
    ...
    for item in data:
        out.append(
            aws_sdk_sqs.types.send_message_batch_request_entry.deserialize_aws_json_1_0(
                item
            )
        )
    return out
