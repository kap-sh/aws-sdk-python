...
if TYPE_CHECKING:
    ...
    import aws_sdk_sqs.types.message_system_attribute_map
...
class Message(TypedDict):
    ...
    md5_of_body: NotRequired["aws_sdk_sqs.types.string.String"]
    """<p>An MD5 digest of the non-URL-encoded message body string.</p>"""
    body: NotRequired["aws_sdk_sqs.types.string.String"]
    """<p>The message's contents (not URL-encoded).</p>"""
    attributes: NotRequired[
        "aws_sdk_sqs.types.message_system_attribute_map.MessageSystemAttributeMap"
    ]
...
def serialize_aws_json_1_0(value: Message) -> dict:
    ...
    if "attributes" in value:
        ...
        out["Attributes"] = (
            aws_sdk_sqs.types.message_system_attribute_map.serialize_aws_json_1_0(
                value["attributes"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> Message:
    ...
    if "Attributes" in data:
        ...
        out["attributes"] = (
            aws_sdk_sqs.types.message_system_attribute_map.deserialize_aws_json_1_0(
                data["Attributes"]
            )
        )
