"""Generated from Smithy shape ``com.amazonaws.sqs#ChangeMessageVisibility``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MessageNotInflight":
            import aws_sdk_sqs.errors.message_not_inflight

            raise aws_sdk_sqs.errors.message_not_inflight.MessageNotInflight.from_aws_json_1_0(
                data
            )
        ...
        case "ReceiptHandleIsInvalid":
            import aws_sdk_sqs.errors.receipt_handle_is_invalid

            raise aws_sdk_sqs.errors.receipt_handle_is_invalid.ReceiptHandleIsInvalid.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.change_message_visibility_request.ChangeMessageVisibilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.change_message_visibility_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_change_message_visibility(
