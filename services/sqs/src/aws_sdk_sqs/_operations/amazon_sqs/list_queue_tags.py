"""Generated from Smithy shape ``com.amazonaws.sqs#ListQueueTags``."""
...
def handle_response(
    ...
    out: aws_sdk_sqs.types.list_queue_tags_result.ListQueueTagsResult = (
        aws_sdk_sqs.types.list_queue_tags_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.list_queue_tags_request.ListQueueTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.list_queue_tags_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_queue_tags(
    ...
    aws_sdk_sqs.types.list_queue_tags_result.ListQueueTagsResult, zapros.Response
]:
...
async def async_list_queue_tags(
