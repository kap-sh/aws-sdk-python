"""Generated from Smithy shape ``com.amazonaws.sqs#DeleteMessage``."""
...
import aws_sdk_sqs.errors.invalid_id_format
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidIdFormat":
            raise aws_sdk_sqs.errors.invalid_id_format.InvalidIdFormat.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.delete_message_request.DeleteMessageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.delete_message_request.serialize_aws_json_1_0(input_)
    ).encode()
