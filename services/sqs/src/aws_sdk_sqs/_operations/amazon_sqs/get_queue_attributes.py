...
def build_request(
    ...
    input: aws_sdk_sqs.types.get_queue_attributes_request.GetQueueAttributesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.get_queue_attributes_request.serialize_aws_json_1_0(input)
    ).encode()
