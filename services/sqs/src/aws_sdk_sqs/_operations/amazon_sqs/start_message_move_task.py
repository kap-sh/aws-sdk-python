...
def build_request(
    ...
    input: aws_sdk_sqs.types.start_message_move_task_request.StartMessageMoveTaskRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.start_message_move_task_request.serialize_aws_json_1_0(input)
    ).encode()
