"""Generated from Smithy shape ``com.amazonaws.sqs#GetQueueUrl``."""
...
def handle_response(
    ...
    out: aws_sdk_sqs.types.get_queue_url_result.GetQueueUrlResult = (
        aws_sdk_sqs.types.get_queue_url_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.get_queue_url_request.GetQueueUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.get_queue_url_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_queue_url(
    ...
    input_: aws_sdk_sqs.types.get_queue_url_request.GetQueueUrlRequest,
) -> tuple[aws_sdk_sqs.types.get_queue_url_result.GetQueueUrlResult, zapros.Response]:
