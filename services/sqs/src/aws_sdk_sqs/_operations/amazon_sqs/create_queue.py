...
def build_request(
    ...
    input_: aws_sdk_sqs.types.create_queue_request.CreateQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.create_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_queue(
    ...
    input_: aws_sdk_sqs.types.create_queue_request.CreateQueueRequest,
) -> tuple[aws_sdk_sqs.types.create_queue_result.CreateQueueResult, zapros.Response]:
