"""Generated from Smithy shape ``com.amazonaws.sqs#RemovePermission``."""
...
def build_request(
    ...
    input: aws_sdk_sqs.types.remove_permission_request.RemovePermissionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.remove_permission_request.serialize_aws_json_1_0(input)
    ).encode()
