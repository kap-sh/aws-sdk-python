"""Generated from Smithy shape ``com.amazonaws.sqs#UntagQueue``."""
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.untag_queue_request.UntagQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSQS.UntagQueue"
    import aws_sdk_sqs.types.untag_queue_request

    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.untag_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
