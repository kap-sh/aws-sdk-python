...
def build_request(
    ...
    input: aws_sdk_sqs.types.delete_message_batch_request.DeleteMessageBatchRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.delete_message_batch_request.serialize_aws_json_1_0(input)
    ).encode()
