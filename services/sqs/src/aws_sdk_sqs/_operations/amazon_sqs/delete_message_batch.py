...
def handle_response(
    ...
    out: aws_sdk_sqs.types.delete_message_batch_result.DeleteMessageBatchResult = (
        aws_sdk_sqs.types.delete_message_batch_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.delete_message_batch_request.DeleteMessageBatchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.delete_message_batch_request.serialize_aws_json_1_0(input_)
    ).encode()
