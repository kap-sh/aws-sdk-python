"""Generated from Smithy shape ``com.amazonaws.sqs#ListMessageMoveTasks``."""
...
def handle_response(
    ...
    out: aws_sdk_sqs.types.list_message_move_tasks_result.ListMessageMoveTasksResult = (
        aws_sdk_sqs.types.list_message_move_tasks_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.list_message_move_tasks_request.ListMessageMoveTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSQS.ListMessageMoveTasks"
    import aws_sdk_sqs.types.list_message_move_tasks_request

    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.list_message_move_tasks_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_list_message_move_tasks(
