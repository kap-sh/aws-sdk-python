...
def build_request(
    ...
    input: aws_sdk_sqs.types.list_message_move_tasks_request.ListMessageMoveTasksRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.list_message_move_tasks_request.serialize_aws_json_1_0(input)
    ).encode()
