"""Generated from Smithy shape ``com.amazonaws.sqs#DeleteQueue``."""
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.delete_queue_request.DeleteQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.delete_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
