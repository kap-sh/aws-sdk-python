...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PurgeQueueInProgress":
            import aws_sdk_sqs.errors.purge_queue_in_progress

            raise aws_sdk_sqs.errors.purge_queue_in_progress.PurgeQueueInProgress.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.purge_queue_request.PurgeQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.purge_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
