...
def handle_response(
    ...
    out: aws_sdk_sqs.types.list_queues_result.ListQueuesResult = (
        aws_sdk_sqs.types.list_queues_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.list_queues_request.ListQueuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.list_queues_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_queues(
    ...
    input_: aws_sdk_sqs.types.list_queues_request.ListQueuesRequest,
) -> tuple[aws_sdk_sqs.types.list_queues_result.ListQueuesResult, zapros.Response]:
