...
def build_request(
    ...
    input_: aws_sdk_sqs.types.cancel_message_move_task_request.CancelMessageMoveTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.cancel_message_move_task_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
