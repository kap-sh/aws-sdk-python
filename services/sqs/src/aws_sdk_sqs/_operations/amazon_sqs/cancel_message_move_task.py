...
def build_request(
    ...
    input: aws_sdk_sqs.types.cancel_message_move_task_request.CancelMessageMoveTaskRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.cancel_message_move_task_request.serialize_aws_json_1_0(input)
    ).encode()
