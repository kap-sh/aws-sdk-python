"""Generated from Smithy shape ``com.amazonaws.sqs#ReceiveMessage``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OverLimit":
            import aws_sdk_sqs.errors.over_limit

            raise aws_sdk_sqs.errors.over_limit.OverLimit.from_aws_json_1_0(data)
...
def handle_response(
    ...
    out: aws_sdk_sqs.types.receive_message_result.ReceiveMessageResult = (
        aws_sdk_sqs.types.receive_message_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.receive_message_request.ReceiveMessageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.receive_message_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def receive_message(
    ...
    aws_sdk_sqs.types.receive_message_result.ReceiveMessageResult, zapros.Response
]:
