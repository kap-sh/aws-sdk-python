...
def build_request(
    ...
    input_: aws_sdk_sqs.types.send_message_batch_request.SendMessageBatchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.send_message_batch_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def send_message_batch(
    ...
    aws_sdk_sqs.types.send_message_batch_result.SendMessageBatchResult, zapros.Response
]:
