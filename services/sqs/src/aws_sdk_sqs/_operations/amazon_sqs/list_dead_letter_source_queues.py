"""Generated from Smithy shape ``com.amazonaws.sqs#ListDeadLetterSourceQueues``."""
...
def handle_response(
    ...
    out: aws_sdk_sqs.types.list_dead_letter_source_queues_result.ListDeadLetterSourceQueuesResult = aws_sdk_sqs.types.list_dead_letter_source_queues_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.list_dead_letter_source_queues_request.ListDeadLetterSourceQueuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSQS.ListDeadLetterSourceQueues"
    import aws_sdk_sqs.types.list_dead_letter_source_queues_request

    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.list_dead_letter_source_queues_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_dead_letter_source_queues(
