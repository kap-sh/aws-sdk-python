"""Generated from Smithy shape ``com.amazonaws.sqs#ChangeMessageVisibilityBatch``."""
...
def build_request(
    ...
    input_: aws_sdk_sqs.types.change_message_visibility_batch_request.ChangeMessageVisibilityBatchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_change_message_visibility_batch(
