...
def build_request(
    ...
    input: aws_sdk_sqs.types.set_queue_attributes_request.SetQueueAttributesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sqs.types.set_queue_attributes_request.serialize_aws_json_1_0(input)
    ).encode()
