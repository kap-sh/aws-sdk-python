"""Generated from Smithy shape ``com.amazonaws.sqs#InvalidAttributeName``."""
...
class InvalidAttributeName_(TypedDict, closed=True):
    message: NotRequired["aws_sdk_sqs.types.exception_message.ExceptionMessage"]


# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: InvalidAttributeName_) -> dict:
    out: dict = {}
    if "message" in value:
...
def deserialize_aws_json_1_0(data: dict) -> InvalidAttributeName_:
    out: InvalidAttributeName_ = {}  # type: ignore[typeddict-item]
    if "message" in data:
...
class InvalidAttributeName(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.sqs#InvalidAttributeName``."""
