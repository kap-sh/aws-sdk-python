...
import capo_sqs.errors.invalid_id_format
import capo_sqs.errors.invalid_security
import capo_sqs.errors.queue_does_not_exist
import capo_sqs.errors.receipt_handle_is_invalid
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidIdFormat":
            raise capo_sqs.errors.invalid_id_format.InvalidIdFormat.from_aws_json_1_0(
                data, message
            )
        ...
        case "ReceiptHandleIsInvalid":
            raise capo_sqs.errors.receipt_handle_is_invalid.ReceiptHandleIsInvalid.from_aws_json_1_0(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.delete_message_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
