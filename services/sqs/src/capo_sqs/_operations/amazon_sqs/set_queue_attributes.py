"""Generated from Smithy shape ``com.amazonaws.sqs#SetQueueAttributes``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.set_queue_attributes_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
async def async_set_queue_attributes(
