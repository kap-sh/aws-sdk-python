"""Generated from Smithy shape ``com.amazonaws.sqs#CancelMessageMoveTask``."""
...
def handle_response(
    ...
    out: capo_sqs.types.cancel_message_move_task_result.CancelMessageMoveTaskResult = (
        capo_sqs.types.cancel_message_move_task_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonSQS.CancelMessageMoveTask"
    body: bytes | None = json.dumps(
        capo_sqs.types.cancel_message_move_task_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_cancel_message_move_task(
