"""Generated from Smithy shape ``com.amazonaws.sqs#CreateQueue``."""
...
import capo_sqs.errors.invalid_attribute_value
import capo_sqs.errors.invalid_security
import capo_sqs.errors.queue_deleted_recently
import capo_sqs.errors.queue_name_exists
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidAttributeName":
            raise capo_sqs.errors.invalid_attribute_name.InvalidAttributeName.from_aws_json_1_0(
                data, message
            )
        case "InvalidAttributeValue":
            raise capo_sqs.errors.invalid_attribute_value.InvalidAttributeValue.from_aws_json_1_0(
                data, message
            )
        ...
        case "QueueDeletedRecently":
            raise capo_sqs.errors.queue_deleted_recently.QueueDeletedRecently.from_aws_json_1_0(
                data, message
            )
        case "QueueNameExists":
            raise capo_sqs.errors.queue_name_exists.QueueNameExists.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_sqs.types.create_queue_result.CreateQueueResult = (
        capo_sqs.types.create_queue_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.create_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_queue(
    ...
    input_: capo_sqs.types.create_queue_request.CreateQueueRequest,
) -> tuple[capo_sqs.types.create_queue_result.CreateQueueResult, zapros.Response]:
