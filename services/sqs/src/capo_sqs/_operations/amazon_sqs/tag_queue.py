"""Generated from Smithy shape ``com.amazonaws.sqs#TagQueue``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonSQS.TagQueue"
    body: bytes | None = json.dumps(
        capo_sqs.types.tag_queue_request.serialize_aws_json_1_0(input_), allow_nan=False
    ).encode()
...
def tag_queue(
    options: OperationOptions, input_: capo_sqs.types.tag_queue_request.TagQueueRequest
