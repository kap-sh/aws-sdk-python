"""Generated from Smithy shape ``com.amazonaws.sqs#ListQueues``."""
...
def handle_response(
    ...
    out: capo_sqs.types.list_queues_result.ListQueuesResult = (
        capo_sqs.types.list_queues_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.list_queues_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_queues(
    ...
    input_: capo_sqs.types.list_queues_request.ListQueuesRequest,
) -> tuple[capo_sqs.types.list_queues_result.ListQueuesResult, zapros.Response]:
