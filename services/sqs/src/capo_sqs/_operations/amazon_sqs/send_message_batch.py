"""Generated from Smithy shape ``com.amazonaws.sqs#SendMessageBatch``."""
...
import capo_sqs.errors.batch_request_too_long
import capo_sqs.errors.empty_batch_request
import capo_sqs.errors.invalid_address
import capo_sqs.errors.invalid_batch_entry_id
...
import capo_sqs.errors.too_many_entries_in_batch_request
...
def handle_response(
    ...
    out: capo_sqs.types.send_message_batch_result.SendMessageBatchResult = (
        capo_sqs.types.send_message_batch_result.deserialize_aws_json_1_0(
...
def send_message_batch(
    ...
    capo_sqs.types.send_message_batch_result.SendMessageBatchResult, zapros.Response
]:
...
async def async_send_message_batch(
