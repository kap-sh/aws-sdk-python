...
import capo_sqs.errors.message_not_inflight
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MessageNotInflight":
            raise capo_sqs.errors.message_not_inflight.MessageNotInflight.from_aws_json_1_0(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.change_message_visibility_request.serialize_aws_json_1_0(input_)
    ).encode()
