"""Generated from Smithy shape ``com.amazonaws.sqs#PurgeQueue``."""
...
import capo_sqs.errors.purge_queue_in_progress
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PurgeQueueInProgress":
            raise capo_sqs.errors.purge_queue_in_progress.PurgeQueueInProgress.from_aws_json_1_0(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.purge_queue_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
