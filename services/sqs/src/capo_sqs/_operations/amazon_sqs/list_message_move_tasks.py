...
def handle_response(
    ...
    out: capo_sqs.types.list_message_move_tasks_result.ListMessageMoveTasksResult = (
        capo_sqs.types.list_message_move_tasks_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.list_message_move_tasks_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
