"""Generated from Smithy shape ``com.amazonaws.sqs#DeleteMessageBatch``."""
...
def handle_response(
    ...
    out: capo_sqs.types.delete_message_batch_result.DeleteMessageBatchResult = (
        capo_sqs.types.delete_message_batch_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.delete_message_batch_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def delete_message_batch(
    ...
    capo_sqs.types.delete_message_batch_result.DeleteMessageBatchResult, zapros.Response
]:
...
async def async_delete_message_batch(
