...
def handle_response(
    ...
    out: capo_sqs.types.get_queue_attributes_result.GetQueueAttributesResult = (
        capo_sqs.types.get_queue_attributes_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.get_queue_attributes_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_queue_attributes(
    ...
    capo_sqs.types.get_queue_attributes_result.GetQueueAttributesResult, zapros.Response
]:
