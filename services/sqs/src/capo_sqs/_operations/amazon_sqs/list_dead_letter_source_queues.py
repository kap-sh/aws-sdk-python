...
def handle_response(
    ...
    out: capo_sqs.types.list_dead_letter_source_queues_result.ListDeadLetterSourceQueuesResult = capo_sqs.types.list_dead_letter_source_queues_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.list_dead_letter_source_queues_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
