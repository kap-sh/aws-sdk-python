...
def handle_response(
    ...
    out: capo_sqs.types.get_queue_url_result.GetQueueUrlResult = (
        capo_sqs.types.get_queue_url_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.get_queue_url_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_queue_url(
    ...
    input_: capo_sqs.types.get_queue_url_request.GetQueueUrlRequest,
) -> tuple[capo_sqs.types.get_queue_url_result.GetQueueUrlResult, zapros.Response]:
