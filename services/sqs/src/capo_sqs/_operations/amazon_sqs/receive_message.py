...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OverLimit":
            raise capo_sqs.errors.over_limit.OverLimit.from_aws_json_1_0(data)
...
def handle_response(
    ...
    out: capo_sqs.types.receive_message_result.ReceiveMessageResult = (
        capo_sqs.types.receive_message_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.receive_message_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def receive_message(
    ...
    input_: capo_sqs.types.receive_message_request.ReceiveMessageRequest,
) -> tuple[capo_sqs.types.receive_message_result.ReceiveMessageResult, zapros.Response]:
