...
def handle_response(
    ...
    out: capo_sqs.types.change_message_visibility_batch_result.ChangeMessageVisibilityBatchResult = capo_sqs.types.change_message_visibility_batch_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sqs.types.change_message_visibility_batch_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
