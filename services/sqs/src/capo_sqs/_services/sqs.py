...
from capo_sqs._services._aws_config import aws_config
...
class SQSClientConfig(TypedDict, total=False, closed=True):
...
class SQSClient:
    ...
    def operation_options(
        self, config_overrides: Optional[SQSClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: SQSClientConfig = config_overrides or {}
    ...
    def add_permission(
        ...
        *,
        config_overrides: Optional[SQSClientConfig] = None,
    ) -> None:
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.add_permission_request.AddPermissionRequest]",
        ) -> OperationResponse[None]:
            import capo_sqs._operations.amazon_sqs.add_permission

            output, http_response = (
                capo_sqs._operations.amazon_sqs.add_permission.add_permission(
    ...
    def cancel_message_move_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.cancel_message_move_task_request.CancelMessageMoveTaskRequest]",
        ) -> OperationResponse[
            "capo_sqs.types.cancel_message_move_task_result.CancelMessageMoveTaskResult"
        ]:
            ...
            output, http_response = (
                capo_sqs._operations.amazon_sqs.cancel_message_move_task.cancel_message_move_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def change_message_visibility(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.change_message_visibility_request.ChangeMessageVisibilityRequest]",
        ) -> OperationResponse[None]:
            import capo_sqs._operations.amazon_sqs.change_message_visibility

            output, http_response = (
                capo_sqs._operations.amazon_sqs.change_message_visibility.change_message_visibility(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def change_message_visibility_batch(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.change_message_visibility_batch_request.ChangeMessageVisibilityBatchRequest]",
        ) -> OperationResponse[
            "capo_sqs.types.change_message_visibility_batch_result.ChangeMessageVisibilityBatchResult"
        ]:
            ...
            output, http_response = (
                capo_sqs._operations.amazon_sqs.change_message_visibility_batch.change_message_visibility_batch(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_queue(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.create_queue_request.CreateQueueRequest]",
        ) -> OperationResponse["capo_sqs.types.create_queue_result.CreateQueueResult"]:
            import capo_sqs._operations.amazon_sqs.create_queue

            output, http_response = (
                capo_sqs._operations.amazon_sqs.create_queue.create_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_message(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.delete_message_request.DeleteMessageRequest]",
        ) -> OperationResponse[None]:
            import capo_sqs._operations.amazon_sqs.delete_message

            output, http_response = (
                capo_sqs._operations.amazon_sqs.delete_message.delete_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_message_batch(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.delete_message_batch_request.DeleteMessageBatchRequest]",
        ) -> OperationResponse[
            "capo_sqs.types.delete_message_batch_result.DeleteMessageBatchResult"
        ]:
            ...
            output, http_response = (
                capo_sqs._operations.amazon_sqs.delete_message_batch.delete_message_batch(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_queue(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.delete_queue_request.DeleteQueueRequest]",
        ) -> OperationResponse[None]:
            import capo_sqs._operations.amazon_sqs.delete_queue

            output, http_response = (
                capo_sqs._operations.amazon_sqs.delete_queue.delete_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_queue_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.get_queue_attributes_request.GetQueueAttributesRequest]",
        ) -> OperationResponse[
            "capo_sqs.types.get_queue_attributes_result.GetQueueAttributesResult"
        ]:
            ...
            output, http_response = (
                capo_sqs._operations.amazon_sqs.get_queue_attributes.get_queue_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_queue_url(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.get_queue_url_request.GetQueueUrlRequest]",
        ) -> OperationResponse["capo_sqs.types.get_queue_url_result.GetQueueUrlResult"]:
            import capo_sqs._operations.amazon_sqs.get_queue_url

            output, http_response = (
                capo_sqs._operations.amazon_sqs.get_queue_url.get_queue_url(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_dead_letter_source_queues(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.list_dead_letter_source_queues_request.ListDeadLetterSourceQueuesRequest]",
        ) -> OperationResponse[
            "capo_sqs.types.list_dead_letter_source_queues_result.ListDeadLetterSourceQueuesResult"
        ]:
            ...
            output, http_response = (
                capo_sqs._operations.amazon_sqs.list_dead_letter_source_queues.list_dead_letter_source_queues(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_dead_letter_source_queues(
        ...
        *,
        ...
        next_token: Optional["capo_sqs.types.token.Token"] = None,
        max_results: Optional["capo_sqs.types.boxed_integer.BoxedInteger"] = None,
    ) -> "Iterator[capo_sqs.types.string.String]":
        _token = next_token
        while True:
            _response = self.list_dead_letter_source_queues(
                queue_url,
    ...
    def list_message_move_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.list_message_move_tasks_request.ListMessageMoveTasksRequest]",
        ) -> OperationResponse[
            "capo_sqs.types.list_message_move_tasks_result.ListMessageMoveTasksResult"
        ]:
            ...
            output, http_response = (
                capo_sqs._operations.amazon_sqs.list_message_move_tasks.list_message_move_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_queues(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.list_queues_request.ListQueuesRequest]",
        ) -> OperationResponse["capo_sqs.types.list_queues_result.ListQueuesResult"]:
            import capo_sqs._operations.amazon_sqs.list_queues

            output, http_response = (
                capo_sqs._operations.amazon_sqs.list_queues.list_queues(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_queue_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.list_queue_tags_request.ListQueueTagsRequest]",
        ) -> OperationResponse[
            "capo_sqs.types.list_queue_tags_result.ListQueueTagsResult"
        ]:
            ...
            output, http_response = (
                capo_sqs._operations.amazon_sqs.list_queue_tags.list_queue_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def purge_queue(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.purge_queue_request.PurgeQueueRequest]",
        ) -> OperationResponse[None]:
            import capo_sqs._operations.amazon_sqs.purge_queue

            output, http_response = (
                capo_sqs._operations.amazon_sqs.purge_queue.purge_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def receive_message(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.receive_message_request.ReceiveMessageRequest]",
        ) -> OperationResponse[
            "capo_sqs.types.receive_message_result.ReceiveMessageResult"
        ]:
            ...
            output, http_response = (
                capo_sqs._operations.amazon_sqs.receive_message.receive_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_permission(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.remove_permission_request.RemovePermissionRequest]",
        ) -> OperationResponse[None]:
            import capo_sqs._operations.amazon_sqs.remove_permission

            output, http_response = (
                capo_sqs._operations.amazon_sqs.remove_permission.remove_permission(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_message(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.send_message_request.SendMessageRequest]",
        ) -> OperationResponse["capo_sqs.types.send_message_result.SendMessageResult"]:
            import capo_sqs._operations.amazon_sqs.send_message

            output, http_response = (
                capo_sqs._operations.amazon_sqs.send_message.send_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_message_batch(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.send_message_batch_request.SendMessageBatchRequest]",
        ) -> OperationResponse[
            "capo_sqs.types.send_message_batch_result.SendMessageBatchResult"
        ]:
            ...
            output, http_response = (
                capo_sqs._operations.amazon_sqs.send_message_batch.send_message_batch(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_queue_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.set_queue_attributes_request.SetQueueAttributesRequest]",
        ) -> OperationResponse[None]:
            import capo_sqs._operations.amazon_sqs.set_queue_attributes

            output, http_response = (
                capo_sqs._operations.amazon_sqs.set_queue_attributes.set_queue_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_message_move_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.start_message_move_task_request.StartMessageMoveTaskRequest]",
        ) -> OperationResponse[
            "capo_sqs.types.start_message_move_task_result.StartMessageMoveTaskResult"
        ]:
            ...
            output, http_response = (
                capo_sqs._operations.amazon_sqs.start_message_move_task.start_message_move_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_queue(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.tag_queue_request.TagQueueRequest]",
        ) -> OperationResponse[None]:
            import capo_sqs._operations.amazon_sqs.tag_queue

            output, http_response = capo_sqs._operations.amazon_sqs.tag_queue.tag_queue(
                req.options, req.input
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_queue(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sqs.types.untag_queue_request.UntagQueueRequest]",
        ) -> OperationResponse[None]:
            import capo_sqs._operations.amazon_sqs.untag_queue

            output, http_response = (
                capo_sqs._operations.amazon_sqs.untag_queue.untag_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
