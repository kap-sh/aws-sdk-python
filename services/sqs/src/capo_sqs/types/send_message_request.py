...
class SendMessageRequest(TypedDict, closed=True):
    ...
    message_deduplication_id: NotRequired["capo_sqs.types.string.String"]
...
def serialize_aws_json_1_0(value: SendMessageRequest) -> dict:
    ...
    if "message_system_attributes" in value:
        ...
        out["MessageSystemAttributes"] = (
            capo_sqs.types.message_body_system_attribute_map.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> SendMessageRequest:
    out: SendMessageRequest = {}  # type: ignore[typeddict-item]
    if "QueueUrl" in data:
        out["queue_url"] = data["QueueUrl"]
    else:
        raise DeserializationError("SendMessageRequest.queue_url required")
    if "MessageBody" in data:
        out["message_body"] = data["MessageBody"]
    else:
        raise DeserializationError("SendMessageRequest.message_body required")
    ...
    if "MessageSystemAttributes" in data:
        ...
        out["message_system_attributes"] = (
            capo_sqs.types.message_body_system_attribute_map.deserialize_aws_json_1_0(
