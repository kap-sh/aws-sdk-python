...
class ListMessageMoveTasksResultEntry(TypedDict, closed=True):
    ...
    approximate_number_of_messages_moved: "capo_sqs.types.long.Long"
    ...
    approximate_number_of_messages_to_move: NotRequired[
        "capo_sqs.types.nullable_long.NullableLong"
    ]
    ...
    failure_reason: NotRequired["capo_sqs.types.string.String"]
    """<p>The task failure reason (only included if the task status is FAILED).</p>"""
    started_timestamp: "capo_sqs.types.long.Long"
