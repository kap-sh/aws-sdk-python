...
from ._services.async_trusted_advisor import (
    AsyncTrustedAdvisorClient as AsyncTrustedAdvisorClient,
)
from ._services.trusted_advisor import TrustedAdvisorClient as TrustedAdvisorClient
