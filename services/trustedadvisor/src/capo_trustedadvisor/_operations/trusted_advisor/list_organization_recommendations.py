"""Generated from Smithy shape ``com.amazonaws.trustedadvisor#ListOrganizationRecommendations``."""
...
def handle_response(
    ...
    out: capo_trustedadvisor.types.list_organization_recommendations_response.ListOrganizationRecommendationsResponse = capo_trustedadvisor.types.list_organization_recommendations_response.deserialize_json(
