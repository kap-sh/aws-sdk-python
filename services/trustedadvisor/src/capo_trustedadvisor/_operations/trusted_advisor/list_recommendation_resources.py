"""Generated from Smithy shape ``com.amazonaws.trustedadvisor#ListRecommendationResources``."""
...
import capo_trustedadvisor.types.recommendation_resource_summary_list
...
def handle_response(
    ...
    out: capo_trustedadvisor.types.list_recommendation_resources_response.ListRecommendationResourcesResponse = capo_trustedadvisor.types.list_recommendation_resources_response.deserialize_json(
...
def build_request(
    ...
    if "exclusion_status" in input_:
        params["exclusionStatus"] = str(input_["exclusion_status"])
    if "region_code" in input_:
        params["regionCode"] = str(input_["region_code"])
...
async def async_list_recommendation_resources(
