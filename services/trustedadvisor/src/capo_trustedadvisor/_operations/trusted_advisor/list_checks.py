"""Generated from Smithy shape ``com.amazonaws.trustedadvisor#ListChecks``."""
...
import capo_trustedadvisor.types.check_summary_list
...
def handle_response(
    ...
    out: capo_trustedadvisor.types.list_checks_response.ListChecksResponse = (
        capo_trustedadvisor.types.list_checks_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/checks"
    params: dict[str, str] = {}
...
def list_checks(
    ...
    capo_trustedadvisor.types.list_checks_response.ListChecksResponse, zapros.Response
]:
