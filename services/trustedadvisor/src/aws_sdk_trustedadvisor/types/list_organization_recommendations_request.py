"""Generated from Smithy shape ``com.amazonaws.trustedadvisor#ListOrganizationRecommendationsRequest``."""
...
class ListOrganizationRecommendationsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListOrganizationRecommendationsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListOrganizationRecommendationsRequest:
    out: ListOrganizationRecommendationsRequest = {}  # type: ignore[typeddict-item]
    return out
