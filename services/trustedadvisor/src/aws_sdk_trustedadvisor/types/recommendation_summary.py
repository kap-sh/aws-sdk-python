...
if TYPE_CHECKING:
    ...
    import aws_sdk_trustedadvisor.types.status_reason
...
class RecommendationSummary(TypedDict, closed=True):
    ...
    arn: "aws_sdk_trustedadvisor.types.account_recommendation_arn.AccountRecommendationArn"
    """<p>The ARN of the Recommendation</p>"""
    status_reason: NotRequired[
        "aws_sdk_trustedadvisor.types.status_reason.StatusReason"
    ]
...
def serialize_json(value: RecommendationSummary) -> dict:
    ...
    if "status_reason" in value:
        ...
        out["statusReason"] = aws_sdk_trustedadvisor.types.status_reason.serialize_json(
            value["status_reason"]
        )
    return out
...
def deserialize_json(data: dict) -> RecommendationSummary:
    ...
    if "statusReason" in data:
        ...
        out["status_reason"] = (
            aws_sdk_trustedadvisor.types.status_reason.deserialize_json(
                data["statusReason"]
            )
        )
    return out
