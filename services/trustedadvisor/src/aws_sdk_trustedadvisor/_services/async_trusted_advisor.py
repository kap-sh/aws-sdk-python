...
from aws_sdk_trustedadvisor._services._aws_config import aaws_config
...
class AsyncTrustedAdvisorClientConfig(TypedDict, total=False):
...
class AsyncTrustedAdvisorClient:
    ...
    async def batch_update_recommendation_resource_exclusion(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.batch_update_recommendation_resource_exclusion_request.BatchUpdateRecommendationResourceExclusionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_trustedadvisor.types.batch_update_recommendation_resource_exclusion_response.BatchUpdateRecommendationResourceExclusionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.batch_update_recommendation_resource_exclusion.async_batch_update_recommendation_resource_exclusion(
    ...
    async def get_organization_recommendation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.get_organization_recommendation_request.GetOrganizationRecommendationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_trustedadvisor.types.get_organization_recommendation_response.GetOrganizationRecommendationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.get_organization_recommendation.async_get_organization_recommendation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_recommendation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.get_recommendation_request.GetRecommendationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_trustedadvisor.types.get_recommendation_response.GetRecommendationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.get_recommendation.async_get_recommendation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_checks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.list_checks_request.ListChecksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_trustedadvisor.types.list_checks_response.ListChecksResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.list_checks.async_list_checks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_trustedadvisor.types.check_summary.CheckSummary]":
        _token = next_token
        while True:
    ...
    async def list_organization_recommendation_accounts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.list_organization_recommendation_accounts_request.ListOrganizationRecommendationAccountsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_trustedadvisor.types.list_organization_recommendation_accounts_response.ListOrganizationRecommendationAccountsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.list_organization_recommendation_accounts.async_list_organization_recommendation_accounts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_trustedadvisor.types.account_recommendation_lifecycle_summary.AccountRecommendationLifecycleSummary]":
        _token = next_token
        while True:
    ...
    async def list_organization_recommendation_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.list_organization_recommendation_resources_request.ListOrganizationRecommendationResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_trustedadvisor.types.list_organization_recommendation_resources_response.ListOrganizationRecommendationResourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.list_organization_recommendation_resources.async_list_organization_recommendation_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_trustedadvisor.types.organization_recommendation_resource_summary.OrganizationRecommendationResourceSummary]":
        _token = next_token
        while True:
    ...
    async def list_organization_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.list_organization_recommendations_request.ListOrganizationRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_trustedadvisor.types.list_organization_recommendations_response.ListOrganizationRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.list_organization_recommendations.async_list_organization_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_organization_recommendations(
        ...
        *,
        ...
        after_last_updated_at: Optional[datetime.datetime] = None,
        before_last_updated_at: Optional[datetime.datetime] = None,
    ) -> "AsyncIterator[aws_sdk_trustedadvisor.types.organization_recommendation_summary.OrganizationRecommendationSummary]":
        _token = next_token
        while True:
    ...
    async def list_recommendation_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.list_recommendation_resources_request.ListRecommendationResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_trustedadvisor.types.list_recommendation_resources_response.ListRecommendationResourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.list_recommendation_resources.async_list_recommendation_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_trustedadvisor.types.recommendation_resource_summary.RecommendationResourceSummary]":
        _token = next_token
        while True:
    ...
    async def list_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.list_recommendations_request.ListRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_trustedadvisor.types.list_recommendations_response.ListRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.list_recommendations.async_list_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_trustedadvisor.types.recommendation_summary.RecommendationSummary]":
        _token = next_token
        while True:
    ...
    async def update_organization_recommendation_lifecycle(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.update_organization_recommendation_lifecycle_request.UpdateOrganizationRecommendationLifecycleRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.update_organization_recommendation_lifecycle.async_update_organization_recommendation_lifecycle(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_recommendation_lifecycle(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_trustedadvisor.types.update_recommendation_lifecycle_request.UpdateRecommendationLifecycleRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_trustedadvisor._operations.trusted_advisor.update_recommendation_lifecycle.async_update_recommendation_lifecycle(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
