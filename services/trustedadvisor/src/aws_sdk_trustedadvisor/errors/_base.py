...
class TrustedAdvisorError(Exception):
    """Base class for all TrustedAdvisor service errors."""


class ServiceError(TrustedAdvisorError):
...
class SerializationError(TrustedAdvisorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(TrustedAdvisorError):
...
class WaiterFailedError(TrustedAdvisorError):
...
class WaiterTimeoutError(TrustedAdvisorError):
