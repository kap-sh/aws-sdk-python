...
def handle_response(
    ...
    out: aws_sdk_trustedadvisor.types.list_organization_recommendation_resources_response.ListOrganizationRecommendationResourcesResponse = aws_sdk_trustedadvisor.types.list_organization_recommendation_resources_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_trustedadvisor.types.list_organization_recommendation_resources_request.ListOrganizationRecommendationResourcesRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["organization_recommendation_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    if "exclusion_status" in input:
        params["exclusionStatus"] = str(input["exclusion_status"])
    if "region_code" in input:
        params["regionCode"] = str(input["region_code"])
    if "affected_account_id" in input:
        params["affectedAccountId"] = str(input["affected_account_id"])
