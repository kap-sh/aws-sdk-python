...
def build_request(
    ...
    input_: aws_sdk_trustedadvisor.types.list_organization_recommendation_resources_request.ListOrganizationRecommendationResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "affected_account_id" in input_:
        params["affectedAccountId"] = str(input_["affected_account_id"])
