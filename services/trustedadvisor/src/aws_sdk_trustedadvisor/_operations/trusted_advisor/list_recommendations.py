"""Generated from Smithy shape ``com.amazonaws.trustedadvisor#ListRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_trustedadvisor.types.list_recommendations_response.ListRecommendationsResponse = aws_sdk_trustedadvisor.types.list_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_trustedadvisor.types.list_recommendations_request.ListRecommendationsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/recommendations"
    params: dict[str, str] = {}
    ...
    if "language" in input:
        params["language"] = str(input["language"])
