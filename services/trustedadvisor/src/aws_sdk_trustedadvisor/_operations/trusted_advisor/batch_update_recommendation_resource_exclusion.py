...
def handle_response(
    ...
    out: aws_sdk_trustedadvisor.types.batch_update_recommendation_resource_exclusion_response.BatchUpdateRecommendationResourceExclusionResponse = aws_sdk_trustedadvisor.types.batch_update_recommendation_resource_exclusion_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_trustedadvisor.types.batch_update_recommendation_resource_exclusion_request.BatchUpdateRecommendationResourceExclusionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_trustedadvisor.types.batch_update_recommendation_resource_exclusion_request.serialize_json(
            input_
        )
    ).encode()
