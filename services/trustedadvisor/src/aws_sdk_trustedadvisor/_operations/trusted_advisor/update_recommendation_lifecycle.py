...
def build_request(
    ...
    input: aws_sdk_trustedadvisor.types.update_recommendation_lifecycle_request.UpdateRecommendationLifecycleRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["recommendation_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
