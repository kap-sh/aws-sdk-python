...
def build_request(
    ...
    input: aws_sdk_trustedadvisor.types.update_organization_recommendation_lifecycle_request.UpdateOrganizationRecommendationLifecycleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_trustedadvisor.types.update_organization_recommendation_lifecycle_request.serialize_json(
            input
        )
    ).encode()
