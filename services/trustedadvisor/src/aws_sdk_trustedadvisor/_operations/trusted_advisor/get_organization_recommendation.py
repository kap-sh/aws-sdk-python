...
def handle_response(
    ...
    out: aws_sdk_trustedadvisor.types.get_organization_recommendation_response.GetOrganizationRecommendationResponse = aws_sdk_trustedadvisor.types.get_organization_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_trustedadvisor.types.get_organization_recommendation_request.GetOrganizationRecommendationRequest,
) -> zapros.Request:
