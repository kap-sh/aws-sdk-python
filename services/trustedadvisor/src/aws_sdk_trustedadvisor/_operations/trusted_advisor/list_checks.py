...
def handle_response(
    ...
    out: aws_sdk_trustedadvisor.types.list_checks_response.ListChecksResponse = (
        aws_sdk_trustedadvisor.types.list_checks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_trustedadvisor.types.list_checks_request.ListChecksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
