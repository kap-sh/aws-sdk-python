...
def handle_response(
    ...
    out: aws_sdk_trustedadvisor.types.list_organization_recommendations_response.ListOrganizationRecommendationsResponse = aws_sdk_trustedadvisor.types.list_organization_recommendations_response.deserialize_json(
