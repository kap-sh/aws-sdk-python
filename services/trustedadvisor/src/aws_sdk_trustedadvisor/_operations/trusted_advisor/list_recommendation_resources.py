...
def handle_response(
    ...
    out: aws_sdk_trustedadvisor.types.list_recommendation_resources_response.ListRecommendationResourcesResponse = aws_sdk_trustedadvisor.types.list_recommendation_resources_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_trustedadvisor.types.list_recommendation_resources_request.ListRecommendationResourcesRequest,
) -> zapros.Request:
