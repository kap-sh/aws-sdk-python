...
def handle_response(
    ...
    out: aws_sdk_trustedadvisor.types.list_organization_recommendation_accounts_response.ListOrganizationRecommendationAccountsResponse = aws_sdk_trustedadvisor.types.list_organization_recommendation_accounts_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_trustedadvisor.types.list_organization_recommendation_accounts_request.ListOrganizationRecommendationAccountsRequest,
) -> zapros.Request:
