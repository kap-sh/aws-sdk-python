...
```
pip install aws-sdk-trustedadvisor
```

## Usage

```python
from aws_sdk_trustedadvisor import AsyncTrustedAdvisorClient
...
```python
from aws_sdk_trustedadvisor import AsyncTrustedAdvisorClient
from aws_sdk_trustedadvisor.error import AccessDeniedException
