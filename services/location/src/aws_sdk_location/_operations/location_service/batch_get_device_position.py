...
def build_request(
    ...
    input: aws_sdk_location.types.batch_get_device_position_request.BatchGetDevicePositionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.batch_get_device_position_request.serialize_json(input)
    ).encode()
