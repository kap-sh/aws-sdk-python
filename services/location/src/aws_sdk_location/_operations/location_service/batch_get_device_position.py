"""Generated from Smithy shape ``com.amazonaws.location#BatchGetDevicePosition``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.batch_get_device_position_response.BatchGetDevicePositionResponse = aws_sdk_location.types.batch_get_device_position_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.batch_get_device_position_request.BatchGetDevicePositionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/tracking/v0/trackers/{TrackerName}/get-positions"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.batch_get_device_position_request.serialize_json(input_)
    ).encode()
...
async def async_batch_get_device_position(
