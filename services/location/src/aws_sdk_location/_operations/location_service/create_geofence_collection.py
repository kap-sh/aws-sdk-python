"""Generated from Smithy shape ``com.amazonaws.location#CreateGeofenceCollection``."""
...
import aws_sdk_location.errors.conflict_exception
import aws_sdk_location.errors.internal_server_exception
import aws_sdk_location.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_location.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_location.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_location.types.create_geofence_collection_response.CreateGeofenceCollectionResponse = aws_sdk_location.types.create_geofence_collection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.create_geofence_collection_request.CreateGeofenceCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/geofencing/v0/collections"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_location.types.create_geofence_collection_request.serialize_json(input_)
    ).encode()
...
async def async_create_geofence_collection(
