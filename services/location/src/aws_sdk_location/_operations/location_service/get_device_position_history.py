"""Generated from Smithy shape ``com.amazonaws.location#GetDevicePositionHistory``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.get_device_position_history_response.GetDevicePositionHistoryResponse = aws_sdk_location.types.get_device_position_history_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.get_device_position_history_request.GetDevicePositionHistoryRequest,
) -> zapros.Request:
    ...
    url = url.replace("{TrackerName}", quote(str(input["tracker_name"]), safe=""))
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.get_device_position_history_request.serialize_json(input)
    ).encode()
...
async def async_get_device_position_history(
