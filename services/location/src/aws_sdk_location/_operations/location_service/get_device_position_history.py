...
def build_request(
    ...
    input_: aws_sdk_location.types.get_device_position_history_request.GetDevicePositionHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.get_device_position_history_request.serialize_json(
            input_
        )
    ).encode()
