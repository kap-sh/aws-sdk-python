...
def build_request(
    ...
    input: aws_sdk_location.types.list_route_calculators_request.ListRouteCalculatorsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_route_calculators_request.serialize_json(input)
    ).encode()
