...
def handle_response(
    ...
    out: aws_sdk_location.types.list_route_calculators_response.ListRouteCalculatorsResponse = aws_sdk_location.types.list_route_calculators_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.list_route_calculators_request.ListRouteCalculatorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_route_calculators_request.serialize_json(input_)
    ).encode()
