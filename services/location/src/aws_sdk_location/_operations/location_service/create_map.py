...
def handle_response(
    ...
    out: aws_sdk_location.types.create_map_response.CreateMapResponse = (
        aws_sdk_location.types.create_map_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.create_map_request.CreateMapRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.create_map_request.serialize_json(input_)
    ).encode()
...
def create_map(
    ...
    aws_sdk_location.types.create_map_response.CreateMapResponse, zapros.Response
]:
