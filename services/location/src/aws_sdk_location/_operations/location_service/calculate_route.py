...
def handle_response(
    ...
    out: aws_sdk_location.types.calculate_route_response.CalculateRouteResponse = (
        aws_sdk_location.types.calculate_route_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.calculate_route_request.CalculateRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.calculate_route_request.serialize_json(input_)
    ).encode()
