"""Generated from Smithy shape ``com.amazonaws.location#DescribeKey``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.describe_key_response.DescribeKeyResponse = (
        aws_sdk_location.types.describe_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.describe_key_request.DescribeKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_key(
    ...
    aws_sdk_location.types.describe_key_response.DescribeKeyResponse, zapros.Response
]:
