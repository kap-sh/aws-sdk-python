"""Generated from Smithy shape ``com.amazonaws.location#DescribePlaceIndex``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.describe_place_index_response.DescribePlaceIndexResponse = aws_sdk_location.types.describe_place_index_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.describe_place_index_request.DescribePlaceIndexRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/places/v0/indexes/{IndexName}"
...
async def async_describe_place_index(
