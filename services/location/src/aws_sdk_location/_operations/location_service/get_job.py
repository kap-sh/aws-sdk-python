...
def handle_response(
    ...
    out: aws_sdk_location.types.get_job_response.GetJobResponse = (
        aws_sdk_location.types.get_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.get_job_request.GetJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_job(
    ...
    input_: aws_sdk_location.types.get_job_request.GetJobRequest,
) -> tuple[aws_sdk_location.types.get_job_response.GetJobResponse, zapros.Response]:
