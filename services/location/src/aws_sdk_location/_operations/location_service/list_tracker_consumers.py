"""Generated from Smithy shape ``com.amazonaws.location#ListTrackerConsumers``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.list_tracker_consumers_response.ListTrackerConsumersResponse = aws_sdk_location.types.list_tracker_consumers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.list_tracker_consumers_request.ListTrackerConsumersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/tracking/v0/trackers/{TrackerName}/list-consumers"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_tracker_consumers_request.serialize_json(input_)
    ).encode()
...
async def async_list_tracker_consumers(
