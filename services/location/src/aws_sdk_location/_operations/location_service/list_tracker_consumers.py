...
def build_request(
    ...
    input: aws_sdk_location.types.list_tracker_consumers_request.ListTrackerConsumersRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_tracker_consumers_request.serialize_json(input)
    ).encode()
