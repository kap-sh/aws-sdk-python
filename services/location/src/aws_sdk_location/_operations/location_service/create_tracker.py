"""Generated from Smithy shape ``com.amazonaws.location#CreateTracker``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.create_tracker_response.CreateTrackerResponse = (
        aws_sdk_location.types.create_tracker_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.create_tracker_request.CreateTrackerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.create_tracker_request.serialize_json(input)
    ).encode()
