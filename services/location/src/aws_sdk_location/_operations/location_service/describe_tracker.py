"""Generated from Smithy shape ``com.amazonaws.location#DescribeTracker``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.describe_tracker_response.DescribeTrackerResponse = (
        aws_sdk_location.types.describe_tracker_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.describe_tracker_request.DescribeTrackerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_tracker(
