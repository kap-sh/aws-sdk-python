...
def handle_response(
    ...
    out: aws_sdk_location.types.get_place_response.GetPlaceResponse = (
        aws_sdk_location.types.get_place_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.get_place_request.GetPlaceRequest,
) -> zapros.Request:
    ...
    url = url.replace("{PlaceId}", quote(str(input["place_id"]), safe=""))
    params: dict[str, str] = {}
...
def get_place(
    ...
    input: aws_sdk_location.types.get_place_request.GetPlaceRequest,
) -> tuple[aws_sdk_location.types.get_place_response.GetPlaceResponse, zapros.Response]:
