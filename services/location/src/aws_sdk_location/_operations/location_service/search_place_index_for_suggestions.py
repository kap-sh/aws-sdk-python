...
def handle_response(
    ...
    out: aws_sdk_location.types.search_place_index_for_suggestions_response.SearchPlaceIndexForSuggestionsResponse = aws_sdk_location.types.search_place_index_for_suggestions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.search_place_index_for_suggestions_request.SearchPlaceIndexForSuggestionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.search_place_index_for_suggestions_request.serialize_json(
            input_
        )
    ).encode()
