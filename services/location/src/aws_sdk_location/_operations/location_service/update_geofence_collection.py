...
def build_request(
    ...
    input: aws_sdk_location.types.update_geofence_collection_request.UpdateGeofenceCollectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.update_geofence_collection_request.serialize_json(input)
    ).encode()
