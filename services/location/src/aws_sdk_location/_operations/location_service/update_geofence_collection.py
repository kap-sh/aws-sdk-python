...
def handle_response(
    ...
    out: aws_sdk_location.types.update_geofence_collection_response.UpdateGeofenceCollectionResponse = aws_sdk_location.types.update_geofence_collection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.update_geofence_collection_request.UpdateGeofenceCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.update_geofence_collection_request.serialize_json(input_)
    ).encode()
