...
def handle_response(
    ...
    out: aws_sdk_location.types.batch_put_geofence_response.BatchPutGeofenceResponse = (
        aws_sdk_location.types.batch_put_geofence_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.batch_put_geofence_request.BatchPutGeofenceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.batch_put_geofence_request.serialize_json(input_)
    ).encode()
