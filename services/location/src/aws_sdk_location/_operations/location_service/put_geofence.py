"""Generated from Smithy shape ``com.amazonaws.location#PutGeofence``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.put_geofence_response.PutGeofenceResponse = (
        aws_sdk_location.types.put_geofence_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.put_geofence_request.PutGeofenceRequest,
) -> zapros.Request:
    ...
    url = url.replace("{CollectionName}", quote(str(input["collection_name"]), safe=""))
    url = url.replace("{GeofenceId}", quote(str(input["geofence_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_location.types.put_geofence_request

    body: bytes | None = json.dumps(
        aws_sdk_location.types.put_geofence_request.serialize_json(input)
    ).encode()
...
def put_geofence(
    ...
    aws_sdk_location.types.put_geofence_response.PutGeofenceResponse, zapros.Response
]:
