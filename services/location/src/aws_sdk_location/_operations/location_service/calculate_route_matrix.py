"""Generated from Smithy shape ``com.amazonaws.location#CalculateRouteMatrix``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.calculate_route_matrix_response.CalculateRouteMatrixResponse = aws_sdk_location.types.calculate_route_matrix_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.calculate_route_matrix_request.CalculateRouteMatrixRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.calculate_route_matrix_request.serialize_json(input)
    ).encode()
