"""Generated from Smithy shape ``com.amazonaws.location#DisassociateTrackerConsumer``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.disassociate_tracker_consumer_response.DisassociateTrackerConsumerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_location.types.disassociate_tracker_consumer_request.DisassociateTrackerConsumerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{ConsumerArn}", quote(str(input_["consumer_arn"]), safe=""))
    params: dict[str, str] = {}
...
async def async_disassociate_tracker_consumer(
