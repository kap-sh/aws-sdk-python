...
def build_request(
    ...
    input: aws_sdk_location.types.disassociate_tracker_consumer_request.DisassociateTrackerConsumerRequest,
) -> zapros.Request:
    ...
    url = url.replace("{ConsumerArn}", quote(str(input["consumer_arn"]), safe=""))
    params: dict[str, str] = {}
