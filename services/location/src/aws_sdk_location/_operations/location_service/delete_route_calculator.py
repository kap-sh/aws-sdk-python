"""Generated from Smithy shape ``com.amazonaws.location#DeleteRouteCalculator``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.delete_route_calculator_response.DeleteRouteCalculatorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_location.types.delete_route_calculator_request.DeleteRouteCalculatorRequest,
) -> zapros.Request:
...
async def async_delete_route_calculator(
