"""Generated from Smithy shape ``com.amazonaws.location#VerifyDevicePosition``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.verify_device_position_response.VerifyDevicePositionResponse = aws_sdk_location.types.verify_device_position_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.verify_device_position_request.VerifyDevicePositionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.verify_device_position_request.serialize_json(input_)
    ).encode()
...
async def async_verify_device_position(
