...
def build_request(
    ...
    input: aws_sdk_location.types.verify_device_position_request.VerifyDevicePositionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.verify_device_position_request.serialize_json(input)
    ).encode()
