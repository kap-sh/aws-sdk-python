...
def handle_response(
    ...
    out: aws_sdk_location.types.describe_map_response.DescribeMapResponse = (
        aws_sdk_location.types.describe_map_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.describe_map_request.DescribeMapRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_map(
    ...
    aws_sdk_location.types.describe_map_response.DescribeMapResponse, zapros.Response
]:
