...
def handle_response(
    ...
    out: aws_sdk_location.types.create_place_index_response.CreatePlaceIndexResponse = (
        aws_sdk_location.types.create_place_index_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.create_place_index_request.CreatePlaceIndexRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.create_place_index_request.serialize_json(input)
    ).encode()
