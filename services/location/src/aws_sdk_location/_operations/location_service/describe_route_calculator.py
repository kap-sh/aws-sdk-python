"""Generated from Smithy shape ``com.amazonaws.location#DescribeRouteCalculator``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.describe_route_calculator_response.DescribeRouteCalculatorResponse = aws_sdk_location.types.describe_route_calculator_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.describe_route_calculator_request.DescribeRouteCalculatorRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/routes/v0/calculators/{CalculatorName}"
    url = url.replace("{CalculatorName}", quote(str(input["calculator_name"]), safe=""))
    params: dict[str, str] = {}
...
async def async_describe_route_calculator(
