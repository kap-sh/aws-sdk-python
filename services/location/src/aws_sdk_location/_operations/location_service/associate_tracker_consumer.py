...
def handle_response(
    ...
    out: aws_sdk_location.types.associate_tracker_consumer_response.AssociateTrackerConsumerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_location.types.associate_tracker_consumer_request.AssociateTrackerConsumerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.associate_tracker_consumer_request.serialize_json(input_)
    ).encode()
