...
def build_request(
    ...
    input: aws_sdk_location.types.associate_tracker_consumer_request.AssociateTrackerConsumerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.associate_tracker_consumer_request.serialize_json(input)
    ).encode()
