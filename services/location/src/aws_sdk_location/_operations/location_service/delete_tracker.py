"""Generated from Smithy shape ``com.amazonaws.location#DeleteTracker``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.delete_tracker_response.DeleteTrackerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_location.types.delete_tracker_request.DeleteTrackerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_tracker(
