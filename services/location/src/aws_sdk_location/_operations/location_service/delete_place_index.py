...
def handle_response(
    ...
    out: aws_sdk_location.types.delete_place_index_response.DeletePlaceIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_location.types.delete_place_index_request.DeletePlaceIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
