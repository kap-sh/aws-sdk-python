"""Generated from Smithy shape ``com.amazonaws.location#SearchPlaceIndexForText``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.search_place_index_for_text_response.SearchPlaceIndexForTextResponse = aws_sdk_location.types.search_place_index_for_text_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.search_place_index_for_text_request.SearchPlaceIndexForTextRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/places/v0/indexes/{IndexName}/search/text"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.search_place_index_for_text_request.serialize_json(input)
    ).encode()
...
async def async_search_place_index_for_text(
