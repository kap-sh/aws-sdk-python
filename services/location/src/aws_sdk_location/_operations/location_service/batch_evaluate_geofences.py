...
def build_request(
    ...
    input: aws_sdk_location.types.batch_evaluate_geofences_request.BatchEvaluateGeofencesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.batch_evaluate_geofences_request.serialize_json(input)
    ).encode()
