...
def handle_response(
    ...
    out: aws_sdk_location.types.batch_evaluate_geofences_response.BatchEvaluateGeofencesResponse = aws_sdk_location.types.batch_evaluate_geofences_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.batch_evaluate_geofences_request.BatchEvaluateGeofencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.batch_evaluate_geofences_request.serialize_json(input_)
    ).encode()
