...
def handle_response(
    ...
    out: aws_sdk_location.types.get_geofence_response.GetGeofenceResponse = (
        aws_sdk_location.types.get_geofence_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.get_geofence_request.GetGeofenceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_geofence(
    ...
    aws_sdk_location.types.get_geofence_response.GetGeofenceResponse, zapros.Response
]:
