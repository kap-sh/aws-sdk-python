"""Generated from Smithy shape ``com.amazonaws.location#UpdateMap``."""
...
if TYPE_CHECKING:
    import aws_sdk_location.types.update_map_request
    import aws_sdk_location.types.update_map_response
...
) -> aws_sdk_location.types.update_map_response.UpdateMapResponse:
    import aws_sdk_location.types.update_map_response

    out: aws_sdk_location.types.update_map_response.UpdateMapResponse = (
        aws_sdk_location.types.update_map_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.update_map_request.UpdateMapRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/maps/v0/maps/{MapName}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.update_map_request.serialize_json(input_)
    ).encode()
...
def update_map(
    ...
    aws_sdk_location.types.update_map_response.UpdateMapResponse, zapros.Response
]:
