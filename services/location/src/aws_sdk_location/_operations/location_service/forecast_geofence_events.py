...
def handle_response(
    ...
    out: aws_sdk_location.types.forecast_geofence_events_response.ForecastGeofenceEventsResponse = aws_sdk_location.types.forecast_geofence_events_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.forecast_geofence_events_request.ForecastGeofenceEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.forecast_geofence_events_request.serialize_json(input_)
    ).encode()
