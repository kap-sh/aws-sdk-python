...
def build_request(
    ...
    input: aws_sdk_location.types.forecast_geofence_events_request.ForecastGeofenceEventsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.forecast_geofence_events_request.serialize_json(input)
    ).encode()
