...
def handle_response(
    ...
    out: aws_sdk_location.types.list_keys_response.ListKeysResponse = (
        aws_sdk_location.types.list_keys_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.list_keys_request.ListKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_keys_request.serialize_json(input_)
    ).encode()
...
def list_keys(
    ...
    input_: aws_sdk_location.types.list_keys_request.ListKeysRequest,
) -> tuple[aws_sdk_location.types.list_keys_response.ListKeysResponse, zapros.Response]:
