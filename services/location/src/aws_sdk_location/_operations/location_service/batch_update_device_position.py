...
def handle_response(
    ...
    out: aws_sdk_location.types.batch_update_device_position_response.BatchUpdateDevicePositionResponse = aws_sdk_location.types.batch_update_device_position_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.batch_update_device_position_request.BatchUpdateDevicePositionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.batch_update_device_position_request.serialize_json(
            input_
        )
    ).encode()
