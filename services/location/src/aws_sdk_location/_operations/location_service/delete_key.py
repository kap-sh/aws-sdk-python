"""Generated from Smithy shape ``com.amazonaws.location#DeleteKey``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.delete_key_response.DeleteKeyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_location.types.delete_key_request.DeleteKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "force_delete" in input_:
        params["forceDelete"] = str(input_["force_delete"])
...
def delete_key(
    ...
    aws_sdk_location.types.delete_key_response.DeleteKeyResponse, zapros.Response
]:
