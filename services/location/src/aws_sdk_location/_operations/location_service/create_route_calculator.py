...
def build_request(
    ...
    input: aws_sdk_location.types.create_route_calculator_request.CreateRouteCalculatorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.create_route_calculator_request.serialize_json(input)
    ).encode()
