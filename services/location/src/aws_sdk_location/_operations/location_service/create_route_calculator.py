...
def handle_response(
    ...
    out: aws_sdk_location.types.create_route_calculator_response.CreateRouteCalculatorResponse = aws_sdk_location.types.create_route_calculator_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.create_route_calculator_request.CreateRouteCalculatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.create_route_calculator_request.serialize_json(input_)
    ).encode()
