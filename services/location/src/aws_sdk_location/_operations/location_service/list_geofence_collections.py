...
def build_request(
    ...
    input: aws_sdk_location.types.list_geofence_collections_request.ListGeofenceCollectionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_geofence_collections_request.serialize_json(input)
    ).encode()
