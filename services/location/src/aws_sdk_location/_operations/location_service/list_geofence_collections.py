"""Generated from Smithy shape ``com.amazonaws.location#ListGeofenceCollections``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.list_geofence_collections_response.ListGeofenceCollectionsResponse = aws_sdk_location.types.list_geofence_collections_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.list_geofence_collections_request.ListGeofenceCollectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/geofencing/v0/list-collections"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_location.types.list_geofence_collections_request

    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_geofence_collections_request.serialize_json(input_)
    ).encode()
...
async def async_list_geofence_collections(
