...
def build_request(
    ...
    input: aws_sdk_location.types.list_device_positions_request.ListDevicePositionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_device_positions_request.serialize_json(input)
    ).encode()
