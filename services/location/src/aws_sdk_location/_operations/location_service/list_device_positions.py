...
def handle_response(
    ...
    out: aws_sdk_location.types.list_device_positions_response.ListDevicePositionsResponse = aws_sdk_location.types.list_device_positions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.list_device_positions_request.ListDevicePositionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_device_positions_request.serialize_json(input_)
    ).encode()
