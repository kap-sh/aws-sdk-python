"""Generated from Smithy shape ``com.amazonaws.location#GetMapStyleDescriptor``."""
...
if TYPE_CHECKING:
    import aws_sdk_location.types.get_map_style_descriptor_request
    import aws_sdk_location.types.get_map_style_descriptor_response
...
) -> aws_sdk_location.types.get_map_style_descriptor_response.GetMapStyleDescriptorResponse:
    out: aws_sdk_location.types.get_map_style_descriptor_response.GetMapStyleDescriptorResponse = {
        "blob": response.read()
...
def build_request(
    ...
    input_: aws_sdk_location.types.get_map_style_descriptor_request.GetMapStyleDescriptorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/maps/v0/maps/{MapName}/style-descriptor"
...
async def async_get_map_style_descriptor(
