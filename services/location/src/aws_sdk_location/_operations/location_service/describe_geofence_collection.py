...
def handle_response(
    ...
    out: aws_sdk_location.types.describe_geofence_collection_response.DescribeGeofenceCollectionResponse = aws_sdk_location.types.describe_geofence_collection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.describe_geofence_collection_request.DescribeGeofenceCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
