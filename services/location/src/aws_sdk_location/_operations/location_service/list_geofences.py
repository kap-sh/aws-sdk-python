"""Generated from Smithy shape ``com.amazonaws.location#ListGeofences``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.list_geofences_response.ListGeofencesResponse = (
        aws_sdk_location.types.list_geofences_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.list_geofences_request.ListGeofencesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_geofences_request.serialize_json(input)
    ).encode()
...
async def async_list_geofences(
