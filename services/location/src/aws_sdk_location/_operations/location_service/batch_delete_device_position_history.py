...
def handle_response(
    ...
    out: aws_sdk_location.types.batch_delete_device_position_history_response.BatchDeleteDevicePositionHistoryResponse = aws_sdk_location.types.batch_delete_device_position_history_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.batch_delete_device_position_history_request.BatchDeleteDevicePositionHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.batch_delete_device_position_history_request.serialize_json(
            input_
        )
    ).encode()
