...
def handle_response(
    ...
    out: aws_sdk_location.types.list_maps_response.ListMapsResponse = (
        aws_sdk_location.types.list_maps_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.list_maps_request.ListMapsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.list_maps_request.serialize_json(input)
    ).encode()
...
def list_maps(
    ...
    input: aws_sdk_location.types.list_maps_request.ListMapsRequest,
) -> tuple[aws_sdk_location.types.list_maps_response.ListMapsResponse, zapros.Response]:
