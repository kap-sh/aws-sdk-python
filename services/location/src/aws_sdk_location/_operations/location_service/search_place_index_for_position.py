...
def handle_response(
    ...
    out: aws_sdk_location.types.search_place_index_for_position_response.SearchPlaceIndexForPositionResponse = aws_sdk_location.types.search_place_index_for_position_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.search_place_index_for_position_request.SearchPlaceIndexForPositionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.search_place_index_for_position_request.serialize_json(
            input_
        )
    ).encode()
