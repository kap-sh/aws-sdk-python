...
def handle_response(
    ...
    out: aws_sdk_location.types.update_place_index_response.UpdatePlaceIndexResponse = (
        aws_sdk_location.types.update_place_index_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_location.types.update_place_index_request.UpdatePlaceIndexRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.update_place_index_request.serialize_json(input)
    ).encode()
