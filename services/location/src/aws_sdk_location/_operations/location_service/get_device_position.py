...
def handle_response(
    ...
    out: aws_sdk_location.types.get_device_position_response.GetDevicePositionResponse = aws_sdk_location.types.get_device_position_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.get_device_position_request.GetDevicePositionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
