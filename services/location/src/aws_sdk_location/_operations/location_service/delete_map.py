"""Generated from Smithy shape ``com.amazonaws.location#DeleteMap``."""
...
if TYPE_CHECKING:
    import aws_sdk_location.types.delete_map_request
    import aws_sdk_location.types.delete_map_response
...
) -> aws_sdk_location.types.delete_map_response.DeleteMapResponse:
    out: aws_sdk_location.types.delete_map_response.DeleteMapResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_location.types.delete_map_request.DeleteMapRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_map(
    ...
    aws_sdk_location.types.delete_map_response.DeleteMapResponse, zapros.Response
]:
