...
def build_request(
    ...
    input: aws_sdk_location.types.update_route_calculator_request.UpdateRouteCalculatorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.update_route_calculator_request.serialize_json(input)
    ).encode()
