...
def handle_response(
    ...
    out: aws_sdk_location.types.update_route_calculator_response.UpdateRouteCalculatorResponse = aws_sdk_location.types.update_route_calculator_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.update_route_calculator_request.UpdateRouteCalculatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.update_route_calculator_request.serialize_json(input_)
    ).encode()
