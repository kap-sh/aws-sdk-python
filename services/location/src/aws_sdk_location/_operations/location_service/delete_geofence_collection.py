"""Generated from Smithy shape ``com.amazonaws.location#DeleteGeofenceCollection``."""
...
def handle_response(
    ...
    out: aws_sdk_location.types.delete_geofence_collection_response.DeleteGeofenceCollectionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_location.types.delete_geofence_collection_request.DeleteGeofenceCollectionRequest,
) -> zapros.Request:
...
async def async_delete_geofence_collection(
