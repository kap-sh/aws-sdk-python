...
def handle_response(
    ...
    out: aws_sdk_location.types.batch_delete_geofence_response.BatchDeleteGeofenceResponse = aws_sdk_location.types.batch_delete_geofence_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_location.types.batch_delete_geofence_request.BatchDeleteGeofenceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.batch_delete_geofence_request.serialize_json(input_)
    ).encode()
