...
def build_request(
    ...
    input: aws_sdk_location.types.batch_delete_geofence_request.BatchDeleteGeofenceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_location.types.batch_delete_geofence_request.serialize_json(input)
    ).encode()
