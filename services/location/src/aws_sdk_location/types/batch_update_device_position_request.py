...
def serialize_json(value: BatchUpdateDevicePositionRequest) -> dict:
    out: dict = {}
    import aws_sdk_location.types.device_position_update_list
    out["Updates"] = aws_sdk_location.types.device_position_update_list.serialize_json(value["updates"])
    return out
...
def deserialize_json(data: dict) -> BatchUpdateDevicePositionRequest:
    ...
    if "Updates" in data:
        import aws_sdk_location.types.device_position_update_list
        out["updates"] = aws_sdk_location.types.device_position_update_list.deserialize_json(data["Updates"])
    else:
