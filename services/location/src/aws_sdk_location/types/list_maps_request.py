"""Generated from Smithy shape ``com.amazonaws.location#ListMapsRequest``."""
...
class ListMapsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListMapsRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListMapsRequest:
    out: ListMapsRequest = {}  # type: ignore[typeddict-item]
