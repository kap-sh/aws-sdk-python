...
# --- restJson1 ser/de ---
def serialize_json(value: ListRouteCalculatorsRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListRouteCalculatorsRequest:
    out: ListRouteCalculatorsRequest = {}  # type: ignore[typeddict-item]
