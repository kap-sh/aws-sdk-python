...
class GeofenceGeometry(TypedDict, closed=True):
    ...
    geobuf: NotRequired[
        "aws_sdk_location.types.base64_encoded_geobuf.Base64EncodedGeobuf"
    ]
    ...
    multi_polygon: NotRequired[
        "aws_sdk_location.types.multi_linear_rings.MultiLinearRings"
    ]
...
def serialize_json(value: GeofenceGeometry) -> dict:
    ...
    if "geobuf" in value:
        ...
        out["Geobuf"] = aws_sdk_location.types.base64_encoded_geobuf.serialize_json(
            value["geobuf"]
        )
    if "multi_polygon" in value:
        import aws_sdk_location.types.multi_linear_rings

        out["MultiPolygon"] = aws_sdk_location.types.multi_linear_rings.serialize_json(
            value["multi_polygon"]
        )
    return out
...
def deserialize_json(data: dict) -> GeofenceGeometry:
    ...
    if "Geobuf" in data:
        ...
        out["geobuf"] = aws_sdk_location.types.base64_encoded_geobuf.deserialize_json(
            data["Geobuf"]
        )
    if "MultiPolygon" in data:
        ...
        out["multi_polygon"] = (
            aws_sdk_location.types.multi_linear_rings.deserialize_json(
                data["MultiPolygon"]
            )
        )
    return out
