...
if TYPE_CHECKING:
    import aws_sdk_location.types.validate_address_additional_feature_list


class ValidateAddressActionOptions(TypedDict):
    additional_features: NotRequired[
        "aws_sdk_location.types.validate_address_additional_feature_list.ValidateAddressAdditionalFeatureList"
    ]
...
def serialize_json(value: ValidateAddressActionOptions) -> dict:
    ...
    if "additional_features" in value:
        ...
        out["AdditionalFeatures"] = (
            aws_sdk_location.types.validate_address_additional_feature_list.serialize_json(
...
def deserialize_json(data: dict) -> ValidateAddressActionOptions:
    ...
    if "AdditionalFeatures" in data:
        ...
        out["additional_features"] = (
            aws_sdk_location.types.validate_address_additional_feature_list.deserialize_json(
