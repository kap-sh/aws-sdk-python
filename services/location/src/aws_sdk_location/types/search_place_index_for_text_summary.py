...
class SearchPlaceIndexForTextSummary(TypedDict):
    ...
    result_b_box: NotRequired["aws_sdk_location.types.bounding_box.BoundingBox"]
...
def serialize_json(value: SearchPlaceIndexForTextSummary) -> dict:
    ...
    if "result_b_box" in value:
        ...
        out["ResultBBox"] = aws_sdk_location.types.bounding_box.serialize_json(
            value["result_b_box"]
        )
...
def deserialize_json(data: dict) -> SearchPlaceIndexForTextSummary:
    ...
    if "ResultBBox" in data:
        ...
        out["result_b_box"] = aws_sdk_location.types.bounding_box.deserialize_json(
            data["ResultBBox"]
        )
