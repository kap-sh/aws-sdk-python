...
class CalculateRouteRequest(TypedDict):
    ...
    waypoint_positions: NotRequired["aws_sdk_location.types.waypoint_position_list.WaypointPositionList"]
    ...
    include_leg_geometry: NotRequired["aws_sdk_location.types.sensitive_boolean.SensitiveBoolean"]
    ...
    optimize_for: NotRequired["aws_sdk_location.types.optimization_mode.OptimizationMode"]
...
def serialize_json(value: CalculateRouteRequest) -> dict:
    out: dict = {}
    import aws_sdk_location.types.position
    out["DeparturePosition"] = aws_sdk_location.types.position.serialize_json(value["departure_position"])
    import aws_sdk_location.types.position
    out["DestinationPosition"] = aws_sdk_location.types.position.serialize_json(value["destination_position"])
    if "waypoint_positions" in value:
        import aws_sdk_location.types.waypoint_position_list
        out["WaypointPositions"] = aws_sdk_location.types.waypoint_position_list.serialize_json(value["waypoint_positions"])
    ...
    if "arrival_time" in value:
        import aws_sdk_location.types.timestamp
        out["ArrivalTime"] = aws_sdk_location.types.timestamp.serialize_json(value["arrival_time"])
...
def deserialize_json(data: dict) -> CalculateRouteRequest:
    ...
    if "DeparturePosition" in data:
        import aws_sdk_location.types.position
        out["departure_position"] = aws_sdk_location.types.position.deserialize_json(data["DeparturePosition"])
    else:
        raise DeserializationError("CalculateRouteRequest.departure_position required")
    if "DestinationPosition" in data:
        import aws_sdk_location.types.position
        out["destination_position"] = aws_sdk_location.types.position.deserialize_json(data["DestinationPosition"])
    else:
        raise DeserializationError("CalculateRouteRequest.destination_position required")
    if "WaypointPositions" in data:
        import aws_sdk_location.types.waypoint_position_list
        out["waypoint_positions"] = aws_sdk_location.types.waypoint_position_list.deserialize_json(data["WaypointPositions"])
    ...
    if "ArrivalTime" in data:
        import aws_sdk_location.types.timestamp
        out["arrival_time"] = aws_sdk_location.types.timestamp.deserialize_json(data["ArrivalTime"])
