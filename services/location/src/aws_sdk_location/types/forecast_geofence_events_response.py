...
class ForecastGeofenceEventsResponse(TypedDict):
    forecasted_events: (
        "aws_sdk_location.types.forecasted_events_list.ForecastedEventsList"
    )
...
def serialize_json(value: ForecastGeofenceEventsResponse) -> dict:
    ...
    out["ForecastedEvents"] = (
        aws_sdk_location.types.forecasted_events_list.serialize_json(
...
def deserialize_json(data: dict) -> ForecastGeofenceEventsResponse:
    ...
    if "ForecastedEvents" in data:
        ...
        out["forecasted_events"] = (
            aws_sdk_location.types.forecasted_events_list.deserialize_json(
