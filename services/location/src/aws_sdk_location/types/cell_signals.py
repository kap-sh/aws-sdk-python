...
def serialize_json(value: CellSignals) -> dict:
    out: dict = {}
    import aws_sdk_location.types.lte_cell_details_list
    out["LteCellDetails"] = aws_sdk_location.types.lte_cell_details_list.serialize_json(value["lte_cell_details"])
    return out
...
def deserialize_json(data: dict) -> CellSignals:
    ...
    if "LteCellDetails" in data:
        import aws_sdk_location.types.lte_cell_details_list
        out["lte_cell_details"] = aws_sdk_location.types.lte_cell_details_list.deserialize_json(data["LteCellDetails"])
    else:
