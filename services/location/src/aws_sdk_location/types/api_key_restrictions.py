...
class ApiKeyRestrictions(TypedDict):
    ...
    allow_referers: NotRequired["aws_sdk_location.types.referer_pattern_list.RefererPatternList"]
    ...
    allow_android_apps: NotRequired["aws_sdk_location.types.android_app_list.AndroidAppList"]
...
def serialize_json(value: ApiKeyRestrictions) -> dict:
    out: dict = {}
    import aws_sdk_location.types.api_key_action_list
    out["AllowActions"] = aws_sdk_location.types.api_key_action_list.serialize_json(value["allow_actions"])
    import aws_sdk_location.types.geo_arn_list
    out["AllowResources"] = aws_sdk_location.types.geo_arn_list.serialize_json(value["allow_resources"])
    if "allow_referers" in value:
        import aws_sdk_location.types.referer_pattern_list
        out["AllowReferers"] = aws_sdk_location.types.referer_pattern_list.serialize_json(value["allow_referers"])
    if "allow_android_apps" in value:
        import aws_sdk_location.types.android_app_list
        out["AllowAndroidApps"] = aws_sdk_location.types.android_app_list.serialize_json(value["allow_android_apps"])
    if "allow_apple_apps" in value:
        import aws_sdk_location.types.apple_app_list
        out["AllowAppleApps"] = aws_sdk_location.types.apple_app_list.serialize_json(value["allow_apple_apps"])
    return out
...
def deserialize_json(data: dict) -> ApiKeyRestrictions:
    ...
    if "AllowActions" in data:
        import aws_sdk_location.types.api_key_action_list
        out["allow_actions"] = aws_sdk_location.types.api_key_action_list.deserialize_json(data["AllowActions"])
    else:
        raise DeserializationError("ApiKeyRestrictions.allow_actions required")
    if "AllowResources" in data:
        import aws_sdk_location.types.geo_arn_list
        out["allow_resources"] = aws_sdk_location.types.geo_arn_list.deserialize_json(data["AllowResources"])
    else:
        raise DeserializationError("ApiKeyRestrictions.allow_resources required")
    if "AllowReferers" in data:
        import aws_sdk_location.types.referer_pattern_list
        out["allow_referers"] = aws_sdk_location.types.referer_pattern_list.deserialize_json(data["AllowReferers"])
    if "AllowAndroidApps" in data:
        import aws_sdk_location.types.android_app_list
        out["allow_android_apps"] = aws_sdk_location.types.android_app_list.deserialize_json(data["AllowAndroidApps"])
    if "AllowAppleApps" in data:
        import aws_sdk_location.types.apple_app_list
        out["allow_apple_apps"] = aws_sdk_location.types.apple_app_list.deserialize_json(data["AllowAppleApps"])
    return out