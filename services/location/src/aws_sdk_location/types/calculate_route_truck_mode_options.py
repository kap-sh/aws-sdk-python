...
class CalculateRouteTruckModeOptions(TypedDict):
...
def serialize_json(value: CalculateRouteTruckModeOptions) -> dict:
    ...
    if "dimensions" in value:
        import aws_sdk_location.types.truck_dimensions
        out["Dimensions"] = aws_sdk_location.types.truck_dimensions.serialize_json(value["dimensions"])
    if "weight" in value:
        import aws_sdk_location.types.truck_weight
        out["Weight"] = aws_sdk_location.types.truck_weight.serialize_json(value["weight"])
    return out
...
def deserialize_json(data: dict) -> CalculateRouteTruckModeOptions:
    ...
    if "Dimensions" in data:
        import aws_sdk_location.types.truck_dimensions
        out["dimensions"] = aws_sdk_location.types.truck_dimensions.deserialize_json(data["Dimensions"])
    if "Weight" in data:
        import aws_sdk_location.types.truck_weight
        out["weight"] = aws_sdk_location.types.truck_weight.deserialize_json(data["Weight"])
    return out