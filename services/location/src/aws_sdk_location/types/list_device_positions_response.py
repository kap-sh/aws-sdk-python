...
if TYPE_CHECKING:
    import aws_sdk_location.types.list_device_positions_response_entry_list
    import aws_sdk_location.types.token


class ListDevicePositionsResponse(TypedDict):
    entries: "aws_sdk_location.types.list_device_positions_response_entry_list.ListDevicePositionsResponseEntryList"
...
def serialize_json(value: ListDevicePositionsResponse) -> dict:
    ...
    out["Entries"] = (
        aws_sdk_location.types.list_device_positions_response_entry_list.serialize_json(
            value["entries"]
        )
    )
...
def deserialize_json(data: dict) -> ListDevicePositionsResponse:
    ...
    if "Entries" in data:
        ...
        out["entries"] = (
            aws_sdk_location.types.list_device_positions_response_entry_list.deserialize_json(
                data["Entries"]
            )
        )
    else:
