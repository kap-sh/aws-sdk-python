...
def serialize_json(value: BatchUpdateDevicePositionResponse) -> dict:
    out: dict = {}
    import aws_sdk_location.types.batch_update_device_position_error_list
    out["Errors"] = aws_sdk_location.types.batch_update_device_position_error_list.serialize_json(value["errors"])
    return out
...
def deserialize_json(data: dict) -> BatchUpdateDevicePositionResponse:
    ...
    if "Errors" in data:
        import aws_sdk_location.types.batch_update_device_position_error_list
        out["errors"] = aws_sdk_location.types.batch_update_device_position_error_list.deserialize_json(data["Errors"])
    else:
