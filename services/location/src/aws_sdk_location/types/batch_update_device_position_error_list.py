...
BatchUpdateDevicePositionErrorList: TypeAlias = list["aws_sdk_location.types.batch_update_device_position_error.BatchUpdateDevicePositionError"]
...
def serialize_json(value: BatchUpdateDevicePositionErrorList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_location.types.batch_update_device_position_error.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> BatchUpdateDevicePositionErrorList:
    ...
    for item in data:
        out.append(aws_sdk_location.types.batch_update_device_position_error.deserialize_json(item))
    return out