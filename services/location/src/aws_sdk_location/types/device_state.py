...
class DeviceState(TypedDict):
    ...
    wi_fi_access_points: NotRequired["aws_sdk_location.types.wi_fi_access_point_list.WiFiAccessPointList"]
...
def serialize_json(value: DeviceState) -> dict:
    ...
    if "wi_fi_access_points" in value:
        import aws_sdk_location.types.wi_fi_access_point_list
        out["WiFiAccessPoints"] = aws_sdk_location.types.wi_fi_access_point_list.serialize_json(value["wi_fi_access_points"])
    if "cell_signals" in value:
        import aws_sdk_location.types.cell_signals
        out["CellSignals"] = aws_sdk_location.types.cell_signals.serialize_json(value["cell_signals"])
    return out
...
def deserialize_json(data: dict) -> DeviceState:
    ...
    if "WiFiAccessPoints" in data:
        import aws_sdk_location.types.wi_fi_access_point_list
        out["wi_fi_access_points"] = aws_sdk_location.types.wi_fi_access_point_list.deserialize_json(data["WiFiAccessPoints"])
    if "CellSignals" in data:
        import aws_sdk_location.types.cell_signals
        out["cell_signals"] = aws_sdk_location.types.cell_signals.deserialize_json(data["CellSignals"])
    return out