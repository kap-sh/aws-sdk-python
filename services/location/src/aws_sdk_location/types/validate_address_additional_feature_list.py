...
if TYPE_CHECKING:
    import aws_sdk_location.types.validate_address_additional_feature

ValidateAddressAdditionalFeatureList: TypeAlias = list[
    "aws_sdk_location.types.validate_address_additional_feature.ValidateAddressAdditionalFeature"
]
