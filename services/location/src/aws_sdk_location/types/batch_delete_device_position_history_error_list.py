...
BatchDeleteDevicePositionHistoryErrorList: TypeAlias = list[
    "aws_sdk_location.types.batch_delete_device_position_history_error.BatchDeleteDevicePositionHistoryError"
]
...
def serialize_json(value: BatchDeleteDevicePositionHistoryErrorList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_location.types.batch_delete_device_position_history_error.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> BatchDeleteDevicePositionHistoryErrorList:
    ...
    for item in data:
        out.append(
            aws_sdk_location.types.batch_delete_device_position_history_error.deserialize_json(
                item
            )
        )
    return out
