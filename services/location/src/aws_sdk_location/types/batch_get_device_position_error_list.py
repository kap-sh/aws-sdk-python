...
BatchGetDevicePositionErrorList: TypeAlias = list[
    "aws_sdk_location.types.batch_get_device_position_error.BatchGetDevicePositionError"
]
...
def serialize_json(value: BatchGetDevicePositionErrorList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_location.types.batch_get_device_position_error.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> BatchGetDevicePositionErrorList:
    ...
    for item in data:
        out.append(
            aws_sdk_location.types.batch_get_device_position_error.deserialize_json(
                item
            )
        )
    return out
