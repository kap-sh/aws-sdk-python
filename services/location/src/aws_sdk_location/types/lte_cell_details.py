...
if TYPE_CHECKING:
    ...
    import aws_sdk_location.types.lte_local_id
    import aws_sdk_location.types.lte_network_measurements_list
    import aws_sdk_location.types.rsrp
    import aws_sdk_location.types.rsrq


class LteCellDetails(TypedDict):
    ...
    local_id: NotRequired["aws_sdk_location.types.lte_local_id.LteLocalId"]
    """<p>The LTE local identification information (local ID).</p>"""
    network_measurements: NotRequired[
        "aws_sdk_location.types.lte_network_measurements_list.LteNetworkMeasurementsList"
    ]
...
def serialize_json(value: LteCellDetails) -> dict:
    ...
    if "local_id" in value:
        ...
        out["LocalId"] = aws_sdk_location.types.lte_local_id.serialize_json(
            value["local_id"]
        )
    if "network_measurements" in value:
        ...
        out["NetworkMeasurements"] = (
            aws_sdk_location.types.lte_network_measurements_list.serialize_json(
...
def deserialize_json(data: dict) -> LteCellDetails:
    ...
    if "LocalId" in data:
        ...
        out["local_id"] = aws_sdk_location.types.lte_local_id.deserialize_json(
            data["LocalId"]
        )
    if "NetworkMeasurements" in data:
        ...
        out["network_measurements"] = (
            aws_sdk_location.types.lte_network_measurements_list.deserialize_json(
