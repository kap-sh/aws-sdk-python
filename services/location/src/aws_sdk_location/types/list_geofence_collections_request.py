"""Generated from Smithy shape ``com.amazonaws.location#ListGeofenceCollectionsRequest``."""
...
class ListGeofenceCollectionsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListGeofenceCollectionsRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListGeofenceCollectionsRequest:
    out: ListGeofenceCollectionsRequest = {}  # type: ignore[typeddict-item]
