...
if TYPE_CHECKING:
    ...
    import aws_sdk_location.types.create_map_request
    import aws_sdk_location.types.create_map_response
    import aws_sdk_location.types.delete_map_request
    import aws_sdk_location.types.delete_map_response
    import aws_sdk_location.types.describe_map_request
    import aws_sdk_location.types.describe_map_response
    import aws_sdk_location.types.get_map_glyphs_request
    import aws_sdk_location.types.get_map_glyphs_response
    ...
    import aws_sdk_location.types.get_map_tile_request
    import aws_sdk_location.types.get_map_tile_response
    import aws_sdk_location.types.list_maps_request
    import aws_sdk_location.types.list_maps_response
...
class MapResource:
    ...
    def put(
        ...
        *,
    ...
    ) -> "aws_sdk_location.types.create_map_response.CreateMapResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_location.types.create_map_request.CreateMapRequest]",
        ) -> OperationResponse[
            "aws_sdk_location.types.create_map_response.CreateMapResponse"
        ]:
            import aws_sdk_location._operations.location_service.create_map

            output, http_response = (
                aws_sdk_location._operations.location_service.create_map.create_map(
    ...
    def read(
        ...
        *,
        config_overrides: Optional[LocationClientConfig] = None,
    ) -> "aws_sdk_location.types.describe_map_response.DescribeMapResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_location.types.describe_map_request.DescribeMapRequest]",
        ) -> OperationResponse[
            "aws_sdk_location.types.describe_map_response.DescribeMapResponse"
        ]:
            import aws_sdk_location._operations.location_service.describe_map

            output, http_response = (
                aws_sdk_location._operations.location_service.describe_map.describe_map(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_location.types.update_map_request.UpdateMapRequest]",
        ) -> OperationResponse[
            "aws_sdk_location.types.update_map_response.UpdateMapResponse"
        ]:
            import aws_sdk_location._operations.location_service.update_map

            output, http_response = (
                aws_sdk_location._operations.location_service.update_map.update_map(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_location.types.delete_map_request.DeleteMapRequest]",
        ) -> OperationResponse[
            "aws_sdk_location.types.delete_map_response.DeleteMapResponse"
        ]:
            import aws_sdk_location._operations.location_service.delete_map

            output, http_response = (
                aws_sdk_location._operations.location_service.delete_map.delete_map(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_location.types.list_maps_response.ListMapsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_location.types.list_maps_request.ListMapsRequest]",
        ) -> OperationResponse[
            "aws_sdk_location.types.list_maps_response.ListMapsResponse"
        ]:
            import aws_sdk_location._operations.location_service.list_maps

            output, http_response = (
                aws_sdk_location._operations.location_service.list_maps.list_maps(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_map_glyphs(
        ...
        *,
    ...
    ) -> "aws_sdk_location.types.get_map_glyphs_response.GetMapGlyphsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_location.types.get_map_glyphs_request.GetMapGlyphsRequest]",
        ) -> OperationResponse[
            "aws_sdk_location.types.get_map_glyphs_response.GetMapGlyphsResponse"
        ]:
            import aws_sdk_location._operations.location_service.get_map_glyphs

            output, http_response = (
                aws_sdk_location._operations.location_service.get_map_glyphs.get_map_glyphs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_map_sprites(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_location.types.get_map_sprites_request.GetMapSpritesRequest]",
        ) -> OperationResponse[
            "aws_sdk_location.types.get_map_sprites_response.GetMapSpritesResponse"
        ]:
            import aws_sdk_location._operations.location_service.get_map_sprites

            output, http_response = (
                aws_sdk_location._operations.location_service.get_map_sprites.get_map_sprites(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_map_style_descriptor(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_location.types.get_map_style_descriptor_request.GetMapStyleDescriptorRequest]",
        ) -> OperationResponse[
            "aws_sdk_location.types.get_map_style_descriptor_response.GetMapStyleDescriptorResponse"
        ]:
            import aws_sdk_location._operations.location_service.get_map_style_descriptor

            output, http_response = (
                aws_sdk_location._operations.location_service.get_map_style_descriptor.get_map_style_descriptor(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_map_tile(
        ...
        *,
        config_overrides: Optional[LocationClientConfig] = None,
        key: Optional["aws_sdk_location.types.api_key.ApiKey"] = None,
    ) -> "aws_sdk_location.types.get_map_tile_response.GetMapTileResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_location.types.get_map_tile_request.GetMapTileRequest]",
        ) -> OperationResponse[
            "aws_sdk_location.types.get_map_tile_response.GetMapTileResponse"
        ]:
            import aws_sdk_location._operations.location_service.get_map_tile

            output, http_response = (
                aws_sdk_location._operations.location_service.get_map_tile.get_map_tile(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncMapResource:
    ...
    async def put(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_location.types.create_map_request.CreateMapRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_location.types.create_map_response.CreateMapResponse"
        ]:
            import aws_sdk_location._operations.location_service.create_map
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_location._operations.location_service.create_map.async_create_map(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_location.types.describe_map_request.DescribeMapRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_location.types.describe_map_response.DescribeMapResponse"
        ]:
            import aws_sdk_location._operations.location_service.describe_map
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_location._operations.location_service.describe_map.async_describe_map(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_location.types.update_map_request.UpdateMapRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_location.types.update_map_response.UpdateMapResponse"
        ]:
            import aws_sdk_location._operations.location_service.update_map
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_location._operations.location_service.update_map.async_update_map(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_location.types.delete_map_request.DeleteMapRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_location.types.delete_map_response.DeleteMapResponse"
        ]:
            import aws_sdk_location._operations.location_service.delete_map
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_location._operations.location_service.delete_map.async_delete_map(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_location.types.list_maps_request.ListMapsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_location.types.list_maps_response.ListMapsResponse"
        ]:
            import aws_sdk_location._operations.location_service.list_maps
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_location._operations.location_service.list_maps.async_list_maps(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_map_glyphs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_location.types.get_map_glyphs_request.GetMapGlyphsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_location.types.get_map_glyphs_response.GetMapGlyphsResponse"
        ]:
            import aws_sdk_location._operations.location_service.get_map_glyphs
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_location._operations.location_service.get_map_glyphs.async_get_map_glyphs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_map_sprites(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_location.types.get_map_sprites_request.GetMapSpritesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_location.types.get_map_sprites_response.GetMapSpritesResponse"
        ]:
            import aws_sdk_location._operations.location_service.get_map_sprites
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_location._operations.location_service.get_map_sprites.async_get_map_sprites(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_map_style_descriptor(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_location.types.get_map_style_descriptor_request.GetMapStyleDescriptorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_location.types.get_map_style_descriptor_response.GetMapStyleDescriptorResponse"
        ]:
            import aws_sdk_location._operations.location_service.get_map_style_descriptor
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_location._operations.location_service.get_map_style_descriptor.async_get_map_style_descriptor(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_map_tile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_location.types.get_map_tile_request.GetMapTileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_location.types.get_map_tile_response.GetMapTileResponse"
        ]:
            import aws_sdk_location._operations.location_service.get_map_tile
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_location._operations.location_service.get_map_tile.async_get_map_tile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
