"""Generated from Smithy shape ``com.amazonaws.location#AccessDeniedException``."""

from typing import TypedDict
from aws_sdk_location.errors import DeserializationError
from aws_sdk_location.errors import ServiceError
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.location#AccessDeniedException``."""
