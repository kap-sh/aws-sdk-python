...
def handle_response(
    ...
    out: capo_location.types.list_geofences_response.ListGeofencesResponse = (
        capo_location.types.list_geofences_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.list_geofences_request.serialize_json(input_)
    ).encode()
...
def list_geofences(
    ...
    capo_location.types.list_geofences_response.ListGeofencesResponse, zapros.Response
]:
