...
def handle_response(
    ...
    out: capo_location.types.create_key_response.CreateKeyResponse = (
        capo_location.types.create_key_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.create_key_request.serialize_json(input_)
    ).encode()
...
def create_key(
    ...
    input_: capo_location.types.create_key_request.CreateKeyRequest,
) -> tuple[capo_location.types.create_key_response.CreateKeyResponse, zapros.Response]:
