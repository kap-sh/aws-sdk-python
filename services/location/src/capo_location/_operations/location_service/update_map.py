...
def handle_response(
    ...
    out: capo_location.types.update_map_response.UpdateMapResponse = (
        capo_location.types.update_map_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.update_map_request.serialize_json(input_)
    ).encode()
...
def update_map(
    ...
    input_: capo_location.types.update_map_request.UpdateMapRequest,
) -> tuple[capo_location.types.update_map_response.UpdateMapResponse, zapros.Response]:
