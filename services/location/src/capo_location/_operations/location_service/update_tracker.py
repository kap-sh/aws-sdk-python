...
def handle_response(
    ...
    out: capo_location.types.update_tracker_response.UpdateTrackerResponse = (
        capo_location.types.update_tracker_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.update_tracker_request.serialize_json(input_)
    ).encode()
...
def update_tracker(
    ...
    capo_location.types.update_tracker_response.UpdateTrackerResponse, zapros.Response
]:
