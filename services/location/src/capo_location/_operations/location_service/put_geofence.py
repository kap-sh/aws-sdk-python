...
def handle_response(
    ...
    out: capo_location.types.put_geofence_response.PutGeofenceResponse = (
        capo_location.types.put_geofence_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.put_geofence_request.serialize_json(input_)
    ).encode()
...
def put_geofence(
    ...
    capo_location.types.put_geofence_response.PutGeofenceResponse, zapros.Response
]:
