"""Generated from Smithy shape ``com.amazonaws.location#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_location.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_location.types.list_tags_for_resource_response.deserialize_json(
