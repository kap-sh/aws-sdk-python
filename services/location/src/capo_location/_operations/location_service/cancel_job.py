...
def handle_response(
    ...
    out: capo_location.types.cancel_job_response.CancelJobResponse = (
        capo_location.types.cancel_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.cancel_job_request.serialize_json(input_)
    ).encode()
...
def cancel_job(
    ...
    input_: capo_location.types.cancel_job_request.CancelJobRequest,
) -> tuple[capo_location.types.cancel_job_response.CancelJobResponse, zapros.Response]:
