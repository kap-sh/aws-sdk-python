"""Generated from Smithy shape ``com.amazonaws.location#BatchPutGeofence``."""
...
def handle_response(
    ...
    out: capo_location.types.batch_put_geofence_response.BatchPutGeofenceResponse = (
        capo_location.types.batch_put_geofence_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.batch_put_geofence_request.serialize_json(input_)
    ).encode()
...
async def async_batch_put_geofence(
