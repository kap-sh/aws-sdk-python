...
def handle_response(
    ...
    out: capo_location.types.get_map_sprites_response.GetMapSpritesResponse = {
        "blob": response.read()
...
def get_map_sprites(
    ...
    capo_location.types.get_map_sprites_response.GetMapSpritesResponse, zapros.Response
]:
