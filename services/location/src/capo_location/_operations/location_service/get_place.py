"""Generated from Smithy shape ``com.amazonaws.location#GetPlace``."""
...
def handle_response(
    ...
    out: capo_location.types.get_place_response.GetPlaceResponse = (
        capo_location.types.get_place_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/places/v0/indexes/{IndexName}/places/{PlaceId}"
...
def get_place(
    ...
    input_: capo_location.types.get_place_request.GetPlaceRequest,
) -> tuple[capo_location.types.get_place_response.GetPlaceResponse, zapros.Response]:
