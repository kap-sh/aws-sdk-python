"""Generated from Smithy shape ``com.amazonaws.location#ListMaps``."""
...
def handle_response(
    ...
    out: capo_location.types.list_maps_response.ListMapsResponse = (
        capo_location.types.list_maps_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.list_maps_request.serialize_json(input_)
    ).encode()
...
def list_maps(
    ...
    input_: capo_location.types.list_maps_request.ListMapsRequest,
) -> tuple[capo_location.types.list_maps_response.ListMapsResponse, zapros.Response]:
