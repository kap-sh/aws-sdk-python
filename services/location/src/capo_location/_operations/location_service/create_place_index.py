"""Generated from Smithy shape ``com.amazonaws.location#CreatePlaceIndex``."""
...
def handle_response(
    ...
    out: capo_location.types.create_place_index_response.CreatePlaceIndexResponse = (
        capo_location.types.create_place_index_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.create_place_index_request.serialize_json(input_)
    ).encode()
...
async def async_create_place_index(
