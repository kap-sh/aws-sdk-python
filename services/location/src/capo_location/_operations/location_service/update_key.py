...
def handle_response(
    ...
    out: capo_location.types.update_key_response.UpdateKeyResponse = (
        capo_location.types.update_key_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.update_key_request.serialize_json(input_)
    ).encode()
...
def update_key(
    ...
    input_: capo_location.types.update_key_request.UpdateKeyRequest,
) -> tuple[capo_location.types.update_key_response.UpdateKeyResponse, zapros.Response]:
