"""Generated from Smithy shape ``com.amazonaws.location#ForecastGeofenceEvents``."""
...
def handle_response(
    ...
    out: capo_location.types.forecast_geofence_events_response.ForecastGeofenceEventsResponse = capo_location.types.forecast_geofence_events_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.forecast_geofence_events_request.serialize_json(input_)
    ).encode()
...
async def async_forecast_geofence_events(
