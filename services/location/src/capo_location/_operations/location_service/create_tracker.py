...
def handle_response(
    ...
    out: capo_location.types.create_tracker_response.CreateTrackerResponse = (
        capo_location.types.create_tracker_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.create_tracker_request.serialize_json(input_)
    ).encode()
...
def create_tracker(
    ...
    capo_location.types.create_tracker_response.CreateTrackerResponse, zapros.Response
]:
