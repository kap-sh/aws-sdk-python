"""Generated from Smithy shape ``com.amazonaws.location#DescribeMap``."""
...
def handle_response(
    ...
    out: capo_location.types.describe_map_response.DescribeMapResponse = (
        capo_location.types.describe_map_response.deserialize_json(
...
def describe_map(
    ...
    capo_location.types.describe_map_response.DescribeMapResponse, zapros.Response
]:
