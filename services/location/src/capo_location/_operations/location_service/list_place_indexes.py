...
def handle_response(
    ...
    out: capo_location.types.list_place_indexes_response.ListPlaceIndexesResponse = (
        capo_location.types.list_place_indexes_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.list_place_indexes_request.serialize_json(input_)
    ).encode()
