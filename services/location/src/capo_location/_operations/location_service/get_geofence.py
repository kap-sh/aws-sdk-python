"""Generated from Smithy shape ``com.amazonaws.location#GetGeofence``."""
...
def handle_response(
    ...
    out: capo_location.types.get_geofence_response.GetGeofenceResponse = (
        capo_location.types.get_geofence_response.deserialize_json(
...
def get_geofence(
    ...
    capo_location.types.get_geofence_response.GetGeofenceResponse, zapros.Response
]:
