...
if TYPE_CHECKING:
    ...
    import capo_location.types.map_style


class MapConfiguration(TypedDict, closed=True):
    style: "capo_location.types.map_style.MapStyle"
    ...
    political_view: NotRequired["capo_location.types.country_code3.CountryCode3"]
