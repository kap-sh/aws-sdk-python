...
def serialize_json(value: MapConfigurationUpdate) -> dict:
    ...
    if "custom_layers" in value:
        ...
        out["CustomLayers"] = capo_location.types.custom_layer_list.serialize_json(
            value["custom_layers"]
        )
    return out
