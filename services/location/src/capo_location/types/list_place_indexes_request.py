"""Generated from Smithy shape ``com.amazonaws.location#ListPlaceIndexesRequest``."""
...
class ListPlaceIndexesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListPlaceIndexesRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListPlaceIndexesRequest:
    out: ListPlaceIndexesRequest = {}  # type: ignore[typeddict-item]
