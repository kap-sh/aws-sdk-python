...
class LocationError(Exception):
    """Base class for all Location service errors."""
...
class SerializationError(LocationError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LocationError):
...
class WaiterFailedError(LocationError):
...
class WaiterTimeoutError(LocationError):
