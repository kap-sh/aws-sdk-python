...
if TYPE_CHECKING:
    import aws_sdk_neptune_graph.types.edge_properties
...
class EdgeStructure(TypedDict, closed=True):
    ...
    edge_properties: NotRequired[
        "aws_sdk_neptune_graph.types.edge_properties.EdgeProperties"
    ]
...
def serialize_json(value: EdgeStructure) -> dict:
    ...
    if "edge_properties" in value:
        ...
        out["edgeProperties"] = (
            aws_sdk_neptune_graph.types.edge_properties.serialize_json(
...
def deserialize_json(data: dict) -> EdgeStructure:
    ...
    if "edgeProperties" in data:
        ...
        out["edge_properties"] = (
            aws_sdk_neptune_graph.types.edge_properties.deserialize_json(
                data["edgeProperties"]
            )
        )
    return out
