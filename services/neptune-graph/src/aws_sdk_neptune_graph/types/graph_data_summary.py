...
if TYPE_CHECKING:
    import aws_sdk_neptune_graph.types.edge_labels
    import aws_sdk_neptune_graph.types.edge_structures
    import aws_sdk_neptune_graph.types.long_valued_map_list
    import aws_sdk_neptune_graph.types.node_labels
    import aws_sdk_neptune_graph.types.node_structures


class GraphDataSummary(TypedDict):
    ...
    node_labels: NotRequired["aws_sdk_neptune_graph.types.node_labels.NodeLabels"]
    """<p>A list of distinct node labels in the graph.</p>"""
    edge_labels: NotRequired["aws_sdk_neptune_graph.types.edge_labels.EdgeLabels"]
    ...
    node_properties: NotRequired[
        "aws_sdk_neptune_graph.types.long_valued_map_list.LongValuedMapList"
    ]
    ...
    node_structures: NotRequired[
        "aws_sdk_neptune_graph.types.node_structures.NodeStructures"
    ]
    ...
    edge_structures: NotRequired[
        "aws_sdk_neptune_graph.types.edge_structures.EdgeStructures"
    ]
...
def serialize_json(value: GraphDataSummary) -> dict:
    ...
    if "node_labels" in value:
        ...
        out["nodeLabels"] = aws_sdk_neptune_graph.types.node_labels.serialize_json(
            value["node_labels"]
        )
    if "edge_labels" in value:
        import aws_sdk_neptune_graph.types.edge_labels

        out["edgeLabels"] = aws_sdk_neptune_graph.types.edge_labels.serialize_json(
            value["edge_labels"]
        )
    ...
    if "node_properties" in value:
        ...
        out["nodeProperties"] = (
            aws_sdk_neptune_graph.types.long_valued_map_list.serialize_json(
    ...
    if "node_structures" in value:
        ...
        out["nodeStructures"] = (
            aws_sdk_neptune_graph.types.node_structures.serialize_json(
    ...
    if "edge_structures" in value:
        ...
        out["edgeStructures"] = (
            aws_sdk_neptune_graph.types.edge_structures.serialize_json(
...
def deserialize_json(data: dict) -> GraphDataSummary:
    ...
    if "nodeLabels" in data:
        ...
        out["node_labels"] = aws_sdk_neptune_graph.types.node_labels.deserialize_json(
            data["nodeLabels"]
        )
    if "edgeLabels" in data:
        import aws_sdk_neptune_graph.types.edge_labels

        out["edge_labels"] = aws_sdk_neptune_graph.types.edge_labels.deserialize_json(
            data["edgeLabels"]
        )
    ...
    if "nodeProperties" in data:
        ...
        out["node_properties"] = (
            aws_sdk_neptune_graph.types.long_valued_map_list.deserialize_json(
                data["nodeProperties"]
            )
        )
    ...
    if "nodeStructures" in data:
        ...
        out["node_structures"] = (
            aws_sdk_neptune_graph.types.node_structures.deserialize_json(
                data["nodeStructures"]
            )
        )
    if "edgeStructures" in data:
        ...
        out["edge_structures"] = (
            aws_sdk_neptune_graph.types.edge_structures.deserialize_json(
                data["edgeStructures"]
            )
        )
    return out
