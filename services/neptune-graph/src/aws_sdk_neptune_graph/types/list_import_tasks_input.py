"""Generated from Smithy shape ``com.amazonaws.neptunegraph#ListImportTasksInput``."""
...
class ListImportTasksInput(TypedDict):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListImportTasksInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListImportTasksInput:
    out: ListImportTasksInput = {}  # type: ignore[typeddict-item]
    return out
