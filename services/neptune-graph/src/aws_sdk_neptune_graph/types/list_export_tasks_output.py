...
if TYPE_CHECKING:
    import aws_sdk_neptune_graph.types.export_task_summary_list
    import aws_sdk_neptune_graph.types.pagination_token


class ListExportTasksOutput(TypedDict):
    tasks: "aws_sdk_neptune_graph.types.export_task_summary_list.ExportTaskSummaryList"
...
def serialize_json(value: ListExportTasksOutput) -> dict:
    ...
    out["tasks"] = aws_sdk_neptune_graph.types.export_task_summary_list.serialize_json(
        value["tasks"]
    )
...
def deserialize_json(data: dict) -> ListExportTasksOutput:
    ...
    if "tasks" in data:
        ...
        out["tasks"] = (
            aws_sdk_neptune_graph.types.export_task_summary_list.deserialize_json(
                data["tasks"]
            )
        )
    else:
