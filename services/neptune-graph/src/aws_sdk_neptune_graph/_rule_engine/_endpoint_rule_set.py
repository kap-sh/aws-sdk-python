        ...
        if _locals["PartitionResult"] is not None:
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            if string_equals(
                                p.ApiType, interpolate("ControlPlane", p, _locals)
                            ):
                                return Endpoint(
                                    url=interpolate(
                            ...
                            if string_equals(
                                p.ApiType, interpolate("DataPlane", p, _locals)
                            ):
                                raise EndpointError(
                                    interpolate(
                            ...
                            raise EndpointError(
                                interpolate(
                                    "Invalid Configuration: Unknown ApiType", p, _locals
                                )
                            )
                    raise EndpointError(
                        interpolate(
            ...
            if p.UseFIPS is True:
                if True is get_attr(
                    ...
                    if string_equals(p.ApiType, interpolate("DataPlane", p, _locals)):
                        raise EndpointError(
                            interpolate(
                                "Invalid Configuration: fips endpoint is not supported for this API",
                                p,
            ...
            if p.UseDualStack is True:
                if True is get_attr(
                    ...
                    if string_equals(p.ApiType, interpolate("DataPlane", p, _locals)):
                        return Endpoint(
                            url=interpolate(
                                "https://neptune-graph.{Region}.on.aws", p, _locals
                            ),
                            properties={},
                            headers={},
                        )
            ...
            if string_equals(p.ApiType, interpolate("ControlPlane", p, _locals)):
                return Endpoint(
                    url=interpolate(
                        "https://neptune-graph.{Region}.{PartitionResult#dnsSuffix}",
                        p,
                        _locals,
                    ),
                    properties={},
            ...
            if string_equals(p.ApiType, interpolate("DataPlane", p, _locals)):
                return Endpoint(
                    url=interpolate(
                        "https://{Region}.neptune-graph.{PartitionResult#dnsSuffix}",
                        p,
                        _locals,
                    ),
                    properties={},
            ...
            raise EndpointError(
                interpolate("Invalid Configuration: Unknown ApiType", p, _locals)
            )
    _locals: dict[str, Any] = {}
    raise EndpointError(
