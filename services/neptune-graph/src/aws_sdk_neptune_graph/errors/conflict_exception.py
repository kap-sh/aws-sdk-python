...
class ConflictException_(TypedDict):
    ...
    reason: NotRequired["aws_sdk_neptune_graph.types.conflict_exception_reason.ConflictExceptionReason"]
...
def serialize_json(value: ConflictException_) -> dict:
    ...
    if "reason" in value:
        import aws_sdk_neptune_graph.types.conflict_exception_reason
        out["reason"] = aws_sdk_neptune_graph.types.conflict_exception_reason.serialize_json(value["reason"])
    return out
...
def deserialize_json(data: dict) -> ConflictException_:
    ...
    if "reason" in data:
        import aws_sdk_neptune_graph.types.conflict_exception_reason
        out["reason"] = aws_sdk_neptune_graph.types.conflict_exception_reason.deserialize_json(data["reason"])
    return out
