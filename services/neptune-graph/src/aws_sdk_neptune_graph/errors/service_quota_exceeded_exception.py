"""Generated from Smithy shape ``com.amazonaws.neptunegraph#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptunegraph#ServiceQuotaExceededException``."""
