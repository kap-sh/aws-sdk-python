...
class NeptuneGraphError(Exception):
    """Base class for all NeptuneGraph service errors."""

class ServiceError(NeptuneGraphError):
...
class SerializationError(NeptuneGraphError):
    """Raised when a value cannot be serialized."""

class DeserializationError(NeptuneGraphError):
...
class WaiterFailedError(NeptuneGraphError):
...
class WaiterTimeoutError(NeptuneGraphError):
