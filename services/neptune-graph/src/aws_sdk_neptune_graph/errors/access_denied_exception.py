"""Generated from Smithy shape ``com.amazonaws.neptunegraph#AccessDeniedException``."""

from typing import TypedDict
from aws_sdk_neptune_graph.errors import DeserializationError
from aws_sdk_neptune_graph.errors import ServiceError
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptunegraph#AccessDeniedException``."""
