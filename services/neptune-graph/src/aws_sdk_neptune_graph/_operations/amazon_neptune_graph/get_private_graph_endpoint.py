...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.get_private_graph_endpoint_output.GetPrivateGraphEndpointOutput = aws_sdk_neptune_graph.types.get_private_graph_endpoint_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.get_private_graph_endpoint_input.GetPrivateGraphEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
