...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            ...
            raise aws_sdk_neptune_graph.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.list_queries_output.ListQueriesOutput = (
        aws_sdk_neptune_graph.types.list_queries_output.deserialize_json(
