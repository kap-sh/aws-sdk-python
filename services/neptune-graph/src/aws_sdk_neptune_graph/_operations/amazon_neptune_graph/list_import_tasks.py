...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.list_import_tasks_output.ListImportTasksOutput = (
        aws_sdk_neptune_graph.types.list_import_tasks_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.list_import_tasks_input.ListImportTasksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_import_tasks(
