...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.reset_graph_output.ResetGraphOutput = (
        aws_sdk_neptune_graph.types.reset_graph_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.reset_graph_input.ResetGraphInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptune_graph.types.reset_graph_input.serialize_json(input_)
    ).encode()
...
def reset_graph(
    ...
    aws_sdk_neptune_graph.types.reset_graph_output.ResetGraphOutput, zapros.Response
]:
