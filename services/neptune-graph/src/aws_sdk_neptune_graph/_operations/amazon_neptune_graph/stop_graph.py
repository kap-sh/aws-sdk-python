...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.stop_graph_output.StopGraphOutput = (
        aws_sdk_neptune_graph.types.stop_graph_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.stop_graph_input.StopGraphInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def stop_graph(
    ...
    aws_sdk_neptune_graph.types.stop_graph_output.StopGraphOutput, zapros.Response
]:
