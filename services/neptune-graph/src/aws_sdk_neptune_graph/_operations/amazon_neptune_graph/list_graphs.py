...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.list_graphs_output.ListGraphsOutput = (
        aws_sdk_neptune_graph.types.list_graphs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.list_graphs_input.ListGraphsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_graphs(
    ...
    aws_sdk_neptune_graph.types.list_graphs_output.ListGraphsOutput, zapros.Response
]:
