...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.cancel_import_task_output.CancelImportTaskOutput = aws_sdk_neptune_graph.types.cancel_import_task_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.cancel_import_task_input.CancelImportTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
