...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.delete_graph_snapshot_output.DeleteGraphSnapshotOutput = aws_sdk_neptune_graph.types.delete_graph_snapshot_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.delete_graph_snapshot_input.DeleteGraphSnapshotInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
