...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.restore_graph_from_snapshot_output.RestoreGraphFromSnapshotOutput = aws_sdk_neptune_graph.types.restore_graph_from_snapshot_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.restore_graph_from_snapshot_input.RestoreGraphFromSnapshotInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
