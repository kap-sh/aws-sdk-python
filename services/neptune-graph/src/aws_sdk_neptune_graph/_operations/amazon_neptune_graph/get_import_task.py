...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.get_import_task_output.GetImportTaskOutput = (
        aws_sdk_neptune_graph.types.get_import_task_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_neptune_graph.types.get_import_task_input.GetImportTaskInput,
) -> zapros.Request:
...
async def async_get_import_task(
