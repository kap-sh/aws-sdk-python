...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.create_private_graph_endpoint_output.CreatePrivateGraphEndpointOutput = aws_sdk_neptune_graph.types.create_private_graph_endpoint_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.create_private_graph_endpoint_input.CreatePrivateGraphEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptune_graph.types.create_private_graph_endpoint_input.serialize_json(
            input_
        )
    ).encode()
