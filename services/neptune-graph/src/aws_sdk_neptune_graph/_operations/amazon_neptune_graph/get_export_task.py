...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.get_export_task_output.GetExportTaskOutput = (
        aws_sdk_neptune_graph.types.get_export_task_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_neptune_graph.types.get_export_task_input.GetExportTaskInput,
) -> zapros.Request:
...
async def async_get_export_task(
