...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.list_graph_snapshots_output.ListGraphSnapshotsOutput = aws_sdk_neptune_graph.types.list_graph_snapshots_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_neptune_graph.types.list_graph_snapshots_input.ListGraphSnapshotsInput,
) -> zapros.Request:
