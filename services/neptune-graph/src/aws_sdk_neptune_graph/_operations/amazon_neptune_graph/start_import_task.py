...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.start_import_task_output.StartImportTaskOutput = (
        aws_sdk_neptune_graph.types.start_import_task_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.start_import_task_input.StartImportTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptune_graph.types.start_import_task_input.serialize_json(input_)
    ).encode()
