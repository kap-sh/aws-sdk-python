...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.list_export_tasks_output.ListExportTasksOutput = (
        aws_sdk_neptune_graph.types.list_export_tasks_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.list_export_tasks_input.ListExportTasksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
