...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.get_graph_output.GetGraphOutput = (
        aws_sdk_neptune_graph.types.get_graph_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.get_graph_input.GetGraphInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_graph(
    ...
    aws_sdk_neptune_graph.types.get_graph_output.GetGraphOutput, zapros.Response
]:
