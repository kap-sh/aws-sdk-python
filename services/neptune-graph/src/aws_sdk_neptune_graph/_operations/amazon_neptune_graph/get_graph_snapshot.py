...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.get_graph_snapshot_output.GetGraphSnapshotOutput = aws_sdk_neptune_graph.types.get_graph_snapshot_output.deserialize_json(
