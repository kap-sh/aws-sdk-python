...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.update_graph_output.UpdateGraphOutput = (
        aws_sdk_neptune_graph.types.update_graph_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.update_graph_input.UpdateGraphInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptune_graph.types.update_graph_input.serialize_json(input_)
    ).encode()
...
def update_graph(
    ...
    aws_sdk_neptune_graph.types.update_graph_output.UpdateGraphOutput, zapros.Response
]:
