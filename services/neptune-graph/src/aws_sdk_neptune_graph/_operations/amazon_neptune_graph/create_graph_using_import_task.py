...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_neptune_graph.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.create_graph_using_import_task_output.CreateGraphUsingImportTaskOutput = aws_sdk_neptune_graph.types.create_graph_using_import_task_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.create_graph_using_import_task_input.CreateGraphUsingImportTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptune_graph.types.create_graph_using_import_task_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_graph_using_import_task(
