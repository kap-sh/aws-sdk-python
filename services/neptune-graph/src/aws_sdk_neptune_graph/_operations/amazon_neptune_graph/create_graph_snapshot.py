...
def build_request(
    ...
    input: aws_sdk_neptune_graph.types.create_graph_snapshot_input.CreateGraphSnapshotInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptune_graph.types.create_graph_snapshot_input.serialize_json(input)
    ).encode()
