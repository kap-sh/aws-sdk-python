...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.create_graph_snapshot_output.CreateGraphSnapshotOutput = aws_sdk_neptune_graph.types.create_graph_snapshot_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.create_graph_snapshot_input.CreateGraphSnapshotInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptune_graph.types.create_graph_snapshot_input.serialize_json(input_)
    ).encode()
