...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.delete_graph_output.DeleteGraphOutput = (
        aws_sdk_neptune_graph.types.delete_graph_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.delete_graph_input.DeleteGraphInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "skip_snapshot" in input_:
        params["skipSnapshot"] = str(input_["skip_snapshot"])
...
def delete_graph(
    ...
    aws_sdk_neptune_graph.types.delete_graph_output.DeleteGraphOutput, zapros.Response
]:
