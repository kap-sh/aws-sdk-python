...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.list_private_graph_endpoints_output.ListPrivateGraphEndpointsOutput = aws_sdk_neptune_graph.types.list_private_graph_endpoints_output.deserialize_json(
