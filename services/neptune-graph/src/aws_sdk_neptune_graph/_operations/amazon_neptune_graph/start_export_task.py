...
def build_request(
    ...
    input: aws_sdk_neptune_graph.types.start_export_task_input.StartExportTaskInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptune_graph.types.start_export_task_input.serialize_json(input)
    ).encode()
