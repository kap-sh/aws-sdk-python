...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.delete_private_graph_endpoint_output.DeletePrivateGraphEndpointOutput = aws_sdk_neptune_graph.types.delete_private_graph_endpoint_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.delete_private_graph_endpoint_input.DeletePrivateGraphEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
