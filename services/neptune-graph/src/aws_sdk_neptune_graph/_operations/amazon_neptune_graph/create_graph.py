...
def handle_response(
    ...
    out: aws_sdk_neptune_graph.types.create_graph_output.CreateGraphOutput = (
        aws_sdk_neptune_graph.types.create_graph_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptune_graph.types.create_graph_input.CreateGraphInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptune_graph.types.create_graph_input.serialize_json(input_)
    ).encode()
...
def create_graph(
    ...
    aws_sdk_neptune_graph.types.create_graph_output.CreateGraphOutput, zapros.Response
]:
