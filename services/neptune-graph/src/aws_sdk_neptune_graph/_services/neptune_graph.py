...
from aws_sdk_neptune_graph._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class NeptuneGraphClient:
    ...
    def cancel_query(self, graph_identifier: "aws_sdk_neptune_graph.types.graph_identifier.GraphIdentifier", query_id: str, *, config_overrides: Optional[NeptuneGraphClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_neptune_graph.types.cancel_query_input.CancelQueryInput]') -> OperationResponse[None]:
            import aws_sdk_neptune_graph._operations.amazon_neptune_graph.cancel_query
            output, http_response = aws_sdk_neptune_graph._operations.amazon_neptune_graph.cancel_query.cancel_query(req.options, req.input)
    ...
    @contextmanager
    def execute_query(self, graph_identifier: "aws_sdk_neptune_graph.types.graph_identifier.GraphIdentifier", query_string: str, language: "aws_sdk_neptune_graph.types.query_language.QueryLanguage", *, config_overrides: Optional[NeptuneGraphClientConfig] = None, parameters: Optional["aws_sdk_neptune_graph.types.document_valued_map.DocumentValuedMap"] = None, plan_cache: Optional["aws_sdk_neptune_graph.types.plan_cache_type.PlanCacheType"] = None, explain_mode: Optional["aws_sdk_neptune_graph.types.explain_mode.ExplainMode"] = None, query_timeout_milliseconds: Optional[int] = None) -> "Generator[aws_sdk_neptune_graph.types.execute_query_output.ExecuteQueryOutput]":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_neptune_graph.types.execute_query_input.ExecuteQueryInput]') -> OperationResponse["aws_sdk_neptune_graph.types.execute_query_output.ExecuteQueryOutput"]:
            import aws_sdk_neptune_graph._operations.amazon_neptune_graph.execute_query
            output, http_response = aws_sdk_neptune_graph._operations.amazon_neptune_graph.execute_query.execute_query(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def get_graph_summary(self, graph_identifier: "aws_sdk_neptune_graph.types.graph_identifier.GraphIdentifier", *, config_overrides: Optional[NeptuneGraphClientConfig] = None, mode: Optional["aws_sdk_neptune_graph.types.graph_summary_mode.GraphSummaryMode"] = None) -> "aws_sdk_neptune_graph.types.get_graph_summary_output.GetGraphSummaryOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_neptune_graph.types.get_graph_summary_input.GetGraphSummaryInput]') -> OperationResponse["aws_sdk_neptune_graph.types.get_graph_summary_output.GetGraphSummaryOutput"]:
            import aws_sdk_neptune_graph._operations.amazon_neptune_graph.get_graph_summary
            output, http_response = aws_sdk_neptune_graph._operations.amazon_neptune_graph.get_graph_summary.get_graph_summary(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_query(self, graph_identifier: "aws_sdk_neptune_graph.types.graph_identifier.GraphIdentifier", query_id: str, *, config_overrides: Optional[NeptuneGraphClientConfig] = None) -> "aws_sdk_neptune_graph.types.get_query_output.GetQueryOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_neptune_graph.types.get_query_input.GetQueryInput]') -> OperationResponse["aws_sdk_neptune_graph.types.get_query_output.GetQueryOutput"]:
            import aws_sdk_neptune_graph._operations.amazon_neptune_graph.get_query
            output, http_response = aws_sdk_neptune_graph._operations.amazon_neptune_graph.get_query.get_query(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list_queries(self, graph_identifier: "aws_sdk_neptune_graph.types.graph_identifier.GraphIdentifier", max_results: int, *, config_overrides: Optional[NeptuneGraphClientConfig] = None, state: Optional["aws_sdk_neptune_graph.types.query_state_input.QueryStateInput"] = None) -> "aws_sdk_neptune_graph.types.list_queries_output.ListQueriesOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_neptune_graph.types.list_queries_input.ListQueriesInput]') -> OperationResponse["aws_sdk_neptune_graph.types.list_queries_output.ListQueriesOutput"]:
            import aws_sdk_neptune_graph._operations.amazon_neptune_graph.list_queries
            output, http_response = aws_sdk_neptune_graph._operations.amazon_neptune_graph.list_queries.list_queries(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list_tags_for_resource(self, resource_arn: "aws_sdk_neptune_graph.types.arn.Arn", *, config_overrides: Optional[NeptuneGraphClientConfig] = None) -> "aws_sdk_neptune_graph.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        """<p>Lists tags associated with a specified resource.</p>

        Args:
            resource_arn: <p>The ARN of the resource.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_neptune_graph.types.list_tags_for_resource_input.ListTagsForResourceInput]') -> OperationResponse["aws_sdk_neptune_graph.types.list_tags_for_resource_output.ListTagsForResourceOutput"]:
            import aws_sdk_neptune_graph._operations.amazon_neptune_graph.list_tags_for_resource
            output, http_response = aws_sdk_neptune_graph._operations.amazon_neptune_graph.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def tag_resource(self, resource_arn: "aws_sdk_neptune_graph.types.arn.Arn", tags: "aws_sdk_neptune_graph.types.tag_map.TagMap", *, config_overrides: Optional[NeptuneGraphClientConfig] = None) -> "aws_sdk_neptune_graph.types.tag_resource_output.TagResourceOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_neptune_graph.types.tag_resource_input.TagResourceInput]') -> OperationResponse["aws_sdk_neptune_graph.types.tag_resource_output.TagResourceOutput"]:
            import aws_sdk_neptune_graph._operations.amazon_neptune_graph.tag_resource
            output, http_response = aws_sdk_neptune_graph._operations.amazon_neptune_graph.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: "aws_sdk_neptune_graph.types.arn.Arn", tag_keys: "aws_sdk_neptune_graph.types.tag_key_list.TagKeyList", *, config_overrides: Optional[NeptuneGraphClientConfig] = None) -> "aws_sdk_neptune_graph.types.untag_resource_output.UntagResourceOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_neptune_graph.types.untag_resource_input.UntagResourceInput]') -> OperationResponse["aws_sdk_neptune_graph.types.untag_resource_output.UntagResourceOutput"]:
            import aws_sdk_neptune_graph._operations.amazon_neptune_graph.untag_resource
            output, http_response = aws_sdk_neptune_graph._operations.amazon_neptune_graph.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
