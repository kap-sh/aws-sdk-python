"""Generated from Smithy shape ``com.amazonaws.neptunegraph#UpdateGraphOutput``."""
...
class UpdateGraphOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateGraphOutput) -> dict:
    out: dict = {}
    out["id"] = value["id"]
    out["name"] = value["name"]
    out["arn"] = value["arn"]
