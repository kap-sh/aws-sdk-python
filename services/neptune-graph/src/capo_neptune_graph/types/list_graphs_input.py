"""Generated from Smithy shape ``com.amazonaws.neptunegraph#ListGraphsInput``."""
...
class ListGraphsInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListGraphsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListGraphsInput:
    out: ListGraphsInput = {}  # type: ignore[typeddict-item]
    return out
