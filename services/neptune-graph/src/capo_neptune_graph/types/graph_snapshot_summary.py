"""Generated from Smithy shape ``com.amazonaws.neptunegraph#GraphSnapshotSummary``."""
...
class GraphSnapshotSummary(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GraphSnapshotSummary) -> dict:
    out: dict = {}
    out["id"] = value["id"]
    out["name"] = value["name"]
    out["arn"] = value["arn"]
