"""Generated from Smithy shape ``com.amazonaws.neptunegraph#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptunegraph#ResourceNotFoundException``."""
