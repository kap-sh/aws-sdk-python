...
import capo_neptune_graph.types.import_task_summary_list
...
def handle_response(
    ...
    out: capo_neptune_graph.types.list_import_tasks_output.ListImportTasksOutput = (
        capo_neptune_graph.types.list_import_tasks_output.deserialize_json(
