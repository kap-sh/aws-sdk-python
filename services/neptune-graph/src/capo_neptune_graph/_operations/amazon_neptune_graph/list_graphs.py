"""Generated from Smithy shape ``com.amazonaws.neptunegraph#ListGraphs``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.list_graphs_output.ListGraphsOutput = (
        capo_neptune_graph.types.list_graphs_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/graphs"
    params: dict[str, str] = {}
...
def list_graphs(
    ...
    capo_neptune_graph.types.list_graphs_output.ListGraphsOutput, zapros.Response
]:
