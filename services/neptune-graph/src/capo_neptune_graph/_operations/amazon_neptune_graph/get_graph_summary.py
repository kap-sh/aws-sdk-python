"""Generated from Smithy shape ``com.amazonaws.neptunegraph#GetGraphSummary``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.get_graph_summary_output.GetGraphSummaryOutput = (
        capo_neptune_graph.types.get_graph_summary_output.deserialize_json(
