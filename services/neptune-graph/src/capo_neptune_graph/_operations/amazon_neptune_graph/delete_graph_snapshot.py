...
def handle_response(
    ...
    out: capo_neptune_graph.types.delete_graph_snapshot_output.DeleteGraphSnapshotOutput = capo_neptune_graph.types.delete_graph_snapshot_output.deserialize_json(
...
async def async_delete_graph_snapshot(
