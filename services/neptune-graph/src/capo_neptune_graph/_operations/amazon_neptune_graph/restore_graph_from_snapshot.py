...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise capo_neptune_graph.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_neptune_graph.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_neptune_graph.types.restore_graph_from_snapshot_output.RestoreGraphFromSnapshotOutput = capo_neptune_graph.types.restore_graph_from_snapshot_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptune_graph.types.restore_graph_from_snapshot_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_restore_graph_from_snapshot(
