"""Generated from Smithy shape ``com.amazonaws.neptunegraph#CancelImportTask``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.cancel_import_task_output.CancelImportTaskOutput = (
        capo_neptune_graph.types.cancel_import_task_output.deserialize_json(
