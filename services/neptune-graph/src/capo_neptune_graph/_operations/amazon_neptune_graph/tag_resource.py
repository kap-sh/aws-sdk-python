"""Generated from Smithy shape ``com.amazonaws.neptunegraph#TagResource``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptune_graph.types.tag_resource_input.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_neptune_graph.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
