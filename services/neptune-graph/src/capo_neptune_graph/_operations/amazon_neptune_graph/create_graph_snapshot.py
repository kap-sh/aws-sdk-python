"""Generated from Smithy shape ``com.amazonaws.neptunegraph#CreateGraphSnapshot``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.create_graph_snapshot_output.CreateGraphSnapshotOutput = capo_neptune_graph.types.create_graph_snapshot_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptune_graph.types.create_graph_snapshot_input.serialize_json(input_)
    ).encode()
...
async def async_create_graph_snapshot(
