...
def handle_response(
    ...
    out: capo_neptune_graph.types.get_import_task_output.GetImportTaskOutput = (
        capo_neptune_graph.types.get_import_task_output.deserialize_json(
...
def get_import_task(
    ...
    capo_neptune_graph.types.get_import_task_output.GetImportTaskOutput, zapros.Response
]:
