...
def handle_response(
    ...
    out: capo_neptune_graph.types.delete_private_graph_endpoint_output.DeletePrivateGraphEndpointOutput = capo_neptune_graph.types.delete_private_graph_endpoint_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{vpcId}", quote(str(input_["vpc_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_private_graph_endpoint(
