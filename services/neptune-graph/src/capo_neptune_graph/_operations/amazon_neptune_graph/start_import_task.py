"""Generated from Smithy shape ``com.amazonaws.neptunegraph#StartImportTask``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.start_import_task_output.StartImportTaskOutput = (
        capo_neptune_graph.types.start_import_task_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/graphs/{graphIdentifier}/importtasks"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_neptune_graph.types.start_import_task_input.serialize_json(input_)
    ).encode()
