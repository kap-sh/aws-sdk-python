"""Generated from Smithy shape ``com.amazonaws.neptunegraph#ListGraphSnapshots``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.list_graph_snapshots_output.ListGraphSnapshotsOutput = capo_neptune_graph.types.list_graph_snapshots_output.deserialize_json(
...
async def async_list_graph_snapshots(
