...
def handle_response(
    ...
    out: capo_neptune_graph.types.reset_graph_output.ResetGraphOutput = (
        capo_neptune_graph.types.reset_graph_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptune_graph.types.reset_graph_input.serialize_json(input_)
    ).encode()
...
def reset_graph(
    ...
    capo_neptune_graph.types.reset_graph_output.ResetGraphOutput, zapros.Response
]:
