...
from capo_neptune_graph._services._aws_config import aws_config
...
class NeptuneGraphClientConfig(TypedDict, total=False, closed=True):
...
class NeptuneGraphClient:
    ...
    def cancel_query(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune_graph.types.cancel_query_input.CancelQueryInput]",
        ) -> OperationResponse[None]:
            import capo_neptune_graph._operations.amazon_neptune_graph.cancel_query

            output, http_response = (
                capo_neptune_graph._operations.amazon_neptune_graph.cancel_query.cancel_query(
    ...
    def execute_query(
        ...
        *,
    ...
    ) -> "Generator[capo_neptune_graph.types.execute_query_output.ExecuteQueryOutput]":
        ...
        def _handler(
            req: "OperationRequest[capo_neptune_graph.types.execute_query_input.ExecuteQueryInput]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                capo_neptune_graph._operations.amazon_neptune_graph.execute_query.execute_query(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_graph_summary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune_graph.types.get_graph_summary_input.GetGraphSummaryInput]",
        ) -> OperationResponse[
            "capo_neptune_graph.types.get_graph_summary_output.GetGraphSummaryOutput"
        ]:
            ...
            output, http_response = (
                capo_neptune_graph._operations.amazon_neptune_graph.get_graph_summary.get_graph_summary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_query(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune_graph.types.get_query_input.GetQueryInput]",
        ) -> OperationResponse[
            "capo_neptune_graph.types.get_query_output.GetQueryOutput"
        ]:
            ...
            output, http_response = (
                capo_neptune_graph._operations.amazon_neptune_graph.get_query.get_query(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_queries(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune_graph.types.list_queries_input.ListQueriesInput]",
        ) -> OperationResponse[
            "capo_neptune_graph.types.list_queries_output.ListQueriesOutput"
        ]:
            ...
            output, http_response = (
                capo_neptune_graph._operations.amazon_neptune_graph.list_queries.list_queries(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune_graph.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "capo_neptune_graph.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_neptune_graph._operations.amazon_neptune_graph.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune_graph.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "capo_neptune_graph.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_neptune_graph._operations.amazon_neptune_graph.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune_graph.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "capo_neptune_graph.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_neptune_graph._operations.amazon_neptune_graph.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
