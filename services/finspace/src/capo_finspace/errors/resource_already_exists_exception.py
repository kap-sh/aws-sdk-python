"""Generated from Smithy shape ``com.amazonaws.finspace#ResourceAlreadyExistsException``."""
...
class ResourceAlreadyExistsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.finspace#ResourceAlreadyExistsException``."""
