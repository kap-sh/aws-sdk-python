...
class finspaceError(Exception):
    """Base class for all finspace service errors."""


class ServiceError(finspaceError):
...
class SerializationError(finspaceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(finspaceError):
...
class WaiterFailedError(finspaceError):
...
class WaiterTimeoutError(finspaceError):
