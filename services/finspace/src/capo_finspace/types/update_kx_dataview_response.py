"""Generated from Smithy shape ``com.amazonaws.finspace#UpdateKxDataviewResponse``."""
...
class UpdateKxDataviewResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateKxDataviewResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateKxDataviewResponse:
    out: UpdateKxDataviewResponse = {}  # type: ignore[typeddict-item]
