...
if TYPE_CHECKING:
    import capo_finspace.types.kx_dataviews
    import capo_finspace.types.pagination_token


class ListKxDataviewsResponse(TypedDict, closed=True):
    kx_dataviews: NotRequired["capo_finspace.types.kx_dataviews.KxDataviews"]
...
def serialize_json(value: ListKxDataviewsResponse) -> dict:
    ...
    if "kx_dataviews" in value:
        ...
        out["kxDataviews"] = capo_finspace.types.kx_dataviews.serialize_json(
            value["kx_dataviews"]
        )
...
def deserialize_json(data: dict) -> ListKxDataviewsResponse:
    ...
    if "kxDataviews" in data:
        ...
        out["kx_dataviews"] = capo_finspace.types.kx_dataviews.deserialize_json(
            data["kxDataviews"]
        )
