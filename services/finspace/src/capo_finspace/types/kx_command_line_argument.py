...
if TYPE_CHECKING:
    import capo_finspace.types.kx_command_line_argument_key
    import capo_finspace.types.kx_command_line_argument_value


class KxCommandLineArgument(TypedDict, closed=True):
    key: NotRequired[
        "capo_finspace.types.kx_command_line_argument_key.KxCommandLineArgumentKey"
    ]
    """<p>The name of the key.</p>"""
    value: NotRequired[
        "capo_finspace.types.kx_command_line_argument_value.KxCommandLineArgumentValue"
    ]
