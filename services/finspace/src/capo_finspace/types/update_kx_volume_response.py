...
if TYPE_CHECKING:
    ...
    import capo_finspace.types.kx_volume_arn
...
class UpdateKxVolumeResponse(TypedDict, closed=True):
    ...
    volume_arn: NotRequired["capo_finspace.types.kx_volume_arn.KxVolumeArn"]
    ...
    attached_clusters: NotRequired[
        "capo_finspace.types.kx_attached_clusters.KxAttachedClusters"
    ]
    """<p> Specifies the clusters that a volume is attached to. </p>"""


# --- restJson1 ser/de ---
def serialize_json(value: UpdateKxVolumeResponse) -> dict:
    out: dict = {}
    ...
    if "attached_clusters" in value:
        ...
        out["attachedClusters"] = (
            capo_finspace.types.kx_attached_clusters.serialize_json(
...
def deserialize_json(data: dict) -> UpdateKxVolumeResponse:
    out: UpdateKxVolumeResponse = {}  # type: ignore[typeddict-item]
    ...
    if "attachedClusters" in data:
        ...
        out["attached_clusters"] = (
            capo_finspace.types.kx_attached_clusters.deserialize_json(
