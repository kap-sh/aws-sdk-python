"""Generated from Smithy shape ``com.amazonaws.finspace#GetKxEnvironmentResponse``."""
...
class GetKxEnvironmentResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetKxEnvironmentResponse) -> dict:
    out: dict = {}
    if "name" in value:
        out["name"] = value["name"]
