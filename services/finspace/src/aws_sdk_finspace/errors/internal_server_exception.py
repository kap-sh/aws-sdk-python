"""Generated from Smithy shape ``com.amazonaws.finspace#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.finspace#InternalServerException``."""
