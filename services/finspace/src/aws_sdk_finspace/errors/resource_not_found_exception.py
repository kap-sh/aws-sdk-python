"""Generated from Smithy shape ``com.amazonaws.finspace#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.finspace#ResourceNotFoundException``."""
