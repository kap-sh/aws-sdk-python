...
def handle_response(
    ...
    out: aws_sdk_finspace.types.get_kx_changeset_response.GetKxChangesetResponse = (
        aws_sdk_finspace.types.get_kx_changeset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.get_kx_changeset_request.GetKxChangesetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
