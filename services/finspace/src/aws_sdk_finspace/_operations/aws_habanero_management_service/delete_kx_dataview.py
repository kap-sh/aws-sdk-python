"""Generated from Smithy shape ``com.amazonaws.finspace#DeleteKxDataview``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.delete_kx_dataview_response.DeleteKxDataviewResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.delete_kx_dataview_request.DeleteKxDataviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_kx_dataview(
