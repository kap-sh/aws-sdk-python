"""Generated from Smithy shape ``com.amazonaws.finspace#ListKxScalingGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_kx_scaling_groups_response.ListKxScalingGroupsResponse = aws_sdk_finspace.types.list_kx_scaling_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.list_kx_scaling_groups_request.ListKxScalingGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_kx_scaling_groups(
