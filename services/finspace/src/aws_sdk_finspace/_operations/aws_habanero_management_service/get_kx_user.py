...
def handle_response(
    ...
    out: aws_sdk_finspace.types.get_kx_user_response.GetKxUserResponse = (
        aws_sdk_finspace.types.get_kx_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.get_kx_user_request.GetKxUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_kx_user(
    ...
    aws_sdk_finspace.types.get_kx_user_response.GetKxUserResponse, zapros.Response
]:
