...
def handle_response(
    ...
    out: aws_sdk_finspace.types.update_kx_volume_response.UpdateKxVolumeResponse = (
        aws_sdk_finspace.types.update_kx_volume_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.update_kx_volume_request.UpdateKxVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.update_kx_volume_request.serialize_json(input_)
    ).encode()
