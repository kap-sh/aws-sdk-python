"""Generated from Smithy shape ``com.amazonaws.finspace#ListKxChangesets``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_kx_changesets_response.ListKxChangesetsResponse = (
        aws_sdk_finspace.types.list_kx_changesets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.list_kx_changesets_request.ListKxChangesetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_kx_changesets(
