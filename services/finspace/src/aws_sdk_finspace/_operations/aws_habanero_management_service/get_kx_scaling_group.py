...
def handle_response(
    ...
    out: aws_sdk_finspace.types.get_kx_scaling_group_response.GetKxScalingGroupResponse = aws_sdk_finspace.types.get_kx_scaling_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.get_kx_scaling_group_request.GetKxScalingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
