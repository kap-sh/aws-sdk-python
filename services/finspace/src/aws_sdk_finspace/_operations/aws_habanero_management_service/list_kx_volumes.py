...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_kx_volumes_response.ListKxVolumesResponse = (
        aws_sdk_finspace.types.list_kx_volumes_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_finspace.types.list_kx_volumes_request.ListKxVolumesRequest,
) -> zapros.Request:
    ...
    if "volume_type" in input:
        params["volumeType"] = str(input["volume_type"])
