...
def handle_response(
    ...
    out: aws_sdk_finspace.types.update_kx_cluster_databases_response.UpdateKxClusterDatabasesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_finspace.types.update_kx_cluster_databases_request.UpdateKxClusterDatabasesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.update_kx_cluster_databases_request.serialize_json(input)
    ).encode()
