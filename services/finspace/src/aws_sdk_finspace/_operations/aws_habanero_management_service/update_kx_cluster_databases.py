...
def build_request(
    ...
    input_: aws_sdk_finspace.types.update_kx_cluster_databases_request.UpdateKxClusterDatabasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.update_kx_cluster_databases_request.serialize_json(
            input_
        )
    ).encode()
