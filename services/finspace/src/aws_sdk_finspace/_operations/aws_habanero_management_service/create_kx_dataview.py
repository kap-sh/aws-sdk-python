...
def handle_response(
    ...
    out: aws_sdk_finspace.types.create_kx_dataview_response.CreateKxDataviewResponse = (
        aws_sdk_finspace.types.create_kx_dataview_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.create_kx_dataview_request.CreateKxDataviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.create_kx_dataview_request.serialize_json(input_)
    ).encode()
