"""Generated from Smithy shape ``com.amazonaws.finspace#ListKxEnvironments``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_kx_environments_response.ListKxEnvironmentsResponse = aws_sdk_finspace.types.list_kx_environments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.list_kx_environments_request.ListKxEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_kx_environments(
