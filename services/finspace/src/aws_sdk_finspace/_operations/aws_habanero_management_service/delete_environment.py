...
def handle_response(
    ...
    out: aws_sdk_finspace.types.delete_environment_response.DeleteEnvironmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.delete_environment_request.DeleteEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
