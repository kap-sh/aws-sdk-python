...
def handle_response(
    ...
    out: aws_sdk_finspace.types.delete_kx_volume_response.DeleteKxVolumeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.delete_kx_volume_request.DeleteKxVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
