...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_kx_users_response.ListKxUsersResponse = (
        aws_sdk_finspace.types.list_kx_users_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.list_kx_users_request.ListKxUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_kx_users(
    ...
    aws_sdk_finspace.types.list_kx_users_response.ListKxUsersResponse, zapros.Response
]:
