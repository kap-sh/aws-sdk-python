...
def handle_response(
    ...
    out: aws_sdk_finspace.types.update_kx_environment_network_response.UpdateKxEnvironmentNetworkResponse = aws_sdk_finspace.types.update_kx_environment_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.update_kx_environment_network_request.UpdateKxEnvironmentNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.update_kx_environment_network_request.serialize_json(
            input_
        )
    ).encode()
