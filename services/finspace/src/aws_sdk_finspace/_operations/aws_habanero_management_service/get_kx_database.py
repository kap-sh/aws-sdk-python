...
def handle_response(
    ...
    out: aws_sdk_finspace.types.get_kx_database_response.GetKxDatabaseResponse = (
        aws_sdk_finspace.types.get_kx_database_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.get_kx_database_request.GetKxDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
