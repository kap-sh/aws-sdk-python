...
def handle_response(
    ...
    out: aws_sdk_finspace.types.create_kx_user_response.CreateKxUserResponse = (
        aws_sdk_finspace.types.create_kx_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.create_kx_user_request.CreateKxUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.create_kx_user_request.serialize_json(input_)
    ).encode()
...
def create_kx_user(
    ...
    aws_sdk_finspace.types.create_kx_user_response.CreateKxUserResponse, zapros.Response
]:
