...
def build_request(
    ...
    input: aws_sdk_finspace.types.create_kx_scaling_group_request.CreateKxScalingGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.create_kx_scaling_group_request.serialize_json(input)
    ).encode()
