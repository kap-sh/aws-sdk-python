...
def handle_response(
    ...
    out: aws_sdk_finspace.types.create_kx_scaling_group_response.CreateKxScalingGroupResponse = aws_sdk_finspace.types.create_kx_scaling_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.create_kx_scaling_group_request.CreateKxScalingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.create_kx_scaling_group_request.serialize_json(input_)
    ).encode()
