...
def handle_response(
    ...
    out: aws_sdk_finspace.types.delete_kx_environment_response.DeleteKxEnvironmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.delete_kx_environment_request.DeleteKxEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
