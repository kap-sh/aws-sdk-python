"""Generated from Smithy shape ``com.amazonaws.finspace#ListKxDataviews``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_kx_dataviews_response.ListKxDataviewsResponse = (
        aws_sdk_finspace.types.list_kx_dataviews_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.list_kx_dataviews_request.ListKxDataviewsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_kx_dataviews(
