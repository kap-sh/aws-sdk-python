...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_kx_databases_response.ListKxDatabasesResponse = (
        aws_sdk_finspace.types.list_kx_databases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.list_kx_databases_request.ListKxDatabasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
