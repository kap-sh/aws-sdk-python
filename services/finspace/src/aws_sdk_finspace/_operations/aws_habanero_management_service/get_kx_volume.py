"""Generated from Smithy shape ``com.amazonaws.finspace#GetKxVolume``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.get_kx_volume_response.GetKxVolumeResponse = (
        aws_sdk_finspace.types.get_kx_volume_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.get_kx_volume_request.GetKxVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_kx_volume(
    ...
    aws_sdk_finspace.types.get_kx_volume_response.GetKxVolumeResponse, zapros.Response
]:
