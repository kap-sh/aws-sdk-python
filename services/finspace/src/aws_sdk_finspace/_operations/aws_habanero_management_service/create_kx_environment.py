...
def build_request(
    ...
    input: aws_sdk_finspace.types.create_kx_environment_request.CreateKxEnvironmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.create_kx_environment_request.serialize_json(input)
    ).encode()
