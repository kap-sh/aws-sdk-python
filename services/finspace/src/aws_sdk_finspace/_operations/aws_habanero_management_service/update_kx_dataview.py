...
def handle_response(
    ...
    out: aws_sdk_finspace.types.update_kx_dataview_response.UpdateKxDataviewResponse = (
        aws_sdk_finspace.types.update_kx_dataview_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.update_kx_dataview_request.UpdateKxDataviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.update_kx_dataview_request.serialize_json(input_)
    ).encode()
