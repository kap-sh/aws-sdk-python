...
def handle_response(
    ...
    out: aws_sdk_finspace.types.delete_kx_cluster_response.DeleteKxClusterResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.delete_kx_cluster_request.DeleteKxClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
