...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_kx_clusters_response.ListKxClustersResponse = (
        aws_sdk_finspace.types.list_kx_clusters_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.list_kx_clusters_request.ListKxClustersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
