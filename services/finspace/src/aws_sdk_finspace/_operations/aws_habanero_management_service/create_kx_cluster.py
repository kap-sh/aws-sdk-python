...
def handle_response(
    ...
    out: aws_sdk_finspace.types.create_kx_cluster_response.CreateKxClusterResponse = (
        aws_sdk_finspace.types.create_kx_cluster_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_finspace.types.create_kx_cluster_request.CreateKxClusterRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.create_kx_cluster_request.serialize_json(input)
    ).encode()
