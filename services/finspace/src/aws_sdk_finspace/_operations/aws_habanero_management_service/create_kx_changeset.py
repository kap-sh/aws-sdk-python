...
def build_request(
    ...
    input: aws_sdk_finspace.types.create_kx_changeset_request.CreateKxChangesetRequest,
) -> zapros.Request:
    ...
    url = url.replace("{databaseName}", quote(str(input["database_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_finspace.types.create_kx_changeset_request

    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.create_kx_changeset_request.serialize_json(input)
    ).encode()
