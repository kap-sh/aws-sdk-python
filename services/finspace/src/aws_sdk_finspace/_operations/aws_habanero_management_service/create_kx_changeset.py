"""Generated from Smithy shape ``com.amazonaws.finspace#CreateKxChangeset``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.create_kx_changeset_response.CreateKxChangesetResponse = aws_sdk_finspace.types.create_kx_changeset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.create_kx_changeset_request.CreateKxChangesetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.create_kx_changeset_request.serialize_json(input_)
    ).encode()
...
async def async_create_kx_changeset(
