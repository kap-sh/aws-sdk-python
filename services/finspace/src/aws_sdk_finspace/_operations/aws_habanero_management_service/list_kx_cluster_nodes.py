"""Generated from Smithy shape ``com.amazonaws.finspace#ListKxClusterNodes``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_kx_cluster_nodes_response.ListKxClusterNodesResponse = aws_sdk_finspace.types.list_kx_cluster_nodes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.list_kx_cluster_nodes_request.ListKxClusterNodesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_kx_cluster_nodes(
