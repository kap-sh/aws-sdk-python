...
def handle_response(
    ...
    out: aws_sdk_finspace.types.get_kx_environment_response.GetKxEnvironmentResponse = (
        aws_sdk_finspace.types.get_kx_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.get_kx_environment_request.GetKxEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
