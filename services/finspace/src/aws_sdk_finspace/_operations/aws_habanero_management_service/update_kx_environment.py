...
def handle_response(
    ...
    out: aws_sdk_finspace.types.update_kx_environment_response.UpdateKxEnvironmentResponse = aws_sdk_finspace.types.update_kx_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.update_kx_environment_request.UpdateKxEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.update_kx_environment_request.serialize_json(input_)
    ).encode()
