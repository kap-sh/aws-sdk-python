...
def handle_response(
    ...
    out: aws_sdk_finspace.types.get_kx_cluster_response.GetKxClusterResponse = (
        aws_sdk_finspace.types.get_kx_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.get_kx_cluster_request.GetKxClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_kx_cluster(
    ...
    aws_sdk_finspace.types.get_kx_cluster_response.GetKxClusterResponse, zapros.Response
]:
