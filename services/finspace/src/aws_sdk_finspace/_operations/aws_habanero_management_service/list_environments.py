...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_environments_response.ListEnvironmentsResponse = (
        aws_sdk_finspace.types.list_environments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.list_environments_request.ListEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
