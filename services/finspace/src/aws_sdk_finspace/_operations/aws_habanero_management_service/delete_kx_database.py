"""Generated from Smithy shape ``com.amazonaws.finspace#DeleteKxDatabase``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.delete_kx_database_response.DeleteKxDatabaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.delete_kx_database_request.DeleteKxDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_kx_database(
