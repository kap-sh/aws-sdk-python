...
def build_request(
    ...
    input: aws_sdk_finspace.types.update_environment_request.UpdateEnvironmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.update_environment_request.serialize_json(input)
    ).encode()
