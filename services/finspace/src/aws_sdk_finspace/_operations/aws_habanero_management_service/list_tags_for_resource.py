"""Generated from Smithy shape ``com.amazonaws.finspace#ListTagsForResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRequestException":
            import aws_sdk_finspace.errors.invalid_request_exception

            raise aws_sdk_finspace.errors.invalid_request_exception.InvalidRequestException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_finspace.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
