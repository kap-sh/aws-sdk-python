"""Generated from Smithy shape ``com.amazonaws.finspace#DeleteKxScalingGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.delete_kx_scaling_group_response.DeleteKxScalingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.delete_kx_scaling_group_request.DeleteKxScalingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_kx_scaling_group(
