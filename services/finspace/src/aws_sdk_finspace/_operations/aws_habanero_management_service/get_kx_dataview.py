"""Generated from Smithy shape ``com.amazonaws.finspace#GetKxDataview``."""
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.get_kx_dataview_response.GetKxDataviewResponse = (
        aws_sdk_finspace.types.get_kx_dataview_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.get_kx_dataview_request.GetKxDataviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{dataviewName}", quote(str(input_["dataview_name"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_kx_dataview(
