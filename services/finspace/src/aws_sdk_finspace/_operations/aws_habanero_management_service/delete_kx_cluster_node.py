...
def handle_response(
    ...
    out: aws_sdk_finspace.types.delete_kx_cluster_node_response.DeleteKxClusterNodeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.delete_kx_cluster_node_request.DeleteKxClusterNodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
