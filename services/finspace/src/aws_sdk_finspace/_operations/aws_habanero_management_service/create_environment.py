...
def build_request(
    ...
    input: aws_sdk_finspace.types.create_environment_request.CreateEnvironmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.create_environment_request.serialize_json(input)
    ).encode()
