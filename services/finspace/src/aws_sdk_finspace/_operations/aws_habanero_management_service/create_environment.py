...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_finspace.errors.service_quota_exceeded_exception

            raise aws_sdk_finspace.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_finspace.types.create_environment_response.CreateEnvironmentResponse = aws_sdk_finspace.types.create_environment_response.deserialize_json(
...
def get_signer(
...
) -> aws_sdk_finspace._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_finspace._auth._sigv4.build_sigv4_auth_scheme(
                "finspace", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_finspace._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.create_environment_request.CreateEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.create_environment_request.serialize_json(input_)
    ).encode()
