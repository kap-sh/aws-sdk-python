...
def build_request(
    ...
    input: aws_sdk_finspace.types.get_kx_connection_string_request.GetKxConnectionStringRequest,
) -> zapros.Request:
    ...
    if "user_arn" in input:
        params["userArn"] = str(input["user_arn"])
    if "cluster_name" in input:
        params["clusterName"] = str(input["cluster_name"])
