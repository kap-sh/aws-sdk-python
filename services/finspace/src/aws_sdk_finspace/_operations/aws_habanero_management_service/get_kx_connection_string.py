...
def handle_response(
    ...
    out: aws_sdk_finspace.types.get_kx_connection_string_response.GetKxConnectionStringResponse = aws_sdk_finspace.types.get_kx_connection_string_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.get_kx_connection_string_request.GetKxConnectionStringRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
