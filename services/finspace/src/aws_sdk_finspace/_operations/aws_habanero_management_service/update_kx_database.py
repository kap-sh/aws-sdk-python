...
def handle_response(
    ...
    out: aws_sdk_finspace.types.update_kx_database_response.UpdateKxDatabaseResponse = (
        aws_sdk_finspace.types.update_kx_database_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.update_kx_database_request.UpdateKxDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_finspace.types.update_kx_database_request.serialize_json(input_)
    ).encode()
