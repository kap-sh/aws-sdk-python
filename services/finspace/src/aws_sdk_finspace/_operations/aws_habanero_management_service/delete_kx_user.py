...
def handle_response(
    ...
    out: aws_sdk_finspace.types.delete_kx_user_response.DeleteKxUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_finspace.types.delete_kx_user_request.DeleteKxUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_kx_user(
    ...
    aws_sdk_finspace.types.delete_kx_user_response.DeleteKxUserResponse, zapros.Response
]:
