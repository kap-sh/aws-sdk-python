...
if TYPE_CHECKING:
    ...
    import aws_sdk_finspace.types.string_value_length1to255
...
class GetKxEnvironmentResponse(TypedDict):
    ...
    certificate_authority_arn: NotRequired[
        "aws_sdk_finspace.types.string_value_length1to255.stringValueLength1to255"
    ]
