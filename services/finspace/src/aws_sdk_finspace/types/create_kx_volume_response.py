"""Generated from Smithy shape ``com.amazonaws.finspace#CreateKxVolumeResponse``."""
...
class CreateKxVolumeResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateKxVolumeResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateKxVolumeResponse:
    out: CreateKxVolumeResponse = {}  # type: ignore[typeddict-item]
