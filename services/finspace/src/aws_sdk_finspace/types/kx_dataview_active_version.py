...
if TYPE_CHECKING:
    import aws_sdk_finspace.types.attached_cluster_list
...
class KxDataviewActiveVersion(TypedDict):
    ...
    attached_clusters: NotRequired[
        "aws_sdk_finspace.types.attached_cluster_list.AttachedClusterList"
    ]
    ...
    version_id: NotRequired["aws_sdk_finspace.types.version_id.VersionId"]
...
def serialize_json(value: KxDataviewActiveVersion) -> dict:
    ...
    if "attached_clusters" in value:
        ...
        out["attachedClusters"] = (
            aws_sdk_finspace.types.attached_cluster_list.serialize_json(
...
def deserialize_json(data: dict) -> KxDataviewActiveVersion:
    ...
    if "attachedClusters" in data:
        ...
        out["attached_clusters"] = (
            aws_sdk_finspace.types.attached_cluster_list.deserialize_json(
