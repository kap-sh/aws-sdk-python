"""Generated from Smithy shape ``com.amazonaws.finspace#KxDataviewListEntry``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_finspace.types.kx_dataview_active_version_list
    ...
    import aws_sdk_finspace.types.kx_dataview_status_reason
    import aws_sdk_finspace.types.timestamp


class KxDataviewListEntry(TypedDict, closed=True):
    ...
    active_versions: NotRequired[
        "aws_sdk_finspace.types.kx_dataview_active_version_list.KxDataviewActiveVersionList"
    ]
    ...
    status_reason: NotRequired[
        "aws_sdk_finspace.types.kx_dataview_status_reason.KxDataviewStatusReason"
    ]
    """<p> The error message when a failed state occurs. </p>"""


# --- restJson1 ser/de ---
def serialize_json(value: KxDataviewListEntry) -> dict:
    out: dict = {}
    ...
    if "active_versions" in value:
        ...
        out["activeVersions"] = (
            aws_sdk_finspace.types.kx_dataview_active_version_list.serialize_json(
...
def deserialize_json(data: dict) -> KxDataviewListEntry:
    out: KxDataviewListEntry = {}  # type: ignore[typeddict-item]
    ...
    if "activeVersions" in data:
        ...
        out["active_versions"] = (
            aws_sdk_finspace.types.kx_dataview_active_version_list.deserialize_json(
                data["activeVersions"]
            )
        )
    if "status" in data:
