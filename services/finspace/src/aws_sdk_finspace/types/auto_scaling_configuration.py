...
if TYPE_CHECKING:
    ...
    import aws_sdk_finspace.types.auto_scaling_metric_target
    import aws_sdk_finspace.types.cooldown_time
...
class AutoScalingConfiguration(TypedDict):
    ...
    auto_scaling_metric: NotRequired[
        "aws_sdk_finspace.types.auto_scaling_metric.AutoScalingMetric"
    ]
    ...
    metric_target: NotRequired[
        "aws_sdk_finspace.types.auto_scaling_metric_target.AutoScalingMetricTarget"
    ]
    ...
    scale_in_cooldown_seconds: NotRequired[
        "aws_sdk_finspace.types.cooldown_time.CooldownTime"
    ]
...
def serialize_json(value: AutoScalingConfiguration) -> dict:
    ...
    if "auto_scaling_metric" in value:
        ...
        out["autoScalingMetric"] = (
            aws_sdk_finspace.types.auto_scaling_metric.serialize_json(
...
def deserialize_json(data: dict) -> AutoScalingConfiguration:
    ...
    if "autoScalingMetric" in data:
        ...
        out["auto_scaling_metric"] = (
            aws_sdk_finspace.types.auto_scaling_metric.deserialize_json(
