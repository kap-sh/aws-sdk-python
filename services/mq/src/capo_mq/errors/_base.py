...
class mqError(Exception):
    """Base class for all mq service errors."""


class ServiceError(mqError):
...
class DeserializationError(mqError):
...
class WaiterFailedError(mqError):
...
class WaiterTimeoutError(mqError):
