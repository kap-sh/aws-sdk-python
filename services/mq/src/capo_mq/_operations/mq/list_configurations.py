"""Generated from Smithy shape ``com.amazonaws.mq#ListConfigurations``."""
...
import capo_mq.types.__list_of_configuration
...
def handle_response(
    ...
    out: capo_mq.types.list_configurations_response.ListConfigurationsResponse = (
        capo_mq.types.list_configurations_response.deserialize_json(
