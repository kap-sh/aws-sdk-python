...
def handle_response(
    ...
    out: capo_mq.types.list_brokers_response.ListBrokersResponse = (
        capo_mq.types.list_brokers_response.deserialize_json(
...
def list_brokers(
    ...
    input_: capo_mq.types.list_brokers_request.ListBrokersRequest,
) -> tuple[capo_mq.types.list_brokers_response.ListBrokersResponse, zapros.Response]:
