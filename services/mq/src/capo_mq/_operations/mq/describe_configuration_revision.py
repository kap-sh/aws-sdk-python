"""Generated from Smithy shape ``com.amazonaws.mq#DescribeConfigurationRevision``."""
...
def handle_response(
    ...
    out: capo_mq.types.describe_configuration_revision_response.DescribeConfigurationRevisionResponse = capo_mq.types.describe_configuration_revision_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{ConfigurationId}", quote(str(input_["configuration_id"]), safe="")
    )
    url = url.replace(
        "{ConfigurationRevision}", quote(str(input_["configuration_revision"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_describe_configuration_revision(
