"""Generated from Smithy shape ``com.amazonaws.mq#DeleteUser``."""
...
def handle_response(
    ...
    out: capo_mq.types.delete_user_response.DeleteUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_user(
    ...
    input_: capo_mq.types.delete_user_request.DeleteUserRequest,
) -> tuple[capo_mq.types.delete_user_response.DeleteUserResponse, zapros.Response]:
