"""Generated from Smithy shape ``com.amazonaws.mq#ListConfigurationRevisions``."""
...
def handle_response(
    ...
    out: capo_mq.types.list_configuration_revisions_response.ListConfigurationRevisionsResponse = capo_mq.types.list_configuration_revisions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/configurations/{ConfigurationId}/revisions"
    url = url.replace(
...
async def async_list_configuration_revisions(
