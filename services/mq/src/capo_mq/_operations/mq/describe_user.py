"""Generated from Smithy shape ``com.amazonaws.mq#DescribeUser``."""
...
def handle_response(
    ...
    out: capo_mq.types.describe_user_response.DescribeUserResponse = (
        capo_mq.types.describe_user_response.deserialize_json(
...
def describe_user(
    ...
    input_: capo_mq.types.describe_user_request.DescribeUserRequest,
) -> tuple[capo_mq.types.describe_user_response.DescribeUserResponse, zapros.Response]:
