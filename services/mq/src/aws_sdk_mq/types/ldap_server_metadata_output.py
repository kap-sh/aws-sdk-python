"""Generated from Smithy shape ``com.amazonaws.mq#LdapServerMetadataOutput``."""
...
class LdapServerMetadataOutput(TypedDict, closed=True):
    ...
    role_name: NotRequired["aws_sdk_mq.types.__string.__string"]
    ...
    role_search_matching: NotRequired["aws_sdk_mq.types.__string.__string"]
    ...
    role_search_subtree: NotRequired["aws_sdk_mq.types.__boolean.__boolean"]
    """<p>The directory search scope for the role. If set to true, scope is to search the entire subtree.</p>"""
    service_account_username: NotRequired["aws_sdk_mq.types.__string.__string"]
    ...
    user_base: NotRequired["aws_sdk_mq.types.__string.__string"]
    ...
    user_role_name: NotRequired["aws_sdk_mq.types.__string.__string"]
    """<p>Specifies the name of the LDAP attribute for the user group membership.</p>"""
    user_search_matching: NotRequired["aws_sdk_mq.types.__string.__string"]
    ...
    user_search_subtree: NotRequired["aws_sdk_mq.types.__boolean.__boolean"]
    """<p>The directory search scope for the user. If set to true, scope is to search the entire subtree.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: LdapServerMetadataOutput) -> dict:
    out: dict = {}
    if "hosts" in value:
        import aws_sdk_mq.types.__list_of__string

        out["hosts"] = aws_sdk_mq.types.__list_of__string.serialize_json(value["hosts"])
...
def deserialize_json(data: dict) -> LdapServerMetadataOutput:
    ...
    if "hosts" in data:
        ...
        out["hosts"] = aws_sdk_mq.types.__list_of__string.deserialize_json(
            data["hosts"]
        )
    if "roleBase" in data:
