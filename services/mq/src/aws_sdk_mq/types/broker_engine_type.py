...
class BrokerEngineType(TypedDict, closed=True):
    ...
    engine_versions: NotRequired[
        "aws_sdk_mq.types.__list_of_engine_version.__listOfEngineVersion"
    ]
...
def serialize_json(value: BrokerEngineType) -> dict:
    ...
    if "engine_versions" in value:
        ...
        out["engineVersions"] = (
            aws_sdk_mq.types.__list_of_engine_version.serialize_json(
...
def deserialize_json(data: dict) -> BrokerEngineType:
    ...
    if "engineVersions" in data:
        ...
        out["engine_versions"] = (
            aws_sdk_mq.types.__list_of_engine_version.deserialize_json(
                data["engineVersions"]
            )
        )
    return out
