...
def handle_response(
    ...
    out: aws_sdk_mq.types.list_tags_response.ListTagsResponse = (
        aws_sdk_mq.types.list_tags_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mq.types.list_tags_request.ListTagsRequest,
) -> zapros.Request:
...
def list_tags(
    options: OperationOptions, input: aws_sdk_mq.types.list_tags_request.ListTagsRequest
) -> tuple[aws_sdk_mq.types.list_tags_response.ListTagsResponse, zapros.Response]:
