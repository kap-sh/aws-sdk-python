"""Generated from Smithy shape ``com.amazonaws.mq#UpdateConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_mq.types.update_configuration_response.UpdateConfigurationResponse = (
        aws_sdk_mq.types.update_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mq.types.update_configuration_request.UpdateConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/configurations/{ConfigurationId}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mq.types.update_configuration_request.serialize_json(input_)
    ).encode()
