...
def build_request(
    ...
    input: aws_sdk_mq.types.update_configuration_request.UpdateConfigurationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ConfigurationId}", quote(str(input["configuration_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mq.types.update_configuration_request.serialize_json(input)
    ).encode()
