"""Generated from Smithy shape ``com.amazonaws.mq#DescribeBrokerEngineTypes``."""
...
def handle_response(
    ...
    out: aws_sdk_mq.types.describe_broker_engine_types_response.DescribeBrokerEngineTypesResponse = aws_sdk_mq.types.describe_broker_engine_types_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mq.types.describe_broker_engine_types_request.DescribeBrokerEngineTypesRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/broker-engine-types"
    params: dict[str, str] = {}
...
async def async_describe_broker_engine_types(
