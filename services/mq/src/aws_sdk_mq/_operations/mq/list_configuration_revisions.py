...
def handle_response(
    ...
    out: aws_sdk_mq.types.list_configuration_revisions_response.ListConfigurationRevisionsResponse = aws_sdk_mq.types.list_configuration_revisions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mq.types.list_configuration_revisions_request.ListConfigurationRevisionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
