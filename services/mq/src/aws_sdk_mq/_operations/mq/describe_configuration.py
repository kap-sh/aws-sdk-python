"""Generated from Smithy shape ``com.amazonaws.mq#DescribeConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_mq.types.describe_configuration_response.DescribeConfigurationResponse = aws_sdk_mq.types.describe_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mq.types.describe_configuration_request.DescribeConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_configuration(
