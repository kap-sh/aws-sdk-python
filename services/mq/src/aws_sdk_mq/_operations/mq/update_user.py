...
def build_request(
    ...
    input_: aws_sdk_mq.types.update_user_request.UpdateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mq.types.update_user_request.serialize_json(input_)
    ).encode()
...
def update_user(
    ...
    input_: aws_sdk_mq.types.update_user_request.UpdateUserRequest,
) -> tuple[aws_sdk_mq.types.update_user_response.UpdateUserResponse, zapros.Response]:
