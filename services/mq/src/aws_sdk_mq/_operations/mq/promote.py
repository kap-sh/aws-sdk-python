...
async def async_handle_response(
    ...
    out: aws_sdk_mq.types.promote_response.PromoteResponse = (
        aws_sdk_mq.types.promote_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mq.types.promote_request.PromoteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mq.types.promote_request.serialize_json(input_)
    ).encode()
...
def promote(
    options: OperationOptions, input_: aws_sdk_mq.types.promote_request.PromoteRequest
