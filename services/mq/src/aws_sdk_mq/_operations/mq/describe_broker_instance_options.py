...
def handle_response(
    ...
    out: aws_sdk_mq.types.describe_broker_instance_options_response.DescribeBrokerInstanceOptionsResponse = aws_sdk_mq.types.describe_broker_instance_options_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mq.types.describe_broker_instance_options_request.DescribeBrokerInstanceOptionsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "engine_type" in input:
        params["engineType"] = str(input["engine_type"])
    if "host_instance_type" in input:
        params["hostInstanceType"] = str(input["host_instance_type"])
    if "max_results" in input:
        params["maxResults"] = str(input["max_results"])
    if "next_token" in input:
        params["nextToken"] = str(input["next_token"])
    if "storage_type" in input:
        params["storageType"] = str(input["storage_type"])
