...
def build_request(
    ...
    input_: aws_sdk_mq.types.describe_broker_instance_options_request.DescribeBrokerInstanceOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "host_instance_type" in input_:
        params["hostInstanceType"] = str(input_["host_instance_type"])
    if "max_results" in input_:
        params["maxResults"] = str(input_["max_results"])
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "storage_type" in input_:
        params["storageType"] = str(input_["storage_type"])
