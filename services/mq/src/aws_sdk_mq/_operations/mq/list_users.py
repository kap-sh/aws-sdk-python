"""Generated from Smithy shape ``com.amazonaws.mq#ListUsers``."""
...
def handle_response(
    ...
    out: aws_sdk_mq.types.list_users_response.ListUsersResponse = (
        aws_sdk_mq.types.list_users_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mq.types.list_users_request.ListUsersRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/brokers/{BrokerId}/users"
...
def list_users(
    ...
    input: aws_sdk_mq.types.list_users_request.ListUsersRequest,
) -> tuple[aws_sdk_mq.types.list_users_response.ListUsersResponse, zapros.Response]:
