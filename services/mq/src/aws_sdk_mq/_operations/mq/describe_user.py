...
def handle_response(
    ...
    out: aws_sdk_mq.types.describe_user_response.DescribeUserResponse = (
        aws_sdk_mq.types.describe_user_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mq.types.describe_user_request.DescribeUserRequest,
) -> zapros.Request:
    ...
    url = url.replace("{Username}", quote(str(input["username"]), safe=""))
    params: dict[str, str] = {}
...
def describe_user(
    ...
    aws_sdk_mq.types.describe_user_response.DescribeUserResponse, zapros.Response
]:
