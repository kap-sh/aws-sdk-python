...
def handle_response(
    ...
    out: aws_sdk_mq.types.describe_configuration_revision_response.DescribeConfigurationRevisionResponse = aws_sdk_mq.types.describe_configuration_revision_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mq.types.describe_configuration_revision_request.DescribeConfigurationRevisionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ConfigurationRevision}", quote(str(input["configuration_revision"]), safe="")
    )
    params: dict[str, str] = {}
