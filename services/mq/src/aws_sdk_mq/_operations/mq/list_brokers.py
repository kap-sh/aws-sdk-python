"""Generated from Smithy shape ``com.amazonaws.mq#ListBrokers``."""
...
def handle_response(
    ...
    out: aws_sdk_mq.types.list_brokers_response.ListBrokersResponse = (
        aws_sdk_mq.types.list_brokers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mq.types.list_brokers_request.ListBrokersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/brokers"
    params: dict[str, str] = {}
...
def list_brokers(
    ...
    input_: aws_sdk_mq.types.list_brokers_request.ListBrokersRequest,
) -> tuple[aws_sdk_mq.types.list_brokers_response.ListBrokersResponse, zapros.Response]:
