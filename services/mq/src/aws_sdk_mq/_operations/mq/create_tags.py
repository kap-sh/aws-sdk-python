"""Generated from Smithy shape ``com.amazonaws.mq#CreateTags``."""
...
def build_request(
    ...
    input: aws_sdk_mq.types.create_tags_request.CreateTagsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mq.types.create_tags_request.serialize_json(input)
    ).encode()
