"""Generated from Smithy shape ``com.amazonaws.mq#CreateUser``."""
...
def handle_response(
    ...
    out: aws_sdk_mq.types.create_user_response.CreateUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_mq.types.create_user_request.CreateUserRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mq.types.create_user_request.serialize_json(input)
    ).encode()
...
def create_user(
    ...
    input: aws_sdk_mq.types.create_user_request.CreateUserRequest,
) -> tuple[aws_sdk_mq.types.create_user_response.CreateUserResponse, zapros.Response]:
