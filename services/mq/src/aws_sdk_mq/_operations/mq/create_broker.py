...
def build_request(
    ...
    input_: aws_sdk_mq.types.create_broker_request.CreateBrokerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mq.types.create_broker_request.serialize_json(input_)
    ).encode()
...
def create_broker(
    ...
    aws_sdk_mq.types.create_broker_response.CreateBrokerResponse, zapros.Response
]:
