"""Generated from Smithy shape ``com.amazonaws.mq#RebootBroker``."""
...
def handle_response(
    ...
    out: aws_sdk_mq.types.reboot_broker_response.RebootBrokerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_mq.types.reboot_broker_request.RebootBrokerRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/brokers/{BrokerId}/reboot"
...
def reboot_broker(
    ...
    aws_sdk_mq.types.reboot_broker_response.RebootBrokerResponse, zapros.Response
]:
