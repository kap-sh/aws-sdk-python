...
def handle_response(
    ...
    out: aws_sdk_mq.types.delete_configuration_response.DeleteConfigurationResponse = (
        aws_sdk_mq.types.delete_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mq.types.delete_configuration_request.DeleteConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
