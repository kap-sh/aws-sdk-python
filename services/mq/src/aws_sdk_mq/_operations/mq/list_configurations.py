...
def handle_response(
    ...
    out: aws_sdk_mq.types.list_configurations_response.ListConfigurationsResponse = (
        aws_sdk_mq.types.list_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mq.types.list_configurations_request.ListConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
