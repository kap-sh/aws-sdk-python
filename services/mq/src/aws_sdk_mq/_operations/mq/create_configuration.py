"""Generated from Smithy shape ``com.amazonaws.mq#CreateConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_mq.types.create_configuration_response.CreateConfigurationResponse = (
        aws_sdk_mq.types.create_configuration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mq.types.create_configuration_request.CreateConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mq.types.create_configuration_request.serialize_json(input)
    ).encode()
