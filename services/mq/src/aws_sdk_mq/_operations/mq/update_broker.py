...
def handle_response(
    ...
    out: aws_sdk_mq.types.update_broker_response.UpdateBrokerResponse = (
        aws_sdk_mq.types.update_broker_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mq.types.update_broker_request.UpdateBrokerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mq.types.update_broker_request.serialize_json(input)
    ).encode()
...
def update_broker(
    ...
    aws_sdk_mq.types.update_broker_response.UpdateBrokerResponse, zapros.Response
]:
