"""Generated from Smithy shape ``com.amazonaws.mq#DeleteBroker``."""
...
def handle_response(
    ...
    out: aws_sdk_mq.types.delete_broker_response.DeleteBrokerResponse = (
        aws_sdk_mq.types.delete_broker_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mq.types.delete_broker_request.DeleteBrokerRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/brokers/{BrokerId}"
...
def delete_broker(
    ...
    aws_sdk_mq.types.delete_broker_response.DeleteBrokerResponse, zapros.Response
]:
