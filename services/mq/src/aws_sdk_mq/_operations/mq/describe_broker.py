...
def handle_response(
    ...
    out: aws_sdk_mq.types.describe_broker_response.DescribeBrokerResponse = (
        aws_sdk_mq.types.describe_broker_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mq.types.describe_broker_request.DescribeBrokerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_broker(
    ...
    aws_sdk_mq.types.describe_broker_response.DescribeBrokerResponse, zapros.Response
]:
