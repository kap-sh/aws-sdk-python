"""Generated from Smithy shape ``com.amazonaws.elementalinference#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elementalinference#ResourceNotFoundException``."""
