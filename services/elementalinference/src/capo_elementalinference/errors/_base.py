...
class ElementalInferenceError(Exception):
    """Base class for all ElementalInference service errors."""


class ServiceError(ElementalInferenceError):
...
class SerializationError(ElementalInferenceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ElementalInferenceError):
...
class WaiterFailedError(ElementalInferenceError):
...
class WaiterTimeoutError(ElementalInferenceError):
