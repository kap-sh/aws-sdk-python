"""Generated from Smithy shape ``com.amazonaws.elementalinference#ExportDictionaryEntries``."""
...
def handle_response(
    ...
    out: capo_elementalinference.types.export_dictionary_entries_response.ExportDictionaryEntriesResponse = capo_elementalinference.types.export_dictionary_entries_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/dictionary/{id}/entries/export"
...
async def async_export_dictionary_entries(
