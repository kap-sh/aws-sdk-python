"""Generated from Smithy shape ``com.amazonaws.elementalinference#DeleteDictionary``."""
...
def handle_response(
    ...
    out: capo_elementalinference.types.delete_dictionary_response.DeleteDictionaryResponse = capo_elementalinference.types.delete_dictionary_response.deserialize_json(
...
async def async_delete_dictionary(
