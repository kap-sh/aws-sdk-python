"""Generated from Smithy shape ``com.amazonaws.elementalinference#DeleteFeed``."""
...
def handle_response(
    ...
    out: capo_elementalinference.types.delete_feed_response.DeleteFeedResponse = (
        capo_elementalinference.types.delete_feed_response.deserialize_json(
