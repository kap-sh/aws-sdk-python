...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.delete_feed_response.DeleteFeedResponse = (
        aws_sdk_elementalinference.types.delete_feed_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.delete_feed_request.DeleteFeedRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
