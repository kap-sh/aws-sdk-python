...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.list_dictionaries_response.ListDictionariesResponse = aws_sdk_elementalinference.types.list_dictionaries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.list_dictionaries_request.ListDictionariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
