...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.disassociate_feed_request.DisassociateFeedRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elementalinference.types.disassociate_feed_request.serialize_json(
            input_
        )
    ).encode()
