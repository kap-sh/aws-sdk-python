...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.disassociate_feed_response.DisassociateFeedResponse = aws_sdk_elementalinference.types.disassociate_feed_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_elementalinference.types.disassociate_feed_request.DisassociateFeedRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elementalinference.types.disassociate_feed_request.serialize_json(input)
    ).encode()
