...
def build_request(
    ...
    input: aws_sdk_elementalinference.types.associate_feed_request.AssociateFeedRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elementalinference.types.associate_feed_request.serialize_json(input)
    ).encode()
