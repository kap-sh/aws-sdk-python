...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.create_dictionary_response.CreateDictionaryResponse = aws_sdk_elementalinference.types.create_dictionary_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_elementalinference.types.create_dictionary_request.CreateDictionaryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elementalinference.types.create_dictionary_request.serialize_json(input)
    ).encode()
