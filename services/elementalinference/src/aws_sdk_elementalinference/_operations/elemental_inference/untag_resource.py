"""Generated from Smithy shape ``com.amazonaws.elementalinference#UntagResource``."""
...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
