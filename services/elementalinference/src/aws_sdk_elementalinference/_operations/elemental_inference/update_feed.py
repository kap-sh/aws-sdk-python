...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.update_feed_response.UpdateFeedResponse = (
        aws_sdk_elementalinference.types.update_feed_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.update_feed_request.UpdateFeedRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elementalinference.types.update_feed_request.serialize_json(input_)
    ).encode()
