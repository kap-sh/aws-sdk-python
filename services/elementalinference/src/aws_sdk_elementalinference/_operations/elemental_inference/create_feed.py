...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.create_feed_response.CreateFeedResponse = (
        aws_sdk_elementalinference.types.create_feed_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.create_feed_request.CreateFeedRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elementalinference.types.create_feed_request.serialize_json(input_)
    ).encode()
