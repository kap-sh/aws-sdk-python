...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.get_feed_response.GetFeedResponse = (
        aws_sdk_elementalinference.types.get_feed_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.get_feed_request.GetFeedRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_feed(
    ...
    aws_sdk_elementalinference.types.get_feed_response.GetFeedResponse, zapros.Response
]:
