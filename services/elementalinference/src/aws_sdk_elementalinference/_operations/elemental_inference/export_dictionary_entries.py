...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.export_dictionary_entries_response.ExportDictionaryEntriesResponse = aws_sdk_elementalinference.types.export_dictionary_entries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.export_dictionary_entries_request.ExportDictionaryEntriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
