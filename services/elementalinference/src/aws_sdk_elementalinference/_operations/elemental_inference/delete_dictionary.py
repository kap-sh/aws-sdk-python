...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.delete_dictionary_response.DeleteDictionaryResponse = aws_sdk_elementalinference.types.delete_dictionary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.delete_dictionary_request.DeleteDictionaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
