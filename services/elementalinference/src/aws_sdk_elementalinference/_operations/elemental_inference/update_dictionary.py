...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.update_dictionary_response.UpdateDictionaryResponse = aws_sdk_elementalinference.types.update_dictionary_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_elementalinference.types.update_dictionary_request.UpdateDictionaryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elementalinference.types.update_dictionary_request.serialize_json(input)
    ).encode()
