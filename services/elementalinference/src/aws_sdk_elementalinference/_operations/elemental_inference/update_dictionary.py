...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.update_dictionary_request.UpdateDictionaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elementalinference.types.update_dictionary_request.serialize_json(
            input_
        )
    ).encode()
