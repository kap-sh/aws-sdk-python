...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.get_dictionary_response.GetDictionaryResponse = aws_sdk_elementalinference.types.get_dictionary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.get_dictionary_request.GetDictionaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
