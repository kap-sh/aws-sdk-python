...
def handle_response(
    ...
    out: aws_sdk_elementalinference.types.list_feeds_response.ListFeedsResponse = (
        aws_sdk_elementalinference.types.list_feeds_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elementalinference.types.list_feeds_request.ListFeedsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
