...
class codestarnotificationsError(Exception):
    """Base class for all codestarnotifications service errors."""


class ServiceError(codestarnotificationsError):
...
class SerializationError(codestarnotificationsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(codestarnotificationsError):
...
class WaiterFailedError(codestarnotificationsError):
...
class WaiterTimeoutError(codestarnotificationsError):
