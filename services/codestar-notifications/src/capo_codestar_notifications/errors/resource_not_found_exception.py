"""Generated from Smithy shape ``com.amazonaws.codestarnotifications#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarnotifications#ResourceNotFoundException``."""
