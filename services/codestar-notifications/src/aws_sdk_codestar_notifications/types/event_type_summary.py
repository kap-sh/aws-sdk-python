...
if TYPE_CHECKING:
    import aws_sdk_codestar_notifications.types.event_type_id
    import aws_sdk_codestar_notifications.types.event_type_name
    import aws_sdk_codestar_notifications.types.resource_type
    import aws_sdk_codestar_notifications.types.service_name


class EventTypeSummary(TypedDict):
    ...
    event_type_name: NotRequired[
        "aws_sdk_codestar_notifications.types.event_type_name.EventTypeName"
    ]
    """<p>The name of the event.</p>"""
    resource_type: NotRequired[
        "aws_sdk_codestar_notifications.types.resource_type.ResourceType"
    ]
