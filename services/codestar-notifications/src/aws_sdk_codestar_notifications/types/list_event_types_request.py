...
class ListEventTypesRequest(TypedDict):
    filters: NotRequired[
...
def serialize_json(value: ListEventTypesRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_codestar_notifications.types.list_event_types_filters.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListEventTypesRequest:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_codestar_notifications.types.list_event_types_filters.deserialize_json(
                data["Filters"]
            )
        )
