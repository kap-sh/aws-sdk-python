"""Generated from Smithy shape ``com.amazonaws.codestarnotifications#ListNotificationRulesRequest``."""
...
class ListNotificationRulesRequest(TypedDict, closed=True):
    filters: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: ListNotificationRulesRequest) -> dict:
    out: dict = {}
    if "filters" in value:
        import aws_sdk_codestar_notifications.types.list_notification_rules_filters

        out["Filters"] = (
            aws_sdk_codestar_notifications.types.list_notification_rules_filters.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListNotificationRulesRequest:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_codestar_notifications.types.list_notification_rules_filters.deserialize_json(
                data["Filters"]
            )
        )
