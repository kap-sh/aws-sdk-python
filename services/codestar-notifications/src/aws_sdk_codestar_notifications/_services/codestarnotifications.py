...
from aws_sdk_codestar_notifications._services._aws_config import aws_config
...
class codestarnotificationsClientConfig(TypedDict, total=False):
...
class codestarnotificationsClient:
    ...
    def create_notification_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.create_notification_rule_request.CreateNotificationRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.create_notification_rule_result.CreateNotificationRuleResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.create_notification_rule.create_notification_rule(
    ...
    def delete_notification_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.delete_notification_rule_request.DeleteNotificationRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.delete_notification_rule_result.DeleteNotificationRuleResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.delete_notification_rule.delete_notification_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_target(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.delete_target_request.DeleteTargetRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.delete_target_result.DeleteTargetResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.delete_target.delete_target(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_notification_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.describe_notification_rule_request.DescribeNotificationRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.describe_notification_rule_result.DescribeNotificationRuleResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.describe_notification_rule.describe_notification_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_event_types(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.list_event_types_request.ListEventTypesRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.list_event_types_result.ListEventTypesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.list_event_types.list_event_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_codestar_notifications.types.event_type_summary.EventTypeSummary]":
        _token = next_token
        while True:
    ...
    def list_notification_rules(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.list_notification_rules_request.ListNotificationRulesRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.list_notification_rules_result.ListNotificationRulesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.list_notification_rules.list_notification_rules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_codestar_notifications.types.notification_rule_summary.NotificationRuleSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.list_tags_for_resource_result.ListTagsForResourceResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_targets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.list_targets_request.ListTargetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.list_targets_result.ListTargetsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.list_targets.list_targets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_codestar_notifications.types.target_summary.TargetSummary]":
        _token = next_token
        while True:
    ...
    def subscribe(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.subscribe_request.SubscribeRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.subscribe_result.SubscribeResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.subscribe.subscribe(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.tag_resource_result.TagResourceResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def unsubscribe(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.unsubscribe_request.UnsubscribeRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.unsubscribe_result.UnsubscribeResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.unsubscribe.unsubscribe(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.untag_resource_result.UntagResourceResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_notification_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_codestar_notifications.types.update_notification_rule_request.UpdateNotificationRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_codestar_notifications.types.update_notification_rule_result.UpdateNotificationRuleResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_codestar_notifications._operations.code_star_notifications_20191015.update_notification_rule.update_notification_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
