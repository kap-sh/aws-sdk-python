"""Generated from Smithy shape ``com.amazonaws.codestarnotifications#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarnotifications#AccessDeniedException``."""
