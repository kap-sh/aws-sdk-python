"""Generated from Smithy shape ``com.amazonaws.codestarnotifications#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarnotifications#LimitExceededException``."""
