...
from ._services.async_codestarnotifications import (
    AsynccodestarnotificationsClient as AsynccodestarnotificationsClient,
)
from ._services.codestarnotifications import (
    codestarnotificationsClient as codestarnotificationsClient,
)
