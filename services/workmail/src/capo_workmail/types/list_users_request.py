...
class ListUsersRequest(TypedDict, closed=True):
    ...
    filters: NotRequired["capo_workmail.types.list_users_filters.ListUsersFilters"]
...
def serialize_aws_json_1_1(value: ListUsersRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = capo_workmail.types.list_users_filters.serialize_aws_json_1_1(
            value["filters"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListUsersRequest:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            capo_workmail.types.list_users_filters.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
    return out
