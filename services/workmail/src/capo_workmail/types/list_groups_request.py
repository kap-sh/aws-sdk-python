...
class ListGroupsRequest(TypedDict, closed=True):
    ...
    filters: NotRequired["capo_workmail.types.list_groups_filters.ListGroupsFilters"]
...
def serialize_aws_json_1_1(value: ListGroupsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = capo_workmail.types.list_groups_filters.serialize_aws_json_1_1(
            value["filters"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListGroupsRequest:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            capo_workmail.types.list_groups_filters.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
    return out
