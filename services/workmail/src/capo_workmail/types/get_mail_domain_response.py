...
class GetMailDomainResponse(TypedDict, closed=True):
    records: NotRequired["capo_workmail.types.dns_records.DnsRecords"]
...
def serialize_aws_json_1_1(value: GetMailDomainResponse) -> dict:
    ...
    if "records" in value:
        ...
        out["Records"] = capo_workmail.types.dns_records.serialize_aws_json_1_1(
            value["records"]
        )
    ...
    if "ownership_verification_status" in value:
        ...
        out["OwnershipVerificationStatus"] = (
            capo_workmail.types.dns_record_verification_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetMailDomainResponse:
    ...
    if "OwnershipVerificationStatus" in data:
        ...
        out["ownership_verification_status"] = (
            capo_workmail.types.dns_record_verification_status.deserialize_aws_json_1_1(
