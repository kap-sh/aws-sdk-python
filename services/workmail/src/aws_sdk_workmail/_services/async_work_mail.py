...
from aws_sdk_workmail._services._aws_config import aaws_config
...
class AsyncWorkMailClientConfig(TypedDict, total=False):
...
class AsyncWorkMailClient:
    ...
    async def associate_delegate_to_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.associate_delegate_to_resource_request.AssociateDelegateToResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.associate_delegate_to_resource_response.AssociateDelegateToResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.associate_delegate_to_resource.async_associate_delegate_to_resource(
    ...
    async def associate_member_to_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.associate_member_to_group_request.AssociateMemberToGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.associate_member_to_group_response.AssociateMemberToGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.associate_member_to_group.async_associate_member_to_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def assume_impersonation_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.assume_impersonation_role_request.AssumeImpersonationRoleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.assume_impersonation_role_response.AssumeImpersonationRoleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.assume_impersonation_role.async_assume_impersonation_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_mailbox_export_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.cancel_mailbox_export_job_request.CancelMailboxExportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.cancel_mailbox_export_job_response.CancelMailboxExportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.cancel_mailbox_export_job.async_cancel_mailbox_export_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.create_alias_request.CreateAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.create_alias_response.CreateAliasResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.create_alias.async_create_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_availability_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.create_availability_configuration_request.CreateAvailabilityConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.create_availability_configuration_response.CreateAvailabilityConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.create_availability_configuration.async_create_availability_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.create_group_request.CreateGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.create_group_response.CreateGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.create_group.async_create_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_identity_center_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.create_identity_center_application_request.CreateIdentityCenterApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.create_identity_center_application_response.CreateIdentityCenterApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.create_identity_center_application.async_create_identity_center_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_impersonation_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.create_impersonation_role_request.CreateImpersonationRoleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.create_impersonation_role_response.CreateImpersonationRoleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.create_impersonation_role.async_create_impersonation_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_mobile_device_access_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.create_mobile_device_access_rule_request.CreateMobileDeviceAccessRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.create_mobile_device_access_rule_response.CreateMobileDeviceAccessRuleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.create_mobile_device_access_rule.async_create_mobile_device_access_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.create_organization_request.CreateOrganizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.create_organization_response.CreateOrganizationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.create_organization.async_create_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.create_resource_request.CreateResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.create_resource_response.CreateResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.create_resource.async_create_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.create_user_request.CreateUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.create_user_response.CreateUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.create_user.async_create_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_access_control_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_access_control_rule_request.DeleteAccessControlRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_access_control_rule_response.DeleteAccessControlRuleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_access_control_rule.async_delete_access_control_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_alias_request.DeleteAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_alias_response.DeleteAliasResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_alias.async_delete_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_availability_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_availability_configuration_request.DeleteAvailabilityConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_availability_configuration_response.DeleteAvailabilityConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_availability_configuration.async_delete_availability_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_email_monitoring_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_email_monitoring_configuration_request.DeleteEmailMonitoringConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_email_monitoring_configuration_response.DeleteEmailMonitoringConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_email_monitoring_configuration.async_delete_email_monitoring_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_group_request.DeleteGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_group_response.DeleteGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_group.async_delete_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_identity_center_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_identity_center_application_request.DeleteIdentityCenterApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_identity_center_application_response.DeleteIdentityCenterApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_identity_center_application.async_delete_identity_center_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_identity_provider_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_identity_provider_configuration_request.DeleteIdentityProviderConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_identity_provider_configuration_response.DeleteIdentityProviderConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_identity_provider_configuration.async_delete_identity_provider_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_impersonation_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_impersonation_role_request.DeleteImpersonationRoleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_impersonation_role_response.DeleteImpersonationRoleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_impersonation_role.async_delete_impersonation_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_mailbox_permissions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_mailbox_permissions_request.DeleteMailboxPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_mailbox_permissions_response.DeleteMailboxPermissionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_mailbox_permissions.async_delete_mailbox_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_mobile_device_access_override(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_mobile_device_access_override_request.DeleteMobileDeviceAccessOverrideRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_mobile_device_access_override_response.DeleteMobileDeviceAccessOverrideResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_mobile_device_access_override.async_delete_mobile_device_access_override(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_mobile_device_access_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_mobile_device_access_rule_request.DeleteMobileDeviceAccessRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_mobile_device_access_rule_response.DeleteMobileDeviceAccessRuleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_mobile_device_access_rule.async_delete_mobile_device_access_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_organization_request.DeleteOrganizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_organization_response.DeleteOrganizationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_organization.async_delete_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_personal_access_token(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_personal_access_token_request.DeletePersonalAccessTokenRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_personal_access_token_response.DeletePersonalAccessTokenResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_personal_access_token.async_delete_personal_access_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_resource_request.DeleteResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_resource_response.DeleteResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_resource.async_delete_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_retention_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_retention_policy_request.DeleteRetentionPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_retention_policy_response.DeleteRetentionPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_retention_policy.async_delete_retention_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.delete_user_request.DeleteUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.delete_user_response.DeleteUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.delete_user.async_delete_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_from_work_mail(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.deregister_from_work_mail_request.DeregisterFromWorkMailRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.deregister_from_work_mail_response.DeregisterFromWorkMailResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.deregister_from_work_mail.async_deregister_from_work_mail(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_mail_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.deregister_mail_domain_request.DeregisterMailDomainRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.deregister_mail_domain_response.DeregisterMailDomainResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.deregister_mail_domain.async_deregister_mail_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_email_monitoring_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.describe_email_monitoring_configuration_request.DescribeEmailMonitoringConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.describe_email_monitoring_configuration_response.DescribeEmailMonitoringConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.describe_email_monitoring_configuration.async_describe_email_monitoring_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_entity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.describe_entity_request.DescribeEntityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.describe_entity_response.DescribeEntityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.describe_entity.async_describe_entity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.describe_group_request.DescribeGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.describe_group_response.DescribeGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.describe_group.async_describe_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_identity_provider_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.describe_identity_provider_configuration_request.DescribeIdentityProviderConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.describe_identity_provider_configuration_response.DescribeIdentityProviderConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.describe_identity_provider_configuration.async_describe_identity_provider_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_inbound_dmarc_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.describe_inbound_dmarc_settings_request.DescribeInboundDmarcSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.describe_inbound_dmarc_settings_response.DescribeInboundDmarcSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.describe_inbound_dmarc_settings.async_describe_inbound_dmarc_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_mailbox_export_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.describe_mailbox_export_job_request.DescribeMailboxExportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.describe_mailbox_export_job_response.DescribeMailboxExportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.describe_mailbox_export_job.async_describe_mailbox_export_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.describe_organization_request.DescribeOrganizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.describe_organization_response.DescribeOrganizationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.describe_organization.async_describe_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.describe_resource_request.DescribeResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.describe_resource_response.DescribeResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.describe_resource.async_describe_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.describe_user_request.DescribeUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.describe_user_response.DescribeUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.describe_user.async_describe_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_delegate_from_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.disassociate_delegate_from_resource_request.DisassociateDelegateFromResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.disassociate_delegate_from_resource_response.DisassociateDelegateFromResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.disassociate_delegate_from_resource.async_disassociate_delegate_from_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_member_from_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.disassociate_member_from_group_request.DisassociateMemberFromGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.disassociate_member_from_group_response.DisassociateMemberFromGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.disassociate_member_from_group.async_disassociate_member_from_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_access_control_effect(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.get_access_control_effect_request.GetAccessControlEffectRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.get_access_control_effect_response.GetAccessControlEffectResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.get_access_control_effect.async_get_access_control_effect(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_default_retention_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.get_default_retention_policy_request.GetDefaultRetentionPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.get_default_retention_policy_response.GetDefaultRetentionPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.get_default_retention_policy.async_get_default_retention_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_impersonation_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.get_impersonation_role_request.GetImpersonationRoleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.get_impersonation_role_response.GetImpersonationRoleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.get_impersonation_role.async_get_impersonation_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_impersonation_role_effect(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.get_impersonation_role_effect_request.GetImpersonationRoleEffectRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.get_impersonation_role_effect_response.GetImpersonationRoleEffectResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.get_impersonation_role_effect.async_get_impersonation_role_effect(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_mailbox_details(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.get_mailbox_details_request.GetMailboxDetailsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.get_mailbox_details_response.GetMailboxDetailsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.get_mailbox_details.async_get_mailbox_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_mail_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.get_mail_domain_request.GetMailDomainRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.get_mail_domain_response.GetMailDomainResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.get_mail_domain.async_get_mail_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_mobile_device_access_effect(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.get_mobile_device_access_effect_request.GetMobileDeviceAccessEffectRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.get_mobile_device_access_effect_response.GetMobileDeviceAccessEffectResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.get_mobile_device_access_effect.async_get_mobile_device_access_effect(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_mobile_device_access_override(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.get_mobile_device_access_override_request.GetMobileDeviceAccessOverrideRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.get_mobile_device_access_override_response.GetMobileDeviceAccessOverrideResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.get_mobile_device_access_override.async_get_mobile_device_access_override(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_personal_access_token_metadata(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.get_personal_access_token_metadata_request.GetPersonalAccessTokenMetadataRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.get_personal_access_token_metadata_response.GetPersonalAccessTokenMetadataResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.get_personal_access_token_metadata.async_get_personal_access_token_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_access_control_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_access_control_rules_request.ListAccessControlRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_access_control_rules_response.ListAccessControlRulesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_access_control_rules.async_list_access_control_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_aliases(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_aliases_request.ListAliasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_aliases_response.ListAliasesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_aliases.async_list_aliases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_availability_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_availability_configurations_request.ListAvailabilityConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_availability_configurations_response.ListAvailabilityConfigurationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_availability_configurations.async_list_availability_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_availability_configurations(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_workmail.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_workmail.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_workmail.types.availability_configuration.AvailabilityConfiguration]":
        _token = next_token
        while True:
    ...
    async def list_group_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_group_members_request.ListGroupMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_group_members_response.ListGroupMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_group_members.async_list_group_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_groups_request.ListGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_groups_response.ListGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_groups.async_list_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_groups_for_entity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_groups_for_entity_request.ListGroupsForEntityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_groups_for_entity_response.ListGroupsForEntityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_groups_for_entity.async_list_groups_for_entity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_impersonation_roles(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_impersonation_roles_request.ListImpersonationRolesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_impersonation_roles_response.ListImpersonationRolesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_impersonation_roles.async_list_impersonation_roles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_mailbox_export_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_mailbox_export_jobs_request.ListMailboxExportJobsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_mailbox_export_jobs_response.ListMailboxExportJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_mailbox_export_jobs.async_list_mailbox_export_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_mailbox_permissions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_mailbox_permissions_request.ListMailboxPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_mailbox_permissions_response.ListMailboxPermissionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_mailbox_permissions.async_list_mailbox_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_mail_domains(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_mail_domains_request.ListMailDomainsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_mail_domains_response.ListMailDomainsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_mail_domains.async_list_mail_domains(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_mobile_device_access_overrides(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_mobile_device_access_overrides_request.ListMobileDeviceAccessOverridesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_mobile_device_access_overrides_response.ListMobileDeviceAccessOverridesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_mobile_device_access_overrides.async_list_mobile_device_access_overrides(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_mobile_device_access_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_mobile_device_access_rules_request.ListMobileDeviceAccessRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_mobile_device_access_rules_response.ListMobileDeviceAccessRulesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_mobile_device_access_rules.async_list_mobile_device_access_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_organizations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_organizations_request.ListOrganizationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_organizations_response.ListOrganizationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_organizations.async_list_organizations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_personal_access_tokens(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_personal_access_tokens_request.ListPersonalAccessTokensRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_personal_access_tokens_response.ListPersonalAccessTokensResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_personal_access_tokens.async_list_personal_access_tokens(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_personal_access_tokens(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_workmail.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_workmail.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_workmail.types.personal_access_token_summary.PersonalAccessTokenSummary]":
        _token = next_token
        while True:
    ...
    async def list_resource_delegates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_resource_delegates_request.ListResourceDelegatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_resource_delegates_response.ListResourceDelegatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_resource_delegates.async_list_resource_delegates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_resources_request.ListResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_resources_response.ListResourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_resources.async_list_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_users(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.list_users_request.ListUsersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.list_users_response.ListUsersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.list_users.async_list_users(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_access_control_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.put_access_control_rule_request.PutAccessControlRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.put_access_control_rule_response.PutAccessControlRuleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.put_access_control_rule.async_put_access_control_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_email_monitoring_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.put_email_monitoring_configuration_request.PutEmailMonitoringConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.put_email_monitoring_configuration_response.PutEmailMonitoringConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.put_email_monitoring_configuration.async_put_email_monitoring_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_identity_provider_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.put_identity_provider_configuration_request.PutIdentityProviderConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.put_identity_provider_configuration_response.PutIdentityProviderConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.put_identity_provider_configuration.async_put_identity_provider_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_inbound_dmarc_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.put_inbound_dmarc_settings_request.PutInboundDmarcSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.put_inbound_dmarc_settings_response.PutInboundDmarcSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.put_inbound_dmarc_settings.async_put_inbound_dmarc_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_mailbox_permissions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.put_mailbox_permissions_request.PutMailboxPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.put_mailbox_permissions_response.PutMailboxPermissionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.put_mailbox_permissions.async_put_mailbox_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_mobile_device_access_override(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.put_mobile_device_access_override_request.PutMobileDeviceAccessOverrideRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.put_mobile_device_access_override_response.PutMobileDeviceAccessOverrideResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.put_mobile_device_access_override.async_put_mobile_device_access_override(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_retention_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.put_retention_policy_request.PutRetentionPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.put_retention_policy_response.PutRetentionPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.put_retention_policy.async_put_retention_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_mail_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.register_mail_domain_request.RegisterMailDomainRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.register_mail_domain_response.RegisterMailDomainResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.register_mail_domain.async_register_mail_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_to_work_mail(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.register_to_work_mail_request.RegisterToWorkMailRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.register_to_work_mail_response.RegisterToWorkMailResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.register_to_work_mail.async_register_to_work_mail(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reset_password(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.reset_password_request.ResetPasswordRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.reset_password_response.ResetPasswordResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.reset_password.async_reset_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_mailbox_export_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.start_mailbox_export_job_request.StartMailboxExportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.start_mailbox_export_job_response.StartMailboxExportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.start_mailbox_export_job.async_start_mailbox_export_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_availability_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.test_availability_configuration_request.TestAvailabilityConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.test_availability_configuration_response.TestAvailabilityConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.test_availability_configuration.async_test_availability_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_availability_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.update_availability_configuration_request.UpdateAvailabilityConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.update_availability_configuration_response.UpdateAvailabilityConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.update_availability_configuration.async_update_availability_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_default_mail_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.update_default_mail_domain_request.UpdateDefaultMailDomainRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.update_default_mail_domain_response.UpdateDefaultMailDomainResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.update_default_mail_domain.async_update_default_mail_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.update_group_request.UpdateGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.update_group_response.UpdateGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.update_group.async_update_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_impersonation_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.update_impersonation_role_request.UpdateImpersonationRoleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.update_impersonation_role_response.UpdateImpersonationRoleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.update_impersonation_role.async_update_impersonation_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_mailbox_quota(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.update_mailbox_quota_request.UpdateMailboxQuotaRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.update_mailbox_quota_response.UpdateMailboxQuotaResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.update_mailbox_quota.async_update_mailbox_quota(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_mobile_device_access_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.update_mobile_device_access_rule_request.UpdateMobileDeviceAccessRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.update_mobile_device_access_rule_response.UpdateMobileDeviceAccessRuleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.update_mobile_device_access_rule.async_update_mobile_device_access_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_primary_email_address(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.update_primary_email_address_request.UpdatePrimaryEmailAddressRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.update_primary_email_address_response.UpdatePrimaryEmailAddressResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.update_primary_email_address.async_update_primary_email_address(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.update_resource_request.UpdateResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.update_resource_response.UpdateResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.update_resource.async_update_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workmail.types.update_user_request.UpdateUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workmail.types.update_user_response.UpdateUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workmail._operations.work_mail_service.update_user.async_update_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
