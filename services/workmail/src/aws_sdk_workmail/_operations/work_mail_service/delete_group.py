"""Generated from Smithy shape ``com.amazonaws.workmail#DeleteGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.delete_group_response.DeleteGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.delete_group_request.DeleteGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_group(
    ...
    aws_sdk_workmail.types.delete_group_response.DeleteGroupResponse, zapros.Response
]:
