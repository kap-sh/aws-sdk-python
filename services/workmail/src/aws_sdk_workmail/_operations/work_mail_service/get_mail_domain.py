...
def handle_response(
    ...
    out: aws_sdk_workmail.types.get_mail_domain_response.GetMailDomainResponse = (
        aws_sdk_workmail.types.get_mail_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.get_mail_domain_request.GetMailDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.get_mail_domain_request.serialize_aws_json_1_1(input_)
    ).encode()
