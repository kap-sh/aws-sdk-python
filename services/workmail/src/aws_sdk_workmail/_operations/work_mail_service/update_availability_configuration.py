...
def handle_response(
    ...
    out: aws_sdk_workmail.types.update_availability_configuration_response.UpdateAvailabilityConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.update_availability_configuration_request.UpdateAvailabilityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.update_availability_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
