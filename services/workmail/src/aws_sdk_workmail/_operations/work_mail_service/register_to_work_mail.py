...
import aws_sdk_workmail.errors.entity_already_registered_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EntityAlreadyRegisteredException":
            raise aws_sdk_workmail.errors.entity_already_registered_exception.EntityAlreadyRegisteredException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.register_to_work_mail_response.RegisterToWorkMailResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.register_to_work_mail_request.RegisterToWorkMailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
