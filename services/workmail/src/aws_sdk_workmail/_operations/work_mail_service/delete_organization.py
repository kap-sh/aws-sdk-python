...
def handle_response(
    ...
    out: aws_sdk_workmail.types.delete_organization_response.DeleteOrganizationResponse = aws_sdk_workmail.types.delete_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_workmail.types.delete_organization_request.DeleteOrganizationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_organization_request.serialize_aws_json_1_1(input)
    ).encode()
