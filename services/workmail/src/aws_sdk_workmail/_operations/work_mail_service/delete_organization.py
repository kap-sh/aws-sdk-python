...
def build_request(
    ...
    input_: aws_sdk_workmail.types.delete_organization_request.DeleteOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_organization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
