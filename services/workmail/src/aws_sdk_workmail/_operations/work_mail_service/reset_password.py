...
def handle_response(
    ...
    out: aws_sdk_workmail.types.reset_password_response.ResetPasswordResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.reset_password_request.ResetPasswordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.reset_password_request.serialize_aws_json_1_1(input_)
    ).encode()
