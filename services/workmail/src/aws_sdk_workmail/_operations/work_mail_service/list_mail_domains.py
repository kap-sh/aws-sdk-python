...
def build_request(
    ...
    input: aws_sdk_workmail.types.list_mail_domains_request.ListMailDomainsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_mail_domains_request.serialize_aws_json_1_1(input)
    ).encode()
