...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_mail_domains_response.ListMailDomainsResponse = (
        aws_sdk_workmail.types.list_mail_domains_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_mail_domains_request.ListMailDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_mail_domains_request.serialize_aws_json_1_1(input_)
    ).encode()
