...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_groups_for_entity_response.ListGroupsForEntityResponse = aws_sdk_workmail.types.list_groups_for_entity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_groups_for_entity_request.ListGroupsForEntityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_groups_for_entity_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
