...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MailDomainInUseException":
            import aws_sdk_workmail.errors.mail_domain_in_use_exception

            raise aws_sdk_workmail.errors.mail_domain_in_use_exception.MailDomainInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.register_mail_domain_response.RegisterMailDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.register_mail_domain_request.RegisterMailDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.register_mail_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
