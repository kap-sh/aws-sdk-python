...
def handle_response(
    ...
    out: aws_sdk_workmail.types.describe_group_response.DescribeGroupResponse = (
        aws_sdk_workmail.types.describe_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.describe_group_request.DescribeGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.describe_group_request.serialize_aws_json_1_1(input_)
    ).encode()
