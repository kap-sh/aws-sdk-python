...
def handle_response(
    ...
    out: aws_sdk_workmail.types.describe_inbound_dmarc_settings_response.DescribeInboundDmarcSettingsResponse = aws_sdk_workmail.types.describe_inbound_dmarc_settings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.describe_inbound_dmarc_settings_request.DescribeInboundDmarcSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.describe_inbound_dmarc_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
