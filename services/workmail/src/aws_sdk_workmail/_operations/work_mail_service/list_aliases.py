...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_aliases_response.ListAliasesResponse = (
        aws_sdk_workmail.types.list_aliases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_aliases_request.ListAliasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_aliases_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_aliases(
    ...
    aws_sdk_workmail.types.list_aliases_response.ListAliasesResponse, zapros.Response
]:
