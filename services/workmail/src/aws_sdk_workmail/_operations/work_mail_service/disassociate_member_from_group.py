"""Generated from Smithy shape ``com.amazonaws.workmail#DisassociateMemberFromGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.disassociate_member_from_group_response.DisassociateMemberFromGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.disassociate_member_from_group_request.DisassociateMemberFromGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.disassociate_member_from_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_member_from_group(
