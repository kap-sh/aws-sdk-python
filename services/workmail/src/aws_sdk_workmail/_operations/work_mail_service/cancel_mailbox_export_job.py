...
def handle_response(
    ...
    out: aws_sdk_workmail.types.cancel_mailbox_export_job_response.CancelMailboxExportJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.cancel_mailbox_export_job_request.CancelMailboxExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.cancel_mailbox_export_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
