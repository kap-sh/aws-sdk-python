...
def handle_response(
    ...
    out: aws_sdk_workmail.types.get_mobile_device_access_effect_response.GetMobileDeviceAccessEffectResponse = aws_sdk_workmail.types.get_mobile_device_access_effect_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.get_mobile_device_access_effect_request.GetMobileDeviceAccessEffectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.get_mobile_device_access_effect_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
