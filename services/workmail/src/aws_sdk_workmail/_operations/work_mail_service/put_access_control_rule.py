...
def handle_response(
    ...
    out: aws_sdk_workmail.types.put_access_control_rule_response.PutAccessControlRuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.put_access_control_rule_request.PutAccessControlRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.put_access_control_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
