"""Generated from Smithy shape ``com.amazonaws.workmail#ListResources``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_resources_response.ListResourcesResponse = (
        aws_sdk_workmail.types.list_resources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_resources_request.ListResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_resources_request.serialize_aws_json_1_1(input_)
    ).encode()
