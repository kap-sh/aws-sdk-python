"""Generated from Smithy shape ``com.amazonaws.workmail#CreateOrganization``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DirectoryInUseException":
            import aws_sdk_workmail.errors.directory_in_use_exception

            raise aws_sdk_workmail.errors.directory_in_use_exception.DirectoryInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.create_organization_response.CreateOrganizationResponse = aws_sdk_workmail.types.create_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_workmail.types.create_organization_request.CreateOrganizationRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "WorkMailService.CreateOrganization"
    import aws_sdk_workmail.types.create_organization_request

    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.create_organization_request.serialize_aws_json_1_1(input)
    ).encode()
