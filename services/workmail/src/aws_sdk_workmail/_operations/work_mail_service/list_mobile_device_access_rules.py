"""Generated from Smithy shape ``com.amazonaws.workmail#ListMobileDeviceAccessRules``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_mobile_device_access_rules_response.ListMobileDeviceAccessRulesResponse = aws_sdk_workmail.types.list_mobile_device_access_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_mobile_device_access_rules_request.ListMobileDeviceAccessRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_mobile_device_access_rules(
