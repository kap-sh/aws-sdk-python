"""Generated from Smithy shape ``com.amazonaws.workmail#ListResourceDelegates``."""
...
import aws_sdk_workmail.types.resource_delegates
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_resource_delegates_response.ListResourceDelegatesResponse = aws_sdk_workmail.types.list_resource_delegates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_resource_delegates_request.ListResourceDelegatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_resource_delegates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resource_delegates(
