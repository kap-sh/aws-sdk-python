...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_personal_access_tokens_response.ListPersonalAccessTokensResponse = aws_sdk_workmail.types.list_personal_access_tokens_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_personal_access_tokens_request.ListPersonalAccessTokensRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_personal_access_tokens_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
