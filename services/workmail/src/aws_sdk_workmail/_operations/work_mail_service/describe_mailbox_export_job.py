...
def handle_response(
    ...
    out: aws_sdk_workmail.types.describe_mailbox_export_job_response.DescribeMailboxExportJobResponse = aws_sdk_workmail.types.describe_mailbox_export_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.describe_mailbox_export_job_request.DescribeMailboxExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.describe_mailbox_export_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
