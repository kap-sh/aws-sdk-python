...
def handle_response(
    ...
    out: aws_sdk_workmail.types.associate_member_to_group_response.AssociateMemberToGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.associate_member_to_group_request.AssociateMemberToGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.associate_member_to_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
