"""Generated from Smithy shape ``com.amazonaws.workmail#DeleteImpersonationRole``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.delete_impersonation_role_response.DeleteImpersonationRoleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.delete_impersonation_role_request.DeleteImpersonationRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkMailService.DeleteImpersonationRole"
    import aws_sdk_workmail.types.delete_impersonation_role_request

    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_impersonation_role_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_impersonation_role(
