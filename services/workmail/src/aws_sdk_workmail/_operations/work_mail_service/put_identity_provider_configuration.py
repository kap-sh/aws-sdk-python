"""Generated from Smithy shape ``com.amazonaws.workmail#PutIdentityProviderConfiguration``."""
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.put_identity_provider_configuration_request.PutIdentityProviderConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkMailService.PutIdentityProviderConfiguration"
    import aws_sdk_workmail.types.put_identity_provider_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.put_identity_provider_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_identity_provider_configuration(
