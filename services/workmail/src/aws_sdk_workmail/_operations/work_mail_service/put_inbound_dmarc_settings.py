...
def handle_response(
    ...
    out: aws_sdk_workmail.types.put_inbound_dmarc_settings_response.PutInboundDmarcSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.put_inbound_dmarc_settings_request.PutInboundDmarcSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.put_inbound_dmarc_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
