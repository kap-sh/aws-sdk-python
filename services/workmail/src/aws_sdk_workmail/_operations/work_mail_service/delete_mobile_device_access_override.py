...
def handle_response(
    ...
    out: aws_sdk_workmail.types.delete_mobile_device_access_override_response.DeleteMobileDeviceAccessOverrideResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.delete_mobile_device_access_override_request.DeleteMobileDeviceAccessOverrideRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_mobile_device_access_override_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
