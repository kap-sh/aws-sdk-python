...
def handle_response(
    ...
    out: aws_sdk_workmail.types.describe_organization_response.DescribeOrganizationResponse = aws_sdk_workmail.types.describe_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.describe_organization_request.DescribeOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.describe_organization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
