...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_mobile_device_access_overrides_response.ListMobileDeviceAccessOverridesResponse = aws_sdk_workmail.types.list_mobile_device_access_overrides_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_mobile_device_access_overrides_request.ListMobileDeviceAccessOverridesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_mobile_device_access_overrides_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
