...
def handle_response(
    ...
    out: aws_sdk_workmail.types.create_mobile_device_access_rule_response.CreateMobileDeviceAccessRuleResponse = aws_sdk_workmail.types.create_mobile_device_access_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.create_mobile_device_access_rule_request.CreateMobileDeviceAccessRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.create_mobile_device_access_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
