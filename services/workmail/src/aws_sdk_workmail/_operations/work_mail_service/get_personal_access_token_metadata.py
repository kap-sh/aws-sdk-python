...
def handle_response(
    ...
    out: aws_sdk_workmail.types.get_personal_access_token_metadata_response.GetPersonalAccessTokenMetadataResponse = aws_sdk_workmail.types.get_personal_access_token_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.get_personal_access_token_metadata_request.GetPersonalAccessTokenMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.get_personal_access_token_metadata_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
