"""Generated from Smithy shape ``com.amazonaws.workmail#UpdateMailboxQuota``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.update_mailbox_quota_response.UpdateMailboxQuotaResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.update_mailbox_quota_request.UpdateMailboxQuotaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.update_mailbox_quota_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_mailbox_quota(
