"""Generated from Smithy shape ``com.amazonaws.workmail#CreateGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.create_group_response.CreateGroupResponse = (
        aws_sdk_workmail.types.create_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.create_group_request.CreateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.create_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_group(
    ...
    aws_sdk_workmail.types.create_group_response.CreateGroupResponse, zapros.Response
]:
