...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidConfigurationException":
            import aws_sdk_workmail.errors.invalid_configuration_exception

            raise aws_sdk_workmail.errors.invalid_configuration_exception.InvalidConfigurationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.update_resource_response.UpdateResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.update_resource_request.UpdateResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.update_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
