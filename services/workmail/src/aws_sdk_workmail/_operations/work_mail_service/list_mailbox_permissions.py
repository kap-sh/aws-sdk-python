...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_mailbox_permissions_response.ListMailboxPermissionsResponse = aws_sdk_workmail.types.list_mailbox_permissions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_mailbox_permissions_request.ListMailboxPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_mailbox_permissions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
