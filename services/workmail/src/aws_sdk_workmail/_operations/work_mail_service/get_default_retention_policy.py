...
def handle_response(
    ...
    out: aws_sdk_workmail.types.get_default_retention_policy_response.GetDefaultRetentionPolicyResponse = aws_sdk_workmail.types.get_default_retention_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.get_default_retention_policy_request.GetDefaultRetentionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.get_default_retention_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
