"""Generated from Smithy shape ``com.amazonaws.workmail#GetAccessControlEffect``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.get_access_control_effect_response.GetAccessControlEffectResponse = aws_sdk_workmail.types.get_access_control_effect_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.get_access_control_effect_request.GetAccessControlEffectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkMailService.GetAccessControlEffect"
    import aws_sdk_workmail.types.get_access_control_effect_request

    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.get_access_control_effect_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_access_control_effect(
