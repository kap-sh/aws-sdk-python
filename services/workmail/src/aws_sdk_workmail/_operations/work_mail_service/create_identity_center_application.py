...
def handle_response(
    ...
    out: aws_sdk_workmail.types.create_identity_center_application_response.CreateIdentityCenterApplicationResponse = aws_sdk_workmail.types.create_identity_center_application_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.create_identity_center_application_request.CreateIdentityCenterApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.create_identity_center_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
