...
import aws_sdk_workmail.errors.invalid_custom_ses_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidCustomSesConfigurationException":
            raise aws_sdk_workmail.errors.invalid_custom_ses_configuration_exception.InvalidCustomSesConfigurationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.deregister_mail_domain_response.DeregisterMailDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.deregister_mail_domain_request.DeregisterMailDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.deregister_mail_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
