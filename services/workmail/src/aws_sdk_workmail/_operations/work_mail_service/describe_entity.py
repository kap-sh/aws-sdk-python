...
import aws_sdk_workmail.types.entity_type
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.describe_entity_response.DescribeEntityResponse = (
        aws_sdk_workmail.types.describe_entity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.describe_entity_request.DescribeEntityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.describe_entity_request.serialize_aws_json_1_1(input_)
    ).encode()
