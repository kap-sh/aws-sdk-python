...
def handle_response(
    ...
    out: aws_sdk_workmail.types.describe_user_response.DescribeUserResponse = (
        aws_sdk_workmail.types.describe_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.describe_user_request.DescribeUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.describe_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_user(
    ...
    aws_sdk_workmail.types.describe_user_response.DescribeUserResponse, zapros.Response
]:
