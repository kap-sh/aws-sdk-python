...
def build_request(
    ...
    input_: aws_sdk_workmail.types.create_user_request.CreateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.create_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_user(
    ...
    aws_sdk_workmail.types.create_user_response.CreateUserResponse, zapros.Response
]:
