...
def handle_response(
    ...
    out: aws_sdk_workmail.types.delete_availability_configuration_response.DeleteAvailabilityConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.delete_availability_configuration_request.DeleteAvailabilityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_availability_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
