"""Generated from Smithy shape ``com.amazonaws.workmail#UpdateMobileDeviceAccessRule``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.update_mobile_device_access_rule_response.UpdateMobileDeviceAccessRuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.update_mobile_device_access_rule_request.UpdateMobileDeviceAccessRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkMailService.UpdateMobileDeviceAccessRule"
    import aws_sdk_workmail.types.update_mobile_device_access_rule_request

    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.update_mobile_device_access_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_mobile_device_access_rule(
