...
def handle_response(
    ...
    out: aws_sdk_workmail.types.start_mailbox_export_job_response.StartMailboxExportJobResponse = aws_sdk_workmail.types.start_mailbox_export_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.start_mailbox_export_job_request.StartMailboxExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.start_mailbox_export_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
