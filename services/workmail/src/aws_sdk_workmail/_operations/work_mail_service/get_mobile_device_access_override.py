...
def handle_response(
    ...
    out: aws_sdk_workmail.types.get_mobile_device_access_override_response.GetMobileDeviceAccessOverrideResponse = aws_sdk_workmail.types.get_mobile_device_access_override_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.get_mobile_device_access_override_request.GetMobileDeviceAccessOverrideRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.get_mobile_device_access_override_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
