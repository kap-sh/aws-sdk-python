"""Generated from Smithy shape ``com.amazonaws.workmail#DeleteAccessControlRule``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.delete_access_control_rule_response.DeleteAccessControlRuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.delete_access_control_rule_request.DeleteAccessControlRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkMailService.DeleteAccessControlRule"
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_access_control_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_access_control_rule(
