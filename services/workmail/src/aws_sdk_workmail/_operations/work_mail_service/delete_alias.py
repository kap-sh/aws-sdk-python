...
def handle_response(
    ...
    out: aws_sdk_workmail.types.delete_alias_response.DeleteAliasResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.delete_alias_request.DeleteAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_alias_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_alias(
    ...
    aws_sdk_workmail.types.delete_alias_response.DeleteAliasResponse, zapros.Response
]:
