...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_mailbox_export_jobs_response.ListMailboxExportJobsResponse = aws_sdk_workmail.types.list_mailbox_export_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_mailbox_export_jobs_request.ListMailboxExportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_mailbox_export_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
