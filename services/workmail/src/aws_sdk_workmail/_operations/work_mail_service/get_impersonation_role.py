...
def handle_response(
    ...
    out: aws_sdk_workmail.types.get_impersonation_role_response.GetImpersonationRoleResponse = aws_sdk_workmail.types.get_impersonation_role_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.get_impersonation_role_request.GetImpersonationRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.get_impersonation_role_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
