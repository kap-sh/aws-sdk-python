...
def handle_response(
    ...
    out: aws_sdk_workmail.types.assume_impersonation_role_response.AssumeImpersonationRoleResponse = aws_sdk_workmail.types.assume_impersonation_role_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.assume_impersonation_role_request.AssumeImpersonationRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.assume_impersonation_role_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
