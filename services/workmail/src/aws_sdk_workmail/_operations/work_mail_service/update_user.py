...
def handle_response(
    ...
    out: aws_sdk_workmail.types.update_user_response.UpdateUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.update_user_request.UpdateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.update_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_user(
    ...
    aws_sdk_workmail.types.update_user_response.UpdateUserResponse, zapros.Response
]:
