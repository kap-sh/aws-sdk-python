...
def handle_response(
    ...
    out: aws_sdk_workmail.types.test_availability_configuration_response.TestAvailabilityConfigurationResponse = aws_sdk_workmail.types.test_availability_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.test_availability_configuration_request.TestAvailabilityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.test_availability_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
