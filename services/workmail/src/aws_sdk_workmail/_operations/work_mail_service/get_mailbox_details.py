...
def handle_response(
    ...
    out: aws_sdk_workmail.types.get_mailbox_details_response.GetMailboxDetailsResponse = aws_sdk_workmail.types.get_mailbox_details_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_workmail.types.get_mailbox_details_request.GetMailboxDetailsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.get_mailbox_details_request.serialize_aws_json_1_1(input)
    ).encode()
