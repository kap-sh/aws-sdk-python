...
def build_request(
    ...
    input_: aws_sdk_workmail.types.get_mailbox_details_request.GetMailboxDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.get_mailbox_details_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
