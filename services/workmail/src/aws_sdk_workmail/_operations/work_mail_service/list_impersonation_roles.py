...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_impersonation_roles_response.ListImpersonationRolesResponse = aws_sdk_workmail.types.list_impersonation_roles_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_impersonation_roles_request.ListImpersonationRolesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_impersonation_roles_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
