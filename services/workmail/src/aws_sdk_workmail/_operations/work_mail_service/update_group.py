...
def handle_response(
    ...
    out: aws_sdk_workmail.types.update_group_response.UpdateGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.update_group_request.UpdateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.update_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_group(
    ...
    aws_sdk_workmail.types.update_group_response.UpdateGroupResponse, zapros.Response
]:
