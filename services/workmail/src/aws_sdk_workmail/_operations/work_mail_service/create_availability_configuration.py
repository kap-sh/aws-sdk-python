"""Generated from Smithy shape ``com.amazonaws.workmail#CreateAvailabilityConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.create_availability_configuration_response.CreateAvailabilityConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.create_availability_configuration_request.CreateAvailabilityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkMailService.CreateAvailabilityConfiguration"
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.create_availability_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_availability_configuration(
