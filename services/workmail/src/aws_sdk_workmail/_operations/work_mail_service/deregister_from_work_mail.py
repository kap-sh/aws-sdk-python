"""Generated from Smithy shape ``com.amazonaws.workmail#DeregisterFromWorkMail``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.deregister_from_work_mail_response.DeregisterFromWorkMailResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.deregister_from_work_mail_request.DeregisterFromWorkMailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.deregister_from_work_mail_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deregister_from_work_mail(
