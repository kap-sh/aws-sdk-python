"""Generated from Smithy shape ``com.amazonaws.workmail#ListGroupMembers``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.list_group_members_response.ListGroupMembersResponse = (
        aws_sdk_workmail.types.list_group_members_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.list_group_members_request.ListGroupMembersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.list_group_members_request.serialize_aws_json_1_1(input_)
    ).encode()
