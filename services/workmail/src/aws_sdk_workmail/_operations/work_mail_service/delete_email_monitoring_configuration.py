...
def handle_response(
    ...
    out: aws_sdk_workmail.types.delete_email_monitoring_configuration_response.DeleteEmailMonitoringConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.delete_email_monitoring_configuration_request.DeleteEmailMonitoringConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_email_monitoring_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
