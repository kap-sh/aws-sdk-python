...
def handle_response(
    ...
    out: aws_sdk_workmail.types.delete_personal_access_token_response.DeletePersonalAccessTokenResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.delete_personal_access_token_request.DeletePersonalAccessTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_personal_access_token_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
