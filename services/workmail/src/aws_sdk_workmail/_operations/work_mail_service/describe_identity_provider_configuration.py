...
def handle_response(
    ...
    out: aws_sdk_workmail.types.describe_identity_provider_configuration_response.DescribeIdentityProviderConfigurationResponse = aws_sdk_workmail.types.describe_identity_provider_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.describe_identity_provider_configuration_request.DescribeIdentityProviderConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.describe_identity_provider_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
