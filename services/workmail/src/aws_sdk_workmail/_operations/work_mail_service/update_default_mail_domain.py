"""Generated from Smithy shape ``com.amazonaws.workmail#UpdateDefaultMailDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.update_default_mail_domain_response.UpdateDefaultMailDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.update_default_mail_domain_request.UpdateDefaultMailDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkMailService.UpdateDefaultMailDomain"
    import aws_sdk_workmail.types.update_default_mail_domain_request

    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.update_default_mail_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_default_mail_domain(
