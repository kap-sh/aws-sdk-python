"""Generated from Smithy shape ``com.amazonaws.workmail#DeleteMobileDeviceAccessRule``."""
...
def handle_response(
    ...
    out: aws_sdk_workmail.types.delete_mobile_device_access_rule_response.DeleteMobileDeviceAccessRuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workmail.types.delete_mobile_device_access_rule_request.DeleteMobileDeviceAccessRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkMailService.DeleteMobileDeviceAccessRule"
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.delete_mobile_device_access_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_mobile_device_access_rule(
