...
def build_request(
    ...
    input: aws_sdk_workmail.types.describe_resource_request.DescribeResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workmail.types.describe_resource_request.serialize_aws_json_1_1(input)
    ).encode()
