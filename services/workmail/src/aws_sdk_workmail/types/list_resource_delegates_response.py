...
class ListResourceDelegatesResponse(TypedDict):
    delegates: NotRequired[
        "aws_sdk_workmail.types.resource_delegates.ResourceDelegates"
    ]
...
def serialize_aws_json_1_1(value: ListResourceDelegatesResponse) -> dict:
    ...
    if "delegates" in value:
        ...
        out["Delegates"] = (
            aws_sdk_workmail.types.resource_delegates.serialize_aws_json_1_1(
                value["delegates"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListResourceDelegatesResponse:
    ...
    if "Delegates" in data:
        ...
        out["delegates"] = (
            aws_sdk_workmail.types.resource_delegates.deserialize_aws_json_1_1(
                data["Delegates"]
            )
        )
