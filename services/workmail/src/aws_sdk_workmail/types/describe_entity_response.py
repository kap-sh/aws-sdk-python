...
class DescribeEntityResponse(TypedDict, closed=True):
    ...
    type: NotRequired["aws_sdk_workmail.types.entity_type.EntityType"]
    """<p>Entity type.</p>"""
...
def serialize_aws_json_1_1(value: DescribeEntityResponse) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = aws_sdk_workmail.types.entity_type.serialize_aws_json_1_1(
            value["type"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeEntityResponse:
    ...
    if "Type" in data:
        ...
        out["type"] = aws_sdk_workmail.types.entity_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    return out
