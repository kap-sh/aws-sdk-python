"""Generated from Smithy shape ``com.amazonaws.workmail#PersonalAccessTokenSummary``."""
...
class PersonalAccessTokenSummary(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: PersonalAccessTokenSummary) -> dict:
    out: dict = {}
