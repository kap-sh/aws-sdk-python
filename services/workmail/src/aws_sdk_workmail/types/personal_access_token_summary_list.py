...
PersonalAccessTokenSummaryList: TypeAlias = list[
    "aws_sdk_workmail.types.personal_access_token_summary.PersonalAccessTokenSummary"
]
...
def serialize_aws_json_1_1(value: PersonalAccessTokenSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_workmail.types.personal_access_token_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> PersonalAccessTokenSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_workmail.types.personal_access_token_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
