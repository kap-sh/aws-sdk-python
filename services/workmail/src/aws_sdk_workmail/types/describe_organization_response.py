...
class DescribeOrganizationResponse(TypedDict, closed=True):
    ...
    directory_id: NotRequired["aws_sdk_workmail.types.string.String"]
    """<p>The identifier for the directory associated with an WorkMail organization.</p>"""
    directory_type: NotRequired["aws_sdk_workmail.types.string.String"]
    """<p>The type of directory associated with the WorkMail organization.</p>"""
    default_mail_domain: NotRequired["aws_sdk_workmail.types.string.String"]
    """<p>The default mail domain associated with the organization.</p>"""
    completed_date: NotRequired["aws_sdk_workmail.types.timestamp.Timestamp"]
    ...
    arn: NotRequired["aws_sdk_workmail.types.amazon_resource_name.AmazonResourceName"]
    ...
    interoperability_enabled: "aws_sdk_workmail.types.boolean.Boolean"
...
def serialize_aws_json_1_1(value: DescribeOrganizationResponse) -> dict:
    ...
    if "completed_date" in value:
        ...
        out["CompletedDate"] = aws_sdk_workmail.types.timestamp.serialize_aws_json_1_1(
