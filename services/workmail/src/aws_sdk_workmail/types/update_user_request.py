...
class UpdateUserRequest(TypedDict):
    ...
    role: NotRequired["aws_sdk_workmail.types.user_role.UserRole"]
...
def serialize_aws_json_1_1(value: UpdateUserRequest) -> dict:
    ...
    if "role" in value:
        ...
        out["Role"] = aws_sdk_workmail.types.user_role.serialize_aws_json_1_1(
            value["role"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> UpdateUserRequest:
    ...
    if "Role" in data:
        ...
        out["role"] = aws_sdk_workmail.types.user_role.deserialize_aws_json_1_1(
            data["Role"]
        )
