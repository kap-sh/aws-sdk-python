"""Generated from Smithy shape ``com.amazonaws.workmail#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.workmail#ResourceNotFoundException``."""
