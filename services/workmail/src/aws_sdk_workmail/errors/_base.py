...
class WorkMailError(Exception):
    """Base class for all WorkMail service errors."""


class ServiceError(WorkMailError):
...
class SerializationError(WorkMailError):
    """Raised when a value cannot be serialized."""


class DeserializationError(WorkMailError):
...
class WaiterFailedError(WorkMailError):
...
class WaiterTimeoutError(WorkMailError):
