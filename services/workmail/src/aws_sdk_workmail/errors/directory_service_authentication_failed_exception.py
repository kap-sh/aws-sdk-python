"""Generated from Smithy shape ``com.amazonaws.workmail#DirectoryServiceAuthenticationFailedException``."""
...
class DirectoryServiceAuthenticationFailedException_(TypedDict, closed=True):
    message: NotRequired["aws_sdk_workmail.types.string.String"]


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(
    value: DirectoryServiceAuthenticationFailedException_,
) -> dict:
    out: dict = {}
    if "message" in value:
...
class DirectoryServiceAuthenticationFailedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.workmail#DirectoryServiceAuthenticationFailedException``."""
