...
from aws_sdk_frauddetector._auth._zapros_handler import AuthMiddleware
from aws_sdk_frauddetector._services._aws_config import aws_config
from aws_sdk_frauddetector._services._pipeline import (
    Interceptor,
    OperationOptions,
    OperationRequest,
    OperationResponse,
...
if TYPE_CHECKING:
    import aws_sdk_frauddetector.types.batch_create_variable_request
    import aws_sdk_frauddetector.types.batch_create_variable_result
    import aws_sdk_frauddetector.types.batch_get_variable_request
    import aws_sdk_frauddetector.types.batch_get_variable_result
    import aws_sdk_frauddetector.types.batch_imports_max_page_size
    import aws_sdk_frauddetector.types.batch_predictions_max_page_size
    import aws_sdk_frauddetector.types.cancel_batch_import_job_request
    import aws_sdk_frauddetector.types.cancel_batch_import_job_result
    import aws_sdk_frauddetector.types.cancel_batch_prediction_job_request
    import aws_sdk_frauddetector.types.cancel_batch_prediction_job_result
    import aws_sdk_frauddetector.types.create_batch_import_job_request
    import aws_sdk_frauddetector.types.create_batch_import_job_result
    import aws_sdk_frauddetector.types.create_batch_prediction_job_request
    import aws_sdk_frauddetector.types.create_batch_prediction_job_result
    import aws_sdk_frauddetector.types.create_detector_version_request
    import aws_sdk_frauddetector.types.create_detector_version_result
    import aws_sdk_frauddetector.types.create_list_request
    import aws_sdk_frauddetector.types.create_list_result
    import aws_sdk_frauddetector.types.create_model_request
    import aws_sdk_frauddetector.types.create_model_result
    import aws_sdk_frauddetector.types.create_model_version_request
    import aws_sdk_frauddetector.types.create_model_version_result
    import aws_sdk_frauddetector.types.create_rule_request
    import aws_sdk_frauddetector.types.create_rule_result
    import aws_sdk_frauddetector.types.create_variable_request
    import aws_sdk_frauddetector.types.create_variable_result
    ...
    import aws_sdk_frauddetector.types.delete_batch_import_job_request
    import aws_sdk_frauddetector.types.delete_batch_import_job_result
    import aws_sdk_frauddetector.types.delete_batch_prediction_job_request
    import aws_sdk_frauddetector.types.delete_batch_prediction_job_result
    import aws_sdk_frauddetector.types.delete_detector_request
    import aws_sdk_frauddetector.types.delete_detector_result
    import aws_sdk_frauddetector.types.delete_detector_version_request
    import aws_sdk_frauddetector.types.delete_detector_version_result
    import aws_sdk_frauddetector.types.delete_entity_type_request
    import aws_sdk_frauddetector.types.delete_entity_type_result
    import aws_sdk_frauddetector.types.delete_event_request
    import aws_sdk_frauddetector.types.delete_event_result
    import aws_sdk_frauddetector.types.delete_event_type_request
    import aws_sdk_frauddetector.types.delete_event_type_result
    import aws_sdk_frauddetector.types.delete_events_by_event_type_request
    import aws_sdk_frauddetector.types.delete_events_by_event_type_result
    import aws_sdk_frauddetector.types.delete_external_model_request
    import aws_sdk_frauddetector.types.delete_external_model_result
    import aws_sdk_frauddetector.types.delete_label_request
    import aws_sdk_frauddetector.types.delete_label_result
    import aws_sdk_frauddetector.types.delete_list_request
    import aws_sdk_frauddetector.types.delete_list_result
    import aws_sdk_frauddetector.types.delete_model_request
    import aws_sdk_frauddetector.types.delete_model_result
    import aws_sdk_frauddetector.types.delete_model_version_request
    import aws_sdk_frauddetector.types.delete_model_version_result
    import aws_sdk_frauddetector.types.delete_outcome_request
    import aws_sdk_frauddetector.types.delete_outcome_result
    import aws_sdk_frauddetector.types.delete_rule_request
    import aws_sdk_frauddetector.types.delete_rule_result
    import aws_sdk_frauddetector.types.delete_variable_request
    import aws_sdk_frauddetector.types.delete_variable_result
    import aws_sdk_frauddetector.types.describe_detector_request
    import aws_sdk_frauddetector.types.describe_detector_result
    import aws_sdk_frauddetector.types.describe_model_versions_request
    import aws_sdk_frauddetector.types.describe_model_versions_result
    ...
    import aws_sdk_frauddetector.types.detectors_max_results
    import aws_sdk_frauddetector.types.elements_list
    import aws_sdk_frauddetector.types.entity_types_max_results
    ...
    import aws_sdk_frauddetector.types.event_types_max_results
    ...
    import aws_sdk_frauddetector.types.get_batch_import_jobs_request
    import aws_sdk_frauddetector.types.get_batch_import_jobs_result
    import aws_sdk_frauddetector.types.get_batch_prediction_jobs_request
    import aws_sdk_frauddetector.types.get_batch_prediction_jobs_result
    import aws_sdk_frauddetector.types.get_delete_events_by_event_type_status_request
    import aws_sdk_frauddetector.types.get_delete_events_by_event_type_status_result
    import aws_sdk_frauddetector.types.get_detector_version_request
    import aws_sdk_frauddetector.types.get_detector_version_result
    import aws_sdk_frauddetector.types.get_detectors_request
    import aws_sdk_frauddetector.types.get_detectors_result
    import aws_sdk_frauddetector.types.get_entity_types_request
    import aws_sdk_frauddetector.types.get_entity_types_result
    import aws_sdk_frauddetector.types.get_event_prediction_metadata_request
    import aws_sdk_frauddetector.types.get_event_prediction_metadata_result
    import aws_sdk_frauddetector.types.get_event_prediction_request
    import aws_sdk_frauddetector.types.get_event_prediction_result
    import aws_sdk_frauddetector.types.get_event_request
    import aws_sdk_frauddetector.types.get_event_result
    import aws_sdk_frauddetector.types.get_event_types_request
    import aws_sdk_frauddetector.types.get_event_types_result
    import aws_sdk_frauddetector.types.get_external_models_request
    import aws_sdk_frauddetector.types.get_external_models_result
    import aws_sdk_frauddetector.types.get_kms_encryption_key_result
    import aws_sdk_frauddetector.types.get_labels_request
    import aws_sdk_frauddetector.types.get_labels_result
    import aws_sdk_frauddetector.types.get_list_elements_request
    import aws_sdk_frauddetector.types.get_list_elements_result
    import aws_sdk_frauddetector.types.get_lists_metadata_request
    import aws_sdk_frauddetector.types.get_lists_metadata_result
    import aws_sdk_frauddetector.types.get_model_version_request
    import aws_sdk_frauddetector.types.get_model_version_result
    import aws_sdk_frauddetector.types.get_models_request
    import aws_sdk_frauddetector.types.get_models_result
    import aws_sdk_frauddetector.types.get_outcomes_request
    import aws_sdk_frauddetector.types.get_outcomes_result
    import aws_sdk_frauddetector.types.get_rules_request
    import aws_sdk_frauddetector.types.get_rules_result
    import aws_sdk_frauddetector.types.get_variables_request
    import aws_sdk_frauddetector.types.get_variables_result
    ...
    import aws_sdk_frauddetector.types.list_event_predictions_request
    import aws_sdk_frauddetector.types.list_event_predictions_result
    ...
    import aws_sdk_frauddetector.types.list_tags_for_resource_request
    import aws_sdk_frauddetector.types.list_tags_for_resource_result
    ...
    import aws_sdk_frauddetector.types.models_max_page_size
    ...
    import aws_sdk_frauddetector.types.outcomes_max_results
    import aws_sdk_frauddetector.types.prediction_time_range
    import aws_sdk_frauddetector.types.put_detector_request
    import aws_sdk_frauddetector.types.put_detector_result
    import aws_sdk_frauddetector.types.put_entity_type_request
    import aws_sdk_frauddetector.types.put_entity_type_result
    import aws_sdk_frauddetector.types.put_event_type_request
    import aws_sdk_frauddetector.types.put_event_type_result
    import aws_sdk_frauddetector.types.put_external_model_request
    import aws_sdk_frauddetector.types.put_external_model_result
    import aws_sdk_frauddetector.types.put_kms_encryption_key_request
    import aws_sdk_frauddetector.types.put_kms_encryption_key_result
    import aws_sdk_frauddetector.types.put_label_request
    import aws_sdk_frauddetector.types.put_label_result
    import aws_sdk_frauddetector.types.put_outcome_request
    import aws_sdk_frauddetector.types.put_outcome_result
    ...
    import aws_sdk_frauddetector.types.send_event_request
    import aws_sdk_frauddetector.types.send_event_result
    ...
    import aws_sdk_frauddetector.types.tag_resource_request
    import aws_sdk_frauddetector.types.tag_resource_result
    import aws_sdk_frauddetector.types.tags_max_results
    ...
    import aws_sdk_frauddetector.types.untag_resource_request
    import aws_sdk_frauddetector.types.untag_resource_result
    import aws_sdk_frauddetector.types.update_detector_version_metadata_request
    import aws_sdk_frauddetector.types.update_detector_version_metadata_result
    import aws_sdk_frauddetector.types.update_detector_version_request
    import aws_sdk_frauddetector.types.update_detector_version_result
    import aws_sdk_frauddetector.types.update_detector_version_status_request
    import aws_sdk_frauddetector.types.update_detector_version_status_result
    import aws_sdk_frauddetector.types.update_event_label_request
    import aws_sdk_frauddetector.types.update_event_label_result
    import aws_sdk_frauddetector.types.update_list_request
    import aws_sdk_frauddetector.types.update_list_result
    import aws_sdk_frauddetector.types.update_model_request
    import aws_sdk_frauddetector.types.update_model_result
    import aws_sdk_frauddetector.types.update_model_version_request
    import aws_sdk_frauddetector.types.update_model_version_result
    import aws_sdk_frauddetector.types.update_model_version_status_request
    import aws_sdk_frauddetector.types.update_model_version_status_result
    import aws_sdk_frauddetector.types.update_rule_metadata_request
    import aws_sdk_frauddetector.types.update_rule_metadata_result
    import aws_sdk_frauddetector.types.update_rule_version_request
    import aws_sdk_frauddetector.types.update_rule_version_result
    import aws_sdk_frauddetector.types.update_variable_request
    import aws_sdk_frauddetector.types.update_variable_result
...
class FraudDetectorClient:
    ...
    def batch_create_variable(
        self,
        variable_entries: "aws_sdk_frauddetector.types.variable_entry_list.VariableEntryList",
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.batch_create_variable_result.BatchCreateVariableResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.batch_create_variable_request.BatchCreateVariableRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.batch_create_variable_result.BatchCreateVariableResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.batch_create_variable

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.batch_create_variable.batch_create_variable(
    ...
    def batch_get_variable(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.batch_get_variable_result.BatchGetVariableResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.batch_get_variable_request.BatchGetVariableRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.batch_get_variable_result.BatchGetVariableResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.batch_get_variable

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.batch_get_variable.batch_get_variable(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def cancel_batch_import_job(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.cancel_batch_import_job_result.CancelBatchImportJobResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.cancel_batch_import_job_request.CancelBatchImportJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.cancel_batch_import_job_result.CancelBatchImportJobResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.cancel_batch_import_job

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.cancel_batch_import_job.cancel_batch_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def cancel_batch_prediction_job(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.cancel_batch_prediction_job_result.CancelBatchPredictionJobResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.cancel_batch_prediction_job_request.CancelBatchPredictionJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.cancel_batch_prediction_job_result.CancelBatchPredictionJobResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.cancel_batch_prediction_job

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.cancel_batch_prediction_job.cancel_batch_prediction_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_batch_import_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.create_batch_import_job_request.CreateBatchImportJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.create_batch_import_job_result.CreateBatchImportJobResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_batch_import_job

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_batch_import_job.create_batch_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_batch_prediction_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.create_batch_prediction_job_request.CreateBatchPredictionJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.create_batch_prediction_job_result.CreateBatchPredictionJobResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_batch_prediction_job

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_batch_prediction_job.create_batch_prediction_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_detector_version(
        ...
        *,
        ...
        description: Optional[
            "aws_sdk_frauddetector.types.description.description"
        ] = None,
        ...
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.create_detector_version_result.CreateDetectorVersionResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.create_detector_version_request.CreateDetectorVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.create_detector_version_result.CreateDetectorVersionResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_detector_version

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_detector_version.create_detector_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_list(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        elements: Optional[
            "aws_sdk_frauddetector.types.elements_list.ElementsList"
        ] = None,
        variable_type: Optional[
            "aws_sdk_frauddetector.types.variable_type.variableType"
        ] = None,
        description: Optional[
            "aws_sdk_frauddetector.types.description.description"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.create_list_request.CreateListRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.create_list_result.CreateListResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_list

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_list.create_list(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_model(
        ...
        *,
        ...
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.create_model_result.CreateModelResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.create_model_request.CreateModelRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.create_model_result.CreateModelResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_model

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_model.create_model(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_model_version(
        ...
        model_id: "aws_sdk_frauddetector.types.model_identifier.modelIdentifier",
        model_type: "aws_sdk_frauddetector.types.model_type_enum.ModelTypeEnum",
        training_data_source: "aws_sdk_frauddetector.types.training_data_source_enum.TrainingDataSourceEnum",
        training_data_schema: "aws_sdk_frauddetector.types.training_data_schema.TrainingDataSchema",
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        ...
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.create_model_version_result.CreateModelVersionResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.create_model_version_request.CreateModelVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.create_model_version_result.CreateModelVersionResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_model_version

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_model_version.create_model_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_rule(
        ...
        outcomes: "aws_sdk_frauddetector.types.non_empty_list_of_strings.NonEmptyListOfStrings",
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        description: Optional[
            "aws_sdk_frauddetector.types.description.description"
        ...
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.create_rule_result.CreateRuleResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.create_rule_request.CreateRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.create_rule_result.CreateRuleResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_rule

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_rule.create_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_variable(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.create_variable_request.CreateVariableRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.create_variable_result.CreateVariableResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_variable

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.create_variable.create_variable(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_batch_import_job(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_batch_import_job_result.DeleteBatchImportJobResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_batch_import_job_request.DeleteBatchImportJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_batch_import_job_result.DeleteBatchImportJobResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_batch_import_job

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_batch_import_job.delete_batch_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_batch_prediction_job(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_batch_prediction_job_result.DeleteBatchPredictionJobResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_batch_prediction_job_request.DeleteBatchPredictionJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_batch_prediction_job_result.DeleteBatchPredictionJobResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_batch_prediction_job

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_batch_prediction_job.delete_batch_prediction_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_detector(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_detector_result.DeleteDetectorResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_detector_request.DeleteDetectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_detector_result.DeleteDetectorResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_detector

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_detector.delete_detector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_detector_version(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_detector_version_result.DeleteDetectorVersionResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_detector_version_request.DeleteDetectorVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_detector_version_result.DeleteDetectorVersionResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_detector_version

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_detector_version.delete_detector_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_entity_type(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_entity_type_result.DeleteEntityTypeResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_entity_type_request.DeleteEntityTypeRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_entity_type_result.DeleteEntityTypeResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_entity_type

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_entity_type.delete_entity_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_event(
        ...
        *,
    ...
    ) -> "aws_sdk_frauddetector.types.delete_event_result.DeleteEventResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_event_request.DeleteEventRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_event_result.DeleteEventResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_event

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_event.delete_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_events_by_event_type(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_events_by_event_type_result.DeleteEventsByEventTypeResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_events_by_event_type_request.DeleteEventsByEventTypeRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_events_by_event_type_result.DeleteEventsByEventTypeResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_events_by_event_type

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_events_by_event_type.delete_events_by_event_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_event_type(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_event_type_result.DeleteEventTypeResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_event_type_request.DeleteEventTypeRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_event_type_result.DeleteEventTypeResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_event_type

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_event_type.delete_event_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_external_model(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_external_model_result.DeleteExternalModelResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_external_model_request.DeleteExternalModelRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_external_model_result.DeleteExternalModelResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_external_model

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_external_model.delete_external_model(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_label(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_label_result.DeleteLabelResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_label_request.DeleteLabelRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_label_result.DeleteLabelResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_label

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_label.delete_label(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_list(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_list_result.DeleteListResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_list_request.DeleteListRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_list_result.DeleteListResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_list

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_list.delete_list(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_model(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_model_result.DeleteModelResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_model_request.DeleteModelRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_model_result.DeleteModelResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_model

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_model.delete_model(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_model_version(
        ...
        model_id: "aws_sdk_frauddetector.types.model_identifier.modelIdentifier",
        model_type: "aws_sdk_frauddetector.types.model_type_enum.ModelTypeEnum",
        model_version_number: "aws_sdk_frauddetector.types.float_version_string.floatVersionString",
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_model_version_result.DeleteModelVersionResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_model_version_request.DeleteModelVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_model_version_result.DeleteModelVersionResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_model_version

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_model_version.delete_model_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_outcome(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_outcome_result.DeleteOutcomeResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_outcome_request.DeleteOutcomeRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_outcome_result.DeleteOutcomeResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_outcome

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_outcome.delete_outcome(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_rule_request.DeleteRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_rule_result.DeleteRuleResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_rule

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_rule.delete_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_variable(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.delete_variable_result.DeleteVariableResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.delete_variable_request.DeleteVariableRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.delete_variable_result.DeleteVariableResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_variable

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.delete_variable.delete_variable(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_detector(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.detector_version_max_results.DetectorVersionMaxResults"
        ] = None,
    ) -> "aws_sdk_frauddetector.types.describe_detector_result.DescribeDetectorResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.describe_detector_request.DescribeDetectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.describe_detector_result.DescribeDetectorResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.describe_detector

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.describe_detector.describe_detector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_model_versions(
        ...
        *,
        ...
        model_type: Optional[
            "aws_sdk_frauddetector.types.model_type_enum.ModelTypeEnum"
        ] = None,
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.models_max_page_size.modelsMaxPageSize"
        ] = None,
    ) -> "aws_sdk_frauddetector.types.describe_model_versions_result.DescribeModelVersionsResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.describe_model_versions_request.DescribeModelVersionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.describe_model_versions_result.DescribeModelVersionsResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.describe_model_versions

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.describe_model_versions.describe_model_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_batch_import_jobs(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        job_id: Optional["aws_sdk_frauddetector.types.identifier.identifier"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.batch_imports_max_page_size.batchImportsMaxPageSize"
        ] = None,
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
    ) -> "aws_sdk_frauddetector.types.get_batch_import_jobs_result.GetBatchImportJobsResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_batch_import_jobs_request.GetBatchImportJobsRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_batch_import_jobs_result.GetBatchImportJobsResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_batch_import_jobs

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_batch_import_jobs.get_batch_import_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_batch_prediction_jobs(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
    ) -> "aws_sdk_frauddetector.types.get_batch_prediction_jobs_result.GetBatchPredictionJobsResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_batch_prediction_jobs_request.GetBatchPredictionJobsRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_batch_prediction_jobs_result.GetBatchPredictionJobsResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_batch_prediction_jobs

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_batch_prediction_jobs.get_batch_prediction_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_delete_events_by_event_type_status(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.get_delete_events_by_event_type_status_result.GetDeleteEventsByEventTypeStatusResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_delete_events_by_event_type_status_request.GetDeleteEventsByEventTypeStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_delete_events_by_event_type_status_result.GetDeleteEventsByEventTypeStatusResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_delete_events_by_event_type_status

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_delete_events_by_event_type_status.get_delete_events_by_event_type_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_detectors(
        ...
        *,
        ...
        detector_id: Optional[
            "aws_sdk_frauddetector.types.identifier.identifier"
        ] = None,
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.detectors_max_results.DetectorsMaxResults"
        ] = None,
    ) -> "aws_sdk_frauddetector.types.get_detectors_result.GetDetectorsResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_detectors_request.GetDetectorsRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_detectors_result.GetDetectorsResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_detectors

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_detectors.get_detectors(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_detector_version(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.get_detector_version_result.GetDetectorVersionResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_detector_version_request.GetDetectorVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_detector_version_result.GetDetectorVersionResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_detector_version

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_detector_version.get_detector_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_entity_types(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        name: Optional["aws_sdk_frauddetector.types.identifier.identifier"] = None,
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.entity_types_max_results.entityTypesMaxResults"
        ] = None,
    ) -> "aws_sdk_frauddetector.types.get_entity_types_result.GetEntityTypesResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_entity_types_request.GetEntityTypesRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_entity_types_result.GetEntityTypesResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_entity_types

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_entity_types.get_entity_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_event(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.get_event_result.GetEventResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_event_request.GetEventRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_event_result.GetEventResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_event

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_event.get_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_event_prediction(
        ...
        event_timestamp: "aws_sdk_frauddetector.types.utc_timestamp_iso8601.utcTimestampISO8601",
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_event_prediction_request.GetEventPredictionRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_event_prediction_result.GetEventPredictionResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_event_prediction

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_event_prediction.get_event_prediction(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_event_prediction_metadata(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_event_prediction_metadata_request.GetEventPredictionMetadataRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_event_prediction_metadata_result.GetEventPredictionMetadataResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_event_prediction_metadata

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_event_prediction_metadata.get_event_prediction_metadata(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_event_types(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.event_types_max_results.eventTypesMaxResults"
        ] = None,
    ) -> "aws_sdk_frauddetector.types.get_event_types_result.GetEventTypesResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_event_types_request.GetEventTypesRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_event_types_result.GetEventTypesResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_event_types

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_event_types.get_event_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_external_models(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        model_endpoint: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.external_models_max_results.ExternalModelsMaxResults"
        ] = None,
    ) -> (
        "aws_sdk_frauddetector.types.get_external_models_result.GetExternalModelsResult"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_external_models_request.GetExternalModelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_external_models_result.GetExternalModelsResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_external_models

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_external_models.get_external_models(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_kms_encryption_key(
        ...
        def _handler(
            ...
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_kms_encryption_key

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_kms_encryption_key.get_kms_encryption_key(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_labels(
        ...
        *,
    ...
    ) -> "aws_sdk_frauddetector.types.get_labels_result.GetLabelsResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_labels_request.GetLabelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_labels_result.GetLabelsResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_labels

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_labels.get_labels(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_list_elements(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        next_token: Optional["aws_sdk_frauddetector.types.next_token.nextToken"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.lists_elements_max_results.ListsElementsMaxResults"
        ] = None,
    ) -> "aws_sdk_frauddetector.types.get_list_elements_result.GetListElementsResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_list_elements_request.GetListElementsRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_list_elements_result.GetListElementsResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_list_elements

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_list_elements.get_list_elements(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_lists_metadata(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        name: Optional[
            "aws_sdk_frauddetector.types.no_dash_identifier.noDashIdentifier"
        ] = None,
        next_token: Optional["aws_sdk_frauddetector.types.next_token.nextToken"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.lists_metadata_max_results.ListsMetadataMaxResults"
        ] = None,
    ) -> "aws_sdk_frauddetector.types.get_lists_metadata_result.GetListsMetadataResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_lists_metadata_request.GetListsMetadataRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_lists_metadata_result.GetListsMetadataResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_lists_metadata

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_lists_metadata.get_lists_metadata(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_models(
        ...
        *,
    ...
    ) -> "aws_sdk_frauddetector.types.get_models_result.GetModelsResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_models_request.GetModelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_models_result.GetModelsResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_models

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_models.get_models(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_model_version(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.get_model_version_result.GetModelVersionResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_model_version_request.GetModelVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_model_version_result.GetModelVersionResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_model_version

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_model_version.get_model_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_outcomes(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.outcomes_max_results.OutcomesMaxResults"
        ] = None,
    ) -> "aws_sdk_frauddetector.types.get_outcomes_result.GetOutcomesResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_outcomes_request.GetOutcomesRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_outcomes_result.GetOutcomesResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_outcomes

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_outcomes.get_outcomes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_rules(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        rule_id: Optional["aws_sdk_frauddetector.types.identifier.identifier"] = None,
    ...
    ) -> "aws_sdk_frauddetector.types.get_rules_result.GetRulesResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_rules_request.GetRulesRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_rules_result.GetRulesResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_rules

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_rules.get_rules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_variables(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        name: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.variables_max_results.VariablesMaxResults"
        ] = None,
    ) -> "aws_sdk_frauddetector.types.get_variables_result.GetVariablesResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.get_variables_request.GetVariablesRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.get_variables_result.GetVariablesResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_variables

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.get_variables.get_variables(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_event_predictions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.list_event_predictions_request.ListEventPredictionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.list_event_predictions_result.ListEventPredictionsResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.list_event_predictions

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.list_event_predictions.list_event_predictions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        max_results: Optional[
            "aws_sdk_frauddetector.types.tags_max_results.TagsMaxResults"
        ] = None,
    ) -> "aws_sdk_frauddetector.types.list_tags_for_resource_result.ListTagsForResourceResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.list_tags_for_resource_result.ListTagsForResourceResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.list_tags_for_resource

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_detector(
        ...
        *,
        ...
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.put_detector_result.PutDetectorResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.put_detector_request.PutDetectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.put_detector_result.PutDetectorResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_detector

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_detector.put_detector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_entity_type(
        ...
        *,
        ...
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.put_entity_type_result.PutEntityTypeResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.put_entity_type_request.PutEntityTypeRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.put_entity_type_result.PutEntityTypeResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_entity_type

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_entity_type.put_entity_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_event_type(
        self,
        name: "aws_sdk_frauddetector.types.identifier.identifier",
        event_variables: "aws_sdk_frauddetector.types.non_empty_list_of_strings.NonEmptyListOfStrings",
        entity_types: "aws_sdk_frauddetector.types.non_empty_list_of_strings.NonEmptyListOfStrings",
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        description: Optional[
            "aws_sdk_frauddetector.types.description.description"
    ...
    ) -> "aws_sdk_frauddetector.types.put_event_type_result.PutEventTypeResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.put_event_type_request.PutEventTypeRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.put_event_type_result.PutEventTypeResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_event_type

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_event_type.put_event_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_external_model(
        ...
        input_configuration: "aws_sdk_frauddetector.types.model_input_configuration.ModelInputConfiguration",
        output_configuration: "aws_sdk_frauddetector.types.model_output_configuration.ModelOutputConfiguration",
        model_endpoint_status: "aws_sdk_frauddetector.types.model_endpoint_status.ModelEndpointStatus",
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.put_external_model_result.PutExternalModelResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.put_external_model_request.PutExternalModelRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.put_external_model_result.PutExternalModelResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_external_model

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_external_model.put_external_model(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_kms_encryption_key(
        self,
        kms_encryption_key_arn: "aws_sdk_frauddetector.types.kms_encryption_key_arn.KmsEncryptionKeyArn",
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.put_kms_encryption_key_result.PutKMSEncryptionKeyResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.put_kms_encryption_key_request.PutKMSEncryptionKeyRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.put_kms_encryption_key_result.PutKMSEncryptionKeyResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_kms_encryption_key

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_kms_encryption_key.put_kms_encryption_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_label(
        ...
        *,
        ...
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.put_label_result.PutLabelResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.put_label_request.PutLabelRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.put_label_result.PutLabelResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_label

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_label.put_label(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_outcome(
        ...
        *,
        ...
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.put_outcome_result.PutOutcomeResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.put_outcome_request.PutOutcomeRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.put_outcome_result.PutOutcomeResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_outcome

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.put_outcome.put_outcome(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_event(
        ...
        *,
    ...
    ) -> "aws_sdk_frauddetector.types.send_event_result.SendEventResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.send_event_request.SendEventRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.send_event_result.SendEventResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.send_event

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.send_event.send_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.tag_resource_result.TagResourceResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.tag_resource_result.TagResourceResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.tag_resource

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.untag_resource_result.UntagResourceResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.untag_resource_result.UntagResourceResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.untag_resource

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_detector_version(
        ...
        detector_id: "aws_sdk_frauddetector.types.identifier.identifier",
        detector_version_id: "aws_sdk_frauddetector.types.whole_number_version_string.wholeNumberVersionString",
        external_model_endpoints: "aws_sdk_frauddetector.types.list_of_strings.ListOfStrings",
        rules: "aws_sdk_frauddetector.types.rule_list.RuleList",
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        description: Optional[
    ...
    ) -> "aws_sdk_frauddetector.types.update_detector_version_result.UpdateDetectorVersionResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_detector_version_request.UpdateDetectorVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_detector_version_result.UpdateDetectorVersionResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_detector_version

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_detector_version.update_detector_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_detector_version_metadata(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.update_detector_version_metadata_result.UpdateDetectorVersionMetadataResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_detector_version_metadata_request.UpdateDetectorVersionMetadataRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_detector_version_metadata_result.UpdateDetectorVersionMetadataResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_detector_version_metadata

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_detector_version_metadata.update_detector_version_metadata(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_detector_version_status(
        ...
        detector_id: "aws_sdk_frauddetector.types.identifier.identifier",
        detector_version_id: "aws_sdk_frauddetector.types.whole_number_version_string.wholeNumberVersionString",
        status: "aws_sdk_frauddetector.types.detector_version_status.DetectorVersionStatus",
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.update_detector_version_status_result.UpdateDetectorVersionStatusResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_detector_version_status_request.UpdateDetectorVersionStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_detector_version_status_result.UpdateDetectorVersionStatusResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_detector_version_status

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_detector_version_status.update_detector_version_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_event_label(
        ...
        event_id: "aws_sdk_frauddetector.types.identifier.identifier",
        event_type_name: "aws_sdk_frauddetector.types.identifier.identifier",
        assigned_label: "aws_sdk_frauddetector.types.identifier.identifier",
        label_timestamp: "aws_sdk_frauddetector.types.utc_timestamp_iso8601.utcTimestampISO8601",
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.update_event_label_result.UpdateEventLabelResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_event_label_request.UpdateEventLabelRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_event_label_result.UpdateEventLabelResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_event_label

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_event_label.update_event_label(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_list(
        ...
        *,
    ...
    ) -> "aws_sdk_frauddetector.types.update_list_result.UpdateListResult":
        """<p> Updates a list. </p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_list_request.UpdateListRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_list_result.UpdateListResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_list

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_list.update_list(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_model(
        ...
        *,
    ...
    ) -> "aws_sdk_frauddetector.types.update_model_result.UpdateModelResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_model_request.UpdateModelRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_model_result.UpdateModelResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_model

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_model.update_model(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_model_version(
        ...
        *,
        ...
        tags: Optional["aws_sdk_frauddetector.types.tag_list.tagList"] = None,
    ) -> "aws_sdk_frauddetector.types.update_model_version_result.UpdateModelVersionResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_model_version_request.UpdateModelVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_model_version_result.UpdateModelVersionResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_model_version

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_model_version.update_model_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_model_version_status(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.update_model_version_status_result.UpdateModelVersionStatusResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_model_version_status_request.UpdateModelVersionStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_model_version_status_result.UpdateModelVersionStatusResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_model_version_status

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_model_version_status.update_model_version_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_rule_metadata(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
    ) -> "aws_sdk_frauddetector.types.update_rule_metadata_result.UpdateRuleMetadataResult":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_rule_metadata_request.UpdateRuleMetadataRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_rule_metadata_result.UpdateRuleMetadataResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_rule_metadata

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_rule_metadata.update_rule_metadata(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_rule_version(
        ...
        *,
        ...
        "aws_sdk_frauddetector.types.update_rule_version_result.UpdateRuleVersionResult"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_rule_version_request.UpdateRuleVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_rule_version_result.UpdateRuleVersionResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_rule_version

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_rule_version.update_rule_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_variable(
        ...
        *,
        config_overrides: Optional[FraudDetectorClientConfig] = None,
        default_value: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        description: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        variable_type: Optional["aws_sdk_frauddetector.types.string.string"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_frauddetector.types.update_variable_request.UpdateVariableRequest]",
        ) -> OperationResponse[
            "aws_sdk_frauddetector.types.update_variable_result.UpdateVariableResult"
        ]:
            import aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_variable

            output, http_response = (
                aws_sdk_frauddetector._operations.aws_hawks_nest_service_facade.update_variable.update_variable(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
