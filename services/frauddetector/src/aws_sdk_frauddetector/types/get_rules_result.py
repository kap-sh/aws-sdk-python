...
class GetRulesResult(TypedDict):
    rule_details: NotRequired[
        "aws_sdk_frauddetector.types.rule_detail_list.RuleDetailList"
    ]
...
def serialize_aws_json_1_1(value: GetRulesResult) -> dict:
    ...
    if "rule_details" in value:
        ...
        out["ruleDetails"] = (
            aws_sdk_frauddetector.types.rule_detail_list.serialize_aws_json_1_1(
                value["rule_details"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetRulesResult:
    ...
    if "ruleDetails" in data:
        ...
        out["rule_details"] = (
            aws_sdk_frauddetector.types.rule_detail_list.deserialize_aws_json_1_1(
                data["ruleDetails"]
            )
        )
