...
class GetDetectorsResult(TypedDict):
    detectors: NotRequired["aws_sdk_frauddetector.types.detector_list.DetectorList"]
    """<p>The detectors.</p>"""
...
def serialize_aws_json_1_1(value: GetDetectorsResult) -> dict:
    ...
    if "detectors" in value:
        ...
        out["detectors"] = (
            aws_sdk_frauddetector.types.detector_list.serialize_aws_json_1_1(
                value["detectors"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetDetectorsResult:
    ...
    if "detectors" in data:
        ...
        out["detectors"] = (
            aws_sdk_frauddetector.types.detector_list.deserialize_aws_json_1_1(
                data["detectors"]
            )
        )
