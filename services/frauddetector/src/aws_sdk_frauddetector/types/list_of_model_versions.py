...
ListOfModelVersions: TypeAlias = list[
    "aws_sdk_frauddetector.types.model_version.ModelVersion"
]
...
def serialize_aws_json_1_1(value: ListOfModelVersions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_frauddetector.types.model_version.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ListOfModelVersions:
    ...
    for item in data:
        out.append(
            aws_sdk_frauddetector.types.model_version.deserialize_aws_json_1_1(item)
        )
    return out
