...
if TYPE_CHECKING:
    ...
    import aws_sdk_frauddetector.types.model_input_data_format
    import aws_sdk_frauddetector.types.model_input_template
    import aws_sdk_frauddetector.types.use_event_variables


class ModelInputConfiguration(TypedDict):
    event_type_name: NotRequired["aws_sdk_frauddetector.types.identifier.identifier"]
    """<p>The event type name.</p>"""
    format: NotRequired[
        "aws_sdk_frauddetector.types.model_input_data_format.ModelInputDataFormat"
    ]
    ...
    use_event_variables: (
        "aws_sdk_frauddetector.types.use_event_variables.UseEventVariables"
    )
    """<p>The event variables.</p>"""
    json_input_template: NotRequired[
        "aws_sdk_frauddetector.types.model_input_template.modelInputTemplate"
    ]
...
def serialize_aws_json_1_1(value: ModelInputConfiguration) -> dict:
    ...
    if "format" in value:
        ...
        out["format"] = (
            aws_sdk_frauddetector.types.model_input_data_format.serialize_aws_json_1_1(
                value["format"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ModelInputConfiguration:
    ...
    if "format" in data:
        ...
        out["format"] = (
            aws_sdk_frauddetector.types.model_input_data_format.deserialize_aws_json_1_1(
                data["format"]
            )
        )
