...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: TFIMetricDataPoint) -> dict:
    out: dict = {}
    if "fpr" in value:
        out["fpr"] = value["fpr"]
...
def deserialize_aws_json_1_1(data: dict) -> TFIMetricDataPoint:
    out: TFIMetricDataPoint = {}  # type: ignore[typeddict-item]
    if "fpr" in data:
        out["fpr"] = data["fpr"]
