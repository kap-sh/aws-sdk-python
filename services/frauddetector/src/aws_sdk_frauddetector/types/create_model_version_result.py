"""Generated from Smithy shape ``com.amazonaws.frauddetector#CreateModelVersionResult``."""
...
class CreateModelVersionResult(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateModelVersionResult) -> dict:
    out: dict = {}
