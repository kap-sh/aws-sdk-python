...
if TYPE_CHECKING:
    import aws_sdk_frauddetector.types.model_version_evaluation

ListOfModelVersionEvaluations: TypeAlias = list[
    "aws_sdk_frauddetector.types.model_version_evaluation.ModelVersionEvaluation"
]
...
def serialize_aws_json_1_1(value: ListOfModelVersionEvaluations) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_frauddetector.types.model_version_evaluation.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ListOfModelVersionEvaluations:
    ...
    for item in data:
        out.append(
            aws_sdk_frauddetector.types.model_version_evaluation.deserialize_aws_json_1_1(
                item
            )
        )
    return out
