...
if TYPE_CHECKING:
    import aws_sdk_frauddetector.types.list_of_model_version_evaluations
    import aws_sdk_frauddetector.types.string


class EvaluatedModelVersion(TypedDict):
    model_id: NotRequired["aws_sdk_frauddetector.types.string.string"]
    """<p> The model ID. </p>"""
    model_version: NotRequired["aws_sdk_frauddetector.types.string.string"]
    """<p> The model version. </p>"""
    model_type: NotRequired["aws_sdk_frauddetector.types.string.string"]
    ...
    evaluations: NotRequired[
        "aws_sdk_frauddetector.types.list_of_model_version_evaluations.ListOfModelVersionEvaluations"
    ]
...
def serialize_aws_json_1_1(value: EvaluatedModelVersion) -> dict:
    ...
    if "evaluations" in value:
        ...
        out["evaluations"] = (
            aws_sdk_frauddetector.types.list_of_model_version_evaluations.serialize_aws_json_1_1(
                value["evaluations"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> EvaluatedModelVersion:
    ...
    if "evaluations" in data:
        ...
        out["evaluations"] = (
            aws_sdk_frauddetector.types.list_of_model_version_evaluations.deserialize_aws_json_1_1(
                data["evaluations"]
            )
        )
    return out
