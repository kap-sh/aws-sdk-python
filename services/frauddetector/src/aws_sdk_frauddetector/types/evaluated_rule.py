...
class EvaluatedRule(TypedDict, closed=True):
    ...
    expression: NotRequired[
        "aws_sdk_frauddetector.types.sensitive_string.sensitiveString"
    ]
    ...
    evaluated: NotRequired["aws_sdk_frauddetector.types.boolean.Boolean"]
    """<p> Indicates whether the rule was evaluated. </p>"""
    matched: NotRequired["aws_sdk_frauddetector.types.boolean.Boolean"]
