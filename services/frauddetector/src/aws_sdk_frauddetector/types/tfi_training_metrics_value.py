...
if TYPE_CHECKING:
    import aws_sdk_frauddetector.types.tfi_metric_data_points_list
    import aws_sdk_frauddetector.types.tfi_model_performance


class TFITrainingMetricsValue(TypedDict):
    metric_data_points: NotRequired[
        "aws_sdk_frauddetector.types.tfi_metric_data_points_list.TFIMetricDataPointsList"
    ]
    """<p> The model's performance metrics data points. </p>"""
    model_performance: NotRequired[
        "aws_sdk_frauddetector.types.tfi_model_performance.TFIModelPerformance"
    ]
...
def serialize_aws_json_1_1(value: TFITrainingMetricsValue) -> dict:
    ...
    if "metric_data_points" in value:
        ...
        out["metricDataPoints"] = (
            aws_sdk_frauddetector.types.tfi_metric_data_points_list.serialize_aws_json_1_1(
    ...
    if "model_performance" in value:
        ...
        out["modelPerformance"] = (
            aws_sdk_frauddetector.types.tfi_model_performance.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TFITrainingMetricsValue:
    ...
    if "metricDataPoints" in data:
        ...
        out["metric_data_points"] = (
            aws_sdk_frauddetector.types.tfi_metric_data_points_list.deserialize_aws_json_1_1(
    ...
    if "modelPerformance" in data:
        ...
        out["model_performance"] = (
            aws_sdk_frauddetector.types.tfi_model_performance.deserialize_aws_json_1_1(
