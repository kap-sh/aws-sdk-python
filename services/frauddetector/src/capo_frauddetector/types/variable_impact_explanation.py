...
class VariableImpactExplanation(TypedDict, closed=True):
    event_variable_name: NotRequired["capo_frauddetector.types.string.string"]
    """<p> The event variable name. </p>"""
    relative_impact: NotRequired["capo_frauddetector.types.string.string"]
    ...
    log_odds_impact: NotRequired["capo_frauddetector.types.float.float"]
