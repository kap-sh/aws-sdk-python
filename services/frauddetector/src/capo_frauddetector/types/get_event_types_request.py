"""Generated from Smithy shape ``com.amazonaws.frauddetector#GetEventTypesRequest``."""
...
class GetEventTypesRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetEventTypesRequest) -> dict:
    out: dict = {}
    if "name" in value:
        out["name"] = value["name"]
...
def deserialize_aws_json_1_1(data: dict) -> GetEventTypesRequest:
    out: GetEventTypesRequest = {}  # type: ignore[typeddict-item]
    if "name" in data:
        out["name"] = data["name"]
