...
class GetLabelsResult(TypedDict, closed=True):
    labels: NotRequired["capo_frauddetector.types.label_list.labelList"]
...
def serialize_aws_json_1_1(value: GetLabelsResult) -> dict:
    ...
    if "labels" in value:
        ...
        out["labels"] = capo_frauddetector.types.label_list.serialize_aws_json_1_1(
            value["labels"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetLabelsResult:
    ...
    if "labels" in data:
        ...
        out["labels"] = capo_frauddetector.types.label_list.deserialize_aws_json_1_1(
            data["labels"]
        )
