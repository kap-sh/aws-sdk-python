...
class GetDetectorVersionResult(TypedDict, closed=True):
    ...
    rules: NotRequired["capo_frauddetector.types.rule_list.RuleList"]
    """<p>The rules included in the detector version.</p>"""
    status: NotRequired[
        "capo_frauddetector.types.detector_version_status.DetectorVersionStatus"
    ]
