...
class PredictionExplanations(TypedDict, closed=True):
    variable_impact_explanations: NotRequired[
        "capo_frauddetector.types.list_of_variable_impact_explanations.listOfVariableImpactExplanations"
    ]
    ...
    aggregated_variables_impact_explanations: NotRequired[
        "capo_frauddetector.types.list_of_aggregated_variables_impact_explanations.ListOfAggregatedVariablesImpactExplanations"
    ]
...
def serialize_aws_json_1_1(value: PredictionExplanations) -> dict:
    ...
    if "variable_impact_explanations" in value:
        ...
        out["variableImpactExplanations"] = (
            capo_frauddetector.types.list_of_variable_impact_explanations.serialize_aws_json_1_1(
    ...
    if "aggregated_variables_impact_explanations" in value:
        ...
        out["aggregatedVariablesImpactExplanations"] = (
            capo_frauddetector.types.list_of_aggregated_variables_impact_explanations.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> PredictionExplanations:
    ...
    if "variableImpactExplanations" in data:
        ...
        out["variable_impact_explanations"] = (
            capo_frauddetector.types.list_of_variable_impact_explanations.deserialize_aws_json_1_1(
    ...
    if "aggregatedVariablesImpactExplanations" in data:
        ...
        out["aggregated_variables_impact_explanations"] = (
            capo_frauddetector.types.list_of_aggregated_variables_impact_explanations.deserialize_aws_json_1_1(
