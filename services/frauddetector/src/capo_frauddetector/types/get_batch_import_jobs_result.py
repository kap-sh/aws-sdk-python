...
class GetBatchImportJobsResult(TypedDict, closed=True):
    batch_imports: NotRequired[
        "capo_frauddetector.types.batch_import_list.BatchImportList"
    ]
...
def serialize_aws_json_1_1(value: GetBatchImportJobsResult) -> dict:
    ...
    if "batch_imports" in value:
        ...
        out["batchImports"] = (
            capo_frauddetector.types.batch_import_list.serialize_aws_json_1_1(
                value["batch_imports"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetBatchImportJobsResult:
    ...
    if "batchImports" in data:
        ...
        out["batch_imports"] = (
            capo_frauddetector.types.batch_import_list.deserialize_aws_json_1_1(
                data["batchImports"]
            )
        )
