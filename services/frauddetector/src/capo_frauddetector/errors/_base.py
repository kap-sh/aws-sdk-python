...
class FraudDetectorError(Exception):
    """Base class for all FraudDetector service errors."""


class ServiceError(FraudDetectorError):
...
class SerializationError(FraudDetectorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(FraudDetectorError):
...
class WaiterFailedError(FraudDetectorError):
...
class WaiterTimeoutError(FraudDetectorError):
