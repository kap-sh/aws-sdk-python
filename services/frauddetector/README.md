...
```
pip install aws-sdk-frauddetector
```

## Usage

```python
from aws_sdk_frauddetector import AsyncFraudDetectorClient
...
```python
from aws_sdk_frauddetector import AsyncFraudDetectorClient
from aws_sdk_frauddetector.error import AccessDeniedException
