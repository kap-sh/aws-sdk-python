...
def handle_response(
    ...
    out: capo_healthlake.types.list_fhir_export_jobs_response.ListFHIRExportJobsResponse = capo_healthlake.types.list_fhir_export_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_healthlake.types.list_fhir_export_jobs_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
