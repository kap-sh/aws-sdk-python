...
def handle_response(
    ...
    out: capo_healthlake.types.start_fhir_export_job_response.StartFHIRExportJobResponse = capo_healthlake.types.start_fhir_export_job_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_healthlake.types.start_fhir_export_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
