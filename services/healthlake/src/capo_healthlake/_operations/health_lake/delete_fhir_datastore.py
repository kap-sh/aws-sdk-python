...
import capo_healthlake.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_healthlake.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        case "InternalServerException":
            raise capo_healthlake.errors.internal_server_exception.InternalServerException.from_aws_json_1_0(
                data
            )
        case "ResourceNotFoundException":
            raise capo_healthlake.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_0(
                data
            )
        case "ThrottlingException":
            raise capo_healthlake.errors.throttling_exception.ThrottlingException.from_aws_json_1_0(
                data
            )
        case "ValidationException":
            raise capo_healthlake.errors.validation_exception.ValidationException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_healthlake.types.delete_fhir_datastore_response.DeleteFHIRDatastoreResponse = capo_healthlake.types.delete_fhir_datastore_response.deserialize_aws_json_1_0(
...
def get_signer(
...
) -> capo_healthlake._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_healthlake._auth._sigv4.build_sigv4_auth_scheme(
                "healthlake", options.region
            )
        )
        if sigv4_config is not None:
            return capo_healthlake._auth._signers.SigV4Signer(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_healthlake.types.delete_fhir_datastore_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
