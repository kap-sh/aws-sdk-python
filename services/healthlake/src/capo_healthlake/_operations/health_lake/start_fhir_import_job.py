"""Generated from Smithy shape ``com.amazonaws.healthlake#StartFHIRImportJob``."""
...
def handle_response(
    ...
    out: capo_healthlake.types.start_fhir_import_job_response.StartFHIRImportJobResponse = capo_healthlake.types.start_fhir_import_job_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "HealthLake.StartFHIRImportJob"
    body: bytes | None = json.dumps(
        capo_healthlake.types.start_fhir_import_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_start_fhir_import_job(
