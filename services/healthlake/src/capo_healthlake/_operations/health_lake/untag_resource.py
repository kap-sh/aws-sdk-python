...
def handle_response(
    ...
    out: capo_healthlake.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_healthlake.types.untag_resource_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_healthlake.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
