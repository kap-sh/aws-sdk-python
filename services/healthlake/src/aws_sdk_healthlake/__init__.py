...
from ._services.async_health_lake import AsyncHealthLakeClient as AsyncHealthLakeClient
from ._services.health_lake import HealthLakeClient as HealthLakeClient
