...
if TYPE_CHECKING:
    import aws_sdk_healthlake.types.generic_double
    import aws_sdk_healthlake.types.generic_long


class JobProgressReport(TypedDict):
    total_number_of_scanned_files: NotRequired[
        "aws_sdk_healthlake.types.generic_long.GenericLong"
    ]
    """<p>The number of files scanned from the S3 input bucket.</p>"""
    total_size_of_scanned_files_in_mb: NotRequired[
        "aws_sdk_healthlake.types.generic_double.GenericDouble"
    ]
    ...
    throughput: NotRequired["aws_sdk_healthlake.types.generic_double.GenericDouble"]
