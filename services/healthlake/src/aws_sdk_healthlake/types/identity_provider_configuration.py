...
if TYPE_CHECKING:
    import aws_sdk_healthlake.types.authorization_strategy
    import aws_sdk_healthlake.types.boolean
    import aws_sdk_healthlake.types.configuration_metadata
    import aws_sdk_healthlake.types.lambda_arn


class IdentityProviderConfiguration(TypedDict):
    authorization_strategy: (
        "aws_sdk_healthlake.types.authorization_strategy.AuthorizationStrategy"
    )
    ...
    fine_grained_authorization_enabled: "aws_sdk_healthlake.types.boolean.Boolean"
    """<p>The parameter to enable SMART on FHIR fine-grained authorization for the data store.</p>"""
    metadata: NotRequired[
        "aws_sdk_healthlake.types.configuration_metadata.ConfigurationMetadata"
    ]
    ...
    idp_lambda_arn: NotRequired["aws_sdk_healthlake.types.lambda_arn.LambdaArn"]
...
def serialize_aws_json_1_0(value: IdentityProviderConfiguration) -> dict:
    ...
    out["AuthorizationStrategy"] = (
        aws_sdk_healthlake.types.authorization_strategy.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> IdentityProviderConfiguration:
    ...
    if "AuthorizationStrategy" in data:
        ...
        out["authorization_strategy"] = (
            aws_sdk_healthlake.types.authorization_strategy.deserialize_aws_json_1_0(
