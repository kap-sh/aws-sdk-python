...
def serialize_aws_json_1_0(value: KmsEncryptionConfig) -> dict:
    ...
    out["CmkType"] = aws_sdk_healthlake.types.cmk_type.serialize_aws_json_1_0(
        value["cmk_type"]
    )
...
def deserialize_aws_json_1_0(data: dict) -> KmsEncryptionConfig:
    ...
    if "CmkType" in data:
        ...
        out["cmk_type"] = aws_sdk_healthlake.types.cmk_type.deserialize_aws_json_1_0(
            data["CmkType"]
        )
    else:
