...
class HealthLakeError(Exception):
    """Base class for all HealthLake service errors."""


class ServiceError(HealthLakeError):
...
class SerializationError(HealthLakeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(HealthLakeError):
...
class WaiterFailedError(HealthLakeError):
...
class WaiterTimeoutError(HealthLakeError):
