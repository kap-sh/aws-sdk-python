...
class DescribeStreamInput(TypedDict, closed=True):
    ...
    shard_filter: NotRequired["aws_sdk_dynamodb_streams.types.shard_filter.ShardFilter"]
...
def serialize_aws_json_1_0(value: DescribeStreamInput) -> dict:
    ...
    if "shard_filter" in value:
        ...
        out["ShardFilter"] = (
            aws_sdk_dynamodb_streams.types.shard_filter.serialize_aws_json_1_0(
                value["shard_filter"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> DescribeStreamInput:
    ...
    if "ShardFilter" in data:
        ...
        out["shard_filter"] = (
            aws_sdk_dynamodb_streams.types.shard_filter.deserialize_aws_json_1_0(
                data["ShardFilter"]
            )
        )
    return out
