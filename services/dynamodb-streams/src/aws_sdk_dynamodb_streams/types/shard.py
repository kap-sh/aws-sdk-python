...
class Shard(TypedDict, closed=True):
    ...
    sequence_number_range: NotRequired[
        "aws_sdk_dynamodb_streams.types.sequence_number_range.SequenceNumberRange"
    ]
    """<p>The range of possible sequence numbers for the shard.</p>"""
    parent_shard_id: NotRequired["aws_sdk_dynamodb_streams.types.shard_id.ShardId"]
...
def serialize_aws_json_1_0(value: Shard) -> dict:
    ...
    if "sequence_number_range" in value:
        ...
        out["SequenceNumberRange"] = (
            aws_sdk_dynamodb_streams.types.sequence_number_range.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Shard:
    ...
    if "SequenceNumberRange" in data:
        ...
        out["sequence_number_range"] = (
            aws_sdk_dynamodb_streams.types.sequence_number_range.deserialize_aws_json_1_0(
