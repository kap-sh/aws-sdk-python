...
from ._services.async_dynamo_db_streams import (
    AsyncDynamoDBStreamsClient as AsyncDynamoDBStreamsClient,
)
from ._services.dynamo_db_streams import DynamoDBStreamsClient as DynamoDBStreamsClient
