...
class DynamoDBStreamsError(Exception):
    """Base class for all DynamoDBStreams service errors."""


class ServiceError(DynamoDBStreamsError):
...
class SerializationError(DynamoDBStreamsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DynamoDBStreamsError):
...
class WaiterFailedError(DynamoDBStreamsError):
...
class WaiterTimeoutError(DynamoDBStreamsError):
