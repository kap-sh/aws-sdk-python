"""Generated from Smithy shape ``com.amazonaws.dynamodbstreams#InternalServerError``."""
...
class InternalServerError(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.dynamodbstreams#InternalServerError``."""
