...
```
pip install aws-sdk-license-manager
```

## Usage

```python
from aws_sdk_license_manager import AsyncLicenseManagerClient
...
```python
from aws_sdk_license_manager import AsyncLicenseManagerClient
from aws_sdk_license_manager.error import AccessDeniedException
