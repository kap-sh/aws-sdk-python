...
```
pip install capo-license-manager
```

## Usage

```python
from capo_license_manager import AsyncLicenseManagerClient
...
```python
from capo_license_manager import AsyncLicenseManagerClient
from capo_license_manager.error import AccessDeniedException
