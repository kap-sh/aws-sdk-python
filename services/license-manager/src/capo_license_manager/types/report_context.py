...
class ReportContext(TypedDict, closed=True):
    license_configuration_arns: "capo_license_manager.types.arn_list.ArnList"
    """<p>Amazon Resource Name (ARN) of the license configuration that this generator reports on.</p>"""
    license_asset_group_arns: NotRequired["capo_license_manager.types.arn_list.ArnList"]
    """<p>Amazon Resource Names (ARNs) of the license asset groups to include in the report.</p>"""
    report_start_date: NotRequired["capo_license_manager.types.date_time.DateTime"]
    """<p>Start date for the report data collection period.</p>"""
    report_end_date: NotRequired["capo_license_manager.types.date_time.DateTime"]
...
def serialize_aws_json_1_1(value: ReportContext) -> dict:
    ...
    out["licenseConfigurationArns"] = (
        capo_license_manager.types.arn_list.serialize_aws_json_1_1(
