"""Generated from Smithy shape ``com.amazonaws.licensemanager#CreateLicenseManagerReportGenerator``."""
...
import capo_license_manager.errors.resource_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceLimitExceededException":
            raise capo_license_manager.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_license_manager.types.create_license_manager_report_generator_response.CreateLicenseManagerReportGeneratorResponse = capo_license_manager.types.create_license_manager_report_generator_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.CreateLicenseManagerReportGenerator"
    body: bytes | None = json.dumps(
        capo_license_manager.types.create_license_manager_report_generator_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_license_manager_report_generator(
