"""Generated from Smithy shape ``com.amazonaws.licensemanager#CreateLicenseConfiguration``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.create_license_configuration_response.CreateLicenseConfigurationResponse = capo_license_manager.types.create_license_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.create_license_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_license_configuration(
