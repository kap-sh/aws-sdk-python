...
def handle_response(
    ...
    out: capo_license_manager.types.get_service_settings_response.GetServiceSettingsResponse = capo_license_manager.types.get_service_settings_response.deserialize_aws_json_1_1(
