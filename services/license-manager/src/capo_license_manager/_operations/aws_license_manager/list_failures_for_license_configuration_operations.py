"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListFailuresForLicenseConfigurationOperations``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.list_failures_for_license_configuration_operations_response.ListFailuresForLicenseConfigurationOperationsResponse = capo_license_manager.types.list_failures_for_license_configuration_operations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_failures_for_license_configuration_operations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_failures_for_license_configuration_operations(
