"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListTokens``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.list_tokens_response.ListTokensResponse = (
        capo_license_manager.types.list_tokens_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ListTokens"
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_tokens_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_tokens(
    ...
    capo_license_manager.types.list_tokens_response.ListTokensResponse, zapros.Response
]:
