"""Generated from Smithy shape ``com.amazonaws.licensemanager#CreateLicenseAssetGroup``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.create_license_asset_group_response.CreateLicenseAssetGroupResponse = capo_license_manager.types.create_license_asset_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.CreateLicenseAssetGroup"
    body: bytes | None = json.dumps(
        capo_license_manager.types.create_license_asset_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_license_asset_group(
