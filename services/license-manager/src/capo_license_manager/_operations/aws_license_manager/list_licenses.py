"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicenses``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.list_licenses_response.ListLicensesResponse = (
        capo_license_manager.types.list_licenses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ListLicenses"
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_licenses_request.serialize_aws_json_1_1(input_)
    ).encode()
