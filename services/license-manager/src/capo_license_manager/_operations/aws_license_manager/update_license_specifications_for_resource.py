"""Generated from Smithy shape ``com.amazonaws.licensemanager#UpdateLicenseSpecificationsForResource``."""
...
import capo_license_manager.errors.invalid_resource_state_exception
import capo_license_manager.errors.license_usage_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourceStateException":
            raise capo_license_manager.errors.invalid_resource_state_exception.InvalidResourceStateException.from_aws_json_1_1(
                data
            )
        case "LicenseUsageException":
            raise capo_license_manager.errors.license_usage_exception.LicenseUsageException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_license_manager.types.update_license_specifications_for_resource_response.UpdateLicenseSpecificationsForResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.update_license_specifications_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_license_specifications_for_resource(
