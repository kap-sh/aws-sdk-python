"""Generated from Smithy shape ``com.amazonaws.licensemanager#GetLicenseUsage``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.get_license_usage_response.GetLicenseUsageResponse = capo_license_manager.types.get_license_usage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.GetLicenseUsage"
    body: bytes | None = json.dumps(
        capo_license_manager.types.get_license_usage_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_license_usage(
