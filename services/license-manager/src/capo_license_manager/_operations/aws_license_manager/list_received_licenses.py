"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListReceivedLicenses``."""
...
import capo_license_manager.types.granted_license_list
...
def handle_response(
    ...
    out: capo_license_manager.types.list_received_licenses_response.ListReceivedLicensesResponse = capo_license_manager.types.list_received_licenses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ListReceivedLicenses"
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_received_licenses_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_received_licenses(
