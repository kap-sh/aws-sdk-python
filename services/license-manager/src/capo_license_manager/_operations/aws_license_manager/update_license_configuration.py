"""Generated from Smithy shape ``com.amazonaws.licensemanager#UpdateLicenseConfiguration``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.update_license_configuration_response.UpdateLicenseConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.update_license_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_license_configuration(
