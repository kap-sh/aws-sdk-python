"""Generated from Smithy shape ``com.amazonaws.licensemanager#CheckoutBorrowLicense``."""
...
import capo_license_manager.errors.entitlement_not_allowed_exception
import capo_license_manager.errors.invalid_parameter_value_exception
import capo_license_manager.errors.no_entitlements_allowed_exception
...
import capo_license_manager.errors.unsupported_digital_signature_method_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EntitlementNotAllowedException":
            raise capo_license_manager.errors.entitlement_not_allowed_exception.EntitlementNotAllowedException.from_aws_json_1_1(
                data
            )
        case "InvalidParameterValueException":
            raise capo_license_manager.errors.invalid_parameter_value_exception.InvalidParameterValueException.from_aws_json_1_1(
                data
            )
        case "NoEntitlementsAllowedException":
            raise capo_license_manager.errors.no_entitlements_allowed_exception.NoEntitlementsAllowedException.from_aws_json_1_1(
                data
            )
        ...
        case "UnsupportedDigitalSignatureMethodException":
            raise capo_license_manager.errors.unsupported_digital_signature_method_exception.UnsupportedDigitalSignatureMethodException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_license_manager.types.checkout_borrow_license_response.CheckoutBorrowLicenseResponse = capo_license_manager.types.checkout_borrow_license_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.checkout_borrow_license_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_checkout_borrow_license(
