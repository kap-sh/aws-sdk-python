"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicenseAssetGroups``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.list_license_asset_groups_response.ListLicenseAssetGroupsResponse = capo_license_manager.types.list_license_asset_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ListLicenseAssetGroups"
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_license_asset_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_license_asset_groups(
