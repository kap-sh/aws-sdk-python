"""Generated from Smithy shape ``com.amazonaws.licensemanager#DeleteLicenseAssetRuleset``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.delete_license_asset_ruleset_response.DeleteLicenseAssetRulesetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.DeleteLicenseAssetRuleset"
    body: bytes | None = json.dumps(
        capo_license_manager.types.delete_license_asset_ruleset_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_license_asset_ruleset(
