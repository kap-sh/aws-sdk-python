"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListUsageForLicenseConfiguration``."""
...
import capo_license_manager.errors.filter_limit_exceeded_exception
...
import capo_license_manager.types.license_configuration_usage_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FilterLimitExceededException":
            raise capo_license_manager.errors.filter_limit_exceeded_exception.FilterLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_license_manager.types.list_usage_for_license_configuration_response.ListUsageForLicenseConfigurationResponse = capo_license_manager.types.list_usage_for_license_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_usage_for_license_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_usage_for_license_configuration(
