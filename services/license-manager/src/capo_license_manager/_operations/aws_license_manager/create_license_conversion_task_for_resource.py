"""Generated from Smithy shape ``com.amazonaws.licensemanager#CreateLicenseConversionTaskForResource``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.create_license_conversion_task_for_resource_response.CreateLicenseConversionTaskForResourceResponse = capo_license_manager.types.create_license_conversion_task_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.CreateLicenseConversionTaskForResource"
    body: bytes | None = json.dumps(
        capo_license_manager.types.create_license_conversion_task_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_license_conversion_task_for_resource(
