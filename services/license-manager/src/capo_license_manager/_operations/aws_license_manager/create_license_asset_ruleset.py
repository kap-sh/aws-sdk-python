"""Generated from Smithy shape ``com.amazonaws.licensemanager#CreateLicenseAssetRuleset``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.create_license_asset_ruleset_response.CreateLicenseAssetRulesetResponse = capo_license_manager.types.create_license_asset_ruleset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.CreateLicenseAssetRuleset"
    body: bytes | None = json.dumps(
        capo_license_manager.types.create_license_asset_ruleset_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_license_asset_ruleset(
