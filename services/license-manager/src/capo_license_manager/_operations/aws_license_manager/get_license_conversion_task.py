"""Generated from Smithy shape ``com.amazonaws.licensemanager#GetLicenseConversionTask``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.get_license_conversion_task_response.GetLicenseConversionTaskResponse = capo_license_manager.types.get_license_conversion_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.GetLicenseConversionTask"
    body: bytes | None = json.dumps(
        capo_license_manager.types.get_license_conversion_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_license_conversion_task(
