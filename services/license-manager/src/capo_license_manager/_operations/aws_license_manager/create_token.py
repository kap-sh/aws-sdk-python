"""Generated from Smithy shape ``com.amazonaws.licensemanager#CreateToken``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.create_token_response.CreateTokenResponse = (
        capo_license_manager.types.create_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.CreateToken"
    body: bytes | None = json.dumps(
        capo_license_manager.types.create_token_request.serialize_aws_json_1_1(input_)
    ).encode()
