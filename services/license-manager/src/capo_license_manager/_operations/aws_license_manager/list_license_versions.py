"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicenseVersions``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.list_license_versions_response.ListLicenseVersionsResponse = capo_license_manager.types.list_license_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ListLicenseVersions"
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_license_versions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_license_versions(
