"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListReceivedGrantsForOrganization``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.list_received_grants_for_organization_response.ListReceivedGrantsForOrganizationResponse = capo_license_manager.types.list_received_grants_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ListReceivedGrantsForOrganization"
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_received_grants_for_organization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_received_grants_for_organization(
