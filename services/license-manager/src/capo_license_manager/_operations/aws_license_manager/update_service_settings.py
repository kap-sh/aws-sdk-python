...
def handle_response(
    ...
    out: capo_license_manager.types.update_service_settings_response.UpdateServiceSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.update_service_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
