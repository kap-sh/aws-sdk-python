"""Generated from Smithy shape ``com.amazonaws.licensemanager#CheckInLicense``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.check_in_license_response.CheckInLicenseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.CheckInLicense"
    body: bytes | None = json.dumps(
        capo_license_manager.types.check_in_license_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_check_in_license(
