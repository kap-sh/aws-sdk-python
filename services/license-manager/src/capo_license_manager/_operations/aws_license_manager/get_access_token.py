...
def handle_response(
    ...
    out: capo_license_manager.types.get_access_token_response.GetAccessTokenResponse = (
        capo_license_manager.types.get_access_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.get_access_token_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
