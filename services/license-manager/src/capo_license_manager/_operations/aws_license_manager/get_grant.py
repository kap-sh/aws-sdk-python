"""Generated from Smithy shape ``com.amazonaws.licensemanager#GetGrant``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.get_grant_response.GetGrantResponse = (
        capo_license_manager.types.get_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.GetGrant"
    body: bytes | None = json.dumps(
        capo_license_manager.types.get_grant_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_grant(
    ...
    capo_license_manager.types.get_grant_response.GetGrantResponse, zapros.Response
]:
