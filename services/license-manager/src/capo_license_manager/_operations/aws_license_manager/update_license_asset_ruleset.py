"""Generated from Smithy shape ``com.amazonaws.licensemanager#UpdateLicenseAssetRuleset``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.update_license_asset_ruleset_response.UpdateLicenseAssetRulesetResponse = capo_license_manager.types.update_license_asset_ruleset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.UpdateLicenseAssetRuleset"
    body: bytes | None = json.dumps(
        capo_license_manager.types.update_license_asset_ruleset_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_license_asset_ruleset(
