"""Generated from Smithy shape ``com.amazonaws.licensemanager#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.licensemanager#ConflictException``."""
