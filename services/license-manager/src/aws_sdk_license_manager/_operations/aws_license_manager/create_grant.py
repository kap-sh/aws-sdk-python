"""Generated from Smithy shape ``com.amazonaws.licensemanager#CreateGrant``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.create_grant_response.CreateGrantResponse = (
        aws_sdk_license_manager.types.create_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_license_manager.types.create_grant_request.CreateGrantRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.CreateGrant"
    import aws_sdk_license_manager.types.create_grant_request

    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.create_grant_request.serialize_aws_json_1_1(input)
    ).encode()
