"""Generated from Smithy shape ``com.amazonaws.licensemanager#GetAccessToken``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.get_access_token_response.GetAccessTokenResponse = aws_sdk_license_manager.types.get_access_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.get_access_token_request.GetAccessTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.GetAccessToken"
    import aws_sdk_license_manager.types.get_access_token_request

    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.get_access_token_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
