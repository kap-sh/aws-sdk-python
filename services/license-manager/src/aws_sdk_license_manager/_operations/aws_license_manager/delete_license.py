"""Generated from Smithy shape ``com.amazonaws.licensemanager#DeleteLicense``."""
...
import aws_sdk_license_manager.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_license_manager.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.delete_license_response.DeleteLicenseResponse = (
        aws_sdk_license_manager.types.delete_license_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.delete_license_request.DeleteLicenseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.DeleteLicense"
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.delete_license_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_license(
