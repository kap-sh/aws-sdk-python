...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.check_in_license_response.CheckInLicenseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.check_in_license_request.CheckInLicenseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.check_in_license_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
