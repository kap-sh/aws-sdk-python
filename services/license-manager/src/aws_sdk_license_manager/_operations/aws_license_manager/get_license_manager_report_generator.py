...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.get_license_manager_report_generator_response.GetLicenseManagerReportGeneratorResponse = aws_sdk_license_manager.types.get_license_manager_report_generator_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.get_license_manager_report_generator_request.GetLicenseManagerReportGeneratorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.get_license_manager_report_generator_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
