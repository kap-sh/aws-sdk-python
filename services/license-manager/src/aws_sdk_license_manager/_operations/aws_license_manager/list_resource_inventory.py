...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_resource_inventory_request.ListResourceInventoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_resource_inventory_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
