"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicenseAssetRulesets``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_license_asset_rulesets_response.ListLicenseAssetRulesetsResponse = aws_sdk_license_manager.types.list_license_asset_rulesets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_license_asset_rulesets_request.ListLicenseAssetRulesetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ListLicenseAssetRulesets"
    import aws_sdk_license_manager.types.list_license_asset_rulesets_request

    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_license_asset_rulesets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_license_asset_rulesets(
