"""Generated from Smithy shape ``com.amazonaws.licensemanager#AcceptGrant``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.accept_grant_response.AcceptGrantResponse = (
        aws_sdk_license_manager.types.accept_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_license_manager.types.accept_grant_request.AcceptGrantRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.AcceptGrant"
    import aws_sdk_license_manager.types.accept_grant_request

    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.accept_grant_request.serialize_aws_json_1_1(input)
    ).encode()
