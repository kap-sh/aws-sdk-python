"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicenseSpecificationsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_license_specifications_for_resource_response.ListLicenseSpecificationsForResourceResponse = aws_sdk_license_manager.types.list_license_specifications_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_license_specifications_for_resource_request.ListLicenseSpecificationsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_license_specifications_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_license_specifications_for_resource(
