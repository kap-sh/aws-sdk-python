...
def build_request(
    ...
    input: aws_sdk_license_manager.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.tag_resource_request.serialize_aws_json_1_1(input)
    ).encode()
