...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.delete_grant_response.DeleteGrantResponse = (
        aws_sdk_license_manager.types.delete_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_license_manager.types.delete_grant_request.DeleteGrantRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.delete_grant_request.serialize_aws_json_1_1(input)
    ).encode()
