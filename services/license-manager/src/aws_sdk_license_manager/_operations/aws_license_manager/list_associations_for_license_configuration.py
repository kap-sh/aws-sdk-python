...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_associations_for_license_configuration_response.ListAssociationsForLicenseConfigurationResponse = aws_sdk_license_manager.types.list_associations_for_license_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_associations_for_license_configuration_request.ListAssociationsForLicenseConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
