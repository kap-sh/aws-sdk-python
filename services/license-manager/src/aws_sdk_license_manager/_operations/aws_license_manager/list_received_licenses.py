...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_received_licenses_response.ListReceivedLicensesResponse = aws_sdk_license_manager.types.list_received_licenses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_received_licenses_request.ListReceivedLicensesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_received_licenses_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
