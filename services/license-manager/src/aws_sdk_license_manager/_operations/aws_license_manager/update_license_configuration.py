...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.update_license_configuration_response.UpdateLicenseConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.update_license_configuration_request.UpdateLicenseConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.update_license_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
