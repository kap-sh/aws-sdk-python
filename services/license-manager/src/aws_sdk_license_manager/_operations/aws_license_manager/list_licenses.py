...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_licenses_response.ListLicensesResponse = (
        aws_sdk_license_manager.types.list_licenses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_licenses_request.ListLicensesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_licenses_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
