...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.delete_license_asset_ruleset_response.DeleteLicenseAssetRulesetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.delete_license_asset_ruleset_request.DeleteLicenseAssetRulesetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.delete_license_asset_ruleset_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
