...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.get_grant_response.GetGrantResponse = (
        aws_sdk_license_manager.types.get_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.get_grant_request.GetGrantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.get_grant_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_grant(
    ...
    aws_sdk_license_manager.types.get_grant_response.GetGrantResponse, zapros.Response
]:
