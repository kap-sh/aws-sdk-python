...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.delete_license_manager_report_generator_response.DeleteLicenseManagerReportGeneratorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.delete_license_manager_report_generator_request.DeleteLicenseManagerReportGeneratorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.delete_license_manager_report_generator_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
