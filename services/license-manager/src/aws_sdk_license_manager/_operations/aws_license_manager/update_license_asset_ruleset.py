...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.update_license_asset_ruleset_response.UpdateLicenseAssetRulesetResponse = aws_sdk_license_manager.types.update_license_asset_ruleset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.update_license_asset_ruleset_request.UpdateLicenseAssetRulesetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.update_license_asset_ruleset_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
