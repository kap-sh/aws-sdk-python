...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_tokens_response.ListTokensResponse = (
        aws_sdk_license_manager.types.list_tokens_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_tokens_request.ListTokensRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_tokens_request.serialize_aws_json_1_1(input_)
    ).encode()
