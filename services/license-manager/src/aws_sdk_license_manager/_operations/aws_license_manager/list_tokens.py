...
def build_request(
    ...
    input: aws_sdk_license_manager.types.list_tokens_request.ListTokensRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_tokens_request.serialize_aws_json_1_1(input)
    ).encode()
