"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicenseConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_license_configurations_response.ListLicenseConfigurationsResponse = aws_sdk_license_manager.types.list_license_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_license_configurations_request.ListLicenseConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_license_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_license_configurations(
