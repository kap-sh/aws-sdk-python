...
def build_request(
    ...
    input: aws_sdk_license_manager.types.create_token_request.CreateTokenRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.create_token_request.serialize_aws_json_1_1(input)
    ).encode()
