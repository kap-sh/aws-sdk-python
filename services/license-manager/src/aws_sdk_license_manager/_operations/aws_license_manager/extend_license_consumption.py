"""Generated from Smithy shape ``com.amazonaws.licensemanager#ExtendLicenseConsumption``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.extend_license_consumption_response.ExtendLicenseConsumptionResponse = aws_sdk_license_manager.types.extend_license_consumption_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.extend_license_consumption_request.ExtendLicenseConsumptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ExtendLicenseConsumption"
    import aws_sdk_license_manager.types.extend_license_consumption_request

    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.extend_license_consumption_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_extend_license_consumption(
