...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.get_license_asset_group_response.GetLicenseAssetGroupResponse = aws_sdk_license_manager.types.get_license_asset_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.get_license_asset_group_request.GetLicenseAssetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.get_license_asset_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
