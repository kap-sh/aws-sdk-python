...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourceStateException":
            import aws_sdk_license_manager.errors.invalid_resource_state_exception

            raise aws_sdk_license_manager.errors.invalid_resource_state_exception.InvalidResourceStateException.from_aws_json_1_1(
                data
            )
        case "LicenseUsageException":
            import aws_sdk_license_manager.errors.license_usage_exception

            raise aws_sdk_license_manager.errors.license_usage_exception.LicenseUsageException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.update_license_specifications_for_resource_response.UpdateLicenseSpecificationsForResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.update_license_specifications_for_resource_request.UpdateLicenseSpecificationsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.update_license_specifications_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
