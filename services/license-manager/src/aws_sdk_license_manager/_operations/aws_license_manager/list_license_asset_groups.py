...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_license_asset_groups_response.ListLicenseAssetGroupsResponse = aws_sdk_license_manager.types.list_license_asset_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_license_asset_groups_request.ListLicenseAssetGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_license_asset_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
