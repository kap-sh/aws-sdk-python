"""Generated from Smithy shape ``com.amazonaws.licensemanager#GetServiceSettings``."""
...
import aws_sdk_license_manager.types.service_status
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.get_service_settings_response.GetServiceSettingsResponse = aws_sdk_license_manager.types.get_service_settings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.get_service_settings_request.GetServiceSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
