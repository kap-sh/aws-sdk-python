...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_license_conversion_tasks_response.ListLicenseConversionTasksResponse = aws_sdk_license_manager.types.list_license_conversion_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_license_conversion_tasks_request.ListLicenseConversionTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_license_conversion_tasks_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
