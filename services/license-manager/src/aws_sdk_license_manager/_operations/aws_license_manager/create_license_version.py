...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.create_license_version_response.CreateLicenseVersionResponse = aws_sdk_license_manager.types.create_license_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.create_license_version_request.CreateLicenseVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.create_license_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
