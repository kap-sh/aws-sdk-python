"""Generated from Smithy shape ``com.amazonaws.licensemanager#GetLicense``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.get_license_response.GetLicenseResponse = (
        aws_sdk_license_manager.types.get_license_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.get_license_request.GetLicenseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.GetLicense"
    import aws_sdk_license_manager.types.get_license_request

    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.get_license_request.serialize_aws_json_1_1(input_)
    ).encode()
