...
def build_request(
    ...
    input: aws_sdk_license_manager.types.get_license_request.GetLicenseRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.get_license_request.serialize_aws_json_1_1(input)
    ).encode()
