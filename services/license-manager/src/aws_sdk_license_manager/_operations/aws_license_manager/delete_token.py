"""Generated from Smithy shape ``com.amazonaws.licensemanager#DeleteToken``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.delete_token_response.DeleteTokenResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_license_manager.types.delete_token_request.DeleteTokenRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.DeleteToken"
    import aws_sdk_license_manager.types.delete_token_request

    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.delete_token_request.serialize_aws_json_1_1(input)
    ).encode()
