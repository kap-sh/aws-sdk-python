"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListDistributedGrants``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_distributed_grants_response.ListDistributedGrantsResponse = aws_sdk_license_manager.types.list_distributed_grants_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_distributed_grants_request.ListDistributedGrantsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ListDistributedGrants"
    import aws_sdk_license_manager.types.list_distributed_grants_request

    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_distributed_grants_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_distributed_grants(
