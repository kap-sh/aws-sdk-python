"""Generated from Smithy shape ``com.amazonaws.licensemanager#UpdateLicenseAssetGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.update_license_asset_group_response.UpdateLicenseAssetGroupResponse = aws_sdk_license_manager.types.update_license_asset_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.update_license_asset_group_request.UpdateLicenseAssetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.UpdateLicenseAssetGroup"
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.update_license_asset_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_license_asset_group(
