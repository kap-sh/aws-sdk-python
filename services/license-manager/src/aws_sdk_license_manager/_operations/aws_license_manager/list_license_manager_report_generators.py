...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_license_manager_report_generators_response.ListLicenseManagerReportGeneratorsResponse = aws_sdk_license_manager.types.list_license_manager_report_generators_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_license_manager_report_generators_request.ListLicenseManagerReportGeneratorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
