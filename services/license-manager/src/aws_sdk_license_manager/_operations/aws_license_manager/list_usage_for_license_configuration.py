...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_usage_for_license_configuration_response.ListUsageForLicenseConfigurationResponse = aws_sdk_license_manager.types.list_usage_for_license_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_usage_for_license_configuration_request.ListUsageForLicenseConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_usage_for_license_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
