...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_received_licenses_for_organization_response.ListReceivedLicensesForOrganizationResponse = aws_sdk_license_manager.types.list_received_licenses_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_received_licenses_for_organization_request.ListReceivedLicensesForOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.list_received_licenses_for_organization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
