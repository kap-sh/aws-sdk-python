...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.create_license_response.CreateLicenseResponse = (
        aws_sdk_license_manager.types.create_license_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.create_license_request.CreateLicenseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.create_license_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
