"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListAssetsForLicenseAssetGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.list_assets_for_license_asset_group_response.ListAssetsForLicenseAssetGroupResponse = aws_sdk_license_manager.types.list_assets_for_license_asset_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.list_assets_for_license_asset_group_request.ListAssetsForLicenseAssetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_assets_for_license_asset_group(
