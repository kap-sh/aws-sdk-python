...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.create_license_configuration_response.CreateLicenseConfigurationResponse = aws_sdk_license_manager.types.create_license_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.create_license_configuration_request.CreateLicenseConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.create_license_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
