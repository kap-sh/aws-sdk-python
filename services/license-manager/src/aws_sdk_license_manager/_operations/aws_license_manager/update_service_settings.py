"""Generated from Smithy shape ``com.amazonaws.licensemanager#UpdateServiceSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.update_service_settings_response.UpdateServiceSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.update_service_settings_request.UpdateServiceSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.update_service_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_service_settings(
