...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.reject_grant_response.RejectGrantResponse = (
        aws_sdk_license_manager.types.reject_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_license_manager.types.reject_grant_request.RejectGrantRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.reject_grant_request.serialize_aws_json_1_1(input)
    ).encode()
