...
def handle_response(
    ...
    out: aws_sdk_license_manager.types.delete_license_asset_group_response.DeleteLicenseAssetGroupResponse = aws_sdk_license_manager.types.delete_license_asset_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_license_manager.types.delete_license_asset_group_request.DeleteLicenseAssetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager.types.delete_license_asset_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
