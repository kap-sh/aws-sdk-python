...
class LicenseManagerError(Exception):
    """Base class for all LicenseManager service errors."""


class ServiceError(LicenseManagerError):
...
class SerializationError(LicenseManagerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LicenseManagerError):
...
class WaiterFailedError(LicenseManagerError):
...
class WaiterTimeoutError(LicenseManagerError):
