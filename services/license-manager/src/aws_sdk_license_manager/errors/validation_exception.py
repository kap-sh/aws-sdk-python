"""Generated from Smithy shape ``com.amazonaws.licensemanager#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.licensemanager#ValidationException``."""
