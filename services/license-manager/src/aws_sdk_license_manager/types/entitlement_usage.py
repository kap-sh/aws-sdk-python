...
if TYPE_CHECKING:
    import aws_sdk_license_manager.types.entitlement_data_unit
...
class EntitlementUsage(TypedDict):
    ...
    consumed_value: "aws_sdk_license_manager.types.string.String"
    """<p>Resource usage consumed.</p>"""
    max_count: NotRequired["aws_sdk_license_manager.types.string.String"]
    """<p>Maximum entitlement usage count.</p>"""
    unit: "aws_sdk_license_manager.types.entitlement_data_unit.EntitlementDataUnit"
...
def serialize_aws_json_1_1(value: EntitlementUsage) -> dict:
    ...
    out["Unit"] = (
        aws_sdk_license_manager.types.entitlement_data_unit.serialize_aws_json_1_1(
            value["unit"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> EntitlementUsage:
    ...
    if "Unit" in data:
        ...
        out["unit"] = (
            aws_sdk_license_manager.types.entitlement_data_unit.deserialize_aws_json_1_1(
                data["Unit"]
            )
        )
    else:
