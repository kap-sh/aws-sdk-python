...
class Grant(TypedDict):
    ...
    """<p>Grant name.</p>"""
    parent_arn: "aws_sdk_license_manager.types.arn.Arn"
    """<p>Parent ARN.</p>"""
    license_arn: "aws_sdk_license_manager.types.arn.Arn"
    """<p>License ARN.</p>"""
    grantee_principal_arn: "aws_sdk_license_manager.types.arn.Arn"
    """<p>The grantee principal ARN.</p>"""
    home_region: "aws_sdk_license_manager.types.string.String"
    """<p>Home Region of the grant.</p>"""
    grant_status: "aws_sdk_license_manager.types.grant_status.GrantStatus"
    """<p>Grant status.</p>"""
