"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicenseConfigurationsResponse``."""
...
class ListLicenseConfigurationsResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListLicenseConfigurationsResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListLicenseConfigurationsResponse:
    out: ListLicenseConfigurationsResponse = {}  # type: ignore[typeddict-item]
