"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListReceivedGrantsResponse``."""
...
class ListReceivedGrantsResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListReceivedGrantsResponse) -> dict:
    out: dict = {}
    if "grants" in value:
        import aws_sdk_license_manager.types.grant_list
...
def deserialize_aws_json_1_1(data: dict) -> ListReceivedGrantsResponse:
    out: ListReceivedGrantsResponse = {}  # type: ignore[typeddict-item]
    if "Grants" in data:
        import aws_sdk_license_manager.types.grant_list
