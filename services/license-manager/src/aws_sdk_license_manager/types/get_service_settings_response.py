...
class GetServiceSettingsResponse(TypedDict):
    ...
    service_status: NotRequired[
        "aws_sdk_license_manager.types.service_status.ServiceStatus"
    ]
    """<p>Service status.</p>"""
...
def serialize_aws_json_1_1(value: GetServiceSettingsResponse) -> dict:
    ...
    if "service_status" in value:
        ...
        out["ServiceStatus"] = (
            aws_sdk_license_manager.types.service_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetServiceSettingsResponse:
    ...
    if "ServiceStatus" in data:
        ...
        out["service_status"] = (
            aws_sdk_license_manager.types.service_status.deserialize_aws_json_1_1(
                data["ServiceStatus"]
            )
        )
    return out
