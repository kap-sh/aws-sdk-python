...
def serialize_aws_json_1_1(
    ...
    if "license_operation_failure_list" in value:
        ...
        out["LicenseOperationFailureList"] = (
            aws_sdk_license_manager.types.license_operation_failure_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "LicenseOperationFailureList" in data:
        ...
        out["license_operation_failure_list"] = (
            aws_sdk_license_manager.types.license_operation_failure_list.deserialize_aws_json_1_1(
