...
if TYPE_CHECKING:
    ...
    import aws_sdk_license_manager.types.received_metadata
    import aws_sdk_license_manager.types.string


class GrantedLicense(TypedDict):
    ...
    received_metadata: NotRequired[
        "aws_sdk_license_manager.types.received_metadata.ReceivedMetadata"
    ]
...
def serialize_aws_json_1_1(value: GrantedLicense) -> dict:
    ...
    if "received_metadata" in value:
        ...
        out["ReceivedMetadata"] = (
            aws_sdk_license_manager.types.received_metadata.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GrantedLicense:
    ...
    if "ReceivedMetadata" in data:
        ...
        out["received_metadata"] = (
            aws_sdk_license_manager.types.received_metadata.deserialize_aws_json_1_1(
