...
class ProductInformationFilter(TypedDict):
    product_information_filter_name: "aws_sdk_license_manager.types.string.String"
    """<p>Filter name.</p>"""
    product_information_filter_value: NotRequired[
        "aws_sdk_license_manager.types.string_list.StringList"
    ]
    """<p>Filter value.</p>"""
    product_information_filter_comparator: "aws_sdk_license_manager.types.string.String"
