"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListReceivedGrantsRequest``."""
...
class ListReceivedGrantsRequest(TypedDict, closed=True):
    grant_arns: NotRequired["aws_sdk_license_manager.types.arn_list.ArnList"]
    """<p>Amazon Resource Names (ARNs) of the grants.</p>"""
    filters: NotRequired["aws_sdk_license_manager.types.filter_list.FilterList"]
    """<p>Filters to scope the results. The following filters are supported:</p> <ul> <li> <p> <code>ProductSKU</code> </p> </li> <li> <p> <code>LicenseIssuerName</code> </p> </li> <li> <p> <code>LicenseArn</code> </p> </li> <li> <p> <code>GrantStatus</code> </p> </li> <li> <p> <code>GranterAccountId</code> </p> </li> </ul>"""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListReceivedGrantsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListReceivedGrantsRequest:
    out: ListReceivedGrantsRequest = {}  # type: ignore[typeddict-item]
