"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicenseVersionsResponse``."""
...
class ListLicenseVersionsResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListLicenseVersionsResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListLicenseVersionsResponse:
    out: ListLicenseVersionsResponse = {}  # type: ignore[typeddict-item]
    if "Licenses" in data:
        import aws_sdk_license_manager.types.license_list
