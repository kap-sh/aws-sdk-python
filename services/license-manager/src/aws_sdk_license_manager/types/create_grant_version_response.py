"""Generated from Smithy shape ``com.amazonaws.licensemanager#CreateGrantVersionResponse``."""
...
class CreateGrantVersionResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateGrantVersionResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateGrantVersionResponse:
    out: CreateGrantVersionResponse = {}  # type: ignore[typeddict-item]
    if "GrantArn" in data:
