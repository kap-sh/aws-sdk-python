...
if TYPE_CHECKING:
    ...
    import capo_finspace_data.types.data_view_arn
...
class GetDataViewResponse(TypedDict, closed=True):
    auto_update: "capo_finspace_data.types.boolean.Boolean"
    ...
    error_info: NotRequired[
        "capo_finspace_data.types.data_view_error_info.DataViewErrorInfo"
    ]
    ...
    data_view_id: NotRequired["capo_finspace_data.types.data_view_id.DataViewId"]
    """<p>The unique identifier for the Dataview.</p>"""
    data_view_arn: NotRequired["capo_finspace_data.types.data_view_arn.DataViewArn"]
    """<p>The ARN identifier of the Dataview.</p>"""
    destination_type_params: NotRequired[
        "capo_finspace_data.types.data_view_destination_type_params.DataViewDestinationTypeParams"
    ]
    """<p>Options that define the destination type for the Dataview.</p>"""
    status: NotRequired["capo_finspace_data.types.data_view_status.DataViewStatus"]
...
def serialize_json(value: GetDataViewResponse) -> dict:
    ...
    if "partition_columns" in value:
        ...
        out["partitionColumns"] = (
            capo_finspace_data.types.partition_column_list.serialize_json(
    ...
    if "error_info" in value:
        ...
        out["errorInfo"] = capo_finspace_data.types.data_view_error_info.serialize_json(
            value["error_info"]
        )
    ...
    if "sort_columns" in value:
        ...
        out["sortColumns"] = capo_finspace_data.types.sort_column_list.serialize_json(
            value["sort_columns"]
        )
    ...
    if "destination_type_params" in value:
        ...
        out["destinationTypeParams"] = (
            capo_finspace_data.types.data_view_destination_type_params.serialize_json(
    ...
    if "status" in value:
        ...
        out["status"] = capo_finspace_data.types.data_view_status.serialize_json(
            value["status"]
        )
    return out
...
def deserialize_json(data: dict) -> GetDataViewResponse:
    ...
    if "partitionColumns" in data:
        ...
        out["partition_columns"] = (
            capo_finspace_data.types.partition_column_list.deserialize_json(
    ...
    if "errorInfo" in data:
        ...
        out["error_info"] = (
            capo_finspace_data.types.data_view_error_info.deserialize_json(
                data["errorInfo"]
            )
        )
    ...
    if "sortColumns" in data:
        ...
        out["sort_columns"] = (
            capo_finspace_data.types.sort_column_list.deserialize_json(
                data["sortColumns"]
            )
        )
    ...
    if "destinationTypeParams" in data:
        ...
        out["destination_type_params"] = (
            capo_finspace_data.types.data_view_destination_type_params.deserialize_json(
