...
if TYPE_CHECKING:
    import capo_finspace_data.types.string_value_length1to2552
    import capo_finspace_data.types.string_value_max_length1000


class Credentials(TypedDict, closed=True):
    access_key_id: NotRequired[
        "capo_finspace_data.types.string_value_length1to2552.StringValueLength1to2552"
    ]
    """<p>The access key identifier.</p>"""
    secret_access_key: NotRequired[
        "capo_finspace_data.types.string_value_max_length1000.stringValueMaxLength1000"
    ]
    """<p>The access key.</p>"""
