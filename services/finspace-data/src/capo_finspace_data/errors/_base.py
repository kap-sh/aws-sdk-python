...
class finspacedataError(Exception):
    """Base class for all finspacedata service errors."""


class ServiceError(finspacedataError):
...
class SerializationError(finspacedataError):
    """Raised when a value cannot be serialized."""


class DeserializationError(finspacedataError):
...
class WaiterFailedError(finspacedataError):
...
class WaiterTimeoutError(finspacedataError):
