"""Generated from Smithy shape ``com.amazonaws.finspacedata#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.finspacedata#AccessDeniedException``."""
