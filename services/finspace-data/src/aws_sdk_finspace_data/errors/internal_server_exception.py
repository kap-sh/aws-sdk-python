"""Generated from Smithy shape ``com.amazonaws.finspacedata#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.finspacedata#InternalServerException``."""
