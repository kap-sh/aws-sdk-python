"""Generated from Smithy shape ``com.amazonaws.finspacedata#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.finspacedata#LimitExceededException``."""
