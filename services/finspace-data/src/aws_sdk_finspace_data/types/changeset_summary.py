...
if TYPE_CHECKING:
    ...
    import aws_sdk_finspace_data.types.changeset_arn
...
class ChangesetSummary(TypedDict):
    ...
    change_type: NotRequired["aws_sdk_finspace_data.types.change_type.ChangeType"]
    ...
    source_params: NotRequired["aws_sdk_finspace_data.types.source_params.SourceParams"]
    """<p>Options that define the location of the data being ingested.</p>"""
    format_params: NotRequired["aws_sdk_finspace_data.types.format_params.FormatParams"]
    ...
    status: NotRequired["aws_sdk_finspace_data.types.ingestion_status.IngestionStatus"]
    ...
    error_info: NotRequired[
        "aws_sdk_finspace_data.types.changeset_error_info.ChangesetErrorInfo"
    ]
    ...
    updates_changeset_id: NotRequired[
        "aws_sdk_finspace_data.types.changeset_id.ChangesetId"
    ]
...
def serialize_json(value: ChangesetSummary) -> dict:
    ...
    if "change_type" in value:
        ...
        out["changeType"] = aws_sdk_finspace_data.types.change_type.serialize_json(
            value["change_type"]
        )
    if "source_params" in value:
        import aws_sdk_finspace_data.types.source_params

        out["sourceParams"] = aws_sdk_finspace_data.types.source_params.serialize_json(
            value["source_params"]
        )
    if "format_params" in value:
        import aws_sdk_finspace_data.types.format_params

        out["formatParams"] = aws_sdk_finspace_data.types.format_params.serialize_json(
            value["format_params"]
        )
    ...
    if "status" in value:
        ...
        out["status"] = aws_sdk_finspace_data.types.ingestion_status.serialize_json(
            value["status"]
        )
    if "error_info" in value:
        ...
        out["errorInfo"] = (
            aws_sdk_finspace_data.types.changeset_error_info.serialize_json(
                value["error_info"]
            )
        )
...
def deserialize_json(data: dict) -> ChangesetSummary:
    ...
    if "changeType" in data:
        ...
        out["change_type"] = aws_sdk_finspace_data.types.change_type.deserialize_json(
            data["changeType"]
        )
    if "sourceParams" in data:
        ...
        out["source_params"] = (
            aws_sdk_finspace_data.types.source_params.deserialize_json(
                data["sourceParams"]
            )
        )
    if "formatParams" in data:
        ...
        out["format_params"] = (
            aws_sdk_finspace_data.types.format_params.deserialize_json(
                data["formatParams"]
            )
        )
    ...
    if "status" in data:
        ...
        out["status"] = aws_sdk_finspace_data.types.ingestion_status.deserialize_json(
            data["status"]
        )
    if "errorInfo" in data:
        ...
        out["error_info"] = (
            aws_sdk_finspace_data.types.changeset_error_info.deserialize_json(
                data["errorInfo"]
            )
        )
