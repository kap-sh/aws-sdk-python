"""Generated from Smithy shape ``com.amazonaws.finspacedata#GetDatasetResponse``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_finspace_data.types.dataset_status
...
class GetDatasetResponse(TypedDict, closed=True):
    ...
    status: NotRequired["aws_sdk_finspace_data.types.dataset_status.DatasetStatus"]
...
def serialize_json(value: GetDatasetResponse) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = aws_sdk_finspace_data.types.dataset_status.serialize_json(
            value["status"]
        )
    return out
...
def deserialize_json(data: dict) -> GetDatasetResponse:
    ...
    if "status" in data:
        ...
        out["status"] = aws_sdk_finspace_data.types.dataset_status.deserialize_json(
            data["status"]
        )
    return out
