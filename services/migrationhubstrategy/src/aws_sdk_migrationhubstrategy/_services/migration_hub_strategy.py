...
from aws_sdk_migrationhubstrategy._services._aws_config import aws_config
...
class MigrationHubStrategyClientConfig(TypedDict, total=False, closed=True):
...
class MigrationHubStrategyClient:
    ...
    def __init__(
        ...
        self._config = MigrationHubStrategyClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[MigrationHubStrategyClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: MigrationHubStrategyClientConfig = config_overrides or {}
    ...
    def get_application_component_details(
        ...
        *,
        config_overrides: Optional[MigrationHubStrategyClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.get_application_component_details_request.GetApplicationComponentDetailsRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.get_application_component_details_response.GetApplicationComponentDetailsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.get_application_component_details.get_application_component_details(
    ...
    def get_application_component_strategies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.get_application_component_strategies_request.GetApplicationComponentStrategiesRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.get_application_component_strategies_response.GetApplicationComponentStrategiesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.get_application_component_strategies.get_application_component_strategies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_assessment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.get_assessment_request.GetAssessmentRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.get_assessment_response.GetAssessmentResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.get_assessment.get_assessment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_import_file_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.get_import_file_task_request.GetImportFileTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.get_import_file_task_response.GetImportFileTaskResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.get_import_file_task.get_import_file_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_latest_assessment_id(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.get_latest_assessment_id_request.GetLatestAssessmentIdRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.get_latest_assessment_id_response.GetLatestAssessmentIdResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.get_latest_assessment_id.get_latest_assessment_id(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_portfolio_preferences(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.get_portfolio_preferences_request.GetPortfolioPreferencesRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.get_portfolio_preferences_response.GetPortfolioPreferencesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.get_portfolio_preferences.get_portfolio_preferences(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_portfolio_summary(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.get_portfolio_summary_request.GetPortfolioSummaryRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.get_portfolio_summary_response.GetPortfolioSummaryResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.get_portfolio_summary.get_portfolio_summary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_recommendation_report_details(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.get_recommendation_report_details_request.GetRecommendationReportDetailsRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.get_recommendation_report_details_response.GetRecommendationReportDetailsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.get_recommendation_report_details.get_recommendation_report_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_server_details(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.get_server_details_request.GetServerDetailsRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.get_server_details_response.GetServerDetailsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.get_server_details.get_server_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_migrationhubstrategy.types.associated_application.AssociatedApplication]":
        _token = next_token
        while True:
            _response = self.get_server_details(
                server_id,
    ...
    def get_server_strategies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.get_server_strategies_request.GetServerStrategiesRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.get_server_strategies_response.GetServerStrategiesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.get_server_strategies.get_server_strategies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_analyzable_servers(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_analyzable_servers(max_results=100, sort='ASC')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.list_analyzable_servers_request.ListAnalyzableServersRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.list_analyzable_servers_response.ListAnalyzableServersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.list_analyzable_servers.list_analyzable_servers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_migrationhubstrategy.types.analyzable_server_summary.AnalyzableServerSummary]":
        _token = next_token
        while True:
            _response = self.list_analyzable_servers(
                config_overrides=config_overrides,
                sort=sort,
                next_token=_token,
                max_results=max_results,
    ...
    def list_application_components(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.list_application_components_request.ListApplicationComponentsRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.list_application_components_response.ListApplicationComponentsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.list_application_components.list_application_components(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_migrationhubstrategy.types.application_component_detail.ApplicationComponentDetail]":
        _token = next_token
        while True:
            _response = self.list_application_components(
                config_overrides=config_overrides,
    ...
    def list_collectors(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.list_collectors_request.ListCollectorsRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.list_collectors_response.ListCollectorsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.list_collectors.list_collectors(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_migrationhubstrategy.types.collector.Collector]":
        _token = next_token
        while True:
            _response = self.list_collectors(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    def list_import_file_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.list_import_file_task_request.ListImportFileTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.list_import_file_task_response.ListImportFileTaskResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.list_import_file_task.list_import_file_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_migrationhubstrategy.types.import_file_task_information.ImportFileTaskInformation]":
        _token = next_token
        while True:
            _response = self.list_import_file_task(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    def list_servers(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.list_servers_request.ListServersRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.list_servers_response.ListServersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.list_servers.list_servers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_migrationhubstrategy.types.server_detail.ServerDetail]":
        _token = next_token
        while True:
    ...
    def put_portfolio_preferences(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.put_portfolio_preferences_request.PutPortfolioPreferencesRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.put_portfolio_preferences_response.PutPortfolioPreferencesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.put_portfolio_preferences.put_portfolio_preferences(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_assessment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.start_assessment_request.StartAssessmentRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.start_assessment_response.StartAssessmentResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.start_assessment.start_assessment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_import_file_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.start_import_file_task_request.StartImportFileTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.start_import_file_task_response.StartImportFileTaskResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.start_import_file_task.start_import_file_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_recommendation_report_generation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.start_recommendation_report_generation_request.StartRecommendationReportGenerationRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.start_recommendation_report_generation_response.StartRecommendationReportGenerationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.start_recommendation_report_generation.start_recommendation_report_generation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_assessment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.stop_assessment_request.StopAssessmentRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.stop_assessment_response.StopAssessmentResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.stop_assessment.stop_assessment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_application_component_config(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.update_application_component_config_request.UpdateApplicationComponentConfigRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.update_application_component_config_response.UpdateApplicationComponentConfigResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.update_application_component_config.update_application_component_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_server_config(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhubstrategy.types.update_server_config_request.UpdateServerConfigRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhubstrategy.types.update_server_config_response.UpdateServerConfigResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhubstrategy._operations.aws_migration_hub_strategy_recommendation.update_server_config.update_server_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
