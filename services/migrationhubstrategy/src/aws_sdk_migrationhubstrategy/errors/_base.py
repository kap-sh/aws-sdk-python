...
class MigrationHubStrategyError(Exception):
    """Base class for all MigrationHubStrategy service errors."""


class ServiceError(MigrationHubStrategyError):
...
class SerializationError(MigrationHubStrategyError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MigrationHubStrategyError):
...
class WaiterFailedError(MigrationHubStrategyError):
...
class WaiterTimeoutError(MigrationHubStrategyError):
