"""Generated from Smithy shape ``com.amazonaws.migrationhubstrategy#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.migrationhubstrategy#InternalServerException``."""
