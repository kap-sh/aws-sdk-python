...
if TYPE_CHECKING:
    import aws_sdk_migrationhubstrategy.types.s3_bucket
    import aws_sdk_migrationhubstrategy.types.s3_key


class S3Object(TypedDict, closed=True):
    s3_bucket: NotRequired["aws_sdk_migrationhubstrategy.types.s3_bucket.S3Bucket"]
    """<p> The S3 bucket name. </p>"""
    s3key: NotRequired["aws_sdk_migrationhubstrategy.types.s3_key.S3Key"]
