...
if TYPE_CHECKING:
    import aws_sdk_migrationhubstrategy.types.no_preference_target_destination

NoPreferenceTargetDestinations: TypeAlias = list[
    "aws_sdk_migrationhubstrategy.types.no_preference_target_destination.NoPreferenceTargetDestination"
]
