...
if TYPE_CHECKING:
    import aws_sdk_migrationhubstrategy.types.assessment_status
    import aws_sdk_migrationhubstrategy.types.assessment_status_message
    import aws_sdk_migrationhubstrategy.types.integer
    import aws_sdk_migrationhubstrategy.types.time_stamp


class DataCollectionDetails(TypedDict):
    status: NotRequired[
        "aws_sdk_migrationhubstrategy.types.assessment_status.AssessmentStatus"
    ]
    """<p> The status of the assessment. </p>"""
    servers: NotRequired["aws_sdk_migrationhubstrategy.types.integer.Integer"]
    """<p> The total number of servers in the assessment. </p>"""
    failed: NotRequired["aws_sdk_migrationhubstrategy.types.integer.Integer"]
    """<p> The number of failed servers in the assessment. </p>"""
    success: NotRequired["aws_sdk_migrationhubstrategy.types.integer.Integer"]
    """<p> The number of successful servers in the assessment. </p>"""
    in_progress: NotRequired["aws_sdk_migrationhubstrategy.types.integer.Integer"]
    ...
    status_message: NotRequired[
        "aws_sdk_migrationhubstrategy.types.assessment_status_message.AssessmentStatusMessage"
    ]
