"""Generated from Smithy shape ``com.amazonaws.migrationhubstrategy#ListServers``."""
...
import capo_migrationhubstrategy.types.list_servers_request
import capo_migrationhubstrategy.types.list_servers_response
...
) -> capo_migrationhubstrategy.types.list_servers_response.ListServersResponse:
    out: capo_migrationhubstrategy.types.list_servers_response.ListServersResponse = (
        capo_migrationhubstrategy.types.list_servers_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/list-servers"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_migrationhubstrategy.types.list_servers_request.serialize_json(input_)
    ).encode()
