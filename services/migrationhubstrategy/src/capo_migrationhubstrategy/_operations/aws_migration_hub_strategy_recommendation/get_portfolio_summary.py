"""Generated from Smithy shape ``com.amazonaws.migrationhubstrategy#GetPortfolioSummary``."""
...
import capo_migrationhubstrategy.types.get_portfolio_summary_request
import capo_migrationhubstrategy.types.get_portfolio_summary_response
...
) -> capo_migrationhubstrategy.types.get_portfolio_summary_response.GetPortfolioSummaryResponse:
    out: capo_migrationhubstrategy.types.get_portfolio_summary_response.GetPortfolioSummaryResponse = capo_migrationhubstrategy.types.get_portfolio_summary_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/get-portfolio-summary"
    params: dict[str, str] = {}
...
async def async_get_portfolio_summary(
