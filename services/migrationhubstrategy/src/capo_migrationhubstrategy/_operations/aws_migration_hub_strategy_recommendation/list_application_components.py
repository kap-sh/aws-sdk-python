...
import capo_migrationhubstrategy.errors.service_linked_role_lock_client_exception
...
import capo_migrationhubstrategy.types.list_application_components_request
import capo_migrationhubstrategy.types.list_application_components_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceLinkedRoleLockClientException":
            raise capo_migrationhubstrategy.errors.service_linked_role_lock_client_exception.ServiceLinkedRoleLockClientException.from_json(
                data
            )
...
) -> capo_migrationhubstrategy.types.list_application_components_response.ListApplicationComponentsResponse:
    out: capo_migrationhubstrategy.types.list_application_components_response.ListApplicationComponentsResponse = capo_migrationhubstrategy.types.list_application_components_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migrationhubstrategy.types.list_application_components_request.serialize_json(
            input_
        )
    ).encode()
