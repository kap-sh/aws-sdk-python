"""Generated from Smithy shape ``com.amazonaws.migrationhubstrategy#GetPortfolioPreferences``."""
...
import capo_migrationhubstrategy.types.get_portfolio_preferences_request
import capo_migrationhubstrategy.types.get_portfolio_preferences_response
...
) -> capo_migrationhubstrategy.types.get_portfolio_preferences_response.GetPortfolioPreferencesResponse:
    out: capo_migrationhubstrategy.types.get_portfolio_preferences_response.GetPortfolioPreferencesResponse = capo_migrationhubstrategy.types.get_portfolio_preferences_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/get-portfolio-preferences"
    params: dict[str, str] = {}
...
async def async_get_portfolio_preferences(
