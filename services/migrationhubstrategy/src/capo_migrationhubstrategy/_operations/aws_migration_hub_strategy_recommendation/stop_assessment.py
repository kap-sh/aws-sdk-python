...
import capo_migrationhubstrategy.types.stop_assessment_request
import capo_migrationhubstrategy.types.stop_assessment_response
...
) -> capo_migrationhubstrategy.types.stop_assessment_response.StopAssessmentResponse:
    out: capo_migrationhubstrategy.types.stop_assessment_response.StopAssessmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migrationhubstrategy.types.stop_assessment_request.serialize_json(input_)
    ).encode()
