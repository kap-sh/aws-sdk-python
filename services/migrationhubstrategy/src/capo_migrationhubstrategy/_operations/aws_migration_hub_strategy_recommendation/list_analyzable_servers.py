...
import capo_migrationhubstrategy.types.list_analyzable_servers_request
import capo_migrationhubstrategy.types.list_analyzable_servers_response
...
) -> capo_migrationhubstrategy.types.list_analyzable_servers_response.ListAnalyzableServersResponse:
    out: capo_migrationhubstrategy.types.list_analyzable_servers_response.ListAnalyzableServersResponse = capo_migrationhubstrategy.types.list_analyzable_servers_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migrationhubstrategy.types.list_analyzable_servers_request.serialize_json(
            input_
        )
    ).encode()
