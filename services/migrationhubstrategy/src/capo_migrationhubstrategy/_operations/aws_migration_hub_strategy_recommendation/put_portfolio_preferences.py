...
import capo_migrationhubstrategy.errors.conflict_exception
...
import capo_migrationhubstrategy.types.put_portfolio_preferences_request
import capo_migrationhubstrategy.types.put_portfolio_preferences_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_migrationhubstrategy.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
) -> capo_migrationhubstrategy.types.put_portfolio_preferences_response.PutPortfolioPreferencesResponse:
    out: capo_migrationhubstrategy.types.put_portfolio_preferences_response.PutPortfolioPreferencesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migrationhubstrategy.types.put_portfolio_preferences_request.serialize_json(
            input_
        )
    ).encode()
