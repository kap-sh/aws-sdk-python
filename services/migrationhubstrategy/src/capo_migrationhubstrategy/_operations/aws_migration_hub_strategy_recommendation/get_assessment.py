"""Generated from Smithy shape ``com.amazonaws.migrationhubstrategy#GetAssessment``."""
...
import capo_migrationhubstrategy.types.get_assessment_request
import capo_migrationhubstrategy.types.get_assessment_response
...
) -> capo_migrationhubstrategy.types.get_assessment_response.GetAssessmentResponse:
    out: capo_migrationhubstrategy.types.get_assessment_response.GetAssessmentResponse = capo_migrationhubstrategy.types.get_assessment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/get-assessment/{id}"
