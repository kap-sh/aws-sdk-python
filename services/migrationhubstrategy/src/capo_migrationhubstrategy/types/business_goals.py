...
if TYPE_CHECKING:
    import capo_migrationhubstrategy.types.business_goals_integer


class BusinessGoals(TypedDict, closed=True):
    speed_of_migration: NotRequired[
        "capo_migrationhubstrategy.types.business_goals_integer.BusinessGoalsInteger"
    ]
