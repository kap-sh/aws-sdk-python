...
if TYPE_CHECKING:
    import capo_migrationhubstrategy.types.group_name
    import capo_migrationhubstrategy.types.string


class Group(TypedDict, closed=True):
    name: NotRequired["capo_migrationhubstrategy.types.group_name.GroupName"]
    """<p> The key of the specific import group. </p>"""
    value: NotRequired["capo_migrationhubstrategy.types.string.String"]
