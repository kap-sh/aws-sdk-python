...
if TYPE_CHECKING:
    ...
    import capo_migrationhubstrategy.types.os_version


class OSInfo(TypedDict, closed=True):
    type: NotRequired["capo_migrationhubstrategy.types.os_type.OSType"]
    """<p> Information about the type of operating system. </p>"""
    version: NotRequired["capo_migrationhubstrategy.types.os_version.OSVersion"]
