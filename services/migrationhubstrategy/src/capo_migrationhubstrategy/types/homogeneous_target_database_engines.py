...
if TYPE_CHECKING:
    import capo_migrationhubstrategy.types.homogeneous_target_database_engine

HomogeneousTargetDatabaseEngines: TypeAlias = list[
    "capo_migrationhubstrategy.types.homogeneous_target_database_engine.HomogeneousTargetDatabaseEngine"
]
