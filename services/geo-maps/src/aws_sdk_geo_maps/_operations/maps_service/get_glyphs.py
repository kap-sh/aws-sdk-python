...
def handle_response(
    ...
    out: aws_sdk_geo_maps.types.get_glyphs_response.GetGlyphsResponse = {
        "blob": response.read()
...
def build_request(
    ...
    input_: aws_sdk_geo_maps.types.get_glyphs_request.GetGlyphsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_glyphs(
    ...
    aws_sdk_geo_maps.types.get_glyphs_response.GetGlyphsResponse, zapros.Response
]:
