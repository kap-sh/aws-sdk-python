...
if TYPE_CHECKING:
    ...
    from capo_geo_maps._services.async_geo_maps import (
        AsyncGeoMapsClient,
        AsyncGeoMapsClientConfig,
    )
    from capo_geo_maps._services.geo_maps import GeoMapsClient, GeoMapsClientConfig
...
class AsyncProviderResource:
    ...
    async def get_glyphs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_maps.types.get_glyphs_request.GetGlyphsRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_maps.types.get_glyphs_response.GetGlyphsResponse"
        ]:
            import capo_geo_maps._operations.maps_service.get_glyphs
            ...
            (
                output,
                http_response,
            ) = await capo_geo_maps._operations.maps_service.get_glyphs.async_get_glyphs(
                req.options, req.input
            )
    ...
    async def get_sprites(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_maps.types.get_sprites_request.GetSpritesRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_maps.types.get_sprites_response.GetSpritesResponse"
        ]:
            import capo_geo_maps._operations.maps_service.get_sprites
            ...
            (
                output,
                http_response,
            ) = await capo_geo_maps._operations.maps_service.get_sprites.async_get_sprites(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_static_map(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_maps.types.get_static_map_request.GetStaticMapRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_maps.types.get_static_map_response.GetStaticMapResponse"
        ]:
            import capo_geo_maps._operations.maps_service.get_static_map
            ...
            (
                output,
                http_response,
            ) = await capo_geo_maps._operations.maps_service.get_static_map.async_get_static_map(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_style_descriptor(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_maps.types.get_style_descriptor_request.GetStyleDescriptorRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_maps.types.get_style_descriptor_response.GetStyleDescriptorResponse"
        ]:
            import capo_geo_maps._operations.maps_service.get_style_descriptor
            ...
            (
                output,
                http_response,
            ) = await capo_geo_maps._operations.maps_service.get_style_descriptor.async_get_style_descriptor(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_tile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_maps.types.get_tile_request.GetTileRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_maps.types.get_tile_response.GetTileResponse"
        ]:
            import capo_geo_maps._operations.maps_service.get_tile
            ...
            (
                output,
                http_response,
            ) = await capo_geo_maps._operations.maps_service.get_tile.async_get_tile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
