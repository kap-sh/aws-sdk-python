import pytest
from capo_application_auto_scaling._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_application_auto_scaling._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
