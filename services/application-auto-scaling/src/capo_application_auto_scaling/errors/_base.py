...
class ApplicationAutoScalingError(Exception):
    """Base class for all ApplicationAutoScaling service errors."""


class ServiceError(ApplicationAutoScalingError):
...
class SerializationError(ApplicationAutoScalingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ApplicationAutoScalingError):
...
class WaiterFailedError(ApplicationAutoScalingError):
...
class WaiterTimeoutError(ApplicationAutoScalingError):
