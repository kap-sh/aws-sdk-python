"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.applicationautoscaling#InvalidNextTokenException``."""
