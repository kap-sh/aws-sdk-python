"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DescribeScheduledActions``."""
...
import capo_application_auto_scaling.errors.concurrent_update_exception
import capo_application_auto_scaling.errors.internal_service_exception
import capo_application_auto_scaling.errors.invalid_next_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentUpdateException":
            raise capo_application_auto_scaling.errors.concurrent_update_exception.ConcurrentUpdateException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidNextTokenException":
            raise capo_application_auto_scaling.errors.invalid_next_token_exception.InvalidNextTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_application_auto_scaling.types.describe_scheduled_actions_response.DescribeScheduledActionsResponse = capo_application_auto_scaling.types.describe_scheduled_actions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_auto_scaling.types.describe_scheduled_actions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_scheduled_actions(
