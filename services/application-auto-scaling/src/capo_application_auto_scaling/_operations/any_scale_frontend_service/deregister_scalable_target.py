"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DeregisterScalableTarget``."""
...
import capo_application_auto_scaling.errors.object_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ObjectNotFoundException":
            raise capo_application_auto_scaling.errors.object_not_found_exception.ObjectNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_application_auto_scaling.types.deregister_scalable_target_response.DeregisterScalableTargetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_auto_scaling.types.deregister_scalable_target_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deregister_scalable_target(
