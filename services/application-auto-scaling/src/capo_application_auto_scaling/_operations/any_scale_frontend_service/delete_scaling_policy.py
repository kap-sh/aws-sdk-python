"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DeleteScalingPolicy``."""
...
def handle_response(
    ...
    out: capo_application_auto_scaling.types.delete_scaling_policy_response.DeleteScalingPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_auto_scaling.types.delete_scaling_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_scaling_policy(
