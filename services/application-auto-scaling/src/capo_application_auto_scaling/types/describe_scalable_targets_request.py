"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DescribeScalableTargetsRequest``."""
...
class DescribeScalableTargetsRequest(TypedDict, closed=True):
    service_namespace: (
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeScalableTargetsRequest) -> dict:
    out: dict = {}
    import capo_application_auto_scaling.types.service_namespace
