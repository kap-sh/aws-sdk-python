...
if TYPE_CHECKING:
    import capo_application_auto_scaling.types.scalable_targets
...
class DescribeScalableTargetsResponse(TypedDict, closed=True):
    scalable_targets: NotRequired[
        "capo_application_auto_scaling.types.scalable_targets.ScalableTargets"
    ]
...
def serialize_aws_json_1_1(value: DescribeScalableTargetsResponse) -> dict:
    ...
    if "scalable_targets" in value:
        ...
        out["ScalableTargets"] = (
            capo_application_auto_scaling.types.scalable_targets.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeScalableTargetsResponse:
    ...
    if "ScalableTargets" in data:
        ...
        out["scalable_targets"] = (
            capo_application_auto_scaling.types.scalable_targets.deserialize_aws_json_1_1(
