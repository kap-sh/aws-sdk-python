"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DeleteScheduledActionRequest``."""
...
class DeleteScheduledActionRequest(TypedDict, closed=True):
    service_namespace: (
...
def deserialize_aws_json_1_1(data: dict) -> DeleteScheduledActionRequest:
    ...
    if "ScalableDimension" in data:
        ...
        raise DeserializationError(
            "DeleteScheduledActionRequest.scalable_dimension required"
        )
    return out
