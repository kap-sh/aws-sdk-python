...
class PredictiveScalingMetricDataQuery(TypedDict, closed=True):
    ...
    metric_stat: NotRequired[
        "capo_application_auto_scaling.types.predictive_scaling_metric_stat.PredictiveScalingMetricStat"
    ]
...
def serialize_aws_json_1_1(value: PredictiveScalingMetricDataQuery) -> dict:
    ...
    if "metric_stat" in value:
        ...
        out["MetricStat"] = (
            capo_application_auto_scaling.types.predictive_scaling_metric_stat.serialize_aws_json_1_1(
                value["metric_stat"]
            )
        )
    if "label" in value:
...
def deserialize_aws_json_1_1(data: dict) -> PredictiveScalingMetricDataQuery:
    ...
    if "MetricStat" in data:
        ...
        out["metric_stat"] = (
            capo_application_auto_scaling.types.predictive_scaling_metric_stat.deserialize_aws_json_1_1(
                data["MetricStat"]
            )
        )
    if "Label" in data:
