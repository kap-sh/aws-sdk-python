"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DescribeScheduledActionsRequest``."""
...
class DescribeScheduledActionsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeScheduledActionsRequest) -> dict:
    out: dict = {}
    if "scheduled_action_names" in value:
        import capo_application_auto_scaling.types.resource_ids_max_len1600

        out["ScheduledActionNames"] = (
            capo_application_auto_scaling.types.resource_ids_max_len1600.serialize_aws_json_1_1(
                value["scheduled_action_names"]
            )
        )
    import capo_application_auto_scaling.types.service_namespace
...
def deserialize_aws_json_1_1(data: dict) -> DescribeScheduledActionsRequest:
    out: DescribeScheduledActionsRequest = {}  # type: ignore[typeddict-item]
    if "ScheduledActionNames" in data:
        import capo_application_auto_scaling.types.resource_ids_max_len1600

        out["scheduled_action_names"] = (
            capo_application_auto_scaling.types.resource_ids_max_len1600.deserialize_aws_json_1_1(
                data["ScheduledActionNames"]
            )
        )
    if "ServiceNamespace" in data:
        ...
        raise DeserializationError(
            "DescribeScheduledActionsRequest.service_namespace required"
        )
