"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.applicationautoscaling#ResourceNotFoundException``."""
