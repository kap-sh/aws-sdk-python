...
if TYPE_CHECKING:
    import aws_sdk_application_auto_scaling.types.metric_type
    import aws_sdk_application_auto_scaling.types.resource_label


class PredefinedMetricSpecification(TypedDict):
    predefined_metric_type: (
        "aws_sdk_application_auto_scaling.types.metric_type.MetricType"
    )
...
def serialize_aws_json_1_1(value: PredefinedMetricSpecification) -> dict:
    ...
    out["PredefinedMetricType"] = (
        aws_sdk_application_auto_scaling.types.metric_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> PredefinedMetricSpecification:
    ...
    if "PredefinedMetricType" in data:
        ...
        out["predefined_metric_type"] = (
            aws_sdk_application_auto_scaling.types.metric_type.deserialize_aws_json_1_1(
