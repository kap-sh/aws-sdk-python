...
if TYPE_CHECKING:
    ...
    import aws_sdk_application_auto_scaling.types.metric_name
    import aws_sdk_application_auto_scaling.types.metric_namespace
    import aws_sdk_application_auto_scaling.types.metric_statistic
    import aws_sdk_application_auto_scaling.types.metric_unit
...
class CustomizedMetricSpecification(TypedDict, closed=True):
    ...
    dimensions: NotRequired[
        "aws_sdk_application_auto_scaling.types.metric_dimensions.MetricDimensions"
    ]
    ...
    statistic: NotRequired[
        "aws_sdk_application_auto_scaling.types.metric_statistic.MetricStatistic"
    ]
...
def serialize_aws_json_1_1(value: CustomizedMetricSpecification) -> dict:
    ...
    if "dimensions" in value:
        ...
        out["Dimensions"] = (
            aws_sdk_application_auto_scaling.types.metric_dimensions.serialize_aws_json_1_1(
                value["dimensions"]
            )
        )
    if "statistic" in value:
        ...
        out["Statistic"] = (
            aws_sdk_application_auto_scaling.types.metric_statistic.serialize_aws_json_1_1(
                value["statistic"]
            )
        )
    if "unit" in value:
    ...
    if "metrics" in value:
        ...
        out["Metrics"] = (
            aws_sdk_application_auto_scaling.types.target_tracking_metric_data_queries.serialize_aws_json_1_1(
                value["metrics"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CustomizedMetricSpecification:
    ...
    if "Dimensions" in data:
        ...
        out["dimensions"] = (
            aws_sdk_application_auto_scaling.types.metric_dimensions.deserialize_aws_json_1_1(
                data["Dimensions"]
            )
        )
    if "Statistic" in data:
        ...
        out["statistic"] = (
            aws_sdk_application_auto_scaling.types.metric_statistic.deserialize_aws_json_1_1(
                data["Statistic"]
            )
        )
    if "Unit" in data:
    ...
    if "Metrics" in data:
        ...
        out["metrics"] = (
            aws_sdk_application_auto_scaling.types.target_tracking_metric_data_queries.deserialize_aws_json_1_1(
                data["Metrics"]
            )
        )
    return out
