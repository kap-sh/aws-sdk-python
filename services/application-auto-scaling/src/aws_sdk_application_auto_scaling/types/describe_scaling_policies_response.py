...
class DescribeScalingPoliciesResponse(TypedDict):
    scaling_policies: NotRequired[
        "aws_sdk_application_auto_scaling.types.scaling_policies.ScalingPolicies"
    ]
...
def serialize_aws_json_1_1(value: DescribeScalingPoliciesResponse) -> dict:
    ...
    if "scaling_policies" in value:
        ...
        out["ScalingPolicies"] = (
            aws_sdk_application_auto_scaling.types.scaling_policies.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeScalingPoliciesResponse:
    ...
    if "ScalingPolicies" in data:
        ...
        out["scaling_policies"] = (
            aws_sdk_application_auto_scaling.types.scaling_policies.deserialize_aws_json_1_1(
