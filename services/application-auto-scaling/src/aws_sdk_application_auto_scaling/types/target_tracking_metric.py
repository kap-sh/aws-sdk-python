...
if TYPE_CHECKING:
    import aws_sdk_application_auto_scaling.types.target_tracking_metric_dimensions
    import aws_sdk_application_auto_scaling.types.target_tracking_metric_name
    import aws_sdk_application_auto_scaling.types.target_tracking_metric_namespace


class TargetTrackingMetric(TypedDict):
    dimensions: NotRequired[
        "aws_sdk_application_auto_scaling.types.target_tracking_metric_dimensions.TargetTrackingMetricDimensions"
    ]
    ...
    metric_name: NotRequired[
        "aws_sdk_application_auto_scaling.types.target_tracking_metric_name.TargetTrackingMetricName"
    ]
    """<p>The name of the metric.</p>"""
    namespace: NotRequired[
        "aws_sdk_application_auto_scaling.types.target_tracking_metric_namespace.TargetTrackingMetricNamespace"
    ]
...
def serialize_aws_json_1_1(value: TargetTrackingMetric) -> dict:
    ...
    if "dimensions" in value:
        ...
        out["Dimensions"] = (
            aws_sdk_application_auto_scaling.types.target_tracking_metric_dimensions.serialize_aws_json_1_1(
                value["dimensions"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> TargetTrackingMetric:
    ...
    if "Dimensions" in data:
        ...
        out["dimensions"] = (
            aws_sdk_application_auto_scaling.types.target_tracking_metric_dimensions.deserialize_aws_json_1_1(
                data["Dimensions"]
            )
        )
