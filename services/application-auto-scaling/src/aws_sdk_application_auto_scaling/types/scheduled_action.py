...
class ScheduledAction(TypedDict, closed=True):
    ...
    scheduled_action_arn: "aws_sdk_application_auto_scaling.types.resource_id_max_len1600.ResourceIdMaxLen1600"
    ...
    schedule: "aws_sdk_application_auto_scaling.types.resource_id_max_len1600.ResourceIdMaxLen1600"
...
def serialize_aws_json_1_1(value: ScheduledAction) -> dict:
    ...
    if "scalable_target_action" in value:
        ...
        out["ScalableTargetAction"] = (
            aws_sdk_application_auto_scaling.types.scalable_target_action.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ScheduledAction:
    ...
    if "ScalableTargetAction" in data:
        ...
        out["scalable_target_action"] = (
            aws_sdk_application_auto_scaling.types.scalable_target_action.deserialize_aws_json_1_1(
