...
if TYPE_CHECKING:
    ...
    import aws_sdk_application_auto_scaling.types.scaling_adjustment


class StepAdjustment(TypedDict, closed=True):
    metric_interval_lower_bound: NotRequired[
        "aws_sdk_application_auto_scaling.types.metric_scale.MetricScale"
    ]
    ...
    scaling_adjustment: (
        "aws_sdk_application_auto_scaling.types.scaling_adjustment.ScalingAdjustment"
    )
