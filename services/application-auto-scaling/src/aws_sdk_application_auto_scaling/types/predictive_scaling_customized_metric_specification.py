...
if TYPE_CHECKING:
    import aws_sdk_application_auto_scaling.types.predictive_scaling_metric_data_queries


class PredictiveScalingCustomizedMetricSpecification(TypedDict):
    metric_data_queries: "aws_sdk_application_auto_scaling.types.predictive_scaling_metric_data_queries.PredictiveScalingMetricDataQueries"
...
def serialize_aws_json_1_1(
    ...
    out["MetricDataQueries"] = (
        aws_sdk_application_auto_scaling.types.predictive_scaling_metric_data_queries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "MetricDataQueries" in data:
        ...
        out["metric_data_queries"] = (
            aws_sdk_application_auto_scaling.types.predictive_scaling_metric_data_queries.deserialize_aws_json_1_1(
