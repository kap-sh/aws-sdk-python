"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DeregisterScalableTargetRequest``."""
...
class DeregisterScalableTargetRequest(TypedDict, closed=True):
    service_namespace: (
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeregisterScalableTargetRequest) -> dict:
    out: dict = {}
    import aws_sdk_application_auto_scaling.types.service_namespace
...
def deserialize_aws_json_1_1(data: dict) -> DeregisterScalableTargetRequest:
    ...
    if "ScalableDimension" in data:
        ...
        raise DeserializationError(
            "DeregisterScalableTargetRequest.scalable_dimension required"
        )
    return out
