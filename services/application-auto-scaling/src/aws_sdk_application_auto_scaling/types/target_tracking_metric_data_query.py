...
if TYPE_CHECKING:
    ...
    import aws_sdk_application_auto_scaling.types.target_tracking_metric_stat
...
class TargetTrackingMetricDataQuery(TypedDict, closed=True):
    ...
    metric_stat: NotRequired[
        "aws_sdk_application_auto_scaling.types.target_tracking_metric_stat.TargetTrackingMetricStat"
    ]
...
def serialize_aws_json_1_1(value: TargetTrackingMetricDataQuery) -> dict:
    ...
    if "metric_stat" in value:
        ...
        out["MetricStat"] = (
            aws_sdk_application_auto_scaling.types.target_tracking_metric_stat.serialize_aws_json_1_1(
                value["metric_stat"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> TargetTrackingMetricDataQuery:
    ...
    if "MetricStat" in data:
        ...
        out["metric_stat"] = (
            aws_sdk_application_auto_scaling.types.target_tracking_metric_stat.deserialize_aws_json_1_1(
                data["MetricStat"]
            )
        )
