...
ScalingPolicies: TypeAlias = list[
    "aws_sdk_application_auto_scaling.types.scaling_policy.ScalingPolicy"
]
...
def serialize_aws_json_1_1(value: ScalingPolicies) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_application_auto_scaling.types.scaling_policy.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ScalingPolicies:
    ...
    for item in data:
        out.append(
            aws_sdk_application_auto_scaling.types.scaling_policy.deserialize_aws_json_1_1(
                item
            )
        )
    return out
