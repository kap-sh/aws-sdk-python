...
def handle_response(
    ...
    out: aws_sdk_application_auto_scaling.types.delete_scaling_policy_response.DeleteScalingPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_application_auto_scaling.types.delete_scaling_policy_request.DeleteScalingPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
