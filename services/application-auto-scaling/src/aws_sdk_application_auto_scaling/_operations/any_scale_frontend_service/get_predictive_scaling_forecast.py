...
def handle_response(
    ...
    out: aws_sdk_application_auto_scaling.types.get_predictive_scaling_forecast_response.GetPredictiveScalingForecastResponse = aws_sdk_application_auto_scaling.types.get_predictive_scaling_forecast_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_auto_scaling.types.get_predictive_scaling_forecast_request.GetPredictiveScalingForecastRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_auto_scaling.types.get_predictive_scaling_forecast_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
