...
def handle_response(
    ...
    out: aws_sdk_application_auto_scaling.types.deregister_scalable_target_response.DeregisterScalableTargetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_application_auto_scaling.types.deregister_scalable_target_request.DeregisterScalableTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_auto_scaling.types.deregister_scalable_target_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
