"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#RegisterScalableTarget``."""
...
def handle_response(
    ...
    out: aws_sdk_application_auto_scaling.types.register_scalable_target_response.RegisterScalableTargetResponse = aws_sdk_application_auto_scaling.types.register_scalable_target_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_auto_scaling.types.register_scalable_target_request.RegisterScalableTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_auto_scaling.types.register_scalable_target_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_scalable_target(
