...
def handle_response(
    ...
    out: aws_sdk_application_auto_scaling.types.describe_scheduled_actions_response.DescribeScheduledActionsResponse = aws_sdk_application_auto_scaling.types.describe_scheduled_actions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_auto_scaling.types.describe_scheduled_actions_request.DescribeScheduledActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_auto_scaling.types.describe_scheduled_actions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
