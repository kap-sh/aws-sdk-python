"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DescribeScalingPolicies``."""
...
import aws_sdk_application_auto_scaling.errors.invalid_next_token_exception
...
import aws_sdk_application_auto_scaling.types.scaling_policies
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNextTokenException":
            raise aws_sdk_application_auto_scaling.errors.invalid_next_token_exception.InvalidNextTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_application_auto_scaling.types.describe_scaling_policies_response.DescribeScalingPoliciesResponse = aws_sdk_application_auto_scaling.types.describe_scaling_policies_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_application_auto_scaling._auth._sigv4.build_sigv4_auth_scheme(
                "application-autoscaling", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_application_auto_scaling._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_application_auto_scaling.types.describe_scaling_policies_request.DescribeScalingPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_auto_scaling.types.describe_scaling_policies_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_scaling_policies(
