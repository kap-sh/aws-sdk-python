...
def handle_response(
    ...
    out: aws_sdk_application_auto_scaling.types.delete_scheduled_action_response.DeleteScheduledActionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_application_auto_scaling.types.delete_scheduled_action_request.DeleteScheduledActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_auto_scaling.types.delete_scheduled_action_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
