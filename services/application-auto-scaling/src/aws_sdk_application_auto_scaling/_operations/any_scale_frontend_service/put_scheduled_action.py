...
def handle_response(
    ...
    out: aws_sdk_application_auto_scaling.types.put_scheduled_action_response.PutScheduledActionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_application_auto_scaling.types.put_scheduled_action_request.PutScheduledActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
