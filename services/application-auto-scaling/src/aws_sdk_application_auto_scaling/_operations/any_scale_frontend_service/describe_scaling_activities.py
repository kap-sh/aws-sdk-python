"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DescribeScalingActivities``."""
...
def handle_response(
    ...
    out: aws_sdk_application_auto_scaling.types.describe_scaling_activities_response.DescribeScalingActivitiesResponse = aws_sdk_application_auto_scaling.types.describe_scaling_activities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_auto_scaling.types.describe_scaling_activities_request.DescribeScalingActivitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_auto_scaling.types.describe_scaling_activities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_scaling_activities(
