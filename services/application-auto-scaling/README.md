...
```
pip install aws-sdk-application-auto-scaling
```

## Usage

```python
from aws_sdk_application_auto_scaling import AsyncApplicationAutoScalingClient
...
```python
from aws_sdk_application_auto_scaling import AsyncApplicationAutoScalingClient
from aws_sdk_application_auto_scaling.error import ConcurrentUpdateException
