...
if TYPE_CHECKING:
    import aws_sdk_synthetics.types.artifact_config_output
    import aws_sdk_synthetics.types.browser_configs
    import aws_sdk_synthetics.types.canary_code_output
    import aws_sdk_synthetics.types.canary_name
    import aws_sdk_synthetics.types.canary_run_config_output
    import aws_sdk_synthetics.types.canary_schedule_output
    import aws_sdk_synthetics.types.canary_status
    import aws_sdk_synthetics.types.canary_timeline
    import aws_sdk_synthetics.types.dry_run_config_output
    import aws_sdk_synthetics.types.engine_configs
    ...
    import aws_sdk_synthetics.types.visual_references_output
    import aws_sdk_synthetics.types.vpc_config_output
...
class Canary(TypedDict):
    ...
    code: NotRequired["aws_sdk_synthetics.types.canary_code_output.CanaryCodeOutput"]
    ...
    schedule: NotRequired[
        "aws_sdk_synthetics.types.canary_schedule_output.CanaryScheduleOutput"
    ]
    ...
    run_config: NotRequired[
        "aws_sdk_synthetics.types.canary_run_config_output.CanaryRunConfigOutput"
    ]
    ...
    engine_configs: NotRequired["aws_sdk_synthetics.types.engine_configs.EngineConfigs"]
    ...
    visual_references: NotRequired[
        "aws_sdk_synthetics.types.visual_references_output.VisualReferencesOutput"
    ]
    ...
    artifact_config: NotRequired[
        "aws_sdk_synthetics.types.artifact_config_output.ArtifactConfigOutput"
    ]
...
def serialize_json(value: Canary) -> dict:
    ...
    if "code" in value:
        ...
        out["Code"] = aws_sdk_synthetics.types.canary_code_output.serialize_json(
            value["code"]
        )
    ...
    if "schedule" in value:
        ...
        out["Schedule"] = (
            aws_sdk_synthetics.types.canary_schedule_output.serialize_json(
                value["schedule"]
            )
        )
    if "run_config" in value:
        ...
        out["RunConfig"] = (
            aws_sdk_synthetics.types.canary_run_config_output.serialize_json(
                value["run_config"]
            )
        )
    ...
    if "status" in value:
        ...
        out["Status"] = aws_sdk_synthetics.types.canary_status.serialize_json(
            value["status"]
        )
    if "timeline" in value:
        import aws_sdk_synthetics.types.canary_timeline

        out["Timeline"] = aws_sdk_synthetics.types.canary_timeline.serialize_json(
            value["timeline"]
        )
    ...
    if "vpc_config" in value:
        ...
        out["VpcConfig"] = aws_sdk_synthetics.types.vpc_config_output.serialize_json(
            value["vpc_config"]
        )
    if "visual_reference" in value:
        ...
        out["VisualReference"] = (
            aws_sdk_synthetics.types.visual_reference_output.serialize_json(
    ...
    if "engine_configs" in value:
        ...
        out["EngineConfigs"] = aws_sdk_synthetics.types.engine_configs.serialize_json(
    ...
    if "visual_references" in value:
        ...
        out["VisualReferences"] = (
            aws_sdk_synthetics.types.visual_references_output.serialize_json(
    ...
    if "artifact_config" in value:
        ...
        out["ArtifactConfig"] = (
            aws_sdk_synthetics.types.artifact_config_output.serialize_json(
...
def deserialize_json(data: dict) -> Canary:
    ...
    if "Code" in data:
        ...
        out["code"] = aws_sdk_synthetics.types.canary_code_output.deserialize_json(
            data["Code"]
        )
    ...
    if "Schedule" in data:
        ...
        out["schedule"] = (
            aws_sdk_synthetics.types.canary_schedule_output.deserialize_json(
                data["Schedule"]
            )
        )
    if "RunConfig" in data:
        ...
        out["run_config"] = (
            aws_sdk_synthetics.types.canary_run_config_output.deserialize_json(
                data["RunConfig"]
            )
        )
    ...
    if "Status" in data:
        ...
        out["status"] = aws_sdk_synthetics.types.canary_status.deserialize_json(
            data["Status"]
        )
    if "Timeline" in data:
        import aws_sdk_synthetics.types.canary_timeline

        out["timeline"] = aws_sdk_synthetics.types.canary_timeline.deserialize_json(
            data["Timeline"]
        )
    ...
    if "VpcConfig" in data:
        ...
        out["vpc_config"] = aws_sdk_synthetics.types.vpc_config_output.deserialize_json(
            data["VpcConfig"]
        )
    if "VisualReference" in data:
        ...
        out["visual_reference"] = (
            aws_sdk_synthetics.types.visual_reference_output.deserialize_json(
    ...
    if "EngineConfigs" in data:
        ...
        out["engine_configs"] = (
            aws_sdk_synthetics.types.engine_configs.deserialize_json(
                data["EngineConfigs"]
            )
        )
    if "VisualReferences" in data:
        ...
        out["visual_references"] = (
            aws_sdk_synthetics.types.visual_references_output.deserialize_json(
    ...
    if "ArtifactConfig" in data:
        ...
        out["artifact_config"] = (
            aws_sdk_synthetics.types.artifact_config_output.deserialize_json(
                data["ArtifactConfig"]
            )
        )
