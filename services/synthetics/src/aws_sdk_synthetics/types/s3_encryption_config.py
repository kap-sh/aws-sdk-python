...
class S3EncryptionConfig(TypedDict):
    ...
    kms_key_arn: NotRequired["aws_sdk_synthetics.types.kms_key_arn.KmsKeyArn"]
...
def serialize_json(value: S3EncryptionConfig) -> dict:
    ...
    if "encryption_mode" in value:
        ...
        out["EncryptionMode"] = aws_sdk_synthetics.types.encryption_mode.serialize_json(
...
def deserialize_json(data: dict) -> S3EncryptionConfig:
    ...
    if "EncryptionMode" in data:
        ...
        out["encryption_mode"] = (
            aws_sdk_synthetics.types.encryption_mode.deserialize_json(
                data["EncryptionMode"]
            )
        )
