...
if TYPE_CHECKING:
    import aws_sdk_synthetics.types.base_screenshot_ignore_coordinates
...
def serialize_json(value: BaseScreenshot) -> dict:
    ...
    if "ignore_coordinates" in value:
        ...
        out["IgnoreCoordinates"] = (
            aws_sdk_synthetics.types.base_screenshot_ignore_coordinates.serialize_json(
...
def deserialize_json(data: dict) -> BaseScreenshot:
    ...
    if "IgnoreCoordinates" in data:
        ...
        out["ignore_coordinates"] = (
            aws_sdk_synthetics.types.base_screenshot_ignore_coordinates.deserialize_json(
