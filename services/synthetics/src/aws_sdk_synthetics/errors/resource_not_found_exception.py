"""Generated from Smithy shape ``com.amazonaws.synthetics#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.synthetics#ResourceNotFoundException``."""
