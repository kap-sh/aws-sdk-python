...
class syntheticsError(Exception):
    """Base class for all synthetics service errors."""


class ServiceError(syntheticsError):
...
class SerializationError(syntheticsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(syntheticsError):
...
class WaiterFailedError(syntheticsError):
...
class WaiterTimeoutError(syntheticsError):
