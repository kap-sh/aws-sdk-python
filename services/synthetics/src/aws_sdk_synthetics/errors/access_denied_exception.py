"""Generated from Smithy shape ``com.amazonaws.synthetics#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.synthetics#AccessDeniedException``."""
