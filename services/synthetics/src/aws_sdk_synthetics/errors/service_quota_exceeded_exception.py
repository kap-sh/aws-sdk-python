"""Generated from Smithy shape ``com.amazonaws.synthetics#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.synthetics#ServiceQuotaExceededException``."""
