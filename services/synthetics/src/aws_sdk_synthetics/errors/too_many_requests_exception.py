"""Generated from Smithy shape ``com.amazonaws.synthetics#TooManyRequestsException``."""
...
class TooManyRequestsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.synthetics#TooManyRequestsException``."""
