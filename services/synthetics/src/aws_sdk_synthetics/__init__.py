...
from ._services.async_synthetics import AsyncsyntheticsClient as AsyncsyntheticsClient
from ._services.synthetics import syntheticsClient as syntheticsClient
