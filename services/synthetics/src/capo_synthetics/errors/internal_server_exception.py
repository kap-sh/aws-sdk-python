"""Generated from Smithy shape ``com.amazonaws.synthetics#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.synthetics#InternalServerException``."""
