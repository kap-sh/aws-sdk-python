"""Generated from Smithy shape ``com.amazonaws.synthetics#CreateCanary``."""
...
def handle_response(
    ...
    out: capo_synthetics.types.create_canary_response.CreateCanaryResponse = (
        capo_synthetics.types.create_canary_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/canary"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_synthetics.types.create_canary_request.serialize_json(input_)
    ).encode()
...
def create_canary(
    ...
    capo_synthetics.types.create_canary_response.CreateCanaryResponse, zapros.Response
]:
