...
def handle_response(
    ...
    out: capo_synthetics.types.get_canary_response.GetCanaryResponse = (
        capo_synthetics.types.get_canary_response.deserialize_json(
...
def get_canary(
    ...
    capo_synthetics.types.get_canary_response.GetCanaryResponse, zapros.Response
]:
