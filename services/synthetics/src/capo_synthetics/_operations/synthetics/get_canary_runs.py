...
def handle_response(
    ...
    out: capo_synthetics.types.get_canary_runs_response.GetCanaryRunsResponse = (
        capo_synthetics.types.get_canary_runs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_synthetics.types.get_canary_runs_request.serialize_json(input_)
    ).encode()
