...
def handle_response(
    ...
    out: capo_synthetics.types.describe_canaries_last_run_response.DescribeCanariesLastRunResponse = capo_synthetics.types.describe_canaries_last_run_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_synthetics.types.describe_canaries_last_run_request.serialize_json(input_)
    ).encode()
