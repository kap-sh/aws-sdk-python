...
def handle_response(
    ...
    out: capo_synthetics.types.list_groups_response.ListGroupsResponse = (
        capo_synthetics.types.list_groups_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_synthetics.types.list_groups_request.serialize_json(input_)
    ).encode()
...
def list_groups(
    ...
    capo_synthetics.types.list_groups_response.ListGroupsResponse, zapros.Response
]:
