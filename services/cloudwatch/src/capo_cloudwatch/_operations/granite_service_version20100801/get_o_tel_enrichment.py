...
def handle_response(
    ...
    out: capo_cloudwatch.types.get_o_tel_enrichment_output.GetOTelEnrichmentOutput = (
        capo_cloudwatch.types.get_o_tel_enrichment_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    capo_cloudwatch.types.get_o_tel_enrichment_input.serialize_query(input_, pairs, "")
