"""Generated from Smithy shape ``com.amazonaws.cloudwatch#StartMetricStreams``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.start_metric_streams_output.StartMetricStreamsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.StartMetricStreams"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "StartMetricStreams"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.start_metric_streams_input.serialize_query(input_, pairs, "")
...
async def async_start_metric_streams(
