"""Generated from Smithy shape ``com.amazonaws.cloudwatch#ListMetricStreams``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.list_metric_streams_output.ListMetricStreamsOutput = (
        capo_cloudwatch.types.list_metric_streams_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.ListMetricStreams"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "ListMetricStreams"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.list_metric_streams_input.serialize_query(input_, pairs, "")
...
async def async_list_metric_streams(
