...
def handle_response(
    ...
    out: capo_cloudwatch.types.delete_metric_stream_output.DeleteMetricStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    capo_cloudwatch.types.delete_metric_stream_input.serialize_query(input_, pairs, "")
