"""Generated from Smithy shape ``com.amazonaws.cloudwatch#TagResource``."""
...
import capo_cloudwatch.errors.conflict_exception
...
def handle_response(
    ...
    out: capo_cloudwatch.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.TagResource"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "TagResource"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.tag_resource_input.serialize_query(input_, pairs, "")
...
def tag_resource(
    ...
    capo_cloudwatch.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
