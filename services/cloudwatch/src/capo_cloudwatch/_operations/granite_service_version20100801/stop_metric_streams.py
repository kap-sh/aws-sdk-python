...
def handle_response(
    ...
    out: capo_cloudwatch.types.stop_metric_streams_output.StopMetricStreamsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    capo_cloudwatch.types.stop_metric_streams_input.serialize_query(input_, pairs, "")
