...
import capo_cloudwatch.errors.dashboard_invalid_input_error
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DashboardInvalidInputError":
            raise capo_cloudwatch.errors.dashboard_invalid_input_error.DashboardInvalidInputError.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudwatch.types.put_dashboard_output.PutDashboardOutput = (
        capo_cloudwatch.types.put_dashboard_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    capo_cloudwatch.types.put_dashboard_input.serialize_query(input_, pairs, "")
...
def put_dashboard(
    ...
    capo_cloudwatch.types.put_dashboard_output.PutDashboardOutput, zapros.Response
]:
