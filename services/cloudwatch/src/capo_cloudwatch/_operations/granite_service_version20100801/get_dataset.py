"""Generated from Smithy shape ``com.amazonaws.cloudwatch#GetDataset``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.get_dataset_output.GetDatasetOutput = (
        capo_cloudwatch.types.get_dataset_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.GetDataset"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "GetDataset"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.get_dataset_input.serialize_query(input_, pairs, "")
...
def get_dataset(
    ...
    input_: capo_cloudwatch.types.get_dataset_input.GetDatasetInput,
) -> tuple[capo_cloudwatch.types.get_dataset_output.GetDatasetOutput, zapros.Response]:
