...
def handle_response(
    ...
    out: capo_cloudwatch.types.get_metric_stream_output.GetMetricStreamOutput = (
        capo_cloudwatch.types.get_metric_stream_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    capo_cloudwatch.types.get_metric_stream_input.serialize_query(input_, pairs, "")
