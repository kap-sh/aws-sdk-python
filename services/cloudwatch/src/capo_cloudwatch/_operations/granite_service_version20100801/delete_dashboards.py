...
def handle_response(
    ...
    out: capo_cloudwatch.types.delete_dashboards_output.DeleteDashboardsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    capo_cloudwatch.types.delete_dashboards_input.serialize_query(input_, pairs, "")
