...
def handle_response(
    ...
    out: capo_cloudwatch.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    capo_cloudwatch.types.untag_resource_input.serialize_query(input_, pairs, "")
...
def untag_resource(
    ...
    capo_cloudwatch.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
