"""Generated from Smithy shape ``com.amazonaws.cloudwatch#PutAlarmMuteRule``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "LimitExceededFault":
            raise capo_cloudwatch.errors.limit_exceeded_fault.LimitExceededFault.from_aws_json_1_0(
                data
            )
        case _:
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.PutAlarmMuteRule"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "PutAlarmMuteRule"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.put_alarm_mute_rule_input.serialize_query(input_, pairs, "")
...
async def async_put_alarm_mute_rule(
