...
import capo_cloudwatch.errors.invalid_format_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidFormatFault":
            raise capo_cloudwatch.errors.invalid_format_fault.InvalidFormatFault.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    capo_cloudwatch.types.set_alarm_state_input.serialize_query(input_, pairs, "")
