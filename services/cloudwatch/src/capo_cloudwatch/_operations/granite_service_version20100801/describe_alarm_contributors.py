"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DescribeAlarmContributors``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.describe_alarm_contributors_output.DescribeAlarmContributorsOutput = capo_cloudwatch.types.describe_alarm_contributors_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DescribeAlarmContributors"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DescribeAlarmContributors"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.describe_alarm_contributors_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_alarm_contributors(
