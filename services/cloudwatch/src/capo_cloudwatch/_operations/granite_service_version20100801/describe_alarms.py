"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DescribeAlarms``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.describe_alarms_output.DescribeAlarmsOutput = (
        capo_cloudwatch.types.describe_alarms_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DescribeAlarms"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DescribeAlarms"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.describe_alarms_input.serialize_query(input_, pairs, "")
...
def describe_alarms(
    ...
    capo_cloudwatch.types.describe_alarms_output.DescribeAlarmsOutput, zapros.Response
]:
...
async def async_describe_alarms(
