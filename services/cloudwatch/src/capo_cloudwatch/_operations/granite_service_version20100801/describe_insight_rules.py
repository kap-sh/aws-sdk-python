...
def handle_response(
    ...
    out: capo_cloudwatch.types.describe_insight_rules_output.DescribeInsightRulesOutput = capo_cloudwatch.types.describe_insight_rules_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    capo_cloudwatch.types.describe_insight_rules_input.serialize_query(
        input_, pairs, ""
    )
