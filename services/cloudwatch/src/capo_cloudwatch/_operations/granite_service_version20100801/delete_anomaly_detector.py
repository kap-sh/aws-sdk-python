"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DeleteAnomalyDetector``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.delete_anomaly_detector_output.DeleteAnomalyDetectorOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DeleteAnomalyDetector"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DeleteAnomalyDetector"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.delete_anomaly_detector_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_anomaly_detector(
