...
def handle_response(
    ...
    out: capo_cloudwatch.types.list_metrics_output.ListMetricsOutput = (
        capo_cloudwatch.types.list_metrics_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    capo_cloudwatch.types.list_metrics_input.serialize_query(input_, pairs, "")
...
def list_metrics(
    ...
    capo_cloudwatch.types.list_metrics_output.ListMetricsOutput, zapros.Response
]:
