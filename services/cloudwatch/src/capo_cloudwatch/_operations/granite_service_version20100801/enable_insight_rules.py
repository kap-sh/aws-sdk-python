...
def handle_response(
    ...
    out: capo_cloudwatch.types.enable_insight_rules_output.EnableInsightRulesOutput = (
        capo_cloudwatch.types.enable_insight_rules_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    capo_cloudwatch.types.enable_insight_rules_input.serialize_query(input_, pairs, "")
