"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DescribeAlarmsForMetric``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.describe_alarms_for_metric_output.DescribeAlarmsForMetricOutput = capo_cloudwatch.types.describe_alarms_for_metric_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DescribeAlarmsForMetric"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DescribeAlarmsForMetric"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.describe_alarms_for_metric_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_alarms_for_metric(
