"""Generated from Smithy shape ``com.amazonaws.cloudwatch#ListDashboards``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.list_dashboards_output.ListDashboardsOutput = (
        capo_cloudwatch.types.list_dashboards_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.ListDashboards"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "ListDashboards"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.list_dashboards_input.serialize_query(input_, pairs, "")
...
def list_dashboards(
    ...
    capo_cloudwatch.types.list_dashboards_output.ListDashboardsOutput, zapros.Response
]:
