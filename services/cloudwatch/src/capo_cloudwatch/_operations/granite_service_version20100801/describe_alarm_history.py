...
def handle_response(
    ...
    out: capo_cloudwatch.types.describe_alarm_history_output.DescribeAlarmHistoryOutput = capo_cloudwatch.types.describe_alarm_history_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    capo_cloudwatch.types.describe_alarm_history_input.serialize_query(
        input_, pairs, ""
    )
