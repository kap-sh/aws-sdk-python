"""Generated from Smithy shape ``com.amazonaws.cloudwatch#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_cloudwatch.types.list_tags_for_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.ListTagsForResource"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "ListTagsForResource"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.list_tags_for_resource_input.serialize_query(
        input_, pairs, ""
    )
