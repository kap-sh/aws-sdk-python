"""Generated from Smithy shape ``com.amazonaws.cloudwatch#GetDashboard``."""
...
import capo_cloudwatch.errors.dashboard_not_found_error
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DashboardNotFoundError":
            raise capo_cloudwatch.errors.dashboard_not_found_error.DashboardNotFoundError.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cloudwatch.types.get_dashboard_output.GetDashboardOutput = (
        capo_cloudwatch.types.get_dashboard_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.GetDashboard"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "GetDashboard"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.get_dashboard_input.serialize_query(input_, pairs, "")
...
def get_dashboard(
    ...
    capo_cloudwatch.types.get_dashboard_output.GetDashboardOutput, zapros.Response
]:
