"""Generated from Smithy shape ``com.amazonaws.cloudwatch#PutLogAlarm``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.PutLogAlarm"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "PutLogAlarm"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.put_log_alarm_input.serialize_query(input_, pairs, "")
