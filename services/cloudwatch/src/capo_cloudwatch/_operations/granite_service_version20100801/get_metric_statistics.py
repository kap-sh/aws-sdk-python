"""Generated from Smithy shape ``com.amazonaws.cloudwatch#GetMetricStatistics``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.get_metric_statistics_output.GetMetricStatisticsOutput = capo_cloudwatch.types.get_metric_statistics_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.GetMetricStatistics"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "GetMetricStatistics"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.get_metric_statistics_input.serialize_query(input_, pairs, "")
...
async def async_get_metric_statistics(
