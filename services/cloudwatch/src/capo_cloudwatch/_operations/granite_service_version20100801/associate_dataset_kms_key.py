...
import capo_cloudwatch.errors.kms_access_denied_exception
import capo_cloudwatch.errors.kms_key_disabled_exception
import capo_cloudwatch.errors.kms_key_not_found_exception
...
def handle_response(
    ...
    out: capo_cloudwatch.types.associate_dataset_kms_key_output.AssociateDatasetKmsKeyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    capo_cloudwatch.types.associate_dataset_kms_key_input.serialize_query(
        input_, pairs, ""
    )
