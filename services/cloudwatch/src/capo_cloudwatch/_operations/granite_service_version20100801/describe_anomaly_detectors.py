"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DescribeAnomalyDetectors``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.describe_anomaly_detectors_output.DescribeAnomalyDetectorsOutput = capo_cloudwatch.types.describe_anomaly_detectors_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DescribeAnomalyDetectors"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DescribeAnomalyDetectors"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.describe_anomaly_detectors_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_anomaly_detectors(
