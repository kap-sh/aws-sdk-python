"""Generated from Smithy shape ``com.amazonaws.cloudwatch#GetInsightRuleReport``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.get_insight_rule_report_output.GetInsightRuleReportOutput = capo_cloudwatch.types.get_insight_rule_report_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.GetInsightRuleReport"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "GetInsightRuleReport"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.get_insight_rule_report_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_insight_rule_report(
