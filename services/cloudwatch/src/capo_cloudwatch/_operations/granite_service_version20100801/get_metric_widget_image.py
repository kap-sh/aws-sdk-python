"""Generated from Smithy shape ``com.amazonaws.cloudwatch#GetMetricWidgetImage``."""
...
def handle_response(
    ...
    out: capo_cloudwatch.types.get_metric_widget_image_output.GetMetricWidgetImageOutput = capo_cloudwatch.types.get_metric_widget_image_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.GetMetricWidgetImage"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "GetMetricWidgetImage"))
    pairs.append(("Version", "2010-08-01"))
    capo_cloudwatch.types.get_metric_widget_image_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_metric_widget_image(
