...
def handle_response(
    ...
    out: capo_cloudwatch.types.disassociate_dataset_kms_key_output.DisassociateDatasetKmsKeyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    capo_cloudwatch.types.disassociate_dataset_kms_key_input.serialize_query(
        input_, pairs, ""
    )
