...
class CloudWatchError(Exception):
    """Base class for all CloudWatch service errors."""


class ServiceError(CloudWatchError):
...
class SerializationError(CloudWatchError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudWatchError):
...
class WaiterFailedError(CloudWatchError):
...
class WaiterTimeoutError(CloudWatchError):
