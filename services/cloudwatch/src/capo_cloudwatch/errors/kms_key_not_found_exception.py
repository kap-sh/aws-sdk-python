"""Generated from Smithy shape ``com.amazonaws.cloudwatch#KmsKeyNotFoundException``."""
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: KmsKeyNotFoundException_) -> dict:
    out: dict = {}
    if "message" in value:
...
def deserialize_aws_json_1_0(data: dict) -> KmsKeyNotFoundException_:
...
class KmsKeyNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatch#KmsKeyNotFoundException``."""
