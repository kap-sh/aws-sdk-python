            ...
            if string_equals(
                ...
                if p.UseFIPS is True:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://monitoring.{Region}.{PartitionResult#dnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={},
            ...
            if string_equals(
                ...
                if p.UseFIPS is True:
                    if p.UseDualStack is True:
                        return Endpoint(
                            url=interpolate(
                                "https://monitoring.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={},
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://monitoring-fips.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={},
            ...
            if p.UseFIPS is True:
                if p.UseDualStack is False:
                    if (
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://monitoring-fips.{Region}.{PartitionResult#dnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={},
