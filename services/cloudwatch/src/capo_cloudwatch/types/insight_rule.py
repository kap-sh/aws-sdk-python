...
class InsightRule(TypedDict, closed=True):
    ...
    managed_rule: NotRequired[
        "capo_cloudwatch.types.insight_rule_is_managed.InsightRuleIsManaged"
    ]
