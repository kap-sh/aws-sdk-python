...
if TYPE_CHECKING:
    import capo_cloudwatch.types.attribute_name
    import capo_cloudwatch.types.attribute_value

ContributorAttributes: TypeAlias = dict[
    "capo_cloudwatch.types.attribute_name.AttributeName",
    "capo_cloudwatch.types.attribute_value.AttributeValue",
]
