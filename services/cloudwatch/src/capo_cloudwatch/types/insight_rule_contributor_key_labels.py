...
if TYPE_CHECKING:
    import capo_cloudwatch.types.insight_rule_contributor_key_label

InsightRuleContributorKeyLabels: TypeAlias = list[
    "capo_cloudwatch.types.insight_rule_contributor_key_label.InsightRuleContributorKeyLabel"
]
