"""Generated from Smithy shape ``com.amazonaws.cloudwatch#EnableAlarmActionsInput``."""
...
class EnableAlarmActionsInput(TypedDict, closed=True):
    alarm_names: NotRequired["capo_cloudwatch.types.alarm_names.AlarmNames"]
    """<p>The names of the alarms.</p>"""


# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: EnableAlarmActionsInput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> EnableAlarmActionsInput:
    out: EnableAlarmActionsInput = {}  # type: ignore[typeddict-item]
...
# --- awsQuery ser/de ---
def serialize_query(
    value: EnableAlarmActionsInput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> EnableAlarmActionsInput:
    out: EnableAlarmActionsInput = {}  # type: ignore[typeddict-item]
