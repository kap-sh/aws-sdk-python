...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.exception_type
    import aws_sdk_cloudwatch.types.failure_code
    import aws_sdk_cloudwatch.types.failure_description
    import aws_sdk_cloudwatch.types.failure_resource


class PartialFailure(TypedDict):
    failure_resource: NotRequired[
        "aws_sdk_cloudwatch.types.failure_resource.FailureResource"
    ]
    """<p>The specified rule that could not be deleted.</p>"""
    exception_type: NotRequired["aws_sdk_cloudwatch.types.exception_type.ExceptionType"]
    """<p>The type of error.</p>"""
    failure_code: NotRequired["aws_sdk_cloudwatch.types.failure_code.FailureCode"]
    """<p>The code of the error.</p>"""
    failure_description: NotRequired[
        "aws_sdk_cloudwatch.types.failure_description.FailureDescription"
    ]
