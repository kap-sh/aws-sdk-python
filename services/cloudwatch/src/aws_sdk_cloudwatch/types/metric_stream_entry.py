...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch.types.metric_stream_state
    import aws_sdk_cloudwatch.types.timestamp


class MetricStreamEntry(TypedDict):
    arn: NotRequired["aws_sdk_cloudwatch.types.amazon_resource_name.AmazonResourceName"]
    """<p>The ARN of the metric stream.</p>"""
    creation_date: NotRequired["aws_sdk_cloudwatch.types.timestamp.Timestamp"]
    """<p>The date that the metric stream was originally created.</p>"""
    last_update_date: NotRequired["aws_sdk_cloudwatch.types.timestamp.Timestamp"]
    ...
    state: NotRequired["aws_sdk_cloudwatch.types.metric_stream_state.MetricStreamState"]
...
def serialize_aws_json_1_0(value: MetricStreamEntry) -> dict:
    ...
    if "creation_date" in value:
        ...
        out["CreationDate"] = aws_sdk_cloudwatch.types.timestamp.serialize_aws_json_1_0(
            value["creation_date"]
        )
    ...
    if "output_format" in value:
        ...
        out["OutputFormat"] = (
            aws_sdk_cloudwatch.types.metric_stream_output_format.serialize_aws_json_1_0(
                value["output_format"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> MetricStreamEntry:
    ...
    if "OutputFormat" in data:
        ...
        out["output_format"] = (
            aws_sdk_cloudwatch.types.metric_stream_output_format.deserialize_aws_json_1_0(
                data["OutputFormat"]
            )
        )
    return out
...
def serialize_query(
    ...
    if "output_format" in value:
        ...
        aws_sdk_cloudwatch.types.metric_stream_output_format.serialize_query(
...
def deserialize_query(el: Element) -> MetricStreamEntry:
    ...
    if child_creation_date is not None:
        ...
        out["creation_date"] = aws_sdk_cloudwatch.types.timestamp.deserialize_query(
            child_creation_date
        )
    ...
    if child_last_update_date is not None:
        ...
        out["last_update_date"] = aws_sdk_cloudwatch.types.timestamp.deserialize_query(
    ...
    if child_output_format is not None:
        ...
        out["output_format"] = (
            aws_sdk_cloudwatch.types.metric_stream_output_format.deserialize_query(
                child_output_format
            )
        )
    return out
