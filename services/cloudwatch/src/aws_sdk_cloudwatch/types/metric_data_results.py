...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.metric_data_result

MetricDataResults: TypeAlias = list[
    "aws_sdk_cloudwatch.types.metric_data_result.MetricDataResult"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_cloudwatch.types.metric_data_result.serialize_query(
...
def deserialize_query(el: Element) -> MetricDataResults:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_cloudwatch.types.metric_data_result.deserialize_query(child))
    return out
...
def serialize_aws_json_1_0(value: MetricDataResults) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cloudwatch.types.metric_data_result.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> MetricDataResults:
    ...
    for item in data:
        out.append(
            aws_sdk_cloudwatch.types.metric_data_result.deserialize_aws_json_1_0(item)
        )
    return out
