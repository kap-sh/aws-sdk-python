...
class GetMetricStreamOutput(TypedDict):
...
def serialize_aws_json_1_0(value: GetMetricStreamOutput) -> dict:
    ...
    if "include_filters" in value:
        ...
        out["IncludeFilters"] = (
            aws_sdk_cloudwatch.types.metric_stream_filters.serialize_aws_json_1_0(
    ...
    if "statistics_configurations" in value:
        ...
        out["StatisticsConfigurations"] = (
            aws_sdk_cloudwatch.types.metric_stream_statistics_configurations.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetMetricStreamOutput:
    ...
    if "IncludeFilters" in data:
        ...
        out["include_filters"] = (
            aws_sdk_cloudwatch.types.metric_stream_filters.deserialize_aws_json_1_0(
                data["IncludeFilters"]
            )
        )
    ...
    if "StatisticsConfigurations" in data:
        ...
        out["statistics_configurations"] = (
            aws_sdk_cloudwatch.types.metric_stream_statistics_configurations.deserialize_aws_json_1_0(
...
def serialize_query(
    ...
    if "include_filters" in value:
        ...
        aws_sdk_cloudwatch.types.metric_stream_filters.serialize_query(
    ...
    if "statistics_configurations" in value:
        ...
        aws_sdk_cloudwatch.types.metric_stream_statistics_configurations.serialize_query(
            value["statistics_configurations"],
            pairs,
...
def deserialize_query(el: Element) -> GetMetricStreamOutput:
    ...
    if child_include_filters is not None:
        ...
        out["include_filters"] = (
            aws_sdk_cloudwatch.types.metric_stream_filters.deserialize_query(
    ...
    if child_statistics_configurations is not None:
        ...
        out["statistics_configurations"] = (
            aws_sdk_cloudwatch.types.metric_stream_statistics_configurations.deserialize_query(
