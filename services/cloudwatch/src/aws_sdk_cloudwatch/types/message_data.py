...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.message_data_code
    import aws_sdk_cloudwatch.types.message_data_value


class MessageData(TypedDict):
    code: NotRequired["aws_sdk_cloudwatch.types.message_data_code.MessageDataCode"]
    """<p>The error code or status code associated with the message.</p>"""
    value: NotRequired["aws_sdk_cloudwatch.types.message_data_value.MessageDataValue"]
