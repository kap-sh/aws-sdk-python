...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.managed_rule_description

ManagedRuleDescriptions: TypeAlias = list[
    "aws_sdk_cloudwatch.types.managed_rule_description.ManagedRuleDescription"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_cloudwatch.types.managed_rule_description.serialize_query(
...
def deserialize_query(el: Element) -> ManagedRuleDescriptions:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_cloudwatch.types.managed_rule_description.deserialize_query(child)
        )
    return out
...
def serialize_aws_json_1_0(value: ManagedRuleDescriptions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cloudwatch.types.managed_rule_description.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ManagedRuleDescriptions:
    ...
    for item in data:
        out.append(
            aws_sdk_cloudwatch.types.managed_rule_description.deserialize_aws_json_1_0(
                item
            )
        )
    return out
