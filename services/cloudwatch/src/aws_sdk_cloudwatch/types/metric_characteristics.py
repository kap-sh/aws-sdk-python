...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.periodic_spikes


class MetricCharacteristics(TypedDict):
    periodic_spikes: NotRequired[
        "aws_sdk_cloudwatch.types.periodic_spikes.PeriodicSpikes"
    ]
