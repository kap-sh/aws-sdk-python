...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.insight_rule_aggregation_statistic
    import aws_sdk_cloudwatch.types.insight_rule_contributor_key_labels
    import aws_sdk_cloudwatch.types.insight_rule_contributors
    import aws_sdk_cloudwatch.types.insight_rule_metric_datapoints
    import aws_sdk_cloudwatch.types.insight_rule_unbound_double
    import aws_sdk_cloudwatch.types.insight_rule_unbound_long


class GetInsightRuleReportOutput(TypedDict):
    key_labels: NotRequired[
        "aws_sdk_cloudwatch.types.insight_rule_contributor_key_labels.InsightRuleContributorKeyLabels"
    ]
    ...
    aggregation_statistic: NotRequired[
        "aws_sdk_cloudwatch.types.insight_rule_aggregation_statistic.InsightRuleAggregationStatistic"
    ]
    ...
    approximate_unique_count: NotRequired[
        "aws_sdk_cloudwatch.types.insight_rule_unbound_long.InsightRuleUnboundLong"
    ]
    """<p>An approximate count of the unique contributors found by this rule in this time period.</p>"""
    contributors: NotRequired[
        "aws_sdk_cloudwatch.types.insight_rule_contributors.InsightRuleContributors"
    ]
    ...
    metric_datapoints: NotRequired[
        "aws_sdk_cloudwatch.types.insight_rule_metric_datapoints.InsightRuleMetricDatapoints"
    ]
...
def serialize_aws_json_1_0(value: GetInsightRuleReportOutput) -> dict:
    ...
    if "key_labels" in value:
        ...
        out["KeyLabels"] = (
            aws_sdk_cloudwatch.types.insight_rule_contributor_key_labels.serialize_aws_json_1_0(
                value["key_labels"]
            )
        )
    ...
    if "contributors" in value:
        ...
        out["Contributors"] = (
            aws_sdk_cloudwatch.types.insight_rule_contributors.serialize_aws_json_1_0(
                value["contributors"]
            )
        )
    if "metric_datapoints" in value:
        ...
        out["MetricDatapoints"] = (
            aws_sdk_cloudwatch.types.insight_rule_metric_datapoints.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetInsightRuleReportOutput:
    ...
    if "KeyLabels" in data:
        ...
        out["key_labels"] = (
            aws_sdk_cloudwatch.types.insight_rule_contributor_key_labels.deserialize_aws_json_1_0(
                data["KeyLabels"]
            )
        )
    ...
    if "Contributors" in data:
        ...
        out["contributors"] = (
            aws_sdk_cloudwatch.types.insight_rule_contributors.deserialize_aws_json_1_0(
                data["Contributors"]
            )
        )
    if "MetricDatapoints" in data:
        ...
        out["metric_datapoints"] = (
            aws_sdk_cloudwatch.types.insight_rule_metric_datapoints.deserialize_aws_json_1_0(
...
def serialize_query(
    ...
    if "key_labels" in value:
        ...
        aws_sdk_cloudwatch.types.insight_rule_contributor_key_labels.serialize_query(
    ...
    if "contributors" in value:
        ...
        aws_sdk_cloudwatch.types.insight_rule_contributors.serialize_query(
            value["contributors"], pairs, f"{prefix}.Contributors"
        )
    if "metric_datapoints" in value:
        import aws_sdk_cloudwatch.types.insight_rule_metric_datapoints

        aws_sdk_cloudwatch.types.insight_rule_metric_datapoints.serialize_query(
...
def deserialize_query(el: Element) -> GetInsightRuleReportOutput:
    ...
    if child_key_labels is not None:
        ...
        out["key_labels"] = (
            aws_sdk_cloudwatch.types.insight_rule_contributor_key_labels.deserialize_query(
                child_key_labels
            )
        )
    ...
    if child_contributors is not None:
        ...
        out["contributors"] = (
            aws_sdk_cloudwatch.types.insight_rule_contributors.deserialize_query(
                child_contributors
            )
        )
    ...
    if child_metric_datapoints is not None:
        ...
        out["metric_datapoints"] = (
            aws_sdk_cloudwatch.types.insight_rule_metric_datapoints.deserialize_query(
