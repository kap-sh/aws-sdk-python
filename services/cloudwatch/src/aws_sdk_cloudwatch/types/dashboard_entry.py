...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch.types.last_modified
    import aws_sdk_cloudwatch.types.size
...
class DashboardEntry(TypedDict, closed=True):
    ...
    last_modified: NotRequired["aws_sdk_cloudwatch.types.last_modified.LastModified"]
    ...
    size: NotRequired["aws_sdk_cloudwatch.types.size.Size"]
...
def serialize_aws_json_1_0(value: DashboardEntry) -> dict:
    ...
    if "last_modified" in value:
        ...
        out["LastModified"] = (
            aws_sdk_cloudwatch.types.last_modified.serialize_aws_json_1_0(
                value["last_modified"]
            )
        )
    if "size" in value:
...
def deserialize_aws_json_1_0(data: dict) -> DashboardEntry:
    ...
    if "LastModified" in data:
        ...
        out["last_modified"] = (
            aws_sdk_cloudwatch.types.last_modified.deserialize_aws_json_1_0(
                data["LastModified"]
            )
        )
    if "Size" in data:
...
def serialize_query(
    ...
    if "last_modified" in value:
        ...
        aws_sdk_cloudwatch.types.last_modified.serialize_query(
...
def deserialize_query(el: Element) -> DashboardEntry:
    ...
    if child_last_modified is not None:
        ...
        out["last_modified"] = aws_sdk_cloudwatch.types.last_modified.deserialize_query(
            child_last_modified
        )
