...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.alarm_contributor

AlarmContributors: TypeAlias = list[
    "aws_sdk_cloudwatch.types.alarm_contributor.AlarmContributor"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_cloudwatch.types.alarm_contributor.serialize_query(
...
def deserialize_query(el: Element) -> AlarmContributors:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_cloudwatch.types.alarm_contributor.deserialize_query(child))
    return out
...
def serialize_aws_json_1_0(value: AlarmContributors) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cloudwatch.types.alarm_contributor.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> AlarmContributors:
    ...
    for item in data:
        out.append(
            aws_sdk_cloudwatch.types.alarm_contributor.deserialize_aws_json_1_0(item)
        )
    return out
