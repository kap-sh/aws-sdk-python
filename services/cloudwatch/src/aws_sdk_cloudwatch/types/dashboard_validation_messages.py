...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.dashboard_validation_message

DashboardValidationMessages: TypeAlias = list[
    "aws_sdk_cloudwatch.types.dashboard_validation_message.DashboardValidationMessage"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_cloudwatch.types.dashboard_validation_message.serialize_query(
...
def deserialize_query(el: Element) -> DashboardValidationMessages:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_cloudwatch.types.dashboard_validation_message.deserialize_query(
                child
            )
        )
    return out
...
def serialize_aws_json_1_0(value: DashboardValidationMessages) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cloudwatch.types.dashboard_validation_message.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> DashboardValidationMessages:
    ...
    for item in data:
        out.append(
            aws_sdk_cloudwatch.types.dashboard_validation_message.deserialize_aws_json_1_0(
                item
            )
        )
    return out
