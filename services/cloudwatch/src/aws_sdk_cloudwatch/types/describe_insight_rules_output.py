...
class DescribeInsightRulesOutput(TypedDict):
    ...
    insight_rules: NotRequired["aws_sdk_cloudwatch.types.insight_rules.InsightRules"]
...
def serialize_aws_json_1_0(value: DescribeInsightRulesOutput) -> dict:
    ...
    if "insight_rules" in value:
        ...
        out["InsightRules"] = (
            aws_sdk_cloudwatch.types.insight_rules.serialize_aws_json_1_0(
                value["insight_rules"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> DescribeInsightRulesOutput:
    ...
    if "InsightRules" in data:
        ...
        out["insight_rules"] = (
            aws_sdk_cloudwatch.types.insight_rules.deserialize_aws_json_1_0(
                data["InsightRules"]
            )
        )
    return out
...
def serialize_query(
    ...
    if "insight_rules" in value:
        ...
        aws_sdk_cloudwatch.types.insight_rules.serialize_query(
...
def deserialize_query(el: Element) -> DescribeInsightRulesOutput:
    ...
    if child_insight_rules is not None:
        ...
        out["insight_rules"] = aws_sdk_cloudwatch.types.insight_rules.deserialize_query(
            child_insight_rules
        )
    return out
