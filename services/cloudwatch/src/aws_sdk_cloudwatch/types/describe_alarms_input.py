...
class DescribeAlarmsInput(TypedDict):
    ...
    parents_of_alarm_name: NotRequired["aws_sdk_cloudwatch.types.alarm_name.AlarmName"]
    ...
    action_prefix: NotRequired["aws_sdk_cloudwatch.types.action_prefix.ActionPrefix"]
