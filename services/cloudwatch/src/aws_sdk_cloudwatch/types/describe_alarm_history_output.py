...
class DescribeAlarmHistoryOutput(TypedDict):
    alarm_history_items: NotRequired[
        "aws_sdk_cloudwatch.types.alarm_history_items.AlarmHistoryItems"
    ]
...
def serialize_aws_json_1_0(value: DescribeAlarmHistoryOutput) -> dict:
    ...
    if "alarm_history_items" in value:
        ...
        out["AlarmHistoryItems"] = (
            aws_sdk_cloudwatch.types.alarm_history_items.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DescribeAlarmHistoryOutput:
    ...
    if "AlarmHistoryItems" in data:
        ...
        out["alarm_history_items"] = (
            aws_sdk_cloudwatch.types.alarm_history_items.deserialize_aws_json_1_0(
...
def serialize_query(
    ...
    if "alarm_history_items" in value:
        ...
        aws_sdk_cloudwatch.types.alarm_history_items.serialize_query(
            value["alarm_history_items"], pairs, f"{prefix}.AlarmHistoryItems"
        )
    if "next_token" in value:
...
def deserialize_query(el: Element) -> DescribeAlarmHistoryOutput:
    ...
    if child_alarm_history_items is not None:
        ...
        out["alarm_history_items"] = (
            aws_sdk_cloudwatch.types.alarm_history_items.deserialize_query(
