...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.metric_stream_filter_metric_names
    import aws_sdk_cloudwatch.types.namespace


class MetricStreamFilter(TypedDict):
    ...
    metric_names: NotRequired[
        "aws_sdk_cloudwatch.types.metric_stream_filter_metric_names.MetricStreamFilterMetricNames"
    ]
...
def serialize_aws_json_1_0(value: MetricStreamFilter) -> dict:
    ...
    if "metric_names" in value:
        ...
        out["MetricNames"] = (
            aws_sdk_cloudwatch.types.metric_stream_filter_metric_names.serialize_aws_json_1_0(
                value["metric_names"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> MetricStreamFilter:
    ...
    if "MetricNames" in data:
        ...
        out["metric_names"] = (
            aws_sdk_cloudwatch.types.metric_stream_filter_metric_names.deserialize_aws_json_1_0(
                data["MetricNames"]
            )
        )
    return out
...
def serialize_query(
    ...
    if "metric_names" in value:
        ...
        aws_sdk_cloudwatch.types.metric_stream_filter_metric_names.serialize_query(
...
def deserialize_query(el: Element) -> MetricStreamFilter:
    ...
    if child_metric_names is not None:
        ...
        out["metric_names"] = (
            aws_sdk_cloudwatch.types.metric_stream_filter_metric_names.deserialize_query(
                child_metric_names
            )
        )
    return out
