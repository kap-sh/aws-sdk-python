...
class GetMetricDataInput(TypedDict):
    ...
    label_options: NotRequired["aws_sdk_cloudwatch.types.label_options.LabelOptions"]
...
def serialize_aws_json_1_0(value: GetMetricDataInput) -> dict:
    ...
    if "label_options" in value:
        ...
        out["LabelOptions"] = (
            aws_sdk_cloudwatch.types.label_options.serialize_aws_json_1_0(
                value["label_options"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> GetMetricDataInput:
    ...
    if "LabelOptions" in data:
        ...
        out["label_options"] = (
            aws_sdk_cloudwatch.types.label_options.deserialize_aws_json_1_0(
                data["LabelOptions"]
            )
        )
    return out
...
def serialize_query(
    ...
    if "label_options" in value:
        ...
        aws_sdk_cloudwatch.types.label_options.serialize_query(
...
def deserialize_query(el: Element) -> GetMetricDataInput:
    ...
    if child_metric_data_queries is not None:
        ...
        out["metric_data_queries"] = (
            aws_sdk_cloudwatch.types.metric_data_queries.deserialize_query(
    ...
    if child_label_options is not None:
        ...
        out["label_options"] = aws_sdk_cloudwatch.types.label_options.deserialize_query(
            child_label_options
        )
    return out
