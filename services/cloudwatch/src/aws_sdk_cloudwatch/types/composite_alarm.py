...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch.types.actions_suppressed_by
    import aws_sdk_cloudwatch.types.actions_suppressed_reason
...
class CompositeAlarm(TypedDict):
    ...
    actions_suppressed_by: NotRequired[
        "aws_sdk_cloudwatch.types.actions_suppressed_by.ActionsSuppressedBy"
    ]
    ...
    actions_suppressed_reason: NotRequired[
        "aws_sdk_cloudwatch.types.actions_suppressed_reason.ActionsSuppressedReason"
    ]
...
def serialize_aws_json_1_0(value: CompositeAlarm) -> dict:
    ...
    if "actions_suppressed_by" in value:
        ...
        out["ActionsSuppressedBy"] = (
            aws_sdk_cloudwatch.types.actions_suppressed_by.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> CompositeAlarm:
    ...
    if "ActionsSuppressedBy" in data:
        ...
        out["actions_suppressed_by"] = (
            aws_sdk_cloudwatch.types.actions_suppressed_by.deserialize_aws_json_1_0(
...
def serialize_query(
    ...
    if "actions_suppressed_by" in value:
        ...
        aws_sdk_cloudwatch.types.actions_suppressed_by.serialize_query(
...
def deserialize_query(el: Element) -> CompositeAlarm:
    ...
    if child_actions_suppressed_by is not None:
        ...
        out["actions_suppressed_by"] = (
            aws_sdk_cloudwatch.types.actions_suppressed_by.deserialize_query(
