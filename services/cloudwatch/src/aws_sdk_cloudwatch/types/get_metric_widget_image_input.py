...
class GetMetricWidgetImageInput(TypedDict):
    metric_widget: NotRequired["aws_sdk_cloudwatch.types.metric_widget.MetricWidget"]
    ...
    output_format: NotRequired["aws_sdk_cloudwatch.types.output_format.OutputFormat"]
