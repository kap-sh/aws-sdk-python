...
class AssociateDatasetKmsKeyInput(TypedDict):
    dataset_identifier: NotRequired[
        "aws_sdk_cloudwatch.types.dataset_identifier.DatasetIdentifier"
    ]
