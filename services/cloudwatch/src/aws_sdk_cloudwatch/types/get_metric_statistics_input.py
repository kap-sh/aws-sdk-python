...
class GetMetricStatisticsInput(TypedDict):
    ...
    statistics: NotRequired["aws_sdk_cloudwatch.types.statistics.Statistics"]
...
def serialize_aws_json_1_0(value: GetMetricStatisticsInput) -> dict:
    ...
    if "statistics" in value:
        ...
        out["Statistics"] = aws_sdk_cloudwatch.types.statistics.serialize_aws_json_1_0(
            value["statistics"]
        )
    if "extended_statistics" in value:
        ...
        out["ExtendedStatistics"] = (
            aws_sdk_cloudwatch.types.extended_statistics.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetMetricStatisticsInput:
    ...
    if "Statistics" in data:
        ...
        out["statistics"] = (
            aws_sdk_cloudwatch.types.statistics.deserialize_aws_json_1_0(
                data["Statistics"]
            )
        )
    if "ExtendedStatistics" in data:
        ...
        out["extended_statistics"] = (
            aws_sdk_cloudwatch.types.extended_statistics.deserialize_aws_json_1_0(
...
def serialize_query(
    ...
    if "statistics" in value:
        ...
        aws_sdk_cloudwatch.types.statistics.serialize_query(
            value["statistics"], pairs, f"{prefix}.Statistics"
        )
    if "extended_statistics" in value:
        import aws_sdk_cloudwatch.types.extended_statistics

        aws_sdk_cloudwatch.types.extended_statistics.serialize_query(
...
def deserialize_query(el: Element) -> GetMetricStatisticsInput:
    ...
    if child_statistics is not None:
        ...
        out["statistics"] = aws_sdk_cloudwatch.types.statistics.deserialize_query(
            child_statistics
        )
    ...
    if child_extended_statistics is not None:
        ...
        out["extended_statistics"] = (
            aws_sdk_cloudwatch.types.extended_statistics.deserialize_query(
