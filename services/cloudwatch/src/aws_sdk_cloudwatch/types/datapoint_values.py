"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DatapointValues``."""
...
DatapointValues: TypeAlias = list[
    "aws_sdk_cloudwatch.types.datapoint_value.DatapointValue"
]
