...
AlarmMuteRuleSummaries: TypeAlias = list[
    "aws_sdk_cloudwatch.types.alarm_mute_rule_summary.AlarmMuteRuleSummary"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_cloudwatch.types.alarm_mute_rule_summary.serialize_query(
...
def deserialize_query(el: Element) -> AlarmMuteRuleSummaries:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_cloudwatch.types.alarm_mute_rule_summary.deserialize_query(child)
        )
    return out
...
def serialize_aws_json_1_0(value: AlarmMuteRuleSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cloudwatch.types.alarm_mute_rule_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> AlarmMuteRuleSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_cloudwatch.types.alarm_mute_rule_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
