...
class StartMetricStreamsInput(TypedDict):
    names: NotRequired["aws_sdk_cloudwatch.types.metric_stream_names.MetricStreamNames"]
...
def serialize_aws_json_1_0(value: StartMetricStreamsInput) -> dict:
    ...
    if "names" in value:
        ...
        out["Names"] = (
            aws_sdk_cloudwatch.types.metric_stream_names.serialize_aws_json_1_0(
                value["names"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> StartMetricStreamsInput:
    ...
    if "Names" in data:
        ...
        out["names"] = (
            aws_sdk_cloudwatch.types.metric_stream_names.deserialize_aws_json_1_0(
                data["Names"]
            )
        )
    return out
...
def serialize_query(
    ...
    if "names" in value:
        ...
        aws_sdk_cloudwatch.types.metric_stream_names.serialize_query(
...
def deserialize_query(el: Element) -> StartMetricStreamsInput:
    ...
    if child_names is not None:
        ...
        out["names"] = aws_sdk_cloudwatch.types.metric_stream_names.deserialize_query(
            child_names
        )
    return out
