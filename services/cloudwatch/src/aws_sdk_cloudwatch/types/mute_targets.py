...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.mute_target_alarm_name_list


class MuteTargets(TypedDict):
    alarm_names: NotRequired[
        "aws_sdk_cloudwatch.types.mute_target_alarm_name_list.MuteTargetAlarmNameList"
    ]
...
def serialize_aws_json_1_0(value: MuteTargets) -> dict:
    ...
    if "alarm_names" in value:
        ...
        out["AlarmNames"] = (
            aws_sdk_cloudwatch.types.mute_target_alarm_name_list.serialize_aws_json_1_0(
                value["alarm_names"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> MuteTargets:
    ...
    if "AlarmNames" in data:
        ...
        out["alarm_names"] = (
            aws_sdk_cloudwatch.types.mute_target_alarm_name_list.deserialize_aws_json_1_0(
                data["AlarmNames"]
            )
        )
    return out
...
def serialize_query(
    ...
    if "alarm_names" in value:
        ...
        aws_sdk_cloudwatch.types.mute_target_alarm_name_list.serialize_query(
...
def deserialize_query(el: Element) -> MuteTargets:
    ...
    if child_alarm_names is not None:
        ...
        out["alarm_names"] = (
            aws_sdk_cloudwatch.types.mute_target_alarm_name_list.deserialize_query(
                child_alarm_names
            )
        )
    return out
