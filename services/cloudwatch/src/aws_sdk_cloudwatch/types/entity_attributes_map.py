...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.entity_attributes_map_key_string
    import aws_sdk_cloudwatch.types.entity_attributes_map_value_string

EntityAttributesMap: TypeAlias = dict[
    "aws_sdk_cloudwatch.types.entity_attributes_map_key_string.EntityAttributesMapKeyString",
    "aws_sdk_cloudwatch.types.entity_attributes_map_value_string.EntityAttributesMapValueString",
]
