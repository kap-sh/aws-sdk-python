...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch.types.counts
    ...
    import aws_sdk_cloudwatch.types.statistic_set
    import aws_sdk_cloudwatch.types.storage_resolution
    import aws_sdk_cloudwatch.types.timestamp
    import aws_sdk_cloudwatch.types.values
...
class MetricDatum(TypedDict):
    ...
    value: NotRequired["aws_sdk_cloudwatch.types.datapoint_value.DatapointValue"]
    ...
    statistic_values: NotRequired["aws_sdk_cloudwatch.types.statistic_set.StatisticSet"]
    """<p>The statistical values for the metric.</p>"""
    values: NotRequired["aws_sdk_cloudwatch.types.values.Values"]
    ...
    counts: NotRequired["aws_sdk_cloudwatch.types.counts.Counts"]
    ...
    storage_resolution: NotRequired[
        "aws_sdk_cloudwatch.types.storage_resolution.StorageResolution"
    ]
...
def serialize_aws_json_1_0(value: MetricDatum) -> dict:
    ...
    if "statistic_values" in value:
        ...
        out["StatisticValues"] = (
            aws_sdk_cloudwatch.types.statistic_set.serialize_aws_json_1_0(
    ...
    if "values" in value:
        ...
        out["Values"] = aws_sdk_cloudwatch.types.values.serialize_aws_json_1_0(
            value["values"]
        )
    if "counts" in value:
        import aws_sdk_cloudwatch.types.counts

        out["Counts"] = aws_sdk_cloudwatch.types.counts.serialize_aws_json_1_0(
            value["counts"]
        )
    if "unit" in value:
        import aws_sdk_cloudwatch.types.standard_unit
...
def deserialize_aws_json_1_0(data: dict) -> MetricDatum:
    ...
    if "StatisticValues" in data:
        ...
        out["statistic_values"] = (
            aws_sdk_cloudwatch.types.statistic_set.deserialize_aws_json_1_0(
    ...
    if "Values" in data:
        ...
        out["values"] = aws_sdk_cloudwatch.types.values.deserialize_aws_json_1_0(
            data["Values"]
        )
    if "Counts" in data:
        import aws_sdk_cloudwatch.types.counts

        out["counts"] = aws_sdk_cloudwatch.types.counts.deserialize_aws_json_1_0(
            data["Counts"]
        )
    if "Unit" in data:
        import aws_sdk_cloudwatch.types.standard_unit
...
def serialize_query(
    ...
    if "statistic_values" in value:
        ...
        aws_sdk_cloudwatch.types.statistic_set.serialize_query(
            value["statistic_values"], pairs, f"{prefix}.StatisticValues"
        )
    if "values" in value:
        import aws_sdk_cloudwatch.types.values

        aws_sdk_cloudwatch.types.values.serialize_query(
            value["values"], pairs, f"{prefix}.Values"
        )
    if "counts" in value:
        import aws_sdk_cloudwatch.types.counts

        aws_sdk_cloudwatch.types.counts.serialize_query(
...
def deserialize_query(el: Element) -> MetricDatum:
    ...
    if child_statistic_values is not None:
        ...
        out["statistic_values"] = (
            aws_sdk_cloudwatch.types.statistic_set.deserialize_query(
    ...
    if child_values is not None:
        ...
        out["values"] = aws_sdk_cloudwatch.types.values.deserialize_query(child_values)
    child_counts = el.find("Counts")
    if child_counts is not None:
        import aws_sdk_cloudwatch.types.counts

        out["counts"] = aws_sdk_cloudwatch.types.counts.deserialize_query(child_counts)
