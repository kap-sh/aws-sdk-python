...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.get_metric_widget_image_output.GetMetricWidgetImageOutput = aws_sdk_cloudwatch.types.get_metric_widget_image_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.get_metric_widget_image_input.GetMetricWidgetImageInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.get_metric_widget_image_input.serialize_query(
        input_, pairs, ""
    )
