"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DisassociateDatasetKmsKey``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.disassociate_dataset_kms_key_output.DisassociateDatasetKmsKeyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.disassociate_dataset_kms_key_input.DisassociateDatasetKmsKeyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DisassociateDatasetKmsKey"
...
async def async_disassociate_dataset_kms_key(
