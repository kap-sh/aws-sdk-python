...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentModificationException":
            import aws_sdk_cloudwatch.errors.concurrent_modification_exception

            raise aws_sdk_cloudwatch.errors.concurrent_modification_exception.ConcurrentModificationException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.tag_resource_input.TagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.tag_resource_input.serialize_query(input_, pairs, "")
...
def tag_resource(
    ...
    aws_sdk_cloudwatch.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
