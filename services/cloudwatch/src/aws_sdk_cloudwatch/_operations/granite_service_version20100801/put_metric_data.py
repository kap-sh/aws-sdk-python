"""Generated from Smithy shape ``com.amazonaws.cloudwatch#PutMetricData``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.put_metric_data_input.PutMetricDataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.PutMetricData"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "PutMetricData"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.put_metric_data_input

    aws_sdk_cloudwatch.types.put_metric_data_input.serialize_query(input_, pairs, "")
...
async def async_put_metric_data(
