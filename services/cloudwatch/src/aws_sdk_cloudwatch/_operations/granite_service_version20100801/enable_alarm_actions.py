"""Generated from Smithy shape ``com.amazonaws.cloudwatch#EnableAlarmActions``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.enable_alarm_actions_input.EnableAlarmActionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.EnableAlarmActions"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "EnableAlarmActions"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.enable_alarm_actions_input

    aws_sdk_cloudwatch.types.enable_alarm_actions_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_enable_alarm_actions(
