"""Generated from Smithy shape ``com.amazonaws.cloudwatch#GetOTelEnrichment``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.get_o_tel_enrichment_output.GetOTelEnrichmentOutput = aws_sdk_cloudwatch.types.get_o_tel_enrichment_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.get_o_tel_enrichment_input.GetOTelEnrichmentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.GetOTelEnrichment"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "GetOTelEnrichment"))
    pairs.append(("Version", "2010-08-01"))
    aws_sdk_cloudwatch.types.get_o_tel_enrichment_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_o_tel_enrichment(
