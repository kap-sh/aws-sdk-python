...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.delete_anomaly_detector_output.DeleteAnomalyDetectorOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.delete_anomaly_detector_input.DeleteAnomalyDetectorInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.delete_anomaly_detector_input.serialize_query(
        input_, pairs, ""
    )
