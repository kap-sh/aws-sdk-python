"""Generated from Smithy shape ``com.amazonaws.cloudwatch#ListManagedInsightRules``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.list_managed_insight_rules_output.ListManagedInsightRulesOutput = aws_sdk_cloudwatch.types.list_managed_insight_rules_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.ListManagedInsightRules"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "ListManagedInsightRules"))
