...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.put_metric_stream_output.PutMetricStreamOutput = (
        aws_sdk_cloudwatch.types.put_metric_stream_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_cloudwatch.types.put_metric_stream_input.PutMetricStreamInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudwatch.types.put_metric_stream_input.serialize_query(input, pairs, "")
