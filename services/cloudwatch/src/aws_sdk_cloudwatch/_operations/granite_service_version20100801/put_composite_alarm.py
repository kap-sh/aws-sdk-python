"""Generated from Smithy shape ``com.amazonaws.cloudwatch#PutCompositeAlarm``."""
...
def build_request(
    ...
    input: aws_sdk_cloudwatch.types.put_composite_alarm_input.PutCompositeAlarmInput,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.PutCompositeAlarm"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "PutCompositeAlarm"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.put_composite_alarm_input

    aws_sdk_cloudwatch.types.put_composite_alarm_input.serialize_query(input, pairs, "")
...
async def async_put_composite_alarm(
