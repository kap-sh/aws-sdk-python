"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DisableInsightRules``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.disable_insight_rules_output.DisableInsightRulesOutput = aws_sdk_cloudwatch.types.disable_insight_rules_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.disable_insight_rules_input.DisableInsightRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DisableInsightRules"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DisableInsightRules"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.disable_insight_rules_input

    aws_sdk_cloudwatch.types.disable_insight_rules_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_disable_insight_rules(
