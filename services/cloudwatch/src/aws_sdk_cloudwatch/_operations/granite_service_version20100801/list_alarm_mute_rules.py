"""Generated from Smithy shape ``com.amazonaws.cloudwatch#ListAlarmMuteRules``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.list_alarm_mute_rules_output.ListAlarmMuteRulesOutput = aws_sdk_cloudwatch.types.list_alarm_mute_rules_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.list_alarm_mute_rules_input.ListAlarmMuteRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.ListAlarmMuteRules"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "ListAlarmMuteRules"))
    pairs.append(("Version", "2010-08-01"))
    aws_sdk_cloudwatch.types.list_alarm_mute_rules_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_alarm_mute_rules(
