"""Generated from Smithy shape ``com.amazonaws.cloudwatch#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.UntagResource"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "UntagResource"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.untag_resource_input

    aws_sdk_cloudwatch.types.untag_resource_input.serialize_query(input_, pairs, "")
...
def untag_resource(
    ...
    aws_sdk_cloudwatch.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
