...
def build_request(
    ...
    input: aws_sdk_cloudwatch.types.put_alarm_mute_rule_input.PutAlarmMuteRuleInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudwatch.types.put_alarm_mute_rule_input.serialize_query(input, pairs, "")
