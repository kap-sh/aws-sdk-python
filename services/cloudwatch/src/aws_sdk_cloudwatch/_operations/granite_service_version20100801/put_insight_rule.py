...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.put_insight_rule_output.PutInsightRuleOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.put_insight_rule_input.PutInsightRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.put_insight_rule_input.serialize_query(input_, pairs, "")
