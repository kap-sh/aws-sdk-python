...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.get_dataset_output.GetDatasetOutput = (
        aws_sdk_cloudwatch.types.get_dataset_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.get_dataset_input.GetDatasetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.get_dataset_input.serialize_query(input_, pairs, "")
...
def get_dataset(
    ...
    aws_sdk_cloudwatch.types.get_dataset_output.GetDatasetOutput, zapros.Response
]:
