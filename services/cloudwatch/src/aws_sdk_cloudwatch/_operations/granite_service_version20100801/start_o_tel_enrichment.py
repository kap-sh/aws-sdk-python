"""Generated from Smithy shape ``com.amazonaws.cloudwatch#StartOTelEnrichment``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.start_o_tel_enrichment_input.StartOTelEnrichmentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.StartOTelEnrichment"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "StartOTelEnrichment"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.start_o_tel_enrichment_input

    aws_sdk_cloudwatch.types.start_o_tel_enrichment_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_start_o_tel_enrichment(
