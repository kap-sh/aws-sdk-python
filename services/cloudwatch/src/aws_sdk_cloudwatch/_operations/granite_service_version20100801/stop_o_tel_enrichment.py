...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.stop_o_tel_enrichment_output.StopOTelEnrichmentOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.stop_o_tel_enrichment_input.StopOTelEnrichmentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.stop_o_tel_enrichment_input.serialize_query(
        input_, pairs, ""
    )
