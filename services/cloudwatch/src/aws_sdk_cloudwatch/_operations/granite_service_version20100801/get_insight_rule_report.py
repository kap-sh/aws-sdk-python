...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.get_insight_rule_report_output.GetInsightRuleReportOutput = aws_sdk_cloudwatch.types.get_insight_rule_report_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.get_insight_rule_report_input.GetInsightRuleReportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.get_insight_rule_report_input.serialize_query(
        input_, pairs, ""
    )
