...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.describe_alarm_contributors_output.DescribeAlarmContributorsOutput = aws_sdk_cloudwatch.types.describe_alarm_contributors_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.describe_alarm_contributors_input.DescribeAlarmContributorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
