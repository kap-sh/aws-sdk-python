...
import aws_sdk_cloudwatch.errors.dashboard_not_found_error
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DashboardNotFoundError":
            raise aws_sdk_cloudwatch.errors.dashboard_not_found_error.DashboardNotFoundError.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.get_dashboard_output.GetDashboardOutput = (
        aws_sdk_cloudwatch.types.get_dashboard_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.get_dashboard_input.GetDashboardInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.get_dashboard_input.serialize_query(input_, pairs, "")
...
def get_dashboard(
    ...
    aws_sdk_cloudwatch.types.get_dashboard_output.GetDashboardOutput, zapros.Response
]:
