"""Generated from Smithy shape ``com.amazonaws.cloudwatch#ListMetrics``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.list_metrics_output.ListMetricsOutput = (
        aws_sdk_cloudwatch.types.list_metrics_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.list_metrics_input.ListMetricsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.ListMetrics"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "ListMetrics"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.list_metrics_input

    aws_sdk_cloudwatch.types.list_metrics_input.serialize_query(input_, pairs, "")
...
def list_metrics(
    ...
    aws_sdk_cloudwatch.types.list_metrics_output.ListMetricsOutput, zapros.Response
]:
