"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DescribeInsightRules``."""
...
import aws_sdk_cloudwatch.types.insight_rules
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.describe_insight_rules_output.DescribeInsightRulesOutput = aws_sdk_cloudwatch.types.describe_insight_rules_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.describe_insight_rules_input.DescribeInsightRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DescribeInsightRules"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DescribeInsightRules"))
    pairs.append(("Version", "2010-08-01"))
    aws_sdk_cloudwatch.types.describe_insight_rules_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_insight_rules(
