...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.list_tags_for_resource_output.ListTagsForResourceOutput = aws_sdk_cloudwatch.types.list_tags_for_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.list_tags_for_resource_input.ListTagsForResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.list_tags_for_resource_input.serialize_query(
        input_, pairs, ""
    )
