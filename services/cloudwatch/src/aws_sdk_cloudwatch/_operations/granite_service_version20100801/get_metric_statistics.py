...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.get_metric_statistics_input.GetMetricStatisticsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.get_metric_statistics_input.serialize_query(
        input_, pairs, ""
    )
