"""Generated from Smithy shape ``com.amazonaws.cloudwatch#PutManagedInsightRules``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.put_managed_insight_rules_output.PutManagedInsightRulesOutput = aws_sdk_cloudwatch.types.put_managed_insight_rules_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.put_managed_insight_rules_input.PutManagedInsightRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.PutManagedInsightRules"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "PutManagedInsightRules"))
    pairs.append(("Version", "2010-08-01"))
    aws_sdk_cloudwatch.types.put_managed_insight_rules_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_put_managed_insight_rules(
