"""Generated from Smithy shape ``com.amazonaws.cloudwatch#PutMetricAlarm``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.put_metric_alarm_input.PutMetricAlarmInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.PutMetricAlarm"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "PutMetricAlarm"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.put_metric_alarm_input

    aws_sdk_cloudwatch.types.put_metric_alarm_input.serialize_query(input_, pairs, "")
...
async def async_put_metric_alarm(
