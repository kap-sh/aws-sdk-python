...
def build_request(
    ...
    input: aws_sdk_cloudwatch.types.delete_dashboards_input.DeleteDashboardsInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudwatch.types.delete_dashboards_input.serialize_query(input, pairs, "")
