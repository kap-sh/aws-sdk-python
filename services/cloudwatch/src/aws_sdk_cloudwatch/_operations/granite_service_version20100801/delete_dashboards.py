"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DeleteDashboards``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.delete_dashboards_output.DeleteDashboardsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.delete_dashboards_input.DeleteDashboardsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DeleteDashboards"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DeleteDashboards"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.delete_dashboards_input

    aws_sdk_cloudwatch.types.delete_dashboards_input.serialize_query(input_, pairs, "")
...
async def async_delete_dashboards(
