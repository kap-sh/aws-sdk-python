"""Generated from Smithy shape ``com.amazonaws.cloudwatch#GetAlarmMuteRule``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.get_alarm_mute_rule_output.GetAlarmMuteRuleOutput = (
        aws_sdk_cloudwatch.types.get_alarm_mute_rule_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_cloudwatch.types.get_alarm_mute_rule_input.GetAlarmMuteRuleInput,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.GetAlarmMuteRule"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "GetAlarmMuteRule"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.get_alarm_mute_rule_input

    aws_sdk_cloudwatch.types.get_alarm_mute_rule_input.serialize_query(input, pairs, "")
...
async def async_get_alarm_mute_rule(
