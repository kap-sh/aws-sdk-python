...
def build_request(
    ...
    input: aws_sdk_cloudwatch.types.get_metric_stream_input.GetMetricStreamInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudwatch.types.get_metric_stream_input.serialize_query(input, pairs, "")
