...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.list_dashboards_output.ListDashboardsOutput = (
        aws_sdk_cloudwatch.types.list_dashboards_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.list_dashboards_input.ListDashboardsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.list_dashboards_input.serialize_query(input_, pairs, "")
