"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DeleteMetricStream``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.delete_metric_stream_output.DeleteMetricStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.delete_metric_stream_input.DeleteMetricStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DeleteMetricStream"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DeleteMetricStream"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.delete_metric_stream_input

    aws_sdk_cloudwatch.types.delete_metric_stream_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_metric_stream(
