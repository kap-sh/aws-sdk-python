...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.describe_alarms_output.DescribeAlarmsOutput = (
        aws_sdk_cloudwatch.types.describe_alarms_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_cloudwatch.types.describe_alarms_input.DescribeAlarmsInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudwatch.types.describe_alarms_input.serialize_query(input, pairs, "")
