"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DeleteAlarms``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceNotFound":
            import aws_sdk_cloudwatch.errors.resource_not_found

            raise aws_sdk_cloudwatch.errors.resource_not_found.ResourceNotFound.from_aws_json_1_0(
                data
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.delete_alarms_input.DeleteAlarmsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DeleteAlarms"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DeleteAlarms"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.delete_alarms_input

    aws_sdk_cloudwatch.types.delete_alarms_input.serialize_query(input_, pairs, "")
