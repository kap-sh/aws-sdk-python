"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DeleteAlarmMuteRule``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.delete_alarm_mute_rule_input.DeleteAlarmMuteRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DeleteAlarmMuteRule"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DeleteAlarmMuteRule"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.delete_alarm_mute_rule_input

    aws_sdk_cloudwatch.types.delete_alarm_mute_rule_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_alarm_mute_rule(
