...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.list_metric_streams_output.ListMetricStreamsOutput = (
        aws_sdk_cloudwatch.types.list_metric_streams_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_cloudwatch.types.list_metric_streams_input.ListMetricStreamsInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudwatch.types.list_metric_streams_input.serialize_query(input, pairs, "")
