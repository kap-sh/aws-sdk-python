"""Generated from Smithy shape ``com.amazonaws.cloudwatch#DisableAlarmActions``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.disable_alarm_actions_input.DisableAlarmActionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.DisableAlarmActions"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "DisableAlarmActions"))
    pairs.append(("Version", "2010-08-01"))
    aws_sdk_cloudwatch.types.disable_alarm_actions_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_disable_alarm_actions(
