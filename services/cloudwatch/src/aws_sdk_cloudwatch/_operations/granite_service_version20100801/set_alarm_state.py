"""Generated from Smithy shape ``com.amazonaws.cloudwatch#SetAlarmState``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidFormatFault":
            import aws_sdk_cloudwatch.errors.invalid_format_fault

            raise aws_sdk_cloudwatch.errors.invalid_format_fault.InvalidFormatFault.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.set_alarm_state_input.SetAlarmStateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.SetAlarmState"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "SetAlarmState"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.set_alarm_state_input

    aws_sdk_cloudwatch.types.set_alarm_state_input.serialize_query(input_, pairs, "")
...
async def async_set_alarm_state(
