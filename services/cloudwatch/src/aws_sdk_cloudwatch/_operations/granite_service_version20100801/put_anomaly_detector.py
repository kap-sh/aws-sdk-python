"""Generated from Smithy shape ``com.amazonaws.cloudwatch#PutAnomalyDetector``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.put_anomaly_detector_output.PutAnomalyDetectorOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.put_anomaly_detector_input.PutAnomalyDetectorInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.PutAnomalyDetector"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "PutAnomalyDetector"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.put_anomaly_detector_input

    aws_sdk_cloudwatch.types.put_anomaly_detector_input.serialize_query(
        input_, pairs, ""
    )
