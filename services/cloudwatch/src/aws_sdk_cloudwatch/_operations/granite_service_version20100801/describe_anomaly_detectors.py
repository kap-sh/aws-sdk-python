...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.describe_anomaly_detectors_output.DescribeAnomalyDetectorsOutput = aws_sdk_cloudwatch.types.describe_anomaly_detectors_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.describe_anomaly_detectors_input.DescribeAnomalyDetectorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
