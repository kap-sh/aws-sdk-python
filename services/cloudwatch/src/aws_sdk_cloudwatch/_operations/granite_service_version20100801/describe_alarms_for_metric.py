...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.describe_alarms_for_metric_output.DescribeAlarmsForMetricOutput = aws_sdk_cloudwatch.types.describe_alarms_for_metric_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.describe_alarms_for_metric_input.DescribeAlarmsForMetricInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.describe_alarms_for_metric_input.serialize_query(
        input_, pairs, ""
    )
