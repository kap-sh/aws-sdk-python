"""Generated from Smithy shape ``com.amazonaws.cloudwatch#EnableInsightRules``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            import aws_sdk_cloudwatch.errors.limit_exceeded_exception

            raise aws_sdk_cloudwatch.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.enable_insight_rules_output.EnableInsightRulesOutput = aws_sdk_cloudwatch.types.enable_insight_rules_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.enable_insight_rules_input.EnableInsightRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GraniteServiceVersion20100801.EnableInsightRules"
    pairs: list[tuple[str, str]] = []
    pairs.append(("Action", "EnableInsightRules"))
    pairs.append(("Version", "2010-08-01"))
    import aws_sdk_cloudwatch.types.enable_insight_rules_input

    aws_sdk_cloudwatch.types.enable_insight_rules_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_enable_insight_rules(
