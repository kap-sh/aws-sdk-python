...
def handle_response(
    ...
    out: aws_sdk_cloudwatch.types.start_metric_streams_output.StartMetricStreamsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch.types.start_metric_streams_input.StartMetricStreamsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudwatch.types.start_metric_streams_input.serialize_query(
        input_, pairs, ""
    )
