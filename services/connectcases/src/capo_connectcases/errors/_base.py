...
class ConnectCasesError(Exception):
    """Base class for all ConnectCases service errors."""


class ServiceError(ConnectCasesError):
...
class SerializationError(ConnectCasesError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ConnectCasesError):
...
class WaiterFailedError(ConnectCasesError):
...
class WaiterTimeoutError(ConnectCasesError):
