...
if TYPE_CHECKING:
    import capo_connectcases.types.mutable_tag_key
    import capo_connectcases.types.tag_value_string

MutableTags: TypeAlias = dict[
    "capo_connectcases.types.mutable_tag_key.MutableTagKey",
    "capo_connectcases.types.tag_value_string.TagValueString",
]
