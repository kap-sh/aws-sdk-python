...
class ListLayoutsResponse(TypedDict):
    layouts: "aws_sdk_connectcases.types.layout_summary_list.LayoutSummaryList"
...
def serialize_json(value: ListLayoutsResponse) -> dict:
    ...
    out["layouts"] = aws_sdk_connectcases.types.layout_summary_list.serialize_json(
        value["layouts"]
    )
...
def deserialize_json(data: dict) -> ListLayoutsResponse:
    ...
    if "layouts" in data:
        ...
        out["layouts"] = (
            aws_sdk_connectcases.types.layout_summary_list.deserialize_json(
                data["layouts"]
            )
        )
    else:
