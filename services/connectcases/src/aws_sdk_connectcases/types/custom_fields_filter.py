...
def serialize_json(value: CustomFieldsFilter) -> dict:
    if "field" in value:
        ...
        return {
            "field": aws_sdk_connectcases.types.field_filter.serialize_json(
                value["field"]
            )
        }
    elif "not" in value:
        ...
        return {
            "not": aws_sdk_connectcases.types.custom_fields_filter.serialize_json(
                value["not"]
            )
        }
        ...
        return {
            "andAll": aws_sdk_connectcases.types.custom_fields_filter_list.serialize_json(
                value["andAll"]
            )
        }
    elif "orAll" in value:
        ...
        return {
            "orAll": aws_sdk_connectcases.types.custom_fields_filter_list.serialize_json(
                value["orAll"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> CustomFieldsFilter:
    if "field" in data:
        ...
        return {
            "field": aws_sdk_connectcases.types.field_filter.deserialize_json(
                data["field"]
            )
        }
    elif "not" in data:
        ...
        return {
            "not": aws_sdk_connectcases.types.custom_fields_filter.deserialize_json(
                data["not"]
            )
        }
    elif "andAll" in data:
        ...
        return {
            "andAll": aws_sdk_connectcases.types.custom_fields_filter_list.deserialize_json(
                data["andAll"]
            )
        }
    elif "orAll" in data:
        ...
        return {
            "orAll": aws_sdk_connectcases.types.custom_fields_filter_list.deserialize_json(
                data["orAll"]
            )
        }
    else:
