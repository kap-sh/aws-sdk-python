...
CaseRuleSummaryList: TypeAlias = list[
    "aws_sdk_connectcases.types.case_rule_summary.CaseRuleSummary"
]
...
def serialize_json(value: CaseRuleSummaryList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_connectcases.types.case_rule_summary.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> CaseRuleSummaryList:
    ...
    for item in data:
        out.append(aws_sdk_connectcases.types.case_rule_summary.deserialize_json(item))
    return out
