...
def serialize_json(value: CaseFilter) -> dict:
    if "field" in value:
        ...
        return {
            "not": aws_sdk_connectcases.types.case_filter.serialize_json(value["not"])
        }
    elif "tag" in value:
        import aws_sdk_connectcases.types.tag_filter

        return {
            "tag": aws_sdk_connectcases.types.tag_filter.serialize_json(value["tag"])
        }
    elif "andAll" in value:
        import aws_sdk_connectcases.types.case_filter_list

        return {
            "andAll": aws_sdk_connectcases.types.case_filter_list.serialize_json(
                value["andAll"]
            )
        }
    elif "orAll" in value:
        ...
        return {
            "orAll": aws_sdk_connectcases.types.case_filter_list.serialize_json(
                value["orAll"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> CaseFilter:
    if "field" in data:
        ...
        return {
            "not": aws_sdk_connectcases.types.case_filter.deserialize_json(data["not"])
        }
    elif "tag" in data:
        import aws_sdk_connectcases.types.tag_filter

        return {
            "tag": aws_sdk_connectcases.types.tag_filter.deserialize_json(data["tag"])
        }
    elif "andAll" in data:
        import aws_sdk_connectcases.types.case_filter_list

        return {
            "andAll": aws_sdk_connectcases.types.case_filter_list.deserialize_json(
                data["andAll"]
            )
        }
    elif "orAll" in data:
        ...
        return {
            "orAll": aws_sdk_connectcases.types.case_filter_list.deserialize_json(
                data["orAll"]
            )
        }
    else:
