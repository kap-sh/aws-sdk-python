...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.list_templates_response.ListTemplatesResponse = (
        aws_sdk_connectcases.types.list_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.list_templates_request.ListTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
