...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.put_case_event_configuration_response.PutCaseEventConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.put_case_event_configuration_request.PutCaseEventConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.put_case_event_configuration_request.serialize_json(
            input_
        )
    ).encode()
