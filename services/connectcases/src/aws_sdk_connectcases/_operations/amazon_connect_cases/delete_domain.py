...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.delete_domain_response.DeleteDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.delete_domain_request.DeleteDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
