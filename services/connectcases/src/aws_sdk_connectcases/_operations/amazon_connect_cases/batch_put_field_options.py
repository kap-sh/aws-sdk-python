...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.batch_put_field_options_request.BatchPutFieldOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.batch_put_field_options_request.serialize_json(
            input_
        )
    ).encode()
