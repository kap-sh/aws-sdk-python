...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.update_case_response.UpdateCaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.update_case_request.UpdateCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.update_case_request.serialize_json(input_)
    ).encode()
...
def update_case(
    ...
    aws_sdk_connectcases.types.update_case_response.UpdateCaseResponse, zapros.Response
]:
