...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.batch_get_case_rule_response.BatchGetCaseRuleResponse = aws_sdk_connectcases.types.batch_get_case_rule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connectcases.types.batch_get_case_rule_request.BatchGetCaseRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.batch_get_case_rule_request.serialize_json(input)
    ).encode()
