...
def build_request(
    ...
    input: aws_sdk_connectcases.types.search_related_items_request.SearchRelatedItemsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.search_related_items_request.serialize_json(input)
    ).encode()
