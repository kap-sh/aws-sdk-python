...
import aws_sdk_connectcases.types.search_related_items_request
import aws_sdk_connectcases.types.search_related_items_response
import aws_sdk_connectcases.types.search_related_items_response_item_list
...
def handle_response(
    ...
    aws_sdk_connectcases.types.search_related_items_response.SearchRelatedItemsResponse
):
    out: aws_sdk_connectcases.types.search_related_items_response.SearchRelatedItemsResponse = aws_sdk_connectcases.types.search_related_items_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.search_related_items_request.SearchRelatedItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.search_related_items_request.serialize_json(input_)
    ).encode()
