"""Generated from Smithy shape ``com.amazonaws.connectcases#UpdateTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.update_template_response.UpdateTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.update_template_request.UpdateTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.update_template_request.serialize_json(input_)
    ).encode()
