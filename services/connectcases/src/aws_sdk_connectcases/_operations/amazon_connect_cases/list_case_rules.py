...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.list_case_rules_response.ListCaseRulesResponse = (
        aws_sdk_connectcases.types.list_case_rules_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.list_case_rules_request.ListCaseRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
