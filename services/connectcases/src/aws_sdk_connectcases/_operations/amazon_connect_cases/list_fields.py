...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.list_fields_response.ListFieldsResponse = (
        aws_sdk_connectcases.types.list_fields_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.list_fields_request.ListFieldsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_fields(
    ...
    aws_sdk_connectcases.types.list_fields_response.ListFieldsResponse, zapros.Response
]:
