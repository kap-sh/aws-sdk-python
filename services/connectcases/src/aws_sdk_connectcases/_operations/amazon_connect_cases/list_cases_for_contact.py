...
def build_request(
    ...
    input: aws_sdk_connectcases.types.list_cases_for_contact_request.ListCasesForContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.list_cases_for_contact_request.serialize_json(input)
    ).encode()
