...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.list_cases_for_contact_response.ListCasesForContactResponse = aws_sdk_connectcases.types.list_cases_for_contact_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.list_cases_for_contact_request.ListCasesForContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.list_cases_for_contact_request.serialize_json(input_)
    ).encode()
