...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.create_case_response.CreateCaseResponse = (
        aws_sdk_connectcases.types.create_case_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.create_case_request.CreateCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.create_case_request.serialize_json(input_)
    ).encode()
...
def create_case(
    ...
    aws_sdk_connectcases.types.create_case_response.CreateCaseResponse, zapros.Response
]:
