"""Generated from Smithy shape ``com.amazonaws.connectcases#DeleteTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.delete_template_response.DeleteTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.delete_template_request.DeleteTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
