...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.list_domains_response.ListDomainsResponse = (
        aws_sdk_connectcases.types.list_domains_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.list_domains_request.ListDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
