...
if TYPE_CHECKING:
    import aws_sdk_connectcases.types.update_related_item_request
    import aws_sdk_connectcases.types.update_related_item_response
...
) -> aws_sdk_connectcases.types.update_related_item_response.UpdateRelatedItemResponse:
    import aws_sdk_connectcases.types.update_related_item_response

    out: aws_sdk_connectcases.types.update_related_item_response.UpdateRelatedItemResponse = aws_sdk_connectcases.types.update_related_item_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.update_related_item_request.UpdateRelatedItemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.update_related_item_request.serialize_json(input_)
    ).encode()
