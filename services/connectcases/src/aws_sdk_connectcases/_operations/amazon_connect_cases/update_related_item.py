...
def build_request(
    ...
    input: aws_sdk_connectcases.types.update_related_item_request.UpdateRelatedItemRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.update_related_item_request.serialize_json(input)
    ).encode()
