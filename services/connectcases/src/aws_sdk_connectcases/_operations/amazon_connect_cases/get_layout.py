...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.get_layout_response.GetLayoutResponse = (
        aws_sdk_connectcases.types.get_layout_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.get_layout_request.GetLayoutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_layout(
    ...
    aws_sdk_connectcases.types.get_layout_response.GetLayoutResponse, zapros.Response
]:
