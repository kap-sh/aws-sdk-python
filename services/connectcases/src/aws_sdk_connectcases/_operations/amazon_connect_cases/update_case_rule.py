...
def build_request(
    ...
    input: aws_sdk_connectcases.types.update_case_rule_request.UpdateCaseRuleRequest,
) -> zapros.Request:
    ...
    url = url.replace("{caseRuleId}", quote(str(input["case_rule_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connectcases.types.update_case_rule_request

    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.update_case_rule_request.serialize_json(input)
    ).encode()
