"""Generated from Smithy shape ``com.amazonaws.connectcases#UpdateCaseRule``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_connectcases.errors.conflict_exception

            raise aws_sdk_connectcases.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.update_case_rule_response.UpdateCaseRuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.update_case_rule_request.UpdateCaseRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{domainId}/case-rules/{caseRuleId}"
    url = url.replace("{domainId}", quote(str(input_["domain_id"]), safe=""))
    url = url.replace("{caseRuleId}", quote(str(input_["case_rule_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connectcases.types.update_case_rule_request

    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.update_case_rule_request.serialize_json(input_)
    ).encode()
...
async def async_update_case_rule(
