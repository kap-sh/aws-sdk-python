...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.create_field_response.CreateFieldResponse = (
        aws_sdk_connectcases.types.create_field_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.create_field_request.CreateFieldRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.create_field_request.serialize_json(input_)
    ).encode()
