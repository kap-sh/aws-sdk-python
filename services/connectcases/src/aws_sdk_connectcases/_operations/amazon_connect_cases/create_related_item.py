...
def build_request(
    ...
    input: aws_sdk_connectcases.types.create_related_item_request.CreateRelatedItemRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.create_related_item_request.serialize_json(input)
    ).encode()
