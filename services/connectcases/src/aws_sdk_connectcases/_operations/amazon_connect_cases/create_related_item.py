...
if TYPE_CHECKING:
    import aws_sdk_connectcases.types.create_related_item_request
    import aws_sdk_connectcases.types.create_related_item_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_connectcases.errors.service_quota_exceeded_exception

            raise aws_sdk_connectcases.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
) -> aws_sdk_connectcases.types.create_related_item_response.CreateRelatedItemResponse:
    import aws_sdk_connectcases.types.create_related_item_response

    out: aws_sdk_connectcases.types.create_related_item_response.CreateRelatedItemResponse = aws_sdk_connectcases.types.create_related_item_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.create_related_item_request.CreateRelatedItemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.create_related_item_request.serialize_json(input_)
    ).encode()
