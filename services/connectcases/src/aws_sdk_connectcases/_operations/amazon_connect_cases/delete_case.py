"""Generated from Smithy shape ``com.amazonaws.connectcases#DeleteCase``."""
...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.delete_case_response.DeleteCaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.delete_case_request.DeleteCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_case(
    ...
    aws_sdk_connectcases.types.delete_case_response.DeleteCaseResponse, zapros.Response
]:
