"""Generated from Smithy shape ``com.amazonaws.connectcases#DeleteCaseRule``."""
...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.delete_case_rule_response.DeleteCaseRuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.delete_case_rule_request.DeleteCaseRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_case_rule(
