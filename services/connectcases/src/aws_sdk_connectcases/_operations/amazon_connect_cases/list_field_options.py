...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.list_field_options_response.ListFieldOptionsResponse = aws_sdk_connectcases.types.list_field_options_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.list_field_options_request.ListFieldOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
