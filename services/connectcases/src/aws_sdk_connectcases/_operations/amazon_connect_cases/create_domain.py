...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.create_domain_response.CreateDomainResponse = (
        aws_sdk_connectcases.types.create_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.create_domain_request.CreateDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.create_domain_request.serialize_json(input_)
    ).encode()
