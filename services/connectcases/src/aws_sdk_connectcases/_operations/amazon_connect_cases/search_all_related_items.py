...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.search_all_related_items_response.SearchAllRelatedItemsResponse = aws_sdk_connectcases.types.search_all_related_items_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.search_all_related_items_request.SearchAllRelatedItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.search_all_related_items_request.serialize_json(
            input_
        )
    ).encode()
