"""Generated from Smithy shape ``com.amazonaws.connectcases#GetCaseAuditEvents``."""
...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.get_case_audit_events_response.GetCaseAuditEventsResponse = aws_sdk_connectcases.types.get_case_audit_events_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.get_case_audit_events_request.GetCaseAuditEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{domainId}/cases/{caseId}/audit-history"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.get_case_audit_events_request.serialize_json(input_)
    ).encode()
...
async def async_get_case_audit_events(
