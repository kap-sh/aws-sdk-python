...
def build_request(
    ...
    input: aws_sdk_connectcases.types.get_case_audit_events_request.GetCaseAuditEventsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.get_case_audit_events_request.serialize_json(input)
    ).encode()
