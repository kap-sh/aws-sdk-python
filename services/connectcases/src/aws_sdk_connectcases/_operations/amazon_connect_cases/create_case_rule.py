...
def build_request(
    ...
    input: aws_sdk_connectcases.types.create_case_rule_request.CreateCaseRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.create_case_rule_request.serialize_json(input)
    ).encode()
