...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.create_case_rule_response.CreateCaseRuleResponse = (
        aws_sdk_connectcases.types.create_case_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.create_case_rule_request.CreateCaseRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.create_case_rule_request.serialize_json(input_)
    ).encode()
