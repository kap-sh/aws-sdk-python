"""Generated from Smithy shape ``com.amazonaws.connectcases#ListLayouts``."""
...
import aws_sdk_connectcases.types.layout_summary_list
...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.list_layouts_response.ListLayoutsResponse = (
        aws_sdk_connectcases.types.list_layouts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.list_layouts_request.ListLayoutsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{domainId}/layouts-list"
