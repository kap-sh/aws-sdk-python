...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.update_field_response.UpdateFieldResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.update_field_request.UpdateFieldRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.update_field_request.serialize_json(input_)
    ).encode()
