...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.get_case_event_configuration_response.GetCaseEventConfigurationResponse = aws_sdk_connectcases.types.get_case_event_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.get_case_event_configuration_request.GetCaseEventConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
