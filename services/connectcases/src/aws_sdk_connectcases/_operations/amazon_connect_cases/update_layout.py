...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.update_layout_response.UpdateLayoutResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.update_layout_request.UpdateLayoutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.update_layout_request.serialize_json(input_)
    ).encode()
