"""Generated from Smithy shape ``com.amazonaws.connectcases#DeleteRelatedItem``."""
...
if TYPE_CHECKING:
    import aws_sdk_connectcases.types.delete_related_item_request
    import aws_sdk_connectcases.types.delete_related_item_response
...
) -> aws_sdk_connectcases.types.delete_related_item_response.DeleteRelatedItemResponse:
    out: aws_sdk_connectcases.types.delete_related_item_response.DeleteRelatedItemResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.delete_related_item_request.DeleteRelatedItemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_related_item(
