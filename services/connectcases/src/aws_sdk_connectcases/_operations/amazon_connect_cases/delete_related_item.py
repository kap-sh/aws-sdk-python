...
def build_request(
    ...
    input: aws_sdk_connectcases.types.delete_related_item_request.DeleteRelatedItemRequest,
) -> zapros.Request:
    ...
    url = url.replace("{relatedItemId}", quote(str(input["related_item_id"]), safe=""))
    params: dict[str, str] = {}
