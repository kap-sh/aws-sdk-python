...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.batch_get_field_response.BatchGetFieldResponse = (
        aws_sdk_connectcases.types.batch_get_field_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.batch_get_field_request.BatchGetFieldRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.batch_get_field_request.serialize_json(input_)
    ).encode()
