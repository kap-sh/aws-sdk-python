...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.create_layout_response.CreateLayoutResponse = (
        aws_sdk_connectcases.types.create_layout_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.create_layout_request.CreateLayoutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcases.types.create_layout_request.serialize_json(input_)
    ).encode()
