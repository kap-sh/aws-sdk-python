...
def handle_response(
    ...
    out: aws_sdk_connectcases.types.delete_field_response.DeleteFieldResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connectcases.types.delete_field_request.DeleteFieldRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
