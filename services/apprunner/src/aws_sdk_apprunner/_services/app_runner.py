...
from aws_sdk_apprunner._services._aws_config import aws_config
...
class AppRunnerClient:
    ...
    def associate_custom_domain(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.associate_custom_domain_request.AssociateCustomDomainRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.associate_custom_domain_response.AssociateCustomDomainResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.associate_custom_domain.associate_custom_domain(
    ...
    def create_auto_scaling_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.create_auto_scaling_configuration_request.CreateAutoScalingConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.create_auto_scaling_configuration_response.CreateAutoScalingConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.create_auto_scaling_configuration.create_auto_scaling_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.create_connection_request.CreateConnectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.create_connection_response.CreateConnectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.create_connection.create_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_observability_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.create_observability_configuration_request.CreateObservabilityConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.create_observability_configuration_response.CreateObservabilityConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.create_observability_configuration.create_observability_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_service(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.create_service_request.CreateServiceRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.create_service_response.CreateServiceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.create_service.create_service(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_vpc_connector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.create_vpc_connector_request.CreateVpcConnectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.create_vpc_connector_response.CreateVpcConnectorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.create_vpc_connector.create_vpc_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_vpc_ingress_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.create_vpc_ingress_connection_request.CreateVpcIngressConnectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.create_vpc_ingress_connection_response.CreateVpcIngressConnectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.create_vpc_ingress_connection.create_vpc_ingress_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_auto_scaling_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.delete_auto_scaling_configuration_request.DeleteAutoScalingConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.delete_auto_scaling_configuration_response.DeleteAutoScalingConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.delete_auto_scaling_configuration.delete_auto_scaling_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.delete_connection_request.DeleteConnectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.delete_connection_response.DeleteConnectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.delete_connection.delete_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_observability_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.delete_observability_configuration_request.DeleteObservabilityConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.delete_observability_configuration_response.DeleteObservabilityConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.delete_observability_configuration.delete_observability_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_service(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.delete_service_request.DeleteServiceRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.delete_service_response.DeleteServiceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.delete_service.delete_service(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_vpc_connector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.delete_vpc_connector_request.DeleteVpcConnectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.delete_vpc_connector_response.DeleteVpcConnectorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.delete_vpc_connector.delete_vpc_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_vpc_ingress_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.delete_vpc_ingress_connection_request.DeleteVpcIngressConnectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.delete_vpc_ingress_connection_response.DeleteVpcIngressConnectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.delete_vpc_ingress_connection.delete_vpc_ingress_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_auto_scaling_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.describe_auto_scaling_configuration_request.DescribeAutoScalingConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.describe_auto_scaling_configuration_response.DescribeAutoScalingConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.describe_auto_scaling_configuration.describe_auto_scaling_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_custom_domains(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.describe_custom_domains_request.DescribeCustomDomainsRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.describe_custom_domains_response.DescribeCustomDomainsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.describe_custom_domains.describe_custom_domains(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_observability_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.describe_observability_configuration_request.DescribeObservabilityConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.describe_observability_configuration_response.DescribeObservabilityConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.describe_observability_configuration.describe_observability_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_service(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.describe_service_request.DescribeServiceRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.describe_service_response.DescribeServiceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.describe_service.describe_service(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_vpc_connector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.describe_vpc_connector_request.DescribeVpcConnectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.describe_vpc_connector_response.DescribeVpcConnectorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.describe_vpc_connector.describe_vpc_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_vpc_ingress_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.describe_vpc_ingress_connection_request.DescribeVpcIngressConnectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.describe_vpc_ingress_connection_response.DescribeVpcIngressConnectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.describe_vpc_ingress_connection.describe_vpc_ingress_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_custom_domain(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.disassociate_custom_domain_request.DisassociateCustomDomainRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.disassociate_custom_domain_response.DisassociateCustomDomainResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.disassociate_custom_domain.disassociate_custom_domain(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_auto_scaling_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.list_auto_scaling_configurations_request.ListAutoScalingConfigurationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.list_auto_scaling_configurations_response.ListAutoScalingConfigurationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.list_auto_scaling_configurations.list_auto_scaling_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_connections(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.list_connections_request.ListConnectionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.list_connections_response.ListConnectionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.list_connections.list_connections(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_observability_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.list_observability_configurations_request.ListObservabilityConfigurationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.list_observability_configurations_response.ListObservabilityConfigurationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.list_observability_configurations.list_observability_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_operations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.list_operations_request.ListOperationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.list_operations_response.ListOperationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.list_operations.list_operations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_services(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.list_services_request.ListServicesRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.list_services_response.ListServicesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.list_services.list_services(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_services_for_auto_scaling_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.list_services_for_auto_scaling_configuration_request.ListServicesForAutoScalingConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.list_services_for_auto_scaling_configuration_response.ListServicesForAutoScalingConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.list_services_for_auto_scaling_configuration.list_services_for_auto_scaling_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_vpc_connectors(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.list_vpc_connectors_request.ListVpcConnectorsRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.list_vpc_connectors_response.ListVpcConnectorsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.list_vpc_connectors.list_vpc_connectors(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_vpc_ingress_connections(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.list_vpc_ingress_connections_request.ListVpcIngressConnectionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.list_vpc_ingress_connections_response.ListVpcIngressConnectionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.list_vpc_ingress_connections.list_vpc_ingress_connections(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def pause_service(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.pause_service_request.PauseServiceRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.pause_service_response.PauseServiceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.pause_service.pause_service(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def resume_service(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.resume_service_request.ResumeServiceRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.resume_service_response.ResumeServiceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.resume_service.resume_service(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_deployment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.start_deployment_request.StartDeploymentRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.start_deployment_response.StartDeploymentResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.start_deployment.start_deployment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_default_auto_scaling_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.update_default_auto_scaling_configuration_request.UpdateDefaultAutoScalingConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.update_default_auto_scaling_configuration_response.UpdateDefaultAutoScalingConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.update_default_auto_scaling_configuration.update_default_auto_scaling_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_service(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.update_service_request.UpdateServiceRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.update_service_response.UpdateServiceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.update_service.update_service(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_vpc_ingress_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_apprunner.types.update_vpc_ingress_connection_request.UpdateVpcIngressConnectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_apprunner.types.update_vpc_ingress_connection_response.UpdateVpcIngressConnectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_apprunner._operations.app_runner.update_vpc_ingress_connection.update_vpc_ingress_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
