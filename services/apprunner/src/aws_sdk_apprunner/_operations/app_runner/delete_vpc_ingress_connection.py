...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.delete_vpc_ingress_connection_response.DeleteVpcIngressConnectionResponse = aws_sdk_apprunner.types.delete_vpc_ingress_connection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.delete_vpc_ingress_connection_request.DeleteVpcIngressConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.delete_vpc_ingress_connection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
