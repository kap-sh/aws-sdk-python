"""Generated from Smithy shape ``com.amazonaws.apprunner#DeleteService``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.delete_service_response.DeleteServiceResponse = (
        aws_sdk_apprunner.types.delete_service_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.delete_service_request.DeleteServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.DeleteService"
    import aws_sdk_apprunner.types.delete_service_request

    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.delete_service_request.serialize_aws_json_1_0(input_)
    ).encode()
