"""Generated from Smithy shape ``com.amazonaws.apprunner#ListServices``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.list_services_response.ListServicesResponse = (
        aws_sdk_apprunner.types.list_services_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.list_services_request.ListServicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.ListServices"
    import aws_sdk_apprunner.types.list_services_request

    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.list_services_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_services(
    ...
    aws_sdk_apprunner.types.list_services_response.ListServicesResponse, zapros.Response
]:
