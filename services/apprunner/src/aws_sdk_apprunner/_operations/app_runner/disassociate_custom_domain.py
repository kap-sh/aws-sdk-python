...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.disassociate_custom_domain_response.DisassociateCustomDomainResponse = aws_sdk_apprunner.types.disassociate_custom_domain_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.disassociate_custom_domain_request.DisassociateCustomDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.disassociate_custom_domain_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
