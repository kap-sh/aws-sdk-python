...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.delete_auto_scaling_configuration_response.DeleteAutoScalingConfigurationResponse = aws_sdk_apprunner.types.delete_auto_scaling_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.delete_auto_scaling_configuration_request.DeleteAutoScalingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.delete_auto_scaling_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
