...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.list_services_for_auto_scaling_configuration_response.ListServicesForAutoScalingConfigurationResponse = aws_sdk_apprunner.types.list_services_for_auto_scaling_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.list_services_for_auto_scaling_configuration_request.ListServicesForAutoScalingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.list_services_for_auto_scaling_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
