...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.update_default_auto_scaling_configuration_response.UpdateDefaultAutoScalingConfigurationResponse = aws_sdk_apprunner.types.update_default_auto_scaling_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.update_default_auto_scaling_configuration_request.UpdateDefaultAutoScalingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.update_default_auto_scaling_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
