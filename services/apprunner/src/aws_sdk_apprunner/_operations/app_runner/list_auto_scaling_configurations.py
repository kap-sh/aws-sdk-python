...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.list_auto_scaling_configurations_response.ListAutoScalingConfigurationsResponse = aws_sdk_apprunner.types.list_auto_scaling_configurations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.list_auto_scaling_configurations_request.ListAutoScalingConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.list_auto_scaling_configurations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
