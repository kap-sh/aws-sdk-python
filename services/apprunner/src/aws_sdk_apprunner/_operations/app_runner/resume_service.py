...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.resume_service_response.ResumeServiceResponse = (
        aws_sdk_apprunner.types.resume_service_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.resume_service_request.ResumeServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.resume_service_request.serialize_aws_json_1_0(input_)
    ).encode()
