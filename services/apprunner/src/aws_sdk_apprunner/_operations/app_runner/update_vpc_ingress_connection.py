...
import aws_sdk_apprunner.errors.invalid_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidStateException":
            raise aws_sdk_apprunner.errors.invalid_state_exception.InvalidStateException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.update_vpc_ingress_connection_response.UpdateVpcIngressConnectionResponse = aws_sdk_apprunner.types.update_vpc_ingress_connection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.update_vpc_ingress_connection_request.UpdateVpcIngressConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.update_vpc_ingress_connection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
