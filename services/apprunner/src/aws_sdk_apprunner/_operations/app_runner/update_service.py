"""Generated from Smithy shape ``com.amazonaws.apprunner#UpdateService``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.update_service_response.UpdateServiceResponse = (
        aws_sdk_apprunner.types.update_service_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.update_service_request.UpdateServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.UpdateService"
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.update_service_request.serialize_aws_json_1_0(input_)
    ).encode()
