...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.list_observability_configurations_response.ListObservabilityConfigurationsResponse = aws_sdk_apprunner.types.list_observability_configurations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.list_observability_configurations_request.ListObservabilityConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.list_observability_configurations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
