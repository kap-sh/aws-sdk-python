...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.describe_custom_domains_response.DescribeCustomDomainsResponse = aws_sdk_apprunner.types.describe_custom_domains_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.describe_custom_domains_request.DescribeCustomDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.describe_custom_domains_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
