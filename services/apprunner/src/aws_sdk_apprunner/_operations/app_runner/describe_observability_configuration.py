"""Generated from Smithy shape ``com.amazonaws.apprunner#DescribeObservabilityConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.describe_observability_configuration_response.DescribeObservabilityConfigurationResponse = aws_sdk_apprunner.types.describe_observability_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.describe_observability_configuration_request.DescribeObservabilityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.DescribeObservabilityConfiguration"
    import aws_sdk_apprunner.types.describe_observability_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.describe_observability_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_observability_configuration(
