...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.pause_service_response.PauseServiceResponse = (
        aws_sdk_apprunner.types.pause_service_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.pause_service_request.PauseServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.pause_service_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def pause_service(
    ...
    aws_sdk_apprunner.types.pause_service_response.PauseServiceResponse, zapros.Response
]:
