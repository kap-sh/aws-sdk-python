...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.start_deployment_response.StartDeploymentResponse = (
        aws_sdk_apprunner.types.start_deployment_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.start_deployment_request.StartDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.start_deployment_request.serialize_aws_json_1_0(input_)
    ).encode()
