...
def build_request(
    ...
    input: aws_sdk_apprunner.types.start_deployment_request.StartDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.start_deployment_request.serialize_aws_json_1_0(input)
    ).encode()
