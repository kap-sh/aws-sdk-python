...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.create_vpc_ingress_connection_response.CreateVpcIngressConnectionResponse = aws_sdk_apprunner.types.create_vpc_ingress_connection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.create_vpc_ingress_connection_request.CreateVpcIngressConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.create_vpc_ingress_connection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
