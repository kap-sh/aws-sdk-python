"""Generated from Smithy shape ``com.amazonaws.apprunner#CreateConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.create_connection_response.CreateConnectionResponse = (
        aws_sdk_apprunner.types.create_connection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.create_connection_request.CreateConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.CreateConnection"
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.create_connection_request.serialize_aws_json_1_0(input_)
    ).encode()
