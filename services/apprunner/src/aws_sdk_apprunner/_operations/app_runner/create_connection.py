...
def build_request(
    ...
    input: aws_sdk_apprunner.types.create_connection_request.CreateConnectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.create_connection_request.serialize_aws_json_1_0(input)
    ).encode()
