...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_apprunner.errors.service_quota_exceeded_exception

            raise aws_sdk_apprunner.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.create_auto_scaling_configuration_response.CreateAutoScalingConfigurationResponse = aws_sdk_apprunner.types.create_auto_scaling_configuration_response.deserialize_aws_json_1_0(
...
def get_signer(
...
) -> aws_sdk_apprunner._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_apprunner._auth._sigv4.build_sigv4_auth_scheme(
                "apprunner", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_apprunner._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.create_auto_scaling_configuration_request.CreateAutoScalingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.create_auto_scaling_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
