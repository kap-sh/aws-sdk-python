"""Generated from Smithy shape ``com.amazonaws.apprunner#ListVpcIngressConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.list_vpc_ingress_connections_response.ListVpcIngressConnectionsResponse = aws_sdk_apprunner.types.list_vpc_ingress_connections_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.list_vpc_ingress_connections_request.ListVpcIngressConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.ListVpcIngressConnections"
    import aws_sdk_apprunner.types.list_vpc_ingress_connections_request

    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.list_vpc_ingress_connections_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_vpc_ingress_connections(
