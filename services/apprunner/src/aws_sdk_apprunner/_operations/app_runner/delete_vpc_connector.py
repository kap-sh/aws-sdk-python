...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.delete_vpc_connector_response.DeleteVpcConnectorResponse = aws_sdk_apprunner.types.delete_vpc_connector_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.delete_vpc_connector_request.DeleteVpcConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
