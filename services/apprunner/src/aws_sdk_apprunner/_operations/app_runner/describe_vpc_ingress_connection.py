...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.describe_vpc_ingress_connection_request.DescribeVpcIngressConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.describe_vpc_ingress_connection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
