"""Generated from Smithy shape ``com.amazonaws.apprunner#ListVpcConnectors``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.list_vpc_connectors_response.ListVpcConnectorsResponse = aws_sdk_apprunner.types.list_vpc_connectors_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.list_vpc_connectors_request.ListVpcConnectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.ListVpcConnectors"
    import aws_sdk_apprunner.types.list_vpc_connectors_request

    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.list_vpc_connectors_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_vpc_connectors(
