...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.describe_vpc_connector_response.DescribeVpcConnectorResponse = aws_sdk_apprunner.types.describe_vpc_connector_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.describe_vpc_connector_request.DescribeVpcConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.describe_vpc_connector_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
