...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.describe_service_response.DescribeServiceResponse = (
        aws_sdk_apprunner.types.describe_service_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_apprunner.types.describe_service_request.DescribeServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.describe_service_request.serialize_aws_json_1_0(input)
    ).encode()
