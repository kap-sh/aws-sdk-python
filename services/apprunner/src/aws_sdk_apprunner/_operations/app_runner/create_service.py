...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.create_service_response.CreateServiceResponse = (
        aws_sdk_apprunner.types.create_service_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.create_service_request.CreateServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.create_service_request.serialize_aws_json_1_0(input_)
    ).encode()
