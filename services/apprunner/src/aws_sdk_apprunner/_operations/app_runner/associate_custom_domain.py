"""Generated from Smithy shape ``com.amazonaws.apprunner#AssociateCustomDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.associate_custom_domain_response.AssociateCustomDomainResponse = aws_sdk_apprunner.types.associate_custom_domain_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.associate_custom_domain_request.AssociateCustomDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.AssociateCustomDomain"
    import aws_sdk_apprunner.types.associate_custom_domain_request

    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.associate_custom_domain_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_associate_custom_domain(
