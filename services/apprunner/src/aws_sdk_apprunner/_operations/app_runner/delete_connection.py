"""Generated from Smithy shape ``com.amazonaws.apprunner#DeleteConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.delete_connection_response.DeleteConnectionResponse = (
        aws_sdk_apprunner.types.delete_connection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.delete_connection_request.DeleteConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.DeleteConnection"
    import aws_sdk_apprunner.types.delete_connection_request

    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.delete_connection_request.serialize_aws_json_1_0(input_)
    ).encode()
