"""Generated from Smithy shape ``com.amazonaws.apprunner#DescribeAutoScalingConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.describe_auto_scaling_configuration_response.DescribeAutoScalingConfigurationResponse = aws_sdk_apprunner.types.describe_auto_scaling_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.describe_auto_scaling_configuration_request.DescribeAutoScalingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.DescribeAutoScalingConfiguration"
    import aws_sdk_apprunner.types.describe_auto_scaling_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.describe_auto_scaling_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_auto_scaling_configuration(
