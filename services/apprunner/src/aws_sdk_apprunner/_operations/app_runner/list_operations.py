...
import aws_sdk_apprunner.types.operation_summary_list
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.list_operations_response.ListOperationsResponse = (
        aws_sdk_apprunner.types.list_operations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.list_operations_request.ListOperationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.list_operations_request.serialize_aws_json_1_0(input_)
    ).encode()
