"""Generated from Smithy shape ``com.amazonaws.apprunner#CreateVpcConnector``."""
...
def handle_response(
    ...
    out: aws_sdk_apprunner.types.create_vpc_connector_response.CreateVpcConnectorResponse = aws_sdk_apprunner.types.create_vpc_connector_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_apprunner.types.create_vpc_connector_request.CreateVpcConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AppRunner.CreateVpcConnector"
    import aws_sdk_apprunner.types.create_vpc_connector_request

    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.create_vpc_connector_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_vpc_connector(
