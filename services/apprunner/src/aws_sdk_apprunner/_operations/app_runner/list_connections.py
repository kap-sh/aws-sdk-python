...
def build_request(
    ...
    input: aws_sdk_apprunner.types.list_connections_request.ListConnectionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apprunner.types.list_connections_request.serialize_aws_json_1_0(input)
    ).encode()
