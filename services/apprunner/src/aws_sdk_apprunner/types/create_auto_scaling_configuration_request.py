...
class CreateAutoScalingConfigurationRequest(TypedDict, closed=True):
    ...
    min_size: NotRequired["aws_sdk_apprunner.types.as_config_min_size.ASConfigMinSize"]
    ...
    max_size: NotRequired["aws_sdk_apprunner.types.as_config_max_size.ASConfigMaxSize"]
