...
if TYPE_CHECKING:
    import aws_sdk_apprunner.types.code_configuration_values
    import aws_sdk_apprunner.types.configuration_source


class CodeConfiguration(TypedDict, closed=True):
    configuration_source: (
        "aws_sdk_apprunner.types.configuration_source.ConfigurationSource"
    )
    ...
    code_configuration_values: NotRequired[
        "aws_sdk_apprunner.types.code_configuration_values.CodeConfigurationValues"
    ]
...
def serialize_aws_json_1_0(value: CodeConfiguration) -> dict:
    ...
    out["ConfigurationSource"] = (
        aws_sdk_apprunner.types.configuration_source.serialize_aws_json_1_0(
    ...
    if "code_configuration_values" in value:
        ...
        out["CodeConfigurationValues"] = (
            aws_sdk_apprunner.types.code_configuration_values.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> CodeConfiguration:
    ...
    if "ConfigurationSource" in data:
        ...
        out["configuration_source"] = (
            aws_sdk_apprunner.types.configuration_source.deserialize_aws_json_1_0(
    ...
    if "CodeConfigurationValues" in data:
        ...
        out["code_configuration_values"] = (
            aws_sdk_apprunner.types.code_configuration_values.deserialize_aws_json_1_0(
