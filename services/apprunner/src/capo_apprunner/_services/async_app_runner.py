...
from capo_apprunner._services._aws_config import aaws_config
...
class AsyncAppRunnerClientConfig(TypedDict, total=False, closed=True):
...
class AsyncAppRunnerClient:
    ...
    async def associate_custom_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.associate_custom_domain_request.AssociateCustomDomainRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.associate_custom_domain_response.AssociateCustomDomainResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.associate_custom_domain.async_associate_custom_domain(
    ...
    async def create_auto_scaling_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.create_auto_scaling_configuration_request.CreateAutoScalingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.create_auto_scaling_configuration_response.CreateAutoScalingConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.create_auto_scaling_configuration.async_create_auto_scaling_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.create_connection_request.CreateConnectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.create_connection_response.CreateConnectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.create_connection.async_create_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_observability_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.create_observability_configuration_request.CreateObservabilityConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.create_observability_configuration_response.CreateObservabilityConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.create_observability_configuration.async_create_observability_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.create_service_request.CreateServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.create_service_response.CreateServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.create_service.async_create_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_vpc_connector(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.create_vpc_connector_request.CreateVpcConnectorRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.create_vpc_connector_response.CreateVpcConnectorResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.create_vpc_connector.async_create_vpc_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_vpc_ingress_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.create_vpc_ingress_connection_request.CreateVpcIngressConnectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.create_vpc_ingress_connection_response.CreateVpcIngressConnectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.create_vpc_ingress_connection.async_create_vpc_ingress_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_auto_scaling_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.delete_auto_scaling_configuration_request.DeleteAutoScalingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.delete_auto_scaling_configuration_response.DeleteAutoScalingConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.delete_auto_scaling_configuration.async_delete_auto_scaling_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.delete_connection_request.DeleteConnectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.delete_connection_response.DeleteConnectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.delete_connection.async_delete_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_observability_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.delete_observability_configuration_request.DeleteObservabilityConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.delete_observability_configuration_response.DeleteObservabilityConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.delete_observability_configuration.async_delete_observability_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.delete_service_request.DeleteServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.delete_service_response.DeleteServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.delete_service.async_delete_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_vpc_connector(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.delete_vpc_connector_request.DeleteVpcConnectorRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.delete_vpc_connector_response.DeleteVpcConnectorResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.delete_vpc_connector.async_delete_vpc_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_vpc_ingress_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.delete_vpc_ingress_connection_request.DeleteVpcIngressConnectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.delete_vpc_ingress_connection_response.DeleteVpcIngressConnectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.delete_vpc_ingress_connection.async_delete_vpc_ingress_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_auto_scaling_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.describe_auto_scaling_configuration_request.DescribeAutoScalingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.describe_auto_scaling_configuration_response.DescribeAutoScalingConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.describe_auto_scaling_configuration.async_describe_auto_scaling_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_custom_domains(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.describe_custom_domains_request.DescribeCustomDomainsRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.describe_custom_domains_response.DescribeCustomDomainsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.describe_custom_domains.async_describe_custom_domains(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_observability_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.describe_observability_configuration_request.DescribeObservabilityConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.describe_observability_configuration_response.DescribeObservabilityConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.describe_observability_configuration.async_describe_observability_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.describe_service_request.DescribeServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.describe_service_response.DescribeServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.describe_service.async_describe_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_vpc_connector(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.describe_vpc_connector_request.DescribeVpcConnectorRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.describe_vpc_connector_response.DescribeVpcConnectorResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.describe_vpc_connector.async_describe_vpc_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_vpc_ingress_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.describe_vpc_ingress_connection_request.DescribeVpcIngressConnectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.describe_vpc_ingress_connection_response.DescribeVpcIngressConnectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.describe_vpc_ingress_connection.async_describe_vpc_ingress_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_custom_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.disassociate_custom_domain_request.DisassociateCustomDomainRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.disassociate_custom_domain_response.DisassociateCustomDomainResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.disassociate_custom_domain.async_disassociate_custom_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_auto_scaling_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.list_auto_scaling_configurations_request.ListAutoScalingConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.list_auto_scaling_configurations_response.ListAutoScalingConfigurationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.list_auto_scaling_configurations.async_list_auto_scaling_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_connections(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.list_connections_request.ListConnectionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.list_connections_response.ListConnectionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.list_connections.async_list_connections(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_observability_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.list_observability_configurations_request.ListObservabilityConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.list_observability_configurations_response.ListObservabilityConfigurationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.list_observability_configurations.async_list_observability_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_operations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.list_operations_request.ListOperationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.list_operations_response.ListOperationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.list_operations.async_list_operations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_services(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.list_services_request.ListServicesRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.list_services_response.ListServicesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.list_services.async_list_services(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_services_for_auto_scaling_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.list_services_for_auto_scaling_configuration_request.ListServicesForAutoScalingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.list_services_for_auto_scaling_configuration_response.ListServicesForAutoScalingConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.list_services_for_auto_scaling_configuration.async_list_services_for_auto_scaling_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_vpc_connectors(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.list_vpc_connectors_request.ListVpcConnectorsRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.list_vpc_connectors_response.ListVpcConnectorsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.list_vpc_connectors.async_list_vpc_connectors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_vpc_ingress_connections(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.list_vpc_ingress_connections_request.ListVpcIngressConnectionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.list_vpc_ingress_connections_response.ListVpcIngressConnectionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.list_vpc_ingress_connections.async_list_vpc_ingress_connections(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def pause_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.pause_service_request.PauseServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.pause_service_response.PauseServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.pause_service.async_pause_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def resume_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.resume_service_request.ResumeServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.resume_service_response.ResumeServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.resume_service.async_resume_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.start_deployment_request.StartDeploymentRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.start_deployment_response.StartDeploymentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.start_deployment.async_start_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_default_auto_scaling_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.update_default_auto_scaling_configuration_request.UpdateDefaultAutoScalingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.update_default_auto_scaling_configuration_response.UpdateDefaultAutoScalingConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.update_default_auto_scaling_configuration.async_update_default_auto_scaling_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.update_service_request.UpdateServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.update_service_response.UpdateServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.update_service.async_update_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_vpc_ingress_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apprunner.types.update_vpc_ingress_connection_request.UpdateVpcIngressConnectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_apprunner.types.update_vpc_ingress_connection_response.UpdateVpcIngressConnectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apprunner._operations.app_runner.update_vpc_ingress_connection.async_update_vpc_ingress_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
