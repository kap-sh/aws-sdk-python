"""Generated from Smithy shape ``com.amazonaws.apprunner#InvalidRequestException``."""
...
class InvalidRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.apprunner#InvalidRequestException``."""
