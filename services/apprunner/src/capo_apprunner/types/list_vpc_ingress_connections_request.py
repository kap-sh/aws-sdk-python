...
def serialize_aws_json_1_0(value: ListVpcIngressConnectionsRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = (
            capo_apprunner.types.list_vpc_ingress_connections_filter.serialize_aws_json_1_0(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListVpcIngressConnectionsRequest:
    ...
    if "Filter" in data:
        ...
        out["filter"] = (
            capo_apprunner.types.list_vpc_ingress_connections_filter.deserialize_aws_json_1_0(
                data["Filter"]
            )
        )
