...
if TYPE_CHECKING:
    import capo_dataexchange.types.list_of_event_action_entry
    import capo_dataexchange.types.next_token


class ListEventActionsResponse(TypedDict, closed=True):
    event_actions: NotRequired[
        "capo_dataexchange.types.list_of_event_action_entry.ListOfEventActionEntry"
    ]
...
def serialize_json(value: ListEventActionsResponse) -> dict:
    ...
    if "event_actions" in value:
        ...
        out["EventActions"] = (
            capo_dataexchange.types.list_of_event_action_entry.serialize_json(
                value["event_actions"]
            )
        )
...
def deserialize_json(data: dict) -> ListEventActionsResponse:
    ...
    if "EventActions" in data:
        ...
        out["event_actions"] = (
            capo_dataexchange.types.list_of_event_action_entry.deserialize_json(
                data["EventActions"]
            )
        )
