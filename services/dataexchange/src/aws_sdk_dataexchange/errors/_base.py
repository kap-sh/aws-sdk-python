...
class DataExchangeError(Exception):
    """Base class for all DataExchange service errors."""


class ServiceError(DataExchangeError):
...
class SerializationError(DataExchangeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DataExchangeError):
...
class WaiterFailedError(DataExchangeError):
...
class WaiterTimeoutError(DataExchangeError):
