...
class ApiGatewayApiAsset(TypedDict):
    ...
    api_endpoint: NotRequired["aws_sdk_dataexchange.types.__string.__string"]
    """<p>The API endpoint of the API asset.</p>"""
    api_id: NotRequired["aws_sdk_dataexchange.types.__string.__string"]
    ...
    api_name: NotRequired["aws_sdk_dataexchange.types.__string.__string"]
    ...
    api_specification_download_url_expires_at: NotRequired[
        "aws_sdk_dataexchange.types.timestamp.Timestamp"
    ]
    """<p>The date and time that the upload URL expires, in ISO 8601 format.</p>"""
    protocol_type: NotRequired["aws_sdk_dataexchange.types.protocol_type.ProtocolType"]
    """<p>The protocol type of the API asset.</p>"""
    stage: NotRequired["aws_sdk_dataexchange.types.__string.__string"]
...
def serialize_json(value: ApiGatewayApiAsset) -> dict:
    ...
    if "api_specification_download_url_expires_at" in value:
        ...
        out["ApiSpecificationDownloadUrlExpiresAt"] = (
            aws_sdk_dataexchange.types.timestamp.serialize_json(
