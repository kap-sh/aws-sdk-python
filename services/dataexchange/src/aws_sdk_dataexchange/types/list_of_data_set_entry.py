...
ListOfDataSetEntry: TypeAlias = list[
    "aws_sdk_dataexchange.types.data_set_entry.DataSetEntry"
]
...
def serialize_json(value: ListOfDataSetEntry) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_dataexchange.types.data_set_entry.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> ListOfDataSetEntry:
    ...
    for item in data:
        out.append(aws_sdk_dataexchange.types.data_set_entry.deserialize_json(item))
    return out
