...
if TYPE_CHECKING:
    import aws_sdk_dataexchange.types.database_lf_tag_policy_permission

ListOfDatabaseLFTagPolicyPermissions: TypeAlias = list[
    "aws_sdk_dataexchange.types.database_lf_tag_policy_permission.DatabaseLFTagPolicyPermission"
]
