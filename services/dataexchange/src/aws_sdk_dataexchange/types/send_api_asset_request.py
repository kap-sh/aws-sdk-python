...
class SendApiAssetRequest(TypedDict):
    ...
    method: NotRequired["aws_sdk_dataexchange.types.__string.__string"]
    """<p>HTTP method value for the API request. Alternatively, you can use the appropriate verb in your request.</p>"""
    path: NotRequired["aws_sdk_dataexchange.types.__string.__string"]
