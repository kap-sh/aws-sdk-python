"""Generated from Smithy shape ``com.amazonaws.dataexchange#ListEventActions``."""
...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.list_event_actions_response.ListEventActionsResponse = aws_sdk_dataexchange.types.list_event_actions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.list_event_actions_request.ListEventActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "event_source_id" in input_:
        params["eventSourceId"] = str(input_["event_source_id"])
...
async def async_list_event_actions(
