...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.list_event_actions_request.ListEventActionsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "event_source_id" in input:
        params["eventSourceId"] = str(input["event_source_id"])
