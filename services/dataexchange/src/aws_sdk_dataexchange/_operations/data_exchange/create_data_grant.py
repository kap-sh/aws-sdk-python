...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.create_data_grant_request.CreateDataGrantRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.create_data_grant_request.serialize_json(input)
    ).encode()
