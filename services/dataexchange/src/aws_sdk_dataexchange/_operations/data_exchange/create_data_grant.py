"""Generated from Smithy shape ``com.amazonaws.dataexchange#CreateDataGrant``."""
...
import aws_sdk_dataexchange.errors.access_denied_exception
...
import aws_sdk_dataexchange.errors.service_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise aws_sdk_dataexchange.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
        ...
        case "ServiceLimitExceededException":
            raise aws_sdk_dataexchange.errors.service_limit_exceeded_exception.ServiceLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.create_data_grant_response.CreateDataGrantResponse = aws_sdk_dataexchange.types.create_data_grant_response.deserialize_json(
...
def get_signer(
...
) -> aws_sdk_dataexchange._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_dataexchange._auth._sigv4.build_sigv4_auth_scheme(
                "dataexchange", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_dataexchange._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.create_data_grant_request.CreateDataGrantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.create_data_grant_request.serialize_json(input_)
    ).encode()
...
async def async_create_data_grant(
