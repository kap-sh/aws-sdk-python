"""Generated from Smithy shape ``com.amazonaws.dataexchange#UpdateRevision``."""
...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.update_revision_response.UpdateRevisionResponse = (
        aws_sdk_dataexchange.types.update_revision_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.update_revision_request.UpdateRevisionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.update_revision_request.serialize_json(input)
    ).encode()
...
async def async_update_revision(
