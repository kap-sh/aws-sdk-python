...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.get_received_data_grant_response.GetReceivedDataGrantResponse = aws_sdk_dataexchange.types.get_received_data_grant_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.get_received_data_grant_request.GetReceivedDataGrantRequest,
) -> zapros.Request:
    ...
    url = url.replace("{DataGrantArn}", quote(str(input["data_grant_arn"]), safe=""))
    params: dict[str, str] = {}
