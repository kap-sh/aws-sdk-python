...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.list_received_data_grants_request.ListReceivedDataGrantsRequest,
) -> zapros.Request:
    ...
    if "acceptance_state" in input:
        params["acceptanceState"] = str(input["acceptance_state"])
