...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.list_received_data_grants_response.ListReceivedDataGrantsResponse = aws_sdk_dataexchange.types.list_received_data_grants_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.list_received_data_grants_request.ListReceivedDataGrantsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
