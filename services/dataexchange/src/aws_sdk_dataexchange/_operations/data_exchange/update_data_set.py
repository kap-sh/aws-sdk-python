"""Generated from Smithy shape ``com.amazonaws.dataexchange#UpdateDataSet``."""
...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.update_data_set_response.UpdateDataSetResponse = (
        aws_sdk_dataexchange.types.update_data_set_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.update_data_set_request.UpdateDataSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.update_data_set_request.serialize_json(input)
    ).encode()
...
async def async_update_data_set(
