...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.get_asset_response.GetAssetResponse = (
        aws_sdk_dataexchange.types.get_asset_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.get_asset_request.GetAssetRequest,
) -> zapros.Request:
    ...
    url = url.replace("{AssetId}", quote(str(input["asset_id"]), safe=""))
...
def get_asset(
    ...
    aws_sdk_dataexchange.types.get_asset_response.GetAssetResponse, zapros.Response
]:
