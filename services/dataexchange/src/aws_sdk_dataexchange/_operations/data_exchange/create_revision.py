...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.create_revision_response.CreateRevisionResponse = (
        aws_sdk_dataexchange.types.create_revision_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.create_revision_request.CreateRevisionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.create_revision_request.serialize_json(input_)
    ).encode()
