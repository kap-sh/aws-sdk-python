...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.get_data_set_response.GetDataSetResponse = (
        aws_sdk_dataexchange.types.get_data_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.get_data_set_request.GetDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_data_set(
    ...
    aws_sdk_dataexchange.types.get_data_set_response.GetDataSetResponse, zapros.Response
]:
