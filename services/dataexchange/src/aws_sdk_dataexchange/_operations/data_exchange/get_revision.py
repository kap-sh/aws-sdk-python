...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.get_revision_response.GetRevisionResponse = (
        aws_sdk_dataexchange.types.get_revision_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.get_revision_request.GetRevisionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
