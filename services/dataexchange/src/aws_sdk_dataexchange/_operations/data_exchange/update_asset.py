...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.update_asset_response.UpdateAssetResponse = (
        aws_sdk_dataexchange.types.update_asset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.update_asset_request.UpdateAssetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.update_asset_request.serialize_json(input_)
    ).encode()
