...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.list_data_grants_response.ListDataGrantsResponse = (
        aws_sdk_dataexchange.types.list_data_grants_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.list_data_grants_request.ListDataGrantsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
