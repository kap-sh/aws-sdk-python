...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.start_job_response.StartJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.start_job_request.StartJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def start_job(
    ...
    aws_sdk_dataexchange.types.start_job_response.StartJobResponse, zapros.Response
]:
