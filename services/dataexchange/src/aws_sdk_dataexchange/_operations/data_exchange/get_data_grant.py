...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.get_data_grant_response.GetDataGrantResponse = (
        aws_sdk_dataexchange.types.get_data_grant_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.get_data_grant_request.GetDataGrantRequest,
) -> zapros.Request:
    ...
    url = url.replace("{DataGrantId}", quote(str(input["data_grant_id"]), safe=""))
    params: dict[str, str] = {}
