"""Generated from Smithy shape ``com.amazonaws.dataexchange#SendDataSetNotification``."""
...
import aws_sdk_dataexchange.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_dataexchange.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.send_data_set_notification_response.SendDataSetNotificationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.send_data_set_notification_request.SendDataSetNotificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/data-sets/{DataSetId}/notification"
    url = url.replace("{DataSetId}", quote(str(input_["data_set_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.send_data_set_notification_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_send_data_set_notification(
