...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.update_event_action_response.UpdateEventActionResponse = aws_sdk_dataexchange.types.update_event_action_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.update_event_action_request.UpdateEventActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.update_event_action_request.serialize_json(input_)
    ).encode()
