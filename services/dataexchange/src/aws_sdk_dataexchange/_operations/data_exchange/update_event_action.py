...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.update_event_action_request.UpdateEventActionRequest,
) -> zapros.Request:
    ...
    url = url.replace("{EventActionId}", quote(str(input["event_action_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_dataexchange.types.update_event_action_request

    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.update_event_action_request.serialize_json(input)
    ).encode()
