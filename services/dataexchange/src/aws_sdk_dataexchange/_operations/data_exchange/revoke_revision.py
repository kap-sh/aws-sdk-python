...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.revoke_revision_response.RevokeRevisionResponse = (
        aws_sdk_dataexchange.types.revoke_revision_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.revoke_revision_request.RevokeRevisionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.revoke_revision_request.serialize_json(input_)
    ).encode()
