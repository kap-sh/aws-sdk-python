"""Generated from Smithy shape ``com.amazonaws.dataexchange#DeleteDataSet``."""
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.delete_data_set_request.DeleteDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_data_set(
