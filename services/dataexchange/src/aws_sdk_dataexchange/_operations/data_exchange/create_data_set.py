...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.create_data_set_response.CreateDataSetResponse = (
        aws_sdk_dataexchange.types.create_data_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.create_data_set_request.CreateDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.create_data_set_request.serialize_json(input_)
    ).encode()
