"""Generated from Smithy shape ``com.amazonaws.dataexchange#GetEventAction``."""
...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.get_event_action_response.GetEventActionResponse = (
        aws_sdk_dataexchange.types.get_event_action_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.get_event_action_request.GetEventActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_event_action(
