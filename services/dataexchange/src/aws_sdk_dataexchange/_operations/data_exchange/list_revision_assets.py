...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.list_revision_assets_response.ListRevisionAssetsResponse = aws_sdk_dataexchange.types.list_revision_assets_response.deserialize_json(
