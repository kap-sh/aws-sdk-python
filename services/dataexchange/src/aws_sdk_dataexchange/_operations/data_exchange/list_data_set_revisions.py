...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.list_data_set_revisions_response.ListDataSetRevisionsResponse = aws_sdk_dataexchange.types.list_data_set_revisions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.list_data_set_revisions_request.ListDataSetRevisionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
