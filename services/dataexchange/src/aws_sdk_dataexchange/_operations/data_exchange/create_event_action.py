...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.create_event_action_response.CreateEventActionResponse = aws_sdk_dataexchange.types.create_event_action_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.create_event_action_request.CreateEventActionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dataexchange.types.create_event_action_request.serialize_json(input)
    ).encode()
