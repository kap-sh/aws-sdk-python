...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.list_jobs_response.ListJobsResponse = (
        aws_sdk_dataexchange.types.list_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dataexchange.types.list_jobs_request.ListJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_jobs(
    ...
    aws_sdk_dataexchange.types.list_jobs_response.ListJobsResponse, zapros.Response
]:
