...
def handle_response(
    ...
    out: aws_sdk_dataexchange.types.accept_data_grant_response.AcceptDataGrantResponse = aws_sdk_dataexchange.types.accept_data_grant_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_dataexchange.types.accept_data_grant_request.AcceptDataGrantRequest,
) -> zapros.Request:
