"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#CertificateNotFoundException``."""
...
class CertificateNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticloadbalancing#CertificateNotFoundException``."""
