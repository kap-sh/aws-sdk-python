...
from capo_elastic_load_balancing._services._aws_config import aaws_config
...
class AsyncElasticLoadBalancingClient:
    ...
    async def add_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.add_tags_input.AddTagsInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.add_tags_output.AddTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.add_tags.async_add_tags(
    ...
    async def apply_security_groups_to_load_balancer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.apply_security_groups_to_load_balancer_input.ApplySecurityGroupsToLoadBalancerInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.apply_security_groups_to_load_balancer_output.ApplySecurityGroupsToLoadBalancerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.apply_security_groups_to_load_balancer.async_apply_security_groups_to_load_balancer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_load_balancer_to_subnets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.attach_load_balancer_to_subnets_input.AttachLoadBalancerToSubnetsInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.attach_load_balancer_to_subnets_output.AttachLoadBalancerToSubnetsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.attach_load_balancer_to_subnets.async_attach_load_balancer_to_subnets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def configure_health_check(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.configure_health_check_input.ConfigureHealthCheckInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.configure_health_check_output.ConfigureHealthCheckOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.configure_health_check.async_configure_health_check(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_app_cookie_stickiness_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.create_app_cookie_stickiness_policy_input.CreateAppCookieStickinessPolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.create_app_cookie_stickiness_policy_output.CreateAppCookieStickinessPolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.create_app_cookie_stickiness_policy.async_create_app_cookie_stickiness_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_lb_cookie_stickiness_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.create_lb_cookie_stickiness_policy_input.CreateLBCookieStickinessPolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.create_lb_cookie_stickiness_policy_output.CreateLBCookieStickinessPolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.create_lb_cookie_stickiness_policy.async_create_lb_cookie_stickiness_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_load_balancer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.create_access_point_input.CreateAccessPointInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.create_access_point_output.CreateAccessPointOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.create_load_balancer.async_create_load_balancer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_load_balancer_listeners(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.create_load_balancer_listener_input.CreateLoadBalancerListenerInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.create_load_balancer_listener_output.CreateLoadBalancerListenerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.create_load_balancer_listeners.async_create_load_balancer_listeners(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_load_balancer_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.create_load_balancer_policy_input.CreateLoadBalancerPolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.create_load_balancer_policy_output.CreateLoadBalancerPolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.create_load_balancer_policy.async_create_load_balancer_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_load_balancer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.delete_access_point_input.DeleteAccessPointInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.delete_access_point_output.DeleteAccessPointOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.delete_load_balancer.async_delete_load_balancer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_load_balancer_listeners(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.delete_load_balancer_listener_input.DeleteLoadBalancerListenerInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.delete_load_balancer_listener_output.DeleteLoadBalancerListenerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.delete_load_balancer_listeners.async_delete_load_balancer_listeners(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_load_balancer_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.delete_load_balancer_policy_input.DeleteLoadBalancerPolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.delete_load_balancer_policy_output.DeleteLoadBalancerPolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.delete_load_balancer_policy.async_delete_load_balancer_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_instances_from_load_balancer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.deregister_end_points_input.DeregisterEndPointsInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.deregister_end_points_output.DeregisterEndPointsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.deregister_instances_from_load_balancer.async_deregister_instances_from_load_balancer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_limits(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.describe_account_limits_input.DescribeAccountLimitsInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.describe_account_limits_output.DescribeAccountLimitsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_account_limits.async_describe_account_limits(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_instance_health(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.describe_end_point_state_input.DescribeEndPointStateInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.describe_end_point_state_output.DescribeEndPointStateOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_instance_health.async_describe_instance_health(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_load_balancer_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.describe_load_balancer_attributes_input.DescribeLoadBalancerAttributesInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.describe_load_balancer_attributes_output.DescribeLoadBalancerAttributesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_load_balancer_attributes.async_describe_load_balancer_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_load_balancer_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.describe_load_balancer_policies_input.DescribeLoadBalancerPoliciesInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.describe_load_balancer_policies_output.DescribeLoadBalancerPoliciesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_load_balancer_policies.async_describe_load_balancer_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_load_balancer_policy_types(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.describe_load_balancer_policy_types_input.DescribeLoadBalancerPolicyTypesInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.describe_load_balancer_policy_types_output.DescribeLoadBalancerPolicyTypesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_load_balancer_policy_types.async_describe_load_balancer_policy_types(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_load_balancers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.describe_access_points_input.DescribeAccessPointsInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.describe_access_points_output.DescribeAccessPointsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_load_balancers.async_describe_load_balancers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_elastic_load_balancing.types.load_balancer_description.LoadBalancerDescription]":
        _token = marker
        while True:
    ...
    async def describe_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.describe_tags_input.DescribeTagsInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.describe_tags_output.DescribeTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_tags.async_describe_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_load_balancer_from_subnets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.detach_load_balancer_from_subnets_input.DetachLoadBalancerFromSubnetsInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.detach_load_balancer_from_subnets_output.DetachLoadBalancerFromSubnetsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.detach_load_balancer_from_subnets.async_detach_load_balancer_from_subnets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_availability_zones_for_load_balancer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.remove_availability_zones_input.RemoveAvailabilityZonesInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.remove_availability_zones_output.RemoveAvailabilityZonesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.disable_availability_zones_for_load_balancer.async_disable_availability_zones_for_load_balancer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_availability_zones_for_load_balancer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.add_availability_zones_input.AddAvailabilityZonesInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.add_availability_zones_output.AddAvailabilityZonesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.enable_availability_zones_for_load_balancer.async_enable_availability_zones_for_load_balancer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_load_balancer_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.modify_load_balancer_attributes_input.ModifyLoadBalancerAttributesInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.modify_load_balancer_attributes_output.ModifyLoadBalancerAttributesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.modify_load_balancer_attributes.async_modify_load_balancer_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_instances_with_load_balancer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.register_end_points_input.RegisterEndPointsInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.register_end_points_output.RegisterEndPointsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.register_instances_with_load_balancer.async_register_instances_with_load_balancer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.remove_tags_input.RemoveTagsInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.remove_tags_output.RemoveTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.remove_tags.async_remove_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_load_balancer_listener_ssl_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.set_load_balancer_listener_ssl_certificate_input.SetLoadBalancerListenerSSLCertificateInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.set_load_balancer_listener_ssl_certificate_output.SetLoadBalancerListenerSSLCertificateOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.set_load_balancer_listener_ssl_certificate.async_set_load_balancer_listener_ssl_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_load_balancer_policies_for_backend_server(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.set_load_balancer_policies_for_backend_server_input.SetLoadBalancerPoliciesForBackendServerInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.set_load_balancer_policies_for_backend_server_output.SetLoadBalancerPoliciesForBackendServerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.set_load_balancer_policies_for_backend_server.async_set_load_balancer_policies_for_backend_server(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_load_balancer_policies_of_listener(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_elastic_load_balancing.types.set_load_balancer_policies_of_listener_input.SetLoadBalancerPoliciesOfListenerInput]",
        ) -> AsyncOperationResponse[
            "capo_elastic_load_balancing.types.set_load_balancer_policies_of_listener_output.SetLoadBalancerPoliciesOfListenerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_elastic_load_balancing._operations.elastic_load_balancing_v7.set_load_balancer_policies_of_listener.async_set_load_balancer_policies_of_listener(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
