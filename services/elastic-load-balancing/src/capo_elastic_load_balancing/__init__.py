...
from ._services.async_elastic_load_balancing import (
    AsyncElasticLoadBalancingClient as AsyncElasticLoadBalancingClient,
)
from ._services.elastic_load_balancing import (
    ElasticLoadBalancingClient as ElasticLoadBalancingClient,
)
