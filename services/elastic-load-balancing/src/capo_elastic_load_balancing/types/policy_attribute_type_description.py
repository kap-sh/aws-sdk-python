...
if TYPE_CHECKING:
    ...
    import capo_elastic_load_balancing.types.attribute_type
    import capo_elastic_load_balancing.types.cardinality
    import capo_elastic_load_balancing.types.default_value
...
class PolicyAttributeTypeDescription(TypedDict, closed=True):
    ...
    attribute_type: NotRequired[
        "capo_elastic_load_balancing.types.attribute_type.AttributeType"
    ]
    ...
    default_value: NotRequired[
        "capo_elastic_load_balancing.types.default_value.DefaultValue"
    ]
    """<p>The default value of the attribute, if applicable.</p>"""
    cardinality: NotRequired[
        "capo_elastic_load_balancing.types.cardinality.Cardinality"
    ]
