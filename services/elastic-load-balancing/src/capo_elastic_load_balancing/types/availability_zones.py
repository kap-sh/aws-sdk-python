"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#AvailabilityZones``."""
...
if TYPE_CHECKING:
    import capo_elastic_load_balancing.types.availability_zone

AvailabilityZones: TypeAlias = list[
    "capo_elastic_load_balancing.types.availability_zone.AvailabilityZone"
]
