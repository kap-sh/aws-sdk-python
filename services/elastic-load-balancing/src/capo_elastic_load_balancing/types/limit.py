...
if TYPE_CHECKING:
    import capo_elastic_load_balancing.types.max
    import capo_elastic_load_balancing.types.name


class Limit(TypedDict, closed=True):
    name: NotRequired["capo_elastic_load_balancing.types.name.Name"]
    ...
    max: NotRequired["capo_elastic_load_balancing.types.max.Max"]
