...
def serialize_query(
    ...
    if "policy_type_names" in value:
        ...
        capo_elastic_load_balancing.types.policy_type_names.serialize_query(
            value["policy_type_names"], pairs, f"{key_prefix}PolicyTypeNames"
        )
...
def deserialize_query(el: Element) -> DescribeLoadBalancerPolicyTypesInput:
    ...
    if child_policy_type_names is not None:
        ...
        out["policy_type_names"] = (
            capo_elastic_load_balancing.types.policy_type_names.deserialize_query(
