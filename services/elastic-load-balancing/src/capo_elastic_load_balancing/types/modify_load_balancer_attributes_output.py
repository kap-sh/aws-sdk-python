...
class ModifyLoadBalancerAttributesOutput(TypedDict, closed=True):
    ...
    load_balancer_attributes: NotRequired[
        "capo_elastic_load_balancing.types.load_balancer_attributes.LoadBalancerAttributes"
    ]
...
def serialize_query(
    ...
    if "load_balancer_attributes" in value:
        ...
        capo_elastic_load_balancing.types.load_balancer_attributes.serialize_query(
            value["load_balancer_attributes"],
            pairs,
            f"{key_prefix}LoadBalancerAttributes",
        )
...
def deserialize_query(el: Element) -> ModifyLoadBalancerAttributesOutput:
    ...
    if child_load_balancer_attributes is not None:
        ...
        out["load_balancer_attributes"] = (
            capo_elastic_load_balancing.types.load_balancer_attributes.deserialize_query(
