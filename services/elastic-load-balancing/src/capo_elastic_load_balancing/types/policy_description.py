...
if TYPE_CHECKING:
    import capo_elastic_load_balancing.types.policy_attribute_descriptions
...
class PolicyDescription(TypedDict, closed=True):
    ...
    policy_attribute_descriptions: NotRequired[
        "capo_elastic_load_balancing.types.policy_attribute_descriptions.PolicyAttributeDescriptions"
    ]
...
def serialize_query(
    ...
    if "policy_attribute_descriptions" in value:
        ...
        capo_elastic_load_balancing.types.policy_attribute_descriptions.serialize_query(
            value["policy_attribute_descriptions"],
            pairs,
            f"{key_prefix}PolicyAttributeDescriptions",
        )
...
def deserialize_query(el: Element) -> PolicyDescription:
    ...
    if child_policy_attribute_descriptions is not None:
        ...
        out["policy_attribute_descriptions"] = (
            capo_elastic_load_balancing.types.policy_attribute_descriptions.deserialize_query(
