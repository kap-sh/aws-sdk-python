"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DescribeEndPointStateInput``."""
...
class DescribeEndPointStateInput(TypedDict, closed=True):
    load_balancer_name: (
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeEndPointStateInput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeEndPointStateInput:
    out: DescribeEndPointStateInput = {}  # type: ignore[typeddict-item]
    ...
    if child_load_balancer_name is not None:
        ...
        raise DeserializationError(
            "DescribeEndPointStateInput.load_balancer_name required"
        )
