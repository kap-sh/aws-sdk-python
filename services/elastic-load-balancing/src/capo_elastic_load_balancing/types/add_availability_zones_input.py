"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#AddAvailabilityZonesInput``."""
...
class AddAvailabilityZonesInput(TypedDict, closed=True):
    load_balancer_name: (
...
# --- awsQuery ser/de ---
def serialize_query(
    value: AddAvailabilityZonesInput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> AddAvailabilityZonesInput:
    out: AddAvailabilityZonesInput = {}  # type: ignore[typeddict-item]
    ...
    if child_load_balancer_name is not None:
        ...
        raise DeserializationError(
            "AddAvailabilityZonesInput.load_balancer_name required"
        )
    ...
    if child_availability_zones is not None:
        ...
        raise DeserializationError(
            "AddAvailabilityZonesInput.availability_zones required"
        )
    return out
