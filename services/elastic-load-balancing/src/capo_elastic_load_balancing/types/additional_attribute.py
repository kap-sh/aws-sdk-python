...
if TYPE_CHECKING:
    import capo_elastic_load_balancing.types.additional_attribute_key
    import capo_elastic_load_balancing.types.additional_attribute_value


class AdditionalAttribute(TypedDict, closed=True):
    key: NotRequired[
        "capo_elastic_load_balancing.types.additional_attribute_key.AdditionalAttributeKey"
    ]
    ...
    value: NotRequired[
        "capo_elastic_load_balancing.types.additional_attribute_value.AdditionalAttributeValue"
    ]
