...
class DescribeAccessPointsOutput(TypedDict, closed=True):
    load_balancer_descriptions: NotRequired[
        "capo_elastic_load_balancing.types.load_balancer_descriptions.LoadBalancerDescriptions"
    ]
...
def deserialize_query(el: Element) -> DescribeAccessPointsOutput:
    ...
    if child_load_balancer_descriptions is not None:
        ...
        out["load_balancer_descriptions"] = (
            capo_elastic_load_balancing.types.load_balancer_descriptions.deserialize_query(
