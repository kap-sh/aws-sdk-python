...
if TYPE_CHECKING:
    import capo_elastic_load_balancing.types.access_log_enabled
    import capo_elastic_load_balancing.types.access_log_interval
    import capo_elastic_load_balancing.types.access_log_prefix
    import capo_elastic_load_balancing.types.s3_bucket_name


class AccessLog(TypedDict, closed=True):
    enabled: "capo_elastic_load_balancing.types.access_log_enabled.AccessLogEnabled"
    """<p>Specifies whether access logs are enabled for the load balancer.</p>"""
    s3_bucket_name: NotRequired[
        "capo_elastic_load_balancing.types.s3_bucket_name.S3BucketName"
    ]
    """<p>The name of the Amazon S3 bucket where the access logs are stored.</p>"""
    emit_interval: NotRequired[
        "capo_elastic_load_balancing.types.access_log_interval.AccessLogInterval"
    ]
    ...
    s3_bucket_prefix: NotRequired[
        "capo_elastic_load_balancing.types.access_log_prefix.AccessLogPrefix"
    ]
