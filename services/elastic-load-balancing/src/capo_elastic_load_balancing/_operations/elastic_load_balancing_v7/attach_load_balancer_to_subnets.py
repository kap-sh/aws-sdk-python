"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#AttachLoadBalancerToSubnets``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("AttachLoadBalancerToSubnetsResult")
    out: capo_elastic_load_balancing.types.attach_load_balancer_to_subnets_output.AttachLoadBalancerToSubnetsOutput = capo_elastic_load_balancing.types.attach_load_balancer_to_subnets_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.attach_load_balancer_to_subnets_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_attach_load_balancer_to_subnets(
