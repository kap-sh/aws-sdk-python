...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.apply_security_groups_to_load_balancer_output.ApplySecurityGroupsToLoadBalancerOutput = capo_elastic_load_balancing.types.apply_security_groups_to_load_balancer_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.apply_security_groups_to_load_balancer_input.serialize_query(
        input_, pairs, ""
    )
