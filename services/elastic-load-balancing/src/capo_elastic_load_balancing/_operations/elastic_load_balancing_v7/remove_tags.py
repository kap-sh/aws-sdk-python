"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#RemoveTags``."""
...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.remove_tags_output.RemoveTagsOutput = (
        capo_elastic_load_balancing.types.remove_tags_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.remove_tags_input.serialize_query(
        input_, pairs, ""
    )
