...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.register_end_points_output.RegisterEndPointsOutput = capo_elastic_load_balancing.types.register_end_points_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.register_end_points_input.serialize_query(
        input_, pairs, ""
    )
