...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.describe_end_point_state_output.DescribeEndPointStateOutput = capo_elastic_load_balancing.types.describe_end_point_state_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.describe_end_point_state_input.serialize_query(
        input_, pairs, ""
    )
