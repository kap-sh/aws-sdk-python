"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#CreateLoadBalancerPolicy``."""
...
import capo_elastic_load_balancing.errors.duplicate_policy_name_exception
import capo_elastic_load_balancing.errors.invalid_configuration_request_exception
import capo_elastic_load_balancing.errors.policy_type_not_found_exception
import capo_elastic_load_balancing.errors.too_many_policies_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicatePolicyName":
            raise capo_elastic_load_balancing.errors.duplicate_policy_name_exception.DuplicatePolicyNameException.from_query(
                error_el, message
            )
        ...
        case "TooManyPolicies":
            raise capo_elastic_load_balancing.errors.too_many_policies_exception.TooManyPoliciesException.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.create_load_balancer_policy_output.CreateLoadBalancerPolicyOutput = capo_elastic_load_balancing.types.create_load_balancer_policy_output.deserialize_query(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = (
                capo_elastic_load_balancing._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    pairs.append(("Action", "CreateLoadBalancerPolicy"))
    pairs.append(("Version", "2012-06-01"))
    capo_elastic_load_balancing.types.create_load_balancer_policy_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_load_balancer_policy(
