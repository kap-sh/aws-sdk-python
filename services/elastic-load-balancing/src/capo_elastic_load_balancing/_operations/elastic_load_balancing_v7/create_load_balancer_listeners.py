"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#CreateLoadBalancerListeners``."""
...
import capo_elastic_load_balancing.errors.duplicate_listener_exception
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateLoadBalancerListenersResult")
    out: capo_elastic_load_balancing.types.create_load_balancer_listener_output.CreateLoadBalancerListenerOutput = capo_elastic_load_balancing.types.create_load_balancer_listener_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.create_load_balancer_listener_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_load_balancer_listeners(
