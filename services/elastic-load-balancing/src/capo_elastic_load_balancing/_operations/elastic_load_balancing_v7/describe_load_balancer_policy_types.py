...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.describe_load_balancer_policy_types_output.DescribeLoadBalancerPolicyTypesOutput = capo_elastic_load_balancing.types.describe_load_balancer_policy_types_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.describe_load_balancer_policy_types_input.serialize_query(
        input_, pairs, ""
    )
