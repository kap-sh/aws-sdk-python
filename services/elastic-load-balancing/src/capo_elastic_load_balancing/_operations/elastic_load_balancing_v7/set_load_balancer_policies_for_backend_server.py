...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyNotFound":
            raise capo_elastic_load_balancing.errors.policy_not_found_exception.PolicyNotFoundException.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.set_load_balancer_policies_for_backend_server_output.SetLoadBalancerPoliciesForBackendServerOutput = capo_elastic_load_balancing.types.set_load_balancer_policies_for_backend_server_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.set_load_balancer_policies_for_backend_server_input.serialize_query(
        input_, pairs, ""
    )
