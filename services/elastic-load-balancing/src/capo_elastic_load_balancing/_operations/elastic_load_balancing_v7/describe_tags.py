...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.describe_tags_output.DescribeTagsOutput = (
        capo_elastic_load_balancing.types.describe_tags_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.describe_tags_input.serialize_query(
        input_, pairs, ""
    )
