...
import capo_elastic_load_balancing.errors.dependency_throttle_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DependencyThrottle":
            raise capo_elastic_load_balancing.errors.dependency_throttle_exception.DependencyThrottleException.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.describe_access_points_output.DescribeAccessPointsOutput = capo_elastic_load_balancing.types.describe_access_points_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.describe_access_points_input.serialize_query(
        input_, pairs, ""
    )
