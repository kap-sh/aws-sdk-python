"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#ModifyLoadBalancerAttributes``."""
...
import capo_elastic_load_balancing.errors.load_balancer_attribute_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LoadBalancerAttributeNotFound":
            raise capo_elastic_load_balancing.errors.load_balancer_attribute_not_found_exception.LoadBalancerAttributeNotFoundException.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyLoadBalancerAttributesResult")
    out: capo_elastic_load_balancing.types.modify_load_balancer_attributes_output.ModifyLoadBalancerAttributesOutput = capo_elastic_load_balancing.types.modify_load_balancer_attributes_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyLoadBalancerAttributes"))
    pairs.append(("Version", "2012-06-01"))
    capo_elastic_load_balancing.types.modify_load_balancer_attributes_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_load_balancer_attributes(
