...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.create_app_cookie_stickiness_policy_output.CreateAppCookieStickinessPolicyOutput = capo_elastic_load_balancing.types.create_app_cookie_stickiness_policy_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.create_app_cookie_stickiness_policy_input.serialize_query(
        input_, pairs, ""
    )
