...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.add_availability_zones_output.AddAvailabilityZonesOutput = capo_elastic_load_balancing.types.add_availability_zones_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.add_availability_zones_input.serialize_query(
        input_, pairs, ""
    )
