"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DeleteLoadBalancerPolicy``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteLoadBalancerPolicyResult")
    out: capo_elastic_load_balancing.types.delete_load_balancer_policy_output.DeleteLoadBalancerPolicyOutput = capo_elastic_load_balancing.types.delete_load_balancer_policy_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteLoadBalancerPolicy"))
    pairs.append(("Version", "2012-06-01"))
    capo_elastic_load_balancing.types.delete_load_balancer_policy_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_load_balancer_policy(
