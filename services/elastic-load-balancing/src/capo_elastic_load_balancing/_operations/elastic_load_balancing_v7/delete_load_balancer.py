...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.delete_access_point_output.DeleteAccessPointOutput = capo_elastic_load_balancing.types.delete_access_point_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.delete_access_point_input.serialize_query(
        input_, pairs, ""
    )
