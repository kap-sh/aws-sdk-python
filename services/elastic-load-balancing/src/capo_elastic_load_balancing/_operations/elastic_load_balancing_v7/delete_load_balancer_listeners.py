"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DeleteLoadBalancerListeners``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteLoadBalancerListenersResult")
    out: capo_elastic_load_balancing.types.delete_load_balancer_listener_output.DeleteLoadBalancerListenerOutput = capo_elastic_load_balancing.types.delete_load_balancer_listener_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteLoadBalancerListeners"))
    pairs.append(("Version", "2012-06-01"))
    capo_elastic_load_balancing.types.delete_load_balancer_listener_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_load_balancer_listeners(
