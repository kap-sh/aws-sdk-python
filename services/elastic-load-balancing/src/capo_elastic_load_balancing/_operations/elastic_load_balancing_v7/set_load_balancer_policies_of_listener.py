...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.set_load_balancer_policies_of_listener_output.SetLoadBalancerPoliciesOfListenerOutput = capo_elastic_load_balancing.types.set_load_balancer_policies_of_listener_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.set_load_balancer_policies_of_listener_input.serialize_query(
        input_, pairs, ""
    )
