"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DetachLoadBalancerFromSubnets``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DetachLoadBalancerFromSubnetsResult")
    out: capo_elastic_load_balancing.types.detach_load_balancer_from_subnets_output.DetachLoadBalancerFromSubnetsOutput = capo_elastic_load_balancing.types.detach_load_balancer_from_subnets_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DetachLoadBalancerFromSubnets"))
    pairs.append(("Version", "2012-06-01"))
    capo_elastic_load_balancing.types.detach_load_balancer_from_subnets_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_detach_load_balancer_from_subnets(
