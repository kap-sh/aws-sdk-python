...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.describe_account_limits_output.DescribeAccountLimitsOutput = capo_elastic_load_balancing.types.describe_account_limits_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.describe_account_limits_input.serialize_query(
        input_, pairs, ""
    )
