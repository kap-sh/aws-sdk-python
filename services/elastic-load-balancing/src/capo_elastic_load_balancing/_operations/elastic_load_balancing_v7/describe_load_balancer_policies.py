...
def handle_response(
    ...
    out: capo_elastic_load_balancing.types.describe_load_balancer_policies_output.DescribeLoadBalancerPoliciesOutput = capo_elastic_load_balancing.types.describe_load_balancer_policies_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing.types.describe_load_balancer_policies_input.serialize_query(
        input_, pairs, ""
    )
