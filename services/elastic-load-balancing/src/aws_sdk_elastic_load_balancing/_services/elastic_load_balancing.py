...
from aws_sdk_elastic_load_balancing._services._aws_config import aws_config
...
class ElasticLoadBalancingClientConfig(TypedDict, total=False):
...
class ElasticLoadBalancingClient:
    ...
    def add_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.add_tags_input.AddTagsInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.add_tags_output.AddTagsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.add_tags.add_tags(
    ...
    def apply_security_groups_to_load_balancer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.apply_security_groups_to_load_balancer_input.ApplySecurityGroupsToLoadBalancerInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.apply_security_groups_to_load_balancer_output.ApplySecurityGroupsToLoadBalancerOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.apply_security_groups_to_load_balancer.apply_security_groups_to_load_balancer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def attach_load_balancer_to_subnets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.attach_load_balancer_to_subnets_input.AttachLoadBalancerToSubnetsInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.attach_load_balancer_to_subnets_output.AttachLoadBalancerToSubnetsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.attach_load_balancer_to_subnets.attach_load_balancer_to_subnets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def configure_health_check(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.configure_health_check_input.ConfigureHealthCheckInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.configure_health_check_output.ConfigureHealthCheckOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.configure_health_check.configure_health_check(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_app_cookie_stickiness_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.create_app_cookie_stickiness_policy_input.CreateAppCookieStickinessPolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.create_app_cookie_stickiness_policy_output.CreateAppCookieStickinessPolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.create_app_cookie_stickiness_policy.create_app_cookie_stickiness_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_lb_cookie_stickiness_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.create_lb_cookie_stickiness_policy_input.CreateLBCookieStickinessPolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.create_lb_cookie_stickiness_policy_output.CreateLBCookieStickinessPolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.create_lb_cookie_stickiness_policy.create_lb_cookie_stickiness_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_load_balancer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.create_access_point_input.CreateAccessPointInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.create_access_point_output.CreateAccessPointOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.create_load_balancer.create_load_balancer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_load_balancer_listeners(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.create_load_balancer_listener_input.CreateLoadBalancerListenerInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.create_load_balancer_listener_output.CreateLoadBalancerListenerOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.create_load_balancer_listeners.create_load_balancer_listeners(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_load_balancer_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.create_load_balancer_policy_input.CreateLoadBalancerPolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.create_load_balancer_policy_output.CreateLoadBalancerPolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.create_load_balancer_policy.create_load_balancer_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_load_balancer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.delete_access_point_input.DeleteAccessPointInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.delete_access_point_output.DeleteAccessPointOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.delete_load_balancer.delete_load_balancer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_load_balancer_listeners(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.delete_load_balancer_listener_input.DeleteLoadBalancerListenerInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.delete_load_balancer_listener_output.DeleteLoadBalancerListenerOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.delete_load_balancer_listeners.delete_load_balancer_listeners(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_load_balancer_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.delete_load_balancer_policy_input.DeleteLoadBalancerPolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.delete_load_balancer_policy_output.DeleteLoadBalancerPolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.delete_load_balancer_policy.delete_load_balancer_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deregister_instances_from_load_balancer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.deregister_end_points_input.DeregisterEndPointsInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.deregister_end_points_output.DeregisterEndPointsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.deregister_instances_from_load_balancer.deregister_instances_from_load_balancer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_account_limits(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.describe_account_limits_input.DescribeAccountLimitsInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.describe_account_limits_output.DescribeAccountLimitsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_account_limits.describe_account_limits(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_instance_health(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.describe_end_point_state_input.DescribeEndPointStateInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.describe_end_point_state_output.DescribeEndPointStateOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_instance_health.describe_instance_health(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_load_balancer_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.describe_load_balancer_attributes_input.DescribeLoadBalancerAttributesInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.describe_load_balancer_attributes_output.DescribeLoadBalancerAttributesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_load_balancer_attributes.describe_load_balancer_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_load_balancer_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.describe_load_balancer_policies_input.DescribeLoadBalancerPoliciesInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.describe_load_balancer_policies_output.DescribeLoadBalancerPoliciesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_load_balancer_policies.describe_load_balancer_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_load_balancer_policy_types(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.describe_load_balancer_policy_types_input.DescribeLoadBalancerPolicyTypesInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.describe_load_balancer_policy_types_output.DescribeLoadBalancerPolicyTypesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_load_balancer_policy_types.describe_load_balancer_policy_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_load_balancers(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.describe_access_points_input.DescribeAccessPointsInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.describe_access_points_output.DescribeAccessPointsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_load_balancers.describe_load_balancers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_elastic_load_balancing.types.load_balancer_description.LoadBalancerDescription]":
        _token = marker
        while True:
    ...
    def describe_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.describe_tags_input.DescribeTagsInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.describe_tags_output.DescribeTagsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.describe_tags.describe_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def detach_load_balancer_from_subnets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.detach_load_balancer_from_subnets_input.DetachLoadBalancerFromSubnetsInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.detach_load_balancer_from_subnets_output.DetachLoadBalancerFromSubnetsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.detach_load_balancer_from_subnets.detach_load_balancer_from_subnets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_availability_zones_for_load_balancer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.remove_availability_zones_input.RemoveAvailabilityZonesInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.remove_availability_zones_output.RemoveAvailabilityZonesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.disable_availability_zones_for_load_balancer.disable_availability_zones_for_load_balancer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_availability_zones_for_load_balancer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.add_availability_zones_input.AddAvailabilityZonesInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.add_availability_zones_output.AddAvailabilityZonesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.enable_availability_zones_for_load_balancer.enable_availability_zones_for_load_balancer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_load_balancer_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.modify_load_balancer_attributes_input.ModifyLoadBalancerAttributesInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.modify_load_balancer_attributes_output.ModifyLoadBalancerAttributesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.modify_load_balancer_attributes.modify_load_balancer_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_instances_with_load_balancer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.register_end_points_input.RegisterEndPointsInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.register_end_points_output.RegisterEndPointsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.register_instances_with_load_balancer.register_instances_with_load_balancer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.remove_tags_input.RemoveTagsInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.remove_tags_output.RemoveTagsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.remove_tags.remove_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_load_balancer_listener_ssl_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.set_load_balancer_listener_ssl_certificate_input.SetLoadBalancerListenerSSLCertificateInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.set_load_balancer_listener_ssl_certificate_output.SetLoadBalancerListenerSSLCertificateOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.set_load_balancer_listener_ssl_certificate.set_load_balancer_listener_ssl_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_load_balancer_policies_for_backend_server(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_for_backend_server_input.SetLoadBalancerPoliciesForBackendServerInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_for_backend_server_output.SetLoadBalancerPoliciesForBackendServerOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.set_load_balancer_policies_for_backend_server.set_load_balancer_policies_for_backend_server(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_load_balancer_policies_of_listener(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_of_listener_input.SetLoadBalancerPoliciesOfListenerInput]",
        ) -> OperationResponse[
            "aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_of_listener_output.SetLoadBalancerPoliciesOfListenerOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_elastic_load_balancing._operations.elastic_load_balancing_v7.set_load_balancer_policies_of_listener.set_load_balancer_policies_of_listener(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
