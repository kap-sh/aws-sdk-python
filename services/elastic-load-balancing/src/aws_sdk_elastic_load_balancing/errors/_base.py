...
class ElasticLoadBalancingError(Exception):
    """Base class for all ElasticLoadBalancing service errors."""


class ServiceError(ElasticLoadBalancingError):
...
class SerializationError(ElasticLoadBalancingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ElasticLoadBalancingError):
...
class WaiterFailedError(ElasticLoadBalancingError):
...
class WaiterTimeoutError(ElasticLoadBalancingError):
