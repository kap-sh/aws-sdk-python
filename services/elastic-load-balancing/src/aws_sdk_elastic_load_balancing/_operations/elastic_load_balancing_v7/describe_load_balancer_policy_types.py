"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DescribeLoadBalancerPolicyTypes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeLoadBalancerPolicyTypesResult")
    out: aws_sdk_elastic_load_balancing.types.describe_load_balancer_policy_types_output.DescribeLoadBalancerPolicyTypesOutput = aws_sdk_elastic_load_balancing.types.describe_load_balancer_policy_types_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.describe_load_balancer_policy_types_input.DescribeLoadBalancerPolicyTypesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.describe_load_balancer_policy_types_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_load_balancer_policy_types(
