"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DescribeTags``."""
...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.describe_tags_output.DescribeTagsOutput = aws_sdk_elastic_load_balancing.types.describe_tags_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.describe_tags_input.DescribeTagsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.describe_tags_input.serialize_query(
        input_, pairs, ""
    )
