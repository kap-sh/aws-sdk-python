...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.deregister_end_points_output.DeregisterEndPointsOutput = aws_sdk_elastic_load_balancing.types.deregister_end_points_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.deregister_end_points_input.DeregisterEndPointsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.deregister_end_points_input.serialize_query(
        input_, pairs, ""
    )
