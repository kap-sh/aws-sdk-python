"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#SetLoadBalancerPoliciesForBackendServer``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SetLoadBalancerPoliciesForBackendServerResult")
    out: aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_for_backend_server_output.SetLoadBalancerPoliciesForBackendServerOutput = aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_for_backend_server_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_for_backend_server_input.SetLoadBalancerPoliciesForBackendServerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_set_load_balancer_policies_for_backend_server(
