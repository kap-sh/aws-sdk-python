...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.detach_load_balancer_from_subnets_output.DetachLoadBalancerFromSubnetsOutput = aws_sdk_elastic_load_balancing.types.detach_load_balancer_from_subnets_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.detach_load_balancer_from_subnets_input.DetachLoadBalancerFromSubnetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.detach_load_balancer_from_subnets_input.serialize_query(
        input_, pairs, ""
    )
