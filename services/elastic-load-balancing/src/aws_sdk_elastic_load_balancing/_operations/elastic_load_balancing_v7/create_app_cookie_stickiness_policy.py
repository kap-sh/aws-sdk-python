"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#CreateAppCookieStickinessPolicy``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateAppCookieStickinessPolicyResult")
    out: aws_sdk_elastic_load_balancing.types.create_app_cookie_stickiness_policy_output.CreateAppCookieStickinessPolicyOutput = aws_sdk_elastic_load_balancing.types.create_app_cookie_stickiness_policy_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.create_app_cookie_stickiness_policy_input.CreateAppCookieStickinessPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_app_cookie_stickiness_policy(
