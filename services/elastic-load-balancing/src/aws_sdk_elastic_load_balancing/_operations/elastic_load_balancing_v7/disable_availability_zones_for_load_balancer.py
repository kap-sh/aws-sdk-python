"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DisableAvailabilityZonesForLoadBalancer``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DisableAvailabilityZonesForLoadBalancerResult")
    out: aws_sdk_elastic_load_balancing.types.remove_availability_zones_output.RemoveAvailabilityZonesOutput = aws_sdk_elastic_load_balancing.types.remove_availability_zones_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.remove_availability_zones_input.RemoveAvailabilityZonesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisableAvailabilityZonesForLoadBalancer"))
    pairs.append(("Version", "2012-06-01"))
    aws_sdk_elastic_load_balancing.types.remove_availability_zones_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_disable_availability_zones_for_load_balancer(
