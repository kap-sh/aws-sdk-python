"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#AddTags``."""
...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.add_tags_output.AddTagsOutput = (
        aws_sdk_elastic_load_balancing.types.add_tags_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.add_tags_input.AddTagsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.add_tags_input.serialize_query(
        input_, pairs, ""
    )
...
def add_tags(
    ...
    aws_sdk_elastic_load_balancing.types.add_tags_output.AddTagsOutput, zapros.Response
]:
