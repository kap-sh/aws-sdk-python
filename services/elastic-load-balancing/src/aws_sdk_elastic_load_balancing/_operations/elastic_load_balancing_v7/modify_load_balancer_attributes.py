...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.modify_load_balancer_attributes_output.ModifyLoadBalancerAttributesOutput = aws_sdk_elastic_load_balancing.types.modify_load_balancer_attributes_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.modify_load_balancer_attributes_input.ModifyLoadBalancerAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.modify_load_balancer_attributes_input.serialize_query(
        input_, pairs, ""
    )
