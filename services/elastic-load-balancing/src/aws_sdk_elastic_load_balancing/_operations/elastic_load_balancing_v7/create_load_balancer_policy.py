...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.create_load_balancer_policy_input.CreateLoadBalancerPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.create_load_balancer_policy_input.serialize_query(
        input_, pairs, ""
    )
