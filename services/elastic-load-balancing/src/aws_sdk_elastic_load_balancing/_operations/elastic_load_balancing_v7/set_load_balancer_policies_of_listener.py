"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#SetLoadBalancerPoliciesOfListener``."""
...
import aws_sdk_elastic_load_balancing.errors.listener_not_found_exception
import aws_sdk_elastic_load_balancing.errors.policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ListenerNotFoundException":
            raise aws_sdk_elastic_load_balancing.errors.listener_not_found_exception.ListenerNotFoundException.from_query(
                root
            )
        case "PolicyNotFoundException":
            raise aws_sdk_elastic_load_balancing.errors.policy_not_found_exception.PolicyNotFoundException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SetLoadBalancerPoliciesOfListenerResult")
    out: aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_of_listener_output.SetLoadBalancerPoliciesOfListenerOutput = aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_of_listener_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_of_listener_input.SetLoadBalancerPoliciesOfListenerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "SetLoadBalancerPoliciesOfListener"))
    pairs.append(("Version", "2012-06-01"))
    import aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_of_listener_input

    aws_sdk_elastic_load_balancing.types.set_load_balancer_policies_of_listener_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_set_load_balancer_policies_of_listener(
