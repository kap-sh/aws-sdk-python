...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.configure_health_check_output.ConfigureHealthCheckOutput = aws_sdk_elastic_load_balancing.types.configure_health_check_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.configure_health_check_input.ConfigureHealthCheckInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
