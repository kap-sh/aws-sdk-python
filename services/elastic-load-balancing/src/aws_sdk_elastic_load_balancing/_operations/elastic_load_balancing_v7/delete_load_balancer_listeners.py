...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.delete_load_balancer_listener_output.DeleteLoadBalancerListenerOutput = aws_sdk_elastic_load_balancing.types.delete_load_balancer_listener_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.delete_load_balancer_listener_input.DeleteLoadBalancerListenerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.delete_load_balancer_listener_input.serialize_query(
        input_, pairs, ""
    )
