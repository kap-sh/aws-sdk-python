"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DescribeLoadBalancerPolicies``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeLoadBalancerPoliciesResult")
    out: aws_sdk_elastic_load_balancing.types.describe_load_balancer_policies_output.DescribeLoadBalancerPoliciesOutput = aws_sdk_elastic_load_balancing.types.describe_load_balancer_policies_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.describe_load_balancer_policies_input.DescribeLoadBalancerPoliciesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_load_balancer_policies(
