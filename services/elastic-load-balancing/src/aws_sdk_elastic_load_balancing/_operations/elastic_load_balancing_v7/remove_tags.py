...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.remove_tags_output.RemoveTagsOutput = (
        aws_sdk_elastic_load_balancing.types.remove_tags_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.remove_tags_input.RemoveTagsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.remove_tags_input.serialize_query(
        input_, pairs, ""
    )
