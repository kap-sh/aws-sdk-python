"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DescribeLoadBalancers``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DependencyThrottleException":
            import aws_sdk_elastic_load_balancing.errors.dependency_throttle_exception

            raise aws_sdk_elastic_load_balancing.errors.dependency_throttle_exception.DependencyThrottleException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.describe_access_points_output.DescribeAccessPointsOutput = aws_sdk_elastic_load_balancing.types.describe_access_points_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.describe_access_points_input.DescribeAccessPointsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.describe_access_points_input.serialize_query(
        input_, pairs, ""
    )
