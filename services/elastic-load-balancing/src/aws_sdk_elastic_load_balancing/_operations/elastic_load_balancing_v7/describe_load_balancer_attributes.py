"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DescribeLoadBalancerAttributes``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LoadBalancerAttributeNotFoundException":
            import aws_sdk_elastic_load_balancing.errors.load_balancer_attribute_not_found_exception

            raise aws_sdk_elastic_load_balancing.errors.load_balancer_attribute_not_found_exception.LoadBalancerAttributeNotFoundException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeLoadBalancerAttributesResult")
    out: aws_sdk_elastic_load_balancing.types.describe_load_balancer_attributes_output.DescribeLoadBalancerAttributesOutput = aws_sdk_elastic_load_balancing.types.describe_load_balancer_attributes_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.describe_load_balancer_attributes_input.DescribeLoadBalancerAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeLoadBalancerAttributes"))
    pairs.append(("Version", "2012-06-01"))
    import aws_sdk_elastic_load_balancing.types.describe_load_balancer_attributes_input

    aws_sdk_elastic_load_balancing.types.describe_load_balancer_attributes_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_load_balancer_attributes(
