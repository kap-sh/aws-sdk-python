"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#RegisterInstancesWithLoadBalancer``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RegisterInstancesWithLoadBalancerResult")
    out: aws_sdk_elastic_load_balancing.types.register_end_points_output.RegisterEndPointsOutput = aws_sdk_elastic_load_balancing.types.register_end_points_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.register_end_points_input.RegisterEndPointsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RegisterInstancesWithLoadBalancer"))
    pairs.append(("Version", "2012-06-01"))
    aws_sdk_elastic_load_balancing.types.register_end_points_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_register_instances_with_load_balancer(
