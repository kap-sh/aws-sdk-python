...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.delete_load_balancer_policy_output.DeleteLoadBalancerPolicyOutput = aws_sdk_elastic_load_balancing.types.delete_load_balancer_policy_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.delete_load_balancer_policy_input.DeleteLoadBalancerPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.delete_load_balancer_policy_input.serialize_query(
        input_, pairs, ""
    )
