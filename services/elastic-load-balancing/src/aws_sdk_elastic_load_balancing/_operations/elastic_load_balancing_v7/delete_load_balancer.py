"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DeleteLoadBalancer``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteLoadBalancerResult")
    out: aws_sdk_elastic_load_balancing.types.delete_access_point_output.DeleteAccessPointOutput = aws_sdk_elastic_load_balancing.types.delete_access_point_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.delete_access_point_input.DeleteAccessPointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteLoadBalancer"))
    pairs.append(("Version", "2012-06-01"))
    import aws_sdk_elastic_load_balancing.types.delete_access_point_input

    aws_sdk_elastic_load_balancing.types.delete_access_point_input.serialize_query(
        input_, pairs, ""
    )
