...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.attach_load_balancer_to_subnets_output.AttachLoadBalancerToSubnetsOutput = aws_sdk_elastic_load_balancing.types.attach_load_balancer_to_subnets_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.attach_load_balancer_to_subnets_input.AttachLoadBalancerToSubnetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
