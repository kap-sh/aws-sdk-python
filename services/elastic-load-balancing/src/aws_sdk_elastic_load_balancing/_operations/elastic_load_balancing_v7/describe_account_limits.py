"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#DescribeAccountLimits``."""
...
import aws_sdk_elastic_load_balancing.types.limits
...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.describe_account_limits_output.DescribeAccountLimitsOutput = aws_sdk_elastic_load_balancing.types.describe_account_limits_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.describe_account_limits_input.DescribeAccountLimitsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.describe_account_limits_input.serialize_query(
        input_, pairs, ""
    )
