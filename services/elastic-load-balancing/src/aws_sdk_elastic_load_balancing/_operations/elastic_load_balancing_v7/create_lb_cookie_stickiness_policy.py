"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancing#CreateLBCookieStickinessPolicy``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateLBCookieStickinessPolicyResult")
    out: aws_sdk_elastic_load_balancing.types.create_lb_cookie_stickiness_policy_output.CreateLBCookieStickinessPolicyOutput = aws_sdk_elastic_load_balancing.types.create_lb_cookie_stickiness_policy_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.create_lb_cookie_stickiness_policy_input.CreateLBCookieStickinessPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateLBCookieStickinessPolicy"))
    pairs.append(("Version", "2012-06-01"))
    import aws_sdk_elastic_load_balancing.types.create_lb_cookie_stickiness_policy_input

    aws_sdk_elastic_load_balancing.types.create_lb_cookie_stickiness_policy_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_lb_cookie_stickiness_policy(
