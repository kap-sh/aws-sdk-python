...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing.types.set_load_balancer_listener_ssl_certificate_output.SetLoadBalancerListenerSSLCertificateOutput = aws_sdk_elastic_load_balancing.types.set_load_balancer_listener_ssl_certificate_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing.types.set_load_balancer_listener_ssl_certificate_input.SetLoadBalancerListenerSSLCertificateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing.types.set_load_balancer_listener_ssl_certificate_input.serialize_query(
        input_, pairs, ""
    )
