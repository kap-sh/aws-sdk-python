...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing.types.connection_draining_enabled
    import aws_sdk_elastic_load_balancing.types.connection_draining_timeout


class ConnectionDraining(TypedDict):
    enabled: "aws_sdk_elastic_load_balancing.types.connection_draining_enabled.ConnectionDrainingEnabled"
    """<p>Specifies whether connection draining is enabled for the load balancer.</p>"""
    timeout: NotRequired[
        "aws_sdk_elastic_load_balancing.types.connection_draining_timeout.ConnectionDrainingTimeout"
    ]
