...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing.types.app_cookie_stickiness_policies
    import aws_sdk_elastic_load_balancing.types.lb_cookie_stickiness_policies
...
class Policies(TypedDict, closed=True):
    app_cookie_stickiness_policies: NotRequired[
        "aws_sdk_elastic_load_balancing.types.app_cookie_stickiness_policies.AppCookieStickinessPolicies"
    ]
    """<p>The stickiness policies created using <a>CreateAppCookieStickinessPolicy</a>.</p>"""
    lb_cookie_stickiness_policies: NotRequired[
        "aws_sdk_elastic_load_balancing.types.lb_cookie_stickiness_policies.LBCookieStickinessPolicies"
    ]
...
def serialize_query(value: Policies, pairs: list[tuple[str, str]], prefix: str) -> None:
    if "app_cookie_stickiness_policies" in value:
        ...
        aws_sdk_elastic_load_balancing.types.app_cookie_stickiness_policies.serialize_query(
    ...
    if "lb_cookie_stickiness_policies" in value:
        ...
        aws_sdk_elastic_load_balancing.types.lb_cookie_stickiness_policies.serialize_query(
...
def deserialize_query(el: Element) -> Policies:
    ...
    if child_app_cookie_stickiness_policies is not None:
        ...
        out["app_cookie_stickiness_policies"] = (
            aws_sdk_elastic_load_balancing.types.app_cookie_stickiness_policies.deserialize_query(
    ...
    if child_lb_cookie_stickiness_policies is not None:
        ...
        out["lb_cookie_stickiness_policies"] = (
            aws_sdk_elastic_load_balancing.types.lb_cookie_stickiness_policies.deserialize_query(
