...
if TYPE_CHECKING:
    ...
    import aws_sdk_elastic_load_balancing.types.instance_id
    import aws_sdk_elastic_load_balancing.types.reason_code
    import aws_sdk_elastic_load_balancing.types.state


class InstanceState(TypedDict):
    instance_id: NotRequired[
        "aws_sdk_elastic_load_balancing.types.instance_id.InstanceId"
    ]
    """<p>The ID of the instance.</p>"""
    state: NotRequired["aws_sdk_elastic_load_balancing.types.state.State"]
    ...
    reason_code: NotRequired[
        "aws_sdk_elastic_load_balancing.types.reason_code.ReasonCode"
    ]
