...
if TYPE_CHECKING:
    ...
    import aws_sdk_elastic_load_balancing.types.policy_attribute_type_descriptions
    import aws_sdk_elastic_load_balancing.types.policy_type_name


class PolicyTypeDescription(TypedDict):
    ...
    policy_attribute_type_descriptions: NotRequired[
        "aws_sdk_elastic_load_balancing.types.policy_attribute_type_descriptions.PolicyAttributeTypeDescriptions"
    ]
...
def serialize_query(
    ...
    if "policy_attribute_type_descriptions" in value:
        ...
        aws_sdk_elastic_load_balancing.types.policy_attribute_type_descriptions.serialize_query(
...
def deserialize_query(el: Element) -> PolicyTypeDescription:
    ...
    if child_policy_attribute_type_descriptions is not None:
        ...
        out["policy_attribute_type_descriptions"] = (
            aws_sdk_elastic_load_balancing.types.policy_attribute_type_descriptions.deserialize_query(
