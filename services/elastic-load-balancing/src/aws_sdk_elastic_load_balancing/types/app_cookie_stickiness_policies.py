...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing.types.app_cookie_stickiness_policy

AppCookieStickinessPolicies: TypeAlias = list[
    "aws_sdk_elastic_load_balancing.types.app_cookie_stickiness_policy.AppCookieStickinessPolicy"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing.types.app_cookie_stickiness_policy.serialize_query(
...
def deserialize_query(el: Element) -> AppCookieStickinessPolicies:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing.types.app_cookie_stickiness_policy.deserialize_query(
                child
            )
        )
    return out
