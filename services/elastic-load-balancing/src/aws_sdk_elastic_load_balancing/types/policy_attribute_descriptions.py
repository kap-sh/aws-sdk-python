...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing.types.policy_attribute_description

PolicyAttributeDescriptions: TypeAlias = list[
    "aws_sdk_elastic_load_balancing.types.policy_attribute_description.PolicyAttributeDescription"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing.types.policy_attribute_description.serialize_query(
...
def deserialize_query(el: Element) -> PolicyAttributeDescriptions:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing.types.policy_attribute_description.deserialize_query(
                child
            )
        )
    return out
