...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing.types.health_check_interval
    import aws_sdk_elastic_load_balancing.types.health_check_target
    import aws_sdk_elastic_load_balancing.types.health_check_timeout
    import aws_sdk_elastic_load_balancing.types.healthy_threshold
    import aws_sdk_elastic_load_balancing.types.unhealthy_threshold


class HealthCheck(TypedDict):
    target: "aws_sdk_elastic_load_balancing.types.health_check_target.HealthCheckTarget"
    ...
    interval: (
        "aws_sdk_elastic_load_balancing.types.health_check_interval.HealthCheckInterval"
    )
    """<p>The approximate interval, in seconds, between health checks of an individual instance.</p>"""
    timeout: (
        "aws_sdk_elastic_load_balancing.types.health_check_timeout.HealthCheckTimeout"
    )
    ...
    unhealthy_threshold: (
        "aws_sdk_elastic_load_balancing.types.unhealthy_threshold.UnhealthyThreshold"
    )
    """<p>The number of consecutive health check failures required before moving the instance to the <code>Unhealthy</code> state.</p>"""
    healthy_threshold: (
        "aws_sdk_elastic_load_balancing.types.healthy_threshold.HealthyThreshold"
    )
