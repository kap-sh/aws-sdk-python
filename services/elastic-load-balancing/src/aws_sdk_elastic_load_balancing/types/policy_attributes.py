...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing.types.policy_attribute

PolicyAttributes: TypeAlias = list[
    "aws_sdk_elastic_load_balancing.types.policy_attribute.PolicyAttribute"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing.types.policy_attribute.serialize_query(
...
def deserialize_query(el: Element) -> PolicyAttributes:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing.types.policy_attribute.deserialize_query(
                child
            )
        )
    return out
