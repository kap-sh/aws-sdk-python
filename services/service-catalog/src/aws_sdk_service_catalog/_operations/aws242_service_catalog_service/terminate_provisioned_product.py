"""Generated from Smithy shape ``com.amazonaws.servicecatalog#TerminateProvisionedProduct``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.terminate_provisioned_product_output.TerminateProvisionedProductOutput = aws_sdk_service_catalog.types.terminate_provisioned_product_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.terminate_provisioned_product_input.TerminateProvisionedProductInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWS242ServiceCatalogService.TerminateProvisionedProduct"
    import aws_sdk_service_catalog.types.terminate_provisioned_product_input

    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.terminate_provisioned_product_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_terminate_provisioned_product(
