"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DescribeConstraint``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.describe_constraint_output.DescribeConstraintOutput = aws_sdk_service_catalog.types.describe_constraint_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.describe_constraint_input.DescribeConstraintInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.describe_constraint_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_constraint(
