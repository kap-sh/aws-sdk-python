"""Generated from Smithy shape ``com.amazonaws.servicecatalog#ListProvisioningArtifacts``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.list_provisioning_artifacts_output.ListProvisioningArtifactsOutput = aws_sdk_service_catalog.types.list_provisioning_artifacts_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.list_provisioning_artifacts_input.ListProvisioningArtifactsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWS242ServiceCatalogService.ListProvisioningArtifacts"
    import aws_sdk_service_catalog.types.list_provisioning_artifacts_input

    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.list_provisioning_artifacts_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_provisioning_artifacts(
