...
def build_request(
    ...
    input: aws_sdk_service_catalog.types.notify_update_provisioned_product_engine_workflow_result_input.NotifyUpdateProvisionedProductEngineWorkflowResultInput,
) -> zapros.Request:
