...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.notify_update_provisioned_product_engine_workflow_result_output.NotifyUpdateProvisionedProductEngineWorkflowResultOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.notify_update_provisioned_product_engine_workflow_result_input.NotifyUpdateProvisionedProductEngineWorkflowResultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.notify_update_provisioned_product_engine_workflow_result_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
