"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DescribePortfolioShareStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.describe_portfolio_share_status_output.DescribePortfolioShareStatusOutput = aws_sdk_service_catalog.types.describe_portfolio_share_status_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.describe_portfolio_share_status_input.DescribePortfolioShareStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWS242ServiceCatalogService.DescribePortfolioShareStatus"
    import aws_sdk_service_catalog.types.describe_portfolio_share_status_input

    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.describe_portfolio_share_status_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_portfolio_share_status(
