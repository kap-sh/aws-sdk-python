"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DisassociateBudgetFromResource``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.disassociate_budget_from_resource_output.DisassociateBudgetFromResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.disassociate_budget_from_resource_input.DisassociateBudgetFromResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_budget_from_resource(
