"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DisassociatePrincipalFromPortfolio``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.disassociate_principal_from_portfolio_output.DisassociatePrincipalFromPortfolioOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.disassociate_principal_from_portfolio_input.DisassociatePrincipalFromPortfolioInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_principal_from_portfolio(
