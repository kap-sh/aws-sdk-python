...
import aws_sdk_service_catalog.types.provisioned_product_attributes
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.search_provisioned_products_output.SearchProvisionedProductsOutput = aws_sdk_service_catalog.types.search_provisioned_products_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.search_provisioned_products_input.SearchProvisionedProductsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.search_provisioned_products_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
