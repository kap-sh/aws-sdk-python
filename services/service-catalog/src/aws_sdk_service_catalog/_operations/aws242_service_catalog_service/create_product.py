...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.create_product_output.CreateProductOutput = (
        aws_sdk_service_catalog.types.create_product_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_service_catalog.types.create_product_input.CreateProductInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.create_product_input.serialize_aws_json_1_1(input)
    ).encode()
