...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.create_service_action_output.CreateServiceActionOutput = aws_sdk_service_catalog.types.create_service_action_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.create_service_action_input.CreateServiceActionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.create_service_action_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
