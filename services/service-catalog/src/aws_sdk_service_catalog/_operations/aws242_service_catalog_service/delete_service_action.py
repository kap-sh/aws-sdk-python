...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.delete_service_action_input.DeleteServiceActionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.delete_service_action_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
