...
import aws_sdk_service_catalog.types.provisioning_artifact_views
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.list_provisioning_artifacts_for_service_action_output.ListProvisioningArtifactsForServiceActionOutput = aws_sdk_service_catalog.types.list_provisioning_artifacts_for_service_action_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.list_provisioning_artifacts_for_service_action_input.ListProvisioningArtifactsForServiceActionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.list_provisioning_artifacts_for_service_action_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
