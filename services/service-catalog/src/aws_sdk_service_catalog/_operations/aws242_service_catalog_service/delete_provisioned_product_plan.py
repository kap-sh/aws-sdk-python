...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.delete_provisioned_product_plan_output.DeleteProvisionedProductPlanOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.delete_provisioned_product_plan_input.DeleteProvisionedProductPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.delete_provisioned_product_plan_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
