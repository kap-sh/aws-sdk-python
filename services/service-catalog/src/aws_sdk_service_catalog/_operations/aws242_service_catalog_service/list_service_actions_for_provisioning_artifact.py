...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.list_service_actions_for_provisioning_artifact_output.ListServiceActionsForProvisioningArtifactOutput = aws_sdk_service_catalog.types.list_service_actions_for_provisioning_artifact_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.list_service_actions_for_provisioning_artifact_input.ListServiceActionsForProvisioningArtifactInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
