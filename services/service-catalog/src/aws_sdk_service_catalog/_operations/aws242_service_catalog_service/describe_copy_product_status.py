...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.describe_copy_product_status_output.DescribeCopyProductStatusOutput = aws_sdk_service_catalog.types.describe_copy_product_status_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.describe_copy_product_status_input.DescribeCopyProductStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
