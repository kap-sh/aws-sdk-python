...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.list_launch_paths_output.ListLaunchPathsOutput = aws_sdk_service_catalog.types.list_launch_paths_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.list_launch_paths_input.ListLaunchPathsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.list_launch_paths_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
