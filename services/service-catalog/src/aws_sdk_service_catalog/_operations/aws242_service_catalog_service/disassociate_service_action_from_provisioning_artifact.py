...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.disassociate_service_action_from_provisioning_artifact_output.DisassociateServiceActionFromProvisioningArtifactOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.disassociate_service_action_from_provisioning_artifact_input.DisassociateServiceActionFromProvisioningArtifactInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
