...
def build_request(
    ...
    input: aws_sdk_service_catalog.types.disassociate_service_action_from_provisioning_artifact_input.DisassociateServiceActionFromProvisioningArtifactInput,
) -> zapros.Request:
