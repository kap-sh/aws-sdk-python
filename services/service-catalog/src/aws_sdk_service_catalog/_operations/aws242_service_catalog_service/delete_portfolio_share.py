...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.delete_portfolio_share_output.DeletePortfolioShareOutput = aws_sdk_service_catalog.types.delete_portfolio_share_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.delete_portfolio_share_input.DeletePortfolioShareInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.delete_portfolio_share_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
