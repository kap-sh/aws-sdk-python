...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.list_provisioned_product_plans_output.ListProvisionedProductPlansOutput = aws_sdk_service_catalog.types.list_provisioned_product_plans_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.list_provisioned_product_plans_input.ListProvisionedProductPlansInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.list_provisioned_product_plans_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
