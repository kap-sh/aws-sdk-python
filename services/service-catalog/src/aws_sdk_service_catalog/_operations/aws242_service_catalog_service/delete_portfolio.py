"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DeletePortfolio``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.delete_portfolio_output.DeletePortfolioOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.delete_portfolio_input.DeletePortfolioInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_portfolio(
