"""Generated from Smithy shape ``com.amazonaws.servicecatalog#GetAWSOrganizationsAccessStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.get_aws_organizations_access_status_output.GetAWSOrganizationsAccessStatusOutput = aws_sdk_service_catalog.types.get_aws_organizations_access_status_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.get_aws_organizations_access_status_input.GetAWSOrganizationsAccessStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_aws_organizations_access_status(
