"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DescribeRecord``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.describe_record_output.DescribeRecordOutput = (
        aws_sdk_service_catalog.types.describe_record_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.describe_record_input.DescribeRecordInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.describe_record_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_record(
