...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.delete_provisioning_artifact_output.DeleteProvisioningArtifactOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.delete_provisioning_artifact_input.DeleteProvisioningArtifactInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.delete_provisioning_artifact_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
