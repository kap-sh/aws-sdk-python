...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.disable_aws_organizations_access_output.DisableAWSOrganizationsAccessOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.disable_aws_organizations_access_input.DisableAWSOrganizationsAccessInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
