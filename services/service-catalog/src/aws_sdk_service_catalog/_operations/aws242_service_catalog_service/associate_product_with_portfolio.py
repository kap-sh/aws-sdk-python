"""Generated from Smithy shape ``com.amazonaws.servicecatalog#AssociateProductWithPortfolio``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.associate_product_with_portfolio_output.AssociateProductWithPortfolioOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.associate_product_with_portfolio_input.AssociateProductWithPortfolioInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.associate_product_with_portfolio_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_product_with_portfolio(
