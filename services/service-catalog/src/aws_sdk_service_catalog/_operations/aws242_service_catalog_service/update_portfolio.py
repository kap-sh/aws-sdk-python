...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.update_portfolio_output.UpdatePortfolioOutput = (
        aws_sdk_service_catalog.types.update_portfolio_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.update_portfolio_input.UpdatePortfolioInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.update_portfolio_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
