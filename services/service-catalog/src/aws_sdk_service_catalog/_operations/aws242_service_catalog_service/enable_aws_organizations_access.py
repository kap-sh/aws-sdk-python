...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.enable_aws_organizations_access_output.EnableAWSOrganizationsAccessOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.enable_aws_organizations_access_input.EnableAWSOrganizationsAccessInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
