"""Generated from Smithy shape ``com.amazonaws.servicecatalog#BatchAssociateServiceActionWithProvisioningArtifact``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.batch_associate_service_action_with_provisioning_artifact_output.BatchAssociateServiceActionWithProvisioningArtifactOutput = aws_sdk_service_catalog.types.batch_associate_service_action_with_provisioning_artifact_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.batch_associate_service_action_with_provisioning_artifact_input.BatchAssociateServiceActionWithProvisioningArtifactInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.batch_associate_service_action_with_provisioning_artifact_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_associate_service_action_with_provisioning_artifact(
