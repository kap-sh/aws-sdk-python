...
def build_request(
    ...
    input: aws_sdk_service_catalog.types.batch_associate_service_action_with_provisioning_artifact_input.BatchAssociateServiceActionWithProvisioningArtifactInput,
) -> zapros.Request:
