...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.create_provisioning_artifact_output.CreateProvisioningArtifactOutput = aws_sdk_service_catalog.types.create_provisioning_artifact_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.create_provisioning_artifact_input.CreateProvisioningArtifactInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.create_provisioning_artifact_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
