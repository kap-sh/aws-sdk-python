...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.describe_product_as_admin_output.DescribeProductAsAdminOutput = aws_sdk_service_catalog.types.describe_product_as_admin_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.describe_product_as_admin_input.DescribeProductAsAdminInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.describe_product_as_admin_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
