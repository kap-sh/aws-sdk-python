"""Generated from Smithy shape ``com.amazonaws.servicecatalog#ListPortfoliosForProduct``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.list_portfolios_for_product_output.ListPortfoliosForProductOutput = aws_sdk_service_catalog.types.list_portfolios_for_product_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.list_portfolios_for_product_input.ListPortfoliosForProductInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWS242ServiceCatalogService.ListPortfoliosForProduct"
    import aws_sdk_service_catalog.types.list_portfolios_for_product_input

    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.list_portfolios_for_product_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_portfolios_for_product(
