...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.list_tag_options_output.ListTagOptionsOutput = (
        aws_sdk_service_catalog.types.list_tag_options_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.list_tag_options_input.ListTagOptionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.list_tag_options_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
