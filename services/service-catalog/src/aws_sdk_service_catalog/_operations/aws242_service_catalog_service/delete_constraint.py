...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.delete_constraint_output.DeleteConstraintOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.delete_constraint_input.DeleteConstraintInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.delete_constraint_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
