...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.notify_provision_product_engine_workflow_result_output.NotifyProvisionProductEngineWorkflowResultOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.notify_provision_product_engine_workflow_result_input.NotifyProvisionProductEngineWorkflowResultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
