"""Generated from Smithy shape ``com.amazonaws.servicecatalog#CreateConstraint``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.create_constraint_output.CreateConstraintOutput = aws_sdk_service_catalog.types.create_constraint_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.create_constraint_input.CreateConstraintInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.create_constraint_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_constraint(
