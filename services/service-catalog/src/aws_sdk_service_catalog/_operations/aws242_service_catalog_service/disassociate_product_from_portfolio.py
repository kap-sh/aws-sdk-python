"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DisassociateProductFromPortfolio``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.disassociate_product_from_portfolio_output.DisassociateProductFromPortfolioOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.disassociate_product_from_portfolio_input.DisassociateProductFromPortfolioInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.disassociate_product_from_portfolio_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_product_from_portfolio(
