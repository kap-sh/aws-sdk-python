...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.associate_tag_option_with_resource_output.AssociateTagOptionWithResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.associate_tag_option_with_resource_input.AssociateTagOptionWithResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.associate_tag_option_with_resource_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
