...
def build_request(
    ...
    input: aws_sdk_service_catalog.types.batch_disassociate_service_action_from_provisioning_artifact_input.BatchDisassociateServiceActionFromProvisioningArtifactInput,
) -> zapros.Request:
