"""Generated from Smithy shape ``com.amazonaws.servicecatalog#BatchDisassociateServiceActionFromProvisioningArtifact``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.batch_disassociate_service_action_from_provisioning_artifact_output.BatchDisassociateServiceActionFromProvisioningArtifactOutput = aws_sdk_service_catalog.types.batch_disassociate_service_action_from_provisioning_artifact_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.batch_disassociate_service_action_from_provisioning_artifact_input.BatchDisassociateServiceActionFromProvisioningArtifactInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.batch_disassociate_service_action_from_provisioning_artifact_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_disassociate_service_action_from_provisioning_artifact(
