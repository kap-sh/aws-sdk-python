"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DeleteProduct``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.delete_product_output.DeleteProductOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_service_catalog.types.delete_product_input.DeleteProductInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.delete_product_input.serialize_aws_json_1_1(input)
    ).encode()
