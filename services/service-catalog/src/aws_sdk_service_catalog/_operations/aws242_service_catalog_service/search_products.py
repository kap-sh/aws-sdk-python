...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.search_products_output.SearchProductsOutput = (
        aws_sdk_service_catalog.types.search_products_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.search_products_input.SearchProductsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.search_products_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
