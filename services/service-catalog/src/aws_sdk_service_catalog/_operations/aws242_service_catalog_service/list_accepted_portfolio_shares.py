...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.list_accepted_portfolio_shares_output.ListAcceptedPortfolioSharesOutput = aws_sdk_service_catalog.types.list_accepted_portfolio_shares_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.list_accepted_portfolio_shares_input.ListAcceptedPortfolioSharesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.list_accepted_portfolio_shares_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
