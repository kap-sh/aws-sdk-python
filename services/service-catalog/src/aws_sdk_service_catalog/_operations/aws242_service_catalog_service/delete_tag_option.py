...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.delete_tag_option_output.DeleteTagOptionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.delete_tag_option_input.DeleteTagOptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
