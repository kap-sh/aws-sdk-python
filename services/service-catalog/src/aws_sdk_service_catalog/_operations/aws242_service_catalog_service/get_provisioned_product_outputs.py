...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.get_provisioned_product_outputs_output.GetProvisionedProductOutputsOutput = aws_sdk_service_catalog.types.get_provisioned_product_outputs_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.get_provisioned_product_outputs_input.GetProvisionedProductOutputsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
