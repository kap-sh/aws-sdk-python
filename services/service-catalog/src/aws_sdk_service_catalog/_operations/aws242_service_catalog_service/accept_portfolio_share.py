"""Generated from Smithy shape ``com.amazonaws.servicecatalog#AcceptPortfolioShare``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.accept_portfolio_share_output.AcceptPortfolioShareOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.accept_portfolio_share_input.AcceptPortfolioShareInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.accept_portfolio_share_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_accept_portfolio_share(
