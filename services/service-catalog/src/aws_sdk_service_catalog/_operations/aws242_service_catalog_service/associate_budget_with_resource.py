...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.associate_budget_with_resource_output.AssociateBudgetWithResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.associate_budget_with_resource_input.AssociateBudgetWithResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.associate_budget_with_resource_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
