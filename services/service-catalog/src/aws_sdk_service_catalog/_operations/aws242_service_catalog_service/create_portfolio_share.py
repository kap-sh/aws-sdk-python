"""Generated from Smithy shape ``com.amazonaws.servicecatalog#CreatePortfolioShare``."""
...
import aws_sdk_service_catalog.errors.limit_exceeded_exception
import aws_sdk_service_catalog.errors.operation_not_supported_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise aws_sdk_service_catalog.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
        case "OperationNotSupportedException":
            raise aws_sdk_service_catalog.errors.operation_not_supported_exception.OperationNotSupportedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.create_portfolio_share_output.CreatePortfolioShareOutput = aws_sdk_service_catalog.types.create_portfolio_share_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.create_portfolio_share_input.CreatePortfolioShareInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.create_portfolio_share_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_portfolio_share(
