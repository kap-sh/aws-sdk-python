"""Generated from Smithy shape ``com.amazonaws.servicecatalog#CreateProvisionedProductPlan``."""
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.create_provisioned_product_plan_input.CreateProvisionedProductPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWS242ServiceCatalogService.CreateProvisionedProductPlan"
    import aws_sdk_service_catalog.types.create_provisioned_product_plan_input

    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.create_provisioned_product_plan_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_provisioned_product_plan(
