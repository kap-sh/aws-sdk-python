...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.describe_provisioned_product_plan_output.DescribeProvisionedProductPlanOutput = aws_sdk_service_catalog.types.describe_provisioned_product_plan_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.describe_provisioned_product_plan_input.DescribeProvisionedProductPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
