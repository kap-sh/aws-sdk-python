"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DescribeProvisioningParameters``."""
...
import aws_sdk_service_catalog.types.provisioning_artifact_outputs
import aws_sdk_service_catalog.types.provisioning_artifact_parameters
import aws_sdk_service_catalog.types.provisioning_artifact_preferences
import aws_sdk_service_catalog.types.tag_option_summaries
import aws_sdk_service_catalog.types.usage_instructions
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.describe_provisioning_parameters_output.DescribeProvisioningParametersOutput = aws_sdk_service_catalog.types.describe_provisioning_parameters_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.describe_provisioning_parameters_input.DescribeProvisioningParametersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.describe_provisioning_parameters_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_provisioning_parameters(
