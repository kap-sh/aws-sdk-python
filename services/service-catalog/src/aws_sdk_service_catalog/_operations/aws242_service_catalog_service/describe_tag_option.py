...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.describe_tag_option_output.DescribeTagOptionOutput = aws_sdk_service_catalog.types.describe_tag_option_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.describe_tag_option_input.DescribeTagOptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
