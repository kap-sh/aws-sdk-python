"""Generated from Smithy shape ``com.amazonaws.servicecatalog#ListConstraintsForPortfolio``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.list_constraints_for_portfolio_output.ListConstraintsForPortfolioOutput = aws_sdk_service_catalog.types.list_constraints_for_portfolio_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.list_constraints_for_portfolio_input.ListConstraintsForPortfolioInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWS242ServiceCatalogService.ListConstraintsForPortfolio"
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.list_constraints_for_portfolio_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_constraints_for_portfolio(
