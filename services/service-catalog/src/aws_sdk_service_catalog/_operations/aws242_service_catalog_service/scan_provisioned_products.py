...
import aws_sdk_service_catalog.types.provisioned_product_details
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.scan_provisioned_products_output.ScanProvisionedProductsOutput = aws_sdk_service_catalog.types.scan_provisioned_products_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.scan_provisioned_products_input.ScanProvisionedProductsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.scan_provisioned_products_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
