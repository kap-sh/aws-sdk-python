...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.update_provisioned_product_properties_output.UpdateProvisionedProductPropertiesOutput = aws_sdk_service_catalog.types.update_provisioned_product_properties_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.update_provisioned_product_properties_input.UpdateProvisionedProductPropertiesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
