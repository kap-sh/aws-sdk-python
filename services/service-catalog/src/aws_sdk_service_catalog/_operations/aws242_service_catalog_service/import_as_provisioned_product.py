"""Generated from Smithy shape ``com.amazonaws.servicecatalog#ImportAsProvisionedProduct``."""
...
import aws_sdk_service_catalog.errors.duplicate_resource_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DuplicateResourceException":
            raise aws_sdk_service_catalog.errors.duplicate_resource_exception.DuplicateResourceException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.import_as_provisioned_product_output.ImportAsProvisionedProductOutput = aws_sdk_service_catalog.types.import_as_provisioned_product_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.import_as_provisioned_product_input.ImportAsProvisionedProductInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWS242ServiceCatalogService.ImportAsProvisionedProduct"
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.import_as_provisioned_product_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_import_as_provisioned_product(
