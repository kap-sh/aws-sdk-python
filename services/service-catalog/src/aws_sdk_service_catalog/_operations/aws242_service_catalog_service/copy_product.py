...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.copy_product_output.CopyProductOutput = (
        aws_sdk_service_catalog.types.copy_product_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.copy_product_input.CopyProductInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.copy_product_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def copy_product(
    ...
    aws_sdk_service_catalog.types.copy_product_output.CopyProductOutput, zapros.Response
]:
