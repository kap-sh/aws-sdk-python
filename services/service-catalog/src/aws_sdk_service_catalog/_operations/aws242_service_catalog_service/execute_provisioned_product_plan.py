...
def handle_response(
    ...
    out: aws_sdk_service_catalog.types.execute_provisioned_product_plan_output.ExecuteProvisionedProductPlanOutput = aws_sdk_service_catalog.types.execute_provisioned_product_plan_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog.types.execute_provisioned_product_plan_input.ExecuteProvisionedProductPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog.types.execute_provisioned_product_plan_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
