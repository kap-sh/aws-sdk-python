...
if TYPE_CHECKING:
    ...
    import aws_sdk_service_catalog.types.last_successful_sync_time
    import aws_sdk_service_catalog.types.last_sync_status
    import aws_sdk_service_catalog.types.last_sync_status_message
...
class LastSync(TypedDict):
    ...
    last_sync_status: NotRequired[
        "aws_sdk_service_catalog.types.last_sync_status.LastSyncStatus"
    ]
    ...
    last_sync_status_message: NotRequired[
        "aws_sdk_service_catalog.types.last_sync_status_message.LastSyncStatusMessage"
    ]
    """<p>The sync's status message. </p>"""
    last_successful_sync_time: NotRequired[
        "aws_sdk_service_catalog.types.last_successful_sync_time.LastSuccessfulSyncTime"
    ]
...
def serialize_aws_json_1_1(value: LastSync) -> dict:
    ...
    if "last_sync_time" in value:
        ...
        out["LastSyncTime"] = (
            aws_sdk_service_catalog.types.last_sync_time.serialize_aws_json_1_1(
    ...
    if "last_sync_status" in value:
        ...
        out["LastSyncStatus"] = (
            aws_sdk_service_catalog.types.last_sync_status.serialize_aws_json_1_1(
    ...
    if "last_successful_sync_time" in value:
        ...
        out["LastSuccessfulSyncTime"] = (
            aws_sdk_service_catalog.types.last_successful_sync_time.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LastSync:
    ...
    if "LastSyncTime" in data:
        ...
        out["last_sync_time"] = (
            aws_sdk_service_catalog.types.last_sync_time.deserialize_aws_json_1_1(
                data["LastSyncTime"]
            )
        )
    if "LastSyncStatus" in data:
        ...
        out["last_sync_status"] = (
            aws_sdk_service_catalog.types.last_sync_status.deserialize_aws_json_1_1(
                data["LastSyncStatus"]
            )
        )
    ...
    if "LastSuccessfulSyncTime" in data:
        ...
        out["last_successful_sync_time"] = (
            aws_sdk_service_catalog.types.last_successful_sync_time.deserialize_aws_json_1_1(
