...
if TYPE_CHECKING:
    ...
    import aws_sdk_service_catalog.types.source_revision


class ProvisioningArtifactDetail(TypedDict):
    ...
    created_time: NotRequired[
        "aws_sdk_service_catalog.types.creation_time.CreationTime"
    ]
    ...
    source_revision: NotRequired[
        "aws_sdk_service_catalog.types.source_revision.SourceRevision"
    ]
...
def serialize_aws_json_1_1(value: ProvisioningArtifactDetail) -> dict:
    ...
    if "created_time" in value:
        ...
        out["CreatedTime"] = (
            aws_sdk_service_catalog.types.creation_time.serialize_aws_json_1_1(
                value["created_time"]
            )
        )
    if "active" in value:
...
def deserialize_aws_json_1_1(data: dict) -> ProvisioningArtifactDetail:
    ...
    if "CreatedTime" in data:
        ...
        out["created_time"] = (
            aws_sdk_service_catalog.types.creation_time.deserialize_aws_json_1_1(
                data["CreatedTime"]
            )
        )
    if "Active" in data:
