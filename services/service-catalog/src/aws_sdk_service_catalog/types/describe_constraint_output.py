"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DescribeConstraintOutput``."""
...
class DescribeConstraintOutput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeConstraintOutput) -> dict:
    out: dict = {}
