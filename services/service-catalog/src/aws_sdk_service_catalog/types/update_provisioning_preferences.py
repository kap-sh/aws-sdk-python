...
if TYPE_CHECKING:
    ...
    import aws_sdk_service_catalog.types.stack_set_failure_tolerance_count
    import aws_sdk_service_catalog.types.stack_set_failure_tolerance_percentage
    import aws_sdk_service_catalog.types.stack_set_max_concurrency_count
    import aws_sdk_service_catalog.types.stack_set_max_concurrency_percentage
    import aws_sdk_service_catalog.types.stack_set_operation_type
    import aws_sdk_service_catalog.types.stack_set_regions


class UpdateProvisioningPreferences(TypedDict):
    ...
    stack_set_regions: NotRequired[
        "aws_sdk_service_catalog.types.stack_set_regions.StackSetRegions"
    ]
    ...
    stack_set_failure_tolerance_count: NotRequired[
        "aws_sdk_service_catalog.types.stack_set_failure_tolerance_count.StackSetFailureToleranceCount"
    ]
    ...
    stack_set_failure_tolerance_percentage: NotRequired[
        "aws_sdk_service_catalog.types.stack_set_failure_tolerance_percentage.StackSetFailureTolerancePercentage"
    ]
    ...
    stack_set_max_concurrency_count: NotRequired[
        "aws_sdk_service_catalog.types.stack_set_max_concurrency_count.StackSetMaxConcurrencyCount"
    ]
    ...
    stack_set_max_concurrency_percentage: NotRequired[
        "aws_sdk_service_catalog.types.stack_set_max_concurrency_percentage.StackSetMaxConcurrencyPercentage"
    ]
    ...
    stack_set_operation_type: NotRequired[
        "aws_sdk_service_catalog.types.stack_set_operation_type.StackSetOperationType"
    ]
...
def serialize_aws_json_1_1(value: UpdateProvisioningPreferences) -> dict:
    ...
    if "stack_set_accounts" in value:
        ...
        out["StackSetAccounts"] = (
            aws_sdk_service_catalog.types.stack_set_accounts.serialize_aws_json_1_1(
    ...
    if "stack_set_regions" in value:
        ...
        out["StackSetRegions"] = (
            aws_sdk_service_catalog.types.stack_set_regions.serialize_aws_json_1_1(
    ...
    if "stack_set_operation_type" in value:
        ...
        out["StackSetOperationType"] = (
            aws_sdk_service_catalog.types.stack_set_operation_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateProvisioningPreferences:
    ...
    if "StackSetAccounts" in data:
        ...
        out["stack_set_accounts"] = (
            aws_sdk_service_catalog.types.stack_set_accounts.deserialize_aws_json_1_1(
    ...
    if "StackSetRegions" in data:
        ...
        out["stack_set_regions"] = (
            aws_sdk_service_catalog.types.stack_set_regions.deserialize_aws_json_1_1(
    ...
    if "StackSetOperationType" in data:
        ...
        out["stack_set_operation_type"] = (
            aws_sdk_service_catalog.types.stack_set_operation_type.deserialize_aws_json_1_1(
