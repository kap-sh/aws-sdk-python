...
class DescribeProvisioningParametersOutput(TypedDict):
    ...
    usage_instructions: NotRequired[
        "aws_sdk_service_catalog.types.usage_instructions.UsageInstructions"
    ]
    ...
    tag_options: NotRequired[
        "aws_sdk_service_catalog.types.tag_option_summaries.TagOptionSummaries"
    ]
    """<p>Information about the TagOptions associated with the resource.</p>"""
    provisioning_artifact_preferences: NotRequired[
        "aws_sdk_service_catalog.types.provisioning_artifact_preferences.ProvisioningArtifactPreferences"
    ]
    ...
    provisioning_artifact_outputs: NotRequired[
        "aws_sdk_service_catalog.types.provisioning_artifact_outputs.ProvisioningArtifactOutputs"
    ]
...
def serialize_aws_json_1_1(value: DescribeProvisioningParametersOutput) -> dict:
    ...
    if "usage_instructions" in value:
        ...
        out["UsageInstructions"] = (
            aws_sdk_service_catalog.types.usage_instructions.serialize_aws_json_1_1(
    ...
    if "tag_options" in value:
        ...
        out["TagOptions"] = (
            aws_sdk_service_catalog.types.tag_option_summaries.serialize_aws_json_1_1(
                value["tag_options"]
            )
        )
    if "provisioning_artifact_preferences" in value:
        ...
        out["ProvisioningArtifactPreferences"] = (
            aws_sdk_service_catalog.types.provisioning_artifact_preferences.serialize_aws_json_1_1(
    ...
    if "provisioning_artifact_outputs" in value:
        ...
        out["ProvisioningArtifactOutputs"] = (
            aws_sdk_service_catalog.types.provisioning_artifact_outputs.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeProvisioningParametersOutput:
    ...
    if "UsageInstructions" in data:
        ...
        out["usage_instructions"] = (
            aws_sdk_service_catalog.types.usage_instructions.deserialize_aws_json_1_1(
    ...
    if "TagOptions" in data:
        ...
        out["tag_options"] = (
            aws_sdk_service_catalog.types.tag_option_summaries.deserialize_aws_json_1_1(
                data["TagOptions"]
            )
        )
    if "ProvisioningArtifactPreferences" in data:
        ...
        out["provisioning_artifact_preferences"] = (
            aws_sdk_service_catalog.types.provisioning_artifact_preferences.deserialize_aws_json_1_1(
    ...
    if "ProvisioningArtifactOutputs" in data:
        ...
        out["provisioning_artifact_outputs"] = (
            aws_sdk_service_catalog.types.provisioning_artifact_outputs.deserialize_aws_json_1_1(
