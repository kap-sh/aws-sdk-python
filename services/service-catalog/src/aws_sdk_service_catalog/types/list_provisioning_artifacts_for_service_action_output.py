...
class ListProvisioningArtifactsForServiceActionOutput(TypedDict):
    provisioning_artifact_views: NotRequired[
        "aws_sdk_service_catalog.types.provisioning_artifact_views.ProvisioningArtifactViews"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "provisioning_artifact_views" in value:
        ...
        out["ProvisioningArtifactViews"] = (
            aws_sdk_service_catalog.types.provisioning_artifact_views.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "ProvisioningArtifactViews" in data:
        ...
        out["provisioning_artifact_views"] = (
            aws_sdk_service_catalog.types.provisioning_artifact_views.deserialize_aws_json_1_1(
