...
if TYPE_CHECKING:
    ...
    import aws_sdk_service_catalog.types.user_arn
    import aws_sdk_service_catalog.types.user_arn_session


class ProvisionedProductAttribute(TypedDict):
    name: NotRequired[
    ...
    last_record_id: NotRequired["aws_sdk_service_catalog.types.id.Id"]
    ...
    physical_id: NotRequired["aws_sdk_service_catalog.types.physical_id.PhysicalId"]
    ...
    user_arn: NotRequired["aws_sdk_service_catalog.types.user_arn.UserArn"]
    """<p>The Amazon Resource Name (ARN) of the user.</p>"""
    user_arn_session: NotRequired[
        "aws_sdk_service_catalog.types.user_arn_session.UserArnSession"
    ]
