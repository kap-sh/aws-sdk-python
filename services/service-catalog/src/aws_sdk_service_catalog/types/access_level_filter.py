...
if TYPE_CHECKING:
    import aws_sdk_service_catalog.types.access_level_filter_key
    import aws_sdk_service_catalog.types.access_level_filter_value


class AccessLevelFilter(TypedDict):
    key: NotRequired[
        "aws_sdk_service_catalog.types.access_level_filter_key.AccessLevelFilterKey"
    ]
    ...
    value: NotRequired[
        "aws_sdk_service_catalog.types.access_level_filter_value.AccessLevelFilterValue"
    ]
...
def serialize_aws_json_1_1(value: AccessLevelFilter) -> dict:
    ...
    if "key" in value:
        ...
        out["Key"] = (
            aws_sdk_service_catalog.types.access_level_filter_key.serialize_aws_json_1_1(
                value["key"]
            )
        )
    if "value" in value:
...
def deserialize_aws_json_1_1(data: dict) -> AccessLevelFilter:
    ...
    if "Key" in data:
        ...
        out["key"] = (
            aws_sdk_service_catalog.types.access_level_filter_key.deserialize_aws_json_1_1(
                data["Key"]
            )
        )
    if "Value" in data:
