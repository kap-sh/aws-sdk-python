...
if TYPE_CHECKING:
    import aws_sdk_service_catalog.types.has_default_path
    import aws_sdk_service_catalog.types.id
    import aws_sdk_service_catalog.types.product_type
    import aws_sdk_service_catalog.types.product_view_distributor
...
class ProductViewSummary(TypedDict):
    ...
    type: NotRequired["aws_sdk_service_catalog.types.product_type.ProductType"]
    ...
    distributor: NotRequired[
        "aws_sdk_service_catalog.types.product_view_distributor.ProductViewDistributor"
    ]
    """<p>The distributor of the product. Contact the product administrator for the significance of this value.</p>"""
    has_default_path: "aws_sdk_service_catalog.types.has_default_path.HasDefaultPath"
...
def serialize_aws_json_1_1(value: ProductViewSummary) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = aws_sdk_service_catalog.types.product_type.serialize_aws_json_1_1(
            value["type"]
        )
