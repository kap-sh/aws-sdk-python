...
class ScanProvisionedProductsOutput(TypedDict):
    provisioned_products: NotRequired[
        "aws_sdk_service_catalog.types.provisioned_product_details.ProvisionedProductDetails"
    ]
...
def serialize_aws_json_1_1(value: ScanProvisionedProductsOutput) -> dict:
    ...
    if "provisioned_products" in value:
        ...
        out["ProvisionedProducts"] = (
            aws_sdk_service_catalog.types.provisioned_product_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ScanProvisionedProductsOutput:
    ...
    if "ProvisionedProducts" in data:
        ...
        out["provisioned_products"] = (
            aws_sdk_service_catalog.types.provisioned_product_details.deserialize_aws_json_1_1(
