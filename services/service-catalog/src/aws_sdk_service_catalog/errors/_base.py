...
class ServiceCatalogError(Exception):
    """Base class for all ServiceCatalog service errors."""


class ServiceError(ServiceCatalogError):
...
class SerializationError(ServiceCatalogError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ServiceCatalogError):
...
class WaiterFailedError(ServiceCatalogError):
...
class WaiterTimeoutError(ServiceCatalogError):
