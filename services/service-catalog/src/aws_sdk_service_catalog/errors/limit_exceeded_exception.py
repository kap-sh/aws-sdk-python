"""Generated from Smithy shape ``com.amazonaws.servicecatalog#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.servicecatalog#LimitExceededException``."""
