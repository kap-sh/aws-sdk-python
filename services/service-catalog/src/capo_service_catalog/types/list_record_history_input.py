...
class ListRecordHistoryInput(TypedDict, closed=True):
...
def serialize_aws_json_1_1(value: ListRecordHistoryInput) -> dict:
    ...
    if "search_filter" in value:
        ...
        out["SearchFilter"] = (
            capo_service_catalog.types.list_record_history_search_filter.serialize_aws_json_1_1(
                value["search_filter"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListRecordHistoryInput:
    ...
    if "SearchFilter" in data:
        ...
        out["search_filter"] = (
            capo_service_catalog.types.list_record_history_search_filter.deserialize_aws_json_1_1(
                data["SearchFilter"]
            )
        )
    if "PageSize" in data:
