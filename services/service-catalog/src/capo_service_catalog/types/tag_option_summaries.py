...
if TYPE_CHECKING:
    import capo_service_catalog.types.tag_option_summary

TagOptionSummaries: TypeAlias = list[
    "capo_service_catalog.types.tag_option_summary.TagOptionSummary"
]
...
def serialize_aws_json_1_1(value: TagOptionSummaries) -> list:
    ...
    for item in value:
        out.append(
            capo_service_catalog.types.tag_option_summary.serialize_aws_json_1_1(item)
        )
    return out
