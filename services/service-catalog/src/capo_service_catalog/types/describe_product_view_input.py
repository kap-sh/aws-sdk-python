"""Generated from Smithy shape ``com.amazonaws.servicecatalog#DescribeProductViewInput``."""
...
class DescribeProductViewInput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeProductViewInput) -> dict:
    out: dict = {}
