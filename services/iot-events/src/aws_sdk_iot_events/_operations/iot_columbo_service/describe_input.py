...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.describe_input_response.DescribeInputResponse = (
        aws_sdk_iot_events.types.describe_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.describe_input_request.DescribeInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
