...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.list_detector_model_versions_response.ListDetectorModelVersionsResponse = aws_sdk_iot_events.types.list_detector_model_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.list_detector_model_versions_request.ListDetectorModelVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
