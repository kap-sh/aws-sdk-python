...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.list_alarm_models_response.ListAlarmModelsResponse = (
        aws_sdk_iot_events.types.list_alarm_models_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.list_alarm_models_request.ListAlarmModelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
