...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.update_alarm_model_response.UpdateAlarmModelResponse = aws_sdk_iot_events.types.update_alarm_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.update_alarm_model_request.UpdateAlarmModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.update_alarm_model_request.serialize_json(input_)
    ).encode()
