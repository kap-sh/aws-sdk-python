...
def build_request(
    ...
    input: aws_sdk_iot_events.types.update_alarm_model_request.UpdateAlarmModelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.update_alarm_model_request.serialize_json(input)
    ).encode()
