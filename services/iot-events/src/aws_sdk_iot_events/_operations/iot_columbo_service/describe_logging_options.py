"""Generated from Smithy shape ``com.amazonaws.iotevents#DescribeLoggingOptions``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedOperationException":
            import aws_sdk_iot_events.errors.unsupported_operation_exception

            raise aws_sdk_iot_events.errors.unsupported_operation_exception.UnsupportedOperationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.describe_logging_options_response.DescribeLoggingOptionsResponse = aws_sdk_iot_events.types.describe_logging_options_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.describe_logging_options_request.DescribeLoggingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/logging"
    params: dict[str, str] = {}
...
async def async_describe_logging_options(
