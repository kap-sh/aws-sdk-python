...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.describe_detector_model_analysis_response.DescribeDetectorModelAnalysisResponse = aws_sdk_iot_events.types.describe_detector_model_analysis_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.describe_detector_model_analysis_request.DescribeDetectorModelAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
