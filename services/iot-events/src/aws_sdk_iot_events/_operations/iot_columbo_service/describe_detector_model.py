...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.describe_detector_model_response.DescribeDetectorModelResponse = aws_sdk_iot_events.types.describe_detector_model_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot_events.types.describe_detector_model_request.DescribeDetectorModelRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "detector_model_version" in input:
        params["version"] = str(input["detector_model_version"])
