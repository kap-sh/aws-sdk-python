...
def build_request(
    ...
    input: aws_sdk_iot_events.types.list_input_routings_request.ListInputRoutingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.list_input_routings_request.serialize_json(input)
    ).encode()
