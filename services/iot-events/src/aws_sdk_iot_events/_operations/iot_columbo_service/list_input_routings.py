...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.list_input_routings_response.ListInputRoutingsResponse = aws_sdk_iot_events.types.list_input_routings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.list_input_routings_request.ListInputRoutingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.list_input_routings_request.serialize_json(input_)
    ).encode()
