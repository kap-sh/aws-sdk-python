...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.start_detector_model_analysis_response.StartDetectorModelAnalysisResponse = aws_sdk_iot_events.types.start_detector_model_analysis_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.start_detector_model_analysis_request.StartDetectorModelAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.start_detector_model_analysis_request.serialize_json(
            input_
        )
    ).encode()
