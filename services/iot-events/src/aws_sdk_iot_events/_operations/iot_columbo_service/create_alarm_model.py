"""Generated from Smithy shape ``com.amazonaws.iotevents#CreateAlarmModel``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            import aws_sdk_iot_events.errors.limit_exceeded_exception

            raise aws_sdk_iot_events.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
        case "ResourceAlreadyExistsException":
            import aws_sdk_iot_events.errors.resource_already_exists_exception

            raise aws_sdk_iot_events.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_json(
                data
            )
        case "ResourceInUseException":
            import aws_sdk_iot_events.errors.resource_in_use_exception

            raise aws_sdk_iot_events.errors.resource_in_use_exception.ResourceInUseException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.create_alarm_model_response.CreateAlarmModelResponse = aws_sdk_iot_events.types.create_alarm_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.create_alarm_model_request.CreateAlarmModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/alarm-models"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iot_events.types.create_alarm_model_request

    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.create_alarm_model_request.serialize_json(input_)
    ).encode()
...
async def async_create_alarm_model(
