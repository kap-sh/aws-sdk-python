...
def build_request(
    ...
    input: aws_sdk_iot_events.types.create_detector_model_request.CreateDetectorModelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.create_detector_model_request.serialize_json(input)
    ).encode()
