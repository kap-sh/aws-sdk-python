"""Generated from Smithy shape ``com.amazonaws.iotevents#CreateDetectorModel``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.create_detector_model_response.CreateDetectorModelResponse = aws_sdk_iot_events.types.create_detector_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.create_detector_model_request.CreateDetectorModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.create_detector_model_request.serialize_json(input_)
    ).encode()
...
async def async_create_detector_model(
