...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.get_detector_model_analysis_results_response.GetDetectorModelAnalysisResultsResponse = aws_sdk_iot_events.types.get_detector_model_analysis_results_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.get_detector_model_analysis_results_request.GetDetectorModelAnalysisResultsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
