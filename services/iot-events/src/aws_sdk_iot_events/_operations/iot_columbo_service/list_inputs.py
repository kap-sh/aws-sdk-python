...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.list_inputs_response.ListInputsResponse = (
        aws_sdk_iot_events.types.list_inputs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.list_inputs_request.ListInputsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_inputs(
    ...
    aws_sdk_iot_events.types.list_inputs_response.ListInputsResponse, zapros.Response
]:
