...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.delete_alarm_model_response.DeleteAlarmModelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.delete_alarm_model_request.DeleteAlarmModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
