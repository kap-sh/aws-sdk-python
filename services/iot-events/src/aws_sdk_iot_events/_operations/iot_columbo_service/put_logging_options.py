...
def build_request(
    ...
    input: aws_sdk_iot_events.types.put_logging_options_request.PutLoggingOptionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.put_logging_options_request.serialize_json(input)
    ).encode()
