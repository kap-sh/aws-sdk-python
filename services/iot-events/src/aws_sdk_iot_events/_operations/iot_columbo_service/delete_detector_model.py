...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.delete_detector_model_response.DeleteDetectorModelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.delete_detector_model_request.DeleteDetectorModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
