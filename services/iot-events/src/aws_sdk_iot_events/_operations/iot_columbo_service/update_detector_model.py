...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.update_detector_model_request.UpdateDetectorModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.update_detector_model_request.serialize_json(input_)
    ).encode()
