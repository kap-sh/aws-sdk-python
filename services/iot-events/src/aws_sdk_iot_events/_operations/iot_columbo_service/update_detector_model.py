"""Generated from Smithy shape ``com.amazonaws.iotevents#UpdateDetectorModel``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.update_detector_model_response.UpdateDetectorModelResponse = aws_sdk_iot_events.types.update_detector_model_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot_events.types.update_detector_model_request.UpdateDetectorModelRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{detectorModelName}", quote(str(input["detector_model_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events.types.update_detector_model_request.serialize_json(input)
    ).encode()
...
async def async_update_detector_model(
