"""Generated from Smithy shape ``com.amazonaws.iotevents#ListAlarmModelVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_events.types.list_alarm_model_versions_response.ListAlarmModelVersionsResponse = aws_sdk_iot_events.types.list_alarm_model_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events.types.list_alarm_model_versions_request.ListAlarmModelVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/alarm-models/{alarmModelName}/versions"
    url = url.replace(
...
async def async_list_alarm_model_versions(
