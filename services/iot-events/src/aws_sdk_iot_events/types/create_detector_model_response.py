"""Generated from Smithy shape ``com.amazonaws.iotevents#CreateDetectorModelResponse``."""
...
class CreateDetectorModelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateDetectorModelResponse) -> dict:
    out: dict = {}
