...
if TYPE_CHECKING:
    import aws_sdk_iot_events.types.analysis_message
    import aws_sdk_iot_events.types.analysis_result_level
    import aws_sdk_iot_events.types.analysis_result_locations
    import aws_sdk_iot_events.types.analysis_type


class AnalysisResult(TypedDict):
    type: NotRequired["aws_sdk_iot_events.types.analysis_type.AnalysisType"]
    ...
    level: NotRequired[
        "aws_sdk_iot_events.types.analysis_result_level.AnalysisResultLevel"
    ]
    ...
    message: NotRequired["aws_sdk_iot_events.types.analysis_message.AnalysisMessage"]
    """<p>Contains additional information about the analysis result.</p>"""
    locations: NotRequired[
        "aws_sdk_iot_events.types.analysis_result_locations.AnalysisResultLocations"
    ]
...
def serialize_json(value: AnalysisResult) -> dict:
    ...
    if "level" in value:
        ...
        out["level"] = aws_sdk_iot_events.types.analysis_result_level.serialize_json(
            value["level"]
        )
    if "message" in value:
    ...
    if "locations" in value:
        ...
        out["locations"] = (
            aws_sdk_iot_events.types.analysis_result_locations.serialize_json(
                value["locations"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> AnalysisResult:
    ...
    if "level" in data:
        ...
        out["level"] = aws_sdk_iot_events.types.analysis_result_level.deserialize_json(
            data["level"]
        )
    if "message" in data:
    ...
    if "locations" in data:
        ...
        out["locations"] = (
            aws_sdk_iot_events.types.analysis_result_locations.deserialize_json(
                data["locations"]
            )
        )
    return out
