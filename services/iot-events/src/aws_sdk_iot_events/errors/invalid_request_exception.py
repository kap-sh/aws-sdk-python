"""Generated from Smithy shape ``com.amazonaws.iotevents#InvalidRequestException``."""
...
class InvalidRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotevents#InvalidRequestException``."""
