"""Generated from Smithy shape ``com.amazonaws.iotevents#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotevents#LimitExceededException``."""
