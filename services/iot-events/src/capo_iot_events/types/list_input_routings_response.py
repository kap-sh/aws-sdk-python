...
class ListInputRoutingsResponse(TypedDict, closed=True):
    routed_resources: NotRequired[
        "capo_iot_events.types.routed_resources.RoutedResources"
    ]
...
def serialize_json(value: ListInputRoutingsResponse) -> dict:
    ...
    if "routed_resources" in value:
        ...
        out["routedResources"] = capo_iot_events.types.routed_resources.serialize_json(
...
def deserialize_json(data: dict) -> ListInputRoutingsResponse:
    ...
    if "routedResources" in data:
        ...
        out["routed_resources"] = (
            capo_iot_events.types.routed_resources.deserialize_json(
