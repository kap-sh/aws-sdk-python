"""Generated from Smithy shape ``com.amazonaws.iotevents#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotevents#ResourceNotFoundException``."""
