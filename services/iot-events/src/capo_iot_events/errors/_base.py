...
class IoTEventsError(Exception):
    """Base class for all IoTEvents service errors."""


class ServiceError(IoTEventsError):
...
class SerializationError(IoTEventsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTEventsError):
...
class WaiterFailedError(IoTEventsError):
...
class WaiterTimeoutError(IoTEventsError):
