"""Generated from Smithy shape ``com.amazonaws.iotevents#ServiceUnavailableException``."""
...
class ServiceUnavailableException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotevents#ServiceUnavailableException``."""
