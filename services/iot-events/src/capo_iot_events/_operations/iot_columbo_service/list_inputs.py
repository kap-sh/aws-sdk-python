"""Generated from Smithy shape ``com.amazonaws.iotevents#ListInputs``."""
...
def handle_response(
    ...
    out: capo_iot_events.types.list_inputs_response.ListInputsResponse = (
        capo_iot_events.types.list_inputs_response.deserialize_json(
...
def list_inputs(
    ...
    capo_iot_events.types.list_inputs_response.ListInputsResponse, zapros.Response
]:
