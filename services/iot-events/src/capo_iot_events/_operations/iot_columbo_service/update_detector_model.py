...
def handle_response(
    ...
    out: capo_iot_events.types.update_detector_model_response.UpdateDetectorModelResponse = capo_iot_events.types.update_detector_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_events.types.update_detector_model_request.serialize_json(input_)
    ).encode()
