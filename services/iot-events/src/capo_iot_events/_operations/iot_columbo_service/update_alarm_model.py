"""Generated from Smithy shape ``com.amazonaws.iotevents#UpdateAlarmModel``."""
...
def handle_response(
    ...
    out: capo_iot_events.types.update_alarm_model_response.UpdateAlarmModelResponse = (
        capo_iot_events.types.update_alarm_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_events.types.update_alarm_model_request.serialize_json(input_)
    ).encode()
...
async def async_update_alarm_model(
