"""Generated from Smithy shape ``com.amazonaws.iotevents#DeleteAlarmModel``."""
...
def handle_response(
    ...
    out: capo_iot_events.types.delete_alarm_model_response.DeleteAlarmModelResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_alarm_model(
