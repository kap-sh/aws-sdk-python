"""Generated from Smithy shape ``com.amazonaws.iotevents#DeleteInput``."""
...
def handle_response(
    ...
    out: capo_iot_events.types.delete_input_response.DeleteInputResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_input(
    ...
    capo_iot_events.types.delete_input_response.DeleteInputResponse, zapros.Response
]:
