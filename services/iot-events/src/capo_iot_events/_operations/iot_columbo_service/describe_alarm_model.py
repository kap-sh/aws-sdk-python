...
def handle_response(
    ...
    out: capo_iot_events.types.describe_alarm_model_response.DescribeAlarmModelResponse = capo_iot_events.types.describe_alarm_model_response.deserialize_json(
