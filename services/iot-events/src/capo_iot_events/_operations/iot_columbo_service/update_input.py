...
def handle_response(
    ...
    out: capo_iot_events.types.update_input_response.UpdateInputResponse = (
        capo_iot_events.types.update_input_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_events.types.update_input_request.serialize_json(input_)
    ).encode()
...
def update_input(
    ...
    capo_iot_events.types.update_input_response.UpdateInputResponse, zapros.Response
]:
