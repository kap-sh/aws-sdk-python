"""Generated from Smithy shape ``com.amazonaws.iotevents#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_iot_events.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_iot_events.types.list_tags_for_resource_response.deserialize_json(
