...
def handle_response(
    ...
    out: capo_iot_events.types.create_input_response.CreateInputResponse = (
        capo_iot_events.types.create_input_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_events.types.create_input_request.serialize_json(input_)
    ).encode()
...
def create_input(
    ...
    capo_iot_events.types.create_input_response.CreateInputResponse, zapros.Response
]:
