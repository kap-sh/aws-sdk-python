...
import capo_iot_events.errors.unsupported_operation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedOperationException":
            raise capo_iot_events.errors.unsupported_operation_exception.UnsupportedOperationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_iot_events.types.describe_logging_options_response.DescribeLoggingOptionsResponse = capo_iot_events.types.describe_logging_options_response.deserialize_json(
