...
import capo_iot_events.errors.limit_exceeded_exception
import capo_iot_events.errors.resource_already_exists_exception
import capo_iot_events.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_iot_events.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
        case "ResourceAlreadyExistsException":
            raise capo_iot_events.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_json(
                data
            )
        case "ResourceInUseException":
            raise capo_iot_events.errors.resource_in_use_exception.ResourceInUseException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_iot_events.types.create_alarm_model_response.CreateAlarmModelResponse = (
        capo_iot_events.types.create_alarm_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_events.types.create_alarm_model_request.serialize_json(input_)
    ).encode()
