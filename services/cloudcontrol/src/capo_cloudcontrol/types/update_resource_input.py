"""Generated from Smithy shape ``com.amazonaws.cloudcontrol#UpdateResourceInput``."""
...
class UpdateResourceInput(TypedDict, closed=True):
    ...
    client_token: NotRequired["capo_cloudcontrol.types.client_token.ClientToken"]
    ...
    r"""<p>A JavaScript Object Notation (JSON) document listing the patch operations that represent the updates to apply to the current resource properties. For details, see <a href=\"https://docs.aws.amazon.com/cloudcontrolapi/latest/userguide/resource-operations-update.html#resource-operations-update-patch\">Composing the patch document</a> in the <i>Amazon Web Services Cloud Control API User Guide</i>.</p>"""


# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateResourceInput) -> dict:
    out: dict = {}
    ...
    out["PatchDocument"] = value["patch_document"]
    return out
