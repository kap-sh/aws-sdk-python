...
from capo_cloudcontrol._services._aws_config import aws_config
...
class CloudControlClientConfig(TypedDict, total=False, closed=True):
...
class CloudControlClient:
    ...
    def cancel_resource_request(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudcontrol.types.cancel_resource_request_input.CancelResourceRequestInput]",
        ) -> OperationResponse[
            "capo_cloudcontrol.types.cancel_resource_request_output.CancelResourceRequestOutput"
        ]:
            ...
            output, http_response = (
                capo_cloudcontrol._operations.cloud_api_service.cancel_resource_request.cancel_resource_request(
    ...
    def create_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudcontrol.types.create_resource_input.CreateResourceInput]",
        ) -> OperationResponse[
            "capo_cloudcontrol.types.create_resource_output.CreateResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_cloudcontrol._operations.cloud_api_service.create_resource.create_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudcontrol.types.delete_resource_input.DeleteResourceInput]",
        ) -> OperationResponse[
            "capo_cloudcontrol.types.delete_resource_output.DeleteResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_cloudcontrol._operations.cloud_api_service.delete_resource.delete_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudcontrol.types.get_resource_input.GetResourceInput]",
        ) -> OperationResponse[
            "capo_cloudcontrol.types.get_resource_output.GetResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_cloudcontrol._operations.cloud_api_service.get_resource.get_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_request_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudcontrol.types.get_resource_request_status_input.GetResourceRequestStatusInput]",
        ) -> OperationResponse[
            "capo_cloudcontrol.types.get_resource_request_status_output.GetResourceRequestStatusOutput"
        ]:
            ...
            output, http_response = (
                capo_cloudcontrol._operations.cloud_api_service.get_resource_request_status.get_resource_request_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_resource_requests(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudcontrol.types.list_resource_requests_input.ListResourceRequestsInput]",
        ) -> OperationResponse[
            "capo_cloudcontrol.types.list_resource_requests_output.ListResourceRequestsOutput"
        ]:
            ...
            output, http_response = (
                capo_cloudcontrol._operations.cloud_api_service.list_resource_requests.list_resource_requests(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_cloudcontrol.types.progress_event.ProgressEvent]":
        _token = next_token
        while True:
    ...
    def list_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudcontrol.types.list_resources_input.ListResourcesInput]",
        ) -> OperationResponse[
            "capo_cloudcontrol.types.list_resources_output.ListResourcesOutput"
        ]:
            ...
            output, http_response = (
                capo_cloudcontrol._operations.cloud_api_service.list_resources.list_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_cloudcontrol.types.resource_description.ResourceDescription]":
        _token = next_token
        while True:
    ...
    def update_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudcontrol.types.update_resource_input.UpdateResourceInput]",
        ) -> OperationResponse[
            "capo_cloudcontrol.types.update_resource_output.UpdateResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_cloudcontrol._operations.cloud_api_service.update_resource.update_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
