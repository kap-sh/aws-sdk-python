"""Generated from Smithy shape ``com.amazonaws.cloudcontrol#InvalidRequestException``."""
...
class InvalidRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudcontrol#InvalidRequestException``."""
