...
class CloudControlError(Exception):
    """Base class for all CloudControl service errors."""


class ServiceError(CloudControlError):
...
class SerializationError(CloudControlError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudControlError):
...
class WaiterFailedError(CloudControlError):
...
class WaiterTimeoutError(CloudControlError):
