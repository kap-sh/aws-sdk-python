"""Generated from Smithy shape ``com.amazonaws.cloudcontrol#UpdateResource``."""
...
def handle_response(
    ...
    out: capo_cloudcontrol.types.update_resource_output.UpdateResourceOutput = (
        capo_cloudcontrol.types.update_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudApiService.UpdateResource"
    body: bytes | None = json.dumps(
        capo_cloudcontrol.types.update_resource_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_resource(
    ...
    capo_cloudcontrol.types.update_resource_output.UpdateResourceOutput, zapros.Response
]:
