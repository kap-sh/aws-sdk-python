"""Generated from Smithy shape ``com.amazonaws.cloudcontrol#ListResources``."""
...
def handle_response(
    ...
    out: capo_cloudcontrol.types.list_resources_output.ListResourcesOutput = (
        capo_cloudcontrol.types.list_resources_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudApiService.ListResources"
    body: bytes | None = json.dumps(
        capo_cloudcontrol.types.list_resources_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_resources(
    ...
    capo_cloudcontrol.types.list_resources_output.ListResourcesOutput, zapros.Response
]:
