"""Generated from Smithy shape ``com.amazonaws.cloudcontrol#DeleteResource``."""
...
def handle_response(
    ...
    out: capo_cloudcontrol.types.delete_resource_output.DeleteResourceOutput = (
        capo_cloudcontrol.types.delete_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudApiService.DeleteResource"
    body: bytes | None = json.dumps(
        capo_cloudcontrol.types.delete_resource_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_resource(
    ...
    capo_cloudcontrol.types.delete_resource_output.DeleteResourceOutput, zapros.Response
]:
