...
def handle_response(
    ...
    out: capo_cloudcontrol.types.get_resource_output.GetResourceOutput = (
        capo_cloudcontrol.types.get_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudcontrol.types.get_resource_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_resource(
    ...
    capo_cloudcontrol.types.get_resource_output.GetResourceOutput, zapros.Response
]:
