"""Generated from Smithy shape ``com.amazonaws.cloudcontrol#ListResourceRequests``."""
...
def handle_response(
    ...
    out: capo_cloudcontrol.types.list_resource_requests_output.ListResourceRequestsOutput = capo_cloudcontrol.types.list_resource_requests_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudApiService.ListResourceRequests"
    body: bytes | None = json.dumps(
        capo_cloudcontrol.types.list_resource_requests_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_resource_requests(
