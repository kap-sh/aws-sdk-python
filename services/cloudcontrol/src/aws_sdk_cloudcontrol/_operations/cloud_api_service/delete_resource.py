...
def handle_response(
    ...
    out: aws_sdk_cloudcontrol.types.delete_resource_output.DeleteResourceOutput = (
        aws_sdk_cloudcontrol.types.delete_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudcontrol.types.delete_resource_input.DeleteResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudcontrol.types.delete_resource_input.serialize_aws_json_1_0(input_)
    ).encode()
