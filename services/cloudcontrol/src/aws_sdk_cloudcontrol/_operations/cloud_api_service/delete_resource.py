...
def build_request(
    ...
    input: aws_sdk_cloudcontrol.types.delete_resource_input.DeleteResourceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudcontrol.types.delete_resource_input.serialize_aws_json_1_0(input)
    ).encode()
