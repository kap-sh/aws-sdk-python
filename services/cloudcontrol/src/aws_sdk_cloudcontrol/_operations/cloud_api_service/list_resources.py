...
def handle_response(
    ...
    out: aws_sdk_cloudcontrol.types.list_resources_output.ListResourcesOutput = (
        aws_sdk_cloudcontrol.types.list_resources_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudcontrol.types.list_resources_input.ListResourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudcontrol.types.list_resources_input.serialize_aws_json_1_0(input_)
    ).encode()
