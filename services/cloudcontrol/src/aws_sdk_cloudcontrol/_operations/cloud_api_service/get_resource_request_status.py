"""Generated from Smithy shape ``com.amazonaws.cloudcontrol#GetResourceRequestStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudcontrol.types.get_resource_request_status_output.GetResourceRequestStatusOutput = aws_sdk_cloudcontrol.types.get_resource_request_status_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_cloudcontrol.types.get_resource_request_status_input.GetResourceRequestStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CloudApiService.GetResourceRequestStatus"
    import aws_sdk_cloudcontrol.types.get_resource_request_status_input

    body: bytes | None = json.dumps(
        aws_sdk_cloudcontrol.types.get_resource_request_status_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_resource_request_status(
