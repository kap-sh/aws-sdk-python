...
def build_request(
    ...
    input: aws_sdk_cloudcontrol.types.update_resource_input.UpdateResourceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudcontrol.types.update_resource_input.serialize_aws_json_1_0(input)
    ).encode()
