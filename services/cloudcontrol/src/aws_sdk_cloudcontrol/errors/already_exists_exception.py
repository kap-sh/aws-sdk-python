"""Generated from Smithy shape ``com.amazonaws.cloudcontrol#AlreadyExistsException``."""
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: AlreadyExistsException_) -> dict:
    out: dict = {}
    if "message" in value:
...
def deserialize_aws_json_1_0(data: dict) -> AlreadyExistsException_:
...
class AlreadyExistsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudcontrol#AlreadyExistsException``."""
    ...
    @classmethod
    def from_aws_json_1_0(cls, data: dict) -> "AlreadyExistsException":
