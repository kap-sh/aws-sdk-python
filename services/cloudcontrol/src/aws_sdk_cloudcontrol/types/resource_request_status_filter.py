...
if TYPE_CHECKING:
    import aws_sdk_cloudcontrol.types.operation_statuses
    import aws_sdk_cloudcontrol.types.operations


class ResourceRequestStatusFilter(TypedDict):
    operations: NotRequired["aws_sdk_cloudcontrol.types.operations.Operations"]
    """<p>The operation types to include in the filter.</p>"""
    operation_statuses: NotRequired[
        "aws_sdk_cloudcontrol.types.operation_statuses.OperationStatuses"
    ]
...
def serialize_aws_json_1_0(value: ResourceRequestStatusFilter) -> dict:
    ...
    if "operations" in value:
        ...
        out["Operations"] = (
            aws_sdk_cloudcontrol.types.operations.serialize_aws_json_1_0(
                value["operations"]
            )
        )
    if "operation_statuses" in value:
        ...
        out["OperationStatuses"] = (
            aws_sdk_cloudcontrol.types.operation_statuses.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ResourceRequestStatusFilter:
    ...
    if "Operations" in data:
        ...
        out["operations"] = (
            aws_sdk_cloudcontrol.types.operations.deserialize_aws_json_1_0(
                data["Operations"]
            )
        )
    if "OperationStatuses" in data:
        ...
        out["operation_statuses"] = (
            aws_sdk_cloudcontrol.types.operation_statuses.deserialize_aws_json_1_0(
