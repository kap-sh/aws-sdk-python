...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudcontrol.types.operation_status
...
class ProgressEvent(TypedDict):
    ...
    operation: NotRequired["aws_sdk_cloudcontrol.types.operation.Operation"]
    """<p>The resource operation type.</p>"""
    operation_status: NotRequired[
        "aws_sdk_cloudcontrol.types.operation_status.OperationStatus"
    ]
    ...
    event_time: NotRequired["aws_sdk_cloudcontrol.types.timestamp.Timestamp"]
...
def serialize_aws_json_1_0(value: ProgressEvent) -> dict:
    ...
    if "event_time" in value:
        ...
        out["EventTime"] = aws_sdk_cloudcontrol.types.timestamp.serialize_aws_json_1_0(
            value["event_time"]
        )
    ...
    if "retry_after" in value:
        ...
        out["RetryAfter"] = aws_sdk_cloudcontrol.types.timestamp.serialize_aws_json_1_0(
            value["retry_after"]
        )
    return out
