import pytest
from capo_workspaces_thin_client._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_workspaces_thin_client._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
