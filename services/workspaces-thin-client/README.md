...
```
pip install aws-sdk-workspaces-thin-client
```

## Usage

```python
from aws_sdk_workspaces_thin_client import AsyncWorkSpacesThinClientClient
...
```python
from aws_sdk_workspaces_thin_client import AsyncWorkSpacesThinClientClient
from aws_sdk_workspaces_thin_client.error import AccessDeniedException
