...
from aws_sdk_workspaces_thin_client._services._aws_config import aaws_config
...
class AsyncWorkSpacesThinClientClientConfig(TypedDict, total=False):
...
class AsyncWorkSpacesThinClientClient:
    ...
    async def create_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.create_environment_request.CreateEnvironmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.create_environment_response.CreateEnvironmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.create_environment.async_create_environment(
    ...
    async def delete_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.delete_device_request.DeleteDeviceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.delete_device_response.DeleteDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.delete_device.async_delete_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.delete_environment_request.DeleteEnvironmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.delete_environment_response.DeleteEnvironmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.delete_environment.async_delete_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.deregister_device_request.DeregisterDeviceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.deregister_device_response.DeregisterDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.deregister_device.async_deregister_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.get_device_request.GetDeviceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.get_device_response.GetDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.get_device.async_get_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.get_environment_request.GetEnvironmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.get_environment_response.GetEnvironmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.get_environment.async_get_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_software_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.get_software_set_request.GetSoftwareSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.get_software_set_response.GetSoftwareSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.get_software_set.async_get_software_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_devices(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.list_devices_request.ListDevicesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.list_devices_response.ListDevicesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.list_devices.async_list_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_workspaces_thin_client.types.device_summary.DeviceSummary]":
        _token = next_token
        while True:
    ...
    async def list_environments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.list_environments_request.ListEnvironmentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.list_environments_response.ListEnvironmentsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.list_environments.async_list_environments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_workspaces_thin_client.types.environment_summary.EnvironmentSummary]":
        _token = next_token
        while True:
    ...
    async def list_software_sets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.list_software_sets_request.ListSoftwareSetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.list_software_sets_response.ListSoftwareSetsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.list_software_sets.async_list_software_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_workspaces_thin_client.types.software_set_summary.SoftwareSetSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.update_device_request.UpdateDeviceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.update_device_response.UpdateDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.update_device.async_update_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.update_environment_request.UpdateEnvironmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.update_environment_response.UpdateEnvironmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.update_environment.async_update_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_software_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_thin_client.types.update_software_set_request.UpdateSoftwareSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_thin_client.types.update_software_set_response.UpdateSoftwareSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_thin_client._operations.thin_client.update_software_set.async_update_software_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
