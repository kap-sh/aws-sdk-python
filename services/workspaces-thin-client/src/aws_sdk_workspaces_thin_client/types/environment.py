...
if TYPE_CHECKING:
    ...
    import aws_sdk_workspaces_thin_client.types.environment_software_set_compliance_status
...
class Environment(TypedDict, closed=True):
    ...
    registered_devices_count: NotRequired["int"]
    ...
    software_set_compliance_status: NotRequired[
        "aws_sdk_workspaces_thin_client.types.environment_software_set_compliance_status.EnvironmentSoftwareSetComplianceStatus"
    ]
...
def serialize_json(value: Environment) -> dict:
    ...
    if "registered_devices_count" in value:
        out["registeredDevicesCount"] = value["registered_devices_count"]
    ...
    if "software_set_compliance_status" in value:
        ...
        out["softwareSetComplianceStatus"] = (
            aws_sdk_workspaces_thin_client.types.environment_software_set_compliance_status.serialize_json(
...
def deserialize_json(data: dict) -> Environment:
    ...
    if "softwareSetComplianceStatus" in data:
        ...
        out["software_set_compliance_status"] = (
            aws_sdk_workspaces_thin_client.types.environment_software_set_compliance_status.deserialize_json(
