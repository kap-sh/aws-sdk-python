...
class ListEnvironmentsResponse(TypedDict, closed=True):
    environments: NotRequired[
        "aws_sdk_workspaces_thin_client.types.environment_list.EnvironmentList"
    ]
...
def serialize_json(value: ListEnvironmentsResponse) -> dict:
    ...
    if "environments" in value:
        ...
        out["environments"] = (
            aws_sdk_workspaces_thin_client.types.environment_list.serialize_json(
                value["environments"]
            )
        )
...
def deserialize_json(data: dict) -> ListEnvironmentsResponse:
    ...
    if "environments" in data:
        ...
        out["environments"] = (
            aws_sdk_workspaces_thin_client.types.environment_list.deserialize_json(
                data["environments"]
            )
        )
