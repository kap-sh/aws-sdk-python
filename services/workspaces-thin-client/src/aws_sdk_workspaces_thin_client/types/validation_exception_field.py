"""Generated from Smithy shape ``com.amazonaws.workspacesthinclient#ValidationExceptionField``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_workspaces_thin_client.types.field_name


class ValidationExceptionField(TypedDict, closed=True):
    name: "aws_sdk_workspaces_thin_client.types.field_name.FieldName"
    """<p>The name of the exception.</p>"""
    message: "aws_sdk_workspaces_thin_client.types.exception_message.ExceptionMessage"
