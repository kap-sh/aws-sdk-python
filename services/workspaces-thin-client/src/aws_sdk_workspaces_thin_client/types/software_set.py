...
if TYPE_CHECKING:
    ...
    import aws_sdk_workspaces_thin_client.types.software_list
...
class SoftwareSet(TypedDict, closed=True):
    ...
    software: NotRequired[
        "aws_sdk_workspaces_thin_client.types.software_list.SoftwareList"
    ]
...
def serialize_json(value: SoftwareSet) -> dict:
    ...
    if "software" in value:
        ...
        out["software"] = (
            aws_sdk_workspaces_thin_client.types.software_list.serialize_json(
                value["software"]
            )
        )
    if "arn" in value:
...
def deserialize_json(data: dict) -> SoftwareSet:
    ...
    if "software" in data:
        ...
        out["software"] = (
            aws_sdk_workspaces_thin_client.types.software_list.deserialize_json(
                data["software"]
            )
        )
    if "arn" in data:
