...
class WorkSpacesThinClientError(Exception):
    """Base class for all WorkSpacesThinClient service errors."""


class ServiceError(WorkSpacesThinClientError):
...
class SerializationError(WorkSpacesThinClientError):
    """Raised when a value cannot be serialized."""


class DeserializationError(WorkSpacesThinClientError):
...
class WaiterFailedError(WorkSpacesThinClientError):
...
class WaiterTimeoutError(WorkSpacesThinClientError):
