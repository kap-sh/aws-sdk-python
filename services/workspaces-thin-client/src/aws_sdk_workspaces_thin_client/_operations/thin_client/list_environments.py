...
import aws_sdk_workspaces_thin_client.types.environment_list
...
def handle_response(
    ...
    out: aws_sdk_workspaces_thin_client.types.list_environments_response.ListEnvironmentsResponse = aws_sdk_workspaces_thin_client.types.list_environments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_thin_client.types.list_environments_request.ListEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
