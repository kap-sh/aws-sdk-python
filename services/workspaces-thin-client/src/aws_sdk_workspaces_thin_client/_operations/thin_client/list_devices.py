"""Generated from Smithy shape ``com.amazonaws.workspacesthinclient#ListDevices``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces_thin_client.types.list_devices_response.ListDevicesResponse = aws_sdk_workspaces_thin_client.types.list_devices_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_thin_client.types.list_devices_request.ListDevicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
