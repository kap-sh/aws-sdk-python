...
def build_request(
    ...
    input: aws_sdk_workspaces_thin_client.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces_thin_client.types.tag_resource_request.serialize_json(input)
    ).encode()
