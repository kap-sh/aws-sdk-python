"""Generated from Smithy shape ``com.amazonaws.workspacesthinclient#UpdateSoftwareSet``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces_thin_client.types.update_software_set_response.UpdateSoftwareSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces_thin_client.types.update_software_set_request.UpdateSoftwareSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces_thin_client.types.update_software_set_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_software_set(
