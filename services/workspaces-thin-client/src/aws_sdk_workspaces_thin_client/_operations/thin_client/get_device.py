...
def handle_response(
    ...
    out: aws_sdk_workspaces_thin_client.types.get_device_response.GetDeviceResponse = (
        aws_sdk_workspaces_thin_client.types.get_device_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_thin_client.types.get_device_request.GetDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
