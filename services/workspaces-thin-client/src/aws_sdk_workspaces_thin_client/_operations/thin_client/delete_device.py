...
def handle_response(
    ...
    out: aws_sdk_workspaces_thin_client.types.delete_device_response.DeleteDeviceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces_thin_client.types.delete_device_request.DeleteDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
