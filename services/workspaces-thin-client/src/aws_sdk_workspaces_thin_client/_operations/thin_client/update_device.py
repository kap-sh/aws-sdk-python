...
def build_request(
    ...
    input_: aws_sdk_workspaces_thin_client.types.update_device_request.UpdateDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces_thin_client.types.update_device_request.serialize_json(
            input_
        )
    ).encode()
