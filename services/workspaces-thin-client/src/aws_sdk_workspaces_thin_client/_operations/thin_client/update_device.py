...
def handle_response(
    ...
    out: aws_sdk_workspaces_thin_client.types.update_device_response.UpdateDeviceResponse = aws_sdk_workspaces_thin_client.types.update_device_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_workspaces_thin_client.types.update_device_request.UpdateDeviceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces_thin_client.types.update_device_request.serialize_json(input)
    ).encode()
