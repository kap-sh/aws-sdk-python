...
def handle_response(
    ...
    out: aws_sdk_workspaces_thin_client.types.get_software_set_response.GetSoftwareSetResponse = aws_sdk_workspaces_thin_client.types.get_software_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_thin_client.types.get_software_set_request.GetSoftwareSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
