...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_workspaces_thin_client.errors.service_quota_exceeded_exception

            raise aws_sdk_workspaces_thin_client.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workspaces_thin_client.types.create_environment_response.CreateEnvironmentResponse = aws_sdk_workspaces_thin_client.types.create_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_thin_client.types.create_environment_request.CreateEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces_thin_client.types.create_environment_request.serialize_json(
            input_
        )
    ).encode()
