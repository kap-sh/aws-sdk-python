"""Generated from Smithy shape ``com.amazonaws.workspacesthinclient#UpdateEnvironment``."""
...
import aws_sdk_workspaces_thin_client.errors.conflict_exception
import aws_sdk_workspaces_thin_client.errors.internal_server_exception
import aws_sdk_workspaces_thin_client.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_workspaces_thin_client.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ResourceNotFoundException":
            raise aws_sdk_workspaces_thin_client.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workspaces_thin_client.types.update_environment_response.UpdateEnvironmentResponse = aws_sdk_workspaces_thin_client.types.update_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_thin_client.types.update_environment_request.UpdateEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
