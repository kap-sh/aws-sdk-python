...
def handle_response(
    ...
    out: aws_sdk_workspaces_thin_client.types.get_environment_response.GetEnvironmentResponse = aws_sdk_workspaces_thin_client.types.get_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_thin_client.types.get_environment_request.GetEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
