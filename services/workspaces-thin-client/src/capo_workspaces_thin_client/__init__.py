...
from ._services.async_work_spaces_thin_client import (
    AsyncWorkSpacesThinClientClient as AsyncWorkSpacesThinClientClient,
)
from ._services.work_spaces_thin_client import (
    WorkSpacesThinClientClient as WorkSpacesThinClientClient,
)
