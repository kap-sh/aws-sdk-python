"""Generated from Smithy shape ``com.amazonaws.workspacesthinclient#ListSoftwareSetsRequest``."""
...
class ListSoftwareSetsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListSoftwareSetsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListSoftwareSetsRequest:
    out: ListSoftwareSetsRequest = {}  # type: ignore[typeddict-item]
    return out
