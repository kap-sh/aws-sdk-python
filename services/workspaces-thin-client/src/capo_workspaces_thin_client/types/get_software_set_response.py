...
class GetSoftwareSetResponse(TypedDict, closed=True):
    software_set: NotRequired[
        "capo_workspaces_thin_client.types.software_set.SoftwareSet"
    ]
...
def serialize_json(value: GetSoftwareSetResponse) -> dict:
    ...
    if "software_set" in value:
        ...
        out["softwareSet"] = (
            capo_workspaces_thin_client.types.software_set.serialize_json(
                value["software_set"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> GetSoftwareSetResponse:
    ...
    if "softwareSet" in data:
        ...
        out["software_set"] = (
            capo_workspaces_thin_client.types.software_set.deserialize_json(
                data["softwareSet"]
            )
        )
    return out
