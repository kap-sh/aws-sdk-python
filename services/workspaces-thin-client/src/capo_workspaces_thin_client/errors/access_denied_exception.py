"""Generated from Smithy shape ``com.amazonaws.workspacesthinclient#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.workspacesthinclient#AccessDeniedException``."""
