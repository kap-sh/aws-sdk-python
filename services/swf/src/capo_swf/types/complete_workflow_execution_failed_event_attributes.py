...
if TYPE_CHECKING:
    import capo_swf.types.complete_workflow_execution_failed_cause
    import capo_swf.types.event_id


class CompleteWorkflowExecutionFailedEventAttributes(TypedDict, closed=True):
    cause: "capo_swf.types.complete_workflow_execution_failed_cause.CompleteWorkflowExecutionFailedCause"
...
def serialize_aws_json_1_0(
    ...
    out["cause"] = (
        capo_swf.types.complete_workflow_execution_failed_cause.serialize_aws_json_1_0(
            value["cause"]
        )
    )
...
def deserialize_aws_json_1_0(
    ...
    if "cause" in data:
        ...
        out["cause"] = (
            capo_swf.types.complete_workflow_execution_failed_cause.deserialize_aws_json_1_0(
                data["cause"]
            )
        )
    else:
