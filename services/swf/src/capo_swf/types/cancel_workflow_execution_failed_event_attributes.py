...
class CancelWorkflowExecutionFailedEventAttributes(TypedDict, closed=True):
    cause: "capo_swf.types.cancel_workflow_execution_failed_cause.CancelWorkflowExecutionFailedCause"
...
def serialize_aws_json_1_0(value: CancelWorkflowExecutionFailedEventAttributes) -> dict:
    ...
    out["cause"] = (
        capo_swf.types.cancel_workflow_execution_failed_cause.serialize_aws_json_1_0(
            value["cause"]
        )
    )
...
def deserialize_aws_json_1_0(
    ...
    if "cause" in data:
        ...
        out["cause"] = (
            capo_swf.types.cancel_workflow_execution_failed_cause.deserialize_aws_json_1_0(
                data["cause"]
            )
        )
    else:
