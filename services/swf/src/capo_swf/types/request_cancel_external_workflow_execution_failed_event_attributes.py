...
class RequestCancelExternalWorkflowExecutionFailedEventAttributes(
    ...
    cause: "capo_swf.types.request_cancel_external_workflow_execution_failed_cause.RequestCancelExternalWorkflowExecutionFailedCause"
...
def serialize_aws_json_1_0(
    ...
    out["cause"] = (
        capo_swf.types.request_cancel_external_workflow_execution_failed_cause.serialize_aws_json_1_0(
            value["cause"]
        )
    )
...
def deserialize_aws_json_1_0(
    ...
    if "cause" in data:
        ...
        out["cause"] = (
            capo_swf.types.request_cancel_external_workflow_execution_failed_cause.deserialize_aws_json_1_0(
                data["cause"]
            )
        )
    else:
