"""Generated from Smithy shape ``com.amazonaws.swf#CountOpenWorkflowExecutions``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.count_open_workflow_executions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_count_open_workflow_executions(
