"""Generated from Smithy shape ``com.amazonaws.swf#UndeprecateDomain``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.undeprecate_domain_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_undeprecate_domain(
