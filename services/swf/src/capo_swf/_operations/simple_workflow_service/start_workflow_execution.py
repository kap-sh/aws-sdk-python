"""Generated from Smithy shape ``com.amazonaws.swf#StartWorkflowExecution``."""
...
import capo_swf.errors.default_undefined_fault
import capo_swf.errors.limit_exceeded_fault
import capo_swf.errors.operation_not_permitted_fault
import capo_swf.errors.type_deprecated_fault
import capo_swf.errors.unknown_resource_fault
import capo_swf.errors.workflow_execution_already_started_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DefaultUndefinedFault":
            raise capo_swf.errors.default_undefined_fault.DefaultUndefinedFault.from_aws_json_1_0(
                data
            )
        ...
        case "TypeDeprecatedFault":
            raise capo_swf.errors.type_deprecated_fault.TypeDeprecatedFault.from_aws_json_1_0(
                data
            )
        ...
        case "WorkflowExecutionAlreadyStartedFault":
            raise capo_swf.errors.workflow_execution_already_started_fault.WorkflowExecutionAlreadyStartedFault.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(response: zapros.Response) -> capo_swf.types.run.Run:
    out: capo_swf.types.run.Run = capo_swf.types.run.deserialize_aws_json_1_0(
        json.loads(response.read())
    )
    return out


async def async_handle_response(response: zapros.Response) -> capo_swf.types.run.Run:
    out: capo_swf.types.run.Run = capo_swf.types.run.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.start_workflow_execution_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def start_workflow_execution(
    ...
    input_: capo_swf.types.start_workflow_execution_input.StartWorkflowExecutionInput,
) -> tuple[capo_swf.types.run.Run, zapros.Response]:
...
async def async_start_workflow_execution(
