"""Generated from Smithy shape ``com.amazonaws.swf#RecordActivityTaskHeartbeat``."""
...
def handle_response(
    ...
    out: capo_swf.types.activity_task_status.ActivityTaskStatus = (
        capo_swf.types.activity_task_status.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.record_activity_task_heartbeat_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
def record_activity_task_heartbeat(
    ...
    input_: capo_swf.types.record_activity_task_heartbeat_input.RecordActivityTaskHeartbeatInput,
) -> tuple[capo_swf.types.activity_task_status.ActivityTaskStatus, zapros.Response]:
...
async def async_record_activity_task_heartbeat(
