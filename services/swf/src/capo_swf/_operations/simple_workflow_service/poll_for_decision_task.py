"""Generated from Smithy shape ``com.amazonaws.swf#PollForDecisionTask``."""
...
def handle_response(
    ...
    out: capo_swf.types.decision_task.DecisionTask = (
        capo_swf.types.decision_task.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.poll_for_decision_task_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def poll_for_decision_task(
    ...
    input_: capo_swf.types.poll_for_decision_task_input.PollForDecisionTaskInput,
) -> tuple[capo_swf.types.decision_task.DecisionTask, zapros.Response]:
...
async def async_poll_for_decision_task(
