...
import capo_swf.errors.domain_deprecated_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DomainDeprecatedFault":
            raise capo_swf.errors.domain_deprecated_fault.DomainDeprecatedFault.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.deprecate_domain_input.serialize_aws_json_1_0(input_)
    ).encode()
