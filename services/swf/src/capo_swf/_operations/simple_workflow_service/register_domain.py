"""Generated from Smithy shape ``com.amazonaws.swf#RegisterDomain``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DomainAlreadyExistsFault":
            raise capo_swf.errors.domain_already_exists_fault.DomainAlreadyExistsFault.from_aws_json_1_0(
                data
            )
        ...
        case "TooManyTagsFault":
            raise capo_swf.errors.too_many_tags_fault.TooManyTagsFault.from_aws_json_1_0(
                data
            )
        case _:
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.register_domain_input.serialize_aws_json_1_0(input_)
    ).encode()
