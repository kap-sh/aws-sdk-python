"""Generated from Smithy shape ``com.amazonaws.swf#RequestCancelWorkflowExecution``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.request_cancel_workflow_execution_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_request_cancel_workflow_execution(
