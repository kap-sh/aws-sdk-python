"""Generated from Smithy shape ``com.amazonaws.swf#DeprecateActivityType``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.deprecate_activity_type_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_deprecate_activity_type(
