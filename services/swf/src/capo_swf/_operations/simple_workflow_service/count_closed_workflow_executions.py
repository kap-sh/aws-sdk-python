"""Generated from Smithy shape ``com.amazonaws.swf#CountClosedWorkflowExecutions``."""
...
def handle_response(
    ...
    out: capo_swf.types.workflow_execution_count.WorkflowExecutionCount = (
        capo_swf.types.workflow_execution_count.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.count_closed_workflow_executions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
def count_closed_workflow_executions(
    ...
    capo_swf.types.workflow_execution_count.WorkflowExecutionCount, zapros.Response
]:
...
async def async_count_closed_workflow_executions(
