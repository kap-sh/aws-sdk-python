...
import capo_swf.errors.type_not_deprecated_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TypeNotDeprecatedFault":
            raise capo_swf.errors.type_not_deprecated_fault.TypeNotDeprecatedFault.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.delete_activity_type_input.serialize_aws_json_1_0(input_)
    ).encode()
