"""Generated from Smithy shape ``com.amazonaws.swf#ListActivityTypes``."""
...
def handle_response(
    ...
    out: capo_swf.types.activity_type_infos.ActivityTypeInfos = (
        capo_swf.types.activity_type_infos.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.list_activity_types_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_activity_types(
    ...
    input_: capo_swf.types.list_activity_types_input.ListActivityTypesInput,
) -> tuple[capo_swf.types.activity_type_infos.ActivityTypeInfos, zapros.Response]:
...
async def async_list_activity_types(
