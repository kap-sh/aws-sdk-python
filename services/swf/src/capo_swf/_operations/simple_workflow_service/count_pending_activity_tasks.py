"""Generated from Smithy shape ``com.amazonaws.swf#CountPendingActivityTasks``."""
...
def handle_response(
    ...
    out: capo_swf.types.pending_task_count.PendingTaskCount = (
        capo_swf.types.pending_task_count.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.count_pending_activity_tasks_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def count_pending_activity_tasks(
    ...
    input_: capo_swf.types.count_pending_activity_tasks_input.CountPendingActivityTasksInput,
) -> tuple[capo_swf.types.pending_task_count.PendingTaskCount, zapros.Response]:
...
async def async_count_pending_activity_tasks(
