...
class SWFError(Exception):
    """Base class for all SWF service errors."""


class ServiceError(SWFError):
...
class SerializationError(SWFError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SWFError):
...
class WaiterFailedError(SWFError):
...
class WaiterTimeoutError(SWFError):
