...
if TYPE_CHECKING:
    ...
    import aws_sdk_swf.types.start_child_workflow_execution_failed_cause
    import aws_sdk_swf.types.workflow_id
    import aws_sdk_swf.types.workflow_type


class StartChildWorkflowExecutionFailedEventAttributes(TypedDict):
    ...
    cause: "aws_sdk_swf.types.start_child_workflow_execution_failed_cause.StartChildWorkflowExecutionFailedCause"
...
def serialize_aws_json_1_0(
    ...
    out["cause"] = (
        aws_sdk_swf.types.start_child_workflow_execution_failed_cause.serialize_aws_json_1_0(
            value["cause"]
        )
    )
...
def deserialize_aws_json_1_0(
    ...
    if "cause" in data:
        ...
        out["cause"] = (
            aws_sdk_swf.types.start_child_workflow_execution_failed_cause.deserialize_aws_json_1_0(
                data["cause"]
            )
        )
    else:
