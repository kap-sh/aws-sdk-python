...
ActivityTypeInfoList: TypeAlias = list[
    "aws_sdk_swf.types.activity_type_info.ActivityTypeInfo"
]
...
def serialize_aws_json_1_0(value: ActivityTypeInfoList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_swf.types.activity_type_info.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> ActivityTypeInfoList:
    ...
    for item in data:
        out.append(aws_sdk_swf.types.activity_type_info.deserialize_aws_json_1_0(item))
    return out
