...
class WorkflowExecutionInfos(TypedDict):
    execution_infos: (
        "aws_sdk_swf.types.workflow_execution_info_list.WorkflowExecutionInfoList"
    )
...
def serialize_aws_json_1_0(value: WorkflowExecutionInfos) -> dict:
    ...
    out["executionInfos"] = (
        aws_sdk_swf.types.workflow_execution_info_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> WorkflowExecutionInfos:
    ...
    if "executionInfos" in data:
        ...
        out["execution_infos"] = (
            aws_sdk_swf.types.workflow_execution_info_list.deserialize_aws_json_1_0(
                data["executionInfos"]
            )
        )
    else:
