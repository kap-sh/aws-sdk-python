...
class DomainInfos(TypedDict):
    domain_infos: "aws_sdk_swf.types.domain_info_list.DomainInfoList"
...
def serialize_aws_json_1_0(value: DomainInfos) -> dict:
    ...
    out["domainInfos"] = aws_sdk_swf.types.domain_info_list.serialize_aws_json_1_0(
        value["domain_infos"]
    )
...
def deserialize_aws_json_1_0(data: dict) -> DomainInfos:
    ...
    if "domainInfos" in data:
        ...
        out["domain_infos"] = (
            aws_sdk_swf.types.domain_info_list.deserialize_aws_json_1_0(
                data["domainInfos"]
            )
        )
    else:
