...
if TYPE_CHECKING:
    ...
    import aws_sdk_swf.types.fail_workflow_execution_failed_cause


class FailWorkflowExecutionFailedEventAttributes(TypedDict):
    cause: "aws_sdk_swf.types.fail_workflow_execution_failed_cause.FailWorkflowExecutionFailedCause"
...
def serialize_aws_json_1_0(value: FailWorkflowExecutionFailedEventAttributes) -> dict:
    ...
    out["cause"] = (
        aws_sdk_swf.types.fail_workflow_execution_failed_cause.serialize_aws_json_1_0(
            value["cause"]
        )
    )
...
def deserialize_aws_json_1_0(data: dict) -> FailWorkflowExecutionFailedEventAttributes:
    ...
    if "cause" in data:
        ...
        out["cause"] = (
            aws_sdk_swf.types.fail_workflow_execution_failed_cause.deserialize_aws_json_1_0(
                data["cause"]
            )
        )
    else:
