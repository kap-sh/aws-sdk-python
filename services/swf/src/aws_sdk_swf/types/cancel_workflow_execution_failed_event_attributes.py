"""Generated from Smithy shape ``com.amazonaws.swf#CancelWorkflowExecutionFailedEventAttributes``."""
...
if TYPE_CHECKING:
    import aws_sdk_swf.types.cancel_workflow_execution_failed_cause
    import aws_sdk_swf.types.event_id


class CancelWorkflowExecutionFailedEventAttributes(TypedDict, closed=True):
    cause: "aws_sdk_swf.types.cancel_workflow_execution_failed_cause.CancelWorkflowExecutionFailedCause"
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CancelWorkflowExecutionFailedEventAttributes) -> dict:
    out: dict = {}
    import aws_sdk_swf.types.cancel_workflow_execution_failed_cause

    out["cause"] = (
        aws_sdk_swf.types.cancel_workflow_execution_failed_cause.serialize_aws_json_1_0(
            value["cause"]
        )
    )
...
def deserialize_aws_json_1_0(
    ...
    if "cause" in data:
        ...
        out["cause"] = (
            aws_sdk_swf.types.cancel_workflow_execution_failed_cause.deserialize_aws_json_1_0(
                data["cause"]
            )
        )
    else:
