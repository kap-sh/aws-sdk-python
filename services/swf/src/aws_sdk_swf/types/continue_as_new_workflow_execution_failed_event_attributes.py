...
if TYPE_CHECKING:
    import aws_sdk_swf.types.continue_as_new_workflow_execution_failed_cause
    import aws_sdk_swf.types.event_id


class ContinueAsNewWorkflowExecutionFailedEventAttributes(TypedDict, closed=True):
    cause: "aws_sdk_swf.types.continue_as_new_workflow_execution_failed_cause.ContinueAsNewWorkflowExecutionFailedCause"
...
def serialize_aws_json_1_0(
    ...
    out["cause"] = (
        aws_sdk_swf.types.continue_as_new_workflow_execution_failed_cause.serialize_aws_json_1_0(
            value["cause"]
        )
    )
...
def deserialize_aws_json_1_0(
    ...
    if "cause" in data:
        ...
        out["cause"] = (
            aws_sdk_swf.types.continue_as_new_workflow_execution_failed_cause.deserialize_aws_json_1_0(
                data["cause"]
            )
        )
    else:
