...
def handle_response(
    ...
    out: aws_sdk_swf.types.activity_task_status.ActivityTaskStatus = (
        aws_sdk_swf.types.activity_task_status.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.record_activity_task_heartbeat_input.RecordActivityTaskHeartbeatInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.record_activity_task_heartbeat_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
def record_activity_task_heartbeat(
    ...
    input_: aws_sdk_swf.types.record_activity_task_heartbeat_input.RecordActivityTaskHeartbeatInput,
) -> tuple[aws_sdk_swf.types.activity_task_status.ActivityTaskStatus, zapros.Response]:
