...
def build_request(
    ...
    input: aws_sdk_swf.types.signal_workflow_execution_input.SignalWorkflowExecutionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.signal_workflow_execution_input.serialize_aws_json_1_0(input)
    ).encode()
