...
def build_request(
    ...
    input_: aws_sdk_swf.types.poll_for_decision_task_input.PollForDecisionTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.poll_for_decision_task_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def poll_for_decision_task(
    ...
    input_: aws_sdk_swf.types.poll_for_decision_task_input.PollForDecisionTaskInput,
) -> tuple[aws_sdk_swf.types.decision_task.DecisionTask, zapros.Response]:
