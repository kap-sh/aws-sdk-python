...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DomainAlreadyExistsFault":
            raise aws_sdk_swf.errors.domain_already_exists_fault.DomainAlreadyExistsFault.from_aws_json_1_0(
                data
            )
        ...
        case "TooManyTagsFault":
            raise aws_sdk_swf.errors.too_many_tags_fault.TooManyTagsFault.from_aws_json_1_0(
                data
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_swf.types.register_domain_input.RegisterDomainInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.register_domain_input.serialize_aws_json_1_0(input_)
    ).encode()
