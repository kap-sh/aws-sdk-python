...
def build_request(
    ...
    input: aws_sdk_swf.types.register_workflow_type_input.RegisterWorkflowTypeInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.register_workflow_type_input.serialize_aws_json_1_0(input)
    ).encode()
