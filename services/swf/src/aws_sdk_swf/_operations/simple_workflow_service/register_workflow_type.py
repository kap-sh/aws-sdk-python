"""Generated from Smithy shape ``com.amazonaws.swf#RegisterWorkflowType``."""
...
def build_request(
    ...
    input_: aws_sdk_swf.types.register_workflow_type_input.RegisterWorkflowTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.register_workflow_type_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_register_workflow_type(
