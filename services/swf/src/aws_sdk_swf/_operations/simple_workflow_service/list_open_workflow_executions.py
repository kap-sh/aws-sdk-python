...
def build_request(
    ...
    input_: aws_sdk_swf.types.list_open_workflow_executions_input.ListOpenWorkflowExecutionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.list_open_workflow_executions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
