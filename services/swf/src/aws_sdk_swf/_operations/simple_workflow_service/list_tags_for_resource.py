...
def build_request(
    ...
    input: aws_sdk_swf.types.list_tags_for_resource_input.ListTagsForResourceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.list_tags_for_resource_input.serialize_aws_json_1_0(input)
    ).encode()
