"""Generated from Smithy shape ``com.amazonaws.swf#CountPendingDecisionTasks``."""
...
def build_request(
    ...
    input_: aws_sdk_swf.types.count_pending_decision_tasks_input.CountPendingDecisionTasksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.count_pending_decision_tasks_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
def count_pending_decision_tasks(
    ...
    input_: aws_sdk_swf.types.count_pending_decision_tasks_input.CountPendingDecisionTasksInput,
) -> tuple[aws_sdk_swf.types.pending_task_count.PendingTaskCount, zapros.Response]:
...
async def async_count_pending_decision_tasks(
