...
def build_request(
    ...
    input: aws_sdk_swf.types.start_workflow_execution_input.StartWorkflowExecutionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.start_workflow_execution_input.serialize_aws_json_1_0(input)
    ).encode()
