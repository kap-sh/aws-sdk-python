...
import aws_sdk_swf.errors.default_undefined_fault
...
import aws_sdk_swf.errors.workflow_execution_already_started_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DefaultUndefinedFault":
            raise aws_sdk_swf.errors.default_undefined_fault.DefaultUndefinedFault.from_aws_json_1_0(
                data
            )
        ...
        case "WorkflowExecutionAlreadyStartedFault":
            raise aws_sdk_swf.errors.workflow_execution_already_started_fault.WorkflowExecutionAlreadyStartedFault.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(response: zapros.Response) -> aws_sdk_swf.types.run.Run:
    out: aws_sdk_swf.types.run.Run = aws_sdk_swf.types.run.deserialize_aws_json_1_0(
        json.loads(response.read())
    )
    return out


async def async_handle_response(response: zapros.Response) -> aws_sdk_swf.types.run.Run:
    out: aws_sdk_swf.types.run.Run = aws_sdk_swf.types.run.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.start_workflow_execution_input.StartWorkflowExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.start_workflow_execution_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def start_workflow_execution(
    ...
    input_: aws_sdk_swf.types.start_workflow_execution_input.StartWorkflowExecutionInput,
) -> tuple[aws_sdk_swf.types.run.Run, zapros.Response]:
