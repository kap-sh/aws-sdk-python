...
def build_request(
    ...
    input: aws_sdk_swf.types.undeprecate_activity_type_input.UndeprecateActivityTypeInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.undeprecate_activity_type_input.serialize_aws_json_1_0(input)
    ).encode()
