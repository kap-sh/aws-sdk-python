"""Generated from Smithy shape ``com.amazonaws.swf#DescribeWorkflowType``."""
...
def handle_response(
    ...
    out: aws_sdk_swf.types.workflow_type_detail.WorkflowTypeDetail = (
        aws_sdk_swf.types.workflow_type_detail.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.describe_workflow_type_input.DescribeWorkflowTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.describe_workflow_type_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def describe_workflow_type(
    ...
    input_: aws_sdk_swf.types.describe_workflow_type_input.DescribeWorkflowTypeInput,
) -> tuple[aws_sdk_swf.types.workflow_type_detail.WorkflowTypeDetail, zapros.Response]:
...
async def async_describe_workflow_type(
