"""Generated from Smithy shape ``com.amazonaws.swf#DeleteActivityType``."""
...
import aws_sdk_swf.errors.type_not_deprecated_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TypeNotDeprecatedFault":
            raise aws_sdk_swf.errors.type_not_deprecated_fault.TypeNotDeprecatedFault.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_swf.types.delete_activity_type_input.DeleteActivityTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SimpleWorkflowService.DeleteActivityType"
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.delete_activity_type_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_delete_activity_type(
