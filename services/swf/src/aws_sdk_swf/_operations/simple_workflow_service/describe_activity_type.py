...
def handle_response(
    ...
    out: aws_sdk_swf.types.activity_type_detail.ActivityTypeDetail = (
        aws_sdk_swf.types.activity_type_detail.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.describe_activity_type_input.DescribeActivityTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.describe_activity_type_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def describe_activity_type(
    ...
    input_: aws_sdk_swf.types.describe_activity_type_input.DescribeActivityTypeInput,
) -> tuple[aws_sdk_swf.types.activity_type_detail.ActivityTypeDetail, zapros.Response]:
