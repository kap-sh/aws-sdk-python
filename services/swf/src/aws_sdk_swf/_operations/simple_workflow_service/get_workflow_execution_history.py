"""Generated from Smithy shape ``com.amazonaws.swf#GetWorkflowExecutionHistory``."""
...
def handle_response(response: zapros.Response) -> aws_sdk_swf.types.history.History:
    out: aws_sdk_swf.types.history.History = (
        aws_sdk_swf.types.history.deserialize_aws_json_1_0(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_swf.types.history.History = (
        aws_sdk_swf.types.history.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.get_workflow_execution_history_input.GetWorkflowExecutionHistoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.get_workflow_execution_history_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
def get_workflow_execution_history(
    ...
    input_: aws_sdk_swf.types.get_workflow_execution_history_input.GetWorkflowExecutionHistoryInput,
) -> tuple[aws_sdk_swf.types.history.History, zapros.Response]:
...
async def async_get_workflow_execution_history(
