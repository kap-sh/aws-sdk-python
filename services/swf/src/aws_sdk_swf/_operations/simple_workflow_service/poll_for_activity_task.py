...
def build_request(
    ...
    input: aws_sdk_swf.types.poll_for_activity_task_input.PollForActivityTaskInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.poll_for_activity_task_input.serialize_aws_json_1_0(input)
    ).encode()
