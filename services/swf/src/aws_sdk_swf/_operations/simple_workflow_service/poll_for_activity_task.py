"""Generated from Smithy shape ``com.amazonaws.swf#PollForActivityTask``."""
...
def handle_response(
    ...
    out: aws_sdk_swf.types.activity_task.ActivityTask = (
        aws_sdk_swf.types.activity_task.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.poll_for_activity_task_input.PollForActivityTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.poll_for_activity_task_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def poll_for_activity_task(
    ...
    input_: aws_sdk_swf.types.poll_for_activity_task_input.PollForActivityTaskInput,
) -> tuple[aws_sdk_swf.types.activity_task.ActivityTask, zapros.Response]:
...
async def async_poll_for_activity_task(
