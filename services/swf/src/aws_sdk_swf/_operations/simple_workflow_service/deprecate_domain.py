"""Generated from Smithy shape ``com.amazonaws.swf#DeprecateDomain``."""
...
import aws_sdk_swf.errors.domain_deprecated_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DomainDeprecatedFault":
            raise aws_sdk_swf.errors.domain_deprecated_fault.DomainDeprecatedFault.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_swf.types.deprecate_domain_input.DeprecateDomainInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.deprecate_domain_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_deprecate_domain(
