"""Generated from Smithy shape ``com.amazonaws.swf#RegisterActivityType``."""
...
def build_request(
    ...
    input_: aws_sdk_swf.types.register_activity_type_input.RegisterActivityTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.register_activity_type_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_register_activity_type(
