...
def handle_response(
    ...
    out: aws_sdk_swf.types.workflow_type_infos.WorkflowTypeInfos = (
        aws_sdk_swf.types.workflow_type_infos.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.list_workflow_types_input.ListWorkflowTypesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.list_workflow_types_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_workflow_types(
    ...
    input_: aws_sdk_swf.types.list_workflow_types_input.ListWorkflowTypesInput,
) -> tuple[aws_sdk_swf.types.workflow_type_infos.WorkflowTypeInfos, zapros.Response]:
