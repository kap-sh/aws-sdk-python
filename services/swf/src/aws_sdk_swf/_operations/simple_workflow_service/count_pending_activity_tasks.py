...
def build_request(
    ...
    input_: aws_sdk_swf.types.count_pending_activity_tasks_input.CountPendingActivityTasksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.count_pending_activity_tasks_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
