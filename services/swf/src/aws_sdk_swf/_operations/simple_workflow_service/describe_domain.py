...
def handle_response(
    ...
    out: aws_sdk_swf.types.domain_detail.DomainDetail = (
        aws_sdk_swf.types.domain_detail.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.describe_domain_input.DescribeDomainInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.describe_domain_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def describe_domain(
    ...
    input_: aws_sdk_swf.types.describe_domain_input.DescribeDomainInput,
) -> tuple[aws_sdk_swf.types.domain_detail.DomainDetail, zapros.Response]:
