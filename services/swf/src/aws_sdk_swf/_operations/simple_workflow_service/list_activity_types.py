...
def handle_response(
    ...
    out: aws_sdk_swf.types.activity_type_infos.ActivityTypeInfos = (
        aws_sdk_swf.types.activity_type_infos.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.list_activity_types_input.ListActivityTypesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.list_activity_types_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_activity_types(
    ...
    input_: aws_sdk_swf.types.list_activity_types_input.ListActivityTypesInput,
) -> tuple[aws_sdk_swf.types.activity_type_infos.ActivityTypeInfos, zapros.Response]:
