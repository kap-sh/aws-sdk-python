...
def build_request(
    ...
    input_: aws_sdk_swf.types.list_closed_workflow_executions_input.ListClosedWorkflowExecutionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.list_closed_workflow_executions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
def list_closed_workflow_executions(
    ...
    aws_sdk_swf.types.workflow_execution_infos.WorkflowExecutionInfos, zapros.Response
]:
