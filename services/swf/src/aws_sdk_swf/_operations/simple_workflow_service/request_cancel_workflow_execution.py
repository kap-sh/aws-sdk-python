...
def build_request(
    ...
    input_: aws_sdk_swf.types.request_cancel_workflow_execution_input.RequestCancelWorkflowExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.request_cancel_workflow_execution_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
