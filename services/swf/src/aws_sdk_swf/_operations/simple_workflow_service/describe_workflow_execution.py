...
def handle_response(
    ...
    out: aws_sdk_swf.types.workflow_execution_detail.WorkflowExecutionDetail = (
        aws_sdk_swf.types.workflow_execution_detail.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.describe_workflow_execution_input.DescribeWorkflowExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.describe_workflow_execution_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
def describe_workflow_execution(
    ...
    aws_sdk_swf.types.workflow_execution_detail.WorkflowExecutionDetail, zapros.Response
]:
