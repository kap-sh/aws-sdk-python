...
def handle_response(
    ...
    out: aws_sdk_swf.types.workflow_execution_count.WorkflowExecutionCount = (
        aws_sdk_swf.types.workflow_execution_count.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_swf.types.count_open_workflow_executions_input.CountOpenWorkflowExecutionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.count_open_workflow_executions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
def count_open_workflow_executions(
    ...
    aws_sdk_swf.types.workflow_execution_count.WorkflowExecutionCount, zapros.Response
]:
