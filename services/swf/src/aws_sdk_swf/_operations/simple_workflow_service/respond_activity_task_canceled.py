"""Generated from Smithy shape ``com.amazonaws.swf#RespondActivityTaskCanceled``."""
...
def build_request(
    ...
    input_: aws_sdk_swf.types.respond_activity_task_canceled_input.RespondActivityTaskCanceledInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_swf.types.respond_activity_task_canceled_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_respond_activity_task_canceled(
