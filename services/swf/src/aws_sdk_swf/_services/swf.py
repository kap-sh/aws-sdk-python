...
class SWFClientConfig(TypedDict, total=False):
...
class SWFClient:
    ...
    def count_closed_workflow_executions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.count_closed_workflow_executions_input.CountClosedWorkflowExecutionsInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.workflow_execution_count.WorkflowExecutionCount"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.count_closed_workflow_executions.count_closed_workflow_executions(
    ...
    def count_open_workflow_executions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.count_open_workflow_executions_input.CountOpenWorkflowExecutionsInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.workflow_execution_count.WorkflowExecutionCount"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.count_open_workflow_executions.count_open_workflow_executions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def count_pending_activity_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.count_pending_activity_tasks_input.CountPendingActivityTasksInput]",
        ) -> OperationResponse["aws_sdk_swf.types.pending_task_count.PendingTaskCount"]:
            import aws_sdk_swf._operations.simple_workflow_service.count_pending_activity_tasks

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.count_pending_activity_tasks.count_pending_activity_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def count_pending_decision_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.count_pending_decision_tasks_input.CountPendingDecisionTasksInput]",
        ) -> OperationResponse["aws_sdk_swf.types.pending_task_count.PendingTaskCount"]:
            import aws_sdk_swf._operations.simple_workflow_service.count_pending_decision_tasks

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.count_pending_decision_tasks.count_pending_decision_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_activity_type(
        ...
        *,
        ...
        """<p>Deletes the specified <i>activity type</i>.</p> <p>Note: Prior to deletion, activity types must first be <b>deprecated</b>. </p> <p> After an activity type has been deleted, you cannot schedule new activities of that type. Activities that started before the type was deleted will continue to run. </p> <p> <b>Access Control</b> </p> <p>You can use IAM policies to control this action's access to Amazon SWF resources as follows:</p> <ul> <li> <p>Use a <code>Resource</code> element with the domain name to limit the action to only specified domains.</p> </li> <li> <p>Use an <code>Action</code> element to allow or deny permission to call this action.</p> </li> <li> <p>Constrain the following parameters by using a <code>Condition</code> element with the appropriate keys.</p> <ul> <li> <p> <code>activityType.name</code>: String constraint. The key is <code>swf:activityType.name</code>.</p> </li> <li> <p> <code>activityType.version</code>: String constraint. The key is <code>swf:activityType.version</code>.</p> </li> </ul> </li> </ul> <p>If the caller doesn't have sufficient permissions to invoke the action, or the parameter values fall outside the specified constraints, the action fails. The associated event attribute's <code>cause</code> parameter is set to <code>OPERATION_NOT_PERMITTED</code>. For details and example IAM policies, see <a href=\"https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html\">Using IAM to Manage Access to Amazon SWF Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.delete_activity_type_input.DeleteActivityTypeInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.delete_activity_type

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.delete_activity_type.delete_activity_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_workflow_type(
        ...
        *,
        ...
        """<p>Deletes the specified <i>workflow type</i>.</p> <p>Note: Prior to deletion, workflow types must first be <b>deprecated</b>.</p> <p> After a workflow type has been deleted, you cannot create new executions of that type. Executions that started before the type was deleted will continue to run. </p> <p> <b>Access Control</b> </p> <p>You can use IAM policies to control this action's access to Amazon SWF resources as follows:</p> <ul> <li> <p>Use a <code>Resource</code> element with the domain name to limit the action to only specified domains.</p> </li> <li> <p>Use an <code>Action</code> element to allow or deny permission to call this action.</p> </li> <li> <p>Constrain the following parameters by using a <code>Condition</code> element with the appropriate keys.</p> <ul> <li> <p> <code>workflowType.name</code>: String constraint. The key is <code>swf:workflowType.name</code>.</p> </li> <li> <p> <code>workflowType.version</code>: String constraint. The key is <code>swf:workflowType.version</code>.</p> </li> </ul> </li> </ul> <p>If the caller doesn't have sufficient permissions to invoke the action, or the parameter values fall outside the specified constraints, the action fails. The associated event attribute's <code>cause</code> parameter is set to <code>OPERATION_NOT_PERMITTED</code>. For details and example IAM policies, see <a href=\"https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html\">Using IAM to Manage Access to Amazon SWF Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.delete_workflow_type_input.DeleteWorkflowTypeInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.delete_workflow_type

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.delete_workflow_type.delete_workflow_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deprecate_activity_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.deprecate_activity_type_input.DeprecateActivityTypeInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.deprecate_activity_type

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.deprecate_activity_type.deprecate_activity_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deprecate_domain(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.deprecate_domain_input.DeprecateDomainInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.deprecate_domain

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.deprecate_domain.deprecate_domain(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deprecate_workflow_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.deprecate_workflow_type_input.DeprecateWorkflowTypeInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.deprecate_workflow_type

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.deprecate_workflow_type.deprecate_workflow_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_activity_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.describe_activity_type_input.DescribeActivityTypeInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.activity_type_detail.ActivityTypeDetail"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.describe_activity_type.describe_activity_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_domain(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.describe_domain_input.DescribeDomainInput]",
        ) -> OperationResponse["aws_sdk_swf.types.domain_detail.DomainDetail"]:
            import aws_sdk_swf._operations.simple_workflow_service.describe_domain

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.describe_domain.describe_domain(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workflow_execution(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.describe_workflow_execution_input.DescribeWorkflowExecutionInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.workflow_execution_detail.WorkflowExecutionDetail"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.describe_workflow_execution.describe_workflow_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workflow_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.describe_workflow_type_input.DescribeWorkflowTypeInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.workflow_type_detail.WorkflowTypeDetail"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.describe_workflow_type.describe_workflow_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_workflow_execution_history(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.get_workflow_execution_history_input.GetWorkflowExecutionHistoryInput]",
        ) -> OperationResponse["aws_sdk_swf.types.history.History"]:
            import aws_sdk_swf._operations.simple_workflow_service.get_workflow_execution_history

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.get_workflow_execution_history.get_workflow_execution_history(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_workflow_execution_history(
        ...
        *,
        ...
        maximum_page_size: Optional["aws_sdk_swf.types.page_size.PageSize"] = None,
        reverse_order: Optional["aws_sdk_swf.types.reverse_order.ReverseOrder"] = None,
    ) -> "Iterator[aws_sdk_swf.types.history_event.HistoryEvent]":
    ...
    def list_activity_types(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.list_activity_types_input.ListActivityTypesInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.activity_type_infos.ActivityTypeInfos"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.list_activity_types.list_activity_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_activity_types(
        ...
        *,
        ...
        maximum_page_size: Optional["aws_sdk_swf.types.page_size.PageSize"] = None,
        reverse_order: Optional["aws_sdk_swf.types.reverse_order.ReverseOrder"] = None,
    ) -> "Iterator[aws_sdk_swf.types.activity_type_info.ActivityTypeInfo]":
        _token = next_page_token
        while True:
    ...
    def list_closed_workflow_executions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.list_closed_workflow_executions_input.ListClosedWorkflowExecutionsInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.workflow_execution_infos.WorkflowExecutionInfos"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.list_closed_workflow_executions.list_closed_workflow_executions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_closed_workflow_executions(
        ...
        *,
        ...
        maximum_page_size: Optional["aws_sdk_swf.types.page_size.PageSize"] = None,
        reverse_order: Optional["aws_sdk_swf.types.reverse_order.ReverseOrder"] = None,
    ) -> "Iterator[aws_sdk_swf.types.workflow_execution_info.WorkflowExecutionInfo]":
        _token = next_page_token
        while True:
    ...
    def list_domains(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.list_domains_input.ListDomainsInput]",
        ) -> OperationResponse["aws_sdk_swf.types.domain_infos.DomainInfos"]:
            import aws_sdk_swf._operations.simple_workflow_service.list_domains

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.list_domains.list_domains(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_domains(
        ...
        *,
        ...
        maximum_page_size: Optional["aws_sdk_swf.types.page_size.PageSize"] = None,
        reverse_order: Optional["aws_sdk_swf.types.reverse_order.ReverseOrder"] = None,
    ) -> "Iterator[aws_sdk_swf.types.domain_info.DomainInfo]":
        _token = next_page_token
        while True:
    ...
    def list_open_workflow_executions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.list_open_workflow_executions_input.ListOpenWorkflowExecutionsInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.workflow_execution_infos.WorkflowExecutionInfos"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.list_open_workflow_executions.list_open_workflow_executions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_workflow_types(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.list_workflow_types_input.ListWorkflowTypesInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.workflow_type_infos.WorkflowTypeInfos"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.list_workflow_types.list_workflow_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_workflow_types(
        ...
        *,
        ...
        maximum_page_size: Optional["aws_sdk_swf.types.page_size.PageSize"] = None,
        reverse_order: Optional["aws_sdk_swf.types.reverse_order.ReverseOrder"] = None,
    ) -> "Iterator[aws_sdk_swf.types.workflow_type_info.WorkflowTypeInfo]":
        _token = next_page_token
        while True:
    ...
    def poll_for_activity_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.poll_for_activity_task_input.PollForActivityTaskInput]",
        ) -> OperationResponse["aws_sdk_swf.types.activity_task.ActivityTask"]:
            import aws_sdk_swf._operations.simple_workflow_service.poll_for_activity_task

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.poll_for_activity_task.poll_for_activity_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def poll_for_decision_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.poll_for_decision_task_input.PollForDecisionTaskInput]",
        ) -> OperationResponse["aws_sdk_swf.types.decision_task.DecisionTask"]:
            import aws_sdk_swf._operations.simple_workflow_service.poll_for_decision_task

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.poll_for_decision_task.poll_for_decision_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def record_activity_task_heartbeat(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.record_activity_task_heartbeat_input.RecordActivityTaskHeartbeatInput]",
        ) -> OperationResponse[
            "aws_sdk_swf.types.activity_task_status.ActivityTaskStatus"
        ]:
            ...
            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.record_activity_task_heartbeat.record_activity_task_heartbeat(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_activity_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.register_activity_type_input.RegisterActivityTypeInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.register_activity_type

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.register_activity_type.register_activity_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_domain(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.register_domain_input.RegisterDomainInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.register_domain

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.register_domain.register_domain(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_workflow_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.register_workflow_type_input.RegisterWorkflowTypeInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.register_workflow_type

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.register_workflow_type.register_workflow_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def request_cancel_workflow_execution(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.request_cancel_workflow_execution_input.RequestCancelWorkflowExecutionInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.request_cancel_workflow_execution

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.request_cancel_workflow_execution.request_cancel_workflow_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def respond_activity_task_canceled(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.respond_activity_task_canceled_input.RespondActivityTaskCanceledInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.respond_activity_task_canceled

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.respond_activity_task_canceled.respond_activity_task_canceled(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def respond_activity_task_completed(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.respond_activity_task_completed_input.RespondActivityTaskCompletedInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.respond_activity_task_completed

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.respond_activity_task_completed.respond_activity_task_completed(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def respond_activity_task_failed(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.respond_activity_task_failed_input.RespondActivityTaskFailedInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.respond_activity_task_failed

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.respond_activity_task_failed.respond_activity_task_failed(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def respond_decision_task_completed(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.respond_decision_task_completed_input.RespondDecisionTaskCompletedInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.respond_decision_task_completed

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.respond_decision_task_completed.respond_decision_task_completed(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def signal_workflow_execution(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.signal_workflow_execution_input.SignalWorkflowExecutionInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.signal_workflow_execution

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.signal_workflow_execution.signal_workflow_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_workflow_execution(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.start_workflow_execution_input.StartWorkflowExecutionInput]",
        ) -> OperationResponse["aws_sdk_swf.types.run.Run"]:
            import aws_sdk_swf._operations.simple_workflow_service.start_workflow_execution

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.start_workflow_execution.start_workflow_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.tag_resource

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def terminate_workflow_execution(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.terminate_workflow_execution_input.TerminateWorkflowExecutionInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.terminate_workflow_execution

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.terminate_workflow_execution.terminate_workflow_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def undeprecate_activity_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.undeprecate_activity_type_input.UndeprecateActivityTypeInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.undeprecate_activity_type

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.undeprecate_activity_type.undeprecate_activity_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def undeprecate_domain(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.undeprecate_domain_input.UndeprecateDomainInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.undeprecate_domain

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.undeprecate_domain.undeprecate_domain(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def undeprecate_workflow_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.undeprecate_workflow_type_input.UndeprecateWorkflowTypeInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.undeprecate_workflow_type

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.undeprecate_workflow_type.undeprecate_workflow_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_swf.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_swf._operations.simple_workflow_service.untag_resource

            output, http_response = (
                aws_sdk_swf._operations.simple_workflow_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
