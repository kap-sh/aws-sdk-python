...
class DescribeVoicesInput(TypedDict, closed=True):
    ...
    include_additional_language_codes: "capo_polly.types.include_additional_language_codes.IncludeAdditionalLanguageCodes"
