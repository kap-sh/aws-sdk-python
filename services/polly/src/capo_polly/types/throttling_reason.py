...
if TYPE_CHECKING:
    import capo_polly.types.coral_availability_throttled_resource
    import capo_polly.types.coral_availability_throttling_reason


class ThrottlingReason(TypedDict, closed=True):
    reason: NotRequired[
        "capo_polly.types.coral_availability_throttling_reason.CoralAvailabilityThrottlingReason"
    ]
    """<p>The reason code explaining why the request was throttled.</p>"""
    resource: NotRequired[
        "capo_polly.types.coral_availability_throttled_resource.CoralAvailabilityThrottledResource"
    ]
