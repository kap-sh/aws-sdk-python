...
def handle_response(
    ...
    out: capo_polly.types.delete_lexicon_output.DeleteLexiconOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_lexicon(
    ...
    input_: capo_polly.types.delete_lexicon_input.DeleteLexiconInput,
) -> tuple[capo_polly.types.delete_lexicon_output.DeleteLexiconOutput, zapros.Response]:
