...
def handle_response(
    ...
    out: capo_polly.types.get_lexicon_output.GetLexiconOutput = (
        capo_polly.types.get_lexicon_output.deserialize_json(
...
def build_request(
    ...
    input_: capo_polly.types.get_lexicon_input.GetLexiconInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_lexicon(
    ...
    input_: capo_polly.types.get_lexicon_input.GetLexiconInput,
) -> tuple[capo_polly.types.get_lexicon_output.GetLexiconOutput, zapros.Response]:
