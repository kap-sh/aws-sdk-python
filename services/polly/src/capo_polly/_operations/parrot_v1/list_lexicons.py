"""Generated from Smithy shape ``com.amazonaws.polly#ListLexicons``."""
...
def handle_response(
    ...
    out: capo_polly.types.list_lexicons_output.ListLexiconsOutput = (
        capo_polly.types.list_lexicons_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/lexicons"
    params: dict[str, str] = {}
...
def list_lexicons(
    ...
    input_: capo_polly.types.list_lexicons_input.ListLexiconsInput,
) -> tuple[capo_polly.types.list_lexicons_output.ListLexiconsOutput, zapros.Response]:
