...
def build_request(
    ...
    input: aws_sdk_polly.types.start_speech_synthesis_task_input.StartSpeechSynthesisTaskInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_polly.types.start_speech_synthesis_task_input.serialize_json(input)
    ).encode()
