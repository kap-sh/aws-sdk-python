...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidTaskIdException":
            import aws_sdk_polly.errors.invalid_task_id_exception

            raise aws_sdk_polly.errors.invalid_task_id_exception.InvalidTaskIdException.from_json(
                data
            )
        ...
        case "SynthesisTaskNotFoundException":
            import aws_sdk_polly.errors.synthesis_task_not_found_exception

            raise aws_sdk_polly.errors.synthesis_task_not_found_exception.SynthesisTaskNotFoundException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_polly.types.get_speech_synthesis_task_output.GetSpeechSynthesisTaskOutput = aws_sdk_polly.types.get_speech_synthesis_task_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_polly.types.get_speech_synthesis_task_input.GetSpeechSynthesisTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
