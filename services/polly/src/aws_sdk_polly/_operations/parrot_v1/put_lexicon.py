...
def build_request(
    ...
    input_: aws_sdk_polly.types.put_lexicon_input.PutLexiconInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_polly.types.put_lexicon_input.serialize_json(input_)
    ).encode()
...
def put_lexicon(
    ...
    input_: aws_sdk_polly.types.put_lexicon_input.PutLexiconInput,
) -> tuple[aws_sdk_polly.types.put_lexicon_output.PutLexiconOutput, zapros.Response]:
