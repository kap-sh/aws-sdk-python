...
def build_request(
    ...
    input_: aws_sdk_polly.types.synthesize_speech_input.SynthesizeSpeechInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_polly.types.synthesize_speech_input.serialize_json(input_)
    ).encode()
...
def synthesize_speech(
    ...
    aws_sdk_polly.types.synthesize_speech_output.SynthesizeSpeechOutput, zapros.Response
]:
