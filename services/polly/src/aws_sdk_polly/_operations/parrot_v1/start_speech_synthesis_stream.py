...
from aws_sdk_polly._protocol.eventstream import (
    MessageDecoder,
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_polly.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case "ThrottlingException":
            raise aws_sdk_polly.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
        case "ValidationException":
            raise aws_sdk_polly.errors.validation_exception.ValidationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    _union_deser = aws_sdk_polly.types.start_speech_synthesis_stream_event_stream.deserialize_event_json
    _iter = cast(Any, response.iter_bytes())
    out: aws_sdk_polly.types.start_speech_synthesis_stream_output.StartSpeechSynthesisStreamOutput = {
        "event_stream": cast(
...
def build_request(
    ...
    input_: aws_sdk_polly.types.start_speech_synthesis_stream_input.StartSpeechSynthesisStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
