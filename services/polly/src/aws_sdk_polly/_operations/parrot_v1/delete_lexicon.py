"""Generated from Smithy shape ``com.amazonaws.polly#DeleteLexicon``."""
...
def handle_response(
    ...
    out: aws_sdk_polly.types.delete_lexicon_output.DeleteLexiconOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_polly.types.delete_lexicon_input.DeleteLexiconInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_lexicon(
    ...
    aws_sdk_polly.types.delete_lexicon_output.DeleteLexiconOutput, zapros.Response
]:
...
async def async_delete_lexicon(
