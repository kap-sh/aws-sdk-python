"""Generated from Smithy shape ``com.amazonaws.polly#GetLexicon``."""
...
def handle_response(
    ...
    out: aws_sdk_polly.types.get_lexicon_output.GetLexiconOutput = (
        aws_sdk_polly.types.get_lexicon_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_polly.types.get_lexicon_input.GetLexiconInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_lexicon(
    ...
    input_: aws_sdk_polly.types.get_lexicon_input.GetLexiconInput,
) -> tuple[aws_sdk_polly.types.get_lexicon_output.GetLexiconOutput, zapros.Response]:
