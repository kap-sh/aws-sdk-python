...
def handle_response(
    ...
    out: aws_sdk_polly.types.list_lexicons_output.ListLexiconsOutput = (
        aws_sdk_polly.types.list_lexicons_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_polly.types.list_lexicons_input.ListLexiconsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_lexicons(
    ...
    aws_sdk_polly.types.list_lexicons_output.ListLexiconsOutput, zapros.Response
]:
