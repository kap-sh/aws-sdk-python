...
class PollyClientConfig(TypedDict, total=False):
...
class PollyClient:
    ...
    def delete_lexicon(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_polly.types.delete_lexicon_input.DeleteLexiconInput]",
        ) -> OperationResponse[
            "aws_sdk_polly.types.delete_lexicon_output.DeleteLexiconOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_polly._operations.parrot_v1.delete_lexicon.delete_lexicon(
    ...
    def describe_voices(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_polly.types.describe_voices_input.DescribeVoicesInput]",
        ) -> OperationResponse[
            "aws_sdk_polly.types.describe_voices_output.DescribeVoicesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_polly._operations.parrot_v1.describe_voices.describe_voices(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_lexicon(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_polly.types.get_lexicon_input.GetLexiconInput]",
        ) -> OperationResponse[
            "aws_sdk_polly.types.get_lexicon_output.GetLexiconOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_polly._operations.parrot_v1.get_lexicon.get_lexicon(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_speech_synthesis_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_polly.types.get_speech_synthesis_task_input.GetSpeechSynthesisTaskInput]",
        ) -> OperationResponse[
            "aws_sdk_polly.types.get_speech_synthesis_task_output.GetSpeechSynthesisTaskOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_polly._operations.parrot_v1.get_speech_synthesis_task.get_speech_synthesis_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_lexicons(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_polly.types.list_lexicons_input.ListLexiconsInput]",
        ) -> OperationResponse[
            "aws_sdk_polly.types.list_lexicons_output.ListLexiconsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_polly._operations.parrot_v1.list_lexicons.list_lexicons(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_speech_synthesis_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_polly.types.list_speech_synthesis_tasks_input.ListSpeechSynthesisTasksInput]",
        ) -> OperationResponse[
            "aws_sdk_polly.types.list_speech_synthesis_tasks_output.ListSpeechSynthesisTasksOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_polly._operations.parrot_v1.list_speech_synthesis_tasks.list_speech_synthesis_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_lexicon(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_polly.types.put_lexicon_input.PutLexiconInput]",
        ) -> OperationResponse[
            "aws_sdk_polly.types.put_lexicon_output.PutLexiconOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_polly._operations.parrot_v1.put_lexicon.put_lexicon(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_speech_synthesis_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_polly.types.start_speech_synthesis_stream_input.StartSpeechSynthesisStreamInput]",
        ) -> OperationResponse[
            "aws_sdk_polly.types.start_speech_synthesis_stream_output.StartSpeechSynthesisStreamOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_polly._operations.parrot_v1.start_speech_synthesis_stream.start_speech_synthesis_stream(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_speech_synthesis_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_polly.types.start_speech_synthesis_task_input.StartSpeechSynthesisTaskInput]",
        ) -> OperationResponse[
            "aws_sdk_polly.types.start_speech_synthesis_task_output.StartSpeechSynthesisTaskOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_polly._operations.parrot_v1.start_speech_synthesis_task.start_speech_synthesis_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def synthesize_speech(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_polly.types.synthesize_speech_input.SynthesizeSpeechInput]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                aws_sdk_polly._operations.parrot_v1.synthesize_speech.synthesize_speech(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
