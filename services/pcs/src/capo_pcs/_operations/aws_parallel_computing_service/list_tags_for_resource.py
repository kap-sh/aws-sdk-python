"""Generated from Smithy shape ``com.amazonaws.pcs#ListTagsForResource``."""
...
import capo_pcs.types.response_tag_map
...
def handle_response(
    ...
    out: capo_pcs.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_pcs.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSParallelComputingService.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_pcs.types.list_tags_for_resource_request.serialize_aws_json_1_0(input_)
    ).encode()
