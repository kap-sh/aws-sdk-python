...
def handle_response(
    ...
    out: capo_pcs.types.update_queue_response.UpdateQueueResponse = (
        capo_pcs.types.update_queue_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pcs.types.update_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_queue(
    ...
    input_: capo_pcs.types.update_queue_request.UpdateQueueRequest,
) -> tuple[capo_pcs.types.update_queue_response.UpdateQueueResponse, zapros.Response]:
