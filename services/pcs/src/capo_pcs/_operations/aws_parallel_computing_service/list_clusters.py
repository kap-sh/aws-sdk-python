...
def handle_response(
    ...
    out: capo_pcs.types.list_clusters_response.ListClustersResponse = (
        capo_pcs.types.list_clusters_response.deserialize_aws_json_1_0(
...
def list_clusters(
    ...
    input_: capo_pcs.types.list_clusters_request.ListClustersRequest,
) -> tuple[capo_pcs.types.list_clusters_response.ListClustersResponse, zapros.Response]:
