...
def handle_response(
    ...
    out: capo_pcs.types.delete_compute_node_group_response.DeleteComputeNodeGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pcs.types.delete_compute_node_group_request.serialize_aws_json_1_0(input_)
    ).encode()
