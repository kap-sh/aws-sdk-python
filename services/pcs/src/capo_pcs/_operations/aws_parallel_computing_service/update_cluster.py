...
def handle_response(
    ...
    out: capo_pcs.types.update_cluster_response.UpdateClusterResponse = (
        capo_pcs.types.update_cluster_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pcs.types.update_cluster_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_cluster(
    ...
    capo_pcs.types.update_cluster_response.UpdateClusterResponse, zapros.Response
]:
