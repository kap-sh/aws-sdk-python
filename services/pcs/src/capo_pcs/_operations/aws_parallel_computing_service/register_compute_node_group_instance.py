"""Generated from Smithy shape ``com.amazonaws.pcs#RegisterComputeNodeGroupInstance``."""
...
def handle_response(
    ...
    out: capo_pcs.types.register_compute_node_group_instance_response.RegisterComputeNodeGroupInstanceResponse = capo_pcs.types.register_compute_node_group_instance_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pcs.types.register_compute_node_group_instance_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_register_compute_node_group_instance(
