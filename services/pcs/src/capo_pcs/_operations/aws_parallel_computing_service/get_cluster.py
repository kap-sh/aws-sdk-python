...
def handle_response(
    ...
    out: capo_pcs.types.get_cluster_response.GetClusterResponse = (
        capo_pcs.types.get_cluster_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pcs.types.get_cluster_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_cluster(
    ...
    input_: capo_pcs.types.get_cluster_request.GetClusterRequest,
) -> tuple[capo_pcs.types.get_cluster_response.GetClusterResponse, zapros.Response]:
