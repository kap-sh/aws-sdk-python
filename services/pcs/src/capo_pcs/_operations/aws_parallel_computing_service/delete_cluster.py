...
def handle_response(
    ...
    out: capo_pcs.types.delete_cluster_response.DeleteClusterResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pcs.types.delete_cluster_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_cluster(
    ...
    capo_pcs.types.delete_cluster_response.DeleteClusterResponse, zapros.Response
]:
