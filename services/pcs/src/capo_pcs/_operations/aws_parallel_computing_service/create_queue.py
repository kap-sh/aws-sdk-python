...
def handle_response(
    ...
    out: capo_pcs.types.create_queue_response.CreateQueueResponse = (
        capo_pcs.types.create_queue_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pcs.types.create_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_queue(
    ...
    input_: capo_pcs.types.create_queue_request.CreateQueueRequest,
) -> tuple[capo_pcs.types.create_queue_response.CreateQueueResponse, zapros.Response]:
