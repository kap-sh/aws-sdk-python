"""Generated from Smithy shape ``com.amazonaws.pcs#ListQueuesRequest``."""
...
class ListQueuesRequest(TypedDict, closed=True):
    ...
    max_results: "capo_pcs.types.max_results.MaxResults"
...
def deserialize_aws_json_1_0(data: dict) -> ListQueuesRequest:
    ...
    if "clusterIdentifier" in data:
        ...
        raise DeserializationError("ListQueuesRequest.cluster_identifier required")
