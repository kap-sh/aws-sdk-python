...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: GetComputeNodeGroupResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> GetComputeNodeGroupResponse:
    out: GetComputeNodeGroupResponse = {}  # type: ignore[typeddict-item]
