...
class ListTagsForResourceResponse(TypedDict, closed=True):
    tags: NotRequired["capo_pcs.types.response_tag_map.ResponseTagMap"]
...
def serialize_aws_json_1_0(value: ListTagsForResourceResponse) -> dict:
    ...
    if "tags" in value:
        ...
        out["tags"] = capo_pcs.types.response_tag_map.serialize_aws_json_1_0(
            value["tags"]
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ListTagsForResourceResponse:
    ...
    if "tags" in data:
        ...
        out["tags"] = capo_pcs.types.response_tag_map.deserialize_aws_json_1_0(
            data["tags"]
        )
    return out
