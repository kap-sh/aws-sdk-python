...
class PCSError(Exception):
    """Base class for all PCS service errors."""
...
class SerializationError(PCSError):
    """Raised when a value cannot be serialized."""

class DeserializationError(PCSError):
...
class WaiterFailedError(PCSError):
...
class WaiterTimeoutError(PCSError):
