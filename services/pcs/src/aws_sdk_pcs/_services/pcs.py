...
from aws_sdk_pcs._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class PCSClient:
    ...
    def __init__(self, http_handler: BaseHandler | None = None, operation_interceptors: Iterable[Interceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_dual_stack: bool | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = PCSClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_dual_stack": use_dual_stack, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[PCSClientConfig] = None) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
    ...
    def list_tags_for_resource(self, resource_arn: "aws_sdk_pcs.types.arn.Arn", *, config_overrides: Optional[PCSClientConfig] = None) -> "aws_sdk_pcs.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_pcs.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> OperationResponse["aws_sdk_pcs.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_pcs._operations.aws_parallel_computing_service.list_tags_for_resource
            output, http_response = aws_sdk_pcs._operations.aws_parallel_computing_service.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
    ...
    def tag_resource(self, resource_arn: "aws_sdk_pcs.types.arn.Arn", tags: "aws_sdk_pcs.types.request_tag_map.RequestTagMap", *, config_overrides: Optional[PCSClientConfig] = None) -> "aws_sdk_pcs.types.tag_resource_response.TagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_pcs.types.tag_resource_request.TagResourceRequest]') -> OperationResponse["aws_sdk_pcs.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_pcs._operations.aws_parallel_computing_service.tag_resource
            output, http_response = aws_sdk_pcs._operations.aws_parallel_computing_service.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: "aws_sdk_pcs.types.arn.Arn", tag_keys: "aws_sdk_pcs.types.tag_keys.TagKeys", *, config_overrides: Optional[PCSClientConfig] = None) -> "aws_sdk_pcs.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_pcs.types.untag_resource_request.UntagResourceRequest]') -> OperationResponse["aws_sdk_pcs.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_pcs._operations.aws_parallel_computing_service.untag_resource
            output, http_response = aws_sdk_pcs._operations.aws_parallel_computing_service.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
