...
from aws_sdk_pcs._auth._signers import SigV4Signer
from aws_sdk_pcs._auth._sigv4 import presign_sigv4
...
from aws_sdk_pcs._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_pcs._async import anysleep
import time
from aws_sdk_pcs.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
from aws_sdk_pcs._auth._identity import Credentials
from aws_sdk_pcs._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
if TYPE_CHECKING:
...
class AsyncPCSClient:
    ...
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_pcs.types.arn.Arn", *, config_overrides: Optional[AsyncPCSClientConfig] = None) -> "aws_sdk_pcs.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_pcs.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> AsyncOperationResponse["aws_sdk_pcs.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_pcs._operations.aws_parallel_computing_service.list_tags_for_resource
            output, http_response = await aws_sdk_pcs._operations.aws_parallel_computing_service.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_pcs.types.list_tags_for_resource_request.ListTagsForResourceRequest = {}  # type: ignore[typeddict-item]
        input["resource_arn"] = resource_arn

        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def tag_resource(self, resource_arn: "aws_sdk_pcs.types.arn.Arn", tags: "aws_sdk_pcs.types.request_tag_map.RequestTagMap", *, config_overrides: Optional[AsyncPCSClientConfig] = None) -> "aws_sdk_pcs.types.tag_resource_response.TagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_pcs.types.tag_resource_request.TagResourceRequest]') -> AsyncOperationResponse["aws_sdk_pcs.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_pcs._operations.aws_parallel_computing_service.tag_resource
            output, http_response = await aws_sdk_pcs._operations.aws_parallel_computing_service.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_pcs.types.tag_resource_request.TagResourceRequest = {}  # type: ignore[typeddict-item]
        input["resource_arn"] = resource_arn
        input["tags"] = tags

        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_pcs.types.arn.Arn", tag_keys: "aws_sdk_pcs.types.tag_keys.TagKeys", *, config_overrides: Optional[AsyncPCSClientConfig] = None) -> "aws_sdk_pcs.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_pcs.types.untag_resource_request.UntagResourceRequest]') -> AsyncOperationResponse["aws_sdk_pcs.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_pcs._operations.aws_parallel_computing_service.untag_resource
            output, http_response = await aws_sdk_pcs._operations.aws_parallel_computing_service.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_pcs.types.untag_resource_request.UntagResourceRequest = {}  # type: ignore[typeddict-item]
        input["resource_arn"] = resource_arn
