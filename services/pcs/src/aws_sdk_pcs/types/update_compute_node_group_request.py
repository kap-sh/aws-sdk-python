...
if TYPE_CHECKING:
    ...
    import aws_sdk_pcs.types.compute_node_group_identifier
...
class UpdateComputeNodeGroupRequest(TypedDict, closed=True):
    ...
    compute_node_group_identifier: (
        "aws_sdk_pcs.types.compute_node_group_identifier.ComputeNodeGroupIdentifier"
    )
    ...
    subnet_ids: NotRequired["aws_sdk_pcs.types.string_list.StringList"]
    ...
    slurm_configuration: NotRequired[
        "aws_sdk_pcs.types.update_compute_node_group_slurm_configuration_request.UpdateComputeNodeGroupSlurmConfigurationRequest"
    ]
...
def serialize_aws_json_1_0(value: UpdateComputeNodeGroupRequest) -> dict:
    ...
    if "slurm_configuration" in value:
        ...
        out["slurmConfiguration"] = (
            aws_sdk_pcs.types.update_compute_node_group_slurm_configuration_request.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> UpdateComputeNodeGroupRequest:
    ...
    if "slurmConfiguration" in data:
        ...
        out["slurm_configuration"] = (
            aws_sdk_pcs.types.update_compute_node_group_slurm_configuration_request.deserialize_aws_json_1_0(
