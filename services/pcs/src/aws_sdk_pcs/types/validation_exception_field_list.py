...
if TYPE_CHECKING:
    import aws_sdk_pcs.types.validation_exception_field

ValidationExceptionFieldList: TypeAlias = list[
    "aws_sdk_pcs.types.validation_exception_field.ValidationExceptionField"
]
...
def serialize_aws_json_1_0(value: ValidationExceptionFieldList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_pcs.types.validation_exception_field.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ValidationExceptionFieldList:
    ...
    for item in data:
        out.append(
            aws_sdk_pcs.types.validation_exception_field.deserialize_aws_json_1_0(item)
        )
    return out
