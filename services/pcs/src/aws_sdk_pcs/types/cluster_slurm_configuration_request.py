...
if TYPE_CHECKING:
    ...
    import aws_sdk_pcs.types.slurm_rest_request
...
class ClusterSlurmConfigurationRequest(TypedDict):
    ...
    accounting: NotRequired["aws_sdk_pcs.types.accounting_request.AccountingRequest"]
    """<p>The accounting configuration includes configurable settings for Slurm accounting.</p>"""
    slurm_rest: NotRequired["aws_sdk_pcs.types.slurm_rest_request.SlurmRestRequest"]
...
def serialize_aws_json_1_0(value: ClusterSlurmConfigurationRequest) -> dict:
    ...
    if "accounting" in value:
        ...
        out["accounting"] = aws_sdk_pcs.types.accounting_request.serialize_aws_json_1_0(
            value["accounting"]
        )
    if "slurm_rest" in value:
        import aws_sdk_pcs.types.slurm_rest_request

        out["slurmRest"] = aws_sdk_pcs.types.slurm_rest_request.serialize_aws_json_1_0(
            value["slurm_rest"]
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ClusterSlurmConfigurationRequest:
    ...
    if "accounting" in data:
        ...
        out["accounting"] = (
            aws_sdk_pcs.types.accounting_request.deserialize_aws_json_1_0(
                data["accounting"]
            )
        )
    if "slurmRest" in data:
        ...
        out["slurm_rest"] = (
            aws_sdk_pcs.types.slurm_rest_request.deserialize_aws_json_1_0(
                data["slurmRest"]
            )
        )
    return out
