"""Generated from Smithy shape ``com.amazonaws.pcs#ComputeNodeGroupSlurmConfiguration``."""
...
class ComputeNodeGroupSlurmConfiguration(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ComputeNodeGroupSlurmConfiguration) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ComputeNodeGroupSlurmConfiguration:
    out: ComputeNodeGroupSlurmConfiguration = {}  # type: ignore[typeddict-item]
