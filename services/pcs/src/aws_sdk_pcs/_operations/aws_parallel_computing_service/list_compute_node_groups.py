...
) -> aws_sdk_pcs.types.list_compute_node_groups_response.ListComputeNodeGroupsResponse:
    import aws_sdk_pcs.types.list_compute_node_groups_response

    out: aws_sdk_pcs.types.list_compute_node_groups_response.ListComputeNodeGroupsResponse = aws_sdk_pcs.types.list_compute_node_groups_response.deserialize_aws_json_1_0(
...
def get_signer(
...
) -> aws_sdk_pcs._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_pcs._auth._sigv4.build_sigv4_auth_scheme("pcs", options.region)
        )
        if sigv4_config is not None:
            return aws_sdk_pcs._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input: aws_sdk_pcs.types.list_compute_node_groups_request.ListComputeNodeGroupsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.list_compute_node_groups_request.serialize_aws_json_1_0(input)
    ).encode()
...
async def async_list_compute_node_groups(
