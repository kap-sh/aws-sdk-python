...
def build_request(
    ...
    input_: aws_sdk_pcs.types.list_compute_node_groups_request.ListComputeNodeGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.list_compute_node_groups_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
