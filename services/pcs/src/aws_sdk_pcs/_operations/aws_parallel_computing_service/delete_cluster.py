...
def build_request(
    ...
    input_: aws_sdk_pcs.types.delete_cluster_request.DeleteClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.delete_cluster_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_cluster(
    ...
    aws_sdk_pcs.types.delete_cluster_response.DeleteClusterResponse, zapros.Response
]:
