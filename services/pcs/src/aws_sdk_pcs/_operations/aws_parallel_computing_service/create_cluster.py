...
def handle_response(
    ...
    out: aws_sdk_pcs.types.create_cluster_response.CreateClusterResponse = (
        aws_sdk_pcs.types.create_cluster_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_pcs.types.create_cluster_request.CreateClusterRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.create_cluster_request.serialize_aws_json_1_0(input)
    ).encode()
...
def create_cluster(
    ...
    aws_sdk_pcs.types.create_cluster_response.CreateClusterResponse, zapros.Response
]:
