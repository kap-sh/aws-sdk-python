...
def handle_response(
    ...
    aws_sdk_pcs.types.delete_compute_node_group_response.DeleteComputeNodeGroupResponse
):
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.delete_compute_node_group_request.DeleteComputeNodeGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.delete_compute_node_group_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_compute_node_group(
