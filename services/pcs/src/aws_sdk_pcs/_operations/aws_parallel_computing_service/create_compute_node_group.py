...
def build_request(
    ...
    input_: aws_sdk_pcs.types.create_compute_node_group_request.CreateComputeNodeGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.create_compute_node_group_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
