...
) -> aws_sdk_pcs.types.create_queue_response.CreateQueueResponse:
    out: aws_sdk_pcs.types.create_queue_response.CreateQueueResponse = (
        aws_sdk_pcs.types.create_queue_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.create_queue_request.CreateQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.create_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_queue(
    ...
    aws_sdk_pcs.types.create_queue_response.CreateQueueResponse, zapros.Response
]:
