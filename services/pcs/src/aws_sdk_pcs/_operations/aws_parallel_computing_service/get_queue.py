...
) -> aws_sdk_pcs.types.get_queue_response.GetQueueResponse:
    import aws_sdk_pcs.types.get_queue_response

    out: aws_sdk_pcs.types.get_queue_response.GetQueueResponse = (
        aws_sdk_pcs.types.get_queue_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.get_queue_request.GetQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.get_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_queue(
    ...
    input_: aws_sdk_pcs.types.get_queue_request.GetQueueRequest,
) -> tuple[aws_sdk_pcs.types.get_queue_response.GetQueueResponse, zapros.Response]:
