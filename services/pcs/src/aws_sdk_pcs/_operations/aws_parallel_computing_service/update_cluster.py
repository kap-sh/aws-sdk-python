...
def handle_response(
    ...
    out: aws_sdk_pcs.types.update_cluster_response.UpdateClusterResponse = (
        aws_sdk_pcs.types.update_cluster_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.update_cluster_request.UpdateClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.update_cluster_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_cluster(
    ...
    aws_sdk_pcs.types.update_cluster_response.UpdateClusterResponse, zapros.Response
]:
