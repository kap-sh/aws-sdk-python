...
) -> aws_sdk_pcs.types.update_queue_response.UpdateQueueResponse:
    import aws_sdk_pcs.types.update_queue_response

    out: aws_sdk_pcs.types.update_queue_response.UpdateQueueResponse = (
        aws_sdk_pcs.types.update_queue_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.update_queue_request.UpdateQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.update_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_queue(
    ...
    aws_sdk_pcs.types.update_queue_response.UpdateQueueResponse, zapros.Response
]:
