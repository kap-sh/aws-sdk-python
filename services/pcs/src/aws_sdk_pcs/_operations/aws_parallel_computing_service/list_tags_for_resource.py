...
def build_request(
    ...
    input: aws_sdk_pcs.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.list_tags_for_resource_request.serialize_aws_json_1_0(input)
    ).encode()
