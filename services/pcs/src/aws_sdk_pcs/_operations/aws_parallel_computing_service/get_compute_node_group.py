...
def build_request(
    ...
    input: aws_sdk_pcs.types.get_compute_node_group_request.GetComputeNodeGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.get_compute_node_group_request.serialize_aws_json_1_0(input)
    ).encode()
