...
) -> aws_sdk_pcs.types.get_compute_node_group_response.GetComputeNodeGroupResponse:
    import aws_sdk_pcs.types.get_compute_node_group_response

    out: aws_sdk_pcs.types.get_compute_node_group_response.GetComputeNodeGroupResponse = aws_sdk_pcs.types.get_compute_node_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.get_compute_node_group_request.GetComputeNodeGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.get_compute_node_group_request.serialize_aws_json_1_0(input_)
    ).encode()
