...
def handle_response(
    ...
    aws_sdk_pcs.types.update_compute_node_group_response.UpdateComputeNodeGroupResponse
):
    import aws_sdk_pcs.types.update_compute_node_group_response

    out: aws_sdk_pcs.types.update_compute_node_group_response.UpdateComputeNodeGroupResponse = aws_sdk_pcs.types.update_compute_node_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.update_compute_node_group_request.UpdateComputeNodeGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.update_compute_node_group_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
