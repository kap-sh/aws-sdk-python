...
) -> aws_sdk_pcs.types.list_queues_response.ListQueuesResponse:
    import aws_sdk_pcs.types.list_queues_response

    out: aws_sdk_pcs.types.list_queues_response.ListQueuesResponse = (
        aws_sdk_pcs.types.list_queues_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.list_queues_request.ListQueuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.list_queues_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_queues(
    ...
    input_: aws_sdk_pcs.types.list_queues_request.ListQueuesRequest,
) -> tuple[aws_sdk_pcs.types.list_queues_response.ListQueuesResponse, zapros.Response]:
