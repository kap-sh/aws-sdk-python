...
def handle_response(
    ...
    out: aws_sdk_pcs.types.get_cluster_response.GetClusterResponse = (
        aws_sdk_pcs.types.get_cluster_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.get_cluster_request.GetClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.get_cluster_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_cluster(
    ...
    input_: aws_sdk_pcs.types.get_cluster_request.GetClusterRequest,
) -> tuple[aws_sdk_pcs.types.get_cluster_response.GetClusterResponse, zapros.Response]:
