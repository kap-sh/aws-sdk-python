...
) -> aws_sdk_pcs.types.delete_queue_response.DeleteQueueResponse:
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.delete_queue_request.DeleteQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pcs.types.delete_queue_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_queue(
    ...
    aws_sdk_pcs.types.delete_queue_response.DeleteQueueResponse, zapros.Response
]:
