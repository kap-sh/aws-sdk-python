...
def handle_response(
    ...
    out: aws_sdk_pcs.types.list_clusters_response.ListClustersResponse = (
        aws_sdk_pcs.types.list_clusters_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_pcs.types.list_clusters_request.ListClustersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_clusters(
    ...
    aws_sdk_pcs.types.list_clusters_response.ListClustersResponse, zapros.Response
]:
