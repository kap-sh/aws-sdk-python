...
class kendraError(Exception):
    """Base class for all kendra service errors."""


class ServiceError(kendraError):
...
class SerializationError(kendraError):
    """Raised when a value cannot be serialized."""


class DeserializationError(kendraError):
...
class WaiterFailedError(kendraError):
...
class WaiterTimeoutError(kendraError):
