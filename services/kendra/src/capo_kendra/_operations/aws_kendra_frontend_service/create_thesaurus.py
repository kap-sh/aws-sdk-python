"""Generated from Smithy shape ``com.amazonaws.kendra#CreateThesaurus``."""
...
import capo_kendra.types.create_thesaurus_request
import capo_kendra.types.create_thesaurus_response
...
) -> capo_kendra.types.create_thesaurus_response.CreateThesaurusResponse:
    out: capo_kendra.types.create_thesaurus_response.CreateThesaurusResponse = (
        capo_kendra.types.create_thesaurus_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.CreateThesaurus"
    body: bytes | None = json.dumps(
        capo_kendra.types.create_thesaurus_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_thesaurus(
    ...
    capo_kendra.types.create_thesaurus_response.CreateThesaurusResponse, zapros.Response
]:
...
async def async_create_thesaurus(
