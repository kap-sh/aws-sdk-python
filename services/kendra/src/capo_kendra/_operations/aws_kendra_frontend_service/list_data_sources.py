"""Generated from Smithy shape ``com.amazonaws.kendra#ListDataSources``."""
...
import capo_kendra.types.data_source_summary_list
import capo_kendra.types.list_data_sources_request
import capo_kendra.types.list_data_sources_response
...
) -> capo_kendra.types.list_data_sources_response.ListDataSourcesResponse:
    out: capo_kendra.types.list_data_sources_response.ListDataSourcesResponse = (
        capo_kendra.types.list_data_sources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.list_data_sources_request.serialize_aws_json_1_1(input_)
    ).encode()
