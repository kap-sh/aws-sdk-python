"""Generated from Smithy shape ``com.amazonaws.kendra#BatchDeleteFeaturedResultsSet``."""
...
import capo_kendra.types.batch_delete_featured_results_set_request
import capo_kendra.types.batch_delete_featured_results_set_response
...
) -> capo_kendra.types.batch_delete_featured_results_set_response.BatchDeleteFeaturedResultsSetResponse:
    out: capo_kendra.types.batch_delete_featured_results_set_response.BatchDeleteFeaturedResultsSetResponse = capo_kendra.types.batch_delete_featured_results_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.BatchDeleteFeaturedResultsSet"
    body: bytes | None = json.dumps(
        capo_kendra.types.batch_delete_featured_results_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_delete_featured_results_set(
