"""Generated from Smithy shape ``com.amazonaws.kendra#DescribeDataSource``."""
...
import capo_kendra.types.describe_data_source_request
import capo_kendra.types.describe_data_source_response
...
) -> capo_kendra.types.describe_data_source_response.DescribeDataSourceResponse:
    out: capo_kendra.types.describe_data_source_response.DescribeDataSourceResponse = (
        capo_kendra.types.describe_data_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.describe_data_source_request.serialize_aws_json_1_1(input_)
    ).encode()
