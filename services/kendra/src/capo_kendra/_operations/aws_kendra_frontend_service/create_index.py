"""Generated from Smithy shape ``com.amazonaws.kendra#CreateIndex``."""
...
import capo_kendra.types.create_index_request
import capo_kendra.types.create_index_response
...
) -> capo_kendra.types.create_index_response.CreateIndexResponse:
    out: capo_kendra.types.create_index_response.CreateIndexResponse = (
        capo_kendra.types.create_index_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.create_index_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_index(
    ...
    capo_kendra.types.create_index_response.CreateIndexResponse, zapros.Response
]:
