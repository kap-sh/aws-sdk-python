"""Generated from Smithy shape ``com.amazonaws.kendra#DescribeQuerySuggestionsBlockList``."""
...
import capo_kendra.types.describe_query_suggestions_block_list_request
import capo_kendra.types.describe_query_suggestions_block_list_response
...
) -> capo_kendra.types.describe_query_suggestions_block_list_response.DescribeQuerySuggestionsBlockListResponse:
    out: capo_kendra.types.describe_query_suggestions_block_list_response.DescribeQuerySuggestionsBlockListResponse = capo_kendra.types.describe_query_suggestions_block_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.describe_query_suggestions_block_list_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_query_suggestions_block_list(
