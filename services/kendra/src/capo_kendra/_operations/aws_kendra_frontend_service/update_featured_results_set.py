"""Generated from Smithy shape ``com.amazonaws.kendra#UpdateFeaturedResultsSet``."""
...
import capo_kendra.errors.featured_results_conflict_exception
...
import capo_kendra.types.update_featured_results_set_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FeaturedResultsConflictException":
            raise capo_kendra.errors.featured_results_conflict_exception.FeaturedResultsConflictException.from_aws_json_1_1(
                data
            )
...
) -> capo_kendra.types.update_featured_results_set_response.UpdateFeaturedResultsSetResponse:
    out: capo_kendra.types.update_featured_results_set_response.UpdateFeaturedResultsSetResponse = capo_kendra.types.update_featured_results_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.UpdateFeaturedResultsSet"
    body: bytes | None = json.dumps(
        capo_kendra.types.update_featured_results_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_featured_results_set(
