"""Generated from Smithy shape ``com.amazonaws.kendra#GetQuerySuggestions``."""
...
import capo_kendra.types.get_query_suggestions_request
import capo_kendra.types.get_query_suggestions_response
...
) -> capo_kendra.types.get_query_suggestions_response.GetQuerySuggestionsResponse:
    out: capo_kendra.types.get_query_suggestions_response.GetQuerySuggestionsResponse = capo_kendra.types.get_query_suggestions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.GetQuerySuggestions"
    body: bytes | None = json.dumps(
        capo_kendra.types.get_query_suggestions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_query_suggestions(
