...
import capo_kendra.types.create_experience_request
import capo_kendra.types.create_experience_response
...
) -> capo_kendra.types.create_experience_response.CreateExperienceResponse:
    out: capo_kendra.types.create_experience_response.CreateExperienceResponse = (
        capo_kendra.types.create_experience_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.create_experience_request.serialize_aws_json_1_1(input_)
    ).encode()
