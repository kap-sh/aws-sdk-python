"""Generated from Smithy shape ``com.amazonaws.kendra#DescribeExperience``."""
...
import capo_kendra.types.describe_experience_request
import capo_kendra.types.describe_experience_response
...
) -> capo_kendra.types.describe_experience_response.DescribeExperienceResponse:
    out: capo_kendra.types.describe_experience_response.DescribeExperienceResponse = (
        capo_kendra.types.describe_experience_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.DescribeExperience"
    body: bytes | None = json.dumps(
        capo_kendra.types.describe_experience_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_experience(
