"""Generated from Smithy shape ``com.amazonaws.kendra#CreateFaq``."""
...
import capo_kendra.types.create_faq_request
import capo_kendra.types.create_faq_response
...
) -> capo_kendra.types.create_faq_response.CreateFaqResponse:
    out: capo_kendra.types.create_faq_response.CreateFaqResponse = (
        capo_kendra.types.create_faq_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.create_faq_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_faq(
    ...
    input_: capo_kendra.types.create_faq_request.CreateFaqRequest,
) -> tuple[capo_kendra.types.create_faq_response.CreateFaqResponse, zapros.Response]:
