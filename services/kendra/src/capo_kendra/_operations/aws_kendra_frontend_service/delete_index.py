"""Generated from Smithy shape ``com.amazonaws.kendra#DeleteIndex``."""
...
import capo_kendra.types.delete_index_request
...
def build_request(
    ...
    input_: capo_kendra.types.delete_index_request.DeleteIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.delete_index_request.serialize_aws_json_1_1(input_)
    ).encode()
