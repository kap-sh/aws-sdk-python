"""Generated from Smithy shape ``com.amazonaws.kendra#CreateDataSource``."""
...
import capo_kendra.errors.service_quota_exceeded_exception
import capo_kendra.errors.throttling_exception
import capo_kendra.errors.validation_exception
import capo_kendra.types.create_data_source_request
import capo_kendra.types.create_data_source_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_kendra.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
) -> capo_kendra.types.create_data_source_response.CreateDataSourceResponse:
    out: capo_kendra.types.create_data_source_response.CreateDataSourceResponse = (
        capo_kendra.types.create_data_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.create_data_source_request.serialize_aws_json_1_1(input_)
    ).encode()
