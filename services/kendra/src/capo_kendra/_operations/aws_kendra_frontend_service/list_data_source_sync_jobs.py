"""Generated from Smithy shape ``com.amazonaws.kendra#ListDataSourceSyncJobs``."""
...
import capo_kendra.types.list_data_source_sync_jobs_request
import capo_kendra.types.list_data_source_sync_jobs_response
...
def handle_response(
    ...
    capo_kendra.types.list_data_source_sync_jobs_response.ListDataSourceSyncJobsResponse
):
    out: capo_kendra.types.list_data_source_sync_jobs_response.ListDataSourceSyncJobsResponse = capo_kendra.types.list_data_source_sync_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.list_data_source_sync_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_data_source_sync_jobs(
