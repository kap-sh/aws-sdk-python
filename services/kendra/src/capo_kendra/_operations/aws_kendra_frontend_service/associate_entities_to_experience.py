"""Generated from Smithy shape ``com.amazonaws.kendra#AssociateEntitiesToExperience``."""
...
import capo_kendra.errors.resource_already_exist_exception
...
import capo_kendra.types.associate_entities_to_experience_request
import capo_kendra.types.associate_entities_to_experience_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAlreadyExistException":
            raise capo_kendra.errors.resource_already_exist_exception.ResourceAlreadyExistException.from_aws_json_1_1(
                data
            )
...
) -> capo_kendra.types.associate_entities_to_experience_response.AssociateEntitiesToExperienceResponse:
    out: capo_kendra.types.associate_entities_to_experience_response.AssociateEntitiesToExperienceResponse = capo_kendra.types.associate_entities_to_experience_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.AssociateEntitiesToExperience"
    body: bytes | None = json.dumps(
        capo_kendra.types.associate_entities_to_experience_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_entities_to_experience(
