"""Generated from Smithy shape ``com.amazonaws.kendra#GetSnapshots``."""
...
import capo_kendra.errors.invalid_request_exception
import capo_kendra.errors.resource_not_found_exception
import capo_kendra.types.get_snapshots_request
import capo_kendra.types.get_snapshots_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRequestException":
            raise capo_kendra.errors.invalid_request_exception.InvalidRequestException.from_aws_json_1_1(
                data
            )
...
) -> capo_kendra.types.get_snapshots_response.GetSnapshotsResponse:
    out: capo_kendra.types.get_snapshots_response.GetSnapshotsResponse = (
        capo_kendra.types.get_snapshots_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.GetSnapshots"
    body: bytes | None = json.dumps(
        capo_kendra.types.get_snapshots_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_snapshots(
    ...
    capo_kendra.types.get_snapshots_response.GetSnapshotsResponse, zapros.Response
]:
