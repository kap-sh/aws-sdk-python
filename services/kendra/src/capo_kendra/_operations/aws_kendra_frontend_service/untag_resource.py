"""Generated from Smithy shape ``com.amazonaws.kendra#UntagResource``."""
...
import capo_kendra.errors.resource_unavailable_exception
...
import capo_kendra.types.untag_resource_request
import capo_kendra.types.untag_resource_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceUnavailableException":
            raise capo_kendra.errors.resource_unavailable_exception.ResourceUnavailableException.from_aws_json_1_1(
                data
            )
...
) -> capo_kendra.types.untag_resource_response.UntagResourceResponse:
    out: capo_kendra.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.UntagResource"
    body: bytes | None = json.dumps(
        capo_kendra.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_kendra.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
