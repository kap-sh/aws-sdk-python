"""Generated from Smithy shape ``com.amazonaws.kendra#DescribeFaq``."""
...
import capo_kendra.types.describe_faq_request
import capo_kendra.types.describe_faq_response
...
) -> capo_kendra.types.describe_faq_response.DescribeFaqResponse:
    out: capo_kendra.types.describe_faq_response.DescribeFaqResponse = (
        capo_kendra.types.describe_faq_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.describe_faq_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_faq(
    ...
    capo_kendra.types.describe_faq_response.DescribeFaqResponse, zapros.Response
]:
