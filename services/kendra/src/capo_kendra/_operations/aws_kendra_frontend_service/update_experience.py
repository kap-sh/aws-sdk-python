"""Generated from Smithy shape ``com.amazonaws.kendra#UpdateExperience``."""
...
import capo_kendra.types.update_experience_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.UpdateExperience"
    body: bytes | None = json.dumps(
        capo_kendra.types.update_experience_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_experience(
