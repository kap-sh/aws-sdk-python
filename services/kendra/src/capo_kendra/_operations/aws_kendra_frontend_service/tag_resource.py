"""Generated from Smithy shape ``com.amazonaws.kendra#TagResource``."""
...
import capo_kendra.types.tag_resource_request
import capo_kendra.types.tag_resource_response
...
) -> capo_kendra.types.tag_resource_response.TagResourceResponse:
    out: capo_kendra.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.TagResource"
    body: bytes | None = json.dumps(
        capo_kendra.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_kendra.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
