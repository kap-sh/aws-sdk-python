"""Generated from Smithy shape ``com.amazonaws.kendra#ListExperiences``."""
...
import capo_kendra.types.list_experiences_request
import capo_kendra.types.list_experiences_response
...
) -> capo_kendra.types.list_experiences_response.ListExperiencesResponse:
    out: capo_kendra.types.list_experiences_response.ListExperiencesResponse = (
        capo_kendra.types.list_experiences_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.ListExperiences"
    body: bytes | None = json.dumps(
        capo_kendra.types.list_experiences_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_experiences(
    ...
    capo_kendra.types.list_experiences_response.ListExperiencesResponse, zapros.Response
]:
...
async def async_list_experiences(
