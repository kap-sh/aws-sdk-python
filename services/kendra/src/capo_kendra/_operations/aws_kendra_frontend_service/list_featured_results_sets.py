"""Generated from Smithy shape ``com.amazonaws.kendra#ListFeaturedResultsSets``."""
...
import capo_kendra.types.list_featured_results_sets_request
import capo_kendra.types.list_featured_results_sets_response
...
) -> capo_kendra.types.list_featured_results_sets_response.ListFeaturedResultsSetsResponse:
    out: capo_kendra.types.list_featured_results_sets_response.ListFeaturedResultsSetsResponse = capo_kendra.types.list_featured_results_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.ListFeaturedResultsSets"
    body: bytes | None = json.dumps(
        capo_kendra.types.list_featured_results_sets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_featured_results_sets(
