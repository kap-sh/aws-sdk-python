"""Generated from Smithy shape ``com.amazonaws.kendra#DescribeThesaurus``."""
...
import capo_kendra.types.describe_thesaurus_request
import capo_kendra.types.describe_thesaurus_response
...
) -> capo_kendra.types.describe_thesaurus_response.DescribeThesaurusResponse:
    out: capo_kendra.types.describe_thesaurus_response.DescribeThesaurusResponse = (
        capo_kendra.types.describe_thesaurus_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.DescribeThesaurus"
    body: bytes | None = json.dumps(
        capo_kendra.types.describe_thesaurus_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_thesaurus(
