"""Generated from Smithy shape ``com.amazonaws.kendra#DeleteDataSource``."""
...
import capo_kendra.types.delete_data_source_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.DeleteDataSource"
    body: bytes | None = json.dumps(
        capo_kendra.types.delete_data_source_request.serialize_aws_json_1_1(input_)
    ).encode()
