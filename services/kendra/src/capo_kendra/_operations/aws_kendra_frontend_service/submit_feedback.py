"""Generated from Smithy shape ``com.amazonaws.kendra#SubmitFeedback``."""
...
import capo_kendra.types.submit_feedback_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.submit_feedback_request.serialize_aws_json_1_1(input_)
    ).encode()
