"""Generated from Smithy shape ``com.amazonaws.kendra#UpdateIndex``."""
...
import capo_kendra.types.update_index_request
...
def build_request(
    ...
    input_: capo_kendra.types.update_index_request.UpdateIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.update_index_request.serialize_aws_json_1_1(input_)
    ).encode()
