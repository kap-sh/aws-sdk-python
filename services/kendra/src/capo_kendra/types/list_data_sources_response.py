...
class ListDataSourcesResponse(TypedDict, closed=True):
    summary_items: NotRequired[
        "capo_kendra.types.data_source_summary_list.DataSourceSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListDataSourcesResponse) -> dict:
    ...
    if "summary_items" in value:
        ...
        out["SummaryItems"] = (
            capo_kendra.types.data_source_summary_list.serialize_aws_json_1_1(
                value["summary_items"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDataSourcesResponse:
    ...
    if "SummaryItems" in data:
        ...
        out["summary_items"] = (
            capo_kendra.types.data_source_summary_list.deserialize_aws_json_1_1(
                data["SummaryItems"]
            )
        )
