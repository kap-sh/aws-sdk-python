...
if TYPE_CHECKING:
    import capo_kendra.types.failure_reason
...
class GroupOrderingIdSummary(TypedDict, closed=True):
    status: NotRequired[
        "capo_kendra.types.principal_mapping_status.PrincipalMappingStatus"
    ]
    ...
    last_updated_at: NotRequired["capo_kendra.types.timestamp.Timestamp"]
    ...
    received_at: NotRequired["capo_kendra.types.timestamp.Timestamp"]
    ...
    failure_reason: NotRequired["capo_kendra.types.failure_reason.FailureReason"]
...
def serialize_aws_json_1_1(value: GroupOrderingIdSummary) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            capo_kendra.types.principal_mapping_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    if "last_updated_at" in value:
        ...
        out["LastUpdatedAt"] = capo_kendra.types.timestamp.serialize_aws_json_1_1(
            value["last_updated_at"]
        )
    if "received_at" in value:
        import capo_kendra.types.timestamp

        out["ReceivedAt"] = capo_kendra.types.timestamp.serialize_aws_json_1_1(
            value["received_at"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> GroupOrderingIdSummary:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            capo_kendra.types.principal_mapping_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
