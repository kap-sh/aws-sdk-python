...
if TYPE_CHECKING:
    import capo_kendra.types.hierarchical_principal

HierarchicalPrincipalList: TypeAlias = list[
    "capo_kendra.types.hierarchical_principal.HierarchicalPrincipal"
]
...
def serialize_aws_json_1_1(value: HierarchicalPrincipalList) -> list:
    ...
    for item in value:
        out.append(
            capo_kendra.types.hierarchical_principal.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> HierarchicalPrincipalList:
    ...
    for item in data:
        out.append(
            capo_kendra.types.hierarchical_principal.deserialize_aws_json_1_1(item)
        )
    return out
