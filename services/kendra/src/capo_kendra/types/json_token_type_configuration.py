...
class JsonTokenTypeConfiguration(TypedDict, closed=True):
    user_name_attribute_field: "capo_kendra.types.string.String"
    """<p>The user name attribute field.</p>"""
    group_attribute_field: "capo_kendra.types.string.String"
