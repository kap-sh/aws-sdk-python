"""Generated from Smithy shape ``com.amazonaws.kendra#ConfluencePageToIndexFieldMapping``."""
...
if TYPE_CHECKING:
    import capo_kendra.types.confluence_page_field_name
    import capo_kendra.types.data_source_date_field_format
    import capo_kendra.types.index_field_name


class ConfluencePageToIndexFieldMapping(TypedDict, closed=True):
    data_source_field_name: NotRequired[
        "capo_kendra.types.confluence_page_field_name.ConfluencePageFieldName"
    ]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ConfluencePageToIndexFieldMapping) -> dict:
    out: dict = {}
    if "data_source_field_name" in value:
        import capo_kendra.types.confluence_page_field_name

        out["DataSourceFieldName"] = (
            capo_kendra.types.confluence_page_field_name.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ConfluencePageToIndexFieldMapping:
    out: ConfluencePageToIndexFieldMapping = {}  # type: ignore[typeddict-item]
    if "DataSourceFieldName" in data:
        import capo_kendra.types.confluence_page_field_name

        out["data_source_field_name"] = (
            capo_kendra.types.confluence_page_field_name.deserialize_aws_json_1_1(
