...
if TYPE_CHECKING:
    import capo_kendra.types.indexed_text_bytes
    import capo_kendra.types.indexed_text_documents_count


class TextDocumentStatistics(TypedDict, closed=True):
    indexed_text_documents_count: (
        "capo_kendra.types.indexed_text_documents_count.IndexedTextDocumentsCount"
    )
    """<p>The number of text documents indexed.</p>"""
    indexed_text_bytes: "capo_kendra.types.indexed_text_bytes.IndexedTextBytes"
