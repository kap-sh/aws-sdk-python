"""Generated from Smithy shape ``com.amazonaws.kendra#AssociatePersonasToEntitiesResponse``."""
...
class AssociatePersonasToEntitiesResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AssociatePersonasToEntitiesResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> AssociatePersonasToEntitiesResponse:
    out: AssociatePersonasToEntitiesResponse = {}  # type: ignore[typeddict-item]
