...
class DataSourceSyncJob(TypedDict, closed=True):
    execution_id: NotRequired["capo_kendra.types.string.String"]
    ...
    data_source_error_code: NotRequired["capo_kendra.types.string.String"]
    ...
    metrics: NotRequired[
        "capo_kendra.types.data_source_sync_job_metrics.DataSourceSyncJobMetrics"
    ]
...
def serialize_aws_json_1_1(value: DataSourceSyncJob) -> dict:
    ...
    if "metrics" in value:
        ...
        out["Metrics"] = (
            capo_kendra.types.data_source_sync_job_metrics.serialize_aws_json_1_1(
                value["metrics"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DataSourceSyncJob:
    ...
    if "Metrics" in data:
        ...
        out["metrics"] = (
            capo_kendra.types.data_source_sync_job_metrics.deserialize_aws_json_1_1(
                data["Metrics"]
            )
        )
    return out
