...
if TYPE_CHECKING:
    import aws_sdk_kendra.types.data_source_inclusions_exclusions_strings_member

DataSourceInclusionsExclusionsStrings: TypeAlias = list[
    "aws_sdk_kendra.types.data_source_inclusions_exclusions_strings_member.DataSourceInclusionsExclusionsStringsMember"
]
