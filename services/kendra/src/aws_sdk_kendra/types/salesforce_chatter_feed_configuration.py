...
class SalesforceChatterFeedConfiguration(TypedDict):
    ...
    include_filter_types: NotRequired[
        "aws_sdk_kendra.types.salesforce_chatter_feed_include_filter_types.SalesforceChatterFeedIncludeFilterTypes"
    ]
...
def serialize_aws_json_1_1(value: SalesforceChatterFeedConfiguration) -> dict:
    ...
    if "include_filter_types" in value:
        ...
        out["IncludeFilterTypes"] = (
            aws_sdk_kendra.types.salesforce_chatter_feed_include_filter_types.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SalesforceChatterFeedConfiguration:
    ...
    if "IncludeFilterTypes" in data:
        ...
        out["include_filter_types"] = (
            aws_sdk_kendra.types.salesforce_chatter_feed_include_filter_types.deserialize_aws_json_1_1(
