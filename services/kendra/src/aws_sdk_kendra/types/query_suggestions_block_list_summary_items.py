...
if TYPE_CHECKING:
    import aws_sdk_kendra.types.query_suggestions_block_list_summary

QuerySuggestionsBlockListSummaryItems: TypeAlias = list[
    "aws_sdk_kendra.types.query_suggestions_block_list_summary.QuerySuggestionsBlockListSummary"
]
...
def serialize_aws_json_1_1(value: QuerySuggestionsBlockListSummaryItems) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_kendra.types.query_suggestions_block_list_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> QuerySuggestionsBlockListSummaryItems:
    ...
    for item in data:
        out.append(
            aws_sdk_kendra.types.query_suggestions_block_list_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
