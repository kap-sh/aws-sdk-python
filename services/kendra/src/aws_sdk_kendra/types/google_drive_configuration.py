...
if TYPE_CHECKING:
    ...
    import aws_sdk_kendra.types.exclude_mime_types_list
    import aws_sdk_kendra.types.exclude_shared_drives_list
    import aws_sdk_kendra.types.exclude_user_accounts_list
...
class GoogleDriveConfiguration(TypedDict, closed=True):
    ...
    exclude_shared_drives: NotRequired[
        "aws_sdk_kendra.types.exclude_shared_drives_list.ExcludeSharedDrivesList"
    ]
...
def serialize_aws_json_1_1(value: GoogleDriveConfiguration) -> dict:
    ...
    if "exclude_mime_types" in value:
        ...
        out["ExcludeMimeTypes"] = (
            aws_sdk_kendra.types.exclude_mime_types_list.serialize_aws_json_1_1(
    ...
    if "exclude_user_accounts" in value:
        ...
        out["ExcludeUserAccounts"] = (
            aws_sdk_kendra.types.exclude_user_accounts_list.serialize_aws_json_1_1(
    ...
    if "exclude_shared_drives" in value:
        ...
        out["ExcludeSharedDrives"] = (
            aws_sdk_kendra.types.exclude_shared_drives_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GoogleDriveConfiguration:
    ...
    if "ExcludeMimeTypes" in data:
        ...
        out["exclude_mime_types"] = (
            aws_sdk_kendra.types.exclude_mime_types_list.deserialize_aws_json_1_1(
    ...
    if "ExcludeUserAccounts" in data:
        ...
        out["exclude_user_accounts"] = (
            aws_sdk_kendra.types.exclude_user_accounts_list.deserialize_aws_json_1_1(
    ...
    if "ExcludeSharedDrives" in data:
        ...
        out["exclude_shared_drives"] = (
            aws_sdk_kendra.types.exclude_shared_drives_list.deserialize_aws_json_1_1(
