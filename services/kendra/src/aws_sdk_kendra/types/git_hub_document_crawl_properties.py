...
class GitHubDocumentCrawlProperties(TypedDict):
    ...
    crawl_issue_comment: "aws_sdk_kendra.types.boolean.Boolean"
    """<p> <code>TRUE</code> to index all comments on issues.</p>"""
    crawl_issue_comment_attachment: "aws_sdk_kendra.types.boolean.Boolean"
    """<p> <code>TRUE</code> to include all comment attachments for issues.</p>"""
    crawl_pull_request: "aws_sdk_kendra.types.boolean.Boolean"
    """<p> <code>TRUE</code> to index all pull requests within a repository.</p>"""
    crawl_pull_request_comment: "aws_sdk_kendra.types.boolean.Boolean"
    """<p> <code>TRUE</code> to index all comments on pull requests.</p>"""
    crawl_pull_request_comment_attachment: "aws_sdk_kendra.types.boolean.Boolean"
