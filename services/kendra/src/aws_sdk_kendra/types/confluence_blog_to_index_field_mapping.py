...
if TYPE_CHECKING:
    import aws_sdk_kendra.types.confluence_blog_field_name
    import aws_sdk_kendra.types.data_source_date_field_format
    import aws_sdk_kendra.types.index_field_name


class ConfluenceBlogToIndexFieldMapping(TypedDict):
    data_source_field_name: NotRequired[
        "aws_sdk_kendra.types.confluence_blog_field_name.ConfluenceBlogFieldName"
    ]
...
def serialize_aws_json_1_1(value: ConfluenceBlogToIndexFieldMapping) -> dict:
    ...
    if "data_source_field_name" in value:
        ...
        out["DataSourceFieldName"] = (
            aws_sdk_kendra.types.confluence_blog_field_name.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ConfluenceBlogToIndexFieldMapping:
    ...
    if "DataSourceFieldName" in data:
        ...
        out["data_source_field_name"] = (
            aws_sdk_kendra.types.confluence_blog_field_name.deserialize_aws_json_1_1(
