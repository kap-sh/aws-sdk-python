...
class ListExperienceEntitiesResponse(TypedDict):
    summary_items: NotRequired[
        "aws_sdk_kendra.types.experience_entities_summary_list.ExperienceEntitiesSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListExperienceEntitiesResponse) -> dict:
    ...
    if "summary_items" in value:
        ...
        out["SummaryItems"] = (
            aws_sdk_kendra.types.experience_entities_summary_list.serialize_aws_json_1_1(
                value["summary_items"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListExperienceEntitiesResponse:
    ...
    if "SummaryItems" in data:
        ...
        out["summary_items"] = (
            aws_sdk_kendra.types.experience_entities_summary_list.deserialize_aws_json_1_1(
                data["SummaryItems"]
            )
        )
