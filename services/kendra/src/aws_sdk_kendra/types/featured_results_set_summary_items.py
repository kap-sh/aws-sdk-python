...
if TYPE_CHECKING:
    import aws_sdk_kendra.types.featured_results_set_summary

FeaturedResultsSetSummaryItems: TypeAlias = list[
    "aws_sdk_kendra.types.featured_results_set_summary.FeaturedResultsSetSummary"
]
...
def serialize_aws_json_1_1(value: FeaturedResultsSetSummaryItems) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_kendra.types.featured_results_set_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> FeaturedResultsSetSummaryItems:
    ...
    for item in data:
        out.append(
            aws_sdk_kendra.types.featured_results_set_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
