...
if TYPE_CHECKING:
    import aws_sdk_kendra.types.featured_document_with_metadata

FeaturedDocumentWithMetadataList: TypeAlias = list[
    "aws_sdk_kendra.types.featured_document_with_metadata.FeaturedDocumentWithMetadata"
]
...
def serialize_aws_json_1_1(value: FeaturedDocumentWithMetadataList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_kendra.types.featured_document_with_metadata.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> FeaturedDocumentWithMetadataList:
    ...
    for item in data:
        out.append(
            aws_sdk_kendra.types.featured_document_with_metadata.deserialize_aws_json_1_1(
                item
            )
        )
    return out
