...
if TYPE_CHECKING:
    ...
    import aws_sdk_kendra.types.share_point_online_authentication_type
    import aws_sdk_kendra.types.share_point_url_list
...
def serialize_aws_json_1_1(value: SharePointConfiguration) -> dict:
    ...
    out["SharePointVersion"] = (
        aws_sdk_kendra.types.share_point_version.serialize_aws_json_1_1(
            value["share_point_version"]
        )
    )
    import aws_sdk_kendra.types.share_point_url_list

    out["Urls"] = aws_sdk_kendra.types.share_point_url_list.serialize_aws_json_1_1(
        value["urls"]
    )
    ...
    if "authentication_type" in value:
        ...
        out["AuthenticationType"] = (
            aws_sdk_kendra.types.share_point_online_authentication_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SharePointConfiguration:
    ...
    if "SharePointVersion" in data:
        ...
        out["share_point_version"] = (
            aws_sdk_kendra.types.share_point_version.deserialize_aws_json_1_1(
    ...
    if "Urls" in data:
        ...
        out["urls"] = (
            aws_sdk_kendra.types.share_point_url_list.deserialize_aws_json_1_1(
                data["Urls"]
            )
        )
    else:
    ...
    if "AuthenticationType" in data:
        ...
        out["authentication_type"] = (
            aws_sdk_kendra.types.share_point_online_authentication_type.deserialize_aws_json_1_1(
