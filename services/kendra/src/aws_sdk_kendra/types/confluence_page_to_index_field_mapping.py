...
if TYPE_CHECKING:
    import aws_sdk_kendra.types.confluence_page_field_name
    import aws_sdk_kendra.types.data_source_date_field_format
    import aws_sdk_kendra.types.index_field_name


class ConfluencePageToIndexFieldMapping(TypedDict):
    data_source_field_name: NotRequired[
        "aws_sdk_kendra.types.confluence_page_field_name.ConfluencePageFieldName"
    ]
...
def serialize_aws_json_1_1(value: ConfluencePageToIndexFieldMapping) -> dict:
    ...
    if "data_source_field_name" in value:
        ...
        out["DataSourceFieldName"] = (
            aws_sdk_kendra.types.confluence_page_field_name.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ConfluencePageToIndexFieldMapping:
    ...
    if "DataSourceFieldName" in data:
        ...
        out["data_source_field_name"] = (
            aws_sdk_kendra.types.confluence_page_field_name.deserialize_aws_json_1_1(
