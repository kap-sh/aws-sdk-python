...
if TYPE_CHECKING:
    ...
    import aws_sdk_kendra.types.sort_order


class SortingConfiguration(TypedDict):
    ...
    sort_order: "aws_sdk_kendra.types.sort_order.SortOrder"
...
def serialize_aws_json_1_1(value: SortingConfiguration) -> dict:
    ...
    out["SortOrder"] = aws_sdk_kendra.types.sort_order.serialize_aws_json_1_1(
        value["sort_order"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> SortingConfiguration:
    ...
    if "SortOrder" in data:
        ...
        out["sort_order"] = aws_sdk_kendra.types.sort_order.deserialize_aws_json_1_1(
            data["SortOrder"]
        )
    else:
