...
def handle_response(
    ...
    out: aws_sdk_kendra.types.list_thesauri_response.ListThesauriResponse = (
        aws_sdk_kendra.types.list_thesauri_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.list_thesauri_request.ListThesauriRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_thesauri_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_thesauri(
    ...
    aws_sdk_kendra.types.list_thesauri_response.ListThesauriResponse, zapros.Response
]:
