"""Generated from Smithy shape ``com.amazonaws.kendra#ListFaqs``."""
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.list_faqs_response.ListFaqsResponse = (
        aws_sdk_kendra.types.list_faqs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.list_faqs_request.ListFaqsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_faqs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_faqs(
    ...
    input_: aws_sdk_kendra.types.list_faqs_request.ListFaqsRequest,
) -> tuple[aws_sdk_kendra.types.list_faqs_response.ListFaqsResponse, zapros.Response]:
