...
def handle_response(
    ...
    out: aws_sdk_kendra.types.update_featured_results_set_response.UpdateFeaturedResultsSetResponse = aws_sdk_kendra.types.update_featured_results_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.update_featured_results_set_request.UpdateFeaturedResultsSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.update_featured_results_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
