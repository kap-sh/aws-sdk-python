...
def handle_response(
    ...
    out: aws_sdk_kendra.types.describe_experience_response.DescribeExperienceResponse = aws_sdk_kendra.types.describe_experience_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.describe_experience_request.DescribeExperienceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.describe_experience_request.serialize_aws_json_1_1(input_)
    ).encode()
