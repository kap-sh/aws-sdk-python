"""Generated from Smithy shape ``com.amazonaws.kendra#CreateAccessControlConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.create_access_control_configuration_response.CreateAccessControlConfigurationResponse = aws_sdk_kendra.types.create_access_control_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.create_access_control_configuration_request.CreateAccessControlConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.create_access_control_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_access_control_configuration(
