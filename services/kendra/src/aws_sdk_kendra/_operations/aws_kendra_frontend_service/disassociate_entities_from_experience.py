...
def handle_response(
    ...
    out: aws_sdk_kendra.types.disassociate_entities_from_experience_response.DisassociateEntitiesFromExperienceResponse = aws_sdk_kendra.types.disassociate_entities_from_experience_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.disassociate_entities_from_experience_request.DisassociateEntitiesFromExperienceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
