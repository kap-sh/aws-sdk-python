...
def handle_response(
    ...
    out: aws_sdk_kendra.types.create_faq_response.CreateFaqResponse = (
        aws_sdk_kendra.types.create_faq_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.create_faq_request.CreateFaqRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.create_faq_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_faq(
    ...
    input_: aws_sdk_kendra.types.create_faq_request.CreateFaqRequest,
) -> tuple[aws_sdk_kendra.types.create_faq_response.CreateFaqResponse, zapros.Response]:
