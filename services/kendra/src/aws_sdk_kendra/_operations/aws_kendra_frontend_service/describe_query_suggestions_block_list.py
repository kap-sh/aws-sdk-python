...
def handle_response(
    ...
    out: aws_sdk_kendra.types.describe_query_suggestions_block_list_response.DescribeQuerySuggestionsBlockListResponse = aws_sdk_kendra.types.describe_query_suggestions_block_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.describe_query_suggestions_block_list_request.DescribeQuerySuggestionsBlockListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
