...
def build_request(
    ...
    input: aws_sdk_kendra.types.describe_thesaurus_request.DescribeThesaurusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.describe_thesaurus_request.serialize_aws_json_1_1(input)
    ).encode()
