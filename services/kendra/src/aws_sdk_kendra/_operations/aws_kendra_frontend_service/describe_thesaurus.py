...
def handle_response(
    ...
    out: aws_sdk_kendra.types.describe_thesaurus_response.DescribeThesaurusResponse = (
        aws_sdk_kendra.types.describe_thesaurus_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.describe_thesaurus_request.DescribeThesaurusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.describe_thesaurus_request.serialize_aws_json_1_1(input_)
    ).encode()
