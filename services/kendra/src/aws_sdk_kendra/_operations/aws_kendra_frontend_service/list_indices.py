...
import aws_sdk_kendra.types.index_configuration_summary_list
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.list_indices_response.ListIndicesResponse = (
        aws_sdk_kendra.types.list_indices_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.list_indices_request.ListIndicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_indices_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_indices(
    ...
    aws_sdk_kendra.types.list_indices_response.ListIndicesResponse, zapros.Response
]:
