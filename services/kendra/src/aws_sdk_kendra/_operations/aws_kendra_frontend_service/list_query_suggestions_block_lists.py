"""Generated from Smithy shape ``com.amazonaws.kendra#ListQuerySuggestionsBlockLists``."""
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.list_query_suggestions_block_lists_response.ListQuerySuggestionsBlockListsResponse = aws_sdk_kendra.types.list_query_suggestions_block_lists_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.list_query_suggestions_block_lists_request.ListQuerySuggestionsBlockListsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.ListQuerySuggestionsBlockLists"
    import aws_sdk_kendra.types.list_query_suggestions_block_lists_request

    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_query_suggestions_block_lists_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_query_suggestions_block_lists(
