...
def handle_response(
    ...
    out: aws_sdk_kendra.types.batch_delete_featured_results_set_response.BatchDeleteFeaturedResultsSetResponse = aws_sdk_kendra.types.batch_delete_featured_results_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.batch_delete_featured_results_set_request.BatchDeleteFeaturedResultsSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.batch_delete_featured_results_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
