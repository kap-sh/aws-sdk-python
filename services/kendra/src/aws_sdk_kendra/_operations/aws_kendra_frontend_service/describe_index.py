...
def handle_response(
    ...
    out: aws_sdk_kendra.types.describe_index_response.DescribeIndexResponse = (
        aws_sdk_kendra.types.describe_index_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.describe_index_request.DescribeIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.describe_index_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_index(
    ...
    aws_sdk_kendra.types.describe_index_response.DescribeIndexResponse, zapros.Response
]:
