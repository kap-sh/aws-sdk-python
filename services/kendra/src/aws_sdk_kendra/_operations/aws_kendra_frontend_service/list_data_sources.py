...
def handle_response(
    ...
    out: aws_sdk_kendra.types.list_data_sources_response.ListDataSourcesResponse = (
        aws_sdk_kendra.types.list_data_sources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.list_data_sources_request.ListDataSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_data_sources_request.serialize_aws_json_1_1(input_)
    ).encode()
