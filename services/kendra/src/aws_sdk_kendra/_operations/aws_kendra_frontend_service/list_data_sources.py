...
def build_request(
    ...
    input: aws_sdk_kendra.types.list_data_sources_request.ListDataSourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_data_sources_request.serialize_aws_json_1_1(input)
    ).encode()
