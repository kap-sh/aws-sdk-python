...
def handle_response(
    ...
    out: aws_sdk_kendra.types.describe_access_control_configuration_response.DescribeAccessControlConfigurationResponse = aws_sdk_kendra.types.describe_access_control_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.describe_access_control_configuration_request.DescribeAccessControlConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
