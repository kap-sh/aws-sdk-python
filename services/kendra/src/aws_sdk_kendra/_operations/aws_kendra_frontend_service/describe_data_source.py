...
def handle_response(
    ...
    out: aws_sdk_kendra.types.describe_data_source_response.DescribeDataSourceResponse = aws_sdk_kendra.types.describe_data_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.describe_data_source_request.DescribeDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.describe_data_source_request.serialize_aws_json_1_1(input_)
    ).encode()
