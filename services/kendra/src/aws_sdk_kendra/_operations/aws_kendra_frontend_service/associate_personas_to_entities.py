"""Generated from Smithy shape ``com.amazonaws.kendra#AssociatePersonasToEntities``."""
...
import aws_sdk_kendra.errors.resource_already_exist_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAlreadyExistException":
            raise aws_sdk_kendra.errors.resource_already_exist_exception.ResourceAlreadyExistException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.associate_personas_to_entities_response.AssociatePersonasToEntitiesResponse = aws_sdk_kendra.types.associate_personas_to_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.associate_personas_to_entities_request.AssociatePersonasToEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.AssociatePersonasToEntities"
    import aws_sdk_kendra.types.associate_personas_to_entities_request

    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.associate_personas_to_entities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_personas_to_entities(
