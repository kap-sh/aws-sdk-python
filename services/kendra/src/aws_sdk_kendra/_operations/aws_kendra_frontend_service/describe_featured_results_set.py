"""Generated from Smithy shape ``com.amazonaws.kendra#DescribeFeaturedResultsSet``."""
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.describe_featured_results_set_response.DescribeFeaturedResultsSetResponse = aws_sdk_kendra.types.describe_featured_results_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.describe_featured_results_set_request.DescribeFeaturedResultsSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.DescribeFeaturedResultsSet"
    import aws_sdk_kendra.types.describe_featured_results_set_request

    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.describe_featured_results_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_featured_results_set(
