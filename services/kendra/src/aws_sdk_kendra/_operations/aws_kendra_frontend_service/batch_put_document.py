...
def handle_response(
    ...
    out: aws_sdk_kendra.types.batch_put_document_response.BatchPutDocumentResponse = (
        aws_sdk_kendra.types.batch_put_document_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.batch_put_document_request.BatchPutDocumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.batch_put_document_request.serialize_aws_json_1_1(input_)
    ).encode()
