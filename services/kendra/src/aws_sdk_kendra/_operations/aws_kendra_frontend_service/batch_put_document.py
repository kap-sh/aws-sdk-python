...
def build_request(
    ...
    input: aws_sdk_kendra.types.batch_put_document_request.BatchPutDocumentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.batch_put_document_request.serialize_aws_json_1_1(input)
    ).encode()
