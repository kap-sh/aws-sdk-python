...
def build_request(
    ...
    input_: aws_sdk_kendra.types.get_snapshots_request.GetSnapshotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.get_snapshots_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_snapshots(
    ...
    aws_sdk_kendra.types.get_snapshots_response.GetSnapshotsResponse, zapros.Response
]:
