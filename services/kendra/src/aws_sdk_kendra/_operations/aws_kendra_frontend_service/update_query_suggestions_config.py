...
def build_request(
    ...
    input_: aws_sdk_kendra.types.update_query_suggestions_config_request.UpdateQuerySuggestionsConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.update_query_suggestions_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
