...
def handle_response(
    ...
    out: aws_sdk_kendra.types.create_query_suggestions_block_list_response.CreateQuerySuggestionsBlockListResponse = aws_sdk_kendra.types.create_query_suggestions_block_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.create_query_suggestions_block_list_request.CreateQuerySuggestionsBlockListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.create_query_suggestions_block_list_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
