"""Generated from Smithy shape ``com.amazonaws.kendra#UpdateAccessControlConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.update_access_control_configuration_response.UpdateAccessControlConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.update_access_control_configuration_request.UpdateAccessControlConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.update_access_control_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_access_control_configuration(
