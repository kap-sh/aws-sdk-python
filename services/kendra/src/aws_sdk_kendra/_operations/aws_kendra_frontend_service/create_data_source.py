...
def handle_response(
    ...
    out: aws_sdk_kendra.types.create_data_source_response.CreateDataSourceResponse = (
        aws_sdk_kendra.types.create_data_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.create_data_source_request.CreateDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.create_data_source_request.serialize_aws_json_1_1(input_)
    ).encode()
