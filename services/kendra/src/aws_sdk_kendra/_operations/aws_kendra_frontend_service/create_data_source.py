...
def build_request(
    ...
    input: aws_sdk_kendra.types.create_data_source_request.CreateDataSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.create_data_source_request.serialize_aws_json_1_1(input)
    ).encode()
