...
def build_request(
    ...
    input_: aws_sdk_kendra.types.get_query_suggestions_request.GetQuerySuggestionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.get_query_suggestions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
