...
def handle_response(
    ...
    out: aws_sdk_kendra.types.get_query_suggestions_response.GetQuerySuggestionsResponse = aws_sdk_kendra.types.get_query_suggestions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_kendra.types.get_query_suggestions_request.GetQuerySuggestionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.get_query_suggestions_request.serialize_aws_json_1_1(input)
    ).encode()
