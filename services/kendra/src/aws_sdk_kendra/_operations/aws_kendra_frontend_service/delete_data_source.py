...
def build_request(
    ...
    input: aws_sdk_kendra.types.delete_data_source_request.DeleteDataSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.delete_data_source_request.serialize_aws_json_1_1(input)
    ).encode()
