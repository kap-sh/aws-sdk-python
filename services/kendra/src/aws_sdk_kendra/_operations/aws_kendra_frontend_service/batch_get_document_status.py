...
def handle_response(
    ...
    out: aws_sdk_kendra.types.batch_get_document_status_response.BatchGetDocumentStatusResponse = aws_sdk_kendra.types.batch_get_document_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.batch_get_document_status_request.BatchGetDocumentStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.batch_get_document_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
