"""Generated from Smithy shape ``com.amazonaws.kendra#DescribePrincipalMapping``."""
...
import aws_sdk_kendra.types.group_ordering_id_summaries
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.describe_principal_mapping_response.DescribePrincipalMappingResponse = aws_sdk_kendra.types.describe_principal_mapping_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.describe_principal_mapping_request.DescribePrincipalMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.DescribePrincipalMapping"
    import aws_sdk_kendra.types.describe_principal_mapping_request

    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.describe_principal_mapping_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_principal_mapping(
