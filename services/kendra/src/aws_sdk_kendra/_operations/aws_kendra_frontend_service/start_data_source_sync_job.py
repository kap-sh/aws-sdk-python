"""Generated from Smithy shape ``com.amazonaws.kendra#StartDataSourceSyncJob``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            import aws_sdk_kendra.errors.resource_in_use_exception

            raise aws_sdk_kendra.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.start_data_source_sync_job_response.StartDataSourceSyncJobResponse = aws_sdk_kendra.types.start_data_source_sync_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.start_data_source_sync_job_request.StartDataSourceSyncJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_start_data_source_sync_job(
