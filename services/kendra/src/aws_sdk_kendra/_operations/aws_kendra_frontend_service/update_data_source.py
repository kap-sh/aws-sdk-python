...
def build_request(
    ...
    input: aws_sdk_kendra.types.update_data_source_request.UpdateDataSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.update_data_source_request.serialize_aws_json_1_1(input)
    ).encode()
