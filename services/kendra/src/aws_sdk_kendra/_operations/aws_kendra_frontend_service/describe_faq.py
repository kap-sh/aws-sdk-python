...
def handle_response(
    ...
    out: aws_sdk_kendra.types.describe_faq_response.DescribeFaqResponse = (
        aws_sdk_kendra.types.describe_faq_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.describe_faq_request.DescribeFaqRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.describe_faq_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_faq(
    ...
    aws_sdk_kendra.types.describe_faq_response.DescribeFaqResponse, zapros.Response
]:
