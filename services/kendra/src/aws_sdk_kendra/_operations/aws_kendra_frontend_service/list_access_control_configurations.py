"""Generated from Smithy shape ``com.amazonaws.kendra#ListAccessControlConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.list_access_control_configurations_response.ListAccessControlConfigurationsResponse = aws_sdk_kendra.types.list_access_control_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.list_access_control_configurations_request.ListAccessControlConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.ListAccessControlConfigurations"
    import aws_sdk_kendra.types.list_access_control_configurations_request

    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_access_control_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_access_control_configurations(
