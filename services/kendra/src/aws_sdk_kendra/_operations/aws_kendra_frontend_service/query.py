...
def handle_response(
    ...
    out: aws_sdk_kendra.types.query_result.QueryResult = (
        aws_sdk_kendra.types.query_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.query_request.QueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.query_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def query(
    options: OperationOptions, input_: aws_sdk_kendra.types.query_request.QueryRequest
) -> tuple[aws_sdk_kendra.types.query_result.QueryResult, zapros.Response]:
