...
def build_request(
    ...
    input: aws_sdk_kendra.types.query_request.QueryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.query_request.serialize_aws_json_1_1(input)
    ).encode()
...
def query(
    options: OperationOptions, input: aws_sdk_kendra.types.query_request.QueryRequest
