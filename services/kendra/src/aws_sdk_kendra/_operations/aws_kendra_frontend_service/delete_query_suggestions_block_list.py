...
def build_request(
    ...
    input_: aws_sdk_kendra.types.delete_query_suggestions_block_list_request.DeleteQuerySuggestionsBlockListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.delete_query_suggestions_block_list_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
