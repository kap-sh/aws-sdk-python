...
def build_request(
    ...
    input: aws_sdk_kendra.types.list_entity_personas_request.ListEntityPersonasRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_entity_personas_request.serialize_aws_json_1_1(input)
    ).encode()
