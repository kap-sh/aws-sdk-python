...
def build_request(
    ...
    input_: aws_sdk_kendra.types.batch_delete_document_request.BatchDeleteDocumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.batch_delete_document_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
