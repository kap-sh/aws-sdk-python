"""Generated from Smithy shape ``com.amazonaws.kendra#BatchDeleteDocument``."""
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.batch_delete_document_response.BatchDeleteDocumentResponse = aws_sdk_kendra.types.batch_delete_document_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_kendra.types.batch_delete_document_request.BatchDeleteDocumentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.batch_delete_document_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_batch_delete_document(
