"""Generated from Smithy shape ``com.amazonaws.kendra#DeleteThesaurus``."""
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.delete_thesaurus_request.DeleteThesaurusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.DeleteThesaurus"
    import aws_sdk_kendra.types.delete_thesaurus_request

    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.delete_thesaurus_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_thesaurus(
