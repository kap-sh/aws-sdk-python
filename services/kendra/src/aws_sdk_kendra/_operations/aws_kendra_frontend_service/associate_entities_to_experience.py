...
def handle_response(
    ...
    out: aws_sdk_kendra.types.associate_entities_to_experience_response.AssociateEntitiesToExperienceResponse = aws_sdk_kendra.types.associate_entities_to_experience_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.associate_entities_to_experience_request.AssociateEntitiesToExperienceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.associate_entities_to_experience_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
