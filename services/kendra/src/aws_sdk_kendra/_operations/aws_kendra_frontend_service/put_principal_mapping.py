...
def build_request(
    ...
    input: aws_sdk_kendra.types.put_principal_mapping_request.PutPrincipalMappingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.put_principal_mapping_request.serialize_aws_json_1_1(input)
    ).encode()
