...
def handle_response(
    ...
    out: aws_sdk_kendra.types.create_thesaurus_response.CreateThesaurusResponse = (
        aws_sdk_kendra.types.create_thesaurus_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.create_thesaurus_request.CreateThesaurusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.create_thesaurus_request.serialize_aws_json_1_1(input_)
    ).encode()
