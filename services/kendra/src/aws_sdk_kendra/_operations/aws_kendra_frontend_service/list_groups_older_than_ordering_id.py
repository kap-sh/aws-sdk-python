...
def handle_response(
    ...
    out: aws_sdk_kendra.types.list_groups_older_than_ordering_id_response.ListGroupsOlderThanOrderingIdResponse = aws_sdk_kendra.types.list_groups_older_than_ordering_id_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.list_groups_older_than_ordering_id_request.ListGroupsOlderThanOrderingIdRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_groups_older_than_ordering_id_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
