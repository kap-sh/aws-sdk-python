"""Generated from Smithy shape ``com.amazonaws.kendra#StopDataSourceSyncJob``."""
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.stop_data_source_sync_job_request.StopDataSourceSyncJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.stop_data_source_sync_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
