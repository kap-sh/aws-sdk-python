...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FeaturedResultsConflictException":
            import aws_sdk_kendra.errors.featured_results_conflict_exception

            raise aws_sdk_kendra.errors.featured_results_conflict_exception.FeaturedResultsConflictException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.create_featured_results_set_response.CreateFeaturedResultsSetResponse = aws_sdk_kendra.types.create_featured_results_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.create_featured_results_set_request.CreateFeaturedResultsSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.create_featured_results_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
