"""Generated from Smithy shape ``com.amazonaws.kendra#ListExperienceEntities``."""
...
import aws_sdk_kendra.types.experience_entities_summary_list
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.list_experience_entities_response.ListExperienceEntitiesResponse = aws_sdk_kendra.types.list_experience_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.list_experience_entities_request.ListExperienceEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.ListExperienceEntities"
    import aws_sdk_kendra.types.list_experience_entities_request

    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_experience_entities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_experience_entities(
