...
def handle_response(
    ...
    out: aws_sdk_kendra.types.list_data_source_sync_jobs_response.ListDataSourceSyncJobsResponse = aws_sdk_kendra.types.list_data_source_sync_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.list_data_source_sync_jobs_request.ListDataSourceSyncJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.list_data_source_sync_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
