"""Generated from Smithy shape ``com.amazonaws.kendra#UpdateQuerySuggestionsBlockList``."""
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.update_query_suggestions_block_list_request.UpdateQuerySuggestionsBlockListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.UpdateQuerySuggestionsBlockList"
    import aws_sdk_kendra.types.update_query_suggestions_block_list_request

    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.update_query_suggestions_block_list_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_query_suggestions_block_list(
