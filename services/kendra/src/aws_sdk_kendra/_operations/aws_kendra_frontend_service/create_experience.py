...
def build_request(
    ...
    input: aws_sdk_kendra.types.create_experience_request.CreateExperienceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.create_experience_request.serialize_aws_json_1_1(input)
    ).encode()
