...
def handle_response(
    ...
    out: aws_sdk_kendra.types.retrieve_result.RetrieveResult = (
        aws_sdk_kendra.types.retrieve_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.retrieve_request.RetrieveRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.retrieve_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def retrieve(
    ...
    input_: aws_sdk_kendra.types.retrieve_request.RetrieveRequest,
) -> tuple[aws_sdk_kendra.types.retrieve_result.RetrieveResult, zapros.Response]:
