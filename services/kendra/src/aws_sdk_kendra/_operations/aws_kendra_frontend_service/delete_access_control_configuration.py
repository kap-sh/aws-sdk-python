...
def handle_response(
    ...
    out: aws_sdk_kendra.types.delete_access_control_configuration_response.DeleteAccessControlConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.delete_access_control_configuration_request.DeleteAccessControlConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
