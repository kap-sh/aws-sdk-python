"""Generated from Smithy shape ``com.amazonaws.kendra#DeleteFaq``."""
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.delete_faq_request.DeleteFaqRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.delete_faq_request.serialize_aws_json_1_1(input_)
    ).encode()
