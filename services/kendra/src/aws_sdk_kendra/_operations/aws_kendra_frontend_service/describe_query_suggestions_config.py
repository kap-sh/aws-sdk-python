"""Generated from Smithy shape ``com.amazonaws.kendra#DescribeQuerySuggestionsConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_kendra.types.describe_query_suggestions_config_response.DescribeQuerySuggestionsConfigResponse = aws_sdk_kendra.types.describe_query_suggestions_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.describe_query_suggestions_config_request.DescribeQuerySuggestionsConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.DescribeQuerySuggestionsConfig"
    import aws_sdk_kendra.types.describe_query_suggestions_config_request

    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.describe_query_suggestions_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_query_suggestions_config(
