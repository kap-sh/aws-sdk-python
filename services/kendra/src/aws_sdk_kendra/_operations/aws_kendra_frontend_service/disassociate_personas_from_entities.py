...
def handle_response(
    ...
    out: aws_sdk_kendra.types.disassociate_personas_from_entities_response.DisassociatePersonasFromEntitiesResponse = aws_sdk_kendra.types.disassociate_personas_from_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.disassociate_personas_from_entities_request.DisassociatePersonasFromEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.disassociate_personas_from_entities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
