...
def handle_response(
    ...
    out: aws_sdk_kendra.types.delete_experience_response.DeleteExperienceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kendra.types.delete_experience_request.DeleteExperienceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.delete_experience_request.serialize_aws_json_1_1(input_)
    ).encode()
