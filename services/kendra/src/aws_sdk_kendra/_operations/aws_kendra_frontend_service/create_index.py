...
def handle_response(
    ...
    out: aws_sdk_kendra.types.create_index_response.CreateIndexResponse = (
        aws_sdk_kendra.types.create_index_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_kendra.types.create_index_request.CreateIndexRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra.types.create_index_request.serialize_aws_json_1_1(input)
    ).encode()
...
def create_index(
    ...
    aws_sdk_kendra.types.create_index_response.CreateIndexResponse, zapros.Response
]:
