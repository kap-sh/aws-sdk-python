...
```
pip install aws-sdk-kendra-ranking
```

## Usage

```python
from aws_sdk_kendra_ranking import AsyncKendraRankingClient
...
```python
from aws_sdk_kendra_ranking import AsyncKendraRankingClient
from aws_sdk_kendra_ranking.error import AccessDeniedException
