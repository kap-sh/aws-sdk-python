...
from ._services.async_kendra_ranking import (
    AsyncKendraRankingClient as AsyncKendraRankingClient,
)
from ._services.kendra_ranking import KendraRankingClient as KendraRankingClient
