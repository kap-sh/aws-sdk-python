"""Generated from Smithy shape ``com.amazonaws.kendraranking#ResourceUnavailableException``."""
...
class ResourceUnavailableException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kendraranking#ResourceUnavailableException``."""
