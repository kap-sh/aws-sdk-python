"""Generated from Smithy shape ``com.amazonaws.kendraranking#DeleteRescoreExecutionPlan``."""
...
def build_request(
    ...
    input_: capo_kendra_ranking.types.delete_rescore_execution_plan_request.DeleteRescoreExecutionPlanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_rescore_execution_plan(
