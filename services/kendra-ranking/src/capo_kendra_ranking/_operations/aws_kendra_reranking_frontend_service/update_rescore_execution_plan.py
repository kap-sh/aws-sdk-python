"""Generated from Smithy shape ``com.amazonaws.kendraranking#UpdateRescoreExecutionPlan``."""
...
import capo_kendra_ranking.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_kendra_ranking.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    input_: capo_kendra_ranking.types.update_rescore_execution_plan_request.UpdateRescoreExecutionPlanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_kendra_ranking.types.update_rescore_execution_plan_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_rescore_execution_plan(
