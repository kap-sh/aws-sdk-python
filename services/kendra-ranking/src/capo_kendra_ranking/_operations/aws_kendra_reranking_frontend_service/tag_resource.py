"""Generated from Smithy shape ``com.amazonaws.kendraranking#TagResource``."""
...
import capo_kendra_ranking.errors.resource_unavailable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceUnavailableException":
            raise capo_kendra_ranking.errors.resource_unavailable_exception.ResourceUnavailableException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_kendra_ranking.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: capo_kendra_ranking.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraRerankingFrontendService.TagResource"
    body: bytes | None = json.dumps(
        capo_kendra_ranking.types.tag_resource_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_kendra_ranking.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
