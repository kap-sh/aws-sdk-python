"""Generated from Smithy shape ``com.amazonaws.kendraranking#DescribeRescoreExecutionPlan``."""
...
def handle_response(
    ...
    out: capo_kendra_ranking.types.describe_rescore_execution_plan_response.DescribeRescoreExecutionPlanResponse = capo_kendra_ranking.types.describe_rescore_execution_plan_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: capo_kendra_ranking.types.describe_rescore_execution_plan_request.DescribeRescoreExecutionPlanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
