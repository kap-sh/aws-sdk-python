"""Generated from Smithy shape ``com.amazonaws.kendraranking#UntagResource``."""
...
def handle_response(
    ...
    out: capo_kendra_ranking.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: capo_kendra_ranking.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSKendraRerankingFrontendService.UntagResource"
    body: bytes | None = json.dumps(
        capo_kendra_ranking.types.untag_resource_request.serialize_aws_json_1_0(input_)
    ).encode()
