...
def handle_response(
    ...
    out: capo_kendra_ranking.types.list_rescore_execution_plans_response.ListRescoreExecutionPlansResponse = capo_kendra_ranking.types.list_rescore_execution_plans_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: capo_kendra_ranking.types.list_rescore_execution_plans_request.ListRescoreExecutionPlansRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
