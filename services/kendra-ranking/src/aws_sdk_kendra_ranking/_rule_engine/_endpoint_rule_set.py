        ...
        if _locals["PartitionResult"] is not None:
            if True is get_attr(
                ...
                if p.UseFIPS is True:
                    if (
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://kendra-ranking-fips.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={},
                ...
                return Endpoint(
                    url=interpolate(
                        "https://kendra-ranking.{Region}.{PartitionResult#dualStackDnsSuffix}",
                        p,
                        _locals,
                    ),
                    properties={},
            ...
            if p.UseFIPS is True:
                if (
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://kendra-ranking-fips.{Region}.{PartitionResult#dnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            return Endpoint(
                url=interpolate(
                    "https://kendra-ranking.{Region}.{PartitionResult#dnsSuffix}",
                    p,
                    _locals,
                ),
                properties={},
