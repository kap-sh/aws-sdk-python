...
from aws_sdk_kendra_ranking._services._aws_config import aaws_config
...
class AsyncKendraRankingClientConfig(TypedDict, total=False):
...
class AsyncKendraRankingClient:
    ...
    async def create_rescore_execution_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kendra_ranking.types.create_rescore_execution_plan_request.CreateRescoreExecutionPlanRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kendra_ranking.types.create_rescore_execution_plan_response.CreateRescoreExecutionPlanResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_kendra_ranking._operations.aws_kendra_reranking_frontend_service.create_rescore_execution_plan.async_create_rescore_execution_plan(
    ...
    async def delete_rescore_execution_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kendra_ranking.types.delete_rescore_execution_plan_request.DeleteRescoreExecutionPlanRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_kendra_ranking._operations.aws_kendra_reranking_frontend_service.delete_rescore_execution_plan.async_delete_rescore_execution_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_rescore_execution_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kendra_ranking.types.describe_rescore_execution_plan_request.DescribeRescoreExecutionPlanRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kendra_ranking.types.describe_rescore_execution_plan_response.DescribeRescoreExecutionPlanResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_kendra_ranking._operations.aws_kendra_reranking_frontend_service.describe_rescore_execution_plan.async_describe_rescore_execution_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_rescore_execution_plans(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kendra_ranking.types.list_rescore_execution_plans_request.ListRescoreExecutionPlansRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kendra_ranking.types.list_rescore_execution_plans_response.ListRescoreExecutionPlansResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_kendra_ranking._operations.aws_kendra_reranking_frontend_service.list_rescore_execution_plans.async_list_rescore_execution_plans(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kendra_ranking.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kendra_ranking.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_kendra_ranking._operations.aws_kendra_reranking_frontend_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rescore(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kendra_ranking.types.rescore_request.RescoreRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kendra_ranking.types.rescore_result.RescoreResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_kendra_ranking._operations.aws_kendra_reranking_frontend_service.rescore.async_rescore(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kendra_ranking.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kendra_ranking.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_kendra_ranking._operations.aws_kendra_reranking_frontend_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kendra_ranking.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kendra_ranking.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_kendra_ranking._operations.aws_kendra_reranking_frontend_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_rescore_execution_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kendra_ranking.types.update_rescore_execution_plan_request.UpdateRescoreExecutionPlanRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_kendra_ranking._operations.aws_kendra_reranking_frontend_service.update_rescore_execution_plan.async_update_rescore_execution_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
