...
class DescribeRescoreExecutionPlanResponse(TypedDict):
    id: NotRequired[
    ...
    arn: NotRequired[
        "aws_sdk_kendra_ranking.types.rescore_execution_plan_arn.RescoreExecutionPlanArn"
    ]
    ...
    error_message: NotRequired[
        "aws_sdk_kendra_ranking.types.error_message.ErrorMessage"
    ]
