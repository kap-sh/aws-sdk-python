...
def handle_response(
    ...
    out: aws_sdk_kendra_ranking.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kendra_ranking.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra_ranking.types.untag_resource_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
