...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceUnavailableException":
            import aws_sdk_kendra_ranking.errors.resource_unavailable_exception

            raise aws_sdk_kendra_ranking.errors.resource_unavailable_exception.ResourceUnavailableException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kendra_ranking.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_kendra_ranking.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_kendra_ranking.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra_ranking.types.list_tags_for_resource_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
