...
import aws_sdk_kendra_ranking.errors.conflict_exception
import aws_sdk_kendra_ranking.errors.internal_server_exception
import aws_sdk_kendra_ranking.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_kendra_ranking.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_kendra_ranking.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kendra_ranking.types.create_rescore_execution_plan_response.CreateRescoreExecutionPlanResponse = aws_sdk_kendra_ranking.types.create_rescore_execution_plan_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_kendra_ranking.types.create_rescore_execution_plan_request.CreateRescoreExecutionPlanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra_ranking.types.create_rescore_execution_plan_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
