...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            import aws_sdk_kendra_ranking.errors.resource_not_found_exception

            raise aws_sdk_kendra_ranking.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kendra_ranking.types.rescore_result.RescoreResult = (
        aws_sdk_kendra_ranking.types.rescore_result.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_kendra_ranking.types.rescore_request.RescoreRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["rescore_execution_plan_id"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kendra_ranking.types.rescore_request.serialize_aws_json_1_0(input)
    ).encode()
...
def rescore(
    ...
    input: aws_sdk_kendra_ranking.types.rescore_request.RescoreRequest,
) -> tuple[aws_sdk_kendra_ranking.types.rescore_result.RescoreResult, zapros.Response]:
