...
def handle_response(
    ...
    out: aws_sdk_kendra_ranking.types.describe_rescore_execution_plan_response.DescribeRescoreExecutionPlanResponse = aws_sdk_kendra_ranking.types.describe_rescore_execution_plan_response.deserialize_aws_json_1_0(
