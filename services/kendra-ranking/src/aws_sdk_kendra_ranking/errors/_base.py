...
class KendraRankingError(Exception):
    """Base class for all KendraRanking service errors."""


class ServiceError(KendraRankingError):
...
class SerializationError(KendraRankingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KendraRankingError):
...
class WaiterFailedError(KendraRankingError):
...
class WaiterTimeoutError(KendraRankingError):
