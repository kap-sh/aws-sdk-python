"""Generated from Smithy shape ``com.amazonaws.kendraranking#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kendraranking#ResourceNotFoundException``."""
