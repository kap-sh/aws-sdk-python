"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.get_resource_policy_response.GetResourcePolicyResponse = capo_migration_hub_refactor_spaces.types.get_resource_policy_response.deserialize_json(
