"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#GetService``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.get_service_response.GetServiceResponse = capo_migration_hub_refactor_spaces.types.get_service_response.deserialize_json(
