"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_migration_hub_refactor_spaces.types.list_tags_for_resource_response.deserialize_json(
