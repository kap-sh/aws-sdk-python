...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.list_applications_response.ListApplicationsResponse = capo_migration_hub_refactor_spaces.types.list_applications_response.deserialize_json(
