"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#CreateApplication``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.create_application_response.CreateApplicationResponse = capo_migration_hub_refactor_spaces.types.create_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub_refactor_spaces.types.create_application_request.serialize_json(
            input_
        )
    ).encode()
