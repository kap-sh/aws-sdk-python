...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.delete_service_response.DeleteServiceResponse = capo_migration_hub_refactor_spaces.types.delete_service_response.deserialize_json(
