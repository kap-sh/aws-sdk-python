...
import capo_migration_hub_refactor_spaces.types.api_gateway_proxy_config
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.get_application_response.GetApplicationResponse = capo_migration_hub_refactor_spaces.types.get_application_response.deserialize_json(
