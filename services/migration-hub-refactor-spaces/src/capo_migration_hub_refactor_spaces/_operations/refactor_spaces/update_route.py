"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#UpdateRoute``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.update_route_response.UpdateRouteResponse = capo_migration_hub_refactor_spaces.types.update_route_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub_refactor_spaces.types.update_route_request.serialize_json(
            input_
        )
    ).encode()
