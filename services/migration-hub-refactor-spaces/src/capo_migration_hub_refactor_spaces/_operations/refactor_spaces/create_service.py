"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#CreateService``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.create_service_response.CreateServiceResponse = capo_migration_hub_refactor_spaces.types.create_service_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub_refactor_spaces.types.create_service_request.serialize_json(
            input_
        )
    ).encode()
