"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#ListEnvironments``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.list_environments_response.ListEnvironmentsResponse = capo_migration_hub_refactor_spaces.types.list_environments_response.deserialize_json(
