...
class MigrationHubRefactorSpacesError(Exception):
    """Base class for all MigrationHubRefactorSpaces service errors."""


class ServiceError(MigrationHubRefactorSpacesError):
...
class SerializationError(MigrationHubRefactorSpacesError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MigrationHubRefactorSpacesError):
...
class WaiterFailedError(MigrationHubRefactorSpacesError):
...
class WaiterTimeoutError(MigrationHubRefactorSpacesError):
