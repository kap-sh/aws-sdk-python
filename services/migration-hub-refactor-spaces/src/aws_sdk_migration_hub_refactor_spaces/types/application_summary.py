...
if TYPE_CHECKING:
    ...
    import aws_sdk_migration_hub_refactor_spaces.types.api_gateway_proxy_summary
...
class ApplicationSummary(TypedDict, closed=True):
    ...
    api_gateway_proxy: NotRequired[
        "aws_sdk_migration_hub_refactor_spaces.types.api_gateway_proxy_summary.ApiGatewayProxySummary"
    ]
...
def serialize_json(value: ApplicationSummary) -> dict:
    ...
    if "api_gateway_proxy" in value:
        ...
        out["ApiGatewayProxy"] = (
            aws_sdk_migration_hub_refactor_spaces.types.api_gateway_proxy_summary.serialize_json(
...
def deserialize_json(data: dict) -> ApplicationSummary:
    ...
    if "ApiGatewayProxy" in data:
        ...
        out["api_gateway_proxy"] = (
            aws_sdk_migration_hub_refactor_spaces.types.api_gateway_proxy_summary.deserialize_json(
