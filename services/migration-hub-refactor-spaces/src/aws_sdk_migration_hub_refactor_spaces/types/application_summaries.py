...
ApplicationSummaries: TypeAlias = list[
    "aws_sdk_migration_hub_refactor_spaces.types.application_summary.ApplicationSummary"
]
...
def serialize_json(value: ApplicationSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_migration_hub_refactor_spaces.types.application_summary.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> ApplicationSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_migration_hub_refactor_spaces.types.application_summary.deserialize_json(
                item
            )
        )
    return out
