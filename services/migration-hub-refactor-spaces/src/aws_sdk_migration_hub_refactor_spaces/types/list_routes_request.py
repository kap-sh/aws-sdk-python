"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#ListRoutesRequest``."""
...
class ListRoutesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListRoutesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListRoutesRequest:
    out: ListRoutesRequest = {}  # type: ignore[typeddict-item]
    return out
