"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#ListEnvironmentVpcsRequest``."""
...
class ListEnvironmentVpcsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListEnvironmentVpcsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListEnvironmentVpcsRequest:
    out: ListEnvironmentVpcsRequest = {}  # type: ignore[typeddict-item]
    return out
