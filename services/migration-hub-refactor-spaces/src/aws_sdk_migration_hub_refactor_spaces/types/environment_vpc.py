...
if TYPE_CHECKING:
    ...
    import aws_sdk_migration_hub_refactor_spaces.types.cidr_blocks
    import aws_sdk_migration_hub_refactor_spaces.types.ec2_tag_value
...
class EnvironmentVpc(TypedDict):
    ...
    cidr_blocks: NotRequired[
        "aws_sdk_migration_hub_refactor_spaces.types.cidr_blocks.CidrBlocks"
    ]
    """<p>The list of Amazon Virtual Private Cloud (Amazon VPC) CIDR blocks. </p>"""
    vpc_name: NotRequired[
        "aws_sdk_migration_hub_refactor_spaces.types.ec2_tag_value.Ec2TagValue"
    ]
...
def serialize_json(value: EnvironmentVpc) -> dict:
    ...
    if "cidr_blocks" in value:
        ...
        out["CidrBlocks"] = (
            aws_sdk_migration_hub_refactor_spaces.types.cidr_blocks.serialize_json(
                value["cidr_blocks"]
            )
        )
...
def deserialize_json(data: dict) -> EnvironmentVpc:
    ...
    if "CidrBlocks" in data:
        ...
        out["cidr_blocks"] = (
            aws_sdk_migration_hub_refactor_spaces.types.cidr_blocks.deserialize_json(
                data["CidrBlocks"]
            )
        )
    if "VpcName" in data:
