...
from aws_sdk_migration_hub_refactor_spaces._services._aws_config import aaws_config
...
class AsyncMigrationHubRefactorSpacesClient:
    ...
    async def create_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.create_application_request.CreateApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.create_application_response.CreateApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.create_application.async_create_application(
    ...
    async def create_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.create_environment_request.CreateEnvironmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.create_environment_response.CreateEnvironmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.create_environment.async_create_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_route(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.create_route_request.CreateRouteRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.create_route_response.CreateRouteResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.create_route.async_create_route(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.create_service_request.CreateServiceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.create_service_response.CreateServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.create_service.async_create_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.delete_application_request.DeleteApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.delete_application_response.DeleteApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.delete_application.async_delete_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.delete_environment_request.DeleteEnvironmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.delete_environment_response.DeleteEnvironmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.delete_environment.async_delete_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.delete_resource_policy_request.DeleteResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.delete_resource_policy_response.DeleteResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.delete_resource_policy.async_delete_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_route(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.delete_route_request.DeleteRouteRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.delete_route_response.DeleteRouteResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.delete_route.async_delete_route(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.delete_service_request.DeleteServiceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.delete_service_response.DeleteServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.delete_service.async_delete_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.get_application_request.GetApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.get_application_response.GetApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.get_application.async_get_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.get_environment_request.GetEnvironmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.get_environment_response.GetEnvironmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.get_environment.async_get_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.get_resource_policy_request.GetResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.get_resource_policy_response.GetResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.get_resource_policy.async_get_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_route(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.get_route_request.GetRouteRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.get_route_response.GetRouteResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.get_route.async_get_route(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.get_service_request.GetServiceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.get_service_response.GetServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.get_service.async_get_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_applications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.list_applications_request.ListApplicationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.list_applications_response.ListApplicationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.list_applications.async_list_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_migration_hub_refactor_spaces.types.application_summary.ApplicationSummary]":
        _token = next_token
        while True:
    ...
    async def list_environments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.list_environments_request.ListEnvironmentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.list_environments_response.ListEnvironmentsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.list_environments.async_list_environments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_migration_hub_refactor_spaces.types.environment_summary.EnvironmentSummary]":
        _token = next_token
        while True:
    ...
    async def list_environment_vpcs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.list_environment_vpcs_request.ListEnvironmentVpcsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.list_environment_vpcs_response.ListEnvironmentVpcsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.list_environment_vpcs.async_list_environment_vpcs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_migration_hub_refactor_spaces.types.environment_vpc.EnvironmentVpc]":
        _token = next_token
        while True:
    ...
    async def list_routes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.list_routes_request.ListRoutesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.list_routes_response.ListRoutesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.list_routes.async_list_routes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_migration_hub_refactor_spaces.types.route_summary.RouteSummary]":
        _token = next_token
        while True:
    ...
    async def list_services(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.list_services_request.ListServicesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.list_services_response.ListServicesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.list_services.async_list_services(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_migration_hub_refactor_spaces.types.service_summary.ServiceSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.put_resource_policy_response.PutResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.put_resource_policy.async_put_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_route(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migration_hub_refactor_spaces.types.update_route_request.UpdateRouteRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migration_hub_refactor_spaces.types.update_route_response.UpdateRouteResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migration_hub_refactor_spaces._operations.refactor_spaces.update_route.async_update_route(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
