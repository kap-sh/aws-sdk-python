...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.list_routes_response.ListRoutesResponse = aws_sdk_migration_hub_refactor_spaces.types.list_routes_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_migration_hub_refactor_spaces.types.list_routes_request.ListRoutesRequest,
) -> zapros.Request:
