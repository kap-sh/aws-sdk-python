"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#DeleteService``."""
...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.delete_service_response.DeleteServiceResponse = aws_sdk_migration_hub_refactor_spaces.types.delete_service_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_migration_hub_refactor_spaces.types.delete_service_request.DeleteServiceRequest,
) -> zapros.Request:
