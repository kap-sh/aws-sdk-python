"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#GetRoute``."""
...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.get_route_response.GetRouteResponse = aws_sdk_migration_hub_refactor_spaces.types.get_route_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_migration_hub_refactor_spaces.types.get_route_request.GetRouteRequest,
) -> zapros.Request:
