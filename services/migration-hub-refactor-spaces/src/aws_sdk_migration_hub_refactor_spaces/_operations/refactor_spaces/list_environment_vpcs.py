...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.list_environment_vpcs_response.ListEnvironmentVpcsResponse = aws_sdk_migration_hub_refactor_spaces.types.list_environment_vpcs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migration_hub_refactor_spaces.types.list_environment_vpcs_request.ListEnvironmentVpcsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
