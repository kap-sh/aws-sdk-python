...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.create_service_response.CreateServiceResponse = aws_sdk_migration_hub_refactor_spaces.types.create_service_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migration_hub_refactor_spaces.types.create_service_request.CreateServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_migration_hub_refactor_spaces.types.create_service_request.serialize_json(
            input_
        )
    ).encode()
