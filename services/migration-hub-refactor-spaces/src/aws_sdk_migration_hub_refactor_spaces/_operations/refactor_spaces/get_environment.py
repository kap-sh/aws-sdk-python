...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.get_environment_response.GetEnvironmentResponse = aws_sdk_migration_hub_refactor_spaces.types.get_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migration_hub_refactor_spaces.types.get_environment_request.GetEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
