...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.get_service_response.GetServiceResponse = aws_sdk_migration_hub_refactor_spaces.types.get_service_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migration_hub_refactor_spaces.types.get_service_request.GetServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
