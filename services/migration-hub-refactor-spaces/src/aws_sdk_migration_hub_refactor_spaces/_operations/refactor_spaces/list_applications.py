"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#ListApplications``."""
...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.list_applications_response.ListApplicationsResponse = aws_sdk_migration_hub_refactor_spaces.types.list_applications_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migration_hub_refactor_spaces.types.list_applications_request.ListApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/environments/{EnvironmentIdentifier}/applications"
    )
    url = url.replace(
