...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.delete_environment_response.DeleteEnvironmentResponse = aws_sdk_migration_hub_refactor_spaces.types.delete_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migration_hub_refactor_spaces.types.delete_environment_request.DeleteEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
