"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#DeleteApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.delete_application_response.DeleteApplicationResponse = aws_sdk_migration_hub_refactor_spaces.types.delete_application_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_migration_hub_refactor_spaces.types.delete_application_request.DeleteApplicationRequest,
) -> zapros.Request:
