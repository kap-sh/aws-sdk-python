...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.update_route_response.UpdateRouteResponse = aws_sdk_migration_hub_refactor_spaces.types.update_route_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migration_hub_refactor_spaces.types.update_route_request.UpdateRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_migration_hub_refactor_spaces.types.update_route_request.serialize_json(
            input_
        )
    ).encode()
