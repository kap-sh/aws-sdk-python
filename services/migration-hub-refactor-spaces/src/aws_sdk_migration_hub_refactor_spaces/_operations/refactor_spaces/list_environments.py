...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.list_environments_response.ListEnvironmentsResponse = aws_sdk_migration_hub_refactor_spaces.types.list_environments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migration_hub_refactor_spaces.types.list_environments_request.ListEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
