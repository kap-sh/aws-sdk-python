"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#CreateRoute``."""
...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.create_route_response.CreateRouteResponse = aws_sdk_migration_hub_refactor_spaces.types.create_route_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_migration_hub_refactor_spaces.types.create_route_request.CreateRouteRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ApplicationIdentifier}", quote(str(input["application_identifier"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_migration_hub_refactor_spaces.types.create_route_request.serialize_json(
            input
        )
    ).encode()
