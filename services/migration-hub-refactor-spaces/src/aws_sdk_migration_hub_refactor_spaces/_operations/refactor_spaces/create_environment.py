...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.create_environment_response.CreateEnvironmentResponse = aws_sdk_migration_hub_refactor_spaces.types.create_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migration_hub_refactor_spaces.types.create_environment_request.CreateEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_migration_hub_refactor_spaces.types.create_environment_request.serialize_json(
            input_
        )
    ).encode()
