"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#GetApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.get_application_response.GetApplicationResponse = aws_sdk_migration_hub_refactor_spaces.types.get_application_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_migration_hub_refactor_spaces.types.get_application_request.GetApplicationRequest,
) -> zapros.Request:
