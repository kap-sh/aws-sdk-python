"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#PutResourcePolicy``."""
...
from aws_sdk_migration_hub_refactor_spaces._rule_engine._endpoint_rule_set import (
    EndpointParams,
    resolve,
)
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourcePolicyException":
            import aws_sdk_migration_hub_refactor_spaces.errors.invalid_resource_policy_exception

            raise aws_sdk_migration_hub_refactor_spaces.errors.invalid_resource_policy_exception.InvalidResourcePolicyException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.put_resource_policy_response.PutResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def get_signer(
...
) -> aws_sdk_migration_hub_refactor_spaces._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_migration_hub_refactor_spaces._auth._sigv4.build_sigv4_auth_scheme(
                "refactor-spaces", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_migration_hub_refactor_spaces._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_migration_hub_refactor_spaces.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/resourcepolicy"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_migration_hub_refactor_spaces.types.put_resource_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_migration_hub_refactor_spaces.types.put_resource_policy_request.serialize_json(
            input_
        )
    ).encode()
