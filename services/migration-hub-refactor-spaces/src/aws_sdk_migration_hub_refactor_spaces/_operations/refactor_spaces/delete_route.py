"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#DeleteRoute``."""
...
def handle_response(
    ...
    out: aws_sdk_migration_hub_refactor_spaces.types.delete_route_response.DeleteRouteResponse = aws_sdk_migration_hub_refactor_spaces.types.delete_route_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_migration_hub_refactor_spaces.types.delete_route_request.DeleteRouteRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{RouteIdentifier}", quote(str(input["route_identifier"]), safe="")
    )
    params: dict[str, str] = {}
