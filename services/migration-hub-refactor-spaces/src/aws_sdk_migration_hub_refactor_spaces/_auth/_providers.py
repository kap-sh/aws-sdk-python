...
from aws_sdk_migration_hub_refactor_spaces._auth._identity import (
    Credentials,
    Identity,
)
from aws_sdk_migration_hub_refactor_spaces._services._aws_config import _load_profile
