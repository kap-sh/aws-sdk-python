...
class PinpointSMSVoiceError(Exception):
    """Base class for all PinpointSMSVoice service errors."""


class ServiceError(PinpointSMSVoiceError):
...
class SerializationError(PinpointSMSVoiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PinpointSMSVoiceError):
...
class WaiterFailedError(PinpointSMSVoiceError):
...
class WaiterTimeoutError(PinpointSMSVoiceError):
