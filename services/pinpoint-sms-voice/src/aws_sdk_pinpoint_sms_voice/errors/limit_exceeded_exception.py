"""Generated from Smithy shape ``com.amazonaws.pinpointsmsvoice#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.pinpointsmsvoice#LimitExceededException``."""
