...
from ._services.async_pinpoint_sms_voice import (
    AsyncPinpointSMSVoiceClient as AsyncPinpointSMSVoiceClient,
)
from ._services.pinpoint_sms_voice import (
    PinpointSMSVoiceClient as PinpointSMSVoiceClient,
)
