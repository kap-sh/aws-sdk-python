...
```
pip install aws-sdk-pinpoint-sms-voice
```

## Usage

```python
from aws_sdk_pinpoint_sms_voice import AsyncPinpointSMSVoiceClient
...
```python
from aws_sdk_pinpoint_sms_voice import AsyncPinpointSMSVoiceClient
from aws_sdk_pinpoint_sms_voice.error import AlreadyExistsException
