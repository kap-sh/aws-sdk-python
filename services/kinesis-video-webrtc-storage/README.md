...
```
pip install aws-sdk-kinesis-video-webrtc-storage
```

## Usage

```python
from aws_sdk_kinesis_video_webrtc_storage import AsyncKinesisVideoWebRTCStorageClient
...
```python
from aws_sdk_kinesis_video_webrtc_storage import AsyncKinesisVideoWebRTCStorageClient
from aws_sdk_kinesis_video_webrtc_storage.error import AccessDeniedException
