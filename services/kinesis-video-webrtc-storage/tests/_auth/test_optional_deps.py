...
import pytest
from capo_kinesis_video_webrtc_storage._auth import _providers
from capo_kinesis_video_webrtc_storage._auth._providers import (
...
def test_sso_configured_reports_missing_extra(tmp_path: Path) -> None:
    ...
    with pytest.raises(
        MissingDependencyError, match=r"capo-kinesis-video-webrtc-storage\[sso\]"
    ) as excinfo:
