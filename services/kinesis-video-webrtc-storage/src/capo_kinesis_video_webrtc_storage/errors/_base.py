...
class KinesisVideoWebRTCStorageError(Exception):
    """Base class for all KinesisVideoWebRTCStorage service errors."""


class ServiceError(KinesisVideoWebRTCStorageError):
...
class SerializationError(KinesisVideoWebRTCStorageError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KinesisVideoWebRTCStorageError):
...
class WaiterFailedError(KinesisVideoWebRTCStorageError):
...
class WaiterTimeoutError(KinesisVideoWebRTCStorageError):
