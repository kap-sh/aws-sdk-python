"""Generated from Smithy shape ``com.amazonaws.kinesisvideowebrtcstorage#JoinStorageSession``."""
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video_webrtc_storage.types.join_storage_session_input.JoinStorageSessionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_join_storage_session(
