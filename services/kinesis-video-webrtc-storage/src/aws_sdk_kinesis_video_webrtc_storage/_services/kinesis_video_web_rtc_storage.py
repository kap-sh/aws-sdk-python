...
from aws_sdk_kinesis_video_webrtc_storage._services._aws_config import aws_config
...
class KinesisVideoWebRTCStorageClientConfig(TypedDict, total=False):
...
class KinesisVideoWebRTCStorageClient:
    ...
    def join_storage_session(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kinesis_video_webrtc_storage.types.join_storage_session_input.JoinStorageSessionInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_kinesis_video_webrtc_storage._operations.aws_acuity_routing_service_lambda.join_storage_session

            output, http_response = (
                aws_sdk_kinesis_video_webrtc_storage._operations.aws_acuity_routing_service_lambda.join_storage_session.join_storage_session(
    ...
    def join_storage_session_as_viewer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kinesis_video_webrtc_storage.types.join_storage_session_as_viewer_input.JoinStorageSessionAsViewerInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_kinesis_video_webrtc_storage._operations.aws_acuity_routing_service_lambda.join_storage_session_as_viewer

            output, http_response = (
                aws_sdk_kinesis_video_webrtc_storage._operations.aws_acuity_routing_service_lambda.join_storage_session_as_viewer.join_storage_session_as_viewer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
