...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_user_proficiencies_request
    import aws_sdk_connect.types.list_user_proficiencies_response
...
def handle_response(
    ...
    aws_sdk_connect.types.list_user_proficiencies_response.ListUserProficienciesResponse
):
    import aws_sdk_connect.types.list_user_proficiencies_response

    out: aws_sdk_connect.types.list_user_proficiencies_response.ListUserProficienciesResponse = aws_sdk_connect.types.list_user_proficiencies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_user_proficiencies_request.ListUserProficienciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
