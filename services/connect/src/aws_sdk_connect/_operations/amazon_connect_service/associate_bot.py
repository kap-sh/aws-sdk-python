"""Generated from Smithy shape ``com.amazonaws.connect#AssociateBot``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.associate_bot_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_bot_request.AssociateBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/bot"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_bot_request.serialize_json(input_)
    ).encode()
