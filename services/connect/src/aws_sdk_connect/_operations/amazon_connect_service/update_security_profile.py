...
def build_request(
    ...
    input: aws_sdk_connect.types.update_security_profile_request.UpdateSecurityProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_security_profile_request.serialize_json(input)
    ).encode()
