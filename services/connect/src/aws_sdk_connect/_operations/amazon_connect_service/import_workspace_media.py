...
def build_request(
    ...
    input: aws_sdk_connect.types.import_workspace_media_request.ImportWorkspaceMediaRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.import_workspace_media_request.serialize_json(input)
    ).encode()
