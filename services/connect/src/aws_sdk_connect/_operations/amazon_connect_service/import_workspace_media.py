"""Generated from Smithy shape ``com.amazonaws.connect#ImportWorkspaceMedia``."""
...
import aws_sdk_connect.types.import_workspace_media_request
import aws_sdk_connect.types.import_workspace_media_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.import_workspace_media_response.ImportWorkspaceMediaResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.import_workspace_media_request.ImportWorkspaceMediaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{InstanceId}/{WorkspaceId}/media"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.import_workspace_media_request.serialize_json(input_)
    ).encode()
...
async def async_import_workspace_media(
