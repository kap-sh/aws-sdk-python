"""Generated from Smithy shape ``com.amazonaws.connect#UpdateParticipantRoleConfig``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_participant_role_config_request
    import aws_sdk_connect.types.update_participant_role_config_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_participant_role_config_response.UpdateParticipantRoleConfigResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_connect.types.update_participant_role_config_request.UpdateParticipantRoleConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_participant_role_config_request.serialize_json(
            input
        )
    ).encode()
...
async def async_update_participant_role_config(
