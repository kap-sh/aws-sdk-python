"""Generated from Smithy shape ``com.amazonaws.connect#ListUserNotifications``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_user_notifications_request
    import aws_sdk_connect.types.list_user_notifications_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_user_notifications_response.ListUserNotificationsResponse = aws_sdk_connect.types.list_user_notifications_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_user_notifications_request.ListUserNotificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/users/{InstanceId}/{UserId}/notifications"
...
async def async_list_user_notifications(
