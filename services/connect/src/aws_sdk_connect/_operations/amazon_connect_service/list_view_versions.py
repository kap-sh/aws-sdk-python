"""Generated from Smithy shape ``com.amazonaws.connect#ListViewVersions``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_view_versions_request
    import aws_sdk_connect.types.list_view_versions_response
...
) -> aws_sdk_connect.types.list_view_versions_response.ListViewVersionsResponse:
    import aws_sdk_connect.types.list_view_versions_response

    out: aws_sdk_connect.types.list_view_versions_response.ListViewVersionsResponse = (
        aws_sdk_connect.types.list_view_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_view_versions_request.ListViewVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_view_versions(
