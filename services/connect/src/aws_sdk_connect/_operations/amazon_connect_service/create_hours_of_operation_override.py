...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_hours_of_operation_override_request
    import aws_sdk_connect.types.create_hours_of_operation_override_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_hours_of_operation_override_response.CreateHoursOfOperationOverrideResponse = aws_sdk_connect.types.create_hours_of_operation_override_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_hours_of_operation_override_request.CreateHoursOfOperationOverrideRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_hours_of_operation_override_request.serialize_json(
            input_
        )
    ).encode()
