...
def build_request(
    ...
    input: aws_sdk_connect.types.update_user_hierarchy_request.UpdateUserHierarchyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_hierarchy_request.serialize_json(input)
    ).encode()
