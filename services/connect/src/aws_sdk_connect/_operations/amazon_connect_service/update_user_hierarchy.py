...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_user_hierarchy_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_user_hierarchy_request.UpdateUserHierarchyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_hierarchy_request.serialize_json(input_)
    ).encode()
