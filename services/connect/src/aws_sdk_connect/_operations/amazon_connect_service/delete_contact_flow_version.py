"""Generated from Smithy shape ``com.amazonaws.connect#DeleteContactFlowVersion``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_contact_flow_version_request
    import aws_sdk_connect.types.delete_contact_flow_version_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_contact_flow_version_response.DeleteContactFlowVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_contact_flow_version_request.DeleteContactFlowVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{ContactFlowVersion}", quote(str(input_["contact_flow_version"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_delete_contact_flow_version(
