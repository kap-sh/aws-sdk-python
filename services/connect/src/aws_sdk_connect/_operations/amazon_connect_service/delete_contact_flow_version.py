...
def build_request(
    ...
    input: aws_sdk_connect.types.delete_contact_flow_version_request.DeleteContactFlowVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ContactFlowVersion}", quote(str(input["contact_flow_version"]), safe="")
    )
    params: dict[str, str] = {}
