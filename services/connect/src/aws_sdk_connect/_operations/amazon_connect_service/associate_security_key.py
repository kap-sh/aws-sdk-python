...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.associate_security_key_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.associate_security_key_response.AssociateSecurityKeyResponse = aws_sdk_connect.types.associate_security_key_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.associate_security_key_request.AssociateSecurityKeyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_security_key_request.serialize_json(input)
    ).encode()
