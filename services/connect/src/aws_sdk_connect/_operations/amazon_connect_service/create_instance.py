...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_instance_request
    import aws_sdk_connect.types.create_instance_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_instance_response.CreateInstanceResponse = (
        aws_sdk_connect.types.create_instance_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_instance_request.CreateInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_instance_request.serialize_json(input_)
    ).encode()
