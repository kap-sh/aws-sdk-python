"""Generated from Smithy shape ``com.amazonaws.connect#DeleteWorkspaceMedia``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_workspace_media_request
    import aws_sdk_connect.types.delete_workspace_media_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_workspace_media_response.DeleteWorkspaceMediaResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_workspace_media_request.DeleteWorkspaceMediaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "media_type" in input_:
        params["mediaType"] = str(input_["media_type"])
...
async def async_delete_workspace_media(
