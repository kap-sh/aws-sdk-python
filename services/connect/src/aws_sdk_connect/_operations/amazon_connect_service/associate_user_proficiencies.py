"""Generated from Smithy shape ``com.amazonaws.connect#AssociateUserProficiencies``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.associate_user_proficiencies_request
...
def build_request(
    ...
    input: aws_sdk_connect.types.associate_user_proficiencies_request.AssociateUserProficienciesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_user_proficiencies_request.serialize_json(input)
    ).encode()
...
async def async_associate_user_proficiencies(
