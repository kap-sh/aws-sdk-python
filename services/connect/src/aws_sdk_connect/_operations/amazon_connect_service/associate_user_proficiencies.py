...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_user_proficiencies_request.AssociateUserProficienciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_user_proficiencies_request.serialize_json(
            input_
        )
    ).encode()
