...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_analytics_data_lake_data_sets_request
    import aws_sdk_connect.types.list_analytics_data_lake_data_sets_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_analytics_data_lake_data_sets_response.ListAnalyticsDataLakeDataSetsResponse = aws_sdk_connect.types.list_analytics_data_lake_data_sets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_analytics_data_lake_data_sets_request.ListAnalyticsDataLakeDataSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
