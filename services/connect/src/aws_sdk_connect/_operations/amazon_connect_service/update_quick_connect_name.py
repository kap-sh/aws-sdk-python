...
def build_request(
    ...
    input: aws_sdk_connect.types.update_quick_connect_name_request.UpdateQuickConnectNameRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{QuickConnectId}", quote(str(input["quick_connect_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_quick_connect_name_request.serialize_json(input)
    ).encode()
