...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_bots_request
    import aws_sdk_connect.types.list_bots_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_bots_response.ListBotsResponse = (
        aws_sdk_connect.types.list_bots_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.list_bots_request.ListBotsRequest,
) -> zapros.Request:
    ...
    if "lex_version" in input:
        params["lexVersion"] = str(input["lex_version"])
...
def list_bots(
    ...
    input: aws_sdk_connect.types.list_bots_request.ListBotsRequest,
) -> tuple[aws_sdk_connect.types.list_bots_response.ListBotsResponse, zapros.Response]:
