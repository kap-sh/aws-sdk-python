...
def build_request(
    ...
    input: aws_sdk_connect.types.update_email_address_metadata_request.UpdateEmailAddressMetadataRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{EmailAddressId}", quote(str(input["email_address_id"]), safe="")
    )
    params: dict[str, str] = {}
