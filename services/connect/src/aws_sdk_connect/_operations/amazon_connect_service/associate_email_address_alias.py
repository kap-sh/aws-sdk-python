...
import aws_sdk_connect.types.associate_email_address_alias_request
import aws_sdk_connect.types.associate_email_address_alias_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.associate_email_address_alias_response.AssociateEmailAddressAliasResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_email_address_alias_request.AssociateEmailAddressAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_email_address_alias_request.serialize_json(
            input_
        )
    ).encode()
