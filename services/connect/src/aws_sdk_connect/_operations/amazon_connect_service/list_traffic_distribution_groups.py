"""Generated from Smithy shape ``com.amazonaws.connect#ListTrafficDistributionGroups``."""
...
import aws_sdk_connect.types.list_traffic_distribution_groups_request
import aws_sdk_connect.types.list_traffic_distribution_groups_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_traffic_distribution_groups_response.ListTrafficDistributionGroupsResponse = aws_sdk_connect.types.list_traffic_distribution_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_traffic_distribution_groups_request.ListTrafficDistributionGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/traffic-distribution-groups"
    params: dict[str, str] = {}
...
async def async_list_traffic_distribution_groups(
