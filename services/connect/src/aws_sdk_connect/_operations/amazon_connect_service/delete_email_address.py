...
import aws_sdk_connect.types.delete_email_address_request
import aws_sdk_connect.types.delete_email_address_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_email_address_response.DeleteEmailAddressResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_email_address_request.DeleteEmailAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
