"""Generated from Smithy shape ``com.amazonaws.connect#ListContactEvaluations``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_contact_evaluations_request
    import aws_sdk_connect.types.list_contact_evaluations_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_contact_evaluations_response.ListContactEvaluationsResponse = aws_sdk_connect.types.list_contact_evaluations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_contact_evaluations_request.ListContactEvaluationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_contact_evaluations(
