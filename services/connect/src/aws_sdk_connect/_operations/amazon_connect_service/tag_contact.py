...
import aws_sdk_connect.types.tag_contact_request
import aws_sdk_connect.types.tag_contact_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.tag_contact_response.TagContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.tag_contact_request.TagContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.tag_contact_request.serialize_json(input_)
    ).encode()
...
def tag_contact(
    ...
    aws_sdk_connect.types.tag_contact_response.TagContactResponse, zapros.Response
]:
