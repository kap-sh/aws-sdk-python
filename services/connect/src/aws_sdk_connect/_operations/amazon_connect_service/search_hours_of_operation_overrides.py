"""Generated from Smithy shape ``com.amazonaws.connect#SearchHoursOfOperationOverrides``."""
...
import aws_sdk_connect.types.hours_of_operation_override_list
...
import aws_sdk_connect.types.search_hours_of_operation_overrides_request
import aws_sdk_connect.types.search_hours_of_operation_overrides_response
...
) -> aws_sdk_connect.types.search_hours_of_operation_overrides_response.SearchHoursOfOperationOverridesResponse:
    out: aws_sdk_connect.types.search_hours_of_operation_overrides_response.SearchHoursOfOperationOverridesResponse = aws_sdk_connect.types.search_hours_of_operation_overrides_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_hours_of_operation_overrides_request.SearchHoursOfOperationOverridesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-hours-of-operation-overrides"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_hours_of_operation_overrides_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_search_hours_of_operation_overrides(
