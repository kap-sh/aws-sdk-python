"""Generated from Smithy shape ``com.amazonaws.connect#DeleteDataTableAttribute``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_data_table_attribute_request
    import aws_sdk_connect.types.delete_data_table_attribute_response
...
) -> aws_sdk_connect.types.delete_data_table_attribute_response.DeleteDataTableAttributeResponse:
    import aws_sdk_connect.types.delete_data_table_attribute_response

    out: aws_sdk_connect.types.delete_data_table_attribute_response.DeleteDataTableAttributeResponse = aws_sdk_connect.types.delete_data_table_attribute_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.delete_data_table_attribute_request.DeleteDataTableAttributeRequest,
) -> zapros.Request:
...
async def async_delete_data_table_attribute(
