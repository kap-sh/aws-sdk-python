"""Generated from Smithy shape ``com.amazonaws.connect#DescribeAgentStatus``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_agent_status_request
    import aws_sdk_connect.types.describe_agent_status_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_agent_status_response.DescribeAgentStatusResponse = aws_sdk_connect.types.describe_agent_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_agent_status_request.DescribeAgentStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_agent_status(
