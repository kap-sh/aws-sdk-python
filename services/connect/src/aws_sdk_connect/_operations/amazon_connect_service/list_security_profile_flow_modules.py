"""Generated from Smithy shape ``com.amazonaws.connect#ListSecurityProfileFlowModules``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_security_profile_flow_modules_request
    import aws_sdk_connect.types.list_security_profile_flow_modules_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_security_profile_flow_modules_response.ListSecurityProfileFlowModulesResponse = aws_sdk_connect.types.list_security_profile_flow_modules_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_security_profile_flow_modules_request.ListSecurityProfileFlowModulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_security_profile_flow_modules(
