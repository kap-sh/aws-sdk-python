...
if TYPE_CHECKING:
    import aws_sdk_connect.types.search_users_request
    import aws_sdk_connect.types.search_users_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_users_response.SearchUsersResponse = (
        aws_sdk_connect.types.search_users_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_users_request.SearchUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_users_request.serialize_json(input_)
    ).encode()
...
def search_users(
    ...
    aws_sdk_connect.types.search_users_response.SearchUsersResponse, zapros.Response
]:
