"""Generated from Smithy shape ``com.amazonaws.connect#DescribePrompt``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_prompt_request
    import aws_sdk_connect.types.describe_prompt_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_prompt_response.DescribePromptResponse = (
        aws_sdk_connect.types.describe_prompt_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.describe_prompt_request.DescribePromptRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/prompts/{InstanceId}/{PromptId}"
...
async def async_describe_prompt(
