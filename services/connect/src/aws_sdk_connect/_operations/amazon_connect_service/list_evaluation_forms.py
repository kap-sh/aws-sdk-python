...
import aws_sdk_connect.types.list_evaluation_forms_request
import aws_sdk_connect.types.list_evaluation_forms_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_evaluation_forms_response.ListEvaluationFormsResponse = aws_sdk_connect.types.list_evaluation_forms_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_evaluation_forms_request.ListEvaluationFormsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
