...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_lambda_functions_request
    import aws_sdk_connect.types.list_lambda_functions_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_lambda_functions_response.ListLambdaFunctionsResponse = aws_sdk_connect.types.list_lambda_functions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_lambda_functions_request.ListLambdaFunctionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
