...
def build_request(
    ...
    input: aws_sdk_connect.types.get_contact_metrics_request.GetContactMetricsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.get_contact_metrics_request.serialize_json(input)
    ).encode()
