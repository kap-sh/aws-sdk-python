"""Generated from Smithy shape ``com.amazonaws.connect#GetContactMetrics``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.get_contact_metrics_request
    import aws_sdk_connect.types.get_contact_metrics_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.get_contact_metrics_response.GetContactMetricsResponse = aws_sdk_connect.types.get_contact_metrics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.get_contact_metrics_request.GetContactMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/metrics/contact"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.get_contact_metrics_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.get_contact_metrics_request.serialize_json(input_)
    ).encode()
...
async def async_get_contact_metrics(
