"""Generated from Smithy shape ``com.amazonaws.connect#DescribeDataTable``."""
...
import aws_sdk_connect.types.describe_data_table_request
import aws_sdk_connect.types.describe_data_table_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_data_table_response.DescribeDataTableResponse = aws_sdk_connect.types.describe_data_table_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_data_table_request.DescribeDataTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_data_table(
