...
if TYPE_CHECKING:
    import aws_sdk_connect.types.get_attached_file_request
    import aws_sdk_connect.types.get_attached_file_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.get_attached_file_response.GetAttachedFileResponse = (
        aws_sdk_connect.types.get_attached_file_response.deserialize_json(
