...
if TYPE_CHECKING:
    import aws_sdk_connect.types.stop_test_case_execution_request
    import aws_sdk_connect.types.stop_test_case_execution_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.stop_test_case_execution_response.StopTestCaseExecutionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.stop_test_case_execution_request.StopTestCaseExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.stop_test_case_execution_request.serialize_json(input_)
    ).encode()
