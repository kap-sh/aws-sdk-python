...
import aws_sdk_connect.types.create_contact_flow_module_alias_request
import aws_sdk_connect.types.create_contact_flow_module_alias_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_contact_flow_module_alias_response.CreateContactFlowModuleAliasResponse = aws_sdk_connect.types.create_contact_flow_module_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_contact_flow_module_alias_request.CreateContactFlowModuleAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_contact_flow_module_alias_request.serialize_json(
            input_
        )
    ).encode()
