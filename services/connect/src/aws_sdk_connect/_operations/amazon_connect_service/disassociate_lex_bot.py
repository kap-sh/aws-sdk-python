...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_lex_bot_request.DisassociateLexBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "bot_name" in input_:
        params["botName"] = str(input_["bot_name"])
    if "lex_region" in input_:
        params["lexRegion"] = str(input_["lex_region"])
