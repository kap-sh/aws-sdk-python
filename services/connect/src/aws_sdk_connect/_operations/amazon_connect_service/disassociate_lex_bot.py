...
if TYPE_CHECKING:
    import aws_sdk_connect.types.disassociate_lex_bot_request
...
def build_request(
    ...
    input: aws_sdk_connect.types.disassociate_lex_bot_request.DisassociateLexBotRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "bot_name" in input:
        params["botName"] = str(input["bot_name"])
    if "lex_region" in input:
        params["lexRegion"] = str(input["lex_region"])
