...
def build_request(
    ...
    input: aws_sdk_connect.types.disassociate_lambda_function_request.DisassociateLambdaFunctionRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "function_arn" in input:
        params["functionArn"] = str(input["function_arn"])
