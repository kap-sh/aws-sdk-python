"""Generated from Smithy shape ``com.amazonaws.connect#UpdateQueueOutboundCallerConfig``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_queue_outbound_caller_config_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_queue_outbound_caller_config_request.UpdateQueueOutboundCallerConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_queue_outbound_caller_config_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_queue_outbound_caller_config(
