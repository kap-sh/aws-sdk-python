...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_view_request
    import aws_sdk_connect.types.describe_view_response
...
) -> aws_sdk_connect.types.describe_view_response.DescribeViewResponse:
    import aws_sdk_connect.types.describe_view_response

    out: aws_sdk_connect.types.describe_view_response.DescribeViewResponse = (
        aws_sdk_connect.types.describe_view_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_view_request.DescribeViewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_view(
    ...
    aws_sdk_connect.types.describe_view_response.DescribeViewResponse, zapros.Response
]:
