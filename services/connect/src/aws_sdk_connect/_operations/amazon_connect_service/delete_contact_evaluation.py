...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_contact_evaluation_request
...
def build_request(
    ...
    input: aws_sdk_connect.types.delete_contact_evaluation_request.DeleteContactEvaluationRequest,
) -> zapros.Request:
