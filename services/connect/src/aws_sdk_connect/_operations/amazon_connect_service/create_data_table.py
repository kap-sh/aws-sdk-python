...
import aws_sdk_connect.types.create_data_table_request
import aws_sdk_connect.types.create_data_table_response
...
) -> aws_sdk_connect.types.create_data_table_response.CreateDataTableResponse:
    out: aws_sdk_connect.types.create_data_table_response.CreateDataTableResponse = (
        aws_sdk_connect.types.create_data_table_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_data_table_request.CreateDataTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_data_table_request.serialize_json(input_)
    ).encode()
