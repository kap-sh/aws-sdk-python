...
if TYPE_CHECKING:
    import aws_sdk_connect.types.stop_contact_request
    import aws_sdk_connect.types.stop_contact_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ContactNotFoundException":
            import aws_sdk_connect.errors.contact_not_found_exception

            raise aws_sdk_connect.errors.contact_not_found_exception.ContactNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connect.types.stop_contact_response.StopContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.stop_contact_request.StopContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.stop_contact_request.serialize_json(input_)
    ).encode()
...
def stop_contact(
    ...
    aws_sdk_connect.types.stop_contact_response.StopContactResponse, zapros.Response
]:
