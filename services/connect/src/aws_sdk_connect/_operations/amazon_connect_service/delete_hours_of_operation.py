"""Generated from Smithy shape ``com.amazonaws.connect#DeleteHoursOfOperation``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_hours_of_operation_request
...
def build_request(
    ...
    input: aws_sdk_connect.types.delete_hours_of_operation_request.DeleteHoursOfOperationRequest,
) -> zapros.Request:
...
async def async_delete_hours_of_operation(
