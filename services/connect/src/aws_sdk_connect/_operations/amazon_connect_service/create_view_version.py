"""Generated from Smithy shape ``com.amazonaws.connect#CreateViewVersion``."""
...
import aws_sdk_connect.types.create_view_version_request
import aws_sdk_connect.types.create_view_version_response
...
) -> aws_sdk_connect.types.create_view_version_response.CreateViewVersionResponse:
    out: aws_sdk_connect.types.create_view_version_response.CreateViewVersionResponse = aws_sdk_connect.types.create_view_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_view_version_request.CreateViewVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/views/{InstanceId}/{ViewId}/versions"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_view_version_request.serialize_json(input_)
    ).encode()
...
async def async_create_view_version(
