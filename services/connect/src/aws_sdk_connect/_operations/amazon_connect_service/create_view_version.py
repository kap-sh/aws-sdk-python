...
def build_request(
    ...
    input: aws_sdk_connect.types.create_view_version_request.CreateViewVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_view_version_request.serialize_json(input)
    ).encode()
