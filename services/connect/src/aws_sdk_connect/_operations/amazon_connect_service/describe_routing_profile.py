"""Generated from Smithy shape ``com.amazonaws.connect#DescribeRoutingProfile``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_routing_profile_request
    import aws_sdk_connect.types.describe_routing_profile_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_routing_profile_response.DescribeRoutingProfileResponse = aws_sdk_connect.types.describe_routing_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_routing_profile_request.DescribeRoutingProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_routing_profile(
