...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_routing_profiles_request
    import aws_sdk_connect.types.list_routing_profiles_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_routing_profiles_response.ListRoutingProfilesResponse = aws_sdk_connect.types.list_routing_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_routing_profiles_request.ListRoutingProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
