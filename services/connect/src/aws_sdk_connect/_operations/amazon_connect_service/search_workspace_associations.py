"""Generated from Smithy shape ``com.amazonaws.connect#SearchWorkspaceAssociations``."""
...
import aws_sdk_connect.types.search_workspace_associations_request
import aws_sdk_connect.types.search_workspace_associations_response
import aws_sdk_connect.types.workspace_association_search_criteria
import aws_sdk_connect.types.workspace_association_search_filter
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_workspace_associations_response.SearchWorkspaceAssociationsResponse = aws_sdk_connect.types.search_workspace_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_workspace_associations_request.SearchWorkspaceAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-workspace-associations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.search_workspace_associations_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_workspace_associations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_search_workspace_associations(
