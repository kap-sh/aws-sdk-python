...
import aws_sdk_connect.types.delete_task_template_request
import aws_sdk_connect.types.delete_task_template_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_task_template_response.DeleteTaskTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
