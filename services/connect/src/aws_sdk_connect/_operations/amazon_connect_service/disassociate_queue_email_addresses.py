...
import aws_sdk_connect.types.disassociate_queue_email_addresses_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_queue_email_addresses_request.DisassociateQueueEmailAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.disassociate_queue_email_addresses_request.serialize_json(
            input_
        )
    ).encode()
