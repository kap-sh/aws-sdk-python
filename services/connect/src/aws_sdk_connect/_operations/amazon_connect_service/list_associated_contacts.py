...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_associated_contacts_request
    import aws_sdk_connect.types.list_associated_contacts_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_associated_contacts_response.ListAssociatedContactsResponse = aws_sdk_connect.types.list_associated_contacts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_associated_contacts_request.ListAssociatedContactsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
