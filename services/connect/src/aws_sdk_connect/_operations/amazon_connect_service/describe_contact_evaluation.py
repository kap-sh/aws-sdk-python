...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_contact_evaluation_request
    import aws_sdk_connect.types.describe_contact_evaluation_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_contact_evaluation_response.DescribeContactEvaluationResponse = aws_sdk_connect.types.describe_contact_evaluation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.describe_contact_evaluation_request.DescribeContactEvaluationRequest,
) -> zapros.Request:
