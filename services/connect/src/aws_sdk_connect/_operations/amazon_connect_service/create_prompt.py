...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_prompt_request
    import aws_sdk_connect.types.create_prompt_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_prompt_response.CreatePromptResponse = (
        aws_sdk_connect.types.create_prompt_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_prompt_request.CreatePromptRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_prompt_request.serialize_json(input_)
    ).encode()
...
def create_prompt(
    ...
    aws_sdk_connect.types.create_prompt_response.CreatePromptResponse, zapros.Response
]:
