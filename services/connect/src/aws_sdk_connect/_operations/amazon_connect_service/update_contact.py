...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_contact_request
    import aws_sdk_connect.types.update_contact_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_contact_response.UpdateContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_contact_request.UpdateContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_request.serialize_json(input_)
    ).encode()
...
def update_contact(
    ...
    aws_sdk_connect.types.update_contact_response.UpdateContactResponse, zapros.Response
]:
