...
if TYPE_CHECKING:
    import aws_sdk_connect.types.disassociate_instance_storage_config_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_instance_storage_config_request.DisassociateInstanceStorageConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
