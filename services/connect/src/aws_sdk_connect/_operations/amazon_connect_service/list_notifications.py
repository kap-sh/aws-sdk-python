...
import aws_sdk_connect.types.list_notifications_request
import aws_sdk_connect.types.list_notifications_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_notifications_response.ListNotificationsResponse = (
        aws_sdk_connect.types.list_notifications_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_notifications_request.ListNotificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
