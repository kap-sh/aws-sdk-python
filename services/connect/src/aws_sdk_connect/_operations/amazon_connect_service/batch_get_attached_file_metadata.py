...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.batch_get_attached_file_metadata_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.batch_get_attached_file_metadata_response.BatchGetAttachedFileMetadataResponse = aws_sdk_connect.types.batch_get_attached_file_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.batch_get_attached_file_metadata_request.BatchGetAttachedFileMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
