...
def build_request(
    ...
    input: aws_sdk_connect.types.update_task_template_request.UpdateTaskTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_task_template_request.serialize_json(input)
    ).encode()
