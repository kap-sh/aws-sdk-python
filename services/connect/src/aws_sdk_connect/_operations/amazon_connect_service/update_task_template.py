...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_task_template_request
    import aws_sdk_connect.types.update_task_template_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PropertyValidationException":
            import aws_sdk_connect.errors.property_validation_exception

            raise aws_sdk_connect.errors.property_validation_exception.PropertyValidationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_task_template_response.UpdateTaskTemplateResponse = aws_sdk_connect.types.update_task_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_task_template_request.UpdateTaskTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_task_template_request.serialize_json(input_)
    ).encode()
