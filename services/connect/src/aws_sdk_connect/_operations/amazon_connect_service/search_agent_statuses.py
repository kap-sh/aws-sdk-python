"""Generated from Smithy shape ``com.amazonaws.connect#SearchAgentStatuses``."""
...
import aws_sdk_connect.types.agent_status_search_filter
import aws_sdk_connect.types.search_agent_statuses_request
import aws_sdk_connect.types.search_agent_statuses_response
...
) -> aws_sdk_connect.types.search_agent_statuses_response.SearchAgentStatusesResponse:
    out: aws_sdk_connect.types.search_agent_statuses_response.SearchAgentStatusesResponse = aws_sdk_connect.types.search_agent_statuses_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_agent_statuses_request.SearchAgentStatusesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-agent-statuses"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_agent_statuses_request.serialize_json(input_)
    ).encode()
...
async def async_search_agent_statuses(
