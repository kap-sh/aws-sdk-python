...
def build_request(
    ...
    input: aws_sdk_connect.types.search_agent_statuses_request.SearchAgentStatusesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_agent_statuses_request.serialize_json(input)
    ).encode()
