"""Generated from Smithy shape ``com.amazonaws.connect#DeleteRule``."""
...
import aws_sdk_connect.types.delete_rule_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_rule_request.DeleteRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
