...
def build_request(
    ...
    input: aws_sdk_connect.types.search_vocabularies_request.SearchVocabulariesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_vocabularies_request.serialize_json(input)
    ).encode()
