"""Generated from Smithy shape ``com.amazonaws.connect#ListInstances``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_instances_request
    import aws_sdk_connect.types.list_instances_response
...
) -> aws_sdk_connect.types.list_instances_response.ListInstancesResponse:
    import aws_sdk_connect.types.list_instances_response

    out: aws_sdk_connect.types.list_instances_response.ListInstancesResponse = (
        aws_sdk_connect.types.list_instances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_instances_request.ListInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/instance"
    params: dict[str, str] = {}
...
def list_instances(
    ...
    aws_sdk_connect.types.list_instances_response.ListInstancesResponse, zapros.Response
]:
