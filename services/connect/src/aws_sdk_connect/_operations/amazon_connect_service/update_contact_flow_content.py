...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_contact_flow_content_request
    import aws_sdk_connect.types.update_contact_flow_content_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidContactFlowException":
            import aws_sdk_connect.errors.invalid_contact_flow_exception

            raise aws_sdk_connect.errors.invalid_contact_flow_exception.InvalidContactFlowException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_contact_flow_content_response.UpdateContactFlowContentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_contact_flow_content_request.UpdateContactFlowContentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_flow_content_request.serialize_json(input_)
    ).encode()
