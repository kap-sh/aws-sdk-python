...
def build_request(
    ...
    input: aws_sdk_connect.types.update_contact_flow_content_request.UpdateContactFlowContentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_flow_content_request.serialize_json(input)
    ).encode()
