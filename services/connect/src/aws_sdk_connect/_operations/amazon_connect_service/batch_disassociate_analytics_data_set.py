"""Generated from Smithy shape ``com.amazonaws.connect#BatchDisassociateAnalyticsDataSet``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.batch_disassociate_analytics_data_set_request
    import aws_sdk_connect.types.batch_disassociate_analytics_data_set_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.batch_disassociate_analytics_data_set_response.BatchDisassociateAnalyticsDataSetResponse = aws_sdk_connect.types.batch_disassociate_analytics_data_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.batch_disassociate_analytics_data_set_request.BatchDisassociateAnalyticsDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/analytics-data/instance/{InstanceId}/associations"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.batch_disassociate_analytics_data_set_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_disassociate_analytics_data_set(
