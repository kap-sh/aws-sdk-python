"""Generated from Smithy shape ``com.amazonaws.connect#SearchHoursOfOperations``."""
...
import aws_sdk_connect.types.hours_of_operation_list
...
import aws_sdk_connect.types.search_hours_of_operations_request
import aws_sdk_connect.types.search_hours_of_operations_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_hours_of_operations_response.SearchHoursOfOperationsResponse = aws_sdk_connect.types.search_hours_of_operations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_hours_of_operations_request.SearchHoursOfOperationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-hours-of-operations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.search_hours_of_operations_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_hours_of_operations_request.serialize_json(input_)
    ).encode()
...
async def async_search_hours_of_operations(
