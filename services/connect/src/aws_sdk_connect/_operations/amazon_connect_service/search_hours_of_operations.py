...
def build_request(
    ...
    input: aws_sdk_connect.types.search_hours_of_operations_request.SearchHoursOfOperationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_hours_of_operations_request.serialize_json(input)
    ).encode()
