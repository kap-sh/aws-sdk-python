"""Generated from Smithy shape ``com.amazonaws.connect#CreateUser``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_user_request
    import aws_sdk_connect.types.create_user_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_user_response.CreateUserResponse = (
        aws_sdk_connect.types.create_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_user_request.CreateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/users/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_user_request.serialize_json(input_)
    ).encode()
...
def create_user(
    ...
    aws_sdk_connect.types.create_user_response.CreateUserResponse, zapros.Response
]:
