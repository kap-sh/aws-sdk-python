...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_user_hierarchy_group_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_user_hierarchy_group_request.DeleteUserHierarchyGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
