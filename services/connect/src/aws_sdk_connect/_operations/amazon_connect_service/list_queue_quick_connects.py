"""Generated from Smithy shape ``com.amazonaws.connect#ListQueueQuickConnects``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_queue_quick_connects_request
    import aws_sdk_connect.types.list_queue_quick_connects_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_queue_quick_connects_response.ListQueueQuickConnectsResponse = aws_sdk_connect.types.list_queue_quick_connects_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_queue_quick_connects_request.ListQueueQuickConnectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/queues/{InstanceId}/{QueueId}/quick-connects"
...
async def async_list_queue_quick_connects(
