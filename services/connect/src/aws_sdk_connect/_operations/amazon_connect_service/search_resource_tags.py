...
def build_request(
    ...
    input: aws_sdk_connect.types.search_resource_tags_request.SearchResourceTagsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_resource_tags_request.serialize_json(input)
    ).encode()
