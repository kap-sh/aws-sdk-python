...
import aws_sdk_connect.errors.maximum_result_returned_exception
import aws_sdk_connect.errors.resource_not_found_exception
import aws_sdk_connect.errors.throttling_exception
import aws_sdk_connect.types.resource_tags_search_criteria
import aws_sdk_connect.types.resource_type_list
import aws_sdk_connect.types.search_resource_tags_request
import aws_sdk_connect.types.search_resource_tags_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MaximumResultReturnedException":
            raise aws_sdk_connect.errors.maximum_result_returned_exception.MaximumResultReturnedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_resource_tags_response.SearchResourceTagsResponse = aws_sdk_connect.types.search_resource_tags_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_resource_tags_request.SearchResourceTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_resource_tags_request.serialize_json(input_)
    ).encode()
