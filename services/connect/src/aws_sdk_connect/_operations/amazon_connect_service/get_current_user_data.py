...
if TYPE_CHECKING:
    import aws_sdk_connect.types.get_current_user_data_request
    import aws_sdk_connect.types.get_current_user_data_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.get_current_user_data_response.GetCurrentUserDataResponse = aws_sdk_connect.types.get_current_user_data_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.get_current_user_data_request.GetCurrentUserDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.get_current_user_data_request.serialize_json(input_)
    ).encode()
