...
def build_request(
    ...
    input: aws_sdk_connect.types.get_current_user_data_request.GetCurrentUserDataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.get_current_user_data_request.serialize_json(input)
    ).encode()
