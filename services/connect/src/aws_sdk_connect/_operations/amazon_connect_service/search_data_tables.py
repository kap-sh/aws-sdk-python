...
if TYPE_CHECKING:
    import aws_sdk_connect.types.search_data_tables_request
    import aws_sdk_connect.types.search_data_tables_response
...
) -> aws_sdk_connect.types.search_data_tables_response.SearchDataTablesResponse:
    import aws_sdk_connect.types.search_data_tables_response

    out: aws_sdk_connect.types.search_data_tables_response.SearchDataTablesResponse = (
        aws_sdk_connect.types.search_data_tables_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_data_tables_request.SearchDataTablesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_data_tables_request.serialize_json(input_)
    ).encode()
