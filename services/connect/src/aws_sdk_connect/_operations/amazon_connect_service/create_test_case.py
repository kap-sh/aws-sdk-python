"""Generated from Smithy shape ``com.amazonaws.connect#CreateTestCase``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.create_test_case_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTestCaseException":
            import aws_sdk_connect.errors.invalid_test_case_exception

            raise aws_sdk_connect.errors.invalid_test_case_exception.InvalidTestCaseException.from_json(
                data
            )
...
) -> aws_sdk_connect.types.create_test_case_response.CreateTestCaseResponse:
    import aws_sdk_connect.types.create_test_case_response

    out: aws_sdk_connect.types.create_test_case_response.CreateTestCaseResponse = (
        aws_sdk_connect.types.create_test_case_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.create_test_case_request.CreateTestCaseRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/test-cases/{InstanceId}"
    url = url.replace("{InstanceId}", quote(str(input["instance_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    if "test_case_id" in input:
        headers["x-amz-resource-id"] = str(input["test_case_id"])
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_test_case_request.serialize_json(input)
    ).encode()
...
async def async_create_test_case(
