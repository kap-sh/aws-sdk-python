...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_workspace_media_request
    import aws_sdk_connect.types.list_workspace_media_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_workspace_media_response.ListWorkspaceMediaResponse = aws_sdk_connect.types.list_workspace_media_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_workspace_media_request.ListWorkspaceMediaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
