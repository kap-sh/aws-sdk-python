"""Generated from Smithy shape ``com.amazonaws.connect#ListWorkspaces``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_workspaces_request
    import aws_sdk_connect.types.list_workspaces_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_workspaces_response.ListWorkspacesResponse = (
        aws_sdk_connect.types.list_workspaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_workspaces_request.ListWorkspacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
