"""Generated from Smithy shape ``com.amazonaws.connect#DescribeTestCase``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_test_case_request
    import aws_sdk_connect.types.describe_test_case_response
...
) -> aws_sdk_connect.types.describe_test_case_response.DescribeTestCaseResponse:
    import aws_sdk_connect.types.describe_test_case_response

    out: aws_sdk_connect.types.describe_test_case_response.DescribeTestCaseResponse = (
        aws_sdk_connect.types.describe_test_case_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_test_case_request.DescribeTestCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_test_case(
