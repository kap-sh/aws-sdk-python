"""Generated from Smithy shape ``com.amazonaws.connect#GetEffectiveHoursOfOperations``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.get_effective_hours_of_operations_request
    import aws_sdk_connect.types.get_effective_hours_of_operations_response
...
) -> aws_sdk_connect.types.get_effective_hours_of_operations_response.GetEffectiveHoursOfOperationsResponse:
    import aws_sdk_connect.types.get_effective_hours_of_operations_response

    out: aws_sdk_connect.types.get_effective_hours_of_operations_response.GetEffectiveHoursOfOperationsResponse = aws_sdk_connect.types.get_effective_hours_of_operations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.get_effective_hours_of_operations_request.GetEffectiveHoursOfOperationsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{HoursOfOperationId}", quote(str(input["hours_of_operation_id"]), safe="")
    )
    params: dict[str, str] = {}
    if "from_date" in input:
        params["fromDate"] = str(input["from_date"])
    if "to_date" in input:
        params["toDate"] = str(input["to_date"])
...
async def async_get_effective_hours_of_operations(
