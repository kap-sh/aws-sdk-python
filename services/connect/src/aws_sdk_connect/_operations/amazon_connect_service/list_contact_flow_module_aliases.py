"""Generated from Smithy shape ``com.amazonaws.connect#ListContactFlowModuleAliases``."""
...
import aws_sdk_connect.types.list_contact_flow_module_aliases_request
import aws_sdk_connect.types.list_contact_flow_module_aliases_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_contact_flow_module_aliases_response.ListContactFlowModuleAliasesResponse = aws_sdk_connect.types.list_contact_flow_module_aliases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_contact_flow_module_aliases_request.ListContactFlowModuleAliasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_contact_flow_module_aliases(
