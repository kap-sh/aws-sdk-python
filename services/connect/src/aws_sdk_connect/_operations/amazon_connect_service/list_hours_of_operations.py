...
import aws_sdk_connect.types.list_hours_of_operations_request
import aws_sdk_connect.types.list_hours_of_operations_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_hours_of_operations_response.ListHoursOfOperationsResponse = aws_sdk_connect.types.list_hours_of_operations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_hours_of_operations_request.ListHoursOfOperationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
