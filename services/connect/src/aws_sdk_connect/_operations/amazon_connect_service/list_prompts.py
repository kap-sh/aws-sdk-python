...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_prompts_request
    import aws_sdk_connect.types.list_prompts_response
...
) -> aws_sdk_connect.types.list_prompts_response.ListPromptsResponse:
    import aws_sdk_connect.types.list_prompts_response

    out: aws_sdk_connect.types.list_prompts_response.ListPromptsResponse = (
        aws_sdk_connect.types.list_prompts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_prompts_request.ListPromptsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_prompts(
    ...
    aws_sdk_connect.types.list_prompts_response.ListPromptsResponse, zapros.Response
]:
