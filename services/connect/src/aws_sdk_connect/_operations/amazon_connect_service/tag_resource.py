...
import aws_sdk_connect.types.tag_resource_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.tag_resource_request.serialize_json(input_)
    ).encode()
