...
import aws_sdk_connect.types.delete_attached_file_request
import aws_sdk_connect.types.delete_attached_file_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_attached_file_response.DeleteAttachedFileResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_attached_file_request.DeleteAttachedFileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
