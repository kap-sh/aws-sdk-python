...
if TYPE_CHECKING:
    import aws_sdk_connect.types.get_test_case_execution_summary_request
    import aws_sdk_connect.types.get_test_case_execution_summary_response
...
) -> aws_sdk_connect.types.get_test_case_execution_summary_response.GetTestCaseExecutionSummaryResponse:
    import aws_sdk_connect.types.get_test_case_execution_summary_response

    out: aws_sdk_connect.types.get_test_case_execution_summary_response.GetTestCaseExecutionSummaryResponse = aws_sdk_connect.types.get_test_case_execution_summary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.get_test_case_execution_summary_request.GetTestCaseExecutionSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
