...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_task_templates_request
    import aws_sdk_connect.types.list_task_templates_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_task_templates_response.ListTaskTemplatesResponse = aws_sdk_connect.types.list_task_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_task_templates_request.ListTaskTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
