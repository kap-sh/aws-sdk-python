"""Generated from Smithy shape ``com.amazonaws.connect#UntagResource``."""
...
import aws_sdk_connect.types.tag_key_list
import aws_sdk_connect.types.untag_resource_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
