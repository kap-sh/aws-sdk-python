...
import aws_sdk_connect.types.update_contact_flow_module_content_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_contact_flow_module_content_response.UpdateContactFlowModuleContentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_contact_flow_module_content_request.UpdateContactFlowModuleContentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
