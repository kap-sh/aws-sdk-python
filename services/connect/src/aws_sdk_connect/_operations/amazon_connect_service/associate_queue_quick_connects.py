"""Generated from Smithy shape ``com.amazonaws.connect#AssociateQueueQuickConnects``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.associate_queue_quick_connects_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_queue_quick_connects_request.AssociateQueueQuickConnectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_queue_quick_connects_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_queue_quick_connects(
