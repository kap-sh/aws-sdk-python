...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_notification_content_request.UpdateNotificationContentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{NotificationId}", quote(str(input_["notification_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_notification_content_request.serialize_json(input_)
    ).encode()
