"""Generated from Smithy shape ``com.amazonaws.connect#ListPredefinedAttributes``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_predefined_attributes_request
    import aws_sdk_connect.types.list_predefined_attributes_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_predefined_attributes_response.ListPredefinedAttributesResponse = aws_sdk_connect.types.list_predefined_attributes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_predefined_attributes_request.ListPredefinedAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_predefined_attributes(
