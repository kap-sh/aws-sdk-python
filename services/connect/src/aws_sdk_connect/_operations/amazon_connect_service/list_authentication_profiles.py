"""Generated from Smithy shape ``com.amazonaws.connect#ListAuthenticationProfiles``."""
...
import aws_sdk_connect.types.list_authentication_profiles_request
import aws_sdk_connect.types.list_authentication_profiles_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_authentication_profiles_response.ListAuthenticationProfilesResponse = aws_sdk_connect.types.list_authentication_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_authentication_profiles_request.ListAuthenticationProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/authentication-profiles-summary/{InstanceId}"
...
async def async_list_authentication_profiles(
