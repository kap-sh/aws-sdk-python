"""Generated from Smithy shape ``com.amazonaws.connect#ListRoutingProfileQueues``."""
...
import aws_sdk_connect.types.list_routing_profile_queues_request
import aws_sdk_connect.types.list_routing_profile_queues_response
import aws_sdk_connect.types.routing_profile_queue_config_summary_list
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_routing_profile_queues_response.ListRoutingProfileQueuesResponse = aws_sdk_connect.types.list_routing_profile_queues_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_routing_profile_queues_request.ListRoutingProfileQueuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_routing_profile_queues(
