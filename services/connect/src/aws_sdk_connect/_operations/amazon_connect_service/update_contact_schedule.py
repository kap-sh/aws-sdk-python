"""Generated from Smithy shape ``com.amazonaws.connect#UpdateContactSchedule``."""
...
import aws_sdk_connect.types.update_contact_schedule_request
import aws_sdk_connect.types.update_contact_schedule_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_contact_schedule_response.UpdateContactScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_contact_schedule_request.UpdateContactScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact/schedule"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_schedule_request.serialize_json(input_)
    ).encode()
...
async def async_update_contact_schedule(
