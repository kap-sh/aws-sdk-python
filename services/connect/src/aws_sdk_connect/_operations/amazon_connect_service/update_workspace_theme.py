...
def build_request(
    ...
    input: aws_sdk_connect.types.update_workspace_theme_request.UpdateWorkspaceThemeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_workspace_theme_request.serialize_json(input)
    ).encode()
