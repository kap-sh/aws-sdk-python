...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_workspace_theme_request
    import aws_sdk_connect.types.update_workspace_theme_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_workspace_theme_response.UpdateWorkspaceThemeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_workspace_theme_request.UpdateWorkspaceThemeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_workspace_theme_request.serialize_json(input_)
    ).encode()
