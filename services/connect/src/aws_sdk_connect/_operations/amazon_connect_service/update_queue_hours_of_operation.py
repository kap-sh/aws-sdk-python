...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_queue_hours_of_operation_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_queue_hours_of_operation_request.UpdateQueueHoursOfOperationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_queue_hours_of_operation_request.serialize_json(
            input_
        )
    ).encode()
