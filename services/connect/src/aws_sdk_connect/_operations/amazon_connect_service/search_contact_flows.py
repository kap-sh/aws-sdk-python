...
import aws_sdk_connect.types.contact_flow_search_filter
import aws_sdk_connect.types.contact_flow_search_summary_list
import aws_sdk_connect.types.search_contact_flows_request
import aws_sdk_connect.types.search_contact_flows_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_contact_flows_response.SearchContactFlowsResponse = aws_sdk_connect.types.search_contact_flows_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_contact_flows_request.SearchContactFlowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_contact_flows_request.serialize_json(input_)
    ).encode()
