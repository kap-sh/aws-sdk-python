...
def build_request(
    ...
    input: aws_sdk_connect.types.search_contact_flows_request.SearchContactFlowsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_contact_flows_request.serialize_json(input)
    ).encode()
