...
def build_request(
    ...
    input: aws_sdk_connect.types.create_agent_status_request.CreateAgentStatusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_agent_status_request.serialize_json(input)
    ).encode()
