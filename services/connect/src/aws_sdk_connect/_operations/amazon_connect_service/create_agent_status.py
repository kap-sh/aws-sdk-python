...
import aws_sdk_connect.types.create_agent_status_request
import aws_sdk_connect.types.create_agent_status_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_agent_status_response.CreateAgentStatusResponse = aws_sdk_connect.types.create_agent_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_agent_status_request.CreateAgentStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_agent_status_request.serialize_json(input_)
    ).encode()
