...
import aws_sdk_connect.types.list_security_keys_request
import aws_sdk_connect.types.list_security_keys_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_security_keys_response.ListSecurityKeysResponse = (
        aws_sdk_connect.types.list_security_keys_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_security_keys_request.ListSecurityKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
