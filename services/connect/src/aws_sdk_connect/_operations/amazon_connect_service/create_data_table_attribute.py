...
def build_request(
    ...
    input: aws_sdk_connect.types.create_data_table_attribute_request.CreateDataTableAttributeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_data_table_attribute_request.serialize_json(input)
    ).encode()
