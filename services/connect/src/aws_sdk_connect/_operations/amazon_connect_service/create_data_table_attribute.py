...
import aws_sdk_connect.types.create_data_table_attribute_request
import aws_sdk_connect.types.create_data_table_attribute_response
...
) -> aws_sdk_connect.types.create_data_table_attribute_response.CreateDataTableAttributeResponse:
    out: aws_sdk_connect.types.create_data_table_attribute_response.CreateDataTableAttributeResponse = aws_sdk_connect.types.create_data_table_attribute_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_data_table_attribute_request.CreateDataTableAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_data_table_attribute_request.serialize_json(input_)
    ).encode()
