...
import aws_sdk_connect.types.list_views_request
import aws_sdk_connect.types.list_views_response
...
) -> aws_sdk_connect.types.list_views_response.ListViewsResponse:
    out: aws_sdk_connect.types.list_views_response.ListViewsResponse = (
        aws_sdk_connect.types.list_views_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_views_request.ListViewsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_views(
    ...
    aws_sdk_connect.types.list_views_response.ListViewsResponse, zapros.Response
]:
