"""Generated from Smithy shape ``com.amazonaws.connect#DescribeUserHierarchyStructure``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_user_hierarchy_structure_request
    import aws_sdk_connect.types.describe_user_hierarchy_structure_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_user_hierarchy_structure_response.DescribeUserHierarchyStructureResponse = aws_sdk_connect.types.describe_user_hierarchy_structure_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_user_hierarchy_structure_request.DescribeUserHierarchyStructureRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/user-hierarchy-structure/{InstanceId}"
...
async def async_describe_user_hierarchy_structure(
