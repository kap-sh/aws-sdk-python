...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_user_identity_info_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_user_identity_info_request.UpdateUserIdentityInfoRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_identity_info_request.serialize_json(input_)
    ).encode()
