...
def build_request(
    ...
    input: aws_sdk_connect.types.update_user_identity_info_request.UpdateUserIdentityInfoRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_identity_info_request.serialize_json(input)
    ).encode()
