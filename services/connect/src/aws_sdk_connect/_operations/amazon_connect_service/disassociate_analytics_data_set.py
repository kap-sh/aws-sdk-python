...
import aws_sdk_connect.types.disassociate_analytics_data_set_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_analytics_data_set_request.DisassociateAnalyticsDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.disassociate_analytics_data_set_request.serialize_json(
            input_
        )
    ).encode()
