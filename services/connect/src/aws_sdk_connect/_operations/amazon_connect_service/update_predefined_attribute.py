...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_predefined_attribute_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_predefined_attribute_request.UpdatePredefinedAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_predefined_attribute_request.serialize_json(input_)
    ).encode()
