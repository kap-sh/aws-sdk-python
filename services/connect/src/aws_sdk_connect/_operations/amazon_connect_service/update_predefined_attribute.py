...
def build_request(
    ...
    input: aws_sdk_connect.types.update_predefined_attribute_request.UpdatePredefinedAttributeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_predefined_attribute_request.serialize_json(input)
    ).encode()
