...
import aws_sdk_connect.types.associate_lambda_function_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_lambda_function_request.AssociateLambdaFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_lambda_function_request.serialize_json(input_)
    ).encode()
