...
def build_request(
    ...
    input: aws_sdk_connect.types.associate_lambda_function_request.AssociateLambdaFunctionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_lambda_function_request.serialize_json(input)
    ).encode()
