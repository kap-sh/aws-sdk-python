...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_approved_origins_request
    import aws_sdk_connect.types.list_approved_origins_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_approved_origins_response.ListApprovedOriginsResponse = aws_sdk_connect.types.list_approved_origins_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_approved_origins_request.ListApprovedOriginsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
