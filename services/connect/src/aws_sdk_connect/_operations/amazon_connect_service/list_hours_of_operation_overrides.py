"""Generated from Smithy shape ``com.amazonaws.connect#ListHoursOfOperationOverrides``."""
...
import aws_sdk_connect.types.list_hours_of_operation_overrides_request
import aws_sdk_connect.types.list_hours_of_operation_overrides_response
...
) -> aws_sdk_connect.types.list_hours_of_operation_overrides_response.ListHoursOfOperationOverridesResponse:
    out: aws_sdk_connect.types.list_hours_of_operation_overrides_response.ListHoursOfOperationOverridesResponse = aws_sdk_connect.types.list_hours_of_operation_overrides_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_hours_of_operation_overrides_request.ListHoursOfOperationOverridesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_hours_of_operation_overrides(
