...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_contact_flow_metadata_request.UpdateContactFlowMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_flow_metadata_request.serialize_json(
            input_
        )
    ).encode()
