"""Generated from Smithy shape ``com.amazonaws.connect#UpdateContactFlowMetadata``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_contact_flow_metadata_request
    import aws_sdk_connect.types.update_contact_flow_metadata_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_contact_flow_metadata_response.UpdateContactFlowMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_connect.types.update_contact_flow_metadata_request.UpdateContactFlowMetadataRequest,
) -> zapros.Request:
    ...
    url = url.replace("{ContactFlowId}", quote(str(input["contact_flow_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.update_contact_flow_metadata_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_flow_metadata_request.serialize_json(input)
    ).encode()
...
async def async_update_contact_flow_metadata(
