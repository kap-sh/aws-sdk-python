...
def build_request(
    ...
    input: aws_sdk_connect.types.create_user_hierarchy_group_request.CreateUserHierarchyGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_user_hierarchy_group_request.serialize_json(input)
    ).encode()
