"""Generated from Smithy shape ``com.amazonaws.connect#CreateUserHierarchyGroup``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_user_hierarchy_group_request
    import aws_sdk_connect.types.create_user_hierarchy_group_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_user_hierarchy_group_response.CreateUserHierarchyGroupResponse = aws_sdk_connect.types.create_user_hierarchy_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_user_hierarchy_group_request.CreateUserHierarchyGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/user-hierarchy-groups/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_user_hierarchy_group_request.serialize_json(input_)
    ).encode()
...
async def async_create_user_hierarchy_group(
