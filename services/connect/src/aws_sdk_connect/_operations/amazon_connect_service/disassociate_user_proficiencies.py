"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateUserProficiencies``."""
...
import aws_sdk_connect.types.disassociate_user_proficiencies_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_user_proficiencies_request.DisassociateUserProficienciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.disassociate_user_proficiencies_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_user_proficiencies(
