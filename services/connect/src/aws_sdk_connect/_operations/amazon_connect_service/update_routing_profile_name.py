...
def build_request(
    ...
    input: aws_sdk_connect.types.update_routing_profile_name_request.UpdateRoutingProfileNameRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_routing_profile_name_request.serialize_json(input)
    ).encode()
