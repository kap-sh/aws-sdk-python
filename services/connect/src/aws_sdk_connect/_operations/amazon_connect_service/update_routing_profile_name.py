...
import aws_sdk_connect.types.update_routing_profile_name_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_routing_profile_name_request.UpdateRoutingProfileNameRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_routing_profile_name_request.serialize_json(input_)
    ).encode()
