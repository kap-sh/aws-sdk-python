...
import aws_sdk_connect.types.create_hours_of_operation_request
import aws_sdk_connect.types.create_hours_of_operation_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_hours_of_operation_response.CreateHoursOfOperationResponse = aws_sdk_connect.types.create_hours_of_operation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_hours_of_operation_request.CreateHoursOfOperationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_hours_of_operation_request.serialize_json(input_)
    ).encode()
