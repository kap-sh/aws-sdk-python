...
def build_request(
    ...
    input: aws_sdk_connect.types.create_hours_of_operation_request.CreateHoursOfOperationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_hours_of_operation_request.serialize_json(input)
    ).encode()
