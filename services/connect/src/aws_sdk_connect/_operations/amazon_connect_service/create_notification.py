...
def build_request(
    ...
    input: aws_sdk_connect.types.create_notification_request.CreateNotificationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_notification_request.serialize_json(input)
    ).encode()
