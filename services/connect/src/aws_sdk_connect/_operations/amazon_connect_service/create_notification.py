...
import aws_sdk_connect.types.create_notification_request
import aws_sdk_connect.types.create_notification_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_notification_response.CreateNotificationResponse = aws_sdk_connect.types.create_notification_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_notification_request.CreateNotificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_notification_request.serialize_json(input_)
    ).encode()
