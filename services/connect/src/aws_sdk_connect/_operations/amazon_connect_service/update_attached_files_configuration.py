...
def build_request(
    ...
    input: aws_sdk_connect.types.update_attached_files_configuration_request.UpdateAttachedFilesConfigurationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{AttachmentScope}", quote(str(input["attachment_scope"]), safe="")
    )
    params: dict[str, str] = {}
