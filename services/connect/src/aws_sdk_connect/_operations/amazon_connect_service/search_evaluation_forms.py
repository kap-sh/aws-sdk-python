...
def build_request(
    ...
    input: aws_sdk_connect.types.search_evaluation_forms_request.SearchEvaluationFormsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_evaluation_forms_request.serialize_json(input)
    ).encode()
