"""Generated from Smithy shape ``com.amazonaws.connect#SearchEvaluationForms``."""
...
import aws_sdk_connect.types.search_evaluation_forms_request
import aws_sdk_connect.types.search_evaluation_forms_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_evaluation_forms_response.SearchEvaluationFormsResponse = aws_sdk_connect.types.search_evaluation_forms_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_evaluation_forms_request.SearchEvaluationFormsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-evaluation-forms"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_evaluation_forms_request.serialize_json(input_)
    ).encode()
...
async def async_search_evaluation_forms(
