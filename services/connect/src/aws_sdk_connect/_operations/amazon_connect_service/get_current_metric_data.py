...
def build_request(
    ...
    input: aws_sdk_connect.types.get_current_metric_data_request.GetCurrentMetricDataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.get_current_metric_data_request.serialize_json(input)
    ).encode()
