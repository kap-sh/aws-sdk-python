...
def build_request(
    ...
    input: aws_sdk_connect.types.resume_contact_recording_request.ResumeContactRecordingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.resume_contact_recording_request.serialize_json(input)
    ).encode()
