...
def build_request(
    ...
    input_: aws_sdk_connect.types.resume_contact_recording_request.ResumeContactRecordingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.resume_contact_recording_request.serialize_json(input_)
    ).encode()
