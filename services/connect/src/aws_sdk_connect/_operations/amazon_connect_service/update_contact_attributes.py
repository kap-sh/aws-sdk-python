...
import aws_sdk_connect.types.update_contact_attributes_request
import aws_sdk_connect.types.update_contact_attributes_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_contact_attributes_response.UpdateContactAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_contact_attributes_request.UpdateContactAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_attributes_request.serialize_json(input_)
    ).encode()
