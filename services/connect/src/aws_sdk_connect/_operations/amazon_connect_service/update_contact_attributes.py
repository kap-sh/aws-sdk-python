...
def build_request(
    ...
    input: aws_sdk_connect.types.update_contact_attributes_request.UpdateContactAttributesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_attributes_request.serialize_json(input)
    ).encode()
