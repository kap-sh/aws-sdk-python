"""Generated from Smithy shape ``com.amazonaws.connect#UpdateAuthenticationProfile``."""
...
import aws_sdk_connect.types.update_authentication_profile_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_authentication_profile_request.UpdateAuthenticationProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_authentication_profile_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_authentication_profile(
