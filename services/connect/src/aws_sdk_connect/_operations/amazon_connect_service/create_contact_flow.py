...
def build_request(
    ...
    input: aws_sdk_connect.types.create_contact_flow_request.CreateContactFlowRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_contact_flow_request.serialize_json(input)
    ).encode()
