...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_contact_flow_request
    import aws_sdk_connect.types.create_contact_flow_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_contact_flow_response.CreateContactFlowResponse = aws_sdk_connect.types.create_contact_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_contact_flow_request.CreateContactFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_contact_flow_request.serialize_json(input_)
    ).encode()
