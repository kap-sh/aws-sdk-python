"""Generated from Smithy shape ``com.amazonaws.connect#AssociateWorkspace``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.associate_workspace_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.associate_workspace_response.AssociateWorkspaceResponse = aws_sdk_connect.types.associate_workspace_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.associate_workspace_request.AssociateWorkspaceRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{InstanceId}/{WorkspaceId}/associate"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_workspace_request.serialize_json(input)
    ).encode()
...
async def async_associate_workspace(
