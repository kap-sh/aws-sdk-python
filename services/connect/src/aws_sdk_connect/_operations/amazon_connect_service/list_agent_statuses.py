...
def build_request(
    ...
    input: aws_sdk_connect.types.list_agent_status_request.ListAgentStatusRequest,
) -> zapros.Request:
    ...
    if "agent_status_types" in input:
        params["AgentStatusTypes"] = str(input["agent_status_types"])
