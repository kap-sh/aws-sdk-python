"""Generated from Smithy shape ``com.amazonaws.connect#ListAgentStatuses``."""
...
import aws_sdk_connect.types.list_agent_status_request
import aws_sdk_connect.types.list_agent_status_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_agent_status_response.ListAgentStatusResponse = (
        aws_sdk_connect.types.list_agent_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_agent_status_request.ListAgentStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/agent-status/{InstanceId}"
    ...
    if "agent_status_types" in input_:
        params["AgentStatusTypes"] = str(input_["agent_status_types"])
...
async def async_list_agent_statuses(
