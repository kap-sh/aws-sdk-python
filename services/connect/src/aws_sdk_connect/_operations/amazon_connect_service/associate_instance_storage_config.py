"""Generated from Smithy shape ``com.amazonaws.connect#AssociateInstanceStorageConfig``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.associate_instance_storage_config_request
    import aws_sdk_connect.types.associate_instance_storage_config_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.associate_instance_storage_config_response.AssociateInstanceStorageConfigResponse = aws_sdk_connect.types.associate_instance_storage_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_instance_storage_config_request.AssociateInstanceStorageConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/storage-config"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_instance_storage_config_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_instance_storage_config(
