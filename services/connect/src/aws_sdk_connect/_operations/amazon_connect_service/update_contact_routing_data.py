...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_contact_routing_data_request.UpdateContactRoutingDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_routing_data_request.serialize_json(input_)
    ).encode()
