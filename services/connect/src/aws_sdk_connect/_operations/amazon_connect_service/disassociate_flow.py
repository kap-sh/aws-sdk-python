"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateFlow``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.disassociate_flow_request
    import aws_sdk_connect.types.disassociate_flow_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.disassociate_flow_response.DisassociateFlowResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_flow_request.DisassociateFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_flow(
