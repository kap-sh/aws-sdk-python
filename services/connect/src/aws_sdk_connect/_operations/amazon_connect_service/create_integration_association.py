...
import aws_sdk_connect.types.create_integration_association_request
import aws_sdk_connect.types.create_integration_association_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_integration_association_response.CreateIntegrationAssociationResponse = aws_sdk_connect.types.create_integration_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_integration_association_request.CreateIntegrationAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_integration_association_request.serialize_json(
            input_
        )
    ).encode()
