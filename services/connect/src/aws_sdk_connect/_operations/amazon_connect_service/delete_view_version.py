"""Generated from Smithy shape ``com.amazonaws.connect#DeleteViewVersion``."""
...
import aws_sdk_connect.types.delete_view_version_request
import aws_sdk_connect.types.delete_view_version_response
...
) -> aws_sdk_connect.types.delete_view_version_response.DeleteViewVersionResponse:
    out: aws_sdk_connect.types.delete_view_version_response.DeleteViewVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_view_version_request.DeleteViewVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/views/{InstanceId}/{ViewId}/versions/{ViewVersion}"
    )
    url = url.replace("{InstanceId}", quote(str(input_["instance_id"]), safe=""))
    url = url.replace("{ViewId}", quote(str(input_["view_id"]), safe=""))
    url = url.replace("{ViewVersion}", quote(str(input_["view_version"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_view_version(
