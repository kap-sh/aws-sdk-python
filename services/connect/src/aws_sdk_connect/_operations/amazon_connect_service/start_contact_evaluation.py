"""Generated from Smithy shape ``com.amazonaws.connect#StartContactEvaluation``."""
...
import aws_sdk_connect.types.start_contact_evaluation_request
import aws_sdk_connect.types.start_contact_evaluation_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.start_contact_evaluation_response.StartContactEvaluationResponse = aws_sdk_connect.types.start_contact_evaluation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.start_contact_evaluation_request.StartContactEvaluationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact-evaluations/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_contact_evaluation_request.serialize_json(input_)
    ).encode()
...
async def async_start_contact_evaluation(
