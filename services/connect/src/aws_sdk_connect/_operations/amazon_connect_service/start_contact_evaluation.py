...
def build_request(
    ...
    input: aws_sdk_connect.types.start_contact_evaluation_request.StartContactEvaluationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_contact_evaluation_request.serialize_json(input)
    ).encode()
