...
def build_request(
    ...
    input: aws_sdk_connect.types.update_workspace_visibility_request.UpdateWorkspaceVisibilityRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_workspace_visibility_request.serialize_json(input)
    ).encode()
