"""Generated from Smithy shape ``com.amazonaws.connect#UpdateWorkspaceVisibility``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_workspace_visibility_request
    import aws_sdk_connect.types.update_workspace_visibility_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_workspace_visibility_response.UpdateWorkspaceVisibilityResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_workspace_visibility_request.UpdateWorkspaceVisibilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{InstanceId}/{WorkspaceId}/visibility"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_workspace_visibility_request.serialize_json(input_)
    ).encode()
...
async def async_update_workspace_visibility(
