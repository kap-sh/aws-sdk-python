...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.start_chat_contact_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.start_chat_contact_response.StartChatContactResponse = (
        aws_sdk_connect.types.start_chat_contact_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.start_chat_contact_request.StartChatContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_chat_contact_request.serialize_json(input)
    ).encode()
