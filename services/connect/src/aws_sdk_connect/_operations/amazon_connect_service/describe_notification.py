...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_notification_request
    import aws_sdk_connect.types.describe_notification_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_notification_response.DescribeNotificationResponse = aws_sdk_connect.types.describe_notification_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_notification_request.DescribeNotificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
