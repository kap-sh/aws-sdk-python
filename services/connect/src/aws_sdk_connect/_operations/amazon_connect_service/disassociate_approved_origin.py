"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateApprovedOrigin``."""
...
import aws_sdk_connect.types.disassociate_approved_origin_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_approved_origin_request.DisassociateApprovedOriginRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_approved_origin(
