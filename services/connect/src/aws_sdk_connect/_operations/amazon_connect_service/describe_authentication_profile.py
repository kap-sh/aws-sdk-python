"""Generated from Smithy shape ``com.amazonaws.connect#DescribeAuthenticationProfile``."""
...
import aws_sdk_connect.types.describe_authentication_profile_request
import aws_sdk_connect.types.describe_authentication_profile_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_authentication_profile_response.DescribeAuthenticationProfileResponse = aws_sdk_connect.types.describe_authentication_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_authentication_profile_request.DescribeAuthenticationProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["authentication_profile_id"]), safe=""),
    )
...
async def async_describe_authentication_profile(
