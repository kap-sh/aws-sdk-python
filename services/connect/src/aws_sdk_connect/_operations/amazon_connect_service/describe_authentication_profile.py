...
def build_request(
    ...
    input: aws_sdk_connect.types.describe_authentication_profile_request.DescribeAuthenticationProfileRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["authentication_profile_id"]), safe=""),
    )
