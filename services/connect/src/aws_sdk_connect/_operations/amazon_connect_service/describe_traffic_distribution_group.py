"""Generated from Smithy shape ``com.amazonaws.connect#DescribeTrafficDistributionGroup``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_traffic_distribution_group_request
    import aws_sdk_connect.types.describe_traffic_distribution_group_response
...
) -> aws_sdk_connect.types.describe_traffic_distribution_group_response.DescribeTrafficDistributionGroupResponse:
    import aws_sdk_connect.types.describe_traffic_distribution_group_response

    out: aws_sdk_connect.types.describe_traffic_distribution_group_response.DescribeTrafficDistributionGroupResponse = aws_sdk_connect.types.describe_traffic_distribution_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_traffic_distribution_group_request.DescribeTrafficDistributionGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_traffic_distribution_group(
