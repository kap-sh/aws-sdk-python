...
def build_request(
    ...
    input: aws_sdk_connect.types.update_traffic_distribution_request.UpdateTrafficDistributionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_traffic_distribution_request.serialize_json(input)
    ).encode()
