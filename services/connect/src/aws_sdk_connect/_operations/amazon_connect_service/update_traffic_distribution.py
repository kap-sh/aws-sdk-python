"""Generated from Smithy shape ``com.amazonaws.connect#UpdateTrafficDistribution``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_traffic_distribution_request
    import aws_sdk_connect.types.update_traffic_distribution_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_traffic_distribution_response.UpdateTrafficDistributionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_traffic_distribution_request.UpdateTrafficDistributionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/traffic-distribution/{Id}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_traffic_distribution_request.serialize_json(input_)
    ).encode()
...
async def async_update_traffic_distribution(
