"""Generated from Smithy shape ``com.amazonaws.connect#DescribeInstanceAttribute``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_instance_attribute_request
    import aws_sdk_connect.types.describe_instance_attribute_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_instance_attribute_response.DescribeInstanceAttributeResponse = aws_sdk_connect.types.describe_instance_attribute_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.describe_instance_attribute_request.DescribeInstanceAttributeRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/attribute/{AttributeType}"
