...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_workspace_request
    import aws_sdk_connect.types.create_workspace_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_workspace_response.CreateWorkspaceResponse = (
        aws_sdk_connect.types.create_workspace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_workspace_request.CreateWorkspaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_workspace_request.serialize_json(input_)
    ).encode()
