"""Generated from Smithy shape ``com.amazonaws.connect#ListQueues``."""
...
import aws_sdk_connect.types.list_queues_request
import aws_sdk_connect.types.list_queues_response
import aws_sdk_connect.types.queue_summary_list
import aws_sdk_connect.types.queue_types
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_queues_response.ListQueuesResponse = (
        aws_sdk_connect.types.list_queues_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_queues_request.ListQueuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/queues-summary/{InstanceId}"
    url = url.replace("{InstanceId}", quote(str(input_["instance_id"]), safe=""))
    params: dict[str, str] = {}
    if "queue_types" in input_:
        params["queueTypes"] = str(input_["queue_types"])
...
def list_queues(
    ...
    aws_sdk_connect.types.list_queues_response.ListQueuesResponse, zapros.Response
]:
