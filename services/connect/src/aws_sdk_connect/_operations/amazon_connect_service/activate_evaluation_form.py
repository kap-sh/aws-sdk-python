...
def build_request(
    ...
    input: aws_sdk_connect.types.activate_evaluation_form_request.ActivateEvaluationFormRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{EvaluationFormId}", quote(str(input["evaluation_form_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.activate_evaluation_form_request.serialize_json(input)
    ).encode()
