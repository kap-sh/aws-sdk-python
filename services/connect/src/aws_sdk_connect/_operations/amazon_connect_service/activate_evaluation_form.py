"""Generated from Smithy shape ``com.amazonaws.connect#ActivateEvaluationForm``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.activate_evaluation_form_request
    import aws_sdk_connect.types.activate_evaluation_form_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.activate_evaluation_form_response.ActivateEvaluationFormResponse = aws_sdk_connect.types.activate_evaluation_form_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.activate_evaluation_form_request.ActivateEvaluationFormRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{EvaluationFormId}", quote(str(input_["evaluation_form_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.activate_evaluation_form_request.serialize_json(input_)
    ).encode()
...
async def async_activate_evaluation_form(
