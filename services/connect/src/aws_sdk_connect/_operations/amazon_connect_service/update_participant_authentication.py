...
import aws_sdk_connect.types.update_participant_authentication_request
import aws_sdk_connect.types.update_participant_authentication_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_participant_authentication_response.UpdateParticipantAuthenticationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_participant_authentication_request.UpdateParticipantAuthenticationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_participant_authentication_request.serialize_json(
            input_
        )
    ).encode()
