"""Generated from Smithy shape ``com.amazonaws.connect#CreateWorkspacePage``."""
...
import aws_sdk_connect.types.create_workspace_page_request
import aws_sdk_connect.types.create_workspace_page_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_workspace_page_response.CreateWorkspacePageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_workspace_page_request.CreateWorkspacePageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{InstanceId}/{WorkspaceId}/pages"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_workspace_page_request.serialize_json(input_)
    ).encode()
...
async def async_create_workspace_page(
