...
def build_request(
    ...
    input: aws_sdk_connect.types.create_workspace_page_request.CreateWorkspacePageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_workspace_page_request.serialize_json(input)
    ).encode()
