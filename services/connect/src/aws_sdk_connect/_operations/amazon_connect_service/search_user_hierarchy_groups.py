...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_user_hierarchy_groups_request.SearchUserHierarchyGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_user_hierarchy_groups_request.serialize_json(
            input_
        )
    ).encode()
