"""Generated from Smithy shape ``com.amazonaws.connect#SearchUserHierarchyGroups``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.search_user_hierarchy_groups_request
    import aws_sdk_connect.types.search_user_hierarchy_groups_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_user_hierarchy_groups_response.SearchUserHierarchyGroupsResponse = aws_sdk_connect.types.search_user_hierarchy_groups_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.search_user_hierarchy_groups_request.SearchUserHierarchyGroupsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/search-user-hierarchy-groups"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.search_user_hierarchy_groups_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_user_hierarchy_groups_request.serialize_json(input)
    ).encode()
...
async def async_search_user_hierarchy_groups(
