...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_predefined_attribute_request
    import aws_sdk_connect.types.describe_predefined_attribute_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_predefined_attribute_response.DescribePredefinedAttributeResponse = aws_sdk_connect.types.describe_predefined_attribute_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_predefined_attribute_request.DescribePredefinedAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
