...
def build_request(
    ...
    input: aws_sdk_connect.types.create_contact_flow_module_version_request.CreateContactFlowModuleVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ContactFlowModuleId}", quote(str(input["contact_flow_module_id"]), safe="")
    )
    params: dict[str, str] = {}
