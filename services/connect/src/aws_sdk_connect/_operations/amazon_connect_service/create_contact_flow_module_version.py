"""Generated from Smithy shape ``com.amazonaws.connect#CreateContactFlowModuleVersion``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_contact_flow_module_version_request
    import aws_sdk_connect.types.create_contact_flow_module_version_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_contact_flow_module_version_response.CreateContactFlowModuleVersionResponse = aws_sdk_connect.types.create_contact_flow_module_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_contact_flow_module_version_request.CreateContactFlowModuleVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{ContactFlowModuleId}", quote(str(input_["contact_flow_module_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_contact_flow_module_version_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_contact_flow_module_version(
