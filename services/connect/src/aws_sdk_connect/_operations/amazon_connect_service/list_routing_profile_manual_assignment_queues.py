"""Generated from Smithy shape ``com.amazonaws.connect#ListRoutingProfileManualAssignmentQueues``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_routing_profile_manual_assignment_queues_request
    import aws_sdk_connect.types.list_routing_profile_manual_assignment_queues_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_routing_profile_manual_assignment_queues_response.ListRoutingProfileManualAssignmentQueuesResponse = aws_sdk_connect.types.list_routing_profile_manual_assignment_queues_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_routing_profile_manual_assignment_queues_request.ListRoutingProfileManualAssignmentQueuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_routing_profile_manual_assignment_queues(
