"""Generated from Smithy shape ``com.amazonaws.connect#DeleteView``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_view_request
    import aws_sdk_connect.types.delete_view_response
...
) -> aws_sdk_connect.types.delete_view_response.DeleteViewResponse:
    out: aws_sdk_connect.types.delete_view_response.DeleteViewResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_view_request.DeleteViewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_view(
    ...
    aws_sdk_connect.types.delete_view_response.DeleteViewResponse, zapros.Response
]:
