...
def build_request(
    ...
    input: aws_sdk_connect.types.start_contact_recording_request.StartContactRecordingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_contact_recording_request.serialize_json(input)
    ).encode()
