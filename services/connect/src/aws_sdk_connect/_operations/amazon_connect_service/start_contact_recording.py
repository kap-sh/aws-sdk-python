"""Generated from Smithy shape ``com.amazonaws.connect#StartContactRecording``."""
...
import aws_sdk_connect.types.start_contact_recording_request
import aws_sdk_connect.types.start_contact_recording_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.start_contact_recording_response.StartContactRecordingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.start_contact_recording_request.StartContactRecordingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact/start-recording"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_contact_recording_request.serialize_json(input_)
    ).encode()
...
async def async_start_contact_recording(
