...
def build_request(
    ...
    input: aws_sdk_connect.types.create_quick_connect_request.CreateQuickConnectRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_quick_connect_request.serialize_json(input)
    ).encode()
