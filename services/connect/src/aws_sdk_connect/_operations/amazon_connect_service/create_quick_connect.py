"""Generated from Smithy shape ``com.amazonaws.connect#CreateQuickConnect``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_quick_connect_request
    import aws_sdk_connect.types.create_quick_connect_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_quick_connect_response.CreateQuickConnectResponse = aws_sdk_connect.types.create_quick_connect_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_quick_connect_request.CreateQuickConnectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/quick-connects/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_quick_connect_request.serialize_json(input_)
    ).encode()
...
async def async_create_quick_connect(
