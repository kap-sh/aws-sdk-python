...
import aws_sdk_connect.types.untag_contact_request
import aws_sdk_connect.types.untag_contact_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.untag_contact_response.UntagContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.untag_contact_request.UntagContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def untag_contact(
    ...
    aws_sdk_connect.types.untag_contact_response.UntagContactResponse, zapros.Response
]:
