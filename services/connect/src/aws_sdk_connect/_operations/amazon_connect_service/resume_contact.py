"""Generated from Smithy shape ``com.amazonaws.connect#ResumeContact``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.resume_contact_request
    import aws_sdk_connect.types.resume_contact_response
...
) -> aws_sdk_connect.types.resume_contact_response.ResumeContactResponse:
    out: aws_sdk_connect.types.resume_contact_response.ResumeContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.resume_contact_request.ResumeContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact/resume"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.resume_contact_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.resume_contact_request.serialize_json(input_)
    ).encode()
...
def resume_contact(
    ...
    aws_sdk_connect.types.resume_contact_response.ResumeContactResponse, zapros.Response
]:
...
async def async_resume_contact(
