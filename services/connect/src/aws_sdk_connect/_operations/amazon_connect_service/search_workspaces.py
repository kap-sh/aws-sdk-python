"""Generated from Smithy shape ``com.amazonaws.connect#SearchWorkspaces``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.search_workspaces_request
    import aws_sdk_connect.types.search_workspaces_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_workspaces_response.SearchWorkspacesResponse = (
        aws_sdk_connect.types.search_workspaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_workspaces_request.SearchWorkspacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-workspaces"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.search_workspaces_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_workspaces_request.serialize_json(input_)
    ).encode()
...
async def async_search_workspaces(
