"""Generated from Smithy shape ``com.amazonaws.connect#UpdateContactFlowModuleMetadata``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_contact_flow_module_metadata_request
    import aws_sdk_connect.types.update_contact_flow_module_metadata_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_contact_flow_module_metadata_response.UpdateContactFlowModuleMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_contact_flow_module_metadata_request.UpdateContactFlowModuleMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_flow_module_metadata_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_contact_flow_module_metadata(
