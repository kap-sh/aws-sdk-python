...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_phone_number_request
    import aws_sdk_connect.types.update_phone_number_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_phone_number_response.UpdatePhoneNumberResponse = aws_sdk_connect.types.update_phone_number_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_phone_number_request.UpdatePhoneNumberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_phone_number_request.serialize_json(input_)
    ).encode()
