...
def build_request(
    ...
    input: aws_sdk_connect.types.describe_contact_flow_module_alias_request.DescribeContactFlowModuleAliasRequest,
) -> zapros.Request:
    ...
    url = url.replace("{AliasId}", quote(str(input["alias_id"]), safe=""))
    params: dict[str, str] = {}
