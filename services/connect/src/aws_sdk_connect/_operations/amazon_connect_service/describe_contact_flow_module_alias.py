"""Generated from Smithy shape ``com.amazonaws.connect#DescribeContactFlowModuleAlias``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_contact_flow_module_alias_request
    import aws_sdk_connect.types.describe_contact_flow_module_alias_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_contact_flow_module_alias_response.DescribeContactFlowModuleAliasResponse = aws_sdk_connect.types.describe_contact_flow_module_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_contact_flow_module_alias_request.DescribeContactFlowModuleAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{AliasId}", quote(str(input_["alias_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_describe_contact_flow_module_alias(
