"""Generated from Smithy shape ``com.amazonaws.connect#ListTrafficDistributionGroupUsers``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_traffic_distribution_group_users_request
    import aws_sdk_connect.types.list_traffic_distribution_group_users_response
...
) -> aws_sdk_connect.types.list_traffic_distribution_group_users_response.ListTrafficDistributionGroupUsersResponse:
    import aws_sdk_connect.types.list_traffic_distribution_group_users_response

    out: aws_sdk_connect.types.list_traffic_distribution_group_users_response.ListTrafficDistributionGroupUsersResponse = aws_sdk_connect.types.list_traffic_distribution_group_users_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_traffic_distribution_group_users_request.ListTrafficDistributionGroupUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_traffic_distribution_group_users(
