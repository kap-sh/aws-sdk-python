...
if TYPE_CHECKING:
    import aws_sdk_connect.types.get_traffic_distribution_request
    import aws_sdk_connect.types.get_traffic_distribution_response
...
) -> aws_sdk_connect.types.get_traffic_distribution_response.GetTrafficDistributionResponse:
    import aws_sdk_connect.types.get_traffic_distribution_response

    out: aws_sdk_connect.types.get_traffic_distribution_response.GetTrafficDistributionResponse = aws_sdk_connect.types.get_traffic_distribution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.get_traffic_distribution_request.GetTrafficDistributionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
