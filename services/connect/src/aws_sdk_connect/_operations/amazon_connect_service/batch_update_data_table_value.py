...
import aws_sdk_connect.types.batch_update_data_table_value_request
import aws_sdk_connect.types.batch_update_data_table_value_response
...
) -> aws_sdk_connect.types.batch_update_data_table_value_response.BatchUpdateDataTableValueResponse:
    out: aws_sdk_connect.types.batch_update_data_table_value_response.BatchUpdateDataTableValueResponse = aws_sdk_connect.types.batch_update_data_table_value_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.batch_update_data_table_value_request.BatchUpdateDataTableValueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.batch_update_data_table_value_request.serialize_json(
            input_
        )
    ).encode()
