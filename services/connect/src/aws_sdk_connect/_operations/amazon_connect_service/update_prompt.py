...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.update_prompt_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_prompt_response.UpdatePromptResponse = (
        aws_sdk_connect.types.update_prompt_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.update_prompt_request.UpdatePromptRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_prompt_request.serialize_json(input)
    ).encode()
...
def update_prompt(
    ...
    aws_sdk_connect.types.update_prompt_response.UpdatePromptResponse, zapros.Response
]:
