...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_attached_files_configuration_request
    import aws_sdk_connect.types.describe_attached_files_configuration_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_attached_files_configuration_response.DescribeAttachedFilesConfigurationResponse = aws_sdk_connect.types.describe_attached_files_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_attached_files_configuration_request.DescribeAttachedFilesConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
