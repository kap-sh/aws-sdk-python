"""Generated from Smithy shape ``com.amazonaws.connect#ListTestCases``."""
...
import aws_sdk_connect.types.list_test_cases_request
import aws_sdk_connect.types.list_test_cases_response
...
) -> aws_sdk_connect.types.list_test_cases_response.ListTestCasesResponse:
    out: aws_sdk_connect.types.list_test_cases_response.ListTestCasesResponse = (
        aws_sdk_connect.types.list_test_cases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_test_cases_request.ListTestCasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/test-cases-summary/{InstanceId}"
...
async def async_list_test_cases(
