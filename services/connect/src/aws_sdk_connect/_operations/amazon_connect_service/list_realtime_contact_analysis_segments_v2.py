...
import aws_sdk_connect.errors.output_type_not_found_exception
import aws_sdk_connect.errors.resource_not_found_exception
import aws_sdk_connect.errors.throttling_exception
import aws_sdk_connect.types.list_realtime_contact_analysis_segments_v2_request
import aws_sdk_connect.types.list_realtime_contact_analysis_segments_v2_response
import aws_sdk_connect.types.real_time_contact_analysis_output_type
import aws_sdk_connect.types.real_time_contact_analysis_segment_types
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OutputTypeNotFoundException":
            raise aws_sdk_connect.errors.output_type_not_found_exception.OutputTypeNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_realtime_contact_analysis_segments_v2_response.ListRealtimeContactAnalysisSegmentsV2Response = aws_sdk_connect.types.list_realtime_contact_analysis_segments_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_realtime_contact_analysis_segments_v2_request.ListRealtimeContactAnalysisSegmentsV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.list_realtime_contact_analysis_segments_v2_request.serialize_json(
            input_
        )
    ).encode()
