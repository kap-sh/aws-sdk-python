...
def build_request(
    ...
    input: aws_sdk_connect.types.update_queue_max_contacts_request.UpdateQueueMaxContactsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_queue_max_contacts_request.serialize_json(input)
    ).encode()
