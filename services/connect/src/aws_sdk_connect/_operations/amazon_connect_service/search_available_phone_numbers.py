...
if TYPE_CHECKING:
    import aws_sdk_connect.types.search_available_phone_numbers_request
    import aws_sdk_connect.types.search_available_phone_numbers_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_available_phone_numbers_response.SearchAvailablePhoneNumbersResponse = aws_sdk_connect.types.search_available_phone_numbers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_available_phone_numbers_request.SearchAvailablePhoneNumbersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_available_phone_numbers_request.serialize_json(
            input_
        )
    ).encode()
