...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_default_vocabulary_request.AssociateDefaultVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_default_vocabulary_request.serialize_json(
            input_
        )
    ).encode()
