...
if TYPE_CHECKING:
    import aws_sdk_connect.types.associate_default_vocabulary_request
    import aws_sdk_connect.types.associate_default_vocabulary_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.associate_default_vocabulary_response.AssociateDefaultVocabularyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_connect.types.associate_default_vocabulary_request.AssociateDefaultVocabularyRequest,
) -> zapros.Request:
    ...
    url = url.replace("{LanguageCode}", quote(str(input["language_code"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.associate_default_vocabulary_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_default_vocabulary_request.serialize_json(input)
    ).encode()
