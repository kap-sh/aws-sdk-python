...
import aws_sdk_connect.types.list_lex_bots_request
import aws_sdk_connect.types.list_lex_bots_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_lex_bots_response.ListLexBotsResponse = (
        aws_sdk_connect.types.list_lex_bots_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_lex_bots_request.ListLexBotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_lex_bots(
    ...
    aws_sdk_connect.types.list_lex_bots_response.ListLexBotsResponse, zapros.Response
]:
