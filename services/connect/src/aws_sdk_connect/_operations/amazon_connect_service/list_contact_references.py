...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_contact_references_request
    import aws_sdk_connect.types.list_contact_references_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_contact_references_response.ListContactReferencesResponse = aws_sdk_connect.types.list_contact_references_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.list_contact_references_request.ListContactReferencesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "reference_types" in input:
        params["referenceTypes"] = str(input["reference_types"])
