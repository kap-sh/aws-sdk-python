...
def build_request(
    ...
    input: aws_sdk_connect.types.search_contact_flow_modules_request.SearchContactFlowModulesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_contact_flow_modules_request.serialize_json(input)
    ).encode()
