"""Generated from Smithy shape ``com.amazonaws.connect#SearchContactFlowModules``."""
...
import aws_sdk_connect.types.contact_flow_module_search_filter
import aws_sdk_connect.types.contact_flow_module_search_summary_list
import aws_sdk_connect.types.search_contact_flow_modules_request
import aws_sdk_connect.types.search_contact_flow_modules_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_contact_flow_modules_response.SearchContactFlowModulesResponse = aws_sdk_connect.types.search_contact_flow_modules_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_contact_flow_modules_request.SearchContactFlowModulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-contact-flow-modules"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.search_contact_flow_modules_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_contact_flow_modules_request.serialize_json(input_)
    ).encode()
...
async def async_search_contact_flow_modules(
