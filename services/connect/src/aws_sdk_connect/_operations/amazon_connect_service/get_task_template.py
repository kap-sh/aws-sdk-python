...
if TYPE_CHECKING:
    import aws_sdk_connect.types.get_task_template_request
    import aws_sdk_connect.types.get_task_template_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.get_task_template_response.GetTaskTemplateResponse = (
        aws_sdk_connect.types.get_task_template_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.get_task_template_request.GetTaskTemplateRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "snapshot_version" in input:
        params["snapshotVersion"] = str(input["snapshot_version"])
