"""Generated from Smithy shape ``com.amazonaws.connect#DeleteWorkspacePage``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_workspace_page_request
    import aws_sdk_connect.types.delete_workspace_page_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_workspace_page_response.DeleteWorkspacePageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_workspace_page_request.DeleteWorkspacePageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/workspaces/{InstanceId}/{WorkspaceId}/pages/{Page}"
    )
    ...
    url = url.replace("{Page}", quote(str(input_["page"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_workspace_page(
