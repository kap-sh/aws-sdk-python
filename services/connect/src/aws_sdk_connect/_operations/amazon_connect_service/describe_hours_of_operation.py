...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_hours_of_operation_request
    import aws_sdk_connect.types.describe_hours_of_operation_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_hours_of_operation_response.DescribeHoursOfOperationResponse = aws_sdk_connect.types.describe_hours_of_operation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_hours_of_operation_request.DescribeHoursOfOperationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
