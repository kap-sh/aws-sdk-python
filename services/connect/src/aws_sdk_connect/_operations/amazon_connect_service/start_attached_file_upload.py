...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.start_attached_file_upload_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.start_attached_file_upload_response.StartAttachedFileUploadResponse = aws_sdk_connect.types.start_attached_file_upload_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.start_attached_file_upload_request.StartAttachedFileUploadRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_attached_file_upload_request.serialize_json(input)
    ).encode()
