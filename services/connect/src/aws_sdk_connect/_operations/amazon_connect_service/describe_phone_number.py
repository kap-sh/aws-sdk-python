...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_phone_number_request
    import aws_sdk_connect.types.describe_phone_number_response
...
) -> aws_sdk_connect.types.describe_phone_number_response.DescribePhoneNumberResponse:
    import aws_sdk_connect.types.describe_phone_number_response

    out: aws_sdk_connect.types.describe_phone_number_response.DescribePhoneNumberResponse = aws_sdk_connect.types.describe_phone_number_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_phone_number_request.DescribePhoneNumberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
