"""Generated from Smithy shape ``com.amazonaws.connect#TransferContact``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.transfer_contact_request
    import aws_sdk_connect.types.transfer_contact_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.transfer_contact_response.TransferContactResponse = (
        aws_sdk_connect.types.transfer_contact_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.transfer_contact_request.TransferContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact/transfer"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.transfer_contact_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.transfer_contact_request.serialize_json(input_)
    ).encode()
...
async def async_transfer_contact(
