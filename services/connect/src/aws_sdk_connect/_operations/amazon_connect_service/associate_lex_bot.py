...
import aws_sdk_connect.types.associate_lex_bot_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_lex_bot_request.AssociateLexBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_lex_bot_request.serialize_json(input_)
    ).encode()
