"""Generated from Smithy shape ``com.amazonaws.connect#ListUseCases``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_use_cases_request
    import aws_sdk_connect.types.list_use_cases_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_use_cases_response.ListUseCasesResponse = (
        aws_sdk_connect.types.list_use_cases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_use_cases_request.ListUseCasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_use_cases(
    ...
    aws_sdk_connect.types.list_use_cases_response.ListUseCasesResponse, zapros.Response
]:
...
async def async_list_use_cases(
