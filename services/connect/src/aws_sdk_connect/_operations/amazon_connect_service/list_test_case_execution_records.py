"""Generated from Smithy shape ``com.amazonaws.connect#ListTestCaseExecutionRecords``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_test_case_execution_records_request
    import aws_sdk_connect.types.list_test_case_execution_records_response
...
) -> aws_sdk_connect.types.list_test_case_execution_records_response.ListTestCaseExecutionRecordsResponse:
    import aws_sdk_connect.types.list_test_case_execution_records_response

    out: aws_sdk_connect.types.list_test_case_execution_records_response.ListTestCaseExecutionRecordsResponse = aws_sdk_connect.types.list_test_case_execution_records_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_test_case_execution_records_request.ListTestCaseExecutionRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{TestCaseExecutionId}", quote(str(input_["test_case_execution_id"]), safe="")
    )
    params: dict[str, str] = {}
    if "status" in input_:
...
async def async_list_test_case_execution_records(
