...
def build_request(
    ...
    input: aws_sdk_connect.types.list_test_case_execution_records_request.ListTestCaseExecutionRecordsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{TestCaseExecutionId}", quote(str(input["test_case_execution_id"]), safe="")
    )
    params: dict[str, str] = {}
    if "status" in input:
