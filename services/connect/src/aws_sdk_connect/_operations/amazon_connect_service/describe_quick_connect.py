...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_quick_connect_request
    import aws_sdk_connect.types.describe_quick_connect_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_quick_connect_response.DescribeQuickConnectResponse = aws_sdk_connect.types.describe_quick_connect_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_quick_connect_request.DescribeQuickConnectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
