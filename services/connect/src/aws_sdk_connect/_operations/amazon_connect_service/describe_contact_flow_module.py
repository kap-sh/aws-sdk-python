"""Generated from Smithy shape ``com.amazonaws.connect#DescribeContactFlowModule``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_contact_flow_module_request
    import aws_sdk_connect.types.describe_contact_flow_module_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_contact_flow_module_response.DescribeContactFlowModuleResponse = aws_sdk_connect.types.describe_contact_flow_module_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_contact_flow_module_request.DescribeContactFlowModuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_contact_flow_module(
