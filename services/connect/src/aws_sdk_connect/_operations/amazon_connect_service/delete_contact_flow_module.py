...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_contact_flow_module_request
    import aws_sdk_connect.types.delete_contact_flow_module_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_contact_flow_module_response.DeleteContactFlowModuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_contact_flow_module_request.DeleteContactFlowModuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
