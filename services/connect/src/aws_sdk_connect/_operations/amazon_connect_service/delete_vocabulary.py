"""Generated from Smithy shape ``com.amazonaws.connect#DeleteVocabulary``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_vocabulary_request
    import aws_sdk_connect.types.delete_vocabulary_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_vocabulary_response.DeleteVocabularyResponse = (
        aws_sdk_connect.types.delete_vocabulary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_vocabulary_request.DeleteVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/vocabulary-remove/{InstanceId}/{VocabularyId}"
    url = url.replace("{InstanceId}", quote(str(input_["instance_id"]), safe=""))
    url = url.replace("{VocabularyId}", quote(str(input_["vocabulary_id"]), safe=""))
    params: dict[str, str] = {}
