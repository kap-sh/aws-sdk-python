...
def build_request(
    ...
    input: aws_sdk_connect.types.update_workspace_page_request.UpdateWorkspacePageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_workspace_page_request.serialize_json(input)
    ).encode()
