...
import aws_sdk_connect.types.update_workspace_page_request
import aws_sdk_connect.types.update_workspace_page_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_workspace_page_response.UpdateWorkspacePageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_workspace_page_request.UpdateWorkspacePageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_workspace_page_request.serialize_json(input_)
    ).encode()
