...
def build_request(
    ...
    input: aws_sdk_connect.types.start_email_contact_request.StartEmailContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_email_contact_request.serialize_json(input)
    ).encode()
