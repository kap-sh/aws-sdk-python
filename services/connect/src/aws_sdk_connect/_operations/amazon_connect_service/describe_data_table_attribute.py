...
import aws_sdk_connect.types.describe_data_table_attribute_request
import aws_sdk_connect.types.describe_data_table_attribute_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_data_table_attribute_response.DescribeDataTableAttributeResponse = aws_sdk_connect.types.describe_data_table_attribute_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_data_table_attribute_request.DescribeDataTableAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
