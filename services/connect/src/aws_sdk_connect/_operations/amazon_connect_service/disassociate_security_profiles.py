...
if TYPE_CHECKING:
    import aws_sdk_connect.types.disassociate_security_profiles_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_security_profiles_request.DisassociateSecurityProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.disassociate_security_profiles_request.serialize_json(
            input_
        )
    ).encode()
