"""Generated from Smithy shape ``com.amazonaws.connect#UpdateInstanceStorageConfig``."""
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_instance_storage_config_request.UpdateInstanceStorageConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_instance_storage_config(
