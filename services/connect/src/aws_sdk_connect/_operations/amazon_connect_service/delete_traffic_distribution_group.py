...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_traffic_distribution_group_request
    import aws_sdk_connect.types.delete_traffic_distribution_group_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_traffic_distribution_group_response.DeleteTrafficDistributionGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_traffic_distribution_group_request.DeleteTrafficDistributionGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
