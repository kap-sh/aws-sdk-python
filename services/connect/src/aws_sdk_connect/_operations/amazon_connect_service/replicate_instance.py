...
if TYPE_CHECKING:
    import aws_sdk_connect.types.replicate_instance_request
    import aws_sdk_connect.types.replicate_instance_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.replicate_instance_response.ReplicateInstanceResponse = (
        aws_sdk_connect.types.replicate_instance_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.replicate_instance_request.ReplicateInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.replicate_instance_request.serialize_json(input_)
    ).encode()
