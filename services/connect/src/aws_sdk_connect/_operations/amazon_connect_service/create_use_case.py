...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_use_case_request
    import aws_sdk_connect.types.create_use_case_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_use_case_response.CreateUseCaseResponse = (
        aws_sdk_connect.types.create_use_case_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_use_case_request.CreateUseCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_use_case_request.serialize_json(input_)
    ).encode()
