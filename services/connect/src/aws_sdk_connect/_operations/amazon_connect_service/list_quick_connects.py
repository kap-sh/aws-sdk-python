...
def build_request(
    ...
    input: aws_sdk_connect.types.list_quick_connects_request.ListQuickConnectsRequest,
) -> zapros.Request:
    ...
    if "quick_connect_types" in input:
        params["QuickConnectTypes"] = str(input["quick_connect_types"])
