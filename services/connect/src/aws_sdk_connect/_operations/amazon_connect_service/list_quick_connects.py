"""Generated from Smithy shape ``com.amazonaws.connect#ListQuickConnects``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_quick_connects_request
    import aws_sdk_connect.types.list_quick_connects_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_quick_connects_response.ListQuickConnectsResponse = aws_sdk_connect.types.list_quick_connects_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_quick_connects_request.ListQuickConnectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "quick_connect_types" in input_:
        params["QuickConnectTypes"] = str(input_["quick_connect_types"])
...
async def async_list_quick_connects(
