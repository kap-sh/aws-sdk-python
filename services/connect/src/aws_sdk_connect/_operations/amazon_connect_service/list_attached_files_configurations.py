"""Generated from Smithy shape ``com.amazonaws.connect#ListAttachedFilesConfigurations``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_attached_files_configurations_request
    import aws_sdk_connect.types.list_attached_files_configurations_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_attached_files_configurations_response.ListAttachedFilesConfigurationsResponse = aws_sdk_connect.types.list_attached_files_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_attached_files_configurations_request.ListAttachedFilesConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/attached-files-configurations/{InstanceId}"
...
async def async_list_attached_files_configurations(
