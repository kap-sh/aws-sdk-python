...
def build_request(
    ...
    input: aws_sdk_connect.types.search_predefined_attributes_request.SearchPredefinedAttributesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_predefined_attributes_request.serialize_json(input)
    ).encode()
