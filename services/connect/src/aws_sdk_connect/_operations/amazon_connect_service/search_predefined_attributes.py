...
import aws_sdk_connect.types.predefined_attribute_search_summary_list
import aws_sdk_connect.types.search_predefined_attributes_request
import aws_sdk_connect.types.search_predefined_attributes_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_predefined_attributes_response.SearchPredefinedAttributesResponse = aws_sdk_connect.types.search_predefined_attributes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_predefined_attributes_request.SearchPredefinedAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_predefined_attributes_request.serialize_json(
            input_
        )
    ).encode()
