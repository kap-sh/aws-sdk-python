...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_analytics_data_associations_request
    import aws_sdk_connect.types.list_analytics_data_associations_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_analytics_data_associations_response.ListAnalyticsDataAssociationsResponse = aws_sdk_connect.types.list_analytics_data_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_analytics_data_associations_request.ListAnalyticsDataAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
