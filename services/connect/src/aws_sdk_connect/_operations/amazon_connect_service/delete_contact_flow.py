...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_contact_flow_request
    import aws_sdk_connect.types.delete_contact_flow_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_contact_flow_response.DeleteContactFlowResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_contact_flow_request.DeleteContactFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
