"""Generated from Smithy shape ``com.amazonaws.connect#DescribeInstanceStorageConfig``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_instance_storage_config_request
    import aws_sdk_connect.types.describe_instance_storage_config_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_instance_storage_config_response.DescribeInstanceStorageConfigResponse = aws_sdk_connect.types.describe_instance_storage_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_instance_storage_config_request.DescribeInstanceStorageConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_instance_storage_config(
