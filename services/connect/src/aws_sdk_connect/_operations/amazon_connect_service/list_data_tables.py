...
import aws_sdk_connect.types.list_data_tables_request
import aws_sdk_connect.types.list_data_tables_response
...
) -> aws_sdk_connect.types.list_data_tables_response.ListDataTablesResponse:
    out: aws_sdk_connect.types.list_data_tables_response.ListDataTablesResponse = (
        aws_sdk_connect.types.list_data_tables_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_data_tables_request.ListDataTablesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
