...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_contact_request
    import aws_sdk_connect.types.create_contact_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_contact_response.CreateContactResponse = (
        aws_sdk_connect.types.create_contact_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_contact_request.CreateContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_contact_request.serialize_json(input_)
    ).encode()
...
def create_contact(
    ...
    aws_sdk_connect.types.create_contact_response.CreateContactResponse, zapros.Response
]:
