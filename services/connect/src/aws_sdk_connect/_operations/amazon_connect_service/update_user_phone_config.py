...
def build_request(
    ...
    input: aws_sdk_connect.types.update_user_phone_config_request.UpdateUserPhoneConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_phone_config_request.serialize_json(input)
    ).encode()
