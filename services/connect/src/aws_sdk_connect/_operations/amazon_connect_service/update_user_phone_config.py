...
import aws_sdk_connect.types.update_user_phone_config_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_user_phone_config_request.UpdateUserPhoneConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_phone_config_request.serialize_json(input_)
    ).encode()
