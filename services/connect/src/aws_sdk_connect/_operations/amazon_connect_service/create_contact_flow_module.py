"""Generated from Smithy shape ``com.amazonaws.connect#CreateContactFlowModule``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_contact_flow_module_request
    import aws_sdk_connect.types.create_contact_flow_module_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicateResourceException":
            import aws_sdk_connect.errors.duplicate_resource_exception

            raise aws_sdk_connect.errors.duplicate_resource_exception.DuplicateResourceException.from_json(
                data
            )
        case "IdempotencyException":
            import aws_sdk_connect.errors.idempotency_exception

            raise aws_sdk_connect.errors.idempotency_exception.IdempotencyException.from_json(
                data
            )
        ...
        case "InvalidContactFlowModuleException":
            import aws_sdk_connect.errors.invalid_contact_flow_module_exception

            raise aws_sdk_connect.errors.invalid_contact_flow_module_exception.InvalidContactFlowModuleException.from_json(
                data
            )
        ...
        case "LimitExceededException":
            import aws_sdk_connect.errors.limit_exceeded_exception

            raise aws_sdk_connect.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_contact_flow_module_response.CreateContactFlowModuleResponse = aws_sdk_connect.types.create_contact_flow_module_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_contact_flow_module_request.CreateContactFlowModuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact-flow-modules/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_contact_flow_module_request.serialize_json(input_)
    ).encode()
...
async def async_create_contact_flow_module(
