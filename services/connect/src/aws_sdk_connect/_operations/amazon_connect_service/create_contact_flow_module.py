...
def build_request(
    ...
    input: aws_sdk_connect.types.create_contact_flow_module_request.CreateContactFlowModuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_contact_flow_module_request.serialize_json(input)
    ).encode()
