...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_user_hierarchy_structure_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_user_hierarchy_structure_request.UpdateUserHierarchyStructureRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_hierarchy_structure_request.serialize_json(
            input_
        )
    ).encode()
