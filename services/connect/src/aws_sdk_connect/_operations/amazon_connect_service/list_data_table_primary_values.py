...
import aws_sdk_connect.types.list_data_table_primary_values_request
import aws_sdk_connect.types.list_data_table_primary_values_response
...
) -> aws_sdk_connect.types.list_data_table_primary_values_response.ListDataTablePrimaryValuesResponse:
    out: aws_sdk_connect.types.list_data_table_primary_values_response.ListDataTablePrimaryValuesResponse = aws_sdk_connect.types.list_data_table_primary_values_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_data_table_primary_values_request.ListDataTablePrimaryValuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.list_data_table_primary_values_request.serialize_json(
            input_
        )
    ).encode()
