...
def build_request(
    ...
    input: aws_sdk_connect.types.start_web_rtc_contact_request.StartWebRTCContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_web_rtc_contact_request.serialize_json(input)
    ).encode()
