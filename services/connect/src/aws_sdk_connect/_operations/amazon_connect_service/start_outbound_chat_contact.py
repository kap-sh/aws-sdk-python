...
def build_request(
    ...
    input: aws_sdk_connect.types.start_outbound_chat_contact_request.StartOutboundChatContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_outbound_chat_contact_request.serialize_json(input)
    ).encode()
