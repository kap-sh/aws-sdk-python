"""Generated from Smithy shape ``com.amazonaws.connect#DeleteIntegrationAssociation``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_integration_association_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_integration_association_request.DeleteIntegrationAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_integration_association(
