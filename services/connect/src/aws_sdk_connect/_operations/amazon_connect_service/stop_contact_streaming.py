...
def build_request(
    ...
    input: aws_sdk_connect.types.stop_contact_streaming_request.StopContactStreamingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.stop_contact_streaming_request.serialize_json(input)
    ).encode()
