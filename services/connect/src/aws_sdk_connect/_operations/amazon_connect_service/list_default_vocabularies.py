...
def build_request(
    ...
    input: aws_sdk_connect.types.list_default_vocabularies_request.ListDefaultVocabulariesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.list_default_vocabularies_request.serialize_json(input)
    ).encode()
