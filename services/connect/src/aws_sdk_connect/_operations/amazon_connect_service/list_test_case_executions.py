...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_test_case_executions_request.ListTestCaseExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "test_case_id" in input_:
        params["testCaseId"] = str(input_["test_case_id"])
    if "test_case_name" in input_:
        params["testCaseName"] = str(input_["test_case_name"])
