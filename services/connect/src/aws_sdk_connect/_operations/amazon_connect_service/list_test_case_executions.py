...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_test_case_executions_request
    import aws_sdk_connect.types.list_test_case_executions_response
...
) -> aws_sdk_connect.types.list_test_case_executions_response.ListTestCaseExecutionsResponse:
    import aws_sdk_connect.types.list_test_case_executions_response

    out: aws_sdk_connect.types.list_test_case_executions_response.ListTestCaseExecutionsResponse = aws_sdk_connect.types.list_test_case_executions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.list_test_case_executions_request.ListTestCaseExecutionsRequest,
) -> zapros.Request:
    ...
    if "test_case_id" in input:
        params["testCaseId"] = str(input["test_case_id"])
    if "test_case_name" in input:
        params["testCaseName"] = str(input["test_case_name"])
