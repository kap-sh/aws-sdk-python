...
import aws_sdk_connect.types.search_test_cases_response
...
) -> aws_sdk_connect.types.search_test_cases_response.SearchTestCasesResponse:
    out: aws_sdk_connect.types.search_test_cases_response.SearchTestCasesResponse = (
        aws_sdk_connect.types.search_test_cases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_test_cases_request.SearchTestCasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
