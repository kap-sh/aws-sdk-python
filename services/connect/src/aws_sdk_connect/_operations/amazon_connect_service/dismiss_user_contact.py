"""Generated from Smithy shape ``com.amazonaws.connect#DismissUserContact``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.dismiss_user_contact_request
    import aws_sdk_connect.types.dismiss_user_contact_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.dismiss_user_contact_response.DismissUserContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.dismiss_user_contact_request.DismissUserContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/users/{InstanceId}/{UserId}/contact"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.dismiss_user_contact_request.serialize_json(input_)
    ).encode()
...
async def async_dismiss_user_contact(
