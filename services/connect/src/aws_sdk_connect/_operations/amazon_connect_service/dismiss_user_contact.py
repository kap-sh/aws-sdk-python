...
def build_request(
    ...
    input: aws_sdk_connect.types.dismiss_user_contact_request.DismissUserContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.dismiss_user_contact_request.serialize_json(input)
    ).encode()
