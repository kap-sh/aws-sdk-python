...
import aws_sdk_connect.errors.resource_not_ready_exception
import aws_sdk_connect.errors.service_quota_exceeded_exception
import aws_sdk_connect.errors.throttling_exception
import aws_sdk_connect.types.create_traffic_distribution_group_request
import aws_sdk_connect.types.create_traffic_distribution_group_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotReadyException":
            raise aws_sdk_connect.errors.resource_not_ready_exception.ResourceNotReadyException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_traffic_distribution_group_response.CreateTrafficDistributionGroupResponse = aws_sdk_connect.types.create_traffic_distribution_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_traffic_distribution_group_request.CreateTrafficDistributionGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_traffic_distribution_group_request.serialize_json(
            input_
        )
    ).encode()
