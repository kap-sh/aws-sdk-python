"""Generated from Smithy shape ``com.amazonaws.connect#DeleteInstance``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_instance_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_instance_request.DeleteInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
