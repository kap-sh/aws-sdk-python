...
if TYPE_CHECKING:
    import aws_sdk_connect.types.disassociate_traffic_distribution_group_user_request
    import aws_sdk_connect.types.disassociate_traffic_distribution_group_user_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.disassociate_traffic_distribution_group_user_response.DisassociateTrafficDistributionGroupUserResponse = {}  # type: ignore[typeddict-item]
    return out
