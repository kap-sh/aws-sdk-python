...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_contact_flows_request
    import aws_sdk_connect.types.list_contact_flows_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_contact_flows_response.ListContactFlowsResponse = (
        aws_sdk_connect.types.list_contact_flows_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.list_contact_flows_request.ListContactFlowsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "contact_flow_types" in input:
        params["contactFlowTypes"] = str(input["contact_flow_types"])
