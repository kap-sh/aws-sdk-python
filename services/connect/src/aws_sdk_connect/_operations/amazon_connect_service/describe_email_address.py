...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_email_address_request
    import aws_sdk_connect.types.describe_email_address_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_email_address_response.DescribeEmailAddressResponse = aws_sdk_connect.types.describe_email_address_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_email_address_request.DescribeEmailAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
