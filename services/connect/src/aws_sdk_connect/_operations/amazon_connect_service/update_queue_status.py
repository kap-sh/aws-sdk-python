...
def build_request(
    ...
    input: aws_sdk_connect.types.update_queue_status_request.UpdateQueueStatusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_queue_status_request.serialize_json(input)
    ).encode()
