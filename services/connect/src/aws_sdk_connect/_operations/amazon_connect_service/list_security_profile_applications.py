...
def build_request(
    ...
    input: aws_sdk_connect.types.list_security_profile_applications_request.ListSecurityProfileApplicationsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{SecurityProfileId}", quote(str(input["security_profile_id"]), safe="")
    )
