"""Generated from Smithy shape ``com.amazonaws.connect#ListSecurityProfileApplications``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_security_profile_applications_request
    import aws_sdk_connect.types.list_security_profile_applications_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_security_profile_applications_response.ListSecurityProfileApplicationsResponse = aws_sdk_connect.types.list_security_profile_applications_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_security_profile_applications_request.ListSecurityProfileApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{SecurityProfileId}", quote(str(input_["security_profile_id"]), safe="")
    )
...
async def async_list_security_profile_applications(
