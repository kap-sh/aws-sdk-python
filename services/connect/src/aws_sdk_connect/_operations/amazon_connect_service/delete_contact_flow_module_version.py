...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_contact_flow_module_version_request
    import aws_sdk_connect.types.delete_contact_flow_module_version_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_contact_flow_module_version_response.DeleteContactFlowModuleVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_connect.types.delete_contact_flow_module_version_request.DeleteContactFlowModuleVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["contact_flow_module_version"]), safe=""),
    )
    params: dict[str, str] = {}
