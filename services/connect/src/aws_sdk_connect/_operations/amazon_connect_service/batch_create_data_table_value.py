...
if TYPE_CHECKING:
    import aws_sdk_connect.types.batch_create_data_table_value_request
    import aws_sdk_connect.types.batch_create_data_table_value_response
...
) -> aws_sdk_connect.types.batch_create_data_table_value_response.BatchCreateDataTableValueResponse:
    import aws_sdk_connect.types.batch_create_data_table_value_response

    out: aws_sdk_connect.types.batch_create_data_table_value_response.BatchCreateDataTableValueResponse = aws_sdk_connect.types.batch_create_data_table_value_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.batch_create_data_table_value_request.BatchCreateDataTableValueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.batch_create_data_table_value_request.serialize_json(
            input_
        )
    ).encode()
