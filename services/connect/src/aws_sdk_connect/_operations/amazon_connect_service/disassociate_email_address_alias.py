"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateEmailAddressAlias``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.disassociate_email_address_alias_request
    import aws_sdk_connect.types.disassociate_email_address_alias_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.disassociate_email_address_alias_response.DisassociateEmailAddressAliasResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_email_address_alias_request.DisassociateEmailAddressAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.disassociate_email_address_alias_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_email_address_alias(
