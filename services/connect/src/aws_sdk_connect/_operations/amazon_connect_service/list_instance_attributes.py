...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_instance_attributes_request
    import aws_sdk_connect.types.list_instance_attributes_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_instance_attributes_response.ListInstanceAttributesResponse = aws_sdk_connect.types.list_instance_attributes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_instance_attributes_request.ListInstanceAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
