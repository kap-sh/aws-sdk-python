...
def build_request(
    ...
    input: aws_sdk_connect.types.update_instance_attribute_request.UpdateInstanceAttributeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_instance_attribute_request.serialize_json(input)
    ).encode()
