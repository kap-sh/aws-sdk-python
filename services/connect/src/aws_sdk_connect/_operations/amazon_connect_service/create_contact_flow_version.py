...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_contact_flow_version_request
    import aws_sdk_connect.types.create_contact_flow_version_response
...
) -> aws_sdk_connect.types.create_contact_flow_version_response.CreateContactFlowVersionResponse:
    import aws_sdk_connect.types.create_contact_flow_version_response

    out: aws_sdk_connect.types.create_contact_flow_version_response.CreateContactFlowVersionResponse = aws_sdk_connect.types.create_contact_flow_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_contact_flow_version_request.CreateContactFlowVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_contact_flow_version_request.serialize_json(input_)
    ).encode()
