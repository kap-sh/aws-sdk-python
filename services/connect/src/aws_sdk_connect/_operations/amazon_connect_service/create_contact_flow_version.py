...
def build_request(
    ...
    input: aws_sdk_connect.types.create_contact_flow_version_request.CreateContactFlowVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_contact_flow_version_request.serialize_json(input)
    ).encode()
