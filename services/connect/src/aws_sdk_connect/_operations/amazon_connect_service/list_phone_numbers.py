...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_phone_numbers_request
    import aws_sdk_connect.types.list_phone_numbers_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_phone_numbers_response.ListPhoneNumbersResponse = (
        aws_sdk_connect.types.list_phone_numbers_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.list_phone_numbers_request.ListPhoneNumbersRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "phone_number_types" in input:
        params["phoneNumberTypes"] = str(input["phone_number_types"])
    if "phone_number_country_codes" in input:
        params["phoneNumberCountryCodes"] = str(input["phone_number_country_codes"])
