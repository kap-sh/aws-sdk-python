...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_phone_numbers_request.ListPhoneNumbersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "phone_number_types" in input_:
        params["phoneNumberTypes"] = str(input_["phone_number_types"])
    if "phone_number_country_codes" in input_:
        params["phoneNumberCountryCodes"] = str(input_["phone_number_country_codes"])
