...
def build_request(
    ...
    input_: aws_sdk_connect.types.submit_contact_evaluation_request.SubmitContactEvaluationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.submit_contact_evaluation_request.serialize_json(input_)
    ).encode()
