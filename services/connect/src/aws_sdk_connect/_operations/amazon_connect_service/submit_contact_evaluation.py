...
if TYPE_CHECKING:
    import aws_sdk_connect.types.submit_contact_evaluation_request
    import aws_sdk_connect.types.submit_contact_evaluation_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.submit_contact_evaluation_response.SubmitContactEvaluationResponse = aws_sdk_connect.types.submit_contact_evaluation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.submit_contact_evaluation_request.SubmitContactEvaluationRequest,
) -> zapros.Request:
    ...
    url = url.replace("{EvaluationId}", quote(str(input["evaluation_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.submit_contact_evaluation_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.submit_contact_evaluation_request.serialize_json(input)
    ).encode()
