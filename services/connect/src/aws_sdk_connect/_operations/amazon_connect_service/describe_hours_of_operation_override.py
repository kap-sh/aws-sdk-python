...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_hours_of_operation_override_request
    import aws_sdk_connect.types.describe_hours_of_operation_override_response
...
) -> aws_sdk_connect.types.describe_hours_of_operation_override_response.DescribeHoursOfOperationOverrideResponse:
    import aws_sdk_connect.types.describe_hours_of_operation_override_response

    out: aws_sdk_connect.types.describe_hours_of_operation_override_response.DescribeHoursOfOperationOverrideResponse = aws_sdk_connect.types.describe_hours_of_operation_override_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_hours_of_operation_override_request.DescribeHoursOfOperationOverrideRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
