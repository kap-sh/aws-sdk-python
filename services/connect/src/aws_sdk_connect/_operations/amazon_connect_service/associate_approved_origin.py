...
if TYPE_CHECKING:
    import aws_sdk_connect.types.associate_approved_origin_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_approved_origin_request.AssociateApprovedOriginRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_approved_origin_request.serialize_json(input_)
    ).encode()
