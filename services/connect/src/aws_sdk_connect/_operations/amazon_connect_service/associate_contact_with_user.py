...
if TYPE_CHECKING:
    import aws_sdk_connect.types.associate_contact_with_user_request
    import aws_sdk_connect.types.associate_contact_with_user_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.associate_contact_with_user_response.AssociateContactWithUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_contact_with_user_request.AssociateContactWithUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_contact_with_user_request.serialize_json(input_)
    ).encode()
