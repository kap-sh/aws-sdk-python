...
def build_request(
    ...
    input: aws_sdk_connect.types.associate_contact_with_user_request.AssociateContactWithUserRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_contact_with_user_request.serialize_json(input)
    ).encode()
