...
import aws_sdk_connect.types.email_address_search_filter
import aws_sdk_connect.types.search_email_addresses_request
import aws_sdk_connect.types.search_email_addresses_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_email_addresses_response.SearchEmailAddressesResponse = aws_sdk_connect.types.search_email_addresses_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_email_addresses_request.SearchEmailAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_email_addresses_request.serialize_json(input_)
    ).encode()
