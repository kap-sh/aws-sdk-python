"""Generated from Smithy shape ``com.amazonaws.connect#ListSecurityProfilePermissions``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_security_profile_permissions_request
    import aws_sdk_connect.types.list_security_profile_permissions_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_security_profile_permissions_response.ListSecurityProfilePermissionsResponse = aws_sdk_connect.types.list_security_profile_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_security_profile_permissions_request.ListSecurityProfilePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_security_profile_permissions(
