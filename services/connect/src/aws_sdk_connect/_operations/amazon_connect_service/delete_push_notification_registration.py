...
def build_request(
    ...
    input: aws_sdk_connect.types.delete_push_notification_registration_request.DeletePushNotificationRegistrationRequest,
) -> zapros.Request:
    ...
    url = url.replace("{RegistrationId}", quote(str(input["registration_id"]), safe=""))
    params: dict[str, str] = {}
    if "contact_id" in input:
        params["contactId"] = str(input["contact_id"])
