"""Generated from Smithy shape ``com.amazonaws.connect#DeletePushNotificationRegistration``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_push_notification_registration_request
    import aws_sdk_connect.types.delete_push_notification_registration_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_push_notification_registration_response.DeletePushNotificationRegistrationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_push_notification_registration_request.DeletePushNotificationRegistrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{RegistrationId}", quote(str(input_["registration_id"]), safe="")
    )
    params: dict[str, str] = {}
    if "contact_id" in input_:
        params["contactId"] = str(input_["contact_id"])
...
async def async_delete_push_notification_registration(
