...
if TYPE_CHECKING:
    import aws_sdk_connect.types.send_outbound_email_request
    import aws_sdk_connect.types.send_outbound_email_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.send_outbound_email_response.SendOutboundEmailResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.send_outbound_email_request.SendOutboundEmailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.send_outbound_email_request.serialize_json(input_)
    ).encode()
