...
def build_request(
    ...
    input: aws_sdk_connect.types.send_outbound_email_request.SendOutboundEmailRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.send_outbound_email_request.serialize_json(input)
    ).encode()
