...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_integration_associations_request.ListIntegrationAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "integration_type" in input_:
        params["integrationType"] = str(input_["integration_type"])
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "max_results" in input_:
        params["maxResults"] = str(input_["max_results"])
    if "integration_arn" in input_:
        params["integrationArn"] = str(input_["integration_arn"])
