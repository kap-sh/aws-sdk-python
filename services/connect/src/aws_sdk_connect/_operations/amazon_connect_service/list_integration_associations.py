...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_integration_associations_request
    import aws_sdk_connect.types.list_integration_associations_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_integration_associations_response.ListIntegrationAssociationsResponse = aws_sdk_connect.types.list_integration_associations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.list_integration_associations_request.ListIntegrationAssociationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "integration_type" in input:
        params["integrationType"] = str(input["integration_type"])
    if "next_token" in input:
        params["nextToken"] = str(input["next_token"])
    if "max_results" in input:
        params["maxResults"] = str(input["max_results"])
    if "integration_arn" in input:
        params["integrationArn"] = str(input["integration_arn"])
