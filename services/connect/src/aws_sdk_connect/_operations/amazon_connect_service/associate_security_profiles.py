...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_security_profiles_request.AssociateSecurityProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_security_profiles_request.serialize_json(input_)
    ).encode()
