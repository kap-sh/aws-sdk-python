...
def build_request(
    ...
    input: aws_sdk_connect.types.associate_security_profiles_request.AssociateSecurityProfilesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_security_profiles_request.serialize_json(input)
    ).encode()
