...
import aws_sdk_connect.types.disassociate_routing_profile_queues_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_routing_profile_queues_request.DisassociateRoutingProfileQueuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.disassociate_routing_profile_queues_request.serialize_json(
            input_
        )
    ).encode()
