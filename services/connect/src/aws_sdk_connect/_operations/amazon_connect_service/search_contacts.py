"""Generated from Smithy shape ``com.amazonaws.connect#SearchContacts``."""
...
import aws_sdk_connect.types.search_contacts_request
import aws_sdk_connect.types.search_contacts_response
...
) -> aws_sdk_connect.types.search_contacts_response.SearchContactsResponse:
    out: aws_sdk_connect.types.search_contacts_response.SearchContactsResponse = (
        aws_sdk_connect.types.search_contacts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_contacts_request.SearchContactsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-contacts"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.search_contacts_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_contacts_request.serialize_json(input_)
    ).encode()
...
async def async_search_contacts(
