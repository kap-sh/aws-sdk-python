"""Generated from Smithy shape ``com.amazonaws.connect#CreateQueue``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_queue_request
    import aws_sdk_connect.types.create_queue_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_queue_response.CreateQueueResponse = (
        aws_sdk_connect.types.create_queue_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_queue_request.CreateQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/queues/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_queue_request.serialize_json(input_)
    ).encode()
...
def create_queue(
    ...
    aws_sdk_connect.types.create_queue_response.CreateQueueResponse, zapros.Response
]:
