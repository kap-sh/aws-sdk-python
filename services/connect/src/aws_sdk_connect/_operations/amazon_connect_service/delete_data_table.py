"""Generated from Smithy shape ``com.amazonaws.connect#DeleteDataTable``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_data_table_request
    import aws_sdk_connect.types.delete_data_table_response
...
) -> aws_sdk_connect.types.delete_data_table_response.DeleteDataTableResponse:
    out: aws_sdk_connect.types.delete_data_table_response.DeleteDataTableResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_data_table_request.DeleteDataTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/data-tables/{InstanceId}/{DataTableId}"
...
async def async_delete_data_table(
