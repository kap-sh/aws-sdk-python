"""Generated from Smithy shape ``com.amazonaws.connect#CreateRule``."""
...
import aws_sdk_connect.types.create_rule_request
import aws_sdk_connect.types.create_rule_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_rule_response.CreateRuleResponse = (
        aws_sdk_connect.types.create_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_rule_request.CreateRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_rule_request.serialize_json(input_)
    ).encode()
...
def create_rule(
    ...
    aws_sdk_connect.types.create_rule_response.CreateRuleResponse, zapros.Response
]:
