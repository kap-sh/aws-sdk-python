"""Generated from Smithy shape ``com.amazonaws.connect#CreateEvaluationForm``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_evaluation_form_request
    import aws_sdk_connect.types.create_evaluation_form_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_evaluation_form_response.CreateEvaluationFormResponse = aws_sdk_connect.types.create_evaluation_form_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_evaluation_form_request.CreateEvaluationFormRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/evaluation-forms/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_evaluation_form_request.serialize_json(input_)
    ).encode()
...
async def async_create_evaluation_form(
