"""Generated from Smithy shape ``com.amazonaws.connect#SendChatIntegrationEvent``."""
...
import aws_sdk_connect.types.send_chat_integration_event_request
import aws_sdk_connect.types.send_chat_integration_event_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.send_chat_integration_event_response.SendChatIntegrationEventResponse = aws_sdk_connect.types.send_chat_integration_event_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.send_chat_integration_event_request.SendChatIntegrationEventRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/chat-integration-event"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.send_chat_integration_event_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.send_chat_integration_event_request.serialize_json(input_)
    ).encode()
...
async def async_send_chat_integration_event(
