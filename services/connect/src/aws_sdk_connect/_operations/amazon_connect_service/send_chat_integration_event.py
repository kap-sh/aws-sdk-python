...
def build_request(
    ...
    input: aws_sdk_connect.types.send_chat_integration_event_request.SendChatIntegrationEventRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.send_chat_integration_event_request.serialize_json(input)
    ).encode()
