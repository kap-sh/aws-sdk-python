...
if TYPE_CHECKING:
    import aws_sdk_connect.types.associate_flow_request
    import aws_sdk_connect.types.associate_flow_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.associate_flow_response.AssociateFlowResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_flow_request.AssociateFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_flow_request.serialize_json(input_)
    ).encode()
...
def associate_flow(
    ...
    aws_sdk_connect.types.associate_flow_response.AssociateFlowResponse, zapros.Response
]:
