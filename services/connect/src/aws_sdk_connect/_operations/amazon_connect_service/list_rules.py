...
def build_request(
    ...
    input: aws_sdk_connect.types.list_rules_request.ListRulesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "publish_status" in input:
        params["publishStatus"] = str(input["publish_status"])
    if "event_source_name" in input:
        params["eventSourceName"] = str(input["event_source_name"])
