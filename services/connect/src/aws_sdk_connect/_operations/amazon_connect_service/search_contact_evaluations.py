"""Generated from Smithy shape ``com.amazonaws.connect#SearchContactEvaluations``."""
...
import aws_sdk_connect.types.evaluation_search_filter
import aws_sdk_connect.types.evaluation_search_summary_list
import aws_sdk_connect.types.search_contact_evaluations_request
import aws_sdk_connect.types.search_contact_evaluations_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_contact_evaluations_response.SearchContactEvaluationsResponse = aws_sdk_connect.types.search_contact_evaluations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_contact_evaluations_request.SearchContactEvaluationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-contact-evaluations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_contact_evaluations_request.serialize_json(input_)
    ).encode()
...
async def async_search_contact_evaluations(
