...
def build_request(
    ...
    input: aws_sdk_connect.types.search_contact_evaluations_request.SearchContactEvaluationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_contact_evaluations_request.serialize_json(input)
    ).encode()
