"""Generated from Smithy shape ``com.amazonaws.connect#StartOutboundEmailContact``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.start_outbound_email_contact_request
    import aws_sdk_connect.types.start_outbound_email_contact_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.start_outbound_email_contact_response.StartOutboundEmailContactResponse = aws_sdk_connect.types.start_outbound_email_contact_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.start_outbound_email_contact_request.StartOutboundEmailContactRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/contact/outbound-email"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.start_outbound_email_contact_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_outbound_email_contact_request.serialize_json(input)
    ).encode()
...
async def async_start_outbound_email_contact(
