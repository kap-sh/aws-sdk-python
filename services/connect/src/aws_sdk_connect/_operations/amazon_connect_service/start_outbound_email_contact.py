...
def build_request(
    ...
    input_: aws_sdk_connect.types.start_outbound_email_contact_request.StartOutboundEmailContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_outbound_email_contact_request.serialize_json(
            input_
        )
    ).encode()
