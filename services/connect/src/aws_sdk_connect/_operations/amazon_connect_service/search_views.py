"""Generated from Smithy shape ``com.amazonaws.connect#SearchViews``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.search_views_request
    import aws_sdk_connect.types.search_views_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_views_response.SearchViewsResponse = (
        aws_sdk_connect.types.search_views_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_views_request.SearchViewsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-views"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.search_views_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_views_request.serialize_json(input_)
    ).encode()
...
def search_views(
    ...
    aws_sdk_connect.types.search_views_response.SearchViewsResponse, zapros.Response
]:
