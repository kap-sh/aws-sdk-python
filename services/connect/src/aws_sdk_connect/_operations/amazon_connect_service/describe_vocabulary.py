...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_vocabulary_request
    import aws_sdk_connect.types.describe_vocabulary_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_vocabulary_response.DescribeVocabularyResponse = aws_sdk_connect.types.describe_vocabulary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_vocabulary_request.DescribeVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
