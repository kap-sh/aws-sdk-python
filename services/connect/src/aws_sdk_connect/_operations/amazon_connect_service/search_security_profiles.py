...
def build_request(
    ...
    input: aws_sdk_connect.types.search_security_profiles_request.SearchSecurityProfilesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_security_profiles_request.serialize_json(input)
    ).encode()
