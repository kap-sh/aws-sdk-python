"""Generated from Smithy shape ``com.amazonaws.connect#SearchSecurityProfiles``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.search_security_profiles_request
    import aws_sdk_connect.types.search_security_profiles_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_security_profiles_response.SearchSecurityProfilesResponse = aws_sdk_connect.types.search_security_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_security_profiles_request.SearchSecurityProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-security-profiles"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.search_security_profiles_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_security_profiles_request.serialize_json(input_)
    ).encode()
...
async def async_search_security_profiles(
