"""Generated from Smithy shape ``com.amazonaws.connect#DescribeContactFlow``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_contact_flow_request
    import aws_sdk_connect.types.describe_contact_flow_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ContactFlowNotPublishedException":
            import aws_sdk_connect.errors.contact_flow_not_published_exception

            raise aws_sdk_connect.errors.contact_flow_not_published_exception.ContactFlowNotPublishedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_contact_flow_response.DescribeContactFlowResponse = aws_sdk_connect.types.describe_contact_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_contact_flow_request.DescribeContactFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact-flows/{InstanceId}/{ContactFlowId}"
    url = url.replace("{InstanceId}", quote(str(input_["instance_id"]), safe=""))
    url = url.replace("{ContactFlowId}", quote(str(input_["contact_flow_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_describe_contact_flow(
