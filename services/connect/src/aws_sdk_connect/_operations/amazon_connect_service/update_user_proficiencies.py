...
def build_request(
    ...
    input: aws_sdk_connect.types.update_user_proficiencies_request.UpdateUserProficienciesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_proficiencies_request.serialize_json(input)
    ).encode()
