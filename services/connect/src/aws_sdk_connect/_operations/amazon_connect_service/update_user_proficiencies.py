"""Generated from Smithy shape ``com.amazonaws.connect#UpdateUserProficiencies``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_user_proficiencies_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_user_proficiencies_request.UpdateUserProficienciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_proficiencies_request.serialize_json(input_)
    ).encode()
...
async def async_update_user_proficiencies(
