...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_security_profiles_request
    import aws_sdk_connect.types.list_security_profiles_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_security_profiles_response.ListSecurityProfilesResponse = aws_sdk_connect.types.list_security_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_security_profiles_request.ListSecurityProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
