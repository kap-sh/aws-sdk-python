...
if TYPE_CHECKING:
    import aws_sdk_connect.types.disassociate_queue_quick_connects_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_queue_quick_connects_request.DisassociateQueueQuickConnectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.disassociate_queue_quick_connects_request.serialize_json(
            input_
        )
    ).encode()
