...
def build_request(
    ...
    input: aws_sdk_connect.types.update_evaluation_form_request.UpdateEvaluationFormRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_evaluation_form_request.serialize_json(input)
    ).encode()
