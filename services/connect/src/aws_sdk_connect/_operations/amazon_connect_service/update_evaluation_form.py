...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_evaluation_form_request
    import aws_sdk_connect.types.update_evaluation_form_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_evaluation_form_response.UpdateEvaluationFormResponse = aws_sdk_connect.types.update_evaluation_form_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_evaluation_form_request.UpdateEvaluationFormRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_evaluation_form_request.serialize_json(input_)
    ).encode()
