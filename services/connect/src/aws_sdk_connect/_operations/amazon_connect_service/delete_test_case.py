...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_test_case_request
    import aws_sdk_connect.types.delete_test_case_response
...
) -> aws_sdk_connect.types.delete_test_case_response.DeleteTestCaseResponse:
    out: aws_sdk_connect.types.delete_test_case_response.DeleteTestCaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_test_case_request.DeleteTestCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
