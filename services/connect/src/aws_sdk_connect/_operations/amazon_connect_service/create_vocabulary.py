...
import aws_sdk_connect.types.create_vocabulary_request
import aws_sdk_connect.types.create_vocabulary_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_vocabulary_response.CreateVocabularyResponse = (
        aws_sdk_connect.types.create_vocabulary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_vocabulary_request.CreateVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_vocabulary_request.serialize_json(input_)
    ).encode()
