"""Generated from Smithy shape ``com.amazonaws.connect#DeleteWorkspace``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_workspace_request
    import aws_sdk_connect.types.delete_workspace_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_workspace_response.DeleteWorkspaceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_workspace_request.DeleteWorkspaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{InstanceId}/{WorkspaceId}"
...
async def async_delete_workspace(
