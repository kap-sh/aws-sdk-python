...
def build_request(
    ...
    input: aws_sdk_connect.types.create_predefined_attribute_request.CreatePredefinedAttributeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_predefined_attribute_request.serialize_json(input)
    ).encode()
