"""Generated from Smithy shape ``com.amazonaws.connect#UpdateViewMetadata``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_view_metadata_request
    import aws_sdk_connect.types.update_view_metadata_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            import aws_sdk_connect.errors.resource_in_use_exception

            raise aws_sdk_connect.errors.resource_in_use_exception.ResourceInUseException.from_json(
                data
            )
        ...
        case "TooManyRequestsException":
            import aws_sdk_connect.errors.too_many_requests_exception

            raise aws_sdk_connect.errors.too_many_requests_exception.TooManyRequestsException.from_json(
                data
            )
        case _:
...
) -> aws_sdk_connect.types.update_view_metadata_response.UpdateViewMetadataResponse:
    out: aws_sdk_connect.types.update_view_metadata_response.UpdateViewMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_view_metadata_request.UpdateViewMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/views/{InstanceId}/{ViewId}/metadata"
    url = url.replace("{InstanceId}", quote(str(input_["instance_id"]), safe=""))
    url = url.replace("{ViewId}", quote(str(input_["view_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.update_view_metadata_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_view_metadata_request.serialize_json(input_)
    ).encode()
...
async def async_update_view_metadata(
