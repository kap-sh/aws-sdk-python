...
def build_request(
    ...
    input: aws_sdk_connect.types.update_view_metadata_request.UpdateViewMetadataRequest,
) -> zapros.Request:
    ...
    url = url.replace("{ViewId}", quote(str(input["view_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.update_view_metadata_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_view_metadata_request.serialize_json(input)
    ).encode()
