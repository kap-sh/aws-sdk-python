"""Generated from Smithy shape ``com.amazonaws.connect#DescribeRule``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_rule_request
    import aws_sdk_connect.types.describe_rule_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_rule_response.DescribeRuleResponse = (
        aws_sdk_connect.types.describe_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_rule_request.DescribeRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/rules/{InstanceId}/{RuleId}"
...
def describe_rule(
    ...
    aws_sdk_connect.types.describe_rule_response.DescribeRuleResponse, zapros.Response
]:
