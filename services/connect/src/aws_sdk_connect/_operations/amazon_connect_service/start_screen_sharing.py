...
def build_request(
    ...
    input: aws_sdk_connect.types.start_screen_sharing_request.StartScreenSharingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_screen_sharing_request.serialize_json(input)
    ).encode()
