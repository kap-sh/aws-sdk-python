...
if TYPE_CHECKING:
    import aws_sdk_connect.types.start_screen_sharing_request
    import aws_sdk_connect.types.start_screen_sharing_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.start_screen_sharing_response.StartScreenSharingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.start_screen_sharing_request.StartScreenSharingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_screen_sharing_request.serialize_json(input_)
    ).encode()
