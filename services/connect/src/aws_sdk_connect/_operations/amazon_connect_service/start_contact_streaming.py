"""Generated from Smithy shape ``com.amazonaws.connect#StartContactStreaming``."""
...
import aws_sdk_connect.types.start_contact_streaming_request
import aws_sdk_connect.types.start_contact_streaming_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.start_contact_streaming_response.StartContactStreamingResponse = aws_sdk_connect.types.start_contact_streaming_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.start_contact_streaming_request.StartContactStreamingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact/start-streaming"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.start_contact_streaming_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_contact_streaming_request.serialize_json(input_)
    ).encode()
...
async def async_start_contact_streaming(
