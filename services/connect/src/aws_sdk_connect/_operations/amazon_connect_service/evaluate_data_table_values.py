...
if TYPE_CHECKING:
    import aws_sdk_connect.types.evaluate_data_table_values_request
    import aws_sdk_connect.types.evaluate_data_table_values_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.evaluate_data_table_values_response.EvaluateDataTableValuesResponse = aws_sdk_connect.types.evaluate_data_table_values_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.evaluate_data_table_values_request.EvaluateDataTableValuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.evaluate_data_table_values_request.serialize_json(input_)
    ).encode()
