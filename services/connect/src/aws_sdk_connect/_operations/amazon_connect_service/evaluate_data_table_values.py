...
def build_request(
    ...
    input: aws_sdk_connect.types.evaluate_data_table_values_request.EvaluateDataTableValuesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.evaluate_data_table_values_request.serialize_json(input)
    ).encode()
