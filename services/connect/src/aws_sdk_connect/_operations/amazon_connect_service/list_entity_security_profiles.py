"""Generated from Smithy shape ``com.amazonaws.connect#ListEntitySecurityProfiles``."""
...
import aws_sdk_connect.types.list_entity_security_profiles_request
import aws_sdk_connect.types.list_entity_security_profiles_response
...
) -> aws_sdk_connect.types.list_entity_security_profiles_response.ListEntitySecurityProfilesResponse:
    out: aws_sdk_connect.types.list_entity_security_profiles_response.ListEntitySecurityProfilesResponse = aws_sdk_connect.types.list_entity_security_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_entity_security_profiles_request.ListEntitySecurityProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/entity-security-profiles-summary/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.list_entity_security_profiles_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_entity_security_profiles(
