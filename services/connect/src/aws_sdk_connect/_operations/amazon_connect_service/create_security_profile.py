...
def build_request(
    ...
    input: aws_sdk_connect.types.create_security_profile_request.CreateSecurityProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_security_profile_request.serialize_json(input)
    ).encode()
