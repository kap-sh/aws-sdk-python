...
def build_request(
    ...
    input: aws_sdk_connect.types.update_hours_of_operation_request.UpdateHoursOfOperationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_hours_of_operation_request.serialize_json(input)
    ).encode()
