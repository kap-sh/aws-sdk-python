...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.update_user_notification_status_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_user_notification_status_response.UpdateUserNotificationStatusResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_connect.types.update_user_notification_status_request.UpdateUserNotificationStatusRequest,
) -> zapros.Request:
