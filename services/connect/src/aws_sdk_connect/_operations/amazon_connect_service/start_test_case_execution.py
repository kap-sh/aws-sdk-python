"""Generated from Smithy shape ``com.amazonaws.connect#StartTestCaseExecution``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.start_test_case_execution_request
    import aws_sdk_connect.types.start_test_case_execution_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.start_test_case_execution_response.StartTestCaseExecutionResponse = aws_sdk_connect.types.start_test_case_execution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.start_test_case_execution_request.StartTestCaseExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_test_case_execution_request.serialize_json(input_)
    ).encode()
...
async def async_start_test_case_execution(
