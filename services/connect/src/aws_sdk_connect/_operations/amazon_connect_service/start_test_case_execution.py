...
def build_request(
    ...
    input: aws_sdk_connect.types.start_test_case_execution_request.StartTestCaseExecutionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_test_case_execution_request.serialize_json(input)
    ).encode()
