...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_user_request
    import aws_sdk_connect.types.describe_user_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_user_response.DescribeUserResponse = (
        aws_sdk_connect.types.describe_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_user_request.DescribeUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_user(
    ...
    aws_sdk_connect.types.describe_user_response.DescribeUserResponse, zapros.Response
]:
