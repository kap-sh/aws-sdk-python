...
import aws_sdk_connect.types.create_task_template_request
import aws_sdk_connect.types.create_task_template_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_task_template_response.CreateTaskTemplateResponse = aws_sdk_connect.types.create_task_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_task_template_request.CreateTaskTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_task_template_request.serialize_json(input_)
    ).encode()
