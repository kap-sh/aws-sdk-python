...
def build_request(
    ...
    input: aws_sdk_connect.types.create_task_template_request.CreateTaskTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_task_template_request.serialize_json(input)
    ).encode()
