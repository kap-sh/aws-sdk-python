...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_quick_connect_config_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_quick_connect_config_request.UpdateQuickConnectConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_quick_connect_config_request.serialize_json(input_)
    ).encode()
