...
def build_request(
    ...
    input: aws_sdk_connect.types.update_quick_connect_config_request.UpdateQuickConnectConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_quick_connect_config_request.serialize_json(input)
    ).encode()
