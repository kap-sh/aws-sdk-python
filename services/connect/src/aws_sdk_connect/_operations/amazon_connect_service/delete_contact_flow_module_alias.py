"""Generated from Smithy shape ``com.amazonaws.connect#DeleteContactFlowModuleAlias``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_contact_flow_module_alias_request
    import aws_sdk_connect.types.delete_contact_flow_module_alias_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_contact_flow_module_alias_response.DeleteContactFlowModuleAliasResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_contact_flow_module_alias_request.DeleteContactFlowModuleAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_contact_flow_module_alias(
