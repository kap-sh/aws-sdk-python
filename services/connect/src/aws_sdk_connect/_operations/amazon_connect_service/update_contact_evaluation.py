...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_contact_evaluation_request
    import aws_sdk_connect.types.update_contact_evaluation_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_contact_evaluation_response.UpdateContactEvaluationResponse = aws_sdk_connect.types.update_contact_evaluation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.update_contact_evaluation_request.UpdateContactEvaluationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_evaluation_request.serialize_json(input)
    ).encode()
