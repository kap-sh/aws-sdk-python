...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_predefined_attribute_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_predefined_attribute_request.DeletePredefinedAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
