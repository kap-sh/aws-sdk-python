"""Generated from Smithy shape ``com.amazonaws.connect#UpdateRoutingProfileDefaultOutboundQueue``."""
...
import aws_sdk_connect.types.update_routing_profile_default_outbound_queue_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_routing_profile_default_outbound_queue_request.UpdateRoutingProfileDefaultOutboundQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_routing_profile_default_outbound_queue_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_routing_profile_default_outbound_queue(
