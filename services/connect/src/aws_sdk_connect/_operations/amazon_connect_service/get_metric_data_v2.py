"""Generated from Smithy shape ``com.amazonaws.connect#GetMetricDataV2``."""
...
import aws_sdk_connect.types.filters_v2_list
import aws_sdk_connect.types.get_metric_data_v2_request
import aws_sdk_connect.types.get_metric_data_v2_response
import aws_sdk_connect.types.groupings_v2
import aws_sdk_connect.types.interval_details
import aws_sdk_connect.types.metric_results_v2
import aws_sdk_connect.types.metrics_v2
...
def handle_response(
    ...
    out: aws_sdk_connect.types.get_metric_data_v2_response.GetMetricDataV2Response = (
        aws_sdk_connect.types.get_metric_data_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.get_metric_data_v2_request.GetMetricDataV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_metric_data_v2(
