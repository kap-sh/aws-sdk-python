...
import aws_sdk_connect.types.describe_instance_request
import aws_sdk_connect.types.describe_instance_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_instance_response.DescribeInstanceResponse = (
        aws_sdk_connect.types.describe_instance_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_instance_request.DescribeInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
