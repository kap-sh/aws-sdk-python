...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_data_table_attribute_request.UpdateDataTableAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{DataTableId}", quote(str(input_["data_table_id"]), safe=""))
