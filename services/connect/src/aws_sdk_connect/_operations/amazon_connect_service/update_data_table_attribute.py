"""Generated from Smithy shape ``com.amazonaws.connect#UpdateDataTableAttribute``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.update_data_table_attribute_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_connect.errors.conflict_exception

            raise aws_sdk_connect.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
) -> aws_sdk_connect.types.update_data_table_attribute_response.UpdateDataTableAttributeResponse:
    import aws_sdk_connect.types.update_data_table_attribute_response

    out: aws_sdk_connect.types.update_data_table_attribute_response.UpdateDataTableAttributeResponse = aws_sdk_connect.types.update_data_table_attribute_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.update_data_table_attribute_request.UpdateDataTableAttributeRequest,
) -> zapros.Request:
    ...
    url = url.replace("{DataTableId}", quote(str(input["data_table_id"]), safe=""))
    url = url.replace("{AttributeName}", quote(str(input["attribute_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.update_data_table_attribute_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_data_table_attribute_request.serialize_json(input)
    ).encode()
...
async def async_update_data_table_attribute(
