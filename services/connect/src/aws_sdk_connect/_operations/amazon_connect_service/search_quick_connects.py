...
def build_request(
    ...
    input: aws_sdk_connect.types.search_quick_connects_request.SearchQuickConnectsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_quick_connects_request.serialize_json(input)
    ).encode()
