"""Generated from Smithy shape ``com.amazonaws.connect#SearchQuickConnects``."""
...
import aws_sdk_connect.types.quick_connect_search_summary_list
import aws_sdk_connect.types.search_quick_connects_request
import aws_sdk_connect.types.search_quick_connects_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_quick_connects_response.SearchQuickConnectsResponse = aws_sdk_connect.types.search_quick_connects_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_quick_connects_request.SearchQuickConnectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/search-quick-connects"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.search_quick_connects_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_quick_connects_request.serialize_json(input_)
    ).encode()
...
async def async_search_quick_connects(
