...
import aws_sdk_connect.types.list_instance_storage_configs_request
import aws_sdk_connect.types.list_instance_storage_configs_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_instance_storage_configs_response.ListInstanceStorageConfigsResponse = aws_sdk_connect.types.list_instance_storage_configs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_instance_storage_configs_request.ListInstanceStorageConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
