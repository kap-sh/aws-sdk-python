...
def build_request(
    ...
    input: aws_sdk_connect.types.create_email_address_request.CreateEmailAddressRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_email_address_request.serialize_json(input)
    ).encode()
