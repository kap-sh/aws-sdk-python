...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_email_address_request
    import aws_sdk_connect.types.create_email_address_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_email_address_response.CreateEmailAddressResponse = aws_sdk_connect.types.create_email_address_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_email_address_request.CreateEmailAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_email_address_request.serialize_json(input_)
    ).encode()
