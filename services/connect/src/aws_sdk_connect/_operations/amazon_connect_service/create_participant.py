"""Generated from Smithy shape ``com.amazonaws.connect#CreateParticipant``."""
...
import aws_sdk_connect.types.create_participant_request
import aws_sdk_connect.types.create_participant_response
import aws_sdk_connect.types.participant_details_to_add
import aws_sdk_connect.types.participant_token_credentials
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_participant_response.CreateParticipantResponse = (
        aws_sdk_connect.types.create_participant_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_participant_request.CreateParticipantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact/create-participant"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_participant_request.serialize_json(input_)
    ).encode()
