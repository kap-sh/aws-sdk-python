...
def build_request(
    ...
    input: aws_sdk_connect.types.deactivate_evaluation_form_request.DeactivateEvaluationFormRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.deactivate_evaluation_form_request.serialize_json(input)
    ).encode()
