...
if TYPE_CHECKING:
    import aws_sdk_connect.types.stop_contact_media_processing_request
    import aws_sdk_connect.types.stop_contact_media_processing_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.stop_contact_media_processing_response.StopContactMediaProcessingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.stop_contact_media_processing_request.StopContactMediaProcessingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.stop_contact_media_processing_request.serialize_json(
            input_
        )
    ).encode()
