...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_data_table_metadata_request
    import aws_sdk_connect.types.update_data_table_metadata_response
...
) -> aws_sdk_connect.types.update_data_table_metadata_response.UpdateDataTableMetadataResponse:
    import aws_sdk_connect.types.update_data_table_metadata_response

    out: aws_sdk_connect.types.update_data_table_metadata_response.UpdateDataTableMetadataResponse = aws_sdk_connect.types.update_data_table_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_data_table_metadata_request.UpdateDataTableMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_data_table_metadata_request.serialize_json(input_)
    ).encode()
