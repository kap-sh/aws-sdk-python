...
def build_request(
    ...
    input: aws_sdk_connect.types.update_data_table_metadata_request.UpdateDataTableMetadataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_data_table_metadata_request.serialize_json(input)
    ).encode()
