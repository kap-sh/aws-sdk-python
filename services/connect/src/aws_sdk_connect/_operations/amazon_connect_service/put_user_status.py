...
if TYPE_CHECKING:
    import aws_sdk_connect.types.put_user_status_request
    import aws_sdk_connect.types.put_user_status_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.put_user_status_response.PutUserStatusResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.put_user_status_request.PutUserStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.put_user_status_request.serialize_json(input_)
    ).encode()
