"""Generated from Smithy shape ``com.amazonaws.connect#BatchPutContact``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.batch_put_contact_request
    import aws_sdk_connect.types.batch_put_contact_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.batch_put_contact_response.BatchPutContactResponse = (
        aws_sdk_connect.types.batch_put_contact_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.batch_put_contact_request.BatchPutContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact/batch/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.batch_put_contact_request.serialize_json(input_)
    ).encode()
...
async def async_batch_put_contact(
