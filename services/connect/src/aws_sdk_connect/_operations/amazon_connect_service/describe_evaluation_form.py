...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_evaluation_form_request
    import aws_sdk_connect.types.describe_evaluation_form_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_evaluation_form_response.DescribeEvaluationFormResponse = aws_sdk_connect.types.describe_evaluation_form_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.describe_evaluation_form_request.DescribeEvaluationFormRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "evaluation_form_version" in input:
        params["version"] = str(input["evaluation_form_version"])
