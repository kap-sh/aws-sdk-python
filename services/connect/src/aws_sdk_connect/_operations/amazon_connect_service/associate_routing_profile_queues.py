"""Generated from Smithy shape ``com.amazonaws.connect#AssociateRoutingProfileQueues``."""
...
import aws_sdk_connect.types.associate_routing_profile_queues_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_routing_profile_queues_request.AssociateRoutingProfileQueuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_routing_profile_queues_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_routing_profile_queues(
