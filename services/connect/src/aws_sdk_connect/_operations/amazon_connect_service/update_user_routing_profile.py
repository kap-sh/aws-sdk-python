...
import aws_sdk_connect.types.update_user_routing_profile_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_user_routing_profile_request.UpdateUserRoutingProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_routing_profile_request.serialize_json(input_)
    ).encode()
