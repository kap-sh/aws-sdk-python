...
def build_request(
    ...
    input: aws_sdk_connect.types.update_user_routing_profile_request.UpdateUserRoutingProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_user_routing_profile_request.serialize_json(input)
    ).encode()
