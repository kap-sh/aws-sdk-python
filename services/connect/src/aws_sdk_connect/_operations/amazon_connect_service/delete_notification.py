"""Generated from Smithy shape ``com.amazonaws.connect#DeleteNotification``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.delete_notification_request
    import aws_sdk_connect.types.delete_notification_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.delete_notification_response.DeleteNotificationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_connect.types.delete_notification_request.DeleteNotificationRequest,
) -> zapros.Request:
