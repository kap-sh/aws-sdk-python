...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_workspace_request
    import aws_sdk_connect.types.describe_workspace_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_workspace_response.DescribeWorkspaceResponse = (
        aws_sdk_connect.types.describe_workspace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_workspace_request.DescribeWorkspaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
