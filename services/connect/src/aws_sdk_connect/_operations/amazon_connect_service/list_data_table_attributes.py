...
def build_request(
    ...
    input: aws_sdk_connect.types.list_data_table_attributes_request.ListDataTableAttributesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.list_data_table_attributes_request.serialize_json(input)
    ).encode()
