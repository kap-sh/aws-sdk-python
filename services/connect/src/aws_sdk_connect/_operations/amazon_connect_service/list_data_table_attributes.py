"""Generated from Smithy shape ``com.amazonaws.connect#ListDataTableAttributes``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_data_table_attributes_request
    import aws_sdk_connect.types.list_data_table_attributes_response
...
) -> aws_sdk_connect.types.list_data_table_attributes_response.ListDataTableAttributesResponse:
    import aws_sdk_connect.types.list_data_table_attributes_response

    out: aws_sdk_connect.types.list_data_table_attributes_response.ListDataTableAttributesResponse = aws_sdk_connect.types.list_data_table_attributes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_data_table_attributes_request.ListDataTableAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/data-tables/{InstanceId}/{DataTableId}/attributes"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.list_data_table_attributes_request.serialize_json(input_)
    ).encode()
...
async def async_list_data_table_attributes(
