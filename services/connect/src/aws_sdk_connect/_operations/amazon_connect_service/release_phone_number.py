"""Generated from Smithy shape ``com.amazonaws.connect#ReleasePhoneNumber``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.release_phone_number_request
...
def build_request(
    ...
    input: aws_sdk_connect.types.release_phone_number_request.ReleasePhoneNumberRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/phone-number/{PhoneNumberId}"
    url = url.replace("{PhoneNumberId}", quote(str(input["phone_number_id"]), safe=""))
    params: dict[str, str] = {}
