...
def build_request(
    ...
    input: aws_sdk_connect.types.create_routing_profile_request.CreateRoutingProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_routing_profile_request.serialize_json(input)
    ).encode()
