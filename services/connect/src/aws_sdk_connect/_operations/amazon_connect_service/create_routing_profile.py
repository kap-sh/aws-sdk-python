"""Generated from Smithy shape ``com.amazonaws.connect#CreateRoutingProfile``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_routing_profile_request
    import aws_sdk_connect.types.create_routing_profile_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_routing_profile_response.CreateRoutingProfileResponse = aws_sdk_connect.types.create_routing_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_routing_profile_request.CreateRoutingProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/routing-profiles/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_routing_profile_request.serialize_json(input_)
    ).encode()
...
async def async_create_routing_profile(
