...
def build_request(
    ...
    input: aws_sdk_connect.types.search_notifications_request.SearchNotificationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_notifications_request.serialize_json(input)
    ).encode()
