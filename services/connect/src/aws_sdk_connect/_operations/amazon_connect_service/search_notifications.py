...
import aws_sdk_connect.types.search_notifications_request
import aws_sdk_connect.types.search_notifications_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_notifications_response.SearchNotificationsResponse = aws_sdk_connect.types.search_notifications_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_notifications_request.SearchNotificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_notifications_request.serialize_json(input_)
    ).encode()
