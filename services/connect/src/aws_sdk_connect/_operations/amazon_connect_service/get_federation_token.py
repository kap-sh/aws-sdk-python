...
if TYPE_CHECKING:
    import aws_sdk_connect.types.get_federation_token_request
    import aws_sdk_connect.types.get_federation_token_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UserNotFoundException":
            import aws_sdk_connect.errors.user_not_found_exception

            raise aws_sdk_connect.errors.user_not_found_exception.UserNotFoundException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_connect.types.get_federation_token_response.GetFederationTokenResponse = aws_sdk_connect.types.get_federation_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.get_federation_token_request.GetFederationTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
