"""Generated from Smithy shape ``com.amazonaws.connect#ListEvaluationFormVersions``."""
...
import aws_sdk_connect.types.list_evaluation_form_versions_request
import aws_sdk_connect.types.list_evaluation_form_versions_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_evaluation_form_versions_response.ListEvaluationFormVersionsResponse = aws_sdk_connect.types.list_evaluation_form_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_evaluation_form_versions_request.ListEvaluationFormVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_evaluation_form_versions(
