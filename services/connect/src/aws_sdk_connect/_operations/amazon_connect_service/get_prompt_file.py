"""Generated from Smithy shape ``com.amazonaws.connect#GetPromptFile``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.get_prompt_file_request
    import aws_sdk_connect.types.get_prompt_file_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.get_prompt_file_response.GetPromptFileResponse = (
        aws_sdk_connect.types.get_prompt_file_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.get_prompt_file_request.GetPromptFileRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/prompts/{InstanceId}/{PromptId}/file"
    url = url.replace("{InstanceId}", quote(str(input["instance_id"]), safe=""))
    url = url.replace("{PromptId}", quote(str(input["prompt_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_prompt_file(
