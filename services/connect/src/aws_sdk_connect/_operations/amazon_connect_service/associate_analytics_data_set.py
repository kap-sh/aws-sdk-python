...
if TYPE_CHECKING:
    import aws_sdk_connect.types.associate_analytics_data_set_request
    import aws_sdk_connect.types.associate_analytics_data_set_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.associate_analytics_data_set_response.AssociateAnalyticsDataSetResponse = aws_sdk_connect.types.associate_analytics_data_set_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.associate_analytics_data_set_request.AssociateAnalyticsDataSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_analytics_data_set_request.serialize_json(input)
    ).encode()
