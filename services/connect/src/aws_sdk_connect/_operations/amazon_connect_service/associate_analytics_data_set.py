...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_analytics_data_set_request.AssociateAnalyticsDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_analytics_data_set_request.serialize_json(
            input_
        )
    ).encode()
