"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateBot``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.disassociate_bot_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_bot_request.DisassociateBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.disassociate_bot_request.serialize_json(input_)
    ).encode()
...
async def async_disassociate_bot(
