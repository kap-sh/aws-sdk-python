"""Generated from Smithy shape ``com.amazonaws.connect#ListContactFlowModuleVersions``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_contact_flow_module_versions_request
    import aws_sdk_connect.types.list_contact_flow_module_versions_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_contact_flow_module_versions_response.ListContactFlowModuleVersionsResponse = aws_sdk_connect.types.list_contact_flow_module_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_contact_flow_module_versions_request.ListContactFlowModuleVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_contact_flow_module_versions(
