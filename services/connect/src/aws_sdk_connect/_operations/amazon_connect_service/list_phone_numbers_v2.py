...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_phone_numbers_v2_request
    import aws_sdk_connect.types.list_phone_numbers_v2_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_phone_numbers_v2_response.ListPhoneNumbersV2Response = aws_sdk_connect.types.list_phone_numbers_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_phone_numbers_v2_request.ListPhoneNumbersV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.list_phone_numbers_v2_request.serialize_json(input_)
    ).encode()
