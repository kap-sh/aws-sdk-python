...
def build_request(
    ...
    input: aws_sdk_connect.types.list_phone_numbers_v2_request.ListPhoneNumbersV2Request,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.list_phone_numbers_v2_request.serialize_json(input)
    ).encode()
