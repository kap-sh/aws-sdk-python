...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_user_hierarchy_group_request
    import aws_sdk_connect.types.describe_user_hierarchy_group_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_user_hierarchy_group_response.DescribeUserHierarchyGroupResponse = aws_sdk_connect.types.describe_user_hierarchy_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_user_hierarchy_group_request.DescribeUserHierarchyGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
