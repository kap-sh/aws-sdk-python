"""Generated from Smithy shape ``com.amazonaws.connect#AssociateQueueEmailAddresses``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.associate_queue_email_addresses_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.associate_queue_email_addresses_request.AssociateQueueEmailAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.associate_queue_email_addresses_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_queue_email_addresses(
