"""Generated from Smithy shape ``com.amazonaws.connect#ListUserHierarchyGroups``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_user_hierarchy_groups_request
    import aws_sdk_connect.types.list_user_hierarchy_groups_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_user_hierarchy_groups_response.ListUserHierarchyGroupsResponse = aws_sdk_connect.types.list_user_hierarchy_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_user_hierarchy_groups_request.ListUserHierarchyGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/user-hierarchy-groups-summary/{InstanceId}"
...
async def async_list_user_hierarchy_groups(
