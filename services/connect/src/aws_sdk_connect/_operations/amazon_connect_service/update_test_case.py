"""Generated from Smithy shape ``com.amazonaws.connect#UpdateTestCase``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.update_test_case_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_test_case_response.UpdateTestCaseResponse = {}  # type: ignore[typeddict-item]
    return out
