"""Generated from Smithy shape ``com.amazonaws.connect#ListUsers``."""
...
import aws_sdk_connect.types.list_users_request
import aws_sdk_connect.types.list_users_response
import aws_sdk_connect.types.user_summary_list
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_users_response.ListUsersResponse = (
        aws_sdk_connect.types.list_users_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_users_request.ListUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/users-summary/{InstanceId}"
...
def list_users(
    ...
    aws_sdk_connect.types.list_users_response.ListUsersResponse, zapros.Response
]:
