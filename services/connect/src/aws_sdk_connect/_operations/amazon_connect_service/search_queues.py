...
import aws_sdk_connect.types.search_queues_request
import aws_sdk_connect.types.search_queues_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_queues_response.SearchQueuesResponse = (
        aws_sdk_connect.types.search_queues_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_queues_request.SearchQueuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_queues_request.serialize_json(input_)
    ).encode()
...
def search_queues(
    ...
    aws_sdk_connect.types.search_queues_response.SearchQueuesResponse, zapros.Response
]:
