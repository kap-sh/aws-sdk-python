"""Generated from Smithy shape ``com.amazonaws.connect#UpdateViewContent``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_view_content_request
    import aws_sdk_connect.types.update_view_content_response
...
) -> aws_sdk_connect.types.update_view_content_response.UpdateViewContentResponse:
    import aws_sdk_connect.types.update_view_content_response

    out: aws_sdk_connect.types.update_view_content_response.UpdateViewContentResponse = aws_sdk_connect.types.update_view_content_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_view_content_request.UpdateViewContentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/views/{InstanceId}/{ViewId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_view_content_request.serialize_json(input_)
    ).encode()
...
async def async_update_view_content(
