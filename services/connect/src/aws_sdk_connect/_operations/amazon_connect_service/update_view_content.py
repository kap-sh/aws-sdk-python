...
def build_request(
    ...
    input: aws_sdk_connect.types.update_view_content_request.UpdateViewContentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_view_content_request.serialize_json(input)
    ).encode()
