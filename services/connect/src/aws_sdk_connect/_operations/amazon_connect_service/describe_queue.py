"""Generated from Smithy shape ``com.amazonaws.connect#DescribeQueue``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.describe_queue_request
    import aws_sdk_connect.types.describe_queue_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.describe_queue_response.DescribeQueueResponse = (
        aws_sdk_connect.types.describe_queue_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.describe_queue_request.DescribeQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/queues/{InstanceId}/{QueueId}"
...
def describe_queue(
    ...
    aws_sdk_connect.types.describe_queue_response.DescribeQueueResponse, zapros.Response
]:
...
async def async_describe_queue(
