...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_data_table_primary_values_request
    import aws_sdk_connect.types.update_data_table_primary_values_response
...
) -> aws_sdk_connect.types.update_data_table_primary_values_response.UpdateDataTablePrimaryValuesResponse:
    import aws_sdk_connect.types.update_data_table_primary_values_response

    out: aws_sdk_connect.types.update_data_table_primary_values_response.UpdateDataTablePrimaryValuesResponse = aws_sdk_connect.types.update_data_table_primary_values_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_data_table_primary_values_request.UpdateDataTablePrimaryValuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_data_table_primary_values_request.serialize_json(
            input_
        )
    ).encode()
