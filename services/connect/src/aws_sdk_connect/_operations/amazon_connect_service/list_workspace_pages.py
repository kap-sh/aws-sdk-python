"""Generated from Smithy shape ``com.amazonaws.connect#ListWorkspacePages``."""
...
import aws_sdk_connect.types.list_workspace_pages_request
import aws_sdk_connect.types.list_workspace_pages_response
import aws_sdk_connect.types.workspace_page_list
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_workspace_pages_response.ListWorkspacePagesResponse = aws_sdk_connect.types.list_workspace_pages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_workspace_pages_request.ListWorkspacePagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_workspace_pages(
