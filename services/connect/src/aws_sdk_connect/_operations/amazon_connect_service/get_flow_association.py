"""Generated from Smithy shape ``com.amazonaws.connect#GetFlowAssociation``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.get_flow_association_request
    import aws_sdk_connect.types.get_flow_association_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.get_flow_association_response.GetFlowAssociationResponse = aws_sdk_connect.types.get_flow_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.get_flow_association_request.GetFlowAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_flow_association(
