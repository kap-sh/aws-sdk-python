...
if TYPE_CHECKING:
    import aws_sdk_connect.types.start_task_contact_request
    import aws_sdk_connect.types.start_task_contact_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.start_task_contact_response.StartTaskContactResponse = (
        aws_sdk_connect.types.start_task_contact_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.start_task_contact_request.StartTaskContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.start_task_contact_request.serialize_json(input_)
    ).encode()
