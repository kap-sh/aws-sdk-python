...
def build_request(
    ...
    input: aws_sdk_connect.types.update_user_hierarchy_group_name_request.UpdateUserHierarchyGroupNameRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{HierarchyGroupId}", quote(str(input["hierarchy_group_id"]), safe="")
    )
