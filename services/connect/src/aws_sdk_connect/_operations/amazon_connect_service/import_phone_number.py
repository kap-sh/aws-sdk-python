"""Generated from Smithy shape ``com.amazonaws.connect#ImportPhoneNumber``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.import_phone_number_request
    import aws_sdk_connect.types.import_phone_number_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.import_phone_number_response.ImportPhoneNumberResponse = aws_sdk_connect.types.import_phone_number_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.import_phone_number_request.ImportPhoneNumberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/phone-number/import"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.import_phone_number_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.import_phone_number_request.serialize_json(input_)
    ).encode()
...
async def async_import_phone_number(
