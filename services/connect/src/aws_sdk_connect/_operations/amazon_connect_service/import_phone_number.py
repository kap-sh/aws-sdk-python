...
def build_request(
    ...
    input: aws_sdk_connect.types.import_phone_number_request.ImportPhoneNumberRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.import_phone_number_request.serialize_json(input)
    ).encode()
