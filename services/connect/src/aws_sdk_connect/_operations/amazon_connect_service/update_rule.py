...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_rule_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_rule_request.UpdateRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_rule_request.serialize_json(input_)
    ).encode()
