"""Generated from Smithy shape ``com.amazonaws.connect#PauseContact``."""
...
import aws_sdk_connect.types.pause_contact_request
import aws_sdk_connect.types.pause_contact_response
...
) -> aws_sdk_connect.types.pause_contact_response.PauseContactResponse:
    out: aws_sdk_connect.types.pause_contact_response.PauseContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.pause_contact_request.PauseContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact/pause"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_connect.types.pause_contact_request

    body: bytes | None = json.dumps(
        aws_sdk_connect.types.pause_contact_request.serialize_json(input_)
    ).encode()
...
def pause_contact(
    ...
    aws_sdk_connect.types.pause_contact_response.PauseContactResponse, zapros.Response
]:
