...
def build_request(
    ...
    input: aws_sdk_connect.types.list_data_table_values_request.ListDataTableValuesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.list_data_table_values_request.serialize_json(input)
    ).encode()
