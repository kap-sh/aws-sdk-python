...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_data_table_values_request
    import aws_sdk_connect.types.list_data_table_values_response
...
) -> aws_sdk_connect.types.list_data_table_values_response.ListDataTableValuesResponse:
    import aws_sdk_connect.types.list_data_table_values_response

    out: aws_sdk_connect.types.list_data_table_values_response.ListDataTableValuesResponse = aws_sdk_connect.types.list_data_table_values_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_data_table_values_request.ListDataTableValuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.list_data_table_values_request.serialize_json(input_)
    ).encode()
