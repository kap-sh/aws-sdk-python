...
def build_request(
    ...
    input: aws_sdk_connect.types.update_workspace_metadata_request.UpdateWorkspaceMetadataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_workspace_metadata_request.serialize_json(input)
    ).encode()
