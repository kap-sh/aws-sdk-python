...
import aws_sdk_connect.types.update_workspace_metadata_request
import aws_sdk_connect.types.update_workspace_metadata_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_workspace_metadata_response.UpdateWorkspaceMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_workspace_metadata_request.UpdateWorkspaceMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_workspace_metadata_request.serialize_json(input_)
    ).encode()
