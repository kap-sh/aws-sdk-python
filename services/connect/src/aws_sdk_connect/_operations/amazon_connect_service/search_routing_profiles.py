...
import aws_sdk_connect.types.search_routing_profiles_request
import aws_sdk_connect.types.search_routing_profiles_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.search_routing_profiles_response.SearchRoutingProfilesResponse = aws_sdk_connect.types.search_routing_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.search_routing_profiles_request.SearchRoutingProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.search_routing_profiles_request.serialize_json(input_)
    ).encode()
