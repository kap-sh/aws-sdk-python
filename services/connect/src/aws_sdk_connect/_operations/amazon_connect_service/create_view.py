...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_view_request
    import aws_sdk_connect.types.create_view_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_view_response.CreateViewResponse = (
        aws_sdk_connect.types.create_view_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_view_request.CreateViewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_view_request.serialize_json(input_)
    ).encode()
...
def create_view(
    ...
    aws_sdk_connect.types.create_view_response.CreateViewResponse, zapros.Response
]:
