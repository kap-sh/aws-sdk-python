"""Generated from Smithy shape ``com.amazonaws.connect#ListFlowAssociations``."""
...
import aws_sdk_connect.types.list_flow_associations_request
import aws_sdk_connect.types.list_flow_associations_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_flow_associations_response.ListFlowAssociationsResponse = aws_sdk_connect.types.list_flow_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_flow_associations_request.ListFlowAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/flow-associations-summary/{InstanceId}"
...
async def async_list_flow_associations(
