"""Generated from Smithy shape ``com.amazonaws.connect#CompleteAttachedFileUpload``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.complete_attached_file_upload_request
    import aws_sdk_connect.types.complete_attached_file_upload_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.complete_attached_file_upload_response.CompleteAttachedFileUploadResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.complete_attached_file_upload_request.CompleteAttachedFileUploadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_complete_attached_file_upload(
