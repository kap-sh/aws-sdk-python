...
if TYPE_CHECKING:
    import aws_sdk_connect.types.batch_associate_analytics_data_set_request
    import aws_sdk_connect.types.batch_associate_analytics_data_set_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.batch_associate_analytics_data_set_response.BatchAssociateAnalyticsDataSetResponse = aws_sdk_connect.types.batch_associate_analytics_data_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.batch_associate_analytics_data_set_request.BatchAssociateAnalyticsDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.batch_associate_analytics_data_set_request.serialize_json(
            input_
        )
    ).encode()
