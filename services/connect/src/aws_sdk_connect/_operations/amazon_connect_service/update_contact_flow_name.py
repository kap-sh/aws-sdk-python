...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_contact_flow_name_request
    import aws_sdk_connect.types.update_contact_flow_name_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.update_contact_flow_name_response.UpdateContactFlowNameResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.update_contact_flow_name_request.UpdateContactFlowNameRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_flow_name_request.serialize_json(input_)
    ).encode()
