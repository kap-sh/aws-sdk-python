...
def build_request(
    ...
    input: aws_sdk_connect.types.update_contact_flow_name_request.UpdateContactFlowNameRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_contact_flow_name_request.serialize_json(input)
    ).encode()
