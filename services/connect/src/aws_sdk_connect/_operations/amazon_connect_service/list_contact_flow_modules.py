...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_contact_flow_modules_request
    import aws_sdk_connect.types.list_contact_flow_modules_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_contact_flow_modules_response.ListContactFlowModulesResponse = aws_sdk_connect.types.list_contact_flow_modules_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_connect.types.list_contact_flow_modules_request.ListContactFlowModulesRequest,
) -> zapros.Request:
    ...
    if "contact_flow_module_state" in input:
        params["state"] = str(input["contact_flow_module_state"])
