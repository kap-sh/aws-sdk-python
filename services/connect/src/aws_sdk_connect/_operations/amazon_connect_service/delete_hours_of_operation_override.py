...
import aws_sdk_connect.types.delete_hours_of_operation_override_request
...
def build_request(
    ...
    input_: aws_sdk_connect.types.delete_hours_of_operation_override_request.DeleteHoursOfOperationOverrideRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
