...
if TYPE_CHECKING:
    import aws_sdk_connect.types.batch_get_flow_association_request
    import aws_sdk_connect.types.batch_get_flow_association_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.batch_get_flow_association_response.BatchGetFlowAssociationResponse = aws_sdk_connect.types.batch_get_flow_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.batch_get_flow_association_request.BatchGetFlowAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.batch_get_flow_association_request.serialize_json(input_)
    ).encode()
