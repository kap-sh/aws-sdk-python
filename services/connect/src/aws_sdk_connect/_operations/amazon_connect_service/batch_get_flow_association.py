...
def build_request(
    ...
    input: aws_sdk_connect.types.batch_get_flow_association_request.BatchGetFlowAssociationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.batch_get_flow_association_request.serialize_json(input)
    ).encode()
