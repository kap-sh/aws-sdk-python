...
def build_request(
    ...
    input: aws_sdk_connect.types.suspend_contact_recording_request.SuspendContactRecordingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.suspend_contact_recording_request.serialize_json(input)
    ).encode()
