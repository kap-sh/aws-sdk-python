...
if TYPE_CHECKING:
    import aws_sdk_connect.types.suspend_contact_recording_request
    import aws_sdk_connect.types.suspend_contact_recording_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.suspend_contact_recording_response.SuspendContactRecordingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_connect.types.suspend_contact_recording_request.SuspendContactRecordingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.suspend_contact_recording_request.serialize_json(input_)
    ).encode()
