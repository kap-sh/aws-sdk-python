...
def build_request(
    ...
    input: aws_sdk_connect.types.disassociate_workspace_request.DisassociateWorkspaceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.disassociate_workspace_request.serialize_json(input)
    ).encode()
