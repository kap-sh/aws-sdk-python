"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateWorkspace``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.disassociate_workspace_request
    import aws_sdk_connect.types.disassociate_workspace_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.disassociate_workspace_response.DisassociateWorkspaceResponse = aws_sdk_connect.types.disassociate_workspace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.disassociate_workspace_request.DisassociateWorkspaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/workspaces/{InstanceId}/{WorkspaceId}/disassociate"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.disassociate_workspace_request.serialize_json(input_)
    ).encode()
...
async def async_disassociate_workspace(
