"""Generated from Smithy shape ``com.amazonaws.connect#ListQueueEmailAddresses``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.list_queue_email_addresses_request
    import aws_sdk_connect.types.list_queue_email_addresses_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.list_queue_email_addresses_response.ListQueueEmailAddressesResponse = aws_sdk_connect.types.list_queue_email_addresses_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.list_queue_email_addresses_request.ListQueueEmailAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/queues/{InstanceId}/{QueueId}/email-addresses"
...
async def async_list_queue_email_addresses(
