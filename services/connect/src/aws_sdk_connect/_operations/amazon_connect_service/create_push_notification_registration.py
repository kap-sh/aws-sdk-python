"""Generated from Smithy shape ``com.amazonaws.connect#CreatePushNotificationRegistration``."""
...
if TYPE_CHECKING:
    import aws_sdk_connect.types.create_push_notification_registration_request
    import aws_sdk_connect.types.create_push_notification_registration_response
...
def handle_response(
    ...
    out: aws_sdk_connect.types.create_push_notification_registration_response.CreatePushNotificationRegistrationResponse = aws_sdk_connect.types.create_push_notification_registration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connect.types.create_push_notification_registration_request.CreatePushNotificationRegistrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/push-notification/{InstanceId}/registrations"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.create_push_notification_registration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_push_notification_registration(
