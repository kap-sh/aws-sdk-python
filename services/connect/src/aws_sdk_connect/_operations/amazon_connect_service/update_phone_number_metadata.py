...
if TYPE_CHECKING:
    import aws_sdk_connect.types.update_phone_number_metadata_request
...
def build_request(
    ...
    input: aws_sdk_connect.types.update_phone_number_metadata_request.UpdatePhoneNumberMetadataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connect.types.update_phone_number_metadata_request.serialize_json(input)
    ).encode()
