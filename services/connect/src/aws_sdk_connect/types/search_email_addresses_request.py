...
class SearchEmailAddressesRequest(TypedDict):
...
def serialize_json(value: SearchEmailAddressesRequest) -> dict:
    ...
    if "search_criteria" in value:
        ...
        out["SearchCriteria"] = (
            aws_sdk_connect.types.email_address_search_criteria.serialize_json(
    ...
    if "search_filter" in value:
        ...
        out["SearchFilter"] = (
            aws_sdk_connect.types.email_address_search_filter.serialize_json(
                value["search_filter"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> SearchEmailAddressesRequest:
    ...
    if "SearchCriteria" in data:
        ...
        out["search_criteria"] = (
            aws_sdk_connect.types.email_address_search_criteria.deserialize_json(
                data["SearchCriteria"]
            )
        )
    if "SearchFilter" in data:
        ...
        out["search_filter"] = (
            aws_sdk_connect.types.email_address_search_filter.deserialize_json(
                data["SearchFilter"]
            )
        )
    return out
