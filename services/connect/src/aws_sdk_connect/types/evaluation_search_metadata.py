...
class EvaluationSearchMetadata(TypedDict):
    ...
    score_automatic_fail: "aws_sdk_connect.types.boolean.Boolean"
    ...
    score_not_applicable: "aws_sdk_connect.types.boolean.Boolean"
