...
if TYPE_CHECKING:
    import aws_sdk_connect.types.contact_flow_modules_summary_list
    import aws_sdk_connect.types.next_token


class ListContactFlowModulesResponse(TypedDict):
    contact_flow_modules_summary_list: NotRequired[
        "aws_sdk_connect.types.contact_flow_modules_summary_list.ContactFlowModulesSummaryList"
    ]
...
def serialize_json(value: ListContactFlowModulesResponse) -> dict:
    ...
    if "contact_flow_modules_summary_list" in value:
        ...
        out["ContactFlowModulesSummaryList"] = (
            aws_sdk_connect.types.contact_flow_modules_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListContactFlowModulesResponse:
    ...
    if "ContactFlowModulesSummaryList" in data:
        ...
        out["contact_flow_modules_summary_list"] = (
            aws_sdk_connect.types.contact_flow_modules_summary_list.deserialize_json(
