...
class SearchContactEvaluationsRequest(TypedDict):
...
def serialize_json(value: SearchContactEvaluationsRequest) -> dict:
    ...
    if "search_criteria" in value:
        ...
        out["SearchCriteria"] = (
            aws_sdk_connect.types.evaluation_search_criteria.serialize_json(
    ...
    if "search_filter" in value:
        ...
        out["SearchFilter"] = (
            aws_sdk_connect.types.evaluation_search_filter.serialize_json(
                value["search_filter"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> SearchContactEvaluationsRequest:
    ...
    if "SearchCriteria" in data:
        ...
        out["search_criteria"] = (
            aws_sdk_connect.types.evaluation_search_criteria.deserialize_json(
                data["SearchCriteria"]
            )
        )
    if "SearchFilter" in data:
        ...
        out["search_filter"] = (
            aws_sdk_connect.types.evaluation_search_filter.deserialize_json(
                data["SearchFilter"]
            )
        )
    return out
