...
class ListQueuesResponse(TypedDict):
    queue_summary_list: NotRequired[
        "aws_sdk_connect.types.queue_summary_list.QueueSummaryList"
    ]
...
def serialize_json(value: ListQueuesResponse) -> dict:
    ...
    if "queue_summary_list" in value:
        ...
        out["QueueSummaryList"] = (
            aws_sdk_connect.types.queue_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListQueuesResponse:
    ...
    if "QueueSummaryList" in data:
        ...
        out["queue_summary_list"] = (
            aws_sdk_connect.types.queue_summary_list.deserialize_json(
