...
class ChatContactMetrics(TypedDict):
    multi_party: NotRequired["aws_sdk_connect.types.nullable_boolean.NullableBoolean"]
    """<p>A boolean flag indicating whether multiparty chat or supervisor barge were enabled on this contact.</p>"""
    total_messages: NotRequired["aws_sdk_connect.types.count.Count"]
    """<p>The number of chat messages on the contact.</p>"""
    total_bot_messages: NotRequired["aws_sdk_connect.types.count.Count"]
    """<p>The total number of bot and automated messages on a chat contact.</p>"""
    total_bot_message_length_in_chars: NotRequired["aws_sdk_connect.types.count.Count"]
    ...
    conversation_turn_count: NotRequired["aws_sdk_connect.types.count.Count"]
