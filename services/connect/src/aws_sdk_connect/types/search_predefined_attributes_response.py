...
class SearchPredefinedAttributesResponse(TypedDict):
    predefined_attributes: NotRequired[
        "aws_sdk_connect.types.predefined_attribute_search_summary_list.PredefinedAttributeSearchSummaryList"
    ]
...
def serialize_json(value: SearchPredefinedAttributesResponse) -> dict:
    ...
    if "predefined_attributes" in value:
        ...
        out["PredefinedAttributes"] = (
            aws_sdk_connect.types.predefined_attribute_search_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> SearchPredefinedAttributesResponse:
    ...
    if "PredefinedAttributes" in data:
        ...
        out["predefined_attributes"] = (
            aws_sdk_connect.types.predefined_attribute_search_summary_list.deserialize_json(
