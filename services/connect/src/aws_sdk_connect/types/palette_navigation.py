...
class PaletteNavigation(TypedDict):
    ...
    text_background_active: NotRequired[
        "aws_sdk_connect.types.theme_string.ThemeString"
    ]
    ...
    text_active: NotRequired["aws_sdk_connect.types.theme_string.ThemeString"]
