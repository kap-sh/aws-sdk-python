...
class HierarchyLevel(TypedDict, closed=True):
    id: NotRequired["aws_sdk_connect.types.hierarchy_level_id.HierarchyLevelId"]
    """<p>The identifier of the hierarchy level.</p>"""
    arn: NotRequired["aws_sdk_connect.types.arn.ARN"]
    """<p>The Amazon Resource Name (ARN) of the hierarchy level.</p>"""
    name: NotRequired["aws_sdk_connect.types.hierarchy_level_name.HierarchyLevelName"]
