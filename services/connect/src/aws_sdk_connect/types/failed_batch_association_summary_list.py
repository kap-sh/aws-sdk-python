...
if TYPE_CHECKING:
    import aws_sdk_connect.types.failed_batch_association_summary

FailedBatchAssociationSummaryList: TypeAlias = list[
    "aws_sdk_connect.types.failed_batch_association_summary.FailedBatchAssociationSummary"
]
...
def serialize_json(value: FailedBatchAssociationSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_connect.types.failed_batch_association_summary.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> FailedBatchAssociationSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_connect.types.failed_batch_association_summary.deserialize_json(
                item
            )
        )
    return out
