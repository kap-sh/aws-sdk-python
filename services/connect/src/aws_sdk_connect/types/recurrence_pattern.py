...
if TYPE_CHECKING:
    import aws_sdk_connect.types.interval_positive_integer
    import aws_sdk_connect.types.month_day_list
    import aws_sdk_connect.types.month_list
    import aws_sdk_connect.types.recurrence_frequency
...
class RecurrencePattern(TypedDict):
    ...
    by_month: NotRequired["aws_sdk_connect.types.month_list.MonthList"]
    ...
    by_month_day: NotRequired["aws_sdk_connect.types.month_day_list.MonthDayList"]
    ...
    by_weekday_occurrence: NotRequired[
        "aws_sdk_connect.types.weekday_occurrence_list.WeekdayOccurrenceList"
    ]
...
def serialize_json(value: RecurrencePattern) -> dict:
    ...
    out["Frequency"] = aws_sdk_connect.types.recurrence_frequency.serialize_json(
        value["frequency"]
    )
    ...
    if "by_month" in value:
        ...
        out["ByMonth"] = aws_sdk_connect.types.month_list.serialize_json(
            value["by_month"]
        )
    if "by_month_day" in value:
        import aws_sdk_connect.types.month_day_list

        out["ByMonthDay"] = aws_sdk_connect.types.month_day_list.serialize_json(
            value["by_month_day"]
        )
    if "by_weekday_occurrence" in value:
        ...
        out["ByWeekdayOccurrence"] = (
            aws_sdk_connect.types.weekday_occurrence_list.serialize_json(
...
def deserialize_json(data: dict) -> RecurrencePattern:
    ...
    if "Frequency" in data:
        ...
        out["frequency"] = aws_sdk_connect.types.recurrence_frequency.deserialize_json(
            data["Frequency"]
        )
    else:
    ...
    if "ByMonth" in data:
        ...
        out["by_month"] = aws_sdk_connect.types.month_list.deserialize_json(
            data["ByMonth"]
        )
    if "ByMonthDay" in data:
        import aws_sdk_connect.types.month_day_list

        out["by_month_day"] = aws_sdk_connect.types.month_day_list.deserialize_json(
            data["ByMonthDay"]
        )
    if "ByWeekdayOccurrence" in data:
        ...
        out["by_weekday_occurrence"] = (
            aws_sdk_connect.types.weekday_occurrence_list.deserialize_json(
