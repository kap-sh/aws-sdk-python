...
class SearchResourceTagsRequest(TypedDict):
    ...
    search_criteria: NotRequired[
        "aws_sdk_connect.types.resource_tags_search_criteria.ResourceTagsSearchCriteria"
    ]
...
def serialize_json(value: SearchResourceTagsRequest) -> dict:
    ...
    if "resource_types" in value:
        ...
        out["ResourceTypes"] = aws_sdk_connect.types.resource_type_list.serialize_json(
    ...
    if "search_criteria" in value:
        ...
        out["SearchCriteria"] = (
            aws_sdk_connect.types.resource_tags_search_criteria.serialize_json(
...
def deserialize_json(data: dict) -> SearchResourceTagsRequest:
    ...
    if "ResourceTypes" in data:
        ...
        out["resource_types"] = (
            aws_sdk_connect.types.resource_type_list.deserialize_json(
                data["ResourceTypes"]
            )
        )
    ...
    if "SearchCriteria" in data:
        ...
        out["search_criteria"] = (
            aws_sdk_connect.types.resource_tags_search_criteria.deserialize_json(
                data["SearchCriteria"]
            )
        )
    return out
