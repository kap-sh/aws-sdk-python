"""Generated from Smithy shape ``com.amazonaws.connect#UserHierarchyGroupSearchFilter``."""
...
class UserHierarchyGroupSearchFilter(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UserHierarchyGroupSearchFilter) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UserHierarchyGroupSearchFilter:
    out: UserHierarchyGroupSearchFilter = {}  # type: ignore[typeddict-item]
