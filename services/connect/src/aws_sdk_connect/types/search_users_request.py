"""Generated from Smithy shape ``com.amazonaws.connect#SearchUsersRequest``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.user_search_filter
...
class SearchUsersRequest(TypedDict, closed=True):
    ...
    search_filter: NotRequired[
        "aws_sdk_connect.types.user_search_filter.UserSearchFilter"
    ]
...
def serialize_json(value: SearchUsersRequest) -> dict:
    ...
    if "search_filter" in value:
        ...
        out["SearchFilter"] = aws_sdk_connect.types.user_search_filter.serialize_json(
            value["search_filter"]
        )
    if "search_criteria" in value:
        ...
        out["SearchCriteria"] = (
            aws_sdk_connect.types.user_search_criteria.serialize_json(
...
def deserialize_json(data: dict) -> SearchUsersRequest:
    ...
    if "InstanceId" in data:
        ...
        raise DeserializationError("SearchUsersRequest.instance_id required")
    ...
    if "SearchFilter" in data:
        ...
        out["search_filter"] = (
            aws_sdk_connect.types.user_search_filter.deserialize_json(
                data["SearchFilter"]
            )
        )
    if "SearchCriteria" in data:
        ...
        out["search_criteria"] = (
            aws_sdk_connect.types.user_search_criteria.deserialize_json(
                data["SearchCriteria"]
            )
        )
    return out
