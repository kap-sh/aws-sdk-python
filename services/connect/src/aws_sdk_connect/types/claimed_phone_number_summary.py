...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.phone_number_status
    import aws_sdk_connect.types.phone_number_type
    import aws_sdk_connect.types.tag_map


class ClaimedPhoneNumberSummary(TypedDict):
    ...
    phone_number_status: NotRequired[
        "aws_sdk_connect.types.phone_number_status.PhoneNumberStatus"
    ]
...
def serialize_json(value: ClaimedPhoneNumberSummary) -> dict:
    ...
    if "phone_number_status" in value:
        ...
        out["PhoneNumberStatus"] = (
            aws_sdk_connect.types.phone_number_status.serialize_json(
...
def deserialize_json(data: dict) -> ClaimedPhoneNumberSummary:
    ...
    if "PhoneNumberStatus" in data:
        ...
        out["phone_number_status"] = (
            aws_sdk_connect.types.phone_number_status.deserialize_json(
