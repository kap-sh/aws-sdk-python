...
class SearchQuickConnectsResponse(TypedDict):
    quick_connects: NotRequired[
        "aws_sdk_connect.types.quick_connect_search_summary_list.QuickConnectSearchSummaryList"
    ]
...
def serialize_json(value: SearchQuickConnectsResponse) -> dict:
    ...
    if "quick_connects" in value:
        ...
        out["QuickConnects"] = (
            aws_sdk_connect.types.quick_connect_search_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> SearchQuickConnectsResponse:
    ...
    if "QuickConnects" in data:
        ...
        out["quick_connects"] = (
            aws_sdk_connect.types.quick_connect_search_summary_list.deserialize_json(
                data["QuickConnects"]
            )
        )
