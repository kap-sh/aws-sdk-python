...
if TYPE_CHECKING:
    import aws_sdk_connect.types.notification_search_condition_list
    import aws_sdk_connect.types.string_condition


class NotificationSearchCriteria(TypedDict):
    or_conditions: NotRequired[
        "aws_sdk_connect.types.notification_search_condition_list.NotificationSearchConditionList"
    ]
...
def serialize_json(value: NotificationSearchCriteria) -> dict:
    ...
    if "or_conditions" in value:
        ...
        out["OrConditions"] = (
            aws_sdk_connect.types.notification_search_condition_list.serialize_json(
                value["or_conditions"]
            )
        )
...
def deserialize_json(data: dict) -> NotificationSearchCriteria:
    ...
    if "OrConditions" in data:
        ...
        out["or_conditions"] = (
            aws_sdk_connect.types.notification_search_condition_list.deserialize_json(
                data["OrConditions"]
            )
        )
