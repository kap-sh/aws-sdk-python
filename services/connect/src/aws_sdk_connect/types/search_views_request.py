...
class SearchViewsRequest(TypedDict, closed=True):
    ...
    search_filter: NotRequired[
        "aws_sdk_connect.types.view_search_filter.ViewSearchFilter"
    ]
...
def serialize_json(value: SearchViewsRequest) -> dict:
    ...
    if "search_filter" in value:
        ...
        out["SearchFilter"] = aws_sdk_connect.types.view_search_filter.serialize_json(
            value["search_filter"]
        )
    if "search_criteria" in value:
        ...
        out["SearchCriteria"] = (
            aws_sdk_connect.types.view_search_criteria.serialize_json(
...
def deserialize_json(data: dict) -> SearchViewsRequest:
    ...
    if "SearchFilter" in data:
        ...
        out["search_filter"] = (
            aws_sdk_connect.types.view_search_filter.deserialize_json(
                data["SearchFilter"]
            )
        )
    if "SearchCriteria" in data:
        ...
        out["search_criteria"] = (
            aws_sdk_connect.types.view_search_criteria.deserialize_json(
                data["SearchCriteria"]
            )
        )
    return out
