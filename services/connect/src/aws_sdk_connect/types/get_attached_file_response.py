...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.download_url_metadata
...
class GetAttachedFileResponse(TypedDict):
    ...
    file_name: NotRequired["aws_sdk_connect.types.file_name.FileName"]
    ...
    download_url_metadata: NotRequired[
        "aws_sdk_connect.types.download_url_metadata.DownloadUrlMetadata"
    ]
...
def serialize_json(value: GetAttachedFileResponse) -> dict:
    ...
    if "download_url_metadata" in value:
        ...
        out["DownloadUrlMetadata"] = (
            aws_sdk_connect.types.download_url_metadata.serialize_json(
...
def deserialize_json(data: dict) -> GetAttachedFileResponse:
    ...
    if "DownloadUrlMetadata" in data:
        ...
        out["download_url_metadata"] = (
            aws_sdk_connect.types.download_url_metadata.deserialize_json(
