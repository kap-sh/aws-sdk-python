...
class CreateContactFlowRequest(TypedDict):
    instance_id: "aws_sdk_connect.types.instance_id.InstanceId"
    """<p>The identifier of the Connect Customer instance.</p>"""
    name: "aws_sdk_connect.types.contact_flow_name.ContactFlowName"
    """<p>The name of the flow.</p>"""
    type: "aws_sdk_connect.types.contact_flow_type.ContactFlowType"
...
def serialize_json(value: CreateContactFlowRequest) -> dict:
    ...
    out["Type"] = aws_sdk_connect.types.contact_flow_type.serialize_json(value["type"])
