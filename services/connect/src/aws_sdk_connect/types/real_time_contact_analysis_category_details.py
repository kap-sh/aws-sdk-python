...
if TYPE_CHECKING:
    import aws_sdk_connect.types.real_time_contact_analysis_points_of_interest


class RealTimeContactAnalysisCategoryDetails(TypedDict):
    points_of_interest: "aws_sdk_connect.types.real_time_contact_analysis_points_of_interest.RealTimeContactAnalysisPointsOfInterest"
...
def serialize_json(value: RealTimeContactAnalysisCategoryDetails) -> dict:
    ...
    out["PointsOfInterest"] = (
        aws_sdk_connect.types.real_time_contact_analysis_points_of_interest.serialize_json(
...
def deserialize_json(data: dict) -> RealTimeContactAnalysisCategoryDetails:
    ...
    if "PointsOfInterest" in data:
        ...
        out["points_of_interest"] = (
            aws_sdk_connect.types.real_time_contact_analysis_points_of_interest.deserialize_json(
