...
if TYPE_CHECKING:
    import aws_sdk_connect.types.primary_attribute_access_control_configuration_item


class DataTableAccessControlConfiguration(TypedDict):
    primary_attribute_access_control_configuration: NotRequired[
        "aws_sdk_connect.types.primary_attribute_access_control_configuration_item.PrimaryAttributeAccessControlConfigurationItem"
    ]
...
def serialize_json(value: DataTableAccessControlConfiguration) -> dict:
    ...
    if "primary_attribute_access_control_configuration" in value:
        ...
        out["PrimaryAttributeAccessControlConfiguration"] = (
            aws_sdk_connect.types.primary_attribute_access_control_configuration_item.serialize_json(
...
def deserialize_json(data: dict) -> DataTableAccessControlConfiguration:
    ...
    if "PrimaryAttributeAccessControlConfiguration" in data:
        ...
        out["primary_attribute_access_control_configuration"] = (
            aws_sdk_connect.types.primary_attribute_access_control_configuration_item.deserialize_json(
