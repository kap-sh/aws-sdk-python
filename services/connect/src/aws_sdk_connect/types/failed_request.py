...
if TYPE_CHECKING:
    import aws_sdk_connect.types.failure_reason_code
...
class FailedRequest(TypedDict, closed=True):
    ...
    failure_reason_code: NotRequired[
        "aws_sdk_connect.types.failure_reason_code.FailureReasonCode"
    ]
    """<p>Reason code for the failure.</p>"""
    failure_reason_message: NotRequired["aws_sdk_connect.types.string.String"]
...
def serialize_json(value: FailedRequest) -> dict:
    ...
    if "failure_reason_code" in value:
        ...
        out["FailureReasonCode"] = (
            aws_sdk_connect.types.failure_reason_code.serialize_json(
...
def deserialize_json(data: dict) -> FailedRequest:
    ...
    if "FailureReasonCode" in data:
        ...
        out["failure_reason_code"] = (
            aws_sdk_connect.types.failure_reason_code.deserialize_json(
