...
if TYPE_CHECKING:
    import aws_sdk_connect.types.evaluation_answer_input
...
EvaluationAnswersInputMap: TypeAlias = dict[
    ...
    "aws_sdk_connect.types.evaluation_answer_input.EvaluationAnswerInput",
]
...
def serialize_json(input_to_serialize: EvaluationAnswersInputMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_connect.types.evaluation_answer_input.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> EvaluationAnswersInputMap:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_connect.types.evaluation_answer_input.deserialize_json(value)
    return out
