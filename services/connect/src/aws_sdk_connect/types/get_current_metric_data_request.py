...
class GetCurrentMetricDataRequest(TypedDict):
    ...
    current_metrics: "aws_sdk_connect.types.current_metrics.CurrentMetrics"
...
def serialize_json(value: GetCurrentMetricDataRequest) -> dict:
    ...
    out["CurrentMetrics"] = aws_sdk_connect.types.current_metrics.serialize_json(
    ...
    if "sort_criteria" in value:
        ...
        out["SortCriteria"] = (
            aws_sdk_connect.types.current_metric_sort_criteria_max_one.serialize_json(
                value["sort_criteria"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> GetCurrentMetricDataRequest:
    ...
    if "CurrentMetrics" in data:
        ...
        out["current_metrics"] = aws_sdk_connect.types.current_metrics.deserialize_json(
            data["CurrentMetrics"]
        )
    else:
    ...
    if "SortCriteria" in data:
        ...
        out["sort_criteria"] = (
            aws_sdk_connect.types.current_metric_sort_criteria_max_one.deserialize_json(
                data["SortCriteria"]
            )
        )
    return out
