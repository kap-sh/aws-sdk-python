...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.new_chat_created


class SendChatIntegrationEventResponse(TypedDict):
    ...
    new_chat_created: NotRequired[
        "aws_sdk_connect.types.new_chat_created.NewChatCreated"
    ]
