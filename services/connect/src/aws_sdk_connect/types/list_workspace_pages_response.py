...
class ListWorkspacePagesResponse(TypedDict):
    next_token: NotRequired["aws_sdk_connect.types.next_token.NextToken"]
    """<p>If there are additional results, this is the token for the next set of results.</p>"""
    workspace_page_list: "aws_sdk_connect.types.workspace_page_list.WorkspacePageList"
...
def serialize_json(value: ListWorkspacePagesResponse) -> dict:
    ...
    out["WorkspacePageList"] = aws_sdk_connect.types.workspace_page_list.serialize_json(
...
def deserialize_json(data: dict) -> ListWorkspacePagesResponse:
    ...
    if "WorkspacePageList" in data:
        ...
        out["workspace_page_list"] = (
            aws_sdk_connect.types.workspace_page_list.deserialize_json(
