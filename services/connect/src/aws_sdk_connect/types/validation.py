...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.length_boundary
    import aws_sdk_connect.types.positive_and_negative_double
    import aws_sdk_connect.types.positive_double
    import aws_sdk_connect.types.validation_enum
...
class Validation(TypedDict):
    ...
    min_values: "aws_sdk_connect.types.value_boundary.ValueBoundary"
    ...
    max_values: "aws_sdk_connect.types.value_boundary.ValueBoundary"
    ...
    ignore_case: "aws_sdk_connect.types.boolean.Boolean"
    ...
    minimum: (
        "aws_sdk_connect.types.positive_and_negative_double.PositiveAndNegativeDouble"
    )
    ...
    multiple_of: "aws_sdk_connect.types.positive_double.PositiveDouble"
    ...
    enum: NotRequired["aws_sdk_connect.types.validation_enum.ValidationEnum"]
...
def serialize_json(value: Validation) -> dict:
    ...
    if "enum" in value:
        ...
        out["Enum"] = aws_sdk_connect.types.validation_enum.serialize_json(
            value["enum"]
        )
    return out
...
def deserialize_json(data: dict) -> Validation:
    ...
    if "Enum" in data:
        ...
        out["enum"] = aws_sdk_connect.types.validation_enum.deserialize_json(
            data["Enum"]
        )
    return out
