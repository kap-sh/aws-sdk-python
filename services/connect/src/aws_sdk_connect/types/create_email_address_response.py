"""Generated from Smithy shape ``com.amazonaws.connect#CreateEmailAddressResponse``."""
...
class CreateEmailAddressResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateEmailAddressResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateEmailAddressResponse:
    out: CreateEmailAddressResponse = {}  # type: ignore[typeddict-item]
