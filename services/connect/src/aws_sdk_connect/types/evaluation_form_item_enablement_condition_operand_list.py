...
if TYPE_CHECKING:
    import aws_sdk_connect.types.evaluation_form_item_enablement_condition_operand

EvaluationFormItemEnablementConditionOperandList: TypeAlias = list[
    "aws_sdk_connect.types.evaluation_form_item_enablement_condition_operand.EvaluationFormItemEnablementConditionOperand"
]
...
def serialize_json(value: EvaluationFormItemEnablementConditionOperandList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_connect.types.evaluation_form_item_enablement_condition_operand.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> EvaluationFormItemEnablementConditionOperandList:
    ...
    for item in data:
        out.append(
            aws_sdk_connect.types.evaluation_form_item_enablement_condition_operand.deserialize_json(
                item
            )
        )
    return out
