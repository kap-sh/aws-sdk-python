...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.test_case_search_criteria
    import aws_sdk_connect.types.test_case_search_filter


class SearchTestCasesRequest(TypedDict):
    ...
    search_filter: NotRequired[
        "aws_sdk_connect.types.test_case_search_filter.TestCaseSearchFilter"
    ]
    """<p>Filters to be applied to search results.</p>"""
    search_criteria: NotRequired[
        "aws_sdk_connect.types.test_case_search_criteria.TestCaseSearchCriteria"
    ]
...
def serialize_json(value: SearchTestCasesRequest) -> dict:
    ...
    if "search_filter" in value:
        ...
        out["SearchFilter"] = (
            aws_sdk_connect.types.test_case_search_filter.serialize_json(
                value["search_filter"]
            )
        )
    if "search_criteria" in value:
        ...
        out["SearchCriteria"] = (
            aws_sdk_connect.types.test_case_search_criteria.serialize_json(
...
def deserialize_json(data: dict) -> SearchTestCasesRequest:
    ...
    if "SearchFilter" in data:
        ...
        out["search_filter"] = (
            aws_sdk_connect.types.test_case_search_filter.deserialize_json(
                data["SearchFilter"]
            )
        )
    if "SearchCriteria" in data:
        ...
        out["search_criteria"] = (
            aws_sdk_connect.types.test_case_search_criteria.deserialize_json(
                data["SearchCriteria"]
            )
        )
    return out
