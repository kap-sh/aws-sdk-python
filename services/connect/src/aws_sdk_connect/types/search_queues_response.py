...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.queue_search_summary_list


class SearchQueuesResponse(TypedDict):
    queues: NotRequired[
        "aws_sdk_connect.types.queue_search_summary_list.QueueSearchSummaryList"
    ]
...
def serialize_json(value: SearchQueuesResponse) -> dict:
    ...
    if "queues" in value:
        ...
        out["Queues"] = aws_sdk_connect.types.queue_search_summary_list.serialize_json(
            value["queues"]
        )
...
def deserialize_json(data: dict) -> SearchQueuesResponse:
    ...
    if "Queues" in data:
        ...
        out["queues"] = (
            aws_sdk_connect.types.queue_search_summary_list.deserialize_json(
                data["Queues"]
            )
        )
