...
if TYPE_CHECKING:
    import aws_sdk_connect.types.error_code
    import aws_sdk_connect.types.error_message
    import aws_sdk_connect.types.file_id


class AttachedFileError(TypedDict):
    error_code: NotRequired["aws_sdk_connect.types.error_code.ErrorCode"]
    """<p> Status code describing the failure. </p>"""
    error_message: NotRequired["aws_sdk_connect.types.error_message.ErrorMessage"]
