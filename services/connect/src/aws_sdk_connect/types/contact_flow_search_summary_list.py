...
ContactFlowSearchSummaryList: TypeAlias = list[
    "aws_sdk_connect.types.contact_flow.ContactFlow"
]
...
def serialize_json(value: ContactFlowSearchSummaryList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_connect.types.contact_flow.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> ContactFlowSearchSummaryList:
    ...
    for item in data:
        out.append(aws_sdk_connect.types.contact_flow.deserialize_json(item))
    return out
