...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.empty_field_value
    import aws_sdk_connect.types.field_string_value


class FieldValueUnion(TypedDict):
    boolean_value: "aws_sdk_connect.types.boolean.Boolean"
    """<p>A Boolean number value type.</p>"""
    double_value: NotRequired["aws_sdk_connect.types.double.Double"]
    """<p>A Double number value type.</p>"""
    empty_value: NotRequired["aws_sdk_connect.types.empty_field_value.EmptyFieldValue"]
    """<p>An empty value.</p>"""
    string_value: NotRequired[
        "aws_sdk_connect.types.field_string_value.FieldStringValue"
    ]
...
def serialize_json(value: FieldValueUnion) -> dict:
    ...
    if "empty_value" in value:
        ...
        out["EmptyValue"] = aws_sdk_connect.types.empty_field_value.serialize_json(
            value["empty_value"]
        )
...
def deserialize_json(data: dict) -> FieldValueUnion:
    ...
    if "EmptyValue" in data:
        ...
        out["empty_value"] = aws_sdk_connect.types.empty_field_value.deserialize_json(
            data["EmptyValue"]
        )
