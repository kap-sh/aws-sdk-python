...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.view_input_schema
    import aws_sdk_connect.types.view_template


class ViewContent(TypedDict):
    input_schema: NotRequired["aws_sdk_connect.types.view_input_schema.ViewInputSchema"]
