...
class ListRealtimeContactAnalysisSegmentsV2Request(TypedDict, closed=True):
    ...
    output_type: "aws_sdk_connect.types.real_time_contact_analysis_output_type.RealTimeContactAnalysisOutputType"
    """<p>The Contact Lens output type to be returned.</p>"""
    segment_types: "aws_sdk_connect.types.real_time_contact_analysis_segment_types.RealTimeContactAnalysisSegmentTypes"
...
def serialize_json(value: ListRealtimeContactAnalysisSegmentsV2Request) -> dict:
    ...
    out["OutputType"] = (
        aws_sdk_connect.types.real_time_contact_analysis_output_type.serialize_json(
            value["output_type"]
        )
    )
    import aws_sdk_connect.types.real_time_contact_analysis_segment_types
    ...
    out["SegmentTypes"] = (
        aws_sdk_connect.types.real_time_contact_analysis_segment_types.serialize_json(
            value["segment_types"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> ListRealtimeContactAnalysisSegmentsV2Request:
    ...
    if "OutputType" in data:
        ...
        out["output_type"] = (
            aws_sdk_connect.types.real_time_contact_analysis_output_type.deserialize_json(
                data["OutputType"]
            )
        )
    else:
    ...
    if "SegmentTypes" in data:
        ...
        out["segment_types"] = (
            aws_sdk_connect.types.real_time_contact_analysis_segment_types.deserialize_json(
                data["SegmentTypes"]
            )
        )
    else:
