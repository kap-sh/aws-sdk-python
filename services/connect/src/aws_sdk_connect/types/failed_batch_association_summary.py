...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.workspace_batch_error_message
    import aws_sdk_connect.types.workspace_error_code


class FailedBatchAssociationSummary(TypedDict):
    ...
    error_code: NotRequired[
        "aws_sdk_connect.types.workspace_error_code.WorkspaceErrorCode"
    ]
    """<p>The error code indicating why the association failed.</p>"""
    error_message: NotRequired[
        "aws_sdk_connect.types.workspace_batch_error_message.WorkspaceBatchErrorMessage"
    ]
