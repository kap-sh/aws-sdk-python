...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.platform_name
...
class DeviceInfo(TypedDict, closed=True):
    ...
    platform_version: NotRequired[
        "aws_sdk_connect.types.platform_version.PlatformVersion"
    ]
    """<p>Version of the platform that the participant used for the call.</p>"""
    operating_system: NotRequired[
        "aws_sdk_connect.types.operating_system.OperatingSystem"
    ]
