"""Generated from Smithy shape ``com.amazonaws.connect#ListUserProficienciesRequest``."""
...
class ListUserProficienciesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListUserProficienciesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListUserProficienciesRequest:
    out: ListUserProficienciesRequest = {}  # type: ignore[typeddict-item]
    return out
