...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.decimal_condition
    import aws_sdk_connect.types.evaluation_search_condition_list
    import aws_sdk_connect.types.number_condition
    import aws_sdk_connect.types.string_condition


class EvaluationSearchCriteria(TypedDict):
    or_conditions: NotRequired[
        "aws_sdk_connect.types.evaluation_search_condition_list.EvaluationSearchConditionList"
    ]
    ...
    decimal_condition: NotRequired[
        "aws_sdk_connect.types.decimal_condition.DecimalCondition"
    ]
...
def serialize_json(value: EvaluationSearchCriteria) -> dict:
    ...
    if "or_conditions" in value:
        ...
        out["OrConditions"] = (
            aws_sdk_connect.types.evaluation_search_condition_list.serialize_json(
                value["or_conditions"]
            )
        )
    ...
    if "decimal_condition" in value:
        ...
        out["DecimalCondition"] = (
            aws_sdk_connect.types.decimal_condition.serialize_json(
...
def deserialize_json(data: dict) -> EvaluationSearchCriteria:
    ...
    if "OrConditions" in data:
        ...
        out["or_conditions"] = (
            aws_sdk_connect.types.evaluation_search_condition_list.deserialize_json(
                data["OrConditions"]
            )
        )
    ...
    if "DecimalCondition" in data:
        ...
        out["decimal_condition"] = (
            aws_sdk_connect.types.decimal_condition.deserialize_json(
