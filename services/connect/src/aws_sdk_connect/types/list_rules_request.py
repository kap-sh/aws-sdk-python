...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.max_result200
...
class ListRulesRequest(TypedDict, closed=True):
    ...
    publish_status: NotRequired[
        "aws_sdk_connect.types.rule_publish_status.RulePublishStatus"
    ]
    """<p>The publish status of the rule.</p>"""
    event_source_name: NotRequired[
        "aws_sdk_connect.types.event_source_name.EventSourceName"
    ]
    """<p>The name of the event source.</p>"""
    max_results: NotRequired["aws_sdk_connect.types.max_result200.MaxResult200"]
