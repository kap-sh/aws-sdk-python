...
if TYPE_CHECKING:
    import aws_sdk_connect.types.instance_storage_configs
    import aws_sdk_connect.types.next_token


class ListInstanceStorageConfigsResponse(TypedDict):
    storage_configs: NotRequired[
        "aws_sdk_connect.types.instance_storage_configs.InstanceStorageConfigs"
    ]
...
def serialize_json(value: ListInstanceStorageConfigsResponse) -> dict:
    ...
    if "storage_configs" in value:
        ...
        out["StorageConfigs"] = (
            aws_sdk_connect.types.instance_storage_configs.serialize_json(
...
def deserialize_json(data: dict) -> ListInstanceStorageConfigsResponse:
    ...
    if "StorageConfigs" in data:
        ...
        out["storage_configs"] = (
            aws_sdk_connect.types.instance_storage_configs.deserialize_json(
                data["StorageConfigs"]
            )
        )
