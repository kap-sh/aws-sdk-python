...
def serialize_json(value: SecurityProfileSearchCriteria) -> dict:
    ...
    if "or_conditions" in value:
        ...
        out["OrConditions"] = (
            aws_sdk_connect.types.security_profile_search_condition_list.serialize_json(
                value["or_conditions"]
            )
        )
...
def deserialize_json(data: dict) -> SecurityProfileSearchCriteria:
    ...
    if "OrConditions" in data:
        ...
        out["or_conditions"] = (
            aws_sdk_connect.types.security_profile_search_condition_list.deserialize_json(
                data["OrConditions"]
            )
        )
