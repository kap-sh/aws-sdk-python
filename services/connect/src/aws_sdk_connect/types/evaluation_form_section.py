...
if TYPE_CHECKING:
    ...
    import aws_sdk_connect.types.evaluation_form_section_title
    import aws_sdk_connect.types.reference_id


class EvaluationFormSection(TypedDict):
    title: (
        "aws_sdk_connect.types.evaluation_form_section_title.EvaluationFormSectionTitle"
    )
