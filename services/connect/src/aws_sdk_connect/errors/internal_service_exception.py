"""Generated from Smithy shape ``com.amazonaws.connect#InternalServiceException``."""
...
class InternalServiceException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.connect#InternalServiceException``."""
