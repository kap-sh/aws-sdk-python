...
class ConnectError(Exception):
    """Base class for all Connect service errors."""


class ServiceError(ConnectError):
...
class SerializationError(ConnectError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ConnectError):
...
class WaiterFailedError(ConnectError):
...
class WaiterTimeoutError(ConnectError):
