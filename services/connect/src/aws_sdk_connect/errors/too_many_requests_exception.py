"""Generated from Smithy shape ``com.amazonaws.connect#TooManyRequestsException``."""
...
class TooManyRequestsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.connect#TooManyRequestsException``."""
