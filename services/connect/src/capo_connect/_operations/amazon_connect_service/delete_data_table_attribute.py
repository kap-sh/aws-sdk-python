...
import capo_connect.types.delete_data_table_attribute_request
import capo_connect.types.delete_data_table_attribute_response
...
) -> capo_connect.types.delete_data_table_attribute_response.DeleteDataTableAttributeResponse:
    out: capo_connect.types.delete_data_table_attribute_response.DeleteDataTableAttributeResponse = capo_connect.types.delete_data_table_attribute_response.deserialize_json(
