...
import capo_connect.types.update_participant_role_config_request
import capo_connect.types.update_participant_role_config_response
...
def handle_response(
    ...
    out: capo_connect.types.update_participant_role_config_response.UpdateParticipantRoleConfigResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_participant_role_config_request.serialize_json(input_)
    ).encode()
