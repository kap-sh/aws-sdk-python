...
import capo_connect.types.contact_flow_module_version_summary_list
import capo_connect.types.list_contact_flow_module_versions_request
import capo_connect.types.list_contact_flow_module_versions_response
...
def handle_response(
    ...
    out: capo_connect.types.list_contact_flow_module_versions_response.ListContactFlowModuleVersionsResponse = capo_connect.types.list_contact_flow_module_versions_response.deserialize_json(
