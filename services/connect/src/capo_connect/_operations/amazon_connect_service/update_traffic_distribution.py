...
import capo_connect.types.update_traffic_distribution_request
import capo_connect.types.update_traffic_distribution_response
...
def handle_response(
    ...
    out: capo_connect.types.update_traffic_distribution_response.UpdateTrafficDistributionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_traffic_distribution_request.serialize_json(input_)
    ).encode()
