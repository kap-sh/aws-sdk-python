"""Generated from Smithy shape ``com.amazonaws.connect#DescribeView``."""
...
import capo_connect.types.describe_view_request
import capo_connect.types.describe_view_response
...
) -> capo_connect.types.describe_view_response.DescribeViewResponse:
    out: capo_connect.types.describe_view_response.DescribeViewResponse = (
        capo_connect.types.describe_view_response.deserialize_json(
...
def describe_view(
    ...
    capo_connect.types.describe_view_response.DescribeViewResponse, zapros.Response
]:
