...
def handle_response(
    ...
    out: capo_connect.types.create_rule_response.CreateRuleResponse = (
        capo_connect.types.create_rule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_rule_request.serialize_json(input_)
    ).encode()
...
def create_rule(
    ...
    input_: capo_connect.types.create_rule_request.CreateRuleRequest,
) -> tuple[capo_connect.types.create_rule_response.CreateRuleResponse, zapros.Response]:
