...
import capo_connect.types.list_test_case_execution_records_request
import capo_connect.types.list_test_case_execution_records_response
...
) -> capo_connect.types.list_test_case_execution_records_response.ListTestCaseExecutionRecordsResponse:
    out: capo_connect.types.list_test_case_execution_records_response.ListTestCaseExecutionRecordsResponse = capo_connect.types.list_test_case_execution_records_response.deserialize_json(
