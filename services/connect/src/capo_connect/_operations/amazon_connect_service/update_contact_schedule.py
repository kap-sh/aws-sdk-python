...
def handle_response(
    ...
    out: capo_connect.types.update_contact_schedule_response.UpdateContactScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_contact_schedule_request.serialize_json(input_)
    ).encode()
