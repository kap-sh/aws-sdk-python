"""Generated from Smithy shape ``com.amazonaws.connect#DescribeContactEvaluation``."""
...
import capo_connect.types.describe_contact_evaluation_request
import capo_connect.types.describe_contact_evaluation_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_contact_evaluation_response.DescribeContactEvaluationResponse = capo_connect.types.describe_contact_evaluation_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/contact-evaluations/{InstanceId}/{EvaluationId}"
...
async def async_describe_contact_evaluation(
