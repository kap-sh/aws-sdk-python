"""Generated from Smithy shape ``com.amazonaws.connect#AssociateAnalyticsDataSet``."""
...
import capo_connect.types.associate_analytics_data_set_request
import capo_connect.types.associate_analytics_data_set_response
...
def handle_response(
    ...
    out: capo_connect.types.associate_analytics_data_set_response.AssociateAnalyticsDataSetResponse = capo_connect.types.associate_analytics_data_set_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/analytics-data/instance/{InstanceId}/association"
    url = url.replace("{InstanceId}", quote(str(input_["instance_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_connect.types.associate_analytics_data_set_request.serialize_json(input_)
    ).encode()
...
async def async_associate_analytics_data_set(
