...
import capo_connect.types.list_default_vocabularies_request
...
def handle_response(
    ...
    out: capo_connect.types.list_default_vocabularies_response.ListDefaultVocabulariesResponse = capo_connect.types.list_default_vocabularies_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.list_default_vocabularies_request.serialize_json(input_)
    ).encode()
