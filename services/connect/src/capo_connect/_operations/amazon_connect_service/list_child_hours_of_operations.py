"""Generated from Smithy shape ``com.amazonaws.connect#ListChildHoursOfOperations``."""
...
import capo_connect.types.child_hours_of_operations_list
import capo_connect.types.list_child_hours_of_operations_request
import capo_connect.types.list_child_hours_of_operations_response
...
def handle_response(
    ...
    out: capo_connect.types.list_child_hours_of_operations_response.ListChildHoursOfOperationsResponse = capo_connect.types.list_child_hours_of_operations_response.deserialize_json(
...
async def async_list_child_hours_of_operations(
