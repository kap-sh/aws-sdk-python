"""Generated from Smithy shape ``com.amazonaws.connect#CreateUseCase``."""
...
import capo_connect.types.create_use_case_request
import capo_connect.types.create_use_case_response
...
def handle_response(
    ...
    out: capo_connect.types.create_use_case_response.CreateUseCaseResponse = (
        capo_connect.types.create_use_case_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_use_case_request.serialize_json(input_)
    ).encode()
...
def create_use_case(
    ...
    capo_connect.types.create_use_case_response.CreateUseCaseResponse, zapros.Response
]:
...
async def async_create_use_case(
