"""Generated from Smithy shape ``com.amazonaws.connect#ListEvaluationForms``."""
...
import capo_connect.types.evaluation_form_summary_list
...
def handle_response(
    ...
    out: capo_connect.types.list_evaluation_forms_response.ListEvaluationFormsResponse = capo_connect.types.list_evaluation_forms_response.deserialize_json(
...
async def async_list_evaluation_forms(
