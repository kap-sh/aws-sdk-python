...
import capo_connect.types.delete_view_request
import capo_connect.types.delete_view_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_view_response.DeleteViewResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_view(
    ...
    input_: capo_connect.types.delete_view_request.DeleteViewRequest,
) -> tuple[capo_connect.types.delete_view_response.DeleteViewResponse, zapros.Response]:
