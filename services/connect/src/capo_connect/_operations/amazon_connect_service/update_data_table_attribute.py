...
) -> capo_connect.types.update_data_table_attribute_response.UpdateDataTableAttributeResponse:
    out: capo_connect.types.update_data_table_attribute_response.UpdateDataTableAttributeResponse = capo_connect.types.update_data_table_attribute_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_data_table_attribute_request.serialize_json(input_)
    ).encode()
