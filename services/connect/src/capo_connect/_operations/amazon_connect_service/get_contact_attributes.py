...
import capo_connect.types.get_contact_attributes_request
...
) -> capo_connect.types.get_contact_attributes_response.GetContactAttributesResponse:
    out: capo_connect.types.get_contact_attributes_response.GetContactAttributesResponse = capo_connect.types.get_contact_attributes_response.deserialize_json(
