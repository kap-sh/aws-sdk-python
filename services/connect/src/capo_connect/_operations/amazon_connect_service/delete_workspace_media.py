...
import capo_connect.types.delete_workspace_media_request
import capo_connect.types.delete_workspace_media_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_workspace_media_response.DeleteWorkspaceMediaResponse = {}  # type: ignore[typeddict-item]
    return out
