...
import capo_connect.types.update_routing_profile_agent_availability_timer_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_routing_profile_agent_availability_timer_request.serialize_json(
            input_
        )
    ).encode()
