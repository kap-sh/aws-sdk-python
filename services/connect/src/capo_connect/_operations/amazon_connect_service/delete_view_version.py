...
import capo_connect.types.delete_view_version_request
import capo_connect.types.delete_view_version_response
...
) -> capo_connect.types.delete_view_version_response.DeleteViewVersionResponse:
    out: capo_connect.types.delete_view_version_response.DeleteViewVersionResponse = {}  # type: ignore[typeddict-item]
    return out
