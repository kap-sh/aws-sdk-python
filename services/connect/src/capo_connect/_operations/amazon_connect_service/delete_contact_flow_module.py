"""Generated from Smithy shape ``com.amazonaws.connect#DeleteContactFlowModule``."""
...
import capo_connect.types.delete_contact_flow_module_request
import capo_connect.types.delete_contact_flow_module_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_contact_flow_module_response.DeleteContactFlowModuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_contact_flow_module(
