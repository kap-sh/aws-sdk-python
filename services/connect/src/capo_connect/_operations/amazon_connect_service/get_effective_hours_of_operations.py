...
) -> capo_connect.types.get_effective_hours_of_operations_response.GetEffectiveHoursOfOperationsResponse:
    out: capo_connect.types.get_effective_hours_of_operations_response.GetEffectiveHoursOfOperationsResponse = capo_connect.types.get_effective_hours_of_operations_response.deserialize_json(
