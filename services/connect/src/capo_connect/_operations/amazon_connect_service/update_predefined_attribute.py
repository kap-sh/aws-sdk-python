"""Generated from Smithy shape ``com.amazonaws.connect#UpdatePredefinedAttribute``."""
...
import capo_connect.types.update_predefined_attribute_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/predefined-attributes/{InstanceId}/{Name}"
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_predefined_attribute_request.serialize_json(input_)
    ).encode()
...
async def async_update_predefined_attribute(
