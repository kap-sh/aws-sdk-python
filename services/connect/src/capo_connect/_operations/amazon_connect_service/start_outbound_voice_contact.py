...
import capo_connect.errors.destination_not_allowed_exception
...
import capo_connect.errors.limit_exceeded_exception
import capo_connect.errors.outbound_contact_not_permitted_exception
...
import capo_connect.types.start_outbound_voice_contact_request
import capo_connect.types.start_outbound_voice_contact_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DestinationNotAllowedException":
            raise capo_connect.errors.destination_not_allowed_exception.DestinationNotAllowedException.from_json(
                data
            )
        ...
        case "LimitExceededException":
            raise capo_connect.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
        case "OutboundContactNotPermittedException":
            raise capo_connect.errors.outbound_contact_not_permitted_exception.OutboundContactNotPermittedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_connect.types.start_outbound_voice_contact_response.StartOutboundVoiceContactResponse = capo_connect.types.start_outbound_voice_contact_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.start_outbound_voice_contact_request.serialize_json(input_)
    ).encode()
