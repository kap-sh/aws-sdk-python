...
import capo_connect.types.list_queue_email_addresses_request
import capo_connect.types.list_queue_email_addresses_response
...
def handle_response(
    ...
    out: capo_connect.types.list_queue_email_addresses_response.ListQueueEmailAddressesResponse = capo_connect.types.list_queue_email_addresses_response.deserialize_json(
