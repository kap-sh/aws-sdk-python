...
import capo_connect.types.create_routing_profile_request
import capo_connect.types.create_routing_profile_response
...
def handle_response(
    ...
    out: capo_connect.types.create_routing_profile_response.CreateRoutingProfileResponse = capo_connect.types.create_routing_profile_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_routing_profile_request.serialize_json(input_)
    ).encode()
