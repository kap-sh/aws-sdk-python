...
import capo_connect.types.quick_connect_search_filter
import capo_connect.types.quick_connect_search_summary_list
import capo_connect.types.search_quick_connects_request
import capo_connect.types.search_quick_connects_response
...
def handle_response(
    ...
    out: capo_connect.types.search_quick_connects_response.SearchQuickConnectsResponse = capo_connect.types.search_quick_connects_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_quick_connects_request.serialize_json(input_)
    ).encode()
