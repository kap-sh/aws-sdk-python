"""Generated from Smithy shape ``com.amazonaws.connect#DescribeEmailAddress``."""
...
import capo_connect.types.describe_email_address_request
...
def handle_response(
    ...
    out: capo_connect.types.describe_email_address_response.DescribeEmailAddressResponse = capo_connect.types.describe_email_address_response.deserialize_json(
...
async def async_describe_email_address(
