...
import capo_connect.types.list_data_table_attributes_request
import capo_connect.types.list_data_table_attributes_response
...
) -> capo_connect.types.list_data_table_attributes_response.ListDataTableAttributesResponse:
    out: capo_connect.types.list_data_table_attributes_response.ListDataTableAttributesResponse = capo_connect.types.list_data_table_attributes_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.list_data_table_attributes_request.serialize_json(input_)
    ).encode()
