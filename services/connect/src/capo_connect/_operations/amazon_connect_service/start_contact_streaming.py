...
import capo_connect.types.start_contact_streaming_request
...
def handle_response(
    ...
    out: capo_connect.types.start_contact_streaming_response.StartContactStreamingResponse = capo_connect.types.start_contact_streaming_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.start_contact_streaming_request.serialize_json(input_)
    ).encode()
