...
import capo_connect.types.associate_instance_storage_config_request
import capo_connect.types.associate_instance_storage_config_response
...
def handle_response(
    ...
    out: capo_connect.types.associate_instance_storage_config_response.AssociateInstanceStorageConfigResponse = capo_connect.types.associate_instance_storage_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.associate_instance_storage_config_request.serialize_json(
            input_
        )
    ).encode()
