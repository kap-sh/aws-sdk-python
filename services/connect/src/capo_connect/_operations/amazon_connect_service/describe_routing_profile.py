...
import capo_connect.types.describe_routing_profile_request
import capo_connect.types.describe_routing_profile_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_routing_profile_response.DescribeRoutingProfileResponse = capo_connect.types.describe_routing_profile_response.deserialize_json(
