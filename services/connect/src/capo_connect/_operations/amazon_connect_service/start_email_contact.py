...
def handle_response(
    ...
    out: capo_connect.types.start_email_contact_response.StartEmailContactResponse = (
        capo_connect.types.start_email_contact_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.start_email_contact_request.serialize_json(input_)
    ).encode()
