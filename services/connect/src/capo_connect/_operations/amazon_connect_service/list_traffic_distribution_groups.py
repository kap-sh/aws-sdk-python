...
import capo_connect.types.list_traffic_distribution_groups_request
import capo_connect.types.list_traffic_distribution_groups_response
import capo_connect.types.traffic_distribution_group_summary_list
...
def handle_response(
    ...
    out: capo_connect.types.list_traffic_distribution_groups_response.ListTrafficDistributionGroupsResponse = capo_connect.types.list_traffic_distribution_groups_response.deserialize_json(
