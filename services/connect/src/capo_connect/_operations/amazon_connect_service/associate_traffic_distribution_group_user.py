"""Generated from Smithy shape ``com.amazonaws.connect#AssociateTrafficDistributionGroupUser``."""
...
import capo_connect.types.associate_traffic_distribution_group_user_request
import capo_connect.types.associate_traffic_distribution_group_user_response
...
def handle_response(
    ...
    out: capo_connect.types.associate_traffic_distribution_group_user_response.AssociateTrafficDistributionGroupUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.associate_traffic_distribution_group_user_request.serialize_json(
            input_
        )
    ).encode()
