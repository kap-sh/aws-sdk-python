...
import capo_connect.types.evaluation_summary_list
import capo_connect.types.list_contact_evaluations_request
import capo_connect.types.list_contact_evaluations_response
...
def handle_response(
    ...
    out: capo_connect.types.list_contact_evaluations_response.ListContactEvaluationsResponse = capo_connect.types.list_contact_evaluations_response.deserialize_json(
