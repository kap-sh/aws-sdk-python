"""Generated from Smithy shape ``com.amazonaws.connect#DescribeInstance``."""
...
import capo_connect.types.describe_instance_request
...
def handle_response(
    ...
    out: capo_connect.types.describe_instance_response.DescribeInstanceResponse = (
        capo_connect.types.describe_instance_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}"
...
async def async_describe_instance(
