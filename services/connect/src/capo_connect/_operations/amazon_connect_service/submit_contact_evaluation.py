"""Generated from Smithy shape ``com.amazonaws.connect#SubmitContactEvaluation``."""
...
import capo_connect.types.submit_contact_evaluation_request
import capo_connect.types.submit_contact_evaluation_response
...
def handle_response(
    ...
    out: capo_connect.types.submit_contact_evaluation_response.SubmitContactEvaluationResponse = capo_connect.types.submit_contact_evaluation_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{EvaluationId}", quote(str(input_["evaluation_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_connect.types.submit_contact_evaluation_request.serialize_json(input_)
    ).encode()
...
async def async_submit_contact_evaluation(
