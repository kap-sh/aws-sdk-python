...
import capo_connect.types.delete_data_table_request
import capo_connect.types.delete_data_table_response
...
) -> capo_connect.types.delete_data_table_response.DeleteDataTableResponse:
    out: capo_connect.types.delete_data_table_response.DeleteDataTableResponse = {}  # type: ignore[typeddict-item]
    return out
