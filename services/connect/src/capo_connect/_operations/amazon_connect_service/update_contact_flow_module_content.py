"""Generated from Smithy shape ``com.amazonaws.connect#UpdateContactFlowModuleContent``."""
...
import capo_connect.types.update_contact_flow_module_content_request
import capo_connect.types.update_contact_flow_module_content_response
...
def handle_response(
    ...
    out: capo_connect.types.update_contact_flow_module_content_response.UpdateContactFlowModuleContentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_contact_flow_module_content_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_contact_flow_module_content(
