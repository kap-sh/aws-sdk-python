"""Generated from Smithy shape ``com.amazonaws.connect#BatchDeleteDataTableValue``."""
...
import capo_connect.types.batch_delete_data_table_value_request
import capo_connect.types.batch_delete_data_table_value_response
...
) -> capo_connect.types.batch_delete_data_table_value_response.BatchDeleteDataTableValueResponse:
    out: capo_connect.types.batch_delete_data_table_value_response.BatchDeleteDataTableValueResponse = capo_connect.types.batch_delete_data_table_value_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.batch_delete_data_table_value_request.serialize_json(input_)
    ).encode()
...
async def async_batch_delete_data_table_value(
