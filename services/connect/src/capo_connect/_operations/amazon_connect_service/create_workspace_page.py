...
import capo_connect.types.create_workspace_page_request
import capo_connect.types.create_workspace_page_response
...
def handle_response(
    ...
    out: capo_connect.types.create_workspace_page_response.CreateWorkspacePageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_workspace_page_request.serialize_json(input_)
    ).encode()
