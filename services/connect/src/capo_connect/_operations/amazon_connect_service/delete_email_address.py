"""Generated from Smithy shape ``com.amazonaws.connect#DeleteEmailAddress``."""
...
def handle_response(
    ...
    out: capo_connect.types.delete_email_address_response.DeleteEmailAddressResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_email_address(
