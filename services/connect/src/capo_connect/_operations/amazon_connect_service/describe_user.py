"""Generated from Smithy shape ``com.amazonaws.connect#DescribeUser``."""
...
import capo_connect.types.describe_user_request
import capo_connect.types.describe_user_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_user_response.DescribeUserResponse = (
        capo_connect.types.describe_user_response.deserialize_json(
...
def describe_user(
    ...
    capo_connect.types.describe_user_response.DescribeUserResponse, zapros.Response
]:
