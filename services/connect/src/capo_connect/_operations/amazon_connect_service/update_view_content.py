...
import capo_connect.types.update_view_content_request
import capo_connect.types.update_view_content_response
...
) -> capo_connect.types.update_view_content_response.UpdateViewContentResponse:
    out: capo_connect.types.update_view_content_response.UpdateViewContentResponse = (
        capo_connect.types.update_view_content_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_view_content_request.serialize_json(input_)
    ).encode()
