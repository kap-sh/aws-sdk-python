"""Generated from Smithy shape ``com.amazonaws.connect#GetFederationToken``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UserNotFoundException":
            raise capo_connect.errors.user_not_found_exception.UserNotFoundException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_connect.types.get_federation_token_response.GetFederationTokenResponse = (
        capo_connect.types.get_federation_token_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/user/federate/{InstanceId}"
