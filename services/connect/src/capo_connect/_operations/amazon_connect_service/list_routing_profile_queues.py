...
import capo_connect.types.list_routing_profile_queues_request
import capo_connect.types.list_routing_profile_queues_response
import capo_connect.types.routing_profile_queue_config_summary_list
...
def handle_response(
    ...
    out: capo_connect.types.list_routing_profile_queues_response.ListRoutingProfileQueuesResponse = capo_connect.types.list_routing_profile_queues_response.deserialize_json(
