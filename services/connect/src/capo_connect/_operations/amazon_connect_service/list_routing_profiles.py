"""Generated from Smithy shape ``com.amazonaws.connect#ListRoutingProfiles``."""
...
import capo_connect.types.list_routing_profiles_request
import capo_connect.types.list_routing_profiles_response
import capo_connect.types.routing_profile_summary_list
...
def handle_response(
    ...
    out: capo_connect.types.list_routing_profiles_response.ListRoutingProfilesResponse = capo_connect.types.list_routing_profiles_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/routing-profiles-summary/{InstanceId}"
...
async def async_list_routing_profiles(
