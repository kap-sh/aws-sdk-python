...
def handle_response(
    ...
    out: capo_connect.types.list_flow_associations_response.ListFlowAssociationsResponse = capo_connect.types.list_flow_associations_response.deserialize_json(
