"""Generated from Smithy shape ``com.amazonaws.connect#ListContactReferences``."""
...
import capo_connect.types.list_contact_references_request
import capo_connect.types.list_contact_references_response
import capo_connect.types.reference_summary_list
...
def handle_response(
    ...
    out: capo_connect.types.list_contact_references_response.ListContactReferencesResponse = capo_connect.types.list_contact_references_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/contact/references/{InstanceId}/{ContactId}"
    url = url.replace("{InstanceId}", quote(str(input_["instance_id"]), safe=""))
    url = url.replace("{ContactId}", quote(str(input_["contact_id"]), safe=""))
    params: dict[str, str] = {}
    if "reference_types" in input_:
        params["referenceTypes"] = str(input_["reference_types"])
...
async def async_list_contact_references(
