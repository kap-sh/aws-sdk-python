...
import capo_connect.types.describe_agent_status_request
import capo_connect.types.describe_agent_status_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_agent_status_response.DescribeAgentStatusResponse = capo_connect.types.describe_agent_status_response.deserialize_json(
