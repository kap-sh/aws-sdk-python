"""Generated from Smithy shape ``com.amazonaws.connect#ListViews``."""
...
import capo_connect.types.list_views_request
import capo_connect.types.list_views_response
import capo_connect.types.view_type
import capo_connect.types.views_summary_list
...
) -> capo_connect.types.list_views_response.ListViewsResponse:
    out: capo_connect.types.list_views_response.ListViewsResponse = (
        capo_connect.types.list_views_response.deserialize_json(
...
def list_views(
    ...
    input_: capo_connect.types.list_views_request.ListViewsRequest,
) -> tuple[capo_connect.types.list_views_response.ListViewsResponse, zapros.Response]:
