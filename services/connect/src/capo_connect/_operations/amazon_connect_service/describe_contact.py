"""Generated from Smithy shape ``com.amazonaws.connect#DescribeContact``."""
...
import capo_connect.types.describe_contact_request
import capo_connect.types.describe_contact_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_contact_response.DescribeContactResponse = (
        capo_connect.types.describe_contact_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/contacts/{InstanceId}/{ContactId}"
...
async def async_describe_contact(
