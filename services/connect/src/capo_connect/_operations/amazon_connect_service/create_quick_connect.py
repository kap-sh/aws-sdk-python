...
import capo_connect.types.create_quick_connect_request
import capo_connect.types.create_quick_connect_response
...
def handle_response(
    ...
    out: capo_connect.types.create_quick_connect_response.CreateQuickConnectResponse = (
        capo_connect.types.create_quick_connect_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_quick_connect_request.serialize_json(input_)
    ).encode()
