"""Generated from Smithy shape ``com.amazonaws.connect#ListHoursOfOperations``."""
...
import capo_connect.types.list_hours_of_operations_request
import capo_connect.types.list_hours_of_operations_response
...
def handle_response(
    ...
    out: capo_connect.types.list_hours_of_operations_response.ListHoursOfOperationsResponse = capo_connect.types.list_hours_of_operations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/hours-of-operations-summary/{InstanceId}"
...
async def async_list_hours_of_operations(
