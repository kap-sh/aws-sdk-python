"""Generated from Smithy shape ``com.amazonaws.connect#BatchUpdateDataTableValue``."""
...
import capo_connect.types.batch_update_data_table_value_request
import capo_connect.types.batch_update_data_table_value_response
...
) -> capo_connect.types.batch_update_data_table_value_response.BatchUpdateDataTableValueResponse:
    out: capo_connect.types.batch_update_data_table_value_response.BatchUpdateDataTableValueResponse = capo_connect.types.batch_update_data_table_value_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.batch_update_data_table_value_request.serialize_json(input_)
    ).encode()
...
async def async_batch_update_data_table_value(
