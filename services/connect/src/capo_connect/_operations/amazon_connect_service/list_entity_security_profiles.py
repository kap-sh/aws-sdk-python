...
) -> capo_connect.types.list_entity_security_profiles_response.ListEntitySecurityProfilesResponse:
    out: capo_connect.types.list_entity_security_profiles_response.ListEntitySecurityProfilesResponse = capo_connect.types.list_entity_security_profiles_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.list_entity_security_profiles_request.serialize_json(input_)
    ).encode()
