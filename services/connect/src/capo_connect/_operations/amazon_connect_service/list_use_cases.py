...
import capo_connect.types.list_use_cases_request
import capo_connect.types.list_use_cases_response
...
def handle_response(
    ...
    out: capo_connect.types.list_use_cases_response.ListUseCasesResponse = (
        capo_connect.types.list_use_cases_response.deserialize_json(
...
def list_use_cases(
    ...
    capo_connect.types.list_use_cases_response.ListUseCasesResponse, zapros.Response
]:
