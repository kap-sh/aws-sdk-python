...
import capo_connect.types.search_vocabularies_request
import capo_connect.types.search_vocabularies_response
import capo_connect.types.vocabulary_language_code
import capo_connect.types.vocabulary_state
import capo_connect.types.vocabulary_summary_list
...
def handle_response(
    ...
    out: capo_connect.types.search_vocabularies_response.SearchVocabulariesResponse = (
        capo_connect.types.search_vocabularies_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_vocabularies_request.serialize_json(input_)
    ).encode()
