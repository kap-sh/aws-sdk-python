"""Generated from Smithy shape ``com.amazonaws.connect#UpdateQueueOutboundEmailConfig``."""
...
import capo_connect.types.update_queue_outbound_email_config_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_queue_outbound_email_config_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_queue_outbound_email_config(
