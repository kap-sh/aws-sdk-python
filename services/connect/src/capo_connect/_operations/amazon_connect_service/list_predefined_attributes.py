...
import capo_connect.types.list_predefined_attributes_request
import capo_connect.types.list_predefined_attributes_response
...
def handle_response(
    ...
    out: capo_connect.types.list_predefined_attributes_response.ListPredefinedAttributesResponse = capo_connect.types.list_predefined_attributes_response.deserialize_json(
