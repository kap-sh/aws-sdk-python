"""Generated from Smithy shape ``com.amazonaws.connect#DeleteTestCase``."""
...
import capo_connect.types.delete_test_case_response
...
) -> capo_connect.types.delete_test_case_response.DeleteTestCaseResponse:
    out: capo_connect.types.delete_test_case_response.DeleteTestCaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_test_case(
    ...
    capo_connect.types.delete_test_case_response.DeleteTestCaseResponse, zapros.Response
]:
...
async def async_delete_test_case(
