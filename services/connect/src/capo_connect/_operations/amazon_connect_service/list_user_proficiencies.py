"""Generated from Smithy shape ``com.amazonaws.connect#ListUserProficiencies``."""
...
import capo_connect.types.list_user_proficiencies_request
import capo_connect.types.list_user_proficiencies_response
...
) -> capo_connect.types.list_user_proficiencies_response.ListUserProficienciesResponse:
    out: capo_connect.types.list_user_proficiencies_response.ListUserProficienciesResponse = capo_connect.types.list_user_proficiencies_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/users/{InstanceId}/{UserId}/proficiencies"
...
async def async_list_user_proficiencies(
