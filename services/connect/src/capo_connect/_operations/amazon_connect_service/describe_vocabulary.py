"""Generated from Smithy shape ``com.amazonaws.connect#DescribeVocabulary``."""
...
import capo_connect.types.describe_vocabulary_request
import capo_connect.types.describe_vocabulary_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_vocabulary_response.DescribeVocabularyResponse = (
        capo_connect.types.describe_vocabulary_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/vocabulary/{InstanceId}/{VocabularyId}"
...
async def async_describe_vocabulary(
