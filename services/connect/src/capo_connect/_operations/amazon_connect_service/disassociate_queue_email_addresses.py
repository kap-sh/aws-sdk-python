"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateQueueEmailAddresses``."""
...
import capo_connect.types.disassociate_queue_email_addresses_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.disassociate_queue_email_addresses_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_queue_email_addresses(
