...
import capo_connect.types.list_routing_profile_manual_assignment_queues_request
import capo_connect.types.list_routing_profile_manual_assignment_queues_response
...
def handle_response(
    ...
    out: capo_connect.types.list_routing_profile_manual_assignment_queues_response.ListRoutingProfileManualAssignmentQueuesResponse = capo_connect.types.list_routing_profile_manual_assignment_queues_response.deserialize_json(
