...
import capo_connect.types.get_prompt_file_request
import capo_connect.types.get_prompt_file_response
...
def handle_response(
    ...
    out: capo_connect.types.get_prompt_file_response.GetPromptFileResponse = (
        capo_connect.types.get_prompt_file_response.deserialize_json(
...
def get_prompt_file(
    ...
    capo_connect.types.get_prompt_file_response.GetPromptFileResponse, zapros.Response
]:
