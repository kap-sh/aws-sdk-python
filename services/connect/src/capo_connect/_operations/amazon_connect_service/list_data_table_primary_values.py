"""Generated from Smithy shape ``com.amazonaws.connect#ListDataTablePrimaryValues``."""
...
import capo_connect.types.list_data_table_primary_values_request
import capo_connect.types.list_data_table_primary_values_response
import capo_connect.types.primary_attribute_value_filters
import capo_connect.types.primary_values_list
...
) -> capo_connect.types.list_data_table_primary_values_response.ListDataTablePrimaryValuesResponse:
    out: capo_connect.types.list_data_table_primary_values_response.ListDataTablePrimaryValuesResponse = capo_connect.types.list_data_table_primary_values_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.list_data_table_primary_values_request.serialize_json(input_)
    ).encode()
...
async def async_list_data_table_primary_values(
