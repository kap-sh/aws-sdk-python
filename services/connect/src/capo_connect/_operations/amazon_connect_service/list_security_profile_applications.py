...
def handle_response(
    ...
    out: capo_connect.types.list_security_profile_applications_response.ListSecurityProfileApplicationsResponse = capo_connect.types.list_security_profile_applications_response.deserialize_json(
