...
def handle_response(
    ...
    out: capo_connect.types.list_evaluation_form_versions_response.ListEvaluationFormVersionsResponse = capo_connect.types.list_evaluation_form_versions_response.deserialize_json(
