"""Generated from Smithy shape ``com.amazonaws.connect#UpdateRoutingProfileName``."""
...
import capo_connect.types.update_routing_profile_name_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_routing_profile_name_request.serialize_json(input_)
    ).encode()
...
async def async_update_routing_profile_name(
