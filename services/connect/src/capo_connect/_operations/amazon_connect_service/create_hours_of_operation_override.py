"""Generated from Smithy shape ``com.amazonaws.connect#CreateHoursOfOperationOverride``."""
...
def handle_response(
    ...
    out: capo_connect.types.create_hours_of_operation_override_response.CreateHoursOfOperationOverrideResponse = capo_connect.types.create_hours_of_operation_override_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_hours_of_operation_override_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_hours_of_operation_override(
