"""Generated from Smithy shape ``com.amazonaws.connect#ListPhoneNumbersV2``."""
...
import capo_connect.types.list_phone_numbers_v2_request
import capo_connect.types.list_phone_numbers_v2_response
...
def handle_response(
    ...
    out: capo_connect.types.list_phone_numbers_v2_response.ListPhoneNumbersV2Response = capo_connect.types.list_phone_numbers_v2_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/phone-number/list"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_connect.types.list_phone_numbers_v2_request.serialize_json(input_)
    ).encode()
...
async def async_list_phone_numbers_v2(
