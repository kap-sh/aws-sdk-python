...
def handle_response(
    ...
    out: capo_connect.types.describe_instance_storage_config_response.DescribeInstanceStorageConfigResponse = capo_connect.types.describe_instance_storage_config_response.deserialize_json(
