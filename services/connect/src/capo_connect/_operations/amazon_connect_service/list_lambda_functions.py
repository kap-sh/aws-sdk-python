"""Generated from Smithy shape ``com.amazonaws.connect#ListLambdaFunctions``."""
...
import capo_connect.types.list_lambda_functions_request
...
def handle_response(
    ...
    out: capo_connect.types.list_lambda_functions_response.ListLambdaFunctionsResponse = capo_connect.types.list_lambda_functions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/lambda-functions"
...
async def async_list_lambda_functions(
