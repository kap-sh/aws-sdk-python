...
import capo_connect.types.list_users_request
import capo_connect.types.list_users_response
...
def handle_response(
    ...
    out: capo_connect.types.list_users_response.ListUsersResponse = (
        capo_connect.types.list_users_response.deserialize_json(
...
def list_users(
    ...
    input_: capo_connect.types.list_users_request.ListUsersRequest,
) -> tuple[capo_connect.types.list_users_response.ListUsersResponse, zapros.Response]:
