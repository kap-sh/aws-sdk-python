...
import capo_connect.types.describe_prompt_request
import capo_connect.types.describe_prompt_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_prompt_response.DescribePromptResponse = (
        capo_connect.types.describe_prompt_response.deserialize_json(
...
def describe_prompt(
    ...
    capo_connect.types.describe_prompt_response.DescribePromptResponse, zapros.Response
]:
