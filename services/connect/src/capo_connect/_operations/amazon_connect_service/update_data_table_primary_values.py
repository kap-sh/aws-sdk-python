"""Generated from Smithy shape ``com.amazonaws.connect#UpdateDataTablePrimaryValues``."""
...
import capo_connect.errors.conflict_exception
...
import capo_connect.types.update_data_table_primary_values_request
import capo_connect.types.update_data_table_primary_values_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_connect.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
) -> capo_connect.types.update_data_table_primary_values_response.UpdateDataTablePrimaryValuesResponse:
    out: capo_connect.types.update_data_table_primary_values_response.UpdateDataTablePrimaryValuesResponse = capo_connect.types.update_data_table_primary_values_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_data_table_primary_values_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_data_table_primary_values(
