"""Generated from Smithy shape ``com.amazonaws.connect#ListSecurityKeys``."""
...
import capo_connect.types.security_keys_list
...
def handle_response(
    ...
    out: capo_connect.types.list_security_keys_response.ListSecurityKeysResponse = (
        capo_connect.types.list_security_keys_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/security-keys"
...
async def async_list_security_keys(
