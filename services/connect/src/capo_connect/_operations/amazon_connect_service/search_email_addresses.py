"""Generated from Smithy shape ``com.amazonaws.connect#SearchEmailAddresses``."""
...
import capo_connect.types.email_address_list
import capo_connect.types.email_address_search_criteria
import capo_connect.types.email_address_search_filter
import capo_connect.types.search_email_addresses_request
import capo_connect.types.search_email_addresses_response
...
def handle_response(
    ...
    out: capo_connect.types.search_email_addresses_response.SearchEmailAddressesResponse = capo_connect.types.search_email_addresses_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/search-email-addresses"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_connect.types.search_email_addresses_request.serialize_json(input_)
    ).encode()
...
async def async_search_email_addresses(
