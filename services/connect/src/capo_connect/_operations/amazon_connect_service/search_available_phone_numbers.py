"""Generated from Smithy shape ``com.amazonaws.connect#SearchAvailablePhoneNumbers``."""
...
import capo_connect.types.available_numbers_list
import capo_connect.types.phone_number_country_code
import capo_connect.types.phone_number_type
import capo_connect.types.search_available_phone_numbers_request
import capo_connect.types.search_available_phone_numbers_response
...
def handle_response(
    ...
    out: capo_connect.types.search_available_phone_numbers_response.SearchAvailablePhoneNumbersResponse = capo_connect.types.search_available_phone_numbers_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/phone-number/search-available"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_connect.types.search_available_phone_numbers_request.serialize_json(input_)
    ).encode()
