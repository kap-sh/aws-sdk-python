...
import capo_connect.types.pause_contact_request
import capo_connect.types.pause_contact_response
...
) -> capo_connect.types.pause_contact_response.PauseContactResponse:
    out: capo_connect.types.pause_contact_response.PauseContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.pause_contact_request.serialize_json(input_)
    ).encode()
...
def pause_contact(
    ...
    capo_connect.types.pause_contact_response.PauseContactResponse, zapros.Response
]:
