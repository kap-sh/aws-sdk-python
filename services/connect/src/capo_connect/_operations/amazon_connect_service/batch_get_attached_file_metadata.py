"""Generated from Smithy shape ``com.amazonaws.connect#BatchGetAttachedFileMetadata``."""
...
import capo_connect.types.batch_get_attached_file_metadata_request
import capo_connect.types.batch_get_attached_file_metadata_response
...
def handle_response(
    ...
    out: capo_connect.types.batch_get_attached_file_metadata_response.BatchGetAttachedFileMetadataResponse = capo_connect.types.batch_get_attached_file_metadata_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/attached-files/{InstanceId}"
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.batch_get_attached_file_metadata_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_get_attached_file_metadata(
