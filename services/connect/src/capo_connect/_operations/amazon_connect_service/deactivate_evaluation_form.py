"""Generated from Smithy shape ``com.amazonaws.connect#DeactivateEvaluationForm``."""
...
import capo_connect.types.deactivate_evaluation_form_request
import capo_connect.types.deactivate_evaluation_form_response
...
def handle_response(
    ...
    out: capo_connect.types.deactivate_evaluation_form_response.DeactivateEvaluationFormResponse = capo_connect.types.deactivate_evaluation_form_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.deactivate_evaluation_form_request.serialize_json(input_)
    ).encode()
...
async def async_deactivate_evaluation_form(
