"""Generated from Smithy shape ``com.amazonaws.connect#DescribeHoursOfOperation``."""
...
import capo_connect.types.describe_hours_of_operation_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_hours_of_operation_response.DescribeHoursOfOperationResponse = capo_connect.types.describe_hours_of_operation_response.deserialize_json(
...
async def async_describe_hours_of_operation(
