...
import capo_connect.types.delete_workspace_request
import capo_connect.types.delete_workspace_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_workspace_response.DeleteWorkspaceResponse = {}  # type: ignore[typeddict-item]
    return out
