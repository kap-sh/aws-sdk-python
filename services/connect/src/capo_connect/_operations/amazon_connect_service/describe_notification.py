"""Generated from Smithy shape ``com.amazonaws.connect#DescribeNotification``."""
...
def handle_response(
    ...
    out: capo_connect.types.describe_notification_response.DescribeNotificationResponse = capo_connect.types.describe_notification_response.deserialize_json(
...
async def async_describe_notification(
