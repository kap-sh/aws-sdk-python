"""Generated from Smithy shape ``com.amazonaws.connect#CreatePrompt``."""
...
import capo_connect.types.create_prompt_request
import capo_connect.types.create_prompt_response
...
def handle_response(
    ...
    out: capo_connect.types.create_prompt_response.CreatePromptResponse = (
        capo_connect.types.create_prompt_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prompts/{InstanceId}"
    url = url.replace("{InstanceId}", quote(str(input_["instance_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_connect.types.create_prompt_request.serialize_json(input_)
    ).encode()
...
def create_prompt(
    ...
    capo_connect.types.create_prompt_response.CreatePromptResponse, zapros.Response
]:
