"""Generated from Smithy shape ``com.amazonaws.connect#UpdateQueueHoursOfOperation``."""
...
import capo_connect.types.update_queue_hours_of_operation_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/queues/{InstanceId}/{QueueId}/hours-of-operation"
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_queue_hours_of_operation_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_queue_hours_of_operation(
