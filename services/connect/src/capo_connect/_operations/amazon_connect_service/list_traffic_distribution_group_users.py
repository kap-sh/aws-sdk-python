...
import capo_connect.types.list_traffic_distribution_group_users_request
import capo_connect.types.list_traffic_distribution_group_users_response
...
def handle_response(
    ...
    out: capo_connect.types.list_traffic_distribution_group_users_response.ListTrafficDistributionGroupUsersResponse = capo_connect.types.list_traffic_distribution_group_users_response.deserialize_json(
