...
import capo_connect.types.dismiss_user_contact_request
import capo_connect.types.dismiss_user_contact_response
...
def handle_response(
    ...
    out: capo_connect.types.dismiss_user_contact_response.DismissUserContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.dismiss_user_contact_request.serialize_json(input_)
    ).encode()
