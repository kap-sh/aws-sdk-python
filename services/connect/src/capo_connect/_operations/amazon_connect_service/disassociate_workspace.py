...
import capo_connect.types.disassociate_workspace_request
import capo_connect.types.disassociate_workspace_response
...
def handle_response(
    ...
    out: capo_connect.types.disassociate_workspace_response.DisassociateWorkspaceResponse = capo_connect.types.disassociate_workspace_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.disassociate_workspace_request.serialize_json(input_)
    ).encode()
