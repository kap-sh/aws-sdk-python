...
import capo_connect.types.search_prompts_request
import capo_connect.types.search_prompts_response
...
def handle_response(
    ...
    out: capo_connect.types.search_prompts_response.SearchPromptsResponse = (
        capo_connect.types.search_prompts_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_prompts_request.serialize_json(input_)
    ).encode()
...
def search_prompts(
    ...
    capo_connect.types.search_prompts_response.SearchPromptsResponse, zapros.Response
]:
