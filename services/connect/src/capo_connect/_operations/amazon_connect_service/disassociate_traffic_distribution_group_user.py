"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateTrafficDistributionGroupUser``."""
...
import capo_connect.types.disassociate_traffic_distribution_group_user_request
import capo_connect.types.disassociate_traffic_distribution_group_user_response
...
def handle_response(
    ...
    out: capo_connect.types.disassociate_traffic_distribution_group_user_response.DisassociateTrafficDistributionGroupUserResponse = {}  # type: ignore[typeddict-item]
    return out
