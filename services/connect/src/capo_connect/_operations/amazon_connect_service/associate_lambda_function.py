"""Generated from Smithy shape ``com.amazonaws.connect#AssociateLambdaFunction``."""
...
import capo_connect.types.associate_lambda_function_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.associate_lambda_function_request.serialize_json(input_)
    ).encode()
...
async def async_associate_lambda_function(
