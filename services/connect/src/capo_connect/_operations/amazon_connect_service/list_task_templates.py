"""Generated from Smithy shape ``com.amazonaws.connect#ListTaskTemplates``."""
...
import capo_connect.types.list_task_templates_request
import capo_connect.types.list_task_templates_response
...
def handle_response(
    ...
    out: capo_connect.types.list_task_templates_response.ListTaskTemplatesResponse = (
        capo_connect.types.list_task_templates_response.deserialize_json(
...
async def async_list_task_templates(
