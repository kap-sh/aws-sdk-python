"""Generated from Smithy shape ``com.amazonaws.connect#UpdateUserNotificationStatus``."""
...
import capo_connect.types.update_user_notification_status_request
import capo_connect.types.update_user_notification_status_response
...
def handle_response(
    ...
    out: capo_connect.types.update_user_notification_status_response.UpdateUserNotificationStatusResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_user_notification_status_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_user_notification_status(
