...
import capo_connect.types.list_contact_flow_module_aliases_request
import capo_connect.types.list_contact_flow_module_aliases_response
...
def handle_response(
    ...
    out: capo_connect.types.list_contact_flow_module_aliases_response.ListContactFlowModuleAliasesResponse = capo_connect.types.list_contact_flow_module_aliases_response.deserialize_json(
