"""Generated from Smithy shape ``com.amazonaws.connect#UpdateRoutingProfileConcurrency``."""
...
import capo_connect.types.update_routing_profile_concurrency_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_routing_profile_concurrency_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_routing_profile_concurrency(
