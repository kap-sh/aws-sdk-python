...
def handle_response(
    ...
    out: capo_connect.types.update_notification_content_response.UpdateNotificationContentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_notification_content_request.serialize_json(input_)
    ).encode()
