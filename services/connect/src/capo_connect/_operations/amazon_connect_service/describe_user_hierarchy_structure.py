...
import capo_connect.types.describe_user_hierarchy_structure_request
import capo_connect.types.describe_user_hierarchy_structure_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_user_hierarchy_structure_response.DescribeUserHierarchyStructureResponse = capo_connect.types.describe_user_hierarchy_structure_response.deserialize_json(
