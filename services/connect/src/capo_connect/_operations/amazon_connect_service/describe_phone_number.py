"""Generated from Smithy shape ``com.amazonaws.connect#DescribePhoneNumber``."""
...
import capo_connect.types.describe_phone_number_response
...
) -> capo_connect.types.describe_phone_number_response.DescribePhoneNumberResponse:
    out: capo_connect.types.describe_phone_number_response.DescribePhoneNumberResponse = capo_connect.types.describe_phone_number_response.deserialize_json(
...
async def async_describe_phone_number(
