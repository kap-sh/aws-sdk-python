"""Generated from Smithy shape ``com.amazonaws.connect#UpdateUserIdentityInfo``."""
...
import capo_connect.types.update_user_identity_info_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/users/{InstanceId}/{UserId}/identity-info"
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_user_identity_info_request.serialize_json(input_)
    ).encode()
...
async def async_update_user_identity_info(
