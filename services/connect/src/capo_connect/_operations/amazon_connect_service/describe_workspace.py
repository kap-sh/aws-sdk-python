"""Generated from Smithy shape ``com.amazonaws.connect#DescribeWorkspace``."""
...
import capo_connect.types.describe_workspace_request
import capo_connect.types.describe_workspace_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_workspace_response.DescribeWorkspaceResponse = (
        capo_connect.types.describe_workspace_response.deserialize_json(
