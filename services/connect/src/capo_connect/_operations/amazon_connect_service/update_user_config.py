"""Generated from Smithy shape ``com.amazonaws.connect#UpdateUserConfig``."""
...
import capo_connect.types.update_user_config_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/users/{InstanceId}/{UserId}/config"
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_user_config_request.serialize_json(input_)
    ).encode()
