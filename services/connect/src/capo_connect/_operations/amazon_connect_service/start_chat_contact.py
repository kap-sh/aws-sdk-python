"""Generated from Smithy shape ``com.amazonaws.connect#StartChatContact``."""
...
def handle_response(
    ...
    out: capo_connect.types.start_chat_contact_response.StartChatContactResponse = (
        capo_connect.types.start_chat_contact_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.start_chat_contact_request.serialize_json(input_)
    ).encode()
...
async def async_start_chat_contact(
