"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateQueueQuickConnects``."""
...
import capo_connect.types.disassociate_queue_quick_connects_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.disassociate_queue_quick_connects_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_queue_quick_connects(
