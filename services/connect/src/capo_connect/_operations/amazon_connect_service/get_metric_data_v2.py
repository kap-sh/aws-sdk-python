...
import capo_connect.types.get_metric_data_v2_request
import capo_connect.types.get_metric_data_v2_response
...
def handle_response(
    ...
    out: capo_connect.types.get_metric_data_v2_response.GetMetricDataV2Response = (
        capo_connect.types.get_metric_data_v2_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.get_metric_data_v2_request.serialize_json(input_)
    ).encode()
