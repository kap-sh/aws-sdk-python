...
def handle_response(
    ...
    out: capo_connect.types.search_hours_of_operations_response.SearchHoursOfOperationsResponse = capo_connect.types.search_hours_of_operations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_hours_of_operations_request.serialize_json(input_)
    ).encode()
