"""Generated from Smithy shape ``com.amazonaws.connect#BatchAssociateAnalyticsDataSet``."""
...
import capo_connect.types.batch_associate_analytics_data_set_request
import capo_connect.types.batch_associate_analytics_data_set_response
...
def handle_response(
    ...
    out: capo_connect.types.batch_associate_analytics_data_set_response.BatchAssociateAnalyticsDataSetResponse = capo_connect.types.batch_associate_analytics_data_set_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.batch_associate_analytics_data_set_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_associate_analytics_data_set(
