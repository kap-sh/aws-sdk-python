...
import capo_connect.types.describe_authentication_profile_request
import capo_connect.types.describe_authentication_profile_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_authentication_profile_response.DescribeAuthenticationProfileResponse = capo_connect.types.describe_authentication_profile_response.deserialize_json(
