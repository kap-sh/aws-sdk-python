...
import capo_connect.types.create_contact_flow_module_version_request
import capo_connect.types.create_contact_flow_module_version_response
...
def handle_response(
    ...
    out: capo_connect.types.create_contact_flow_module_version_response.CreateContactFlowModuleVersionResponse = capo_connect.types.create_contact_flow_module_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_contact_flow_module_version_request.serialize_json(
            input_
        )
    ).encode()
