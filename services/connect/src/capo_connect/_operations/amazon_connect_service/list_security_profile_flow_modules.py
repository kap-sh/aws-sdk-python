...
import capo_connect.types.list_security_profile_flow_modules_response
...
def handle_response(
    ...
    out: capo_connect.types.list_security_profile_flow_modules_response.ListSecurityProfileFlowModulesResponse = capo_connect.types.list_security_profile_flow_modules_response.deserialize_json(
