"""Generated from Smithy shape ``com.amazonaws.connect#ListRealtimeContactAnalysisSegmentsV2``."""
...
import capo_connect.errors.output_type_not_found_exception
import capo_connect.errors.resource_not_found_exception
import capo_connect.errors.throttling_exception
import capo_connect.types.list_realtime_contact_analysis_segments_v2_request
import capo_connect.types.list_realtime_contact_analysis_segments_v2_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OutputTypeNotFoundException":
            raise capo_connect.errors.output_type_not_found_exception.OutputTypeNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_connect.types.list_realtime_contact_analysis_segments_v2_response.ListRealtimeContactAnalysisSegmentsV2Response = capo_connect.types.list_realtime_contact_analysis_segments_v2_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.list_realtime_contact_analysis_segments_v2_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_realtime_contact_analysis_segments_v2(
