...
import capo_connect.types.delete_workspace_page_request
import capo_connect.types.delete_workspace_page_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_workspace_page_response.DeleteWorkspacePageResponse = {}  # type: ignore[typeddict-item]
    return out
