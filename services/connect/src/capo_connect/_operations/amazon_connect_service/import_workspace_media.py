...
import capo_connect.types.import_workspace_media_request
import capo_connect.types.import_workspace_media_response
...
def handle_response(
    ...
    out: capo_connect.types.import_workspace_media_response.ImportWorkspaceMediaResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.import_workspace_media_request.serialize_json(input_)
    ).encode()
