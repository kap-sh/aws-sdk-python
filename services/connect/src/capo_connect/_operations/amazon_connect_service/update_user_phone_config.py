"""Generated from Smithy shape ``com.amazonaws.connect#UpdateUserPhoneConfig``."""
...
import capo_connect.types.update_user_phone_config_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/users/{InstanceId}/{UserId}/phone-config"
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_user_phone_config_request.serialize_json(input_)
    ).encode()
...
async def async_update_user_phone_config(
