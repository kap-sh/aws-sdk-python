"""Generated from Smithy shape ``com.amazonaws.connect#ListSecurityProfiles``."""
...
import capo_connect.types.list_security_profiles_request
import capo_connect.types.list_security_profiles_response
import capo_connect.types.security_profile_summary_list
...
def handle_response(
    ...
    out: capo_connect.types.list_security_profiles_response.ListSecurityProfilesResponse = capo_connect.types.list_security_profiles_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/security-profiles-summary/{InstanceId}"
...
async def async_list_security_profiles(
