...
import capo_connect.errors.idempotency_exception
import capo_connect.errors.internal_service_exception
import capo_connect.errors.invalid_contact_flow_module_exception
...
import capo_connect.types.create_contact_flow_module_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IdempotencyException":
            raise capo_connect.errors.idempotency_exception.IdempotencyException.from_json(
                data
            )
        ...
        case "InvalidContactFlowModuleException":
            raise capo_connect.errors.invalid_contact_flow_module_exception.InvalidContactFlowModuleException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_connect.types.create_contact_flow_module_response.CreateContactFlowModuleResponse = capo_connect.types.create_contact_flow_module_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_contact_flow_module_request.serialize_json(input_)
    ).encode()
