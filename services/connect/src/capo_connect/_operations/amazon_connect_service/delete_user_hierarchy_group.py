"""Generated from Smithy shape ``com.amazonaws.connect#DeleteUserHierarchyGroup``."""
...
import capo_connect.types.delete_user_hierarchy_group_request
...
async def async_delete_user_hierarchy_group(
