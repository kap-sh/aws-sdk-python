...
import capo_connect.types.import_phone_number_request
import capo_connect.types.import_phone_number_response
...
def handle_response(
    ...
    out: capo_connect.types.import_phone_number_response.ImportPhoneNumberResponse = (
        capo_connect.types.import_phone_number_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.import_phone_number_request.serialize_json(input_)
    ).encode()
