"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateHoursOfOperations``."""
...
import capo_connect.types.disassociate_hours_of_operations_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.disassociate_hours_of_operations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_hours_of_operations(
