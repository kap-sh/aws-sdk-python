"""Generated from Smithy shape ``com.amazonaws.connect#SearchQueues``."""
...
import capo_connect.types.search_queues_request
import capo_connect.types.search_queues_response
...
def handle_response(
    ...
    out: capo_connect.types.search_queues_response.SearchQueuesResponse = (
        capo_connect.types.search_queues_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/search-queues"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_connect.types.search_queues_request.serialize_json(input_)
    ).encode()
...
def search_queues(
    ...
    capo_connect.types.search_queues_response.SearchQueuesResponse, zapros.Response
]:
