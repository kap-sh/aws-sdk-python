...
def handle_response(
    ...
    out: capo_connect.types.search_security_profiles_response.SearchSecurityProfilesResponse = capo_connect.types.search_security_profiles_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_security_profiles_request.serialize_json(input_)
    ).encode()
