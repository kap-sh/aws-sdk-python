...
import capo_connect.types.list_workspace_pages_request
import capo_connect.types.list_workspace_pages_response
...
def handle_response(
    ...
    out: capo_connect.types.list_workspace_pages_response.ListWorkspacePagesResponse = (
        capo_connect.types.list_workspace_pages_response.deserialize_json(
