"""Generated from Smithy shape ``com.amazonaws.connect#CreateVocabularyResponse``."""
...
class CreateVocabularyResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateVocabularyResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateVocabularyResponse:
    ...
    if "State" in data:
        ...
        raise DeserializationError("CreateVocabularyResponse.state required")
    return out
