...
def serialize_json(input_to_serialize: EvaluationAnswersOutputMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = capo_connect.types.evaluation_answer_output.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> EvaluationAnswersOutputMap:
    ...
    for key, value in data.items():
        ...
        out[key] = capo_connect.types.evaluation_answer_output.deserialize_json(value)
    return out
