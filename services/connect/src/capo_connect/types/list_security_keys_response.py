...
class ListSecurityKeysResponse(TypedDict, closed=True):
    security_keys: NotRequired["capo_connect.types.security_keys_list.SecurityKeysList"]
...
def serialize_json(value: ListSecurityKeysResponse) -> dict:
    ...
    if "security_keys" in value:
        ...
        out["SecurityKeys"] = capo_connect.types.security_keys_list.serialize_json(
            value["security_keys"]
        )
...
def deserialize_json(data: dict) -> ListSecurityKeysResponse:
    ...
    if "SecurityKeys" in data:
        ...
        out["security_keys"] = capo_connect.types.security_keys_list.deserialize_json(
            data["SecurityKeys"]
        )
