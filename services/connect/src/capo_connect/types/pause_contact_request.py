"""Generated from Smithy shape ``com.amazonaws.connect#PauseContactRequest``."""
...
class PauseContactRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: PauseContactRequest) -> dict:
    out: dict = {}
