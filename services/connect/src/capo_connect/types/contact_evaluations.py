...
if TYPE_CHECKING:
    ...
    import capo_connect.types.evaluation_id

ContactEvaluations: TypeAlias = dict[
    "capo_connect.types.evaluation_id.EvaluationId",
    "capo_connect.types.contact_evaluation.ContactEvaluation",
]
...
def serialize_json(input_to_serialize: ContactEvaluations) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = capo_connect.types.contact_evaluation.serialize_json(value)
    return out
