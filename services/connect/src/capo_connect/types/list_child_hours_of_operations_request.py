...
# --- restJson1 ser/de ---
def serialize_json(value: ListChildHoursOfOperationsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListChildHoursOfOperationsRequest:
    out: ListChildHoursOfOperationsRequest = {}  # type: ignore[typeddict-item]
    return out
