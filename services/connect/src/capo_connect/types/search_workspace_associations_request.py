...
class SearchWorkspaceAssociationsRequest(TypedDict, closed=True):
    ...
    search_filter: NotRequired[
        "capo_connect.types.workspace_association_search_filter.WorkspaceAssociationSearchFilter"
    ]
...
def serialize_json(value: SearchWorkspaceAssociationsRequest) -> dict:
    ...
    if "search_filter" in value:
        ...
        out["SearchFilter"] = (
            capo_connect.types.workspace_association_search_filter.serialize_json(
                value["search_filter"]
            )
        )
...
def deserialize_json(data: dict) -> SearchWorkspaceAssociationsRequest:
    ...
    if "SearchFilter" in data:
        ...
        out["search_filter"] = (
            capo_connect.types.workspace_association_search_filter.deserialize_json(
                data["SearchFilter"]
            )
        )
