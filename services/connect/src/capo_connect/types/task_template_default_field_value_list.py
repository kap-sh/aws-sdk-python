...
if TYPE_CHECKING:
    import capo_connect.types.task_template_default_field_value

TaskTemplateDefaultFieldValueList: TypeAlias = list[
    "capo_connect.types.task_template_default_field_value.TaskTemplateDefaultFieldValue"
]
...
def serialize_json(value: TaskTemplateDefaultFieldValueList) -> list:
    ...
    for item in value:
        out.append(
            capo_connect.types.task_template_default_field_value.serialize_json(item)
        )
    return out
