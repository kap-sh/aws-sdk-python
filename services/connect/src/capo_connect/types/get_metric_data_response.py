...
if TYPE_CHECKING:
    import capo_connect.types.historical_metric_results
    import capo_connect.types.next_token


class GetMetricDataResponse(TypedDict, closed=True):
    ...
    metric_results: NotRequired[
        "capo_connect.types.historical_metric_results.HistoricalMetricResults"
    ]
...
def serialize_json(value: GetMetricDataResponse) -> dict:
    ...
    if "metric_results" in value:
        ...
        out["MetricResults"] = (
            capo_connect.types.historical_metric_results.serialize_json(
...
def deserialize_json(data: dict) -> GetMetricDataResponse:
    ...
    if "MetricResults" in data:
        ...
        out["metric_results"] = (
            capo_connect.types.historical_metric_results.deserialize_json(
                data["MetricResults"]
            )
        )
    return out
