...
class AnalyticsDataAssociationResult(TypedDict, closed=True):
    ...
    resource_share_id: NotRequired["capo_connect.types.string.String"]
    """<p>The Resource Access Manager share ID.</p>"""
    resource_share_arn: NotRequired["capo_connect.types.arn.ARN"]
    """<p>The Amazon Resource Name (ARN) of the Resource Access Manager share. </p>"""
    resource_share_status: NotRequired["capo_connect.types.string.String"]
