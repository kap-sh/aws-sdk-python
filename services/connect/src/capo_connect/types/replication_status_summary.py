...
if TYPE_CHECKING:
    ...
    import capo_connect.types.replication_status_reason


class ReplicationStatusSummary(TypedDict, closed=True):
    region: NotRequired["capo_connect.types.aws_region.AwsRegion"]
    ...
    replication_status: NotRequired[
        "capo_connect.types.instance_replication_status.InstanceReplicationStatus"
    ]
    """<p>The state of the replication.</p>"""
    replication_status_reason: NotRequired[
        "capo_connect.types.replication_status_reason.ReplicationStatusReason"
    ]
...
def serialize_json(value: ReplicationStatusSummary) -> dict:
    ...
    if "replication_status" in value:
        ...
        out["ReplicationStatus"] = (
            capo_connect.types.instance_replication_status.serialize_json(
...
def deserialize_json(data: dict) -> ReplicationStatusSummary:
    ...
    if "ReplicationStatus" in data:
        ...
        out["replication_status"] = (
            capo_connect.types.instance_replication_status.deserialize_json(
