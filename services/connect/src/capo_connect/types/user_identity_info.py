...
if TYPE_CHECKING:
    ...
    import capo_connect.types.email
...
class UserIdentityInfo(TypedDict, closed=True):
    ...
    mobile: NotRequired["capo_connect.types.phone_number.PhoneNumber"]
