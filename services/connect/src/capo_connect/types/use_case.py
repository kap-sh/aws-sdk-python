...
class UseCase(TypedDict, closed=True):
    use_case_id: NotRequired["capo_connect.types.use_case_id.UseCaseId"]
    """<p>The identifier for the use case.</p>"""
    use_case_arn: NotRequired["capo_connect.types.arn.ARN"]
    """<p>The Amazon Resource Name (ARN) for the use case.</p>"""
    use_case_type: NotRequired["capo_connect.types.use_case_type.UseCaseType"]
