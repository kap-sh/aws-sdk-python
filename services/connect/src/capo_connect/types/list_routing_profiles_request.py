...
# --- restJson1 ser/de ---
def serialize_json(value: ListRoutingProfilesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListRoutingProfilesRequest:
    out: ListRoutingProfilesRequest = {}  # type: ignore[typeddict-item]
    return out
