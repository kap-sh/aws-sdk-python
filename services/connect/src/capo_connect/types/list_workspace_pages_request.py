"""Generated from Smithy shape ``com.amazonaws.connect#ListWorkspacePagesRequest``."""
...
class ListWorkspacePagesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListWorkspacePagesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListWorkspacePagesRequest:
    out: ListWorkspacePagesRequest = {}  # type: ignore[typeddict-item]
    return out
