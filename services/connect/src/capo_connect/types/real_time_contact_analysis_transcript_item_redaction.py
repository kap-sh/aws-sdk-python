...
if TYPE_CHECKING:
    import capo_connect.types.real_time_contact_analysis_character_intervals


class RealTimeContactAnalysisTranscriptItemRedaction(TypedDict, closed=True):
    character_offsets: NotRequired[
        "capo_connect.types.real_time_contact_analysis_character_intervals.RealTimeContactAnalysisCharacterIntervals"
    ]
...
def serialize_json(value: RealTimeContactAnalysisTranscriptItemRedaction) -> dict:
    ...
    if "character_offsets" in value:
        ...
        out["CharacterOffsets"] = (
            capo_connect.types.real_time_contact_analysis_character_intervals.serialize_json(
...
def deserialize_json(data: dict) -> RealTimeContactAnalysisTranscriptItemRedaction:
    ...
    if "CharacterOffsets" in data:
        ...
        out["character_offsets"] = (
            capo_connect.types.real_time_contact_analysis_character_intervals.deserialize_json(
