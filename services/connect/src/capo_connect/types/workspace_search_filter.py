"""Generated from Smithy shape ``com.amazonaws.connect#WorkspaceSearchFilter``."""
...
class WorkspaceSearchFilter(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: WorkspaceSearchFilter) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> WorkspaceSearchFilter:
    out: WorkspaceSearchFilter = {}  # type: ignore[typeddict-item]
