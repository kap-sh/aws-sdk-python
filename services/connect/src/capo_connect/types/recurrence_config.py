...
class RecurrenceConfig(TypedDict, closed=True):
    recurrence_pattern: "capo_connect.types.recurrence_pattern.RecurrencePattern"
...
def serialize_json(value: RecurrenceConfig) -> dict:
    ...
    out["RecurrencePattern"] = capo_connect.types.recurrence_pattern.serialize_json(
...
def deserialize_json(data: dict) -> RecurrenceConfig:
    ...
    if "RecurrencePattern" in data:
        ...
        out["recurrence_pattern"] = (
            capo_connect.types.recurrence_pattern.deserialize_json(
