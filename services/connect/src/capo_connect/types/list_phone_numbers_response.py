...
if TYPE_CHECKING:
    ...
    import capo_connect.types.phone_number_summary_list


class ListPhoneNumbersResponse(TypedDict, closed=True):
    phone_number_summary_list: NotRequired[
        "capo_connect.types.phone_number_summary_list.PhoneNumberSummaryList"
    ]
...
def serialize_json(value: ListPhoneNumbersResponse) -> dict:
    ...
    if "phone_number_summary_list" in value:
        ...
        out["PhoneNumberSummaryList"] = (
            capo_connect.types.phone_number_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListPhoneNumbersResponse:
    ...
    if "PhoneNumberSummaryList" in data:
        ...
        out["phone_number_summary_list"] = (
            capo_connect.types.phone_number_summary_list.deserialize_json(
