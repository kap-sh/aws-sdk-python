"""Generated from Smithy shape ``com.amazonaws.connect#StartOutboundVoiceContactResponse``."""
...
class StartOutboundVoiceContactResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: StartOutboundVoiceContactResponse) -> dict:
    out: dict = {}
