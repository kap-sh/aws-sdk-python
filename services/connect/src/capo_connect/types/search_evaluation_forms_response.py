...
if TYPE_CHECKING:
    ...
    import capo_connect.types.evaluation_form_search_summary_list
    import capo_connect.types.next_token


class SearchEvaluationFormsResponse(TypedDict, closed=True):
    evaluation_form_search_summary_list: NotRequired[
        "capo_connect.types.evaluation_form_search_summary_list.EvaluationFormSearchSummaryList"
    ]
...
def serialize_json(value: SearchEvaluationFormsResponse) -> dict:
    ...
    if "evaluation_form_search_summary_list" in value:
        ...
        out["EvaluationFormSearchSummaryList"] = (
            capo_connect.types.evaluation_form_search_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> SearchEvaluationFormsResponse:
    ...
    if "EvaluationFormSearchSummaryList" in data:
        ...
        out["evaluation_form_search_summary_list"] = (
            capo_connect.types.evaluation_form_search_summary_list.deserialize_json(
