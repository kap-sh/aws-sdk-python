...
if TYPE_CHECKING:
    import capo_connect.types.evaluation_form_text_question_automation


class EvaluationFormTextQuestionProperties(TypedDict, closed=True):
    automation: NotRequired[
        "capo_connect.types.evaluation_form_text_question_automation.EvaluationFormTextQuestionAutomation"
    ]
...
def serialize_json(value: EvaluationFormTextQuestionProperties) -> dict:
    ...
    if "automation" in value:
        ...
        out["Automation"] = (
            capo_connect.types.evaluation_form_text_question_automation.serialize_json(
                value["automation"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> EvaluationFormTextQuestionProperties:
    ...
    if "Automation" in data:
        ...
        out["automation"] = (
            capo_connect.types.evaluation_form_text_question_automation.deserialize_json(
                data["Automation"]
            )
        )
    return out
