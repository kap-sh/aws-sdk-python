...
if TYPE_CHECKING:
    ...
    import capo_connect.types.registration_id


class DeletePushNotificationRegistrationRequest(TypedDict, closed=True):
    ...
    registration_id: "capo_connect.types.registration_id.RegistrationId"
