...
if TYPE_CHECKING:
    ...
    import capo_connect.types.namespace


class Application(TypedDict, closed=True):
    namespace: NotRequired["capo_connect.types.namespace.Namespace"]
    """<p>Namespace of the application that you want to give access to.</p>"""
    application_permissions: NotRequired[
        "capo_connect.types.application_permissions.ApplicationPermissions"
    ]
    ...
    type: NotRequired["capo_connect.types.application_type.ApplicationType"]
...
def serialize_json(value: Application) -> dict:
    ...
    if "application_permissions" in value:
        ...
        out["ApplicationPermissions"] = (
            capo_connect.types.application_permissions.serialize_json(
    ...
    if "type" in value:
        ...
        out["Type"] = capo_connect.types.application_type.serialize_json(value["type"])
    return out
...
def deserialize_json(data: dict) -> Application:
    ...
    if "ApplicationPermissions" in data:
        ...
        out["application_permissions"] = (
            capo_connect.types.application_permissions.deserialize_json(
