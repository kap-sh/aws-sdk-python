...
```
pip install aws-sdk-cost-optimization-hub
```

## Usage

```python
from aws_sdk_cost_optimization_hub import AsyncCostOptimizationHubClient
...
```python
from aws_sdk_cost_optimization_hub import AsyncCostOptimizationHubClient
from aws_sdk_cost_optimization_hub.error import AccessDeniedException
