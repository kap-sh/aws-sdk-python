...
if TYPE_CHECKING:
    import capo_cost_optimization_hub.types.db_instance_configuration
...
def serialize_aws_json_1_0(value: RdsDbInstanceConfiguration) -> dict:
    ...
    if "instance" in value:
        ...
        out["instance"] = (
            capo_cost_optimization_hub.types.db_instance_configuration.serialize_aws_json_1_0(
                value["instance"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> RdsDbInstanceConfiguration:
    ...
    if "instance" in data:
        ...
        out["instance"] = (
            capo_cost_optimization_hub.types.db_instance_configuration.deserialize_aws_json_1_0(
                data["instance"]
            )
        )
    return out
