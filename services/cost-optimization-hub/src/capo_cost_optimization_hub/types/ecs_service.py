...
if TYPE_CHECKING:
    import capo_cost_optimization_hub.types.ecs_service_configuration
    import capo_cost_optimization_hub.types.resource_cost_calculation


class EcsService(TypedDict, closed=True):
    configuration: NotRequired[
        "capo_cost_optimization_hub.types.ecs_service_configuration.EcsServiceConfiguration"
    ]
...
def serialize_aws_json_1_0(value: EcsService) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            capo_cost_optimization_hub.types.ecs_service_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> EcsService:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            capo_cost_optimization_hub.types.ecs_service_configuration.deserialize_aws_json_1_0(
                data["configuration"]
            )
        )
