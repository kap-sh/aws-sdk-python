...
if TYPE_CHECKING:
    import capo_cost_optimization_hub.types.lambda_function_configuration
    import capo_cost_optimization_hub.types.resource_cost_calculation


class LambdaFunction(TypedDict, closed=True):
    configuration: NotRequired[
        "capo_cost_optimization_hub.types.lambda_function_configuration.LambdaFunctionConfiguration"
    ]
...
def serialize_aws_json_1_0(value: LambdaFunction) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            capo_cost_optimization_hub.types.lambda_function_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> LambdaFunction:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            capo_cost_optimization_hub.types.lambda_function_configuration.deserialize_aws_json_1_0(
                data["configuration"]
            )
        )
