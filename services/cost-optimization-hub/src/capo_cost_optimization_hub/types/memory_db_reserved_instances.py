...
class MemoryDbReservedInstances(TypedDict, closed=True):
    configuration: NotRequired[
        "capo_cost_optimization_hub.types.memory_db_reserved_instances_configuration.MemoryDbReservedInstancesConfiguration"
    ]
...
def serialize_aws_json_1_0(value: MemoryDbReservedInstances) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            capo_cost_optimization_hub.types.memory_db_reserved_instances_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> MemoryDbReservedInstances:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            capo_cost_optimization_hub.types.memory_db_reserved_instances_configuration.deserialize_aws_json_1_0(
                data["configuration"]
            )
        )
