...
if TYPE_CHECKING:
    import capo_cost_optimization_hub.types.ec2_auto_scaling_group_configuration
    import capo_cost_optimization_hub.types.resource_cost_calculation


class Ec2AutoScalingGroup(TypedDict, closed=True):
    configuration: NotRequired[
        "capo_cost_optimization_hub.types.ec2_auto_scaling_group_configuration.Ec2AutoScalingGroupConfiguration"
    ]
...
def serialize_aws_json_1_0(value: Ec2AutoScalingGroup) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            capo_cost_optimization_hub.types.ec2_auto_scaling_group_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> Ec2AutoScalingGroup:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            capo_cost_optimization_hub.types.ec2_auto_scaling_group_configuration.deserialize_aws_json_1_0(
                data["configuration"]
            )
        )
