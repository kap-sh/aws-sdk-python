...
EfficiencyMetricsByGroupList: TypeAlias = list[
    "capo_cost_optimization_hub.types.efficiency_metrics_by_group.EfficiencyMetricsByGroup"
]
...
def serialize_aws_json_1_0(value: EfficiencyMetricsByGroupList) -> list:
    ...
    for item in value:
        out.append(
            capo_cost_optimization_hub.types.efficiency_metrics_by_group.serialize_aws_json_1_0(
                item
            )
        )
    return out
