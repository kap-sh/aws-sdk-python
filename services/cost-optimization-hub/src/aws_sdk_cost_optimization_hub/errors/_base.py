...
class CostOptimizationHubError(Exception):
    """Base class for all CostOptimizationHub service errors."""


class ServiceError(CostOptimizationHubError):
...
class SerializationError(CostOptimizationHubError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CostOptimizationHubError):
...
class WaiterFailedError(CostOptimizationHubError):
...
class WaiterTimeoutError(CostOptimizationHubError):
