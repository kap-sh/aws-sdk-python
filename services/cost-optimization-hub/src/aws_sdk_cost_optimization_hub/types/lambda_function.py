"""Generated from Smithy shape ``com.amazonaws.costoptimizationhub#LambdaFunction``."""
...
if TYPE_CHECKING:
    import aws_sdk_cost_optimization_hub.types.lambda_function_configuration
    import aws_sdk_cost_optimization_hub.types.resource_cost_calculation


class LambdaFunction(TypedDict, closed=True):
    configuration: NotRequired[
        "aws_sdk_cost_optimization_hub.types.lambda_function_configuration.LambdaFunctionConfiguration"
    ]
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: LambdaFunction) -> dict:
    out: dict = {}
    if "configuration" in value:
        import aws_sdk_cost_optimization_hub.types.lambda_function_configuration

        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.lambda_function_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> LambdaFunction:
    out: LambdaFunction = {}  # type: ignore[typeddict-item]
    if "configuration" in data:
        import aws_sdk_cost_optimization_hub.types.lambda_function_configuration

        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.lambda_function_configuration.deserialize_aws_json_1_0(
                data["configuration"]
            )
        )
