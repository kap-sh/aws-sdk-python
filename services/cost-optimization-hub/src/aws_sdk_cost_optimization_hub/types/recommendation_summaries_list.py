...
RecommendationSummariesList: TypeAlias = list[
    "aws_sdk_cost_optimization_hub.types.recommendation_summary.RecommendationSummary"
]
...
def serialize_aws_json_1_0(value: RecommendationSummariesList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cost_optimization_hub.types.recommendation_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> RecommendationSummariesList:
    ...
    for item in data:
        out.append(
            aws_sdk_cost_optimization_hub.types.recommendation_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
