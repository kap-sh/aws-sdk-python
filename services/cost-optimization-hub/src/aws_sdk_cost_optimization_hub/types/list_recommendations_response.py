...
class ListRecommendationsResponse(TypedDict):
    items: NotRequired[
        "aws_sdk_cost_optimization_hub.types.recommendation_list.RecommendationList"
    ]
...
def serialize_aws_json_1_0(value: ListRecommendationsResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            aws_sdk_cost_optimization_hub.types.recommendation_list.serialize_aws_json_1_0(
                value["items"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListRecommendationsResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_cost_optimization_hub.types.recommendation_list.deserialize_aws_json_1_0(
                data["items"]
            )
        )
