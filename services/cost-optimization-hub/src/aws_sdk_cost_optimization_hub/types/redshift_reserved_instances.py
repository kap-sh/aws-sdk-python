"""Generated from Smithy shape ``com.amazonaws.costoptimizationhub#RedshiftReservedInstances``."""
...
if TYPE_CHECKING:
    import aws_sdk_cost_optimization_hub.types.redshift_reserved_instances_configuration
    import aws_sdk_cost_optimization_hub.types.reserved_instances_cost_calculation


class RedshiftReservedInstances(TypedDict, closed=True):
    configuration: NotRequired[
        "aws_sdk_cost_optimization_hub.types.redshift_reserved_instances_configuration.RedshiftReservedInstancesConfiguration"
    ]
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: RedshiftReservedInstances) -> dict:
    out: dict = {}
    if "configuration" in value:
        import aws_sdk_cost_optimization_hub.types.redshift_reserved_instances_configuration

        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.redshift_reserved_instances_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> RedshiftReservedInstances:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.redshift_reserved_instances_configuration.deserialize_aws_json_1_0(
                data["configuration"]
            )
        )
