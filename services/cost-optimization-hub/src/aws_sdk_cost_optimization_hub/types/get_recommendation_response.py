...
if TYPE_CHECKING:
    ...
    import aws_sdk_cost_optimization_hub.types.resource_details
...
class GetRecommendationResponse(TypedDict):
    ...
    current_resource_details: NotRequired[
        "aws_sdk_cost_optimization_hub.types.resource_details.ResourceDetails"
    ]
...
def serialize_aws_json_1_0(value: GetRecommendationResponse) -> dict:
    ...
    if "action_type" in value:
        ...
        out["actionType"] = (
            aws_sdk_cost_optimization_hub.types.action_type.serialize_aws_json_1_0(
                value["action_type"]
            )
        )
    ...
    if "current_resource_details" in value:
        ...
        out["currentResourceDetails"] = (
            aws_sdk_cost_optimization_hub.types.resource_details.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetRecommendationResponse:
    ...
    if "currentResourceDetails" in data:
        ...
        out["current_resource_details"] = (
            aws_sdk_cost_optimization_hub.types.resource_details.deserialize_aws_json_1_0(
