...
if TYPE_CHECKING:
    import aws_sdk_cost_optimization_hub.types.ec2_reserved_instances_configuration
    import aws_sdk_cost_optimization_hub.types.reserved_instances_cost_calculation


class Ec2ReservedInstances(TypedDict):
    configuration: NotRequired[
        "aws_sdk_cost_optimization_hub.types.ec2_reserved_instances_configuration.Ec2ReservedInstancesConfiguration"
    ]
...
def serialize_aws_json_1_0(value: Ec2ReservedInstances) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.ec2_reserved_instances_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> Ec2ReservedInstances:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.ec2_reserved_instances_configuration.deserialize_aws_json_1_0(
                data["configuration"]
            )
        )
