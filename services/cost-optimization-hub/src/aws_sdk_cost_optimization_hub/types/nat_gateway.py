...
def serialize_aws_json_1_0(value: NatGateway) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.nat_gateway_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> NatGateway:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.nat_gateway_configuration.deserialize_aws_json_1_0(
                data["configuration"]
            )
        )
