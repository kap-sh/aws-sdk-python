"""Generated from Smithy shape ``com.amazonaws.costoptimizationhub#SageMakerEndpoint``."""
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: SageMakerEndpoint) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> SageMakerEndpoint:
