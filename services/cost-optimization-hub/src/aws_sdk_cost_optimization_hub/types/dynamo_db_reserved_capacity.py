...
if TYPE_CHECKING:
    import aws_sdk_cost_optimization_hub.types.dynamo_db_reserved_capacity_configuration
    import aws_sdk_cost_optimization_hub.types.reserved_instances_cost_calculation


class DynamoDbReservedCapacity(TypedDict):
    configuration: NotRequired[
        "aws_sdk_cost_optimization_hub.types.dynamo_db_reserved_capacity_configuration.DynamoDbReservedCapacityConfiguration"
    ]
...
def serialize_aws_json_1_0(value: DynamoDbReservedCapacity) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.dynamo_db_reserved_capacity_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DynamoDbReservedCapacity:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.dynamo_db_reserved_capacity_configuration.deserialize_aws_json_1_0(
                data["configuration"]
            )
        )
