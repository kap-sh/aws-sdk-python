...
if TYPE_CHECKING:
    import aws_sdk_cost_optimization_hub.types.ec2_instance_configuration
    import aws_sdk_cost_optimization_hub.types.resource_cost_calculation


class Ec2Instance(TypedDict):
    configuration: NotRequired[
        "aws_sdk_cost_optimization_hub.types.ec2_instance_configuration.Ec2InstanceConfiguration"
    ]
...
def serialize_aws_json_1_0(value: Ec2Instance) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.ec2_instance_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> Ec2Instance:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            aws_sdk_cost_optimization_hub.types.ec2_instance_configuration.deserialize_aws_json_1_0(
                data["configuration"]
            )
        )
