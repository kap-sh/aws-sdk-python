...
if TYPE_CHECKING:
    ...
    import aws_sdk_cost_optimization_hub.types.ec2_auto_scaling_group_type
...
class Ec2AutoScalingGroupConfiguration(TypedDict):
    ...
    mixed_instances: NotRequired[
        "aws_sdk_cost_optimization_hub.types.mixed_instance_configuration_list.MixedInstanceConfigurationList"
    ]
    """<p>A list of instance types for an EC2 Auto Scaling group with mixed instance types.</p>"""
    type: NotRequired[
        "aws_sdk_cost_optimization_hub.types.ec2_auto_scaling_group_type.Ec2AutoScalingGroupType"
    ]
    ...
    allocation_strategy: NotRequired[
        "aws_sdk_cost_optimization_hub.types.allocation_strategy.AllocationStrategy"
    ]
...
def serialize_aws_json_1_0(value: Ec2AutoScalingGroupConfiguration) -> dict:
    ...
    if "mixed_instances" in value:
        ...
        out["mixedInstances"] = (
            aws_sdk_cost_optimization_hub.types.mixed_instance_configuration_list.serialize_aws_json_1_0(
    ...
    if "type" in value:
        ...
        out["type"] = (
            aws_sdk_cost_optimization_hub.types.ec2_auto_scaling_group_type.serialize_aws_json_1_0(
                value["type"]
            )
        )
    if "allocation_strategy" in value:
        ...
        out["allocationStrategy"] = (
            aws_sdk_cost_optimization_hub.types.allocation_strategy.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Ec2AutoScalingGroupConfiguration:
    ...
    if "mixedInstances" in data:
        ...
        out["mixed_instances"] = (
            aws_sdk_cost_optimization_hub.types.mixed_instance_configuration_list.deserialize_aws_json_1_0(
                data["mixedInstances"]
            )
        )
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_cost_optimization_hub.types.ec2_auto_scaling_group_type.deserialize_aws_json_1_0(
                data["type"]
            )
        )
    if "allocationStrategy" in data:
        ...
        out["allocation_strategy"] = (
            aws_sdk_cost_optimization_hub.types.allocation_strategy.deserialize_aws_json_1_0(
