...
class ListRecommendationSummariesResponse(TypedDict):
    ...
    items: NotRequired[
        "aws_sdk_cost_optimization_hub.types.recommendation_summaries_list.RecommendationSummariesList"
    ]
    ...
    metrics: NotRequired[
        "aws_sdk_cost_optimization_hub.types.summary_metrics_result.SummaryMetricsResult"
    ]
...
def serialize_aws_json_1_0(value: ListRecommendationSummariesResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            aws_sdk_cost_optimization_hub.types.recommendation_summaries_list.serialize_aws_json_1_0(
                value["items"]
            )
        )
    ...
    if "metrics" in value:
        ...
        out["metrics"] = (
            aws_sdk_cost_optimization_hub.types.summary_metrics_result.serialize_aws_json_1_0(
                value["metrics"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListRecommendationSummariesResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_cost_optimization_hub.types.recommendation_summaries_list.deserialize_aws_json_1_0(
                data["items"]
            )
        )
    if "groupBy" in data:
    ...
    if "metrics" in data:
        ...
        out["metrics"] = (
            aws_sdk_cost_optimization_hub.types.summary_metrics_result.deserialize_aws_json_1_0(
                data["metrics"]
            )
        )
