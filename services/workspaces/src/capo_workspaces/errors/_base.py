...
class WorkSpacesError(Exception):
    """Base class for all WorkSpaces service errors."""


class ServiceError(WorkSpacesError):
...
class SerializationError(WorkSpacesError):
    """Raised when a value cannot be serialized."""


class DeserializationError(WorkSpacesError):
...
class WaiterFailedError(WorkSpacesError):
...
class WaiterTimeoutError(WorkSpacesError):
