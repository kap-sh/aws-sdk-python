...
from aws_sdk_workspaces._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
...
from aws_sdk_workspaces._services._aws_config import aaws_config
...
class AsyncWorkSpacesClientConfig(TypedDict, total=False, closed=True):
...
class AsyncWorkSpacesClient:
    ...
    def __init__(
        ...
        self._config = AsyncWorkSpacesClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncWorkSpacesClientConfig] = None
    ...
    async def accept_account_link_invitation(
        ...
        *,
        ...
        client_token: Optional[
            "aws_sdk_workspaces.types.client_token.ClientToken"
        ] = None,
    ) -> "aws_sdk_workspaces.types.accept_account_link_invitation_result.AcceptAccountLinkInvitationResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.accept_account_link_invitation_request.AcceptAccountLinkInvitationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.accept_account_link_invitation_result.AcceptAccountLinkInvitationResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.accept_account_link_invitation.async_accept_account_link_invitation(
    ...
    async def associate_connection_alias(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.associate_connection_alias_result.AssociateConnectionAliasResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.associate_connection_alias_request.AssociateConnectionAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.associate_connection_alias_result.AssociateConnectionAliasResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.associate_connection_alias.async_associate_connection_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_ip_groups(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.associate_ip_groups_result.AssociateIpGroupsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.associate_ip_groups_request.AssociateIpGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.associate_ip_groups_result.AssociateIpGroupsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.associate_ip_groups.async_associate_ip_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_workspace_application(
        ...
        application_id: "aws_sdk_workspaces.types.work_space_application_id.WorkSpaceApplicationId",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.associate_workspace_application_result.AssociateWorkspaceApplicationResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.associate_workspace_application_request.AssociateWorkspaceApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.associate_workspace_application_result.AssociateWorkspaceApplicationResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.associate_workspace_application.async_associate_workspace_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def authorize_ip_rules(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.authorize_ip_rules_result.AuthorizeIpRulesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.authorize_ip_rules_request.AuthorizeIpRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.authorize_ip_rules_result.AuthorizeIpRulesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.authorize_ip_rules.async_authorize_ip_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def copy_workspace_image(
        ...
        *,
        ...
        tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None,
    ) -> (
        "aws_sdk_workspaces.types.copy_workspace_image_result.CopyWorkspaceImageResult"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.copy_workspace_image_request.CopyWorkspaceImageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.copy_workspace_image_result.CopyWorkspaceImageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.copy_workspace_image.async_copy_workspace_image(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_account_link_invitation(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.create_account_link_invitation_result.CreateAccountLinkInvitationResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_account_link_invitation_request.CreateAccountLinkInvitationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_account_link_invitation_result.CreateAccountLinkInvitationResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_account_link_invitation.async_create_account_link_invitation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_connect_client_add_in(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.create_connect_client_add_in_result.CreateConnectClientAddInResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_connect_client_add_in_request.CreateConnectClientAddInRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_connect_client_add_in_result.CreateConnectClientAddInResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_connect_client_add_in.async_create_connect_client_add_in(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_connection_alias(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_workspaces.types.create_connection_alias_result.CreateConnectionAliasResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_connection_alias_request.CreateConnectionAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_connection_alias_result.CreateConnectionAliasResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_connection_alias.async_create_connection_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_ip_group(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        group_desc: Optional[
            "aws_sdk_workspaces.types.ip_group_desc.IpGroupDesc"
        ] = None,
        user_rules: Optional["aws_sdk_workspaces.types.ip_rule_list.IpRuleList"] = None,
        tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_ip_group_request.CreateIpGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_ip_group_result.CreateIpGroupResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_ip_group.async_create_ip_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_standby_workspaces(
        ...
        standby_workspaces: "aws_sdk_workspaces.types.standby_workspaces_list.StandbyWorkspacesList",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.create_standby_workspaces_result.CreateStandbyWorkspacesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_standby_workspaces_request.CreateStandbyWorkspacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_standby_workspaces_result.CreateStandbyWorkspacesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_standby_workspaces.async_create_standby_workspaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_tags(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.create_tags_result.CreateTagsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_tags_request.CreateTagsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_tags_result.CreateTagsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_tags.async_create_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_updated_workspace_image(
        self,
        name: "aws_sdk_workspaces.types.workspace_image_name.WorkspaceImageName",
        description: "aws_sdk_workspaces.types.workspace_image_description.WorkspaceImageDescription",
        source_image_id: "aws_sdk_workspaces.types.workspace_image_id.WorkspaceImageId",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_workspaces.types.create_updated_workspace_image_result.CreateUpdatedWorkspaceImageResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_updated_workspace_image_request.CreateUpdatedWorkspaceImageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_updated_workspace_image_result.CreateUpdatedWorkspaceImageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_updated_workspace_image.async_create_updated_workspace_image(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_workspace_bundle(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        root_storage: Optional[
            "aws_sdk_workspaces.types.root_storage.RootStorage"
        ] = None,
        tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_workspaces.types.create_workspace_bundle_result.CreateWorkspaceBundleResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_workspace_bundle_request.CreateWorkspaceBundleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_workspace_bundle_result.CreateWorkspaceBundleResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_workspace_bundle.async_create_workspace_bundle(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_workspace_image(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_workspaces.types.create_workspace_image_result.CreateWorkspaceImageResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_workspace_image_request.CreateWorkspaceImageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_workspace_image_result.CreateWorkspaceImageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_workspace_image.async_create_workspace_image(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_workspaces(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.create_workspaces_result.CreateWorkspacesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_workspaces_request.CreateWorkspacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_workspaces_result.CreateWorkspacesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_workspaces.async_create_workspaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_workspaces_pool(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.create_workspaces_pool_result.CreateWorkspacesPoolResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.create_workspaces_pool_request.CreateWorkspacesPoolRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.create_workspaces_pool_result.CreateWorkspacesPoolResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.create_workspaces_pool.async_create_workspaces_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_account_link_invitation(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.delete_account_link_invitation_result.DeleteAccountLinkInvitationResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.delete_account_link_invitation_request.DeleteAccountLinkInvitationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.delete_account_link_invitation_result.DeleteAccountLinkInvitationResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.delete_account_link_invitation.async_delete_account_link_invitation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_client_branding(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.delete_client_branding_result.DeleteClientBrandingResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.delete_client_branding_request.DeleteClientBrandingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.delete_client_branding_result.DeleteClientBrandingResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.delete_client_branding.async_delete_client_branding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_connect_client_add_in(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.delete_connect_client_add_in_result.DeleteConnectClientAddInResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.delete_connect_client_add_in_request.DeleteConnectClientAddInRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.delete_connect_client_add_in_result.DeleteConnectClientAddInResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.delete_connect_client_add_in.async_delete_connect_client_add_in(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_connection_alias(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.delete_connection_alias_result.DeleteConnectionAliasResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.delete_connection_alias_request.DeleteConnectionAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.delete_connection_alias_result.DeleteConnectionAliasResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.delete_connection_alias.async_delete_connection_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_ip_group(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.delete_ip_group_result.DeleteIpGroupResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.delete_ip_group_request.DeleteIpGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.delete_ip_group_result.DeleteIpGroupResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.delete_ip_group.async_delete_ip_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tags(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.delete_tags_result.DeleteTagsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.delete_tags_request.DeleteTagsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.delete_tags_result.DeleteTagsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.delete_tags.async_delete_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_workspace_bundle(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        bundle_id: Optional["aws_sdk_workspaces.types.bundle_id.BundleId"] = None,
    ) -> "aws_sdk_workspaces.types.delete_workspace_bundle_result.DeleteWorkspaceBundleResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.delete_workspace_bundle_request.DeleteWorkspaceBundleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.delete_workspace_bundle_result.DeleteWorkspaceBundleResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.delete_workspace_bundle.async_delete_workspace_bundle(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_workspace_image(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.delete_workspace_image_result.DeleteWorkspaceImageResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.delete_workspace_image_request.DeleteWorkspaceImageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.delete_workspace_image_result.DeleteWorkspaceImageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.delete_workspace_image.async_delete_workspace_image(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deploy_workspace_applications(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        force: Optional["aws_sdk_workspaces.types.boolean_object.BooleanObject"] = None,
    ) -> "aws_sdk_workspaces.types.deploy_workspace_applications_result.DeployWorkspaceApplicationsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.deploy_workspace_applications_request.DeployWorkspaceApplicationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.deploy_workspace_applications_result.DeployWorkspaceApplicationsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.deploy_workspace_applications.async_deploy_workspace_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_workspace_directory(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.deregister_workspace_directory_result.DeregisterWorkspaceDirectoryResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.deregister_workspace_directory_request.DeregisterWorkspaceDirectoryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.deregister_workspace_directory_result.DeregisterWorkspaceDirectoryResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.deregister_workspace_directory.async_deregister_workspace_directory(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_account_request.DescribeAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_account_result.DescribeAccountResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_account.async_describe_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_modifications(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        next_token: Optional[
            "aws_sdk_workspaces.types.pagination_token.PaginationToken"
        ] = None,
    ) -> "aws_sdk_workspaces.types.describe_account_modifications_result.DescribeAccountModificationsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_account_modifications_request.DescribeAccountModificationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_account_modifications_result.DescribeAccountModificationsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_account_modifications.async_describe_account_modifications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_application_associations(
        self,
        application_id: "aws_sdk_workspaces.types.work_space_application_id.WorkSpaceApplicationId",
        associated_resource_types: "aws_sdk_workspaces.types.application_associated_resource_type_list.ApplicationAssociatedResourceTypeList",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None,
        next_token: Optional[
            "aws_sdk_workspaces.types.pagination_token.PaginationToken"
        ] = None,
    ) -> "aws_sdk_workspaces.types.describe_application_associations_result.DescribeApplicationAssociationsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_application_associations_request.DescribeApplicationAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_application_associations_result.DescribeApplicationAssociationsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_application_associations.async_describe_application_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_applications(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.describe_applications_result.DescribeApplicationsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_applications_request.DescribeApplicationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_applications_result.DescribeApplicationsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_applications.async_describe_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_bundle_associations(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.describe_bundle_associations_result.DescribeBundleAssociationsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_bundle_associations_request.DescribeBundleAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_bundle_associations_result.DescribeBundleAssociationsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_bundle_associations.async_describe_bundle_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_client_branding(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.describe_client_branding_result.DescribeClientBrandingResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_client_branding_request.DescribeClientBrandingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_client_branding_result.DescribeClientBrandingResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_client_branding.async_describe_client_branding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_client_properties(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.describe_client_properties_result.DescribeClientPropertiesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_client_properties_request.DescribeClientPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_client_properties_result.DescribeClientPropertiesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_client_properties.async_describe_client_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_connect_client_add_ins(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None,
    ) -> "aws_sdk_workspaces.types.describe_connect_client_add_ins_result.DescribeConnectClientAddInsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_connect_client_add_ins_request.DescribeConnectClientAddInsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_connect_client_add_ins_result.DescribeConnectClientAddInsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_connect_client_add_ins.async_describe_connect_client_add_ins(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_connection_aliases(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        alias_ids: Optional[
            "aws_sdk_workspaces.types.connection_alias_id_list.ConnectionAliasIdList"
        ] = None,
        resource_id: Optional[
            "aws_sdk_workspaces.types.non_empty_string.NonEmptyString"
        ] = None,
        limit: Optional["aws_sdk_workspaces.types.limit.Limit"] = None,
        next_token: Optional[
            "aws_sdk_workspaces.types.pagination_token.PaginationToken"
        ] = None,
    ) -> "aws_sdk_workspaces.types.describe_connection_aliases_result.DescribeConnectionAliasesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_connection_aliases_request.DescribeConnectionAliasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_connection_aliases_result.DescribeConnectionAliasesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_connection_aliases.async_describe_connection_aliases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_connection_alias_permissions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None,
    ) -> "aws_sdk_workspaces.types.describe_connection_alias_permissions_result.DescribeConnectionAliasPermissionsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_connection_alias_permissions_request.DescribeConnectionAliasPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_connection_alias_permissions_result.DescribeConnectionAliasPermissionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_connection_alias_permissions.async_describe_connection_alias_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_custom_workspace_image_import(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.describe_custom_workspace_image_import_result.DescribeCustomWorkspaceImageImportResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_custom_workspace_image_import_request.DescribeCustomWorkspaceImageImportRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_custom_workspace_image_import_result.DescribeCustomWorkspaceImageImportResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_custom_workspace_image_import.async_describe_custom_workspace_image_import(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_image_associations(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.describe_image_associations_result.DescribeImageAssociationsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_image_associations_request.DescribeImageAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_image_associations_result.DescribeImageAssociationsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_image_associations.async_describe_image_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_ip_groups(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        group_ids: Optional[
            "aws_sdk_workspaces.types.ip_group_id_list.IpGroupIdList"
        ] = None,
        next_token: Optional[
            "aws_sdk_workspaces.types.pagination_token.PaginationToken"
        ] = None,
        max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None,
    ) -> "aws_sdk_workspaces.types.describe_ip_groups_result.DescribeIpGroupsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_ip_groups_request.DescribeIpGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_ip_groups_result.DescribeIpGroupsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_ip_groups.async_describe_ip_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_tags(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.describe_tags_result.DescribeTagsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_tags_request.DescribeTagsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_tags_result.DescribeTagsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_tags.async_describe_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_workspace_associations(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.describe_workspace_associations_result.DescribeWorkspaceAssociationsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_workspace_associations_request.DescribeWorkspaceAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_workspace_associations_result.DescribeWorkspaceAssociationsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_workspace_associations.async_describe_workspace_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_workspace_bundles(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        bundle_ids: Optional[
            "aws_sdk_workspaces.types.bundle_id_list.BundleIdList"
        ] = None,
        owner: Optional["aws_sdk_workspaces.types.bundle_owner.BundleOwner"] = None,
        next_token: Optional[
            "aws_sdk_workspaces.types.pagination_token.PaginationToken"
        ] = None,
    ) -> "aws_sdk_workspaces.types.describe_workspace_bundles_result.DescribeWorkspaceBundlesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_workspace_bundles_request.DescribeWorkspaceBundlesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_workspace_bundles_result.DescribeWorkspaceBundlesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_workspace_bundles.async_describe_workspace_bundles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_workspace_bundles(
        self,
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        bundle_ids: Optional[
    ...
    ) -> "AsyncIterator[aws_sdk_workspaces.types.workspace_bundle.WorkspaceBundle]":
        _token = next_token
        while True:
    ...
    async def describe_workspace_directories(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.describe_workspace_directories_result.DescribeWorkspaceDirectoriesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_workspace_directories_request.DescribeWorkspaceDirectoriesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_workspace_directories_result.DescribeWorkspaceDirectoriesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_workspace_directories.async_describe_workspace_directories(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_workspace_directories(
        self,
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        directory_ids: Optional[
        ...
        "AsyncIterator[aws_sdk_workspaces.types.workspace_directory.WorkspaceDirectory]"
    ):
        _token = next_token
        while True:
    ...
    async def describe_workspace_image_permissions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None,
    ) -> "aws_sdk_workspaces.types.describe_workspace_image_permissions_result.DescribeWorkspaceImagePermissionsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_workspace_image_permissions_request.DescribeWorkspaceImagePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_workspace_image_permissions_result.DescribeWorkspaceImagePermissionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_workspace_image_permissions.async_describe_workspace_image_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_workspace_images(
        ...
        *,
        ...
        image_type: Optional["aws_sdk_workspaces.types.image_type.ImageType"] = None,
        next_token: Optional[
            "aws_sdk_workspaces.types.pagination_token.PaginationToken"
        ] = None,
        max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None,
    ) -> "aws_sdk_workspaces.types.describe_workspace_images_result.DescribeWorkspaceImagesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_workspace_images_request.DescribeWorkspaceImagesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_workspace_images_result.DescribeWorkspaceImagesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_workspace_images.async_describe_workspace_images(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_workspaces(
        ...
        *,
        ...
        directory_id: Optional[
            "aws_sdk_workspaces.types.directory_id.DirectoryId"
        ] = None,
        user_name: Optional["aws_sdk_workspaces.types.user_name.UserName"] = None,
        bundle_id: Optional["aws_sdk_workspaces.types.bundle_id.BundleId"] = None,
        limit: Optional["aws_sdk_workspaces.types.limit.Limit"] = None,
        next_token: Optional[
            "aws_sdk_workspaces.types.pagination_token.PaginationToken"
        ...
        workspace_name: Optional[
            "aws_sdk_workspaces.types.workspace_name.WorkspaceName"
        ] = None,
    ) -> "aws_sdk_workspaces.types.describe_workspaces_result.DescribeWorkspacesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_workspaces_request.DescribeWorkspacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_workspaces_result.DescribeWorkspacesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_workspaces.async_describe_workspaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_workspaces(
        self,
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        workspace_ids: Optional[
    ...
    ) -> "AsyncIterator[aws_sdk_workspaces.types.workspace.Workspace]":
        _token = next_token
        while True:
    ...
    async def describe_workspaces_connection_status(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.describe_workspaces_connection_status_result.DescribeWorkspacesConnectionStatusResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_workspaces_connection_status_request.DescribeWorkspacesConnectionStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_workspaces_connection_status_result.DescribeWorkspacesConnectionStatusResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_workspaces_connection_status.async_describe_workspaces_connection_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_workspace_snapshots(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.describe_workspace_snapshots_result.DescribeWorkspaceSnapshotsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_workspace_snapshots_request.DescribeWorkspaceSnapshotsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_workspace_snapshots_result.DescribeWorkspaceSnapshotsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_workspace_snapshots.async_describe_workspace_snapshots(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_workspaces_pools(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.describe_workspaces_pools_result.DescribeWorkspacesPoolsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_workspaces_pools_request.DescribeWorkspacesPoolsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_workspaces_pools_result.DescribeWorkspacesPoolsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_workspaces_pools.async_describe_workspaces_pools(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_workspaces_pool_sessions(
        ...
        *,
        ...
        limit: Optional["aws_sdk_workspaces.types.limit50.Limit50"] = None,
        next_token: Optional[
            "aws_sdk_workspaces.types.pagination_token.PaginationToken"
        ] = None,
    ) -> "aws_sdk_workspaces.types.describe_workspaces_pool_sessions_result.DescribeWorkspacesPoolSessionsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.describe_workspaces_pool_sessions_request.DescribeWorkspacesPoolSessionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.describe_workspaces_pool_sessions_result.DescribeWorkspacesPoolSessionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.describe_workspaces_pool_sessions.async_describe_workspaces_pool_sessions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_connection_alias(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.disassociate_connection_alias_result.DisassociateConnectionAliasResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.disassociate_connection_alias_request.DisassociateConnectionAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.disassociate_connection_alias_result.DisassociateConnectionAliasResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.disassociate_connection_alias.async_disassociate_connection_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_ip_groups(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.disassociate_ip_groups_result.DisassociateIpGroupsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.disassociate_ip_groups_request.DisassociateIpGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.disassociate_ip_groups_result.DisassociateIpGroupsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.disassociate_ip_groups.async_disassociate_ip_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_workspace_application(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.disassociate_workspace_application_result.DisassociateWorkspaceApplicationResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.disassociate_workspace_application_request.DisassociateWorkspaceApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.disassociate_workspace_application_result.DisassociateWorkspaceApplicationResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.disassociate_workspace_application.async_disassociate_workspace_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_link(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        link_id: Optional["aws_sdk_workspaces.types.link_id.LinkId"] = None,
        linked_account_id: Optional[
            "aws_sdk_workspaces.types.aws_account.AwsAccount"
        ] = None,
    ) -> "aws_sdk_workspaces.types.get_account_link_result.GetAccountLinkResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.get_account_link_request.GetAccountLinkRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.get_account_link_result.GetAccountLinkResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.get_account_link.async_get_account_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_client_branding(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.import_client_branding_result.ImportClientBrandingResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.import_client_branding_request.ImportClientBrandingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.import_client_branding_result.ImportClientBrandingResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.import_client_branding.async_import_client_branding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_custom_workspace_image(
        ...
        image_description: "aws_sdk_workspaces.types.workspace_image_description.WorkspaceImageDescription",
        ...
        image_source: "aws_sdk_workspaces.types.image_source_identifier.ImageSourceIdentifier",
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_workspaces.types.import_custom_workspace_image_result.ImportCustomWorkspaceImageResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.import_custom_workspace_image_request.ImportCustomWorkspaceImageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.import_custom_workspace_image_result.ImportCustomWorkspaceImageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.import_custom_workspace_image.async_import_custom_workspace_image(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_workspace_image(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.import_workspace_image_result.ImportWorkspaceImageResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.import_workspace_image_request.ImportWorkspaceImageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.import_workspace_image_result.ImportWorkspaceImageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.import_workspace_image.async_import_workspace_image(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_account_links(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None,
    ) -> "aws_sdk_workspaces.types.list_account_links_result.ListAccountLinksResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.list_account_links_request.ListAccountLinksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.list_account_links_result.ListAccountLinksResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.list_account_links.async_list_account_links(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_account_links(
        self,
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        link_status_filter: Optional[
        ...
        max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None,
    ) -> "AsyncIterator[aws_sdk_workspaces.types.account_link.AccountLink]":
        _token = next_token
        while True:
    ...
    async def list_available_management_cidr_ranges(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.list_available_management_cidr_ranges_result.ListAvailableManagementCidrRangesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.list_available_management_cidr_ranges_request.ListAvailableManagementCidrRangesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.list_available_management_cidr_ranges_result.ListAvailableManagementCidrRangesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.list_available_management_cidr_ranges.async_list_available_management_cidr_ranges(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def migrate_workspace(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.migrate_workspace_result.MigrateWorkspaceResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.migrate_workspace_request.MigrateWorkspaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.migrate_workspace_result.MigrateWorkspaceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.migrate_workspace.async_migrate_workspace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_account(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.modify_account_result.ModifyAccountResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_account_request.ModifyAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_account_result.ModifyAccountResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_account.async_modify_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_certificate_based_auth_properties(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.modify_certificate_based_auth_properties_result.ModifyCertificateBasedAuthPropertiesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_certificate_based_auth_properties_request.ModifyCertificateBasedAuthPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_certificate_based_auth_properties_result.ModifyCertificateBasedAuthPropertiesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_certificate_based_auth_properties.async_modify_certificate_based_auth_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_client_properties(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.modify_client_properties_result.ModifyClientPropertiesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_client_properties_request.ModifyClientPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_client_properties_result.ModifyClientPropertiesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_client_properties.async_modify_client_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_endpoint_encryption_mode(
        self,
        directory_id: "aws_sdk_workspaces.types.directory_id.DirectoryId",
        endpoint_encryption_mode: "aws_sdk_workspaces.types.endpoint_encryption_mode.EndpointEncryptionMode",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.modify_endpoint_encryption_mode_response.ModifyEndpointEncryptionModeResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_endpoint_encryption_mode_request.ModifyEndpointEncryptionModeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_endpoint_encryption_mode_response.ModifyEndpointEncryptionModeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_endpoint_encryption_mode.async_modify_endpoint_encryption_mode(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_saml_properties(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.modify_saml_properties_result.ModifySamlPropertiesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_saml_properties_request.ModifySamlPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_saml_properties_result.ModifySamlPropertiesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_saml_properties.async_modify_saml_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_selfservice_permissions(
        self,
        resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId",
        selfservice_permissions: "aws_sdk_workspaces.types.selfservice_permissions.SelfservicePermissions",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.modify_selfservice_permissions_result.ModifySelfservicePermissionsResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_selfservice_permissions_request.ModifySelfservicePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_selfservice_permissions_result.ModifySelfservicePermissionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_selfservice_permissions.async_modify_selfservice_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_streaming_properties(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_streaming_properties_request.ModifyStreamingPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_streaming_properties_result.ModifyStreamingPropertiesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_streaming_properties.async_modify_streaming_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_workspace_access_properties(
        self,
        resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId",
        workspace_access_properties: "aws_sdk_workspaces.types.workspace_access_properties.WorkspaceAccessProperties",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.modify_workspace_access_properties_result.ModifyWorkspaceAccessPropertiesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_workspace_access_properties_request.ModifyWorkspaceAccessPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_workspace_access_properties_result.ModifyWorkspaceAccessPropertiesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_workspace_access_properties.async_modify_workspace_access_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_workspace_creation_properties(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.modify_workspace_creation_properties_result.ModifyWorkspaceCreationPropertiesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_workspace_creation_properties_request.ModifyWorkspaceCreationPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_workspace_creation_properties_result.ModifyWorkspaceCreationPropertiesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_workspace_creation_properties.async_modify_workspace_creation_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_workspace_properties(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.modify_workspace_properties_result.ModifyWorkspacePropertiesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_workspace_properties_request.ModifyWorkspacePropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_workspace_properties_result.ModifyWorkspacePropertiesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_workspace_properties.async_modify_workspace_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_workspace_state(
        self,
        workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId",
        workspace_state: "aws_sdk_workspaces.types.target_workspace_state.TargetWorkspaceState",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.modify_workspace_state_result.ModifyWorkspaceStateResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.modify_workspace_state_request.ModifyWorkspaceStateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.modify_workspace_state_result.ModifyWorkspaceStateResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.modify_workspace_state.async_modify_workspace_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reboot_workspaces(
        self,
        reboot_workspace_requests: "aws_sdk_workspaces.types.reboot_workspace_requests.RebootWorkspaceRequests",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.reboot_workspaces_result.RebootWorkspacesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.reboot_workspaces_request.RebootWorkspacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.reboot_workspaces_result.RebootWorkspacesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.reboot_workspaces.async_reboot_workspaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rebuild_workspaces(
        self,
        rebuild_workspace_requests: "aws_sdk_workspaces.types.rebuild_workspace_requests.RebuildWorkspaceRequests",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.rebuild_workspaces_result.RebuildWorkspacesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.rebuild_workspaces_request.RebuildWorkspacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.rebuild_workspaces_result.RebuildWorkspacesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.rebuild_workspaces.async_rebuild_workspaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_workspace_directory(
        ...
        *,
        ...
        subnet_ids: Optional["aws_sdk_workspaces.types.subnet_ids.SubnetIds"] = None,
        enable_self_service: Optional[
            "aws_sdk_workspaces.types.boolean_object.BooleanObject"
        ] = None,
        tenancy: Optional["aws_sdk_workspaces.types.tenancy.Tenancy"] = None,
        tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None,
        ...
        idc_instance_arn: Optional["aws_sdk_workspaces.types.arn.ARN"] = None,
        ...
        workspace_type: Optional[
            "aws_sdk_workspaces.types.workspace_type.WorkspaceType"
        ] = None,
        active_directory_config: Optional[
            "aws_sdk_workspaces.types.active_directory_config.ActiveDirectoryConfig"
        ] = None,
    ) -> "aws_sdk_workspaces.types.register_workspace_directory_result.RegisterWorkspaceDirectoryResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.register_workspace_directory_request.RegisterWorkspaceDirectoryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.register_workspace_directory_result.RegisterWorkspaceDirectoryResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.register_workspace_directory.async_register_workspace_directory(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reject_account_link_invitation(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.reject_account_link_invitation_result.RejectAccountLinkInvitationResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.reject_account_link_invitation_request.RejectAccountLinkInvitationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.reject_account_link_invitation_result.RejectAccountLinkInvitationResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.reject_account_link_invitation.async_reject_account_link_invitation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def restore_workspace(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.restore_workspace_result.RestoreWorkspaceResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.restore_workspace_request.RestoreWorkspaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.restore_workspace_result.RestoreWorkspaceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.restore_workspace.async_restore_workspace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def revoke_ip_rules(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.revoke_ip_rules_result.RevokeIpRulesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.revoke_ip_rules_request.RevokeIpRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.revoke_ip_rules_result.RevokeIpRulesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.revoke_ip_rules.async_revoke_ip_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_workspaces(
        self,
        start_workspace_requests: "aws_sdk_workspaces.types.start_workspace_requests.StartWorkspaceRequests",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.start_workspaces_result.StartWorkspacesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.start_workspaces_request.StartWorkspacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.start_workspaces_result.StartWorkspacesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.start_workspaces.async_start_workspaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_workspaces_pool(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.start_workspaces_pool_result.StartWorkspacesPoolResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.start_workspaces_pool_request.StartWorkspacesPoolRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.start_workspaces_pool_result.StartWorkspacesPoolResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.start_workspaces_pool.async_start_workspaces_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_workspaces(
        self,
        stop_workspace_requests: "aws_sdk_workspaces.types.stop_workspace_requests.StopWorkspaceRequests",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.stop_workspaces_result.StopWorkspacesResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.stop_workspaces_request.StopWorkspacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.stop_workspaces_result.StopWorkspacesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.stop_workspaces.async_stop_workspaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_workspaces_pool(
        ...
        *,
        ...
        "aws_sdk_workspaces.types.stop_workspaces_pool_result.StopWorkspacesPoolResult"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.stop_workspaces_pool_request.StopWorkspacesPoolRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.stop_workspaces_pool_result.StopWorkspacesPoolResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.stop_workspaces_pool.async_stop_workspaces_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def terminate_workspaces(
        ...
        *,
        ...
        "aws_sdk_workspaces.types.terminate_workspaces_result.TerminateWorkspacesResult"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.terminate_workspaces_request.TerminateWorkspacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.terminate_workspaces_result.TerminateWorkspacesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.terminate_workspaces.async_terminate_workspaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def terminate_workspaces_pool(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.terminate_workspaces_pool_result.TerminateWorkspacesPoolResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.terminate_workspaces_pool_request.TerminateWorkspacesPoolRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.terminate_workspaces_pool_result.TerminateWorkspacesPoolResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.terminate_workspaces_pool.async_terminate_workspaces_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def terminate_workspaces_pool_session(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.terminate_workspaces_pool_session_result.TerminateWorkspacesPoolSessionResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.terminate_workspaces_pool_session_request.TerminateWorkspacesPoolSessionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.terminate_workspaces_pool_session_result.TerminateWorkspacesPoolSessionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.terminate_workspaces_pool_session.async_terminate_workspaces_pool_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_connect_client_add_in(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
        name: Optional["aws_sdk_workspaces.types.add_in_name.AddInName"] = None,
        url: Optional["aws_sdk_workspaces.types.add_in_url.AddInUrl"] = None,
    ) -> "aws_sdk_workspaces.types.update_connect_client_add_in_result.UpdateConnectClientAddInResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.update_connect_client_add_in_request.UpdateConnectClientAddInRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.update_connect_client_add_in_result.UpdateConnectClientAddInResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.update_connect_client_add_in.async_update_connect_client_add_in(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_connection_alias_permission(
        self,
        alias_id: "aws_sdk_workspaces.types.connection_alias_id.ConnectionAliasId",
        connection_alias_permission: "aws_sdk_workspaces.types.connection_alias_permission.ConnectionAliasPermission",
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.update_connection_alias_permission_result.UpdateConnectionAliasPermissionResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.update_connection_alias_permission_request.UpdateConnectionAliasPermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.update_connection_alias_permission_result.UpdateConnectionAliasPermissionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.update_connection_alias_permission.async_update_connection_alias_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_rules_of_ip_group(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.update_rules_of_ip_group_result.UpdateRulesOfIpGroupResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.update_rules_of_ip_group_request.UpdateRulesOfIpGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.update_rules_of_ip_group_result.UpdateRulesOfIpGroupResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.update_rules_of_ip_group.async_update_rules_of_ip_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_workspace_bundle(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces.types.update_workspace_bundle_result.UpdateWorkspaceBundleResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.update_workspace_bundle_request.UpdateWorkspaceBundleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.update_workspace_bundle_result.UpdateWorkspaceBundleResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.update_workspace_bundle.async_update_workspace_bundle(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_workspace_image_permission(
        ...
        *,
        config_overrides: Optional[AsyncWorkSpacesClientConfig] = None,
    ) -> "aws_sdk_workspaces.types.update_workspace_image_permission_result.UpdateWorkspaceImagePermissionResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.update_workspace_image_permission_request.UpdateWorkspaceImagePermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.update_workspace_image_permission_result.UpdateWorkspaceImagePermissionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.update_workspace_image_permission.async_update_workspace_image_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_workspaces_pool(
        ...
        *,
        ...
        capacity: Optional["aws_sdk_workspaces.types.capacity.Capacity"] = None,
        application_settings: Optional[
            "aws_sdk_workspaces.types.application_settings_request.ApplicationSettingsRequest"
        ] = None,
        timeout_settings: Optional[
    ...
    ) -> "aws_sdk_workspaces.types.update_workspaces_pool_result.UpdateWorkspacesPoolResult":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces.types.update_workspaces_pool_request.UpdateWorkspacesPoolRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces.types.update_workspaces_pool_result.UpdateWorkspacesPoolResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces._operations.workspaces_service.update_workspaces_pool.async_update_workspaces_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
