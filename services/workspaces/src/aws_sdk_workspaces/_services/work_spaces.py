...
from aws_sdk_workspaces._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class WorkSpacesClientConfig(TypedDict, total=False):
...
class WorkSpacesClient:
    ...
    def accept_account_link_invitation(self, link_id: "aws_sdk_workspaces.types.link_id.LinkId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, client_token: Optional["aws_sdk_workspaces.types.client_token.ClientToken"] = None) -> "aws_sdk_workspaces.types.accept_account_link_invitation_result.AcceptAccountLinkInvitationResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.accept_account_link_invitation_request.AcceptAccountLinkInvitationRequest]') -> OperationResponse["aws_sdk_workspaces.types.accept_account_link_invitation_result.AcceptAccountLinkInvitationResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.accept_account_link_invitation
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.accept_account_link_invitation.accept_account_link_invitation(req.options, req.input)
    ...
    def associate_connection_alias(self, alias_id: "aws_sdk_workspaces.types.connection_alias_id.ConnectionAliasId", resource_id: "aws_sdk_workspaces.types.non_empty_string.NonEmptyString", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.associate_connection_alias_result.AssociateConnectionAliasResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.associate_connection_alias_request.AssociateConnectionAliasRequest]') -> OperationResponse["aws_sdk_workspaces.types.associate_connection_alias_result.AssociateConnectionAliasResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.associate_connection_alias
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.associate_connection_alias.associate_connection_alias(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def associate_ip_groups(self, directory_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", group_ids: "aws_sdk_workspaces.types.ip_group_id_list.IpGroupIdList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.associate_ip_groups_result.AssociateIpGroupsResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.associate_ip_groups_request.AssociateIpGroupsRequest]') -> OperationResponse["aws_sdk_workspaces.types.associate_ip_groups_result.AssociateIpGroupsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.associate_ip_groups
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.associate_ip_groups.associate_ip_groups(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def associate_workspace_application(self, workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId", application_id: "aws_sdk_workspaces.types.work_space_application_id.WorkSpaceApplicationId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.associate_workspace_application_result.AssociateWorkspaceApplicationResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.associate_workspace_application_request.AssociateWorkspaceApplicationRequest]') -> OperationResponse["aws_sdk_workspaces.types.associate_workspace_application_result.AssociateWorkspaceApplicationResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.associate_workspace_application
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.associate_workspace_application.associate_workspace_application(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def authorize_ip_rules(self, group_id: "aws_sdk_workspaces.types.ip_group_id.IpGroupId", user_rules: "aws_sdk_workspaces.types.ip_rule_list.IpRuleList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.authorize_ip_rules_result.AuthorizeIpRulesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.authorize_ip_rules_request.AuthorizeIpRulesRequest]') -> OperationResponse["aws_sdk_workspaces.types.authorize_ip_rules_result.AuthorizeIpRulesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.authorize_ip_rules
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.authorize_ip_rules.authorize_ip_rules(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def copy_workspace_image(self, name: "aws_sdk_workspaces.types.workspace_image_name.WorkspaceImageName", source_image_id: "aws_sdk_workspaces.types.workspace_image_id.WorkspaceImageId", source_region: "aws_sdk_workspaces.types.region.Region", *, config_overrides: Optional[WorkSpacesClientConfig] = None, description: Optional["aws_sdk_workspaces.types.workspace_image_description.WorkspaceImageDescription"] = None, tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None) -> "aws_sdk_workspaces.types.copy_workspace_image_result.CopyWorkspaceImageResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.copy_workspace_image_request.CopyWorkspaceImageRequest]') -> OperationResponse["aws_sdk_workspaces.types.copy_workspace_image_result.CopyWorkspaceImageResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.copy_workspace_image
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.copy_workspace_image.copy_workspace_image(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_account_link_invitation(self, target_account_id: "aws_sdk_workspaces.types.aws_account.AwsAccount", *, config_overrides: Optional[WorkSpacesClientConfig] = None, client_token: Optional["aws_sdk_workspaces.types.client_token.ClientToken"] = None) -> "aws_sdk_workspaces.types.create_account_link_invitation_result.CreateAccountLinkInvitationResult":
        ...
        Args:
            ...
            client_token: <p>A string of up to 64 ASCII characters that Amazon WorkSpaces uses to ensure idempotent creation.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_account_link_invitation_request.CreateAccountLinkInvitationRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_account_link_invitation_result.CreateAccountLinkInvitationResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_account_link_invitation
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_account_link_invitation.create_account_link_invitation(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_connect_client_add_in(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", name: "aws_sdk_workspaces.types.add_in_name.AddInName", url: "aws_sdk_workspaces.types.add_in_url.AddInUrl", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.create_connect_client_add_in_result.CreateConnectClientAddInResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_connect_client_add_in_request.CreateConnectClientAddInRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_connect_client_add_in_result.CreateConnectClientAddInResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_connect_client_add_in
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_connect_client_add_in.create_connect_client_add_in(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_connection_alias(self, connection_string: "aws_sdk_workspaces.types.connection_string.ConnectionString", *, config_overrides: Optional[WorkSpacesClientConfig] = None, tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None) -> "aws_sdk_workspaces.types.create_connection_alias_result.CreateConnectionAliasResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_connection_alias_request.CreateConnectionAliasRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_connection_alias_result.CreateConnectionAliasResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_connection_alias
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_connection_alias.create_connection_alias(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_ip_group(self, group_name: "aws_sdk_workspaces.types.ip_group_name.IpGroupName", *, config_overrides: Optional[WorkSpacesClientConfig] = None, group_desc: Optional["aws_sdk_workspaces.types.ip_group_desc.IpGroupDesc"] = None, user_rules: Optional["aws_sdk_workspaces.types.ip_rule_list.IpRuleList"] = None, tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None) -> "aws_sdk_workspaces.types.create_ip_group_result.CreateIpGroupResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_ip_group_request.CreateIpGroupRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_ip_group_result.CreateIpGroupResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_ip_group
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_ip_group.create_ip_group(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_standby_workspaces(self, primary_region: "aws_sdk_workspaces.types.region.Region", standby_workspaces: "aws_sdk_workspaces.types.standby_workspaces_list.StandbyWorkspacesList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.create_standby_workspaces_result.CreateStandbyWorkspacesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_standby_workspaces_request.CreateStandbyWorkspacesRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_standby_workspaces_result.CreateStandbyWorkspacesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_standby_workspaces
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_standby_workspaces.create_standby_workspaces(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_tags(self, resource_id: "aws_sdk_workspaces.types.non_empty_string.NonEmptyString", tags: "aws_sdk_workspaces.types.tag_list.TagList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.create_tags_result.CreateTagsResult":
        ...
        Args:
            ...
            tags: <p>The tags. Each WorkSpaces resource can have a maximum of 50 tags.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_tags_request.CreateTagsRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_tags_result.CreateTagsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_tags
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_tags.create_tags(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_updated_workspace_image(self, name: "aws_sdk_workspaces.types.workspace_image_name.WorkspaceImageName", description: "aws_sdk_workspaces.types.workspace_image_description.WorkspaceImageDescription", source_image_id: "aws_sdk_workspaces.types.workspace_image_id.WorkspaceImageId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None) -> "aws_sdk_workspaces.types.create_updated_workspace_image_result.CreateUpdatedWorkspaceImageResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_updated_workspace_image_request.CreateUpdatedWorkspaceImageRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_updated_workspace_image_result.CreateUpdatedWorkspaceImageResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_updated_workspace_image
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_updated_workspace_image.create_updated_workspace_image(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_workspace_bundle(self, bundle_name: "aws_sdk_workspaces.types.workspace_bundle_name.WorkspaceBundleName", bundle_description: "aws_sdk_workspaces.types.workspace_bundle_description.WorkspaceBundleDescription", image_id: "aws_sdk_workspaces.types.workspace_image_id.WorkspaceImageId", compute_type: "aws_sdk_workspaces.types.compute_type.ComputeType", user_storage: "aws_sdk_workspaces.types.user_storage.UserStorage", *, config_overrides: Optional[WorkSpacesClientConfig] = None, root_storage: Optional["aws_sdk_workspaces.types.root_storage.RootStorage"] = None, tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None) -> "aws_sdk_workspaces.types.create_workspace_bundle_result.CreateWorkspaceBundleResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_workspace_bundle_request.CreateWorkspaceBundleRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_workspace_bundle_result.CreateWorkspaceBundleResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_workspace_bundle
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_workspace_bundle.create_workspace_bundle(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_workspace_image(self, name: "aws_sdk_workspaces.types.workspace_image_name.WorkspaceImageName", description: "aws_sdk_workspaces.types.workspace_image_description.WorkspaceImageDescription", workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None) -> "aws_sdk_workspaces.types.create_workspace_image_result.CreateWorkspaceImageResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_workspace_image_request.CreateWorkspaceImageRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_workspace_image_result.CreateWorkspaceImageResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_workspace_image
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_workspace_image.create_workspace_image(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_workspaces(self, workspaces: "aws_sdk_workspaces.types.workspace_request_list.WorkspaceRequestList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.create_workspaces_result.CreateWorkspacesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_workspaces_request.CreateWorkspacesRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_workspaces_result.CreateWorkspacesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_workspaces
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_workspaces.create_workspaces(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_workspaces_pool(self, pool_name: "aws_sdk_workspaces.types.workspaces_pool_name.WorkspacesPoolName", description: "aws_sdk_workspaces.types.update_description.UpdateDescription", bundle_id: "aws_sdk_workspaces.types.bundle_id.BundleId", directory_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", capacity: "aws_sdk_workspaces.types.capacity.Capacity", *, config_overrides: Optional[WorkSpacesClientConfig] = None, tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None, application_settings: Optional["aws_sdk_workspaces.types.application_settings_request.ApplicationSettingsRequest"] = None, timeout_settings: Optional["aws_sdk_workspaces.types.timeout_settings.TimeoutSettings"] = None, running_mode: Optional["aws_sdk_workspaces.types.pools_running_mode.PoolsRunningMode"] = None) -> "aws_sdk_workspaces.types.create_workspaces_pool_result.CreateWorkspacesPoolResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.create_workspaces_pool_request.CreateWorkspacesPoolRequest]') -> OperationResponse["aws_sdk_workspaces.types.create_workspaces_pool_result.CreateWorkspacesPoolResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.create_workspaces_pool
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.create_workspaces_pool.create_workspaces_pool(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_account_link_invitation(self, link_id: "aws_sdk_workspaces.types.link_id.LinkId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, client_token: Optional["aws_sdk_workspaces.types.client_token.ClientToken"] = None) -> "aws_sdk_workspaces.types.delete_account_link_invitation_result.DeleteAccountLinkInvitationResult":
        ...
        Args:
            ...
            client_token: <p>A string of up to 64 ASCII characters that Amazon WorkSpaces uses to ensure idempotent creation.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.delete_account_link_invitation_request.DeleteAccountLinkInvitationRequest]') -> OperationResponse["aws_sdk_workspaces.types.delete_account_link_invitation_result.DeleteAccountLinkInvitationResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.delete_account_link_invitation
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.delete_account_link_invitation.delete_account_link_invitation(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_client_branding(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", platforms: "aws_sdk_workspaces.types.client_device_type_list.ClientDeviceTypeList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.delete_client_branding_result.DeleteClientBrandingResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.delete_client_branding_request.DeleteClientBrandingRequest]') -> OperationResponse["aws_sdk_workspaces.types.delete_client_branding_result.DeleteClientBrandingResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.delete_client_branding
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.delete_client_branding.delete_client_branding(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_connect_client_add_in(self, add_in_id: "aws_sdk_workspaces.types.amazon_uuid.AmazonUuid", resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.delete_connect_client_add_in_result.DeleteConnectClientAddInResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.delete_connect_client_add_in_request.DeleteConnectClientAddInRequest]') -> OperationResponse["aws_sdk_workspaces.types.delete_connect_client_add_in_result.DeleteConnectClientAddInResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.delete_connect_client_add_in
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.delete_connect_client_add_in.delete_connect_client_add_in(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_connection_alias(self, alias_id: "aws_sdk_workspaces.types.connection_alias_id.ConnectionAliasId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.delete_connection_alias_result.DeleteConnectionAliasResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.delete_connection_alias_request.DeleteConnectionAliasRequest]') -> OperationResponse["aws_sdk_workspaces.types.delete_connection_alias_result.DeleteConnectionAliasResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.delete_connection_alias
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.delete_connection_alias.delete_connection_alias(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_ip_group(self, group_id: "aws_sdk_workspaces.types.ip_group_id.IpGroupId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.delete_ip_group_result.DeleteIpGroupResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.delete_ip_group_request.DeleteIpGroupRequest]') -> OperationResponse["aws_sdk_workspaces.types.delete_ip_group_result.DeleteIpGroupResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.delete_ip_group
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.delete_ip_group.delete_ip_group(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_tags(self, resource_id: "aws_sdk_workspaces.types.non_empty_string.NonEmptyString", tag_keys: "aws_sdk_workspaces.types.tag_key_list.TagKeyList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.delete_tags_result.DeleteTagsResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.delete_tags_request.DeleteTagsRequest]') -> OperationResponse["aws_sdk_workspaces.types.delete_tags_result.DeleteTagsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.delete_tags
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.delete_tags.delete_tags(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_workspace_bundle(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, bundle_id: Optional["aws_sdk_workspaces.types.bundle_id.BundleId"] = None) -> "aws_sdk_workspaces.types.delete_workspace_bundle_result.DeleteWorkspaceBundleResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.delete_workspace_bundle_request.DeleteWorkspaceBundleRequest]') -> OperationResponse["aws_sdk_workspaces.types.delete_workspace_bundle_result.DeleteWorkspaceBundleResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.delete_workspace_bundle
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.delete_workspace_bundle.delete_workspace_bundle(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_workspace_image(self, image_id: "aws_sdk_workspaces.types.workspace_image_id.WorkspaceImageId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.delete_workspace_image_result.DeleteWorkspaceImageResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.delete_workspace_image_request.DeleteWorkspaceImageRequest]') -> OperationResponse["aws_sdk_workspaces.types.delete_workspace_image_result.DeleteWorkspaceImageResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.delete_workspace_image
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.delete_workspace_image.delete_workspace_image(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def deploy_workspace_applications(self, workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, force: Optional["aws_sdk_workspaces.types.boolean_object.BooleanObject"] = None) -> "aws_sdk_workspaces.types.deploy_workspace_applications_result.DeployWorkspaceApplicationsResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.deploy_workspace_applications_request.DeployWorkspaceApplicationsRequest]') -> OperationResponse["aws_sdk_workspaces.types.deploy_workspace_applications_result.DeployWorkspaceApplicationsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.deploy_workspace_applications
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.deploy_workspace_applications.deploy_workspace_applications(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def deregister_workspace_directory(self, directory_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.deregister_workspace_directory_result.DeregisterWorkspaceDirectoryResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.deregister_workspace_directory_request.DeregisterWorkspaceDirectoryRequest]') -> OperationResponse["aws_sdk_workspaces.types.deregister_workspace_directory_result.DeregisterWorkspaceDirectoryResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.deregister_workspace_directory
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.deregister_workspace_directory.deregister_workspace_directory(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_account(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.describe_account_result.DescribeAccountResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_account_request.DescribeAccountRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_account_result.DescribeAccountResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_account
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_account.describe_account(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_account_modifications(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_workspaces.types.describe_account_modifications_result.DescribeAccountModificationsResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_account_modifications_request.DescribeAccountModificationsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_account_modifications_result.DescribeAccountModificationsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_account_modifications
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_account_modifications.describe_account_modifications(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_application_associations(self, application_id: "aws_sdk_workspaces.types.work_space_application_id.WorkSpaceApplicationId", associated_resource_types: "aws_sdk_workspaces.types.application_associated_resource_type_list.ApplicationAssociatedResourceTypeList", *, config_overrides: Optional[WorkSpacesClientConfig] = None, max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_workspaces.types.describe_application_associations_result.DescribeApplicationAssociationsResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_application_associations_request.DescribeApplicationAssociationsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_application_associations_result.DescribeApplicationAssociationsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_application_associations
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_application_associations.describe_application_associations(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_applications(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, application_ids: Optional["aws_sdk_workspaces.types.work_space_application_id_list.WorkSpaceApplicationIdList"] = None, compute_type_names: Optional["aws_sdk_workspaces.types.compute_list.ComputeList"] = None, license_type: Optional["aws_sdk_workspaces.types.work_space_application_license_type.WorkSpaceApplicationLicenseType"] = None, operating_system_names: Optional["aws_sdk_workspaces.types.operating_system_name_list.OperatingSystemNameList"] = None, owner: Optional["aws_sdk_workspaces.types.work_space_application_owner.WorkSpaceApplicationOwner"] = None, max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_workspaces.types.describe_applications_result.DescribeApplicationsResult":
        ...
        Args:
            ...
            next_token: <p>If you received a <code>NextToken</code> from a previous call that was paginated, provide this token to receive the next set of results.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_applications_request.DescribeApplicationsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_applications_result.DescribeApplicationsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_applications
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_applications.describe_applications(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_bundle_associations(self, bundle_id: "aws_sdk_workspaces.types.bundle_id.BundleId", associated_resource_types: "aws_sdk_workspaces.types.bundle_associated_resource_type_list.BundleAssociatedResourceTypeList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.describe_bundle_associations_result.DescribeBundleAssociationsResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_bundle_associations_request.DescribeBundleAssociationsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_bundle_associations_result.DescribeBundleAssociationsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_bundle_associations
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_bundle_associations.describe_bundle_associations(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_client_branding(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.describe_client_branding_result.DescribeClientBrandingResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_client_branding_request.DescribeClientBrandingRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_client_branding_result.DescribeClientBrandingResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_client_branding
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_client_branding.describe_client_branding(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_client_properties(self, resource_ids: "aws_sdk_workspaces.types.resource_id_list.ResourceIdList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.describe_client_properties_result.DescribeClientPropertiesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_client_properties_request.DescribeClientPropertiesRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_client_properties_result.DescribeClientPropertiesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_client_properties
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_client_properties.describe_client_properties(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_connect_client_add_ins(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None, max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None) -> "aws_sdk_workspaces.types.describe_connect_client_add_ins_result.DescribeConnectClientAddInsResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_connect_client_add_ins_request.DescribeConnectClientAddInsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_connect_client_add_ins_result.DescribeConnectClientAddInsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_connect_client_add_ins
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_connect_client_add_ins.describe_connect_client_add_ins(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_connection_aliases(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, alias_ids: Optional["aws_sdk_workspaces.types.connection_alias_id_list.ConnectionAliasIdList"] = None, resource_id: Optional["aws_sdk_workspaces.types.non_empty_string.NonEmptyString"] = None, limit: Optional["aws_sdk_workspaces.types.limit.Limit"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_workspaces.types.describe_connection_aliases_result.DescribeConnectionAliasesResult":
        ...
        Args:
            ...
            next_token: <p>If you received a <code>NextToken</code> from a previous call that was paginated, provide this token to receive the next set of results. </p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_connection_aliases_request.DescribeConnectionAliasesRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_connection_aliases_result.DescribeConnectionAliasesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_connection_aliases
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_connection_aliases.describe_connection_aliases(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_connection_alias_permissions(self, alias_id: "aws_sdk_workspaces.types.connection_alias_id.ConnectionAliasId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None, max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None) -> "aws_sdk_workspaces.types.describe_connection_alias_permissions_result.DescribeConnectionAliasPermissionsResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_connection_alias_permissions_request.DescribeConnectionAliasPermissionsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_connection_alias_permissions_result.DescribeConnectionAliasPermissionsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_connection_alias_permissions
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_connection_alias_permissions.describe_connection_alias_permissions(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_custom_workspace_image_import(self, image_id: "aws_sdk_workspaces.types.workspace_image_id.WorkspaceImageId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.describe_custom_workspace_image_import_result.DescribeCustomWorkspaceImageImportResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_custom_workspace_image_import_request.DescribeCustomWorkspaceImageImportRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_custom_workspace_image_import_result.DescribeCustomWorkspaceImageImportResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_custom_workspace_image_import
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_custom_workspace_image_import.describe_custom_workspace_image_import(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_image_associations(self, image_id: "aws_sdk_workspaces.types.workspace_image_id.WorkspaceImageId", associated_resource_types: "aws_sdk_workspaces.types.image_associated_resource_type_list.ImageAssociatedResourceTypeList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.describe_image_associations_result.DescribeImageAssociationsResult":
        ...
        Args:
            ...
            associated_resource_types: <p>The resource types of the associated resource.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_image_associations_request.DescribeImageAssociationsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_image_associations_result.DescribeImageAssociationsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_image_associations
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_image_associations.describe_image_associations(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_ip_groups(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, group_ids: Optional["aws_sdk_workspaces.types.ip_group_id_list.IpGroupIdList"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None, max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None) -> "aws_sdk_workspaces.types.describe_ip_groups_result.DescribeIpGroupsResult":
        ...
        Args:
            ...
            max_results: <p>The maximum number of items to return.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_ip_groups_request.DescribeIpGroupsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_ip_groups_result.DescribeIpGroupsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_ip_groups
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_ip_groups.describe_ip_groups(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_tags(self, resource_id: "aws_sdk_workspaces.types.non_empty_string.NonEmptyString", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.describe_tags_result.DescribeTagsResult":
        ...
        Args:
            resource_id: <p>The identifier of the WorkSpaces resource. The supported resource types are WorkSpaces, registered directories, images, custom bundles, IP access control groups, and connection aliases.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_tags_request.DescribeTagsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_tags_result.DescribeTagsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_tags
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_tags.describe_tags(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workspace_associations(self, workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId", associated_resource_types: "aws_sdk_workspaces.types.work_space_associated_resource_type_list.WorkSpaceAssociatedResourceTypeList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.describe_workspace_associations_result.DescribeWorkspaceAssociationsResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_workspace_associations_request.DescribeWorkspaceAssociationsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_workspace_associations_result.DescribeWorkspaceAssociationsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_workspace_associations
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_workspace_associations.describe_workspace_associations(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workspace_bundles(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, bundle_ids: Optional["aws_sdk_workspaces.types.bundle_id_list.BundleIdList"] = None, owner: Optional["aws_sdk_workspaces.types.bundle_owner.BundleOwner"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_workspaces.types.describe_workspace_bundles_result.DescribeWorkspaceBundlesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_workspace_bundles_request.DescribeWorkspaceBundlesRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_workspace_bundles_result.DescribeWorkspaceBundlesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_workspace_bundles
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_workspace_bundles.describe_workspace_bundles(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workspace_directories(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, directory_ids: Optional["aws_sdk_workspaces.types.directory_id_list.DirectoryIdList"] = None, workspace_directory_names: Optional["aws_sdk_workspaces.types.workspace_directory_name_list.WorkspaceDirectoryNameList"] = None, limit: Optional["aws_sdk_workspaces.types.limit.Limit"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None, filters: Optional["aws_sdk_workspaces.types.describe_workspace_directories_filter_list.DescribeWorkspaceDirectoriesFilterList"] = None) -> "aws_sdk_workspaces.types.describe_workspace_directories_result.DescribeWorkspaceDirectoriesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_workspace_directories_request.DescribeWorkspaceDirectoriesRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_workspace_directories_result.DescribeWorkspaceDirectoriesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_workspace_directories
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_workspace_directories.describe_workspace_directories(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_workspace_directories(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, directory_ids: Optional["aws_sdk_workspaces.types.directory_id_list.DirectoryIdList"] = None, workspace_directory_names: Optional["aws_sdk_workspaces.types.workspace_directory_name_list.WorkspaceDirectoryNameList"] = None, limit: Optional["aws_sdk_workspaces.types.limit.Limit"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None, filters: Optional["aws_sdk_workspaces.types.describe_workspace_directories_filter_list.DescribeWorkspaceDirectoriesFilterList"] = None) -> "Iterator[aws_sdk_workspaces.types.workspace_directory.WorkspaceDirectory]":
        ...
        while True:
            ...
            if not _token:
                break
    def describe_workspace_image_permissions(self, image_id: "aws_sdk_workspaces.types.workspace_image_id.WorkspaceImageId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None, max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None) -> "aws_sdk_workspaces.types.describe_workspace_image_permissions_result.DescribeWorkspaceImagePermissionsResult":
        ...
        Args:
            ...
            max_results: <p>The maximum number of items to return.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_workspace_image_permissions_request.DescribeWorkspaceImagePermissionsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_workspace_image_permissions_result.DescribeWorkspaceImagePermissionsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_workspace_image_permissions
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_workspace_image_permissions.describe_workspace_image_permissions(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workspace_images(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, image_ids: Optional["aws_sdk_workspaces.types.workspace_image_id_list.WorkspaceImageIdList"] = None, image_type: Optional["aws_sdk_workspaces.types.image_type.ImageType"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None, max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None) -> "aws_sdk_workspaces.types.describe_workspace_images_result.DescribeWorkspaceImagesResult":
        ...
        Args:
            ...
            max_results: <p>The maximum number of items to return.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_workspace_images_request.DescribeWorkspaceImagesRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_workspace_images_result.DescribeWorkspaceImagesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_workspace_images
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_workspace_images.describe_workspace_images(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workspaces(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, workspace_ids: Optional["aws_sdk_workspaces.types.workspace_id_list.WorkspaceIdList"] = None, directory_id: Optional["aws_sdk_workspaces.types.directory_id.DirectoryId"] = None, user_name: Optional["aws_sdk_workspaces.types.user_name.UserName"] = None, bundle_id: Optional["aws_sdk_workspaces.types.bundle_id.BundleId"] = None, limit: Optional["aws_sdk_workspaces.types.limit.Limit"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None, workspace_name: Optional["aws_sdk_workspaces.types.workspace_name.WorkspaceName"] = None) -> "aws_sdk_workspaces.types.describe_workspaces_result.DescribeWorkspacesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_workspaces_request.DescribeWorkspacesRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_workspaces_result.DescribeWorkspacesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_workspaces
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_workspaces.describe_workspaces(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workspaces_connection_status(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, workspace_ids: Optional["aws_sdk_workspaces.types.workspace_id_list.WorkspaceIdList"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_workspaces.types.describe_workspaces_connection_status_result.DescribeWorkspacesConnectionStatusResult":
        ...
        Args:
            ...
            next_token: <p>If you received a <code>NextToken</code> from a previous call that was paginated, provide this token to receive the next set of results.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_workspaces_connection_status_request.DescribeWorkspacesConnectionStatusRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_workspaces_connection_status_result.DescribeWorkspacesConnectionStatusResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_workspaces_connection_status
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_workspaces_connection_status.describe_workspaces_connection_status(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workspace_snapshots(self, workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.describe_workspace_snapshots_result.DescribeWorkspaceSnapshotsResult":
        ...
        Args:
            workspace_id: <p>The identifier of the WorkSpace.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_workspace_snapshots_request.DescribeWorkspaceSnapshotsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_workspace_snapshots_result.DescribeWorkspaceSnapshotsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_workspace_snapshots
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_workspace_snapshots.describe_workspace_snapshots(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workspaces_pools(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, pool_ids: Optional["aws_sdk_workspaces.types.workspaces_pool_ids.WorkspacesPoolIds"] = None, filters: Optional["aws_sdk_workspaces.types.describe_workspaces_pools_filters.DescribeWorkspacesPoolsFilters"] = None, limit: Optional["aws_sdk_workspaces.types.limit.Limit"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_workspaces.types.describe_workspaces_pools_result.DescribeWorkspacesPoolsResult":
        ...
        Args:
            ...
            next_token: <p>If you received a <code>NextToken</code> from a previous call that was paginated, provide this token to receive the next set of results.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_workspaces_pools_request.DescribeWorkspacesPoolsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_workspaces_pools_result.DescribeWorkspacesPoolsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_workspaces_pools
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_workspaces_pools.describe_workspaces_pools(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workspaces_pool_sessions(self, pool_id: "aws_sdk_workspaces.types.workspaces_pool_id.WorkspacesPoolId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, user_id: Optional["aws_sdk_workspaces.types.workspaces_pool_user_id.WorkspacesPoolUserId"] = None, limit: Optional["aws_sdk_workspaces.types.limit50.Limit50"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_workspaces.types.describe_workspaces_pool_sessions_result.DescribeWorkspacesPoolSessionsResult":
        ...
        Args:
            ...
            next_token: <p>If you received a <code>NextToken</code> from a previous call that was paginated, provide this token to receive the next set of results.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.describe_workspaces_pool_sessions_request.DescribeWorkspacesPoolSessionsRequest]') -> OperationResponse["aws_sdk_workspaces.types.describe_workspaces_pool_sessions_result.DescribeWorkspacesPoolSessionsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.describe_workspaces_pool_sessions
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.describe_workspaces_pool_sessions.describe_workspaces_pool_sessions(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_connection_alias(self, alias_id: "aws_sdk_workspaces.types.connection_alias_id.ConnectionAliasId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.disassociate_connection_alias_result.DisassociateConnectionAliasResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.disassociate_connection_alias_request.DisassociateConnectionAliasRequest]') -> OperationResponse["aws_sdk_workspaces.types.disassociate_connection_alias_result.DisassociateConnectionAliasResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.disassociate_connection_alias
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.disassociate_connection_alias.disassociate_connection_alias(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_ip_groups(self, directory_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", group_ids: "aws_sdk_workspaces.types.ip_group_id_list.IpGroupIdList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.disassociate_ip_groups_result.DisassociateIpGroupsResult":
        ...
        Args:
            ...
            group_ids: <p>The identifiers of one or more IP access control groups.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.disassociate_ip_groups_request.DisassociateIpGroupsRequest]') -> OperationResponse["aws_sdk_workspaces.types.disassociate_ip_groups_result.DisassociateIpGroupsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.disassociate_ip_groups
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.disassociate_ip_groups.disassociate_ip_groups(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_workspace_application(self, workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId", application_id: "aws_sdk_workspaces.types.work_space_application_id.WorkSpaceApplicationId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.disassociate_workspace_application_result.DisassociateWorkspaceApplicationResult":
        ...
        Args:
            ...
            application_id: <p>The identifier of the application.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.disassociate_workspace_application_request.DisassociateWorkspaceApplicationRequest]') -> OperationResponse["aws_sdk_workspaces.types.disassociate_workspace_application_result.DisassociateWorkspaceApplicationResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.disassociate_workspace_application
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.disassociate_workspace_application.disassociate_workspace_application(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def get_account_link(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, link_id: Optional["aws_sdk_workspaces.types.link_id.LinkId"] = None, linked_account_id: Optional["aws_sdk_workspaces.types.aws_account.AwsAccount"] = None) -> "aws_sdk_workspaces.types.get_account_link_result.GetAccountLinkResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.get_account_link_request.GetAccountLinkRequest]') -> OperationResponse["aws_sdk_workspaces.types.get_account_link_result.GetAccountLinkResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.get_account_link
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.get_account_link.get_account_link(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def import_client_branding(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, device_type_windows: Optional["aws_sdk_workspaces.types.default_import_client_branding_attributes.DefaultImportClientBrandingAttributes"] = None, device_type_osx: Optional["aws_sdk_workspaces.types.default_import_client_branding_attributes.DefaultImportClientBrandingAttributes"] = None, device_type_android: Optional["aws_sdk_workspaces.types.default_import_client_branding_attributes.DefaultImportClientBrandingAttributes"] = None, device_type_ios: Optional["aws_sdk_workspaces.types.ios_import_client_branding_attributes.IosImportClientBrandingAttributes"] = None, device_type_linux: Optional["aws_sdk_workspaces.types.default_import_client_branding_attributes.DefaultImportClientBrandingAttributes"] = None, device_type_web: Optional["aws_sdk_workspaces.types.default_import_client_branding_attributes.DefaultImportClientBrandingAttributes"] = None) -> "aws_sdk_workspaces.types.import_client_branding_result.ImportClientBrandingResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.import_client_branding_request.ImportClientBrandingRequest]') -> OperationResponse["aws_sdk_workspaces.types.import_client_branding_result.ImportClientBrandingResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.import_client_branding
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.import_client_branding.import_client_branding(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def import_custom_workspace_image(self, image_name: "aws_sdk_workspaces.types.workspace_image_name.WorkspaceImageName", image_description: "aws_sdk_workspaces.types.workspace_image_description.WorkspaceImageDescription", compute_type: "aws_sdk_workspaces.types.image_compute_type.ImageComputeType", protocol: "aws_sdk_workspaces.types.custom_image_protocol.CustomImageProtocol", image_source: "aws_sdk_workspaces.types.image_source_identifier.ImageSourceIdentifier", infrastructure_configuration_arn: "aws_sdk_workspaces.types.infrastructure_configuration_arn.InfrastructureConfigurationArn", platform: "aws_sdk_workspaces.types.platform.Platform", os_version: "aws_sdk_workspaces.types.os_version.OSVersion", *, config_overrides: Optional[WorkSpacesClientConfig] = None, tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None) -> "aws_sdk_workspaces.types.import_custom_workspace_image_result.ImportCustomWorkspaceImageResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.import_custom_workspace_image_request.ImportCustomWorkspaceImageRequest]') -> OperationResponse["aws_sdk_workspaces.types.import_custom_workspace_image_result.ImportCustomWorkspaceImageResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.import_custom_workspace_image
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.import_custom_workspace_image.import_custom_workspace_image(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def import_workspace_image(self, ec2_image_id: "aws_sdk_workspaces.types.ec2_image_id.Ec2ImageId", ingestion_process: "aws_sdk_workspaces.types.workspace_image_ingestion_process.WorkspaceImageIngestionProcess", image_name: "aws_sdk_workspaces.types.workspace_image_name.WorkspaceImageName", image_description: "aws_sdk_workspaces.types.workspace_image_description.WorkspaceImageDescription", *, config_overrides: Optional[WorkSpacesClientConfig] = None, tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None, applications: Optional["aws_sdk_workspaces.types.application_list.ApplicationList"] = None) -> "aws_sdk_workspaces.types.import_workspace_image_result.ImportWorkspaceImageResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.import_workspace_image_request.ImportWorkspaceImageRequest]') -> OperationResponse["aws_sdk_workspaces.types.import_workspace_image_result.ImportWorkspaceImageResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.import_workspace_image
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.import_workspace_image.import_workspace_image(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def list_account_links(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, link_status_filter: Optional["aws_sdk_workspaces.types.link_status_filter_list.LinkStatusFilterList"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None, max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None) -> "aws_sdk_workspaces.types.list_account_links_result.ListAccountLinksResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.list_account_links_request.ListAccountLinksRequest]') -> OperationResponse["aws_sdk_workspaces.types.list_account_links_result.ListAccountLinksResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.list_account_links
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.list_account_links.list_account_links(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_account_links(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, link_status_filter: Optional["aws_sdk_workspaces.types.link_status_filter_list.LinkStatusFilterList"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None, max_results: Optional["aws_sdk_workspaces.types.limit.Limit"] = None) -> "Iterator[aws_sdk_workspaces.types.account_link.AccountLink]":
        ...
        while True:
            ...
            if not _token:
                break
    def list_available_management_cidr_ranges(self, management_cidr_range_constraint: "aws_sdk_workspaces.types.management_cidr_range_constraint.ManagementCidrRangeConstraint", *, config_overrides: Optional[WorkSpacesClientConfig] = None, max_results: Optional["aws_sdk_workspaces.types.management_cidr_range_max_results.ManagementCidrRangeMaxResults"] = None, next_token: Optional["aws_sdk_workspaces.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_workspaces.types.list_available_management_cidr_ranges_result.ListAvailableManagementCidrRangesResult":
        ...
        Args:
            ...
            next_token: <p>If you received a <code>NextToken</code> from a previous call that was paginated, provide this token to receive the next set of results.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.list_available_management_cidr_ranges_request.ListAvailableManagementCidrRangesRequest]') -> OperationResponse["aws_sdk_workspaces.types.list_available_management_cidr_ranges_result.ListAvailableManagementCidrRangesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.list_available_management_cidr_ranges
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.list_available_management_cidr_ranges.list_available_management_cidr_ranges(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def migrate_workspace(self, source_workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId", bundle_id: "aws_sdk_workspaces.types.bundle_id.BundleId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.migrate_workspace_result.MigrateWorkspaceResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.migrate_workspace_request.MigrateWorkspaceRequest]') -> OperationResponse["aws_sdk_workspaces.types.migrate_workspace_result.MigrateWorkspaceResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.migrate_workspace
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.migrate_workspace.migrate_workspace(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_account(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, dedicated_tenancy_support: Optional["aws_sdk_workspaces.types.dedicated_tenancy_support_enum.DedicatedTenancySupportEnum"] = None, dedicated_tenancy_management_cidr_range: Optional["aws_sdk_workspaces.types.dedicated_tenancy_management_cidr_range.DedicatedTenancyManagementCidrRange"] = None) -> "aws_sdk_workspaces.types.modify_account_result.ModifyAccountResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_account_request.ModifyAccountRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_account_result.ModifyAccountResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_account
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_account.modify_account(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_certificate_based_auth_properties(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, certificate_based_auth_properties: Optional["aws_sdk_workspaces.types.certificate_based_auth_properties.CertificateBasedAuthProperties"] = None, properties_to_delete: Optional["aws_sdk_workspaces.types.deletable_certificate_based_auth_properties_list.DeletableCertificateBasedAuthPropertiesList"] = None) -> "aws_sdk_workspaces.types.modify_certificate_based_auth_properties_result.ModifyCertificateBasedAuthPropertiesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_certificate_based_auth_properties_request.ModifyCertificateBasedAuthPropertiesRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_certificate_based_auth_properties_result.ModifyCertificateBasedAuthPropertiesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_certificate_based_auth_properties
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_certificate_based_auth_properties.modify_certificate_based_auth_properties(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_client_properties(self, resource_id: "aws_sdk_workspaces.types.non_empty_string.NonEmptyString", client_properties: "aws_sdk_workspaces.types.client_properties.ClientProperties", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.modify_client_properties_result.ModifyClientPropertiesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_client_properties_request.ModifyClientPropertiesRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_client_properties_result.ModifyClientPropertiesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_client_properties
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_client_properties.modify_client_properties(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_endpoint_encryption_mode(self, directory_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", endpoint_encryption_mode: "aws_sdk_workspaces.types.endpoint_encryption_mode.EndpointEncryptionMode", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.modify_endpoint_encryption_mode_response.ModifyEndpointEncryptionModeResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_endpoint_encryption_mode_request.ModifyEndpointEncryptionModeRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_endpoint_encryption_mode_response.ModifyEndpointEncryptionModeResponse"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_endpoint_encryption_mode
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_endpoint_encryption_mode.modify_endpoint_encryption_mode(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_saml_properties(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, saml_properties: Optional["aws_sdk_workspaces.types.saml_properties.SamlProperties"] = None, properties_to_delete: Optional["aws_sdk_workspaces.types.deletable_saml_properties_list.DeletableSamlPropertiesList"] = None) -> "aws_sdk_workspaces.types.modify_saml_properties_result.ModifySamlPropertiesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_saml_properties_request.ModifySamlPropertiesRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_saml_properties_result.ModifySamlPropertiesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_saml_properties
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_saml_properties.modify_saml_properties(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_selfservice_permissions(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", selfservice_permissions: "aws_sdk_workspaces.types.selfservice_permissions.SelfservicePermissions", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.modify_selfservice_permissions_result.ModifySelfservicePermissionsResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_selfservice_permissions_request.ModifySelfservicePermissionsRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_selfservice_permissions_result.ModifySelfservicePermissionsResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_selfservice_permissions
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_selfservice_permissions.modify_selfservice_permissions(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_streaming_properties(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, streaming_properties: Optional["aws_sdk_workspaces.types.streaming_properties.StreamingProperties"] = None) -> "aws_sdk_workspaces.types.modify_streaming_properties_result.ModifyStreamingPropertiesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_streaming_properties_request.ModifyStreamingPropertiesRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_streaming_properties_result.ModifyStreamingPropertiesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_streaming_properties
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_streaming_properties.modify_streaming_properties(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_workspace_access_properties(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", workspace_access_properties: "aws_sdk_workspaces.types.workspace_access_properties.WorkspaceAccessProperties", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.modify_workspace_access_properties_result.ModifyWorkspaceAccessPropertiesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_workspace_access_properties_request.ModifyWorkspaceAccessPropertiesRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_workspace_access_properties_result.ModifyWorkspaceAccessPropertiesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_workspace_access_properties
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_workspace_access_properties.modify_workspace_access_properties(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_workspace_creation_properties(self, resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", workspace_creation_properties: "aws_sdk_workspaces.types.workspace_creation_properties.WorkspaceCreationProperties", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.modify_workspace_creation_properties_result.ModifyWorkspaceCreationPropertiesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_workspace_creation_properties_request.ModifyWorkspaceCreationPropertiesRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_workspace_creation_properties_result.ModifyWorkspaceCreationPropertiesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_workspace_creation_properties
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_workspace_creation_properties.modify_workspace_creation_properties(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_workspace_properties(self, workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, workspace_properties: Optional["aws_sdk_workspaces.types.workspace_properties.WorkspaceProperties"] = None, data_replication: Optional["aws_sdk_workspaces.types.data_replication.DataReplication"] = None) -> "aws_sdk_workspaces.types.modify_workspace_properties_result.ModifyWorkspacePropertiesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_workspace_properties_request.ModifyWorkspacePropertiesRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_workspace_properties_result.ModifyWorkspacePropertiesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_workspace_properties
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_workspace_properties.modify_workspace_properties(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_workspace_state(self, workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId", workspace_state: "aws_sdk_workspaces.types.target_workspace_state.TargetWorkspaceState", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.modify_workspace_state_result.ModifyWorkspaceStateResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.modify_workspace_state_request.ModifyWorkspaceStateRequest]') -> OperationResponse["aws_sdk_workspaces.types.modify_workspace_state_result.ModifyWorkspaceStateResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.modify_workspace_state
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.modify_workspace_state.modify_workspace_state(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def reboot_workspaces(self, reboot_workspace_requests: "aws_sdk_workspaces.types.reboot_workspace_requests.RebootWorkspaceRequests", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.reboot_workspaces_result.RebootWorkspacesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.reboot_workspaces_request.RebootWorkspacesRequest]') -> OperationResponse["aws_sdk_workspaces.types.reboot_workspaces_result.RebootWorkspacesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.reboot_workspaces
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.reboot_workspaces.reboot_workspaces(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def rebuild_workspaces(self, rebuild_workspace_requests: "aws_sdk_workspaces.types.rebuild_workspace_requests.RebuildWorkspaceRequests", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.rebuild_workspaces_result.RebuildWorkspacesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.rebuild_workspaces_request.RebuildWorkspacesRequest]') -> OperationResponse["aws_sdk_workspaces.types.rebuild_workspaces_result.RebuildWorkspacesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.rebuild_workspaces
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.rebuild_workspaces.rebuild_workspaces(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def register_workspace_directory(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, directory_id: Optional["aws_sdk_workspaces.types.directory_id.DirectoryId"] = None, subnet_ids: Optional["aws_sdk_workspaces.types.subnet_ids.SubnetIds"] = None, enable_self_service: Optional["aws_sdk_workspaces.types.boolean_object.BooleanObject"] = None, tenancy: Optional["aws_sdk_workspaces.types.tenancy.Tenancy"] = None, tags: Optional["aws_sdk_workspaces.types.tag_list.TagList"] = None, workspace_directory_name: Optional["aws_sdk_workspaces.types.workspace_directory_name.WorkspaceDirectoryName"] = None, workspace_directory_description: Optional["aws_sdk_workspaces.types.workspace_directory_description.WorkspaceDirectoryDescription"] = None, user_identity_type: Optional["aws_sdk_workspaces.types.user_identity_type.UserIdentityType"] = None, idc_instance_arn: Optional["aws_sdk_workspaces.types.arn.ARN"] = None, microsoft_entra_config: Optional["aws_sdk_workspaces.types.microsoft_entra_config.MicrosoftEntraConfig"] = None, workspace_type: Optional["aws_sdk_workspaces.types.workspace_type.WorkspaceType"] = None, active_directory_config: Optional["aws_sdk_workspaces.types.active_directory_config.ActiveDirectoryConfig"] = None) -> "aws_sdk_workspaces.types.register_workspace_directory_result.RegisterWorkspaceDirectoryResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.register_workspace_directory_request.RegisterWorkspaceDirectoryRequest]') -> OperationResponse["aws_sdk_workspaces.types.register_workspace_directory_result.RegisterWorkspaceDirectoryResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.register_workspace_directory
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.register_workspace_directory.register_workspace_directory(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def reject_account_link_invitation(self, link_id: "aws_sdk_workspaces.types.link_id.LinkId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, client_token: Optional["aws_sdk_workspaces.types.client_token.ClientToken"] = None) -> "aws_sdk_workspaces.types.reject_account_link_invitation_result.RejectAccountLinkInvitationResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.reject_account_link_invitation_request.RejectAccountLinkInvitationRequest]') -> OperationResponse["aws_sdk_workspaces.types.reject_account_link_invitation_result.RejectAccountLinkInvitationResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.reject_account_link_invitation
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.reject_account_link_invitation.reject_account_link_invitation(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def restore_workspace(self, workspace_id: "aws_sdk_workspaces.types.workspace_id.WorkspaceId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.restore_workspace_result.RestoreWorkspaceResult":
        ...
        Args:
            workspace_id: <p>The identifier of the WorkSpace.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.restore_workspace_request.RestoreWorkspaceRequest]') -> OperationResponse["aws_sdk_workspaces.types.restore_workspace_result.RestoreWorkspaceResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.restore_workspace
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.restore_workspace.restore_workspace(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def revoke_ip_rules(self, group_id: "aws_sdk_workspaces.types.ip_group_id.IpGroupId", user_rules: "aws_sdk_workspaces.types.ip_revoked_rule_list.IpRevokedRuleList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.revoke_ip_rules_result.RevokeIpRulesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.revoke_ip_rules_request.RevokeIpRulesRequest]') -> OperationResponse["aws_sdk_workspaces.types.revoke_ip_rules_result.RevokeIpRulesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.revoke_ip_rules
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.revoke_ip_rules.revoke_ip_rules(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def start_workspaces(self, start_workspace_requests: "aws_sdk_workspaces.types.start_workspace_requests.StartWorkspaceRequests", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.start_workspaces_result.StartWorkspacesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.start_workspaces_request.StartWorkspacesRequest]') -> OperationResponse["aws_sdk_workspaces.types.start_workspaces_result.StartWorkspacesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.start_workspaces
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.start_workspaces.start_workspaces(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def start_workspaces_pool(self, pool_id: "aws_sdk_workspaces.types.workspaces_pool_id.WorkspacesPoolId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.start_workspaces_pool_result.StartWorkspacesPoolResult":
        ...
        Args:
            pool_id: <p>The identifier of the pool.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.start_workspaces_pool_request.StartWorkspacesPoolRequest]') -> OperationResponse["aws_sdk_workspaces.types.start_workspaces_pool_result.StartWorkspacesPoolResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.start_workspaces_pool
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.start_workspaces_pool.start_workspaces_pool(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_workspaces(self, stop_workspace_requests: "aws_sdk_workspaces.types.stop_workspace_requests.StopWorkspaceRequests", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.stop_workspaces_result.StopWorkspacesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.stop_workspaces_request.StopWorkspacesRequest]') -> OperationResponse["aws_sdk_workspaces.types.stop_workspaces_result.StopWorkspacesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.stop_workspaces
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.stop_workspaces.stop_workspaces(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_workspaces_pool(self, pool_id: "aws_sdk_workspaces.types.workspaces_pool_id.WorkspacesPoolId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.stop_workspaces_pool_result.StopWorkspacesPoolResult":
        ...
        Args:
            pool_id: <p>The identifier of the pool.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.stop_workspaces_pool_request.StopWorkspacesPoolRequest]') -> OperationResponse["aws_sdk_workspaces.types.stop_workspaces_pool_result.StopWorkspacesPoolResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.stop_workspaces_pool
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.stop_workspaces_pool.stop_workspaces_pool(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def terminate_workspaces(self, terminate_workspace_requests: "aws_sdk_workspaces.types.terminate_workspace_requests.TerminateWorkspaceRequests", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.terminate_workspaces_result.TerminateWorkspacesResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.terminate_workspaces_request.TerminateWorkspacesRequest]') -> OperationResponse["aws_sdk_workspaces.types.terminate_workspaces_result.TerminateWorkspacesResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.terminate_workspaces
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.terminate_workspaces.terminate_workspaces(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def terminate_workspaces_pool(self, pool_id: "aws_sdk_workspaces.types.workspaces_pool_id.WorkspacesPoolId", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.terminate_workspaces_pool_result.TerminateWorkspacesPoolResult":
        ...
        Args:
            pool_id: <p>The identifier of the pool.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.terminate_workspaces_pool_request.TerminateWorkspacesPoolRequest]') -> OperationResponse["aws_sdk_workspaces.types.terminate_workspaces_pool_result.TerminateWorkspacesPoolResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.terminate_workspaces_pool
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.terminate_workspaces_pool.terminate_workspaces_pool(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def terminate_workspaces_pool_session(self, session_id: "aws_sdk_workspaces.types.amazon_uuid.AmazonUuid", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.terminate_workspaces_pool_session_result.TerminateWorkspacesPoolSessionResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.terminate_workspaces_pool_session_request.TerminateWorkspacesPoolSessionRequest]') -> OperationResponse["aws_sdk_workspaces.types.terminate_workspaces_pool_session_result.TerminateWorkspacesPoolSessionResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.terminate_workspaces_pool_session
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.terminate_workspaces_pool_session.terminate_workspaces_pool_session(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def update_connect_client_add_in(self, add_in_id: "aws_sdk_workspaces.types.amazon_uuid.AmazonUuid", resource_id: "aws_sdk_workspaces.types.directory_id.DirectoryId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, name: Optional["aws_sdk_workspaces.types.add_in_name.AddInName"] = None, url: Optional["aws_sdk_workspaces.types.add_in_url.AddInUrl"] = None) -> "aws_sdk_workspaces.types.update_connect_client_add_in_result.UpdateConnectClientAddInResult":
        ...
        Args:
            ...
            url: <p>The endpoint URL of the Connect Customer client add-in.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.update_connect_client_add_in_request.UpdateConnectClientAddInRequest]') -> OperationResponse["aws_sdk_workspaces.types.update_connect_client_add_in_result.UpdateConnectClientAddInResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.update_connect_client_add_in
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.update_connect_client_add_in.update_connect_client_add_in(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def update_connection_alias_permission(self, alias_id: "aws_sdk_workspaces.types.connection_alias_id.ConnectionAliasId", connection_alias_permission: "aws_sdk_workspaces.types.connection_alias_permission.ConnectionAliasPermission", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.update_connection_alias_permission_result.UpdateConnectionAliasPermissionResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.update_connection_alias_permission_request.UpdateConnectionAliasPermissionRequest]') -> OperationResponse["aws_sdk_workspaces.types.update_connection_alias_permission_result.UpdateConnectionAliasPermissionResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.update_connection_alias_permission
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.update_connection_alias_permission.update_connection_alias_permission(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def update_rules_of_ip_group(self, group_id: "aws_sdk_workspaces.types.ip_group_id.IpGroupId", user_rules: "aws_sdk_workspaces.types.ip_rule_list.IpRuleList", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.update_rules_of_ip_group_result.UpdateRulesOfIpGroupResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.update_rules_of_ip_group_request.UpdateRulesOfIpGroupRequest]') -> OperationResponse["aws_sdk_workspaces.types.update_rules_of_ip_group_result.UpdateRulesOfIpGroupResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.update_rules_of_ip_group
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.update_rules_of_ip_group.update_rules_of_ip_group(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def update_workspace_bundle(self, *, config_overrides: Optional[WorkSpacesClientConfig] = None, bundle_id: Optional["aws_sdk_workspaces.types.bundle_id.BundleId"] = None, image_id: Optional["aws_sdk_workspaces.types.workspace_image_id.WorkspaceImageId"] = None) -> "aws_sdk_workspaces.types.update_workspace_bundle_result.UpdateWorkspaceBundleResult":
        ...
        Args:
            ...
            image_id: <p>The identifier of the image.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.update_workspace_bundle_request.UpdateWorkspaceBundleRequest]') -> OperationResponse["aws_sdk_workspaces.types.update_workspace_bundle_result.UpdateWorkspaceBundleResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.update_workspace_bundle
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.update_workspace_bundle.update_workspace_bundle(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def update_workspace_image_permission(self, image_id: "aws_sdk_workspaces.types.workspace_image_id.WorkspaceImageId", allow_copy_image: "aws_sdk_workspaces.types.boolean_object.BooleanObject", shared_account_id: "aws_sdk_workspaces.types.aws_account.AwsAccount", *, config_overrides: Optional[WorkSpacesClientConfig] = None) -> "aws_sdk_workspaces.types.update_workspace_image_permission_result.UpdateWorkspaceImagePermissionResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.update_workspace_image_permission_request.UpdateWorkspaceImagePermissionRequest]') -> OperationResponse["aws_sdk_workspaces.types.update_workspace_image_permission_result.UpdateWorkspaceImagePermissionResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.update_workspace_image_permission
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.update_workspace_image_permission.update_workspace_image_permission(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def update_workspaces_pool(self, pool_id: "aws_sdk_workspaces.types.workspaces_pool_id.WorkspacesPoolId", *, config_overrides: Optional[WorkSpacesClientConfig] = None, description: Optional["aws_sdk_workspaces.types.update_description.UpdateDescription"] = None, bundle_id: Optional["aws_sdk_workspaces.types.bundle_id.BundleId"] = None, directory_id: Optional["aws_sdk_workspaces.types.directory_id.DirectoryId"] = None, capacity: Optional["aws_sdk_workspaces.types.capacity.Capacity"] = None, application_settings: Optional["aws_sdk_workspaces.types.application_settings_request.ApplicationSettingsRequest"] = None, timeout_settings: Optional["aws_sdk_workspaces.types.timeout_settings.TimeoutSettings"] = None, running_mode: Optional["aws_sdk_workspaces.types.pools_running_mode.PoolsRunningMode"] = None) -> "aws_sdk_workspaces.types.update_workspaces_pool_result.UpdateWorkspacesPoolResult":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces.types.update_workspaces_pool_request.UpdateWorkspacesPoolRequest]') -> OperationResponse["aws_sdk_workspaces.types.update_workspaces_pool_result.UpdateWorkspacesPoolResult"]:
            import aws_sdk_workspaces._operations.workspaces_service.update_workspaces_pool
            output, http_response = aws_sdk_workspaces._operations.workspaces_service.update_workspaces_pool.update_workspaces_pool(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
