...
def serialize_aws_json_1_1(value: DescribeConnectClientAddInsResult) -> dict:
    ...
    if "add_ins" in value:
        ...
        out["AddIns"] = (
            aws_sdk_workspaces.types.connect_client_add_in_list.serialize_aws_json_1_1(
                value["add_ins"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeConnectClientAddInsResult:
    ...
    if "AddIns" in data:
        ...
        out["add_ins"] = (
            aws_sdk_workspaces.types.connect_client_add_in_list.deserialize_aws_json_1_1(
                data["AddIns"]
            )
        )
