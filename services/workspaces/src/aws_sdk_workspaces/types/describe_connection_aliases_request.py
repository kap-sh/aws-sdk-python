...
class DescribeConnectionAliasesRequest(TypedDict):
...
def serialize_aws_json_1_1(value: DescribeConnectionAliasesRequest) -> dict:
    ...
    if "alias_ids" in value:
        ...
        out["AliasIds"] = (
            aws_sdk_workspaces.types.connection_alias_id_list.serialize_aws_json_1_1(
                value["alias_ids"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeConnectionAliasesRequest:
    ...
    if "AliasIds" in data:
        ...
        out["alias_ids"] = (
            aws_sdk_workspaces.types.connection_alias_id_list.deserialize_aws_json_1_1(
                data["AliasIds"]
            )
        )
