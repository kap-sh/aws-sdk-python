...
if TYPE_CHECKING:
    import aws_sdk_workspaces.types.describe_workspace_directories_filter

DescribeWorkspaceDirectoriesFilterList: TypeAlias = list[
    "aws_sdk_workspaces.types.describe_workspace_directories_filter.DescribeWorkspaceDirectoriesFilter"
]
...
def serialize_aws_json_1_1(value: DescribeWorkspaceDirectoriesFilterList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_workspaces.types.describe_workspace_directories_filter.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> DescribeWorkspaceDirectoriesFilterList:
    ...
    for item in data:
        out.append(
            aws_sdk_workspaces.types.describe_workspace_directories_filter.deserialize_aws_json_1_1(
                item
            )
        )
    return out
