"""Generated from Smithy shape ``com.amazonaws.workspaces#DefaultImportClientBrandingAttributes``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_workspaces.types.default_logo
    import aws_sdk_workspaces.types.login_message


class DefaultImportClientBrandingAttributes(TypedDict, closed=True):
    logo: NotRequired["aws_sdk_workspaces.types.default_logo.DefaultLogo"]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DefaultImportClientBrandingAttributes) -> dict:
    out: dict = {}
    if "logo" in value:
        import aws_sdk_workspaces.types.default_logo

        out["Logo"] = aws_sdk_workspaces.types.default_logo.serialize_aws_json_1_1(
            value["logo"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DefaultImportClientBrandingAttributes:
    out: DefaultImportClientBrandingAttributes = {}  # type: ignore[typeddict-item]
    if "Logo" in data:
        import aws_sdk_workspaces.types.default_logo

        out["logo"] = aws_sdk_workspaces.types.default_logo.deserialize_aws_json_1_1(
            data["Logo"]
        )
