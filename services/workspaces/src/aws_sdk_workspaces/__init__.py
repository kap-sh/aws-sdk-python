...
from ._services.async_work_spaces import AsyncWorkSpacesClient as AsyncWorkSpacesClient
from ._services.work_spaces import WorkSpacesClient as WorkSpacesClient
