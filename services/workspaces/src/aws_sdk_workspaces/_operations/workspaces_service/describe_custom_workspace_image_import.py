...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_custom_workspace_image_import_result.DescribeCustomWorkspaceImageImportResult = aws_sdk_workspaces.types.describe_custom_workspace_image_import_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_custom_workspace_image_import_request.DescribeCustomWorkspaceImageImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_custom_workspace_image_import_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
