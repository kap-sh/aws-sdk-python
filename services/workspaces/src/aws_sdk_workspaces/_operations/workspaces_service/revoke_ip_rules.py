...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.revoke_ip_rules_result.RevokeIpRulesResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.revoke_ip_rules_request.RevokeIpRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.revoke_ip_rules_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def revoke_ip_rules(
    ...
    aws_sdk_workspaces.types.revoke_ip_rules_result.RevokeIpRulesResult, zapros.Response
]:
