...
def build_request(
    ...
    input: aws_sdk_workspaces.types.revoke_ip_rules_request.RevokeIpRulesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.revoke_ip_rules_request.serialize_aws_json_1_1(input)
    ).encode()
