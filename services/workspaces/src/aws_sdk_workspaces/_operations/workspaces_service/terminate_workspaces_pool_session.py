...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.terminate_workspaces_pool_session_result.TerminateWorkspacesPoolSessionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.terminate_workspaces_pool_session_request.TerminateWorkspacesPoolSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.terminate_workspaces_pool_session_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
