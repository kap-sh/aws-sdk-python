...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.modify_selfservice_permissions_result.ModifySelfservicePermissionsResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.modify_selfservice_permissions_request.ModifySelfservicePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.modify_selfservice_permissions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
