...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidParameterCombinationException":
            import aws_sdk_workspaces.errors.invalid_parameter_combination_exception

            raise aws_sdk_workspaces.errors.invalid_parameter_combination_exception.InvalidParameterCombinationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.modify_workspace_access_properties_result.ModifyWorkspaceAccessPropertiesResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.modify_workspace_access_properties_request.ModifyWorkspaceAccessPropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.modify_workspace_access_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
