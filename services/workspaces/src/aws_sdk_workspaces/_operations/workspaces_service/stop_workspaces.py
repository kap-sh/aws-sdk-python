...
def build_request(
    ...
    input: aws_sdk_workspaces.types.stop_workspaces_request.StopWorkspacesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.stop_workspaces_request.serialize_aws_json_1_1(input)
    ).encode()
