...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.disassociate_workspace_application_result.DisassociateWorkspaceApplicationResult = aws_sdk_workspaces.types.disassociate_workspace_application_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.disassociate_workspace_application_request.DisassociateWorkspaceApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.disassociate_workspace_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
