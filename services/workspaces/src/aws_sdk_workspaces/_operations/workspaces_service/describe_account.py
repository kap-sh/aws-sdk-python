...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_account_result.DescribeAccountResult = (
        aws_sdk_workspaces.types.describe_account_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_account_request.DescribeAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
