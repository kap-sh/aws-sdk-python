...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.reboot_workspaces_result.RebootWorkspacesResult = (
        aws_sdk_workspaces.types.reboot_workspaces_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_workspaces.types.reboot_workspaces_request.RebootWorkspacesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.reboot_workspaces_request.serialize_aws_json_1_1(input)
    ).encode()
