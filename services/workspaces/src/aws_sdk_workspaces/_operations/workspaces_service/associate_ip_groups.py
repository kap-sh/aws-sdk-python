...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.associate_ip_groups_result.AssociateIpGroupsResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.associate_ip_groups_request.AssociateIpGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.associate_ip_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
