...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.delete_workspace_bundle_result.DeleteWorkspaceBundleResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.delete_workspace_bundle_request.DeleteWorkspaceBundleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.delete_workspace_bundle_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
