...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.create_workspaces_pool_result.CreateWorkspacesPoolResult = aws_sdk_workspaces.types.create_workspaces_pool_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.create_workspaces_pool_request.CreateWorkspacesPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.create_workspaces_pool_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
