"""Generated from Smithy shape ``com.amazonaws.workspaces#DescribeTags``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_tags_result.DescribeTagsResult = (
        aws_sdk_workspaces.types.describe_tags_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_tags_request.DescribeTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_tags(
    ...
    aws_sdk_workspaces.types.describe_tags_result.DescribeTagsResult, zapros.Response
]:
