"""Generated from Smithy shape ``com.amazonaws.workspaces#ModifyCertificateBasedAuthProperties``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.modify_certificate_based_auth_properties_result.ModifyCertificateBasedAuthPropertiesResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.modify_certificate_based_auth_properties_request.ModifyCertificateBasedAuthPropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkspacesService.ModifyCertificateBasedAuthProperties"
    import aws_sdk_workspaces.types.modify_certificate_based_auth_properties_request

    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.modify_certificate_based_auth_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_certificate_based_auth_properties(
