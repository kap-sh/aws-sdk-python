...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.import_client_branding_result.ImportClientBrandingResult = aws_sdk_workspaces.types.import_client_branding_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.import_client_branding_request.ImportClientBrandingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.import_client_branding_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
