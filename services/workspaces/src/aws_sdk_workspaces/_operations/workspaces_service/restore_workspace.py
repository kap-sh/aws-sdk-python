...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.restore_workspace_result.RestoreWorkspaceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_workspaces.types.restore_workspace_request.RestoreWorkspaceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.restore_workspace_request.serialize_aws_json_1_1(input)
    ).encode()
