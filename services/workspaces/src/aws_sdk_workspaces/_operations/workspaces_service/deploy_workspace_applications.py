...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.deploy_workspace_applications_result.DeployWorkspaceApplicationsResult = aws_sdk_workspaces.types.deploy_workspace_applications_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.deploy_workspace_applications_request.DeployWorkspaceApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.deploy_workspace_applications_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
