...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.create_ip_group_request.CreateIpGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.create_ip_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_ip_group(
    ...
    aws_sdk_workspaces.types.create_ip_group_result.CreateIpGroupResult, zapros.Response
]:
