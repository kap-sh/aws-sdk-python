...
def build_request(
    ...
    input: aws_sdk_workspaces.types.create_ip_group_request.CreateIpGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.create_ip_group_request.serialize_aws_json_1_1(input)
    ).encode()
