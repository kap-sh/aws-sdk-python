...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.terminate_workspaces_result.TerminateWorkspacesResult = aws_sdk_workspaces.types.terminate_workspaces_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.terminate_workspaces_request.TerminateWorkspacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.terminate_workspaces_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
