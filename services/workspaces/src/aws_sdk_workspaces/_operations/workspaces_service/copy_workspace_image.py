...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.copy_workspace_image_result.CopyWorkspaceImageResult = aws_sdk_workspaces.types.copy_workspace_image_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.copy_workspace_image_request.CopyWorkspaceImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.copy_workspace_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
