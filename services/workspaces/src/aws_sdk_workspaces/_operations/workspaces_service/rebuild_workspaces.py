"""Generated from Smithy shape ``com.amazonaws.workspaces#RebuildWorkspaces``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.rebuild_workspaces_result.RebuildWorkspacesResult = (
        aws_sdk_workspaces.types.rebuild_workspaces_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.rebuild_workspaces_request.RebuildWorkspacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.rebuild_workspaces_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_rebuild_workspaces(
