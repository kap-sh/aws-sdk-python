...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.create_workspace_bundle_result.CreateWorkspaceBundleResult = aws_sdk_workspaces.types.create_workspace_bundle_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.create_workspace_bundle_request.CreateWorkspaceBundleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.create_workspace_bundle_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
