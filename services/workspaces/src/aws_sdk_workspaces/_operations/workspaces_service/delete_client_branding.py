...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.delete_client_branding_result.DeleteClientBrandingResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.delete_client_branding_request.DeleteClientBrandingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.delete_client_branding_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
