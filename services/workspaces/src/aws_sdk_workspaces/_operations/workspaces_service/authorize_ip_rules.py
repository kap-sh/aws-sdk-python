...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.authorize_ip_rules_result.AuthorizeIpRulesResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.authorize_ip_rules_request.AuthorizeIpRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.authorize_ip_rules_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
