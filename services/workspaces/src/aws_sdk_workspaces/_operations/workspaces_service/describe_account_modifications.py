...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_account_modifications_result.DescribeAccountModificationsResult = aws_sdk_workspaces.types.describe_account_modifications_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_account_modifications_request.DescribeAccountModificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_account_modifications_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
