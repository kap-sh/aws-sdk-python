"""Generated from Smithy shape ``com.amazonaws.workspaces#TerminateWorkspacesPool``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.terminate_workspaces_pool_result.TerminateWorkspacesPoolResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.terminate_workspaces_pool_request.TerminateWorkspacesPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkspacesService.TerminateWorkspacesPool"
    import aws_sdk_workspaces.types.terminate_workspaces_pool_request

    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.terminate_workspaces_pool_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_terminate_workspaces_pool(
