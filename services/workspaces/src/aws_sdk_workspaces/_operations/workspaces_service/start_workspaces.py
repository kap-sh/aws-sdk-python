...
def build_request(
    ...
    input: aws_sdk_workspaces.types.start_workspaces_request.StartWorkspacesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.start_workspaces_request.serialize_aws_json_1_1(input)
    ).encode()
