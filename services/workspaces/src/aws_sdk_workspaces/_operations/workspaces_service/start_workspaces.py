...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.start_workspaces_result.StartWorkspacesResult = (
        aws_sdk_workspaces.types.start_workspaces_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.start_workspaces_request.StartWorkspacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.start_workspaces_request.serialize_aws_json_1_1(input_)
    ).encode()
