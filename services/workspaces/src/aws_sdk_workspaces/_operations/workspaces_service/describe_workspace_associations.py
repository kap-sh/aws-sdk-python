...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_workspace_associations_result.DescribeWorkspaceAssociationsResult = aws_sdk_workspaces.types.describe_workspace_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_workspace_associations_request.DescribeWorkspaceAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_workspace_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
