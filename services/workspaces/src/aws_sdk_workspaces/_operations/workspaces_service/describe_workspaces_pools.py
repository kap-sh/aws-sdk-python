...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_workspaces_pools_result.DescribeWorkspacesPoolsResult = aws_sdk_workspaces.types.describe_workspaces_pools_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_workspaces_pools_request.DescribeWorkspacesPoolsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_workspaces_pools_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
