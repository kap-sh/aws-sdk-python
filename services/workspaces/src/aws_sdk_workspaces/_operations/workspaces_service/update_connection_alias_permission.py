...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.update_connection_alias_permission_result.UpdateConnectionAliasPermissionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.update_connection_alias_permission_request.UpdateConnectionAliasPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.update_connection_alias_permission_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
