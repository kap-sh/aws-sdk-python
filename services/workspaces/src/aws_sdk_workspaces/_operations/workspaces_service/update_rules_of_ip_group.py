...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.update_rules_of_ip_group_result.UpdateRulesOfIpGroupResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.update_rules_of_ip_group_request.UpdateRulesOfIpGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.update_rules_of_ip_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
