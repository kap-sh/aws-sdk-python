...
def build_request(
    ...
    input: aws_sdk_workspaces.types.get_account_link_request.GetAccountLinkRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.get_account_link_request.serialize_aws_json_1_1(input)
    ).encode()
