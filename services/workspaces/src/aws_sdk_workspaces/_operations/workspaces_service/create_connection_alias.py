...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.create_connection_alias_result.CreateConnectionAliasResult = aws_sdk_workspaces.types.create_connection_alias_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.create_connection_alias_request.CreateConnectionAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.create_connection_alias_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
