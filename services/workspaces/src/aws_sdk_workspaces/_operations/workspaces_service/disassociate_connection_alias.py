...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.disassociate_connection_alias_result.DisassociateConnectionAliasResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.disassociate_connection_alias_request.DisassociateConnectionAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.disassociate_connection_alias_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
