...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.migrate_workspace_request.MigrateWorkspaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.migrate_workspace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
