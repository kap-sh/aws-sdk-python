...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.migrate_workspace_result.MigrateWorkspaceResult = (
        aws_sdk_workspaces.types.migrate_workspace_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_workspaces.types.migrate_workspace_request.MigrateWorkspaceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.migrate_workspace_request.serialize_aws_json_1_1(input)
    ).encode()
