...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.import_custom_workspace_image_result.ImportCustomWorkspaceImageResult = aws_sdk_workspaces.types.import_custom_workspace_image_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.import_custom_workspace_image_request.ImportCustomWorkspaceImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.import_custom_workspace_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
