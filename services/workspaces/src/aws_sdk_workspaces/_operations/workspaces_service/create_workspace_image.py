"""Generated from Smithy shape ``com.amazonaws.workspaces#CreateWorkspaceImage``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.create_workspace_image_result.CreateWorkspaceImageResult = aws_sdk_workspaces.types.create_workspace_image_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.create_workspace_image_request.CreateWorkspaceImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkspacesService.CreateWorkspaceImage"
    import aws_sdk_workspaces.types.create_workspace_image_request

    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.create_workspace_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_workspace_image(
