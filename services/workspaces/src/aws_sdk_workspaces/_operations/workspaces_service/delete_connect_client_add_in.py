...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.delete_connect_client_add_in_result.DeleteConnectClientAddInResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.delete_connect_client_add_in_request.DeleteConnectClientAddInRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
