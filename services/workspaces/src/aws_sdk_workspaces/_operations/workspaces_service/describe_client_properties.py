"""Generated from Smithy shape ``com.amazonaws.workspaces#DescribeClientProperties``."""
...
import aws_sdk_workspaces.types.client_properties_list
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_client_properties_result.DescribeClientPropertiesResult = aws_sdk_workspaces.types.describe_client_properties_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_client_properties_request.DescribeClientPropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_client_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_client_properties(
