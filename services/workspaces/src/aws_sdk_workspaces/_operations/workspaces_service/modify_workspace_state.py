"""Generated from Smithy shape ``com.amazonaws.workspaces#ModifyWorkspaceState``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.modify_workspace_state_result.ModifyWorkspaceStateResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.modify_workspace_state_request.ModifyWorkspaceStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.modify_workspace_state_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_workspace_state(
