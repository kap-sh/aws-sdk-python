...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.list_available_management_cidr_ranges_result.ListAvailableManagementCidrRangesResult = aws_sdk_workspaces.types.list_available_management_cidr_ranges_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.list_available_management_cidr_ranges_request.ListAvailableManagementCidrRangesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.list_available_management_cidr_ranges_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
