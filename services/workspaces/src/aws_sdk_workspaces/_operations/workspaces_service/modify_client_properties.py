...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.modify_client_properties_result.ModifyClientPropertiesResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.modify_client_properties_request.ModifyClientPropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.modify_client_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
