...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAssociatedException":
            import aws_sdk_workspaces.errors.resource_associated_exception

            raise aws_sdk_workspaces.errors.resource_associated_exception.ResourceAssociatedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.associate_connection_alias_result.AssociateConnectionAliasResult = aws_sdk_workspaces.types.associate_connection_alias_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.associate_connection_alias_request.AssociateConnectionAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.associate_connection_alias_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
