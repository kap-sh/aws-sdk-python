...
def build_request(
    ...
    input: aws_sdk_workspaces.types.delete_ip_group_request.DeleteIpGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.delete_ip_group_request.serialize_aws_json_1_1(input)
    ).encode()
