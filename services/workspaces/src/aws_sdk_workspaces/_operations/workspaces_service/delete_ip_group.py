...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.delete_ip_group_result.DeleteIpGroupResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.delete_ip_group_request.DeleteIpGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.delete_ip_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_ip_group(
    ...
    aws_sdk_workspaces.types.delete_ip_group_result.DeleteIpGroupResult, zapros.Response
]:
