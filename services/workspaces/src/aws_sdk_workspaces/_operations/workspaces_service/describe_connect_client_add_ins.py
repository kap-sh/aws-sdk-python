...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_connect_client_add_ins_result.DescribeConnectClientAddInsResult = aws_sdk_workspaces.types.describe_connect_client_add_ins_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_connect_client_add_ins_request.DescribeConnectClientAddInsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
