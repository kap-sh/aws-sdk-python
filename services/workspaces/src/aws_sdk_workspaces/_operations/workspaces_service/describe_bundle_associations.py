"""Generated from Smithy shape ``com.amazonaws.workspaces#DescribeBundleAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_bundle_associations_result.DescribeBundleAssociationsResult = aws_sdk_workspaces.types.describe_bundle_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_bundle_associations_request.DescribeBundleAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkspacesService.DescribeBundleAssociations"
    import aws_sdk_workspaces.types.describe_bundle_associations_request

    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_bundle_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_bundle_associations(
