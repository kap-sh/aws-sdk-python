...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.update_connect_client_add_in_result.UpdateConnectClientAddInResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.update_connect_client_add_in_request.UpdateConnectClientAddInRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.update_connect_client_add_in_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
