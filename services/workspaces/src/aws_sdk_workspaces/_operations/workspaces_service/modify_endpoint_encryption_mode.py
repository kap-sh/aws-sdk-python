...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.modify_endpoint_encryption_mode_response.ModifyEndpointEncryptionModeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.modify_endpoint_encryption_mode_request.ModifyEndpointEncryptionModeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.modify_endpoint_encryption_mode_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
