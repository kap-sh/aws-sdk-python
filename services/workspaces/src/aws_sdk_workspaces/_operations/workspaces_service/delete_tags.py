...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.delete_tags_result.DeleteTagsResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.delete_tags_request.DeleteTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.delete_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_tags(
    ...
    aws_sdk_workspaces.types.delete_tags_result.DeleteTagsResult, zapros.Response
]:
