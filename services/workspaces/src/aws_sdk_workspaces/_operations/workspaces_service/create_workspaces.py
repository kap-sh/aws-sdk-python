"""Generated from Smithy shape ``com.amazonaws.workspaces#CreateWorkspaces``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.create_workspaces_result.CreateWorkspacesResult = (
        aws_sdk_workspaces.types.create_workspaces_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_workspaces.types.create_workspaces_request.CreateWorkspacesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.create_workspaces_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_create_workspaces(
