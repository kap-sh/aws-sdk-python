...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_workspaces_connection_status_result.DescribeWorkspacesConnectionStatusResult = aws_sdk_workspaces.types.describe_workspaces_connection_status_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_workspaces_connection_status_request.DescribeWorkspacesConnectionStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_workspaces_connection_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
