...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.deregister_workspace_directory_result.DeregisterWorkspaceDirectoryResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.deregister_workspace_directory_request.DeregisterWorkspaceDirectoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.deregister_workspace_directory_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
