...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_application_associations_result.DescribeApplicationAssociationsResult = aws_sdk_workspaces.types.describe_application_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_application_associations_request.DescribeApplicationAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_application_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
