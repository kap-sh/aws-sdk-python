...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.update_workspaces_pool_result.UpdateWorkspacesPoolResult = aws_sdk_workspaces.types.update_workspaces_pool_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.update_workspaces_pool_request.UpdateWorkspacesPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.update_workspaces_pool_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
