...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.update_workspace_image_permission_result.UpdateWorkspaceImagePermissionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.update_workspace_image_permission_request.UpdateWorkspaceImagePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.update_workspace_image_permission_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
