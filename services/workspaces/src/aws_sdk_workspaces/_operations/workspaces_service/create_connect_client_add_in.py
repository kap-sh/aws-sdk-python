...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.create_connect_client_add_in_result.CreateConnectClientAddInResult = aws_sdk_workspaces.types.create_connect_client_add_in_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.create_connect_client_add_in_request.CreateConnectClientAddInRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.create_connect_client_add_in_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
