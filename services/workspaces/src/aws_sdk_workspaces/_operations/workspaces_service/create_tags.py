"""Generated from Smithy shape ``com.amazonaws.workspaces#CreateTags``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.create_tags_result.CreateTagsResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.create_tags_request.CreateTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.create_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_tags(
    ...
    aws_sdk_workspaces.types.create_tags_result.CreateTagsResult, zapros.Response
]:
