...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.modify_account_result.ModifyAccountResult = (
        aws_sdk_workspaces.types.modify_account_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.modify_account_request.ModifyAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.modify_account_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def modify_account(
    ...
    aws_sdk_workspaces.types.modify_account_result.ModifyAccountResult, zapros.Response
]:
