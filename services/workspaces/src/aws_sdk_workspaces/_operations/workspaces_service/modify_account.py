...
def build_request(
    ...
    input: aws_sdk_workspaces.types.modify_account_request.ModifyAccountRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.modify_account_request.serialize_aws_json_1_1(input)
    ).encode()
