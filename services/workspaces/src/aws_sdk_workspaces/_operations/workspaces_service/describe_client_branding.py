"""Generated from Smithy shape ``com.amazonaws.workspaces#DescribeClientBranding``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_client_branding_result.DescribeClientBrandingResult = aws_sdk_workspaces.types.describe_client_branding_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_client_branding_request.DescribeClientBrandingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "WorkspacesService.DescribeClientBranding"
    import aws_sdk_workspaces.types.describe_client_branding_request

    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_client_branding_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_client_branding(
