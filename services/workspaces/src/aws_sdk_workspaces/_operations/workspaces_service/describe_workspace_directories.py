"""Generated from Smithy shape ``com.amazonaws.workspaces#DescribeWorkspaceDirectories``."""
...
def handle_response(
    ...
    out: aws_sdk_workspaces.types.describe_workspace_directories_result.DescribeWorkspaceDirectoriesResult = aws_sdk_workspaces.types.describe_workspace_directories_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_workspaces.types.describe_workspace_directories_request.DescribeWorkspaceDirectoriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces.types.describe_workspace_directories_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_workspace_directories(
