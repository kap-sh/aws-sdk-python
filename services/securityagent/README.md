...
```
pip install aws-sdk-securityagent
```

## Usage

```python
from aws_sdk_securityagent import AsyncSecurityAgentClient
...
```python
from aws_sdk_securityagent import AsyncSecurityAgentClient
from aws_sdk_securityagent.error import AccessDeniedException
