...
class SecurityAgentError(Exception):
    """Base class for all SecurityAgent service errors."""


class ServiceError(SecurityAgentError):
...
class SerializationError(SecurityAgentError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SecurityAgentError):
...
class WaiterFailedError(SecurityAgentError):
...
class WaiterTimeoutError(SecurityAgentError):
