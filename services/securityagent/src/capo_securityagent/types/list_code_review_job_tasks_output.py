...
if TYPE_CHECKING:
    import capo_securityagent.types.code_review_job_task_summary_list
    import capo_securityagent.types.next_token


class ListCodeReviewJobTasksOutput(TypedDict, closed=True):
    code_review_job_task_summaries: NotRequired[
        "capo_securityagent.types.code_review_job_task_summary_list.CodeReviewJobTaskSummaryList"
    ]
...
def serialize_json(value: ListCodeReviewJobTasksOutput) -> dict:
    ...
    if "code_review_job_task_summaries" in value:
        ...
        out["codeReviewJobTaskSummaries"] = (
            capo_securityagent.types.code_review_job_task_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListCodeReviewJobTasksOutput:
    ...
    if "codeReviewJobTaskSummaries" in data:
        ...
        out["code_review_job_task_summaries"] = (
            capo_securityagent.types.code_review_job_task_summary_list.deserialize_json(
