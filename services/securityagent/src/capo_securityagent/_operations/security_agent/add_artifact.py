...
def handle_response(
    ...
    out: capo_securityagent.types.add_artifact_output.AddArtifactOutput = (
        capo_securityagent.types.add_artifact_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.add_artifact_input.serialize_json(input_)
    ).encode()
...
def add_artifact(
    ...
    capo_securityagent.types.add_artifact_output.AddArtifactOutput, zapros.Response
]:
