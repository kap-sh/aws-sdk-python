...
def handle_response(
    ...
    out: capo_securityagent.types.delete_integration_output.DeleteIntegrationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.delete_integration_input.serialize_json(input_)
    ).encode()
