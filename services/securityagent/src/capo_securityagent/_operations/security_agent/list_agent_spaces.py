...
def handle_response(
    ...
    out: capo_securityagent.types.list_agent_spaces_output.ListAgentSpacesOutput = (
        capo_securityagent.types.list_agent_spaces_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.list_agent_spaces_input.serialize_json(input_)
    ).encode()
