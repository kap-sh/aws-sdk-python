...
def handle_response(
    ...
    out: capo_securityagent.types.verify_target_domain_output.VerifyTargetDomainOutput = capo_securityagent.types.verify_target_domain_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.verify_target_domain_input.serialize_json(input_)
    ).encode()
