"""Generated from Smithy shape ``com.amazonaws.securityagent#ListCodeReviewJobsForCodeReview``."""
...
def handle_response(
    ...
    out: capo_securityagent.types.list_code_review_jobs_for_code_review_output.ListCodeReviewJobsForCodeReviewOutput = capo_securityagent.types.list_code_review_jobs_for_code_review_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ListCodeReviewJobsForCodeReview"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_securityagent.types.list_code_review_jobs_for_code_review_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_code_review_jobs_for_code_review(
