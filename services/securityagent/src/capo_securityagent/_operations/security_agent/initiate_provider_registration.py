...
import capo_securityagent.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_securityagent.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_securityagent.types.initiate_provider_registration_output.InitiateProviderRegistrationOutput = capo_securityagent.types.initiate_provider_registration_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.initiate_provider_registration_input.serialize_json(
            input_
        )
    ).encode()
