...
def handle_response(
    ...
    out: capo_securityagent.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_securityagent.types.list_tags_for_resource_output.deserialize_json(
