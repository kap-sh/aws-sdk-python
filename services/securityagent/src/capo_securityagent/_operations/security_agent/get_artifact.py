...
def handle_response(
    ...
    out: capo_securityagent.types.get_artifact_output.GetArtifactOutput = (
        capo_securityagent.types.get_artifact_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.get_artifact_input.serialize_json(input_)
    ).encode()
...
def get_artifact(
    ...
    capo_securityagent.types.get_artifact_output.GetArtifactOutput, zapros.Response
]:
