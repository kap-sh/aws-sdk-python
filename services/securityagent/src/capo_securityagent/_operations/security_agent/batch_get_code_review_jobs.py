"""Generated from Smithy shape ``com.amazonaws.securityagent#BatchGetCodeReviewJobs``."""
...
def handle_response(
    ...
    out: capo_securityagent.types.batch_get_code_review_jobs_output.BatchGetCodeReviewJobsOutput = capo_securityagent.types.batch_get_code_review_jobs_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.batch_get_code_review_jobs_input.serialize_json(input_)
    ).encode()
