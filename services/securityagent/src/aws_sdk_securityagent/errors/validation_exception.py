...
if TYPE_CHECKING:
    import aws_sdk_securityagent.types.validation_exception_field_list
...
class ValidationException_(TypedDict):
    ...
    field_list: NotRequired[
        "aws_sdk_securityagent.types.validation_exception_field_list.ValidationExceptionFieldList"
    ]
...
def serialize_json(value: ValidationException_) -> dict:
    ...
    if "field_list" in value:
        ...
        out["fieldList"] = (
            aws_sdk_securityagent.types.validation_exception_field_list.serialize_json(
                value["field_list"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ValidationException_:
    ...
    if "fieldList" in data:
        ...
        out["field_list"] = (
            aws_sdk_securityagent.types.validation_exception_field_list.deserialize_json(
                data["fieldList"]
            )
        )
    return out
