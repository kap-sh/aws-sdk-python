"""Generated from Smithy shape ``com.amazonaws.securityagent#AccessDeniedException``."""

from typing import TypedDict
from aws_sdk_securityagent.errors import DeserializationError
from aws_sdk_securityagent.errors import ServiceError
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.securityagent#AccessDeniedException``."""
