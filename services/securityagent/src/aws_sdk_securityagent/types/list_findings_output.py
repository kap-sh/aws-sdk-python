...
class ListFindingsOutput(TypedDict):
    findings_summaries: NotRequired[
        "aws_sdk_securityagent.types.finding_summary_list.FindingSummaryList"
    ]
...
def serialize_json(value: ListFindingsOutput) -> dict:
    ...
    if "findings_summaries" in value:
        ...
        out["findingsSummaries"] = (
            aws_sdk_securityagent.types.finding_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListFindingsOutput:
    ...
    if "findingsSummaries" in data:
        ...
        out["findings_summaries"] = (
            aws_sdk_securityagent.types.finding_summary_list.deserialize_json(
