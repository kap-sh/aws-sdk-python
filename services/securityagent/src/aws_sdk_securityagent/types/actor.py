...
class Actor(TypedDict):
    ...
    authentication: NotRequired["aws_sdk_securityagent.types.authentication.Authentication"]
...
def serialize_json(value: Actor) -> dict:
    ...
    if "authentication" in value:
        import aws_sdk_securityagent.types.authentication
        out["authentication"] = aws_sdk_securityagent.types.authentication.serialize_json(value["authentication"])
...
def deserialize_json(data: dict) -> Actor:
    ...
    if "uris" in data:
        import aws_sdk_securityagent.types.uri_list
        out["uris"] = aws_sdk_securityagent.types.uri_list.deserialize_json(data["uris"])
    if "authentication" in data:
        import aws_sdk_securityagent.types.authentication
        out["authentication"] = aws_sdk_securityagent.types.authentication.deserialize_json(data["authentication"])
