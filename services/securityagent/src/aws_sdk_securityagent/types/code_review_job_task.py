"""Generated from Smithy shape ``com.amazonaws.securityagent#CodeReviewJobTask``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityagent.types.category_list
    import aws_sdk_securityagent.types.log_location
    import aws_sdk_securityagent.types.risk_type
    import aws_sdk_securityagent.types.task_execution_status


class CodeReviewJobTask(TypedDict, closed=True):
    task_id: "str"
    ...
    categories: NotRequired["aws_sdk_securityagent.types.category_list.CategoryList"]
    ...
    logs_location: NotRequired["aws_sdk_securityagent.types.log_location.LogLocation"]
...
# --- restJson1 ser/de ---
def serialize_json(value: CodeReviewJobTask) -> dict:
    out: dict = {}
    ...
    if "categories" in value:
        ...
        out["categories"] = aws_sdk_securityagent.types.category_list.serialize_json(
            value["categories"]
        )
    ...
    if "logs_location" in value:
        ...
        out["logsLocation"] = aws_sdk_securityagent.types.log_location.serialize_json(
            value["logs_location"]
        )
...
def deserialize_json(data: dict) -> CodeReviewJobTask:
    out: CodeReviewJobTask = {}  # type: ignore[typeddict-item]
    if "taskId" in data:
        out["task_id"] = data["taskId"]
    else:
        raise DeserializationError("CodeReviewJobTask.task_id required")
    ...
    if "categories" in data:
        ...
        out["categories"] = aws_sdk_securityagent.types.category_list.deserialize_json(
            data["categories"]
        )
    if "riskType" in data:
        import aws_sdk_securityagent.types.risk_type
    ...
    if "logsLocation" in data:
        ...
        out["logs_location"] = (
            aws_sdk_securityagent.types.log_location.deserialize_json(
                data["logsLocation"]
            )
        )
