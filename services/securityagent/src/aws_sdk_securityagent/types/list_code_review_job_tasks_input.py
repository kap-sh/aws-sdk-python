...
class ListCodeReviewJobTasksInput(TypedDict):
    agent_space_id: "str"
    ...
    step_name: NotRequired["aws_sdk_securityagent.types.step_name.StepName"]
...
def serialize_json(value: ListCodeReviewJobTasksInput) -> dict:
    ...
    if "step_name" in value:
        ...
        out["stepName"] = aws_sdk_securityagent.types.step_name.serialize_json(
            value["step_name"]
        )
...
def deserialize_json(data: dict) -> ListCodeReviewJobTasksInput:
    ...
    if "stepName" in data:
        ...
        out["step_name"] = aws_sdk_securityagent.types.step_name.deserialize_json(
            data["stepName"]
        )
