...
class ListIntegratedResourcesInput(TypedDict):
...
def serialize_json(value: ListIntegratedResourcesInput) -> dict:
    ...
    if "resource_type" in value:
        ...
        out["resourceType"] = aws_sdk_securityagent.types.resource_type.serialize_json(
            value["resource_type"]
        )
...
def deserialize_json(data: dict) -> ListIntegratedResourcesInput:
    ...
    if "resourceType" in data:
        ...
        out["resource_type"] = (
            aws_sdk_securityagent.types.resource_type.deserialize_json(
                data["resourceType"]
            )
        )
