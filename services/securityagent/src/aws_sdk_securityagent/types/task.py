...
class Task(TypedDict, closed=True):
    ...
    target_endpoint: NotRequired["aws_sdk_securityagent.types.endpoint.Endpoint"]
...
def serialize_json(value: Task) -> dict:
    ...
    if "target_endpoint" in value:
        ...
        out["targetEndpoint"] = aws_sdk_securityagent.types.endpoint.serialize_json(
...
def deserialize_json(data: dict) -> Task:
    ...
    if "targetEndpoint" in data:
        ...
        out["target_endpoint"] = aws_sdk_securityagent.types.endpoint.deserialize_json(
            data["targetEndpoint"]
        )
