...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityagent.types.target_domain_summary_list


class ListTargetDomainsOutput(TypedDict):
    target_domain_summaries: NotRequired[
        "aws_sdk_securityagent.types.target_domain_summary_list.TargetDomainSummaryList"
    ]
...
def serialize_json(value: ListTargetDomainsOutput) -> dict:
    ...
    if "target_domain_summaries" in value:
        ...
        out["targetDomainSummaries"] = (
            aws_sdk_securityagent.types.target_domain_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListTargetDomainsOutput:
    ...
    if "targetDomainSummaries" in data:
        ...
        out["target_domain_summaries"] = (
            aws_sdk_securityagent.types.target_domain_summary_list.deserialize_json(
