...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityagent.types.location


class InitiateProviderRegistrationOutput(TypedDict):
    redirect_to: "aws_sdk_securityagent.types.location.Location"
    """<p>The URL to redirect the user to for completing the OAuth authorization.</p>"""
    csrf_state: "aws_sdk_securityagent.types.csrf_state.CsrfState"
