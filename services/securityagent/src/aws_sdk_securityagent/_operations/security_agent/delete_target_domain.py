...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.delete_target_domain_output.DeleteTargetDomainOutput = aws_sdk_securityagent.types.delete_target_domain_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.delete_target_domain_input.DeleteTargetDomainInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.delete_target_domain_input.serialize_json(input_)
    ).encode()
