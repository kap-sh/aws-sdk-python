"""Generated from Smithy shape ``com.amazonaws.securityagent#BatchGetAgentSpaces``."""
...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.batch_get_agent_spaces_output.BatchGetAgentSpacesOutput = aws_sdk_securityagent.types.batch_get_agent_spaces_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.batch_get_agent_spaces_input.BatchGetAgentSpacesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/BatchGetAgentSpaces"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityagent.types.batch_get_agent_spaces_input

    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.batch_get_agent_spaces_input.serialize_json(input_)
    ).encode()
...
async def async_batch_get_agent_spaces(
