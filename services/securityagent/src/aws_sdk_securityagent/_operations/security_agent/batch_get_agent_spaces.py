...
def build_request(
    ...
    input: aws_sdk_securityagent.types.batch_get_agent_spaces_input.BatchGetAgentSpacesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.batch_get_agent_spaces_input.serialize_json(input)
    ).encode()
