...
def build_request(
    ...
    input: aws_sdk_securityagent.types.batch_get_findings_input.BatchGetFindingsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.batch_get_findings_input.serialize_json(input)
    ).encode()
