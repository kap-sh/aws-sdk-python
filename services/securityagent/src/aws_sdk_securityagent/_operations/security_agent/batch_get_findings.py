...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.batch_get_findings_output.BatchGetFindingsOutput = aws_sdk_securityagent.types.batch_get_findings_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.batch_get_findings_input.BatchGetFindingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.batch_get_findings_input.serialize_json(input_)
    ).encode()
