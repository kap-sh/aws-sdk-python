...
def build_request(
    ...
    input: aws_sdk_securityagent.types.delete_membership_request.DeleteMembershipRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.delete_membership_request.serialize_json(input)
    ).encode()
