"""Generated from Smithy shape ``com.amazonaws.securityagent#DeleteMembership``."""
...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.delete_membership_response.DeleteMembershipResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.delete_membership_request.DeleteMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteMembership"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityagent.types.delete_membership_request

    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.delete_membership_request.serialize_json(input_)
    ).encode()
...
async def async_delete_membership(
