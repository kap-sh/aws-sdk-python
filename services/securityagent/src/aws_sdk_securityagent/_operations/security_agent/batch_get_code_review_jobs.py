...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.batch_get_code_review_jobs_output.BatchGetCodeReviewJobsOutput = aws_sdk_securityagent.types.batch_get_code_review_jobs_output.deserialize_json(
