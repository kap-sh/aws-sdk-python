...
def build_request(
    ...
    input: aws_sdk_securityagent.types.get_application_request.GetApplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.get_application_request.serialize_json(input)
    ).encode()
