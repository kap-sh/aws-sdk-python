"""Generated from Smithy shape ``com.amazonaws.securityagent#GetApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.get_application_response.GetApplicationResponse = (
        aws_sdk_securityagent.types.get_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.get_application_request.GetApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetApplication"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityagent.types.get_application_request

    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.get_application_request.serialize_json(input_)
    ).encode()
