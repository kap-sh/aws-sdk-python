"""Generated from Smithy shape ``com.amazonaws.securityagent#ListMemberships``."""
...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.list_memberships_response.ListMembershipsResponse = aws_sdk_securityagent.types.list_memberships_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.list_memberships_request.ListMembershipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListMemberships"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityagent.types.list_memberships_request

    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_memberships_request.serialize_json(input_)
    ).encode()
