...
def build_request(
    ...
    input: aws_sdk_securityagent.types.list_memberships_request.ListMembershipsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_memberships_request.serialize_json(input)
    ).encode()
