...
def build_request(
    ...
    input: aws_sdk_securityagent.types.start_code_review_job_input.StartCodeReviewJobInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.start_code_review_job_input.serialize_json(input)
    ).encode()
