...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.start_code_remediation_output.StartCodeRemediationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.start_code_remediation_input.StartCodeRemediationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.start_code_remediation_input.serialize_json(input_)
    ).encode()
