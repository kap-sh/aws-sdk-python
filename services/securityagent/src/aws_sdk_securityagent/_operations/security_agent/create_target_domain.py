...
def build_request(
    ...
    input: aws_sdk_securityagent.types.create_target_domain_input.CreateTargetDomainInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.create_target_domain_input.serialize_json(input)
    ).encode()
