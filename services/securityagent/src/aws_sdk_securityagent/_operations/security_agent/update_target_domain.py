...
def build_request(
    ...
    input: aws_sdk_securityagent.types.update_target_domain_input.UpdateTargetDomainInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.update_target_domain_input.serialize_json(input)
    ).encode()
