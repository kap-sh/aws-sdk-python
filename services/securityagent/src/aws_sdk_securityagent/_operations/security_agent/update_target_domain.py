...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.update_target_domain_output.UpdateTargetDomainOutput = aws_sdk_securityagent.types.update_target_domain_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.update_target_domain_input.UpdateTargetDomainInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.update_target_domain_input.serialize_json(input_)
    ).encode()
