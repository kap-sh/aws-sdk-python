...
def build_request(
    ...
    input: aws_sdk_securityagent.types.batch_get_code_reviews_input.BatchGetCodeReviewsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.batch_get_code_reviews_input.serialize_json(input)
    ).encode()
