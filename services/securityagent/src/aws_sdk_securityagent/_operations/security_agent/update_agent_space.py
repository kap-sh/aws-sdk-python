...
def build_request(
    ...
    input: aws_sdk_securityagent.types.update_agent_space_input.UpdateAgentSpaceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.update_agent_space_input.serialize_json(input)
    ).encode()
