...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.update_agent_space_output.UpdateAgentSpaceOutput = aws_sdk_securityagent.types.update_agent_space_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.update_agent_space_input.UpdateAgentSpaceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.update_agent_space_input.serialize_json(input_)
    ).encode()
