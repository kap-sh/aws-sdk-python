...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.update_finding_output.UpdateFindingOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.update_finding_input.UpdateFindingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.update_finding_input.serialize_json(input_)
    ).encode()
