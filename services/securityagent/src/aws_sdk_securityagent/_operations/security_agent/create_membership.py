...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.create_membership_request.CreateMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.create_membership_request.serialize_json(input_)
    ).encode()
