...
def build_request(
    ...
    input: aws_sdk_securityagent.types.create_membership_request.CreateMembershipRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.create_membership_request.serialize_json(input)
    ).encode()
