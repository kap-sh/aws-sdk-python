"""Generated from Smithy shape ``com.amazonaws.securityagent#VerifyTargetDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.verify_target_domain_output.VerifyTargetDomainOutput = aws_sdk_securityagent.types.verify_target_domain_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityagent.types.verify_target_domain_input.VerifyTargetDomainInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.verify_target_domain_input.serialize_json(input)
    ).encode()
...
async def async_verify_target_domain(
