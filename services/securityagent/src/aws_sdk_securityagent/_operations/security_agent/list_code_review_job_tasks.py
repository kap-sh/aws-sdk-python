...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.list_code_review_job_tasks_output.ListCodeReviewJobTasksOutput = aws_sdk_securityagent.types.list_code_review_job_tasks_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.list_code_review_job_tasks_input.ListCodeReviewJobTasksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_code_review_job_tasks_input.serialize_json(
            input_
        )
    ).encode()
