...
def build_request(
    ...
    input: aws_sdk_securityagent.types.list_code_reviews_input.ListCodeReviewsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_code_reviews_input.serialize_json(input)
    ).encode()
