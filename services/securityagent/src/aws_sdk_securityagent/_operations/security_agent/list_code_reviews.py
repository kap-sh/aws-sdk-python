...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.list_code_reviews_output.ListCodeReviewsOutput = (
        aws_sdk_securityagent.types.list_code_reviews_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.list_code_reviews_input.ListCodeReviewsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_code_reviews_input.serialize_json(input_)
    ).encode()
