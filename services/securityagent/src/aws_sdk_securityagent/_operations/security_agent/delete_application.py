...
def build_request(
    ...
    input: aws_sdk_securityagent.types.delete_application_request.DeleteApplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.delete_application_request.serialize_json(input)
    ).encode()
