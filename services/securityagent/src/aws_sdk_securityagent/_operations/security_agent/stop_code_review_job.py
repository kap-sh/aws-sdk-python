...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.stop_code_review_job_output.StopCodeReviewJobOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.stop_code_review_job_input.StopCodeReviewJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.stop_code_review_job_input.serialize_json(input_)
    ).encode()
