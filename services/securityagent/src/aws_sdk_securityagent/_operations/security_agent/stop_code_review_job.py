...
def build_request(
    ...
    input: aws_sdk_securityagent.types.stop_code_review_job_input.StopCodeReviewJobInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.stop_code_review_job_input.serialize_json(input)
    ).encode()
