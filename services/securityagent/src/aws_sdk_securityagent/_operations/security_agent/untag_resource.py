"""Generated from Smithy shape ``com.amazonaws.securityagent#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
