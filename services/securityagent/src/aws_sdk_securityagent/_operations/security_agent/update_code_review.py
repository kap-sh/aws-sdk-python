...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.update_code_review_output.UpdateCodeReviewOutput = aws_sdk_securityagent.types.update_code_review_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.update_code_review_input.UpdateCodeReviewInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.update_code_review_input.serialize_json(input_)
    ).encode()
