...
def build_request(
    ...
    input: aws_sdk_securityagent.types.list_applications_request.ListApplicationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_applications_request.serialize_json(input)
    ).encode()
