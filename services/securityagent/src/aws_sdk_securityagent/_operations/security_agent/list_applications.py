"""Generated from Smithy shape ``com.amazonaws.securityagent#ListApplications``."""
...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.list_applications_response.ListApplicationsResponse = aws_sdk_securityagent.types.list_applications_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.list_applications_request.ListApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_applications_request.serialize_json(input_)
    ).encode()
