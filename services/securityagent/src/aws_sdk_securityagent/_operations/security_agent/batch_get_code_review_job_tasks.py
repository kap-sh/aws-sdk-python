...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.batch_get_code_review_job_tasks_input.BatchGetCodeReviewJobTasksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.batch_get_code_review_job_tasks_input.serialize_json(
            input_
        )
    ).encode()
