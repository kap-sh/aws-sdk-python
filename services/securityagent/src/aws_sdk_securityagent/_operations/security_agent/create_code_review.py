...
def build_request(
    ...
    input: aws_sdk_securityagent.types.create_code_review_input.CreateCodeReviewInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.create_code_review_input.serialize_json(input)
    ).encode()
