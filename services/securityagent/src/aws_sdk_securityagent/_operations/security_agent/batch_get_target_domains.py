...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.batch_get_target_domains_output.BatchGetTargetDomainsOutput = aws_sdk_securityagent.types.batch_get_target_domains_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityagent.types.batch_get_target_domains_input.BatchGetTargetDomainsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.batch_get_target_domains_input.serialize_json(input)
    ).encode()
