...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.batch_get_target_domains_input.BatchGetTargetDomainsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.batch_get_target_domains_input.serialize_json(
            input_
        )
    ).encode()
