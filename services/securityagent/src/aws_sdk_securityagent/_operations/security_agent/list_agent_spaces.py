...
def build_request(
    ...
    input: aws_sdk_securityagent.types.list_agent_spaces_input.ListAgentSpacesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_agent_spaces_input.serialize_json(input)
    ).encode()
