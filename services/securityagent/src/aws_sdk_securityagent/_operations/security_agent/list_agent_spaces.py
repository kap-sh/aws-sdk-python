"""Generated from Smithy shape ``com.amazonaws.securityagent#ListAgentSpaces``."""
...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.list_agent_spaces_output.ListAgentSpacesOutput = (
        aws_sdk_securityagent.types.list_agent_spaces_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.list_agent_spaces_input.ListAgentSpacesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListAgentSpaces"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityagent.types.list_agent_spaces_input

    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_agent_spaces_input.serialize_json(input_)
    ).encode()
...
async def async_list_agent_spaces(
