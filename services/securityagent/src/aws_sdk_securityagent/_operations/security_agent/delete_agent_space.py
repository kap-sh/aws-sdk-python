...
def build_request(
    ...
    input: aws_sdk_securityagent.types.delete_agent_space_input.DeleteAgentSpaceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.delete_agent_space_input.serialize_json(input)
    ).encode()
