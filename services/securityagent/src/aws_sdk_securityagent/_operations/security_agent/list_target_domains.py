...
def build_request(
    ...
    input: aws_sdk_securityagent.types.list_target_domains_input.ListTargetDomainsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_target_domains_input.serialize_json(input)
    ).encode()
