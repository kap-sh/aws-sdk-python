...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.list_target_domains_output.ListTargetDomainsOutput = aws_sdk_securityagent.types.list_target_domains_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.list_target_domains_input.ListTargetDomainsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_target_domains_input.serialize_json(input_)
    ).encode()
