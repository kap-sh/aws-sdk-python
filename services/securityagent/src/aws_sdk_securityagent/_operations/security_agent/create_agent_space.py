...
def build_request(
    ...
    input: aws_sdk_securityagent.types.create_agent_space_input.CreateAgentSpaceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.create_agent_space_input.serialize_json(input)
    ).encode()
