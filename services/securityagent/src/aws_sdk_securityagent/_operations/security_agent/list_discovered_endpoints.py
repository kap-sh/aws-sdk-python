"""Generated from Smithy shape ``com.amazonaws.securityagent#ListDiscoveredEndpoints``."""
...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.list_discovered_endpoints_output.ListDiscoveredEndpointsOutput = aws_sdk_securityagent.types.list_discovered_endpoints_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.list_discovered_endpoints_input.ListDiscoveredEndpointsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListDiscoveredEndpoints"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.list_discovered_endpoints_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_discovered_endpoints(
