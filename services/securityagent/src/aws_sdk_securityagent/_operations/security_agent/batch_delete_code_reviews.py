...
def handle_response(
    ...
    out: aws_sdk_securityagent.types.batch_delete_code_reviews_output.BatchDeleteCodeReviewsOutput = aws_sdk_securityagent.types.batch_delete_code_reviews_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityagent.types.batch_delete_code_reviews_input.BatchDeleteCodeReviewsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityagent.types.batch_delete_code_reviews_input.serialize_json(
            input_
        )
    ).encode()
