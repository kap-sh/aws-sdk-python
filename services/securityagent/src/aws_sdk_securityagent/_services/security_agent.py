...
class SecurityAgentClientConfig(TypedDict, total=False, closed=True):
...
class SecurityAgentClient:
    ...
    def __init__(
        ...
        self.integration_resource = IntegrationResource(self)
        self.target_domain_resource = TargetDomainResource(self)

    def operation_options(
        self, config_overrides: Optional[SecurityAgentClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: SecurityAgentClientConfig = config_overrides or {}
    ...
    def add_artifact(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.add_artifact_input.AddArtifactInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.add_artifact_output.AddArtifactOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.add_artifact.add_artifact(
    ...
    def batch_delete_code_reviews(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.batch_delete_code_reviews_input.BatchDeleteCodeReviewsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.batch_delete_code_reviews_output.BatchDeleteCodeReviewsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.batch_delete_code_reviews.batch_delete_code_reviews(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_delete_pentests(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.batch_delete_pentests_input.BatchDeletePentestsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.batch_delete_pentests_output.BatchDeletePentestsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.batch_delete_pentests.batch_delete_pentests(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_artifact_metadata(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.batch_get_artifact_metadata_input.BatchGetArtifactMetadataInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.batch_get_artifact_metadata_output.BatchGetArtifactMetadataOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.batch_get_artifact_metadata.batch_get_artifact_metadata(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_code_review_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.batch_get_code_review_jobs_input.BatchGetCodeReviewJobsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.batch_get_code_review_jobs_output.BatchGetCodeReviewJobsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.batch_get_code_review_jobs.batch_get_code_review_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_code_review_job_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.batch_get_code_review_job_tasks_input.BatchGetCodeReviewJobTasksInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.batch_get_code_review_job_tasks_output.BatchGetCodeReviewJobTasksOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.batch_get_code_review_job_tasks.batch_get_code_review_job_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_code_reviews(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.batch_get_code_reviews_input.BatchGetCodeReviewsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.batch_get_code_reviews_output.BatchGetCodeReviewsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.batch_get_code_reviews.batch_get_code_reviews(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_findings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.batch_get_findings_input.BatchGetFindingsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.batch_get_findings_output.BatchGetFindingsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.batch_get_findings.batch_get_findings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_pentest_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.batch_get_pentest_jobs_input.BatchGetPentestJobsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.batch_get_pentest_jobs_output.BatchGetPentestJobsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.batch_get_pentest_jobs.batch_get_pentest_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_pentest_job_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.batch_get_pentest_job_tasks_input.BatchGetPentestJobTasksInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.batch_get_pentest_job_tasks_output.BatchGetPentestJobTasksOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.batch_get_pentest_job_tasks.batch_get_pentest_job_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_pentests(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.batch_get_pentests_input.BatchGetPentestsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.batch_get_pentests_output.BatchGetPentestsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.batch_get_pentests.batch_get_pentests(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_code_review(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.create_code_review_input.CreateCodeReviewInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.create_code_review_output.CreateCodeReviewOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.create_code_review.create_code_review(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_membership(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.create_membership_request.CreateMembershipRequest]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.create_membership_response.CreateMembershipResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.create_membership.create_membership(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_pentest(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.create_pentest_input.CreatePentestInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.create_pentest_output.CreatePentestOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.create_pentest.create_pentest(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_artifact(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.delete_artifact_input.DeleteArtifactInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.delete_artifact_output.DeleteArtifactOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.delete_artifact.delete_artifact(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_membership(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.delete_membership_request.DeleteMembershipRequest]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.delete_membership_response.DeleteMembershipResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.delete_membership.delete_membership(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_artifact(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.get_artifact_input.GetArtifactInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.get_artifact_output.GetArtifactOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.get_artifact.get_artifact(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def initiate_provider_registration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.initiate_provider_registration_input.InitiateProviderRegistrationInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.initiate_provider_registration_output.InitiateProviderRegistrationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.initiate_provider_registration.initiate_provider_registration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_artifacts(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_artifacts_input.ListArtifactsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_artifacts_output.ListArtifactsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_artifacts.list_artifacts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_securityagent.types.artifact_summary.ArtifactSummary]":
        _token = next_token
        while True:
    ...
    def list_code_review_jobs_for_code_review(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_code_review_jobs_for_code_review_input.ListCodeReviewJobsForCodeReviewInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_code_review_jobs_for_code_review_output.ListCodeReviewJobsForCodeReviewOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_code_review_jobs_for_code_review.list_code_review_jobs_for_code_review(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_code_review_jobs_for_code_review(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_securityagent.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_securityagent.types.code_review_job_summary.CodeReviewJobSummary]":
        _token = next_token
        while True:
            _response = self.list_code_review_jobs_for_code_review(
                code_review_id,
                agent_space_id,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    def list_code_review_job_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_code_review_job_tasks_input.ListCodeReviewJobTasksInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_code_review_job_tasks_output.ListCodeReviewJobTasksOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_code_review_job_tasks.list_code_review_job_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_code_review_job_tasks(
        ...
        *,
        ...
        category_name: Optional[str] = None,
        next_token: Optional["aws_sdk_securityagent.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_securityagent.types.code_review_job_task_summary.CodeReviewJobTaskSummary]":
        _token = next_token
        while True:
            _response = self.list_code_review_job_tasks(
                agent_space_id,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    def list_code_reviews(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_code_reviews_input.ListCodeReviewsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_code_reviews_output.ListCodeReviewsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_code_reviews.list_code_reviews(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_code_reviews(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_securityagent.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_securityagent.types.code_review_summary.CodeReviewSummary]":
        _token = next_token
        while True:
    ...
    def list_discovered_endpoints(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_discovered_endpoints_input.ListDiscoveredEndpointsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_discovered_endpoints_output.ListDiscoveredEndpointsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_discovered_endpoints.list_discovered_endpoints(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_discovered_endpoints(
        ...
        *,
        ...
        prefix: Optional[str] = None,
        next_token: Optional["aws_sdk_securityagent.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_securityagent.types.discovered_endpoint.DiscoveredEndpoint]":
        _token = next_token
        while True:
            _response = self.list_discovered_endpoints(
                pentest_job_id,
                agent_space_id,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    def list_findings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_findings_input.ListFindingsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_findings_output.ListFindingsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_findings.list_findings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_findings(
        ...
        *,
        ...
        name: Optional[str] = None,
    ) -> "Iterator[aws_sdk_securityagent.types.finding_summary.FindingSummary]":
        _token = next_token
        while True:
    ...
    def list_integrated_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_integrated_resources_input.ListIntegratedResourcesInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_integrated_resources_output.ListIntegratedResourcesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_integrated_resources.list_integrated_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_securityagent.types.integrated_resource_summary.IntegratedResourceSummary]":
        _token = next_token
        while True:
            _response = self.list_integrated_resources(
                agent_space_id,
                config_overrides=config_overrides,
    ...
    def list_memberships(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_memberships_request.ListMembershipsRequest]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_memberships_response.ListMembershipsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_memberships.list_memberships(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_memberships(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_securityagent.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_securityagent.types.membership_summary.MembershipSummary]":
        _token = next_token
        while True:
    ...
    def list_pentest_jobs_for_pentest(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_pentest_jobs_for_pentest_input.ListPentestJobsForPentestInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_pentest_jobs_for_pentest_output.ListPentestJobsForPentestOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_pentest_jobs_for_pentest.list_pentest_jobs_for_pentest(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_pentest_jobs_for_pentest(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_securityagent.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_securityagent.types.pentest_job_summary.PentestJobSummary]":
        _token = next_token
        while True:
            _response = self.list_pentest_jobs_for_pentest(
                pentest_id,
                agent_space_id,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    def list_pentest_job_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_pentest_job_tasks_input.ListPentestJobTasksInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_pentest_job_tasks_output.ListPentestJobTasksOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_pentest_job_tasks.list_pentest_job_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_pentest_job_tasks(
        ...
        *,
        ...
        category_name: Optional[str] = None,
        next_token: Optional["aws_sdk_securityagent.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_securityagent.types.task_summary.TaskSummary]":
        _token = next_token
        while True:
            _response = self.list_pentest_job_tasks(
                agent_space_id,
                config_overrides=config_overrides,
                max_results=max_results,
                pentest_job_id=pentest_job_id,
    ...
    def list_pentests(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_pentests_input.ListPentestsInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_pentests_output.ListPentestsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_pentests.list_pentests(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_pentests(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_securityagent.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_securityagent.types.pentest_summary.PentestSummary]":
        _token = next_token
        while True:
            _response = self.list_pentests(
                agent_space_id,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_code_remediation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.start_code_remediation_input.StartCodeRemediationInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.start_code_remediation_output.StartCodeRemediationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.start_code_remediation.start_code_remediation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_code_review_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.start_code_review_job_input.StartCodeReviewJobInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.start_code_review_job_output.StartCodeReviewJobOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.start_code_review_job.start_code_review_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_pentest_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.start_pentest_job_input.StartPentestJobInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.start_pentest_job_output.StartPentestJobOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.start_pentest_job.start_pentest_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_code_review_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.stop_code_review_job_input.StopCodeReviewJobInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.stop_code_review_job_output.StopCodeReviewJobOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.stop_code_review_job.stop_code_review_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_pentest_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.stop_pentest_job_input.StopPentestJobInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.stop_pentest_job_output.StopPentestJobOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.stop_pentest_job.stop_pentest_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_code_review(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.update_code_review_input.UpdateCodeReviewInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.update_code_review_output.UpdateCodeReviewOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.update_code_review.update_code_review(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_finding(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.update_finding_input.UpdateFindingInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.update_finding_output.UpdateFindingOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.update_finding.update_finding(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_integrated_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.update_integrated_resources_input.UpdateIntegratedResourcesInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.update_integrated_resources_output.UpdateIntegratedResourcesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.update_integrated_resources.update_integrated_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_pentest(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.update_pentest_input.UpdatePentestInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.update_pentest_output.UpdatePentestOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.update_pentest.update_pentest(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def verify_target_domain(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_securityagent.types.verify_target_domain_input.VerifyTargetDomainInput]",
        ) -> OperationResponse[
            "aws_sdk_securityagent.types.verify_target_domain_output.VerifyTargetDomainOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_securityagent._operations.security_agent.verify_target_domain.verify_target_domain(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
