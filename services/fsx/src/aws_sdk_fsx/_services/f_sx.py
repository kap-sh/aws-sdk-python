...
from aws_sdk_fsx._services._aws_config import aws_config
from aws_sdk_fsx._services._pipeline import (
    Interceptor,
    OperationOptions,
    OperationRequest,
    OperationResponse,
...
if TYPE_CHECKING:
    ...
    import aws_sdk_fsx.types.associate_file_system_aliases_request
    import aws_sdk_fsx.types.associate_file_system_aliases_response
    ...
    import aws_sdk_fsx.types.copy_backup_request
    import aws_sdk_fsx.types.copy_backup_response
    import aws_sdk_fsx.types.copy_snapshot_and_update_volume_request
    import aws_sdk_fsx.types.copy_snapshot_and_update_volume_response
    import aws_sdk_fsx.types.copy_tags_to_data_repository_associations
    ...
    import aws_sdk_fsx.types.create_backup_request
    import aws_sdk_fsx.types.create_backup_response
    import aws_sdk_fsx.types.create_data_repository_association_request
    import aws_sdk_fsx.types.create_data_repository_association_response
    import aws_sdk_fsx.types.create_data_repository_task_request
    import aws_sdk_fsx.types.create_data_repository_task_response
    ...
    import aws_sdk_fsx.types.create_file_system_ontap_configuration
    import aws_sdk_fsx.types.create_file_system_open_zfs_configuration
    import aws_sdk_fsx.types.create_file_system_request
    import aws_sdk_fsx.types.create_file_system_response
    ...
    import aws_sdk_fsx.types.create_storage_virtual_machine_request
    import aws_sdk_fsx.types.create_storage_virtual_machine_response
    ...
    import aws_sdk_fsx.types.create_volume_request
    import aws_sdk_fsx.types.create_volume_response
    ...
    import aws_sdk_fsx.types.delete_backup_request
    import aws_sdk_fsx.types.delete_backup_response
    import aws_sdk_fsx.types.delete_data_in_file_system
    import aws_sdk_fsx.types.delete_data_repository_association_request
    import aws_sdk_fsx.types.delete_data_repository_association_response
    import aws_sdk_fsx.types.delete_file_cache_request
    import aws_sdk_fsx.types.delete_file_cache_response
    ...
    import aws_sdk_fsx.types.delete_file_system_request
    import aws_sdk_fsx.types.delete_file_system_response
    import aws_sdk_fsx.types.delete_file_system_windows_configuration
    import aws_sdk_fsx.types.delete_snapshot_request
    import aws_sdk_fsx.types.delete_snapshot_response
    import aws_sdk_fsx.types.delete_storage_virtual_machine_request
    import aws_sdk_fsx.types.delete_storage_virtual_machine_response
    import aws_sdk_fsx.types.delete_volume_ontap_configuration
    import aws_sdk_fsx.types.delete_volume_open_zfs_configuration
    import aws_sdk_fsx.types.delete_volume_request
    import aws_sdk_fsx.types.delete_volume_response
    import aws_sdk_fsx.types.describe_backups_request
    import aws_sdk_fsx.types.describe_backups_response
    ...
    import aws_sdk_fsx.types.describe_data_repository_tasks_request
    import aws_sdk_fsx.types.describe_data_repository_tasks_response
    import aws_sdk_fsx.types.describe_file_caches_request
    import aws_sdk_fsx.types.describe_file_caches_response
    import aws_sdk_fsx.types.describe_file_system_aliases_request
    import aws_sdk_fsx.types.describe_file_system_aliases_response
    import aws_sdk_fsx.types.describe_file_systems_request
    import aws_sdk_fsx.types.describe_file_systems_response
    import aws_sdk_fsx.types.describe_s3_access_point_attachments_request
    import aws_sdk_fsx.types.describe_s3_access_point_attachments_response
    import aws_sdk_fsx.types.describe_shared_vpc_configuration_request
    import aws_sdk_fsx.types.describe_shared_vpc_configuration_response
    import aws_sdk_fsx.types.describe_snapshots_request
    import aws_sdk_fsx.types.describe_snapshots_response
    import aws_sdk_fsx.types.describe_storage_virtual_machines_request
    import aws_sdk_fsx.types.describe_storage_virtual_machines_response
    import aws_sdk_fsx.types.describe_volumes_request
    import aws_sdk_fsx.types.describe_volumes_response
    import aws_sdk_fsx.types.detach_and_delete_s3_access_point_request
    import aws_sdk_fsx.types.detach_and_delete_s3_access_point_response
    import aws_sdk_fsx.types.disassociate_file_system_aliases_request
    import aws_sdk_fsx.types.disassociate_file_system_aliases_response
    ...
    import aws_sdk_fsx.types.release_file_system_nfs_v3_locks_response
    import aws_sdk_fsx.types.resource_arn
    import aws_sdk_fsx.types.restore_open_zfs_volume_options
    import aws_sdk_fsx.types.restore_volume_from_snapshot_request
    import aws_sdk_fsx.types.restore_volume_from_snapshot_response
    ...
    import aws_sdk_fsx.types.start_misconfigured_state_recovery_response
    ...
    import aws_sdk_fsx.types.tag_resource_request
    import aws_sdk_fsx.types.tag_resource_response
    import aws_sdk_fsx.types.tags
    import aws_sdk_fsx.types.task_id
    import aws_sdk_fsx.types.task_ids
    import aws_sdk_fsx.types.untag_resource_request
    import aws_sdk_fsx.types.untag_resource_response
    import aws_sdk_fsx.types.update_data_repository_association_request
    import aws_sdk_fsx.types.update_data_repository_association_response
    import aws_sdk_fsx.types.update_file_cache_lustre_configuration
    import aws_sdk_fsx.types.update_file_cache_request
    import aws_sdk_fsx.types.update_file_cache_response
    import aws_sdk_fsx.types.update_file_system_lustre_configuration
    import aws_sdk_fsx.types.update_file_system_ontap_configuration
    import aws_sdk_fsx.types.update_file_system_open_zfs_configuration
    import aws_sdk_fsx.types.update_file_system_request
    import aws_sdk_fsx.types.update_file_system_response
    import aws_sdk_fsx.types.update_file_system_windows_configuration
    import aws_sdk_fsx.types.update_ontap_volume_configuration
    import aws_sdk_fsx.types.update_open_zfs_volume_configuration
    import aws_sdk_fsx.types.update_open_zfs_volume_options
    import aws_sdk_fsx.types.update_shared_vpc_configuration_request
    import aws_sdk_fsx.types.update_shared_vpc_configuration_response
    import aws_sdk_fsx.types.update_snapshot_request
    import aws_sdk_fsx.types.update_snapshot_response
    import aws_sdk_fsx.types.update_storage_virtual_machine_request
    import aws_sdk_fsx.types.update_storage_virtual_machine_response
    import aws_sdk_fsx.types.update_svm_active_directory_configuration
    import aws_sdk_fsx.types.update_volume_request
    import aws_sdk_fsx.types.update_volume_response
...
class FSxClientConfig(TypedDict, total=False, closed=True):
...
class FSxClient:
    ...
    def operation_options(
        self, config_overrides: Optional[FSxClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: FSxClientConfig = config_overrides or {}
    ...
    def associate_file_system_aliases(
        self,
        file_system_id: "aws_sdk_fsx.types.file_system_id.FileSystemId",
        aliases: "aws_sdk_fsx.types.alternate_dns_names.AlternateDNSNames",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
        ] = None,
    ) -> "aws_sdk_fsx.types.associate_file_system_aliases_response.AssociateFileSystemAliasesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.associate_file_system_aliases_request.AssociateFileSystemAliasesRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.associate_file_system_aliases_response.AssociateFileSystemAliasesResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.associate_file_system_aliases

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.associate_file_system_aliases.associate_file_system_aliases(
    ...
    def cancel_data_repository_task(
        self,
        task_id: "aws_sdk_fsx.types.task_id.TaskId",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.cancel_data_repository_task_request.CancelDataRepositoryTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.cancel_data_repository_task_response.CancelDataRepositoryTaskResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.cancel_data_repository_task

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.cancel_data_repository_task.cancel_data_repository_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def copy_backup(
        self,
        source_backup_id: "aws_sdk_fsx.types.source_backup_id.SourceBackupId",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
        ] = None,
        source_region: Optional["aws_sdk_fsx.types.region.Region"] = None,
        kms_key_id: Optional["aws_sdk_fsx.types.kms_key_id.KmsKeyId"] = None,
        copy_tags: Optional["aws_sdk_fsx.types.flag.Flag"] = None,
        tags: Optional["aws_sdk_fsx.types.tags.Tags"] = None,
    ) -> "aws_sdk_fsx.types.copy_backup_response.CopyBackupResponse":
        ...
        Examples:
            ...
            >>> client.copy_backup(source_backup_id='backup-03e3c82e0183b7b6b', source_region='us-east-2')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.copy_backup_request.CopyBackupRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.copy_backup_response.CopyBackupResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.copy_backup

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.copy_backup.copy_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def copy_snapshot_and_update_volume(
        self,
        volume_id: "aws_sdk_fsx.types.volume_id.VolumeId",
        source_snapshot_arn: "aws_sdk_fsx.types.resource_arn.ResourceARN",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
        ...
        options: Optional[
            "aws_sdk_fsx.types.update_open_zfs_volume_options.UpdateOpenZFSVolumeOptions"
        ] = None,
    ) -> "aws_sdk_fsx.types.copy_snapshot_and_update_volume_response.CopySnapshotAndUpdateVolumeResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.copy_snapshot_and_update_volume_request.CopySnapshotAndUpdateVolumeRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.copy_snapshot_and_update_volume_response.CopySnapshotAndUpdateVolumeResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.copy_snapshot_and_update_volume

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.copy_snapshot_and_update_volume.copy_snapshot_and_update_volume(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_and_attach_s3_access_point(
        self,
        name: "aws_sdk_fsx.types.s3_access_point_attachment_name.S3AccessPointAttachmentName",
        type: "aws_sdk_fsx.types.s3_access_point_attachment_type.S3AccessPointAttachmentType",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_and_attach_s3_access_point_request.CreateAndAttachS3AccessPointRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_and_attach_s3_access_point_response.CreateAndAttachS3AccessPointResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_and_attach_s3_access_point

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_and_attach_s3_access_point.create_and_attach_s3_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_backup(
        ...
        *,
        ...
        file_system_id: Optional[
            "aws_sdk_fsx.types.file_system_id.FileSystemId"
        ] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
        ] = None,
        tags: Optional["aws_sdk_fsx.types.tags.Tags"] = None,
        volume_id: Optional["aws_sdk_fsx.types.volume_id.VolumeId"] = None,
    ) -> "aws_sdk_fsx.types.create_backup_response.CreateBackupResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_backup_request.CreateBackupRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_backup_response.CreateBackupResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_backup

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_backup.create_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_data_repository_association(
        self,
        file_system_id: "aws_sdk_fsx.types.file_system_id.FileSystemId",
        data_repository_path: "aws_sdk_fsx.types.archive_path.ArchivePath",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        file_system_path: Optional["aws_sdk_fsx.types.namespace.Namespace"] = None,
        batch_import_meta_data_on_create: Optional[
            "aws_sdk_fsx.types.batch_import_meta_data_on_create.BatchImportMetaDataOnCreate"
        ] = None,
        imported_file_chunk_size: Optional[
            "aws_sdk_fsx.types.megabytes.Megabytes"
        ] = None,
        s3: Optional[
        ...
        tags: Optional["aws_sdk_fsx.types.tags.Tags"] = None,
    ) -> "aws_sdk_fsx.types.create_data_repository_association_response.CreateDataRepositoryAssociationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_data_repository_association_request.CreateDataRepositoryAssociationRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_data_repository_association_response.CreateDataRepositoryAssociationResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_data_repository_association

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_data_repository_association.create_data_repository_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_data_repository_task(
        self,
        type: "aws_sdk_fsx.types.data_repository_task_type.DataRepositoryTaskType",
        file_system_id: "aws_sdk_fsx.types.file_system_id.FileSystemId",
        report: "aws_sdk_fsx.types.completion_report.CompletionReport",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        paths: Optional[
    ...
    ) -> "aws_sdk_fsx.types.create_data_repository_task_response.CreateDataRepositoryTaskResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_data_repository_task_request.CreateDataRepositoryTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_data_repository_task_response.CreateDataRepositoryTaskResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_data_repository_task

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_data_repository_task.create_data_repository_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_file_cache(
        self,
        file_cache_type: "aws_sdk_fsx.types.file_cache_type.FileCacheType",
        file_cache_type_version: "aws_sdk_fsx.types.file_system_type_version.FileSystemTypeVersion",
        storage_capacity: "aws_sdk_fsx.types.storage_capacity.StorageCapacity",
        subnet_ids: "aws_sdk_fsx.types.subnet_ids.SubnetIds",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
        ...
        copy_tags_to_data_repository_associations: Optional[
            "aws_sdk_fsx.types.copy_tags_to_data_repository_associations.CopyTagsToDataRepositoryAssociations"
        ] = None,
        kms_key_id: Optional["aws_sdk_fsx.types.kms_key_id.KmsKeyId"] = None,
        ...
        data_repository_associations: Optional[
            "aws_sdk_fsx.types.create_file_cache_data_repository_associations.CreateFileCacheDataRepositoryAssociations"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_file_cache_request.CreateFileCacheRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_file_cache_response.CreateFileCacheResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_file_cache

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_file_cache.create_file_cache(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_file_system(
        self,
        file_system_type: "aws_sdk_fsx.types.file_system_type.FileSystemType",
        subnet_ids: "aws_sdk_fsx.types.subnet_ids.SubnetIds",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
        ...
        storage_capacity: Optional[
            "aws_sdk_fsx.types.storage_capacity.StorageCapacity"
        ] = None,
        storage_type: Optional["aws_sdk_fsx.types.storage_type.StorageType"] = None,
        security_group_ids: Optional[
            "aws_sdk_fsx.types.security_group_ids.SecurityGroupIds"
        ] = None,
        tags: Optional["aws_sdk_fsx.types.tags.Tags"] = None,
        ...
        ontap_configuration: Optional[
            "aws_sdk_fsx.types.create_file_system_ontap_configuration.CreateFileSystemOntapConfiguration"
        ] = None,
        ...
        network_type: Optional["aws_sdk_fsx.types.network_type.NetworkType"] = None,
    ) -> "aws_sdk_fsx.types.create_file_system_response.CreateFileSystemResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_file_system_request.CreateFileSystemRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_file_system_response.CreateFileSystemResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_file_system

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_file_system.create_file_system(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_file_system_from_backup(
        self,
        backup_id: "aws_sdk_fsx.types.backup_id.BackupId",
        subnet_ids: "aws_sdk_fsx.types.subnet_ids.SubnetIds",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_file_system_from_backup_request.CreateFileSystemFromBackupRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_file_system_from_backup_response.CreateFileSystemFromBackupResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_file_system_from_backup

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_file_system_from_backup.create_file_system_from_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_snapshot(
        self,
        name: "aws_sdk_fsx.types.snapshot_name.SnapshotName",
        volume_id: "aws_sdk_fsx.types.volume_id.VolumeId",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_snapshot_request.CreateSnapshotRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_snapshot_response.CreateSnapshotResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_snapshot

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_snapshot.create_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_storage_virtual_machine(
        self,
        file_system_id: "aws_sdk_fsx.types.file_system_id.FileSystemId",
        name: "aws_sdk_fsx.types.storage_virtual_machine_name.StorageVirtualMachineName",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        ...
        svm_admin_password: Optional[
            "aws_sdk_fsx.types.admin_password.AdminPassword"
        ] = None,
        tags: Optional["aws_sdk_fsx.types.tags.Tags"] = None,
    ...
    ) -> "aws_sdk_fsx.types.create_storage_virtual_machine_response.CreateStorageVirtualMachineResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_storage_virtual_machine_request.CreateStorageVirtualMachineRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_storage_virtual_machine_response.CreateStorageVirtualMachineResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_storage_virtual_machine

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_storage_virtual_machine.create_storage_virtual_machine(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_volume(
        self,
        volume_type: "aws_sdk_fsx.types.volume_type.VolumeType",
        name: "aws_sdk_fsx.types.volume_name.VolumeName",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
    ...
    ) -> "aws_sdk_fsx.types.create_volume_response.CreateVolumeResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_volume_request.CreateVolumeRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_volume_response.CreateVolumeResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_volume

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_volume.create_volume(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_volume_from_backup(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.create_volume_from_backup_request.CreateVolumeFromBackupRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.create_volume_from_backup_response.CreateVolumeFromBackupResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_volume_from_backup

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.create_volume_from_backup.create_volume_from_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_backup(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.delete_backup_response.DeleteBackupResponse":
        ...
        Examples:
            ...
            >>> client.delete_backup(backup_id='backup-03e3c82e0183b7b6b')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.delete_backup_request.DeleteBackupRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.delete_backup_response.DeleteBackupResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_backup

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_backup.delete_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_data_repository_association(
        self,
        association_id: "aws_sdk_fsx.types.data_repository_association_id.DataRepositoryAssociationId",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
    ...
    ) -> "aws_sdk_fsx.types.delete_data_repository_association_response.DeleteDataRepositoryAssociationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.delete_data_repository_association_request.DeleteDataRepositoryAssociationRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.delete_data_repository_association_response.DeleteDataRepositoryAssociationResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_data_repository_association

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_data_repository_association.delete_data_repository_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_file_cache(
        self,
        file_cache_id: "aws_sdk_fsx.types.file_cache_id.FileCacheId",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
        ] = None,
    ) -> "aws_sdk_fsx.types.delete_file_cache_response.DeleteFileCacheResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.delete_file_cache_request.DeleteFileCacheRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.delete_file_cache_response.DeleteFileCacheResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_file_cache

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_file_cache.delete_file_cache(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_file_system(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.delete_file_system_response.DeleteFileSystemResponse":
        ...
        Examples:
            ...
            >>> client.delete_file_system(file_system_id='fs-0498eed5fe91001ec')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.delete_file_system_request.DeleteFileSystemRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.delete_file_system_response.DeleteFileSystemResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_file_system

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_file_system.delete_file_system(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_snapshot(
        self,
        snapshot_id: "aws_sdk_fsx.types.snapshot_id.SnapshotId",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
        ] = None,
    ) -> "aws_sdk_fsx.types.delete_snapshot_response.DeleteSnapshotResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.delete_snapshot_request.DeleteSnapshotRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.delete_snapshot_response.DeleteSnapshotResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_snapshot

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_snapshot.delete_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_storage_virtual_machine(
        self,
        storage_virtual_machine_id: "aws_sdk_fsx.types.storage_virtual_machine_id.StorageVirtualMachineId",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        client_request_token: Optional[
            "aws_sdk_fsx.types.client_request_token.ClientRequestToken"
        ] = None,
    ) -> "aws_sdk_fsx.types.delete_storage_virtual_machine_response.DeleteStorageVirtualMachineResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.delete_storage_virtual_machine_request.DeleteStorageVirtualMachineRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.delete_storage_virtual_machine_response.DeleteStorageVirtualMachineResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_storage_virtual_machine

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_storage_virtual_machine.delete_storage_virtual_machine(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_volume(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.delete_volume_response.DeleteVolumeResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.delete_volume_request.DeleteVolumeRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.delete_volume_response.DeleteVolumeResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_volume

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.delete_volume.delete_volume(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_backups(
        ...
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        backup_ids: Optional["aws_sdk_fsx.types.backup_ids.BackupIds"] = None,
        filters: Optional["aws_sdk_fsx.types.filters.Filters"] = None,
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_fsx.types.describe_backups_response.DescribeBackupsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_backups_request.DescribeBackupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_backups_response.DescribeBackupsResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_backups

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_backups.describe_backups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_data_repository_associations(
        ...
        *,
        ...
        max_results: Optional[
            "aws_sdk_fsx.types.limited_max_results.LimitedMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_data_repository_associations_request.DescribeDataRepositoryAssociationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_data_repository_associations_response.DescribeDataRepositoryAssociationsResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_data_repository_associations

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_data_repository_associations.describe_data_repository_associations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_data_repository_tasks(
        ...
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        task_ids: Optional["aws_sdk_fsx.types.task_ids.TaskIds"] = None,
        filters: Optional[
            "aws_sdk_fsx.types.data_repository_task_filters.DataRepositoryTaskFilters"
        ] = None,
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_fsx.types.describe_data_repository_tasks_response.DescribeDataRepositoryTasksResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_data_repository_tasks_request.DescribeDataRepositoryTasksRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_data_repository_tasks_response.DescribeDataRepositoryTasksResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_data_repository_tasks

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_data_repository_tasks.describe_data_repository_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_file_caches(
        ...
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        file_cache_ids: Optional[
            "aws_sdk_fsx.types.file_cache_ids.FileCacheIds"
        ] = None,
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_fsx.types.describe_file_caches_response.DescribeFileCachesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_file_caches_request.DescribeFileCachesRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_file_caches_response.DescribeFileCachesResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_file_caches

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_file_caches.describe_file_caches(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_file_system_aliases(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_fsx.types.describe_file_system_aliases_response.DescribeFileSystemAliasesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_file_system_aliases_request.DescribeFileSystemAliasesRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_file_system_aliases_response.DescribeFileSystemAliasesResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_file_system_aliases

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_file_system_aliases.describe_file_system_aliases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_file_systems(
        ...
        *,
        ...
        file_system_ids: Optional[
            "aws_sdk_fsx.types.file_system_ids.FileSystemIds"
        ] = None,
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_fsx.types.describe_file_systems_response.DescribeFileSystemsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_file_systems_request.DescribeFileSystemsRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_file_systems_response.DescribeFileSystemsResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_file_systems

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_file_systems.describe_file_systems(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_s3_access_point_attachments(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_fsx.types.describe_s3_access_point_attachments_response.DescribeS3AccessPointAttachmentsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_s3_access_point_attachments_request.DescribeS3AccessPointAttachmentsRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_s3_access_point_attachments_response.DescribeS3AccessPointAttachmentsResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_s3_access_point_attachments

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_s3_access_point_attachments.describe_s3_access_point_attachments(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_s3_access_point_attachments(
        ...
        *,
        ...
        "Iterator[aws_sdk_fsx.types.s3_access_point_attachment.S3AccessPointAttachment]"
    ):
        _token = next_token
        while True:
            _response = self.describe_s3_access_point_attachments(
    ...
    def describe_shared_vpc_configuration(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_shared_vpc_configuration_request.DescribeSharedVpcConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_shared_vpc_configuration_response.DescribeSharedVpcConfigurationResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_shared_vpc_configuration

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_shared_vpc_configuration.describe_shared_vpc_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_snapshots(
        ...
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        snapshot_ids: Optional["aws_sdk_fsx.types.snapshot_ids.SnapshotIds"] = None,
        filters: Optional["aws_sdk_fsx.types.snapshot_filters.SnapshotFilters"] = None,
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
        include_shared: Optional[
            "aws_sdk_fsx.types.include_shared.IncludeShared"
        ] = None,
    ) -> "aws_sdk_fsx.types.describe_snapshots_response.DescribeSnapshotsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_snapshots_request.DescribeSnapshotsRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_snapshots_response.DescribeSnapshotsResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_snapshots

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_snapshots.describe_snapshots(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_fsx.types.snapshot.Snapshot]":
        _token = next_token
        while True:
    ...
    def describe_storage_virtual_machines(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_fsx.types.describe_storage_virtual_machines_response.DescribeStorageVirtualMachinesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_storage_virtual_machines_request.DescribeStorageVirtualMachinesRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_storage_virtual_machines_response.DescribeStorageVirtualMachinesResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_storage_virtual_machines

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_storage_virtual_machines.describe_storage_virtual_machines(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_storage_virtual_machines(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_fsx.types.storage_virtual_machine.StorageVirtualMachine]":
        _token = next_token
        while True:
            _response = self.describe_storage_virtual_machines(
                config_overrides=config_overrides,
    ...
    def describe_volumes(
        ...
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        volume_ids: Optional["aws_sdk_fsx.types.volume_ids.VolumeIds"] = None,
        filters: Optional["aws_sdk_fsx.types.volume_filters.VolumeFilters"] = None,
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_fsx.types.describe_volumes_response.DescribeVolumesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.describe_volumes_request.DescribeVolumesRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.describe_volumes_response.DescribeVolumesResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_volumes

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.describe_volumes.describe_volumes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_volumes(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_fsx.types.volume.Volume]":
        _token = next_token
        while True:
            _response = self.describe_volumes(
                config_overrides=config_overrides,
    ...
    def detach_and_delete_s3_access_point(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.detach_and_delete_s3_access_point_response.DetachAndDeleteS3AccessPointResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.detach_and_delete_s3_access_point_request.DetachAndDeleteS3AccessPointRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.detach_and_delete_s3_access_point_response.DetachAndDeleteS3AccessPointResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.detach_and_delete_s3_access_point

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.detach_and_delete_s3_access_point.detach_and_delete_s3_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_file_system_aliases(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.disassociate_file_system_aliases_response.DisassociateFileSystemAliasesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.disassociate_file_system_aliases_request.DisassociateFileSystemAliasesRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.disassociate_file_system_aliases_response.DisassociateFileSystemAliasesResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.disassociate_file_system_aliases

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.disassociate_file_system_aliases.disassociate_file_system_aliases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        self,
        resource_arn: "aws_sdk_fsx.types.resource_arn.ResourceARN",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
        max_results: Optional["aws_sdk_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_fsx.types.next_token.NextToken"] = None,
        ...
        Examples:
            ...
            >>> client.list_tags_for_resource(resource_arn='arn:aws:fsx:us-east-1:012345678912:file-system/fs-0498eed5fe91001ec')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.list_tags_for_resource

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def release_file_system_nfs_v3_locks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.release_file_system_nfs_v3_locks_request.ReleaseFileSystemNfsV3LocksRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.release_file_system_nfs_v3_locks_response.ReleaseFileSystemNfsV3LocksResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.release_file_system_nfs_v3_locks

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.release_file_system_nfs_v3_locks.release_file_system_nfs_v3_locks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def restore_volume_from_snapshot(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.restore_volume_from_snapshot_response.RestoreVolumeFromSnapshotResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.restore_volume_from_snapshot_request.RestoreVolumeFromSnapshotRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.restore_volume_from_snapshot_response.RestoreVolumeFromSnapshotResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.restore_volume_from_snapshot

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.restore_volume_from_snapshot.restore_volume_from_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_misconfigured_state_recovery(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.start_misconfigured_state_recovery_request.StartMisconfiguredStateRecoveryRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.start_misconfigured_state_recovery_response.StartMisconfiguredStateRecoveryResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.start_misconfigured_state_recovery

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.start_misconfigured_state_recovery.start_misconfigured_state_recovery(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        self,
        resource_arn: "aws_sdk_fsx.types.resource_arn.ResourceARN",
        tags: "aws_sdk_fsx.types.tags.Tags",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
    ) -> "aws_sdk_fsx.types.tag_resource_response.TagResourceResponse":
        ...
        Examples:
            ...
            >>> client.tag_resource(resource_arn='arn:aws:fsx:us-east-1:012345678912:file-system/fs-0498eed5fe91001ec', tags=[{'Key': 'Name', 'Value': 'MyFileSystem'}])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.tag_resource

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        self,
        resource_arn: "aws_sdk_fsx.types.resource_arn.ResourceARN",
        tag_keys: "aws_sdk_fsx.types.tag_keys.TagKeys",
        *,
        config_overrides: Optional[FSxClientConfig] = None,
    ) -> "aws_sdk_fsx.types.untag_resource_response.UntagResourceResponse":
        ...
        Examples:
            ...
            >>> client.untag_resource(resource_arn='arn:aws:fsx:us-east-1:012345678912:file-system/fs-0498eed5fe91001ec', tag_keys=['Name'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.untag_resource

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_data_repository_association(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.update_data_repository_association_response.UpdateDataRepositoryAssociationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.update_data_repository_association_request.UpdateDataRepositoryAssociationRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.update_data_repository_association_response.UpdateDataRepositoryAssociationResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_data_repository_association

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_data_repository_association.update_data_repository_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_file_cache(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.update_file_cache_response.UpdateFileCacheResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.update_file_cache_request.UpdateFileCacheRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.update_file_cache_response.UpdateFileCacheResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_file_cache

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_file_cache.update_file_cache(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_file_system(
        ...
        *,
        ...
        windows_configuration: Optional[
            "aws_sdk_fsx.types.update_file_system_windows_configuration.UpdateFileSystemWindowsConfiguration"
        ] = None,
        lustre_configuration: Optional[
            "aws_sdk_fsx.types.update_file_system_lustre_configuration.UpdateFileSystemLustreConfiguration"
        ] = None,
        ontap_configuration: Optional[
            "aws_sdk_fsx.types.update_file_system_ontap_configuration.UpdateFileSystemOntapConfiguration"
        ] = None,
        open_zfs_configuration: Optional[
            "aws_sdk_fsx.types.update_file_system_open_zfs_configuration.UpdateFileSystemOpenZFSConfiguration"
        ] = None,
        storage_type: Optional["aws_sdk_fsx.types.storage_type.StorageType"] = None,
        file_system_type_version: Optional[
            "aws_sdk_fsx.types.file_system_type_version.FileSystemTypeVersion"
        ...
        network_type: Optional["aws_sdk_fsx.types.network_type.NetworkType"] = None,
    ) -> "aws_sdk_fsx.types.update_file_system_response.UpdateFileSystemResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.update_file_system_request.UpdateFileSystemRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.update_file_system_response.UpdateFileSystemResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_file_system

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_file_system.update_file_system(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_shared_vpc_configuration(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.update_shared_vpc_configuration_response.UpdateSharedVpcConfigurationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.update_shared_vpc_configuration_request.UpdateSharedVpcConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.update_shared_vpc_configuration_response.UpdateSharedVpcConfigurationResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_shared_vpc_configuration

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_shared_vpc_configuration.update_shared_vpc_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_snapshot(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.update_snapshot_response.UpdateSnapshotResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.update_snapshot_request.UpdateSnapshotRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.update_snapshot_response.UpdateSnapshotResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_snapshot

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_snapshot.update_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_storage_virtual_machine(
        ...
        *,
    ...
    ) -> "aws_sdk_fsx.types.update_storage_virtual_machine_response.UpdateStorageVirtualMachineResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.update_storage_virtual_machine_request.UpdateStorageVirtualMachineRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.update_storage_virtual_machine_response.UpdateStorageVirtualMachineResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_storage_virtual_machine

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_storage_virtual_machine.update_storage_virtual_machine(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_volume(
        ...
        *,
        ...
        name: Optional["aws_sdk_fsx.types.volume_name.VolumeName"] = None,
        open_zfs_configuration: Optional[
            "aws_sdk_fsx.types.update_open_zfs_volume_configuration.UpdateOpenZFSVolumeConfiguration"
        ] = None,
    ) -> "aws_sdk_fsx.types.update_volume_response.UpdateVolumeResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_fsx.types.update_volume_request.UpdateVolumeRequest]",
        ) -> OperationResponse[
            "aws_sdk_fsx.types.update_volume_response.UpdateVolumeResponse"
        ]:
            import aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_volume

            output, http_response = (
                aws_sdk_fsx._operations.aws_simba_api_service_v20180301.update_volume.update_volume(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
