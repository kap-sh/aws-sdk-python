...
def handle_response(
    ...
    out: aws_sdk_fsx.types.update_file_system_response.UpdateFileSystemResponse = (
        aws_sdk_fsx.types.update_file_system_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.update_file_system_request.UpdateFileSystemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.update_file_system_request.serialize_aws_json_1_1(input_)
    ).encode()
