"""Generated from Smithy shape ``com.amazonaws.fsx#DescribeStorageVirtualMachines``."""
...
import aws_sdk_fsx.types.storage_virtual_machines
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.describe_storage_virtual_machines_response.DescribeStorageVirtualMachinesResponse = aws_sdk_fsx.types.describe_storage_virtual_machines_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.describe_storage_virtual_machines_request.DescribeStorageVirtualMachinesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.describe_storage_virtual_machines_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_storage_virtual_machines(
