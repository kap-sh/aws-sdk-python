...
def build_request(
    ...
    input_: aws_sdk_fsx.types.create_and_attach_s3_access_point_request.CreateAndAttachS3AccessPointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.create_and_attach_s3_access_point_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
