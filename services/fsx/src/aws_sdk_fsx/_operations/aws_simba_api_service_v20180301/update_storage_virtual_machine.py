"""Generated from Smithy shape ``com.amazonaws.fsx#UpdateStorageVirtualMachine``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.update_storage_virtual_machine_response.UpdateStorageVirtualMachineResponse = aws_sdk_fsx.types.update_storage_virtual_machine_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.update_storage_virtual_machine_request.UpdateStorageVirtualMachineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.UpdateStorageVirtualMachine"
    import aws_sdk_fsx.types.update_storage_virtual_machine_request

    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.update_storage_virtual_machine_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_storage_virtual_machine(
