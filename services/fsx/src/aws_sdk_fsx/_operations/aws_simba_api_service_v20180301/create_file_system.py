...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidExportPath":
            import aws_sdk_fsx.errors.invalid_export_path

            raise aws_sdk_fsx.errors.invalid_export_path.InvalidExportPath.from_aws_json_1_1(
                data
            )
        case "InvalidImportPath":
            import aws_sdk_fsx.errors.invalid_import_path

            raise aws_sdk_fsx.errors.invalid_import_path.InvalidImportPath.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.create_file_system_response.CreateFileSystemResponse = (
        aws_sdk_fsx.types.create_file_system_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.create_file_system_request.CreateFileSystemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.create_file_system_request.serialize_aws_json_1_1(input_)
    ).encode()
