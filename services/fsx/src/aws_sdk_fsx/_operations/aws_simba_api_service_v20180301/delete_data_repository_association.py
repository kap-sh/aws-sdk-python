...
def handle_response(
    ...
    out: aws_sdk_fsx.types.delete_data_repository_association_response.DeleteDataRepositoryAssociationResponse = aws_sdk_fsx.types.delete_data_repository_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.delete_data_repository_association_request.DeleteDataRepositoryAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.delete_data_repository_association_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
