...
def handle_response(
    ...
    out: aws_sdk_fsx.types.delete_storage_virtual_machine_response.DeleteStorageVirtualMachineResponse = aws_sdk_fsx.types.delete_storage_virtual_machine_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.delete_storage_virtual_machine_request.DeleteStorageVirtualMachineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.delete_storage_virtual_machine_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
