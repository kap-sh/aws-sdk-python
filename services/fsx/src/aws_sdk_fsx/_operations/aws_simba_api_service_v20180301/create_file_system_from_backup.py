...
def build_request(
    ...
    input_: aws_sdk_fsx.types.create_file_system_from_backup_request.CreateFileSystemFromBackupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.create_file_system_from_backup_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
