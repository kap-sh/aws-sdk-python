"""Generated from Smithy shape ``com.amazonaws.fsx#CreateStorageVirtualMachine``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.create_storage_virtual_machine_response.CreateStorageVirtualMachineResponse = aws_sdk_fsx.types.create_storage_virtual_machine_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.create_storage_virtual_machine_request.CreateStorageVirtualMachineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.CreateStorageVirtualMachine"
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.create_storage_virtual_machine_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_storage_virtual_machine(
