"""Generated from Smithy shape ``com.amazonaws.fsx#DeleteVolume``."""
...
import aws_sdk_fsx.types.delete_volume_ontap_response
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.delete_volume_response.DeleteVolumeResponse = (
        aws_sdk_fsx.types.delete_volume_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.delete_volume_request.DeleteVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.DeleteVolume"
    import aws_sdk_fsx.types.delete_volume_request

    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.delete_volume_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_volume(
    ...
    aws_sdk_fsx.types.delete_volume_response.DeleteVolumeResponse, zapros.Response
]:
