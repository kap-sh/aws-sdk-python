...
def handle_response(
    ...
    out: aws_sdk_fsx.types.describe_s3_access_point_attachments_response.DescribeS3AccessPointAttachmentsResponse = aws_sdk_fsx.types.describe_s3_access_point_attachments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.describe_s3_access_point_attachments_request.DescribeS3AccessPointAttachmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
