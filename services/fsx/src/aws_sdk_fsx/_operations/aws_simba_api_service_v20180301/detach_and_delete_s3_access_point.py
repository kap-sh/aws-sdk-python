"""Generated from Smithy shape ``com.amazonaws.fsx#DetachAndDeleteS3AccessPoint``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "S3AccessPointAttachmentNotFound":
            import aws_sdk_fsx.errors.s3_access_point_attachment_not_found

            raise aws_sdk_fsx.errors.s3_access_point_attachment_not_found.S3AccessPointAttachmentNotFound.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.detach_and_delete_s3_access_point_response.DetachAndDeleteS3AccessPointResponse = aws_sdk_fsx.types.detach_and_delete_s3_access_point_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.detach_and_delete_s3_access_point_request.DetachAndDeleteS3AccessPointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.detach_and_delete_s3_access_point_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_detach_and_delete_s3_access_point(
