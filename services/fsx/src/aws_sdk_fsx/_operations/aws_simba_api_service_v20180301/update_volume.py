"""Generated from Smithy shape ``com.amazonaws.fsx#UpdateVolume``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.update_volume_response.UpdateVolumeResponse = (
        aws_sdk_fsx.types.update_volume_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.update_volume_request.UpdateVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.UpdateVolume"
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.update_volume_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_volume(
    ...
    aws_sdk_fsx.types.update_volume_response.UpdateVolumeResponse, zapros.Response
]:
