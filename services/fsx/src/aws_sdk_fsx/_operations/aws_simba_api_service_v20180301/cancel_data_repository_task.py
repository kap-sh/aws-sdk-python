...
def build_request(
    ...
    input_: aws_sdk_fsx.types.cancel_data_repository_task_request.CancelDataRepositoryTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.cancel_data_repository_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
