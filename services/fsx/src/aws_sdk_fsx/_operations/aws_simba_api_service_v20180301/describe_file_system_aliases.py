"""Generated from Smithy shape ``com.amazonaws.fsx#DescribeFileSystemAliases``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.describe_file_system_aliases_response.DescribeFileSystemAliasesResponse = aws_sdk_fsx.types.describe_file_system_aliases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.describe_file_system_aliases_request.DescribeFileSystemAliasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.DescribeFileSystemAliases"
    import aws_sdk_fsx.types.describe_file_system_aliases_request

    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.describe_file_system_aliases_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_file_system_aliases(
