...
def handle_response(
    ...
    out: aws_sdk_fsx.types.describe_shared_vpc_configuration_response.DescribeSharedVpcConfigurationResponse = aws_sdk_fsx.types.describe_shared_vpc_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.describe_shared_vpc_configuration_request.DescribeSharedVpcConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
