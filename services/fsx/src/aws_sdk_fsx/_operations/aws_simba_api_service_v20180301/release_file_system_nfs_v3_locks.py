"""Generated from Smithy shape ``com.amazonaws.fsx#ReleaseFileSystemNfsV3Locks``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.release_file_system_nfs_v3_locks_response.ReleaseFileSystemNfsV3LocksResponse = aws_sdk_fsx.types.release_file_system_nfs_v3_locks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.release_file_system_nfs_v3_locks_request.ReleaseFileSystemNfsV3LocksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_release_file_system_nfs_v3_locks(
