"""Generated from Smithy shape ``com.amazonaws.fsx#UpdateFileCache``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FileCacheNotFound":
            import aws_sdk_fsx.errors.file_cache_not_found

            raise aws_sdk_fsx.errors.file_cache_not_found.FileCacheNotFound.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.update_file_cache_response.UpdateFileCacheResponse = (
        aws_sdk_fsx.types.update_file_cache_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.update_file_cache_request.UpdateFileCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.UpdateFileCache"
    import aws_sdk_fsx.types.update_file_cache_request

    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.update_file_cache_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_file_cache(
