"""Generated from Smithy shape ``com.amazonaws.fsx#DescribeDataRepositoryTasks``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.describe_data_repository_tasks_response.DescribeDataRepositoryTasksResponse = aws_sdk_fsx.types.describe_data_repository_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.describe_data_repository_tasks_request.DescribeDataRepositoryTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.describe_data_repository_tasks_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_data_repository_tasks(
