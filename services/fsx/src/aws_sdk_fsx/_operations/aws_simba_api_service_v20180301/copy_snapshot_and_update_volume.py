"""Generated from Smithy shape ``com.amazonaws.fsx#CopySnapshotAndUpdateVolume``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.copy_snapshot_and_update_volume_response.CopySnapshotAndUpdateVolumeResponse = aws_sdk_fsx.types.copy_snapshot_and_update_volume_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.copy_snapshot_and_update_volume_request.CopySnapshotAndUpdateVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.CopySnapshotAndUpdateVolume"
    import aws_sdk_fsx.types.copy_snapshot_and_update_volume_request

    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.copy_snapshot_and_update_volume_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_copy_snapshot_and_update_volume(
