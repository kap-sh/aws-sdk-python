...
def handle_response(
    ...
    out: aws_sdk_fsx.types.create_volume_response.CreateVolumeResponse = (
        aws_sdk_fsx.types.create_volume_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.create_volume_request.CreateVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.create_volume_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_volume(
    ...
    aws_sdk_fsx.types.create_volume_response.CreateVolumeResponse, zapros.Response
]:
