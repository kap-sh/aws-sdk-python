"""Generated from Smithy shape ``com.amazonaws.fsx#DeleteBackup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BackupBeingCopied":
            import aws_sdk_fsx.errors.backup_being_copied

            raise aws_sdk_fsx.errors.backup_being_copied.BackupBeingCopied.from_aws_json_1_1(
                data
            )
        case "BackupInProgress":
            import aws_sdk_fsx.errors.backup_in_progress

            raise aws_sdk_fsx.errors.backup_in_progress.BackupInProgress.from_aws_json_1_1(
                data
            )
        case "BackupNotFound":
        ...
        case "BackupRestoring":
            import aws_sdk_fsx.errors.backup_restoring

            raise aws_sdk_fsx.errors.backup_restoring.BackupRestoring.from_aws_json_1_1(
                data
            )
        case "BadRequest":
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.delete_backup_response.DeleteBackupResponse = (
        aws_sdk_fsx.types.delete_backup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.delete_backup_request.DeleteBackupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.delete_backup_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_backup(
    ...
    aws_sdk_fsx.types.delete_backup_response.DeleteBackupResponse, zapros.Response
]:
