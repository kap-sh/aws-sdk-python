...
def handle_response(
    ...
    out: aws_sdk_fsx.types.restore_volume_from_snapshot_response.RestoreVolumeFromSnapshotResponse = aws_sdk_fsx.types.restore_volume_from_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.restore_volume_from_snapshot_request.RestoreVolumeFromSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.restore_volume_from_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
