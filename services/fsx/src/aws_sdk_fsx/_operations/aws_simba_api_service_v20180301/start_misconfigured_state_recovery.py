...
def handle_response(
    ...
    out: aws_sdk_fsx.types.start_misconfigured_state_recovery_response.StartMisconfiguredStateRecoveryResponse = aws_sdk_fsx.types.start_misconfigured_state_recovery_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.start_misconfigured_state_recovery_request.StartMisconfiguredStateRecoveryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
