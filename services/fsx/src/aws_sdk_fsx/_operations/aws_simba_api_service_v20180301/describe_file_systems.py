...
def build_request(
    ...
    input: aws_sdk_fsx.types.describe_file_systems_request.DescribeFileSystemsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.describe_file_systems_request.serialize_aws_json_1_1(input)
    ).encode()
