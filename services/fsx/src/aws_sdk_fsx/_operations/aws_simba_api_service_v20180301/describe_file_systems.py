"""Generated from Smithy shape ``com.amazonaws.fsx#DescribeFileSystems``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.describe_file_systems_response.DescribeFileSystemsResponse = aws_sdk_fsx.types.describe_file_systems_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.describe_file_systems_request.DescribeFileSystemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.describe_file_systems_request.serialize_aws_json_1_1(input_)
    ).encode()
