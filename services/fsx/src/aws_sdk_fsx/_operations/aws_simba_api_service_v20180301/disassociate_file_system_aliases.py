"""Generated from Smithy shape ``com.amazonaws.fsx#DisassociateFileSystemAliases``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.disassociate_file_system_aliases_response.DisassociateFileSystemAliasesResponse = aws_sdk_fsx.types.disassociate_file_system_aliases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.disassociate_file_system_aliases_request.DisassociateFileSystemAliasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.disassociate_file_system_aliases_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_file_system_aliases(
