"""Generated from Smithy shape ``com.amazonaws.fsx#DescribeVolumes``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.describe_volumes_response.DescribeVolumesResponse = (
        aws_sdk_fsx.types.describe_volumes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.describe_volumes_request.DescribeVolumesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.DescribeVolumes"
    import aws_sdk_fsx.types.describe_volumes_request

    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.describe_volumes_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_volumes(
    ...
    aws_sdk_fsx.types.describe_volumes_response.DescribeVolumesResponse, zapros.Response
]:
