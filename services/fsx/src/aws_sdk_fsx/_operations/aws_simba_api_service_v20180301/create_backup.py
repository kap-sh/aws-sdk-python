"""Generated from Smithy shape ``com.amazonaws.fsx#CreateBackup``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.create_backup_response.CreateBackupResponse = (
        aws_sdk_fsx.types.create_backup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.create_backup_request.CreateBackupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.create_backup_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_backup(
    ...
    aws_sdk_fsx.types.create_backup_response.CreateBackupResponse, zapros.Response
]:
