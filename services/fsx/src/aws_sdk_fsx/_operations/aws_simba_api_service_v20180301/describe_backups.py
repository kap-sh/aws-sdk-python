...
def handle_response(
    ...
    out: aws_sdk_fsx.types.describe_backups_response.DescribeBackupsResponse = (
        aws_sdk_fsx.types.describe_backups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.describe_backups_request.DescribeBackupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.describe_backups_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_backups(
    ...
    aws_sdk_fsx.types.describe_backups_response.DescribeBackupsResponse, zapros.Response
]:
