"""Generated from Smithy shape ``com.amazonaws.fsx#DescribeDataRepositoryAssociations``."""
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.describe_data_repository_associations_request.DescribeDataRepositoryAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_data_repository_associations(
