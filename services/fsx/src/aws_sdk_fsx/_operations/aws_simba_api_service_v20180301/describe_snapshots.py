...
def handle_response(
    ...
    out: aws_sdk_fsx.types.describe_snapshots_response.DescribeSnapshotsResponse = (
        aws_sdk_fsx.types.describe_snapshots_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.describe_snapshots_request.DescribeSnapshotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fsx.types.describe_snapshots_request.serialize_aws_json_1_1(input_)
    ).encode()
