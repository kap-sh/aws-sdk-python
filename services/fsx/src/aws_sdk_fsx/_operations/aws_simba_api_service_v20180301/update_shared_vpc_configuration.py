"""Generated from Smithy shape ``com.amazonaws.fsx#UpdateSharedVpcConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_fsx.types.update_shared_vpc_configuration_response.UpdateSharedVpcConfigurationResponse = aws_sdk_fsx.types.update_shared_vpc_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fsx.types.update_shared_vpc_configuration_request.UpdateSharedVpcConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_shared_vpc_configuration(
