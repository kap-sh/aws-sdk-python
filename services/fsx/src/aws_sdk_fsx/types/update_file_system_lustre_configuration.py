...
if TYPE_CHECKING:
    ...
    import aws_sdk_fsx.types.update_file_system_lustre_metadata_configuration
    import aws_sdk_fsx.types.weekly_time


class UpdateFileSystemLustreConfiguration(TypedDict):
...
def serialize_aws_json_1_1(value: UpdateFileSystemLustreConfiguration) -> dict:
    ...
    if "metadata_configuration" in value:
        ...
        out["MetadataConfiguration"] = (
            aws_sdk_fsx.types.update_file_system_lustre_metadata_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateFileSystemLustreConfiguration:
    ...
    if "MetadataConfiguration" in data:
        ...
        out["metadata_configuration"] = (
            aws_sdk_fsx.types.update_file_system_lustre_metadata_configuration.deserialize_aws_json_1_1(
