...
class CreateFileCacheRequest(TypedDict):
...
def serialize_aws_json_1_1(value: CreateFileCacheRequest) -> dict:
    ...
    if "lustre_configuration" in value:
        ...
        out["LustreConfiguration"] = (
            aws_sdk_fsx.types.create_file_cache_lustre_configuration.serialize_aws_json_1_1(
    ...
    if "data_repository_associations" in value:
        ...
        out["DataRepositoryAssociations"] = (
            aws_sdk_fsx.types.create_file_cache_data_repository_associations.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateFileCacheRequest:
    ...
    if "LustreConfiguration" in data:
        ...
        out["lustre_configuration"] = (
            aws_sdk_fsx.types.create_file_cache_lustre_configuration.deserialize_aws_json_1_1(
    ...
    if "DataRepositoryAssociations" in data:
        ...
        out["data_repository_associations"] = (
            aws_sdk_fsx.types.create_file_cache_data_repository_associations.deserialize_aws_json_1_1(
