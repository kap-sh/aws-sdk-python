...
if TYPE_CHECKING:
    import aws_sdk_fsx.types.backups
    import aws_sdk_fsx.types.next_token


class DescribeBackupsResponse(TypedDict):
    backups: NotRequired["aws_sdk_fsx.types.backups.Backups"]
...
def serialize_aws_json_1_1(value: DescribeBackupsResponse) -> dict:
    ...
    if "backups" in value:
        ...
        out["Backups"] = aws_sdk_fsx.types.backups.serialize_aws_json_1_1(
            value["backups"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeBackupsResponse:
    ...
    if "Backups" in data:
        ...
        out["backups"] = aws_sdk_fsx.types.backups.deserialize_aws_json_1_1(
            data["Backups"]
        )
