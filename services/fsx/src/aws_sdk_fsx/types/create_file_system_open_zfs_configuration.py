...
if TYPE_CHECKING:
    ...
    import aws_sdk_fsx.types.open_zfs_create_root_volume_configuration
...
class CreateFileSystemOpenZFSConfiguration(TypedDict):
    ...
    root_volume_configuration: NotRequired[
        "aws_sdk_fsx.types.open_zfs_create_root_volume_configuration.OpenZFSCreateRootVolumeConfiguration"
    ]
...
def serialize_aws_json_1_1(value: CreateFileSystemOpenZFSConfiguration) -> dict:
    ...
    if "root_volume_configuration" in value:
        ...
        out["RootVolumeConfiguration"] = (
            aws_sdk_fsx.types.open_zfs_create_root_volume_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateFileSystemOpenZFSConfiguration:
    ...
    if "RootVolumeConfiguration" in data:
        ...
        out["root_volume_configuration"] = (
            aws_sdk_fsx.types.open_zfs_create_root_volume_configuration.deserialize_aws_json_1_1(
