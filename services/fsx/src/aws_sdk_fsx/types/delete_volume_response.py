...
class DeleteVolumeResponse(TypedDict, closed=True):
    ...
    ontap_response: NotRequired[
        "aws_sdk_fsx.types.delete_volume_ontap_response.DeleteVolumeOntapResponse"
    ]
...
def serialize_aws_json_1_1(value: DeleteVolumeResponse) -> dict:
    ...
    if "ontap_response" in value:
        ...
        out["OntapResponse"] = (
            aws_sdk_fsx.types.delete_volume_ontap_response.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DeleteVolumeResponse:
    ...
    if "OntapResponse" in data:
        ...
        out["ontap_response"] = (
            aws_sdk_fsx.types.delete_volume_ontap_response.deserialize_aws_json_1_1(
                data["OntapResponse"]
            )
        )
    return out
