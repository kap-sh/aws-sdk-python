...
if TYPE_CHECKING:
    import aws_sdk_fsx.types.delete_file_system_open_zfs_options
    import aws_sdk_fsx.types.flag
    import aws_sdk_fsx.types.tags


class DeleteFileSystemOpenZFSConfiguration(TypedDict):
    ...
    options: NotRequired[
        "aws_sdk_fsx.types.delete_file_system_open_zfs_options.DeleteFileSystemOpenZFSOptions"
    ]
...
def serialize_aws_json_1_1(value: DeleteFileSystemOpenZFSConfiguration) -> dict:
    ...
    if "options" in value:
        ...
        out["Options"] = (
            aws_sdk_fsx.types.delete_file_system_open_zfs_options.serialize_aws_json_1_1(
                value["options"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DeleteFileSystemOpenZFSConfiguration:
    ...
    if "Options" in data:
        ...
        out["options"] = (
            aws_sdk_fsx.types.delete_file_system_open_zfs_options.deserialize_aws_json_1_1(
                data["Options"]
            )
        )
    return out
