...
if TYPE_CHECKING:
    ...
    import aws_sdk_fsx.types.update_snaplock_configuration
...
class UpdateOntapVolumeConfiguration(TypedDict):
    ...
    snaplock_configuration: NotRequired[
        "aws_sdk_fsx.types.update_snaplock_configuration.UpdateSnaplockConfiguration"
    ]
...
def serialize_aws_json_1_1(value: UpdateOntapVolumeConfiguration) -> dict:
    ...
    if "snaplock_configuration" in value:
        ...
        out["SnaplockConfiguration"] = (
            aws_sdk_fsx.types.update_snaplock_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateOntapVolumeConfiguration:
    ...
    if "SnaplockConfiguration" in data:
        ...
        out["snaplock_configuration"] = (
            aws_sdk_fsx.types.update_snaplock_configuration.deserialize_aws_json_1_1(
