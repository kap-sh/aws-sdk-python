"""Generated from Smithy shape ``com.amazonaws.fsx#CreateSnaplockConfiguration``."""
...
class CreateSnaplockConfiguration(TypedDict, closed=True):
    ...
    r"""<p>Enables, disables, or permanently disables privileged delete on an FSx for ONTAP SnapLock Enterprise volume. Enabling privileged delete allows SnapLock administrators to delete WORM files even if they have active retention periods. <code>PERMANENTLY_DISABLED</code> is a terminal state. If privileged delete is permanently disabled on a SnapLock volume, you can't re-enable it. The default value is <code>DISABLED</code>. </p> <p>For more information, see <a href=\"https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/snaplock-enterprise.html#privileged-delete\">Privileged delete</a>. </p>"""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateSnaplockConfiguration) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateSnaplockConfiguration:
    out: CreateSnaplockConfiguration = {}  # type: ignore[typeddict-item]
