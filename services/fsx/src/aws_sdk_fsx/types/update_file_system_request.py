...
def serialize_aws_json_1_1(value: UpdateFileSystemRequest) -> dict:
    ...
    if "windows_configuration" in value:
        ...
        out["WindowsConfiguration"] = (
            aws_sdk_fsx.types.update_file_system_windows_configuration.serialize_aws_json_1_1(
    ...
    if "lustre_configuration" in value:
        ...
        out["LustreConfiguration"] = (
            aws_sdk_fsx.types.update_file_system_lustre_configuration.serialize_aws_json_1_1(
    ...
    if "ontap_configuration" in value:
        ...
        out["OntapConfiguration"] = (
            aws_sdk_fsx.types.update_file_system_ontap_configuration.serialize_aws_json_1_1(
    ...
    if "open_zfs_configuration" in value:
        ...
        out["OpenZFSConfiguration"] = (
            aws_sdk_fsx.types.update_file_system_open_zfs_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateFileSystemRequest:
    ...
    if "WindowsConfiguration" in data:
        ...
        out["windows_configuration"] = (
            aws_sdk_fsx.types.update_file_system_windows_configuration.deserialize_aws_json_1_1(
    ...
    if "LustreConfiguration" in data:
        ...
        out["lustre_configuration"] = (
            aws_sdk_fsx.types.update_file_system_lustre_configuration.deserialize_aws_json_1_1(
    ...
    if "OntapConfiguration" in data:
        ...
        out["ontap_configuration"] = (
            aws_sdk_fsx.types.update_file_system_ontap_configuration.deserialize_aws_json_1_1(
    ...
    if "OpenZFSConfiguration" in data:
        ...
        out["open_zfs_configuration"] = (
            aws_sdk_fsx.types.update_file_system_open_zfs_configuration.deserialize_aws_json_1_1(
