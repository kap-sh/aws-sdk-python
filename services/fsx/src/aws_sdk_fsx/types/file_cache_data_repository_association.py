...
if TYPE_CHECKING:
    ...
    import aws_sdk_fsx.types.file_cache_nfs_configuration
...
class FileCacheDataRepositoryAssociation(TypedDict, closed=True):
    ...
    nfs: NotRequired[
        "aws_sdk_fsx.types.file_cache_nfs_configuration.FileCacheNFSConfiguration"
    ]
...
def serialize_aws_json_1_1(value: FileCacheDataRepositoryAssociation) -> dict:
    ...
    if "nfs" in value:
        ...
        out["NFS"] = (
            aws_sdk_fsx.types.file_cache_nfs_configuration.serialize_aws_json_1_1(
                value["nfs"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> FileCacheDataRepositoryAssociation:
    ...
    if "NFS" in data:
        ...
        out["nfs"] = (
            aws_sdk_fsx.types.file_cache_nfs_configuration.deserialize_aws_json_1_1(
                data["NFS"]
            )
        )
    return out
