...
if TYPE_CHECKING:
    ...
    import aws_sdk_fsx.types.open_zfs_quota_type


class OpenZFSUserOrGroupQuota(TypedDict):
    type: NotRequired["aws_sdk_fsx.types.open_zfs_quota_type.OpenZFSQuotaType"]
    """<p>Specifies whether the quota applies to a user or group.</p>"""
    id: NotRequired["aws_sdk_fsx.types.integer_no_max.IntegerNoMax"]
...
def serialize_aws_json_1_1(value: OpenZFSUserOrGroupQuota) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = aws_sdk_fsx.types.open_zfs_quota_type.serialize_aws_json_1_1(
            value["type"]
        )
    if "id" in value:
        out["Id"] = value["id"]
...
def deserialize_aws_json_1_1(data: dict) -> OpenZFSUserOrGroupQuota:
    ...
    if "Type" in data:
        ...
        out["type"] = aws_sdk_fsx.types.open_zfs_quota_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    if "Id" in data:
        out["id"] = data["Id"]
