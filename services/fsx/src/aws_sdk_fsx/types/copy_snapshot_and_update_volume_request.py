...
class CopySnapshotAndUpdateVolumeRequest(TypedDict):
...
def serialize_aws_json_1_1(value: CopySnapshotAndUpdateVolumeRequest) -> dict:
    ...
    if "options" in value:
        ...
        out["Options"] = (
            aws_sdk_fsx.types.update_open_zfs_volume_options.serialize_aws_json_1_1(
                value["options"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CopySnapshotAndUpdateVolumeRequest:
    ...
    if "Options" in data:
        ...
        out["options"] = (
            aws_sdk_fsx.types.update_open_zfs_volume_options.deserialize_aws_json_1_1(
                data["Options"]
            )
        )
    return out
