...
def serialize_aws_json_1_1(value: AdministrativeActionType) -> str:
    return value


def deserialize_aws_json_1_1(data: str) -> AdministrativeActionType:
    if data not in _VALUES:
        raise DeserializationError(f"unknown AdministrativeActionType value: {data!r}")
    return cast(AdministrativeActionType, data)
