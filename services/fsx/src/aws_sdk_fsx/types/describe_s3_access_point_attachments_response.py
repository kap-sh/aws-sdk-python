...
if TYPE_CHECKING:
    ...
    import aws_sdk_fsx.types.s3_access_point_attachments


class DescribeS3AccessPointAttachmentsResponse(TypedDict):
    s3_access_point_attachments: NotRequired[
        "aws_sdk_fsx.types.s3_access_point_attachments.S3AccessPointAttachments"
    ]
...
def serialize_aws_json_1_1(value: DescribeS3AccessPointAttachmentsResponse) -> dict:
    ...
    if "s3_access_point_attachments" in value:
        ...
        out["S3AccessPointAttachments"] = (
            aws_sdk_fsx.types.s3_access_point_attachments.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeS3AccessPointAttachmentsResponse:
    ...
    if "S3AccessPointAttachments" in data:
        ...
        out["s3_access_point_attachments"] = (
            aws_sdk_fsx.types.s3_access_point_attachments.deserialize_aws_json_1_1(
