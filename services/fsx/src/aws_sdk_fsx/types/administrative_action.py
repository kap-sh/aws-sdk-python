...
if TYPE_CHECKING:
    ...
    import aws_sdk_fsx.types.administrative_action_type
    import aws_sdk_fsx.types.error_message
    import aws_sdk_fsx.types.file_system
    import aws_sdk_fsx.types.progress_percent
    import aws_sdk_fsx.types.remaining_transfer_bytes
    import aws_sdk_fsx.types.request_time
    import aws_sdk_fsx.types.snapshot
    import aws_sdk_fsx.types.status
    import aws_sdk_fsx.types.total_transfer_bytes
...
class AdministrativeAction(TypedDict):
    ...
    request_time: NotRequired["aws_sdk_fsx.types.request_time.RequestTime"]
    """<p>The time that the administrative action request was received.</p>"""
    status: NotRequired["aws_sdk_fsx.types.status.Status"]
    ...
    target_file_system_values: NotRequired["aws_sdk_fsx.types.file_system.FileSystem"]
    ...
    failure_details: NotRequired[
        "aws_sdk_fsx.types.administrative_action_failure_details.AdministrativeActionFailureDetails"
    ]
    target_volume_values: NotRequired["aws_sdk_fsx.types.volume.Volume"]
    target_snapshot_values: NotRequired["aws_sdk_fsx.types.snapshot.Snapshot"]
    total_transfer_bytes: NotRequired[
        "aws_sdk_fsx.types.total_transfer_bytes.TotalTransferBytes"
    ]
    ...
    remaining_transfer_bytes: NotRequired[
        "aws_sdk_fsx.types.remaining_transfer_bytes.RemainingTransferBytes"
    ]
...
def serialize_aws_json_1_1(value: AdministrativeAction) -> dict:
    ...
    if "administrative_action_type" in value:
        ...
        out["AdministrativeActionType"] = (
            aws_sdk_fsx.types.administrative_action_type.serialize_aws_json_1_1(
    ...
    if "request_time" in value:
        ...
        out["RequestTime"] = aws_sdk_fsx.types.request_time.serialize_aws_json_1_1(
            value["request_time"]
        )
    if "status" in value:
        import aws_sdk_fsx.types.status

        out["Status"] = aws_sdk_fsx.types.status.serialize_aws_json_1_1(value["status"])
    if "target_file_system_values" in value:
        import aws_sdk_fsx.types.file_system

        out["TargetFileSystemValues"] = (
            aws_sdk_fsx.types.file_system.serialize_aws_json_1_1(
    ...
    if "failure_details" in value:
        ...
        out["FailureDetails"] = (
            aws_sdk_fsx.types.administrative_action_failure_details.serialize_aws_json_1_1(
    ...
    if "target_volume_values" in value:
        ...
        out["TargetVolumeValues"] = aws_sdk_fsx.types.volume.serialize_aws_json_1_1(
            value["target_volume_values"]
        )
    if "target_snapshot_values" in value:
        import aws_sdk_fsx.types.snapshot

        out["TargetSnapshotValues"] = aws_sdk_fsx.types.snapshot.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AdministrativeAction:
    ...
    if "AdministrativeActionType" in data:
        ...
        out["administrative_action_type"] = (
            aws_sdk_fsx.types.administrative_action_type.deserialize_aws_json_1_1(
    ...
    if "RequestTime" in data:
        ...
        out["request_time"] = aws_sdk_fsx.types.request_time.deserialize_aws_json_1_1(
            data["RequestTime"]
        )
    if "Status" in data:
        import aws_sdk_fsx.types.status

        out["status"] = aws_sdk_fsx.types.status.deserialize_aws_json_1_1(
            data["Status"]
        )
    if "TargetFileSystemValues" in data:
        ...
        out["target_file_system_values"] = (
            aws_sdk_fsx.types.file_system.deserialize_aws_json_1_1(
    ...
    if "FailureDetails" in data:
        ...
        out["failure_details"] = (
            aws_sdk_fsx.types.administrative_action_failure_details.deserialize_aws_json_1_1(
                data["FailureDetails"]
            )
        )
    if "TargetVolumeValues" in data:
        ...
        out["target_volume_values"] = aws_sdk_fsx.types.volume.deserialize_aws_json_1_1(
    ...
    if "TargetSnapshotValues" in data:
        ...
        out["target_snapshot_values"] = (
            aws_sdk_fsx.types.snapshot.deserialize_aws_json_1_1(
