...
class CreateOpenZFSVolumeConfiguration(TypedDict):
    ...
    origin_snapshot: NotRequired[
        "aws_sdk_fsx.types.create_open_zfs_origin_snapshot_configuration.CreateOpenZFSOriginSnapshotConfiguration"
    ]
...
def serialize_aws_json_1_1(value: CreateOpenZFSVolumeConfiguration) -> dict:
    ...
    if "origin_snapshot" in value:
        ...
        out["OriginSnapshot"] = (
            aws_sdk_fsx.types.create_open_zfs_origin_snapshot_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateOpenZFSVolumeConfiguration:
    ...
    if "OriginSnapshot" in data:
        ...
        out["origin_snapshot"] = (
            aws_sdk_fsx.types.create_open_zfs_origin_snapshot_configuration.deserialize_aws_json_1_1(
                data["OriginSnapshot"]
            )
        )
    if "ReadOnly" in data:
