...
if TYPE_CHECKING:
    ...
    import aws_sdk_fsx.types.start_time
...
class DataRepositoryTask(TypedDict):
    ...
    start_time: NotRequired["aws_sdk_fsx.types.start_time.StartTime"]
    """<p>The time the system began processing the task.</p>"""
    end_time: NotRequired["aws_sdk_fsx.types.end_time.EndTime"]
    ...
    failure_details: NotRequired[
        "aws_sdk_fsx.types.data_repository_task_failure_details.DataRepositoryTaskFailureDetails"
    ]
    ...
    status: NotRequired[
        "aws_sdk_fsx.types.data_repository_task_status.DataRepositoryTaskStatus"
    ]
...
def serialize_aws_json_1_1(value: DataRepositoryTask) -> dict:
    ...
    if "start_time" in value:
        ...
        out["StartTime"] = aws_sdk_fsx.types.start_time.serialize_aws_json_1_1(
            value["start_time"]
        )
    if "end_time" in value:
        import aws_sdk_fsx.types.end_time

        out["EndTime"] = aws_sdk_fsx.types.end_time.serialize_aws_json_1_1(
            value["end_time"]
        )
    ...
    if "failure_details" in value:
        ...
        out["FailureDetails"] = (
            aws_sdk_fsx.types.data_repository_task_failure_details.serialize_aws_json_1_1(
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_fsx.types.data_repository_task_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    if "report" in value:
...
def deserialize_aws_json_1_1(data: dict) -> DataRepositoryTask:
    ...
    if "StartTime" in data:
        ...
        out["start_time"] = aws_sdk_fsx.types.start_time.deserialize_aws_json_1_1(
            data["StartTime"]
        )
    if "EndTime" in data:
        import aws_sdk_fsx.types.end_time

        out["end_time"] = aws_sdk_fsx.types.end_time.deserialize_aws_json_1_1(
            data["EndTime"]
        )
    ...
    if "FailureDetails" in data:
        ...
        out["failure_details"] = (
            aws_sdk_fsx.types.data_repository_task_failure_details.deserialize_aws_json_1_1(
                data["FailureDetails"]
            )
        )
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_fsx.types.data_repository_task_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    if "Report" in data:
