...
if TYPE_CHECKING:
    ...
    import capo_fsx.types.value


class DurationSinceLastAccess(TypedDict, closed=True):
    unit: NotRequired["capo_fsx.types.unit.Unit"]
    ...
    value: NotRequired["capo_fsx.types.value.Value"]
...
def serialize_aws_json_1_1(value: DurationSinceLastAccess) -> dict:
    ...
    if "unit" in value:
        ...
        out["Unit"] = capo_fsx.types.unit.serialize_aws_json_1_1(value["unit"])
    if "value" in value:
