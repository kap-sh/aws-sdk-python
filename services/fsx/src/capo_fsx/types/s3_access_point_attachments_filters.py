...
if TYPE_CHECKING:
    import capo_fsx.types.s3_access_point_attachments_filter

S3AccessPointAttachmentsFilters: TypeAlias = list[
    "capo_fsx.types.s3_access_point_attachments_filter.S3AccessPointAttachmentsFilter"
]
...
def serialize_aws_json_1_1(value: S3AccessPointAttachmentsFilters) -> list:
    ...
    for item in value:
        out.append(
            capo_fsx.types.s3_access_point_attachments_filter.serialize_aws_json_1_1(
                item
            )
        )
    return out
