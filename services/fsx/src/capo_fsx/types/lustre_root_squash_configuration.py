...
if TYPE_CHECKING:
    ...
    import capo_fsx.types.lustre_root_squash


class LustreRootSquashConfiguration(TypedDict, closed=True):
    root_squash: NotRequired["capo_fsx.types.lustre_root_squash.LustreRootSquash"]
    ...
    no_squash_nids: NotRequired[
        "capo_fsx.types.lustre_no_squash_nids.LustreNoSquashNids"
    ]
...
def serialize_aws_json_1_1(value: LustreRootSquashConfiguration) -> dict:
    ...
    if "no_squash_nids" in value:
        ...
        out["NoSquashNids"] = (
            capo_fsx.types.lustre_no_squash_nids.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LustreRootSquashConfiguration:
    ...
    if "NoSquashNids" in data:
        ...
        out["no_squash_nids"] = (
            capo_fsx.types.lustre_no_squash_nids.deserialize_aws_json_1_1(
                data["NoSquashNids"]
            )
        )
    return out
