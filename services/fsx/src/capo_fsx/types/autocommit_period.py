...
if TYPE_CHECKING:
    import capo_fsx.types.autocommit_period_type
    import capo_fsx.types.autocommit_period_value


class AutocommitPeriod(TypedDict, closed=True):
    type: NotRequired["capo_fsx.types.autocommit_period_type.AutocommitPeriodType"]
    ...
    value: NotRequired["capo_fsx.types.autocommit_period_value.AutocommitPeriodValue"]
...
def serialize_aws_json_1_1(value: AutocommitPeriod) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = capo_fsx.types.autocommit_period_type.serialize_aws_json_1_1(
            value["type"]
        )
    if "value" in value:
...
def deserialize_aws_json_1_1(data: dict) -> AutocommitPeriod:
    ...
    if "Type" in data:
        ...
        out["type"] = capo_fsx.types.autocommit_period_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    if "Value" in data:
