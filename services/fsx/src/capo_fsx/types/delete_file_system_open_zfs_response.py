"""Generated from Smithy shape ``com.amazonaws.fsx#DeleteFileSystemOpenZFSResponse``."""
...
class DeleteFileSystemOpenZFSResponse(TypedDict, closed=True):
    final_backup_id: NotRequired["capo_fsx.types.backup_id.BackupId"]
    final_backup_tags: NotRequired["capo_fsx.types.tags.Tags"]


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteFileSystemOpenZFSResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteFileSystemOpenZFSResponse:
    out: DeleteFileSystemOpenZFSResponse = {}  # type: ignore[typeddict-item]
