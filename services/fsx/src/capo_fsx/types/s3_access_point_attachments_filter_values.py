...
if TYPE_CHECKING:
    import capo_fsx.types.s3_access_point_attachments_filter_value

S3AccessPointAttachmentsFilterValues: TypeAlias = list[
    "capo_fsx.types.s3_access_point_attachments_filter_value.S3AccessPointAttachmentsFilterValue"
]
