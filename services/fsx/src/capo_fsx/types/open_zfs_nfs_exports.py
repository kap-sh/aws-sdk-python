...
if TYPE_CHECKING:
    import capo_fsx.types.open_zfs_nfs_export

OpenZFSNfsExports: TypeAlias = list[
    "capo_fsx.types.open_zfs_nfs_export.OpenZFSNfsExport"
]
...
def serialize_aws_json_1_1(value: OpenZFSNfsExports) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_fsx.types.open_zfs_nfs_export.serialize_aws_json_1_1(item))
    return out
