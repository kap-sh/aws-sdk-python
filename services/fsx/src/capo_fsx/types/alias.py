...
if TYPE_CHECKING:
    import capo_fsx.types.alias_lifecycle
    import capo_fsx.types.alternate_dns_name


class Alias(TypedDict, closed=True):
    name: NotRequired["capo_fsx.types.alternate_dns_name.AlternateDNSName"]
    ...
    lifecycle: NotRequired["capo_fsx.types.alias_lifecycle.AliasLifecycle"]
...
def serialize_aws_json_1_1(value: Alias) -> dict:
    ...
    if "lifecycle" in value:
        ...
        out["Lifecycle"] = capo_fsx.types.alias_lifecycle.serialize_aws_json_1_1(
            value["lifecycle"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Alias:
    ...
    if "Lifecycle" in data:
        ...
        out["lifecycle"] = capo_fsx.types.alias_lifecycle.deserialize_aws_json_1_1(
            data["Lifecycle"]
        )
    return out
