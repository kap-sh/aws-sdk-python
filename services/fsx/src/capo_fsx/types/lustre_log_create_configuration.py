...
class LustreLogCreateConfiguration(TypedDict, closed=True):
    level: NotRequired[
        "capo_fsx.types.lustre_access_audit_log_level.LustreAccessAuditLogLevel"
    ]
    ...
    destination: NotRequired["capo_fsx.types.general_arn.GeneralARN"]
...
def serialize_aws_json_1_1(value: LustreLogCreateConfiguration) -> dict:
    ...
    if "level" in value:
        ...
        out["Level"] = (
            capo_fsx.types.lustre_access_audit_log_level.serialize_aws_json_1_1(
                value["level"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> LustreLogCreateConfiguration:
    ...
    if "Level" in data:
        ...
        out["level"] = (
            capo_fsx.types.lustre_access_audit_log_level.deserialize_aws_json_1_1(
                data["Level"]
            )
        )
