...
if TYPE_CHECKING:
    import capo_fsx.types.data_repository_associations
...
class DescribeDataRepositoryAssociationsResponse(TypedDict, closed=True):
    associations: NotRequired[
        "capo_fsx.types.data_repository_associations.DataRepositoryAssociations"
    ]
...
def serialize_aws_json_1_1(value: DescribeDataRepositoryAssociationsResponse) -> dict:
    ...
    if "associations" in value:
        ...
        out["Associations"] = (
            capo_fsx.types.data_repository_associations.serialize_aws_json_1_1(
                value["associations"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeDataRepositoryAssociationsResponse:
    ...
    if "Associations" in data:
        ...
        out["associations"] = (
            capo_fsx.types.data_repository_associations.deserialize_aws_json_1_1(
                data["Associations"]
            )
        )
