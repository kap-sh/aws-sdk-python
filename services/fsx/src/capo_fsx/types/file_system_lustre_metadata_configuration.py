...
if TYPE_CHECKING:
    ...
    import capo_fsx.types.metadata_iops


class FileSystemLustreMetadataConfiguration(TypedDict, closed=True):
    iops: NotRequired["capo_fsx.types.metadata_iops.MetadataIops"]
    ...
    mode: NotRequired[
        "capo_fsx.types.metadata_configuration_mode.MetadataConfigurationMode"
    ]
...
def serialize_aws_json_1_1(value: FileSystemLustreMetadataConfiguration) -> dict:
    ...
    if "mode" in value:
        ...
        out["Mode"] = capo_fsx.types.metadata_configuration_mode.serialize_aws_json_1_1(
            value["mode"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> FileSystemLustreMetadataConfiguration:
    ...
    if "Mode" in data:
        ...
        out["mode"] = (
            capo_fsx.types.metadata_configuration_mode.deserialize_aws_json_1_1(
                data["Mode"]
            )
        )
    return out
