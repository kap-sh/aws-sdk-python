...
if TYPE_CHECKING:
    ...
    import capo_fsx.types.lustre_file_system_mount_name
    import capo_fsx.types.lustre_log_configuration
...
class FileCacheLustreConfiguration(TypedDict, closed=True):
    ...
    deployment_type: NotRequired[
        "capo_fsx.types.file_cache_lustre_deployment_type.FileCacheLustreDeploymentType"
    ]
    """<p>The deployment type of the Amazon File Cache resource, which must be <code>CACHE_1</code>.</p>"""
    mount_name: NotRequired[
        "capo_fsx.types.lustre_file_system_mount_name.LustreFileSystemMountName"
    ]
    ...
    metadata_configuration: NotRequired[
        "capo_fsx.types.file_cache_lustre_metadata_configuration.FileCacheLustreMetadataConfiguration"
    ]
    """<p>The configuration for a Lustre MDT (Metadata Target) storage volume.</p>"""
    log_configuration: NotRequired[
        "capo_fsx.types.lustre_log_configuration.LustreLogConfiguration"
    ]
...
def serialize_aws_json_1_1(value: FileCacheLustreConfiguration) -> dict:
    ...
    if "deployment_type" in value:
        ...
        out["DeploymentType"] = (
            capo_fsx.types.file_cache_lustre_deployment_type.serialize_aws_json_1_1(
    ...
    if "metadata_configuration" in value:
        ...
        out["MetadataConfiguration"] = (
            capo_fsx.types.file_cache_lustre_metadata_configuration.serialize_aws_json_1_1(
    ...
    if "log_configuration" in value:
        ...
        out["LogConfiguration"] = (
            capo_fsx.types.lustre_log_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> FileCacheLustreConfiguration:
    ...
    if "DeploymentType" in data:
        ...
        out["deployment_type"] = (
            capo_fsx.types.file_cache_lustre_deployment_type.deserialize_aws_json_1_1(
                data["DeploymentType"]
            )
        )
    ...
    if "MetadataConfiguration" in data:
        ...
        out["metadata_configuration"] = (
            capo_fsx.types.file_cache_lustre_metadata_configuration.deserialize_aws_json_1_1(
    ...
    if "LogConfiguration" in data:
        ...
        out["log_configuration"] = (
            capo_fsx.types.lustre_log_configuration.deserialize_aws_json_1_1(
