"""Generated from Smithy shape ``com.amazonaws.fsx#RestoreVolumeFromSnapshot``."""
...
def handle_response(
    ...
    out: capo_fsx.types.restore_volume_from_snapshot_response.RestoreVolumeFromSnapshotResponse = capo_fsx.types.restore_volume_from_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.RestoreVolumeFromSnapshot"
    body: bytes | None = json.dumps(
        capo_fsx.types.restore_volume_from_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_restore_volume_from_snapshot(
