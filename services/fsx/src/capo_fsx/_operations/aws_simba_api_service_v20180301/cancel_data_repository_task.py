"""Generated from Smithy shape ``com.amazonaws.fsx#CancelDataRepositoryTask``."""
...
import capo_fsx.errors.data_repository_task_ended
import capo_fsx.errors.data_repository_task_not_found
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DataRepositoryTaskEnded":
            raise capo_fsx.errors.data_repository_task_ended.DataRepositoryTaskEnded.from_aws_json_1_1(
                data
            )
        case "DataRepositoryTaskNotFound":
            raise capo_fsx.errors.data_repository_task_not_found.DataRepositoryTaskNotFound.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_fsx.types.cancel_data_repository_task_response.CancelDataRepositoryTaskResponse = capo_fsx.types.cancel_data_repository_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.cancel_data_repository_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_cancel_data_repository_task(
