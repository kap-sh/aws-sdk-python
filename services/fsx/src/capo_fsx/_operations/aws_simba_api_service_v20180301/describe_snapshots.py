"""Generated from Smithy shape ``com.amazonaws.fsx#DescribeSnapshots``."""
...
import capo_fsx.types.snapshots
...
def handle_response(
    ...
    out: capo_fsx.types.describe_snapshots_response.DescribeSnapshotsResponse = (
        capo_fsx.types.describe_snapshots_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.DescribeSnapshots"
    body: bytes | None = json.dumps(
        capo_fsx.types.describe_snapshots_request.serialize_aws_json_1_1(input_)
    ).encode()
