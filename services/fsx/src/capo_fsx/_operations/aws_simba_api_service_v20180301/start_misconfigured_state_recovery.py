"""Generated from Smithy shape ``com.amazonaws.fsx#StartMisconfiguredStateRecovery``."""
...
def handle_response(
    ...
    out: capo_fsx.types.start_misconfigured_state_recovery_response.StartMisconfiguredStateRecoveryResponse = capo_fsx.types.start_misconfigured_state_recovery_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.start_misconfigured_state_recovery_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_misconfigured_state_recovery(
