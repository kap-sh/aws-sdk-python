"""Generated from Smithy shape ``com.amazonaws.fsx#CreateVolume``."""
...
import capo_fsx.errors.missing_volume_configuration
import capo_fsx.errors.service_limit_exceeded
import capo_fsx.errors.storage_virtual_machine_not_found
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MissingVolumeConfiguration":
            raise capo_fsx.errors.missing_volume_configuration.MissingVolumeConfiguration.from_aws_json_1_1(
                data
            )
        ...
        case "StorageVirtualMachineNotFound":
            raise capo_fsx.errors.storage_virtual_machine_not_found.StorageVirtualMachineNotFound.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_fsx.types.create_volume_response.CreateVolumeResponse = (
        capo_fsx.types.create_volume_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.CreateVolume"
    body: bytes | None = json.dumps(
        capo_fsx.types.create_volume_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_volume(
    ...
    input_: capo_fsx.types.create_volume_request.CreateVolumeRequest,
) -> tuple[capo_fsx.types.create_volume_response.CreateVolumeResponse, zapros.Response]:
