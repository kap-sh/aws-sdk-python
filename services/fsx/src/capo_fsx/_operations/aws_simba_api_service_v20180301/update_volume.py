...
def handle_response(
    ...
    out: capo_fsx.types.update_volume_response.UpdateVolumeResponse = (
        capo_fsx.types.update_volume_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.update_volume_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_volume(
    ...
    input_: capo_fsx.types.update_volume_request.UpdateVolumeRequest,
) -> tuple[capo_fsx.types.update_volume_response.UpdateVolumeResponse, zapros.Response]:
