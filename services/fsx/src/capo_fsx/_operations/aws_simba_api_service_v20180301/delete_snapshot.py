...
def handle_response(
    ...
    out: capo_fsx.types.delete_snapshot_response.DeleteSnapshotResponse = (
        capo_fsx.types.delete_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.delete_snapshot_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_snapshot(
    ...
    capo_fsx.types.delete_snapshot_response.DeleteSnapshotResponse, zapros.Response
]:
