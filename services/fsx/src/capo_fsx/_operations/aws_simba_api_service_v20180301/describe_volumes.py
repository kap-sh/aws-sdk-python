...
def handle_response(
    ...
    out: capo_fsx.types.describe_volumes_response.DescribeVolumesResponse = (
        capo_fsx.types.describe_volumes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.describe_volumes_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_volumes(
    ...
    capo_fsx.types.describe_volumes_response.DescribeVolumesResponse, zapros.Response
]:
