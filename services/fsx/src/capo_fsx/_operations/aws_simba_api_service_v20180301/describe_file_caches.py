"""Generated from Smithy shape ``com.amazonaws.fsx#DescribeFileCaches``."""
...
def handle_response(
    ...
    out: capo_fsx.types.describe_file_caches_response.DescribeFileCachesResponse = (
        capo_fsx.types.describe_file_caches_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.DescribeFileCaches"
    body: bytes | None = json.dumps(
        capo_fsx.types.describe_file_caches_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_file_caches(
