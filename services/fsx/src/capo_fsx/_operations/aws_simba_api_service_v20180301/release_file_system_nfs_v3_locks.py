...
def handle_response(
    ...
    out: capo_fsx.types.release_file_system_nfs_v3_locks_response.ReleaseFileSystemNfsV3LocksResponse = capo_fsx.types.release_file_system_nfs_v3_locks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.release_file_system_nfs_v3_locks_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
