"""Generated from Smithy shape ``com.amazonaws.fsx#DescribeSharedVpcConfiguration``."""
...
def handle_response(
    ...
    out: capo_fsx.types.describe_shared_vpc_configuration_response.DescribeSharedVpcConfigurationResponse = capo_fsx.types.describe_shared_vpc_configuration_response.deserialize_aws_json_1_1(
...
async def async_describe_shared_vpc_configuration(
