"""Generated from Smithy shape ``com.amazonaws.fsx#CreateFileSystem``."""
...
import capo_fsx.errors.invalid_export_path
import capo_fsx.errors.invalid_import_path
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidExportPath":
            raise capo_fsx.errors.invalid_export_path.InvalidExportPath.from_aws_json_1_1(
                data
            )
        case "InvalidImportPath":
            raise capo_fsx.errors.invalid_import_path.InvalidImportPath.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_fsx.types.create_file_system_response.CreateFileSystemResponse = (
        capo_fsx.types.create_file_system_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.create_file_system_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_file_system(
    ...
    capo_fsx.types.create_file_system_response.CreateFileSystemResponse, zapros.Response
]:
