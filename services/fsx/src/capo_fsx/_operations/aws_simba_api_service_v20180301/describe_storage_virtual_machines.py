...
def handle_response(
    ...
    out: capo_fsx.types.describe_storage_virtual_machines_response.DescribeStorageVirtualMachinesResponse = capo_fsx.types.describe_storage_virtual_machines_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.describe_storage_virtual_machines_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
