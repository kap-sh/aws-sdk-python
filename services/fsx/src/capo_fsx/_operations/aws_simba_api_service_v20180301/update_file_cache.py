...
import capo_fsx.errors.file_cache_not_found
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FileCacheNotFound":
            raise capo_fsx.errors.file_cache_not_found.FileCacheNotFound.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_fsx.types.update_file_cache_response.UpdateFileCacheResponse = (
        capo_fsx.types.update_file_cache_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.update_file_cache_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_file_cache(
    ...
    capo_fsx.types.update_file_cache_response.UpdateFileCacheResponse, zapros.Response
]:
