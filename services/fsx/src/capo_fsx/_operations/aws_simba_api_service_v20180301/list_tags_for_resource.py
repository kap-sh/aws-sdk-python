"""Generated from Smithy shape ``com.amazonaws.fsx#ListTagsForResource``."""
...
import capo_fsx.errors.not_service_resource_error
import capo_fsx.errors.resource_does_not_support_tagging
import capo_fsx.errors.resource_not_found
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotServiceResourceError":
            raise capo_fsx.errors.not_service_resource_error.NotServiceResourceError.from_aws_json_1_1(
                data
            )
        case "ResourceDoesNotSupportTagging":
            raise capo_fsx.errors.resource_does_not_support_tagging.ResourceDoesNotSupportTagging.from_aws_json_1_1(
                data
            )
        case "ResourceNotFound":
            raise capo_fsx.errors.resource_not_found.ResourceNotFound.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_fsx.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_fsx.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.list_tags_for_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
