"""Generated from Smithy shape ``com.amazonaws.fsx#CopyBackup``."""
...
import capo_fsx.errors.incompatible_region_for_multi_az
import capo_fsx.errors.internal_server_error
import capo_fsx.errors.invalid_destination_kms_key
import capo_fsx.errors.invalid_region
import capo_fsx.errors.invalid_source_kms_key
import capo_fsx.errors.service_limit_exceeded
import capo_fsx.errors.source_backup_unavailable
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IncompatibleRegionForMultiAZ":
            raise capo_fsx.errors.incompatible_region_for_multi_az.IncompatibleRegionForMultiAZ.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidDestinationKmsKey":
            raise capo_fsx.errors.invalid_destination_kms_key.InvalidDestinationKmsKey.from_aws_json_1_1(
                data
            )
        case "InvalidRegion":
            raise capo_fsx.errors.invalid_region.InvalidRegion.from_aws_json_1_1(data)
        case "InvalidSourceKmsKey":
            raise capo_fsx.errors.invalid_source_kms_key.InvalidSourceKmsKey.from_aws_json_1_1(
                data
            )
        ...
        case "SourceBackupUnavailable":
            raise capo_fsx.errors.source_backup_unavailable.SourceBackupUnavailable.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_fsx.types.copy_backup_response.CopyBackupResponse = (
        capo_fsx.types.copy_backup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.CopyBackup"
    body: bytes | None = json.dumps(
        capo_fsx.types.copy_backup_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def copy_backup(
    ...
    input_: capo_fsx.types.copy_backup_request.CopyBackupRequest,
) -> tuple[capo_fsx.types.copy_backup_response.CopyBackupResponse, zapros.Response]:
