...
if TYPE_CHECKING:
    ...
    import aws_sdk_guardduty.types.coverage_resource_details
...
class CoverageResource(TypedDict):
...
def serialize_json(value: CoverageResource) -> dict:
    ...
    if "resource_details" in value:
        ...
        out["resourceDetails"] = (
            aws_sdk_guardduty.types.coverage_resource_details.serialize_json(
    ...
    if "coverage_status" in value:
        ...
        out["coverageStatus"] = aws_sdk_guardduty.types.coverage_status.serialize_json(
...
def deserialize_json(data: dict) -> CoverageResource:
    ...
    if "resourceDetails" in data:
        ...
        out["resource_details"] = (
            aws_sdk_guardduty.types.coverage_resource_details.deserialize_json(
    ...
    if "coverageStatus" in data:
        ...
        out["coverage_status"] = (
            aws_sdk_guardduty.types.coverage_status.deserialize_json(
                data["coverageStatus"]
            )
        )
    if "issue" in data:
