...
if TYPE_CHECKING:
    ...
    import aws_sdk_guardduty.types.ecs_launch_type
...
class EcsTask(TypedDict):
    ...
    launch_type: NotRequired["aws_sdk_guardduty.types.ecs_launch_type.EcsLaunchType"]
...
def serialize_json(value: EcsTask) -> dict:
    ...
    if "launch_type" in value:
        ...
        out["launchType"] = aws_sdk_guardduty.types.ecs_launch_type.serialize_json(
            value["launch_type"]
        )
...
def deserialize_json(data: dict) -> EcsTask:
    ...
    if "launchType" in data:
        ...
        out["launch_type"] = aws_sdk_guardduty.types.ecs_launch_type.deserialize_json(
            data["launchType"]
        )
