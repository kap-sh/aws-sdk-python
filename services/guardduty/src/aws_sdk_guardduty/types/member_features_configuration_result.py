...
if TYPE_CHECKING:
    ...
    import aws_sdk_guardduty.types.member_additional_configuration_results
...
class MemberFeaturesConfigurationResult(TypedDict):
    ...
    additional_configuration: NotRequired[
        "aws_sdk_guardduty.types.member_additional_configuration_results.MemberAdditionalConfigurationResults"
    ]
...
def serialize_json(value: MemberFeaturesConfigurationResult) -> dict:
    ...
    if "additional_configuration" in value:
        ...
        out["additionalConfiguration"] = (
            aws_sdk_guardduty.types.member_additional_configuration_results.serialize_json(
...
def deserialize_json(data: dict) -> MemberFeaturesConfigurationResult:
    ...
    if "additionalConfiguration" in data:
        ...
        out["additional_configuration"] = (
            aws_sdk_guardduty.types.member_additional_configuration_results.deserialize_json(
