"""Generated from Smithy shape ``com.amazonaws.guardduty#OrganizationAdditionalConfiguration``."""
...
class OrganizationAdditionalConfiguration(TypedDict, closed=True):
    name: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: OrganizationAdditionalConfiguration) -> dict:
    out: dict = {}
    if "name" in value:
        import aws_sdk_guardduty.types.org_feature_additional_configuration
