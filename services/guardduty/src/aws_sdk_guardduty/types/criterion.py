...
if TYPE_CHECKING:
    import aws_sdk_guardduty.types.condition
    import aws_sdk_guardduty.types.string

Criterion: TypeAlias = dict[
    "aws_sdk_guardduty.types.string.String",
    "aws_sdk_guardduty.types.condition.Condition",
]
...
def serialize_json(input_to_serialize: Criterion) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_guardduty.types.condition.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> Criterion:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_guardduty.types.condition.deserialize_json(value)
    return out
