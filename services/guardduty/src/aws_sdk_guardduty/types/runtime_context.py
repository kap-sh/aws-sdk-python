...
if TYPE_CHECKING:
    import aws_sdk_guardduty.types.flags_list
    import aws_sdk_guardduty.types.integer
    import aws_sdk_guardduty.types.memory_regions_list
    import aws_sdk_guardduty.types.process_details
    import aws_sdk_guardduty.types.related_file_paths_list
...
class RuntimeContext(TypedDict):
    modifying_process: NotRequired[
        "aws_sdk_guardduty.types.process_details.ProcessDetails"
    ]
    """<p>Information about the process that modified the current process. This is available for multiple finding types.</p>"""
    modified_at: NotRequired["aws_sdk_guardduty.types.timestamp.Timestamp"]
    """<p>The timestamp at which the process modified the current process. The timestamp is in UTC date string format.</p>"""
    script_path: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The path to the script that was executed.</p>"""
    library_path: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The path to the new library that was loaded.</p>"""
    ld_preload_value: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The value of the LD_PRELOAD environment variable.</p>"""
    socket_path: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The path to the docket socket that was accessed.</p>"""
    runc_binary_path: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The path to the leveraged <code>runc</code> implementation.</p>"""
    release_agent_path: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The path in the container that modified the release agent file.</p>"""
    mount_source: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The path on the host that is mounted by the container.</p>"""
    mount_target: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The path in the container that is mapped to the host directory.</p>"""
    file_system_type: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>Represents the type of mounted fileSystem.</p>"""
    flags: NotRequired["aws_sdk_guardduty.types.flags_list.FlagsList"]
    ...
    module_name: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The name of the module loaded into the kernel.</p>"""
    module_file_path: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The path to the module loaded into the kernel.</p>"""
    module_sha256: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The <code>SHA256</code> hash of the module.</p>"""
    shell_history_file_path: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The path to the modified shell history file.</p>"""
    target_process: NotRequired[
        "aws_sdk_guardduty.types.process_details.ProcessDetails"
    ]
    """<p>Information about the process that had its memory overwritten by the current process.</p>"""
    address_family: NotRequired["aws_sdk_guardduty.types.string.String"]
    ...
    iana_protocol_number: NotRequired["aws_sdk_guardduty.types.integer.Integer"]
    ...
    memory_regions: NotRequired[
        "aws_sdk_guardduty.types.memory_regions_list.MemoryRegionsList"
    ]
    """<p>Specifies the Region of a process's address space such as stack and heap.</p>"""
    tool_name: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>Name of the potentially suspicious tool.</p>"""
    tool_category: NotRequired["aws_sdk_guardduty.types.string.String"]
    ...
    related_file_paths: NotRequired[
        "aws_sdk_guardduty.types.related_file_paths_list.RelatedFilePathsList"
    ]
...
def serialize_json(value: RuntimeContext) -> dict:
    ...
    if "modifying_process" in value:
        ...
        out["modifyingProcess"] = (
            aws_sdk_guardduty.types.process_details.serialize_json(
    ...
    if "modified_at" in value:
        ...
        out["modifiedAt"] = aws_sdk_guardduty.types.timestamp.serialize_json(
            value["modified_at"]
        )
    ...
    if "flags" in value:
        ...
        out["flags"] = aws_sdk_guardduty.types.flags_list.serialize_json(value["flags"])
    ...
    if "target_process" in value:
        ...
        out["targetProcess"] = aws_sdk_guardduty.types.process_details.serialize_json(
    ...
    if "memory_regions" in value:
        ...
        out["memoryRegions"] = (
            aws_sdk_guardduty.types.memory_regions_list.serialize_json(
    ...
    if "related_file_paths" in value:
        ...
        out["relatedFilePaths"] = (
            aws_sdk_guardduty.types.related_file_paths_list.serialize_json(
...
def deserialize_json(data: dict) -> RuntimeContext:
    ...
    if "modifyingProcess" in data:
        ...
        out["modifying_process"] = (
            aws_sdk_guardduty.types.process_details.deserialize_json(
    ...
    if "modifiedAt" in data:
        ...
        out["modified_at"] = aws_sdk_guardduty.types.timestamp.deserialize_json(
            data["modifiedAt"]
        )
    ...
    if "flags" in data:
        ...
        out["flags"] = aws_sdk_guardduty.types.flags_list.deserialize_json(
            data["flags"]
        )
    ...
    if "memoryRegions" in data:
        ...
        out["memory_regions"] = (
            aws_sdk_guardduty.types.memory_regions_list.deserialize_json(
                data["memoryRegions"]
            )
        )
    if "toolName" in data:
    ...
    if "relatedFilePaths" in data:
        ...
        out["related_file_paths"] = (
            aws_sdk_guardduty.types.related_file_paths_list.deserialize_json(
