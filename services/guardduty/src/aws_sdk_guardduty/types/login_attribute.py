...
class LoginAttribute(TypedDict):
    ...
    failed_login_attempts: NotRequired["aws_sdk_guardduty.types.integer.Integer"]
    """<p>Represents the sum of failed (unsuccessful) login attempts made to establish a connection to the database instance.</p>"""
    successful_login_attempts: NotRequired["aws_sdk_guardduty.types.integer.Integer"]
