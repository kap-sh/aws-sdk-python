...
if TYPE_CHECKING:
    import aws_sdk_guardduty.types.affected_resources
    import aws_sdk_guardduty.types.domain_details
    import aws_sdk_guardduty.types.remote_account_details
    import aws_sdk_guardduty.types.remote_ip_details
    import aws_sdk_guardduty.types.string


class AwsApiCallAction(TypedDict, closed=True):
    api: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The Amazon Web Services API name.</p>"""
    caller_type: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The Amazon Web Services API caller type.</p>"""
    domain_details: NotRequired["aws_sdk_guardduty.types.domain_details.DomainDetails"]
    """<p>The domain information for the Amazon Web Services API call.</p>"""
    error_code: NotRequired["aws_sdk_guardduty.types.string.String"]
    ...
    remote_account_details: NotRequired[
        "aws_sdk_guardduty.types.remote_account_details.RemoteAccountDetails"
    ]
    ...
    affected_resources: NotRequired[
        "aws_sdk_guardduty.types.affected_resources.AffectedResources"
    ]
...
def serialize_json(value: AwsApiCallAction) -> dict:
    ...
    if "domain_details" in value:
        ...
        out["domainDetails"] = aws_sdk_guardduty.types.domain_details.serialize_json(
    ...
    if "remote_account_details" in value:
        ...
        out["remoteAccountDetails"] = (
            aws_sdk_guardduty.types.remote_account_details.serialize_json(
    ...
    if "affected_resources" in value:
        ...
        out["affectedResources"] = (
            aws_sdk_guardduty.types.affected_resources.serialize_json(
...
def deserialize_json(data: dict) -> AwsApiCallAction:
    ...
    if "domainDetails" in data:
        ...
        out["domain_details"] = aws_sdk_guardduty.types.domain_details.deserialize_json(
            data["domainDetails"]
        )
    ...
    if "remoteAccountDetails" in data:
        ...
        out["remote_account_details"] = (
            aws_sdk_guardduty.types.remote_account_details.deserialize_json(
    ...
    if "affectedResources" in data:
        ...
        out["affected_resources"] = (
            aws_sdk_guardduty.types.affected_resources.deserialize_json(
