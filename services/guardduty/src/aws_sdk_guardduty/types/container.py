...
if TYPE_CHECKING:
    import aws_sdk_guardduty.types.security_context
    import aws_sdk_guardduty.types.string
    import aws_sdk_guardduty.types.volume_mounts


class Container(TypedDict):
    container_runtime: NotRequired["aws_sdk_guardduty.types.string.String"]
    ...
    """<p>Container image.</p>"""
    image_prefix: NotRequired["aws_sdk_guardduty.types.string.String"]
    ...
    volume_mounts: NotRequired["aws_sdk_guardduty.types.volume_mounts.VolumeMounts"]
    """<p>Container volume mounts.</p>"""
    security_context: NotRequired[
        "aws_sdk_guardduty.types.security_context.SecurityContext"
    ]
...
def serialize_json(value: Container) -> dict:
    ...
    if "volume_mounts" in value:
        ...
        out["volumeMounts"] = aws_sdk_guardduty.types.volume_mounts.serialize_json(
            value["volume_mounts"]
        )
    if "security_context" in value:
        ...
        out["securityContext"] = (
            aws_sdk_guardduty.types.security_context.serialize_json(
...
def deserialize_json(data: dict) -> Container:
    ...
    if "volumeMounts" in data:
        ...
        out["volume_mounts"] = aws_sdk_guardduty.types.volume_mounts.deserialize_json(
            data["volumeMounts"]
        )
    if "securityContext" in data:
        ...
        out["security_context"] = (
            aws_sdk_guardduty.types.security_context.deserialize_json(
