"""Generated from Smithy shape ``com.amazonaws.guardduty#ListTrustedEntitySetsRequest``."""
...
class ListTrustedEntitySetsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListTrustedEntitySetsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListTrustedEntitySetsRequest:
    out: ListTrustedEntitySetsRequest = {}  # type: ignore[typeddict-item]
    return out
