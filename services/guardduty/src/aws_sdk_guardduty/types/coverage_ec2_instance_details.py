...
if TYPE_CHECKING:
    import aws_sdk_guardduty.types.agent_details
    import aws_sdk_guardduty.types.management_type
    import aws_sdk_guardduty.types.string


class CoverageEc2InstanceDetails(TypedDict):
    ...
    cluster_arn: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The cluster ARN of the Amazon ECS cluster running on the Amazon EC2 instance.</p>"""
    agent_details: NotRequired["aws_sdk_guardduty.types.agent_details.AgentDetails"]
...
def serialize_json(value: CoverageEc2InstanceDetails) -> dict:
    ...
    if "agent_details" in value:
        ...
        out["agentDetails"] = aws_sdk_guardduty.types.agent_details.serialize_json(
            value["agent_details"]
        )
...
def deserialize_json(data: dict) -> CoverageEc2InstanceDetails:
    ...
    if "agentDetails" in data:
        ...
        out["agent_details"] = aws_sdk_guardduty.types.agent_details.deserialize_json(
            data["agentDetails"]
        )
