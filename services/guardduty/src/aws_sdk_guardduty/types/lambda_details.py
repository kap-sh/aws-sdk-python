...
if TYPE_CHECKING:
    ...
    import aws_sdk_guardduty.types.vpc_config


class LambdaDetails(TypedDict):
    function_arn: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>Amazon Resource Name (ARN) of the Lambda function.</p>"""
    function_name: NotRequired["aws_sdk_guardduty.types.string.String"]
    ...
    last_modified_at: NotRequired["aws_sdk_guardduty.types.timestamp.Timestamp"]
    ...
    revision_id: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The revision ID of the Lambda function version.</p>"""
    function_version: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The version of the Lambda function.</p>"""
    role: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The execution role of the Lambda function.</p>"""
    vpc_config: NotRequired["aws_sdk_guardduty.types.vpc_config.VpcConfig"]
...
def serialize_json(value: LambdaDetails) -> dict:
    ...
    if "last_modified_at" in value:
        ...
        out["lastModifiedAt"] = aws_sdk_guardduty.types.timestamp.serialize_json(
    ...
    if "vpc_config" in value:
        ...
        out["vpcConfig"] = aws_sdk_guardduty.types.vpc_config.serialize_json(
            value["vpc_config"]
        )
    if "tags" in value:
        import aws_sdk_guardduty.types.tags
...
def deserialize_json(data: dict) -> LambdaDetails:
    ...
    if "lastModifiedAt" in data:
        ...
        out["last_modified_at"] = aws_sdk_guardduty.types.timestamp.deserialize_json(
            data["lastModifiedAt"]
        )
    ...
    if "vpcConfig" in data:
        ...
        out["vpc_config"] = aws_sdk_guardduty.types.vpc_config.deserialize_json(
            data["vpcConfig"]
        )
    if "tags" in data:
        import aws_sdk_guardduty.types.tags
