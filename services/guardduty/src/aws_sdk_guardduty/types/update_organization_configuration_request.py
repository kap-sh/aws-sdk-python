...
def serialize_json(value: UpdateOrganizationConfigurationRequest) -> dict:
    ...
    if "data_sources" in value:
        ...
        out["dataSources"] = (
            aws_sdk_guardduty.types.organization_data_source_configurations.serialize_json(
                value["data_sources"]
            )
        )
    if "features" in value:
        ...
        out["features"] = (
            aws_sdk_guardduty.types.organization_features_configurations.serialize_json(
                value["features"]
            )
        )
...
def deserialize_json(data: dict) -> UpdateOrganizationConfigurationRequest:
    ...
    if "dataSources" in data:
        ...
        out["data_sources"] = (
            aws_sdk_guardduty.types.organization_data_source_configurations.deserialize_json(
                data["dataSources"]
            )
        )
    if "features" in data:
        ...
        out["features"] = (
            aws_sdk_guardduty.types.organization_features_configurations.deserialize_json(
                data["features"]
            )
        )
