...
CountByResourceType: TypeAlias = dict[
    "aws_sdk_guardduty.types.resource_type.ResourceType",
...
def serialize_json(input_to_serialize: CountByResourceType) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[aws_sdk_guardduty.types.resource_type.serialize_json(key)] = value
    return out
...
def deserialize_json(data: dict) -> CountByResourceType:
    ...
    for key, value in data.items():
        ...
        out[aws_sdk_guardduty.types.resource_type.deserialize_json(key)] = value
    return out
