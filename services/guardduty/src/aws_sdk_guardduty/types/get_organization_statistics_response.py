...
if TYPE_CHECKING:
    import aws_sdk_guardduty.types.organization_details


class GetOrganizationStatisticsResponse(TypedDict):
    organization_details: NotRequired[
        "aws_sdk_guardduty.types.organization_details.OrganizationDetails"
    ]
...
def serialize_json(value: GetOrganizationStatisticsResponse) -> dict:
    ...
    if "organization_details" in value:
        ...
        out["organizationDetails"] = (
            aws_sdk_guardduty.types.organization_details.serialize_json(
...
def deserialize_json(data: dict) -> GetOrganizationStatisticsResponse:
    ...
    if "organizationDetails" in data:
        ...
        out["organization_details"] = (
            aws_sdk_guardduty.types.organization_details.deserialize_json(
