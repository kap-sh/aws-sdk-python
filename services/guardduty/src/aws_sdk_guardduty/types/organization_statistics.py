...
class OrganizationStatistics(TypedDict):
    ...
    active_accounts_count: NotRequired["aws_sdk_guardduty.types.integer.Integer"]
    ...
    count_by_feature: NotRequired[
        "aws_sdk_guardduty.types.organization_feature_statistics_results.OrganizationFeatureStatisticsResults"
    ]
...
def serialize_json(value: OrganizationStatistics) -> dict:
    ...
    if "count_by_feature" in value:
        ...
        out["countByFeature"] = (
            aws_sdk_guardduty.types.organization_feature_statistics_results.serialize_json(
...
def deserialize_json(data: dict) -> OrganizationStatistics:
    ...
    if "countByFeature" in data:
        ...
        out["count_by_feature"] = (
            aws_sdk_guardduty.types.organization_feature_statistics_results.deserialize_json(
                data["countByFeature"]
            )
        )
    return out
