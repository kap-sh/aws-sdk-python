...
if TYPE_CHECKING:
    ...
    import aws_sdk_guardduty.types.threat_names


class ThreatIntelligenceDetail(TypedDict):
    threat_list_name: NotRequired["aws_sdk_guardduty.types.string.String"]
    """<p>The name of the threat intelligence list that triggered the finding.</p>"""
    threat_names: NotRequired["aws_sdk_guardduty.types.threat_names.ThreatNames"]
    """<p>A list of names of the threats in the threat intelligence list that triggered the finding.</p>"""
    threat_file_sha256: NotRequired["aws_sdk_guardduty.types.string.String"]
...
def serialize_json(value: ThreatIntelligenceDetail) -> dict:
    ...
    if "threat_names" in value:
        ...
        out["threatNames"] = aws_sdk_guardduty.types.threat_names.serialize_json(
            value["threat_names"]
        )
...
def deserialize_json(data: dict) -> ThreatIntelligenceDetail:
    ...
    if "threatNames" in data:
        ...
        out["threat_names"] = aws_sdk_guardduty.types.threat_names.deserialize_json(
            data["threatNames"]
        )
