...
if TYPE_CHECKING:
    import aws_sdk_guardduty.types.tag_key
    import aws_sdk_guardduty.types.tag_value


class ScanConditionPair(TypedDict):
    key: NotRequired["aws_sdk_guardduty.types.tag_key.TagKey"]
    """<p>Represents the <b>key</b> in the map condition.</p>"""
    value: NotRequired["aws_sdk_guardduty.types.tag_value.TagValue"]
