...
if TYPE_CHECKING:
    ...
    import aws_sdk_guardduty.types.organization_data_source_configurations_result
    import aws_sdk_guardduty.types.organization_features_configurations_results
...
class DescribeOrganizationConfigurationResponse(TypedDict, closed=True):
    ...
    data_sources: NotRequired[
        "aws_sdk_guardduty.types.organization_data_source_configurations_result.OrganizationDataSourceConfigurationsResult"
    ]
    """<p>Describes which data sources are enabled automatically for member accounts.</p>"""
    features: NotRequired[
        "aws_sdk_guardduty.types.organization_features_configurations_results.OrganizationFeaturesConfigurationsResults"
    ]
...
def serialize_json(value: DescribeOrganizationConfigurationResponse) -> dict:
    ...
    if "data_sources" in value:
        ...
        out["dataSources"] = (
            aws_sdk_guardduty.types.organization_data_source_configurations_result.serialize_json(
                value["data_sources"]
            )
        )
    if "features" in value:
        ...
        out["features"] = (
            aws_sdk_guardduty.types.organization_features_configurations_results.serialize_json(
                value["features"]
            )
        )
    ...
    if "auto_enable_organization_members" in value:
        ...
        out["autoEnableOrganizationMembers"] = (
            aws_sdk_guardduty.types.auto_enable_members.serialize_json(
...
def deserialize_json(data: dict) -> DescribeOrganizationConfigurationResponse:
    ...
    if "dataSources" in data:
        ...
        out["data_sources"] = (
            aws_sdk_guardduty.types.organization_data_source_configurations_result.deserialize_json(
                data["dataSources"]
            )
        )
    if "features" in data:
        ...
        out["features"] = (
            aws_sdk_guardduty.types.organization_features_configurations_results.deserialize_json(
                data["features"]
            )
        )
    ...
    if "autoEnableOrganizationMembers" in data:
        ...
        out["auto_enable_organization_members"] = (
            aws_sdk_guardduty.types.auto_enable_members.deserialize_json(
