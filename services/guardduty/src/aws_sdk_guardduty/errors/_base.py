...
class GuardDutyError(Exception):
    """Base class for all GuardDuty service errors."""


class ServiceError(GuardDutyError):
...
class SerializationError(GuardDutyError):
    """Raised when a value cannot be serialized."""


class DeserializationError(GuardDutyError):
...
class WaiterFailedError(GuardDutyError):
...
class WaiterTimeoutError(GuardDutyError):
