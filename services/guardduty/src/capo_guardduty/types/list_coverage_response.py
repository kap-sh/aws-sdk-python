...
if TYPE_CHECKING:
    import capo_guardduty.types.coverage_resources
    import capo_guardduty.types.string


class ListCoverageResponse(TypedDict, closed=True):
    resources: NotRequired["capo_guardduty.types.coverage_resources.CoverageResources"]
...
def serialize_json(value: ListCoverageResponse) -> dict:
    ...
    if "resources" in value:
        ...
        out["resources"] = capo_guardduty.types.coverage_resources.serialize_json(
            value["resources"]
        )
...
def deserialize_json(data: dict) -> ListCoverageResponse:
    ...
    if "resources" in data:
        ...
        out["resources"] = capo_guardduty.types.coverage_resources.deserialize_json(
            data["resources"]
        )
