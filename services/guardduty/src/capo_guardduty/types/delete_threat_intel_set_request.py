"""Generated from Smithy shape ``com.amazonaws.guardduty#DeleteThreatIntelSetRequest``."""
...
class DeleteThreatIntelSetRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteThreatIntelSetRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteThreatIntelSetRequest:
    out: DeleteThreatIntelSetRequest = {}  # type: ignore[typeddict-item]
    return out
