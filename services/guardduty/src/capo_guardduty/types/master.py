"""Generated from Smithy shape ``com.amazonaws.guardduty#Master``."""
...
class Master(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: Master) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> Master:
    out: Master = {}  # type: ignore[typeddict-item]
