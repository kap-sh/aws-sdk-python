...
class RdsLimitlessDbDetails(TypedDict, closed=True):
    db_shard_group_identifier: NotRequired["capo_guardduty.types.string.String"]
    """<p>The name associated with the Limitless DB shard group.</p>"""
    db_shard_group_resource_id: NotRequired["capo_guardduty.types.string.String"]
    """<p>The resource identifier of the DB shard group within the Limitless Database.</p>"""
    db_shard_group_arn: NotRequired["capo_guardduty.types.string.String"]
    """<p>The Amazon Resource Name (ARN) that identifies the DB shard group.</p>"""
    engine: NotRequired["capo_guardduty.types.string.String"]
    """<p>The database engine of the database instance involved in the finding.</p>"""
    engine_version: NotRequired["capo_guardduty.types.string.String"]
    """<p>The version of the database engine.</p>"""
    db_cluster_identifier: NotRequired["capo_guardduty.types.string.String"]
