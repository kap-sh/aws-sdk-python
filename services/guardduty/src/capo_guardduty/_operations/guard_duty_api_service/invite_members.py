...
def handle_response(
    ...
    out: capo_guardduty.types.invite_members_response.InviteMembersResponse = (
        capo_guardduty.types.invite_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.invite_members_request.serialize_json(input_)
    ).encode()
...
def invite_members(
    ...
    capo_guardduty.types.invite_members_response.InviteMembersResponse, zapros.Response
]:
