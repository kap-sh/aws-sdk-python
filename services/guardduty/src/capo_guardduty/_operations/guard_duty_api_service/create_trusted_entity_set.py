"""Generated from Smithy shape ``com.amazonaws.guardduty#CreateTrustedEntitySet``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.create_trusted_entity_set_response.CreateTrustedEntitySetResponse = capo_guardduty.types.create_trusted_entity_set_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.create_trusted_entity_set_request.serialize_json(input_)
    ).encode()
...
async def async_create_trusted_entity_set(
