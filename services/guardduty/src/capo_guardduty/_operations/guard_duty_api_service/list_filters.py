"""Generated from Smithy shape ``com.amazonaws.guardduty#ListFilters``."""
...
import capo_guardduty.types.filter_names
...
def handle_response(
    ...
    out: capo_guardduty.types.list_filters_response.ListFiltersResponse = (
        capo_guardduty.types.list_filters_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/detector/{DetectorId}/filter"
...
def list_filters(
    ...
    capo_guardduty.types.list_filters_response.ListFiltersResponse, zapros.Response
]:
