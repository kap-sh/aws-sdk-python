"""Generated from Smithy shape ``com.amazonaws.guardduty#ListDetectors``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.list_detectors_response.ListDetectorsResponse = (
        capo_guardduty.types.list_detectors_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/detector"
    params: dict[str, str] = {}
...
def list_detectors(
    ...
    capo_guardduty.types.list_detectors_response.ListDetectorsResponse, zapros.Response
]:
...
async def async_list_detectors(
