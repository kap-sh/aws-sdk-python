...
def handle_response(
    ...
    out: capo_guardduty.types.list_members_response.ListMembersResponse = (
        capo_guardduty.types.list_members_response.deserialize_json(
...
def list_members(
    ...
    capo_guardduty.types.list_members_response.ListMembersResponse, zapros.Response
]:
