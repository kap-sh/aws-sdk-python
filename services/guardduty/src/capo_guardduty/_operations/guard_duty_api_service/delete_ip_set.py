"""Generated from Smithy shape ``com.amazonaws.guardduty#DeleteIPSet``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.delete_ip_set_response.DeleteIPSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_ip_set(
    ...
    capo_guardduty.types.delete_ip_set_response.DeleteIPSetResponse, zapros.Response
]:
