"""Generated from Smithy shape ``com.amazonaws.guardduty#DeletePublishingDestination``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.delete_publishing_destination_response.DeletePublishingDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_publishing_destination(
