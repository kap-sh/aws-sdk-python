"""Generated from Smithy shape ``com.amazonaws.guardduty#CreateDetector``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.create_detector_response.CreateDetectorResponse = (
        capo_guardduty.types.create_detector_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.create_detector_request.serialize_json(input_)
    ).encode()
...
async def async_create_detector(
