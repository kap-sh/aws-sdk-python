...
def handle_response(
    ...
    out: capo_guardduty.types.update_trusted_entity_set_response.UpdateTrustedEntitySetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.update_trusted_entity_set_request.serialize_json(input_)
    ).encode()
