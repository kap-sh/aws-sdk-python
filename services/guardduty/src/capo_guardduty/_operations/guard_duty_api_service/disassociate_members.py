...
def handle_response(
    ...
    out: capo_guardduty.types.disassociate_members_response.DisassociateMembersResponse = capo_guardduty.types.disassociate_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.disassociate_members_request.serialize_json(input_)
    ).encode()
