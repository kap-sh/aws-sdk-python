...
def handle_response(
    ...
    out: capo_guardduty.types.get_threat_entity_set_response.GetThreatEntitySetResponse = capo_guardduty.types.get_threat_entity_set_response.deserialize_json(
