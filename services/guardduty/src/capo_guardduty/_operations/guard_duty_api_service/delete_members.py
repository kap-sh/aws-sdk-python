...
def handle_response(
    ...
    out: capo_guardduty.types.delete_members_response.DeleteMembersResponse = (
        capo_guardduty.types.delete_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.delete_members_request.serialize_json(input_)
    ).encode()
...
def delete_members(
    ...
    capo_guardduty.types.delete_members_response.DeleteMembersResponse, zapros.Response
]:
