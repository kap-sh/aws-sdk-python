...
def handle_response(
    ...
    out: capo_guardduty.types.list_trusted_entity_sets_response.ListTrustedEntitySetsResponse = capo_guardduty.types.list_trusted_entity_sets_response.deserialize_json(
