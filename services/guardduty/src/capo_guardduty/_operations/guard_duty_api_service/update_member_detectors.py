...
def handle_response(
    ...
    out: capo_guardduty.types.update_member_detectors_response.UpdateMemberDetectorsResponse = capo_guardduty.types.update_member_detectors_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.update_member_detectors_request.serialize_json(input_)
    ).encode()
