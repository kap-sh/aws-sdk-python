...
def handle_response(
    ...
    out: capo_guardduty.types.delete_filter_response.DeleteFilterResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_filter(
    ...
    capo_guardduty.types.delete_filter_response.DeleteFilterResponse, zapros.Response
]:
