"""Generated from Smithy shape ``com.amazonaws.guardduty#CreateIPSet``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.create_ip_set_response.CreateIPSetResponse = (
        capo_guardduty.types.create_ip_set_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.create_ip_set_request.serialize_json(input_)
    ).encode()
...
def create_ip_set(
    ...
    capo_guardduty.types.create_ip_set_response.CreateIPSetResponse, zapros.Response
]:
