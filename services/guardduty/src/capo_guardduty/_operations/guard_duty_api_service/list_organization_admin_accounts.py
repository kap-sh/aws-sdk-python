"""Generated from Smithy shape ``com.amazonaws.guardduty#ListOrganizationAdminAccounts``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.list_organization_admin_accounts_response.ListOrganizationAdminAccountsResponse = capo_guardduty.types.list_organization_admin_accounts_response.deserialize_json(
