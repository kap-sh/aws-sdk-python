...
def handle_response(
    ...
    out: capo_guardduty.types.create_members_response.CreateMembersResponse = (
        capo_guardduty.types.create_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.create_members_request.serialize_json(input_)
    ).encode()
...
def create_members(
    ...
    capo_guardduty.types.create_members_response.CreateMembersResponse, zapros.Response
]:
