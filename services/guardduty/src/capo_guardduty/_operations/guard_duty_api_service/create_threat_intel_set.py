"""Generated from Smithy shape ``com.amazonaws.guardduty#CreateThreatIntelSet``."""
...
import capo_guardduty.errors.access_denied_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_guardduty.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_guardduty.types.create_threat_intel_set_response.CreateThreatIntelSetResponse = capo_guardduty.types.create_threat_intel_set_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.create_threat_intel_set_request.serialize_json(input_)
    ).encode()
...
async def async_create_threat_intel_set(
