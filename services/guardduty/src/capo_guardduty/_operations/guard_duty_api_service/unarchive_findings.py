...
def handle_response(
    ...
    out: capo_guardduty.types.unarchive_findings_response.UnarchiveFindingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.unarchive_findings_request.serialize_json(input_)
    ).encode()
