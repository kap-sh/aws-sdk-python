"""Generated from Smithy shape ``com.amazonaws.guardduty#DeleteThreatEntitySet``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.delete_threat_entity_set_response.DeleteThreatEntitySetResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_threat_entity_set(
