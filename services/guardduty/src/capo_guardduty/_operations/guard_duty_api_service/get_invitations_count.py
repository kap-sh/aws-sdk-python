"""Generated from Smithy shape ``com.amazonaws.guardduty#GetInvitationsCount``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.get_invitations_count_response.GetInvitationsCountResponse = capo_guardduty.types.get_invitations_count_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/invitation/count"
    params: dict[str, str] = {}
