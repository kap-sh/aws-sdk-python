"""Generated from Smithy shape ``com.amazonaws.guardduty#DeleteTrustedEntitySet``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.delete_trusted_entity_set_response.DeleteTrustedEntitySetResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_trusted_entity_set(
