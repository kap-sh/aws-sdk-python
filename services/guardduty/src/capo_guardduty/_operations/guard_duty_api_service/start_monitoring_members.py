...
def handle_response(
    ...
    out: capo_guardduty.types.start_monitoring_members_response.StartMonitoringMembersResponse = capo_guardduty.types.start_monitoring_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.start_monitoring_members_request.serialize_json(input_)
    ).encode()
