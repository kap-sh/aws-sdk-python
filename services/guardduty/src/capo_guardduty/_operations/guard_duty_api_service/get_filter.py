"""Generated from Smithy shape ``com.amazonaws.guardduty#GetFilter``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.get_filter_response.GetFilterResponse = (
        capo_guardduty.types.get_filter_response.deserialize_json(
...
def get_filter(
    ...
    input_: capo_guardduty.types.get_filter_request.GetFilterRequest,
) -> tuple[capo_guardduty.types.get_filter_response.GetFilterResponse, zapros.Response]:
