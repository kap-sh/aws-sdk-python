...
from ._services.async_guard_duty import AsyncGuardDutyClient as AsyncGuardDutyClient
from ._services.guard_duty import GuardDutyClient as GuardDutyClient
