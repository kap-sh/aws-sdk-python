...
if TYPE_CHECKING:
    ...
    import capo_codestar_connections.types.host_status
    import capo_codestar_connections.types.host_status_message
...
class Host(TypedDict, closed=True):
    name: NotRequired["capo_codestar_connections.types.host_name.HostName"]
    ...
    provider_endpoint: NotRequired["capo_codestar_connections.types.url.Url"]
    ...
    status: NotRequired["capo_codestar_connections.types.host_status.HostStatus"]
    ...
    status_message: NotRequired[
        "capo_codestar_connections.types.host_status_message.HostStatusMessage"
    ]
...
def serialize_aws_json_1_0(value: Host) -> dict:
    ...
    if "vpc_configuration" in value:
        ...
        out["VpcConfiguration"] = (
            capo_codestar_connections.types.vpc_configuration.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Host:
    ...
    if "VpcConfiguration" in data:
        ...
        out["vpc_configuration"] = (
            capo_codestar_connections.types.vpc_configuration.deserialize_aws_json_1_0(
