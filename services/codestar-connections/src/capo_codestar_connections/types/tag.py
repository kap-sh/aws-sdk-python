...
if TYPE_CHECKING:
    import capo_codestar_connections.types.tag_key
    import capo_codestar_connections.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_codestar_connections.types.tag_key.TagKey"
    """<p>The tag's key.</p>"""
    value: "capo_codestar_connections.types.tag_value.TagValue"
    """<p>The tag's value.</p>"""
