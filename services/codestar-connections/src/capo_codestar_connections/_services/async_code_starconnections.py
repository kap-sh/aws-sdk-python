...
from capo_codestar_connections._auth._identity import Credentials
from capo_codestar_connections._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
...
if TYPE_CHECKING:
    ...
    import capo_codestar_connections.types.create_connection_input
    import capo_codestar_connections.types.create_connection_output
    import capo_codestar_connections.types.create_host_input
    import capo_codestar_connections.types.create_host_output
    import capo_codestar_connections.types.create_repository_link_input
    import capo_codestar_connections.types.create_repository_link_output
    import capo_codestar_connections.types.create_sync_configuration_input
    import capo_codestar_connections.types.create_sync_configuration_output
    import capo_codestar_connections.types.delete_connection_input
    import capo_codestar_connections.types.delete_connection_output
    import capo_codestar_connections.types.delete_host_input
    import capo_codestar_connections.types.delete_host_output
    import capo_codestar_connections.types.delete_repository_link_input
    import capo_codestar_connections.types.delete_repository_link_output
    import capo_codestar_connections.types.delete_sync_configuration_input
    import capo_codestar_connections.types.delete_sync_configuration_output
    import capo_codestar_connections.types.deployment_file_path
    import capo_codestar_connections.types.get_connection_input
    import capo_codestar_connections.types.get_connection_output
    import capo_codestar_connections.types.get_host_input
    import capo_codestar_connections.types.get_host_output
    import capo_codestar_connections.types.get_repository_link_input
    import capo_codestar_connections.types.get_repository_link_output
    import capo_codestar_connections.types.get_repository_sync_status_input
    import capo_codestar_connections.types.get_repository_sync_status_output
    import capo_codestar_connections.types.get_resource_sync_status_input
    import capo_codestar_connections.types.get_resource_sync_status_output
    import capo_codestar_connections.types.get_sync_blocker_summary_input
    import capo_codestar_connections.types.get_sync_blocker_summary_output
    import capo_codestar_connections.types.get_sync_configuration_input
    import capo_codestar_connections.types.get_sync_configuration_output
    import capo_codestar_connections.types.host_arn
    import capo_codestar_connections.types.host_name
    ...
    import capo_codestar_connections.types.list_connections_input
    import capo_codestar_connections.types.list_connections_output
    import capo_codestar_connections.types.list_hosts_input
    import capo_codestar_connections.types.list_hosts_output
    import capo_codestar_connections.types.list_repository_links_input
    import capo_codestar_connections.types.list_repository_links_output
    import capo_codestar_connections.types.list_repository_sync_definitions_input
    import capo_codestar_connections.types.list_repository_sync_definitions_output
    import capo_codestar_connections.types.list_sync_configurations_input
    import capo_codestar_connections.types.list_sync_configurations_output
    import capo_codestar_connections.types.list_tags_for_resource_input
    import capo_codestar_connections.types.list_tags_for_resource_output
    import capo_codestar_connections.types.max_results
    import capo_codestar_connections.types.next_token
    ...
    import capo_codestar_connections.types.tag_resource_input
    import capo_codestar_connections.types.tag_resource_output
    import capo_codestar_connections.types.trigger_resource_update_on
    import capo_codestar_connections.types.untag_resource_input
    import capo_codestar_connections.types.untag_resource_output
    import capo_codestar_connections.types.update_host_input
    import capo_codestar_connections.types.update_host_output
    import capo_codestar_connections.types.update_repository_link_input
    import capo_codestar_connections.types.update_repository_link_output
    import capo_codestar_connections.types.update_sync_blocker_input
    import capo_codestar_connections.types.update_sync_blocker_output
    ...
    import capo_codestar_connections.types.url
...
class AsyncCodeStarconnectionsClient:
    ...
    async def create_connection(
        ...
        *,
        ...
        tags: Optional["capo_codestar_connections.types.tag_list.TagList"] = None,
        host_arn: Optional["capo_codestar_connections.types.host_arn.HostArn"] = None,
    ) -> "capo_codestar_connections.types.create_connection_output.CreateConnectionOutput":
        ...
        Raises:
            capo_codestar_connections.errors.limit_exceeded_exception.LimitExceededException: <p>Exceeded the maximum limit for connections.</p>
            capo_codestar_connections.errors.resource_not_found_exception.ResourceNotFoundException: <p>Resource not found. Verify the connection resource ARN and try again.</p>
            capo_codestar_connections.errors.resource_unavailable_exception.ResourceUnavailableException: <p>Resource not found. Verify the ARN for the host resource and try again.</p>
            capo_codestar_connections.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.create_connection_input.CreateConnectionInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.create_connection_output.CreateConnectionOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.create_connection

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.create_connection.async_create_connection(
    ...
    async def create_host(
        self,
        name: "capo_codestar_connections.types.host_name.HostName",
        provider_type: "capo_codestar_connections.types.provider_type.ProviderType",
        provider_endpoint: "capo_codestar_connections.types.url.Url",
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
        vpc_configuration: Optional[
            "capo_codestar_connections.types.vpc_configuration.VpcConfiguration"
        ] = None,
        tags: Optional["capo_codestar_connections.types.tag_list.TagList"] = None,
    ) -> "capo_codestar_connections.types.create_host_output.CreateHostOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.create_host_input.CreateHostInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.create_host_output.CreateHostOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.create_host

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.create_host.async_create_host(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_repository_link(
        ...
        *,
        ...
        tags: Optional["capo_codestar_connections.types.tag_list.TagList"] = None,
    ) -> "capo_codestar_connections.types.create_repository_link_output.CreateRepositoryLinkOutput":
        ...
        Raises:
            capo_codestar_connections.errors.access_denied_exception.AccessDeniedException: <p>You do not have sufficient access to perform this action.</p>
            capo_codestar_connections.errors.concurrent_modification_exception.ConcurrentModificationException: <p>Exception thrown as a result of concurrent modification to an application. For example, two individuals attempting to edit the same application at the same time. </p>
            capo_codestar_connections.errors.internal_server_exception.InternalServerException: <p>Received an internal server exception. Try again later.</p>
            capo_codestar_connections.errors.invalid_input_exception.InvalidInputException: <p>The input is not valid. Verify that the action is typed correctly.</p>
            capo_codestar_connections.errors.limit_exceeded_exception.LimitExceededException: <p>Exceeded the maximum limit for connections.</p>
            capo_codestar_connections.errors.resource_already_exists_exception.ResourceAlreadyExistsException: <p>Unable to create resource. Resource already exists.</p>
            capo_codestar_connections.errors.throttling_exception.ThrottlingException: <p>The request was denied due to request throttling.</p>
            capo_codestar_connections.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.create_repository_link_input.CreateRepositoryLinkInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.create_repository_link_output.CreateRepositoryLinkOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.create_repository_link

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.create_repository_link.async_create_repository_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_sync_configuration(
        ...
        config_file: "capo_codestar_connections.types.deployment_file_path.DeploymentFilePath",
        ...
        *,
    ...
    ) -> "capo_codestar_connections.types.create_sync_configuration_output.CreateSyncConfigurationOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.create_sync_configuration_input.CreateSyncConfigurationInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.create_sync_configuration_output.CreateSyncConfigurationOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.create_sync_configuration

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.create_sync_configuration.async_create_sync_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_connection(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.delete_connection_output.DeleteConnectionOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.delete_connection_input.DeleteConnectionInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.delete_connection_output.DeleteConnectionOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.delete_connection

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.delete_connection.async_delete_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_host(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.delete_host_output.DeleteHostOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.delete_host_input.DeleteHostInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.delete_host_output.DeleteHostOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.delete_host

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.delete_host.async_delete_host(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_repository_link(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.delete_repository_link_output.DeleteRepositoryLinkOutput":
        ...
        Raises:
            ...
            capo_codestar_connections.errors.invalid_input_exception.InvalidInputException: <p>The input is not valid. Verify that the action is typed correctly.</p>
            capo_codestar_connections.errors.resource_not_found_exception.ResourceNotFoundException: <p>Resource not found. Verify the connection resource ARN and try again.</p>
            capo_codestar_connections.errors.sync_configuration_still_exists_exception.SyncConfigurationStillExistsException: <p>Unable to continue. The sync blocker still exists.</p>
            capo_codestar_connections.errors.throttling_exception.ThrottlingException: <p>The request was denied due to request throttling.</p>
            capo_codestar_connections.errors.unsupported_provider_type_exception.UnsupportedProviderTypeException: <p>The specified provider type is not supported for connections.</p>
            capo_codestar_connections.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.delete_repository_link_input.DeleteRepositoryLinkInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.delete_repository_link_output.DeleteRepositoryLinkOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.delete_repository_link

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.delete_repository_link.async_delete_repository_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_sync_configuration(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.delete_sync_configuration_output.DeleteSyncConfigurationOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.delete_sync_configuration_input.DeleteSyncConfigurationInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.delete_sync_configuration_output.DeleteSyncConfigurationOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.delete_sync_configuration

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.delete_sync_configuration.async_delete_sync_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_connection(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.get_connection_output.GetConnectionOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.get_connection_input.GetConnectionInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.get_connection_output.GetConnectionOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.get_connection

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.get_connection.async_get_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_host(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.get_host_output.GetHostOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.get_host_input.GetHostInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.get_host_output.GetHostOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.get_host

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.get_host.async_get_host(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_repository_link(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.get_repository_link_output.GetRepositoryLinkOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.get_repository_link_input.GetRepositoryLinkInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.get_repository_link_output.GetRepositoryLinkOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.get_repository_link

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.get_repository_link.async_get_repository_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_repository_sync_status(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.get_repository_sync_status_output.GetRepositorySyncStatusOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.get_repository_sync_status_input.GetRepositorySyncStatusInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.get_repository_sync_status_output.GetRepositorySyncStatusOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.get_repository_sync_status

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.get_repository_sync_status.async_get_repository_sync_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_sync_status(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.get_resource_sync_status_output.GetResourceSyncStatusOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.get_resource_sync_status_input.GetResourceSyncStatusInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.get_resource_sync_status_output.GetResourceSyncStatusOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.get_resource_sync_status

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.get_resource_sync_status.async_get_resource_sync_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sync_blocker_summary(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.get_sync_blocker_summary_output.GetSyncBlockerSummaryOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.get_sync_blocker_summary_input.GetSyncBlockerSummaryInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.get_sync_blocker_summary_output.GetSyncBlockerSummaryOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.get_sync_blocker_summary

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.get_sync_blocker_summary.async_get_sync_blocker_summary(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sync_configuration(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.get_sync_configuration_output.GetSyncConfigurationOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.get_sync_configuration_input.GetSyncConfigurationInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.get_sync_configuration_output.GetSyncConfigurationOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.get_sync_configuration

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.get_sync_configuration.async_get_sync_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_connections(
        ...
        *,
        ...
        "capo_codestar_connections.types.list_connections_output.ListConnectionsOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.list_connections_input.ListConnectionsInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.list_connections_output.ListConnectionsOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.list_connections

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.list_connections.async_list_connections(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_hosts(
        ...
        *,
    ...
    ) -> "capo_codestar_connections.types.list_hosts_output.ListHostsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.list_hosts_input.ListHostsInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.list_hosts_output.ListHostsOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.list_hosts

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.list_hosts.async_list_hosts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_repository_links(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.list_repository_links_input.ListRepositoryLinksInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.list_repository_links_output.ListRepositoryLinksOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.list_repository_links

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.list_repository_links.async_list_repository_links(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_repository_sync_definitions(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.list_repository_sync_definitions_output.ListRepositorySyncDefinitionsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.list_repository_sync_definitions_input.ListRepositorySyncDefinitionsInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.list_repository_sync_definitions_output.ListRepositorySyncDefinitionsOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.list_repository_sync_definitions

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.list_repository_sync_definitions.async_list_repository_sync_definitions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_sync_configurations(
        ...
        *,
    ...
    ) -> "capo_codestar_connections.types.list_sync_configurations_output.ListSyncConfigurationsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.list_sync_configurations_input.ListSyncConfigurationsInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.list_sync_configurations_output.ListSyncConfigurationsOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.list_sync_configurations

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.list_sync_configurations.async_list_sync_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        self,
        resource_arn: "capo_codestar_connections.types.amazon_resource_name.AmazonResourceName",
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.list_tags_for_resource

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        self,
        resource_arn: "capo_codestar_connections.types.amazon_resource_name.AmazonResourceName",
        tags: "capo_codestar_connections.types.tag_list.TagList",
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.tag_resource_output.TagResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.tag_resource_output.TagResourceOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.tag_resource

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.untag_resource_output.UntagResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.untag_resource_output.UntagResourceOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.untag_resource

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_host(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
        provider_endpoint: Optional["capo_codestar_connections.types.url.Url"] = None,
        vpc_configuration: Optional[
            "capo_codestar_connections.types.vpc_configuration.VpcConfiguration"
        ] = None,
    ) -> "capo_codestar_connections.types.update_host_output.UpdateHostOutput":
        ...
        Raises:
            capo_codestar_connections.errors.conflict_exception.ConflictException: <p>Two conflicting operations have been made on the same resource.</p>
            capo_codestar_connections.errors.resource_not_found_exception.ResourceNotFoundException: <p>Resource not found. Verify the connection resource ARN and try again.</p>
            capo_codestar_connections.errors.resource_unavailable_exception.ResourceUnavailableException: <p>Resource not found. Verify the ARN for the host resource and try again.</p>
            capo_codestar_connections.errors.unsupported_operation_exception.UnsupportedOperationException: <p>The operation is not supported. Check the connection status and try again.</p>
            capo_codestar_connections.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.update_host_input.UpdateHostInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.update_host_output.UpdateHostOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.update_host

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.update_host.async_update_host(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_repository_link(
        ...
        *,
        ...
        connection_arn: Optional[
            "capo_codestar_connections.types.connection_arn.ConnectionArn"
        ] = None,
        encryption_key_arn: Optional[
            "capo_codestar_connections.types.kms_key_arn.KmsKeyArn"
        ] = None,
    ) -> "capo_codestar_connections.types.update_repository_link_output.UpdateRepositoryLinkOutput":
        ...
        Raises:
            capo_codestar_connections.errors.access_denied_exception.AccessDeniedException: <p>You do not have sufficient access to perform this action.</p>
            capo_codestar_connections.errors.conditional_check_failed_exception.ConditionalCheckFailedException: <p>The conditional check failed. Try again later.</p>
            capo_codestar_connections.errors.internal_server_exception.InternalServerException: <p>Received an internal server exception. Try again later.</p>
            capo_codestar_connections.errors.invalid_input_exception.InvalidInputException: <p>The input is not valid. Verify that the action is typed correctly.</p>
            capo_codestar_connections.errors.resource_not_found_exception.ResourceNotFoundException: <p>Resource not found. Verify the connection resource ARN and try again.</p>
            capo_codestar_connections.errors.throttling_exception.ThrottlingException: <p>The request was denied due to request throttling.</p>
            capo_codestar_connections.errors.update_out_of_sync_exception.UpdateOutOfSyncException: <p>The update is out of sync. Try syncing again.</p>
            capo_codestar_connections.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.update_repository_link_input.UpdateRepositoryLinkInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.update_repository_link_output.UpdateRepositoryLinkOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.update_repository_link

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.update_repository_link.async_update_repository_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sync_blocker(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
    ) -> "capo_codestar_connections.types.update_sync_blocker_output.UpdateSyncBlockerOutput":
        ...
        Raises:
            ...
            capo_codestar_connections.errors.invalid_input_exception.InvalidInputException: <p>The input is not valid. Verify that the action is typed correctly.</p>
            capo_codestar_connections.errors.resource_not_found_exception.ResourceNotFoundException: <p>Resource not found. Verify the connection resource ARN and try again.</p>
            capo_codestar_connections.errors.retry_latest_commit_failed_exception.RetryLatestCommitFailedException: <p>Retrying the latest commit failed. Try again later.</p>
            capo_codestar_connections.errors.sync_blocker_does_not_exist_exception.SyncBlockerDoesNotExistException: <p>Unable to continue. The sync blocker does not exist.</p>
            capo_codestar_connections.errors.throttling_exception.ThrottlingException: <p>The request was denied due to request throttling.</p>
            capo_codestar_connections.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.update_sync_blocker_input.UpdateSyncBlockerInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.update_sync_blocker_output.UpdateSyncBlockerOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.update_sync_blocker

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.update_sync_blocker.async_update_sync_blocker(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sync_configuration(
        ...
        *,
        config_overrides: Optional[AsyncCodeStarconnectionsClientConfig] = None,
        branch: Optional[
            "capo_codestar_connections.types.branch_name.BranchName"
        ] = None,
        ...
        role_arn: Optional[
            "capo_codestar_connections.types.iam_role_arn.IamRoleArn"
        ] = None,
        publish_deployment_status: Optional[
            "capo_codestar_connections.types.publish_deployment_status.PublishDeploymentStatus"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_connections.types.update_sync_configuration_input.UpdateSyncConfigurationInput]",
        ) -> AsyncOperationResponse[
            "capo_codestar_connections.types.update_sync_configuration_output.UpdateSyncConfigurationOutput"
        ]:
            import capo_codestar_connections._operations.code_star_connections_20191201.update_sync_configuration

            (
                output,
                http_response,
            ) = await capo_codestar_connections._operations.code_star_connections_20191201.update_sync_configuration.async_update_sync_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
