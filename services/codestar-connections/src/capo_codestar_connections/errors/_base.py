...
class CodeStarconnectionsError(Exception):
    """Base class for all CodeStarconnections service errors."""


class ServiceError(CodeStarconnectionsError):
...
class SerializationError(CodeStarconnectionsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CodeStarconnectionsError):
...
class WaiterFailedError(CodeStarconnectionsError):
...
class WaiterTimeoutError(CodeStarconnectionsError):
