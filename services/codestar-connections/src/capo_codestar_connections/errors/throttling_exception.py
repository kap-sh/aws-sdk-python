"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarconnections#ThrottlingException``."""
