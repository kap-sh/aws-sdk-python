"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarconnections#ConflictException``."""
