"""Generated from Smithy shape ``com.amazonaws.codestarconnections#SyncConfigurationStillExistsException``."""
...
class SyncConfigurationStillExistsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarconnections#SyncConfigurationStillExistsException``."""
