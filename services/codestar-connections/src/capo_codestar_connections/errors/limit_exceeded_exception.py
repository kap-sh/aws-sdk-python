"""Generated from Smithy shape ``com.amazonaws.codestarconnections#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarconnections#LimitExceededException``."""
