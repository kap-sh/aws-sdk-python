"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ConditionalCheckFailedException``."""
...
class ConditionalCheckFailedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarconnections#ConditionalCheckFailedException``."""
