"""Generated from Smithy shape ``com.amazonaws.codestarconnections#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarconnections#InternalServerException``."""
