"""Generated from Smithy shape ``com.amazonaws.codestarconnections#GetResourceSyncStatus``."""
...
def handle_response(
    ...
    out: capo_codestar_connections.types.get_resource_sync_status_output.GetResourceSyncStatusOutput = capo_codestar_connections.types.get_resource_sync_status_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.GetResourceSyncStatus"
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.get_resource_sync_status_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
