"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ListRepositorySyncDefinitions``."""
...
import capo_codestar_connections.types.repository_sync_definition_list
...
def handle_response(
    ...
    out: capo_codestar_connections.types.list_repository_sync_definitions_output.ListRepositorySyncDefinitionsOutput = capo_codestar_connections.types.list_repository_sync_definitions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.list_repository_sync_definitions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
