"""Generated from Smithy shape ``com.amazonaws.codestarconnections#TagResource``."""
...
def handle_response(
    ...
    out: capo_codestar_connections.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.TagResource"
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.tag_resource_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
