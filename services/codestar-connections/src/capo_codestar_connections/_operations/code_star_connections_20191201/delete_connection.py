"""Generated from Smithy shape ``com.amazonaws.codestarconnections#DeleteConnection``."""
...
def handle_response(
    ...
    out: capo_codestar_connections.types.delete_connection_output.DeleteConnectionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.delete_connection_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
