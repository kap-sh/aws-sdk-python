"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ListConnections``."""
...
import capo_codestar_connections.types.connection_list
...
def handle_response(
    ...
    out: capo_codestar_connections.types.list_connections_output.ListConnectionsOutput = capo_codestar_connections.types.list_connections_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.list_connections_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
