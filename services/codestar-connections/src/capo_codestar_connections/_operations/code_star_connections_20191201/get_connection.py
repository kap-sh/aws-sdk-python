"""Generated from Smithy shape ``com.amazonaws.codestarconnections#GetConnection``."""
...
def handle_response(
    ...
    out: capo_codestar_connections.types.get_connection_output.GetConnectionOutput = (
        capo_codestar_connections.types.get_connection_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.get_connection_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
