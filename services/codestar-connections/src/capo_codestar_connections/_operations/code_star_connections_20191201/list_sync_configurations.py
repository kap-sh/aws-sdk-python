"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ListSyncConfigurations``."""
...
def handle_response(
    ...
    out: capo_codestar_connections.types.list_sync_configurations_output.ListSyncConfigurationsOutput = capo_codestar_connections.types.list_sync_configurations_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.list_sync_configurations_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_sync_configurations(
