"""Generated from Smithy shape ``com.amazonaws.codestarconnections#CreateConnection``."""
...
def handle_response(
    ...
    out: capo_codestar_connections.types.create_connection_output.CreateConnectionOutput = capo_codestar_connections.types.create_connection_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.create_connection_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
