"""Generated from Smithy shape ``com.amazonaws.codestarconnections#UpdateRepositoryLink``."""
...
import capo_codestar_connections.errors.conditional_check_failed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConditionalCheckFailedException":
            raise capo_codestar_connections.errors.conditional_check_failed_exception.ConditionalCheckFailedException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_codestar_connections.types.update_repository_link_output.UpdateRepositoryLinkOutput = capo_codestar_connections.types.update_repository_link_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.UpdateRepositoryLink"
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.update_repository_link_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_repository_link(
