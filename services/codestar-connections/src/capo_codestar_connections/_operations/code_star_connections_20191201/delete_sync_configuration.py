"""Generated from Smithy shape ``com.amazonaws.codestarconnections#DeleteSyncConfiguration``."""
...
def handle_response(
    ...
    out: capo_codestar_connections.types.delete_sync_configuration_output.DeleteSyncConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.delete_sync_configuration_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
