...
def handle_response(
    ...
    out: capo_codestar_connections.types.get_repository_link_output.GetRepositoryLinkOutput = capo_codestar_connections.types.get_repository_link_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.get_repository_link_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
