...
def handle_response(
    ...
    out: capo_codestar_connections.types.list_repository_links_output.ListRepositoryLinksOutput = capo_codestar_connections.types.list_repository_links_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.list_repository_links_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
