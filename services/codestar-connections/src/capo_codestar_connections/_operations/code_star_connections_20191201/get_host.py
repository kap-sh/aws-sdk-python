"""Generated from Smithy shape ``com.amazonaws.codestarconnections#GetHost``."""
...
def handle_response(
    ...
    out: capo_codestar_connections.types.get_host_output.GetHostOutput = (
        capo_codestar_connections.types.get_host_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.GetHost"
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.get_host_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_host(
    ...
    capo_codestar_connections.types.get_host_output.GetHostOutput, zapros.Response
]:
