...
import capo_codestar_connections.errors.limit_exceeded_exception
import capo_codestar_connections.errors.resource_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_codestar_connections.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_0(
                data
            )
        case "ResourceAlreadyExistsException":
            raise capo_codestar_connections.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_codestar_connections.types.create_repository_link_output.CreateRepositoryLinkOutput = capo_codestar_connections.types.create_repository_link_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.create_repository_link_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
