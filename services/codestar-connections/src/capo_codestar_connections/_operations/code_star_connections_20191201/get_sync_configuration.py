"""Generated from Smithy shape ``com.amazonaws.codestarconnections#GetSyncConfiguration``."""
...
def handle_response(
    ...
    out: capo_codestar_connections.types.get_sync_configuration_output.GetSyncConfigurationOutput = capo_codestar_connections.types.get_sync_configuration_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.GetSyncConfiguration"
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.get_sync_configuration_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
