"""Generated from Smithy shape ``com.amazonaws.codestarconnections#DeleteHost``."""
...
def handle_response(
    ...
    out: capo_codestar_connections.types.delete_host_output.DeleteHostOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.DeleteHost"
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.delete_host_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_host(
    ...
    capo_codestar_connections.types.delete_host_output.DeleteHostOutput, zapros.Response
]:
