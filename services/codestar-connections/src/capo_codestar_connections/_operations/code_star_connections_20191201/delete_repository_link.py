"""Generated from Smithy shape ``com.amazonaws.codestarconnections#DeleteRepositoryLink``."""
...
import capo_codestar_connections.errors.sync_configuration_still_exists_exception
import capo_codestar_connections.errors.throttling_exception
import capo_codestar_connections.errors.unsupported_provider_type_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SyncConfigurationStillExistsException":
            raise capo_codestar_connections.errors.sync_configuration_still_exists_exception.SyncConfigurationStillExistsException.from_aws_json_1_0(
                data
            )
        ...
        case "UnsupportedProviderTypeException":
            raise capo_codestar_connections.errors.unsupported_provider_type_exception.UnsupportedProviderTypeException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_codestar_connections.types.delete_repository_link_output.DeleteRepositoryLinkOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.DeleteRepositoryLink"
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.delete_repository_link_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_repository_link(
