...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RetryLatestCommitFailedException":
            import aws_sdk_codestar_connections.errors.retry_latest_commit_failed_exception

            raise aws_sdk_codestar_connections.errors.retry_latest_commit_failed_exception.RetryLatestCommitFailedException.from_aws_json_1_0(
                data
            )
        case "SyncBlockerDoesNotExistException":
            import aws_sdk_codestar_connections.errors.sync_blocker_does_not_exist_exception

            raise aws_sdk_codestar_connections.errors.sync_blocker_does_not_exist_exception.SyncBlockerDoesNotExistException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.update_sync_blocker_output.UpdateSyncBlockerOutput = aws_sdk_codestar_connections.types.update_sync_blocker_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.update_sync_blocker_input.UpdateSyncBlockerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.update_sync_blocker_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
