...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.get_host_output.GetHostOutput = (
        aws_sdk_codestar_connections.types.get_host_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.get_host_input.GetHostInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.get_host_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_host(
    ...
    aws_sdk_codestar_connections.types.get_host_output.GetHostOutput, zapros.Response
]:
