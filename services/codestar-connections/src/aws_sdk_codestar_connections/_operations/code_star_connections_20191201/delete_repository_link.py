...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SyncConfigurationStillExistsException":
            import aws_sdk_codestar_connections.errors.sync_configuration_still_exists_exception

            raise aws_sdk_codestar_connections.errors.sync_configuration_still_exists_exception.SyncConfigurationStillExistsException.from_aws_json_1_0(
                data
            )
        ...
        case "UnsupportedProviderTypeException":
            import aws_sdk_codestar_connections.errors.unsupported_provider_type_exception

            raise aws_sdk_codestar_connections.errors.unsupported_provider_type_exception.UnsupportedProviderTypeException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.delete_repository_link_output.DeleteRepositoryLinkOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.delete_repository_link_input.DeleteRepositoryLinkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.delete_repository_link_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
