"""Generated from Smithy shape ``com.amazonaws.codestarconnections#CreateHost``."""
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.create_host_output.CreateHostOutput = (
        aws_sdk_codestar_connections.types.create_host_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.create_host_input.CreateHostInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.CreateHost"
    import aws_sdk_codestar_connections.types.create_host_input

    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.create_host_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
