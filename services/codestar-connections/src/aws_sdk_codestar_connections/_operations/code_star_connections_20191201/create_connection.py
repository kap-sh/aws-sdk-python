...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceUnavailableException":
            import aws_sdk_codestar_connections.errors.resource_unavailable_exception

            raise aws_sdk_codestar_connections.errors.resource_unavailable_exception.ResourceUnavailableException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.create_connection_output.CreateConnectionOutput = aws_sdk_codestar_connections.types.create_connection_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.create_connection_input.CreateConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.create_connection_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
