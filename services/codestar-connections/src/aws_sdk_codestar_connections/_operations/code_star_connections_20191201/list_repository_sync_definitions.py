...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.list_repository_sync_definitions_output.ListRepositorySyncDefinitionsOutput = aws_sdk_codestar_connections.types.list_repository_sync_definitions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.list_repository_sync_definitions_input.ListRepositorySyncDefinitionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
