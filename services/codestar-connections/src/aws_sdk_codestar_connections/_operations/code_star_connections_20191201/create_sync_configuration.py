"""Generated from Smithy shape ``com.amazonaws.codestarconnections#CreateSyncConfiguration``."""
...
import aws_sdk_codestar_connections.errors.concurrent_modification_exception
...
import aws_sdk_codestar_connections.errors.limit_exceeded_exception
import aws_sdk_codestar_connections.errors.resource_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConcurrentModificationException":
            raise aws_sdk_codestar_connections.errors.concurrent_modification_exception.ConcurrentModificationException.from_aws_json_1_0(
                data
            )
        ...
        case "LimitExceededException":
            raise aws_sdk_codestar_connections.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_0(
                data
            )
        case "ResourceAlreadyExistsException":
            raise aws_sdk_codestar_connections.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.create_sync_configuration_output.CreateSyncConfigurationOutput = aws_sdk_codestar_connections.types.create_sync_configuration_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.create_sync_configuration_input.CreateSyncConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.CreateSyncConfiguration"
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.create_sync_configuration_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
