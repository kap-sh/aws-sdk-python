"""Generated from Smithy shape ``com.amazonaws.codestarconnections#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.UntagResource"
    import aws_sdk_codestar_connections.types.untag_resource_input

    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.untag_resource_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
