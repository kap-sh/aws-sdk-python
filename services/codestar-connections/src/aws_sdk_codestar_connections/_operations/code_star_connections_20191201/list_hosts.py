...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.list_hosts_output.ListHostsOutput = (
        aws_sdk_codestar_connections.types.list_hosts_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.list_hosts_input.ListHostsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.list_hosts_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
