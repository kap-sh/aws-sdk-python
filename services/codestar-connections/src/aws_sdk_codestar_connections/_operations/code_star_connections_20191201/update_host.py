...
import aws_sdk_codestar_connections.errors.conflict_exception
...
import aws_sdk_codestar_connections.errors.unsupported_operation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise aws_sdk_codestar_connections.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "UnsupportedOperationException":
            raise aws_sdk_codestar_connections.errors.unsupported_operation_exception.UnsupportedOperationException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.update_host_output.UpdateHostOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.update_host_input.UpdateHostInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.update_host_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
