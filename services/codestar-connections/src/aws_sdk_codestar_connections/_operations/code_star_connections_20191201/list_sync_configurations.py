...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.list_sync_configurations_output.ListSyncConfigurationsOutput = aws_sdk_codestar_connections.types.list_sync_configurations_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.list_sync_configurations_input.ListSyncConfigurationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
