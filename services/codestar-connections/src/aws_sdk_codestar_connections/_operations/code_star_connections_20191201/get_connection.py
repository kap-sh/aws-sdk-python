...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.get_connection_output.GetConnectionOutput = aws_sdk_codestar_connections.types.get_connection_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.get_connection_input.GetConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.get_connection_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
