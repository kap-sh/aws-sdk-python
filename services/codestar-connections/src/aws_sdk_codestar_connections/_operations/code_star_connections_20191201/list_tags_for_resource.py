"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ListTagsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.list_tags_for_resource_output.ListTagsForResourceOutput = aws_sdk_codestar_connections.types.list_tags_for_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.list_tags_for_resource_input.ListTagsForResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.ListTagsForResource"
    import aws_sdk_codestar_connections.types.list_tags_for_resource_input

    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.list_tags_for_resource_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
