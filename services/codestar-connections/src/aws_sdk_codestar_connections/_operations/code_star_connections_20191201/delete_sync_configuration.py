...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.delete_sync_configuration_output.DeleteSyncConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.delete_sync_configuration_input.DeleteSyncConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
