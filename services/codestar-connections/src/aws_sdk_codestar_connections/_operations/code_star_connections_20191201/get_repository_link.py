"""Generated from Smithy shape ``com.amazonaws.codestarconnections#GetRepositoryLink``."""
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.get_repository_link_output.GetRepositoryLinkOutput = aws_sdk_codestar_connections.types.get_repository_link_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.get_repository_link_input.GetRepositoryLinkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.GetRepositoryLink"
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.get_repository_link_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
