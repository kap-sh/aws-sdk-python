...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConditionalCheckFailedException":
            import aws_sdk_codestar_connections.errors.conditional_check_failed_exception

            raise aws_sdk_codestar_connections.errors.conditional_check_failed_exception.ConditionalCheckFailedException.from_aws_json_1_0(
                data
            )
        ...
        case "UpdateOutOfSyncException":
            import aws_sdk_codestar_connections.errors.update_out_of_sync_exception

            raise aws_sdk_codestar_connections.errors.update_out_of_sync_exception.UpdateOutOfSyncException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.update_repository_link_output.UpdateRepositoryLinkOutput = aws_sdk_codestar_connections.types.update_repository_link_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.update_repository_link_input.UpdateRepositoryLinkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.update_repository_link_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
