...
import aws_sdk_codestar_connections.types.connection_list
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.list_connections_output.ListConnectionsOutput = aws_sdk_codestar_connections.types.list_connections_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.list_connections_input.ListConnectionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.list_connections_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
