"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ListRepositoryLinks``."""
...
import aws_sdk_codestar_connections.types.repository_link_list
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.list_repository_links_output.ListRepositoryLinksOutput = aws_sdk_codestar_connections.types.list_repository_links_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.list_repository_links_input.ListRepositoryLinksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.ListRepositoryLinks"
    import aws_sdk_codestar_connections.types.list_repository_links_input

    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.list_repository_links_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_repository_links(
