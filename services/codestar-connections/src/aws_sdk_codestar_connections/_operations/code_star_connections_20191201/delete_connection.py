...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.delete_connection_output.DeleteConnectionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.delete_connection_input.DeleteConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.delete_connection_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
