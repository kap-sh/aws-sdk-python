"""Generated from Smithy shape ``com.amazonaws.codestarconnections#GetRepositorySyncStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_codestar_connections.types.get_repository_sync_status_output.GetRepositorySyncStatusOutput = aws_sdk_codestar_connections.types.get_repository_sync_status_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codestar_connections.types.get_repository_sync_status_input.GetRepositorySyncStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeStar_connections_20191201.GetRepositorySyncStatus"
    body: bytes | None = json.dumps(
        aws_sdk_codestar_connections.types.get_repository_sync_status_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
