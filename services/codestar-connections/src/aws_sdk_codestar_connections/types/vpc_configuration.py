...
if TYPE_CHECKING:
    import aws_sdk_codestar_connections.types.security_group_ids
    import aws_sdk_codestar_connections.types.subnet_ids
    import aws_sdk_codestar_connections.types.tls_certificate
...
class VpcConfiguration(TypedDict, closed=True):
    ...
    security_group_ids: (
        "aws_sdk_codestar_connections.types.security_group_ids.SecurityGroupIds"
    )
    ...
    tls_certificate: NotRequired[
        "aws_sdk_codestar_connections.types.tls_certificate.TlsCertificate"
    ]
...
def serialize_aws_json_1_0(value: VpcConfiguration) -> dict:
    ...
    out["SubnetIds"] = (
        aws_sdk_codestar_connections.types.subnet_ids.serialize_aws_json_1_0(
            value["subnet_ids"]
        )
    )
    import aws_sdk_codestar_connections.types.security_group_ids
    ...
    out["SecurityGroupIds"] = (
        aws_sdk_codestar_connections.types.security_group_ids.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> VpcConfiguration:
    ...
    if "SubnetIds" in data:
        ...
        out["subnet_ids"] = (
            aws_sdk_codestar_connections.types.subnet_ids.deserialize_aws_json_1_0(
                data["SubnetIds"]
            )
        )
    else:
    ...
    if "SecurityGroupIds" in data:
        ...
        out["security_group_ids"] = (
            aws_sdk_codestar_connections.types.security_group_ids.deserialize_aws_json_1_0(
