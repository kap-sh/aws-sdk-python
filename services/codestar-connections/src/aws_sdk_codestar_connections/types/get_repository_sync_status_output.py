...
def serialize_aws_json_1_0(value: GetRepositorySyncStatusOutput) -> dict:
    ...
    out["LatestSync"] = (
        aws_sdk_codestar_connections.types.repository_sync_attempt.serialize_aws_json_1_0(
            value["latest_sync"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> GetRepositorySyncStatusOutput:
    ...
    if "LatestSync" in data:
        ...
        out["latest_sync"] = (
            aws_sdk_codestar_connections.types.repository_sync_attempt.deserialize_aws_json_1_0(
                data["LatestSync"]
            )
        )
    else:
