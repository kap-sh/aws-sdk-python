...
class ListRepositoryLinksOutput(TypedDict, closed=True):
    repository_links: (
        "aws_sdk_codestar_connections.types.repository_link_list.RepositoryLinkList"
    )
...
def serialize_aws_json_1_0(value: ListRepositoryLinksOutput) -> dict:
    ...
    out["RepositoryLinks"] = (
        aws_sdk_codestar_connections.types.repository_link_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListRepositoryLinksOutput:
    ...
    if "RepositoryLinks" in data:
        ...
        out["repository_links"] = (
            aws_sdk_codestar_connections.types.repository_link_list.deserialize_aws_json_1_0(
