...
class ListConnectionsOutput(TypedDict, closed=True):
    connections: NotRequired[
        "aws_sdk_codestar_connections.types.connection_list.ConnectionList"
    ]
...
def serialize_aws_json_1_0(value: ListConnectionsOutput) -> dict:
    ...
    if "connections" in value:
        ...
        out["Connections"] = (
            aws_sdk_codestar_connections.types.connection_list.serialize_aws_json_1_0(
                value["connections"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListConnectionsOutput:
    ...
    if "Connections" in data:
        ...
        out["connections"] = (
            aws_sdk_codestar_connections.types.connection_list.deserialize_aws_json_1_0(
                data["Connections"]
            )
        )
