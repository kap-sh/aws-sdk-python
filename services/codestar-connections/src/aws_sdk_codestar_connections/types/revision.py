"""Generated from Smithy shape ``com.amazonaws.codestarconnections#Revision``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_codestar_connections.types.directory
...
class Revision(TypedDict):
    ...
    sha: "aws_sdk_codestar_connections.types.sha.SHA"
