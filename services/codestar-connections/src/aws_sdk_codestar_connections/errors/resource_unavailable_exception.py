"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ResourceUnavailableException``."""
...
class ResourceUnavailableException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarconnections#ResourceUnavailableException``."""
