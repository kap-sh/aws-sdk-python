"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ResourceAlreadyExistsException``."""
...
class ResourceAlreadyExistsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarconnections#ResourceAlreadyExistsException``."""
