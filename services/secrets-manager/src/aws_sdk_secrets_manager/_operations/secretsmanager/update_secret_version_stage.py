...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.update_secret_version_stage_response.UpdateSecretVersionStageResponse = aws_sdk_secrets_manager.types.update_secret_version_stage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.update_secret_version_stage_request.UpdateSecretVersionStageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.update_secret_version_stage_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
