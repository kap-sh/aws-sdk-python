...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.list_secrets_response.ListSecretsResponse = (
        aws_sdk_secrets_manager.types.list_secrets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.list_secrets_request.ListSecretsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.list_secrets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
