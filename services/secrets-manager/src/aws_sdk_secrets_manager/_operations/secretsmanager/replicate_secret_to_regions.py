...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.replicate_secret_to_regions_response.ReplicateSecretToRegionsResponse = aws_sdk_secrets_manager.types.replicate_secret_to_regions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.replicate_secret_to_regions_request.ReplicateSecretToRegionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "secretsmanager.ReplicateSecretToRegions"
    import aws_sdk_secrets_manager.types.replicate_secret_to_regions_request

    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.replicate_secret_to_regions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
