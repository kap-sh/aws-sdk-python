...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.get_secret_value_response.GetSecretValueResponse = aws_sdk_secrets_manager.types.get_secret_value_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.get_secret_value_request.GetSecretValueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.get_secret_value_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
