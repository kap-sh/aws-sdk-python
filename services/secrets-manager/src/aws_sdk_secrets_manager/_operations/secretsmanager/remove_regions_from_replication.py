...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.remove_regions_from_replication_response.RemoveRegionsFromReplicationResponse = aws_sdk_secrets_manager.types.remove_regions_from_replication_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.remove_regions_from_replication_request.RemoveRegionsFromReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "secretsmanager.RemoveRegionsFromReplication"
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.remove_regions_from_replication_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
