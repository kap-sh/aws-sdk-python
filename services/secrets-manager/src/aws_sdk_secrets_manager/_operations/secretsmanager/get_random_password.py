...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.get_random_password_response.GetRandomPasswordResponse = aws_sdk_secrets_manager.types.get_random_password_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.get_random_password_request.GetRandomPasswordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.get_random_password_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
