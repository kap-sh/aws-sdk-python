"""Generated from Smithy shape ``com.amazonaws.secretsmanager#RotateSecret``."""
...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.rotate_secret_response.RotateSecretResponse = (
        aws_sdk_secrets_manager.types.rotate_secret_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.rotate_secret_request.RotateSecretRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.rotate_secret_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
