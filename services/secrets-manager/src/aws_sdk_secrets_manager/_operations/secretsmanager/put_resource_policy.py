...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PublicPolicyException":
            import aws_sdk_secrets_manager.errors.public_policy_exception

            raise aws_sdk_secrets_manager.errors.public_policy_exception.PublicPolicyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.put_resource_policy_response.PutResourcePolicyResponse = aws_sdk_secrets_manager.types.put_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.put_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
