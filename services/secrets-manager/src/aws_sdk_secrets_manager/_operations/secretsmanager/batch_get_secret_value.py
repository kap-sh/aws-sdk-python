...
import aws_sdk_secrets_manager.errors.invalid_next_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNextTokenException":
            raise aws_sdk_secrets_manager.errors.invalid_next_token_exception.InvalidNextTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.batch_get_secret_value_response.BatchGetSecretValueResponse = aws_sdk_secrets_manager.types.batch_get_secret_value_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.batch_get_secret_value_request.BatchGetSecretValueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.batch_get_secret_value_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
