...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.list_secret_version_ids_response.ListSecretVersionIdsResponse = aws_sdk_secrets_manager.types.list_secret_version_ids_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.list_secret_version_ids_request.ListSecretVersionIdsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.list_secret_version_ids_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
