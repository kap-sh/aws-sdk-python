...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.stop_replication_to_replica_response.StopReplicationToReplicaResponse = aws_sdk_secrets_manager.types.stop_replication_to_replica_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.stop_replication_to_replica_request.StopReplicationToReplicaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.stop_replication_to_replica_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
