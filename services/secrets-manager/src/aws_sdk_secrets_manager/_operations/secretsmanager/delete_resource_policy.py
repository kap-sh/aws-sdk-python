...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.delete_resource_policy_response.DeleteResourcePolicyResponse = aws_sdk_secrets_manager.types.delete_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.delete_resource_policy_request.DeleteResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.delete_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
