...
def handle_response(
    ...
    out: aws_sdk_secrets_manager.types.validate_resource_policy_response.ValidateResourcePolicyResponse = aws_sdk_secrets_manager.types.validate_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_secrets_manager.types.validate_resource_policy_request.ValidateResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "secretsmanager.ValidateResourcePolicy"
    import aws_sdk_secrets_manager.types.validate_resource_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_secrets_manager.types.validate_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
