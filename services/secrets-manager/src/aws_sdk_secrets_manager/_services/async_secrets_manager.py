...
class AsyncSecretsManagerClientConfig(TypedDict, total=False):
...
class AsyncSecretsManagerClient:
    ...
    async def batch_get_secret_value(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.batch_get_secret_value_request.BatchGetSecretValueRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.batch_get_secret_value_response.BatchGetSecretValueResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.batch_get_secret_value.async_batch_get_secret_value(
    ...
    async def cancel_rotate_secret(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.cancel_rotate_secret_request.CancelRotateSecretRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.cancel_rotate_secret_response.CancelRotateSecretResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.cancel_rotate_secret.async_cancel_rotate_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_secret(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.create_secret_request.CreateSecretRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.create_secret_response.CreateSecretResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.create_secret.async_create_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.delete_resource_policy_request.DeleteResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.delete_resource_policy_response.DeleteResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.delete_resource_policy.async_delete_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_secret(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.delete_secret_request.DeleteSecretRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.delete_secret_response.DeleteSecretResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.delete_secret.async_delete_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_secret(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.describe_secret_request.DescribeSecretRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.describe_secret_response.DescribeSecretResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.describe_secret.async_describe_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_random_password(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.get_random_password_request.GetRandomPasswordRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.get_random_password_response.GetRandomPasswordResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.get_random_password.async_get_random_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.get_resource_policy_request.GetResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.get_resource_policy_response.GetResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.get_resource_policy.async_get_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_secret_value(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.get_secret_value_request.GetSecretValueRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.get_secret_value_response.GetSecretValueResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.get_secret_value.async_get_secret_value(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_secrets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.list_secrets_request.ListSecretsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.list_secrets_response.ListSecretsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.list_secrets.async_list_secrets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_secret_version_ids(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.list_secret_version_ids_request.ListSecretVersionIdsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.list_secret_version_ids_response.ListSecretVersionIdsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.list_secret_version_ids.async_list_secret_version_ids(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.put_resource_policy_response.PutResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.put_resource_policy.async_put_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_secret_value(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.put_secret_value_request.PutSecretValueRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.put_secret_value_response.PutSecretValueResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.put_secret_value.async_put_secret_value(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_regions_from_replication(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.remove_regions_from_replication_request.RemoveRegionsFromReplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.remove_regions_from_replication_response.RemoveRegionsFromReplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.remove_regions_from_replication.async_remove_regions_from_replication(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def replicate_secret_to_regions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.replicate_secret_to_regions_request.ReplicateSecretToRegionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.replicate_secret_to_regions_response.ReplicateSecretToRegionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.replicate_secret_to_regions.async_replicate_secret_to_regions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def restore_secret(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.restore_secret_request.RestoreSecretRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.restore_secret_response.RestoreSecretResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.restore_secret.async_restore_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rotate_secret(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.rotate_secret_request.RotateSecretRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.rotate_secret_response.RotateSecretResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.rotate_secret.async_rotate_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_replication_to_replica(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.stop_replication_to_replica_request.StopReplicationToReplicaRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.stop_replication_to_replica_response.StopReplicationToReplicaResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.stop_replication_to_replica.async_stop_replication_to_replica(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.tag_resource_request.TagResourceRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_secret(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.update_secret_request.UpdateSecretRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.update_secret_response.UpdateSecretResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.update_secret.async_update_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_secret_version_stage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.update_secret_version_stage_request.UpdateSecretVersionStageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.update_secret_version_stage_response.UpdateSecretVersionStageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.update_secret_version_stage.async_update_secret_version_stage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_secrets_manager.types.validate_resource_policy_request.ValidateResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_secrets_manager.types.validate_resource_policy_response.ValidateResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_secrets_manager._operations.secretsmanager.validate_resource_policy.async_validate_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
