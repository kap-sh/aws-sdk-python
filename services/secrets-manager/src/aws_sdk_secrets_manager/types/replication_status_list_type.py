...
def serialize_aws_json_1_1(value: ReplicationStatusListType) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_secrets_manager.types.replication_status_type.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ReplicationStatusListType:
    ...
    for item in data:
        out.append(
            aws_sdk_secrets_manager.types.replication_status_type.deserialize_aws_json_1_1(
                item
            )
        )
    return out
