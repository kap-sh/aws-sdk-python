...
def serialize_aws_json_1_1(value: RemoveRegionsFromReplicationRequest) -> dict:
    ...
    out["RemoveReplicaRegions"] = (
        aws_sdk_secrets_manager.types.remove_replica_region_list_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RemoveRegionsFromReplicationRequest:
    ...
    if "RemoveReplicaRegions" in data:
        ...
        out["remove_replica_regions"] = (
            aws_sdk_secrets_manager.types.remove_replica_region_list_type.deserialize_aws_json_1_1(
