...
class SecretsManagerError(Exception):
    """Base class for all SecretsManager service errors."""


class ServiceError(SecretsManagerError):
...
class SerializationError(SecretsManagerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SecretsManagerError):
...
class WaiterFailedError(SecretsManagerError):
...
class WaiterTimeoutError(SecretsManagerError):
