...
```
pip install aws-sdk-opensearchserverless
```

## Usage

```python
from aws_sdk_opensearchserverless import AsyncOpenSearchServerlessClient
...
```python
from aws_sdk_opensearchserverless import AsyncOpenSearchServerlessClient
from aws_sdk_opensearchserverless.error import InternalServerException
