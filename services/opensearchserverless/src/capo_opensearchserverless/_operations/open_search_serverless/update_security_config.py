"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#UpdateSecurityConfig``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.update_security_config_response.UpdateSecurityConfigResponse = capo_opensearchserverless.types.update_security_config_response.deserialize_aws_json_1_0(
...
async def async_update_security_config(
