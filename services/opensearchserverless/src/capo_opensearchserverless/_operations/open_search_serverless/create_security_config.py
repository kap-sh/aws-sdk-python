"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#CreateSecurityConfig``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.create_security_config_response.CreateSecurityConfigResponse = capo_opensearchserverless.types.create_security_config_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.CreateSecurityConfig"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.create_security_config_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_security_config(
