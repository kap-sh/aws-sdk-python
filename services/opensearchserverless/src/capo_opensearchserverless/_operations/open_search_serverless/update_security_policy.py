"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#UpdateSecurityPolicy``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.update_security_policy_response.UpdateSecurityPolicyResponse = capo_opensearchserverless.types.update_security_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.UpdateSecurityPolicy"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.update_security_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_security_policy(
