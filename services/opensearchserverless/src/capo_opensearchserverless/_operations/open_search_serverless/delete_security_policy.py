"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#DeleteSecurityPolicy``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.delete_security_policy_response.DeleteSecurityPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.DeleteSecurityPolicy"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.delete_security_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_security_policy(
