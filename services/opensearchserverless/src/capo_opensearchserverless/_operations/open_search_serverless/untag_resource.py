"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#UntagResource``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.UntagResource"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.untag_resource_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
