"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#DeleteAccessPolicy``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.delete_access_policy_response.DeleteAccessPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.DeleteAccessPolicy"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.delete_access_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_access_policy(
