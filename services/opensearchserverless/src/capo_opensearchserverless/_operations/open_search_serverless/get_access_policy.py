"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#GetAccessPolicy``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.get_access_policy_response.GetAccessPolicyResponse = capo_opensearchserverless.types.get_access_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.GetAccessPolicy"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.get_access_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_access_policy(
