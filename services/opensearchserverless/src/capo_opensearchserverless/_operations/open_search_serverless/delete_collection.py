...
import capo_opensearchserverless.types.delete_collection_detail
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.delete_collection_response.DeleteCollectionResponse = capo_opensearchserverless.types.delete_collection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.delete_collection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
