"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#GetAccountSettings``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.get_account_settings_response.GetAccountSettingsResponse = capo_opensearchserverless.types.get_account_settings_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.GetAccountSettings"
    body: bytes | None = b""
