"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#DeleteLifecyclePolicy``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.DeleteLifecyclePolicy"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.delete_lifecycle_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
