"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#UpdateVpcEndpoint``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.update_vpc_endpoint_response.UpdateVpcEndpointResponse = capo_opensearchserverless.types.update_vpc_endpoint_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.UpdateVpcEndpoint"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.update_vpc_endpoint_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
