"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#ListVpcEndpoints``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.list_vpc_endpoints_response.ListVpcEndpointsResponse = capo_opensearchserverless.types.list_vpc_endpoints_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.ListVpcEndpoints"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.list_vpc_endpoints_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
