"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#ListLifecyclePolicies``."""
...
import capo_opensearchserverless.types.lifecycle_policy_summaries
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.list_lifecycle_policies_response.ListLifecyclePoliciesResponse = capo_opensearchserverless.types.list_lifecycle_policies_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.ListLifecyclePolicies"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.list_lifecycle_policies_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_lifecycle_policies(
