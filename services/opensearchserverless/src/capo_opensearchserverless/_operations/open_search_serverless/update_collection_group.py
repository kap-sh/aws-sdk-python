"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#UpdateCollectionGroup``."""
...
import capo_opensearchserverless.errors.service_quota_exceeded_exception
import capo_opensearchserverless.errors.validation_exception
...
from capo_opensearchserverless._protocol.errors import parse_error_metadata_json
from capo_opensearchserverless._rule_engine._endpoint_rule_set import (
    EndpointParams,
    resolve,
)
...
from capo_opensearchserverless.errors import UnknownServiceError
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_opensearchserverless.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.update_collection_group_response.UpdateCollectionGroupResponse = capo_opensearchserverless.types.update_collection_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.UpdateCollectionGroup"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.update_collection_group_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_collection_group(
