"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#UpdateAccountSettings``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.update_account_settings_response.UpdateAccountSettingsResponse = capo_opensearchserverless.types.update_account_settings_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.UpdateAccountSettings"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.update_account_settings_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
