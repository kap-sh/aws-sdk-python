"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#ListAccessPolicies``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.list_access_policies_response.ListAccessPoliciesResponse = capo_opensearchserverless.types.list_access_policies_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.ListAccessPolicies"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.list_access_policies_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_access_policies(
