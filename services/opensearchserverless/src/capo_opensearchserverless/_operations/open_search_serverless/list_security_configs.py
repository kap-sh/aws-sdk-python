"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#ListSecurityConfigs``."""
...
import capo_opensearchserverless.types.security_config_summaries
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.list_security_configs_response.ListSecurityConfigsResponse = capo_opensearchserverless.types.list_security_configs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.ListSecurityConfigs"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.list_security_configs_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_security_configs(
