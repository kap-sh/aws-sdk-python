"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#ListCollections``."""
...
import capo_opensearchserverless.types.collection_summaries
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.list_collections_response.ListCollectionsResponse = capo_opensearchserverless.types.list_collections_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.ListCollections"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.list_collections_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
