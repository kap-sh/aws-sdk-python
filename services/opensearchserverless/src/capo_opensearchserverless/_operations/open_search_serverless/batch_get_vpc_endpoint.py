"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#BatchGetVpcEndpoint``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.batch_get_vpc_endpoint_response.BatchGetVpcEndpointResponse = capo_opensearchserverless.types.batch_get_vpc_endpoint_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.BatchGetVpcEndpoint"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.batch_get_vpc_endpoint_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_batch_get_vpc_endpoint(
