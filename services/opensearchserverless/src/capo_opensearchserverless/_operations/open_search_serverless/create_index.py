"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#CreateIndex``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.create_index_response.CreateIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.CreateIndex"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.create_index_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
