"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#CreateCollectionGroup``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.create_collection_group_response.CreateCollectionGroupResponse = capo_opensearchserverless.types.create_collection_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.CreateCollectionGroup"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.create_collection_group_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_collection_group(
