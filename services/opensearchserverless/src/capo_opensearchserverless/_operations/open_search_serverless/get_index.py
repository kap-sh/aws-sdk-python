"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#GetIndex``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.get_index_response.GetIndexResponse = (
        capo_opensearchserverless.types.get_index_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.GetIndex"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.get_index_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_index(
    ...
    capo_opensearchserverless.types.get_index_response.GetIndexResponse, zapros.Response
]:
