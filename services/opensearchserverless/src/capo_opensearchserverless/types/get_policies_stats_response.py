...
class GetPoliciesStatsResponse(TypedDict, closed=True):
    access_policy_stats: NotRequired[
        "capo_opensearchserverless.types.access_policy_stats.AccessPolicyStats"
    ]
    """<p>Information about the data access policies in your account.</p>"""
    security_policy_stats: NotRequired[
        "capo_opensearchserverless.types.security_policy_stats.SecurityPolicyStats"
    ]
    """<p>Information about the security policies in your account.</p>"""
    security_config_stats: NotRequired[
        "capo_opensearchserverless.types.security_config_stats.SecurityConfigStats"
    ]
    """<p>Information about the security configurations in your account.</p>"""
    lifecycle_policy_stats: NotRequired[
        "capo_opensearchserverless.types.lifecycle_policy_stats.LifecyclePolicyStats"
    ]
...
def serialize_aws_json_1_0(value: GetPoliciesStatsResponse) -> dict:
    ...
    if "access_policy_stats" in value:
        ...
        out["AccessPolicyStats"] = (
            capo_opensearchserverless.types.access_policy_stats.serialize_aws_json_1_0(
    ...
    if "security_policy_stats" in value:
        ...
        out["SecurityPolicyStats"] = (
            capo_opensearchserverless.types.security_policy_stats.serialize_aws_json_1_0(
    ...
    if "security_config_stats" in value:
        ...
        out["SecurityConfigStats"] = (
            capo_opensearchserverless.types.security_config_stats.serialize_aws_json_1_0(
    ...
    if "lifecycle_policy_stats" in value:
        ...
        out["LifecyclePolicyStats"] = (
            capo_opensearchserverless.types.lifecycle_policy_stats.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetPoliciesStatsResponse:
    ...
    if "AccessPolicyStats" in data:
        ...
        out["access_policy_stats"] = (
            capo_opensearchserverless.types.access_policy_stats.deserialize_aws_json_1_0(
    ...
    if "SecurityPolicyStats" in data:
        ...
        out["security_policy_stats"] = (
            capo_opensearchserverless.types.security_policy_stats.deserialize_aws_json_1_0(
    ...
    if "SecurityConfigStats" in data:
        ...
        out["security_config_stats"] = (
            capo_opensearchserverless.types.security_config_stats.deserialize_aws_json_1_0(
    ...
    if "LifecyclePolicyStats" in data:
        ...
        out["lifecycle_policy_stats"] = (
            capo_opensearchserverless.types.lifecycle_policy_stats.deserialize_aws_json_1_0(
