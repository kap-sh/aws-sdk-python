...
if TYPE_CHECKING:
    import capo_opensearchserverless.types.lifecycle_policy_resource_identifier

LifecyclePolicyResourceIdentifiers: TypeAlias = list[
    "capo_opensearchserverless.types.lifecycle_policy_resource_identifier.LifecyclePolicyResourceIdentifier"
]
...
def serialize_aws_json_1_0(value: LifecyclePolicyResourceIdentifiers) -> list:
    ...
    for item in value:
        out.append(
            capo_opensearchserverless.types.lifecycle_policy_resource_identifier.serialize_aws_json_1_0(
                item
            )
        )
    return out
