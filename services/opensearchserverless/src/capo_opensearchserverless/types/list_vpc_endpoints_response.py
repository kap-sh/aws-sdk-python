...
class ListVpcEndpointsResponse(TypedDict, closed=True):
    vpc_endpoint_summaries: NotRequired[
        "capo_opensearchserverless.types.vpc_endpoint_summaries.VpcEndpointSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListVpcEndpointsResponse) -> dict:
    ...
    if "vpc_endpoint_summaries" in value:
        ...
        out["vpcEndpointSummaries"] = (
            capo_opensearchserverless.types.vpc_endpoint_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListVpcEndpointsResponse:
    ...
    if "vpcEndpointSummaries" in data:
        ...
        out["vpc_endpoint_summaries"] = (
            capo_opensearchserverless.types.vpc_endpoint_summaries.deserialize_aws_json_1_0(
