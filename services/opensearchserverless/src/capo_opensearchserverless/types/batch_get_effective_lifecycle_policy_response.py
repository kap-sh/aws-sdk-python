...
if TYPE_CHECKING:
    import capo_opensearchserverless.types.effective_lifecycle_policy_details
    import capo_opensearchserverless.types.effective_lifecycle_policy_error_details


class BatchGetEffectiveLifecyclePolicyResponse(TypedDict, closed=True):
    effective_lifecycle_policy_details: NotRequired[
        "capo_opensearchserverless.types.effective_lifecycle_policy_details.EffectiveLifecyclePolicyDetails"
    ]
    ...
    effective_lifecycle_policy_error_details: NotRequired[
        "capo_opensearchserverless.types.effective_lifecycle_policy_error_details.EffectiveLifecyclePolicyErrorDetails"
    ]
...
def serialize_aws_json_1_0(value: BatchGetEffectiveLifecyclePolicyResponse) -> dict:
    ...
    if "effective_lifecycle_policy_details" in value:
        ...
        out["effectiveLifecyclePolicyDetails"] = (
            capo_opensearchserverless.types.effective_lifecycle_policy_details.serialize_aws_json_1_0(
    ...
    if "effective_lifecycle_policy_error_details" in value:
        ...
        out["effectiveLifecyclePolicyErrorDetails"] = (
            capo_opensearchserverless.types.effective_lifecycle_policy_error_details.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> BatchGetEffectiveLifecyclePolicyResponse:
    ...
    if "effectiveLifecyclePolicyDetails" in data:
        ...
        out["effective_lifecycle_policy_details"] = (
            capo_opensearchserverless.types.effective_lifecycle_policy_details.deserialize_aws_json_1_0(
    ...
    if "effectiveLifecyclePolicyErrorDetails" in data:
        ...
        out["effective_lifecycle_policy_error_details"] = (
            capo_opensearchserverless.types.effective_lifecycle_policy_error_details.deserialize_aws_json_1_0(
