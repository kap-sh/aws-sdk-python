...
if TYPE_CHECKING:
    import aws_sdk_opensearchserverless.types.indexing_capacity_value
    import aws_sdk_opensearchserverless.types.search_capacity_value


class CapacityLimits(TypedDict):
    max_indexing_capacity_in_ocu: NotRequired[
        "aws_sdk_opensearchserverless.types.indexing_capacity_value.IndexingCapacityValue"
    ]
    """<p>The maximum indexing capacity for collections.</p>"""
    max_search_capacity_in_ocu: NotRequired[
        "aws_sdk_opensearchserverless.types.search_capacity_value.SearchCapacityValue"
    ]
