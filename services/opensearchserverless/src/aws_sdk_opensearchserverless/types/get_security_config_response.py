"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#GetSecurityConfigResponse``."""
...
class GetSecurityConfigResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: GetSecurityConfigResponse) -> dict:
    out: dict = {}
