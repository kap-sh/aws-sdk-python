...
class CreateVpcEndpointResponse(TypedDict):
    create_vpc_endpoint_detail: NotRequired[
        "aws_sdk_opensearchserverless.types.create_vpc_endpoint_detail.CreateVpcEndpointDetail"
    ]
...
def serialize_aws_json_1_0(value: CreateVpcEndpointResponse) -> dict:
    ...
    if "create_vpc_endpoint_detail" in value:
        ...
        out["createVpcEndpointDetail"] = (
            aws_sdk_opensearchserverless.types.create_vpc_endpoint_detail.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> CreateVpcEndpointResponse:
    ...
    if "createVpcEndpointDetail" in data:
        ...
        out["create_vpc_endpoint_detail"] = (
            aws_sdk_opensearchserverless.types.create_vpc_endpoint_detail.deserialize_aws_json_1_0(
