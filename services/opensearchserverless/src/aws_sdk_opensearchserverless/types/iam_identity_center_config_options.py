...
if TYPE_CHECKING:
    import aws_sdk_opensearchserverless.types.iam_identity_center_application_arn
...
class IamIdentityCenterConfigOptions(TypedDict):
    instance_arn: NotRequired[
        "aws_sdk_opensearchserverless.types.iam_identity_center_instance_arn.IamIdentityCenterInstanceArn"
    ]
    """<p>The ARN of the IAM Identity Center instance used to integrate with OpenSearch Serverless.</p>"""
    application_arn: NotRequired[
        "aws_sdk_opensearchserverless.types.iam_identity_center_application_arn.IamIdentityCenterApplicationArn"
    ]
