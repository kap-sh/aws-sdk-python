...
class BatchGetLifecyclePolicyRequest(TypedDict):
...
def serialize_aws_json_1_0(value: BatchGetLifecyclePolicyRequest) -> dict:
    ...
    out["identifiers"] = (
        aws_sdk_opensearchserverless.types.lifecycle_policy_identifiers.serialize_aws_json_1_0(
            value["identifiers"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchGetLifecyclePolicyRequest:
    ...
    if "identifiers" in data:
        ...
        out["identifiers"] = (
            aws_sdk_opensearchserverless.types.lifecycle_policy_identifiers.deserialize_aws_json_1_0(
                data["identifiers"]
            )
        )
    else:
