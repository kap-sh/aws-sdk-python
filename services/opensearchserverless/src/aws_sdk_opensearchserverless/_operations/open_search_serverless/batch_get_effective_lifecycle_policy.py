"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#BatchGetEffectiveLifecyclePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.batch_get_effective_lifecycle_policy_response.BatchGetEffectiveLifecyclePolicyResponse = aws_sdk_opensearchserverless.types.batch_get_effective_lifecycle_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.batch_get_effective_lifecycle_policy_request.BatchGetEffectiveLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_batch_get_effective_lifecycle_policy(
