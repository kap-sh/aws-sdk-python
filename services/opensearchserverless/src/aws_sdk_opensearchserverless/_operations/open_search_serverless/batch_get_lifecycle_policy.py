"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#BatchGetLifecyclePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.batch_get_lifecycle_policy_response.BatchGetLifecyclePolicyResponse = aws_sdk_opensearchserverless.types.batch_get_lifecycle_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.batch_get_lifecycle_policy_request.BatchGetLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.BatchGetLifecyclePolicy"
    import aws_sdk_opensearchserverless.types.batch_get_lifecycle_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.batch_get_lifecycle_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_batch_get_lifecycle_policy(
