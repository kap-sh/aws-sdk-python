...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.create_collection_group_response.CreateCollectionGroupResponse = aws_sdk_opensearchserverless.types.create_collection_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.create_collection_group_request.CreateCollectionGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.create_collection_group_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
