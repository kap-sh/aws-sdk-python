"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#UpdateCollection``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.update_collection_response.UpdateCollectionResponse = aws_sdk_opensearchserverless.types.update_collection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.update_collection_request.UpdateCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.UpdateCollection"
    import aws_sdk_opensearchserverless.types.update_collection_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.update_collection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
