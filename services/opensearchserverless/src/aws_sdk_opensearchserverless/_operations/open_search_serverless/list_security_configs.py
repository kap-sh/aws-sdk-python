...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.list_security_configs_response.ListSecurityConfigsResponse = aws_sdk_opensearchserverless.types.list_security_configs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.list_security_configs_request.ListSecurityConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.list_security_configs_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
