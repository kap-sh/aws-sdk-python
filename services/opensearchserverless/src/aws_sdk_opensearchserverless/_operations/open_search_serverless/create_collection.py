"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#CreateCollection``."""
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.create_collection_request.CreateCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.create_collection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
