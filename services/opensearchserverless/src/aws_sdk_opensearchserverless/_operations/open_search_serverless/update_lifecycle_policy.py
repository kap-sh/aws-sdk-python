"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#UpdateLifecyclePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.update_lifecycle_policy_response.UpdateLifecyclePolicyResponse = aws_sdk_opensearchserverless.types.update_lifecycle_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.update_lifecycle_policy_request.UpdateLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.UpdateLifecyclePolicy"
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.update_lifecycle_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_lifecycle_policy(
