...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.delete_security_policy_response.DeleteSecurityPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.delete_security_policy_request.DeleteSecurityPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.delete_security_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
