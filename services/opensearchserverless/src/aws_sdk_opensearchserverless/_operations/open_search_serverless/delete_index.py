"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#DeleteIndex``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.delete_index_response.DeleteIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.delete_index_request.DeleteIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.DeleteIndex"
    import aws_sdk_opensearchserverless.types.delete_index_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.delete_index_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
