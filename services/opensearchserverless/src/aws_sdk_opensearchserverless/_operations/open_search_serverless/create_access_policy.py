"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#CreateAccessPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.create_access_policy_response.CreateAccessPolicyResponse = aws_sdk_opensearchserverless.types.create_access_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.create_access_policy_request.CreateAccessPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.CreateAccessPolicy"
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.create_access_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_access_policy(
