...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.batch_get_collection_response.BatchGetCollectionResponse = aws_sdk_opensearchserverless.types.batch_get_collection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.batch_get_collection_request.BatchGetCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.batch_get_collection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
