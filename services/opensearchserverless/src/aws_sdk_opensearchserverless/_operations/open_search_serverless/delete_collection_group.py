"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#DeleteCollectionGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.delete_collection_group_response.DeleteCollectionGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.delete_collection_group_request.DeleteCollectionGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.DeleteCollectionGroup"
    import aws_sdk_opensearchserverless.types.delete_collection_group_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.delete_collection_group_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_collection_group(
