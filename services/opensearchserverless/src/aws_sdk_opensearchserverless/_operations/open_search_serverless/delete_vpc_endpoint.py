"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#DeleteVpcEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.delete_vpc_endpoint_response.DeleteVpcEndpointResponse = aws_sdk_opensearchserverless.types.delete_vpc_endpoint_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.delete_vpc_endpoint_request.DeleteVpcEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.DeleteVpcEndpoint"
    import aws_sdk_opensearchserverless.types.delete_vpc_endpoint_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.delete_vpc_endpoint_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
