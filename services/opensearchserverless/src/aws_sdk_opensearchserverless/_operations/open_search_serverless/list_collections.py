...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.list_collections_response.ListCollectionsResponse = aws_sdk_opensearchserverless.types.list_collections_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.list_collections_request.ListCollectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.list_collections_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
