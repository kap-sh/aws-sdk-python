"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#CreateSecurityPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.create_security_policy_response.CreateSecurityPolicyResponse = aws_sdk_opensearchserverless.types.create_security_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.create_security_policy_request.CreateSecurityPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.CreateSecurityPolicy"
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.create_security_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_security_policy(
