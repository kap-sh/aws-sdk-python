"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#UpdateAccessPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.update_access_policy_response.UpdateAccessPolicyResponse = aws_sdk_opensearchserverless.types.update_access_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.update_access_policy_request.UpdateAccessPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.UpdateAccessPolicy"
    import aws_sdk_opensearchserverless.types.update_access_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.update_access_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_access_policy(
