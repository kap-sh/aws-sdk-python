...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.update_account_settings_response.UpdateAccountSettingsResponse = aws_sdk_opensearchserverless.types.update_account_settings_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.update_account_settings_request.UpdateAccountSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.update_account_settings_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
