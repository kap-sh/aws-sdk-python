...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.get_policies_stats_response.GetPoliciesStatsResponse = aws_sdk_opensearchserverless.types.get_policies_stats_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.get_policies_stats_request.GetPoliciesStatsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
