"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#CreateLifecyclePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.create_lifecycle_policy_response.CreateLifecyclePolicyResponse = aws_sdk_opensearchserverless.types.create_lifecycle_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.create_lifecycle_policy_request.CreateLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.CreateLifecyclePolicy"
    import aws_sdk_opensearchserverless.types.create_lifecycle_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.create_lifecycle_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
