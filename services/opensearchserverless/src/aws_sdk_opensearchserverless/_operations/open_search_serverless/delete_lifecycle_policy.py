...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.delete_lifecycle_policy_request.DeleteLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.delete_lifecycle_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
