...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.list_lifecycle_policies_response.ListLifecyclePoliciesResponse = aws_sdk_opensearchserverless.types.list_lifecycle_policies_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.list_lifecycle_policies_request.ListLifecyclePoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.list_lifecycle_policies_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
