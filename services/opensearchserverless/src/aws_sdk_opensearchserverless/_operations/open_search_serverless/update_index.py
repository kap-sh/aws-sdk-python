"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#UpdateIndex``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.update_index_response.UpdateIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.update_index_request.UpdateIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.UpdateIndex"
    import aws_sdk_opensearchserverless.types.update_index_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.update_index_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
