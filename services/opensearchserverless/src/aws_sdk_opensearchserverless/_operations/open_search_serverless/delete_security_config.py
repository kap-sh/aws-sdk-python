"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#DeleteSecurityConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.delete_security_config_response.DeleteSecurityConfigResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.delete_security_config_request.DeleteSecurityConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.DeleteSecurityConfig"
    import aws_sdk_opensearchserverless.types.delete_security_config_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.delete_security_config_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_security_config(
