...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.get_index_response.GetIndexResponse = (
        aws_sdk_opensearchserverless.types.get_index_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.get_index_request.GetIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.get_index_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
