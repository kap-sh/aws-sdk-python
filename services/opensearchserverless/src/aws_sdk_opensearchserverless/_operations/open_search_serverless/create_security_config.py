...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.create_security_config_response.CreateSecurityConfigResponse = aws_sdk_opensearchserverless.types.create_security_config_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.create_security_config_request.CreateSecurityConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.create_security_config_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
