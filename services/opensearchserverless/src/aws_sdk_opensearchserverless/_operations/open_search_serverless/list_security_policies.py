"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#ListSecurityPolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.list_security_policies_response.ListSecurityPoliciesResponse = aws_sdk_opensearchserverless.types.list_security_policies_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.list_security_policies_request.ListSecurityPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.ListSecurityPolicies"
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.list_security_policies_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
