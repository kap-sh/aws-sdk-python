...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.batch_get_vpc_endpoint_response.BatchGetVpcEndpointResponse = aws_sdk_opensearchserverless.types.batch_get_vpc_endpoint_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.batch_get_vpc_endpoint_request.BatchGetVpcEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.batch_get_vpc_endpoint_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
