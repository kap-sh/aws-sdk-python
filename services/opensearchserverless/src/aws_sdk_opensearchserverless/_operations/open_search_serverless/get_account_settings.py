...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.get_account_settings_response.GetAccountSettingsResponse = aws_sdk_opensearchserverless.types.get_account_settings_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.get_account_settings_request.GetAccountSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
