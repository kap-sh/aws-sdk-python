...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.list_access_policies_response.ListAccessPoliciesResponse = aws_sdk_opensearchserverless.types.list_access_policies_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.list_access_policies_request.ListAccessPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.list_access_policies_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
