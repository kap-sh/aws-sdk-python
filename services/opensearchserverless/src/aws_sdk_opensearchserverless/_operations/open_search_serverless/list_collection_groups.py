"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#ListCollectionGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearchserverless.types.list_collection_groups_response.ListCollectionGroupsResponse = aws_sdk_opensearchserverless.types.list_collection_groups_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_opensearchserverless.types.list_collection_groups_request.ListCollectionGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.ListCollectionGroups"
    import aws_sdk_opensearchserverless.types.list_collection_groups_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearchserverless.types.list_collection_groups_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_collection_groups(
