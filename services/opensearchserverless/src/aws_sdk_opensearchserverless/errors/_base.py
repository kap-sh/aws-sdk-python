...
class OpenSearchServerlessError(Exception):
    """Base class for all OpenSearchServerless service errors."""


class ServiceError(OpenSearchServerlessError):
...
class SerializationError(OpenSearchServerlessError):
    """Raised when a value cannot be serialized."""


class DeserializationError(OpenSearchServerlessError):
...
class WaiterFailedError(OpenSearchServerlessError):
...
class WaiterTimeoutError(OpenSearchServerlessError):
