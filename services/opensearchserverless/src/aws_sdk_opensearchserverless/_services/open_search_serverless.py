...
from aws_sdk_opensearchserverless._services._aws_config import aws_config
...
class OpenSearchServerlessClientConfig(TypedDict, total=False):
...
class OpenSearchServerlessClient:
    ...
    def batch_get_collection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.batch_get_collection_request.BatchGetCollectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.batch_get_collection_response.BatchGetCollectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.batch_get_collection.batch_get_collection(
    ...
    def batch_get_collection_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.batch_get_collection_group_request.BatchGetCollectionGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.batch_get_collection_group_response.BatchGetCollectionGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.batch_get_collection_group.batch_get_collection_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_effective_lifecycle_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.batch_get_effective_lifecycle_policy_request.BatchGetEffectiveLifecyclePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.batch_get_effective_lifecycle_policy_response.BatchGetEffectiveLifecyclePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.batch_get_effective_lifecycle_policy.batch_get_effective_lifecycle_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_lifecycle_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.batch_get_lifecycle_policy_request.BatchGetLifecyclePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.batch_get_lifecycle_policy_response.BatchGetLifecyclePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.batch_get_lifecycle_policy.batch_get_lifecycle_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_get_vpc_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.batch_get_vpc_endpoint_request.BatchGetVpcEndpointRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.batch_get_vpc_endpoint_response.BatchGetVpcEndpointResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.batch_get_vpc_endpoint.batch_get_vpc_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_lifecycle_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.create_lifecycle_policy_request.CreateLifecyclePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.create_lifecycle_policy_response.CreateLifecyclePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.create_lifecycle_policy.create_lifecycle_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_security_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.create_security_policy_request.CreateSecurityPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.create_security_policy_response.CreateSecurityPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.create_security_policy.create_security_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_account_settings(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.get_account_settings.get_account_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_policies_stats(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.get_policies_stats.get_policies_stats(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_account_settings(
        ...
        *,
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.update_account_settings.update_account_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_vpc_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_opensearchserverless.types.update_vpc_endpoint_request.UpdateVpcEndpointRequest]",
        ) -> OperationResponse[
            "aws_sdk_opensearchserverless.types.update_vpc_endpoint_response.UpdateVpcEndpointResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_opensearchserverless._operations.open_search_serverless.update_vpc_endpoint.update_vpc_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
