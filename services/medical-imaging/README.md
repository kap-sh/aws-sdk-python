...
```
pip install aws-sdk-medical-imaging
```

## Usage

```python
from aws_sdk_medical_imaging import AsyncMedicalImagingClient
...
```python
from aws_sdk_medical_imaging import AsyncMedicalImagingClient
from aws_sdk_medical_imaging.error import AccessDeniedException
