...
if TYPE_CHECKING:
    ...
    import aws_sdk_medical_imaging.types.dicom_number_of_study_related_instances
    import aws_sdk_medical_imaging.types.dicom_number_of_study_related_series
    import aws_sdk_medical_imaging.types.dicom_patient_birth_date
    import aws_sdk_medical_imaging.types.dicom_patient_id
    import aws_sdk_medical_imaging.types.dicom_patient_name
    import aws_sdk_medical_imaging.types.dicom_patient_sex
    import aws_sdk_medical_imaging.types.dicom_series_body_part
    import aws_sdk_medical_imaging.types.dicom_series_instance_uid
    import aws_sdk_medical_imaging.types.dicom_series_modality
    import aws_sdk_medical_imaging.types.dicom_series_number
    import aws_sdk_medical_imaging.types.dicom_study_date
    import aws_sdk_medical_imaging.types.dicom_study_description
...
class DICOMTags(TypedDict):
    dicom_patient_id: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_patient_id.DICOMPatientId"
    ]
    """<p>The unique identifier for a patient in a DICOM Study.</p>"""
    dicom_patient_name: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_patient_name.DICOMPatientName"
    ]
    """<p>The patient name.</p>"""
    dicom_patient_birth_date: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_patient_birth_date.DICOMPatientBirthDate"
    ]
    """<p>The patient birth date.</p>"""
    dicom_patient_sex: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_patient_sex.DICOMPatientSex"
    ]
    """<p>The patient sex.</p>"""
    ...
    dicom_study_id: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_study_id.DICOMStudyId"
    ]
    """<p>The DICOM provided identifier for the Study ID.</p>"""
    dicom_study_description: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_study_description.DICOMStudyDescription"
    ]
    """<p>The DICOM provided Study Description.</p>"""
    dicom_number_of_study_related_series: "aws_sdk_medical_imaging.types.dicom_number_of_study_related_series.DICOMNumberOfStudyRelatedSeries"
    """<p>The total number of series in the DICOM study.</p>"""
    dicom_number_of_study_related_instances: "aws_sdk_medical_imaging.types.dicom_number_of_study_related_instances.DICOMNumberOfStudyRelatedInstances"
    ...
    dicom_series_modality: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_series_modality.DICOMSeriesModality"
    ]
    """<p>The DICOM provided identifier for the series Modality.</p>"""
    dicom_series_body_part: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_series_body_part.DICOMSeriesBodyPart"
    ]
    """<p>The DICOM provided identifier for the series Body Part Examined.</p>"""
    dicom_series_number: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_series_number.DICOMSeriesNumber"
    ]
    """<p>The DICOM provided identifier for the Series Number.</p>"""
    dicom_study_date: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_study_date.DICOMStudyDate"
    ]
    """<p>The study date.</p>"""
    dicom_study_time: NotRequired[
        "aws_sdk_medical_imaging.types.dicom_study_time.DICOMStudyTime"
    ]
    """<p>The study time.</p>"""
