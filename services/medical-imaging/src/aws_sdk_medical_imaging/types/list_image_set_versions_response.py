...
class ListImageSetVersionsResponse(TypedDict):
    image_set_properties_list: (
        "aws_sdk_medical_imaging.types.image_set_properties_list.ImageSetPropertiesList"
    )
...
def serialize_json(value: ListImageSetVersionsResponse) -> dict:
    ...
    out["imageSetPropertiesList"] = (
        aws_sdk_medical_imaging.types.image_set_properties_list.serialize_json(
...
def deserialize_json(data: dict) -> ListImageSetVersionsResponse:
    ...
    if "imageSetPropertiesList" in data:
        ...
        out["image_set_properties_list"] = (
            aws_sdk_medical_imaging.types.image_set_properties_list.deserialize_json(
