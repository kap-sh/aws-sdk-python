...
if TYPE_CHECKING:
    import aws_sdk_medical_imaging.types.copiable_attributes


class MetadataCopies(TypedDict):
    copiable_attributes: (
        "aws_sdk_medical_imaging.types.copiable_attributes.CopiableAttributes"
    )
