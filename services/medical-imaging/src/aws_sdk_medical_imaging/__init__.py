...
from ._services.async_medical_imaging import (
    AsyncMedicalImagingClient as AsyncMedicalImagingClient,
)
from ._services.medical_imaging import MedicalImagingClient as MedicalImagingClient
