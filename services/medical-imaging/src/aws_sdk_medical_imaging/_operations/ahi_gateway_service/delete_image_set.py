...
def handle_response(
    ...
    out: aws_sdk_medical_imaging.types.delete_image_set_response.DeleteImageSetResponse = aws_sdk_medical_imaging.types.delete_image_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medical_imaging.types.delete_image_set_request.DeleteImageSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
