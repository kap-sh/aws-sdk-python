"""Generated from Smithy shape ``com.amazonaws.medicalimaging#SearchImageSets``."""
...
def handle_response(
    ...
    out: aws_sdk_medical_imaging.types.search_image_sets_response.SearchImageSetsResponse = aws_sdk_medical_imaging.types.search_image_sets_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medical_imaging.types.search_image_sets_request.SearchImageSetsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/datastore/{datastoreId}/searchImageSets"
...
async def async_search_image_sets(
