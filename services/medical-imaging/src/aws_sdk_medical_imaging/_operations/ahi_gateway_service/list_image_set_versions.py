"""Generated from Smithy shape ``com.amazonaws.medicalimaging#ListImageSetVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_medical_imaging.types.list_image_set_versions_response.ListImageSetVersionsResponse = aws_sdk_medical_imaging.types.list_image_set_versions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medical_imaging.types.list_image_set_versions_request.ListImageSetVersionsRequest,
) -> zapros.Request:
...
async def async_list_image_set_versions(
