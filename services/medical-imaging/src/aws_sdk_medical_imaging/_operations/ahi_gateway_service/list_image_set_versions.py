...
import aws_sdk_medical_imaging.types.image_set_properties_list
...
def build_request(
    ...
    input_: aws_sdk_medical_imaging.types.list_image_set_versions_request.ListImageSetVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
