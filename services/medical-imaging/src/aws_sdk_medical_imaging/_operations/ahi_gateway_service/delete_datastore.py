"""Generated from Smithy shape ``com.amazonaws.medicalimaging#DeleteDatastore``."""
...
def handle_response(
    ...
    out: aws_sdk_medical_imaging.types.delete_datastore_response.DeleteDatastoreResponse = aws_sdk_medical_imaging.types.delete_datastore_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medical_imaging.types.delete_datastore_request.DeleteDatastoreRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/datastore/{datastoreId}"
...
async def async_delete_datastore(
