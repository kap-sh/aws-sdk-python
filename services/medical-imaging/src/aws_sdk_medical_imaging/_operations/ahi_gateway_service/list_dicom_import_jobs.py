...
def handle_response(
    ...
    out: aws_sdk_medical_imaging.types.list_dicom_import_jobs_response.ListDICOMImportJobsResponse = aws_sdk_medical_imaging.types.list_dicom_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medical_imaging.types.list_dicom_import_jobs_request.ListDICOMImportJobsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "job_status" in input:
        params["jobStatus"] = str(input["job_status"])
