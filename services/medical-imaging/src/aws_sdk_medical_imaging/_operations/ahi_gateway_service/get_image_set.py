...
def handle_response(
    ...
    out: aws_sdk_medical_imaging.types.get_image_set_response.GetImageSetResponse = (
        aws_sdk_medical_imaging.types.get_image_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medical_imaging.types.get_image_set_request.GetImageSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
