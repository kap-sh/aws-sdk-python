"""Generated from Smithy shape ``com.amazonaws.medicalimaging#CreateDatastore``."""
...
def handle_response(
    ...
    out: aws_sdk_medical_imaging.types.create_datastore_response.CreateDatastoreResponse = aws_sdk_medical_imaging.types.create_datastore_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medical_imaging.types.create_datastore_request.CreateDatastoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medical_imaging.types.create_datastore_request.serialize_json(input_)
    ).encode()
...
async def async_create_datastore(
