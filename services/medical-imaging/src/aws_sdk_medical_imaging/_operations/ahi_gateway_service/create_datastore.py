...
def build_request(
    ...
    input: aws_sdk_medical_imaging.types.create_datastore_request.CreateDatastoreRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medical_imaging.types.create_datastore_request.serialize_json(input)
    ).encode()
