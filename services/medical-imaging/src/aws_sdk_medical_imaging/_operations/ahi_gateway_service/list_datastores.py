...
def handle_response(
    ...
    out: aws_sdk_medical_imaging.types.list_datastores_response.ListDatastoresResponse = aws_sdk_medical_imaging.types.list_datastores_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medical_imaging.types.list_datastores_request.ListDatastoresRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "datastore_status" in input:
        params["datastoreStatus"] = str(input["datastore_status"])
