"""Generated from Smithy shape ``com.amazonaws.medicalimaging#GetDICOMImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_medical_imaging.types.get_dicom_import_job_response.GetDICOMImportJobResponse = aws_sdk_medical_imaging.types.get_dicom_import_job_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medical_imaging.types.get_dicom_import_job_request.GetDICOMImportJobRequest,
) -> zapros.Request:
...
async def async_get_dicom_import_job(
