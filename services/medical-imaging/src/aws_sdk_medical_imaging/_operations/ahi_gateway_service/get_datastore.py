"""Generated from Smithy shape ``com.amazonaws.medicalimaging#GetDatastore``."""
...
def handle_response(
    ...
    out: aws_sdk_medical_imaging.types.get_datastore_response.GetDatastoreResponse = (
        aws_sdk_medical_imaging.types.get_datastore_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medical_imaging.types.get_datastore_request.GetDatastoreRequest,
) -> zapros.Request:
