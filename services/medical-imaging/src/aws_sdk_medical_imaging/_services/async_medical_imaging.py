...
from aws_sdk_medical_imaging._resources.ahi_gateway_service.image_set_resource import (
    AsyncImageSetResource,
)
from aws_sdk_medical_imaging._services._aws_config import aaws_config
...
class AsyncMedicalImagingClientConfig(TypedDict, total=False, closed=True):
...
class AsyncMedicalImagingClient:
    ...
    def __init__(
        ...
        self._config = AsyncMedicalImagingClientConfig(
            {
        ...
        # resources
        self.datastore_resource = AsyncDatastoreResource(self)
        self.image_set_resource = AsyncImageSetResource(self)
