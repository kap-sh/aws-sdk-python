"""Generated from Smithy shape ``com.amazonaws.medicalimaging#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.medicalimaging#ServiceQuotaExceededException``."""
