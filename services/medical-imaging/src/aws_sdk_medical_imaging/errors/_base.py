...
class MedicalImagingError(Exception):
    """Base class for all MedicalImaging service errors."""


class ServiceError(MedicalImagingError):
...
class SerializationError(MedicalImagingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MedicalImagingError):
...
class WaiterFailedError(MedicalImagingError):
...
class WaiterTimeoutError(MedicalImagingError):
