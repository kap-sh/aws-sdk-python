"""Generated from Smithy shape ``com.amazonaws.medicalimaging#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.medicalimaging#ResourceNotFoundException``."""
