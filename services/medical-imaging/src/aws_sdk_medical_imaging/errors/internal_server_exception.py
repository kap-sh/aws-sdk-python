"""Generated from Smithy shape ``com.amazonaws.medicalimaging#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.medicalimaging#InternalServerException``."""
