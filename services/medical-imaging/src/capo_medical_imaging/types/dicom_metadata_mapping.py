...
if TYPE_CHECKING:
    ...
    import capo_medical_imaging.types.metadata_file_path


class DicomMetadataMapping(TypedDict, closed=True):
    study_instance_uid: (
    ...
    metadata_file_path: "capo_medical_imaging.types.metadata_file_path.MetadataFilePath"
