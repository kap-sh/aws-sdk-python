...
def handle_response(
    ...
    out: capo_medical_imaging.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medical_imaging.types.tag_resource_request.serialize_json(input_)
    ).encode()
