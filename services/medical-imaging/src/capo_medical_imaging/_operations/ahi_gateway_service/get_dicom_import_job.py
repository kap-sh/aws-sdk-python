...
def handle_response(
    ...
    out: capo_medical_imaging.types.get_dicom_import_job_response.GetDICOMImportJobResponse = capo_medical_imaging.types.get_dicom_import_job_response.deserialize_json(
