...
def handle_response(
    ...
    out: capo_medical_imaging.types.delete_datastore_response.DeleteDatastoreResponse = capo_medical_imaging.types.delete_datastore_response.deserialize_json(
