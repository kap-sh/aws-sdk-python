...
def handle_response(
    ...
    out: capo_medical_imaging.types.create_datastore_response.CreateDatastoreResponse = capo_medical_imaging.types.create_datastore_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medical_imaging.types.create_datastore_request.serialize_json(input_)
    ).encode()
