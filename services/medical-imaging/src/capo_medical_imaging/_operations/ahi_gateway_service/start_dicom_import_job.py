...
def handle_response(
    ...
    out: capo_medical_imaging.types.start_dicom_import_job_response.StartDICOMImportJobResponse = capo_medical_imaging.types.start_dicom_import_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medical_imaging.types.start_dicom_import_job_request.serialize_json(input_)
    ).encode()
