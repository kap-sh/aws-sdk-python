...
def handle_response(
    ...
    out: capo_medical_imaging.types.search_image_sets_response.SearchImageSetsResponse = capo_medical_imaging.types.search_image_sets_response.deserialize_json(
