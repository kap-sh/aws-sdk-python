"""Generated from Smithy shape ``com.amazonaws.medicalimaging#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_medical_imaging.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_medical_imaging.types.list_tags_for_resource_response.deserialize_json(
