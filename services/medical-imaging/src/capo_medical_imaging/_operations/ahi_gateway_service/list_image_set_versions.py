...
def handle_response(
    ...
    out: capo_medical_imaging.types.list_image_set_versions_response.ListImageSetVersionsResponse = capo_medical_imaging.types.list_image_set_versions_response.deserialize_json(
