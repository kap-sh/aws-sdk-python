...
def handle_response(
    ...
    out: capo_vpc_lattice.types.get_service_network_resource_association_response.GetServiceNetworkResourceAssociationResponse = capo_vpc_lattice.types.get_service_network_resource_association_response.deserialize_json(
