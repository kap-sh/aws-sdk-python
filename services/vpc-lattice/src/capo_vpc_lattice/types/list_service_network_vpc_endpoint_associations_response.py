...
class ListServiceNetworkVpcEndpointAssociationsResponse(TypedDict, closed=True):
    items: "capo_vpc_lattice.types.service_network_vpc_endpoint_association_list.ServiceNetworkVpcEndpointAssociationList"
...
def serialize_json(value: ListServiceNetworkVpcEndpointAssociationsResponse) -> dict:
    ...
    out["items"] = (
        capo_vpc_lattice.types.service_network_vpc_endpoint_association_list.serialize_json(
            value["items"]
        )
    )
...
def deserialize_json(data: dict) -> ListServiceNetworkVpcEndpointAssociationsResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            capo_vpc_lattice.types.service_network_vpc_endpoint_association_list.deserialize_json(
                data["items"]
            )
        )
    else:
