...
if TYPE_CHECKING:
    ...
    import capo_vpc_lattice.types.health_check_interval_seconds
    import capo_vpc_lattice.types.health_check_path
    import capo_vpc_lattice.types.health_check_port
    import capo_vpc_lattice.types.health_check_protocol_version
    import capo_vpc_lattice.types.health_check_timeout_seconds
    import capo_vpc_lattice.types.healthy_threshold_count
    import capo_vpc_lattice.types.matcher
    import capo_vpc_lattice.types.target_group_protocol
    import capo_vpc_lattice.types.unhealthy_threshold_count


class HealthCheckConfig(TypedDict, closed=True):
    enabled: NotRequired["capo_vpc_lattice.types.boolean.Boolean"]
    ...
    protocol_version: NotRequired[
        "capo_vpc_lattice.types.health_check_protocol_version.HealthCheckProtocolVersion"
    ]
    ...
    port: NotRequired["capo_vpc_lattice.types.health_check_port.HealthCheckPort"]
    ...
    path: NotRequired["capo_vpc_lattice.types.health_check_path.HealthCheckPath"]
    ...
    health_check_interval_seconds: NotRequired[
        "capo_vpc_lattice.types.health_check_interval_seconds.HealthCheckIntervalSeconds"
    ]
    ...
    health_check_timeout_seconds: NotRequired[
        "capo_vpc_lattice.types.health_check_timeout_seconds.HealthCheckTimeoutSeconds"
    ]
    ...
    healthy_threshold_count: NotRequired[
        "capo_vpc_lattice.types.healthy_threshold_count.HealthyThresholdCount"
    ]
    ...
    unhealthy_threshold_count: NotRequired[
        "capo_vpc_lattice.types.unhealthy_threshold_count.UnhealthyThresholdCount"
    ]
    ...
    matcher: NotRequired["capo_vpc_lattice.types.matcher.Matcher"]
...
def serialize_json(value: HealthCheckConfig) -> dict:
    ...
    if "matcher" in value:
        ...
        out["matcher"] = capo_vpc_lattice.types.matcher.serialize_json(value["matcher"])
    return out
