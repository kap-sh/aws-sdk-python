...
ResourceConfigurationSummaryList: TypeAlias = list[
    "capo_vpc_lattice.types.resource_configuration_summary.ResourceConfigurationSummary"
]
...
def serialize_json(value: ResourceConfigurationSummaryList) -> list:
    ...
    for item in value:
        out.append(
            capo_vpc_lattice.types.resource_configuration_summary.serialize_json(item)
        )
    return out
