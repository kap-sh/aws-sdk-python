...
if TYPE_CHECKING:
    ...
    import capo_vpc_lattice.types.resource_configuration_ip_address_type


class DnsResource(TypedDict, closed=True):
    domain_name: NotRequired["capo_vpc_lattice.types.domain_name.DomainName"]
    """<p>The domain name of the resource.</p>"""
    ip_address_type: NotRequired[
        "capo_vpc_lattice.types.resource_configuration_ip_address_type.ResourceConfigurationIpAddressType"
    ]
