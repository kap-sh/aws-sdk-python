...
from ._services.async_vpc_lattice import AsyncVPCLatticeClient as AsyncVPCLatticeClient
from ._services.vpc_lattice import VPCLatticeClient as VPCLatticeClient
