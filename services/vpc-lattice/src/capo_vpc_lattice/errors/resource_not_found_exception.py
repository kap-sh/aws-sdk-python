"""Generated from Smithy shape ``com.amazonaws.vpclattice#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.vpclattice#ResourceNotFoundException``."""
