...
class VPCLatticeError(Exception):
    """Base class for all VPCLattice service errors."""


class ServiceError(VPCLatticeError):
...
class SerializationError(VPCLatticeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(VPCLatticeError):
...
class WaiterFailedError(VPCLatticeError):
...
class WaiterTimeoutError(VPCLatticeError):
