...
class ServiceNetworkServiceAssociation:
    ...
    def create(
        ...
        *,
        ...
        input: aws_sdk_vpc_lattice.types.create_service_network_service_association_request.CreateServiceNetworkServiceAssociationRequest = {}  # type: ignore[typeddict-item]
    ...
    def read(
        ...
        *,
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_vpc_lattice.types.get_service_network_service_association_request.GetServiceNetworkServiceAssociationRequest = {}  # type: ignore[typeddict-item]
        input["service_network_service_association_identifier"] = (
    ...
    def delete(
        ...
        *,
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_vpc_lattice.types.delete_service_network_service_association_request.DeleteServiceNetworkServiceAssociationRequest = {}  # type: ignore[typeddict-item]
        input["service_network_service_association_identifier"] = (
            service_network_service_association_identifier
        )
    ...
    def list(
        ...
        *,
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_vpc_lattice.types.list_service_network_service_associations_request.ListServiceNetworkServiceAssociationsRequest = {}  # type: ignore[typeddict-item]
