...
if TYPE_CHECKING:
    ...
    import aws_sdk_vpc_lattice.types.service_network_arn_without_regex
...
class ServiceNetworkResourceAssociationSummary(TypedDict):
    id: NotRequired[
    ...
    service_network_arn: NotRequired[
        "aws_sdk_vpc_lattice.types.service_network_arn_without_regex.ServiceNetworkArnWithoutRegex"
    ]
