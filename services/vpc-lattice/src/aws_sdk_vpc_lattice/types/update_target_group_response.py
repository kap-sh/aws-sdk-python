"""Generated from Smithy shape ``com.amazonaws.vpclattice#UpdateTargetGroupResponse``."""
...
class UpdateTargetGroupResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateTargetGroupResponse) -> dict:
    out: dict = {}
    if "id" in value:
        out["id"] = value["id"]
    if "arn" in value:
