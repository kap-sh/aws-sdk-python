...
class ListDomainVerificationsResponse(TypedDict):
    items: "aws_sdk_vpc_lattice.types.domain_verification_list.DomainVerificationList"
...
def serialize_json(value: ListDomainVerificationsResponse) -> dict:
    ...
    out["items"] = aws_sdk_vpc_lattice.types.domain_verification_list.serialize_json(
        value["items"]
    )
...
def deserialize_json(data: dict) -> ListDomainVerificationsResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_vpc_lattice.types.domain_verification_list.deserialize_json(
                data["items"]
            )
        )
    else:
