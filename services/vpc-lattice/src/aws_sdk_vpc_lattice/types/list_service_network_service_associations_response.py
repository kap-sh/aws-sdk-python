...
if TYPE_CHECKING:
    ...
    import aws_sdk_vpc_lattice.types.service_network_service_association_list


class ListServiceNetworkServiceAssociationsResponse(TypedDict):
    items: "aws_sdk_vpc_lattice.types.service_network_service_association_list.ServiceNetworkServiceAssociationList"
...
def serialize_json(value: ListServiceNetworkServiceAssociationsResponse) -> dict:
    ...
    out["items"] = (
        aws_sdk_vpc_lattice.types.service_network_service_association_list.serialize_json(
            value["items"]
        )
    )
...
def deserialize_json(data: dict) -> ListServiceNetworkServiceAssociationsResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_vpc_lattice.types.service_network_service_association_list.deserialize_json(
                data["items"]
            )
        )
    else:
