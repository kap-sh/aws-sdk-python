...
if TYPE_CHECKING:
    ...
    import aws_sdk_vpc_lattice.types.target_group_protocol_version
...
class TargetGroupConfig(TypedDict):
    ...
    protocol_version: NotRequired[
        "aws_sdk_vpc_lattice.types.target_group_protocol_version.TargetGroupProtocolVersion"
    ]
    ...
    health_check: NotRequired[
        "aws_sdk_vpc_lattice.types.health_check_config.HealthCheckConfig"
    ]
...
def serialize_json(value: TargetGroupConfig) -> dict:
    ...
    if "health_check" in value:
        ...
        out["healthCheck"] = (
            aws_sdk_vpc_lattice.types.health_check_config.serialize_json(
                value["health_check"]
            )
        )
