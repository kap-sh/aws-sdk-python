...
if TYPE_CHECKING:
    import aws_sdk_vpc_lattice.types.http_code_matcher


class _Matcher_httpCode(TypedDict):
    httpCode: "aws_sdk_vpc_lattice.types.http_code_matcher.HttpCodeMatcher"
