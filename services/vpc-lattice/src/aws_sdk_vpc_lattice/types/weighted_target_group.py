...
if TYPE_CHECKING:
    ...
    import aws_sdk_vpc_lattice.types.target_group_weight


class WeightedTargetGroup(TypedDict):
    target_group_identifier: (
        "aws_sdk_vpc_lattice.types.target_group_identifier.TargetGroupIdentifier"
    )
    """<p>The ID or ARN of the target group.</p>"""
    weight: NotRequired[
        "aws_sdk_vpc_lattice.types.target_group_weight.TargetGroupWeight"
    ]
