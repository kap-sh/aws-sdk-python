"""Generated from Smithy shape ``com.amazonaws.chime#UnauthorizedClientException``."""
...
class UnauthorizedClientException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.chime#UnauthorizedClientException``."""
