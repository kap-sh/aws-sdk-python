...
def handle_response(
    ...
    out: capo_chime.types.batch_create_room_membership_response.BatchCreateRoomMembershipResponse = capo_chime.types.batch_create_room_membership_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.batch_create_room_membership_request.serialize_json(input_)
    ).encode()
