...
def handle_response(
    ...
    out: capo_chime.types.batch_unsuspend_user_response.BatchUnsuspendUserResponse = (
        capo_chime.types.batch_unsuspend_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.batch_unsuspend_user_request.serialize_json(input_)
    ).encode()
