"""Generated from Smithy shape ``com.amazonaws.chime#RedactConversationMessage``."""
...
def handle_response(
    ...
    out: capo_chime.types.redact_conversation_message_response.RedactConversationMessageResponse = {}  # type: ignore[typeddict-item]
    return out
