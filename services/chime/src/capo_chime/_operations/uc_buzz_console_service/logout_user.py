...
def handle_response(
    ...
    out: capo_chime.types.logout_user_response.LogoutUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def logout_user(
    ...
    input_: capo_chime.types.logout_user_request.LogoutUserRequest,
) -> tuple[capo_chime.types.logout_user_response.LogoutUserResponse, zapros.Response]:
