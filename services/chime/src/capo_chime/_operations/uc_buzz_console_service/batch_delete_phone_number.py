"""Generated from Smithy shape ``com.amazonaws.chime#BatchDeletePhoneNumber``."""
...
def handle_response(
    ...
    out: capo_chime.types.batch_delete_phone_number_response.BatchDeletePhoneNumberResponse = capo_chime.types.batch_delete_phone_number_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.batch_delete_phone_number_request.serialize_json(input_)
    ).encode()
