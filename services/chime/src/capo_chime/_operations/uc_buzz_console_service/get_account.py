...
def handle_response(
    ...
    out: capo_chime.types.get_account_response.GetAccountResponse = (
        capo_chime.types.get_account_response.deserialize_json(
...
def get_account(
    ...
    input_: capo_chime.types.get_account_request.GetAccountRequest,
) -> tuple[capo_chime.types.get_account_response.GetAccountResponse, zapros.Response]:
