...
import capo_chime.types.phone_number_list
...
def handle_response(
    ...
    out: capo_chime.types.list_phone_numbers_response.ListPhoneNumbersResponse = (
        capo_chime.types.list_phone_numbers_response.deserialize_json(
