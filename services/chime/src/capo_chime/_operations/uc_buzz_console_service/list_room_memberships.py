"""Generated from Smithy shape ``com.amazonaws.chime#ListRoomMemberships``."""
...
import capo_chime.types.room_membership_list
...
def handle_response(
    ...
    out: capo_chime.types.list_room_memberships_response.ListRoomMembershipsResponse = (
        capo_chime.types.list_room_memberships_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AccountId}/rooms/{RoomId}/memberships"
...
async def async_list_room_memberships(
