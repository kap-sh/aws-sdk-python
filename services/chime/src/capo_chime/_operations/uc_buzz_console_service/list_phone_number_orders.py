...
def handle_response(
    ...
    out: capo_chime.types.list_phone_number_orders_response.ListPhoneNumberOrdersResponse = capo_chime.types.list_phone_number_orders_response.deserialize_json(
