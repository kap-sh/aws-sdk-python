"""Generated from Smithy shape ``com.amazonaws.chime#ListBots``."""
...
def handle_response(
    ...
    out: capo_chime.types.list_bots_response.ListBotsResponse = (
        capo_chime.types.list_bots_response.deserialize_json(
...
def list_bots(
    ...
    input_: capo_chime.types.list_bots_request.ListBotsRequest,
) -> tuple[capo_chime.types.list_bots_response.ListBotsResponse, zapros.Response]:
