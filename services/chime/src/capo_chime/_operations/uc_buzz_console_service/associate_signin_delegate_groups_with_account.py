...
def handle_response(
    ...
    out: capo_chime.types.associate_signin_delegate_groups_with_account_response.AssociateSigninDelegateGroupsWithAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.associate_signin_delegate_groups_with_account_request.serialize_json(
            input_
        )
    ).encode()
