"""Generated from Smithy shape ``com.amazonaws.chime#CreatePhoneNumberOrder``."""
...
import capo_chime.errors.access_denied_exception
import capo_chime.errors.bad_request_exception
import capo_chime.errors.forbidden_exception
import capo_chime.errors.resource_limit_exceeded_exception
...
import capo_chime.types.phone_number_order
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_chime.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
        ...
        case "ResourceLimitExceededException":
            raise capo_chime.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_chime.types.create_phone_number_order_response.CreatePhoneNumberOrderResponse = capo_chime.types.create_phone_number_order_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.create_phone_number_order_request.serialize_json(input_)
    ).encode()
