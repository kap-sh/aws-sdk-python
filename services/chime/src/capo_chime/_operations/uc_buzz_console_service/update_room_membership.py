"""Generated from Smithy shape ``com.amazonaws.chime#UpdateRoomMembership``."""
...
def handle_response(
    ...
    out: capo_chime.types.update_room_membership_response.UpdateRoomMembershipResponse = capo_chime.types.update_room_membership_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.update_room_membership_request.serialize_json(input_)
    ).encode()
...
async def async_update_room_membership(
