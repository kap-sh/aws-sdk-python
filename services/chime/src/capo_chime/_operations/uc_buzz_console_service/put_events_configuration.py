"""Generated from Smithy shape ``com.amazonaws.chime#PutEventsConfiguration``."""
...
def handle_response(
    ...
    out: capo_chime.types.put_events_configuration_response.PutEventsConfigurationResponse = capo_chime.types.put_events_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.put_events_configuration_request.serialize_json(input_)
    ).encode()
...
async def async_put_events_configuration(
