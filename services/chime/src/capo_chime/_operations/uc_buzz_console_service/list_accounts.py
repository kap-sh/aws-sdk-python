...
def handle_response(
    ...
    out: capo_chime.types.list_accounts_response.ListAccountsResponse = (
        capo_chime.types.list_accounts_response.deserialize_json(
...
def list_accounts(
    ...
    capo_chime.types.list_accounts_response.ListAccountsResponse, zapros.Response
]:
