...
def handle_response(
    ...
    out: capo_chime.types.list_rooms_response.ListRoomsResponse = (
        capo_chime.types.list_rooms_response.deserialize_json(
...
def list_rooms(
    ...
    input_: capo_chime.types.list_rooms_request.ListRoomsRequest,
) -> tuple[capo_chime.types.list_rooms_response.ListRoomsResponse, zapros.Response]:
