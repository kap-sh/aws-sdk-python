"""Generated from Smithy shape ``com.amazonaws.chime#DisassociatePhoneNumberFromUser``."""
...
def handle_response(
    ...
    out: capo_chime.types.disassociate_phone_number_from_user_response.DisassociatePhoneNumberFromUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_phone_number_from_user(
