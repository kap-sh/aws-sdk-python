"""Generated from Smithy shape ``com.amazonaws.chime#ListUsers``."""
...
def handle_response(
    ...
    out: capo_chime.types.list_users_response.ListUsersResponse = (
        capo_chime.types.list_users_response.deserialize_json(
...
def build_request(
    ...
    if "user_type" in input_:
        params["user-type"] = str(input_["user_type"])
...
def list_users(
    ...
    input_: capo_chime.types.list_users_request.ListUsersRequest,
) -> tuple[capo_chime.types.list_users_response.ListUsersResponse, zapros.Response]:
