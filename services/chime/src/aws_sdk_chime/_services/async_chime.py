...
from aws_sdk_chime._services._aws_config import aaws_config
...
class AsyncChimeClient:
    ...
    async def associate_phone_number_with_user(
        ...
        *,
        ...
        Raises:
            aws_sdk_chime.errors.access_denied_exception.AccessDeniedException: <p>You don't have permissions to perform the requested operation.</p>
            aws_sdk_chime.errors.bad_request_exception.BadRequestException: <p>The input parameters don't match the service's restrictions.</p>
            aws_sdk_chime.errors.forbidden_exception.ForbiddenException: <p>The client is permanently forbidden from making the request.</p>
            aws_sdk_chime.errors.not_found_exception.NotFoundException: <p>One or more of the resources in the request does not exist in the system.</p>
            aws_sdk_chime.errors.service_failure_exception.ServiceFailureException: <p>The service encountered an unexpected error.</p>
            aws_sdk_chime.errors.service_unavailable_exception.ServiceUnavailableException: <p>The service is currently unavailable.</p>
            aws_sdk_chime.errors.throttled_client_exception.ThrottledClientException: <p>The client exceeded its request rate limit.</p>
            aws_sdk_chime.errors.unauthorized_client_exception.UnauthorizedClientException: <p>The client is not currently authorized to make the request.</p>
            aws_sdk_chime.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.associate_phone_number_with_user_request.AssociatePhoneNumberWithUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.associate_phone_number_with_user_response.AssociatePhoneNumberWithUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.associate_phone_number_with_user.async_associate_phone_number_with_user(
    ...
    async def associate_signin_delegate_groups_with_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.associate_signin_delegate_groups_with_account_request.AssociateSigninDelegateGroupsWithAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.associate_signin_delegate_groups_with_account_response.AssociateSigninDelegateGroupsWithAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.associate_signin_delegate_groups_with_account.async_associate_signin_delegate_groups_with_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_create_room_membership(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.batch_create_room_membership_request.BatchCreateRoomMembershipRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.batch_create_room_membership_response.BatchCreateRoomMembershipResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.batch_create_room_membership.async_batch_create_room_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_delete_phone_number(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.batch_delete_phone_number_request.BatchDeletePhoneNumberRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.batch_delete_phone_number_response.BatchDeletePhoneNumberResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.batch_delete_phone_number.async_batch_delete_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_suspend_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.batch_suspend_user_request.BatchSuspendUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.batch_suspend_user_response.BatchSuspendUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.batch_suspend_user.async_batch_suspend_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_unsuspend_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.batch_unsuspend_user_request.BatchUnsuspendUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.batch_unsuspend_user_response.BatchUnsuspendUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.batch_unsuspend_user.async_batch_unsuspend_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_phone_number(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.batch_update_phone_number_request.BatchUpdatePhoneNumberRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.batch_update_phone_number_response.BatchUpdatePhoneNumberResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.batch_update_phone_number.async_batch_update_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.batch_update_user_request.BatchUpdateUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.batch_update_user_response.BatchUpdateUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.batch_update_user.async_batch_update_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.create_account_request.CreateAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.create_account_response.CreateAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.create_account.async_create_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_bot(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_chime.errors.forbidden_exception.ForbiddenException: <p>The client is permanently forbidden from making the request.</p>
            aws_sdk_chime.errors.not_found_exception.NotFoundException: <p>One or more of the resources in the request does not exist in the system.</p>
            aws_sdk_chime.errors.resource_limit_exceeded_exception.ResourceLimitExceededException: <p>The request exceeds the resource limit.</p>
            aws_sdk_chime.errors.service_failure_exception.ServiceFailureException: <p>The service encountered an unexpected error.</p>
            aws_sdk_chime.errors.service_unavailable_exception.ServiceUnavailableException: <p>The service is currently unavailable.</p>
            aws_sdk_chime.errors.throttled_client_exception.ThrottledClientException: <p>The client exceeded its request rate limit.</p>
            aws_sdk_chime.errors.unauthorized_client_exception.UnauthorizedClientException: <p>The client is not currently authorized to make the request.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.create_bot_request.CreateBotRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.create_bot_response.CreateBotResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.create_bot.async_create_bot(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_meeting_dial_out(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.create_meeting_dial_out_request.CreateMeetingDialOutRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.create_meeting_dial_out_response.CreateMeetingDialOutResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.create_meeting_dial_out.async_create_meeting_dial_out(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_phone_number_order(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.create_phone_number_order_request.CreatePhoneNumberOrderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.create_phone_number_order_response.CreatePhoneNumberOrderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.create_phone_number_order.async_create_phone_number_order(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_room(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.create_room_request.CreateRoomRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.create_room_response.CreateRoomResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.create_room.async_create_room(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_room_membership(
        ...
        *,
        ...
        Raises:
            aws_sdk_chime.errors.bad_request_exception.BadRequestException: <p>The input parameters don't match the service's restrictions.</p>
            aws_sdk_chime.errors.conflict_exception.ConflictException: <p>The request could not be processed because of conflict in the current state of the resource.</p>
            aws_sdk_chime.errors.forbidden_exception.ForbiddenException: <p>The client is permanently forbidden from making the request.</p>
            aws_sdk_chime.errors.not_found_exception.NotFoundException: <p>One or more of the resources in the request does not exist in the system.</p>
            aws_sdk_chime.errors.resource_limit_exceeded_exception.ResourceLimitExceededException: <p>The request exceeds the resource limit.</p>
            aws_sdk_chime.errors.service_failure_exception.ServiceFailureException: <p>The service encountered an unexpected error.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.create_room_membership_request.CreateRoomMembershipRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.create_room_membership_response.CreateRoomMembershipResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.create_room_membership.async_create_room_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.create_user_request.CreateUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.create_user_response.CreateUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.create_user.async_create_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_account(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_chime.errors.throttled_client_exception.ThrottledClientException: <p>The client exceeded its request rate limit.</p>
            aws_sdk_chime.errors.unauthorized_client_exception.UnauthorizedClientException: <p>The client is not currently authorized to make the request.</p>
            aws_sdk_chime.errors.unprocessable_entity_exception.UnprocessableEntityException: <p>The request was well-formed but was unable to be followed due to semantic errors.</p>
            aws_sdk_chime.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.delete_account_request.DeleteAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.delete_account_response.DeleteAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.delete_account.async_delete_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_events_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.delete_events_configuration_request.DeleteEventsConfigurationRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.delete_events_configuration.async_delete_events_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_phone_number(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.delete_phone_number_request.DeletePhoneNumberRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.delete_phone_number.async_delete_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_room(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.delete_room_request.DeleteRoomRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.delete_room.async_delete_room(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_room_membership(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.delete_room_membership_request.DeleteRoomMembershipRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.delete_room_membership.async_delete_room_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_phone_number_from_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.disassociate_phone_number_from_user_request.DisassociatePhoneNumberFromUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.disassociate_phone_number_from_user_response.DisassociatePhoneNumberFromUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.disassociate_phone_number_from_user.async_disassociate_phone_number_from_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_signin_delegate_groups_from_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.disassociate_signin_delegate_groups_from_account_request.DisassociateSigninDelegateGroupsFromAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.disassociate_signin_delegate_groups_from_account_response.DisassociateSigninDelegateGroupsFromAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.disassociate_signin_delegate_groups_from_account.async_disassociate_signin_delegate_groups_from_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.get_account_request.GetAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.get_account_response.GetAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_account.async_get_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.get_account_settings_request.GetAccountSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.get_account_settings_response.GetAccountSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_account_settings.async_get_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_bot(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.get_bot_request.GetBotRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.get_bot_response.GetBotResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_bot.async_get_bot(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_events_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.get_events_configuration_request.GetEventsConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.get_events_configuration_response.GetEventsConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_events_configuration.async_get_events_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_global_settings(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_global_settings.async_get_global_settings(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_phone_number(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.get_phone_number_request.GetPhoneNumberRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.get_phone_number_response.GetPhoneNumberResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_phone_number.async_get_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_phone_number_order(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.get_phone_number_order_request.GetPhoneNumberOrderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.get_phone_number_order_response.GetPhoneNumberOrderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_phone_number_order.async_get_phone_number_order(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_phone_number_settings(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_phone_number_settings.async_get_phone_number_settings(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_retention_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.get_retention_settings_request.GetRetentionSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.get_retention_settings_response.GetRetentionSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_retention_settings.async_get_retention_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_room(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.get_room_request.GetRoomRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.get_room_response.GetRoomResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_room.async_get_room(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.get_user_request.GetUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.get_user_response.GetUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_user.async_get_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_user_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.get_user_settings_request.GetUserSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.get_user_settings_response.GetUserSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.get_user_settings.async_get_user_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def invite_users(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.invite_users_request.InviteUsersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.invite_users_response.InviteUsersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.invite_users.async_invite_users(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_accounts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.list_accounts_request.ListAccountsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.list_accounts_response.ListAccountsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.list_accounts.async_list_accounts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_bots(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.list_bots_request.ListBotsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.list_bots_response.ListBotsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.list_bots.async_list_bots(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_phone_number_orders(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.list_phone_number_orders_request.ListPhoneNumberOrdersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.list_phone_number_orders_response.ListPhoneNumberOrdersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.list_phone_number_orders.async_list_phone_number_orders(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_phone_numbers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.list_phone_numbers_request.ListPhoneNumbersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.list_phone_numbers_response.ListPhoneNumbersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.list_phone_numbers.async_list_phone_numbers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_room_memberships(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.list_room_memberships_request.ListRoomMembershipsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.list_room_memberships_response.ListRoomMembershipsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.list_room_memberships.async_list_room_memberships(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_rooms(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.list_rooms_request.ListRoomsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.list_rooms_response.ListRoomsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.list_rooms.async_list_rooms(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_supported_phone_number_countries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.list_supported_phone_number_countries_request.ListSupportedPhoneNumberCountriesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.list_supported_phone_number_countries_response.ListSupportedPhoneNumberCountriesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.list_supported_phone_number_countries.async_list_supported_phone_number_countries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_users(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.list_users_request.ListUsersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.list_users_response.ListUsersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.list_users.async_list_users(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def logout_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.logout_user_request.LogoutUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.logout_user_response.LogoutUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.logout_user.async_logout_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_events_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.put_events_configuration_request.PutEventsConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.put_events_configuration_response.PutEventsConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.put_events_configuration.async_put_events_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_retention_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.put_retention_settings_request.PutRetentionSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.put_retention_settings_response.PutRetentionSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.put_retention_settings.async_put_retention_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def redact_conversation_message(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.redact_conversation_message_request.RedactConversationMessageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.redact_conversation_message_response.RedactConversationMessageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.redact_conversation_message.async_redact_conversation_message(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def redact_room_message(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.redact_room_message_request.RedactRoomMessageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.redact_room_message_response.RedactRoomMessageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.redact_room_message.async_redact_room_message(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def regenerate_security_token(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.regenerate_security_token_request.RegenerateSecurityTokenRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.regenerate_security_token_response.RegenerateSecurityTokenResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.regenerate_security_token.async_regenerate_security_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reset_personal_pin(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.reset_personal_pin_request.ResetPersonalPINRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.reset_personal_pin_response.ResetPersonalPINResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.reset_personal_pin.async_reset_personal_pin(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def restore_phone_number(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.restore_phone_number_request.RestorePhoneNumberRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.restore_phone_number_response.RestorePhoneNumberResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.restore_phone_number.async_restore_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_available_phone_numbers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.search_available_phone_numbers_request.SearchAvailablePhoneNumbersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.search_available_phone_numbers_response.SearchAvailablePhoneNumbersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.search_available_phone_numbers.async_search_available_phone_numbers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.update_account_request.UpdateAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.update_account_response.UpdateAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.update_account.async_update_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.update_account_settings_request.UpdateAccountSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.update_account_settings_response.UpdateAccountSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.update_account_settings.async_update_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_bot(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.update_bot_request.UpdateBotRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.update_bot_response.UpdateBotResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.update_bot.async_update_bot(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_global_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.update_global_settings_request.UpdateGlobalSettingsRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.update_global_settings.async_update_global_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_phone_number(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.update_phone_number_request.UpdatePhoneNumberRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.update_phone_number_response.UpdatePhoneNumberResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.update_phone_number.async_update_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_phone_number_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.update_phone_number_settings_request.UpdatePhoneNumberSettingsRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.update_phone_number_settings.async_update_phone_number_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_room(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.update_room_request.UpdateRoomRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.update_room_response.UpdateRoomResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.update_room.async_update_room(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_room_membership(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.update_room_membership_request.UpdateRoomMembershipRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.update_room_membership_response.UpdateRoomMembershipResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.update_room_membership.async_update_room_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.update_user_request.UpdateUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime.types.update_user_response.UpdateUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.update_user.async_update_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime.types.update_user_settings_request.UpdateUserSettingsRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime._operations.uc_buzz_console_service.update_user_settings.async_update_user_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
