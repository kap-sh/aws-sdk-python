"""Generated from Smithy shape ``com.amazonaws.chime#LogoutUser``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.logout_user_response.LogoutUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_chime.types.logout_user_request.LogoutUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def logout_user(
    ...
    aws_sdk_chime.types.logout_user_response.LogoutUserResponse, zapros.Response
]:
