"""Generated from Smithy shape ``com.amazonaws.chime#RegenerateSecurityToken``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.regenerate_security_token_response.RegenerateSecurityTokenResponse = aws_sdk_chime.types.regenerate_security_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.regenerate_security_token_request.RegenerateSecurityTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_regenerate_security_token(
