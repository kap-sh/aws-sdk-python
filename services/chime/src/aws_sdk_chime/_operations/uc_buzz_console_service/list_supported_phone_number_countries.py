...
def handle_response(
    ...
    out: aws_sdk_chime.types.list_supported_phone_number_countries_response.ListSupportedPhoneNumberCountriesResponse = aws_sdk_chime.types.list_supported_phone_number_countries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.list_supported_phone_number_countries_request.ListSupportedPhoneNumberCountriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
