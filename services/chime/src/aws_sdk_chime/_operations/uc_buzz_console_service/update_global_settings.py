...
def build_request(
    ...
    input_: aws_sdk_chime.types.update_global_settings_request.UpdateGlobalSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.update_global_settings_request.serialize_json(input_)
    ).encode()
