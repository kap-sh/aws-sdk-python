...
def build_request(
    ...
    input: aws_sdk_chime.types.update_global_settings_request.UpdateGlobalSettingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.update_global_settings_request.serialize_json(input)
    ).encode()
