...
def handle_response(
    ...
    out: aws_sdk_chime.types.search_available_phone_numbers_response.SearchAvailablePhoneNumbersResponse = aws_sdk_chime.types.search_available_phone_numbers_response.deserialize_json(
