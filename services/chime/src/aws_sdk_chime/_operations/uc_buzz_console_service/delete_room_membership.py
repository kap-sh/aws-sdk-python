"""Generated from Smithy shape ``com.amazonaws.chime#DeleteRoomMembership``."""
...
def build_request(
    ...
    input_: aws_sdk_chime.types.delete_room_membership_request.DeleteRoomMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_room_membership(
