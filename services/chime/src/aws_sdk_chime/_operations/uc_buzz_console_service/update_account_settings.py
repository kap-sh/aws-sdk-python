...
def handle_response(
    ...
    out: aws_sdk_chime.types.update_account_settings_response.UpdateAccountSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_chime.types.update_account_settings_request.UpdateAccountSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.update_account_settings_request.serialize_json(input_)
    ).encode()
