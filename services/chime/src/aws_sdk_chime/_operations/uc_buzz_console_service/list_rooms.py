"""Generated from Smithy shape ``com.amazonaws.chime#ListRooms``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.list_rooms_response.ListRoomsResponse = (
        aws_sdk_chime.types.list_rooms_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.list_rooms_request.ListRoomsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "member_id" in input_:
        params["member-id"] = str(input_["member_id"])
...
def list_rooms(
    ...
    input_: aws_sdk_chime.types.list_rooms_request.ListRoomsRequest,
) -> tuple[aws_sdk_chime.types.list_rooms_response.ListRoomsResponse, zapros.Response]:
