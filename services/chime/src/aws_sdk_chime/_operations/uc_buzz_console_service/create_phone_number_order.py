...
def build_request(
    ...
    input: aws_sdk_chime.types.create_phone_number_order_request.CreatePhoneNumberOrderRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.create_phone_number_order_request.serialize_json(input)
    ).encode()
