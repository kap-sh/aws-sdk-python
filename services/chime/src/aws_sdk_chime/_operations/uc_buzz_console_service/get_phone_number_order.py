...
def handle_response(
    ...
    out: aws_sdk_chime.types.get_phone_number_order_response.GetPhoneNumberOrderResponse = aws_sdk_chime.types.get_phone_number_order_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.get_phone_number_order_request.GetPhoneNumberOrderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
