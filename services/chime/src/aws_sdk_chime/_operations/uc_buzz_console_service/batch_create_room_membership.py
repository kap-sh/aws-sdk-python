"""Generated from Smithy shape ``com.amazonaws.chime#BatchCreateRoomMembership``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.batch_create_room_membership_response.BatchCreateRoomMembershipResponse = aws_sdk_chime.types.batch_create_room_membership_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.batch_create_room_membership_request.BatchCreateRoomMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{RoomId}", quote(str(input_["room_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.batch_create_room_membership_request.serialize_json(input_)
    ).encode()
...
async def async_batch_create_room_membership(
