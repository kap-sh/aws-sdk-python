...
def handle_response(
    ...
    out: aws_sdk_chime.types.reset_personal_pin_response.ResetPersonalPINResponse = (
        aws_sdk_chime.types.reset_personal_pin_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.reset_personal_pin_request.ResetPersonalPINRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
