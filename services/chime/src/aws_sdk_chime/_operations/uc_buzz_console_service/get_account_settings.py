"""Generated from Smithy shape ``com.amazonaws.chime#GetAccountSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.get_account_settings_response.GetAccountSettingsResponse = aws_sdk_chime.types.get_account_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.get_account_settings_request.GetAccountSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
