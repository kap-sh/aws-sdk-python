"""Generated from Smithy shape ``com.amazonaws.chime#UpdatePhoneNumberSettings``."""
...
def build_request(
    ...
    input_: aws_sdk_chime.types.update_phone_number_settings_request.UpdatePhoneNumberSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.update_phone_number_settings_request.serialize_json(input_)
    ).encode()
...
async def async_update_phone_number_settings(
