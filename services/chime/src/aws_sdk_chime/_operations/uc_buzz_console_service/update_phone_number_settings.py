...
def build_request(
    ...
    input: aws_sdk_chime.types.update_phone_number_settings_request.UpdatePhoneNumberSettingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.update_phone_number_settings_request.serialize_json(input)
    ).encode()
