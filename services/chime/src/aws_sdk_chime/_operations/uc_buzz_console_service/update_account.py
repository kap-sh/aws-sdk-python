...
def handle_response(
    ...
    out: aws_sdk_chime.types.update_account_response.UpdateAccountResponse = (
        aws_sdk_chime.types.update_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.update_account_request.UpdateAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.update_account_request.serialize_json(input_)
    ).encode()
...
def update_account(
    ...
    aws_sdk_chime.types.update_account_response.UpdateAccountResponse, zapros.Response
]:
