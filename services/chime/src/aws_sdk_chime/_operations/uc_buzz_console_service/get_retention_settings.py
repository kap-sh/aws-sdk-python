"""Generated from Smithy shape ``com.amazonaws.chime#GetRetentionSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.get_retention_settings_response.GetRetentionSettingsResponse = aws_sdk_chime.types.get_retention_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.get_retention_settings_request.GetRetentionSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_retention_settings(
