"""Generated from Smithy shape ``com.amazonaws.chime#RestorePhoneNumber``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.restore_phone_number_response.RestorePhoneNumberResponse = aws_sdk_chime.types.restore_phone_number_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime.types.restore_phone_number_request.RestorePhoneNumberRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/phone-numbers/{PhoneNumberId}?operation=restore"
...
async def async_restore_phone_number(
