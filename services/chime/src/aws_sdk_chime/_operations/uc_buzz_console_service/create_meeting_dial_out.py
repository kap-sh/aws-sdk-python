...
def handle_response(
    ...
    out: aws_sdk_chime.types.create_meeting_dial_out_response.CreateMeetingDialOutResponse = aws_sdk_chime.types.create_meeting_dial_out_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.create_meeting_dial_out_request.CreateMeetingDialOutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.create_meeting_dial_out_request.serialize_json(input_)
    ).encode()
