...
def build_request(
    ...
    input: aws_sdk_chime.types.create_meeting_dial_out_request.CreateMeetingDialOutRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.create_meeting_dial_out_request.serialize_json(input)
    ).encode()
