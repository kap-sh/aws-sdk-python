...
def handle_response(
    ...
    out: aws_sdk_chime.types.list_room_memberships_response.ListRoomMembershipsResponse = aws_sdk_chime.types.list_room_memberships_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.list_room_memberships_request.ListRoomMembershipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
