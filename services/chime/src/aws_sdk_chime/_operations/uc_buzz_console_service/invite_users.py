...
def handle_response(
    ...
    out: aws_sdk_chime.types.invite_users_response.InviteUsersResponse = (
        aws_sdk_chime.types.invite_users_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.invite_users_request.InviteUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.invite_users_request.serialize_json(input_)
    ).encode()
...
def invite_users(
    ...
    aws_sdk_chime.types.invite_users_response.InviteUsersResponse, zapros.Response
]:
