...
def handle_response(
    ...
    out: aws_sdk_chime.types.get_phone_number_settings_response.GetPhoneNumberSettingsResponse = aws_sdk_chime.types.get_phone_number_settings_response.deserialize_json(
