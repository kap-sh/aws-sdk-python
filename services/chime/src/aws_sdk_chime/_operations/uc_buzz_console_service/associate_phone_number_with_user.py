"""Generated from Smithy shape ``com.amazonaws.chime#AssociatePhoneNumberWithUser``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            import aws_sdk_chime.errors.access_denied_exception

            raise aws_sdk_chime.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chime.types.associate_phone_number_with_user_response.AssociatePhoneNumberWithUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_chime.types.associate_phone_number_with_user_request.AssociatePhoneNumberWithUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.associate_phone_number_with_user_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_phone_number_with_user(
