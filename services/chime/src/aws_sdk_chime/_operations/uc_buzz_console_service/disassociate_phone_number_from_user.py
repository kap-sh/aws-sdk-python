...
def handle_response(
    ...
    out: aws_sdk_chime.types.disassociate_phone_number_from_user_response.DisassociatePhoneNumberFromUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_chime.types.disassociate_phone_number_from_user_request.DisassociatePhoneNumberFromUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
