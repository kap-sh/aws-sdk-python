...
def handle_response(
    ...
    out: aws_sdk_chime.types.update_room_response.UpdateRoomResponse = (
        aws_sdk_chime.types.update_room_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.update_room_request.UpdateRoomRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.update_room_request.serialize_json(input_)
    ).encode()
...
def update_room(
    ...
    aws_sdk_chime.types.update_room_response.UpdateRoomResponse, zapros.Response
]:
