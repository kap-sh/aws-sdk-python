...
def handle_response(
    ...
    out: aws_sdk_chime.types.put_events_configuration_response.PutEventsConfigurationResponse = aws_sdk_chime.types.put_events_configuration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime.types.put_events_configuration_request.PutEventsConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.put_events_configuration_request.serialize_json(input)
    ).encode()
