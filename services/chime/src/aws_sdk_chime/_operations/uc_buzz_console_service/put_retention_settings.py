"""Generated from Smithy shape ``com.amazonaws.chime#PutRetentionSettings``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_chime.errors.conflict_exception

            raise aws_sdk_chime.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chime.types.put_retention_settings_response.PutRetentionSettingsResponse = aws_sdk_chime.types.put_retention_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.put_retention_settings_request.PutRetentionSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AccountId}/retention-settings"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.put_retention_settings_request.serialize_json(input_)
    ).encode()
...
async def async_put_retention_settings(
