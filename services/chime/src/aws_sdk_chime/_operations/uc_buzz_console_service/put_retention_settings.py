...
def build_request(
    ...
    input: aws_sdk_chime.types.put_retention_settings_request.PutRetentionSettingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.put_retention_settings_request.serialize_json(input)
    ).encode()
