...
def handle_response(
    ...
    out: aws_sdk_chime.types.batch_suspend_user_response.BatchSuspendUserResponse = (
        aws_sdk_chime.types.batch_suspend_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.batch_suspend_user_request.BatchSuspendUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.batch_suspend_user_request.serialize_json(input_)
    ).encode()
