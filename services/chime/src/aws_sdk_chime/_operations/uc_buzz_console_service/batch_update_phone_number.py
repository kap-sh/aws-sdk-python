...
def build_request(
    ...
    input: aws_sdk_chime.types.batch_update_phone_number_request.BatchUpdatePhoneNumberRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.batch_update_phone_number_request.serialize_json(input)
    ).encode()
