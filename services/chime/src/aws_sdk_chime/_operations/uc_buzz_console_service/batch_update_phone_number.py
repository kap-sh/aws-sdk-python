"""Generated from Smithy shape ``com.amazonaws.chime#BatchUpdatePhoneNumber``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.batch_update_phone_number_response.BatchUpdatePhoneNumberResponse = aws_sdk_chime.types.batch_update_phone_number_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.batch_update_phone_number_request.BatchUpdatePhoneNumberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.batch_update_phone_number_request.serialize_json(input_)
    ).encode()
