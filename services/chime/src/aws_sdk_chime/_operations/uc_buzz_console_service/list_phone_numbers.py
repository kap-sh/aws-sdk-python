"""Generated from Smithy shape ``com.amazonaws.chime#ListPhoneNumbers``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.list_phone_numbers_response.ListPhoneNumbersResponse = (
        aws_sdk_chime.types.list_phone_numbers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.list_phone_numbers_request.ListPhoneNumbersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
