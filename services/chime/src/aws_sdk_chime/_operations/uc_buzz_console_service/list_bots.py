...
def handle_response(
    ...
    out: aws_sdk_chime.types.list_bots_response.ListBotsResponse = (
        aws_sdk_chime.types.list_bots_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.list_bots_request.ListBotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_bots(
    ...
    input_: aws_sdk_chime.types.list_bots_request.ListBotsRequest,
) -> tuple[aws_sdk_chime.types.list_bots_response.ListBotsResponse, zapros.Response]:
