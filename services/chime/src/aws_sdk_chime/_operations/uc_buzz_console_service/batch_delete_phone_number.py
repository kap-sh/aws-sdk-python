...
def build_request(
    ...
    input: aws_sdk_chime.types.batch_delete_phone_number_request.BatchDeletePhoneNumberRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.batch_delete_phone_number_request.serialize_json(input)
    ).encode()
