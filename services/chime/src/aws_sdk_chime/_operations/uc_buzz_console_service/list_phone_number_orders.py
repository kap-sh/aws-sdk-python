"""Generated from Smithy shape ``com.amazonaws.chime#ListPhoneNumberOrders``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.list_phone_number_orders_response.ListPhoneNumberOrdersResponse = aws_sdk_chime.types.list_phone_number_orders_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.list_phone_number_orders_request.ListPhoneNumberOrdersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_phone_number_orders(
