...
def build_request(
    ...
    input: aws_sdk_chime.types.update_room_membership_request.UpdateRoomMembershipRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.update_room_membership_request.serialize_json(input)
    ).encode()
