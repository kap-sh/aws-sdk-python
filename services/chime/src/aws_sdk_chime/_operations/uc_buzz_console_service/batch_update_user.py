"""Generated from Smithy shape ``com.amazonaws.chime#BatchUpdateUser``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.batch_update_user_response.BatchUpdateUserResponse = (
        aws_sdk_chime.types.batch_update_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.batch_update_user_request.BatchUpdateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AccountId}/users"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.batch_update_user_request.serialize_json(input_)
    ).encode()
...
async def async_batch_update_user(
