...
def build_request(
    ...
    input: aws_sdk_chime.types.create_room_membership_request.CreateRoomMembershipRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.create_room_membership_request.serialize_json(input)
    ).encode()
