...
def handle_response(
    ...
    out: aws_sdk_chime.types.create_room_membership_response.CreateRoomMembershipResponse = aws_sdk_chime.types.create_room_membership_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.create_room_membership_request.CreateRoomMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.create_room_membership_request.serialize_json(input_)
    ).encode()
