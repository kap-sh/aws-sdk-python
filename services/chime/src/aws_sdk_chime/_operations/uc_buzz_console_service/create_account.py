...
def handle_response(
    ...
    out: aws_sdk_chime.types.create_account_response.CreateAccountResponse = (
        aws_sdk_chime.types.create_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.create_account_request.CreateAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime.types.create_account_request.serialize_json(input_)
    ).encode()
...
def create_account(
    ...
    aws_sdk_chime.types.create_account_response.CreateAccountResponse, zapros.Response
]:
