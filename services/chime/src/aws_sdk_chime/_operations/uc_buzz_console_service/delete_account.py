...
import aws_sdk_chime.errors.unprocessable_entity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnprocessableEntityException":
            raise aws_sdk_chime.errors.unprocessable_entity_exception.UnprocessableEntityException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_chime.types.delete_account_response.DeleteAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_chime.types.delete_account_request.DeleteAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_account(
    ...
    aws_sdk_chime.types.delete_account_response.DeleteAccountResponse, zapros.Response
]:
