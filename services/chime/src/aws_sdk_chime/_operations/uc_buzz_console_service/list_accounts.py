"""Generated from Smithy shape ``com.amazonaws.chime#ListAccounts``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.list_accounts_response.ListAccountsResponse = (
        aws_sdk_chime.types.list_accounts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.list_accounts_request.ListAccountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "user_email" in input_:
        params["user-email"] = str(input_["user_email"])
...
def list_accounts(
    ...
    aws_sdk_chime.types.list_accounts_response.ListAccountsResponse, zapros.Response
]:
