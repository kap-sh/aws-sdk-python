...
def handle_response(
    ...
    out: aws_sdk_chime.types.list_users_response.ListUsersResponse = (
        aws_sdk_chime.types.list_users_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime.types.list_users_request.ListUsersRequest,
) -> zapros.Request:
    ...
    if "user_type" in input:
        params["user-type"] = str(input["user_type"])
...
def list_users(
    ...
    input: aws_sdk_chime.types.list_users_request.ListUsersRequest,
) -> tuple[aws_sdk_chime.types.list_users_response.ListUsersResponse, zapros.Response]:
