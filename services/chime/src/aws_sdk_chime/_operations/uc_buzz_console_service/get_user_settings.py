...
def handle_response(
    ...
    out: aws_sdk_chime.types.get_user_settings_response.GetUserSettingsResponse = (
        aws_sdk_chime.types.get_user_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime.types.get_user_settings_request.GetUserSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
