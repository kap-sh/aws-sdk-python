"""Generated from Smithy shape ``com.amazonaws.chime#GetPhoneNumber``."""
...
def handle_response(
    ...
    out: aws_sdk_chime.types.get_phone_number_response.GetPhoneNumberResponse = (
        aws_sdk_chime.types.get_phone_number_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime.types.get_phone_number_request.GetPhoneNumberRequest,
) -> zapros.Request:
