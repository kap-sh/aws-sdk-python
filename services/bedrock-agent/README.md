...
```
pip install aws-sdk-bedrock-agent
```

## Usage

```python
from aws_sdk_bedrock_agent import AsyncBedrockAgentClient
...
```python
from aws_sdk_bedrock_agent import AsyncBedrockAgentClient
from aws_sdk_bedrock_agent.error import AccessDeniedException
