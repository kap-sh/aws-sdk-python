...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agent.types.create_knowledge_base_request
    import aws_sdk_bedrock_agent.types.create_knowledge_base_response
    import aws_sdk_bedrock_agent.types.delete_knowledge_base_request
    import aws_sdk_bedrock_agent.types.delete_knowledge_base_response
    import aws_sdk_bedrock_agent.types.description
    import aws_sdk_bedrock_agent.types.disassociate_agent_knowledge_base_request
    import aws_sdk_bedrock_agent.types.disassociate_agent_knowledge_base_response
    ...
    import aws_sdk_bedrock_agent.types.list_agent_knowledge_bases_request
    import aws_sdk_bedrock_agent.types.list_agent_knowledge_bases_response
    import aws_sdk_bedrock_agent.types.list_knowledge_bases_request
    import aws_sdk_bedrock_agent.types.list_knowledge_bases_response
...
class KnowledgeBaseResource:
    ...
    def associate_agent_knowledge_base(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.associate_agent_knowledge_base_request.AssociateAgentKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.associate_agent_knowledge_base_response.AssociateAgentKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.associate_agent_knowledge_base

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.associate_agent_knowledge_base.associate_agent_knowledge_base(
    ...
    def create_knowledge_base(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agent.types.create_knowledge_base_response.CreateKnowledgeBaseResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.create_knowledge_base_request.CreateKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.create_knowledge_base_response.CreateKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.create_knowledge_base

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.create_knowledge_base.create_knowledge_base(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_knowledge_base(
        ...
        *,
        config_overrides: Optional[BedrockAgentClientConfig] = None,
    ) -> "aws_sdk_bedrock_agent.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.delete_knowledge_base_request.DeleteKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.delete_knowledge_base

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.delete_knowledge_base.delete_knowledge_base(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_agent_knowledge_base(
        ...
        *,
        config_overrides: Optional[BedrockAgentClientConfig] = None,
    ) -> "aws_sdk_bedrock_agent.types.disassociate_agent_knowledge_base_response.DisassociateAgentKnowledgeBaseResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.disassociate_agent_knowledge_base_request.DisassociateAgentKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.disassociate_agent_knowledge_base_response.DisassociateAgentKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.disassociate_agent_knowledge_base

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.disassociate_agent_knowledge_base.disassociate_agent_knowledge_base(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_agent_knowledge_base(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.get_agent_knowledge_base_request.GetAgentKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.get_agent_knowledge_base_response.GetAgentKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_agent_knowledge_base

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_agent_knowledge_base.get_agent_knowledge_base(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_knowledge_base(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.get_knowledge_base_request.GetKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.get_knowledge_base_response.GetKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_knowledge_base

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_knowledge_base.get_knowledge_base(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_agent_knowledge_bases(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agent.types.list_agent_knowledge_bases_response.ListAgentKnowledgeBasesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.list_agent_knowledge_bases_request.ListAgentKnowledgeBasesRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.list_agent_knowledge_bases_response.ListAgentKnowledgeBasesResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_agent_knowledge_bases

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_agent_knowledge_bases.list_agent_knowledge_bases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_knowledge_bases(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_bedrock_agent.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_bedrock_agent.types.list_knowledge_bases_response.ListKnowledgeBasesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.list_knowledge_bases_request.ListKnowledgeBasesRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.list_knowledge_bases_response.ListKnowledgeBasesResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_knowledge_bases

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_knowledge_bases.list_knowledge_bases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_agent_knowledge_base(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.update_agent_knowledge_base_request.UpdateAgentKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.update_agent_knowledge_base_response.UpdateAgentKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_agent_knowledge_base

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_agent_knowledge_base.update_agent_knowledge_base(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_knowledge_base(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.update_knowledge_base_request.UpdateKnowledgeBaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.update_knowledge_base_response.UpdateKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_knowledge_base

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_knowledge_base.update_knowledge_base(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncKnowledgeBaseResource:
    ...
    async def associate_agent_knowledge_base(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.associate_agent_knowledge_base_request.AssociateAgentKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.associate_agent_knowledge_base_response.AssociateAgentKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.associate_agent_knowledge_base
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.associate_agent_knowledge_base.async_associate_agent_knowledge_base(
                req.options, req.input
            )
    ...
    async def create_knowledge_base(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.create_knowledge_base_request.CreateKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.create_knowledge_base_response.CreateKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.create_knowledge_base
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.create_knowledge_base.async_create_knowledge_base(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_knowledge_base(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.delete_knowledge_base_request.DeleteKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.delete_knowledge_base
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.delete_knowledge_base.async_delete_knowledge_base(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_agent_knowledge_base(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.disassociate_agent_knowledge_base_request.DisassociateAgentKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.disassociate_agent_knowledge_base_response.DisassociateAgentKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.disassociate_agent_knowledge_base
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.disassociate_agent_knowledge_base.async_disassociate_agent_knowledge_base(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_agent_knowledge_base(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.get_agent_knowledge_base_request.GetAgentKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.get_agent_knowledge_base_response.GetAgentKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_agent_knowledge_base
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_agent_knowledge_base.async_get_agent_knowledge_base(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_knowledge_base(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.get_knowledge_base_request.GetKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.get_knowledge_base_response.GetKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_knowledge_base
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_knowledge_base.async_get_knowledge_base(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_agent_knowledge_bases(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.list_agent_knowledge_bases_request.ListAgentKnowledgeBasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.list_agent_knowledge_bases_response.ListAgentKnowledgeBasesResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_agent_knowledge_bases
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_agent_knowledge_bases.async_list_agent_knowledge_bases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_knowledge_bases(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.list_knowledge_bases_request.ListKnowledgeBasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.list_knowledge_bases_response.ListKnowledgeBasesResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_knowledge_bases
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_knowledge_bases.async_list_knowledge_bases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_agent_knowledge_base(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.update_agent_knowledge_base_request.UpdateAgentKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.update_agent_knowledge_base_response.UpdateAgentKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_agent_knowledge_base
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_agent_knowledge_base.async_update_agent_knowledge_base(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_knowledge_base(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.update_knowledge_base_request.UpdateKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.update_knowledge_base_response.UpdateKnowledgeBaseResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_knowledge_base
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_knowledge_base.async_update_knowledge_base(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
