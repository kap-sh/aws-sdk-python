...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agent.types.delete_agent_action_group_request
    import aws_sdk_bedrock_agent.types.delete_agent_action_group_response
    ...
    import aws_sdk_bedrock_agent.types.list_agent_action_groups_request
    import aws_sdk_bedrock_agent.types.list_agent_action_groups_response
    ...
    import aws_sdk_bedrock_agent.types.update_agent_action_group_request
    import aws_sdk_bedrock_agent.types.update_agent_action_group_response
...
class ActionGroupResource:
    ...
    def create_agent_action_group(
        ...
        *,
        ...
        api_schema: Optional["aws_sdk_bedrock_agent.types.api_schema.APISchema"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.create_agent_action_group_request.CreateAgentActionGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.create_agent_action_group_response.CreateAgentActionGroupResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.create_agent_action_group

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.create_agent_action_group.create_agent_action_group(
    ...
    def delete_agent_action_group(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agent.types.delete_agent_action_group_response.DeleteAgentActionGroupResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.delete_agent_action_group_request.DeleteAgentActionGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.delete_agent_action_group_response.DeleteAgentActionGroupResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.delete_agent_action_group

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.delete_agent_action_group.delete_agent_action_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_agent_action_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.get_agent_action_group_request.GetAgentActionGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.get_agent_action_group_response.GetAgentActionGroupResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_agent_action_group

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_agent_action_group.get_agent_action_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_agent_action_groups(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agent.types.list_agent_action_groups_response.ListAgentActionGroupsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.list_agent_action_groups_request.ListAgentActionGroupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.list_agent_action_groups_response.ListAgentActionGroupsResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_agent_action_groups

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_agent_action_groups.list_agent_action_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_agent_action_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent.types.update_agent_action_group_request.UpdateAgentActionGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent.types.update_agent_action_group_response.UpdateAgentActionGroupResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_agent_action_group

            output, http_response = (
                aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_agent_action_group.update_agent_action_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncActionGroupResource:
    ...
    async def create_agent_action_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.create_agent_action_group_request.CreateAgentActionGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.create_agent_action_group_response.CreateAgentActionGroupResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.create_agent_action_group
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.create_agent_action_group.async_create_agent_action_group(
                req.options, req.input
            )
    ...
    async def delete_agent_action_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.delete_agent_action_group_request.DeleteAgentActionGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.delete_agent_action_group_response.DeleteAgentActionGroupResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.delete_agent_action_group
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.delete_agent_action_group.async_delete_agent_action_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_agent_action_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.get_agent_action_group_request.GetAgentActionGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.get_agent_action_group_response.GetAgentActionGroupResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_agent_action_group
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.get_agent_action_group.async_get_agent_action_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_agent_action_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.list_agent_action_groups_request.ListAgentActionGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.list_agent_action_groups_response.ListAgentActionGroupsResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_agent_action_groups
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.list_agent_action_groups.async_list_agent_action_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_agent_action_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent.types.update_agent_action_group_request.UpdateAgentActionGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent.types.update_agent_action_group_response.UpdateAgentActionGroupResponse"
        ]:
            import aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_agent_action_group
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent._operations.amazon_bedrock_agent_build_time_lambda.update_agent_action_group.async_update_agent_action_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
