"""Generated from Smithy shape ``com.amazonaws.bedrockagent#MongoDbAtlasFieldMapping``."""
...
class MongoDbAtlasFieldMapping(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: MongoDbAtlasFieldMapping) -> dict:
    out: dict = {}
