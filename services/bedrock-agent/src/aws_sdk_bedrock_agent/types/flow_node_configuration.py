...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.agent_flow_node_configuration
    import aws_sdk_bedrock_agent.types.collector_flow_node_configuration
    import aws_sdk_bedrock_agent.types.condition_flow_node_configuration
    import aws_sdk_bedrock_agent.types.inline_code_flow_node_configuration
    import aws_sdk_bedrock_agent.types.input_flow_node_configuration
    import aws_sdk_bedrock_agent.types.iterator_flow_node_configuration
    import aws_sdk_bedrock_agent.types.knowledge_base_flow_node_configuration
    import aws_sdk_bedrock_agent.types.lambda_function_flow_node_configuration
    import aws_sdk_bedrock_agent.types.lex_flow_node_configuration
    import aws_sdk_bedrock_agent.types.loop_controller_flow_node_configuration
    import aws_sdk_bedrock_agent.types.loop_flow_node_configuration
    import aws_sdk_bedrock_agent.types.loop_input_flow_node_configuration
    import aws_sdk_bedrock_agent.types.output_flow_node_configuration
    import aws_sdk_bedrock_agent.types.prompt_flow_node_configuration
    import aws_sdk_bedrock_agent.types.retrieval_flow_node_configuration
...
def serialize_json(value: FlowNodeConfiguration) -> dict:
    if "input" in value:
        ...
        return {
            "input": aws_sdk_bedrock_agent.types.input_flow_node_configuration.serialize_json(
                value["input"]
            )
        }
        ...
        return {
            "output": aws_sdk_bedrock_agent.types.output_flow_node_configuration.serialize_json(
                value["output"]
            )
        }
        ...
        return {
            "knowledgeBase": aws_sdk_bedrock_agent.types.knowledge_base_flow_node_configuration.serialize_json(
                value["knowledgeBase"]
            )
        }
        ...
        return {
            "condition": aws_sdk_bedrock_agent.types.condition_flow_node_configuration.serialize_json(
                value["condition"]
            )
        }
    elif "lex" in value:
        ...
        return {
            "lex": aws_sdk_bedrock_agent.types.lex_flow_node_configuration.serialize_json(
                value["lex"]
            )
        }
        ...
        return {
            "prompt": aws_sdk_bedrock_agent.types.prompt_flow_node_configuration.serialize_json(
                value["prompt"]
            )
        }
        ...
        return {
            "lambdaFunction": aws_sdk_bedrock_agent.types.lambda_function_flow_node_configuration.serialize_json(
        ...
        return {
            "storage": aws_sdk_bedrock_agent.types.storage_flow_node_configuration.serialize_json(
                value["storage"]
            )
        }
    elif "agent" in value:
        ...
        return {
            "agent": aws_sdk_bedrock_agent.types.agent_flow_node_configuration.serialize_json(
                value["agent"]
            )
        }
        ...
        return {
            "retrieval": aws_sdk_bedrock_agent.types.retrieval_flow_node_configuration.serialize_json(
                value["retrieval"]
            )
        }
        ...
        return {
            "iterator": aws_sdk_bedrock_agent.types.iterator_flow_node_configuration.serialize_json(
                value["iterator"]
            )
        }
        ...
        return {
            "collector": aws_sdk_bedrock_agent.types.collector_flow_node_configuration.serialize_json(
                value["collector"]
            )
        }
        ...
        return {
            "inlineCode": aws_sdk_bedrock_agent.types.inline_code_flow_node_configuration.serialize_json(
                value["inlineCode"]
            )
        }
    elif "loop" in value:
        ...
        return {
            "loop": aws_sdk_bedrock_agent.types.loop_flow_node_configuration.serialize_json(
                value["loop"]
            )
        }
        ...
        return {
            "loopInput": aws_sdk_bedrock_agent.types.loop_input_flow_node_configuration.serialize_json(
                value["loopInput"]
            )
        }
        ...
        return {
            "loopController": aws_sdk_bedrock_agent.types.loop_controller_flow_node_configuration.serialize_json(
...
def deserialize_json(data: dict) -> FlowNodeConfiguration:
    if "input" in data:
        ...
        return {
            "input": aws_sdk_bedrock_agent.types.input_flow_node_configuration.deserialize_json(
                data["input"]
            )
        }
    elif "output" in data:
        ...
        return {
            "output": aws_sdk_bedrock_agent.types.output_flow_node_configuration.deserialize_json(
                data["output"]
            )
        }
        ...
        return {
            "knowledgeBase": aws_sdk_bedrock_agent.types.knowledge_base_flow_node_configuration.deserialize_json(
                data["knowledgeBase"]
            )
        }
        ...
        return {
            "condition": aws_sdk_bedrock_agent.types.condition_flow_node_configuration.deserialize_json(
                data["condition"]
            )
        }
    elif "lex" in data:
        ...
        return {
            "lex": aws_sdk_bedrock_agent.types.lex_flow_node_configuration.deserialize_json(
                data["lex"]
            )
        }
    elif "prompt" in data:
        ...
        return {
            "prompt": aws_sdk_bedrock_agent.types.prompt_flow_node_configuration.deserialize_json(
                data["prompt"]
            )
        }
        ...
        return {
            "lambdaFunction": aws_sdk_bedrock_agent.types.lambda_function_flow_node_configuration.deserialize_json(
                data["lambdaFunction"]
            )
        }
        ...
        return {
            "storage": aws_sdk_bedrock_agent.types.storage_flow_node_configuration.deserialize_json(
                data["storage"]
            )
        }
    elif "agent" in data:
        ...
        return {
            "agent": aws_sdk_bedrock_agent.types.agent_flow_node_configuration.deserialize_json(
                data["agent"]
            )
        }
        ...
        return {
            "retrieval": aws_sdk_bedrock_agent.types.retrieval_flow_node_configuration.deserialize_json(
                data["retrieval"]
            )
        }
        ...
        return {
            "iterator": aws_sdk_bedrock_agent.types.iterator_flow_node_configuration.deserialize_json(
                data["iterator"]
            )
        }
        ...
        return {
            "collector": aws_sdk_bedrock_agent.types.collector_flow_node_configuration.deserialize_json(
                data["collector"]
            )
        }
        ...
        return {
            "inlineCode": aws_sdk_bedrock_agent.types.inline_code_flow_node_configuration.deserialize_json(
                data["inlineCode"]
            )
        }
    elif "loop" in data:
        ...
        return {
            "loop": aws_sdk_bedrock_agent.types.loop_flow_node_configuration.deserialize_json(
                data["loop"]
            )
        }
        ...
        return {
            "loopInput": aws_sdk_bedrock_agent.types.loop_input_flow_node_configuration.deserialize_json(
                data["loopInput"]
            )
        }
        ...
        return {
            "loopController": aws_sdk_bedrock_agent.types.loop_controller_flow_node_configuration.deserialize_json(
                data["loopController"]
            )
        }
    else:
