...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agent.types.incompatible_loop_node_type


class LoopIncompatibleNodeTypeFlowValidationDetails(TypedDict):
    ...
    incompatible_node_type: "aws_sdk_bedrock_agent.types.incompatible_loop_node_type.IncompatibleLoopNodeType"
    ...
    incompatible_node_name: "aws_sdk_bedrock_agent.types.flow_node_name.FlowNodeName"
...
def serialize_json(value: LoopIncompatibleNodeTypeFlowValidationDetails) -> dict:
    ...
    out["incompatibleNodeType"] = (
        aws_sdk_bedrock_agent.types.incompatible_loop_node_type.serialize_json(
...
def deserialize_json(data: dict) -> LoopIncompatibleNodeTypeFlowValidationDetails:
    ...
    if "incompatibleNodeType" in data:
        ...
        out["incompatible_node_type"] = (
            aws_sdk_bedrock_agent.types.incompatible_loop_node_type.deserialize_json(
