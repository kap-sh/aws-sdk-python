...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agent.types.metadata_attributes
...
class DocumentMetadata(TypedDict, closed=True):
    ...
    inline_attributes: NotRequired[
        "aws_sdk_bedrock_agent.types.metadata_attributes.MetadataAttributes"
    ]
...
def serialize_json(value: DocumentMetadata) -> dict:
    ...
    out["type"] = aws_sdk_bedrock_agent.types.metadata_source_type.serialize_json(
        value["type"]
    )
    if "inline_attributes" in value:
        ...
        out["inlineAttributes"] = (
            aws_sdk_bedrock_agent.types.metadata_attributes.serialize_json(
...
def deserialize_json(data: dict) -> DocumentMetadata:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_bedrock_agent.types.metadata_source_type.deserialize_json(
            data["type"]
        )
    else:
    ...
    if "inlineAttributes" in data:
        ...
        out["inline_attributes"] = (
            aws_sdk_bedrock_agent.types.metadata_attributes.deserialize_json(
