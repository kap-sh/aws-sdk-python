...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.flow_connection_configuration
    import aws_sdk_bedrock_agent.types.flow_connection_name
    import aws_sdk_bedrock_agent.types.flow_connection_type
...
class FlowConnection(TypedDict, closed=True):
    ...
    configuration: NotRequired[
        "aws_sdk_bedrock_agent.types.flow_connection_configuration.FlowConnectionConfiguration"
    ]
...
def serialize_json(value: FlowConnection) -> dict:
    ...
    out["type"] = aws_sdk_bedrock_agent.types.flow_connection_type.serialize_json(
        value["type"]
    )
    out["name"] = value["name"]
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            aws_sdk_bedrock_agent.types.flow_connection_configuration.serialize_json(
                value["configuration"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> FlowConnection:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_bedrock_agent.types.flow_connection_type.deserialize_json(
            data["type"]
        )
    else:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            aws_sdk_bedrock_agent.types.flow_connection_configuration.deserialize_json(
                data["configuration"]
            )
        )
    return out
