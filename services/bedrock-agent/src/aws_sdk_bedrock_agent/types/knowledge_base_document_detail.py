...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agent.types.document_status
    import aws_sdk_bedrock_agent.types.id


class KnowledgeBaseDocumentDetail(TypedDict):
    ...
    status: "aws_sdk_bedrock_agent.types.document_status.DocumentStatus"
    ...
    identifier: "aws_sdk_bedrock_agent.types.document_identifier.DocumentIdentifier"
    ...
    updated_at: NotRequired["aws_sdk_bedrock_agent.types.date_timestamp.DateTimestamp"]
...
def serialize_json(value: KnowledgeBaseDocumentDetail) -> dict:
    ...
    out["status"] = aws_sdk_bedrock_agent.types.document_status.serialize_json(
        value["status"]
    )
    import aws_sdk_bedrock_agent.types.document_identifier

    out["identifier"] = aws_sdk_bedrock_agent.types.document_identifier.serialize_json(
        value["identifier"]
    )
...
def deserialize_json(data: dict) -> KnowledgeBaseDocumentDetail:
    ...
    if "status" in data:
        ...
        out["status"] = aws_sdk_bedrock_agent.types.document_status.deserialize_json(
            data["status"]
        )
    else:
    ...
    if "identifier" in data:
        ...
        out["identifier"] = (
            aws_sdk_bedrock_agent.types.document_identifier.deserialize_json(
                data["identifier"]
            )
        )
    else:
