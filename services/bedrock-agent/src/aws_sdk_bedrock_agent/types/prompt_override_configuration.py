...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agent.types.prompt_configurations


class PromptOverrideConfiguration(TypedDict):
    prompt_configurations: (
        "aws_sdk_bedrock_agent.types.prompt_configurations.PromptConfigurations"
    )
    ...
    override_lambda: NotRequired["aws_sdk_bedrock_agent.types.lambda_arn.LambdaArn"]
...
def serialize_json(value: PromptOverrideConfiguration) -> dict:
    ...
    out["promptConfigurations"] = (
        aws_sdk_bedrock_agent.types.prompt_configurations.serialize_json(
...
def deserialize_json(data: dict) -> PromptOverrideConfiguration:
    ...
    if "promptConfigurations" in data:
        ...
        out["prompt_configurations"] = (
            aws_sdk_bedrock_agent.types.prompt_configurations.deserialize_json(
