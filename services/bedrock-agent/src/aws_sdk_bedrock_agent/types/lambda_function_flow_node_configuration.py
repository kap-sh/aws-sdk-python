...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.flow_lambda_arn


class LambdaFunctionFlowNodeConfiguration(TypedDict):
    lambda_arn: "aws_sdk_bedrock_agent.types.flow_lambda_arn.FlowLambdaArn"
