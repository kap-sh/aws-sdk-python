...
class ListIngestionJobsResponse(TypedDict):
    ingestion_job_summaries: (
        "aws_sdk_bedrock_agent.types.ingestion_job_summaries.IngestionJobSummaries"
    )
...
def serialize_json(value: ListIngestionJobsResponse) -> dict:
    ...
    out["ingestionJobSummaries"] = (
        aws_sdk_bedrock_agent.types.ingestion_job_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListIngestionJobsResponse:
    ...
    if "ingestionJobSummaries" in data:
        ...
        out["ingestion_job_summaries"] = (
            aws_sdk_bedrock_agent.types.ingestion_job_summaries.deserialize_json(
