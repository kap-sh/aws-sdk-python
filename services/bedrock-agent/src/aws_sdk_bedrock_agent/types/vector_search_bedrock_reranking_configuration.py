"""Generated from Smithy shape ``com.amazonaws.bedrockagent#VectorSearchBedrockRerankingConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.metadata_configuration_for_reranking
    import aws_sdk_bedrock_agent.types.vector_search_bedrock_reranking_model_configuration


class VectorSearchBedrockRerankingConfiguration(TypedDict):
    model_configuration: "aws_sdk_bedrock_agent.types.vector_search_bedrock_reranking_model_configuration.VectorSearchBedrockRerankingModelConfiguration"
    ...
    metadata_configuration: NotRequired[
        "aws_sdk_bedrock_agent.types.metadata_configuration_for_reranking.MetadataConfigurationForReranking"
    ]
...
def serialize_json(value: VectorSearchBedrockRerankingConfiguration) -> dict:
    ...
    out["modelConfiguration"] = (
        aws_sdk_bedrock_agent.types.vector_search_bedrock_reranking_model_configuration.serialize_json(
    ...
    if "metadata_configuration" in value:
        ...
        out["metadataConfiguration"] = (
            aws_sdk_bedrock_agent.types.metadata_configuration_for_reranking.serialize_json(
...
def deserialize_json(data: dict) -> VectorSearchBedrockRerankingConfiguration:
    ...
    if "modelConfiguration" in data:
        ...
        out["model_configuration"] = (
            aws_sdk_bedrock_agent.types.vector_search_bedrock_reranking_model_configuration.deserialize_json(
    ...
    if "metadataConfiguration" in data:
        ...
        out["metadata_configuration"] = (
            aws_sdk_bedrock_agent.types.metadata_configuration_for_reranking.deserialize_json(
