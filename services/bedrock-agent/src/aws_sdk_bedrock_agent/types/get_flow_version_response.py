"""Generated from Smithy shape ``com.amazonaws.bedrockagent#GetFlowVersionResponse``."""
...
class GetFlowVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetFlowVersionResponse) -> dict:
    out: dict = {}
    out["name"] = value["name"]
