...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.storage_flow_node_service_configuration


class StorageFlowNodeConfiguration(TypedDict):
    service_configuration: "aws_sdk_bedrock_agent.types.storage_flow_node_service_configuration.StorageFlowNodeServiceConfiguration"
...
def serialize_json(value: StorageFlowNodeConfiguration) -> dict:
    ...
    out["serviceConfiguration"] = (
        aws_sdk_bedrock_agent.types.storage_flow_node_service_configuration.serialize_json(
...
def deserialize_json(data: dict) -> StorageFlowNodeConfiguration:
    ...
    if "serviceConfiguration" in data:
        ...
        out["service_configuration"] = (
            aws_sdk_bedrock_agent.types.storage_flow_node_service_configuration.deserialize_json(
