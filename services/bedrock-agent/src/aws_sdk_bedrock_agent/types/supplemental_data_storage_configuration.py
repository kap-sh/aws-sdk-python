...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.supplemental_data_storage_locations


class SupplementalDataStorageConfiguration(TypedDict):
    storage_locations: "aws_sdk_bedrock_agent.types.supplemental_data_storage_locations.SupplementalDataStorageLocations"
...
def serialize_json(value: SupplementalDataStorageConfiguration) -> dict:
    ...
    out["storageLocations"] = (
        aws_sdk_bedrock_agent.types.supplemental_data_storage_locations.serialize_json(
...
def deserialize_json(data: dict) -> SupplementalDataStorageConfiguration:
    ...
    if "storageLocations" in data:
        ...
        out["storage_locations"] = (
            aws_sdk_bedrock_agent.types.supplemental_data_storage_locations.deserialize_json(
