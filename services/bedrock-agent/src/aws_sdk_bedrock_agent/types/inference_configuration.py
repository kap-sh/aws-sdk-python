...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agent.types.top_k
...
class InferenceConfiguration(TypedDict, closed=True):
    ...
    top_k: NotRequired["aws_sdk_bedrock_agent.types.top_k.TopK"]
    ...
    maximum_length: NotRequired[
        "aws_sdk_bedrock_agent.types.maximum_length.MaximumLength"
    ]
