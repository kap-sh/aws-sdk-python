...
class GetAgentVersionResponse(TypedDict):
    agent_version: "aws_sdk_bedrock_agent.types.agent_version.AgentVersion"
...
def serialize_json(value: GetAgentVersionResponse) -> dict:
    ...
    out["agentVersion"] = aws_sdk_bedrock_agent.types.agent_version.serialize_json(
        value["agent_version"]
    )
    return out
...
def deserialize_json(data: dict) -> GetAgentVersionResponse:
    ...
    if "agentVersion" in data:
        ...
        out["agent_version"] = (
            aws_sdk_bedrock_agent.types.agent_version.deserialize_json(
                data["agentVersion"]
            )
        )
    else:
