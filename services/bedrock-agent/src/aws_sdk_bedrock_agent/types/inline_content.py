...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.byte_content_doc
    import aws_sdk_bedrock_agent.types.inline_content_type
...
class InlineContent(TypedDict, closed=True):
    ...
    byte_content: NotRequired[
        "aws_sdk_bedrock_agent.types.byte_content_doc.ByteContentDoc"
    ]
    """<p>Contains information about content defined inline in bytes.</p>"""
    text_content: NotRequired[
        "aws_sdk_bedrock_agent.types.text_content_doc.TextContentDoc"
    ]
...
def serialize_json(value: InlineContent) -> dict:
    ...
    out["type"] = aws_sdk_bedrock_agent.types.inline_content_type.serialize_json(
        value["type"]
    )
    if "byte_content" in value:
        ...
        out["byteContent"] = (
            aws_sdk_bedrock_agent.types.byte_content_doc.serialize_json(
                value["byte_content"]
            )
        )
    if "text_content" in value:
        ...
        out["textContent"] = (
            aws_sdk_bedrock_agent.types.text_content_doc.serialize_json(
                value["text_content"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> InlineContent:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_bedrock_agent.types.inline_content_type.deserialize_json(
            data["type"]
        )
    else:
    ...
    if "byteContent" in data:
        ...
        out["byte_content"] = (
            aws_sdk_bedrock_agent.types.byte_content_doc.deserialize_json(
                data["byteContent"]
            )
        )
    if "textContent" in data:
        ...
        out["text_content"] = (
            aws_sdk_bedrock_agent.types.text_content_doc.deserialize_json(
                data["textContent"]
            )
        )
    return out
