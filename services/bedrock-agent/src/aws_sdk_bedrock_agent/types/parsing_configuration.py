...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.bedrock_data_automation_configuration
    import aws_sdk_bedrock_agent.types.bedrock_foundation_model_configuration
    import aws_sdk_bedrock_agent.types.parsing_strategy


class ParsingConfiguration(TypedDict, closed=True):
    parsing_strategy: "aws_sdk_bedrock_agent.types.parsing_strategy.ParsingStrategy"
    """<p>The parsing strategy for the data source.</p>"""
    bedrock_foundation_model_configuration: NotRequired[
        "aws_sdk_bedrock_agent.types.bedrock_foundation_model_configuration.BedrockFoundationModelConfiguration"
    ]
    ...
    bedrock_data_automation_configuration: NotRequired[
        "aws_sdk_bedrock_agent.types.bedrock_data_automation_configuration.BedrockDataAutomationConfiguration"
    ]
...
def serialize_json(value: ParsingConfiguration) -> dict:
    ...
    out["parsingStrategy"] = (
        aws_sdk_bedrock_agent.types.parsing_strategy.serialize_json(
    ...
    if "bedrock_foundation_model_configuration" in value:
        ...
        out["bedrockFoundationModelConfiguration"] = (
            aws_sdk_bedrock_agent.types.bedrock_foundation_model_configuration.serialize_json(
    ...
    if "bedrock_data_automation_configuration" in value:
        ...
        out["bedrockDataAutomationConfiguration"] = (
            aws_sdk_bedrock_agent.types.bedrock_data_automation_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ParsingConfiguration:
    ...
    if "parsingStrategy" in data:
        ...
        out["parsing_strategy"] = (
            aws_sdk_bedrock_agent.types.parsing_strategy.deserialize_json(
    ...
    if "bedrockFoundationModelConfiguration" in data:
        ...
        out["bedrock_foundation_model_configuration"] = (
            aws_sdk_bedrock_agent.types.bedrock_foundation_model_configuration.deserialize_json(
    ...
    if "bedrockDataAutomationConfiguration" in data:
        ...
        out["bedrock_data_automation_configuration"] = (
            aws_sdk_bedrock_agent.types.bedrock_data_automation_configuration.deserialize_json(
