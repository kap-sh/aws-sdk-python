...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.hierarchical_chunking_level_configurations


class HierarchicalChunkingConfiguration(TypedDict):
    level_configurations: "aws_sdk_bedrock_agent.types.hierarchical_chunking_level_configurations.HierarchicalChunkingLevelConfigurations"
...
def serialize_json(value: HierarchicalChunkingConfiguration) -> dict:
    ...
    out["levelConfigurations"] = (
        aws_sdk_bedrock_agent.types.hierarchical_chunking_level_configurations.serialize_json(
...
def deserialize_json(data: dict) -> HierarchicalChunkingConfiguration:
    ...
    if "levelConfigurations" in data:
        ...
        out["level_configurations"] = (
            aws_sdk_bedrock_agent.types.hierarchical_chunking_level_configurations.deserialize_json(
