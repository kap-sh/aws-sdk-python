...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.flow_alias_summaries
    import aws_sdk_bedrock_agent.types.next_token


class ListFlowAliasesResponse(TypedDict):
    flow_alias_summaries: (
        "aws_sdk_bedrock_agent.types.flow_alias_summaries.FlowAliasSummaries"
    )
...
def serialize_json(value: ListFlowAliasesResponse) -> dict:
    ...
    out["flowAliasSummaries"] = (
        aws_sdk_bedrock_agent.types.flow_alias_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListFlowAliasesResponse:
    ...
    if "flowAliasSummaries" in data:
        ...
        out["flow_alias_summaries"] = (
            aws_sdk_bedrock_agent.types.flow_alias_summaries.deserialize_json(
