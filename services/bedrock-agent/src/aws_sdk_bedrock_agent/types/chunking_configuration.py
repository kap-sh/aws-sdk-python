...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent.types.chunking_strategy
    import aws_sdk_bedrock_agent.types.fixed_size_chunking_configuration
    import aws_sdk_bedrock_agent.types.hierarchical_chunking_configuration
    import aws_sdk_bedrock_agent.types.semantic_chunking_configuration


class ChunkingConfiguration(TypedDict):
    chunking_strategy: "aws_sdk_bedrock_agent.types.chunking_strategy.ChunkingStrategy"
    ...
    fixed_size_chunking_configuration: NotRequired[
        "aws_sdk_bedrock_agent.types.fixed_size_chunking_configuration.FixedSizeChunkingConfiguration"
    ]
    ...
    hierarchical_chunking_configuration: NotRequired[
        "aws_sdk_bedrock_agent.types.hierarchical_chunking_configuration.HierarchicalChunkingConfiguration"
    ]
    ...
    semantic_chunking_configuration: NotRequired[
        "aws_sdk_bedrock_agent.types.semantic_chunking_configuration.SemanticChunkingConfiguration"
    ]
...
def serialize_json(value: ChunkingConfiguration) -> dict:
    ...
    out["chunkingStrategy"] = (
        aws_sdk_bedrock_agent.types.chunking_strategy.serialize_json(
    ...
    if "fixed_size_chunking_configuration" in value:
        ...
        out["fixedSizeChunkingConfiguration"] = (
            aws_sdk_bedrock_agent.types.fixed_size_chunking_configuration.serialize_json(
    ...
    if "hierarchical_chunking_configuration" in value:
        ...
        out["hierarchicalChunkingConfiguration"] = (
            aws_sdk_bedrock_agent.types.hierarchical_chunking_configuration.serialize_json(
    ...
    if "semantic_chunking_configuration" in value:
        ...
        out["semanticChunkingConfiguration"] = (
            aws_sdk_bedrock_agent.types.semantic_chunking_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ChunkingConfiguration:
    ...
    if "chunkingStrategy" in data:
        ...
        out["chunking_strategy"] = (
            aws_sdk_bedrock_agent.types.chunking_strategy.deserialize_json(
    ...
    if "fixedSizeChunkingConfiguration" in data:
        ...
        out["fixed_size_chunking_configuration"] = (
            aws_sdk_bedrock_agent.types.fixed_size_chunking_configuration.deserialize_json(
    ...
    if "hierarchicalChunkingConfiguration" in data:
        ...
        out["hierarchical_chunking_configuration"] = (
            aws_sdk_bedrock_agent.types.hierarchical_chunking_configuration.deserialize_json(
    ...
    if "semanticChunkingConfiguration" in data:
        ...
        out["semantic_chunking_configuration"] = (
            aws_sdk_bedrock_agent.types.semantic_chunking_configuration.deserialize_json(
