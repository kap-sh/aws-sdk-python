...
def handle_response(
    ...
    out: capo_bedrock_agent.types.get_agent_knowledge_base_response.GetAgentKnowledgeBaseResponse = capo_bedrock_agent.types.get_agent_knowledge_base_response.deserialize_json(
