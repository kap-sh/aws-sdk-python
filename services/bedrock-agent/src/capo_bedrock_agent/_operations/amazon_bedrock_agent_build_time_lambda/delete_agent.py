...
def handle_response(
    ...
    out: capo_bedrock_agent.types.delete_agent_response.DeleteAgentResponse = (
        capo_bedrock_agent.types.delete_agent_response.deserialize_json(
...
def delete_agent(
    ...
    capo_bedrock_agent.types.delete_agent_response.DeleteAgentResponse, zapros.Response
]:
