"""Generated from Smithy shape ``com.amazonaws.bedrockagent#DeleteAgentAlias``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.delete_agent_alias_response.DeleteAgentAliasResponse = capo_bedrock_agent.types.delete_agent_alias_response.deserialize_json(
...
async def async_delete_agent_alias(
