...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_flows_response.ListFlowsResponse = (
        capo_bedrock_agent.types.list_flows_response.deserialize_json(
...
def list_flows(
    ...
    capo_bedrock_agent.types.list_flows_response.ListFlowsResponse, zapros.Response
]:
