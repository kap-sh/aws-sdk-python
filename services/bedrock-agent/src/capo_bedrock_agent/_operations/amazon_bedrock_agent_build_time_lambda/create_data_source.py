...
def handle_response(
    ...
    out: capo_bedrock_agent.types.create_data_source_response.CreateDataSourceResponse = capo_bedrock_agent.types.create_data_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.create_data_source_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
