...
def handle_response(
    ...
    out: capo_bedrock_agent.types.update_prompt_response.UpdatePromptResponse = (
        capo_bedrock_agent.types.update_prompt_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.update_prompt_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
