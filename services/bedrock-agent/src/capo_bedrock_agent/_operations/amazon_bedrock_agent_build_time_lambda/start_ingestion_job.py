...
def handle_response(
    ...
    out: capo_bedrock_agent.types.start_ingestion_job_response.StartIngestionJobResponse = capo_bedrock_agent.types.start_ingestion_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.start_ingestion_job_request.serialize_json(input_)
    ).encode()
