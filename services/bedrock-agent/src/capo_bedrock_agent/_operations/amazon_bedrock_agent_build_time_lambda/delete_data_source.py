...
def handle_response(
    ...
    out: capo_bedrock_agent.types.delete_data_source_response.DeleteDataSourceResponse = capo_bedrock_agent.types.delete_data_source_response.deserialize_json(
