"""Generated from Smithy shape ``com.amazonaws.bedrockagent#GetIngestionJob``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.get_ingestion_job_response.GetIngestionJobResponse = (
        capo_bedrock_agent.types.get_ingestion_job_response.deserialize_json(
...
async def async_get_ingestion_job(
