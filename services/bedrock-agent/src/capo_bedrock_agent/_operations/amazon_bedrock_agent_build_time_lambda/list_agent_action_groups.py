"""Generated from Smithy shape ``com.amazonaws.bedrockagent#ListAgentActionGroups``."""
...
import capo_bedrock_agent.types.action_group_summaries
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_agent_action_groups_response.ListAgentActionGroupsResponse = capo_bedrock_agent.types.list_agent_action_groups_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.list_agent_action_groups_request.serialize_json(input_)
    ).encode()
...
async def async_list_agent_action_groups(
