...
def handle_response(
    ...
    out: capo_bedrock_agent.types.get_knowledge_base_response.GetKnowledgeBaseResponse = capo_bedrock_agent.types.get_knowledge_base_response.deserialize_json(
