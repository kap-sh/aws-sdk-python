...
def handle_response(
    ...
    out: capo_bedrock_agent.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse = capo_bedrock_agent.types.delete_knowledge_base_response.deserialize_json(
