...
def handle_response(
    ...
    out: capo_bedrock_agent.types.update_flow_alias_response.UpdateFlowAliasResponse = (
        capo_bedrock_agent.types.update_flow_alias_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.update_flow_alias_request.serialize_json(input_)
    ).encode()
