...
def handle_response(
    ...
    out: capo_bedrock_agent.types.delete_flow_response.DeleteFlowResponse = (
        capo_bedrock_agent.types.delete_flow_response.deserialize_json(
...
def delete_flow(
    ...
    capo_bedrock_agent.types.delete_flow_response.DeleteFlowResponse, zapros.Response
]:
