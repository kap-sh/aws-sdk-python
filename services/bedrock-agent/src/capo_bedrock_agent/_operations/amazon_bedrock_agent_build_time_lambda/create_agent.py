...
def handle_response(
    ...
    out: capo_bedrock_agent.types.create_agent_response.CreateAgentResponse = (
        capo_bedrock_agent.types.create_agent_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.create_agent_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_agent(
    ...
    capo_bedrock_agent.types.create_agent_response.CreateAgentResponse, zapros.Response
]:
