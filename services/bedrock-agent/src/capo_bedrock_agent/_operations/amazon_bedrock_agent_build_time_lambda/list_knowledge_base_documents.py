...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_knowledge_base_documents_response.ListKnowledgeBaseDocumentsResponse = capo_bedrock_agent.types.list_knowledge_base_documents_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.list_knowledge_base_documents_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
