"""Generated from Smithy shape ``com.amazonaws.bedrockagent#GetFlowAlias``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.get_flow_alias_response.GetFlowAliasResponse = (
        capo_bedrock_agent.types.get_flow_alias_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{aliasIdentifier}", quote(input_["alias_identifier"], safe=""))
...
async def async_get_flow_alias(
