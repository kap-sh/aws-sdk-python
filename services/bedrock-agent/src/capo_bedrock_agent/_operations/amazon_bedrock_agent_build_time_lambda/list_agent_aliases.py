...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_agent_aliases_response.ListAgentAliasesResponse = capo_bedrock_agent.types.list_agent_aliases_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.list_agent_aliases_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
