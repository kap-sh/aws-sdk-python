...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_agent_knowledge_bases_response.ListAgentKnowledgeBasesResponse = capo_bedrock_agent.types.list_agent_knowledge_bases_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.list_agent_knowledge_bases_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
