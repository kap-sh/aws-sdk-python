"""Generated from Smithy shape ``com.amazonaws.bedrockagent#DisassociateAgentCollaborator``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.disassociate_agent_collaborator_response.DisassociateAgentCollaboratorResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_agent_collaborator(
