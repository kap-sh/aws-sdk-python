...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_agent_versions_response.ListAgentVersionsResponse = capo_bedrock_agent.types.list_agent_versions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.list_agent_versions_request.serialize_json(input_)
    ).encode()
