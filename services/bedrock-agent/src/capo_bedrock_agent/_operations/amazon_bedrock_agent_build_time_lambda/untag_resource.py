"""Generated from Smithy shape ``com.amazonaws.bedrockagent#UntagResource``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
