"""Generated from Smithy shape ``com.amazonaws.bedrockagent#CreateFlow``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.create_flow_response.CreateFlowResponse = (
        capo_bedrock_agent.types.create_flow_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.create_flow_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_flow(
    ...
    capo_bedrock_agent.types.create_flow_response.CreateFlowResponse, zapros.Response
]:
