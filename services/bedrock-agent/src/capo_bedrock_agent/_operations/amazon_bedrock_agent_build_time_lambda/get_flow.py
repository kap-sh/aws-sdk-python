...
def handle_response(
    ...
    out: capo_bedrock_agent.types.get_flow_response.GetFlowResponse = (
        capo_bedrock_agent.types.get_flow_response.deserialize_json(
...
def get_flow(
    ...
    input_: capo_bedrock_agent.types.get_flow_request.GetFlowRequest,
) -> tuple[capo_bedrock_agent.types.get_flow_response.GetFlowResponse, zapros.Response]:
