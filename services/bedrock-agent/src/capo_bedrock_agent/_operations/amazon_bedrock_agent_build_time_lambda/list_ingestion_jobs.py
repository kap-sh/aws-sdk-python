...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_ingestion_jobs_response.ListIngestionJobsResponse = capo_bedrock_agent.types.list_ingestion_jobs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.list_ingestion_jobs_request.serialize_json(input_)
    ).encode()
