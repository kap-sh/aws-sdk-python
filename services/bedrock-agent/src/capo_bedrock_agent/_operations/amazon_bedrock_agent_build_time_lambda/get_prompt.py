...
def handle_response(
    ...
    out: capo_bedrock_agent.types.get_prompt_response.GetPromptResponse = (
        capo_bedrock_agent.types.get_prompt_response.deserialize_json(
...
def get_prompt(
    ...
    capo_bedrock_agent.types.get_prompt_response.GetPromptResponse, zapros.Response
]:
