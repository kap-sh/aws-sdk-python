...
def handle_response(
    ...
    out: capo_bedrock_agent.types.stop_ingestion_job_response.StopIngestionJobResponse = capo_bedrock_agent.types.stop_ingestion_job_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ingestionJobId}", quote(input_["ingestion_job_id"], safe=""))
