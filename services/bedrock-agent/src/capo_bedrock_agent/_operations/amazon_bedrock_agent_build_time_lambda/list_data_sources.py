"""Generated from Smithy shape ``com.amazonaws.bedrockagent#ListDataSources``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_data_sources_response.ListDataSourcesResponse = (
        capo_bedrock_agent.types.list_data_sources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.list_data_sources_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
