"""Generated from Smithy shape ``com.amazonaws.bedrockagent#DeletePrompt``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.delete_prompt_response.DeletePromptResponse = (
        capo_bedrock_agent.types.delete_prompt_response.deserialize_json(
