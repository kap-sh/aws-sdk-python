...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_agent_collaborators_response.ListAgentCollaboratorsResponse = capo_bedrock_agent.types.list_agent_collaborators_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.list_agent_collaborators_request.serialize_json(input_)
    ).encode()
