...
def handle_response(
    ...
    out: capo_bedrock_agent.types.get_agent_response.GetAgentResponse = (
        capo_bedrock_agent.types.get_agent_response.deserialize_json(
...
def get_agent(
    ...
    capo_bedrock_agent.types.get_agent_response.GetAgentResponse, zapros.Response
]:
