"""Generated from Smithy shape ``com.amazonaws.bedrockagent#ListPrompts``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_prompts_response.ListPromptsResponse = (
        capo_bedrock_agent.types.list_prompts_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prompts/"
    params: list[tuple[str, str]] = []
    if "prompt_identifier" in input_:
        params.append(("promptIdentifier", input_["prompt_identifier"]))
...
def list_prompts(
    ...
    capo_bedrock_agent.types.list_prompts_response.ListPromptsResponse, zapros.Response
]:
