...
def handle_response(
    ...
    out: capo_bedrock_agent.types.validate_flow_definition_response.ValidateFlowDefinitionResponse = capo_bedrock_agent.types.validate_flow_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.validate_flow_definition_request.serialize_json(input_)
    ).encode()
