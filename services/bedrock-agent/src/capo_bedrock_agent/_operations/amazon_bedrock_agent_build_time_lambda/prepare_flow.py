"""Generated from Smithy shape ``com.amazonaws.bedrockagent#PrepareFlow``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.prepare_flow_response.PrepareFlowResponse = (
        capo_bedrock_agent.types.prepare_flow_response.deserialize_json(
...
def prepare_flow(
    ...
    capo_bedrock_agent.types.prepare_flow_response.PrepareFlowResponse, zapros.Response
]:
