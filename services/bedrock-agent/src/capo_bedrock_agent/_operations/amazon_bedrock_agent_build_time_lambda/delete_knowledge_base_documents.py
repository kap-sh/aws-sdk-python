"""Generated from Smithy shape ``com.amazonaws.bedrockagent#DeleteKnowledgeBaseDocuments``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.delete_knowledge_base_documents_response.DeleteKnowledgeBaseDocumentsResponse = capo_bedrock_agent.types.delete_knowledge_base_documents_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.delete_knowledge_base_documents_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_knowledge_base_documents(
