...
def handle_response(
    ...
    out: capo_bedrock_agent.types.delete_agent_version_response.DeleteAgentVersionResponse = capo_bedrock_agent.types.delete_agent_version_response.deserialize_json(
