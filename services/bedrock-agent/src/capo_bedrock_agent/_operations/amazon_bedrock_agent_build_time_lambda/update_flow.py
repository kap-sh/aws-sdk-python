...
def handle_response(
    ...
    out: capo_bedrock_agent.types.update_flow_response.UpdateFlowResponse = (
        capo_bedrock_agent.types.update_flow_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.update_flow_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_flow(
    ...
    capo_bedrock_agent.types.update_flow_response.UpdateFlowResponse, zapros.Response
]:
