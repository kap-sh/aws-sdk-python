...
def handle_response(
    ...
    out: capo_bedrock_agent.types.update_agent_alias_response.UpdateAgentAliasResponse = capo_bedrock_agent.types.update_agent_alias_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.update_agent_alias_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
