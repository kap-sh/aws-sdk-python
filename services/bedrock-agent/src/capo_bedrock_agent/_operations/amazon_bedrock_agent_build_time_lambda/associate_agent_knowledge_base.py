...
def handle_response(
    ...
    out: capo_bedrock_agent.types.associate_agent_knowledge_base_response.AssociateAgentKnowledgeBaseResponse = capo_bedrock_agent.types.associate_agent_knowledge_base_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.associate_agent_knowledge_base_request.serialize_json(
            input_
        )
    ).encode()
