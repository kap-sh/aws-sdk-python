"""Generated from Smithy shape ``com.amazonaws.bedrockagent#GetAgentCollaborator``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.get_agent_collaborator_response.GetAgentCollaboratorResponse = capo_bedrock_agent.types.get_agent_collaborator_response.deserialize_json(
...
async def async_get_agent_collaborator(
