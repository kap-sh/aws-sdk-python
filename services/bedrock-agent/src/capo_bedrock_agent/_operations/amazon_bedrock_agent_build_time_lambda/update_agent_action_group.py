"""Generated from Smithy shape ``com.amazonaws.bedrockagent#UpdateAgentActionGroup``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.update_agent_action_group_response.UpdateAgentActionGroupResponse = capo_bedrock_agent.types.update_agent_action_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.update_agent_action_group_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_agent_action_group(
