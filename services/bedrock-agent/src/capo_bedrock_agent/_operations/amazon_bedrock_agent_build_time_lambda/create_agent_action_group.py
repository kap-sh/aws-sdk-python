...
def handle_response(
    ...
    out: capo_bedrock_agent.types.create_agent_action_group_response.CreateAgentActionGroupResponse = capo_bedrock_agent.types.create_agent_action_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.create_agent_action_group_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
