"""Generated from Smithy shape ``com.amazonaws.bedrockagent#DeleteFlowVersion``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.delete_flow_version_response.DeleteFlowVersionResponse = capo_bedrock_agent.types.delete_flow_version_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{flowVersion}", quote(str(input_["flow_version"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_flow_version(
