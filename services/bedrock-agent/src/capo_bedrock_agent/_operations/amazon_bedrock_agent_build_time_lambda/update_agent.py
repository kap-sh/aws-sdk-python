"""Generated from Smithy shape ``com.amazonaws.bedrockagent#UpdateAgent``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent.types.update_agent_response.UpdateAgentResponse = (
        capo_bedrock_agent.types.update_agent_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent.types.update_agent_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_agent(
    ...
    capo_bedrock_agent.types.update_agent_response.UpdateAgentResponse, zapros.Response
]:
