...
def handle_response(
    ...
    out: capo_bedrock_agent.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_bedrock_agent.types.list_tags_for_resource_response.deserialize_json(
