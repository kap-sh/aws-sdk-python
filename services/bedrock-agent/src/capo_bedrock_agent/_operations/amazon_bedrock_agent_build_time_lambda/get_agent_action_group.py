...
def handle_response(
    ...
    out: capo_bedrock_agent.types.get_agent_action_group_response.GetAgentActionGroupResponse = capo_bedrock_agent.types.get_agent_action_group_response.deserialize_json(
