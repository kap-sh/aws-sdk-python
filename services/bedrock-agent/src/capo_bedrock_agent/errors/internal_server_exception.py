"""Generated from Smithy shape ``com.amazonaws.bedrockagent#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagent#InternalServerException``."""
