...
class BedrockAgentError(Exception):
    """Base class for all BedrockAgent service errors."""


class ServiceError(BedrockAgentError):
...
class SerializationError(BedrockAgentError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BedrockAgentError):
...
class WaiterFailedError(BedrockAgentError):
...
class WaiterTimeoutError(BedrockAgentError):
