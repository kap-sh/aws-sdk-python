"""Generated from Smithy shape ``com.amazonaws.bedrockagent#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagent#ResourceNotFoundException``."""
