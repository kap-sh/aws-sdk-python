...
if TYPE_CHECKING:
    import capo_bedrock_agent.types.base_prompt_template
...
class PromptConfiguration(TypedDict, closed=True):
    prompt_type: NotRequired["capo_bedrock_agent.types.prompt_type.PromptType"]
    """<p>The step in the agent sequence that this prompt configuration applies to.</p>"""
    prompt_creation_mode: NotRequired[
        "capo_bedrock_agent.types.creation_mode.CreationMode"
    ]
    ...
    prompt_state: NotRequired["capo_bedrock_agent.types.prompt_state.PromptState"]
    ...
    base_prompt_template: NotRequired[
        "capo_bedrock_agent.types.base_prompt_template.BasePromptTemplate"
    ]
    ...
    inference_configuration: NotRequired[
        "capo_bedrock_agent.types.inference_configuration.InferenceConfiguration"
    ]
    ...
    parser_mode: NotRequired["capo_bedrock_agent.types.creation_mode.CreationMode"]
...
def serialize_json(value: PromptConfiguration) -> dict:
    ...
    if "prompt_type" in value:
        ...
        out["promptType"] = capo_bedrock_agent.types.prompt_type.serialize_json(
            value["prompt_type"]
        )
    if "prompt_creation_mode" in value:
        ...
        out["promptCreationMode"] = (
            capo_bedrock_agent.types.creation_mode.serialize_json(
    ...
    if "prompt_state" in value:
        ...
        out["promptState"] = capo_bedrock_agent.types.prompt_state.serialize_json(
            value["prompt_state"]
        )
    ...
    if "inference_configuration" in value:
        ...
        out["inferenceConfiguration"] = (
            capo_bedrock_agent.types.inference_configuration.serialize_json(
    ...
    if "parser_mode" in value:
        ...
        out["parserMode"] = capo_bedrock_agent.types.creation_mode.serialize_json(
            value["parser_mode"]
        )
...
def deserialize_json(data: dict) -> PromptConfiguration:
    ...
    if "promptCreationMode" in data:
        ...
        out["prompt_creation_mode"] = (
            capo_bedrock_agent.types.creation_mode.deserialize_json(
    ...
    if "inferenceConfiguration" in data:
        ...
        out["inference_configuration"] = (
            capo_bedrock_agent.types.inference_configuration.deserialize_json(
