"""Generated from Smithy shape ``com.amazonaws.bedrockagent#UpdateFlowAliasResponse``."""
...
class UpdateFlowAliasResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateFlowAliasResponse) -> dict:
    out: dict = {}
    out["name"] = value["name"]
...
def deserialize_json(data: dict) -> UpdateFlowAliasResponse:
    out: UpdateFlowAliasResponse = {}  # type: ignore[typeddict-item]
    if "name" in data:
        out["name"] = data["name"]
    else:
        raise DeserializationError("UpdateFlowAliasResponse.name required")
    ...
    if "routingConfiguration" in data:
        ...
        raise DeserializationError(
            "UpdateFlowAliasResponse.routing_configuration required"
        )
    ...
    if "flowId" in data:
        ...
        raise DeserializationError("UpdateFlowAliasResponse.flow_id required")
    if "id" in data:
        out["id"] = data["id"]
    else:
        raise DeserializationError("UpdateFlowAliasResponse.id required")
    if "arn" in data:
        out["arn"] = data["arn"]
    else:
        raise DeserializationError("UpdateFlowAliasResponse.arn required")
    if "createdAt" in data:
        ...
        raise DeserializationError("UpdateFlowAliasResponse.created_at required")
    if "updatedAt" in data:
        ...
        raise DeserializationError("UpdateFlowAliasResponse.updated_at required")
    return out
