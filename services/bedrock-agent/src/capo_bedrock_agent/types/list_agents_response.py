...
class ListAgentsResponse(TypedDict, closed=True):
    agent_summaries: "capo_bedrock_agent.types.agent_summaries.AgentSummaries"
...
def serialize_json(value: ListAgentsResponse) -> dict:
    ...
    out["agentSummaries"] = capo_bedrock_agent.types.agent_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListAgentsResponse:
    ...
    if "agentSummaries" in data:
        ...
        out["agent_summaries"] = (
            capo_bedrock_agent.types.agent_summaries.deserialize_json(
                data["agentSummaries"]
            )
        )
    else:
