...
# --- restJson1 ser/de ---
def serialize_json(value: ListFlowVersionsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListFlowVersionsRequest:
    out: ListFlowVersionsRequest = {}  # type: ignore[typeddict-item]
    return out
