...
if TYPE_CHECKING:
    import capo_bedrock_agent.types.provisioned_model_identifier
    import capo_bedrock_agent.types.version


class AgentAliasRoutingConfigurationListItem(TypedDict, closed=True):
    agent_version: NotRequired["capo_bedrock_agent.types.version.Version"]
    """<p>The version of the agent with which the alias is associated.</p>"""
    provisioned_throughput: NotRequired[
        "capo_bedrock_agent.types.provisioned_model_identifier.ProvisionedModelIdentifier"
    ]
