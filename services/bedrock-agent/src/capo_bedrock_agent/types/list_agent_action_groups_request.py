"""Generated from Smithy shape ``com.amazonaws.bedrockagent#ListAgentActionGroupsRequest``."""
...
class ListAgentActionGroupsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListAgentActionGroupsRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListAgentActionGroupsRequest:
    out: ListAgentActionGroupsRequest = {}  # type: ignore[typeddict-item]
