...
if TYPE_CHECKING:
    ...
    import capo_auditmanager.types.event_name
...
class Evidence(TypedDict, closed=True):
    data_source: NotRequired["capo_auditmanager.types.string.String"]
    """<p> The data source where the evidence was collected from. </p>"""
    evidence_aws_account_id: NotRequired["capo_auditmanager.types.account_id.AccountId"]
    """<p> The identifier for the Amazon Web Services account. </p>"""
    time: NotRequired["capo_auditmanager.types.timestamp.Timestamp"]
    """<p> The timestamp that represents when the evidence was collected. </p>"""
    event_source: NotRequired["capo_auditmanager.types.aws_service_name.AWSServiceName"]
    """<p> The Amazon Web Services service that the evidence is collected from. </p>"""
    event_name: NotRequired["capo_auditmanager.types.event_name.EventName"]
    """<p> The name of the evidence event. </p>"""
    evidence_by_type: NotRequired["capo_auditmanager.types.string.String"]
    """<p> The type of automated evidence. </p>"""
    resources_included: NotRequired["capo_auditmanager.types.resources.Resources"]
    """<p> The list of resources that are assessed to generate the evidence. </p>"""
    attributes: NotRequired[
        "capo_auditmanager.types.evidence_attributes.EvidenceAttributes"
    ]
    ...
    iam_id: NotRequired["capo_auditmanager.types.iam_arn.IamArn"]
    """<p> The unique identifier for the user or role that's associated with the evidence. </p>"""
    compliance_check: NotRequired["capo_auditmanager.types.string.String"]
    ...
    aws_organization: NotRequired["capo_auditmanager.types.string.String"]
    """<p> The Amazon Web Services account that the evidence is collected from, and its organization path. </p>"""
    aws_account_id: NotRequired["capo_auditmanager.types.account_id.AccountId"]
    """<p> The identifier for the Amazon Web Services account. </p>"""
    evidence_folder_id: NotRequired["capo_auditmanager.types.uuid.UUID"]
    """<p> The identifier for the folder that the evidence is stored in. </p>"""
    id: NotRequired["capo_auditmanager.types.uuid.UUID"]
    """<p> The identifier for the evidence. </p>"""
    assessment_report_selection: NotRequired["capo_auditmanager.types.string.String"]
...
def serialize_json(value: Evidence) -> dict:
    ...
    if "time" in value:
        ...
        out["time"] = capo_auditmanager.types.timestamp.serialize_json(value["time"])
    ...
    if "resources_included" in value:
        ...
        out["resourcesIncluded"] = capo_auditmanager.types.resources.serialize_json(
            value["resources_included"]
        )
    if "attributes" in value:
        import capo_auditmanager.types.evidence_attributes

        out["attributes"] = capo_auditmanager.types.evidence_attributes.serialize_json(
            value["attributes"]
        )
    if "iam_id" in value:
...
def deserialize_json(data: dict) -> Evidence:
    ...
    if "attributes" in data:
        ...
        out["attributes"] = (
            capo_auditmanager.types.evidence_attributes.deserialize_json(
                data["attributes"]
            )
        )
    if "iamId" in data:
