"""Generated from Smithy shape ``com.amazonaws.auditmanager#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.auditmanager#InternalServerException``."""
