"""Generated from Smithy shape ``com.amazonaws.auditmanager#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.auditmanager#ThrottlingException``."""
