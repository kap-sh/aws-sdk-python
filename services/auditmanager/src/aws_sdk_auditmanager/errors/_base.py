...
class AuditManagerError(Exception):
    """Base class for all AuditManager service errors."""


class ServiceError(AuditManagerError):
...
class SerializationError(AuditManagerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AuditManagerError):
...
class WaiterFailedError(AuditManagerError):
...
class WaiterTimeoutError(AuditManagerError):
