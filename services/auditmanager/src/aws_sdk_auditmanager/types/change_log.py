...
class ChangeLog(TypedDict, closed=True):
    ...
    action: NotRequired["aws_sdk_auditmanager.types.action_enum.ActionEnum"]
    ...
    created_by: NotRequired["aws_sdk_auditmanager.types.iam_arn.IamArn"]
...
def serialize_json(value: ChangeLog) -> dict:
    ...
    if "object_type" in value:
        ...
        out["objectType"] = aws_sdk_auditmanager.types.object_type_enum.serialize_json(
            value["object_type"]
        )
    ...
    if "action" in value:
        ...
        out["action"] = aws_sdk_auditmanager.types.action_enum.serialize_json(
            value["action"]
        )
...
def deserialize_json(data: dict) -> ChangeLog:
    ...
    if "objectType" in data:
        ...
        out["object_type"] = (
            aws_sdk_auditmanager.types.object_type_enum.deserialize_json(
                data["objectType"]
            )
        )
    ...
    if "action" in data:
        ...
        out["action"] = aws_sdk_auditmanager.types.action_enum.deserialize_json(
            data["action"]
        )
