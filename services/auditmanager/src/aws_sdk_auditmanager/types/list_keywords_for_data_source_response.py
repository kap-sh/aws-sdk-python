...
class ListKeywordsForDataSourceResponse(TypedDict):
    keywords: NotRequired["aws_sdk_auditmanager.types.keywords.Keywords"]
...
def serialize_json(value: ListKeywordsForDataSourceResponse) -> dict:
    ...
    if "keywords" in value:
        ...
        out["keywords"] = aws_sdk_auditmanager.types.keywords.serialize_json(
            value["keywords"]
        )
...
def deserialize_json(data: dict) -> ListKeywordsForDataSourceResponse:
    ...
    if "keywords" in data:
        ...
        out["keywords"] = aws_sdk_auditmanager.types.keywords.deserialize_json(
            data["keywords"]
        )
