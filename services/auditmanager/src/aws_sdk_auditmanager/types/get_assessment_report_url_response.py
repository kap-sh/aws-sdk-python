...
class GetAssessmentReportUrlResponse(TypedDict):
    pre_signed_url: NotRequired["aws_sdk_auditmanager.types.url.URL"]
...
def serialize_json(value: GetAssessmentReportUrlResponse) -> dict:
    ...
    if "pre_signed_url" in value:
        ...
        out["preSignedUrl"] = aws_sdk_auditmanager.types.url.serialize_json(
...
def deserialize_json(data: dict) -> GetAssessmentReportUrlResponse:
    ...
    if "preSignedUrl" in data:
        ...
        out["pre_signed_url"] = aws_sdk_auditmanager.types.url.deserialize_json(
            data["preSignedUrl"]
        )
    return out
