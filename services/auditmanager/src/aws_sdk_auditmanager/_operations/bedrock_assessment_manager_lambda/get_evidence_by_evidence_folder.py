...
def build_request(
    ...
    input: aws_sdk_auditmanager.types.get_evidence_by_evidence_folder_request.GetEvidenceByEvidenceFolderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{evidenceFolderId}", quote(str(input["evidence_folder_id"]), safe="")
    )
    params: dict[str, str] = {}
