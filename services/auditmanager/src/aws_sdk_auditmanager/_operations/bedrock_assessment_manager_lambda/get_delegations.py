...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.get_delegations_response.GetDelegationsResponse = (
        aws_sdk_auditmanager.types.get_delegations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_auditmanager.types.get_delegations_request.GetDelegationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
