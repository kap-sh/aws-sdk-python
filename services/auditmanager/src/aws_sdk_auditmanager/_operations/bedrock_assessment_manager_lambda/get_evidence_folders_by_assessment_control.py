...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.get_evidence_folders_by_assessment_control_response.GetEvidenceFoldersByAssessmentControlResponse = aws_sdk_auditmanager.types.get_evidence_folders_by_assessment_control_response.deserialize_json(
