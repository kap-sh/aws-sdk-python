...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.get_evidence_response.GetEvidenceResponse = (
        aws_sdk_auditmanager.types.get_evidence_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_auditmanager.types.get_evidence_request.GetEvidenceRequest,
) -> zapros.Request:
    ...
    url = url.replace("{evidenceId}", quote(str(input["evidence_id"]), safe=""))
    params: dict[str, str] = {}
