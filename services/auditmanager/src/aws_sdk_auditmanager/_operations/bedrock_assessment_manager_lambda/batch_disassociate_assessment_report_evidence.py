...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.batch_disassociate_assessment_report_evidence_response.BatchDisassociateAssessmentReportEvidenceResponse = aws_sdk_auditmanager.types.batch_disassociate_assessment_report_evidence_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_auditmanager.types.batch_disassociate_assessment_report_evidence_request.BatchDisassociateAssessmentReportEvidenceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
