"""Generated from Smithy shape ``com.amazonaws.auditmanager#GetEvidenceFoldersByAssessment``."""
...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.get_evidence_folders_by_assessment_response.GetEvidenceFoldersByAssessmentResponse = aws_sdk_auditmanager.types.get_evidence_folders_by_assessment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_auditmanager.types.get_evidence_folders_by_assessment_request.GetEvidenceFoldersByAssessmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_evidence_folders_by_assessment(
