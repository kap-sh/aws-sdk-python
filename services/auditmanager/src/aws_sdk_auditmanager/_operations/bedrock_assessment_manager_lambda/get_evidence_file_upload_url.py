...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.get_evidence_file_upload_url_response.GetEvidenceFileUploadUrlResponse = aws_sdk_auditmanager.types.get_evidence_file_upload_url_response.deserialize_json(
