...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.associate_assessment_report_evidence_folder_response.AssociateAssessmentReportEvidenceFolderResponse = {}  # type: ignore[typeddict-item]
    return out
