"""Generated from Smithy shape ``com.amazonaws.auditmanager#ListAssessments``."""
...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.list_assessments_response.ListAssessmentsResponse = aws_sdk_auditmanager.types.list_assessments_response.deserialize_json(
