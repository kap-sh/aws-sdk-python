"""Generated from Smithy shape ``com.amazonaws.auditmanager#GetInsights``."""
...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.get_insights_response.GetInsightsResponse = (
        aws_sdk_auditmanager.types.get_insights_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_auditmanager.types.get_insights_request.GetInsightsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/insights"
    params: dict[str, str] = {}
