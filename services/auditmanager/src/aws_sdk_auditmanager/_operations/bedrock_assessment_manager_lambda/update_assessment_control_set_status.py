...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.update_assessment_control_set_status_response.UpdateAssessmentControlSetStatusResponse = aws_sdk_auditmanager.types.update_assessment_control_set_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_auditmanager.types.update_assessment_control_set_status_request.UpdateAssessmentControlSetStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_auditmanager.types.update_assessment_control_set_status_request.serialize_json(
            input_
        )
    ).encode()
