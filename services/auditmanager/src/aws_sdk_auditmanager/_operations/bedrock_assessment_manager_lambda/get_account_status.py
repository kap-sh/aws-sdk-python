"""Generated from Smithy shape ``com.amazonaws.auditmanager#GetAccountStatus``."""
...
def build_request(
    ...
    input_: aws_sdk_auditmanager.types.get_account_status_request.GetAccountStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/account/status"
    params: dict[str, str] = {}
...
async def async_get_account_status(
