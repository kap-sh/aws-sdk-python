...
def handle_response(
    ...
    out: aws_sdk_auditmanager.types.get_services_in_scope_response.GetServicesInScopeResponse = aws_sdk_auditmanager.types.get_services_in_scope_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_auditmanager.types.get_services_in_scope_request.GetServicesInScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
