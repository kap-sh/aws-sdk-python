...
class ECSClient:
    ...
    def continue_service_deployment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.continue_service_deployment_request.ContinueServiceDeploymentRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.continue_service_deployment_response.ContinueServiceDeploymentResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.continue_service_deployment.continue_service_deployment(
    ...
    def delete_account_setting(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.delete_account_setting_request.DeleteAccountSettingRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.delete_account_setting_response.DeleteAccountSettingResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.delete_account_setting.delete_account_setting(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deregister_task_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.deregister_task_definition_request.DeregisterTaskDefinitionRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.deregister_task_definition_response.DeregisterTaskDefinitionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.deregister_task_definition.deregister_task_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_task_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.describe_task_definition_request.DescribeTaskDefinitionRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.describe_task_definition_response.DescribeTaskDefinitionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.describe_task_definition.describe_task_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def discover_poll_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.discover_poll_endpoint_request.DiscoverPollEndpointRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.discover_poll_endpoint_response.DiscoverPollEndpointResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.discover_poll_endpoint.discover_poll_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_account_settings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.list_account_settings_request.ListAccountSettingsRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.list_account_settings_response.ListAccountSettingsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_account_settings.list_account_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_account_settings(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ecs.types.string.String"] = None,
        max_results: Optional["aws_sdk_ecs.types.integer.Integer"] = None,
    ) -> "Iterator[aws_sdk_ecs.types.setting.Setting]":
        _token = next_token
        while True:
    ...
    def list_services_by_namespace(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.list_services_by_namespace_request.ListServicesByNamespaceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.list_services_by_namespace_response.ListServicesByNamespaceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_services_by_namespace.list_services_by_namespace(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_services_by_namespace(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ecs.types.string.String"] = None,
        max_results: Optional["aws_sdk_ecs.types.boxed_integer.BoxedInteger"] = None,
    ) -> "Iterator[aws_sdk_ecs.types.string.String]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_task_definition_families(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.list_task_definition_families_request.ListTaskDefinitionFamiliesRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.list_task_definition_families_response.ListTaskDefinitionFamiliesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_task_definition_families.list_task_definition_families(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_account_setting(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.put_account_setting_request.PutAccountSettingRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.put_account_setting_response.PutAccountSettingResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.put_account_setting.put_account_setting(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_account_setting_default(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.put_account_setting_default_request.PutAccountSettingDefaultRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.put_account_setting_default_response.PutAccountSettingDefaultResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.put_account_setting_default.put_account_setting_default(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_ecs.errors.cluster_not_found_exception.ClusterNotFoundException: <p>The specified cluster wasn't found. You can view your available clusters with <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_ListClusters.html\">ListClusters</a>. Amazon ECS clusters are Region specific.</p>
            aws_sdk_ecs.errors.invalid_parameter_exception.InvalidParameterException: <p>The specified parameter isn't valid. Review the available parameters for the API request.</p> <p>For more information about service event errors, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-event-messages-list.html\">Amazon ECS service event messages</a>. </p>
            aws_sdk_ecs.errors.limit_exceeded_exception.LimitExceededException: <p>The limit for the resource was exceeded.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
