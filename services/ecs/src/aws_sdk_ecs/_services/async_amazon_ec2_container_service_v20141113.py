...
if TYPE_CHECKING:
    ...
    import aws_sdk_ecs.types.list_account_settings_request
    import aws_sdk_ecs.types.list_account_settings_response
    import aws_sdk_ecs.types.list_services_by_namespace_request
    import aws_sdk_ecs.types.list_services_by_namespace_response
...
class AsyncECSClient:
    ...
    def __init__(
        ...
        self.config = AsyncECSClientConfig(
            {
    ...
    async def continue_service_deployment(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.continue_service_deployment(service_deployment_arn='arn:aws:ecs:us-east-1:123456789012:service-deployment/MyCluster/MyService/r9i43YFjvgF_xlg7m2eJ1r', hook_id='ABCDEFGHIJKLMNOPQRSTUVWXYZ234567', action='CONTINUE')
            ...
            >>> await client.continue_service_deployment(service_deployment_arn='arn:aws:ecs:us-east-1:123456789012:service-deployment/MyCluster/MyService/r9i43YFjvgF_xlg7m2eJ1r', hook_id='ABCDEFGHIJKLMNOPQRSTUVWXYZ234567', action='ROLLBACK')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.continue_service_deployment_request.ContinueServiceDeploymentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.continue_service_deployment_response.ContinueServiceDeploymentResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.continue_service_deployment

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.continue_service_deployment.async_continue_service_deployment(
    ...
    async def delete_account_setting(
        ...
        *,
        config_overrides: Optional[AsyncECSClientConfig] = None,
        principal_arn: Optional["aws_sdk_ecs.types.string.String"] = None,
    ) -> (
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.delete_account_setting_request.DeleteAccountSettingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.delete_account_setting_response.DeleteAccountSettingResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.delete_account_setting

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.delete_account_setting.async_delete_account_setting(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_task_definition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.deregister_task_definition_request.DeregisterTaskDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.deregister_task_definition_response.DeregisterTaskDefinitionResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.deregister_task_definition

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.deregister_task_definition.async_deregister_task_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_task_definition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.describe_task_definition_request.DescribeTaskDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.describe_task_definition_response.DescribeTaskDefinitionResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.describe_task_definition

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.describe_task_definition.async_describe_task_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def discover_poll_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.discover_poll_endpoint_request.DiscoverPollEndpointRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.discover_poll_endpoint_response.DiscoverPollEndpointResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.discover_poll_endpoint

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.discover_poll_endpoint.async_discover_poll_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_account_settings(
        ...
        *,
        config_overrides: Optional[AsyncECSClientConfig] = None,
        name: Optional["aws_sdk_ecs.types.setting_name.SettingName"] = None,
        value: Optional["aws_sdk_ecs.types.string.String"] = None,
        principal_arn: Optional["aws_sdk_ecs.types.string.String"] = None,
        effective_settings: Optional["aws_sdk_ecs.types.boolean.Boolean"] = None,
        next_token: Optional["aws_sdk_ecs.types.string.String"] = None,
        max_results: Optional["aws_sdk_ecs.types.integer.Integer"] = None,
    ) -> "aws_sdk_ecs.types.list_account_settings_response.ListAccountSettingsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.list_account_settings_request.ListAccountSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.list_account_settings_response.ListAccountSettingsResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_account_settings

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_account_settings.async_list_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_account_settings(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ecs.types.string.String"] = None,
        max_results: Optional["aws_sdk_ecs.types.integer.Integer"] = None,
    ) -> "AsyncIterator[aws_sdk_ecs.types.setting.Setting]":
        _token = next_token
        while True:
    ...
    async def list_services_by_namespace(
        ...
        *,
    ...
    ) -> "aws_sdk_ecs.types.list_services_by_namespace_response.ListServicesByNamespaceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.list_services_by_namespace_request.ListServicesByNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.list_services_by_namespace_response.ListServicesByNamespaceResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_services_by_namespace

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_services_by_namespace.async_list_services_by_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_services_by_namespace(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ecs.types.string.String"] = None,
        max_results: Optional["aws_sdk_ecs.types.boxed_integer.BoxedInteger"] = None,
    ) -> "AsyncIterator[aws_sdk_ecs.types.string.String]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_tags_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_task_definition_families(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.list_task_definition_families_request.ListTaskDefinitionFamiliesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.list_task_definition_families_response.ListTaskDefinitionFamiliesResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_task_definition_families

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_task_definition_families.async_list_task_definition_families(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_account_setting(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.put_account_setting_request.PutAccountSettingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.put_account_setting_response.PutAccountSettingResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.put_account_setting

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.put_account_setting.async_put_account_setting(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_account_setting_default(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.put_account_setting_default_request.PutAccountSettingDefaultRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.put_account_setting_default_response.PutAccountSettingDefaultResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.put_account_setting_default

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.put_account_setting_default.async_put_account_setting_default(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        config_overrides: Optional[AsyncECSClientConfig] = None,
    ) -> "aws_sdk_ecs.types.tag_resource_response.TagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.tag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        config_overrides: Optional[AsyncECSClientConfig] = None,
    ) -> "aws_sdk_ecs.types.untag_resource_response.UntagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.untag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
