...
if TYPE_CHECKING:
    ...
    import aws_sdk_ecs.types.delete_task_definitions_request
    import aws_sdk_ecs.types.delete_task_definitions_response
    ...
    import aws_sdk_ecs.types.list_task_definitions_request
    import aws_sdk_ecs.types.list_task_definitions_response
...
class TaskDefinitionResource:
    ...
    def delete_task_definitions(
        ...
        *,
    ...
    ) -> "aws_sdk_ecs.types.delete_task_definitions_response.DeleteTaskDefinitionsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.delete_task_definitions_request.DeleteTaskDefinitionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.delete_task_definitions_response.DeleteTaskDefinitionsResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.delete_task_definitions

            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.delete_task_definitions.delete_task_definitions(
    ...
    def list_task_definitions(
        ...
        *,
        ...
        status: Optional[
            "aws_sdk_ecs.types.task_definition_status.TaskDefinitionStatus"
        ] = None,
    ...
    ) -> "aws_sdk_ecs.types.list_task_definitions_response.ListTaskDefinitionsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.list_task_definitions_request.ListTaskDefinitionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.list_task_definitions_response.ListTaskDefinitionsResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_task_definitions

            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_task_definitions.list_task_definitions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_task_definition(
        ...
        container_definitions: "aws_sdk_ecs.types.container_definitions.ContainerDefinitions",
        *,
        config_overrides: Optional[ECSClientConfig] = None,
        ...
        network_mode: Optional["aws_sdk_ecs.types.network_mode.NetworkMode"] = None,
        volumes: Optional["aws_sdk_ecs.types.volume_list.VolumeList"] = None,
        ...
        pid_mode: Optional["aws_sdk_ecs.types.pid_mode.PidMode"] = None,
        ipc_mode: Optional["aws_sdk_ecs.types.ipc_mode.IpcMode"] = None,
        ...
        runtime_platform: Optional[
            "aws_sdk_ecs.types.runtime_platform.RuntimePlatform"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.register_task_definition_request.RegisterTaskDefinitionRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.register_task_definition_response.RegisterTaskDefinitionResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.register_task_definition

            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.register_task_definition.register_task_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncTaskDefinitionResource:
    ...
    async def delete_task_definitions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.delete_task_definitions_request.DeleteTaskDefinitionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.delete_task_definitions_response.DeleteTaskDefinitionsResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.delete_task_definitions
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.delete_task_definitions.async_delete_task_definitions(
                req.options, req.input
            )
    ...
    async def list_task_definitions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.list_task_definitions_request.ListTaskDefinitionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.list_task_definitions_response.ListTaskDefinitionsResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_task_definitions
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.list_task_definitions.async_list_task_definitions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_task_definition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.register_task_definition_request.RegisterTaskDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.register_task_definition_response.RegisterTaskDefinitionResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.register_task_definition
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.register_task_definition.async_register_task_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
