...
class TaskResource:
    ...
    def describe_tasks(
        ...
        *,
        ...
        include: Optional["aws_sdk_ecs.types.task_field_list.TaskFieldList"] = None,
    ) -> "aws_sdk_ecs.types.describe_tasks_response.DescribeTasksResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.describe_tasks_request.DescribeTasksRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.describe_tasks_response.DescribeTasksResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.describe_tasks

            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.describe_tasks.describe_tasks(
    ...
    def get_task_protection(
        ...
        *,
        config_overrides: Optional[ECSClientConfig] = None,
        tasks: Optional["aws_sdk_ecs.types.string_list.StringList"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.get_task_protection_request.GetTaskProtectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.get_task_protection_response.GetTaskProtectionResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.get_task_protection

            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.get_task_protection.get_task_protection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def run_task(
        ...
        *,
        ...
        cluster: Optional["aws_sdk_ecs.types.string.String"] = None,
        count: Optional["aws_sdk_ecs.types.boxed_integer.BoxedInteger"] = None,
        ...
        group: Optional["aws_sdk_ecs.types.string.String"] = None,
        ...
        overrides: Optional["aws_sdk_ecs.types.task_override.TaskOverride"] = None,
        ...
        reference_id: Optional["aws_sdk_ecs.types.string.String"] = None,
    ...
    ) -> "aws_sdk_ecs.types.run_task_response.RunTaskResponse":
        ...
        Raises:
            aws_sdk_ecs.errors.access_denied_exception.AccessDeniedException: <p>You don't have authorization to perform the requested action.</p>
            aws_sdk_ecs.errors.blocked_exception.BlockedException: <p>Your Amazon Web Services account was blocked. For more information, contact <a href=\"http://aws.amazon.com/contact-us/\"> Amazon Web Services Support</a>.</p>
            aws_sdk_ecs.errors.client_exception.ClientException: <p>These errors are usually caused by a client action. This client action might be using an action or resource on behalf of a user that doesn't have permissions to use the action or resource. Or, it might be specifying an identifier that isn't valid.</p>
            aws_sdk_ecs.errors.cluster_not_found_exception.ClusterNotFoundException: <p>The specified cluster wasn't found. You can view your available clusters with <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_ListClusters.html\">ListClusters</a>. Amazon ECS clusters are Region specific.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.run_task_request.RunTaskRequest]",
        ) -> OperationResponse["aws_sdk_ecs.types.run_task_response.RunTaskResponse"]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.run_task

            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.run_task.run_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_task(
        ...
        *,
    ...
    ) -> "aws_sdk_ecs.types.start_task_response.StartTaskResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.start_task_request.StartTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.start_task_response.StartTaskResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.start_task

            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.start_task.start_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_task(
        ...
        *,
    ...
    ) -> "aws_sdk_ecs.types.stop_task_response.StopTaskResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.stop_task_request.StopTaskRequest]",
        ) -> OperationResponse["aws_sdk_ecs.types.stop_task_response.StopTaskResponse"]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.stop_task

            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.stop_task.stop_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_task_protection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ecs.types.update_task_protection_request.UpdateTaskProtectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_ecs.types.update_task_protection_response.UpdateTaskProtectionResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.update_task_protection

            output, http_response = (
                aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.update_task_protection.update_task_protection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncTaskResource:
    ...
    async def describe_tasks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.describe_tasks_request.DescribeTasksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.describe_tasks_response.DescribeTasksResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.describe_tasks
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.describe_tasks.async_describe_tasks(
                req.options, req.input
            )
    ...
    async def get_task_protection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.get_task_protection_request.GetTaskProtectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.get_task_protection_response.GetTaskProtectionResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.get_task_protection
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.get_task_protection.async_get_task_protection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def run_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.run_task_request.RunTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.run_task_response.RunTaskResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.run_task
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.run_task.async_run_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.start_task_request.StartTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.start_task_response.StartTaskResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.start_task
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.start_task.async_start_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.stop_task_request.StopTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.stop_task_response.StopTaskResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.stop_task
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.stop_task.async_stop_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_task_protection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_ecs.types.update_task_protection_request.UpdateTaskProtectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_ecs.types.update_task_protection_response.UpdateTaskProtectionResponse"
        ]:
            import aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.update_task_protection
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_ecs._operations.amazon_ec2_container_service_v20141113.update_task_protection.async_update_task_protection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
