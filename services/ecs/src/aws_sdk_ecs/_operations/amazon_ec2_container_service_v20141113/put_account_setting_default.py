...
def handle_response(
    ...
    out: aws_sdk_ecs.types.put_account_setting_default_response.PutAccountSettingDefaultResponse = aws_sdk_ecs.types.put_account_setting_default_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.put_account_setting_default_request.PutAccountSettingDefaultRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
