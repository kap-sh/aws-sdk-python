...
def handle_response(
    ...
    out: aws_sdk_ecs.types.describe_service_revisions_response.DescribeServiceRevisionsResponse = aws_sdk_ecs.types.describe_service_revisions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.describe_service_revisions_request.DescribeServiceRevisionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.describe_service_revisions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
