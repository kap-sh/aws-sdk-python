...
def handle_response(
    ...
    out: aws_sdk_ecs.types.delete_service_response.DeleteServiceResponse = (
        aws_sdk_ecs.types.delete_service_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.delete_service_request.DeleteServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.delete_service_request.serialize_aws_json_1_1(input_)
    ).encode()
