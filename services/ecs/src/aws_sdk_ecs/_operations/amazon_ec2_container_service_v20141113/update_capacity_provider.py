"""Generated from Smithy shape ``com.amazonaws.ecs#UpdateCapacityProvider``."""
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.update_capacity_provider_response.UpdateCapacityProviderResponse = aws_sdk_ecs.types.update_capacity_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ecs.types.update_capacity_provider_request.UpdateCapacityProviderRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.update_capacity_provider_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_update_capacity_provider(
