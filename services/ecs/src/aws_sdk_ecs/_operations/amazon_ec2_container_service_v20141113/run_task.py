...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BlockedException":
            import aws_sdk_ecs.errors.blocked_exception

            raise aws_sdk_ecs.errors.blocked_exception.BlockedException.from_aws_json_1_1(
                data
            )
        ...
        case "ConflictException":
            import aws_sdk_ecs.errors.conflict_exception

            raise aws_sdk_ecs.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.run_task_response.RunTaskResponse = (
        aws_sdk_ecs.types.run_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.run_task_request.RunTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def run_task(
    options: OperationOptions, input_: aws_sdk_ecs.types.run_task_request.RunTaskRequest
