"""Generated from Smithy shape ``com.amazonaws.ecs#DescribeExpressGatewayService``."""
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.describe_express_gateway_service_response.DescribeExpressGatewayServiceResponse = aws_sdk_ecs.types.describe_express_gateway_service_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.describe_express_gateway_service_request.DescribeExpressGatewayServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.describe_express_gateway_service_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_express_gateway_service(
