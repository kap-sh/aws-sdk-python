...
import aws_sdk_ecs.errors.target_not_connected_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TargetNotConnectedException":
            raise aws_sdk_ecs.errors.target_not_connected_exception.TargetNotConnectedException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.execute_command_response.ExecuteCommandResponse = (
        aws_sdk_ecs.types.execute_command_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.execute_command_request.ExecuteCommandRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerServiceV20141113.ExecuteCommand"
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.execute_command_request.serialize_aws_json_1_1(input_)
    ).encode()
