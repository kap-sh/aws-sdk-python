"""Generated from Smithy shape ``com.amazonaws.ecs#CreateCapacityProvider``."""
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.create_capacity_provider_response.CreateCapacityProviderResponse = aws_sdk_ecs.types.create_capacity_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ecs.types.create_capacity_provider_request.CreateCapacityProviderRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.create_capacity_provider_request.serialize_aws_json_1_1(input)
    ).encode()
