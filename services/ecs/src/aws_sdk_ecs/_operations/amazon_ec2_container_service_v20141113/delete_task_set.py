...
def handle_response(
    ...
    out: aws_sdk_ecs.types.delete_task_set_response.DeleteTaskSetResponse = (
        aws_sdk_ecs.types.delete_task_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.delete_task_set_request.DeleteTaskSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.delete_task_set_request.serialize_aws_json_1_1(input_)
    ).encode()
