...
def handle_response(
    ...
    out: aws_sdk_ecs.types.list_task_definition_families_response.ListTaskDefinitionFamiliesResponse = aws_sdk_ecs.types.list_task_definition_families_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.list_task_definition_families_request.ListTaskDefinitionFamiliesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
