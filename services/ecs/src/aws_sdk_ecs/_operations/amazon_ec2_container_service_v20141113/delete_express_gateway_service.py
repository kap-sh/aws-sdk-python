...
def handle_response(
    ...
    out: aws_sdk_ecs.types.delete_express_gateway_service_response.DeleteExpressGatewayServiceResponse = aws_sdk_ecs.types.delete_express_gateway_service_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.delete_express_gateway_service_request.DeleteExpressGatewayServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
