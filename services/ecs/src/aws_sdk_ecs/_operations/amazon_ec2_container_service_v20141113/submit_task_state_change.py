...
def handle_response(
    ...
    out: aws_sdk_ecs.types.submit_task_state_change_response.SubmitTaskStateChangeResponse = aws_sdk_ecs.types.submit_task_state_change_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.submit_task_state_change_request.SubmitTaskStateChangeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.submit_task_state_change_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
