...
def handle_response(
    ...
    out: aws_sdk_ecs.types.describe_task_sets_response.DescribeTaskSetsResponse = (
        aws_sdk_ecs.types.describe_task_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.describe_task_sets_request.DescribeTaskSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.describe_task_sets_request.serialize_aws_json_1_1(input_)
    ).encode()
