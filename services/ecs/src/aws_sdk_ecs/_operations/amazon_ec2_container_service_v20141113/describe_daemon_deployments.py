...
def handle_response(
    ...
    out: aws_sdk_ecs.types.describe_daemon_deployments_response.DescribeDaemonDeploymentsResponse = aws_sdk_ecs.types.describe_daemon_deployments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.describe_daemon_deployments_request.DescribeDaemonDeploymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
