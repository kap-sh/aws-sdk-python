...
def handle_response(
    ...
    out: aws_sdk_ecs.types.stop_service_deployment_response.StopServiceDeploymentResponse = aws_sdk_ecs.types.stop_service_deployment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.stop_service_deployment_request.StopServiceDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerServiceV20141113.StopServiceDeployment"
    import aws_sdk_ecs.types.stop_service_deployment_request

    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.stop_service_deployment_request.serialize_aws_json_1_1(input_)
    ).encode()
