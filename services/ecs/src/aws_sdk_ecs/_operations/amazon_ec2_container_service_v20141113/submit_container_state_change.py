...
def handle_response(
    ...
    out: aws_sdk_ecs.types.submit_container_state_change_response.SubmitContainerStateChangeResponse = aws_sdk_ecs.types.submit_container_state_change_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.submit_container_state_change_request.SubmitContainerStateChangeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.submit_container_state_change_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
