...
def build_request(
    ...
    input: aws_sdk_ecs.types.list_account_settings_request.ListAccountSettingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.list_account_settings_request.serialize_aws_json_1_1(input)
    ).encode()
