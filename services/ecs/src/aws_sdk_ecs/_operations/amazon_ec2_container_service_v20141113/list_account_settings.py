"""Generated from Smithy shape ``com.amazonaws.ecs#ListAccountSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.list_account_settings_response.ListAccountSettingsResponse = aws_sdk_ecs.types.list_account_settings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.list_account_settings_request.ListAccountSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.list_account_settings_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_account_settings(
