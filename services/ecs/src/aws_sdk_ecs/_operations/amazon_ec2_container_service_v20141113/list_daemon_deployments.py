...
def handle_response(
    ...
    out: aws_sdk_ecs.types.list_daemon_deployments_response.ListDaemonDeploymentsResponse = aws_sdk_ecs.types.list_daemon_deployments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.list_daemon_deployments_request.ListDaemonDeploymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerServiceV20141113.ListDaemonDeployments"
    import aws_sdk_ecs.types.list_daemon_deployments_request

    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.list_daemon_deployments_request.serialize_aws_json_1_1(input_)
    ).encode()
