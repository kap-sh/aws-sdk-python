...
def handle_response(
    ...
    out: aws_sdk_ecs.types.delete_account_setting_response.DeleteAccountSettingResponse = aws_sdk_ecs.types.delete_account_setting_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.delete_account_setting_request.DeleteAccountSettingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.delete_account_setting_request.serialize_aws_json_1_1(input_)
    ).encode()
