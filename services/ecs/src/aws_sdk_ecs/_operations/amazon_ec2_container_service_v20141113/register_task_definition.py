...
def handle_response(
    ...
    out: aws_sdk_ecs.types.register_task_definition_response.RegisterTaskDefinitionResponse = aws_sdk_ecs.types.register_task_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.register_task_definition_request.RegisterTaskDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.register_task_definition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
