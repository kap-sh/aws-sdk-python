...
def handle_response(
    ...
    out: aws_sdk_ecs.types.create_daemon_response.CreateDaemonResponse = (
        aws_sdk_ecs.types.create_daemon_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.create_daemon_request.CreateDaemonRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.create_daemon_request.serialize_aws_json_1_1(input_)
    ).encode()
