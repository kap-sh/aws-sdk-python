...
def handle_response(
    ...
    out: aws_sdk_ecs.types.update_service_response.UpdateServiceResponse = (
        aws_sdk_ecs.types.update_service_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.update_service_request.UpdateServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.update_service_request.serialize_aws_json_1_1(input_)
    ).encode()
