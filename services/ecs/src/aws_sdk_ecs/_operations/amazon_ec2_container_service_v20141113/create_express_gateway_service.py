...
def handle_response(
    ...
    out: aws_sdk_ecs.types.create_express_gateway_service_response.CreateExpressGatewayServiceResponse = aws_sdk_ecs.types.create_express_gateway_service_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.create_express_gateway_service_request.CreateExpressGatewayServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = (
        "AmazonEC2ContainerServiceV20141113.CreateExpressGatewayService"
    )
    import aws_sdk_ecs.types.create_express_gateway_service_request

    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.create_express_gateway_service_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
