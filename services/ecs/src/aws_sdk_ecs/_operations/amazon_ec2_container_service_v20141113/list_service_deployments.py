...
def handle_response(
    ...
    out: aws_sdk_ecs.types.list_service_deployments_response.ListServiceDeploymentsResponse = aws_sdk_ecs.types.list_service_deployments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.list_service_deployments_request.ListServiceDeploymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.list_service_deployments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
