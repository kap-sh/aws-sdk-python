...
def handle_response(
    ...
    out: aws_sdk_ecs.types.list_daemon_task_definitions_response.ListDaemonTaskDefinitionsResponse = aws_sdk_ecs.types.list_daemon_task_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.list_daemon_task_definitions_request.ListDaemonTaskDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
