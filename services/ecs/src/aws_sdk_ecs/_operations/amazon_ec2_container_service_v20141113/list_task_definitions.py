...
def handle_response(
    ...
    out: aws_sdk_ecs.types.list_task_definitions_response.ListTaskDefinitionsResponse = aws_sdk_ecs.types.list_task_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.list_task_definitions_request.ListTaskDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.list_task_definitions_request.serialize_aws_json_1_1(input_)
    ).encode()
