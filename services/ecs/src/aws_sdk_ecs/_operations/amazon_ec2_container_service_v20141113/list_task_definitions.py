...
def build_request(
    ...
    input: aws_sdk_ecs.types.list_task_definitions_request.ListTaskDefinitionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.list_task_definitions_request.serialize_aws_json_1_1(input)
    ).encode()
