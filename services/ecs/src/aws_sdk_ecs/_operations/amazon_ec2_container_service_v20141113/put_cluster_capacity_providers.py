...
import aws_sdk_ecs.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise aws_sdk_ecs.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.put_cluster_capacity_providers_response.PutClusterCapacityProvidersResponse = aws_sdk_ecs.types.put_cluster_capacity_providers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.put_cluster_capacity_providers_request.PutClusterCapacityProvidersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.put_cluster_capacity_providers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
