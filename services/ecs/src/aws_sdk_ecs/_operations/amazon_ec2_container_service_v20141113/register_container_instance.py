...
def handle_response(
    ...
    out: aws_sdk_ecs.types.register_container_instance_response.RegisterContainerInstanceResponse = aws_sdk_ecs.types.register_container_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.register_container_instance_request.RegisterContainerInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.register_container_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
