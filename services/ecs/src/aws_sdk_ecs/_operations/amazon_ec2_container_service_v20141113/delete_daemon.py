...
import aws_sdk_ecs.errors.daemon_not_active_exception
import aws_sdk_ecs.errors.daemon_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DaemonNotActiveException":
            raise aws_sdk_ecs.errors.daemon_not_active_exception.DaemonNotActiveException.from_aws_json_1_1(
                data
            )
        case "DaemonNotFoundException":
            raise aws_sdk_ecs.errors.daemon_not_found_exception.DaemonNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.delete_daemon_response.DeleteDaemonResponse = (
        aws_sdk_ecs.types.delete_daemon_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_ecs._auth._sigv4.build_sigv4_auth_scheme("ecs", options.region)
        )
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.delete_daemon_request.DeleteDaemonRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerServiceV20141113.DeleteDaemon"
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.delete_daemon_request.serialize_aws_json_1_1(input_)
    ).encode()
