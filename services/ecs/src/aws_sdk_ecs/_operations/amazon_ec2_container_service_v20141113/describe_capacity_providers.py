...
def handle_response(
    ...
    out: aws_sdk_ecs.types.describe_capacity_providers_response.DescribeCapacityProvidersResponse = aws_sdk_ecs.types.describe_capacity_providers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.describe_capacity_providers_request.DescribeCapacityProvidersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.describe_capacity_providers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
