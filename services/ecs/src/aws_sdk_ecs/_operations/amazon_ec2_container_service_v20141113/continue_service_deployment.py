...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceDeploymentNotFoundException":
            import aws_sdk_ecs.errors.service_deployment_not_found_exception

            raise aws_sdk_ecs.errors.service_deployment_not_found_exception.ServiceDeploymentNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.continue_service_deployment_response.ContinueServiceDeploymentResponse = aws_sdk_ecs.types.continue_service_deployment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.continue_service_deployment_request.ContinueServiceDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.continue_service_deployment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
