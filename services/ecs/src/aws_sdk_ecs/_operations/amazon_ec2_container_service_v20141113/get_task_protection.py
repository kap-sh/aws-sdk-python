...
def handle_response(
    ...
    out: aws_sdk_ecs.types.get_task_protection_response.GetTaskProtectionResponse = (
        aws_sdk_ecs.types.get_task_protection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.get_task_protection_request.GetTaskProtectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerServiceV20141113.GetTaskProtection"
    import aws_sdk_ecs.types.get_task_protection_request

    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.get_task_protection_request.serialize_aws_json_1_1(input_)
    ).encode()
