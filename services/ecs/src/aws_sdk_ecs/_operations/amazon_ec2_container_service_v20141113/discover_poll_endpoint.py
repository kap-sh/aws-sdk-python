...
def handle_response(
    ...
    out: aws_sdk_ecs.types.discover_poll_endpoint_response.DiscoverPollEndpointResponse = aws_sdk_ecs.types.discover_poll_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.discover_poll_endpoint_request.DiscoverPollEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.discover_poll_endpoint_request.serialize_aws_json_1_1(input_)
    ).encode()
