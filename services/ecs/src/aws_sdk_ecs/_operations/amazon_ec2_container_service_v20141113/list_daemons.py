...
def handle_response(
    ...
    out: aws_sdk_ecs.types.list_daemons_response.ListDaemonsResponse = (
        aws_sdk_ecs.types.list_daemons_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.list_daemons_request.ListDaemonsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.list_daemons_request.serialize_aws_json_1_1(input_)
    ).encode()
