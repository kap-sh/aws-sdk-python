...
def build_request(
    ...
    input_: aws_sdk_ecs.types.list_container_instances_request.ListContainerInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.list_container_instances_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
