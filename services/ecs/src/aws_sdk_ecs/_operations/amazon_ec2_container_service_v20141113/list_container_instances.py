...
def handle_response(
    ...
    out: aws_sdk_ecs.types.list_container_instances_response.ListContainerInstancesResponse = aws_sdk_ecs.types.list_container_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ecs.types.list_container_instances_request.ListContainerInstancesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.list_container_instances_request.serialize_aws_json_1_1(input)
    ).encode()
