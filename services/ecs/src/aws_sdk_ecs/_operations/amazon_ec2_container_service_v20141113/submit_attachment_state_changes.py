...
def handle_response(
    ...
    out: aws_sdk_ecs.types.submit_attachment_state_changes_response.SubmitAttachmentStateChangesResponse = aws_sdk_ecs.types.submit_attachment_state_changes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.submit_attachment_state_changes_request.SubmitAttachmentStateChangesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
