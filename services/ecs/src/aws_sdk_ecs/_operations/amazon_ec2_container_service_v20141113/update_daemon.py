...
def handle_response(
    ...
    out: aws_sdk_ecs.types.update_daemon_response.UpdateDaemonResponse = (
        aws_sdk_ecs.types.update_daemon_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.update_daemon_request.UpdateDaemonRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.update_daemon_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_daemon(
    ...
    aws_sdk_ecs.types.update_daemon_response.UpdateDaemonResponse, zapros.Response
]:
