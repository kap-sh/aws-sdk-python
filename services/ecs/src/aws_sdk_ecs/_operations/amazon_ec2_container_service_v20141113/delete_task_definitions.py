...
def build_request(
    ...
    input: aws_sdk_ecs.types.delete_task_definitions_request.DeleteTaskDefinitionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.delete_task_definitions_request.serialize_aws_json_1_1(input)
    ).encode()
