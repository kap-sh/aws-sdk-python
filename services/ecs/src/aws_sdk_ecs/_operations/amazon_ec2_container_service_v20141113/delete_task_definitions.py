"""Generated from Smithy shape ``com.amazonaws.ecs#DeleteTaskDefinitions``."""
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.delete_task_definitions_response.DeleteTaskDefinitionsResponse = aws_sdk_ecs.types.delete_task_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.delete_task_definitions_request.DeleteTaskDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerServiceV20141113.DeleteTaskDefinitions"
    import aws_sdk_ecs.types.delete_task_definitions_request

    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.delete_task_definitions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_task_definitions(
