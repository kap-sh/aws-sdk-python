...
def build_request(
    ...
    input_: aws_sdk_ecs.types.put_account_setting_request.PutAccountSettingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.put_account_setting_request.serialize_aws_json_1_1(input_)
    ).encode()
