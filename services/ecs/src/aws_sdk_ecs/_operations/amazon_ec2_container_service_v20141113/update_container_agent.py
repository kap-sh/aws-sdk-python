...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MissingVersionException":
            import aws_sdk_ecs.errors.missing_version_exception

            raise aws_sdk_ecs.errors.missing_version_exception.MissingVersionException.from_aws_json_1_1(
                data
            )
        case "NoUpdateAvailableException":
            import aws_sdk_ecs.errors.no_update_available_exception

            raise aws_sdk_ecs.errors.no_update_available_exception.NoUpdateAvailableException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.update_container_agent_response.UpdateContainerAgentResponse = aws_sdk_ecs.types.update_container_agent_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.update_container_agent_request.UpdateContainerAgentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.update_container_agent_request.serialize_aws_json_1_1(input_)
    ).encode()
