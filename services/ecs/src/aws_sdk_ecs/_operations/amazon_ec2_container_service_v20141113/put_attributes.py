...
import aws_sdk_ecs.errors.attribute_limit_exceeded_exception
...
import aws_sdk_ecs.errors.target_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AttributeLimitExceededException":
            raise aws_sdk_ecs.errors.attribute_limit_exceeded_exception.AttributeLimitExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "TargetNotFoundException":
            raise aws_sdk_ecs.errors.target_not_found_exception.TargetNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.put_attributes_response.PutAttributesResponse = (
        aws_sdk_ecs.types.put_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.put_attributes_request.PutAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.put_attributes_request.serialize_aws_json_1_1(input_)
    ).encode()
