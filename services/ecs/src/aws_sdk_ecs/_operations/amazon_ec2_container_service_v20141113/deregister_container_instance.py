...
def handle_response(
    ...
    out: aws_sdk_ecs.types.deregister_container_instance_response.DeregisterContainerInstanceResponse = aws_sdk_ecs.types.deregister_container_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.deregister_container_instance_request.DeregisterContainerInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.deregister_container_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
