"""Generated from Smithy shape ``com.amazonaws.ecs#DescribeDaemonRevisions``."""
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.describe_daemon_revisions_response.DescribeDaemonRevisionsResponse = aws_sdk_ecs.types.describe_daemon_revisions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.describe_daemon_revisions_request.DescribeDaemonRevisionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.describe_daemon_revisions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_daemon_revisions(
