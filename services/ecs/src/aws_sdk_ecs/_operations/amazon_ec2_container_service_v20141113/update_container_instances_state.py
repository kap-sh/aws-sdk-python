...
def handle_response(
    ...
    out: aws_sdk_ecs.types.update_container_instances_state_response.UpdateContainerInstancesStateResponse = aws_sdk_ecs.types.update_container_instances_state_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.update_container_instances_state_request.UpdateContainerInstancesStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
