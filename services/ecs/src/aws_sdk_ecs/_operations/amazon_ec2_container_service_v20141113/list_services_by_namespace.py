"""Generated from Smithy shape ``com.amazonaws.ecs#ListServicesByNamespace``."""
...
def handle_response(
    ...
    out: aws_sdk_ecs.types.list_services_by_namespace_response.ListServicesByNamespaceResponse = aws_sdk_ecs.types.list_services_by_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.list_services_by_namespace_request.ListServicesByNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_services_by_namespace(
