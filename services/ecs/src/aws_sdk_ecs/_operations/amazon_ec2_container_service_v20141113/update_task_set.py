...
def handle_response(
    ...
    out: aws_sdk_ecs.types.update_task_set_response.UpdateTaskSetResponse = (
        aws_sdk_ecs.types.update_task_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecs.types.update_task_set_request.UpdateTaskSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecs.types.update_task_set_request.serialize_aws_json_1_1(input_)
    ).encode()
