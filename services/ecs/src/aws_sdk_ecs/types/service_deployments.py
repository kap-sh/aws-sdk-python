...
def serialize_aws_json_1_1(value: ServiceDeployments) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_ecs.types.service_deployment.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> ServiceDeployments:
    ...
    for item in data:
        out.append(aws_sdk_ecs.types.service_deployment.deserialize_aws_json_1_1(item))
    return out
