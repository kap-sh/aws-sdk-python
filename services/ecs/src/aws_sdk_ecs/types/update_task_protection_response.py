"""Generated from Smithy shape ``com.amazonaws.ecs#UpdateTaskProtectionResponse``."""
...
class UpdateTaskProtectionResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateTaskProtectionResponse) -> dict:
    out: dict = {}
