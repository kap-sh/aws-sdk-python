...
def serialize_aws_json_1_1(value: ProxyConfiguration) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = aws_sdk_ecs.types.proxy_configuration_type.serialize_aws_json_1_1(
            value["type"]
        )
    ...
    if "properties" in value:
        ...
        out["properties"] = (
            aws_sdk_ecs.types.proxy_configuration_properties.serialize_aws_json_1_1(
                value["properties"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ProxyConfiguration:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_ecs.types.proxy_configuration_type.deserialize_aws_json_1_1(
                data["type"]
            )
        )
    ...
    if "properties" in data:
        ...
        out["properties"] = (
            aws_sdk_ecs.types.proxy_configuration_properties.deserialize_aws_json_1_1(
                data["properties"]
            )
        )
    return out
