...
class ServiceVolumeConfiguration(TypedDict):
    ...
    managed_ebs_volume: NotRequired[
        "aws_sdk_ecs.types.service_managed_ebs_volume_configuration.ServiceManagedEBSVolumeConfiguration"
    ]
...
def serialize_aws_json_1_1(value: ServiceVolumeConfiguration) -> dict:
    ...
    if "managed_ebs_volume" in value:
        ...
        out["managedEBSVolume"] = (
            aws_sdk_ecs.types.service_managed_ebs_volume_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ServiceVolumeConfiguration:
    ...
    if "managedEBSVolume" in data:
        ...
        out["managed_ebs_volume"] = (
            aws_sdk_ecs.types.service_managed_ebs_volume_configuration.deserialize_aws_json_1_1(
