...
class ServiceRevisionSummary(TypedDict):
    ...
    requested_test_traffic_weight: NotRequired["aws_sdk_ecs.types.double.Double"]
    ...
    requested_production_traffic_weight: NotRequired["aws_sdk_ecs.types.double.Double"]
