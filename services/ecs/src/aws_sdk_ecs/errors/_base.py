...
class ECSError(Exception):
    """Base class for all ECS service errors."""


class ServiceError(ECSError):
...
class SerializationError(ECSError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ECSError):
...
class WaiterFailedError(ECSError):
...
class WaiterTimeoutError(ECSError):
