...
def handle_response(
    ...
    out: capo_ecs.types.delete_daemon_task_definition_response.DeleteDaemonTaskDefinitionResponse = capo_ecs.types.delete_daemon_task_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = (
        "AmazonEC2ContainerServiceV20141113.DeleteDaemonTaskDefinition"
    )
    body: bytes | None = json.dumps(
        capo_ecs.types.delete_daemon_task_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
