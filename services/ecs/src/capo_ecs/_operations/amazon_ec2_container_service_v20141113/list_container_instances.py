"""Generated from Smithy shape ``com.amazonaws.ecs#ListContainerInstances``."""
...
def handle_response(
    ...
    out: capo_ecs.types.list_container_instances_response.ListContainerInstancesResponse = capo_ecs.types.list_container_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.list_container_instances_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_container_instances(
