...
def handle_response(
    ...
    out: capo_ecs.types.delete_attributes_response.DeleteAttributesResponse = (
        capo_ecs.types.delete_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.delete_attributes_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_attributes(
    ...
    capo_ecs.types.delete_attributes_response.DeleteAttributesResponse, zapros.Response
]:
