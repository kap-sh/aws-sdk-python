...
import capo_ecs.errors.attribute_limit_exceeded_exception
...
import capo_ecs.errors.target_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AttributeLimitExceededException":
            raise capo_ecs.errors.attribute_limit_exceeded_exception.AttributeLimitExceededException.from_aws_json_1_1(
                data, message
            )
        ...
        case "TargetNotFoundException":
            raise capo_ecs.errors.target_not_found_exception.TargetNotFoundException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ecs.types.put_attributes_response.PutAttributesResponse = (
        capo_ecs.types.put_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.put_attributes_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_attributes(
    ...
    capo_ecs.types.put_attributes_response.PutAttributesResponse, zapros.Response
]:
