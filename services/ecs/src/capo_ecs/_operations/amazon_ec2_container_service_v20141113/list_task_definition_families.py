...
def handle_response(
    ...
    out: capo_ecs.types.list_task_definition_families_response.ListTaskDefinitionFamiliesResponse = capo_ecs.types.list_task_definition_families_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.list_task_definition_families_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
