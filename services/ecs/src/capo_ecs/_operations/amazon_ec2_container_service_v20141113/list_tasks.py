...
def handle_response(
    ...
    out: capo_ecs.types.list_tasks_response.ListTasksResponse = (
        capo_ecs.types.list_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.list_tasks_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_tasks(
    ...
    input_: capo_ecs.types.list_tasks_request.ListTasksRequest,
) -> tuple[capo_ecs.types.list_tasks_response.ListTasksResponse, zapros.Response]:
