...
def handle_response(
    ...
    out: capo_ecs.types.discover_poll_endpoint_response.DiscoverPollEndpointResponse = (
        capo_ecs.types.discover_poll_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.discover_poll_endpoint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
