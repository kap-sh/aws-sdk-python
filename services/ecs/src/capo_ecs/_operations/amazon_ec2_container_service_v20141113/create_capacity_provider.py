...
def handle_response(
    ...
    out: capo_ecs.types.create_capacity_provider_response.CreateCapacityProviderResponse = capo_ecs.types.create_capacity_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.create_capacity_provider_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
