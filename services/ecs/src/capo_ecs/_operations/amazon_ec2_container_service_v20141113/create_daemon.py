...
def handle_response(
    ...
    out: capo_ecs.types.create_daemon_response.CreateDaemonResponse = (
        capo_ecs.types.create_daemon_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerServiceV20141113.CreateDaemon"
    body: bytes | None = json.dumps(
        capo_ecs.types.create_daemon_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_daemon(
    ...
    input_: capo_ecs.types.create_daemon_request.CreateDaemonRequest,
) -> tuple[capo_ecs.types.create_daemon_response.CreateDaemonResponse, zapros.Response]:
