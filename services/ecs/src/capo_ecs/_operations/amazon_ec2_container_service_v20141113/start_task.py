...
def handle_response(
    ...
    out: capo_ecs.types.start_task_response.StartTaskResponse = (
        capo_ecs.types.start_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.start_task_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_task(
    ...
    input_: capo_ecs.types.start_task_request.StartTaskRequest,
) -> tuple[capo_ecs.types.start_task_response.StartTaskResponse, zapros.Response]:
