...
def handle_response(
    ...
    out: capo_ecs.types.describe_container_instances_response.DescribeContainerInstancesResponse = capo_ecs.types.describe_container_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.describe_container_instances_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
