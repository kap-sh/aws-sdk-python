"""Generated from Smithy shape ``com.amazonaws.ecs#ListTaskDefinitions``."""
...
def handle_response(
    ...
    out: capo_ecs.types.list_task_definitions_response.ListTaskDefinitionsResponse = (
        capo_ecs.types.list_task_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.list_task_definitions_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_task_definitions(
