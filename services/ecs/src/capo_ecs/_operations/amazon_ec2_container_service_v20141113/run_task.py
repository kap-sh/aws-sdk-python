...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BlockedException":
            raise capo_ecs.errors.blocked_exception.BlockedException.from_aws_json_1_1(
                data, message
            )
        ...
        case "ConflictException":
            raise capo_ecs.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecs.types.run_task_response.RunTaskResponse = (
        capo_ecs.types.run_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.run_task_request.serialize_aws_json_1_1(input_), allow_nan=False
    ).encode()
...
def run_task(
    options: OperationOptions, input_: capo_ecs.types.run_task_request.RunTaskRequest
) -> tuple[capo_ecs.types.run_task_response.RunTaskResponse, zapros.Response]:
