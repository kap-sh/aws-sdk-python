...
def handle_response(
    ...
    out: capo_ecs.types.update_capacity_provider_response.UpdateCapacityProviderResponse = capo_ecs.types.update_capacity_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.update_capacity_provider_request.serialize_aws_json_1_1(input_)
    ).encode()
