...
def handle_response(
    ...
    out: capo_ecs.types.create_task_set_response.CreateTaskSetResponse = (
        capo_ecs.types.create_task_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.create_task_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_task_set(
    ...
    capo_ecs.types.create_task_set_response.CreateTaskSetResponse, zapros.Response
]:
