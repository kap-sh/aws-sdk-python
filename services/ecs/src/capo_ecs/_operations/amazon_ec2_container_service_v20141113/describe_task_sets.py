...
def handle_response(
    ...
    out: capo_ecs.types.describe_task_sets_response.DescribeTaskSetsResponse = (
        capo_ecs.types.describe_task_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.describe_task_sets_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_task_sets(
    ...
    capo_ecs.types.describe_task_sets_response.DescribeTaskSetsResponse, zapros.Response
]:
