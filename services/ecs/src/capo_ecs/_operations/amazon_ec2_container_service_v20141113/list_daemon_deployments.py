...
import capo_ecs.types.daemon_deployment_summary_list
...
def handle_response(
    ...
    out: capo_ecs.types.list_daemon_deployments_response.ListDaemonDeploymentsResponse = capo_ecs.types.list_daemon_deployments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.list_daemon_deployments_request.serialize_aws_json_1_1(input_)
    ).encode()
