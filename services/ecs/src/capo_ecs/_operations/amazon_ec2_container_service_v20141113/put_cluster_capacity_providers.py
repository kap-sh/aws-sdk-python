...
import capo_ecs.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_ecs.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecs.types.put_cluster_capacity_providers_response.PutClusterCapacityProvidersResponse = capo_ecs.types.put_cluster_capacity_providers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.put_cluster_capacity_providers_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
