...
def handle_response(
    ...
    out: capo_ecs.types.describe_express_gateway_service_response.DescribeExpressGatewayServiceResponse = capo_ecs.types.describe_express_gateway_service_response.deserialize_aws_json_1_1(
