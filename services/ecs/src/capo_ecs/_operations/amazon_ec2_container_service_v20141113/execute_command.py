...
import capo_ecs.errors.target_not_connected_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TargetNotConnectedException":
            raise capo_ecs.errors.target_not_connected_exception.TargetNotConnectedException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ecs.types.execute_command_response.ExecuteCommandResponse = (
        capo_ecs.types.execute_command_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.execute_command_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def execute_command(
    ...
    capo_ecs.types.execute_command_response.ExecuteCommandResponse, zapros.Response
]:
