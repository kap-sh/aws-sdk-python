...
def handle_response(
    ...
    out: capo_ecs.types.list_daemon_task_definitions_response.ListDaemonTaskDefinitionsResponse = capo_ecs.types.list_daemon_task_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.list_daemon_task_definitions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
