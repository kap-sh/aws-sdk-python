...
def handle_response(
    ...
    out: capo_ecs.types.create_cluster_response.CreateClusterResponse = (
        capo_ecs.types.create_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.create_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_cluster(
    ...
    capo_ecs.types.create_cluster_response.CreateClusterResponse, zapros.Response
]:
