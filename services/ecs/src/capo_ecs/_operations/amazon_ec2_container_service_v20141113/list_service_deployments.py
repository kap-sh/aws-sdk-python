...
def handle_response(
    ...
    out: capo_ecs.types.list_service_deployments_response.ListServiceDeploymentsResponse = capo_ecs.types.list_service_deployments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.list_service_deployments_request.serialize_aws_json_1_1(input_)
    ).encode()
