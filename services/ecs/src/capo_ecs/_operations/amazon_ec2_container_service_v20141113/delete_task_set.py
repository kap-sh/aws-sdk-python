...
import capo_ecs.errors.task_set_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_ecs.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data, message
            )
        ...
        case "TaskSetNotFoundException":
            raise capo_ecs.errors.task_set_not_found_exception.TaskSetNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecs.types.delete_task_set_response.DeleteTaskSetResponse = (
        capo_ecs.types.delete_task_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.delete_task_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_task_set(
    ...
    capo_ecs.types.delete_task_set_response.DeleteTaskSetResponse, zapros.Response
]:
