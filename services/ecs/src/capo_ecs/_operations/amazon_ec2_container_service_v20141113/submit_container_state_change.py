...
def handle_response(
    ...
    out: capo_ecs.types.submit_container_state_change_response.SubmitContainerStateChangeResponse = capo_ecs.types.submit_container_state_change_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.submit_container_state_change_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
