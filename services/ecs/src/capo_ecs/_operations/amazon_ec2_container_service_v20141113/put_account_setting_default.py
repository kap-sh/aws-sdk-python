...
def handle_response(
    ...
    out: capo_ecs.types.put_account_setting_default_response.PutAccountSettingDefaultResponse = capo_ecs.types.put_account_setting_default_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.put_account_setting_default_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
