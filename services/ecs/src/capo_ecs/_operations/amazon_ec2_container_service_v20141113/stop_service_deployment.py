...
def handle_response(
    ...
    out: capo_ecs.types.stop_service_deployment_response.StopServiceDeploymentResponse = capo_ecs.types.stop_service_deployment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.stop_service_deployment_request.serialize_aws_json_1_1(input_)
    ).encode()
