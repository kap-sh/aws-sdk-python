...
def handle_response(
    ...
    out: capo_ecs.types.delete_account_setting_response.DeleteAccountSettingResponse = (
        capo_ecs.types.delete_account_setting_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.delete_account_setting_request.serialize_aws_json_1_1(input_)
    ).encode()
