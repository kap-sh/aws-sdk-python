...
def handle_response(
    ...
    out: capo_ecs.types.describe_tasks_response.DescribeTasksResponse = (
        capo_ecs.types.describe_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.describe_tasks_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_tasks(
    ...
    capo_ecs.types.describe_tasks_response.DescribeTasksResponse, zapros.Response
]:
