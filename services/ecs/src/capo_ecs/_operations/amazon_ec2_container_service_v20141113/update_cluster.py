...
def handle_response(
    ...
    out: capo_ecs.types.update_cluster_response.UpdateClusterResponse = (
        capo_ecs.types.update_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerServiceV20141113.UpdateCluster"
    body: bytes | None = json.dumps(
        capo_ecs.types.update_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_cluster(
    ...
    capo_ecs.types.update_cluster_response.UpdateClusterResponse, zapros.Response
]:
