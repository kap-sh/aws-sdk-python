...
def handle_response(
    ...
    out: capo_ecs.types.list_attributes_response.ListAttributesResponse = (
        capo_ecs.types.list_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.list_attributes_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_attributes(
    ...
    capo_ecs.types.list_attributes_response.ListAttributesResponse, zapros.Response
]:
