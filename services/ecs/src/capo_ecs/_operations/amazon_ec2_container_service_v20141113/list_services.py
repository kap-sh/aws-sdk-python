...
def handle_response(
    ...
    out: capo_ecs.types.list_services_response.ListServicesResponse = (
        capo_ecs.types.list_services_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.list_services_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_services(
    ...
    input_: capo_ecs.types.list_services_request.ListServicesRequest,
) -> tuple[capo_ecs.types.list_services_response.ListServicesResponse, zapros.Response]:
