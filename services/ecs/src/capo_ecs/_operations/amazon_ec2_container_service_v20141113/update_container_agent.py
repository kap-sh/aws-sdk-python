...
import capo_ecs.errors.missing_version_exception
import capo_ecs.errors.no_update_available_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MissingVersionException":
            raise capo_ecs.errors.missing_version_exception.MissingVersionException.from_aws_json_1_1(
                data, message
            )
        case "NoUpdateAvailableException":
            raise capo_ecs.errors.no_update_available_exception.NoUpdateAvailableException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecs.types.update_container_agent_response.UpdateContainerAgentResponse = (
        capo_ecs.types.update_container_agent_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.update_container_agent_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
