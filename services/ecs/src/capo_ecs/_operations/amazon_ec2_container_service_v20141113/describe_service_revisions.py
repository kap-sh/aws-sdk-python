...
def handle_response(
    ...
    out: capo_ecs.types.describe_service_revisions_response.DescribeServiceRevisionsResponse = capo_ecs.types.describe_service_revisions_response.deserialize_aws_json_1_1(
