...
import capo_ecs.errors.service_deployment_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceDeploymentNotFoundException":
            raise capo_ecs.errors.service_deployment_not_found_exception.ServiceDeploymentNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecs.types.continue_service_deployment_response.ContinueServiceDeploymentResponse = capo_ecs.types.continue_service_deployment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.continue_service_deployment_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
