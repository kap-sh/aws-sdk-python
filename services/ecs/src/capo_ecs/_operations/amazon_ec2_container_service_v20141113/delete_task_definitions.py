...
def handle_response(
    ...
    out: capo_ecs.types.delete_task_definitions_response.DeleteTaskDefinitionsResponse = capo_ecs.types.delete_task_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.delete_task_definitions_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
