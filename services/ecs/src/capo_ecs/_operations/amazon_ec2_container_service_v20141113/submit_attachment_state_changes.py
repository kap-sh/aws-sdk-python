...
def handle_response(
    ...
    out: capo_ecs.types.submit_attachment_state_changes_response.SubmitAttachmentStateChangesResponse = capo_ecs.types.submit_attachment_state_changes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.submit_attachment_state_changes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
