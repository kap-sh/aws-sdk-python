...
def handle_response(
    ...
    out: capo_ecs.types.register_container_instance_response.RegisterContainerInstanceResponse = capo_ecs.types.register_container_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.register_container_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
