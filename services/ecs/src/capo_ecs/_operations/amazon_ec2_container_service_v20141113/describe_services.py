...
def handle_response(
    ...
    out: capo_ecs.types.describe_services_response.DescribeServicesResponse = (
        capo_ecs.types.describe_services_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.describe_services_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_services(
    ...
    capo_ecs.types.describe_services_response.DescribeServicesResponse, zapros.Response
]:
