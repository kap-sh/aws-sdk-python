...
def handle_response(
    ...
    out: capo_ecs.types.delete_daemon_response.DeleteDaemonResponse = (
        capo_ecs.types.delete_daemon_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.delete_daemon_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_daemon(
    ...
    input_: capo_ecs.types.delete_daemon_request.DeleteDaemonRequest,
) -> tuple[capo_ecs.types.delete_daemon_response.DeleteDaemonResponse, zapros.Response]:
