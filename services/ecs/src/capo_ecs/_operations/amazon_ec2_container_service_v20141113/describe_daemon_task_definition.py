...
def handle_response(
    ...
    out: capo_ecs.types.describe_daemon_task_definition_response.DescribeDaemonTaskDefinitionResponse = capo_ecs.types.describe_daemon_task_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.describe_daemon_task_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
