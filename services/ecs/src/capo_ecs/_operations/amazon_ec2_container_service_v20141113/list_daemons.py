...
def handle_response(
    ...
    out: capo_ecs.types.list_daemons_response.ListDaemonsResponse = (
        capo_ecs.types.list_daemons_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerServiceV20141113.ListDaemons"
    body: bytes | None = json.dumps(
        capo_ecs.types.list_daemons_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_daemons(
    ...
    input_: capo_ecs.types.list_daemons_request.ListDaemonsRequest,
) -> tuple[capo_ecs.types.list_daemons_response.ListDaemonsResponse, zapros.Response]:
