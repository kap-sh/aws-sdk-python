...
import capo_ecs.errors.namespace_not_found_exception
import capo_ecs.errors.platform_task_definition_incompatibility_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NamespaceNotFoundException":
            raise capo_ecs.errors.namespace_not_found_exception.NamespaceNotFoundException.from_aws_json_1_1(
                data, message
            )
        case "PlatformTaskDefinitionIncompatibilityException":
            raise capo_ecs.errors.platform_task_definition_incompatibility_exception.PlatformTaskDefinitionIncompatibilityException.from_aws_json_1_1(
                data, message
            )
        ...
        case "ServiceNotActiveException":
            raise capo_ecs.errors.service_not_active_exception.ServiceNotActiveException.from_aws_json_1_1(
                data, message
            )
        case "ServiceNotFoundException":
            raise capo_ecs.errors.service_not_found_exception.ServiceNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ecs.types.update_service_response.UpdateServiceResponse = (
        capo_ecs.types.update_service_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.update_service_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_service(
    ...
    capo_ecs.types.update_service_response.UpdateServiceResponse, zapros.Response
]:
