...
def handle_response(
    ...
    out: capo_ecs.types.stop_task_response.StopTaskResponse = (
        capo_ecs.types.stop_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_ecs.types.stop_task_request.StopTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def stop_task(
    options: OperationOptions, input_: capo_ecs.types.stop_task_request.StopTaskRequest
) -> tuple[capo_ecs.types.stop_task_response.StopTaskResponse, zapros.Response]:
