...
def handle_response(
    ...
    out: capo_ecs.types.deregister_task_definition_response.DeregisterTaskDefinitionResponse = capo_ecs.types.deregister_task_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.deregister_task_definition_request.serialize_aws_json_1_1(input_)
    ).encode()
