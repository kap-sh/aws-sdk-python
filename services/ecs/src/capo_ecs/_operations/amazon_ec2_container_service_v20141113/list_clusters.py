...
def handle_response(
    ...
    out: capo_ecs.types.list_clusters_response.ListClustersResponse = (
        capo_ecs.types.list_clusters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.list_clusters_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_clusters(
    ...
    input_: capo_ecs.types.list_clusters_request.ListClustersRequest,
) -> tuple[capo_ecs.types.list_clusters_response.ListClustersResponse, zapros.Response]:
