...
def handle_response(
    ...
    out: capo_ecs.types.delete_express_gateway_service_response.DeleteExpressGatewayServiceResponse = capo_ecs.types.delete_express_gateway_service_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.delete_express_gateway_service_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
