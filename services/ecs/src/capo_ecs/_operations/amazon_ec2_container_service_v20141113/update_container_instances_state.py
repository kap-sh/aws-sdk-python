...
def handle_response(
    ...
    out: capo_ecs.types.update_container_instances_state_response.UpdateContainerInstancesStateResponse = capo_ecs.types.update_container_instances_state_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ecs.types.update_container_instances_state_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
