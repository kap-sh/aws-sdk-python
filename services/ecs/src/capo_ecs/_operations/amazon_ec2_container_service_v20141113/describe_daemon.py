...
def handle_response(
    ...
    out: capo_ecs.types.describe_daemon_response.DescribeDaemonResponse = (
        capo_ecs.types.describe_daemon_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonEC2ContainerServiceV20141113.DescribeDaemon"
    body: bytes | None = json.dumps(
        capo_ecs.types.describe_daemon_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_daemon(
    ...
    capo_ecs.types.describe_daemon_response.DescribeDaemonResponse, zapros.Response
]:
