...
class ListDaemonDeploymentsResponse(TypedDict, closed=True):
    ...
    daemon_deployments: NotRequired[
        "capo_ecs.types.daemon_deployment_summary_list.DaemonDeploymentSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListDaemonDeploymentsResponse) -> dict:
    ...
    if "daemon_deployments" in value:
        ...
        out["daemonDeployments"] = (
            capo_ecs.types.daemon_deployment_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListDaemonDeploymentsResponse:
    ...
    if data.get("daemonDeployments") is not None:
        import capo_ecs.types.daemon_deployment_summary_list

        out["daemon_deployments"] = (
            capo_ecs.types.daemon_deployment_summary_list.deserialize_aws_json_1_1(
