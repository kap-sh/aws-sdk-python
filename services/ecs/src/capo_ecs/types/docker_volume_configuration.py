...
class DockerVolumeConfiguration(TypedDict, closed=True):
    scope: NotRequired["capo_ecs.types.scope.Scope"]
    ...
    autoprovision: NotRequired["capo_ecs.types.boxed_boolean.BoxedBoolean"]
    ...
    driver: NotRequired["capo_ecs.types.string.String"]
    ...
    driver_opts: NotRequired["capo_ecs.types.string_map.StringMap"]
    ...
    labels: NotRequired["capo_ecs.types.string_map.StringMap"]
...
def serialize_aws_json_1_1(value: DockerVolumeConfiguration) -> dict:
    ...
    if "scope" in value:
        ...
        out["scope"] = capo_ecs.types.scope.serialize_aws_json_1_1(value["scope"])
    ...
    if "driver_opts" in value:
        ...
        out["driverOpts"] = capo_ecs.types.string_map.serialize_aws_json_1_1(
            value["driver_opts"]
        )
    if "labels" in value:
        import capo_ecs.types.string_map

        out["labels"] = capo_ecs.types.string_map.serialize_aws_json_1_1(
            value["labels"]
        )
    return out
