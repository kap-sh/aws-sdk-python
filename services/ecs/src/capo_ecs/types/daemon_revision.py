...
class DaemonRevision(TypedDict, closed=True):
    daemon_revision_arn: NotRequired["capo_ecs.types.string.String"]
    ...
    container_images: NotRequired[
        "capo_ecs.types.daemon_container_images.DaemonContainerImages"
    ]
...
def serialize_aws_json_1_1(value: DaemonRevision) -> dict:
    ...
    if "container_images" in value:
        ...
        out["containerImages"] = (
            capo_ecs.types.daemon_container_images.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DaemonRevision:
    ...
    if "containerImages" in data:
        ...
        out["container_images"] = (
            capo_ecs.types.daemon_container_images.deserialize_aws_json_1_1(
