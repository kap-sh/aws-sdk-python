...
class ListTasksRequest(TypedDict, closed=True):
    ...
    desired_status: NotRequired["capo_ecs.types.desired_status.DesiredStatus"]
    ...
    daemon_name: NotRequired["capo_ecs.types.string.String"]
...
def serialize_aws_json_1_1(value: ListTasksRequest) -> dict:
    ...
    if "desired_status" in value:
        ...
        out["desiredStatus"] = capo_ecs.types.desired_status.serialize_aws_json_1_1(
