...
class RegisterContainerInstanceRequest(TypedDict, closed=True):
    ...
    instance_identity_document: NotRequired["capo_ecs.types.string.String"]
    ...
    instance_identity_document_signature: NotRequired["capo_ecs.types.string.String"]
    ...
    total_resources: NotRequired["capo_ecs.types.resources.Resources"]
    ...
    platform_devices: NotRequired["capo_ecs.types.platform_devices.PlatformDevices"]
...
def serialize_aws_json_1_1(value: RegisterContainerInstanceRequest) -> dict:
    ...
    if "total_resources" in value:
        ...
        out["totalResources"] = capo_ecs.types.resources.serialize_aws_json_1_1(
    ...
    if "platform_devices" in value:
        ...
        out["platformDevices"] = capo_ecs.types.platform_devices.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RegisterContainerInstanceRequest:
    ...
    if "platformDevices" in data:
        ...
        out["platform_devices"] = (
            capo_ecs.types.platform_devices.deserialize_aws_json_1_1(
