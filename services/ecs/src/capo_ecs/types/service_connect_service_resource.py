...
class ServiceConnectServiceResource(TypedDict, closed=True):
    discovery_name: NotRequired["capo_ecs.types.string.String"]
    ...
    discovery_arn: NotRequired["capo_ecs.types.string.String"]
