...
class AutoRepairConfiguration(TypedDict, closed=True):
    actions_status: NotRequired[
        "capo_ecs.types.auto_repair_actions_status.AutoRepairActionsStatus"
    ]
...
def serialize_aws_json_1_1(value: AutoRepairConfiguration) -> dict:
    ...
    if "actions_status" in value:
        ...
        out["actionsStatus"] = (
            capo_ecs.types.auto_repair_actions_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AutoRepairConfiguration:
    ...
    if "actionsStatus" in data:
        ...
        out["actions_status"] = (
            capo_ecs.types.auto_repair_actions_status.deserialize_aws_json_1_1(
                data["actionsStatus"]
            )
        )
    return out
