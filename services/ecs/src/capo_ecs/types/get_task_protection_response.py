...
class GetTaskProtectionResponse(TypedDict, closed=True):
    protected_tasks: NotRequired["capo_ecs.types.protected_tasks.ProtectedTasks"]
...
def serialize_aws_json_1_1(value: GetTaskProtectionResponse) -> dict:
    ...
    if "protected_tasks" in value:
        ...
        out["protectedTasks"] = capo_ecs.types.protected_tasks.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetTaskProtectionResponse:
    ...
    if data.get("protectedTasks") is not None:
        ...
        out["protected_tasks"] = (
            capo_ecs.types.protected_tasks.deserialize_aws_json_1_1(
                data["protectedTasks"]
            )
        )
