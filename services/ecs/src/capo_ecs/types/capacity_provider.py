...
class CapacityProvider(TypedDict, closed=True):
    capacity_provider_arn: NotRequired["capo_ecs.types.string.String"]
    ...
    status: NotRequired[
        "capo_ecs.types.capacity_provider_status.CapacityProviderStatus"
    ]
    ...
    managed_instances_provider: NotRequired[
        "capo_ecs.types.managed_instances_provider.ManagedInstancesProvider"
    ]
    ...
    update_status: NotRequired[
        "capo_ecs.types.capacity_provider_update_status.CapacityProviderUpdateStatus"
    ]
    ...
    update_status_reason: NotRequired["capo_ecs.types.string.String"]
    ...
    type: NotRequired["capo_ecs.types.capacity_provider_type.CapacityProviderType"]
...
def serialize_aws_json_1_1(value: CapacityProvider) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = capo_ecs.types.capacity_provider_status.serialize_aws_json_1_1(
            value["status"]
        )
    ...
    if "managed_instances_provider" in value:
        ...
        out["managedInstancesProvider"] = (
            capo_ecs.types.managed_instances_provider.serialize_aws_json_1_1(
    ...
    if "update_status" in value:
        ...
        out["updateStatus"] = (
            capo_ecs.types.capacity_provider_update_status.serialize_aws_json_1_1(
                value["update_status"]
            )
        )
    ...
    if "type" in value:
        ...
        out["type"] = capo_ecs.types.capacity_provider_type.serialize_aws_json_1_1(
            value["type"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CapacityProvider:
    ...
    if "status" in data:
        ...
        out["status"] = (
            capo_ecs.types.capacity_provider_status.deserialize_aws_json_1_1(
                data["status"]
            )
        )
    ...
    if "managedInstancesProvider" in data:
        ...
        out["managed_instances_provider"] = (
            capo_ecs.types.managed_instances_provider.deserialize_aws_json_1_1(
    ...
    if "updateStatus" in data:
        ...
        out["update_status"] = (
            capo_ecs.types.capacity_provider_update_status.deserialize_aws_json_1_1(
                data["updateStatus"]
            )
        )
