...
class ListClustersResponse(TypedDict, closed=True):
    cluster_arns: NotRequired["capo_ecs.types.string_list.StringList"]
...
def serialize_aws_json_1_1(value: ListClustersResponse) -> dict:
    ...
    if "cluster_arns" in value:
        ...
        out["clusterArns"] = capo_ecs.types.string_list.serialize_aws_json_1_1(
            value["cluster_arns"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListClustersResponse:
    ...
    if data.get("clusterArns") is not None:
        import capo_ecs.types.string_list

        out["cluster_arns"] = capo_ecs.types.string_list.deserialize_aws_json_1_1(
            data["clusterArns"]
        )
