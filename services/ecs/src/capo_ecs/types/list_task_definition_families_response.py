...
class ListTaskDefinitionFamiliesResponse(TypedDict, closed=True):
    families: NotRequired["capo_ecs.types.string_list.StringList"]
...
def serialize_aws_json_1_1(value: ListTaskDefinitionFamiliesResponse) -> dict:
    ...
    if "families" in value:
        ...
        out["families"] = capo_ecs.types.string_list.serialize_aws_json_1_1(
            value["families"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListTaskDefinitionFamiliesResponse:
    ...
    if "families" in data:
        ...
        out["families"] = capo_ecs.types.string_list.deserialize_aws_json_1_1(
            data["families"]
        )
