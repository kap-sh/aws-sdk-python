...
Statistics: TypeAlias = list["capo_ecs.types.key_value_pair.KeyValuePair"]


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: Statistics) -> list:
    import capo_ecs.types.key_value_pair
...
def deserialize_aws_json_1_1(data: list) -> Statistics:
    import capo_ecs.types.key_value_pair
