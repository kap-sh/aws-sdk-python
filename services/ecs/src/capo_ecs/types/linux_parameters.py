...
class LinuxParameters(TypedDict, closed=True):
    ...
    shared_memory_size: NotRequired["capo_ecs.types.boxed_integer.BoxedInteger"]
    ...
    max_swap: NotRequired["capo_ecs.types.boxed_integer.BoxedInteger"]
    ...
    swappiness: NotRequired["capo_ecs.types.boxed_integer.BoxedInteger"]
