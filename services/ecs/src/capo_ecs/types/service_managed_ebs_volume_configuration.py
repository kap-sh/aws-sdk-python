"""Generated from Smithy shape ``com.amazonaws.ecs#ServiceManagedEBSVolumeConfiguration``."""
...
class ServiceManagedEBSVolumeConfiguration(TypedDict, closed=True):
    ...
    r"""<p>The snapshot that Amazon ECS uses to create volumes for attachment to tasks maintained by the service. You must specify either <code>snapshotId</code> or <code>sizeInGiB</code> in your volume configuration. This parameter maps 1:1 with the <code>SnapshotId</code> parameter of the <a href=\"https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html\">CreateVolume API</a> in the <i>Amazon EC2 API Reference</i>.</p>"""
