...
if TYPE_CHECKING:
    import capo_ecs.types.tag_key
    import capo_ecs.types.tag_value


class Tag(TypedDict, closed=True):
    key: NotRequired["capo_ecs.types.tag_key.TagKey"]
    ...
    value: NotRequired["capo_ecs.types.tag_value.TagValue"]
