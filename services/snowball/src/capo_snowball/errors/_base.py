...
class SnowballError(Exception):
    """Base class for all Snowball service errors."""


class ServiceError(SnowballError):
...
class SerializationError(SnowballError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SnowballError):
...
class WaiterFailedError(SnowballError):
...
class WaiterTimeoutError(SnowballError):
