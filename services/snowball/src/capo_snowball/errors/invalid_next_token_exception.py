"""Generated from Smithy shape ``com.amazonaws.snowball#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.snowball#InvalidNextTokenException``."""
