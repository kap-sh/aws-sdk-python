...
def handle_response(
    ...
    out: capo_snowball.types.describe_job_result.DescribeJobResult = (
        capo_snowball.types.describe_job_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.describe_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_job(
    ...
    input_: capo_snowball.types.describe_job_request.DescribeJobRequest,
) -> tuple[capo_snowball.types.describe_job_result.DescribeJobResult, zapros.Response]:
