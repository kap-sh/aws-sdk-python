...
import capo_snowball.types.cluster_list_entry_list
...
def handle_response(
    ...
    out: capo_snowball.types.list_clusters_result.ListClustersResult = (
        capo_snowball.types.list_clusters_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.list_clusters_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_clusters(
    ...
    capo_snowball.types.list_clusters_result.ListClustersResult, zapros.Response
]:
