...
import capo_snowball.errors.conflict_exception
...
import capo_snowball.errors.return_shipping_label_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise capo_snowball.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        ...
        case "ReturnShippingLabelAlreadyExistsException":
            raise capo_snowball.errors.return_shipping_label_already_exists_exception.ReturnShippingLabelAlreadyExistsException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_snowball.types.create_return_shipping_label_result.CreateReturnShippingLabelResult = capo_snowball.types.create_return_shipping_label_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.create_return_shipping_label_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
