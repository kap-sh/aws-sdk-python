...
def handle_response(
    ...
    out: capo_snowball.types.update_long_term_pricing_result.UpdateLongTermPricingResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.update_long_term_pricing_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
