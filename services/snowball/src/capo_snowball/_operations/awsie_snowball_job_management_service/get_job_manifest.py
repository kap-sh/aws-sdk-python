...
def handle_response(
    ...
    out: capo_snowball.types.get_job_manifest_result.GetJobManifestResult = (
        capo_snowball.types.get_job_manifest_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.get_job_manifest_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_job_manifest(
    ...
    capo_snowball.types.get_job_manifest_result.GetJobManifestResult, zapros.Response
]:
