...
def handle_response(
    ...
    out: capo_snowball.types.update_job_result.UpdateJobResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.update_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_job(
    ...
    input_: capo_snowball.types.update_job_request.UpdateJobRequest,
) -> tuple[capo_snowball.types.update_job_result.UpdateJobResult, zapros.Response]:
