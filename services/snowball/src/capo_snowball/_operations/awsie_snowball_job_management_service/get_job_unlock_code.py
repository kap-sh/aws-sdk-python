"""Generated from Smithy shape ``com.amazonaws.snowball#GetJobUnlockCode``."""
...
def handle_response(
    ...
    out: capo_snowball.types.get_job_unlock_code_result.GetJobUnlockCodeResult = (
        capo_snowball.types.get_job_unlock_code_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.get_job_unlock_code_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_job_unlock_code(
