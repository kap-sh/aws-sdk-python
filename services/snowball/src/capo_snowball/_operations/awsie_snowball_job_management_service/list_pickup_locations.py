"""Generated from Smithy shape ``com.amazonaws.snowball#ListPickupLocations``."""
...
def handle_response(
    ...
    out: capo_snowball.types.list_pickup_locations_result.ListPickupLocationsResult = (
        capo_snowball.types.list_pickup_locations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSIESnowballJobManagementService.ListPickupLocations"
    body: bytes | None = json.dumps(
        capo_snowball.types.list_pickup_locations_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_pickup_locations(
