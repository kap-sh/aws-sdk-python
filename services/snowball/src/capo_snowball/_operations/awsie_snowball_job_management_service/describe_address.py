"""Generated from Smithy shape ``com.amazonaws.snowball#DescribeAddress``."""
...
def handle_response(
    ...
    out: capo_snowball.types.describe_address_result.DescribeAddressResult = (
        capo_snowball.types.describe_address_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.describe_address_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_address(
    ...
    capo_snowball.types.describe_address_result.DescribeAddressResult, zapros.Response
]:
...
async def async_describe_address(
