"""Generated from Smithy shape ``com.amazonaws.snowball#UpdateCluster``."""
...
def handle_response(
    ...
    out: capo_snowball.types.update_cluster_result.UpdateClusterResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.update_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_cluster(
    ...
    capo_snowball.types.update_cluster_result.UpdateClusterResult, zapros.Response
]:
