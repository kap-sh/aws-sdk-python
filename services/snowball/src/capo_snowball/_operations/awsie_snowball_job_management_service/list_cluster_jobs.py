"""Generated from Smithy shape ``com.amazonaws.snowball#ListClusterJobs``."""
...
def handle_response(
    ...
    out: capo_snowball.types.list_cluster_jobs_result.ListClusterJobsResult = (
        capo_snowball.types.list_cluster_jobs_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.list_cluster_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_cluster_jobs(
    ...
    capo_snowball.types.list_cluster_jobs_result.ListClusterJobsResult, zapros.Response
]:
...
async def async_list_cluster_jobs(
