...
def handle_response(
    ...
    out: capo_snowball.types.describe_return_shipping_label_result.DescribeReturnShippingLabelResult = capo_snowball.types.describe_return_shipping_label_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.describe_return_shipping_label_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
