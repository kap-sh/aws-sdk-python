"""Generated from Smithy shape ``com.amazonaws.snowball#ListServiceVersions``."""
...
import capo_snowball.types.service_version_list
...
def handle_response(
    ...
    out: capo_snowball.types.list_service_versions_result.ListServiceVersionsResult = (
        capo_snowball.types.list_service_versions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSIESnowballJobManagementService.ListServiceVersions"
    body: bytes | None = json.dumps(
        capo_snowball.types.list_service_versions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_service_versions(
