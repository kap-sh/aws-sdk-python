...
def build_request(
    ...
    input: aws_sdk_snowball.types.describe_cluster_request.DescribeClusterRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.describe_cluster_request.serialize_aws_json_1_1(input)
    ).encode()
