"""Generated from Smithy shape ``com.amazonaws.snowball#DescribeCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.describe_cluster_result.DescribeClusterResult = (
        aws_sdk_snowball.types.describe_cluster_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.describe_cluster_request.DescribeClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.describe_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
