"""Generated from Smithy shape ``com.amazonaws.snowball#ListClusters``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.list_clusters_result.ListClustersResult = (
        aws_sdk_snowball.types.list_clusters_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.list_clusters_request.ListClustersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.list_clusters_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_clusters(
    ...
    aws_sdk_snowball.types.list_clusters_result.ListClustersResult, zapros.Response
]:
