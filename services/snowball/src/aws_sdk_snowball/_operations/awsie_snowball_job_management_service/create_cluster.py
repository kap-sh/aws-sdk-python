"""Generated from Smithy shape ``com.amazonaws.snowball#CreateCluster``."""
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.create_cluster_request.CreateClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.create_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_cluster(
    ...
    aws_sdk_snowball.types.create_cluster_result.CreateClusterResult, zapros.Response
]:
