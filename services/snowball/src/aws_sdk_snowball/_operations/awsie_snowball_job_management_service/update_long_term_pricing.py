"""Generated from Smithy shape ``com.amazonaws.snowball#UpdateLongTermPricing``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.update_long_term_pricing_result.UpdateLongTermPricingResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.update_long_term_pricing_request.UpdateLongTermPricingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSIESnowballJobManagementService.UpdateLongTermPricing"
    import aws_sdk_snowball.types.update_long_term_pricing_request

    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.update_long_term_pricing_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_long_term_pricing(
