...
def handle_response(
    ...
    out: aws_sdk_snowball.types.describe_address_result.DescribeAddressResult = (
        aws_sdk_snowball.types.describe_address_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.describe_address_request.DescribeAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.describe_address_request.serialize_aws_json_1_1(input_)
    ).encode()
