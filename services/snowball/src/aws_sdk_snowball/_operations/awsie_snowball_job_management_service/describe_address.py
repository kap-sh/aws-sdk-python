...
def build_request(
    ...
    input: aws_sdk_snowball.types.describe_address_request.DescribeAddressRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.describe_address_request.serialize_aws_json_1_1(input)
    ).encode()
