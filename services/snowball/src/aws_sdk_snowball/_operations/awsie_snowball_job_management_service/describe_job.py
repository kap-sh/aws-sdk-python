"""Generated from Smithy shape ``com.amazonaws.snowball#DescribeJob``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.describe_job_result.DescribeJobResult = (
        aws_sdk_snowball.types.describe_job_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.describe_job_request.DescribeJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.describe_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_job(
    ...
    aws_sdk_snowball.types.describe_job_result.DescribeJobResult, zapros.Response
]:
