"""Generated from Smithy shape ``com.amazonaws.snowball#UpdateJobShipmentState``."""
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.update_job_shipment_state_request.UpdateJobShipmentStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSIESnowballJobManagementService.UpdateJobShipmentState"
    import aws_sdk_snowball.types.update_job_shipment_state_request

    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.update_job_shipment_state_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_job_shipment_state(
