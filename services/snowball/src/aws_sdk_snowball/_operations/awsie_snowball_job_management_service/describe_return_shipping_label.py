"""Generated from Smithy shape ``com.amazonaws.snowball#DescribeReturnShippingLabel``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.describe_return_shipping_label_result.DescribeReturnShippingLabelResult = aws_sdk_snowball.types.describe_return_shipping_label_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.describe_return_shipping_label_request.DescribeReturnShippingLabelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_return_shipping_label(
