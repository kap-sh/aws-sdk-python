"""Generated from Smithy shape ``com.amazonaws.snowball#CreateReturnShippingLabel``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            import aws_sdk_snowball.errors.conflict_exception

            raise aws_sdk_snowball.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        ...
        case "ReturnShippingLabelAlreadyExistsException":
            import aws_sdk_snowball.errors.return_shipping_label_already_exists_exception

            raise aws_sdk_snowball.errors.return_shipping_label_already_exists_exception.ReturnShippingLabelAlreadyExistsException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.create_return_shipping_label_result.CreateReturnShippingLabelResult = aws_sdk_snowball.types.create_return_shipping_label_result.deserialize_aws_json_1_1(
...
def get_signer(
...
) -> aws_sdk_snowball._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_snowball._auth._sigv4.build_sigv4_auth_scheme(
                "snowball", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_snowball._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.create_return_shipping_label_request.CreateReturnShippingLabelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.create_return_shipping_label_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_return_shipping_label(
