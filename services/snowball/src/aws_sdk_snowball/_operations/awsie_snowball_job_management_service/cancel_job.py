"""Generated from Smithy shape ``com.amazonaws.snowball#CancelJob``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.cancel_job_result.CancelJobResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.cancel_job_request.CancelJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.cancel_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def cancel_job(
    ...
    input_: aws_sdk_snowball.types.cancel_job_request.CancelJobRequest,
) -> tuple[aws_sdk_snowball.types.cancel_job_result.CancelJobResult, zapros.Response]:
