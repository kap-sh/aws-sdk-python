...
def build_request(
    ...
    input_: aws_sdk_snowball.types.list_cluster_jobs_request.ListClusterJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.list_cluster_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
