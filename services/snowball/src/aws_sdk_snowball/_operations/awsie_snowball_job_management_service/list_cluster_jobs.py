...
def build_request(
    ...
    input: aws_sdk_snowball.types.list_cluster_jobs_request.ListClusterJobsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.list_cluster_jobs_request.serialize_aws_json_1_1(input)
    ).encode()
