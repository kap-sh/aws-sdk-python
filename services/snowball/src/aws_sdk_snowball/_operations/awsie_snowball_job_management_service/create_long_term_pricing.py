...
def handle_response(
    ...
    out: aws_sdk_snowball.types.create_long_term_pricing_result.CreateLongTermPricingResult = aws_sdk_snowball.types.create_long_term_pricing_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.create_long_term_pricing_request.CreateLongTermPricingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
