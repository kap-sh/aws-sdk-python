"""Generated from Smithy shape ``com.amazonaws.snowball#GetSnowballUsage``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.get_snowball_usage_result.GetSnowballUsageResult = (
        aws_sdk_snowball.types.get_snowball_usage_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.get_snowball_usage_request.GetSnowballUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_snowball_usage(
