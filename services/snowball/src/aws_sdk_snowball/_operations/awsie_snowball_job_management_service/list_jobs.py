...
def handle_response(
    ...
    out: aws_sdk_snowball.types.list_jobs_result.ListJobsResult = (
        aws_sdk_snowball.types.list_jobs_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.list_jobs_request.ListJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.list_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_jobs(
    ...
    input_: aws_sdk_snowball.types.list_jobs_request.ListJobsRequest,
) -> tuple[aws_sdk_snowball.types.list_jobs_result.ListJobsResult, zapros.Response]:
