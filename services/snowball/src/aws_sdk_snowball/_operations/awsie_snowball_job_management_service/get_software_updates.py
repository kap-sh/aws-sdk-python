...
def handle_response(
    ...
    out: aws_sdk_snowball.types.get_software_updates_result.GetSoftwareUpdatesResult = (
        aws_sdk_snowball.types.get_software_updates_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.get_software_updates_request.GetSoftwareUpdatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.get_software_updates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
