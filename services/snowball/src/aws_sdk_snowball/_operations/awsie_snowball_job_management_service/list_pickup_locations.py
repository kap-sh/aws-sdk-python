...
def handle_response(
    ...
    out: aws_sdk_snowball.types.list_pickup_locations_result.ListPickupLocationsResult = aws_sdk_snowball.types.list_pickup_locations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.list_pickup_locations_request.ListPickupLocationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.list_pickup_locations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
