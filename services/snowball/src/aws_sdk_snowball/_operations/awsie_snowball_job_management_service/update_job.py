"""Generated from Smithy shape ``com.amazonaws.snowball#UpdateJob``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ClusterLimitExceededException":
            import aws_sdk_snowball.errors.cluster_limit_exceeded_exception

            raise aws_sdk_snowball.errors.cluster_limit_exceeded_exception.ClusterLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.update_job_result.UpdateJobResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.update_job_request.UpdateJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.update_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_job(
    ...
    input_: aws_sdk_snowball.types.update_job_request.UpdateJobRequest,
) -> tuple[aws_sdk_snowball.types.update_job_result.UpdateJobResult, zapros.Response]:
