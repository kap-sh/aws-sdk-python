...
def build_request(
    ...
    input: aws_sdk_snowball.types.get_job_manifest_request.GetJobManifestRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.get_job_manifest_request.serialize_aws_json_1_1(input)
    ).encode()
