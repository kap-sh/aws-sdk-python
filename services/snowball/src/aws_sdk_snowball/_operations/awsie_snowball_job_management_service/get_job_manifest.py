"""Generated from Smithy shape ``com.amazonaws.snowball#GetJobManifest``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.get_job_manifest_result.GetJobManifestResult = (
        aws_sdk_snowball.types.get_job_manifest_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.get_job_manifest_request.GetJobManifestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.get_job_manifest_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_job_manifest(
    ...
    aws_sdk_snowball.types.get_job_manifest_result.GetJobManifestResult, zapros.Response
]:
...
async def async_get_job_manifest(
