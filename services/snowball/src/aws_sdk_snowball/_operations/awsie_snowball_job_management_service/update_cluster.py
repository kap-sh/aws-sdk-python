...
def handle_response(
    ...
    out: aws_sdk_snowball.types.update_cluster_result.UpdateClusterResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.update_cluster_request.UpdateClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.update_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_cluster(
    ...
    aws_sdk_snowball.types.update_cluster_result.UpdateClusterResult, zapros.Response
]:
