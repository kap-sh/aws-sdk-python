...
def build_request(
    ...
    input_: aws_sdk_snowball.types.get_job_unlock_code_request.GetJobUnlockCodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.get_job_unlock_code_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
