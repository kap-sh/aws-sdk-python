...
def handle_response(
    ...
    out: aws_sdk_snowball.types.get_job_unlock_code_result.GetJobUnlockCodeResult = (
        aws_sdk_snowball.types.get_job_unlock_code_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_snowball.types.get_job_unlock_code_request.GetJobUnlockCodeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.get_job_unlock_code_request.serialize_aws_json_1_1(input)
    ).encode()
