"""Generated from Smithy shape ``com.amazonaws.snowball#ListCompatibleImages``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.list_compatible_images_result.ListCompatibleImagesResult = aws_sdk_snowball.types.list_compatible_images_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.list_compatible_images_request.ListCompatibleImagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.list_compatible_images_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_compatible_images(
