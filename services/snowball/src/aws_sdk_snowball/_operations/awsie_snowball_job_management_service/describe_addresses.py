"""Generated from Smithy shape ``com.amazonaws.snowball#DescribeAddresses``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.describe_addresses_result.DescribeAddressesResult = (
        aws_sdk_snowball.types.describe_addresses_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.describe_addresses_request.DescribeAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.describe_addresses_request.serialize_aws_json_1_1(input_)
    ).encode()
