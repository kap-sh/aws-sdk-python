...
def build_request(
    ...
    input: aws_sdk_snowball.types.describe_addresses_request.DescribeAddressesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.describe_addresses_request.serialize_aws_json_1_1(input)
    ).encode()
