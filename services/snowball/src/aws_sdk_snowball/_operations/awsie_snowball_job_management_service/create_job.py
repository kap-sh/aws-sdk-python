...
def handle_response(
    ...
    out: aws_sdk_snowball.types.create_job_result.CreateJobResult = (
        aws_sdk_snowball.types.create_job_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.create_job_request.CreateJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.create_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_job(
    ...
    input_: aws_sdk_snowball.types.create_job_request.CreateJobRequest,
) -> tuple[aws_sdk_snowball.types.create_job_result.CreateJobResult, zapros.Response]:
