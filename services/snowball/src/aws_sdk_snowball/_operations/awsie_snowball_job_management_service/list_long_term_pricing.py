"""Generated from Smithy shape ``com.amazonaws.snowball#ListLongTermPricing``."""
...
def handle_response(
    ...
    out: aws_sdk_snowball.types.list_long_term_pricing_result.ListLongTermPricingResult = aws_sdk_snowball.types.list_long_term_pricing_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.list_long_term_pricing_request.ListLongTermPricingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSIESnowballJobManagementService.ListLongTermPricing"
    import aws_sdk_snowball.types.list_long_term_pricing_request

    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.list_long_term_pricing_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_long_term_pricing(
