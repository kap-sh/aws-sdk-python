...
def handle_response(
    ...
    out: aws_sdk_snowball.types.cancel_cluster_result.CancelClusterResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_snowball.types.cancel_cluster_request.CancelClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_snowball.types.cancel_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def cancel_cluster(
    ...
    aws_sdk_snowball.types.cancel_cluster_result.CancelClusterResult, zapros.Response
]:
