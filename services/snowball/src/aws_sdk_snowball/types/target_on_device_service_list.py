...
if TYPE_CHECKING:
    import aws_sdk_snowball.types.target_on_device_service

TargetOnDeviceServiceList: TypeAlias = list[
    "aws_sdk_snowball.types.target_on_device_service.TargetOnDeviceService"
]
...
def serialize_aws_json_1_1(value: TargetOnDeviceServiceList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_snowball.types.target_on_device_service.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> TargetOnDeviceServiceList:
    ...
    for item in data:
        out.append(
            aws_sdk_snowball.types.target_on_device_service.deserialize_aws_json_1_1(
                item
            )
        )
    return out
