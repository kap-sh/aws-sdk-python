...
if TYPE_CHECKING:
    import aws_sdk_snowball.types.event_trigger_definition

EventTriggerDefinitionList: TypeAlias = list[
    "aws_sdk_snowball.types.event_trigger_definition.EventTriggerDefinition"
]
...
def serialize_aws_json_1_1(value: EventTriggerDefinitionList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_snowball.types.event_trigger_definition.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> EventTriggerDefinitionList:
    ...
    for item in data:
        out.append(
            aws_sdk_snowball.types.event_trigger_definition.deserialize_aws_json_1_1(
                item
            )
        )
    return out
