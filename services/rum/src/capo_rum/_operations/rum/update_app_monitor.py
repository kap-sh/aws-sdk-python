"""Generated from Smithy shape ``com.amazonaws.rum#UpdateAppMonitor``."""
...
def handle_response(
    ...
    out: capo_rum.types.update_app_monitor_response.UpdateAppMonitorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rum.types.update_app_monitor_request.serialize_json(input_)
    ).encode()
...
def update_app_monitor(
    ...
    capo_rum.types.update_app_monitor_response.UpdateAppMonitorResponse, zapros.Response
]:
...
async def async_update_app_monitor(
