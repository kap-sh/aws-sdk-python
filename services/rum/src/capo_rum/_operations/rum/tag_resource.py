"""Generated from Smithy shape ``com.amazonaws.rum#TagResource``."""
...
def handle_response(
    ...
    out: capo_rum.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rum.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: capo_rum.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_rum.types.tag_resource_response.TagResourceResponse, zapros.Response]:
