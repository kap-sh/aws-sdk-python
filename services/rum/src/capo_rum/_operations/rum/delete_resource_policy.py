"""Generated from Smithy shape ``com.amazonaws.rum#DeleteResourcePolicy``."""
...
import capo_rum.errors.invalid_policy_revision_id_exception
import capo_rum.errors.policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPolicyRevisionIdException":
            raise capo_rum.errors.invalid_policy_revision_id_exception.InvalidPolicyRevisionIdException.from_json(
                data
            )
        case "PolicyNotFoundException":
            raise capo_rum.errors.policy_not_found_exception.PolicyNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_rum.types.delete_resource_policy_response.DeleteResourcePolicyResponse = (
        capo_rum.types.delete_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/appmonitor/{Name}/policy"
    url = url.replace("{Name}", quote(str(input_["name"]), safe=""))
    params: dict[str, str] = {}
    if "policy_revision_id" in input_:
        params["policyRevisionId"] = str(input_["policy_revision_id"])
