"""Generated from Smithy shape ``com.amazonaws.rum#PutRumMetricsDestination``."""
...
def handle_response(
    ...
    out: capo_rum.types.put_rum_metrics_destination_response.PutRumMetricsDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rum.types.put_rum_metrics_destination_request.serialize_json(input_)
    ).encode()
...
async def async_put_rum_metrics_destination(
