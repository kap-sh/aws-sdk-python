...
def handle_response(
    ...
    out: capo_rum.types.delete_app_monitor_response.DeleteAppMonitorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_app_monitor(
    ...
    capo_rum.types.delete_app_monitor_response.DeleteAppMonitorResponse, zapros.Response
]:
