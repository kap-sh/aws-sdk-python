"""Generated from Smithy shape ``com.amazonaws.rum#UpdateRumMetricDefinition``."""
...
def handle_response(
    ...
    out: capo_rum.types.update_rum_metric_definition_response.UpdateRumMetricDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rum.types.update_rum_metric_definition_request.serialize_json(input_)
    ).encode()
...
async def async_update_rum_metric_definition(
