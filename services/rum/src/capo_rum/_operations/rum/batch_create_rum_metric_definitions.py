"""Generated from Smithy shape ``com.amazonaws.rum#BatchCreateRumMetricDefinitions``."""
...
import capo_rum.errors.service_quota_exceeded_exception
import capo_rum.errors.throttling_exception
import capo_rum.errors.validation_exception
import capo_rum.types.batch_create_rum_metric_definitions_errors
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_rum.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_rum.types.batch_create_rum_metric_definitions_response.BatchCreateRumMetricDefinitionsResponse = capo_rum.types.batch_create_rum_metric_definitions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rum.types.batch_create_rum_metric_definitions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_create_rum_metric_definitions(
