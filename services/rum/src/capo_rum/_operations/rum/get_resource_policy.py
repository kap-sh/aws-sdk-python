"""Generated from Smithy shape ``com.amazonaws.rum#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_rum.types.get_resource_policy_response.GetResourcePolicyResponse = (
        capo_rum.types.get_resource_policy_response.deserialize_json(
