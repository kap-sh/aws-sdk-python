"""Generated from Smithy shape ``com.amazonaws.rum#ListRumMetricsDestinations``."""
...
def handle_response(
    ...
    out: capo_rum.types.list_rum_metrics_destinations_response.ListRumMetricsDestinationsResponse = capo_rum.types.list_rum_metrics_destinations_response.deserialize_json(
...
async def async_list_rum_metrics_destinations(
