...
def build_request(
    ...
    input_: aws_sdk_rum.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rum.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_rum.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
