...
def handle_response(
    ...
    out: aws_sdk_rum.types.batch_create_rum_metric_definitions_response.BatchCreateRumMetricDefinitionsResponse = aws_sdk_rum.types.batch_create_rum_metric_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rum.types.batch_create_rum_metric_definitions_request.BatchCreateRumMetricDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
