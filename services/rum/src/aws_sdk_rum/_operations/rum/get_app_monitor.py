...
def handle_response(
    ...
    out: aws_sdk_rum.types.get_app_monitor_response.GetAppMonitorResponse = (
        aws_sdk_rum.types.get_app_monitor_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rum.types.get_app_monitor_request.GetAppMonitorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_app_monitor(
    ...
    aws_sdk_rum.types.get_app_monitor_response.GetAppMonitorResponse, zapros.Response
]:
...
async def async_get_app_monitor(
