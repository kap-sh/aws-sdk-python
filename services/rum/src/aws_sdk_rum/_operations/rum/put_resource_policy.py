...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPolicyRevisionIdException":
            ...
            raise aws_sdk_rum.errors.invalid_policy_revision_id_exception.InvalidPolicyRevisionIdException.from_json(
                data
            )
        case "MalformedPolicyDocumentException":
            import aws_sdk_rum.errors.malformed_policy_document_exception

            raise aws_sdk_rum.errors.malformed_policy_document_exception.MalformedPolicyDocumentException.from_json(
                data
            )
        case "PolicySizeLimitExceededException":
            import aws_sdk_rum.errors.policy_size_limit_exceeded_exception

            raise aws_sdk_rum.errors.policy_size_limit_exceeded_exception.PolicySizeLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_rum.types.put_resource_policy_response.PutResourcePolicyResponse = (
        aws_sdk_rum.types.put_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rum.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rum.types.put_resource_policy_request.serialize_json(input_)
    ).encode()
