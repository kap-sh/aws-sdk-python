...
def build_request(
    ...
    input_: aws_sdk_rum.types.put_rum_events_request.PutRumEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rum.types.put_rum_events_request.serialize_json(input_)
    ).encode()
...
def put_rum_events(
    ...
    aws_sdk_rum.types.put_rum_events_response.PutRumEventsResponse, zapros.Response
]:
