...
def handle_response(
    ...
    out: aws_sdk_rum.types.get_app_monitor_data_response.GetAppMonitorDataResponse = (
        aws_sdk_rum.types.get_app_monitor_data_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rum.types.get_app_monitor_data_request.GetAppMonitorDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rum.types.get_app_monitor_data_request.serialize_json(input_)
    ).encode()
