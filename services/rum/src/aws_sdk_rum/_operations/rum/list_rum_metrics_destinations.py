...
def handle_response(
    ...
    out: aws_sdk_rum.types.list_rum_metrics_destinations_response.ListRumMetricsDestinationsResponse = aws_sdk_rum.types.list_rum_metrics_destinations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rum.types.list_rum_metrics_destinations_request.ListRumMetricsDestinationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
