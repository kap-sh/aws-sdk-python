...
def handle_response(
    ...
    out: aws_sdk_rum.types.list_app_monitors_response.ListAppMonitorsResponse = (
        aws_sdk_rum.types.list_app_monitors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rum.types.list_app_monitors_request.ListAppMonitorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
