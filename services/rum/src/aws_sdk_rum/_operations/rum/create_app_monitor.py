...
def build_request(
    ...
    input_: aws_sdk_rum.types.create_app_monitor_request.CreateAppMonitorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rum.types.create_app_monitor_request.serialize_json(input_)
    ).encode()
...
async def async_create_app_monitor(
