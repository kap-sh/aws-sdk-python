...
def handle_response(
    ...
    out: aws_sdk_rum.types.batch_get_rum_metric_definitions_response.BatchGetRumMetricDefinitionsResponse = aws_sdk_rum.types.batch_get_rum_metric_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rum.types.batch_get_rum_metric_definitions_request.BatchGetRumMetricDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_batch_get_rum_metric_definitions(
