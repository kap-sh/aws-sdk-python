...
def build_request(
    ...
    input: aws_sdk_rum.types.put_rum_metrics_destination_request.PutRumMetricsDestinationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rum.types.put_rum_metrics_destination_request.serialize_json(input)
    ).encode()
