...
def build_request(
    ...
    input_: aws_sdk_rum.types.put_rum_metrics_destination_request.PutRumMetricsDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rum.types.put_rum_metrics_destination_request.serialize_json(input_)
    ).encode()
