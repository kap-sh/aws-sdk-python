...
def handle_response(
    ...
    out: aws_sdk_rum.types.batch_delete_rum_metric_definitions_response.BatchDeleteRumMetricDefinitionsResponse = aws_sdk_rum.types.batch_delete_rum_metric_definitions_response.deserialize_json(
