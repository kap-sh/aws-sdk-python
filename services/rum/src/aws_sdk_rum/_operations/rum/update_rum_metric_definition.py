...
def build_request(
    ...
    input: aws_sdk_rum.types.update_rum_metric_definition_request.UpdateRumMetricDefinitionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rum.types.update_rum_metric_definition_request.serialize_json(input)
    ).encode()
