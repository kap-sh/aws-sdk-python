...
def build_request(
    ...
    input_: aws_sdk_rum.types.update_rum_metric_definition_request.UpdateRumMetricDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rum.types.update_rum_metric_definition_request.serialize_json(input_)
    ).encode()
