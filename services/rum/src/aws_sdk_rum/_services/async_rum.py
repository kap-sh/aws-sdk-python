...
from aws_sdk_rum._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_rum._async import anysleep
import time
...
class AsyncRUMClientConfig(TypedDict, total=False):
...
class AsyncRUMClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_dual_stack: bool | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncRUMClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_dual_stack": use_dual_stack, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncRUMClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncRUMClientConfig = config_overrides or {}
    ...
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_rum.types.arn.Arn", *, config_overrides: Optional[AsyncRUMClientConfig] = None) -> "aws_sdk_rum.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_rum.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> AsyncOperationResponse["aws_sdk_rum.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_rum._operations.rum.list_tags_for_resource
            output, http_response = await aws_sdk_rum._operations.rum.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
    ...
    async def put_rum_events(self, id: "aws_sdk_rum.types.app_monitor_id.AppMonitorId", batch_id: str, app_monitor_details: "aws_sdk_rum.types.app_monitor_details.AppMonitorDetails", user_details: "aws_sdk_rum.types.user_details.UserDetails", rum_events: "aws_sdk_rum.types.rum_event_list.RumEventList", *, config_overrides: Optional[AsyncRUMClientConfig] = None, alias: Optional["aws_sdk_rum.types.alias.Alias"] = None) -> "aws_sdk_rum.types.put_rum_events_response.PutRumEventsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_rum.types.put_rum_events_request.PutRumEventsRequest]') -> AsyncOperationResponse["aws_sdk_rum.types.put_rum_events_response.PutRumEventsResponse"]:
            import aws_sdk_rum._operations.rum.put_rum_events
            output, http_response = await aws_sdk_rum._operations.rum.put_rum_events.async_put_rum_events(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def tag_resource(self, resource_arn: "aws_sdk_rum.types.arn.Arn", tags: "aws_sdk_rum.types.tag_map.TagMap", *, config_overrides: Optional[AsyncRUMClientConfig] = None) -> "aws_sdk_rum.types.tag_resource_response.TagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_rum.types.tag_resource_request.TagResourceRequest]') -> AsyncOperationResponse["aws_sdk_rum.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_rum._operations.rum.tag_resource
            output, http_response = await aws_sdk_rum._operations.rum.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_rum.types.arn.Arn", tag_keys: "aws_sdk_rum.types.tag_key_list.TagKeyList", *, config_overrides: Optional[AsyncRUMClientConfig] = None) -> "aws_sdk_rum.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_rum.types.untag_resource_request.UntagResourceRequest]') -> AsyncOperationResponse["aws_sdk_rum.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_rum._operations.rum.untag_resource
            output, http_response = await aws_sdk_rum._operations.rum.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
