...
from aws_sdk_rum._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
...
from aws_sdk_rum._services._aws_config import aaws_config
...
class AsyncRUMClientConfig(TypedDict, total=False, closed=True):
...
class AsyncRUMClient:
    ...
    def __init__(
        ...
        self._config = AsyncRUMClientConfig(
            {
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        "aws_sdk_rum.types.list_tags_for_resource_response.ListTagsForResourceResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_rum.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_rum.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_rum._operations.rum.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def put_rum_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_rum.types.put_rum_events_request.PutRumEventsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_rum.types.put_rum_events_response.PutRumEventsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_rum._operations.rum.put_rum_events.async_put_rum_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_rum.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_rum.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_rum._operations.rum.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        self,
        resource_arn: "aws_sdk_rum.types.arn.Arn",
        tag_keys: "aws_sdk_rum.types.tag_key_list.TagKeyList",
        *,
        config_overrides: Optional[AsyncRUMClientConfig] = None,
    ) -> "aws_sdk_rum.types.untag_resource_response.UntagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_rum.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_rum.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_rum._operations.rum.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
