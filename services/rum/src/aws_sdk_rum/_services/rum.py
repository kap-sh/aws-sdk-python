...
from aws_sdk_rum._services._aws_config import aws_config
...
class RUMClient:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_rum.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_rum.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_rum._operations.rum.list_tags_for_resource.list_tags_for_resource(
    ...
    def put_rum_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_rum.types.put_rum_events_request.PutRumEventsRequest]",
        ) -> OperationResponse[
            "aws_sdk_rum.types.put_rum_events_response.PutRumEventsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_rum._operations.rum.put_rum_events.put_rum_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_rum.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_rum.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_rum._operations.rum.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_rum.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_rum.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_rum._operations.rum.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
