...
class ListRumMetricsDestinationsResponse(TypedDict, closed=True):
    destinations: NotRequired[
        "aws_sdk_rum.types.metric_destination_summary_list.MetricDestinationSummaryList"
    ]
...
def serialize_json(value: ListRumMetricsDestinationsResponse) -> dict:
    ...
    if "destinations" in value:
        ...
        out["Destinations"] = (
            aws_sdk_rum.types.metric_destination_summary_list.serialize_json(
                value["destinations"]
            )
        )
...
def deserialize_json(data: dict) -> ListRumMetricsDestinationsResponse:
    ...
    if "Destinations" in data:
        ...
        out["destinations"] = (
            aws_sdk_rum.types.metric_destination_summary_list.deserialize_json(
                data["Destinations"]
            )
        )
