...
class DeobfuscationConfiguration(TypedDict):
    java_script_source_maps: NotRequired["aws_sdk_rum.types.java_script_source_maps.JavaScriptSourceMaps"]
...
def serialize_json(value: DeobfuscationConfiguration) -> dict:
    ...
    if "java_script_source_maps" in value:
        import aws_sdk_rum.types.java_script_source_maps
        out["JavaScriptSourceMaps"] = aws_sdk_rum.types.java_script_source_maps.serialize_json(value["java_script_source_maps"])
    return out
...
def deserialize_json(data: dict) -> DeobfuscationConfiguration:
    ...
    if "JavaScriptSourceMaps" in data:
        import aws_sdk_rum.types.java_script_source_maps
        out["java_script_source_maps"] = aws_sdk_rum.types.java_script_source_maps.deserialize_json(data["JavaScriptSourceMaps"])
    return out