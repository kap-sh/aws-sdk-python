...
class GetRecommendationsRequest(TypedDict):
    ...
    context: NotRequired["aws_sdk_personalize_runtime.types.context.Context"]
    ...
    recommender_arn: NotRequired["aws_sdk_personalize_runtime.types.arn.Arn"]
...
def serialize_json(value: GetRecommendationsRequest) -> dict:
    ...
    if "context" in value:
        ...
        out["context"] = aws_sdk_personalize_runtime.types.context.serialize_json(
            value["context"]
        )
    ...
    if "promotions" in value:
        ...
        out["promotions"] = (
            aws_sdk_personalize_runtime.types.promotion_list.serialize_json(
                value["promotions"]
            )
        )
    if "metadata_columns" in value:
        ...
        out["metadataColumns"] = (
            aws_sdk_personalize_runtime.types.metadata_columns.serialize_json(
...
def deserialize_json(data: dict) -> GetRecommendationsRequest:
    ...
    if "context" in data:
        ...
        out["context"] = aws_sdk_personalize_runtime.types.context.deserialize_json(
            data["context"]
        )
    ...
    if "promotions" in data:
        ...
        out["promotions"] = (
            aws_sdk_personalize_runtime.types.promotion_list.deserialize_json(
                data["promotions"]
            )
        )
    if "metadataColumns" in data:
        ...
        out["metadata_columns"] = (
            aws_sdk_personalize_runtime.types.metadata_columns.deserialize_json(
