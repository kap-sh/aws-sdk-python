...
class PersonalizeRuntimeError(Exception):
    """Base class for all PersonalizeRuntime service errors."""


class ServiceError(PersonalizeRuntimeError):
...
class SerializationError(PersonalizeRuntimeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PersonalizeRuntimeError):
...
class WaiterFailedError(PersonalizeRuntimeError):
...
class WaiterTimeoutError(PersonalizeRuntimeError):
