...
from aws_sdk_personalize_runtime._services._aws_config import aaws_config
...
class AsyncPersonalizeRuntimeClient:
    ...
    async def get_action_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_personalize_runtime.types.get_action_recommendations_request.GetActionRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_personalize_runtime.types.get_action_recommendations_response.GetActionRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_personalize_runtime._operations.amazon_personalize_runtime.get_action_recommendations.async_get_action_recommendations(
    ...
    async def get_personalized_ranking(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_personalize_runtime.types.get_personalized_ranking_request.GetPersonalizedRankingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_personalize_runtime.types.get_personalized_ranking_response.GetPersonalizedRankingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_personalize_runtime._operations.amazon_personalize_runtime.get_personalized_ranking.async_get_personalized_ranking(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_personalize_runtime.types.get_recommendations_request.GetRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_personalize_runtime.types.get_recommendations_response.GetRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_personalize_runtime._operations.amazon_personalize_runtime.get_recommendations.async_get_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
