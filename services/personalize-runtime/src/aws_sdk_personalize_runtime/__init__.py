...
from ._services.async_personalize_runtime import (
    AsyncPersonalizeRuntimeClient as AsyncPersonalizeRuntimeClient,
)
from ._services.personalize_runtime import (
    PersonalizeRuntimeClient as PersonalizeRuntimeClient,
)
