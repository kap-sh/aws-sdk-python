...
```
pip install aws-sdk-personalize-runtime
```

## Usage

```python
from aws_sdk_personalize_runtime import AsyncPersonalizeRuntimeClient
...
```python
from aws_sdk_personalize_runtime import AsyncPersonalizeRuntimeClient
from aws_sdk_personalize_runtime.error import InvalidInputException
