"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ResourceStateUpdateIncludeResources``."""
...
class ResourceStateUpdateIncludeResources(TypedDict):
    ...
    containers: "aws_sdk_imagebuilder.types.boolean.Boolean"
    """<p>Specifies whether the lifecycle action should apply to distributed containers.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: ResourceStateUpdateIncludeResources) -> dict:
    out: dict = {}
