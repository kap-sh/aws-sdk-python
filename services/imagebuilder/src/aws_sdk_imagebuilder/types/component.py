...
if TYPE_CHECKING:
    ...
    import aws_sdk_imagebuilder.types.component_data
    import aws_sdk_imagebuilder.types.component_parameter_detail_list
...
class Component(TypedDict, closed=True):
    ...
    parameters: NotRequired[
        "aws_sdk_imagebuilder.types.component_parameter_detail_list.ComponentParameterDetailList"
    ]
    ...
    data: NotRequired["aws_sdk_imagebuilder.types.component_data.ComponentData"]
...
def serialize_json(value: Component) -> dict:
    ...
    if "parameters" in value:
        ...
        out["parameters"] = (
            aws_sdk_imagebuilder.types.component_parameter_detail_list.serialize_json(
                value["parameters"]
            )
        )
    if "owner" in value:
...
def deserialize_json(data: dict) -> Component:
    ...
    if "parameters" in data:
        ...
        out["parameters"] = (
            aws_sdk_imagebuilder.types.component_parameter_detail_list.deserialize_json(
                data["parameters"]
            )
        )
    if "owner" in data:
