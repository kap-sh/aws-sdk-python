...
if TYPE_CHECKING:
    import aws_sdk_imagebuilder.types.ebs_instance_block_device_specification
    import aws_sdk_imagebuilder.types.empty_string
...
class InstanceBlockDeviceMapping(TypedDict):
    ...
    ebs: NotRequired[
        "aws_sdk_imagebuilder.types.ebs_instance_block_device_specification.EbsInstanceBlockDeviceSpecification"
    ]
    ...
    no_device: NotRequired["aws_sdk_imagebuilder.types.empty_string.EmptyString"]
...
def serialize_json(value: InstanceBlockDeviceMapping) -> dict:
    ...
    if "ebs" in value:
        ...
        out["ebs"] = (
            aws_sdk_imagebuilder.types.ebs_instance_block_device_specification.serialize_json(
                value["ebs"]
            )
        )
...
def deserialize_json(data: dict) -> InstanceBlockDeviceMapping:
    ...
    if "ebs" in data:
        ...
        out["ebs"] = (
            aws_sdk_imagebuilder.types.ebs_instance_block_device_specification.deserialize_json(
                data["ebs"]
            )
        )
