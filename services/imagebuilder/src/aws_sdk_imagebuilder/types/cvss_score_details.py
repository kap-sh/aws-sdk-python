...
class CvssScoreDetails(TypedDict):
    ...
    adjustments: NotRequired[
        "aws_sdk_imagebuilder.types.cvss_score_adjustment_list.CvssScoreAdjustmentList"
    ]
...
def serialize_json(value: CvssScoreDetails) -> dict:
    ...
    if "adjustments" in value:
        ...
        out["adjustments"] = (
            aws_sdk_imagebuilder.types.cvss_score_adjustment_list.serialize_json(
                value["adjustments"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> CvssScoreDetails:
    ...
    if "adjustments" in data:
        ...
        out["adjustments"] = (
            aws_sdk_imagebuilder.types.cvss_score_adjustment_list.deserialize_json(
                data["adjustments"]
            )
        )
    return out
