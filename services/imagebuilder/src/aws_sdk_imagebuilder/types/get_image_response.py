...
class GetImageResponse(TypedDict, closed=True):
    ...
    image: NotRequired["aws_sdk_imagebuilder.types.image.Image"]
...
def serialize_json(value: GetImageResponse) -> dict:
    ...
    if "image" in value:
        ...
        out["image"] = aws_sdk_imagebuilder.types.image.serialize_json(value["image"])
...
def deserialize_json(data: dict) -> GetImageResponse:
    ...
    if "image" in data:
        ...
        out["image"] = aws_sdk_imagebuilder.types.image.deserialize_json(data["image"])
