...
if TYPE_CHECKING:
    ...
    import aws_sdk_imagebuilder.types.filter_values


class Filter(TypedDict, closed=True):
    name: NotRequired["aws_sdk_imagebuilder.types.filter_name.FilterName"]
    """<p>The name of the filter. Filter names are case-sensitive.</p>"""
    values: NotRequired["aws_sdk_imagebuilder.types.filter_values.FilterValues"]
...
def serialize_json(value: Filter) -> dict:
    ...
    if "values" in value:
        ...
        out["values"] = aws_sdk_imagebuilder.types.filter_values.serialize_json(
            value["values"]
        )
    return out
...
def deserialize_json(data: dict) -> Filter:
    ...
    if "values" in data:
        ...
        out["values"] = aws_sdk_imagebuilder.types.filter_values.deserialize_json(
            data["values"]
        )
    return out
