...
if TYPE_CHECKING:
    import aws_sdk_imagebuilder.types.ecr_configuration
...
class ImageScanningConfiguration(TypedDict):
    ...
    ecr_configuration: NotRequired[
        "aws_sdk_imagebuilder.types.ecr_configuration.EcrConfiguration"
    ]
...
def serialize_json(value: ImageScanningConfiguration) -> dict:
    ...
    if "ecr_configuration" in value:
        ...
        out["ecrConfiguration"] = (
            aws_sdk_imagebuilder.types.ecr_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ImageScanningConfiguration:
    ...
    if "ecrConfiguration" in data:
        ...
        out["ecr_configuration"] = (
            aws_sdk_imagebuilder.types.ecr_configuration.deserialize_json(
