...
if TYPE_CHECKING:
    ...
    import aws_sdk_imagebuilder.types.consecutive_failures
...
class ImagePipeline(TypedDict):
    ...
    image_recipe_arn: NotRequired["aws_sdk_imagebuilder.types.arn.Arn"]
    """<p>The Amazon Resource Name (ARN) of the image recipe associated with this image pipeline.</p>"""
    container_recipe_arn: NotRequired["aws_sdk_imagebuilder.types.arn.Arn"]
    """<p>The Amazon Resource Name (ARN) of the container recipe that is used for this pipeline.</p>"""
    infrastructure_configuration_arn: NotRequired["aws_sdk_imagebuilder.types.arn.Arn"]
    """<p>The Amazon Resource Name (ARN) of the infrastructure configuration associated with this image pipeline.</p>"""
    distribution_configuration_arn: NotRequired["aws_sdk_imagebuilder.types.arn.Arn"]
    ...
    date_last_run: NotRequired["aws_sdk_imagebuilder.types.date_time.DateTime"]
    """<p>This is no longer supported, and does not return a value.</p>"""
    last_run_status: NotRequired["aws_sdk_imagebuilder.types.image_status.ImageStatus"]
    ...
    date_next_run: NotRequired["aws_sdk_imagebuilder.types.date_time.DateTime"]
    ...
    consecutive_failures: NotRequired[
        "aws_sdk_imagebuilder.types.consecutive_failures.ConsecutiveFailures"
    ]
...
def serialize_json(value: ImagePipeline) -> dict:
    ...
    if "last_run_status" in value:
        ...
        out["lastRunStatus"] = aws_sdk_imagebuilder.types.image_status.serialize_json(
...
def deserialize_json(data: dict) -> ImagePipeline:
    ...
    if "lastRunStatus" in data:
        ...
        out["last_run_status"] = (
            aws_sdk_imagebuilder.types.image_status.deserialize_json(
                data["lastRunStatus"]
            )
        )
