...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_workflow_execution_response.GetWorkflowExecutionResponse = aws_sdk_imagebuilder.types.get_workflow_execution_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.get_workflow_execution_request.GetWorkflowExecutionRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "workflow_execution_id" in input:
        params["workflowExecutionId"] = str(input["workflow_execution_id"])
