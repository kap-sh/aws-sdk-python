...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.cancel_image_creation_request.CancelImageCreationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.cancel_image_creation_request.serialize_json(input)
    ).encode()
