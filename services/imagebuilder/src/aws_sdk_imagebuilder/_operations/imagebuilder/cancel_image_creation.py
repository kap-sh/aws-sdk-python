...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.cancel_image_creation_response.CancelImageCreationResponse = aws_sdk_imagebuilder.types.cancel_image_creation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.cancel_image_creation_request.CancelImageCreationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.cancel_image_creation_request.serialize_json(input_)
    ).encode()
