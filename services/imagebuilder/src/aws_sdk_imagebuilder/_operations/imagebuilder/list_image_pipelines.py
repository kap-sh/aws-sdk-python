...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.list_image_pipelines_request.ListImagePipelinesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_image_pipelines_request.serialize_json(input)
    ).encode()
