...
import aws_sdk_imagebuilder.types.image_pipeline_list
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_image_pipelines_response.ListImagePipelinesResponse = aws_sdk_imagebuilder.types.list_image_pipelines_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_image_pipelines_request.ListImagePipelinesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_image_pipelines_request.serialize_json(input_)
    ).encode()
