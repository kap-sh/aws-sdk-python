"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetImageRecipePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_image_recipe_policy_response.GetImageRecipePolicyResponse = aws_sdk_imagebuilder.types.get_image_recipe_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.get_image_recipe_policy_request.GetImageRecipePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetImageRecipePolicy"
    params: dict[str, str] = {}
    if "image_recipe_arn" in input_:
        params["imageRecipeArn"] = str(input_["image_recipe_arn"])
...
async def async_get_image_recipe_policy(
