...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.get_image_recipe_policy_request.GetImageRecipePolicyRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "image_recipe_arn" in input:
        params["imageRecipeArn"] = str(input["image_recipe_arn"])
