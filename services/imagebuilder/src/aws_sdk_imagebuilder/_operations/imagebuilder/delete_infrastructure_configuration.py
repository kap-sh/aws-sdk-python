"""Generated from Smithy shape ``com.amazonaws.imagebuilder#DeleteInfrastructureConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.delete_infrastructure_configuration_response.DeleteInfrastructureConfigurationResponse = aws_sdk_imagebuilder.types.delete_infrastructure_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.delete_infrastructure_configuration_request.DeleteInfrastructureConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteInfrastructureConfiguration"
    params: dict[str, str] = {}
    if "infrastructure_configuration_arn" in input_:
        params["infrastructureConfigurationArn"] = str(
            input_["infrastructure_configuration_arn"]
        )
...
async def async_delete_infrastructure_configuration(
