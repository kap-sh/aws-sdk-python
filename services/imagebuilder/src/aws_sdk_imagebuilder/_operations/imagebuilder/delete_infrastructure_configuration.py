...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.delete_infrastructure_configuration_request.DeleteInfrastructureConfigurationRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "infrastructure_configuration_arn" in input:
