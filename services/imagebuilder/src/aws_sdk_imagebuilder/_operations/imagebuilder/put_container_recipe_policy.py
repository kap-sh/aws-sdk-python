...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.put_container_recipe_policy_response.PutContainerRecipePolicyResponse = aws_sdk_imagebuilder.types.put_container_recipe_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.put_container_recipe_policy_request.PutContainerRecipePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.put_container_recipe_policy_request.serialize_json(
            input_
        )
    ).encode()
