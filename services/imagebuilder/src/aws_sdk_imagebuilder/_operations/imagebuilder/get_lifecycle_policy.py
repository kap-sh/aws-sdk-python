...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_lifecycle_policy_response.GetLifecyclePolicyResponse = aws_sdk_imagebuilder.types.get_lifecycle_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.get_lifecycle_policy_request.GetLifecyclePolicyRequest,
) -> zapros.Request:
