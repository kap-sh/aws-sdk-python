...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_waiting_workflow_steps_response.ListWaitingWorkflowStepsResponse = aws_sdk_imagebuilder.types.list_waiting_workflow_steps_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_waiting_workflow_steps_request.ListWaitingWorkflowStepsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_waiting_workflow_steps_request.serialize_json(
            input_
        )
    ).encode()
