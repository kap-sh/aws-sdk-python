...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.create_container_recipe_response.CreateContainerRecipeResponse = aws_sdk_imagebuilder.types.create_container_recipe_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.create_container_recipe_request.CreateContainerRecipeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.create_container_recipe_request.serialize_json(input)
    ).encode()
