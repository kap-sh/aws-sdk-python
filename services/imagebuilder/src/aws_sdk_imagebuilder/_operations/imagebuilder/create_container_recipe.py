...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.create_container_recipe_request.CreateContainerRecipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.create_container_recipe_request.serialize_json(
            input_
        )
    ).encode()
