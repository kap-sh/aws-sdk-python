...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.get_lifecycle_execution_request.GetLifecycleExecutionRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "lifecycle_execution_id" in input:
        params["lifecycleExecutionId"] = str(input["lifecycle_execution_id"])
