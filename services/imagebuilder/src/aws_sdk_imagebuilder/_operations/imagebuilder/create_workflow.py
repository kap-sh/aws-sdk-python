...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.create_workflow_response.CreateWorkflowResponse = (
        aws_sdk_imagebuilder.types.create_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.create_workflow_request.CreateWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.create_workflow_request.serialize_json(input_)
    ).encode()
