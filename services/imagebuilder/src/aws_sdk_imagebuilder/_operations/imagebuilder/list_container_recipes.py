...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.list_container_recipes_request.ListContainerRecipesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_container_recipes_request.serialize_json(input)
    ).encode()
