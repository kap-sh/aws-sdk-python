...
import aws_sdk_imagebuilder.types.container_recipe_summary_list
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_container_recipes_response.ListContainerRecipesResponse = aws_sdk_imagebuilder.types.list_container_recipes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_container_recipes_request.ListContainerRecipesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_container_recipes_request.serialize_json(input_)
    ).encode()
