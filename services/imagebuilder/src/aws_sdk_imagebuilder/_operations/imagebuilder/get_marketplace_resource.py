"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetMarketplaceResource``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_marketplace_resource_response.GetMarketplaceResourceResponse = aws_sdk_imagebuilder.types.get_marketplace_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.get_marketplace_resource_request.GetMarketplaceResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetMarketplaceResource"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.get_marketplace_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.get_marketplace_resource_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_marketplace_resource(
