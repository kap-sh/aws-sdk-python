"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListImageScanFindings``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_image_scan_findings_response.ListImageScanFindingsResponse = aws_sdk_imagebuilder.types.list_image_scan_findings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_image_scan_findings_request.ListImageScanFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListImageScanFindings"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.list_image_scan_findings_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_image_scan_findings_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_image_scan_findings(
