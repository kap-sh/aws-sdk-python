"""Generated from Smithy shape ``com.amazonaws.imagebuilder#RetryImage``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.retry_image_response.RetryImageResponse = (
        aws_sdk_imagebuilder.types.retry_image_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.retry_image_request.RetryImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/RetryImage"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.retry_image_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.retry_image_request.serialize_json(input_)
    ).encode()
...
def retry_image(
    ...
    aws_sdk_imagebuilder.types.retry_image_response.RetryImageResponse, zapros.Response
]:
