"""Generated from Smithy shape ``com.amazonaws.imagebuilder#StartImagePipelineExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.start_image_pipeline_execution_response.StartImagePipelineExecutionResponse = aws_sdk_imagebuilder.types.start_image_pipeline_execution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.start_image_pipeline_execution_request.StartImagePipelineExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/StartImagePipelineExecution"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.start_image_pipeline_execution_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.start_image_pipeline_execution_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_image_pipeline_execution(
