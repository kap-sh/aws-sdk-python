"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetImage``."""
...
import aws_sdk_imagebuilder.types.image
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_image_response.GetImageResponse = (
        aws_sdk_imagebuilder.types.get_image_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.get_image_request.GetImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetImage"
    params: dict[str, str] = {}
...
def get_image(
    ...
    aws_sdk_imagebuilder.types.get_image_response.GetImageResponse, zapros.Response
]:
