...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.get_image_request.GetImageRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "image_build_version_arn" in input:
        params["imageBuildVersionArn"] = str(input["image_build_version_arn"])
