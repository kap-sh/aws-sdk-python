...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.import_vm_image_response.ImportVmImageResponse = (
        aws_sdk_imagebuilder.types.import_vm_image_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.import_vm_image_request.ImportVmImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.import_vm_image_request.serialize_json(input_)
    ).encode()
