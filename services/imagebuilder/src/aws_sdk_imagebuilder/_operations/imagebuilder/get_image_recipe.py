"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetImageRecipe``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_image_recipe_response.GetImageRecipeResponse = (
        aws_sdk_imagebuilder.types.get_image_recipe_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.get_image_recipe_request.GetImageRecipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetImageRecipe"
    params: dict[str, str] = {}
...
async def async_get_image_recipe(
