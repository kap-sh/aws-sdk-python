...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.put_image_policy_response.PutImagePolicyResponse = (
        aws_sdk_imagebuilder.types.put_image_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.put_image_policy_request.PutImagePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.put_image_policy_request.serialize_json(input)
    ).encode()
