...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.delete_workflow_request.DeleteWorkflowRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "workflow_build_version_arn" in input:
        params["workflowBuildVersionArn"] = str(input["workflow_build_version_arn"])
