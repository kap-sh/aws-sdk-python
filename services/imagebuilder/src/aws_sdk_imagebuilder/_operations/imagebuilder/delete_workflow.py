...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.delete_workflow_response.DeleteWorkflowResponse = (
        aws_sdk_imagebuilder.types.delete_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.delete_workflow_request.DeleteWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
