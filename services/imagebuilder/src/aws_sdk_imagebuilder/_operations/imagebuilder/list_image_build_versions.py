"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListImageBuildVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_image_build_versions_response.ListImageBuildVersionsResponse = aws_sdk_imagebuilder.types.list_image_build_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_image_build_versions_request.ListImageBuildVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListImageBuildVersions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.list_image_build_versions_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_image_build_versions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_image_build_versions(
