...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_image_pipeline_images_response.ListImagePipelineImagesResponse = aws_sdk_imagebuilder.types.list_image_pipeline_images_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_image_pipeline_images_request.ListImagePipelineImagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
