...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.distribute_image_request.DistributeImageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.distribute_image_request.serialize_json(input)
    ).encode()
