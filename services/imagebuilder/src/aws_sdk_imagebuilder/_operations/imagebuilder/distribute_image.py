...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.distribute_image_response.DistributeImageResponse = aws_sdk_imagebuilder.types.distribute_image_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.distribute_image_request.DistributeImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.distribute_image_request.serialize_json(input_)
    ).encode()
