...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_image_pipeline_response.GetImagePipelineResponse = aws_sdk_imagebuilder.types.get_image_pipeline_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.get_image_pipeline_request.GetImagePipelineRequest,
) -> zapros.Request:
