...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.put_component_policy_request.PutComponentPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.put_component_policy_request.serialize_json(input)
    ).encode()
