"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetContainerRecipe``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_container_recipe_response.GetContainerRecipeResponse = aws_sdk_imagebuilder.types.get_container_recipe_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.get_container_recipe_request.GetContainerRecipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetContainerRecipe"
    params: dict[str, str] = {}
...
async def async_get_container_recipe(
