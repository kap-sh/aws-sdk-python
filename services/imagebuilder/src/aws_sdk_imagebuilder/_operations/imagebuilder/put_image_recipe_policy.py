...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.put_image_recipe_policy_response.PutImageRecipePolicyResponse = aws_sdk_imagebuilder.types.put_image_recipe_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.put_image_recipe_policy_request.PutImageRecipePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.put_image_recipe_policy_request.serialize_json(input)
    ).encode()
