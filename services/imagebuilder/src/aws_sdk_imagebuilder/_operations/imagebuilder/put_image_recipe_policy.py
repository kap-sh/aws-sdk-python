...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.put_image_recipe_policy_request.PutImageRecipePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.put_image_recipe_policy_request.serialize_json(
            input_
        )
    ).encode()
