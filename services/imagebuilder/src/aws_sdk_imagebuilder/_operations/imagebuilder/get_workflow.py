...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_workflow_response.GetWorkflowResponse = (
        aws_sdk_imagebuilder.types.get_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.get_workflow_request.GetWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
