"""Generated from Smithy shape ``com.amazonaws.imagebuilder#DeleteImageRecipe``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.delete_image_recipe_response.DeleteImageRecipeResponse = aws_sdk_imagebuilder.types.delete_image_recipe_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.delete_image_recipe_request.DeleteImageRecipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteImageRecipe"
    params: dict[str, str] = {}
...
async def async_delete_image_recipe(
