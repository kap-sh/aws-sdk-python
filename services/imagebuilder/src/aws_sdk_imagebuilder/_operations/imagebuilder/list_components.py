...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_components_response.ListComponentsResponse = (
        aws_sdk_imagebuilder.types.list_components_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.list_components_request.ListComponentsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_components_request.serialize_json(input)
    ).encode()
