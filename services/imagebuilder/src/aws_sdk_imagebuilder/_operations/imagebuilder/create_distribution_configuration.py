...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.create_distribution_configuration_response.CreateDistributionConfigurationResponse = aws_sdk_imagebuilder.types.create_distribution_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.create_distribution_configuration_request.CreateDistributionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.create_distribution_configuration_request.serialize_json(
            input_
        )
    ).encode()
