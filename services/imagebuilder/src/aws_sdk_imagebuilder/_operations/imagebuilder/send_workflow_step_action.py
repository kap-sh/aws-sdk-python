...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.send_workflow_step_action_response.SendWorkflowStepActionResponse = aws_sdk_imagebuilder.types.send_workflow_step_action_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.send_workflow_step_action_request.SendWorkflowStepActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.send_workflow_step_action_request.serialize_json(
            input_
        )
    ).encode()
