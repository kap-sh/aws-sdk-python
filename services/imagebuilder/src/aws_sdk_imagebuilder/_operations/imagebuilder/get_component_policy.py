...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.get_component_policy_request.GetComponentPolicyRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "component_arn" in input:
        params["componentArn"] = str(input["component_arn"])
