...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_component_policy_response.GetComponentPolicyResponse = aws_sdk_imagebuilder.types.get_component_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.get_component_policy_request.GetComponentPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
