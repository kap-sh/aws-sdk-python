"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListLifecyclePolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_lifecycle_policies_response.ListLifecyclePoliciesResponse = aws_sdk_imagebuilder.types.list_lifecycle_policies_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.list_lifecycle_policies_request.ListLifecyclePoliciesRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/ListLifecyclePolicies"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.list_lifecycle_policies_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_lifecycle_policies_request.serialize_json(input)
    ).encode()
