...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_lifecycle_policies_request.ListLifecyclePoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_lifecycle_policies_request.serialize_json(
            input_
        )
    ).encode()
