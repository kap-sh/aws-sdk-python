...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.delete_image_pipeline_response.DeleteImagePipelineResponse = aws_sdk_imagebuilder.types.delete_image_pipeline_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.delete_image_pipeline_request.DeleteImagePipelineRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "image_pipeline_arn" in input:
        params["imagePipelineArn"] = str(input["image_pipeline_arn"])
