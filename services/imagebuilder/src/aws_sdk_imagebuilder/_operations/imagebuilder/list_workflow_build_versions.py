"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListWorkflowBuildVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_workflow_build_versions_response.ListWorkflowBuildVersionsResponse = aws_sdk_imagebuilder.types.list_workflow_build_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_workflow_build_versions_request.ListWorkflowBuildVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListWorkflowBuildVersions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_workflow_build_versions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_workflow_build_versions(
