...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.update_image_pipeline_request.UpdateImagePipelineRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.update_image_pipeline_request.serialize_json(input)
    ).encode()
