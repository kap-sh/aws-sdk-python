...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.update_image_pipeline_response.UpdateImagePipelineResponse = aws_sdk_imagebuilder.types.update_image_pipeline_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.update_image_pipeline_request.UpdateImagePipelineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.update_image_pipeline_request.serialize_json(input_)
    ).encode()
