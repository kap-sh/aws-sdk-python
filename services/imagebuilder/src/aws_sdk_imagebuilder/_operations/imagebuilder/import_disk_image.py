"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ImportDiskImage``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            import aws_sdk_imagebuilder.errors.access_denied_exception

            raise aws_sdk_imagebuilder.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
        ...
        case "TooManyRequestsException":
            import aws_sdk_imagebuilder.errors.too_many_requests_exception

            raise aws_sdk_imagebuilder.errors.too_many_requests_exception.TooManyRequestsException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.import_disk_image_response.ImportDiskImageResponse = aws_sdk_imagebuilder.types.import_disk_image_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.import_disk_image_request.ImportDiskImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ImportDiskImage"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.import_disk_image_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.import_disk_image_request.serialize_json(input_)
    ).encode()
...
async def async_import_disk_image(
