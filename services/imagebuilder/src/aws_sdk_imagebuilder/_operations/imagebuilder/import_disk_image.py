...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.import_disk_image_request.ImportDiskImageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.import_disk_image_request.serialize_json(input)
    ).encode()
