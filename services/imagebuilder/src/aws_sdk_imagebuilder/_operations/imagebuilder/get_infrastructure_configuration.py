...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_infrastructure_configuration_response.GetInfrastructureConfigurationResponse = aws_sdk_imagebuilder.types.get_infrastructure_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.get_infrastructure_configuration_request.GetInfrastructureConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
