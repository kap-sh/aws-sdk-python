...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.start_resource_state_update_request.StartResourceStateUpdateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.start_resource_state_update_request.serialize_json(
            input_
        )
    ).encode()
