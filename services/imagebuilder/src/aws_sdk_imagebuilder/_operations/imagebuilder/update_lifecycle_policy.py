...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.update_lifecycle_policy_request.UpdateLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.update_lifecycle_policy_request.serialize_json(
            input_
        )
    ).encode()
