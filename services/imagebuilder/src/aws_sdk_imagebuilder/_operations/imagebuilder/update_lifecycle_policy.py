"""Generated from Smithy shape ``com.amazonaws.imagebuilder#UpdateLifecyclePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.update_lifecycle_policy_response.UpdateLifecyclePolicyResponse = aws_sdk_imagebuilder.types.update_lifecycle_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.update_lifecycle_policy_request.UpdateLifecyclePolicyRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/UpdateLifecyclePolicy"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.update_lifecycle_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.update_lifecycle_policy_request.serialize_json(input)
    ).encode()
