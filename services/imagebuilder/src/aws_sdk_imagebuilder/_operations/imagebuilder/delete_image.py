...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.delete_image_response.DeleteImageResponse = (
        aws_sdk_imagebuilder.types.delete_image_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.delete_image_request.DeleteImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
