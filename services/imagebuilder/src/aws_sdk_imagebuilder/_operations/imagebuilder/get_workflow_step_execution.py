...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_workflow_step_execution_response.GetWorkflowStepExecutionResponse = aws_sdk_imagebuilder.types.get_workflow_step_execution_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.get_workflow_step_execution_request.GetWorkflowStepExecutionRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "step_execution_id" in input:
        params["stepExecutionId"] = str(input["step_execution_id"])
