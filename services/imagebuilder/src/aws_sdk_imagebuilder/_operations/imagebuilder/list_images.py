"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListImages``."""
...
import aws_sdk_imagebuilder.types.image_version_list
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_images_response.ListImagesResponse = (
        aws_sdk_imagebuilder.types.list_images_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_images_request.ListImagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListImages"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.list_images_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_images_request.serialize_json(input_)
    ).encode()
...
def list_images(
    ...
    aws_sdk_imagebuilder.types.list_images_response.ListImagesResponse, zapros.Response
]:
