"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetDistributionConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_distribution_configuration_response.GetDistributionConfigurationResponse = aws_sdk_imagebuilder.types.get_distribution_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.get_distribution_configuration_request.GetDistributionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetDistributionConfiguration"
    params: dict[str, str] = {}
...
async def async_get_distribution_configuration(
