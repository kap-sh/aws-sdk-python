...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.create_lifecycle_policy_request.CreateLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.create_lifecycle_policy_request.serialize_json(
            input_
        )
    ).encode()
