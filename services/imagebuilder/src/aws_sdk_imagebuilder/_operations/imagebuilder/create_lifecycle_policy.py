...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.create_lifecycle_policy_response.CreateLifecyclePolicyResponse = aws_sdk_imagebuilder.types.create_lifecycle_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.create_lifecycle_policy_request.CreateLifecyclePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.create_lifecycle_policy_request.serialize_json(input)
    ).encode()
