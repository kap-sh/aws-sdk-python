"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListWorkflows``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_workflows_response.ListWorkflowsResponse = (
        aws_sdk_imagebuilder.types.list_workflows_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_workflows_request.ListWorkflowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListWorkflows"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.list_workflows_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_workflows_request.serialize_json(input_)
    ).encode()
