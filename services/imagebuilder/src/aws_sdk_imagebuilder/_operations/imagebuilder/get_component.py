"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetComponent``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_component_response.GetComponentResponse = (
        aws_sdk_imagebuilder.types.get_component_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.get_component_request.GetComponentRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/GetComponent"
    params: dict[str, str] = {}
    if "component_build_version_arn" in input:
        params["componentBuildVersionArn"] = str(input["component_build_version_arn"])
