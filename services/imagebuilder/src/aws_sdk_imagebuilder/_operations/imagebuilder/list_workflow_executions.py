"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListWorkflowExecutions``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_workflow_executions_response.ListWorkflowExecutionsResponse = aws_sdk_imagebuilder.types.list_workflow_executions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_workflow_executions_request.ListWorkflowExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListWorkflowExecutions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.list_workflow_executions_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_workflow_executions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_workflow_executions(
