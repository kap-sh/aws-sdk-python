"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListInfrastructureConfigurations``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPaginationTokenException":
            import aws_sdk_imagebuilder.errors.invalid_pagination_token_exception

            raise aws_sdk_imagebuilder.errors.invalid_pagination_token_exception.InvalidPaginationTokenException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_infrastructure_configurations_response.ListInfrastructureConfigurationsResponse = aws_sdk_imagebuilder.types.list_infrastructure_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_infrastructure_configurations_request.ListInfrastructureConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListInfrastructureConfigurations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.list_infrastructure_configurations_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_infrastructure_configurations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_infrastructure_configurations(
