...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.list_image_packages_request.ListImagePackagesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_image_packages_request.serialize_json(input)
    ).encode()
