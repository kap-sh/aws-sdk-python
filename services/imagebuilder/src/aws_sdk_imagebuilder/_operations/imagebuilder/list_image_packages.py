...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_image_packages_response.ListImagePackagesResponse = aws_sdk_imagebuilder.types.list_image_packages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_image_packages_request.ListImagePackagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_image_packages_request.serialize_json(input_)
    ).encode()
