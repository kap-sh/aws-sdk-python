...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.create_image_pipeline_request.CreateImagePipelineRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.create_image_pipeline_request.serialize_json(input)
    ).encode()
