...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.create_image_pipeline_response.CreateImagePipelineResponse = aws_sdk_imagebuilder.types.create_image_pipeline_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.create_image_pipeline_request.CreateImagePipelineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.create_image_pipeline_request.serialize_json(input_)
    ).encode()
