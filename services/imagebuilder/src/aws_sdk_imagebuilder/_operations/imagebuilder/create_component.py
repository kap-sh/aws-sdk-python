...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.create_component_request.CreateComponentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.create_component_request.serialize_json(input)
    ).encode()
