...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse = aws_sdk_imagebuilder.types.delete_lifecycle_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.delete_lifecycle_policy_request.DeleteLifecyclePolicyRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "lifecycle_policy_arn" in input:
        params["lifecyclePolicyArn"] = str(input["lifecycle_policy_arn"])
