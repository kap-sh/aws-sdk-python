...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.delete_lifecycle_policy_request.DeleteLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "lifecycle_policy_arn" in input_:
        params["lifecyclePolicyArn"] = str(input_["lifecycle_policy_arn"])
