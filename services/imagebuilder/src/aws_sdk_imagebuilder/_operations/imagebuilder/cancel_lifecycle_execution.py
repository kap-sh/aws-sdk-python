...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.cancel_lifecycle_execution_response.CancelLifecycleExecutionResponse = aws_sdk_imagebuilder.types.cancel_lifecycle_execution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.cancel_lifecycle_execution_request.CancelLifecycleExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.cancel_lifecycle_execution_request.serialize_json(
            input_
        )
    ).encode()
