"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListImageRecipes``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_image_recipes_response.ListImageRecipesResponse = aws_sdk_imagebuilder.types.list_image_recipes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_image_recipes_request.ListImageRecipesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListImageRecipes"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.list_image_recipes_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_image_recipes_request.serialize_json(input_)
    ).encode()
...
async def async_list_image_recipes(
