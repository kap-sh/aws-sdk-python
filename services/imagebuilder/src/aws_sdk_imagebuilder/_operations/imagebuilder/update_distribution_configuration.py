"""Generated from Smithy shape ``com.amazonaws.imagebuilder#UpdateDistributionConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.update_distribution_configuration_response.UpdateDistributionConfigurationResponse = aws_sdk_imagebuilder.types.update_distribution_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.update_distribution_configuration_request.UpdateDistributionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/UpdateDistributionConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.update_distribution_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_distribution_configuration(
