...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.delete_distribution_configuration_request.DeleteDistributionConfigurationRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "distribution_configuration_arn" in input:
