...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.delete_distribution_configuration_response.DeleteDistributionConfigurationResponse = aws_sdk_imagebuilder.types.delete_distribution_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.delete_distribution_configuration_request.DeleteDistributionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
