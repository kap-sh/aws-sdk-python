...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.get_container_recipe_policy_response.GetContainerRecipePolicyResponse = aws_sdk_imagebuilder.types.get_container_recipe_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.get_container_recipe_policy_request.GetContainerRecipePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
