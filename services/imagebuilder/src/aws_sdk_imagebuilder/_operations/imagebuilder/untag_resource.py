"""Generated from Smithy shape ``com.amazonaws.imagebuilder#UntagResource``."""
...
import aws_sdk_imagebuilder.errors.invalid_parameter_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidParameterException":
            raise aws_sdk_imagebuilder.errors.invalid_parameter_exception.InvalidParameterException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
