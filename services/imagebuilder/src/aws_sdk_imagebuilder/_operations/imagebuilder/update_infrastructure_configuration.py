...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.update_infrastructure_configuration_response.UpdateInfrastructureConfigurationResponse = aws_sdk_imagebuilder.types.update_infrastructure_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.update_infrastructure_configuration_request.UpdateInfrastructureConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.update_infrastructure_configuration_request.serialize_json(
            input_
        )
    ).encode()
