...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_workflow_step_executions_response.ListWorkflowStepExecutionsResponse = aws_sdk_imagebuilder.types.list_workflow_step_executions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_workflow_step_executions_request.ListWorkflowStepExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_workflow_step_executions_request.serialize_json(
            input_
        )
    ).encode()
