...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.create_image_recipe_response.CreateImageRecipeResponse = aws_sdk_imagebuilder.types.create_image_recipe_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.create_image_recipe_request.CreateImageRecipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.create_image_recipe_request.serialize_json(input_)
    ).encode()
