"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListComponentBuildVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_component_build_versions_response.ListComponentBuildVersionsResponse = aws_sdk_imagebuilder.types.list_component_build_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_component_build_versions_request.ListComponentBuildVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListComponentBuildVersions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_component_build_versions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_component_build_versions(
