"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListLifecycleExecutionResources``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_lifecycle_execution_resources_response.ListLifecycleExecutionResourcesResponse = aws_sdk_imagebuilder.types.list_lifecycle_execution_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_lifecycle_execution_resources_request.ListLifecycleExecutionResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListLifecycleExecutionResources"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_imagebuilder.types.list_lifecycle_execution_resources_request

    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_lifecycle_execution_resources_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_lifecycle_execution_resources(
