...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.delete_container_recipe_request.DeleteContainerRecipeRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "container_recipe_arn" in input:
        params["containerRecipeArn"] = str(input["container_recipe_arn"])
