"""Generated from Smithy shape ``com.amazonaws.imagebuilder#DeleteContainerRecipe``."""
...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.delete_container_recipe_response.DeleteContainerRecipeResponse = aws_sdk_imagebuilder.types.delete_container_recipe_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.delete_container_recipe_request.DeleteContainerRecipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteContainerRecipe"
    params: dict[str, str] = {}
    if "container_recipe_arn" in input_:
        params["containerRecipeArn"] = str(input_["container_recipe_arn"])
...
async def async_delete_container_recipe(
