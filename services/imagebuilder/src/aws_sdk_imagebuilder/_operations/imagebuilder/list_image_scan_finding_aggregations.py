...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_image_scan_finding_aggregations_response.ListImageScanFindingAggregationsResponse = aws_sdk_imagebuilder.types.list_image_scan_finding_aggregations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_image_scan_finding_aggregations_request.ListImageScanFindingAggregationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_image_scan_finding_aggregations_request.serialize_json(
            input_
        )
    ).encode()
