...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.list_distribution_configurations_response.ListDistributionConfigurationsResponse = aws_sdk_imagebuilder.types.list_distribution_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.list_distribution_configurations_request.ListDistributionConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.list_distribution_configurations_request.serialize_json(
            input_
        )
    ).encode()
