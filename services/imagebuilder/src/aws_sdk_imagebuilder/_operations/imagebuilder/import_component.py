...
def handle_response(
    ...
    out: aws_sdk_imagebuilder.types.import_component_response.ImportComponentResponse = aws_sdk_imagebuilder.types.import_component_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_imagebuilder.types.import_component_request.ImportComponentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.import_component_request.serialize_json(input_)
    ).encode()
