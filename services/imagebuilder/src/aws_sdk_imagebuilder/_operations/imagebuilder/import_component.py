...
def build_request(
    ...
    input: aws_sdk_imagebuilder.types.import_component_request.ImportComponentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_imagebuilder.types.import_component_request.serialize_json(input)
    ).encode()
