...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_lifecycle_execution_resources_response.ListLifecycleExecutionResourcesResponse = capo_imagebuilder.types.list_lifecycle_execution_resources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_lifecycle_execution_resources_request.serialize_json(
            input_
        )
    ).encode()
