"""Generated from Smithy shape ``com.amazonaws.imagebuilder#SendWorkflowStepAction``."""
...
import capo_imagebuilder.errors.invalid_parameter_value_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidParameterValueException":
            raise capo_imagebuilder.errors.invalid_parameter_value_exception.InvalidParameterValueException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_imagebuilder.types.send_workflow_step_action_response.SendWorkflowStepActionResponse = capo_imagebuilder.types.send_workflow_step_action_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/SendWorkflowStepAction"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.send_workflow_step_action_request.serialize_json(input_)
    ).encode()
...
async def async_send_workflow_step_action(
