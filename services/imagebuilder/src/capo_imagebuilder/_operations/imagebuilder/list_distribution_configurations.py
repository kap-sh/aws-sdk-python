"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListDistributionConfigurations``."""
...
import capo_imagebuilder.types.distribution_configuration_summary_list
...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_distribution_configurations_response.ListDistributionConfigurationsResponse = capo_imagebuilder.types.list_distribution_configurations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ListDistributionConfigurations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_distribution_configurations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_distribution_configurations(
