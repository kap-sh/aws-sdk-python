"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListComponents``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_components_response.ListComponentsResponse = (
        capo_imagebuilder.types.list_components_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_components_request.serialize_json(input_)
    ).encode()
