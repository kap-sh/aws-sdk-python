...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_marketplace_resource_response.GetMarketplaceResourceResponse = capo_imagebuilder.types.get_marketplace_resource_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.get_marketplace_resource_request.serialize_json(input_)
    ).encode()
