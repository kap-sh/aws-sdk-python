...
def handle_response(
    ...
    out: capo_imagebuilder.types.create_component_response.CreateComponentResponse = (
        capo_imagebuilder.types.create_component_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.create_component_request.serialize_json(input_)
    ).encode()
