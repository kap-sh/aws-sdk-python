"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetComponentPolicy``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_component_policy_response.GetComponentPolicyResponse = capo_imagebuilder.types.get_component_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetComponentPolicy"
    params: dict[str, str] = {}
    if "component_arn" in input_:
        params["componentArn"] = str(input_["component_arn"])
...
async def async_get_component_policy(
