...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_image_recipes_response.ListImageRecipesResponse = capo_imagebuilder.types.list_image_recipes_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_image_recipes_request.serialize_json(input_)
    ).encode()
