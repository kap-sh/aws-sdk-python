"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListImagePipelineImages``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_image_pipeline_images_response.ListImagePipelineImagesResponse = capo_imagebuilder.types.list_image_pipeline_images_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_image_pipeline_images_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_image_pipeline_images(
