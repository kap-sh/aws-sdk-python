"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListLifecycleExecutions``."""
...
import capo_imagebuilder.types.lifecycle_executions_list
...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_lifecycle_executions_response.ListLifecycleExecutionsResponse = capo_imagebuilder.types.list_lifecycle_executions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ListLifecycleExecutions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_lifecycle_executions_request.serialize_json(input_)
    ).encode()
...
async def async_list_lifecycle_executions(
