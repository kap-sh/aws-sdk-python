...
def handle_response(
    ...
    out: capo_imagebuilder.types.retry_image_response.RetryImageResponse = (
        capo_imagebuilder.types.retry_image_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.retry_image_request.serialize_json(input_)
    ).encode()
...
def retry_image(
    ...
    capo_imagebuilder.types.retry_image_response.RetryImageResponse, zapros.Response
]:
