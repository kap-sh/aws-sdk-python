"""Generated from Smithy shape ``com.amazonaws.imagebuilder#DistributeImage``."""
...
import capo_imagebuilder.errors.access_denied_exception
...
import capo_imagebuilder.errors.resource_not_found_exception
...
import capo_imagebuilder.errors.too_many_requests_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_imagebuilder.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
        ...
        case "ResourceNotFoundException":
            raise capo_imagebuilder.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        ...
        case "TooManyRequestsException":
            raise capo_imagebuilder.errors.too_many_requests_exception.TooManyRequestsException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_imagebuilder.types.distribute_image_response.DistributeImageResponse = (
        capo_imagebuilder.types.distribute_image_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DistributeImage"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.distribute_image_request.serialize_json(input_)
    ).encode()
...
async def async_distribute_image(
