"""Generated from Smithy shape ``com.amazonaws.imagebuilder#DeleteDistributionConfiguration``."""
...
import capo_imagebuilder.errors.resource_dependency_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceDependencyException":
            raise capo_imagebuilder.errors.resource_dependency_exception.ResourceDependencyException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_imagebuilder.types.delete_distribution_configuration_response.DeleteDistributionConfigurationResponse = capo_imagebuilder.types.delete_distribution_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteDistributionConfiguration"
    params: dict[str, str] = {}
    if "distribution_configuration_arn" in input_:
        params["distributionConfigurationArn"] = str(
            input_["distribution_configuration_arn"]
        )
...
async def async_delete_distribution_configuration(
