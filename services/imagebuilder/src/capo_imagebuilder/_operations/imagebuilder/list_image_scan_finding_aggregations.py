"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListImageScanFindingAggregations``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_image_scan_finding_aggregations_response.ListImageScanFindingAggregationsResponse = capo_imagebuilder.types.list_image_scan_finding_aggregations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ListImageScanFindingAggregations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_image_scan_finding_aggregations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_image_scan_finding_aggregations(
