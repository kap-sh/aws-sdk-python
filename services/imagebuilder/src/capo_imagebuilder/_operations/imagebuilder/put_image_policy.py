"""Generated from Smithy shape ``com.amazonaws.imagebuilder#PutImagePolicy``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.put_image_policy_response.PutImagePolicyResponse = (
        capo_imagebuilder.types.put_image_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.put_image_policy_request.serialize_json(input_)
    ).encode()
...
async def async_put_image_policy(
