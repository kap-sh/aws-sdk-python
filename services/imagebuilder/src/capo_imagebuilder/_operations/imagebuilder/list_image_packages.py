"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListImagePackages``."""
...
import capo_imagebuilder.errors.invalid_pagination_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPaginationTokenException":
            raise capo_imagebuilder.errors.invalid_pagination_token_exception.InvalidPaginationTokenException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_image_packages_response.ListImagePackagesResponse = capo_imagebuilder.types.list_image_packages_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ListImagePackages"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_image_packages_request.serialize_json(input_)
    ).encode()
...
async def async_list_image_packages(
