"""Generated from Smithy shape ``com.amazonaws.imagebuilder#DeleteWorkflow``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.delete_workflow_response.DeleteWorkflowResponse = (
        capo_imagebuilder.types.delete_workflow_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteWorkflow"
    params: dict[str, str] = {}
    if "workflow_build_version_arn" in input_:
        params["workflowBuildVersionArn"] = str(input_["workflow_build_version_arn"])
