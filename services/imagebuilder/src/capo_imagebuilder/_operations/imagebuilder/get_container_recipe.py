...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_container_recipe_response.GetContainerRecipeResponse = capo_imagebuilder.types.get_container_recipe_response.deserialize_json(
