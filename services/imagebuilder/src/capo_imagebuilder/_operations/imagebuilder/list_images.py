...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_images_response.ListImagesResponse = (
        capo_imagebuilder.types.list_images_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_images_request.serialize_json(input_)
    ).encode()
...
def list_images(
    ...
    capo_imagebuilder.types.list_images_response.ListImagesResponse, zapros.Response
]:
