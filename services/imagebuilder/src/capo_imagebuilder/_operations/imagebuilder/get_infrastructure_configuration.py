"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetInfrastructureConfiguration``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_infrastructure_configuration_response.GetInfrastructureConfigurationResponse = capo_imagebuilder.types.get_infrastructure_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetInfrastructureConfiguration"
    params: dict[str, str] = {}
...
async def async_get_infrastructure_configuration(
