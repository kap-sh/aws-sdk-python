"""Generated from Smithy shape ``com.amazonaws.imagebuilder#DeleteImage``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.delete_image_response.DeleteImageResponse = (
        capo_imagebuilder.types.delete_image_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteImage"
    params: dict[str, str] = {}
    if "image_build_version_arn" in input_:
        params["imageBuildVersionArn"] = str(input_["image_build_version_arn"])
...
def delete_image(
    ...
    capo_imagebuilder.types.delete_image_response.DeleteImageResponse, zapros.Response
]:
