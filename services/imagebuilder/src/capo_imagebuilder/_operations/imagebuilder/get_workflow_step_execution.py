"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetWorkflowStepExecution``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_workflow_step_execution_response.GetWorkflowStepExecutionResponse = capo_imagebuilder.types.get_workflow_step_execution_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetWorkflowStepExecution"
    params: dict[str, str] = {}
    if "step_execution_id" in input_:
        params["stepExecutionId"] = str(input_["step_execution_id"])
...
async def async_get_workflow_step_execution(
