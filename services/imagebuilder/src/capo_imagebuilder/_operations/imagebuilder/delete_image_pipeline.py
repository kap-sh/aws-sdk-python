"""Generated from Smithy shape ``com.amazonaws.imagebuilder#DeleteImagePipeline``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.delete_image_pipeline_response.DeleteImagePipelineResponse = capo_imagebuilder.types.delete_image_pipeline_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteImagePipeline"
    params: dict[str, str] = {}
    if "image_pipeline_arn" in input_:
        params["imagePipelineArn"] = str(input_["image_pipeline_arn"])
...
async def async_delete_image_pipeline(
