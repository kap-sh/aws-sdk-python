"""Generated from Smithy shape ``com.amazonaws.imagebuilder#TagResource``."""
...
import capo_imagebuilder.errors.invalid_parameter_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidParameterException":
            raise capo_imagebuilder.errors.invalid_parameter_exception.InvalidParameterException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_imagebuilder.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_imagebuilder.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
