"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.imagebuilder#ResourceNotFoundException``."""
