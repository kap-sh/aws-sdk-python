...
class imagebuilderError(Exception):
    """Base class for all imagebuilder service errors."""


class ServiceError(imagebuilderError):
...
class SerializationError(imagebuilderError):
    """Raised when a value cannot be serialized."""


class DeserializationError(imagebuilderError):
...
class WaiterFailedError(imagebuilderError):
...
class WaiterTimeoutError(imagebuilderError):
