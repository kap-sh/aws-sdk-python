"""Generated from Smithy shape ``com.amazonaws.imagebuilder#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.imagebuilder#AccessDeniedException``."""
