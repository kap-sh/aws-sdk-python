"""Generated from Smithy shape ``com.amazonaws.imagebuilder#UpdateImagePipelineResponse``."""
...
class UpdateImagePipelineResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateImagePipelineResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateImagePipelineResponse:
    out: UpdateImagePipelineResponse = {}  # type: ignore[typeddict-item]
