...
if TYPE_CHECKING:
    ...
    import capo_imagebuilder.types.workflow_step_execution_list
...
def serialize_json(value: ListWaitingWorkflowStepsResponse) -> dict:
    ...
    if "steps" in value:
        ...
        out["steps"] = (
            capo_imagebuilder.types.workflow_step_execution_list.serialize_json(
                value["steps"]
            )
        )
...
def deserialize_json(data: dict) -> ListWaitingWorkflowStepsResponse:
    ...
    if "steps" in data:
        ...
        out["steps"] = (
            capo_imagebuilder.types.workflow_step_execution_list.deserialize_json(
                data["steps"]
            )
        )
