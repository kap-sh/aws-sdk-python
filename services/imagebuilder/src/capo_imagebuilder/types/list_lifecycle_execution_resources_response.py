...
class ListLifecycleExecutionResourcesResponse(TypedDict, closed=True):
    ...
    resources: NotRequired[
        "capo_imagebuilder.types.lifecycle_execution_resource_list.LifecycleExecutionResourceList"
    ]
...
def serialize_json(value: ListLifecycleExecutionResourcesResponse) -> dict:
    ...
    if "lifecycle_execution_state" in value:
        ...
        out["lifecycleExecutionState"] = (
            capo_imagebuilder.types.lifecycle_execution_state.serialize_json(
    ...
    if "resources" in value:
        ...
        out["resources"] = (
            capo_imagebuilder.types.lifecycle_execution_resource_list.serialize_json(
                value["resources"]
            )
        )
...
def deserialize_json(data: dict) -> ListLifecycleExecutionResourcesResponse:
    ...
    if "resources" in data:
        ...
        out["resources"] = (
            capo_imagebuilder.types.lifecycle_execution_resource_list.deserialize_json(
                data["resources"]
            )
        )
