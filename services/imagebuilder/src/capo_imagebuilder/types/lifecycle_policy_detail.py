...
if TYPE_CHECKING:
    import capo_imagebuilder.types.lifecycle_policy_detail_action
    import capo_imagebuilder.types.lifecycle_policy_detail_exclusion_rules
    import capo_imagebuilder.types.lifecycle_policy_detail_filter


class LifecyclePolicyDetail(TypedDict, closed=True):
    action: "capo_imagebuilder.types.lifecycle_policy_detail_action.LifecyclePolicyDetailAction"
    """<p>Configuration details for the policy action.</p>"""
    filter: "capo_imagebuilder.types.lifecycle_policy_detail_filter.LifecyclePolicyDetailFilter"
...
def serialize_json(value: LifecyclePolicyDetail) -> dict:
    ...
    out["action"] = (
        capo_imagebuilder.types.lifecycle_policy_detail_action.serialize_json(
            value["action"]
        )
    )
    import capo_imagebuilder.types.lifecycle_policy_detail_filter
    ...
    out["filter"] = (
        capo_imagebuilder.types.lifecycle_policy_detail_filter.serialize_json(
            value["filter"]
        )
    )
    if "exclusion_rules" in value:
        ...
        out["exclusionRules"] = (
            capo_imagebuilder.types.lifecycle_policy_detail_exclusion_rules.serialize_json(
...
def deserialize_json(data: dict) -> LifecyclePolicyDetail:
    ...
    if "action" in data:
        ...
        out["action"] = (
            capo_imagebuilder.types.lifecycle_policy_detail_action.deserialize_json(
                data["action"]
            )
        )
    else:
    ...
    if "filter" in data:
        ...
        out["filter"] = (
            capo_imagebuilder.types.lifecycle_policy_detail_filter.deserialize_json(
                data["filter"]
            )
        )
    else:
    ...
    if "exclusionRules" in data:
        ...
        out["exclusion_rules"] = (
            capo_imagebuilder.types.lifecycle_policy_detail_exclusion_rules.deserialize_json(
                data["exclusionRules"]
            )
        )
    return out
