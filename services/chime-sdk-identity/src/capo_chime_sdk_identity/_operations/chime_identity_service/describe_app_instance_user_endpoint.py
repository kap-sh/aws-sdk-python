"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#DescribeAppInstanceUserEndpoint``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.describe_app_instance_user_endpoint_response.DescribeAppInstanceUserEndpointResponse = capo_chime_sdk_identity.types.describe_app_instance_user_endpoint_response.deserialize_json(
...
async def async_describe_app_instance_user_endpoint(
