"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#CreateAppInstanceAdmin``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.create_app_instance_admin_response.CreateAppInstanceAdminResponse = capo_chime_sdk_identity.types.create_app_instance_admin_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_identity.types.create_app_instance_admin_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_app_instance_admin(
