"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#DescribeAppInstance``."""
...
import capo_chime_sdk_identity.types.app_instance
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.describe_app_instance_response.DescribeAppInstanceResponse = capo_chime_sdk_identity.types.describe_app_instance_response.deserialize_json(
...
async def async_describe_app_instance(
