"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#DeleteAppInstanceAdmin``."""
...
def build_request(
    ...
    url = url.replace(
        "{AppInstanceAdminArn}", quote(str(input_["app_instance_admin_arn"]), safe="")
    )
    url = url.replace(
...
async def async_delete_app_instance_admin(
