...
import capo_chime_sdk_identity.types.app_instance_user_endpoint_summary_list
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.list_app_instance_user_endpoints_response.ListAppInstanceUserEndpointsResponse = capo_chime_sdk_identity.types.list_app_instance_user_endpoints_response.deserialize_json(
