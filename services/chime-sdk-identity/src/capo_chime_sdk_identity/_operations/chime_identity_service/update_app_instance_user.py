...
import capo_chime_sdk_identity.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_chime_sdk_identity.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.update_app_instance_user_response.UpdateAppInstanceUserResponse = capo_chime_sdk_identity.types.update_app_instance_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_identity.types.update_app_instance_user_request.serialize_json(
            input_
        )
    ).encode()
