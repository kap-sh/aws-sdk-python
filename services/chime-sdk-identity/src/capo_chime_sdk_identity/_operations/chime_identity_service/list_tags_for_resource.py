"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_chime_sdk_identity.types.list_tags_for_resource_response.deserialize_json(
