...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.update_app_instance_response.UpdateAppInstanceResponse = capo_chime_sdk_identity.types.update_app_instance_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_identity.types.update_app_instance_request.serialize_json(input_)
    ).encode()
