"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#ListAppInstances``."""
...
import capo_chime_sdk_identity.types.app_instance_list
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.list_app_instances_response.ListAppInstancesResponse = capo_chime_sdk_identity.types.list_app_instances_response.deserialize_json(
...
async def async_list_app_instances(
