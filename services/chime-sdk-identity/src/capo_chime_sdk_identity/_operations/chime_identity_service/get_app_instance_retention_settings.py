...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.get_app_instance_retention_settings_response.GetAppInstanceRetentionSettingsResponse = capo_chime_sdk_identity.types.get_app_instance_retention_settings_response.deserialize_json(
