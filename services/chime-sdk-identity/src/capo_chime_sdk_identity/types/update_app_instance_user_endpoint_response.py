"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#UpdateAppInstanceUserEndpointResponse``."""
...
class UpdateAppInstanceUserEndpointResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateAppInstanceUserEndpointResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateAppInstanceUserEndpointResponse:
    out: UpdateAppInstanceUserEndpointResponse = {}  # type: ignore[typeddict-item]
