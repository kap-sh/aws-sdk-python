...
class ChimeSDKIdentityError(Exception):
    """Base class for all ChimeSDKIdentity service errors."""


class ServiceError(ChimeSDKIdentityError):
...
class SerializationError(ChimeSDKIdentityError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ChimeSDKIdentityError):
...
class WaiterFailedError(ChimeSDKIdentityError):
...
class WaiterTimeoutError(ChimeSDKIdentityError):
