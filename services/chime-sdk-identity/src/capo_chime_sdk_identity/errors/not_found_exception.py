"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#NotFoundException``."""
...
class NotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.chimesdkidentity#NotFoundException``."""
