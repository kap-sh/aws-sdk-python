...
if TYPE_CHECKING:
    import aws_sdk_chime_sdk_identity.types.expiration_criterion
    import aws_sdk_chime_sdk_identity.types.expiration_days


class ExpirationSettings(TypedDict, closed=True):
    expiration_days: "aws_sdk_chime_sdk_identity.types.expiration_days.ExpirationDays"
    """<p>The period in days after which an <code>AppInstanceUser</code> will be automatically deleted.</p>"""
    expiration_criterion: (
        "aws_sdk_chime_sdk_identity.types.expiration_criterion.ExpirationCriterion"
    )
...
def serialize_json(value: ExpirationSettings) -> dict:
    ...
    out["ExpirationCriterion"] = (
        aws_sdk_chime_sdk_identity.types.expiration_criterion.serialize_json(
...
def deserialize_json(data: dict) -> ExpirationSettings:
    ...
    if "ExpirationCriterion" in data:
        ...
        out["expiration_criterion"] = (
            aws_sdk_chime_sdk_identity.types.expiration_criterion.deserialize_json(
