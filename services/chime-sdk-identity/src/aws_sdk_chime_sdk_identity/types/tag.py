...
if TYPE_CHECKING:
    ...
    import aws_sdk_chime_sdk_identity.types.tag_value


class Tag(TypedDict, closed=True):
    key: "aws_sdk_chime_sdk_identity.types.tag_key.TagKey"
    """<p>The key in a tag.</p>"""
    value: "aws_sdk_chime_sdk_identity.types.tag_value.TagValue"
