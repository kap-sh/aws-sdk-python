...
class DescribeAppInstanceUserResponse(TypedDict):
    app_instance_user: NotRequired[
        "aws_sdk_chime_sdk_identity.types.app_instance_user.AppInstanceUser"
    ]
...
def serialize_json(value: DescribeAppInstanceUserResponse) -> dict:
    ...
    if "app_instance_user" in value:
        ...
        out["AppInstanceUser"] = (
            aws_sdk_chime_sdk_identity.types.app_instance_user.serialize_json(
...
def deserialize_json(data: dict) -> DescribeAppInstanceUserResponse:
    ...
    if "AppInstanceUser" in data:
        ...
        out["app_instance_user"] = (
            aws_sdk_chime_sdk_identity.types.app_instance_user.deserialize_json(
