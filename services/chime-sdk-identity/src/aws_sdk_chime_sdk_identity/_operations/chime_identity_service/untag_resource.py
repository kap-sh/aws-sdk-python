"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#UntagResource``."""
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.untag_resource_request.serialize_json(input_)
    ).encode()
