...
def build_request(
    ...
    input: aws_sdk_chime_sdk_identity.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.untag_resource_request.serialize_json(input)
    ).encode()
