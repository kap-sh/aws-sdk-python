...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.list_app_instance_users_response.ListAppInstanceUsersResponse = aws_sdk_chime_sdk_identity.types.list_app_instance_users_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.list_app_instance_users_request.ListAppInstanceUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
