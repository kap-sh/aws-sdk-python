"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#CreateAppInstanceUser``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.create_app_instance_user_response.CreateAppInstanceUserResponse = aws_sdk_chime_sdk_identity.types.create_app_instance_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.create_app_instance_user_request.CreateAppInstanceUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/app-instance-users"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_chime_sdk_identity.types.create_app_instance_user_request

    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.create_app_instance_user_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_app_instance_user(
