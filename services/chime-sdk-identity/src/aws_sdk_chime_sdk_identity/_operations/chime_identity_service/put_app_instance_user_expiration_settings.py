"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#PutAppInstanceUserExpirationSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.put_app_instance_user_expiration_settings_response.PutAppInstanceUserExpirationSettingsResponse = aws_sdk_chime_sdk_identity.types.put_app_instance_user_expiration_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.put_app_instance_user_expiration_settings_request.PutAppInstanceUserExpirationSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.put_app_instance_user_expiration_settings_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_app_instance_user_expiration_settings(
