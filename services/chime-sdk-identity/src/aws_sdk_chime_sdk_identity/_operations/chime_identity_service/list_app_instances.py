...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.list_app_instances_response.ListAppInstancesResponse = aws_sdk_chime_sdk_identity.types.list_app_instances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.list_app_instances_request.ListAppInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
