"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#ListAppInstanceUserEndpoints``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.list_app_instance_user_endpoints_response.ListAppInstanceUserEndpointsResponse = aws_sdk_chime_sdk_identity.types.list_app_instance_user_endpoints_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.list_app_instance_user_endpoints_request.ListAppInstanceUserEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/app-instance-users/{AppInstanceUserArn}/endpoints"
    )
    url = url.replace(
...
async def async_list_app_instance_user_endpoints(
