"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#CreateAppInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.create_app_instance_response.CreateAppInstanceResponse = aws_sdk_chime_sdk_identity.types.create_app_instance_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.create_app_instance_request.CreateAppInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/app-instances"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_chime_sdk_identity.types.create_app_instance_request

    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.create_app_instance_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_app_instance(
