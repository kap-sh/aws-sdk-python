...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.describe_app_instance_user_endpoint_response.DescribeAppInstanceUserEndpointResponse = aws_sdk_chime_sdk_identity.types.describe_app_instance_user_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.describe_app_instance_user_endpoint_request.DescribeAppInstanceUserEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
