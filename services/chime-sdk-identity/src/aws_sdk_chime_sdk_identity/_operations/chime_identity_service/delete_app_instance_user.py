"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#DeleteAppInstanceUser``."""
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.delete_app_instance_user_request.DeleteAppInstanceUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_app_instance_user(
