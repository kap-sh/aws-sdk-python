...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.describe_app_instance_admin_response.DescribeAppInstanceAdminResponse = aws_sdk_chime_sdk_identity.types.describe_app_instance_admin_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_identity.types.describe_app_instance_admin_request.DescribeAppInstanceAdminRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{AppInstanceAdminArn}", quote(str(input["app_instance_admin_arn"]), safe="")
    )
    url = url.replace(
