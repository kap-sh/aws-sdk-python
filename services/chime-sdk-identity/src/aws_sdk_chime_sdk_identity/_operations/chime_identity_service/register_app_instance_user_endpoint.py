...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.register_app_instance_user_endpoint_response.RegisterAppInstanceUserEndpointResponse = aws_sdk_chime_sdk_identity.types.register_app_instance_user_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.register_app_instance_user_endpoint_request.RegisterAppInstanceUserEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.register_app_instance_user_endpoint_request.serialize_json(
            input_
        )
    ).encode()
