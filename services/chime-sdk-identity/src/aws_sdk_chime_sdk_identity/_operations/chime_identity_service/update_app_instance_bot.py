...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.update_app_instance_bot_response.UpdateAppInstanceBotResponse = aws_sdk_chime_sdk_identity.types.update_app_instance_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.update_app_instance_bot_request.UpdateAppInstanceBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.update_app_instance_bot_request.serialize_json(
            input_
        )
    ).encode()
