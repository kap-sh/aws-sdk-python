...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.create_app_instance_admin_response.CreateAppInstanceAdminResponse = aws_sdk_chime_sdk_identity.types.create_app_instance_admin_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.create_app_instance_admin_request.CreateAppInstanceAdminRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.create_app_instance_admin_request.serialize_json(
            input_
        )
    ).encode()
