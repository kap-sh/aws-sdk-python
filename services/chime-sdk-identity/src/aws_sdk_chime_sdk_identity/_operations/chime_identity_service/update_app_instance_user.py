"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#UpdateAppInstanceUser``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_chime_sdk_identity.errors.conflict_exception

            raise aws_sdk_chime_sdk_identity.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ResourceLimitExceededException":
            import aws_sdk_chime_sdk_identity.errors.resource_limit_exceeded_exception

            raise aws_sdk_chime_sdk_identity.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.update_app_instance_user_response.UpdateAppInstanceUserResponse = aws_sdk_chime_sdk_identity.types.update_app_instance_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.update_app_instance_user_request.UpdateAppInstanceUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/app-instance-users/{AppInstanceUserArn}"
    url = url.replace(
        "{AppInstanceUserArn}", quote(str(input_["app_instance_user_arn"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.update_app_instance_user_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_app_instance_user(
