...
def build_request(
    ...
    input: aws_sdk_chime_sdk_identity.types.update_app_instance_user_request.UpdateAppInstanceUserRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{AppInstanceUserArn}", quote(str(input["app_instance_user_arn"]), safe="")
    )
    params: dict[str, str] = {}
