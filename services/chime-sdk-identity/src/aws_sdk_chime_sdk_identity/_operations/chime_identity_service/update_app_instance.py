"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#UpdateAppInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.update_app_instance_response.UpdateAppInstanceResponse = aws_sdk_chime_sdk_identity.types.update_app_instance_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_identity.types.update_app_instance_request.UpdateAppInstanceRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/app-instances/{AppInstanceArn}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.update_app_instance_request.serialize_json(
            input
        )
    ).encode()
...
async def async_update_app_instance(
