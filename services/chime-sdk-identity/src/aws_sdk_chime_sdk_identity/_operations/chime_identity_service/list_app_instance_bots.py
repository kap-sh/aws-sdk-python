"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#ListAppInstanceBots``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.list_app_instance_bots_response.ListAppInstanceBotsResponse = aws_sdk_chime_sdk_identity.types.list_app_instance_bots_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_identity.types.list_app_instance_bots_request.ListAppInstanceBotsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "app_instance_arn" in input:
        params["app-instance-arn"] = str(input["app_instance_arn"])
...
async def async_list_app_instance_bots(
