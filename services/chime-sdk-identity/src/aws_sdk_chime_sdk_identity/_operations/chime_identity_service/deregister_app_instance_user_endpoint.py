"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#DeregisterAppInstanceUserEndpoint``."""
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_identity.types.deregister_app_instance_user_endpoint_request.DeregisterAppInstanceUserEndpointRequest,
) -> zapros.Request:
...
async def async_deregister_app_instance_user_endpoint(
