...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.describe_app_instance_response.DescribeAppInstanceResponse = aws_sdk_chime_sdk_identity.types.describe_app_instance_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.describe_app_instance_request.DescribeAppInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
