"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#ListAppInstanceAdmins``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.list_app_instance_admins_response.ListAppInstanceAdminsResponse = aws_sdk_chime_sdk_identity.types.list_app_instance_admins_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_identity.types.list_app_instance_admins_request.ListAppInstanceAdminsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/app-instances/{AppInstanceArn}/admins"
    url = url.replace(
        "{AppInstanceArn}", quote(str(input["app_instance_arn"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_list_app_instance_admins(
