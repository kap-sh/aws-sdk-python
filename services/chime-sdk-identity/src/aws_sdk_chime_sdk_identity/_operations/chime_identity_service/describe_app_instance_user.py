...
import aws_sdk_chime_sdk_identity.types.app_instance_user
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.describe_app_instance_user_response.DescribeAppInstanceUserResponse = aws_sdk_chime_sdk_identity.types.describe_app_instance_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.describe_app_instance_user_request.DescribeAppInstanceUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
