...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.put_app_instance_retention_settings_response.PutAppInstanceRetentionSettingsResponse = aws_sdk_chime_sdk_identity.types.put_app_instance_retention_settings_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_identity.types.put_app_instance_retention_settings_request.PutAppInstanceRetentionSettingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.put_app_instance_retention_settings_request.serialize_json(
            input
        )
    ).encode()
