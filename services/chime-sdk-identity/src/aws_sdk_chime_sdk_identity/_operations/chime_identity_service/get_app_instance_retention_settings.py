"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#GetAppInstanceRetentionSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.get_app_instance_retention_settings_response.GetAppInstanceRetentionSettingsResponse = aws_sdk_chime_sdk_identity.types.get_app_instance_retention_settings_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_identity.types.get_app_instance_retention_settings_request.GetAppInstanceRetentionSettingsRequest,
) -> zapros.Request:
...
async def async_get_app_instance_retention_settings(
