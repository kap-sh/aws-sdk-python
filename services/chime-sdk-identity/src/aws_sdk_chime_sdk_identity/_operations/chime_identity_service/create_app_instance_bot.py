"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#CreateAppInstanceBot``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_identity.types.create_app_instance_bot_response.CreateAppInstanceBotResponse = aws_sdk_chime_sdk_identity.types.create_app_instance_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_identity.types.create_app_instance_bot_request.CreateAppInstanceBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/app-instance-bots"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_chime_sdk_identity.types.create_app_instance_bot_request

    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_identity.types.create_app_instance_bot_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_app_instance_bot(
