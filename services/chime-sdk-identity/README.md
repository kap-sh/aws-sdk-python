...
```
pip install aws-sdk-chime-sdk-identity
```

## Usage

```python
from aws_sdk_chime_sdk_identity import AsyncChimeSDKIdentityClient
...
```python
from aws_sdk_chime_sdk_identity import AsyncChimeSDKIdentityClient
from aws_sdk_chime_sdk_identity.error import BadRequestException
