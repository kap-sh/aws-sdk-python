...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.get_channel_output.GetChannelOutput = (
        aws_sdk_repostspace.types.get_channel_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_repostspace.types.get_channel_input.GetChannelInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_channel(
    ...
    aws_sdk_repostspace.types.get_channel_output.GetChannelOutput, zapros.Response
]:
