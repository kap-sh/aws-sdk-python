"""Generated from Smithy shape ``com.amazonaws.repostspace#GetSpace``."""
...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.get_space_output.GetSpaceOutput = (
        aws_sdk_repostspace.types.get_space_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_repostspace.types.get_space_input.GetSpaceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_space(
    ...
    input_: aws_sdk_repostspace.types.get_space_input.GetSpaceInput,
) -> tuple[aws_sdk_repostspace.types.get_space_output.GetSpaceOutput, zapros.Response]:
