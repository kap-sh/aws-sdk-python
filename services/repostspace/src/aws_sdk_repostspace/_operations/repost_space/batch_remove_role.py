...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.batch_remove_role_output.BatchRemoveRoleOutput = (
        aws_sdk_repostspace.types.batch_remove_role_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_repostspace.types.batch_remove_role_input.BatchRemoveRoleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_repostspace.types.batch_remove_role_input.serialize_json(input_)
    ).encode()
