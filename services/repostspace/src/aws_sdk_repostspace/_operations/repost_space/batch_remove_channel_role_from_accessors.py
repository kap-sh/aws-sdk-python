...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.batch_remove_channel_role_from_accessors_output.BatchRemoveChannelRoleFromAccessorsOutput = aws_sdk_repostspace.types.batch_remove_channel_role_from_accessors_output.deserialize_json(
