"""Generated from Smithy shape ``com.amazonaws.repostspace#BatchAddRole``."""
...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.batch_add_role_output.BatchAddRoleOutput = (
        aws_sdk_repostspace.types.batch_add_role_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_repostspace.types.batch_add_role_input.BatchAddRoleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/spaces/{spaceId}/roles"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_repostspace.types.batch_add_role_input.serialize_json(input_)
    ).encode()
...
def batch_add_role(
    ...
    aws_sdk_repostspace.types.batch_add_role_output.BatchAddRoleOutput, zapros.Response
]:
...
async def async_batch_add_role(
