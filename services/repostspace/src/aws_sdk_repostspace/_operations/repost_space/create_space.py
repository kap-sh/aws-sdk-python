...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.create_space_output.CreateSpaceOutput = (
        aws_sdk_repostspace.types.create_space_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_repostspace.types.create_space_input.CreateSpaceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_repostspace.types.create_space_input.serialize_json(input)
    ).encode()
...
def create_space(
    ...
    aws_sdk_repostspace.types.create_space_output.CreateSpaceOutput, zapros.Response
]:
