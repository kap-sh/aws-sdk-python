"""Generated from Smithy shape ``com.amazonaws.repostspace#CreateChannel``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_repostspace.errors.conflict_exception

            raise aws_sdk_repostspace.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_repostspace.errors.service_quota_exceeded_exception

            raise aws_sdk_repostspace.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.create_channel_output.CreateChannelOutput = (
        aws_sdk_repostspace.types.create_channel_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_repostspace.types.create_channel_input.CreateChannelInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_repostspace.types.create_channel_input.serialize_json(input_)
    ).encode()
...
def create_channel(
    ...
    aws_sdk_repostspace.types.create_channel_output.CreateChannelOutput, zapros.Response
]:
