...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.batch_add_channel_role_to_accessors_output.BatchAddChannelRoleToAccessorsOutput = aws_sdk_repostspace.types.batch_add_channel_role_to_accessors_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_repostspace.types.batch_add_channel_role_to_accessors_input.BatchAddChannelRoleToAccessorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_repostspace.types.batch_add_channel_role_to_accessors_input.serialize_json(
            input_
        )
    ).encode()
