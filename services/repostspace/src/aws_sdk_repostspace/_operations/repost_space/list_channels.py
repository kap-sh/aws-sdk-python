...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.list_channels_output.ListChannelsOutput = (
        aws_sdk_repostspace.types.list_channels_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_repostspace.types.list_channels_input.ListChannelsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_channels(
    ...
    aws_sdk_repostspace.types.list_channels_output.ListChannelsOutput, zapros.Response
]:
