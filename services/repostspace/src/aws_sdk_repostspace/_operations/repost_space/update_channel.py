...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.update_channel_output.UpdateChannelOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_repostspace.types.update_channel_input.UpdateChannelInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_repostspace.types.update_channel_input.serialize_json(input_)
    ).encode()
...
def update_channel(
    ...
    aws_sdk_repostspace.types.update_channel_output.UpdateChannelOutput, zapros.Response
]:
