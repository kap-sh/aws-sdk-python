"""Generated from Smithy shape ``com.amazonaws.repostspace#UpdateSpace``."""
...
def build_request(
    ...
    input_: aws_sdk_repostspace.types.update_space_input.UpdateSpaceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_repostspace.types.update_space_input.serialize_json(input_)
    ).encode()
