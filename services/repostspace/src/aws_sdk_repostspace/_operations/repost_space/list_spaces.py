...
def handle_response(
    ...
    out: aws_sdk_repostspace.types.list_spaces_output.ListSpacesOutput = (
        aws_sdk_repostspace.types.list_spaces_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_repostspace.types.list_spaces_input.ListSpacesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_spaces(
    ...
    aws_sdk_repostspace.types.list_spaces_output.ListSpacesOutput, zapros.Response
]:
