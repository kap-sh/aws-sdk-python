"""Generated from Smithy shape ``com.amazonaws.repostspace#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.repostspace#ResourceNotFoundException``."""
