...
class repostspaceError(Exception):
    """Base class for all repostspace service errors."""


class ServiceError(repostspaceError):
...
class SerializationError(repostspaceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(repostspaceError):
...
class WaiterFailedError(repostspaceError):
...
class WaiterTimeoutError(repostspaceError):
