...
from aws_sdk_repostspace._services._aws_config import aaws_config
...
class AsyncrepostspaceClientConfig(TypedDict, total=False):
...
class AsyncrepostspaceClient:
    ...
    async def batch_add_channel_role_to_accessors(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.batch_add_channel_role_to_accessors_input.BatchAddChannelRoleToAccessorsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.batch_add_channel_role_to_accessors_output.BatchAddChannelRoleToAccessorsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.batch_add_channel_role_to_accessors.async_batch_add_channel_role_to_accessors(
    ...
    async def batch_add_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.batch_add_role_input.BatchAddRoleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.batch_add_role_output.BatchAddRoleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.batch_add_role.async_batch_add_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_remove_channel_role_from_accessors(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.batch_remove_channel_role_from_accessors_input.BatchRemoveChannelRoleFromAccessorsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.batch_remove_channel_role_from_accessors_output.BatchRemoveChannelRoleFromAccessorsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.batch_remove_channel_role_from_accessors.async_batch_remove_channel_role_from_accessors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_remove_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.batch_remove_role_input.BatchRemoveRoleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.batch_remove_role_output.BatchRemoveRoleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.batch_remove_role.async_batch_remove_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.create_channel_input.CreateChannelInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.create_channel_output.CreateChannelOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.create_channel.async_create_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_space(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.create_space_input.CreateSpaceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.create_space_output.CreateSpaceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.create_space.async_create_space(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_space(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.delete_space_input.DeleteSpaceInput]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.delete_space.async_delete_space(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_admin(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.deregister_admin_input.DeregisterAdminInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.deregister_admin.async_deregister_admin(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.get_channel_input.GetChannelInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.get_channel_output.GetChannelOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.get_channel.async_get_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_space(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.get_space_input.GetSpaceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.get_space_output.GetSpaceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.get_space.async_get_space(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_channels(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.list_channels_input.ListChannelsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.list_channels_output.ListChannelsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.list_channels.async_list_channels(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_repostspace.types.channel_data.ChannelData]":
        _token = next_token
        while True:
    ...
    async def list_spaces(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.list_spaces_input.ListSpacesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.list_spaces_output.ListSpacesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.list_spaces.async_list_spaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_repostspace.types.space_data.SpaceData]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_admin(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.register_admin_input.RegisterAdminInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.register_admin.async_register_admin(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_invites(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.send_invites_input.SendInvitesInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.send_invites.async_send_invites(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.update_channel_input.UpdateChannelInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_repostspace.types.update_channel_output.UpdateChannelOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.update_channel.async_update_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_space(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_repostspace.types.update_space_input.UpdateSpaceInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_repostspace._operations.repost_space.update_space.async_update_space(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
