...
class BatchAddChannelRoleToAccessorsOutput(TypedDict):
...
def serialize_json(value: BatchAddChannelRoleToAccessorsOutput) -> dict:
    out: dict = {}
    import aws_sdk_repostspace.types.accessor_id_list
    out["addedAccessorIds"] = aws_sdk_repostspace.types.accessor_id_list.serialize_json(value["added_accessor_ids"])
    import aws_sdk_repostspace.types.batch_error_list
...
def deserialize_json(data: dict) -> BatchAddChannelRoleToAccessorsOutput:
    ...
    if "addedAccessorIds" in data:
        import aws_sdk_repostspace.types.accessor_id_list
        out["added_accessor_ids"] = aws_sdk_repostspace.types.accessor_id_list.deserialize_json(data["addedAccessorIds"])
    else:
        raise DeserializationError("BatchAddChannelRoleToAccessorsOutput.added_accessor_ids required")
    if "errors" in data:
        import aws_sdk_repostspace.types.batch_error_list
        out["errors"] = aws_sdk_repostspace.types.batch_error_list.deserialize_json(data["errors"])
    else:
        raise DeserializationError("BatchAddChannelRoleToAccessorsOutput.errors required")
    return out