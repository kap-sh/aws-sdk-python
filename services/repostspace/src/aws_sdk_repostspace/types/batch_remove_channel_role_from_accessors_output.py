...
class BatchRemoveChannelRoleFromAccessorsOutput(TypedDict):
...
def serialize_json(value: BatchRemoveChannelRoleFromAccessorsOutput) -> dict:
    out: dict = {}
    import aws_sdk_repostspace.types.accessor_id_list
    out["removedAccessorIds"] = aws_sdk_repostspace.types.accessor_id_list.serialize_json(value["removed_accessor_ids"])
    import aws_sdk_repostspace.types.batch_error_list
    out["errors"] = aws_sdk_repostspace.types.batch_error_list.serialize_json(value["errors"])
    return out
...
def deserialize_json(data: dict) -> BatchRemoveChannelRoleFromAccessorsOutput:
    ...
    if "removedAccessorIds" in data:
        import aws_sdk_repostspace.types.accessor_id_list
        out["removed_accessor_ids"] = aws_sdk_repostspace.types.accessor_id_list.deserialize_json(data["removedAccessorIds"])
    else:
        raise DeserializationError("BatchRemoveChannelRoleFromAccessorsOutput.removed_accessor_ids required")
    if "errors" in data:
        import aws_sdk_repostspace.types.batch_error_list
        out["errors"] = aws_sdk_repostspace.types.batch_error_list.deserialize_json(data["errors"])
    else:
        raise DeserializationError("BatchRemoveChannelRoleFromAccessorsOutput.errors required")
    return out