...
```
pip install aws-sdk-backup-gateway
```

## Usage

```python
from aws_sdk_backup_gateway import AsyncBackupGatewayClient


async def main():
    async with AsyncBackupGatewayClient() as s3:
...
```python
from aws_sdk_backup_gateway import AsyncBackupGatewayClient
from aws_sdk_backup_gateway.error import InternalServerException
