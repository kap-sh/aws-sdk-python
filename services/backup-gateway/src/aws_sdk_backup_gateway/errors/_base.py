...
class BackupGatewayError(Exception):
    """Base class for all BackupGateway service errors."""


class ServiceError(BackupGatewayError):
...
class SerializationError(BackupGatewayError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BackupGatewayError):
...
class WaiterFailedError(BackupGatewayError):
...
class WaiterTimeoutError(BackupGatewayError):
