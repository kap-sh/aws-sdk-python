...
def handle_response(
    ...
    out: capo_backup_gateway.types.delete_hypervisor_output.DeleteHypervisorOutput = (
        capo_backup_gateway.types.delete_hypervisor_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.delete_hypervisor_input.serialize_aws_json_1_0(input_)
    ).encode()
