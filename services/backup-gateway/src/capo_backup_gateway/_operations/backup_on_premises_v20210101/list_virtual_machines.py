...
def handle_response(
    ...
    out: capo_backup_gateway.types.list_virtual_machines_output.ListVirtualMachinesOutput = capo_backup_gateway.types.list_virtual_machines_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.list_virtual_machines_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
