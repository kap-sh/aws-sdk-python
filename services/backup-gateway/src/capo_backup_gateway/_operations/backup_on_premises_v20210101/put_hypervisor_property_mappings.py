...
def handle_response(
    ...
    out: capo_backup_gateway.types.put_hypervisor_property_mappings_output.PutHypervisorPropertyMappingsOutput = capo_backup_gateway.types.put_hypervisor_property_mappings_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.put_hypervisor_property_mappings_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
