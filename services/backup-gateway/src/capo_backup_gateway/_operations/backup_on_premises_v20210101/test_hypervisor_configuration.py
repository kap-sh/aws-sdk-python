...
def handle_response(
    ...
    out: capo_backup_gateway.types.test_hypervisor_configuration_output.TestHypervisorConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.test_hypervisor_configuration_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
