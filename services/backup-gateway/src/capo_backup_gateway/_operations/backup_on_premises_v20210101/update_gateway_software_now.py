"""Generated from Smithy shape ``com.amazonaws.backupgateway#UpdateGatewaySoftwareNow``."""
...
def handle_response(
    ...
    out: capo_backup_gateway.types.update_gateway_software_now_output.UpdateGatewaySoftwareNowOutput = capo_backup_gateway.types.update_gateway_software_now_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "BackupOnPremises_v20210101.UpdateGatewaySoftwareNow"
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.update_gateway_software_now_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_gateway_software_now(
