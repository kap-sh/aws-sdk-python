...
def handle_response(
    ...
    out: capo_backup_gateway.types.untag_resource_output.UntagResourceOutput = (
        capo_backup_gateway.types.untag_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.untag_resource_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_backup_gateway.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
