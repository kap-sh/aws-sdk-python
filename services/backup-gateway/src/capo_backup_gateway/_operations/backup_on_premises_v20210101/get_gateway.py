"""Generated from Smithy shape ``com.amazonaws.backupgateway#GetGateway``."""
...
def handle_response(
    ...
    out: capo_backup_gateway.types.get_gateway_output.GetGatewayOutput = (
        capo_backup_gateway.types.get_gateway_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.get_gateway_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_gateway(
    ...
    capo_backup_gateway.types.get_gateway_output.GetGatewayOutput, zapros.Response
]:
