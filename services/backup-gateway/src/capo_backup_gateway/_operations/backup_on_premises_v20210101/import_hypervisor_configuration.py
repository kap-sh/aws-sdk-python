"""Generated from Smithy shape ``com.amazonaws.backupgateway#ImportHypervisorConfiguration``."""
...
def handle_response(
    ...
    out: capo_backup_gateway.types.import_hypervisor_configuration_output.ImportHypervisorConfigurationOutput = capo_backup_gateway.types.import_hypervisor_configuration_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "BackupOnPremises_v20210101.ImportHypervisorConfiguration"
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.import_hypervisor_configuration_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_import_hypervisor_configuration(
