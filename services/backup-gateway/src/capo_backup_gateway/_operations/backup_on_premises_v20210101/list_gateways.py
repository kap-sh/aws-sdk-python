...
def handle_response(
    ...
    out: capo_backup_gateway.types.list_gateways_output.ListGatewaysOutput = (
        capo_backup_gateway.types.list_gateways_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.list_gateways_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_gateways(
    ...
    capo_backup_gateway.types.list_gateways_output.ListGatewaysOutput, zapros.Response
]:
