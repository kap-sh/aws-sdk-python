...
class SupplyChainError(Exception):
    """Base class for all SupplyChain service errors."""


class ServiceError(SupplyChainError):
...
class SerializationError(SupplyChainError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SupplyChainError):
...
class WaiterFailedError(SupplyChainError):
...
class WaiterTimeoutError(SupplyChainError):
