...
def serialize_json(value: CreateDataLakeNamespaceResponse) -> dict:
    out: dict = {}
    import aws_sdk_supplychain.types.data_lake_namespace
    out["namespace"] = aws_sdk_supplychain.types.data_lake_namespace.serialize_json(value["namespace"])
    return out
...
def deserialize_json(data: dict) -> CreateDataLakeNamespaceResponse:
    ...
    if "namespace" in data:
        import aws_sdk_supplychain.types.data_lake_namespace
        out["namespace"] = aws_sdk_supplychain.types.data_lake_namespace.deserialize_json(data["namespace"])
    else:
