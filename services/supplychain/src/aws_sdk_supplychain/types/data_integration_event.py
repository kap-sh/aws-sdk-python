...
if TYPE_CHECKING:
    ...
    import aws_sdk_supplychain.types.data_integration_event_dataset_target_details
...
class DataIntegrationEvent(TypedDict):
    ...
    dataset_target_details: NotRequired[
        "aws_sdk_supplychain.types.data_integration_event_dataset_target_details.DataIntegrationEventDatasetTargetDetails"
    ]
...
def serialize_json(value: DataIntegrationEvent) -> dict:
    ...
    out["eventTimestamp"] = aws_sdk_supplychain.types._prelude.timestamp.serialize_json(
    ...
    if "dataset_target_details" in value:
        ...
        out["datasetTargetDetails"] = (
            aws_sdk_supplychain.types.data_integration_event_dataset_target_details.serialize_json(
...
def deserialize_json(data: dict) -> DataIntegrationEvent:
    ...
    if "datasetTargetDetails" in data:
        ...
        out["dataset_target_details"] = (
            aws_sdk_supplychain.types.data_integration_event_dataset_target_details.deserialize_json(
