...
class CreateDataLakeNamespaceRequest(TypedDict):
    ...
    description: NotRequired["aws_sdk_supplychain.types.data_lake_namespace_description.DataLakeNamespaceDescription"]
