...
class CreateDataLakeDatasetResponse(TypedDict):
...
def serialize_json(value: CreateDataLakeDatasetResponse) -> dict:
    out: dict = {}
    import aws_sdk_supplychain.types.data_lake_dataset
    out["dataset"] = aws_sdk_supplychain.types.data_lake_dataset.serialize_json(value["dataset"])
    return out
...
def deserialize_json(data: dict) -> CreateDataLakeDatasetResponse:
    ...
    if "dataset" in data:
        import aws_sdk_supplychain.types.data_lake_dataset
        out["dataset"] = aws_sdk_supplychain.types.data_lake_dataset.deserialize_json(data["dataset"])
    else:
