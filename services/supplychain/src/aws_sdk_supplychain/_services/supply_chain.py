...
from aws_sdk_supplychain._auth._identity import Credentials
from aws_sdk_supplychain._auth._providers import (
    CredentialsProvider,
...
from aws_sdk_supplychain._services._aws_config import aws_config
...
if TYPE_CHECKING:
    ...
    import aws_sdk_supplychain.types.get_data_integration_event_request
    import aws_sdk_supplychain.types.get_data_integration_event_response
    import aws_sdk_supplychain.types.get_data_integration_flow_execution_request
    import aws_sdk_supplychain.types.get_data_integration_flow_execution_response
    import aws_sdk_supplychain.types.list_data_integration_events_request
    import aws_sdk_supplychain.types.list_data_integration_events_response
    import aws_sdk_supplychain.types.list_data_integration_flow_executions_request
    import aws_sdk_supplychain.types.list_data_integration_flow_executions_response
    import aws_sdk_supplychain.types.list_tags_for_resource_request
    import aws_sdk_supplychain.types.list_tags_for_resource_response
    import aws_sdk_supplychain.types.send_data_integration_event_request
    import aws_sdk_supplychain.types.send_data_integration_event_response
    import aws_sdk_supplychain.types.tag_key_list
    import aws_sdk_supplychain.types.tag_map
    import aws_sdk_supplychain.types.tag_resource_request
    import aws_sdk_supplychain.types.tag_resource_response
    import aws_sdk_supplychain.types.untag_resource_request
    import aws_sdk_supplychain.types.untag_resource_response
    import aws_sdk_supplychain.types.uuid


class SupplyChainClientConfig(TypedDict, total=False):
...
class SupplyChainClient:
    ...
    def get_data_integration_event(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_supplychain.types.get_data_integration_event_request.GetDataIntegrationEventRequest]",
        ) -> OperationResponse[
            "aws_sdk_supplychain.types.get_data_integration_event_response.GetDataIntegrationEventResponse"
        ]:
            import aws_sdk_supplychain._operations.galaxy_public_api_gateway.get_data_integration_event

            output, http_response = (
                aws_sdk_supplychain._operations.galaxy_public_api_gateway.get_data_integration_event.get_data_integration_event(
    ...
    def get_data_integration_flow_execution(
        self,
        instance_id: "aws_sdk_supplychain.types.uuid.UUID",
        flow_name: "aws_sdk_supplychain.types.data_integration_flow_name.DataIntegrationFlowName",
        execution_id: "aws_sdk_supplychain.types.uuid.UUID",
        *,
        config_overrides: Optional[SupplyChainClientConfig] = None,
    ) -> "aws_sdk_supplychain.types.get_data_integration_flow_execution_response.GetDataIntegrationFlowExecutionResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_supplychain.types.get_data_integration_flow_execution_request.GetDataIntegrationFlowExecutionRequest]",
        ) -> OperationResponse[
            "aws_sdk_supplychain.types.get_data_integration_flow_execution_response.GetDataIntegrationFlowExecutionResponse"
        ]:
            import aws_sdk_supplychain._operations.galaxy_public_api_gateway.get_data_integration_flow_execution

            output, http_response = (
                aws_sdk_supplychain._operations.galaxy_public_api_gateway.get_data_integration_flow_execution.get_data_integration_flow_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_data_integration_events(
        ...
        *,
        ...
        max_results: Optional[
            "aws_sdk_supplychain.types.data_integration_event_max_results.DataIntegrationEventMaxResults"
        ] = None,
    ) -> "aws_sdk_supplychain.types.list_data_integration_events_response.ListDataIntegrationEventsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_supplychain.types.list_data_integration_events_request.ListDataIntegrationEventsRequest]",
        ) -> OperationResponse[
            "aws_sdk_supplychain.types.list_data_integration_events_response.ListDataIntegrationEventsResponse"
        ]:
            import aws_sdk_supplychain._operations.galaxy_public_api_gateway.list_data_integration_events

            output, http_response = (
                aws_sdk_supplychain._operations.galaxy_public_api_gateway.list_data_integration_events.list_data_integration_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_supplychain.types.data_integration_event.DataIntegrationEvent]":
        _token = next_token
        while True:
    ...
    def list_data_integration_flow_executions(
        ...
        *,
        ...
        max_results: Optional[
            "aws_sdk_supplychain.types.data_integration_flow_execution_max_results.DataIntegrationFlowExecutionMaxResults"
        ] = None,
    ) -> "aws_sdk_supplychain.types.list_data_integration_flow_executions_response.ListDataIntegrationFlowExecutionsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_supplychain.types.list_data_integration_flow_executions_request.ListDataIntegrationFlowExecutionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_supplychain.types.list_data_integration_flow_executions_response.ListDataIntegrationFlowExecutionsResponse"
        ]:
            import aws_sdk_supplychain._operations.galaxy_public_api_gateway.list_data_integration_flow_executions

            output, http_response = (
                aws_sdk_supplychain._operations.galaxy_public_api_gateway.list_data_integration_flow_executions.list_data_integration_flow_executions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_supplychain.types.data_integration_flow_execution.DataIntegrationFlowExecution]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        config_overrides: Optional[SupplyChainClientConfig] = None,
    ) -> "aws_sdk_supplychain.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_supplychain.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_supplychain.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_supplychain._operations.galaxy_public_api_gateway.list_tags_for_resource

            output, http_response = (
                aws_sdk_supplychain._operations.galaxy_public_api_gateway.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_data_integration_event(
        self,
        instance_id: "aws_sdk_supplychain.types.uuid.UUID",
        event_type: "aws_sdk_supplychain.types.data_integration_event_type.DataIntegrationEventType",
        data: "aws_sdk_supplychain.types.data_integration_event_data.DataIntegrationEventData",
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_supplychain.types.send_data_integration_event_request.SendDataIntegrationEventRequest]",
        ) -> OperationResponse[
            "aws_sdk_supplychain.types.send_data_integration_event_response.SendDataIntegrationEventResponse"
        ]:
            import aws_sdk_supplychain._operations.galaxy_public_api_gateway.send_data_integration_event

            output, http_response = (
                aws_sdk_supplychain._operations.galaxy_public_api_gateway.send_data_integration_event.send_data_integration_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        config_overrides: Optional[SupplyChainClientConfig] = None,
    ) -> "aws_sdk_supplychain.types.tag_resource_response.TagResourceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_supplychain.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_supplychain.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_supplychain._operations.galaxy_public_api_gateway.tag_resource

            output, http_response = (
                aws_sdk_supplychain._operations.galaxy_public_api_gateway.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        config_overrides: Optional[SupplyChainClientConfig] = None,
    ) -> "aws_sdk_supplychain.types.untag_resource_response.UntagResourceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_supplychain.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_supplychain.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_supplychain._operations.galaxy_public_api_gateway.untag_resource

            output, http_response = (
                aws_sdk_supplychain._operations.galaxy_public_api_gateway.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
