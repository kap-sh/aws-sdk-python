...
from aws_sdk_supplychain._services._aws_config import aaws_config
...
class AsyncSupplyChainClientConfig(TypedDict, total=False):
...
class AsyncSupplyChainClient:
    ...
    async def get_data_integration_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_supplychain.types.get_data_integration_event_request.GetDataIntegrationEventRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_supplychain.types.get_data_integration_event_response.GetDataIntegrationEventResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_supplychain._operations.galaxy_public_api_gateway.get_data_integration_event.async_get_data_integration_event(
    ...
    async def get_data_integration_flow_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_supplychain.types.get_data_integration_flow_execution_request.GetDataIntegrationFlowExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_supplychain.types.get_data_integration_flow_execution_response.GetDataIntegrationFlowExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_supplychain._operations.galaxy_public_api_gateway.get_data_integration_flow_execution.async_get_data_integration_flow_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_data_integration_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_supplychain.types.list_data_integration_events_request.ListDataIntegrationEventsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_supplychain.types.list_data_integration_events_response.ListDataIntegrationEventsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_supplychain._operations.galaxy_public_api_gateway.list_data_integration_events.async_list_data_integration_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_supplychain.types.data_integration_event.DataIntegrationEvent]":
        _token = next_token
        while True:
    ...
    async def list_data_integration_flow_executions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_supplychain.types.list_data_integration_flow_executions_request.ListDataIntegrationFlowExecutionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_supplychain.types.list_data_integration_flow_executions_response.ListDataIntegrationFlowExecutionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_supplychain._operations.galaxy_public_api_gateway.list_data_integration_flow_executions.async_list_data_integration_flow_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_supplychain.types.data_integration_flow_execution.DataIntegrationFlowExecution]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_supplychain.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_supplychain.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_supplychain._operations.galaxy_public_api_gateway.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_data_integration_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_supplychain.types.send_data_integration_event_request.SendDataIntegrationEventRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_supplychain.types.send_data_integration_event_response.SendDataIntegrationEventResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_supplychain._operations.galaxy_public_api_gateway.send_data_integration_event.async_send_data_integration_event(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_supplychain.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_supplychain.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_supplychain._operations.galaxy_public_api_gateway.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_supplychain.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_supplychain.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_supplychain._operations.galaxy_public_api_gateway.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
