import pytest
from capo_auto_scaling_plans._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_auto_scaling_plans._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
