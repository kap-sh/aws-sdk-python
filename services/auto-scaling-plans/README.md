...
```
pip install aws-sdk-auto-scaling-plans
```

## Usage

```python
from aws_sdk_auto_scaling_plans import AsyncAutoScalingPlansClient
...
```python
from aws_sdk_auto_scaling_plans import AsyncAutoScalingPlansClient
from aws_sdk_auto_scaling_plans.error import ConcurrentUpdateException
