...
if TYPE_CHECKING:
    import capo_auto_scaling_plans.types.metric_dimension_name
    import capo_auto_scaling_plans.types.metric_dimension_value


class MetricDimension(TypedDict, closed=True):
    name: "capo_auto_scaling_plans.types.metric_dimension_name.MetricDimensionName"
    """<p>The name of the dimension.</p>"""
    value: "capo_auto_scaling_plans.types.metric_dimension_value.MetricDimensionValue"
