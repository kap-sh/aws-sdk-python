...
class ApplicationSource(TypedDict, closed=True):
    cloud_formation_stack_arn: NotRequired[
        "capo_auto_scaling_plans.types.xml_string.XmlString"
    ]
    """<p>The Amazon Resource Name (ARN) of a AWS CloudFormation stack.</p>"""
    tag_filters: NotRequired["capo_auto_scaling_plans.types.tag_filters.TagFilters"]
...
def serialize_aws_json_1_1(value: ApplicationSource) -> dict:
    ...
    if "tag_filters" in value:
        ...
        out["TagFilters"] = (
            capo_auto_scaling_plans.types.tag_filters.serialize_aws_json_1_1(
                value["tag_filters"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ApplicationSource:
    ...
    if "TagFilters" in data:
        ...
        out["tag_filters"] = (
            capo_auto_scaling_plans.types.tag_filters.deserialize_aws_json_1_1(
                data["TagFilters"]
            )
        )
    return out
