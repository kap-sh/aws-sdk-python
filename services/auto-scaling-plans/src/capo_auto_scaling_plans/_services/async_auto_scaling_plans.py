...
from capo_auto_scaling_plans._services._aws_config import aaws_config
...
class AsyncAutoScalingPlansClient:
    ...
    async def create_scaling_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_auto_scaling_plans.types.create_scaling_plan_request.CreateScalingPlanRequest]",
        ) -> AsyncOperationResponse[
            "capo_auto_scaling_plans.types.create_scaling_plan_response.CreateScalingPlanResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.create_scaling_plan.async_create_scaling_plan(
    ...
    async def delete_scaling_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_auto_scaling_plans.types.delete_scaling_plan_request.DeleteScalingPlanRequest]",
        ) -> AsyncOperationResponse[
            "capo_auto_scaling_plans.types.delete_scaling_plan_response.DeleteScalingPlanResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.delete_scaling_plan.async_delete_scaling_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_scaling_plan_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_auto_scaling_plans.types.describe_scaling_plan_resources_request.DescribeScalingPlanResourcesRequest]",
        ) -> AsyncOperationResponse[
            "capo_auto_scaling_plans.types.describe_scaling_plan_resources_response.DescribeScalingPlanResourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.describe_scaling_plan_resources.async_describe_scaling_plan_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_scaling_plans(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_auto_scaling_plans.types.describe_scaling_plans_request.DescribeScalingPlansRequest]",
        ) -> AsyncOperationResponse[
            "capo_auto_scaling_plans.types.describe_scaling_plans_response.DescribeScalingPlansResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.describe_scaling_plans.async_describe_scaling_plans(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_scaling_plan_resource_forecast_data(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_auto_scaling_plans.types.get_scaling_plan_resource_forecast_data_request.GetScalingPlanResourceForecastDataRequest]",
        ) -> AsyncOperationResponse[
            "capo_auto_scaling_plans.types.get_scaling_plan_resource_forecast_data_response.GetScalingPlanResourceForecastDataResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.get_scaling_plan_resource_forecast_data.async_get_scaling_plan_resource_forecast_data(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_scaling_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_auto_scaling_plans.types.update_scaling_plan_request.UpdateScalingPlanRequest]",
        ) -> AsyncOperationResponse[
            "capo_auto_scaling_plans.types.update_scaling_plan_response.UpdateScalingPlanResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.update_scaling_plan.async_update_scaling_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
