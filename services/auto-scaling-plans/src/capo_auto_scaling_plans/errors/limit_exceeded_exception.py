"""Generated from Smithy shape ``com.amazonaws.autoscalingplans#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.autoscalingplans#LimitExceededException``."""
