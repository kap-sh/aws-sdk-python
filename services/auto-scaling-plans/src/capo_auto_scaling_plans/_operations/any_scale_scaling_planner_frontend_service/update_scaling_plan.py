"""Generated from Smithy shape ``com.amazonaws.autoscalingplans#UpdateScalingPlan``."""
...
import capo_auto_scaling_plans.errors.object_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ObjectNotFoundException":
            raise capo_auto_scaling_plans.errors.object_not_found_exception.ObjectNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_auto_scaling_plans.types.update_scaling_plan_response.UpdateScalingPlanResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AnyScaleScalingPlannerFrontendService.UpdateScalingPlan"
    body: bytes | None = json.dumps(
        capo_auto_scaling_plans.types.update_scaling_plan_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_scaling_plan(
