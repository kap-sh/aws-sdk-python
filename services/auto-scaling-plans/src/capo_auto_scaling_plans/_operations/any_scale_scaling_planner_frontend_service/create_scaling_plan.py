"""Generated from Smithy shape ``com.amazonaws.autoscalingplans#CreateScalingPlan``."""
...
import capo_auto_scaling_plans.errors.concurrent_update_exception
import capo_auto_scaling_plans.errors.internal_service_exception
import capo_auto_scaling_plans.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentUpdateException":
            raise capo_auto_scaling_plans.errors.concurrent_update_exception.ConcurrentUpdateException.from_aws_json_1_1(
                data
            )
        ...
        case "LimitExceededException":
            raise capo_auto_scaling_plans.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_auto_scaling_plans.types.create_scaling_plan_response.CreateScalingPlanResponse = capo_auto_scaling_plans.types.create_scaling_plan_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AnyScaleScalingPlannerFrontendService.CreateScalingPlan"
    body: bytes | None = json.dumps(
        capo_auto_scaling_plans.types.create_scaling_plan_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_scaling_plan(
