...
class AutoScalingPlansError(Exception):
    """Base class for all AutoScalingPlans service errors."""


class ServiceError(AutoScalingPlansError):
...
class SerializationError(AutoScalingPlansError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AutoScalingPlansError):
...
class WaiterFailedError(AutoScalingPlansError):
...
class WaiterTimeoutError(AutoScalingPlansError):
