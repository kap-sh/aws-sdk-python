"""Generated from Smithy shape ``com.amazonaws.autoscalingplans#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.autoscalingplans#InvalidNextTokenException``."""
