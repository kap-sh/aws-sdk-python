...
from aws_sdk_auto_scaling_plans._services._aws_config import aws_config
...
class AutoScalingPlansClientConfig(TypedDict, total=False):
...
class AutoScalingPlansClient:
    ...
    def create_scaling_plan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_auto_scaling_plans.types.create_scaling_plan_request.CreateScalingPlanRequest]",
        ) -> OperationResponse[
            "aws_sdk_auto_scaling_plans.types.create_scaling_plan_response.CreateScalingPlanResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.create_scaling_plan.create_scaling_plan(
    ...
    def delete_scaling_plan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_auto_scaling_plans.types.delete_scaling_plan_request.DeleteScalingPlanRequest]",
        ) -> OperationResponse[
            "aws_sdk_auto_scaling_plans.types.delete_scaling_plan_response.DeleteScalingPlanResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.delete_scaling_plan.delete_scaling_plan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_scaling_plan_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_auto_scaling_plans.types.describe_scaling_plan_resources_request.DescribeScalingPlanResourcesRequest]",
        ) -> OperationResponse[
            "aws_sdk_auto_scaling_plans.types.describe_scaling_plan_resources_response.DescribeScalingPlanResourcesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.describe_scaling_plan_resources.describe_scaling_plan_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_scaling_plans(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_auto_scaling_plans.types.describe_scaling_plans_request.DescribeScalingPlansRequest]",
        ) -> OperationResponse[
            "aws_sdk_auto_scaling_plans.types.describe_scaling_plans_response.DescribeScalingPlansResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.describe_scaling_plans.describe_scaling_plans(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_scaling_plan_resource_forecast_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_auto_scaling_plans.types.get_scaling_plan_resource_forecast_data_request.GetScalingPlanResourceForecastDataRequest]",
        ) -> OperationResponse[
            "aws_sdk_auto_scaling_plans.types.get_scaling_plan_resource_forecast_data_response.GetScalingPlanResourceForecastDataResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.get_scaling_plan_resource_forecast_data.get_scaling_plan_resource_forecast_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_scaling_plan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_auto_scaling_plans.types.update_scaling_plan_request.UpdateScalingPlanRequest]",
        ) -> OperationResponse[
            "aws_sdk_auto_scaling_plans.types.update_scaling_plan_response.UpdateScalingPlanResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_auto_scaling_plans._operations.any_scale_scaling_planner_frontend_service.update_scaling_plan.update_scaling_plan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
