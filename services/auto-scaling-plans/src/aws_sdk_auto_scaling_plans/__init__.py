...
from ._services.async_auto_scaling_plans import (
    AsyncAutoScalingPlansClient as AsyncAutoScalingPlansClient,
)
from ._services.auto_scaling_plans import (
    AutoScalingPlansClient as AutoScalingPlansClient,
)
