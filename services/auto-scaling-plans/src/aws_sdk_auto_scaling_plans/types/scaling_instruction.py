...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling_plans.types.customized_load_metric_specification
    import aws_sdk_auto_scaling_plans.types.disable_dynamic_scaling
    import aws_sdk_auto_scaling_plans.types.predefined_load_metric_specification
    import aws_sdk_auto_scaling_plans.types.predictive_scaling_max_capacity_behavior
    import aws_sdk_auto_scaling_plans.types.predictive_scaling_mode
    import aws_sdk_auto_scaling_plans.types.resource_capacity
    ...
    import aws_sdk_auto_scaling_plans.types.scaling_policy_update_behavior
    import aws_sdk_auto_scaling_plans.types.scheduled_action_buffer_time
    import aws_sdk_auto_scaling_plans.types.service_namespace
    import aws_sdk_auto_scaling_plans.types.target_tracking_configurations


class ScalingInstruction(TypedDict):
    service_namespace: (
    ...
    min_capacity: "aws_sdk_auto_scaling_plans.types.resource_capacity.ResourceCapacity"
    """<p>The minimum capacity of the resource. </p>"""
    max_capacity: "aws_sdk_auto_scaling_plans.types.resource_capacity.ResourceCapacity"
    ...
    target_tracking_configurations: "aws_sdk_auto_scaling_plans.types.target_tracking_configurations.TargetTrackingConfigurations"
    ...
    predefined_load_metric_specification: NotRequired[
        "aws_sdk_auto_scaling_plans.types.predefined_load_metric_specification.PredefinedLoadMetricSpecification"
    ]
    ...
    customized_load_metric_specification: NotRequired[
        "aws_sdk_auto_scaling_plans.types.customized_load_metric_specification.CustomizedLoadMetricSpecification"
    ]
    ...
    scheduled_action_buffer_time: NotRequired[
        "aws_sdk_auto_scaling_plans.types.scheduled_action_buffer_time.ScheduledActionBufferTime"
    ]
    ...
    predictive_scaling_max_capacity_behavior: NotRequired[
        "aws_sdk_auto_scaling_plans.types.predictive_scaling_max_capacity_behavior.PredictiveScalingMaxCapacityBehavior"
    ]
    ...
    predictive_scaling_max_capacity_buffer: NotRequired[
        "aws_sdk_auto_scaling_plans.types.resource_capacity.ResourceCapacity"
    ]
    ...
    predictive_scaling_mode: NotRequired[
        "aws_sdk_auto_scaling_plans.types.predictive_scaling_mode.PredictiveScalingMode"
    ]
    ...
    scaling_policy_update_behavior: NotRequired[
        "aws_sdk_auto_scaling_plans.types.scaling_policy_update_behavior.ScalingPolicyUpdateBehavior"
    ]
    ...
    disable_dynamic_scaling: NotRequired[
        "aws_sdk_auto_scaling_plans.types.disable_dynamic_scaling.DisableDynamicScaling"
    ]
...
def serialize_aws_json_1_1(value: ScalingInstruction) -> dict:
    ...
    out["TargetTrackingConfigurations"] = (
        aws_sdk_auto_scaling_plans.types.target_tracking_configurations.serialize_aws_json_1_1(
    ...
    if "predefined_load_metric_specification" in value:
        ...
        out["PredefinedLoadMetricSpecification"] = (
            aws_sdk_auto_scaling_plans.types.predefined_load_metric_specification.serialize_aws_json_1_1(
    ...
    if "customized_load_metric_specification" in value:
        ...
        out["CustomizedLoadMetricSpecification"] = (
            aws_sdk_auto_scaling_plans.types.customized_load_metric_specification.serialize_aws_json_1_1(
    ...
    if "predictive_scaling_max_capacity_behavior" in value:
        ...
        out["PredictiveScalingMaxCapacityBehavior"] = (
            aws_sdk_auto_scaling_plans.types.predictive_scaling_max_capacity_behavior.serialize_aws_json_1_1(
    ...
    if "predictive_scaling_mode" in value:
        ...
        out["PredictiveScalingMode"] = (
            aws_sdk_auto_scaling_plans.types.predictive_scaling_mode.serialize_aws_json_1_1(
    ...
    if "scaling_policy_update_behavior" in value:
        ...
        out["ScalingPolicyUpdateBehavior"] = (
            aws_sdk_auto_scaling_plans.types.scaling_policy_update_behavior.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ScalingInstruction:
    ...
    if "TargetTrackingConfigurations" in data:
        ...
        out["target_tracking_configurations"] = (
            aws_sdk_auto_scaling_plans.types.target_tracking_configurations.deserialize_aws_json_1_1(
    ...
    if "PredefinedLoadMetricSpecification" in data:
        ...
        out["predefined_load_metric_specification"] = (
            aws_sdk_auto_scaling_plans.types.predefined_load_metric_specification.deserialize_aws_json_1_1(
    ...
    if "CustomizedLoadMetricSpecification" in data:
        ...
        out["customized_load_metric_specification"] = (
            aws_sdk_auto_scaling_plans.types.customized_load_metric_specification.deserialize_aws_json_1_1(
    ...
    if "PredictiveScalingMaxCapacityBehavior" in data:
        ...
        out["predictive_scaling_max_capacity_behavior"] = (
            aws_sdk_auto_scaling_plans.types.predictive_scaling_max_capacity_behavior.deserialize_aws_json_1_1(
    ...
    if "PredictiveScalingMode" in data:
        ...
        out["predictive_scaling_mode"] = (
            aws_sdk_auto_scaling_plans.types.predictive_scaling_mode.deserialize_aws_json_1_1(
    ...
    if "ScalingPolicyUpdateBehavior" in data:
        ...
        out["scaling_policy_update_behavior"] = (
            aws_sdk_auto_scaling_plans.types.scaling_policy_update_behavior.deserialize_aws_json_1_1(
