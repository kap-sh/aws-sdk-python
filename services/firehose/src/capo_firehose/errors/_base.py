...
class FirehoseError(Exception):
    """Base class for all Firehose service errors."""


class ServiceError(FirehoseError):
...
class SerializationError(FirehoseError):
    """Raised when a value cannot be serialized."""


class DeserializationError(FirehoseError):
...
class WaiterFailedError(FirehoseError):
...
class WaiterTimeoutError(FirehoseError):
