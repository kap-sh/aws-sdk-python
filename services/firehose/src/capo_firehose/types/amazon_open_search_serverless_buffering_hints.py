...
if TYPE_CHECKING:
    import capo_firehose.types.amazon_open_search_serverless_buffering_interval_in_seconds
    import capo_firehose.types.amazon_open_search_serverless_buffering_size_in_m_bs


class AmazonOpenSearchServerlessBufferingHints(TypedDict, closed=True):
    interval_in_seconds: NotRequired[
        "capo_firehose.types.amazon_open_search_serverless_buffering_interval_in_seconds.AmazonOpenSearchServerlessBufferingIntervalInSeconds"
    ]
    ...
    size_in_m_bs: NotRequired[
        "capo_firehose.types.amazon_open_search_serverless_buffering_size_in_m_bs.AmazonOpenSearchServerlessBufferingSizeInMBs"
    ]
