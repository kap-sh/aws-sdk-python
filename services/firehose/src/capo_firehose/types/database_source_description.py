...
if TYPE_CHECKING:
    import capo_firehose.types.database_column_include_or_exclude_list
    ...
    import capo_firehose.types.database_snapshot_info_list
...
class DatabaseSourceDescription(TypedDict, closed=True):
    type: NotRequired["capo_firehose.types.database_type.DatabaseType"]
    ...
    endpoint: NotRequired["capo_firehose.types.database_endpoint.DatabaseEndpoint"]
    """<p> The endpoint of the database server. </p> <p>Amazon Data Firehose is in preview release and is subject to change.</p>"""
    port: NotRequired["capo_firehose.types.database_port.DatabasePort"]
    ...
    databases: NotRequired["capo_firehose.types.database_list.DatabaseList"]
    ...
    tables: NotRequired["capo_firehose.types.database_table_list.DatabaseTableList"]
    ...
    surrogate_keys: NotRequired[
        "capo_firehose.types.database_column_include_or_exclude_list.DatabaseColumnIncludeOrExcludeList"
    ]
    ...
    snapshot_info: NotRequired[
        "capo_firehose.types.database_snapshot_info_list.DatabaseSnapshotInfoList"
    ]
    ...
    database_source_authentication_configuration: NotRequired[
        "capo_firehose.types.database_source_authentication_configuration.DatabaseSourceAuthenticationConfiguration"
    ]
    ...
    database_source_vpc_configuration: NotRequired[
        "capo_firehose.types.database_source_vpc_configuration.DatabaseSourceVPCConfiguration"
    ]
...
def serialize_aws_json_1_1(value: DatabaseSourceDescription) -> dict:
    ...
    if "surrogate_keys" in value:
        ...
        out["SurrogateKeys"] = (
            capo_firehose.types.database_column_include_or_exclude_list.serialize_aws_json_1_1(
    ...
    if "snapshot_info" in value:
        ...
        out["SnapshotInfo"] = (
            capo_firehose.types.database_snapshot_info_list.serialize_aws_json_1_1(
                value["snapshot_info"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DatabaseSourceDescription:
    ...
    if "SurrogateKeys" in data:
        ...
        out["surrogate_keys"] = (
            capo_firehose.types.database_column_include_or_exclude_list.deserialize_aws_json_1_1(
                data["SurrogateKeys"]
            )
        )
    ...
    if "SnapshotInfo" in data:
        ...
        out["snapshot_info"] = (
            capo_firehose.types.database_snapshot_info_list.deserialize_aws_json_1_1(
                data["SnapshotInfo"]
            )
        )
