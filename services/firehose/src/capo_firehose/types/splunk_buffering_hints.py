...
if TYPE_CHECKING:
    import capo_firehose.types.splunk_buffering_interval_in_seconds
    import capo_firehose.types.splunk_buffering_size_in_m_bs


class SplunkBufferingHints(TypedDict, closed=True):
    interval_in_seconds: NotRequired[
        "capo_firehose.types.splunk_buffering_interval_in_seconds.SplunkBufferingIntervalInSeconds"
    ]
    ...
    size_in_m_bs: NotRequired[
        "capo_firehose.types.splunk_buffering_size_in_m_bs.SplunkBufferingSizeInMBs"
    ]
