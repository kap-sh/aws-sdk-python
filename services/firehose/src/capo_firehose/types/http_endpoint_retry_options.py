...
if TYPE_CHECKING:
    import capo_firehose.types.http_endpoint_retry_duration_in_seconds


class HttpEndpointRetryOptions(TypedDict, closed=True):
    duration_in_seconds: NotRequired[
        "capo_firehose.types.http_endpoint_retry_duration_in_seconds.HttpEndpointRetryDurationInSeconds"
    ]
