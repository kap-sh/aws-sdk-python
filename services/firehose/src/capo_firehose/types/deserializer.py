...
class Deserializer(TypedDict, closed=True):
    open_x_json_ser_de: NotRequired[
        "capo_firehose.types.open_x_json_ser_de.OpenXJsonSerDe"
    ]
    ...
    hive_json_ser_de: NotRequired["capo_firehose.types.hive_json_ser_de.HiveJsonSerDe"]
...
def serialize_aws_json_1_1(value: Deserializer) -> dict:
    ...
    if "open_x_json_ser_de" in value:
        ...
        out["OpenXJsonSerDe"] = (
            capo_firehose.types.open_x_json_ser_de.serialize_aws_json_1_1(
    ...
    if "hive_json_ser_de" in value:
        ...
        out["HiveJsonSerDe"] = (
            capo_firehose.types.hive_json_ser_de.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Deserializer:
    ...
    if "OpenXJsonSerDe" in data:
        ...
        out["open_x_json_ser_de"] = (
            capo_firehose.types.open_x_json_ser_de.deserialize_aws_json_1_1(
                data["OpenXJsonSerDe"]
            )
        )
    if "HiveJsonSerDe" in data:
        ...
        out["hive_json_ser_de"] = (
            capo_firehose.types.hive_json_ser_de.deserialize_aws_json_1_1(
                data["HiveJsonSerDe"]
            )
        )
    return out
