...
if TYPE_CHECKING:
    import capo_firehose.types.snowflake_buffering_interval_in_seconds
    import capo_firehose.types.snowflake_buffering_size_in_m_bs


class SnowflakeBufferingHints(TypedDict, closed=True):
    size_in_m_bs: NotRequired[
        "capo_firehose.types.snowflake_buffering_size_in_m_bs.SnowflakeBufferingSizeInMBs"
    ]
    ...
    interval_in_seconds: NotRequired[
        "capo_firehose.types.snowflake_buffering_interval_in_seconds.SnowflakeBufferingIntervalInSeconds"
    ]
