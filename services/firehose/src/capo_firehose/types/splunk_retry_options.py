...
if TYPE_CHECKING:
    import capo_firehose.types.splunk_retry_duration_in_seconds


class SplunkRetryOptions(TypedDict, closed=True):
    duration_in_seconds: NotRequired[
        "capo_firehose.types.splunk_retry_duration_in_seconds.SplunkRetryDurationInSeconds"
    ]
