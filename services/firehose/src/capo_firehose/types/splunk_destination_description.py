...
class SplunkDestinationDescription(TypedDict, closed=True):
    hec_endpoint: NotRequired["capo_firehose.types.hec_endpoint.HECEndpoint"]
    """<p>The HTTP Event Collector (HEC) endpoint to which Firehose sends your data.</p>"""
    hec_endpoint_type: NotRequired[
        "capo_firehose.types.hec_endpoint_type.HECEndpointType"
    ]
