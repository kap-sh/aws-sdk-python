...
if TYPE_CHECKING:
    import capo_firehose.types.elasticsearch_buffering_interval_in_seconds
    import capo_firehose.types.elasticsearch_buffering_size_in_m_bs


class ElasticsearchBufferingHints(TypedDict, closed=True):
    interval_in_seconds: NotRequired[
        "capo_firehose.types.elasticsearch_buffering_interval_in_seconds.ElasticsearchBufferingIntervalInSeconds"
    ]
    ...
    size_in_m_bs: NotRequired[
        "capo_firehose.types.elasticsearch_buffering_size_in_m_bs.ElasticsearchBufferingSizeInMBs"
    ]
