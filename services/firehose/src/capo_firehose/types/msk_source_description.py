...
class MSKSourceDescription(TypedDict, closed=True):
    msk_cluster_arn: NotRequired["capo_firehose.types.msk_cluster_arn.MSKClusterARN"]
    """<p>The ARN of the Amazon MSK cluster.</p>"""
    topic_name: NotRequired["capo_firehose.types.topic_name.TopicName"]
