"""Generated from Smithy shape ``com.amazonaws.firehose#IcebergDestinationDescription``."""
...
class IcebergDestinationDescription(TypedDict, closed=True):
    ...
    """<p>The description of automatic schema evolution configuration.</p> <p>Amazon Data Firehose is in preview release and is subject to change.</p>"""
    table_creation_configuration: NotRequired[
        "capo_firehose.types.table_creation_configuration.TableCreationConfiguration"
    ]
    """<p> The description of table creation configuration. </p> <p>Amazon Data Firehose is in preview release and is subject to change.</p>"""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: IcebergDestinationDescription) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> IcebergDestinationDescription:
    out: IcebergDestinationDescription = {}  # type: ignore[typeddict-item]
