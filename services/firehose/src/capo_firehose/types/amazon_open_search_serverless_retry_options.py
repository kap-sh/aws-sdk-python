...
if TYPE_CHECKING:
    import capo_firehose.types.amazon_open_search_serverless_retry_duration_in_seconds


class AmazonOpenSearchServerlessRetryOptions(TypedDict, closed=True):
    duration_in_seconds: NotRequired[
        "capo_firehose.types.amazon_open_search_serverless_retry_duration_in_seconds.AmazonOpenSearchServerlessRetryDurationInSeconds"
    ]
