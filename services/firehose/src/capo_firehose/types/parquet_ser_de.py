...
if TYPE_CHECKING:
    import capo_firehose.types.block_size_bytes
    ...
    import capo_firehose.types.parquet_page_size_bytes
    import capo_firehose.types.parquet_writer_version


class ParquetSerDe(TypedDict, closed=True):
    block_size_bytes: NotRequired["capo_firehose.types.block_size_bytes.BlockSizeBytes"]
    ...
    page_size_bytes: NotRequired[
        "capo_firehose.types.parquet_page_size_bytes.ParquetPageSizeBytes"
    ]
    ...
    compression: NotRequired[
        "capo_firehose.types.parquet_compression.ParquetCompression"
    ]
    ...
    writer_version: NotRequired[
        "capo_firehose.types.parquet_writer_version.ParquetWriterVersion"
    ]
...
def serialize_aws_json_1_1(value: ParquetSerDe) -> dict:
    ...
    if "compression" in value:
        ...
        out["Compression"] = (
            capo_firehose.types.parquet_compression.serialize_aws_json_1_1(
                value["compression"]
            )
        )
    ...
    if "writer_version" in value:
        ...
        out["WriterVersion"] = (
            capo_firehose.types.parquet_writer_version.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ParquetSerDe:
    ...
    if "Compression" in data:
        ...
        out["compression"] = (
            capo_firehose.types.parquet_compression.deserialize_aws_json_1_1(
                data["Compression"]
            )
        )
    ...
    if "WriterVersion" in data:
        ...
        out["writer_version"] = (
            capo_firehose.types.parquet_writer_version.deserialize_aws_json_1_1(
                data["WriterVersion"]
            )
        )
    return out
