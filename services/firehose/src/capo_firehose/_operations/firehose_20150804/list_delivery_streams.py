"""Generated from Smithy shape ``com.amazonaws.firehose#ListDeliveryStreams``."""
...
def handle_response(
    ...
    out: capo_firehose.types.list_delivery_streams_output.ListDeliveryStreamsOutput = (
        capo_firehose.types.list_delivery_streams_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_firehose.types.list_delivery_streams_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_delivery_streams(
