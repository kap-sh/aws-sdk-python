"""Generated from Smithy shape ``com.amazonaws.firehose#UntagDeliveryStream``."""
...
def handle_response(
    ...
    out: capo_firehose.types.untag_delivery_stream_output.UntagDeliveryStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_firehose.types.untag_delivery_stream_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_untag_delivery_stream(
