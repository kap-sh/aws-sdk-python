"""Generated from Smithy shape ``com.amazonaws.firehose#ListTagsForDeliveryStream``."""
...
import capo_firehose.types.list_tags_for_delivery_stream_output_tag_list
...
def handle_response(
    ...
    out: capo_firehose.types.list_tags_for_delivery_stream_output.ListTagsForDeliveryStreamOutput = capo_firehose.types.list_tags_for_delivery_stream_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_firehose.types.list_tags_for_delivery_stream_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_tags_for_delivery_stream(
