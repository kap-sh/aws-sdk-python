...
def handle_response(
    ...
    out: capo_firehose.types.delete_delivery_stream_output.DeleteDeliveryStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_firehose.types.delete_delivery_stream_input.serialize_aws_json_1_1(input_)
    ).encode()
