...
from aws_sdk_firehose._services._aws_config import aws_config
...
class FirehoseClient:
    ...
    def create_delivery_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.create_delivery_stream_input.CreateDeliveryStreamInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.create_delivery_stream_output.CreateDeliveryStreamOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.create_delivery_stream.create_delivery_stream(
    ...
    def delete_delivery_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.delete_delivery_stream_input.DeleteDeliveryStreamInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.delete_delivery_stream_output.DeleteDeliveryStreamOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.delete_delivery_stream.delete_delivery_stream(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_delivery_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.describe_delivery_stream_input.DescribeDeliveryStreamInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.describe_delivery_stream_output.DescribeDeliveryStreamOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.describe_delivery_stream.describe_delivery_stream(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_delivery_streams(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.list_delivery_streams_input.ListDeliveryStreamsInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.list_delivery_streams_output.ListDeliveryStreamsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.list_delivery_streams.list_delivery_streams(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_delivery_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.list_tags_for_delivery_stream_input.ListTagsForDeliveryStreamInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.list_tags_for_delivery_stream_output.ListTagsForDeliveryStreamOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.list_tags_for_delivery_stream.list_tags_for_delivery_stream(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_record(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.put_record_input.PutRecordInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.put_record_output.PutRecordOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.put_record.put_record(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_record_batch(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.put_record_batch_input.PutRecordBatchInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.put_record_batch_output.PutRecordBatchOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.put_record_batch.put_record_batch(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_delivery_stream_encryption(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.start_delivery_stream_encryption_input.StartDeliveryStreamEncryptionInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.start_delivery_stream_encryption_output.StartDeliveryStreamEncryptionOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.start_delivery_stream_encryption.start_delivery_stream_encryption(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_delivery_stream_encryption(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.stop_delivery_stream_encryption_input.StopDeliveryStreamEncryptionInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.stop_delivery_stream_encryption_output.StopDeliveryStreamEncryptionOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.stop_delivery_stream_encryption.stop_delivery_stream_encryption(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_delivery_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.tag_delivery_stream_input.TagDeliveryStreamInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.tag_delivery_stream_output.TagDeliveryStreamOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.tag_delivery_stream.tag_delivery_stream(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_delivery_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.untag_delivery_stream_input.UntagDeliveryStreamInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.untag_delivery_stream_output.UntagDeliveryStreamOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.untag_delivery_stream.untag_delivery_stream(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_destination(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_firehose.types.update_destination_input.UpdateDestinationInput]",
        ) -> OperationResponse[
            "aws_sdk_firehose.types.update_destination_output.UpdateDestinationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_firehose._operations.firehose_20150804.update_destination.update_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
