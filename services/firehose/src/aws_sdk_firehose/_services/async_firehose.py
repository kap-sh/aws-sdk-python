...
from aws_sdk_firehose._services._aws_config import aaws_config
...
class AsyncFirehoseClientConfig(TypedDict, total=False, closed=True):
...
class AsyncFirehoseClient:
    ...
    def __init__(
        ...
        self._config = AsyncFirehoseClientConfig(
            {
