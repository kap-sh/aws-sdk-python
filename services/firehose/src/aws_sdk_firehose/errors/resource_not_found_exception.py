"""Generated from Smithy shape ``com.amazonaws.firehose#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.firehose#ResourceNotFoundException``."""
