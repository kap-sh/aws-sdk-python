...
if TYPE_CHECKING:
    import aws_sdk_firehose.types.database_table_include_or_exclude_list


class DatabaseTableList(TypedDict):
    include: NotRequired[
        "aws_sdk_firehose.types.database_table_include_or_exclude_list.DatabaseTableIncludeOrExcludeList"
    ]
...
def serialize_aws_json_1_1(value: DatabaseTableList) -> dict:
    ...
    if "include" in value:
        ...
        out["Include"] = (
            aws_sdk_firehose.types.database_table_include_or_exclude_list.serialize_aws_json_1_1(
                value["include"]
            )
        )
    if "exclude" in value:
...
def deserialize_aws_json_1_1(data: dict) -> DatabaseTableList:
    ...
    if "Include" in data:
        ...
        out["include"] = (
            aws_sdk_firehose.types.database_table_include_or_exclude_list.deserialize_aws_json_1_1(
                data["Include"]
            )
        )
    if "Exclude" in data:
