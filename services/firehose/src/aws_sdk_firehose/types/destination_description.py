...
if TYPE_CHECKING:
    import aws_sdk_firehose.types.amazon_open_search_serverless_destination_description
    import aws_sdk_firehose.types.amazonopensearchservice_destination_description
    import aws_sdk_firehose.types.destination_id
    import aws_sdk_firehose.types.elasticsearch_destination_description
    import aws_sdk_firehose.types.extended_s3_destination_description
    import aws_sdk_firehose.types.http_endpoint_destination_description
    import aws_sdk_firehose.types.iceberg_destination_description
    import aws_sdk_firehose.types.redshift_destination_description
    import aws_sdk_firehose.types.s3_destination_description
    import aws_sdk_firehose.types.snowflake_destination_description
...
class DestinationDescription(TypedDict, closed=True):
    ...
    extended_s3_destination_description: NotRequired[
        "aws_sdk_firehose.types.extended_s3_destination_description.ExtendedS3DestinationDescription"
    ]
    """<p>The destination in Amazon S3.</p>"""
    redshift_destination_description: NotRequired[
        "aws_sdk_firehose.types.redshift_destination_description.RedshiftDestinationDescription"
    ]
    """<p>The destination in Amazon Redshift.</p>"""
    elasticsearch_destination_description: NotRequired[
        "aws_sdk_firehose.types.elasticsearch_destination_description.ElasticsearchDestinationDescription"
    ]
    """<p>The destination in Amazon OpenSearch Service.</p>"""
    amazonopensearchservice_destination_description: NotRequired[
        "aws_sdk_firehose.types.amazonopensearchservice_destination_description.AmazonopensearchserviceDestinationDescription"
    ]
    """<p>The destination in Amazon OpenSearch Service.</p>"""
    splunk_destination_description: NotRequired[
        "aws_sdk_firehose.types.splunk_destination_description.SplunkDestinationDescription"
    ]
    """<p>The destination in Splunk.</p>"""
    http_endpoint_destination_description: NotRequired[
        "aws_sdk_firehose.types.http_endpoint_destination_description.HttpEndpointDestinationDescription"
    ]
    """<p>Describes the specified HTTP endpoint destination.</p>"""
    snowflake_destination_description: NotRequired[
        "aws_sdk_firehose.types.snowflake_destination_description.SnowflakeDestinationDescription"
    ]
    """<p>Optional description for the destination</p>"""
    amazon_open_search_serverless_destination_description: NotRequired[
        "aws_sdk_firehose.types.amazon_open_search_serverless_destination_description.AmazonOpenSearchServerlessDestinationDescription"
    ]
    """<p>The destination in the Serverless offering for Amazon OpenSearch Service.</p>"""
    iceberg_destination_description: NotRequired[
        "aws_sdk_firehose.types.iceberg_destination_description.IcebergDestinationDescription"
    ]
...
def serialize_aws_json_1_1(value: DestinationDescription) -> dict:
    ...
    if "extended_s3_destination_description" in value:
        ...
        out["ExtendedS3DestinationDescription"] = (
            aws_sdk_firehose.types.extended_s3_destination_description.serialize_aws_json_1_1(
    ...
    if "redshift_destination_description" in value:
        ...
        out["RedshiftDestinationDescription"] = (
            aws_sdk_firehose.types.redshift_destination_description.serialize_aws_json_1_1(
    ...
    if "elasticsearch_destination_description" in value:
        ...
        out["ElasticsearchDestinationDescription"] = (
            aws_sdk_firehose.types.elasticsearch_destination_description.serialize_aws_json_1_1(
    ...
    if "amazonopensearchservice_destination_description" in value:
        ...
        out["AmazonopensearchserviceDestinationDescription"] = (
            aws_sdk_firehose.types.amazonopensearchservice_destination_description.serialize_aws_json_1_1(
    ...
    if "splunk_destination_description" in value:
        ...
        out["SplunkDestinationDescription"] = (
            aws_sdk_firehose.types.splunk_destination_description.serialize_aws_json_1_1(
    ...
    if "http_endpoint_destination_description" in value:
        ...
        out["HttpEndpointDestinationDescription"] = (
            aws_sdk_firehose.types.http_endpoint_destination_description.serialize_aws_json_1_1(
    ...
    if "snowflake_destination_description" in value:
        ...
        out["SnowflakeDestinationDescription"] = (
            aws_sdk_firehose.types.snowflake_destination_description.serialize_aws_json_1_1(
    ...
    if "amazon_open_search_serverless_destination_description" in value:
        ...
        out["AmazonOpenSearchServerlessDestinationDescription"] = (
            aws_sdk_firehose.types.amazon_open_search_serverless_destination_description.serialize_aws_json_1_1(
    ...
    if "iceberg_destination_description" in value:
        ...
        out["IcebergDestinationDescription"] = (
            aws_sdk_firehose.types.iceberg_destination_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DestinationDescription:
    ...
    if "ExtendedS3DestinationDescription" in data:
        ...
        out["extended_s3_destination_description"] = (
            aws_sdk_firehose.types.extended_s3_destination_description.deserialize_aws_json_1_1(
    ...
    if "RedshiftDestinationDescription" in data:
        ...
        out["redshift_destination_description"] = (
            aws_sdk_firehose.types.redshift_destination_description.deserialize_aws_json_1_1(
    ...
    if "ElasticsearchDestinationDescription" in data:
        ...
        out["elasticsearch_destination_description"] = (
            aws_sdk_firehose.types.elasticsearch_destination_description.deserialize_aws_json_1_1(
    ...
    if "AmazonopensearchserviceDestinationDescription" in data:
        ...
        out["amazonopensearchservice_destination_description"] = (
            aws_sdk_firehose.types.amazonopensearchservice_destination_description.deserialize_aws_json_1_1(
    ...
    if "SplunkDestinationDescription" in data:
        ...
        out["splunk_destination_description"] = (
            aws_sdk_firehose.types.splunk_destination_description.deserialize_aws_json_1_1(
    ...
    if "HttpEndpointDestinationDescription" in data:
        ...
        out["http_endpoint_destination_description"] = (
            aws_sdk_firehose.types.http_endpoint_destination_description.deserialize_aws_json_1_1(
    ...
    if "SnowflakeDestinationDescription" in data:
        ...
        out["snowflake_destination_description"] = (
            aws_sdk_firehose.types.snowflake_destination_description.deserialize_aws_json_1_1(
    ...
    if "AmazonOpenSearchServerlessDestinationDescription" in data:
        ...
        out["amazon_open_search_serverless_destination_description"] = (
            aws_sdk_firehose.types.amazon_open_search_serverless_destination_description.deserialize_aws_json_1_1(
    ...
    if "IcebergDestinationDescription" in data:
        ...
        out["iceberg_destination_description"] = (
            aws_sdk_firehose.types.iceberg_destination_description.deserialize_aws_json_1_1(
