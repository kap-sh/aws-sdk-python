...
if TYPE_CHECKING:
    ...
    import aws_sdk_firehose.types.input_format_configuration
    import aws_sdk_firehose.types.output_format_configuration
    import aws_sdk_firehose.types.schema_configuration


class DataFormatConversionConfiguration(TypedDict):
    schema_configuration: NotRequired[
        "aws_sdk_firehose.types.schema_configuration.SchemaConfiguration"
    ]
    ...
    input_format_configuration: NotRequired[
        "aws_sdk_firehose.types.input_format_configuration.InputFormatConfiguration"
    ]
    ...
    output_format_configuration: NotRequired[
        "aws_sdk_firehose.types.output_format_configuration.OutputFormatConfiguration"
    ]
...
def serialize_aws_json_1_1(value: DataFormatConversionConfiguration) -> dict:
    ...
    if "schema_configuration" in value:
        ...
        out["SchemaConfiguration"] = (
            aws_sdk_firehose.types.schema_configuration.serialize_aws_json_1_1(
    ...
    if "input_format_configuration" in value:
        ...
        out["InputFormatConfiguration"] = (
            aws_sdk_firehose.types.input_format_configuration.serialize_aws_json_1_1(
    ...
    if "output_format_configuration" in value:
        ...
        out["OutputFormatConfiguration"] = (
            aws_sdk_firehose.types.output_format_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DataFormatConversionConfiguration:
    ...
    if "SchemaConfiguration" in data:
        ...
        out["schema_configuration"] = (
            aws_sdk_firehose.types.schema_configuration.deserialize_aws_json_1_1(
    ...
    if "InputFormatConfiguration" in data:
        ...
        out["input_format_configuration"] = (
            aws_sdk_firehose.types.input_format_configuration.deserialize_aws_json_1_1(
    ...
    if "OutputFormatConfiguration" in data:
        ...
        out["output_format_configuration"] = (
            aws_sdk_firehose.types.output_format_configuration.deserialize_aws_json_1_1(
