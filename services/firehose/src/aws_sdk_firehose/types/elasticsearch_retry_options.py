...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ElasticsearchRetryOptions) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ElasticsearchRetryOptions:
    out: ElasticsearchRetryOptions = {}  # type: ignore[typeddict-item]
