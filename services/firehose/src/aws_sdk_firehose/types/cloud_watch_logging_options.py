...
if TYPE_CHECKING:
    ...
    import aws_sdk_firehose.types.log_group_name
    import aws_sdk_firehose.types.log_stream_name
...
class CloudWatchLoggingOptions(TypedDict, closed=True):
    ...
    log_group_name: NotRequired["aws_sdk_firehose.types.log_group_name.LogGroupName"]
    """<p>The CloudWatch group name for logging. This value is required if CloudWatch logging is enabled.</p>"""
    log_stream_name: NotRequired["aws_sdk_firehose.types.log_stream_name.LogStreamName"]
