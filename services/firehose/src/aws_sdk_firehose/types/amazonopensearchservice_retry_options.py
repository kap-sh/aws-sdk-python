...
if TYPE_CHECKING:
    import aws_sdk_firehose.types.amazonopensearchservice_retry_duration_in_seconds


class AmazonopensearchserviceRetryOptions(TypedDict, closed=True):
    duration_in_seconds: NotRequired[
        "aws_sdk_firehose.types.amazonopensearchservice_retry_duration_in_seconds.AmazonopensearchserviceRetryDurationInSeconds"
    ]
