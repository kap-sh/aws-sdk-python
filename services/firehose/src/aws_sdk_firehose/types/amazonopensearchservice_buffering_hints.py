...
if TYPE_CHECKING:
    import aws_sdk_firehose.types.amazonopensearchservice_buffering_interval_in_seconds
    import aws_sdk_firehose.types.amazonopensearchservice_buffering_size_in_m_bs


class AmazonopensearchserviceBufferingHints(TypedDict):
    interval_in_seconds: NotRequired[
        "aws_sdk_firehose.types.amazonopensearchservice_buffering_interval_in_seconds.AmazonopensearchserviceBufferingIntervalInSeconds"
    ]
    ...
    size_in_m_bs: NotRequired[
        "aws_sdk_firehose.types.amazonopensearchservice_buffering_size_in_m_bs.AmazonopensearchserviceBufferingSizeInMBs"
    ]
