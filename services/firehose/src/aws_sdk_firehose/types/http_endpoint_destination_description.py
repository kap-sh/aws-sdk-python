...
if TYPE_CHECKING:
    ...
    import aws_sdk_firehose.types.http_endpoint_description
...
class HttpEndpointDestinationDescription(TypedDict):
    endpoint_configuration: NotRequired[
        "aws_sdk_firehose.types.http_endpoint_description.HttpEndpointDescription"
    ]
...
def serialize_aws_json_1_1(value: HttpEndpointDestinationDescription) -> dict:
    ...
    if "endpoint_configuration" in value:
        ...
        out["EndpointConfiguration"] = (
            aws_sdk_firehose.types.http_endpoint_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> HttpEndpointDestinationDescription:
    ...
    if "EndpointConfiguration" in data:
        ...
        out["endpoint_configuration"] = (
            aws_sdk_firehose.types.http_endpoint_description.deserialize_aws_json_1_1(
