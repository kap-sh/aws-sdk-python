...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: SplunkDestinationUpdate) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> SplunkDestinationUpdate:
    out: SplunkDestinationUpdate = {}  # type: ignore[typeddict-item]
