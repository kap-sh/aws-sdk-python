...
import aws_sdk_firehose.errors.invalid_source_exception
import aws_sdk_firehose.errors.resource_not_found_exception
import aws_sdk_firehose.errors.service_unavailable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidSourceException":
            raise aws_sdk_firehose.errors.invalid_source_exception.InvalidSourceException.from_aws_json_1_1(
                data
            )
        ...
        case "ServiceUnavailableException":
            raise aws_sdk_firehose.errors.service_unavailable_exception.ServiceUnavailableException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_firehose.types.put_record_batch_output.PutRecordBatchOutput = (
        aws_sdk_firehose.types.put_record_batch_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_firehose.types.put_record_batch_input.PutRecordBatchInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.put_record_batch_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_record_batch(
    ...
    aws_sdk_firehose.types.put_record_batch_output.PutRecordBatchOutput, zapros.Response
]:
