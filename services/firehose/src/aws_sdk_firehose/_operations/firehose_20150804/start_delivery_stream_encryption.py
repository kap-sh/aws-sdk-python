...
def handle_response(
    ...
    out: aws_sdk_firehose.types.start_delivery_stream_encryption_output.StartDeliveryStreamEncryptionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_firehose.types.start_delivery_stream_encryption_input.StartDeliveryStreamEncryptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
