...
def build_request(
    ...
    input_: aws_sdk_firehose.types.list_delivery_streams_input.ListDeliveryStreamsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.list_delivery_streams_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
