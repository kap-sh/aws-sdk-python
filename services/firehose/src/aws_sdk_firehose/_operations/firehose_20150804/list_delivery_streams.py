...
def handle_response(
    ...
    out: aws_sdk_firehose.types.list_delivery_streams_output.ListDeliveryStreamsOutput = aws_sdk_firehose.types.list_delivery_streams_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_firehose.types.list_delivery_streams_input.ListDeliveryStreamsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.list_delivery_streams_input.serialize_aws_json_1_1(input)
    ).encode()
