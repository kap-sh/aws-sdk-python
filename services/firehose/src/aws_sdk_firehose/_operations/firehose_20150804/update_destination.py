...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentModificationException":
            import aws_sdk_firehose.errors.concurrent_modification_exception

            raise aws_sdk_firehose.errors.concurrent_modification_exception.ConcurrentModificationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_firehose.types.update_destination_output.UpdateDestinationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_firehose.types.update_destination_input.UpdateDestinationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.update_destination_input.serialize_aws_json_1_1(input_)
    ).encode()
