...
def build_request(
    ...
    input: aws_sdk_firehose.types.update_destination_input.UpdateDestinationInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.update_destination_input.serialize_aws_json_1_1(input)
    ).encode()
