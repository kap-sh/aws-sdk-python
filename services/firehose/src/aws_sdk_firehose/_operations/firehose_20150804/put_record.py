...
def handle_response(
    ...
    out: aws_sdk_firehose.types.put_record_output.PutRecordOutput = (
        aws_sdk_firehose.types.put_record_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_firehose.types.put_record_input.PutRecordInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.put_record_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_record(
    ...
    input_: aws_sdk_firehose.types.put_record_input.PutRecordInput,
) -> tuple[aws_sdk_firehose.types.put_record_output.PutRecordOutput, zapros.Response]:
