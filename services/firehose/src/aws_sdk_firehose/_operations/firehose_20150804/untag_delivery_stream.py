...
def build_request(
    ...
    input_: aws_sdk_firehose.types.untag_delivery_stream_input.UntagDeliveryStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.untag_delivery_stream_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
