...
def handle_response(
    ...
    out: aws_sdk_firehose.types.untag_delivery_stream_output.UntagDeliveryStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_firehose.types.untag_delivery_stream_input.UntagDeliveryStreamInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.untag_delivery_stream_input.serialize_aws_json_1_1(input)
    ).encode()
