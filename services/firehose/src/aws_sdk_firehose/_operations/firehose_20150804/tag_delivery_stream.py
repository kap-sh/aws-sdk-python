...
def handle_response(
    ...
    out: aws_sdk_firehose.types.tag_delivery_stream_output.TagDeliveryStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_firehose.types.tag_delivery_stream_input.TagDeliveryStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.tag_delivery_stream_input.serialize_aws_json_1_1(input_)
    ).encode()
