...
def build_request(
    ...
    input: aws_sdk_firehose.types.tag_delivery_stream_input.TagDeliveryStreamInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.tag_delivery_stream_input.serialize_aws_json_1_1(input)
    ).encode()
