...
def handle_response(
    ...
    out: aws_sdk_firehose.types.list_tags_for_delivery_stream_output.ListTagsForDeliveryStreamOutput = aws_sdk_firehose.types.list_tags_for_delivery_stream_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_firehose.types.list_tags_for_delivery_stream_input.ListTagsForDeliveryStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.list_tags_for_delivery_stream_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
