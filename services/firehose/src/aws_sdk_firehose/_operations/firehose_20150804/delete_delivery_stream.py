"""Generated from Smithy shape ``com.amazonaws.firehose#DeleteDeliveryStream``."""
...
def handle_response(
    ...
    out: aws_sdk_firehose.types.delete_delivery_stream_output.DeleteDeliveryStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_firehose.types.delete_delivery_stream_input.DeleteDeliveryStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_firehose.types.delete_delivery_stream_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_delivery_stream(
