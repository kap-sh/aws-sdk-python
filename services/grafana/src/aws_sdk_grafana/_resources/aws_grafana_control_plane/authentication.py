...
class Authentication:
    ...
    def read(self, workspace_id: "aws_sdk_grafana.types.workspace_id.WorkspaceId", *, config_overrides: Optional[grafanaClientConfig] = None) -> "aws_sdk_grafana.types.describe_workspace_authentication_response.DescribeWorkspaceAuthenticationResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_grafana.types.describe_workspace_authentication_request.DescribeWorkspaceAuthenticationRequest]') -> OperationResponse["aws_sdk_grafana.types.describe_workspace_authentication_response.DescribeWorkspaceAuthenticationResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.describe_workspace_authentication
            output, http_response = aws_sdk_grafana._operations.aws_grafana_control_plane.describe_workspace_authentication.describe_workspace_authentication(req.options, req.input)
    ...
    def update(self, workspace_id: "aws_sdk_grafana.types.workspace_id.WorkspaceId", authentication_providers: "aws_sdk_grafana.types.authentication_providers.AuthenticationProviders", *, config_overrides: Optional[grafanaClientConfig] = None, saml_configuration: Optional["aws_sdk_grafana.types.saml_configuration.SamlConfiguration"] = None) -> "aws_sdk_grafana.types.update_workspace_authentication_response.UpdateWorkspaceAuthenticationResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_grafana.types.update_workspace_authentication_request.UpdateWorkspaceAuthenticationRequest]') -> OperationResponse["aws_sdk_grafana.types.update_workspace_authentication_response.UpdateWorkspaceAuthenticationResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.update_workspace_authentication
            output, http_response = aws_sdk_grafana._operations.aws_grafana_control_plane.update_workspace_authentication.update_workspace_authentication(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
...
class AsyncAuthentication:
    def __init__(self, service: AsyncgrafanaClient) -> None:
        self._service = service
    async def read(self, workspace_id: "aws_sdk_grafana.types.workspace_id.WorkspaceId", *, config_overrides: Optional[AsyncgrafanaClientConfig] = None) -> "aws_sdk_grafana.types.describe_workspace_authentication_response.DescribeWorkspaceAuthenticationResponse":
        """<p>Displays information about the authentication methods used in one Amazon Managed Grafana workspace.</p>

        Args:
            workspace_id: <p>The ID of the workspace to return authentication information about.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_grafana.types.describe_workspace_authentication_request.DescribeWorkspaceAuthenticationRequest]') -> AsyncOperationResponse["aws_sdk_grafana.types.describe_workspace_authentication_response.DescribeWorkspaceAuthenticationResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.describe_workspace_authentication
            output, http_response = await aws_sdk_grafana._operations.aws_grafana_control_plane.describe_workspace_authentication.async_describe_workspace_authentication(req.options, req.input)
    ...
    async def update(self, workspace_id: "aws_sdk_grafana.types.workspace_id.WorkspaceId", authentication_providers: "aws_sdk_grafana.types.authentication_providers.AuthenticationProviders", *, config_overrides: Optional[AsyncgrafanaClientConfig] = None, saml_configuration: Optional["aws_sdk_grafana.types.saml_configuration.SamlConfiguration"] = None) -> "aws_sdk_grafana.types.update_workspace_authentication_response.UpdateWorkspaceAuthenticationResponse":
        ...
        Args:
            ...
            saml_configuration: <p>If the workspace uses SAML, use this structure to map SAML assertion attributes to workspace user information and define which groups in the assertion attribute are to have the <code>Admin</code> and <code>Editor</code> roles in the workspace.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_grafana.types.update_workspace_authentication_request.UpdateWorkspaceAuthenticationRequest]') -> AsyncOperationResponse["aws_sdk_grafana.types.update_workspace_authentication_response.UpdateWorkspaceAuthenticationResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.update_workspace_authentication
            output, http_response = await aws_sdk_grafana._operations.aws_grafana_control_plane.update_workspace_authentication.async_update_workspace_authentication(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
