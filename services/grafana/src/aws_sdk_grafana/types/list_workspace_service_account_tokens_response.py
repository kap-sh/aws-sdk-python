...
class ListWorkspaceServiceAccountTokensResponse(TypedDict):
    ...
    service_account_tokens: "aws_sdk_grafana.types.service_account_token_list.ServiceAccountTokenList"
...
def serialize_json(value: ListWorkspaceServiceAccountTokensResponse) -> dict:
    ...
    import aws_sdk_grafana.types.service_account_token_list
    out["serviceAccountTokens"] = aws_sdk_grafana.types.service_account_token_list.serialize_json(value["service_account_tokens"])
...
def deserialize_json(data: dict) -> ListWorkspaceServiceAccountTokensResponse:
    ...
    if "serviceAccountTokens" in data:
        import aws_sdk_grafana.types.service_account_token_list
        out["service_account_tokens"] = aws_sdk_grafana.types.service_account_token_list.deserialize_json(data["serviceAccountTokens"])
    else:
        raise DeserializationError("ListWorkspaceServiceAccountTokensResponse.service_account_tokens required")
    if "serviceAccountId" in data:
        out["service_account_id"] = data["serviceAccountId"]
    else:
        raise DeserializationError("ListWorkspaceServiceAccountTokensResponse.service_account_id required")
    if "workspaceId" in data:
        out["workspace_id"] = data["workspaceId"]
    else:
        raise DeserializationError("ListWorkspaceServiceAccountTokensResponse.workspace_id required")
    return out