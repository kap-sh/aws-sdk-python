...
def serialize_json(value: ListPermissionsResponse) -> dict:
    ...
    import aws_sdk_grafana.types.permission_entry_list
    out["permissions"] = aws_sdk_grafana.types.permission_entry_list.serialize_json(value["permissions"])
    return out
...
def deserialize_json(data: dict) -> ListPermissionsResponse:
    ...
    if "permissions" in data:
        import aws_sdk_grafana.types.permission_entry_list
        out["permissions"] = aws_sdk_grafana.types.permission_entry_list.deserialize_json(data["permissions"])
    else:
