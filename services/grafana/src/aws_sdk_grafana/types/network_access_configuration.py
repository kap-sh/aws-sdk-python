...
def serialize_json(value: NetworkAccessConfiguration) -> dict:
    ...
    out["prefixListIds"] = aws_sdk_grafana.types.prefix_list_ids.serialize_json(
...
def deserialize_json(data: dict) -> NetworkAccessConfiguration:
    ...
    if "prefixListIds" in data:
        ...
        out["prefix_list_ids"] = aws_sdk_grafana.types.prefix_list_ids.deserialize_json(
            data["prefixListIds"]
        )
    else:
    ...
    if "vpceIds" in data:
        ...
        out["vpce_ids"] = aws_sdk_grafana.types.vpce_ids.deserialize_json(
            data["vpceIds"]
        )
    else:
