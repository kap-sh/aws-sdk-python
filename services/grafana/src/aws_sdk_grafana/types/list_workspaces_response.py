...
def serialize_json(value: ListWorkspacesResponse) -> dict:
    out: dict = {}
    import aws_sdk_grafana.types.workspace_list
    out["workspaces"] = aws_sdk_grafana.types.workspace_list.serialize_json(value["workspaces"])
...
def deserialize_json(data: dict) -> ListWorkspacesResponse:
    ...
    if "workspaces" in data:
        import aws_sdk_grafana.types.workspace_list
        out["workspaces"] = aws_sdk_grafana.types.workspace_list.deserialize_json(data["workspaces"])
    else:
