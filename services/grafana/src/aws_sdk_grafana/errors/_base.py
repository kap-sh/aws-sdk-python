...
class grafanaError(Exception):
    """Base class for all grafana service errors."""

class ServiceError(grafanaError):
...
class SerializationError(grafanaError):
    """Raised when a value cannot be serialized."""

class DeserializationError(grafanaError):
...
class WaiterFailedError(grafanaError):
...
class WaiterTimeoutError(grafanaError):
