...
from aws_sdk_grafana._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_grafana._async import anysleep
import time
...
class AsyncgrafanaClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_dual_stack: bool | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncgrafanaClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_dual_stack": use_dual_stack, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncgrafanaClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
    ...
    async def list_tags_for_resource(self, resource_arn: str, *, config_overrides: Optional[AsyncgrafanaClientConfig] = None) -> "aws_sdk_grafana.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_grafana.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> AsyncOperationResponse["aws_sdk_grafana.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.list_tags_for_resource
            output, http_response = await aws_sdk_grafana._operations.aws_grafana_control_plane.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
    ...
    async def list_versions(self, *, config_overrides: Optional[AsyncgrafanaClientConfig] = None, max_results: Optional[int] = None, next_token: Optional["aws_sdk_grafana.types.pagination_token.PaginationToken"] = None, workspace_id: Optional["aws_sdk_grafana.types.workspace_id.WorkspaceId"] = None) -> "aws_sdk_grafana.types.list_versions_response.ListVersionsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_grafana.types.list_versions_request.ListVersionsRequest]') -> AsyncOperationResponse["aws_sdk_grafana.types.list_versions_response.ListVersionsResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.list_versions
            output, http_response = await aws_sdk_grafana._operations.aws_grafana_control_plane.list_versions.async_list_versions(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_versions(self, *, config_overrides: Optional[AsyncgrafanaClientConfig] = None, max_results: Optional[int] = None, next_token: Optional["aws_sdk_grafana.types.pagination_token.PaginationToken"] = None, workspace_id: Optional["aws_sdk_grafana.types.workspace_id.WorkspaceId"] = None) -> "AsyncIterator[aws_sdk_grafana.types.grafana_version.GrafanaVersion]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def tag_resource(self, resource_arn: str, tags: "aws_sdk_grafana.types.tag_map.TagMap", *, config_overrides: Optional[AsyncgrafanaClientConfig] = None) -> "aws_sdk_grafana.types.tag_resource_response.TagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_grafana.types.tag_resource_request.TagResourceRequest]') -> AsyncOperationResponse["aws_sdk_grafana.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.tag_resource
            output, http_response = await aws_sdk_grafana._operations.aws_grafana_control_plane.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: str, tag_keys: "aws_sdk_grafana.types.tag_keys.TagKeys", *, config_overrides: Optional[AsyncgrafanaClientConfig] = None) -> "aws_sdk_grafana.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_grafana.types.untag_resource_request.UntagResourceRequest]') -> AsyncOperationResponse["aws_sdk_grafana.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.untag_resource
            output, http_response = await aws_sdk_grafana._operations.aws_grafana_control_plane.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
