...
from aws_sdk_grafana._auth._signers import SigV4Signer
from aws_sdk_grafana._auth._sigv4 import presign_sigv4
...
from aws_sdk_grafana._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
from aws_sdk_grafana.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
...
from aws_sdk_grafana._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
if TYPE_CHECKING:
...
class grafanaClient:
    ...
    def list_tags_for_resource(self, resource_arn: str, *, config_overrides: Optional[grafanaClientConfig] = None) -> "aws_sdk_grafana.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_grafana.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> OperationResponse["aws_sdk_grafana.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.list_tags_for_resource
            output, http_response = aws_sdk_grafana._operations.aws_grafana_control_plane.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
    ...
    def list_versions(self, *, config_overrides: Optional[grafanaClientConfig] = None, max_results: Optional[int] = None, next_token: Optional["aws_sdk_grafana.types.pagination_token.PaginationToken"] = None, workspace_id: Optional["aws_sdk_grafana.types.workspace_id.WorkspaceId"] = None) -> "aws_sdk_grafana.types.list_versions_response.ListVersionsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_grafana.types.list_versions_request.ListVersionsRequest]') -> OperationResponse["aws_sdk_grafana.types.list_versions_response.ListVersionsResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.list_versions
            output, http_response = aws_sdk_grafana._operations.aws_grafana_control_plane.list_versions.list_versions(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_versions(self, *, config_overrides: Optional[grafanaClientConfig] = None, max_results: Optional[int] = None, next_token: Optional["aws_sdk_grafana.types.pagination_token.PaginationToken"] = None, workspace_id: Optional["aws_sdk_grafana.types.workspace_id.WorkspaceId"] = None) -> "Iterator[aws_sdk_grafana.types.grafana_version.GrafanaVersion]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def tag_resource(self, resource_arn: str, tags: "aws_sdk_grafana.types.tag_map.TagMap", *, config_overrides: Optional[grafanaClientConfig] = None) -> "aws_sdk_grafana.types.tag_resource_response.TagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_grafana.types.tag_resource_request.TagResourceRequest]') -> OperationResponse["aws_sdk_grafana.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.tag_resource
            output, http_response = aws_sdk_grafana._operations.aws_grafana_control_plane.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: str, tag_keys: "aws_sdk_grafana.types.tag_keys.TagKeys", *, config_overrides: Optional[grafanaClientConfig] = None) -> "aws_sdk_grafana.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_grafana.types.untag_resource_request.UntagResourceRequest]') -> OperationResponse["aws_sdk_grafana.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_grafana._operations.aws_grafana_control_plane.untag_resource
            output, http_response = aws_sdk_grafana._operations.aws_grafana_control_plane.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
