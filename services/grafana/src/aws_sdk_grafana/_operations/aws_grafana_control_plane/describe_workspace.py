...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.describe_workspace_response.DescribeWorkspaceResponse:
    import aws_sdk_grafana.types.describe_workspace_response
    out: aws_sdk_grafana.types.describe_workspace_response.DescribeWorkspaceResponse = aws_sdk_grafana.types.describe_workspace_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.describe_workspace_request.DescribeWorkspaceRequest) -> zapros.Request:
...
def describe_workspace(options: OperationOptions, input: aws_sdk_grafana.types.describe_workspace_request.DescribeWorkspaceRequest) -> tuple[aws_sdk_grafana.types.describe_workspace_response.DescribeWorkspaceResponse, zapros.Response]:
...
async def async_describe_workspace(options: AsyncOperationOptions, input: aws_sdk_grafana.types.describe_workspace_request.DescribeWorkspaceRequest) -> tuple[aws_sdk_grafana.types.describe_workspace_response.DescribeWorkspaceResponse, zapros.Response]:
