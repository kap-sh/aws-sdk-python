...
def handle_response(
    ...
    out: aws_sdk_grafana.types.delete_workspace_api_key_response.DeleteWorkspaceApiKeyResponse = aws_sdk_grafana.types.delete_workspace_api_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.delete_workspace_api_key_request.DeleteWorkspaceApiKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{keyName}", quote(str(input_["key_name"]), safe=""))
...
async def async_delete_workspace_api_key(
