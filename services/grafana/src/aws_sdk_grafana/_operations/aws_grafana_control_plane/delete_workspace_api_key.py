"""Generated from Smithy shape ``com.amazonaws.grafana#DeleteWorkspaceApiKey``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.delete_workspace_api_key_response.DeleteWorkspaceApiKeyResponse:
    import aws_sdk_grafana.types.delete_workspace_api_key_response
    out: aws_sdk_grafana.types.delete_workspace_api_key_response.DeleteWorkspaceApiKeyResponse = aws_sdk_grafana.types.delete_workspace_api_key_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.delete_workspace_api_key_request.DeleteWorkspaceApiKeyRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/apikeys/{keyName}"
    url = url.replace("{keyName}", quote(str(input["key_name"]), safe=""))
...
def delete_workspace_api_key(options: OperationOptions, input: aws_sdk_grafana.types.delete_workspace_api_key_request.DeleteWorkspaceApiKeyRequest) -> tuple[aws_sdk_grafana.types.delete_workspace_api_key_response.DeleteWorkspaceApiKeyResponse, zapros.Response]:
...
async def async_delete_workspace_api_key(options: AsyncOperationOptions, input: aws_sdk_grafana.types.delete_workspace_api_key_request.DeleteWorkspaceApiKeyRequest) -> tuple[aws_sdk_grafana.types.delete_workspace_api_key_response.DeleteWorkspaceApiKeyResponse, zapros.Response]:
