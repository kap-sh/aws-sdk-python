...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.create_workspace_response.CreateWorkspaceResponse:
    import aws_sdk_grafana.types.create_workspace_response
    out: aws_sdk_grafana.types.create_workspace_response.CreateWorkspaceResponse = aws_sdk_grafana.types.create_workspace_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.create_workspace_request.CreateWorkspaceRequest) -> zapros.Request:
    ...
    import aws_sdk_grafana.types.create_workspace_request
    body: bytes | None = json.dumps(aws_sdk_grafana.types.create_workspace_request.serialize_json(input)).encode()
...
def create_workspace(options: OperationOptions, input: aws_sdk_grafana.types.create_workspace_request.CreateWorkspaceRequest) -> tuple[aws_sdk_grafana.types.create_workspace_response.CreateWorkspaceResponse, zapros.Response]:
...
async def async_create_workspace(options: AsyncOperationOptions, input: aws_sdk_grafana.types.create_workspace_request.CreateWorkspaceRequest) -> tuple[aws_sdk_grafana.types.create_workspace_response.CreateWorkspaceResponse, zapros.Response]:
