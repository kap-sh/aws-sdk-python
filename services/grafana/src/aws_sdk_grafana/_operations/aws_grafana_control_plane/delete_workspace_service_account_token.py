"""Generated from Smithy shape ``com.amazonaws.grafana#DeleteWorkspaceServiceAccountToken``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.delete_workspace_service_account_token_response.DeleteWorkspaceServiceAccountTokenResponse:
    import aws_sdk_grafana.types.delete_workspace_service_account_token_response
    out: aws_sdk_grafana.types.delete_workspace_service_account_token_response.DeleteWorkspaceServiceAccountTokenResponse = aws_sdk_grafana.types.delete_workspace_service_account_token_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.delete_workspace_service_account_token_request.DeleteWorkspaceServiceAccountTokenRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/serviceaccounts/{serviceAccountId}/tokens/{tokenId}"
    url = url.replace("{tokenId}", quote(str(input["token_id"]), safe=""))
...
def delete_workspace_service_account_token(options: OperationOptions, input: aws_sdk_grafana.types.delete_workspace_service_account_token_request.DeleteWorkspaceServiceAccountTokenRequest) -> tuple[aws_sdk_grafana.types.delete_workspace_service_account_token_response.DeleteWorkspaceServiceAccountTokenResponse, zapros.Response]:
...
async def async_delete_workspace_service_account_token(options: AsyncOperationOptions, input: aws_sdk_grafana.types.delete_workspace_service_account_token_request.DeleteWorkspaceServiceAccountTokenRequest) -> tuple[aws_sdk_grafana.types.delete_workspace_service_account_token_response.DeleteWorkspaceServiceAccountTokenResponse, zapros.Response]:
