...
def handle_response(
    ...
    out: aws_sdk_grafana.types.delete_workspace_service_account_token_response.DeleteWorkspaceServiceAccountTokenResponse = aws_sdk_grafana.types.delete_workspace_service_account_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.delete_workspace_service_account_token_request.DeleteWorkspaceServiceAccountTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{tokenId}", quote(str(input_["token_id"]), safe=""))
    url = url.replace(
...
async def async_delete_workspace_service_account_token(
