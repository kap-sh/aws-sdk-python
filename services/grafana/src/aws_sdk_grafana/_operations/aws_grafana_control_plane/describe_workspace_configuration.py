"""Generated from Smithy shape ``com.amazonaws.grafana#DescribeWorkspaceConfiguration``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.describe_workspace_configuration_response.DescribeWorkspaceConfigurationResponse:
    import aws_sdk_grafana.types.describe_workspace_configuration_response
    out: aws_sdk_grafana.types.describe_workspace_configuration_response.DescribeWorkspaceConfigurationResponse = aws_sdk_grafana.types.describe_workspace_configuration_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.describe_workspace_configuration_request.DescribeWorkspaceConfigurationRequest) -> zapros.Request:
...
def describe_workspace_configuration(options: OperationOptions, input: aws_sdk_grafana.types.describe_workspace_configuration_request.DescribeWorkspaceConfigurationRequest) -> tuple[aws_sdk_grafana.types.describe_workspace_configuration_response.DescribeWorkspaceConfigurationResponse, zapros.Response]:
...
async def async_describe_workspace_configuration(options: AsyncOperationOptions, input: aws_sdk_grafana.types.describe_workspace_configuration_request.DescribeWorkspaceConfigurationRequest) -> tuple[aws_sdk_grafana.types.describe_workspace_configuration_response.DescribeWorkspaceConfigurationResponse, zapros.Response]:
