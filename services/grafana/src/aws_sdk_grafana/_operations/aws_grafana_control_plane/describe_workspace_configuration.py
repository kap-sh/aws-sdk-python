...
def handle_response(
    ...
    out: aws_sdk_grafana.types.describe_workspace_configuration_response.DescribeWorkspaceConfigurationResponse = aws_sdk_grafana.types.describe_workspace_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.describe_workspace_configuration_request.DescribeWorkspaceConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
