...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.describe_workspace_authentication_response.DescribeWorkspaceAuthenticationResponse:
    import aws_sdk_grafana.types.describe_workspace_authentication_response
    out: aws_sdk_grafana.types.describe_workspace_authentication_response.DescribeWorkspaceAuthenticationResponse = aws_sdk_grafana.types.describe_workspace_authentication_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.describe_workspace_authentication_request.DescribeWorkspaceAuthenticationRequest) -> zapros.Request:
...
def describe_workspace_authentication(options: OperationOptions, input: aws_sdk_grafana.types.describe_workspace_authentication_request.DescribeWorkspaceAuthenticationRequest) -> tuple[aws_sdk_grafana.types.describe_workspace_authentication_response.DescribeWorkspaceAuthenticationResponse, zapros.Response]:
...
async def async_describe_workspace_authentication(options: AsyncOperationOptions, input: aws_sdk_grafana.types.describe_workspace_authentication_request.DescribeWorkspaceAuthenticationRequest) -> tuple[aws_sdk_grafana.types.describe_workspace_authentication_response.DescribeWorkspaceAuthenticationResponse, zapros.Response]:
