...
def handle_response(
    ...
    out: aws_sdk_grafana.types.describe_workspace_authentication_response.DescribeWorkspaceAuthenticationResponse = aws_sdk_grafana.types.describe_workspace_authentication_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.describe_workspace_authentication_request.DescribeWorkspaceAuthenticationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
