...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.list_tags_for_resource_response.ListTagsForResourceResponse:
    import aws_sdk_grafana.types.list_tags_for_resource_response
    out: aws_sdk_grafana.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_grafana.types.list_tags_for_resource_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.list_tags_for_resource_request.ListTagsForResourceRequest) -> zapros.Request:
...
def list_tags_for_resource(options: OperationOptions, input: aws_sdk_grafana.types.list_tags_for_resource_request.ListTagsForResourceRequest) -> tuple[aws_sdk_grafana.types.list_tags_for_resource_response.ListTagsForResourceResponse, zapros.Response]:
...
async def async_list_tags_for_resource(options: AsyncOperationOptions, input: aws_sdk_grafana.types.list_tags_for_resource_request.ListTagsForResourceRequest) -> tuple[aws_sdk_grafana.types.list_tags_for_resource_response.ListTagsForResourceResponse, zapros.Response]:
