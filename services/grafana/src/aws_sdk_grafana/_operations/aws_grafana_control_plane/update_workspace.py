"""Generated from Smithy shape ``com.amazonaws.grafana#UpdateWorkspace``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.update_workspace_response.UpdateWorkspaceResponse:
    import aws_sdk_grafana.types.update_workspace_response
    out: aws_sdk_grafana.types.update_workspace_response.UpdateWorkspaceResponse = aws_sdk_grafana.types.update_workspace_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.update_workspace_request.UpdateWorkspaceRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}"
    url = url.replace("{workspaceId}", quote(str(input["workspace_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_grafana.types.update_workspace_request
    body: bytes | None = json.dumps(aws_sdk_grafana.types.update_workspace_request.serialize_json(input)).encode()
...
def update_workspace(options: OperationOptions, input: aws_sdk_grafana.types.update_workspace_request.UpdateWorkspaceRequest) -> tuple[aws_sdk_grafana.types.update_workspace_response.UpdateWorkspaceResponse, zapros.Response]:
...
async def async_update_workspace(options: AsyncOperationOptions, input: aws_sdk_grafana.types.update_workspace_request.UpdateWorkspaceRequest) -> tuple[aws_sdk_grafana.types.update_workspace_response.UpdateWorkspaceResponse, zapros.Response]:
