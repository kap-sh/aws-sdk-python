...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.list_workspace_service_account_tokens_response.ListWorkspaceServiceAccountTokensResponse:
    import aws_sdk_grafana.types.list_workspace_service_account_tokens_response
    out: aws_sdk_grafana.types.list_workspace_service_account_tokens_response.ListWorkspaceServiceAccountTokensResponse = aws_sdk_grafana.types.list_workspace_service_account_tokens_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.list_workspace_service_account_tokens_request.ListWorkspaceServiceAccountTokensRequest) -> zapros.Request:
...
def list_workspace_service_account_tokens(options: OperationOptions, input: aws_sdk_grafana.types.list_workspace_service_account_tokens_request.ListWorkspaceServiceAccountTokensRequest) -> tuple[aws_sdk_grafana.types.list_workspace_service_account_tokens_response.ListWorkspaceServiceAccountTokensResponse, zapros.Response]:
...
async def async_list_workspace_service_account_tokens(options: AsyncOperationOptions, input: aws_sdk_grafana.types.list_workspace_service_account_tokens_request.ListWorkspaceServiceAccountTokensRequest) -> tuple[aws_sdk_grafana.types.list_workspace_service_account_tokens_response.ListWorkspaceServiceAccountTokensResponse, zapros.Response]:
