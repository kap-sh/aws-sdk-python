...
def handle_response(
    ...
    out: aws_sdk_grafana.types.list_workspace_service_account_tokens_response.ListWorkspaceServiceAccountTokensResponse = aws_sdk_grafana.types.list_workspace_service_account_tokens_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.list_workspace_service_account_tokens_request.ListWorkspaceServiceAccountTokensRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
