...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.update_workspace_configuration_response.UpdateWorkspaceConfigurationResponse:
    out: aws_sdk_grafana.types.update_workspace_configuration_response.UpdateWorkspaceConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.update_workspace_configuration_request.UpdateWorkspaceConfigurationRequest) -> zapros.Request:
    ...
    import aws_sdk_grafana.types.update_workspace_configuration_request
    body: bytes | None = json.dumps(aws_sdk_grafana.types.update_workspace_configuration_request.serialize_json(input)).encode()
...
def update_workspace_configuration(options: OperationOptions, input: aws_sdk_grafana.types.update_workspace_configuration_request.UpdateWorkspaceConfigurationRequest) -> tuple[aws_sdk_grafana.types.update_workspace_configuration_response.UpdateWorkspaceConfigurationResponse, zapros.Response]:
...
async def async_update_workspace_configuration(options: AsyncOperationOptions, input: aws_sdk_grafana.types.update_workspace_configuration_request.UpdateWorkspaceConfigurationRequest) -> tuple[aws_sdk_grafana.types.update_workspace_configuration_response.UpdateWorkspaceConfigurationResponse, zapros.Response]:
