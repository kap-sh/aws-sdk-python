...
def build_request(
    ...
    input_: aws_sdk_grafana.types.update_workspace_configuration_request.UpdateWorkspaceConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_grafana.types.update_workspace_configuration_request.serialize_json(
            input_
        )
    ).encode()
