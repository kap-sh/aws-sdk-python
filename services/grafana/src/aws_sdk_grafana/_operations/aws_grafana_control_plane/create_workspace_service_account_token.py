...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            ...
            raise aws_sdk_grafana.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            ...
            raise aws_sdk_grafana.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_grafana.types.create_workspace_service_account_token_response.CreateWorkspaceServiceAccountTokenResponse = aws_sdk_grafana.types.create_workspace_service_account_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.create_workspace_service_account_token_request.CreateWorkspaceServiceAccountTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{serviceAccountId}", quote(str(input_["service_account_id"]), safe="")
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_grafana.types.create_workspace_service_account_token_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_workspace_service_account_token(
