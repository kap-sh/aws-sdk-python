"""Generated from Smithy shape ``com.amazonaws.grafana#CreateWorkspaceServiceAccountToken``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_grafana.errors.conflict_exception
            raise aws_sdk_grafana.errors.conflict_exception.ConflictException.from_json(data)
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_grafana.errors.service_quota_exceeded_exception
            raise aws_sdk_grafana.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.create_workspace_service_account_token_response.CreateWorkspaceServiceAccountTokenResponse:
    import aws_sdk_grafana.types.create_workspace_service_account_token_response
    out: aws_sdk_grafana.types.create_workspace_service_account_token_response.CreateWorkspaceServiceAccountTokenResponse = aws_sdk_grafana.types.create_workspace_service_account_token_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.create_workspace_service_account_token_request.CreateWorkspaceServiceAccountTokenRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/serviceaccounts/{serviceAccountId}/tokens"
    url = url.replace("{serviceAccountId}", quote(str(input["service_account_id"]), safe=""))
    url = url.replace("{workspaceId}", quote(str(input["workspace_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_grafana.types.create_workspace_service_account_token_request
    body: bytes | None = json.dumps(aws_sdk_grafana.types.create_workspace_service_account_token_request.serialize_json(input)).encode()
...
def create_workspace_service_account_token(options: OperationOptions, input: aws_sdk_grafana.types.create_workspace_service_account_token_request.CreateWorkspaceServiceAccountTokenRequest) -> tuple[aws_sdk_grafana.types.create_workspace_service_account_token_response.CreateWorkspaceServiceAccountTokenResponse, zapros.Response]:
...
async def async_create_workspace_service_account_token(options: AsyncOperationOptions, input: aws_sdk_grafana.types.create_workspace_service_account_token_request.CreateWorkspaceServiceAccountTokenRequest) -> tuple[aws_sdk_grafana.types.create_workspace_service_account_token_response.CreateWorkspaceServiceAccountTokenResponse, zapros.Response]:
