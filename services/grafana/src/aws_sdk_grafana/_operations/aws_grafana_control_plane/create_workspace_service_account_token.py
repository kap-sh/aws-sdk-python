...
def build_request(
    ...
    input: aws_sdk_grafana.types.create_workspace_service_account_token_request.CreateWorkspaceServiceAccountTokenRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{serviceAccountId}", quote(str(input["service_account_id"]), safe="")
    )
