...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.list_workspace_service_accounts_response.ListWorkspaceServiceAccountsResponse:
    import aws_sdk_grafana.types.list_workspace_service_accounts_response
    out: aws_sdk_grafana.types.list_workspace_service_accounts_response.ListWorkspaceServiceAccountsResponse = aws_sdk_grafana.types.list_workspace_service_accounts_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.list_workspace_service_accounts_request.ListWorkspaceServiceAccountsRequest) -> zapros.Request:
...
def list_workspace_service_accounts(options: OperationOptions, input: aws_sdk_grafana.types.list_workspace_service_accounts_request.ListWorkspaceServiceAccountsRequest) -> tuple[aws_sdk_grafana.types.list_workspace_service_accounts_response.ListWorkspaceServiceAccountsResponse, zapros.Response]:
...
async def async_list_workspace_service_accounts(options: AsyncOperationOptions, input: aws_sdk_grafana.types.list_workspace_service_accounts_request.ListWorkspaceServiceAccountsRequest) -> tuple[aws_sdk_grafana.types.list_workspace_service_accounts_response.ListWorkspaceServiceAccountsResponse, zapros.Response]:
