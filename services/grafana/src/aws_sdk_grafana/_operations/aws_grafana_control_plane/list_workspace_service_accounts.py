...
def handle_response(
    ...
    out: aws_sdk_grafana.types.list_workspace_service_accounts_response.ListWorkspaceServiceAccountsResponse = aws_sdk_grafana.types.list_workspace_service_accounts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.list_workspace_service_accounts_request.ListWorkspaceServiceAccountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
