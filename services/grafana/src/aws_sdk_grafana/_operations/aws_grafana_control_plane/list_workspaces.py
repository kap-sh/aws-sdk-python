...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.list_workspaces_response.ListWorkspacesResponse:
    import aws_sdk_grafana.types.list_workspaces_response
    out: aws_sdk_grafana.types.list_workspaces_response.ListWorkspacesResponse = aws_sdk_grafana.types.list_workspaces_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.list_workspaces_request.ListWorkspacesRequest) -> zapros.Request:
...
def list_workspaces(options: OperationOptions, input: aws_sdk_grafana.types.list_workspaces_request.ListWorkspacesRequest) -> tuple[aws_sdk_grafana.types.list_workspaces_response.ListWorkspacesResponse, zapros.Response]:
...
async def async_list_workspaces(options: AsyncOperationOptions, input: aws_sdk_grafana.types.list_workspaces_request.ListWorkspacesRequest) -> tuple[aws_sdk_grafana.types.list_workspaces_response.ListWorkspacesResponse, zapros.Response]:
