...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.create_workspace_api_key_response.CreateWorkspaceApiKeyResponse:
    import aws_sdk_grafana.types.create_workspace_api_key_response
    out: aws_sdk_grafana.types.create_workspace_api_key_response.CreateWorkspaceApiKeyResponse = aws_sdk_grafana.types.create_workspace_api_key_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.create_workspace_api_key_request.CreateWorkspaceApiKeyRequest) -> zapros.Request:
    ...
    import aws_sdk_grafana.types.create_workspace_api_key_request
    body: bytes | None = json.dumps(aws_sdk_grafana.types.create_workspace_api_key_request.serialize_json(input)).encode()
...
def create_workspace_api_key(options: OperationOptions, input: aws_sdk_grafana.types.create_workspace_api_key_request.CreateWorkspaceApiKeyRequest) -> tuple[aws_sdk_grafana.types.create_workspace_api_key_response.CreateWorkspaceApiKeyResponse, zapros.Response]:
...
async def async_create_workspace_api_key(options: AsyncOperationOptions, input: aws_sdk_grafana.types.create_workspace_api_key_request.CreateWorkspaceApiKeyRequest) -> tuple[aws_sdk_grafana.types.create_workspace_api_key_response.CreateWorkspaceApiKeyResponse, zapros.Response]:
