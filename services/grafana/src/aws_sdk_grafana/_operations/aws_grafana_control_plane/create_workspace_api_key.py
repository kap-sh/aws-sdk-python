...
def build_request(
    ...
    input: aws_sdk_grafana.types.create_workspace_api_key_request.CreateWorkspaceApiKeyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_grafana.types.create_workspace_api_key_request.serialize_json(input)
    ).encode()
