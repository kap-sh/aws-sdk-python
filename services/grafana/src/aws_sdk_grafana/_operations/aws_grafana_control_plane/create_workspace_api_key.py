...
def handle_response(
    ...
    out: aws_sdk_grafana.types.create_workspace_api_key_response.CreateWorkspaceApiKeyResponse = aws_sdk_grafana.types.create_workspace_api_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.create_workspace_api_key_request.CreateWorkspaceApiKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_grafana.types.create_workspace_api_key_request.serialize_json(input_)
    ).encode()
