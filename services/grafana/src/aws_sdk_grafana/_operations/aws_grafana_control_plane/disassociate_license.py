...
def handle_response(
    ...
    out: aws_sdk_grafana.types.disassociate_license_response.DisassociateLicenseResponse = aws_sdk_grafana.types.disassociate_license_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.disassociate_license_request.DisassociateLicenseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
