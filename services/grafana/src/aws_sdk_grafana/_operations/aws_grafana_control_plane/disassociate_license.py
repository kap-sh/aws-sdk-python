...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.disassociate_license_response.DisassociateLicenseResponse:
    import aws_sdk_grafana.types.disassociate_license_response
    out: aws_sdk_grafana.types.disassociate_license_response.DisassociateLicenseResponse = aws_sdk_grafana.types.disassociate_license_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.disassociate_license_request.DisassociateLicenseRequest) -> zapros.Request:
...
def disassociate_license(options: OperationOptions, input: aws_sdk_grafana.types.disassociate_license_request.DisassociateLicenseRequest) -> tuple[aws_sdk_grafana.types.disassociate_license_response.DisassociateLicenseResponse, zapros.Response]:
...
async def async_disassociate_license(options: AsyncOperationOptions, input: aws_sdk_grafana.types.disassociate_license_request.DisassociateLicenseRequest) -> tuple[aws_sdk_grafana.types.disassociate_license_response.DisassociateLicenseResponse, zapros.Response]:
