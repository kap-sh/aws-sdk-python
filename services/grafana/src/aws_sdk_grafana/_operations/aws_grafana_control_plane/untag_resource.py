...
def build_request(
    ...
    input_: aws_sdk_grafana.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def untag_resource(
    ...
    aws_sdk_grafana.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
