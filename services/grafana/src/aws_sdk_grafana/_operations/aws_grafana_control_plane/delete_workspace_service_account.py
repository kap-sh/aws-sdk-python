...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.delete_workspace_service_account_response.DeleteWorkspaceServiceAccountResponse:
    import aws_sdk_grafana.types.delete_workspace_service_account_response
    out: aws_sdk_grafana.types.delete_workspace_service_account_response.DeleteWorkspaceServiceAccountResponse = aws_sdk_grafana.types.delete_workspace_service_account_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.delete_workspace_service_account_request.DeleteWorkspaceServiceAccountRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/serviceaccounts/{serviceAccountId}"
...
def delete_workspace_service_account(options: OperationOptions, input: aws_sdk_grafana.types.delete_workspace_service_account_request.DeleteWorkspaceServiceAccountRequest) -> tuple[aws_sdk_grafana.types.delete_workspace_service_account_response.DeleteWorkspaceServiceAccountResponse, zapros.Response]:
...
async def async_delete_workspace_service_account(options: AsyncOperationOptions, input: aws_sdk_grafana.types.delete_workspace_service_account_request.DeleteWorkspaceServiceAccountRequest) -> tuple[aws_sdk_grafana.types.delete_workspace_service_account_response.DeleteWorkspaceServiceAccountResponse, zapros.Response]:
