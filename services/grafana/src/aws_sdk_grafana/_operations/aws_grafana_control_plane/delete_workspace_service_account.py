...
def handle_response(
    ...
    out: aws_sdk_grafana.types.delete_workspace_service_account_response.DeleteWorkspaceServiceAccountResponse = aws_sdk_grafana.types.delete_workspace_service_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.delete_workspace_service_account_request.DeleteWorkspaceServiceAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
