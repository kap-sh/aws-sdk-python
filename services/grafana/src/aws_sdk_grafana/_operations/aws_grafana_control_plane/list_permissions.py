"""Generated from Smithy shape ``com.amazonaws.grafana#ListPermissions``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.list_permissions_response.ListPermissionsResponse:
    import aws_sdk_grafana.types.list_permissions_response
    out: aws_sdk_grafana.types.list_permissions_response.ListPermissionsResponse = aws_sdk_grafana.types.list_permissions_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.list_permissions_request.ListPermissionsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/permissions"
...
def list_permissions(options: OperationOptions, input: aws_sdk_grafana.types.list_permissions_request.ListPermissionsRequest) -> tuple[aws_sdk_grafana.types.list_permissions_response.ListPermissionsResponse, zapros.Response]:
...
async def async_list_permissions(options: AsyncOperationOptions, input: aws_sdk_grafana.types.list_permissions_request.ListPermissionsRequest) -> tuple[aws_sdk_grafana.types.list_permissions_response.ListPermissionsResponse, zapros.Response]:
