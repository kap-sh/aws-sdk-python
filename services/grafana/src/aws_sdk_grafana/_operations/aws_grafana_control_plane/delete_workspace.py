...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.delete_workspace_response.DeleteWorkspaceResponse:
    import aws_sdk_grafana.types.delete_workspace_response
    out: aws_sdk_grafana.types.delete_workspace_response.DeleteWorkspaceResponse = aws_sdk_grafana.types.delete_workspace_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.delete_workspace_request.DeleteWorkspaceRequest) -> zapros.Request:
...
def delete_workspace(options: OperationOptions, input: aws_sdk_grafana.types.delete_workspace_request.DeleteWorkspaceRequest) -> tuple[aws_sdk_grafana.types.delete_workspace_response.DeleteWorkspaceResponse, zapros.Response]:
...
async def async_delete_workspace(options: AsyncOperationOptions, input: aws_sdk_grafana.types.delete_workspace_request.DeleteWorkspaceRequest) -> tuple[aws_sdk_grafana.types.delete_workspace_response.DeleteWorkspaceResponse, zapros.Response]:
