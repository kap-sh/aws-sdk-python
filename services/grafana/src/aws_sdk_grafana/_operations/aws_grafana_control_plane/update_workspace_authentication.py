...
def handle_response(
    ...
    out: aws_sdk_grafana.types.update_workspace_authentication_response.UpdateWorkspaceAuthenticationResponse = aws_sdk_grafana.types.update_workspace_authentication_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.update_workspace_authentication_request.UpdateWorkspaceAuthenticationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_grafana.types.update_workspace_authentication_request.serialize_json(
            input_
        )
    ).encode()
