...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.update_workspace_authentication_response.UpdateWorkspaceAuthenticationResponse:
    import aws_sdk_grafana.types.update_workspace_authentication_response
    out: aws_sdk_grafana.types.update_workspace_authentication_response.UpdateWorkspaceAuthenticationResponse = aws_sdk_grafana.types.update_workspace_authentication_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.update_workspace_authentication_request.UpdateWorkspaceAuthenticationRequest) -> zapros.Request:
    ...
    import aws_sdk_grafana.types.update_workspace_authentication_request
    body: bytes | None = json.dumps(aws_sdk_grafana.types.update_workspace_authentication_request.serialize_json(input)).encode()
...
def update_workspace_authentication(options: OperationOptions, input: aws_sdk_grafana.types.update_workspace_authentication_request.UpdateWorkspaceAuthenticationRequest) -> tuple[aws_sdk_grafana.types.update_workspace_authentication_response.UpdateWorkspaceAuthenticationResponse, zapros.Response]:
...
async def async_update_workspace_authentication(options: AsyncOperationOptions, input: aws_sdk_grafana.types.update_workspace_authentication_request.UpdateWorkspaceAuthenticationRequest) -> tuple[aws_sdk_grafana.types.update_workspace_authentication_response.UpdateWorkspaceAuthenticationResponse, zapros.Response]:
