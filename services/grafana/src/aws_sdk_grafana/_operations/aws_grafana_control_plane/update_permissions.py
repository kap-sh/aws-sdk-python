...
def handle_response(
    ...
    out: aws_sdk_grafana.types.update_permissions_response.UpdatePermissionsResponse = (
        aws_sdk_grafana.types.update_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.update_permissions_request.UpdatePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_grafana.types.update_permissions_request.serialize_json(input_)
    ).encode()
