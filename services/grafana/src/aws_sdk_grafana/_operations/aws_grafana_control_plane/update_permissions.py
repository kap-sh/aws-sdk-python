...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.update_permissions_response.UpdatePermissionsResponse:
    import aws_sdk_grafana.types.update_permissions_response
    out: aws_sdk_grafana.types.update_permissions_response.UpdatePermissionsResponse = aws_sdk_grafana.types.update_permissions_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.update_permissions_request.UpdatePermissionsRequest) -> zapros.Request:
    ...
    import aws_sdk_grafana.types.update_permissions_request
    body: bytes | None = json.dumps(aws_sdk_grafana.types.update_permissions_request.serialize_json(input)).encode()
...
def update_permissions(options: OperationOptions, input: aws_sdk_grafana.types.update_permissions_request.UpdatePermissionsRequest) -> tuple[aws_sdk_grafana.types.update_permissions_response.UpdatePermissionsResponse, zapros.Response]:
...
async def async_update_permissions(options: AsyncOperationOptions, input: aws_sdk_grafana.types.update_permissions_request.UpdatePermissionsRequest) -> tuple[aws_sdk_grafana.types.update_permissions_response.UpdatePermissionsResponse, zapros.Response]:
