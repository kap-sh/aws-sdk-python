"""Generated from Smithy shape ``com.amazonaws.grafana#CreateWorkspaceServiceAccount``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_grafana.types.create_workspace_service_account_response.CreateWorkspaceServiceAccountResponse:
    import aws_sdk_grafana.types.create_workspace_service_account_response
    out: aws_sdk_grafana.types.create_workspace_service_account_response.CreateWorkspaceServiceAccountResponse = aws_sdk_grafana.types.create_workspace_service_account_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_grafana.types.create_workspace_service_account_request.CreateWorkspaceServiceAccountRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/serviceaccounts"
    url = url.replace("{workspaceId}", quote(str(input["workspace_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_grafana.types.create_workspace_service_account_request
    body: bytes | None = json.dumps(aws_sdk_grafana.types.create_workspace_service_account_request.serialize_json(input)).encode()
...
def create_workspace_service_account(options: OperationOptions, input: aws_sdk_grafana.types.create_workspace_service_account_request.CreateWorkspaceServiceAccountRequest) -> tuple[aws_sdk_grafana.types.create_workspace_service_account_response.CreateWorkspaceServiceAccountResponse, zapros.Response]:
...
async def async_create_workspace_service_account(options: AsyncOperationOptions, input: aws_sdk_grafana.types.create_workspace_service_account_request.CreateWorkspaceServiceAccountRequest) -> tuple[aws_sdk_grafana.types.create_workspace_service_account_response.CreateWorkspaceServiceAccountResponse, zapros.Response]:
