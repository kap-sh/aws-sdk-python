...
def handle_response(
    ...
    out: aws_sdk_grafana.types.create_workspace_service_account_response.CreateWorkspaceServiceAccountResponse = aws_sdk_grafana.types.create_workspace_service_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_grafana.types.create_workspace_service_account_request.CreateWorkspaceServiceAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_grafana.types.create_workspace_service_account_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_workspace_service_account(
