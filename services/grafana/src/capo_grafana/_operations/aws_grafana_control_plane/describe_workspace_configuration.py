...
def handle_response(
    ...
    out: capo_grafana.types.describe_workspace_configuration_response.DescribeWorkspaceConfigurationResponse = capo_grafana.types.describe_workspace_configuration_response.deserialize_json(
