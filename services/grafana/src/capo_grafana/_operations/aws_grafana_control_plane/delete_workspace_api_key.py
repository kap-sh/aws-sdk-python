...
def handle_response(
    ...
    out: capo_grafana.types.delete_workspace_api_key_response.DeleteWorkspaceApiKeyResponse = capo_grafana.types.delete_workspace_api_key_response.deserialize_json(
