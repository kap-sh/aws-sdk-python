"""Generated from Smithy shape ``com.amazonaws.grafana#DeleteWorkspaceServiceAccount``."""
...
def handle_response(
    ...
    out: capo_grafana.types.delete_workspace_service_account_response.DeleteWorkspaceServiceAccountResponse = capo_grafana.types.delete_workspace_service_account_response.deserialize_json(
...
async def async_delete_workspace_service_account(
