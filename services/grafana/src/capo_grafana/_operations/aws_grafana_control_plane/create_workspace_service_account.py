...
def handle_response(
    ...
    out: capo_grafana.types.create_workspace_service_account_response.CreateWorkspaceServiceAccountResponse = capo_grafana.types.create_workspace_service_account_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_grafana.types.create_workspace_service_account_request.serialize_json(
            input_
        )
    ).encode()
