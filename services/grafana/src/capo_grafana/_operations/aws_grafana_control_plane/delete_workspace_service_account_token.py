...
def handle_response(
    ...
    out: capo_grafana.types.delete_workspace_service_account_token_response.DeleteWorkspaceServiceAccountTokenResponse = capo_grafana.types.delete_workspace_service_account_token_response.deserialize_json(
