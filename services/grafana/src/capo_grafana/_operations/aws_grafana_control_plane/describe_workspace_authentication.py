"""Generated from Smithy shape ``com.amazonaws.grafana#DescribeWorkspaceAuthentication``."""
...
def handle_response(
    ...
    out: capo_grafana.types.describe_workspace_authentication_response.DescribeWorkspaceAuthenticationResponse = capo_grafana.types.describe_workspace_authentication_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/authentication"
...
async def async_describe_workspace_authentication(
