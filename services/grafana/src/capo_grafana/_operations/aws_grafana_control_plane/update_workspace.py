...
def handle_response(
    ...
    out: capo_grafana.types.update_workspace_response.UpdateWorkspaceResponse = (
        capo_grafana.types.update_workspace_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_grafana.types.update_workspace_request.serialize_json(input_)
    ).encode()
