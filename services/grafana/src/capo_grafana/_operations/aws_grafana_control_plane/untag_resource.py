"""Generated from Smithy shape ``com.amazonaws.grafana#UntagResource``."""
...
def handle_response(
    ...
    out: capo_grafana.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_grafana.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
