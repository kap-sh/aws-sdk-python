"""Generated from Smithy shape ``com.amazonaws.grafana#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_grafana.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_grafana.types.list_tags_for_resource_response.deserialize_json(
