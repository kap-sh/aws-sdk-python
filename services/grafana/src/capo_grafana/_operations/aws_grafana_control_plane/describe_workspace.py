"""Generated from Smithy shape ``com.amazonaws.grafana#DescribeWorkspace``."""
...
def handle_response(
    ...
    out: capo_grafana.types.describe_workspace_response.DescribeWorkspaceResponse = (
        capo_grafana.types.describe_workspace_response.deserialize_json(
