"""Generated from Smithy shape ``com.amazonaws.grafana#UpdatePermissions``."""
...
def handle_response(
    ...
    out: capo_grafana.types.update_permissions_response.UpdatePermissionsResponse = (
        capo_grafana.types.update_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_grafana.types.update_permissions_request.serialize_json(input_)
    ).encode()
