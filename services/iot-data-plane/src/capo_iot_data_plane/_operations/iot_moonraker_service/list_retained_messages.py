"""Generated from Smithy shape ``com.amazonaws.iotdataplane#ListRetainedMessages``."""
...
import capo_iot_data_plane.errors.service_unavailable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUnavailableException":
            raise capo_iot_data_plane.errors.service_unavailable_exception.ServiceUnavailableException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_iot_data_plane.types.list_retained_messages_response.ListRetainedMessagesResponse = capo_iot_data_plane.types.list_retained_messages_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/retainedMessage"
    params: dict[str, str] = {}
...
async def async_list_retained_messages(
