"""Generated from Smithy shape ``com.amazonaws.iotdataplane#ListNamedShadowsForThing``."""
...
def handle_response(
    ...
    out: capo_iot_data_plane.types.list_named_shadows_for_thing_response.ListNamedShadowsForThingResponse = capo_iot_data_plane.types.list_named_shadows_for_thing_response.deserialize_json(
...
async def async_list_named_shadows_for_thing(
