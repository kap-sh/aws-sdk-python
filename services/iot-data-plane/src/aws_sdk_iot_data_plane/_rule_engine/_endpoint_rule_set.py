        ...
        if _locals["PartitionResult"] is not None:
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://data-ats.iot-fips.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={},
            ...
            if p.UseFIPS is True:
                if (
                    ...
                    if string_equals(p.Region, interpolate("ca-central-1", p, _locals)):
                        return Endpoint(
                            url=interpolate(
                                "https://data.iot-fips.ca-central-1.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={},
                    ...
                    if string_equals(p.Region, interpolate("us-east-1", p, _locals)):
                        return Endpoint(
                            url=interpolate(
                                "https://data.iot-fips.us-east-1.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={},
                    ...
                    if string_equals(p.Region, interpolate("us-east-2", p, _locals)):
                        return Endpoint(
                            url=interpolate(
                                "https://data.iot-fips.us-east-2.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={},
                    ...
                    if string_equals(p.Region, interpolate("us-west-1", p, _locals)):
                        return Endpoint(
                            url=interpolate(
                                "https://data.iot-fips.us-west-1.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={},
                    ...
                    if string_equals(p.Region, interpolate("us-west-2", p, _locals)):
                        return Endpoint(
                            url=interpolate(
                                "https://data.iot-fips.us-west-2.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={},
                    ...
                    if string_equals(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://data.iot-fips.us-gov-east-1.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={},
                    ...
                    if string_equals(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://data.iot-fips.us-gov-west-1.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={},
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://data-ats.iot-fips.{Region}.{PartitionResult#dnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            if p.UseDualStack is True:
                if True is get_attr(
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://data-ats.iot.{Region}.{PartitionResult#dualStackDnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            if string_equals(p.Region, interpolate("cn-north-1", p, _locals)):
                return Endpoint(
                    url=interpolate(
                        "https://data.ats.iot.cn-north-1.amazonaws.com.cn", p, _locals
                    ),
                    properties={},
                    headers={},
                )
            if string_equals(
                ...
                return Endpoint(
                    url=interpolate(
                        "https://data-ats.iot.{Region}.amazonaws.com", p, _locals
                    ),
                    properties={},
                    headers={},
                )
            if string_equals(
                ...
                return Endpoint(
                    url=interpolate(
                        "https://data-ats.iot.{Region}.amazonaws.com.cn", p, _locals
                    ),
                    properties={},
                    headers={},
                )
            ...
            return Endpoint(
                url=interpolate(
                    "https://data-ats.iot.{Region}.{PartitionResult#dnsSuffix}",
                    p,
                    _locals,
                ),
                properties={},
