...
from aws_sdk_iot_data_plane._services._aws_config import aws_config
...
class IoTDataPlaneClientConfig(TypedDict, total=False):
...
class IoTDataPlaneClient:
    ...
    def delete_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.delete_connection_request.DeleteConnectionRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iot_data_plane._operations.iot_moonraker_service.delete_connection

            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.delete_connection.delete_connection(
    ...
    def delete_thing_shadow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.delete_thing_shadow_request.DeleteThingShadowRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_data_plane.types.delete_thing_shadow_response.DeleteThingShadowResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.delete_thing_shadow.delete_thing_shadow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.get_connection_request.GetConnectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_data_plane.types.get_connection_response.GetConnectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.get_connection.get_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_retained_message(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.get_retained_message_request.GetRetainedMessageRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_data_plane.types.get_retained_message_response.GetRetainedMessageResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.get_retained_message.get_retained_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_thing_shadow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.get_thing_shadow_request.GetThingShadowRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_data_plane.types.get_thing_shadow_response.GetThingShadowResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.get_thing_shadow.get_thing_shadow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_named_shadows_for_thing(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.list_named_shadows_for_thing_request.ListNamedShadowsForThingRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_data_plane.types.list_named_shadows_for_thing_response.ListNamedShadowsForThingResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.list_named_shadows_for_thing.list_named_shadows_for_thing(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_retained_messages(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.list_retained_messages_request.ListRetainedMessagesRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_data_plane.types.list_retained_messages_response.ListRetainedMessagesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.list_retained_messages.list_retained_messages(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_iot_data_plane.types.retained_message_summary.RetainedMessageSummary]":
        _token = next_token
        while True:
    ...
    def list_subscriptions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.list_subscriptions_request.ListSubscriptionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_data_plane.types.list_subscriptions_response.ListSubscriptionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.list_subscriptions.list_subscriptions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_iot_data_plane.types.subscription_summary.SubscriptionSummary]":
        _token = next_token
        while True:
    ...
    def publish(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.publish_request.PublishRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iot_data_plane._operations.iot_moonraker_service.publish

            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.publish.publish(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_direct_message(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.send_direct_message_request.SendDirectMessageRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_data_plane.types.send_direct_message_response.SendDirectMessageResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.send_direct_message.send_direct_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_thing_shadow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_data_plane.types.update_thing_shadow_request.UpdateThingShadowRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_data_plane.types.update_thing_shadow_response.UpdateThingShadowResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_data_plane._operations.iot_moonraker_service.update_thing_shadow.update_thing_shadow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
