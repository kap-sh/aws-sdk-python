"""Generated from Smithy shape ``com.amazonaws.iotdataplane#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotdataplane#ResourceNotFoundException``."""
