...
class IoTDataPlaneError(Exception):
    """Base class for all IoTDataPlane service errors."""


class ServiceError(IoTDataPlaneError):
...
class SerializationError(IoTDataPlaneError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTDataPlaneError):
...
class WaiterFailedError(IoTDataPlaneError):
...
class WaiterTimeoutError(IoTDataPlaneError):
