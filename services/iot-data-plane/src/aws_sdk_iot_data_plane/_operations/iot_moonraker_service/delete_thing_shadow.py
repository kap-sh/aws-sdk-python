"""Generated from Smithy shape ``com.amazonaws.iotdataplane#DeleteThingShadow``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_data_plane.types.delete_thing_shadow_response.DeleteThingShadowResponse = {
...
def build_request(
    ...
    input_: aws_sdk_iot_data_plane.types.delete_thing_shadow_request.DeleteThingShadowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_thing_shadow(
