"""Generated from Smithy shape ``com.amazonaws.iotdataplane#GetThingShadow``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_data_plane.types.get_thing_shadow_response.GetThingShadowResponse = {
