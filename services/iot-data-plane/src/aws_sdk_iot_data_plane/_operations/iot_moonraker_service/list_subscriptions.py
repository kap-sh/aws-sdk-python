"""Generated from Smithy shape ``com.amazonaws.iotdataplane#ListSubscriptions``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_data_plane.types.list_subscriptions_response.ListSubscriptionsResponse = aws_sdk_iot_data_plane.types.list_subscriptions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_data_plane.types.list_subscriptions_request.ListSubscriptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/connections/{clientId}/subscriptions"
