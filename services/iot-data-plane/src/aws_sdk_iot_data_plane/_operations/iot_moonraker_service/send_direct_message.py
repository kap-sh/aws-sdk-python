...
def build_request(
    ...
    input: aws_sdk_iot_data_plane.types.send_direct_message_request.SendDirectMessageRequest,
) -> zapros.Request:
    ...
    params["confirmation"] = str(input.get("confirmation", False))
    params["timeout"] = str(input.get("timeout", 0))
