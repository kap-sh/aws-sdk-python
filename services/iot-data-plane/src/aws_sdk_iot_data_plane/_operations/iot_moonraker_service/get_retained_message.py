"""Generated from Smithy shape ``com.amazonaws.iotdataplane#GetRetainedMessage``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_data_plane.types.get_retained_message_response.GetRetainedMessageResponse = aws_sdk_iot_data_plane.types.get_retained_message_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot_data_plane.types.get_retained_message_request.GetRetainedMessageRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/retainedMessage/{topic}"
...
async def async_get_retained_message(
