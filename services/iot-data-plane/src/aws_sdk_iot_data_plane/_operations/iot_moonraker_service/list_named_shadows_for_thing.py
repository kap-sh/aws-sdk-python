...
def handle_response(
    ...
    out: aws_sdk_iot_data_plane.types.list_named_shadows_for_thing_response.ListNamedShadowsForThingResponse = aws_sdk_iot_data_plane.types.list_named_shadows_for_thing_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_data_plane.types.list_named_shadows_for_thing_request.ListNamedShadowsForThingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
