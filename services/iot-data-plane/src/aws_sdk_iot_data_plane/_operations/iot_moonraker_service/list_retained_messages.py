...
def handle_response(
    ...
    out: aws_sdk_iot_data_plane.types.list_retained_messages_response.ListRetainedMessagesResponse = aws_sdk_iot_data_plane.types.list_retained_messages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_data_plane.types.list_retained_messages_request.ListRetainedMessagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
