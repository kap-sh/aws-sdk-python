...
```
pip install aws-sdk-iot-data-plane
```

## Usage

```python
from aws_sdk_iot_data_plane import AsyncIoTDataPlaneClient
...
```python
from aws_sdk_iot_data_plane import AsyncIoTDataPlaneClient
from aws_sdk_iot_data_plane.error import ForbiddenException
