...
if TYPE_CHECKING:
    import aws_sdk_geo_places.types.validation_exception_field_list
...
class ValidationException_(TypedDict, closed=True):
    ...
    field_list: "aws_sdk_geo_places.types.validation_exception_field_list.ValidationExceptionFieldList"
...
def serialize_json(value: ValidationException_) -> dict:
    ...
    out["fieldList"] = (
        aws_sdk_geo_places.types.validation_exception_field_list.serialize_json(
            value["field_list"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> ValidationException_:
    ...
    if "fieldList" in data:
        ...
        out["field_list"] = (
            aws_sdk_geo_places.types.validation_exception_field_list.deserialize_json(
                data["fieldList"]
            )
        )
    else:
