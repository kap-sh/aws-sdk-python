...
class GeoPlacesError(Exception):
    """Base class for all GeoPlaces service errors."""


class ServiceError(GeoPlacesError):
...
class SerializationError(GeoPlacesError):
    """Raised when a value cannot be serialized."""


class DeserializationError(GeoPlacesError):
...
class WaiterFailedError(GeoPlacesError):
...
class WaiterTimeoutError(GeoPlacesError):
