...
from aws_sdk_geo_places._async import anysleep
from aws_sdk_geo_places.errors import ServiceError

if TYPE_CHECKING:
    from aws_sdk_geo_places._auth._identity import Credentials
    from aws_sdk_geo_places._auth._providers import IdentityProvider
