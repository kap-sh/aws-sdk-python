...
def serialize_json(value: AutocompleteRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = aws_sdk_geo_places.types.autocomplete_filter.serialize_json(
            value["filter"]
        )
    ...
    if "additional_features" in value:
        ...
        out["AdditionalFeatures"] = (
            aws_sdk_geo_places.types.autocomplete_additional_feature_list.serialize_json(
...
def deserialize_json(data: dict) -> AutocompleteRequest:
    ...
    if "Filter" in data:
        ...
        out["filter"] = aws_sdk_geo_places.types.autocomplete_filter.deserialize_json(
            data["Filter"]
        )
    ...
    if "AdditionalFeatures" in data:
        ...
        out["additional_features"] = (
            aws_sdk_geo_places.types.autocomplete_additional_feature_list.deserialize_json(
