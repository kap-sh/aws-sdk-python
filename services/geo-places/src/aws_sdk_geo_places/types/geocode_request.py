...
class GeocodeRequest(TypedDict):
    ...
    filter: NotRequired["aws_sdk_geo_places.types.geocode_filter.GeocodeFilter"]
...
def serialize_json(value: GeocodeRequest) -> dict:
    ...
    if "query_components" in value:
        ...
        out["QueryComponents"] = (
            aws_sdk_geo_places.types.geocode_query_components.serialize_json(
    ...
    if "filter" in value:
        ...
        out["Filter"] = aws_sdk_geo_places.types.geocode_filter.serialize_json(
            value["filter"]
        )
    if "additional_features" in value:
        ...
        out["AdditionalFeatures"] = (
            aws_sdk_geo_places.types.geocode_additional_feature_list.serialize_json(
...
def deserialize_json(data: dict) -> GeocodeRequest:
    ...
    if "QueryComponents" in data:
        ...
        out["query_components"] = (
            aws_sdk_geo_places.types.geocode_query_components.deserialize_json(
    ...
    if "Filter" in data:
        ...
        out["filter"] = aws_sdk_geo_places.types.geocode_filter.deserialize_json(
            data["Filter"]
        )
    if "AdditionalFeatures" in data:
        ...
        out["additional_features"] = (
            aws_sdk_geo_places.types.geocode_additional_feature_list.deserialize_json(
