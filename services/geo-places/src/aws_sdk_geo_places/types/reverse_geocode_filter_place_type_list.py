...
if TYPE_CHECKING:
    import aws_sdk_geo_places.types.reverse_geocode_filter_place_type

ReverseGeocodeFilterPlaceTypeList: TypeAlias = list[
    "aws_sdk_geo_places.types.reverse_geocode_filter_place_type.ReverseGeocodeFilterPlaceType"
]
