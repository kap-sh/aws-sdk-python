...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_places.types.intersection_street_list
    import aws_sdk_geo_places.types.region
    import aws_sdk_geo_places.types.secondary_address_component_list
    import aws_sdk_geo_places.types.sensitive_string
    import aws_sdk_geo_places.types.street_components_list
...
class Address(TypedDict):
    ...
    region: NotRequired["aws_sdk_geo_places.types.region.Region"]
    """<p>The region or state results should be present in. </p> <p>Example: <code>North Rhine-Westphalia</code>.</p>"""
    sub_region: NotRequired["aws_sdk_geo_places.types.sub_region.SubRegion"]
    """<p>The sub-region or county for which results should be present in. </p>"""
    locality: NotRequired["aws_sdk_geo_places.types.sensitive_string.SensitiveString"]
    """<p>The city or locality of the address.</p> <p>Example: <code>Vancouver</code>.</p>"""
    district: NotRequired["aws_sdk_geo_places.types.sensitive_string.SensitiveString"]
...
def serialize_json(value: Address) -> dict:
    ...
    if "country" in value:
        ...
        out["Country"] = aws_sdk_geo_places.types.country.serialize_json(
            value["country"]
        )
    if "region" in value:
        import aws_sdk_geo_places.types.region

        out["Region"] = aws_sdk_geo_places.types.region.serialize_json(value["region"])
    if "sub_region" in value:
        import aws_sdk_geo_places.types.sub_region

        out["SubRegion"] = aws_sdk_geo_places.types.sub_region.serialize_json(
            value["sub_region"]
        )
    ...
    if "intersection" in value:
        ...
        out["Intersection"] = (
            aws_sdk_geo_places.types.intersection_street_list.serialize_json(
                value["intersection"]
            )
        )
    if "street" in value:
    ...
    if "street_components" in value:
        ...
        out["StreetComponents"] = (
            aws_sdk_geo_places.types.street_components_list.serialize_json(
    ...
    if "secondary_address_components" in value:
        ...
        out["SecondaryAddressComponents"] = (
            aws_sdk_geo_places.types.secondary_address_component_list.serialize_json(
...
def deserialize_json(data: dict) -> Address:
    ...
    if "Country" in data:
        ...
        out["country"] = aws_sdk_geo_places.types.country.deserialize_json(
            data["Country"]
        )
    if "Region" in data:
        import aws_sdk_geo_places.types.region

        out["region"] = aws_sdk_geo_places.types.region.deserialize_json(data["Region"])
    if "SubRegion" in data:
        import aws_sdk_geo_places.types.sub_region

        out["sub_region"] = aws_sdk_geo_places.types.sub_region.deserialize_json(
            data["SubRegion"]
        )
    if "Locality" in data:
    ...
    if "Intersection" in data:
        ...
        out["intersection"] = (
            aws_sdk_geo_places.types.intersection_street_list.deserialize_json(
                data["Intersection"]
            )
        )
    if "Street" in data:
    ...
    if "StreetComponents" in data:
        ...
        out["street_components"] = (
            aws_sdk_geo_places.types.street_components_list.deserialize_json(
    ...
    if "SecondaryAddressComponents" in data:
        ...
        out["secondary_address_components"] = (
            aws_sdk_geo_places.types.secondary_address_component_list.deserialize_json(
