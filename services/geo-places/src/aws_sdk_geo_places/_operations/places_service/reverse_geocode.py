...
def handle_response(
    ...
    out: aws_sdk_geo_places.types.reverse_geocode_response.ReverseGeocodeResponse = (
        aws_sdk_geo_places.types.reverse_geocode_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_geo_places.types.reverse_geocode_request.ReverseGeocodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_places.types.reverse_geocode_request.serialize_json(input_)
    ).encode()
