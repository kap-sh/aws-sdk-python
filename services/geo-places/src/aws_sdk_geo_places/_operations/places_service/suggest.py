"""Generated from Smithy shape ``com.amazonaws.geoplaces#Suggest``."""
...
def handle_response(
    ...
    out: aws_sdk_geo_places.types.suggest_response.SuggestResponse = (
        aws_sdk_geo_places.types.suggest_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_geo_places.types.suggest_request.SuggestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/suggest"
    params: dict[str, str] = {}
    if "key" in input_:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_places.types.suggest_request.serialize_json(input_)
    ).encode()
...
def suggest(
    ...
    input_: aws_sdk_geo_places.types.suggest_request.SuggestRequest,
) -> tuple[aws_sdk_geo_places.types.suggest_response.SuggestResponse, zapros.Response]:
