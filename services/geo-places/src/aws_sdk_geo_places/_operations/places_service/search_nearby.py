...
def handle_response(
    ...
    out: aws_sdk_geo_places.types.search_nearby_response.SearchNearbyResponse = (
        aws_sdk_geo_places.types.search_nearby_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_geo_places.types.search_nearby_request.SearchNearbyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_places.types.search_nearby_request.serialize_json(input_)
    ).encode()
