...
def handle_response(
    ...
    out: aws_sdk_geo_places.types.autocomplete_response.AutocompleteResponse = (
        aws_sdk_geo_places.types.autocomplete_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_geo_places.types.autocomplete_request.AutocompleteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_places.types.autocomplete_request.serialize_json(input_)
    ).encode()
...
def autocomplete(
    ...
    aws_sdk_geo_places.types.autocomplete_response.AutocompleteResponse, zapros.Response
]:
