...
import aws_sdk_geo_places.types.geocode_result_item_list
...
def handle_response(
    ...
    out: aws_sdk_geo_places.types.geocode_response.GeocodeResponse = (
        aws_sdk_geo_places.types.geocode_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_geo_places.types.geocode_request.GeocodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_places.types.geocode_request.serialize_json(input_)
    ).encode()
...
def geocode(
    ...
    input_: aws_sdk_geo_places.types.geocode_request.GeocodeRequest,
) -> tuple[aws_sdk_geo_places.types.geocode_response.GeocodeResponse, zapros.Response]:
