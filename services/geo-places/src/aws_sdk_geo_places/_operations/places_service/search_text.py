...
def handle_response(
    ...
    out: aws_sdk_geo_places.types.search_text_response.SearchTextResponse = (
        aws_sdk_geo_places.types.search_text_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_geo_places.types.search_text_request.SearchTextRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_places.types.search_text_request.serialize_json(input_)
    ).encode()
...
def search_text(
    ...
    aws_sdk_geo_places.types.search_text_response.SearchTextResponse, zapros.Response
]:
