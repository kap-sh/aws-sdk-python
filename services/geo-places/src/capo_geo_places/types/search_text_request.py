...
class SearchTextRequest(TypedDict, closed=True):
    ...
    filter: NotRequired["capo_geo_places.types.search_text_filter.SearchTextFilter"]
...
def serialize_json(value: SearchTextRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = capo_geo_places.types.search_text_filter.serialize_json(
            value["filter"]
        )
    if "additional_features" in value:
        ...
        out["AdditionalFeatures"] = (
            capo_geo_places.types.search_text_additional_feature_list.serialize_json(
...
def deserialize_json(data: dict) -> SearchTextRequest:
    ...
    if "AdditionalFeatures" in data:
        ...
        out["additional_features"] = (
            capo_geo_places.types.search_text_additional_feature_list.deserialize_json(
