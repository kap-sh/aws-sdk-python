"""Generated from Smithy shape ``com.amazonaws.geoplaces#SuggestFilter``."""
...
class SuggestFilter(TypedDict, closed=True):
    ...
    circle: NotRequired["capo_geo_places.types.filter_circle.FilterCircle"]
...
# --- restJson1 ser/de ---
def serialize_json(value: SuggestFilter) -> dict:
    out: dict = {}
    ...
    if "circle" in value:
        ...
        out["Circle"] = capo_geo_places.types.filter_circle.serialize_json(
            value["circle"]
        )
...
def deserialize_json(data: dict) -> SuggestFilter:
    out: SuggestFilter = {}  # type: ignore[typeddict-item]
