"""Generated from Smithy shape ``com.amazonaws.odb#DbServerSummary``."""
...
class DbServerSummary(TypedDict, closed=True):
    ...
    db_server_patching_details: NotRequired[
        "capo_odb.types.db_server_patching_details.DbServerPatchingDetails"
    ]
    ...
    vm_cluster_ids: NotRequired["capo_odb.types.string_list.StringList"]
    ...
    autonomous_vm_cluster_ids: NotRequired["capo_odb.types.string_list.StringList"]
    """<p>A list of identifiers for the Autonomous VM clusters.</p>"""
    autonomous_virtual_machine_ids: NotRequired["capo_odb.types.string_list.StringList"]
    """<p>A list of unique identifiers for the Autonomous VMs.</p>"""


# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DbServerSummary) -> dict:
    out: dict = {}
    ...
    if "db_server_patching_details" in value:
        ...
        out["dbServerPatchingDetails"] = (
            capo_odb.types.db_server_patching_details.serialize_aws_json_1_0(
    ...
    if "vm_cluster_ids" in value:
        ...
        out["vmClusterIds"] = capo_odb.types.string_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DbServerSummary:
    ...
    if "dbServerPatchingDetails" in data:
        ...
        out["db_server_patching_details"] = (
            capo_odb.types.db_server_patching_details.deserialize_aws_json_1_0(
