"""Generated from Smithy shape ``com.amazonaws.odb#StopAutonomousDatabaseOutput``."""
...
class StopAutonomousDatabaseOutput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: StopAutonomousDatabaseOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> StopAutonomousDatabaseOutput:
    out: StopAutonomousDatabaseOutput = {}  # type: ignore[typeddict-item]
    if "autonomousDatabaseId" in data:
        out["autonomous_database_id"] = data["autonomousDatabaseId"]
    else:
        raise DeserializationError(
            "StopAutonomousDatabaseOutput.autonomous_database_id required"
        )
