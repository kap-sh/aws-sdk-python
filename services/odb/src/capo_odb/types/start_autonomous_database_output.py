"""Generated from Smithy shape ``com.amazonaws.odb#StartAutonomousDatabaseOutput``."""
...
class StartAutonomousDatabaseOutput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: StartAutonomousDatabaseOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> StartAutonomousDatabaseOutput:
    out: StartAutonomousDatabaseOutput = {}  # type: ignore[typeddict-item]
    if "autonomousDatabaseId" in data:
        out["autonomous_database_id"] = data["autonomousDatabaseId"]
    else:
        raise DeserializationError(
            "StartAutonomousDatabaseOutput.autonomous_database_id required"
        )
