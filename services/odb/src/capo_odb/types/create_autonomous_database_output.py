"""Generated from Smithy shape ``com.amazonaws.odb#CreateAutonomousDatabaseOutput``."""
...
class CreateAutonomousDatabaseOutput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CreateAutonomousDatabaseOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> CreateAutonomousDatabaseOutput:
    out: CreateAutonomousDatabaseOutput = {}  # type: ignore[typeddict-item]
    if "autonomousDatabaseId" in data:
        out["autonomous_database_id"] = data["autonomousDatabaseId"]
    else:
        raise DeserializationError(
            "CreateAutonomousDatabaseOutput.autonomous_database_id required"
        )
