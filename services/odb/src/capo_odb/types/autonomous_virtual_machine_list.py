...
AutonomousVirtualMachineList: TypeAlias = list[
    "capo_odb.types.autonomous_virtual_machine_summary.AutonomousVirtualMachineSummary"
]
...
def serialize_aws_json_1_0(value: AutonomousVirtualMachineList) -> list:
    ...
    for item in value:
        out.append(
            capo_odb.types.autonomous_virtual_machine_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> AutonomousVirtualMachineList:
    ...
    for item in data:
        out.append(
            capo_odb.types.autonomous_virtual_machine_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
