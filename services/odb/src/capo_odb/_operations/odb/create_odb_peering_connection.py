"""Generated from Smithy shape ``com.amazonaws.odb#CreateOdbPeeringConnection``."""
...
def handle_response(
    ...
    out: capo_odb.types.create_odb_peering_connection_output.CreateOdbPeeringConnectionOutput = capo_odb.types.create_odb_peering_connection_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.create_odb_peering_connection_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_odb_peering_connection(
