"""Generated from Smithy shape ``com.amazonaws.odb#ListAutonomousVirtualMachines``."""
...
def handle_response(
    ...
    out: capo_odb.types.list_autonomous_virtual_machines_output.ListAutonomousVirtualMachinesOutput = capo_odb.types.list_autonomous_virtual_machines_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.ListAutonomousVirtualMachines"
    body: bytes | None = b""
...
async def async_list_autonomous_virtual_machines(
