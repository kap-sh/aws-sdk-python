...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_odb.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_odb.types.create_cloud_autonomous_vm_cluster_output.CreateCloudAutonomousVmClusterOutput = capo_odb.types.create_cloud_autonomous_vm_cluster_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.create_cloud_autonomous_vm_cluster_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
