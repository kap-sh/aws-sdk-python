...
def handle_response(
    ...
    out: capo_odb.types.list_cloud_vm_clusters_output.ListCloudVmClustersOutput = (
        capo_odb.types.list_cloud_vm_clusters_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.list_cloud_vm_clusters_input.serialize_aws_json_1_0(input_)
    ).encode()
