"""Generated from Smithy shape ``com.amazonaws.odb#GetAutonomousDatabaseBackup``."""
...
import capo_odb.types.autonomous_database_backup
...
def handle_response(
    ...
    out: capo_odb.types.get_autonomous_database_backup_output.GetAutonomousDatabaseBackupOutput = capo_odb.types.get_autonomous_database_backup_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.GetAutonomousDatabaseBackup"
    body: bytes | None = b""
...
async def async_get_autonomous_database_backup(
