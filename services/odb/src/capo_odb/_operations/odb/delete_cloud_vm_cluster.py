"""Generated from Smithy shape ``com.amazonaws.odb#DeleteCloudVmCluster``."""
...
def handle_response(
    ...
    out: capo_odb.types.delete_cloud_vm_cluster_output.DeleteCloudVmClusterOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.DeleteCloudVmCluster"
    body: bytes | None = b""
...
async def async_delete_cloud_vm_cluster(
