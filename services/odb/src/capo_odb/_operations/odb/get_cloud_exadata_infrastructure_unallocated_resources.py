"""Generated from Smithy shape ``com.amazonaws.odb#GetCloudExadataInfrastructureUnallocatedResources``."""
...
def handle_response(
    ...
    out: capo_odb.types.get_cloud_exadata_infrastructure_unallocated_resources_output.GetCloudExadataInfrastructureUnallocatedResourcesOutput = capo_odb.types.get_cloud_exadata_infrastructure_unallocated_resources_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["cloud_exadata_infrastructure_id"]), safe=""),
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Odb.GetCloudExadataInfrastructureUnallocatedResources"
    body: bytes | None = json.dumps(
        capo_odb.types.get_cloud_exadata_infrastructure_unallocated_resources_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_cloud_exadata_infrastructure_unallocated_resources(
