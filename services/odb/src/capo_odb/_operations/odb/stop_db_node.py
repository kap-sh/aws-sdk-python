"""Generated from Smithy shape ``com.amazonaws.odb#StopDbNode``."""
...
def handle_response(
    ...
    out: capo_odb.types.stop_db_node_output.StopDbNodeOutput = (
        capo_odb.types.stop_db_node_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.StopDbNode"
    body: bytes | None = b""
...
def stop_db_node(
    options: OperationOptions, input_: capo_odb.types.stop_db_node_input.StopDbNodeInput
) -> tuple[capo_odb.types.stop_db_node_output.StopDbNodeOutput, zapros.Response]:
