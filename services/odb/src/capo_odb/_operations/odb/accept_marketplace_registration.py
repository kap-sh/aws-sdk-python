"""Generated from Smithy shape ``com.amazonaws.odb#AcceptMarketplaceRegistration``."""
...
def handle_response(
    ...
    out: capo_odb.types.accept_marketplace_registration_output.AcceptMarketplaceRegistrationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.AcceptMarketplaceRegistration"
    body: bytes | None = json.dumps(
        capo_odb.types.accept_marketplace_registration_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_accept_marketplace_registration(
