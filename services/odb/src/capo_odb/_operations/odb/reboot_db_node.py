...
def handle_response(
    ...
    out: capo_odb.types.reboot_db_node_output.RebootDbNodeOutput = (
        capo_odb.types.reboot_db_node_output.deserialize_aws_json_1_0(
...
def reboot_db_node(
    ...
    input_: capo_odb.types.reboot_db_node_input.RebootDbNodeInput,
) -> tuple[capo_odb.types.reboot_db_node_output.RebootDbNodeOutput, zapros.Response]:
