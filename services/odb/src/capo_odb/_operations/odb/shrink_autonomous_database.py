...
def handle_response(
    ...
    out: capo_odb.types.shrink_autonomous_database_output.ShrinkAutonomousDatabaseOutput = capo_odb.types.shrink_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.shrink_autonomous_database_input.serialize_aws_json_1_0(input_)
    ).encode()
