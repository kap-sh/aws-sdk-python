"""Generated from Smithy shape ``com.amazonaws.odb#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_odb.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_odb.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_odb.types.list_tags_for_resource_request.serialize_aws_json_1_0(input_)
    ).encode()
