"""Generated from Smithy shape ``com.amazonaws.odb#CreateAutonomousDatabaseBackup``."""
...
def handle_response(
    ...
    out: capo_odb.types.create_autonomous_database_backup_output.CreateAutonomousDatabaseBackupOutput = capo_odb.types.create_autonomous_database_backup_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.CreateAutonomousDatabaseBackup"
    body: bytes | None = json.dumps(
        capo_odb.types.create_autonomous_database_backup_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_autonomous_database_backup(
