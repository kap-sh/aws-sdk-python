"""Generated from Smithy shape ``com.amazonaws.odb#CreateOdbNetwork``."""
...
def handle_response(
    ...
    out: capo_odb.types.create_odb_network_output.CreateOdbNetworkOutput = (
        capo_odb.types.create_odb_network_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.CreateOdbNetwork"
    body: bytes | None = json.dumps(
        capo_odb.types.create_odb_network_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_odb_network(
    ...
    capo_odb.types.create_odb_network_output.CreateOdbNetworkOutput, zapros.Response
]:
...
async def async_create_odb_network(
