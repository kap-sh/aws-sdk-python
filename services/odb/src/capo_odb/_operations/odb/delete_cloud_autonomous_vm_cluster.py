"""Generated from Smithy shape ``com.amazonaws.odb#DeleteCloudAutonomousVmCluster``."""
...
def handle_response(
    ...
    out: capo_odb.types.delete_cloud_autonomous_vm_cluster_output.DeleteCloudAutonomousVmClusterOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.DeleteCloudAutonomousVmCluster"
    body: bytes | None = b""
...
async def async_delete_cloud_autonomous_vm_cluster(
