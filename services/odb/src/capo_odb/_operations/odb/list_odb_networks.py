"""Generated from Smithy shape ``com.amazonaws.odb#ListOdbNetworks``."""
...
import capo_odb.types.odb_network_list
...
def handle_response(
    ...
    out: capo_odb.types.list_odb_networks_output.ListOdbNetworksOutput = (
        capo_odb.types.list_odb_networks_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.ListOdbNetworks"
    body: bytes | None = b""
...
def list_odb_networks(
    ...
    capo_odb.types.list_odb_networks_output.ListOdbNetworksOutput, zapros.Response
]:
...
async def async_list_odb_networks(
