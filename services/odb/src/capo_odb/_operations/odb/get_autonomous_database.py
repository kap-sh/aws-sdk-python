"""Generated from Smithy shape ``com.amazonaws.odb#GetAutonomousDatabase``."""
...
def handle_response(
    ...
    out: capo_odb.types.get_autonomous_database_output.GetAutonomousDatabaseOutput = (
        capo_odb.types.get_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.GetAutonomousDatabase"
    body: bytes | None = b""
...
async def async_get_autonomous_database(
