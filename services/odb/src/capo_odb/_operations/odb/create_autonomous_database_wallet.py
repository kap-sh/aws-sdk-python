...
def handle_response(
    ...
    out: capo_odb.types.create_autonomous_database_wallet_output.CreateAutonomousDatabaseWalletOutput = capo_odb.types.create_autonomous_database_wallet_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.create_autonomous_database_wallet_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
