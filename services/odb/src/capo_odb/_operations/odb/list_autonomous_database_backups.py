"""Generated from Smithy shape ``com.amazonaws.odb#ListAutonomousDatabaseBackups``."""
...
def handle_response(
    ...
    out: capo_odb.types.list_autonomous_database_backups_output.ListAutonomousDatabaseBackupsOutput = capo_odb.types.list_autonomous_database_backups_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.ListAutonomousDatabaseBackups"
    body: bytes | None = json.dumps(
        capo_odb.types.list_autonomous_database_backups_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_autonomous_database_backups(
