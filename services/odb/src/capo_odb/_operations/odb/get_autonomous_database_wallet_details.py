"""Generated from Smithy shape ``com.amazonaws.odb#GetAutonomousDatabaseWalletDetails``."""
...
import capo_odb.types.autonomous_database_wallet_details
...
def handle_response(
    ...
    out: capo_odb.types.get_autonomous_database_wallet_details_output.GetAutonomousDatabaseWalletDetailsOutput = capo_odb.types.get_autonomous_database_wallet_details_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.get_autonomous_database_wallet_details_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_autonomous_database_wallet_details(
