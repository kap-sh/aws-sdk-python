"""Generated from Smithy shape ``com.amazonaws.odb#StartDbNode``."""
...
def handle_response(
    ...
    out: capo_odb.types.start_db_node_output.StartDbNodeOutput = (
        capo_odb.types.start_db_node_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.StartDbNode"
    body: bytes | None = b""
...
def start_db_node(
    ...
    input_: capo_odb.types.start_db_node_input.StartDbNodeInput,
) -> tuple[capo_odb.types.start_db_node_output.StartDbNodeOutput, zapros.Response]:
