...
def handle_response(
    ...
    out: capo_odb.types.delete_odb_network_output.DeleteOdbNetworkOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.delete_odb_network_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_odb_network(
    ...
    capo_odb.types.delete_odb_network_output.DeleteOdbNetworkOutput, zapros.Response
]:
