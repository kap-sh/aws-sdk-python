...
def handle_response(
    ...
    out: capo_odb.types.restore_autonomous_database_output.RestoreAutonomousDatabaseOutput = capo_odb.types.restore_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.restore_autonomous_database_input.serialize_aws_json_1_0(input_)
    ).encode()
