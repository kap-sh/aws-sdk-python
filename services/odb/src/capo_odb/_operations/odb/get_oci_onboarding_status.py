"""Generated from Smithy shape ``com.amazonaws.odb#GetOciOnboardingStatus``."""
...
def handle_response(
    ...
    out: capo_odb.types.get_oci_onboarding_status_output.GetOciOnboardingStatusOutput = capo_odb.types.get_oci_onboarding_status_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.GetOciOnboardingStatus"
    body: bytes | None = b""
...
async def async_get_oci_onboarding_status(
