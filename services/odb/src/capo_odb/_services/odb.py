...
from capo_odb._resources.odb.cloud_vm_cluster_resource import CloudVmClusterResource
from capo_odb._resources.odb.db_node_resource import DbNodeResource
from capo_odb._resources.odb.exadb_vm_cluster_resource import ExadbVmClusterResource
from capo_odb._resources.odb.exascale_db_storage_vault_resource import (
    ExascaleDbStorageVaultResource,
)
from capo_odb._resources.odb.exascale_vm_cluster_resource import (
    ExascaleVmClusterResource,
)
from capo_odb._resources.odb.odb_network_resource import OdbNetworkResource
from capo_odb._resources.odb.odb_peering_connection_resource import (
    OdbPeeringConnectionResource,
)
from capo_odb._services._aws_config import aws_config
...
class odbClientConfig(TypedDict, total=False, closed=True):
...
class odbClient:
    ...
    def accept_marketplace_registration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.accept_marketplace_registration_input.AcceptMarketplaceRegistrationInput]",
        ) -> OperationResponse[
            "capo_odb.types.accept_marketplace_registration_output.AcceptMarketplaceRegistrationOutput"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.accept_marketplace_registration.accept_marketplace_registration(
    ...
    def associate_iam_role_to_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.associate_iam_role_to_resource_input.AssociateIamRoleToResourceInput]",
        ) -> OperationResponse[
            "capo_odb.types.associate_iam_role_to_resource_output.AssociateIamRoleToResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.associate_iam_role_to_resource.associate_iam_role_to_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_iam_role_from_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.disassociate_iam_role_from_resource_input.DisassociateIamRoleFromResourceInput]",
        ) -> OperationResponse[
            "capo_odb.types.disassociate_iam_role_from_resource_output.DisassociateIamRoleFromResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.disassociate_iam_role_from_resource.disassociate_iam_role_from_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_oci_onboarding_status(
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.get_oci_onboarding_status_input.GetOciOnboardingStatusInput]",
        ) -> OperationResponse[
            "capo_odb.types.get_oci_onboarding_status_output.GetOciOnboardingStatusOutput"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.get_oci_onboarding_status.get_oci_onboarding_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def initialize_service(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.initialize_service_input.InitializeServiceInput]",
        ) -> OperationResponse[
            "capo_odb.types.initialize_service_output.InitializeServiceOutput"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.initialize_service.initialize_service(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_autonomous_database_character_sets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.list_autonomous_database_character_sets_input.ListAutonomousDatabaseCharacterSetsInput]",
        ) -> OperationResponse[
            "capo_odb.types.list_autonomous_database_character_sets_output.ListAutonomousDatabaseCharacterSetsOutput"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.list_autonomous_database_character_sets.list_autonomous_database_character_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_odb.types.autonomous_database_character_set_summary.AutonomousDatabaseCharacterSetSummary]":
        _token = next_token
        while True:
    ...
    def list_autonomous_database_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.list_autonomous_database_versions_input.ListAutonomousDatabaseVersionsInput]",
        ) -> OperationResponse[
            "capo_odb.types.list_autonomous_database_versions_output.ListAutonomousDatabaseVersionsOutput"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.list_autonomous_database_versions.list_autonomous_database_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_autonomous_database_versions(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        db_workload: Optional["capo_odb.types.db_workload.DbWorkload"] = None,
    ) -> "Iterator[capo_odb.types.autonomous_database_version_summary.AutonomousDatabaseVersionSummary]":
        _token = next_token
        while True:
    ...
    def list_db_system_shapes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.list_db_system_shapes_input.ListDbSystemShapesInput]",
        ) -> OperationResponse[
            "capo_odb.types.list_db_system_shapes_output.ListDbSystemShapesOutput"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.list_db_system_shapes.list_db_system_shapes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_db_system_shapes(
        ...
        *,
        ...
        availability_zone: Optional[str] = None,
        availability_zone_id: Optional[str] = None,
    ) -> "Iterator[capo_odb.types.db_system_shape_summary.DbSystemShapeSummary]":
        _token = next_token
        while True:
    ...
    def list_gi_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.list_gi_versions_input.ListGiVersionsInput]",
        ) -> OperationResponse[
            "capo_odb.types.list_gi_versions_output.ListGiVersionsOutput"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.list_gi_versions.list_gi_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_gi_versions(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        shape: Optional[str] = None,
    ) -> "Iterator[capo_odb.types.gi_version_summary.GiVersionSummary]":
        _token = next_token
        while True:
    ...
    def list_system_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.list_system_versions_input.ListSystemVersionsInput]",
        ) -> OperationResponse[
            "capo_odb.types.list_system_versions_output.ListSystemVersionsOutput"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.list_system_versions.list_system_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_system_versions(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_odb.types.system_version_summary.SystemVersionSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_odb.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_odb.types.tag_resource_response.TagResourceResponse"
        ]:
            import capo_odb._operations.odb.tag_resource

            output, http_response = capo_odb._operations.odb.tag_resource.tag_resource(
                req.options, req.input
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_odb.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_odb.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_odb._operations.odb.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
