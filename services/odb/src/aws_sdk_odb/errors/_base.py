...
class odbError(Exception):
    """Base class for all odb service errors."""


class ServiceError(odbError):
...
class SerializationError(odbError):
    """Raised when a value cannot be serialized."""


class DeserializationError(odbError):
...
class WaiterFailedError(odbError):
...
class WaiterTimeoutError(odbError):
