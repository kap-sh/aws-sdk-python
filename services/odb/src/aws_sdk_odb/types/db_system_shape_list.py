...
DbSystemShapeList: TypeAlias = list[
    "aws_sdk_odb.types.db_system_shape_summary.DbSystemShapeSummary"
]
...
def serialize_aws_json_1_0(value: DbSystemShapeList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_odb.types.db_system_shape_summary.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> DbSystemShapeList:
    ...
    for item in data:
        out.append(
            aws_sdk_odb.types.db_system_shape_summary.deserialize_aws_json_1_0(item)
        )
    return out
