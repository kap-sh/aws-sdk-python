...
class IamRole(TypedDict):
    ...
    status: NotRequired["aws_sdk_odb.types.iam_role_status.IamRoleStatus"]
...
def serialize_aws_json_1_0(value: IamRole) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = aws_sdk_odb.types.iam_role_status.serialize_aws_json_1_0(
            value["status"]
        )
...
def deserialize_aws_json_1_0(data: dict) -> IamRole:
    ...
    if "status" in data:
        ...
        out["status"] = aws_sdk_odb.types.iam_role_status.deserialize_aws_json_1_0(
            data["status"]
        )
