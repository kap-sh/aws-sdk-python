"""Generated from Smithy shape ``com.amazonaws.odb#AutonomousDatabase``."""
...
class AutonomousDatabase(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: AutonomousDatabase) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> AutonomousDatabase:
    out: AutonomousDatabase = {}  # type: ignore[typeddict-item]
