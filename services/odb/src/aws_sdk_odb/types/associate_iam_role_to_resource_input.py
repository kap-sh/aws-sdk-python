...
class AssociateIamRoleToResourceInput(TypedDict):
...
def serialize_aws_json_1_0(value: AssociateIamRoleToResourceInput) -> dict:
    ...
    import aws_sdk_odb.types.supported_aws_integration
    out["awsIntegration"] = aws_sdk_odb.types.supported_aws_integration.serialize_aws_json_1_0(value["aws_integration"])
...
def deserialize_aws_json_1_0(data: dict) -> AssociateIamRoleToResourceInput:
    ...
    if "iamRoleArn" in data:
        ...
        raise DeserializationError("AssociateIamRoleToResourceInput.iam_role_arn required")
    if "awsIntegration" in data:
        import aws_sdk_odb.types.supported_aws_integration
        out["aws_integration"] = aws_sdk_odb.types.supported_aws_integration.deserialize_aws_json_1_0(data["awsIntegration"])
    else:
        raise DeserializationError("AssociateIamRoleToResourceInput.aws_integration required")
    if "resourceArn" in data:
        out["resource_arn"] = data["resourceArn"]
    else:
        raise DeserializationError("AssociateIamRoleToResourceInput.resource_arn required")
    return out