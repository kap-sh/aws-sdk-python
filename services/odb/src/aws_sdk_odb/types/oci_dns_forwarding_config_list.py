...
if TYPE_CHECKING:
    import aws_sdk_odb.types.oci_dns_forwarding_config

OciDnsForwardingConfigList: TypeAlias = list[
    "aws_sdk_odb.types.oci_dns_forwarding_config.OciDnsForwardingConfig"
]
...
def serialize_aws_json_1_0(value: OciDnsForwardingConfigList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_odb.types.oci_dns_forwarding_config.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> OciDnsForwardingConfigList:
    ...
    for item in data:
        out.append(
            aws_sdk_odb.types.oci_dns_forwarding_config.deserialize_aws_json_1_0(item)
        )
    return out
