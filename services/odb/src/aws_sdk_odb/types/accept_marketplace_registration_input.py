...
class AcceptMarketplaceRegistrationInput(TypedDict):
...
def deserialize_aws_json_1_0(data: dict) -> AcceptMarketplaceRegistrationInput:
    ...
    if "marketplaceRegistrationToken" in data:
        ...
        raise DeserializationError("AcceptMarketplaceRegistrationInput.marketplace_registration_token required")
    return out