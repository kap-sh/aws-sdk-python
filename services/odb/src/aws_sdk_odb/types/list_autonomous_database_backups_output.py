...
class ListAutonomousDatabaseBackupsOutput(TypedDict):
    next_token: NotRequired["str"]
    """<p>The token to include in another request to get the next page of items. This value is <code>null</code> when there are no more items to return.</p>"""
    autonomous_database_backups: (
        "aws_sdk_odb.types.autonomous_database_backup_list.AutonomousDatabaseBackupList"
    )
...
def serialize_aws_json_1_0(value: ListAutonomousDatabaseBackupsOutput) -> dict:
    ...
    out["autonomousDatabaseBackups"] = (
        aws_sdk_odb.types.autonomous_database_backup_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListAutonomousDatabaseBackupsOutput:
    ...
    if "autonomousDatabaseBackups" in data:
        ...
        out["autonomous_database_backups"] = (
            aws_sdk_odb.types.autonomous_database_backup_list.deserialize_aws_json_1_0(
