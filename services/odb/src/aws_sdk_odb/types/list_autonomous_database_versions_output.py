...
if TYPE_CHECKING:
    import aws_sdk_odb.types.autonomous_database_version_list


class ListAutonomousDatabaseVersionsOutput(TypedDict):
    next_token: NotRequired["str"]
    """<p>The token to include in another request to get the next page of items. This value is <code>null</code> when there are no more items to return.</p>"""
    autonomous_database_versions: "aws_sdk_odb.types.autonomous_database_version_list.AutonomousDatabaseVersionList"
...
def serialize_aws_json_1_0(value: ListAutonomousDatabaseVersionsOutput) -> dict:
    ...
    out["autonomousDatabaseVersions"] = (
        aws_sdk_odb.types.autonomous_database_version_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListAutonomousDatabaseVersionsOutput:
    ...
    if "autonomousDatabaseVersions" in data:
        ...
        out["autonomous_database_versions"] = (
            aws_sdk_odb.types.autonomous_database_version_list.deserialize_aws_json_1_0(
