...
class SystemVersionSummary(TypedDict, closed=True):
    ...
    system_versions: NotRequired["aws_sdk_odb.types.string_list.StringList"]
...
def serialize_aws_json_1_0(value: SystemVersionSummary) -> dict:
    ...
    if "system_versions" in value:
        ...
        out["systemVersions"] = aws_sdk_odb.types.string_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> SystemVersionSummary:
    ...
    if "systemVersions" in data:
        ...
        out["system_versions"] = aws_sdk_odb.types.string_list.deserialize_aws_json_1_0(
            data["systemVersions"]
        )
    return out
