...
AutonomousDatabaseVersionList: TypeAlias = list[
    "aws_sdk_odb.types.autonomous_database_version_summary.AutonomousDatabaseVersionSummary"
]
...
def serialize_aws_json_1_0(value: AutonomousDatabaseVersionList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_odb.types.autonomous_database_version_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> AutonomousDatabaseVersionList:
    ...
    for item in data:
        out.append(
            aws_sdk_odb.types.autonomous_database_version_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
