...
AutonomousDatabaseList: TypeAlias = list[
    "aws_sdk_odb.types.autonomous_database_summary.AutonomousDatabaseSummary"
]
...
def serialize_aws_json_1_0(value: AutonomousDatabaseList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_odb.types.autonomous_database_summary.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> AutonomousDatabaseList:
    ...
    for item in data:
        out.append(
            aws_sdk_odb.types.autonomous_database_summary.deserialize_aws_json_1_0(item)
        )
    return out
