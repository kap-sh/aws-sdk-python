...
CloudExadataInfrastructureList: TypeAlias = list[
    "aws_sdk_odb.types.cloud_exadata_infrastructure_summary.CloudExadataInfrastructureSummary"
]
...
def serialize_aws_json_1_0(value: CloudExadataInfrastructureList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_odb.types.cloud_exadata_infrastructure_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> CloudExadataInfrastructureList:
    ...
    for item in data:
        out.append(
            aws_sdk_odb.types.cloud_exadata_infrastructure_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
