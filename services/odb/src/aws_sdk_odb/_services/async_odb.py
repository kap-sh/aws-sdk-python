...
from aws_sdk_odb._services._aws_config import aaws_config
...
class AsyncodbClientConfig(TypedDict, total=False):
...
class AsyncodbClient:
    ...
    async def accept_marketplace_registration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.accept_marketplace_registration_input.AcceptMarketplaceRegistrationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.accept_marketplace_registration_output.AcceptMarketplaceRegistrationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.accept_marketplace_registration.async_accept_marketplace_registration(
    ...
    async def associate_iam_role_to_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.associate_iam_role_to_resource_input.AssociateIamRoleToResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.associate_iam_role_to_resource_output.AssociateIamRoleToResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.associate_iam_role_to_resource.async_associate_iam_role_to_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_iam_role_from_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.disassociate_iam_role_from_resource_input.DisassociateIamRoleFromResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.disassociate_iam_role_from_resource_output.DisassociateIamRoleFromResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.disassociate_iam_role_from_resource.async_disassociate_iam_role_from_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_oci_onboarding_status(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.get_oci_onboarding_status_input.GetOciOnboardingStatusInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.get_oci_onboarding_status_output.GetOciOnboardingStatusOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.get_oci_onboarding_status.async_get_oci_onboarding_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def initialize_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.initialize_service_input.InitializeServiceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.initialize_service_output.InitializeServiceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.initialize_service.async_initialize_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_autonomous_database_character_sets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.list_autonomous_database_character_sets_input.ListAutonomousDatabaseCharacterSetsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.list_autonomous_database_character_sets_output.ListAutonomousDatabaseCharacterSetsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.list_autonomous_database_character_sets.async_list_autonomous_database_character_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_odb.types.autonomous_database_character_set_summary.AutonomousDatabaseCharacterSetSummary]":
        _token = next_token
        while True:
    ...
    async def list_autonomous_database_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.list_autonomous_database_versions_input.ListAutonomousDatabaseVersionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.list_autonomous_database_versions_output.ListAutonomousDatabaseVersionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.list_autonomous_database_versions.async_list_autonomous_database_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_autonomous_database_versions(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        db_workload: Optional["aws_sdk_odb.types.db_workload.DbWorkload"] = None,
    ) -> "AsyncIterator[aws_sdk_odb.types.autonomous_database_version_summary.AutonomousDatabaseVersionSummary]":
        _token = next_token
        while True:
    ...
    async def list_db_system_shapes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.list_db_system_shapes_input.ListDbSystemShapesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.list_db_system_shapes_output.ListDbSystemShapesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.list_db_system_shapes.async_list_db_system_shapes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_db_system_shapes(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_odb.types.db_system_shape_summary.DbSystemShapeSummary]"
    ):
        _token = next_token
        while True:
    ...
    async def list_gi_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.list_gi_versions_input.ListGiVersionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.list_gi_versions_output.ListGiVersionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.list_gi_versions.async_list_gi_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_gi_versions(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        shape: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_odb.types.gi_version_summary.GiVersionSummary]":
        _token = next_token
        while True:
    ...
    async def list_system_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.list_system_versions_input.ListSystemVersionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.list_system_versions_output.ListSystemVersionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.list_system_versions.async_list_system_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_system_versions(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_odb.types.system_version_summary.SystemVersionSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_odb.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_odb.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_odb._operations.odb.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
