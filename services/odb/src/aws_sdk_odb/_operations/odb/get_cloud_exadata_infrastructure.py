"""Generated from Smithy shape ``com.amazonaws.odb#GetCloudExadataInfrastructure``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_cloud_exadata_infrastructure_output.GetCloudExadataInfrastructureOutput = aws_sdk_odb.types.get_cloud_exadata_infrastructure_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_cloud_exadata_infrastructure_input.GetCloudExadataInfrastructureInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.GetCloudExadataInfrastructure"
    body: bytes | None = b""
...
async def async_get_cloud_exadata_infrastructure(
