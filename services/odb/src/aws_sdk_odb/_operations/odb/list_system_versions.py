...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_system_versions_output.ListSystemVersionsOutput = (
        aws_sdk_odb.types.list_system_versions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_system_versions_input.ListSystemVersionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.list_system_versions_input.serialize_aws_json_1_0(input_)
    ).encode()
