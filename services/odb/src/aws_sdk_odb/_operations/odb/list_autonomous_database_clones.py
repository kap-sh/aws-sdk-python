"""Generated from Smithy shape ``com.amazonaws.odb#ListAutonomousDatabaseClones``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_autonomous_database_clones_output.ListAutonomousDatabaseClonesOutput = aws_sdk_odb.types.list_autonomous_database_clones_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_autonomous_database_clones_input.ListAutonomousDatabaseClonesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{autonomousDatabaseId}", quote(str(input_["autonomous_database_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    headers["X-Amz-Target"] = "Odb.ListAutonomousDatabaseClones"
    body: bytes | None = b""
...
async def async_list_autonomous_database_clones(
