...
def build_request(
    ...
    input: aws_sdk_odb.types.list_autonomous_database_clones_input.ListAutonomousDatabaseClonesInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{autonomousDatabaseId}", quote(str(input["autonomous_database_id"]), safe="")
    )
    params: dict[str, str] = {}
