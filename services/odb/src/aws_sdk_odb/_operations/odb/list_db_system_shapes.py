"""Generated from Smithy shape ``com.amazonaws.odb#ListDbSystemShapes``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_db_system_shapes_output.ListDbSystemShapesOutput = (
        aws_sdk_odb.types.list_db_system_shapes_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_db_system_shapes_input.ListDbSystemShapesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.ListDbSystemShapes"
    import aws_sdk_odb.types.list_db_system_shapes_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.list_db_system_shapes_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_list_db_system_shapes(
