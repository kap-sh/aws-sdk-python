"""Generated from Smithy shape ``com.amazonaws.odb#CreateCloudAutonomousVmCluster``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_odb.errors.service_quota_exceeded_exception

            raise aws_sdk_odb.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_odb.types.create_cloud_autonomous_vm_cluster_output.CreateCloudAutonomousVmClusterOutput = aws_sdk_odb.types.create_cloud_autonomous_vm_cluster_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.create_cloud_autonomous_vm_cluster_input.CreateCloudAutonomousVmClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.CreateCloudAutonomousVmCluster"
    import aws_sdk_odb.types.create_cloud_autonomous_vm_cluster_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.create_cloud_autonomous_vm_cluster_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_cloud_autonomous_vm_cluster(
