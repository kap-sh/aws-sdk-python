...
def build_request(
    ...
    input: aws_sdk_odb.types.create_cloud_vm_cluster_input.CreateCloudVmClusterInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.create_cloud_vm_cluster_input.serialize_aws_json_1_0(input)
    ).encode()
