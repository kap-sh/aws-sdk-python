"""Generated from Smithy shape ``com.amazonaws.odb#CreateCloudVmCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.create_cloud_vm_cluster_output.CreateCloudVmClusterOutput = (
        aws_sdk_odb.types.create_cloud_vm_cluster_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.create_cloud_vm_cluster_input.CreateCloudVmClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.CreateCloudVmCluster"
    import aws_sdk_odb.types.create_cloud_vm_cluster_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.create_cloud_vm_cluster_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_create_cloud_vm_cluster(
