...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_odb_networks_output.ListOdbNetworksOutput = (
        aws_sdk_odb.types.list_odb_networks_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_odb_networks_input.ListOdbNetworksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_odb_networks(
    ...
    aws_sdk_odb.types.list_odb_networks_output.ListOdbNetworksOutput, zapros.Response
]:
