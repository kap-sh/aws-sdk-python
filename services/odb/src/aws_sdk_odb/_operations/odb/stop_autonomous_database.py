"""Generated from Smithy shape ``com.amazonaws.odb#StopAutonomousDatabase``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.stop_autonomous_database_output.StopAutonomousDatabaseOutput = aws_sdk_odb.types.stop_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.stop_autonomous_database_input.StopAutonomousDatabaseInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.StopAutonomousDatabase"
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.stop_autonomous_database_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_stop_autonomous_database(
