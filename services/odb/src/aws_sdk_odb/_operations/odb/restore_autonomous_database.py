"""Generated from Smithy shape ``com.amazonaws.odb#RestoreAutonomousDatabase``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.restore_autonomous_database_output.RestoreAutonomousDatabaseOutput = aws_sdk_odb.types.restore_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.restore_autonomous_database_input.RestoreAutonomousDatabaseInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_restore_autonomous_database(
