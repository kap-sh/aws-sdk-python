"""Generated from Smithy shape ``com.amazonaws.odb#GetDbServer``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_db_server_output.GetDbServerOutput = (
        aws_sdk_odb.types.get_db_server_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_db_server_input.GetDbServerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{dbServerId}", quote(str(input_["db_server_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Odb.GetDbServer"
    body: bytes | None = b""
...
def get_db_server(
    ...
    input_: aws_sdk_odb.types.get_db_server_input.GetDbServerInput,
) -> tuple[aws_sdk_odb.types.get_db_server_output.GetDbServerOutput, zapros.Response]:
