...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_autonomous_database_output.GetAutonomousDatabaseOutput = aws_sdk_odb.types.get_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_autonomous_database_input.GetAutonomousDatabaseInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
