...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_odb_peering_connection_output.GetOdbPeeringConnectionOutput = aws_sdk_odb.types.get_odb_peering_connection_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_odb_peering_connection_input.GetOdbPeeringConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
