"""Generated from Smithy shape ``com.amazonaws.odb#InitializeService``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.initialize_service_output.InitializeServiceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_odb.types.initialize_service_input.InitializeServiceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.InitializeService"
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.initialize_service_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def initialize_service(
    ...
    aws_sdk_odb.types.initialize_service_output.InitializeServiceOutput, zapros.Response
]:
