"""Generated from Smithy shape ``com.amazonaws.odb#ListDbServers``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_db_servers_output.ListDbServersOutput = (
        aws_sdk_odb.types.list_db_servers_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_db_servers_input.ListDbServersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.ListDbServers"
    body: bytes | None = b""
...
def list_db_servers(
    ...
    aws_sdk_odb.types.list_db_servers_output.ListDbServersOutput, zapros.Response
]:
...
async def async_list_db_servers(
