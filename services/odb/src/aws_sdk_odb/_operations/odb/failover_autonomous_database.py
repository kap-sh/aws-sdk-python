"""Generated from Smithy shape ``com.amazonaws.odb#FailoverAutonomousDatabase``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.failover_autonomous_database_output.FailoverAutonomousDatabaseOutput = aws_sdk_odb.types.failover_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.failover_autonomous_database_input.FailoverAutonomousDatabaseInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.FailoverAutonomousDatabase"
    import aws_sdk_odb.types.failover_autonomous_database_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.failover_autonomous_database_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_failover_autonomous_database(
