...
import aws_sdk_odb.types.autonomous_database_backup_list
...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_autonomous_database_backups_output.ListAutonomousDatabaseBackupsOutput = aws_sdk_odb.types.list_autonomous_database_backups_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_autonomous_database_backups_input.ListAutonomousDatabaseBackupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.list_autonomous_database_backups_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
