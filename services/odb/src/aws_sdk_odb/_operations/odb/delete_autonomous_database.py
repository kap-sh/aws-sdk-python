...
def handle_response(
    ...
    out: aws_sdk_odb.types.delete_autonomous_database_output.DeleteAutonomousDatabaseOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_odb.types.delete_autonomous_database_input.DeleteAutonomousDatabaseInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
