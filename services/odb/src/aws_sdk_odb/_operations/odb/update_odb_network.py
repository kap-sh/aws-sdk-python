...
def build_request(
    ...
    input: aws_sdk_odb.types.update_odb_network_input.UpdateOdbNetworkInput,
) -> zapros.Request:
    ...
    url = url.replace("{odbNetworkId}", quote(str(input["odb_network_id"]), safe=""))
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.update_odb_network_input.serialize_aws_json_1_0(input)
    ).encode()
