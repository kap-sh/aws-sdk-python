"""Generated from Smithy shape ``com.amazonaws.odb#ListGiVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_gi_versions_output.ListGiVersionsOutput = (
        aws_sdk_odb.types.list_gi_versions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_gi_versions_input.ListGiVersionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.ListGiVersions"
    import aws_sdk_odb.types.list_gi_versions_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.list_gi_versions_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_gi_versions(
    ...
    aws_sdk_odb.types.list_gi_versions_output.ListGiVersionsOutput, zapros.Response
]:
...
async def async_list_gi_versions(
