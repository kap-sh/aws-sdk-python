...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_autonomous_virtual_machines_output.ListAutonomousVirtualMachinesOutput = aws_sdk_odb.types.list_autonomous_virtual_machines_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_autonomous_virtual_machines_input.ListAutonomousVirtualMachinesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
