...
def handle_response(
    ...
    out: aws_sdk_odb.types.create_odb_peering_connection_output.CreateOdbPeeringConnectionOutput = aws_sdk_odb.types.create_odb_peering_connection_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.create_odb_peering_connection_input.CreateOdbPeeringConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
