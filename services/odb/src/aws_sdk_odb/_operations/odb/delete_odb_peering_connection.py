...
def handle_response(
    ...
    out: aws_sdk_odb.types.delete_odb_peering_connection_output.DeleteOdbPeeringConnectionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_odb.types.delete_odb_peering_connection_input.DeleteOdbPeeringConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
