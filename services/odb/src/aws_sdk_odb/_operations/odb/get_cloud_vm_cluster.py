"""Generated from Smithy shape ``com.amazonaws.odb#GetCloudVmCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_cloud_vm_cluster_output.GetCloudVmClusterOutput = (
        aws_sdk_odb.types.get_cloud_vm_cluster_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_cloud_vm_cluster_input.GetCloudVmClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.GetCloudVmCluster"
    body: bytes | None = b""
...
async def async_get_cloud_vm_cluster(
