"""Generated from Smithy shape ``com.amazonaws.odb#GetCloudAutonomousVmCluster``."""
...
import aws_sdk_odb.types.cloud_autonomous_vm_cluster
...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_cloud_autonomous_vm_cluster_output.GetCloudAutonomousVmClusterOutput = aws_sdk_odb.types.get_cloud_autonomous_vm_cluster_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_cloud_autonomous_vm_cluster_input.GetCloudAutonomousVmClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["cloud_autonomous_vm_cluster_id"]), safe=""),
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Odb.GetCloudAutonomousVmCluster"
    body: bytes | None = b""
...
async def async_get_cloud_autonomous_vm_cluster(
