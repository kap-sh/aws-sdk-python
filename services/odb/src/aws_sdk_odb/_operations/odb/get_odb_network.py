"""Generated from Smithy shape ``com.amazonaws.odb#GetOdbNetwork``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_odb_network_output.GetOdbNetworkOutput = (
        aws_sdk_odb.types.get_odb_network_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_odb_network_input.GetOdbNetworkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.GetOdbNetwork"
    body: bytes | None = b""
...
def get_odb_network(
    ...
    aws_sdk_odb.types.get_odb_network_output.GetOdbNetworkOutput, zapros.Response
]:
...
async def async_get_odb_network(
