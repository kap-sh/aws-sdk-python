...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_cloud_autonomous_vm_clusters_output.ListCloudAutonomousVmClustersOutput = aws_sdk_odb.types.list_cloud_autonomous_vm_clusters_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_cloud_autonomous_vm_clusters_input.ListCloudAutonomousVmClustersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.list_cloud_autonomous_vm_clusters_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
