"""Generated from Smithy shape ``com.amazonaws.odb#ListCloudVmClusters``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_cloud_vm_clusters_output.ListCloudVmClustersOutput = (
        aws_sdk_odb.types.list_cloud_vm_clusters_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_odb.types.list_cloud_vm_clusters_input.ListCloudVmClustersInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.list_cloud_vm_clusters_input.serialize_aws_json_1_0(input)
    ).encode()
...
async def async_list_cloud_vm_clusters(
