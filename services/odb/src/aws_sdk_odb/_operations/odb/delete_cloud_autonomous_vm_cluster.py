...
def handle_response(
    ...
    out: aws_sdk_odb.types.delete_cloud_autonomous_vm_cluster_output.DeleteCloudAutonomousVmClusterOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_odb.types.delete_cloud_autonomous_vm_cluster_input.DeleteCloudAutonomousVmClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
