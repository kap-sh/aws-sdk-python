...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_autonomous_database_character_sets_output.ListAutonomousDatabaseCharacterSetsOutput = aws_sdk_odb.types.list_autonomous_database_character_sets_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_autonomous_database_character_sets_input.ListAutonomousDatabaseCharacterSetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.list_autonomous_database_character_sets_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
