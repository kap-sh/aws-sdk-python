...
def handle_response(
    ...
    out: aws_sdk_odb.types.stop_db_node_output.StopDbNodeOutput = (
        aws_sdk_odb.types.stop_db_node_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.stop_db_node_input.StopDbNodeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def stop_db_node(
    ...
    input_: aws_sdk_odb.types.stop_db_node_input.StopDbNodeInput,
) -> tuple[aws_sdk_odb.types.stop_db_node_output.StopDbNodeOutput, zapros.Response]:
