...
def handle_response(
    ...
    out: aws_sdk_odb.types.create_odb_network_output.CreateOdbNetworkOutput = (
        aws_sdk_odb.types.create_odb_network_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.create_odb_network_input.CreateOdbNetworkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.create_odb_network_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_odb_network(
    ...
    aws_sdk_odb.types.create_odb_network_output.CreateOdbNetworkOutput, zapros.Response
]:
