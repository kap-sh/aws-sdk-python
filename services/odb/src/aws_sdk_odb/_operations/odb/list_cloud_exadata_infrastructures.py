"""Generated from Smithy shape ``com.amazonaws.odb#ListCloudExadataInfrastructures``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_cloud_exadata_infrastructures_output.ListCloudExadataInfrastructuresOutput = aws_sdk_odb.types.list_cloud_exadata_infrastructures_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_cloud_exadata_infrastructures_input.ListCloudExadataInfrastructuresInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.ListCloudExadataInfrastructures"
    body: bytes | None = b""
...
async def async_list_cloud_exadata_infrastructures(
