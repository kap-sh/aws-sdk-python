"""Generated from Smithy shape ``com.amazonaws.odb#CreateCloudExadataInfrastructure``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.create_cloud_exadata_infrastructure_output.CreateCloudExadataInfrastructureOutput = aws_sdk_odb.types.create_cloud_exadata_infrastructure_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.create_cloud_exadata_infrastructure_input.CreateCloudExadataInfrastructureInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_cloud_exadata_infrastructure(
