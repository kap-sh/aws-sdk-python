...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_oci_onboarding_status_output.GetOciOnboardingStatusOutput = aws_sdk_odb.types.get_oci_onboarding_status_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_oci_onboarding_status_input.GetOciOnboardingStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
