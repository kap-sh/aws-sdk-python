...
def handle_response(
    ...
    out: aws_sdk_odb.types.delete_autonomous_database_backup_output.DeleteAutonomousDatabaseBackupOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_odb.types.delete_autonomous_database_backup_input.DeleteAutonomousDatabaseBackupInput,
) -> zapros.Request:
