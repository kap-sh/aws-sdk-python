...
def handle_response(
    ...
    out: aws_sdk_odb.types.start_db_node_output.StartDbNodeOutput = (
        aws_sdk_odb.types.start_db_node_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.start_db_node_input.StartDbNodeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def start_db_node(
    ...
    input_: aws_sdk_odb.types.start_db_node_input.StartDbNodeInput,
) -> tuple[aws_sdk_odb.types.start_db_node_output.StartDbNodeOutput, zapros.Response]:
