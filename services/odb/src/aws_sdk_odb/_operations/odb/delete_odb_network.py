"""Generated from Smithy shape ``com.amazonaws.odb#DeleteOdbNetwork``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.delete_odb_network_output.DeleteOdbNetworkOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_odb.types.delete_odb_network_input.DeleteOdbNetworkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.DeleteOdbNetwork"
    import aws_sdk_odb.types.delete_odb_network_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.delete_odb_network_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_odb_network(
    ...
    aws_sdk_odb.types.delete_odb_network_output.DeleteOdbNetworkOutput, zapros.Response
]:
...
async def async_delete_odb_network(
