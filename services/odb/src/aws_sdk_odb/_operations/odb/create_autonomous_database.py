...
def handle_response(
    ...
    out: aws_sdk_odb.types.create_autonomous_database_output.CreateAutonomousDatabaseOutput = aws_sdk_odb.types.create_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_odb.types.create_autonomous_database_input.CreateAutonomousDatabaseInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.create_autonomous_database_input.serialize_aws_json_1_0(input)
    ).encode()
