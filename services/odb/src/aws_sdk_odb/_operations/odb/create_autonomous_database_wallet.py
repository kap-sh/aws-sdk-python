"""Generated from Smithy shape ``com.amazonaws.odb#CreateAutonomousDatabaseWallet``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.create_autonomous_database_wallet_output.CreateAutonomousDatabaseWalletOutput = aws_sdk_odb.types.create_autonomous_database_wallet_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.create_autonomous_database_wallet_input.CreateAutonomousDatabaseWalletInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.CreateAutonomousDatabaseWallet"
    import aws_sdk_odb.types.create_autonomous_database_wallet_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.create_autonomous_database_wallet_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_autonomous_database_wallet(
