"""Generated from Smithy shape ``com.amazonaws.odb#ShrinkAutonomousDatabase``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.shrink_autonomous_database_output.ShrinkAutonomousDatabaseOutput = aws_sdk_odb.types.shrink_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_odb.types.shrink_autonomous_database_input.ShrinkAutonomousDatabaseInput,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "Odb.ShrinkAutonomousDatabase"
    import aws_sdk_odb.types.shrink_autonomous_database_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.shrink_autonomous_database_input.serialize_aws_json_1_0(input)
    ).encode()
...
async def async_shrink_autonomous_database(
