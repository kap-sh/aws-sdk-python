...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_autonomous_database_versions_output.ListAutonomousDatabaseVersionsOutput = aws_sdk_odb.types.list_autonomous_database_versions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_autonomous_database_versions_input.ListAutonomousDatabaseVersionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.list_autonomous_database_versions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
