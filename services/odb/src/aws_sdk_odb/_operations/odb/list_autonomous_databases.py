"""Generated from Smithy shape ``com.amazonaws.odb#ListAutonomousDatabases``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_autonomous_databases_output.ListAutonomousDatabasesOutput = aws_sdk_odb.types.list_autonomous_databases_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_autonomous_databases_input.ListAutonomousDatabasesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.ListAutonomousDatabases"
    body: bytes | None = b""
...
async def async_list_autonomous_databases(
