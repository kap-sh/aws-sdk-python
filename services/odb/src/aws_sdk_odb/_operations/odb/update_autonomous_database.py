...
def build_request(
    ...
    input_: aws_sdk_odb.types.update_autonomous_database_input.UpdateAutonomousDatabaseInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.update_autonomous_database_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
