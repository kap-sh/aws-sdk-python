...
def handle_response(
    ...
    out: aws_sdk_odb.types.update_autonomous_database_output.UpdateAutonomousDatabaseOutput = aws_sdk_odb.types.update_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_odb.types.update_autonomous_database_input.UpdateAutonomousDatabaseInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.update_autonomous_database_input.serialize_aws_json_1_0(input)
    ).encode()
