"""Generated from Smithy shape ``com.amazonaws.odb#ListOdbPeeringConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_odb_peering_connections_output.ListOdbPeeringConnectionsOutput = aws_sdk_odb.types.list_odb_peering_connections_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_odb_peering_connections_input.ListOdbPeeringConnectionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.ListOdbPeeringConnections"
    import aws_sdk_odb.types.list_odb_peering_connections_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.list_odb_peering_connections_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_odb_peering_connections(
