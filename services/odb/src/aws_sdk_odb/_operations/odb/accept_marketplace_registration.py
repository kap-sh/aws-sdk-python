...
def handle_response(
    ...
    out: aws_sdk_odb.types.accept_marketplace_registration_output.AcceptMarketplaceRegistrationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_odb.types.accept_marketplace_registration_input.AcceptMarketplaceRegistrationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.accept_marketplace_registration_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
