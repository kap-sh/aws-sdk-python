...
def build_request(
    ...
    input: aws_sdk_odb.types.update_cloud_exadata_infrastructure_input.UpdateCloudExadataInfrastructureInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["cloud_exadata_infrastructure_id"]), safe=""),
    )
    params: dict[str, str] = {}
