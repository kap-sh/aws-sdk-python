"""Generated from Smithy shape ``com.amazonaws.odb#UpdateCloudExadataInfrastructure``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.update_cloud_exadata_infrastructure_output.UpdateCloudExadataInfrastructureOutput = aws_sdk_odb.types.update_cloud_exadata_infrastructure_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.update_cloud_exadata_infrastructure_input.UpdateCloudExadataInfrastructureInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Odb.UpdateCloudExadataInfrastructure"
    import aws_sdk_odb.types.update_cloud_exadata_infrastructure_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.update_cloud_exadata_infrastructure_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_cloud_exadata_infrastructure(
