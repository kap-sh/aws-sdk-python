...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_autonomous_database_wallet_details_output.GetAutonomousDatabaseWalletDetailsOutput = aws_sdk_odb.types.get_autonomous_database_wallet_details_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_autonomous_database_wallet_details_input.GetAutonomousDatabaseWalletDetailsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
