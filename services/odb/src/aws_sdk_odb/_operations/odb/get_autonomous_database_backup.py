...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_autonomous_database_backup_output.GetAutonomousDatabaseBackupOutput = aws_sdk_odb.types.get_autonomous_database_backup_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_autonomous_database_backup_input.GetAutonomousDatabaseBackupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
