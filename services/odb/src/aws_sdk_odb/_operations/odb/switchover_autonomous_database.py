...
def handle_response(
    ...
    out: aws_sdk_odb.types.switchover_autonomous_database_output.SwitchoverAutonomousDatabaseOutput = aws_sdk_odb.types.switchover_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.switchover_autonomous_database_input.SwitchoverAutonomousDatabaseInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.switchover_autonomous_database_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
