...
def build_request(
    ...
    input: aws_sdk_odb.types.start_autonomous_database_input.StartAutonomousDatabaseInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.start_autonomous_database_input.serialize_aws_json_1_0(input)
    ).encode()
