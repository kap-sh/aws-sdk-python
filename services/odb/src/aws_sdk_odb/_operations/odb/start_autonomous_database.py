...
def handle_response(
    ...
    out: aws_sdk_odb.types.start_autonomous_database_output.StartAutonomousDatabaseOutput = aws_sdk_odb.types.start_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.start_autonomous_database_input.StartAutonomousDatabaseInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.start_autonomous_database_input.serialize_aws_json_1_0(input_)
    ).encode()
