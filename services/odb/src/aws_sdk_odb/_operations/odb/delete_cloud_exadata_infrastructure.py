...
def handle_response(
    ...
    out: aws_sdk_odb.types.delete_cloud_exadata_infrastructure_output.DeleteCloudExadataInfrastructureOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_odb.types.delete_cloud_exadata_infrastructure_input.DeleteCloudExadataInfrastructureInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
