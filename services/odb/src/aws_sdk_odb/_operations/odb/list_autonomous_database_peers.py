...
def handle_response(
    ...
    out: aws_sdk_odb.types.list_autonomous_database_peers_output.ListAutonomousDatabasePeersOutput = aws_sdk_odb.types.list_autonomous_database_peers_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.list_autonomous_database_peers_input.ListAutonomousDatabasePeersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
