"""Generated from Smithy shape ``com.amazonaws.odb#RebootAutonomousDatabase``."""
...
def handle_response(
    ...
    out: aws_sdk_odb.types.reboot_autonomous_database_output.RebootAutonomousDatabaseOutput = aws_sdk_odb.types.reboot_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_odb.types.reboot_autonomous_database_input.RebootAutonomousDatabaseInput,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "Odb.RebootAutonomousDatabase"
    import aws_sdk_odb.types.reboot_autonomous_database_input

    body: bytes | None = json.dumps(
        aws_sdk_odb.types.reboot_autonomous_database_input.serialize_aws_json_1_0(input)
    ).encode()
...
async def async_reboot_autonomous_database(
