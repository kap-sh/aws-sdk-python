...
def handle_response(
    ...
    out: aws_sdk_odb.types.get_cloud_exadata_infrastructure_unallocated_resources_output.GetCloudExadataInfrastructureUnallocatedResourcesOutput = aws_sdk_odb.types.get_cloud_exadata_infrastructure_unallocated_resources_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_odb.types.get_cloud_exadata_infrastructure_unallocated_resources_input.GetCloudExadataInfrastructureUnallocatedResourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_odb.types.get_cloud_exadata_infrastructure_unallocated_resources_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
