...
def handle_response(
    ...
    out: aws_sdk_odb.types.delete_cloud_vm_cluster_output.DeleteCloudVmClusterOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_odb.types.delete_cloud_vm_cluster_input.DeleteCloudVmClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
