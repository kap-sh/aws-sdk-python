"""Generated from Smithy shape ``com.amazonaws.simspaceweaver#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.simspaceweaver#ServiceQuotaExceededException``."""
