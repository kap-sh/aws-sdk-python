...
class SimSpaceWeaverError(Exception):
    """Base class for all SimSpaceWeaver service errors."""


class ServiceError(SimSpaceWeaverError):
...
class SerializationError(SimSpaceWeaverError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SimSpaceWeaverError):
...
class WaiterFailedError(SimSpaceWeaverError):
...
class WaiterTimeoutError(SimSpaceWeaverError):
