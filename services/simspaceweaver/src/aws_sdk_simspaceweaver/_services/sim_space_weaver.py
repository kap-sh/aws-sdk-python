...
from aws_sdk_simspaceweaver._resources.sim_space_weaver.simulation import Simulation
from aws_sdk_simspaceweaver._services._aws_config import aws_config
...
class SimSpaceWeaverClientConfig(TypedDict, total=False, closed=True):
...
class SimSpaceWeaverClient:
    ...
    def __init__(
        ...
        self._config = SimSpaceWeaverClientConfig(
            {
