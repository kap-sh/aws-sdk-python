"""Generated from Smithy shape ``com.amazonaws.simspaceweaver#DeleteSimulation``."""
...
def handle_response(
    ...
    out: capo_simspaceweaver.types.delete_simulation_output.DeleteSimulationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/deletesimulation"
    params: dict[str, str] = {}
...
async def async_delete_simulation(
