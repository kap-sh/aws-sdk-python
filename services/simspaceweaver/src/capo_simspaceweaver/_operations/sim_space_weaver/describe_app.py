...
def handle_response(
    ...
    out: capo_simspaceweaver.types.describe_app_output.DescribeAppOutput = (
        capo_simspaceweaver.types.describe_app_output.deserialize_json(
...
def describe_app(
    ...
    capo_simspaceweaver.types.describe_app_output.DescribeAppOutput, zapros.Response
]:
