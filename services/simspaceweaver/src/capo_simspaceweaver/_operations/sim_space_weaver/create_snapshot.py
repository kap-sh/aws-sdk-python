...
def handle_response(
    ...
    out: capo_simspaceweaver.types.create_snapshot_output.CreateSnapshotOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_simspaceweaver.types.create_snapshot_input.serialize_json(input_)
    ).encode()
