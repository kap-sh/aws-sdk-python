...
def handle_response(
    ...
    out: capo_simspaceweaver.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_simspaceweaver.types.list_tags_for_resource_output.deserialize_json(
