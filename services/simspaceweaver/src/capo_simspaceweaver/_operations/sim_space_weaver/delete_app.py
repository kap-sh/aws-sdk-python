"""Generated from Smithy shape ``com.amazonaws.simspaceweaver#DeleteApp``."""
...
def handle_response(
    ...
    out: capo_simspaceweaver.types.delete_app_output.DeleteAppOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/deleteapp"
    params: dict[str, str] = {}
...
def delete_app(
    ...
    capo_simspaceweaver.types.delete_app_output.DeleteAppOutput, zapros.Response
]:
