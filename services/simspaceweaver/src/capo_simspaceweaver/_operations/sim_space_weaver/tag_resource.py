"""Generated from Smithy shape ``com.amazonaws.simspaceweaver#TagResource``."""
...
import capo_simspaceweaver.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_simspaceweaver.errors.too_many_tags_exception.TooManyTagsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_simspaceweaver.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_simspaceweaver.types.tag_resource_input.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_simspaceweaver.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
