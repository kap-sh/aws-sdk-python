...
def handle_response(
    ...
    out: capo_simspaceweaver.types.start_simulation_output.StartSimulationOutput = (
        capo_simspaceweaver.types.start_simulation_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_simspaceweaver.types.start_simulation_input.serialize_json(input_)
    ).encode()
