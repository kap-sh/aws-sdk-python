...
if TYPE_CHECKING:
    import capo_simspaceweaver.types.port_number


class SimulationAppPortMapping(TypedDict, closed=True):
    declared: NotRequired["capo_simspaceweaver.types.port_number.PortNumber"]
    ...
    actual: NotRequired["capo_simspaceweaver.types.port_number.PortNumber"]
