...
```
pip install aws-sdk-simspaceweaver
```

## Usage

```python
from aws_sdk_simspaceweaver import AsyncSimSpaceWeaverClient
...
```python
from aws_sdk_simspaceweaver import AsyncSimSpaceWeaverClient
from aws_sdk_simspaceweaver.error import ResourceNotFoundException
