"""Generated from Smithy shape ``com.amazonaws.m2#ListDataSetImportHistoryRequest``."""
...
class ListDataSetImportHistoryRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListDataSetImportHistoryRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListDataSetImportHistoryRequest:
    out: ListDataSetImportHistoryRequest = {}  # type: ignore[typeddict-item]
    return out
