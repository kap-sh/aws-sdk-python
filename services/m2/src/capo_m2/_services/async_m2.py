...
from capo_m2._services._aws_config import aaws_config
...
class Asyncm2ClientConfig(TypedDict, total=False, closed=True):
...
class Asyncm2Client:
    ...
    def __init__(
        ...
        self._config = Asyncm2ClientConfig(
            {
    ...
    async def get_signed_bluinsights_url(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await capo_m2._operations.aws_supernova_control_plane_service.get_signed_bluinsights_url.async_get_signed_bluinsights_url(
                req.options
            )
    ...
    async def list_engine_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_m2.types.list_engine_versions_request.ListEngineVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_m2.types.list_engine_versions_response.ListEngineVersionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_m2._operations.aws_supernova_control_plane_service.list_engine_versions.async_list_engine_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_m2.types.list_engine_versions_request.ListEngineVersionsRequest = {}  # type: ignore[typeddict-item]
    ...
    async def iter_list_engine_versions(
        ...
        *,
        ...
        next_token: Optional["capo_m2.types.next_token.NextToken"] = None,
        max_results: Optional["capo_m2.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_m2.types.engine_versions_summary.EngineVersionsSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_m2.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_m2.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_m2._operations.aws_supernova_control_plane_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_m2.types.list_tags_for_resource_request.ListTagsForResourceRequest = {}  # type: ignore[typeddict-item]
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_m2.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_m2.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_m2._operations.aws_supernova_control_plane_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_m2.types.tag_resource_request.TagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_m2.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_m2.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_m2._operations.aws_supernova_control_plane_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_m2.types.untag_resource_request.UntagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
