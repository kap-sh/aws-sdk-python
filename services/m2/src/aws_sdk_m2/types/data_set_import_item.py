...
if TYPE_CHECKING:
    import aws_sdk_m2.types.data_set
...
def serialize_json(value: DataSetImportItem) -> dict:
    ...
    out["dataSet"] = aws_sdk_m2.types.data_set.serialize_json(value["data_set"])
    import aws_sdk_m2.types.external_location
...
def deserialize_json(data: dict) -> DataSetImportItem:
    ...
    if "dataSet" in data:
        ...
        out["data_set"] = aws_sdk_m2.types.data_set.deserialize_json(data["dataSet"])
    else:
