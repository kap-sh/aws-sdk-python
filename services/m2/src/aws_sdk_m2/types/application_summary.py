...
if TYPE_CHECKING:
    import aws_sdk_m2.types.application_deployment_lifecycle
...
class ApplicationSummary(TypedDict, closed=True):
    ...
    version_status: NotRequired[
        "aws_sdk_m2.types.application_version_lifecycle.ApplicationVersionLifecycle"
    ]
    """<p>Indicates the status of the latest version of the application.</p>"""
    deployment_status: NotRequired[
        "aws_sdk_m2.types.application_deployment_lifecycle.ApplicationDeploymentLifecycle"
    ]
