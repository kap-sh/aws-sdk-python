...
if TYPE_CHECKING:
    import aws_sdk_m2.types.batch_param_key
    import aws_sdk_m2.types.batch_param_value

BatchJobParametersMap: TypeAlias = dict[
    "aws_sdk_m2.types.batch_param_key.BatchParamKey",
    "aws_sdk_m2.types.batch_param_value.BatchParamValue",
]
