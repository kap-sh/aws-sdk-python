...
BatchJobDefinitions: TypeAlias = list[
    "aws_sdk_m2.types.batch_job_definition.BatchJobDefinition"
]
...
def serialize_json(value: BatchJobDefinitions) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_m2.types.batch_job_definition.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> BatchJobDefinitions:
    ...
    for item in data:
        out.append(aws_sdk_m2.types.batch_job_definition.deserialize_json(item))
    return out
