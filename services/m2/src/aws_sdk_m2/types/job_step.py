...
class JobStep(TypedDict):
    step_number: "aws_sdk_m2.types.integer.Integer"
    """<p>The number of a step.</p>"""
    step_name: NotRequired["str"]
    """<p>The name of a step.</p>"""
    proc_step_number: "aws_sdk_m2.types.integer.Integer"
    ...
    step_restartable: "aws_sdk_m2.types.boolean.Boolean"
    ...
    step_checkpoint_time: NotRequired["aws_sdk_m2.types.timestamp.Timestamp"]
    """<p>The step-level checkpoint status for an Amazon Web Services Blu Age application batch job.</p>"""
...
def serialize_json(value: JobStep) -> dict:
    ...
    if "step_checkpoint_time" in value:
        ...
        out["stepCheckpointTime"] = aws_sdk_m2.types.timestamp.serialize_json(
...
def deserialize_json(data: dict) -> JobStep:
    ...
    if "stepCheckpointTime" in data:
        ...
        out["step_checkpoint_time"] = aws_sdk_m2.types.timestamp.deserialize_json(
