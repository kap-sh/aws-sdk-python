...
class DataSetExportSummary(TypedDict):
    ...
    failed: "aws_sdk_m2.types.integer.Integer"
    """<p>The number of data set exports that have failed.</p>"""
    pending: "aws_sdk_m2.types.integer.Integer"
    """<p>The number of data set exports that are pending.</p>"""
    in_progress: "aws_sdk_m2.types.integer.Integer"
    """<p>The number of data set exports that are in progress.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: DataSetExportSummary) -> dict:
    out: dict = {}
