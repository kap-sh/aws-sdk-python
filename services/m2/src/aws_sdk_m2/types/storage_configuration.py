...
if TYPE_CHECKING:
    import aws_sdk_m2.types.efs_storage_configuration
...
def serialize_json(value: StorageConfiguration) -> dict:
    if "efs" in value:
        ...
        return {
            "efs": aws_sdk_m2.types.efs_storage_configuration.serialize_json(
                value["efs"]
            )
        }
    elif "fsx" in value:
        ...
        return {
            "fsx": aws_sdk_m2.types.fsx_storage_configuration.serialize_json(
                value["fsx"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> StorageConfiguration:
    if "efs" in data:
        ...
        return {
            "efs": aws_sdk_m2.types.efs_storage_configuration.deserialize_json(
                data["efs"]
            )
        }
    elif "fsx" in data:
        ...
        return {
            "fsx": aws_sdk_m2.types.fsx_storage_configuration.deserialize_json(
                data["fsx"]
            )
        }
    else:
