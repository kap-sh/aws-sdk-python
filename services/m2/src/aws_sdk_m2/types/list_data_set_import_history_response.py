...
class ListDataSetImportHistoryResponse(TypedDict):
    data_set_import_tasks: (
        "aws_sdk_m2.types.data_set_import_task_list.DataSetImportTaskList"
    )
...
def serialize_json(value: ListDataSetImportHistoryResponse) -> dict:
    ...
    out["dataSetImportTasks"] = (
        aws_sdk_m2.types.data_set_import_task_list.serialize_json(
...
def deserialize_json(data: dict) -> ListDataSetImportHistoryResponse:
    ...
    if "dataSetImportTasks" in data:
        ...
        out["data_set_import_tasks"] = (
            aws_sdk_m2.types.data_set_import_task_list.deserialize_json(
