...
if TYPE_CHECKING:
    import aws_sdk_m2.types.gdg_attributes
    import aws_sdk_m2.types.po_attributes
    import aws_sdk_m2.types.ps_attributes
...
def serialize_json(value: DatasetOrgAttributes) -> dict:
    if "vsam" in value:
        ...
        return {"vsam": aws_sdk_m2.types.vsam_attributes.serialize_json(value["vsam"])}
    elif "gdg" in value:
        import aws_sdk_m2.types.gdg_attributes

        return {"gdg": aws_sdk_m2.types.gdg_attributes.serialize_json(value["gdg"])}
    elif "po" in value:
        import aws_sdk_m2.types.po_attributes

        return {"po": aws_sdk_m2.types.po_attributes.serialize_json(value["po"])}
    elif "ps" in value:
        import aws_sdk_m2.types.ps_attributes

        return {"ps": aws_sdk_m2.types.ps_attributes.serialize_json(value["ps"])}
    else:
...
def deserialize_json(data: dict) -> DatasetOrgAttributes:
    if "vsam" in data:
        ...
        return {"vsam": aws_sdk_m2.types.vsam_attributes.deserialize_json(data["vsam"])}
    elif "gdg" in data:
        import aws_sdk_m2.types.gdg_attributes

        return {"gdg": aws_sdk_m2.types.gdg_attributes.deserialize_json(data["gdg"])}
    elif "po" in data:
        import aws_sdk_m2.types.po_attributes

        return {"po": aws_sdk_m2.types.po_attributes.deserialize_json(data["po"])}
    elif "ps" in data:
        import aws_sdk_m2.types.ps_attributes

        return {"ps": aws_sdk_m2.types.ps_attributes.deserialize_json(data["ps"])}
    else:
