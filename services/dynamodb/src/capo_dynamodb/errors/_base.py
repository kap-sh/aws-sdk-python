...
class DynamoDBError(Exception):
    """Base class for all DynamoDB service errors."""


class ServiceError(DynamoDBError):
...
class SerializationError(DynamoDBError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DynamoDBError):
...
class WaiterFailedError(DynamoDBError):
...
class WaiterTimeoutError(DynamoDBError):
