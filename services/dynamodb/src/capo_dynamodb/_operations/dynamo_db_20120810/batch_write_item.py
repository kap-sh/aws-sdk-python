...
def handle_response(
    ...
    out: capo_dynamodb.types.batch_write_item_output.BatchWriteItemOutput = (
        capo_dynamodb.types.batch_write_item_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.batch_write_item_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def batch_write_item(
    ...
    capo_dynamodb.types.batch_write_item_output.BatchWriteItemOutput, zapros.Response
]:
