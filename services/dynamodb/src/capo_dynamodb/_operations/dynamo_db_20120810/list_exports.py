...
def handle_response(
    ...
    out: capo_dynamodb.types.list_exports_output.ListExportsOutput = (
        capo_dynamodb.types.list_exports_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.list_exports_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_exports(
    ...
    input_: capo_dynamodb.types.list_exports_input.ListExportsInput,
) -> tuple[capo_dynamodb.types.list_exports_output.ListExportsOutput, zapros.Response]:
