...
def handle_response(
    ...
    out: capo_dynamodb.types.delete_table_output.DeleteTableOutput = (
        capo_dynamodb.types.delete_table_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.delete_table_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_table(
    ...
    input_: capo_dynamodb.types.delete_table_input.DeleteTableInput,
) -> tuple[capo_dynamodb.types.delete_table_output.DeleteTableOutput, zapros.Response]:
