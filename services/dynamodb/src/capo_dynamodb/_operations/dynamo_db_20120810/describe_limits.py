...
def handle_response(
    ...
    out: capo_dynamodb.types.describe_limits_output.DescribeLimitsOutput = (
        capo_dynamodb.types.describe_limits_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.describe_limits_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_limits(
    ...
    capo_dynamodb.types.describe_limits_output.DescribeLimitsOutput, zapros.Response
]:
