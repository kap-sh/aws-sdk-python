...
import capo_dynamodb.errors.conditional_check_failed_exception
import capo_dynamodb.errors.internal_server_error
import capo_dynamodb.errors.invalid_endpoint_exception
import capo_dynamodb.errors.item_collection_size_limit_exceeded_exception
import capo_dynamodb.errors.provisioned_throughput_exceeded_exception
import capo_dynamodb.errors.replicated_write_conflict_exception
...
import capo_dynamodb.errors.transaction_conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReplicatedWriteConflictException":
            raise capo_dynamodb.errors.replicated_write_conflict_exception.ReplicatedWriteConflictException.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_dynamodb.types.put_item_output.PutItemOutput = (
        capo_dynamodb.types.put_item_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.put_item_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def put_item(
    options: OperationOptions, input_: capo_dynamodb.types.put_item_input.PutItemInput
) -> tuple[capo_dynamodb.types.put_item_output.PutItemOutput, zapros.Response]:
