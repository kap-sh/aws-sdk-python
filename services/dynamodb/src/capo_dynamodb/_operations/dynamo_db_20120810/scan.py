...
def handle_response(
    ...
    out: capo_dynamodb.types.scan_output.ScanOutput = (
        capo_dynamodb.types.scan_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: capo_dynamodb.types.scan_input.ScanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.scan_input.serialize_aws_json_1_0(input_), allow_nan=False
    ).encode()
...
def scan(
    options: OperationOptions, input_: capo_dynamodb.types.scan_input.ScanInput
) -> tuple[capo_dynamodb.types.scan_output.ScanOutput, zapros.Response]:
...
async def async_scan(
    options: AsyncOperationOptions, input_: capo_dynamodb.types.scan_input.ScanInput
) -> tuple[capo_dynamodb.types.scan_output.ScanOutput, zapros.Response]:
