...
def handle_response(
    ...
    out: capo_dynamodb.types.list_backups_output.ListBackupsOutput = (
        capo_dynamodb.types.list_backups_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.list_backups_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_backups(
    ...
    input_: capo_dynamodb.types.list_backups_input.ListBackupsInput,
) -> tuple[capo_dynamodb.types.list_backups_output.ListBackupsOutput, zapros.Response]:
