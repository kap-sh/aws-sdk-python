...
import capo_dynamodb.errors.import_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ImportNotFoundException":
            raise capo_dynamodb.errors.import_not_found_exception.ImportNotFoundException.from_aws_json_1_0(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_dynamodb.types.describe_import_output.DescribeImportOutput = (
        capo_dynamodb.types.describe_import_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.describe_import_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_import(
    ...
    capo_dynamodb.types.describe_import_output.DescribeImportOutput, zapros.Response
]:
