...
import capo_dynamodb.errors.replica_already_exists_exception
import capo_dynamodb.errors.replica_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReplicaAlreadyExistsException":
            raise capo_dynamodb.errors.replica_already_exists_exception.ReplicaAlreadyExistsException.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_dynamodb.types.update_global_table_output.UpdateGlobalTableOutput = (
        capo_dynamodb.types.update_global_table_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.update_global_table_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
