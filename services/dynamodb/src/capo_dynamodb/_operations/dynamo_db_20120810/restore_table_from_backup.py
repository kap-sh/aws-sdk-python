"""Generated from Smithy shape ``com.amazonaws.dynamodb#RestoreTableFromBackup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BackupNotFoundException":
            raise capo_dynamodb.errors.backup_not_found_exception.BackupNotFoundException.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_dynamodb.types.restore_table_from_backup_output.RestoreTableFromBackupOutput = capo_dynamodb.types.restore_table_from_backup_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.restore_table_from_backup_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
