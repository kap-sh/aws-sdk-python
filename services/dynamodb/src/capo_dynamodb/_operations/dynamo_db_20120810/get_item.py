...
def handle_response(
    ...
    out: capo_dynamodb.types.get_item_output.GetItemOutput = (
        capo_dynamodb.types.get_item_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.get_item_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_item(
    options: OperationOptions, input_: capo_dynamodb.types.get_item_input.GetItemInput
) -> tuple[capo_dynamodb.types.get_item_output.GetItemOutput, zapros.Response]:
