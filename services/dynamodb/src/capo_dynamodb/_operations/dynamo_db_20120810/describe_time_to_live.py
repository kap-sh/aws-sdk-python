...
def handle_response(
    ...
    out: capo_dynamodb.types.describe_time_to_live_output.DescribeTimeToLiveOutput = (
        capo_dynamodb.types.describe_time_to_live_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.describe_time_to_live_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
