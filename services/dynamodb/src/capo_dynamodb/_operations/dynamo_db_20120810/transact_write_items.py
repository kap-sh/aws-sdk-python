...
import capo_dynamodb.errors.idempotent_parameter_mismatch_exception
...
import capo_dynamodb.errors.transaction_canceled_exception
import capo_dynamodb.errors.transaction_in_progress_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "IdempotentParameterMismatchException":
            raise capo_dynamodb.errors.idempotent_parameter_mismatch_exception.IdempotentParameterMismatchException.from_aws_json_1_0(
                data, message
            )
        ...
        case "TransactionCanceledException":
            raise capo_dynamodb.errors.transaction_canceled_exception.TransactionCanceledException.from_aws_json_1_0(
                data, message
            )
        case "TransactionInProgressException":
            raise capo_dynamodb.errors.transaction_in_progress_exception.TransactionInProgressException.from_aws_json_1_0(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_dynamodb.types.transact_write_items_output.TransactWriteItemsOutput = (
        capo_dynamodb.types.transact_write_items_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.transact_write_items_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
