...
def handle_response(
    ...
    out: capo_dynamodb.types.list_imports_output.ListImportsOutput = (
        capo_dynamodb.types.list_imports_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DynamoDB_20120810.ListImports"
    body: bytes | None = json.dumps(
        capo_dynamodb.types.list_imports_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_imports(
    ...
    input_: capo_dynamodb.types.list_imports_input.ListImportsInput,
) -> tuple[capo_dynamodb.types.list_imports_output.ListImportsOutput, zapros.Response]:
