...
def handle_response(
    ...
    out: capo_dynamodb.types.describe_table_replica_auto_scaling_output.DescribeTableReplicaAutoScalingOutput = capo_dynamodb.types.describe_table_replica_auto_scaling_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.describe_table_replica_auto_scaling_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
