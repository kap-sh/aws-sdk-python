...
def handle_response(
    ...
    out: capo_dynamodb.types.describe_table_output.DescribeTableOutput = (
        capo_dynamodb.types.describe_table_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.describe_table_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_table(
    ...
    capo_dynamodb.types.describe_table_output.DescribeTableOutput, zapros.Response
]:
