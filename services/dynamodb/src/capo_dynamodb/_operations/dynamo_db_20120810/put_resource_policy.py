...
import capo_dynamodb.errors.policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyNotFoundException":
            raise capo_dynamodb.errors.policy_not_found_exception.PolicyNotFoundException.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_dynamodb.types.put_resource_policy_output.PutResourcePolicyOutput = (
        capo_dynamodb.types.put_resource_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.put_resource_policy_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
