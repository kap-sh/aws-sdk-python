...
import capo_dynamodb.errors.export_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ExportNotFoundException":
            raise capo_dynamodb.errors.export_not_found_exception.ExportNotFoundException.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_dynamodb.types.describe_export_output.DescribeExportOutput = (
        capo_dynamodb.types.describe_export_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    endpoint = resolve(
        EndpointParams(
            ...
            ResourceArn=input_.get("export_arn"),
    ...
    headers["X-Amz-Target"] = "DynamoDB_20120810.DescribeExport"
    body: bytes | None = json.dumps(
        capo_dynamodb.types.describe_export_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_export(
    ...
    capo_dynamodb.types.describe_export_output.DescribeExportOutput, zapros.Response
]:
