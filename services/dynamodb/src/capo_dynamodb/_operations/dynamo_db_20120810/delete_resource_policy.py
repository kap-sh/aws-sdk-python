...
def handle_response(
    ...
    out: capo_dynamodb.types.delete_resource_policy_output.DeleteResourcePolicyOutput = capo_dynamodb.types.delete_resource_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DynamoDB_20120810.DeleteResourcePolicy"
    body: bytes | None = json.dumps(
        capo_dynamodb.types.delete_resource_policy_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
