...
def handle_response(
    ...
    out: capo_dynamodb.types.update_continuous_backups_output.UpdateContinuousBackupsOutput = capo_dynamodb.types.update_continuous_backups_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.update_continuous_backups_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
