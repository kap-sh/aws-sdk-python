...
def handle_response(
    ...
    out: capo_dynamodb.types.delete_item_output.DeleteItemOutput = (
        capo_dynamodb.types.delete_item_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.delete_item_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def delete_item(
    ...
    input_: capo_dynamodb.types.delete_item_input.DeleteItemInput,
) -> tuple[capo_dynamodb.types.delete_item_output.DeleteItemOutput, zapros.Response]:
