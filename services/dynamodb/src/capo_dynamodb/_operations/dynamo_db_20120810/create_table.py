...
def handle_response(
    ...
    out: capo_dynamodb.types.create_table_output.CreateTableOutput = (
        capo_dynamodb.types.create_table_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.create_table_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def create_table(
    ...
    input_: capo_dynamodb.types.create_table_input.CreateTableInput,
) -> tuple[capo_dynamodb.types.create_table_output.CreateTableOutput, zapros.Response]:
