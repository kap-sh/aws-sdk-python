...
import capo_dynamodb.errors.global_table_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GlobalTableAlreadyExistsException":
            raise capo_dynamodb.errors.global_table_already_exists_exception.GlobalTableAlreadyExistsException.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_dynamodb.types.create_global_table_output.CreateGlobalTableOutput = (
        capo_dynamodb.types.create_global_table_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.create_global_table_input.serialize_aws_json_1_0(input_)
    ).encode()
