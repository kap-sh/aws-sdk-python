...
def handle_response(
    ...
    out: capo_dynamodb.types.list_tags_of_resource_output.ListTagsOfResourceOutput = (
        capo_dynamodb.types.list_tags_of_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.list_tags_of_resource_input.serialize_aws_json_1_0(input_)
    ).encode()
