...
def handle_response(
    ...
    out: capo_dynamodb.types.delete_backup_output.DeleteBackupOutput = (
        capo_dynamodb.types.delete_backup_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.delete_backup_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def delete_backup(
    ...
    capo_dynamodb.types.delete_backup_output.DeleteBackupOutput, zapros.Response
]:
