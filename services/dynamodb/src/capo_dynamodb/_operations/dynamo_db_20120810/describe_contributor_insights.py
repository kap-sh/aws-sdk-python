...
def handle_response(
    ...
    out: capo_dynamodb.types.describe_contributor_insights_output.DescribeContributorInsightsOutput = capo_dynamodb.types.describe_contributor_insights_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.describe_contributor_insights_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
