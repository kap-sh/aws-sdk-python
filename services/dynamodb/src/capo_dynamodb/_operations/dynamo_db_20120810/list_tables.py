"""Generated from Smithy shape ``com.amazonaws.dynamodb#ListTables``."""
...
def handle_response(
    ...
    out: capo_dynamodb.types.list_tables_output.ListTablesOutput = (
        capo_dynamodb.types.list_tables_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.list_tables_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_tables(
    ...
    input_: capo_dynamodb.types.list_tables_input.ListTablesInput,
) -> tuple[capo_dynamodb.types.list_tables_output.ListTablesOutput, zapros.Response]:
