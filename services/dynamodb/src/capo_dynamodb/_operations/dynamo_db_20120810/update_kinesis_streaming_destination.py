...
def handle_response(
    ...
    out: capo_dynamodb.types.update_kinesis_streaming_destination_output.UpdateKinesisStreamingDestinationOutput = capo_dynamodb.types.update_kinesis_streaming_destination_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DynamoDB_20120810.UpdateKinesisStreamingDestination"
    body: bytes | None = json.dumps(
        capo_dynamodb.types.update_kinesis_streaming_destination_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
