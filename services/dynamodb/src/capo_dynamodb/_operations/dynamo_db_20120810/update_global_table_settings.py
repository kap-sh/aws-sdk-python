...
import capo_dynamodb.errors.index_not_found_exception
...
def handle_response(
    ...
    out: capo_dynamodb.types.update_global_table_settings_output.UpdateGlobalTableSettingsOutput = capo_dynamodb.types.update_global_table_settings_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.update_global_table_settings_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
