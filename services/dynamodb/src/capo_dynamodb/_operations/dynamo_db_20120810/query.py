...
def handle_response(
    ...
    out: capo_dynamodb.types.query_output.QueryOutput = (
        capo_dynamodb.types.query_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: capo_dynamodb.types.query_input.QueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def query(
    options: OperationOptions, input_: capo_dynamodb.types.query_input.QueryInput
) -> tuple[capo_dynamodb.types.query_output.QueryOutput, zapros.Response]:
...
async def async_query(
    options: AsyncOperationOptions, input_: capo_dynamodb.types.query_input.QueryInput
) -> tuple[capo_dynamodb.types.query_output.QueryOutput, zapros.Response]:
