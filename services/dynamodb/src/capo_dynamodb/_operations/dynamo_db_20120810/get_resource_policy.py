...
def handle_response(
    ...
    out: capo_dynamodb.types.get_resource_policy_output.GetResourcePolicyOutput = (
        capo_dynamodb.types.get_resource_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.get_resource_policy_input.serialize_aws_json_1_0(input_)
    ).encode()
