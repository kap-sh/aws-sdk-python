...
def handle_response(
    ...
    out: capo_dynamodb.types.batch_execute_statement_output.BatchExecuteStatementOutput = capo_dynamodb.types.batch_execute_statement_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DynamoDB_20120810.BatchExecuteStatement"
    body: bytes | None = json.dumps(
        capo_dynamodb.types.batch_execute_statement_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
