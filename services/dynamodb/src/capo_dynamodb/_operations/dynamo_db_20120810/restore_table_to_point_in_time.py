...
import capo_dynamodb.errors.invalid_restore_time_exception
import capo_dynamodb.errors.limit_exceeded_exception
import capo_dynamodb.errors.point_in_time_recovery_unavailable_exception
import capo_dynamodb.errors.table_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRestoreTimeException":
            raise capo_dynamodb.errors.invalid_restore_time_exception.InvalidRestoreTimeException.from_aws_json_1_0(
                data, message
            )
        ...
        case "PointInTimeRecoveryUnavailableException":
            raise capo_dynamodb.errors.point_in_time_recovery_unavailable_exception.PointInTimeRecoveryUnavailableException.from_aws_json_1_0(
                data, message
            )
        case "TableAlreadyExistsException":
            raise capo_dynamodb.errors.table_already_exists_exception.TableAlreadyExistsException.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_dynamodb.types.restore_table_to_point_in_time_output.RestoreTableToPointInTimeOutput = capo_dynamodb.types.restore_table_to_point_in_time_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.restore_table_to_point_in_time_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
