...
import capo_dynamodb.errors.duplicate_item_exception
...
def handle_response(
    ...
    out: capo_dynamodb.types.execute_statement_output.ExecuteStatementOutput = (
        capo_dynamodb.types.execute_statement_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.execute_statement_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def execute_statement(
    ...
    capo_dynamodb.types.execute_statement_output.ExecuteStatementOutput, zapros.Response
]:
