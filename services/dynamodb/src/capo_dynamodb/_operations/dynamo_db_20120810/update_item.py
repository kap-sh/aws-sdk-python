...
def handle_response(
    ...
    out: capo_dynamodb.types.update_item_output.UpdateItemOutput = (
        capo_dynamodb.types.update_item_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dynamodb.types.update_item_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_item(
    ...
    input_: capo_dynamodb.types.update_item_input.UpdateItemInput,
) -> tuple[capo_dynamodb.types.update_item_output.UpdateItemOutput, zapros.Response]:
