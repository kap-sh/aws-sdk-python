...
def handle_response(
    ...
    out: capo_dynamodb.types.kinesis_streaming_destination_output.KinesisStreamingDestinationOutput = capo_dynamodb.types.kinesis_streaming_destination_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DynamoDB_20120810.EnableKinesisStreamingDestination"
    body: bytes | None = json.dumps(
        capo_dynamodb.types.kinesis_streaming_destination_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
