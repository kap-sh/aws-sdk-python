...
def handle_response(
    ...
    out: capo_dynamodb.types.update_table_output.UpdateTableOutput = (
        capo_dynamodb.types.update_table_output.deserialize_aws_json_1_0(
...
def update_table(
    ...
    input_: capo_dynamodb.types.update_table_input.UpdateTableInput,
) -> tuple[capo_dynamodb.types.update_table_output.UpdateTableOutput, zapros.Response]:
