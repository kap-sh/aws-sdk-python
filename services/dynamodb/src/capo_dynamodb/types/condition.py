"""Generated from Smithy shape ``com.amazonaws.dynamodb#Condition``."""
...
class Condition(TypedDict, closed=True):
    attribute_value_list: NotRequired[
        "capo_dynamodb.types.attribute_value_list.AttributeValueList"
    ]
    ...
    comparison_operator: "capo_dynamodb.types.comparison_operator.ComparisonOperator"
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: Condition) -> dict:
    out: dict = {}
    if "attribute_value_list" in value:
        import capo_dynamodb.types.attribute_value_list

        out["AttributeValueList"] = (
            capo_dynamodb.types.attribute_value_list.serialize_aws_json_1_0(
    ...
    out["ComparisonOperator"] = (
        capo_dynamodb.types.comparison_operator.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Condition:
    out: Condition = {}  # type: ignore[typeddict-item]
    if "AttributeValueList" in data:
        import capo_dynamodb.types.attribute_value_list

        out["attribute_value_list"] = (
            capo_dynamodb.types.attribute_value_list.deserialize_aws_json_1_0(
    ...
    if "ComparisonOperator" in data:
        ...
        out["comparison_operator"] = (
            capo_dynamodb.types.comparison_operator.deserialize_aws_json_1_0(
                data["ComparisonOperator"]
            )
        )
    else:
        raise DeserializationError("Condition.comparison_operator required")
    return out
