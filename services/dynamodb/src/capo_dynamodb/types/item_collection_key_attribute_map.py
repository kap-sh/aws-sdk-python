...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(input_to_serialize: ItemCollectionKeyAttributeMap) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ItemCollectionKeyAttributeMap:
    out: ItemCollectionKeyAttributeMap = {}
