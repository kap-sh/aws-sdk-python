...
def serialize_aws_json_1_0(input_to_serialize: BatchGetRequestMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = capo_dynamodb.types.keys_and_attributes.serialize_aws_json_1_0(value)
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchGetRequestMap:
    ...
    for key, value in data.items():
        ...
        out[key] = capo_dynamodb.types.keys_and_attributes.deserialize_aws_json_1_0(
            value
        )
    return out
