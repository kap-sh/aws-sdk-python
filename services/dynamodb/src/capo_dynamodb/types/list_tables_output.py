...
class ListTablesOutput(TypedDict, closed=True):
    table_names: NotRequired["capo_dynamodb.types.table_name_list.TableNameList"]
    ...
    last_evaluated_table_name: NotRequired["capo_dynamodb.types.table_name.TableName"]
...
def serialize_aws_json_1_0(value: ListTablesOutput) -> dict:
    ...
    if "table_names" in value:
        ...
        out["TableNames"] = capo_dynamodb.types.table_name_list.serialize_aws_json_1_0(
            value["table_names"]
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListTablesOutput:
    ...
    if "TableNames" in data:
        ...
        out["table_names"] = (
            capo_dynamodb.types.table_name_list.deserialize_aws_json_1_0(
                data["TableNames"]
            )
        )
