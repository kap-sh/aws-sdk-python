...
class Projection(TypedDict, closed=True):
    projection_type: NotRequired["capo_dynamodb.types.projection_type.ProjectionType"]
    ...
    non_key_attributes: NotRequired[
        "capo_dynamodb.types.non_key_attribute_name_list.NonKeyAttributeNameList"
    ]
...
def serialize_aws_json_1_0(value: Projection) -> dict:
    ...
    if "projection_type" in value:
        ...
        out["ProjectionType"] = (
            capo_dynamodb.types.projection_type.serialize_aws_json_1_0(
    ...
    if "non_key_attributes" in value:
        ...
        out["NonKeyAttributes"] = (
            capo_dynamodb.types.non_key_attribute_name_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Projection:
    ...
    if data.get("ProjectionType") is not None:
        ...
        out["projection_type"] = (
            capo_dynamodb.types.projection_type.deserialize_aws_json_1_0(
                data["ProjectionType"]
            )
        )
    if data.get("NonKeyAttributes") is not None:
        ...
        out["non_key_attributes"] = (
            capo_dynamodb.types.non_key_attribute_name_list.deserialize_aws_json_1_0(
