...
if TYPE_CHECKING:
    import capo_dynamodb.types.local_secondary_index

LocalSecondaryIndexList: TypeAlias = list[
    "capo_dynamodb.types.local_secondary_index.LocalSecondaryIndex"
]
...
def serialize_aws_json_1_0(value: LocalSecondaryIndexList) -> list:
    ...
    for item in value:
        out.append(
            capo_dynamodb.types.local_secondary_index.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> LocalSecondaryIndexList:
    ...
    for item in data:
        out.append(
            capo_dynamodb.types.local_secondary_index.deserialize_aws_json_1_0(item)
        )
    return out
