...
class GlobalTableWitnessDescription(TypedDict, closed=True):
    ...
    witness_status: NotRequired["capo_dynamodb.types.witness_status.WitnessStatus"]
...
def serialize_aws_json_1_0(value: GlobalTableWitnessDescription) -> dict:
    ...
    if "witness_status" in value:
        ...
        out["WitnessStatus"] = (
            capo_dynamodb.types.witness_status.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GlobalTableWitnessDescription:
    ...
    if "WitnessStatus" in data:
        ...
        out["witness_status"] = (
            capo_dynamodb.types.witness_status.deserialize_aws_json_1_0(
                data["WitnessStatus"]
            )
        )
    return out
