...
class AttributeValueUpdate(TypedDict, closed=True):
    value: NotRequired["capo_dynamodb.types.attribute_value.AttributeValue"]
    r"""<p>Represents the data for an attribute.</p> <p>Each attribute value is described as a name-value pair. The name is the data type, and the value is the data itself.</p> <p>For more information, see <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.NamingRulesDataTypes.html#HowItWorks.DataTypes\">Data Types</a> in the <i>Amazon DynamoDB Developer Guide</i>. </p>"""
    action: NotRequired["capo_dynamodb.types.attribute_action.AttributeAction"]
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: AttributeValueUpdate) -> dict:
    out: dict = {}
    if "value" in value:
        import capo_dynamodb.types.attribute_value

        out["Value"] = capo_dynamodb.types.attribute_value.serialize_aws_json_1_0(
            value["value"]
        )
    if "action" in value:
        import capo_dynamodb.types.attribute_action

        out["Action"] = capo_dynamodb.types.attribute_action.serialize_aws_json_1_0(
            value["action"]
        )
    return out
