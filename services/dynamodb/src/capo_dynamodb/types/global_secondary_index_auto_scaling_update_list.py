...
if TYPE_CHECKING:
    import capo_dynamodb.types.global_secondary_index_auto_scaling_update

GlobalSecondaryIndexAutoScalingUpdateList: TypeAlias = list[
    "capo_dynamodb.types.global_secondary_index_auto_scaling_update.GlobalSecondaryIndexAutoScalingUpdate"
]
...
def serialize_aws_json_1_0(value: GlobalSecondaryIndexAutoScalingUpdateList) -> list:
    ...
    for item in value:
        out.append(
            capo_dynamodb.types.global_secondary_index_auto_scaling_update.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> GlobalSecondaryIndexAutoScalingUpdateList:
    ...
    for item in data:
        out.append(
            capo_dynamodb.types.global_secondary_index_auto_scaling_update.deserialize_aws_json_1_0(
                item
            )
        )
    return out
