...
if TYPE_CHECKING:
    ...
    import capo_dynamodb.types.replica_status_description
    import capo_dynamodb.types.replica_status_percent_progress
...
class ReplicaDescription(TypedDict, closed=True):
    ...
    replica_arn: NotRequired["capo_dynamodb.types.string.String"]
    """<p>The Amazon Resource Name (ARN) of the global table replica.</p>"""
    replica_status_description: NotRequired[
        "capo_dynamodb.types.replica_status_description.ReplicaStatusDescription"
    ]
    """<p>Detailed information about the replica status.</p>"""
    replica_status_percent_progress: NotRequired[
        "capo_dynamodb.types.replica_status_percent_progress.ReplicaStatusPercentProgress"
    ]
    ...
    global_secondary_indexes: NotRequired[
        "capo_dynamodb.types.replica_global_secondary_index_description_list.ReplicaGlobalSecondaryIndexDescriptionList"
    ]
    """<p>Replica-specific global secondary index settings.</p>"""
    replica_inaccessible_date_time: NotRequired["capo_dynamodb.types.date.Date"]
...
def serialize_aws_json_1_0(value: ReplicaDescription) -> dict:
    ...
    if "global_secondary_indexes" in value:
        ...
        out["GlobalSecondaryIndexes"] = (
            capo_dynamodb.types.replica_global_secondary_index_description_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ReplicaDescription:
    ...
    if "GlobalSecondaryIndexes" in data:
        ...
        out["global_secondary_indexes"] = (
            capo_dynamodb.types.replica_global_secondary_index_description_list.deserialize_aws_json_1_0(
