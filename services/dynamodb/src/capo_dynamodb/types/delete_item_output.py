...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DeleteItemOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> DeleteItemOutput:
    out: DeleteItemOutput = {}  # type: ignore[typeddict-item]
