...
class CreateTableInput(TypedDict, closed=True):
    ...
    resource_policy: NotRequired["capo_dynamodb.types.resource_policy.ResourcePolicy"]
    ...
    global_table_source_arn: NotRequired["capo_dynamodb.types.table_arn.TableArn"]
