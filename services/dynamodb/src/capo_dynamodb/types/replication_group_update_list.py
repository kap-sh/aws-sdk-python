...
if TYPE_CHECKING:
    import capo_dynamodb.types.replication_group_update

ReplicationGroupUpdateList: TypeAlias = list[
    "capo_dynamodb.types.replication_group_update.ReplicationGroupUpdate"
]
...
def serialize_aws_json_1_0(value: ReplicationGroupUpdateList) -> list:
    ...
    for item in value:
        out.append(
            capo_dynamodb.types.replication_group_update.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ReplicationGroupUpdateList:
    ...
    for item in data:
        out.append(
            capo_dynamodb.types.replication_group_update.deserialize_aws_json_1_0(item)
        )
    return out
