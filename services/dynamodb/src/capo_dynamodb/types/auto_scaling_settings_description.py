...
if TYPE_CHECKING:
    import capo_dynamodb.types.auto_scaling_policy_description_list
...
class AutoScalingSettingsDescription(TypedDict, closed=True):
    ...
    auto_scaling_role_arn: NotRequired["capo_dynamodb.types.string.String"]
    """<p>Role ARN used for configuring the auto scaling policy.</p>"""
    scaling_policies: NotRequired[
        "capo_dynamodb.types.auto_scaling_policy_description_list.AutoScalingPolicyDescriptionList"
    ]
...
def serialize_aws_json_1_0(value: AutoScalingSettingsDescription) -> dict:
    ...
    if "scaling_policies" in value:
        ...
        out["ScalingPolicies"] = (
            capo_dynamodb.types.auto_scaling_policy_description_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> AutoScalingSettingsDescription:
    ...
    if "ScalingPolicies" in data:
        ...
        out["scaling_policies"] = (
            capo_dynamodb.types.auto_scaling_policy_description_list.deserialize_aws_json_1_0(
