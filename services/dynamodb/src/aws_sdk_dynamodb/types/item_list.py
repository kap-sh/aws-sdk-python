...
def serialize_aws_json_1_0(value: ItemList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_dynamodb.types.attribute_map.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> ItemList:
    ...
    out: ItemList = []
    for item in data:
        out.append(aws_sdk_dynamodb.types.attribute_map.deserialize_aws_json_1_0(item))
    return out
