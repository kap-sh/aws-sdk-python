...
def serialize_aws_json_1_0(
    ...
    for item in value:
        out.append(
            aws_sdk_dynamodb.types.global_table_global_secondary_index_settings_update.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(
    ...
    for item in data:
        out.append(
            aws_sdk_dynamodb.types.global_table_global_secondary_index_settings_update.deserialize_aws_json_1_0(
                item
            )
        )
    return out
