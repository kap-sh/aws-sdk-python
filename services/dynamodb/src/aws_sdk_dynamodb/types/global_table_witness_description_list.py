...
def serialize_aws_json_1_0(value: GlobalTableWitnessDescriptionList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_dynamodb.types.global_table_witness_description.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> GlobalTableWitnessDescriptionList:
    ...
    for item in data:
        out.append(
            aws_sdk_dynamodb.types.global_table_witness_description.deserialize_aws_json_1_0(
                item
            )
        )
    return out
