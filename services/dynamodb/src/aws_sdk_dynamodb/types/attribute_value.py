...
def serialize_aws_json_1_0(value: AttributeValue) -> dict:
    if "S" in value:
        ...
        return {
            "B": aws_sdk_dynamodb.types.binary_attribute_value.serialize_aws_json_1_0(
                value["B"]
            )
        }
    elif "SS" in value:
        ...
        return {
            "SS": aws_sdk_dynamodb.types.string_set_attribute_value.serialize_aws_json_1_0(
                value["SS"]
            )
        }
    elif "NS" in value:
        ...
        return {
            "NS": aws_sdk_dynamodb.types.number_set_attribute_value.serialize_aws_json_1_0(
                value["NS"]
            )
        }
    elif "BS" in value:
        ...
        return {
            "BS": aws_sdk_dynamodb.types.binary_set_attribute_value.serialize_aws_json_1_0(
                value["BS"]
            )
        }
    elif "M" in value:
        ...
        return {
            "M": aws_sdk_dynamodb.types.map_attribute_value.serialize_aws_json_1_0(
                value["M"]
            )
        }
    elif "L" in value:
        ...
        return {
            "L": aws_sdk_dynamodb.types.list_attribute_value.serialize_aws_json_1_0(
                value["L"]
            )
        }
    elif "NULL" in value:
...
def deserialize_aws_json_1_0(data: dict) -> AttributeValue:
    if "S" in data:
        ...
        return {
            "B": aws_sdk_dynamodb.types.binary_attribute_value.deserialize_aws_json_1_0(
                data["B"]
            )
        }
    elif "SS" in data:
        ...
        return {
            "SS": aws_sdk_dynamodb.types.string_set_attribute_value.deserialize_aws_json_1_0(
                data["SS"]
            )
        }
    elif "NS" in data:
        ...
        return {
            "NS": aws_sdk_dynamodb.types.number_set_attribute_value.deserialize_aws_json_1_0(
                data["NS"]
            )
        }
    elif "BS" in data:
        ...
        return {
            "BS": aws_sdk_dynamodb.types.binary_set_attribute_value.deserialize_aws_json_1_0(
                data["BS"]
            )
        }
    elif "M" in data:
        ...
        return {
            "M": aws_sdk_dynamodb.types.map_attribute_value.deserialize_aws_json_1_0(
                data["M"]
            )
        }
    elif "L" in data:
        ...
        return {
            "L": aws_sdk_dynamodb.types.list_attribute_value.deserialize_aws_json_1_0(
                data["L"]
            )
        }
    elif "NULL" in data:
