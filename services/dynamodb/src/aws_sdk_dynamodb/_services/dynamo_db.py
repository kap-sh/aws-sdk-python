...
from aws_sdk_dynamodb._services._aws_config import aws_config
from aws_sdk_dynamodb._services._pipeline import (
    Interceptor,
    OperationOptions,
    OperationRequest,
    OperationResponse,
...
from aws_sdk_dynamodb.errors import ServiceError, WaiterTimeoutError
...
if TYPE_CHECKING:
    ...
    import aws_sdk_dynamodb.types.batch_get_item_output
    ...
    import aws_sdk_dynamodb.types.create_backup_output
    ...
    import aws_sdk_dynamodb.types.describe_limits_input
    import aws_sdk_dynamodb.types.describe_limits_output
    ...
    import aws_sdk_dynamodb.types.global_secondary_index_update_list
    ...
    import aws_sdk_dynamodb.types.global_table_witness_group_update_list
    ...
    import aws_sdk_dynamodb.types.key_expression
    ...
    import aws_sdk_dynamodb.types.list_tables_output
    ...
    import aws_sdk_dynamodb.types.replication_group_update_list
...
class DynamoDBClientConfig(TypedDict, total=False, closed=True):
...
class DynamoDBClient:
    ...
    def __init__(
        ...
        self._config = DynamoDBClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[DynamoDBClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: DynamoDBClientConfig = config_overrides or {}
    ...
    def batch_execute_statement(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.batch_execute_statement_input.BatchExecuteStatementInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.batch_execute_statement_output.BatchExecuteStatementOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.batch_execute_statement

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.batch_execute_statement.batch_execute_statement(
    ...
    def batch_get_item(
        self,
        request_items: "aws_sdk_dynamodb.types.batch_get_request_map.BatchGetRequestMap",
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        return_consumed_capacity: Optional[
            "aws_sdk_dynamodb.types.return_consumed_capacity.ReturnConsumedCapacity"
        ] = None,
    ) -> "aws_sdk_dynamodb.types.batch_get_item_output.BatchGetItemOutput":
        ...
        Examples:
            ...
            >>> client.batch_get_item(request_items={'Music': {'Keys': [{'Artist': {'S': 'No One You Know'}, 'SongTitle': {'S': 'Call Me Today'}}, {'Artist': {'S': 'Acme Band'}, 'SongTitle': {'S': 'Happy Day'}}, {'Artist': {'S': 'No One You Know'}, 'SongTitle': {'S': 'Scared of My Shadow'}}], 'ProjectionExpression': 'AlbumTitle'}})
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.batch_get_item_input.BatchGetItemInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.batch_get_item_output.BatchGetItemOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.batch_get_item

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.batch_get_item.batch_get_item(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_write_item(
        self,
        request_items: "aws_sdk_dynamodb.types.batch_write_item_request_map.BatchWriteItemRequestMap",
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        return_consumed_capacity: Optional[
            "aws_sdk_dynamodb.types.return_consumed_capacity.ReturnConsumedCapacity"
        ...
        Raises:
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.item_collection_size_limit_exceeded_exception.ItemCollectionSizeLimitExceededException: <p>An item collection is too large. This exception is only returned for tables that have one or more local secondary indexes.</p>
            aws_sdk_dynamodb.errors.provisioned_throughput_exceeded_exception.ProvisionedThroughputExceededException: <p>The request was denied due to request throttling. For detailed information about why the request was throttled and the ARN of the impacted resource, find the <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html\">ThrottlingReason</a> field in the returned exception. The Amazon Web Services SDKs for DynamoDB automatically retry requests that receive this exception. Your request is eventually successful, unless your retry queue is too large to finish. Reduce the frequency of requests and use exponential backoff. For more information, go to <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Programming.Errors.html#Programming.Errors.RetryAndBackoff\">Error Retries and Exponential Backoff</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
            aws_sdk_dynamodb.errors.replicated_write_conflict_exception.ReplicatedWriteConflictException: <p>The request was rejected because one or more items in the request are being modified by a request in another Region. </p>
            aws_sdk_dynamodb.errors.request_limit_exceeded.RequestLimitExceeded: <p>Throughput exceeds the current throughput quota for your account. For detailed information about why the request was throttled and the ARN of the impacted resource, find the <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html\">ThrottlingReason</a> field in the returned exception. Contact <a href=\"https://aws.amazon.com/support\">Amazon Web Services Support</a> to request a quota increase.</p>
            aws_sdk_dynamodb.errors.resource_not_found_exception.ResourceNotFoundException: <p>The operation tried to access a nonexistent table or index. The resource might not be specified correctly, or its status might not be <code>ACTIVE</code>.</p>
            aws_sdk_dynamodb.errors.throttling_exception.ThrottlingException: <p>The request was denied due to request throttling. For detailed information about why the request was throttled and the ARN of the impacted resource, find the <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html\">ThrottlingReason</a> field in the returned exception.</p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        Examples:
            ...
            >>> client.batch_write_item(request_items={'Music': [{'PutRequest': {'Item': {'AlbumTitle': {'S': 'Somewhat Famous'}, 'SongTitle': {'S': 'Call Me Today'}, 'Artist': {'S': 'No One You Know'}}}}, {'PutRequest': {'Item': {'AlbumTitle': {'S': 'Songs About Life'}, 'SongTitle': {'S': 'Happy Day'}, 'Artist': {'S': 'Acme Band'}}}}, {'PutRequest': {'Item': {'AlbumTitle': {'S': 'Blue Sky Blues'}, 'SongTitle': {'S': 'Scared of My Shadow'}, 'Artist': {'S': 'No One You Know'}}}}]})
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.batch_write_item_input.BatchWriteItemInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.batch_write_item_output.BatchWriteItemOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.batch_write_item

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.batch_write_item.batch_write_item(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_backup(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
    ) -> "aws_sdk_dynamodb.types.create_backup_output.CreateBackupOutput":
        ...
        Raises:
            aws_sdk_dynamodb.errors.backup_in_use_exception.BackupInUseException: <p>There is another ongoing conflicting backup control plane operation on the table. The backup is either being created, deleted or restored to a table.</p>
            aws_sdk_dynamodb.errors.continuous_backups_unavailable_exception.ContinuousBackupsUnavailableException: <p>Backups have not yet been enabled for this table.</p>
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            ...
            aws_sdk_dynamodb.errors.table_in_use_exception.TableInUseException: <p>A target table with the specified name is either being created or deleted. </p>
            aws_sdk_dynamodb.errors.table_not_found_exception.TableNotFoundException: <p>A source table with the name <code>TableName</code> does not currently exist within the subscriber's account or the subscriber is operating in the wrong Amazon Web Services Region.</p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.create_backup_input.CreateBackupInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.create_backup_output.CreateBackupOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.create_backup

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.create_backup.create_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_global_table(
        ...
        *,
        ...
        Raises:
            aws_sdk_dynamodb.errors.global_table_already_exists_exception.GlobalTableAlreadyExistsException: <p>The specified global table already exists.</p>
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.limit_exceeded_exception.LimitExceededException: <p>There is no limit to the number of daily on-demand backups that can be taken. </p> <p>For most purposes, up to 500 simultaneous table operations are allowed per account. These operations include <code>CreateTable</code>, <code>UpdateTable</code>, <code>DeleteTable</code>,<code>UpdateTimeToLive</code>, <code>RestoreTableFromBackup</code>, and <code>RestoreTableToPointInTime</code>. </p> <p>When you are creating a table with one or more secondary indexes, you can have up to 250 such requests running at a time. However, if the table or index specifications are complex, then DynamoDB might temporarily reduce the number of concurrent operations.</p> <p>When importing into DynamoDB, up to 50 simultaneous import table operations are allowed per account.</p> <p>There is a soft account quota of 2,500 tables.</p> <p>GetRecords was called with a value of more than 1000 for the limit request parameter.</p> <p>More than 2 processes are reading from the same streams shard at the same time. Exceeding this limit may result in request throttling.</p>
            aws_sdk_dynamodb.errors.table_not_found_exception.TableNotFoundException: <p>A source table with the name <code>TableName</code> does not currently exist within the subscriber's account or the subscriber is operating in the wrong Amazon Web Services Region.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.create_global_table_input.CreateGlobalTableInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.create_global_table_output.CreateGlobalTableOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.create_global_table

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.create_global_table.create_global_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_table(
        ...
        *,
        ...
        key_schema: Optional["aws_sdk_dynamodb.types.key_schema.KeySchema"] = None,
        ...
        tags: Optional["aws_sdk_dynamodb.types.tag_list.TagList"] = None,
        table_class: Optional["aws_sdk_dynamodb.types.table_class.TableClass"] = None,
    ...
    ) -> "aws_sdk_dynamodb.types.create_table_output.CreateTableOutput":
        ...
        Raises:
            ...
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.limit_exceeded_exception.LimitExceededException: <p>There is no limit to the number of daily on-demand backups that can be taken. </p> <p>For most purposes, up to 500 simultaneous table operations are allowed per account. These operations include <code>CreateTable</code>, <code>UpdateTable</code>, <code>DeleteTable</code>,<code>UpdateTimeToLive</code>, <code>RestoreTableFromBackup</code>, and <code>RestoreTableToPointInTime</code>. </p> <p>When you are creating a table with one or more secondary indexes, you can have up to 250 such requests running at a time. However, if the table or index specifications are complex, then DynamoDB might temporarily reduce the number of concurrent operations.</p> <p>When importing into DynamoDB, up to 50 simultaneous import table operations are allowed per account.</p> <p>There is a soft account quota of 2,500 tables.</p> <p>GetRecords was called with a value of more than 1000 for the limit request parameter.</p> <p>More than 2 processes are reading from the same streams shard at the same time. Exceeding this limit may result in request throttling.</p>
            aws_sdk_dynamodb.errors.resource_in_use_exception.ResourceInUseException: <p>The operation conflicts with the resource's availability. For example:</p> <ul> <li> <p>You attempted to recreate an existing table.</p> </li> <li> <p>You tried to delete a table currently in the <code>CREATING</code> state.</p> </li> <li> <p>You tried to update a resource that was already being updated.</p> </li> </ul> <p>When appropriate, wait for the ongoing update to complete and attempt the request again.</p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.create_table_input.CreateTableInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.create_table_output.CreateTableOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.create_table

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.create_table.create_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_backup(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
    ) -> "aws_sdk_dynamodb.types.delete_backup_output.DeleteBackupOutput":
        ...
        Raises:
            aws_sdk_dynamodb.errors.backup_in_use_exception.BackupInUseException: <p>There is another ongoing conflicting backup control plane operation on the table. The backup is either being created, deleted or restored to a table.</p>
            aws_sdk_dynamodb.errors.backup_not_found_exception.BackupNotFoundException: <p>Backup not found for the given BackupARN. </p>
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.limit_exceeded_exception.LimitExceededException: <p>There is no limit to the number of daily on-demand backups that can be taken. </p> <p>For most purposes, up to 500 simultaneous table operations are allowed per account. These operations include <code>CreateTable</code>, <code>UpdateTable</code>, <code>DeleteTable</code>,<code>UpdateTimeToLive</code>, <code>RestoreTableFromBackup</code>, and <code>RestoreTableToPointInTime</code>. </p> <p>When you are creating a table with one or more secondary indexes, you can have up to 250 such requests running at a time. However, if the table or index specifications are complex, then DynamoDB might temporarily reduce the number of concurrent operations.</p> <p>When importing into DynamoDB, up to 50 simultaneous import table operations are allowed per account.</p> <p>There is a soft account quota of 2,500 tables.</p> <p>GetRecords was called with a value of more than 1000 for the limit request parameter.</p> <p>More than 2 processes are reading from the same streams shard at the same time. Exceeding this limit may result in request throttling.</p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.delete_backup_input.DeleteBackupInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.delete_backup_output.DeleteBackupOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.delete_backup

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.delete_backup.delete_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_item(
        ...
        *,
        ...
        return_values: Optional[
            "aws_sdk_dynamodb.types.return_value.ReturnValue"
        ] = None,
        return_consumed_capacity: Optional[
            "aws_sdk_dynamodb.types.return_consumed_capacity.ReturnConsumedCapacity"
        ] = None,
        ...
        Raises:
            aws_sdk_dynamodb.errors.conditional_check_failed_exception.ConditionalCheckFailedException: <p>A condition specified in the operation failed to be evaluated.</p>
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.item_collection_size_limit_exceeded_exception.ItemCollectionSizeLimitExceededException: <p>An item collection is too large. This exception is only returned for tables that have one or more local secondary indexes.</p>
            aws_sdk_dynamodb.errors.provisioned_throughput_exceeded_exception.ProvisionedThroughputExceededException: <p>The request was denied due to request throttling. For detailed information about why the request was throttled and the ARN of the impacted resource, find the <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html\">ThrottlingReason</a> field in the returned exception. The Amazon Web Services SDKs for DynamoDB automatically retry requests that receive this exception. Your request is eventually successful, unless your retry queue is too large to finish. Reduce the frequency of requests and use exponential backoff. For more information, go to <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Programming.Errors.html#Programming.Errors.RetryAndBackoff\">Error Retries and Exponential Backoff</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
            ...
            aws_sdk_dynamodb.errors.resource_not_found_exception.ResourceNotFoundException: <p>The operation tried to access a nonexistent table or index. The resource might not be specified correctly, or its status might not be <code>ACTIVE</code>.</p>
            aws_sdk_dynamodb.errors.throttling_exception.ThrottlingException: <p>The request was denied due to request throttling. For detailed information about why the request was throttled and the ARN of the impacted resource, find the <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html\">ThrottlingReason</a> field in the returned exception.</p>
            aws_sdk_dynamodb.errors.transaction_conflict_exception.TransactionConflictException: <p>Operation was rejected because there is an ongoing transaction for the item.</p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        Examples:
            ...
            >>> client.delete_item(table_name='Music', key={'Artist': {'S': 'No One You Know'}, 'SongTitle': {'S': 'Scared of My Shadow'}})
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.delete_item_input.DeleteItemInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.delete_item_output.DeleteItemOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.delete_item

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.delete_item.delete_item(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource_policy(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.limit_exceeded_exception.LimitExceededException: <p>There is no limit to the number of daily on-demand backups that can be taken. </p> <p>For most purposes, up to 500 simultaneous table operations are allowed per account. These operations include <code>CreateTable</code>, <code>UpdateTable</code>, <code>DeleteTable</code>,<code>UpdateTimeToLive</code>, <code>RestoreTableFromBackup</code>, and <code>RestoreTableToPointInTime</code>. </p> <p>When you are creating a table with one or more secondary indexes, you can have up to 250 such requests running at a time. However, if the table or index specifications are complex, then DynamoDB might temporarily reduce the number of concurrent operations.</p> <p>When importing into DynamoDB, up to 50 simultaneous import table operations are allowed per account.</p> <p>There is a soft account quota of 2,500 tables.</p> <p>GetRecords was called with a value of more than 1000 for the limit request parameter.</p> <p>More than 2 processes are reading from the same streams shard at the same time. Exceeding this limit may result in request throttling.</p>
            aws_sdk_dynamodb.errors.policy_not_found_exception.PolicyNotFoundException: <p>The operation tried to access a nonexistent resource-based policy.</p> <p>If you specified an <code>ExpectedRevisionId</code>, it's possible that a policy is present for the resource but its revision ID didn't match the expected value.</p>
            aws_sdk_dynamodb.errors.resource_in_use_exception.ResourceInUseException: <p>The operation conflicts with the resource's availability. For example:</p> <ul> <li> <p>You attempted to recreate an existing table.</p> </li> <li> <p>You tried to delete a table currently in the <code>CREATING</code> state.</p> </li> <li> <p>You tried to update a resource that was already being updated.</p> </li> </ul> <p>When appropriate, wait for the ongoing update to complete and attempt the request again.</p>
            aws_sdk_dynamodb.errors.resource_not_found_exception.ResourceNotFoundException: <p>The operation tried to access a nonexistent table or index. The resource might not be specified correctly, or its status might not be <code>ACTIVE</code>.</p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.delete_resource_policy_input.DeleteResourcePolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.delete_resource_policy_output.DeleteResourcePolicyOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.delete_resource_policy

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.delete_resource_policy.delete_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_table(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
    ) -> "aws_sdk_dynamodb.types.delete_table_output.DeleteTableOutput":
        ...
        Examples:
            ...
            >>> client.delete_table(table_name='Music')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.delete_table_input.DeleteTableInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.delete_table_output.DeleteTableOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.delete_table

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.delete_table.delete_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_backup(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
    ) -> "aws_sdk_dynamodb.types.describe_backup_output.DescribeBackupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_backup_input.DescribeBackupInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_backup_output.DescribeBackupOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_backup

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_backup.describe_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_continuous_backups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_continuous_backups_input.DescribeContinuousBackupsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_continuous_backups_output.DescribeContinuousBackupsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_continuous_backups

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_continuous_backups.describe_continuous_backups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_contributor_insights(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        index_name: Optional["aws_sdk_dynamodb.types.index_name.IndexName"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_contributor_insights_input.DescribeContributorInsightsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_contributor_insights_output.DescribeContributorInsightsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_contributor_insights

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_contributor_insights.describe_contributor_insights(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_endpoints(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_endpoints_request.DescribeEndpointsRequest]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_endpoints_response.DescribeEndpointsResponse"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_endpoints

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_endpoints.describe_endpoints(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_export(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
    ) -> "aws_sdk_dynamodb.types.describe_export_output.DescribeExportOutput":
        ...
        Raises:
            aws_sdk_dynamodb.errors.export_not_found_exception.ExportNotFoundException: <p>The specified export was not found.</p>
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.limit_exceeded_exception.LimitExceededException: <p>There is no limit to the number of daily on-demand backups that can be taken. </p> <p>For most purposes, up to 500 simultaneous table operations are allowed per account. These operations include <code>CreateTable</code>, <code>UpdateTable</code>, <code>DeleteTable</code>,<code>UpdateTimeToLive</code>, <code>RestoreTableFromBackup</code>, and <code>RestoreTableToPointInTime</code>. </p> <p>When you are creating a table with one or more secondary indexes, you can have up to 250 such requests running at a time. However, if the table or index specifications are complex, then DynamoDB might temporarily reduce the number of concurrent operations.</p> <p>When importing into DynamoDB, up to 50 simultaneous import table operations are allowed per account.</p> <p>There is a soft account quota of 2,500 tables.</p> <p>GetRecords was called with a value of more than 1000 for the limit request parameter.</p> <p>More than 2 processes are reading from the same streams shard at the same time. Exceeding this limit may result in request throttling.</p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_export_input.DescribeExportInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_export_output.DescribeExportOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_export

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_export.describe_export(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_global_table(
        ...
        *,
        ...
        Raises:
            aws_sdk_dynamodb.errors.global_table_not_found_exception.GlobalTableNotFoundException: <p>The specified global table does not exist.</p>
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_global_table_input.DescribeGlobalTableInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_global_table_output.DescribeGlobalTableOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_global_table

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_global_table.describe_global_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_global_table_settings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_global_table_settings_input.DescribeGlobalTableSettingsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_global_table_settings_output.DescribeGlobalTableSettingsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_global_table_settings

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_global_table_settings.describe_global_table_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_import(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
    ) -> "aws_sdk_dynamodb.types.describe_import_output.DescribeImportOutput":
        ...
        Raises:
            aws_sdk_dynamodb.errors.import_not_found_exception.ImportNotFoundException: <p> The specified import was not found. </p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_import_input.DescribeImportInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_import_output.DescribeImportOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_import

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_import.describe_import(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_kinesis_streaming_destination(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_kinesis_streaming_destination_input.DescribeKinesisStreamingDestinationInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_kinesis_streaming_destination_output.DescribeKinesisStreamingDestinationOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_kinesis_streaming_destination

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_kinesis_streaming_destination.describe_kinesis_streaming_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_limits(
        self, *, config_overrides: Optional[DynamoDBClientConfig] = None
    ) -> "aws_sdk_dynamodb.types.describe_limits_output.DescribeLimitsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_limits_input.DescribeLimitsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_limits_output.DescribeLimitsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_limits

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_limits.describe_limits(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_table(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
    ) -> "aws_sdk_dynamodb.types.describe_table_output.DescribeTableOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_table_input.DescribeTableInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_table_output.DescribeTableOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_table

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_table.describe_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def wait_until_table_not_exists(
        ...
        *,
        ...
        attempt = 0
        while True:
            op_output: "aws_sdk_dynamodb.types.describe_table_output.DescribeTableOutput | None" = None
            op_error: ServiceError | None = None
            try:
                op_output = self.describe_table(  # noqa: F841
    ...
    def describe_table_replica_auto_scaling(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_table_replica_auto_scaling_input.DescribeTableReplicaAutoScalingInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_table_replica_auto_scaling_output.DescribeTableReplicaAutoScalingOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_table_replica_auto_scaling

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_table_replica_auto_scaling.describe_table_replica_auto_scaling(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_time_to_live(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.describe_time_to_live_input.DescribeTimeToLiveInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.describe_time_to_live_output.DescribeTimeToLiveOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_time_to_live

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.describe_time_to_live.describe_time_to_live(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_kinesis_streaming_destination(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.kinesis_streaming_destination_input.KinesisStreamingDestinationInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.kinesis_streaming_destination_output.KinesisStreamingDestinationOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.disable_kinesis_streaming_destination

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.disable_kinesis_streaming_destination.disable_kinesis_streaming_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_kinesis_streaming_destination(
        ...
        *,
        ...
        def _handler(
            ...
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.enable_kinesis_streaming_destination

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.enable_kinesis_streaming_destination.enable_kinesis_streaming_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def execute_statement(
        ...
        *,
        ...
        Raises:
            aws_sdk_dynamodb.errors.conditional_check_failed_exception.ConditionalCheckFailedException: <p>A condition specified in the operation failed to be evaluated.</p>
            aws_sdk_dynamodb.errors.duplicate_item_exception.DuplicateItemException: <p> There was an attempt to insert an item with the same primary key as an item that already exists in the DynamoDB table.</p>
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.item_collection_size_limit_exceeded_exception.ItemCollectionSizeLimitExceededException: <p>An item collection is too large. This exception is only returned for tables that have one or more local secondary indexes.</p>
            aws_sdk_dynamodb.errors.provisioned_throughput_exceeded_exception.ProvisionedThroughputExceededException: <p>The request was denied due to request throttling. For detailed information about why the request was throttled and the ARN of the impacted resource, find the <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html\">ThrottlingReason</a> field in the returned exception. The Amazon Web Services SDKs for DynamoDB automatically retry requests that receive this exception. Your request is eventually successful, unless your retry queue is too large to finish. Reduce the frequency of requests and use exponential backoff. For more information, go to <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Programming.Errors.html#Programming.Errors.RetryAndBackoff\">Error Retries and Exponential Backoff</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
            aws_sdk_dynamodb.errors.request_limit_exceeded.RequestLimitExceeded: <p>Throughput exceeds the current throughput quota for your account. For detailed information about why the request was throttled and the ARN of the impacted resource, find the <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html\">ThrottlingReason</a> field in the returned exception. Contact <a href=\"https://aws.amazon.com/support\">Amazon Web Services Support</a> to request a quota increase.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.execute_statement_input.ExecuteStatementInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.execute_statement_output.ExecuteStatementOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.execute_statement

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.execute_statement.execute_statement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def execute_transaction(
        self,
        transact_statements: "aws_sdk_dynamodb.types.parameterized_statements.ParameterizedStatements",
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
    ...
    def export_table_to_point_in_time(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        export_time: Optional["aws_sdk_dynamodb.types.export_time.ExportTime"] = None,
        client_token: Optional[
            "aws_sdk_dynamodb.types.client_token.ClientToken"
        ] = None,
        s3_bucket_owner: Optional[
            "aws_sdk_dynamodb.types.s3_bucket_owner.S3BucketOwner"
        ] = None,
        s3_prefix: Optional["aws_sdk_dynamodb.types.s3_prefix.S3Prefix"] = None,
        ...
        export_format: Optional[
            "aws_sdk_dynamodb.types.export_format.ExportFormat"
        ] = None,
        export_type: Optional["aws_sdk_dynamodb.types.export_type.ExportType"] = None,
        ...
        Raises:
            aws_sdk_dynamodb.errors.export_conflict_exception.ExportConflictException: <p>There was a conflict when writing to the specified S3 bucket.</p>
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.invalid_export_time_exception.InvalidExportTimeException: <p>The specified <code>ExportTime</code> is outside of the point in time recovery window.</p>
            aws_sdk_dynamodb.errors.limit_exceeded_exception.LimitExceededException: <p>There is no limit to the number of daily on-demand backups that can be taken. </p> <p>For most purposes, up to 500 simultaneous table operations are allowed per account. These operations include <code>CreateTable</code>, <code>UpdateTable</code>, <code>DeleteTable</code>,<code>UpdateTimeToLive</code>, <code>RestoreTableFromBackup</code>, and <code>RestoreTableToPointInTime</code>. </p> <p>When you are creating a table with one or more secondary indexes, you can have up to 250 such requests running at a time. However, if the table or index specifications are complex, then DynamoDB might temporarily reduce the number of concurrent operations.</p> <p>When importing into DynamoDB, up to 50 simultaneous import table operations are allowed per account.</p> <p>There is a soft account quota of 2,500 tables.</p> <p>GetRecords was called with a value of more than 1000 for the limit request parameter.</p> <p>More than 2 processes are reading from the same streams shard at the same time. Exceeding this limit may result in request throttling.</p>
            aws_sdk_dynamodb.errors.point_in_time_recovery_unavailable_exception.PointInTimeRecoveryUnavailableException: <p>Point in time recovery has not yet been enabled for this source table.</p>
            aws_sdk_dynamodb.errors.table_not_found_exception.TableNotFoundException: <p>A source table with the name <code>TableName</code> does not currently exist within the subscriber's account or the subscriber is operating in the wrong Amazon Web Services Region.</p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.export_table_to_point_in_time_input.ExportTableToPointInTimeInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.export_table_to_point_in_time_output.ExportTableToPointInTimeOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.export_table_to_point_in_time

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.export_table_to_point_in_time.export_table_to_point_in_time(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_item(
        ...
        *,
    ...
    ) -> "aws_sdk_dynamodb.types.get_item_output.GetItemOutput":
        ...
        Examples:
            ...
            >>> client.get_item(table_name='Music', key={'Artist': {'S': 'Acme Band'}, 'SongTitle': {'S': 'Happy Day'}})
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.get_item_input.GetItemInput]",
        ) -> OperationResponse["aws_sdk_dynamodb.types.get_item_output.GetItemOutput"]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.get_item

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.get_item.get_item(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.get_resource_policy_input.GetResourcePolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.get_resource_policy_output.GetResourcePolicyOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.get_resource_policy

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.get_resource_policy.get_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_table(
        ...
        table_creation_parameters: "aws_sdk_dynamodb.types.table_creation_parameters.TableCreationParameters",
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        client_token: Optional[
            "aws_sdk_dynamodb.types.client_token.ClientToken"
    ...
    ) -> "aws_sdk_dynamodb.types.import_table_output.ImportTableOutput":
        ...
        Raises:
            aws_sdk_dynamodb.errors.import_conflict_exception.ImportConflictException: <p> There was a conflict when importing from the specified S3 source. This can occur when the current import conflicts with a previous import request that had the same client token. </p>
            aws_sdk_dynamodb.errors.limit_exceeded_exception.LimitExceededException: <p>There is no limit to the number of daily on-demand backups that can be taken. </p> <p>For most purposes, up to 500 simultaneous table operations are allowed per account. These operations include <code>CreateTable</code>, <code>UpdateTable</code>, <code>DeleteTable</code>,<code>UpdateTimeToLive</code>, <code>RestoreTableFromBackup</code>, and <code>RestoreTableToPointInTime</code>. </p> <p>When you are creating a table with one or more secondary indexes, you can have up to 250 such requests running at a time. However, if the table or index specifications are complex, then DynamoDB might temporarily reduce the number of concurrent operations.</p> <p>When importing into DynamoDB, up to 50 simultaneous import table operations are allowed per account.</p> <p>There is a soft account quota of 2,500 tables.</p> <p>GetRecords was called with a value of more than 1000 for the limit request parameter.</p> <p>More than 2 processes are reading from the same streams shard at the same time. Exceeding this limit may result in request throttling.</p>
            aws_sdk_dynamodb.errors.resource_in_use_exception.ResourceInUseException: <p>The operation conflicts with the resource's availability. For example:</p> <ul> <li> <p>You attempted to recreate an existing table.</p> </li> <li> <p>You tried to delete a table currently in the <code>CREATING</code> state.</p> </li> <li> <p>You tried to update a resource that was already being updated.</p> </li> </ul> <p>When appropriate, wait for the ongoing update to complete and attempt the request again.</p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.import_table_input.ImportTableInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.import_table_output.ImportTableOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.import_table

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.import_table.import_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_backups(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        table_name: Optional["aws_sdk_dynamodb.types.table_arn.TableArn"] = None,
        limit: Optional[
            "aws_sdk_dynamodb.types.backups_input_limit.BackupsInputLimit"
        ] = None,
    ...
    ) -> "aws_sdk_dynamodb.types.list_backups_output.ListBackupsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.list_backups_input.ListBackupsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.list_backups_output.ListBackupsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.list_backups

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.list_backups.list_backups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_contributor_insights(
        ...
        *,
        ...
        table_name: Optional["aws_sdk_dynamodb.types.table_arn.TableArn"] = None,
        next_token: Optional[
            "aws_sdk_dynamodb.types.next_token_string.NextTokenString"
        ] = None,
        max_results: Optional[
            "aws_sdk_dynamodb.types.list_contributor_insights_limit.ListContributorInsightsLimit"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.list_contributor_insights_input.ListContributorInsightsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.list_contributor_insights_output.ListContributorInsightsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.list_contributor_insights

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.list_contributor_insights.list_contributor_insights(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_exports(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        table_arn: Optional["aws_sdk_dynamodb.types.table_arn.TableArn"] = None,
        max_results: Optional[
            "aws_sdk_dynamodb.types.list_exports_max_limit.ListExportsMaxLimit"
        ] = None,
        next_token: Optional[
            "aws_sdk_dynamodb.types.export_next_token.ExportNextToken"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.list_exports_input.ListExportsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.list_exports_output.ListExportsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.list_exports

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.list_exports.list_exports(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_global_tables(
        ...
        *,
        ...
        region_name: Optional["aws_sdk_dynamodb.types.region_name.RegionName"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.list_global_tables_input.ListGlobalTablesInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.list_global_tables_output.ListGlobalTablesOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.list_global_tables

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.list_global_tables.list_global_tables(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_imports(
        ...
        *,
        ...
        next_token: Optional[
            "aws_sdk_dynamodb.types.import_next_token.ImportNextToken"
        ] = None,
    ) -> "aws_sdk_dynamodb.types.list_imports_output.ListImportsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.list_imports_input.ListImportsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.list_imports_output.ListImportsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.list_imports

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.list_imports.list_imports(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tables(
        ...
        *,
    ...
    ) -> "aws_sdk_dynamodb.types.list_tables_output.ListTablesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.list_tables_input.ListTablesInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.list_tables_output.ListTablesOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.list_tables

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.list_tables.list_tables(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_dynamodb.types.table_name.TableName]":
    ...
    def list_tags_of_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.list_tags_of_resource_input.ListTagsOfResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.list_tags_of_resource_output.ListTagsOfResourceOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.list_tags_of_resource

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.list_tags_of_resource.list_tags_of_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_item(
        ...
        *,
    ...
    ) -> "aws_sdk_dynamodb.types.put_item_output.PutItemOutput":
        ...
        Examples:
            ...
            >>> client.put_item(table_name='Music', item={'AlbumTitle': {'S': 'Somewhat Famous'}, 'SongTitle': {'S': 'Call Me Today'}, 'Artist': {'S': 'No One You Know'}}, return_consumed_capacity='TOTAL')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.put_item_input.PutItemInput]",
        ) -> OperationResponse["aws_sdk_dynamodb.types.put_item_output.PutItemOutput"]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.put_item

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.put_item.put_item(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_resource_policy(
        ...
        *,
        ...
        confirm_remove_self_resource_access: Optional[
            "aws_sdk_dynamodb.types.confirm_remove_self_resource_access.ConfirmRemoveSelfResourceAccess"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.put_resource_policy_input.PutResourcePolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.put_resource_policy_output.PutResourcePolicyOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.put_resource_policy

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.put_resource_policy.put_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def query(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        index_name: Optional["aws_sdk_dynamodb.types.index_name.IndexName"] = None,
        select: Optional["aws_sdk_dynamodb.types.select.Select"] = None,
        attributes_to_get: Optional[
            "aws_sdk_dynamodb.types.attribute_name_list.AttributeNameList"
        ] = None,
        limit: Optional[
        ...
        key_conditions: Optional[
            "aws_sdk_dynamodb.types.key_conditions.KeyConditions"
        ] = None,
        ...
        exclusive_start_key: Optional["aws_sdk_dynamodb.types.key.Key"] = None,
        return_consumed_capacity: Optional[
            "aws_sdk_dynamodb.types.return_consumed_capacity.ReturnConsumedCapacity"
        ] = None,
        projection_expression: Optional[
        ...
        key_condition_expression: Optional[
            "aws_sdk_dynamodb.types.key_expression.KeyExpression"
        ] = None,
        expression_attribute_names: Optional[
            "aws_sdk_dynamodb.types.expression_attribute_name_map.ExpressionAttributeNameMap"
        ] = None,
    ...
    ) -> "aws_sdk_dynamodb.types.query_output.QueryOutput":
        ...
        Examples:
            ...
            >>> client.query(table_name='Music', projection_expression='SongTitle', key_condition_expression='Artist = :v1', expression_attribute_values={':v1': {'S': 'No One You Know'}})
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.query_input.QueryInput]",
        ) -> OperationResponse["aws_sdk_dynamodb.types.query_output.QueryOutput"]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.query

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.query.query(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_dynamodb.types.attribute_map.AttributeMap]":
    ...
    def restore_table_from_backup(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.limit_exceeded_exception.LimitExceededException: <p>There is no limit to the number of daily on-demand backups that can be taken. </p> <p>For most purposes, up to 500 simultaneous table operations are allowed per account. These operations include <code>CreateTable</code>, <code>UpdateTable</code>, <code>DeleteTable</code>,<code>UpdateTimeToLive</code>, <code>RestoreTableFromBackup</code>, and <code>RestoreTableToPointInTime</code>. </p> <p>When you are creating a table with one or more secondary indexes, you can have up to 250 such requests running at a time. However, if the table or index specifications are complex, then DynamoDB might temporarily reduce the number of concurrent operations.</p> <p>When importing into DynamoDB, up to 50 simultaneous import table operations are allowed per account.</p> <p>There is a soft account quota of 2,500 tables.</p> <p>GetRecords was called with a value of more than 1000 for the limit request parameter.</p> <p>More than 2 processes are reading from the same streams shard at the same time. Exceeding this limit may result in request throttling.</p>
            aws_sdk_dynamodb.errors.table_already_exists_exception.TableAlreadyExistsException: <p>A target table with the specified name already exists. </p>
            aws_sdk_dynamodb.errors.table_in_use_exception.TableInUseException: <p>A target table with the specified name is either being created or deleted. </p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.restore_table_from_backup_input.RestoreTableFromBackupInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.restore_table_from_backup_output.RestoreTableFromBackupOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.restore_table_from_backup

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.restore_table_from_backup.restore_table_from_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def restore_table_to_point_in_time(
        ...
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        source_table_arn: Optional["aws_sdk_dynamodb.types.table_arn.TableArn"] = None,
        ...
        restore_date_time: Optional["aws_sdk_dynamodb.types.date.Date"] = None,
        billing_mode_override: Optional[
            "aws_sdk_dynamodb.types.billing_mode.BillingMode"
        ] = None,
        global_secondary_index_override: Optional[
        ...
        Raises:
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.invalid_restore_time_exception.InvalidRestoreTimeException: <p>An invalid restore time was specified. RestoreDateTime must be between EarliestRestorableDateTime and LatestRestorableDateTime.</p>
            aws_sdk_dynamodb.errors.limit_exceeded_exception.LimitExceededException: <p>There is no limit to the number of daily on-demand backups that can be taken. </p> <p>For most purposes, up to 500 simultaneous table operations are allowed per account. These operations include <code>CreateTable</code>, <code>UpdateTable</code>, <code>DeleteTable</code>,<code>UpdateTimeToLive</code>, <code>RestoreTableFromBackup</code>, and <code>RestoreTableToPointInTime</code>. </p> <p>When you are creating a table with one or more secondary indexes, you can have up to 250 such requests running at a time. However, if the table or index specifications are complex, then DynamoDB might temporarily reduce the number of concurrent operations.</p> <p>When importing into DynamoDB, up to 50 simultaneous import table operations are allowed per account.</p> <p>There is a soft account quota of 2,500 tables.</p> <p>GetRecords was called with a value of more than 1000 for the limit request parameter.</p> <p>More than 2 processes are reading from the same streams shard at the same time. Exceeding this limit may result in request throttling.</p>
            aws_sdk_dynamodb.errors.point_in_time_recovery_unavailable_exception.PointInTimeRecoveryUnavailableException: <p>Point in time recovery has not yet been enabled for this source table.</p>
            aws_sdk_dynamodb.errors.table_already_exists_exception.TableAlreadyExistsException: <p>A target table with the specified name already exists. </p>
            aws_sdk_dynamodb.errors.table_in_use_exception.TableInUseException: <p>A target table with the specified name is either being created or deleted. </p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.restore_table_to_point_in_time_input.RestoreTableToPointInTimeInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.restore_table_to_point_in_time_output.RestoreTableToPointInTimeOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.restore_table_to_point_in_time

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.restore_table_to_point_in_time.restore_table_to_point_in_time(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def scan(
        ...
        *,
        ...
        segment: Optional["aws_sdk_dynamodb.types.scan_segment.ScanSegment"] = None,
        projection_expression: Optional[
            "aws_sdk_dynamodb.types.projection_expression.ProjectionExpression"
        ] = None,
        filter_expression: Optional[
    ...
    ) -> "aws_sdk_dynamodb.types.scan_output.ScanOutput":
        ...
        Examples:
            ...
            >>> client.scan(table_name='Music', filter_expression='Artist = :a', projection_expression='#ST, #AT', expression_attribute_names={'#ST': 'SongTitle', '#AT': 'AlbumTitle'}, expression_attribute_values={':a': {'S': 'No One You Know'}})
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.scan_input.ScanInput]",
        ) -> OperationResponse["aws_sdk_dynamodb.types.scan_output.ScanOutput"]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.scan

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.scan.scan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.tag_resource

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def transact_get_items(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.transact_get_items_input.TransactGetItemsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.transact_get_items_output.TransactGetItemsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.transact_get_items

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.transact_get_items.transact_get_items(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def transact_write_items(
        self,
        transact_items: "aws_sdk_dynamodb.types.transact_write_item_list.TransactWriteItemList",
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        return_consumed_capacity: Optional[
            "aws_sdk_dynamodb.types.return_consumed_capacity.ReturnConsumedCapacity"
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.transact_write_items_input.TransactWriteItemsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.transact_write_items_output.TransactWriteItemsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.transact_write_items

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.transact_write_items.transact_write_items(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.untag_resource

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_continuous_backups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.update_continuous_backups_input.UpdateContinuousBackupsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.update_continuous_backups_output.UpdateContinuousBackupsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.update_continuous_backups

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.update_continuous_backups.update_continuous_backups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_contributor_insights(
        self,
        table_name: "aws_sdk_dynamodb.types.table_arn.TableArn",
        contributor_insights_action: "aws_sdk_dynamodb.types.contributor_insights_action.ContributorInsightsAction",
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        index_name: Optional["aws_sdk_dynamodb.types.index_name.IndexName"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.update_contributor_insights_input.UpdateContributorInsightsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.update_contributor_insights_output.UpdateContributorInsightsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.update_contributor_insights

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.update_contributor_insights.update_contributor_insights(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_global_table(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.replica_already_exists_exception.ReplicaAlreadyExistsException: <p>The specified replica is already part of the global table.</p>
            aws_sdk_dynamodb.errors.replica_not_found_exception.ReplicaNotFoundException: <p>The specified replica is no longer part of the global table.</p>
            aws_sdk_dynamodb.errors.table_not_found_exception.TableNotFoundException: <p>A source table with the name <code>TableName</code> does not currently exist within the subscriber's account or the subscriber is operating in the wrong Amazon Web Services Region.</p>
            aws_sdk_dynamodb.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.update_global_table_input.UpdateGlobalTableInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.update_global_table_output.UpdateGlobalTableOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.update_global_table

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.update_global_table.update_global_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_global_table_settings(
        ...
        *,
        ...
        Raises:
            aws_sdk_dynamodb.errors.global_table_not_found_exception.GlobalTableNotFoundException: <p>The specified global table does not exist.</p>
            aws_sdk_dynamodb.errors.index_not_found_exception.IndexNotFoundException: <p>The operation tried to access a nonexistent index.</p>
            aws_sdk_dynamodb.errors.internal_server_error.InternalServerError: <p>An error occurred on the server side.</p>
            aws_sdk_dynamodb.errors.invalid_endpoint_exception.InvalidEndpointException
            aws_sdk_dynamodb.errors.limit_exceeded_exception.LimitExceededException: <p>There is no limit to the number of daily on-demand backups that can be taken. </p> <p>For most purposes, up to 500 simultaneous table operations are allowed per account. These operations include <code>CreateTable</code>, <code>UpdateTable</code>, <code>DeleteTable</code>,<code>UpdateTimeToLive</code>, <code>RestoreTableFromBackup</code>, and <code>RestoreTableToPointInTime</code>. </p> <p>When you are creating a table with one or more secondary indexes, you can have up to 250 such requests running at a time. However, if the table or index specifications are complex, then DynamoDB might temporarily reduce the number of concurrent operations.</p> <p>When importing into DynamoDB, up to 50 simultaneous import table operations are allowed per account.</p> <p>There is a soft account quota of 2,500 tables.</p> <p>GetRecords was called with a value of more than 1000 for the limit request parameter.</p> <p>More than 2 processes are reading from the same streams shard at the same time. Exceeding this limit may result in request throttling.</p>
            aws_sdk_dynamodb.errors.replica_not_found_exception.ReplicaNotFoundException: <p>The specified replica is no longer part of the global table.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.update_global_table_settings_input.UpdateGlobalTableSettingsInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.update_global_table_settings_output.UpdateGlobalTableSettingsOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.update_global_table_settings

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.update_global_table_settings.update_global_table_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_item(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_item(table_name='Music', key={'Artist': {'S': 'Acme Band'}, 'SongTitle': {'S': 'Happy Day'}}, update_expression='SET #Y = :y, #AT = :t', expression_attribute_names={'#Y': 'Year', '#AT': 'AlbumTitle'}, expression_attribute_values={':y': {'N': '2015'}, ':t': {'S': 'Louder Than Ever'}}, return_values='ALL_NEW')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.update_item_input.UpdateItemInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.update_item_output.UpdateItemOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.update_item

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.update_item.update_item(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_kinesis_streaming_destination(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.update_kinesis_streaming_destination_input.UpdateKinesisStreamingDestinationInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.update_kinesis_streaming_destination_output.UpdateKinesisStreamingDestinationOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.update_kinesis_streaming_destination

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.update_kinesis_streaming_destination.update_kinesis_streaming_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_table(
        ...
        *,
        ...
        global_secondary_index_updates: Optional[
            "aws_sdk_dynamodb.types.global_secondary_index_update_list.GlobalSecondaryIndexUpdateList"
        ] = None,
        stream_specification: Optional[
            "aws_sdk_dynamodb.types.stream_specification.StreamSpecification"
        ] = None,
        ...
        replica_updates: Optional[
            "aws_sdk_dynamodb.types.replication_group_update_list.ReplicationGroupUpdateList"
        ] = None,
        table_class: Optional["aws_sdk_dynamodb.types.table_class.TableClass"] = None,
        deletion_protection_enabled: Optional[
            "aws_sdk_dynamodb.types.deletion_protection_enabled.DeletionProtectionEnabled"
        ...
        global_table_witness_updates: Optional[
            "aws_sdk_dynamodb.types.global_table_witness_group_update_list.GlobalTableWitnessGroupUpdateList"
        ] = None,
        on_demand_throughput: Optional[
            "aws_sdk_dynamodb.types.on_demand_throughput.OnDemandThroughput"
        ] = None,
    ...
    ) -> "aws_sdk_dynamodb.types.update_table_output.UpdateTableOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.update_table_input.UpdateTableInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.update_table_output.UpdateTableOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.update_table

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.update_table.update_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_table_replica_auto_scaling(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.update_table_replica_auto_scaling_input.UpdateTableReplicaAutoScalingInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.update_table_replica_auto_scaling_output.UpdateTableReplicaAutoScalingOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.update_table_replica_auto_scaling

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.update_table_replica_auto_scaling.update_table_replica_auto_scaling(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_time_to_live(
        self,
        table_name: "aws_sdk_dynamodb.types.table_arn.TableArn",
        time_to_live_specification: "aws_sdk_dynamodb.types.time_to_live_specification.TimeToLiveSpecification",
        *,
        config_overrides: Optional[DynamoDBClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dynamodb.types.update_time_to_live_input.UpdateTimeToLiveInput]",
        ) -> OperationResponse[
            "aws_sdk_dynamodb.types.update_time_to_live_output.UpdateTimeToLiveOutput"
        ]:
            import aws_sdk_dynamodb._operations.dynamo_db_20120810.update_time_to_live

            output, http_response = (
                aws_sdk_dynamodb._operations.dynamo_db_20120810.update_time_to_live.update_time_to_live(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
