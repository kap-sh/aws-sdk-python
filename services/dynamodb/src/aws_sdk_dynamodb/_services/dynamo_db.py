...
class DynamoDBClient:
    ...
    def __init__(
        ...
        self.config = DynamoDBClientConfig(
            {
    ...
    def operation_options(
        ...
        options_: OperationOptions = OperationOptions(
            ...
            account_id=overrides.get("account_id", self.config.get("account_id")),
            account_id_endpoint_mode=overrides.get(
                "account_id_endpoint_mode", self.config.get("account_id_endpoint_mode")
            ),
