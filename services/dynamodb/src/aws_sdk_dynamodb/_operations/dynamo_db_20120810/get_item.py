...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.get_item_output.GetItemOutput = (
        aws_sdk_dynamodb.types.get_item_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.get_item_input.GetItemInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.get_item_input.serialize_aws_json_1_0(input_)
    ).encode()
