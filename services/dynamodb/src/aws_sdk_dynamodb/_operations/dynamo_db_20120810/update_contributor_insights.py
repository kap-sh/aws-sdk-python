...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.update_contributor_insights_output.UpdateContributorInsightsOutput = aws_sdk_dynamodb.types.update_contributor_insights_output.deserialize_aws_json_1_0(
