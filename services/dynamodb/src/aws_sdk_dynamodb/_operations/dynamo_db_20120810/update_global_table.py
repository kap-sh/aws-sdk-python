...
def build_request(
    ...
    input: aws_sdk_dynamodb.types.update_global_table_input.UpdateGlobalTableInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.update_global_table_input.serialize_aws_json_1_0(input)
    ).encode()
