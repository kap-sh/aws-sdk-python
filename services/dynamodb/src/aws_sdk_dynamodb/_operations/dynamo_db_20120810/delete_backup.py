...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.delete_backup_output.DeleteBackupOutput = (
        aws_sdk_dynamodb.types.delete_backup_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.delete_backup_input.DeleteBackupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.delete_backup_input.serialize_aws_json_1_0(input_)
    ).encode()
