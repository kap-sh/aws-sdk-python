...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.describe_endpoints_response.DescribeEndpointsResponse = aws_sdk_dynamodb.types.describe_endpoints_response.deserialize_aws_json_1_0(
