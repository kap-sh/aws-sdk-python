...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.list_tags_of_resource_output.ListTagsOfResourceOutput = aws_sdk_dynamodb.types.list_tags_of_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.list_tags_of_resource_input.ListTagsOfResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.list_tags_of_resource_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
