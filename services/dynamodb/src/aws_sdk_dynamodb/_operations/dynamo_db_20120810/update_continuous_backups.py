...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ContinuousBackupsUnavailableException":
            import aws_sdk_dynamodb.errors.continuous_backups_unavailable_exception

            raise aws_sdk_dynamodb.errors.continuous_backups_unavailable_exception.ContinuousBackupsUnavailableException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.update_continuous_backups_output.UpdateContinuousBackupsOutput = aws_sdk_dynamodb.types.update_continuous_backups_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.update_continuous_backups_input.UpdateContinuousBackupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.update_continuous_backups_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
