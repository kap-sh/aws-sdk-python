...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.scan_output.ScanOutput = (
        aws_sdk_dynamodb.types.scan_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.scan_input.ScanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.scan_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def scan(
    options: OperationOptions, input_: aws_sdk_dynamodb.types.scan_input.ScanInput
...
async def async_scan(
    options: AsyncOperationOptions, input_: aws_sdk_dynamodb.types.scan_input.ScanInput
) -> tuple[aws_sdk_dynamodb.types.scan_output.ScanOutput, zapros.Response]:
