...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.execute_transaction_input.ExecuteTransactionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.execute_transaction_input.serialize_aws_json_1_0(input_)
    ).encode()
