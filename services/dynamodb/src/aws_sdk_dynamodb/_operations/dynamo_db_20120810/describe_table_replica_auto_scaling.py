...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.describe_table_replica_auto_scaling_output.DescribeTableReplicaAutoScalingOutput = aws_sdk_dynamodb.types.describe_table_replica_auto_scaling_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.describe_table_replica_auto_scaling_input.DescribeTableReplicaAutoScalingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
