...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.update_table_replica_auto_scaling_output.UpdateTableReplicaAutoScalingOutput = aws_sdk_dynamodb.types.update_table_replica_auto_scaling_output.deserialize_aws_json_1_0(
