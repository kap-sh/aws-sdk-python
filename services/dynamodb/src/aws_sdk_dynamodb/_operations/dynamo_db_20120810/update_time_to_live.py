...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.update_time_to_live_output.UpdateTimeToLiveOutput = (
        aws_sdk_dynamodb.types.update_time_to_live_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.update_time_to_live_input.UpdateTimeToLiveInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.update_time_to_live_input.serialize_aws_json_1_0(input_)
    ).encode()
