...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GlobalTableAlreadyExistsException":
            import aws_sdk_dynamodb.errors.global_table_already_exists_exception

            raise aws_sdk_dynamodb.errors.global_table_already_exists_exception.GlobalTableAlreadyExistsException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.create_global_table_output.CreateGlobalTableOutput = (
        aws_sdk_dynamodb.types.create_global_table_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.create_global_table_input.CreateGlobalTableInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.create_global_table_input.serialize_aws_json_1_0(input_)
    ).encode()
