...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.put_resource_policy_output.PutResourcePolicyOutput = (
        aws_sdk_dynamodb.types.put_resource_policy_output.deserialize_aws_json_1_0(
