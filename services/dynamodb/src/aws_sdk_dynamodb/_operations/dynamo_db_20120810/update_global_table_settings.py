...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IndexNotFoundException":
            import aws_sdk_dynamodb.errors.index_not_found_exception

            raise aws_sdk_dynamodb.errors.index_not_found_exception.IndexNotFoundException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.update_global_table_settings_output.UpdateGlobalTableSettingsOutput = aws_sdk_dynamodb.types.update_global_table_settings_output.deserialize_aws_json_1_0(
