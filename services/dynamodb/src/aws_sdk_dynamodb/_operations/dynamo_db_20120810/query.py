...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.query_output.QueryOutput = (
        aws_sdk_dynamodb.types.query_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.query_input.QueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.query_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def query(
    options: OperationOptions, input_: aws_sdk_dynamodb.types.query_input.QueryInput
