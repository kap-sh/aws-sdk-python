...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.delete_table_output.DeleteTableOutput = (
        aws_sdk_dynamodb.types.delete_table_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.delete_table_input.DeleteTableInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.delete_table_input.serialize_aws_json_1_0(input_)
    ).encode()
