...
import aws_sdk_dynamodb.errors.import_conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ImportConflictException":
            raise aws_sdk_dynamodb.errors.import_conflict_exception.ImportConflictException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.import_table_output.ImportTableOutput = (
        aws_sdk_dynamodb.types.import_table_output.deserialize_aws_json_1_0(
