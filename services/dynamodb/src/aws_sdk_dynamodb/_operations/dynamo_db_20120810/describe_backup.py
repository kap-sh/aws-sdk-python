...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.describe_backup_output.DescribeBackupOutput = (
        aws_sdk_dynamodb.types.describe_backup_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.describe_backup_input.DescribeBackupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
            ...
            ResourceArn=input_.get("backup_arn"),
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.describe_backup_input.serialize_aws_json_1_0(input_)
    ).encode()
