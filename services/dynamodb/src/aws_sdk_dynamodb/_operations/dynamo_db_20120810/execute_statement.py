...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicateItemException":
            import aws_sdk_dynamodb.errors.duplicate_item_exception

            raise aws_sdk_dynamodb.errors.duplicate_item_exception.DuplicateItemException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.execute_statement_output.ExecuteStatementOutput = (
        aws_sdk_dynamodb.types.execute_statement_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.execute_statement_input.ExecuteStatementInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.execute_statement_input.serialize_aws_json_1_0(input_)
    ).encode()
