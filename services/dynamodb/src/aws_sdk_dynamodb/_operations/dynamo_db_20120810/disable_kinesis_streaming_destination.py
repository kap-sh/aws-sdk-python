"""Generated from Smithy shape ``com.amazonaws.dynamodb#DisableKinesisStreamingDestination``."""
...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.kinesis_streaming_destination_output.KinesisStreamingDestinationOutput = aws_sdk_dynamodb.types.kinesis_streaming_destination_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.kinesis_streaming_destination_input.KinesisStreamingDestinationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "DynamoDB_20120810.DisableKinesisStreamingDestination"
    import aws_sdk_dynamodb.types.kinesis_streaming_destination_input

    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.kinesis_streaming_destination_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_disable_kinesis_streaming_destination(
