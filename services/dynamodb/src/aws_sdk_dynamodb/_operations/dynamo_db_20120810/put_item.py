...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.put_item_output.PutItemOutput = (
        aws_sdk_dynamodb.types.put_item_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.put_item_input.PutItemInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.put_item_input.serialize_aws_json_1_0(input_)
    ).encode()
