...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.list_imports_output.ListImportsOutput = (
        aws_sdk_dynamodb.types.list_imports_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.list_imports_input.ListImportsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.list_imports_input.serialize_aws_json_1_0(input_)
    ).encode()
