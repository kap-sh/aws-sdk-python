...
import aws_sdk_dynamodb.errors.export_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ExportNotFoundException":
            raise aws_sdk_dynamodb.errors.export_not_found_exception.ExportNotFoundException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.describe_export_output.DescribeExportOutput = (
        aws_sdk_dynamodb.types.describe_export_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.describe_export_input.DescribeExportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.describe_export_input.serialize_aws_json_1_0(input_)
    ).encode()
