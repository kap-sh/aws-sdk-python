...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.describe_kinesis_streaming_destination_output.DescribeKinesisStreamingDestinationOutput = aws_sdk_dynamodb.types.describe_kinesis_streaming_destination_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.describe_kinesis_streaming_destination_input.DescribeKinesisStreamingDestinationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "DynamoDB_20120810.DescribeKinesisStreamingDestination"
    import aws_sdk_dynamodb.types.describe_kinesis_streaming_destination_input

    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.describe_kinesis_streaming_destination_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
