...
import aws_sdk_dynamodb.errors.policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyNotFoundException":
            raise aws_sdk_dynamodb.errors.policy_not_found_exception.PolicyNotFoundException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.get_resource_policy_output.GetResourcePolicyOutput = (
        aws_sdk_dynamodb.types.get_resource_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DynamoDB_20120810.GetResourcePolicy"
