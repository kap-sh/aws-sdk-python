...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.transact_write_items_output.TransactWriteItemsOutput = (
        aws_sdk_dynamodb.types.transact_write_items_output.deserialize_aws_json_1_0(
