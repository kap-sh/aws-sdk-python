...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ImportNotFoundException":
            import aws_sdk_dynamodb.errors.import_not_found_exception

            raise aws_sdk_dynamodb.errors.import_not_found_exception.ImportNotFoundException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.describe_import_output.DescribeImportOutput = (
        aws_sdk_dynamodb.types.describe_import_output.deserialize_aws_json_1_0(
