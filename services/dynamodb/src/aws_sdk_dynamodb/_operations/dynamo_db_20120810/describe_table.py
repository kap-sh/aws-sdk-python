...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.describe_table_output.DescribeTableOutput = (
        aws_sdk_dynamodb.types.describe_table_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_dynamodb.types.describe_table_input.DescribeTableInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dynamodb.types.describe_table_input.serialize_aws_json_1_0(input_)
    ).encode()
