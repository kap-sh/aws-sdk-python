...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.batch_execute_statement_output.BatchExecuteStatementOutput = aws_sdk_dynamodb.types.batch_execute_statement_output.deserialize_aws_json_1_0(
