"""Generated from Smithy shape ``com.amazonaws.dynamodb#DescribeLimits``."""
...
def handle_response(
    ...
    out: aws_sdk_dynamodb.types.describe_limits_output.DescribeLimitsOutput = (
        aws_sdk_dynamodb.types.describe_limits_output.deserialize_aws_json_1_0(
