...
from aws_sdk_pca_connector_ad._services._aws_config import aaws_config
...
class AsyncPcaConnectorAdClientConfig(TypedDict, total=False):
...
class AsyncPcaConnectorAdClient:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_pca_connector_ad.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_pca_connector_ad.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_pca_connector_ad._operations.pca_connector_ad.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_pca_connector_ad.types.tag_resource_request.TagResourceRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_pca_connector_ad._operations.pca_connector_ad.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_pca_connector_ad.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_pca_connector_ad._operations.pca_connector_ad.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
