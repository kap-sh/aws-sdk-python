...
class PcaConnectorAdError(Exception):
    """Base class for all PcaConnectorAd service errors."""


class ServiceError(PcaConnectorAdError):
...
class SerializationError(PcaConnectorAdError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PcaConnectorAdError):
...
class WaiterFailedError(PcaConnectorAdError):
...
class WaiterTimeoutError(PcaConnectorAdError):
