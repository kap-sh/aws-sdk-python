...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.list_directory_registrations_response.ListDirectoryRegistrationsResponse = aws_sdk_pca_connector_ad.types.list_directory_registrations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.list_directory_registrations_request.ListDirectoryRegistrationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
