...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_pca_connector_ad.errors.service_quota_exceeded_exception

            raise aws_sdk_pca_connector_ad.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.create_template_group_access_control_entry_request.CreateTemplateGroupAccessControlEntryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pca_connector_ad.types.create_template_group_access_control_entry_request.serialize_json(
            input_
        )
    ).encode()
