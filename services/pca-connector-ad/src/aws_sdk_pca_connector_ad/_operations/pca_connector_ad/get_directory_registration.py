"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#GetDirectoryRegistration``."""
...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.get_directory_registration_response.GetDirectoryRegistrationResponse = aws_sdk_pca_connector_ad.types.get_directory_registration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.get_directory_registration_request.GetDirectoryRegistrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/directoryRegistrations/{DirectoryRegistrationArn}"
    )
    url = url.replace(
...
async def async_get_directory_registration(
