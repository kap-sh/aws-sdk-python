...
def build_request(
    ...
    input: aws_sdk_pca_connector_ad.types.get_directory_registration_request.GetDirectoryRegistrationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["directory_registration_arn"]), safe=""),
    )
    params: dict[str, str] = {}
