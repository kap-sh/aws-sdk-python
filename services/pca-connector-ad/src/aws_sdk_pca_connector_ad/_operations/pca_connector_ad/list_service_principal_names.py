...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.list_service_principal_names_response.ListServicePrincipalNamesResponse = aws_sdk_pca_connector_ad.types.list_service_principal_names_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.list_service_principal_names_request.ListServicePrincipalNamesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
