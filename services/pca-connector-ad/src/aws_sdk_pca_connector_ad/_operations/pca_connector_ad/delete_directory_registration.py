"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#DeleteDirectoryRegistration``."""
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.delete_directory_registration_request.DeleteDirectoryRegistrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_directory_registration(
