...
def build_request(
    ...
    input: aws_sdk_pca_connector_ad.types.create_template_request.CreateTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pca_connector_ad.types.create_template_request.serialize_json(input)
    ).encode()
