...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.create_template_response.CreateTemplateResponse = aws_sdk_pca_connector_ad.types.create_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.create_template_request.CreateTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pca_connector_ad.types.create_template_request.serialize_json(input_)
    ).encode()
