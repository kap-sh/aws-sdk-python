...
def build_request(
    ...
    input: aws_sdk_pca_connector_ad.types.update_template_request.UpdateTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pca_connector_ad.types.update_template_request.serialize_json(input)
    ).encode()
