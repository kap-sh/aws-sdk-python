...
import aws_sdk_pca_connector_ad.types.service_principal_name
...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.get_service_principal_name_response.GetServicePrincipalNameResponse = aws_sdk_pca_connector_ad.types.get_service_principal_name_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.get_service_principal_name_request.GetServicePrincipalNameRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
