...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.list_connectors_response.ListConnectorsResponse = aws_sdk_pca_connector_ad.types.list_connectors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.list_connectors_request.ListConnectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
