...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.get_connector_response.GetConnectorResponse = (
        aws_sdk_pca_connector_ad.types.get_connector_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pca_connector_ad.types.get_connector_request.GetConnectorRequest,
) -> zapros.Request:
