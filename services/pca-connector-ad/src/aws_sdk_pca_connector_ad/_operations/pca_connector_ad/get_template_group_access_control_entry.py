...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.get_template_group_access_control_entry_response.GetTemplateGroupAccessControlEntryResponse = aws_sdk_pca_connector_ad.types.get_template_group_access_control_entry_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pca_connector_ad.types.get_template_group_access_control_entry_request.GetTemplateGroupAccessControlEntryRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["group_security_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
