"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#ListTemplateGroupAccessControlEntries``."""
...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.list_template_group_access_control_entries_response.ListTemplateGroupAccessControlEntriesResponse = aws_sdk_pca_connector_ad.types.list_template_group_access_control_entries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.list_template_group_access_control_entries_request.ListTemplateGroupAccessControlEntriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_template_group_access_control_entries(
