...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.get_template_response.GetTemplateResponse = (
        aws_sdk_pca_connector_ad.types.get_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.get_template_request.GetTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
