...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.create_connector_response.CreateConnectorResponse = aws_sdk_pca_connector_ad.types.create_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.create_connector_request.CreateConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pca_connector_ad.types.create_connector_request.serialize_json(input_)
    ).encode()
