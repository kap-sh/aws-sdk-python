...
def handle_response(
    ...
    out: aws_sdk_pca_connector_ad.types.create_directory_registration_response.CreateDirectoryRegistrationResponse = aws_sdk_pca_connector_ad.types.create_directory_registration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pca_connector_ad.types.create_directory_registration_request.CreateDirectoryRegistrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pca_connector_ad.types.create_directory_registration_request.serialize_json(
            input_
        )
    ).encode()
