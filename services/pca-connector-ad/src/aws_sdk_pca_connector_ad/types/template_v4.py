"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#TemplateV4``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_pca_connector_ad.types.enrollment_flags_v4
    import aws_sdk_pca_connector_ad.types.extensions_v4
    import aws_sdk_pca_connector_ad.types.general_flags_v4
    import aws_sdk_pca_connector_ad.types.hash_algorithm
    import aws_sdk_pca_connector_ad.types.private_key_attributes_v4
    import aws_sdk_pca_connector_ad.types.private_key_flags_v4
    import aws_sdk_pca_connector_ad.types.subject_name_flags_v4
    import aws_sdk_pca_connector_ad.types.template_name_list


class TemplateV4(TypedDict, closed=True):
    ...
    private_key_attributes: "aws_sdk_pca_connector_ad.types.private_key_attributes_v4.PrivateKeyAttributesV4"
    ...
    private_key_flags: (
        "aws_sdk_pca_connector_ad.types.private_key_flags_v4.PrivateKeyFlagsV4"
    )
    ...
    enrollment_flags: (
        "aws_sdk_pca_connector_ad.types.enrollment_flags_v4.EnrollmentFlagsV4"
    )
    ...
    subject_name_flags: (
        "aws_sdk_pca_connector_ad.types.subject_name_flags_v4.SubjectNameFlagsV4"
    )
    """<p>Subject name flags describe the subject name and subject alternate name that is included in a certificate.</p>"""
    general_flags: "aws_sdk_pca_connector_ad.types.general_flags_v4.GeneralFlagsV4"
    ...
    hash_algorithm: NotRequired[
        "aws_sdk_pca_connector_ad.types.hash_algorithm.HashAlgorithm"
    ]
    ...
    extensions: "aws_sdk_pca_connector_ad.types.extensions_v4.ExtensionsV4"
    """<p>Extensions describe the key usage extensions and application policies for a template.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: TemplateV4) -> dict:
    out: dict = {}
    import aws_sdk_pca_connector_ad.types.certificate_validity
    ...
    out["PrivateKeyAttributes"] = (
        aws_sdk_pca_connector_ad.types.private_key_attributes_v4.serialize_json(
    ...
    out["PrivateKeyFlags"] = (
        aws_sdk_pca_connector_ad.types.private_key_flags_v4.serialize_json(
    ...
    out["EnrollmentFlags"] = (
        aws_sdk_pca_connector_ad.types.enrollment_flags_v4.serialize_json(
    ...
    out["SubjectNameFlags"] = (
        aws_sdk_pca_connector_ad.types.subject_name_flags_v4.serialize_json(
    ...
    out["GeneralFlags"] = (
        aws_sdk_pca_connector_ad.types.general_flags_v4.serialize_json(
            value["general_flags"]
        )
    )
    if "hash_algorithm" in value:
        ...
        out["HashAlgorithm"] = (
            aws_sdk_pca_connector_ad.types.hash_algorithm.serialize_json(
                value["hash_algorithm"]
            )
        )
    import aws_sdk_pca_connector_ad.types.extensions_v4

    out["Extensions"] = aws_sdk_pca_connector_ad.types.extensions_v4.serialize_json(
        value["extensions"]
    )
    return out


def deserialize_json(data: dict) -> TemplateV4:
    out: TemplateV4 = {}  # type: ignore[typeddict-item]
    if "CertificateValidity" in data:
        ...
        raise DeserializationError("TemplateV4.certificate_validity required")
    ...
    if "PrivateKeyAttributes" in data:
        ...
        out["private_key_attributes"] = (
            aws_sdk_pca_connector_ad.types.private_key_attributes_v4.deserialize_json(
                data["PrivateKeyAttributes"]
            )
        )
    else:
        raise DeserializationError("TemplateV4.private_key_attributes required")
    if "PrivateKeyFlags" in data:
        import aws_sdk_pca_connector_ad.types.private_key_flags_v4

        out["private_key_flags"] = (
            aws_sdk_pca_connector_ad.types.private_key_flags_v4.deserialize_json(
                data["PrivateKeyFlags"]
            )
        )
    else:
        raise DeserializationError("TemplateV4.private_key_flags required")
    if "EnrollmentFlags" in data:
        import aws_sdk_pca_connector_ad.types.enrollment_flags_v4

        out["enrollment_flags"] = (
            aws_sdk_pca_connector_ad.types.enrollment_flags_v4.deserialize_json(
                data["EnrollmentFlags"]
            )
        )
    else:
        raise DeserializationError("TemplateV4.enrollment_flags required")
    if "SubjectNameFlags" in data:
        import aws_sdk_pca_connector_ad.types.subject_name_flags_v4

        out["subject_name_flags"] = (
            aws_sdk_pca_connector_ad.types.subject_name_flags_v4.deserialize_json(
                data["SubjectNameFlags"]
            )
        )
    else:
        raise DeserializationError("TemplateV4.subject_name_flags required")
    if "GeneralFlags" in data:
        import aws_sdk_pca_connector_ad.types.general_flags_v4

        out["general_flags"] = (
            aws_sdk_pca_connector_ad.types.general_flags_v4.deserialize_json(
                data["GeneralFlags"]
            )
        )
    else:
        raise DeserializationError("TemplateV4.general_flags required")
    if "HashAlgorithm" in data:
        import aws_sdk_pca_connector_ad.types.hash_algorithm

        out["hash_algorithm"] = (
            aws_sdk_pca_connector_ad.types.hash_algorithm.deserialize_json(
                data["HashAlgorithm"]
            )
        )
    if "Extensions" in data:
        ...
        out["extensions"] = (
            aws_sdk_pca_connector_ad.types.extensions_v4.deserialize_json(
                data["Extensions"]
            )
        )
    else:
        raise DeserializationError("TemplateV4.extensions required")
    return out
