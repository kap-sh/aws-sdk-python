...
if TYPE_CHECKING:
    import aws_sdk_pca_connector_ad.types.client_compatibility_v4


class PrivateKeyFlagsV4(TypedDict):
    ...
    client_version: (
        "aws_sdk_pca_connector_ad.types.client_compatibility_v4.ClientCompatibilityV4"
    )
...
def serialize_json(value: PrivateKeyFlagsV4) -> dict:
    ...
    out["ClientVersion"] = (
        aws_sdk_pca_connector_ad.types.client_compatibility_v4.serialize_json(
...
def deserialize_json(data: dict) -> PrivateKeyFlagsV4:
    ...
    if "ClientVersion" in data:
        ...
        out["client_version"] = (
            aws_sdk_pca_connector_ad.types.client_compatibility_v4.deserialize_json(
                data["ClientVersion"]
            )
        )
    else:
