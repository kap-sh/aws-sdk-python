...
# --- restJson1 ser/de ---
def serialize_json(value: ExtensionsV3) -> dict:
    out: dict = {}
    import aws_sdk_pca_connector_ad.types.key_usage
...
def deserialize_json(data: dict) -> ExtensionsV3:
    out: ExtensionsV3 = {}  # type: ignore[typeddict-item]
    if "KeyUsage" in data:
        import aws_sdk_pca_connector_ad.types.key_usage
        ...
        raise DeserializationError("ExtensionsV3.key_usage required")
