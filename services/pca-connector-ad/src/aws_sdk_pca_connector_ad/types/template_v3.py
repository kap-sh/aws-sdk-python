...
if TYPE_CHECKING:
    ...
    import aws_sdk_pca_connector_ad.types.enrollment_flags_v3
    import aws_sdk_pca_connector_ad.types.extensions_v3
    import aws_sdk_pca_connector_ad.types.general_flags_v3
    import aws_sdk_pca_connector_ad.types.hash_algorithm
    import aws_sdk_pca_connector_ad.types.private_key_attributes_v3
    import aws_sdk_pca_connector_ad.types.private_key_flags_v3
    import aws_sdk_pca_connector_ad.types.subject_name_flags_v3
    import aws_sdk_pca_connector_ad.types.template_name_list


class TemplateV3(TypedDict):
    ...
    private_key_attributes: "aws_sdk_pca_connector_ad.types.private_key_attributes_v3.PrivateKeyAttributesV3"
    ...
    private_key_flags: (
        "aws_sdk_pca_connector_ad.types.private_key_flags_v3.PrivateKeyFlagsV3"
    )
    ...
    enrollment_flags: (
        "aws_sdk_pca_connector_ad.types.enrollment_flags_v3.EnrollmentFlagsV3"
    )
    ...
    subject_name_flags: (
        "aws_sdk_pca_connector_ad.types.subject_name_flags_v3.SubjectNameFlagsV3"
    )
    """<p>Subject name flags describe the subject name and subject alternate name that is included in a certificate.</p>"""
    general_flags: "aws_sdk_pca_connector_ad.types.general_flags_v3.GeneralFlagsV3"
    ...
    hash_algorithm: "aws_sdk_pca_connector_ad.types.hash_algorithm.HashAlgorithm"
    """<p>Specifies the hash algorithm used to hash the private key.</p>"""
    extensions: "aws_sdk_pca_connector_ad.types.extensions_v3.ExtensionsV3"
...
def serialize_json(value: TemplateV3) -> dict:
    ...
    out["PrivateKeyAttributes"] = (
        aws_sdk_pca_connector_ad.types.private_key_attributes_v3.serialize_json(
    ...
    out["PrivateKeyFlags"] = (
        aws_sdk_pca_connector_ad.types.private_key_flags_v3.serialize_json(
    ...
    out["EnrollmentFlags"] = (
        aws_sdk_pca_connector_ad.types.enrollment_flags_v3.serialize_json(
    ...
    out["SubjectNameFlags"] = (
        aws_sdk_pca_connector_ad.types.subject_name_flags_v3.serialize_json(
    ...
    out["GeneralFlags"] = (
        aws_sdk_pca_connector_ad.types.general_flags_v3.serialize_json(
            value["general_flags"]
        )
    )
    import aws_sdk_pca_connector_ad.types.hash_algorithm

    out["HashAlgorithm"] = aws_sdk_pca_connector_ad.types.hash_algorithm.serialize_json(
        value["hash_algorithm"]
    )
    import aws_sdk_pca_connector_ad.types.extensions_v3

    out["Extensions"] = aws_sdk_pca_connector_ad.types.extensions_v3.serialize_json(
        value["extensions"]
    )
    return out
...
def deserialize_json(data: dict) -> TemplateV3:
    ...
    if "PrivateKeyAttributes" in data:
        ...
        out["private_key_attributes"] = (
            aws_sdk_pca_connector_ad.types.private_key_attributes_v3.deserialize_json(
    ...
    if "PrivateKeyFlags" in data:
        ...
        out["private_key_flags"] = (
            aws_sdk_pca_connector_ad.types.private_key_flags_v3.deserialize_json(
    ...
    if "EnrollmentFlags" in data:
        ...
        out["enrollment_flags"] = (
            aws_sdk_pca_connector_ad.types.enrollment_flags_v3.deserialize_json(
    ...
    if "SubjectNameFlags" in data:
        ...
        out["subject_name_flags"] = (
            aws_sdk_pca_connector_ad.types.subject_name_flags_v3.deserialize_json(
    ...
    if "GeneralFlags" in data:
        ...
        out["general_flags"] = (
            aws_sdk_pca_connector_ad.types.general_flags_v3.deserialize_json(
                data["GeneralFlags"]
            )
        )
    else:
    ...
    if "Extensions" in data:
        ...
        out["extensions"] = (
            aws_sdk_pca_connector_ad.types.extensions_v3.deserialize_json(
                data["Extensions"]
            )
        )
    else:
