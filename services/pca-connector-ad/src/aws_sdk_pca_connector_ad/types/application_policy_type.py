"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#ApplicationPolicyType``."""

from typing import Literal, TypeAlias, cast

from aws_sdk_pca_connector_ad.errors import DeserializationError

ApplicationPolicyType: TypeAlias = Literal[
...
def serialize_json(value: ApplicationPolicyType) -> str:
    return value


def deserialize_json(data: str) -> ApplicationPolicyType:
    if data not in _VALUES:
        raise DeserializationError(f"unknown ApplicationPolicyType value: {data!r}")
    return cast(ApplicationPolicyType, data)
