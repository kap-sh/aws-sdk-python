"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#EnrollmentFlagsV2``."""

from typing_extensions import NotRequired, TypedDict


class EnrollmentFlagsV2(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: EnrollmentFlagsV2) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> EnrollmentFlagsV2:
    out: EnrollmentFlagsV2 = {}  # type: ignore[typeddict-item]
