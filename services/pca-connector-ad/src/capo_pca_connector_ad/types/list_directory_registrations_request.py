"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#ListDirectoryRegistrationsRequest``."""
...
class ListDirectoryRegistrationsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListDirectoryRegistrationsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListDirectoryRegistrationsRequest:
    out: ListDirectoryRegistrationsRequest = {}  # type: ignore[typeddict-item]
    return out
