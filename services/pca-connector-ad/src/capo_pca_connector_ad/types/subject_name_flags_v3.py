"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#SubjectNameFlagsV3``."""

from typing_extensions import NotRequired, TypedDict


class SubjectNameFlagsV3(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: SubjectNameFlagsV3) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> SubjectNameFlagsV3:
    out: SubjectNameFlagsV3 = {}  # type: ignore[typeddict-item]
