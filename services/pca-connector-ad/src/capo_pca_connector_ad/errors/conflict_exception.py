"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.pcaconnectorad#ConflictException``."""
