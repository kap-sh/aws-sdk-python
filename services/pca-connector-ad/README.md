...
```
pip install aws-sdk-pca-connector-ad
```

## Usage

```python
from aws_sdk_pca_connector_ad import AsyncPcaConnectorAdClient


async def main():
    async with AsyncPcaConnectorAdClient() as s3:
...
```python
from aws_sdk_pca_connector_ad import AsyncPcaConnectorAdClient
from aws_sdk_pca_connector_ad.error import AccessDeniedException
