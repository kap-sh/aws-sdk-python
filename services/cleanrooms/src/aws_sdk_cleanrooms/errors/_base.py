...
class CleanRoomsError(Exception):
    """Base class for all CleanRooms service errors."""

class ServiceError(CleanRoomsError):
...
class SerializationError(CleanRoomsError):
    """Raised when a value cannot be serialized."""

class DeserializationError(CleanRoomsError):
...
class WaiterFailedError(CleanRoomsError):
...
class WaiterTimeoutError(CleanRoomsError):
