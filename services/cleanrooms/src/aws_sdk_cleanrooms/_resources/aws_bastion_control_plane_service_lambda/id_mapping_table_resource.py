...
class IdMappingTableResource:
    ...
    def create(
        ...
        *,
        ...
        kms_key_arn: Optional["aws_sdk_cleanrooms.types.kms_key_arn.KMSKeyArn"] = None,
    ) -> "aws_sdk_cleanrooms.types.create_id_mapping_table_output.CreateIdMappingTableOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.create_id_mapping_table_input.CreateIdMappingTableInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.create_id_mapping_table_output.CreateIdMappingTableOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.create_id_mapping_table.create_id_mapping_table(
    ...
    def read(
        ...
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
    ) -> "aws_sdk_cleanrooms.types.get_id_mapping_table_output.GetIdMappingTableOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.get_id_mapping_table_input.GetIdMappingTableInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.get_id_mapping_table_output.GetIdMappingTableOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.get_id_mapping_table.get_id_mapping_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        ...
        kms_key_arn: Optional["aws_sdk_cleanrooms.types.kms_key_arn.KMSKeyArn"] = None,
    ) -> "aws_sdk_cleanrooms.types.update_id_mapping_table_output.UpdateIdMappingTableOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.update_id_mapping_table_input.UpdateIdMappingTableInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.update_id_mapping_table_output.UpdateIdMappingTableOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.update_id_mapping_table.update_id_mapping_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
    ) -> "aws_sdk_cleanrooms.types.delete_id_mapping_table_output.DeleteIdMappingTableOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.delete_id_mapping_table_input.DeleteIdMappingTableInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.delete_id_mapping_table_output.DeleteIdMappingTableOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.delete_id_mapping_table.delete_id_mapping_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_cleanrooms.types.list_id_mapping_tables_output.ListIdMappingTablesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.list_id_mapping_tables_input.ListIdMappingTablesInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.list_id_mapping_tables_output.ListIdMappingTablesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_id_mapping_tables.list_id_mapping_tables(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def populate_id_mapping_table(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.populate_id_mapping_table_input.PopulateIdMappingTableInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.populate_id_mapping_table_output.PopulateIdMappingTableOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.populate_id_mapping_table.populate_id_mapping_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncIdMappingTableResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.create_id_mapping_table_input.CreateIdMappingTableInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.create_id_mapping_table_output.CreateIdMappingTableOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.create_id_mapping_table
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.create_id_mapping_table.async_create_id_mapping_table(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.get_id_mapping_table_input.GetIdMappingTableInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.get_id_mapping_table_output.GetIdMappingTableOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.get_id_mapping_table
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.get_id_mapping_table.async_get_id_mapping_table(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.update_id_mapping_table_input.UpdateIdMappingTableInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.update_id_mapping_table_output.UpdateIdMappingTableOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.update_id_mapping_table
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.update_id_mapping_table.async_update_id_mapping_table(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.delete_id_mapping_table_input.DeleteIdMappingTableInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.delete_id_mapping_table_output.DeleteIdMappingTableOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.delete_id_mapping_table
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.delete_id_mapping_table.async_delete_id_mapping_table(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.list_id_mapping_tables_input.ListIdMappingTablesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.list_id_mapping_tables_output.ListIdMappingTablesOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_id_mapping_tables
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_id_mapping_tables.async_list_id_mapping_tables(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def populate_id_mapping_table(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.populate_id_mapping_table_input.PopulateIdMappingTableInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.populate_id_mapping_table_output.PopulateIdMappingTableOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.populate_id_mapping_table
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.populate_id_mapping_table.async_populate_id_mapping_table(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
