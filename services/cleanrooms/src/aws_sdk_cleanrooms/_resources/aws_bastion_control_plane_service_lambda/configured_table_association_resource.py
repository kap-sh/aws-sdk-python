...
class ConfiguredTableAssociationResource:
    ...
    def create(
        ...
        *,
    ...
    ) -> "aws_sdk_cleanrooms.types.create_configured_table_association_output.CreateConfiguredTableAssociationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.create_configured_table_association_input.CreateConfiguredTableAssociationInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.create_configured_table_association_output.CreateConfiguredTableAssociationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.create_configured_table_association.create_configured_table_association(
    ...
    def read(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.get_configured_table_association_input.GetConfiguredTableAssociationInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.get_configured_table_association_output.GetConfiguredTableAssociationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.get_configured_table_association.get_configured_table_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        ...
        role_arn: Optional["aws_sdk_cleanrooms.types.role_arn.RoleArn"] = None,
    ) -> "aws_sdk_cleanrooms.types.update_configured_table_association_output.UpdateConfiguredTableAssociationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.update_configured_table_association_input.UpdateConfiguredTableAssociationInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.update_configured_table_association_output.UpdateConfiguredTableAssociationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.update_configured_table_association.update_configured_table_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
    ) -> "aws_sdk_cleanrooms.types.delete_configured_table_association_output.DeleteConfiguredTableAssociationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.delete_configured_table_association_input.DeleteConfiguredTableAssociationInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.delete_configured_table_association_output.DeleteConfiguredTableAssociationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.delete_configured_table_association.delete_configured_table_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_cleanrooms.types.list_configured_table_associations_output.ListConfiguredTableAssociationsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.list_configured_table_associations_input.ListConfiguredTableAssociationsInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.list_configured_table_associations_output.ListConfiguredTableAssociationsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_configured_table_associations.list_configured_table_associations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_configured_table_association_analysis_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_input.CreateConfiguredTableAssociationAnalysisRuleInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_output.CreateConfiguredTableAssociationAnalysisRuleOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.create_configured_table_association_analysis_rule.create_configured_table_association_analysis_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_configured_table_association_analysis_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.delete_configured_table_association_analysis_rule_input.DeleteConfiguredTableAssociationAnalysisRuleInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.delete_configured_table_association_analysis_rule_output.DeleteConfiguredTableAssociationAnalysisRuleOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.delete_configured_table_association_analysis_rule.delete_configured_table_association_analysis_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_configured_table_association_analysis_rule(
        ...
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
    ) -> "aws_sdk_cleanrooms.types.get_configured_table_association_analysis_rule_output.GetConfiguredTableAssociationAnalysisRuleOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.get_configured_table_association_analysis_rule_input.GetConfiguredTableAssociationAnalysisRuleInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.get_configured_table_association_analysis_rule_output.GetConfiguredTableAssociationAnalysisRuleOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.get_configured_table_association_analysis_rule.get_configured_table_association_analysis_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_configured_table_association_analysis_rule(
        ...
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
    ) -> "aws_sdk_cleanrooms.types.update_configured_table_association_analysis_rule_output.UpdateConfiguredTableAssociationAnalysisRuleOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cleanrooms.types.update_configured_table_association_analysis_rule_input.UpdateConfiguredTableAssociationAnalysisRuleInput]",
        ) -> OperationResponse[
            "aws_sdk_cleanrooms.types.update_configured_table_association_analysis_rule_output.UpdateConfiguredTableAssociationAnalysisRuleOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.update_configured_table_association_analysis_rule.update_configured_table_association_analysis_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncConfiguredTableAssociationResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.create_configured_table_association_input.CreateConfiguredTableAssociationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.create_configured_table_association_output.CreateConfiguredTableAssociationOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.create_configured_table_association
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.create_configured_table_association.async_create_configured_table_association(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.get_configured_table_association_input.GetConfiguredTableAssociationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.get_configured_table_association_output.GetConfiguredTableAssociationOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.get_configured_table_association
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.get_configured_table_association.async_get_configured_table_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.update_configured_table_association_input.UpdateConfiguredTableAssociationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.update_configured_table_association_output.UpdateConfiguredTableAssociationOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.update_configured_table_association
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.update_configured_table_association.async_update_configured_table_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.delete_configured_table_association_input.DeleteConfiguredTableAssociationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.delete_configured_table_association_output.DeleteConfiguredTableAssociationOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.delete_configured_table_association
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.delete_configured_table_association.async_delete_configured_table_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.list_configured_table_associations_input.ListConfiguredTableAssociationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.list_configured_table_associations_output.ListConfiguredTableAssociationsOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_configured_table_associations
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_configured_table_associations.async_list_configured_table_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_configured_table_association_analysis_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_input.CreateConfiguredTableAssociationAnalysisRuleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_output.CreateConfiguredTableAssociationAnalysisRuleOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.create_configured_table_association_analysis_rule
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.create_configured_table_association_analysis_rule.async_create_configured_table_association_analysis_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_configured_table_association_analysis_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.delete_configured_table_association_analysis_rule_input.DeleteConfiguredTableAssociationAnalysisRuleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.delete_configured_table_association_analysis_rule_output.DeleteConfiguredTableAssociationAnalysisRuleOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.delete_configured_table_association_analysis_rule
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.delete_configured_table_association_analysis_rule.async_delete_configured_table_association_analysis_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_configured_table_association_analysis_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.get_configured_table_association_analysis_rule_input.GetConfiguredTableAssociationAnalysisRuleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.get_configured_table_association_analysis_rule_output.GetConfiguredTableAssociationAnalysisRuleOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.get_configured_table_association_analysis_rule
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.get_configured_table_association_analysis_rule.async_get_configured_table_association_analysis_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_configured_table_association_analysis_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cleanrooms.types.update_configured_table_association_analysis_rule_input.UpdateConfiguredTableAssociationAnalysisRuleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cleanrooms.types.update_configured_table_association_analysis_rule_output.UpdateConfiguredTableAssociationAnalysisRuleOutput"
        ]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.update_configured_table_association_analysis_rule
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.update_configured_table_association_analysis_rule.async_update_configured_table_association_analysis_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
