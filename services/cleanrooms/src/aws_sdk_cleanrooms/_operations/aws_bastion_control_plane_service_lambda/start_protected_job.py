...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.start_protected_job_output.StartProtectedJobOutput = (
        aws_sdk_cleanrooms.types.start_protected_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.start_protected_job_input.StartProtectedJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.start_protected_job_input.serialize_json(input_)
    ).encode()
