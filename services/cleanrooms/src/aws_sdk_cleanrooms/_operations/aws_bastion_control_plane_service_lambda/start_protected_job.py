...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.start_protected_job_input.StartProtectedJobInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.start_protected_job_input.serialize_json(input)
    ).encode()
