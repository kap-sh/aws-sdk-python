...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.delete_configured_table_association_analysis_rule_input.DeleteConfiguredTableAssociationAnalysisRuleInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{analysisRuleType}", quote(str(input["analysis_rule_type"]), safe="")
    )
    params: dict[str, str] = {}
