...
) -> aws_sdk_cleanrooms.types.delete_configured_table_association_analysis_rule_output.DeleteConfiguredTableAssociationAnalysisRuleOutput:
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.delete_configured_table_association_analysis_rule_input.DeleteConfiguredTableAssociationAnalysisRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_configured_table_association_analysis_rule(
