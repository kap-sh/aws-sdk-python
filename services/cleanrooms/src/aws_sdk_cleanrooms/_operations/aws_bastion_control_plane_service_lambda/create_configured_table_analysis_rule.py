...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.create_configured_table_analysis_rule_input.CreateConfiguredTableAnalysisRuleInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["configured_table_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
