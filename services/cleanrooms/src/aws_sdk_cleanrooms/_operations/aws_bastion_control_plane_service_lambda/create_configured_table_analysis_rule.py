...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.create_configured_table_analysis_rule_output.CreateConfiguredTableAnalysisRuleOutput = aws_sdk_cleanrooms.types.create_configured_table_analysis_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.create_configured_table_analysis_rule_input.CreateConfiguredTableAnalysisRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_configured_table_analysis_rule_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_configured_table_analysis_rule(
