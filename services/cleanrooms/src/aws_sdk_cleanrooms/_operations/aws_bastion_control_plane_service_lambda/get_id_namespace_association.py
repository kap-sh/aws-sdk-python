...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_id_namespace_association_output.GetIdNamespaceAssociationOutput = aws_sdk_cleanrooms.types.get_id_namespace_association_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_id_namespace_association_input.GetIdNamespaceAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_id_namespace_association(
