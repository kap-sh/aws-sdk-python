"""Generated from Smithy shape ``com.amazonaws.cleanrooms#DeleteConfiguredTable``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.delete_configured_table_output.DeleteConfiguredTableOutput:
    out: aws_sdk_cleanrooms.types.delete_configured_table_output.DeleteConfiguredTableOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.delete_configured_table_input.DeleteConfiguredTableInput) -> zapros.Request:
...
def delete_configured_table(options: OperationOptions, input: aws_sdk_cleanrooms.types.delete_configured_table_input.DeleteConfiguredTableInput) -> tuple[aws_sdk_cleanrooms.types.delete_configured_table_output.DeleteConfiguredTableOutput, zapros.Response]:
...
async def async_delete_configured_table(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.delete_configured_table_input.DeleteConfiguredTableInput) -> tuple[aws_sdk_cleanrooms.types.delete_configured_table_output.DeleteConfiguredTableOutput, zapros.Response]:
