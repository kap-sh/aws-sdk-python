...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_configured_audience_model_associations_output.ListConfiguredAudienceModelAssociationsOutput = aws_sdk_cleanrooms.types.list_configured_audience_model_associations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_configured_audience_model_associations_input.ListConfiguredAudienceModelAssociationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
