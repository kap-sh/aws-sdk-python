"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListConfiguredAudienceModelAssociations``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_configured_audience_model_associations_output.ListConfiguredAudienceModelAssociationsOutput:
    import aws_sdk_cleanrooms.types.list_configured_audience_model_associations_output
    out: aws_sdk_cleanrooms.types.list_configured_audience_model_associations_output.ListConfiguredAudienceModelAssociationsOutput = aws_sdk_cleanrooms.types.list_configured_audience_model_associations_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_configured_audience_model_associations_input.ListConfiguredAudienceModelAssociationsInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/configuredaudiencemodelassociations"
...
def list_configured_audience_model_associations(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_configured_audience_model_associations_input.ListConfiguredAudienceModelAssociationsInput) -> tuple[aws_sdk_cleanrooms.types.list_configured_audience_model_associations_output.ListConfiguredAudienceModelAssociationsOutput, zapros.Response]:
...
async def async_list_configured_audience_model_associations(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_configured_audience_model_associations_input.ListConfiguredAudienceModelAssociationsInput) -> tuple[aws_sdk_cleanrooms.types.list_configured_audience_model_associations_output.ListConfiguredAudienceModelAssociationsOutput, zapros.Response]:
