...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_collaboration_output.GetCollaborationOutput = (
        aws_sdk_cleanrooms.types.get_collaboration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_collaboration_input.GetCollaborationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_collaboration(
