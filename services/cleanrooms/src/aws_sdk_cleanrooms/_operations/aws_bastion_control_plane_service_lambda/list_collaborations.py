"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListCollaborations``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_collaborations_output.ListCollaborationsOutput:
    import aws_sdk_cleanrooms.types.list_collaborations_output
    out: aws_sdk_cleanrooms.types.list_collaborations_output.ListCollaborationsOutput = aws_sdk_cleanrooms.types.list_collaborations_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_collaborations_input.ListCollaborationsInput) -> zapros.Request:
    ...
    if "member_status" in input:
        params["memberStatus"] = str(input["member_status"])
...
def list_collaborations(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_collaborations_input.ListCollaborationsInput) -> tuple[aws_sdk_cleanrooms.types.list_collaborations_output.ListCollaborationsOutput, zapros.Response]:
...
async def async_list_collaborations(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_collaborations_input.ListCollaborationsInput) -> tuple[aws_sdk_cleanrooms.types.list_collaborations_output.ListCollaborationsOutput, zapros.Response]:
