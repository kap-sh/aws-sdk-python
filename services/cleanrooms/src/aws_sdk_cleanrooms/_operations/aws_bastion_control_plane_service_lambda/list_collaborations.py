...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_collaborations_output.ListCollaborationsOutput = aws_sdk_cleanrooms.types.list_collaborations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_collaborations_input.ListCollaborationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "member_status" in input_:
        params["memberStatus"] = str(input_["member_status"])
...
async def async_list_collaborations(
