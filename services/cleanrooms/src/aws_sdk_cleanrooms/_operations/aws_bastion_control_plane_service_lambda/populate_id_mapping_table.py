...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.populate_id_mapping_table_output.PopulateIdMappingTableOutput = aws_sdk_cleanrooms.types.populate_id_mapping_table_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.populate_id_mapping_table_input.PopulateIdMappingTableInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.populate_id_mapping_table_input.serialize_json(input_)
    ).encode()
...
async def async_populate_id_mapping_table(
