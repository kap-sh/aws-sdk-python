...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.populate_id_mapping_table_input.PopulateIdMappingTableInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["id_mapping_table_identifier"]), safe=""),
    )
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.populate_id_mapping_table_input.serialize_json(input)
    ).encode()
