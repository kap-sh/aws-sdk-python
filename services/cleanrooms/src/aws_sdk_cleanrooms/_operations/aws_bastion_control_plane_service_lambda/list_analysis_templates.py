"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListAnalysisTemplates``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_analysis_templates_output.ListAnalysisTemplatesOutput:
    import aws_sdk_cleanrooms.types.list_analysis_templates_output
    out: aws_sdk_cleanrooms.types.list_analysis_templates_output.ListAnalysisTemplatesOutput = aws_sdk_cleanrooms.types.list_analysis_templates_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_analysis_templates_input.ListAnalysisTemplatesInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/analysistemplates"
...
def list_analysis_templates(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_analysis_templates_input.ListAnalysisTemplatesInput) -> tuple[aws_sdk_cleanrooms.types.list_analysis_templates_output.ListAnalysisTemplatesOutput, zapros.Response]:
...
async def async_list_analysis_templates(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_analysis_templates_input.ListAnalysisTemplatesInput) -> tuple[aws_sdk_cleanrooms.types.list_analysis_templates_output.ListAnalysisTemplatesOutput, zapros.Response]:
