...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_analysis_templates_output.ListAnalysisTemplatesOutput = aws_sdk_cleanrooms.types.list_analysis_templates_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_analysis_templates_input.ListAnalysisTemplatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
