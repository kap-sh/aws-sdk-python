...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_protected_job_output.GetProtectedJobOutput = (
        aws_sdk_cleanrooms.types.get_protected_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_protected_job_input.GetProtectedJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["protected_job_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_protected_job(
