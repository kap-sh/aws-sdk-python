"""Generated from Smithy shape ``com.amazonaws.cleanrooms#GetProtectedJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.get_protected_job_output.GetProtectedJobOutput:
    import aws_sdk_cleanrooms.types.get_protected_job_output
    out: aws_sdk_cleanrooms.types.get_protected_job_output.GetProtectedJobOutput = aws_sdk_cleanrooms.types.get_protected_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.get_protected_job_input.GetProtectedJobInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/protectedJobs/{protectedJobIdentifier}"
    url = url.replace("{membershipIdentifier}", quote(str(input["membership_identifier"]), safe=""))
    url = url.replace("{protectedJobIdentifier}", quote(str(input["protected_job_identifier"]), safe=""))
    params: dict[str, str] = {}
...
def get_protected_job(options: OperationOptions, input: aws_sdk_cleanrooms.types.get_protected_job_input.GetProtectedJobInput) -> tuple[aws_sdk_cleanrooms.types.get_protected_job_output.GetProtectedJobOutput, zapros.Response]:
...
async def async_get_protected_job(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.get_protected_job_input.GetProtectedJobInput) -> tuple[aws_sdk_cleanrooms.types.get_protected_job_output.GetProtectedJobOutput, zapros.Response]:
