...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.create_configured_table_input.CreateConfiguredTableInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_configured_table_input.serialize_json(input)
    ).encode()
