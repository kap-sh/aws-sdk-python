...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_schemas_output.ListSchemasOutput = (
        aws_sdk_cleanrooms.types.list_schemas_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.list_schemas_input.ListSchemasInput,
) -> zapros.Request:
...
def list_schemas(
    ...
    aws_sdk_cleanrooms.types.list_schemas_output.ListSchemasOutput, zapros.Response
]:
