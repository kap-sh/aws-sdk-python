...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_schemas_output.ListSchemasOutput:
    import aws_sdk_cleanrooms.types.list_schemas_output
    out: aws_sdk_cleanrooms.types.list_schemas_output.ListSchemasOutput = aws_sdk_cleanrooms.types.list_schemas_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_schemas_input.ListSchemasInput) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "schema_type" in input:
        params["schemaType"] = str(input["schema_type"])
...
def list_schemas(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_schemas_input.ListSchemasInput) -> tuple[aws_sdk_cleanrooms.types.list_schemas_output.ListSchemasOutput, zapros.Response]:
...
async def async_list_schemas(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_schemas_input.ListSchemasInput) -> tuple[aws_sdk_cleanrooms.types.list_schemas_output.ListSchemasOutput, zapros.Response]:
