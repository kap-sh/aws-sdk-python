...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_collaboration_change_requests_output.ListCollaborationChangeRequestsOutput = aws_sdk_cleanrooms.types.list_collaboration_change_requests_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_collaboration_change_requests_input.ListCollaborationChangeRequestsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
