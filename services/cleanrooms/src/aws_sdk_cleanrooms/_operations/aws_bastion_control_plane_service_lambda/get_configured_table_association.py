...
) -> aws_sdk_cleanrooms.types.get_configured_table_association_output.GetConfiguredTableAssociationOutput:
    import aws_sdk_cleanrooms.types.get_configured_table_association_output

    out: aws_sdk_cleanrooms.types.get_configured_table_association_output.GetConfiguredTableAssociationOutput = aws_sdk_cleanrooms.types.get_configured_table_association_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_configured_table_association_input.GetConfiguredTableAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
