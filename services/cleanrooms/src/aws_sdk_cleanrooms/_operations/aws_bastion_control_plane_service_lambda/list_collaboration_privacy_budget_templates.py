...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_collaboration_privacy_budget_templates_output.ListCollaborationPrivacyBudgetTemplatesOutput = aws_sdk_cleanrooms.types.list_collaboration_privacy_budget_templates_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_collaboration_privacy_budget_templates_input.ListCollaborationPrivacyBudgetTemplatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
