...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.update_configured_table_output.UpdateConfiguredTableOutput = aws_sdk_cleanrooms.types.update_configured_table_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.update_configured_table_input.UpdateConfiguredTableInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_configured_table_input.serialize_json(input_)
    ).encode()
...
async def async_update_configured_table(
