...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.update_configured_table_input.UpdateConfiguredTableInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_configured_table_input.serialize_json(input)
    ).encode()
