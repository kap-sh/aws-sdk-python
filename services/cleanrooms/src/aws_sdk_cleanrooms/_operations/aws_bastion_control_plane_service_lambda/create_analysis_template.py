...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.create_analysis_template_input.CreateAnalysisTemplateInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_analysis_template_input.serialize_json(input)
    ).encode()
