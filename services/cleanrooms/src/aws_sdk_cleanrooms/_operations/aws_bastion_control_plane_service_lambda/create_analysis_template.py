...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.create_analysis_template_input.CreateAnalysisTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_analysis_template_input.serialize_json(input_)
    ).encode()
