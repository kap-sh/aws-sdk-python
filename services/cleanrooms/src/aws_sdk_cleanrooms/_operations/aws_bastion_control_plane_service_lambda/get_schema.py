...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_schema_output.GetSchemaOutput = (
        aws_sdk_cleanrooms.types.get_schema_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_schema_input.GetSchemaInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_schema(
    ...
    input_: aws_sdk_cleanrooms.types.get_schema_input.GetSchemaInput,
) -> tuple[aws_sdk_cleanrooms.types.get_schema_output.GetSchemaOutput, zapros.Response]:
