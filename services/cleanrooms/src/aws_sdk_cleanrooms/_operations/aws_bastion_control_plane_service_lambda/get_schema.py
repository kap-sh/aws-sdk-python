"""Generated from Smithy shape ``com.amazonaws.cleanrooms#GetSchema``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.get_schema_output.GetSchemaOutput:
    import aws_sdk_cleanrooms.types.get_schema_output
    out: aws_sdk_cleanrooms.types.get_schema_output.GetSchemaOutput = aws_sdk_cleanrooms.types.get_schema_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.get_schema_input.GetSchemaInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/collaborations/{collaborationIdentifier}/schemas/{name}"
...
def get_schema(options: OperationOptions, input: aws_sdk_cleanrooms.types.get_schema_input.GetSchemaInput) -> tuple[aws_sdk_cleanrooms.types.get_schema_output.GetSchemaOutput, zapros.Response]:
...
async def async_get_schema(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.get_schema_input.GetSchemaInput) -> tuple[aws_sdk_cleanrooms.types.get_schema_output.GetSchemaOutput, zapros.Response]:
