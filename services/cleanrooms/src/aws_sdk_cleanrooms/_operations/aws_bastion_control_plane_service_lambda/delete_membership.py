...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.delete_membership_output.DeleteMembershipOutput:
    out: aws_sdk_cleanrooms.types.delete_membership_output.DeleteMembershipOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.delete_membership_input.DeleteMembershipInput) -> zapros.Request:
...
def delete_membership(options: OperationOptions, input: aws_sdk_cleanrooms.types.delete_membership_input.DeleteMembershipInput) -> tuple[aws_sdk_cleanrooms.types.delete_membership_output.DeleteMembershipOutput, zapros.Response]:
...
async def async_delete_membership(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.delete_membership_input.DeleteMembershipInput) -> tuple[aws_sdk_cleanrooms.types.delete_membership_output.DeleteMembershipOutput, zapros.Response]:
