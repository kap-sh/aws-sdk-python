...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_protected_jobs_output.ListProtectedJobsOutput = (
        aws_sdk_cleanrooms.types.list_protected_jobs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_protected_jobs_input.ListProtectedJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
