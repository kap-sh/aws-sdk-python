"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListProtectedJobs``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_protected_jobs_output.ListProtectedJobsOutput:
    import aws_sdk_cleanrooms.types.list_protected_jobs_output
    out: aws_sdk_cleanrooms.types.list_protected_jobs_output.ListProtectedJobsOutput = aws_sdk_cleanrooms.types.list_protected_jobs_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_protected_jobs_input.ListProtectedJobsInput) -> zapros.Request:
...
def list_protected_jobs(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_protected_jobs_input.ListProtectedJobsInput) -> tuple[aws_sdk_cleanrooms.types.list_protected_jobs_output.ListProtectedJobsOutput, zapros.Response]:
...
async def async_list_protected_jobs(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_protected_jobs_input.ListProtectedJobsInput) -> tuple[aws_sdk_cleanrooms.types.list_protected_jobs_output.ListProtectedJobsOutput, zapros.Response]:
