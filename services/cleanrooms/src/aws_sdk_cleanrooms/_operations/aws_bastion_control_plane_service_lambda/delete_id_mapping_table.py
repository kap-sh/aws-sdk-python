...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.delete_id_mapping_table_output.DeleteIdMappingTableOutput:
    out: aws_sdk_cleanrooms.types.delete_id_mapping_table_output.DeleteIdMappingTableOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.delete_id_mapping_table_input.DeleteIdMappingTableInput) -> zapros.Request:
...
def delete_id_mapping_table(options: OperationOptions, input: aws_sdk_cleanrooms.types.delete_id_mapping_table_input.DeleteIdMappingTableInput) -> tuple[aws_sdk_cleanrooms.types.delete_id_mapping_table_output.DeleteIdMappingTableOutput, zapros.Response]:
...
async def async_delete_id_mapping_table(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.delete_id_mapping_table_input.DeleteIdMappingTableInput) -> tuple[aws_sdk_cleanrooms.types.delete_id_mapping_table_output.DeleteIdMappingTableOutput, zapros.Response]:
