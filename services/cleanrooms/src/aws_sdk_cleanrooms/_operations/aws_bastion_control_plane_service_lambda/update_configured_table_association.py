...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.update_configured_table_association_output.UpdateConfiguredTableAssociationOutput = aws_sdk_cleanrooms.types.update_configured_table_association_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.update_configured_table_association_input.UpdateConfiguredTableAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_configured_table_association_input.serialize_json(
            input_
        )
    ).encode()
