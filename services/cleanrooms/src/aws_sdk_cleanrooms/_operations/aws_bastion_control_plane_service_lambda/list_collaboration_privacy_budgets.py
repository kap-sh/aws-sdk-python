...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_collaboration_privacy_budgets_output.ListCollaborationPrivacyBudgetsOutput = aws_sdk_cleanrooms.types.list_collaboration_privacy_budgets_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_collaboration_privacy_budgets_input.ListCollaborationPrivacyBudgetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_collaboration_privacy_budgets(
