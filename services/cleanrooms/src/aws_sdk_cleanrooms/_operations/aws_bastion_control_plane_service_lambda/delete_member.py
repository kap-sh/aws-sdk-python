...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.delete_member_output.DeleteMemberOutput:
    out: aws_sdk_cleanrooms.types.delete_member_output.DeleteMemberOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.delete_member_input.DeleteMemberInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/collaborations/{collaborationIdentifier}/member/{accountId}"
...
def delete_member(options: OperationOptions, input: aws_sdk_cleanrooms.types.delete_member_input.DeleteMemberInput) -> tuple[aws_sdk_cleanrooms.types.delete_member_output.DeleteMemberOutput, zapros.Response]:
...
async def async_delete_member(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.delete_member_input.DeleteMemberInput) -> tuple[aws_sdk_cleanrooms.types.delete_member_output.DeleteMemberOutput, zapros.Response]:
