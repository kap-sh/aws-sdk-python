...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_memberships_output.ListMembershipsOutput = (
        aws_sdk_cleanrooms.types.list_memberships_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_memberships_input.ListMembershipsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
