...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_memberships_output.ListMembershipsOutput:
    import aws_sdk_cleanrooms.types.list_memberships_output
    out: aws_sdk_cleanrooms.types.list_memberships_output.ListMembershipsOutput = aws_sdk_cleanrooms.types.list_memberships_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_memberships_input.ListMembershipsInput) -> zapros.Request:
...
def list_memberships(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_memberships_input.ListMembershipsInput) -> tuple[aws_sdk_cleanrooms.types.list_memberships_output.ListMembershipsOutput, zapros.Response]:
...
async def async_list_memberships(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_memberships_input.ListMembershipsInput) -> tuple[aws_sdk_cleanrooms.types.list_memberships_output.ListMembershipsOutput, zapros.Response]:
