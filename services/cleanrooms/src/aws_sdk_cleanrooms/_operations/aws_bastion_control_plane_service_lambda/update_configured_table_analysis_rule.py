...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.update_configured_table_analysis_rule_output.UpdateConfiguredTableAnalysisRuleOutput = aws_sdk_cleanrooms.types.update_configured_table_analysis_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.update_configured_table_analysis_rule_input.UpdateConfiguredTableAnalysisRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_configured_table_analysis_rule_input.serialize_json(
            input_
        )
    ).encode()
