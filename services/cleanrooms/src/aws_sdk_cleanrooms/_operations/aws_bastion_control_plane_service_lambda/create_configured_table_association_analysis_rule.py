...
) -> aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_output.CreateConfiguredTableAssociationAnalysisRuleOutput:
    import aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_output

    out: aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_output.CreateConfiguredTableAssociationAnalysisRuleOutput = aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_input.CreateConfiguredTableAssociationAnalysisRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_configured_table_association_analysis_rule(
