...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.create_configured_table_association_analysis_rule_input.CreateConfiguredTableAssociationAnalysisRuleInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["configured_table_association_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
