...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.create_privacy_budget_template_output.CreatePrivacyBudgetTemplateOutput = aws_sdk_cleanrooms.types.create_privacy_budget_template_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.create_privacy_budget_template_input.CreatePrivacyBudgetTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_privacy_budget_template_input.serialize_json(
            input_
        )
    ).encode()
