...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.get_collaboration_id_namespace_association_input.GetCollaborationIdNamespaceAssociationInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["id_namespace_association_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
