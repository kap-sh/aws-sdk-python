...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_collaboration_id_namespace_association_output.GetCollaborationIdNamespaceAssociationOutput = aws_sdk_cleanrooms.types.get_collaboration_id_namespace_association_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_collaboration_id_namespace_association_input.GetCollaborationIdNamespaceAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
