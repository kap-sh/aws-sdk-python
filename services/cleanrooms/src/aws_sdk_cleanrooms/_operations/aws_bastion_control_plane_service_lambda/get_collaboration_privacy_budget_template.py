...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_collaboration_privacy_budget_template_output.GetCollaborationPrivacyBudgetTemplateOutput = aws_sdk_cleanrooms.types.get_collaboration_privacy_budget_template_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_collaboration_privacy_budget_template_input.GetCollaborationPrivacyBudgetTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
