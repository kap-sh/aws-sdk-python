...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_id_mapping_tables_output.ListIdMappingTablesOutput = aws_sdk_cleanrooms.types.list_id_mapping_tables_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_id_mapping_tables_input.ListIdMappingTablesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_id_mapping_tables(
