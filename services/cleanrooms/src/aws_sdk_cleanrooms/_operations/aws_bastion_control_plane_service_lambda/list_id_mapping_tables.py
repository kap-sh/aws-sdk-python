"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListIdMappingTables``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_id_mapping_tables_output.ListIdMappingTablesOutput:
    import aws_sdk_cleanrooms.types.list_id_mapping_tables_output
    out: aws_sdk_cleanrooms.types.list_id_mapping_tables_output.ListIdMappingTablesOutput = aws_sdk_cleanrooms.types.list_id_mapping_tables_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_id_mapping_tables_input.ListIdMappingTablesInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/idmappingtables"
...
def list_id_mapping_tables(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_id_mapping_tables_input.ListIdMappingTablesInput) -> tuple[aws_sdk_cleanrooms.types.list_id_mapping_tables_output.ListIdMappingTablesOutput, zapros.Response]:
...
async def async_list_id_mapping_tables(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_id_mapping_tables_input.ListIdMappingTablesInput) -> tuple[aws_sdk_cleanrooms.types.list_id_mapping_tables_output.ListIdMappingTablesOutput, zapros.Response]:
