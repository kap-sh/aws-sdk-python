...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.start_protected_query_output.StartProtectedQueryOutput = aws_sdk_cleanrooms.types.start_protected_query_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.start_protected_query_input.StartProtectedQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.start_protected_query_input.serialize_json(input_)
    ).encode()
...
async def async_start_protected_query(
