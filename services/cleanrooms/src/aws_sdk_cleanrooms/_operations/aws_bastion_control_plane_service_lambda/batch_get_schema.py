...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.batch_get_schema_output.BatchGetSchemaOutput:
    import aws_sdk_cleanrooms.types.batch_get_schema_output
    out: aws_sdk_cleanrooms.types.batch_get_schema_output.BatchGetSchemaOutput = aws_sdk_cleanrooms.types.batch_get_schema_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.batch_get_schema_input.BatchGetSchemaInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/collaborations/{collaborationIdentifier}/batch-schema"
    url = url.replace("{collaborationIdentifier}", quote(str(input["collaboration_identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_cleanrooms.types.batch_get_schema_input
    body: bytes | None = json.dumps(aws_sdk_cleanrooms.types.batch_get_schema_input.serialize_json(input)).encode()
...
def batch_get_schema(options: OperationOptions, input: aws_sdk_cleanrooms.types.batch_get_schema_input.BatchGetSchemaInput) -> tuple[aws_sdk_cleanrooms.types.batch_get_schema_output.BatchGetSchemaOutput, zapros.Response]:
...
async def async_batch_get_schema(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.batch_get_schema_input.BatchGetSchemaInput) -> tuple[aws_sdk_cleanrooms.types.batch_get_schema_output.BatchGetSchemaOutput, zapros.Response]:
