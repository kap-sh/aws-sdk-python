...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_id_mapping_table_output.GetIdMappingTableOutput = aws_sdk_cleanrooms.types.get_id_mapping_table_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_id_mapping_table_input.GetIdMappingTableInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
