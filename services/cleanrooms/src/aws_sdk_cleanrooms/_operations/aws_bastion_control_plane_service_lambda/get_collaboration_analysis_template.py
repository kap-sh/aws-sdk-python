...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_collaboration_analysis_template_output.GetCollaborationAnalysisTemplateOutput = aws_sdk_cleanrooms.types.get_collaboration_analysis_template_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.get_collaboration_analysis_template_input.GetCollaborationAnalysisTemplateInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{analysisTemplateArn}", quote(str(input["analysis_template_arn"]), safe="")
    )
    params: dict[str, str] = {}
