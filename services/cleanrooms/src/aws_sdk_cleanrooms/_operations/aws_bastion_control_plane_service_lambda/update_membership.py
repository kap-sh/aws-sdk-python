...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.update_membership_output.UpdateMembershipOutput = (
        aws_sdk_cleanrooms.types.update_membership_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.update_membership_input.UpdateMembershipInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_membership_input.serialize_json(input_)
    ).encode()
