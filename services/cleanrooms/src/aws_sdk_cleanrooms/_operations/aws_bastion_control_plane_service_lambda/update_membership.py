...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.update_membership_output.UpdateMembershipOutput:
    import aws_sdk_cleanrooms.types.update_membership_output
    out: aws_sdk_cleanrooms.types.update_membership_output.UpdateMembershipOutput = aws_sdk_cleanrooms.types.update_membership_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.update_membership_input.UpdateMembershipInput) -> zapros.Request:
    ...
    import aws_sdk_cleanrooms.types.update_membership_input
    body: bytes | None = json.dumps(aws_sdk_cleanrooms.types.update_membership_input.serialize_json(input)).encode()
...
def update_membership(options: OperationOptions, input: aws_sdk_cleanrooms.types.update_membership_input.UpdateMembershipInput) -> tuple[aws_sdk_cleanrooms.types.update_membership_output.UpdateMembershipOutput, zapros.Response]:
...
async def async_update_membership(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.update_membership_input.UpdateMembershipInput) -> tuple[aws_sdk_cleanrooms.types.update_membership_output.UpdateMembershipOutput, zapros.Response]:
