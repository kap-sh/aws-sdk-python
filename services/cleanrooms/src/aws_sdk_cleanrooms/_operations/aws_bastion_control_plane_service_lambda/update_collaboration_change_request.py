...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.update_collaboration_change_request_input.UpdateCollaborationChangeRequestInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["change_request_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
