...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.update_collaboration_change_request_output.UpdateCollaborationChangeRequestOutput = aws_sdk_cleanrooms.types.update_collaboration_change_request_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.update_collaboration_change_request_input.UpdateCollaborationChangeRequestInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_collaboration_change_request_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_collaboration_change_request(
