...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.create_collaboration_input.CreateCollaborationInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_collaboration_input.serialize_json(input)
    ).encode()
