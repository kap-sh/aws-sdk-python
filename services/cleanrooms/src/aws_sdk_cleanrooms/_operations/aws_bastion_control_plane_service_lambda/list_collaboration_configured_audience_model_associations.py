...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_collaboration_configured_audience_model_associations_output.ListCollaborationConfiguredAudienceModelAssociationsOutput = aws_sdk_cleanrooms.types.list_collaboration_configured_audience_model_associations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_collaboration_configured_audience_model_associations_input.ListCollaborationConfiguredAudienceModelAssociationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
