...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.list_collaboration_configured_audience_model_associations_input.ListCollaborationConfiguredAudienceModelAssociationsInput,
) -> zapros.Request:
