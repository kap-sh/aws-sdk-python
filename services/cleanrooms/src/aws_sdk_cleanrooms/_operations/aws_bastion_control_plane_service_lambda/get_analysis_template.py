...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_analysis_template_output.GetAnalysisTemplateOutput = aws_sdk_cleanrooms.types.get_analysis_template_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_analysis_template_input.GetAnalysisTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
