...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.update_id_mapping_table_output.UpdateIdMappingTableOutput = aws_sdk_cleanrooms.types.update_id_mapping_table_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.update_id_mapping_table_input.UpdateIdMappingTableInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_id_mapping_table_input.serialize_json(input_)
    ).encode()
