...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_configured_audience_model_association_output.GetConfiguredAudienceModelAssociationOutput = aws_sdk_cleanrooms.types.get_configured_audience_model_association_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_configured_audience_model_association_input.GetConfiguredAudienceModelAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
