...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_membership_output.GetMembershipOutput = (
        aws_sdk_cleanrooms.types.get_membership_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_membership_input.GetMembershipInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_membership(
    ...
    aws_sdk_cleanrooms.types.get_membership_output.GetMembershipOutput, zapros.Response
]:
