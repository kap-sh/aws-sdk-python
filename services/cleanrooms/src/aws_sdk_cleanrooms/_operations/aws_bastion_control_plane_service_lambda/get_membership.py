"""Generated from Smithy shape ``com.amazonaws.cleanrooms#GetMembership``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.get_membership_output.GetMembershipOutput:
    import aws_sdk_cleanrooms.types.get_membership_output
    out: aws_sdk_cleanrooms.types.get_membership_output.GetMembershipOutput = aws_sdk_cleanrooms.types.get_membership_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.get_membership_input.GetMembershipInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}"
...
def get_membership(options: OperationOptions, input: aws_sdk_cleanrooms.types.get_membership_input.GetMembershipInput) -> tuple[aws_sdk_cleanrooms.types.get_membership_output.GetMembershipOutput, zapros.Response]:
...
async def async_get_membership(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.get_membership_input.GetMembershipInput) -> tuple[aws_sdk_cleanrooms.types.get_membership_output.GetMembershipOutput, zapros.Response]:
