...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.get_schema_analysis_rule_output.GetSchemaAnalysisRuleOutput:
    import aws_sdk_cleanrooms.types.get_schema_analysis_rule_output
    out: aws_sdk_cleanrooms.types.get_schema_analysis_rule_output.GetSchemaAnalysisRuleOutput = aws_sdk_cleanrooms.types.get_schema_analysis_rule_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.get_schema_analysis_rule_input.GetSchemaAnalysisRuleInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/collaborations/{collaborationIdentifier}/schemas/{name}/analysisRule/{type}"
...
def get_schema_analysis_rule(options: OperationOptions, input: aws_sdk_cleanrooms.types.get_schema_analysis_rule_input.GetSchemaAnalysisRuleInput) -> tuple[aws_sdk_cleanrooms.types.get_schema_analysis_rule_output.GetSchemaAnalysisRuleOutput, zapros.Response]:
...
async def async_get_schema_analysis_rule(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.get_schema_analysis_rule_input.GetSchemaAnalysisRuleInput) -> tuple[aws_sdk_cleanrooms.types.get_schema_analysis_rule_output.GetSchemaAnalysisRuleOutput, zapros.Response]:
