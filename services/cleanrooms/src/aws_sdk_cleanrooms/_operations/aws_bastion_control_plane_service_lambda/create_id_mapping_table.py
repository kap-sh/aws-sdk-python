...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.create_id_mapping_table_input.CreateIdMappingTableInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_id_mapping_table_input.serialize_json(input)
    ).encode()
