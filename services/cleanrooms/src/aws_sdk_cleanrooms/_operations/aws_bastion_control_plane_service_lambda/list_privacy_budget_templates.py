...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_privacy_budget_templates_output.ListPrivacyBudgetTemplatesOutput = aws_sdk_cleanrooms.types.list_privacy_budget_templates_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_privacy_budget_templates_input.ListPrivacyBudgetTemplatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_privacy_budget_templates(
