"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListPrivacyBudgetTemplates``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_privacy_budget_templates_output.ListPrivacyBudgetTemplatesOutput:
    import aws_sdk_cleanrooms.types.list_privacy_budget_templates_output
    out: aws_sdk_cleanrooms.types.list_privacy_budget_templates_output.ListPrivacyBudgetTemplatesOutput = aws_sdk_cleanrooms.types.list_privacy_budget_templates_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_privacy_budget_templates_input.ListPrivacyBudgetTemplatesInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/privacybudgettemplates"
...
def list_privacy_budget_templates(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_privacy_budget_templates_input.ListPrivacyBudgetTemplatesInput) -> tuple[aws_sdk_cleanrooms.types.list_privacy_budget_templates_output.ListPrivacyBudgetTemplatesOutput, zapros.Response]:
...
async def async_list_privacy_budget_templates(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_privacy_budget_templates_input.ListPrivacyBudgetTemplatesInput) -> tuple[aws_sdk_cleanrooms.types.list_privacy_budget_templates_output.ListPrivacyBudgetTemplatesOutput, zapros.Response]:
