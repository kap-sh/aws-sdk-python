...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_collaboration_change_request_output.GetCollaborationChangeRequestOutput = aws_sdk_cleanrooms.types.get_collaboration_change_request_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_collaboration_change_request_input.GetCollaborationChangeRequestInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
