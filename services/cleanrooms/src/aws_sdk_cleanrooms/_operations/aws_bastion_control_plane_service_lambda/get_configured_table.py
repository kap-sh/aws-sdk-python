...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_configured_table_output.GetConfiguredTableOutput = aws_sdk_cleanrooms.types.get_configured_table_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_configured_table_input.GetConfiguredTableInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
