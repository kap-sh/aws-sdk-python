...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.get_configured_table_output.GetConfiguredTableOutput:
    import aws_sdk_cleanrooms.types.get_configured_table_output
    out: aws_sdk_cleanrooms.types.get_configured_table_output.GetConfiguredTableOutput = aws_sdk_cleanrooms.types.get_configured_table_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.get_configured_table_input.GetConfiguredTableInput) -> zapros.Request:
...
def get_configured_table(options: OperationOptions, input: aws_sdk_cleanrooms.types.get_configured_table_input.GetConfiguredTableInput) -> tuple[aws_sdk_cleanrooms.types.get_configured_table_output.GetConfiguredTableOutput, zapros.Response]:
...
async def async_get_configured_table(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.get_configured_table_input.GetConfiguredTableInput) -> tuple[aws_sdk_cleanrooms.types.get_configured_table_output.GetConfiguredTableOutput, zapros.Response]:
