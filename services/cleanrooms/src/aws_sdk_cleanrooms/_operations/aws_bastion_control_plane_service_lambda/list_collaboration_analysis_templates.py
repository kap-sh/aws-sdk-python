...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_collaboration_analysis_templates_output.ListCollaborationAnalysisTemplatesOutput = aws_sdk_cleanrooms.types.list_collaboration_analysis_templates_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_collaboration_analysis_templates_input.ListCollaborationAnalysisTemplatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
