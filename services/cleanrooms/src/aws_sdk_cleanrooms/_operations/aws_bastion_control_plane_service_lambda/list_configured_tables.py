...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_configured_tables_output.ListConfiguredTablesOutput = aws_sdk_cleanrooms.types.list_configured_tables_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_configured_tables_input.ListConfiguredTablesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_configured_tables(
