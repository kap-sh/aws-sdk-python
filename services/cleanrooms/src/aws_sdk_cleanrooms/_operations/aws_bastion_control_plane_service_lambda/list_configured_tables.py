"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListConfiguredTables``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_configured_tables_output.ListConfiguredTablesOutput:
    import aws_sdk_cleanrooms.types.list_configured_tables_output
    out: aws_sdk_cleanrooms.types.list_configured_tables_output.ListConfiguredTablesOutput = aws_sdk_cleanrooms.types.list_configured_tables_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_configured_tables_input.ListConfiguredTablesInput) -> zapros.Request:
...
def list_configured_tables(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_configured_tables_input.ListConfiguredTablesInput) -> tuple[aws_sdk_cleanrooms.types.list_configured_tables_output.ListConfiguredTablesOutput, zapros.Response]:
...
async def async_list_configured_tables(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_configured_tables_input.ListConfiguredTablesInput) -> tuple[aws_sdk_cleanrooms.types.list_configured_tables_output.ListConfiguredTablesOutput, zapros.Response]:
