...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.create_configured_audience_model_association_output.CreateConfiguredAudienceModelAssociationOutput = aws_sdk_cleanrooms.types.create_configured_audience_model_association_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.create_configured_audience_model_association_input.CreateConfiguredAudienceModelAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_configured_audience_model_association_input.serialize_json(
            input_
        )
    ).encode()
