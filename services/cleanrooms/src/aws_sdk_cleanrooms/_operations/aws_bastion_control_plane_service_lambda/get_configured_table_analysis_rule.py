...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_configured_table_analysis_rule_output.GetConfiguredTableAnalysisRuleOutput = aws_sdk_cleanrooms.types.get_configured_table_analysis_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_configured_table_analysis_rule_input.GetConfiguredTableAnalysisRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
