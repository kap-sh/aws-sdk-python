...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.update_privacy_budget_template_output.UpdatePrivacyBudgetTemplateOutput = aws_sdk_cleanrooms.types.update_privacy_budget_template_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.update_privacy_budget_template_input.UpdatePrivacyBudgetTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_privacy_budget_template_input.serialize_json(
            input_
        )
    ).encode()
