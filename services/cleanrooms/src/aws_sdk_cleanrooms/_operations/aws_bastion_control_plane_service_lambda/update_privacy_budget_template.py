...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.update_privacy_budget_template_input.UpdatePrivacyBudgetTemplateInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["privacy_budget_template_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
