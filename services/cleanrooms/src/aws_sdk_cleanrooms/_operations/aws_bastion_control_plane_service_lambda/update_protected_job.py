...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.update_protected_job_output.UpdateProtectedJobOutput = aws_sdk_cleanrooms.types.update_protected_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.update_protected_job_input.UpdateProtectedJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_protected_job_input.serialize_json(input_)
    ).encode()
