...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.update_protected_job_input.UpdateProtectedJobInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_protected_job_input.serialize_json(input)
    ).encode()
