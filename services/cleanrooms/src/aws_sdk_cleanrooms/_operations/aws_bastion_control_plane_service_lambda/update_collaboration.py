...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.update_collaboration_output.UpdateCollaborationOutput = aws_sdk_cleanrooms.types.update_collaboration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.update_collaboration_input.UpdateCollaborationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_collaboration_input.serialize_json(input_)
    ).encode()
