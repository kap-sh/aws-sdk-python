...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.update_collaboration_input.UpdateCollaborationInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_collaboration_input.serialize_json(input)
    ).encode()
