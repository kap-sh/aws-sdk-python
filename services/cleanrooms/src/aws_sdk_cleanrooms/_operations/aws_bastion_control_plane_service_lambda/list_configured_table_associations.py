...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_configured_table_associations_output.ListConfiguredTableAssociationsOutput = aws_sdk_cleanrooms.types.list_configured_table_associations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_configured_table_associations_input.ListConfiguredTableAssociationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
