...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.preview_privacy_impact_input.PreviewPrivacyImpactInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.preview_privacy_impact_input.serialize_json(input)
    ).encode()
