...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.preview_privacy_impact_output.PreviewPrivacyImpactOutput = aws_sdk_cleanrooms.types.preview_privacy_impact_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.preview_privacy_impact_input.PreviewPrivacyImpactInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.preview_privacy_impact_input.serialize_json(input_)
    ).encode()
...
async def async_preview_privacy_impact(
