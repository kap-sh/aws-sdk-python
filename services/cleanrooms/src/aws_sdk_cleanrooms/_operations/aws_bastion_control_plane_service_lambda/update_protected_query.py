...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.update_protected_query_output.UpdateProtectedQueryOutput = aws_sdk_cleanrooms.types.update_protected_query_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.update_protected_query_input.UpdateProtectedQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_protected_query_input.serialize_json(input_)
    ).encode()
...
async def async_update_protected_query(
