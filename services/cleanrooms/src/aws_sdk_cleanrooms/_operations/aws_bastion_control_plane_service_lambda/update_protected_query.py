...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.update_protected_query_input.UpdateProtectedQueryInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["protected_query_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_protected_query_input.serialize_json(input)
    ).encode()
