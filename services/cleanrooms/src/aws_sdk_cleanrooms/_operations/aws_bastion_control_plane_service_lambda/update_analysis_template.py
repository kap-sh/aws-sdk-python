...
def build_request(
    ...
    input: aws_sdk_cleanrooms.types.update_analysis_template_input.UpdateAnalysisTemplateInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["analysis_template_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.update_analysis_template_input.serialize_json(input)
    ).encode()
