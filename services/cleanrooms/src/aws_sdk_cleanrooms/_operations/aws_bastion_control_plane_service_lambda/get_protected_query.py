...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_protected_query_output.GetProtectedQueryOutput = (
        aws_sdk_cleanrooms.types.get_protected_query_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_protected_query_input.GetProtectedQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
