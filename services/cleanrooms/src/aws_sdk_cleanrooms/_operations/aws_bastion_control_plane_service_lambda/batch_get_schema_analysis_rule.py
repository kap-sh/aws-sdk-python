...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.batch_get_schema_analysis_rule_output.BatchGetSchemaAnalysisRuleOutput = aws_sdk_cleanrooms.types.batch_get_schema_analysis_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.batch_get_schema_analysis_rule_input.BatchGetSchemaAnalysisRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.batch_get_schema_analysis_rule_input.serialize_json(
            input_
        )
    ).encode()
