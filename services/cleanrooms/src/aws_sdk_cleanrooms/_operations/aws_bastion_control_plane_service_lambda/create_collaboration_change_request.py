...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.create_collaboration_change_request_output.CreateCollaborationChangeRequestOutput = aws_sdk_cleanrooms.types.create_collaboration_change_request_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.create_collaboration_change_request_input.CreateCollaborationChangeRequestInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_collaboration_change_request_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_collaboration_change_request(
