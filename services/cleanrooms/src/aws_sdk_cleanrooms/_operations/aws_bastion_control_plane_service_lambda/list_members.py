...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_members_output.ListMembersOutput:
    import aws_sdk_cleanrooms.types.list_members_output
    out: aws_sdk_cleanrooms.types.list_members_output.ListMembersOutput = aws_sdk_cleanrooms.types.list_members_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_members_input.ListMembersInput) -> zapros.Request:
...
def list_members(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_members_input.ListMembersInput) -> tuple[aws_sdk_cleanrooms.types.list_members_output.ListMembersOutput, zapros.Response]:
...
async def async_list_members(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_members_input.ListMembersInput) -> tuple[aws_sdk_cleanrooms.types.list_members_output.ListMembersOutput, zapros.Response]:
