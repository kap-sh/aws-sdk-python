...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_output.ListCollaborationIdNamespaceAssociationsOutput:
    import aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_output
    out: aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_output.ListCollaborationIdNamespaceAssociationsOutput = aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_input.ListCollaborationIdNamespaceAssociationsInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/collaborations/{collaborationIdentifier}/idnamespaceassociations"
...
def list_collaboration_id_namespace_associations(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_input.ListCollaborationIdNamespaceAssociationsInput) -> tuple[aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_output.ListCollaborationIdNamespaceAssociationsOutput, zapros.Response]:
...
async def async_list_collaboration_id_namespace_associations(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_input.ListCollaborationIdNamespaceAssociationsInput) -> tuple[aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_output.ListCollaborationIdNamespaceAssociationsOutput, zapros.Response]:
