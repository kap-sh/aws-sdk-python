...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_output.ListCollaborationIdNamespaceAssociationsOutput = aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_collaboration_id_namespace_associations_input.ListCollaborationIdNamespaceAssociationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
