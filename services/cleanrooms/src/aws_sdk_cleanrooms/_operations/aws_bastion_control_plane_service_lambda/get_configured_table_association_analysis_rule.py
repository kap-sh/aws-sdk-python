...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_configured_table_association_analysis_rule_output.GetConfiguredTableAssociationAnalysisRuleOutput = aws_sdk_cleanrooms.types.get_configured_table_association_analysis_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_configured_table_association_analysis_rule_input.GetConfiguredTableAssociationAnalysisRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
