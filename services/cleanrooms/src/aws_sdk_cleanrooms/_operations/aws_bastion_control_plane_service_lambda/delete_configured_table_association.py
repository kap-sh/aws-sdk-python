...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.delete_configured_table_association_output.DeleteConfiguredTableAssociationOutput:
    out: aws_sdk_cleanrooms.types.delete_configured_table_association_output.DeleteConfiguredTableAssociationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.delete_configured_table_association_input.DeleteConfiguredTableAssociationInput) -> zapros.Request:
...
def delete_configured_table_association(options: OperationOptions, input: aws_sdk_cleanrooms.types.delete_configured_table_association_input.DeleteConfiguredTableAssociationInput) -> tuple[aws_sdk_cleanrooms.types.delete_configured_table_association_output.DeleteConfiguredTableAssociationOutput, zapros.Response]:
...
async def async_delete_configured_table_association(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.delete_configured_table_association_input.DeleteConfiguredTableAssociationInput) -> tuple[aws_sdk_cleanrooms.types.delete_configured_table_association_output.DeleteConfiguredTableAssociationOutput, zapros.Response]:
