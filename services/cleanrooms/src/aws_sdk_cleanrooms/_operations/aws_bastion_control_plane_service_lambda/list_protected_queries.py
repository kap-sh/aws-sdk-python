...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_protected_queries_output.ListProtectedQueriesOutput = aws_sdk_cleanrooms.types.list_protected_queries_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_protected_queries_input.ListProtectedQueriesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
