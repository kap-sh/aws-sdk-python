...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.list_protected_queries_output.ListProtectedQueriesOutput:
    import aws_sdk_cleanrooms.types.list_protected_queries_output
    out: aws_sdk_cleanrooms.types.list_protected_queries_output.ListProtectedQueriesOutput = aws_sdk_cleanrooms.types.list_protected_queries_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_protected_queries_input.ListProtectedQueriesInput) -> zapros.Request:
...
def list_protected_queries(options: OperationOptions, input: aws_sdk_cleanrooms.types.list_protected_queries_input.ListProtectedQueriesInput) -> tuple[aws_sdk_cleanrooms.types.list_protected_queries_output.ListProtectedQueriesOutput, zapros.Response]:
...
async def async_list_protected_queries(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.list_protected_queries_input.ListProtectedQueriesInput) -> tuple[aws_sdk_cleanrooms.types.list_protected_queries_output.ListProtectedQueriesOutput, zapros.Response]:
