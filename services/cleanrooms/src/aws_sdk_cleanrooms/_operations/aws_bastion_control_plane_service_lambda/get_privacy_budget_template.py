...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.get_privacy_budget_template_output.GetPrivacyBudgetTemplateOutput = aws_sdk_cleanrooms.types.get_privacy_budget_template_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.get_privacy_budget_template_input.GetPrivacyBudgetTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
