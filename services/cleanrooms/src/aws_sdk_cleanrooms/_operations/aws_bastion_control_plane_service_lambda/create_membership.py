...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.create_membership_output.CreateMembershipOutput = (
        aws_sdk_cleanrooms.types.create_membership_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.create_membership_input.CreateMembershipInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cleanrooms.types.create_membership_input.serialize_json(input_)
    ).encode()
