...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cleanrooms.types.create_membership_output.CreateMembershipOutput:
    import aws_sdk_cleanrooms.types.create_membership_output
    out: aws_sdk_cleanrooms.types.create_membership_output.CreateMembershipOutput = aws_sdk_cleanrooms.types.create_membership_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cleanrooms.types.create_membership_input.CreateMembershipInput) -> zapros.Request:
    ...
    import aws_sdk_cleanrooms.types.create_membership_input
    body: bytes | None = json.dumps(aws_sdk_cleanrooms.types.create_membership_input.serialize_json(input)).encode()
...
def create_membership(options: OperationOptions, input: aws_sdk_cleanrooms.types.create_membership_input.CreateMembershipInput) -> tuple[aws_sdk_cleanrooms.types.create_membership_output.CreateMembershipOutput, zapros.Response]:
...
async def async_create_membership(options: AsyncOperationOptions, input: aws_sdk_cleanrooms.types.create_membership_input.CreateMembershipInput) -> tuple[aws_sdk_cleanrooms.types.create_membership_output.CreateMembershipOutput, zapros.Response]:
