...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def untag_resource(
    ...
    aws_sdk_cleanrooms.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
