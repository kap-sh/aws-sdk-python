...
def handle_response(
    ...
    out: aws_sdk_cleanrooms.types.list_id_namespace_associations_output.ListIdNamespaceAssociationsOutput = aws_sdk_cleanrooms.types.list_id_namespace_associations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cleanrooms.types.list_id_namespace_associations_input.ListIdNamespaceAssociationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_id_namespace_associations(
