...
if TYPE_CHECKING:
    import aws_sdk_cleanrooms.types.additional_analyses_resource_arn

AllowedAdditionalAnalyses: TypeAlias = list[
    "aws_sdk_cleanrooms.types.additional_analyses_resource_arn.AdditionalAnalysesResourceArn"
]
