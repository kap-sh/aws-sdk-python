"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListConfiguredTableAssociationsInput``."""
...
class ListConfiguredTableAssociationsInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListConfiguredTableAssociationsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListConfiguredTableAssociationsInput:
    out: ListConfiguredTableAssociationsInput = {}  # type: ignore[typeddict-item]
    return out
