...
class MemberSummary(TypedDict, closed=True):
    ...
    status: "aws_sdk_cleanrooms.types.member_status.MemberStatus"
    """<p>The status of the member. </p>"""
    display_name: "aws_sdk_cleanrooms.types.display_name.DisplayName"
    """<p>The member's display name.</p>"""
    abilities: "aws_sdk_cleanrooms.types.member_abilities.MemberAbilities"
...
def serialize_json(value: MemberSummary) -> dict:
    ...
    out["abilities"] = aws_sdk_cleanrooms.types.member_abilities.serialize_json(
        value["abilities"]
    )
...
def deserialize_json(data: dict) -> MemberSummary:
    ...
    if "abilities" in data:
        ...
        out["abilities"] = aws_sdk_cleanrooms.types.member_abilities.deserialize_json(
            data["abilities"]
        )
    else:
