...
if TYPE_CHECKING:
    import aws_sdk_cleanrooms.types.membership_protected_query_output_configuration
    import aws_sdk_cleanrooms.types.role_arn


class MembershipProtectedQueryResultConfiguration(TypedDict):
    output_configuration: "aws_sdk_cleanrooms.types.membership_protected_query_output_configuration.MembershipProtectedQueryOutputConfiguration"
...
def serialize_json(value: MembershipProtectedQueryResultConfiguration) -> dict:
    ...
    out["outputConfiguration"] = (
        aws_sdk_cleanrooms.types.membership_protected_query_output_configuration.serialize_json(
...
def deserialize_json(data: dict) -> MembershipProtectedQueryResultConfiguration:
    ...
    if "outputConfiguration" in data:
        ...
        out["output_configuration"] = (
            aws_sdk_cleanrooms.types.membership_protected_query_output_configuration.deserialize_json(
