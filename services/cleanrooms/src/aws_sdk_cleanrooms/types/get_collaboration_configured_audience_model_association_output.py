...
if TYPE_CHECKING:
    import aws_sdk_cleanrooms.types.collaboration_configured_audience_model_association


class GetCollaborationConfiguredAudienceModelAssociationOutput(TypedDict):
    collaboration_configured_audience_model_association: "aws_sdk_cleanrooms.types.collaboration_configured_audience_model_association.CollaborationConfiguredAudienceModelAssociation"
...
def serialize_json(
    ...
    out["collaborationConfiguredAudienceModelAssociation"] = (
        aws_sdk_cleanrooms.types.collaboration_configured_audience_model_association.serialize_json(
...
def deserialize_json(
    ...
    if "collaborationConfiguredAudienceModelAssociation" in data:
        ...
        out["collaboration_configured_audience_model_association"] = (
            aws_sdk_cleanrooms.types.collaboration_configured_audience_model_association.deserialize_json(
