...
# --- restJson1 ser/de ---
def serialize_json(value: GetIdNamespaceAssociationInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetIdNamespaceAssociationInput:
    out: GetIdNamespaceAssociationInput = {}  # type: ignore[typeddict-item]
    return out
