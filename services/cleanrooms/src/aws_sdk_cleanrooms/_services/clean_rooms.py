...
from aws_sdk_cleanrooms._auth._signers import SigV4Signer
from aws_sdk_cleanrooms._auth._sigv4 import presign_sigv4
...
from aws_sdk_cleanrooms._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
from aws_sdk_cleanrooms.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
...
from aws_sdk_cleanrooms._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
if TYPE_CHECKING:
...
class CleanRoomsClient:
    ...
    def list_tags_for_resource(self, resource_arn: "aws_sdk_cleanrooms.types.cleanrooms_arn.CleanroomsArn", *, config_overrides: Optional[CleanRoomsClientConfig] = None) -> "aws_sdk_cleanrooms.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cleanrooms.types.list_tags_for_resource_input.ListTagsForResourceInput]') -> OperationResponse["aws_sdk_cleanrooms.types.list_tags_for_resource_output.ListTagsForResourceOutput"]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_tags_for_resource
            output, http_response = aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
    ...
    def tag_resource(self, resource_arn: "aws_sdk_cleanrooms.types.cleanrooms_arn.CleanroomsArn", tags: "aws_sdk_cleanrooms.types.tag_map.TagMap", *, config_overrides: Optional[CleanRoomsClientConfig] = None) -> "aws_sdk_cleanrooms.types.tag_resource_output.TagResourceOutput":
        """<p>Tags a resource.</p>
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cleanrooms.types.tag_resource_input.TagResourceInput]') -> OperationResponse["aws_sdk_cleanrooms.types.tag_resource_output.TagResourceOutput"]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.tag_resource
            output, http_response = aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: "aws_sdk_cleanrooms.types.cleanrooms_arn.CleanroomsArn", tag_keys: "aws_sdk_cleanrooms.types.tag_keys.TagKeys", *, config_overrides: Optional[CleanRoomsClientConfig] = None) -> "aws_sdk_cleanrooms.types.untag_resource_output.UntagResourceOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cleanrooms.types.untag_resource_input.UntagResourceInput]') -> OperationResponse["aws_sdk_cleanrooms.types.untag_resource_output.UntagResourceOutput"]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.untag_resource
            output, http_response = aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
