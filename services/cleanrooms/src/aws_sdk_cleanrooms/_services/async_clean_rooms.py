...
from aws_sdk_cleanrooms._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
...
class AsyncCleanRoomsClient:
    ...
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_cleanrooms.types.cleanrooms_arn.CleanroomsArn", *, config_overrides: Optional[AsyncCleanRoomsClientConfig] = None) -> "aws_sdk_cleanrooms.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cleanrooms.types.list_tags_for_resource_input.ListTagsForResourceInput]') -> AsyncOperationResponse["aws_sdk_cleanrooms.types.list_tags_for_resource_output.ListTagsForResourceOutput"]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_tags_for_resource
            output, http_response = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
    ...
    async def tag_resource(self, resource_arn: "aws_sdk_cleanrooms.types.cleanrooms_arn.CleanroomsArn", tags: "aws_sdk_cleanrooms.types.tag_map.TagMap", *, config_overrides: Optional[AsyncCleanRoomsClientConfig] = None) -> "aws_sdk_cleanrooms.types.tag_resource_output.TagResourceOutput":
        """<p>Tags a resource.</p>
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cleanrooms.types.tag_resource_input.TagResourceInput]') -> AsyncOperationResponse["aws_sdk_cleanrooms.types.tag_resource_output.TagResourceOutput"]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.tag_resource
            output, http_response = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_cleanrooms.types.cleanrooms_arn.CleanroomsArn", tag_keys: "aws_sdk_cleanrooms.types.tag_keys.TagKeys", *, config_overrides: Optional[AsyncCleanRoomsClientConfig] = None) -> "aws_sdk_cleanrooms.types.untag_resource_output.UntagResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cleanrooms.types.untag_resource_input.UntagResourceInput]') -> AsyncOperationResponse["aws_sdk_cleanrooms.types.untag_resource_output.UntagResourceOutput"]:
            import aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.untag_resource
            output, http_response = await aws_sdk_cleanrooms._operations.aws_bastion_control_plane_service_lambda.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
