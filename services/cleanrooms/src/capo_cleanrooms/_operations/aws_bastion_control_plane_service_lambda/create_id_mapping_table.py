"""Generated from Smithy shape ``com.amazonaws.cleanrooms#CreateIdMappingTable``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_id_mapping_table_output.CreateIdMappingTableOutput = capo_cleanrooms.types.create_id_mapping_table_output.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/memberships/{membershipIdentifier}/idmappingtables"
    )
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_id_mapping_table_input.serialize_json(input_)
    ).encode()
...
async def async_create_id_mapping_table(
