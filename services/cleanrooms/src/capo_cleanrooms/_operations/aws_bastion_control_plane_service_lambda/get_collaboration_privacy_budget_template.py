"""Generated from Smithy shape ``com.amazonaws.cleanrooms#GetCollaborationPrivacyBudgetTemplate``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_collaboration_privacy_budget_template_output.GetCollaborationPrivacyBudgetTemplateOutput = capo_cleanrooms.types.get_collaboration_privacy_budget_template_output.deserialize_json(
...
async def async_get_collaboration_privacy_budget_template(
