"""Generated from Smithy shape ``com.amazonaws.cleanrooms#CreateConfiguredAudienceModelAssociation``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_configured_audience_model_association_output.CreateConfiguredAudienceModelAssociationOutput = capo_cleanrooms.types.create_configured_audience_model_association_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_configured_audience_model_association_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_configured_audience_model_association(
