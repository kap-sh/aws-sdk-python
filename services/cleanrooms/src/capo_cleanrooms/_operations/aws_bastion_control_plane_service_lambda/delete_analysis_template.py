...
def handle_response(
    ...
    out: capo_cleanrooms.types.delete_analysis_template_output.DeleteAnalysisTemplateOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_analysis_template(
