...
def handle_response(
    ...
    out: capo_cleanrooms.types.batch_get_collaboration_analysis_template_output.BatchGetCollaborationAnalysisTemplateOutput = capo_cleanrooms.types.batch_get_collaboration_analysis_template_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.batch_get_collaboration_analysis_template_input.serialize_json(
            input_
        )
    ).encode()
