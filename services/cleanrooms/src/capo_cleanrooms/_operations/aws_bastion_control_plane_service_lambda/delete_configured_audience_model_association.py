"""Generated from Smithy shape ``com.amazonaws.cleanrooms#DeleteConfiguredAudienceModelAssociation``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.delete_configured_audience_model_association_output.DeleteConfiguredAudienceModelAssociationOutput = {}  # type: ignore[typeddict-item]
    return out
