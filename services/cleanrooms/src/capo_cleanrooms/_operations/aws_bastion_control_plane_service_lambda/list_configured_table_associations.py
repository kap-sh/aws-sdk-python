"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListConfiguredTableAssociations``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_configured_table_associations_output.ListConfiguredTableAssociationsOutput = capo_cleanrooms.types.list_configured_table_associations_output.deserialize_json(
...
async def async_list_configured_table_associations(
