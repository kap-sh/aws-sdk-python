...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_configured_table_output.CreateConfiguredTableOutput = capo_cleanrooms.types.create_configured_table_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_configured_table_input.serialize_json(input_)
    ).encode()
...
async def async_create_configured_table(
