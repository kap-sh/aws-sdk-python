"""Generated from Smithy shape ``com.amazonaws.cleanrooms#BatchGetSchemaAnalysisRule``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.batch_get_schema_analysis_rule_output.BatchGetSchemaAnalysisRuleOutput = capo_cleanrooms.types.batch_get_schema_analysis_rule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.batch_get_schema_analysis_rule_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_get_schema_analysis_rule(
