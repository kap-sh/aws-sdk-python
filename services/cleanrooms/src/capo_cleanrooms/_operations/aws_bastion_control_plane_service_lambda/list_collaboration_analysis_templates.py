...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_collaboration_analysis_templates_output.ListCollaborationAnalysisTemplatesOutput = capo_cleanrooms.types.list_collaboration_analysis_templates_output.deserialize_json(
...
async def async_list_collaboration_analysis_templates(
