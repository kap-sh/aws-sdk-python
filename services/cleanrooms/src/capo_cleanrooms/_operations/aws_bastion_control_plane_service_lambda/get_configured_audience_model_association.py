...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_configured_audience_model_association_output.GetConfiguredAudienceModelAssociationOutput = capo_cleanrooms.types.get_configured_audience_model_association_output.deserialize_json(
...
async def async_get_configured_audience_model_association(
