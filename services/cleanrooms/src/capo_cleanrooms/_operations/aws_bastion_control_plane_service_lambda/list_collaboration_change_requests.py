...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_collaboration_change_requests_output.ListCollaborationChangeRequestsOutput = capo_cleanrooms.types.list_collaboration_change_requests_output.deserialize_json(
...
async def async_list_collaboration_change_requests(
