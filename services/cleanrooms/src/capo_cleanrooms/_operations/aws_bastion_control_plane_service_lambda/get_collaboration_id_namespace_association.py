...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_collaboration_id_namespace_association_output.GetCollaborationIdNamespaceAssociationOutput = capo_cleanrooms.types.get_collaboration_id_namespace_association_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["id_namespace_association_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_collaboration_id_namespace_association(
