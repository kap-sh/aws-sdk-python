...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_analysis_template_output.GetAnalysisTemplateOutput = capo_cleanrooms.types.get_analysis_template_output.deserialize_json(
...
async def async_get_analysis_template(
