...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_collaboration_output.CreateCollaborationOutput = (
        capo_cleanrooms.types.create_collaboration_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_collaboration_input.serialize_json(input_)
    ).encode()
...
async def async_create_collaboration(
