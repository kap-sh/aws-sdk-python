...
import capo_cleanrooms.types.collaboration_privacy_budget_template_summary_list
...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_collaboration_privacy_budget_templates_output.ListCollaborationPrivacyBudgetTemplatesOutput = capo_cleanrooms.types.list_collaboration_privacy_budget_templates_output.deserialize_json(
...
async def async_list_collaboration_privacy_budget_templates(
