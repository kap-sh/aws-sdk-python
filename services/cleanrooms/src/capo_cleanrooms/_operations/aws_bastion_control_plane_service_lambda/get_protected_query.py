"""Generated from Smithy shape ``com.amazonaws.cleanrooms#GetProtectedQuery``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_protected_query_output.GetProtectedQueryOutput = (
        capo_cleanrooms.types.get_protected_query_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["protected_query_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_protected_query(
