...
def handle_response(
    ...
    out: capo_cleanrooms.types.start_protected_job_output.StartProtectedJobOutput = (
        capo_cleanrooms.types.start_protected_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.start_protected_job_input.serialize_json(input_)
    ).encode()
...
async def async_start_protected_job(
