"""Generated from Smithy shape ``com.amazonaws.cleanrooms#UpdateIdMappingTable``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.update_id_mapping_table_output.UpdateIdMappingTableOutput = capo_cleanrooms.types.update_id_mapping_table_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["id_mapping_table_identifier"]), safe=""),
    )
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.update_id_mapping_table_input.serialize_json(input_)
    ).encode()
...
async def async_update_id_mapping_table(
