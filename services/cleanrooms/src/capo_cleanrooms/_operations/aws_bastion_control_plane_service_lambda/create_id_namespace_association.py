"""Generated from Smithy shape ``com.amazonaws.cleanrooms#CreateIdNamespaceAssociation``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_id_namespace_association_output.CreateIdNamespaceAssociationOutput = capo_cleanrooms.types.create_id_namespace_association_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_id_namespace_association_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_id_namespace_association(
