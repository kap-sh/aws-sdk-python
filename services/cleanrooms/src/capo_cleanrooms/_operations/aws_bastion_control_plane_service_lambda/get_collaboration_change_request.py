...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_collaboration_change_request_output.GetCollaborationChangeRequestOutput = capo_cleanrooms.types.get_collaboration_change_request_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["change_request_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_collaboration_change_request(
