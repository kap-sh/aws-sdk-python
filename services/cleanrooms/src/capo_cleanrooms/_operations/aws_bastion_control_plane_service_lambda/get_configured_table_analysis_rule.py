...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_configured_table_analysis_rule_output.GetConfiguredTableAnalysisRuleOutput = capo_cleanrooms.types.get_configured_table_analysis_rule_output.deserialize_json(
...
async def async_get_configured_table_analysis_rule(
