"""Generated from Smithy shape ``com.amazonaws.cleanrooms#GetConfiguredTable``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_configured_table_output.GetConfiguredTableOutput = (
        capo_cleanrooms.types.get_configured_table_output.deserialize_json(
...
async def async_get_configured_table(
