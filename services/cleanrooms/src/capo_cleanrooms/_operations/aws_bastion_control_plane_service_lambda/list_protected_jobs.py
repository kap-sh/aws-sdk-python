...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_protected_jobs_output.ListProtectedJobsOutput = (
        capo_cleanrooms.types.list_protected_jobs_output.deserialize_json(
...
async def async_list_protected_jobs(
