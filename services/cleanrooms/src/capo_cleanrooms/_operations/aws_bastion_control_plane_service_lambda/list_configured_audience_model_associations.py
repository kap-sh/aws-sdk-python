...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_configured_audience_model_associations_output.ListConfiguredAudienceModelAssociationsOutput = capo_cleanrooms.types.list_configured_audience_model_associations_output.deserialize_json(
...
async def async_list_configured_audience_model_associations(
