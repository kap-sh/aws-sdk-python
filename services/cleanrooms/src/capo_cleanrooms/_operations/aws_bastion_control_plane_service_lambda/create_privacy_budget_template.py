"""Generated from Smithy shape ``com.amazonaws.cleanrooms#CreatePrivacyBudgetTemplate``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_privacy_budget_template_output.CreatePrivacyBudgetTemplateOutput = capo_cleanrooms.types.create_privacy_budget_template_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_privacy_budget_template_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_privacy_budget_template(
