"""Generated from Smithy shape ``com.amazonaws.cleanrooms#UntagResource``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_cleanrooms.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
