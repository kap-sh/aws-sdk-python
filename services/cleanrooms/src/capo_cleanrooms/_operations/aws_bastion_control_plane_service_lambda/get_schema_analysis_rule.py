...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_schema_analysis_rule_output.GetSchemaAnalysisRuleOutput = capo_cleanrooms.types.get_schema_analysis_rule_output.deserialize_json(
