"""Generated from Smithy shape ``com.amazonaws.cleanrooms#CreateMembership``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_membership_output.CreateMembershipOutput = (
        capo_cleanrooms.types.create_membership_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/memberships"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_membership_input.serialize_json(input_)
    ).encode()
...
async def async_create_membership(
