...
def handle_response(
    ...
    out: capo_cleanrooms.types.delete_configured_table_output.DeleteConfiguredTableOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_configured_table(
