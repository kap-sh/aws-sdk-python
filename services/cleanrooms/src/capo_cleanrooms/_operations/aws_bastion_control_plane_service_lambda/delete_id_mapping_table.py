"""Generated from Smithy shape ``com.amazonaws.cleanrooms#DeleteIdMappingTable``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.delete_id_mapping_table_output.DeleteIdMappingTableOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_id_mapping_table(
