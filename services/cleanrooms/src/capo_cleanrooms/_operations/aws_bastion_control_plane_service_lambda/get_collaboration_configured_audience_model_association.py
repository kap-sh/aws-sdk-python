"""Generated from Smithy shape ``com.amazonaws.cleanrooms#GetCollaborationConfiguredAudienceModelAssociation``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_collaboration_configured_audience_model_association_output.GetCollaborationConfiguredAudienceModelAssociationOutput = capo_cleanrooms.types.get_collaboration_configured_audience_model_association_output.deserialize_json(
