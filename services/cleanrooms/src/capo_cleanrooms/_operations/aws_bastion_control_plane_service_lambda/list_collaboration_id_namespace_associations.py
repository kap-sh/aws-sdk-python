"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListCollaborationIdNamespaceAssociations``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_collaboration_id_namespace_associations_output.ListCollaborationIdNamespaceAssociationsOutput = capo_cleanrooms.types.list_collaboration_id_namespace_associations_output.deserialize_json(
...
async def async_list_collaboration_id_namespace_associations(
