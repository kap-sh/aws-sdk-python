"""Generated from Smithy shape ``com.amazonaws.cleanrooms#GetConfiguredTableAssociationAnalysisRule``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_configured_table_association_analysis_rule_output.GetConfiguredTableAssociationAnalysisRuleOutput = capo_cleanrooms.types.get_configured_table_association_analysis_rule_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["configured_table_association_identifier"]), safe=""),
    )
    url = url.replace(
...
async def async_get_configured_table_association_analysis_rule(
