"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListProtectedQueries``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_protected_queries_output.ListProtectedQueriesOutput = capo_cleanrooms.types.list_protected_queries_output.deserialize_json(
...
async def async_list_protected_queries(
