"""Generated from Smithy shape ``com.amazonaws.cleanrooms#GetCollaborationAnalysisTemplate``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_collaboration_analysis_template_output.GetCollaborationAnalysisTemplateOutput = capo_cleanrooms.types.get_collaboration_analysis_template_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{analysisTemplateArn}", quote(str(input_["analysis_template_arn"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_get_collaboration_analysis_template(
