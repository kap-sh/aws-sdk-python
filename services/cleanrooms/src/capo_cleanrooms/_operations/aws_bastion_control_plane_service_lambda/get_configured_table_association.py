...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_configured_table_association_output.GetConfiguredTableAssociationOutput = capo_cleanrooms.types.get_configured_table_association_output.deserialize_json(
...
async def async_get_configured_table_association(
