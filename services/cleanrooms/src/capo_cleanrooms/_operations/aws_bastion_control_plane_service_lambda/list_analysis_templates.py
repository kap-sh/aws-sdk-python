...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_analysis_templates_output.ListAnalysisTemplatesOutput = capo_cleanrooms.types.list_analysis_templates_output.deserialize_json(
...
async def async_list_analysis_templates(
