"""Generated from Smithy shape ``com.amazonaws.cleanrooms#CreateAnalysisTemplate``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_analysis_template_output.CreateAnalysisTemplateOutput = capo_cleanrooms.types.create_analysis_template_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_analysis_template_input.serialize_json(input_)
    ).encode()
...
async def async_create_analysis_template(
