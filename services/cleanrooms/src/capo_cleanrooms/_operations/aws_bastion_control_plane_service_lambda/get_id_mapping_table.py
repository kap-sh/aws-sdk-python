...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_id_mapping_table_output.GetIdMappingTableOutput = (
        capo_cleanrooms.types.get_id_mapping_table_output.deserialize_json(
...
async def async_get_id_mapping_table(
