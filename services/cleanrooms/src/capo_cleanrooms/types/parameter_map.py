"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ParameterMap``."""
...
ParameterMap: TypeAlias = dict[
    "capo_cleanrooms.types.parameter_name.ParameterName",
    "capo_cleanrooms.types.parameter_value.ParameterValue",
]
