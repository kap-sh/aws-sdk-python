...
class CollaborationPrivacyBudgetTemplate(TypedDict, closed=True):
    ...
    auto_refresh: "capo_cleanrooms.types.privacy_budget_template_auto_refresh.PrivacyBudgetTemplateAutoRefresh"
    ...
    parameters: "capo_cleanrooms.types.privacy_budget_template_parameters_output.PrivacyBudgetTemplateParametersOutput"
...
def serialize_json(value: CollaborationPrivacyBudgetTemplate) -> dict:
    ...
    out["autoRefresh"] = (
        capo_cleanrooms.types.privacy_budget_template_auto_refresh.serialize_json(
            value["auto_refresh"]
        )
    )
    import capo_cleanrooms.types.privacy_budget_template_parameters_output
    ...
    out["parameters"] = (
        capo_cleanrooms.types.privacy_budget_template_parameters_output.serialize_json(
            value["parameters"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> CollaborationPrivacyBudgetTemplate:
    ...
    if "autoRefresh" in data:
        ...
        out["auto_refresh"] = (
            capo_cleanrooms.types.privacy_budget_template_auto_refresh.deserialize_json(
                data["autoRefresh"]
            )
        )
    else:
    ...
    if "parameters" in data:
        ...
        out["parameters"] = (
            capo_cleanrooms.types.privacy_budget_template_parameters_output.deserialize_json(
                data["parameters"]
            )
        )
    else:
