"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ConfiguredTableAssociationAnalysisRuleCustom``."""
...
class ConfiguredTableAssociationAnalysisRuleCustom(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ConfiguredTableAssociationAnalysisRuleCustom) -> dict:
    out: dict = {}
