...
# --- restJson1 ser/de ---
def serialize_json(value: ListConfiguredTablesInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListConfiguredTablesInput:
    out: ListConfiguredTablesInput = {}  # type: ignore[typeddict-item]
    return out
