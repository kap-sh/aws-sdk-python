"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListConfiguredAudienceModelAssociationsInput``."""
...
class ListConfiguredAudienceModelAssociationsInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListConfiguredAudienceModelAssociationsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListConfiguredAudienceModelAssociationsInput:
    out: ListConfiguredAudienceModelAssociationsInput = {}  # type: ignore[typeddict-item]
    return out
