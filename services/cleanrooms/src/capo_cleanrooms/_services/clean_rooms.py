...
from capo_cleanrooms._services._aws_config import aws_config
...
class CleanRoomsClientConfig(TypedDict, total=False, closed=True):
...
class CleanRoomsClient:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cleanrooms.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "capo_cleanrooms.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_cleanrooms._operations.aws_bastion_control_plane_service_lambda.list_tags_for_resource.list_tags_for_resource(
        ...
        input_: capo_cleanrooms.types.list_tags_for_resource_input.ListTagsForResourceInput = {}  # type: ignore[typeddict-item]
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cleanrooms.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "capo_cleanrooms.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_cleanrooms._operations.aws_bastion_control_plane_service_lambda.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_cleanrooms.types.tag_resource_input.TagResourceInput = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cleanrooms.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "capo_cleanrooms.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_cleanrooms._operations.aws_bastion_control_plane_service_lambda.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_cleanrooms.types.untag_resource_input.UntagResourceInput = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
