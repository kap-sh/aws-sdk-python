"""Generated from Smithy shape ``com.amazonaws.bedrockruntime#AccessDeniedException``."""
...
class AccessDeniedException_(TypedDict):
    message: NotRequired["aws_sdk_bedrock_runtime.types.non_blank_string.NonBlankString"]
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockruntime#AccessDeniedException``."""
