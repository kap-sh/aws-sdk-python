...
class GuardrailResource:
    ...
    def apply_guardrail(self, guardrail_identifier: "aws_sdk_bedrock_runtime.types.guardrail_identifier.GuardrailIdentifier", guardrail_version: "aws_sdk_bedrock_runtime.types.guardrail_version.GuardrailVersion", source: "aws_sdk_bedrock_runtime.types.guardrail_content_source.GuardrailContentSource", content: "aws_sdk_bedrock_runtime.types.guardrail_content_block_list.GuardrailContentBlockList", *, config_overrides: Optional[BedrockRuntimeClientConfig] = None, output_scope: Optional["aws_sdk_bedrock_runtime.types.guardrail_output_scope.GuardrailOutputScope"] = None) -> "aws_sdk_bedrock_runtime.types.apply_guardrail_response.ApplyGuardrailResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_runtime.types.apply_guardrail_request.ApplyGuardrailRequest]') -> OperationResponse["aws_sdk_bedrock_runtime.types.apply_guardrail_response.ApplyGuardrailResponse"]:
            import aws_sdk_bedrock_runtime._operations.amazon_bedrock_frontend_service.apply_guardrail
            output, http_response = aws_sdk_bedrock_runtime._operations.amazon_bedrock_frontend_service.apply_guardrail.apply_guardrail(req.options, req.input)
...
class AsyncGuardrailResource:
    def __init__(self, service: AsyncBedrockRuntimeClient) -> None:
        self._service = service
    async def apply_guardrail(self, guardrail_identifier: "aws_sdk_bedrock_runtime.types.guardrail_identifier.GuardrailIdentifier", guardrail_version: "aws_sdk_bedrock_runtime.types.guardrail_version.GuardrailVersion", source: "aws_sdk_bedrock_runtime.types.guardrail_content_source.GuardrailContentSource", content: "aws_sdk_bedrock_runtime.types.guardrail_content_block_list.GuardrailContentBlockList", *, config_overrides: Optional[AsyncBedrockRuntimeClientConfig] = None, output_scope: Optional["aws_sdk_bedrock_runtime.types.guardrail_output_scope.GuardrailOutputScope"] = None) -> "aws_sdk_bedrock_runtime.types.apply_guardrail_response.ApplyGuardrailResponse":
        """<p>The action to apply a guardrail.</p> <p>For troubleshooting some of the common errors you might encounter when using the <code>ApplyGuardrail</code> API, see <a href=\"https://docs.aws.amazon.com/bedrock/latest/userguide/troubleshooting-api-error-codes.html\">Troubleshooting Amazon Bedrock API Error Codes</a> in the Amazon Bedrock User Guide</p>
        ...
        Args:
            ...
            output_scope: <p>Specifies the scope of the output that you get in the response. Set to <code>FULL</code> to return the entire output, including any detected and non-detected entries in the response for enhanced debugging.</p> <p>Note that the full output scope doesn't apply to word filters or regex in sensitive information filters. It does apply to all other filtering policies, including sensitive information with filters that can detect personally identifiable information (PII).</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_runtime.types.apply_guardrail_request.ApplyGuardrailRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_runtime.types.apply_guardrail_response.ApplyGuardrailResponse"]:
            import aws_sdk_bedrock_runtime._operations.amazon_bedrock_frontend_service.apply_guardrail
            output, http_response = await aws_sdk_bedrock_runtime._operations.amazon_bedrock_frontend_service.apply_guardrail.async_apply_guardrail(req.options, req.input)
