...
if TYPE_CHECKING:
    import aws_sdk_bedrock_runtime.types.image_block_start
    import aws_sdk_bedrock_runtime.types.tool_result_block_start
...
def serialize_json(value: ContentBlockStart) -> dict:
    if "toolUse" in value:
        ...
        return {
            "toolUse": aws_sdk_bedrock_runtime.types.tool_use_block_start.serialize_json(
                value["toolUse"]
            )
        }
        ...
        return {
            "toolResult": aws_sdk_bedrock_runtime.types.tool_result_block_start.serialize_json(
                value["toolResult"]
            )
        }
    elif "image" in value:
        ...
        return {
            "image": aws_sdk_bedrock_runtime.types.image_block_start.serialize_json(
                value["image"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> ContentBlockStart:
    if "toolUse" in data:
        ...
        return {
            "toolUse": aws_sdk_bedrock_runtime.types.tool_use_block_start.deserialize_json(
                data["toolUse"]
            )
        }
        ...
        return {
            "toolResult": aws_sdk_bedrock_runtime.types.tool_result_block_start.deserialize_json(
                data["toolResult"]
            )
        }
    elif "image" in data:
        ...
        return {
            "image": aws_sdk_bedrock_runtime.types.image_block_start.deserialize_json(
                data["image"]
            )
        }
    else:
