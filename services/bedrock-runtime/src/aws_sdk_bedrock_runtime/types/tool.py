...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_runtime.types.system_tool
...
def serialize_json(value: Tool) -> dict:
    if "toolSpec" in value:
        ...
        return {
            "toolSpec": aws_sdk_bedrock_runtime.types.tool_specification.serialize_json(
                value["toolSpec"]
            )
        }
        ...
        return {
            "systemTool": aws_sdk_bedrock_runtime.types.system_tool.serialize_json(
                value["systemTool"]
            )
        }
...
def deserialize_json(data: dict) -> Tool:
    if "toolSpec" in data:
        ...
        return {
            "toolSpec": aws_sdk_bedrock_runtime.types.tool_specification.deserialize_json(
                data["toolSpec"]
            )
        }
        ...
        return {
            "systemTool": aws_sdk_bedrock_runtime.types.system_tool.deserialize_json(
                data["systemTool"]
            )
        }
