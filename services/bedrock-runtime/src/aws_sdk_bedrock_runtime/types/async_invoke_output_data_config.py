...
def serialize_json(value: AsyncInvokeOutputDataConfig) -> dict:
    if "s3OutputDataConfig" in value:
        ...
        return {
            "s3OutputDataConfig": aws_sdk_bedrock_runtime.types.async_invoke_s3_output_data_config.serialize_json(
...
def deserialize_json(data: dict) -> AsyncInvokeOutputDataConfig:
    if "s3OutputDataConfig" in data:
        ...
        return {
            "s3OutputDataConfig": aws_sdk_bedrock_runtime.types.async_invoke_s3_output_data_config.deserialize_json(
