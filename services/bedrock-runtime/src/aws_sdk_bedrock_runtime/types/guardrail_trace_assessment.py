...
if TYPE_CHECKING:
    import aws_sdk_bedrock_runtime.types.guardrail_assessment_list_map
    import aws_sdk_bedrock_runtime.types.guardrail_assessment_map
    import aws_sdk_bedrock_runtime.types.model_outputs


class GuardrailTraceAssessment(TypedDict):
    model_output: NotRequired[
        "aws_sdk_bedrock_runtime.types.model_outputs.ModelOutputs"
    ]
    """<p>The output from the model.</p>"""
    input_assessment: NotRequired[
        "aws_sdk_bedrock_runtime.types.guardrail_assessment_map.GuardrailAssessmentMap"
    ]
    """<p>The input assessment.</p>"""
    output_assessments: NotRequired[
        "aws_sdk_bedrock_runtime.types.guardrail_assessment_list_map.GuardrailAssessmentListMap"
    ]
...
def serialize_json(value: GuardrailTraceAssessment) -> dict:
    ...
    if "model_output" in value:
        ...
        out["modelOutput"] = aws_sdk_bedrock_runtime.types.model_outputs.serialize_json(
            value["model_output"]
        )
    if "input_assessment" in value:
        ...
        out["inputAssessment"] = (
            aws_sdk_bedrock_runtime.types.guardrail_assessment_map.serialize_json(
    ...
    if "output_assessments" in value:
        ...
        out["outputAssessments"] = (
            aws_sdk_bedrock_runtime.types.guardrail_assessment_list_map.serialize_json(
...
def deserialize_json(data: dict) -> GuardrailTraceAssessment:
    ...
    if "modelOutput" in data:
        ...
        out["model_output"] = (
            aws_sdk_bedrock_runtime.types.model_outputs.deserialize_json(
                data["modelOutput"]
            )
        )
    if "inputAssessment" in data:
        ...
        out["input_assessment"] = (
            aws_sdk_bedrock_runtime.types.guardrail_assessment_map.deserialize_json(
    ...
    if "outputAssessments" in data:
        ...
        out["output_assessments"] = (
            aws_sdk_bedrock_runtime.types.guardrail_assessment_list_map.deserialize_json(
