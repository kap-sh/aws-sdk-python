...
if TYPE_CHECKING:
    import aws_sdk_bedrock_runtime.types.guardrail_automated_reasoning_translation_list


class GuardrailAutomatedReasoningTranslationOption(TypedDict):
    translations: NotRequired[
        "aws_sdk_bedrock_runtime.types.guardrail_automated_reasoning_translation_list.GuardrailAutomatedReasoningTranslationList"
    ]
...
def serialize_json(value: GuardrailAutomatedReasoningTranslationOption) -> dict:
    ...
    if "translations" in value:
        ...
        out["translations"] = (
            aws_sdk_bedrock_runtime.types.guardrail_automated_reasoning_translation_list.serialize_json(
                value["translations"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> GuardrailAutomatedReasoningTranslationOption:
    ...
    if "translations" in data:
        ...
        out["translations"] = (
            aws_sdk_bedrock_runtime.types.guardrail_automated_reasoning_translation_list.deserialize_json(
                data["translations"]
            )
        )
    return out
