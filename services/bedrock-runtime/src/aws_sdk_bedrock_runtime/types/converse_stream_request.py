...
class ConverseStreamRequest(TypedDict, closed=True):
    ...
    r"""<p>Configuration information for the tools that the model can use when generating a response.</p> <p>For information about models that support streaming tool use, see <a href=\"https://docs.aws.amazon.com/bedrock/latest/userguide/conversation-inference.html#conversation-inference-supported-models-features\">Supported models and model features</a>.</p>"""
...
# --- restJson1 ser/de ---
def serialize_json(value: ConverseStreamRequest) -> dict:
    out: dict = {}
    ...
    if "inference_config" in value:
        ...
        out["inferenceConfig"] = (
            aws_sdk_bedrock_runtime.types.inference_configuration.serialize_json(
    ...
    if "guardrail_config" in value:
        ...
        out["guardrailConfig"] = (
            aws_sdk_bedrock_runtime.types.guardrail_stream_configuration.serialize_json(
    ...
    if "prompt_variables" in value:
        ...
        out["promptVariables"] = (
            aws_sdk_bedrock_runtime.types.prompt_variable_map.serialize_json(
    ...
    if "additional_model_response_field_paths" in value:
        ...
        out["additionalModelResponseFieldPaths"] = (
            aws_sdk_bedrock_runtime.types.additional_model_response_field_paths.serialize_json(
    ...
    if "request_metadata" in value:
        ...
        out["requestMetadata"] = (
            aws_sdk_bedrock_runtime.types.request_metadata.serialize_json(
    ...
    if "output_config" in value:
        ...
        out["outputConfig"] = (
            aws_sdk_bedrock_runtime.types.output_config.serialize_json(
                value["output_config"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ConverseStreamRequest:
    ...
    if "inferenceConfig" in data:
        ...
        out["inference_config"] = (
            aws_sdk_bedrock_runtime.types.inference_configuration.deserialize_json(
    ...
    if "guardrailConfig" in data:
        ...
        out["guardrail_config"] = (
            aws_sdk_bedrock_runtime.types.guardrail_stream_configuration.deserialize_json(
    ...
    if "promptVariables" in data:
        ...
        out["prompt_variables"] = (
            aws_sdk_bedrock_runtime.types.prompt_variable_map.deserialize_json(
    ...
    if "additionalModelResponseFieldPaths" in data:
        ...
        out["additional_model_response_field_paths"] = (
            aws_sdk_bedrock_runtime.types.additional_model_response_field_paths.deserialize_json(
    ...
    if "requestMetadata" in data:
        ...
        out["request_metadata"] = (
            aws_sdk_bedrock_runtime.types.request_metadata.deserialize_json(
    ...
    if "outputConfig" in data:
        ...
        out["output_config"] = (
            aws_sdk_bedrock_runtime.types.output_config.deserialize_json(
                data["outputConfig"]
            )
        )
    return out
