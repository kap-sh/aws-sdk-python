...
class CitationsContentBlock(TypedDict, closed=True):
    ...
    citations: NotRequired["aws_sdk_bedrock_runtime.types.citations.Citations"]
...
def serialize_json(value: CitationsContentBlock) -> dict:
    ...
    if "content" in value:
        ...
        out["content"] = (
            aws_sdk_bedrock_runtime.types.citation_generated_content_list.serialize_json(
                value["content"]
            )
        )
    if "citations" in value:
        ...
        out["citations"] = aws_sdk_bedrock_runtime.types.citations.serialize_json(
            value["citations"]
        )
    return out
...
def deserialize_json(data: dict) -> CitationsContentBlock:
    ...
    if "content" in data:
        ...
        out["content"] = (
            aws_sdk_bedrock_runtime.types.citation_generated_content_list.deserialize_json(
                data["content"]
            )
        )
    if "citations" in data:
        ...
        out["citations"] = aws_sdk_bedrock_runtime.types.citations.deserialize_json(
            data["citations"]
        )
    return out
