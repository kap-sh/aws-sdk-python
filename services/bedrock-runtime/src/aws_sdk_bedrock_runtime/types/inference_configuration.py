...
class InferenceConfiguration(TypedDict, closed=True):
    ...
    stop_sequences: NotRequired[
        "aws_sdk_bedrock_runtime.types.non_empty_string_list.NonEmptyStringList"
    ]
...
def serialize_json(value: InferenceConfiguration) -> dict:
    ...
    if "stop_sequences" in value:
        ...
        out["stopSequences"] = (
            aws_sdk_bedrock_runtime.types.non_empty_string_list.serialize_json(
...
def deserialize_json(data: dict) -> InferenceConfiguration:
    ...
    if "stopSequences" in data:
        ...
        out["stop_sequences"] = (
            aws_sdk_bedrock_runtime.types.non_empty_string_list.deserialize_json(
                data["stopSequences"]
            )
        )
    return out
