...
class AppliedGuardrailDetails(TypedDict, closed=True):
    ...
    guardrail_arn: NotRequired[
        "aws_sdk_bedrock_runtime.types.guardrail_arn.GuardrailArn"
    ]
    """<p>The ARN of the guardrail that was applied.</p>"""
    guardrail_origin: NotRequired[
        "aws_sdk_bedrock_runtime.types.guardrail_origin_list.GuardrailOriginList"
    ]
    ...
    guardrail_ownership: NotRequired[
        "aws_sdk_bedrock_runtime.types.guardrail_ownership.GuardrailOwnership"
    ]
...
def serialize_json(value: AppliedGuardrailDetails) -> dict:
    ...
    if "guardrail_origin" in value:
        ...
        out["guardrailOrigin"] = (
            aws_sdk_bedrock_runtime.types.guardrail_origin_list.serialize_json(
    ...
    if "guardrail_ownership" in value:
        ...
        out["guardrailOwnership"] = (
            aws_sdk_bedrock_runtime.types.guardrail_ownership.serialize_json(
...
def deserialize_json(data: dict) -> AppliedGuardrailDetails:
    ...
    if "guardrailOrigin" in data:
        ...
        out["guardrail_origin"] = (
            aws_sdk_bedrock_runtime.types.guardrail_origin_list.deserialize_json(
    ...
    if "guardrailOwnership" in data:
        ...
        out["guardrail_ownership"] = (
            aws_sdk_bedrock_runtime.types.guardrail_ownership.deserialize_json(
