...
class PerformanceConfiguration(TypedDict, closed=True):
    latency: "aws_sdk_bedrock_runtime.types.performance_config_latency.PerformanceConfigLatency"
...
def serialize_json(value: PerformanceConfiguration) -> dict:
    ...
    out["latency"] = (
        aws_sdk_bedrock_runtime.types.performance_config_latency.serialize_json(
