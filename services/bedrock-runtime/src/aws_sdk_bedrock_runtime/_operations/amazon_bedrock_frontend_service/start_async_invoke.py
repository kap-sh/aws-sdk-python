...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_bedrock_runtime.errors.conflict_exception
            raise aws_sdk_bedrock_runtime.errors.conflict_exception.ConflictException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_runtime.types.start_async_invoke_response.StartAsyncInvokeResponse:
    import aws_sdk_bedrock_runtime.types.start_async_invoke_response
    out: aws_sdk_bedrock_runtime.types.start_async_invoke_response.StartAsyncInvokeResponse = aws_sdk_bedrock_runtime.types.start_async_invoke_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.start_async_invoke_request.StartAsyncInvokeRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_runtime.types.start_async_invoke_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_runtime.types.start_async_invoke_request.serialize_json(input)).encode()
...
def start_async_invoke(options: OperationOptions, input: aws_sdk_bedrock_runtime.types.start_async_invoke_request.StartAsyncInvokeRequest) -> tuple[aws_sdk_bedrock_runtime.types.start_async_invoke_response.StartAsyncInvokeResponse, zapros.Response]:
...
async def async_start_async_invoke(options: AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.start_async_invoke_request.StartAsyncInvokeRequest) -> tuple[aws_sdk_bedrock_runtime.types.start_async_invoke_response.StartAsyncInvokeResponse, zapros.Response]:
