...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            ...
            raise aws_sdk_bedrock_runtime.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_bedrock_runtime.types.start_async_invoke_response.StartAsyncInvokeResponse = aws_sdk_bedrock_runtime.types.start_async_invoke_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_runtime.types.start_async_invoke_request.StartAsyncInvokeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_runtime.types.start_async_invoke_request.serialize_json(input_)
    ).encode()
