...
def build_request(
    ...
    input: aws_sdk_bedrock_runtime.types.start_async_invoke_request.StartAsyncInvokeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_runtime.types.start_async_invoke_request.serialize_json(input)
    ).encode()
