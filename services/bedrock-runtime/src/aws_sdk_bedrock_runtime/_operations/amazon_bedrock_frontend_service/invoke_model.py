...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ModelErrorException":
            ...
            raise aws_sdk_bedrock_runtime.errors.model_error_exception.ModelErrorException.from_json(data)
        case "ModelNotReadyException":
            import aws_sdk_bedrock_runtime.errors.model_not_ready_exception
            raise aws_sdk_bedrock_runtime.errors.model_not_ready_exception.ModelNotReadyException.from_json(data)
        case "ModelTimeoutException":
            import aws_sdk_bedrock_runtime.errors.model_timeout_exception
            raise aws_sdk_bedrock_runtime.errors.model_timeout_exception.ModelTimeoutException.from_json(data)
        ...
        case "ServiceQuotaExceededException":
            ...
            raise aws_sdk_bedrock_runtime.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_runtime.types.invoke_model_response.InvokeModelResponse:
    import aws_sdk_bedrock_runtime.types.body
    out: aws_sdk_bedrock_runtime.types.invoke_model_response.InvokeModelResponse = {"body": aws_sdk_bedrock_runtime.types.body.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    ...
    if "X-Amzn-Bedrock-PerformanceConfig-Latency" in response.headers:
        ...
        out["performance_config_latency"] = aws_sdk_bedrock_runtime.types.performance_config_latency.from_xml_text(response.headers["X-Amzn-Bedrock-PerformanceConfig-Latency"])
    if "X-Amzn-Bedrock-Service-Tier" in response.headers:
        import aws_sdk_bedrock_runtime.types.service_tier_type
        out["service_tier"] = aws_sdk_bedrock_runtime.types.service_tier_type.from_xml_text(response.headers["X-Amzn-Bedrock-Service-Tier"])
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.invoke_model_request.InvokeModelRequest) -> zapros.Request:
    ...
    if "trace" in input:
        headers["X-Amzn-Bedrock-Trace"] = str(input["trace"])
    if "guardrail_identifier" in input:
        headers["X-Amzn-Bedrock-GuardrailIdentifier"] = str(input["guardrail_identifier"])
    if "guardrail_version" in input:
        headers["X-Amzn-Bedrock-GuardrailVersion"] = str(input["guardrail_version"])
    headers["X-Amzn-Bedrock-PerformanceConfig-Latency"] = str(input.get("performance_config_latency", 'standard'))
    if "service_tier" in input:
        headers["X-Amzn-Bedrock-Service-Tier"] = str(input["service_tier"])
    if "request_metadata" in input:
        headers["X-Amzn-Bedrock-Request-Metadata"] = str(input["request_metadata"])
    if "body" in input:
        import aws_sdk_bedrock_runtime.types.body
        body: bytes | None = json.dumps(aws_sdk_bedrock_runtime.types.body.serialize_json(input["body"])).encode()
...
def invoke_model(options: OperationOptions, input: aws_sdk_bedrock_runtime.types.invoke_model_request.InvokeModelRequest) -> tuple[aws_sdk_bedrock_runtime.types.invoke_model_response.InvokeModelResponse, zapros.Response]:
...
async def async_invoke_model(options: AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.invoke_model_request.InvokeModelRequest) -> tuple[aws_sdk_bedrock_runtime.types.invoke_model_response.InvokeModelResponse, zapros.Response]:
