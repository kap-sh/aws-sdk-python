...
def handle_response(
    ...
    out: aws_sdk_bedrock_runtime.types.list_async_invokes_response.ListAsyncInvokesResponse = aws_sdk_bedrock_runtime.types.list_async_invokes_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_bedrock_runtime.types.list_async_invokes_request.ListAsyncInvokesRequest,
) -> zapros.Request:
