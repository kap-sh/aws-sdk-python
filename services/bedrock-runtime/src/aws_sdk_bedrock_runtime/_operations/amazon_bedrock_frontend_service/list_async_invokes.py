...
def build_request(
    ...
    input_: aws_sdk_bedrock_runtime.types.list_async_invokes_request.ListAsyncInvokesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params["sortBy"] = str(input_.get("sort_by", "SubmissionTime"))
    params["sortOrder"] = str(input_.get("sort_order", "Descending"))
