...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_runtime.types.list_async_invokes_response.ListAsyncInvokesResponse:
    import aws_sdk_bedrock_runtime.types.list_async_invokes_response
    out: aws_sdk_bedrock_runtime.types.list_async_invokes_response.ListAsyncInvokesResponse = aws_sdk_bedrock_runtime.types.list_async_invokes_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.list_async_invokes_request.ListAsyncInvokesRequest) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "submit_time_after" in input:
        params["submitTimeAfter"] = str(input["submit_time_after"])
    if "submit_time_before" in input:
        params["submitTimeBefore"] = str(input["submit_time_before"])
    ...
    params["sortBy"] = str(input.get("sort_by", 'SubmissionTime'))
    params["sortOrder"] = str(input.get("sort_order", 'Descending'))
...
def list_async_invokes(options: OperationOptions, input: aws_sdk_bedrock_runtime.types.list_async_invokes_request.ListAsyncInvokesRequest) -> tuple[aws_sdk_bedrock_runtime.types.list_async_invokes_response.ListAsyncInvokesResponse, zapros.Response]:
...
async def async_list_async_invokes(options: AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.list_async_invokes_request.ListAsyncInvokesRequest) -> tuple[aws_sdk_bedrock_runtime.types.list_async_invokes_response.ListAsyncInvokesResponse, zapros.Response]:
