"""Generated from Smithy shape ``com.amazonaws.bedrockruntime#GetAsyncInvoke``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_runtime.types.get_async_invoke_response.GetAsyncInvokeResponse:
    import aws_sdk_bedrock_runtime.types.get_async_invoke_response
    out: aws_sdk_bedrock_runtime.types.get_async_invoke_response.GetAsyncInvokeResponse = aws_sdk_bedrock_runtime.types.get_async_invoke_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.get_async_invoke_request.GetAsyncInvokeRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/async-invoke/{invocationArn}"
...
def get_async_invoke(options: OperationOptions, input: aws_sdk_bedrock_runtime.types.get_async_invoke_request.GetAsyncInvokeRequest) -> tuple[aws_sdk_bedrock_runtime.types.get_async_invoke_response.GetAsyncInvokeResponse, zapros.Response]:
...
async def async_get_async_invoke(options: AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.get_async_invoke_request.GetAsyncInvokeRequest) -> tuple[aws_sdk_bedrock_runtime.types.get_async_invoke_response.GetAsyncInvokeResponse, zapros.Response]:
