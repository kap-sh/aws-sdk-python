...
def handle_response(
    ...
    out: aws_sdk_bedrock_runtime.types.get_async_invoke_response.GetAsyncInvokeResponse = aws_sdk_bedrock_runtime.types.get_async_invoke_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_runtime.types.get_async_invoke_request.GetAsyncInvokeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_async_invoke(
