...
def build_request(
    ...
    input_: aws_sdk_bedrock_runtime.types.count_tokens_request.CountTokensRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/model/{modelId}/count-tokens"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_runtime.types.count_tokens_request.serialize_json(input_)
    ).encode()
