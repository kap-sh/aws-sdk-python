...
def build_request(
    ...
    input_: aws_sdk_bedrock_runtime.types.converse_request.ConverseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_runtime.types.converse_request.serialize_json(input_)
    ).encode()
...
def converse(
    ...
    aws_sdk_bedrock_runtime.types.converse_response.ConverseResponse, zapros.Response
]:
