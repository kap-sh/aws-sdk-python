"""Generated from Smithy shape ``com.amazonaws.bedrockruntime#Converse``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_runtime.types.converse_response.ConverseResponse:
    import aws_sdk_bedrock_runtime.types.converse_response
    out: aws_sdk_bedrock_runtime.types.converse_response.ConverseResponse = aws_sdk_bedrock_runtime.types.converse_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.converse_request.ConverseRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_runtime.types.converse_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_runtime.types.converse_request.serialize_json(input)).encode()
...
def converse(options: OperationOptions, input: aws_sdk_bedrock_runtime.types.converse_request.ConverseRequest) -> tuple[aws_sdk_bedrock_runtime.types.converse_response.ConverseResponse, zapros.Response]:
...
async def async_converse(options: AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.converse_request.ConverseRequest) -> tuple[aws_sdk_bedrock_runtime.types.converse_response.ConverseResponse, zapros.Response]:
