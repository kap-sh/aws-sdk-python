"""Generated from Smithy shape ``com.amazonaws.bedrockruntime#ApplyGuardrail``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_runtime.types.apply_guardrail_response.ApplyGuardrailResponse:
    import aws_sdk_bedrock_runtime.types.apply_guardrail_response
    out: aws_sdk_bedrock_runtime.types.apply_guardrail_response.ApplyGuardrailResponse = aws_sdk_bedrock_runtime.types.apply_guardrail_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.apply_guardrail_request.ApplyGuardrailRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/guardrail/{guardrailIdentifier}/version/{guardrailVersion}/apply"
    url = url.replace("{guardrailIdentifier}", quote(str(input["guardrail_identifier"]), safe=""))
    url = url.replace("{guardrailVersion}", quote(str(input["guardrail_version"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_runtime.types.apply_guardrail_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_runtime.types.apply_guardrail_request.serialize_json(input)).encode()
...
def apply_guardrail(options: OperationOptions, input: aws_sdk_bedrock_runtime.types.apply_guardrail_request.ApplyGuardrailRequest) -> tuple[aws_sdk_bedrock_runtime.types.apply_guardrail_response.ApplyGuardrailResponse, zapros.Response]:
...
async def async_apply_guardrail(options: AsyncOperationOptions, input: aws_sdk_bedrock_runtime.types.apply_guardrail_request.ApplyGuardrailRequest) -> tuple[aws_sdk_bedrock_runtime.types.apply_guardrail_response.ApplyGuardrailResponse, zapros.Response]:
