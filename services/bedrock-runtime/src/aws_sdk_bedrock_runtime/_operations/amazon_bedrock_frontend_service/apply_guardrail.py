...
def build_request(
    ...
    input_: aws_sdk_bedrock_runtime.types.apply_guardrail_request.ApplyGuardrailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_runtime.types.apply_guardrail_request.serialize_json(input_)
    ).encode()
