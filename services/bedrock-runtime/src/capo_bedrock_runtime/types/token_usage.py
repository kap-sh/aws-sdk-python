...
class TokenUsage(TypedDict, closed=True):
    ...
    cache_details: NotRequired[
        "capo_bedrock_runtime.types.cache_details_list.CacheDetailsList"
    ]
...
def serialize_json(value: TokenUsage) -> dict:
    ...
    if "cache_details" in value:
        ...
        out["cacheDetails"] = (
            capo_bedrock_runtime.types.cache_details_list.serialize_json(
                value["cache_details"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> TokenUsage:
    ...
    if data.get("cacheDetails") is not None:
        ...
        out["cache_details"] = (
            capo_bedrock_runtime.types.cache_details_list.deserialize_json(
                data["cacheDetails"]
            )
        )
    return out
