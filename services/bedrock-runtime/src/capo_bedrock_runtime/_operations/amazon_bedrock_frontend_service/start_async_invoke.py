"""Generated from Smithy shape ``com.amazonaws.bedrockruntime#StartAsyncInvoke``."""
...
import capo_bedrock_runtime.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_bedrock_runtime.errors.conflict_exception.ConflictException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_bedrock_runtime.types.start_async_invoke_response.StartAsyncInvokeResponse = capo_bedrock_runtime.types.start_async_invoke_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_runtime.types.start_async_invoke_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_async_invoke(
