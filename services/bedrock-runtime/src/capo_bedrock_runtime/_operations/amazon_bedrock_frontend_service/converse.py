...
def handle_response(
    ...
    out: capo_bedrock_runtime.types.converse_response.ConverseResponse = (
        capo_bedrock_runtime.types.converse_response.deserialize_json(
...
def converse(
    ...
    capo_bedrock_runtime.types.converse_response.ConverseResponse, zapros.Response
]:
