...
def handle_response(
    ...
    _union_deser = (
        capo_bedrock_runtime.types.converse_stream_output.deserialize_event_json
    )
    _iter = cast(Any, response.iter_bytes())
    out: capo_bedrock_runtime.types.converse_stream_response.ConverseStreamResponse = {
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_runtime.types.converse_stream_request.serialize_json(input_)
    ).encode()
