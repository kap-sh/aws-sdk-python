...
class BedrockRuntimeError(Exception):
    """Base class for all BedrockRuntime service errors."""


class ServiceError(BedrockRuntimeError):
...
class SerializationError(BedrockRuntimeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BedrockRuntimeError):
...
class WaiterFailedError(BedrockRuntimeError):
...
class WaiterTimeoutError(BedrockRuntimeError):
