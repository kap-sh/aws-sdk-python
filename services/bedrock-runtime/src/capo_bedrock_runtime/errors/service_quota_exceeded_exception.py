"""Generated from Smithy shape ``com.amazonaws.bedrockruntime#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockruntime#ServiceQuotaExceededException``."""
