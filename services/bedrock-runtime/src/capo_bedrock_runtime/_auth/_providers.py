...
from capo_bedrock_runtime._auth._identity import (
    BearerToken,
    Credentials,
    Identity,
)
...
# they need the `sso` extra: `pip install capo-bedrock-runtime[sso]`. Without it the imports
...
def require_dependency(module: object | None, package: str) -> None:
    if module is None:
        raise MissingDependencyError(
            ...
            "installed; reinstall with the sso feature enabled: capo-bedrock-runtime[sso]"
        )
