...
class SageMakerRuntimeHTTP2Error(Exception):
    """Base class for all SageMakerRuntimeHTTP2 service errors."""


class ServiceError(SageMakerRuntimeHTTP2Error):
...
class SerializationError(SageMakerRuntimeHTTP2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(SageMakerRuntimeHTTP2Error):
...
class WaiterFailedError(SageMakerRuntimeHTTP2Error):
...
class WaiterTimeoutError(SageMakerRuntimeHTTP2Error):
