...
from ._services.async_sage_maker_runtime_http2 import (
    AsyncSageMakerRuntimeHTTP2Client as AsyncSageMakerRuntimeHTTP2Client,
)
from ._services.sage_maker_runtime_http2 import (
    SageMakerRuntimeHTTP2Client as SageMakerRuntimeHTTP2Client,
)
