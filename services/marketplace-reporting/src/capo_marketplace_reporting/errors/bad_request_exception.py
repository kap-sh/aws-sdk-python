"""Generated from Smithy shape ``com.amazonaws.marketplacereporting#BadRequestException``."""
...
class BadRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.marketplacereporting#BadRequestException``."""
