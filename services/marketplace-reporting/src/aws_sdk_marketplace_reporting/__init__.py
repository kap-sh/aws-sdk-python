...
from ._services.async_marketplace_reporting import (
    AsyncMarketplaceReportingClient as AsyncMarketplaceReportingClient,
)
from ._services.marketplace_reporting import (
    MarketplaceReportingClient as MarketplaceReportingClient,
)
