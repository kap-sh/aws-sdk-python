...
from aws_sdk_marketplace_reporting._services._aws_config import aws_config
...
class MarketplaceReportingClientConfig(TypedDict, total=False, closed=True):
...
class MarketplaceReportingClient:
    ...
    def operation_options(
        ...
        overrides: MarketplaceReportingClientConfig = config_overrides or {}
