...
class MarketplaceReportingError(Exception):
    """Base class for all MarketplaceReporting service errors."""


class ServiceError(MarketplaceReportingError):
...
class SerializationError(MarketplaceReportingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MarketplaceReportingError):
...
class WaiterFailedError(MarketplaceReportingError):
...
class WaiterTimeoutError(MarketplaceReportingError):
