"""Generated from Smithy shape ``com.amazonaws.mediatailor#CreateSourceLocationResponse``."""
...
class CreateSourceLocationResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateSourceLocationResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateSourceLocationResponse:
    out: CreateSourceLocationResponse = {}  # type: ignore[typeddict-item]
