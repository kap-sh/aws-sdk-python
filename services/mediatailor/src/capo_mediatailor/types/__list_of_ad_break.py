...
if TYPE_CHECKING:
    import capo_mediatailor.types.ad_break

__listOfAdBreak: TypeAlias = list["capo_mediatailor.types.ad_break.AdBreak"]
...
def serialize_json(value: __listOfAdBreak) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_mediatailor.types.ad_break.serialize_json(item))
    return out
