...
class DashConfigurationForPut(TypedDict, closed=True):
    mpd_location: NotRequired["capo_mediatailor.types.__string.__string"]
    ...
    origin_manifest_type: NotRequired[
        "capo_mediatailor.types.origin_manifest_type.OriginManifestType"
    ]
...
def serialize_json(value: DashConfigurationForPut) -> dict:
    ...
    if "origin_manifest_type" in value:
        ...
        out["OriginManifestType"] = (
            capo_mediatailor.types.origin_manifest_type.serialize_json(
...
def deserialize_json(data: dict) -> DashConfigurationForPut:
    ...
    if "OriginManifestType" in data:
        ...
        out["origin_manifest_type"] = (
            capo_mediatailor.types.origin_manifest_type.deserialize_json(
