...
class ManifestServiceInteractionLog(TypedDict, closed=True):
    publish_opt_in_event_types: NotRequired[
        "capo_mediatailor.types.__manifest_service_publish_opt_in_event_types_list.__manifestServicePublishOptInEventTypesList"
    ]
    ...
    exclude_event_types: NotRequired[
        "capo_mediatailor.types.__manifest_service_exclude_event_types_list.__manifestServiceExcludeEventTypesList"
    ]
...
def serialize_json(value: ManifestServiceInteractionLog) -> dict:
    ...
    if "publish_opt_in_event_types" in value:
        ...
        out["PublishOptInEventTypes"] = (
            capo_mediatailor.types.__manifest_service_publish_opt_in_event_types_list.serialize_json(
    ...
    if "exclude_event_types" in value:
        ...
        out["ExcludeEventTypes"] = (
            capo_mediatailor.types.__manifest_service_exclude_event_types_list.serialize_json(
...
def deserialize_json(data: dict) -> ManifestServiceInteractionLog:
    ...
    if "PublishOptInEventTypes" in data:
        ...
        out["publish_opt_in_event_types"] = (
            capo_mediatailor.types.__manifest_service_publish_opt_in_event_types_list.deserialize_json(
    ...
    if "ExcludeEventTypes" in data:
        ...
        out["exclude_event_types"] = (
            capo_mediatailor.types.__manifest_service_exclude_event_types_list.deserialize_json(
