...
class DashPlaylistSettings(TypedDict, closed=True):
    manifest_window_seconds: NotRequired["capo_mediatailor.types.__integer.__integer"]
    """<p>The total duration (in seconds) of each manifest. Minimum value: <code>30</code> seconds. Maximum value: <code>3600</code> seconds.</p>"""
    min_buffer_time_seconds: NotRequired["capo_mediatailor.types.__integer.__integer"]
    ...
    min_update_period_seconds: NotRequired["capo_mediatailor.types.__integer.__integer"]
