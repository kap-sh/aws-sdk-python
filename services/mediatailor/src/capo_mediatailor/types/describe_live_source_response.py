...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeLiveSourceResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> DescribeLiveSourceResponse:
    out: DescribeLiveSourceResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
