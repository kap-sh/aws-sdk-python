...
class CdnConfiguration(TypedDict, closed=True):
    ad_segment_url_prefix: NotRequired["capo_mediatailor.types.__string.__string"]
    ...
    content_segment_url_prefix: NotRequired["capo_mediatailor.types.__string.__string"]
