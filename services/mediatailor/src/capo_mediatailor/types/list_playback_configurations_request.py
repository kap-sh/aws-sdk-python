"""Generated from Smithy shape ``com.amazonaws.mediatailor#ListPlaybackConfigurationsRequest``."""
...
class ListPlaybackConfigurationsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListPlaybackConfigurationsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListPlaybackConfigurationsRequest:
    out: ListPlaybackConfigurationsRequest = {}  # type: ignore[typeddict-item]
    return out
