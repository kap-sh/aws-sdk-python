...
class SpliceInsertMessage(TypedDict, closed=True):
    avail_num: NotRequired["capo_mediatailor.types.__integer.__integer"]
    ...
    avails_expected: NotRequired["capo_mediatailor.types.__integer.__integer"]
    ...
    splice_event_id: NotRequired["capo_mediatailor.types.__integer.__integer"]
    ...
    unique_program_id: NotRequired["capo_mediatailor.types.__integer.__integer"]
