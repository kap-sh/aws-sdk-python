"""Generated from Smithy shape ``com.amazonaws.mediatailor#DeleteFunction``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.delete_function_response.DeleteFunctionResponse = {}  # type: ignore[typeddict-item]
    return out
