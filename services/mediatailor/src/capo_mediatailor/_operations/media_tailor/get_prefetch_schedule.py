"""Generated from Smithy shape ``com.amazonaws.mediatailor#GetPrefetchSchedule``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.get_prefetch_schedule_response.GetPrefetchScheduleResponse = capo_mediatailor.types.get_prefetch_schedule_response.deserialize_json(
...
async def async_get_prefetch_schedule(
