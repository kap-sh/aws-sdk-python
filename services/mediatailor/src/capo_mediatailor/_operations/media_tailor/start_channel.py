...
def handle_response(
    ...
    out: capo_mediatailor.types.start_channel_response.StartChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def start_channel(
    ...
    capo_mediatailor.types.start_channel_response.StartChannelResponse, zapros.Response
]:
