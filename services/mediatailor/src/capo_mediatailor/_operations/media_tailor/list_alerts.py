...
def handle_response(
    ...
    out: capo_mediatailor.types.list_alerts_response.ListAlertsResponse = (
        capo_mediatailor.types.list_alerts_response.deserialize_json(
...
def list_alerts(
    ...
    capo_mediatailor.types.list_alerts_response.ListAlertsResponse, zapros.Response
]:
