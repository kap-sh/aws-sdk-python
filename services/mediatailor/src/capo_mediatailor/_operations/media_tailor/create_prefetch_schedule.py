...
def handle_response(
    ...
    out: capo_mediatailor.types.create_prefetch_schedule_response.CreatePrefetchScheduleResponse = capo_mediatailor.types.create_prefetch_schedule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.create_prefetch_schedule_request.serialize_json(input_)
    ).encode()
