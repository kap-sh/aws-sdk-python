"""Generated from Smithy shape ``com.amazonaws.mediatailor#ListPrefetchSchedules``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.list_prefetch_schedules_response.ListPrefetchSchedulesResponse = capo_mediatailor.types.list_prefetch_schedules_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prefetchSchedule/{PlaybackConfigurationName}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.list_prefetch_schedules_request.serialize_json(input_)
    ).encode()
...
async def async_list_prefetch_schedules(
