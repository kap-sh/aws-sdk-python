"""Generated from Smithy shape ``com.amazonaws.mediatailor#ListTagsForResource``."""
...
import capo_mediatailor.errors.bad_request_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BadRequestException":
            raise capo_mediatailor.errors.bad_request_exception.BadRequestException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_mediatailor.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_mediatailor.types.list_tags_for_resource_response.deserialize_json(
