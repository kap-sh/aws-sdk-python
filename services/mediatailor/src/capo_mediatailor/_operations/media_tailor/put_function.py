...
def handle_response(
    ...
    out: capo_mediatailor.types.put_function_response.PutFunctionResponse = (
        capo_mediatailor.types.put_function_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.put_function_request.serialize_json(input_)
    ).encode()
...
def put_function(
    ...
    capo_mediatailor.types.put_function_response.PutFunctionResponse, zapros.Response
]:
