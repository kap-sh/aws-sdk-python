...
def handle_response(
    ...
    out: capo_mediatailor.types.put_channel_policy_response.PutChannelPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.put_channel_policy_request.serialize_json(input_)
    ).encode()
