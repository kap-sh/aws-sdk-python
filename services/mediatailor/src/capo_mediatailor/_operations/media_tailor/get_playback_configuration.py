"""Generated from Smithy shape ``com.amazonaws.mediatailor#GetPlaybackConfiguration``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.get_playback_configuration_response.GetPlaybackConfigurationResponse = capo_mediatailor.types.get_playback_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/playbackConfiguration/{Name}"
...
async def async_get_playback_configuration(
