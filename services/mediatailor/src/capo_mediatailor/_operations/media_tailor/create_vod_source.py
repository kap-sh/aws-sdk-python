...
def handle_response(
    ...
    out: capo_mediatailor.types.create_vod_source_response.CreateVodSourceResponse = (
        capo_mediatailor.types.create_vod_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.create_vod_source_request.serialize_json(input_)
    ).encode()
