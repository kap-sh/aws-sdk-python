"""Generated from Smithy shape ``com.amazonaws.mediatailor#ListPlaybackConfigurations``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.list_playback_configurations_response.ListPlaybackConfigurationsResponse = capo_mediatailor.types.list_playback_configurations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/playbackConfigurations"
    params: dict[str, str] = {}
...
async def async_list_playback_configurations(
