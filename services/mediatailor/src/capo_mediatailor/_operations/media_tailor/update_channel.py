...
def handle_response(
    ...
    out: capo_mediatailor.types.update_channel_response.UpdateChannelResponse = (
        capo_mediatailor.types.update_channel_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.update_channel_request.serialize_json(input_)
    ).encode()
