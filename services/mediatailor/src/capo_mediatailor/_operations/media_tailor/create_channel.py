"""Generated from Smithy shape ``com.amazonaws.mediatailor#CreateChannel``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.create_channel_response.CreateChannelResponse = (
        capo_mediatailor.types.create_channel_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.create_channel_request.serialize_json(input_)
    ).encode()
