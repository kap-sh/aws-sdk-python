...
class AsyncMediaTailorClientConfig(TypedDict, total=False, closed=True):
...
class AsyncMediaTailorClient:
    ...
    def __init__(
        ...
        self._config = AsyncMediaTailorClientConfig(
            {
        ...
        # resources
        self.channel_resource = AsyncChannelResource(self)
        self.function_resource = AsyncFunctionResource(self)
        self.live_source_resource = AsyncLiveSourceResource(self)
        self.playback_configuration_resource = AsyncPlaybackConfigurationResource(self)
        self.prefetch_schedule_resource = AsyncPrefetchScheduleResource(self)
        self.source_location_resource = AsyncSourceLocationResource(self)
        self.vod_source_resource = AsyncVodSourceResource(self)

    def operation_options(
        self, config_overrides: Optional[AsyncMediaTailorClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncMediaTailorClientConfig = config_overrides or {}
    ...
    async def configure_logs_for_playback_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediatailor.types.configure_logs_for_playback_configuration_request.ConfigureLogsForPlaybackConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediatailor.types.configure_logs_for_playback_configuration_response.ConfigureLogsForPlaybackConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediatailor._operations.media_tailor.configure_logs_for_playback_configuration.async_configure_logs_for_playback_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_mediatailor.types.configure_logs_for_playback_configuration_request.ConfigureLogsForPlaybackConfigurationRequest = {}  # type: ignore[typeddict-item]
    ...
    async def list_alerts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediatailor.types.list_alerts_request.ListAlertsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediatailor.types.list_alerts_response.ListAlertsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediatailor._operations.media_tailor.list_alerts.async_list_alerts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_mediatailor.types.list_alerts_request.ListAlertsRequest = {}  # type: ignore[typeddict-item]
    ...
    async def iter_list_alerts(
        ...
        *,
        ...
        max_results: Optional["capo_mediatailor.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_mediatailor.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_mediatailor.types.alert.Alert]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediatailor.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediatailor.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediatailor._operations.media_tailor.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_mediatailor.types.list_tags_for_resource_request.ListTagsForResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediatailor.types.tag_resource_request.TagResourceRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_mediatailor._operations.media_tailor.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_mediatailor.types.tag_resource_request.TagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediatailor.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediatailor._operations.media_tailor.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_mediatailor.types.untag_resource_request.UntagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
