...
class Channel(TypedDict, closed=True):
    ...
    channel_state: "aws_sdk_mediatailor.types.__string.__string"
    ...
    outputs: "aws_sdk_mediatailor.types.response_outputs.ResponseOutputs"
    """<p>The channel's output properties.</p>"""
    playback_mode: "aws_sdk_mediatailor.types.__string.__string"
    ...
    tier: "aws_sdk_mediatailor.types.__string.__string"
