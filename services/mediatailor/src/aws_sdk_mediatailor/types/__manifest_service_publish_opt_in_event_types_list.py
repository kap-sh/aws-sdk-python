...
if TYPE_CHECKING:
    import aws_sdk_mediatailor.types.manifest_service_publish_opt_in_event_type

__manifestServicePublishOptInEventTypesList: TypeAlias = list[
    "aws_sdk_mediatailor.types.manifest_service_publish_opt_in_event_type.ManifestServicePublishOptInEventType"
]
...
def serialize_json(value: __manifestServicePublishOptInEventTypesList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_mediatailor.types.manifest_service_publish_opt_in_event_type.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> __manifestServicePublishOptInEventTypesList:
    ...
    for item in data:
        out.append(
            aws_sdk_mediatailor.types.manifest_service_publish_opt_in_event_type.deserialize_json(
                item
            )
        )
    return out
