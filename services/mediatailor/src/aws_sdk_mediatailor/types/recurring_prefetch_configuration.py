...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediatailor.types.recurring_consumption
    import aws_sdk_mediatailor.types.recurring_retrieval


class RecurringPrefetchConfiguration(TypedDict):
    ...
    recurring_consumption: (
        "aws_sdk_mediatailor.types.recurring_consumption.RecurringConsumption"
    )
    ...
    recurring_retrieval: (
        "aws_sdk_mediatailor.types.recurring_retrieval.RecurringRetrieval"
    )
...
def serialize_json(value: RecurringPrefetchConfiguration) -> dict:
    ...
    out["RecurringConsumption"] = (
        aws_sdk_mediatailor.types.recurring_consumption.serialize_json(
    ...
    out["RecurringRetrieval"] = (
        aws_sdk_mediatailor.types.recurring_retrieval.serialize_json(
...
def deserialize_json(data: dict) -> RecurringPrefetchConfiguration:
    ...
    if "RecurringConsumption" in data:
        ...
        out["recurring_consumption"] = (
            aws_sdk_mediatailor.types.recurring_consumption.deserialize_json(
    ...
    if "RecurringRetrieval" in data:
        ...
        out["recurring_retrieval"] = (
            aws_sdk_mediatailor.types.recurring_retrieval.deserialize_json(
