...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediatailor.types.__list_of_functions_ref
    import aws_sdk_mediatailor.types.__map_of__string
    import aws_sdk_mediatailor.types.runtime_type


class SequentialExecutorConfiguration(TypedDict):
    ...
    function_list: (
        "aws_sdk_mediatailor.types.__list_of_functions_ref.__listOfFunctionsRef"
    )
    ...
    timeout_milliseconds: "aws_sdk_mediatailor.types.__integer.__integer"
...
def serialize_json(value: SequentialExecutorConfiguration) -> dict:
    ...
    out["FunctionList"] = (
        aws_sdk_mediatailor.types.__list_of_functions_ref.serialize_json(
            value["function_list"]
        )
    )
...
def deserialize_json(data: dict) -> SequentialExecutorConfiguration:
    ...
    if "FunctionList" in data:
        ...
        out["function_list"] = (
            aws_sdk_mediatailor.types.__list_of_functions_ref.deserialize_json(
                data["FunctionList"]
            )
        )
    else:
