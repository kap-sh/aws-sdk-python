"""Generated from Smithy shape ``com.amazonaws.mediatailor#ListVodSourcesRequest``."""
...
class ListVodSourcesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListVodSourcesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListVodSourcesRequest:
    out: ListVodSourcesRequest = {}  # type: ignore[typeddict-item]
    return out
