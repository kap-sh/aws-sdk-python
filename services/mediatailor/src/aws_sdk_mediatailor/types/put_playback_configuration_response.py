"""Generated from Smithy shape ``com.amazonaws.mediatailor#PutPlaybackConfigurationResponse``."""
...
class PutPlaybackConfigurationResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: PutPlaybackConfigurationResponse) -> dict:
    out: dict = {}
