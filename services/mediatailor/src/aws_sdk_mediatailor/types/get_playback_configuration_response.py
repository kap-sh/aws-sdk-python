"""Generated from Smithy shape ``com.amazonaws.mediatailor#GetPlaybackConfigurationResponse``."""
...
class GetPlaybackConfigurationResponse(TypedDict):
    ...
    r"""<p>The tags assigned to the playback configuration. Tags are key-value pairs that you can associate with Amazon resources to help with organization, access control, and cost tracking. For more information, see <a href=\"https://docs.aws.amazon.com/mediatailor/latest/ug/tagging.html\">Tagging AWS Elemental MediaTailor Resources</a>.</p>"""
...
# --- restJson1 ser/de ---
def serialize_json(value: GetPlaybackConfigurationResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetPlaybackConfigurationResponse:
    out: GetPlaybackConfigurationResponse = {}  # type: ignore[typeddict-item]
