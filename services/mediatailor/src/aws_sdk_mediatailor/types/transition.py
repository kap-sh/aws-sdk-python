...
class Transition(TypedDict, closed=True):
    ...
    relative_program: NotRequired["aws_sdk_mediatailor.types.__string.__string"]
    ...
    type: "aws_sdk_mediatailor.types.__string.__string"
...
def serialize_json(value: Transition) -> dict:
    ...
    out["RelativePosition"] = (
        aws_sdk_mediatailor.types.relative_position.serialize_json(
...
def deserialize_json(data: dict) -> Transition:
    ...
    if "RelativePosition" in data:
        ...
        out["relative_position"] = (
            aws_sdk_mediatailor.types.relative_position.deserialize_json(
