"""Generated from Smithy shape ``com.amazonaws.mediatailor#ListSourceLocationsRequest``."""
...
class ListSourceLocationsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListSourceLocationsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListSourceLocationsRequest:
    out: ListSourceLocationsRequest = {}  # type: ignore[typeddict-item]
    return out
