...
if TYPE_CHECKING:
    import aws_sdk_mediatailor.types.segment_delivery_configuration

__listOfSegmentDeliveryConfiguration: TypeAlias = list[
    "aws_sdk_mediatailor.types.segment_delivery_configuration.SegmentDeliveryConfiguration"
]
...
def serialize_json(value: __listOfSegmentDeliveryConfiguration) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_mediatailor.types.segment_delivery_configuration.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> __listOfSegmentDeliveryConfiguration:
    ...
    for item in data:
        out.append(
            aws_sdk_mediatailor.types.segment_delivery_configuration.deserialize_json(
                item
            )
        )
    return out
