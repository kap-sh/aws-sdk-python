"""Generated from Smithy shape ``com.amazonaws.mediatailor#AdsInteractionExcludeEventType``."""
...
def serialize_json(value: AdsInteractionExcludeEventType) -> str:
    return value


def deserialize_json(data: str) -> AdsInteractionExcludeEventType:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown AdsInteractionExcludeEventType value: {data!r}"
        )
    return cast(AdsInteractionExcludeEventType, data)
