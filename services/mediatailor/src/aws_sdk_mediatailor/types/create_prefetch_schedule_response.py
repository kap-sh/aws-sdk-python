"""Generated from Smithy shape ``com.amazonaws.mediatailor#CreatePrefetchScheduleResponse``."""
...
class CreatePrefetchScheduleResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreatePrefetchScheduleResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
