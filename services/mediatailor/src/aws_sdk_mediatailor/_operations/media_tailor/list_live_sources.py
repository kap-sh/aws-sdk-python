...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.list_live_sources_response.ListLiveSourcesResponse = aws_sdk_mediatailor.types.list_live_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.list_live_sources_request.ListLiveSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
