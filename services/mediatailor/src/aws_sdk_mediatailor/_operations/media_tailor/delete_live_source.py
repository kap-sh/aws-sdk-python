"""Generated from Smithy shape ``com.amazonaws.mediatailor#DeleteLiveSource``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.delete_live_source_response.DeleteLiveSourceResponse = {}  # type: ignore[typeddict-item]
    return out
