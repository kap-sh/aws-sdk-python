"""Generated from Smithy shape ``com.amazonaws.mediatailor#CreateVodSource``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.create_vod_source_response.CreateVodSourceResponse = aws_sdk_mediatailor.types.create_vod_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.create_vod_source_request.CreateVodSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.create_vod_source_request.serialize_json(input_)
    ).encode()
...
async def async_create_vod_source(
