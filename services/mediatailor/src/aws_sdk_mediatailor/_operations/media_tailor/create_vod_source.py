...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.create_vod_source_request.CreateVodSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.create_vod_source_request.serialize_json(input)
    ).encode()
