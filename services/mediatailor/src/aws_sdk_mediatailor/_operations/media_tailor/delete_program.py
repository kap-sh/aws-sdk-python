"""Generated from Smithy shape ``com.amazonaws.mediatailor#DeleteProgram``."""
...
if TYPE_CHECKING:
    import aws_sdk_mediatailor.types.delete_program_request
    import aws_sdk_mediatailor.types.delete_program_response
...
) -> aws_sdk_mediatailor.types.delete_program_response.DeleteProgramResponse:
    out: aws_sdk_mediatailor.types.delete_program_response.DeleteProgramResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.delete_program_request.DeleteProgramRequest,
) -> zapros.Request:
...
async def async_delete_program(
