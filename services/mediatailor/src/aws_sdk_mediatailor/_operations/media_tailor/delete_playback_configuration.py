...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.delete_playback_configuration_response.DeletePlaybackConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.delete_playback_configuration_request.DeletePlaybackConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
