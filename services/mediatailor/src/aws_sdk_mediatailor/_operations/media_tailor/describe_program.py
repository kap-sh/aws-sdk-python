...
import aws_sdk_mediatailor.types.describe_program_request
import aws_sdk_mediatailor.types.describe_program_response
...
) -> aws_sdk_mediatailor.types.describe_program_response.DescribeProgramResponse:
    out: aws_sdk_mediatailor.types.describe_program_response.DescribeProgramResponse = (
        aws_sdk_mediatailor.types.describe_program_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.describe_program_request.DescribeProgramRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
