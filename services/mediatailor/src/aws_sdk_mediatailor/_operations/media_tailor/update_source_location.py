...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.update_source_location_response.UpdateSourceLocationResponse = aws_sdk_mediatailor.types.update_source_location_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.update_source_location_request.UpdateSourceLocationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.update_source_location_request.serialize_json(input)
    ).encode()
