"""Generated from Smithy shape ``com.amazonaws.mediatailor#ListAlerts``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.list_alerts_response.ListAlertsResponse = (
        aws_sdk_mediatailor.types.list_alerts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.list_alerts_request.ListAlertsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/alerts"
    params: dict[str, str] = {}
...
def list_alerts(
    ...
    aws_sdk_mediatailor.types.list_alerts_response.ListAlertsResponse, zapros.Response
]:
