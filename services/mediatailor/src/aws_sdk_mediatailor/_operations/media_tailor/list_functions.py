...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.list_functions_response.ListFunctionsResponse = (
        aws_sdk_mediatailor.types.list_functions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.list_functions_request.ListFunctionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
