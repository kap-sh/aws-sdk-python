"""Generated from Smithy shape ``com.amazonaws.mediatailor#ConfigureLogsForChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.configure_logs_for_channel_response.ConfigureLogsForChannelResponse = aws_sdk_mediatailor.types.configure_logs_for_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.configure_logs_for_channel_request.ConfigureLogsForChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/configureLogs/channel"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_mediatailor.types.configure_logs_for_channel_request

    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.configure_logs_for_channel_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_configure_logs_for_channel(
