"""Generated from Smithy shape ``com.amazonaws.mediatailor#CreatePrefetchSchedule``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.create_prefetch_schedule_response.CreatePrefetchScheduleResponse = aws_sdk_mediatailor.types.create_prefetch_schedule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.create_prefetch_schedule_request.CreatePrefetchScheduleRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["playback_configuration_name"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.create_prefetch_schedule_request.serialize_json(input)
    ).encode()
...
async def async_create_prefetch_schedule(
