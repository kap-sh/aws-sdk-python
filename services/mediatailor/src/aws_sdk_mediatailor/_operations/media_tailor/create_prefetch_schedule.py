...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.create_prefetch_schedule_request.CreatePrefetchScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["playback_configuration_name"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.create_prefetch_schedule_request.serialize_json(
            input_
        )
    ).encode()
