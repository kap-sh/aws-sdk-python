...
if TYPE_CHECKING:
    import aws_sdk_mediatailor.types.get_channel_policy_request
    import aws_sdk_mediatailor.types.get_channel_policy_response
...
) -> aws_sdk_mediatailor.types.get_channel_policy_response.GetChannelPolicyResponse:
    import aws_sdk_mediatailor.types.get_channel_policy_response

    out: aws_sdk_mediatailor.types.get_channel_policy_response.GetChannelPolicyResponse = aws_sdk_mediatailor.types.get_channel_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.get_channel_policy_request.GetChannelPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
