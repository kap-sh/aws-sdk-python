"""Generated from Smithy shape ``com.amazonaws.mediatailor#PutFunction``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.put_function_response.PutFunctionResponse = (
        aws_sdk_mediatailor.types.put_function_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.put_function_request.PutFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/function/{FunctionId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.put_function_request.serialize_json(input_)
    ).encode()
...
def put_function(
    ...
    aws_sdk_mediatailor.types.put_function_response.PutFunctionResponse, zapros.Response
]:
