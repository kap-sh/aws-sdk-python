...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediatailor.types.create_program_response
...
) -> aws_sdk_mediatailor.types.create_program_response.CreateProgramResponse:
    import aws_sdk_mediatailor.types.create_program_response

    out: aws_sdk_mediatailor.types.create_program_response.CreateProgramResponse = (
        aws_sdk_mediatailor.types.create_program_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.create_program_request.CreateProgramRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.create_program_request.serialize_json(input)
    ).encode()
