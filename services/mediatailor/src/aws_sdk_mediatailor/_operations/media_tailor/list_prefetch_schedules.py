...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.list_prefetch_schedules_request.ListPrefetchSchedulesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.list_prefetch_schedules_request.serialize_json(input)
    ).encode()
