...
if TYPE_CHECKING:
    import aws_sdk_mediatailor.types.update_program_request
    import aws_sdk_mediatailor.types.update_program_response
...
) -> aws_sdk_mediatailor.types.update_program_response.UpdateProgramResponse:
    import aws_sdk_mediatailor.types.update_program_response

    out: aws_sdk_mediatailor.types.update_program_response.UpdateProgramResponse = (
        aws_sdk_mediatailor.types.update_program_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.update_program_request.UpdateProgramRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.update_program_request.serialize_json(input_)
    ).encode()
