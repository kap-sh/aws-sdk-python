...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.put_channel_policy_request.PutChannelPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.put_channel_policy_request.serialize_json(input_)
    ).encode()
