...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.create_live_source_request.CreateLiveSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.create_live_source_request.serialize_json(input)
    ).encode()
