...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.delete_source_location_response.DeleteSourceLocationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.delete_source_location_request.DeleteSourceLocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
