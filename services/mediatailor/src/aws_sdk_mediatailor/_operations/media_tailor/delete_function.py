...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.delete_function_response.DeleteFunctionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.delete_function_request.DeleteFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
