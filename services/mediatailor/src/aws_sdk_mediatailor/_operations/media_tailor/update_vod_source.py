"""Generated from Smithy shape ``com.amazonaws.mediatailor#UpdateVodSource``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.update_vod_source_response.UpdateVodSourceResponse = aws_sdk_mediatailor.types.update_vod_source_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.update_vod_source_request.UpdateVodSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.update_vod_source_request.serialize_json(input)
    ).encode()
...
async def async_update_vod_source(
