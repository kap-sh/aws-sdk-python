...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.describe_vod_source_response.DescribeVodSourceResponse = aws_sdk_mediatailor.types.describe_vod_source_response.deserialize_json(
