"""Generated from Smithy shape ``com.amazonaws.mediatailor#DeleteChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.delete_channel_response.DeleteChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.delete_channel_request.DeleteChannelRequest,
) -> zapros.Request:
