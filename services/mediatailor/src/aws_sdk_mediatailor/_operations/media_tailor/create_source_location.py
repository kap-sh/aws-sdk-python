"""Generated from Smithy shape ``com.amazonaws.mediatailor#CreateSourceLocation``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.create_source_location_response.CreateSourceLocationResponse = aws_sdk_mediatailor.types.create_source_location_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.create_source_location_request.CreateSourceLocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.create_source_location_request.serialize_json(input_)
    ).encode()
...
async def async_create_source_location(
