...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.create_source_location_request.CreateSourceLocationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.create_source_location_request.serialize_json(input)
    ).encode()
