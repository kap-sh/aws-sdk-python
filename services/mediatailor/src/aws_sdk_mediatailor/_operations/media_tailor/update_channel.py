"""Generated from Smithy shape ``com.amazonaws.mediatailor#UpdateChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.update_channel_response.UpdateChannelResponse = (
        aws_sdk_mediatailor.types.update_channel_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.update_channel_request.UpdateChannelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.update_channel_request.serialize_json(input)
    ).encode()
