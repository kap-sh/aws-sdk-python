...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.delete_vod_source_response.DeleteVodSourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.delete_vod_source_request.DeleteVodSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
