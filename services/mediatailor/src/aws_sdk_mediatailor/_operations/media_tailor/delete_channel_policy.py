...
if TYPE_CHECKING:
    import aws_sdk_mediatailor.types.delete_channel_policy_request
    import aws_sdk_mediatailor.types.delete_channel_policy_response
...
def handle_response(
    ...
    aws_sdk_mediatailor.types.delete_channel_policy_response.DeleteChannelPolicyResponse
):
    out: aws_sdk_mediatailor.types.delete_channel_policy_response.DeleteChannelPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.delete_channel_policy_request.DeleteChannelPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
