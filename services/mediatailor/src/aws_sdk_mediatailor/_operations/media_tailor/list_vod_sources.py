...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.list_vod_sources_response.ListVodSourcesResponse = (
        aws_sdk_mediatailor.types.list_vod_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.list_vod_sources_request.ListVodSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
