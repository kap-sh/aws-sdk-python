"""Generated from Smithy shape ``com.amazonaws.mediatailor#GetFunction``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.get_function_response.GetFunctionResponse = (
        aws_sdk_mediatailor.types.get_function_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.get_function_request.GetFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_function(
    ...
    aws_sdk_mediatailor.types.get_function_response.GetFunctionResponse, zapros.Response
]:
