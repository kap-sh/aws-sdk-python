"""Generated from Smithy shape ``com.amazonaws.mediatailor#DescribeSourceLocation``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.describe_source_location_response.DescribeSourceLocationResponse = aws_sdk_mediatailor.types.describe_source_location_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.describe_source_location_request.DescribeSourceLocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_source_location(
