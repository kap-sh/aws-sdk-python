...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.get_prefetch_schedule_response.GetPrefetchScheduleResponse = aws_sdk_mediatailor.types.get_prefetch_schedule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.get_prefetch_schedule_request.GetPrefetchScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
