...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.update_live_source_request.UpdateLiveSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.update_live_source_request.serialize_json(input)
    ).encode()
