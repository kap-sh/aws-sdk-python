...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.update_live_source_response.UpdateLiveSourceResponse = aws_sdk_mediatailor.types.update_live_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.update_live_source_request.UpdateLiveSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediatailor.types.update_live_source_request.serialize_json(input_)
    ).encode()
