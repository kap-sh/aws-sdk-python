"""Generated from Smithy shape ``com.amazonaws.mediatailor#DeletePrefetchSchedule``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.delete_prefetch_schedule_response.DeletePrefetchScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.delete_prefetch_schedule_request.DeletePrefetchScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_prefetch_schedule(
