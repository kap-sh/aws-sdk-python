...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.list_playback_configurations_response.ListPlaybackConfigurationsResponse = aws_sdk_mediatailor.types.list_playback_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediatailor.types.list_playback_configurations_request.ListPlaybackConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
