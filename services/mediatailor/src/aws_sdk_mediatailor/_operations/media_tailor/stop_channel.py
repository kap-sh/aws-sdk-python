"""Generated from Smithy shape ``com.amazonaws.mediatailor#StopChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.stop_channel_response.StopChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.stop_channel_request.StopChannelRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/channel/{ChannelName}/stop"
...
def stop_channel(
    ...
    aws_sdk_mediatailor.types.stop_channel_response.StopChannelResponse, zapros.Response
]:
