...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.get_channel_schedule_response.GetChannelScheduleResponse = aws_sdk_mediatailor.types.get_channel_schedule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.get_channel_schedule_request.GetChannelScheduleRequest,
) -> zapros.Request:
