"""Generated from Smithy shape ``com.amazonaws.mediatailor#StartChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_mediatailor.types.start_channel_response.StartChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_mediatailor.types.start_channel_request.StartChannelRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/channel/{ChannelName}/start"
