...
from aws_sdk_mediatailor._resources.media_tailor.channel_resource import (
...
from aws_sdk_mediatailor._services._aws_config import aaws_config
...
class AsyncMediaTailorClientConfig(TypedDict, total=False):
...
class AsyncMediaTailorClient:
    ...
    async def configure_logs_for_playback_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mediatailor.types.configure_logs_for_playback_configuration_request.ConfigureLogsForPlaybackConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mediatailor.types.configure_logs_for_playback_configuration_response.ConfigureLogsForPlaybackConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mediatailor._operations.media_tailor.configure_logs_for_playback_configuration.async_configure_logs_for_playback_configuration(
    ...
    async def list_alerts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mediatailor.types.list_alerts_request.ListAlertsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mediatailor.types.list_alerts_response.ListAlertsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mediatailor._operations.media_tailor.list_alerts.async_list_alerts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_alerts(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_mediatailor.types.__string.__string"] = None,
    ) -> "AsyncIterator[aws_sdk_mediatailor.types.alert.Alert]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mediatailor.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mediatailor.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mediatailor._operations.media_tailor.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mediatailor.types.tag_resource_request.TagResourceRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mediatailor._operations.media_tailor.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mediatailor.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mediatailor._operations.media_tailor.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
