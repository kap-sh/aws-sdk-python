...
class MediaTailorError(Exception):
    """Base class for all MediaTailor service errors."""


class ServiceError(MediaTailorError):
...
class SerializationError(MediaTailorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MediaTailorError):
...
class WaiterFailedError(MediaTailorError):
...
class WaiterTimeoutError(MediaTailorError):
