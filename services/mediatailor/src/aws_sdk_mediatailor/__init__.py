...
from ._services.async_media_tailor import (
    AsyncMediaTailorClient as AsyncMediaTailorClient,
)
from ._services.media_tailor import MediaTailorClient as MediaTailorClient
