...
from aws_sdk_mediatailor._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_4_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.us-east-1.api.aws'
...
def test_5_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.us-east-1.amazonaws.com'
...
def test_6_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://mediatailor.us-east-1.api.aws'
...
def test_7_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor.us-east-1.amazonaws.com'
...
def test_8_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_9_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.cn-northwest-1.amazonaws.com.cn'
...
def test_10_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_11_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor.cn-northwest-1.amazonaws.com.cn'
...
def test_12_for_region_eusc_de_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.eusc-de-east-1.amazonaws.eu'
...
def test_13_for_region_eusc_de_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor.eusc-de-east-1.amazonaws.eu'
...
def test_14_for_region_us_iso_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.us-iso-east-1.c2s.ic.gov'
...
def test_15_for_region_us_iso_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor.us-iso-east-1.c2s.ic.gov'
...
def test_16_for_region_us_isob_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.us-isob-east-1.sc2s.sgov.gov'
...
def test_17_for_region_us_isob_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor.us-isob-east-1.sc2s.sgov.gov'
...
def test_18_for_region_eu_isoe_west_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.eu-isoe-west-1.cloud.adc-e.uk'
...
def test_19_for_region_eu_isoe_west_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor.eu-isoe-west-1.cloud.adc-e.uk'
...
def test_20_for_region_us_isof_south_1_with_fips_ena():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.us-isof-south-1.csp.hci.ic.gov'
...
def test_21_for_region_us_isof_south_1_with_fips_dis():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor.us-isof-south-1.csp.hci.ic.gov'
...
def test_22_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.us-gov-west-1.api.aws'
...
def test_23_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor-fips.us-gov-west-1.amazonaws.com'
...
def test_24_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor.us-gov-west-1.api.aws'
...
def test_25_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://api.mediatailor.us-gov-west-1.amazonaws.com'
