"""Generated from Smithy shape ``com.amazonaws.apigateway#GetRequestValidators``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.request_validators.RequestValidators = (
        capo_api_gateway.types.request_validators.deserialize_json(
...
def get_request_validators(
    ...
    capo_api_gateway.types.request_validators.RequestValidators, zapros.Response
]:
...
async def async_get_request_validators(
