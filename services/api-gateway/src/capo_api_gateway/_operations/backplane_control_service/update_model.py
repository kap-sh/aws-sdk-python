"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateModel``."""
...
def handle_response(response: zapros.Response) -> capo_api_gateway.types.model.Model:
    out: capo_api_gateway.types.model.Model = (
        capo_api_gateway.types.model.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.model.Model = (
        capo_api_gateway.types.model.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_model_request.serialize_json(input_)
    ).encode()
...
def update_model(
    ...
    input_: capo_api_gateway.types.update_model_request.UpdateModelRequest,
) -> tuple[capo_api_gateway.types.model.Model, zapros.Response]:
