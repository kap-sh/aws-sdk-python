"""Generated from Smithy shape ``com.amazonaws.apigateway#GetUsagePlans``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.usage_plans.UsagePlans = (
        capo_api_gateway.types.usage_plans.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.usage_plans.UsagePlans = (
        capo_api_gateway.types.usage_plans.deserialize_json(
...
def build_request(
    ...
    if "key_id" in input_:
        params["keyId"] = str(input_["key_id"])
    if "limit" in input_:
...
def get_usage_plans(
    ...
    input_: capo_api_gateway.types.get_usage_plans_request.GetUsagePlansRequest,
) -> tuple[capo_api_gateway.types.usage_plans.UsagePlans, zapros.Response]:
...
async def async_get_usage_plans(
