"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateResource``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.resource.Resource = (
        capo_api_gateway.types.resource.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.resource.Resource = (
        capo_api_gateway.types.resource.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/restapis/{restApiId}/resources/{resourceId}"
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_resource_request.serialize_json(input_)
    ).encode()
...
def update_resource(
    ...
    input_: capo_api_gateway.types.update_resource_request.UpdateResourceRequest,
) -> tuple[capo_api_gateway.types.resource.Resource, zapros.Response]:
