"""Generated from Smithy shape ``com.amazonaws.apigateway#GetVpcLinks``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.vpc_links.VpcLinks = (
        capo_api_gateway.types.vpc_links.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.vpc_links.VpcLinks = (
        capo_api_gateway.types.vpc_links.deserialize_json(
...
def get_vpc_links(
    ...
    input_: capo_api_gateway.types.get_vpc_links_request.GetVpcLinksRequest,
) -> tuple[capo_api_gateway.types.vpc_links.VpcLinks, zapros.Response]:
