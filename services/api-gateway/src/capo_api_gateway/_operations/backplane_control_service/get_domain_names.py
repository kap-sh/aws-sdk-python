"""Generated from Smithy shape ``com.amazonaws.apigateway#GetDomainNames``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.domain_names.DomainNames = (
        capo_api_gateway.types.domain_names.deserialize_json(
...
def get_domain_names(
    ...
    input_: capo_api_gateway.types.get_domain_names_request.GetDomainNamesRequest,
) -> tuple[capo_api_gateway.types.domain_names.DomainNames, zapros.Response]:
...
async def async_get_domain_names(
