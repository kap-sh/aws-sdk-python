...
def handle_response(
    ...
    out: capo_api_gateway.types.gateway_responses.GatewayResponses = (
        capo_api_gateway.types.gateway_responses.deserialize_json(
...
def get_gateway_responses(
    ...
    input_: capo_api_gateway.types.get_gateway_responses_request.GetGatewayResponsesRequest,
) -> tuple[capo_api_gateway.types.gateway_responses.GatewayResponses, zapros.Response]:
