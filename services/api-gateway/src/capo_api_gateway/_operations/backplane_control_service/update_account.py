...
def handle_response(
    ...
    out: capo_api_gateway.types.account.Account = (
        capo_api_gateway.types.account.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.account.Account = (
        capo_api_gateway.types.account.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_account_request.serialize_json(input_)
    ).encode()
...
def update_account(
    ...
    input_: capo_api_gateway.types.update_account_request.UpdateAccountRequest,
) -> tuple[capo_api_gateway.types.account.Account, zapros.Response]:
