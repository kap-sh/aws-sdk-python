...
def handle_response(
    ...
    out: capo_api_gateway.types.documentation_versions.DocumentationVersions = (
        capo_api_gateway.types.documentation_versions.deserialize_json(
...
def get_documentation_versions(
    ...
    capo_api_gateway.types.documentation_versions.DocumentationVersions, zapros.Response
]:
