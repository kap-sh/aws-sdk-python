"""Generated from Smithy shape ``com.amazonaws.apigateway#GetModels``."""
...
import capo_api_gateway.types.list_of_model
...
def handle_response(response: zapros.Response) -> capo_api_gateway.types.models.Models:
    out: capo_api_gateway.types.models.Models = (
        capo_api_gateway.types.models.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.models.Models = (
        capo_api_gateway.types.models.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/restapis/{restApiId}/models"
...
def get_models(
    ...
    input_: capo_api_gateway.types.get_models_request.GetModelsRequest,
) -> tuple[capo_api_gateway.types.models.Models, zapros.Response]:
