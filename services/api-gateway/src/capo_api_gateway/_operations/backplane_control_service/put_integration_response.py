"""Generated from Smithy shape ``com.amazonaws.apigateway#PutIntegrationResponse``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.put_integration_response_request.serialize_json(input_)
    ).encode()
...
async def async_put_integration_response(
