"""Generated from Smithy shape ``com.amazonaws.apigateway#TestInvokeMethod``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.test_invoke_method_response.TestInvokeMethodResponse = (
        capo_api_gateway.types.test_invoke_method_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.test_invoke_method_request.serialize_json(input_)
    ).encode()
...
async def async_test_invoke_method(
