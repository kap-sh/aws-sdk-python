"""Generated from Smithy shape ``com.amazonaws.apigateway#GetSdkTypes``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.sdk_types.SdkTypes = (
        capo_api_gateway.types.sdk_types.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.sdk_types.SdkTypes = (
        capo_api_gateway.types.sdk_types.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sdktypes"
    params: dict[str, str] = {}
...
def get_sdk_types(
    ...
    input_: capo_api_gateway.types.get_sdk_types_request.GetSdkTypesRequest,
) -> tuple[capo_api_gateway.types.sdk_types.SdkTypes, zapros.Response]:
