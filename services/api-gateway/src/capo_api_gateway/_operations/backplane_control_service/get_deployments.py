"""Generated from Smithy shape ``com.amazonaws.apigateway#GetDeployments``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.deployments.Deployments = (
        capo_api_gateway.types.deployments.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.deployments.Deployments = (
        capo_api_gateway.types.deployments.deserialize_json(
...
def get_deployments(
    ...
    input_: capo_api_gateway.types.get_deployments_request.GetDeploymentsRequest,
) -> tuple[capo_api_gateway.types.deployments.Deployments, zapros.Response]:
