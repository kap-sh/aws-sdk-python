"""Generated from Smithy shape ``com.amazonaws.apigateway#GetDeployment``."""
...
import capo_api_gateway.errors.service_unavailable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUnavailableException":
            raise capo_api_gateway.errors.service_unavailable_exception.ServiceUnavailableException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_api_gateway.types.deployment.Deployment = (
        capo_api_gateway.types.deployment.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.deployment.Deployment = (
        capo_api_gateway.types.deployment.deserialize_json(
...
def get_deployment(
    ...
    input_: capo_api_gateway.types.get_deployment_request.GetDeploymentRequest,
) -> tuple[capo_api_gateway.types.deployment.Deployment, zapros.Response]:
