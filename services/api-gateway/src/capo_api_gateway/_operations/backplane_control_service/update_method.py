"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateMethod``."""
...
def handle_response(response: zapros.Response) -> capo_api_gateway.types.method.Method:
    out: capo_api_gateway.types.method.Method = (
        capo_api_gateway.types.method.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.method.Method = (
        capo_api_gateway.types.method.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_method_request.serialize_json(input_)
    ).encode()
...
def update_method(
    ...
    input_: capo_api_gateway.types.update_method_request.UpdateMethodRequest,
) -> tuple[capo_api_gateway.types.method.Method, zapros.Response]:
