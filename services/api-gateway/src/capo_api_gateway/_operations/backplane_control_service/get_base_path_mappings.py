...
def handle_response(
    ...
    out: capo_api_gateway.types.base_path_mappings.BasePathMappings = (
        capo_api_gateway.types.base_path_mappings.deserialize_json(
...
def get_base_path_mappings(
    ...
    input_: capo_api_gateway.types.get_base_path_mappings_request.GetBasePathMappingsRequest,
) -> tuple[capo_api_gateway.types.base_path_mappings.BasePathMappings, zapros.Response]:
