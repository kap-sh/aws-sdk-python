...
def handle_response(response: zapros.Response) -> capo_api_gateway.types.api_key.ApiKey:
    out: capo_api_gateway.types.api_key.ApiKey = (
        capo_api_gateway.types.api_key.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.api_key.ApiKey = (
        capo_api_gateway.types.api_key.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_api_key_request.serialize_json(input_)
    ).encode()
...
def update_api_key(
    ...
    input_: capo_api_gateway.types.update_api_key_request.UpdateApiKeyRequest,
) -> tuple[capo_api_gateway.types.api_key.ApiKey, zapros.Response]:
