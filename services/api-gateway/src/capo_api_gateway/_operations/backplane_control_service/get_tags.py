...
def handle_response(response: zapros.Response) -> capo_api_gateway.types.tags.Tags:
    out: capo_api_gateway.types.tags.Tags = (
        capo_api_gateway.types.tags.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.tags.Tags = (
        capo_api_gateway.types.tags.deserialize_json(json.loads(await response.aread()))
    )
    return out
...
def get_tags(
    ...
    input_: capo_api_gateway.types.get_tags_request.GetTagsRequest,
) -> tuple[capo_api_gateway.types.tags.Tags, zapros.Response]:
