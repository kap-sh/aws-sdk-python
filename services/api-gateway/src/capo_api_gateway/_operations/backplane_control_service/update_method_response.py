...
def handle_response(
    ...
    out: capo_api_gateway.types.method_response.MethodResponse = (
        capo_api_gateway.types.method_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_method_response_request.serialize_json(input_)
    ).encode()
...
def update_method_response(
    ...
    input_: capo_api_gateway.types.update_method_response_request.UpdateMethodResponseRequest,
) -> tuple[capo_api_gateway.types.method_response.MethodResponse, zapros.Response]:
