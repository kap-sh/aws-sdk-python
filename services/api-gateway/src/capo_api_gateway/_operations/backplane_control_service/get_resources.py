...
import capo_api_gateway.types.list_of_resource
...
def handle_response(
    ...
    out: capo_api_gateway.types.resources.Resources = (
        capo_api_gateway.types.resources.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.resources.Resources = (
        capo_api_gateway.types.resources.deserialize_json(
...
def get_resources(
    ...
    input_: capo_api_gateway.types.get_resources_request.GetResourcesRequest,
) -> tuple[capo_api_gateway.types.resources.Resources, zapros.Response]:
