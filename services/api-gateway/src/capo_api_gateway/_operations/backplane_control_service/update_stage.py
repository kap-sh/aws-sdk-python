...
def handle_response(response: zapros.Response) -> capo_api_gateway.types.stage.Stage:
    out: capo_api_gateway.types.stage.Stage = (
        capo_api_gateway.types.stage.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.stage.Stage = (
        capo_api_gateway.types.stage.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_stage_request.serialize_json(input_)
    ).encode()
...
def update_stage(
    ...
    input_: capo_api_gateway.types.update_stage_request.UpdateStageRequest,
) -> tuple[capo_api_gateway.types.stage.Stage, zapros.Response]:
