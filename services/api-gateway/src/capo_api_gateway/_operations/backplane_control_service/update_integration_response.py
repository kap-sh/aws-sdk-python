...
def handle_response(
    ...
    out: capo_api_gateway.types.integration_response.IntegrationResponse = (
        capo_api_gateway.types.integration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_integration_response_request.serialize_json(
            input_
        )
    ).encode()
...
def update_integration_response(
    ...
    capo_api_gateway.types.integration_response.IntegrationResponse, zapros.Response
]:
