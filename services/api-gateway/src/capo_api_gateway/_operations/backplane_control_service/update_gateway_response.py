...
def handle_response(
    ...
    out: capo_api_gateway.types.gateway_response.GatewayResponse = (
        capo_api_gateway.types.gateway_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_gateway_response_request.serialize_json(input_)
    ).encode()
...
def update_gateway_response(
    ...
    input_: capo_api_gateway.types.update_gateway_response_request.UpdateGatewayResponseRequest,
) -> tuple[capo_api_gateway.types.gateway_response.GatewayResponse, zapros.Response]:
