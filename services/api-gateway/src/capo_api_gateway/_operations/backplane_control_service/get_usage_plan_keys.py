"""Generated from Smithy shape ``com.amazonaws.apigateway#GetUsagePlanKeys``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.usage_plan_keys.UsagePlanKeys = (
        capo_api_gateway.types.usage_plan_keys.deserialize_json(
...
def get_usage_plan_keys(
    ...
    input_: capo_api_gateway.types.get_usage_plan_keys_request.GetUsagePlanKeysRequest,
) -> tuple[capo_api_gateway.types.usage_plan_keys.UsagePlanKeys, zapros.Response]:
...
async def async_get_usage_plan_keys(
