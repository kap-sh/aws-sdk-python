"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateBasePathMapping``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.base_path_mapping.BasePathMapping = (
        capo_api_gateway.types.base_path_mapping.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.create_base_path_mapping_request.serialize_json(input_)
    ).encode()
...
def create_base_path_mapping(
    ...
    input_: capo_api_gateway.types.create_base_path_mapping_request.CreateBasePathMappingRequest,
) -> tuple[capo_api_gateway.types.base_path_mapping.BasePathMapping, zapros.Response]:
...
async def async_create_base_path_mapping(
