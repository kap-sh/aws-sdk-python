...
import capo_api_gateway.types.list_of_client_certificate
...
def handle_response(
    ...
    out: capo_api_gateway.types.client_certificates.ClientCertificates = (
        capo_api_gateway.types.client_certificates.deserialize_json(
...
def get_client_certificates(
    ...
    capo_api_gateway.types.client_certificates.ClientCertificates, zapros.Response
]:
