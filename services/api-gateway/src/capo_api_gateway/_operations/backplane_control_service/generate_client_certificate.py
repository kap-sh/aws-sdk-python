"""Generated from Smithy shape ``com.amazonaws.apigateway#GenerateClientCertificate``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.generate_client_certificate_request.serialize_json(
            input_
        )
    ).encode()
