"""Generated from Smithy shape ``com.amazonaws.apigateway#GetAuthorizers``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.authorizers.Authorizers = (
        capo_api_gateway.types.authorizers.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.authorizers.Authorizers = (
        capo_api_gateway.types.authorizers.deserialize_json(
...
def get_authorizers(
    ...
    input_: capo_api_gateway.types.get_authorizers_request.GetAuthorizersRequest,
) -> tuple[capo_api_gateway.types.authorizers.Authorizers, zapros.Response]:
...
async def async_get_authorizers(
