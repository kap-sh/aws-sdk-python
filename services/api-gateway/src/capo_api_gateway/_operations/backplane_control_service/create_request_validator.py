...
def handle_response(
    ...
    out: capo_api_gateway.types.request_validator.RequestValidator = (
        capo_api_gateway.types.request_validator.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.create_request_validator_request.serialize_json(input_)
    ).encode()
...
def create_request_validator(
    ...
    input_: capo_api_gateway.types.create_request_validator_request.CreateRequestValidatorRequest,
) -> tuple[capo_api_gateway.types.request_validator.RequestValidator, zapros.Response]:
