...
def handle_response(response: zapros.Response) -> capo_api_gateway.types.stages.Stages:
    out: capo_api_gateway.types.stages.Stages = (
        capo_api_gateway.types.stages.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.stages.Stages = (
        capo_api_gateway.types.stages.deserialize_json(
...
def get_stages(
    ...
    input_: capo_api_gateway.types.get_stages_request.GetStagesRequest,
) -> tuple[capo_api_gateway.types.stages.Stages, zapros.Response]:
