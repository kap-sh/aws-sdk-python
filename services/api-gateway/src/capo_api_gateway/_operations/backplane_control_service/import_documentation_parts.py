...
def handle_response(
    ...
    out: capo_api_gateway.types.documentation_part_ids.DocumentationPartIds = (
        capo_api_gateway.types.documentation_part_ids.deserialize_json(
...
def import_documentation_parts(
    ...
    capo_api_gateway.types.documentation_part_ids.DocumentationPartIds, zapros.Response
]:
