"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateDocumentationPart``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.documentation_part.DocumentationPart = (
        capo_api_gateway.types.documentation_part.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.create_documentation_part_request.serialize_json(input_)
    ).encode()
...
def create_documentation_part(
    ...
    capo_api_gateway.types.documentation_part.DocumentationPart, zapros.Response
]:
...
async def async_create_documentation_part(
