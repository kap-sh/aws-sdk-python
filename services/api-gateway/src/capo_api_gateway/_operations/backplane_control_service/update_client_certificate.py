...
def handle_response(
    ...
    out: capo_api_gateway.types.client_certificate.ClientCertificate = (
        capo_api_gateway.types.client_certificate.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_client_certificate_request.serialize_json(input_)
    ).encode()
...
def update_client_certificate(
    ...
    capo_api_gateway.types.client_certificate.ClientCertificate, zapros.Response
]:
