"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateRestApi``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_rest_api_request.serialize_json(input_)
    ).encode()
...
async def async_update_rest_api(
