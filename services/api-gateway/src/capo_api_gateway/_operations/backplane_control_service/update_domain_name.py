...
def handle_response(
    ...
    out: capo_api_gateway.types.domain_name.DomainName = (
        capo_api_gateway.types.domain_name.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.domain_name.DomainName = (
        capo_api_gateway.types.domain_name.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_domain_name_request.serialize_json(input_)
    ).encode()
...
def update_domain_name(
    ...
    input_: capo_api_gateway.types.update_domain_name_request.UpdateDomainNameRequest,
) -> tuple[capo_api_gateway.types.domain_name.DomainName, zapros.Response]:
