...
def handle_response(
    ...
    out: capo_api_gateway.types.documentation_version.DocumentationVersion = (
        capo_api_gateway.types.documentation_version.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.update_documentation_version_request.serialize_json(
            input_
        )
    ).encode()
...
def update_documentation_version(
    ...
    capo_api_gateway.types.documentation_version.DocumentationVersion, zapros.Response
]:
