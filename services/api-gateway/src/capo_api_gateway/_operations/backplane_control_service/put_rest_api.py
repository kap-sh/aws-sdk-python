"""Generated from Smithy shape ``com.amazonaws.apigateway#PutRestApi``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.rest_api.RestApi = (
        capo_api_gateway.types.rest_api.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.rest_api.RestApi = (
        capo_api_gateway.types.rest_api.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/restapis/{restApiId}"
    ...
    if "body" in input_:
        body: bytes | None = json.dumps(
            capo_api_gateway.types.blob.serialize_json(input_["body"])
        ).encode()
...
def put_rest_api(
    ...
    input_: capo_api_gateway.types.put_rest_api_request.PutRestApiRequest,
) -> tuple[capo_api_gateway.types.rest_api.RestApi, zapros.Response]:
