"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateRequestValidatorRequest``."""
...
class UpdateRequestValidatorRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateRequestValidatorRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateRequestValidatorRequest:
    out: UpdateRequestValidatorRequest = {}  # type: ignore[typeddict-item]
