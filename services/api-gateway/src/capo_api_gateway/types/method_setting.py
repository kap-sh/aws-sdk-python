...
class MethodSetting(TypedDict, closed=True):
    metrics_enabled: "capo_api_gateway.types.boolean.Boolean"
    """<p>Specifies whether Amazon CloudWatch metrics are enabled for this method.</p>"""
    logging_level: NotRequired["capo_api_gateway.types.string.String"]
    ...
    data_trace_enabled: "capo_api_gateway.types.boolean.Boolean"
    ...
    throttling_burst_limit: "capo_api_gateway.types.integer.Integer"
    """<p>Specifies the throttling burst limit.</p>"""
    throttling_rate_limit: "capo_api_gateway.types.double.Double"
    """<p>Specifies the throttling rate limit.</p>"""
    caching_enabled: "capo_api_gateway.types.boolean.Boolean"
    ...
    cache_ttl_in_seconds: "capo_api_gateway.types.integer.Integer"
    ...
    cache_data_encrypted: "capo_api_gateway.types.boolean.Boolean"
    """<p>Specifies whether the cached responses are encrypted.</p>"""
    require_authorization_for_cache_control: "capo_api_gateway.types.boolean.Boolean"
    ...
    unauthorized_cache_control_header_strategy: NotRequired[
        "capo_api_gateway.types.unauthorized_cache_control_header_strategy.UnauthorizedCacheControlHeaderStrategy"
    ]
...
def serialize_json(value: MethodSetting) -> dict:
    ...
    if "unauthorized_cache_control_header_strategy" in value:
        ...
        out["unauthorizedCacheControlHeaderStrategy"] = (
            capo_api_gateway.types.unauthorized_cache_control_header_strategy.serialize_json(
...
def deserialize_json(data: dict) -> MethodSetting:
    ...
    if "unauthorizedCacheControlHeaderStrategy" in data:
        ...
        out["unauthorized_cache_control_header_strategy"] = (
            capo_api_gateway.types.unauthorized_cache_control_header_strategy.deserialize_json(
