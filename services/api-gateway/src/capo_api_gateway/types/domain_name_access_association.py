...
class DomainNameAccessAssociation(TypedDict, closed=True):
    ...
    access_association_source_type: NotRequired[
        "capo_api_gateway.types.access_association_source_type.AccessAssociationSourceType"
    ]
    """<p> The type of the domain name access association source. </p>"""
    access_association_source: NotRequired["capo_api_gateway.types.string.String"]
