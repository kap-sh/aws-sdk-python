...
class PutMethodRequest(TypedDict, closed=True):
    ...
    authorizer_id: NotRequired["aws_sdk_api_gateway.types.string.String"]
    ...
    operation_name: NotRequired["aws_sdk_api_gateway.types.string.String"]
    ...
    request_validator_id: NotRequired["aws_sdk_api_gateway.types.string.String"]
