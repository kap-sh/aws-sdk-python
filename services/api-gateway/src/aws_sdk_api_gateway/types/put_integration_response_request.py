"""Generated from Smithy shape ``com.amazonaws.apigateway#PutIntegrationResponseRequest``."""
...
class PutIntegrationResponseRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: PutIntegrationResponseRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> PutIntegrationResponseRequest:
    out: PutIntegrationResponseRequest = {}  # type: ignore[typeddict-item]
