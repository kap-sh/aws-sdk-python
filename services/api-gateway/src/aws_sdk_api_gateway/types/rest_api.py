...
class RestApi(TypedDict, closed=True):
    ...
    root_resource_id: NotRequired["aws_sdk_api_gateway.types.string.String"]
    ...
    api_status: NotRequired["aws_sdk_api_gateway.types.api_status.ApiStatus"]
    """<p>The ApiStatus of the RestApi. </p>"""
    api_status_message: NotRequired["aws_sdk_api_gateway.types.string.String"]
...
def serialize_json(value: RestApi) -> dict:
    ...
    if "api_status" in value:
        ...
        out["apiStatus"] = aws_sdk_api_gateway.types.api_status.serialize_json(
            value["api_status"]
        )
...
def deserialize_json(data: dict) -> RestApi:
    ...
    if "apiStatus" in data:
        ...
        out["api_status"] = aws_sdk_api_gateway.types.api_status.deserialize_json(
            data["apiStatus"]
        )
