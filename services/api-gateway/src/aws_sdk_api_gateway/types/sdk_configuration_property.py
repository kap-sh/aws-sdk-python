...
class SdkConfigurationProperty(TypedDict):
    ...
    required: "aws_sdk_api_gateway.types.boolean.Boolean"
    ...
    default_value: NotRequired["aws_sdk_api_gateway.types.string.String"]
