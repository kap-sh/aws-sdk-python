...
class SdkType(TypedDict):
    ...
    configuration_properties: NotRequired[
        "aws_sdk_api_gateway.types.list_of_sdk_configuration_property.ListOfSdkConfigurationProperty"
    ]
...
def serialize_json(value: SdkType) -> dict:
    ...
    if "configuration_properties" in value:
        ...
        out["configurationProperties"] = (
            aws_sdk_api_gateway.types.list_of_sdk_configuration_property.serialize_json(
...
def deserialize_json(data: dict) -> SdkType:
    ...
    if "configurationProperties" in data:
        ...
        out["configuration_properties"] = (
            aws_sdk_api_gateway.types.list_of_sdk_configuration_property.deserialize_json(
