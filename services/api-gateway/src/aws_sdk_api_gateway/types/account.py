...
class Account(TypedDict, closed=True):
    cloudwatch_role_arn: NotRequired["aws_sdk_api_gateway.types.string.String"]
...
def serialize_json(value: Account) -> dict:
    ...
    if "throttle_settings" in value:
        ...
        out["throttleSettings"] = (
            aws_sdk_api_gateway.types.throttle_settings.serialize_json(
    ...
    if "features" in value:
        ...
        out["features"] = aws_sdk_api_gateway.types.list_of_string.serialize_json(
            value["features"]
        )
...
def deserialize_json(data: dict) -> Account:
    ...
    if "throttleSettings" in data:
        ...
        out["throttle_settings"] = (
            aws_sdk_api_gateway.types.throttle_settings.deserialize_json(
    ...
    if "features" in data:
        ...
        out["features"] = aws_sdk_api_gateway.types.list_of_string.deserialize_json(
            data["features"]
        )
