"""Generated from Smithy shape ``com.amazonaws.apigateway#GetModelsRequest``."""
...
class GetModelsRequest(TypedDict):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetModelsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetModelsRequest:
