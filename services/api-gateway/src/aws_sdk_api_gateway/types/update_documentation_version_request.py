"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateDocumentationVersionRequest``."""
...
class UpdateDocumentationVersionRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateDocumentationVersionRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateDocumentationVersionRequest:
    out: UpdateDocumentationVersionRequest = {}  # type: ignore[typeddict-item]
