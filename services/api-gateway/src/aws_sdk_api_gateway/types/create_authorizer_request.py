"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateAuthorizerRequest``."""
...
class CreateAuthorizerRequest(TypedDict):
    ...
    provider_ar_ns: NotRequired["aws_sdk_api_gateway.types.list_of_ar_ns.ListOfARNs"]
    ...
    auth_type: NotRequired["aws_sdk_api_gateway.types.string.String"]
    """<p>Optional customer-defined field, used in OpenAPI imports and exports without functional impact.</p>"""
    authorizer_uri: NotRequired["aws_sdk_api_gateway.types.string.String"]
    ...
    authorizer_credentials: NotRequired["aws_sdk_api_gateway.types.string.String"]
    ...
    identity_source: NotRequired["aws_sdk_api_gateway.types.string.String"]
...
def serialize_json(value: CreateAuthorizerRequest) -> dict:
    ...
    out["type"] = aws_sdk_api_gateway.types.authorizer_type.serialize_json(
        value["type"]
    )
    if "provider_ar_ns" in value:
        import aws_sdk_api_gateway.types.list_of_ar_ns

        out["providerARNs"] = aws_sdk_api_gateway.types.list_of_ar_ns.serialize_json(
...
def deserialize_json(data: dict) -> CreateAuthorizerRequest:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_api_gateway.types.authorizer_type.deserialize_json(
            data["type"]
        )
    else:
    ...
    if "providerARNs" in data:
        ...
        out["provider_ar_ns"] = (
            aws_sdk_api_gateway.types.list_of_ar_ns.deserialize_json(
                data["providerARNs"]
            )
        )
    if "authType" in data:
