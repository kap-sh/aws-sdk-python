...
class Method(TypedDict, closed=True):
    ...
    method_responses: NotRequired[
        "aws_sdk_api_gateway.types.map_of_method_response.MapOfMethodResponse"
    ]
    """<p>Gets a method response associated with a given HTTP status code. </p>"""
    method_integration: NotRequired["aws_sdk_api_gateway.types.integration.Integration"]
...
def serialize_json(value: Method) -> dict:
    ...
    if "method_responses" in value:
        ...
        out["methodResponses"] = (
            aws_sdk_api_gateway.types.map_of_method_response.serialize_json(
    ...
    if "method_integration" in value:
        ...
        out["methodIntegration"] = aws_sdk_api_gateway.types.integration.serialize_json(
...
def deserialize_json(data: dict) -> Method:
    ...
    if "methodResponses" in data:
        ...
        out["method_responses"] = (
            aws_sdk_api_gateway.types.map_of_method_response.deserialize_json(
    ...
    if "methodIntegration" in data:
        ...
        out["method_integration"] = (
            aws_sdk_api_gateway.types.integration.deserialize_json(
