...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.usage_plans.UsagePlans = (
        aws_sdk_api_gateway.types.usage_plans.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.get_usage_plans_request.GetUsagePlansRequest,
) -> zapros.Request:
...
def get_usage_plans(
    ...
    input: aws_sdk_api_gateway.types.get_usage_plans_request.GetUsagePlansRequest,
) -> tuple[aws_sdk_api_gateway.types.usage_plans.UsagePlans, zapros.Response]:
