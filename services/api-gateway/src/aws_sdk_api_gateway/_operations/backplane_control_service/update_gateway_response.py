"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateGatewayResponse``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.gateway_response.GatewayResponse = (
        aws_sdk_api_gateway.types.gateway_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_gateway_response_request.UpdateGatewayResponseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{responseType}", quote(str(input_["response_type"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_api_gateway.types.update_gateway_response_request

    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_gateway_response_request.serialize_json(input_)
    ).encode()
...
def update_gateway_response(
    ...
    input_: aws_sdk_api_gateway.types.update_gateway_response_request.UpdateGatewayResponseRequest,
) -> tuple[aws_sdk_api_gateway.types.gateway_response.GatewayResponse, zapros.Response]:
...
async def async_update_gateway_response(
