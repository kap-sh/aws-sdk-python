"""Generated from Smithy shape ``com.amazonaws.apigateway#GetVpcLink``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_vpc_link_request.GetVpcLinkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
