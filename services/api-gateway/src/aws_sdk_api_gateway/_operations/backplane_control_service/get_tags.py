"""Generated from Smithy shape ``com.amazonaws.apigateway#GetTags``."""
...
def handle_response(response: zapros.Response) -> aws_sdk_api_gateway.types.tags.Tags:
    out: aws_sdk_api_gateway.types.tags.Tags = (
        aws_sdk_api_gateway.types.tags.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.tags.Tags = (
        aws_sdk_api_gateway.types.tags.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_tags_request.GetTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_tags(
    ...
    input_: aws_sdk_api_gateway.types.get_tags_request.GetTagsRequest,
) -> tuple[aws_sdk_api_gateway.types.tags.Tags, zapros.Response]:
