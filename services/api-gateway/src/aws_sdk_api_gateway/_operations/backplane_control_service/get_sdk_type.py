"""Generated from Smithy shape ``com.amazonaws.apigateway#GetSdkType``."""
...
import aws_sdk_api_gateway.types.list_of_sdk_configuration_property
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.sdk_type.SdkType = (
        aws_sdk_api_gateway.types.sdk_type.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.sdk_type.SdkType = (
        aws_sdk_api_gateway.types.sdk_type.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_sdk_type_request.GetSdkTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/sdktypes/{id}"
...
def get_sdk_type(
    ...
    input_: aws_sdk_api_gateway.types.get_sdk_type_request.GetSdkTypeRequest,
) -> tuple[aws_sdk_api_gateway.types.sdk_type.SdkType, zapros.Response]:
