"""Generated from Smithy shape ``com.amazonaws.apigateway#ImportApiKeys``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.api_key_ids.ApiKeyIds = (
        aws_sdk_api_gateway.types.api_key_ids.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.import_api_keys_request.ImportApiKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/apikeys?mode=import"
    params: dict[str, str] = {}
    if "format" in input_:
...
def import_api_keys(
    ...
    input_: aws_sdk_api_gateway.types.import_api_keys_request.ImportApiKeysRequest,
) -> tuple[aws_sdk_api_gateway.types.api_key_ids.ApiKeyIds, zapros.Response]:
...
async def async_import_api_keys(
