"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateMethodResponse``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.method_response.MethodResponse = (
        aws_sdk_api_gateway.types.method_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.update_method_response_request.UpdateMethodResponseRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_method_response_request.serialize_json(input)
    ).encode()
...
def update_method_response(
    ...
    input: aws_sdk_api_gateway.types.update_method_response_request.UpdateMethodResponseRequest,
) -> tuple[aws_sdk_api_gateway.types.method_response.MethodResponse, zapros.Response]:
...
async def async_update_method_response(
