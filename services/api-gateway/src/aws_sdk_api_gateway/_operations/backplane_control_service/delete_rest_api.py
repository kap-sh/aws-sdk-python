"""Generated from Smithy shape ``com.amazonaws.apigateway#DeleteRestApi``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.delete_rest_api_request.DeleteRestApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_rest_api(
