...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.create_usage_plan_key_request.CreateUsagePlanKeyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_usage_plan_key_request.serialize_json(input)
    ).encode()
