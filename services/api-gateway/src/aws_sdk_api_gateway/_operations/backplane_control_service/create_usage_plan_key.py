...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.create_usage_plan_key_request.CreateUsagePlanKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_usage_plan_key_request.serialize_json(input_)
    ).encode()
