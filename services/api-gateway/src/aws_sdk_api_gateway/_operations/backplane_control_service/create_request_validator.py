...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.create_request_validator_request.CreateRequestValidatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_request_validator_request.serialize_json(
            input_
        )
    ).encode()
