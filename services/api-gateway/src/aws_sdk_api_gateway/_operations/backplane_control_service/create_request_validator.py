"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateRequestValidator``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.request_validator.RequestValidator = (
        aws_sdk_api_gateway.types.request_validator.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.create_request_validator_request.CreateRequestValidatorRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/restapis/{restApiId}/requestvalidators"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_request_validator_request.serialize_json(input)
    ).encode()
...
async def async_create_request_validator(
