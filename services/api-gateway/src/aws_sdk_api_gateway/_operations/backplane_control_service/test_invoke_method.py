...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.test_invoke_method_request.TestInvokeMethodRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.test_invoke_method_request.serialize_json(input)
    ).encode()
