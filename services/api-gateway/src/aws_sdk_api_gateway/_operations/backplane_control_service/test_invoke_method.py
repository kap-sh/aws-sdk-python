...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.test_invoke_method_response.TestInvokeMethodResponse = aws_sdk_api_gateway.types.test_invoke_method_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.test_invoke_method_request.TestInvokeMethodRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.test_invoke_method_request.serialize_json(input_)
    ).encode()
