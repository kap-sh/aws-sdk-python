"""Generated from Smithy shape ``com.amazonaws.apigateway#GetAuthorizer``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_authorizer_request.GetAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_authorizer(
