"""Generated from Smithy shape ``com.amazonaws.apigateway#FlushStageAuthorizersCache``."""
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.flush_stage_authorizers_cache_request.FlushStageAuthorizersCacheRequest,
) -> zapros.Request:
...
async def async_flush_stage_authorizers_cache(
