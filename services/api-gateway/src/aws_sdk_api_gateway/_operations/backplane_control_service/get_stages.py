"""Generated from Smithy shape ``com.amazonaws.apigateway#GetStages``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.stages.Stages = (
        aws_sdk_api_gateway.types.stages.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.stages.Stages = (
        aws_sdk_api_gateway.types.stages.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_stages_request.GetStagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "deployment_id" in input_:
        params["deploymentId"] = str(input_["deployment_id"])
...
def get_stages(
    ...
    input_: aws_sdk_api_gateway.types.get_stages_request.GetStagesRequest,
) -> tuple[aws_sdk_api_gateway.types.stages.Stages, zapros.Response]:
