...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.create_documentation_version_request.CreateDocumentationVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_documentation_version_request.serialize_json(
            input_
        )
    ).encode()
