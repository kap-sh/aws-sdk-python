"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateStage``."""
...
def handle_response(response: zapros.Response) -> aws_sdk_api_gateway.types.stage.Stage:
    out: aws_sdk_api_gateway.types.stage.Stage = (
        aws_sdk_api_gateway.types.stage.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.stage.Stage = (
        aws_sdk_api_gateway.types.stage.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_stage_request.UpdateStageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/restapis/{restApiId}/stages/{stageName}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_stage_request.serialize_json(input_)
    ).encode()
...
def update_stage(
    ...
    input_: aws_sdk_api_gateway.types.update_stage_request.UpdateStageRequest,
) -> tuple[aws_sdk_api_gateway.types.stage.Stage, zapros.Response]:
