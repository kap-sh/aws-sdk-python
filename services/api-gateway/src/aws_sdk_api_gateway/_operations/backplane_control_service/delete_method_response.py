"""Generated from Smithy shape ``com.amazonaws.apigateway#DeleteMethodResponse``."""
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.delete_method_response_request.DeleteMethodResponseRequest,
) -> zapros.Request:
...
async def async_delete_method_response(
