"""Generated from Smithy shape ``com.amazonaws.apigateway#GetUsagePlanKey``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.usage_plan_key.UsagePlanKey = (
        aws_sdk_api_gateway.types.usage_plan_key.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_usage_plan_key_request.GetUsagePlanKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_usage_plan_key(
    ...
    input_: aws_sdk_api_gateway.types.get_usage_plan_key_request.GetUsagePlanKeyRequest,
) -> tuple[aws_sdk_api_gateway.types.usage_plan_key.UsagePlanKey, zapros.Response]:
...
async def async_get_usage_plan_key(
