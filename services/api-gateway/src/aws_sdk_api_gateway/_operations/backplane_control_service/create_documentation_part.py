...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.create_documentation_part_request.CreateDocumentationPartRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_documentation_part_request.serialize_json(
            input_
        )
    ).encode()
