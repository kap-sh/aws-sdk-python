"""Generated from Smithy shape ``com.amazonaws.apigateway#DeleteUsagePlan``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.delete_usage_plan_request.DeleteUsagePlanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/usageplans/{usagePlanId}"
...
async def async_delete_usage_plan(
