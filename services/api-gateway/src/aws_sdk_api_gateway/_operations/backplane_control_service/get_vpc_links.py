...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.vpc_links.VpcLinks = (
        aws_sdk_api_gateway.types.vpc_links.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_vpc_links_request.GetVpcLinksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_vpc_links(
    ...
    input_: aws_sdk_api_gateway.types.get_vpc_links_request.GetVpcLinksRequest,
) -> tuple[aws_sdk_api_gateway.types.vpc_links.VpcLinks, zapros.Response]:
