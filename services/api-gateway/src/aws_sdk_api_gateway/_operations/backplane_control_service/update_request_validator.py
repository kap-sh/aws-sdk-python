"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateRequestValidator``."""
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.update_request_validator_request.UpdateRequestValidatorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_request_validator_request.serialize_json(input)
    ).encode()
...
async def async_update_request_validator(
