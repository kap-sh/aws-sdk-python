"""Generated from Smithy shape ``com.amazonaws.apigateway#GetClientCertificates``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.client_certificates.ClientCertificates = (
        aws_sdk_api_gateway.types.client_certificates.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_client_certificates_request.GetClientCertificatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_client_certificates(
    ...
    aws_sdk_api_gateway.types.client_certificates.ClientCertificates, zapros.Response
]:
...
async def async_get_client_certificates(
