...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.create_usage_plan_request.CreateUsagePlanRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_usage_plan_request.serialize_json(input)
    ).encode()
