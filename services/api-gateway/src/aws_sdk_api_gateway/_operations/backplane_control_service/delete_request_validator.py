"""Generated from Smithy shape ``com.amazonaws.apigateway#DeleteRequestValidator``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.delete_request_validator_request.DeleteRequestValidatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_request_validator(
