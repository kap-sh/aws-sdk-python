"""Generated from Smithy shape ``com.amazonaws.apigateway#GetGatewayResponses``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.gateway_responses.GatewayResponses = (
        aws_sdk_api_gateway.types.gateway_responses.deserialize_json(
