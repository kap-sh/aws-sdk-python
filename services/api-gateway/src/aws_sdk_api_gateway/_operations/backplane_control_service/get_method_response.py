"""Generated from Smithy shape ``com.amazonaws.apigateway#GetMethodResponse``."""
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.get_method_response_request.GetMethodResponseRequest,
) -> zapros.Request:
...
async def async_get_method_response(
