"""Generated from Smithy shape ``com.amazonaws.apigateway#GetBasePathMapping``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.base_path_mapping.BasePathMapping = (
        aws_sdk_api_gateway.types.base_path_mapping.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.get_base_path_mapping_request.GetBasePathMappingRequest,
) -> zapros.Request:
    ...
    url = url.replace("{basePath}", quote(str(input["base_path"]), safe=""))
    params: dict[str, str] = {}
...
def get_base_path_mapping(
    ...
    aws_sdk_api_gateway.types.base_path_mapping.BasePathMapping, zapros.Response
]:
...
async def async_get_base_path_mapping(
