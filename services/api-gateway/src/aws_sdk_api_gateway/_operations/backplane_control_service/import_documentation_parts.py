"""Generated from Smithy shape ``com.amazonaws.apigateway#ImportDocumentationParts``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.documentation_part_ids.DocumentationPartIds = (
        aws_sdk_api_gateway.types.documentation_part_ids.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.import_documentation_parts_request.ImportDocumentationPartsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_import_documentation_parts(
