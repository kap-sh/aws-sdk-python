"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateDocumentationVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.documentation_version.DocumentationVersion = (
        aws_sdk_api_gateway.types.documentation_version.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_documentation_version_request.UpdateDocumentationVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_documentation_version_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_documentation_version(
