...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.update_integration_request.UpdateIntegrationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_integration_request.serialize_json(input)
    ).encode()
