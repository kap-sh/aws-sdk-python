...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.integration.Integration = (
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_integration_request.UpdateIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_integration_request.serialize_json(input_)
    ).encode()
...
def update_integration(
    ...
    input_: aws_sdk_api_gateway.types.update_integration_request.UpdateIntegrationRequest,
) -> tuple[aws_sdk_api_gateway.types.integration.Integration, zapros.Response]:
