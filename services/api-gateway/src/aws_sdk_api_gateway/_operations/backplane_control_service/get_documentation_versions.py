"""Generated from Smithy shape ``com.amazonaws.apigateway#GetDocumentationVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.documentation_versions.DocumentationVersions = (
        aws_sdk_api_gateway.types.documentation_versions.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_documentation_versions_request.GetDocumentationVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/restapis/{restApiId}/documentation/versions"
...
async def async_get_documentation_versions(
