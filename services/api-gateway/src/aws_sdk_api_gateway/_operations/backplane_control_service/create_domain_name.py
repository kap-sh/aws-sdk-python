"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateDomainName``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.create_domain_name_request.CreateDomainNameRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domainnames"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_api_gateway.types.create_domain_name_request

    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_domain_name_request.serialize_json(input_)
    ).encode()
