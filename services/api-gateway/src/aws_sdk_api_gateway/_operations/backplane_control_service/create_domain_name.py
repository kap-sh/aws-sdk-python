...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.create_domain_name_request.CreateDomainNameRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_domain_name_request.serialize_json(input)
    ).encode()
