...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.template.Template = (
        aws_sdk_api_gateway.types.template.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.template.Template = (
        aws_sdk_api_gateway.types.template.deserialize_json(
