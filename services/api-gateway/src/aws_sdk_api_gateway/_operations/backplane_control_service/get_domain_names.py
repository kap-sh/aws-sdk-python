...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.domain_names.DomainNames = (
        aws_sdk_api_gateway.types.domain_names.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_domain_names_request.GetDomainNamesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_domain_names(
    ...
    input_: aws_sdk_api_gateway.types.get_domain_names_request.GetDomainNamesRequest,
) -> tuple[aws_sdk_api_gateway.types.domain_names.DomainNames, zapros.Response]:
