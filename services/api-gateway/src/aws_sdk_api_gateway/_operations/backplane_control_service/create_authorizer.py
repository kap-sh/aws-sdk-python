"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateAuthorizer``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.authorizer.Authorizer = (
        aws_sdk_api_gateway.types.authorizer.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.create_authorizer_request.CreateAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/restapis/{restApiId}/authorizers"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_authorizer_request.serialize_json(input_)
    ).encode()
...
def create_authorizer(
    ...
    input_: aws_sdk_api_gateway.types.create_authorizer_request.CreateAuthorizerRequest,
) -> tuple[aws_sdk_api_gateway.types.authorizer.Authorizer, zapros.Response]:
