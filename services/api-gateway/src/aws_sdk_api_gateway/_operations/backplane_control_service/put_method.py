"""Generated from Smithy shape ``com.amazonaws.apigateway#PutMethod``."""
...
import aws_sdk_api_gateway.types.map_of_method_response
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.method.Method = (
        aws_sdk_api_gateway.types.method.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.method.Method = (
        aws_sdk_api_gateway.types.method.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.put_method_request.PutMethodRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.put_method_request.serialize_json(input_)
    ).encode()
...
def put_method(
    ...
    input_: aws_sdk_api_gateway.types.put_method_request.PutMethodRequest,
) -> tuple[aws_sdk_api_gateway.types.method.Method, zapros.Response]:
