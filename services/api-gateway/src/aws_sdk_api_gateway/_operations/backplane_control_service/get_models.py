...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.models.Models = (
        aws_sdk_api_gateway.types.models.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.models.Models = (
        aws_sdk_api_gateway.types.models.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_models_request.GetModelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_models(
    ...
    input_: aws_sdk_api_gateway.types.get_models_request.GetModelsRequest,
) -> tuple[aws_sdk_api_gateway.types.models.Models, zapros.Response]:
