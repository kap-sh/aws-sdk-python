"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateDomainName``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.domain_name.DomainName = (
        aws_sdk_api_gateway.types.domain_name.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.update_domain_name_request.UpdateDomainNameRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/domainnames/{domainName}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_domain_name_request.serialize_json(input)
    ).encode()
...
def update_domain_name(
    ...
    input: aws_sdk_api_gateway.types.update_domain_name_request.UpdateDomainNameRequest,
) -> tuple[aws_sdk_api_gateway.types.domain_name.DomainName, zapros.Response]:
