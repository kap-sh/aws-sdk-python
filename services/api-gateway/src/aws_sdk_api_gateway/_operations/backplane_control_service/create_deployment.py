"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateDeployment``."""
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.create_deployment_request.CreateDeploymentRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/restapis/{restApiId}/deployments"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_deployment_request.serialize_json(input)
    ).encode()
