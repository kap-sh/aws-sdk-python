...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.deployments.Deployments = (
        aws_sdk_api_gateway.types.deployments.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_deployments_request.GetDeploymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_deployments(
    ...
    input_: aws_sdk_api_gateway.types.get_deployments_request.GetDeploymentsRequest,
) -> tuple[aws_sdk_api_gateway.types.deployments.Deployments, zapros.Response]:
