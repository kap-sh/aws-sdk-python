"""Generated from Smithy shape ``com.amazonaws.apigateway#DeleteAuthorizer``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.delete_authorizer_request.DeleteAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
