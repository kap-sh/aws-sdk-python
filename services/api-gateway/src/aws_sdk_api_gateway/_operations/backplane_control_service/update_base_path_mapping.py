...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_base_path_mapping_request.UpdateBasePathMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_base_path_mapping_request.serialize_json(
            input_
        )
    ).encode()
