...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.update_base_path_mapping_request.UpdateBasePathMappingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_base_path_mapping_request.serialize_json(input)
    ).encode()
