"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateApiKey``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.api_key.ApiKey = (
        aws_sdk_api_gateway.types.api_key.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.api_key.ApiKey = (
        aws_sdk_api_gateway.types.api_key.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.create_api_key_request.CreateApiKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/apikeys"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_api_key_request.serialize_json(input_)
    ).encode()
...
def create_api_key(
    ...
    input_: aws_sdk_api_gateway.types.create_api_key_request.CreateApiKeyRequest,
) -> tuple[aws_sdk_api_gateway.types.api_key.ApiKey, zapros.Response]:
