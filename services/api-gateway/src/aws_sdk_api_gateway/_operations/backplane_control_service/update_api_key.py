"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateApiKey``."""
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.update_api_key_request.UpdateApiKeyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_api_key_request.serialize_json(input)
    ).encode()
