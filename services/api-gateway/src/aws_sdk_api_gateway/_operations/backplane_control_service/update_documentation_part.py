"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateDocumentationPart``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.documentation_part.DocumentationPart = (
        aws_sdk_api_gateway.types.documentation_part.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_documentation_part_request.UpdateDocumentationPartRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{documentationPartId}", quote(str(input_["documentation_part_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_documentation_part_request.serialize_json(
            input_
        )
    ).encode()
...
def update_documentation_part(
    ...
    aws_sdk_api_gateway.types.documentation_part.DocumentationPart, zapros.Response
]:
...
async def async_update_documentation_part(
