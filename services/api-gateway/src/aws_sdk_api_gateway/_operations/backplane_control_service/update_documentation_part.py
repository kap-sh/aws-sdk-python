...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.update_documentation_part_request.UpdateDocumentationPartRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{documentationPartId}", quote(str(input["documentation_part_id"]), safe="")
    )
    params: dict[str, str] = {}
