...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.usage_plan.UsagePlan = (
        aws_sdk_api_gateway.types.usage_plan.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_usage_plan_request.UpdateUsagePlanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_usage_plan_request.serialize_json(input_)
    ).encode()
...
def update_usage_plan(
    ...
    input_: aws_sdk_api_gateway.types.update_usage_plan_request.UpdateUsagePlanRequest,
) -> tuple[aws_sdk_api_gateway.types.usage_plan.UsagePlan, zapros.Response]:
