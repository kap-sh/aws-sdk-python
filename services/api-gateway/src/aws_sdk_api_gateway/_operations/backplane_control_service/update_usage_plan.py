...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.update_usage_plan_request.UpdateUsagePlanRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_usage_plan_request.serialize_json(input)
    ).encode()
