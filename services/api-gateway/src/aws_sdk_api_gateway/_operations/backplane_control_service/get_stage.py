"""Generated from Smithy shape ``com.amazonaws.apigateway#GetStage``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_stage_request.GetStageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
