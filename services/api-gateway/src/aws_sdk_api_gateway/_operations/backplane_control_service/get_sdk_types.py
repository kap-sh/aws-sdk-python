...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.sdk_types.SdkTypes = (
        aws_sdk_api_gateway.types.sdk_types.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_sdk_types_request.GetSdkTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_sdk_types(
    ...
    input_: aws_sdk_api_gateway.types.get_sdk_types_request.GetSdkTypesRequest,
) -> tuple[aws_sdk_api_gateway.types.sdk_types.SdkTypes, zapros.Response]:
