...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.get_api_key_request.GetApiKeyRequest,
) -> zapros.Request:
    ...
    url = url.replace("{apiKey}", quote(str(input["api_key"]), safe=""))
    params: dict[str, str] = {}
    if "include_value" in input:
        params["includeValue"] = str(input["include_value"])
