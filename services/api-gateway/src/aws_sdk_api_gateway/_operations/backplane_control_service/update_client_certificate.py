"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateClientCertificate``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.client_certificate.ClientCertificate = (
        aws_sdk_api_gateway.types.client_certificate.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_client_certificate_request.UpdateClientCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/clientcertificates/{clientCertificateId}"
    url = url.replace(
        "{clientCertificateId}", quote(str(input_["client_certificate_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_client_certificate_request.serialize_json(
            input_
        )
    ).encode()
...
def update_client_certificate(
    ...
    aws_sdk_api_gateway.types.client_certificate.ClientCertificate, zapros.Response
]:
...
async def async_update_client_certificate(
