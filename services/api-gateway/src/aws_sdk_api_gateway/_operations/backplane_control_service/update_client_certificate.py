...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.update_client_certificate_request.UpdateClientCertificateRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{clientCertificateId}", quote(str(input["client_certificate_id"]), safe="")
    )
    params: dict[str, str] = {}
