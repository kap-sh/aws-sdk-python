"""Generated from Smithy shape ``com.amazonaws.apigateway#RejectDomainNameAccessAssociation``."""
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.reject_domain_name_access_association_request.RejectDomainNameAccessAssociationRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/rejectdomainnameaccessassociations"
    params: dict[str, str] = {}
    if "domain_name_access_association_arn" in input:
        params["domainNameAccessAssociationArn"] = str(
            input["domain_name_access_association_arn"]
        )
    if "domain_name_arn" in input:
        params["domainNameArn"] = str(input["domain_name_arn"])
...
async def async_reject_domain_name_access_association(
