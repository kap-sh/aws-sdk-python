...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.reject_domain_name_access_association_request.RejectDomainNameAccessAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "domain_name_access_association_arn" in input_:
        params["domainNameAccessAssociationArn"] = str(
            input_["domain_name_access_association_arn"]
        )
    if "domain_name_arn" in input_:
        params["domainNameArn"] = str(input_["domain_name_arn"])
