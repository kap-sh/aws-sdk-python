...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.create_resource_request.CreateResourceRequest,
) -> zapros.Request:
    ...
    url = url.replace("{parentId}", quote(str(input["parent_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_api_gateway.types.create_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_resource_request.serialize_json(input)
    ).encode()
