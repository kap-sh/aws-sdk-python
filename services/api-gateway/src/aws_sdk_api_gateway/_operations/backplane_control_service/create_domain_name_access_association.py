"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateDomainNameAccessAssociation``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.domain_name_access_association.DomainNameAccessAssociation = aws_sdk_api_gateway.types.domain_name_access_association.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.create_domain_name_access_association_request.CreateDomainNameAccessAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_domain_name_access_association_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_domain_name_access_association(
