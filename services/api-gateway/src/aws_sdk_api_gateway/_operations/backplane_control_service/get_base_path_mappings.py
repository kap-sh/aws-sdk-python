"""Generated from Smithy shape ``com.amazonaws.apigateway#GetBasePathMappings``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.base_path_mappings.BasePathMappings = (
        aws_sdk_api_gateway.types.base_path_mappings.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.get_base_path_mappings_request.GetBasePathMappingsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/domainnames/{domainName}/basepathmappings"
    url = url.replace("{domainName}", quote(str(input["domain_name"]), safe=""))
    params: dict[str, str] = {}
    if "domain_name_id" in input:
        params["domainNameId"] = str(input["domain_name_id"])
...
def get_base_path_mappings(
    ...
    aws_sdk_api_gateway.types.base_path_mappings.BasePathMappings, zapros.Response
]:
...
async def async_get_base_path_mappings(
