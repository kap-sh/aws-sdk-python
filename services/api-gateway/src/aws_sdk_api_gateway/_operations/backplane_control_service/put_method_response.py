...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.put_method_response_request.PutMethodResponseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.put_method_response_request.serialize_json(input_)
    ).encode()
