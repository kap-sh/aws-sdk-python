...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.put_method_response_request.PutMethodResponseRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.put_method_response_request.serialize_json(input)
    ).encode()
