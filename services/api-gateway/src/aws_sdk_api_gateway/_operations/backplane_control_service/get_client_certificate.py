"""Generated from Smithy shape ``com.amazonaws.apigateway#GetClientCertificate``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_client_certificate_request.GetClientCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_client_certificate(
