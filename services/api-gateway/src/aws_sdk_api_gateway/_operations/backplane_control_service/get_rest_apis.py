"""Generated from Smithy shape ``com.amazonaws.apigateway#GetRestApis``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.rest_apis.RestApis = (
        aws_sdk_api_gateway.types.rest_apis.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_rest_apis_request.GetRestApisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_rest_apis(
    ...
    input_: aws_sdk_api_gateway.types.get_rest_apis_request.GetRestApisRequest,
) -> tuple[aws_sdk_api_gateway.types.rest_apis.RestApis, zapros.Response]:
