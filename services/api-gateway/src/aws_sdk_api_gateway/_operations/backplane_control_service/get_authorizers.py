...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.authorizers.Authorizers = (
        aws_sdk_api_gateway.types.authorizers.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_authorizers_request.GetAuthorizersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_authorizers(
    ...
    input_: aws_sdk_api_gateway.types.get_authorizers_request.GetAuthorizersRequest,
) -> tuple[aws_sdk_api_gateway.types.authorizers.Authorizers, zapros.Response]:
