"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateRestApi``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.create_rest_api_request.CreateRestApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/restapis"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_rest_api_request.serialize_json(input_)
    ).encode()
...
async def async_create_rest_api(
