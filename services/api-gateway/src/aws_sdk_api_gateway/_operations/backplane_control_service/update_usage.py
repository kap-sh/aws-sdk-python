...
def handle_response(response: zapros.Response) -> aws_sdk_api_gateway.types.usage.Usage:
    out: aws_sdk_api_gateway.types.usage.Usage = (
        aws_sdk_api_gateway.types.usage.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.usage.Usage = (
        aws_sdk_api_gateway.types.usage.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_usage_request.UpdateUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_usage_request.serialize_json(input_)
    ).encode()
...
def update_usage(
    ...
    input_: aws_sdk_api_gateway.types.update_usage_request.UpdateUsageRequest,
) -> tuple[aws_sdk_api_gateway.types.usage.Usage, zapros.Response]:
