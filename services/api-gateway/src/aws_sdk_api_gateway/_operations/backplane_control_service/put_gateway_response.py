...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.put_gateway_response_request.PutGatewayResponseRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.put_gateway_response_request.serialize_json(input)
    ).encode()
