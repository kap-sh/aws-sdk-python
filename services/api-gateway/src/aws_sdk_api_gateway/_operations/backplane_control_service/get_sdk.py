"""Generated from Smithy shape ``com.amazonaws.apigateway#GetSdk``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.sdk_response.SdkResponse = {
        "body": aws_sdk_api_gateway.types.blob.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.get_sdk_request.GetSdkRequest,
) -> zapros.Request:
    ...
    url = url.replace("{stageName}", quote(str(input["stage_name"]), safe=""))
    url = url.replace("{sdkType}", quote(str(input["sdk_type"]), safe=""))
    params: dict[str, str] = {}
...
def get_sdk(
    ...
    input: aws_sdk_api_gateway.types.get_sdk_request.GetSdkRequest,
) -> tuple[aws_sdk_api_gateway.types.sdk_response.SdkResponse, zapros.Response]:
