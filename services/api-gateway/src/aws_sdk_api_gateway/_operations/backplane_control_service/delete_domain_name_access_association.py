...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.delete_domain_name_access_association_request.DeleteDomainNameAccessAssociationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["domain_name_access_association_arn"]), safe=""),
    )
    params: dict[str, str] = {}
