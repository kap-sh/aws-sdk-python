...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.delete_domain_name_access_association_request.DeleteDomainNameAccessAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["domain_name_access_association_arn"]), safe=""),
    )
    params: dict[str, str] = {}
