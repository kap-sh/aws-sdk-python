"""Generated from Smithy shape ``com.amazonaws.apigateway#DeleteIntegrationResponse``."""
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.delete_integration_response_request.DeleteIntegrationResponseRequest,
) -> zapros.Request:
...
async def async_delete_integration_response(
