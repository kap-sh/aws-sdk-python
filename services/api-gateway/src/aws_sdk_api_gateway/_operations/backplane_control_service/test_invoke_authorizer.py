...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.test_invoke_authorizer_request.TestInvokeAuthorizerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.test_invoke_authorizer_request.serialize_json(input)
    ).encode()
