"""Generated from Smithy shape ``com.amazonaws.apigateway#TestInvokeAuthorizer``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.test_invoke_authorizer_response.TestInvokeAuthorizerResponse = aws_sdk_api_gateway.types.test_invoke_authorizer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.test_invoke_authorizer_request.TestInvokeAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/restapis/{restApiId}/authorizers/{authorizerId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.test_invoke_authorizer_request.serialize_json(input_)
    ).encode()
...
async def async_test_invoke_authorizer(
