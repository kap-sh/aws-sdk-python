...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.api_keys.ApiKeys = (
        aws_sdk_api_gateway.types.api_keys.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.api_keys.ApiKeys = (
        aws_sdk_api_gateway.types.api_keys.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_api_keys_request.GetApiKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "customer_id" in input_:
        params["customerId"] = str(input_["customer_id"])
    if "include_values" in input_:
        params["includeValues"] = str(input_["include_values"])
...
def get_api_keys(
    ...
    input_: aws_sdk_api_gateway.types.get_api_keys_request.GetApiKeysRequest,
) -> tuple[aws_sdk_api_gateway.types.api_keys.ApiKeys, zapros.Response]:
