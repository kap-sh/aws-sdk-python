...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.get_api_keys_request.GetApiKeysRequest,
) -> zapros.Request:
    ...
    if "customer_id" in input:
        params["customerId"] = str(input["customer_id"])
    if "include_values" in input:
        params["includeValues"] = str(input["include_values"])
