"""Generated from Smithy shape ``com.amazonaws.apigateway#DeleteBasePathMapping``."""
...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.delete_base_path_mapping_request.DeleteBasePathMappingRequest,
) -> zapros.Request:
...
async def async_delete_base_path_mapping(
