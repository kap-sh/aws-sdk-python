"""Generated from Smithy shape ``com.amazonaws.apigateway#GetModel``."""
...
def handle_response(response: zapros.Response) -> aws_sdk_api_gateway.types.model.Model:
    out: aws_sdk_api_gateway.types.model.Model = (
        aws_sdk_api_gateway.types.model.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.model.Model = (
        aws_sdk_api_gateway.types.model.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_model_request.GetModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_model(
    ...
    input_: aws_sdk_api_gateway.types.get_model_request.GetModelRequest,
) -> tuple[aws_sdk_api_gateway.types.model.Model, zapros.Response]:
