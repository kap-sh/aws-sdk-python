"""Generated from Smithy shape ``com.amazonaws.apigateway#DeleteDeployment``."""
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.delete_deployment_request.DeleteDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
