"""Generated from Smithy shape ``com.amazonaws.apigateway#GetResources``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.resources.Resources = (
        aws_sdk_api_gateway.types.resources.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_resources_request.GetResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/restapis/{restApiId}/resources"
...
def get_resources(
    ...
    input_: aws_sdk_api_gateway.types.get_resources_request.GetResourcesRequest,
) -> tuple[aws_sdk_api_gateway.types.resources.Resources, zapros.Response]:
