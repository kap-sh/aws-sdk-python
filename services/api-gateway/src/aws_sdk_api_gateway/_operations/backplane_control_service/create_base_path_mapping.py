...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.create_base_path_mapping_request.CreateBasePathMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_base_path_mapping_request.serialize_json(
            input_
        )
    ).encode()
