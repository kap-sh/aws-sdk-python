...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.create_base_path_mapping_request.CreateBasePathMappingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.create_base_path_mapping_request.serialize_json(input)
    ).encode()
