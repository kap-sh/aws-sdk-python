...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.request_validators.RequestValidators = (
        aws_sdk_api_gateway.types.request_validators.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_request_validators_request.GetRequestValidatorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_request_validators(
    ...
    aws_sdk_api_gateway.types.request_validators.RequestValidators, zapros.Response
]:
