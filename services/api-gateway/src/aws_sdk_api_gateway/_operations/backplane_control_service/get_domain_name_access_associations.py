...
def build_request(
    ...
    input: aws_sdk_api_gateway.types.get_domain_name_access_associations_request.GetDomainNameAccessAssociationsRequest,
) -> zapros.Request:
    ...
    if "resource_owner" in input:
        params["resourceOwner"] = str(input["resource_owner"])
