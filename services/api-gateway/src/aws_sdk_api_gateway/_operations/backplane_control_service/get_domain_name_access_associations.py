"""Generated from Smithy shape ``com.amazonaws.apigateway#GetDomainNameAccessAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.domain_name_access_associations.DomainNameAccessAssociations = aws_sdk_api_gateway.types.domain_name_access_associations.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.get_domain_name_access_associations_request.GetDomainNameAccessAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domainnameaccessassociations"
    params: dict[str, str] = {}
    if "position" in input_:
        params["position"] = str(input_["position"])
    if "limit" in input_:
        params["limit"] = str(input_["limit"])
    if "resource_owner" in input_:
        params["resourceOwner"] = str(input_["resource_owner"])
...
async def async_get_domain_name_access_associations(
