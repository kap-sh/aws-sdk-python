"""Generated from Smithy shape ``com.amazonaws.apigateway#UpdateAccount``."""
...
def handle_response(
    ...
    out: aws_sdk_api_gateway.types.account.Account = (
        aws_sdk_api_gateway.types.account.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_api_gateway.types.account.Account = (
        aws_sdk_api_gateway.types.account.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_account_request.UpdateAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/account"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_api_gateway.types.update_account_request.serialize_json(input_)
    ).encode()
...
def update_account(
    ...
    input_: aws_sdk_api_gateway.types.update_account_request.UpdateAccountRequest,
) -> tuple[aws_sdk_api_gateway.types.account.Account, zapros.Response]:
