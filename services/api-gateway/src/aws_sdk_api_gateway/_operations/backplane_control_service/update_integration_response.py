...
def build_request(
    ...
    input_: aws_sdk_api_gateway.types.update_integration_response_request.UpdateIntegrationResponseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{httpMethod}", quote(str(input_["http_method"]), safe=""))
