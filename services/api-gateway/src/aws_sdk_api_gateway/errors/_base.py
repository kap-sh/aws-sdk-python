...
class APIGatewayError(Exception):
    """Base class for all APIGateway service errors."""


class ServiceError(APIGatewayError):
...
class SerializationError(APIGatewayError):
    """Raised when a value cannot be serialized."""


class DeserializationError(APIGatewayError):
...
class WaiterFailedError(APIGatewayError):
...
class WaiterTimeoutError(APIGatewayError):
