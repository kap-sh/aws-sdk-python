...
```
pip install aws-sdk-resource-groups-tagging-api
```

## Usage

```python
from aws_sdk_resource_groups_tagging_api import AsyncResourceGroupsTaggingAPIClient
...
```python
from aws_sdk_resource_groups_tagging_api import AsyncResourceGroupsTaggingAPIClient
from aws_sdk_resource_groups_tagging_api.error import ConstraintViolationException
