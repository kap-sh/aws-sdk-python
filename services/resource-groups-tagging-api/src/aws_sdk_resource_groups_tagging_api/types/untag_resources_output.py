...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UntagResourcesOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UntagResourcesOutput:
    out: UntagResourcesOutput = {}  # type: ignore[typeddict-item]
