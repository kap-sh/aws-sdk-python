...
if TYPE_CHECKING:
    import aws_sdk_resource_groups_tagging_api.types.cloud_formation_resource_type

CloudFormationResourceTypes: TypeAlias = list[
    "aws_sdk_resource_groups_tagging_api.types.cloud_formation_resource_type.CloudFormationResourceType"
]
