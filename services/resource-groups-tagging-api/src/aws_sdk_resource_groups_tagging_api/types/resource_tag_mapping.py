...
class ResourceTagMapping(TypedDict, closed=True):
    ...
    tags: NotRequired["aws_sdk_resource_groups_tagging_api.types.tag_list.TagList"]
    """<p>The tags that have been applied to one or more Amazon Web Services resources.</p>"""
    compliance_details: NotRequired[
        "aws_sdk_resource_groups_tagging_api.types.compliance_details.ComplianceDetails"
    ]
...
def serialize_aws_json_1_1(value: ResourceTagMapping) -> dict:
    ...
    if "tags" in value:
        ...
        out["Tags"] = (
            aws_sdk_resource_groups_tagging_api.types.tag_list.serialize_aws_json_1_1(
                value["tags"]
            )
        )
    if "compliance_details" in value:
        ...
        out["ComplianceDetails"] = (
            aws_sdk_resource_groups_tagging_api.types.compliance_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ResourceTagMapping:
    ...
    if "Tags" in data:
        ...
        out["tags"] = (
            aws_sdk_resource_groups_tagging_api.types.tag_list.deserialize_aws_json_1_1(
                data["Tags"]
            )
        )
    if "ComplianceDetails" in data:
        ...
        out["compliance_details"] = (
            aws_sdk_resource_groups_tagging_api.types.compliance_details.deserialize_aws_json_1_1(
