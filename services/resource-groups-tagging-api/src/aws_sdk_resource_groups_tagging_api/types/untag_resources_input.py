...
def serialize_aws_json_1_1(value: UntagResourcesInput) -> dict:
    ...
    out["TagKeys"] = (
        aws_sdk_resource_groups_tagging_api.types.tag_key_list_for_untag.serialize_aws_json_1_1(
            value["tag_keys"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UntagResourcesInput:
    ...
    if "TagKeys" in data:
        ...
        out["tag_keys"] = (
            aws_sdk_resource_groups_tagging_api.types.tag_key_list_for_untag.deserialize_aws_json_1_1(
                data["TagKeys"]
            )
        )
    else:
