...
class GetResourcesInput(TypedDict):
...
def serialize_aws_json_1_1(value: GetResourcesInput) -> dict:
    ...
    if "tag_filters" in value:
        ...
        out["TagFilters"] = (
            aws_sdk_resource_groups_tagging_api.types.tag_filter_list.serialize_aws_json_1_1(
                value["tag_filters"]
            )
        )
    ...
    if "resource_arn_list" in value:
        ...
        out["ResourceARNList"] = (
            aws_sdk_resource_groups_tagging_api.types.resource_arn_list_for_get.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetResourcesInput:
    ...
    if "TagFilters" in data:
        ...
        out["tag_filters"] = (
            aws_sdk_resource_groups_tagging_api.types.tag_filter_list.deserialize_aws_json_1_1(
                data["TagFilters"]
            )
        )
    ...
    if "ResourceARNList" in data:
        ...
        out["resource_arn_list"] = (
            aws_sdk_resource_groups_tagging_api.types.resource_arn_list_for_get.deserialize_aws_json_1_1(
