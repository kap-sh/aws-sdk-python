...
def handle_response(
    ...
    out: aws_sdk_resource_groups_tagging_api.types.get_tag_values_output.GetTagValuesOutput = aws_sdk_resource_groups_tagging_api.types.get_tag_values_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups_tagging_api.types.get_tag_values_input.GetTagValuesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups_tagging_api.types.get_tag_values_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
