...
def handle_response(
    ...
    out: aws_sdk_resource_groups_tagging_api.types.get_tag_keys_output.GetTagKeysOutput = aws_sdk_resource_groups_tagging_api.types.get_tag_keys_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups_tagging_api.types.get_tag_keys_input.GetTagKeysInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups_tagging_api.types.get_tag_keys_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
