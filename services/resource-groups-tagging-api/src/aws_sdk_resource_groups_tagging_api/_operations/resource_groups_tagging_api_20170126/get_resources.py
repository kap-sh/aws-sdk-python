"""Generated from Smithy shape ``com.amazonaws.resourcegroupstaggingapi#GetResources``."""
...
def handle_response(
    ...
    out: aws_sdk_resource_groups_tagging_api.types.get_resources_output.GetResourcesOutput = aws_sdk_resource_groups_tagging_api.types.get_resources_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups_tagging_api.types.get_resources_input.GetResourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetResources"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups_tagging_api.types.get_resources_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
