...
def handle_response(
    ...
    out: aws_sdk_resource_groups_tagging_api.types.describe_report_creation_output.DescribeReportCreationOutput = aws_sdk_resource_groups_tagging_api.types.describe_report_creation_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups_tagging_api.types.describe_report_creation_input.DescribeReportCreationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
