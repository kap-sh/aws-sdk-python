...
def build_request(
    ...
    input_: aws_sdk_resource_groups_tagging_api.types.get_compliance_summary_input.GetComplianceSummaryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups_tagging_api.types.get_compliance_summary_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
