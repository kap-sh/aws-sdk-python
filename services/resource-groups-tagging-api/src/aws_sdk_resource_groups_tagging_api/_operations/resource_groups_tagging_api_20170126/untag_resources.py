...
def handle_response(
    ...
    out: aws_sdk_resource_groups_tagging_api.types.untag_resources_output.UntagResourcesOutput = aws_sdk_resource_groups_tagging_api.types.untag_resources_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups_tagging_api.types.untag_resources_input.UntagResourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups_tagging_api.types.untag_resources_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
