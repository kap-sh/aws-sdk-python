...
def handle_response(
    ...
    out: aws_sdk_resource_groups_tagging_api.types.tag_resources_output.TagResourcesOutput = aws_sdk_resource_groups_tagging_api.types.tag_resources_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups_tagging_api.types.tag_resources_input.TagResourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups_tagging_api.types.tag_resources_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
