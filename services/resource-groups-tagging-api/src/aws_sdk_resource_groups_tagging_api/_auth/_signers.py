...
from aws_sdk_resource_groups_tagging_api._auth._identity import Credentials, Identity
from aws_sdk_resource_groups_tagging_api._auth._providers import IdentityProvider
