...
from capo_resource_groups_tagging_api._auth._identity import (
    Credentials,
    Identity,
)
...
# they need the `sso` extra: `pip install capo-resource-groups-tagging-api[sso]`. Without it the imports
...
def require_dependency(module: object | None, package: str) -> None:
    if module is None:
        raise MissingDependencyError(
            ...
            "installed; reinstall with the sso feature enabled: capo-resource-groups-tagging-api[sso]"
        )
