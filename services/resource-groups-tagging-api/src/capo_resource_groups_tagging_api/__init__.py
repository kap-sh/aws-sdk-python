...
from ._services.async_resource_groups_tagging_api import (
    AsyncResourceGroupsTaggingAPIClient as AsyncResourceGroupsTaggingAPIClient,
)
from ._services.resource_groups_tagging_api import (
    ResourceGroupsTaggingAPIClient as ResourceGroupsTaggingAPIClient,
)
