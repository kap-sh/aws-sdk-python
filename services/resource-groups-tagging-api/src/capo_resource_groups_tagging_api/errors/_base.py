...
class ResourceGroupsTaggingAPIError(Exception):
    """Base class for all ResourceGroupsTaggingAPI service errors."""


class ServiceError(ResourceGroupsTaggingAPIError):
...
class SerializationError(ResourceGroupsTaggingAPIError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ResourceGroupsTaggingAPIError):
...
class WaiterFailedError(ResourceGroupsTaggingAPIError):
...
class WaiterTimeoutError(ResourceGroupsTaggingAPIError):
