...
class ListSchemaVersionsResponse(TypedDict, closed=True):
    ...
    schema_versions: NotRequired[
        "capo_schemas.types.__list_of_schema_version_summary.__listOfSchemaVersionSummary"
    ]
...
def serialize_json(value: ListSchemaVersionsResponse) -> dict:
    ...
    if "schema_versions" in value:
        ...
        out["SchemaVersions"] = (
            capo_schemas.types.__list_of_schema_version_summary.serialize_json(
...
def deserialize_json(data: dict) -> ListSchemaVersionsResponse:
    ...
    if "SchemaVersions" in data:
        ...
        out["schema_versions"] = (
            capo_schemas.types.__list_of_schema_version_summary.deserialize_json(
                data["SchemaVersions"]
            )
        )
    return out
