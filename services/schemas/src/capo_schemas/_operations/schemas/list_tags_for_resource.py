...
def handle_response(
    ...
    out: capo_schemas.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_schemas.types.list_tags_for_resource_response.deserialize_json(
