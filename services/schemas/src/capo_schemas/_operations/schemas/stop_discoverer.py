"""Generated from Smithy shape ``com.amazonaws.schemas#StopDiscoverer``."""
...
def handle_response(
    ...
    out: capo_schemas.types.stop_discoverer_response.StopDiscovererResponse = (
        capo_schemas.types.stop_discoverer_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/discoverers/id/{DiscovererId}/stop"
...
def stop_discoverer(
    ...
    capo_schemas.types.stop_discoverer_response.StopDiscovererResponse, zapros.Response
]:
...
async def async_stop_discoverer(
