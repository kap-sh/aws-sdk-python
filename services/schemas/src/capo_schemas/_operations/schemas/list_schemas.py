"""Generated from Smithy shape ``com.amazonaws.schemas#ListSchemas``."""
...
import capo_schemas.types.__list_of_schema_summary
...
def handle_response(
    ...
    out: capo_schemas.types.list_schemas_response.ListSchemasResponse = (
        capo_schemas.types.list_schemas_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/registries/name/{RegistryName}/schemas"
    ...
    if "schema_name_prefix" in input_:
        params["schemaNamePrefix"] = str(input_["schema_name_prefix"])
...
def list_schemas(
    ...
    capo_schemas.types.list_schemas_response.ListSchemasResponse, zapros.Response
]:
