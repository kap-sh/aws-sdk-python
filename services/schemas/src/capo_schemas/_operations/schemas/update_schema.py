...
def handle_response(
    ...
    out: capo_schemas.types.update_schema_response.UpdateSchemaResponse = (
        capo_schemas.types.update_schema_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_schemas.types.update_schema_request.serialize_json(input_)
    ).encode()
...
def update_schema(
    ...
    capo_schemas.types.update_schema_response.UpdateSchemaResponse, zapros.Response
]:
