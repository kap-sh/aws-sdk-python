...
def handle_response(
    ...
    out: capo_schemas.types.search_schemas_response.SearchSchemasResponse = (
        capo_schemas.types.search_schemas_response.deserialize_json(
...
def search_schemas(
    ...
    capo_schemas.types.search_schemas_response.SearchSchemasResponse, zapros.Response
]:
