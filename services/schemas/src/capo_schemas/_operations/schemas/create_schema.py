...
def handle_response(
    ...
    out: capo_schemas.types.create_schema_response.CreateSchemaResponse = (
        capo_schemas.types.create_schema_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_schemas.types.create_schema_request.serialize_json(input_)
    ).encode()
...
def create_schema(
    ...
    capo_schemas.types.create_schema_response.CreateSchemaResponse, zapros.Response
]:
