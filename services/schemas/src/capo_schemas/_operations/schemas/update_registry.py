"""Generated from Smithy shape ``com.amazonaws.schemas#UpdateRegistry``."""
...
def handle_response(
    ...
    out: capo_schemas.types.update_registry_response.UpdateRegistryResponse = (
        capo_schemas.types.update_registry_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_schemas.types.update_registry_request.serialize_json(input_)
    ).encode()
...
def update_registry(
    ...
    capo_schemas.types.update_registry_response.UpdateRegistryResponse, zapros.Response
]:
