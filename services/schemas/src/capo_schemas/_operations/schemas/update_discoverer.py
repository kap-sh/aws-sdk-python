...
def handle_response(
    ...
    out: capo_schemas.types.update_discoverer_response.UpdateDiscovererResponse = (
        capo_schemas.types.update_discoverer_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_schemas.types.update_discoverer_request.serialize_json(input_)
    ).encode()
