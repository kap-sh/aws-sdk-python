...
import capo_schemas.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_schemas.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_schemas.types.create_discoverer_response.CreateDiscovererResponse = (
        capo_schemas.types.create_discoverer_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_schemas.types.create_discoverer_request.serialize_json(input_)
    ).encode()
