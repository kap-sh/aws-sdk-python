"""Generated from Smithy shape ``com.amazonaws.schemas#StartDiscoverer``."""
...
def handle_response(
    ...
    out: capo_schemas.types.start_discoverer_response.StartDiscovererResponse = (
        capo_schemas.types.start_discoverer_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/discoverers/id/{DiscovererId}/start"
...
async def async_start_discoverer(
