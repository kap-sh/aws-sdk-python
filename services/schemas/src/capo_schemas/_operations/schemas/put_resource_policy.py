"""Generated from Smithy shape ``com.amazonaws.schemas#PutResourcePolicy``."""
...
import capo_schemas.errors.precondition_failed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PreconditionFailedException":
            raise capo_schemas.errors.precondition_failed_exception.PreconditionFailedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_schemas.types.put_resource_policy_response.PutResourcePolicyResponse = (
        capo_schemas.types.put_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_schemas.types.put_resource_policy_request.serialize_json(input_)
    ).encode()
