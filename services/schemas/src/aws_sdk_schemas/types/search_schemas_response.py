...
class SearchSchemasResponse(TypedDict):
    ...
    schemas: NotRequired[
        "aws_sdk_schemas.types.__list_of_search_schema_summary.__listOfSearchSchemaSummary"
    ]
...
def serialize_json(value: SearchSchemasResponse) -> dict:
    ...
    if "schemas" in value:
        ...
        out["Schemas"] = (
            aws_sdk_schemas.types.__list_of_search_schema_summary.serialize_json(
                value["schemas"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> SearchSchemasResponse:
    ...
    if "Schemas" in data:
        ...
        out["schemas"] = (
            aws_sdk_schemas.types.__list_of_search_schema_summary.deserialize_json(
                data["Schemas"]
            )
        )
    return out
