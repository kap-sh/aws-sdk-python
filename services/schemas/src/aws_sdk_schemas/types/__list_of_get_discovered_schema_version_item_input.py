...
if TYPE_CHECKING:
    import aws_sdk_schemas.types.get_discovered_schema_version_item_input

__listOfGetDiscoveredSchemaVersionItemInput: TypeAlias = list[
    "aws_sdk_schemas.types.get_discovered_schema_version_item_input.GetDiscoveredSchemaVersionItemInput"
]
