"""Generated from Smithy shape ``com.amazonaws.schemas#DescribeRegistryResponse``."""
...
class DescribeRegistryResponse(TypedDict):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeRegistryResponse) -> dict:
    out: dict = {}
