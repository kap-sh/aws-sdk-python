...
# --- restJson1 ser/de ---
def serialize_json(value: StopDiscovererResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> StopDiscovererResponse:
    out: StopDiscovererResponse = {}  # type: ignore[typeddict-item]
