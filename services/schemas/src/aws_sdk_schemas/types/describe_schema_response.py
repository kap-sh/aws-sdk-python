"""Generated from Smithy shape ``com.amazonaws.schemas#DescribeSchemaResponse``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeSchemaResponse) -> dict:
    out: dict = {}
    if "content" in value:
...
def deserialize_json(data: dict) -> DescribeSchemaResponse:
