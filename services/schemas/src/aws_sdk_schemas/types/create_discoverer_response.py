"""Generated from Smithy shape ``com.amazonaws.schemas#CreateDiscovererResponse``."""
...
class CreateDiscovererResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateDiscovererResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateDiscovererResponse:
    out: CreateDiscovererResponse = {}  # type: ignore[typeddict-item]
