"""Generated from Smithy shape ``com.amazonaws.schemas#UpdateDiscovererResponse``."""
...
class UpdateDiscovererResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateDiscovererResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateDiscovererResponse:
    out: UpdateDiscovererResponse = {}  # type: ignore[typeddict-item]
