"""Generated from Smithy shape ``com.amazonaws.schemas#PreconditionFailedException``."""
...
class PreconditionFailedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.schemas#PreconditionFailedException``."""
