...
class schemasError(Exception):
    """Base class for all schemas service errors."""


class ServiceError(schemasError):
...
class SerializationError(schemasError):
    """Raised when a value cannot be serialized."""


class DeserializationError(schemasError):
...
class WaiterFailedError(schemasError):
...
class WaiterTimeoutError(schemasError):
