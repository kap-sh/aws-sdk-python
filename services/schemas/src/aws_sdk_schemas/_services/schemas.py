...
from aws_sdk_schemas._services._aws_config import aws_config
...
class schemasClientConfig(TypedDict, total=False, closed=True):
...
class schemasClient:
    ...
    def __init__(
        ...
        self._config = schemasClientConfig(
            {
