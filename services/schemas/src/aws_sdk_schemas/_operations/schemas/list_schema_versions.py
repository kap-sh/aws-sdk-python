"""Generated from Smithy shape ``com.amazonaws.schemas#ListSchemaVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.list_schema_versions_response.ListSchemaVersionsResponse = aws_sdk_schemas.types.list_schema_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.list_schema_versions_request.ListSchemaVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
