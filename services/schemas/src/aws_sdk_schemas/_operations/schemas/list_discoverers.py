...
def build_request(
    ...
    input_: aws_sdk_schemas.types.list_discoverers_request.ListDiscoverersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "discoverer_id_prefix" in input_:
        params["discovererIdPrefix"] = str(input_["discoverer_id_prefix"])
    if "limit" in input_:
        params["limit"] = str(input_["limit"])
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "source_arn_prefix" in input_:
        params["sourceArnPrefix"] = str(input_["source_arn_prefix"])
