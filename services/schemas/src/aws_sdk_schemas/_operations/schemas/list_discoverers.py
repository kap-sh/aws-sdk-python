...
def handle_response(
    ...
    out: aws_sdk_schemas.types.list_discoverers_response.ListDiscoverersResponse = (
        aws_sdk_schemas.types.list_discoverers_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_schemas.types.list_discoverers_request.ListDiscoverersRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "discoverer_id_prefix" in input:
        params["discovererIdPrefix"] = str(input["discoverer_id_prefix"])
    if "limit" in input:
        params["limit"] = str(input["limit"])
    if "next_token" in input:
        params["nextToken"] = str(input["next_token"])
    if "source_arn_prefix" in input:
        params["sourceArnPrefix"] = str(input["source_arn_prefix"])
