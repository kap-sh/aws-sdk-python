"""Generated from Smithy shape ``com.amazonaws.schemas#DeleteDiscoverer``."""
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.delete_discoverer_request.DeleteDiscovererRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_discoverer(
