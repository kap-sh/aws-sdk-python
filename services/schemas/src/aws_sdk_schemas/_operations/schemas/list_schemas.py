...
def handle_response(
    ...
    out: aws_sdk_schemas.types.list_schemas_response.ListSchemasResponse = (
        aws_sdk_schemas.types.list_schemas_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_schemas.types.list_schemas_request.ListSchemasRequest,
) -> zapros.Request:
    ...
    if "schema_name_prefix" in input:
        params["schemaNamePrefix"] = str(input["schema_name_prefix"])
...
def list_schemas(
    ...
    aws_sdk_schemas.types.list_schemas_response.ListSchemasResponse, zapros.Response
]:
