"""Generated from Smithy shape ``com.amazonaws.schemas#CreateDiscoverer``."""
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.create_discoverer_response.CreateDiscovererResponse = (
        aws_sdk_schemas.types.create_discoverer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.create_discoverer_request.CreateDiscovererRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/discoverers"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_schemas.types.create_discoverer_request

    body: bytes | None = json.dumps(
        aws_sdk_schemas.types.create_discoverer_request.serialize_json(input_)
    ).encode()
...
async def async_create_discoverer(
