"""Generated from Smithy shape ``com.amazonaws.schemas#UpdateSchema``."""
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.update_schema_response.UpdateSchemaResponse = (
        aws_sdk_schemas.types.update_schema_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.update_schema_request.UpdateSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_schemas.types.update_schema_request.serialize_json(input_)
    ).encode()
...
def update_schema(
    ...
    aws_sdk_schemas.types.update_schema_response.UpdateSchemaResponse, zapros.Response
]:
