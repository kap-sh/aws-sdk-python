"""Generated from Smithy shape ``com.amazonaws.schemas#DescribeCodeBinding``."""
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.describe_code_binding_response.DescribeCodeBindingResponse = aws_sdk_schemas.types.describe_code_binding_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.describe_code_binding_request.DescribeCodeBindingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_code_binding(
