...
def handle_response(
    ...
    out: aws_sdk_schemas.types.describe_schema_response.DescribeSchemaResponse = (
        aws_sdk_schemas.types.describe_schema_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.describe_schema_request.DescribeSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
