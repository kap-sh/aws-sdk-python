...
def build_request(
    ...
    input_: aws_sdk_schemas.types.delete_schema_version_request.DeleteSchemaVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{SchemaVersion}", quote(str(input_["schema_version"]), safe=""))
    params: dict[str, str] = {}
