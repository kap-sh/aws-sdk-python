...
def handle_response(
    ...
    out: aws_sdk_schemas.types.update_registry_response.UpdateRegistryResponse = (
        aws_sdk_schemas.types.update_registry_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.update_registry_request.UpdateRegistryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_schemas.types.update_registry_request.serialize_json(input_)
    ).encode()
