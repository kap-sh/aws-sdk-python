"""Generated from Smithy shape ``com.amazonaws.schemas#ListRegistries``."""
...
import aws_sdk_schemas.types.__list_of_registry_summary
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.list_registries_response.ListRegistriesResponse = (
        aws_sdk_schemas.types.list_registries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.list_registries_request.ListRegistriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/registries"
    params: dict[str, str] = {}
    if "limit" in input_:
        params["limit"] = str(input_["limit"])
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "registry_name_prefix" in input_:
        params["registryNamePrefix"] = str(input_["registry_name_prefix"])
    if "scope" in input_:
