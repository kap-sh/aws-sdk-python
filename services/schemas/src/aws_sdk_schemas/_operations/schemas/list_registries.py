...
def build_request(
    ...
    input: aws_sdk_schemas.types.list_registries_request.ListRegistriesRequest,
) -> zapros.Request:
    ...
    if "registry_name_prefix" in input:
        params["registryNamePrefix"] = str(input["registry_name_prefix"])
    if "scope" in input:
