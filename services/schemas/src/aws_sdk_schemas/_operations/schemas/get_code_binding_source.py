"""Generated from Smithy shape ``com.amazonaws.schemas#GetCodeBindingSource``."""
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.get_code_binding_source_response.GetCodeBindingSourceResponse = {
        "body": aws_sdk_schemas.types.body.deserialize_json(json.loads(response.read()))
...
async def async_handle_response(
    ...
    out: aws_sdk_schemas.types.get_code_binding_source_response.GetCodeBindingSourceResponse = {
        "body": aws_sdk_schemas.types.body.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.get_code_binding_source_request.GetCodeBindingSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_code_binding_source(
