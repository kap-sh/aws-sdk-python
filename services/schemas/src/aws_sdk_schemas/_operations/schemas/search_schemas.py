"""Generated from Smithy shape ``com.amazonaws.schemas#SearchSchemas``."""
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.search_schemas_response.SearchSchemasResponse = (
        aws_sdk_schemas.types.search_schemas_response.deserialize_json(
