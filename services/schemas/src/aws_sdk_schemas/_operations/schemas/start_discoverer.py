...
def handle_response(
    ...
    out: aws_sdk_schemas.types.start_discoverer_response.StartDiscovererResponse = (
        aws_sdk_schemas.types.start_discoverer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.start_discoverer_request.StartDiscovererRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
