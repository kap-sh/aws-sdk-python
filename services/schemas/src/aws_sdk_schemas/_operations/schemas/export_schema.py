...
def handle_response(
    ...
    out: aws_sdk_schemas.types.export_schema_response.ExportSchemaResponse = (
        aws_sdk_schemas.types.export_schema_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.export_schema_request.ExportSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def export_schema(
    ...
    aws_sdk_schemas.types.export_schema_response.ExportSchemaResponse, zapros.Response
]:
