...
def handle_response(
    ...
    out: aws_sdk_schemas.types.get_discovered_schema_response.GetDiscoveredSchemaResponse = aws_sdk_schemas.types.get_discovered_schema_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.get_discovered_schema_request.GetDiscoveredSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_schemas.types.get_discovered_schema_request.serialize_json(input_)
    ).encode()
