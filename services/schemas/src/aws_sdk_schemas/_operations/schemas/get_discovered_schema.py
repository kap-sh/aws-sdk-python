...
def build_request(
    ...
    input: aws_sdk_schemas.types.get_discovered_schema_request.GetDiscoveredSchemaRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_schemas.types.get_discovered_schema_request.serialize_json(input)
    ).encode()
