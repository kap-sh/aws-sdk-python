...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PreconditionFailedException":
            import aws_sdk_schemas.errors.precondition_failed_exception

            raise aws_sdk_schemas.errors.precondition_failed_exception.PreconditionFailedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.put_resource_policy_response.PutResourcePolicyResponse = aws_sdk_schemas.types.put_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_schemas.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_schemas.types.put_resource_policy_request.serialize_json(input)
    ).encode()
