"""Generated from Smithy shape ``com.amazonaws.schemas#DescribeRegistry``."""
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.describe_registry_response.DescribeRegistryResponse = (
        aws_sdk_schemas.types.describe_registry_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.describe_registry_request.DescribeRegistryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
