...
def handle_response(
    ...
    out: aws_sdk_schemas.types.describe_discoverer_response.DescribeDiscovererResponse = aws_sdk_schemas.types.describe_discoverer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.describe_discoverer_request.DescribeDiscovererRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
