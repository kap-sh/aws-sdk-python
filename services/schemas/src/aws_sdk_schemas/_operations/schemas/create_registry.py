"""Generated from Smithy shape ``com.amazonaws.schemas#CreateRegistry``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_schemas.errors.conflict_exception

            raise aws_sdk_schemas.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceUnavailableException":
            import aws_sdk_schemas.errors.service_unavailable_exception

            raise aws_sdk_schemas.errors.service_unavailable_exception.ServiceUnavailableException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.create_registry_response.CreateRegistryResponse = (
        aws_sdk_schemas.types.create_registry_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.create_registry_request.CreateRegistryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/registries/name/{RegistryName}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_schemas.types.create_registry_request.serialize_json(input_)
    ).encode()
...
async def async_create_registry(
