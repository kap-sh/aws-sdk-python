"""Generated from Smithy shape ``com.amazonaws.schemas#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_schemas.types.get_resource_policy_response.GetResourcePolicyResponse = aws_sdk_schemas.types.get_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_schemas.types.get_resource_policy_request.GetResourcePolicyRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/policy"
    params: dict[str, str] = {}
    if "registry_name" in input:
        params["registryName"] = str(input["registry_name"])
