...
def handle_response(
    ...
    out: aws_sdk_schemas.types.stop_discoverer_response.StopDiscovererResponse = (
        aws_sdk_schemas.types.stop_discoverer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_schemas.types.stop_discoverer_request.StopDiscovererRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
