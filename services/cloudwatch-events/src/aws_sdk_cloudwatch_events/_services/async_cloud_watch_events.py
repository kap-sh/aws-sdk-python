...
from aws_sdk_cloudwatch_events._services._aws_config import aaws_config
...
class AsyncCloudWatchEventsClientConfig(TypedDict, total=False, closed=True):
...
class AsyncCloudWatchEventsClient:
    ...
    def __init__(
        ...
        self._config = AsyncCloudWatchEventsClientConfig(
            {
