...
from ._services.async_cloud_watch_events import (
    AsyncCloudWatchEventsClient as AsyncCloudWatchEventsClient,
)
from ._services.cloud_watch_events import (
    CloudWatchEventsClient as CloudWatchEventsClient,
)
