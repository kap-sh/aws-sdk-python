...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_events.types.list_partner_event_sources_response.ListPartnerEventSourcesResponse = aws_sdk_cloudwatch_events.types.list_partner_event_sources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_events.types.list_partner_event_sources_request.ListPartnerEventSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_events.types.list_partner_event_sources_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
