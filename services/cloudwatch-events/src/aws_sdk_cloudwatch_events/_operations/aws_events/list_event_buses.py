"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListEventBuses``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_events.types.list_event_buses_request.ListEventBusesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_events.types.list_event_buses_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_event_buses(
