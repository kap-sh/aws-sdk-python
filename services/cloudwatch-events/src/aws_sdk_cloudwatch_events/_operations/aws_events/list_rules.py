"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListRules``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_events.types.list_rules_response.ListRulesResponse = (
        aws_sdk_cloudwatch_events.types.list_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_cloudwatch_events.types.list_rules_request.ListRulesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_events.types.list_rules_request.serialize_aws_json_1_1(input)
    ).encode()
