"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListReplays``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_events.types.list_replays_response.ListReplaysResponse = (
        aws_sdk_cloudwatch_events.types.list_replays_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_events.types.list_replays_request.ListReplaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSEvents.ListReplays"
    import aws_sdk_cloudwatch_events.types.list_replays_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_events.types.list_replays_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
