...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_events.types.put_partner_events_response.PutPartnerEventsResponse = aws_sdk_cloudwatch_events.types.put_partner_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_events.types.put_partner_events_request.PutPartnerEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_events.types.put_partner_events_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
