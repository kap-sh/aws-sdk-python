"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_events.types.list_connections_response.ListConnectionsResponse = aws_sdk_cloudwatch_events.types.list_connections_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_events.types.list_connections_request.ListConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSEvents.ListConnections"
    import aws_sdk_cloudwatch_events.types.list_connections_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_events.types.list_connections_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
