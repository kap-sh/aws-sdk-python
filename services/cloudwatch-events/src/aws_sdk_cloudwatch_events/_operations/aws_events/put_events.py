"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#PutEvents``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_events.types.put_events_response.PutEventsResponse = (
        aws_sdk_cloudwatch_events.types.put_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_cloudwatch_events.types.put_events_request.PutEventsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_events.types.put_events_request.serialize_aws_json_1_1(input)
    ).encode()
