...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_events.types.query_string_value_sensitive


class ConnectionQueryStringParameter(TypedDict):
    key: NotRequired["aws_sdk_cloudwatch_events.types.query_string_key.QueryStringKey"]
    """<p>The key for a query string parameter.</p>"""
    value: NotRequired[
        "aws_sdk_cloudwatch_events.types.query_string_value_sensitive.QueryStringValueSensitive"
    ]
