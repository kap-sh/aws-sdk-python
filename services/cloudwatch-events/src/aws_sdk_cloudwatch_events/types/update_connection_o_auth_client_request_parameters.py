"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#UpdateConnectionOAuthClientRequestParameters``."""
...
class UpdateConnectionOAuthClientRequestParameters(TypedDict):
    ...
    client_secret: NotRequired[
        "aws_sdk_cloudwatch_events.types.auth_header_parameters_sensitive.AuthHeaderParametersSensitive"
    ]
