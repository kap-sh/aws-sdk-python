"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#CreateConnectionRequest``."""
...
def serialize_aws_json_1_1(value: CreateConnectionRequest) -> dict:
    ...
    out["AuthParameters"] = (
        aws_sdk_cloudwatch_events.types.create_connection_auth_request_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateConnectionRequest:
    ...
    if "AuthParameters" in data:
        ...
        out["auth_parameters"] = (
            aws_sdk_cloudwatch_events.types.create_connection_auth_request_parameters.deserialize_aws_json_1_1(
                data["AuthParameters"]
            )
        )
    else:
