...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch_events.types.batch_array_properties
    import aws_sdk_cloudwatch_events.types.batch_retry_strategy
...
class BatchParameters(TypedDict, closed=True):
    ...
    array_properties: NotRequired[
        "aws_sdk_cloudwatch_events.types.batch_array_properties.BatchArrayProperties"
    ]
    ...
    retry_strategy: NotRequired[
        "aws_sdk_cloudwatch_events.types.batch_retry_strategy.BatchRetryStrategy"
    ]
...
def serialize_aws_json_1_1(value: BatchParameters) -> dict:
    ...
    if "array_properties" in value:
        ...
        out["ArrayProperties"] = (
            aws_sdk_cloudwatch_events.types.batch_array_properties.serialize_aws_json_1_1(
    ...
    if "retry_strategy" in value:
        ...
        out["RetryStrategy"] = (
            aws_sdk_cloudwatch_events.types.batch_retry_strategy.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchParameters:
    ...
    if "ArrayProperties" in data:
        ...
        out["array_properties"] = (
            aws_sdk_cloudwatch_events.types.batch_array_properties.deserialize_aws_json_1_1(
    ...
    if "RetryStrategy" in data:
        ...
        out["retry_strategy"] = (
            aws_sdk_cloudwatch_events.types.batch_retry_strategy.deserialize_aws_json_1_1(
                data["RetryStrategy"]
            )
        )
    return out
