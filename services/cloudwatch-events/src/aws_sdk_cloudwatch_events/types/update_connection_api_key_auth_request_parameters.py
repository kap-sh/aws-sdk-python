"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#UpdateConnectionApiKeyAuthRequestParameters``."""
...
class UpdateConnectionApiKeyAuthRequestParameters(TypedDict):
