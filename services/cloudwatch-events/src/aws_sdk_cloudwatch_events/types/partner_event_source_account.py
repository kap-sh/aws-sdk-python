...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_events.types.event_source_state
    import aws_sdk_cloudwatch_events.types.timestamp


class PartnerEventSourceAccount(TypedDict):
    account: NotRequired["aws_sdk_cloudwatch_events.types.account_id.AccountId"]
    ...
    expiration_time: NotRequired["aws_sdk_cloudwatch_events.types.timestamp.Timestamp"]
    ...
    state: NotRequired[
        "aws_sdk_cloudwatch_events.types.event_source_state.EventSourceState"
    ]
...
def serialize_aws_json_1_1(value: PartnerEventSourceAccount) -> dict:
    ...
    if "state" in value:
        ...
        out["State"] = (
            aws_sdk_cloudwatch_events.types.event_source_state.serialize_aws_json_1_1(
                value["state"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> PartnerEventSourceAccount:
    ...
    if "State" in data:
        ...
        out["state"] = (
            aws_sdk_cloudwatch_events.types.event_source_state.deserialize_aws_json_1_1(
                data["State"]
            )
        )
    return out
