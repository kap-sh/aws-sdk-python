"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#SageMakerPipelineParameter``."""
...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch_events.types.sage_maker_pipeline_parameter_name
    import aws_sdk_cloudwatch_events.types.sage_maker_pipeline_parameter_value


class SageMakerPipelineParameter(TypedDict, closed=True):
    name: "aws_sdk_cloudwatch_events.types.sage_maker_pipeline_parameter_name.SageMakerPipelineParameterName"
    """<p>Name of parameter to start execution of a SageMaker AI Model Building Pipeline.</p>"""
    value: "aws_sdk_cloudwatch_events.types.sage_maker_pipeline_parameter_value.SageMakerPipelineParameterValue"
