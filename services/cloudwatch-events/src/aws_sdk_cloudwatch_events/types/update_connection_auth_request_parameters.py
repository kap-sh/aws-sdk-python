...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_events.types.update_connection_api_key_auth_request_parameters
    import aws_sdk_cloudwatch_events.types.update_connection_basic_auth_request_parameters
    import aws_sdk_cloudwatch_events.types.update_connection_o_auth_request_parameters


class UpdateConnectionAuthRequestParameters(TypedDict):
    basic_auth_parameters: NotRequired[
        "aws_sdk_cloudwatch_events.types.update_connection_basic_auth_request_parameters.UpdateConnectionBasicAuthRequestParameters"
    ]
    ...
    o_auth_parameters: NotRequired[
        "aws_sdk_cloudwatch_events.types.update_connection_o_auth_request_parameters.UpdateConnectionOAuthRequestParameters"
    ]
    ...
    api_key_auth_parameters: NotRequired[
        "aws_sdk_cloudwatch_events.types.update_connection_api_key_auth_request_parameters.UpdateConnectionApiKeyAuthRequestParameters"
    ]
...
def serialize_aws_json_1_1(value: UpdateConnectionAuthRequestParameters) -> dict:
    ...
    if "basic_auth_parameters" in value:
        ...
        out["BasicAuthParameters"] = (
            aws_sdk_cloudwatch_events.types.update_connection_basic_auth_request_parameters.serialize_aws_json_1_1(
    ...
    if "o_auth_parameters" in value:
        ...
        out["OAuthParameters"] = (
            aws_sdk_cloudwatch_events.types.update_connection_o_auth_request_parameters.serialize_aws_json_1_1(
    ...
    if "api_key_auth_parameters" in value:
        ...
        out["ApiKeyAuthParameters"] = (
            aws_sdk_cloudwatch_events.types.update_connection_api_key_auth_request_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateConnectionAuthRequestParameters:
    ...
    if "BasicAuthParameters" in data:
        ...
        out["basic_auth_parameters"] = (
            aws_sdk_cloudwatch_events.types.update_connection_basic_auth_request_parameters.deserialize_aws_json_1_1(
    ...
    if "OAuthParameters" in data:
        ...
        out["o_auth_parameters"] = (
            aws_sdk_cloudwatch_events.types.update_connection_o_auth_request_parameters.deserialize_aws_json_1_1(
    ...
    if "ApiKeyAuthParameters" in data:
        ...
        out["api_key_auth_parameters"] = (
            aws_sdk_cloudwatch_events.types.update_connection_api_key_auth_request_parameters.deserialize_aws_json_1_1(
