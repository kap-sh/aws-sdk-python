...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch_events.types.placement_constraint_expression
    import aws_sdk_cloudwatch_events.types.placement_constraint_type


class PlacementConstraint(TypedDict, closed=True):
    type: NotRequired[
        "aws_sdk_cloudwatch_events.types.placement_constraint_type.PlacementConstraintType"
    ]
    ...
    expression: NotRequired[
        "aws_sdk_cloudwatch_events.types.placement_constraint_expression.PlacementConstraintExpression"
    ]
...
def serialize_aws_json_1_1(value: PlacementConstraint) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = (
            aws_sdk_cloudwatch_events.types.placement_constraint_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> PlacementConstraint:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_cloudwatch_events.types.placement_constraint_type.deserialize_aws_json_1_1(
                data["type"]
            )
        )
