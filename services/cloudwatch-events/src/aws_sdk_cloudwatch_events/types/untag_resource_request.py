"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#UntagResourceRequest``."""
...
def serialize_aws_json_1_1(value: UntagResourceRequest) -> dict:
    ...
    out["TagKeys"] = (
        aws_sdk_cloudwatch_events.types.tag_key_list.serialize_aws_json_1_1(
            value["tag_keys"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UntagResourceRequest:
    ...
    if "TagKeys" in data:
        ...
        out["tag_keys"] = (
            aws_sdk_cloudwatch_events.types.tag_key_list.deserialize_aws_json_1_1(
                data["TagKeys"]
            )
        )
    else:
