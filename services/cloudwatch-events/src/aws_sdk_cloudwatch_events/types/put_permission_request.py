...
class PutPermissionRequest(TypedDict, closed=True):
    ...
    action: NotRequired["aws_sdk_cloudwatch_events.types.action.Action"]
    """<p>The action that you are enabling the other account to perform.</p>"""
    principal: NotRequired["aws_sdk_cloudwatch_events.types.principal.Principal"]
    ...
    condition: NotRequired["aws_sdk_cloudwatch_events.types.condition.Condition"]
...
def serialize_aws_json_1_1(value: PutPermissionRequest) -> dict:
    ...
    if "condition" in value:
        ...
        out["Condition"] = (
            aws_sdk_cloudwatch_events.types.condition.serialize_aws_json_1_1(
                value["condition"]
            )
        )
    if "policy" in value:
...
def deserialize_aws_json_1_1(data: dict) -> PutPermissionRequest:
    ...
    if "Condition" in data:
        ...
        out["condition"] = (
            aws_sdk_cloudwatch_events.types.condition.deserialize_aws_json_1_1(
                data["Condition"]
            )
        )
    if "Policy" in data:
