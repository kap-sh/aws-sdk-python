...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_events.types.tag_value


class Tag(TypedDict):
    key: "aws_sdk_cloudwatch_events.types.tag_key.TagKey"
    ...
    value: "aws_sdk_cloudwatch_events.types.tag_value.TagValue"
