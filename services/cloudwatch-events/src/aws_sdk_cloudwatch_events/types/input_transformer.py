"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#InputTransformer``."""
...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch_events.types.transformer_input
    import aws_sdk_cloudwatch_events.types.transformer_paths


class InputTransformer(TypedDict):
    input_paths_map: NotRequired[
        "aws_sdk_cloudwatch_events.types.transformer_paths.TransformerPaths"
    ]
    ...
    input_template: "aws_sdk_cloudwatch_events.types.transformer_input.TransformerInput"
...
def serialize_aws_json_1_1(value: InputTransformer) -> dict:
    ...
    if "input_paths_map" in value:
        ...
        out["InputPathsMap"] = (
            aws_sdk_cloudwatch_events.types.transformer_paths.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InputTransformer:
    ...
    if "InputPathsMap" in data:
        ...
        out["input_paths_map"] = (
            aws_sdk_cloudwatch_events.types.transformer_paths.deserialize_aws_json_1_1(
                data["InputPathsMap"]
            )
        )
