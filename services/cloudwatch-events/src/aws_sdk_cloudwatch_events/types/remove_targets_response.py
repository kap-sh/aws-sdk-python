...
class RemoveTargetsResponse(TypedDict, closed=True):
    ...
    failed_entries: NotRequired[
        "aws_sdk_cloudwatch_events.types.remove_targets_result_entry_list.RemoveTargetsResultEntryList"
    ]
...
def serialize_aws_json_1_1(value: RemoveTargetsResponse) -> dict:
    ...
    if "failed_entries" in value:
        ...
        out["FailedEntries"] = (
            aws_sdk_cloudwatch_events.types.remove_targets_result_entry_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RemoveTargetsResponse:
    ...
    if "FailedEntries" in data:
        ...
        out["failed_entries"] = (
            aws_sdk_cloudwatch_events.types.remove_targets_result_entry_list.deserialize_aws_json_1_1(
                data["FailedEntries"]
            )
        )
    return out
