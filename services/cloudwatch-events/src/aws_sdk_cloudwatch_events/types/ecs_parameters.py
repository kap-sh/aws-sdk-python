...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_events.types.capacity_provider_strategy
    import aws_sdk_cloudwatch_events.types.launch_type
    import aws_sdk_cloudwatch_events.types.limit_min1
    import aws_sdk_cloudwatch_events.types.network_configuration
    import aws_sdk_cloudwatch_events.types.placement_constraints
    import aws_sdk_cloudwatch_events.types.placement_strategies
    import aws_sdk_cloudwatch_events.types.propagate_tags
    import aws_sdk_cloudwatch_events.types.reference_id
...
class EcsParameters(TypedDict):
    task_definition_arn: "aws_sdk_cloudwatch_events.types.arn.Arn"
    ...
    capacity_provider_strategy: NotRequired[
        "aws_sdk_cloudwatch_events.types.capacity_provider_strategy.CapacityProviderStrategy"
    ]
    ...
    placement_constraints: NotRequired[
        "aws_sdk_cloudwatch_events.types.placement_constraints.PlacementConstraints"
    ]
    ...
    placement_strategy: NotRequired[
        "aws_sdk_cloudwatch_events.types.placement_strategies.PlacementStrategies"
    ]
    ...
    propagate_tags: NotRequired[
        "aws_sdk_cloudwatch_events.types.propagate_tags.PropagateTags"
    ]
    ...
    reference_id: NotRequired[
        "aws_sdk_cloudwatch_events.types.reference_id.ReferenceId"
    ]
...
def serialize_aws_json_1_1(value: EcsParameters) -> dict:
    ...
    if "launch_type" in value:
        ...
        out["LaunchType"] = (
            aws_sdk_cloudwatch_events.types.launch_type.serialize_aws_json_1_1(
                value["launch_type"]
            )
        )
    if "network_configuration" in value:
        ...
        out["NetworkConfiguration"] = (
            aws_sdk_cloudwatch_events.types.network_configuration.serialize_aws_json_1_1(
    ...
    if "capacity_provider_strategy" in value:
        ...
        out["CapacityProviderStrategy"] = (
            aws_sdk_cloudwatch_events.types.capacity_provider_strategy.serialize_aws_json_1_1(
    ...
    if "placement_constraints" in value:
        ...
        out["PlacementConstraints"] = (
            aws_sdk_cloudwatch_events.types.placement_constraints.serialize_aws_json_1_1(
    ...
    if "placement_strategy" in value:
        ...
        out["PlacementStrategy"] = (
            aws_sdk_cloudwatch_events.types.placement_strategies.serialize_aws_json_1_1(
    ...
    if "propagate_tags" in value:
        ...
        out["PropagateTags"] = (
            aws_sdk_cloudwatch_events.types.propagate_tags.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EcsParameters:
    ...
    if "LaunchType" in data:
        ...
        out["launch_type"] = (
            aws_sdk_cloudwatch_events.types.launch_type.deserialize_aws_json_1_1(
                data["LaunchType"]
            )
        )
    if "NetworkConfiguration" in data:
        ...
        out["network_configuration"] = (
            aws_sdk_cloudwatch_events.types.network_configuration.deserialize_aws_json_1_1(
    ...
    if "CapacityProviderStrategy" in data:
        ...
        out["capacity_provider_strategy"] = (
            aws_sdk_cloudwatch_events.types.capacity_provider_strategy.deserialize_aws_json_1_1(
    ...
    if "PlacementConstraints" in data:
        ...
        out["placement_constraints"] = (
            aws_sdk_cloudwatch_events.types.placement_constraints.deserialize_aws_json_1_1(
    ...
    if "PlacementStrategy" in data:
        ...
        out["placement_strategy"] = (
            aws_sdk_cloudwatch_events.types.placement_strategies.deserialize_aws_json_1_1(
    ...
    if "PropagateTags" in data:
        ...
        out["propagate_tags"] = (
            aws_sdk_cloudwatch_events.types.propagate_tags.deserialize_aws_json_1_1(
                data["PropagateTags"]
            )
        )
