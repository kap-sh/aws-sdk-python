...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch_events.types.assign_public_ip
    import aws_sdk_cloudwatch_events.types.string_list


class AwsVpcConfiguration(TypedDict):
    subnets: "aws_sdk_cloudwatch_events.types.string_list.StringList"
    ...
    security_groups: NotRequired[
        "aws_sdk_cloudwatch_events.types.string_list.StringList"
    ]
    ...
    assign_public_ip: NotRequired[
        "aws_sdk_cloudwatch_events.types.assign_public_ip.AssignPublicIp"
    ]
...
def serialize_aws_json_1_1(value: AwsVpcConfiguration) -> dict:
    ...
    out["Subnets"] = aws_sdk_cloudwatch_events.types.string_list.serialize_aws_json_1_1(
        value["subnets"]
    )
    if "security_groups" in value:
        ...
        out["SecurityGroups"] = (
            aws_sdk_cloudwatch_events.types.string_list.serialize_aws_json_1_1(
    ...
    if "assign_public_ip" in value:
        ...
        out["AssignPublicIp"] = (
            aws_sdk_cloudwatch_events.types.assign_public_ip.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AwsVpcConfiguration:
    ...
    if "Subnets" in data:
        ...
        out["subnets"] = (
            aws_sdk_cloudwatch_events.types.string_list.deserialize_aws_json_1_1(
                data["Subnets"]
            )
        )
    else:
    ...
    if "AssignPublicIp" in data:
        ...
        out["assign_public_ip"] = (
            aws_sdk_cloudwatch_events.types.assign_public_ip.deserialize_aws_json_1_1(
                data["AssignPublicIp"]
            )
        )
    return out
