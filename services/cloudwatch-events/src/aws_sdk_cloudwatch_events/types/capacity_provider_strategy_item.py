...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch_events.types.capacity_provider
    import aws_sdk_cloudwatch_events.types.capacity_provider_strategy_item_base
...
class CapacityProviderStrategyItem(TypedDict):
    ...
    weight: "aws_sdk_cloudwatch_events.types.capacity_provider_strategy_item_weight.CapacityProviderStrategyItemWeight"
    ...
    base: "aws_sdk_cloudwatch_events.types.capacity_provider_strategy_item_base.CapacityProviderStrategyItemBase"
