...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_events.types.database
    import aws_sdk_cloudwatch_events.types.db_user
    import aws_sdk_cloudwatch_events.types.redshift_secret_manager_arn
    import aws_sdk_cloudwatch_events.types.sql
    import aws_sdk_cloudwatch_events.types.statement_name


class RedshiftDataParameters(TypedDict):
    secret_manager_arn: NotRequired[
        "aws_sdk_cloudwatch_events.types.redshift_secret_manager_arn.RedshiftSecretManagerArn"
    ]
    ...
    database: "aws_sdk_cloudwatch_events.types.database.Database"
    """<p>The name of the database. Required when authenticating using temporary credentials.</p>"""
    db_user: NotRequired["aws_sdk_cloudwatch_events.types.db_user.DbUser"]
    """<p>The database user name. Required when authenticating using temporary credentials.</p>"""
    sql: "aws_sdk_cloudwatch_events.types.sql.Sql"
    """<p>The SQL statement text to run.</p>"""
    statement_name: NotRequired[
        "aws_sdk_cloudwatch_events.types.statement_name.StatementName"
    ]
    """<p>The name of the SQL statement. You can name the SQL statement when you create it to identify the query.</p>"""
    with_event: "aws_sdk_cloudwatch_events.types.boolean.Boolean"
