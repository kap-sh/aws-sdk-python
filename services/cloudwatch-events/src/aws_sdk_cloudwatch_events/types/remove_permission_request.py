"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#RemovePermissionRequest``."""
...
class RemovePermissionRequest(TypedDict):
    ...
    remove_all_permissions: "aws_sdk_cloudwatch_events.types.boolean.Boolean"
