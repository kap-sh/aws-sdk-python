"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#UpdateConnectionOAuthRequestParameters``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_events.types.update_connection_o_auth_client_request_parameters


class UpdateConnectionOAuthRequestParameters(TypedDict, closed=True):
    client_parameters: NotRequired[
        "aws_sdk_cloudwatch_events.types.update_connection_o_auth_client_request_parameters.UpdateConnectionOAuthClientRequestParameters"
    ]
...
def serialize_aws_json_1_1(value: UpdateConnectionOAuthRequestParameters) -> dict:
    ...
    if "client_parameters" in value:
        ...
        out["ClientParameters"] = (
            aws_sdk_cloudwatch_events.types.update_connection_o_auth_client_request_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateConnectionOAuthRequestParameters:
    ...
    if "ClientParameters" in data:
        ...
        out["client_parameters"] = (
            aws_sdk_cloudwatch_events.types.update_connection_o_auth_client_request_parameters.deserialize_aws_json_1_1(
