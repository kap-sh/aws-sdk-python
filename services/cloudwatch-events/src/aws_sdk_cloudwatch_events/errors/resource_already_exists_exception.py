"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ResourceAlreadyExistsException``."""
...
class ResourceAlreadyExistsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatchevents#ResourceAlreadyExistsException``."""
