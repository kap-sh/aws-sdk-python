"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatchevents#ResourceNotFoundException``."""
