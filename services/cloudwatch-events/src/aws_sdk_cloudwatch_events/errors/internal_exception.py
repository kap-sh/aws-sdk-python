"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#InternalException``."""
...
class InternalException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatchevents#InternalException``."""
