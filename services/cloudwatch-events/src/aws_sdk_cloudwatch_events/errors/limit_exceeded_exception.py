"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatchevents#LimitExceededException``."""
