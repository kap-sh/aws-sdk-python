"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#PlacementStrategy``."""
...
if TYPE_CHECKING:
    import capo_cloudwatch_events.types.placement_strategy_field
    import capo_cloudwatch_events.types.placement_strategy_type


class PlacementStrategy(TypedDict, closed=True):
    type: NotRequired[
        "capo_cloudwatch_events.types.placement_strategy_type.PlacementStrategyType"
    ]
    ...
    field: NotRequired[
        "capo_cloudwatch_events.types.placement_strategy_field.PlacementStrategyField"
    ]
...
def serialize_aws_json_1_1(value: PlacementStrategy) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = (
            capo_cloudwatch_events.types.placement_strategy_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
    if "field" in value:
...
def deserialize_aws_json_1_1(data: dict) -> PlacementStrategy:
    ...
    if "type" in data:
        ...
        out["type"] = (
            capo_cloudwatch_events.types.placement_strategy_type.deserialize_aws_json_1_1(
                data["type"]
            )
        )
    if "field" in data:
