"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#DescribeApiDestinationResponse``."""
...
if TYPE_CHECKING:
    import capo_cloudwatch_events.types.api_destination_arn
...
class DescribeApiDestinationResponse(TypedDict, closed=True):
    api_destination_arn: NotRequired[
        "capo_cloudwatch_events.types.api_destination_arn.ApiDestinationArn"
    ]
    ...
    api_destination_state: NotRequired[
        "capo_cloudwatch_events.types.api_destination_state.ApiDestinationState"
    ]
...
def serialize_aws_json_1_1(value: DescribeApiDestinationResponse) -> dict:
    ...
    if "api_destination_state" in value:
        ...
        out["ApiDestinationState"] = (
            capo_cloudwatch_events.types.api_destination_state.serialize_aws_json_1_1(
    ...
    if "http_method" in value:
        ...
        out["HttpMethod"] = (
            capo_cloudwatch_events.types.api_destination_http_method.serialize_aws_json_1_1(
                value["http_method"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeApiDestinationResponse:
    ...
    if "ApiDestinationState" in data:
        ...
        out["api_destination_state"] = (
            capo_cloudwatch_events.types.api_destination_state.deserialize_aws_json_1_1(
    ...
    if "HttpMethod" in data:
        ...
        out["http_method"] = (
            capo_cloudwatch_events.types.api_destination_http_method.deserialize_aws_json_1_1(
                data["HttpMethod"]
            )
        )
