"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#StartReplayRequest``."""
...
def serialize_aws_json_1_1(value: StartReplayRequest) -> dict:
    ...
    out["EventEndTime"] = capo_cloudwatch_events.types.timestamp.serialize_aws_json_1_1(
