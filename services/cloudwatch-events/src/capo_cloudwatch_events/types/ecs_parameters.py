"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#EcsParameters``."""
...
if TYPE_CHECKING:
    ...
    import capo_cloudwatch_events.types.capacity_provider_strategy
    import capo_cloudwatch_events.types.launch_type
    import capo_cloudwatch_events.types.limit_min1
    import capo_cloudwatch_events.types.network_configuration
    import capo_cloudwatch_events.types.placement_constraints
    import capo_cloudwatch_events.types.placement_strategies
    import capo_cloudwatch_events.types.propagate_tags
    import capo_cloudwatch_events.types.reference_id
...
class EcsParameters(TypedDict, closed=True):
    task_definition_arn: "capo_cloudwatch_events.types.arn.Arn"
    """<p>The ARN of the task definition to use if the event target is an Amazon ECS task. </p>"""
    task_count: NotRequired["capo_cloudwatch_events.types.limit_min1.LimitMin1"]
    """<p>The number of tasks to create based on <code>TaskDefinition</code>. The default is 1.</p>"""
    launch_type: NotRequired["capo_cloudwatch_events.types.launch_type.LaunchType"]
    ...
    network_configuration: NotRequired[
        "capo_cloudwatch_events.types.network_configuration.NetworkConfiguration"
    ]
    ...
    platform_version: NotRequired["capo_cloudwatch_events.types.string.String"]
    ...
    group: NotRequired["capo_cloudwatch_events.types.string.String"]
    """<p>Specifies an ECS task group for the task. The maximum length is 255 characters.</p>"""
    capacity_provider_strategy: NotRequired[
        "capo_cloudwatch_events.types.capacity_provider_strategy.CapacityProviderStrategy"
    ]
    ...
    enable_ecs_managed_tags: "capo_cloudwatch_events.types.boolean.Boolean"
    ...
    enable_execute_command: "capo_cloudwatch_events.types.boolean.Boolean"
    ...
    placement_constraints: NotRequired[
        "capo_cloudwatch_events.types.placement_constraints.PlacementConstraints"
    ]
    ...
    placement_strategy: NotRequired[
        "capo_cloudwatch_events.types.placement_strategies.PlacementStrategies"
    ]
    ...
    propagate_tags: NotRequired[
        "capo_cloudwatch_events.types.propagate_tags.PropagateTags"
    ]
    ...
    reference_id: NotRequired["capo_cloudwatch_events.types.reference_id.ReferenceId"]
...
def serialize_aws_json_1_1(value: EcsParameters) -> dict:
    ...
    if "launch_type" in value:
        ...
        out["LaunchType"] = (
            capo_cloudwatch_events.types.launch_type.serialize_aws_json_1_1(
                value["launch_type"]
            )
        )
    if "network_configuration" in value:
        ...
        out["NetworkConfiguration"] = (
            capo_cloudwatch_events.types.network_configuration.serialize_aws_json_1_1(
    ...
    if "capacity_provider_strategy" in value:
        ...
        out["CapacityProviderStrategy"] = (
            capo_cloudwatch_events.types.capacity_provider_strategy.serialize_aws_json_1_1(
    ...
    if "placement_constraints" in value:
        ...
        out["PlacementConstraints"] = (
            capo_cloudwatch_events.types.placement_constraints.serialize_aws_json_1_1(
    ...
    if "placement_strategy" in value:
        ...
        out["PlacementStrategy"] = (
            capo_cloudwatch_events.types.placement_strategies.serialize_aws_json_1_1(
    ...
    if "propagate_tags" in value:
        ...
        out["PropagateTags"] = (
            capo_cloudwatch_events.types.propagate_tags.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EcsParameters:
    ...
    if "LaunchType" in data:
        ...
        out["launch_type"] = (
            capo_cloudwatch_events.types.launch_type.deserialize_aws_json_1_1(
                data["LaunchType"]
            )
        )
    if "NetworkConfiguration" in data:
        ...
        out["network_configuration"] = (
            capo_cloudwatch_events.types.network_configuration.deserialize_aws_json_1_1(
    ...
    if "CapacityProviderStrategy" in data:
        ...
        out["capacity_provider_strategy"] = (
            capo_cloudwatch_events.types.capacity_provider_strategy.deserialize_aws_json_1_1(
    ...
    if "PlacementConstraints" in data:
        ...
        out["placement_constraints"] = (
            capo_cloudwatch_events.types.placement_constraints.deserialize_aws_json_1_1(
    ...
    if "PlacementStrategy" in data:
        ...
        out["placement_strategy"] = (
            capo_cloudwatch_events.types.placement_strategies.deserialize_aws_json_1_1(
    ...
    if "PropagateTags" in data:
        ...
        out["propagate_tags"] = (
            capo_cloudwatch_events.types.propagate_tags.deserialize_aws_json_1_1(
                data["PropagateTags"]
            )
        )
