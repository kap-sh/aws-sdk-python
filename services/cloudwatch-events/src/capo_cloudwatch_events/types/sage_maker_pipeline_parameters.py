...
if TYPE_CHECKING:
    import capo_cloudwatch_events.types.sage_maker_pipeline_parameter_list


class SageMakerPipelineParameters(TypedDict, closed=True):
    pipeline_parameter_list: NotRequired[
        "capo_cloudwatch_events.types.sage_maker_pipeline_parameter_list.SageMakerPipelineParameterList"
    ]
...
def serialize_aws_json_1_1(value: SageMakerPipelineParameters) -> dict:
    ...
    if "pipeline_parameter_list" in value:
        ...
        out["PipelineParameterList"] = (
            capo_cloudwatch_events.types.sage_maker_pipeline_parameter_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SageMakerPipelineParameters:
    ...
    if "PipelineParameterList" in data:
        ...
        out["pipeline_parameter_list"] = (
            capo_cloudwatch_events.types.sage_maker_pipeline_parameter_list.deserialize_aws_json_1_1(
