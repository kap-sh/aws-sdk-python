...
if TYPE_CHECKING:
    ...
    import capo_cloudwatch_events.types.header_value

HeaderParametersMap: TypeAlias = dict[
    "capo_cloudwatch_events.types.header_key.HeaderKey",
    "capo_cloudwatch_events.types.header_value.HeaderValue",
]
