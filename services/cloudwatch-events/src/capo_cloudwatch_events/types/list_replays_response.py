...
class ListReplaysResponse(TypedDict, closed=True):
    replays: NotRequired["capo_cloudwatch_events.types.replay_list.ReplayList"]
...
def serialize_aws_json_1_1(value: ListReplaysResponse) -> dict:
    ...
    if "replays" in value:
        ...
        out["Replays"] = (
            capo_cloudwatch_events.types.replay_list.serialize_aws_json_1_1(
                value["replays"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListReplaysResponse:
    ...
    if "Replays" in data:
        ...
        out["replays"] = (
            capo_cloudwatch_events.types.replay_list.deserialize_aws_json_1_1(
                data["Replays"]
            )
        )
