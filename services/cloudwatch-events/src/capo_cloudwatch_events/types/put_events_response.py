...
if TYPE_CHECKING:
    ...
    import capo_cloudwatch_events.types.put_events_result_entry_list
...
class PutEventsResponse(TypedDict, closed=True):
    ...
    entries: NotRequired[
        "capo_cloudwatch_events.types.put_events_result_entry_list.PutEventsResultEntryList"
    ]
...
def serialize_aws_json_1_1(value: PutEventsResponse) -> dict:
    ...
    if "entries" in value:
        ...
        out["Entries"] = (
            capo_cloudwatch_events.types.put_events_result_entry_list.serialize_aws_json_1_1(
                value["entries"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> PutEventsResponse:
    ...
    if "Entries" in data:
        ...
        out["entries"] = (
            capo_cloudwatch_events.types.put_events_result_entry_list.deserialize_aws_json_1_1(
                data["Entries"]
            )
        )
    return out
