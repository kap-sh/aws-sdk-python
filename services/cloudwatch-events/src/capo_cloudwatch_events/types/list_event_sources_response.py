...
if TYPE_CHECKING:
    import capo_cloudwatch_events.types.event_source_list
...
class ListEventSourcesResponse(TypedDict, closed=True):
    event_sources: NotRequired[
        "capo_cloudwatch_events.types.event_source_list.EventSourceList"
    ]
...
def serialize_aws_json_1_1(value: ListEventSourcesResponse) -> dict:
    ...
    if "event_sources" in value:
        ...
        out["EventSources"] = (
            capo_cloudwatch_events.types.event_source_list.serialize_aws_json_1_1(
                value["event_sources"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListEventSourcesResponse:
    ...
    if "EventSources" in data:
        ...
        out["event_sources"] = (
            capo_cloudwatch_events.types.event_source_list.deserialize_aws_json_1_1(
                data["EventSources"]
            )
        )
