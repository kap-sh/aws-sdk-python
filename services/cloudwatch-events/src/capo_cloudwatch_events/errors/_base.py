...
class CloudWatchEventsError(Exception):
    """Base class for all CloudWatchEvents service errors."""


class ServiceError(CloudWatchEventsError):
...
class SerializationError(CloudWatchEventsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudWatchEventsError):
...
class WaiterFailedError(CloudWatchEventsError):
...
class WaiterTimeoutError(CloudWatchEventsError):
