...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.delete_connection_response.DeleteConnectionResponse = capo_cloudwatch_events.types.delete_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.delete_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
