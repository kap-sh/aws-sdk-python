"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListApiDestinations``."""
...
import capo_cloudwatch_events.types.api_destination_response_list
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.list_api_destinations_response.ListApiDestinationsResponse = capo_cloudwatch_events.types.list_api_destinations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSEvents.ListApiDestinations"
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.list_api_destinations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_api_destinations(
