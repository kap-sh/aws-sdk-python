"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#UpdateApiDestination``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.update_api_destination_response.UpdateApiDestinationResponse = capo_cloudwatch_events.types.update_api_destination_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.update_api_destination_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
