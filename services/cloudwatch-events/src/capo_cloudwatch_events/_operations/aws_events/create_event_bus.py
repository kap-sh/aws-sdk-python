"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#CreateEventBus``."""
...
import capo_cloudwatch_events.errors.invalid_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidStateException":
            raise capo_cloudwatch_events.errors.invalid_state_exception.InvalidStateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.create_event_bus_response.CreateEventBusResponse = capo_cloudwatch_events.types.create_event_bus_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.create_event_bus_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_event_bus(
