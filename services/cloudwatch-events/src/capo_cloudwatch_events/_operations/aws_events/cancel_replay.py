...
import capo_cloudwatch_events.errors.illegal_status_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalStatusException":
            raise capo_cloudwatch_events.errors.illegal_status_exception.IllegalStatusException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.cancel_replay_response.CancelReplayResponse = (
        capo_cloudwatch_events.types.cancel_replay_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_cloudwatch_events._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.cancel_replay_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
