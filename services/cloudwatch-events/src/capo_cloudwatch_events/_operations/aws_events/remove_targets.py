...
import capo_cloudwatch_events.errors.managed_rule_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ManagedRuleException":
            raise capo_cloudwatch_events.errors.managed_rule_exception.ManagedRuleException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.remove_targets_response.RemoveTargetsResponse = (
        capo_cloudwatch_events.types.remove_targets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.remove_targets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
