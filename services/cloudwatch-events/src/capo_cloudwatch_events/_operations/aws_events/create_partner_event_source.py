"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#CreatePartnerEventSource``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.create_partner_event_source_response.CreatePartnerEventSourceResponse = capo_cloudwatch_events.types.create_partner_event_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.create_partner_event_source_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
