"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#DescribeReplay``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.describe_replay_response.DescribeReplayResponse = capo_cloudwatch_events.types.describe_replay_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSEvents.DescribeReplay"
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.describe_replay_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_replay(
