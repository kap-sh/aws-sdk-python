"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#DeleteArchive``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.delete_archive_response.DeleteArchiveResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.delete_archive_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
