...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.describe_rule_response.DescribeRuleResponse = (
        capo_cloudwatch_events.types.describe_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.describe_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
