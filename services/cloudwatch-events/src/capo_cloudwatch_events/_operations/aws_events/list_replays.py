...
import capo_cloudwatch_events.types.replay_list
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.list_replays_response.ListReplaysResponse = (
        capo_cloudwatch_events.types.list_replays_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.list_replays_request.serialize_aws_json_1_1(input_)
    ).encode()
