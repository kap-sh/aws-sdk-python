"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#PutPermission``."""
...
import capo_cloudwatch_events.errors.policy_length_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyLengthExceededException":
            raise capo_cloudwatch_events.errors.policy_length_exceeded_exception.PolicyLengthExceededException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.put_permission_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
