...
```
pip install aws-sdk-cloudwatch-events
```

## Usage

```python
from aws_sdk_cloudwatch_events import AsyncCloudWatchEventsClient
...
```python
from aws_sdk_cloudwatch_events import AsyncCloudWatchEventsClient
from aws_sdk_cloudwatch_events.error import ConcurrentModificationException
