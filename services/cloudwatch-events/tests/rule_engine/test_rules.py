import pytest
from aws_sdk_cloudwatch_events._rule_engine._endpoint_rule_set import EndpointParams, resolve
from aws_sdk_cloudwatch_events._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://events-fips.us-gov-east-1.api.aws'
