...
class NetworkFlowMonitorError(Exception):
    """Base class for all NetworkFlowMonitor service errors."""


class ServiceError(NetworkFlowMonitorError):
...
class SerializationError(NetworkFlowMonitorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(NetworkFlowMonitorError):
...
class WaiterFailedError(NetworkFlowMonitorError):
...
class WaiterTimeoutError(NetworkFlowMonitorError):
