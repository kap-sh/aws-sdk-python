...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.start_query_monitor_top_contributors_output.StartQueryMonitorTopContributorsOutput = capo_networkflowmonitor.types.start_query_monitor_top_contributors_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkflowmonitor.types.start_query_monitor_top_contributors_input.serialize_json(
            input_
        )
    ).encode()
