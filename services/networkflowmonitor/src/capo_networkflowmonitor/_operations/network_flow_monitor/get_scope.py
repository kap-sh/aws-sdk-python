"""Generated from Smithy shape ``com.amazonaws.networkflowmonitor#GetScope``."""
...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.get_scope_output.GetScopeOutput = (
        capo_networkflowmonitor.types.get_scope_output.deserialize_json(
...
def get_scope(
    ...
    capo_networkflowmonitor.types.get_scope_output.GetScopeOutput, zapros.Response
]:
