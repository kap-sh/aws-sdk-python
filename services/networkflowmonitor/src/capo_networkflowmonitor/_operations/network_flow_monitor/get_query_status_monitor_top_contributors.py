"""Generated from Smithy shape ``com.amazonaws.networkflowmonitor#GetQueryStatusMonitorTopContributors``."""
...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.get_query_status_monitor_top_contributors_output.GetQueryStatusMonitorTopContributorsOutput = capo_networkflowmonitor.types.get_query_status_monitor_top_contributors_output.deserialize_json(
...
async def async_get_query_status_monitor_top_contributors(
