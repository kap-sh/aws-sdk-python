"""Generated from Smithy shape ``com.amazonaws.networkflowmonitor#CreateMonitor``."""
...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.create_monitor_output.CreateMonitorOutput = (
        capo_networkflowmonitor.types.create_monitor_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkflowmonitor.types.create_monitor_input.serialize_json(input_)
    ).encode()
