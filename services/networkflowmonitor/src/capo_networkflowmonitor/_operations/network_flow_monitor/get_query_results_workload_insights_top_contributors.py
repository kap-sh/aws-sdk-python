"""Generated from Smithy shape ``com.amazonaws.networkflowmonitor#GetQueryResultsWorkloadInsightsTopContributors``."""
...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.get_query_results_workload_insights_top_contributors_output.GetQueryResultsWorkloadInsightsTopContributorsOutput = capo_networkflowmonitor.types.get_query_results_workload_insights_top_contributors_output.deserialize_json(
...
async def async_get_query_results_workload_insights_top_contributors(
