...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.start_query_workload_insights_top_contributors_data_output.StartQueryWorkloadInsightsTopContributorsDataOutput = capo_networkflowmonitor.types.start_query_workload_insights_top_contributors_data_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkflowmonitor.types.start_query_workload_insights_top_contributors_data_input.serialize_json(
            input_
        )
    ).encode()
