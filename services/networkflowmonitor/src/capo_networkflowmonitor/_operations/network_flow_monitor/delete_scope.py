...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.delete_scope_output.DeleteScopeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_scope(
    ...
    capo_networkflowmonitor.types.delete_scope_output.DeleteScopeOutput, zapros.Response
]:
