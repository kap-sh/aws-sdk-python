"""Generated from Smithy shape ``com.amazonaws.networkflowmonitor#GetQueryStatusWorkloadInsightsTopContributors``."""
...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.get_query_status_workload_insights_top_contributors_output.GetQueryStatusWorkloadInsightsTopContributorsOutput = capo_networkflowmonitor.types.get_query_status_workload_insights_top_contributors_output.deserialize_json(
...
async def async_get_query_status_workload_insights_top_contributors(
