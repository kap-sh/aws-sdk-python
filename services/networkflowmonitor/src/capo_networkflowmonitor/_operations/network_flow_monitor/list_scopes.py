"""Generated from Smithy shape ``com.amazonaws.networkflowmonitor#ListScopes``."""
...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.list_scopes_output.ListScopesOutput = (
        capo_networkflowmonitor.types.list_scopes_output.deserialize_json(
...
def list_scopes(
    ...
    capo_networkflowmonitor.types.list_scopes_output.ListScopesOutput, zapros.Response
]:
