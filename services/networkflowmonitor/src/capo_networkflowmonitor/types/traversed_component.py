...
if TYPE_CHECKING:
    ...
    import capo_networkflowmonitor.types.component
    import capo_networkflowmonitor.types.component_type


class TraversedComponent(TypedDict, closed=True):
    component_id: NotRequired["capo_networkflowmonitor.types.component.Component"]
    """<p>The identifier for the traversed component.</p>"""
    component_type: NotRequired[
        "capo_networkflowmonitor.types.component_type.ComponentType"
    ]
    """<p>The type of component that was traversed.</p>"""
    component_arn: NotRequired["capo_networkflowmonitor.types.arn.Arn"]
