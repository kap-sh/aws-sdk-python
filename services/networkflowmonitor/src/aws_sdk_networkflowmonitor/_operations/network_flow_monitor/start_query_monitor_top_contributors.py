...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.start_query_monitor_top_contributors_output.StartQueryMonitorTopContributorsOutput = aws_sdk_networkflowmonitor.types.start_query_monitor_top_contributors_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkflowmonitor.types.start_query_monitor_top_contributors_input.StartQueryMonitorTopContributorsInput,
) -> zapros.Request:
...
async def async_start_query_monitor_top_contributors(
