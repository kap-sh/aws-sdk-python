...
def build_request(
    ...
    input: aws_sdk_networkflowmonitor.types.create_monitor_input.CreateMonitorInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkflowmonitor.types.create_monitor_input.serialize_json(input)
    ).encode()
