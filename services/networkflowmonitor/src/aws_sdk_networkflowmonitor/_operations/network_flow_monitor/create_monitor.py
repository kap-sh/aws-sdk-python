...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.create_monitor_output.CreateMonitorOutput = (
        aws_sdk_networkflowmonitor.types.create_monitor_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkflowmonitor.types.create_monitor_input.CreateMonitorInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkflowmonitor.types.create_monitor_input.serialize_json(input_)
    ).encode()
