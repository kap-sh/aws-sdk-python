...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.list_monitors_output.ListMonitorsOutput = (
        aws_sdk_networkflowmonitor.types.list_monitors_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkflowmonitor.types.list_monitors_input.ListMonitorsInput,
) -> zapros.Request:
