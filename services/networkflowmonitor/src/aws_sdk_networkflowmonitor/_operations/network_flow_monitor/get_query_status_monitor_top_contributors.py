...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.get_query_status_monitor_top_contributors_output.GetQueryStatusMonitorTopContributorsOutput = aws_sdk_networkflowmonitor.types.get_query_status_monitor_top_contributors_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkflowmonitor.types.get_query_status_monitor_top_contributors_input.GetQueryStatusMonitorTopContributorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
