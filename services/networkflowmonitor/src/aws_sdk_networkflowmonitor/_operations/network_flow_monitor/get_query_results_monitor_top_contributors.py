...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            ...
            raise aws_sdk_networkflowmonitor.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.get_query_results_monitor_top_contributors_output.GetQueryResultsMonitorTopContributorsOutput = aws_sdk_networkflowmonitor.types.get_query_results_monitor_top_contributors_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkflowmonitor.types.get_query_results_monitor_top_contributors_input.GetQueryResultsMonitorTopContributorsInput,
) -> zapros.Request:
...
async def async_get_query_results_monitor_top_contributors(
