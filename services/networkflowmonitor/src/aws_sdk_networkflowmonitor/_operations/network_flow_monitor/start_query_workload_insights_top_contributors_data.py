...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.start_query_workload_insights_top_contributors_data_output.StartQueryWorkloadInsightsTopContributorsDataOutput = aws_sdk_networkflowmonitor.types.start_query_workload_insights_top_contributors_data_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkflowmonitor.types.start_query_workload_insights_top_contributors_data_input.StartQueryWorkloadInsightsTopContributorsDataInput,
) -> zapros.Request:
...
async def async_start_query_workload_insights_top_contributors_data(
