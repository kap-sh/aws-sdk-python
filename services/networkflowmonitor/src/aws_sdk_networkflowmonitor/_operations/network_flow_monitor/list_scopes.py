...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.list_scopes_output.ListScopesOutput = (
        aws_sdk_networkflowmonitor.types.list_scopes_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkflowmonitor.types.list_scopes_input.ListScopesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
