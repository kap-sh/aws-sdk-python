...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.get_query_status_workload_insights_top_contributors_output.GetQueryStatusWorkloadInsightsTopContributorsOutput = aws_sdk_networkflowmonitor.types.get_query_status_workload_insights_top_contributors_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkflowmonitor.types.get_query_status_workload_insights_top_contributors_input.GetQueryStatusWorkloadInsightsTopContributorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
