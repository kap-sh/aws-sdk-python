...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.get_scope_output.GetScopeOutput = (
        aws_sdk_networkflowmonitor.types.get_scope_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkflowmonitor.types.get_scope_input.GetScopeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_scope(
    ...
    aws_sdk_networkflowmonitor.types.get_scope_output.GetScopeOutput, zapros.Response
]:
