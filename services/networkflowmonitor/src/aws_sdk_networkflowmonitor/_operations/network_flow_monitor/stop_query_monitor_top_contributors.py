...
def build_request(
    ...
    input: aws_sdk_networkflowmonitor.types.stop_query_monitor_top_contributors_input.StopQueryMonitorTopContributorsInput,
) -> zapros.Request:
...
async def async_stop_query_monitor_top_contributors(
