...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.create_scope_output.CreateScopeOutput = (
        aws_sdk_networkflowmonitor.types.create_scope_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkflowmonitor.types.create_scope_input.CreateScopeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkflowmonitor.types.create_scope_input.serialize_json(input_)
    ).encode()
