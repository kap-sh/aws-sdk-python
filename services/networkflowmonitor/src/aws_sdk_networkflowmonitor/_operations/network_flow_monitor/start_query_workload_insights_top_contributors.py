...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.start_query_workload_insights_top_contributors_output.StartQueryWorkloadInsightsTopContributorsOutput = aws_sdk_networkflowmonitor.types.start_query_workload_insights_top_contributors_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkflowmonitor.types.start_query_workload_insights_top_contributors_input.StartQueryWorkloadInsightsTopContributorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkflowmonitor.types.start_query_workload_insights_top_contributors_input.serialize_json(
            input_
        )
    ).encode()
