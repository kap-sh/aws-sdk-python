...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.update_scope_output.UpdateScopeOutput = (
        aws_sdk_networkflowmonitor.types.update_scope_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkflowmonitor.types.update_scope_input.UpdateScopeInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkflowmonitor.types.update_scope_input.serialize_json(input)
    ).encode()
