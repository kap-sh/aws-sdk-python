...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.get_query_results_workload_insights_top_contributors_data_output.GetQueryResultsWorkloadInsightsTopContributorsDataOutput = aws_sdk_networkflowmonitor.types.get_query_results_workload_insights_top_contributors_data_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_networkflowmonitor.types.get_query_results_workload_insights_top_contributors_data_input.GetQueryResultsWorkloadInsightsTopContributorsDataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
