...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.get_monitor_output.GetMonitorOutput = (
        aws_sdk_networkflowmonitor.types.get_monitor_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkflowmonitor.types.get_monitor_input.GetMonitorInput,
) -> zapros.Request:
