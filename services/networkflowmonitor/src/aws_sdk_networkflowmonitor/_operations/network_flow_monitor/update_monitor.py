...
def build_request(
    ...
    input_: aws_sdk_networkflowmonitor.types.update_monitor_input.UpdateMonitorInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkflowmonitor.types.update_monitor_input.serialize_json(input_)
    ).encode()
