...
def handle_response(
    ...
    out: aws_sdk_networkflowmonitor.types.update_monitor_output.UpdateMonitorOutput = (
        aws_sdk_networkflowmonitor.types.update_monitor_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_networkflowmonitor.types.update_monitor_input.UpdateMonitorInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_networkflowmonitor.types.update_monitor_input.serialize_json(input)
    ).encode()
