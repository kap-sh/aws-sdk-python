...
from aws_sdk_networkflowmonitor._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_networkflowmonitor._async import anysleep
import time
...
class AsyncNetworkFlowMonitorClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, use_fips: bool | None = None, endpoint: str | None = None, region: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncNetworkFlowMonitorClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "use_fips": use_fips, "endpoint": endpoint, "region": region, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncNetworkFlowMonitorClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
    ...
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_networkflowmonitor.types.arn.Arn", *, config_overrides: Optional[AsyncNetworkFlowMonitorClientConfig] = None) -> "aws_sdk_networkflowmonitor.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        """<p>Returns all the tags for a resource.</p>

        Args:
            resource_arn: <p>The Amazon Resource Name (ARN) of the resource.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_networkflowmonitor.types.list_tags_for_resource_input.ListTagsForResourceInput]') -> AsyncOperationResponse["aws_sdk_networkflowmonitor.types.list_tags_for_resource_output.ListTagsForResourceOutput"]:
            import aws_sdk_networkflowmonitor._operations.network_flow_monitor.list_tags_for_resource
            output, http_response = await aws_sdk_networkflowmonitor._operations.network_flow_monitor.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
    ...
    async def tag_resource(self, resource_arn: "aws_sdk_networkflowmonitor.types.arn.Arn", tags: "aws_sdk_networkflowmonitor.types.tag_map.TagMap", *, config_overrides: Optional[AsyncNetworkFlowMonitorClientConfig] = None) -> "aws_sdk_networkflowmonitor.types.tag_resource_output.TagResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_networkflowmonitor.types.tag_resource_input.TagResourceInput]') -> AsyncOperationResponse["aws_sdk_networkflowmonitor.types.tag_resource_output.TagResourceOutput"]:
            import aws_sdk_networkflowmonitor._operations.network_flow_monitor.tag_resource
            output, http_response = await aws_sdk_networkflowmonitor._operations.network_flow_monitor.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_networkflowmonitor.types.arn.Arn", tag_keys: "aws_sdk_networkflowmonitor.types.tag_key_list.TagKeyList", *, config_overrides: Optional[AsyncNetworkFlowMonitorClientConfig] = None) -> "aws_sdk_networkflowmonitor.types.untag_resource_output.UntagResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_networkflowmonitor.types.untag_resource_input.UntagResourceInput]') -> AsyncOperationResponse["aws_sdk_networkflowmonitor.types.untag_resource_output.UntagResourceOutput"]:
            import aws_sdk_networkflowmonitor._operations.network_flow_monitor.untag_resource
            output, http_response = await aws_sdk_networkflowmonitor._operations.network_flow_monitor.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
