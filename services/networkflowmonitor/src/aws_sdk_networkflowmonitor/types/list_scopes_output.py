...
def serialize_json(value: ListScopesOutput) -> dict:
    out: dict = {}
    import aws_sdk_networkflowmonitor.types.scope_summary_list
    out["scopes"] = aws_sdk_networkflowmonitor.types.scope_summary_list.serialize_json(value["scopes"])
...
def deserialize_json(data: dict) -> ListScopesOutput:
    ...
    if "scopes" in data:
        import aws_sdk_networkflowmonitor.types.scope_summary_list
        out["scopes"] = aws_sdk_networkflowmonitor.types.scope_summary_list.deserialize_json(data["scopes"])
    else:
