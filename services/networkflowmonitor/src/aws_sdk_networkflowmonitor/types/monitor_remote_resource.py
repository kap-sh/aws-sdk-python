...
def serialize_json(value: MonitorRemoteResource) -> dict:
    out: dict = {}
    import aws_sdk_networkflowmonitor.types.monitor_remote_resource_type
    out["type"] = aws_sdk_networkflowmonitor.types.monitor_remote_resource_type.serialize_json(value["type"])
...
def deserialize_json(data: dict) -> MonitorRemoteResource:
    ...
    if "type" in data:
        import aws_sdk_networkflowmonitor.types.monitor_remote_resource_type
        out["type"] = aws_sdk_networkflowmonitor.types.monitor_remote_resource_type.deserialize_json(data["type"])
    else:
