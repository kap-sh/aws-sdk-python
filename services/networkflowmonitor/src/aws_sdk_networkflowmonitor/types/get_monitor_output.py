...
def serialize_json(value: GetMonitorOutput) -> dict:
    ...
    import aws_sdk_networkflowmonitor.types.monitor_status
    out["monitorStatus"] = aws_sdk_networkflowmonitor.types.monitor_status.serialize_json(value["monitor_status"])
    import aws_sdk_networkflowmonitor.types.monitor_local_resources
    ...
    import aws_sdk_networkflowmonitor.types.iso8601_timestamp
    out["createdAt"] = aws_sdk_networkflowmonitor.types.iso8601_timestamp.serialize_json(value["created_at"])
    import aws_sdk_networkflowmonitor.types.iso8601_timestamp
    out["modifiedAt"] = aws_sdk_networkflowmonitor.types.iso8601_timestamp.serialize_json(value["modified_at"])
    if "tags" in value:
        import aws_sdk_networkflowmonitor.types.tag_map
...
def deserialize_json(data: dict) -> GetMonitorOutput:
    ...
    if "monitorStatus" in data:
        import aws_sdk_networkflowmonitor.types.monitor_status
        out["monitor_status"] = aws_sdk_networkflowmonitor.types.monitor_status.deserialize_json(data["monitorStatus"])
    else:
    ...
    if "createdAt" in data:
        import aws_sdk_networkflowmonitor.types.iso8601_timestamp
        out["created_at"] = aws_sdk_networkflowmonitor.types.iso8601_timestamp.deserialize_json(data["createdAt"])
    else:
        raise DeserializationError("GetMonitorOutput.created_at required")
    if "modifiedAt" in data:
        import aws_sdk_networkflowmonitor.types.iso8601_timestamp
        out["modified_at"] = aws_sdk_networkflowmonitor.types.iso8601_timestamp.deserialize_json(data["modifiedAt"])
    else:
