...
class GetQueryResultsWorkloadInsightsTopContributorsOutput(TypedDict):
    top_contributors: NotRequired[
        "aws_sdk_networkflowmonitor.types.workload_insights_top_contributors_row_list.WorkloadInsightsTopContributorsRowList"
    ]
...
def serialize_json(value: GetQueryResultsWorkloadInsightsTopContributorsOutput) -> dict:
    ...
    if "top_contributors" in value:
        ...
        out["topContributors"] = (
            aws_sdk_networkflowmonitor.types.workload_insights_top_contributors_row_list.serialize_json(
...
def deserialize_json(
    ...
    if "topContributors" in data:
        ...
        out["top_contributors"] = (
            aws_sdk_networkflowmonitor.types.workload_insights_top_contributors_row_list.deserialize_json(
