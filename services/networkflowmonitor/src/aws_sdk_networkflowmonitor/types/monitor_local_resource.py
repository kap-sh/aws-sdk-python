...
def serialize_json(value: MonitorLocalResource) -> dict:
    out: dict = {}
    import aws_sdk_networkflowmonitor.types.monitor_local_resource_type
    out["type"] = aws_sdk_networkflowmonitor.types.monitor_local_resource_type.serialize_json(value["type"])
...
def deserialize_json(data: dict) -> MonitorLocalResource:
    ...
    if "type" in data:
        import aws_sdk_networkflowmonitor.types.monitor_local_resource_type
        out["type"] = aws_sdk_networkflowmonitor.types.monitor_local_resource_type.deserialize_json(data["type"])
    else:
