...
class MonitorTopContributorsRow(TypedDict):
    ...
    local_instance_id: NotRequired[
        "aws_sdk_networkflowmonitor.types.instance_id.InstanceId"
    ]
    ...
    traversed_constructs: NotRequired[
        "aws_sdk_networkflowmonitor.types.traversed_constructs_list.TraversedConstructsList"
    ]
    """<p>The constructs traversed by a network flow.</p>"""
    kubernetes_metadata: NotRequired[
        "aws_sdk_networkflowmonitor.types.kubernetes_metadata.KubernetesMetadata"
    ]
    """<p>Meta data about Kubernetes resources.</p>"""
    local_instance_arn: NotRequired[
        "aws_sdk_networkflowmonitor.types.instance_arn.InstanceArn"
    ]
...
def serialize_json(value: MonitorTopContributorsRow) -> dict:
    ...
    if "traversed_constructs" in value:
        ...
        out["traversedConstructs"] = (
            aws_sdk_networkflowmonitor.types.traversed_constructs_list.serialize_json(
    ...
    if "kubernetes_metadata" in value:
        ...
        out["kubernetesMetadata"] = (
            aws_sdk_networkflowmonitor.types.kubernetes_metadata.serialize_json(
...
def deserialize_json(data: dict) -> MonitorTopContributorsRow:
    ...
    if "traversedConstructs" in data:
        ...
        out["traversed_constructs"] = (
            aws_sdk_networkflowmonitor.types.traversed_constructs_list.deserialize_json(
    ...
    if "kubernetesMetadata" in data:
        ...
        out["kubernetes_metadata"] = (
            aws_sdk_networkflowmonitor.types.kubernetes_metadata.deserialize_json(
