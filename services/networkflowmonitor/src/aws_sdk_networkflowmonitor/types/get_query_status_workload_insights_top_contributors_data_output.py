...
class GetQueryStatusWorkloadInsightsTopContributorsDataOutput(TypedDict):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetQueryStatusWorkloadInsightsTopContributorsDataOutput) -> dict:
    out: dict = {}
    import aws_sdk_networkflowmonitor.types.query_status
...
def deserialize_json(data: dict) -> GetQueryStatusWorkloadInsightsTopContributorsDataOutput:
    ...
    if "status" in data:
        ...
        raise DeserializationError("GetQueryStatusWorkloadInsightsTopContributorsDataOutput.status required")
    return out