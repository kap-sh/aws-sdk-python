...
MonitorLocalResources: TypeAlias = list[
    "aws_sdk_networkflowmonitor.types.monitor_local_resource.MonitorLocalResource"
]
...
def serialize_json(value: MonitorLocalResources) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_networkflowmonitor.types.monitor_local_resource.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> MonitorLocalResources:
    ...
    for item in data:
        out.append(
            aws_sdk_networkflowmonitor.types.monitor_local_resource.deserialize_json(
                item
            )
        )
    return out
