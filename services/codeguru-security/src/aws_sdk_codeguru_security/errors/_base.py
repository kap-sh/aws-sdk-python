...
class CodeGuruSecurityError(Exception):
    """Base class for all CodeGuruSecurity service errors."""


class ServiceError(CodeGuruSecurityError):
...
class SerializationError(CodeGuruSecurityError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CodeGuruSecurityError):
...
class WaiterFailedError(CodeGuruSecurityError):
...
class WaiterTimeoutError(CodeGuruSecurityError):
