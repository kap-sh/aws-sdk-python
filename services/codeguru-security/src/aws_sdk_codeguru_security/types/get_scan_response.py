...
if TYPE_CHECKING:
    ...
    import aws_sdk_codeguru_security.types.error_message
...
class GetScanResponse(TypedDict):
    ...
    analysis_type: "aws_sdk_codeguru_security.types.analysis_type.AnalysisType"
    ...
    error_message: NotRequired[
        "aws_sdk_codeguru_security.types.error_message.ErrorMessage"
    ]
...
def serialize_json(value: GetScanResponse) -> dict:
    ...
    out["analysisType"] = aws_sdk_codeguru_security.types.analysis_type.serialize_json(
        value["analysis_type"]
    )
