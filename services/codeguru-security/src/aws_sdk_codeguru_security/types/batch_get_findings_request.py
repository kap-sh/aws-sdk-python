...
if TYPE_CHECKING:
    import aws_sdk_codeguru_security.types.finding_identifiers


class BatchGetFindingsRequest(TypedDict):
    finding_identifiers: (
        "aws_sdk_codeguru_security.types.finding_identifiers.FindingIdentifiers"
    )
...
def serialize_json(value: BatchGetFindingsRequest) -> dict:
    ...
    out["findingIdentifiers"] = (
        aws_sdk_codeguru_security.types.finding_identifiers.serialize_json(
...
def deserialize_json(data: dict) -> BatchGetFindingsRequest:
    ...
    if "findingIdentifiers" in data:
        ...
        out["finding_identifiers"] = (
            aws_sdk_codeguru_security.types.finding_identifiers.deserialize_json(
