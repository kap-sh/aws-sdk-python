...
from ._services.async_personalize import (
    AsyncPersonalizeClient as AsyncPersonalizeClient,
)
from ._services.personalize import PersonalizeClient as PersonalizeClient
