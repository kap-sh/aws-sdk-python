"""Generated from Smithy shape ``com.amazonaws.personalize#DatasetSchemaSummary``."""
...
class DatasetSchemaSummary(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DatasetSchemaSummary) -> dict:
    out: dict = {}
    if "name" in value:
        out["name"] = value["name"]
...
def deserialize_aws_json_1_1(data: dict) -> DatasetSchemaSummary:
    out: DatasetSchemaSummary = {}  # type: ignore[typeddict-item]
    if "name" in data:
        out["name"] = data["name"]
