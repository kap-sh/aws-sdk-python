...
if TYPE_CHECKING:
    ...
    import aws_sdk_personalize.types.training_hours
    import aws_sdk_personalize.types.training_mode
    import aws_sdk_personalize.types.training_type
    import aws_sdk_personalize.types.tuned_hpo_params


class SolutionVersion(TypedDict):
    ...
    training_hours: NotRequired[
        "aws_sdk_personalize.types.training_hours.TrainingHours"
    ]
    ...
    tuned_hpo_params: NotRequired[
        "aws_sdk_personalize.types.tuned_hpo_params.TunedHPOParams"
    ]
    ...
    training_type: NotRequired["aws_sdk_personalize.types.training_type.TrainingType"]
...
def serialize_aws_json_1_1(value: SolutionVersion) -> dict:
    ...
    if "tuned_hpo_params" in value:
        ...
        out["tunedHPOParams"] = (
            aws_sdk_personalize.types.tuned_hpo_params.serialize_aws_json_1_1(
    ...
    if "training_type" in value:
        ...
        out["trainingType"] = (
            aws_sdk_personalize.types.training_type.serialize_aws_json_1_1(
                value["training_type"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> SolutionVersion:
    ...
    if "tunedHPOParams" in data:
        ...
        out["tuned_hpo_params"] = (
            aws_sdk_personalize.types.tuned_hpo_params.deserialize_aws_json_1_1(
                data["tunedHPOParams"]
            )
        )
    if "status" in data:
    ...
    if "trainingType" in data:
        ...
        out["training_type"] = (
            aws_sdk_personalize.types.training_type.deserialize_aws_json_1_1(
                data["trainingType"]
            )
        )
    return out
