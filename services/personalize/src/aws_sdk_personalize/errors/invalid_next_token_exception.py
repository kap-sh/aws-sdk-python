"""Generated from Smithy shape ``com.amazonaws.personalize#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.personalize#InvalidNextTokenException``."""
