...
class PersonalizeError(Exception):
    """Base class for all Personalize service errors."""


class ServiceError(PersonalizeError):
...
class SerializationError(PersonalizeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PersonalizeError):
...
class WaiterFailedError(PersonalizeError):
...
class WaiterTimeoutError(PersonalizeError):
