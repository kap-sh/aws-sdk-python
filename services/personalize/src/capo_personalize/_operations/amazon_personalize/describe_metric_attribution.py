"""Generated from Smithy shape ``com.amazonaws.personalize#DescribeMetricAttribution``."""
...
def handle_response(
    ...
    out: capo_personalize.types.describe_metric_attribution_response.DescribeMetricAttributionResponse = capo_personalize.types.describe_metric_attribution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.DescribeMetricAttribution"
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_metric_attribution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_metric_attribution(
