...
def handle_response(
    ...
    out: capo_personalize.types.update_solution_response.UpdateSolutionResponse = (
        capo_personalize.types.update_solution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.update_solution_request.serialize_aws_json_1_1(input_)
    ).encode()
