"""Generated from Smithy shape ``com.amazonaws.personalize#GetSolutionMetrics``."""
...
def handle_response(
    ...
    out: capo_personalize.types.get_solution_metrics_response.GetSolutionMetricsResponse = capo_personalize.types.get_solution_metrics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.get_solution_metrics_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_solution_metrics(
