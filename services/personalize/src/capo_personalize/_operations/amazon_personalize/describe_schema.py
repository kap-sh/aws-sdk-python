...
import capo_personalize.types.dataset_schema
...
def handle_response(
    ...
    out: capo_personalize.types.describe_schema_response.DescribeSchemaResponse = (
        capo_personalize.types.describe_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_schema_request.serialize_aws_json_1_1(input_)
    ).encode()
