"""Generated from Smithy shape ``com.amazonaws.personalize#DescribeDatasetExportJob``."""
...
def handle_response(
    ...
    out: capo_personalize.types.describe_dataset_export_job_response.DescribeDatasetExportJobResponse = capo_personalize.types.describe_dataset_export_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.DescribeDatasetExportJob"
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_dataset_export_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_dataset_export_job(
