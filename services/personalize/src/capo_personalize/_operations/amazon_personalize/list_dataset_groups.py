"""Generated from Smithy shape ``com.amazonaws.personalize#ListDatasetGroups``."""
...
def handle_response(
    ...
    out: capo_personalize.types.list_dataset_groups_response.ListDatasetGroupsResponse = capo_personalize.types.list_dataset_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.list_dataset_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
