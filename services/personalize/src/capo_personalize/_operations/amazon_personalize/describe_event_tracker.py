...
def handle_response(
    ...
    out: capo_personalize.types.describe_event_tracker_response.DescribeEventTrackerResponse = capo_personalize.types.describe_event_tracker_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_event_tracker_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
