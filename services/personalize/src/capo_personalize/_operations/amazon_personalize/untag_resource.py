...
import capo_personalize.errors.too_many_tag_keys_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagKeysException":
            raise capo_personalize.errors.too_many_tag_keys_exception.TooManyTagKeysException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_personalize.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
