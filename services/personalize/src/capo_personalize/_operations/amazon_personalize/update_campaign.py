...
def handle_response(
    ...
    out: capo_personalize.types.update_campaign_response.UpdateCampaignResponse = (
        capo_personalize.types.update_campaign_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.update_campaign_request.serialize_aws_json_1_1(input_)
    ).encode()
