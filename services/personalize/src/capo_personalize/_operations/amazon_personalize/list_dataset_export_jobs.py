"""Generated from Smithy shape ``com.amazonaws.personalize#ListDatasetExportJobs``."""
...
import capo_personalize.types.dataset_export_jobs
...
def handle_response(
    ...
    out: capo_personalize.types.list_dataset_export_jobs_response.ListDatasetExportJobsResponse = capo_personalize.types.list_dataset_export_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.ListDatasetExportJobs"
    body: bytes | None = json.dumps(
        capo_personalize.types.list_dataset_export_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_dataset_export_jobs(
