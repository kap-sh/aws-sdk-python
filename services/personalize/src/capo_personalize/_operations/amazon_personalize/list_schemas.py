...
def handle_response(
    ...
    out: capo_personalize.types.list_schemas_response.ListSchemasResponse = (
        capo_personalize.types.list_schemas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.list_schemas_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_schemas(
    ...
    capo_personalize.types.list_schemas_response.ListSchemasResponse, zapros.Response
]:
