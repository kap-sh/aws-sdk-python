...
def handle_response(
    ...
    out: capo_personalize.types.create_schema_response.CreateSchemaResponse = (
        capo_personalize.types.create_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.create_schema_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_schema(
    ...
    capo_personalize.types.create_schema_response.CreateSchemaResponse, zapros.Response
]:
