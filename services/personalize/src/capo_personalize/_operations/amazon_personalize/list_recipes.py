...
def handle_response(
    ...
    out: capo_personalize.types.list_recipes_response.ListRecipesResponse = (
        capo_personalize.types.list_recipes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.list_recipes_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_recipes(
    ...
    capo_personalize.types.list_recipes_response.ListRecipesResponse, zapros.Response
]:
