"""Generated from Smithy shape ``com.amazonaws.personalize#CreateSolutionVersion``."""
...
def handle_response(
    ...
    out: capo_personalize.types.create_solution_version_response.CreateSolutionVersionResponse = capo_personalize.types.create_solution_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.create_solution_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_solution_version(
