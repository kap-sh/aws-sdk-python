"""Generated from Smithy shape ``com.amazonaws.personalize#DescribeFilter``."""
...
def handle_response(
    ...
    out: capo_personalize.types.describe_filter_response.DescribeFilterResponse = (
        capo_personalize.types.describe_filter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.DescribeFilter"
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_filter_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_filter(
