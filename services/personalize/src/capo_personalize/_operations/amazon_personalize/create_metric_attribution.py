"""Generated from Smithy shape ``com.amazonaws.personalize#CreateMetricAttribution``."""
...
def handle_response(
    ...
    out: capo_personalize.types.create_metric_attribution_response.CreateMetricAttributionResponse = capo_personalize.types.create_metric_attribution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.CreateMetricAttribution"
    body: bytes | None = json.dumps(
        capo_personalize.types.create_metric_attribution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_metric_attribution(
