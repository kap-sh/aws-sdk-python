"""Generated from Smithy shape ``com.amazonaws.personalize#DeleteFilter``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.DeleteFilter"
    body: bytes | None = json.dumps(
        capo_personalize.types.delete_filter_request.serialize_aws_json_1_1(input_)
    ).encode()
