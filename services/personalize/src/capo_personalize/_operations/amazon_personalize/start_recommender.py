"""Generated from Smithy shape ``com.amazonaws.personalize#StartRecommender``."""
...
def handle_response(
    ...
    out: capo_personalize.types.start_recommender_response.StartRecommenderResponse = (
        capo_personalize.types.start_recommender_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.StartRecommender"
    body: bytes | None = json.dumps(
        capo_personalize.types.start_recommender_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_start_recommender(
