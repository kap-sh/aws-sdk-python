...
def handle_response(
    ...
    out: capo_personalize.types.create_dataset_import_job_response.CreateDatasetImportJobResponse = capo_personalize.types.create_dataset_import_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.create_dataset_import_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
