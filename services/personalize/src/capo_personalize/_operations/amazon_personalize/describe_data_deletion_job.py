"""Generated from Smithy shape ``com.amazonaws.personalize#DescribeDataDeletionJob``."""
...
def handle_response(
    ...
    out: capo_personalize.types.describe_data_deletion_job_response.DescribeDataDeletionJobResponse = capo_personalize.types.describe_data_deletion_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.DescribeDataDeletionJob"
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_data_deletion_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_data_deletion_job(
