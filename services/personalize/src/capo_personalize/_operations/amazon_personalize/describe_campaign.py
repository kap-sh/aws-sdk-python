"""Generated from Smithy shape ``com.amazonaws.personalize#DescribeCampaign``."""
...
def handle_response(
    ...
    out: capo_personalize.types.describe_campaign_response.DescribeCampaignResponse = (
        capo_personalize.types.describe_campaign_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_campaign_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_campaign(
