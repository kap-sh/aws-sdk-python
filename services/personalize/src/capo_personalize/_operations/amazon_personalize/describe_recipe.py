"""Generated from Smithy shape ``com.amazonaws.personalize#DescribeRecipe``."""
...
def handle_response(
    ...
    out: capo_personalize.types.describe_recipe_response.DescribeRecipeResponse = (
        capo_personalize.types.describe_recipe_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_recipe_request.serialize_aws_json_1_1(input_)
    ).encode()
