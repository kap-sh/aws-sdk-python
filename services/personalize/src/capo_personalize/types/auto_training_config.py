...
if TYPE_CHECKING:
    import capo_personalize.types.scheduling_expression


class AutoTrainingConfig(TypedDict, closed=True):
    scheduling_expression: NotRequired[
        "capo_personalize.types.scheduling_expression.SchedulingExpression"
    ]
