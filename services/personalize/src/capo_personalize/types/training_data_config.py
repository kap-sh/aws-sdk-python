...
class TrainingDataConfig(TypedDict, closed=True):
    excluded_dataset_columns: NotRequired[
        "capo_personalize.types.excluded_dataset_columns.ExcludedDatasetColumns"
    ]
    ...
    included_dataset_columns: NotRequired[
        "capo_personalize.types.included_dataset_columns.IncludedDatasetColumns"
    ]
...
def serialize_aws_json_1_1(value: TrainingDataConfig) -> dict:
    ...
    if "excluded_dataset_columns" in value:
        ...
        out["excludedDatasetColumns"] = (
            capo_personalize.types.excluded_dataset_columns.serialize_aws_json_1_1(
    ...
    if "included_dataset_columns" in value:
        ...
        out["includedDatasetColumns"] = (
            capo_personalize.types.included_dataset_columns.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TrainingDataConfig:
    ...
    if "excludedDatasetColumns" in data:
        ...
        out["excluded_dataset_columns"] = (
            capo_personalize.types.excluded_dataset_columns.deserialize_aws_json_1_1(
    ...
    if "includedDatasetColumns" in data:
        ...
        out["included_dataset_columns"] = (
            capo_personalize.types.included_dataset_columns.deserialize_aws_json_1_1(
