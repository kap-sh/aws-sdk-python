...
class ListEventTrackersResponse(TypedDict, closed=True):
    event_trackers: NotRequired["capo_personalize.types.event_trackers.EventTrackers"]
...
def serialize_aws_json_1_1(value: ListEventTrackersResponse) -> dict:
    ...
    if "event_trackers" in value:
        ...
        out["eventTrackers"] = (
            capo_personalize.types.event_trackers.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListEventTrackersResponse:
    ...
    if "eventTrackers" in data:
        ...
        out["event_trackers"] = (
            capo_personalize.types.event_trackers.deserialize_aws_json_1_1(
                data["eventTrackers"]
            )
        )
