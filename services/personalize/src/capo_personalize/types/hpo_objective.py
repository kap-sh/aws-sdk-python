...
if TYPE_CHECKING:
    import capo_personalize.types.hpo_objective_type
    import capo_personalize.types.metric_name
    import capo_personalize.types.metric_regex


class HPOObjective(TypedDict, closed=True):
    type: NotRequired["capo_personalize.types.hpo_objective_type.HPOObjectiveType"]
    """<p>The type of the metric. Valid values are <code>Maximize</code> and <code>Minimize</code>.</p>"""
    metric_name: NotRequired["capo_personalize.types.metric_name.MetricName"]
    """<p>The name of the metric.</p>"""
    metric_regex: NotRequired["capo_personalize.types.metric_regex.MetricRegex"]
