...
if TYPE_CHECKING:
    import capo_personalize.types.campaigns
    import capo_personalize.types.next_token


class ListCampaignsResponse(TypedDict, closed=True):
    campaigns: NotRequired["capo_personalize.types.campaigns.Campaigns"]
...
def serialize_aws_json_1_1(value: ListCampaignsResponse) -> dict:
    ...
    if "campaigns" in value:
        ...
        out["campaigns"] = capo_personalize.types.campaigns.serialize_aws_json_1_1(
            value["campaigns"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListCampaignsResponse:
    ...
    if "campaigns" in data:
        ...
        out["campaigns"] = capo_personalize.types.campaigns.deserialize_aws_json_1_1(
            data["campaigns"]
        )
