"""Generated from Smithy shape ``com.amazonaws.personalize#ListFiltersRequest``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListFiltersRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListFiltersRequest:
