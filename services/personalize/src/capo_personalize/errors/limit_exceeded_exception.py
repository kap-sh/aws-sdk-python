"""Generated from Smithy shape ``com.amazonaws.personalize#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.personalize#LimitExceededException``."""
