"""Generated from Smithy shape ``com.amazonaws.personalize#ResourceAlreadyExistsException``."""
...
class ResourceAlreadyExistsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.personalize#ResourceAlreadyExistsException``."""
