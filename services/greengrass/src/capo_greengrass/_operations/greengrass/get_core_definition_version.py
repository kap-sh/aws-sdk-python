"""Generated from Smithy shape ``com.amazonaws.greengrass#GetCoreDefinitionVersion``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_core_definition_version_response.GetCoreDefinitionVersionResponse = capo_greengrass.types.get_core_definition_version_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["core_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_core_definition_version(
