"""Generated from Smithy shape ``com.amazonaws.greengrass#ListDeployments``."""
...
import capo_greengrass.types.deployments
...
def handle_response(
    ...
    out: capo_greengrass.types.list_deployments_response.ListDeploymentsResponse = (
        capo_greengrass.types.list_deployments_response.deserialize_json(
