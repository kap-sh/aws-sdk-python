...
def handle_response(
    ...
    out: capo_greengrass.types.get_thing_runtime_configuration_response.GetThingRuntimeConfigurationResponse = capo_greengrass.types.get_thing_runtime_configuration_response.deserialize_json(
