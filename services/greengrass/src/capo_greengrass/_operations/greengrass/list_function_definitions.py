"""Generated from Smithy shape ``com.amazonaws.greengrass#ListFunctionDefinitions``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.list_function_definitions_response.ListFunctionDefinitionsResponse = capo_greengrass.types.list_function_definitions_response.deserialize_json(
...
async def async_list_function_definitions(
