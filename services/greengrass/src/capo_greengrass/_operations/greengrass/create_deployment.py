"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateDeployment``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.create_deployment_response.CreateDeploymentResponse = (
        capo_greengrass.types.create_deployment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/groups/{GroupId}/deployments"
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_deployment_request.serialize_json(input_)
    ).encode()
