...
def handle_response(
    ...
    out: capo_greengrass.types.create_resource_definition_response.CreateResourceDefinitionResponse = capo_greengrass.types.create_resource_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_resource_definition_request.serialize_json(input_)
    ).encode()
