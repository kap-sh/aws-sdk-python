"""Generated from Smithy shape ``com.amazonaws.greengrass#AssociateServiceRoleToAccount``."""
...
import capo_greengrass.errors.internal_server_error_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalServerErrorException":
            raise capo_greengrass.errors.internal_server_error_exception.InternalServerErrorException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_greengrass.types.associate_service_role_to_account_response.AssociateServiceRoleToAccountResponse = capo_greengrass.types.associate_service_role_to_account_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.associate_service_role_to_account_request.serialize_json(
            input_
        )
    ).encode()
