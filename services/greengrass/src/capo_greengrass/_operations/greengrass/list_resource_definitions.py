...
def handle_response(
    ...
    out: capo_greengrass.types.list_resource_definitions_response.ListResourceDefinitionsResponse = capo_greengrass.types.list_resource_definitions_response.deserialize_json(
