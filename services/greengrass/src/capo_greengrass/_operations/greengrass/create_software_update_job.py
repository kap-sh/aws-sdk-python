"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateSoftwareUpdateJob``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.create_software_update_job_response.CreateSoftwareUpdateJobResponse = capo_greengrass.types.create_software_update_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_software_update_job_request.serialize_json(input_)
    ).encode()
