"""Generated from Smithy shape ``com.amazonaws.greengrass#UpdateThingRuntimeConfiguration``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.update_thing_runtime_configuration_response.UpdateThingRuntimeConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.update_thing_runtime_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_thing_runtime_configuration(
