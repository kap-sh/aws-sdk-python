...
def handle_response(
    ...
    out: capo_greengrass.types.get_subscription_definition_response.GetSubscriptionDefinitionResponse = capo_greengrass.types.get_subscription_definition_response.deserialize_json(
