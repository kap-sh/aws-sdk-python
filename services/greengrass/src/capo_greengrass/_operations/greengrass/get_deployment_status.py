"""Generated from Smithy shape ``com.amazonaws.greengrass#GetDeploymentStatus``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_deployment_status_response.GetDeploymentStatusResponse = capo_greengrass.types.get_deployment_status_response.deserialize_json(
