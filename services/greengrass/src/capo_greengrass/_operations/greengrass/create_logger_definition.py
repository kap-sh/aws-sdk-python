"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateLoggerDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.create_logger_definition_response.CreateLoggerDefinitionResponse = capo_greengrass.types.create_logger_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_logger_definition_request.serialize_json(input_)
    ).encode()
...
async def async_create_logger_definition(
