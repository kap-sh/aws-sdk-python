"""Generated from Smithy shape ``com.amazonaws.greengrass#UpdateResourceDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.update_resource_definition_response.UpdateResourceDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.update_resource_definition_request.serialize_json(input_)
    ).encode()
...
async def async_update_resource_definition(
