...
def handle_response(
    ...
    out: capo_greengrass.types.create_device_definition_version_response.CreateDeviceDefinitionVersionResponse = capo_greengrass.types.create_device_definition_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_device_definition_version_request.serialize_json(
            input_
        )
    ).encode()
