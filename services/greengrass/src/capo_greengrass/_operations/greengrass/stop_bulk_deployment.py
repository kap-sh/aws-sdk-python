"""Generated from Smithy shape ``com.amazonaws.greengrass#StopBulkDeployment``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.stop_bulk_deployment_response.StopBulkDeploymentResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_stop_bulk_deployment(
