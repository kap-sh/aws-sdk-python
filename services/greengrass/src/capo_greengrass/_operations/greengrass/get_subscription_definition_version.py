...
def handle_response(
    ...
    out: capo_greengrass.types.get_subscription_definition_version_response.GetSubscriptionDefinitionVersionResponse = capo_greengrass.types.get_subscription_definition_version_response.deserialize_json(
