...
def handle_response(
    ...
    out: capo_greengrass.types.list_subscription_definitions_response.ListSubscriptionDefinitionsResponse = capo_greengrass.types.list_subscription_definitions_response.deserialize_json(
