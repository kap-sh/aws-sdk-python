"""Generated from Smithy shape ``com.amazonaws.greengrass#DeleteResourceDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.delete_resource_definition_response.DeleteResourceDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_resource_definition(
