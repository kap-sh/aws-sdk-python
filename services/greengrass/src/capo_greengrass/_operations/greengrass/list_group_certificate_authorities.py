"""Generated from Smithy shape ``com.amazonaws.greengrass#ListGroupCertificateAuthorities``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.list_group_certificate_authorities_response.ListGroupCertificateAuthoritiesResponse = capo_greengrass.types.list_group_certificate_authorities_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/greengrass/groups/{GroupId}/certificateauthorities"
    )
...
async def async_list_group_certificate_authorities(
