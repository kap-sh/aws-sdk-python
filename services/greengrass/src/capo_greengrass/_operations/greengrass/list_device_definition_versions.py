"""Generated from Smithy shape ``com.amazonaws.greengrass#ListDeviceDefinitionVersions``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.list_device_definition_versions_response.ListDeviceDefinitionVersionsResponse = capo_greengrass.types.list_device_definition_versions_response.deserialize_json(
...
async def async_list_device_definition_versions(
