...
def handle_response(
    ...
    out: capo_greengrass.types.list_function_definition_versions_response.ListFunctionDefinitionVersionsResponse = capo_greengrass.types.list_function_definition_versions_response.deserialize_json(
