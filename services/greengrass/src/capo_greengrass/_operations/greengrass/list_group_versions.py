"""Generated from Smithy shape ``com.amazonaws.greengrass#ListGroupVersions``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.list_group_versions_response.ListGroupVersionsResponse = capo_greengrass.types.list_group_versions_response.deserialize_json(
...
async def async_list_group_versions(
