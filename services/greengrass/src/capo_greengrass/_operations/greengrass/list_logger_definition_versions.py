...
def handle_response(
    ...
    out: capo_greengrass.types.list_logger_definition_versions_response.ListLoggerDefinitionVersionsResponse = capo_greengrass.types.list_logger_definition_versions_response.deserialize_json(
