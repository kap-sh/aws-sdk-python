...
def handle_response(
    ...
    out: capo_greengrass.types.get_resource_definition_version_response.GetResourceDefinitionVersionResponse = capo_greengrass.types.get_resource_definition_version_response.deserialize_json(
