"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateGroupVersion``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.create_group_version_response.CreateGroupVersionResponse = capo_greengrass.types.create_group_version_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/groups/{GroupId}/versions"
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_group_version_request.serialize_json(input_)
    ).encode()
...
async def async_create_group_version(
