"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateGroup``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.create_group_response.CreateGroupResponse = (
        capo_greengrass.types.create_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_group_request.serialize_json(input_)
    ).encode()
...
def create_group(
    ...
    capo_greengrass.types.create_group_response.CreateGroupResponse, zapros.Response
]:
