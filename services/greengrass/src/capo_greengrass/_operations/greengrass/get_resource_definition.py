"""Generated from Smithy shape ``com.amazonaws.greengrass#GetResourceDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_resource_definition_response.GetResourceDefinitionResponse = capo_greengrass.types.get_resource_definition_response.deserialize_json(
...
async def async_get_resource_definition(
