"""Generated from Smithy shape ``com.amazonaws.greengrass#GetFunctionDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_function_definition_response.GetFunctionDefinitionResponse = capo_greengrass.types.get_function_definition_response.deserialize_json(
...
async def async_get_function_definition(
