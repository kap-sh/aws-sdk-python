...
def handle_response(
    ...
    out: capo_greengrass.types.list_logger_definitions_response.ListLoggerDefinitionsResponse = capo_greengrass.types.list_logger_definitions_response.deserialize_json(
