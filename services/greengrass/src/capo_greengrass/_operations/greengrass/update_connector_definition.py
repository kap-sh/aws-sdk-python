"""Generated from Smithy shape ``com.amazonaws.greengrass#UpdateConnectorDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.update_connector_definition_response.UpdateConnectorDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.update_connector_definition_request.serialize_json(input_)
    ).encode()
...
async def async_update_connector_definition(
