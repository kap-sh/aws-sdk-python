...
def handle_response(
    ...
    out: capo_greengrass.types.list_core_definition_versions_response.ListCoreDefinitionVersionsResponse = capo_greengrass.types.list_core_definition_versions_response.deserialize_json(
