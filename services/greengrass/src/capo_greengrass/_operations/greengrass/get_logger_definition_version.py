...
def handle_response(
    ...
    out: capo_greengrass.types.get_logger_definition_version_response.GetLoggerDefinitionVersionResponse = capo_greengrass.types.get_logger_definition_version_response.deserialize_json(
