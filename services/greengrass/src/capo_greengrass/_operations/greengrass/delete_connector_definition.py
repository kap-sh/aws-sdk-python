"""Generated from Smithy shape ``com.amazonaws.greengrass#DeleteConnectorDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.delete_connector_definition_response.DeleteConnectorDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_connector_definition(
