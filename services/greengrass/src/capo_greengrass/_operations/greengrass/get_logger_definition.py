"""Generated from Smithy shape ``com.amazonaws.greengrass#GetLoggerDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_logger_definition_response.GetLoggerDefinitionResponse = capo_greengrass.types.get_logger_definition_response.deserialize_json(
...
async def async_get_logger_definition(
