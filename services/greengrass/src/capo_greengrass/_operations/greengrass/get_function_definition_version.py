...
def handle_response(
    ...
    out: capo_greengrass.types.get_function_definition_version_response.GetFunctionDefinitionVersionResponse = capo_greengrass.types.get_function_definition_version_response.deserialize_json(
