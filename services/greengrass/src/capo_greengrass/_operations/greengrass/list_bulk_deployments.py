"""Generated from Smithy shape ``com.amazonaws.greengrass#ListBulkDeployments``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.list_bulk_deployments_response.ListBulkDeploymentsResponse = capo_greengrass.types.list_bulk_deployments_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/bulk/deployments"
    params: dict[str, str] = {}
...
async def async_list_bulk_deployments(
