"""Generated from Smithy shape ``com.amazonaws.greengrass#GetFunctionDefinitionResponse``."""
...
class GetFunctionDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetFunctionDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> GetFunctionDefinitionResponse:
    out: GetFunctionDefinitionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
