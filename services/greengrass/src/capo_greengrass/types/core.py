...
class Core(TypedDict, closed=True):
    certificate_arn: NotRequired["capo_greengrass.types.__string.__string"]
    """The ARN of the certificate associated with the core."""
    id: NotRequired["capo_greengrass.types.__string.__string"]
    """A descriptive or arbitrary ID for the core. This value must be unique within the core definition version. Max length is 128 characters with pattern ''[a-zA-Z0-9:_-]+''."""
    sync_shadow: NotRequired["capo_greengrass.types.__boolean.__boolean"]
    """If true, the core's local shadow is automatically synced with the cloud."""
    thing_arn: NotRequired["capo_greengrass.types.__string.__string"]
