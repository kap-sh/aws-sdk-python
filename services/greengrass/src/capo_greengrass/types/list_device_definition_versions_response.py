"""Generated from Smithy shape ``com.amazonaws.greengrass#ListDeviceDefinitionVersionsResponse``."""
...
class ListDeviceDefinitionVersionsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListDeviceDefinitionVersionsResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListDeviceDefinitionVersionsResponse:
    out: ListDeviceDefinitionVersionsResponse = {}  # type: ignore[typeddict-item]
