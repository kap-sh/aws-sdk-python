...
class CreateSoftwareUpdateJobResponse(TypedDict, closed=True):
    iot_job_arn: NotRequired["capo_greengrass.types.__string.__string"]
    """The IoT Job ARN corresponding to this update."""
    iot_job_id: NotRequired["capo_greengrass.types.__string.__string"]
    """The IoT Job Id corresponding to this update."""
    platform_software_version: NotRequired["capo_greengrass.types.__string.__string"]
