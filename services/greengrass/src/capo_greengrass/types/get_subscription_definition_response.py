"""Generated from Smithy shape ``com.amazonaws.greengrass#GetSubscriptionDefinitionResponse``."""
...
class GetSubscriptionDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetSubscriptionDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> GetSubscriptionDefinitionResponse:
    out: GetSubscriptionDefinitionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
