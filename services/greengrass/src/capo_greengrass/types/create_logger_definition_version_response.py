"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateLoggerDefinitionVersionResponse``."""
...
class CreateLoggerDefinitionVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateLoggerDefinitionVersionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateLoggerDefinitionVersionResponse:
    out: CreateLoggerDefinitionVersionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
