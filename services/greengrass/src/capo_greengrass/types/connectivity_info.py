...
class ConnectivityInfo(TypedDict, closed=True):
    host_address: NotRequired["capo_greengrass.types.__string.__string"]
    """The endpoint for the Greengrass core. Can be an IP address or DNS."""
    id: NotRequired["capo_greengrass.types.__string.__string"]
    """The ID of the connectivity information."""
    metadata: NotRequired["capo_greengrass.types.__string.__string"]
    """Metadata for this endpoint."""
    port_number: NotRequired["capo_greengrass.types.__integer.__integer"]
