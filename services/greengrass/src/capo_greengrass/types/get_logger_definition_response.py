"""Generated from Smithy shape ``com.amazonaws.greengrass#GetLoggerDefinitionResponse``."""
...
class GetLoggerDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetLoggerDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> GetLoggerDefinitionResponse:
    out: GetLoggerDefinitionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
