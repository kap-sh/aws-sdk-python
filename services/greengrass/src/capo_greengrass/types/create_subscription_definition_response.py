"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateSubscriptionDefinitionResponse``."""
...
class CreateSubscriptionDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateSubscriptionDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateSubscriptionDefinitionResponse:
    out: CreateSubscriptionDefinitionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
