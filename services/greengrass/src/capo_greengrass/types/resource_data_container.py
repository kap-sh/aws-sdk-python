...
class ResourceDataContainer(TypedDict, closed=True):
    local_device_resource_data: NotRequired[
        "capo_greengrass.types.local_device_resource_data.LocalDeviceResourceData"
    ]
    """Attributes that define the local device resource."""
    local_volume_resource_data: NotRequired[
        "capo_greengrass.types.local_volume_resource_data.LocalVolumeResourceData"
    ]
    """Attributes that define the local volume resource."""
    s3_machine_learning_model_resource_data: NotRequired[
        "capo_greengrass.types.s3_machine_learning_model_resource_data.S3MachineLearningModelResourceData"
    ]
    """Attributes that define an Amazon S3 machine learning resource."""
    sage_maker_machine_learning_model_resource_data: NotRequired[
        "capo_greengrass.types.sage_maker_machine_learning_model_resource_data.SageMakerMachineLearningModelResourceData"
    ]
    """Attributes that define an Amazon SageMaker machine learning resource."""
    secrets_manager_secret_resource_data: NotRequired[
        "capo_greengrass.types.secrets_manager_secret_resource_data.SecretsManagerSecretResourceData"
    ]
...
def serialize_json(value: ResourceDataContainer) -> dict:
    ...
    if "local_device_resource_data" in value:
        ...
        out["LocalDeviceResourceData"] = (
            capo_greengrass.types.local_device_resource_data.serialize_json(
    ...
    if "local_volume_resource_data" in value:
        ...
        out["LocalVolumeResourceData"] = (
            capo_greengrass.types.local_volume_resource_data.serialize_json(
    ...
    if "s3_machine_learning_model_resource_data" in value:
        ...
        out["S3MachineLearningModelResourceData"] = (
            capo_greengrass.types.s3_machine_learning_model_resource_data.serialize_json(
    ...
    if "sage_maker_machine_learning_model_resource_data" in value:
        ...
        out["SageMakerMachineLearningModelResourceData"] = (
            capo_greengrass.types.sage_maker_machine_learning_model_resource_data.serialize_json(
    ...
    if "secrets_manager_secret_resource_data" in value:
        ...
        out["SecretsManagerSecretResourceData"] = (
            capo_greengrass.types.secrets_manager_secret_resource_data.serialize_json(
...
def deserialize_json(data: dict) -> ResourceDataContainer:
    ...
    if "LocalDeviceResourceData" in data:
        ...
        out["local_device_resource_data"] = (
            capo_greengrass.types.local_device_resource_data.deserialize_json(
    ...
    if "LocalVolumeResourceData" in data:
        ...
        out["local_volume_resource_data"] = (
            capo_greengrass.types.local_volume_resource_data.deserialize_json(
    ...
    if "S3MachineLearningModelResourceData" in data:
        ...
        out["s3_machine_learning_model_resource_data"] = (
            capo_greengrass.types.s3_machine_learning_model_resource_data.deserialize_json(
    ...
    if "SageMakerMachineLearningModelResourceData" in data:
        ...
        out["sage_maker_machine_learning_model_resource_data"] = (
            capo_greengrass.types.sage_maker_machine_learning_model_resource_data.deserialize_json(
    ...
    if "SecretsManagerSecretResourceData" in data:
        ...
        out["secrets_manager_secret_resource_data"] = (
            capo_greengrass.types.secrets_manager_secret_resource_data.deserialize_json(
