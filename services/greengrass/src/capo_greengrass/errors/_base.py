...
class GreengrassError(Exception):
    """Base class for all Greengrass service errors."""


class ServiceError(GreengrassError):
...
class SerializationError(GreengrassError):
    """Raised when a value cannot be serialized."""


class DeserializationError(GreengrassError):
...
class WaiterFailedError(GreengrassError):
...
class WaiterTimeoutError(GreengrassError):
