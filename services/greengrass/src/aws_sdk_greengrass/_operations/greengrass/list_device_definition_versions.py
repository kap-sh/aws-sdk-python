...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_device_definition_versions_response.ListDeviceDefinitionVersionsResponse = aws_sdk_greengrass.types.list_device_definition_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_device_definition_versions_request.ListDeviceDefinitionVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
