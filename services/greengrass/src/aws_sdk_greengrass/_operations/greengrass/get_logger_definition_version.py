"""Generated from Smithy shape ``com.amazonaws.greengrass#GetLoggerDefinitionVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_logger_definition_version_response.GetLoggerDefinitionVersionResponse = aws_sdk_greengrass.types.get_logger_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_greengrass.types.get_logger_definition_version_request.GetLoggerDefinitionVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{LoggerDefinitionId}", quote(str(input["logger_definition_id"]), safe="")
    )
    url = url.replace(
        "{LoggerDefinitionVersionId}",
        quote(str(input["logger_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_logger_definition_version(
