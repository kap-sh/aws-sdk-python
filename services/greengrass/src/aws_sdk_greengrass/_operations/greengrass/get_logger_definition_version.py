...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_logger_definition_version_request.GetLoggerDefinitionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["logger_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
