"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateConnectorDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_connector_definition_response.CreateConnectorDefinitionResponse = aws_sdk_greengrass.types.create_connector_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_connector_definition_request.CreateConnectorDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/definition/connectors"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_connector_definition_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_connector_definition(
