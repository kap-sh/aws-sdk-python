"""Generated from Smithy shape ``com.amazonaws.greengrass#UpdateSubscriptionDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.update_subscription_definition_response.UpdateSubscriptionDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.update_subscription_definition_request.UpdateSubscriptionDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.update_subscription_definition_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_subscription_definition(
