"""Generated from Smithy shape ``com.amazonaws.greengrass#GetSubscriptionDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_subscription_definition_response.GetSubscriptionDefinitionResponse = aws_sdk_greengrass.types.get_subscription_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_subscription_definition_request.GetSubscriptionDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_subscription_definition(
