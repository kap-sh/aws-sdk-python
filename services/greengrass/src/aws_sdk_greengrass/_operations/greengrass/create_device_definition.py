...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_device_definition_response.CreateDeviceDefinitionResponse = aws_sdk_greengrass.types.create_device_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_device_definition_request.CreateDeviceDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_device_definition_request.serialize_json(input_)
    ).encode()
