...
def build_request(
    ...
    input: aws_sdk_greengrass.types.create_device_definition_request.CreateDeviceDefinitionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_device_definition_request.serialize_json(input)
    ).encode()
