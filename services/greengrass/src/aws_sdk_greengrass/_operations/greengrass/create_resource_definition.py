"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateResourceDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_resource_definition_response.CreateResourceDefinitionResponse = aws_sdk_greengrass.types.create_resource_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_resource_definition_request.CreateResourceDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_resource_definition_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_resource_definition(
