"""Generated from Smithy shape ``com.amazonaws.greengrass#GetAssociatedRole``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_associated_role_response.GetAssociatedRoleResponse = aws_sdk_greengrass.types.get_associated_role_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_associated_role_request.GetAssociatedRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_associated_role(
