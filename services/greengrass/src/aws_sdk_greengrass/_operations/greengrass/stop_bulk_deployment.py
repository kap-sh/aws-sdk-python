...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.stop_bulk_deployment_response.StopBulkDeploymentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.stop_bulk_deployment_request.StopBulkDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
