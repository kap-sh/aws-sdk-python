...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_resource_definition_version_response.CreateResourceDefinitionVersionResponse = aws_sdk_greengrass.types.create_resource_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_resource_definition_version_request.CreateResourceDefinitionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_resource_definition_version_request.serialize_json(
            input_
        )
    ).encode()
