...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_group_response.CreateGroupResponse = (
        aws_sdk_greengrass.types.create_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_group_request.CreateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_group_request.serialize_json(input_)
    ).encode()
...
def create_group(
    ...
    aws_sdk_greengrass.types.create_group_response.CreateGroupResponse, zapros.Response
]:
