...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_software_update_job_response.CreateSoftwareUpdateJobResponse = aws_sdk_greengrass.types.create_software_update_job_response.deserialize_json(
