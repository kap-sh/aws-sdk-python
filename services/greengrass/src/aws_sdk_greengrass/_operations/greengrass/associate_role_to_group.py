...
def build_request(
    ...
    input: aws_sdk_greengrass.types.associate_role_to_group_request.AssociateRoleToGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.associate_role_to_group_request.serialize_json(input)
    ).encode()
