...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.start_bulk_deployment_response.StartBulkDeploymentResponse = aws_sdk_greengrass.types.start_bulk_deployment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.start_bulk_deployment_request.StartBulkDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.start_bulk_deployment_request.serialize_json(input_)
    ).encode()
