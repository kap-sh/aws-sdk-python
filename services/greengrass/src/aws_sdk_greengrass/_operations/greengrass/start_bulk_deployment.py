...
def build_request(
    ...
    input: aws_sdk_greengrass.types.start_bulk_deployment_request.StartBulkDeploymentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.start_bulk_deployment_request.serialize_json(input)
    ).encode()
