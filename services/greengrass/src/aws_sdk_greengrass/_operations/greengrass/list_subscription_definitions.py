"""Generated from Smithy shape ``com.amazonaws.greengrass#ListSubscriptionDefinitions``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_subscription_definitions_response.ListSubscriptionDefinitionsResponse = aws_sdk_greengrass.types.list_subscription_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_subscription_definitions_request.ListSubscriptionDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/definition/subscriptions"
    params: dict[str, str] = {}
...
async def async_list_subscription_definitions(
