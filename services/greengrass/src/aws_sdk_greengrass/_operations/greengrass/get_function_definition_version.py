...
def build_request(
    ...
    input: aws_sdk_greengrass.types.get_function_definition_version_request.GetFunctionDefinitionVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{FunctionDefinitionId}", quote(str(input["function_definition_id"]), safe="")
    )
    url = url.replace(
        "{FunctionDefinitionVersionId}",
        quote(str(input["function_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
