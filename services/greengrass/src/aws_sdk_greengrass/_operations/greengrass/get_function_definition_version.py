"""Generated from Smithy shape ``com.amazonaws.greengrass#GetFunctionDefinitionVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_function_definition_version_response.GetFunctionDefinitionVersionResponse = aws_sdk_greengrass.types.get_function_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_function_definition_version_request.GetFunctionDefinitionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{FunctionDefinitionId}", quote(str(input_["function_definition_id"]), safe="")
    )
    url = url.replace(
        "{FunctionDefinitionVersionId}",
        quote(str(input_["function_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_function_definition_version(
