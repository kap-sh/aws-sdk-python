"""Generated from Smithy shape ``com.amazonaws.greengrass#ListLoggerDefinitions``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_logger_definitions_response.ListLoggerDefinitionsResponse = aws_sdk_greengrass.types.list_logger_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_logger_definitions_request.ListLoggerDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/definition/loggers"
    params: dict[str, str] = {}
...
async def async_list_logger_definitions(
