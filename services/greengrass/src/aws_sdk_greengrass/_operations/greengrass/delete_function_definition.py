...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.delete_function_definition_response.DeleteFunctionDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.delete_function_definition_request.DeleteFunctionDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
