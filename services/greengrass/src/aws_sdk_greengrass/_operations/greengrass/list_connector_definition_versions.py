"""Generated from Smithy shape ``com.amazonaws.greengrass#ListConnectorDefinitionVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_connector_definition_versions_response.ListConnectorDefinitionVersionsResponse = aws_sdk_greengrass.types.list_connector_definition_versions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_greengrass.types.list_connector_definition_versions_request.ListConnectorDefinitionVersionsRequest,
) -> zapros.Request:
...
async def async_list_connector_definition_versions(
