...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_group_certificate_configuration_response.GetGroupCertificateConfigurationResponse = aws_sdk_greengrass.types.get_group_certificate_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_group_certificate_configuration_request.GetGroupCertificateConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
