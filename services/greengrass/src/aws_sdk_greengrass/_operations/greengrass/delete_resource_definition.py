...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.delete_resource_definition_response.DeleteResourceDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.delete_resource_definition_request.DeleteResourceDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
