...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.associate_service_role_to_account_response.AssociateServiceRoleToAccountResponse = aws_sdk_greengrass.types.associate_service_role_to_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.associate_service_role_to_account_request.AssociateServiceRoleToAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.associate_service_role_to_account_request.serialize_json(
            input_
        )
    ).encode()
