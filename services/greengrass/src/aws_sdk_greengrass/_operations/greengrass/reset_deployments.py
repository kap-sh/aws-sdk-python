...
def build_request(
    ...
    input: aws_sdk_greengrass.types.reset_deployments_request.ResetDeploymentsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.reset_deployments_request.serialize_json(input)
    ).encode()
