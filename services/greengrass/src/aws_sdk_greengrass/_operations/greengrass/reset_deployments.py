...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.reset_deployments_response.ResetDeploymentsResponse = aws_sdk_greengrass.types.reset_deployments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.reset_deployments_request.ResetDeploymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.reset_deployments_request.serialize_json(input_)
    ).encode()
