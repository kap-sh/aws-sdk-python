"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateConnectorDefinitionVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_connector_definition_version_response.CreateConnectorDefinitionVersionResponse = aws_sdk_greengrass.types.create_connector_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_greengrass.types.create_connector_definition_version_request.CreateConnectorDefinitionVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ConnectorDefinitionId}", quote(str(input["connector_definition_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_connector_definition_version_request.serialize_json(
            input
        )
    ).encode()
...
async def async_create_connector_definition_version(
