...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_connector_definition_version_request.CreateConnectorDefinitionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["connector_definition_id"]), safe=""),
    )
    params: dict[str, str] = {}
