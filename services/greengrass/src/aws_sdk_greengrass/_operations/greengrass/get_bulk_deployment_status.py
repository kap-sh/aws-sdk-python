...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_bulk_deployment_status_response.GetBulkDeploymentStatusResponse = aws_sdk_greengrass.types.get_bulk_deployment_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_bulk_deployment_status_request.GetBulkDeploymentStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
