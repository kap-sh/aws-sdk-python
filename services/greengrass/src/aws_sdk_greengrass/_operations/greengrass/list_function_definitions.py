...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_function_definitions_response.ListFunctionDefinitionsResponse = aws_sdk_greengrass.types.list_function_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_function_definitions_request.ListFunctionDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
