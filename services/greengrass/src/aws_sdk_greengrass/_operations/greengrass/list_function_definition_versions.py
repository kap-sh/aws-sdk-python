"""Generated from Smithy shape ``com.amazonaws.greengrass#ListFunctionDefinitionVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_function_definition_versions_response.ListFunctionDefinitionVersionsResponse = aws_sdk_greengrass.types.list_function_definition_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_function_definition_versions_request.ListFunctionDefinitionVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_function_definition_versions(
