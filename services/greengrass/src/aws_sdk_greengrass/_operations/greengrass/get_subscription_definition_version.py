"""Generated from Smithy shape ``com.amazonaws.greengrass#GetSubscriptionDefinitionVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_subscription_definition_version_response.GetSubscriptionDefinitionVersionResponse = aws_sdk_greengrass.types.get_subscription_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_subscription_definition_version_request.GetSubscriptionDefinitionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["subscription_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_subscription_definition_version(
