...
def build_request(
    ...
    input: aws_sdk_greengrass.types.get_subscription_definition_version_request.GetSubscriptionDefinitionVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["subscription_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
