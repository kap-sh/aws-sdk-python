...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_subscription_definition_versions_response.ListSubscriptionDefinitionVersionsResponse = aws_sdk_greengrass.types.list_subscription_definition_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_subscription_definition_versions_request.ListSubscriptionDefinitionVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
