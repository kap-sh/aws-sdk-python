"""Generated from Smithy shape ``com.amazonaws.greengrass#GetConnectorDefinitionVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_connector_definition_version_response.GetConnectorDefinitionVersionResponse = aws_sdk_greengrass.types.get_connector_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_greengrass.types.get_connector_definition_version_request.GetConnectorDefinitionVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["connector_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_connector_definition_version(
