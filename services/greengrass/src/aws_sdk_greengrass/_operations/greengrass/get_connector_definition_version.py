...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_connector_definition_version_request.GetConnectorDefinitionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["connector_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
