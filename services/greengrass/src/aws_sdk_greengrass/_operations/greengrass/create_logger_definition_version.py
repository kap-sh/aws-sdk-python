...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_logger_definition_version_response.CreateLoggerDefinitionVersionResponse = aws_sdk_greengrass.types.create_logger_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_greengrass.types.create_logger_definition_version_request.CreateLoggerDefinitionVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_logger_definition_version_request.serialize_json(
            input
        )
    ).encode()
