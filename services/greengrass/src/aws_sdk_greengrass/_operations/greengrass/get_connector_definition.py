...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_connector_definition_response.GetConnectorDefinitionResponse = aws_sdk_greengrass.types.get_connector_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_connector_definition_request.GetConnectorDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
