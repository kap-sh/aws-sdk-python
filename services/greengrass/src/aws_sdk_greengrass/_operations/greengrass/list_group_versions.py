...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_group_versions_response.ListGroupVersionsResponse = aws_sdk_greengrass.types.list_group_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_group_versions_request.ListGroupVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
