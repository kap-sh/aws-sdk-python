...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_deployment_status_response.GetDeploymentStatusResponse = aws_sdk_greengrass.types.get_deployment_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_deployment_status_request.GetDeploymentStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
