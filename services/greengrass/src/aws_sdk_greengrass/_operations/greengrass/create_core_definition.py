...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_core_definition_response.CreateCoreDefinitionResponse = aws_sdk_greengrass.types.create_core_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_core_definition_request.CreateCoreDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_core_definition_request.serialize_json(input_)
    ).encode()
