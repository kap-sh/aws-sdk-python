"""Generated from Smithy shape ``com.amazonaws.greengrass#ListCoreDefinitions``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_core_definitions_response.ListCoreDefinitionsResponse = aws_sdk_greengrass.types.list_core_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_core_definitions_request.ListCoreDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/definition/cores"
    params: dict[str, str] = {}
...
async def async_list_core_definitions(
