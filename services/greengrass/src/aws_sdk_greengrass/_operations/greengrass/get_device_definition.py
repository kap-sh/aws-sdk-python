...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_device_definition_response.GetDeviceDefinitionResponse = aws_sdk_greengrass.types.get_device_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_device_definition_request.GetDeviceDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
