...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_connector_definitions_response.ListConnectorDefinitionsResponse = aws_sdk_greengrass.types.list_connector_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_connector_definitions_request.ListConnectorDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
