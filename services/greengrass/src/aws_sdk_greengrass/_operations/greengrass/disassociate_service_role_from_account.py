"""Generated from Smithy shape ``com.amazonaws.greengrass#DisassociateServiceRoleFromAccount``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.disassociate_service_role_from_account_response.DisassociateServiceRoleFromAccountResponse = aws_sdk_greengrass.types.disassociate_service_role_from_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.disassociate_service_role_from_account_request.DisassociateServiceRoleFromAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
