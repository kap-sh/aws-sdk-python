...
def build_request(
    ...
    input: aws_sdk_greengrass.types.update_device_definition_request.UpdateDeviceDefinitionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.update_device_definition_request.serialize_json(input)
    ).encode()
