...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.update_device_definition_response.UpdateDeviceDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.update_device_definition_request.UpdateDeviceDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.update_device_definition_request.serialize_json(input_)
    ).encode()
