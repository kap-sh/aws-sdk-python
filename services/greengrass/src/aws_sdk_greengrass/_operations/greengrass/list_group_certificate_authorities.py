...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_group_certificate_authorities_response.ListGroupCertificateAuthoritiesResponse = aws_sdk_greengrass.types.list_group_certificate_authorities_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_group_certificate_authorities_request.ListGroupCertificateAuthoritiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
