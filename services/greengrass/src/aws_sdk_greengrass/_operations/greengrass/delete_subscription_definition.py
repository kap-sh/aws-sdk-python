"""Generated from Smithy shape ``com.amazonaws.greengrass#DeleteSubscriptionDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.delete_subscription_definition_response.DeleteSubscriptionDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.delete_subscription_definition_request.DeleteSubscriptionDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_subscription_definition(
