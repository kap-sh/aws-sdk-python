...
def build_request(
    ...
    input: aws_sdk_greengrass.types.update_core_definition_request.UpdateCoreDefinitionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{CoreDefinitionId}", quote(str(input["core_definition_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.update_core_definition_request.serialize_json(input)
    ).encode()
