"""Generated from Smithy shape ``com.amazonaws.greengrass#GetDeviceDefinitionVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_device_definition_version_response.GetDeviceDefinitionVersionResponse = aws_sdk_greengrass.types.get_device_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_device_definition_version_request.GetDeviceDefinitionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["device_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_device_definition_version(
