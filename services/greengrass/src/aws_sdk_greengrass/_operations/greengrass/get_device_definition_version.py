...
def build_request(
    ...
    input: aws_sdk_greengrass.types.get_device_definition_version_request.GetDeviceDefinitionVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["device_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
