"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateSubscriptionDefinitionVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_subscription_definition_version_response.CreateSubscriptionDefinitionVersionResponse = aws_sdk_greengrass.types.create_subscription_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_subscription_definition_version_request.CreateSubscriptionDefinitionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["subscription_definition_id"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_subscription_definition_version_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_subscription_definition_version(
