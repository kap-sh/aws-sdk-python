...
def build_request(
    ...
    input: aws_sdk_greengrass.types.create_subscription_definition_version_request.CreateSubscriptionDefinitionVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["subscription_definition_id"]), safe=""),
    )
    params: dict[str, str] = {}
