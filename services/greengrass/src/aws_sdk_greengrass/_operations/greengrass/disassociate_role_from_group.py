...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.disassociate_role_from_group_response.DisassociateRoleFromGroupResponse = aws_sdk_greengrass.types.disassociate_role_from_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.disassociate_role_from_group_request.DisassociateRoleFromGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
