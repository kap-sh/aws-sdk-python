...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_deployments_response.ListDeploymentsResponse = (
        aws_sdk_greengrass.types.list_deployments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_deployments_request.ListDeploymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
