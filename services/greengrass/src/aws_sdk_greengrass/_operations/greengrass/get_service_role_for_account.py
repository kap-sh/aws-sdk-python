"""Generated from Smithy shape ``com.amazonaws.greengrass#GetServiceRoleForAccount``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_service_role_for_account_response.GetServiceRoleForAccountResponse = aws_sdk_greengrass.types.get_service_role_for_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_service_role_for_account_request.GetServiceRoleForAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_service_role_for_account(
