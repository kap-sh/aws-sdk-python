"""Generated from Smithy shape ``com.amazonaws.greengrass#GetResourceDefinitionVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_resource_definition_version_response.GetResourceDefinitionVersionResponse = aws_sdk_greengrass.types.get_resource_definition_version_response.deserialize_json(
