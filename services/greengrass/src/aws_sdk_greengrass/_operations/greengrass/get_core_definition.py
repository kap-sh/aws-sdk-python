...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_core_definition_response.GetCoreDefinitionResponse = aws_sdk_greengrass.types.get_core_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_core_definition_request.GetCoreDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
