...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.delete_connector_definition_response.DeleteConnectorDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.delete_connector_definition_request.DeleteConnectorDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
