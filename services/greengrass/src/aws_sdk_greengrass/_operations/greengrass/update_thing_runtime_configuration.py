...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.update_thing_runtime_configuration_response.UpdateThingRuntimeConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.update_thing_runtime_configuration_request.UpdateThingRuntimeConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.update_thing_runtime_configuration_request.serialize_json(
            input_
        )
    ).encode()
