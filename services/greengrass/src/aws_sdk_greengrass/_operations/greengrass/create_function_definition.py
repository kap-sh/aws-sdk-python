"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateFunctionDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_function_definition_response.CreateFunctionDefinitionResponse = aws_sdk_greengrass.types.create_function_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_function_definition_request.CreateFunctionDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/definition/functions"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_function_definition_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_function_definition(
