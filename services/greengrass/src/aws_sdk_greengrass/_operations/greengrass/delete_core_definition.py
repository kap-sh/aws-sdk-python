"""Generated from Smithy shape ``com.amazonaws.greengrass#DeleteCoreDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.delete_core_definition_response.DeleteCoreDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.delete_core_definition_request.DeleteCoreDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_core_definition(
