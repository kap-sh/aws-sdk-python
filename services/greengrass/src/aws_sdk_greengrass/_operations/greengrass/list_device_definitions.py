...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_device_definitions_response.ListDeviceDefinitionsResponse = aws_sdk_greengrass.types.list_device_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_device_definitions_request.ListDeviceDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
