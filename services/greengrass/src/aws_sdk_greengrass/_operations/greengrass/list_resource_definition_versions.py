...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_resource_definition_versions_response.ListResourceDefinitionVersionsResponse = aws_sdk_greengrass.types.list_resource_definition_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_resource_definition_versions_request.ListResourceDefinitionVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
