"""Generated from Smithy shape ``com.amazonaws.greengrass#UpdateGroupCertificateConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalServerErrorException":
            import aws_sdk_greengrass.errors.internal_server_error_exception

            raise aws_sdk_greengrass.errors.internal_server_error_exception.InternalServerErrorException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.update_group_certificate_configuration_response.UpdateGroupCertificateConfigurationResponse = aws_sdk_greengrass.types.update_group_certificate_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.update_group_certificate_configuration_request.UpdateGroupCertificateConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.update_group_certificate_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_group_certificate_configuration(
