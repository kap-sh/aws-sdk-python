...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_group_certificate_authority_response.CreateGroupCertificateAuthorityResponse = aws_sdk_greengrass.types.create_group_certificate_authority_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_group_certificate_authority_request.CreateGroupCertificateAuthorityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
