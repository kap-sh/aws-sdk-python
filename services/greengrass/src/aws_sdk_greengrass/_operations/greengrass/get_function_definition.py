...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_function_definition_response.GetFunctionDefinitionResponse = aws_sdk_greengrass.types.get_function_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_function_definition_request.GetFunctionDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
