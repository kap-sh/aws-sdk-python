...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_group_certificate_authority_response.GetGroupCertificateAuthorityResponse = aws_sdk_greengrass.types.get_group_certificate_authority_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_group_certificate_authority_request.GetGroupCertificateAuthorityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["certificate_authority_id"]), safe=""),
    )
