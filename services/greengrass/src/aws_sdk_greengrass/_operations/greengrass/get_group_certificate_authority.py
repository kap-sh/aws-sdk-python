...
def build_request(
    ...
    input: aws_sdk_greengrass.types.get_group_certificate_authority_request.GetGroupCertificateAuthorityRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["certificate_authority_id"]), safe=""),
    )
