...
def build_request(
    ...
    input: aws_sdk_greengrass.types.create_device_definition_version_request.CreateDeviceDefinitionVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{DeviceDefinitionId}", quote(str(input["device_definition_id"]), safe="")
    )
    params: dict[str, str] = {}
