"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateDeviceDefinitionVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_device_definition_version_response.CreateDeviceDefinitionVersionResponse = aws_sdk_greengrass.types.create_device_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_device_definition_version_request.CreateDeviceDefinitionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{DeviceDefinitionId}", quote(str(input_["device_definition_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_device_definition_version_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_device_definition_version(
