...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_group_version_response.CreateGroupVersionResponse = aws_sdk_greengrass.types.create_group_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_greengrass.types.create_group_version_request.CreateGroupVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_group_version_request.serialize_json(input)
    ).encode()
