"""Generated from Smithy shape ``com.amazonaws.greengrass#ListCoreDefinitionVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_core_definition_versions_response.ListCoreDefinitionVersionsResponse = aws_sdk_greengrass.types.list_core_definition_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_core_definition_versions_request.ListCoreDefinitionVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_core_definition_versions(
