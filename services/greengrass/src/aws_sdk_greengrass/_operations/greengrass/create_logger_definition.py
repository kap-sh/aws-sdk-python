...
def build_request(
    ...
    input: aws_sdk_greengrass.types.create_logger_definition_request.CreateLoggerDefinitionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_logger_definition_request.serialize_json(input)
    ).encode()
