...
def build_request(
    ...
    input: aws_sdk_greengrass.types.update_connectivity_info_request.UpdateConnectivityInfoRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.update_connectivity_info_request.serialize_json(input)
    ).encode()
