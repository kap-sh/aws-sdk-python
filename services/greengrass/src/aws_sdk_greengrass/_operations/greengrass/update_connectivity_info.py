"""Generated from Smithy shape ``com.amazonaws.greengrass#UpdateConnectivityInfo``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.update_connectivity_info_response.UpdateConnectivityInfoResponse = aws_sdk_greengrass.types.update_connectivity_info_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.update_connectivity_info_request.UpdateConnectivityInfoRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.update_connectivity_info_request.serialize_json(input_)
    ).encode()
