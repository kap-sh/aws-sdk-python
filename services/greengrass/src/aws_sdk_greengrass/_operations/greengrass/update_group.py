"""Generated from Smithy shape ``com.amazonaws.greengrass#UpdateGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.update_group_response.UpdateGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_greengrass.types.update_group_request.UpdateGroupRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/groups/{GroupId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.update_group_request.serialize_json(input)
    ).encode()
...
def update_group(
    ...
    aws_sdk_greengrass.types.update_group_response.UpdateGroupResponse, zapros.Response
]:
