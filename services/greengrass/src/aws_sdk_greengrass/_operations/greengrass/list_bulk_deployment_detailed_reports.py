"""Generated from Smithy shape ``com.amazonaws.greengrass#ListBulkDeploymentDetailedReports``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_bulk_deployment_detailed_reports_response.ListBulkDeploymentDetailedReportsResponse = aws_sdk_greengrass.types.list_bulk_deployment_detailed_reports_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_bulk_deployment_detailed_reports_request.ListBulkDeploymentDetailedReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{BulkDeploymentId}", quote(str(input_["bulk_deployment_id"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_list_bulk_deployment_detailed_reports(
