...
def build_request(
    ...
    input: aws_sdk_greengrass.types.list_bulk_deployment_detailed_reports_request.ListBulkDeploymentDetailedReportsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{BulkDeploymentId}", quote(str(input["bulk_deployment_id"]), safe="")
    )
    params: dict[str, str] = {}
