"""Generated from Smithy shape ``com.amazonaws.greengrass#ListGroups``."""
...
import aws_sdk_greengrass.types.__list_of_group_information
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.list_groups_response.ListGroupsResponse = (
        aws_sdk_greengrass.types.list_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.list_groups_request.ListGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/groups"
    params: dict[str, str] = {}
...
def list_groups(
    ...
    aws_sdk_greengrass.types.list_groups_response.ListGroupsResponse, zapros.Response
]:
