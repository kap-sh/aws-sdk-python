...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_connectivity_info_response.GetConnectivityInfoResponse = aws_sdk_greengrass.types.get_connectivity_info_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_connectivity_info_request.GetConnectivityInfoRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
