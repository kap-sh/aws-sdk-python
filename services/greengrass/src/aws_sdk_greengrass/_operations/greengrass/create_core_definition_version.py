...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.create_core_definition_version_response.CreateCoreDefinitionVersionResponse = aws_sdk_greengrass.types.create_core_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.create_core_definition_version_request.CreateCoreDefinitionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_greengrass.types.create_core_definition_version_request.serialize_json(
            input_
        )
    ).encode()
