"""Generated from Smithy shape ``com.amazonaws.greengrass#DeleteDeviceDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.delete_device_definition_response.DeleteDeviceDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.delete_device_definition_request.DeleteDeviceDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/greengrass/definition/devices/{DeviceDefinitionId}"
    )
    url = url.replace(
...
async def async_delete_device_definition(
