...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_resource_definition_response.GetResourceDefinitionResponse = aws_sdk_greengrass.types.get_resource_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_resource_definition_request.GetResourceDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
