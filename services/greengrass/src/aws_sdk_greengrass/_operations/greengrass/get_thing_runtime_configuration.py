"""Generated from Smithy shape ``com.amazonaws.greengrass#GetThingRuntimeConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_thing_runtime_configuration_response.GetThingRuntimeConfigurationResponse = aws_sdk_greengrass.types.get_thing_runtime_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_thing_runtime_configuration_request.GetThingRuntimeConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/things/{ThingName}/runtimeconfig"
...
async def async_get_thing_runtime_configuration(
