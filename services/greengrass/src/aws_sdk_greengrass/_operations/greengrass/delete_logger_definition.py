"""Generated from Smithy shape ``com.amazonaws.greengrass#DeleteLoggerDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.delete_logger_definition_response.DeleteLoggerDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_greengrass.types.delete_logger_definition_request.DeleteLoggerDefinitionRequest,
) -> zapros.Request:
    ...
    url = (
        endpoint.url.rstrip("/") + "/greengrass/definition/loggers/{LoggerDefinitionId}"
    )
    url = url.replace(
...
async def async_delete_logger_definition(
