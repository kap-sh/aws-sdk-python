...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_logger_definition_response.GetLoggerDefinitionResponse = aws_sdk_greengrass.types.get_logger_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_greengrass.types.get_logger_definition_request.GetLoggerDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
