...
def handle_response(
    ...
    out: aws_sdk_greengrass.types.get_core_definition_version_response.GetCoreDefinitionVersionResponse = aws_sdk_greengrass.types.get_core_definition_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_greengrass.types.get_core_definition_version_request.GetCoreDefinitionVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["core_definition_version_id"]), safe=""),
    )
    params: dict[str, str] = {}
