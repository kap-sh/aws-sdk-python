...
def resolve(p: EndpointParams) -> Endpoint:  # type: ignore
    ...
    if p.Region is not None:
        ...
        if _locals["PartitionResult"] is not None:
            ...
            if p.UseFIPS is True:
                if (
                    ...
                    if string_equals(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://greengrass.us-gov-east-1.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={},
                    ...
                    if string_equals(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://greengrass.us-gov-west-1.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={},
            ...
            if string_equals(
                p.Region, interpolate("dataplane-us-gov-east-1", p, _locals)
            ):
                return Endpoint(
                    url=interpolate(
                        ...
                        "authSchemes": [
                            {
                                ...
                                "signingName": interpolate("greengrass", p, _locals),
                                "signingRegion": interpolate(
                                    "us-gov-east-1", p, _locals
                                ),
                            }
                        ]
                    },
            ...
            if string_equals(
                p.Region, interpolate("dataplane-us-gov-west-1", p, _locals)
            ):
                return Endpoint(
                    url=interpolate(
            ...
            return Endpoint(
                url=interpolate(
                    "https://greengrass.{Region}.{PartitionResult#dnsSuffix}",
                    p,
                    _locals,
                ),
                properties={},
