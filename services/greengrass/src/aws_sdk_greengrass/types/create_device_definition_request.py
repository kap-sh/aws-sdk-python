"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateDeviceDefinitionRequest``."""
...
class CreateDeviceDefinitionRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateDeviceDefinitionRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateDeviceDefinitionRequest:
    out: CreateDeviceDefinitionRequest = {}  # type: ignore[typeddict-item]
