"""Generated from Smithy shape ``com.amazonaws.greengrass#DefinitionInformation``."""
...
class DefinitionInformation(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DefinitionInformation) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
