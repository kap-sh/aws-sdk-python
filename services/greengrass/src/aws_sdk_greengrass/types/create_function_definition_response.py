"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateFunctionDefinitionResponse``."""
...
class CreateFunctionDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateFunctionDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateFunctionDefinitionResponse:
    out: CreateFunctionDefinitionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
