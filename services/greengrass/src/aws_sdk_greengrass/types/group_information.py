"""Generated from Smithy shape ``com.amazonaws.greengrass#GroupInformation``."""
...
class GroupInformation(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GroupInformation) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> GroupInformation:
    out: GroupInformation = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
