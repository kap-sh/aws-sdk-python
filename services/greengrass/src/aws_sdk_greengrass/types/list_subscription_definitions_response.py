"""Generated from Smithy shape ``com.amazonaws.greengrass#ListSubscriptionDefinitionsResponse``."""
...
class ListSubscriptionDefinitionsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListSubscriptionDefinitionsResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListSubscriptionDefinitionsResponse:
    out: ListSubscriptionDefinitionsResponse = {}  # type: ignore[typeddict-item]
