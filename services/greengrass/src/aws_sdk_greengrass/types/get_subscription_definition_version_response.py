...
class GetSubscriptionDefinitionVersionResponse(TypedDict):
...
def serialize_json(value: GetSubscriptionDefinitionVersionResponse) -> dict:
    ...
    if "definition" in value:
        ...
        out["Definition"] = (
            aws_sdk_greengrass.types.subscription_definition_version.serialize_json(
                value["definition"]
            )
        )
    if "id" in value:
...
def deserialize_json(data: dict) -> GetSubscriptionDefinitionVersionResponse:
    ...
    if "Definition" in data:
        ...
        out["definition"] = (
            aws_sdk_greengrass.types.subscription_definition_version.deserialize_json(
                data["Definition"]
            )
        )
    if "Id" in data:
