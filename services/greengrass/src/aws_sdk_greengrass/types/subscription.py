...
class Subscription(TypedDict, closed=True):
    ...
    source: NotRequired["aws_sdk_greengrass.types.__string.__string"]
    """The source of the subscription. Can be a thing ARN, a Lambda function ARN, a connector ARN, 'cloud' (which represents the AWS IoT cloud), or 'GGShadowService'."""
    subject: NotRequired["aws_sdk_greengrass.types.__string.__string"]
    """The MQTT topic used to route the message."""
    target: NotRequired["aws_sdk_greengrass.types.__string.__string"]
