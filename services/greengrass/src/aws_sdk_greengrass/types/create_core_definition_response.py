"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateCoreDefinitionResponse``."""
...
class CreateCoreDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateCoreDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateCoreDefinitionResponse:
    out: CreateCoreDefinitionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
