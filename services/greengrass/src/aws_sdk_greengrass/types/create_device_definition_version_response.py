"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateDeviceDefinitionVersionResponse``."""
...
class CreateDeviceDefinitionVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateDeviceDefinitionVersionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateDeviceDefinitionVersionResponse:
    out: CreateDeviceDefinitionVersionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
