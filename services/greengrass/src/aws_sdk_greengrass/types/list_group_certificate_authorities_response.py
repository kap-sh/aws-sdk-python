...
if TYPE_CHECKING:
    import aws_sdk_greengrass.types.__list_of_group_certificate_authority_properties


class ListGroupCertificateAuthoritiesResponse(TypedDict):
    group_certificate_authorities: NotRequired[
        "aws_sdk_greengrass.types.__list_of_group_certificate_authority_properties.__listOfGroupCertificateAuthorityProperties"
    ]
...
def serialize_json(value: ListGroupCertificateAuthoritiesResponse) -> dict:
    ...
    if "group_certificate_authorities" in value:
        ...
        out["GroupCertificateAuthorities"] = (
            aws_sdk_greengrass.types.__list_of_group_certificate_authority_properties.serialize_json(
...
def deserialize_json(data: dict) -> ListGroupCertificateAuthoritiesResponse:
    ...
    if "GroupCertificateAuthorities" in data:
        ...
        out["group_certificate_authorities"] = (
            aws_sdk_greengrass.types.__list_of_group_certificate_authority_properties.deserialize_json(
