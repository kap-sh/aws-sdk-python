"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateCoreDefinitionVersionResponse``."""
...
class CreateCoreDefinitionVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateCoreDefinitionVersionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateCoreDefinitionVersionResponse:
    out: CreateCoreDefinitionVersionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
