"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateResourceDefinitionVersionResponse``."""
...
class CreateResourceDefinitionVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateResourceDefinitionVersionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateResourceDefinitionVersionResponse:
    out: CreateResourceDefinitionVersionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
