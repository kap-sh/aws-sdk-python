...
class ListGroupsResponse(TypedDict, closed=True):
    groups: NotRequired[
        "aws_sdk_greengrass.types.__list_of_group_information.__listOfGroupInformation"
    ]
...
def serialize_json(value: ListGroupsResponse) -> dict:
    ...
    if "groups" in value:
        ...
        out["Groups"] = (
            aws_sdk_greengrass.types.__list_of_group_information.serialize_json(
                value["groups"]
            )
        )
...
def deserialize_json(data: dict) -> ListGroupsResponse:
    ...
    if "Groups" in data:
        ...
        out["groups"] = (
            aws_sdk_greengrass.types.__list_of_group_information.deserialize_json(
                data["Groups"]
            )
        )
