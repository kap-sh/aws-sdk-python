"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateDeviceDefinitionResponse``."""
...
class CreateDeviceDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateDeviceDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateDeviceDefinitionResponse:
    out: CreateDeviceDefinitionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
