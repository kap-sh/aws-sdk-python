"""Generated from Smithy shape ``com.amazonaws.greengrass#ListFunctionDefinitionVersionsResponse``."""
...
class ListFunctionDefinitionVersionsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListFunctionDefinitionVersionsResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListFunctionDefinitionVersionsResponse:
    out: ListFunctionDefinitionVersionsResponse = {}  # type: ignore[typeddict-item]
