"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateGroupVersionResponse``."""
...
class CreateGroupVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateGroupVersionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateGroupVersionResponse:
    out: CreateGroupVersionResponse = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
