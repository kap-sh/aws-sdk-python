...
class LicenseManagerUserSubscriptionsError(Exception):
    """Base class for all LicenseManagerUserSubscriptions service errors."""


class ServiceError(LicenseManagerUserSubscriptionsError):
...
class SerializationError(LicenseManagerUserSubscriptionsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LicenseManagerUserSubscriptionsError):
...
class WaiterFailedError(LicenseManagerUserSubscriptionsError):
...
class WaiterTimeoutError(LicenseManagerUserSubscriptionsError):
