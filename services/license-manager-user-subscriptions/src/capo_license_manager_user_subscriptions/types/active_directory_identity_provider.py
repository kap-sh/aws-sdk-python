...
if TYPE_CHECKING:
    ...
    import capo_license_manager_user_subscriptions.types.active_directory_type
    import capo_license_manager_user_subscriptions.types.directory


class ActiveDirectoryIdentityProvider(TypedDict, closed=True):
    directory_id: NotRequired[
        "capo_license_manager_user_subscriptions.types.directory.Directory"
    ]
    """<p>The directory ID for an Active Directory identity provider.</p>"""
    active_directory_settings: NotRequired[
        "capo_license_manager_user_subscriptions.types.active_directory_settings.ActiveDirectorySettings"
    ]
    ...
    active_directory_type: NotRequired[
        "capo_license_manager_user_subscriptions.types.active_directory_type.ActiveDirectoryType"
    ]
...
def serialize_json(value: ActiveDirectoryIdentityProvider) -> dict:
    ...
    if "active_directory_settings" in value:
        ...
        out["ActiveDirectorySettings"] = (
            capo_license_manager_user_subscriptions.types.active_directory_settings.serialize_json(
...
def deserialize_json(data: dict) -> ActiveDirectoryIdentityProvider:
    ...
    if "ActiveDirectorySettings" in data:
        ...
        out["active_directory_settings"] = (
            capo_license_manager_user_subscriptions.types.active_directory_settings.deserialize_json(
