...
# they need the `sso` extra: `pip install capo-license-manager-user-subscriptions[sso]`. Without it the imports
...
def require_dependency(module: object | None, package: str) -> None:
    if module is None:
        raise MissingDependencyError(
            ...
            "installed; reinstall with the sso feature enabled: capo-license-manager-user-subscriptions[sso]"
        )
