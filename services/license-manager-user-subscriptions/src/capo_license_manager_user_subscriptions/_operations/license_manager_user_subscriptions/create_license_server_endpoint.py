"""Generated from Smithy shape ``com.amazonaws.licensemanagerusersubscriptions#CreateLicenseServerEndpoint``."""
...
def handle_response(
    ...
    out: capo_license_manager_user_subscriptions.types.create_license_server_endpoint_response.CreateLicenseServerEndpointResponse = capo_license_manager_user_subscriptions.types.create_license_server_endpoint_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/license-server/CreateLicenseServerEndpoint"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_license_manager_user_subscriptions.types.create_license_server_endpoint_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_license_server_endpoint(
