"""Generated from Smithy shape ``com.amazonaws.licensemanagerusersubscriptions#StartProductSubscription``."""
...
def handle_response(
    ...
    out: capo_license_manager_user_subscriptions.types.start_product_subscription_response.StartProductSubscriptionResponse = capo_license_manager_user_subscriptions.types.start_product_subscription_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/user/StartProductSubscription"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_license_manager_user_subscriptions.types.start_product_subscription_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_product_subscription(
