...
def handle_response(
    ...
    out: capo_license_manager_user_subscriptions.types.list_instances_response.ListInstancesResponse = capo_license_manager_user_subscriptions.types.list_instances_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager_user_subscriptions.types.list_instances_request.serialize_json(
            input_
        )
    ).encode()
