"""Generated from Smithy shape ``com.amazonaws.licensemanagerusersubscriptions#UpdateIdentityProviderSettings``."""
...
def handle_response(
    ...
    out: capo_license_manager_user_subscriptions.types.update_identity_provider_settings_response.UpdateIdentityProviderSettingsResponse = capo_license_manager_user_subscriptions.types.update_identity_provider_settings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/identity-provider/UpdateIdentityProviderSettings"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_license_manager_user_subscriptions.types.update_identity_provider_settings_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_identity_provider_settings(
