"""Generated from Smithy shape ``com.amazonaws.licensemanagerusersubscriptions#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.licensemanagerusersubscriptions#InternalServerException``."""
