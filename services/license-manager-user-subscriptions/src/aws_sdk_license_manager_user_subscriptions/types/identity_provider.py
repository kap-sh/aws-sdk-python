...
def serialize_json(value: IdentityProvider) -> dict:
    if "ActiveDirectoryIdentityProvider" in value:
        ...
        return {
            "ActiveDirectoryIdentityProvider": aws_sdk_license_manager_user_subscriptions.types.active_directory_identity_provider.serialize_json(
...
def deserialize_json(data: dict) -> IdentityProvider:
    if "ActiveDirectoryIdentityProvider" in data:
        ...
        return {
            "ActiveDirectoryIdentityProvider": aws_sdk_license_manager_user_subscriptions.types.active_directory_identity_provider.deserialize_json(
