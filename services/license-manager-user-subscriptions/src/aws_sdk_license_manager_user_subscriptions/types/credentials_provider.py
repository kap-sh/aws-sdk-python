...
def serialize_json(value: CredentialsProvider) -> dict:
    if "SecretsManagerCredentialsProvider" in value:
        import aws_sdk_license_manager_user_subscriptions.types.secrets_manager_credentials_provider
        return {"SecretsManagerCredentialsProvider": aws_sdk_license_manager_user_subscriptions.types.secrets_manager_credentials_provider.serialize_json(value["SecretsManagerCredentialsProvider"])}
    else:
...
def deserialize_json(data: dict) -> CredentialsProvider:
    if "SecretsManagerCredentialsProvider" in data:
        import aws_sdk_license_manager_user_subscriptions.types.secrets_manager_credentials_provider
        return {"SecretsManagerCredentialsProvider": aws_sdk_license_manager_user_subscriptions.types.secrets_manager_credentials_provider.deserialize_json(data["SecretsManagerCredentialsProvider"])}
    else:
