...
class DeleteLicenseServerEndpointResponse(TypedDict):
    license_server_endpoint: NotRequired["aws_sdk_license_manager_user_subscriptions.types.license_server_endpoint.LicenseServerEndpoint"]
...
def serialize_json(value: DeleteLicenseServerEndpointResponse) -> dict:
    ...
    if "license_server_endpoint" in value:
        import aws_sdk_license_manager_user_subscriptions.types.license_server_endpoint
        out["LicenseServerEndpoint"] = aws_sdk_license_manager_user_subscriptions.types.license_server_endpoint.serialize_json(value["license_server_endpoint"])
    return out
...
def deserialize_json(data: dict) -> DeleteLicenseServerEndpointResponse:
    ...
    if "LicenseServerEndpoint" in data:
        import aws_sdk_license_manager_user_subscriptions.types.license_server_endpoint
        out["license_server_endpoint"] = aws_sdk_license_manager_user_subscriptions.types.license_server_endpoint.deserialize_json(data["LicenseServerEndpoint"])
    return out