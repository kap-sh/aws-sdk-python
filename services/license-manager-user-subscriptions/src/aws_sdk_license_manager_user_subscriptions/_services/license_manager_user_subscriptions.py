...
from aws_sdk_license_manager_user_subscriptions._services._aws_config import aws_config
...
class LicenseManagerUserSubscriptionsClientConfig(TypedDict, total=False, closed=True):
