...
from aws_sdk_license_manager_user_subscriptions._services._aws_config import aaws_config
...
class AsyncLicenseManagerUserSubscriptionsClient:
    ...
    async def associate_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.associate_user_request.AssociateUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.associate_user_response.AssociateUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.associate_user.async_associate_user(
    ...
    async def create_license_server_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.create_license_server_endpoint_request.CreateLicenseServerEndpointRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.create_license_server_endpoint_response.CreateLicenseServerEndpointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.create_license_server_endpoint.async_create_license_server_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_license_server_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.delete_license_server_endpoint_request.DeleteLicenseServerEndpointRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.delete_license_server_endpoint_response.DeleteLicenseServerEndpointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.delete_license_server_endpoint.async_delete_license_server_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_identity_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.deregister_identity_provider_request.DeregisterIdentityProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.deregister_identity_provider_response.DeregisterIdentityProviderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.deregister_identity_provider.async_deregister_identity_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.disassociate_user_request.DisassociateUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.disassociate_user_response.DisassociateUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.disassociate_user.async_disassociate_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_identity_providers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_identity_providers_request.ListIdentityProvidersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.list_identity_providers_response.ListIdentityProvidersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_identity_providers.async_list_identity_providers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_identity_providers(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_license_manager_user_subscriptions.types.identity_provider_summary.IdentityProviderSummary]":
        _token = next_token
        while True:
    ...
    async def list_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_instances_request.ListInstancesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.list_instances_response.ListInstancesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_instances.async_list_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_license_manager_user_subscriptions.types.instance_summary.InstanceSummary]":
        _token = next_token
        while True:
    ...
    async def list_license_server_endpoints(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_license_server_endpoints_request.ListLicenseServerEndpointsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.list_license_server_endpoints_response.ListLicenseServerEndpointsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_license_server_endpoints.async_list_license_server_endpoints(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_license_server_endpoints(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_license_manager_user_subscriptions.types.license_server_endpoint.LicenseServerEndpoint]":
        _token = next_token
        while True:
    ...
    async def list_product_subscriptions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_product_subscriptions_request.ListProductSubscriptionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.list_product_subscriptions_response.ListProductSubscriptionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_product_subscriptions.async_list_product_subscriptions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_product_subscriptions(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_license_manager_user_subscriptions.types.product_user_summary.ProductUserSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_user_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_user_associations_request.ListUserAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.list_user_associations_response.ListUserAssociationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_user_associations.async_list_user_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_user_associations(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_license_manager_user_subscriptions.types.instance_user_summary.InstanceUserSummary]":
        _token = next_token
        while True:
    ...
    async def register_identity_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.register_identity_provider_request.RegisterIdentityProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.register_identity_provider_response.RegisterIdentityProviderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.register_identity_provider.async_register_identity_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_product_subscription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.start_product_subscription_request.StartProductSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.start_product_subscription_response.StartProductSubscriptionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.start_product_subscription.async_start_product_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_product_subscription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.stop_product_subscription_request.StopProductSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.stop_product_subscription_response.StopProductSubscriptionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.stop_product_subscription.async_stop_product_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_identity_provider_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.update_identity_provider_settings_request.UpdateIdentityProviderSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_user_subscriptions.types.update_identity_provider_settings_response.UpdateIdentityProviderSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.update_identity_provider_settings.async_update_identity_provider_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
