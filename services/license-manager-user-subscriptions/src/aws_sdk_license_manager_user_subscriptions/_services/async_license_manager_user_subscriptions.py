...
from aws_sdk_license_manager_user_subscriptions._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_license_manager_user_subscriptions._async import anysleep
import time
...
class AsyncLicenseManagerUserSubscriptionsClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_dual_stack: bool | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncLicenseManagerUserSubscriptionsClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_dual_stack": use_dual_stack, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncLicenseManagerUserSubscriptionsClientConfig = config_overrides or {}
    ...
    async def associate_user(self, username: str, instance_id: str, identity_provider: "aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, domain: Optional[str] = None, tags: Optional["aws_sdk_license_manager_user_subscriptions.types.tags.Tags"] = None) -> "aws_sdk_license_manager_user_subscriptions.types.associate_user_response.AssociateUserResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.associate_user_request.AssociateUserRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.associate_user_response.AssociateUserResponse"]:
            import aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.associate_user
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.associate_user.async_associate_user(req.options, req.input)
    ...
    async def create_license_server_endpoint(self, identity_provider_arn: "aws_sdk_license_manager_user_subscriptions.types.arn.Arn", license_server_settings: "aws_sdk_license_manager_user_subscriptions.types.license_server_settings.LicenseServerSettings", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, tags: Optional["aws_sdk_license_manager_user_subscriptions.types.tags.Tags"] = None) -> "aws_sdk_license_manager_user_subscriptions.types.create_license_server_endpoint_response.CreateLicenseServerEndpointResponse":
        ...
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.create_license_server_endpoint_request.CreateLicenseServerEndpointRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.create_license_server_endpoint_response.CreateLicenseServerEndpointResponse"]:
            ...
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.create_license_server_endpoint.async_create_license_server_endpoint(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_license_server_endpoint(self, license_server_endpoint_arn: "aws_sdk_license_manager_user_subscriptions.types.arn.Arn", server_type: "aws_sdk_license_manager_user_subscriptions.types.server_type.ServerType", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None) -> "aws_sdk_license_manager_user_subscriptions.types.delete_license_server_endpoint_response.DeleteLicenseServerEndpointResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.delete_license_server_endpoint_request.DeleteLicenseServerEndpointRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.delete_license_server_endpoint_response.DeleteLicenseServerEndpointResponse"]:
            ...
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.delete_license_server_endpoint.async_delete_license_server_endpoint(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def deregister_identity_provider(self, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, identity_provider: Optional["aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider"] = None, product: Optional[str] = None, identity_provider_arn: Optional["aws_sdk_license_manager_user_subscriptions.types.arn.Arn"] = None) -> "aws_sdk_license_manager_user_subscriptions.types.deregister_identity_provider_response.DeregisterIdentityProviderResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.deregister_identity_provider_request.DeregisterIdentityProviderRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.deregister_identity_provider_response.DeregisterIdentityProviderResponse"]:
            ...
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.deregister_identity_provider.async_deregister_identity_provider(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def disassociate_user(self, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, username: Optional[str] = None, instance_id: Optional[str] = None, identity_provider: Optional["aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider"] = None, instance_user_arn: Optional["aws_sdk_license_manager_user_subscriptions.types.arn.Arn"] = None, domain: Optional[str] = None) -> "aws_sdk_license_manager_user_subscriptions.types.disassociate_user_response.DisassociateUserResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.disassociate_user_request.DisassociateUserRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.disassociate_user_response.DisassociateUserResponse"]:
            import aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.disassociate_user
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.disassociate_user.async_disassociate_user(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def list_identity_providers(self, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, max_results: Optional["aws_sdk_license_manager_user_subscriptions.types.box_integer.BoxInteger"] = None, filters: Optional["aws_sdk_license_manager_user_subscriptions.types.filter_list.FilterList"] = None, next_token: Optional[str] = None) -> "aws_sdk_license_manager_user_subscriptions.types.list_identity_providers_response.ListIdentityProvidersResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_identity_providers_request.ListIdentityProvidersRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.list_identity_providers_response.ListIdentityProvidersResponse"]:
            import aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_identity_providers
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_identity_providers.async_list_identity_providers(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_identity_providers(self, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, max_results: Optional["aws_sdk_license_manager_user_subscriptions.types.box_integer.BoxInteger"] = None, filters: Optional["aws_sdk_license_manager_user_subscriptions.types.filter_list.FilterList"] = None, next_token: Optional[str] = None) -> "AsyncIterator[aws_sdk_license_manager_user_subscriptions.types.identity_provider_summary.IdentityProviderSummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def list_instances(self, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, max_results: Optional["aws_sdk_license_manager_user_subscriptions.types.box_integer.BoxInteger"] = None, next_token: Optional[str] = None, filters: Optional["aws_sdk_license_manager_user_subscriptions.types.filter_list.FilterList"] = None) -> "aws_sdk_license_manager_user_subscriptions.types.list_instances_response.ListInstancesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_instances_request.ListInstancesRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.list_instances_response.ListInstancesResponse"]:
            import aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_instances
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_instances.async_list_instances(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_instances(self, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, max_results: Optional["aws_sdk_license_manager_user_subscriptions.types.box_integer.BoxInteger"] = None, next_token: Optional[str] = None, filters: Optional["aws_sdk_license_manager_user_subscriptions.types.filter_list.FilterList"] = None) -> "AsyncIterator[aws_sdk_license_manager_user_subscriptions.types.instance_summary.InstanceSummary]":
        _token = next_token
        while True:
    ...
    async def list_license_server_endpoints(self, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, max_results: Optional["aws_sdk_license_manager_user_subscriptions.types.box_integer.BoxInteger"] = None, filters: Optional["aws_sdk_license_manager_user_subscriptions.types.filter_list.FilterList"] = None, next_token: Optional[str] = None) -> "aws_sdk_license_manager_user_subscriptions.types.list_license_server_endpoints_response.ListLicenseServerEndpointsResponse":
        ...
        Args:
            ...
            next_token: <p>A token to specify where to start paginating. This is the nextToken from a previously truncated response.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_license_server_endpoints_request.ListLicenseServerEndpointsRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.list_license_server_endpoints_response.ListLicenseServerEndpointsResponse"]:
            ...
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_license_server_endpoints.async_list_license_server_endpoints(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_license_server_endpoints(self, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, max_results: Optional["aws_sdk_license_manager_user_subscriptions.types.box_integer.BoxInteger"] = None, filters: Optional["aws_sdk_license_manager_user_subscriptions.types.filter_list.FilterList"] = None, next_token: Optional[str] = None) -> "AsyncIterator[aws_sdk_license_manager_user_subscriptions.types.license_server_endpoint.LicenseServerEndpoint]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def list_product_subscriptions(self, identity_provider: "aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, product: Optional[str] = None, max_results: Optional["aws_sdk_license_manager_user_subscriptions.types.box_integer.BoxInteger"] = None, filters: Optional["aws_sdk_license_manager_user_subscriptions.types.filter_list.FilterList"] = None, next_token: Optional[str] = None) -> "aws_sdk_license_manager_user_subscriptions.types.list_product_subscriptions_response.ListProductSubscriptionsResponse":
        ...
        Args:
            ...
            next_token: <p>A token to specify where to start paginating. This is the nextToken from a previously truncated response.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_product_subscriptions_request.ListProductSubscriptionsRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.list_product_subscriptions_response.ListProductSubscriptionsResponse"]:
            ...
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_product_subscriptions.async_list_product_subscriptions(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_product_subscriptions(self, identity_provider: "aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, product: Optional[str] = None, max_results: Optional["aws_sdk_license_manager_user_subscriptions.types.box_integer.BoxInteger"] = None, filters: Optional["aws_sdk_license_manager_user_subscriptions.types.filter_list.FilterList"] = None, next_token: Optional[str] = None) -> "AsyncIterator[aws_sdk_license_manager_user_subscriptions.types.product_user_summary.ProductUserSummary]":
        ...
        while True:
            ...
            if not _token:
                break
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_license_manager_user_subscriptions.types.resource_arn.ResourceArn", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None) -> "aws_sdk_license_manager_user_subscriptions.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_tags_for_resource
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_user_associations(self, instance_id: str, identity_provider: "aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, max_results: Optional["aws_sdk_license_manager_user_subscriptions.types.box_integer.BoxInteger"] = None, filters: Optional["aws_sdk_license_manager_user_subscriptions.types.filter_list.FilterList"] = None, next_token: Optional[str] = None) -> "aws_sdk_license_manager_user_subscriptions.types.list_user_associations_response.ListUserAssociationsResponse":
        ...
        Args:
            ...
            next_token: <p>A token to specify where to start paginating. This is the nextToken from a previously truncated response.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.list_user_associations_request.ListUserAssociationsRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.list_user_associations_response.ListUserAssociationsResponse"]:
            import aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_user_associations
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_user_associations.async_list_user_associations(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_user_associations(self, instance_id: str, identity_provider: "aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, max_results: Optional["aws_sdk_license_manager_user_subscriptions.types.box_integer.BoxInteger"] = None, filters: Optional["aws_sdk_license_manager_user_subscriptions.types.filter_list.FilterList"] = None, next_token: Optional[str] = None) -> "AsyncIterator[aws_sdk_license_manager_user_subscriptions.types.instance_user_summary.InstanceUserSummary]":
        _token = next_token
        while True:
    ...
    async def register_identity_provider(self, identity_provider: "aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider", product: str, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, settings: Optional["aws_sdk_license_manager_user_subscriptions.types.settings.Settings"] = None, tags: Optional["aws_sdk_license_manager_user_subscriptions.types.tags.Tags"] = None) -> "aws_sdk_license_manager_user_subscriptions.types.register_identity_provider_response.RegisterIdentityProviderResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.register_identity_provider_request.RegisterIdentityProviderRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.register_identity_provider_response.RegisterIdentityProviderResponse"]:
            ...
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.register_identity_provider.async_register_identity_provider(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def start_product_subscription(self, username: str, identity_provider: "aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider", product: str, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, domain: Optional[str] = None, tags: Optional["aws_sdk_license_manager_user_subscriptions.types.tags.Tags"] = None) -> "aws_sdk_license_manager_user_subscriptions.types.start_product_subscription_response.StartProductSubscriptionResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.start_product_subscription_request.StartProductSubscriptionRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.start_product_subscription_response.StartProductSubscriptionResponse"]:
            ...
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.start_product_subscription.async_start_product_subscription(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def stop_product_subscription(self, *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, username: Optional[str] = None, identity_provider: Optional["aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider"] = None, product: Optional[str] = None, product_user_arn: Optional["aws_sdk_license_manager_user_subscriptions.types.arn.Arn"] = None, domain: Optional[str] = None) -> "aws_sdk_license_manager_user_subscriptions.types.stop_product_subscription_response.StopProductSubscriptionResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.stop_product_subscription_request.StopProductSubscriptionRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.stop_product_subscription_response.StopProductSubscriptionResponse"]:
            ...
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.stop_product_subscription.async_stop_product_subscription(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def tag_resource(self, resource_arn: "aws_sdk_license_manager_user_subscriptions.types.resource_arn.ResourceArn", tags: "aws_sdk_license_manager_user_subscriptions.types.tags.Tags", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None) -> "aws_sdk_license_manager_user_subscriptions.types.tag_resource_response.TagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.tag_resource_request.TagResourceRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.tag_resource
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_license_manager_user_subscriptions.types.resource_arn.ResourceArn", tag_keys: "aws_sdk_license_manager_user_subscriptions.types.tag_key_list.TagKeyList", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None) -> "aws_sdk_license_manager_user_subscriptions.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.untag_resource_request.UntagResourceRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.untag_resource
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def update_identity_provider_settings(self, update_settings: "aws_sdk_license_manager_user_subscriptions.types.update_settings.UpdateSettings", *, config_overrides: Optional[AsyncLicenseManagerUserSubscriptionsClientConfig] = None, identity_provider: Optional["aws_sdk_license_manager_user_subscriptions.types.identity_provider.IdentityProvider"] = None, product: Optional[str] = None, identity_provider_arn: Optional["aws_sdk_license_manager_user_subscriptions.types.arn.Arn"] = None) -> "aws_sdk_license_manager_user_subscriptions.types.update_identity_provider_settings_response.UpdateIdentityProviderSettingsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_license_manager_user_subscriptions.types.update_identity_provider_settings_request.UpdateIdentityProviderSettingsRequest]') -> AsyncOperationResponse["aws_sdk_license_manager_user_subscriptions.types.update_identity_provider_settings_response.UpdateIdentityProviderSettingsResponse"]:
            ...
            output, http_response = await aws_sdk_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.update_identity_provider_settings.async_update_identity_provider_settings(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
