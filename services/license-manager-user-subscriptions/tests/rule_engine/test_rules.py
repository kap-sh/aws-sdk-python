import pytest
from capo_license_manager_user_subscriptions._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_license_manager_user_subscriptions._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
