...
```
pip install aws-sdk-license-manager-user-subscriptions
```

## Usage

```python
from aws_sdk_license_manager_user_subscriptions import AsyncLicenseManagerUserSubscriptionsClient
...
```python
from aws_sdk_license_manager_user_subscriptions import AsyncLicenseManagerUserSubscriptionsClient
from aws_sdk_license_manager_user_subscriptions.error import AccessDeniedException
