"""Generated from Smithy shape ``com.amazonaws.migrationhubconfig#ServiceUnavailableException``."""
...
class ServiceUnavailableException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.migrationhubconfig#ServiceUnavailableException``."""
