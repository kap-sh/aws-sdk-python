...
class MigrationHubConfigError(Exception):
    """Base class for all MigrationHubConfig service errors."""


class ServiceError(MigrationHubConfigError):
...
class SerializationError(MigrationHubConfigError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MigrationHubConfigError):
...
class WaiterFailedError(MigrationHubConfigError):
...
class WaiterTimeoutError(MigrationHubConfigError):
