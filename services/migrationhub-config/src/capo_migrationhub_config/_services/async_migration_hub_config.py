...
class AsyncMigrationHubConfigClientConfig(TypedDict, total=False, closed=True):
...
class AsyncMigrationHubConfigClient:
    ...
    async def create_home_region_control(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migrationhub_config.types.create_home_region_control_request.CreateHomeRegionControlRequest]",
        ) -> AsyncOperationResponse[
            "capo_migrationhub_config.types.create_home_region_control_result.CreateHomeRegionControlResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migrationhub_config._operations.aws_migration_hub_multi_account_service.create_home_region_control.async_create_home_region_control(
    ...
    async def delete_home_region_control(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migrationhub_config.types.delete_home_region_control_request.DeleteHomeRegionControlRequest]",
        ) -> AsyncOperationResponse[
            "capo_migrationhub_config.types.delete_home_region_control_result.DeleteHomeRegionControlResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migrationhub_config._operations.aws_migration_hub_multi_account_service.delete_home_region_control.async_delete_home_region_control(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_home_region_controls(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migrationhub_config.types.describe_home_region_controls_request.DescribeHomeRegionControlsRequest]",
        ) -> AsyncOperationResponse[
            "capo_migrationhub_config.types.describe_home_region_controls_result.DescribeHomeRegionControlsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migrationhub_config._operations.aws_migration_hub_multi_account_service.describe_home_region_controls.async_describe_home_region_controls(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_home_region(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migrationhub_config.types.get_home_region_request.GetHomeRegionRequest]",
        ) -> AsyncOperationResponse[
            "capo_migrationhub_config.types.get_home_region_result.GetHomeRegionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migrationhub_config._operations.aws_migration_hub_multi_account_service.get_home_region.async_get_home_region(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
