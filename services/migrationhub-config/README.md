...
```
pip install aws-sdk-migrationhub-config
```

## Usage

```python
from aws_sdk_migrationhub_config import AsyncMigrationHubConfigClient
...
```python
from aws_sdk_migrationhub_config import AsyncMigrationHubConfigClient
from aws_sdk_migrationhub_config.error import AccessDeniedException
