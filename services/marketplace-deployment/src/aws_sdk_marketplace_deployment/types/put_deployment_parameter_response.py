...
if TYPE_CHECKING:
    import aws_sdk_marketplace_deployment.types.deployment_parameter_resource_identifier
    import aws_sdk_marketplace_deployment.types.resource_arn
...
class PutDeploymentParameterResponse(TypedDict, closed=True):
    ...
    deployment_parameter_id: "aws_sdk_marketplace_deployment.types.deployment_parameter_resource_identifier.DeploymentParameterResourceIdentifier"
