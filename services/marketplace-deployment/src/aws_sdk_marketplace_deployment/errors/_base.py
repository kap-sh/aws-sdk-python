...
class MarketplaceDeploymentError(Exception):
    """Base class for all MarketplaceDeployment service errors."""

class ServiceError(MarketplaceDeploymentError):
...
class SerializationError(MarketplaceDeploymentError):
    """Raised when a value cannot be serialized."""

class DeserializationError(MarketplaceDeploymentError):
...
class WaiterFailedError(MarketplaceDeploymentError):
...
class WaiterTimeoutError(MarketplaceDeploymentError):
