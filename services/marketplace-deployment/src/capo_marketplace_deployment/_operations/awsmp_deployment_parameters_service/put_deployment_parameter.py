...
import capo_marketplace_deployment.errors.conflict_exception
...
import capo_marketplace_deployment.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_marketplace_deployment.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_marketplace_deployment.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_marketplace_deployment.types.put_deployment_parameter_response.PutDeploymentParameterResponse = capo_marketplace_deployment.types.put_deployment_parameter_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_deployment.types.put_deployment_parameter_request.serialize_json(
            input_
        )
    ).encode()
