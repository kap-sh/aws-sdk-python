...
from capo_marketplace_deployment._services._aws_config import aws_config
...
class MarketplaceDeploymentClientConfig(TypedDict, total=False, closed=True):
...
class MarketplaceDeploymentClient:
    ...
    def __init__(
        ...
        self._config = MarketplaceDeploymentClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: MarketplaceDeploymentClientConfig = config_overrides or {}
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_tags_for_resource(resource_arn='arn:aws:aws-marketplace:us-east-1:123456789012:DeploymentParameter:catalogs/AWSMarketplace/products/product-1234/dp-uniqueidentifier')
        """

        def _handler(
            req: "OperationRequest[capo_marketplace_deployment.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_marketplace_deployment.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_deployment._operations.awsmp_deployment_parameters_service.list_tags_for_resource.list_tags_for_resource(
        ...
        input_: capo_marketplace_deployment.types.list_tags_for_resource_request.ListTagsForResourceRequest = {}  # type: ignore[typeddict-item]
    ...
    def tag_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.tag_resource(resource_arn='arn:aws:aws-marketplace:us-east-1:123456789012:DeploymentParameter:catalogs/AWSMarketplace/products/product-1234/dp-uniqueidentifier', tags={'FooKey': 'BarValue', 'HelloKey': 'WorldValue'})
        """

        def _handler(
            req: "OperationRequest[capo_marketplace_deployment.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_marketplace_deployment.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_deployment._operations.awsmp_deployment_parameters_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_marketplace_deployment.types.tag_resource_request.TagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        if tags is not None:
            input_["tags"] = tags
    ...
    def untag_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.untag_resource(resource_arn='arn:aws:aws-marketplace:us-east-1:123456789012:DeploymentParameter:catalogs/AWSMarketplace/products/product-1234/dp-uniqueidentifier', tag_keys=['FooKey', 'HelloKey'])
        """

        def _handler(
            req: "OperationRequest[capo_marketplace_deployment.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_marketplace_deployment.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_deployment._operations.awsmp_deployment_parameters_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_marketplace_deployment.types.untag_resource_request.UntagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
