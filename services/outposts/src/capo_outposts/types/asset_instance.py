...
if TYPE_CHECKING:
    ...
    import capo_outposts.types.outpost_instance_type


class AssetInstance(TypedDict, closed=True):
    instance_id: NotRequired["capo_outposts.types.instance_id.InstanceId"]
    """<p>The ID of the instance.</p>"""
    instance_type: NotRequired[
        "capo_outposts.types.outpost_instance_type.OutpostInstanceType"
    ]
    ...
    aws_service_name: NotRequired["capo_outposts.types.aws_service_name.AWSServiceName"]
...
def serialize_json(value: AssetInstance) -> dict:
    ...
    if "aws_service_name" in value:
        ...
        out["AwsServiceName"] = capo_outposts.types.aws_service_name.serialize_json(
