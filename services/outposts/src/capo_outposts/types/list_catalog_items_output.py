...
class ListCatalogItemsOutput(TypedDict, closed=True):
    catalog_items: NotRequired[
        "capo_outposts.types.catalog_item_list_definition.CatalogItemListDefinition"
    ]
...
def serialize_json(value: ListCatalogItemsOutput) -> dict:
    ...
    if "catalog_items" in value:
        ...
        out["CatalogItems"] = (
            capo_outposts.types.catalog_item_list_definition.serialize_json(
                value["catalog_items"]
            )
        )
...
def deserialize_json(data: dict) -> ListCatalogItemsOutput:
    ...
    if "CatalogItems" in data:
        ...
        out["catalog_items"] = (
            capo_outposts.types.catalog_item_list_definition.deserialize_json(
                data["CatalogItems"]
            )
        )
