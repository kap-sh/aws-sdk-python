...
class ListAssetsInput(TypedDict, closed=True):
    ...
    host_id_filter: NotRequired["capo_outposts.types.host_id_list.HostIdList"]
    ...
    status_filter: NotRequired["capo_outposts.types.status_list.StatusList"]
    """<p>Filters the results by state.</p>"""
    asset_type_filter: NotRequired["capo_outposts.types.asset_type_list.AssetTypeList"]
