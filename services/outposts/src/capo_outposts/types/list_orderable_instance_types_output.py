...
class ListOrderableInstanceTypesOutput(TypedDict, closed=True):
    instance_types: NotRequired[
        "capo_outposts.types.detailed_instance_type_list_definition.DetailedInstanceTypeListDefinition"
    ]
...
def serialize_json(value: ListOrderableInstanceTypesOutput) -> dict:
    ...
    if "instance_types" in value:
        ...
        out["InstanceTypes"] = (
            capo_outposts.types.detailed_instance_type_list_definition.serialize_json(
...
def deserialize_json(data: dict) -> ListOrderableInstanceTypesOutput:
    ...
    if "InstanceTypes" in data:
        ...
        out["instance_types"] = (
            capo_outposts.types.detailed_instance_type_list_definition.deserialize_json(
                data["InstanceTypes"]
            )
        )
