"""Generated from Smithy shape ``com.amazonaws.outposts#UntagResource``."""
...
def handle_response(
    ...
    out: capo_outposts.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_outposts.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
