...
def handle_response(
    ...
    out: capo_outposts.types.create_outpost_output.CreateOutpostOutput = (
        capo_outposts.types.create_outpost_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_outposts.types.create_outpost_input.serialize_json(input_)
    ).encode()
...
def create_outpost(
    ...
    capo_outposts.types.create_outpost_output.CreateOutpostOutput, zapros.Response
]:
