...
def handle_response(
    ...
    out: capo_outposts.types.get_outpost_billing_information_output.GetOutpostBillingInformationOutput = capo_outposts.types.get_outpost_billing_information_output.deserialize_json(
