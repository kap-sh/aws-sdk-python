"""Generated from Smithy shape ``com.amazonaws.outposts#GetQuote``."""
...
def handle_response(
    ...
    out: capo_outposts.types.get_quote_output.GetQuoteOutput = (
        capo_outposts.types.get_quote_output.deserialize_json(
...
def get_quote(
    options: OperationOptions, input_: capo_outposts.types.get_quote_input.GetQuoteInput
) -> tuple[capo_outposts.types.get_quote_output.GetQuoteOutput, zapros.Response]:
