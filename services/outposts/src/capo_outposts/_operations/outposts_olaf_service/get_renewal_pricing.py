"""Generated from Smithy shape ``com.amazonaws.outposts#GetRenewalPricing``."""
...
def handle_response(
    ...
    out: capo_outposts.types.get_renewal_pricing_output.GetRenewalPricingOutput = (
        capo_outposts.types.get_renewal_pricing_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/outpost/{OutpostIdentifier}/renewal-pricing"
    url = url.replace(
...
async def async_get_renewal_pricing(
