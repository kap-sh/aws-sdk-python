"""Generated from Smithy shape ``com.amazonaws.outposts#GetConnection``."""
...
def handle_response(
    ...
    out: capo_outposts.types.get_connection_response.GetConnectionResponse = (
        capo_outposts.types.get_connection_response.deserialize_json(
...
def get_connection(
    ...
    capo_outposts.types.get_connection_response.GetConnectionResponse, zapros.Response
]:
