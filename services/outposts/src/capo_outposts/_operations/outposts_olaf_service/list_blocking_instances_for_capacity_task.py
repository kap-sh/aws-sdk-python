"""Generated from Smithy shape ``com.amazonaws.outposts#ListBlockingInstancesForCapacityTask``."""
...
def handle_response(
    ...
    out: capo_outposts.types.list_blocking_instances_for_capacity_task_output.ListBlockingInstancesForCapacityTaskOutput = capo_outposts.types.list_blocking_instances_for_capacity_task_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{CapacityTaskId}", quote(str(input_["capacity_task_id"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_list_blocking_instances_for_capacity_task(
