"""Generated from Smithy shape ``com.amazonaws.outposts#GetSite``."""
...
def handle_response(
    ...
    out: capo_outposts.types.get_site_output.GetSiteOutput = (
        capo_outposts.types.get_site_output.deserialize_json(
...
def build_request(
    ...
    input_: capo_outposts.types.get_site_input.GetSiteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/sites/{SiteId}"
...
def get_site(
    options: OperationOptions, input_: capo_outposts.types.get_site_input.GetSiteInput
) -> tuple[capo_outposts.types.get_site_output.GetSiteOutput, zapros.Response]:
