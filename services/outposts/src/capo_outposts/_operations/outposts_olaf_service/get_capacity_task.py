"""Generated from Smithy shape ``com.amazonaws.outposts#GetCapacityTask``."""
...
def handle_response(
    ...
    out: capo_outposts.types.get_capacity_task_output.GetCapacityTaskOutput = (
        capo_outposts.types.get_capacity_task_output.deserialize_json(
...
def get_capacity_task(
    ...
    capo_outposts.types.get_capacity_task_output.GetCapacityTaskOutput, zapros.Response
]:
...
async def async_get_capacity_task(
