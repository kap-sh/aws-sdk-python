"""Generated from Smithy shape ``com.amazonaws.outposts#ListOrderableInstanceTypes``."""
...
import capo_outposts.types.detailed_instance_type_list_definition
...
def handle_response(
    ...
    out: capo_outposts.types.list_orderable_instance_types_output.ListOrderableInstanceTypesOutput = capo_outposts.types.list_orderable_instance_types_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/instanceTypes"
    params: dict[str, str] = {}
    if "outpost_generation_filter" in input_:
        params["OutpostGenerationFilter"] = str(input_["outpost_generation_filter"])
...
async def async_list_orderable_instance_types(
