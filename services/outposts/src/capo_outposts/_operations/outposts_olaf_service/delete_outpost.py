"""Generated from Smithy shape ``com.amazonaws.outposts#DeleteOutpost``."""
...
def handle_response(
    ...
    out: capo_outposts.types.delete_outpost_output.DeleteOutpostOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/outposts/{OutpostId}"
...
def delete_outpost(
    ...
    capo_outposts.types.delete_outpost_output.DeleteOutpostOutput, zapros.Response
]:
...
async def async_delete_outpost(
