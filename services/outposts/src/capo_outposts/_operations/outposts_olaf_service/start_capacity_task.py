"""Generated from Smithy shape ``com.amazonaws.outposts#StartCapacityTask``."""
...
def handle_response(
    ...
    out: capo_outposts.types.start_capacity_task_output.StartCapacityTaskOutput = (
        capo_outposts.types.start_capacity_task_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/outposts/{OutpostIdentifier}/capacity"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_outposts.types.start_capacity_task_input.serialize_json(input_)
    ).encode()
...
async def async_start_capacity_task(
