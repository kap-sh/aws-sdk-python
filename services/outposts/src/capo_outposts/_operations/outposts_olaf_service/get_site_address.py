"""Generated from Smithy shape ``com.amazonaws.outposts#GetSiteAddress``."""
...
def handle_response(
    ...
    out: capo_outposts.types.get_site_address_output.GetSiteAddressOutput = (
        capo_outposts.types.get_site_address_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sites/{SiteId}/address"
    url = url.replace("{SiteId}", quote(str(input_["site_id"]), safe=""))
    params: dict[str, str] = {}
    if "address_type" in input_:
        params["AddressType"] = str(input_["address_type"])
...
def get_site_address(
    ...
    capo_outposts.types.get_site_address_output.GetSiteAddressOutput, zapros.Response
]:
...
async def async_get_site_address(
