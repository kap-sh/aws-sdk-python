"""Generated from Smithy shape ``com.amazonaws.outposts#CancelOrder``."""
...
def handle_response(
    ...
    out: capo_outposts.types.cancel_order_output.CancelOrderOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/orders/{OrderId}/cancel"
    url = url.replace("{OrderId}", quote(str(input_["order_id"]), safe=""))
    params: dict[str, str] = {}
...
def cancel_order(
    ...
    input_: capo_outposts.types.cancel_order_input.CancelOrderInput,
) -> tuple[capo_outposts.types.cancel_order_output.CancelOrderOutput, zapros.Response]:
