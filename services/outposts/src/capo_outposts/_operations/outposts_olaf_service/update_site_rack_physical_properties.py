...
def handle_response(
    ...
    out: capo_outposts.types.update_site_rack_physical_properties_output.UpdateSiteRackPhysicalPropertiesOutput = capo_outposts.types.update_site_rack_physical_properties_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_outposts.types.update_site_rack_physical_properties_input.serialize_json(
            input_
        )
    ).encode()
