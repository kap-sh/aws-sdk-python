"""Generated from Smithy shape ``com.amazonaws.outposts#DeleteSite``."""
...
def handle_response(
    ...
    out: capo_outposts.types.delete_site_output.DeleteSiteOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_site(
    ...
    input_: capo_outposts.types.delete_site_input.DeleteSiteInput,
) -> tuple[capo_outposts.types.delete_site_output.DeleteSiteOutput, zapros.Response]:
