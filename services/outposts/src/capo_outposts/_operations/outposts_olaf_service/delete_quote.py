"""Generated from Smithy shape ``com.amazonaws.outposts#DeleteQuote``."""
...
def handle_response(
    ...
    out: capo_outposts.types.delete_quote_output.DeleteQuoteOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_quote(
    ...
    input_: capo_outposts.types.delete_quote_input.DeleteQuoteInput,
) -> tuple[capo_outposts.types.delete_quote_output.DeleteQuoteOutput, zapros.Response]:
