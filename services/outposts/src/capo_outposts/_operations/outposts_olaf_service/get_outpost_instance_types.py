"""Generated from Smithy shape ``com.amazonaws.outposts#GetOutpostInstanceTypes``."""
...
def handle_response(
    ...
    out: capo_outposts.types.get_outpost_instance_types_output.GetOutpostInstanceTypesOutput = capo_outposts.types.get_outpost_instance_types_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/outposts/{OutpostId}/instanceTypes"
    url = url.replace("{OutpostId}", quote(str(input_["outpost_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_outpost_instance_types(
