"""Generated from Smithy shape ``com.amazonaws.outposts#UpdateSite``."""
...
def handle_response(
    ...
    out: capo_outposts.types.update_site_output.UpdateSiteOutput = (
        capo_outposts.types.update_site_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_outposts.types.update_site_input.serialize_json(input_)
    ).encode()
...
def update_site(
    ...
    input_: capo_outposts.types.update_site_input.UpdateSiteInput,
) -> tuple[capo_outposts.types.update_site_output.UpdateSiteOutput, zapros.Response]:
