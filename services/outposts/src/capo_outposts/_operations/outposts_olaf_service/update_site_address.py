"""Generated from Smithy shape ``com.amazonaws.outposts#UpdateSiteAddress``."""
...
def handle_response(
    ...
    out: capo_outposts.types.update_site_address_output.UpdateSiteAddressOutput = (
        capo_outposts.types.update_site_address_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_outposts.types.update_site_address_input.serialize_json(input_)
    ).encode()
...
async def async_update_site_address(
