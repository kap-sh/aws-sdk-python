...
def handle_response(
    ...
    out: capo_outposts.types.list_capacity_tasks_output.ListCapacityTasksOutput = (
        capo_outposts.types.list_capacity_tasks_output.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "outpost_identifier_filter" in input_:
        params["OutpostIdentifierFilter"] = str(input_["outpost_identifier_filter"])
    if "max_results" in input_:
        params["MaxResults"] = str(input_["max_results"])
    if "next_token" in input_:
        params["NextToken"] = str(input_["next_token"])
    if "capacity_task_status_filter" in input_:
        params["CapacityTaskStatusFilter"] = str(input_["capacity_task_status_filter"])
