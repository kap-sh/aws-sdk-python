"""Generated from Smithy shape ``com.amazonaws.outposts#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.outposts#InternalServerException``."""
