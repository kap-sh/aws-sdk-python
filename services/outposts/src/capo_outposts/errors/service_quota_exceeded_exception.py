"""Generated from Smithy shape ``com.amazonaws.outposts#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.outposts#ServiceQuotaExceededException``."""
