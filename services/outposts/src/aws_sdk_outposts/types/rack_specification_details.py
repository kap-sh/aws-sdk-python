...
if TYPE_CHECKING:
    ...
    import aws_sdk_outposts.types.quote_rack_use_type
...
def serialize_json(value: RackSpecificationDetails) -> dict:
    ...
    if "rack_use" in value:
        ...
        out["RackUse"] = aws_sdk_outposts.types.quote_rack_use_type.serialize_json(
            value["rack_use"]
        )
...
def deserialize_json(data: dict) -> RackSpecificationDetails:
    ...
    if "RackUse" in data:
        ...
        out["rack_use"] = aws_sdk_outposts.types.quote_rack_use_type.deserialize_json(
            data["RackUse"]
        )
