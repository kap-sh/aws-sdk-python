...
if TYPE_CHECKING:
    import aws_sdk_outposts.types.address_line1
    import aws_sdk_outposts.types.address_line2
    import aws_sdk_outposts.types.address_line3
    import aws_sdk_outposts.types.city
    import aws_sdk_outposts.types.contact_name
    import aws_sdk_outposts.types.contact_phone_number
    import aws_sdk_outposts.types.country_code
    import aws_sdk_outposts.types.district_or_county
    import aws_sdk_outposts.types.municipality
    import aws_sdk_outposts.types.postal_code
...
class Address(TypedDict):
    ...
    contact_phone_number: (
        "aws_sdk_outposts.types.contact_phone_number.ContactPhoneNumber"
    )
    """<p>The phone number of the contact.</p>"""
    address_line1: "aws_sdk_outposts.types.address_line1.AddressLine1"
    """<p>The first line of the address.</p>"""
    address_line2: NotRequired["aws_sdk_outposts.types.address_line2.AddressLine2"]
    """<p>The second line of the address.</p>"""
    address_line3: NotRequired["aws_sdk_outposts.types.address_line3.AddressLine3"]
    """<p>The third line of the address.</p>"""
    city: "aws_sdk_outposts.types.city.City"
    """<p>The city for the address.</p>"""
    state_or_region: "aws_sdk_outposts.types.state_or_region.StateOrRegion"
    """<p>The state for the address.</p>"""
    district_or_county: NotRequired[
        "aws_sdk_outposts.types.district_or_county.DistrictOrCounty"
    ]
    """<p>The district or county for the address.</p>"""
    postal_code: "aws_sdk_outposts.types.postal_code.PostalCode"
    ...
    municipality: NotRequired["aws_sdk_outposts.types.municipality.Municipality"]
