...
if TYPE_CHECKING:
    import aws_sdk_outposts.types.asset_instance_capacity_list
    import aws_sdk_outposts.types.compute_asset_state
    import aws_sdk_outposts.types.host_id
    import aws_sdk_outposts.types.instance_families
    import aws_sdk_outposts.types.vcpu_count


class ComputeAttributes(TypedDict):
    host_id: NotRequired["aws_sdk_outposts.types.host_id.HostId"]
    """<p> The host ID of the Dedicated Host on the asset. </p>"""
    state: NotRequired["aws_sdk_outposts.types.compute_asset_state.ComputeAssetState"]
    ...
    instance_families: NotRequired[
        "aws_sdk_outposts.types.instance_families.InstanceFamilies"
    ]
    ...
    instance_type_capacities: NotRequired[
        "aws_sdk_outposts.types.asset_instance_capacity_list.AssetInstanceCapacityList"
    ]
    """<p>The instance type capacities configured for this asset. This can be changed through a capacity task.</p>"""
    max_vcpus: NotRequired["aws_sdk_outposts.types.vcpu_count.VCPUCount"]
...
def serialize_json(value: ComputeAttributes) -> dict:
    ...
    if "state" in value:
        ...
        out["State"] = aws_sdk_outposts.types.compute_asset_state.serialize_json(
            value["state"]
        )
    if "instance_families" in value:
        ...
        out["InstanceFamilies"] = (
            aws_sdk_outposts.types.instance_families.serialize_json(
    ...
    if "instance_type_capacities" in value:
        ...
        out["InstanceTypeCapacities"] = (
            aws_sdk_outposts.types.asset_instance_capacity_list.serialize_json(
...
def deserialize_json(data: dict) -> ComputeAttributes:
    ...
    if "State" in data:
        ...
        out["state"] = aws_sdk_outposts.types.compute_asset_state.deserialize_json(
            data["State"]
        )
    if "InstanceFamilies" in data:
        ...
        out["instance_families"] = (
            aws_sdk_outposts.types.instance_families.deserialize_json(
    ...
    if "InstanceTypeCapacities" in data:
        ...
        out["instance_type_capacities"] = (
            aws_sdk_outposts.types.asset_instance_capacity_list.deserialize_json(
