...
if TYPE_CHECKING:
    ...
    import aws_sdk_outposts.types.ordering_requirement_list
...
class Quote(TypedDict, closed=True):
    ...
    ordering_requirements: NotRequired[
        "aws_sdk_outposts.types.ordering_requirement_list.OrderingRequirementList"
    ]
...
def serialize_json(value: Quote) -> dict:
    ...
    if "ordering_requirements" in value:
        ...
        out["OrderingRequirements"] = (
            aws_sdk_outposts.types.ordering_requirement_list.serialize_json(
...
def deserialize_json(data: dict) -> Quote:
    ...
    if "OrderingRequirements" in data:
        ...
        out["ordering_requirements"] = (
            aws_sdk_outposts.types.ordering_requirement_list.deserialize_json(
