...
if TYPE_CHECKING:
    import aws_sdk_outposts.types.ordering_requirement_status
    import aws_sdk_outposts.types.ordering_requirement_type
    import aws_sdk_outposts.types.status_message


class OrderingRequirement(TypedDict):
    ...
    ordering_requirement_type: NotRequired[
        "aws_sdk_outposts.types.ordering_requirement_type.OrderingRequirementType"
    ]
    ...
    status: NotRequired[
        "aws_sdk_outposts.types.ordering_requirement_status.OrderingRequirementStatus"
    ]
...
def serialize_json(value: OrderingRequirement) -> dict:
    ...
    if "ordering_requirement_type" in value:
        ...
        out["OrderingRequirementType"] = (
            aws_sdk_outposts.types.ordering_requirement_type.serialize_json(
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_outposts.types.ordering_requirement_status.serialize_json(
                value["status"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> OrderingRequirement:
    ...
    if "OrderingRequirementType" in data:
        ...
        out["ordering_requirement_type"] = (
            aws_sdk_outposts.types.ordering_requirement_type.deserialize_json(
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_outposts.types.ordering_requirement_status.deserialize_json(
                data["Status"]
            )
        )
    return out
