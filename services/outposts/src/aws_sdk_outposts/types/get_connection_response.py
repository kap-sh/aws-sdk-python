...
if TYPE_CHECKING:
    import aws_sdk_outposts.types.connection_details
...
class GetConnectionResponse(TypedDict):
    ...
    connection_details: NotRequired[
        "aws_sdk_outposts.types.connection_details.ConnectionDetails"
    ]
...
def serialize_json(value: GetConnectionResponse) -> dict:
    ...
    if "connection_details" in value:
        ...
        out["ConnectionDetails"] = (
            aws_sdk_outposts.types.connection_details.serialize_json(
...
def deserialize_json(data: dict) -> GetConnectionResponse:
    ...
    if "ConnectionDetails" in data:
        ...
        out["connection_details"] = (
            aws_sdk_outposts.types.connection_details.deserialize_json(
