...
def handle_response(
    ...
    out: aws_sdk_outposts.types.get_outpost_instance_types_output.GetOutpostInstanceTypesOutput = aws_sdk_outposts.types.get_outpost_instance_types_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.get_outpost_instance_types_input.GetOutpostInstanceTypesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
