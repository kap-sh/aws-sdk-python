...
def build_request(
    ...
    input: aws_sdk_outposts.types.list_outposts_input.ListOutpostsInput,
) -> zapros.Request:
    ...
    if "life_cycle_status_filter" in input:
        params["LifeCycleStatusFilter"] = str(input["life_cycle_status_filter"])
    if "availability_zone_filter" in input:
        params["AvailabilityZoneFilter"] = str(input["availability_zone_filter"])
    if "availability_zone_id_filter" in input:
        params["AvailabilityZoneIdFilter"] = str(input["availability_zone_id_filter"])
