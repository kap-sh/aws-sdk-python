...
def handle_response(
    ...
    out: aws_sdk_outposts.types.cancel_capacity_task_output.CancelCapacityTaskOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.cancel_capacity_task_input.CancelCapacityTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
