"""Generated from Smithy shape ``com.amazonaws.outposts#GetOrder``."""
...
def handle_response(
    ...
    out: aws_sdk_outposts.types.get_order_output.GetOrderOutput = (
        aws_sdk_outposts.types.get_order_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.get_order_input.GetOrderInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/orders/{OrderId}"
...
def get_order(
    ...
    input_: aws_sdk_outposts.types.get_order_input.GetOrderInput,
) -> tuple[aws_sdk_outposts.types.get_order_output.GetOrderOutput, zapros.Response]:
