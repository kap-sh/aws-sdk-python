...
def handle_response(
    ...
    out: aws_sdk_outposts.types.get_site_output.GetSiteOutput = (
        aws_sdk_outposts.types.get_site_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_outposts.types.get_site_input.GetSiteInput,
) -> zapros.Request:
...
def get_site(
    options: OperationOptions, input: aws_sdk_outposts.types.get_site_input.GetSiteInput
) -> tuple[aws_sdk_outposts.types.get_site_output.GetSiteOutput, zapros.Response]:
