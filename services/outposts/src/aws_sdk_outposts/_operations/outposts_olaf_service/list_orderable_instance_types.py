...
def handle_response(
    ...
    out: aws_sdk_outposts.types.list_orderable_instance_types_output.ListOrderableInstanceTypesOutput = aws_sdk_outposts.types.list_orderable_instance_types_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.list_orderable_instance_types_input.ListOrderableInstanceTypesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
