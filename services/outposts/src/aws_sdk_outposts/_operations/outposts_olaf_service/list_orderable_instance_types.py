...
def build_request(
    ...
    input: aws_sdk_outposts.types.list_orderable_instance_types_input.ListOrderableInstanceTypesInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "outpost_generation_filter" in input:
        params["OutpostGenerationFilter"] = str(input["outpost_generation_filter"])
