...
def handle_response(
    ...
    out: aws_sdk_outposts.types.update_site_output.UpdateSiteOutput = (
        aws_sdk_outposts.types.update_site_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.update_site_input.UpdateSiteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.update_site_input.serialize_json(input_)
    ).encode()
...
def update_site(
    ...
    input_: aws_sdk_outposts.types.update_site_input.UpdateSiteInput,
) -> tuple[aws_sdk_outposts.types.update_site_output.UpdateSiteOutput, zapros.Response]:
