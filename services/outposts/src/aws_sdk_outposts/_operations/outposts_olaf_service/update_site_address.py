...
def handle_response(
    ...
    out: aws_sdk_outposts.types.update_site_address_output.UpdateSiteAddressOutput = (
        aws_sdk_outposts.types.update_site_address_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.update_site_address_input.UpdateSiteAddressInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.update_site_address_input.serialize_json(input_)
    ).encode()
