"""Generated from Smithy shape ``com.amazonaws.outposts#CreateOutpost``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_outposts.errors.service_quota_exceeded_exception

            raise aws_sdk_outposts.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_outposts.types.create_outpost_output.CreateOutpostOutput = (
        aws_sdk_outposts.types.create_outpost_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.create_outpost_input.CreateOutpostInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.create_outpost_input.serialize_json(input_)
    ).encode()
...
def create_outpost(
    ...
    aws_sdk_outposts.types.create_outpost_output.CreateOutpostOutput, zapros.Response
]:
...
async def async_create_outpost(
