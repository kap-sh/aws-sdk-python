...
def handle_response(
    ...
    out: aws_sdk_outposts.types.list_orders_output.ListOrdersOutput = (
        aws_sdk_outposts.types.list_orders_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.list_orders_input.ListOrdersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_orders(
    ...
    input_: aws_sdk_outposts.types.list_orders_input.ListOrdersInput,
) -> tuple[aws_sdk_outposts.types.list_orders_output.ListOrdersOutput, zapros.Response]:
