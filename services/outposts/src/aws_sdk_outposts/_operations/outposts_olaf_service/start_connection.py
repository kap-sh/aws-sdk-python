...
def handle_response(
    ...
    out: aws_sdk_outposts.types.start_connection_response.StartConnectionResponse = (
        aws_sdk_outposts.types.start_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.start_connection_request.StartConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.start_connection_request.serialize_json(input_)
    ).encode()
