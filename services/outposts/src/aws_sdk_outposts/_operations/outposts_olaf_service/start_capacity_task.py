...
def handle_response(
    ...
    out: aws_sdk_outposts.types.start_capacity_task_output.StartCapacityTaskOutput = (
        aws_sdk_outposts.types.start_capacity_task_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.start_capacity_task_input.StartCapacityTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.start_capacity_task_input.serialize_json(input_)
    ).encode()
