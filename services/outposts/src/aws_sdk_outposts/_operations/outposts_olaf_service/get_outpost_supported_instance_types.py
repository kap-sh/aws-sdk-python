"""Generated from Smithy shape ``com.amazonaws.outposts#GetOutpostSupportedInstanceTypes``."""
...
def handle_response(
    ...
    out: aws_sdk_outposts.types.get_outpost_supported_instance_types_output.GetOutpostSupportedInstanceTypesOutput = aws_sdk_outposts.types.get_outpost_supported_instance_types_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.get_outpost_supported_instance_types_input.GetOutpostSupportedInstanceTypesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "order_id" in input_:
        params["OrderId"] = str(input_["order_id"])
...
async def async_get_outpost_supported_instance_types(
