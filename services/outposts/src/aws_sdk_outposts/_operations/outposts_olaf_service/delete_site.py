...
def handle_response(
    ...
    out: aws_sdk_outposts.types.delete_site_output.DeleteSiteOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.delete_site_input.DeleteSiteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_site(
    ...
    input_: aws_sdk_outposts.types.delete_site_input.DeleteSiteInput,
) -> tuple[aws_sdk_outposts.types.delete_site_output.DeleteSiteOutput, zapros.Response]:
