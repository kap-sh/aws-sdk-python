...
def handle_response(
    ...
    out: aws_sdk_outposts.types.get_site_address_output.GetSiteAddressOutput = (
        aws_sdk_outposts.types.get_site_address_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_outposts.types.get_site_address_input.GetSiteAddressInput,
) -> zapros.Request:
    ...
    url = url.replace("{SiteId}", quote(str(input["site_id"]), safe=""))
    params: dict[str, str] = {}
    if "address_type" in input:
        params["AddressType"] = str(input["address_type"])
...
def get_site_address(
    ...
    aws_sdk_outposts.types.get_site_address_output.GetSiteAddressOutput, zapros.Response
]:
