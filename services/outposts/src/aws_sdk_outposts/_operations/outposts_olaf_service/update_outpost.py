...
def handle_response(
    ...
    out: aws_sdk_outposts.types.update_outpost_output.UpdateOutpostOutput = (
        aws_sdk_outposts.types.update_outpost_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.update_outpost_input.UpdateOutpostInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.update_outpost_input.serialize_json(input_)
    ).encode()
...
def update_outpost(
    ...
    aws_sdk_outposts.types.update_outpost_output.UpdateOutpostOutput, zapros.Response
]:
