...
def build_request(
    ...
    input: aws_sdk_outposts.types.update_quote_input.UpdateQuoteInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{QuoteIdentifier}", quote(str(input["quote_identifier"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.update_quote_input.serialize_json(input)
    ).encode()
