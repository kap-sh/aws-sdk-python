"""Generated from Smithy shape ``com.amazonaws.outposts#UpdateQuote``."""
...
def handle_response(
    ...
    out: aws_sdk_outposts.types.update_quote_output.UpdateQuoteOutput = (
        aws_sdk_outposts.types.update_quote_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.update_quote_input.UpdateQuoteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/quotes/{QuoteIdentifier}"
    url = url.replace(
        "{QuoteIdentifier}", quote(str(input_["quote_identifier"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.update_quote_input.serialize_json(input_)
    ).encode()
...
def update_quote(
    ...
    aws_sdk_outposts.types.update_quote_output.UpdateQuoteOutput, zapros.Response
]:
