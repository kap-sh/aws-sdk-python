"""Generated from Smithy shape ``com.amazonaws.outposts#ListAssets``."""
...
def handle_response(
    ...
    out: aws_sdk_outposts.types.list_assets_output.ListAssetsOutput = (
        aws_sdk_outposts.types.list_assets_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.list_assets_input.ListAssetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/outposts/{OutpostIdentifier}/assets"
    url = url.replace(
        "{OutpostIdentifier}", quote(str(input_["outpost_identifier"]), safe="")
    )
    params: dict[str, str] = {}
    if "host_id_filter" in input_:
        params["HostIdFilter"] = str(input_["host_id_filter"])
    ...
    if "asset_type_filter" in input_:
        params["AssetTypeFilter"] = str(input_["asset_type_filter"])
...
def list_assets(
    ...
    input_: aws_sdk_outposts.types.list_assets_input.ListAssetsInput,
) -> tuple[aws_sdk_outposts.types.list_assets_output.ListAssetsOutput, zapros.Response]:
