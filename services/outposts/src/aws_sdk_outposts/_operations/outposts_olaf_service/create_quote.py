"""Generated from Smithy shape ``com.amazonaws.outposts#CreateQuote``."""
...
def handle_response(
    ...
    out: aws_sdk_outposts.types.create_quote_output.CreateQuoteOutput = (
        aws_sdk_outposts.types.create_quote_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.create_quote_input.CreateQuoteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/quotes"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_outposts.types.create_quote_input

    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.create_quote_input.serialize_json(input_)
    ).encode()
...
def create_quote(
    ...
    aws_sdk_outposts.types.create_quote_output.CreateQuoteOutput, zapros.Response
]:
