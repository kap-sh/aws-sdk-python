...
def handle_response(
    ...
    out: aws_sdk_outposts.types.create_site_output.CreateSiteOutput = (
        aws_sdk_outposts.types.create_site_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.create_site_input.CreateSiteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.create_site_input.serialize_json(input_)
    ).encode()
...
def create_site(
    ...
    input_: aws_sdk_outposts.types.create_site_input.CreateSiteInput,
) -> tuple[aws_sdk_outposts.types.create_site_output.CreateSiteOutput, zapros.Response]:
