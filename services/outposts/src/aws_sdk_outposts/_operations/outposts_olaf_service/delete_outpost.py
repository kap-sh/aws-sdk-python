...
def handle_response(
    ...
    out: aws_sdk_outposts.types.delete_outpost_output.DeleteOutpostOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.delete_outpost_input.DeleteOutpostInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_outpost(
    ...
    aws_sdk_outposts.types.delete_outpost_output.DeleteOutpostOutput, zapros.Response
]:
