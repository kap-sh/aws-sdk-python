...
def handle_response(
    ...
    out: aws_sdk_outposts.types.cancel_order_output.CancelOrderOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.cancel_order_input.CancelOrderInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def cancel_order(
    ...
    aws_sdk_outposts.types.cancel_order_output.CancelOrderOutput, zapros.Response
]:
