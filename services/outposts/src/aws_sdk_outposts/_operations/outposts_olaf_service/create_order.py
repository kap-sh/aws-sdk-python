"""Generated from Smithy shape ``com.amazonaws.outposts#CreateOrder``."""
...
def handle_response(
    ...
    out: aws_sdk_outposts.types.create_order_output.CreateOrderOutput = (
        aws_sdk_outposts.types.create_order_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.create_order_input.CreateOrderInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/orders"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.create_order_input.serialize_json(input_)
    ).encode()
...
def create_order(
    ...
    aws_sdk_outposts.types.create_order_output.CreateOrderOutput, zapros.Response
]:
