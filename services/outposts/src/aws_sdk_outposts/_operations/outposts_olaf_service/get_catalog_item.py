...
def handle_response(
    ...
    out: aws_sdk_outposts.types.get_catalog_item_output.GetCatalogItemOutput = (
        aws_sdk_outposts.types.get_catalog_item_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_outposts.types.get_catalog_item_input.GetCatalogItemInput,
) -> zapros.Request:
    ...
    url = url.replace("{CatalogItemId}", quote(str(input["catalog_item_id"]), safe=""))
    params: dict[str, str] = {}
...
def get_catalog_item(
    ...
    aws_sdk_outposts.types.get_catalog_item_output.GetCatalogItemOutput, zapros.Response
]:
