...
def handle_response(
    ...
    out: aws_sdk_outposts.types.list_sites_output.ListSitesOutput = (
        aws_sdk_outposts.types.list_sites_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.list_sites_input.ListSitesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_sites(
    ...
    input_: aws_sdk_outposts.types.list_sites_input.ListSitesInput,
) -> tuple[aws_sdk_outposts.types.list_sites_output.ListSitesOutput, zapros.Response]:
