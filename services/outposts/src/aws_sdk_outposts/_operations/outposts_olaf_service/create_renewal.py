...
def handle_response(
    ...
    out: aws_sdk_outposts.types.create_renewal_output.CreateRenewalOutput = (
        aws_sdk_outposts.types.create_renewal_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.create_renewal_input.CreateRenewalInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.create_renewal_input.serialize_json(input_)
    ).encode()
...
def create_renewal(
    ...
    aws_sdk_outposts.types.create_renewal_output.CreateRenewalOutput, zapros.Response
]:
