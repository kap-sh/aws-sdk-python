...
def handle_response(
    ...
    out: aws_sdk_outposts.types.get_connection_response.GetConnectionResponse = (
        aws_sdk_outposts.types.get_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.get_connection_request.GetConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
