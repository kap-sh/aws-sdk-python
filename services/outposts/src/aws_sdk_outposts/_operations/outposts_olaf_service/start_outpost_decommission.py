...
def build_request(
    ...
    input: aws_sdk_outposts.types.start_outpost_decommission_input.StartOutpostDecommissionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.start_outpost_decommission_input.serialize_json(input)
    ).encode()
