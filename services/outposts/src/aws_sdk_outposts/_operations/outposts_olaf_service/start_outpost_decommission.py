"""Generated from Smithy shape ``com.amazonaws.outposts#StartOutpostDecommission``."""
...
def handle_response(
    ...
    out: aws_sdk_outposts.types.start_outpost_decommission_output.StartOutpostDecommissionOutput = aws_sdk_outposts.types.start_outpost_decommission_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.start_outpost_decommission_input.StartOutpostDecommissionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/outposts/{OutpostIdentifier}/decommission"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_outposts.types.start_outpost_decommission_input.serialize_json(input_)
    ).encode()
...
async def async_start_outpost_decommission(
