...
def handle_response(
    ...
    out: aws_sdk_outposts.types.list_blocking_instances_for_capacity_task_output.ListBlockingInstancesForCapacityTaskOutput = aws_sdk_outposts.types.list_blocking_instances_for_capacity_task_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.list_blocking_instances_for_capacity_task_input.ListBlockingInstancesForCapacityTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
