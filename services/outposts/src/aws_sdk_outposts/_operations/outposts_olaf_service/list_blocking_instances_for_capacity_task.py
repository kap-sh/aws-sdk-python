...
def build_request(
    ...
    input: aws_sdk_outposts.types.list_blocking_instances_for_capacity_task_input.ListBlockingInstancesForCapacityTaskInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{CapacityTaskId}", quote(str(input["capacity_task_id"]), safe="")
    )
    params: dict[str, str] = {}
