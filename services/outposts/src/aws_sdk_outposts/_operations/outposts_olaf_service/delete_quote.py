...
def handle_response(
    ...
    out: aws_sdk_outposts.types.delete_quote_output.DeleteQuoteOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.delete_quote_input.DeleteQuoteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_quote(
    ...
    aws_sdk_outposts.types.delete_quote_output.DeleteQuoteOutput, zapros.Response
]:
