...
def handle_response(
    ...
    out: aws_sdk_outposts.types.get_quote_output.GetQuoteOutput = (
        aws_sdk_outposts.types.get_quote_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.get_quote_input.GetQuoteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_quote(
    ...
    input_: aws_sdk_outposts.types.get_quote_input.GetQuoteInput,
) -> tuple[aws_sdk_outposts.types.get_quote_output.GetQuoteOutput, zapros.Response]:
