...
def handle_response(
    ...
    out: aws_sdk_outposts.types.get_outpost_output.GetOutpostOutput = (
        aws_sdk_outposts.types.get_outpost_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.get_outpost_input.GetOutpostInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_outpost(
    ...
    input_: aws_sdk_outposts.types.get_outpost_input.GetOutpostInput,
) -> tuple[aws_sdk_outposts.types.get_outpost_output.GetOutpostOutput, zapros.Response]:
