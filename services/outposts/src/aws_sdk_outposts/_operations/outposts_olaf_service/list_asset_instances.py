...
def build_request(
    ...
    input: aws_sdk_outposts.types.list_asset_instances_input.ListAssetInstancesInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "asset_id_filter" in input:
        params["AssetIdFilter"] = str(input["asset_id_filter"])
    if "instance_type_filter" in input:
        params["InstanceTypeFilter"] = str(input["instance_type_filter"])
    if "account_id_filter" in input:
        params["AccountIdFilter"] = str(input["account_id_filter"])
    if "aws_service_filter" in input:
        params["AwsServiceFilter"] = str(input["aws_service_filter"])
