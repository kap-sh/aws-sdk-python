"""Generated from Smithy shape ``com.amazonaws.outposts#ListQuotes``."""
...
def handle_response(
    ...
    out: aws_sdk_outposts.types.list_quotes_output.ListQuotesOutput = (
        aws_sdk_outposts.types.list_quotes_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.list_quotes_input.ListQuotesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_quotes(
    ...
    input_: aws_sdk_outposts.types.list_quotes_input.ListQuotesInput,
) -> tuple[aws_sdk_outposts.types.list_quotes_output.ListQuotesOutput, zapros.Response]:
