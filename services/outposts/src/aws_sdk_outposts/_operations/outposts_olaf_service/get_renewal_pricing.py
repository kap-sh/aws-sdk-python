...
def handle_response(
    ...
    out: aws_sdk_outposts.types.get_renewal_pricing_output.GetRenewalPricingOutput = (
        aws_sdk_outposts.types.get_renewal_pricing_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_outposts.types.get_renewal_pricing_input.GetRenewalPricingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
