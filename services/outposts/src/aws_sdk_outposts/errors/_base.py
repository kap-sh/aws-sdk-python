...
class OutpostsError(Exception):
    """Base class for all Outposts service errors."""


class ServiceError(OutpostsError):
...
class SerializationError(OutpostsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(OutpostsError):
...
class WaiterFailedError(OutpostsError):
...
class WaiterTimeoutError(OutpostsError):
