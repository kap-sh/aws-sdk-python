...
from aws_sdk_mpa._resources.aws_fluffy_core_service.approval_team import ApprovalTeam
from aws_sdk_mpa._resources.aws_fluffy_core_service.identity_source import (
    IdentitySource,
)
from aws_sdk_mpa._resources.aws_fluffy_core_service.session import Session
from aws_sdk_mpa._services._aws_config import aws_config
...
class MPAClientConfig(TypedDict, total=False):
...
class MPAClient:
    ...
    def get_policy_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mpa.types.get_policy_version_request.GetPolicyVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_mpa.types.get_policy_version_response.GetPolicyVersionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mpa._operations.aws_fluffy_core_service.get_policy_version.get_policy_version(
    ...
    def get_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mpa.types.get_resource_policy_request.GetResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_mpa.types.get_resource_policy_response.GetResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mpa._operations.aws_fluffy_core_service.get_resource_policy.get_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mpa.types.list_policies_request.ListPoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_mpa.types.list_policies_response.ListPoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mpa._operations.aws_fluffy_core_service.list_policies.list_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_policies(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_mpa.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_mpa.types.token.Token"] = None,
    ) -> "Iterator[aws_sdk_mpa.types.policy.Policy]":
        _token = next_token
        while True:
    ...
    def list_policy_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mpa.types.list_policy_versions_request.ListPolicyVersionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_mpa.types.list_policy_versions_response.ListPolicyVersionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mpa._operations.aws_fluffy_core_service.list_policy_versions.list_policy_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_policy_versions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_mpa.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_mpa.types.token.Token"] = None,
    ) -> "Iterator[aws_sdk_mpa.types.policy_version_summary.PolicyVersionSummary]":
        _token = next_token
        while True:
    ...
    def list_resource_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mpa.types.list_resource_policies_request.ListResourcePoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_mpa.types.list_resource_policies_response.ListResourcePoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mpa._operations.aws_fluffy_core_service.list_resource_policies.list_resource_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_resource_policies(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_mpa.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_mpa.types.token.Token"] = None,
    ) -> "Iterator[aws_sdk_mpa.types.list_resource_policies_response_resource_policy.ListResourcePoliciesResponseResourcePolicy]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mpa.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_mpa.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mpa._operations.aws_fluffy_core_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mpa.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_mpa.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mpa._operations.aws_fluffy_core_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mpa.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_mpa.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mpa._operations.aws_fluffy_core_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
