"""Generated from Smithy shape ``com.amazonaws.mpa#ListResourcePolicies``."""
...
import aws_sdk_mpa.types.list_resource_policies_response_resource_policies
...
def handle_response(
    ...
    out: aws_sdk_mpa.types.list_resource_policies_response.ListResourcePoliciesResponse = aws_sdk_mpa.types.list_resource_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.list_resource_policies_request.ListResourcePoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/resource-policies/{ResourceArn}/?List"
