"""Generated from Smithy shape ``com.amazonaws.mpa#ListIdentitySources``."""
...
def handle_response(
    ...
    out: aws_sdk_mpa.types.list_identity_sources_response.ListIdentitySourcesResponse = aws_sdk_mpa.types.list_identity_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.list_identity_sources_request.ListIdentitySourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/identity-sources/?List"
    params: dict[str, str] = {}
