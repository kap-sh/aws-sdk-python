"""Generated from Smithy shape ``com.amazonaws.mpa#DeleteInactiveApprovalTeamVersion``."""
...
import aws_sdk_mpa.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_mpa.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_mpa.types.delete_inactive_approval_team_version_response.DeleteInactiveApprovalTeamVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.delete_inactive_approval_team_version_request.DeleteInactiveApprovalTeamVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/approval-teams/{Arn}/{VersionId}"
...
async def async_delete_inactive_approval_team_version(
