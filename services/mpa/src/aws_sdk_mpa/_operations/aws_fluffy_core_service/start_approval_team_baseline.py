"""Generated from Smithy shape ``com.amazonaws.mpa#StartApprovalTeamBaseline``."""
...
def handle_response(
    ...
    out: aws_sdk_mpa.types.start_approval_team_baseline_response.StartApprovalTeamBaselineResponse = aws_sdk_mpa.types.start_approval_team_baseline_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.start_approval_team_baseline_request.StartApprovalTeamBaselineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/approval-teams/{Arn}/baseline"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mpa.types.start_approval_team_baseline_request.serialize_json(input_)
    ).encode()
...
async def async_start_approval_team_baseline(
