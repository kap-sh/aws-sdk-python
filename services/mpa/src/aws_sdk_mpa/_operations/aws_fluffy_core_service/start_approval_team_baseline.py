...
def build_request(
    ...
    input: aws_sdk_mpa.types.start_approval_team_baseline_request.StartApprovalTeamBaselineRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mpa.types.start_approval_team_baseline_request.serialize_json(input)
    ).encode()
