...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidParameterException":
            import aws_sdk_mpa.errors.invalid_parameter_exception

            raise aws_sdk_mpa.errors.invalid_parameter_exception.InvalidParameterException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_mpa.types.get_resource_policy_response.GetResourcePolicyResponse = (
        aws_sdk_mpa.types.get_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.get_resource_policy_request.GetResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mpa.types.get_resource_policy_request.serialize_json(input_)
    ).encode()
