...
def handle_response(
    ...
    out: aws_sdk_mpa.types.list_policies_response.ListPoliciesResponse = (
        aws_sdk_mpa.types.list_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.list_policies_request.ListPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_policies(
    ...
    aws_sdk_mpa.types.list_policies_response.ListPoliciesResponse, zapros.Response
]:
