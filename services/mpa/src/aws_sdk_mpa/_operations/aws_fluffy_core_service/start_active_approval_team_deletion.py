...
def handle_response(
    ...
    out: aws_sdk_mpa.types.start_active_approval_team_deletion_response.StartActiveApprovalTeamDeletionResponse = aws_sdk_mpa.types.start_active_approval_team_deletion_response.deserialize_json(
