...
def handle_response(
    ...
    out: aws_sdk_mpa.types.cancel_session_response.CancelSessionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_mpa.types.cancel_session_request.CancelSessionRequest,
) -> zapros.Request:
    ...
    url = url.replace("{SessionArn}", quote(str(input["session_arn"]), safe=""))
    params: dict[str, str] = {}
...
def cancel_session(
    ...
    aws_sdk_mpa.types.cancel_session_response.CancelSessionResponse, zapros.Response
]:
