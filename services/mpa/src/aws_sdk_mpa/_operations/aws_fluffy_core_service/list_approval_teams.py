"""Generated from Smithy shape ``com.amazonaws.mpa#ListApprovalTeams``."""
...
import aws_sdk_mpa.types.list_approval_teams_response_approval_teams
...
def handle_response(
    ...
    out: aws_sdk_mpa.types.list_approval_teams_response.ListApprovalTeamsResponse = (
        aws_sdk_mpa.types.list_approval_teams_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.list_approval_teams_request.ListApprovalTeamsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/approval-teams/?List"
    params: dict[str, str] = {}
...
async def async_list_approval_teams(
