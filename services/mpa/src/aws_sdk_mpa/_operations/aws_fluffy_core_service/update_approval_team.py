"""Generated from Smithy shape ``com.amazonaws.mpa#UpdateApprovalTeam``."""
...
def handle_response(
    ...
    out: aws_sdk_mpa.types.update_approval_team_response.UpdateApprovalTeamResponse = (
        aws_sdk_mpa.types.update_approval_team_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mpa.types.update_approval_team_request.UpdateApprovalTeamRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/approval-teams/{Arn}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mpa.types.update_approval_team_request.serialize_json(input)
    ).encode()
...
async def async_update_approval_team(
