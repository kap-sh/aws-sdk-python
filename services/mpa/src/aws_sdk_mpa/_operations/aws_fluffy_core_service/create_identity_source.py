...
def build_request(
    ...
    input: aws_sdk_mpa.types.create_identity_source_request.CreateIdentitySourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mpa.types.create_identity_source_request.serialize_json(input)
    ).encode()
