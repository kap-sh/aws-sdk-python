...
def handle_response(
    ...
    out: aws_sdk_mpa.types.get_session_response.GetSessionResponse = (
        aws_sdk_mpa.types.get_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.get_session_request.GetSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_session(
    ...
    input_: aws_sdk_mpa.types.get_session_request.GetSessionRequest,
) -> tuple[aws_sdk_mpa.types.get_session_response.GetSessionResponse, zapros.Response]:
