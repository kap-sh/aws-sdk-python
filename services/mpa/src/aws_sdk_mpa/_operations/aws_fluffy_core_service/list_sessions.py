...
def build_request(
    ...
    input: aws_sdk_mpa.types.list_sessions_request.ListSessionsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ApprovalTeamArn}", quote(str(input["approval_team_arn"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mpa.types.list_sessions_request.serialize_json(input)
    ).encode()
