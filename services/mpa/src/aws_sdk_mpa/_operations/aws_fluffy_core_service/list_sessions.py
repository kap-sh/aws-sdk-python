"""Generated from Smithy shape ``com.amazonaws.mpa#ListSessions``."""
...
import aws_sdk_mpa.types.list_sessions_response_sessions
...
def handle_response(
    ...
    out: aws_sdk_mpa.types.list_sessions_response.ListSessionsResponse = (
        aws_sdk_mpa.types.list_sessions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.list_sessions_request.ListSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/approval-teams/{ApprovalTeamArn}/sessions/?List"
    url = url.replace(
        "{ApprovalTeamArn}", quote(str(input_["approval_team_arn"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mpa.types.list_sessions_request.serialize_json(input_)
    ).encode()
...
def list_sessions(
    ...
    aws_sdk_mpa.types.list_sessions_response.ListSessionsResponse, zapros.Response
]:
