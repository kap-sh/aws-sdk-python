...
def handle_response(
    ...
    out: aws_sdk_mpa.types.get_policy_version_response.GetPolicyVersionResponse = (
        aws_sdk_mpa.types.get_policy_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mpa.types.get_policy_version_request.GetPolicyVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{PolicyVersionArn}", quote(str(input["policy_version_arn"]), safe="")
    )
    params: dict[str, str] = {}
