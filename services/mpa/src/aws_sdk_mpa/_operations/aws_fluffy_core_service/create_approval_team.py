"""Generated from Smithy shape ``com.amazonaws.mpa#CreateApprovalTeam``."""
...
def handle_response(
    ...
    out: aws_sdk_mpa.types.create_approval_team_response.CreateApprovalTeamResponse = (
        aws_sdk_mpa.types.create_approval_team_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.create_approval_team_request.CreateApprovalTeamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/approval-teams"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_mpa.types.create_approval_team_request

    body: bytes | None = json.dumps(
        aws_sdk_mpa.types.create_approval_team_request.serialize_json(input_)
    ).encode()
...
async def async_create_approval_team(
