...
def handle_response(
    ...
    out: aws_sdk_mpa.types.get_approval_team_response.GetApprovalTeamResponse = (
        aws_sdk_mpa.types.get_approval_team_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mpa.types.get_approval_team_request.GetApprovalTeamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
