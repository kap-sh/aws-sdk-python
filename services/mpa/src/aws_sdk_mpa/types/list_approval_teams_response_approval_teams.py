...
ListApprovalTeamsResponseApprovalTeams: TypeAlias = list[
    "aws_sdk_mpa.types.list_approval_teams_response_approval_team.ListApprovalTeamsResponseApprovalTeam"
]
...
def serialize_json(value: ListApprovalTeamsResponseApprovalTeams) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_mpa.types.list_approval_teams_response_approval_team.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> ListApprovalTeamsResponseApprovalTeams:
    ...
    for item in data:
        out.append(
            aws_sdk_mpa.types.list_approval_teams_response_approval_team.deserialize_json(
                item
            )
        )
    return out
