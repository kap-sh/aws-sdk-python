...
if TYPE_CHECKING:
    import aws_sdk_mpa.types.iam_identity_center_for_list


class _IdentitySourceParametersForList_IamIdentityCenter(TypedDict):
    IamIdentityCenter: (
        "aws_sdk_mpa.types.iam_identity_center_for_list.IamIdentityCenterForList"
    )
...
def serialize_json(value: IdentitySourceParametersForList) -> dict:
    if "IamIdentityCenter" in value:
        ...
        return {
            "IamIdentityCenter": aws_sdk_mpa.types.iam_identity_center_for_list.serialize_json(
...
def deserialize_json(data: dict) -> IdentitySourceParametersForList:
    if "IamIdentityCenter" in data:
        ...
        return {
            "IamIdentityCenter": aws_sdk_mpa.types.iam_identity_center_for_list.deserialize_json(
