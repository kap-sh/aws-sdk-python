...
class ListSessionsResponse(TypedDict, closed=True):
    ...
    sessions: NotRequired[
        "aws_sdk_mpa.types.list_sessions_response_sessions.ListSessionsResponseSessions"
    ]
...
def serialize_json(value: ListSessionsResponse) -> dict:
    ...
    if "sessions" in value:
        ...
        out["Sessions"] = (
            aws_sdk_mpa.types.list_sessions_response_sessions.serialize_json(
                value["sessions"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ListSessionsResponse:
    ...
    if "Sessions" in data:
        ...
        out["sessions"] = (
            aws_sdk_mpa.types.list_sessions_response_sessions.deserialize_json(
                data["Sessions"]
            )
        )
    return out
