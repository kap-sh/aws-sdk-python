...
class UpdateApprovalTeamRequest(TypedDict, closed=True):
    ...
    update_actions: NotRequired["aws_sdk_mpa.types.update_actions.UpdateActions"]
...
def serialize_json(value: UpdateApprovalTeamRequest) -> dict:
    ...
    if "approvers" in value:
        ...
        out["Approvers"] = (
            aws_sdk_mpa.types.approval_team_request_approvers.serialize_json(
                value["approvers"]
            )
        )
    ...
    if "update_actions" in value:
        ...
        out["UpdateActions"] = aws_sdk_mpa.types.update_actions.serialize_json(
...
def deserialize_json(data: dict) -> UpdateApprovalTeamRequest:
    ...
    if "UpdateActions" in data:
        ...
        out["update_actions"] = aws_sdk_mpa.types.update_actions.deserialize_json(
            data["UpdateActions"]
        )
    return out
