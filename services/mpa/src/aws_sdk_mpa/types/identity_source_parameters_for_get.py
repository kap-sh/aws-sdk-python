...
if TYPE_CHECKING:
    import aws_sdk_mpa.types.iam_identity_center_for_get


class _IdentitySourceParametersForGet_IamIdentityCenter(TypedDict):
    IamIdentityCenter: (
        "aws_sdk_mpa.types.iam_identity_center_for_get.IamIdentityCenterForGet"
    )
...
def serialize_json(value: IdentitySourceParametersForGet) -> dict:
    if "IamIdentityCenter" in value:
        ...
        return {
            "IamIdentityCenter": aws_sdk_mpa.types.iam_identity_center_for_get.serialize_json(
...
def deserialize_json(data: dict) -> IdentitySourceParametersForGet:
    if "IamIdentityCenter" in data:
        ...
        return {
            "IamIdentityCenter": aws_sdk_mpa.types.iam_identity_center_for_get.deserialize_json(
