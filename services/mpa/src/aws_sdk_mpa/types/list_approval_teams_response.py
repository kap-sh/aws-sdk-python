...
class ListApprovalTeamsResponse(TypedDict):
    ...
    approval_teams: NotRequired[
        "aws_sdk_mpa.types.list_approval_teams_response_approval_teams.ListApprovalTeamsResponseApprovalTeams"
    ]
...
def serialize_json(value: ListApprovalTeamsResponse) -> dict:
    ...
    if "approval_teams" in value:
        ...
        out["ApprovalTeams"] = (
            aws_sdk_mpa.types.list_approval_teams_response_approval_teams.serialize_json(
...
def deserialize_json(data: dict) -> ListApprovalTeamsResponse:
    ...
    if "ApprovalTeams" in data:
        ...
        out["approval_teams"] = (
            aws_sdk_mpa.types.list_approval_teams_response_approval_teams.deserialize_json(
                data["ApprovalTeams"]
            )
        )
    return out
