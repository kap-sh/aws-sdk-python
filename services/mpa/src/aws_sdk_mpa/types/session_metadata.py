...
if TYPE_CHECKING:
    import aws_sdk_mpa.types.session_key
    import aws_sdk_mpa.types.session_value

SessionMetadata: TypeAlias = dict[
    "aws_sdk_mpa.types.session_key.SessionKey",
    "aws_sdk_mpa.types.session_value.SessionValue",
]
