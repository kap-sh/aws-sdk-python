"""Generated from Smithy shape ``com.amazonaws.mpa#IamIdentityCenterForList``."""
...
class IamIdentityCenterForList(TypedDict, closed=True):
    instance_arn: NotRequired["aws_sdk_mpa.types.string.String"]
    """<p>Amazon Resource Name (ARN) for the IAM Identity Center instance.</p>"""
    approval_portal_url: NotRequired["aws_sdk_mpa.types.string.String"]
    """<p>URL for the approval portal associated with the IAM Identity Center instance.</p>"""
    region: NotRequired["aws_sdk_mpa.types.string.String"]
    """<p>Amazon Web Services Region where the IAM Identity Center instance is located.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: IamIdentityCenterForList) -> dict:
    out: dict = {}
