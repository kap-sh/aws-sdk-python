...
class ListResourcePoliciesResponse(TypedDict):
    ...
    resource_policies: NotRequired[
        "aws_sdk_mpa.types.list_resource_policies_response_resource_policies.ListResourcePoliciesResponseResourcePolicies"
    ]
...
def serialize_json(value: ListResourcePoliciesResponse) -> dict:
    ...
    if "resource_policies" in value:
        ...
        out["ResourcePolicies"] = (
            aws_sdk_mpa.types.list_resource_policies_response_resource_policies.serialize_json(
...
def deserialize_json(data: dict) -> ListResourcePoliciesResponse:
    ...
    if "ResourcePolicies" in data:
        ...
        out["resource_policies"] = (
            aws_sdk_mpa.types.list_resource_policies_response_resource_policies.deserialize_json(
