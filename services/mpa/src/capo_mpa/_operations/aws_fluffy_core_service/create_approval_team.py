...
import capo_mpa.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_mpa.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_mpa.types.create_approval_team_response.CreateApprovalTeamResponse = (
        capo_mpa.types.create_approval_team_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mpa.types.create_approval_team_request.serialize_json(input_)
    ).encode()
