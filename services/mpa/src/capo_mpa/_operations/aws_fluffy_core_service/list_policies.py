"""Generated from Smithy shape ``com.amazonaws.mpa#ListPolicies``."""
...
def handle_response(
    ...
    out: capo_mpa.types.list_policies_response.ListPoliciesResponse = (
        capo_mpa.types.list_policies_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/policies/?List"
    params: dict[str, str] = {}
...
def list_policies(
    ...
    input_: capo_mpa.types.list_policies_request.ListPoliciesRequest,
) -> tuple[capo_mpa.types.list_policies_response.ListPoliciesResponse, zapros.Response]:
