"""Generated from Smithy shape ``com.amazonaws.mpa#GetApprovalTeam``."""
...
def handle_response(
    ...
    out: capo_mpa.types.get_approval_team_response.GetApprovalTeamResponse = (
        capo_mpa.types.get_approval_team_response.deserialize_json(
...
def get_approval_team(
    ...
    capo_mpa.types.get_approval_team_response.GetApprovalTeamResponse, zapros.Response
]:
...
async def async_get_approval_team(
