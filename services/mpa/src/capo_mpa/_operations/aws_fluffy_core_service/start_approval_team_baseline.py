...
def handle_response(
    ...
    out: capo_mpa.types.start_approval_team_baseline_response.StartApprovalTeamBaselineResponse = capo_mpa.types.start_approval_team_baseline_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mpa.types.start_approval_team_baseline_request.serialize_json(input_)
    ).encode()
