...
def handle_response(
    ...
    out: capo_mpa.types.create_identity_source_response.CreateIdentitySourceResponse = (
        capo_mpa.types.create_identity_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mpa.types.create_identity_source_request.serialize_json(input_)
    ).encode()
