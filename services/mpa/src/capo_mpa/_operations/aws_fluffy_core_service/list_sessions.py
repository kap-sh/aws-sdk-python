...
def handle_response(
    ...
    out: capo_mpa.types.list_sessions_response.ListSessionsResponse = (
        capo_mpa.types.list_sessions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mpa.types.list_sessions_request.serialize_json(input_)
    ).encode()
...
def list_sessions(
    ...
    input_: capo_mpa.types.list_sessions_request.ListSessionsRequest,
) -> tuple[capo_mpa.types.list_sessions_response.ListSessionsResponse, zapros.Response]:
