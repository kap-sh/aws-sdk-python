"""Generated from Smithy shape ``com.amazonaws.mpa#GetResourcePolicy``."""
...
import capo_mpa.errors.invalid_parameter_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidParameterException":
            raise capo_mpa.errors.invalid_parameter_exception.InvalidParameterException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_mpa.types.get_resource_policy_response.GetResourcePolicyResponse = (
        capo_mpa.types.get_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mpa.types.get_resource_policy_request.serialize_json(input_)
    ).encode()
