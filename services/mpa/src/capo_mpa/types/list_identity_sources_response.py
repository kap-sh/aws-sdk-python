...
if TYPE_CHECKING:
    import capo_mpa.types.identity_sources
    import capo_mpa.types.token


class ListIdentitySourcesResponse(TypedDict, closed=True):
    ...
    identity_sources: NotRequired["capo_mpa.types.identity_sources.IdentitySources"]
...
def serialize_json(value: ListIdentitySourcesResponse) -> dict:
    ...
    if "identity_sources" in value:
        ...
        out["IdentitySources"] = capo_mpa.types.identity_sources.serialize_json(
...
def deserialize_json(data: dict) -> ListIdentitySourcesResponse:
    ...
    if "IdentitySources" in data:
        ...
        out["identity_sources"] = capo_mpa.types.identity_sources.deserialize_json(
