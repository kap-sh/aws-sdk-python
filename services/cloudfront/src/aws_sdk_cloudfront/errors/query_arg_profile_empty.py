...
# --- restXml ser/de ---
def serialize_xml(value: QueryArgProfileEmpty_, parent: Element, tag: str) -> None:
    el = SubElement(parent, tag)
    if "message" in value:
        SubElement(el, "Message").text = str(value["message"])


def deserialize_xml(el: Element) -> QueryArgProfileEmpty_:
    out: QueryArgProfileEmpty_ = {}  # type: ignore[typeddict-item]
...
class QueryArgProfileEmpty(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudfront#QueryArgProfileEmpty``."""
