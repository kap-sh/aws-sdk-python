...
class CloudFrontError(Exception):
    """Base class for all CloudFront service errors."""


class ServiceError(CloudFrontError):
...
class SerializationError(CloudFrontError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudFrontError):
...
class WaiterFailedError(CloudFrontError):
...
class WaiterTimeoutError(CloudFrontError):
