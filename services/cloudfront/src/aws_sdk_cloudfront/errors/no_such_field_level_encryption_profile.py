...
class NoSuchFieldLevelEncryptionProfile_(TypedDict):
...
class NoSuchFieldLevelEncryptionProfile(ServiceError):
    ...
    def __init__(self, data: NoSuchFieldLevelEncryptionProfile_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_xml(cls, el: Element) -> "NoSuchFieldLevelEncryptionProfile":
