...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.update_connection_function_result.UpdateConnectionFunctionResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.update_connection_function_request.UpdateConnectionFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
