"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetCloudFrontOriginAccessIdentity``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_cloud_front_origin_access_identity_result.GetCloudFrontOriginAccessIdentityResult = {
