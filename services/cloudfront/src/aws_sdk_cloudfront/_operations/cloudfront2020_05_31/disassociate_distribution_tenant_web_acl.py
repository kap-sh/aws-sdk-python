"""Generated from Smithy shape ``com.amazonaws.cloudfront#DisassociateDistributionTenantWebACL``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.disassociate_distribution_tenant_web_acl_result.DisassociateDistributionTenantWebACLResult = aws_sdk_cloudfront.types.disassociate_distribution_tenant_web_acl_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.disassociate_distribution_tenant_web_acl_request.DisassociateDistributionTenantWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_distribution_tenant_web_acl(
