"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateResponseHeadersPolicy``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResponseHeadersPolicyAlreadyExists":
            import aws_sdk_cloudfront.errors.response_headers_policy_already_exists

            raise aws_sdk_cloudfront.errors.response_headers_policy_already_exists.ResponseHeadersPolicyAlreadyExists.from_xml(
                root
            )
        case "TooLongCSPInResponseHeadersPolicy":
            import aws_sdk_cloudfront.errors.too_long_csp_in_response_headers_policy

            raise aws_sdk_cloudfront.errors.too_long_csp_in_response_headers_policy.TooLongCSPInResponseHeadersPolicy.from_xml(
                root
            )
        case "TooManyCustomHeadersInResponseHeadersPolicy":
            import aws_sdk_cloudfront.errors.too_many_custom_headers_in_response_headers_policy

            raise aws_sdk_cloudfront.errors.too_many_custom_headers_in_response_headers_policy.TooManyCustomHeadersInResponseHeadersPolicy.from_xml(
                root
            )
        case "TooManyRemoveHeadersInResponseHeadersPolicy":
            import aws_sdk_cloudfront.errors.too_many_remove_headers_in_response_headers_policy

            raise aws_sdk_cloudfront.errors.too_many_remove_headers_in_response_headers_policy.TooManyRemoveHeadersInResponseHeadersPolicy.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.update_response_headers_policy_result.UpdateResponseHeadersPolicyResult = {
        "response_headers_policy": aws_sdk_cloudfront.types.response_headers_policy.deserialize_xml(
