"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListContinuousDeploymentPolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_continuous_deployment_policies_result.ListContinuousDeploymentPoliciesResult = {
        "continuous_deployment_policy_list": aws_sdk_cloudfront.types.continuous_deployment_policy_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_continuous_deployment_policies_request.ListContinuousDeploymentPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_continuous_deployment_policies(
