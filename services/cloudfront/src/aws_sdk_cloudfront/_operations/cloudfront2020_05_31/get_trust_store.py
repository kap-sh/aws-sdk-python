"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetTrustStore``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_trust_store_result.GetTrustStoreResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_trust_store_request.GetTrustStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/trust-store/{Identifier}"
...
def get_trust_store(
    ...
    aws_sdk_cloudfront.types.get_trust_store_result.GetTrustStoreResult, zapros.Response
]:
