"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetDistributionTenant``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_distribution_tenant_result.GetDistributionTenantResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_distribution_tenant_request.GetDistributionTenantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/distribution-tenant/{Identifier}"
...
async def async_get_distribution_tenant(
