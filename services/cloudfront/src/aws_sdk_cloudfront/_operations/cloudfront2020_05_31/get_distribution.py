"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetDistribution``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_distribution_result.GetDistributionResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_distribution_request.GetDistributionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_distribution(
