"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetInvalidation``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchInvalidation":
            import aws_sdk_cloudfront.errors.no_such_invalidation

            raise aws_sdk_cloudfront.errors.no_such_invalidation.NoSuchInvalidation.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_invalidation_result.GetInvalidationResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_invalidation_request.GetInvalidationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_invalidation(
