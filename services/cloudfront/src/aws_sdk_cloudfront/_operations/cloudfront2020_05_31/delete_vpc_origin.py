...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.delete_vpc_origin_result.DeleteVpcOriginResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_vpc_origin_request.DeleteVpcOriginRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
