"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetPublicKey``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_public_key_result.GetPublicKeyResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_public_key_request.GetPublicKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/public-key/{Id}"
...
def get_public_key(
    ...
    aws_sdk_cloudfront.types.get_public_key_result.GetPublicKeyResult, zapros.Response
]:
