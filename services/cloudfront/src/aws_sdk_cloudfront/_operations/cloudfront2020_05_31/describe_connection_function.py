...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.describe_connection_function_result.DescribeConnectionFunctionResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.describe_connection_function_request.DescribeConnectionFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
