"""Generated from Smithy shape ``com.amazonaws.cloudfront#CreateStreamingDistribution``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.create_streaming_distribution_request.CreateStreamingDistributionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_streaming_distribution(
