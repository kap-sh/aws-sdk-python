...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_public_keys_result.ListPublicKeysResult = {
        "public_key_list": aws_sdk_cloudfront.types.public_key_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_public_keys_request.ListPublicKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
