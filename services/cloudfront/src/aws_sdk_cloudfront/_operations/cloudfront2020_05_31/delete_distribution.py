"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteDistribution``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DistributionNotDisabled":
            import aws_sdk_cloudfront.errors.distribution_not_disabled

            raise aws_sdk_cloudfront.errors.distribution_not_disabled.DistributionNotDisabled.from_xml(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_distribution_request.DeleteDistributionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/distribution/{Id}"
...
async def async_delete_distribution(
