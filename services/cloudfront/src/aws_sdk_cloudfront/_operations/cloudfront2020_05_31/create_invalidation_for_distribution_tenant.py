...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.create_invalidation_for_distribution_tenant_result.CreateInvalidationForDistributionTenantResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.create_invalidation_for_distribution_tenant_request.CreateInvalidationForDistributionTenantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
