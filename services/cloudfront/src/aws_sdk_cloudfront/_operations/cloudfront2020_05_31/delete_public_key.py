...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PublicKeyInUse":
            import aws_sdk_cloudfront.errors.public_key_in_use

            raise aws_sdk_cloudfront.errors.public_key_in_use.PublicKeyInUse.from_xml(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_public_key_request.DeletePublicKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
