"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteRealtimeLogConfig``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_realtime_log_config_request.DeleteRealtimeLogConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_realtime_log_config(
