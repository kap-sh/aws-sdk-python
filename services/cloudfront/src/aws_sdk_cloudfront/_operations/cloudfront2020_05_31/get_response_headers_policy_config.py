...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_response_headers_policy_config_result.GetResponseHeadersPolicyConfigResult = {
        "response_headers_policy_config": aws_sdk_cloudfront.types.response_headers_policy_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_response_headers_policy_config_request.GetResponseHeadersPolicyConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
