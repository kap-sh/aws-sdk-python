"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetConnectionGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_connection_group_result.GetConnectionGroupResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_connection_group_request.GetConnectionGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/connection-group/{Identifier}"
...
async def async_get_connection_group(
