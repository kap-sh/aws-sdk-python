"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteResponseHeadersPolicy``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalDelete":
            import aws_sdk_cloudfront.errors.illegal_delete

            raise aws_sdk_cloudfront.errors.illegal_delete.IllegalDelete.from_xml(root)
        ...
        case "ResponseHeadersPolicyInUse":
            import aws_sdk_cloudfront.errors.response_headers_policy_in_use

            raise aws_sdk_cloudfront.errors.response_headers_policy_in_use.ResponseHeadersPolicyInUse.from_xml(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_response_headers_policy_request.DeleteResponseHeadersPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_response_headers_policy(
