"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteDistributionTenant``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_distribution_tenant_request.DeleteDistributionTenantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_distribution_tenant(
