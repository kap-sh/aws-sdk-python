...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.update_cache_policy_result.UpdateCachePolicyResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.update_cache_policy_request.UpdateCachePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
