...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_origin_access_control_config_result.GetOriginAccessControlConfigResult = {
        "origin_access_control_config": aws_sdk_cloudfront.types.origin_access_control_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_origin_access_control_config_request.GetOriginAccessControlConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
