...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_origin_request_policy_result.GetOriginRequestPolicyResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_origin_request_policy_request.GetOriginRequestPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
