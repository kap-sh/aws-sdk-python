"""Generated from Smithy shape ``com.amazonaws.cloudfront#PublishConnectionFunction``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.publish_connection_function_result.PublishConnectionFunctionResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.publish_connection_function_request.PublishConnectionFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/connection-function/{Id}/publish"
...
async def async_publish_connection_function(
