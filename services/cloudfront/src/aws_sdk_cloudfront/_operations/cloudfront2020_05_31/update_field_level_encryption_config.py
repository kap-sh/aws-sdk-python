...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.update_field_level_encryption_config_result.UpdateFieldLevelEncryptionConfigResult = {
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.update_field_level_encryption_config_request.UpdateFieldLevelEncryptionConfigRequest,
) -> zapros.Request:
    ...
    if "field_level_encryption_config" in input:
