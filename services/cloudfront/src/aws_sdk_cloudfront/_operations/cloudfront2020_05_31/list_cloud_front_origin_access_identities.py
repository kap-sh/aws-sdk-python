...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_cloud_front_origin_access_identities_result.ListCloudFrontOriginAccessIdentitiesResult = {
        "cloud_front_origin_access_identity_list": aws_sdk_cloudfront.types.cloud_front_origin_access_identity_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_cloud_front_origin_access_identities_request.ListCloudFrontOriginAccessIdentitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
