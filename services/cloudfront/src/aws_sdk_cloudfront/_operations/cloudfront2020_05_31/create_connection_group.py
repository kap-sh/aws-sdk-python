"""Generated from Smithy shape ``com.amazonaws.cloudfront#CreateConnectionGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.create_connection_group_result.CreateConnectionGroupResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.create_connection_group_request.CreateConnectionGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    root = Element("CreateConnectionGroupRequest")
    if "name" in input_:
...
async def async_create_connection_group(
