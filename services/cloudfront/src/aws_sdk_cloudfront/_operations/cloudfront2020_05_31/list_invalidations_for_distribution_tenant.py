"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListInvalidationsForDistributionTenant``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_invalidations_for_distribution_tenant_result.ListInvalidationsForDistributionTenantResult = {
        "invalidation_list": aws_sdk_cloudfront.types.invalidation_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_invalidations_for_distribution_tenant_request.ListInvalidationsForDistributionTenantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/distribution-tenant/{Id}/invalidation"
...
async def async_list_invalidations_for_distribution_tenant(
