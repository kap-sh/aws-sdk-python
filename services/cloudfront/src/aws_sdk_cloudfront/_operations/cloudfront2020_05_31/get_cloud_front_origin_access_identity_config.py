"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetCloudFrontOriginAccessIdentityConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_cloud_front_origin_access_identity_config_result.GetCloudFrontOriginAccessIdentityConfigResult = {
        "cloud_front_origin_access_identity_config": aws_sdk_cloudfront.types.cloud_front_origin_access_identity_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_cloud_front_origin_access_identity_config_request.GetCloudFrontOriginAccessIdentityConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_cloud_front_origin_access_identity_config(
