"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteFieldLevelEncryptionProfile``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FieldLevelEncryptionProfileInUse":
            import aws_sdk_cloudfront.errors.field_level_encryption_profile_in_use

            raise aws_sdk_cloudfront.errors.field_level_encryption_profile_in_use.FieldLevelEncryptionProfileInUse.from_xml(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_field_level_encryption_profile_request.DeleteFieldLevelEncryptionProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_field_level_encryption_profile(
