...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.get_connection_group_by_routing_endpoint_request.GetConnectionGroupByRoutingEndpointRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "routing_endpoint" in input:
        params["RoutingEndpoint"] = str(input["routing_endpoint"])
