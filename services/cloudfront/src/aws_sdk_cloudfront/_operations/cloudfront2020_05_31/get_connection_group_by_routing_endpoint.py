"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetConnectionGroupByRoutingEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_connection_group_by_routing_endpoint_result.GetConnectionGroupByRoutingEndpointResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_connection_group_by_routing_endpoint_request.GetConnectionGroupByRoutingEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/connection-group"
    params: dict[str, str] = {}
    if "routing_endpoint" in input_:
        params["RoutingEndpoint"] = str(input_["routing_endpoint"])
...
async def async_get_connection_group_by_routing_endpoint(
