"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetCachePolicyConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_cache_policy_config_result.GetCachePolicyConfigResult = {
        "cache_policy_config": aws_sdk_cloudfront.types.cache_policy_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_cache_policy_config_request.GetCachePolicyConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/cache-policy/{Id}/config"
...
async def async_get_cache_policy_config(
