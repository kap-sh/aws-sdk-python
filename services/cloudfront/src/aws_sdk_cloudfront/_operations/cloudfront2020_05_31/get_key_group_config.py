"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetKeyGroupConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_key_group_config_result.GetKeyGroupConfigResult = {
        "key_group_config": aws_sdk_cloudfront.types.key_group_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_key_group_config_request.GetKeyGroupConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/key-group/{Id}/config"
...
async def async_get_key_group_config(
