"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetStreamingDistributionConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_streaming_distribution_config_result.GetStreamingDistributionConfigResult = {
        "streaming_distribution_config": aws_sdk_cloudfront.types.streaming_distribution_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_streaming_distribution_config_request.GetStreamingDistributionConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_streaming_distribution_config(
