"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListDistributionsByResponseHeadersPolicyId``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_distributions_by_response_headers_policy_id_result.ListDistributionsByResponseHeadersPolicyIdResult = {
        "distribution_id_list": aws_sdk_cloudfront.types.distribution_id_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_distributions_by_response_headers_policy_id_request.ListDistributionsByResponseHeadersPolicyIdRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["response_headers_policy_id"]), safe=""),
    )
    params: dict[str, str] = {}
    if "marker" in input_:
...
async def async_list_distributions_by_response_headers_policy_id(
