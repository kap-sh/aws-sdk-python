...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_distributions_by_response_headers_policy_id_request.ListDistributionsByResponseHeadersPolicyIdRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["response_headers_policy_id"]), safe=""),
    )
    params: dict[str, str] = {}
    if "marker" in input:
