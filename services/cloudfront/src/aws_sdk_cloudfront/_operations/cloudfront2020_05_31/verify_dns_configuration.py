...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.verify_dns_configuration_request.VerifyDnsConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "identifier" in input_:
        SubElement(root, "Identifier").text = str(input_["identifier"])
