"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetFunction``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_function_result.GetFunctionResult = {
        "function_code": aws_sdk_cloudfront.types.function_blob.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.get_function_request.GetFunctionRequest,
) -> zapros.Request:
...
def get_function(
    ...
    aws_sdk_cloudfront.types.get_function_result.GetFunctionResult, zapros.Response
]:
