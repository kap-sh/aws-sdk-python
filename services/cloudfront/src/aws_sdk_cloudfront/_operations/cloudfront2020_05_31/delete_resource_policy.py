"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteResourcePolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_resource_policy_request.DeleteResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/delete-resource-policy"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    root = Element("DeleteResourcePolicyRequest")
