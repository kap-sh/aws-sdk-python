...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.create_streaming_distribution_with_tags_result.CreateStreamingDistributionWithTagsResult = {
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.create_streaming_distribution_with_tags_request.CreateStreamingDistributionWithTagsRequest,
) -> zapros.Request:
    ...
    if "streaming_distribution_config_with_tags" in input:
