...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.update_key_group_result.UpdateKeyGroupResult = {
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.update_key_group_request.UpdateKeyGroupRequest,
) -> zapros.Request:
