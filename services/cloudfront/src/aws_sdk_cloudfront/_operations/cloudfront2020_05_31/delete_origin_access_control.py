"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteOriginAccessControl``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OriginAccessControlInUse":
            import aws_sdk_cloudfront.errors.origin_access_control_in_use

            raise aws_sdk_cloudfront.errors.origin_access_control_in_use.OriginAccessControlInUse.from_xml(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_origin_access_control_request.DeleteOriginAccessControlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/origin-access-control/{Id}"
...
async def async_delete_origin_access_control(
