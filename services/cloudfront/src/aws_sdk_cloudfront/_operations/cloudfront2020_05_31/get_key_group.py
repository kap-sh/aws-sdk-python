"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetKeyGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_key_group_result.GetKeyGroupResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_key_group_request.GetKeyGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_key_group(
    ...
    aws_sdk_cloudfront.types.get_key_group_result.GetKeyGroupResult, zapros.Response
]:
