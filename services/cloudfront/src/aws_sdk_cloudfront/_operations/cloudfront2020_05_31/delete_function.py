...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "FunctionInUse":
            import aws_sdk_cloudfront.errors.function_in_use

            raise aws_sdk_cloudfront.errors.function_in_use.FunctionInUse.from_xml(root)
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_function_request.DeleteFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
