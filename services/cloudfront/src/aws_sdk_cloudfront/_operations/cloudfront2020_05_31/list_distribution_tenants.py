...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_distribution_tenants_result.ListDistributionTenantsResult = aws_sdk_cloudfront.types.list_distribution_tenants_result.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_distribution_tenants_request.ListDistributionTenantsRequest,
) -> zapros.Request:
