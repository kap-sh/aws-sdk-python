"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateOriginAccessControl``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchOriginAccessControl":
            import aws_sdk_cloudfront.errors.no_such_origin_access_control

            raise aws_sdk_cloudfront.errors.no_such_origin_access_control.NoSuchOriginAccessControl.from_xml(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.update_origin_access_control_result.UpdateOriginAccessControlResult = {
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.update_origin_access_control_request.UpdateOriginAccessControlRequest,
) -> zapros.Request:
    ...
    if "origin_access_control_config" in input:
        ...
        aws_sdk_cloudfront.types.origin_access_control_config.serialize_xml(
            input["origin_access_control_config"],
            payload_root,
...
async def async_update_origin_access_control(
