"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetDistributionTenantByDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_distribution_tenant_by_domain_result.GetDistributionTenantByDomainResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_distribution_tenant_by_domain_request.GetDistributionTenantByDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_distribution_tenant_by_domain(
