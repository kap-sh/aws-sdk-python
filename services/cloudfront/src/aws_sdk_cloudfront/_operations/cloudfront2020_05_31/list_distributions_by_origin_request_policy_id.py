"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListDistributionsByOriginRequestPolicyId``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_distributions_by_origin_request_policy_id_result.ListDistributionsByOriginRequestPolicyIdResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_distributions_by_origin_request_policy_id_request.ListDistributionsByOriginRequestPolicyIdRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["origin_request_policy_id"]), safe=""),
    )
    params: dict[str, str] = {}
    if "marker" in input_:
...
async def async_list_distributions_by_origin_request_policy_id(
