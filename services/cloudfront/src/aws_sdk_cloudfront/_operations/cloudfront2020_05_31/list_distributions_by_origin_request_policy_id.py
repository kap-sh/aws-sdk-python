...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_distributions_by_origin_request_policy_id_request.ListDistributionsByOriginRequestPolicyIdRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["origin_request_policy_id"]), safe=""),
    )
    params: dict[str, str] = {}
    if "marker" in input:
