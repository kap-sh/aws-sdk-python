...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_managed_certificate_details_result.GetManagedCertificateDetailsResult = {
        "managed_certificate_details": aws_sdk_cloudfront.types.managed_certificate_details.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_managed_certificate_details_request.GetManagedCertificateDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
