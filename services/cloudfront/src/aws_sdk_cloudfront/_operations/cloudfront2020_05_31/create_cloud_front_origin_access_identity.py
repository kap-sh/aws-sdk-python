...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.create_cloud_front_origin_access_identity_request.CreateCloudFrontOriginAccessIdentityRequest,
) -> zapros.Request:
    ...
    if "cloud_front_origin_access_identity_config" in input:
