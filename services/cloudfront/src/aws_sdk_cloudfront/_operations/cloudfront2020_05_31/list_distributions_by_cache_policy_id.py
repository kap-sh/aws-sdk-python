...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_distributions_by_cache_policy_id_result.ListDistributionsByCachePolicyIdResult = {
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_distributions_by_cache_policy_id_request.ListDistributionsByCachePolicyIdRequest,
) -> zapros.Request:
    ...
    url = url.replace("{CachePolicyId}", quote(str(input["cache_policy_id"]), safe=""))
    params: dict[str, str] = {}
    if "marker" in input:
