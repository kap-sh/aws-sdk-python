"""Generated from Smithy shape ``com.amazonaws.cloudfront#DescribeFunction``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.describe_function_result.DescribeFunctionResult = {
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.describe_function_request.DescribeFunctionRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/function/{Name}/describe"
...
async def async_describe_function(
