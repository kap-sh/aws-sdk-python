...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    ...
    if "tag_keys" in input:
        ...
        aws_sdk_cloudfront.types.tag_keys.serialize_xml(
            input["tag_keys"], payload_root, "TagKeys"
        )
