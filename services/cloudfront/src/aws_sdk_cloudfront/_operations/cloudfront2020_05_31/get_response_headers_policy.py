"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetResponseHeadersPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_response_headers_policy_result.GetResponseHeadersPolicyResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_response_headers_policy_request.GetResponseHeadersPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_response_headers_policy(
