"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateTrustStore``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.update_trust_store_result.UpdateTrustStoreResult = {
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.update_trust_store_request.UpdateTrustStoreRequest,
) -> zapros.Request:
    ...
    if "ca_certificates_bundle_source" in input:
        ...
        aws_sdk_cloudfront.types.ca_certificates_bundle_source.serialize_xml(
            input["ca_certificates_bundle_source"],
            payload_root,
