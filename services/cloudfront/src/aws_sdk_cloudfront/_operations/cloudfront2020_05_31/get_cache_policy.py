...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_cache_policy_result.GetCachePolicyResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_cache_policy_request.GetCachePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
