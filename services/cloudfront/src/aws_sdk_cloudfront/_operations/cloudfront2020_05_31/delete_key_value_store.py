"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteKeyValueStore``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_key_value_store_request.DeleteKeyValueStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_key_value_store(
