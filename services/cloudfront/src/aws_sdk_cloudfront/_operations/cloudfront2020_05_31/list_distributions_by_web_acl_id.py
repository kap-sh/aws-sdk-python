...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_distributions_by_web_acl_id_request.ListDistributionsByWebACLIdRequest,
) -> zapros.Request:
    ...
    url = url.replace("{WebACLId}", quote(str(input["web_acl_id"]), safe=""))
    params: dict[str, str] = {}
    if "marker" in input:
