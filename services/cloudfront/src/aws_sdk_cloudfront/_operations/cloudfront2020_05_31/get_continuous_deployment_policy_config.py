...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_continuous_deployment_policy_config_result.GetContinuousDeploymentPolicyConfigResult = {
        "continuous_deployment_policy_config": aws_sdk_cloudfront.types.continuous_deployment_policy_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_continuous_deployment_policy_config_request.GetContinuousDeploymentPolicyConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
