...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_realtime_log_configs_result.ListRealtimeLogConfigsResult = {
        "realtime_log_configs": aws_sdk_cloudfront.types.realtime_log_configs.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_realtime_log_configs_request.ListRealtimeLogConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
