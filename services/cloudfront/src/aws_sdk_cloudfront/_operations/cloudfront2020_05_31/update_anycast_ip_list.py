...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.update_anycast_ip_list_result.UpdateAnycastIpListResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.update_anycast_ip_list_request.UpdateAnycastIpListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
