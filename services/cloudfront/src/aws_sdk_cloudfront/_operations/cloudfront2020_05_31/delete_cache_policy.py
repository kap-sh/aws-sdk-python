"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteCachePolicy``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CachePolicyInUse":
            import aws_sdk_cloudfront.errors.cache_policy_in_use

            raise aws_sdk_cloudfront.errors.cache_policy_in_use.CachePolicyInUse.from_xml(
                root
            )
        case "IllegalDelete":
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_cache_policy_request.DeleteCachePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_cache_policy(
