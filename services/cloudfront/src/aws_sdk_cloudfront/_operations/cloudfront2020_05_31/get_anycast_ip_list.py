"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetAnycastIpList``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_anycast_ip_list_result.GetAnycastIpListResult = {
        "anycast_ip_list": aws_sdk_cloudfront.types.anycast_ip_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_anycast_ip_list_request.GetAnycastIpListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_anycast_ip_list(
