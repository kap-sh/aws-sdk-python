...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_tags_for_resource_result.ListTagsForResourceResult = {
        "tags": aws_sdk_cloudfront.types.tags.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    ...
    if "resource" in input:
        params["Resource"] = str(input["resource"])
