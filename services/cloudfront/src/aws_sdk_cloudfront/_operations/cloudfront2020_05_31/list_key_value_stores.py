"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListKeyValueStores``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_key_value_stores_result.ListKeyValueStoresResult = {
        "key_value_store_list": aws_sdk_cloudfront.types.key_value_store_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_key_value_stores_request.ListKeyValueStoresRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_key_value_stores(
