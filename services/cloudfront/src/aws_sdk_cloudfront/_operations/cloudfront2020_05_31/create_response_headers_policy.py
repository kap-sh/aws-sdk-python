...
import aws_sdk_cloudfront.errors.too_many_response_headers_policies
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyResponseHeadersPolicies":
            raise aws_sdk_cloudfront.errors.too_many_response_headers_policies.TooManyResponseHeadersPolicies.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.create_response_headers_policy_result.CreateResponseHeadersPolicyResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.create_response_headers_policy_request.CreateResponseHeadersPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
