"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetFieldLevelEncryptionConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_field_level_encryption_config_result.GetFieldLevelEncryptionConfigResult = {
        "field_level_encryption_config": aws_sdk_cloudfront.types.field_level_encryption_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_field_level_encryption_config_request.GetFieldLevelEncryptionConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_field_level_encryption_config(
