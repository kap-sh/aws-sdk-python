"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetContinuousDeploymentPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_continuous_deployment_policy_result.GetContinuousDeploymentPolicyResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_continuous_deployment_policy_request.GetContinuousDeploymentPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_continuous_deployment_policy(
