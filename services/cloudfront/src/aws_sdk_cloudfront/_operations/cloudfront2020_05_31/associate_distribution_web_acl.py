...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.associate_distribution_web_acl_result.AssociateDistributionWebACLResult = aws_sdk_cloudfront.types.associate_distribution_web_acl_result.deserialize_xml(
