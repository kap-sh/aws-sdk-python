"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetConnectionFunction``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_connection_function_result.GetConnectionFunctionResult = {
        "connection_function_code": aws_sdk_cloudfront.types.function_blob.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_connection_function_request.GetConnectionFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/connection-function/{Identifier}"
...
async def async_get_connection_function(
