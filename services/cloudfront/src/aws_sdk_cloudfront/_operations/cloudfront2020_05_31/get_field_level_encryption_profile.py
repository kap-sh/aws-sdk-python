"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetFieldLevelEncryptionProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_field_level_encryption_profile_result.GetFieldLevelEncryptionProfileResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_field_level_encryption_profile_request.GetFieldLevelEncryptionProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/field-level-encryption-profile/{Id}"
...
async def async_get_field_level_encryption_profile(
