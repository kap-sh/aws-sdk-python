"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListDistributionsByVpcOriginId``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_distributions_by_vpc_origin_id_result.ListDistributionsByVpcOriginIdResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_distributions_by_vpc_origin_id_request.ListDistributionsByVpcOriginIdRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{VpcOriginId}", quote(str(input_["vpc_origin_id"]), safe=""))
    params: dict[str, str] = {}
    if "marker" in input_:
...
async def async_list_distributions_by_vpc_origin_id(
