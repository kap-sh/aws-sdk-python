...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_distributions_by_vpc_origin_id_request.ListDistributionsByVpcOriginIdRequest,
) -> zapros.Request:
    ...
    url = url.replace("{VpcOriginId}", quote(str(input["vpc_origin_id"]), safe=""))
    params: dict[str, str] = {}
    if "marker" in input:
