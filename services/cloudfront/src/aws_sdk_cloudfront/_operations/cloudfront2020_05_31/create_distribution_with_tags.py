...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.create_distribution_with_tags_result.CreateDistributionWithTagsResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.create_distribution_with_tags_request.CreateDistributionWithTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "distribution_config_with_tags" in input_:
        import aws_sdk_cloudfront.types.distribution_config_with_tags
