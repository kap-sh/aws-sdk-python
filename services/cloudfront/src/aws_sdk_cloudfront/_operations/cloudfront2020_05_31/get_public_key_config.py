"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetPublicKeyConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_public_key_config_result.GetPublicKeyConfigResult = {
        "public_key_config": aws_sdk_cloudfront.types.public_key_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_public_key_config_request.GetPublicKeyConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_public_key_config(
