"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetOriginRequestPolicyConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_origin_request_policy_config_result.GetOriginRequestPolicyConfigResult = {
        "origin_request_policy_config": aws_sdk_cloudfront.types.origin_request_policy_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_origin_request_policy_config_request.GetOriginRequestPolicyConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/origin-request-policy/{Id}/config"
...
async def async_get_origin_request_policy_config(
