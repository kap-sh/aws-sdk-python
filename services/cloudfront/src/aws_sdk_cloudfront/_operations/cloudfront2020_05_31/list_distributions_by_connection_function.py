...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_distributions_by_connection_function_request.ListDistributionsByConnectionFunctionRequest,
) -> zapros.Request:
    ...
    if "connection_function_identifier" in input:
        params["ConnectionFunctionIdentifier"] = str(
            input["connection_function_identifier"]
        )
