"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListDistributionsByTrustStore``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_distributions_by_trust_store_result.ListDistributionsByTrustStoreResult = {
