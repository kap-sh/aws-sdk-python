"""Generated from Smithy shape ``com.amazonaws.cloudfront#CreateMonitoringSubscription``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MonitoringSubscriptionAlreadyExists":
            import aws_sdk_cloudfront.errors.monitoring_subscription_already_exists

            raise aws_sdk_cloudfront.errors.monitoring_subscription_already_exists.MonitoringSubscriptionAlreadyExists.from_xml(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.create_monitoring_subscription_result.CreateMonitoringSubscriptionResult = {
        "monitoring_subscription": aws_sdk_cloudfront.types.monitoring_subscription.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.create_monitoring_subscription_request.CreateMonitoringSubscriptionRequest,
) -> zapros.Request:
    ...
    if "monitoring_subscription" in input:
        import aws_sdk_cloudfront.types.monitoring_subscription

        payload_root = Element("_")
        aws_sdk_cloudfront.types.monitoring_subscription.serialize_xml(
            input["monitoring_subscription"], payload_root, "MonitoringSubscription"
        )
...
async def async_create_monitoring_subscription(
