"""Generated from Smithy shape ``com.amazonaws.cloudfront#CreateAnycastIpList``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.create_anycast_ip_list_result.CreateAnycastIpListResult = {
