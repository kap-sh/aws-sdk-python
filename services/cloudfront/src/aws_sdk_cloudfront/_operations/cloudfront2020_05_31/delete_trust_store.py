"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteTrustStore``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_trust_store_request.DeleteTrustStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
