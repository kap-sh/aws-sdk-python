"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetFieldLevelEncryptionProfileConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_field_level_encryption_profile_config_result.GetFieldLevelEncryptionProfileConfigResult = {
        "field_level_encryption_profile_config": aws_sdk_cloudfront.types.field_level_encryption_profile_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_field_level_encryption_profile_config_request.GetFieldLevelEncryptionProfileConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_field_level_encryption_profile_config(
