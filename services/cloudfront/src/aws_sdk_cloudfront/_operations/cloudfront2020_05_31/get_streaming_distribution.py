...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_streaming_distribution_result.GetStreamingDistributionResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_streaming_distribution_request.GetStreamingDistributionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
