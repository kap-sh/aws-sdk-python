"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListStreamingDistributions``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_streaming_distributions_result.ListStreamingDistributionsResult = {
        "streaming_distribution_list": aws_sdk_cloudfront.types.streaming_distribution_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_streaming_distributions_request.ListStreamingDistributionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_streaming_distributions(
