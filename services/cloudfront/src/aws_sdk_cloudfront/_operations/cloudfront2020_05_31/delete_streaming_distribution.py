"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteStreamingDistribution``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StreamingDistributionNotDisabled":
            import aws_sdk_cloudfront.errors.streaming_distribution_not_disabled

            raise aws_sdk_cloudfront.errors.streaming_distribution_not_disabled.StreamingDistributionNotDisabled.from_xml(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_streaming_distribution_request.DeleteStreamingDistributionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_streaming_distribution(
