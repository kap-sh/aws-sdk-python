"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListVpcOrigins``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_vpc_origins_result.ListVpcOriginsResult = {
        "vpc_origin_list": aws_sdk_cloudfront.types.vpc_origin_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_vpc_origins_request.ListVpcOriginsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_vpc_origins(
