...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_monitoring_subscription_result.GetMonitoringSubscriptionResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_monitoring_subscription_request.GetMonitoringSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
