"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateDistribution``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.update_distribution_result.UpdateDistributionResult = {
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.update_distribution_request.UpdateDistributionRequest,
) -> zapros.Request:
...
async def async_update_distribution(
