"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListKeyGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_key_groups_result.ListKeyGroupsResult = {
        "key_group_list": aws_sdk_cloudfront.types.key_group_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_key_groups_request.ListKeyGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_key_groups(
    ...
    aws_sdk_cloudfront.types.list_key_groups_result.ListKeyGroupsResult, zapros.Response
]:
...
async def async_list_key_groups(
