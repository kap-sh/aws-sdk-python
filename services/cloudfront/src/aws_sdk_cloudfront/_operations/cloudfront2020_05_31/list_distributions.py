"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListDistributions``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_distributions_result.ListDistributionsResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_distributions_request.ListDistributionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_distributions(
