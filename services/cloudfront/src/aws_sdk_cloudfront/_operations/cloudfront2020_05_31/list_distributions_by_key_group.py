...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_distributions_by_key_group_request.ListDistributionsByKeyGroupRequest,
) -> zapros.Request:
    ...
    url = url.replace("{KeyGroupId}", quote(str(input["key_group_id"]), safe=""))
    params: dict[str, str] = {}
    if "marker" in input:
