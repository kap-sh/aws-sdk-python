"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListFieldLevelEncryptionConfigs``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_field_level_encryption_configs_result.ListFieldLevelEncryptionConfigsResult = {
        "field_level_encryption_list": aws_sdk_cloudfront.types.field_level_encryption_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_field_level_encryption_configs_request.ListFieldLevelEncryptionConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_field_level_encryption_configs(
