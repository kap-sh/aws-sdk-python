"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetFieldLevelEncryption``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_field_level_encryption_result.GetFieldLevelEncryptionResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_field_level_encryption_request.GetFieldLevelEncryptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_field_level_encryption(
