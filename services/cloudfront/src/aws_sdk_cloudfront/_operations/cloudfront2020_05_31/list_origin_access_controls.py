"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListOriginAccessControls``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_origin_access_controls_result.ListOriginAccessControlsResult = {
        "origin_access_control_list": aws_sdk_cloudfront.types.origin_access_control_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_origin_access_controls_request.ListOriginAccessControlsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_origin_access_controls(
