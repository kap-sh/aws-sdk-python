...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OriginRequestPolicyInUse":
            import aws_sdk_cloudfront.errors.origin_request_policy_in_use

            raise aws_sdk_cloudfront.errors.origin_request_policy_in_use.OriginRequestPolicyInUse.from_xml(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_origin_request_policy_request.DeleteOriginRequestPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
