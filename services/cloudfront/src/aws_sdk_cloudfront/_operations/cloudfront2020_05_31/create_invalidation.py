"""Generated from Smithy shape ``com.amazonaws.cloudfront#CreateInvalidation``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BatchTooLarge":
            import aws_sdk_cloudfront.errors.batch_too_large

            raise aws_sdk_cloudfront.errors.batch_too_large.BatchTooLarge.from_xml(root)
        ...
        case "NoSuchDistribution":
            import aws_sdk_cloudfront.errors.no_such_distribution

            raise aws_sdk_cloudfront.errors.no_such_distribution.NoSuchDistribution.from_xml(
                root
            )
        case "TooManyInvalidationsInProgress":
            import aws_sdk_cloudfront.errors.too_many_invalidations_in_progress

            raise aws_sdk_cloudfront.errors.too_many_invalidations_in_progress.TooManyInvalidationsInProgress.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.create_invalidation_result.CreateInvalidationResult = {
        "invalidation": aws_sdk_cloudfront.types.invalidation.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.create_invalidation_request.CreateInvalidationRequest,
) -> zapros.Request:
...
async def async_create_invalidation(
