"""Generated from Smithy shape ``com.amazonaws.cloudfront#AssociateDistributionTenantWebACL``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.associate_distribution_tenant_web_acl_result.AssociateDistributionTenantWebACLResult = aws_sdk_cloudfront.types.associate_distribution_tenant_web_acl_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.associate_distribution_tenant_web_acl_request.AssociateDistributionTenantWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    root = Element("AssociateDistributionTenantWebACLRequest")
...
async def async_associate_distribution_tenant_web_acl(
