...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.get_invalidation_for_distribution_tenant_request.GetInvalidationForDistributionTenantRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{DistributionTenantId}", quote(str(input["distribution_tenant_id"]), safe="")
    )
