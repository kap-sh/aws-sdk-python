...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_invalidation_for_distribution_tenant_result.GetInvalidationForDistributionTenantResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_invalidation_for_distribution_tenant_request.GetInvalidationForDistributionTenantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
