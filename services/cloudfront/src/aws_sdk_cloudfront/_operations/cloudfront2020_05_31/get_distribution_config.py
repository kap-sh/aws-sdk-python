...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_distribution_config_result.GetDistributionConfigResult = {
        "distribution_config": aws_sdk_cloudfront.types.distribution_config.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_distribution_config_request.GetDistributionConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
