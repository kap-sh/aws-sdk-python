"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListOriginRequestPolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_origin_request_policies_result.ListOriginRequestPoliciesResult = {
        "origin_request_policy_list": aws_sdk_cloudfront.types.origin_request_policy_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_origin_request_policies_request.ListOriginRequestPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_origin_request_policies(
