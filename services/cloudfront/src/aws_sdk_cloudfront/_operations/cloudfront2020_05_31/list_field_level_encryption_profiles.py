"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListFieldLevelEncryptionProfiles``."""
...
def handle_response(
    ...
    import aws_sdk_cloudfront.types.field_level_encryption_profile_list

    out: aws_sdk_cloudfront.types.list_field_level_encryption_profiles_result.ListFieldLevelEncryptionProfilesResult = {
        "field_level_encryption_profile_list": aws_sdk_cloudfront.types.field_level_encryption_profile_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_field_level_encryption_profiles_request.ListFieldLevelEncryptionProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_field_level_encryption_profiles(
