...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_distributions_by_connection_mode_result.ListDistributionsByConnectionModeResult = {
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_distributions_by_connection_mode_request.ListDistributionsByConnectionModeRequest,
) -> zapros.Request:
    ...
    url = url.replace("{ConnectionMode}", quote(str(input["connection_mode"]), safe=""))
    params: dict[str, str] = {}
    if "marker" in input:
