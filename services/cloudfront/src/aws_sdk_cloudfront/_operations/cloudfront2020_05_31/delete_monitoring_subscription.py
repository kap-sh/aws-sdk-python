"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteMonitoringSubscription``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchMonitoringSubscription":
            import aws_sdk_cloudfront.errors.no_such_monitoring_subscription

            raise aws_sdk_cloudfront.errors.no_such_monitoring_subscription.NoSuchMonitoringSubscription.from_xml(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.delete_monitoring_subscription_result.DeleteMonitoringSubscriptionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_monitoring_subscription_request.DeleteMonitoringSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_monitoring_subscription(
