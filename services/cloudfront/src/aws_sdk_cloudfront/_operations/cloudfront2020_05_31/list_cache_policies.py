"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListCachePolicies``."""
...
def handle_response(
    ...
    import aws_sdk_cloudfront.types.cache_policy_list

    out: aws_sdk_cloudfront.types.list_cache_policies_result.ListCachePoliciesResult = {
        "cache_policy_list": aws_sdk_cloudfront.types.cache_policy_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_cache_policies_request.ListCachePoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_cache_policies(
