...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.update_origin_request_policy_result.UpdateOriginRequestPolicyResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.update_origin_request_policy_request.UpdateOriginRequestPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
