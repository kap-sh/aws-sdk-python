...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    ...
    if "policy_document" in input:
        SubElement(root, "PolicyDocument").text = str(input["policy_document"])
