...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_domain_conflicts_result.ListDomainConflictsResult = aws_sdk_cloudfront.types.list_domain_conflicts_result.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_cloudfront.types.list_domain_conflicts_request.ListDomainConflictsRequest,
) -> zapros.Request:
