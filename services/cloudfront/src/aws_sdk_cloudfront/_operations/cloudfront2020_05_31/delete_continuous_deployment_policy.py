"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteContinuousDeploymentPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.delete_continuous_deployment_policy_request.DeleteContinuousDeploymentPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_continuous_deployment_policy(
