...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.get_origin_access_control_result.GetOriginAccessControlResult = {
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.get_origin_access_control_request.GetOriginAccessControlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
