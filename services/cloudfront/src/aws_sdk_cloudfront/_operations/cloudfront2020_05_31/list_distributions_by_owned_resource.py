...
def handle_response(
    ...
    out: aws_sdk_cloudfront.types.list_distributions_by_owned_resource_result.ListDistributionsByOwnedResourceResult = {
        "distribution_list": aws_sdk_cloudfront.types.distribution_id_owner_list.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront.types.list_distributions_by_owned_resource_request.ListDistributionsByOwnedResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
