"""Generated from Smithy shape ``com.amazonaws.cloudfront#OriginRequestPolicyList``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.origin_request_policy_summary_list
    import aws_sdk_cloudfront.types.string


class OriginRequestPolicyList(TypedDict, closed=True):
    ...
    items: NotRequired[
        "aws_sdk_cloudfront.types.origin_request_policy_summary_list.OriginRequestPolicySummaryList"
    ]
    """<p>Contains the origin request policies in the list.</p>"""


# --- restXml ser/de ---
def serialize_xml(value: OriginRequestPolicyList, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        aws_sdk_cloudfront.types.origin_request_policy_summary_list.serialize_xml(
            value["items"], el, "Items"
        )


def deserialize_xml(el: Element) -> OriginRequestPolicyList:
    out: OriginRequestPolicyList = {}  # type: ignore[typeddict-item]
    ...
    if child_max_items is not None:
        ...
        raise DeserializationError("OriginRequestPolicyList.max_items required")
    child_quantity = el.find("Quantity")
    if child_quantity is not None:
        out["quantity"] = int(child_quantity.text or "")
    else:
        raise DeserializationError("OriginRequestPolicyList.quantity required")
    child_items = el.find("Items")
    if child_items is not None:
        import aws_sdk_cloudfront.types.origin_request_policy_summary_list

        out["items"] = (
            aws_sdk_cloudfront.types.origin_request_policy_summary_list.deserialize_xml(
                child_items
            )
        )
    return out
