...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.public_key_summary_list
    import aws_sdk_cloudfront.types.string


class PublicKeyList(TypedDict):
    ...
    items: NotRequired[
        "aws_sdk_cloudfront.types.public_key_summary_list.PublicKeySummaryList"
    ]
...
def serialize_xml(value: PublicKeyList, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        aws_sdk_cloudfront.types.public_key_summary_list.serialize_xml(
...
def deserialize_xml(el: Element) -> PublicKeyList:
    ...
    if child_items is not None:
        ...
        out["items"] = aws_sdk_cloudfront.types.public_key_summary_list.deserialize_xml(
            child_items
        )
    return out
