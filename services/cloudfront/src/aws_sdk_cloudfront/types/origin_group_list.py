...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.origin_group

OriginGroupList: TypeAlias = list["aws_sdk_cloudfront.types.origin_group.OriginGroup"]
...
def serialize_xml(value: OriginGroupList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.origin_group.serialize_xml(item, el, "OriginGroup")
...
def deserialize_xml(el: Element) -> OriginGroupList:
    ...
    for child in el.findall("OriginGroup"):
        out.append(aws_sdk_cloudfront.types.origin_group.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: OriginGroupList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.origin_group.serialize_xml(item, parent, tag)
