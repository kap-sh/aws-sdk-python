"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteVpcOriginResult``."""
...
class DeleteVpcOriginResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: DeleteVpcOriginResult, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> DeleteVpcOriginResult:
    out: DeleteVpcOriginResult = {}  # type: ignore[typeddict-item]
