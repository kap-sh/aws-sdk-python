...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.cache_tag_config
    import aws_sdk_cloudfront.types.comment_type
    ...
    import aws_sdk_cloudfront.types.logging_config
    ...
    import aws_sdk_cloudfront.types.tenant_config
...
class DistributionConfig(TypedDict):
    ...
    default_root_object: NotRequired["aws_sdk_cloudfront.types.string.string"]
    ...
    cache_behaviors: NotRequired[
        "aws_sdk_cloudfront.types.cache_behaviors.CacheBehaviors"
    ]
    ...
    comment: "aws_sdk_cloudfront.types.comment_type.CommentType"
    """<p>A comment to describe the distribution. The comment cannot be longer than 128 characters.</p>"""
    logging: NotRequired["aws_sdk_cloudfront.types.logging_config.LoggingConfig"]
    ...
    viewer_certificate: NotRequired[
        "aws_sdk_cloudfront.types.viewer_certificate.ViewerCertificate"
    ]
    """<p>A complex type that determines the distribution's SSL/TLS configuration for communicating with viewers.</p>"""
    restrictions: NotRequired["aws_sdk_cloudfront.types.restrictions.Restrictions"]
    """<p>A complex type that identifies ways in which you want to restrict distribution of your content.</p>"""
    web_acl_id: NotRequired["aws_sdk_cloudfront.types.string.string"]
    ...
    http_version: NotRequired["aws_sdk_cloudfront.types.http_version.HttpVersion"]
    ...
    is_ipv6_enabled: NotRequired["aws_sdk_cloudfront.types.boolean.boolean"]
    ...
    continuous_deployment_policy_id: NotRequired[
    ...
    tenant_config: NotRequired["aws_sdk_cloudfront.types.tenant_config.TenantConfig"]
    ...
    cache_tag_config: NotRequired[
        "aws_sdk_cloudfront.types.cache_tag_config.CacheTagConfig"
    ]
...
def serialize_xml(value: DistributionConfig, parent: Element, tag: str) -> None:
    ...
    if "logging" in value:
        ...
        aws_sdk_cloudfront.types.logging_config.serialize_xml(
    ...
    if "tenant_config" in value:
        ...
        aws_sdk_cloudfront.types.tenant_config.serialize_xml(
    ...
    if "cache_tag_config" in value:
        ...
        aws_sdk_cloudfront.types.cache_tag_config.serialize_xml(
...
def deserialize_xml(el: Element) -> DistributionConfig:
    ...
    if child_logging is not None:
        ...
        out["logging"] = aws_sdk_cloudfront.types.logging_config.deserialize_xml(
            child_logging
        )
    ...
    if child_tenant_config is not None:
        ...
        out["tenant_config"] = aws_sdk_cloudfront.types.tenant_config.deserialize_xml(
            child_tenant_config
        )
    ...
    if child_cache_tag_config is not None:
        ...
        out["cache_tag_config"] = (
            aws_sdk_cloudfront.types.cache_tag_config.deserialize_xml(
