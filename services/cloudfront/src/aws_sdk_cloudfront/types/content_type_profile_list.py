...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.content_type_profile

ContentTypeProfileList: TypeAlias = list[
    "aws_sdk_cloudfront.types.content_type_profile.ContentTypeProfile"
]
...
def serialize_xml(value: ContentTypeProfileList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.content_type_profile.serialize_xml(
...
def deserialize_xml(el: Element) -> ContentTypeProfileList:
    ...
    for child in el.findall("ContentTypeProfile"):
        out.append(aws_sdk_cloudfront.types.content_type_profile.deserialize_xml(child))
    return out
...
def serialize_xml_flat(
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.content_type_profile.serialize_xml(item, parent, tag)
