...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.cookie_preference
    import aws_sdk_cloudfront.types.headers
    import aws_sdk_cloudfront.types.query_string_cache_keys


class ForwardedValues(TypedDict):
    query_string: "aws_sdk_cloudfront.types.boolean.boolean"
    ...
    cookies: "aws_sdk_cloudfront.types.cookie_preference.CookiePreference"
    ...
    query_string_cache_keys: NotRequired[
        "aws_sdk_cloudfront.types.query_string_cache_keys.QueryStringCacheKeys"
    ]
...
def serialize_xml(value: ForwardedValues, parent: Element, tag: str) -> None:
    ...
    aws_sdk_cloudfront.types.cookie_preference.serialize_xml(
    ...
    if "query_string_cache_keys" in value:
        ...
        aws_sdk_cloudfront.types.query_string_cache_keys.serialize_xml(
...
def deserialize_xml(el: Element) -> ForwardedValues:
    ...
    if child_cookies is not None:
        ...
        out["cookies"] = aws_sdk_cloudfront.types.cookie_preference.deserialize_xml(
            child_cookies
        )
    else:
    ...
    if child_query_string_cache_keys is not None:
        ...
        out["query_string_cache_keys"] = (
            aws_sdk_cloudfront.types.query_string_cache_keys.deserialize_xml(
