...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.distribution_id_list_summary
    import aws_sdk_cloudfront.types.integer
    import aws_sdk_cloudfront.types.string


class DistributionIdList(TypedDict):
    ...
    items: NotRequired[
        "aws_sdk_cloudfront.types.distribution_id_list_summary.DistributionIdListSummary"
    ]
...
def serialize_xml(value: DistributionIdList, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        aws_sdk_cloudfront.types.distribution_id_list_summary.serialize_xml(
...
def deserialize_xml(el: Element) -> DistributionIdList:
    ...
    if child_items is not None:
        ...
        out["items"] = (
            aws_sdk_cloudfront.types.distribution_id_list_summary.deserialize_xml(
                child_items
            )
        )
    return out
