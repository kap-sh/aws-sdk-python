...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.origin_access_control_summary_list
...
class OriginAccessControlList(TypedDict):
    ...
    items: NotRequired[
        "aws_sdk_cloudfront.types.origin_access_control_summary_list.OriginAccessControlSummaryList"
    ]
...
def serialize_xml(value: OriginAccessControlList, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        aws_sdk_cloudfront.types.origin_access_control_summary_list.serialize_xml(
...
def deserialize_xml(el: Element) -> OriginAccessControlList:
    ...
    if child_items is not None:
        ...
        out["items"] = (
            aws_sdk_cloudfront.types.origin_access_control_summary_list.deserialize_xml(
                child_items
            )
        )
    return out
