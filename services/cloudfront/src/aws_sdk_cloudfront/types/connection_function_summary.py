...
class ConnectionFunctionSummary(TypedDict):
    ...
    connection_function_arn: "aws_sdk_cloudfront.types.string.string"
    ...
    stage: "aws_sdk_cloudfront.types.function_stage.FunctionStage"
...
def serialize_xml(value: ConnectionFunctionSummary, parent: Element, tag: str) -> None:
    ...
    aws_sdk_cloudfront.types.function_stage.serialize_xml(value["stage"], el, "Stage")
    import aws_sdk_cloudfront.types.timestamp
