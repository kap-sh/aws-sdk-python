...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.custom_error_response

CustomErrorResponseList: TypeAlias = list[
    "aws_sdk_cloudfront.types.custom_error_response.CustomErrorResponse"
]
...
def serialize_xml(value: CustomErrorResponseList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.custom_error_response.serialize_xml(
...
def deserialize_xml(el: Element) -> CustomErrorResponseList:
    ...
    for child in el.findall("CustomErrorResponse"):
        out.append(
            aws_sdk_cloudfront.types.custom_error_response.deserialize_xml(child)
        )
    return out
...
def serialize_xml_flat(
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.custom_error_response.serialize_xml(item, parent, tag)
