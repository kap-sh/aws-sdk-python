"""Generated from Smithy shape ``com.amazonaws.cloudfront#DescribeConnectionFunctionResult``."""
...
class DescribeConnectionFunctionResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: DescribeConnectionFunctionResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> DescribeConnectionFunctionResult:
    out: DescribeConnectionFunctionResult = {}  # type: ignore[typeddict-item]
