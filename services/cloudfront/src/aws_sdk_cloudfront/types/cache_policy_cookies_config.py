...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.cache_policy_cookie_behavior
    import aws_sdk_cloudfront.types.cookie_names


class CachePolicyCookiesConfig(TypedDict):
    cookie_behavior: "aws_sdk_cloudfront.types.cache_policy_cookie_behavior.CachePolicyCookieBehavior"
...
def serialize_xml(value: CachePolicyCookiesConfig, parent: Element, tag: str) -> None:
    ...
    aws_sdk_cloudfront.types.cache_policy_cookie_behavior.serialize_xml(
...
def deserialize_xml(el: Element) -> CachePolicyCookiesConfig:
    ...
    if child_cookie_behavior is not None:
        ...
        out["cookie_behavior"] = (
            aws_sdk_cloudfront.types.cache_policy_cookie_behavior.deserialize_xml(
