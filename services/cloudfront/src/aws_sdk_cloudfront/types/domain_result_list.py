...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.domain_result

DomainResultList: TypeAlias = list[
    "aws_sdk_cloudfront.types.domain_result.DomainResult"
]
...
def serialize_xml(value: DomainResultList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.domain_result.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> DomainResultList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_cloudfront.types.domain_result.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: DomainResultList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.domain_result.serialize_xml(item, parent, tag)
