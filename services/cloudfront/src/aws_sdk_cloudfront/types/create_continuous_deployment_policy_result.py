"""Generated from Smithy shape ``com.amazonaws.cloudfront#CreateContinuousDeploymentPolicyResult``."""
...
class CreateContinuousDeploymentPolicyResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: CreateContinuousDeploymentPolicyResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> CreateContinuousDeploymentPolicyResult:
    out: CreateContinuousDeploymentPolicyResult = {}  # type: ignore[typeddict-item]
