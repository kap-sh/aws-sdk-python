...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.parameter_definition

ParameterDefinitions: TypeAlias = list[
    "aws_sdk_cloudfront.types.parameter_definition.ParameterDefinition"
]
...
def serialize_xml(value: ParameterDefinitions, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.parameter_definition.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> ParameterDefinitions:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_cloudfront.types.parameter_definition.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: ParameterDefinitions, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.parameter_definition.serialize_xml(item, parent, tag)
