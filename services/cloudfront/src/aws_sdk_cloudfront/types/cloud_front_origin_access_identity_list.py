...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.cloud_front_origin_access_identity_summary_list
    import aws_sdk_cloudfront.types.integer
    import aws_sdk_cloudfront.types.string


class CloudFrontOriginAccessIdentityList(TypedDict):
    ...
    items: NotRequired[
        "aws_sdk_cloudfront.types.cloud_front_origin_access_identity_summary_list.CloudFrontOriginAccessIdentitySummaryList"
    ]
...
def serialize_xml(
    ...
    if "items" in value:
        ...
        aws_sdk_cloudfront.types.cloud_front_origin_access_identity_summary_list.serialize_xml(
...
def deserialize_xml(el: Element) -> CloudFrontOriginAccessIdentityList:
    ...
    if child_items is not None:
        ...
        out["items"] = (
            aws_sdk_cloudfront.types.cloud_front_origin_access_identity_summary_list.deserialize_xml(
                child_items
            )
        )
    return out
