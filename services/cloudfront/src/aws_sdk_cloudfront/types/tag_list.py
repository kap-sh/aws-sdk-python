...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.tag

TagList: TypeAlias = list["aws_sdk_cloudfront.types.tag.Tag"]
...
def serialize_xml(value: TagList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.tag.serialize_xml(item, el, "Tag")
...
def deserialize_xml(el: Element) -> TagList:
    ...
    for child in el.findall("Tag"):
        out.append(aws_sdk_cloudfront.types.tag.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: TagList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.tag.serialize_xml(item, parent, tag)
