...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.encryption_entity

EncryptionEntityList: TypeAlias = list[
    "aws_sdk_cloudfront.types.encryption_entity.EncryptionEntity"
]
...
def serialize_xml(value: EncryptionEntityList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.encryption_entity.serialize_xml(
...
def deserialize_xml(el: Element) -> EncryptionEntityList:
    ...
    for child in el.findall("EncryptionEntity"):
        out.append(aws_sdk_cloudfront.types.encryption_entity.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: EncryptionEntityList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.encryption_entity.serialize_xml(item, parent, tag)
