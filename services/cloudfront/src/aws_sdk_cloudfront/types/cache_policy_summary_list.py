...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.cache_policy_summary

CachePolicySummaryList: TypeAlias = list[
    "aws_sdk_cloudfront.types.cache_policy_summary.CachePolicySummary"
]
...
def serialize_xml(value: CachePolicySummaryList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.cache_policy_summary.serialize_xml(
...
def deserialize_xml(el: Element) -> CachePolicySummaryList:
    ...
    for child in el.findall("CachePolicySummary"):
        out.append(aws_sdk_cloudfront.types.cache_policy_summary.deserialize_xml(child))
    return out
...
def serialize_xml_flat(
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.cache_policy_summary.serialize_xml(item, parent, tag)
