...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.staging_distribution_dns_names
...
class ContinuousDeploymentPolicyConfig(TypedDict):
    ...
    traffic_config: NotRequired["aws_sdk_cloudfront.types.traffic_config.TrafficConfig"]
...
def serialize_xml(
    ...
    aws_sdk_cloudfront.types.staging_distribution_dns_names.serialize_xml(
    ...
    if "traffic_config" in value:
        ...
        aws_sdk_cloudfront.types.traffic_config.serialize_xml(
...
def deserialize_xml(el: Element) -> ContinuousDeploymentPolicyConfig:
    ...
    if child_staging_distribution_dns_names is not None:
        ...
        out["staging_distribution_dns_names"] = (
            aws_sdk_cloudfront.types.staging_distribution_dns_names.deserialize_xml(
    ...
    if child_traffic_config is not None:
        ...
        out["traffic_config"] = aws_sdk_cloudfront.types.traffic_config.deserialize_xml(
