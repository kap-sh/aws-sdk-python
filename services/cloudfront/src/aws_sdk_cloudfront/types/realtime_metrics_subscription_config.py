...
def serialize_xml(
    ...
    aws_sdk_cloudfront.types.realtime_metrics_subscription_status.serialize_xml(
...
def deserialize_xml(el: Element) -> RealtimeMetricsSubscriptionConfig:
    ...
    if child_realtime_metrics_subscription_status is not None:
        ...
        out["realtime_metrics_subscription_status"] = (
            aws_sdk_cloudfront.types.realtime_metrics_subscription_status.deserialize_xml(
