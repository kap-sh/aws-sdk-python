...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.conflicting_aliases
    import aws_sdk_cloudfront.types.integer
    import aws_sdk_cloudfront.types.string


class ConflictingAliasesList(TypedDict):
    ...
    quantity: NotRequired["aws_sdk_cloudfront.types.integer.integer"]
    """<p>The number of conflicting aliases returned in the response.</p>"""
    items: NotRequired[
        "aws_sdk_cloudfront.types.conflicting_aliases.ConflictingAliases"
    ]
...
def serialize_xml(value: ConflictingAliasesList, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        aws_sdk_cloudfront.types.conflicting_aliases.serialize_xml(
...
def deserialize_xml(el: Element) -> ConflictingAliasesList:
    ...
    if child_items is not None:
        ...
        out["items"] = aws_sdk_cloudfront.types.conflicting_aliases.deserialize_xml(
            child_items
        )
    return out
