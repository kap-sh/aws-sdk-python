...
class TrustStore(TypedDict):
    ...
    status: NotRequired["aws_sdk_cloudfront.types.trust_store_status.TrustStoreStatus"]
    """<p>The trust store's status.</p>"""
    number_of_ca_certificates: NotRequired["aws_sdk_cloudfront.types.integer.integer"]
