...
class CreateDistributionTenantRequest(TypedDict):
    ...
    parameters: NotRequired["aws_sdk_cloudfront.types.parameters.Parameters"]
...
def serialize_xml(
    ...
    aws_sdk_cloudfront.types.domain_list.serialize_xml(value["domains"], el, "Domains")
    if "tags" in value:
        import aws_sdk_cloudfront.types.tags
...
def deserialize_xml(el: Element) -> CreateDistributionTenantRequest:
    ...
    if child_domains is not None:
        ...
        out["domains"] = aws_sdk_cloudfront.types.domain_list.deserialize_xml(
            child_domains
        )
    else:
    ...
    if child_parameters is not None:
        ...
        out["parameters"] = aws_sdk_cloudfront.types.parameters.deserialize_xml(
            child_parameters
        )
    ...
    if child_managed_certificate_request is not None:
        ...
        out["managed_certificate_request"] = (
            aws_sdk_cloudfront.types.managed_certificate_request.deserialize_xml(
