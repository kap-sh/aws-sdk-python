"""Generated from Smithy shape ``com.amazonaws.cloudfront#InvalidationList``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.invalidation_summary_list
    import aws_sdk_cloudfront.types.string


class InvalidationList(TypedDict, closed=True):
    ...
    items: NotRequired[
        "aws_sdk_cloudfront.types.invalidation_summary_list.InvalidationSummaryList"
    ]
...
# --- restXml ser/de ---
def serialize_xml(value: InvalidationList, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        aws_sdk_cloudfront.types.invalidation_summary_list.serialize_xml(
            value["items"], el, "Items"
        )


def deserialize_xml(el: Element) -> InvalidationList:
    out: InvalidationList = {}  # type: ignore[typeddict-item]
    child_marker = el.find("Marker")
    if child_marker is not None:
        out["marker"] = str(child_marker.text or "")
    else:
        raise DeserializationError("InvalidationList.marker required")
    ...
    if child_max_items is not None:
        ...
        raise DeserializationError("InvalidationList.max_items required")
    ...
    if child_is_truncated is not None:
        ...
        raise DeserializationError("InvalidationList.is_truncated required")
    child_quantity = el.find("Quantity")
    if child_quantity is not None:
        out["quantity"] = int(child_quantity.text or "")
    else:
        raise DeserializationError("InvalidationList.quantity required")
    child_items = el.find("Items")
    if child_items is not None:
        import aws_sdk_cloudfront.types.invalidation_summary_list

        out["items"] = (
            aws_sdk_cloudfront.types.invalidation_summary_list.deserialize_xml(
                child_items
            )
        )
    return out
