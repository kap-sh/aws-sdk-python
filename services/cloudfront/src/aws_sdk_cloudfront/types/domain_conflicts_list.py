...
DomainConflictsList: TypeAlias = list[
    "aws_sdk_cloudfront.types.domain_conflict.DomainConflict"
]
...
def serialize_xml(value: DomainConflictsList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.domain_conflict.serialize_xml(
            item, el, "DomainConflicts"
        )
...
def deserialize_xml(el: Element) -> DomainConflictsList:
    ...
    for child in el.findall("DomainConflicts"):
        out.append(aws_sdk_cloudfront.types.domain_conflict.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: DomainConflictsList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.domain_conflict.serialize_xml(item, parent, tag)
