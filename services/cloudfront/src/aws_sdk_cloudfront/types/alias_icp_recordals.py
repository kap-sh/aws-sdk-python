...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.alias_icp_recordal

AliasICPRecordals: TypeAlias = list[
    "aws_sdk_cloudfront.types.alias_icp_recordal.AliasICPRecordal"
]
...
def serialize_xml(value: AliasICPRecordals, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.alias_icp_recordal.serialize_xml(
...
def deserialize_xml(el: Element) -> AliasICPRecordals:
    ...
    for child in el.findall("AliasICPRecordal"):
        out.append(aws_sdk_cloudfront.types.alias_icp_recordal.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: AliasICPRecordals, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.alias_icp_recordal.serialize_xml(item, parent, tag)
