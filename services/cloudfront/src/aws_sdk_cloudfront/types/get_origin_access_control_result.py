"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetOriginAccessControlResult``."""
...
class GetOriginAccessControlResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: GetOriginAccessControlResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> GetOriginAccessControlResult:
    out: GetOriginAccessControlResult = {}  # type: ignore[typeddict-item]
