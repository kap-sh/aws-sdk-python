"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateVpcOriginResult``."""
...
class UpdateVpcOriginResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: UpdateVpcOriginResult, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> UpdateVpcOriginResult:
    out: UpdateVpcOriginResult = {}  # type: ignore[typeddict-item]
