...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.cache_policy_header_behavior
...
def serialize_xml(value: CachePolicyHeadersConfig, parent: Element, tag: str) -> None:
    ...
    aws_sdk_cloudfront.types.cache_policy_header_behavior.serialize_xml(
...
def deserialize_xml(el: Element) -> CachePolicyHeadersConfig:
    ...
    if child_header_behavior is not None:
        ...
        out["header_behavior"] = (
            aws_sdk_cloudfront.types.cache_policy_header_behavior.deserialize_xml(
