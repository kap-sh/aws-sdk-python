"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateOriginRequestPolicyResult``."""
...
class UpdateOriginRequestPolicyResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: UpdateOriginRequestPolicyResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> UpdateOriginRequestPolicyResult:
    out: UpdateOriginRequestPolicyResult = {}  # type: ignore[typeddict-item]
