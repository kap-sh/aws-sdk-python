...
class TrustStoreConfig(TypedDict):
    trust_store_id: "aws_sdk_cloudfront.types.string.string"
    ...
    ignore_certificate_expiry: NotRequired["aws_sdk_cloudfront.types.boolean.boolean"]
