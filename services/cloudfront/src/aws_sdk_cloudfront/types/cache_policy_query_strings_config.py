...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.cache_policy_query_string_behavior
...
# --- restXml ser/de ---
def serialize_xml(
    value: CachePolicyQueryStringsConfig, parent: Element, tag: str
) -> None:
    el = SubElement(parent, tag)
    import aws_sdk_cloudfront.types.cache_policy_query_string_behavior

    aws_sdk_cloudfront.types.cache_policy_query_string_behavior.serialize_xml(
...
def deserialize_xml(el: Element) -> CachePolicyQueryStringsConfig:
    out: CachePolicyQueryStringsConfig = {}  # type: ignore[typeddict-item]
    ...
    if child_query_string_behavior is not None:
        ...
        out["query_string_behavior"] = (
            aws_sdk_cloudfront.types.cache_policy_query_string_behavior.deserialize_xml(
                child_query_string_behavior
            )
        )
    else:
        raise DeserializationError(
            "CachePolicyQueryStringsConfig.query_string_behavior required"
        )
