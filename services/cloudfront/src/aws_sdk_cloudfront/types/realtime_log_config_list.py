...
def serialize_xml(value: RealtimeLogConfigList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.realtime_log_config.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> RealtimeLogConfigList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_cloudfront.types.realtime_log_config.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: RealtimeLogConfigList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.realtime_log_config.serialize_xml(item, parent, tag)
