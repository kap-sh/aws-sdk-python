...
class ListFieldLevelEncryptionProfilesResult(TypedDict):
    field_level_encryption_profile_list: NotRequired[
        "aws_sdk_cloudfront.types.field_level_encryption_profile_list.FieldLevelEncryptionProfileList"
    ]
...
def serialize_xml(
    ...
    if "field_level_encryption_profile_list" in value:
        ...
        aws_sdk_cloudfront.types.field_level_encryption_profile_list.serialize_xml(
...
def deserialize_xml(el: Element) -> ListFieldLevelEncryptionProfilesResult:
    ...
    if child_field_level_encryption_profile_list is not None:
        ...
        out["field_level_encryption_profile_list"] = (
            aws_sdk_cloudfront.types.field_level_encryption_profile_list.deserialize_xml(
