...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.validation_token_detail

ValidationTokenDetailList: TypeAlias = list[
    "aws_sdk_cloudfront.types.validation_token_detail.ValidationTokenDetail"
]
...
def serialize_xml(value: ValidationTokenDetailList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_cloudfront.types.validation_token_detail.serialize_xml(
            item, el, "member"
        )
...
def deserialize_xml(el: Element) -> ValidationTokenDetailList:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_cloudfront.types.validation_token_detail.deserialize_xml(child)
        )
    return out
