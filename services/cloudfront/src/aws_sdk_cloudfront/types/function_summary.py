...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.function_metadata
...
class FunctionSummary(TypedDict):
    ...
    function_metadata: "aws_sdk_cloudfront.types.function_metadata.FunctionMetadata"
...
def serialize_xml(value: FunctionSummary, parent: Element, tag: str) -> None:
    ...
    aws_sdk_cloudfront.types.function_metadata.serialize_xml(
...
def deserialize_xml(el: Element) -> FunctionSummary:
    ...
    if child_function_metadata is not None:
        ...
        out["function_metadata"] = (
            aws_sdk_cloudfront.types.function_metadata.deserialize_xml(
