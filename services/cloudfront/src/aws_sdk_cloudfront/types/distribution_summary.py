...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudfront.types.cache_behaviors
    import aws_sdk_cloudfront.types.connection_function_association
    import aws_sdk_cloudfront.types.connection_mode
    import aws_sdk_cloudfront.types.custom_error_responses
    import aws_sdk_cloudfront.types.default_cache_behavior
    import aws_sdk_cloudfront.types.http_version
    import aws_sdk_cloudfront.types.origin_groups
    import aws_sdk_cloudfront.types.origins
    import aws_sdk_cloudfront.types.price_class
    import aws_sdk_cloudfront.types.restrictions
    import aws_sdk_cloudfront.types.sensitive_string_type
    import aws_sdk_cloudfront.types.string
    import aws_sdk_cloudfront.types.timestamp
    import aws_sdk_cloudfront.types.viewer_certificate
...
class DistributionSummary(TypedDict, closed=True):
    ...
    origins: "aws_sdk_cloudfront.types.origins.Origins"
    """<p>A complex type that contains information about origins for this distribution.</p>"""
    origin_groups: NotRequired["aws_sdk_cloudfront.types.origin_groups.OriginGroups"]
    """<p>A complex type that contains information about origin groups for this distribution.</p>"""
    default_cache_behavior: (
        "aws_sdk_cloudfront.types.default_cache_behavior.DefaultCacheBehavior"
    )
    ...
    cache_behaviors: "aws_sdk_cloudfront.types.cache_behaviors.CacheBehaviors"
    """<p>A complex type that contains zero or more <code>CacheBehavior</code> elements.</p>"""
    custom_error_responses: (
        "aws_sdk_cloudfront.types.custom_error_responses.CustomErrorResponses"
    )
    ...
    restrictions: "aws_sdk_cloudfront.types.restrictions.Restrictions"
    ...
    http_version: "aws_sdk_cloudfront.types.http_version.HttpVersion"
    ...
    is_ipv6_enabled: "aws_sdk_cloudfront.types.boolean.boolean"
    ...
    connection_mode: NotRequired[
        "aws_sdk_cloudfront.types.connection_mode.ConnectionMode"
    ]
    ...
    viewer_mtls_config: NotRequired[
        "aws_sdk_cloudfront.types.viewer_mtls_config.ViewerMtlsConfig"
    ]
    """<p>The distribution's viewer mTLS configuration.</p>"""
    connection_function_association: NotRequired[
        "aws_sdk_cloudfront.types.connection_function_association.ConnectionFunctionAssociation"
    ]
...
def serialize_xml(value: DistributionSummary, parent: Element, tag: str) -> None:
    ...
    aws_sdk_cloudfront.types.origins.serialize_xml(value["origins"], el, "Origins")
    if "origin_groups" in value:
        import aws_sdk_cloudfront.types.origin_groups

        aws_sdk_cloudfront.types.origin_groups.serialize_xml(
            value["origin_groups"], el, "OriginGroups"
        )
    import aws_sdk_cloudfront.types.default_cache_behavior

    aws_sdk_cloudfront.types.default_cache_behavior.serialize_xml(
        value["default_cache_behavior"], el, "DefaultCacheBehavior"
    )
    import aws_sdk_cloudfront.types.cache_behaviors

    aws_sdk_cloudfront.types.cache_behaviors.serialize_xml(
        value["cache_behaviors"], el, "CacheBehaviors"
    )
    import aws_sdk_cloudfront.types.custom_error_responses

    aws_sdk_cloudfront.types.custom_error_responses.serialize_xml(
    ...
    aws_sdk_cloudfront.types.viewer_certificate.serialize_xml(
        value["viewer_certificate"], el, "ViewerCertificate"
    )
    import aws_sdk_cloudfront.types.restrictions

    aws_sdk_cloudfront.types.restrictions.serialize_xml(
        value["restrictions"], el, "Restrictions"
    )
    SubElement(el, "WebACLId").text = str(value["web_acl_id"])
    import aws_sdk_cloudfront.types.http_version

    aws_sdk_cloudfront.types.http_version.serialize_xml(
    ...
    if "connection_mode" in value:
        ...
        aws_sdk_cloudfront.types.connection_mode.serialize_xml(
    ...
    if "viewer_mtls_config" in value:
        ...
        aws_sdk_cloudfront.types.viewer_mtls_config.serialize_xml(
            value["viewer_mtls_config"], el, "ViewerMtlsConfig"
        )
    if "connection_function_association" in value:
        import aws_sdk_cloudfront.types.connection_function_association

        aws_sdk_cloudfront.types.connection_function_association.serialize_xml(
...
def deserialize_xml(el: Element) -> DistributionSummary:
    ...
    if child_origins is not None:
        ...
        out["origins"] = aws_sdk_cloudfront.types.origins.deserialize_xml(child_origins)
    else:
    ...
    if child_origin_groups is not None:
        ...
        out["origin_groups"] = aws_sdk_cloudfront.types.origin_groups.deserialize_xml(
            child_origin_groups
        )
    ...
    if child_default_cache_behavior is not None:
        ...
        out["default_cache_behavior"] = (
            aws_sdk_cloudfront.types.default_cache_behavior.deserialize_xml(
    ...
    if child_cache_behaviors is not None:
        ...
        out["cache_behaviors"] = (
            aws_sdk_cloudfront.types.cache_behaviors.deserialize_xml(
    ...
    if child_custom_error_responses is not None:
        ...
        out["custom_error_responses"] = (
            aws_sdk_cloudfront.types.custom_error_responses.deserialize_xml(
    ...
    if child_viewer_certificate is not None:
        ...
        out["viewer_certificate"] = (
            aws_sdk_cloudfront.types.viewer_certificate.deserialize_xml(
    ...
    if child_restrictions is not None:
        ...
        out["restrictions"] = aws_sdk_cloudfront.types.restrictions.deserialize_xml(
            child_restrictions
        )
    else:
    ...
    if child_http_version is not None:
        ...
        out["http_version"] = aws_sdk_cloudfront.types.http_version.deserialize_xml(
            child_http_version
        )
    else:
    ...
    if child_connection_mode is not None:
        ...
        out["connection_mode"] = (
            aws_sdk_cloudfront.types.connection_mode.deserialize_xml(
    ...
    if child_viewer_mtls_config is not None:
        ...
        out["viewer_mtls_config"] = (
            aws_sdk_cloudfront.types.viewer_mtls_config.deserialize_xml(
    ...
    if child_connection_function_association is not None:
        ...
        out["connection_function_association"] = (
            aws_sdk_cloudfront.types.connection_function_association.deserialize_xml(
