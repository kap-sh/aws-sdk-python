...
if TYPE_CHECKING:
    import aws_sdk_cloudfront.types.access_control_allow_methods_list
    import aws_sdk_cloudfront.types.integer


class ResponseHeadersPolicyAccessControlAllowMethods(TypedDict):
    quantity: "aws_sdk_cloudfront.types.integer.integer"
    """<p>The number of HTTP methods in the list.</p>"""
    items: "aws_sdk_cloudfront.types.access_control_allow_methods_list.AccessControlAllowMethodsList"
...
def serialize_xml(
    ...
    aws_sdk_cloudfront.types.access_control_allow_methods_list.serialize_xml(
...
def deserialize_xml(el: Element) -> ResponseHeadersPolicyAccessControlAllowMethods:
    ...
    if child_items is not None:
        ...
        out["items"] = (
            aws_sdk_cloudfront.types.access_control_allow_methods_list.deserialize_xml(
                child_items
            )
        )
    else:
