"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListDistributionsByCachePolicyIdRequest``."""
...
class ListDistributionsByCachePolicyIdRequest(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: ListDistributionsByCachePolicyIdRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> ListDistributionsByCachePolicyIdRequest:
    out: ListDistributionsByCachePolicyIdRequest = {}  # type: ignore[typeddict-item]
    return out
