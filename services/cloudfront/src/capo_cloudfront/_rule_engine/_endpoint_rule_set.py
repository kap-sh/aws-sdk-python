...
def resolve(p: EndpointParams) -> Endpoint:  # type: ignore
    ...
    if p.Region is not None:
        ...
        if _locals["PartitionResult"] is not None:
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is True:
                        return Endpoint(
                            url=interpolate(
                                "https://cloudfront.global.api.aws", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is True:
                    if p.UseDualStack is True:
                        return Endpoint(
                            url=interpolate(
                                "https://cloudfront-fips.global.api.aws", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if p.UseFIPS is True:
                if p.UseDualStack is False:
                    if (
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://cloudfront-fips.{PartitionResult#dnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={
            ...
            if p.UseFIPS is False:
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://cloudfront.{PartitionResult#dualStackDnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={
            ...
            return Endpoint(
                url=interpolate(
                    "https://cloudfront.{PartitionResult#dnsSuffix}", p, _locals
                ),
                properties={
                    "authSchemes": [
                        {
