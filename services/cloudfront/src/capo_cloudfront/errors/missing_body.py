...
class MissingBody_(TypedDict, closed=True):
...
class MissingBody(ServiceError):
    ...
    def __init__(self, data: MissingBody_, message: str | None = None):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_xml(cls, el: Element, message: str | None = None) -> "MissingBody":
