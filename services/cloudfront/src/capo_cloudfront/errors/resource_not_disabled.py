...
class ResourceNotDisabled_(TypedDict, closed=True):
...
class ResourceNotDisabled(ServiceError):
    ...
    def __init__(self, data: ResourceNotDisabled_, message: str | None = None):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_xml(cls, el: Element, message: str | None = None) -> "ResourceNotDisabled":
