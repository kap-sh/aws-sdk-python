...
if TYPE_CHECKING:
    import capo_cloudfront.types.dns_configuration

DnsConfigurationList: TypeAlias = list[
    "capo_cloudfront.types.dns_configuration.DnsConfiguration"
]
...
def serialize_xml(value: DnsConfigurationList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_cloudfront.types.dns_configuration.serialize_xml(
...
def deserialize_xml(el: Element) -> DnsConfigurationList:
    ...
    for child in el.findall("DnsConfiguration"):
        out.append(capo_cloudfront.types.dns_configuration.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: DnsConfigurationList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_cloudfront.types.dns_configuration.serialize_xml(item, parent, tag)
