...
if TYPE_CHECKING:
    import capo_cloudfront.types.function_association

FunctionAssociationList: TypeAlias = list[
    "capo_cloudfront.types.function_association.FunctionAssociation"
]
...
def serialize_xml(value: FunctionAssociationList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_cloudfront.types.function_association.serialize_xml(
...
def deserialize_xml(el: Element) -> FunctionAssociationList:
    ...
    for child in el.findall("FunctionAssociation"):
        out.append(capo_cloudfront.types.function_association.deserialize_xml(child))
    return out
...
def serialize_xml_flat(
    ...
    for item in value:
        ...
        capo_cloudfront.types.function_association.serialize_xml(item, parent, tag)
