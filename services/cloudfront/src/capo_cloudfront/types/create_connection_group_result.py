"""Generated from Smithy shape ``com.amazonaws.cloudfront#CreateConnectionGroupResult``."""
...
class CreateConnectionGroupResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: CreateConnectionGroupResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> CreateConnectionGroupResult:
    out: CreateConnectionGroupResult = {}  # type: ignore[typeddict-item]
