"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateTrustStoreResult``."""
...
class UpdateTrustStoreResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: UpdateTrustStoreResult, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> UpdateTrustStoreResult:
    out: UpdateTrustStoreResult = {}  # type: ignore[typeddict-item]
