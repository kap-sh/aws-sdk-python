...
if TYPE_CHECKING:
    import capo_cloudfront.types.icp_recordal_status
    import capo_cloudfront.types.string


class AliasICPRecordal(TypedDict, closed=True):
    cname: NotRequired["capo_cloudfront.types.string.string"]
    """<p>A domain name associated with a distribution.</p>"""
    icp_recordal_status: NotRequired[
        "capo_cloudfront.types.icp_recordal_status.ICPRecordalStatus"
    ]
...
def serialize_xml(value: AliasICPRecordal, parent: Element, tag: str) -> None:
    ...
    if "icp_recordal_status" in value:
        ...
        capo_cloudfront.types.icp_recordal_status.serialize_xml(
...
def deserialize_xml(el: Element) -> AliasICPRecordal:
    ...
    if child_icp_recordal_status is not None:
        ...
        out["icp_recordal_status"] = (
            capo_cloudfront.types.icp_recordal_status.deserialize_xml(
