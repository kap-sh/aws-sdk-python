"""Generated from Smithy shape ``com.amazonaws.cloudfront#PublishFunctionResult``."""
...
class PublishFunctionResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: PublishFunctionResult, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> PublishFunctionResult:
    out: PublishFunctionResult = {}  # type: ignore[typeddict-item]
