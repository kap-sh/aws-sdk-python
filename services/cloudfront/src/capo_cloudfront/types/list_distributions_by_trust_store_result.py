"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListDistributionsByTrustStoreResult``."""
...
class ListDistributionsByTrustStoreResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: ListDistributionsByTrustStoreResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> ListDistributionsByTrustStoreResult:
    out: ListDistributionsByTrustStoreResult = {}  # type: ignore[typeddict-item]
