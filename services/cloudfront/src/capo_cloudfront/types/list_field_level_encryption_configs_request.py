"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListFieldLevelEncryptionConfigsRequest``."""
...
class ListFieldLevelEncryptionConfigsRequest(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: ListFieldLevelEncryptionConfigsRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> ListFieldLevelEncryptionConfigsRequest:
    out: ListFieldLevelEncryptionConfigsRequest = {}  # type: ignore[typeddict-item]
    return out
