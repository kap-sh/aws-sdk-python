"""Generated from Smithy shape ``com.amazonaws.cloudfront#CreateStreamingDistributionWithTagsResult``."""
...
class CreateStreamingDistributionWithTagsResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: CreateStreamingDistributionWithTagsResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> CreateStreamingDistributionWithTagsResult:
    out: CreateStreamingDistributionWithTagsResult = {}  # type: ignore[typeddict-item]
