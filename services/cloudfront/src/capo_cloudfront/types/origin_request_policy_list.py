...
if TYPE_CHECKING:
    ...
    import capo_cloudfront.types.origin_request_policy_summary_list
...
class OriginRequestPolicyList(TypedDict, closed=True):
    ...
    items: NotRequired[
        "capo_cloudfront.types.origin_request_policy_summary_list.OriginRequestPolicySummaryList"
    ]
...
def serialize_xml(value: OriginRequestPolicyList, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        capo_cloudfront.types.origin_request_policy_summary_list.serialize_xml(
...
def deserialize_xml(el: Element) -> OriginRequestPolicyList:
    ...
    if child_items is not None:
        ...
        out["items"] = (
            capo_cloudfront.types.origin_request_policy_summary_list.deserialize_xml(
                child_items
            )
        )
    return out
