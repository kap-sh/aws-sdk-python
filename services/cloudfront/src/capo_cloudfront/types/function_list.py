...
if TYPE_CHECKING:
    import capo_cloudfront.types.function_summary_list
...
class FunctionList(TypedDict, closed=True):
    ...
    items: NotRequired[
        "capo_cloudfront.types.function_summary_list.FunctionSummaryList"
    ]
...
def serialize_xml(value: FunctionList, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        capo_cloudfront.types.function_summary_list.serialize_xml(
...
def deserialize_xml(el: Element) -> FunctionList:
    ...
    if child_items is not None:
        ...
        out["items"] = capo_cloudfront.types.function_summary_list.deserialize_xml(
            child_items
        )
    return out
