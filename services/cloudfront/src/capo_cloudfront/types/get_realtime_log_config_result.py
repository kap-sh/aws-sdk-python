"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetRealtimeLogConfigResult``."""
...
class GetRealtimeLogConfigResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: GetRealtimeLogConfigResult, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> GetRealtimeLogConfigResult:
    out: GetRealtimeLogConfigResult = {}  # type: ignore[typeddict-item]
