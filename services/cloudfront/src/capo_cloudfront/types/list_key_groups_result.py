...
class ListKeyGroupsResult(TypedDict, closed=True):
    key_group_list: NotRequired["capo_cloudfront.types.key_group_list.KeyGroupList"]
...
def serialize_xml(value: ListKeyGroupsResult, parent: Element, tag: str) -> None:
    ...
    if "key_group_list" in value:
        ...
        capo_cloudfront.types.key_group_list.serialize_xml(
...
def deserialize_xml(el: Element) -> ListKeyGroupsResult:
    ...
    if child_key_group_list is not None:
        ...
        out["key_group_list"] = capo_cloudfront.types.key_group_list.deserialize_xml(
