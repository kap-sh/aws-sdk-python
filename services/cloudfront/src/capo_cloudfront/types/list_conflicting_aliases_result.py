...
class ListConflictingAliasesResult(TypedDict, closed=True):
    conflicting_aliases_list: NotRequired[
        "capo_cloudfront.types.conflicting_aliases_list.ConflictingAliasesList"
    ]
...
def serialize_xml(
    ...
    if "conflicting_aliases_list" in value:
        ...
        capo_cloudfront.types.conflicting_aliases_list.serialize_xml(
...
def deserialize_xml(el: Element) -> ListConflictingAliasesResult:
    ...
    if child_conflicting_aliases_list is not None:
        ...
        out["conflicting_aliases_list"] = (
            capo_cloudfront.types.conflicting_aliases_list.deserialize_xml(
