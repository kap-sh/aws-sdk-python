...
if TYPE_CHECKING:
    import capo_cloudfront.types.method

MethodsList: TypeAlias = list["capo_cloudfront.types.method.Method"]
...
def serialize_xml(value: MethodsList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_cloudfront.types.method.serialize_xml(item, el, "Method")
...
def deserialize_xml(el: Element) -> MethodsList:
    ...
    for child in el.findall("Method"):
        out.append(capo_cloudfront.types.method.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: MethodsList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_cloudfront.types.method.serialize_xml(item, parent, tag)
