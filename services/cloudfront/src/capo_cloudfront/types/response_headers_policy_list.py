...
if TYPE_CHECKING:
    ...
    import capo_cloudfront.types.response_headers_policy_summary_list
...
class ResponseHeadersPolicyList(TypedDict, closed=True):
    ...
    items: NotRequired[
        "capo_cloudfront.types.response_headers_policy_summary_list.ResponseHeadersPolicySummaryList"
    ]
...
def serialize_xml(value: ResponseHeadersPolicyList, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        capo_cloudfront.types.response_headers_policy_summary_list.serialize_xml(
...
def deserialize_xml(el: Element) -> ResponseHeadersPolicyList:
    ...
    if child_items is not None:
        ...
        out["items"] = (
            capo_cloudfront.types.response_headers_policy_summary_list.deserialize_xml(
                child_items
            )
        )
    return out
