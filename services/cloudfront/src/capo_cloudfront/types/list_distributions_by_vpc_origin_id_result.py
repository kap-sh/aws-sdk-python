"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListDistributionsByVpcOriginIdResult``."""
...
class ListDistributionsByVpcOriginIdResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: ListDistributionsByVpcOriginIdResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> ListDistributionsByVpcOriginIdResult:
    out: ListDistributionsByVpcOriginIdResult = {}  # type: ignore[typeddict-item]
