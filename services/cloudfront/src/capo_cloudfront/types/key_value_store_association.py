...
if TYPE_CHECKING:
    import capo_cloudfront.types.key_value_store_arn


class KeyValueStoreAssociation(TypedDict, closed=True):
    key_value_store_arn: "capo_cloudfront.types.key_value_store_arn.KeyValueStoreARN"
