...
if TYPE_CHECKING:
    ...
    import capo_cloudfront.types.trusted_key_group_id_list
...
class TrustedKeyGroups(TypedDict, closed=True):
    ...
    items: NotRequired[
        "capo_cloudfront.types.trusted_key_group_id_list.TrustedKeyGroupIdList"
    ]
...
def serialize_xml(value: TrustedKeyGroups, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        capo_cloudfront.types.trusted_key_group_id_list.serialize_xml(
...
def deserialize_xml(el: Element) -> TrustedKeyGroups:
    ...
    if child_items is not None:
        ...
        out["items"] = capo_cloudfront.types.trusted_key_group_id_list.deserialize_xml(
            child_items
        )
    return out
