...
if TYPE_CHECKING:
    ...
    import capo_cloudfront.types.key_value_store_summary_list
...
class KeyValueStoreList(TypedDict, closed=True):
    ...
    items: NotRequired[
        "capo_cloudfront.types.key_value_store_summary_list.KeyValueStoreSummaryList"
    ]
...
def serialize_xml(value: KeyValueStoreList, parent: Element, tag: str) -> None:
    ...
    if "items" in value:
        ...
        capo_cloudfront.types.key_value_store_summary_list.serialize_xml(
...
def deserialize_xml(el: Element) -> KeyValueStoreList:
    ...
    if child_items is not None:
        ...
        out["items"] = (
            capo_cloudfront.types.key_value_store_summary_list.deserialize_xml(
                child_items
            )
        )
    return out
