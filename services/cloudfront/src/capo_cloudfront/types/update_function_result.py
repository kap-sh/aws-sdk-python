"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateFunctionResult``."""
...
class UpdateFunctionResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: UpdateFunctionResult, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> UpdateFunctionResult:
    out: UpdateFunctionResult = {}  # type: ignore[typeddict-item]
