...
class ListConnectionFunctionsResult(TypedDict, closed=True):
    ...
    connection_functions: NotRequired[
        "capo_cloudfront.types.connection_function_summary_list.ConnectionFunctionSummaryList"
    ]
...
def serialize_xml(
    ...
    if "connection_functions" in value:
        ...
        capo_cloudfront.types.connection_function_summary_list.serialize_xml(
...
def deserialize_xml(el: Element) -> ListConnectionFunctionsResult:
    ...
    if child_connection_functions is not None:
        ...
        out["connection_functions"] = (
            capo_cloudfront.types.connection_function_summary_list.deserialize_xml(
