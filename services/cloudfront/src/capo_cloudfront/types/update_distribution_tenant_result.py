"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateDistributionTenantResult``."""
...
class UpdateDistributionTenantResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: UpdateDistributionTenantResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> UpdateDistributionTenantResult:
    out: UpdateDistributionTenantResult = {}  # type: ignore[typeddict-item]
