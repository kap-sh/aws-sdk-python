"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetContinuousDeploymentPolicyResult``."""
...
class GetContinuousDeploymentPolicyResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: GetContinuousDeploymentPolicyResult, parent: Element, tag: str
) -> None:
...
def deserialize_xml(el: Element) -> GetContinuousDeploymentPolicyResult:
    out: GetContinuousDeploymentPolicyResult = {}  # type: ignore[typeddict-item]
