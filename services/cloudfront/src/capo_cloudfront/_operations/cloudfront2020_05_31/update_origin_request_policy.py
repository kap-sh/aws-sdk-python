"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateOriginRequestPolicy``."""
...
def handle_response(
    ...
    out: capo_cloudfront.types.update_origin_request_policy_result.UpdateOriginRequestPolicyResult = {
...
async def async_update_origin_request_policy(
