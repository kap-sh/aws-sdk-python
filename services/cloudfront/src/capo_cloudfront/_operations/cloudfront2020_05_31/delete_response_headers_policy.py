...
import capo_cloudfront.errors.response_headers_policy_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResponseHeadersPolicyInUse":
            raise capo_cloudfront.errors.response_headers_policy_in_use.ResponseHeadersPolicyInUse.from_xml(
                error_el, message
            )
        case _:
