"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetDistributionConfig``."""
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_distribution_config_result.GetDistributionConfigResult = {
        "distribution_config": capo_cloudfront.types.distribution_config.deserialize_xml(
...
async def async_get_distribution_config(
