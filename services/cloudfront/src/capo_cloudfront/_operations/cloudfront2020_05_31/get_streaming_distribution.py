"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetStreamingDistribution``."""
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_streaming_distribution_result.GetStreamingDistributionResult = {
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/streaming-distribution/{Id}"
...
async def async_get_streaming_distribution(
