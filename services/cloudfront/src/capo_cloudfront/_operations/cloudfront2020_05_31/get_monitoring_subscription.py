"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetMonitoringSubscription``."""
...
import capo_cloudfront.errors.no_such_monitoring_subscription
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchMonitoringSubscription":
            raise capo_cloudfront.errors.no_such_monitoring_subscription.NoSuchMonitoringSubscription.from_xml(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_monitoring_subscription_result.GetMonitoringSubscriptionResult = {
        "monitoring_subscription": capo_cloudfront.types.monitoring_subscription.deserialize_xml(
...
async def async_get_monitoring_subscription(
