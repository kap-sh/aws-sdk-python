...
STATUS_CODE_TO_CODE = {404: "NoSuchFunctionExists", 412: "PreconditionFailed"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.publish_function_result.PublishFunctionResult = {
...
def publish_function(
    ...
    capo_cloudfront.types.publish_function_result.PublishFunctionResult, zapros.Response
]:
