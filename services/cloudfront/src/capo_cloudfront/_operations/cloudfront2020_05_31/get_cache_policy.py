"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetCachePolicy``."""
...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "NoSuchCachePolicy"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_cache_policy_result.GetCachePolicyResult = {
...
def get_cache_policy(
    ...
    capo_cloudfront.types.get_cache_policy_result.GetCachePolicyResult, zapros.Response
]:
...
async def async_get_cache_policy(
