"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetOriginAccessControlConfig``."""
...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "NoSuchOriginAccessControl"}
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchOriginAccessControl":
            raise capo_cloudfront.errors.no_such_origin_access_control.NoSuchOriginAccessControl.from_xml(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_origin_access_control_config_result.GetOriginAccessControlConfigResult = {
        "origin_access_control_config": capo_cloudfront.types.origin_access_control_config.deserialize_xml(
...
async def async_get_origin_access_control_config(
