"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteFunction``."""
...
import capo_cloudfront.errors.function_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "FunctionInUse":
            raise capo_cloudfront.errors.function_in_use.FunctionInUse.from_xml(root)
