"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListPublicKeys``."""
...
import capo_cloudfront.types.public_key_list
...
def handle_response(
    ...
    out: capo_cloudfront.types.list_public_keys_result.ListPublicKeysResult = {
        "public_key_list": capo_cloudfront.types.public_key_list.deserialize_xml(
...
def list_public_keys(
    ...
    capo_cloudfront.types.list_public_keys_result.ListPublicKeysResult, zapros.Response
]:
