...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "NoSuchDistribution"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_distribution_result.GetDistributionResult = {
...
def get_distribution(
    ...
    capo_cloudfront.types.get_distribution_result.GetDistributionResult, zapros.Response
]:
