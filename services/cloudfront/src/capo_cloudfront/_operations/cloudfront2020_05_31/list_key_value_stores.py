...
def handle_response(
    ...
    out: capo_cloudfront.types.list_key_value_stores_result.ListKeyValueStoresResult = {
        "key_value_store_list": capo_cloudfront.types.key_value_store_list.deserialize_xml(
