...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "NoSuchStreamingDistribution"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_streaming_distribution_config_result.GetStreamingDistributionConfigResult = {
        "streaming_distribution_config": capo_cloudfront.types.streaming_distribution_config.deserialize_xml(
