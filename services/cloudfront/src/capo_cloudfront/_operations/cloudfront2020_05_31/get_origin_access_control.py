"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetOriginAccessControl``."""
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_origin_access_control_result.GetOriginAccessControlResult = {
...
async def async_get_origin_access_control(
