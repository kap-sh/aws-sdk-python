"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeletePublicKey``."""
...
import capo_cloudfront.errors.public_key_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PublicKeyInUse":
            raise capo_cloudfront.errors.public_key_in_use.PublicKeyInUse.from_xml(root)
        case _:
