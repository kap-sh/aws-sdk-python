"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateCachePolicy``."""
...
def handle_response(
    ...
    out: capo_cloudfront.types.update_cache_policy_result.UpdateCachePolicyResult = {
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/cache-policy/{Id}"
...
async def async_update_cache_policy(
