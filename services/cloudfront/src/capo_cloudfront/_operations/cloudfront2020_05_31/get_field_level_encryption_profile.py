...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "NoSuchFieldLevelEncryptionProfile"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_field_level_encryption_profile_result.GetFieldLevelEncryptionProfileResult = {
