"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetManagedCertificateDetails``."""
...
import capo_cloudfront.types.managed_certificate_details
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_managed_certificate_details_result.GetManagedCertificateDetailsResult = {
        "managed_certificate_details": capo_cloudfront.types.managed_certificate_details.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/managed-certificate/{Identifier}"
...
async def async_get_managed_certificate_details(
