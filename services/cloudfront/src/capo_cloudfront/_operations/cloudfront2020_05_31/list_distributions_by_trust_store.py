...
def handle_response(
    ...
    out: capo_cloudfront.types.list_distributions_by_trust_store_result.ListDistributionsByTrustStoreResult = {
...
def build_request(
    ...
    if "trust_store_identifier" in input_:
        params.append(("TrustStoreIdentifier", input_["trust_store_identifier"]))
    if "marker" in input_:
