...
def handle_response(
    ...
    out: capo_cloudfront.types.list_functions_result.ListFunctionsResult = {
        "function_list": capo_cloudfront.types.function_list.deserialize_xml(
...
def list_functions(
    ...
    capo_cloudfront.types.list_functions_result.ListFunctionsResult, zapros.Response
]:
