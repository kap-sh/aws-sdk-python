...
def handle_response(
    ...
    out: capo_cloudfront.types.get_field_level_encryption_profile_config_result.GetFieldLevelEncryptionProfileConfigResult = {
        "field_level_encryption_profile_config": capo_cloudfront.types.field_level_encryption_profile_config.deserialize_xml(
