...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "NoSuchCloudFrontOriginAccessIdentity"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_cloud_front_origin_access_identity_config_result.GetCloudFrontOriginAccessIdentityConfigResult = {
        "cloud_front_origin_access_identity_config": capo_cloudfront.types.cloud_front_origin_access_identity_config.deserialize_xml(
