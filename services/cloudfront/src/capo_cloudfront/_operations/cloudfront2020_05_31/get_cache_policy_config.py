...
def handle_response(
    ...
    out: capo_cloudfront.types.get_cache_policy_config_result.GetCachePolicyConfigResult = {
        "cache_policy_config": capo_cloudfront.types.cache_policy_config.deserialize_xml(
