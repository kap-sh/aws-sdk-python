...
def handle_response(
    ...
    out: capo_cloudfront.types.list_distributions_by_response_headers_policy_id_result.ListDistributionsByResponseHeadersPolicyIdResult = {
        "distribution_id_list": capo_cloudfront.types.distribution_id_list.deserialize_xml(
