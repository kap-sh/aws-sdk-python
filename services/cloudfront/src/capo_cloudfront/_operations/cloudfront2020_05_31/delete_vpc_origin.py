"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteVpcOrigin``."""
...
import capo_cloudfront.errors.cannot_delete_entity_while_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CannotDeleteEntityWhileInUse":
            raise capo_cloudfront.errors.cannot_delete_entity_while_in_use.CannotDeleteEntityWhileInUse.from_xml(
                root
            )
        case "EntityNotFound":
            raise capo_cloudfront.errors.entity_not_found.EntityNotFound.from_xml(root)
        case "IllegalDelete":
            raise capo_cloudfront.errors.illegal_delete.IllegalDelete.from_xml(root)
...
def handle_response(
    ...
    out: capo_cloudfront.types.delete_vpc_origin_result.DeleteVpcOriginResult = {
        "vpc_origin": capo_cloudfront.types.vpc_origin.deserialize_xml(
...
async def async_delete_vpc_origin(
