"""Generated from Smithy shape ``com.amazonaws.cloudfront#CreateInvalidationForDistributionTenant``."""
...
import capo_cloudfront.errors.batch_too_large
...
import capo_cloudfront.errors.too_many_invalidations_in_progress
...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "EntityNotFound", 413: "BatchTooLarge"}
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BatchTooLarge":
            raise capo_cloudfront.errors.batch_too_large.BatchTooLarge.from_xml(
                error_el, message
            )
        case "EntityNotFound":
        ...
        case "TooManyInvalidationsInProgress":
            raise capo_cloudfront.errors.too_many_invalidations_in_progress.TooManyInvalidationsInProgress.from_xml(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_cloudfront.types.create_invalidation_for_distribution_tenant_result.CreateInvalidationForDistributionTenantResult = {
        "invalidation": capo_cloudfront.types.invalidation.deserialize_xml(
...
async def async_create_invalidation_for_distribution_tenant(
