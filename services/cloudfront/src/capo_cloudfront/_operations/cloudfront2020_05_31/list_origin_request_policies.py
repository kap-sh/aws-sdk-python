...
def handle_response(
    ...
    out: capo_cloudfront.types.list_origin_request_policies_result.ListOriginRequestPoliciesResult = {
        "origin_request_policy_list": capo_cloudfront.types.origin_request_policy_list.deserialize_xml(
...
def build_request(
    ...
    if "type" in input_:
        params.append(
            (
                "Type",
                capo_cloudfront.types.origin_request_policy_type.to_xml_text(
                    input_["type"]
                ),
            )
        )
