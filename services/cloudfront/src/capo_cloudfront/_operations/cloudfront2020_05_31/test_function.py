"""Generated from Smithy shape ``com.amazonaws.cloudfront#TestFunction``."""
...
STATUS_CODE_TO_CODE = {404: "NoSuchFunctionExists", 500: "TestFunctionFailed"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.test_function_result.TestFunctionResult = {
        "test_result": capo_cloudfront.types.test_result.deserialize_xml(
...
def test_function(
    ...
    capo_cloudfront.types.test_function_result.TestFunctionResult, zapros.Response
]:
