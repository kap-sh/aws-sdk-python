...
def handle_response(
    ...
    out: capo_cloudfront.types.list_vpc_origins_result.ListVpcOriginsResult = {
        "vpc_origin_list": capo_cloudfront.types.vpc_origin_list.deserialize_xml(
...
def list_vpc_origins(
    ...
    capo_cloudfront.types.list_vpc_origins_result.ListVpcOriginsResult, zapros.Response
]:
