"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetInvalidationForDistributionTenant``."""
...
import capo_cloudfront.errors.no_such_invalidation
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchInvalidation":
            raise capo_cloudfront.errors.no_such_invalidation.NoSuchInvalidation.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_invalidation_for_distribution_tenant_result.GetInvalidationForDistributionTenantResult = {
...
def build_request(
    ...
    url = url.replace(
        "{DistributionTenantId}", quote(str(input_["distribution_tenant_id"]), safe="")
    )
...
async def async_get_invalidation_for_distribution_tenant(
