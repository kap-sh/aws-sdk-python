...
def handle_response(
    ...
    out: capo_cloudfront.types.list_connection_groups_result.ListConnectionGroupsResult = capo_cloudfront.types.list_connection_groups_result.deserialize_xml(
