...
def handle_response(
    ...
    out: capo_cloudfront.types.list_streaming_distributions_result.ListStreamingDistributionsResult = {
        "streaming_distribution_list": capo_cloudfront.types.streaming_distribution_list.deserialize_xml(
