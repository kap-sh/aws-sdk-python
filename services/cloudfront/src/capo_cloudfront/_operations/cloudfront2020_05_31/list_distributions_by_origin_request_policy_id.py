...
def handle_response(
    ...
    out: capo_cloudfront.types.list_distributions_by_origin_request_policy_id_result.ListDistributionsByOriginRequestPolicyIdResult = {
...
def build_request(
    ...
    url = url.replace(
        "{OriginRequestPolicyId}", quote(input_["origin_request_policy_id"], safe="")
    )
