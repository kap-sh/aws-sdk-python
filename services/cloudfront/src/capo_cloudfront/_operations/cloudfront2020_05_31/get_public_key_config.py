...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "NoSuchPublicKey"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_public_key_config_result.GetPublicKeyConfigResult = {
        "public_key_config": capo_cloudfront.types.public_key_config.deserialize_xml(
