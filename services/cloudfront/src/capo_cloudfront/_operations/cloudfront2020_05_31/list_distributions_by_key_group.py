...
STATUS_CODE_TO_CODE = {400: "InvalidArgument", 404: "NoSuchResource"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.list_distributions_by_key_group_result.ListDistributionsByKeyGroupResult = {
...
def build_request(
    ...
    url = url.replace("{KeyGroupId}", quote(input_["key_group_id"], safe=""))
