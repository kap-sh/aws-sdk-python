...
def handle_response(
    ...
    out: capo_cloudfront.types.list_continuous_deployment_policies_result.ListContinuousDeploymentPoliciesResult = {
        "continuous_deployment_policy_list": capo_cloudfront.types.continuous_deployment_policy_list.deserialize_xml(
