...
import capo_cloudfront.types.key_group_list
...
def handle_response(
    ...
    out: capo_cloudfront.types.list_key_groups_result.ListKeyGroupsResult = {
        "key_group_list": capo_cloudfront.types.key_group_list.deserialize_xml(
...
def list_key_groups(
    ...
    capo_cloudfront.types.list_key_groups_result.ListKeyGroupsResult, zapros.Response
]:
