...
def handle_response(
    ...
    out: capo_cloudfront.types.list_distribution_tenants_by_customization_result.ListDistributionTenantsByCustomizationResult = capo_cloudfront.types.list_distribution_tenants_by_customization_result.deserialize_xml(
...
def build_request(
    ...
    if "certificate_arn" in input_:
        SubElement(root, "CertificateArn").text = str(input_["certificate_arn"])
    if "marker" in input_:
