...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "NoSuchOriginRequestPolicy"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_origin_request_policy_config_result.GetOriginRequestPolicyConfigResult = {
        "origin_request_policy_config": capo_cloudfront.types.origin_request_policy_config.deserialize_xml(
