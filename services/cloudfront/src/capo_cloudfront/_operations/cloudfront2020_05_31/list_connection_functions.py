...
import capo_cloudfront.types.connection_function_summary_list
...
STATUS_CODE_TO_CODE = {403: "AccessDenied"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.list_connection_functions_result.ListConnectionFunctionsResult = capo_cloudfront.types.list_connection_functions_result.deserialize_xml(
