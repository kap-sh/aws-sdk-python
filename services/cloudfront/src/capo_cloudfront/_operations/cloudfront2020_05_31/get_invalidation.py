...
def handle_response(
    ...
    out: capo_cloudfront.types.get_invalidation_result.GetInvalidationResult = {
...
def get_invalidation(
    ...
    capo_cloudfront.types.get_invalidation_result.GetInvalidationResult, zapros.Response
]:
