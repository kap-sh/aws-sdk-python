...
def handle_response(
    ...
    out: capo_cloudfront.types.associate_distribution_tenant_web_acl_result.AssociateDistributionTenantWebACLResult = capo_cloudfront.types.associate_distribution_tenant_web_acl_result.deserialize_xml(
