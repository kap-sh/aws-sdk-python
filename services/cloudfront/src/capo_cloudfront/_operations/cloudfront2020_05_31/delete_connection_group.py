"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteConnectionGroup``."""
...
import capo_cloudfront.errors.resource_not_disabled
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotDisabled":
            raise capo_cloudfront.errors.resource_not_disabled.ResourceNotDisabled.from_xml(
                error_el, message
            )
        case _:
...
async def async_delete_connection_group(
