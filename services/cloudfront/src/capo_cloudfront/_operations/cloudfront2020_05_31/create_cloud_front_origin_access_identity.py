...
import capo_cloudfront.errors.cloud_front_origin_access_identity_already_exists
...
import capo_cloudfront.errors.too_many_cloud_front_origin_access_identities
...
STATUS_CODE_TO_CODE = {409: "CloudFrontOriginAccessIdentityAlreadyExists"}
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CloudFrontOriginAccessIdentityAlreadyExists":
            raise capo_cloudfront.errors.cloud_front_origin_access_identity_already_exists.CloudFrontOriginAccessIdentityAlreadyExists.from_xml(
                error_el, message
            )
        ...
        case "TooManyCloudFrontOriginAccessIdentities":
            raise capo_cloudfront.errors.too_many_cloud_front_origin_access_identities.TooManyCloudFrontOriginAccessIdentities.from_xml(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_cloudfront.types.create_cloud_front_origin_access_identity_result.CreateCloudFrontOriginAccessIdentityResult = {
