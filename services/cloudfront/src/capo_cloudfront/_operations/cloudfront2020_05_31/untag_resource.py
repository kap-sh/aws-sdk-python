"""Generated from Smithy shape ``com.amazonaws.cloudfront#UntagResource``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/tagging?Operation=Untag"
    params: dict[str, str] = {}
    ...
    if "tag_keys" in input_:
        ...
        capo_cloudfront.types.tag_keys.serialize_xml(
            input_["tag_keys"], payload_root, "TagKeys"
        )
