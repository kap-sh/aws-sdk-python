...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "NoSuchFieldLevelEncryptionConfig"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_field_level_encryption_config_result.GetFieldLevelEncryptionConfigResult = {
        "field_level_encryption_config": capo_cloudfront.types.field_level_encryption_config.deserialize_xml(
