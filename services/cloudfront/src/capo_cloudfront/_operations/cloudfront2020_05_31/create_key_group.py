...
import capo_cloudfront.errors.too_many_key_groups
...
STATUS_CODE_TO_CODE = {409: "KeyGroupAlreadyExists"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.create_key_group_result.CreateKeyGroupResult = {
...
def create_key_group(
    ...
    capo_cloudfront.types.create_key_group_result.CreateKeyGroupResult, zapros.Response
]:
