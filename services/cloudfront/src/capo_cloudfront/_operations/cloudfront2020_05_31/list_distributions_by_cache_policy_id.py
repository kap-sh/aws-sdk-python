"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListDistributionsByCachePolicyId``."""
...
def handle_response(
    ...
    out: capo_cloudfront.types.list_distributions_by_cache_policy_id_result.ListDistributionsByCachePolicyIdResult = {
...
def build_request(
    ...
    url = url.replace("{CachePolicyId}", quote(str(input_["cache_policy_id"]), safe=""))
    params: dict[str, str] = {}
    if "marker" in input_:
...
async def async_list_distributions_by_cache_policy_id(
