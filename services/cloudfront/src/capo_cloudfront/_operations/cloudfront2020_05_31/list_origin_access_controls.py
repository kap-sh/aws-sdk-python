...
def handle_response(
    ...
    out: capo_cloudfront.types.list_origin_access_controls_result.ListOriginAccessControlsResult = {
        "origin_access_control_list": capo_cloudfront.types.origin_access_control_list.deserialize_xml(
