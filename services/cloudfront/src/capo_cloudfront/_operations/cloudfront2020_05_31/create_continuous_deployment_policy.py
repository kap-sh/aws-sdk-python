...
import capo_cloudfront.errors.continuous_deployment_policy_already_exists
import capo_cloudfront.errors.inconsistent_quantities
import capo_cloudfront.errors.invalid_argument
import capo_cloudfront.errors.staging_distribution_in_use
import capo_cloudfront.errors.too_many_continuous_deployment_policies
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ContinuousDeploymentPolicyAlreadyExists":
            raise capo_cloudfront.errors.continuous_deployment_policy_already_exists.ContinuousDeploymentPolicyAlreadyExists.from_xml(
                error_el, message
            )
        ...
        case "TooManyContinuousDeploymentPolicies":
            raise capo_cloudfront.errors.too_many_continuous_deployment_policies.TooManyContinuousDeploymentPolicies.from_xml(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_cloudfront.types.create_continuous_deployment_policy_result.CreateContinuousDeploymentPolicyResult = {
        "continuous_deployment_policy": capo_cloudfront.types.continuous_deployment_policy.deserialize_xml(
