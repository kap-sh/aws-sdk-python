"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateVpcOrigin``."""
...
import capo_cloudfront.errors.cannot_update_entity_while_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CannotUpdateEntityWhileInUse":
            raise capo_cloudfront.errors.cannot_update_entity_while_in_use.CannotUpdateEntityWhileInUse.from_xml(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_cloudfront.types.update_vpc_origin_result.UpdateVpcOriginResult = {
...
def build_request(
    ...
    capo_cloudfront.types.vpc_origin_endpoint_config.serialize_xml(
        input_["vpc_origin_endpoint_config"], payload_root, "VpcOriginEndpointConfig"
    )
