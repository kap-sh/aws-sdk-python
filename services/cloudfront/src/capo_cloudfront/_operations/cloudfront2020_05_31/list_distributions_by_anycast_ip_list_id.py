...
def handle_response(
    ...
    out: capo_cloudfront.types.list_distributions_by_anycast_ip_list_id_result.ListDistributionsByAnycastIpListIdResult = {
...
def build_request(
    ...
    url = url.replace("{AnycastIpListId}", quote(input_["anycast_ip_list_id"], safe=""))
