...
import capo_cloudfront.types.field_level_encryption_list
...
def handle_response(
    ...
    out: capo_cloudfront.types.list_field_level_encryption_configs_result.ListFieldLevelEncryptionConfigsResult = {
        "field_level_encryption_list": capo_cloudfront.types.field_level_encryption_list.deserialize_xml(
