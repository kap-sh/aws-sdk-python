...
def handle_response(
    ...
    out: capo_cloudfront.types.get_connection_group_by_routing_endpoint_result.GetConnectionGroupByRoutingEndpointResult = {
...
def build_request(
    ...
    if "routing_endpoint" in input_:
        params.append(("RoutingEndpoint", input_["routing_endpoint"]))
