"""Generated from Smithy shape ``com.amazonaws.cloudfront#UpdateKeyValueStore``."""
...
def handle_response(
    ...
    out: capo_cloudfront.types.update_key_value_store_result.UpdateKeyValueStoreResult = {
...
def build_request(
    ...
    root = Element("UpdateKeyValueStoreRequest")
...
async def async_update_key_value_store(
