...
def handle_response(
    ...
    out: capo_cloudfront.types.list_anycast_ip_lists_result.ListAnycastIpListsResult = {
        "anycast_ip_lists": capo_cloudfront.types.anycast_ip_list_collection.deserialize_xml(
