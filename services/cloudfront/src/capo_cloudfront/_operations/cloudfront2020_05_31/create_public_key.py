...
import capo_cloudfront.errors.public_key_already_exists
import capo_cloudfront.errors.too_many_public_keys
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PublicKeyAlreadyExists":
            raise capo_cloudfront.errors.public_key_already_exists.PublicKeyAlreadyExists.from_xml(
                root
            )
        case "TooManyPublicKeys":
            raise capo_cloudfront.errors.too_many_public_keys.TooManyPublicKeys.from_xml(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_cloudfront.types.create_public_key_result.CreatePublicKeyResult = {
