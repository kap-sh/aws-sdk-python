"""Generated from Smithy shape ``com.amazonaws.cloudfront#TagResource``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2020-05-31/tagging?Operation=Tag"
    params: dict[str, str] = {}
    ...
    if "tags" in input_:
        ...
        capo_cloudfront.types.tags.serialize_xml(input_["tags"], payload_root, "Tags")
