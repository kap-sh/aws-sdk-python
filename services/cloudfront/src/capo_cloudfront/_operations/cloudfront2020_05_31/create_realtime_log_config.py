...
import capo_cloudfront.errors.realtime_log_config_already_exists
import capo_cloudfront.errors.too_many_realtime_log_configs
...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 409: "RealtimeLogConfigAlreadyExists"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.create_realtime_log_config_result.CreateRealtimeLogConfigResult = capo_cloudfront.types.create_realtime_log_config_result.deserialize_xml(
