...
import capo_cloudfront.errors.monitoring_subscription_already_exists
...
def handle_response(
    ...
    out: capo_cloudfront.types.create_monitoring_subscription_result.CreateMonitoringSubscriptionResult = {
