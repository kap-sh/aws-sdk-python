"""Generated from Smithy shape ``com.amazonaws.cloudfront#GetContinuousDeploymentPolicyConfig``."""
...
STATUS_CODE_TO_CODE = {403: "AccessDenied", 404: "NoSuchContinuousDeploymentPolicy"}
...
def handle_response(
    ...
    out: capo_cloudfront.types.get_continuous_deployment_policy_config_result.GetContinuousDeploymentPolicyConfigResult = {
        "continuous_deployment_policy_config": capo_cloudfront.types.continuous_deployment_policy_config.deserialize_xml(
...
async def async_get_continuous_deployment_policy_config(
