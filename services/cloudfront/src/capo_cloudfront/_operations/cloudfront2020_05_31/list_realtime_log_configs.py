"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListRealtimeLogConfigs``."""
...
def handle_response(
    ...
    out: capo_cloudfront.types.list_realtime_log_configs_result.ListRealtimeLogConfigsResult = {
        "realtime_log_configs": capo_cloudfront.types.realtime_log_configs.deserialize_xml(
...
async def async_list_realtime_log_configs(
