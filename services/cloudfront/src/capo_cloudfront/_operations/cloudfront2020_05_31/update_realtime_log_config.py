...
def handle_response(
    ...
    out: capo_cloudfront.types.update_realtime_log_config_result.UpdateRealtimeLogConfigResult = capo_cloudfront.types.update_realtime_log_config_result.deserialize_xml(
