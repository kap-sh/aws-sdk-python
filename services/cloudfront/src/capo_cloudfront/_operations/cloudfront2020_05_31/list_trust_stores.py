"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListTrustStores``."""
...
def handle_response(
    ...
    out: capo_cloudfront.types.list_trust_stores_result.ListTrustStoresResult = (
        capo_cloudfront.types.list_trust_stores_result.deserialize_xml(
