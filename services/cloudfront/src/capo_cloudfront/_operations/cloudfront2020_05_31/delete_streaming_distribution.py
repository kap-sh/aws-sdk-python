...
import capo_cloudfront.errors.streaming_distribution_not_disabled
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StreamingDistributionNotDisabled":
            raise capo_cloudfront.errors.streaming_distribution_not_disabled.StreamingDistributionNotDisabled.from_xml(
                error_el, message
            )
        case _:
