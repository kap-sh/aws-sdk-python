...
def handle_response(
    ...
    out: capo_cloudfront.types.list_field_level_encryption_profiles_result.ListFieldLevelEncryptionProfilesResult = {
        "field_level_encryption_profile_list": capo_cloudfront.types.field_level_encryption_profile_list.deserialize_xml(
