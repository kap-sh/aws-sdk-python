"""Generated from Smithy shape ``com.amazonaws.cloudfront#ListInvalidations``."""
...
def handle_response(
    ...
    out: capo_cloudfront.types.list_invalidations_result.ListInvalidationsResult = {
        "invalidation_list": capo_cloudfront.types.invalidation_list.deserialize_xml(
