...
def handle_response(
    ...
    out: capo_cloudfront.types.disassociate_distribution_tenant_web_acl_result.DisassociateDistributionTenantWebACLResult = capo_cloudfront.types.disassociate_distribution_tenant_web_acl_result.deserialize_xml(
