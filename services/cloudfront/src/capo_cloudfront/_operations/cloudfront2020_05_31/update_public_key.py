...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CannotChangeImmutablePublicKeyFields":
            raise capo_cloudfront.errors.cannot_change_immutable_public_key_fields.CannotChangeImmutablePublicKeyFields.from_xml(
                error_el, message
            )
        case "IllegalUpdate":
...
def handle_response(
    ...
    out: capo_cloudfront.types.update_public_key_result.UpdatePublicKeyResult = {
        "public_key": capo_cloudfront.types.public_key.deserialize_xml(
