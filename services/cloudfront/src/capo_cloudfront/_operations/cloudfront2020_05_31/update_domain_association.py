...
def handle_response(
    ...
    out: capo_cloudfront.types.update_domain_association_result.UpdateDomainAssociationResult = capo_cloudfront.types.update_domain_association_result.deserialize_xml(
