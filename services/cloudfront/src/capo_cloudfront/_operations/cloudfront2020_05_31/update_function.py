...
def handle_response(
    ...
    out: capo_cloudfront.types.update_function_result.UpdateFunctionResult = {
...
def update_function(
    ...
    capo_cloudfront.types.update_function_result.UpdateFunctionResult, zapros.Response
]:
