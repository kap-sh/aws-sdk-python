...
import capo_cloudfront.errors.field_level_encryption_config_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FieldLevelEncryptionConfigInUse":
            raise capo_cloudfront.errors.field_level_encryption_config_in_use.FieldLevelEncryptionConfigInUse.from_xml(
                error_el, message
            )
