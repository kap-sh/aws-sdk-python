"""Generated from Smithy shape ``com.amazonaws.cloudfront#DeleteKeyGroup``."""
...
import capo_cloudfront.errors.resource_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUse":
            raise capo_cloudfront.errors.resource_in_use.ResourceInUse.from_xml(root)
        case _:
...
async def async_delete_key_group(
