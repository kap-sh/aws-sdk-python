...
from aws_sdk_signer_data._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_signer_data._async import anysleep
import time
...
class AsyncSignerDataClient:
    ...
    async def get_revocation_status(self, signature_timestamp: datetime.datetime, platform_id: "aws_sdk_signer_data.types.platform_id.PlatformId", profile_version_arn: "aws_sdk_signer_data.types.arn.Arn", job_arn: "aws_sdk_signer_data.types.arn.Arn", certificate_hashes: "aws_sdk_signer_data.types.certificate_hashes.CertificateHashes", *, config_overrides: Optional[AsyncSignerDataClientConfig] = None) -> "aws_sdk_signer_data.types.get_revocation_status_response.GetRevocationStatusResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_signer_data.types.get_revocation_status_request.GetRevocationStatusRequest]') -> AsyncOperationResponse["aws_sdk_signer_data.types.get_revocation_status_response.GetRevocationStatusResponse"]:
            import aws_sdk_signer_data._operations.signer_data_plane.get_revocation_status
            output, http_response = await aws_sdk_signer_data._operations.signer_data_plane.get_revocation_status.async_get_revocation_status(req.options, req.input)
