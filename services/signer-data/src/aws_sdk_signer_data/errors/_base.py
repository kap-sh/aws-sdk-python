...
class SignerDataError(Exception):
    """Base class for all SignerData service errors."""

class ServiceError(SignerDataError):
...
class SerializationError(SignerDataError):
    """Raised when a value cannot be serialized."""

class DeserializationError(SignerDataError):
...
class WaiterFailedError(SignerDataError):
...
class WaiterTimeoutError(SignerDataError):
