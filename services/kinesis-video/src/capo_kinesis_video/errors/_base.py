...
class KinesisVideoError(Exception):
    """Base class for all KinesisVideo service errors."""


class ServiceError(KinesisVideoError):
...
class SerializationError(KinesisVideoError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KinesisVideoError):
...
class WaiterFailedError(KinesisVideoError):
...
class WaiterTimeoutError(KinesisVideoError):
