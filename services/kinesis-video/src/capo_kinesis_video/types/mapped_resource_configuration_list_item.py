...
if TYPE_CHECKING:
    ...
    import capo_kinesis_video.types.type


class MappedResourceConfigurationListItem(TypedDict, closed=True):
    type: NotRequired["capo_kinesis_video.types.type.Type"]
    """<p>The type of the associated resource for the kinesis video stream.</p>"""
    arn: NotRequired["capo_kinesis_video.types.resource_arn.ResourceARN"]
