...
if TYPE_CHECKING:
    import aws_sdk_kinesis_video.types.media_uri_secret_arn
...
class MediaSourceConfig(TypedDict, closed=True):
    ...
    media_uri_type: "aws_sdk_kinesis_video.types.media_uri_type.MediaUriType"
...
def serialize_json(value: MediaSourceConfig) -> dict:
    ...
    out["MediaUriType"] = aws_sdk_kinesis_video.types.media_uri_type.serialize_json(
...
def deserialize_json(data: dict) -> MediaSourceConfig:
    ...
    if "MediaUriType" in data:
        ...
        out["media_uri_type"] = (
            aws_sdk_kinesis_video.types.media_uri_type.deserialize_json(
                data["MediaUriType"]
            )
        )
    else:
