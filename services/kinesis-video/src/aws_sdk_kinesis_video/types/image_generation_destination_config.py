...
if TYPE_CHECKING:
    import aws_sdk_kinesis_video.types.destination_region
    import aws_sdk_kinesis_video.types.destination_uri


class ImageGenerationDestinationConfig(TypedDict):
    ...
    destination_region: (
        "aws_sdk_kinesis_video.types.destination_region.DestinationRegion"
    )
