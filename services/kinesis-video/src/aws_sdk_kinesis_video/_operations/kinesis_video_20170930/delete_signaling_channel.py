...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.delete_signaling_channel_output.DeleteSignalingChannelOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_kinesis_video.types.delete_signaling_channel_input.DeleteSignalingChannelInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.delete_signaling_channel_input.serialize_json(input)
    ).encode()
