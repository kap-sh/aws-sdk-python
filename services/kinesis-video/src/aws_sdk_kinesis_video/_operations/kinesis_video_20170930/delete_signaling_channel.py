...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.delete_signaling_channel_input.DeleteSignalingChannelInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.delete_signaling_channel_input.serialize_json(
            input_
        )
    ).encode()
