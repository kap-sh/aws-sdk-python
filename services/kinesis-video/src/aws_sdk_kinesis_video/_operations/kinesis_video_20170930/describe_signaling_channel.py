...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.describe_signaling_channel_output.DescribeSignalingChannelOutput = aws_sdk_kinesis_video.types.describe_signaling_channel_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.describe_signaling_channel_input.DescribeSignalingChannelInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.describe_signaling_channel_input.serialize_json(
            input_
        )
    ).encode()
