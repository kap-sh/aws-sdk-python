...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourceFormatException":
            import aws_sdk_kinesis_video.errors.invalid_resource_format_exception

            raise aws_sdk_kinesis_video.errors.invalid_resource_format_exception.InvalidResourceFormatException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.list_tags_for_stream_output.ListTagsForStreamOutput = aws_sdk_kinesis_video.types.list_tags_for_stream_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.list_tags_for_stream_input.ListTagsForStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.list_tags_for_stream_input.serialize_json(input_)
    ).encode()
