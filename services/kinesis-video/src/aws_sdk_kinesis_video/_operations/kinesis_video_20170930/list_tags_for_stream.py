...
def build_request(
    ...
    input: aws_sdk_kinesis_video.types.list_tags_for_stream_input.ListTagsForStreamInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.list_tags_for_stream_input.serialize_json(input)
    ).encode()
