...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.list_signaling_channels_output.ListSignalingChannelsOutput = aws_sdk_kinesis_video.types.list_signaling_channels_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.list_signaling_channels_input.ListSignalingChannelsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.list_signaling_channels_input.serialize_json(input_)
    ).encode()
