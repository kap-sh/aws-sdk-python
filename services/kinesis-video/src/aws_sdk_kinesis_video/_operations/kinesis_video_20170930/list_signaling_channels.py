...
def build_request(
    ...
    input: aws_sdk_kinesis_video.types.list_signaling_channels_input.ListSignalingChannelsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.list_signaling_channels_input.serialize_json(input)
    ).encode()
