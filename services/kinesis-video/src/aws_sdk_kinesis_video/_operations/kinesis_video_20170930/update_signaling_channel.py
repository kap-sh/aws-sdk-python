...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.update_signaling_channel_output.UpdateSignalingChannelOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_kinesis_video.types.update_signaling_channel_input.UpdateSignalingChannelInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.update_signaling_channel_input.serialize_json(input)
    ).encode()
