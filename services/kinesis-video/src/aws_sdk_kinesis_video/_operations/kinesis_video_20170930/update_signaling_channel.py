...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.update_signaling_channel_input.UpdateSignalingChannelInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.update_signaling_channel_input.serialize_json(
            input_
        )
    ).encode()
