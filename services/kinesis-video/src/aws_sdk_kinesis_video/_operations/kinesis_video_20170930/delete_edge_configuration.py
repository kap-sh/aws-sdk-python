...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.delete_edge_configuration_output.DeleteEdgeConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.delete_edge_configuration_input.DeleteEdgeConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
