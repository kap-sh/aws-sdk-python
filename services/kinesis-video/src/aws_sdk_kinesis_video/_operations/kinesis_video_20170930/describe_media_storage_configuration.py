...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.describe_media_storage_configuration_output.DescribeMediaStorageConfigurationOutput = aws_sdk_kinesis_video.types.describe_media_storage_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.describe_media_storage_configuration_input.DescribeMediaStorageConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.describe_media_storage_configuration_input.serialize_json(
            input_
        )
    ).encode()
