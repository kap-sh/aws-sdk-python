"""Generated from Smithy shape ``com.amazonaws.kinesisvideo#DescribeStream``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.describe_stream_output.DescribeStreamOutput = (
        aws_sdk_kinesis_video.types.describe_stream_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.describe_stream_input.DescribeStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/describeStream"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_kinesis_video.types.describe_stream_input

    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.describe_stream_input.serialize_json(input_)
    ).encode()
