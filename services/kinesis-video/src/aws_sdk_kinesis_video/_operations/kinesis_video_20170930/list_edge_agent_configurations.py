...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.list_edge_agent_configurations_output.ListEdgeAgentConfigurationsOutput = aws_sdk_kinesis_video.types.list_edge_agent_configurations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.list_edge_agent_configurations_input.ListEdgeAgentConfigurationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.list_edge_agent_configurations_input.serialize_json(
            input_
        )
    ).encode()
