...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.list_streams_output.ListStreamsOutput = (
        aws_sdk_kinesis_video.types.list_streams_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_kinesis_video.types.list_streams_input.ListStreamsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.list_streams_input.serialize_json(input)
    ).encode()
...
def list_streams(
    ...
    aws_sdk_kinesis_video.types.list_streams_output.ListStreamsOutput, zapros.Response
]:
