...
def build_request(
    ...
    input: aws_sdk_kinesis_video.types.create_signaling_channel_input.CreateSignalingChannelInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.create_signaling_channel_input.serialize_json(input)
    ).encode()
