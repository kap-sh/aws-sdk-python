...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.create_signaling_channel_input.CreateSignalingChannelInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.create_signaling_channel_input.serialize_json(
            input_
        )
    ).encode()
