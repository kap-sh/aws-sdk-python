"""Generated from Smithy shape ``com.amazonaws.kinesisvideo#GetSignalingChannelEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.get_signaling_channel_endpoint_output.GetSignalingChannelEndpointOutput = aws_sdk_kinesis_video.types.get_signaling_channel_endpoint_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.get_signaling_channel_endpoint_input.GetSignalingChannelEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/getSignalingChannelEndpoint"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_kinesis_video.types.get_signaling_channel_endpoint_input

    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.get_signaling_channel_endpoint_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_signaling_channel_endpoint(
