...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.get_data_endpoint_output.GetDataEndpointOutput = (
        aws_sdk_kinesis_video.types.get_data_endpoint_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.get_data_endpoint_input.GetDataEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.get_data_endpoint_input.serialize_json(input_)
    ).encode()
