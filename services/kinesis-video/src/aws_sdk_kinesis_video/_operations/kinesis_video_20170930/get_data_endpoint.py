...
def build_request(
    ...
    input: aws_sdk_kinesis_video.types.get_data_endpoint_input.GetDataEndpointInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.get_data_endpoint_input.serialize_json(input)
    ).encode()
