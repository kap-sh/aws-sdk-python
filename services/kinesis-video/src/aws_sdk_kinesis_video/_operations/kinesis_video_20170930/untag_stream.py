...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.untag_stream_output.UntagStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.untag_stream_input.UntagStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.untag_stream_input.serialize_json(input_)
    ).encode()
...
def untag_stream(
    ...
    aws_sdk_kinesis_video.types.untag_stream_output.UntagStreamOutput, zapros.Response
]:
