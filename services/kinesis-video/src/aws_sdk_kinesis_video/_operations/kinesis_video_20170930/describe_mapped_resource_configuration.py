...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.describe_mapped_resource_configuration_output.DescribeMappedResourceConfigurationOutput = aws_sdk_kinesis_video.types.describe_mapped_resource_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.describe_mapped_resource_configuration_input.DescribeMappedResourceConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.describe_mapped_resource_configuration_input.serialize_json(
            input_
        )
    ).encode()
