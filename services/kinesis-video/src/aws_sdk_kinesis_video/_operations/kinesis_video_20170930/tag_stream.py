...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.tag_stream_output.TagStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.tag_stream_input.TagStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.tag_stream_input.serialize_json(input_)
    ).encode()
...
def tag_stream(
    ...
    aws_sdk_kinesis_video.types.tag_stream_output.TagStreamOutput, zapros.Response
]:
