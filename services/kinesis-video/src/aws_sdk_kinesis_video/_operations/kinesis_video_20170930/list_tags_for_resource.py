...
def build_request(
    ...
    input: aws_sdk_kinesis_video.types.list_tags_for_resource_input.ListTagsForResourceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.list_tags_for_resource_input.serialize_json(input)
    ).encode()
