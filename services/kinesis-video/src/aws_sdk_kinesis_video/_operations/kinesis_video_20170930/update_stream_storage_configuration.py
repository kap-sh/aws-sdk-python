...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.update_stream_storage_configuration_output.UpdateStreamStorageConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.update_stream_storage_configuration_input.UpdateStreamStorageConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.update_stream_storage_configuration_input.serialize_json(
            input_
        )
    ).encode()
