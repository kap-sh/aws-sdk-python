...
def build_request(
    ...
    input: aws_sdk_kinesis_video.types.update_data_retention_input.UpdateDataRetentionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.update_data_retention_input.serialize_json(input)
    ).encode()
