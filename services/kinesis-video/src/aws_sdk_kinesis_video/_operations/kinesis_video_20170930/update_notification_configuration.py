...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.update_notification_configuration_output.UpdateNotificationConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.update_notification_configuration_input.UpdateNotificationConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.update_notification_configuration_input.serialize_json(
            input_
        )
    ).encode()
