...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.delete_stream_output.DeleteStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.delete_stream_input.DeleteStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.delete_stream_input.serialize_json(input_)
    ).encode()
...
def delete_stream(
    ...
    aws_sdk_kinesis_video.types.delete_stream_output.DeleteStreamOutput, zapros.Response
]:
