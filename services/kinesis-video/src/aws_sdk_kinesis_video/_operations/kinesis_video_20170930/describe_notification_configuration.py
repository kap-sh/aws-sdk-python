...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.describe_notification_configuration_output.DescribeNotificationConfigurationOutput = aws_sdk_kinesis_video.types.describe_notification_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.describe_notification_configuration_input.DescribeNotificationConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.describe_notification_configuration_input.serialize_json(
            input_
        )
    ).encode()
