...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.describe_image_generation_configuration_output.DescribeImageGenerationConfigurationOutput = aws_sdk_kinesis_video.types.describe_image_generation_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.describe_image_generation_configuration_input.DescribeImageGenerationConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.describe_image_generation_configuration_input.serialize_json(
            input_
        )
    ).encode()
