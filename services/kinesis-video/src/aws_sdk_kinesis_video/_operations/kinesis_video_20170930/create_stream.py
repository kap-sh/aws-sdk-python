...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.create_stream_input.CreateStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.create_stream_input.serialize_json(input_)
    ).encode()
...
def create_stream(
    ...
    aws_sdk_kinesis_video.types.create_stream_output.CreateStreamOutput, zapros.Response
]:
