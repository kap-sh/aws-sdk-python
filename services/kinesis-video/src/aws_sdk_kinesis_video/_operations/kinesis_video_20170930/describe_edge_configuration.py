...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StreamEdgeConfigurationNotFoundException":
            import aws_sdk_kinesis_video.errors.stream_edge_configuration_not_found_exception

            raise aws_sdk_kinesis_video.errors.stream_edge_configuration_not_found_exception.StreamEdgeConfigurationNotFoundException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.describe_edge_configuration_output.DescribeEdgeConfigurationOutput = aws_sdk_kinesis_video.types.describe_edge_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.describe_edge_configuration_input.DescribeEdgeConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.describe_edge_configuration_input.serialize_json(
            input_
        )
    ).encode()
