...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.start_edge_configuration_update_output.StartEdgeConfigurationUpdateOutput = aws_sdk_kinesis_video.types.start_edge_configuration_update_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.start_edge_configuration_update_input.StartEdgeConfigurationUpdateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
