"""Generated from Smithy shape ``com.amazonaws.kinesisvideo#UpdateMediaStorageConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoDataRetentionException":
            import aws_sdk_kinesis_video.errors.no_data_retention_exception

            raise aws_sdk_kinesis_video.errors.no_data_retention_exception.NoDataRetentionException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kinesis_video.types.update_media_storage_configuration_output.UpdateMediaStorageConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video.types.update_media_storage_configuration_input.UpdateMediaStorageConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/updateMediaStorageConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_kinesis_video.types.update_media_storage_configuration_input

    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video.types.update_media_storage_configuration_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_media_storage_configuration(
