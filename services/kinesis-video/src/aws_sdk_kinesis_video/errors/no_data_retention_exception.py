"""Generated from Smithy shape ``com.amazonaws.kinesisvideo#NoDataRetentionException``."""
...
class NoDataRetentionException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisvideo#NoDataRetentionException``."""
