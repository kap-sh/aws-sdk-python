"""Generated from Smithy shape ``com.amazonaws.kinesisvideo#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisvideo#ResourceNotFoundException``."""
