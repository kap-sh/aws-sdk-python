...
def serialize_json(value: DeprecationDetail) -> dict:
    ...
    if "client_stats" in value:
        ...
        out["clientStats"] = capo_eks.types.client_stats.serialize_json(
            value["client_stats"]
        )
    return out
