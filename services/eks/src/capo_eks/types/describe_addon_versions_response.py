...
class DescribeAddonVersionsResponse(TypedDict, closed=True):
    addons: NotRequired["capo_eks.types.addons.Addons"]
...
def serialize_json(value: DescribeAddonVersionsResponse) -> dict:
    ...
    if "addons" in value:
        ...
        out["addons"] = capo_eks.types.addons.serialize_json(value["addons"])
...
def deserialize_json(data: dict) -> DescribeAddonVersionsResponse:
    ...
    if "addons" in data:
        ...
        out["addons"] = capo_eks.types.addons.deserialize_json(data["addons"])
