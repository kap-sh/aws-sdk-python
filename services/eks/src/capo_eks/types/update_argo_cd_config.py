...
class UpdateArgoCdConfig(TypedDict, closed=True):
    rbac_role_mappings: NotRequired[
        "capo_eks.types.update_role_mappings.UpdateRoleMappings"
    ]
...
def serialize_json(value: UpdateArgoCdConfig) -> dict:
    ...
    if "rbac_role_mappings" in value:
        ...
        out["rbacRoleMappings"] = capo_eks.types.update_role_mappings.serialize_json(
...
def deserialize_json(data: dict) -> UpdateArgoCdConfig:
    ...
    if "rbacRoleMappings" in data:
        ...
        out["rbac_role_mappings"] = (
            capo_eks.types.update_role_mappings.deserialize_json(
