...
class AddonInfo(TypedDict, closed=True):
    ...
    addon_versions: NotRequired[
        "capo_eks.types.addon_version_info_list.AddonVersionInfoList"
    ]
    ...
    default_namespace: NotRequired["capo_eks.types.string.String"]
...
def serialize_json(value: AddonInfo) -> dict:
    ...
    if "addon_versions" in value:
        ...
        out["addonVersions"] = capo_eks.types.addon_version_info_list.serialize_json(
