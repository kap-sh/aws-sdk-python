...
# --- restJson1 ser/de ---
def serialize_json(value: ListIdentityProviderConfigsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListIdentityProviderConfigsRequest:
    out: ListIdentityProviderConfigsRequest = {}  # type: ignore[typeddict-item]
    return out
