...
class ErrorDetail(TypedDict, closed=True):
    error_code: NotRequired["capo_eks.types.error_code.ErrorCode"]
    ...
    error_message: NotRequired["capo_eks.types.string.String"]
...
def serialize_json(value: ErrorDetail) -> dict:
    ...
    if "error_code" in value:
        ...
        out["errorCode"] = capo_eks.types.error_code.serialize_json(value["error_code"])
