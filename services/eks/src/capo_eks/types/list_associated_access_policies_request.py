"""Generated from Smithy shape ``com.amazonaws.eks#ListAssociatedAccessPoliciesRequest``."""
...
class ListAssociatedAccessPoliciesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListAssociatedAccessPoliciesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListAssociatedAccessPoliciesRequest:
    out: ListAssociatedAccessPoliciesRequest = {}  # type: ignore[typeddict-item]
    return out
