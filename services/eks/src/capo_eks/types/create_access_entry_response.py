...
# --- restJson1 ser/de ---
def serialize_json(value: CreateAccessEntryResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateAccessEntryResponse:
    out: CreateAccessEntryResponse = {}  # type: ignore[typeddict-item]
