...
if TYPE_CHECKING:
    import capo_eks.types.node_repair_config_overrides

NodeRepairConfigOverridesList: TypeAlias = list[
    "capo_eks.types.node_repair_config_overrides.NodeRepairConfigOverrides"
]
...
def serialize_json(value: NodeRepairConfigOverridesList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_eks.types.node_repair_config_overrides.serialize_json(item))
    return out
