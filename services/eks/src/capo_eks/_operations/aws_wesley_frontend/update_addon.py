"""Generated from Smithy shape ``com.amazonaws.eks#UpdateAddon``."""
...
def handle_response(
    ...
    out: capo_eks.types.update_addon_response.UpdateAddonResponse = (
        capo_eks.types.update_addon_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/clusters/{clusterName}/addons/{addonName}/update"
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.update_addon_request.serialize_json(input_)
    ).encode()
...
def update_addon(
    ...
    input_: capo_eks.types.update_addon_request.UpdateAddonRequest,
) -> tuple[capo_eks.types.update_addon_response.UpdateAddonResponse, zapros.Response]:
