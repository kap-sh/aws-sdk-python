...
def handle_response(
    ...
    out: capo_eks.types.associate_identity_provider_config_response.AssociateIdentityProviderConfigResponse = capo_eks.types.associate_identity_provider_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.associate_identity_provider_config_request.serialize_json(input_)
    ).encode()
