...
def handle_response(
    ...
    out: capo_eks.types.describe_eks_anywhere_subscription_response.DescribeEksAnywhereSubscriptionResponse = capo_eks.types.describe_eks_anywhere_subscription_response.deserialize_json(
