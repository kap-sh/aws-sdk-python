...
def handle_response(
    ...
    out: capo_eks.types.list_associated_access_policies_response.ListAssociatedAccessPoliciesResponse = capo_eks.types.list_associated_access_policies_response.deserialize_json(
