"""Generated from Smithy shape ``com.amazonaws.eks#ListAddons``."""
...
def handle_response(
    ...
    out: capo_eks.types.list_addons_response.ListAddonsResponse = (
        capo_eks.types.list_addons_response.deserialize_json(
...
def list_addons(
    ...
    input_: capo_eks.types.list_addons_request.ListAddonsRequest,
) -> tuple[capo_eks.types.list_addons_response.ListAddonsResponse, zapros.Response]:
