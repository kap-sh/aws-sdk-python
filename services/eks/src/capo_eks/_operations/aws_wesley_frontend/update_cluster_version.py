...
import capo_eks.errors.invalid_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidStateException":
            raise capo_eks.errors.invalid_state_exception.InvalidStateException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_eks.types.update_cluster_version_response.UpdateClusterVersionResponse = (
        capo_eks.types.update_cluster_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.update_cluster_version_request.serialize_json(input_)
    ).encode()
