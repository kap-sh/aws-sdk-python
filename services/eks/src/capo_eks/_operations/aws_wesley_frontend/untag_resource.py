"""Generated from Smithy shape ``com.amazonaws.eks#UntagResource``."""
...
import capo_eks.errors.bad_request_exception
import capo_eks.errors.not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BadRequestException":
            raise capo_eks.errors.bad_request_exception.BadRequestException.from_json(
                data
            )
        case "NotFoundException":
            raise capo_eks.errors.not_found_exception.NotFoundException.from_json(data)
        case _:
...
def handle_response(
    ...
    out: capo_eks.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_eks.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
