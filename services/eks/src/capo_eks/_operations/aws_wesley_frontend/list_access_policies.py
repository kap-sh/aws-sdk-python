"""Generated from Smithy shape ``com.amazonaws.eks#ListAccessPolicies``."""
...
def handle_response(
    ...
    out: capo_eks.types.list_access_policies_response.ListAccessPoliciesResponse = (
        capo_eks.types.list_access_policies_response.deserialize_json(
