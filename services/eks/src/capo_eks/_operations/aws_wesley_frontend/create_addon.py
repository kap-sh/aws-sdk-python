...
def handle_response(
    ...
    out: capo_eks.types.create_addon_response.CreateAddonResponse = (
        capo_eks.types.create_addon_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.create_addon_request.serialize_json(input_)
    ).encode()
...
def create_addon(
    ...
    input_: capo_eks.types.create_addon_request.CreateAddonRequest,
) -> tuple[capo_eks.types.create_addon_response.CreateAddonResponse, zapros.Response]:
