"""Generated from Smithy shape ``com.amazonaws.eks#DescribeCluster``."""
...
def handle_response(
    ...
    out: capo_eks.types.describe_cluster_response.DescribeClusterResponse = (
        capo_eks.types.describe_cluster_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/clusters/{name}"
...
def describe_cluster(
    ...
    capo_eks.types.describe_cluster_response.DescribeClusterResponse, zapros.Response
]:
