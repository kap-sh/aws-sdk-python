"""Generated from Smithy shape ``com.amazonaws.eks#DeleteAccessEntry``."""
...
def handle_response(
    ...
    out: capo_eks.types.delete_access_entry_response.DeleteAccessEntryResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_access_entry(
