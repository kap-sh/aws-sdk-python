"""Generated from Smithy shape ``com.amazonaws.eks#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_eks.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_eks.types.list_tags_for_resource_response.deserialize_json(
