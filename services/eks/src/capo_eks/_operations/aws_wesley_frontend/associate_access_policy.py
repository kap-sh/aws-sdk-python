...
def handle_response(
    ...
    out: capo_eks.types.associate_access_policy_response.AssociateAccessPolicyResponse = capo_eks.types.associate_access_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.associate_access_policy_request.serialize_json(input_)
    ).encode()
