...
def handle_response(
    ...
    out: capo_eks.types.update_nodegroup_config_response.UpdateNodegroupConfigResponse = capo_eks.types.update_nodegroup_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.update_nodegroup_config_request.serialize_json(input_)
    ).encode()
