...
def handle_response(
    ...
    out: capo_eks.types.update_nodegroup_version_response.UpdateNodegroupVersionResponse = capo_eks.types.update_nodegroup_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.update_nodegroup_version_request.serialize_json(input_)
    ).encode()
