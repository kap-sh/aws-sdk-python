"""Generated from Smithy shape ``com.amazonaws.eks#DeleteCapability``."""
...
def handle_response(
    ...
    out: capo_eks.types.delete_capability_response.DeleteCapabilityResponse = (
        capo_eks.types.delete_capability_response.deserialize_json(
...
def delete_capability(
    ...
    capo_eks.types.delete_capability_response.DeleteCapabilityResponse, zapros.Response
]:
...
async def async_delete_capability(
