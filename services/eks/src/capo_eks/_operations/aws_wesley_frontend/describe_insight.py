"""Generated from Smithy shape ``com.amazonaws.eks#DescribeInsight``."""
...
def handle_response(
    ...
    out: capo_eks.types.describe_insight_response.DescribeInsightResponse = (
        capo_eks.types.describe_insight_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/clusters/{clusterName}/insights/{id}"
...
def describe_insight(
    ...
    capo_eks.types.describe_insight_response.DescribeInsightResponse, zapros.Response
]:
