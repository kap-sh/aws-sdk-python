...
def handle_response(
    ...
    out: capo_eks.types.list_nodegroups_response.ListNodegroupsResponse = (
        capo_eks.types.list_nodegroups_response.deserialize_json(
...
def list_nodegroups(
    ...
    capo_eks.types.list_nodegroups_response.ListNodegroupsResponse, zapros.Response
]:
