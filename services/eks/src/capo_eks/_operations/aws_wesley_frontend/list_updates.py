...
def handle_response(
    ...
    out: capo_eks.types.list_updates_response.ListUpdatesResponse = (
        capo_eks.types.list_updates_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_eks.types.list_updates_request.ListUpdatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_updates(
    ...
    input_: capo_eks.types.list_updates_request.ListUpdatesRequest,
) -> tuple[capo_eks.types.list_updates_response.ListUpdatesResponse, zapros.Response]:
