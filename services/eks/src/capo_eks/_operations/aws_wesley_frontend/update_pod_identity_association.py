"""Generated from Smithy shape ``com.amazonaws.eks#UpdatePodIdentityAssociation``."""
...
def handle_response(
    ...
    out: capo_eks.types.update_pod_identity_association_response.UpdatePodIdentityAssociationResponse = capo_eks.types.update_pod_identity_association_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.update_pod_identity_association_request.serialize_json(input_)
    ).encode()
...
async def async_update_pod_identity_association(
