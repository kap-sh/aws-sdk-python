"""Generated from Smithy shape ``com.amazonaws.eks#CreateEksAnywhereSubscription``."""
...
def handle_response(
    ...
    out: capo_eks.types.create_eks_anywhere_subscription_response.CreateEksAnywhereSubscriptionResponse = capo_eks.types.create_eks_anywhere_subscription_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.create_eks_anywhere_subscription_request.serialize_json(input_)
    ).encode()
...
async def async_create_eks_anywhere_subscription(
