...
def handle_response(
    ...
    out: capo_eks.types.delete_pod_identity_association_response.DeletePodIdentityAssociationResponse = capo_eks.types.delete_pod_identity_association_response.deserialize_json(
