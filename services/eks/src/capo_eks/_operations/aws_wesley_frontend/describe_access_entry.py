"""Generated from Smithy shape ``com.amazonaws.eks#DescribeAccessEntry``."""
...
def handle_response(
    ...
    out: capo_eks.types.describe_access_entry_response.DescribeAccessEntryResponse = (
        capo_eks.types.describe_access_entry_response.deserialize_json(
...
async def async_describe_access_entry(
