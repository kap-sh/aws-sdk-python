"""Generated from Smithy shape ``com.amazonaws.eks#InvalidParameterException``."""
...
class InvalidParameterException_(TypedDict, closed=True):
    ...
    fargate_profile_name: NotRequired["capo_eks.types.string.String"]
...
class InvalidParameterException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.eks#InvalidParameterException``."""
