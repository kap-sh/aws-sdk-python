...
def handle_response(
    ...
    out: aws_sdk_eks.types.create_access_entry_response.CreateAccessEntryResponse = (
        aws_sdk_eks.types.create_access_entry_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.create_access_entry_request.CreateAccessEntryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.create_access_entry_request.serialize_json(input_)
    ).encode()
