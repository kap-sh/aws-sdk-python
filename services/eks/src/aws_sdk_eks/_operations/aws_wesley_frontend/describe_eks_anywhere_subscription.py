"""Generated from Smithy shape ``com.amazonaws.eks#DescribeEksAnywhereSubscription``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.describe_eks_anywhere_subscription_request
    import aws_sdk_eks.types.describe_eks_anywhere_subscription_response
...
) -> aws_sdk_eks.types.describe_eks_anywhere_subscription_response.DescribeEksAnywhereSubscriptionResponse:
    import aws_sdk_eks.types.describe_eks_anywhere_subscription_response

    out: aws_sdk_eks.types.describe_eks_anywhere_subscription_response.DescribeEksAnywhereSubscriptionResponse = aws_sdk_eks.types.describe_eks_anywhere_subscription_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.describe_eks_anywhere_subscription_request.DescribeEksAnywhereSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_eks_anywhere_subscription(
