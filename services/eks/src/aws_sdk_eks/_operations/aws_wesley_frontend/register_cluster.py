...
import aws_sdk_eks.errors.resource_propagation_delay_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourcePropagationDelayException":
            raise aws_sdk_eks.errors.resource_propagation_delay_exception.ResourcePropagationDelayException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_eks.types.register_cluster_response.RegisterClusterResponse = (
        aws_sdk_eks.types.register_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.register_cluster_request.RegisterClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.register_cluster_request.serialize_json(input_)
    ).encode()
...
def register_cluster(
    ...
    aws_sdk_eks.types.register_cluster_response.RegisterClusterResponse, zapros.Response
]:
