...
def handle_response(
    ...
    out: aws_sdk_eks.types.describe_insight_response.DescribeInsightResponse = (
        aws_sdk_eks.types.describe_insight_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.describe_insight_request.DescribeInsightRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_insight(
    ...
    aws_sdk_eks.types.describe_insight_response.DescribeInsightResponse, zapros.Response
]:
