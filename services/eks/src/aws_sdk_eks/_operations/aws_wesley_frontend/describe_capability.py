...
def handle_response(
    ...
    out: aws_sdk_eks.types.describe_capability_response.DescribeCapabilityResponse = (
        aws_sdk_eks.types.describe_capability_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_eks.types.describe_capability_request.DescribeCapabilityRequest,
) -> zapros.Request:
