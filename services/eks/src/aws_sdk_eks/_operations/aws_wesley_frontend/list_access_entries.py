"""Generated from Smithy shape ``com.amazonaws.eks#ListAccessEntries``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.list_access_entries_request
    import aws_sdk_eks.types.list_access_entries_response
...
) -> aws_sdk_eks.types.list_access_entries_response.ListAccessEntriesResponse:
    import aws_sdk_eks.types.list_access_entries_response

    out: aws_sdk_eks.types.list_access_entries_response.ListAccessEntriesResponse = (
        aws_sdk_eks.types.list_access_entries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.list_access_entries_request.ListAccessEntriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "associated_policy_arn" in input_:
        params["associatedPolicyArn"] = str(input_["associated_policy_arn"])
...
async def async_list_access_entries(
