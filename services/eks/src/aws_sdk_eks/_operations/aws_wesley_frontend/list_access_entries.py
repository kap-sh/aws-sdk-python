...
def build_request(
    ...
    input: aws_sdk_eks.types.list_access_entries_request.ListAccessEntriesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "associated_policy_arn" in input:
        params["associatedPolicyArn"] = str(input["associated_policy_arn"])
