...
def handle_response(
    ...
    out: aws_sdk_eks.types.describe_access_entry_response.DescribeAccessEntryResponse = aws_sdk_eks.types.describe_access_entry_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.describe_access_entry_request.DescribeAccessEntryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
