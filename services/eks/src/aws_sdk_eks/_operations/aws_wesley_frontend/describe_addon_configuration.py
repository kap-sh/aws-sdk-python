...
if TYPE_CHECKING:
    ...
    import aws_sdk_eks.types.describe_addon_configuration_response
...
) -> aws_sdk_eks.types.describe_addon_configuration_response.DescribeAddonConfigurationResponse:
    import aws_sdk_eks.types.describe_addon_configuration_response

    out: aws_sdk_eks.types.describe_addon_configuration_response.DescribeAddonConfigurationResponse = aws_sdk_eks.types.describe_addon_configuration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_eks.types.describe_addon_configuration_request.DescribeAddonConfigurationRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/addons/configuration-schemas"
    params: dict[str, str] = {}
    if "addon_name" in input:
        params["addonName"] = str(input["addon_name"])
    if "addon_version" in input:
        params["addonVersion"] = str(input["addon_version"])
...
async def async_describe_addon_configuration(
