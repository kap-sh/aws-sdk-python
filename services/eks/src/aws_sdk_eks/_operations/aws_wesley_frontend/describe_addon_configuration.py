...
def build_request(
    ...
    input_: aws_sdk_eks.types.describe_addon_configuration_request.DescribeAddonConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "addon_version" in input_:
        params["addonVersion"] = str(input_["addon_version"])
