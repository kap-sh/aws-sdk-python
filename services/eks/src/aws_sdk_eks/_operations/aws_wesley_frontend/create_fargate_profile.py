...
def build_request(
    ...
    input: aws_sdk_eks.types.create_fargate_profile_request.CreateFargateProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.create_fargate_profile_request.serialize_json(input)
    ).encode()
