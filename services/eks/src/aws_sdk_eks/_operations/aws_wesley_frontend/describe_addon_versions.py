...
def build_request(
    ...
    input_: aws_sdk_eks.types.describe_addon_versions_request.DescribeAddonVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "kubernetes_version" in input_:
        params["kubernetesVersion"] = str(input_["kubernetes_version"])
    ...
    if "types" in input_:
        params["types"] = str(input_["types"])
    if "publishers" in input_:
        params["publishers"] = str(input_["publishers"])
    if "owners" in input_:
        params["owners"] = str(input_["owners"])
