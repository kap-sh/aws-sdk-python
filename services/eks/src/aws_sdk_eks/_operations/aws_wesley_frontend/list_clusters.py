"""Generated from Smithy shape ``com.amazonaws.eks#ListClusters``."""
...
import aws_sdk_eks.types.include_clusters_list
import aws_sdk_eks.types.list_clusters_request
import aws_sdk_eks.types.list_clusters_response
...
) -> aws_sdk_eks.types.list_clusters_response.ListClustersResponse:
    out: aws_sdk_eks.types.list_clusters_response.ListClustersResponse = (
        aws_sdk_eks.types.list_clusters_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.list_clusters_request.ListClustersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_clusters(
    ...
    aws_sdk_eks.types.list_clusters_response.ListClustersResponse, zapros.Response
]:
