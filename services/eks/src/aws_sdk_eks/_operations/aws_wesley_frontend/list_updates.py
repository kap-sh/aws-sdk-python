...
def build_request(
    ...
    input_: aws_sdk_eks.types.list_updates_request.ListUpdatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "nodegroup_name" in input_:
        params["nodegroupName"] = str(input_["nodegroup_name"])
    if "addon_name" in input_:
        params["addonName"] = str(input_["addon_name"])
    if "capability_name" in input_:
        params["capabilityName"] = str(input_["capability_name"])
