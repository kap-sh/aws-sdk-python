"""Generated from Smithy shape ``com.amazonaws.eks#ListUpdates``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.list_updates_request
    import aws_sdk_eks.types.list_updates_response
...
) -> aws_sdk_eks.types.list_updates_response.ListUpdatesResponse:
    import aws_sdk_eks.types.list_updates_response

    out: aws_sdk_eks.types.list_updates_response.ListUpdatesResponse = (
        aws_sdk_eks.types.list_updates_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_eks.types.list_updates_request.ListUpdatesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "nodegroup_name" in input:
        params["nodegroupName"] = str(input["nodegroup_name"])
    if "addon_name" in input:
        params["addonName"] = str(input["addon_name"])
    if "capability_name" in input:
        params["capabilityName"] = str(input["capability_name"])
...
def list_updates(
    ...
    aws_sdk_eks.types.list_updates_response.ListUpdatesResponse, zapros.Response
]:
