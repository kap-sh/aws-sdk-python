"""Generated from Smithy shape ``com.amazonaws.eks#DeletePodIdentityAssociation``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.delete_pod_identity_association_request
    import aws_sdk_eks.types.delete_pod_identity_association_response
...
) -> aws_sdk_eks.types.delete_pod_identity_association_response.DeletePodIdentityAssociationResponse:
    import aws_sdk_eks.types.delete_pod_identity_association_response

    out: aws_sdk_eks.types.delete_pod_identity_association_response.DeletePodIdentityAssociationResponse = aws_sdk_eks.types.delete_pod_identity_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.delete_pod_identity_association_request.DeletePodIdentityAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_pod_identity_association(
