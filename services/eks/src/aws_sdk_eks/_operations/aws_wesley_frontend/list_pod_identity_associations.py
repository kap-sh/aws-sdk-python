...
def handle_response(
    ...
    out: aws_sdk_eks.types.list_pod_identity_associations_response.ListPodIdentityAssociationsResponse = aws_sdk_eks.types.list_pod_identity_associations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_eks.types.list_pod_identity_associations_request.ListPodIdentityAssociationsRequest,
) -> zapros.Request:
    ...
    if "service_account" in input:
        params["serviceAccount"] = str(input["service_account"])
