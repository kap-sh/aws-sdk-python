...
def handle_response(
    ...
    out: aws_sdk_eks.types.list_addons_response.ListAddonsResponse = (
        aws_sdk_eks.types.list_addons_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.list_addons_request.ListAddonsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_addons(
    ...
    input_: aws_sdk_eks.types.list_addons_request.ListAddonsRequest,
) -> tuple[aws_sdk_eks.types.list_addons_response.ListAddonsResponse, zapros.Response]:
