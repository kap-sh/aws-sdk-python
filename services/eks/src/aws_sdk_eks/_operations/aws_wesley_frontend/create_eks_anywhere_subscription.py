...
def build_request(
    ...
    input_: aws_sdk_eks.types.create_eks_anywhere_subscription_request.CreateEksAnywhereSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.create_eks_anywhere_subscription_request.serialize_json(
            input_
        )
    ).encode()
