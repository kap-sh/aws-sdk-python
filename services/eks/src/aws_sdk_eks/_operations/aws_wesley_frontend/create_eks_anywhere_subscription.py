...
def handle_response(
    ...
    out: aws_sdk_eks.types.create_eks_anywhere_subscription_response.CreateEksAnywhereSubscriptionResponse = aws_sdk_eks.types.create_eks_anywhere_subscription_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_eks.types.create_eks_anywhere_subscription_request.CreateEksAnywhereSubscriptionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.create_eks_anywhere_subscription_request.serialize_json(input)
    ).encode()
