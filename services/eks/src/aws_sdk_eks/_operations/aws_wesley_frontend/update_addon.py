...
def handle_response(
    ...
    out: aws_sdk_eks.types.update_addon_response.UpdateAddonResponse = (
        aws_sdk_eks.types.update_addon_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.update_addon_request.UpdateAddonRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.update_addon_request.serialize_json(input_)
    ).encode()
...
def update_addon(
    ...
    aws_sdk_eks.types.update_addon_response.UpdateAddonResponse, zapros.Response
]:
