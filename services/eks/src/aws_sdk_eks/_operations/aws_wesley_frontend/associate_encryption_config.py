...
def build_request(
    ...
    input_: aws_sdk_eks.types.associate_encryption_config_request.AssociateEncryptionConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.associate_encryption_config_request.serialize_json(input_)
    ).encode()
