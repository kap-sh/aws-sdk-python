...
if TYPE_CHECKING:
    import aws_sdk_eks.types.update_eks_anywhere_subscription_request
    import aws_sdk_eks.types.update_eks_anywhere_subscription_response
...
) -> aws_sdk_eks.types.update_eks_anywhere_subscription_response.UpdateEksAnywhereSubscriptionResponse:
    import aws_sdk_eks.types.update_eks_anywhere_subscription_response

    out: aws_sdk_eks.types.update_eks_anywhere_subscription_response.UpdateEksAnywhereSubscriptionResponse = aws_sdk_eks.types.update_eks_anywhere_subscription_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_eks.types.update_eks_anywhere_subscription_request.UpdateEksAnywhereSubscriptionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.update_eks_anywhere_subscription_request.serialize_json(input)
    ).encode()
