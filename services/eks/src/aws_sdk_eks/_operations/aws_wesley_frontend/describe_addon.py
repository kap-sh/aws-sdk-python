"""Generated from Smithy shape ``com.amazonaws.eks#DescribeAddon``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.describe_addon_request
    import aws_sdk_eks.types.describe_addon_response
...
) -> aws_sdk_eks.types.describe_addon_response.DescribeAddonResponse:
    import aws_sdk_eks.types.describe_addon_response

    out: aws_sdk_eks.types.describe_addon_response.DescribeAddonResponse = (
        aws_sdk_eks.types.describe_addon_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.describe_addon_request.DescribeAddonRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_addon(
    ...
    aws_sdk_eks.types.describe_addon_response.DescribeAddonResponse, zapros.Response
]:
...
async def async_describe_addon(
