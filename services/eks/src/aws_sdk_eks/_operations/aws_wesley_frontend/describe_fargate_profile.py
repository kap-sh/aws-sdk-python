"""Generated from Smithy shape ``com.amazonaws.eks#DescribeFargateProfile``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.describe_fargate_profile_request
    import aws_sdk_eks.types.describe_fargate_profile_response
...
) -> aws_sdk_eks.types.describe_fargate_profile_response.DescribeFargateProfileResponse:
    import aws_sdk_eks.types.describe_fargate_profile_response

    out: aws_sdk_eks.types.describe_fargate_profile_response.DescribeFargateProfileResponse = aws_sdk_eks.types.describe_fargate_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.describe_fargate_profile_request.DescribeFargateProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{fargateProfileName}", quote(str(input_["fargate_profile_name"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_describe_fargate_profile(
