...
def build_request(
    ...
    input: aws_sdk_eks.types.update_pod_identity_association_request.UpdatePodIdentityAssociationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.update_pod_identity_association_request.serialize_json(input)
    ).encode()
