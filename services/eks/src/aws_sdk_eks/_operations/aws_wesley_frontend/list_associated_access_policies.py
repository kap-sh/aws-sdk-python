"""Generated from Smithy shape ``com.amazonaws.eks#ListAssociatedAccessPolicies``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.list_associated_access_policies_request
    import aws_sdk_eks.types.list_associated_access_policies_response
...
) -> aws_sdk_eks.types.list_associated_access_policies_response.ListAssociatedAccessPoliciesResponse:
    import aws_sdk_eks.types.list_associated_access_policies_response

    out: aws_sdk_eks.types.list_associated_access_policies_response.ListAssociatedAccessPoliciesResponse = aws_sdk_eks.types.list_associated_access_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.list_associated_access_policies_request.ListAssociatedAccessPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{principalArn}", quote(str(input_["principal_arn"]), safe=""))
    params: dict[str, str] = {}
...
async def async_list_associated_access_policies(
