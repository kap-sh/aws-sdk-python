"""Generated from Smithy shape ``com.amazonaws.eks#AssociateIdentityProviderConfig``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.associate_identity_provider_config_request
    import aws_sdk_eks.types.associate_identity_provider_config_response
...
) -> aws_sdk_eks.types.associate_identity_provider_config_response.AssociateIdentityProviderConfigResponse:
    import aws_sdk_eks.types.associate_identity_provider_config_response

    out: aws_sdk_eks.types.associate_identity_provider_config_response.AssociateIdentityProviderConfigResponse = aws_sdk_eks.types.associate_identity_provider_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.associate_identity_provider_config_request.AssociateIdentityProviderConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.associate_identity_provider_config_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_identity_provider_config(
