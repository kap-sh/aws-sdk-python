...
def handle_response(
    ...
    out: aws_sdk_eks.types.create_pod_identity_association_response.CreatePodIdentityAssociationResponse = aws_sdk_eks.types.create_pod_identity_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.create_pod_identity_association_request.CreatePodIdentityAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.create_pod_identity_association_request.serialize_json(input_)
    ).encode()
