...
def build_request(
    ...
    input: aws_sdk_eks.types.create_pod_identity_association_request.CreatePodIdentityAssociationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.create_pod_identity_association_request.serialize_json(input)
    ).encode()
