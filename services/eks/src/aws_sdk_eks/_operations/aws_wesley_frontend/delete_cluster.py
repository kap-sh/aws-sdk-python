"""Generated from Smithy shape ``com.amazonaws.eks#DeleteCluster``."""
...
def build_request(
    ...
    input_: aws_sdk_eks.types.delete_cluster_request.DeleteClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_cluster(
    ...
    aws_sdk_eks.types.delete_cluster_response.DeleteClusterResponse, zapros.Response
]:
