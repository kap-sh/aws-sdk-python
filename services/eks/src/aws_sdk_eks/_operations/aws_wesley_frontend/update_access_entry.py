"""Generated from Smithy shape ``com.amazonaws.eks#UpdateAccessEntry``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.update_access_entry_request
    import aws_sdk_eks.types.update_access_entry_response
...
) -> aws_sdk_eks.types.update_access_entry_response.UpdateAccessEntryResponse:
    import aws_sdk_eks.types.update_access_entry_response

    out: aws_sdk_eks.types.update_access_entry_response.UpdateAccessEntryResponse = (
        aws_sdk_eks.types.update_access_entry_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.update_access_entry_request.UpdateAccessEntryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.update_access_entry_request.serialize_json(input_)
    ).encode()
...
async def async_update_access_entry(
