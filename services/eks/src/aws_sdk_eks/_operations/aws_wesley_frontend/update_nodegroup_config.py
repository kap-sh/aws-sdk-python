...
def build_request(
    ...
    input: aws_sdk_eks.types.update_nodegroup_config_request.UpdateNodegroupConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.update_nodegroup_config_request.serialize_json(input)
    ).encode()
