"""Generated from Smithy shape ``com.amazonaws.eks#UpdateNodegroupConfig``."""
...
import aws_sdk_eks.types.update_nodegroup_config_request
import aws_sdk_eks.types.update_nodegroup_config_response
...
) -> aws_sdk_eks.types.update_nodegroup_config_response.UpdateNodegroupConfigResponse:
    out: aws_sdk_eks.types.update_nodegroup_config_response.UpdateNodegroupConfigResponse = aws_sdk_eks.types.update_nodegroup_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.update_nodegroup_config_request.UpdateNodegroupConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.update_nodegroup_config_request.serialize_json(input_)
    ).encode()
...
async def async_update_nodegroup_config(
