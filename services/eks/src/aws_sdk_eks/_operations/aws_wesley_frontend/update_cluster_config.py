"""Generated from Smithy shape ``com.amazonaws.eks#UpdateClusterConfig``."""
...
import aws_sdk_eks.types.update_access_config_request
import aws_sdk_eks.types.update_cluster_config_request
import aws_sdk_eks.types.update_cluster_config_response
...
) -> aws_sdk_eks.types.update_cluster_config_response.UpdateClusterConfigResponse:
    out: aws_sdk_eks.types.update_cluster_config_response.UpdateClusterConfigResponse = aws_sdk_eks.types.update_cluster_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.update_cluster_config_request.UpdateClusterConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/clusters/{name}/update-config"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.update_cluster_config_request.serialize_json(input_)
    ).encode()
...
async def async_update_cluster_config(
