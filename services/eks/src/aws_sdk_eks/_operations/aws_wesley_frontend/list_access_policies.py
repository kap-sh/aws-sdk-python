...
def handle_response(
    ...
    out: aws_sdk_eks.types.list_access_policies_response.ListAccessPoliciesResponse = (
        aws_sdk_eks.types.list_access_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.list_access_policies_request.ListAccessPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
