"""Generated from Smithy shape ``com.amazonaws.eks#DescribeNodegroup``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.describe_nodegroup_request
    import aws_sdk_eks.types.describe_nodegroup_response
...
) -> aws_sdk_eks.types.describe_nodegroup_response.DescribeNodegroupResponse:
    import aws_sdk_eks.types.describe_nodegroup_response

    out: aws_sdk_eks.types.describe_nodegroup_response.DescribeNodegroupResponse = (
        aws_sdk_eks.types.describe_nodegroup_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.describe_nodegroup_request.DescribeNodegroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/clusters/{clusterName}/node-groups/{nodegroupName}"
    )
...
async def async_describe_nodegroup(
