...
def handle_response(
    ...
    out: aws_sdk_eks.types.delete_nodegroup_response.DeleteNodegroupResponse = (
        aws_sdk_eks.types.delete_nodegroup_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.delete_nodegroup_request.DeleteNodegroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_nodegroup(
    ...
    aws_sdk_eks.types.delete_nodegroup_response.DeleteNodegroupResponse, zapros.Response
]:
