...
def handle_response(
    ...
    out: aws_sdk_eks.types.delete_fargate_profile_response.DeleteFargateProfileResponse = aws_sdk_eks.types.delete_fargate_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.delete_fargate_profile_request.DeleteFargateProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
