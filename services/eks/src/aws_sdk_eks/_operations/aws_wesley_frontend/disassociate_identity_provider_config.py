...
def handle_response(
    ...
    out: aws_sdk_eks.types.disassociate_identity_provider_config_response.DisassociateIdentityProviderConfigResponse = aws_sdk_eks.types.disassociate_identity_provider_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.disassociate_identity_provider_config_request.DisassociateIdentityProviderConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.disassociate_identity_provider_config_request.serialize_json(
            input_
        )
    ).encode()
