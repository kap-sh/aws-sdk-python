"""Generated from Smithy shape ``com.amazonaws.eks#ListFargateProfiles``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.list_fargate_profiles_request
    import aws_sdk_eks.types.list_fargate_profiles_response
...
) -> aws_sdk_eks.types.list_fargate_profiles_response.ListFargateProfilesResponse:
    import aws_sdk_eks.types.list_fargate_profiles_response

    out: aws_sdk_eks.types.list_fargate_profiles_response.ListFargateProfilesResponse = aws_sdk_eks.types.list_fargate_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.list_fargate_profiles_request.ListFargateProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_fargate_profiles(
