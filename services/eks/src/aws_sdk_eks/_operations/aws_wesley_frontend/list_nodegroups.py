"""Generated from Smithy shape ``com.amazonaws.eks#ListNodegroups``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.list_nodegroups_request
    import aws_sdk_eks.types.list_nodegroups_response
...
) -> aws_sdk_eks.types.list_nodegroups_response.ListNodegroupsResponse:
    import aws_sdk_eks.types.list_nodegroups_response

    out: aws_sdk_eks.types.list_nodegroups_response.ListNodegroupsResponse = (
        aws_sdk_eks.types.list_nodegroups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.list_nodegroups_request.ListNodegroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/clusters/{clusterName}/node-groups"
...
def list_nodegroups(
    ...
    aws_sdk_eks.types.list_nodegroups_response.ListNodegroupsResponse, zapros.Response
]:
...
async def async_list_nodegroups(
