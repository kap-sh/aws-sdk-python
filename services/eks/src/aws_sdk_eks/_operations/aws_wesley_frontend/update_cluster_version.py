"""Generated from Smithy shape ``com.amazonaws.eks#UpdateClusterVersion``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.update_cluster_version_request
    import aws_sdk_eks.types.update_cluster_version_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidStateException":
            import aws_sdk_eks.errors.invalid_state_exception

            raise aws_sdk_eks.errors.invalid_state_exception.InvalidStateException.from_json(
                data
            )
...
) -> aws_sdk_eks.types.update_cluster_version_response.UpdateClusterVersionResponse:
    import aws_sdk_eks.types.update_cluster_version_response

    out: aws_sdk_eks.types.update_cluster_version_response.UpdateClusterVersionResponse = aws_sdk_eks.types.update_cluster_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.update_cluster_version_request.UpdateClusterVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/clusters/{name}/updates"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.update_cluster_version_request.serialize_json(input_)
    ).encode()
...
async def async_update_cluster_version(
