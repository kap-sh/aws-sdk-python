...
def build_request(
    ...
    input: aws_sdk_eks.types.update_cluster_version_request.UpdateClusterVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.update_cluster_version_request.serialize_json(input)
    ).encode()
