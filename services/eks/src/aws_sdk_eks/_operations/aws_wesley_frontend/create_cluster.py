"""Generated from Smithy shape ``com.amazonaws.eks#CreateCluster``."""
...
import aws_sdk_eks.types.create_cluster_request
import aws_sdk_eks.types.create_cluster_response
...
) -> aws_sdk_eks.types.create_cluster_response.CreateClusterResponse:
    out: aws_sdk_eks.types.create_cluster_response.CreateClusterResponse = (
        aws_sdk_eks.types.create_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.create_cluster_request.CreateClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.create_cluster_request.serialize_json(input_)
    ).encode()
...
def create_cluster(
    ...
    aws_sdk_eks.types.create_cluster_response.CreateClusterResponse, zapros.Response
]:
