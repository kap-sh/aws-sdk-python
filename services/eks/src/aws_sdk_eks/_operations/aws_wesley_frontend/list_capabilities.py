...
def handle_response(
    ...
    out: aws_sdk_eks.types.list_capabilities_response.ListCapabilitiesResponse = (
        aws_sdk_eks.types.list_capabilities_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.list_capabilities_request.ListCapabilitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
