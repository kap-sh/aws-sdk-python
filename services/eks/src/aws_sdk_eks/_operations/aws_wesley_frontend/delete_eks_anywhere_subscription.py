"""Generated from Smithy shape ``com.amazonaws.eks#DeleteEksAnywhereSubscription``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.delete_eks_anywhere_subscription_request
    import aws_sdk_eks.types.delete_eks_anywhere_subscription_response
...
) -> aws_sdk_eks.types.delete_eks_anywhere_subscription_response.DeleteEksAnywhereSubscriptionResponse:
    import aws_sdk_eks.types.delete_eks_anywhere_subscription_response

    out: aws_sdk_eks.types.delete_eks_anywhere_subscription_response.DeleteEksAnywhereSubscriptionResponse = aws_sdk_eks.types.delete_eks_anywhere_subscription_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.delete_eks_anywhere_subscription_request.DeleteEksAnywhereSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_eks_anywhere_subscription(
