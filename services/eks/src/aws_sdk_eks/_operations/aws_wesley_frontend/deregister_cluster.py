"""Generated from Smithy shape ``com.amazonaws.eks#DeregisterCluster``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.deregister_cluster_request
    import aws_sdk_eks.types.deregister_cluster_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            import aws_sdk_eks.errors.access_denied_exception

            raise aws_sdk_eks.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
...
) -> aws_sdk_eks.types.deregister_cluster_response.DeregisterClusterResponse:
    import aws_sdk_eks.types.deregister_cluster_response

    out: aws_sdk_eks.types.deregister_cluster_response.DeregisterClusterResponse = (
        aws_sdk_eks.types.deregister_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.deregister_cluster_request.DeregisterClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/cluster-registrations/{name}"
...
async def async_deregister_cluster(
