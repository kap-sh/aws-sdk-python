...
def handle_response(
    ...
    out: aws_sdk_eks.types.create_capability_response.CreateCapabilityResponse = (
        aws_sdk_eks.types.create_capability_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.create_capability_request.CreateCapabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.create_capability_request.serialize_json(input_)
    ).encode()
