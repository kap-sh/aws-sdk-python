...
def handle_response(
    ...
    out: aws_sdk_eks.types.create_nodegroup_response.CreateNodegroupResponse = (
        aws_sdk_eks.types.create_nodegroup_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.create_nodegroup_request.CreateNodegroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.create_nodegroup_request.serialize_json(input_)
    ).encode()
...
def create_nodegroup(
    ...
    aws_sdk_eks.types.create_nodegroup_response.CreateNodegroupResponse, zapros.Response
]:
