"""Generated from Smithy shape ``com.amazonaws.eks#AssociateAccessPolicy``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.associate_access_policy_request
    import aws_sdk_eks.types.associate_access_policy_response
...
) -> aws_sdk_eks.types.associate_access_policy_response.AssociateAccessPolicyResponse:
    import aws_sdk_eks.types.associate_access_policy_response

    out: aws_sdk_eks.types.associate_access_policy_response.AssociateAccessPolicyResponse = aws_sdk_eks.types.associate_access_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.associate_access_policy_request.AssociateAccessPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eks.types.associate_access_policy_request.serialize_json(input_)
    ).encode()
...
async def async_associate_access_policy(
