...
def handle_response(
    ...
    out: aws_sdk_eks.types.describe_update_response.DescribeUpdateResponse = (
        aws_sdk_eks.types.describe_update_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_eks.types.describe_update_request.DescribeUpdateRequest,
) -> zapros.Request:
    ...
    url = url.replace("{updateId}", quote(str(input["update_id"]), safe=""))
    params: dict[str, str] = {}
...
def describe_update(
    ...
    aws_sdk_eks.types.describe_update_response.DescribeUpdateResponse, zapros.Response
]:
