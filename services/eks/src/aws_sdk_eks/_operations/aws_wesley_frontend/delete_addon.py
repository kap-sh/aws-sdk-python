...
def build_request(
    ...
    input: aws_sdk_eks.types.delete_addon_request.DeleteAddonRequest,
) -> zapros.Request:
    ...
    url = url.replace("{addonName}", quote(str(input["addon_name"]), safe=""))
    params: dict[str, str] = {}
    params["preserve"] = str(input.get("preserve", False))
