...
if TYPE_CHECKING:
    import aws_sdk_eks.types.list_eks_anywhere_subscriptions_request
    import aws_sdk_eks.types.list_eks_anywhere_subscriptions_response
...
) -> aws_sdk_eks.types.list_eks_anywhere_subscriptions_response.ListEksAnywhereSubscriptionsResponse:
    import aws_sdk_eks.types.list_eks_anywhere_subscriptions_response

    out: aws_sdk_eks.types.list_eks_anywhere_subscriptions_response.ListEksAnywhereSubscriptionsResponse = aws_sdk_eks.types.list_eks_anywhere_subscriptions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_eks.types.list_eks_anywhere_subscriptions_request.ListEksAnywhereSubscriptionsRequest,
) -> zapros.Request:
