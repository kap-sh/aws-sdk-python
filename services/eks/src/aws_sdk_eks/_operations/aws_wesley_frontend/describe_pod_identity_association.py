"""Generated from Smithy shape ``com.amazonaws.eks#DescribePodIdentityAssociation``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.describe_pod_identity_association_request
    import aws_sdk_eks.types.describe_pod_identity_association_response
...
) -> aws_sdk_eks.types.describe_pod_identity_association_response.DescribePodIdentityAssociationResponse:
    import aws_sdk_eks.types.describe_pod_identity_association_response

    out: aws_sdk_eks.types.describe_pod_identity_association_response.DescribePodIdentityAssociationResponse = aws_sdk_eks.types.describe_pod_identity_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.describe_pod_identity_association_request.DescribePodIdentityAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_pod_identity_association(
