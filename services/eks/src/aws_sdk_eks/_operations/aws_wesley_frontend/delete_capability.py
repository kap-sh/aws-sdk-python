...
def handle_response(
    ...
    out: aws_sdk_eks.types.delete_capability_response.DeleteCapabilityResponse = (
        aws_sdk_eks.types.delete_capability_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_eks.types.delete_capability_request.DeleteCapabilityRequest,
) -> zapros.Request:
