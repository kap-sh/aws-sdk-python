"""Generated from Smithy shape ``com.amazonaws.eks#StartInsightsRefresh``."""
...
if TYPE_CHECKING:
    import aws_sdk_eks.types.start_insights_refresh_request
    import aws_sdk_eks.types.start_insights_refresh_response
...
) -> aws_sdk_eks.types.start_insights_refresh_response.StartInsightsRefreshResponse:
    import aws_sdk_eks.types.start_insights_refresh_response

    out: aws_sdk_eks.types.start_insights_refresh_response.StartInsightsRefreshResponse = aws_sdk_eks.types.start_insights_refresh_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_eks.types.start_insights_refresh_request.StartInsightsRefreshRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_start_insights_refresh(
