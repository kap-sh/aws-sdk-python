...
if TYPE_CHECKING:
    import aws_sdk_eks.types.pod_identity_association_summary

PodIdentityAssociationSummaries: TypeAlias = list[
    "aws_sdk_eks.types.pod_identity_association_summary.PodIdentityAssociationSummary"
]
...
def serialize_json(value: PodIdentityAssociationSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_eks.types.pod_identity_association_summary.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> PodIdentityAssociationSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_eks.types.pod_identity_association_summary.deserialize_json(item)
        )
    return out
