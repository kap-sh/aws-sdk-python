"""Generated from Smithy shape ``com.amazonaws.eks#ListNodegroupsRequest``."""
...
class ListNodegroupsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListNodegroupsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListNodegroupsRequest:
    out: ListNodegroupsRequest = {}  # type: ignore[typeddict-item]
    return out
