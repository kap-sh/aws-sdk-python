"""Generated from Smithy shape ``com.amazonaws.eks#UpdateCapabilityResponse``."""
...
class UpdateCapabilityResponse(TypedDict):
    update: NotRequired["aws_sdk_eks.types.update.Update"]


# --- restJson1 ser/de ---
def serialize_json(value: UpdateCapabilityResponse) -> dict:
    out: dict = {}
    if "update" in value:
        import aws_sdk_eks.types.update
...
def deserialize_json(data: dict) -> UpdateCapabilityResponse:
