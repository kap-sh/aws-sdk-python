...
if TYPE_CHECKING:
    import aws_sdk_eks.types.additional_info_map
    import aws_sdk_eks.types.category
    import aws_sdk_eks.types.insight_category_specific_summary
    import aws_sdk_eks.types.insight_resource_details
...
def serialize_json(value: Insight) -> dict:
    ...
    if "additional_info" in value:
        ...
        out["additionalInfo"] = aws_sdk_eks.types.additional_info_map.serialize_json(
            value["additional_info"]
        )
    if "resources" in value:
        import aws_sdk_eks.types.insight_resource_details

        out["resources"] = aws_sdk_eks.types.insight_resource_details.serialize_json(
            value["resources"]
        )
    if "category_specific_summary" in value:
        ...
        out["categorySpecificSummary"] = (
            aws_sdk_eks.types.insight_category_specific_summary.serialize_json(
...
def deserialize_json(data: dict) -> Insight:
    ...
    if "additionalInfo" in data:
        ...
        out["additional_info"] = aws_sdk_eks.types.additional_info_map.deserialize_json(
            data["additionalInfo"]
        )
    if "resources" in data:
        import aws_sdk_eks.types.insight_resource_details

        out["resources"] = aws_sdk_eks.types.insight_resource_details.deserialize_json(
            data["resources"]
        )
    if "categorySpecificSummary" in data:
        ...
        out["category_specific_summary"] = (
            aws_sdk_eks.types.insight_category_specific_summary.deserialize_json(
