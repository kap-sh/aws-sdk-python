...
if TYPE_CHECKING:
    import aws_sdk_eks.types.insights_filter
    import aws_sdk_eks.types.list_insights_max_results
...
class ListInsightsRequest(TypedDict):
    ...
    filter: NotRequired["aws_sdk_eks.types.insights_filter.InsightsFilter"]
    ...
    max_results: NotRequired[
        "aws_sdk_eks.types.list_insights_max_results.ListInsightsMaxResults"
    ]
...
def serialize_json(value: ListInsightsRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["filter"] = aws_sdk_eks.types.insights_filter.serialize_json(
            value["filter"]
        )
...
def deserialize_json(data: dict) -> ListInsightsRequest:
    ...
    if "filter" in data:
        ...
        out["filter"] = aws_sdk_eks.types.insights_filter.deserialize_json(
            data["filter"]
        )
