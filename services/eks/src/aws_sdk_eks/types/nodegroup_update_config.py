...
class NodegroupUpdateConfig(TypedDict):
    ...
    update_strategy: NotRequired[
        "aws_sdk_eks.types.nodegroup_update_strategies.NodegroupUpdateStrategies"
    ]
...
def serialize_json(value: NodegroupUpdateConfig) -> dict:
    ...
    if "update_strategy" in value:
        ...
        out["updateStrategy"] = (
            aws_sdk_eks.types.nodegroup_update_strategies.serialize_json(
...
def deserialize_json(data: dict) -> NodegroupUpdateConfig:
    ...
    if "updateStrategy" in data:
        ...
        out["update_strategy"] = (
            aws_sdk_eks.types.nodegroup_update_strategies.deserialize_json(
                data["updateStrategy"]
            )
        )
    return out
