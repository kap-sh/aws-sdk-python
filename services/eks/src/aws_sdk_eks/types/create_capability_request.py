...
if TYPE_CHECKING:
    import aws_sdk_eks.types.capability_configuration_request
...
class CreateCapabilityRequest(TypedDict):
    ...
    type: "aws_sdk_eks.types.capability_type.CapabilityType"
    ...
    configuration: NotRequired[
        "aws_sdk_eks.types.capability_configuration_request.CapabilityConfigurationRequest"
    ]
    ...
    delete_propagation_policy: "aws_sdk_eks.types.capability_delete_propagation_policy.CapabilityDeletePropagationPolicy"
...
def serialize_json(value: CreateCapabilityRequest) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            aws_sdk_eks.types.capability_configuration_request.serialize_json(
                value["configuration"]
            )
        )
    if "tags" in value:
...
def deserialize_json(data: dict) -> CreateCapabilityRequest:
    ...
    if "configuration" in data:
        ...
        out["configuration"] = (
            aws_sdk_eks.types.capability_configuration_request.deserialize_json(
                data["configuration"]
            )
        )
    if "tags" in data:
