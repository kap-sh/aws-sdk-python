...
class CreateAddonRequest(TypedDict):
...
def serialize_json(value: CreateAddonRequest) -> dict:
    ...
    if "namespace_config" in value:
        ...
        out["namespaceConfig"] = (
            aws_sdk_eks.types.addon_namespace_config_request.serialize_json(
...
def deserialize_json(data: dict) -> CreateAddonRequest:
    ...
    if "namespaceConfig" in data:
        ...
        out["namespace_config"] = (
            aws_sdk_eks.types.addon_namespace_config_request.deserialize_json(
