...
if TYPE_CHECKING:
    import aws_sdk_eks.types.auto_scaling_group_list
    import aws_sdk_eks.types.string


class NodegroupResources(TypedDict):
    auto_scaling_groups: NotRequired[
        "aws_sdk_eks.types.auto_scaling_group_list.AutoScalingGroupList"
    ]
    """<p>The Auto Scaling groups associated with the node group.</p>"""
    remote_access_security_group: NotRequired["aws_sdk_eks.types.string.String"]
...
def serialize_json(value: NodegroupResources) -> dict:
    ...
    if "auto_scaling_groups" in value:
        ...
        out["autoScalingGroups"] = (
            aws_sdk_eks.types.auto_scaling_group_list.serialize_json(
...
def deserialize_json(data: dict) -> NodegroupResources:
    ...
    if "autoScalingGroups" in data:
        ...
        out["auto_scaling_groups"] = (
            aws_sdk_eks.types.auto_scaling_group_list.deserialize_json(
