...
class ClusterVersionInformation(TypedDict):
    ...
    default_platform_version: NotRequired["aws_sdk_eks.types.string.String"]
    ...
    release_date: NotRequired["aws_sdk_eks.types.timestamp.Timestamp"]
    """<p>The release date of this cluster version.</p>"""
    end_of_standard_support_date: NotRequired["aws_sdk_eks.types.timestamp.Timestamp"]
    """<p>Date when standard support ends for this version.</p>"""
    end_of_extended_support_date: NotRequired["aws_sdk_eks.types.timestamp.Timestamp"]
    ...
    kubernetes_patch_version: NotRequired["aws_sdk_eks.types.string.String"]
...
def serialize_json(value: ClusterVersionInformation) -> dict:
    ...
    if "release_date" in value:
        ...
        out["releaseDate"] = aws_sdk_eks.types.timestamp.serialize_json(
            value["release_date"]
        )
    if "end_of_standard_support_date" in value:
        import aws_sdk_eks.types.timestamp

        out["endOfStandardSupportDate"] = aws_sdk_eks.types.timestamp.serialize_json(
            value["end_of_standard_support_date"]
        )
    if "end_of_extended_support_date" in value:
        import aws_sdk_eks.types.timestamp

        out["endOfExtendedSupportDate"] = aws_sdk_eks.types.timestamp.serialize_json(
            value["end_of_extended_support_date"]
        )
    if "status" in value:
        import aws_sdk_eks.types.cluster_version_status

        out["status"] = aws_sdk_eks.types.cluster_version_status.serialize_json(
            value["status"]
        )
    if "version_status" in value:
        import aws_sdk_eks.types.version_status

        out["versionStatus"] = aws_sdk_eks.types.version_status.serialize_json(
...
def deserialize_json(data: dict) -> ClusterVersionInformation:
    ...
    if "releaseDate" in data:
        ...
        out["release_date"] = aws_sdk_eks.types.timestamp.deserialize_json(
            data["releaseDate"]
        )
    if "endOfStandardSupportDate" in data:
        import aws_sdk_eks.types.timestamp

        out["end_of_standard_support_date"] = (
            aws_sdk_eks.types.timestamp.deserialize_json(
    ...
    if "endOfExtendedSupportDate" in data:
        ...
        out["end_of_extended_support_date"] = (
            aws_sdk_eks.types.timestamp.deserialize_json(
    ...
    if "status" in data:
        ...
        out["status"] = aws_sdk_eks.types.cluster_version_status.deserialize_json(
            data["status"]
        )
    if "versionStatus" in data:
        import aws_sdk_eks.types.version_status

        out["version_status"] = aws_sdk_eks.types.version_status.deserialize_json(
            data["versionStatus"]
        )
