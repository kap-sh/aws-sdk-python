"""Generated from Smithy shape ``com.amazonaws.eks#ListAddonsRequest``."""
...
class ListAddonsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListAddonsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListAddonsRequest:
    out: ListAddonsRequest = {}  # type: ignore[typeddict-item]
    return out
