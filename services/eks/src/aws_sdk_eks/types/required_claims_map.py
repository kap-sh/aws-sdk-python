...
if TYPE_CHECKING:
    import aws_sdk_eks.types.required_claims_key
    import aws_sdk_eks.types.required_claims_value

requiredClaimsMap: TypeAlias = dict[
    "aws_sdk_eks.types.required_claims_key.requiredClaimsKey",
    "aws_sdk_eks.types.required_claims_value.requiredClaimsValue",
]
