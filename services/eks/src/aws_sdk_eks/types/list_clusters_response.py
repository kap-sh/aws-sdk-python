...
class ListClustersResponse(TypedDict):
    clusters: NotRequired["aws_sdk_eks.types.string_list.StringList"]
...
def serialize_json(value: ListClustersResponse) -> dict:
    ...
    if "clusters" in value:
        ...
        out["clusters"] = aws_sdk_eks.types.string_list.serialize_json(
            value["clusters"]
        )
...
def deserialize_json(data: dict) -> ListClustersResponse:
    ...
    if "clusters" in data:
        ...
        out["clusters"] = aws_sdk_eks.types.string_list.deserialize_json(
            data["clusters"]
        )
