...
from aws_sdk_eks._pagination import resolve_path as _resolve_path
...
from aws_sdk_eks._services._pipeline import (
    AsyncInterceptor,
...
if TYPE_CHECKING:
    ...
    import aws_sdk_eks.types.addon_info
    import aws_sdk_eks.types.addon_namespace_config_request
    ...
    import aws_sdk_eks.types.create_access_entry_request
    import aws_sdk_eks.types.create_access_entry_response
    import aws_sdk_eks.types.create_addon_request
    import aws_sdk_eks.types.create_addon_response
    import aws_sdk_eks.types.create_capability_request
    import aws_sdk_eks.types.create_capability_response
    import aws_sdk_eks.types.create_cluster_request
    import aws_sdk_eks.types.create_cluster_response
    import aws_sdk_eks.types.create_eks_anywhere_subscription_request
    import aws_sdk_eks.types.create_eks_anywhere_subscription_response
    import aws_sdk_eks.types.create_fargate_profile_request
    import aws_sdk_eks.types.create_fargate_profile_response
    import aws_sdk_eks.types.create_nodegroup_request
    import aws_sdk_eks.types.create_nodegroup_response
    import aws_sdk_eks.types.create_pod_identity_association_request
    import aws_sdk_eks.types.create_pod_identity_association_response
    ...
    import aws_sdk_eks.types.delete_capability_request
    import aws_sdk_eks.types.delete_capability_response
    ...
    import aws_sdk_eks.types.delete_fargate_profile_request
    import aws_sdk_eks.types.delete_fargate_profile_response
    import aws_sdk_eks.types.delete_nodegroup_request
    import aws_sdk_eks.types.delete_nodegroup_response
    ...
    import aws_sdk_eks.types.describe_access_entry_request
    import aws_sdk_eks.types.describe_access_entry_response
    ...
    import aws_sdk_eks.types.describe_capability_request
    import aws_sdk_eks.types.describe_capability_response
    import aws_sdk_eks.types.describe_cluster_request
    import aws_sdk_eks.types.describe_cluster_response
    ...
    import aws_sdk_eks.types.describe_insight_request
    import aws_sdk_eks.types.describe_insight_response
    ...
    import aws_sdk_eks.types.describe_update_request
    import aws_sdk_eks.types.describe_update_response
    import aws_sdk_eks.types.disassociate_access_policy_request
    import aws_sdk_eks.types.disassociate_access_policy_response
    import aws_sdk_eks.types.disassociate_identity_provider_config_request
    import aws_sdk_eks.types.disassociate_identity_provider_config_response
    import aws_sdk_eks.types.eks_anywhere_subscription
    import aws_sdk_eks.types.eks_anywhere_subscription_license_type
    import aws_sdk_eks.types.eks_anywhere_subscription_name
    ...
    import aws_sdk_eks.types.fargate_profiles_request_max_results
    ...
    import aws_sdk_eks.types.list_access_policies_request
    import aws_sdk_eks.types.list_access_policies_request_max_results
    import aws_sdk_eks.types.list_access_policies_response
    import aws_sdk_eks.types.list_addons_request
    import aws_sdk_eks.types.list_addons_request_max_results
    import aws_sdk_eks.types.list_addons_response
    import aws_sdk_eks.types.list_associated_access_policies_request
    import aws_sdk_eks.types.list_associated_access_policies_request_max_results
    import aws_sdk_eks.types.list_associated_access_policies_response
    import aws_sdk_eks.types.list_capabilities_request
    import aws_sdk_eks.types.list_capabilities_request_max_results
    import aws_sdk_eks.types.list_capabilities_response
    import aws_sdk_eks.types.list_clusters_request
    import aws_sdk_eks.types.list_clusters_request_max_results
    ...
    import aws_sdk_eks.types.list_insights_request
    import aws_sdk_eks.types.list_insights_response
    import aws_sdk_eks.types.list_nodegroups_request
    import aws_sdk_eks.types.list_nodegroups_request_max_results
    import aws_sdk_eks.types.list_nodegroups_response
    import aws_sdk_eks.types.list_pod_identity_associations_max_results
    import aws_sdk_eks.types.list_pod_identity_associations_request
    import aws_sdk_eks.types.list_pod_identity_associations_response
    import aws_sdk_eks.types.list_tags_for_resource_request
    import aws_sdk_eks.types.list_tags_for_resource_response
    ...
    import aws_sdk_eks.types.register_cluster_request
    import aws_sdk_eks.types.register_cluster_response
    ...
    import aws_sdk_eks.types.tag_key_list
    import aws_sdk_eks.types.tag_map
    import aws_sdk_eks.types.tag_resource_request
    import aws_sdk_eks.types.tag_resource_response
    import aws_sdk_eks.types.taints_list
    import aws_sdk_eks.types.untag_resource_request
    import aws_sdk_eks.types.untag_resource_response
    ...
    import aws_sdk_eks.types.update_addon_request
    import aws_sdk_eks.types.update_addon_response
    import aws_sdk_eks.types.update_capability_configuration
    import aws_sdk_eks.types.update_capability_request
    import aws_sdk_eks.types.update_capability_response
    ...
    import aws_sdk_eks.types.update_pod_identity_association_request
    import aws_sdk_eks.types.update_pod_identity_association_response
...
class AsyncEKSClientConfig(TypedDict, total=False):
...
class AsyncEKSClient:
    ...
    def __init__(
        ...
        self.config = AsyncEKSClientConfig(
            {
    ...
    async def associate_access_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.associate_access_policy_request.AssociateAccessPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.associate_access_policy_response.AssociateAccessPolicyResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.associate_access_policy

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.associate_access_policy.async_associate_access_policy(
    ...
    async def associate_encryption_config(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        client_request_token: Optional["aws_sdk_eks.types.string.String"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.associate_encryption_config_request.AssociateEncryptionConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.associate_encryption_config_response.AssociateEncryptionConfigResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.associate_encryption_config

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.associate_encryption_config.async_associate_encryption_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_identity_provider_config(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        tags: Optional["aws_sdk_eks.types.tag_map.TagMap"] = None,
        client_request_token: Optional["aws_sdk_eks.types.string.String"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.associate_identity_provider_config_request.AssociateIdentityProviderConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.associate_identity_provider_config_response.AssociateIdentityProviderConfigResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.associate_identity_provider_config

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.associate_identity_provider_config.async_associate_identity_provider_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_access_entry(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        kubernetes_groups: Optional["aws_sdk_eks.types.string_list.StringList"] = None,
        tags: Optional["aws_sdk_eks.types.tag_map.TagMap"] = None,
        client_request_token: Optional["aws_sdk_eks.types.string.String"] = None,
        username: Optional["aws_sdk_eks.types.string.String"] = None,
        type: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "aws_sdk_eks.types.create_access_entry_response.CreateAccessEntryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.create_access_entry_request.CreateAccessEntryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.create_access_entry_response.CreateAccessEntryResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.create_access_entry

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.create_access_entry.async_create_access_entry(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_addon(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        addon_version: Optional["aws_sdk_eks.types.string.String"] = None,
        service_account_role_arn: Optional["aws_sdk_eks.types.role_arn.RoleArn"] = None,
        resolve_conflicts: Optional[
            "aws_sdk_eks.types.resolve_conflicts.ResolveConflicts"
        ] = None,
        client_request_token: Optional["aws_sdk_eks.types.string.String"] = None,
        tags: Optional["aws_sdk_eks.types.tag_map.TagMap"] = None,
        configuration_values: Optional["aws_sdk_eks.types.string.String"] = None,
        ...
        namespace_config: Optional[
            "aws_sdk_eks.types.addon_namespace_config_request.AddonNamespaceConfigRequest"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.create_addon_request.CreateAddonRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.create_addon_response.CreateAddonResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.create_addon

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.create_addon.async_create_addon(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_capability(
        ...
        *,
        ...
        tags: Optional["aws_sdk_eks.types.tag_map.TagMap"] = None,
    ) -> "aws_sdk_eks.types.create_capability_response.CreateCapabilityResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.create_capability_request.CreateCapabilityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.create_capability_response.CreateCapabilityResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.create_capability

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.create_capability.async_create_capability(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.create_cluster_request.CreateClusterRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.create_cluster_response.CreateClusterResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.create_cluster

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.create_cluster.async_create_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_eks_anywhere_subscription(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        license_quantity: Optional["aws_sdk_eks.types.integer.Integer"] = None,
        license_type: Optional[
            "aws_sdk_eks.types.eks_anywhere_subscription_license_type.EksAnywhereSubscriptionLicenseType"
        ] = None,
        auto_renew: Optional["aws_sdk_eks.types.boolean.Boolean"] = None,
        client_request_token: Optional["aws_sdk_eks.types.string.String"] = None,
        tags: Optional["aws_sdk_eks.types.tag_map.TagMap"] = None,
    ) -> "aws_sdk_eks.types.create_eks_anywhere_subscription_response.CreateEksAnywhereSubscriptionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.create_eks_anywhere_subscription_request.CreateEksAnywhereSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.create_eks_anywhere_subscription_response.CreateEksAnywhereSubscriptionResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.create_eks_anywhere_subscription

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.create_eks_anywhere_subscription.async_create_eks_anywhere_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_fargate_profile(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        subnets: Optional["aws_sdk_eks.types.string_list.StringList"] = None,
        selectors: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.create_fargate_profile_request.CreateFargateProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.create_fargate_profile_response.CreateFargateProfileResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.create_fargate_profile

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.create_fargate_profile.async_create_fargate_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_nodegroup(
        ...
        subnets: "aws_sdk_eks.types.string_list.StringList",
        node_role: "aws_sdk_eks.types.string.String",
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        scaling_config: Optional[
            "aws_sdk_eks.types.nodegroup_scaling_config.NodegroupScalingConfig"
        ] = None,
        disk_size: Optional["aws_sdk_eks.types.boxed_integer.BoxedInteger"] = None,
        instance_types: Optional["aws_sdk_eks.types.string_list.StringList"] = None,
        ami_type: Optional["aws_sdk_eks.types.ami_types.AMITypes"] = None,
        remote_access: Optional[
            "aws_sdk_eks.types.remote_access_config.RemoteAccessConfig"
        ] = None,
        labels: Optional["aws_sdk_eks.types.labels_map.labelsMap"] = None,
        taints: Optional["aws_sdk_eks.types.taints_list.taintsList"] = None,
        tags: Optional["aws_sdk_eks.types.tag_map.TagMap"] = None,
        client_request_token: Optional["aws_sdk_eks.types.string.String"] = None,
        ...
        capacity_type: Optional[
            "aws_sdk_eks.types.capacity_types.CapacityTypes"
        ] = None,
        version: Optional["aws_sdk_eks.types.string.String"] = None,
        release_version: Optional["aws_sdk_eks.types.string.String"] = None,
        warm_pool_config: Optional[
            "aws_sdk_eks.types.warm_pool_config.WarmPoolConfig"
        ] = None,
    ) -> "aws_sdk_eks.types.create_nodegroup_response.CreateNodegroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.create_nodegroup_request.CreateNodegroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.create_nodegroup_response.CreateNodegroupResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.create_nodegroup

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.create_nodegroup.async_create_nodegroup(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_pod_identity_association(
        ...
        *,
        ...
        target_role_arn: Optional["aws_sdk_eks.types.string.String"] = None,
        policy: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "aws_sdk_eks.types.create_pod_identity_association_response.CreatePodIdentityAssociationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.create_pod_identity_association_request.CreatePodIdentityAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.create_pod_identity_association_response.CreatePodIdentityAssociationResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.create_pod_identity_association

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.create_pod_identity_association.async_create_pod_identity_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_access_entry(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.delete_access_entry_request.DeleteAccessEntryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.delete_access_entry_response.DeleteAccessEntryResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.delete_access_entry

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.delete_access_entry.async_delete_access_entry(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_addon(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        preserve: Optional["aws_sdk_eks.types.boolean.Boolean"] = None,
    ) -> "aws_sdk_eks.types.delete_addon_response.DeleteAddonResponse":
        """<p>Deletes an Amazon EKS add-on.</p> <p>When you remove an add-on, it's deleted from the cluster. You can always manually start an add-on on the cluster using the Kubernetes API.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.delete_addon_request.DeleteAddonRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.delete_addon_response.DeleteAddonResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.delete_addon

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.delete_addon.async_delete_addon(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_capability(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
    ) -> "aws_sdk_eks.types.delete_capability_response.DeleteCapabilityResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.delete_capability_request.DeleteCapabilityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.delete_capability_response.DeleteCapabilityResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.delete_capability

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.delete_capability.async_delete_capability(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.delete_cluster_request.DeleteClusterRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.delete_cluster_response.DeleteClusterResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.delete_cluster

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.delete_cluster.async_delete_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_eks_anywhere_subscription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.delete_eks_anywhere_subscription_request.DeleteEksAnywhereSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.delete_eks_anywhere_subscription_response.DeleteEksAnywhereSubscriptionResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.delete_eks_anywhere_subscription

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.delete_eks_anywhere_subscription.async_delete_eks_anywhere_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_fargate_profile(
        ...
        *,
        ...
        "aws_sdk_eks.types.delete_fargate_profile_response.DeleteFargateProfileResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.delete_fargate_profile_request.DeleteFargateProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.delete_fargate_profile_response.DeleteFargateProfileResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.delete_fargate_profile

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.delete_fargate_profile.async_delete_fargate_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_nodegroup(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
    ) -> "aws_sdk_eks.types.delete_nodegroup_response.DeleteNodegroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.delete_nodegroup_request.DeleteNodegroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.delete_nodegroup_response.DeleteNodegroupResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.delete_nodegroup

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.delete_nodegroup.async_delete_nodegroup(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_pod_identity_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.delete_pod_identity_association_request.DeletePodIdentityAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.delete_pod_identity_association_response.DeletePodIdentityAssociationResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.delete_pod_identity_association

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.delete_pod_identity_association.async_delete_pod_identity_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_cluster(
        ...
        *,
        ...
        """<p>Deregisters a connected cluster to remove it from the Amazon EKS control plane.</p> <p>A connected cluster is a Kubernetes cluster that you've connected to your control plane using the <a href=\"https://docs.aws.amazon.com/eks/latest/userguide/eks-connector.html\">Amazon EKS Connector</a>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.deregister_cluster_request.DeregisterClusterRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.deregister_cluster_response.DeregisterClusterResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.deregister_cluster

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.deregister_cluster.async_deregister_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_access_entry(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
    ) -> "aws_sdk_eks.types.describe_access_entry_response.DescribeAccessEntryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_access_entry_request.DescribeAccessEntryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_access_entry_response.DescribeAccessEntryResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_access_entry

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_access_entry.async_describe_access_entry(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_addon(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_addon_request.DescribeAddonRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_addon_response.DescribeAddonResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_addon

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_addon.async_describe_addon(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_addon_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_addon_configuration_request.DescribeAddonConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_addon_configuration_response.DescribeAddonConfigurationResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_addon_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_addon_configuration.async_describe_addon_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_addon_versions(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        kubernetes_version: Optional["aws_sdk_eks.types.string.String"] = None,
        max_results: Optional[
            "aws_sdk_eks.types.describe_addon_versions_request_max_results.DescribeAddonVersionsRequestMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
        addon_name: Optional["aws_sdk_eks.types.string.String"] = None,
        types: Optional["aws_sdk_eks.types.string_list.StringList"] = None,
        publishers: Optional["aws_sdk_eks.types.string_list.StringList"] = None,
        owners: Optional["aws_sdk_eks.types.string_list.StringList"] = None,
    ) -> "aws_sdk_eks.types.describe_addon_versions_response.DescribeAddonVersionsResponse":
        """<p>Describes the versions for an add-on.</p> <p>Information such as the Kubernetes versions that you can use the add-on with, the <code>owner</code>, <code>publisher</code>, and the <code>type</code> of the add-on are returned.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_addon_versions_request.DescribeAddonVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_addon_versions_response.DescribeAddonVersionsResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_addon_versions

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_addon_versions.async_describe_addon_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_addon_versions(
        ...
        *,
        ...
        publishers: Optional["aws_sdk_eks.types.string_list.StringList"] = None,
        owners: Optional["aws_sdk_eks.types.string_list.StringList"] = None,
    ) -> "AsyncIterator[aws_sdk_eks.types.addon_info.AddonInfo]":
        _token = next_token
        while True:
    ...
    async def describe_capability(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
    ) -> "aws_sdk_eks.types.describe_capability_response.DescribeCapabilityResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_capability_request.DescribeCapabilityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_capability_response.DescribeCapabilityResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_capability

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_capability.async_describe_capability(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_cluster_request.DescribeClusterRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_cluster_response.DescribeClusterResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_cluster

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_cluster.async_describe_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_cluster_versions(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        cluster_type: Optional["aws_sdk_eks.types.string.String"] = None,
        max_results: Optional[
            "aws_sdk_eks.types.describe_cluster_version_max_results.DescribeClusterVersionMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
        default_only: Optional["aws_sdk_eks.types.boxed_boolean.BoxedBoolean"] = None,
        include_all: Optional["aws_sdk_eks.types.boxed_boolean.BoxedBoolean"] = None,
        cluster_versions: Optional["aws_sdk_eks.types.string_list.StringList"] = None,
        status: Optional[
            "aws_sdk_eks.types.cluster_version_status.ClusterVersionStatus"
        ] = None,
        version_status: Optional[
            "aws_sdk_eks.types.version_status.VersionStatus"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_cluster_versions_request.DescribeClusterVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_cluster_versions_response.DescribeClusterVersionsResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_cluster_versions

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_cluster_versions.async_describe_cluster_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_eks.types.cluster_version_information.ClusterVersionInformation]":
        _token = next_token
        while True:
    ...
    async def describe_eks_anywhere_subscription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_eks_anywhere_subscription_request.DescribeEksAnywhereSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_eks_anywhere_subscription_response.DescribeEksAnywhereSubscriptionResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_eks_anywhere_subscription

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_eks_anywhere_subscription.async_describe_eks_anywhere_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_fargate_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_fargate_profile_request.DescribeFargateProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_fargate_profile_response.DescribeFargateProfileResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_fargate_profile

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_fargate_profile.async_describe_fargate_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_identity_provider_config(
        self,
        cluster_name: "aws_sdk_eks.types.string.String",
        identity_provider_config: "aws_sdk_eks.types.identity_provider_config.IdentityProviderConfig",
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_identity_provider_config_request.DescribeIdentityProviderConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_identity_provider_config_response.DescribeIdentityProviderConfigResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_identity_provider_config

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_identity_provider_config.async_describe_identity_provider_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_insight(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
    ) -> "aws_sdk_eks.types.describe_insight_response.DescribeInsightResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_insight_request.DescribeInsightRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_insight_response.DescribeInsightResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_insight

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_insight.async_describe_insight(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_insights_refresh(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_insights_refresh_request.DescribeInsightsRefreshRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_insights_refresh_response.DescribeInsightsRefreshResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_insights_refresh

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_insights_refresh.async_describe_insights_refresh(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_nodegroup(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_nodegroup_request.DescribeNodegroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_nodegroup_response.DescribeNodegroupResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_nodegroup

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_nodegroup.async_describe_nodegroup(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_pod_identity_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_pod_identity_association_request.DescribePodIdentityAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_pod_identity_association_response.DescribePodIdentityAssociationResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_pod_identity_association

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_pod_identity_association.async_describe_pod_identity_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_update(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        nodegroup_name: Optional["aws_sdk_eks.types.string.String"] = None,
        addon_name: Optional["aws_sdk_eks.types.string.String"] = None,
        capability_name: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "aws_sdk_eks.types.describe_update_response.DescribeUpdateResponse":
        """<p>Describes an update to an Amazon EKS resource.</p> <p>When the status of the update is <code>Successful</code>, the update is complete. If an update fails, the status is <code>Failed</code>, and an error detail explains the reason for the failure.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.describe_update_request.DescribeUpdateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.describe_update_response.DescribeUpdateResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.describe_update

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.describe_update.async_describe_update(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_access_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.disassociate_access_policy_request.DisassociateAccessPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.disassociate_access_policy_response.DisassociateAccessPolicyResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.disassociate_access_policy

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.disassociate_access_policy.async_disassociate_access_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_identity_provider_config(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        client_request_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "aws_sdk_eks.types.disassociate_identity_provider_config_response.DisassociateIdentityProviderConfigResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.disassociate_identity_provider_config_request.DisassociateIdentityProviderConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.disassociate_identity_provider_config_response.DisassociateIdentityProviderConfigResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.disassociate_identity_provider_config

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.disassociate_identity_provider_config.async_disassociate_identity_provider_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_access_entries(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        associated_policy_arn: Optional["aws_sdk_eks.types.string.String"] = None,
        max_results: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_access_entries_request.ListAccessEntriesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_access_entries_response.ListAccessEntriesResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_access_entries

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_access_entries.async_list_access_entries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_access_entries(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "AsyncIterator[aws_sdk_eks.types.string.String]":
        _token = next_token
        while True:
    ...
    async def list_access_policies(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "aws_sdk_eks.types.list_access_policies_response.ListAccessPoliciesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_access_policies_request.ListAccessPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_access_policies_response.ListAccessPoliciesResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_access_policies

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_access_policies.async_list_access_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_access_policies(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "AsyncIterator[aws_sdk_eks.types.access_policy.AccessPolicy]":
        _token = next_token
        while True:
    ...
    async def list_addons(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        max_results: Optional[
            "aws_sdk_eks.types.list_addons_request_max_results.ListAddonsRequestMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "aws_sdk_eks.types.list_addons_response.ListAddonsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_addons_request.ListAddonsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_addons_response.ListAddonsResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_addons

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_addons.async_list_addons(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_associated_access_policies(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        max_results: Optional[
            "aws_sdk_eks.types.list_associated_access_policies_request_max_results.ListAssociatedAccessPoliciesRequestMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_associated_access_policies_request.ListAssociatedAccessPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_associated_access_policies_response.ListAssociatedAccessPoliciesResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_associated_access_policies

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_associated_access_policies.async_list_associated_access_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_associated_access_policies(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "AsyncIterator[aws_sdk_eks.types.associated_access_policy.AssociatedAccessPolicy]":
        _token = next_token
        while True:
    ...
    async def list_capabilities(
        ...
        *,
    ...
    ) -> "aws_sdk_eks.types.list_capabilities_response.ListCapabilitiesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_capabilities_request.ListCapabilitiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_capabilities_response.ListCapabilitiesResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_capabilities

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_capabilities.async_list_capabilities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_eks.types.capability_summary.CapabilitySummary]":
        _token = next_token
        while True:
    ...
    async def list_clusters(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        max_results: Optional[
            "aws_sdk_eks.types.list_clusters_request_max_results.ListClustersRequestMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
        include: Optional[
            "aws_sdk_eks.types.include_clusters_list.IncludeClustersList"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_clusters_request.ListClustersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_clusters_response.ListClustersResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_clusters

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_clusters.async_list_clusters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_eks_anywhere_subscriptions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_eks_anywhere_subscriptions_request.ListEksAnywhereSubscriptionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_eks_anywhere_subscriptions_response.ListEksAnywhereSubscriptionsResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_eks_anywhere_subscriptions

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_eks_anywhere_subscriptions.async_list_eks_anywhere_subscriptions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_eks.types.eks_anywhere_subscription.EksAnywhereSubscription]":
        _token = next_token
        while True:
    ...
    async def list_fargate_profiles(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        max_results: Optional[
            "aws_sdk_eks.types.fargate_profiles_request_max_results.FargateProfilesRequestMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_fargate_profiles_request.ListFargateProfilesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_fargate_profiles_response.ListFargateProfilesResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_fargate_profiles

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_fargate_profiles.async_list_fargate_profiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_identity_provider_configs(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        max_results: Optional[
            "aws_sdk_eks.types.list_identity_provider_configs_request_max_results.ListIdentityProviderConfigsRequestMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_identity_provider_configs_request.ListIdentityProviderConfigsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_identity_provider_configs_response.ListIdentityProviderConfigsResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_identity_provider_configs

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_identity_provider_configs.async_list_identity_provider_configs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_identity_provider_configs(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "AsyncIterator[aws_sdk_eks.types.identity_provider_config.IdentityProviderConfig]":
        _token = next_token
        while True:
    ...
    async def list_insights(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        filter: Optional["aws_sdk_eks.types.insights_filter.InsightsFilter"] = None,
        max_results: Optional[
            "aws_sdk_eks.types.list_insights_max_results.ListInsightsMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "aws_sdk_eks.types.list_insights_response.ListInsightsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_insights_request.ListInsightsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_insights_response.ListInsightsResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_insights

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_insights.async_list_insights(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_insights(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "AsyncIterator[aws_sdk_eks.types.insight_summary.InsightSummary]":
        _token = next_token
        while True:
    ...
    async def list_nodegroups(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        max_results: Optional[
            "aws_sdk_eks.types.list_nodegroups_request_max_results.ListNodegroupsRequestMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_nodegroups_request.ListNodegroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_nodegroups_response.ListNodegroupsResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_nodegroups

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_nodegroups.async_list_nodegroups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_pod_identity_associations(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        namespace: Optional["aws_sdk_eks.types.string.String"] = None,
        service_account: Optional["aws_sdk_eks.types.string.String"] = None,
        max_results: Optional[
            "aws_sdk_eks.types.list_pod_identity_associations_max_results.ListPodIdentityAssociationsMaxResults"
        ] = None,
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "aws_sdk_eks.types.list_pod_identity_associations_response.ListPodIdentityAssociationsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_pod_identity_associations_request.ListPodIdentityAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_pod_identity_associations_response.ListPodIdentityAssociationsResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_pod_identity_associations

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_pod_identity_associations.async_list_pod_identity_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_pod_identity_associations(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "AsyncIterator[aws_sdk_eks.types.pod_identity_association_summary.PodIdentityAssociationSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        "aws_sdk_eks.types.list_tags_for_resource_response.ListTagsForResourceResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_tags_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_updates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.list_updates_request.ListUpdatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.list_updates_response.ListUpdatesResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.list_updates

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.list_updates.async_list_updates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_cluster(
        self,
        name: "aws_sdk_eks.types.cluster_name.ClusterName",
        connector_config: "aws_sdk_eks.types.connector_config_request.ConnectorConfigRequest",
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        client_request_token: Optional["aws_sdk_eks.types.string.String"] = None,
        tags: Optional["aws_sdk_eks.types.tag_map.TagMap"] = None,
    ) -> "aws_sdk_eks.types.register_cluster_response.RegisterClusterResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.register_cluster_request.RegisterClusterRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.register_cluster_response.RegisterClusterResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.register_cluster

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.register_cluster.async_register_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_insights_refresh(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.start_insights_refresh_request.StartInsightsRefreshRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.start_insights_refresh_response.StartInsightsRefreshResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.start_insights_refresh

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.start_insights_refresh.async_start_insights_refresh(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
    ) -> "aws_sdk_eks.types.tag_resource_response.TagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.tag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        self,
        resource_arn: "aws_sdk_eks.types.string.String",
        tag_keys: "aws_sdk_eks.types.tag_key_list.TagKeyList",
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
    ) -> "aws_sdk_eks.types.untag_resource_response.UntagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.untag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_access_entry(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.update_access_entry_request.UpdateAccessEntryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.update_access_entry_response.UpdateAccessEntryResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.update_access_entry

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.update_access_entry.async_update_access_entry(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_addon(
        ...
        *,
    ...
    ) -> "aws_sdk_eks.types.update_addon_response.UpdateAddonResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.update_addon_request.UpdateAddonRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.update_addon_response.UpdateAddonResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.update_addon

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.update_addon.async_update_addon(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_capability(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        role_arn: Optional["aws_sdk_eks.types.string.String"] = None,
        configuration: Optional[
    ...
    ) -> "aws_sdk_eks.types.update_capability_response.UpdateCapabilityResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.update_capability_request.UpdateCapabilityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.update_capability_response.UpdateCapabilityResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.update_capability

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.update_capability.async_update_capability(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cluster_config(
        ...
        *,
        ...
        resources_vpc_config: Optional[
            "aws_sdk_eks.types.vpc_config_request.VpcConfigRequest"
        ] = None,
        logging: Optional["aws_sdk_eks.types.logging.Logging"] = None,
        client_request_token: Optional["aws_sdk_eks.types.string.String"] = None,
        access_config: Optional[
            "aws_sdk_eks.types.update_access_config_request.UpdateAccessConfigRequest"
        ] = None,
        upgrade_policy: Optional[
            "aws_sdk_eks.types.upgrade_policy_request.UpgradePolicyRequest"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.update_cluster_config_request.UpdateClusterConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.update_cluster_config_response.UpdateClusterConfigResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.update_cluster_config

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.update_cluster_config.async_update_cluster_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cluster_version(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        client_request_token: Optional["aws_sdk_eks.types.string.String"] = None,
        force: Optional["aws_sdk_eks.types.boolean.Boolean"] = None,
    ) -> (
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.update_cluster_version_request.UpdateClusterVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.update_cluster_version_response.UpdateClusterVersionResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.update_cluster_version

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.update_cluster_version.async_update_cluster_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_eks_anywhere_subscription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.update_eks_anywhere_subscription_request.UpdateEksAnywhereSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.update_eks_anywhere_subscription_response.UpdateEksAnywhereSubscriptionResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.update_eks_anywhere_subscription

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.update_eks_anywhere_subscription.async_update_eks_anywhere_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_nodegroup_config(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        labels: Optional[
            "aws_sdk_eks.types.update_labels_payload.UpdateLabelsPayload"
        ] = None,
        taints: Optional[
            "aws_sdk_eks.types.update_taints_payload.UpdateTaintsPayload"
        ] = None,
        scaling_config: Optional[
            "aws_sdk_eks.types.nodegroup_scaling_config.NodegroupScalingConfig"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.update_nodegroup_config_request.UpdateNodegroupConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.update_nodegroup_config_response.UpdateNodegroupConfigResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.update_nodegroup_config

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.update_nodegroup_config.async_update_nodegroup_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_nodegroup_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.update_nodegroup_version_request.UpdateNodegroupVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.update_nodegroup_version_response.UpdateNodegroupVersionResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.update_nodegroup_version

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.update_nodegroup_version.async_update_nodegroup_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_pod_identity_association(
        ...
        *,
        ...
        target_role_arn: Optional["aws_sdk_eks.types.string.String"] = None,
        policy: Optional["aws_sdk_eks.types.string.String"] = None,
    ) -> "aws_sdk_eks.types.update_pod_identity_association_response.UpdatePodIdentityAssociationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_eks.types.update_pod_identity_association_request.UpdatePodIdentityAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_eks.types.update_pod_identity_association_response.UpdatePodIdentityAssociationResponse"
        ]:
            import aws_sdk_eks._operations.aws_wesley_frontend.update_pod_identity_association

            (
                output,
                http_response,
            ) = await aws_sdk_eks._operations.aws_wesley_frontend.update_pod_identity_association.async_update_pod_identity_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
