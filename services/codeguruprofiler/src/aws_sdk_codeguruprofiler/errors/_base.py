...
class CodeGuruProfilerError(Exception):
    """Base class for all CodeGuruProfiler service errors."""


class ServiceError(CodeGuruProfilerError):
...
class SerializationError(CodeGuruProfilerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CodeGuruProfilerError):
...
class WaiterFailedError(CodeGuruProfilerError):
...
class WaiterTimeoutError(CodeGuruProfilerError):
