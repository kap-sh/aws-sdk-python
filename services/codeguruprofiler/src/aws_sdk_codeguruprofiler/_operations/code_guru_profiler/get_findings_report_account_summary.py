...
def build_request(
    ...
    input: aws_sdk_codeguruprofiler.types.get_findings_report_account_summary_request.GetFindingsReportAccountSummaryRequest,
) -> zapros.Request:
    ...
    if "daily_reports_only" in input:
        params["dailyReportsOnly"] = str(input["daily_reports_only"])
