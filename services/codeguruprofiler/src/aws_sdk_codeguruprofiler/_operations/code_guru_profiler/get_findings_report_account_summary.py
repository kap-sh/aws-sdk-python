"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#GetFindingsReportAccountSummary``."""
...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.get_findings_report_account_summary_response.GetFindingsReportAccountSummaryResponse = aws_sdk_codeguruprofiler.types.get_findings_report_account_summary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.get_findings_report_account_summary_request.GetFindingsReportAccountSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/internal/findingsReports"
    params: dict[str, str] = {}
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "max_results" in input_:
        params["maxResults"] = str(input_["max_results"])
    if "daily_reports_only" in input_:
        params["dailyReportsOnly"] = str(input_["daily_reports_only"])
...
async def async_get_findings_report_account_summary(
