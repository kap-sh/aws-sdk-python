...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.get_policy_response.GetPolicyResponse = (
        aws_sdk_codeguruprofiler.types.get_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.get_policy_request.GetPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
