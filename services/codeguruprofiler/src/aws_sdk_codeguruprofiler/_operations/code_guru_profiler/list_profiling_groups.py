...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.list_profiling_groups_response.ListProfilingGroupsResponse = aws_sdk_codeguruprofiler.types.list_profiling_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.list_profiling_groups_request.ListProfilingGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "include_description" in input_:
        params["includeDescription"] = str(input_["include_description"])
