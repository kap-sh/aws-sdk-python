...
def build_request(
    ...
    input: aws_sdk_codeguruprofiler.types.list_profiling_groups_request.ListProfilingGroupsRequest,
) -> zapros.Request:
    ...
    if "include_description" in input:
        params["includeDescription"] = str(input["include_description"])
