...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.batch_get_frame_metric_data_response.BatchGetFrameMetricDataResponse = aws_sdk_codeguruprofiler.types.batch_get_frame_metric_data_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_codeguruprofiler.types.batch_get_frame_metric_data_request.BatchGetFrameMetricDataRequest,
) -> zapros.Request:
    ...
    if "target_resolution" in input:
        params["targetResolution"] = str(input["target_resolution"])
