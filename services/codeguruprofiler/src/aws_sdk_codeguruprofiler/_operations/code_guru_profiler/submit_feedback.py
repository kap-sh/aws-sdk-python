...
def build_request(
    ...
    input: aws_sdk_codeguruprofiler.types.submit_feedback_request.SubmitFeedbackRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{anomalyInstanceId}", quote(str(input["anomaly_instance_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeguruprofiler.types.submit_feedback_request.serialize_json(input)
    ).encode()
