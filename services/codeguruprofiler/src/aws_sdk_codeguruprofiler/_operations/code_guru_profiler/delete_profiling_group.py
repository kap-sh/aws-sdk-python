...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.delete_profiling_group_response.DeleteProfilingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.delete_profiling_group_request.DeleteProfilingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
