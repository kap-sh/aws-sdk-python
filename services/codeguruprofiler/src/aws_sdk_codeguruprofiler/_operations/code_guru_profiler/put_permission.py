...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.put_permission_response.PutPermissionResponse = aws_sdk_codeguruprofiler.types.put_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.put_permission_request.PutPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeguruprofiler.types.put_permission_request.serialize_json(input_)
    ).encode()
