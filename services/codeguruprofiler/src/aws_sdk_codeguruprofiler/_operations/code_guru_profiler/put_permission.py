...
def build_request(
    ...
    input: aws_sdk_codeguruprofiler.types.put_permission_request.PutPermissionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeguruprofiler.types.put_permission_request.serialize_json(input)
    ).encode()
