"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#RemovePermission``."""
...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.remove_permission_response.RemovePermissionResponse = aws_sdk_codeguruprofiler.types.remove_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.remove_permission_request.RemovePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{actionGroup}", quote(str(input_["action_group"]), safe=""))
    params: dict[str, str] = {}
