...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.describe_profiling_group_response.DescribeProfilingGroupResponse = {
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.describe_profiling_group_request.DescribeProfilingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
