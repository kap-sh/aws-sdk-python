...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.list_findings_reports_response.ListFindingsReportsResponse = aws_sdk_codeguruprofiler.types.list_findings_reports_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.list_findings_reports_request.ListFindingsReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
