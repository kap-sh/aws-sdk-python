...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.add_notification_channels_response.AddNotificationChannelsResponse = aws_sdk_codeguruprofiler.types.add_notification_channels_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.add_notification_channels_request.AddNotificationChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeguruprofiler.types.add_notification_channels_request.serialize_json(
            input_
        )
    ).encode()
