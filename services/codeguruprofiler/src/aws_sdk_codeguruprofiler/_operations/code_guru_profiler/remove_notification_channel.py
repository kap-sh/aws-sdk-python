...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.remove_notification_channel_response.RemoveNotificationChannelResponse = aws_sdk_codeguruprofiler.types.remove_notification_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.remove_notification_channel_request.RemoveNotificationChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
