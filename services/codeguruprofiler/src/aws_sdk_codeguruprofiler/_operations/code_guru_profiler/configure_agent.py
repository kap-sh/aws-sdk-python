...
def build_request(
    ...
    input: aws_sdk_codeguruprofiler.types.configure_agent_request.ConfigureAgentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeguruprofiler.types.configure_agent_request.serialize_json(input)
    ).encode()
