...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.configure_agent_response.ConfigureAgentResponse = {
        "configuration": aws_sdk_codeguruprofiler.types.agent_configuration.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.configure_agent_request.ConfigureAgentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeguruprofiler.types.configure_agent_request.serialize_json(input_)
    ).encode()
