...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.list_profile_times_response.ListProfileTimesResponse = aws_sdk_codeguruprofiler.types.list_profile_times_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.list_profile_times_request.ListProfileTimesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "order_by" in input_:
        params["orderBy"] = str(input_["order_by"])
