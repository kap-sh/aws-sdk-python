...
def handle_response(
    ...
    out: aws_sdk_codeguruprofiler.types.get_notification_configuration_response.GetNotificationConfigurationResponse = aws_sdk_codeguruprofiler.types.get_notification_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeguruprofiler.types.get_notification_configuration_request.GetNotificationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
