...
if TYPE_CHECKING:
    ...
    import aws_sdk_codeguruprofiler.types.profiling_group_descriptions
...
class ListProfilingGroupsResponse(TypedDict):
    ...
    profiling_groups: NotRequired[
        "aws_sdk_codeguruprofiler.types.profiling_group_descriptions.ProfilingGroupDescriptions"
    ]
...
def serialize_json(value: ListProfilingGroupsResponse) -> dict:
    ...
    out["profilingGroupNames"] = (
        aws_sdk_codeguruprofiler.types.profiling_group_names.serialize_json(
    ...
    if "profiling_groups" in value:
        ...
        out["profilingGroups"] = (
            aws_sdk_codeguruprofiler.types.profiling_group_descriptions.serialize_json(
...
def deserialize_json(data: dict) -> ListProfilingGroupsResponse:
    ...
    if "profilingGroupNames" in data:
        ...
        out["profiling_group_names"] = (
            aws_sdk_codeguruprofiler.types.profiling_group_names.deserialize_json(
    ...
    if "profilingGroups" in data:
        ...
        out["profiling_groups"] = (
            aws_sdk_codeguruprofiler.types.profiling_group_descriptions.deserialize_json(
