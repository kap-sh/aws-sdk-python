...
from capo_codeguruprofiler._services._aws_config import aws_config
...
class CodeGuruProfilerClientConfig(TypedDict, total=False, closed=True):
...
class CodeGuruProfilerClient:
    ...
    def get_findings_report_account_summary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeguruprofiler.types.get_findings_report_account_summary_request.GetFindingsReportAccountSummaryRequest]",
        ) -> OperationResponse[
            "capo_codeguruprofiler.types.get_findings_report_account_summary_response.GetFindingsReportAccountSummaryResponse"
        ]:
            ...
            output, http_response = (
                capo_codeguruprofiler._operations.code_guru_profiler.get_findings_report_account_summary.get_findings_report_account_summary(
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeguruprofiler.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_codeguruprofiler.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_codeguruprofiler._operations.code_guru_profiler.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeguruprofiler.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_codeguruprofiler.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_codeguruprofiler._operations.code_guru_profiler.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeguruprofiler.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_codeguruprofiler.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_codeguruprofiler._operations.code_guru_profiler.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
