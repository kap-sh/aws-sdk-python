"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#AddNotificationChannels``."""
...
import capo_codeguruprofiler.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_codeguruprofiler.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.add_notification_channels_response.AddNotificationChannelsResponse = capo_codeguruprofiler.types.add_notification_channels_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_codeguruprofiler._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeguruprofiler.types.add_notification_channels_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_add_notification_channels(
