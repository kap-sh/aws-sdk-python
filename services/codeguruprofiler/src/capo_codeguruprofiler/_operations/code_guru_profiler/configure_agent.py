"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#ConfigureAgent``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.configure_agent_response.ConfigureAgentResponse = {
        "configuration": capo_codeguruprofiler.types.agent_configuration.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeguruprofiler.types.configure_agent_request.serialize_json(input_)
    ).encode()
