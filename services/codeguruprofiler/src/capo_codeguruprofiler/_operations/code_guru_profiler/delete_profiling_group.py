"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#DeleteProfilingGroup``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.delete_profiling_group_response.DeleteProfilingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_profiling_group(
