"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#UntagResource``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
