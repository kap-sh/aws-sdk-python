...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.update_profiling_group_response.UpdateProfilingGroupResponse = {
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeguruprofiler.types.update_profiling_group_request.serialize_json(
            input_
        )
    ).encode()
