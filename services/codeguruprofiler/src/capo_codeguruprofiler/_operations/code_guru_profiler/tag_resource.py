"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#TagResource``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeguruprofiler.types.tag_resource_request.serialize_json(input_)
    ).encode()
