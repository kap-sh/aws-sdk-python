"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#GetProfile``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.get_profile_response.GetProfileResponse = {
        "profile": capo_codeguruprofiler.types.aggregated_profile.deserialize_json(
...
def get_profile(
    ...
    capo_codeguruprofiler.types.get_profile_response.GetProfileResponse, zapros.Response
]:
