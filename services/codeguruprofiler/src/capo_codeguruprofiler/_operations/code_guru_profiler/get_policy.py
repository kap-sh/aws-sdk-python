"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#GetPolicy``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.get_policy_response.GetPolicyResponse = (
        capo_codeguruprofiler.types.get_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/profilingGroups/{profilingGroupName}/policy"
    url = url.replace(
...
def get_policy(
    ...
    capo_codeguruprofiler.types.get_policy_response.GetPolicyResponse, zapros.Response
]:
