"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#DescribeProfilingGroup``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.describe_profiling_group_response.DescribeProfilingGroupResponse = {
...
async def async_describe_profiling_group(
