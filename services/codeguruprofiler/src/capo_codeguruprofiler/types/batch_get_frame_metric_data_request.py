...
class BatchGetFrameMetricDataRequest(TypedDict, closed=True):
    ...
    start_time: NotRequired["capo_codeguruprofiler.types.timestamp.Timestamp"]
    ...
    period: NotRequired["capo_codeguruprofiler.types.period.Period"]
    ...
    frame_metrics: NotRequired["capo_codeguruprofiler.types.frame_metrics.FrameMetrics"]
...
def serialize_json(value: BatchGetFrameMetricDataRequest) -> dict:
    ...
    if "frame_metrics" in value:
        ...
        out["frameMetrics"] = capo_codeguruprofiler.types.frame_metrics.serialize_json(
            value["frame_metrics"]
        )
    return out
...
def deserialize_json(data: dict) -> BatchGetFrameMetricDataRequest:
    ...
    if "frameMetrics" in data:
        ...
        out["frame_metrics"] = (
            capo_codeguruprofiler.types.frame_metrics.deserialize_json(
                data["frameMetrics"]
            )
        )
    return out
