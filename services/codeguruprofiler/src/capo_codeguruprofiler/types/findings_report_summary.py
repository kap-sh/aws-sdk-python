...
if TYPE_CHECKING:
    import capo_codeguruprofiler.types.findings_report_id
    import capo_codeguruprofiler.types.timestamp


class FindingsReportSummary(TypedDict, closed=True):
    id: NotRequired["capo_codeguruprofiler.types.findings_report_id.FindingsReportId"]
    ...
    profile_start_time: NotRequired["capo_codeguruprofiler.types.timestamp.Timestamp"]
    ...
    profile_end_time: NotRequired["capo_codeguruprofiler.types.timestamp.Timestamp"]
