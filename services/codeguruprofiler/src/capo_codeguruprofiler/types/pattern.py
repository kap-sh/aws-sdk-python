...
if TYPE_CHECKING:
    import capo_codeguruprofiler.types.percentage
...
class Pattern(TypedDict, closed=True):
    ...
    target_frames: NotRequired["capo_codeguruprofiler.types.target_frames.TargetFrames"]
    """<p>A list of frame names that were searched during the analysis that generated a recommendation.</p>"""
    threshold_percent: "capo_codeguruprofiler.types.percentage.Percentage"
    ...
    counters_to_aggregate: NotRequired["capo_codeguruprofiler.types.strings.Strings"]
...
def serialize_json(value: Pattern) -> dict:
    ...
    if "counters_to_aggregate" in value:
        ...
        out["countersToAggregate"] = capo_codeguruprofiler.types.strings.serialize_json(
...
def deserialize_json(data: dict) -> Pattern:
    ...
    if "targetFrames" in data:
        ...
        out["target_frames"] = (
            capo_codeguruprofiler.types.target_frames.deserialize_json(
                data["targetFrames"]
            )
        )
    ...
    if "countersToAggregate" in data:
        ...
        out["counters_to_aggregate"] = (
            capo_codeguruprofiler.types.strings.deserialize_json(
