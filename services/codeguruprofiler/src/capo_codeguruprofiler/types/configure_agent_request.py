...
class ConfigureAgentRequest(TypedDict, closed=True):
    ...
    metadata: NotRequired["capo_codeguruprofiler.types.metadata.Metadata"]
...
def serialize_json(value: ConfigureAgentRequest) -> dict:
    ...
    if "metadata" in value:
        ...
        out["metadata"] = capo_codeguruprofiler.types.metadata.serialize_json(
            value["metadata"]
        )
    return out
