"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetDevicePoolResult``."""
...
class GetDevicePoolResult(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetDevicePoolResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetDevicePoolResult:
    out: GetDevicePoolResult = {}  # type: ignore[typeddict-item]
