...
class ListProjectsResult(TypedDict, closed=True):
    projects: NotRequired["capo_device_farm.types.projects.Projects"]
...
def serialize_aws_json_1_1(value: ListProjectsResult) -> dict:
    ...
    if "projects" in value:
        ...
        out["projects"] = capo_device_farm.types.projects.serialize_aws_json_1_1(
            value["projects"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListProjectsResult:
    ...
    if "projects" in data:
        ...
        out["projects"] = capo_device_farm.types.projects.deserialize_aws_json_1_1(
            data["projects"]
        )
