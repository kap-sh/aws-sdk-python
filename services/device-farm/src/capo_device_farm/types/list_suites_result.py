...
class ListSuitesResult(TypedDict, closed=True):
    suites: NotRequired["capo_device_farm.types.suites.Suites"]
...
def serialize_aws_json_1_1(value: ListSuitesResult) -> dict:
    ...
    if "suites" in value:
        ...
        out["suites"] = capo_device_farm.types.suites.serialize_aws_json_1_1(
            value["suites"]
        )
