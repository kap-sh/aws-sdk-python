"""Generated from Smithy shape ``com.amazonaws.devicefarm#UpdateVPCEConfigurationResult``."""
...
class UpdateVPCEConfigurationResult(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateVPCEConfigurationResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateVPCEConfigurationResult:
    out: UpdateVPCEConfigurationResult = {}  # type: ignore[typeddict-item]
