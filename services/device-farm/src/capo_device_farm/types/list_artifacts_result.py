...
class ListArtifactsResult(TypedDict, closed=True):
    artifacts: NotRequired["capo_device_farm.types.artifacts.Artifacts"]
...
def serialize_aws_json_1_1(value: ListArtifactsResult) -> dict:
    ...
    if "artifacts" in value:
        ...
        out["artifacts"] = capo_device_farm.types.artifacts.serialize_aws_json_1_1(
            value["artifacts"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListArtifactsResult:
    ...
    if "artifacts" in data:
        ...
        out["artifacts"] = capo_device_farm.types.artifacts.deserialize_aws_json_1_1(
            data["artifacts"]
        )
