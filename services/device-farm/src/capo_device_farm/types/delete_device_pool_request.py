"""Generated from Smithy shape ``com.amazonaws.devicefarm#DeleteDevicePoolRequest``."""
...
class DeleteDevicePoolRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteDevicePoolRequest) -> dict:
    out: dict = {}
    out["arn"] = value["arn"]
    return out
