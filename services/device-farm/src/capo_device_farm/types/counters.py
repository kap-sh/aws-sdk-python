...
class Counters(TypedDict, closed=True):
    total: NotRequired["capo_device_farm.types.integer.Integer"]
    """<p>The total number of entities.</p>"""
    passed: NotRequired["capo_device_farm.types.integer.Integer"]
    """<p>The number of passed entities.</p>"""
    failed: NotRequired["capo_device_farm.types.integer.Integer"]
    """<p>The number of failed entities.</p>"""
    warned: NotRequired["capo_device_farm.types.integer.Integer"]
    """<p>The number of warned entities.</p>"""
    errored: NotRequired["capo_device_farm.types.integer.Integer"]
    """<p>The number of errored entities.</p>"""
    stopped: NotRequired["capo_device_farm.types.integer.Integer"]
    """<p>The number of stopped entities.</p>"""
    skipped: NotRequired["capo_device_farm.types.integer.Integer"]
