...
if TYPE_CHECKING:
    ...
    import capo_device_farm.types.test_grid_session_actions


class ListTestGridSessionActionsResult(TypedDict, closed=True):
    actions: NotRequired[
        "capo_device_farm.types.test_grid_session_actions.TestGridSessionActions"
    ]
...
def serialize_aws_json_1_1(value: ListTestGridSessionActionsResult) -> dict:
    ...
    if "actions" in value:
        ...
        out["actions"] = (
            capo_device_farm.types.test_grid_session_actions.serialize_aws_json_1_1(
                value["actions"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListTestGridSessionActionsResult:
    ...
    if "actions" in data:
        ...
        out["actions"] = (
            capo_device_farm.types.test_grid_session_actions.deserialize_aws_json_1_1(
                data["actions"]
            )
        )
