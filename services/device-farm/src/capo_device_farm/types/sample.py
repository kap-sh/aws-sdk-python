...
if TYPE_CHECKING:
    ...
    import capo_device_farm.types.url
...
class Sample(TypedDict, closed=True):
    ...
    type: NotRequired["capo_device_farm.types.sample_type.SampleType"]
    ...
    url: NotRequired["capo_device_farm.types.url.URL"]
...
def serialize_aws_json_1_1(value: Sample) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = capo_device_farm.types.sample_type.serialize_aws_json_1_1(
            value["type"]
        )
    if "url" in value:
        out["url"] = value["url"]
