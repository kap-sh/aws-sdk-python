...
if TYPE_CHECKING:
    ...
    import capo_device_farm.types.samples


class ListSamplesResult(TypedDict, closed=True):
    samples: NotRequired["capo_device_farm.types.samples.Samples"]
...
def serialize_aws_json_1_1(value: ListSamplesResult) -> dict:
    ...
    if "samples" in value:
        ...
        out["samples"] = capo_device_farm.types.samples.serialize_aws_json_1_1(
            value["samples"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListSamplesResult:
    ...
    if "samples" in data:
        ...
        out["samples"] = capo_device_farm.types.samples.deserialize_aws_json_1_1(
            data["samples"]
        )
