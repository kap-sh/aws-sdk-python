...
class DeviceFarmError(Exception):
    """Base class for all DeviceFarm service errors."""


class ServiceError(DeviceFarmError):
...
class SerializationError(DeviceFarmError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DeviceFarmError):
...
class WaiterFailedError(DeviceFarmError):
...
class WaiterTimeoutError(DeviceFarmError):
