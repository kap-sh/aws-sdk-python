...
def handle_response(
    ...
    out: capo_device_farm.types.delete_instance_profile_result.DeleteInstanceProfileResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.delete_instance_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
