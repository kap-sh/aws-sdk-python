...
def handle_response(
    ...
    out: capo_device_farm.types.create_test_grid_url_result.CreateTestGridUrlResult = (
        capo_device_farm.types.create_test_grid_url_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.create_test_grid_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
