"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetInstanceProfile``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.get_instance_profile_result.GetInstanceProfileResult = (
        capo_device_farm.types.get_instance_profile_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_instance_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
