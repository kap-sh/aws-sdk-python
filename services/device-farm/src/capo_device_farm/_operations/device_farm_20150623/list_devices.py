...
def handle_response(
    ...
    out: capo_device_farm.types.list_devices_result.ListDevicesResult = (
        capo_device_farm.types.list_devices_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_devices_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_devices(
    ...
    capo_device_farm.types.list_devices_result.ListDevicesResult, zapros.Response
]:
