"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListOfferingPromotions``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.list_offering_promotions_result.ListOfferingPromotionsResult = capo_device_farm.types.list_offering_promotions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_offering_promotions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_offering_promotions(
