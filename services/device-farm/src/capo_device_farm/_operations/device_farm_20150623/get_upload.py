"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetUpload``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.get_upload_result.GetUploadResult = (
        capo_device_farm.types.get_upload_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_upload_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_upload(
    ...
    input_: capo_device_farm.types.get_upload_request.GetUploadRequest,
) -> tuple[capo_device_farm.types.get_upload_result.GetUploadResult, zapros.Response]:
