"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListUploads``."""
...
import capo_device_farm.types.uploads
...
def handle_response(
    ...
    out: capo_device_farm.types.list_uploads_result.ListUploadsResult = (
        capo_device_farm.types.list_uploads_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_uploads_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_uploads(
    ...
    capo_device_farm.types.list_uploads_result.ListUploadsResult, zapros.Response
]:
