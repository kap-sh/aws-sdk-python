...
def handle_response(
    ...
    out: capo_device_farm.types.list_offerings_result.ListOfferingsResult = (
        capo_device_farm.types.list_offerings_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_offerings_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_offerings(
    ...
    capo_device_farm.types.list_offerings_result.ListOfferingsResult, zapros.Response
]:
