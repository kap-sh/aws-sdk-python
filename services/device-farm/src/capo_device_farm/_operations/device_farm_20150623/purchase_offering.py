"""Generated from Smithy shape ``com.amazonaws.devicefarm#PurchaseOffering``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.purchase_offering_result.PurchaseOfferingResult = (
        capo_device_farm.types.purchase_offering_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.purchase_offering_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_purchase_offering(
