...
def handle_response(
    ...
    out: capo_device_farm.types.get_vpce_configuration_result.GetVPCEConfigurationResult = capo_device_farm.types.get_vpce_configuration_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_vpce_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
