"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListRuns``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.list_runs_result.ListRunsResult = (
        capo_device_farm.types.list_runs_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_device_farm.types.list_runs_request.ListRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_runs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_runs(
    ...
    input_: capo_device_farm.types.list_runs_request.ListRunsRequest,
) -> tuple[capo_device_farm.types.list_runs_result.ListRunsResult, zapros.Response]:
