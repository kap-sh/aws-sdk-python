"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListDevicePools``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.list_device_pools_result.ListDevicePoolsResult = (
        capo_device_farm.types.list_device_pools_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_device_pools_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_device_pools(
