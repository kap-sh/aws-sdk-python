"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListTestGridSessions``."""
...
import capo_device_farm.errors.internal_service_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalServiceException":
            raise capo_device_farm.errors.internal_service_exception.InternalServiceException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_device_farm.types.list_test_grid_sessions_result.ListTestGridSessionsResult = capo_device_farm.types.list_test_grid_sessions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_test_grid_sessions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_test_grid_sessions(
