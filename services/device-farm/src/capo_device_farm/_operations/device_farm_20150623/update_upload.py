...
def handle_response(
    ...
    out: capo_device_farm.types.update_upload_result.UpdateUploadResult = (
        capo_device_farm.types.update_upload_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.update_upload_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_upload(
    ...
    capo_device_farm.types.update_upload_result.UpdateUploadResult, zapros.Response
]:
