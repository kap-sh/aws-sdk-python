"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetRun``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.get_run_result.GetRunResult = (
        capo_device_farm.types.get_run_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_device_farm.types.get_run_request.GetRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_run(
    ...
    input_: capo_device_farm.types.get_run_request.GetRunRequest,
) -> tuple[capo_device_farm.types.get_run_result.GetRunResult, zapros.Response]:
