"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetOfferingStatus``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.get_offering_status_result.GetOfferingStatusResult = (
        capo_device_farm.types.get_offering_status_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_offering_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_offering_status(
