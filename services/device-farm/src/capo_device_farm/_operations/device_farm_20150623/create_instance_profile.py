"""Generated from Smithy shape ``com.amazonaws.devicefarm#CreateInstanceProfile``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.create_instance_profile_result.CreateInstanceProfileResult = capo_device_farm.types.create_instance_profile_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.create_instance_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
