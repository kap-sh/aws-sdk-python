"""Generated from Smithy shape ``com.amazonaws.devicefarm#CreateProject``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.create_project_result.CreateProjectResult = (
        capo_device_farm.types.create_project_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.create_project_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_project(
    ...
    capo_device_farm.types.create_project_result.CreateProjectResult, zapros.Response
]:
