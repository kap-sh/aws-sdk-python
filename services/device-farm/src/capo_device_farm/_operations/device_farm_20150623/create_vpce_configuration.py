"""Generated from Smithy shape ``com.amazonaws.devicefarm#CreateVPCEConfiguration``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.create_vpce_configuration_result.CreateVPCEConfigurationResult = capo_device_farm.types.create_vpce_configuration_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.create_vpce_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_vpce_configuration(
