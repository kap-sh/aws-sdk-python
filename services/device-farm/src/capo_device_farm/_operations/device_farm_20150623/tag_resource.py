...
import capo_device_farm.errors.tag_policy_exception
import capo_device_farm.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TagPolicyException":
            raise capo_device_farm.errors.tag_policy_exception.TagPolicyException.from_aws_json_1_1(
                data
            )
        case "TooManyTagsException":
            raise capo_device_farm.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_device_farm.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_device_farm.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
