...
import capo_device_farm.types.artifacts
...
def handle_response(
    ...
    out: capo_device_farm.types.list_artifacts_result.ListArtifactsResult = (
        capo_device_farm.types.list_artifacts_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_artifacts_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_artifacts(
    ...
    capo_device_farm.types.list_artifacts_result.ListArtifactsResult, zapros.Response
]:
