...
def handle_response(
    ...
    out: capo_device_farm.types.install_to_remote_access_session_result.InstallToRemoteAccessSessionResult = capo_device_farm.types.install_to_remote_access_session_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.install_to_remote_access_session_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
