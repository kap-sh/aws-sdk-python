"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListOfferingTransactions``."""
...
import capo_device_farm.errors.not_eligible_exception
...
import capo_device_farm.types.offering_transactions
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotEligibleException":
            raise capo_device_farm.errors.not_eligible_exception.NotEligibleException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_device_farm.types.list_offering_transactions_result.ListOfferingTransactionsResult = capo_device_farm.types.list_offering_transactions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_offering_transactions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_offering_transactions(
