"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListJobs``."""
...
import capo_device_farm.types.jobs
...
def handle_response(
    ...
    out: capo_device_farm.types.list_jobs_result.ListJobsResult = (
        capo_device_farm.types.list_jobs_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_device_farm.types.list_jobs_request.ListJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_jobs(
    ...
    input_: capo_device_farm.types.list_jobs_request.ListJobsRequest,
) -> tuple[capo_device_farm.types.list_jobs_result.ListJobsResult, zapros.Response]:
