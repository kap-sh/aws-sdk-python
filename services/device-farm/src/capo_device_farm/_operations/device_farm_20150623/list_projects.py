...
import capo_device_farm.types.projects
...
def handle_response(
    ...
    out: capo_device_farm.types.list_projects_result.ListProjectsResult = (
        capo_device_farm.types.list_projects_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_projects_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_projects(
    ...
    capo_device_farm.types.list_projects_result.ListProjectsResult, zapros.Response
]:
