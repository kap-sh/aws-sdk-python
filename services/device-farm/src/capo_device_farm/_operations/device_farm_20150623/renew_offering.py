"""Generated from Smithy shape ``com.amazonaws.devicefarm#RenewOffering``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.renew_offering_result.RenewOfferingResult = (
        capo_device_farm.types.renew_offering_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.renew_offering_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def renew_offering(
    ...
    capo_device_farm.types.renew_offering_result.RenewOfferingResult, zapros.Response
]:
...
async def async_renew_offering(
