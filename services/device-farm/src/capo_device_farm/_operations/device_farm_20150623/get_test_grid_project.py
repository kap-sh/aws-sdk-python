...
def handle_response(
    ...
    out: capo_device_farm.types.get_test_grid_project_result.GetTestGridProjectResult = capo_device_farm.types.get_test_grid_project_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_test_grid_project_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
