"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListUniqueProblems``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.list_unique_problems_result.ListUniqueProblemsResult = (
        capo_device_farm.types.list_unique_problems_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_unique_problems_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_unique_problems(
