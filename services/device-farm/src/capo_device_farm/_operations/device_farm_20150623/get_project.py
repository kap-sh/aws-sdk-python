"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetProject``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.get_project_result.GetProjectResult = (
        capo_device_farm.types.get_project_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_project_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_project(
    ...
    input_: capo_device_farm.types.get_project_request.GetProjectRequest,
) -> tuple[capo_device_farm.types.get_project_result.GetProjectResult, zapros.Response]:
