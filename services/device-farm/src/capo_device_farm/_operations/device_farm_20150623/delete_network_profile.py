"""Generated from Smithy shape ``com.amazonaws.devicefarm#DeleteNetworkProfile``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.delete_network_profile_result.DeleteNetworkProfileResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.delete_network_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_network_profile(
