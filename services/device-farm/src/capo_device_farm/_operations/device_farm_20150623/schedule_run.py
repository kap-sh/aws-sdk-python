"""Generated from Smithy shape ``com.amazonaws.devicefarm#ScheduleRun``."""
...
import capo_device_farm.errors.idempotency_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IdempotencyException":
            raise capo_device_farm.errors.idempotency_exception.IdempotencyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_device_farm.types.schedule_run_result.ScheduleRunResult = (
        capo_device_farm.types.schedule_run_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.schedule_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def schedule_run(
    ...
    capo_device_farm.types.schedule_run_result.ScheduleRunResult, zapros.Response
]:
