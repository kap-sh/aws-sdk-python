...
if TYPE_CHECKING:
    ...
    import aws_sdk_device_farm.types.exception_message


class TagOperationException_(TypedDict):
    message: NotRequired["aws_sdk_device_farm.types.exception_message.ExceptionMessage"]
