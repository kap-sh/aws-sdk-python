...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.create_device_pool_result.CreateDevicePoolResult = (
        aws_sdk_device_farm.types.create_device_pool_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.create_device_pool_request.CreateDevicePoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.create_device_pool_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
