...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_project_result.GetProjectResult = (
        aws_sdk_device_farm.types.get_project_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_project_request.GetProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_project_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_project(
    ...
    aws_sdk_device_farm.types.get_project_result.GetProjectResult, zapros.Response
]:
