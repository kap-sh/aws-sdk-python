"""Generated from Smithy shape ``com.amazonaws.devicefarm#UpdateUpload``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.update_upload_result.UpdateUploadResult = (
        aws_sdk_device_farm.types.update_upload_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.update_upload_request.UpdateUploadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.update_upload_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_upload(
    ...
    aws_sdk_device_farm.types.update_upload_result.UpdateUploadResult, zapros.Response
]:
