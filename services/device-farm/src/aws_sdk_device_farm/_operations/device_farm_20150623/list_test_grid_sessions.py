...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_test_grid_sessions_result.ListTestGridSessionsResult = aws_sdk_device_farm.types.list_test_grid_sessions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_test_grid_sessions_request.ListTestGridSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_test_grid_sessions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
