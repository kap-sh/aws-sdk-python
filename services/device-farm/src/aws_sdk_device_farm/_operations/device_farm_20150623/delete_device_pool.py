...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.delete_device_pool_result.DeleteDevicePoolResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.delete_device_pool_request.DeleteDevicePoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.delete_device_pool_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
