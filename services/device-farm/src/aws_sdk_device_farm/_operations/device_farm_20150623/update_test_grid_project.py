"""Generated from Smithy shape ``com.amazonaws.devicefarm#UpdateTestGridProject``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.update_test_grid_project_result.UpdateTestGridProjectResult = aws_sdk_device_farm.types.update_test_grid_project_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.update_test_grid_project_request.UpdateTestGridProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.update_test_grid_project_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_test_grid_project(
