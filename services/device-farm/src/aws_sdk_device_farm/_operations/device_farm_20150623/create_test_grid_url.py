"""Generated from Smithy shape ``com.amazonaws.devicefarm#CreateTestGridUrl``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.create_test_grid_url_result.CreateTestGridUrlResult = aws_sdk_device_farm.types.create_test_grid_url_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.create_test_grid_url_request.CreateTestGridUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.create_test_grid_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_test_grid_url(
