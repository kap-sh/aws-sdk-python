...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.create_remote_access_session_result.CreateRemoteAccessSessionResult = aws_sdk_device_farm.types.create_remote_access_session_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.create_remote_access_session_request.CreateRemoteAccessSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.create_remote_access_session_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
