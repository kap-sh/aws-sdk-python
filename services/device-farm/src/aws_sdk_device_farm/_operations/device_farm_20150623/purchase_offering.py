...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.purchase_offering_result.PurchaseOfferingResult = (
        aws_sdk_device_farm.types.purchase_offering_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.purchase_offering_request.PurchaseOfferingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.purchase_offering_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
