...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IdempotencyException":
            import aws_sdk_device_farm.errors.idempotency_exception

            raise aws_sdk_device_farm.errors.idempotency_exception.IdempotencyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.schedule_run_result.ScheduleRunResult = (
        aws_sdk_device_farm.types.schedule_run_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_device_farm.types.schedule_run_request.ScheduleRunRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.schedule_run_request.serialize_aws_json_1_1(input)
    ).encode()
...
def schedule_run(
    ...
    aws_sdk_device_farm.types.schedule_run_result.ScheduleRunResult, zapros.Response
]:
