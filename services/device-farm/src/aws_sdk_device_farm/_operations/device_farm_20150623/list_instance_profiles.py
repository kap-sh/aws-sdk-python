"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListInstanceProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_instance_profiles_result.ListInstanceProfilesResult = aws_sdk_device_farm.types.list_instance_profiles_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_instance_profiles_request.ListInstanceProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_instance_profiles_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
