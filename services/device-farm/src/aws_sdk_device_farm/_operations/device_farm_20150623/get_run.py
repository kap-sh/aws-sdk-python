...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_run_result.GetRunResult = (
        aws_sdk_device_farm.types.get_run_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_run_request.GetRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_run(
    ...
    input_: aws_sdk_device_farm.types.get_run_request.GetRunRequest,
) -> tuple[aws_sdk_device_farm.types.get_run_result.GetRunResult, zapros.Response]:
