...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_uploads_result.ListUploadsResult = (
        aws_sdk_device_farm.types.list_uploads_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_uploads_request.ListUploadsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_uploads_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_uploads(
    ...
    aws_sdk_device_farm.types.list_uploads_result.ListUploadsResult, zapros.Response
]:
