...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_offering_transactions_result.ListOfferingTransactionsResult = aws_sdk_device_farm.types.list_offering_transactions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_offering_transactions_request.ListOfferingTransactionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_offering_transactions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
