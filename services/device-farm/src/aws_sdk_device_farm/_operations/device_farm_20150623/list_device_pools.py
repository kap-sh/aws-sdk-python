...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_device_pools_result.ListDevicePoolsResult = (
        aws_sdk_device_farm.types.list_device_pools_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_device_pools_request.ListDevicePoolsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
