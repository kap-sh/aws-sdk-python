"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetVPCEConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_vpce_configuration_result.GetVPCEConfigurationResult = aws_sdk_device_farm.types.get_vpce_configuration_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_vpce_configuration_request.GetVPCEConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_vpce_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_vpce_configuration(
