"""Generated from Smithy shape ``com.amazonaws.devicefarm#TagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TagOperationException":
            import aws_sdk_device_farm.errors.tag_operation_exception

            raise aws_sdk_device_farm.errors.tag_operation_exception.TagOperationException.from_aws_json_1_1(
                data
            )
        case "TagPolicyException":
            import aws_sdk_device_farm.errors.tag_policy_exception

            raise aws_sdk_device_farm.errors.tag_policy_exception.TagPolicyException.from_aws_json_1_1(
                data
            )
        case "TooManyTagsException":
            import aws_sdk_device_farm.errors.too_many_tags_exception

            raise aws_sdk_device_farm.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_device_farm.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
