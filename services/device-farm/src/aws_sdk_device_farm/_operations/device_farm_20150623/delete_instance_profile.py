"""Generated from Smithy shape ``com.amazonaws.devicefarm#DeleteInstanceProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.delete_instance_profile_result.DeleteInstanceProfileResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.delete_instance_profile_request.DeleteInstanceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.delete_instance_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
