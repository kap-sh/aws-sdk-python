...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.create_vpce_configuration_result.CreateVPCEConfigurationResult = aws_sdk_device_farm.types.create_vpce_configuration_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.create_vpce_configuration_request.CreateVPCEConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.create_vpce_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
