"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListTestGridSessionArtifacts``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_test_grid_session_artifacts_result.ListTestGridSessionArtifactsResult = aws_sdk_device_farm.types.list_test_grid_session_artifacts_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_test_grid_session_artifacts_request.ListTestGridSessionArtifactsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_test_grid_session_artifacts_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_test_grid_session_artifacts(
