...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.stop_job_result.StopJobResult = (
        aws_sdk_device_farm.types.stop_job_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.stop_job_request.StopJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.stop_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_job(
    ...
    input_: aws_sdk_device_farm.types.stop_job_request.StopJobRequest,
) -> tuple[aws_sdk_device_farm.types.stop_job_result.StopJobResult, zapros.Response]:
