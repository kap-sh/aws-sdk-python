"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetTestGridSession``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_test_grid_session_result.GetTestGridSessionResult = aws_sdk_device_farm.types.get_test_grid_session_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_test_grid_session_request.GetTestGridSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_test_grid_session_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_test_grid_session(
