"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListSuites``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_suites_result.ListSuitesResult = (
        aws_sdk_device_farm.types.list_suites_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_suites_request.ListSuitesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_suites_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_suites(
    ...
    aws_sdk_device_farm.types.list_suites_result.ListSuitesResult, zapros.Response
]:
