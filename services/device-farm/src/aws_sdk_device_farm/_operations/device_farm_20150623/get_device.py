...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_device_result.GetDeviceResult = (
        aws_sdk_device_farm.types.get_device_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_device_request.GetDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_device_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_device(
    ...
    aws_sdk_device_farm.types.get_device_result.GetDeviceResult, zapros.Response
]:
