...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.update_project_result.UpdateProjectResult = (
        aws_sdk_device_farm.types.update_project_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.update_project_request.UpdateProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.update_project_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_project(
    ...
    aws_sdk_device_farm.types.update_project_result.UpdateProjectResult, zapros.Response
]:
