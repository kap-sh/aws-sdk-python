...
def build_request(
    ...
    input: aws_sdk_device_farm.types.update_project_request.UpdateProjectRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.update_project_request.serialize_aws_json_1_1(input)
    ).encode()
