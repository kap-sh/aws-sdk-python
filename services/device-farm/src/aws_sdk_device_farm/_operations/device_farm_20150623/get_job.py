"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetJob``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_job_result.GetJobResult = (
        aws_sdk_device_farm.types.get_job_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_job_request.GetJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_job(
    ...
    input_: aws_sdk_device_farm.types.get_job_request.GetJobRequest,
) -> tuple[aws_sdk_device_farm.types.get_job_result.GetJobResult, zapros.Response]:
