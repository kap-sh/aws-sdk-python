...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.update_network_profile_result.UpdateNetworkProfileResult = aws_sdk_device_farm.types.update_network_profile_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.update_network_profile_request.UpdateNetworkProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.update_network_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
