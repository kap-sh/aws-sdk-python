"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetSuite``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_suite_result.GetSuiteResult = (
        aws_sdk_device_farm.types.get_suite_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_suite_request.GetSuiteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_suite_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_suite(
    ...
    input_: aws_sdk_device_farm.types.get_suite_request.GetSuiteRequest,
) -> tuple[aws_sdk_device_farm.types.get_suite_result.GetSuiteResult, zapros.Response]:
