"""Generated from Smithy shape ``com.amazonaws.devicefarm#DeleteUpload``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.delete_upload_result.DeleteUploadResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.delete_upload_request.DeleteUploadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.delete_upload_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_upload(
    ...
    aws_sdk_device_farm.types.delete_upload_result.DeleteUploadResult, zapros.Response
]:
