...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_account_settings_result.GetAccountSettingsResult = aws_sdk_device_farm.types.get_account_settings_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_account_settings_request.GetAccountSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
