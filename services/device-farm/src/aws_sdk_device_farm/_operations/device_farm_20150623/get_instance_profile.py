...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_instance_profile_result.GetInstanceProfileResult = aws_sdk_device_farm.types.get_instance_profile_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_instance_profile_request.GetInstanceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_instance_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
