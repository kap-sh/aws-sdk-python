...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_offering_status_result.GetOfferingStatusResult = aws_sdk_device_farm.types.get_offering_status_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_offering_status_request.GetOfferingStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_offering_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
