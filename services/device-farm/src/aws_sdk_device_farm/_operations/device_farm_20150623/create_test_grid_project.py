"""Generated from Smithy shape ``com.amazonaws.devicefarm#CreateTestGridProject``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.create_test_grid_project_result.CreateTestGridProjectResult = aws_sdk_device_farm.types.create_test_grid_project_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.create_test_grid_project_request.CreateTestGridProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.create_test_grid_project_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_test_grid_project(
