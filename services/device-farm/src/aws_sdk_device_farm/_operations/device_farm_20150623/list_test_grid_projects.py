...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_test_grid_projects_result.ListTestGridProjectsResult = aws_sdk_device_farm.types.list_test_grid_projects_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_test_grid_projects_request.ListTestGridProjectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_test_grid_projects_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
