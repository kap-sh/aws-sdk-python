"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetDevicePool``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_device_pool_result.GetDevicePoolResult = (
        aws_sdk_device_farm.types.get_device_pool_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_device_pool_request.GetDevicePoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_device_pool_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_device_pool(
