...
def build_request(
    ...
    input: aws_sdk_device_farm.types.get_device_pool_request.GetDevicePoolRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_device_pool_request.serialize_aws_json_1_1(input)
    ).encode()
