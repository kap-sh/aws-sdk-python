"""Generated from Smithy shape ``com.amazonaws.devicefarm#CreateUpload``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.create_upload_result.CreateUploadResult = (
        aws_sdk_device_farm.types.create_upload_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.create_upload_request.CreateUploadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.create_upload_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_upload(
    ...
    aws_sdk_device_farm.types.create_upload_result.CreateUploadResult, zapros.Response
]:
