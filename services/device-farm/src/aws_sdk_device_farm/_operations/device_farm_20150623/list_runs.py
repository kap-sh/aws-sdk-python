...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_runs_result.ListRunsResult = (
        aws_sdk_device_farm.types.list_runs_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_runs_request.ListRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_runs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_runs(
    ...
    input_: aws_sdk_device_farm.types.list_runs_request.ListRunsRequest,
) -> tuple[aws_sdk_device_farm.types.list_runs_result.ListRunsResult, zapros.Response]:
