"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListRemoteAccessSessions``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_remote_access_sessions_result.ListRemoteAccessSessionsResult = aws_sdk_device_farm.types.list_remote_access_sessions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_remote_access_sessions_request.ListRemoteAccessSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_remote_access_sessions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_remote_access_sessions(
