...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.stop_run_result.StopRunResult = (
        aws_sdk_device_farm.types.stop_run_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.stop_run_request.StopRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.stop_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_run(
    ...
    input_: aws_sdk_device_farm.types.stop_run_request.StopRunRequest,
) -> tuple[aws_sdk_device_farm.types.stop_run_result.StopRunResult, zapros.Response]:
