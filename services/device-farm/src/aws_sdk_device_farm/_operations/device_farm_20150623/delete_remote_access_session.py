...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.delete_remote_access_session_result.DeleteRemoteAccessSessionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.delete_remote_access_session_request.DeleteRemoteAccessSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.delete_remote_access_session_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
