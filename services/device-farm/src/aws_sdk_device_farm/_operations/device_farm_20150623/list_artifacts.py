...
def build_request(
    ...
    input: aws_sdk_device_farm.types.list_artifacts_request.ListArtifactsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_artifacts_request.serialize_aws_json_1_1(input)
    ).encode()
