"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListArtifacts``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_artifacts_result.ListArtifactsResult = (
        aws_sdk_device_farm.types.list_artifacts_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_artifacts_request.ListArtifactsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_artifacts_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_artifacts(
    ...
    aws_sdk_device_farm.types.list_artifacts_result.ListArtifactsResult, zapros.Response
]:
