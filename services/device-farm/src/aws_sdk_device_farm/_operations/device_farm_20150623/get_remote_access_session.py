"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetRemoteAccessSession``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_remote_access_session_result.GetRemoteAccessSessionResult = aws_sdk_device_farm.types.get_remote_access_session_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_remote_access_session_request.GetRemoteAccessSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_remote_access_session_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_remote_access_session(
