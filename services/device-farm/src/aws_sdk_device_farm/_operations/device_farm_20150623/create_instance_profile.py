...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.create_instance_profile_result.CreateInstanceProfileResult = aws_sdk_device_farm.types.create_instance_profile_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.create_instance_profile_request.CreateInstanceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.create_instance_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
