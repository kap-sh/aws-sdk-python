...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_tests_result.ListTestsResult = (
        aws_sdk_device_farm.types.list_tests_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_tests_request.ListTestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_tests_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_tests(
    ...
    aws_sdk_device_farm.types.list_tests_result.ListTestsResult, zapros.Response
]:
