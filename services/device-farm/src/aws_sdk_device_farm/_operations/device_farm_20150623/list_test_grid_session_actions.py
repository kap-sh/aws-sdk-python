...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_test_grid_session_actions_result.ListTestGridSessionActionsResult = aws_sdk_device_farm.types.list_test_grid_session_actions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_test_grid_session_actions_request.ListTestGridSessionActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
