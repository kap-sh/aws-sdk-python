"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListNetworkProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_network_profiles_result.ListNetworkProfilesResult = aws_sdk_device_farm.types.list_network_profiles_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_network_profiles_request.ListNetworkProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_network_profiles_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_network_profiles(
