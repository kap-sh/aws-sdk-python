"""Generated from Smithy shape ``com.amazonaws.devicefarm#DeleteTestGridProject``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CannotDeleteException":
            import aws_sdk_device_farm.errors.cannot_delete_exception

            raise aws_sdk_device_farm.errors.cannot_delete_exception.CannotDeleteException.from_aws_json_1_1(
                data
            )
        case "InternalServiceException":
            import aws_sdk_device_farm.errors.internal_service_exception

            raise aws_sdk_device_farm.errors.internal_service_exception.InternalServiceException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.delete_test_grid_project_result.DeleteTestGridProjectResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.delete_test_grid_project_request.DeleteTestGridProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.delete_test_grid_project_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_test_grid_project(
