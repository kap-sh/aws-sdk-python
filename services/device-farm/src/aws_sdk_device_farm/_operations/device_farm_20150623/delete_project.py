"""Generated from Smithy shape ``com.amazonaws.devicefarm#DeleteProject``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.delete_project_result.DeleteProjectResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.delete_project_request.DeleteProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.delete_project_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_project(
    ...
    aws_sdk_device_farm.types.delete_project_result.DeleteProjectResult, zapros.Response
]:
