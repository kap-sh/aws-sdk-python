"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetDeviceInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_device_instance_result.GetDeviceInstanceResult = aws_sdk_device_farm.types.get_device_instance_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_device_instance_request.GetDeviceInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_device_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_device_instance(
