...
def build_request(
    ...
    input: aws_sdk_device_farm.types.renew_offering_request.RenewOfferingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.renew_offering_request.serialize_aws_json_1_1(input)
    ).encode()
