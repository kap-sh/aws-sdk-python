...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.renew_offering_result.RenewOfferingResult = (
        aws_sdk_device_farm.types.renew_offering_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.renew_offering_request.RenewOfferingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.renew_offering_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def renew_offering(
    ...
    aws_sdk_device_farm.types.renew_offering_result.RenewOfferingResult, zapros.Response
]:
