...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_unique_problems_result.ListUniqueProblemsResult = aws_sdk_device_farm.types.list_unique_problems_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_unique_problems_request.ListUniqueProblemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_unique_problems_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
