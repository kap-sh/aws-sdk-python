"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListVPCEConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_vpce_configurations_result.ListVPCEConfigurationsResult = aws_sdk_device_farm.types.list_vpce_configurations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_vpce_configurations_request.ListVPCEConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_vpce_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_vpce_configurations(
