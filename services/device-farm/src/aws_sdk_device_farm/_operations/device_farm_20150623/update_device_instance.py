"""Generated from Smithy shape ``com.amazonaws.devicefarm#UpdateDeviceInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.update_device_instance_result.UpdateDeviceInstanceResult = aws_sdk_device_farm.types.update_device_instance_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.update_device_instance_request.UpdateDeviceInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.update_device_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_device_instance(
