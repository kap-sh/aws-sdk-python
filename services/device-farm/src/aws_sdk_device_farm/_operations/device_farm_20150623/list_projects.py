"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListProjects``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_projects_result.ListProjectsResult = (
        aws_sdk_device_farm.types.list_projects_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_projects_request.ListProjectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_projects_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_projects(
    ...
    aws_sdk_device_farm.types.list_projects_result.ListProjectsResult, zapros.Response
]:
