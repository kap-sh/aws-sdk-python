"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListDevices``."""
...
import aws_sdk_device_farm.types.devices
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_devices_result.ListDevicesResult = (
        aws_sdk_device_farm.types.list_devices_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_devices_request.ListDevicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_devices_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_devices(
    ...
    aws_sdk_device_farm.types.list_devices_result.ListDevicesResult, zapros.Response
]:
