"""Generated from Smithy shape ``com.amazonaws.devicefarm#DeleteRun``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.delete_run_result.DeleteRunResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.delete_run_request.DeleteRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.delete_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_run(
    ...
    aws_sdk_device_farm.types.delete_run_result.DeleteRunResult, zapros.Response
]:
