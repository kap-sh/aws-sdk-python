...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_upload_result.GetUploadResult = (
        aws_sdk_device_farm.types.get_upload_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_upload_request.GetUploadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_upload_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_upload(
    ...
    aws_sdk_device_farm.types.get_upload_result.GetUploadResult, zapros.Response
]:
