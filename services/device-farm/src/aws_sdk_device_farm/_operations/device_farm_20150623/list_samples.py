"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListSamples``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_samples_result.ListSamplesResult = (
        aws_sdk_device_farm.types.list_samples_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_samples_request.ListSamplesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_samples_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_samples(
    ...
    aws_sdk_device_farm.types.list_samples_result.ListSamplesResult, zapros.Response
]:
