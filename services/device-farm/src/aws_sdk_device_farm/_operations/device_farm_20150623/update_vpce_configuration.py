"""Generated from Smithy shape ``com.amazonaws.devicefarm#UpdateVPCEConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.update_vpce_configuration_result.UpdateVPCEConfigurationResult = aws_sdk_device_farm.types.update_vpce_configuration_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.update_vpce_configuration_request.UpdateVPCEConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.update_vpce_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_vpce_configuration(
