...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.get_test_result.GetTestResult = (
        aws_sdk_device_farm.types.get_test_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.get_test_request.GetTestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.get_test_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_test(
    ...
    input_: aws_sdk_device_farm.types.get_test_request.GetTestRequest,
) -> tuple[aws_sdk_device_farm.types.get_test_result.GetTestResult, zapros.Response]:
