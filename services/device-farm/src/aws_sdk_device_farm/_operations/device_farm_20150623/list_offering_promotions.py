...
def handle_response(
    ...
    out: aws_sdk_device_farm.types.list_offering_promotions_result.ListOfferingPromotionsResult = aws_sdk_device_farm.types.list_offering_promotions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_device_farm.types.list_offering_promotions_request.ListOfferingPromotionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_device_farm.types.list_offering_promotions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
