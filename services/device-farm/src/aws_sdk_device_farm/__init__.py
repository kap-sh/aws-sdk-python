...
from ._services.async_device_farm import AsyncDeviceFarmClient as AsyncDeviceFarmClient
from ._services.device_farm import DeviceFarmClient as DeviceFarmClient
