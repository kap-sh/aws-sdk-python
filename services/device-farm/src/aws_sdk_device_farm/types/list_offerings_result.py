...
if TYPE_CHECKING:
    import aws_sdk_device_farm.types.offerings
    import aws_sdk_device_farm.types.pagination_token


class ListOfferingsResult(TypedDict):
    offerings: NotRequired["aws_sdk_device_farm.types.offerings.Offerings"]
...
def serialize_aws_json_1_1(value: ListOfferingsResult) -> dict:
    ...
    if "offerings" in value:
        ...
        out["offerings"] = aws_sdk_device_farm.types.offerings.serialize_aws_json_1_1(
            value["offerings"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListOfferingsResult:
    ...
    if "offerings" in data:
        ...
        out["offerings"] = aws_sdk_device_farm.types.offerings.deserialize_aws_json_1_1(
            data["offerings"]
        )
