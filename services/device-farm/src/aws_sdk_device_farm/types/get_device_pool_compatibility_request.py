...
class GetDevicePoolCompatibilityRequest(TypedDict):
    ...
    test_type: NotRequired["aws_sdk_device_farm.types.test_type.TestType"]
    ...
    test: NotRequired["aws_sdk_device_farm.types.schedule_run_test.ScheduleRunTest"]
...
def serialize_aws_json_1_1(value: GetDevicePoolCompatibilityRequest) -> dict:
    ...
    if "test_type" in value:
        ...
        out["testType"] = aws_sdk_device_farm.types.test_type.serialize_aws_json_1_1(
            value["test_type"]
        )
    if "test" in value:
        import aws_sdk_device_farm.types.schedule_run_test
        ...
        out["test"] = (
            aws_sdk_device_farm.types.schedule_run_test.serialize_aws_json_1_1(
                value["test"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetDevicePoolCompatibilityRequest:
    ...
    if "testType" in data:
        ...
        out["test_type"] = aws_sdk_device_farm.types.test_type.deserialize_aws_json_1_1(
            data["testType"]
        )
    if "test" in data:
        import aws_sdk_device_farm.types.schedule_run_test
