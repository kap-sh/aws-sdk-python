...
class ListDevicesResult(TypedDict, closed=True):
    devices: NotRequired["aws_sdk_device_farm.types.devices.Devices"]
...
def serialize_aws_json_1_1(value: ListDevicesResult) -> dict:
    ...
    if "devices" in value:
        ...
        out["devices"] = aws_sdk_device_farm.types.devices.serialize_aws_json_1_1(
            value["devices"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDevicesResult:
    ...
    if "devices" in data:
        ...
        out["devices"] = aws_sdk_device_farm.types.devices.deserialize_aws_json_1_1(
            data["devices"]
        )
