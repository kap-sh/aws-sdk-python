...
def serialize_aws_json_1_1(value: DeviceFilter) -> dict:
    ...
    out["attribute"] = (
        aws_sdk_device_farm.types.device_filter_attribute.serialize_aws_json_1_1(
            value["attribute"]
        )
    )
    import aws_sdk_device_farm.types.rule_operator

    out["operator"] = aws_sdk_device_farm.types.rule_operator.serialize_aws_json_1_1(
        value["operator"]
    )
    import aws_sdk_device_farm.types.device_filter_values

    out["values"] = (
        aws_sdk_device_farm.types.device_filter_values.serialize_aws_json_1_1(
            value["values"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DeviceFilter:
    ...
    if "attribute" in data:
        ...
        out["attribute"] = (
            aws_sdk_device_farm.types.device_filter_attribute.deserialize_aws_json_1_1(
                data["attribute"]
            )
        )
    else:
    ...
    if "operator" in data:
        ...
        out["operator"] = (
            aws_sdk_device_farm.types.rule_operator.deserialize_aws_json_1_1(
                data["operator"]
            )
        )
    else:
    ...
    if "values" in data:
        ...
        out["values"] = (
            aws_sdk_device_farm.types.device_filter_values.deserialize_aws_json_1_1(
                data["values"]
            )
        )
    else:
