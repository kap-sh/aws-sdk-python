...
if TYPE_CHECKING:
    ...
    import aws_sdk_device_farm.types.cpu
    import aws_sdk_device_farm.types.device_availability
    import aws_sdk_device_farm.types.device_form_factor
    ...
    import aws_sdk_device_farm.types.resolution
...
class Device(TypedDict):
    ...
    manufacturer: NotRequired["aws_sdk_device_farm.types.string.String"]
    """<p>The device's manufacturer name.</p>"""
    model: NotRequired["aws_sdk_device_farm.types.string.String"]
    """<p>The device's model name.</p>"""
    model_id: NotRequired["aws_sdk_device_farm.types.string.String"]
    """<p>The device's model ID.</p>"""
    form_factor: NotRequired[
        "aws_sdk_device_farm.types.device_form_factor.DeviceFormFactor"
    ]
    ...
    os: NotRequired["aws_sdk_device_farm.types.string.String"]
    """<p>The device's operating system type.</p>"""
    cpu: NotRequired["aws_sdk_device_farm.types.cpu.CPU"]
    """<p>Information about the device's CPU.</p>"""
    resolution: NotRequired["aws_sdk_device_farm.types.resolution.Resolution"]
    """<p>The resolution of the device.</p>"""
    heap_size: NotRequired["aws_sdk_device_farm.types.long.Long"]
    """<p>The device's heap size, expressed in bytes.</p>"""
    memory: NotRequired["aws_sdk_device_farm.types.long.Long"]
    """<p>The device's total memory size, expressed in bytes.</p>"""
    image: NotRequired["aws_sdk_device_farm.types.string.String"]
    """<p>The device's image name.</p>"""
    carrier: NotRequired["aws_sdk_device_farm.types.string.String"]
    """<p>The device's carrier.</p>"""
    radio: NotRequired["aws_sdk_device_farm.types.string.String"]
    ...
    instances: NotRequired["aws_sdk_device_farm.types.device_instances.DeviceInstances"]
    """<p>The instances that belong to this device.</p>"""
    availability: NotRequired[
        "aws_sdk_device_farm.types.device_availability.DeviceAvailability"
    ]
...
def serialize_aws_json_1_1(value: Device) -> dict:
    ...
    if "form_factor" in value:
        ...
        out["formFactor"] = (
            aws_sdk_device_farm.types.device_form_factor.serialize_aws_json_1_1(
                value["form_factor"]
            )
        )
    ...
    if "cpu" in value:
        ...
        out["cpu"] = aws_sdk_device_farm.types.cpu.serialize_aws_json_1_1(value["cpu"])
    if "resolution" in value:
        import aws_sdk_device_farm.types.resolution

        out["resolution"] = aws_sdk_device_farm.types.resolution.serialize_aws_json_1_1(
            value["resolution"]
        )
    ...
    if "availability" in value:
        ...
        out["availability"] = (
            aws_sdk_device_farm.types.device_availability.serialize_aws_json_1_1(
                value["availability"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Device:
    ...
    if "formFactor" in data:
        ...
        out["form_factor"] = (
            aws_sdk_device_farm.types.device_form_factor.deserialize_aws_json_1_1(
                data["formFactor"]
            )
        )
    if "platform" in data:
    ...
    if "cpu" in data:
        ...
        out["cpu"] = aws_sdk_device_farm.types.cpu.deserialize_aws_json_1_1(data["cpu"])
    if "resolution" in data:
        import aws_sdk_device_farm.types.resolution

        out["resolution"] = (
            aws_sdk_device_farm.types.resolution.deserialize_aws_json_1_1(
                data["resolution"]
            )
        )
    if "heapSize" in data:
    ...
    if "availability" in data:
        ...
        out["availability"] = (
            aws_sdk_device_farm.types.device_availability.deserialize_aws_json_1_1(
                data["availability"]
            )
        )
    return out
