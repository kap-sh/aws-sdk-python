...
def serialize_aws_json_1_1(value: ListUniqueProblemsResult) -> dict:
    ...
    if "unique_problems" in value:
        ...
        out["uniqueProblems"] = (
            aws_sdk_device_farm.types.unique_problems_by_execution_result_map.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListUniqueProblemsResult:
    ...
    if "uniqueProblems" in data:
        ...
        out["unique_problems"] = (
            aws_sdk_device_farm.types.unique_problems_by_execution_result_map.deserialize_aws_json_1_1(
                data["uniqueProblems"]
            )
        )
