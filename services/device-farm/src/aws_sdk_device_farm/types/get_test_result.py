...
class GetTestResult(TypedDict):
    test: NotRequired["aws_sdk_device_farm.types.test.Test"]
...
def serialize_aws_json_1_1(value: GetTestResult) -> dict:
    ...
    if "test" in value:
        ...
        out["test"] = aws_sdk_device_farm.types.test.serialize_aws_json_1_1(
            value["test"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetTestResult:
    ...
    if "test" in data:
        ...
        out["test"] = aws_sdk_device_farm.types.test.deserialize_aws_json_1_1(
            data["test"]
        )
    return out
