"""Generated from Smithy shape ``com.amazonaws.devicefarm#CreateInstanceProfileResult``."""
...
class CreateInstanceProfileResult(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateInstanceProfileResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateInstanceProfileResult:
    out: CreateInstanceProfileResult = {}  # type: ignore[typeddict-item]
