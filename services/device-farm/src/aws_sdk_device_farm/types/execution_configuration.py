...
if TYPE_CHECKING:
    import aws_sdk_device_farm.types.accounts_cleanup
    import aws_sdk_device_farm.types.app_packages_cleanup
...
class ExecutionConfiguration(TypedDict):
    ...
    accounts_cleanup: NotRequired[
        "aws_sdk_device_farm.types.accounts_cleanup.AccountsCleanup"
    ]
    """<p>True if account cleanup is enabled at the beginning of the test. Otherwise, false.</p>"""
    app_packages_cleanup: NotRequired[
        "aws_sdk_device_farm.types.app_packages_cleanup.AppPackagesCleanup"
    ]
