...
class Rule(TypedDict):
    attribute: NotRequired["aws_sdk_device_farm.types.device_attribute.DeviceAttribute"]
    ...
    operator: NotRequired["aws_sdk_device_farm.types.rule_operator.RuleOperator"]
    ...
    value: NotRequired["aws_sdk_device_farm.types.string.String"]
...
def serialize_aws_json_1_1(value: Rule) -> dict:
    ...
    if "attribute" in value:
        ...
        out["attribute"] = (
            aws_sdk_device_farm.types.device_attribute.serialize_aws_json_1_1(
                value["attribute"]
            )
        )
    if "operator" in value:
        ...
        out["operator"] = (
            aws_sdk_device_farm.types.rule_operator.serialize_aws_json_1_1(
                value["operator"]
            )
        )
    if "value" in value:
