...
from aws_sdk_device_farm._rule_engine._endpoint_runtime import EndpointError
import re
import zapros

def test_1_for_region_us_west_2_with_fips_disabled_():
    """For region us-west-2 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-west-2', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://devicefarm.us-west-2.amazonaws.com'
...
def test_2_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm-fips.us-east-1.api.aws'
...
def test_3_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm-fips.us-east-1.amazonaws.com'
...
def test_4_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm.us-east-1.api.aws'
...
def test_5_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm.us-east-1.amazonaws.com'
...
def test_6_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm-fips.cn-north-1.api.amazonwebservices.com.cn'
...
def test_7_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm-fips.cn-north-1.amazonaws.com.cn'
...
def test_8_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm.cn-north-1.api.amazonwebservices.com.cn'
...
def test_9_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm.cn-north-1.amazonaws.com.cn'
...
def test_10_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm-fips.us-gov-east-1.api.aws'
...
def test_11_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm-fips.us-gov-east-1.amazonaws.com'
...
def test_12_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm.us-gov-east-1.api.aws'
...
def test_13_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm.us-gov-east-1.amazonaws.com'
...
def test_14_for_region_us_iso_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm-fips.us-iso-east-1.c2s.ic.gov'
...
def test_15_for_region_us_iso_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm.us-iso-east-1.c2s.ic.gov'
...
def test_16_for_region_us_isob_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm-fips.us-isob-east-1.sc2s.sgov.gov'
...
def test_17_for_region_us_isob_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://devicefarm.us-isob-east-1.sc2s.sgov.gov'
