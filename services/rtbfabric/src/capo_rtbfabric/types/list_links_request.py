"""Generated from Smithy shape ``com.amazonaws.rtbfabric#ListLinksRequest``."""
...
class ListLinksRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListLinksRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListLinksRequest:
    out: ListLinksRequest = {}  # type: ignore[typeddict-item]
    return out
