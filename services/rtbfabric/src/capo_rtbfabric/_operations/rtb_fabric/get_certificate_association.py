...
def handle_response(
    ...
    out: capo_rtbfabric.types.get_certificate_association_response.GetCertificateAssociationResponse = capo_rtbfabric.types.get_certificate_association_response.deserialize_json(
