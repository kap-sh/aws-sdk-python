...
def handle_response(
    ...
    out: capo_rtbfabric.types.get_responder_gateway_response.GetResponderGatewayResponse = capo_rtbfabric.types.get_responder_gateway_response.deserialize_json(
