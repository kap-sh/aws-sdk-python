"""Generated from Smithy shape ``com.amazonaws.rtbfabric#DeleteLink``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.delete_link_response.DeleteLinkResponse = (
        capo_rtbfabric.types.delete_link_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/gateway/{gatewayId}/link/{linkId}"
...
def delete_link(
    ...
    capo_rtbfabric.types.delete_link_response.DeleteLinkResponse, zapros.Response
]:
