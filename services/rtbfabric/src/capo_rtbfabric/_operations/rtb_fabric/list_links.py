...
def handle_response(
    ...
    out: capo_rtbfabric.types.list_links_response.ListLinksResponse = (
        capo_rtbfabric.types.list_links_response.deserialize_json(
...
def list_links(
    ...
    input_: capo_rtbfabric.types.list_links_request.ListLinksRequest,
) -> tuple[capo_rtbfabric.types.list_links_response.ListLinksResponse, zapros.Response]:
