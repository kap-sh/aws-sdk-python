...
def handle_response(
    ...
    out: capo_rtbfabric.types.delete_requester_gateway_response.DeleteRequesterGatewayResponse = capo_rtbfabric.types.delete_requester_gateway_response.deserialize_json(
