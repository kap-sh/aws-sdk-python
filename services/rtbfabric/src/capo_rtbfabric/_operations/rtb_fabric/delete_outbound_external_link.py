"""Generated from Smithy shape ``com.amazonaws.rtbfabric#DeleteOutboundExternalLink``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.delete_outbound_external_link_response.DeleteOutboundExternalLinkResponse = capo_rtbfabric.types.delete_outbound_external_link_response.deserialize_json(
...
async def async_delete_outbound_external_link(
