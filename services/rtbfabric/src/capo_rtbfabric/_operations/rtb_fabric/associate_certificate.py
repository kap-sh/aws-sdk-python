...
def handle_response(
    ...
    out: capo_rtbfabric.types.associate_certificate_response.AssociateCertificateResponse = capo_rtbfabric.types.associate_certificate_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rtbfabric.types.associate_certificate_request.serialize_json(input_)
    ).encode()
