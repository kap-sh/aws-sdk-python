"""Generated from Smithy shape ``com.amazonaws.rtbfabric#CreateOutboundExternalLink``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.create_outbound_external_link_response.CreateOutboundExternalLinkResponse = capo_rtbfabric.types.create_outbound_external_link_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rtbfabric.types.create_outbound_external_link_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_outbound_external_link(
