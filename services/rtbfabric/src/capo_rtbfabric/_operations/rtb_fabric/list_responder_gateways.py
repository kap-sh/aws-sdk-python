...
def handle_response(
    ...
    out: capo_rtbfabric.types.list_responder_gateways_response.ListResponderGatewaysResponse = capo_rtbfabric.types.list_responder_gateways_response.deserialize_json(
