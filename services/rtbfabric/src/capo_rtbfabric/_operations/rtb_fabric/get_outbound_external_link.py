...
def handle_response(
    ...
    out: capo_rtbfabric.types.get_outbound_external_link_response.GetOutboundExternalLinkResponse = capo_rtbfabric.types.get_outbound_external_link_response.deserialize_json(
