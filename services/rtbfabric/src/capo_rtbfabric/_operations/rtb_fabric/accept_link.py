"""Generated from Smithy shape ``com.amazonaws.rtbfabric#AcceptLink``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.accept_link_response.AcceptLinkResponse = (
        capo_rtbfabric.types.accept_link_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/gateway/{gatewayId}/link/{linkId}/accept"
    ...
    body: bytes | None = json.dumps(
        capo_rtbfabric.types.accept_link_request.serialize_json(input_)
    ).encode()
...
def accept_link(
    ...
    capo_rtbfabric.types.accept_link_response.AcceptLinkResponse, zapros.Response
]:
