"""Generated from Smithy shape ``com.amazonaws.rtbfabric#DeleteLinkRoutingRule``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.delete_link_routing_rule_response.DeleteLinkRoutingRuleResponse = capo_rtbfabric.types.delete_link_routing_rule_response.deserialize_json(
...
async def async_delete_link_routing_rule(
