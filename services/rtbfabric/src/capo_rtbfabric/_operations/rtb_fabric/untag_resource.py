"""Generated from Smithy shape ``com.amazonaws.rtbfabric#UntagResource``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_rtbfabric.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
