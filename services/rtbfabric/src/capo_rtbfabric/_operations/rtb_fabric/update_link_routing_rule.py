...
def handle_response(
    ...
    out: capo_rtbfabric.types.update_link_routing_rule_response.UpdateLinkRoutingRuleResponse = capo_rtbfabric.types.update_link_routing_rule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rtbfabric.types.update_link_routing_rule_request.serialize_json(input_)
    ).encode()
