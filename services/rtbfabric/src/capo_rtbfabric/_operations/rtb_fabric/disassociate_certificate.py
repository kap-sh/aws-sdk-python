...
import capo_rtbfabric.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_rtbfabric.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_rtbfabric.types.disassociate_certificate_response.DisassociateCertificateResponse = capo_rtbfabric.types.disassociate_certificate_response.deserialize_json(
