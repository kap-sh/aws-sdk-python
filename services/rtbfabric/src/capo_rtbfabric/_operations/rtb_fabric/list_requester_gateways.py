...
def handle_response(
    ...
    out: capo_rtbfabric.types.list_requester_gateways_response.ListRequesterGatewaysResponse = capo_rtbfabric.types.list_requester_gateways_response.deserialize_json(
