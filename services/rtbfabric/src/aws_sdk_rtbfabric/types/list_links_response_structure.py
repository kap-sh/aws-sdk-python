"""Generated from Smithy shape ``com.amazonaws.rtbfabric#ListLinksResponseStructure``."""
...
class ListLinksResponseStructure(TypedDict, closed=True):
    ...
    public_endpoint: NotRequired["aws_sdk_rtbfabric.types.url.URL"]
    """<p>The public endpoint of the outbound link.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: ListLinksResponseStructure) -> dict:
    out: dict = {}
