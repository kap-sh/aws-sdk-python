...
class AcceptLinkRequest(TypedDict):
    ...
    timeout_in_millis: NotRequired["aws_sdk_rtbfabric.types.link_timeout_in_millis.LinkTimeoutInMillis"]
...
def serialize_json(value: AcceptLinkRequest) -> dict:
    ...
    if "attributes" in value:
        import aws_sdk_rtbfabric.types.link_attributes
        out["attributes"] = aws_sdk_rtbfabric.types.link_attributes.serialize_json(value["attributes"])
    import aws_sdk_rtbfabric.types.link_log_settings
    out["logSettings"] = aws_sdk_rtbfabric.types.link_log_settings.serialize_json(value["log_settings"])
...
def deserialize_json(data: dict) -> AcceptLinkRequest:
    ...
    if "attributes" in data:
        import aws_sdk_rtbfabric.types.link_attributes
        out["attributes"] = aws_sdk_rtbfabric.types.link_attributes.deserialize_json(data["attributes"])
    if "logSettings" in data:
        import aws_sdk_rtbfabric.types.link_log_settings
        out["log_settings"] = aws_sdk_rtbfabric.types.link_log_settings.deserialize_json(data["logSettings"])
    else:
