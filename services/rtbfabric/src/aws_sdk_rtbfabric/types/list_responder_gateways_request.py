...
# --- restJson1 ser/de ---
def serialize_json(value: ListResponderGatewaysRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListResponderGatewaysRequest:
    out: ListResponderGatewaysRequest = {}  # type: ignore[typeddict-item]
    return out
