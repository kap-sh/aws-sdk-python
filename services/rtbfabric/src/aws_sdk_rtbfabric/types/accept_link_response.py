"""Generated from Smithy shape ``com.amazonaws.rtbfabric#AcceptLinkResponse``."""
...
class AcceptLinkResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: AcceptLinkResponse) -> dict:
    out: dict = {}
