...
class HealthCheckConfig(TypedDict, closed=True):
    ...
    protocol: NotRequired["aws_sdk_rtbfabric.types.protocol.Protocol"]
    ...
    status_code_matcher: NotRequired[
        "aws_sdk_rtbfabric.types.status_code_matcher.StatusCodeMatcher"
    ]
...
def serialize_json(value: HealthCheckConfig) -> dict:
    ...
    if "protocol" in value:
        ...
        out["protocol"] = aws_sdk_rtbfabric.types.protocol.serialize_json(
            value["protocol"]
        )
