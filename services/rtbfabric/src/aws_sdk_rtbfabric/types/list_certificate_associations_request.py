"""Generated from Smithy shape ``com.amazonaws.rtbfabric#ListCertificateAssociationsRequest``."""
...
class ListCertificateAssociationsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListCertificateAssociationsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListCertificateAssociationsRequest:
    out: ListCertificateAssociationsRequest = {}  # type: ignore[typeddict-item]
    return out
