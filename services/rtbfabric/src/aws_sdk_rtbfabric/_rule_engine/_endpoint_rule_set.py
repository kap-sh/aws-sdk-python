...
def resolve(p: EndpointParams) -> Endpoint:  # type: ignore
    ...
    if p.Region is not None:
        ...
        if _locals["PartitionResult"] is not None:
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://rtbfabric-fips.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={},
            ...
            if p.UseFIPS is True:
                if p.UseDualStack is False:
                    if (
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://rtbfabric-fips.{Region}.{PartitionResult#dnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={},
            ...
            if p.UseFIPS is False:
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://rtbfabric.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={},
            ...
            return Endpoint(
                url=interpolate(
                    "https://rtbfabric.{Region}.{PartitionResult#dnsSuffix}", p, _locals
                ),
                properties={},
                headers={},
            )
