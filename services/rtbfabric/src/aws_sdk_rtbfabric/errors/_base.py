...
class RTBFabricError(Exception):
    """Base class for all RTBFabric service errors."""


class ServiceError(RTBFabricError):
...
class SerializationError(RTBFabricError):
    """Raised when a value cannot be serialized."""


class DeserializationError(RTBFabricError):
...
class WaiterFailedError(RTBFabricError):
...
class WaiterTimeoutError(RTBFabricError):
