...
from aws_sdk_appconfig._services._aws_config import aaws_config
...
class AsyncAppConfigClientConfig(TypedDict, total=False):
...
class AsyncAppConfigClient:
    ...
    async def create_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.create_application_request.CreateApplicationRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.application.Application"]:
            import aws_sdk_appconfig._operations.amazon_app_config.create_application

            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.create_application.async_create_application(
    ...
    async def create_configuration_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.create_configuration_profile_request.CreateConfigurationProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.configuration_profile.ConfigurationProfile"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.create_configuration_profile.async_create_configuration_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_deployment_strategy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.create_deployment_strategy_request.CreateDeploymentStrategyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.deployment_strategy.DeploymentStrategy"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.create_deployment_strategy.async_create_deployment_strategy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.create_environment_request.CreateEnvironmentRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.environment.Environment"]:
            import aws_sdk_appconfig._operations.amazon_app_config.create_environment

            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.create_environment.async_create_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_extension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.create_extension_request.CreateExtensionRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.extension.Extension"]:
            import aws_sdk_appconfig._operations.amazon_app_config.create_extension

            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.create_extension.async_create_extension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_extension_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.create_extension_association_request.CreateExtensionAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.extension_association.ExtensionAssociation"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.create_extension_association.async_create_extension_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_hosted_configuration_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.create_hosted_configuration_version_request.CreateHostedConfigurationVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.hosted_configuration_version.HostedConfigurationVersion"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.create_hosted_configuration_version.async_create_hosted_configuration_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.delete_application_request.DeleteApplicationRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.delete_application.async_delete_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_configuration_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.delete_configuration_profile_request.DeleteConfigurationProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.delete_configuration_profile.async_delete_configuration_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_deployment_strategy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.delete_deployment_strategy_request.DeleteDeploymentStrategyRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.delete_deployment_strategy.async_delete_deployment_strategy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.delete_environment_request.DeleteEnvironmentRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.delete_environment.async_delete_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_extension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.delete_extension_request.DeleteExtensionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.delete_extension.async_delete_extension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_extension_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.delete_extension_association_request.DeleteExtensionAssociationRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.delete_extension_association.async_delete_extension_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_hosted_configuration_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.delete_hosted_configuration_version_request.DeleteHostedConfigurationVersionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.delete_hosted_configuration_version.async_delete_hosted_configuration_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_settings(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.get_account_settings.async_get_account_settings(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.get_application_request.GetApplicationRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.application.Application"]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.get_application.async_get_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.get_configuration_request.GetConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.configuration.Configuration"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.get_configuration.async_get_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_configuration_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.get_configuration_profile_request.GetConfigurationProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.configuration_profile.ConfigurationProfile"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.get_configuration_profile.async_get_configuration_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.get_deployment_request.GetDeploymentRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.deployment.Deployment"]:
            import aws_sdk_appconfig._operations.amazon_app_config.get_deployment

            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.get_deployment.async_get_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_deployment_strategy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.get_deployment_strategy_request.GetDeploymentStrategyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.deployment_strategy.DeploymentStrategy"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.get_deployment_strategy.async_get_deployment_strategy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.get_environment_request.GetEnvironmentRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.environment.Environment"]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.get_environment.async_get_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_extension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.get_extension_request.GetExtensionRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.extension.Extension"]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.get_extension.async_get_extension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_extension_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.get_extension_association_request.GetExtensionAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.extension_association.ExtensionAssociation"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.get_extension_association.async_get_extension_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_hosted_configuration_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.get_hosted_configuration_version_request.GetHostedConfigurationVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.hosted_configuration_version.HostedConfigurationVersion"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.get_hosted_configuration_version.async_get_hosted_configuration_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_applications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.list_applications_request.ListApplicationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.applications.Applications"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.list_applications.async_list_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_applications(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_appconfig.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_appconfig.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_appconfig.types.application.Application]":
        _token = next_token
        while True:
    ...
    async def list_configuration_profiles(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.list_configuration_profiles_request.ListConfigurationProfilesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.configuration_profiles.ConfigurationProfiles"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.list_configuration_profiles.async_list_configuration_profiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_appconfig.types.configuration_profile_summary.ConfigurationProfileSummary]":
        _token = next_token
        while True:
    ...
    async def list_deployments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.list_deployments_request.ListDeploymentsRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.deployments.Deployments"]:
            import aws_sdk_appconfig._operations.amazon_app_config.list_deployments

            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.list_deployments.async_list_deployments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_deployments(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_appconfig.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_appconfig.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_appconfig.types.deployment_summary.DeploymentSummary]":
        _token = next_token
        while True:
    ...
    async def list_deployment_strategies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.list_deployment_strategies_request.ListDeploymentStrategiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.deployment_strategies.DeploymentStrategies"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.list_deployment_strategies.async_list_deployment_strategies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_deployment_strategies(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_appconfig.types.deployment_strategy.DeploymentStrategy]"
    ):
        _token = next_token
        while True:
    ...
    async def list_environments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.list_environments_request.ListEnvironmentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.environments.Environments"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.list_environments.async_list_environments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_environments(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_appconfig.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_appconfig.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_appconfig.types.environment.Environment]":
        _token = next_token
        while True:
    ...
    async def list_extension_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.list_extension_associations_request.ListExtensionAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.extension_associations.ExtensionAssociations"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.list_extension_associations.async_list_extension_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_extension_associations(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_appconfig.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_appconfig.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_appconfig.types.extension_association_summary.ExtensionAssociationSummary]":
        _token = next_token
        while True:
    ...
    async def list_extensions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.list_extensions_request.ListExtensionsRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.extensions.Extensions"]:
            import aws_sdk_appconfig._operations.amazon_app_config.list_extensions

            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.list_extensions.async_list_extensions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_extensions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_appconfig.types.next_token.NextToken"] = None,
        name: Optional["aws_sdk_appconfig.types.query_name.QueryName"] = None,
    ) -> "AsyncIterator[aws_sdk_appconfig.types.extension_summary.ExtensionSummary]":
        _token = next_token
        while True:
    ...
    async def list_hosted_configuration_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.list_hosted_configuration_versions_request.ListHostedConfigurationVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.hosted_configuration_versions.HostedConfigurationVersions"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.list_hosted_configuration_versions.async_list_hosted_configuration_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_hosted_configuration_versions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_appconfig.types.next_token.NextToken"] = None,
        version_label: Optional["aws_sdk_appconfig.types.query_name.QueryName"] = None,
    ) -> "AsyncIterator[aws_sdk_appconfig.types.hosted_configuration_version_summary.HostedConfigurationVersionSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.resource_tags.ResourceTags"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.start_deployment_request.StartDeploymentRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.deployment.Deployment"]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.start_deployment.async_start_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.stop_deployment_request.StopDeploymentRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.deployment.Deployment"]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.stop_deployment.async_stop_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.update_account_settings_request.UpdateAccountSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.account_settings.AccountSettings"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.update_account_settings.async_update_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.update_application_request.UpdateApplicationRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.application.Application"]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.update_application.async_update_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_configuration_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.update_configuration_profile_request.UpdateConfigurationProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.configuration_profile.ConfigurationProfile"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.update_configuration_profile.async_update_configuration_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_deployment_strategy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.update_deployment_strategy_request.UpdateDeploymentStrategyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.deployment_strategy.DeploymentStrategy"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.update_deployment_strategy.async_update_deployment_strategy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_environment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.update_environment_request.UpdateEnvironmentRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.environment.Environment"]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.update_environment.async_update_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_extension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.update_extension_request.UpdateExtensionRequest]",
        ) -> AsyncOperationResponse["aws_sdk_appconfig.types.extension.Extension"]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.update_extension.async_update_extension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_extension_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.update_extension_association_request.UpdateExtensionAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfig.types.extension_association.ExtensionAssociation"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.update_extension_association.async_update_extension_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfig.types.validate_configuration_request.ValidateConfigurationRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfig._operations.amazon_app_config.validate_configuration.async_validate_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
