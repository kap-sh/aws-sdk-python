...
if TYPE_CHECKING:
    ...
    import aws_sdk_appconfig.types.deletion_protection_duration


class DeletionProtectionSettings(TypedDict):
    enabled: NotRequired["aws_sdk_appconfig.types.boolean.Boolean"]
