...
if TYPE_CHECKING:
    import aws_sdk_appconfig.types.environment_list
    import aws_sdk_appconfig.types.next_token


class Environments(TypedDict):
    items: NotRequired["aws_sdk_appconfig.types.environment_list.EnvironmentList"]
...
def serialize_json(value: Environments) -> dict:
    ...
    if "items" in value:
        ...
        out["Items"] = aws_sdk_appconfig.types.environment_list.serialize_json(
            value["items"]
        )
...
def deserialize_json(data: dict) -> Environments:
    ...
    if "Items" in data:
        ...
        out["items"] = aws_sdk_appconfig.types.environment_list.deserialize_json(
            data["Items"]
        )
