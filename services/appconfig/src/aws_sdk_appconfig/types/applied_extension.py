...
class AppliedExtension(TypedDict):
    extension_id: NotRequired["aws_sdk_appconfig.types.id.Id"]
    """<p>The system-generated ID of the extension.</p>"""
    extension_association_id: NotRequired["aws_sdk_appconfig.types.id.Id"]
