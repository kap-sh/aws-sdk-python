"""Generated from Smithy shape ``com.amazonaws.appconfig#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.appconfig#InternalServerException``."""
