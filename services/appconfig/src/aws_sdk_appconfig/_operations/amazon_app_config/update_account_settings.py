...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.account_settings.AccountSettings = (
        aws_sdk_appconfig.types.account_settings.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.update_account_settings_request.UpdateAccountSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.update_account_settings_request.serialize_json(input_)
    ).encode()
...
def update_account_settings(
    ...
    input_: aws_sdk_appconfig.types.update_account_settings_request.UpdateAccountSettingsRequest,
) -> tuple[aws_sdk_appconfig.types.account_settings.AccountSettings, zapros.Response]:
