...
def build_request(
    ...
    input: aws_sdk_appconfig.types.update_account_settings_request.UpdateAccountSettingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.update_account_settings_request.serialize_json(input)
    ).encode()
