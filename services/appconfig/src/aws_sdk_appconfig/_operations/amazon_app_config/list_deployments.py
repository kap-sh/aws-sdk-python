...
import aws_sdk_appconfig.types.deployment_list
...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.deployments.Deployments = (
        aws_sdk_appconfig.types.deployments.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.list_deployments_request.ListDeploymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_deployments(
    ...
    input_: aws_sdk_appconfig.types.list_deployments_request.ListDeploymentsRequest,
) -> tuple[aws_sdk_appconfig.types.deployments.Deployments, zapros.Response]:
