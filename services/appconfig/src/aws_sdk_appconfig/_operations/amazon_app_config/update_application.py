"""Generated from Smithy shape ``com.amazonaws.appconfig#UpdateApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.application.Application = (
        aws_sdk_appconfig.types.application.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.update_application_request.UpdateApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.update_application_request.serialize_json(input_)
    ).encode()
...
def update_application(
    ...
    input_: aws_sdk_appconfig.types.update_application_request.UpdateApplicationRequest,
) -> tuple[aws_sdk_appconfig.types.application.Application, zapros.Response]:
