...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.update_environment_request.UpdateEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.update_environment_request.serialize_json(input_)
    ).encode()
