"""Generated from Smithy shape ``com.amazonaws.appconfig#DeleteEnvironment``."""
...
def build_request(
    ...
    input: aws_sdk_appconfig.types.delete_environment_request.DeleteEnvironmentRequest,
) -> zapros.Request:
    ...
    if "deletion_protection_check" in input:
        headers["x-amzn-deletion-protection-check"] = str(
            input["deletion_protection_check"]
        )
    body: bytes | None = b""
