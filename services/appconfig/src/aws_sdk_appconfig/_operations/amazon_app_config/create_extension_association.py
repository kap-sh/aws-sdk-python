...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.create_extension_association_request.CreateExtensionAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.create_extension_association_request.serialize_json(
            input_
        )
    ).encode()
