...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_appconfig.errors.service_quota_exceeded_exception

            raise aws_sdk_appconfig.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.environment.Environment = (
        aws_sdk_appconfig.types.environment.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.create_environment_request.CreateEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.create_environment_request.serialize_json(input_)
    ).encode()
...
def create_environment(
    ...
    input_: aws_sdk_appconfig.types.create_environment_request.CreateEnvironmentRequest,
) -> tuple[aws_sdk_appconfig.types.environment.Environment, zapros.Response]:
