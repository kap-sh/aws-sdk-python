...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.resource_tags.ResourceTags = (
        aws_sdk_appconfig.types.resource_tags.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_tags_for_resource(
    ...
    input_: aws_sdk_appconfig.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> tuple[aws_sdk_appconfig.types.resource_tags.ResourceTags, zapros.Response]:
