"""Generated from Smithy shape ``com.amazonaws.appconfig#ListDeploymentStrategies``."""
...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.deployment_strategies.DeploymentStrategies = (
        aws_sdk_appconfig.types.deployment_strategies.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.list_deployment_strategies_request.ListDeploymentStrategiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/deploymentstrategies"
    params: dict[str, str] = {}
...
def list_deployment_strategies(
    ...
    aws_sdk_appconfig.types.deployment_strategies.DeploymentStrategies, zapros.Response
]:
...
async def async_list_deployment_strategies(
