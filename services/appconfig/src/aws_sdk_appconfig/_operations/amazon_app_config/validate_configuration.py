...
def build_request(
    ...
    input: aws_sdk_appconfig.types.validate_configuration_request.ValidateConfigurationRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "configuration_version" in input:
        params["configuration_version"] = str(input["configuration_version"])
