"""Generated from Smithy shape ``com.amazonaws.appconfig#GetExtensionAssociation``."""
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.get_extension_association_request.GetExtensionAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_extension_association(
