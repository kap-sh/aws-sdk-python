"""Generated from Smithy shape ``com.amazonaws.appconfig#UpdateDeploymentStrategy``."""
...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.deployment_strategy.DeploymentStrategy = (
        aws_sdk_appconfig.types.deployment_strategy.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_appconfig.types.update_deployment_strategy_request.UpdateDeploymentStrategyRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/deploymentstrategies/{DeploymentStrategyId}"
    url = url.replace(
        "{DeploymentStrategyId}", quote(str(input["deployment_strategy_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.update_deployment_strategy_request.serialize_json(input)
    ).encode()
...
def update_deployment_strategy(
    ...
    aws_sdk_appconfig.types.deployment_strategy.DeploymentStrategy, zapros.Response
]:
...
async def async_update_deployment_strategy(
