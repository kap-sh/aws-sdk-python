...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.applications.Applications = (
        aws_sdk_appconfig.types.applications.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.list_applications_request.ListApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_applications(
    ...
    input_: aws_sdk_appconfig.types.list_applications_request.ListApplicationsRequest,
) -> tuple[aws_sdk_appconfig.types.applications.Applications, zapros.Response]:
