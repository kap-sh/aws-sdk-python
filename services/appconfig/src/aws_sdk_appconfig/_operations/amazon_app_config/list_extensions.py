...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.extensions.Extensions = (
        aws_sdk_appconfig.types.extensions.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_appconfig.types.extensions.Extensions = (
        aws_sdk_appconfig.types.extensions.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.list_extensions_request.ListExtensionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_extensions(
    ...
    input_: aws_sdk_appconfig.types.list_extensions_request.ListExtensionsRequest,
) -> tuple[aws_sdk_appconfig.types.extensions.Extensions, zapros.Response]:
