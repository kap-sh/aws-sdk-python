...
def build_request(
    ...
    input: aws_sdk_appconfig.types.get_extension_request.GetExtensionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ExtensionIdentifier}", quote(str(input["extension_identifier"]), safe="")
    )
    params: dict[str, str] = {}
    if "version_number" in input:
        params["version_number"] = str(input["version_number"])
