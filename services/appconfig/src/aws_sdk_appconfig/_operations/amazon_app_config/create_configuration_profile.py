...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.create_configuration_profile_request.CreateConfigurationProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.create_configuration_profile_request.serialize_json(
            input_
        )
    ).encode()
