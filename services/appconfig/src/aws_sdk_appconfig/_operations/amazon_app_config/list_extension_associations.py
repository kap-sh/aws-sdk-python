...
def build_request(
    ...
    input: aws_sdk_appconfig.types.list_extension_associations_request.ListExtensionAssociationsRequest,
) -> zapros.Request:
    ...
    if "resource_identifier" in input:
        params["resource_identifier"] = str(input["resource_identifier"])
    if "extension_identifier" in input:
        params["extension_identifier"] = str(input["extension_identifier"])
    if "extension_version_number" in input:
        params["extension_version_number"] = str(input["extension_version_number"])
