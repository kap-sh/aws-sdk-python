...
def build_request(
    ...
    input: aws_sdk_appconfig.types.list_hosted_configuration_versions_request.ListHostedConfigurationVersionsRequest,
) -> zapros.Request:
    ...
    if "version_label" in input:
        params["version_label"] = str(input["version_label"])
