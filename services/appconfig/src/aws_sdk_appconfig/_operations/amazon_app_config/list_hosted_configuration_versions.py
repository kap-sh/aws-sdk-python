"""Generated from Smithy shape ``com.amazonaws.appconfig#ListHostedConfigurationVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.hosted_configuration_versions.HostedConfigurationVersions = aws_sdk_appconfig.types.hosted_configuration_versions.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.list_hosted_configuration_versions_request.ListHostedConfigurationVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "version_label" in input_:
        params["version_label"] = str(input_["version_label"])
...
async def async_list_hosted_configuration_versions(
