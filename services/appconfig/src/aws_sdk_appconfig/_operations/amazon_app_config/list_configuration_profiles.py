"""Generated from Smithy shape ``com.amazonaws.appconfig#ListConfigurationProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.configuration_profiles.ConfigurationProfiles = (
        aws_sdk_appconfig.types.configuration_profiles.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.list_configuration_profiles_request.ListConfigurationProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/applications/{ApplicationId}/configurationprofiles"
    )
...
async def async_list_configuration_profiles(
