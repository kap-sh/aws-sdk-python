"""Generated from Smithy shape ``com.amazonaws.appconfig#StartDeployment``."""
...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.deployment.Deployment = (
        aws_sdk_appconfig.types.deployment.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_appconfig.types.deployment.Deployment = (
        aws_sdk_appconfig.types.deployment.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.start_deployment_request.StartDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.start_deployment_request.serialize_json(input_)
    ).encode()
...
def start_deployment(
    ...
    input_: aws_sdk_appconfig.types.start_deployment_request.StartDeploymentRequest,
) -> tuple[aws_sdk_appconfig.types.deployment.Deployment, zapros.Response]:
