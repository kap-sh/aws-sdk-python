...
def handle_response(
    ...
    out: aws_sdk_appconfig.types.environments.Environments = (
        aws_sdk_appconfig.types.environments.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.list_environments_request.ListEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_environments(
    ...
    input_: aws_sdk_appconfig.types.list_environments_request.ListEnvironmentsRequest,
) -> tuple[aws_sdk_appconfig.types.environments.Environments, zapros.Response]:
