"""Generated from Smithy shape ``com.amazonaws.appconfig#DeleteApplication``."""
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.delete_application_request.DeleteApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
