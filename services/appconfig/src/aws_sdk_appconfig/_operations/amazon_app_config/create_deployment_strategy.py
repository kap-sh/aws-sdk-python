...
def build_request(
    ...
    input: aws_sdk_appconfig.types.create_deployment_strategy_request.CreateDeploymentStrategyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.create_deployment_strategy_request.serialize_json(input)
    ).encode()
