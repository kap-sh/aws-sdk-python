...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.create_deployment_strategy_request.CreateDeploymentStrategyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appconfig.types.create_deployment_strategy_request.serialize_json(
            input_
        )
    ).encode()
