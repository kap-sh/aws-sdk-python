...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.get_configuration_request.GetConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{Environment}", quote(str(input_["environment"]), safe=""))
    url = url.replace("{Configuration}", quote(str(input_["configuration"]), safe=""))
    params: dict[str, str] = {}
    if "client_id" in input_:
        params["client_id"] = str(input_["client_id"])
    if "client_configuration_version" in input_:
        params["client_configuration_version"] = str(
            input_["client_configuration_version"]
        )
