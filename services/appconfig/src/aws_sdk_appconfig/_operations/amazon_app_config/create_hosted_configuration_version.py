...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PayloadTooLargeException":
            import aws_sdk_appconfig.errors.payload_too_large_exception

            raise aws_sdk_appconfig.errors.payload_too_large_exception.PayloadTooLargeException.from_json(
                data
            )
