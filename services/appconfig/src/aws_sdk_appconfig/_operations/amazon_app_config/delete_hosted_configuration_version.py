"""Generated from Smithy shape ``com.amazonaws.appconfig#DeleteHostedConfigurationVersion``."""
...
def build_request(
    ...
    input_: aws_sdk_appconfig.types.delete_hosted_configuration_version_request.DeleteHostedConfigurationVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_hosted_configuration_version(
