...
class AppConfigError(Exception):
    """Base class for all AppConfig service errors."""


class ServiceError(AppConfigError):
...
class SerializationError(AppConfigError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AppConfigError):
...
class WaiterFailedError(AppConfigError):
...
class WaiterTimeoutError(AppConfigError):
