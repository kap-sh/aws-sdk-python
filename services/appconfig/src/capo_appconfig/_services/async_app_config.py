...
from capo_appconfig._services._aws_config import aaws_config
...
class AsyncAppConfigClientConfig(TypedDict, total=False, closed=True):
...
class AsyncAppConfigClient:
    ...
    async def create_application(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_application(name='example-application', description='An application used for creating an example.')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.create_application_request.CreateApplicationRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.application.Application"]:
            import capo_appconfig._operations.amazon_app_config.create_application

            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.create_application.async_create_application(
    ...
    async def create_configuration_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_configuration_profile(application_id='339ohji', name='Example-Configuration-Profile', location_uri='ssm-parameter://Example-Parameter', retrieval_role_arn='arn:aws:iam::111122223333:role/Example-App-Config-Role')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.create_configuration_profile_request.CreateConfigurationProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.configuration_profile.ConfigurationProfile"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.create_configuration_profile.async_create_configuration_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_deployment_strategy(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_deployment_strategy(name='Example-Deployment', deployment_duration_in_minutes=15, growth_factor=25, replicate_to='SSM_DOCUMENT')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.create_deployment_strategy_request.CreateDeploymentStrategyRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.deployment_strategy.DeploymentStrategy"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.create_deployment_strategy.async_create_deployment_strategy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_environment(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_environment(application_id='339ohji', name='Example-Environment')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.create_environment_request.CreateEnvironmentRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.environment.Environment"]:
            import capo_appconfig._operations.amazon_app_config.create_environment

            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.create_environment.async_create_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_extension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.create_extension_request.CreateExtensionRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.extension.Extension"]:
            import capo_appconfig._operations.amazon_app_config.create_extension

            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.create_extension.async_create_extension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_extension_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.create_extension_association_request.CreateExtensionAssociationRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.extension_association.ExtensionAssociation"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.create_extension_association.async_create_extension_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_hosted_configuration_version(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_hosted_configuration_version(application_id='339ohji', configuration_profile_id='ur8hx2f', content='eyAiTmFtZSI6ICJFeGFtcGxlQXBwbGljYXRpb24iLCAiSWQiOiBFeGFtcGxlSUQsICJSYW5rIjogNyB9', content_type='text', latest_version_number=1)
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.create_hosted_configuration_version_request.CreateHostedConfigurationVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.hosted_configuration_version.HostedConfigurationVersion"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.create_hosted_configuration_version.async_create_hosted_configuration_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_application(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_application(application_id='339ohji')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.delete_application_request.DeleteApplicationRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.delete_application.async_delete_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_configuration_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_configuration_profile(application_id='339ohji', configuration_profile_id='ur8hx2f')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.delete_configuration_profile_request.DeleteConfigurationProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.delete_configuration_profile.async_delete_configuration_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_deployment_strategy(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_deployment_strategy(deployment_strategy_id='1225qzk')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.delete_deployment_strategy_request.DeleteDeploymentStrategyRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.delete_deployment_strategy.async_delete_deployment_strategy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_environment(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_environment(application_id='339ohji', environment_id='54j1r29')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.delete_environment_request.DeleteEnvironmentRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.delete_environment.async_delete_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_extension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.delete_extension_request.DeleteExtensionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.delete_extension.async_delete_extension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_extension_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.delete_extension_association_request.DeleteExtensionAssociationRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.delete_extension_association.async_delete_extension_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_hosted_configuration_version(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_hosted_configuration_version(application_id='339ohji', configuration_profile_id='ur8hx2f', version_number=1)
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.delete_hosted_configuration_version_request.DeleteHostedConfigurationVersionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.delete_hosted_configuration_version.async_delete_hosted_configuration_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_settings(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.get_account_settings.async_get_account_settings(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_application(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_application(application_id='339ohji')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.get_application_request.GetApplicationRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.application.Application"]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.get_application.async_get_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_configuration(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_configuration(application='example-application', environment='Example-Environment', configuration='Example-Configuration-Profile', client_id='example-id')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.get_configuration_request.GetConfigurationRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.configuration.Configuration"]:
            import capo_appconfig._operations.amazon_app_config.get_configuration

            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.get_configuration.async_get_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_configuration_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_configuration_profile(application_id='339ohji', configuration_profile_id='ur8hx2f')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.get_configuration_profile_request.GetConfigurationProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.configuration_profile.ConfigurationProfile"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.get_configuration_profile.async_get_configuration_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.get_deployment_request.GetDeploymentRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.deployment.Deployment"]:
            import capo_appconfig._operations.amazon_app_config.get_deployment

            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.get_deployment.async_get_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_deployment_strategy(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_deployment_strategy(deployment_strategy_id='1225qzk')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.get_deployment_strategy_request.GetDeploymentStrategyRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.deployment_strategy.DeploymentStrategy"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.get_deployment_strategy.async_get_deployment_strategy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_environment(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_environment(application_id='339ohji', environment_id='54j1r29')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.get_environment_request.GetEnvironmentRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.environment.Environment"]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.get_environment.async_get_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_extension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.get_extension_request.GetExtensionRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.extension.Extension"]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.get_extension.async_get_extension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_extension_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.get_extension_association_request.GetExtensionAssociationRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.extension_association.ExtensionAssociation"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.get_extension_association.async_get_extension_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_hosted_configuration_version(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_hosted_configuration_version(application_id='339ohji', configuration_profile_id='ur8hx2f', version_number=1)
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.get_hosted_configuration_version_request.GetHostedConfigurationVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.hosted_configuration_version.HostedConfigurationVersion"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.get_hosted_configuration_version.async_get_hosted_configuration_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_applications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.list_applications_request.ListApplicationsRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.applications.Applications"]:
            import capo_appconfig._operations.amazon_app_config.list_applications

            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.list_applications.async_list_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_applications(
        ...
        *,
        ...
        max_results: Optional["capo_appconfig.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_appconfig.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_appconfig.types.application.Application]":
        _token = next_token
        while True:
    ...
    async def list_configuration_profiles(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_configuration_profiles(application_id='339ohji')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.list_configuration_profiles_request.ListConfigurationProfilesRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.configuration_profiles.ConfigurationProfiles"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.list_configuration_profiles.async_list_configuration_profiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_appconfig.types.configuration_profile_summary.ConfigurationProfileSummary]":
        _token = next_token
        while True:
            _response = await self.list_configuration_profiles(
                application_id,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_deployments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.list_deployments_request.ListDeploymentsRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.deployments.Deployments"]:
            import capo_appconfig._operations.amazon_app_config.list_deployments

            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.list_deployments.async_list_deployments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_deployments(
        ...
        *,
        ...
        max_results: Optional["capo_appconfig.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_appconfig.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_appconfig.types.deployment_summary.DeploymentSummary]":
        _token = next_token
        while True:
    ...
    async def list_deployment_strategies(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_deployment_strategies()
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.list_deployment_strategies_request.ListDeploymentStrategiesRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.deployment_strategies.DeploymentStrategies"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.list_deployment_strategies.async_list_deployment_strategies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_deployment_strategies(
        ...
        *,
        ...
        max_results: Optional["capo_appconfig.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_appconfig.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_appconfig.types.deployment_strategy.DeploymentStrategy]":
        _token = next_token
        while True:
            _response = await self.list_deployment_strategies(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
    ...
    async def list_environments(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_environments(application_id='339ohji')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.list_environments_request.ListEnvironmentsRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.environments.Environments"]:
            import capo_appconfig._operations.amazon_app_config.list_environments

            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.list_environments.async_list_environments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_environments(
        ...
        *,
        ...
        max_results: Optional["capo_appconfig.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_appconfig.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_appconfig.types.environment.Environment]":
        _token = next_token
        while True:
    ...
    async def list_extension_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.list_extension_associations_request.ListExtensionAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.extension_associations.ExtensionAssociations"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.list_extension_associations.async_list_extension_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_extension_associations(
        ...
        *,
        ...
        max_results: Optional["capo_appconfig.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_appconfig.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_appconfig.types.extension_association_summary.ExtensionAssociationSummary]":
        _token = next_token
        while True:
            _response = await self.list_extension_associations(
                config_overrides=config_overrides,
    ...
    async def list_extensions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.list_extensions_request.ListExtensionsRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.extensions.Extensions"]:
            import capo_appconfig._operations.amazon_app_config.list_extensions

            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.list_extensions.async_list_extensions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_extensions(
        ...
        *,
        ...
        next_token: Optional["capo_appconfig.types.next_token.NextToken"] = None,
        name: Optional["capo_appconfig.types.query_name.QueryName"] = None,
    ) -> "AsyncIterator[capo_appconfig.types.extension_summary.ExtensionSummary]":
        _token = next_token
        while True:
            _response = await self.list_extensions(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
                name=name,
    ...
    async def list_hosted_configuration_versions(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_hosted_configuration_versions(application_id='339ohji', configuration_profile_id='ur8hx2f')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.list_hosted_configuration_versions_request.ListHostedConfigurationVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.hosted_configuration_versions.HostedConfigurationVersions"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.list_hosted_configuration_versions.async_list_hosted_configuration_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_hosted_configuration_versions(
        ...
        *,
        ...
        next_token: Optional["capo_appconfig.types.next_token.NextToken"] = None,
        version_label: Optional["capo_appconfig.types.query_name.QueryName"] = None,
    ) -> "AsyncIterator[capo_appconfig.types.hosted_configuration_version_summary.HostedConfigurationVersionSummary]":
        _token = next_token
        while True:
            _response = await self.list_hosted_configuration_versions(
                application_id,
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_tags_for_resource(resource_arn='arn:aws:appconfig:us-east-1:111122223333:application/339ohji')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.resource_tags.ResourceTags"]:
            import capo_appconfig._operations.amazon_app_config.list_tags_for_resource

            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.start_deployment_request.StartDeploymentRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.deployment.Deployment"]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.start_deployment.async_start_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_deployment(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.stop_deployment(application_id='339ohji', environment_id='54j1r29', deployment_number=2)
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.stop_deployment_request.StopDeploymentRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.deployment.Deployment"]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.stop_deployment.async_stop_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.tag_resource(resource_arn='arn:aws:appconfig:us-east-1:111122223333:application/339ohji', tags={'group1': '1'})
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.untag_resource(resource_arn='arn:aws:appconfig:us-east-1:111122223333:application/339ohji', tag_keys=['group1'])
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.update_account_settings_request.UpdateAccountSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.account_settings.AccountSettings"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.update_account_settings.async_update_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_application(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_application(application_id='339ohji', name='Example-Application', description='')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.update_application_request.UpdateApplicationRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.application.Application"]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.update_application.async_update_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_configuration_profile(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_configuration_profile(application_id='339ohji', configuration_profile_id='ur8hx2f', description='Configuration profile used for examples.')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.update_configuration_profile_request.UpdateConfigurationProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.configuration_profile.ConfigurationProfile"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.update_configuration_profile.async_update_configuration_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_deployment_strategy(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_deployment_strategy(deployment_strategy_id='1225qzk', final_bake_time_in_minutes=20)
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.update_deployment_strategy_request.UpdateDeploymentStrategyRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.deployment_strategy.DeploymentStrategy"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.update_deployment_strategy.async_update_deployment_strategy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_environment(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_environment(application_id='339ohji', environment_id='54j1r29', description='An environment for examples.')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.update_environment_request.UpdateEnvironmentRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.environment.Environment"]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.update_environment.async_update_environment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_extension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.update_extension_request.UpdateExtensionRequest]",
        ) -> AsyncOperationResponse["capo_appconfig.types.extension.Extension"]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.update_extension.async_update_extension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_extension_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.update_extension_association_request.UpdateExtensionAssociationRequest]",
        ) -> AsyncOperationResponse[
            "capo_appconfig.types.extension_association.ExtensionAssociation"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.update_extension_association.async_update_extension_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_configuration(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.validate_configuration(application_id='abc1234', configuration_profile_id='ur8hx2f', configuration_version='1')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_appconfig.types.validate_configuration_request.ValidateConfigurationRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_appconfig._operations.amazon_app_config.validate_configuration.async_validate_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
