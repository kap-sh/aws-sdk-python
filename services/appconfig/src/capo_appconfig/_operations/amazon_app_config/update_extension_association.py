...
def handle_response(
    ...
    out: capo_appconfig.types.extension_association.ExtensionAssociation = (
        capo_appconfig.types.extension_association.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appconfig.types.update_extension_association_request.serialize_json(input_)
    ).encode()
...
def update_extension_association(
    ...
    capo_appconfig.types.extension_association.ExtensionAssociation, zapros.Response
]:
