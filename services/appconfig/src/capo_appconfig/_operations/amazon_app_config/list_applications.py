"""Generated from Smithy shape ``com.amazonaws.appconfig#ListApplications``."""
...
import capo_appconfig.types.application_list
...
def handle_response(
    ...
    out: capo_appconfig.types.applications.Applications = (
        capo_appconfig.types.applications.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_appconfig.types.applications.Applications = (
        capo_appconfig.types.applications.deserialize_json(
...
def list_applications(
    ...
    input_: capo_appconfig.types.list_applications_request.ListApplicationsRequest,
) -> tuple[capo_appconfig.types.applications.Applications, zapros.Response]:
