"""Generated from Smithy shape ``com.amazonaws.appconfig#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_appconfig.types.resource_tags.ResourceTags = (
        capo_appconfig.types.resource_tags.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_appconfig.types.resource_tags.ResourceTags = (
        capo_appconfig.types.resource_tags.deserialize_json(
...
def list_tags_for_resource(
    ...
    input_: capo_appconfig.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> tuple[capo_appconfig.types.resource_tags.ResourceTags, zapros.Response]:
