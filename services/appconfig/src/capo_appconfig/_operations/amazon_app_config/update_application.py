...
def handle_response(
    ...
    out: capo_appconfig.types.application.Application = (
        capo_appconfig.types.application.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_appconfig.types.application.Application = (
        capo_appconfig.types.application.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appconfig.types.update_application_request.serialize_json(input_)
    ).encode()
...
def update_application(
    ...
    input_: capo_appconfig.types.update_application_request.UpdateApplicationRequest,
) -> tuple[capo_appconfig.types.application.Application, zapros.Response]:
