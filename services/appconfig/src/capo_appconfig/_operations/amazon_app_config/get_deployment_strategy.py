"""Generated from Smithy shape ``com.amazonaws.appconfig#GetDeploymentStrategy``."""
...
def handle_response(
    ...
    out: capo_appconfig.types.deployment_strategy.DeploymentStrategy = (
        capo_appconfig.types.deployment_strategy.deserialize_json(
...
def get_deployment_strategy(
    ...
    capo_appconfig.types.deployment_strategy.DeploymentStrategy, zapros.Response
]:
...
async def async_get_deployment_strategy(
