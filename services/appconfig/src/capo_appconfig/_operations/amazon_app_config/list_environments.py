"""Generated from Smithy shape ``com.amazonaws.appconfig#ListEnvironments``."""
...
def handle_response(
    ...
    out: capo_appconfig.types.environments.Environments = (
        capo_appconfig.types.environments.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_appconfig.types.environments.Environments = (
        capo_appconfig.types.environments.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{ApplicationId}/environments"
...
def list_environments(
    ...
    input_: capo_appconfig.types.list_environments_request.ListEnvironmentsRequest,
) -> tuple[capo_appconfig.types.environments.Environments, zapros.Response]:
