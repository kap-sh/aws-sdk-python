"""Generated from Smithy shape ``com.amazonaws.appconfig#ListExtensionAssociations``."""
...
import capo_appconfig.types.extension_association_summaries
...
def handle_response(
    ...
    out: capo_appconfig.types.extension_associations.ExtensionAssociations = (
        capo_appconfig.types.extension_associations.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/extensionassociations"
    params: dict[str, str] = {}
    if "resource_identifier" in input_:
        params["resource_identifier"] = str(input_["resource_identifier"])
    if "extension_identifier" in input_:
        params["extension_identifier"] = str(input_["extension_identifier"])
    if "extension_version_number" in input_:
        params["extension_version_number"] = str(input_["extension_version_number"])
...
def list_extension_associations(
    ...
    capo_appconfig.types.extension_associations.ExtensionAssociations, zapros.Response
]:
...
async def async_list_extension_associations(
