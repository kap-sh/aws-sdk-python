...
import capo_appconfig.types.deployment_strategy_list
...
def handle_response(
    ...
    out: capo_appconfig.types.deployment_strategies.DeploymentStrategies = (
        capo_appconfig.types.deployment_strategies.deserialize_json(
...
def list_deployment_strategies(
    ...
    capo_appconfig.types.deployment_strategies.DeploymentStrategies, zapros.Response
]:
