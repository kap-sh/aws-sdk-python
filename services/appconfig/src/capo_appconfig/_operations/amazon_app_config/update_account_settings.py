"""Generated from Smithy shape ``com.amazonaws.appconfig#UpdateAccountSettings``."""
...
def handle_response(
    ...
    out: capo_appconfig.types.account_settings.AccountSettings = (
        capo_appconfig.types.account_settings.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appconfig.types.update_account_settings_request.serialize_json(input_)
    ).encode()
...
def update_account_settings(
    ...
    input_: capo_appconfig.types.update_account_settings_request.UpdateAccountSettingsRequest,
) -> tuple[capo_appconfig.types.account_settings.AccountSettings, zapros.Response]:
