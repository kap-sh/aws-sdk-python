...
def handle_response(
    ...
    out: aws_sdk_pipes.types.update_pipe_response.UpdatePipeResponse = (
        aws_sdk_pipes.types.update_pipe_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pipes.types.update_pipe_request.UpdatePipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pipes.types.update_pipe_request.serialize_json(input_)
    ).encode()
...
def update_pipe(
    ...
    aws_sdk_pipes.types.update_pipe_response.UpdatePipeResponse, zapros.Response
]:
