"""Generated from Smithy shape ``com.amazonaws.pipes#StartPipe``."""
...
import aws_sdk_pipes.errors.conflict_exception
import aws_sdk_pipes.errors.internal_exception
import aws_sdk_pipes.errors.not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise aws_sdk_pipes.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "NotFoundException":
            raise aws_sdk_pipes.errors.not_found_exception.NotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_pipes.types.start_pipe_response.StartPipeResponse = (
        aws_sdk_pipes.types.start_pipe_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pipes.types.start_pipe_request.StartPipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/pipes/{Name}/start"
...
def start_pipe(
    ...
    input_: aws_sdk_pipes.types.start_pipe_request.StartPipeRequest,
) -> tuple[aws_sdk_pipes.types.start_pipe_response.StartPipeResponse, zapros.Response]:
