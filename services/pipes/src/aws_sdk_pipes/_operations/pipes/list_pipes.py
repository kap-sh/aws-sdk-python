...
def build_request(
    ...
    input: aws_sdk_pipes.types.list_pipes_request.ListPipesRequest,
) -> zapros.Request:
    ...
    if "desired_state" in input:
        params["DesiredState"] = str(input["desired_state"])
    if "current_state" in input:
        params["CurrentState"] = str(input["current_state"])
    if "source_prefix" in input:
        params["SourcePrefix"] = str(input["source_prefix"])
    if "target_prefix" in input:
        params["TargetPrefix"] = str(input["target_prefix"])
