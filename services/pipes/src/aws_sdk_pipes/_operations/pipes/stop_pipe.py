"""Generated from Smithy shape ``com.amazonaws.pipes#StopPipe``."""
...
def handle_response(
    ...
    out: aws_sdk_pipes.types.stop_pipe_response.StopPipeResponse = (
        aws_sdk_pipes.types.stop_pipe_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pipes.types.stop_pipe_request.StopPipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/pipes/{Name}/stop"
...
def stop_pipe(
    ...
    input_: aws_sdk_pipes.types.stop_pipe_request.StopPipeRequest,
) -> tuple[aws_sdk_pipes.types.stop_pipe_response.StopPipeResponse, zapros.Response]:
