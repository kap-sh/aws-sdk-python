...
def handle_response(
    ...
    out: aws_sdk_pipes.types.describe_pipe_response.DescribePipeResponse = (
        aws_sdk_pipes.types.describe_pipe_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pipes.types.describe_pipe_request.DescribePipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_pipe(
    ...
    aws_sdk_pipes.types.describe_pipe_response.DescribePipeResponse, zapros.Response
]:
