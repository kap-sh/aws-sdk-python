...
def handle_response(
    ...
    out: aws_sdk_pipes.types.delete_pipe_response.DeletePipeResponse = (
        aws_sdk_pipes.types.delete_pipe_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pipes.types.delete_pipe_request.DeletePipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_pipe(
    ...
    aws_sdk_pipes.types.delete_pipe_response.DeletePipeResponse, zapros.Response
]:
