...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_pipes.errors.service_quota_exceeded_exception

            raise aws_sdk_pipes.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_pipes.types.create_pipe_response.CreatePipeResponse = (
        aws_sdk_pipes.types.create_pipe_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pipes.types.create_pipe_request.CreatePipeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pipes.types.create_pipe_request.serialize_json(input)
    ).encode()
...
def create_pipe(
    ...
    aws_sdk_pipes.types.create_pipe_response.CreatePipeResponse, zapros.Response
]:
