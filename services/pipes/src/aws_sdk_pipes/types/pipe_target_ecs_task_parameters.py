...
if TYPE_CHECKING:
    ...
    import aws_sdk_pipes.types.boolean
    import aws_sdk_pipes.types.capacity_provider_strategy
    import aws_sdk_pipes.types.ecs_task_override
    import aws_sdk_pipes.types.launch_type
    import aws_sdk_pipes.types.limit_min1
    import aws_sdk_pipes.types.network_configuration
    import aws_sdk_pipes.types.placement_constraints
    import aws_sdk_pipes.types.placement_strategies
    import aws_sdk_pipes.types.propagate_tags
    import aws_sdk_pipes.types.reference_id
...
class PipeTargetEcsTaskParameters(TypedDict):
    ...
    launch_type: NotRequired["aws_sdk_pipes.types.launch_type.LaunchType"]
    ...
    network_configuration: NotRequired[
        "aws_sdk_pipes.types.network_configuration.NetworkConfiguration"
    ]
    ...
    platform_version: NotRequired["aws_sdk_pipes.types.string.String"]
    ...
    group: NotRequired["aws_sdk_pipes.types.string.String"]
    ...
    capacity_provider_strategy: NotRequired[
        "aws_sdk_pipes.types.capacity_provider_strategy.CapacityProviderStrategy"
    ]
    ...
    enable_ecs_managed_tags: "aws_sdk_pipes.types.boolean.Boolean"
    ...
    enable_execute_command: "aws_sdk_pipes.types.boolean.Boolean"
    ...
    placement_constraints: NotRequired[
        "aws_sdk_pipes.types.placement_constraints.PlacementConstraints"
    ]
    ...
    placement_strategy: NotRequired[
        "aws_sdk_pipes.types.placement_strategies.PlacementStrategies"
    ]
    """<p>The placement strategy objects to use for the task. You can specify a maximum of five strategy rules per task. </p>"""
    propagate_tags: NotRequired["aws_sdk_pipes.types.propagate_tags.PropagateTags"]
    ...
    reference_id: NotRequired["aws_sdk_pipes.types.reference_id.ReferenceId"]
    """<p>The reference ID to use for the task.</p>"""
    overrides: NotRequired["aws_sdk_pipes.types.ecs_task_override.EcsTaskOverride"]
    """<p>The overrides that are associated with a task.</p>"""
    tags: NotRequired["aws_sdk_pipes.types.tag_list.TagList"]
...
def serialize_json(value: PipeTargetEcsTaskParameters) -> dict:
    ...
    if "network_configuration" in value:
        ...
        out["NetworkConfiguration"] = (
            aws_sdk_pipes.types.network_configuration.serialize_json(
    ...
    if "capacity_provider_strategy" in value:
        ...
        out["CapacityProviderStrategy"] = (
            aws_sdk_pipes.types.capacity_provider_strategy.serialize_json(
    ...
    if "placement_constraints" in value:
        ...
        out["PlacementConstraints"] = (
            aws_sdk_pipes.types.placement_constraints.serialize_json(
    ...
    if "placement_strategy" in value:
        ...
        out["PlacementStrategy"] = (
            aws_sdk_pipes.types.placement_strategies.serialize_json(
    ...
    if "overrides" in value:
        ...
        out["Overrides"] = aws_sdk_pipes.types.ecs_task_override.serialize_json(
            value["overrides"]
        )
    if "tags" in value:
        import aws_sdk_pipes.types.tag_list

        out["Tags"] = aws_sdk_pipes.types.tag_list.serialize_json(value["tags"])
    return out
...
def deserialize_json(data: dict) -> PipeTargetEcsTaskParameters:
    ...
    if "NetworkConfiguration" in data:
        ...
        out["network_configuration"] = (
            aws_sdk_pipes.types.network_configuration.deserialize_json(
    ...
    if "CapacityProviderStrategy" in data:
        ...
        out["capacity_provider_strategy"] = (
            aws_sdk_pipes.types.capacity_provider_strategy.deserialize_json(
    ...
    if "PlacementConstraints" in data:
        ...
        out["placement_constraints"] = (
            aws_sdk_pipes.types.placement_constraints.deserialize_json(
    ...
    if "PlacementStrategy" in data:
        ...
        out["placement_strategy"] = (
            aws_sdk_pipes.types.placement_strategies.deserialize_json(
    ...
    if "Overrides" in data:
        ...
        out["overrides"] = aws_sdk_pipes.types.ecs_task_override.deserialize_json(
            data["Overrides"]
        )
    if "Tags" in data:
        import aws_sdk_pipes.types.tag_list

        out["tags"] = aws_sdk_pipes.types.tag_list.deserialize_json(data["Tags"])
    return out
