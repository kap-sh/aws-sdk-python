"""Generated from Smithy shape ``com.amazonaws.pipes#UpdatePipeSourceDynamoDBStreamParameters``."""
...
class UpdatePipeSourceDynamoDBStreamParameters(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdatePipeSourceDynamoDBStreamParameters) -> dict:
    out: dict = {}
