...
if TYPE_CHECKING:
    ...
    import aws_sdk_pipes.types.database
    import aws_sdk_pipes.types.db_user
    import aws_sdk_pipes.types.secret_manager_arn_or_json_path
    import aws_sdk_pipes.types.sqls
...
class PipeTargetRedshiftDataParameters(TypedDict, closed=True):
    ...
    database: "aws_sdk_pipes.types.database.Database"
    """<p>The name of the database. Required when authenticating using temporary credentials.</p>"""
    db_user: NotRequired["aws_sdk_pipes.types.db_user.DbUser"]
    """<p>The database user name. Required when authenticating using temporary credentials.</p>"""
    statement_name: NotRequired["aws_sdk_pipes.types.statement_name.StatementName"]
    """<p>The name of the SQL statement. You can name the SQL statement when you create it to identify the query.</p>"""
    with_event: "aws_sdk_pipes.types.boolean.Boolean"
    """<p>Indicates whether to send an event back to EventBridge after the SQL statement runs.</p>"""
    sqls: "aws_sdk_pipes.types.sqls.Sqls"
...
def serialize_json(value: PipeTargetRedshiftDataParameters) -> dict:
    ...
    out["Sqls"] = aws_sdk_pipes.types.sqls.serialize_json(value["sqls"])
    return out
...
def deserialize_json(data: dict) -> PipeTargetRedshiftDataParameters:
    ...
    if "Sqls" in data:
        ...
        out["sqls"] = aws_sdk_pipes.types.sqls.deserialize_json(data["Sqls"])
    else:
