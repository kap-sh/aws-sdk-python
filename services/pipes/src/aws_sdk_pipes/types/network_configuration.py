"""Generated from Smithy shape ``com.amazonaws.pipes#NetworkConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_pipes.types.aws_vpc_configuration


class NetworkConfiguration(TypedDict):
    awsvpc_configuration: NotRequired[
        "aws_sdk_pipes.types.aws_vpc_configuration.AwsVpcConfiguration"
    ]
...
def serialize_json(value: NetworkConfiguration) -> dict:
    ...
    if "awsvpc_configuration" in value:
        ...
        out["awsvpcConfiguration"] = (
            aws_sdk_pipes.types.aws_vpc_configuration.serialize_json(
...
def deserialize_json(data: dict) -> NetworkConfiguration:
    ...
    if "awsvpcConfiguration" in data:
        ...
        out["awsvpc_configuration"] = (
            aws_sdk_pipes.types.aws_vpc_configuration.deserialize_json(
