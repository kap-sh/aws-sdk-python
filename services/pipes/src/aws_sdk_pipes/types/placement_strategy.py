...
if TYPE_CHECKING:
    import aws_sdk_pipes.types.placement_strategy_field
    import aws_sdk_pipes.types.placement_strategy_type


class PlacementStrategy(TypedDict):
    type: NotRequired[
        "aws_sdk_pipes.types.placement_strategy_type.PlacementStrategyType"
    ]
    ...
    field: NotRequired[
        "aws_sdk_pipes.types.placement_strategy_field.PlacementStrategyField"
    ]
