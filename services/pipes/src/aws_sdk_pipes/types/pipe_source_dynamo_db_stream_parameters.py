...
if TYPE_CHECKING:
    ...
    import aws_sdk_pipes.types.dynamo_db_stream_start_position
...
class PipeSourceDynamoDBStreamParameters(TypedDict):
    ...
    starting_position: "aws_sdk_pipes.types.dynamo_db_stream_start_position.DynamoDBStreamStartPosition"
