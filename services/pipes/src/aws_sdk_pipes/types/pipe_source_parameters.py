...
if TYPE_CHECKING:
    ...
    import aws_sdk_pipes.types.pipe_source_active_mq_broker_parameters
    import aws_sdk_pipes.types.pipe_source_dynamo_db_stream_parameters
    import aws_sdk_pipes.types.pipe_source_kinesis_stream_parameters
    import aws_sdk_pipes.types.pipe_source_managed_streaming_kafka_parameters
    import aws_sdk_pipes.types.pipe_source_rabbit_mq_broker_parameters
    import aws_sdk_pipes.types.pipe_source_self_managed_kafka_parameters
...
class PipeSourceParameters(TypedDict, closed=True):
    ...
    kinesis_stream_parameters: NotRequired[
        "aws_sdk_pipes.types.pipe_source_kinesis_stream_parameters.PipeSourceKinesisStreamParameters"
    ]
    """<p>The parameters for using a Kinesis stream as a source.</p>"""
    dynamo_db_stream_parameters: NotRequired[
        "aws_sdk_pipes.types.pipe_source_dynamo_db_stream_parameters.PipeSourceDynamoDBStreamParameters"
    ]
    """<p>The parameters for using a DynamoDB stream as a source.</p>"""
    sqs_queue_parameters: NotRequired[
        "aws_sdk_pipes.types.pipe_source_sqs_queue_parameters.PipeSourceSqsQueueParameters"
    ]
    """<p>The parameters for using a Amazon SQS stream as a source.</p>"""
    active_mq_broker_parameters: NotRequired[
        "aws_sdk_pipes.types.pipe_source_active_mq_broker_parameters.PipeSourceActiveMQBrokerParameters"
    ]
    """<p>The parameters for using an Active MQ broker as a source.</p>"""
    rabbit_mq_broker_parameters: NotRequired[
        "aws_sdk_pipes.types.pipe_source_rabbit_mq_broker_parameters.PipeSourceRabbitMQBrokerParameters"
    ]
    """<p>The parameters for using a Rabbit MQ broker as a source.</p>"""
    managed_streaming_kafka_parameters: NotRequired[
        "aws_sdk_pipes.types.pipe_source_managed_streaming_kafka_parameters.PipeSourceManagedStreamingKafkaParameters"
    ]
    """<p>The parameters for using an MSK stream as a source.</p>"""
    self_managed_kafka_parameters: NotRequired[
        "aws_sdk_pipes.types.pipe_source_self_managed_kafka_parameters.PipeSourceSelfManagedKafkaParameters"
    ]
...
def serialize_json(value: PipeSourceParameters) -> dict:
    ...
    if "kinesis_stream_parameters" in value:
        ...
        out["KinesisStreamParameters"] = (
            aws_sdk_pipes.types.pipe_source_kinesis_stream_parameters.serialize_json(
    ...
    if "dynamo_db_stream_parameters" in value:
        ...
        out["DynamoDBStreamParameters"] = (
            aws_sdk_pipes.types.pipe_source_dynamo_db_stream_parameters.serialize_json(
    ...
    if "sqs_queue_parameters" in value:
        ...
        out["SqsQueueParameters"] = (
            aws_sdk_pipes.types.pipe_source_sqs_queue_parameters.serialize_json(
    ...
    if "active_mq_broker_parameters" in value:
        ...
        out["ActiveMQBrokerParameters"] = (
            aws_sdk_pipes.types.pipe_source_active_mq_broker_parameters.serialize_json(
    ...
    if "rabbit_mq_broker_parameters" in value:
        ...
        out["RabbitMQBrokerParameters"] = (
            aws_sdk_pipes.types.pipe_source_rabbit_mq_broker_parameters.serialize_json(
    ...
    if "managed_streaming_kafka_parameters" in value:
        ...
        out["ManagedStreamingKafkaParameters"] = (
            aws_sdk_pipes.types.pipe_source_managed_streaming_kafka_parameters.serialize_json(
    ...
    if "self_managed_kafka_parameters" in value:
        ...
        out["SelfManagedKafkaParameters"] = (
            aws_sdk_pipes.types.pipe_source_self_managed_kafka_parameters.serialize_json(
...
def deserialize_json(data: dict) -> PipeSourceParameters:
    ...
    if "KinesisStreamParameters" in data:
        ...
        out["kinesis_stream_parameters"] = (
            aws_sdk_pipes.types.pipe_source_kinesis_stream_parameters.deserialize_json(
    ...
    if "DynamoDBStreamParameters" in data:
        ...
        out["dynamo_db_stream_parameters"] = (
            aws_sdk_pipes.types.pipe_source_dynamo_db_stream_parameters.deserialize_json(
    ...
    if "SqsQueueParameters" in data:
        ...
        out["sqs_queue_parameters"] = (
            aws_sdk_pipes.types.pipe_source_sqs_queue_parameters.deserialize_json(
    ...
    if "ActiveMQBrokerParameters" in data:
        ...
        out["active_mq_broker_parameters"] = (
            aws_sdk_pipes.types.pipe_source_active_mq_broker_parameters.deserialize_json(
    ...
    if "RabbitMQBrokerParameters" in data:
        ...
        out["rabbit_mq_broker_parameters"] = (
            aws_sdk_pipes.types.pipe_source_rabbit_mq_broker_parameters.deserialize_json(
    ...
    if "ManagedStreamingKafkaParameters" in data:
        ...
        out["managed_streaming_kafka_parameters"] = (
            aws_sdk_pipes.types.pipe_source_managed_streaming_kafka_parameters.deserialize_json(
    ...
    if "SelfManagedKafkaParameters" in data:
        ...
        out["self_managed_kafka_parameters"] = (
            aws_sdk_pipes.types.pipe_source_self_managed_kafka_parameters.deserialize_json(
