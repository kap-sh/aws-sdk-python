...
class PipesError(Exception):
    """Base class for all Pipes service errors."""


class ServiceError(PipesError):
...
class SerializationError(PipesError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PipesError):
...
class WaiterFailedError(PipesError):
...
class WaiterTimeoutError(PipesError):
