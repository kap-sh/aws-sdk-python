...
class UpdatePipeSourceParameters(TypedDict, closed=True):
    ...
    kinesis_stream_parameters: NotRequired[
        "capo_pipes.types.update_pipe_source_kinesis_stream_parameters.UpdatePipeSourceKinesisStreamParameters"
    ]
    """<p>The parameters for using a Kinesis stream as a source.</p>"""
    dynamo_db_stream_parameters: NotRequired[
        "capo_pipes.types.update_pipe_source_dynamo_db_stream_parameters.UpdatePipeSourceDynamoDBStreamParameters"
    ]
    """<p>The parameters for using a DynamoDB stream as a source.</p>"""
    sqs_queue_parameters: NotRequired[
        "capo_pipes.types.update_pipe_source_sqs_queue_parameters.UpdatePipeSourceSqsQueueParameters"
    ]
    """<p>The parameters for using a Amazon SQS stream as a source.</p>"""
    active_mq_broker_parameters: NotRequired[
        "capo_pipes.types.update_pipe_source_active_mq_broker_parameters.UpdatePipeSourceActiveMQBrokerParameters"
    ]
    """<p>The parameters for using an Active MQ broker as a source.</p>"""
    rabbit_mq_broker_parameters: NotRequired[
        "capo_pipes.types.update_pipe_source_rabbit_mq_broker_parameters.UpdatePipeSourceRabbitMQBrokerParameters"
    ]
    """<p>The parameters for using a Rabbit MQ broker as a source.</p>"""
    managed_streaming_kafka_parameters: NotRequired[
        "capo_pipes.types.update_pipe_source_managed_streaming_kafka_parameters.UpdatePipeSourceManagedStreamingKafkaParameters"
    ]
    """<p>The parameters for using an MSK stream as a source.</p>"""
    self_managed_kafka_parameters: NotRequired[
        "capo_pipes.types.update_pipe_source_self_managed_kafka_parameters.UpdatePipeSourceSelfManagedKafkaParameters"
    ]
...
def serialize_json(value: UpdatePipeSourceParameters) -> dict:
    ...
    if "kinesis_stream_parameters" in value:
        ...
        out["KinesisStreamParameters"] = (
            capo_pipes.types.update_pipe_source_kinesis_stream_parameters.serialize_json(
    ...
    if "dynamo_db_stream_parameters" in value:
        ...
        out["DynamoDBStreamParameters"] = (
            capo_pipes.types.update_pipe_source_dynamo_db_stream_parameters.serialize_json(
    ...
    if "sqs_queue_parameters" in value:
        ...
        out["SqsQueueParameters"] = (
            capo_pipes.types.update_pipe_source_sqs_queue_parameters.serialize_json(
    ...
    if "active_mq_broker_parameters" in value:
        ...
        out["ActiveMQBrokerParameters"] = (
            capo_pipes.types.update_pipe_source_active_mq_broker_parameters.serialize_json(
    ...
    if "rabbit_mq_broker_parameters" in value:
        ...
        out["RabbitMQBrokerParameters"] = (
            capo_pipes.types.update_pipe_source_rabbit_mq_broker_parameters.serialize_json(
    ...
    if "managed_streaming_kafka_parameters" in value:
        ...
        out["ManagedStreamingKafkaParameters"] = (
            capo_pipes.types.update_pipe_source_managed_streaming_kafka_parameters.serialize_json(
    ...
    if "self_managed_kafka_parameters" in value:
        ...
        out["SelfManagedKafkaParameters"] = (
            capo_pipes.types.update_pipe_source_self_managed_kafka_parameters.serialize_json(
...
def deserialize_json(data: dict) -> UpdatePipeSourceParameters:
    ...
    if "KinesisStreamParameters" in data:
        ...
        out["kinesis_stream_parameters"] = (
            capo_pipes.types.update_pipe_source_kinesis_stream_parameters.deserialize_json(
    ...
    if "DynamoDBStreamParameters" in data:
        ...
        out["dynamo_db_stream_parameters"] = (
            capo_pipes.types.update_pipe_source_dynamo_db_stream_parameters.deserialize_json(
    ...
    if "SqsQueueParameters" in data:
        ...
        out["sqs_queue_parameters"] = (
            capo_pipes.types.update_pipe_source_sqs_queue_parameters.deserialize_json(
    ...
    if "ActiveMQBrokerParameters" in data:
        ...
        out["active_mq_broker_parameters"] = (
            capo_pipes.types.update_pipe_source_active_mq_broker_parameters.deserialize_json(
    ...
    if "RabbitMQBrokerParameters" in data:
        ...
        out["rabbit_mq_broker_parameters"] = (
            capo_pipes.types.update_pipe_source_rabbit_mq_broker_parameters.deserialize_json(
    ...
    if "ManagedStreamingKafkaParameters" in data:
        ...
        out["managed_streaming_kafka_parameters"] = (
            capo_pipes.types.update_pipe_source_managed_streaming_kafka_parameters.deserialize_json(
    ...
    if "SelfManagedKafkaParameters" in data:
        ...
        out["self_managed_kafka_parameters"] = (
            capo_pipes.types.update_pipe_source_self_managed_kafka_parameters.deserialize_json(
