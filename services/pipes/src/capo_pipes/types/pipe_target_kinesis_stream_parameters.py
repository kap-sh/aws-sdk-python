...
if TYPE_CHECKING:
    import capo_pipes.types.kinesis_partition_key


class PipeTargetKinesisStreamParameters(TypedDict, closed=True):
    partition_key: "capo_pipes.types.kinesis_partition_key.KinesisPartitionKey"
