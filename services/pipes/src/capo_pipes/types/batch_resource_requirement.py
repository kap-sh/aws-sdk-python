...
if TYPE_CHECKING:
    import capo_pipes.types.batch_resource_requirement_type


class BatchResourceRequirement(TypedDict, closed=True):
    type: (
        "capo_pipes.types.batch_resource_requirement_type.BatchResourceRequirementType"
    )
...
# --- restJson1 ser/de ---
def serialize_json(value: BatchResourceRequirement) -> dict:
    out: dict = {}
    out["Type"] = value["type"]
