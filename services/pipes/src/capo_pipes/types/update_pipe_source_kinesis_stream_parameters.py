...
# --- restJson1 ser/de ---
def serialize_json(value: UpdatePipeSourceKinesisStreamParameters) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdatePipeSourceKinesisStreamParameters:
    out: UpdatePipeSourceKinesisStreamParameters = {}  # type: ignore[typeddict-item]
