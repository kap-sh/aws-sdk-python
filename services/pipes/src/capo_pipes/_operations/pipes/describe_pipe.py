"""Generated from Smithy shape ``com.amazonaws.pipes#DescribePipe``."""
...
def handle_response(
    ...
    out: capo_pipes.types.describe_pipe_response.DescribePipeResponse = (
        capo_pipes.types.describe_pipe_response.deserialize_json(
...
def describe_pipe(
    ...
    capo_pipes.types.describe_pipe_response.DescribePipeResponse, zapros.Response
]:
