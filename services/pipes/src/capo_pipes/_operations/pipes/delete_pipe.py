"""Generated from Smithy shape ``com.amazonaws.pipes#DeletePipe``."""
...
def handle_response(
    ...
    out: capo_pipes.types.delete_pipe_response.DeletePipeResponse = (
        capo_pipes.types.delete_pipe_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_pipes.types.delete_pipe_request.DeletePipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_pipe(
    ...
    input_: capo_pipes.types.delete_pipe_request.DeletePipeRequest,
) -> tuple[capo_pipes.types.delete_pipe_response.DeletePipeResponse, zapros.Response]:
