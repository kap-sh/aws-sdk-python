"""Generated from Smithy shape ``com.amazonaws.pipes#UpdatePipe``."""
...
def handle_response(
    ...
    out: capo_pipes.types.update_pipe_response.UpdatePipeResponse = (
        capo_pipes.types.update_pipe_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pipes.types.update_pipe_request.serialize_json(input_)
    ).encode()
...
def update_pipe(
    ...
    input_: capo_pipes.types.update_pipe_request.UpdatePipeRequest,
) -> tuple[capo_pipes.types.update_pipe_response.UpdatePipeResponse, zapros.Response]:
