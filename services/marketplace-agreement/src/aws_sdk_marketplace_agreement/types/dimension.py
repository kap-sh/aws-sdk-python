...
if TYPE_CHECKING:
    ...
    import aws_sdk_marketplace_agreement.types.zero_value_integer


class Dimension(TypedDict, closed=True):
    dimension_key: "aws_sdk_marketplace_agreement.types.bounded_string.BoundedString"
    """<p>The name of key value of the dimension.</p>"""
    dimension_value: (
        "aws_sdk_marketplace_agreement.types.zero_value_integer.ZeroValueInteger"
    )
