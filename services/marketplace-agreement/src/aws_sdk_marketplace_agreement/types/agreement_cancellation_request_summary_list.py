...
AgreementCancellationRequestSummaryList: TypeAlias = list[
    "aws_sdk_marketplace_agreement.types.agreement_cancellation_request_summary.AgreementCancellationRequestSummary"
]
...
def serialize_aws_json_1_0(value: AgreementCancellationRequestSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_marketplace_agreement.types.agreement_cancellation_request_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> AgreementCancellationRequestSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_marketplace_agreement.types.agreement_cancellation_request_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
