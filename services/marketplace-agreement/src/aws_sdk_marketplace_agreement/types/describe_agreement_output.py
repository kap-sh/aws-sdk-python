...
class DescribeAgreementOutput(TypedDict):
    ...
    estimated_charges: NotRequired[
        "aws_sdk_marketplace_agreement.types.estimated_charges.EstimatedCharges"
    ]
...
def serialize_aws_json_1_0(value: DescribeAgreementOutput) -> dict:
    ...
    if "estimated_charges" in value:
        ...
        out["estimatedCharges"] = (
            aws_sdk_marketplace_agreement.types.estimated_charges.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DescribeAgreementOutput:
    ...
    if "estimatedCharges" in data:
        ...
        out["estimated_charges"] = (
            aws_sdk_marketplace_agreement.types.estimated_charges.deserialize_aws_json_1_0(
