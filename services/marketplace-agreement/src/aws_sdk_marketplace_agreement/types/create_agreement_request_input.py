...
class CreateAgreementRequestInput(TypedDict):
    ...
    requested_terms: (
        "aws_sdk_marketplace_agreement.types.requested_term_list.RequestedTermList"
    )
...
def serialize_aws_json_1_0(value: CreateAgreementRequestInput) -> dict:
    ...
    out["intent"] = aws_sdk_marketplace_agreement.types.intent.serialize_aws_json_1_0(
        value["intent"]
    )
    import aws_sdk_marketplace_agreement.types.requested_term_list

    out["requestedTerms"] = (
        aws_sdk_marketplace_agreement.types.requested_term_list.serialize_aws_json_1_0(
    ...
    if "tax_configuration" in value:
        ...
        out["taxConfiguration"] = (
            aws_sdk_marketplace_agreement.types.tax_configuration.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> CreateAgreementRequestInput:
    ...
    if "intent" in data:
        ...
        out["intent"] = (
            aws_sdk_marketplace_agreement.types.intent.deserialize_aws_json_1_0(
                data["intent"]
            )
        )
    else:
    ...
    if "requestedTerms" in data:
        ...
        out["requested_terms"] = (
            aws_sdk_marketplace_agreement.types.requested_term_list.deserialize_aws_json_1_0(
                data["requestedTerms"]
            )
        )
    else:
    ...
    if "taxConfiguration" in data:
        ...
        out["tax_configuration"] = (
            aws_sdk_marketplace_agreement.types.tax_configuration.deserialize_aws_json_1_0(
