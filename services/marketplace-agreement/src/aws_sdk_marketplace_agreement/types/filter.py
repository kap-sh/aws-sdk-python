...
class Filter(TypedDict, closed=True):
    ...
    values: NotRequired[
        "aws_sdk_marketplace_agreement.types.filter_value_list.FilterValueList"
    ]
...
def serialize_aws_json_1_0(value: Filter) -> dict:
    ...
    if "values" in value:
        ...
        out["values"] = (
            aws_sdk_marketplace_agreement.types.filter_value_list.serialize_aws_json_1_0(
                value["values"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> Filter:
    ...
    if "values" in data:
        ...
        out["values"] = (
            aws_sdk_marketplace_agreement.types.filter_value_list.deserialize_aws_json_1_0(
                data["values"]
            )
        )
    return out
