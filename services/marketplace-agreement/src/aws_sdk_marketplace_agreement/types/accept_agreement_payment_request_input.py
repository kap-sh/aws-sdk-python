...
class AcceptAgreementPaymentRequestInput(TypedDict):
    ...
    purchase_order_reference: NotRequired["aws_sdk_marketplace_agreement.types.purchase_order_reference.PurchaseOrderReference"]
...
def deserialize_aws_json_1_0(data: dict) -> AcceptAgreementPaymentRequestInput:
    ...
    if "paymentRequestId" in data:
        ...
        raise DeserializationError("AcceptAgreementPaymentRequestInput.payment_request_id required")
    if "agreementId" in data:
        out["agreement_id"] = data["agreementId"]
    else:
        raise DeserializationError("AcceptAgreementPaymentRequestInput.agreement_id required")
