...
if TYPE_CHECKING:
    import aws_sdk_marketplace_agreement.types.accepted_term_list
    import aws_sdk_marketplace_agreement.types.next_token


class GetAgreementTermsOutput(TypedDict):
    accepted_terms: NotRequired[
        "aws_sdk_marketplace_agreement.types.accepted_term_list.AcceptedTermList"
    ]
...
def serialize_aws_json_1_0(value: GetAgreementTermsOutput) -> dict:
    ...
    if "accepted_terms" in value:
        ...
        out["acceptedTerms"] = (
            aws_sdk_marketplace_agreement.types.accepted_term_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetAgreementTermsOutput:
    ...
    if "acceptedTerms" in data:
        ...
        out["accepted_terms"] = (
            aws_sdk_marketplace_agreement.types.accepted_term_list.deserialize_aws_json_1_0(
                data["acceptedTerms"]
            )
        )
