...
class UsageBasedPricingTerm(TypedDict, closed=True):
    ...
    rate_cards: NotRequired[
        "aws_sdk_marketplace_agreement.types.usage_based_rate_card_list.UsageBasedRateCardList"
    ]
...
def serialize_aws_json_1_0(value: UsageBasedPricingTerm) -> dict:
    ...
    if "rate_cards" in value:
        ...
        out["rateCards"] = (
            aws_sdk_marketplace_agreement.types.usage_based_rate_card_list.serialize_aws_json_1_0(
                value["rate_cards"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> UsageBasedPricingTerm:
    ...
    if "rateCards" in data:
        ...
        out["rate_cards"] = (
            aws_sdk_marketplace_agreement.types.usage_based_rate_card_list.deserialize_aws_json_1_0(
                data["rateCards"]
            )
        )
    return out
