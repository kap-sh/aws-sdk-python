...
if TYPE_CHECKING:
    import aws_sdk_marketplace_agreement.types.access_denied_exception_reason
...
class AccessDeniedException_(TypedDict, closed=True):
    ...
    reason: NotRequired[
        "aws_sdk_marketplace_agreement.types.access_denied_exception_reason.AccessDeniedExceptionReason"
    ]
...
def serialize_aws_json_1_0(value: AccessDeniedException_) -> dict:
    ...
    if "reason" in value:
        ...
        out["reason"] = (
            aws_sdk_marketplace_agreement.types.access_denied_exception_reason.serialize_aws_json_1_0(
                value["reason"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> AccessDeniedException_:
    ...
    if "reason" in data:
        ...
        out["reason"] = (
            aws_sdk_marketplace_agreement.types.access_denied_exception_reason.deserialize_aws_json_1_0(
                data["reason"]
            )
        )
    return out
