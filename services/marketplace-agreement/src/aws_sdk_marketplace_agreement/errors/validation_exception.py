...
if TYPE_CHECKING:
    ...
    import aws_sdk_marketplace_agreement.types.validation_exception_field_list
    import aws_sdk_marketplace_agreement.types.validation_exception_reason
...
class ValidationException_(TypedDict):
    ...
    reason: NotRequired[
        "aws_sdk_marketplace_agreement.types.validation_exception_reason.ValidationExceptionReason"
    ]
    """<p>The reason associated with the error.</p>"""
    fields: NotRequired[
        "aws_sdk_marketplace_agreement.types.validation_exception_field_list.ValidationExceptionFieldList"
    ]
...
def serialize_aws_json_1_0(value: ValidationException_) -> dict:
    ...
    if "reason" in value:
        ...
        out["reason"] = (
            aws_sdk_marketplace_agreement.types.validation_exception_reason.serialize_aws_json_1_0(
                value["reason"]
            )
        )
    if "fields" in value:
        ...
        out["fields"] = (
            aws_sdk_marketplace_agreement.types.validation_exception_field_list.serialize_aws_json_1_0(
                value["fields"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ValidationException_:
    ...
    if "reason" in data:
        ...
        out["reason"] = (
            aws_sdk_marketplace_agreement.types.validation_exception_reason.deserialize_aws_json_1_0(
                data["reason"]
            )
        )
    if "fields" in data:
        ...
        out["fields"] = (
            aws_sdk_marketplace_agreement.types.validation_exception_field_list.deserialize_aws_json_1_0(
                data["fields"]
            )
        )
    return out
