...
class MarketplaceAgreementError(Exception):
    """Base class for all MarketplaceAgreement service errors."""

class ServiceError(MarketplaceAgreementError):
...
class SerializationError(MarketplaceAgreementError):
    """Raised when a value cannot be serialized."""

class DeserializationError(MarketplaceAgreementError):
...
class WaiterFailedError(MarketplaceAgreementError):
...
class WaiterTimeoutError(MarketplaceAgreementError):
