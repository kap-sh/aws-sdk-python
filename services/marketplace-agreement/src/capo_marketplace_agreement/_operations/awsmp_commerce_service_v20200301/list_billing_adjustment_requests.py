"""Generated from Smithy shape ``com.amazonaws.marketplaceagreement#ListBillingAdjustmentRequests``."""
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.list_billing_adjustment_requests_output.ListBillingAdjustmentRequestsOutput = capo_marketplace_agreement.types.list_billing_adjustment_requests_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.list_billing_adjustment_requests_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_billing_adjustment_requests(
