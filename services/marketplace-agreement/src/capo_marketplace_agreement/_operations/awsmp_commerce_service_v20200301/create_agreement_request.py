...
import capo_marketplace_agreement.errors.conflict_exception
...
import capo_marketplace_agreement.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_marketplace_agreement.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_marketplace_agreement.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.create_agreement_request_output.CreateAgreementRequestOutput = capo_marketplace_agreement.types.create_agreement_request_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.create_agreement_request_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
