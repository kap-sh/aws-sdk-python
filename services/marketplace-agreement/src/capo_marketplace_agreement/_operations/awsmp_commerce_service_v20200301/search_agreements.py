"""Generated from Smithy shape ``com.amazonaws.marketplaceagreement#SearchAgreements``."""
...
import capo_marketplace_agreement.types.agreement_view_summary_list
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.search_agreements_output.SearchAgreementsOutput = capo_marketplace_agreement.types.search_agreements_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSMPCommerceService_v20200301.SearchAgreements"
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.search_agreements_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_search_agreements(
