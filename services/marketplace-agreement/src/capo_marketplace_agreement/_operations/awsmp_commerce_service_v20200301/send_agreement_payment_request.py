"""Generated from Smithy shape ``com.amazonaws.marketplaceagreement#SendAgreementPaymentRequest``."""
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.send_agreement_payment_request_output.SendAgreementPaymentRequestOutput = capo_marketplace_agreement.types.send_agreement_payment_request_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.send_agreement_payment_request_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_send_agreement_payment_request(
