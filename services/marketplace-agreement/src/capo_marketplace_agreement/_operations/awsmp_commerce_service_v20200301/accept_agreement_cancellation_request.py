...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.accept_agreement_cancellation_request_output.AcceptAgreementCancellationRequestOutput = capo_marketplace_agreement.types.accept_agreement_cancellation_request_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.accept_agreement_cancellation_request_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
