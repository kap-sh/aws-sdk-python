...
import capo_marketplace_agreement.types.agreement_invoice_line_item_group_summaries
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.list_agreement_invoice_line_items_output.ListAgreementInvoiceLineItemsOutput = capo_marketplace_agreement.types.list_agreement_invoice_line_items_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.list_agreement_invoice_line_items_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
