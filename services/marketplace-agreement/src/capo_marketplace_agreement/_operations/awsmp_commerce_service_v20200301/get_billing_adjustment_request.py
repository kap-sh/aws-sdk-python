"""Generated from Smithy shape ``com.amazonaws.marketplaceagreement#GetBillingAdjustmentRequest``."""
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.get_billing_adjustment_request_output.GetBillingAdjustmentRequestOutput = capo_marketplace_agreement.types.get_billing_adjustment_request_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.get_billing_adjustment_request_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_billing_adjustment_request(
