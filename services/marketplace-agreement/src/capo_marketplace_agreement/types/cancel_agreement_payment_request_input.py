"""Generated from Smithy shape ``com.amazonaws.marketplaceagreement#CancelAgreementPaymentRequestInput``."""
...
class CancelAgreementPaymentRequestInput(TypedDict, closed=True):
    payment_request_id: (
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CancelAgreementPaymentRequestInput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> CancelAgreementPaymentRequestInput:
    out: CancelAgreementPaymentRequestInput = {}  # type: ignore[typeddict-item]
    if "paymentRequestId" in data:
        out["payment_request_id"] = data["paymentRequestId"]
    else:
        raise DeserializationError(
            "CancelAgreementPaymentRequestInput.payment_request_id required"
        )
    if "agreementId" in data:
        out["agreement_id"] = data["agreementId"]
    else:
        raise DeserializationError(
            "CancelAgreementPaymentRequestInput.agreement_id required"
        )
    return out
