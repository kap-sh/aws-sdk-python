...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.inference_component_container_specification
    import aws_sdk_sagemaker.types.inference_component_data_cache_config
...
class InferenceComponentSpecification(TypedDict):
    ...
    container: NotRequired[
        "aws_sdk_sagemaker.types.inference_component_container_specification.InferenceComponentContainerSpecification"
    ]
    ...
    data_cache_config: NotRequired[
        "aws_sdk_sagemaker.types.inference_component_data_cache_config.InferenceComponentDataCacheConfig"
    ]
...
def serialize_aws_json_1_1(value: InferenceComponentSpecification) -> dict:
    ...
    if "container" in value:
        ...
        out["Container"] = (
            aws_sdk_sagemaker.types.inference_component_container_specification.serialize_aws_json_1_1(
                value["container"]
            )
        )
    ...
    if "data_cache_config" in value:
        ...
        out["DataCacheConfig"] = (
            aws_sdk_sagemaker.types.inference_component_data_cache_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InferenceComponentSpecification:
    ...
    if "Container" in data:
        ...
        out["container"] = (
            aws_sdk_sagemaker.types.inference_component_container_specification.deserialize_aws_json_1_1(
                data["Container"]
            )
        )
    ...
    if "DataCacheConfig" in data:
        ...
        out["data_cache_config"] = (
            aws_sdk_sagemaker.types.inference_component_data_cache_config.deserialize_aws_json_1_1(
