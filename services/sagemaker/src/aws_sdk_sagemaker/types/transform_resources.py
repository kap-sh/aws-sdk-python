...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.transform_ami_version
    import aws_sdk_sagemaker.types.transform_instance_count
...
class TransformResources(TypedDict, closed=True):
    ...
    instance_count: NotRequired[
        "aws_sdk_sagemaker.types.transform_instance_count.TransformInstanceCount"
    ]
    ...
    transform_ami_version: NotRequired[
        "aws_sdk_sagemaker.types.transform_ami_version.TransformAmiVersion"
    ]
...
def serialize_aws_json_1_1(value: TransformResources) -> dict:
    ...
    if "instance_type" in value:
        ...
        out["InstanceType"] = (
            aws_sdk_sagemaker.types.transform_instance_type.serialize_aws_json_1_1(
                value["instance_type"]
            )
        )
