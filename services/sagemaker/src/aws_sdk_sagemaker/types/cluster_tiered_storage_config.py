...
class ClusterTieredStorageConfig(TypedDict, closed=True):
    ...
    instance_memory_allocation_percentage: NotRequired[
        "aws_sdk_sagemaker.types.cluster_instance_memory_allocation_percentage.ClusterInstanceMemoryAllocationPercentage"
    ]
...
def serialize_aws_json_1_1(value: ClusterTieredStorageConfig) -> dict:
    ...
    if "mode" in value:
        ...
        out["Mode"] = (
            aws_sdk_sagemaker.types.cluster_config_mode.serialize_aws_json_1_1(
                value["mode"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ClusterTieredStorageConfig:
    ...
    if "Mode" in data:
        ...
        out["mode"] = (
            aws_sdk_sagemaker.types.cluster_config_mode.deserialize_aws_json_1_1(
                data["Mode"]
            )
        )
