...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.batch_add_cluster_nodes_error_list
    import aws_sdk_sagemaker.types.node_addition_result_list


class BatchAddClusterNodesResponse(TypedDict):
    successful: (
        "aws_sdk_sagemaker.types.node_addition_result_list.NodeAdditionResultList"
    )
    ...
    failed: "aws_sdk_sagemaker.types.batch_add_cluster_nodes_error_list.BatchAddClusterNodesErrorList"
...
def serialize_aws_json_1_1(value: BatchAddClusterNodesResponse) -> dict:
    ...
    out["Successful"] = (
        aws_sdk_sagemaker.types.node_addition_result_list.serialize_aws_json_1_1(
            value["successful"]
        )
    )
    import aws_sdk_sagemaker.types.batch_add_cluster_nodes_error_list
    ...
    out["Failed"] = (
        aws_sdk_sagemaker.types.batch_add_cluster_nodes_error_list.serialize_aws_json_1_1(
            value["failed"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> BatchAddClusterNodesResponse:
    ...
    if "Successful" in data:
        ...
        out["successful"] = (
            aws_sdk_sagemaker.types.node_addition_result_list.deserialize_aws_json_1_1(
                data["Successful"]
            )
        )
    else:
    ...
    if "Failed" in data:
        ...
        out["failed"] = (
            aws_sdk_sagemaker.types.batch_add_cluster_nodes_error_list.deserialize_aws_json_1_1(
                data["Failed"]
            )
        )
    else:
