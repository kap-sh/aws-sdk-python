...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.monitoring_schedule_summary

MonitoringScheduleSummaryList: TypeAlias = list[
    "aws_sdk_sagemaker.types.monitoring_schedule_summary.MonitoringScheduleSummary"
]
...
def serialize_aws_json_1_1(value: MonitoringScheduleSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.monitoring_schedule_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> MonitoringScheduleSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.monitoring_schedule_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
