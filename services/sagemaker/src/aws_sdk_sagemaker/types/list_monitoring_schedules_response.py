...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.monitoring_schedule_summary_list
    import aws_sdk_sagemaker.types.next_token


class ListMonitoringSchedulesResponse(TypedDict):
    monitoring_schedule_summaries: NotRequired[
        "aws_sdk_sagemaker.types.monitoring_schedule_summary_list.MonitoringScheduleSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListMonitoringSchedulesResponse) -> dict:
    ...
    if "monitoring_schedule_summaries" in value:
        ...
        out["MonitoringScheduleSummaries"] = (
            aws_sdk_sagemaker.types.monitoring_schedule_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListMonitoringSchedulesResponse:
    ...
    if "MonitoringScheduleSummaries" in data:
        ...
        out["monitoring_schedule_summaries"] = (
            aws_sdk_sagemaker.types.monitoring_schedule_summary_list.deserialize_aws_json_1_1(
