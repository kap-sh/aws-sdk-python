...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.media_type
    import aws_sdk_sagemaker.types.trial_component_artifact_value


class TrialComponentArtifact(TypedDict):
    media_type: NotRequired["aws_sdk_sagemaker.types.media_type.MediaType"]
    ...
    value: NotRequired[
        "aws_sdk_sagemaker.types.trial_component_artifact_value.TrialComponentArtifactValue"
    ]
