...
class EdgeModelStat(TypedDict):
    ...
    offline_device_count: NotRequired["aws_sdk_sagemaker.types.long.Long"]
    ...
    active_device_count: NotRequired["aws_sdk_sagemaker.types.long.Long"]
    """<p>The number of devices that have this model version, a heart beat, and are currently running.</p>"""
    sampling_device_count: NotRequired["aws_sdk_sagemaker.types.long.Long"]
