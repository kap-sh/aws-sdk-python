"""Generated from Smithy shape ``com.amazonaws.sagemaker#AttachClusterNodeVolumeRequest``."""
...
class AttachClusterNodeVolumeRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AttachClusterNodeVolumeRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> AttachClusterNodeVolumeRequest:
    out: AttachClusterNodeVolumeRequest = {}  # type: ignore[typeddict-item]
