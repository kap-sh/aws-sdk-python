...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.production_variant_status

ProductionVariantStatusList: TypeAlias = list[
    "aws_sdk_sagemaker.types.production_variant_status.ProductionVariantStatus"
]
...
def serialize_aws_json_1_1(value: ProductionVariantStatusList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.production_variant_status.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ProductionVariantStatusList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.production_variant_status.deserialize_aws_json_1_1(
                item
            )
        )
    return out
