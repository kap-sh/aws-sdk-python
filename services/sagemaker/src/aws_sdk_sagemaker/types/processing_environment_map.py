...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.processing_environment_key
    import aws_sdk_sagemaker.types.processing_environment_value

ProcessingEnvironmentMap: TypeAlias = dict[
    "aws_sdk_sagemaker.types.processing_environment_key.ProcessingEnvironmentKey",
    "aws_sdk_sagemaker.types.processing_environment_value.ProcessingEnvironmentValue",
]
