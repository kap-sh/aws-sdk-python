...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.auto_ml_job_channel

AutoMLJobInputDataConfig: TypeAlias = list[
    "aws_sdk_sagemaker.types.auto_ml_job_channel.AutoMLJobChannel"
]
...
def serialize_aws_json_1_1(value: AutoMLJobInputDataConfig) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.auto_ml_job_channel.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AutoMLJobInputDataConfig:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.auto_ml_job_channel.deserialize_aws_json_1_1(item)
        )
    return out
