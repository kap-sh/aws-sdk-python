...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.availability_zone_balance_enforcement_mode
    import aws_sdk_sagemaker.types.availability_zone_balance_max_imbalance


class InferenceComponentAvailabilityZoneBalance(TypedDict):
    enforcement_mode: NotRequired[
        "aws_sdk_sagemaker.types.availability_zone_balance_enforcement_mode.AvailabilityZoneBalanceEnforcementMode"
    ]
    ...
    max_imbalance: NotRequired[
        "aws_sdk_sagemaker.types.availability_zone_balance_max_imbalance.AvailabilityZoneBalanceMaxImbalance"
    ]
...
def serialize_aws_json_1_1(value: InferenceComponentAvailabilityZoneBalance) -> dict:
    ...
    if "enforcement_mode" in value:
        ...
        out["EnforcementMode"] = (
            aws_sdk_sagemaker.types.availability_zone_balance_enforcement_mode.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InferenceComponentAvailabilityZoneBalance:
    ...
    if "EnforcementMode" in data:
        ...
        out["enforcement_mode"] = (
            aws_sdk_sagemaker.types.availability_zone_balance_enforcement_mode.deserialize_aws_json_1_1(
