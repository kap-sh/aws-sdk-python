...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.ai_recommendation_deployment_s3_channel

AIRecommendationDeploymentS3ChannelList: TypeAlias = list[
    "aws_sdk_sagemaker.types.ai_recommendation_deployment_s3_channel.AIRecommendationDeploymentS3Channel"
]
...
def serialize_aws_json_1_1(value: AIRecommendationDeploymentS3ChannelList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.ai_recommendation_deployment_s3_channel.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AIRecommendationDeploymentS3ChannelList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.ai_recommendation_deployment_s3_channel.deserialize_aws_json_1_1(
                item
            )
        )
    return out
