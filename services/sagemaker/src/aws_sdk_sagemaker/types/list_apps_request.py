"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListAppsRequest``."""
...
class ListAppsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired["aws_sdk_sagemaker.types.app_sort_key.AppSortKey"]
    """<p>The parameter by which to sort the results. The default is CreationTime.</p>"""
    domain_id_equals: NotRequired["aws_sdk_sagemaker.types.domain_id.DomainId"]
    """<p>A parameter to search for the domain ID.</p>"""
    user_profile_name_equals: NotRequired[
    ...
    space_name_equals: NotRequired["aws_sdk_sagemaker.types.space_name.SpaceName"]
    """<p>A parameter to search by space name. If <code>UserProfileNameEquals</code> is set, then this value cannot be set.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListAppsRequest) -> dict:
    out: dict = {}
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = aws_sdk_sagemaker.types.app_sort_key.serialize_aws_json_1_1(
            value["sort_by"]
        )
    if "domain_id_equals" in value:
        out["DomainIdEquals"] = value["domain_id_equals"]
    if "user_profile_name_equals" in value:
        out["UserProfileNameEquals"] = value["user_profile_name_equals"]
    if "space_name_equals" in value:
        out["SpaceNameEquals"] = value["space_name_equals"]
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListAppsRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = aws_sdk_sagemaker.types.app_sort_key.deserialize_aws_json_1_1(
            data["SortBy"]
        )
