...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.online_store_security_config
    import aws_sdk_sagemaker.types.storage_type
...
class OnlineStoreConfig(TypedDict):
    ...
    enable_online_store: NotRequired["aws_sdk_sagemaker.types.boolean.Boolean"]
    ...
    storage_type: NotRequired["aws_sdk_sagemaker.types.storage_type.StorageType"]
...
def serialize_aws_json_1_1(value: OnlineStoreConfig) -> dict:
    ...
    if "security_config" in value:
        ...
        out["SecurityConfig"] = (
            aws_sdk_sagemaker.types.online_store_security_config.serialize_aws_json_1_1(
    ...
    if "storage_type" in value:
        ...
        out["StorageType"] = (
            aws_sdk_sagemaker.types.storage_type.serialize_aws_json_1_1(
                value["storage_type"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> OnlineStoreConfig:
    ...
    if "SecurityConfig" in data:
        ...
        out["security_config"] = (
            aws_sdk_sagemaker.types.online_store_security_config.deserialize_aws_json_1_1(
                data["SecurityConfig"]
            )
        )
    ...
    if "StorageType" in data:
        ...
        out["storage_type"] = (
            aws_sdk_sagemaker.types.storage_type.deserialize_aws_json_1_1(
                data["StorageType"]
            )
        )
    return out
