...
class ListModelMetadataRequest(TypedDict):
    search_expression: NotRequired[
        "aws_sdk_sagemaker.types.model_metadata_search_expression.ModelMetadataSearchExpression"
    ]
...
def serialize_aws_json_1_1(value: ListModelMetadataRequest) -> dict:
    ...
    if "search_expression" in value:
        ...
        out["SearchExpression"] = (
            aws_sdk_sagemaker.types.model_metadata_search_expression.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListModelMetadataRequest:
    ...
    if "SearchExpression" in data:
        ...
        out["search_expression"] = (
            aws_sdk_sagemaker.types.model_metadata_search_expression.deserialize_aws_json_1_1(
