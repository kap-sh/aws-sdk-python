...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.edge_models
...
class DescribeDeviceResponse(TypedDict):
    ...
    models: NotRequired["aws_sdk_sagemaker.types.edge_models.EdgeModels"]
    """<p>Models on the device.</p>"""
    max_models: NotRequired["aws_sdk_sagemaker.types.integer.Integer"]
...
def serialize_aws_json_1_1(value: DescribeDeviceResponse) -> dict:
    ...
    if "models" in value:
        ...
        out["Models"] = aws_sdk_sagemaker.types.edge_models.serialize_aws_json_1_1(
            value["models"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeDeviceResponse:
    ...
    if "Models" in data:
        ...
        out["models"] = aws_sdk_sagemaker.types.edge_models.deserialize_aws_json_1_1(
            data["Models"]
        )
