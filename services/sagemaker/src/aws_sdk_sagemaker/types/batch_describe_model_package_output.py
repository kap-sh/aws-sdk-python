...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.batch_describe_model_package_error_map
    import aws_sdk_sagemaker.types.model_package_summaries


class BatchDescribeModelPackageOutput(TypedDict):
    model_package_summaries: NotRequired[
        "aws_sdk_sagemaker.types.model_package_summaries.ModelPackageSummaries"
    ]
    """<p>The summaries for the model package versions</p>"""
    batch_describe_model_package_error_map: NotRequired[
        "aws_sdk_sagemaker.types.batch_describe_model_package_error_map.BatchDescribeModelPackageErrorMap"
    ]
...
def serialize_aws_json_1_1(value: BatchDescribeModelPackageOutput) -> dict:
    ...
    if "model_package_summaries" in value:
        ...
        out["ModelPackageSummaries"] = (
            aws_sdk_sagemaker.types.model_package_summaries.serialize_aws_json_1_1(
    ...
    if "batch_describe_model_package_error_map" in value:
        ...
        out["BatchDescribeModelPackageErrorMap"] = (
            aws_sdk_sagemaker.types.batch_describe_model_package_error_map.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchDescribeModelPackageOutput:
    ...
    if "ModelPackageSummaries" in data:
        ...
        out["model_package_summaries"] = (
            aws_sdk_sagemaker.types.model_package_summaries.deserialize_aws_json_1_1(
    ...
    if "BatchDescribeModelPackageErrorMap" in data:
        ...
        out["batch_describe_model_package_error_map"] = (
            aws_sdk_sagemaker.types.batch_describe_model_package_error_map.deserialize_aws_json_1_1(
