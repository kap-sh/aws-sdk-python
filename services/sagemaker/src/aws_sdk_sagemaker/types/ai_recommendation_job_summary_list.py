...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.ai_recommendation_job_summary

AIRecommendationJobSummaryList: TypeAlias = list[
    "aws_sdk_sagemaker.types.ai_recommendation_job_summary.AIRecommendationJobSummary"
]
...
def serialize_aws_json_1_1(value: AIRecommendationJobSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.ai_recommendation_job_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AIRecommendationJobSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.ai_recommendation_job_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
