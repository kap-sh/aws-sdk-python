...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.grouping_attribute_names
    import aws_sdk_sagemaker.types.item_identifier_attribute_name
    import aws_sdk_sagemaker.types.target_attribute_name
    import aws_sdk_sagemaker.types.timestamp_attribute_name
...
class TimeSeriesConfig(TypedDict):
    ...
    timestamp_attribute_name: NotRequired[
        "aws_sdk_sagemaker.types.timestamp_attribute_name.TimestampAttributeName"
    ]
    ...
    item_identifier_attribute_name: NotRequired[
        "aws_sdk_sagemaker.types.item_identifier_attribute_name.ItemIdentifierAttributeName"
    ]
    ...
    grouping_attribute_names: NotRequired[
        "aws_sdk_sagemaker.types.grouping_attribute_names.GroupingAttributeNames"
    ]
...
def serialize_aws_json_1_1(value: TimeSeriesConfig) -> dict:
    ...
    if "grouping_attribute_names" in value:
        ...
        out["GroupingAttributeNames"] = (
            aws_sdk_sagemaker.types.grouping_attribute_names.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TimeSeriesConfig:
    ...
    if "GroupingAttributeNames" in data:
        ...
        out["grouping_attribute_names"] = (
            aws_sdk_sagemaker.types.grouping_attribute_names.deserialize_aws_json_1_1(
