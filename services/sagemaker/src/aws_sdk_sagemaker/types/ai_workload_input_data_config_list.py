...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.ai_workload_input_data_config

AIWorkloadInputDataConfigList: TypeAlias = list[
    "aws_sdk_sagemaker.types.ai_workload_input_data_config.AIWorkloadInputDataConfig"
]
...
def serialize_aws_json_1_1(value: AIWorkloadInputDataConfigList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.ai_workload_input_data_config.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AIWorkloadInputDataConfigList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.ai_workload_input_data_config.deserialize_aws_json_1_1(
                item
            )
        )
    return out
