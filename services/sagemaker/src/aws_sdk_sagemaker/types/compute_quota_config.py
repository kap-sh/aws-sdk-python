...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.compute_quota_resource_config_list
    import aws_sdk_sagemaker.types.preempt_team_tasks
    import aws_sdk_sagemaker.types.resource_sharing_config


class ComputeQuotaConfig(TypedDict):
    compute_quota_resources: NotRequired[
        "aws_sdk_sagemaker.types.compute_quota_resource_config_list.ComputeQuotaResourceConfigList"
    ]
    """<p>Allocate compute resources by instance types.</p>"""
    resource_sharing_config: NotRequired[
        "aws_sdk_sagemaker.types.resource_sharing_config.ResourceSharingConfig"
    ]
    ...
    preempt_team_tasks: NotRequired[
        "aws_sdk_sagemaker.types.preempt_team_tasks.PreemptTeamTasks"
    ]
...
def serialize_aws_json_1_1(value: ComputeQuotaConfig) -> dict:
    ...
    if "compute_quota_resources" in value:
        ...
        out["ComputeQuotaResources"] = (
            aws_sdk_sagemaker.types.compute_quota_resource_config_list.serialize_aws_json_1_1(
    ...
    if "resource_sharing_config" in value:
        ...
        out["ResourceSharingConfig"] = (
            aws_sdk_sagemaker.types.resource_sharing_config.serialize_aws_json_1_1(
    ...
    if "preempt_team_tasks" in value:
        ...
        out["PreemptTeamTasks"] = (
            aws_sdk_sagemaker.types.preempt_team_tasks.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ComputeQuotaConfig:
    ...
    if "ComputeQuotaResources" in data:
        ...
        out["compute_quota_resources"] = (
            aws_sdk_sagemaker.types.compute_quota_resource_config_list.deserialize_aws_json_1_1(
    ...
    if "ResourceSharingConfig" in data:
        ...
        out["resource_sharing_config"] = (
            aws_sdk_sagemaker.types.resource_sharing_config.deserialize_aws_json_1_1(
    ...
    if "PreemptTeamTasks" in data:
        ...
        out["preempt_team_tasks"] = (
            aws_sdk_sagemaker.types.preempt_team_tasks.deserialize_aws_json_1_1(
