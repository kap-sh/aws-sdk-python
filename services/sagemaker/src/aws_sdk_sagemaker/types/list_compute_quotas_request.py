...
class ListComputeQuotasRequest(TypedDict):
    ...
    sort_by: NotRequired["aws_sdk_sagemaker.types.sort_quota_by.SortQuotaBy"]
...
def serialize_aws_json_1_1(value: ListComputeQuotasRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = aws_sdk_sagemaker.types.sort_quota_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListComputeQuotasRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = aws_sdk_sagemaker.types.sort_quota_by.deserialize_aws_json_1_1(
            data["SortBy"]
        )
