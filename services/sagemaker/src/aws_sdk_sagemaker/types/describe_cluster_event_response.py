...
class DescribeClusterEventResponse(TypedDict):
    event_details: NotRequired[
        "aws_sdk_sagemaker.types.cluster_event_detail.ClusterEventDetail"
    ]
...
def serialize_aws_json_1_1(value: DescribeClusterEventResponse) -> dict:
    ...
    if "event_details" in value:
        ...
        out["EventDetails"] = (
            aws_sdk_sagemaker.types.cluster_event_detail.serialize_aws_json_1_1(
                value["event_details"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeClusterEventResponse:
    ...
    if "EventDetails" in data:
        ...
        out["event_details"] = (
            aws_sdk_sagemaker.types.cluster_event_detail.deserialize_aws_json_1_1(
                data["EventDetails"]
            )
        )
    return out
