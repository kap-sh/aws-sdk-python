...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.cluster_scheduler_config_summary

ClusterSchedulerConfigSummaryList: TypeAlias = list[
    "aws_sdk_sagemaker.types.cluster_scheduler_config_summary.ClusterSchedulerConfigSummary"
]
...
def serialize_aws_json_1_1(value: ClusterSchedulerConfigSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.cluster_scheduler_config_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ClusterSchedulerConfigSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.cluster_scheduler_config_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
