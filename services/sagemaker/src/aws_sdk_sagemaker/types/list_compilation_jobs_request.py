...
class ListCompilationJobsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "aws_sdk_sagemaker.types.list_compilation_jobs_sort_by.ListCompilationJobsSortBy"
    ]
...
def serialize_aws_json_1_1(value: ListCompilationJobsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            aws_sdk_sagemaker.types.list_compilation_jobs_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListCompilationJobsRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_sagemaker.types.list_compilation_jobs_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
