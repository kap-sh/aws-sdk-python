...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.direction
    import aws_sdk_sagemaker.types.query_filters
    import aws_sdk_sagemaker.types.query_lineage_max_depth
    import aws_sdk_sagemaker.types.query_lineage_max_results
    import aws_sdk_sagemaker.types.query_lineage_start_arns
    import aws_sdk_sagemaker.types.string8192


class QueryLineageRequest(TypedDict):
    start_arns: NotRequired[
        "aws_sdk_sagemaker.types.query_lineage_start_arns.QueryLineageStartArns"
    ]
    ...
    max_depth: NotRequired[
        "aws_sdk_sagemaker.types.query_lineage_max_depth.QueryLineageMaxDepth"
    ]
    ...
    max_results: NotRequired[
        "aws_sdk_sagemaker.types.query_lineage_max_results.QueryLineageMaxResults"
    ]
...
def serialize_aws_json_1_1(value: QueryLineageRequest) -> dict:
    ...
    if "start_arns" in value:
        ...
        out["StartArns"] = (
            aws_sdk_sagemaker.types.query_lineage_start_arns.serialize_aws_json_1_1(
                value["start_arns"]
            )
        )
    if "direction" in value:
        ...
        out["Direction"] = aws_sdk_sagemaker.types.direction.serialize_aws_json_1_1(
            value["direction"]
        )
    ...
    if "filters" in value:
        ...
        out["Filters"] = aws_sdk_sagemaker.types.query_filters.serialize_aws_json_1_1(
            value["filters"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> QueryLineageRequest:
    ...
    if "StartArns" in data:
        ...
        out["start_arns"] = (
            aws_sdk_sagemaker.types.query_lineage_start_arns.deserialize_aws_json_1_1(
                data["StartArns"]
            )
        )
    if "Direction" in data:
        ...
        out["direction"] = aws_sdk_sagemaker.types.direction.deserialize_aws_json_1_1(
            data["Direction"]
        )
    ...
    if "Filters" in data:
        ...
        out["filters"] = aws_sdk_sagemaker.types.query_filters.deserialize_aws_json_1_1(
            data["Filters"]
        )
    if "MaxDepth" in data:
