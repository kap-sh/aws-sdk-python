...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.metric_definition

MetricDefinitionList: TypeAlias = list[
    "aws_sdk_sagemaker.types.metric_definition.MetricDefinition"
]
...
def serialize_aws_json_1_1(value: MetricDefinitionList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.metric_definition.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> MetricDefinitionList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.metric_definition.deserialize_aws_json_1_1(item)
        )
    return out
