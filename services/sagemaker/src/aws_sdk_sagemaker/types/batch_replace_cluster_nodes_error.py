"""Generated from Smithy shape ``com.amazonaws.sagemaker#BatchReplaceClusterNodesError``."""
...
class BatchReplaceClusterNodesError(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: BatchReplaceClusterNodesError) -> dict:
    out: dict = {}
    if "node_id" in value:
...
def deserialize_aws_json_1_1(data: dict) -> BatchReplaceClusterNodesError:
    out: BatchReplaceClusterNodesError = {}  # type: ignore[typeddict-item]
    if "NodeId" in data:
