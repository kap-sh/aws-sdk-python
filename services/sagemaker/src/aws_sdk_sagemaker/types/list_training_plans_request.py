...
class ListTrainingPlansRequest(TypedDict):
    ...
    start_time_before: NotRequired["aws_sdk_sagemaker.types.timestamp.Timestamp"]
    """<p>Filter to list only training plans with an actual start time before this date.</p>"""
    sort_by: NotRequired[
        "aws_sdk_sagemaker.types.training_plan_sort_by.TrainingPlanSortBy"
    ]
    """<p>The training plan field to sort the results by (e.g., StartTime, Status).</p>"""
    sort_order: NotRequired[
        "aws_sdk_sagemaker.types.training_plan_sort_order.TrainingPlanSortOrder"
    ]
    """<p>The order to sort the results (Ascending or Descending).</p>"""
    filters: NotRequired[
        "aws_sdk_sagemaker.types.training_plan_filters.TrainingPlanFilters"
    ]
...
def serialize_aws_json_1_1(value: ListTrainingPlansRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            aws_sdk_sagemaker.types.training_plan_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
    if "sort_order" in value:
        ...
        out["SortOrder"] = (
            aws_sdk_sagemaker.types.training_plan_sort_order.serialize_aws_json_1_1(
                value["sort_order"]
            )
        )
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_sagemaker.types.training_plan_filters.serialize_aws_json_1_1(
                value["filters"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListTrainingPlansRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_sagemaker.types.training_plan_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
    if "SortOrder" in data:
        ...
        out["sort_order"] = (
            aws_sdk_sagemaker.types.training_plan_sort_order.deserialize_aws_json_1_1(
                data["SortOrder"]
            )
        )
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_sagemaker.types.training_plan_filters.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
    return out
