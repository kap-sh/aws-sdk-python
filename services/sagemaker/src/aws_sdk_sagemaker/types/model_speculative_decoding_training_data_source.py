...
class ModelSpeculativeDecodingTrainingDataSource(TypedDict, closed=True):
    ...
    s3_data_type: NotRequired[
        "aws_sdk_sagemaker.types.model_speculative_decoding_s3_data_type.ModelSpeculativeDecodingS3DataType"
    ]
...
def serialize_aws_json_1_1(value: ModelSpeculativeDecodingTrainingDataSource) -> dict:
    ...
    if "s3_data_type" in value:
        ...
        out["S3DataType"] = (
            aws_sdk_sagemaker.types.model_speculative_decoding_s3_data_type.serialize_aws_json_1_1(
                value["s3_data_type"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ModelSpeculativeDecodingTrainingDataSource:
    ...
    if "S3DataType" in data:
        ...
        out["s3_data_type"] = (
            aws_sdk_sagemaker.types.model_speculative_decoding_s3_data_type.deserialize_aws_json_1_1(
                data["S3DataType"]
            )
        )
    return out
