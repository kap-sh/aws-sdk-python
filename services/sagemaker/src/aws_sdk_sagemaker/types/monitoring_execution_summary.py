...
def serialize_aws_json_1_1(value: MonitoringExecutionSummary) -> dict:
    ...
    if "scheduled_time" in value:
        ...
        out["ScheduledTime"] = aws_sdk_sagemaker.types.timestamp.serialize_aws_json_1_1(
