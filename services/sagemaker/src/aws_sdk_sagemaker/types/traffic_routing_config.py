...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.traffic_routing_config_type
    import aws_sdk_sagemaker.types.wait_interval_in_seconds


class TrafficRoutingConfig(TypedDict):
    type: NotRequired[
        "aws_sdk_sagemaker.types.traffic_routing_config_type.TrafficRoutingConfigType"
    ]
    ...
    canary_size: NotRequired["aws_sdk_sagemaker.types.capacity_size.CapacitySize"]
    ...
    linear_step_size: NotRequired["aws_sdk_sagemaker.types.capacity_size.CapacitySize"]
...
def serialize_aws_json_1_1(value: TrafficRoutingConfig) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = (
            aws_sdk_sagemaker.types.traffic_routing_config_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> TrafficRoutingConfig:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_sagemaker.types.traffic_routing_config_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
