...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.sort_actions_by
...
class ListActionsRequest(TypedDict):
    ...
    sort_by: NotRequired["aws_sdk_sagemaker.types.sort_actions_by.SortActionsBy"]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListActionsRequest) -> dict:
    out: dict = {}
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = aws_sdk_sagemaker.types.sort_actions_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListActionsRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_sagemaker.types.sort_actions_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
