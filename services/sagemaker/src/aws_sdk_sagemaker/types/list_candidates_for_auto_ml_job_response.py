...
class ListCandidatesForAutoMLJobResponse(TypedDict):
    candidates: NotRequired[
        "aws_sdk_sagemaker.types.auto_ml_candidates.AutoMLCandidates"
    ]
...
def serialize_aws_json_1_1(value: ListCandidatesForAutoMLJobResponse) -> dict:
    ...
    if "candidates" in value:
        ...
        out["Candidates"] = (
            aws_sdk_sagemaker.types.auto_ml_candidates.serialize_aws_json_1_1(
                value["candidates"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListCandidatesForAutoMLJobResponse:
    ...
    if "Candidates" in data:
        ...
        out["candidates"] = (
            aws_sdk_sagemaker.types.auto_ml_candidates.deserialize_aws_json_1_1(
                data["Candidates"]
            )
        )
