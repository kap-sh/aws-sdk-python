...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.target_tracking_scaling_policy_configuration


class _ScalingPolicy_TargetTracking(TypedDict):
    TargetTracking: "aws_sdk_sagemaker.types.target_tracking_scaling_policy_configuration.TargetTrackingScalingPolicyConfiguration"
...
def serialize_aws_json_1_1(value: ScalingPolicy) -> dict:
    if "TargetTracking" in value:
        ...
        return {
            "TargetTracking": aws_sdk_sagemaker.types.target_tracking_scaling_policy_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ScalingPolicy:
    if "TargetTracking" in data:
        ...
        return {
            "TargetTracking": aws_sdk_sagemaker.types.target_tracking_scaling_policy_configuration.deserialize_aws_json_1_1(
                data["TargetTracking"]
            )
        }
    else:
