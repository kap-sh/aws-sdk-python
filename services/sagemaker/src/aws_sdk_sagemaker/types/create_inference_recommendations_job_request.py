...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.recommendation_job_output_config
...
class CreateInferenceRecommendationsJobRequest(TypedDict):
    ...
    output_config: NotRequired[
        "aws_sdk_sagemaker.types.recommendation_job_output_config.RecommendationJobOutputConfig"
    ]
...
def serialize_aws_json_1_1(value: CreateInferenceRecommendationsJobRequest) -> dict:
    ...
    if "output_config" in value:
        ...
        out["OutputConfig"] = (
            aws_sdk_sagemaker.types.recommendation_job_output_config.serialize_aws_json_1_1(
                value["output_config"]
            )
        )
    if "tags" in value:
...
def deserialize_aws_json_1_1(data: dict) -> CreateInferenceRecommendationsJobRequest:
    ...
    if "OutputConfig" in data:
        ...
        out["output_config"] = (
            aws_sdk_sagemaker.types.recommendation_job_output_config.deserialize_aws_json_1_1(
                data["OutputConfig"]
            )
        )
    if "Tags" in data:
