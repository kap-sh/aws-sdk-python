...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.capture_option_list
...
class DataCaptureConfig(TypedDict):
    ...
    capture_options: NotRequired[
        "aws_sdk_sagemaker.types.capture_option_list.CaptureOptionList"
    ]
...
def serialize_aws_json_1_1(value: DataCaptureConfig) -> dict:
    ...
    if "capture_options" in value:
        ...
        out["CaptureOptions"] = (
            aws_sdk_sagemaker.types.capture_option_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DataCaptureConfig:
    ...
    if "CaptureOptions" in data:
        ...
        out["capture_options"] = (
            aws_sdk_sagemaker.types.capture_option_list.deserialize_aws_json_1_1(
                data["CaptureOptions"]
            )
        )
