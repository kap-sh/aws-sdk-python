...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.hyper_parameter_tuning_instance_configs
...
class HyperParameterTuningResourceConfig(TypedDict, closed=True):
    ...
    allocation_strategy: NotRequired[
        "aws_sdk_sagemaker.types.hyper_parameter_tuning_allocation_strategy.HyperParameterTuningAllocationStrategy"
    ]
    ...
    instance_configs: NotRequired[
        "aws_sdk_sagemaker.types.hyper_parameter_tuning_instance_configs.HyperParameterTuningInstanceConfigs"
    ]
...
def serialize_aws_json_1_1(value: HyperParameterTuningResourceConfig) -> dict:
    ...
    if "allocation_strategy" in value:
        ...
        out["AllocationStrategy"] = (
            aws_sdk_sagemaker.types.hyper_parameter_tuning_allocation_strategy.serialize_aws_json_1_1(
    ...
    if "instance_configs" in value:
        ...
        out["InstanceConfigs"] = (
            aws_sdk_sagemaker.types.hyper_parameter_tuning_instance_configs.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> HyperParameterTuningResourceConfig:
    ...
    if "AllocationStrategy" in data:
        ...
        out["allocation_strategy"] = (
            aws_sdk_sagemaker.types.hyper_parameter_tuning_allocation_strategy.deserialize_aws_json_1_1(
    ...
    if "InstanceConfigs" in data:
        ...
        out["instance_configs"] = (
            aws_sdk_sagemaker.types.hyper_parameter_tuning_instance_configs.deserialize_aws_json_1_1(
