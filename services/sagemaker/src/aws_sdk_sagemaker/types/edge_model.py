...
class EdgeModel(TypedDict, closed=True):
    ...
    latest_sample_time: NotRequired["aws_sdk_sagemaker.types.timestamp.Timestamp"]
    """<p>The timestamp of the last data sample taken.</p>"""
    latest_inference: NotRequired["aws_sdk_sagemaker.types.timestamp.Timestamp"]
