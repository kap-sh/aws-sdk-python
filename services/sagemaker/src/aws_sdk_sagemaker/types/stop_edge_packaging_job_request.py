...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StopEdgePackagingJobRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> StopEdgePackagingJobRequest:
    out: StopEdgePackagingJobRequest = {}  # type: ignore[typeddict-item]
