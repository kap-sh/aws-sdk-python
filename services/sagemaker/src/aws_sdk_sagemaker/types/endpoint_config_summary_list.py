...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.endpoint_config_summary

EndpointConfigSummaryList: TypeAlias = list[
    "aws_sdk_sagemaker.types.endpoint_config_summary.EndpointConfigSummary"
]
...
def serialize_aws_json_1_1(value: EndpointConfigSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.endpoint_config_summary.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> EndpointConfigSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.endpoint_config_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
