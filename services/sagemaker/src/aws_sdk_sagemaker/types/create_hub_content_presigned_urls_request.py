...
class CreateHubContentPresignedUrlsRequest(TypedDict):
    ...
    access_config: NotRequired[
        "aws_sdk_sagemaker.types.presigned_url_access_config.PresignedUrlAccessConfig"
    ]
...
def serialize_aws_json_1_1(value: CreateHubContentPresignedUrlsRequest) -> dict:
    ...
    if "access_config" in value:
        ...
        out["AccessConfig"] = (
            aws_sdk_sagemaker.types.presigned_url_access_config.serialize_aws_json_1_1(
                value["access_config"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> CreateHubContentPresignedUrlsRequest:
    ...
    if "AccessConfig" in data:
        ...
        out["access_config"] = (
            aws_sdk_sagemaker.types.presigned_url_access_config.deserialize_aws_json_1_1(
                data["AccessConfig"]
            )
        )
