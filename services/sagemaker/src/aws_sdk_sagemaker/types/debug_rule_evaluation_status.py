"""Generated from Smithy shape ``com.amazonaws.sagemaker#DebugRuleEvaluationStatus``."""
...
class DebugRuleEvaluationStatus(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DebugRuleEvaluationStatus) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DebugRuleEvaluationStatus:
    out: DebugRuleEvaluationStatus = {}  # type: ignore[typeddict-item]
