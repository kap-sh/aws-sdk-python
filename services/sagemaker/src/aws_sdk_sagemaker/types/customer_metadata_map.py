...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.customer_metadata_key
    import aws_sdk_sagemaker.types.customer_metadata_value

CustomerMetadataMap: TypeAlias = dict[
    "aws_sdk_sagemaker.types.customer_metadata_key.CustomerMetadataKey",
    "aws_sdk_sagemaker.types.customer_metadata_value.CustomerMetadataValue",
]
