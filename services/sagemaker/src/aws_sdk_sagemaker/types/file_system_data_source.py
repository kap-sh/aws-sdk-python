...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.file_system_access_mode
...
class FileSystemDataSource(TypedDict):
    ...
    file_system_access_mode: NotRequired[
        "aws_sdk_sagemaker.types.file_system_access_mode.FileSystemAccessMode"
    ]
    ...
    file_system_type: NotRequired[
        "aws_sdk_sagemaker.types.file_system_type.FileSystemType"
    ]
    """<p>The file system type. </p>"""
    directory_path: NotRequired["aws_sdk_sagemaker.types.directory_path.DirectoryPath"]
...
def serialize_aws_json_1_1(value: FileSystemDataSource) -> dict:
    ...
    if "file_system_access_mode" in value:
        ...
        out["FileSystemAccessMode"] = (
            aws_sdk_sagemaker.types.file_system_access_mode.serialize_aws_json_1_1(
    ...
    if "file_system_type" in value:
        ...
        out["FileSystemType"] = (
            aws_sdk_sagemaker.types.file_system_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> FileSystemDataSource:
    ...
    if "FileSystemAccessMode" in data:
        ...
        out["file_system_access_mode"] = (
            aws_sdk_sagemaker.types.file_system_access_mode.deserialize_aws_json_1_1(
    ...
    if "FileSystemType" in data:
        ...
        out["file_system_type"] = (
            aws_sdk_sagemaker.types.file_system_type.deserialize_aws_json_1_1(
                data["FileSystemType"]
            )
        )
