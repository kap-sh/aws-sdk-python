...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.ai_inference_specification_name
    import aws_sdk_sagemaker.types.ai_recommendation_instance_detail_list
    import aws_sdk_sagemaker.types.model_package_arn


class AIRecommendationModelDetails(TypedDict):
    ...
    inference_specification_name: NotRequired[
        "aws_sdk_sagemaker.types.ai_inference_specification_name.AIInferenceSpecificationName"
    ]
    """<p>The name of the inference specification within the model package.</p>"""
    instance_details: NotRequired[
        "aws_sdk_sagemaker.types.ai_recommendation_instance_detail_list.AIRecommendationInstanceDetailList"
    ]
...
def serialize_aws_json_1_1(value: AIRecommendationModelDetails) -> dict:
    ...
    if "instance_details" in value:
        ...
        out["InstanceDetails"] = (
            aws_sdk_sagemaker.types.ai_recommendation_instance_detail_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AIRecommendationModelDetails:
    ...
    if "InstanceDetails" in data:
        ...
        out["instance_details"] = (
            aws_sdk_sagemaker.types.ai_recommendation_instance_detail_list.deserialize_aws_json_1_1(
