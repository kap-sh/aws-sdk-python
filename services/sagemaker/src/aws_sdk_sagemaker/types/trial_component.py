...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.parents
...
class TrialComponent(TypedDict):
    ...
    source_detail: NotRequired[
        "aws_sdk_sagemaker.types.trial_component_source_detail.TrialComponentSourceDetail"
    ]
...
def serialize_aws_json_1_1(value: TrialComponent) -> dict:
    ...
    if "source_detail" in value:
        ...
        out["SourceDetail"] = (
            aws_sdk_sagemaker.types.trial_component_source_detail.serialize_aws_json_1_1(
                value["source_detail"]
            )
        )
    ...
    if "parents" in value:
        ...
        out["Parents"] = aws_sdk_sagemaker.types.parents.serialize_aws_json_1_1(
            value["parents"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> TrialComponent:
    ...
    if "SourceDetail" in data:
        ...
        out["source_detail"] = (
            aws_sdk_sagemaker.types.trial_component_source_detail.deserialize_aws_json_1_1(
                data["SourceDetail"]
            )
        )
    ...
    if "Parents" in data:
        ...
        out["parents"] = aws_sdk_sagemaker.types.parents.deserialize_aws_json_1_1(
            data["Parents"]
        )
    if "RunName" in data:
