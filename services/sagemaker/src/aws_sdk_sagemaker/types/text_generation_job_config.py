...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.text_generation_hyper_parameters


class TextGenerationJobConfig(TypedDict):
    ...
    text_generation_hyper_parameters: NotRequired[
        "aws_sdk_sagemaker.types.text_generation_hyper_parameters.TextGenerationHyperParameters"
    ]
...
def serialize_aws_json_1_1(value: TextGenerationJobConfig) -> dict:
    ...
    if "text_generation_hyper_parameters" in value:
        ...
        out["TextGenerationHyperParameters"] = (
            aws_sdk_sagemaker.types.text_generation_hyper_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TextGenerationJobConfig:
    ...
    if "TextGenerationHyperParameters" in data:
        ...
        out["text_generation_hyper_parameters"] = (
            aws_sdk_sagemaker.types.text_generation_hyper_parameters.deserialize_aws_json_1_1(
