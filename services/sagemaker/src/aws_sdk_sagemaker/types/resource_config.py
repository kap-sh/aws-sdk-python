...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.instance_groups
    import aws_sdk_sagemaker.types.instance_placement_config
...
class ResourceConfig(TypedDict, closed=True):
    ...
    instance_groups: NotRequired[
        "aws_sdk_sagemaker.types.instance_groups.InstanceGroups"
    ]
    ...
    instance_placement_config: NotRequired[
        "aws_sdk_sagemaker.types.instance_placement_config.InstancePlacementConfig"
    ]
...
def serialize_aws_json_1_1(value: ResourceConfig) -> dict:
    ...
    if "instance_groups" in value:
        ...
        out["InstanceGroups"] = (
            aws_sdk_sagemaker.types.instance_groups.serialize_aws_json_1_1(
    ...
    if "instance_placement_config" in value:
        ...
        out["InstancePlacementConfig"] = (
            aws_sdk_sagemaker.types.instance_placement_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ResourceConfig:
    ...
    if "InstanceGroups" in data:
        ...
        out["instance_groups"] = (
            aws_sdk_sagemaker.types.instance_groups.deserialize_aws_json_1_1(
                data["InstanceGroups"]
            )
        )
    ...
    if "InstancePlacementConfig" in data:
        ...
        out["instance_placement_config"] = (
            aws_sdk_sagemaker.types.instance_placement_config.deserialize_aws_json_1_1(
