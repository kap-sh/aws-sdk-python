...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.routing_strategy


class ProductionVariantRoutingConfig(TypedDict):
    routing_strategy: NotRequired[
        "aws_sdk_sagemaker.types.routing_strategy.RoutingStrategy"
    ]
...
def serialize_aws_json_1_1(value: ProductionVariantRoutingConfig) -> dict:
    ...
    if "routing_strategy" in value:
        ...
        out["RoutingStrategy"] = (
            aws_sdk_sagemaker.types.routing_strategy.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ProductionVariantRoutingConfig:
    ...
    if "RoutingStrategy" in data:
        ...
        out["routing_strategy"] = (
            aws_sdk_sagemaker.types.routing_strategy.deserialize_aws_json_1_1(
