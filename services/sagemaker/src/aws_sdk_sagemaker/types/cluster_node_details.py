...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.cluster_kubernetes_config_node_details
    ...
    import aws_sdk_sagemaker.types.cluster_private_primary_ip
    import aws_sdk_sagemaker.types.cluster_private_primary_ipv6
...
class ClusterNodeDetails(TypedDict):
    ...
    private_primary_ip: NotRequired[
        "aws_sdk_sagemaker.types.cluster_private_primary_ip.ClusterPrivatePrimaryIp"
    ]
    """<p>The private primary IP address of the SageMaker HyperPod cluster node.</p>"""
    private_primary_ipv6: NotRequired[
        "aws_sdk_sagemaker.types.cluster_private_primary_ipv6.ClusterPrivatePrimaryIpv6"
    ]
    ...
    placement: NotRequired[
        "aws_sdk_sagemaker.types.cluster_instance_placement.ClusterInstancePlacement"
    ]
    ...
    kubernetes_config: NotRequired[
        "aws_sdk_sagemaker.types.cluster_kubernetes_config_node_details.ClusterKubernetesConfigNodeDetails"
    ]
    ...
    capacity_type: NotRequired[
        "aws_sdk_sagemaker.types.cluster_capacity_type.ClusterCapacityType"
    ]
...
def serialize_aws_json_1_1(value: ClusterNodeDetails) -> dict:
    ...
    if "placement" in value:
        ...
        out["Placement"] = (
            aws_sdk_sagemaker.types.cluster_instance_placement.serialize_aws_json_1_1(
                value["placement"]
            )
        )
    ...
    if "kubernetes_config" in value:
        ...
        out["KubernetesConfig"] = (
            aws_sdk_sagemaker.types.cluster_kubernetes_config_node_details.serialize_aws_json_1_1(
    ...
    if "capacity_type" in value:
        ...
        out["CapacityType"] = (
            aws_sdk_sagemaker.types.cluster_capacity_type.serialize_aws_json_1_1(
                value["capacity_type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ClusterNodeDetails:
    ...
    if "Placement" in data:
        ...
        out["placement"] = (
            aws_sdk_sagemaker.types.cluster_instance_placement.deserialize_aws_json_1_1(
                data["Placement"]
            )
        )
    ...
    if "KubernetesConfig" in data:
        ...
        out["kubernetes_config"] = (
            aws_sdk_sagemaker.types.cluster_kubernetes_config_node_details.deserialize_aws_json_1_1(
    ...
    if "CapacityType" in data:
        ...
        out["capacity_type"] = (
            aws_sdk_sagemaker.types.cluster_capacity_type.deserialize_aws_json_1_1(
                data["CapacityType"]
            )
        )
