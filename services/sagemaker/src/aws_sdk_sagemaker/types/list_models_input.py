...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.model_name_contains
...
class ListModelsInput(TypedDict):
    sort_by: NotRequired["aws_sdk_sagemaker.types.model_sort_key.ModelSortKey"]
    ...
    name_contains: NotRequired[
        "aws_sdk_sagemaker.types.model_name_contains.ModelNameContains"
    ]
...
def serialize_aws_json_1_1(value: ListModelsInput) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = aws_sdk_sagemaker.types.model_sort_key.serialize_aws_json_1_1(
            value["sort_by"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListModelsInput:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_sagemaker.types.model_sort_key.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
