...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.athena_database
    import aws_sdk_sagemaker.types.athena_query_string
    import aws_sdk_sagemaker.types.athena_result_compression_type
    import aws_sdk_sagemaker.types.athena_result_format
    import aws_sdk_sagemaker.types.athena_work_group
...
class AthenaDatasetDefinition(TypedDict):
    ...
    query_string: NotRequired[
        "aws_sdk_sagemaker.types.athena_query_string.AthenaQueryString"
    ]
    work_group: NotRequired["aws_sdk_sagemaker.types.athena_work_group.AthenaWorkGroup"]
    ...
    output_format: NotRequired[
        "aws_sdk_sagemaker.types.athena_result_format.AthenaResultFormat"
    ]
    output_compression: NotRequired[
        "aws_sdk_sagemaker.types.athena_result_compression_type.AthenaResultCompressionType"
    ]
...
def serialize_aws_json_1_1(value: AthenaDatasetDefinition) -> dict:
    ...
    if "output_format" in value:
        ...
        out["OutputFormat"] = (
            aws_sdk_sagemaker.types.athena_result_format.serialize_aws_json_1_1(
                value["output_format"]
            )
        )
    if "output_compression" in value:
        ...
        out["OutputCompression"] = (
            aws_sdk_sagemaker.types.athena_result_compression_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AthenaDatasetDefinition:
    ...
    if "OutputFormat" in data:
        ...
        out["output_format"] = (
            aws_sdk_sagemaker.types.athena_result_format.deserialize_aws_json_1_1(
                data["OutputFormat"]
            )
        )
    if "OutputCompression" in data:
        ...
        out["output_compression"] = (
            aws_sdk_sagemaker.types.athena_result_compression_type.deserialize_aws_json_1_1(
