...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.ai_benchmark_inference_component_list
    import aws_sdk_sagemaker.types.ai_resource_identifier
    import aws_sdk_sagemaker.types.string


class AIBenchmarkEndpoint(TypedDict):
    ...
    target_container_hostname: NotRequired["aws_sdk_sagemaker.types.string.String"]
    """<p>The hostname of the specific container to target within a multi-container endpoint.</p>"""
    inference_components: NotRequired[
        "aws_sdk_sagemaker.types.ai_benchmark_inference_component_list.AIBenchmarkInferenceComponentList"
    ]
...
def serialize_aws_json_1_1(value: AIBenchmarkEndpoint) -> dict:
    ...
    if "inference_components" in value:
        ...
        out["InferenceComponents"] = (
            aws_sdk_sagemaker.types.ai_benchmark_inference_component_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AIBenchmarkEndpoint:
    ...
    if "InferenceComponents" in data:
        ...
        out["inference_components"] = (
            aws_sdk_sagemaker.types.ai_benchmark_inference_component_list.deserialize_aws_json_1_1(
