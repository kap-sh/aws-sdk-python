...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.auto_mls3_data_source


class AutoMLDataSource(TypedDict):
    s3_data_source: NotRequired[
        "aws_sdk_sagemaker.types.auto_mls3_data_source.AutoMLS3DataSource"
    ]
...
def serialize_aws_json_1_1(value: AutoMLDataSource) -> dict:
    ...
    if "s3_data_source" in value:
        ...
        out["S3DataSource"] = (
            aws_sdk_sagemaker.types.auto_mls3_data_source.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AutoMLDataSource:
    ...
    if "S3DataSource" in data:
        ...
        out["s3_data_source"] = (
            aws_sdk_sagemaker.types.auto_mls3_data_source.deserialize_aws_json_1_1(
                data["S3DataSource"]
            )
        )
    return out
