...
class Workforce(TypedDict, closed=True):
    ...
    workforce_vpc_config: NotRequired[
        "aws_sdk_sagemaker.types.workforce_vpc_config_response.WorkforceVpcConfigResponse"
    ]
    """<p>The configuration of a VPC workforce.</p>"""
    status: NotRequired["aws_sdk_sagemaker.types.workforce_status.WorkforceStatus"]
    """<p>The status of your workforce.</p>"""
    failure_reason: NotRequired[
        "aws_sdk_sagemaker.types.workforce_failure_reason.WorkforceFailureReason"
    ]
...
def serialize_aws_json_1_1(value: Workforce) -> dict:
    ...
    if "oidc_config" in value:
        ...
        out["OidcConfig"] = (
            aws_sdk_sagemaker.types.oidc_config_for_response.serialize_aws_json_1_1(
                value["oidc_config"]
            )
        )
    ...
    if "workforce_vpc_config" in value:
        ...
        out["WorkforceVpcConfig"] = (
            aws_sdk_sagemaker.types.workforce_vpc_config_response.serialize_aws_json_1_1(
    ...
    if "status" in value:
        ...
        out["Status"] = aws_sdk_sagemaker.types.workforce_status.serialize_aws_json_1_1(
            value["status"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> Workforce:
    ...
    if "OidcConfig" in data:
        ...
        out["oidc_config"] = (
            aws_sdk_sagemaker.types.oidc_config_for_response.deserialize_aws_json_1_1(
                data["OidcConfig"]
            )
        )
    ...
    if "WorkforceVpcConfig" in data:
        ...
        out["workforce_vpc_config"] = (
            aws_sdk_sagemaker.types.workforce_vpc_config_response.deserialize_aws_json_1_1(
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_sagemaker.types.workforce_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
