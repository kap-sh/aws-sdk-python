...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.forecast_frequency
    import aws_sdk_sagemaker.types.forecast_horizon
    import aws_sdk_sagemaker.types.forecast_quantiles
    import aws_sdk_sagemaker.types.holiday_config
    import aws_sdk_sagemaker.types.s3_uri
    import aws_sdk_sagemaker.types.time_series_config
    import aws_sdk_sagemaker.types.time_series_transformations


class TimeSeriesForecastingJobConfig(TypedDict):
    ...
    forecast_frequency: NotRequired[
        "aws_sdk_sagemaker.types.forecast_frequency.ForecastFrequency"
    ]
    ...
    forecast_horizon: NotRequired[
        "aws_sdk_sagemaker.types.forecast_horizon.ForecastHorizon"
    ]
    ...
    forecast_quantiles: NotRequired[
        "aws_sdk_sagemaker.types.forecast_quantiles.ForecastQuantiles"
    ]
    ...
    transformations: NotRequired[
        "aws_sdk_sagemaker.types.time_series_transformations.TimeSeriesTransformations"
    ]
    ...
    time_series_config: NotRequired[
        "aws_sdk_sagemaker.types.time_series_config.TimeSeriesConfig"
    ]
    """<p>The collection of components that defines the time-series.</p>"""
    holiday_config: NotRequired["aws_sdk_sagemaker.types.holiday_config.HolidayConfig"]
...
def serialize_aws_json_1_1(value: TimeSeriesForecastingJobConfig) -> dict:
    ...
    if "forecast_quantiles" in value:
        ...
        out["ForecastQuantiles"] = (
            aws_sdk_sagemaker.types.forecast_quantiles.serialize_aws_json_1_1(
    ...
    if "transformations" in value:
        ...
        out["Transformations"] = (
            aws_sdk_sagemaker.types.time_series_transformations.serialize_aws_json_1_1(
    ...
    if "time_series_config" in value:
        ...
        out["TimeSeriesConfig"] = (
            aws_sdk_sagemaker.types.time_series_config.serialize_aws_json_1_1(
    ...
    if "holiday_config" in value:
        ...
        out["HolidayConfig"] = (
            aws_sdk_sagemaker.types.holiday_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TimeSeriesForecastingJobConfig:
    ...
    if "ForecastQuantiles" in data:
        ...
        out["forecast_quantiles"] = (
            aws_sdk_sagemaker.types.forecast_quantiles.deserialize_aws_json_1_1(
    ...
    if "Transformations" in data:
        ...
        out["transformations"] = (
            aws_sdk_sagemaker.types.time_series_transformations.deserialize_aws_json_1_1(
    ...
    if "TimeSeriesConfig" in data:
        ...
        out["time_series_config"] = (
            aws_sdk_sagemaker.types.time_series_config.deserialize_aws_json_1_1(
    ...
    if "HolidayConfig" in data:
        ...
        out["holiday_config"] = (
            aws_sdk_sagemaker.types.holiday_config.deserialize_aws_json_1_1(
                data["HolidayConfig"]
            )
        )
