...
class InferenceComponentSchedulingConfig(TypedDict):
    ...
    availability_zone_balance: NotRequired[
        "aws_sdk_sagemaker.types.inference_component_availability_zone_balance.InferenceComponentAvailabilityZoneBalance"
    ]
...
def serialize_aws_json_1_1(value: InferenceComponentSchedulingConfig) -> dict:
    ...
    if "placement_strategy" in value:
        ...
        out["PlacementStrategy"] = (
            aws_sdk_sagemaker.types.inference_component_placement_strategy.serialize_aws_json_1_1(
    ...
    if "availability_zone_balance" in value:
        ...
        out["AvailabilityZoneBalance"] = (
            aws_sdk_sagemaker.types.inference_component_availability_zone_balance.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InferenceComponentSchedulingConfig:
    ...
    if "PlacementStrategy" in data:
        ...
        out["placement_strategy"] = (
            aws_sdk_sagemaker.types.inference_component_placement_strategy.deserialize_aws_json_1_1(
    ...
    if "AvailabilityZoneBalance" in data:
        ...
        out["availability_zone_balance"] = (
            aws_sdk_sagemaker.types.inference_component_availability_zone_balance.deserialize_aws_json_1_1(
