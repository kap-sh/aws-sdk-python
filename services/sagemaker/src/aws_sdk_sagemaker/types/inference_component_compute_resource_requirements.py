...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.number_of_accelerator_devices
...
class InferenceComponentComputeResourceRequirements(TypedDict):
    ...
    number_of_accelerator_devices_required: NotRequired[
        "aws_sdk_sagemaker.types.number_of_accelerator_devices.NumberOfAcceleratorDevices"
    ]
    ...
    min_memory_required_in_mb: NotRequired[
        "aws_sdk_sagemaker.types.memory_in_mb.MemoryInMb"
    ]
