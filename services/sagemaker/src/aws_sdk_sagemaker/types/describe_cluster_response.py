...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.cluster_auto_scaling_config_output
    import aws_sdk_sagemaker.types.cluster_instance_group_details_list
    ...
    import aws_sdk_sagemaker.types.cluster_restricted_instance_group_details_list
    import aws_sdk_sagemaker.types.cluster_restricted_instance_groups_config_output
...
class DescribeClusterResponse(TypedDict, closed=True):
    ...
    failure_message: NotRequired["aws_sdk_sagemaker.types.string.String"]
    """<p>The failure message of the SageMaker HyperPod cluster.</p>"""
    instance_groups: NotRequired[
        "aws_sdk_sagemaker.types.cluster_instance_group_details_list.ClusterInstanceGroupDetailsList"
    ]
    """<p>The instance groups of the SageMaker HyperPod cluster.</p>"""
    restricted_instance_groups: NotRequired[
        "aws_sdk_sagemaker.types.cluster_restricted_instance_group_details_list.ClusterRestrictedInstanceGroupDetailsList"
    ]
    ...
    restricted_instance_groups_config: NotRequired[
        "aws_sdk_sagemaker.types.cluster_restricted_instance_groups_config_output.ClusterRestrictedInstanceGroupsConfigOutput"
    ]
    ...
    auto_scaling: NotRequired[
        "aws_sdk_sagemaker.types.cluster_auto_scaling_config_output.ClusterAutoScalingConfigOutput"
    ]
...
def serialize_aws_json_1_1(value: DescribeClusterResponse) -> dict:
    ...
    if "instance_groups" in value:
        ...
        out["InstanceGroups"] = (
            aws_sdk_sagemaker.types.cluster_instance_group_details_list.serialize_aws_json_1_1(
    ...
    if "restricted_instance_groups" in value:
        ...
        out["RestrictedInstanceGroups"] = (
            aws_sdk_sagemaker.types.cluster_restricted_instance_group_details_list.serialize_aws_json_1_1(
    ...
    if "restricted_instance_groups_config" in value:
        ...
        out["RestrictedInstanceGroupsConfig"] = (
            aws_sdk_sagemaker.types.cluster_restricted_instance_groups_config_output.serialize_aws_json_1_1(
    ...
    if "auto_scaling" in value:
        ...
        out["AutoScaling"] = (
            aws_sdk_sagemaker.types.cluster_auto_scaling_config_output.serialize_aws_json_1_1(
                value["auto_scaling"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeClusterResponse:
    ...
    if "InstanceGroups" in data:
        ...
        out["instance_groups"] = (
            aws_sdk_sagemaker.types.cluster_instance_group_details_list.deserialize_aws_json_1_1(
                data["InstanceGroups"]
            )
        )
    if "RestrictedInstanceGroups" in data:
        ...
        out["restricted_instance_groups"] = (
            aws_sdk_sagemaker.types.cluster_restricted_instance_group_details_list.deserialize_aws_json_1_1(
    ...
    if "RestrictedInstanceGroupsConfig" in data:
        ...
        out["restricted_instance_groups_config"] = (
            aws_sdk_sagemaker.types.cluster_restricted_instance_groups_config_output.deserialize_aws_json_1_1(
    ...
    if "AutoScaling" in data:
        ...
        out["auto_scaling"] = (
            aws_sdk_sagemaker.types.cluster_auto_scaling_config_output.deserialize_aws_json_1_1(
                data["AutoScaling"]
            )
        )
    return out
