...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.cluster_ebs_volume_size_in_gb
    import aws_sdk_sagemaker.types.kms_key_id


class ClusterEbsVolumeConfig(TypedDict):
    volume_size_in_gb: NotRequired[
        "aws_sdk_sagemaker.types.cluster_ebs_volume_size_in_gb.ClusterEbsVolumeSizeInGB"
    ]
    ...
    root_volume: NotRequired["aws_sdk_sagemaker.types.boolean.Boolean"]
