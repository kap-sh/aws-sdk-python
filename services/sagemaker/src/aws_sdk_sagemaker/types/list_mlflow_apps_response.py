...
class ListMlflowAppsResponse(TypedDict):
    summaries: NotRequired[
        "aws_sdk_sagemaker.types.mlflow_app_summaries.MlflowAppSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListMlflowAppsResponse) -> dict:
    ...
    if "summaries" in value:
        ...
        out["Summaries"] = (
            aws_sdk_sagemaker.types.mlflow_app_summaries.serialize_aws_json_1_1(
                value["summaries"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListMlflowAppsResponse:
    ...
    if "Summaries" in data:
        ...
        out["summaries"] = (
            aws_sdk_sagemaker.types.mlflow_app_summaries.deserialize_aws_json_1_1(
                data["Summaries"]
            )
        )
