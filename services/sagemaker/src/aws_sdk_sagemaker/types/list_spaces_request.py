...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.space_sort_key


class ListSpacesRequest(TypedDict):
    ...
    sort_by: NotRequired["aws_sdk_sagemaker.types.space_sort_key.SpaceSortKey"]
    """<p>The parameter by which to sort the results. The default is <code>CreationTime</code>.</p>"""
    domain_id_equals: NotRequired["aws_sdk_sagemaker.types.domain_id.DomainId"]
    """<p>A parameter to search for the domain ID.</p>"""
    space_name_contains: NotRequired["aws_sdk_sagemaker.types.space_name.SpaceName"]
...
def serialize_aws_json_1_1(value: ListSpacesRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = aws_sdk_sagemaker.types.space_sort_key.serialize_aws_json_1_1(
            value["sort_by"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListSpacesRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_sagemaker.types.space_sort_key.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
