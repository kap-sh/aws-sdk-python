...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.device_deployment_status
...
class DeviceDeploymentSummary(TypedDict):
    ...
    deployed_stage_name: NotRequired["aws_sdk_sagemaker.types.entity_name.EntityName"]
    ...
    device_name: NotRequired["aws_sdk_sagemaker.types.device_name.DeviceName"]
    """<p>The name of the device.</p>"""
    device_arn: NotRequired["aws_sdk_sagemaker.types.device_arn.DeviceArn"]
    """<p>The ARN of the device.</p>"""
    device_deployment_status: NotRequired[
        "aws_sdk_sagemaker.types.device_deployment_status.DeviceDeploymentStatus"
    ]
    """<p>The deployment status of the device.</p>"""
    device_deployment_status_message: NotRequired[
        "aws_sdk_sagemaker.types.string.String"
    ]
    ...
    deployment_start_time: NotRequired["aws_sdk_sagemaker.types.timestamp.Timestamp"]
...
def serialize_aws_json_1_1(value: DeviceDeploymentSummary) -> dict:
    ...
    if "device_deployment_status" in value:
        ...
        out["DeviceDeploymentStatus"] = (
            aws_sdk_sagemaker.types.device_deployment_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DeviceDeploymentSummary:
    ...
    if "DeviceDeploymentStatus" in data:
        ...
        out["device_deployment_status"] = (
            aws_sdk_sagemaker.types.device_deployment_status.deserialize_aws_json_1_1(
