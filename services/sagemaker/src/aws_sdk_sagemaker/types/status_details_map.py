...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.scheduler_config_component
    import aws_sdk_sagemaker.types.scheduler_resource_status

StatusDetailsMap: TypeAlias = dict[
    "aws_sdk_sagemaker.types.scheduler_config_component.SchedulerConfigComponent",
...
def serialize_aws_json_1_1(input_to_serialize: StatusDetailsMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[
            aws_sdk_sagemaker.types.scheduler_config_component.serialize_aws_json_1_1(
                key
            )
...
def deserialize_aws_json_1_1(data: dict) -> StatusDetailsMap:
    ...
    for key, value in data.items():
        ...
        out[
            aws_sdk_sagemaker.types.scheduler_config_component.deserialize_aws_json_1_1(
                key
            )
