...
class ListTrialsResponse(TypedDict):
    trial_summaries: NotRequired[
        "aws_sdk_sagemaker.types.trial_summaries.TrialSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListTrialsResponse) -> dict:
    ...
    if "trial_summaries" in value:
        ...
        out["TrialSummaries"] = (
            aws_sdk_sagemaker.types.trial_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListTrialsResponse:
    ...
    if "TrialSummaries" in data:
        ...
        out["trial_summaries"] = (
            aws_sdk_sagemaker.types.trial_summaries.deserialize_aws_json_1_1(
                data["TrialSummaries"]
            )
        )
