...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.inference_execution_mode


class InferenceExecutionConfig(TypedDict):
    mode: NotRequired[
        "aws_sdk_sagemaker.types.inference_execution_mode.InferenceExecutionMode"
    ]
...
def serialize_aws_json_1_1(value: InferenceExecutionConfig) -> dict:
    ...
    if "mode" in value:
        ...
        out["Mode"] = (
            aws_sdk_sagemaker.types.inference_execution_mode.serialize_aws_json_1_1(
                value["mode"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> InferenceExecutionConfig:
    ...
    if "Mode" in data:
        ...
        out["mode"] = (
            aws_sdk_sagemaker.types.inference_execution_mode.deserialize_aws_json_1_1(
                data["Mode"]
            )
        )
    return out
