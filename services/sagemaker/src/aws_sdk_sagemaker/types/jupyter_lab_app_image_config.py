"""Generated from Smithy shape ``com.amazonaws.sagemaker#JupyterLabAppImageConfig``."""
...
class JupyterLabAppImageConfig(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: JupyterLabAppImageConfig) -> dict:
    out: dict = {}
