...
class RecommendationJobStoppingConditions(TypedDict):
    ...
    model_latency_thresholds: NotRequired[
        "aws_sdk_sagemaker.types.model_latency_thresholds.ModelLatencyThresholds"
    ]
    ...
    flat_invocations: NotRequired[
        "aws_sdk_sagemaker.types.flat_invocations.FlatInvocations"
    ]
...
def serialize_aws_json_1_1(value: RecommendationJobStoppingConditions) -> dict:
    ...
    if "model_latency_thresholds" in value:
        ...
        out["ModelLatencyThresholds"] = (
            aws_sdk_sagemaker.types.model_latency_thresholds.serialize_aws_json_1_1(
    ...
    if "flat_invocations" in value:
        ...
        out["FlatInvocations"] = (
            aws_sdk_sagemaker.types.flat_invocations.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RecommendationJobStoppingConditions:
    ...
    if "ModelLatencyThresholds" in data:
        ...
        out["model_latency_thresholds"] = (
            aws_sdk_sagemaker.types.model_latency_thresholds.deserialize_aws_json_1_1(
    ...
    if "FlatInvocations" in data:
        ...
        out["flat_invocations"] = (
            aws_sdk_sagemaker.types.flat_invocations.deserialize_aws_json_1_1(
