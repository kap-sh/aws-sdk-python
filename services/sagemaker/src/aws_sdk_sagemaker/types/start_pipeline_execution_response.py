"""Generated from Smithy shape ``com.amazonaws.sagemaker#StartPipelineExecutionResponse``."""
...
class StartPipelineExecutionResponse(TypedDict):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StartPipelineExecutionResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> StartPipelineExecutionResponse:
