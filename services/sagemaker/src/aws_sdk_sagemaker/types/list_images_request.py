...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.image_name_contains
    import aws_sdk_sagemaker.types.image_sort_by
    import aws_sdk_sagemaker.types.image_sort_order
...
class ListImagesRequest(TypedDict):
    ...
    name_contains: NotRequired[
        "aws_sdk_sagemaker.types.image_name_contains.ImageNameContains"
    ]
    ...
    sort_by: NotRequired["aws_sdk_sagemaker.types.image_sort_by.ImageSortBy"]
    """<p>The property used to sort results. The default value is <code>CREATION_TIME</code>.</p>"""
    sort_order: NotRequired["aws_sdk_sagemaker.types.image_sort_order.ImageSortOrder"]
...
def serialize_aws_json_1_1(value: ListImagesRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = aws_sdk_sagemaker.types.image_sort_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
    if "sort_order" in value:
        ...
        out["SortOrder"] = (
            aws_sdk_sagemaker.types.image_sort_order.serialize_aws_json_1_1(
                value["sort_order"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListImagesRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = aws_sdk_sagemaker.types.image_sort_by.deserialize_aws_json_1_1(
            data["SortBy"]
        )
    if "SortOrder" in data:
        ...
        out["sort_order"] = (
            aws_sdk_sagemaker.types.image_sort_order.deserialize_aws_json_1_1(
                data["SortOrder"]
            )
        )
    return out
