...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.pipeline_execution_step

PipelineExecutionStepList: TypeAlias = list[
    "aws_sdk_sagemaker.types.pipeline_execution_step.PipelineExecutionStep"
]
...
def serialize_aws_json_1_1(value: PipelineExecutionStepList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.pipeline_execution_step.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> PipelineExecutionStepList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.pipeline_execution_step.deserialize_aws_json_1_1(
                item
            )
        )
    return out
