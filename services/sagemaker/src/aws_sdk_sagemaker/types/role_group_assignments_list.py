...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.role_group_assignment

RoleGroupAssignmentsList: TypeAlias = list[
    "aws_sdk_sagemaker.types.role_group_assignment.RoleGroupAssignment"
]
...
def serialize_aws_json_1_1(value: RoleGroupAssignmentsList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.role_group_assignment.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> RoleGroupAssignmentsList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.role_group_assignment.deserialize_aws_json_1_1(item)
        )
    return out
