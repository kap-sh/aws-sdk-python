...
class ListAIBenchmarkJobsRequest(TypedDict):
    ...
    sort_by: NotRequired[
        "aws_sdk_sagemaker.types.list_ai_benchmark_jobs_sort_by.ListAIBenchmarkJobsSortBy"
    ]
...
def serialize_aws_json_1_1(value: ListAIBenchmarkJobsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            aws_sdk_sagemaker.types.list_ai_benchmark_jobs_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListAIBenchmarkJobsRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_sagemaker.types.list_ai_benchmark_jobs_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
