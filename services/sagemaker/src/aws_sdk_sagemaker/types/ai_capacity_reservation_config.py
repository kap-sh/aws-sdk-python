...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.ai_capacity_reservation_preference
    import aws_sdk_sagemaker.types.ai_ml_reservation_arn_list


class AICapacityReservationConfig(TypedDict):
    capacity_reservation_preference: NotRequired[
        "aws_sdk_sagemaker.types.ai_capacity_reservation_preference.AICapacityReservationPreference"
    ]
    ...
    ml_reservation_arns: NotRequired[
        "aws_sdk_sagemaker.types.ai_ml_reservation_arn_list.AIMlReservationArnList"
    ]
...
def serialize_aws_json_1_1(value: AICapacityReservationConfig) -> dict:
    ...
    if "capacity_reservation_preference" in value:
        ...
        out["CapacityReservationPreference"] = (
            aws_sdk_sagemaker.types.ai_capacity_reservation_preference.serialize_aws_json_1_1(
    ...
    if "ml_reservation_arns" in value:
        ...
        out["MlReservationArns"] = (
            aws_sdk_sagemaker.types.ai_ml_reservation_arn_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AICapacityReservationConfig:
    ...
    if "CapacityReservationPreference" in data:
        ...
        out["capacity_reservation_preference"] = (
            aws_sdk_sagemaker.types.ai_capacity_reservation_preference.deserialize_aws_json_1_1(
    ...
    if "MlReservationArns" in data:
        ...
        out["ml_reservation_arns"] = (
            aws_sdk_sagemaker.types.ai_ml_reservation_arn_list.deserialize_aws_json_1_1(
