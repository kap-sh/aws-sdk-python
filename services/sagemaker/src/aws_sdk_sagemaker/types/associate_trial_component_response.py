"""Generated from Smithy shape ``com.amazonaws.sagemaker#AssociateTrialComponentResponse``."""
...
class AssociateTrialComponentResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AssociateTrialComponentResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> AssociateTrialComponentResponse:
    out: AssociateTrialComponentResponse = {}  # type: ignore[typeddict-item]
