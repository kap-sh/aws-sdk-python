...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.sort_contexts_by
...
class ListContextsRequest(TypedDict):
    ...
    sort_by: NotRequired["aws_sdk_sagemaker.types.sort_contexts_by.SortContextsBy"]
...
def serialize_aws_json_1_1(value: ListContextsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = aws_sdk_sagemaker.types.sort_contexts_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListContextsRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_sagemaker.types.sort_contexts_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
