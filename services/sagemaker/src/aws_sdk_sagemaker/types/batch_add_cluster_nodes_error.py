...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.batch_add_cluster_nodes_error_code
    import aws_sdk_sagemaker.types.batch_add_failure_count
...
class BatchAddClusterNodesError(TypedDict, closed=True):
    ...
    failed_count: "aws_sdk_sagemaker.types.batch_add_failure_count.BatchAddFailureCount"
...
def serialize_aws_json_1_1(value: BatchAddClusterNodesError) -> dict:
    ...
    out["ErrorCode"] = (
        aws_sdk_sagemaker.types.batch_add_cluster_nodes_error_code.serialize_aws_json_1_1(
            value["error_code"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> BatchAddClusterNodesError:
    ...
    if "ErrorCode" in data:
        ...
        out["error_code"] = (
            aws_sdk_sagemaker.types.batch_add_cluster_nodes_error_code.deserialize_aws_json_1_1(
                data["ErrorCode"]
            )
        )
    else:
