...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.inference_component_compute_resource_requirements
    import aws_sdk_sagemaker.types.inference_component_container_specification_summary
    import aws_sdk_sagemaker.types.inference_component_data_cache_config_summary
    import aws_sdk_sagemaker.types.inference_component_name
    import aws_sdk_sagemaker.types.inference_component_scheduling_config
    import aws_sdk_sagemaker.types.inference_component_startup_parameters
    import aws_sdk_sagemaker.types.model_name
    import aws_sdk_sagemaker.types.production_variant_instance_type


class InferenceComponentSpecificationSummary(TypedDict):
    ...
    container: NotRequired[
        "aws_sdk_sagemaker.types.inference_component_container_specification_summary.InferenceComponentContainerSpecificationSummary"
    ]
    ...
    startup_parameters: NotRequired[
        "aws_sdk_sagemaker.types.inference_component_startup_parameters.InferenceComponentStartupParameters"
    ]
    """<p>Settings that take effect while the model container starts up.</p>"""
    compute_resource_requirements: NotRequired[
        "aws_sdk_sagemaker.types.inference_component_compute_resource_requirements.InferenceComponentComputeResourceRequirements"
    ]
    ...
    data_cache_config: NotRequired[
        "aws_sdk_sagemaker.types.inference_component_data_cache_config_summary.InferenceComponentDataCacheConfigSummary"
    ]
    """<p>Settings that affect how the inference component caches data.</p>"""
    scheduling_config: NotRequired[
        "aws_sdk_sagemaker.types.inference_component_scheduling_config.InferenceComponentSchedulingConfig"
    ]
...
def serialize_aws_json_1_1(value: InferenceComponentSpecificationSummary) -> dict:
    ...
    if "container" in value:
        ...
        out["Container"] = (
            aws_sdk_sagemaker.types.inference_component_container_specification_summary.serialize_aws_json_1_1(
                value["container"]
            )
        )
    if "startup_parameters" in value:
        ...
        out["StartupParameters"] = (
            aws_sdk_sagemaker.types.inference_component_startup_parameters.serialize_aws_json_1_1(
    ...
    if "compute_resource_requirements" in value:
        ...
        out["ComputeResourceRequirements"] = (
            aws_sdk_sagemaker.types.inference_component_compute_resource_requirements.serialize_aws_json_1_1(
    ...
    if "data_cache_config" in value:
        ...
        out["DataCacheConfig"] = (
            aws_sdk_sagemaker.types.inference_component_data_cache_config_summary.serialize_aws_json_1_1(
    ...
    if "scheduling_config" in value:
        ...
        out["SchedulingConfig"] = (
            aws_sdk_sagemaker.types.inference_component_scheduling_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InferenceComponentSpecificationSummary:
    ...
    if "Container" in data:
        ...
        out["container"] = (
            aws_sdk_sagemaker.types.inference_component_container_specification_summary.deserialize_aws_json_1_1(
                data["Container"]
            )
        )
    if "StartupParameters" in data:
        ...
        out["startup_parameters"] = (
            aws_sdk_sagemaker.types.inference_component_startup_parameters.deserialize_aws_json_1_1(
    ...
    if "ComputeResourceRequirements" in data:
        ...
        out["compute_resource_requirements"] = (
            aws_sdk_sagemaker.types.inference_component_compute_resource_requirements.deserialize_aws_json_1_1(
    ...
    if "DataCacheConfig" in data:
        ...
        out["data_cache_config"] = (
            aws_sdk_sagemaker.types.inference_component_data_cache_config_summary.deserialize_aws_json_1_1(
    ...
    if "SchedulingConfig" in data:
        ...
        out["scheduling_config"] = (
            aws_sdk_sagemaker.types.inference_component_scheduling_config.deserialize_aws_json_1_1(
