...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.batch_delete_cluster_nodes_error

BatchDeleteClusterNodesErrorList: TypeAlias = list[
    "aws_sdk_sagemaker.types.batch_delete_cluster_nodes_error.BatchDeleteClusterNodesError"
]
...
def serialize_aws_json_1_1(value: BatchDeleteClusterNodesErrorList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sagemaker.types.batch_delete_cluster_nodes_error.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> BatchDeleteClusterNodesErrorList:
    ...
    for item in data:
        out.append(
            aws_sdk_sagemaker.types.batch_delete_cluster_nodes_error.deserialize_aws_json_1_1(
                item
            )
        )
    return out
