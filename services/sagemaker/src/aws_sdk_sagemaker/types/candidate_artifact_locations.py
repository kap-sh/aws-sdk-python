...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.backtest_results_location
    import aws_sdk_sagemaker.types.explainability_location
    import aws_sdk_sagemaker.types.model_insights_location


class CandidateArtifactLocations(TypedDict):
    explainability: NotRequired[
        "aws_sdk_sagemaker.types.explainability_location.ExplainabilityLocation"
    ]
    """<p>The Amazon S3 prefix to the explainability artifacts generated for the AutoML candidate.</p>"""
    model_insights: NotRequired[
        "aws_sdk_sagemaker.types.model_insights_location.ModelInsightsLocation"
    ]
    """<p>The Amazon S3 prefix to the model insight artifacts generated for the AutoML candidate.</p>"""
    backtest_results: NotRequired[
        "aws_sdk_sagemaker.types.backtest_results_location.BacktestResultsLocation"
    ]
