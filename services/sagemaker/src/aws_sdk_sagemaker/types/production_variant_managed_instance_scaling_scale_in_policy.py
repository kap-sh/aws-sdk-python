...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.managed_instance_scaling_cooldown_in_minutes
    import aws_sdk_sagemaker.types.managed_instance_scaling_maximum_step_size
    import aws_sdk_sagemaker.types.managed_instance_scaling_scale_in_strategy


class ProductionVariantManagedInstanceScalingScaleInPolicy(TypedDict):
    strategy: NotRequired[
        "aws_sdk_sagemaker.types.managed_instance_scaling_scale_in_strategy.ManagedInstanceScalingScaleInStrategy"
    ]
    ...
    maximum_step_size: NotRequired[
        "aws_sdk_sagemaker.types.managed_instance_scaling_maximum_step_size.ManagedInstanceScalingMaximumStepSize"
    ]
    ...
    cooldown_in_minutes: NotRequired[
        "aws_sdk_sagemaker.types.managed_instance_scaling_cooldown_in_minutes.ManagedInstanceScalingCooldownInMinutes"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "strategy" in value:
        ...
        out["Strategy"] = (
            aws_sdk_sagemaker.types.managed_instance_scaling_scale_in_strategy.serialize_aws_json_1_1(
                value["strategy"]
            )
        )
...
def deserialize_aws_json_1_1(
    ...
    if "Strategy" in data:
        ...
        out["strategy"] = (
            aws_sdk_sagemaker.types.managed_instance_scaling_scale_in_strategy.deserialize_aws_json_1_1(
                data["Strategy"]
            )
        )
