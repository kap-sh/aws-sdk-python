...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.endpoint_sort_key
...
class ListEndpointsInput(TypedDict, closed=True):
    ...
    name_contains: NotRequired[
        "aws_sdk_sagemaker.types.endpoint_name_contains.EndpointNameContains"
    ]
    ...
    status_equals: NotRequired["aws_sdk_sagemaker.types.endpoint_status.EndpointStatus"]
...
def serialize_aws_json_1_1(value: ListEndpointsInput) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            aws_sdk_sagemaker.types.endpoint_sort_key.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListEndpointsInput:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_sagemaker.types.endpoint_sort_key.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
