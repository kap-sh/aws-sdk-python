...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.device_subset_type
    import aws_sdk_sagemaker.types.percentage


class DeviceSelectionConfig(TypedDict):
    device_subset_type: NotRequired[
        "aws_sdk_sagemaker.types.device_subset_type.DeviceSubsetType"
    ]
    """<p>Type of device subsets to deploy to the current stage.</p>"""
    percentage: NotRequired["aws_sdk_sagemaker.types.percentage.Percentage"]
    ...
    device_name_contains: NotRequired["aws_sdk_sagemaker.types.device_name.DeviceName"]
...
def serialize_aws_json_1_1(value: DeviceSelectionConfig) -> dict:
    ...
    if "device_subset_type" in value:
        ...
        out["DeviceSubsetType"] = (
            aws_sdk_sagemaker.types.device_subset_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DeviceSelectionConfig:
    ...
    if "DeviceSubsetType" in data:
        ...
        out["device_subset_type"] = (
            aws_sdk_sagemaker.types.device_subset_type.deserialize_aws_json_1_1(
