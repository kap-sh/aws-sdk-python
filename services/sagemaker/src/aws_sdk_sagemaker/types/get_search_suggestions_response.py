...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.property_name_suggestion_list


class GetSearchSuggestionsResponse(TypedDict):
    property_name_suggestions: NotRequired[
        "aws_sdk_sagemaker.types.property_name_suggestion_list.PropertyNameSuggestionList"
    ]
...
def serialize_aws_json_1_1(value: GetSearchSuggestionsResponse) -> dict:
    ...
    if "property_name_suggestions" in value:
        ...
        out["PropertyNameSuggestions"] = (
            aws_sdk_sagemaker.types.property_name_suggestion_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetSearchSuggestionsResponse:
    ...
    if "PropertyNameSuggestions" in data:
        ...
        out["property_name_suggestions"] = (
            aws_sdk_sagemaker.types.property_name_suggestion_list.deserialize_aws_json_1_1(
