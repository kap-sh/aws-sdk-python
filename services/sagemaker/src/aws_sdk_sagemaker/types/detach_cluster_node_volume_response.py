...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.volume_device_name
    import aws_sdk_sagemaker.types.volume_id


class DetachClusterNodeVolumeResponse(TypedDict):
    ...
    attach_time: NotRequired["aws_sdk_sagemaker.types.timestamp.Timestamp"]
    """<p> The original timestamp when your volume was initially attached to the node. </p>"""
    status: NotRequired[
        "aws_sdk_sagemaker.types.volume_attachment_status.VolumeAttachmentStatus"
    ]
    """<p> The current status of your volume detachment operation. </p>"""
    device_name: NotRequired[
        "aws_sdk_sagemaker.types.volume_device_name.VolumeDeviceName"
    ]
...
def serialize_aws_json_1_1(value: DetachClusterNodeVolumeResponse) -> dict:
    ...
    if "attach_time" in value:
        ...
        out["AttachTime"] = aws_sdk_sagemaker.types.timestamp.serialize_aws_json_1_1(
            value["attach_time"]
        )
    if "status" in value:
        import aws_sdk_sagemaker.types.volume_attachment_status
        ...
        out["Status"] = (
            aws_sdk_sagemaker.types.volume_attachment_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DetachClusterNodeVolumeResponse:
    ...
    if "AttachTime" in data:
        ...
        out["attach_time"] = aws_sdk_sagemaker.types.timestamp.deserialize_aws_json_1_1(
            data["AttachTime"]
        )
    if "Status" in data:
        import aws_sdk_sagemaker.types.volume_attachment_status
        ...
        out["status"] = (
            aws_sdk_sagemaker.types.volume_attachment_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
