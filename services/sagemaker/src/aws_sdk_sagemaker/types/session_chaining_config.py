...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.enable_session_tag_chaining


class SessionChainingConfig(TypedDict):
    enable_session_tag_chaining: NotRequired[
        "aws_sdk_sagemaker.types.enable_session_tag_chaining.EnableSessionTagChaining"
    ]
