...
class TimeSeriesTransformations(TypedDict):
    ...
    aggregation: NotRequired[
        "aws_sdk_sagemaker.types.aggregation_transformations.AggregationTransformations"
    ]
...
def serialize_aws_json_1_1(value: TimeSeriesTransformations) -> dict:
    ...
    if "filling" in value:
        ...
        out["Filling"] = (
            aws_sdk_sagemaker.types.filling_transformations.serialize_aws_json_1_1(
                value["filling"]
            )
        )
    if "aggregation" in value:
        ...
        out["Aggregation"] = (
            aws_sdk_sagemaker.types.aggregation_transformations.serialize_aws_json_1_1(
                value["aggregation"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> TimeSeriesTransformations:
    ...
    if "Filling" in data:
        ...
        out["filling"] = (
            aws_sdk_sagemaker.types.filling_transformations.deserialize_aws_json_1_1(
                data["Filling"]
            )
        )
    if "Aggregation" in data:
        ...
        out["aggregation"] = (
            aws_sdk_sagemaker.types.aggregation_transformations.deserialize_aws_json_1_1(
                data["Aggregation"]
            )
        )
    return out
