...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.optimization_types
    import aws_sdk_sagemaker.types.timestamp


class OptimizationJobSummary(TypedDict):
    ...
    optimization_types: NotRequired[
        "aws_sdk_sagemaker.types.optimization_types.OptimizationTypes"
    ]
...
def serialize_aws_json_1_1(value: OptimizationJobSummary) -> dict:
    ...
    if "optimization_types" in value:
        ...
        out["OptimizationTypes"] = (
            aws_sdk_sagemaker.types.optimization_types.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OptimizationJobSummary:
    ...
    if "OptimizationTypes" in data:
        ...
        out["optimization_types"] = (
            aws_sdk_sagemaker.types.optimization_types.deserialize_aws_json_1_1(
