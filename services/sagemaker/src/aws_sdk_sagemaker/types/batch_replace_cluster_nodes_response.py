...
if TYPE_CHECKING:
    ...
    import aws_sdk_sagemaker.types.batch_replace_cluster_nodes_errors
...
class BatchReplaceClusterNodesResponse(TypedDict):
    ...
    failed: NotRequired[
        "aws_sdk_sagemaker.types.batch_replace_cluster_nodes_errors.BatchReplaceClusterNodesErrors"
    ]
    ...
    failed_node_logical_ids: NotRequired[
        "aws_sdk_sagemaker.types.batch_replace_cluster_node_logical_ids_errors.BatchReplaceClusterNodeLogicalIdsErrors"
    ]
...
def serialize_aws_json_1_1(value: BatchReplaceClusterNodesResponse) -> dict:
    ...
    if "failed" in value:
        ...
        out["Failed"] = (
            aws_sdk_sagemaker.types.batch_replace_cluster_nodes_errors.serialize_aws_json_1_1(
                value["failed"]
            )
        )
    if "failed_node_logical_ids" in value:
        ...
        out["FailedNodeLogicalIds"] = (
            aws_sdk_sagemaker.types.batch_replace_cluster_node_logical_ids_errors.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchReplaceClusterNodesResponse:
    ...
    if "Failed" in data:
        ...
        out["failed"] = (
            aws_sdk_sagemaker.types.batch_replace_cluster_nodes_errors.deserialize_aws_json_1_1(
                data["Failed"]
            )
        )
    if "FailedNodeLogicalIds" in data:
        ...
        out["failed_node_logical_ids"] = (
            aws_sdk_sagemaker.types.batch_replace_cluster_node_logical_ids_errors.deserialize_aws_json_1_1(
