...
class CreateAIBenchmarkJobRequest(TypedDict):
    ...
    output_config: NotRequired[
        "aws_sdk_sagemaker.types.ai_benchmark_output_config.AIBenchmarkOutputConfig"
    ]
...
def serialize_aws_json_1_1(value: CreateAIBenchmarkJobRequest) -> dict:
    ...
    if "output_config" in value:
        ...
        out["OutputConfig"] = (
            aws_sdk_sagemaker.types.ai_benchmark_output_config.serialize_aws_json_1_1(
                value["output_config"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> CreateAIBenchmarkJobRequest:
    ...
    if "OutputConfig" in data:
        ...
        out["output_config"] = (
            aws_sdk_sagemaker.types.ai_benchmark_output_config.deserialize_aws_json_1_1(
                data["OutputConfig"]
            )
        )
