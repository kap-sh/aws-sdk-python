...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.stop_processing_job_request
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.stop_processing_job_request.StopProcessingJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.stop_processing_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
