...
def build_request(
    ...
    input: aws_sdk_sagemaker.types.update_workteam_request.UpdateWorkteamRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.update_workteam_request.serialize_aws_json_1_1(input)
    ).encode()
