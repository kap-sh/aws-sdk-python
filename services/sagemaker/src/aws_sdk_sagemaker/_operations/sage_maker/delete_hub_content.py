...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.delete_hub_content_request
...
def build_request(
    ...
    input: aws_sdk_sagemaker.types.delete_hub_content_request.DeleteHubContentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.delete_hub_content_request.serialize_aws_json_1_1(input)
    ).encode()
