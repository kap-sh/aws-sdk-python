...
import aws_sdk_sagemaker.types.update_space_request
import aws_sdk_sagemaker.types.update_space_response
...
) -> aws_sdk_sagemaker.types.update_space_response.UpdateSpaceResponse:
    out: aws_sdk_sagemaker.types.update_space_response.UpdateSpaceResponse = (
        aws_sdk_sagemaker.types.update_space_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.update_space_request.UpdateSpaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.update_space_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_space(
    ...
    aws_sdk_sagemaker.types.update_space_response.UpdateSpaceResponse, zapros.Response
]:
