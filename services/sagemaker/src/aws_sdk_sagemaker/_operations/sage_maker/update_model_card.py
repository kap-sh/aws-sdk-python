...
import aws_sdk_sagemaker.types.update_model_card_request
import aws_sdk_sagemaker.types.update_model_card_response
...
) -> aws_sdk_sagemaker.types.update_model_card_response.UpdateModelCardResponse:
    out: aws_sdk_sagemaker.types.update_model_card_response.UpdateModelCardResponse = (
        aws_sdk_sagemaker.types.update_model_card_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.update_model_card_request.UpdateModelCardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.update_model_card_request.serialize_aws_json_1_1(input_)
    ).encode()
