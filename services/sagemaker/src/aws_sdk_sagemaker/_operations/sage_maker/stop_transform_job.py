...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.stop_transform_job_request
...
def build_request(
    ...
    input: aws_sdk_sagemaker.types.stop_transform_job_request.StopTransformJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.stop_transform_job_request.serialize_aws_json_1_1(input)
    ).encode()
