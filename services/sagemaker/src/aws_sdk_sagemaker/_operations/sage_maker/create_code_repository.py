...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.create_code_repository_input.CreateCodeRepositoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.create_code_repository_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
