"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateLabelingJob``."""
...
import aws_sdk_sagemaker.types.create_labeling_job_request
import aws_sdk_sagemaker.types.create_labeling_job_response
...
) -> aws_sdk_sagemaker.types.create_labeling_job_response.CreateLabelingJobResponse:
    out: aws_sdk_sagemaker.types.create_labeling_job_response.CreateLabelingJobResponse = aws_sdk_sagemaker.types.create_labeling_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.create_labeling_job_request.CreateLabelingJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.create_labeling_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_labeling_job(
