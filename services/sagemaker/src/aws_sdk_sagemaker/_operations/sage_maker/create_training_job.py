"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateTrainingJob``."""
...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.create_training_job_request
    import aws_sdk_sagemaker.types.create_training_job_response
...
) -> aws_sdk_sagemaker.types.create_training_job_response.CreateTrainingJobResponse:
    import aws_sdk_sagemaker.types.create_training_job_response

    out: aws_sdk_sagemaker.types.create_training_job_response.CreateTrainingJobResponse = aws_sdk_sagemaker.types.create_training_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.create_training_job_request.CreateTrainingJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.create_training_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_training_job(
