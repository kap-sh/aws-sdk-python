"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeEndpoint``."""
...
import aws_sdk_sagemaker.types.describe_endpoint_input
import aws_sdk_sagemaker.types.describe_endpoint_output
...
) -> aws_sdk_sagemaker.types.describe_endpoint_output.DescribeEndpointOutput:
    out: aws_sdk_sagemaker.types.describe_endpoint_output.DescribeEndpointOutput = (
        aws_sdk_sagemaker.types.describe_endpoint_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_endpoint_input.DescribeEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_endpoint_input.serialize_aws_json_1_1(input_)
    ).encode()
