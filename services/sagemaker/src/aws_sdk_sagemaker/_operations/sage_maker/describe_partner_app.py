"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribePartnerApp``."""
...
import aws_sdk_sagemaker.types.describe_partner_app_request
import aws_sdk_sagemaker.types.describe_partner_app_response
...
) -> aws_sdk_sagemaker.types.describe_partner_app_response.DescribePartnerAppResponse:
    out: aws_sdk_sagemaker.types.describe_partner_app_response.DescribePartnerAppResponse = aws_sdk_sagemaker.types.describe_partner_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_partner_app_request.DescribePartnerAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribePartnerApp"
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_partner_app_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_partner_app(
