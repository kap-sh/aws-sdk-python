"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeNotebookInstance``."""
...
import aws_sdk_sagemaker.types.describe_notebook_instance_input
import aws_sdk_sagemaker.types.describe_notebook_instance_output
...
) -> aws_sdk_sagemaker.types.describe_notebook_instance_output.DescribeNotebookInstanceOutput:
    out: aws_sdk_sagemaker.types.describe_notebook_instance_output.DescribeNotebookInstanceOutput = aws_sdk_sagemaker.types.describe_notebook_instance_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_notebook_instance_input.DescribeNotebookInstanceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_notebook_instance_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_notebook_instance(
