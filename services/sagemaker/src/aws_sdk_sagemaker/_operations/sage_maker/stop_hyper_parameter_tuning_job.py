"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopHyperParameterTuningJob``."""
...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.stop_hyper_parameter_tuning_job_request
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.stop_hyper_parameter_tuning_job_request.StopHyperParameterTuningJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.stop_hyper_parameter_tuning_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_hyper_parameter_tuning_job(
