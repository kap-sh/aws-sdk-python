...
def build_request(
    ...
    input: aws_sdk_sagemaker.types.describe_domain_request.DescribeDomainRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_domain_request.serialize_aws_json_1_1(input)
    ).encode()
