...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.describe_domain_request
    import aws_sdk_sagemaker.types.describe_domain_response
...
) -> aws_sdk_sagemaker.types.describe_domain_response.DescribeDomainResponse:
    import aws_sdk_sagemaker.types.describe_domain_response

    out: aws_sdk_sagemaker.types.describe_domain_response.DescribeDomainResponse = (
        aws_sdk_sagemaker.types.describe_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_domain_request.DescribeDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_domain_request.serialize_aws_json_1_1(input_)
    ).encode()
