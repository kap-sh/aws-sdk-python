"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateDeviceFleet``."""
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.create_device_fleet_request.CreateDeviceFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateDeviceFleet"
    import aws_sdk_sagemaker.types.create_device_fleet_request

    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.create_device_fleet_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_device_fleet(
