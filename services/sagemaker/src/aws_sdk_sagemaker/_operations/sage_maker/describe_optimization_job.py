"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeOptimizationJob``."""
...
import aws_sdk_sagemaker.types.describe_optimization_job_request
import aws_sdk_sagemaker.types.describe_optimization_job_response
...
) -> aws_sdk_sagemaker.types.describe_optimization_job_response.DescribeOptimizationJobResponse:
    out: aws_sdk_sagemaker.types.describe_optimization_job_response.DescribeOptimizationJobResponse = aws_sdk_sagemaker.types.describe_optimization_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_optimization_job_request.DescribeOptimizationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeOptimizationJob"
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_optimization_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_optimization_job(
