"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateJob``."""
...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.create_job_request
    import aws_sdk_sagemaker.types.create_job_response
...
) -> aws_sdk_sagemaker.types.create_job_response.CreateJobResponse:
    import aws_sdk_sagemaker.types.create_job_response

    out: aws_sdk_sagemaker.types.create_job_response.CreateJobResponse = (
        aws_sdk_sagemaker.types.create_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.create_job_request.CreateJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateJob"
    import aws_sdk_sagemaker.types.create_job_request

    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.create_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_job(
    ...
    aws_sdk_sagemaker.types.create_job_response.CreateJobResponse, zapros.Response
]:
