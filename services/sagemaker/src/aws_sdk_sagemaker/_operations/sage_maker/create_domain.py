"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateDomain``."""
...
import aws_sdk_sagemaker.types.create_domain_request
import aws_sdk_sagemaker.types.create_domain_response
...
) -> aws_sdk_sagemaker.types.create_domain_response.CreateDomainResponse:
    out: aws_sdk_sagemaker.types.create_domain_response.CreateDomainResponse = (
        aws_sdk_sagemaker.types.create_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.create_domain_request.CreateDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.create_domain_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_domain(
    ...
    aws_sdk_sagemaker.types.create_domain_response.CreateDomainResponse, zapros.Response
]:
