...
import aws_sdk_sagemaker.types.describe_mlflow_app_request
import aws_sdk_sagemaker.types.describe_mlflow_app_response
...
) -> aws_sdk_sagemaker.types.describe_mlflow_app_response.DescribeMlflowAppResponse:
    out: aws_sdk_sagemaker.types.describe_mlflow_app_response.DescribeMlflowAppResponse = aws_sdk_sagemaker.types.describe_mlflow_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_mlflow_app_request.DescribeMlflowAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_mlflow_app_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
