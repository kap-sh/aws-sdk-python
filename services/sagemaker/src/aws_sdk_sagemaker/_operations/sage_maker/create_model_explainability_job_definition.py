"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateModelExplainabilityJobDefinition``."""
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.create_model_explainability_job_definition_request.CreateModelExplainabilityJobDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateModelExplainabilityJobDefinition"
    import aws_sdk_sagemaker.types.create_model_explainability_job_definition_request

    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.create_model_explainability_job_definition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_model_explainability_job_definition(
