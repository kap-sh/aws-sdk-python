"""Generated from Smithy shape ``com.amazonaws.sagemaker#Search``."""
...
import aws_sdk_sagemaker.types.search_request
import aws_sdk_sagemaker.types.search_response
...
) -> aws_sdk_sagemaker.types.search_response.SearchResponse:
    out: aws_sdk_sagemaker.types.search_response.SearchResponse = (
        aws_sdk_sagemaker.types.search_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.search_request.SearchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.search_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def search(
    ...
    input_: aws_sdk_sagemaker.types.search_request.SearchRequest,
) -> tuple[aws_sdk_sagemaker.types.search_response.SearchResponse, zapros.Response]:
