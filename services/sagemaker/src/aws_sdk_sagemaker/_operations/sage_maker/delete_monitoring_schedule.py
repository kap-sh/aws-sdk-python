"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteMonitoringSchedule``."""
...
import aws_sdk_sagemaker.types.delete_monitoring_schedule_request
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.delete_monitoring_schedule_request.DeleteMonitoringScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.delete_monitoring_schedule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_monitoring_schedule(
