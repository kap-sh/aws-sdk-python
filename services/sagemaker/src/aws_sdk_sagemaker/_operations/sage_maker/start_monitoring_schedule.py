...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.start_monitoring_schedule_request
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.start_monitoring_schedule_request.StartMonitoringScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.start_monitoring_schedule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
