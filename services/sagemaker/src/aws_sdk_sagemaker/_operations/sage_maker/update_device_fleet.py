"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateDeviceFleet``."""
...
import aws_sdk_sagemaker.types.update_device_fleet_request
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.update_device_fleet_request.UpdateDeviceFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateDeviceFleet"
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.update_device_fleet_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_device_fleet(
