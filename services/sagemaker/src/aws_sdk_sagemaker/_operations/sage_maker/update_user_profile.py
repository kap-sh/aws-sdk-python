...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.update_user_profile_request
    import aws_sdk_sagemaker.types.update_user_profile_response
...
) -> aws_sdk_sagemaker.types.update_user_profile_response.UpdateUserProfileResponse:
    import aws_sdk_sagemaker.types.update_user_profile_response

    out: aws_sdk_sagemaker.types.update_user_profile_response.UpdateUserProfileResponse = aws_sdk_sagemaker.types.update_user_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.update_user_profile_request.UpdateUserProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.update_user_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
