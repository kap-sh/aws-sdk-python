"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeFeatureGroup``."""
...
import aws_sdk_sagemaker.types.describe_feature_group_request
import aws_sdk_sagemaker.types.describe_feature_group_response
...
def handle_response(
    ...
    aws_sdk_sagemaker.types.describe_feature_group_response.DescribeFeatureGroupResponse
):
    out: aws_sdk_sagemaker.types.describe_feature_group_response.DescribeFeatureGroupResponse = aws_sdk_sagemaker.types.describe_feature_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_feature_group_request.DescribeFeatureGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_feature_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_feature_group(
