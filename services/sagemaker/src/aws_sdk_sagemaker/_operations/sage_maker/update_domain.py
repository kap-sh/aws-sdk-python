"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateDomain``."""
...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.update_domain_request
    import aws_sdk_sagemaker.types.update_domain_response
...
) -> aws_sdk_sagemaker.types.update_domain_response.UpdateDomainResponse:
    import aws_sdk_sagemaker.types.update_domain_response

    out: aws_sdk_sagemaker.types.update_domain_response.UpdateDomainResponse = (
        aws_sdk_sagemaker.types.update_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.update_domain_request.UpdateDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.update_domain_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_domain(
    ...
    aws_sdk_sagemaker.types.update_domain_response.UpdateDomainResponse, zapros.Response
]:
