"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteUserProfile``."""
...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.delete_user_profile_request
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.delete_user_profile_request.DeleteUserProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.delete_user_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_user_profile(
