...
import aws_sdk_sagemaker.types.create_data_quality_job_definition_request
import aws_sdk_sagemaker.types.create_data_quality_job_definition_response
...
) -> aws_sdk_sagemaker.types.create_data_quality_job_definition_response.CreateDataQualityJobDefinitionResponse:
    out: aws_sdk_sagemaker.types.create_data_quality_job_definition_response.CreateDataQualityJobDefinitionResponse = aws_sdk_sagemaker.types.create_data_quality_job_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.create_data_quality_job_definition_request.CreateDataQualityJobDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.create_data_quality_job_definition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
