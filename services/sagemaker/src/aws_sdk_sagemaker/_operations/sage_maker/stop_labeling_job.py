...
def build_request(
    ...
    input: aws_sdk_sagemaker.types.stop_labeling_job_request.StopLabelingJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.stop_labeling_job_request.serialize_aws_json_1_1(input)
    ).encode()
