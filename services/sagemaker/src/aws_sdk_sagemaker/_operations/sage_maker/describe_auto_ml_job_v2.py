"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeAutoMLJobV2``."""
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_auto_ml_job_v2_request.DescribeAutoMLJobV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeAutoMLJobV2"
    import aws_sdk_sagemaker.types.describe_auto_ml_job_v2_request

    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_auto_ml_job_v2_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_auto_ml_job_v2(
