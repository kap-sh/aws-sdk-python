"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateImageVersion``."""
...
import aws_sdk_sagemaker.types.create_image_version_request
import aws_sdk_sagemaker.types.create_image_version_response
...
) -> aws_sdk_sagemaker.types.create_image_version_response.CreateImageVersionResponse:
    out: aws_sdk_sagemaker.types.create_image_version_response.CreateImageVersionResponse = aws_sdk_sagemaker.types.create_image_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.create_image_version_request.CreateImageVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateImageVersion"
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.create_image_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_image_version(
