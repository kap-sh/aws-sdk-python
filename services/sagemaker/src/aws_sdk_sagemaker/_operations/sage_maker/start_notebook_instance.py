...
import aws_sdk_sagemaker.types.start_notebook_instance_input
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.start_notebook_instance_input.StartNotebookInstanceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.start_notebook_instance_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
