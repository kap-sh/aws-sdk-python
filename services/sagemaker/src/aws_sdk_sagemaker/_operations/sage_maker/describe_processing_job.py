...
import aws_sdk_sagemaker.types.describe_processing_job_request
import aws_sdk_sagemaker.types.describe_processing_job_response
...
) -> aws_sdk_sagemaker.types.describe_processing_job_response.DescribeProcessingJobResponse:
    out: aws_sdk_sagemaker.types.describe_processing_job_response.DescribeProcessingJobResponse = aws_sdk_sagemaker.types.describe_processing_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_processing_job_request.DescribeProcessingJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_processing_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
