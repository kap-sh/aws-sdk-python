...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.list_model_cards_request.ListModelCardsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.list_model_cards_request.serialize_aws_json_1_1(input_)
    ).encode()
