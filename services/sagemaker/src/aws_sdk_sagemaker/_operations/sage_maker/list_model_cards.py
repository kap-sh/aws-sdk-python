...
def build_request(
    ...
    input: aws_sdk_sagemaker.types.list_model_cards_request.ListModelCardsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.list_model_cards_request.serialize_aws_json_1_1(input)
    ).encode()
