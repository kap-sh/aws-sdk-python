...
import aws_sdk_sagemaker.types.describe_flow_definition_request
import aws_sdk_sagemaker.types.describe_flow_definition_response
...
) -> aws_sdk_sagemaker.types.describe_flow_definition_response.DescribeFlowDefinitionResponse:
    out: aws_sdk_sagemaker.types.describe_flow_definition_response.DescribeFlowDefinitionResponse = aws_sdk_sagemaker.types.describe_flow_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_flow_definition_request.DescribeFlowDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_flow_definition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
