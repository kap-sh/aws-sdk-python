"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteTrainingJob``."""
...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.delete_training_job_request
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.delete_training_job_request.DeleteTrainingJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteTrainingJob"
    import aws_sdk_sagemaker.types.delete_training_job_request

    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.delete_training_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_training_job(
