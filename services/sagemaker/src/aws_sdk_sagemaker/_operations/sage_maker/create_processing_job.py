...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.create_processing_job_request
    import aws_sdk_sagemaker.types.create_processing_job_response
...
) -> aws_sdk_sagemaker.types.create_processing_job_response.CreateProcessingJobResponse:
    import aws_sdk_sagemaker.types.create_processing_job_response

    out: aws_sdk_sagemaker.types.create_processing_job_response.CreateProcessingJobResponse = aws_sdk_sagemaker.types.create_processing_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.create_processing_job_request.CreateProcessingJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.create_processing_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
