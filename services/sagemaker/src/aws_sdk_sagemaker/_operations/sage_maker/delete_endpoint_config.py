"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteEndpointConfig``."""
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.delete_endpoint_config_input.DeleteEndpointConfigInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.delete_endpoint_config_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_endpoint_config(
