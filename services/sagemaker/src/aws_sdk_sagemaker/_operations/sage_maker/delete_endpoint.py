"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteEndpoint``."""
...
import aws_sdk_sagemaker.types.delete_endpoint_input
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.delete_endpoint_input.DeleteEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.delete_endpoint_input.serialize_aws_json_1_1(input_)
    ).encode()
