...
if TYPE_CHECKING:
    import aws_sdk_sagemaker.types.register_devices_request
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.register_devices_request.RegisterDevicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.register_devices_request.serialize_aws_json_1_1(input_)
    ).encode()
