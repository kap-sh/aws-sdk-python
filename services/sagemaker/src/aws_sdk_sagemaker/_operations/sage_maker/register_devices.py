...
def build_request(
    ...
    input: aws_sdk_sagemaker.types.register_devices_request.RegisterDevicesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.register_devices_request.serialize_aws_json_1_1(input)
    ).encode()
