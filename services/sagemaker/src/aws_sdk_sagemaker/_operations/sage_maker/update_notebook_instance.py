"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateNotebookInstance``."""
...
import aws_sdk_sagemaker.types.update_notebook_instance_input
import aws_sdk_sagemaker.types.update_notebook_instance_output
...
def handle_response(
    ...
    aws_sdk_sagemaker.types.update_notebook_instance_output.UpdateNotebookInstanceOutput
):
    out: aws_sdk_sagemaker.types.update_notebook_instance_output.UpdateNotebookInstanceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.update_notebook_instance_input.UpdateNotebookInstanceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.update_notebook_instance_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_notebook_instance(
