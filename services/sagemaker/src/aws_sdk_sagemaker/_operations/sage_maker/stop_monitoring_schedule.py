...
import aws_sdk_sagemaker.types.stop_monitoring_schedule_request
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.stop_monitoring_schedule_request.StopMonitoringScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.stop_monitoring_schedule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
