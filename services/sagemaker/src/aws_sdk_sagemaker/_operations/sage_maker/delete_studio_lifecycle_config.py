"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteStudioLifecycleConfig``."""
...
import aws_sdk_sagemaker.types.delete_studio_lifecycle_config_request
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.delete_studio_lifecycle_config_request.DeleteStudioLifecycleConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteStudioLifecycleConfig"
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.delete_studio_lifecycle_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_studio_lifecycle_config(
