"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeUserProfile``."""
...
import aws_sdk_sagemaker.types.describe_user_profile_request
import aws_sdk_sagemaker.types.describe_user_profile_response
...
) -> aws_sdk_sagemaker.types.describe_user_profile_response.DescribeUserProfileResponse:
    out: aws_sdk_sagemaker.types.describe_user_profile_response.DescribeUserProfileResponse = aws_sdk_sagemaker.types.describe_user_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker.types.describe_user_profile_request.DescribeUserProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.describe_user_profile_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_user_profile(
