...
def build_request(
    ...
    input: aws_sdk_sagemaker.types.stop_auto_ml_job_request.StopAutoMLJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker.types.stop_auto_ml_job_request.serialize_aws_json_1_1(input)
    ).encode()
