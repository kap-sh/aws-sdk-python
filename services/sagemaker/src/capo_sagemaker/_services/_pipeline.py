...
from capo_sagemaker._async import anysleep
from capo_sagemaker.errors import ServiceError

if TYPE_CHECKING:
    from capo_sagemaker._auth._identity import Credentials
    from capo_sagemaker._auth._providers import IdentityProvider
