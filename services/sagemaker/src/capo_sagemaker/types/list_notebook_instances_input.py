...
if TYPE_CHECKING:
    import capo_sagemaker.types.code_repository_contains
    ...
    import capo_sagemaker.types.notebook_instance_name_contains
    import capo_sagemaker.types.notebook_instance_sort_key
    import capo_sagemaker.types.notebook_instance_sort_order
...
class ListNotebookInstancesInput(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.notebook_instance_sort_key.NotebookInstanceSortKey"
    ]
    """<p>The field to sort results by. The default is <code>Name</code>.</p>"""
    sort_order: NotRequired[
        "capo_sagemaker.types.notebook_instance_sort_order.NotebookInstanceSortOrder"
    ]
    """<p>The sort order for results. </p>"""
    name_contains: NotRequired[
        "capo_sagemaker.types.notebook_instance_name_contains.NotebookInstanceNameContains"
    ]
    ...
    status_equals: NotRequired[
        "capo_sagemaker.types.notebook_instance_status.NotebookInstanceStatus"
    ]
    ...
    default_code_repository_contains: NotRequired[
        "capo_sagemaker.types.code_repository_contains.CodeRepositoryContains"
    ]
...
def serialize_aws_json_1_1(value: ListNotebookInstancesInput) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.notebook_instance_sort_key.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
    if "sort_order" in value:
        ...
        out["SortOrder"] = (
            capo_sagemaker.types.notebook_instance_sort_order.serialize_aws_json_1_1(
                value["sort_order"]
            )
        )
    ...
    if "status_equals" in value:
        ...
        out["StatusEquals"] = (
            capo_sagemaker.types.notebook_instance_status.serialize_aws_json_1_1(
                value["status_equals"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListNotebookInstancesInput:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.notebook_instance_sort_key.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
    if "SortOrder" in data:
        ...
        out["sort_order"] = (
            capo_sagemaker.types.notebook_instance_sort_order.deserialize_aws_json_1_1(
                data["SortOrder"]
            )
        )
    ...
    if "StatusEquals" in data:
        ...
        out["status_equals"] = (
            capo_sagemaker.types.notebook_instance_status.deserialize_aws_json_1_1(
                data["StatusEquals"]
            )
        )
