...
class AsyncInferenceNotificationConfig(TypedDict, closed=True):
    success_topic: NotRequired["capo_sagemaker.types.sns_topic_arn.SnsTopicArn"]
    ...
    error_topic: NotRequired["capo_sagemaker.types.sns_topic_arn.SnsTopicArn"]
    ...
    include_inference_response_in: NotRequired[
        "capo_sagemaker.types.async_notification_topic_type_list.AsyncNotificationTopicTypeList"
    ]
...
def serialize_aws_json_1_1(value: AsyncInferenceNotificationConfig) -> dict:
    ...
    if "include_inference_response_in" in value:
        ...
        out["IncludeInferenceResponseIn"] = (
            capo_sagemaker.types.async_notification_topic_type_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AsyncInferenceNotificationConfig:
    ...
    if "IncludeInferenceResponseIn" in data:
        ...
        out["include_inference_response_in"] = (
            capo_sagemaker.types.async_notification_topic_type_list.deserialize_aws_json_1_1(
