...
class LabelingJobInputConfig(TypedDict, closed=True):
    data_source: NotRequired[
        "capo_sagemaker.types.labeling_job_data_source.LabelingJobDataSource"
    ]
    """<p>The location of the input data.</p>"""
    data_attributes: NotRequired[
        "capo_sagemaker.types.labeling_job_data_attributes.LabelingJobDataAttributes"
    ]
...
def serialize_aws_json_1_1(value: LabelingJobInputConfig) -> dict:
    ...
    if "data_source" in value:
        ...
        out["DataSource"] = (
            capo_sagemaker.types.labeling_job_data_source.serialize_aws_json_1_1(
                value["data_source"]
            )
        )
    if "data_attributes" in value:
        ...
        out["DataAttributes"] = (
            capo_sagemaker.types.labeling_job_data_attributes.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LabelingJobInputConfig:
    ...
    if "DataSource" in data:
        ...
        out["data_source"] = (
            capo_sagemaker.types.labeling_job_data_source.deserialize_aws_json_1_1(
                data["DataSource"]
            )
        )
    if "DataAttributes" in data:
        ...
        out["data_attributes"] = (
            capo_sagemaker.types.labeling_job_data_attributes.deserialize_aws_json_1_1(
                data["DataAttributes"]
            )
        )
    return out
