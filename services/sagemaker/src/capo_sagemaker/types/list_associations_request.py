...
class ListAssociationsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired["capo_sagemaker.types.sort_associations_by.SortAssociationsBy"]
...
def serialize_aws_json_1_1(value: ListAssociationsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.sort_associations_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListAssociationsRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.sort_associations_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
