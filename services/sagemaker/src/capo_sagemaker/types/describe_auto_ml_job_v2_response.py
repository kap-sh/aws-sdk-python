...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.auto_ml_problem_type_config_name
    import capo_sagemaker.types.auto_ml_resolved_attributes
...
class DescribeAutoMLJobV2Response(TypedDict, closed=True):
    ...
    auto_ml_problem_type_config_name: NotRequired[
        "capo_sagemaker.types.auto_ml_problem_type_config_name.AutoMLProblemTypeConfigName"
    ]
    ...
    resolved_attributes: NotRequired[
        "capo_sagemaker.types.auto_ml_resolved_attributes.AutoMLResolvedAttributes"
    ]
...
def serialize_aws_json_1_1(value: DescribeAutoMLJobV2Response) -> dict:
    ...
    if "auto_ml_problem_type_config_name" in value:
        ...
        out["AutoMLProblemTypeConfigName"] = (
            capo_sagemaker.types.auto_ml_problem_type_config_name.serialize_aws_json_1_1(
    ...
    if "resolved_attributes" in value:
        ...
        out["ResolvedAttributes"] = (
            capo_sagemaker.types.auto_ml_resolved_attributes.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeAutoMLJobV2Response:
    ...
    if "AutoMLProblemTypeConfigName" in data:
        ...
        out["auto_ml_problem_type_config_name"] = (
            capo_sagemaker.types.auto_ml_problem_type_config_name.deserialize_aws_json_1_1(
    ...
    if "ResolvedAttributes" in data:
        ...
        out["resolved_attributes"] = (
            capo_sagemaker.types.auto_ml_resolved_attributes.deserialize_aws_json_1_1(
