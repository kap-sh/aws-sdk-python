"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListSpacesRequest``."""
...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.space_sort_key
...
class ListSpacesRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired["capo_sagemaker.types.space_sort_key.SpaceSortKey"]
    """<p>The parameter by which to sort the results. The default is <code>CreationTime</code>.</p>"""
    domain_id_equals: NotRequired["capo_sagemaker.types.domain_id.DomainId"]
    """<p>A parameter to search for the domain ID.</p>"""
    space_name_contains: NotRequired["capo_sagemaker.types.space_name.SpaceName"]
    """<p>A parameter by which to filter the results.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListSpacesRequest) -> dict:
    out: dict = {}
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = capo_sagemaker.types.space_sort_key.serialize_aws_json_1_1(
            value["sort_by"]
        )
    if "domain_id_equals" in value:
        out["DomainIdEquals"] = value["domain_id_equals"]
    if "space_name_contains" in value:
        out["SpaceNameContains"] = value["space_name_contains"]
    return out


def deserialize_aws_json_1_1(data: dict) -> ListSpacesRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = capo_sagemaker.types.space_sort_key.deserialize_aws_json_1_1(
            data["SortBy"]
        )
    if "DomainIdEquals" in data:
        out["domain_id_equals"] = data["DomainIdEquals"]
    if "SpaceNameContains" in data:
        out["space_name_contains"] = data["SpaceNameContains"]
    return out
