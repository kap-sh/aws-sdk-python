...
class JupyterLabAppSettings(TypedDict, closed=True):
    ...
    emr_settings: NotRequired["capo_sagemaker.types.emr_settings.EmrSettings"]
...
def serialize_aws_json_1_1(value: JupyterLabAppSettings) -> dict:
    ...
    if "emr_settings" in value:
        ...
        out["EmrSettings"] = capo_sagemaker.types.emr_settings.serialize_aws_json_1_1(
            value["emr_settings"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> JupyterLabAppSettings:
    ...
    if "EmrSettings" in data:
        ...
        out["emr_settings"] = (
            capo_sagemaker.types.emr_settings.deserialize_aws_json_1_1(
                data["EmrSettings"]
            )
        )
