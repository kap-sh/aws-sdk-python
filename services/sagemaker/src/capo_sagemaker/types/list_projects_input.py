...
class ListProjectsInput(TypedDict, closed=True):
    ...
    sort_by: NotRequired["capo_sagemaker.types.project_sort_by.ProjectSortBy"]
    """<p>The field by which to sort results. The default is <code>CreationTime</code>.</p>"""
    sort_order: NotRequired["capo_sagemaker.types.project_sort_order.ProjectSortOrder"]
...
def serialize_aws_json_1_1(value: ListProjectsInput) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = capo_sagemaker.types.project_sort_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
    if "sort_order" in value:
        ...
        out["SortOrder"] = (
            capo_sagemaker.types.project_sort_order.serialize_aws_json_1_1(
                value["sort_order"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListProjectsInput:
    ...
    if "SortOrder" in data:
        ...
        out["sort_order"] = (
            capo_sagemaker.types.project_sort_order.deserialize_aws_json_1_1(
                data["SortOrder"]
            )
        )
    return out
