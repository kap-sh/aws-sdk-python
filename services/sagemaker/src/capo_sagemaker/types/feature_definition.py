...
class FeatureDefinition(TypedDict, closed=True):
    ...
    collection_type: NotRequired["capo_sagemaker.types.collection_type.CollectionType"]
    ...
    collection_config: NotRequired[
        "capo_sagemaker.types.collection_config.CollectionConfig"
    ]
...
def serialize_aws_json_1_1(value: FeatureDefinition) -> dict:
    ...
    if "collection_type" in value:
        ...
        out["CollectionType"] = (
            capo_sagemaker.types.collection_type.serialize_aws_json_1_1(
    ...
    if "collection_config" in value:
        ...
        out["CollectionConfig"] = (
            capo_sagemaker.types.collection_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> FeatureDefinition:
    ...
    if "CollectionType" in data:
        ...
        out["collection_type"] = (
            capo_sagemaker.types.collection_type.deserialize_aws_json_1_1(
                data["CollectionType"]
            )
        )
    if "CollectionConfig" in data:
        ...
        out["collection_config"] = (
            capo_sagemaker.types.collection_config.deserialize_aws_json_1_1(
