...
if TYPE_CHECKING:
    import capo_sagemaker.types.job_config_schema_version_summary

JobConfigSchemas: TypeAlias = list[
    "capo_sagemaker.types.job_config_schema_version_summary.JobConfigSchemaVersionSummary"
]
...
def serialize_aws_json_1_1(value: JobConfigSchemas) -> list:
    ...
    for item in value:
        out.append(
            capo_sagemaker.types.job_config_schema_version_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
