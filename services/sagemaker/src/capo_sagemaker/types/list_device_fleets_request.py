...
class ListDeviceFleetsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.list_device_fleets_sort_by.ListDeviceFleetsSortBy"
    ]
...
def serialize_aws_json_1_1(value: ListDeviceFleetsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.list_device_fleets_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDeviceFleetsRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.list_device_fleets_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
