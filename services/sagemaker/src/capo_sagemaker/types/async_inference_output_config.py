...
class AsyncInferenceOutputConfig(TypedDict, closed=True):
    ...
    notification_config: NotRequired[
        "capo_sagemaker.types.async_inference_notification_config.AsyncInferenceNotificationConfig"
    ]
...
def serialize_aws_json_1_1(value: AsyncInferenceOutputConfig) -> dict:
    ...
    if "notification_config" in value:
        ...
        out["NotificationConfig"] = (
            capo_sagemaker.types.async_inference_notification_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AsyncInferenceOutputConfig:
    ...
    if "NotificationConfig" in data:
        ...
        out["notification_config"] = (
            capo_sagemaker.types.async_inference_notification_config.deserialize_aws_json_1_1(
