"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeModelBiasJobDefinitionRequest``."""
...
class DescribeModelBiasJobDefinitionRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeModelBiasJobDefinitionRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeModelBiasJobDefinitionRequest:
    out: DescribeModelBiasJobDefinitionRequest = {}  # type: ignore[typeddict-item]
