...
class TrainingSpecification(TypedDict, closed=True):
    training_image: NotRequired["capo_sagemaker.types.container_image.ContainerImage"]
    """<p>The Amazon ECR registry path of the Docker image that contains the training algorithm.</p>"""
    training_image_digest: NotRequired["capo_sagemaker.types.image_digest.ImageDigest"]
    ...
    supported_hyper_parameters: NotRequired[
        "capo_sagemaker.types.hyper_parameter_specifications.HyperParameterSpecifications"
    ]
    ...
    supported_training_instance_types: NotRequired[
        "capo_sagemaker.types.training_instance_types.TrainingInstanceTypes"
    ]
    """<p>A list of the instance types that this algorithm can use for training.</p>"""
    supports_distributed_training: NotRequired["capo_sagemaker.types.boolean.Boolean"]
    ...
    training_channels: NotRequired[
        "capo_sagemaker.types.channel_specifications.ChannelSpecifications"
    ]
    ...
    supported_tuning_job_objective_metrics: NotRequired[
        "capo_sagemaker.types.hyper_parameter_tuning_job_objectives.HyperParameterTuningJobObjectives"
    ]
...
def serialize_aws_json_1_1(value: TrainingSpecification) -> dict:
    ...
    if "supported_hyper_parameters" in value:
        ...
        out["SupportedHyperParameters"] = (
            capo_sagemaker.types.hyper_parameter_specifications.serialize_aws_json_1_1(
    ...
    if "supported_training_instance_types" in value:
        ...
        out["SupportedTrainingInstanceTypes"] = (
            capo_sagemaker.types.training_instance_types.serialize_aws_json_1_1(
    ...
    if "training_channels" in value:
        ...
        out["TrainingChannels"] = (
            capo_sagemaker.types.channel_specifications.serialize_aws_json_1_1(
    ...
    if "supported_tuning_job_objective_metrics" in value:
        ...
        out["SupportedTuningJobObjectiveMetrics"] = (
            capo_sagemaker.types.hyper_parameter_tuning_job_objectives.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TrainingSpecification:
    ...
    if "SupportedHyperParameters" in data:
        ...
        out["supported_hyper_parameters"] = (
            capo_sagemaker.types.hyper_parameter_specifications.deserialize_aws_json_1_1(
    ...
    if "SupportedTrainingInstanceTypes" in data:
        ...
        out["supported_training_instance_types"] = (
            capo_sagemaker.types.training_instance_types.deserialize_aws_json_1_1(
    ...
    if "TrainingChannels" in data:
        ...
        out["training_channels"] = (
            capo_sagemaker.types.channel_specifications.deserialize_aws_json_1_1(
    ...
    if "SupportedTuningJobObjectiveMetrics" in data:
        ...
        out["supported_tuning_job_objective_metrics"] = (
            capo_sagemaker.types.hyper_parameter_tuning_job_objectives.deserialize_aws_json_1_1(
