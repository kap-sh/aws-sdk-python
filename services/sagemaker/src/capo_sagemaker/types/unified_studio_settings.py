...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.region_name
    import capo_sagemaker.types.s3_uri
    import capo_sagemaker.types.single_sign_on_application_arn
    import capo_sagemaker.types.unified_studio_domain_id
    import capo_sagemaker.types.unified_studio_environment_id
    import capo_sagemaker.types.unified_studio_project_id
...
class UnifiedStudioSettings(TypedDict, closed=True):
    ...
    domain_account_id: NotRequired["capo_sagemaker.types.account_id.AccountId"]
    ...
    domain_region: NotRequired["capo_sagemaker.types.region_name.RegionName"]
    ...
    single_sign_on_application_arn: NotRequired[
        "capo_sagemaker.types.single_sign_on_application_arn.SingleSignOnApplicationArn"
    ]
