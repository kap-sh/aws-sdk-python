...
class InferenceComponentRuntimeConfigSummary(TypedDict, closed=True):
    ...
    placement_status: NotRequired[
        "capo_sagemaker.types.inference_component_placement_status_list.InferenceComponentPlacementStatusList"
    ]
...
def serialize_aws_json_1_1(value: InferenceComponentRuntimeConfigSummary) -> dict:
    ...
    if "placement_status" in value:
        ...
        out["PlacementStatus"] = (
            capo_sagemaker.types.inference_component_placement_status_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InferenceComponentRuntimeConfigSummary:
    ...
    if "PlacementStatus" in data:
        ...
        out["placement_status"] = (
            capo_sagemaker.types.inference_component_placement_status_list.deserialize_aws_json_1_1(
