...
if TYPE_CHECKING:
    import capo_sagemaker.types.monitoring_cluster_config


class MonitoringResources(TypedDict, closed=True):
    cluster_config: NotRequired[
        "capo_sagemaker.types.monitoring_cluster_config.MonitoringClusterConfig"
    ]
...
def serialize_aws_json_1_1(value: MonitoringResources) -> dict:
    ...
    if "cluster_config" in value:
        ...
        out["ClusterConfig"] = (
            capo_sagemaker.types.monitoring_cluster_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> MonitoringResources:
    ...
    if "ClusterConfig" in data:
        ...
        out["cluster_config"] = (
            capo_sagemaker.types.monitoring_cluster_config.deserialize_aws_json_1_1(
                data["ClusterConfig"]
            )
        )
    return out
