...
if TYPE_CHECKING:
    import capo_sagemaker.types.minimum_instance_metadata_service_version


class InstanceMetadataServiceConfiguration(TypedDict, closed=True):
    minimum_instance_metadata_service_version: NotRequired[
        "capo_sagemaker.types.minimum_instance_metadata_service_version.MinimumInstanceMetadataServiceVersion"
    ]
