"""Generated from Smithy shape ``com.amazonaws.sagemaker#ModelCompilationConfig``."""
...
class ModelCompilationConfig(TypedDict, closed=True):
    image: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ModelCompilationConfig) -> dict:
    out: dict = {}
    if "image" in value:
...
def deserialize_aws_json_1_1(data: dict) -> ModelCompilationConfig:
    out: ModelCompilationConfig = {}  # type: ignore[typeddict-item]
    if "Image" in data:
