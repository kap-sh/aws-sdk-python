...
if TYPE_CHECKING:
    import capo_sagemaker.types.trial_component_metric_summary

TrialComponentMetricSummaries: TypeAlias = list[
    "capo_sagemaker.types.trial_component_metric_summary.TrialComponentMetricSummary"
]
...
def serialize_aws_json_1_1(value: TrialComponentMetricSummaries) -> list:
    ...
    for item in value:
        out.append(
            capo_sagemaker.types.trial_component_metric_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> TrialComponentMetricSummaries:
    ...
    for item in data:
        out.append(
            capo_sagemaker.types.trial_component_metric_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
