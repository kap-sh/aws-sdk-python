...
if TYPE_CHECKING:
    import capo_sagemaker.types.model_dashboard_monitoring_schedule

ModelDashboardMonitoringSchedules: TypeAlias = list[
    "capo_sagemaker.types.model_dashboard_monitoring_schedule.ModelDashboardMonitoringSchedule"
]
...
def serialize_aws_json_1_1(value: ModelDashboardMonitoringSchedules) -> list:
    ...
    for item in value:
        out.append(
            capo_sagemaker.types.model_dashboard_monitoring_schedule.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ModelDashboardMonitoringSchedules:
    ...
    for item in data:
        out.append(
            capo_sagemaker.types.model_dashboard_monitoring_schedule.deserialize_aws_json_1_1(
                item
            )
        )
    return out
