...
class ListModelCardExportJobsRequest(TypedDict, closed=True):
    ...
    status_equals: NotRequired[
        "capo_sagemaker.types.model_card_export_job_status.ModelCardExportJobStatus"
    ]
    """<p>Only list model card export jobs with the specified status.</p>"""
    sort_by: NotRequired[
        "capo_sagemaker.types.model_card_export_job_sort_by.ModelCardExportJobSortBy"
    ]
    """<p>Sort model card export jobs by either name or creation time. Sorts by creation time by default.</p>"""
    sort_order: NotRequired[
        "capo_sagemaker.types.model_card_export_job_sort_order.ModelCardExportJobSortOrder"
    ]
...
def serialize_aws_json_1_1(value: ListModelCardExportJobsRequest) -> dict:
    ...
    if "status_equals" in value:
        ...
        out["StatusEquals"] = (
            capo_sagemaker.types.model_card_export_job_status.serialize_aws_json_1_1(
                value["status_equals"]
            )
        )
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.model_card_export_job_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
    if "sort_order" in value:
        ...
        out["SortOrder"] = (
            capo_sagemaker.types.model_card_export_job_sort_order.serialize_aws_json_1_1(
                value["sort_order"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListModelCardExportJobsRequest:
    ...
    if "StatusEquals" in data:
        ...
        out["status_equals"] = (
            capo_sagemaker.types.model_card_export_job_status.deserialize_aws_json_1_1(
                data["StatusEquals"]
            )
        )
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.model_card_export_job_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
    if "SortOrder" in data:
        ...
        out["sort_order"] = (
            capo_sagemaker.types.model_card_export_job_sort_order.deserialize_aws_json_1_1(
                data["SortOrder"]
            )
        )
