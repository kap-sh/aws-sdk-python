...
if TYPE_CHECKING:
    import capo_sagemaker.types.compute_quota_target_team_name
    import capo_sagemaker.types.fair_share_weight


class ComputeQuotaTarget(TypedDict, closed=True):
    team_name: NotRequired[
        "capo_sagemaker.types.compute_quota_target_team_name.ComputeQuotaTargetTeamName"
    ]
    """<p>Name of the team to allocate compute resources to.</p>"""
    fair_share_weight: NotRequired[
        "capo_sagemaker.types.fair_share_weight.FairShareWeight"
    ]
