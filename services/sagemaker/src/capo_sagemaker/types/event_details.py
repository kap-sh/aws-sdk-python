...
class EventDetails(TypedDict, closed=True):
    event_metadata: NotRequired["capo_sagemaker.types.event_metadata.EventMetadata"]
...
def serialize_aws_json_1_1(value: EventDetails) -> dict:
    ...
    if "event_metadata" in value:
        ...
        out["EventMetadata"] = (
            capo_sagemaker.types.event_metadata.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EventDetails:
    ...
    if "EventMetadata" in data:
        ...
        out["event_metadata"] = (
            capo_sagemaker.types.event_metadata.deserialize_aws_json_1_1(
                data["EventMetadata"]
            )
        )
    return out
