...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.training_plan_duration_hours_input
    import capo_sagemaker.types.ultra_server_count
    import capo_sagemaker.types.ultra_server_type


class SearchTrainingPlanOfferingsRequest(TypedDict, closed=True):
    ...
    end_time_before: NotRequired["capo_sagemaker.types.timestamp.Timestamp"]
    ...
    training_plan_arn: NotRequired["capo_sagemaker.types.string.String"]
...
def serialize_aws_json_1_1(value: SearchTrainingPlanOfferingsRequest) -> dict:
    ...
    if "end_time_before" in value:
        ...
        out["EndTimeBefore"] = capo_sagemaker.types.timestamp.serialize_aws_json_1_1(
