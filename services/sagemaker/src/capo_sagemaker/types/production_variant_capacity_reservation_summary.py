...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.ml_reservation_arn
    import capo_sagemaker.types.task_count


class ProductionVariantCapacityReservationSummary(TypedDict, closed=True):
    ml_reservation_arn: NotRequired[
        "capo_sagemaker.types.ml_reservation_arn.MlReservationArn"
    ]
    ...
    capacity_reservation_preference: NotRequired[
        "capo_sagemaker.types.capacity_reservation_preference.CapacityReservationPreference"
    ]
    ...
    total_instance_count: NotRequired["capo_sagemaker.types.task_count.TaskCount"]
    """<p>The number of instances that you allocated to the ML capacity reservation.</p>"""
    available_instance_count: NotRequired["capo_sagemaker.types.task_count.TaskCount"]
    """<p>The number of instances that are currently available in the ML capacity reservation.</p>"""
    used_by_current_endpoint: NotRequired["capo_sagemaker.types.task_count.TaskCount"]
    ...
    ec2_capacity_reservations: NotRequired[
        "capo_sagemaker.types.ec2_capacity_reservations_list.Ec2CapacityReservationsList"
    ]
...
def serialize_aws_json_1_1(value: ProductionVariantCapacityReservationSummary) -> dict:
    ...
    if "capacity_reservation_preference" in value:
        ...
        out["CapacityReservationPreference"] = (
            capo_sagemaker.types.capacity_reservation_preference.serialize_aws_json_1_1(
    ...
    if "ec2_capacity_reservations" in value:
        ...
        out["Ec2CapacityReservations"] = (
            capo_sagemaker.types.ec2_capacity_reservations_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ProductionVariantCapacityReservationSummary:
    ...
    if "CapacityReservationPreference" in data:
        ...
        out["capacity_reservation_preference"] = (
            capo_sagemaker.types.capacity_reservation_preference.deserialize_aws_json_1_1(
    ...
    if "Ec2CapacityReservations" in data:
        ...
        out["ec2_capacity_reservations"] = (
            capo_sagemaker.types.ec2_capacity_reservations_list.deserialize_aws_json_1_1(
