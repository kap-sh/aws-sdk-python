...
if TYPE_CHECKING:
    import capo_sagemaker.types.cluster_kubernetes_label_key
    import capo_sagemaker.types.cluster_kubernetes_label_value

ClusterKubernetesLabels: TypeAlias = dict[
    "capo_sagemaker.types.cluster_kubernetes_label_key.ClusterKubernetesLabelKey",
    "capo_sagemaker.types.cluster_kubernetes_label_value.ClusterKubernetesLabelValue",
]
