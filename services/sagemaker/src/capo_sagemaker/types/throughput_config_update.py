...
if TYPE_CHECKING:
    import capo_sagemaker.types.capacity_unit
    import capo_sagemaker.types.throughput_mode


class ThroughputConfigUpdate(TypedDict, closed=True):
    throughput_mode: NotRequired["capo_sagemaker.types.throughput_mode.ThroughputMode"]
    ...
    provisioned_read_capacity_units: NotRequired[
        "capo_sagemaker.types.capacity_unit.CapacityUnit"
    ]
...
def serialize_aws_json_1_1(value: ThroughputConfigUpdate) -> dict:
    ...
    if "throughput_mode" in value:
        ...
        out["ThroughputMode"] = (
            capo_sagemaker.types.throughput_mode.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ThroughputConfigUpdate:
    ...
    if "ThroughputMode" in data:
        ...
        out["throughput_mode"] = (
            capo_sagemaker.types.throughput_mode.deserialize_aws_json_1_1(
                data["ThroughputMode"]
            )
        )
