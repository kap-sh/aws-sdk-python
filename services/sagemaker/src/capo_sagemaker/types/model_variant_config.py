...
class ModelVariantConfig(TypedDict, closed=True):
    ...
    infrastructure_config: NotRequired[
        "capo_sagemaker.types.model_infrastructure_config.ModelInfrastructureConfig"
    ]
...
def serialize_aws_json_1_1(value: ModelVariantConfig) -> dict:
    ...
    if "infrastructure_config" in value:
        ...
        out["InfrastructureConfig"] = (
            capo_sagemaker.types.model_infrastructure_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ModelVariantConfig:
    ...
    if "InfrastructureConfig" in data:
        ...
        out["infrastructure_config"] = (
            capo_sagemaker.types.model_infrastructure_config.deserialize_aws_json_1_1(
