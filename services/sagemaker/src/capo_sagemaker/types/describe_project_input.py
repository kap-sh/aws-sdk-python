"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeProjectInput``."""
...
class DescribeProjectInput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeProjectInput) -> dict:
    out: dict = {}
