...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.framework_version
...
class InputConfig(TypedDict, closed=True):
    ...
    framework: NotRequired["capo_sagemaker.types.framework.Framework"]
    """<p>Identifies the framework in which the model was trained. For example: TENSORFLOW.</p>"""
    framework_version: NotRequired[
        "capo_sagemaker.types.framework_version.FrameworkVersion"
    ]
...
def serialize_aws_json_1_1(value: InputConfig) -> dict:
    ...
    if "framework" in value:
        ...
        out["Framework"] = capo_sagemaker.types.framework.serialize_aws_json_1_1(
            value["framework"]
        )
