...
if TYPE_CHECKING:
    import capo_sagemaker.types.monitoring_alert_summary

MonitoringAlertSummaryList: TypeAlias = list[
    "capo_sagemaker.types.monitoring_alert_summary.MonitoringAlertSummary"
]
...
def serialize_aws_json_1_1(value: MonitoringAlertSummaryList) -> list:
    ...
    for item in value:
        out.append(
            capo_sagemaker.types.monitoring_alert_summary.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> MonitoringAlertSummaryList:
    ...
    for item in data:
        out.append(
            capo_sagemaker.types.monitoring_alert_summary.deserialize_aws_json_1_1(item)
        )
    return out
