...
class EMRStepMetadata(TypedDict, closed=True):
    cluster_id: NotRequired["capo_sagemaker.types.string256.String256"]
    """<p>The identifier of the EMR cluster.</p>"""
    step_id: NotRequired["capo_sagemaker.types.string256.String256"]
    """<p>The identifier of the EMR cluster step.</p>"""
    step_name: NotRequired["capo_sagemaker.types.string256.String256"]
    """<p>The name of the EMR cluster step.</p>"""
    log_file_path: NotRequired["capo_sagemaker.types.string1024.String1024"]
