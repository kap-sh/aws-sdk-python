...
if TYPE_CHECKING:
    import capo_sagemaker.types.candidate_definition_notebook_location
    import capo_sagemaker.types.data_exploration_notebook_location


class AutoMLJobArtifacts(TypedDict, closed=True):
    candidate_definition_notebook_location: NotRequired[
        "capo_sagemaker.types.candidate_definition_notebook_location.CandidateDefinitionNotebookLocation"
    ]
    """<p>The URL of the notebook location.</p>"""
    data_exploration_notebook_location: NotRequired[
        "capo_sagemaker.types.data_exploration_notebook_location.DataExplorationNotebookLocation"
    ]
    """<p>The URL of the notebook location.</p>"""
