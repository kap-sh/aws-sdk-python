...
if TYPE_CHECKING:
    import capo_sagemaker.types.managed_instance_scaling_max_instance_count
    import capo_sagemaker.types.managed_instance_scaling_min_instance_count
...
class ProductionVariantManagedInstanceScaling(TypedDict, closed=True):
    status: NotRequired[
        "capo_sagemaker.types.managed_instance_scaling_status.ManagedInstanceScalingStatus"
    ]
    """<p>Indicates whether managed instance scaling is enabled.</p>"""
    min_instance_count: NotRequired[
        "capo_sagemaker.types.managed_instance_scaling_min_instance_count.ManagedInstanceScalingMinInstanceCount"
    ]
    ...
    max_instance_count: NotRequired[
        "capo_sagemaker.types.managed_instance_scaling_max_instance_count.ManagedInstanceScalingMaxInstanceCount"
    ]
    ...
    scale_in_policy: NotRequired[
        "capo_sagemaker.types.production_variant_managed_instance_scaling_scale_in_policy.ProductionVariantManagedInstanceScalingScaleInPolicy"
    ]
...
def serialize_aws_json_1_1(value: ProductionVariantManagedInstanceScaling) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            capo_sagemaker.types.managed_instance_scaling_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    ...
    if "scale_in_policy" in value:
        ...
        out["ScaleInPolicy"] = (
            capo_sagemaker.types.production_variant_managed_instance_scaling_scale_in_policy.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ProductionVariantManagedInstanceScaling:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            capo_sagemaker.types.managed_instance_scaling_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    ...
    if "ScaleInPolicy" in data:
        ...
        out["scale_in_policy"] = (
            capo_sagemaker.types.production_variant_managed_instance_scaling_scale_in_policy.deserialize_aws_json_1_1(
                data["ScaleInPolicy"]
            )
        )
    return out
