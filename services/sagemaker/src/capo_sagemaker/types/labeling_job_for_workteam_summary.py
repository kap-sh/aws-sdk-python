...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.number_of_human_workers_per_data_object
...
class LabelingJobForWorkteamSummary(TypedDict, closed=True):
    ...
    work_requester_account_id: NotRequired["capo_sagemaker.types.account_id.AccountId"]
    ...
    label_counters: NotRequired[
        "capo_sagemaker.types.label_counters_for_workteam.LabelCountersForWorkteam"
    ]
    """<p>Provides information about the progress of a labeling job.</p>"""
    number_of_human_workers_per_data_object: NotRequired[
        "capo_sagemaker.types.number_of_human_workers_per_data_object.NumberOfHumanWorkersPerDataObject"
    ]
...
def serialize_aws_json_1_1(value: LabelingJobForWorkteamSummary) -> dict:
    ...
    if "label_counters" in value:
        ...
        out["LabelCounters"] = (
            capo_sagemaker.types.label_counters_for_workteam.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LabelingJobForWorkteamSummary:
    ...
    if "LabelCounters" in data:
        ...
        out["label_counters"] = (
            capo_sagemaker.types.label_counters_for_workteam.deserialize_aws_json_1_1(
                data["LabelCounters"]
            )
        )
