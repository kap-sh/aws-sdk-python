...
if TYPE_CHECKING:
    import capo_sagemaker.types.monitoring_alert_history_list
    import capo_sagemaker.types.next_token


class ListMonitoringAlertHistoryResponse(TypedDict, closed=True):
    monitoring_alert_history: NotRequired[
        "capo_sagemaker.types.monitoring_alert_history_list.MonitoringAlertHistoryList"
    ]
...
def serialize_aws_json_1_1(value: ListMonitoringAlertHistoryResponse) -> dict:
    ...
    if "monitoring_alert_history" in value:
        ...
        out["MonitoringAlertHistory"] = (
            capo_sagemaker.types.monitoring_alert_history_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListMonitoringAlertHistoryResponse:
    ...
    if "MonitoringAlertHistory" in data:
        ...
        out["monitoring_alert_history"] = (
            capo_sagemaker.types.monitoring_alert_history_list.deserialize_aws_json_1_1(
