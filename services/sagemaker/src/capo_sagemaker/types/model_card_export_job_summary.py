...
class ModelCardExportJobSummary(TypedDict, closed=True):
    ...
    created_at: NotRequired["capo_sagemaker.types.timestamp.Timestamp"]
    """<p>The date and time that the model card export job was created.</p>"""
    last_modified_at: NotRequired["capo_sagemaker.types.timestamp.Timestamp"]
...
def serialize_aws_json_1_1(value: ModelCardExportJobSummary) -> dict:
    ...
    if "created_at" in value:
        ...
        out["CreatedAt"] = capo_sagemaker.types.timestamp.serialize_aws_json_1_1(
            value["created_at"]
        )
    if "last_modified_at" in value:
        import capo_sagemaker.types.timestamp

        out["LastModifiedAt"] = capo_sagemaker.types.timestamp.serialize_aws_json_1_1(
