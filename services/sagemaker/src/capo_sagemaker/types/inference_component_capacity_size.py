...
if TYPE_CHECKING:
    import capo_sagemaker.types.capacity_size_value
...
class InferenceComponentCapacitySize(TypedDict, closed=True):
    type: NotRequired[
        "capo_sagemaker.types.inference_component_capacity_size_type.InferenceComponentCapacitySizeType"
    ]
    ...
    value: NotRequired["capo_sagemaker.types.capacity_size_value.CapacitySizeValue"]
...
def serialize_aws_json_1_1(value: InferenceComponentCapacitySize) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = (
            capo_sagemaker.types.inference_component_capacity_size_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
    if "value" in value:
...
def deserialize_aws_json_1_1(data: dict) -> InferenceComponentCapacitySize:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            capo_sagemaker.types.inference_component_capacity_size_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    if "Value" in data:
