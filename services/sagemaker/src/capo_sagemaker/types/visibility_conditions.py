...
if TYPE_CHECKING:
    import capo_sagemaker.types.visibility_conditions_key
    import capo_sagemaker.types.visibility_conditions_value


class VisibilityConditions(TypedDict, closed=True):
    key: NotRequired[
        "capo_sagemaker.types.visibility_conditions_key.VisibilityConditionsKey"
    ]
    ...
    value: NotRequired[
        "capo_sagemaker.types.visibility_conditions_value.VisibilityConditionsValue"
    ]
