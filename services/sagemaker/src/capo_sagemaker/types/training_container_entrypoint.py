...
if TYPE_CHECKING:
    import capo_sagemaker.types.training_container_entrypoint_string

TrainingContainerEntrypoint: TypeAlias = list[
    "capo_sagemaker.types.training_container_entrypoint_string.TrainingContainerEntrypointString"
]
