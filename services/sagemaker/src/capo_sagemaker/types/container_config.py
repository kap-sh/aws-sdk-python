...
class ContainerConfig(TypedDict, closed=True):
    container_arguments: NotRequired[
        "capo_sagemaker.types.custom_image_container_arguments.CustomImageContainerArguments"
    ]
    """<p>The arguments for the container when you're running the application.</p>"""
    container_entrypoint: NotRequired[
        "capo_sagemaker.types.custom_image_container_entrypoint.CustomImageContainerEntrypoint"
    ]
    """<p>The entrypoint used to run the application in the container.</p>"""
    container_environment_variables: NotRequired[
        "capo_sagemaker.types.custom_image_container_environment_variables.CustomImageContainerEnvironmentVariables"
    ]
...
def serialize_aws_json_1_1(value: ContainerConfig) -> dict:
    ...
    if "container_arguments" in value:
        ...
        out["ContainerArguments"] = (
            capo_sagemaker.types.custom_image_container_arguments.serialize_aws_json_1_1(
    ...
    if "container_entrypoint" in value:
        ...
        out["ContainerEntrypoint"] = (
            capo_sagemaker.types.custom_image_container_entrypoint.serialize_aws_json_1_1(
    ...
    if "container_environment_variables" in value:
        ...
        out["ContainerEnvironmentVariables"] = (
            capo_sagemaker.types.custom_image_container_environment_variables.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ContainerConfig:
    ...
    if "ContainerArguments" in data:
        ...
        out["container_arguments"] = (
            capo_sagemaker.types.custom_image_container_arguments.deserialize_aws_json_1_1(
    ...
    if "ContainerEntrypoint" in data:
        ...
        out["container_entrypoint"] = (
            capo_sagemaker.types.custom_image_container_entrypoint.deserialize_aws_json_1_1(
    ...
    if "ContainerEnvironmentVariables" in data:
        ...
        out["container_environment_variables"] = (
            capo_sagemaker.types.custom_image_container_environment_variables.deserialize_aws_json_1_1(
