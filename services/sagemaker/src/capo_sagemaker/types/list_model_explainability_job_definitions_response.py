"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListModelExplainabilityJobDefinitionsResponse``."""
...
class ListModelExplainabilityJobDefinitionsResponse(TypedDict, closed=True):
...
def serialize_aws_json_1_1(
    value: ListModelExplainabilityJobDefinitionsResponse,
) -> dict:
    out: dict = {}
