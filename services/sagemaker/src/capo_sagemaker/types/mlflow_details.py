...
if TYPE_CHECKING:
    import capo_sagemaker.types.mlflow_experiment_id
    import capo_sagemaker.types.mlflow_run_id


class MlflowDetails(TypedDict, closed=True):
    mlflow_experiment_id: NotRequired[
        "capo_sagemaker.types.mlflow_experiment_id.MlflowExperimentId"
    ]
    """<p> The MLflow experiment ID used for this job. </p>"""
    mlflow_run_id: NotRequired["capo_sagemaker.types.mlflow_run_id.MlflowRunId"]
