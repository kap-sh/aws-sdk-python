...
class InstancePlacementConfig(TypedDict, closed=True):
    enable_multiple_jobs: NotRequired["capo_sagemaker.types.boolean.Boolean"]
    ...
    placement_specifications: NotRequired[
        "capo_sagemaker.types.placement_specifications.PlacementSpecifications"
    ]
...
def serialize_aws_json_1_1(value: InstancePlacementConfig) -> dict:
    ...
    if "placement_specifications" in value:
        ...
        out["PlacementSpecifications"] = (
            capo_sagemaker.types.placement_specifications.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InstancePlacementConfig:
    ...
    if "PlacementSpecifications" in data:
        ...
        out["placement_specifications"] = (
            capo_sagemaker.types.placement_specifications.deserialize_aws_json_1_1(
