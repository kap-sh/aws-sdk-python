"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListComputeQuotasRequest``."""
...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.sort_quota_by
...
class ListComputeQuotasRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired["capo_sagemaker.types.sort_quota_by.SortQuotaBy"]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListComputeQuotasRequest) -> dict:
    out: dict = {}
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = capo_sagemaker.types.sort_quota_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListComputeQuotasRequest:
    out: ListComputeQuotasRequest = {}  # type: ignore[typeddict-item]
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = capo_sagemaker.types.sort_quota_by.deserialize_aws_json_1_1(
            data["SortBy"]
        )
