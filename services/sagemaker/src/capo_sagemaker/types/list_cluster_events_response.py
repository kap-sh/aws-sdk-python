...
if TYPE_CHECKING:
    import capo_sagemaker.types.cluster_event_summaries
...
class ListClusterEventsResponse(TypedDict, closed=True):
    ...
    events: NotRequired[
        "capo_sagemaker.types.cluster_event_summaries.ClusterEventSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListClusterEventsResponse) -> dict:
    ...
    if "events" in value:
        ...
        out["Events"] = (
            capo_sagemaker.types.cluster_event_summaries.serialize_aws_json_1_1(
                value["events"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListClusterEventsResponse:
    ...
    if "Events" in data:
        ...
        out["events"] = (
            capo_sagemaker.types.cluster_event_summaries.deserialize_aws_json_1_1(
                data["Events"]
            )
        )
    return out
