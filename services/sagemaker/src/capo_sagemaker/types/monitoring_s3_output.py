...
class MonitoringS3Output(TypedDict, closed=True):
    ...
    s3_upload_mode: NotRequired[
        "capo_sagemaker.types.processing_s3_upload_mode.ProcessingS3UploadMode"
    ]
...
def serialize_aws_json_1_1(value: MonitoringS3Output) -> dict:
    ...
    if "s3_upload_mode" in value:
        ...
        out["S3UploadMode"] = (
            capo_sagemaker.types.processing_s3_upload_mode.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> MonitoringS3Output:
    ...
    if "S3UploadMode" in data:
        ...
        out["s3_upload_mode"] = (
            capo_sagemaker.types.processing_s3_upload_mode.deserialize_aws_json_1_1(
                data["S3UploadMode"]
            )
        )
    return out
