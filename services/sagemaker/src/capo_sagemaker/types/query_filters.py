...
class QueryFilters(TypedDict, closed=True):
    types: NotRequired["capo_sagemaker.types.query_types.QueryTypes"]
    ...
    lineage_types: NotRequired[
        "capo_sagemaker.types.query_lineage_types.QueryLineageTypes"
    ]
    ...
    modified_before: NotRequired["capo_sagemaker.types.timestamp.Timestamp"]
    """<p>Filter the lineage entities connected to the <code>StartArn</code>(s) before the last modified date.</p>"""
    modified_after: NotRequired["capo_sagemaker.types.timestamp.Timestamp"]
    """<p>Filter the lineage entities connected to the <code>StartArn</code>(s) after the last modified date.</p>"""
    properties: NotRequired["capo_sagemaker.types.query_properties.QueryProperties"]
...
def serialize_aws_json_1_1(value: QueryFilters) -> dict:
    ...
    if "types" in value:
        ...
        out["Types"] = capo_sagemaker.types.query_types.serialize_aws_json_1_1(
            value["types"]
        )
    if "lineage_types" in value:
        ...
        out["LineageTypes"] = (
            capo_sagemaker.types.query_lineage_types.serialize_aws_json_1_1(
                value["lineage_types"]
            )
        )
    ...
    if "modified_before" in value:
        ...
        out["ModifiedBefore"] = capo_sagemaker.types.timestamp.serialize_aws_json_1_1(
            value["modified_before"]
        )
    if "modified_after" in value:
        import capo_sagemaker.types.timestamp

        out["ModifiedAfter"] = capo_sagemaker.types.timestamp.serialize_aws_json_1_1(
    ...
    if "properties" in value:
        ...
        out["Properties"] = (
            capo_sagemaker.types.query_properties.serialize_aws_json_1_1(
                value["properties"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> QueryFilters:
    ...
    if "LineageTypes" in data:
        ...
        out["lineage_types"] = (
            capo_sagemaker.types.query_lineage_types.deserialize_aws_json_1_1(
                data["LineageTypes"]
            )
        )
    ...
    if "Properties" in data:
        ...
        out["properties"] = (
            capo_sagemaker.types.query_properties.deserialize_aws_json_1_1(
                data["Properties"]
            )
        )
    return out
