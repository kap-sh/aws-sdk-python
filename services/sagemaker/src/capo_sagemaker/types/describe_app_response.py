...
if TYPE_CHECKING:
    import capo_sagemaker.types.app_arn
...
class DescribeAppResponse(TypedDict, closed=True):
    app_arn: NotRequired["capo_sagemaker.types.app_arn.AppArn"]
    ...
    last_health_check_timestamp: NotRequired["capo_sagemaker.types.timestamp.Timestamp"]
