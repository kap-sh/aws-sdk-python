...
class ListImagesResponse(TypedDict, closed=True):
    images: NotRequired["capo_sagemaker.types.images.Images"]
...
def serialize_aws_json_1_1(value: ListImagesResponse) -> dict:
    ...
    if "images" in value:
        ...
        out["Images"] = capo_sagemaker.types.images.serialize_aws_json_1_1(
            value["images"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListImagesResponse:
    ...
    if "Images" in data:
        ...
        out["images"] = capo_sagemaker.types.images.deserialize_aws_json_1_1(
            data["Images"]
        )
