...
if TYPE_CHECKING:
    import capo_sagemaker.types.batch_replace_cluster_node_logical_ids_errors
    import capo_sagemaker.types.batch_replace_cluster_nodes_errors
...
class BatchReplaceClusterNodesResponse(TypedDict, closed=True):
    ...
    failed: NotRequired[
        "capo_sagemaker.types.batch_replace_cluster_nodes_errors.BatchReplaceClusterNodesErrors"
    ]
    ...
    failed_node_logical_ids: NotRequired[
        "capo_sagemaker.types.batch_replace_cluster_node_logical_ids_errors.BatchReplaceClusterNodeLogicalIdsErrors"
    ]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: BatchReplaceClusterNodesResponse) -> dict:
    out: dict = {}
    ...
    if "failed" in value:
        ...
        out["Failed"] = (
            capo_sagemaker.types.batch_replace_cluster_nodes_errors.serialize_aws_json_1_1(
                value["failed"]
            )
        )
    if "failed_node_logical_ids" in value:
        ...
        out["FailedNodeLogicalIds"] = (
            capo_sagemaker.types.batch_replace_cluster_node_logical_ids_errors.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchReplaceClusterNodesResponse:
    out: BatchReplaceClusterNodesResponse = {}  # type: ignore[typeddict-item]
    ...
    if "Failed" in data:
        ...
        out["failed"] = (
            capo_sagemaker.types.batch_replace_cluster_nodes_errors.deserialize_aws_json_1_1(
                data["Failed"]
            )
        )
    if "FailedNodeLogicalIds" in data:
        ...
        out["failed_node_logical_ids"] = (
            capo_sagemaker.types.batch_replace_cluster_node_logical_ids_errors.deserialize_aws_json_1_1(
