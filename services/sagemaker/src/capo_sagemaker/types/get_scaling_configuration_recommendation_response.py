...
if TYPE_CHECKING:
    import capo_sagemaker.types.dynamic_scaling_configuration
    import capo_sagemaker.types.endpoint_name
    import capo_sagemaker.types.recommendation_job_name
    import capo_sagemaker.types.scaling_policy_metric
...
class GetScalingConfigurationRecommendationResponse(TypedDict, closed=True):
    ...
    metric: NotRequired[
        "capo_sagemaker.types.scaling_policy_metric.ScalingPolicyMetric"
    ]
    ...
    dynamic_scaling_configuration: NotRequired[
        "capo_sagemaker.types.dynamic_scaling_configuration.DynamicScalingConfiguration"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "metric" in value:
        ...
        out["Metric"] = (
            capo_sagemaker.types.scaling_policy_metric.serialize_aws_json_1_1(
                value["metric"]
            )
        )
    if "dynamic_scaling_configuration" in value:
        ...
        out["DynamicScalingConfiguration"] = (
            capo_sagemaker.types.dynamic_scaling_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "Metric" in data:
        ...
        out["metric"] = (
            capo_sagemaker.types.scaling_policy_metric.deserialize_aws_json_1_1(
                data["Metric"]
            )
        )
    if "DynamicScalingConfiguration" in data:
        ...
        out["dynamic_scaling_configuration"] = (
            capo_sagemaker.types.dynamic_scaling_configuration.deserialize_aws_json_1_1(
