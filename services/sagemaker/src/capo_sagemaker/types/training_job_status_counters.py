...
if TYPE_CHECKING:
    import capo_sagemaker.types.training_job_status_counter


class TrainingJobStatusCounters(TypedDict, closed=True):
    completed: NotRequired[
        "capo_sagemaker.types.training_job_status_counter.TrainingJobStatusCounter"
    ]
