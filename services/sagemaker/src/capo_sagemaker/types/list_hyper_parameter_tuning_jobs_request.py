...
class ListHyperParameterTuningJobsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.hyper_parameter_tuning_job_sort_by_options.HyperParameterTuningJobSortByOptions"
    ]
...
def serialize_aws_json_1_1(value: ListHyperParameterTuningJobsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.hyper_parameter_tuning_job_sort_by_options.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListHyperParameterTuningJobsRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.hyper_parameter_tuning_job_sort_by_options.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
