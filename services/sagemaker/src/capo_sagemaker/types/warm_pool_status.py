...
if TYPE_CHECKING:
    import capo_sagemaker.types.resource_retained_billable_time_in_seconds
    import capo_sagemaker.types.training_job_name
    import capo_sagemaker.types.warm_pool_resource_status


class WarmPoolStatus(TypedDict, closed=True):
    status: NotRequired[
    ...
    resource_retained_billable_time_in_seconds: NotRequired[
        "capo_sagemaker.types.resource_retained_billable_time_in_seconds.ResourceRetainedBillableTimeInSeconds"
    ]
    ...
    reused_by_job: NotRequired["capo_sagemaker.types.training_job_name.TrainingJobName"]
