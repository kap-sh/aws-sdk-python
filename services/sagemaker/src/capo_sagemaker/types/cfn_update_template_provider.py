...
if TYPE_CHECKING:
    import capo_sagemaker.types.cfn_stack_update_parameters
    import capo_sagemaker.types.cfn_template_name
    import capo_sagemaker.types.cfn_template_url


class CfnUpdateTemplateProvider(TypedDict, closed=True):
    ...
    parameters: NotRequired[
        "capo_sagemaker.types.cfn_stack_update_parameters.CfnStackUpdateParameters"
    ]
...
def serialize_aws_json_1_1(value: CfnUpdateTemplateProvider) -> dict:
    ...
    if "parameters" in value:
        ...
        out["Parameters"] = (
            capo_sagemaker.types.cfn_stack_update_parameters.serialize_aws_json_1_1(
                value["parameters"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CfnUpdateTemplateProvider:
    ...
    if "Parameters" in data:
        ...
        out["parameters"] = (
            capo_sagemaker.types.cfn_stack_update_parameters.deserialize_aws_json_1_1(
                data["Parameters"]
            )
        )
    return out
