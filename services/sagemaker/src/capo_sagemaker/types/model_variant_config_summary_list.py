...
if TYPE_CHECKING:
    import capo_sagemaker.types.model_variant_config_summary

ModelVariantConfigSummaryList: TypeAlias = list[
    "capo_sagemaker.types.model_variant_config_summary.ModelVariantConfigSummary"
]
...
def serialize_aws_json_1_1(value: ModelVariantConfigSummaryList) -> list:
    ...
    for item in value:
        out.append(
            capo_sagemaker.types.model_variant_config_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
