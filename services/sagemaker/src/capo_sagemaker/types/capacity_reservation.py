...
if TYPE_CHECKING:
    import capo_sagemaker.types.capacity_reservation_type
...
class CapacityReservation(TypedDict, closed=True):
    ...
    type: NotRequired[
        "capo_sagemaker.types.capacity_reservation_type.CapacityReservationType"
    ]
...
def serialize_aws_json_1_1(value: CapacityReservation) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = (
            capo_sagemaker.types.capacity_reservation_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CapacityReservation:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            capo_sagemaker.types.capacity_reservation_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    return out
