...
if TYPE_CHECKING:
    import capo_sagemaker.types.batch_delete_cluster_node_logical_ids_error_list
    import capo_sagemaker.types.batch_delete_cluster_nodes_error_list
...
class BatchDeleteClusterNodesResponse(TypedDict, closed=True):
    failed: NotRequired[
        "capo_sagemaker.types.batch_delete_cluster_nodes_error_list.BatchDeleteClusterNodesErrorList"
    ]
    ...
    failed_node_logical_ids: NotRequired[
        "capo_sagemaker.types.batch_delete_cluster_node_logical_ids_error_list.BatchDeleteClusterNodeLogicalIdsErrorList"
    ]
...
def serialize_aws_json_1_1(value: BatchDeleteClusterNodesResponse) -> dict:
    ...
    if "failed" in value:
        ...
        out["Failed"] = (
            capo_sagemaker.types.batch_delete_cluster_nodes_error_list.serialize_aws_json_1_1(
                value["failed"]
            )
        )
    ...
    if "failed_node_logical_ids" in value:
        ...
        out["FailedNodeLogicalIds"] = (
            capo_sagemaker.types.batch_delete_cluster_node_logical_ids_error_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchDeleteClusterNodesResponse:
    ...
    if "Failed" in data:
        ...
        out["failed"] = (
            capo_sagemaker.types.batch_delete_cluster_nodes_error_list.deserialize_aws_json_1_1(
                data["Failed"]
            )
        )
    ...
    if "FailedNodeLogicalIds" in data:
        ...
        out["failed_node_logical_ids"] = (
            capo_sagemaker.types.batch_delete_cluster_node_logical_ids_error_list.deserialize_aws_json_1_1(
