...
if TYPE_CHECKING:
    import capo_sagemaker.types.cron_schedule_expression
    import capo_sagemaker.types.deployment_configuration


class ScheduledUpdateConfig(TypedDict, closed=True):
    schedule_expression: NotRequired[
        "capo_sagemaker.types.cron_schedule_expression.CronScheduleExpression"
    ]
