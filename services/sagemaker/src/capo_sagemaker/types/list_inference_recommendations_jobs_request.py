...
class ListInferenceRecommendationsJobsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.list_inference_recommendations_jobs_sort_by.ListInferenceRecommendationsJobsSortBy"
    ]
    ...
    model_name_equals: NotRequired["capo_sagemaker.types.model_name.ModelName"]
...
def serialize_aws_json_1_1(value: ListInferenceRecommendationsJobsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.list_inference_recommendations_jobs_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListInferenceRecommendationsJobsRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.list_inference_recommendations_jobs_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
