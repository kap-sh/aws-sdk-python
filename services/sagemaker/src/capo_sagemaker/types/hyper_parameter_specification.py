...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.parameter_name
...
class HyperParameterSpecification(TypedDict, closed=True):
    name: NotRequired["capo_sagemaker.types.parameter_name.ParameterName"]
    ...
    type: NotRequired["capo_sagemaker.types.parameter_type.ParameterType"]
    ...
    range: NotRequired["capo_sagemaker.types.parameter_range.ParameterRange"]
    """<p>The allowed range for this hyperparameter.</p>"""
    is_tunable: NotRequired["capo_sagemaker.types.boolean.Boolean"]
...
def serialize_aws_json_1_1(value: HyperParameterSpecification) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = capo_sagemaker.types.parameter_type.serialize_aws_json_1_1(
            value["type"]
        )
    if "range" in value:
        import capo_sagemaker.types.parameter_range

        out["Range"] = capo_sagemaker.types.parameter_range.serialize_aws_json_1_1(
            value["range"]
        )
