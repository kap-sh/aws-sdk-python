...
if TYPE_CHECKING:
    import capo_sagemaker.types.model_package_validation_profiles
    import capo_sagemaker.types.role_arn


class ModelPackageValidationSpecification(TypedDict, closed=True):
    validation_role: NotRequired["capo_sagemaker.types.role_arn.RoleArn"]
    """<p>The IAM roles to be used for the validation of the model package.</p>"""
    validation_profiles: NotRequired[
        "capo_sagemaker.types.model_package_validation_profiles.ModelPackageValidationProfiles"
    ]
...
def serialize_aws_json_1_1(value: ModelPackageValidationSpecification) -> dict:
    ...
    if "validation_profiles" in value:
        ...
        out["ValidationProfiles"] = (
            capo_sagemaker.types.model_package_validation_profiles.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ModelPackageValidationSpecification:
    ...
    if "ValidationProfiles" in data:
        ...
        out["validation_profiles"] = (
            capo_sagemaker.types.model_package_validation_profiles.deserialize_aws_json_1_1(
