...
if TYPE_CHECKING:
    import capo_sagemaker.types.notebook_instance_accelerator_type

NotebookInstanceAcceleratorTypes: TypeAlias = list[
    "capo_sagemaker.types.notebook_instance_accelerator_type.NotebookInstanceAcceleratorType"
]
...
def serialize_aws_json_1_1(value: NotebookInstanceAcceleratorTypes) -> list:
    ...
    for item in value:
        out.append(
            capo_sagemaker.types.notebook_instance_accelerator_type.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> NotebookInstanceAcceleratorTypes:
    ...
    for item in data:
        out.append(
            capo_sagemaker.types.notebook_instance_accelerator_type.deserialize_aws_json_1_1(
                item
            )
        )
    return out
