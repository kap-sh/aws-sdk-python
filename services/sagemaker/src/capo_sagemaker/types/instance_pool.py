...
if TYPE_CHECKING:
    import capo_sagemaker.types.instance_pool_priority
...
class InstancePool(TypedDict, closed=True):
    ...
    model_name_override: NotRequired["capo_sagemaker.types.model_name.ModelName"]
    ...
    priority: NotRequired[
        "capo_sagemaker.types.instance_pool_priority.InstancePoolPriority"
    ]
