...
class EdgeDeploymentStatus(TypedDict, closed=True):
    stage_status: NotRequired["capo_sagemaker.types.stage_status.StageStatus"]
    ...
    edge_deployment_failed_in_stage: NotRequired["capo_sagemaker.types.integer.Integer"]
    """<p>The number of edge devices that failed the deployment in current stage.</p>"""
    edge_deployment_status_message: NotRequired["capo_sagemaker.types.string.String"]
...
def serialize_aws_json_1_1(value: EdgeDeploymentStatus) -> dict:
    ...
    if "stage_status" in value:
        ...
        out["StageStatus"] = capo_sagemaker.types.stage_status.serialize_aws_json_1_1(
            value["stage_status"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> EdgeDeploymentStatus:
    ...
    if "StageStatus" in data:
        ...
        out["stage_status"] = (
            capo_sagemaker.types.stage_status.deserialize_aws_json_1_1(
                data["StageStatus"]
            )
        )
