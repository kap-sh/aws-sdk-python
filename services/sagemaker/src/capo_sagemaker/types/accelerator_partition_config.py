...
class AcceleratorPartitionConfig(TypedDict, closed=True):
    type: NotRequired["capo_sagemaker.types.mig_profile_type.MIGProfileType"]
    ...
    count: NotRequired["capo_sagemaker.types.integer.Integer"]
...
def serialize_aws_json_1_1(value: AcceleratorPartitionConfig) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = capo_sagemaker.types.mig_profile_type.serialize_aws_json_1_1(
            value["type"]
        )
    if "count" in value:
