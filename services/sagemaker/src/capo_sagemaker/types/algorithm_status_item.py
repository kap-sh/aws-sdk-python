...
class AlgorithmStatusItem(TypedDict, closed=True):
    ...
    status: NotRequired[
        "capo_sagemaker.types.detailed_algorithm_status.DetailedAlgorithmStatus"
    ]
...
def serialize_aws_json_1_1(value: AlgorithmStatusItem) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            capo_sagemaker.types.detailed_algorithm_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> AlgorithmStatusItem:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            capo_sagemaker.types.detailed_algorithm_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
