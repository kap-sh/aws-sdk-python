...
if TYPE_CHECKING:
    import capo_sagemaker.types.compiler_options
...
class OutputConfig(TypedDict, closed=True):
    ...
    target_device: NotRequired["capo_sagemaker.types.target_device.TargetDevice"]
    ...
    target_platform: NotRequired["capo_sagemaker.types.target_platform.TargetPlatform"]
    ...
    compiler_options: NotRequired[
        "capo_sagemaker.types.compiler_options.CompilerOptions"
    ]
...
def serialize_aws_json_1_1(value: OutputConfig) -> dict:
    ...
    if "target_device" in value:
        ...
        out["TargetDevice"] = capo_sagemaker.types.target_device.serialize_aws_json_1_1(
            value["target_device"]
        )
    if "target_platform" in value:
        ...
        out["TargetPlatform"] = (
            capo_sagemaker.types.target_platform.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OutputConfig:
    ...
    if "TargetPlatform" in data:
        ...
        out["target_platform"] = (
            capo_sagemaker.types.target_platform.deserialize_aws_json_1_1(
                data["TargetPlatform"]
            )
        )
