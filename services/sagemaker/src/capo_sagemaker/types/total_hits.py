...
class TotalHits(TypedDict, closed=True):
    value: NotRequired["capo_sagemaker.types.long.Long"]
    ...
    relation: NotRequired["capo_sagemaker.types.relation.Relation"]
...
def serialize_aws_json_1_1(value: TotalHits) -> dict:
    ...
    if "relation" in value:
        ...
        out["Relation"] = capo_sagemaker.types.relation.serialize_aws_json_1_1(
            value["relation"]
        )
    return out
