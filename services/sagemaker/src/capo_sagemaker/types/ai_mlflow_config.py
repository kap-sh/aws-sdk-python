...
if TYPE_CHECKING:
    import capo_sagemaker.types.ai_mlflow_experiment_name
    import capo_sagemaker.types.ai_mlflow_resource_arn
    import capo_sagemaker.types.ai_mlflow_run_name


class AIMlflowConfig(TypedDict, closed=True):
    mlflow_resource_arn: NotRequired[
        "capo_sagemaker.types.ai_mlflow_resource_arn.AIMlflowResourceArn"
    ]
    """<p>The Amazon Resource Name (ARN) of the SageMaker managed MLflow resource.</p>"""
    mlflow_experiment_name: NotRequired[
        "capo_sagemaker.types.ai_mlflow_experiment_name.AIMlflowExperimentName"
    ]
    """<p>The MLflow experiment name used for tracking.</p>"""
    mlflow_run_name: NotRequired[
        "capo_sagemaker.types.ai_mlflow_run_name.AIMlflowRunName"
    ]
