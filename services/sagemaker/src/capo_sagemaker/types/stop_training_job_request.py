"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopTrainingJobRequest``."""
...
class StopTrainingJobRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StopTrainingJobRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> StopTrainingJobRequest:
    out: StopTrainingJobRequest = {}  # type: ignore[typeddict-item]
