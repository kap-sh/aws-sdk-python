...
class MonitoringBaselineConfig(TypedDict, closed=True):
    ...
    statistics_resource: NotRequired[
        "capo_sagemaker.types.monitoring_statistics_resource.MonitoringStatisticsResource"
    ]
...
def serialize_aws_json_1_1(value: MonitoringBaselineConfig) -> dict:
    ...
    if "statistics_resource" in value:
        ...
        out["StatisticsResource"] = (
            capo_sagemaker.types.monitoring_statistics_resource.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> MonitoringBaselineConfig:
    ...
    if "StatisticsResource" in data:
        ...
        out["statistics_resource"] = (
            capo_sagemaker.types.monitoring_statistics_resource.deserialize_aws_json_1_1(
