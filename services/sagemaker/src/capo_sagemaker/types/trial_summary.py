...
class TrialSummary(TypedDict, closed=True):
    ...
    trial_source: NotRequired["capo_sagemaker.types.trial_source.TrialSource"]
...
def serialize_aws_json_1_1(value: TrialSummary) -> dict:
    ...
    if "trial_source" in value:
        ...
        out["TrialSource"] = capo_sagemaker.types.trial_source.serialize_aws_json_1_1(
            value["trial_source"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> TrialSummary:
    ...
    if "TrialSource" in data:
        ...
        out["trial_source"] = (
            capo_sagemaker.types.trial_source.deserialize_aws_json_1_1(
                data["TrialSource"]
            )
        )
