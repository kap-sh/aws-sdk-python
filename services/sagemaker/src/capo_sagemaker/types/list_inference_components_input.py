...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.inference_component_name_contains
    import capo_sagemaker.types.inference_component_sort_key
...
class ListInferenceComponentsInput(TypedDict, closed=True):
    sort_by: NotRequired[
        "capo_sagemaker.types.inference_component_sort_key.InferenceComponentSortKey"
    ]
    ...
    status_equals: NotRequired[
        "capo_sagemaker.types.inference_component_status.InferenceComponentStatus"
    ]
    """<p>Filters the results to only those inference components with the specified status.</p>"""
    endpoint_name_equals: NotRequired["capo_sagemaker.types.endpoint_name.EndpointName"]
    ...
    variant_name_equals: NotRequired["capo_sagemaker.types.variant_name.VariantName"]
...
def serialize_aws_json_1_1(value: ListInferenceComponentsInput) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.inference_component_sort_key.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
    ...
    if "status_equals" in value:
        ...
        out["StatusEquals"] = (
            capo_sagemaker.types.inference_component_status.serialize_aws_json_1_1(
                value["status_equals"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListInferenceComponentsInput:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.inference_component_sort_key.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
    ...
    if "StatusEquals" in data:
        ...
        out["status_equals"] = (
            capo_sagemaker.types.inference_component_status.deserialize_aws_json_1_1(
                data["StatusEquals"]
            )
        )
