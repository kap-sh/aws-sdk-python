...
if TYPE_CHECKING:
    import capo_sagemaker.types.recommendation_job_supported_response_mime_type

RecommendationJobSupportedResponseMIMETypes: TypeAlias = list[
    "capo_sagemaker.types.recommendation_job_supported_response_mime_type.RecommendationJobSupportedResponseMIMEType"
]
