...
if TYPE_CHECKING:
    import capo_sagemaker.types.template_content_sha256
    import capo_sagemaker.types.template_url


class UiTemplateInfo(TypedDict, closed=True):
    url: NotRequired["capo_sagemaker.types.template_url.TemplateUrl"]
    """<p>The URL for the user interface template.</p>"""
    content_sha256: NotRequired[
        "capo_sagemaker.types.template_content_sha256.TemplateContentSha256"
    ]
