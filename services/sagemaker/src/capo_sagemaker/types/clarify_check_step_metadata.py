...
class ClarifyCheckStepMetadata(TypedDict, closed=True):
    check_type: NotRequired["capo_sagemaker.types.string256.String256"]
    """<p>The type of the Clarify Check step</p>"""
    baseline_used_for_drift_check_constraints: NotRequired[
        "capo_sagemaker.types.string1024.String1024"
    ]
    ...
    model_package_group_name: NotRequired["capo_sagemaker.types.string256.String256"]
    """<p>The model package group name.</p>"""
    violation_report: NotRequired["capo_sagemaker.types.string1024.String1024"]
    """<p>The Amazon S3 URI of the violation report if violations are detected.</p>"""
    check_job_arn: NotRequired["capo_sagemaker.types.string256.String256"]
    """<p>The Amazon Resource Name (ARN) of the check processing job that was run by this step's execution.</p>"""
    skip_check: NotRequired["capo_sagemaker.types.boolean.Boolean"]
    ...
    register_new_baseline: NotRequired["capo_sagemaker.types.boolean.Boolean"]
