...
if TYPE_CHECKING:
    import capo_sagemaker.types.cluster_shared_environment_config_details


class ClusterRestrictedInstanceGroupsConfigOutput(TypedDict, closed=True):
    shared_environment_config: NotRequired[
        "capo_sagemaker.types.cluster_shared_environment_config_details.ClusterSharedEnvironmentConfigDetails"
    ]
...
def serialize_aws_json_1_1(value: ClusterRestrictedInstanceGroupsConfigOutput) -> dict:
    ...
    if "shared_environment_config" in value:
        ...
        out["SharedEnvironmentConfig"] = (
            capo_sagemaker.types.cluster_shared_environment_config_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ClusterRestrictedInstanceGroupsConfigOutput:
    ...
    if "SharedEnvironmentConfig" in data:
        ...
        out["shared_environment_config"] = (
            capo_sagemaker.types.cluster_shared_environment_config_details.deserialize_aws_json_1_1(
