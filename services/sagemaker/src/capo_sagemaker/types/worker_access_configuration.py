...
class WorkerAccessConfiguration(TypedDict, closed=True):
    s3_presign: NotRequired["capo_sagemaker.types.s3_presign.S3Presign"]
...
def serialize_aws_json_1_1(value: WorkerAccessConfiguration) -> dict:
    ...
    if "s3_presign" in value:
        ...
        out["S3Presign"] = capo_sagemaker.types.s3_presign.serialize_aws_json_1_1(
            value["s3_presign"]
        )
    return out
