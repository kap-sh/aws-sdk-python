...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.online_store_total_size_bytes
...
class DescribeFeatureGroupResponse(TypedDict, closed=True):
    ...
    throughput_config: NotRequired[
        "capo_sagemaker.types.throughput_config_description.ThroughputConfigDescription"
    ]
    ...
    online_store_total_size_bytes: NotRequired[
        "capo_sagemaker.types.online_store_total_size_bytes.OnlineStoreTotalSizeBytes"
    ]
...
def serialize_aws_json_1_1(value: DescribeFeatureGroupResponse) -> dict:
    ...
    if "throughput_config" in value:
        ...
        out["ThroughputConfig"] = (
            capo_sagemaker.types.throughput_config_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeFeatureGroupResponse:
    ...
    if "ThroughputConfig" in data:
        ...
        out["throughput_config"] = (
            capo_sagemaker.types.throughput_config_description.deserialize_aws_json_1_1(
