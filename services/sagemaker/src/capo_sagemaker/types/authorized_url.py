...
if TYPE_CHECKING:
    import capo_sagemaker.types.local_path
    import capo_sagemaker.types.long_s3_uri


class AuthorizedUrl(TypedDict, closed=True):
    url: NotRequired["capo_sagemaker.types.long_s3_uri.LongS3Uri"]
    ...
    local_path: NotRequired["capo_sagemaker.types.local_path.LocalPath"]
