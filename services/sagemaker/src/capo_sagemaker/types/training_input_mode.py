"""Generated from Smithy shape ``com.amazonaws.sagemaker#TrainingInputMode``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: TrainingInputMode) -> str:
    return value


def deserialize_aws_json_1_1(data: str) -> TrainingInputMode:
