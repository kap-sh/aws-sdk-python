"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeNotebookInstanceInput``."""
...
class DescribeNotebookInstanceInput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeNotebookInstanceInput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeNotebookInstanceInput:
    out: DescribeNotebookInstanceInput = {}  # type: ignore[typeddict-item]
