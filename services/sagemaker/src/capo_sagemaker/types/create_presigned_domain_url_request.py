...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.expires_in_seconds
...
class CreatePresignedDomainUrlRequest(TypedDict, closed=True):
    ...
    landing_uri: NotRequired["capo_sagemaker.types.landing_uri.LandingUri"]
