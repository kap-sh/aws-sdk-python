...
if TYPE_CHECKING:
    import capo_sagemaker.types.feature_parameter_key
    import capo_sagemaker.types.feature_parameter_value


class FeatureParameter(TypedDict, closed=True):
    key: NotRequired["capo_sagemaker.types.feature_parameter_key.FeatureParameterKey"]
    """<p>A key that must contain a value to describe the feature.</p>"""
    value: NotRequired[
        "capo_sagemaker.types.feature_parameter_value.FeatureParameterValue"
    ]
