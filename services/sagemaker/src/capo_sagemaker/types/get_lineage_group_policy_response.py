...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.resource_policy_string


class GetLineageGroupPolicyResponse(TypedDict, closed=True):
    lineage_group_arn: NotRequired[
        "capo_sagemaker.types.lineage_group_arn.LineageGroupArn"
    ]
    """<p>The Amazon Resource Name (ARN) of the lineage group.</p>"""
    resource_policy: NotRequired[
        "capo_sagemaker.types.resource_policy_string.ResourcePolicyString"
    ]
