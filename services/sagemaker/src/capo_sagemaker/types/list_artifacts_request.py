...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.sort_artifacts_by
...
class ListArtifactsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired["capo_sagemaker.types.sort_artifacts_by.SortArtifactsBy"]
...
def serialize_aws_json_1_1(value: ListArtifactsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = capo_sagemaker.types.sort_artifacts_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListArtifactsRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.sort_artifacts_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
