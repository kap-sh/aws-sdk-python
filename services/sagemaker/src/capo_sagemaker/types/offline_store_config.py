...
class OfflineStoreConfig(TypedDict, closed=True):
    ...
    r"""<p>Format for the offline store table. Supported formats are Glue (Default) and <a href=\"https://iceberg.apache.org/\">Apache Iceberg</a>.</p>"""
