...
class ListModelPackagesInput(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.model_package_sort_by.ModelPackageSortBy"
    ]
...
def serialize_aws_json_1_1(value: ListModelPackagesInput) -> dict:
    ...
    if "model_package_type" in value:
        ...
        out["ModelPackageType"] = (
            capo_sagemaker.types.model_package_type.serialize_aws_json_1_1(
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.model_package_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListModelPackagesInput:
    ...
    if "ModelPackageType" in data:
        ...
        out["model_package_type"] = (
            capo_sagemaker.types.model_package_type.deserialize_aws_json_1_1(
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.model_package_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
