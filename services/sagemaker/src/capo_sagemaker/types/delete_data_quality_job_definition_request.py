"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteDataQualityJobDefinitionRequest``."""
...
class DeleteDataQualityJobDefinitionRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteDataQualityJobDefinitionRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteDataQualityJobDefinitionRequest:
    out: DeleteDataQualityJobDefinitionRequest = {}  # type: ignore[typeddict-item]
