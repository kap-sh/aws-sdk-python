...
class UpdateClusterSoftwareRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_1(value: UpdateClusterSoftwareRequest) -> dict:
    ...
    if "instance_groups" in value:
        ...
        out["InstanceGroups"] = (
            capo_sagemaker.types.update_cluster_software_instance_groups.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateClusterSoftwareRequest:
    ...
    if "InstanceGroups" in data:
        ...
        out["instance_groups"] = (
            capo_sagemaker.types.update_cluster_software_instance_groups.deserialize_aws_json_1_1(
                data["InstanceGroups"]
            )
        )
