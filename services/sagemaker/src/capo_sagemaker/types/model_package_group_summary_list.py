...
if TYPE_CHECKING:
    import capo_sagemaker.types.model_package_group_summary

ModelPackageGroupSummaryList: TypeAlias = list[
    "capo_sagemaker.types.model_package_group_summary.ModelPackageGroupSummary"
]
...
def serialize_aws_json_1_1(value: ModelPackageGroupSummaryList) -> list:
    ...
    for item in value:
        out.append(
            capo_sagemaker.types.model_package_group_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ModelPackageGroupSummaryList:
    ...
    for item in data:
        out.append(
            capo_sagemaker.types.model_package_group_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
