...
class LabelCounters(TypedDict, closed=True):
    total_labeled: NotRequired["capo_sagemaker.types.label_counter.LabelCounter"]
    ...
    machine_labeled: NotRequired["capo_sagemaker.types.label_counter.LabelCounter"]
    """<p>The total number of objects labeled by automated data labeling.</p>"""
    failed_non_retryable_error: NotRequired[
        "capo_sagemaker.types.label_counter.LabelCounter"
    ]
    """<p>The total number of objects that could not be labeled due to an error.</p>"""
    unlabeled: NotRequired["capo_sagemaker.types.label_counter.LabelCounter"]
