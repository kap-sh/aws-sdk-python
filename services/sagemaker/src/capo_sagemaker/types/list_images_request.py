"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListImagesRequest``."""
...
if TYPE_CHECKING:
    import capo_sagemaker.types.image_name_contains
...
class ListImagesRequest(TypedDict, closed=True):
    ...
    name_contains: NotRequired[
        "capo_sagemaker.types.image_name_contains.ImageNameContains"
    ]
    ...
    sort_by: NotRequired["capo_sagemaker.types.image_sort_by.ImageSortBy"]
    """<p>The property used to sort results. The default value is <code>CREATION_TIME</code>.</p>"""
    sort_order: NotRequired["capo_sagemaker.types.image_sort_order.ImageSortOrder"]
...
def serialize_aws_json_1_1(value: ListImagesRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = capo_sagemaker.types.image_sort_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
    if "sort_order" in value:
        import capo_sagemaker.types.image_sort_order

        out["SortOrder"] = capo_sagemaker.types.image_sort_order.serialize_aws_json_1_1(
            value["sort_order"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListImagesRequest:
    ...
    if "SortOrder" in data:
        ...
        out["sort_order"] = (
            capo_sagemaker.types.image_sort_order.deserialize_aws_json_1_1(
                data["SortOrder"]
            )
        )
    return out
