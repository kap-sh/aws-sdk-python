...
class EmrSettings(TypedDict, closed=True):
    assumable_role_arns: NotRequired[
        "capo_sagemaker.types.assumable_role_arns.AssumableRoleArns"
    ]
    ...
    execution_role_arns: NotRequired[
        "capo_sagemaker.types.execution_role_arns.ExecutionRoleArns"
    ]
...
def serialize_aws_json_1_1(value: EmrSettings) -> dict:
    ...
    if "assumable_role_arns" in value:
        ...
        out["AssumableRoleArns"] = (
            capo_sagemaker.types.assumable_role_arns.serialize_aws_json_1_1(
    ...
    if "execution_role_arns" in value:
        ...
        out["ExecutionRoleArns"] = (
            capo_sagemaker.types.execution_role_arns.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EmrSettings:
    ...
    if "AssumableRoleArns" in data:
        ...
        out["assumable_role_arns"] = (
            capo_sagemaker.types.assumable_role_arns.deserialize_aws_json_1_1(
    ...
    if "ExecutionRoleArns" in data:
        ...
        out["execution_role_arns"] = (
            capo_sagemaker.types.execution_role_arns.deserialize_aws_json_1_1(
