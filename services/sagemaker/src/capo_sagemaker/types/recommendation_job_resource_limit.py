...
if TYPE_CHECKING:
    import capo_sagemaker.types.max_number_of_tests
    import capo_sagemaker.types.max_parallel_of_tests


class RecommendationJobResourceLimit(TypedDict, closed=True):
    max_number_of_tests: NotRequired[
        "capo_sagemaker.types.max_number_of_tests.MaxNumberOfTests"
    ]
    """<p>Defines the maximum number of load tests.</p>"""
    max_parallel_of_tests: NotRequired[
        "capo_sagemaker.types.max_parallel_of_tests.MaxParallelOfTests"
    ]
