...
class ListJobsRequest(TypedDict, closed=True):
    ...
    status_equals: NotRequired["capo_sagemaker.types.job_status.JobStatus"]
...
def serialize_aws_json_1_1(value: ListJobsRequest) -> dict:
    ...
    if "status_equals" in value:
        ...
        out["StatusEquals"] = capo_sagemaker.types.job_status.serialize_aws_json_1_1(
            value["status_equals"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListJobsRequest:
    ...
    if "StatusEquals" in data:
        ...
        out["status_equals"] = capo_sagemaker.types.job_status.deserialize_aws_json_1_1(
            data["StatusEquals"]
        )
    return out
