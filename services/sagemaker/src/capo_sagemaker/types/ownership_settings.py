"""Generated from Smithy shape ``com.amazonaws.sagemaker#OwnershipSettings``."""
...
class OwnershipSettings(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: OwnershipSettings) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> OwnershipSettings:
    out: OwnershipSettings = {}  # type: ignore[typeddict-item]
