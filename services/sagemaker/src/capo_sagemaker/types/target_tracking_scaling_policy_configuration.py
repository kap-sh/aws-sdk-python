...
if TYPE_CHECKING:
    import capo_sagemaker.types.double
    import capo_sagemaker.types.metric_specification


class TargetTrackingScalingPolicyConfiguration(TypedDict, closed=True):
    metric_specification: NotRequired[
        "capo_sagemaker.types.metric_specification.MetricSpecification"
    ]
    """<p>An object containing information about a metric.</p>"""
    target_value: NotRequired["capo_sagemaker.types.double.Double"]
...
def serialize_aws_json_1_1(value: TargetTrackingScalingPolicyConfiguration) -> dict:
    ...
    if "metric_specification" in value:
        ...
        out["MetricSpecification"] = (
            capo_sagemaker.types.metric_specification.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TargetTrackingScalingPolicyConfiguration:
    ...
    if "MetricSpecification" in data:
        ...
        out["metric_specification"] = (
            capo_sagemaker.types.metric_specification.deserialize_aws_json_1_1(
