"""Generated from Smithy shape ``com.amazonaws.sagemaker#BatchAddClusterNodes``."""
...
import capo_sagemaker.types.batch_add_cluster_nodes_request
import capo_sagemaker.types.batch_add_cluster_nodes_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.batch_add_cluster_nodes_response.BatchAddClusterNodesResponse = capo_sagemaker.types.batch_add_cluster_nodes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.BatchAddClusterNodes"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.batch_add_cluster_nodes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_add_cluster_nodes(
