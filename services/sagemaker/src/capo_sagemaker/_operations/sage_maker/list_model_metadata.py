...
import capo_sagemaker.types.list_model_metadata_request
import capo_sagemaker.types.list_model_metadata_response
...
) -> capo_sagemaker.types.list_model_metadata_response.ListModelMetadataResponse:
    out: capo_sagemaker.types.list_model_metadata_response.ListModelMetadataResponse = (
        capo_sagemaker.types.list_model_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_model_metadata_request.serialize_aws_json_1_1(input_)
    ).encode()
