"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeDevice``."""
...
import capo_sagemaker.types.describe_device_request
import capo_sagemaker.types.describe_device_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_device_response.DescribeDeviceResponse = (
        capo_sagemaker.types.describe_device_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeDevice"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_device_request.serialize_aws_json_1_1(input_)
    ).encode()
