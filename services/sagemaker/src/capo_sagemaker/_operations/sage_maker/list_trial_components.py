...
import capo_sagemaker.types.list_trial_components_request
import capo_sagemaker.types.list_trial_components_response
...
) -> capo_sagemaker.types.list_trial_components_response.ListTrialComponentsResponse:
    out: capo_sagemaker.types.list_trial_components_response.ListTrialComponentsResponse = capo_sagemaker.types.list_trial_components_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_trial_components_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
