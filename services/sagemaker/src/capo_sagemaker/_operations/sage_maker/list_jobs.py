...
import capo_sagemaker.types.list_jobs_request
import capo_sagemaker.types.list_jobs_response
...
) -> capo_sagemaker.types.list_jobs_response.ListJobsResponse:
    out: capo_sagemaker.types.list_jobs_response.ListJobsResponse = (
        capo_sagemaker.types.list_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_jobs(
    ...
    input_: capo_sagemaker.types.list_jobs_request.ListJobsRequest,
) -> tuple[capo_sagemaker.types.list_jobs_response.ListJobsResponse, zapros.Response]:
