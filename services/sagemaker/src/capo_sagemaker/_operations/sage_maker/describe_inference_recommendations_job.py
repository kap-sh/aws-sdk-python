"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeInferenceRecommendationsJob``."""
...
import capo_sagemaker.types.describe_inference_recommendations_job_request
import capo_sagemaker.types.describe_inference_recommendations_job_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_inference_recommendations_job_response.DescribeInferenceRecommendationsJobResponse = capo_sagemaker.types.describe_inference_recommendations_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeInferenceRecommendationsJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_inference_recommendations_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_inference_recommendations_job(
