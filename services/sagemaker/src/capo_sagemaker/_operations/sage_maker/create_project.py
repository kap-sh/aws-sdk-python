"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateProject``."""
...
import capo_sagemaker.types.create_project_input
import capo_sagemaker.types.create_project_output
...
) -> capo_sagemaker.types.create_project_output.CreateProjectOutput:
    out: capo_sagemaker.types.create_project_output.CreateProjectOutput = (
        capo_sagemaker.types.create_project_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateProject"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_project_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_project(
    ...
    capo_sagemaker.types.create_project_output.CreateProjectOutput, zapros.Response
]:
