"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateFlowDefinition``."""
...
import capo_sagemaker.types.create_flow_definition_request
import capo_sagemaker.types.create_flow_definition_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.create_flow_definition_response.CreateFlowDefinitionResponse = capo_sagemaker.types.create_flow_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_flow_definition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_flow_definition(
