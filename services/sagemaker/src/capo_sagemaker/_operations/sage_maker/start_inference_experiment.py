"""Generated from Smithy shape ``com.amazonaws.sagemaker#StartInferenceExperiment``."""
...
import capo_sagemaker.types.start_inference_experiment_request
import capo_sagemaker.types.start_inference_experiment_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.start_inference_experiment_response.StartInferenceExperimentResponse = capo_sagemaker.types.start_inference_experiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StartInferenceExperiment"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.start_inference_experiment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_inference_experiment(
