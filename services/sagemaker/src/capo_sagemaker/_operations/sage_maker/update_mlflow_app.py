"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateMlflowApp``."""
...
import capo_sagemaker.types.update_mlflow_app_request
import capo_sagemaker.types.update_mlflow_app_response
...
) -> capo_sagemaker.types.update_mlflow_app_response.UpdateMlflowAppResponse:
    out: capo_sagemaker.types.update_mlflow_app_response.UpdateMlflowAppResponse = (
        capo_sagemaker.types.update_mlflow_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateMlflowApp"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_mlflow_app_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_mlflow_app(
