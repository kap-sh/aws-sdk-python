"""Generated from Smithy shape ``com.amazonaws.sagemaker#ImportHubContent``."""
...
import capo_sagemaker.types.import_hub_content_request
import capo_sagemaker.types.import_hub_content_response
...
) -> capo_sagemaker.types.import_hub_content_response.ImportHubContentResponse:
    out: capo_sagemaker.types.import_hub_content_response.ImportHubContentResponse = (
        capo_sagemaker.types.import_hub_content_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ImportHubContent"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.import_hub_content_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_import_hub_content(
