"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListLabelingJobs``."""
...
import capo_sagemaker.types.list_labeling_jobs_request
import capo_sagemaker.types.list_labeling_jobs_response
...
) -> capo_sagemaker.types.list_labeling_jobs_response.ListLabelingJobsResponse:
    out: capo_sagemaker.types.list_labeling_jobs_response.ListLabelingJobsResponse = (
        capo_sagemaker.types.list_labeling_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_labeling_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_labeling_jobs(
