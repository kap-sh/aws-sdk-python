"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeModelCardExportJob``."""
...
import capo_sagemaker.types.describe_model_card_export_job_request
import capo_sagemaker.types.describe_model_card_export_job_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_model_card_export_job_response.DescribeModelCardExportJobResponse = capo_sagemaker.types.describe_model_card_export_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeModelCardExportJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_model_card_export_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_model_card_export_job(
