"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeNotebookInstanceLifecycleConfig``."""
...
import capo_sagemaker.types.describe_notebook_instance_lifecycle_config_input
import capo_sagemaker.types.describe_notebook_instance_lifecycle_config_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_notebook_instance_lifecycle_config_output.DescribeNotebookInstanceLifecycleConfigOutput = capo_sagemaker.types.describe_notebook_instance_lifecycle_config_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_notebook_instance_lifecycle_config_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_notebook_instance_lifecycle_config(
