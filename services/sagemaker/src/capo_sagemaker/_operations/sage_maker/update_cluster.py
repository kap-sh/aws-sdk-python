...
import capo_sagemaker.types.update_cluster_request
import capo_sagemaker.types.update_cluster_response
...
) -> capo_sagemaker.types.update_cluster_response.UpdateClusterResponse:
    out: capo_sagemaker.types.update_cluster_response.UpdateClusterResponse = (
        capo_sagemaker.types.update_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_cluster(
    ...
    capo_sagemaker.types.update_cluster_response.UpdateClusterResponse, zapros.Response
]:
