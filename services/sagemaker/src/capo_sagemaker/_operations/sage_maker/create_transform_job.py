...
import capo_sagemaker.types.create_transform_job_request
import capo_sagemaker.types.create_transform_job_response
...
) -> capo_sagemaker.types.create_transform_job_response.CreateTransformJobResponse:
    out: capo_sagemaker.types.create_transform_job_response.CreateTransformJobResponse = capo_sagemaker.types.create_transform_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_transform_job_request.serialize_aws_json_1_1(input_)
    ).encode()
