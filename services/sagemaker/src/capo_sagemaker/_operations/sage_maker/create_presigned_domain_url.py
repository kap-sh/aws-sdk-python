...
import capo_sagemaker.types.create_presigned_domain_url_request
import capo_sagemaker.types.create_presigned_domain_url_response
...
) -> capo_sagemaker.types.create_presigned_domain_url_response.CreatePresignedDomainUrlResponse:
    out: capo_sagemaker.types.create_presigned_domain_url_response.CreatePresignedDomainUrlResponse = capo_sagemaker.types.create_presigned_domain_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_presigned_domain_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
