"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateApp``."""
...
import capo_sagemaker.types.create_app_request
import capo_sagemaker.types.create_app_response
...
) -> capo_sagemaker.types.create_app_response.CreateAppResponse:
    out: capo_sagemaker.types.create_app_response.CreateAppResponse = (
        capo_sagemaker.types.create_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_app_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_app(
    ...
    input_: capo_sagemaker.types.create_app_request.CreateAppRequest,
) -> tuple[capo_sagemaker.types.create_app_response.CreateAppResponse, zapros.Response]:
