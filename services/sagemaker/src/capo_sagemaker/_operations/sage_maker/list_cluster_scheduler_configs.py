...
import capo_sagemaker.types.cluster_scheduler_config_summary_list
import capo_sagemaker.types.list_cluster_scheduler_configs_request
import capo_sagemaker.types.list_cluster_scheduler_configs_response
...
) -> capo_sagemaker.types.list_cluster_scheduler_configs_response.ListClusterSchedulerConfigsResponse:
    out: capo_sagemaker.types.list_cluster_scheduler_configs_response.ListClusterSchedulerConfigsResponse = capo_sagemaker.types.list_cluster_scheduler_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_cluster_scheduler_configs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
