...
import capo_sagemaker.types.add_tags_input
...
def handle_response(
    ...
    out: capo_sagemaker.types.add_tags_output.AddTagsOutput = (
        capo_sagemaker.types.add_tags_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.add_tags_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_tags(
    options: OperationOptions, input_: capo_sagemaker.types.add_tags_input.AddTagsInput
) -> tuple[capo_sagemaker.types.add_tags_output.AddTagsOutput, zapros.Response]:
