"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListModelCards``."""
...
import capo_sagemaker.types.list_model_cards_request
import capo_sagemaker.types.list_model_cards_response
...
import capo_sagemaker.types.model_card_summary_list
...
) -> capo_sagemaker.types.list_model_cards_response.ListModelCardsResponse:
    out: capo_sagemaker.types.list_model_cards_response.ListModelCardsResponse = (
        capo_sagemaker.types.list_model_cards_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListModelCards"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_model_cards_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_model_cards(
