"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateAppImageConfig``."""
...
import capo_sagemaker.types.create_app_image_config_request
import capo_sagemaker.types.create_app_image_config_response
...
) -> capo_sagemaker.types.create_app_image_config_response.CreateAppImageConfigResponse:
    out: capo_sagemaker.types.create_app_image_config_response.CreateAppImageConfigResponse = capo_sagemaker.types.create_app_image_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateAppImageConfig"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_app_image_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_app_image_config(
