"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeComputeQuota``."""
...
import capo_sagemaker.types.describe_compute_quota_request
import capo_sagemaker.types.describe_compute_quota_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_compute_quota_response.DescribeComputeQuotaResponse = capo_sagemaker.types.describe_compute_quota_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeComputeQuota"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_compute_quota_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_compute_quota(
