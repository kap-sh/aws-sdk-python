...
import capo_sagemaker.types.create_image_request
import capo_sagemaker.types.create_image_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.create_image_response.CreateImageResponse = (
        capo_sagemaker.types.create_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_image_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_image(
    ...
    capo_sagemaker.types.create_image_response.CreateImageResponse, zapros.Response
]:
