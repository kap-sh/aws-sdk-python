...
import capo_sagemaker.types.create_compute_quota_request
import capo_sagemaker.types.create_compute_quota_response
...
) -> capo_sagemaker.types.create_compute_quota_response.CreateComputeQuotaResponse:
    out: capo_sagemaker.types.create_compute_quota_response.CreateComputeQuotaResponse = capo_sagemaker.types.create_compute_quota_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_compute_quota_request.serialize_aws_json_1_1(input_)
    ).encode()
