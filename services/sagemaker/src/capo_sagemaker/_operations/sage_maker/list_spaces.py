"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListSpaces``."""
...
import capo_sagemaker.types.list_spaces_request
import capo_sagemaker.types.list_spaces_response
...
) -> capo_sagemaker.types.list_spaces_response.ListSpacesResponse:
    out: capo_sagemaker.types.list_spaces_response.ListSpacesResponse = (
        capo_sagemaker.types.list_spaces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListSpaces"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_spaces_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_spaces(
    ...
    capo_sagemaker.types.list_spaces_response.ListSpacesResponse, zapros.Response
]:
