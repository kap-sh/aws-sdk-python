"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateHyperParameterTuningJob``."""
...
import capo_sagemaker.types.create_hyper_parameter_tuning_job_request
import capo_sagemaker.types.create_hyper_parameter_tuning_job_response
...
) -> capo_sagemaker.types.create_hyper_parameter_tuning_job_response.CreateHyperParameterTuningJobResponse:
    out: capo_sagemaker.types.create_hyper_parameter_tuning_job_response.CreateHyperParameterTuningJobResponse = capo_sagemaker.types.create_hyper_parameter_tuning_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_hyper_parameter_tuning_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_hyper_parameter_tuning_job(
