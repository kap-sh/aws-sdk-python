"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopJob``."""
...
import capo_sagemaker.types.stop_job_request
import capo_sagemaker.types.stop_job_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.stop_job_response.StopJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StopJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.stop_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_job(
    ...
    input_: capo_sagemaker.types.stop_job_request.StopJobRequest,
) -> tuple[capo_sagemaker.types.stop_job_response.StopJobResponse, zapros.Response]:
