"""Generated from Smithy shape ``com.amazonaws.sagemaker#StartSession``."""
...
import capo_sagemaker.types.start_session_request
import capo_sagemaker.types.start_session_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.start_session_response.StartSessionResponse = (
        capo_sagemaker.types.start_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StartSession"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.start_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_session(
    ...
    capo_sagemaker.types.start_session_response.StartSessionResponse, zapros.Response
]:
