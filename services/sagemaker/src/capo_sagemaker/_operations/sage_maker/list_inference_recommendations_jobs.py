"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListInferenceRecommendationsJobs``."""
...
import capo_sagemaker.types.list_inference_recommendations_jobs_request
import capo_sagemaker.types.list_inference_recommendations_jobs_response
...
) -> capo_sagemaker.types.list_inference_recommendations_jobs_response.ListInferenceRecommendationsJobsResponse:
    out: capo_sagemaker.types.list_inference_recommendations_jobs_response.ListInferenceRecommendationsJobsResponse = capo_sagemaker.types.list_inference_recommendations_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListInferenceRecommendationsJobs"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_inference_recommendations_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_inference_recommendations_jobs(
