"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListStageDevices``."""
...
import capo_sagemaker.types.device_deployment_summaries
import capo_sagemaker.types.list_stage_devices_request
import capo_sagemaker.types.list_stage_devices_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.list_stage_devices_response.ListStageDevicesResponse = (
        capo_sagemaker.types.list_stage_devices_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListStageDevices"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_stage_devices_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_stage_devices(
