"""Generated from Smithy shape ``com.amazonaws.sagemaker#GetSagemakerServicecatalogPortfolioStatus``."""
...
import capo_sagemaker.types.get_sagemaker_servicecatalog_portfolio_status_input
import capo_sagemaker.types.get_sagemaker_servicecatalog_portfolio_status_output
...
) -> capo_sagemaker.types.get_sagemaker_servicecatalog_portfolio_status_output.GetSagemakerServicecatalogPortfolioStatusOutput:
    out: capo_sagemaker.types.get_sagemaker_servicecatalog_portfolio_status_output.GetSagemakerServicecatalogPortfolioStatusOutput = capo_sagemaker.types.get_sagemaker_servicecatalog_portfolio_status_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.GetSagemakerServicecatalogPortfolioStatus"
    body: bytes | None = b""
...
async def async_get_sagemaker_servicecatalog_portfolio_status(
