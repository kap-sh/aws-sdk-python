...
import capo_sagemaker.types.create_model_quality_job_definition_request
import capo_sagemaker.types.create_model_quality_job_definition_response
...
) -> capo_sagemaker.types.create_model_quality_job_definition_response.CreateModelQualityJobDefinitionResponse:
    out: capo_sagemaker.types.create_model_quality_job_definition_response.CreateModelQualityJobDefinitionResponse = capo_sagemaker.types.create_model_quality_job_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_model_quality_job_definition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
