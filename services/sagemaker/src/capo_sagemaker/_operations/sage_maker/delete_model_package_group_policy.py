...
import capo_sagemaker.types.delete_model_package_group_policy_input
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_model_package_group_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
