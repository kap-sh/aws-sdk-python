...
import capo_sagemaker.types.delete_image_request
import capo_sagemaker.types.delete_image_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_image_response.DeleteImageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_image_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_image(
    ...
    capo_sagemaker.types.delete_image_response.DeleteImageResponse, zapros.Response
]:
