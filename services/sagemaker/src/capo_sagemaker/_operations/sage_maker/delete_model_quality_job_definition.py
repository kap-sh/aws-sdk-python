"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteModelQualityJobDefinition``."""
...
import capo_sagemaker.types.delete_model_quality_job_definition_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteModelQualityJobDefinition"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_model_quality_job_definition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_model_quality_job_definition(
