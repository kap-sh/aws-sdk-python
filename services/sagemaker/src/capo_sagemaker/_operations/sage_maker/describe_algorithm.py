"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeAlgorithm``."""
...
import capo_sagemaker.types.describe_algorithm_input
import capo_sagemaker.types.describe_algorithm_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_algorithm_output.DescribeAlgorithmOutput = (
        capo_sagemaker.types.describe_algorithm_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_algorithm_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_algorithm(
