"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListImageVersions``."""
...
import capo_sagemaker.types.image_version_sort_by
import capo_sagemaker.types.image_version_sort_order
import capo_sagemaker.types.image_versions
import capo_sagemaker.types.list_image_versions_request
import capo_sagemaker.types.list_image_versions_response
...
) -> capo_sagemaker.types.list_image_versions_response.ListImageVersionsResponse:
    out: capo_sagemaker.types.list_image_versions_response.ListImageVersionsResponse = (
        capo_sagemaker.types.list_image_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListImageVersions"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_image_versions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_image_versions(
