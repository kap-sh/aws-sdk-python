...
import capo_sagemaker.types.list_projects_input
import capo_sagemaker.types.list_projects_output
...
) -> capo_sagemaker.types.list_projects_output.ListProjectsOutput:
    out: capo_sagemaker.types.list_projects_output.ListProjectsOutput = (
        capo_sagemaker.types.list_projects_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_projects_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_projects(
    ...
    capo_sagemaker.types.list_projects_output.ListProjectsOutput, zapros.Response
]:
