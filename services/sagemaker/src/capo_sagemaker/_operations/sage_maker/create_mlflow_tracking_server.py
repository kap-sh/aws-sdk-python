"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateMlflowTrackingServer``."""
...
import capo_sagemaker.types.create_mlflow_tracking_server_request
import capo_sagemaker.types.create_mlflow_tracking_server_response
...
) -> capo_sagemaker.types.create_mlflow_tracking_server_response.CreateMlflowTrackingServerResponse:
    out: capo_sagemaker.types.create_mlflow_tracking_server_response.CreateMlflowTrackingServerResponse = capo_sagemaker.types.create_mlflow_tracking_server_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateMlflowTrackingServer"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_mlflow_tracking_server_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_mlflow_tracking_server(
