"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateMonitoringSchedule``."""
...
import capo_sagemaker.types.update_monitoring_schedule_request
import capo_sagemaker.types.update_monitoring_schedule_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.update_monitoring_schedule_response.UpdateMonitoringScheduleResponse = capo_sagemaker.types.update_monitoring_schedule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_monitoring_schedule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_monitoring_schedule(
