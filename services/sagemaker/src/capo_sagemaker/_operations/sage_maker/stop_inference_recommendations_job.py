"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopInferenceRecommendationsJob``."""
...
import capo_sagemaker.types.stop_inference_recommendations_job_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StopInferenceRecommendationsJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.stop_inference_recommendations_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_inference_recommendations_job(
