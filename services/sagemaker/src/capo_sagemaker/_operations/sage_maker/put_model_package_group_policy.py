...
import capo_sagemaker.types.put_model_package_group_policy_input
import capo_sagemaker.types.put_model_package_group_policy_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.put_model_package_group_policy_output.PutModelPackageGroupPolicyOutput = capo_sagemaker.types.put_model_package_group_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.put_model_package_group_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
