...
import capo_sagemaker.types.list_experiments_request
import capo_sagemaker.types.list_experiments_response
...
) -> capo_sagemaker.types.list_experiments_response.ListExperimentsResponse:
    out: capo_sagemaker.types.list_experiments_response.ListExperimentsResponse = (
        capo_sagemaker.types.list_experiments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_experiments_request.serialize_aws_json_1_1(input_)
    ).encode()
