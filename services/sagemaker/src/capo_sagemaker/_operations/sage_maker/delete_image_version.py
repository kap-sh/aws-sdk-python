...
import capo_sagemaker.types.delete_image_version_request
import capo_sagemaker.types.delete_image_version_response
...
) -> capo_sagemaker.types.delete_image_version_response.DeleteImageVersionResponse:
    out: capo_sagemaker.types.delete_image_version_response.DeleteImageVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_image_version_request.serialize_aws_json_1_1(input_)
    ).encode()
