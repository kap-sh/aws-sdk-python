...
import capo_sagemaker.types.list_devices_request
import capo_sagemaker.types.list_devices_response
...
) -> capo_sagemaker.types.list_devices_response.ListDevicesResponse:
    out: capo_sagemaker.types.list_devices_response.ListDevicesResponse = (
        capo_sagemaker.types.list_devices_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_devices_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_devices(
    ...
    capo_sagemaker.types.list_devices_response.ListDevicesResponse, zapros.Response
]:
