"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteComputeQuota``."""
...
import capo_sagemaker.types.delete_compute_quota_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteComputeQuota"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_compute_quota_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_compute_quota(
