"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListHubContentVersions``."""
...
import capo_sagemaker.types.list_hub_content_versions_request
import capo_sagemaker.types.list_hub_content_versions_response
...
) -> capo_sagemaker.types.list_hub_content_versions_response.ListHubContentVersionsResponse:
    out: capo_sagemaker.types.list_hub_content_versions_response.ListHubContentVersionsResponse = capo_sagemaker.types.list_hub_content_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListHubContentVersions"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_hub_content_versions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_hub_content_versions(
