"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListPipelineVersions``."""
...
import capo_sagemaker.types.list_pipeline_versions_request
import capo_sagemaker.types.list_pipeline_versions_response
...
) -> capo_sagemaker.types.list_pipeline_versions_response.ListPipelineVersionsResponse:
    out: capo_sagemaker.types.list_pipeline_versions_response.ListPipelineVersionsResponse = capo_sagemaker.types.list_pipeline_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListPipelineVersions"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_pipeline_versions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_pipeline_versions(
