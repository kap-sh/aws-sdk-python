"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateTrial``."""
...
import capo_sagemaker.types.create_trial_request
import capo_sagemaker.types.create_trial_response
...
) -> capo_sagemaker.types.create_trial_response.CreateTrialResponse:
    out: capo_sagemaker.types.create_trial_response.CreateTrialResponse = (
        capo_sagemaker.types.create_trial_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_trial_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_trial(
    ...
    capo_sagemaker.types.create_trial_response.CreateTrialResponse, zapros.Response
]:
