...
import capo_sagemaker.types.list_cluster_nodes_request
import capo_sagemaker.types.list_cluster_nodes_response
...
) -> capo_sagemaker.types.list_cluster_nodes_response.ListClusterNodesResponse:
    out: capo_sagemaker.types.list_cluster_nodes_response.ListClusterNodesResponse = (
        capo_sagemaker.types.list_cluster_nodes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_cluster_nodes_request.serialize_aws_json_1_1(input_)
    ).encode()
