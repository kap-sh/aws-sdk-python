...
import capo_sagemaker.types.describe_job_request
import capo_sagemaker.types.describe_job_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_job_response.DescribeJobResponse = (
        capo_sagemaker.types.describe_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_job(
    ...
    capo_sagemaker.types.describe_job_response.DescribeJobResponse, zapros.Response
]:
