...
import capo_sagemaker.types.list_flow_definitions_request
import capo_sagemaker.types.list_flow_definitions_response
...
) -> capo_sagemaker.types.list_flow_definitions_response.ListFlowDefinitionsResponse:
    out: capo_sagemaker.types.list_flow_definitions_response.ListFlowDefinitionsResponse = capo_sagemaker.types.list_flow_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_flow_definitions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
