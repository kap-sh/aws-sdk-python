"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteAIWorkloadConfig``."""
...
import capo_sagemaker.types.delete_ai_workload_config_request
import capo_sagemaker.types.delete_ai_workload_config_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_ai_workload_config_response.DeleteAIWorkloadConfigResponse = capo_sagemaker.types.delete_ai_workload_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteAIWorkloadConfig"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_ai_workload_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_ai_workload_config(
