"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateProject``."""
...
import capo_sagemaker.types.update_project_input
import capo_sagemaker.types.update_project_output
...
) -> capo_sagemaker.types.update_project_output.UpdateProjectOutput:
    out: capo_sagemaker.types.update_project_output.UpdateProjectOutput = (
        capo_sagemaker.types.update_project_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateProject"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_project_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_project(
    ...
    capo_sagemaker.types.update_project_output.UpdateProjectOutput, zapros.Response
]:
