...
import capo_sagemaker.types.update_pipeline_request
import capo_sagemaker.types.update_pipeline_response
...
) -> capo_sagemaker.types.update_pipeline_response.UpdatePipelineResponse:
    out: capo_sagemaker.types.update_pipeline_response.UpdatePipelineResponse = (
        capo_sagemaker.types.update_pipeline_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_pipeline_request.serialize_aws_json_1_1(input_)
    ).encode()
