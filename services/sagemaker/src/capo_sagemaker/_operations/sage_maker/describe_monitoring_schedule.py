"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeMonitoringSchedule``."""
...
import capo_sagemaker.types.describe_monitoring_schedule_request
import capo_sagemaker.types.describe_monitoring_schedule_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_monitoring_schedule_response.DescribeMonitoringScheduleResponse = capo_sagemaker.types.describe_monitoring_schedule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_monitoring_schedule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_monitoring_schedule(
