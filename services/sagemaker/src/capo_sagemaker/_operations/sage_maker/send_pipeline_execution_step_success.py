...
import capo_sagemaker.types.send_pipeline_execution_step_success_request
import capo_sagemaker.types.send_pipeline_execution_step_success_response
...
) -> capo_sagemaker.types.send_pipeline_execution_step_success_response.SendPipelineExecutionStepSuccessResponse:
    out: capo_sagemaker.types.send_pipeline_execution_step_success_response.SendPipelineExecutionStepSuccessResponse = capo_sagemaker.types.send_pipeline_execution_step_success_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.send_pipeline_execution_step_success_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
