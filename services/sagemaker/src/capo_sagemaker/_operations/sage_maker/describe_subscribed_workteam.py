"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeSubscribedWorkteam``."""
...
import capo_sagemaker.types.describe_subscribed_workteam_request
import capo_sagemaker.types.describe_subscribed_workteam_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_subscribed_workteam_response.DescribeSubscribedWorkteamResponse = capo_sagemaker.types.describe_subscribed_workteam_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_subscribed_workteam_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_subscribed_workteam(
