...
import capo_sagemaker.types.labeling_job_for_workteam_summary_list
import capo_sagemaker.types.list_labeling_jobs_for_workteam_request
import capo_sagemaker.types.list_labeling_jobs_for_workteam_response
...
) -> capo_sagemaker.types.list_labeling_jobs_for_workteam_response.ListLabelingJobsForWorkteamResponse:
    out: capo_sagemaker.types.list_labeling_jobs_for_workteam_response.ListLabelingJobsForWorkteamResponse = capo_sagemaker.types.list_labeling_jobs_for_workteam_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_labeling_jobs_for_workteam_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
