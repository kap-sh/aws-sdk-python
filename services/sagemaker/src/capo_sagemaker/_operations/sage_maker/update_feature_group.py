...
import capo_sagemaker.types.update_feature_group_request
import capo_sagemaker.types.update_feature_group_response
...
) -> capo_sagemaker.types.update_feature_group_response.UpdateFeatureGroupResponse:
    out: capo_sagemaker.types.update_feature_group_response.UpdateFeatureGroupResponse = capo_sagemaker.types.update_feature_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_feature_group_request.serialize_aws_json_1_1(input_)
    ).encode()
