"""Generated from Smithy shape ``com.amazonaws.sagemaker#QueryLineage``."""
...
import capo_sagemaker.types.query_lineage_request
import capo_sagemaker.types.query_lineage_response
...
) -> capo_sagemaker.types.query_lineage_response.QueryLineageResponse:
    out: capo_sagemaker.types.query_lineage_response.QueryLineageResponse = (
        capo_sagemaker.types.query_lineage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.QueryLineage"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.query_lineage_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def query_lineage(
    ...
    capo_sagemaker.types.query_lineage_response.QueryLineageResponse, zapros.Response
]:
