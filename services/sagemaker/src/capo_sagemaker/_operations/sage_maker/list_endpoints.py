"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListEndpoints``."""
...
import capo_sagemaker.types.list_endpoints_input
import capo_sagemaker.types.list_endpoints_output
...
) -> capo_sagemaker.types.list_endpoints_output.ListEndpointsOutput:
    out: capo_sagemaker.types.list_endpoints_output.ListEndpointsOutput = (
        capo_sagemaker.types.list_endpoints_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_endpoints_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_endpoints(
    ...
    capo_sagemaker.types.list_endpoints_output.ListEndpointsOutput, zapros.Response
]:
