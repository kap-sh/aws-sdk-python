...
def handle_response(
    ...
    out: capo_sagemaker.types.attach_cluster_node_volume_response.AttachClusterNodeVolumeResponse = capo_sagemaker.types.attach_cluster_node_volume_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.attach_cluster_node_volume_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
