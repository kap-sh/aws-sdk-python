"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateInferenceRecommendationsJob``."""
...
import capo_sagemaker.types.create_inference_recommendations_job_request
import capo_sagemaker.types.create_inference_recommendations_job_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceInUse":
            raise capo_sagemaker.errors.resource_in_use.ResourceInUse.from_aws_json_1_1(
                data
            )
...
) -> capo_sagemaker.types.create_inference_recommendations_job_response.CreateInferenceRecommendationsJobResponse:
    out: capo_sagemaker.types.create_inference_recommendations_job_response.CreateInferenceRecommendationsJobResponse = capo_sagemaker.types.create_inference_recommendations_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateInferenceRecommendationsJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_inference_recommendations_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_inference_recommendations_job(
