"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeStudioLifecycleConfig``."""
...
import capo_sagemaker.types.describe_studio_lifecycle_config_request
import capo_sagemaker.types.describe_studio_lifecycle_config_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_studio_lifecycle_config_response.DescribeStudioLifecycleConfigResponse = capo_sagemaker.types.describe_studio_lifecycle_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeStudioLifecycleConfig"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_studio_lifecycle_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_studio_lifecycle_config(
