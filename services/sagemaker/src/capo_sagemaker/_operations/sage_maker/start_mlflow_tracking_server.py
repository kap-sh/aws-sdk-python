"""Generated from Smithy shape ``com.amazonaws.sagemaker#StartMlflowTrackingServer``."""
...
import capo_sagemaker.types.start_mlflow_tracking_server_request
import capo_sagemaker.types.start_mlflow_tracking_server_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.start_mlflow_tracking_server_response.StartMlflowTrackingServerResponse = capo_sagemaker.types.start_mlflow_tracking_server_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StartMlflowTrackingServer"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.start_mlflow_tracking_server_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_mlflow_tracking_server(
