...
import capo_sagemaker.types.create_endpoint_config_input
import capo_sagemaker.types.create_endpoint_config_output
...
) -> capo_sagemaker.types.create_endpoint_config_output.CreateEndpointConfigOutput:
    out: capo_sagemaker.types.create_endpoint_config_output.CreateEndpointConfigOutput = capo_sagemaker.types.create_endpoint_config_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_endpoint_config_input.serialize_aws_json_1_1(input_)
    ).encode()
