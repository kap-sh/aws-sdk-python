"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeModel``."""
...
import capo_sagemaker.types.describe_model_input
import capo_sagemaker.types.describe_model_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_model_output.DescribeModelOutput = (
        capo_sagemaker.types.describe_model_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_model_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_model(
    ...
    capo_sagemaker.types.describe_model_output.DescribeModelOutput, zapros.Response
]:
