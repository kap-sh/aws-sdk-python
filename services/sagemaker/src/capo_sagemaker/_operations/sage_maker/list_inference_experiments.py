"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListInferenceExperiments``."""
...
import capo_sagemaker.types.list_inference_experiments_request
import capo_sagemaker.types.list_inference_experiments_response
...
) -> capo_sagemaker.types.list_inference_experiments_response.ListInferenceExperimentsResponse:
    out: capo_sagemaker.types.list_inference_experiments_response.ListInferenceExperimentsResponse = capo_sagemaker.types.list_inference_experiments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListInferenceExperiments"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_inference_experiments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_inference_experiments(
