"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateEndpoint``."""
...
import capo_sagemaker.types.update_endpoint_input
import capo_sagemaker.types.update_endpoint_output
...
) -> capo_sagemaker.types.update_endpoint_output.UpdateEndpointOutput:
    out: capo_sagemaker.types.update_endpoint_output.UpdateEndpointOutput = (
        capo_sagemaker.types.update_endpoint_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_endpoint_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_endpoint(
    ...
    capo_sagemaker.types.update_endpoint_output.UpdateEndpointOutput, zapros.Response
]:
