...
import capo_sagemaker.types.create_ai_benchmark_job_request
import capo_sagemaker.types.create_ai_benchmark_job_response
...
) -> capo_sagemaker.types.create_ai_benchmark_job_response.CreateAIBenchmarkJobResponse:
    out: capo_sagemaker.types.create_ai_benchmark_job_response.CreateAIBenchmarkJobResponse = capo_sagemaker.types.create_ai_benchmark_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_ai_benchmark_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
