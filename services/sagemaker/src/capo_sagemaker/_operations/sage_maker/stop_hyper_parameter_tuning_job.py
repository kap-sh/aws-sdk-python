...
import capo_sagemaker.types.stop_hyper_parameter_tuning_job_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.stop_hyper_parameter_tuning_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
