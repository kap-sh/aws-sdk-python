...
import capo_sagemaker.types.update_image_request
import capo_sagemaker.types.update_image_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.update_image_response.UpdateImageResponse = (
        capo_sagemaker.types.update_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_image_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_image(
    ...
    capo_sagemaker.types.update_image_response.UpdateImageResponse, zapros.Response
]:
