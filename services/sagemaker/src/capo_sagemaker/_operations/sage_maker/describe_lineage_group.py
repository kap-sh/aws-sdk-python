"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeLineageGroup``."""
...
import capo_sagemaker.types.describe_lineage_group_request
import capo_sagemaker.types.describe_lineage_group_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_lineage_group_response.DescribeLineageGroupResponse = capo_sagemaker.types.describe_lineage_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeLineageGroup"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_lineage_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_lineage_group(
