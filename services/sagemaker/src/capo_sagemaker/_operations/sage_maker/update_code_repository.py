"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateCodeRepository``."""
...
import capo_sagemaker.types.update_code_repository_input
import capo_sagemaker.types.update_code_repository_output
...
) -> capo_sagemaker.types.update_code_repository_output.UpdateCodeRepositoryOutput:
    out: capo_sagemaker.types.update_code_repository_output.UpdateCodeRepositoryOutput = capo_sagemaker.types.update_code_repository_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_code_repository_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_code_repository(
