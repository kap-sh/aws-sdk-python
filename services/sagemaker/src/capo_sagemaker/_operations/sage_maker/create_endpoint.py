...
import capo_sagemaker.types.create_endpoint_input
import capo_sagemaker.types.create_endpoint_output
...
) -> capo_sagemaker.types.create_endpoint_output.CreateEndpointOutput:
    out: capo_sagemaker.types.create_endpoint_output.CreateEndpointOutput = (
        capo_sagemaker.types.create_endpoint_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_endpoint_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_endpoint(
    ...
    capo_sagemaker.types.create_endpoint_output.CreateEndpointOutput, zapros.Response
]:
