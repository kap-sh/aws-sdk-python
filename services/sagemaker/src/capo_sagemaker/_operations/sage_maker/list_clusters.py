"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListClusters``."""
...
import capo_sagemaker.types.list_clusters_request
import capo_sagemaker.types.list_clusters_response
...
) -> capo_sagemaker.types.list_clusters_response.ListClustersResponse:
    out: capo_sagemaker.types.list_clusters_response.ListClustersResponse = (
        capo_sagemaker.types.list_clusters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListClusters"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_clusters_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_clusters(
    ...
    capo_sagemaker.types.list_clusters_response.ListClustersResponse, zapros.Response
]:
