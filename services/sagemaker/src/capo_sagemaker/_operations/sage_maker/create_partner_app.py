...
) -> capo_sagemaker.types.create_partner_app_response.CreatePartnerAppResponse:
    out: capo_sagemaker.types.create_partner_app_response.CreatePartnerAppResponse = (
        capo_sagemaker.types.create_partner_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_partner_app_request.serialize_aws_json_1_1(input_)
    ).encode()
