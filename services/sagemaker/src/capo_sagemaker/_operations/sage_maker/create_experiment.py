...
import capo_sagemaker.types.create_experiment_request
import capo_sagemaker.types.create_experiment_response
...
) -> capo_sagemaker.types.create_experiment_response.CreateExperimentResponse:
    out: capo_sagemaker.types.create_experiment_response.CreateExperimentResponse = (
        capo_sagemaker.types.create_experiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_experiment_request.serialize_aws_json_1_1(input_)
    ).encode()
