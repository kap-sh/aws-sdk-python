"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateHub``."""
...
import capo_sagemaker.types.create_hub_request
import capo_sagemaker.types.create_hub_response
...
) -> capo_sagemaker.types.create_hub_response.CreateHubResponse:
    out: capo_sagemaker.types.create_hub_response.CreateHubResponse = (
        capo_sagemaker.types.create_hub_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateHub"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_hub_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_hub(
    ...
    input_: capo_sagemaker.types.create_hub_request.CreateHubRequest,
) -> tuple[capo_sagemaker.types.create_hub_response.CreateHubResponse, zapros.Response]:
