"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeCluster``."""
...
import capo_sagemaker.types.describe_cluster_request
import capo_sagemaker.types.describe_cluster_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_cluster_response.DescribeClusterResponse = (
        capo_sagemaker.types.describe_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeCluster"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
