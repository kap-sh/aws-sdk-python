"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopEdgePackagingJob``."""
...
import capo_sagemaker.types.stop_edge_packaging_job_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StopEdgePackagingJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.stop_edge_packaging_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_edge_packaging_job(
