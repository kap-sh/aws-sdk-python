"""Generated from Smithy shape ``com.amazonaws.sagemaker#GetSearchSuggestions``."""
...
import capo_sagemaker.types.get_search_suggestions_request
import capo_sagemaker.types.get_search_suggestions_response
...
) -> capo_sagemaker.types.get_search_suggestions_response.GetSearchSuggestionsResponse:
    out: capo_sagemaker.types.get_search_suggestions_response.GetSearchSuggestionsResponse = capo_sagemaker.types.get_search_suggestions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.get_search_suggestions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_search_suggestions(
