...
import capo_sagemaker.types.disable_sagemaker_servicecatalog_portfolio_input
import capo_sagemaker.types.disable_sagemaker_servicecatalog_portfolio_output
...
) -> capo_sagemaker.types.disable_sagemaker_servicecatalog_portfolio_output.DisableSagemakerServicecatalogPortfolioOutput:
    out: capo_sagemaker.types.disable_sagemaker_servicecatalog_portfolio_output.DisableSagemakerServicecatalogPortfolioOutput = {}  # type: ignore[typeddict-item]
    return out
