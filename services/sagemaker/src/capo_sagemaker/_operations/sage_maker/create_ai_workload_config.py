...
import capo_sagemaker.types.create_ai_workload_config_request
import capo_sagemaker.types.create_ai_workload_config_response
...
) -> capo_sagemaker.types.create_ai_workload_config_response.CreateAIWorkloadConfigResponse:
    out: capo_sagemaker.types.create_ai_workload_config_response.CreateAIWorkloadConfigResponse = capo_sagemaker.types.create_ai_workload_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_ai_workload_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
