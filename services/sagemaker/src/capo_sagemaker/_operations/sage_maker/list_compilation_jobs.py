"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListCompilationJobs``."""
...
import capo_sagemaker.types.list_compilation_jobs_request
import capo_sagemaker.types.list_compilation_jobs_response
...
) -> capo_sagemaker.types.list_compilation_jobs_response.ListCompilationJobsResponse:
    out: capo_sagemaker.types.list_compilation_jobs_response.ListCompilationJobsResponse = capo_sagemaker.types.list_compilation_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_compilation_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_compilation_jobs(
