"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListLineageGroups``."""
...
import capo_sagemaker.types.list_lineage_groups_request
import capo_sagemaker.types.list_lineage_groups_response
...
) -> capo_sagemaker.types.list_lineage_groups_response.ListLineageGroupsResponse:
    out: capo_sagemaker.types.list_lineage_groups_response.ListLineageGroupsResponse = (
        capo_sagemaker.types.list_lineage_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListLineageGroups"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_lineage_groups_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_lineage_groups(
