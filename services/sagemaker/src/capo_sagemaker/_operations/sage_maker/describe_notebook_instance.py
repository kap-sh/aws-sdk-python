...
import capo_sagemaker.types.describe_notebook_instance_input
import capo_sagemaker.types.describe_notebook_instance_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_notebook_instance_output.DescribeNotebookInstanceOutput = capo_sagemaker.types.describe_notebook_instance_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_notebook_instance_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
