"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateUserProfile``."""
...
import capo_sagemaker.types.update_user_profile_request
import capo_sagemaker.types.update_user_profile_response
...
) -> capo_sagemaker.types.update_user_profile_response.UpdateUserProfileResponse:
    out: capo_sagemaker.types.update_user_profile_response.UpdateUserProfileResponse = (
        capo_sagemaker.types.update_user_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_user_profile_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_user_profile(
