"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdatePartnerApp``."""
...
import capo_sagemaker.types.update_partner_app_request
...
) -> capo_sagemaker.types.update_partner_app_response.UpdatePartnerAppResponse:
    out: capo_sagemaker.types.update_partner_app_response.UpdatePartnerAppResponse = (
        capo_sagemaker.types.update_partner_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdatePartnerApp"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_partner_app_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_partner_app(
