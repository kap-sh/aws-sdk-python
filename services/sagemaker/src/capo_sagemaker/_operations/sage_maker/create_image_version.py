...
import capo_sagemaker.types.create_image_version_request
import capo_sagemaker.types.create_image_version_response
...
) -> capo_sagemaker.types.create_image_version_response.CreateImageVersionResponse:
    out: capo_sagemaker.types.create_image_version_response.CreateImageVersionResponse = capo_sagemaker.types.create_image_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_image_version_request.serialize_aws_json_1_1(input_)
    ).encode()
