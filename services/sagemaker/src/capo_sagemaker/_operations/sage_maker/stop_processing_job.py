"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopProcessingJob``."""
...
import capo_sagemaker.types.stop_processing_job_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.stop_processing_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_stop_processing_job(
