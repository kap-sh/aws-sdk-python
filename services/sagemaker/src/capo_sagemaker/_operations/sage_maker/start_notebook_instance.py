"""Generated from Smithy shape ``com.amazonaws.sagemaker#StartNotebookInstance``."""
...
import capo_sagemaker.types.start_notebook_instance_input
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.start_notebook_instance_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_notebook_instance(
