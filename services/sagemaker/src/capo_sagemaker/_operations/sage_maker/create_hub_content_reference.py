...
import capo_sagemaker.types.create_hub_content_reference_request
import capo_sagemaker.types.create_hub_content_reference_response
...
) -> capo_sagemaker.types.create_hub_content_reference_response.CreateHubContentReferenceResponse:
    out: capo_sagemaker.types.create_hub_content_reference_response.CreateHubContentReferenceResponse = capo_sagemaker.types.create_hub_content_reference_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_hub_content_reference_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
