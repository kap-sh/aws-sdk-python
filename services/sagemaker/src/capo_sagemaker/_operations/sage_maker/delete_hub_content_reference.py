"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteHubContentReference``."""
...
import capo_sagemaker.types.delete_hub_content_reference_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteHubContentReference"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_hub_content_reference_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_hub_content_reference(
