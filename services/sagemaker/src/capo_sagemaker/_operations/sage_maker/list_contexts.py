"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListContexts``."""
...
import capo_sagemaker.types.context_summaries
import capo_sagemaker.types.list_contexts_request
import capo_sagemaker.types.list_contexts_response
...
) -> capo_sagemaker.types.list_contexts_response.ListContextsResponse:
    out: capo_sagemaker.types.list_contexts_response.ListContextsResponse = (
        capo_sagemaker.types.list_contexts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListContexts"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_contexts_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_contexts(
    ...
    capo_sagemaker.types.list_contexts_response.ListContextsResponse, zapros.Response
]:
