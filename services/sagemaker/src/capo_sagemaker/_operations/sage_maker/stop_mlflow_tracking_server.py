"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopMlflowTrackingServer``."""
...
import capo_sagemaker.types.stop_mlflow_tracking_server_request
import capo_sagemaker.types.stop_mlflow_tracking_server_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.stop_mlflow_tracking_server_response.StopMlflowTrackingServerResponse = capo_sagemaker.types.stop_mlflow_tracking_server_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StopMlflowTrackingServer"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.stop_mlflow_tracking_server_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_mlflow_tracking_server(
