"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteTrial``."""
...
import capo_sagemaker.types.delete_trial_request
import capo_sagemaker.types.delete_trial_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_trial_response.DeleteTrialResponse = (
        capo_sagemaker.types.delete_trial_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_trial_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_trial(
    ...
    capo_sagemaker.types.delete_trial_response.DeleteTrialResponse, zapros.Response
]:
