"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateImageVersion``."""
...
import capo_sagemaker.types.update_image_version_request
import capo_sagemaker.types.update_image_version_response
...
) -> capo_sagemaker.types.update_image_version_response.UpdateImageVersionResponse:
    out: capo_sagemaker.types.update_image_version_response.UpdateImageVersionResponse = capo_sagemaker.types.update_image_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateImageVersion"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_image_version_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_image_version(
