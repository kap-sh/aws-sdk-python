"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListMonitoringAlerts``."""
...
import capo_sagemaker.types.list_monitoring_alerts_request
import capo_sagemaker.types.list_monitoring_alerts_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.list_monitoring_alerts_response.ListMonitoringAlertsResponse = capo_sagemaker.types.list_monitoring_alerts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListMonitoringAlerts"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_monitoring_alerts_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_monitoring_alerts(
