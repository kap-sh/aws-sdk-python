"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteFeatureGroup``."""
...
import capo_sagemaker.types.delete_feature_group_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteFeatureGroup"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_feature_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_feature_group(
