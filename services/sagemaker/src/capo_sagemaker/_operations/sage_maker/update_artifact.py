...
import capo_sagemaker.types.update_artifact_request
import capo_sagemaker.types.update_artifact_response
...
) -> capo_sagemaker.types.update_artifact_response.UpdateArtifactResponse:
    out: capo_sagemaker.types.update_artifact_response.UpdateArtifactResponse = (
        capo_sagemaker.types.update_artifact_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_artifact_request.serialize_aws_json_1_1(input_)
    ).encode()
