"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeTrainingPlan``."""
...
import capo_sagemaker.types.describe_training_plan_request
import capo_sagemaker.types.describe_training_plan_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_training_plan_response.DescribeTrainingPlanResponse = capo_sagemaker.types.describe_training_plan_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeTrainingPlan"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_training_plan_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_training_plan(
