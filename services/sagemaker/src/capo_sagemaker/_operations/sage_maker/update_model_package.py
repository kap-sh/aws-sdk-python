"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateModelPackage``."""
...
import capo_sagemaker.types.update_model_package_input
import capo_sagemaker.types.update_model_package_output
...
) -> capo_sagemaker.types.update_model_package_output.UpdateModelPackageOutput:
    out: capo_sagemaker.types.update_model_package_output.UpdateModelPackageOutput = (
        capo_sagemaker.types.update_model_package_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateModelPackage"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_model_package_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_model_package(
