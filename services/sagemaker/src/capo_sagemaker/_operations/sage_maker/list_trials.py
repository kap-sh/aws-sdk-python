...
import capo_sagemaker.types.list_trials_request
import capo_sagemaker.types.list_trials_response
import capo_sagemaker.types.sort_order
import capo_sagemaker.types.sort_trials_by
...
) -> capo_sagemaker.types.list_trials_response.ListTrialsResponse:
    out: capo_sagemaker.types.list_trials_response.ListTrialsResponse = (
        capo_sagemaker.types.list_trials_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_trials_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_trials(
    ...
    capo_sagemaker.types.list_trials_response.ListTrialsResponse, zapros.Response
]:
