"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteHumanTaskUi``."""
...
import capo_sagemaker.types.delete_human_task_ui_request
import capo_sagemaker.types.delete_human_task_ui_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_human_task_ui_response.DeleteHumanTaskUiResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteHumanTaskUi"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_human_task_ui_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_human_task_ui(
