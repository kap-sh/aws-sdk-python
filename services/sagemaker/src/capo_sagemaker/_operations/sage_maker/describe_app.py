...
import capo_sagemaker.types.describe_app_request
import capo_sagemaker.types.describe_app_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_app_response.DescribeAppResponse = (
        capo_sagemaker.types.describe_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_app_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_app(
    ...
    capo_sagemaker.types.describe_app_response.DescribeAppResponse, zapros.Response
]:
