"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateCluster``."""
...
import capo_sagemaker.types.create_cluster_request
import capo_sagemaker.types.create_cluster_response
...
) -> capo_sagemaker.types.create_cluster_response.CreateClusterResponse:
    out: capo_sagemaker.types.create_cluster_response.CreateClusterResponse = (
        capo_sagemaker.types.create_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateCluster"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_cluster(
    ...
    capo_sagemaker.types.create_cluster_response.CreateClusterResponse, zapros.Response
]:
