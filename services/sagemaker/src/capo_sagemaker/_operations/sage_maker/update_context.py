"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateContext``."""
...
import capo_sagemaker.types.update_context_request
import capo_sagemaker.types.update_context_response
...
) -> capo_sagemaker.types.update_context_response.UpdateContextResponse:
    out: capo_sagemaker.types.update_context_response.UpdateContextResponse = (
        capo_sagemaker.types.update_context_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateContext"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_context_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_context(
    ...
    capo_sagemaker.types.update_context_response.UpdateContextResponse, zapros.Response
]:
