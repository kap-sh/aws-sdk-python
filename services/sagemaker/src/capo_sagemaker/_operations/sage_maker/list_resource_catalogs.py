...
import capo_sagemaker.types.list_resource_catalogs_request
import capo_sagemaker.types.list_resource_catalogs_response
...
) -> capo_sagemaker.types.list_resource_catalogs_response.ListResourceCatalogsResponse:
    out: capo_sagemaker.types.list_resource_catalogs_response.ListResourceCatalogsResponse = capo_sagemaker.types.list_resource_catalogs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_resource_catalogs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
