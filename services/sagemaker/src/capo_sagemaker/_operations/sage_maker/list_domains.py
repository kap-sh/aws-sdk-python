...
import capo_sagemaker.types.domain_list
import capo_sagemaker.types.list_domains_request
import capo_sagemaker.types.list_domains_response
...
) -> capo_sagemaker.types.list_domains_response.ListDomainsResponse:
    out: capo_sagemaker.types.list_domains_response.ListDomainsResponse = (
        capo_sagemaker.types.list_domains_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_domains_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_domains(
    ...
    capo_sagemaker.types.list_domains_response.ListDomainsResponse, zapros.Response
]:
