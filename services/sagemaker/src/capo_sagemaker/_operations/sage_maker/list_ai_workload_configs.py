...
import capo_sagemaker.types.list_ai_workload_configs_request
import capo_sagemaker.types.list_ai_workload_configs_response
import capo_sagemaker.types.list_ai_workload_configs_sort_by
...
def handle_response(
    ...
    capo_sagemaker.types.list_ai_workload_configs_response.ListAIWorkloadConfigsResponse
):
    out: capo_sagemaker.types.list_ai_workload_configs_response.ListAIWorkloadConfigsResponse = capo_sagemaker.types.list_ai_workload_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_ai_workload_configs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
