...
import capo_sagemaker.types.create_feature_group_request
import capo_sagemaker.types.create_feature_group_response
...
) -> capo_sagemaker.types.create_feature_group_response.CreateFeatureGroupResponse:
    out: capo_sagemaker.types.create_feature_group_response.CreateFeatureGroupResponse = capo_sagemaker.types.create_feature_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_feature_group_request.serialize_aws_json_1_1(input_)
    ).encode()
