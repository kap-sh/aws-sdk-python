...
import capo_sagemaker.types.update_notebook_instance_input
import capo_sagemaker.types.update_notebook_instance_output
...
) -> capo_sagemaker.types.update_notebook_instance_output.UpdateNotebookInstanceOutput:
    out: capo_sagemaker.types.update_notebook_instance_output.UpdateNotebookInstanceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_notebook_instance_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
