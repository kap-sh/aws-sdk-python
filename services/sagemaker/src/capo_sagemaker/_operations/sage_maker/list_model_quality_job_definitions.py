"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListModelQualityJobDefinitions``."""
...
import capo_sagemaker.types.list_model_quality_job_definitions_request
import capo_sagemaker.types.list_model_quality_job_definitions_response
...
) -> capo_sagemaker.types.list_model_quality_job_definitions_response.ListModelQualityJobDefinitionsResponse:
    out: capo_sagemaker.types.list_model_quality_job_definitions_response.ListModelQualityJobDefinitionsResponse = capo_sagemaker.types.list_model_quality_job_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListModelQualityJobDefinitions"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_model_quality_job_definitions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_model_quality_job_definitions(
