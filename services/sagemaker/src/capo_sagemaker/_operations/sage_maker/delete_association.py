"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteAssociation``."""
...
import capo_sagemaker.types.delete_association_request
import capo_sagemaker.types.delete_association_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_association_response.DeleteAssociationResponse = (
        capo_sagemaker.types.delete_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteAssociation"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_association_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_association(
