"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateHumanTaskUi``."""
...
import capo_sagemaker.types.create_human_task_ui_request
import capo_sagemaker.types.create_human_task_ui_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.create_human_task_ui_response.CreateHumanTaskUiResponse = capo_sagemaker.types.create_human_task_ui_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_human_task_ui_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_human_task_ui(
