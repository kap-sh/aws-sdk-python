"""Generated from Smithy shape ``com.amazonaws.sagemaker#BatchDescribeModelPackage``."""
...
import capo_sagemaker.types.batch_describe_model_package_input
import capo_sagemaker.types.batch_describe_model_package_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.batch_describe_model_package_output.BatchDescribeModelPackageOutput = capo_sagemaker.types.batch_describe_model_package_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.BatchDescribeModelPackage"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.batch_describe_model_package_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_describe_model_package(
