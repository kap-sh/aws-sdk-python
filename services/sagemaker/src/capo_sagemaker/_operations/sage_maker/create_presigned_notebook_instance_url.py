"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreatePresignedNotebookInstanceUrl``."""
...
import capo_sagemaker.types.create_presigned_notebook_instance_url_input
import capo_sagemaker.types.create_presigned_notebook_instance_url_output
...
) -> capo_sagemaker.types.create_presigned_notebook_instance_url_output.CreatePresignedNotebookInstanceUrlOutput:
    out: capo_sagemaker.types.create_presigned_notebook_instance_url_output.CreatePresignedNotebookInstanceUrlOutput = capo_sagemaker.types.create_presigned_notebook_instance_url_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_presigned_notebook_instance_url_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_presigned_notebook_instance_url(
