"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateHubContent``."""
...
import capo_sagemaker.types.update_hub_content_request
import capo_sagemaker.types.update_hub_content_response
...
) -> capo_sagemaker.types.update_hub_content_response.UpdateHubContentResponse:
    out: capo_sagemaker.types.update_hub_content_response.UpdateHubContentResponse = (
        capo_sagemaker.types.update_hub_content_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateHubContent"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_hub_content_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_hub_content(
