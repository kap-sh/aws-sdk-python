...
import capo_sagemaker.types.describe_app_image_config_request
import capo_sagemaker.types.describe_app_image_config_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_app_image_config_response.DescribeAppImageConfigResponse = capo_sagemaker.types.describe_app_image_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_app_image_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
