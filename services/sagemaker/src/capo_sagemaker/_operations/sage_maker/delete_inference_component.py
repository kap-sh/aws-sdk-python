"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteInferenceComponent``."""
...
import capo_sagemaker.types.delete_inference_component_input
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteInferenceComponent"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_inference_component_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_inference_component(
