...
import capo_sagemaker.types.delete_tags_input
import capo_sagemaker.types.delete_tags_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_tags_output.DeleteTagsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_tags_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_tags(
    ...
    input_: capo_sagemaker.types.delete_tags_input.DeleteTagsInput,
) -> tuple[capo_sagemaker.types.delete_tags_output.DeleteTagsOutput, zapros.Response]:
