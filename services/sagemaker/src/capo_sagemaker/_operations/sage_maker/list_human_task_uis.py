...
import capo_sagemaker.types.list_human_task_uis_request
import capo_sagemaker.types.list_human_task_uis_response
...
) -> capo_sagemaker.types.list_human_task_uis_response.ListHumanTaskUisResponse:
    out: capo_sagemaker.types.list_human_task_uis_response.ListHumanTaskUisResponse = (
        capo_sagemaker.types.list_human_task_uis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_human_task_uis_request.serialize_aws_json_1_1(input_)
    ).encode()
