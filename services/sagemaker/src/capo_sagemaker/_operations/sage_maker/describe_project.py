...
import capo_sagemaker.types.describe_project_input
import capo_sagemaker.types.describe_project_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_project_output.DescribeProjectOutput = (
        capo_sagemaker.types.describe_project_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_project_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_project(
    ...
    capo_sagemaker.types.describe_project_output.DescribeProjectOutput, zapros.Response
]:
