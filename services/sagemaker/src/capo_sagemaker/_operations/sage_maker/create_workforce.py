"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateWorkforce``."""
...
import capo_sagemaker.types.create_workforce_request
import capo_sagemaker.types.create_workforce_response
...
) -> capo_sagemaker.types.create_workforce_response.CreateWorkforceResponse:
    out: capo_sagemaker.types.create_workforce_response.CreateWorkforceResponse = (
        capo_sagemaker.types.create_workforce_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateWorkforce"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_workforce_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_workforce(
