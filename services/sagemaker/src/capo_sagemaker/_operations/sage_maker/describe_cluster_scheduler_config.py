"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeClusterSchedulerConfig``."""
...
import capo_sagemaker.types.describe_cluster_scheduler_config_request
import capo_sagemaker.types.describe_cluster_scheduler_config_response
...
) -> capo_sagemaker.types.describe_cluster_scheduler_config_response.DescribeClusterSchedulerConfigResponse:
    out: capo_sagemaker.types.describe_cluster_scheduler_config_response.DescribeClusterSchedulerConfigResponse = capo_sagemaker.types.describe_cluster_scheduler_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeClusterSchedulerConfig"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_cluster_scheduler_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_cluster_scheduler_config(
