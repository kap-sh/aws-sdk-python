"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeEdgeDeploymentPlan``."""
...
import capo_sagemaker.types.describe_edge_deployment_plan_request
import capo_sagemaker.types.describe_edge_deployment_plan_response
...
) -> capo_sagemaker.types.describe_edge_deployment_plan_response.DescribeEdgeDeploymentPlanResponse:
    out: capo_sagemaker.types.describe_edge_deployment_plan_response.DescribeEdgeDeploymentPlanResponse = capo_sagemaker.types.describe_edge_deployment_plan_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeEdgeDeploymentPlan"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_edge_deployment_plan_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_edge_deployment_plan(
