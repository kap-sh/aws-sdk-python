"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateHub``."""
...
import capo_sagemaker.types.update_hub_request
import capo_sagemaker.types.update_hub_response
...
) -> capo_sagemaker.types.update_hub_response.UpdateHubResponse:
    out: capo_sagemaker.types.update_hub_response.UpdateHubResponse = (
        capo_sagemaker.types.update_hub_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateHub"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_hub_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_hub(
    ...
    input_: capo_sagemaker.types.update_hub_request.UpdateHubRequest,
) -> tuple[capo_sagemaker.types.update_hub_response.UpdateHubResponse, zapros.Response]:
