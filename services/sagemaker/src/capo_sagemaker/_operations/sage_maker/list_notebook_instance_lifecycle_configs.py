"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListNotebookInstanceLifecycleConfigs``."""
...
import capo_sagemaker.types.list_notebook_instance_lifecycle_configs_input
import capo_sagemaker.types.list_notebook_instance_lifecycle_configs_output
...
) -> capo_sagemaker.types.list_notebook_instance_lifecycle_configs_output.ListNotebookInstanceLifecycleConfigsOutput:
    out: capo_sagemaker.types.list_notebook_instance_lifecycle_configs_output.ListNotebookInstanceLifecycleConfigsOutput = capo_sagemaker.types.list_notebook_instance_lifecycle_configs_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_notebook_instance_lifecycle_configs_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_notebook_instance_lifecycle_configs(
