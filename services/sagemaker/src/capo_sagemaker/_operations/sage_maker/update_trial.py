"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateTrial``."""
...
import capo_sagemaker.types.update_trial_request
import capo_sagemaker.types.update_trial_response
...
) -> capo_sagemaker.types.update_trial_response.UpdateTrialResponse:
    out: capo_sagemaker.types.update_trial_response.UpdateTrialResponse = (
        capo_sagemaker.types.update_trial_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_trial_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_trial(
    ...
    capo_sagemaker.types.update_trial_response.UpdateTrialResponse, zapros.Response
]:
