"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteDomain``."""
...
import capo_sagemaker.types.delete_domain_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_domain_request.serialize_aws_json_1_1(input_)
    ).encode()
