"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListInferenceComponents``."""
...
import capo_sagemaker.types.list_inference_components_input
import capo_sagemaker.types.list_inference_components_output
...
def handle_response(
    ...
    capo_sagemaker.types.list_inference_components_output.ListInferenceComponentsOutput
):
    out: capo_sagemaker.types.list_inference_components_output.ListInferenceComponentsOutput = capo_sagemaker.types.list_inference_components_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListInferenceComponents"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_inference_components_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_inference_components(
