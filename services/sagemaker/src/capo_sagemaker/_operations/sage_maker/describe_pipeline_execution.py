"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribePipelineExecution``."""
...
import capo_sagemaker.types.describe_pipeline_execution_request
import capo_sagemaker.types.describe_pipeline_execution_response
import capo_sagemaker.types.m_lflow_configuration
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_pipeline_execution_response.DescribePipelineExecutionResponse = capo_sagemaker.types.describe_pipeline_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribePipelineExecution"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_pipeline_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_pipeline_execution(
