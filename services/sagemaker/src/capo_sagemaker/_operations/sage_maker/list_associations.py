...
import capo_sagemaker.types.list_associations_request
import capo_sagemaker.types.list_associations_response
import capo_sagemaker.types.sort_associations_by
...
def handle_response(
    ...
    out: capo_sagemaker.types.list_associations_response.ListAssociationsResponse = (
        capo_sagemaker.types.list_associations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_associations_request.serialize_aws_json_1_1(input_)
    ).encode()
