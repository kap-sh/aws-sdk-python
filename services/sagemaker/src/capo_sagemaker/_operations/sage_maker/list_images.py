"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListImages``."""
...
import capo_sagemaker.types.images
import capo_sagemaker.types.list_images_request
import capo_sagemaker.types.list_images_response
...
) -> capo_sagemaker.types.list_images_response.ListImagesResponse:
    out: capo_sagemaker.types.list_images_response.ListImagesResponse = (
        capo_sagemaker.types.list_images_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListImages"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_images_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_images(
    ...
    capo_sagemaker.types.list_images_response.ListImagesResponse, zapros.Response
]:
