"""Generated from Smithy shape ``com.amazonaws.sagemaker#BatchReplaceClusterNodes``."""
...
import capo_sagemaker.types.batch_replace_cluster_nodes_request
import capo_sagemaker.types.batch_replace_cluster_nodes_response
...
) -> capo_sagemaker.types.batch_replace_cluster_nodes_response.BatchReplaceClusterNodesResponse:
    out: capo_sagemaker.types.batch_replace_cluster_nodes_response.BatchReplaceClusterNodesResponse = capo_sagemaker.types.batch_replace_cluster_nodes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.BatchReplaceClusterNodes"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.batch_replace_cluster_nodes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_replace_cluster_nodes(
