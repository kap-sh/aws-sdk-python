"""Generated from Smithy shape ``com.amazonaws.sagemaker#StartEdgeDeploymentStage``."""
...
import capo_sagemaker.types.start_edge_deployment_stage_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StartEdgeDeploymentStage"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.start_edge_deployment_stage_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_edge_deployment_stage(
