"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteProcessingJob``."""
...
import capo_sagemaker.types.delete_processing_job_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteProcessingJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_processing_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_processing_job(
