...
import capo_sagemaker.types.delete_model_explainability_job_definition_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_model_explainability_job_definition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
