"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListPipelineParametersForExecution``."""
...
import capo_sagemaker.types.list_pipeline_parameters_for_execution_request
import capo_sagemaker.types.list_pipeline_parameters_for_execution_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.list_pipeline_parameters_for_execution_response.ListPipelineParametersForExecutionResponse = capo_sagemaker.types.list_pipeline_parameters_for_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListPipelineParametersForExecution"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_pipeline_parameters_for_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_pipeline_parameters_for_execution(
