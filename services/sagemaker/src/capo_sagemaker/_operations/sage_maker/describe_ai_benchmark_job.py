"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeAIBenchmarkJob``."""
...
import capo_sagemaker.types.describe_ai_benchmark_job_request
import capo_sagemaker.types.describe_ai_benchmark_job_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_ai_benchmark_job_response.DescribeAIBenchmarkJobResponse = capo_sagemaker.types.describe_ai_benchmark_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeAIBenchmarkJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_ai_benchmark_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_ai_benchmark_job(
