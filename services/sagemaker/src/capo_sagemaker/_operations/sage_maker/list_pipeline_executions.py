...
import capo_sagemaker.types.list_pipeline_executions_request
import capo_sagemaker.types.list_pipeline_executions_response
...
) -> capo_sagemaker.types.list_pipeline_executions_response.ListPipelineExecutionsResponse:
    out: capo_sagemaker.types.list_pipeline_executions_response.ListPipelineExecutionsResponse = capo_sagemaker.types.list_pipeline_executions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_pipeline_executions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
