...
import capo_sagemaker.types.create_partner_app_presigned_url_request
import capo_sagemaker.types.create_partner_app_presigned_url_response
...
) -> capo_sagemaker.types.create_partner_app_presigned_url_response.CreatePartnerAppPresignedUrlResponse:
    out: capo_sagemaker.types.create_partner_app_presigned_url_response.CreatePartnerAppPresignedUrlResponse = capo_sagemaker.types.create_partner_app_presigned_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_partner_app_presigned_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
