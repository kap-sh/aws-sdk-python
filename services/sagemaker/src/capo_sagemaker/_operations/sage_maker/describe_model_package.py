"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeModelPackage``."""
...
import capo_sagemaker.types.describe_model_package_input
import capo_sagemaker.types.describe_model_package_output
...
) -> capo_sagemaker.types.describe_model_package_output.DescribeModelPackageOutput:
    out: capo_sagemaker.types.describe_model_package_output.DescribeModelPackageOutput = capo_sagemaker.types.describe_model_package_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_model_package_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_model_package(
