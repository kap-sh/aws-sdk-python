"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListEdgeDeploymentPlans``."""
...
import capo_sagemaker.types.list_edge_deployment_plans_request
import capo_sagemaker.types.list_edge_deployment_plans_response
...
) -> capo_sagemaker.types.list_edge_deployment_plans_response.ListEdgeDeploymentPlansResponse:
    out: capo_sagemaker.types.list_edge_deployment_plans_response.ListEdgeDeploymentPlansResponse = capo_sagemaker.types.list_edge_deployment_plans_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListEdgeDeploymentPlans"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_edge_deployment_plans_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_edge_deployment_plans(
