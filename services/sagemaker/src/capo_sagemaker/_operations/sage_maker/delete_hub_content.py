"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteHubContent``."""
...
import capo_sagemaker.types.delete_hub_content_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteHubContent"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_hub_content_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_hub_content(
