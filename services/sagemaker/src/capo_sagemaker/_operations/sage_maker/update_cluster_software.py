"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateClusterSoftware``."""
...
import capo_sagemaker.types.update_cluster_software_request
import capo_sagemaker.types.update_cluster_software_response
...
def handle_response(
    ...
    capo_sagemaker.types.update_cluster_software_response.UpdateClusterSoftwareResponse
):
    out: capo_sagemaker.types.update_cluster_software_response.UpdateClusterSoftwareResponse = capo_sagemaker.types.update_cluster_software_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateClusterSoftware"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_cluster_software_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_cluster_software(
