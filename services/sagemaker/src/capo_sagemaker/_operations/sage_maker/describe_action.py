"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeAction``."""
...
import capo_sagemaker.types.describe_action_request
import capo_sagemaker.types.describe_action_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_action_response.DescribeActionResponse = (
        capo_sagemaker.types.describe_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeAction"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_action_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_action(
