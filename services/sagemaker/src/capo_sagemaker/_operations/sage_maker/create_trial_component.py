"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateTrialComponent``."""
...
import capo_sagemaker.types.create_trial_component_request
import capo_sagemaker.types.create_trial_component_response
...
) -> capo_sagemaker.types.create_trial_component_response.CreateTrialComponentResponse:
    out: capo_sagemaker.types.create_trial_component_response.CreateTrialComponentResponse = capo_sagemaker.types.create_trial_component_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_trial_component_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_trial_component(
