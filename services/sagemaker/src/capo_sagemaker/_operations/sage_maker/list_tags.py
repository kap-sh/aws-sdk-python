...
import capo_sagemaker.types.list_tags_input
import capo_sagemaker.types.list_tags_output
...
) -> capo_sagemaker.types.list_tags_output.ListTagsOutput:
    out: capo_sagemaker.types.list_tags_output.ListTagsOutput = (
        capo_sagemaker.types.list_tags_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_tags_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_tags(
    ...
    input_: capo_sagemaker.types.list_tags_input.ListTagsInput,
) -> tuple[capo_sagemaker.types.list_tags_output.ListTagsOutput, zapros.Response]:
