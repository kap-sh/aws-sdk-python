"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateTrainingJob``."""
...
import capo_sagemaker.types.update_training_job_request
import capo_sagemaker.types.update_training_job_response
...
) -> capo_sagemaker.types.update_training_job_response.UpdateTrainingJobResponse:
    out: capo_sagemaker.types.update_training_job_response.UpdateTrainingJobResponse = (
        capo_sagemaker.types.update_training_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateTrainingJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_training_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_training_job(
