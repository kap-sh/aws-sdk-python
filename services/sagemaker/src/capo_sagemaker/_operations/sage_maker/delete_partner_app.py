"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeletePartnerApp``."""
...
import capo_sagemaker.types.delete_partner_app_request
import capo_sagemaker.types.delete_partner_app_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_partner_app_response.DeletePartnerAppResponse = (
        capo_sagemaker.types.delete_partner_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeletePartnerApp"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_partner_app_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_partner_app(
