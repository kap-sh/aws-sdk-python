"""Generated from Smithy shape ``com.amazonaws.sagemaker#SearchTrainingPlanOfferings``."""
...
import capo_sagemaker.types.search_training_plan_offerings_request
import capo_sagemaker.types.search_training_plan_offerings_response
...
) -> capo_sagemaker.types.search_training_plan_offerings_response.SearchTrainingPlanOfferingsResponse:
    out: capo_sagemaker.types.search_training_plan_offerings_response.SearchTrainingPlanOfferingsResponse = capo_sagemaker.types.search_training_plan_offerings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.SearchTrainingPlanOfferings"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.search_training_plan_offerings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_search_training_plan_offerings(
