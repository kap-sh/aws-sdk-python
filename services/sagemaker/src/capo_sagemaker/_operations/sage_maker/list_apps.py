...
import capo_sagemaker.types.list_apps_request
import capo_sagemaker.types.list_apps_response
...
) -> capo_sagemaker.types.list_apps_response.ListAppsResponse:
    out: capo_sagemaker.types.list_apps_response.ListAppsResponse = (
        capo_sagemaker.types.list_apps_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_apps_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_apps(
    ...
    input_: capo_sagemaker.types.list_apps_request.ListAppsRequest,
) -> tuple[capo_sagemaker.types.list_apps_response.ListAppsResponse, zapros.Response]:
