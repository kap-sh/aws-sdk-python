...
import capo_sagemaker.types.update_trial_component_request
import capo_sagemaker.types.update_trial_component_response
...
) -> capo_sagemaker.types.update_trial_component_response.UpdateTrialComponentResponse:
    out: capo_sagemaker.types.update_trial_component_response.UpdateTrialComponentResponse = capo_sagemaker.types.update_trial_component_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_trial_component_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
