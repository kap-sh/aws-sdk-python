"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateEndpointWeightsAndCapacities``."""
...
import capo_sagemaker.types.update_endpoint_weights_and_capacities_input
import capo_sagemaker.types.update_endpoint_weights_and_capacities_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.update_endpoint_weights_and_capacities_output.UpdateEndpointWeightsAndCapacitiesOutput = capo_sagemaker.types.update_endpoint_weights_and_capacities_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_endpoint_weights_and_capacities_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_endpoint_weights_and_capacities(
