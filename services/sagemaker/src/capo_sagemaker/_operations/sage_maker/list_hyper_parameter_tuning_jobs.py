...
import capo_sagemaker.types.list_hyper_parameter_tuning_jobs_request
import capo_sagemaker.types.list_hyper_parameter_tuning_jobs_response
...
) -> capo_sagemaker.types.list_hyper_parameter_tuning_jobs_response.ListHyperParameterTuningJobsResponse:
    out: capo_sagemaker.types.list_hyper_parameter_tuning_jobs_response.ListHyperParameterTuningJobsResponse = capo_sagemaker.types.list_hyper_parameter_tuning_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_hyper_parameter_tuning_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
