...
class SageMakerError(Exception):
    """Base class for all SageMaker service errors."""


class ServiceError(SageMakerError):
...
class SerializationError(SageMakerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SageMakerError):
...
class WaiterFailedError(SageMakerError):
...
class WaiterTimeoutError(SageMakerError):
