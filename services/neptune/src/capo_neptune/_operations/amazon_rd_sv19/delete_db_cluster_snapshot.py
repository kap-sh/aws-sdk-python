"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteDBClusterSnapshot``."""
...
def handle_response(
    ...
    out: capo_neptune.types.delete_db_cluster_snapshot_result.DeleteDBClusterSnapshotResult = capo_neptune.types.delete_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.delete_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
