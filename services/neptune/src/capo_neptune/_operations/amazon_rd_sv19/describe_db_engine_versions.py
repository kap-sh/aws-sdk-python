"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeDBEngineVersions``."""
...
import capo_neptune.types.db_engine_version_list
...
def handle_response(
    ...
    out: capo_neptune.types.db_engine_version_message.DBEngineVersionMessage = (
        capo_neptune.types.db_engine_version_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_engine_versions_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_db_engine_versions(
    ...
    capo_neptune.types.db_engine_version_message.DBEngineVersionMessage, zapros.Response
]:
