...
def handle_response(
    ...
    out: capo_neptune.types.apply_pending_maintenance_action_result.ApplyPendingMaintenanceActionResult = capo_neptune.types.apply_pending_maintenance_action_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.apply_pending_maintenance_action_message.serialize_query(
        input_, pairs, ""
    )
