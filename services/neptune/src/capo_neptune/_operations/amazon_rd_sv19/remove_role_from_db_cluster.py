...
import capo_neptune.errors.db_cluster_role_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBClusterRoleNotFoundFault":
            raise capo_neptune.errors.db_cluster_role_not_found_fault.DBClusterRoleNotFoundFault.from_query(
                root
            )
...
def build_request(
    ...
    capo_neptune.types.remove_role_from_db_cluster_message.serialize_query(
        input_, pairs, ""
    )
