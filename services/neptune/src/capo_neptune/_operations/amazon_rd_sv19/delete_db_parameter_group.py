"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteDBParameterGroup``."""
...
import capo_neptune.errors.invalid_db_parameter_group_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBParameterGroupStateFault":
            raise capo_neptune.errors.invalid_db_parameter_group_state_fault.InvalidDBParameterGroupStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    pairs.append(("Action", "DeleteDBParameterGroup"))
    pairs.append(("Version", "2014-10-31"))
    capo_neptune.types.delete_db_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_db_parameter_group(
