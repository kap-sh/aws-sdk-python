"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeDBClusterEndpoints``."""
...
import capo_neptune.types.db_cluster_endpoint_list
...
def handle_response(
    ...
    out: capo_neptune.types.db_cluster_endpoint_message.DBClusterEndpointMessage = (
        capo_neptune.types.db_cluster_endpoint_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_cluster_endpoints_message.serialize_query(
        input_, pairs, ""
    )
