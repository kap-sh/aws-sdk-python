"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteDBClusterEndpoint``."""
...
import capo_neptune.errors.db_cluster_endpoint_not_found_fault
import capo_neptune.errors.invalid_db_cluster_endpoint_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBClusterEndpointNotFoundFault":
            raise capo_neptune.errors.db_cluster_endpoint_not_found_fault.DBClusterEndpointNotFoundFault.from_query(
                root
            )
        case "InvalidDBClusterEndpointStateFault":
            raise capo_neptune.errors.invalid_db_cluster_endpoint_state_fault.InvalidDBClusterEndpointStateFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_neptune.types.delete_db_cluster_endpoint_output.DeleteDBClusterEndpointOutput = capo_neptune.types.delete_db_cluster_endpoint_output.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.delete_db_cluster_endpoint_message.serialize_query(
        input_, pairs, ""
    )
