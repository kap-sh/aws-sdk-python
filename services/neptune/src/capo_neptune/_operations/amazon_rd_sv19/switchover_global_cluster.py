"""Generated from Smithy shape ``com.amazonaws.neptune#SwitchoverGlobalCluster``."""
...
def handle_response(
    ...
    out: capo_neptune.types.switchover_global_cluster_result.SwitchoverGlobalClusterResult = capo_neptune.types.switchover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.switchover_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
