...
def handle_response(
    ...
    out: capo_neptune.types.describe_db_cluster_snapshot_attributes_result.DescribeDBClusterSnapshotAttributesResult = capo_neptune.types.describe_db_cluster_snapshot_attributes_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_cluster_snapshot_attributes_message.serialize_query(
        input_, pairs, ""
    )
