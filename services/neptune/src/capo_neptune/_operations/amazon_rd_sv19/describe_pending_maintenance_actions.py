...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceNotFoundFault":
            raise capo_neptune.errors.resource_not_found_fault.ResourceNotFoundFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_neptune.types.pending_maintenance_actions_message.PendingMaintenanceActionsMessage = capo_neptune.types.pending_maintenance_actions_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_pending_maintenance_actions_message.serialize_query(
        input_, pairs, ""
    )
