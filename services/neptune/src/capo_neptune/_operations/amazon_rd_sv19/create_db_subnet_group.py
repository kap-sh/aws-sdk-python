"""Generated from Smithy shape ``com.amazonaws.neptune#CreateDBSubnetGroup``."""
...
import capo_neptune.errors.db_subnet_group_already_exists_fault
import capo_neptune.errors.db_subnet_group_does_not_cover_enough_a_zs
import capo_neptune.errors.db_subnet_group_quota_exceeded_fault
import capo_neptune.errors.db_subnet_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBSubnetGroupAlreadyExistsFault":
            raise capo_neptune.errors.db_subnet_group_already_exists_fault.DBSubnetGroupAlreadyExistsFault.from_query(
                root
            )
        case "DBSubnetGroupDoesNotCoverEnoughAZs":
            raise capo_neptune.errors.db_subnet_group_does_not_cover_enough_a_zs.DBSubnetGroupDoesNotCoverEnoughAZs.from_query(
                root
            )
        case "DBSubnetGroupQuotaExceededFault":
            raise capo_neptune.errors.db_subnet_group_quota_exceeded_fault.DBSubnetGroupQuotaExceededFault.from_query(
                root
            )
        case "DBSubnetQuotaExceededFault":
            raise capo_neptune.errors.db_subnet_quota_exceeded_fault.DBSubnetQuotaExceededFault.from_query(
                root
            )
        case "InvalidSubnet":
...
def handle_response(
    ...
    out: capo_neptune.types.create_db_subnet_group_result.CreateDBSubnetGroupResult = (
        capo_neptune.types.create_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.create_db_subnet_group_message.serialize_query(input_, pairs, "")
