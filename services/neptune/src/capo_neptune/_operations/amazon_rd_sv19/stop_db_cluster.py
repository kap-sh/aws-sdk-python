"""Generated from Smithy shape ``com.amazonaws.neptune#StopDBCluster``."""
...
def handle_response(
    ...
    out: capo_neptune.types.stop_db_cluster_result.StopDBClusterResult = (
        capo_neptune.types.stop_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.stop_db_cluster_message.serialize_query(input_, pairs, "")
...
def stop_db_cluster(
    ...
    capo_neptune.types.stop_db_cluster_result.StopDBClusterResult, zapros.Response
]:
