"""Generated from Smithy shape ``com.amazonaws.neptune#ModifyDBClusterSnapshotAttribute``."""
...
import capo_neptune.errors.shared_snapshot_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SharedSnapshotQuotaExceededFault":
            raise capo_neptune.errors.shared_snapshot_quota_exceeded_fault.SharedSnapshotQuotaExceededFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_neptune.types.modify_db_cluster_snapshot_attribute_result.ModifyDBClusterSnapshotAttributeResult = capo_neptune.types.modify_db_cluster_snapshot_attribute_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.modify_db_cluster_snapshot_attribute_message.serialize_query(
        input_, pairs, ""
    )
