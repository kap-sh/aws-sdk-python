...
import capo_neptune.errors.db_parameter_group_already_exists_fault
import capo_neptune.errors.db_parameter_group_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBParameterGroupAlreadyExistsFault":
            raise capo_neptune.errors.db_parameter_group_already_exists_fault.DBParameterGroupAlreadyExistsFault.from_query(
                root
            )
        case "DBParameterGroupQuotaExceededFault":
            raise capo_neptune.errors.db_parameter_group_quota_exceeded_fault.DBParameterGroupQuotaExceededFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_neptune.types.create_db_parameter_group_result.CreateDBParameterGroupResult = capo_neptune.types.create_db_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.create_db_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
