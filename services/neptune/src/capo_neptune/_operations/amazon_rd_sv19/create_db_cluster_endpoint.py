"""Generated from Smithy shape ``com.amazonaws.neptune#CreateDBClusterEndpoint``."""
...
import capo_neptune.errors.db_cluster_endpoint_already_exists_fault
import capo_neptune.errors.db_cluster_endpoint_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBClusterEndpointAlreadyExistsFault":
            raise capo_neptune.errors.db_cluster_endpoint_already_exists_fault.DBClusterEndpointAlreadyExistsFault.from_query(
                root
            )
        case "DBClusterEndpointQuotaExceededFault":
            raise capo_neptune.errors.db_cluster_endpoint_quota_exceeded_fault.DBClusterEndpointQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_neptune.types.create_db_cluster_endpoint_output.CreateDBClusterEndpointOutput = capo_neptune.types.create_db_cluster_endpoint_output.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.create_db_cluster_endpoint_message.serialize_query(
        input_, pairs, ""
    )
