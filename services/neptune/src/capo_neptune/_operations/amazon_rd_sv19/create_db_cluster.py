...
import capo_neptune.errors.global_cluster_not_found_fault
...
import capo_neptune.errors.invalid_global_cluster_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "GlobalClusterNotFoundFault":
            raise capo_neptune.errors.global_cluster_not_found_fault.GlobalClusterNotFoundFault.from_query(
                root
            )
        ...
        case "InvalidGlobalClusterStateFault":
            raise capo_neptune.errors.invalid_global_cluster_state_fault.InvalidGlobalClusterStateFault.from_query(
                root
            )
        case "InvalidSubnet":
...
def handle_response(
    ...
    out: capo_neptune.types.create_db_cluster_result.CreateDBClusterResult = (
        capo_neptune.types.create_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.create_db_cluster_message.serialize_query(input_, pairs, "")
...
def create_db_cluster(
    ...
    capo_neptune.types.create_db_cluster_result.CreateDBClusterResult, zapros.Response
]:
