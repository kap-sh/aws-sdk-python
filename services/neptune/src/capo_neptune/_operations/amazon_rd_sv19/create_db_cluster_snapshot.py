"""Generated from Smithy shape ``com.amazonaws.neptune#CreateDBClusterSnapshot``."""
...
def handle_response(
    ...
    out: capo_neptune.types.create_db_cluster_snapshot_result.CreateDBClusterSnapshotResult = capo_neptune.types.create_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateDBClusterSnapshot"))
    pairs.append(("Version", "2014-10-31"))
    capo_neptune.types.create_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_db_cluster_snapshot(
