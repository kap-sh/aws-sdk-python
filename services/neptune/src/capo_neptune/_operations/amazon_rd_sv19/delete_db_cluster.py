...
import capo_neptune.errors.snapshot_quota_exceeded_fault
...
def handle_response(
    ...
    out: capo_neptune.types.delete_db_cluster_result.DeleteDBClusterResult = (
        capo_neptune.types.delete_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.delete_db_cluster_message.serialize_query(input_, pairs, "")
...
def delete_db_cluster(
    ...
    capo_neptune.types.delete_db_cluster_result.DeleteDBClusterResult, zapros.Response
]:
