"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteEventSubscription``."""
...
import capo_neptune.errors.invalid_event_subscription_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidEventSubscriptionStateFault":
            raise capo_neptune.errors.invalid_event_subscription_state_fault.InvalidEventSubscriptionStateFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_neptune.types.delete_event_subscription_result.DeleteEventSubscriptionResult = capo_neptune.types.delete_event_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.delete_event_subscription_message.serialize_query(
        input_, pairs, ""
    )
