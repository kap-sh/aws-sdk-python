"""Generated from Smithy shape ``com.amazonaws.neptune#SharedSnapshotQuotaExceededFault``."""
...
class SharedSnapshotQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#SharedSnapshotQuotaExceededFault``."""
