"""Generated from Smithy shape ``com.amazonaws.neptune#SubscriptionCategoryNotFoundFault``."""
...
class SubscriptionCategoryNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#SubscriptionCategoryNotFoundFault``."""

    code: str | None = "SubscriptionCategoryNotFoundFault"

    def __init__(self, data: SubscriptionCategoryNotFoundFault_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_query(cls, el: Element) -> "SubscriptionCategoryNotFoundFault":
