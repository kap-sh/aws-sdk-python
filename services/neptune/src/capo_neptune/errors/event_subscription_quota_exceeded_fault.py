"""Generated from Smithy shape ``com.amazonaws.neptune#EventSubscriptionQuotaExceededFault``."""
...
class EventSubscriptionQuotaExceededFault_(TypedDict, closed=True):
...
class EventSubscriptionQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#EventSubscriptionQuotaExceededFault``."""
