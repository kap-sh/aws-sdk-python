"""Generated from Smithy shape ``com.amazonaws.neptune#SubscriptionAlreadyExistFault``."""
...
class SubscriptionAlreadyExistFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#SubscriptionAlreadyExistFault``."""
