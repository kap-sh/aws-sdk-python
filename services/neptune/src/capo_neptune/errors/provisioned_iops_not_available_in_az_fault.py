"""Generated from Smithy shape ``com.amazonaws.neptune#ProvisionedIopsNotAvailableInAZFault``."""
...
class ProvisionedIopsNotAvailableInAZFault_(TypedDict, closed=True):
...
class ProvisionedIopsNotAvailableInAZFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#ProvisionedIopsNotAvailableInAZFault``."""
