"""Generated from Smithy shape ``com.amazonaws.neptune#InvalidDBSecurityGroupStateFault``."""
...
class InvalidDBSecurityGroupStateFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#InvalidDBSecurityGroupStateFault``."""
