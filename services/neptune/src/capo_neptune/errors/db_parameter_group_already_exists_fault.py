"""Generated from Smithy shape ``com.amazonaws.neptune#DBParameterGroupAlreadyExistsFault``."""
...
class DBParameterGroupAlreadyExistsFault_(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DBParameterGroupAlreadyExistsFault_,
...
def deserialize_query(el: Element) -> DBParameterGroupAlreadyExistsFault_:
    out: DBParameterGroupAlreadyExistsFault_ = {}  # type: ignore[typeddict-item]
...
class DBParameterGroupAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#DBParameterGroupAlreadyExistsFault``."""
