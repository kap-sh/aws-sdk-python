"""Generated from Smithy shape ``com.amazonaws.neptune#InvalidDBParameterGroupStateFault``."""
...
class InvalidDBParameterGroupStateFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#InvalidDBParameterGroupStateFault``."""
