"""Generated from Smithy shape ``com.amazonaws.neptune#InvalidEventSubscriptionStateFault``."""
...
class InvalidEventSubscriptionStateFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#InvalidEventSubscriptionStateFault``."""
