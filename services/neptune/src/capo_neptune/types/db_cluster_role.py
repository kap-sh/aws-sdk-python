"""Generated from Smithy shape ``com.amazonaws.neptune#DBClusterRole``."""
...
class DBClusterRole(TypedDict, closed=True):
    ...
    """<p>The name of the feature associated with the Amazon Identity and Access Management (IAM) role. For the list of supported feature names, see <a>DescribeDBEngineVersions</a>. </p>"""
