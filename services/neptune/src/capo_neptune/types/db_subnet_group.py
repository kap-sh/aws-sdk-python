...
if TYPE_CHECKING:
    ...
    import capo_neptune.types.subnet_list


class DBSubnetGroup(TypedDict, closed=True):
    db_subnet_group_name: NotRequired["capo_neptune.types.string.String"]
    """<p>The name of the DB subnet group.</p>"""
    db_subnet_group_description: NotRequired["capo_neptune.types.string.String"]
    """<p>Provides the description of the DB subnet group.</p>"""
    vpc_id: NotRequired["capo_neptune.types.string.String"]
    """<p>Provides the VpcId of the DB subnet group.</p>"""
    subnet_group_status: NotRequired["capo_neptune.types.string.String"]
    """<p>Provides the status of the DB subnet group.</p>"""
    subnets: NotRequired["capo_neptune.types.subnet_list.SubnetList"]
    """<p> Contains a list of <a>Subnet</a> elements.</p>"""
    db_subnet_group_arn: NotRequired["capo_neptune.types.string.String"]
...
def serialize_query(
    ...
    if "subnets" in value:
        ...
        capo_neptune.types.subnet_list.serialize_query(
...
def deserialize_query(el: Element) -> DBSubnetGroup:
    ...
    if child_subnets is not None:
        ...
        out["subnets"] = capo_neptune.types.subnet_list.deserialize_query(child_subnets)
