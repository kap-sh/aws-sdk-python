...
class Event(TypedDict, closed=True):
    ...
    date: NotRequired["capo_neptune.types.t_stamp.TStamp"]
    """<p>Specifies the date and time of the event.</p>"""
    source_arn: NotRequired["capo_neptune.types.string.String"]
...
def deserialize_query(el: Element) -> Event:
    ...
    if child_date is not None:
        ...
        out["date"] = capo_neptune.types.t_stamp.deserialize_query(child_date)
