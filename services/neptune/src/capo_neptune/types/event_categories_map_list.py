...
if TYPE_CHECKING:
    import capo_neptune.types.event_categories_map
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        capo_neptune.types.event_categories_map.serialize_query(
...
def deserialize_query(el: Element) -> EventCategoriesMapList:
    ...
    for child in el.findall("EventCategoriesMap"):
        out.append(capo_neptune.types.event_categories_map.deserialize_query(child))
    return out
