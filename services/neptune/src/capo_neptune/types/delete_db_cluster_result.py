"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteDBClusterResult``."""
...
class DeleteDBClusterResult(TypedDict, closed=True):
    db_cluster: NotRequired["capo_neptune.types.db_cluster.DBCluster"]


# --- awsQuery ser/de ---
def serialize_query(
    value: DeleteDBClusterResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DeleteDBClusterResult:
    out: DeleteDBClusterResult = {}  # type: ignore[typeddict-item]
