"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteDBClusterEndpointOutput``."""
...
class DeleteDBClusterEndpointOutput(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DeleteDBClusterEndpointOutput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DeleteDBClusterEndpointOutput:
    out: DeleteDBClusterEndpointOutput = {}  # type: ignore[typeddict-item]
