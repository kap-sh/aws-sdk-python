...
Range = TypedDict(
    "Range",
    {
        "from": NotRequired["capo_neptune.types.integer.Integer"],
        "to": NotRequired["capo_neptune.types.integer.Integer"],
        "step": NotRequired["capo_neptune.types.integer_optional.IntegerOptional"],
    },
    closed=True,
)
