...
if TYPE_CHECKING:
    import capo_neptune.types.db_parameter_group_list
...
class DBParameterGroupsMessage(TypedDict, closed=True):
    ...
    db_parameter_groups: NotRequired[
        "capo_neptune.types.db_parameter_group_list.DBParameterGroupList"
    ]
...
def serialize_query(
    ...
    if "db_parameter_groups" in value:
        ...
        capo_neptune.types.db_parameter_group_list.serialize_query(
...
def deserialize_query(el: Element) -> DBParameterGroupsMessage:
    ...
    if child_db_parameter_groups is not None:
        ...
        out["db_parameter_groups"] = (
            capo_neptune.types.db_parameter_group_list.deserialize_query(
