...
if TYPE_CHECKING:
    import capo_neptune.types.double_range_list
    import capo_neptune.types.range_list
...
class ValidStorageOptions(TypedDict, closed=True):
    ...
    storage_size: NotRequired["capo_neptune.types.range_list.RangeList"]
    """<p>Not applicable. In Neptune the storage type is managed at the DB Cluster level.</p>"""
    provisioned_iops: NotRequired["capo_neptune.types.range_list.RangeList"]
    """<p>Not applicable. In Neptune the storage type is managed at the DB Cluster level.</p>"""
    iops_to_storage_ratio: NotRequired[
        "capo_neptune.types.double_range_list.DoubleRangeList"
    ]
    """<p>Not applicable. In Neptune the storage type is managed at the DB Cluster level.</p>"""
...
def serialize_query(
    ...
    if "storage_size" in value:
        ...
        capo_neptune.types.range_list.serialize_query(
    ...
    if "iops_to_storage_ratio" in value:
        ...
        capo_neptune.types.double_range_list.serialize_query(
...
def deserialize_query(el: Element) -> ValidStorageOptions:
    ...
    if child_storage_size is not None:
        ...
        out["storage_size"] = capo_neptune.types.range_list.deserialize_query(
            child_storage_size
        )
    ...
    if child_provisioned_iops is not None:
        ...
        out["provisioned_iops"] = capo_neptune.types.range_list.deserialize_query(
    ...
    if child_iops_to_storage_ratio is not None:
        ...
        out["iops_to_storage_ratio"] = (
            capo_neptune.types.double_range_list.deserialize_query(
