...
if TYPE_CHECKING:
    import capo_neptune.types.db_parameter_group_status

DBParameterGroupStatusList: TypeAlias = list[
    "capo_neptune.types.db_parameter_group_status.DBParameterGroupStatus"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        capo_neptune.types.db_parameter_group_status.serialize_query(
...
def deserialize_query(el: Element) -> DBParameterGroupStatusList:
    ...
    for child in el.findall("DBParameterGroup"):
        out.append(
            capo_neptune.types.db_parameter_group_status.deserialize_query(child)
        )
    return out
