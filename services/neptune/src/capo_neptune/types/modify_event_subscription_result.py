"""Generated from Smithy shape ``com.amazonaws.neptune#ModifyEventSubscriptionResult``."""
...
class ModifyEventSubscriptionResult(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> ModifyEventSubscriptionResult:
    out: ModifyEventSubscriptionResult = {}  # type: ignore[typeddict-item]
