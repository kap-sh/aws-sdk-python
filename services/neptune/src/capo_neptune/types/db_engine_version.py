...
class DBEngineVersion(TypedDict, closed=True):
    ...
    db_engine_description: NotRequired["capo_neptune.types.string.String"]
    """<p>The description of the database engine.</p>"""
    db_engine_version_description: NotRequired["capo_neptune.types.string.String"]
    """<p>The description of the database engine version.</p>"""
    default_character_set: NotRequired["capo_neptune.types.character_set.CharacterSet"]
    """<p> <i>(Not supported by Neptune)</i> </p>"""
    supported_character_sets: NotRequired[
        "capo_neptune.types.supported_character_sets_list.SupportedCharacterSetsList"
    ]
    """<p> <i>(Not supported by Neptune)</i> </p>"""
    valid_upgrade_target: NotRequired[
        "capo_neptune.types.valid_upgrade_target_list.ValidUpgradeTargetList"
    ]
    """<p>A list of engine versions that this database engine version can be upgraded to.</p>"""
    supported_timezones: NotRequired[
        "capo_neptune.types.supported_timezones_list.SupportedTimezonesList"
    ]
    ...
    exportable_log_types: NotRequired["capo_neptune.types.log_type_list.LogTypeList"]
    ...
    supports_read_replica: NotRequired["capo_neptune.types.boolean.Boolean"]
...
def deserialize_query(el: Element) -> DBEngineVersion:
    ...
    if child_default_character_set is not None:
        ...
        out["default_character_set"] = (
            capo_neptune.types.character_set.deserialize_query(
    ...
    if child_supported_character_sets is not None:
        ...
        out["supported_character_sets"] = (
            capo_neptune.types.supported_character_sets_list.deserialize_query(
    ...
    if child_valid_upgrade_target is not None:
        ...
        out["valid_upgrade_target"] = (
            capo_neptune.types.valid_upgrade_target_list.deserialize_query(
    ...
    if child_supported_timezones is not None:
        ...
        out["supported_timezones"] = (
            capo_neptune.types.supported_timezones_list.deserialize_query(
