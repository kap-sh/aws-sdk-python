"""Generated from Smithy shape ``com.amazonaws.neptune#ModifyDBClusterResult``."""
...
class ModifyDBClusterResult(TypedDict, closed=True):
    db_cluster: NotRequired["capo_neptune.types.db_cluster.DBCluster"]


# --- awsQuery ser/de ---
def serialize_query(
    value: ModifyDBClusterResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ModifyDBClusterResult:
    out: ModifyDBClusterResult = {}  # type: ignore[typeddict-item]
