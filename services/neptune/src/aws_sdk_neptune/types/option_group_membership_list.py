...
if TYPE_CHECKING:
    import aws_sdk_neptune.types.option_group_membership

OptionGroupMembershipList: TypeAlias = list[
    "aws_sdk_neptune.types.option_group_membership.OptionGroupMembership"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_neptune.types.option_group_membership.serialize_query(
...
def deserialize_query(el: Element) -> OptionGroupMembershipList:
    ...
    for child in el.findall("OptionGroupMembership"):
        out.append(
            aws_sdk_neptune.types.option_group_membership.deserialize_query(child)
        )
    return out
