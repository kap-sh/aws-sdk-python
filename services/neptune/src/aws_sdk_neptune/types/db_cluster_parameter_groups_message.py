...
if TYPE_CHECKING:
    import aws_sdk_neptune.types.db_cluster_parameter_group_list
...
class DBClusterParameterGroupsMessage(TypedDict):
    ...
    db_cluster_parameter_groups: NotRequired[
        "aws_sdk_neptune.types.db_cluster_parameter_group_list.DBClusterParameterGroupList"
    ]
...
def serialize_query(
    ...
    if "db_cluster_parameter_groups" in value:
        ...
        aws_sdk_neptune.types.db_cluster_parameter_group_list.serialize_query(
...
def deserialize_query(el: Element) -> DBClusterParameterGroupsMessage:
    ...
    if child_db_cluster_parameter_groups is not None:
        ...
        out["db_cluster_parameter_groups"] = (
            aws_sdk_neptune.types.db_cluster_parameter_group_list.deserialize_query(
