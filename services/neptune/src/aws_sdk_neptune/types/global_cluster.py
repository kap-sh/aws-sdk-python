...
if TYPE_CHECKING:
    ...
    import aws_sdk_neptune.types.failover_state
    import aws_sdk_neptune.types.global_cluster_identifier
    import aws_sdk_neptune.types.global_cluster_member_list
...
class GlobalCluster(TypedDict):
    ...
    global_cluster_resource_id: NotRequired["aws_sdk_neptune.types.string.String"]
    ...
    global_cluster_arn: NotRequired["aws_sdk_neptune.types.string.String"]
    ...
    global_cluster_members: NotRequired[
        "aws_sdk_neptune.types.global_cluster_member_list.GlobalClusterMemberList"
    ]
    """<p>A list of cluster ARNs and instance ARNs for all the DB clusters that are part of the global database.</p>"""
    failover_state: NotRequired["aws_sdk_neptune.types.failover_state.FailoverState"]
...
def serialize_query(
    ...
    if "global_cluster_members" in value:
        ...
        aws_sdk_neptune.types.global_cluster_member_list.serialize_query(
            value["global_cluster_members"], pairs, f"{prefix}.GlobalClusterMembers"
        )
    if "failover_state" in value:
        import aws_sdk_neptune.types.failover_state

        aws_sdk_neptune.types.failover_state.serialize_query(
...
def deserialize_query(el: Element) -> GlobalCluster:
    ...
    if child_global_cluster_members is not None:
        ...
        out["global_cluster_members"] = (
            aws_sdk_neptune.types.global_cluster_member_list.deserialize_query(
    ...
    if child_failover_state is not None:
        ...
        out["failover_state"] = aws_sdk_neptune.types.failover_state.deserialize_query(
