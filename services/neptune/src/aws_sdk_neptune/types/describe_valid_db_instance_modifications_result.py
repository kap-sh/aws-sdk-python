"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeValidDBInstanceModificationsResult``."""
...
if TYPE_CHECKING:
    import aws_sdk_neptune.types.valid_db_instance_modifications_message


class DescribeValidDBInstanceModificationsResult(TypedDict):
    valid_db_instance_modifications_message: NotRequired[
        "aws_sdk_neptune.types.valid_db_instance_modifications_message.ValidDBInstanceModificationsMessage"
    ]
...
def serialize_query(
    ...
    if "valid_db_instance_modifications_message" in value:
        ...
        aws_sdk_neptune.types.valid_db_instance_modifications_message.serialize_query(
...
def deserialize_query(el: Element) -> DescribeValidDBInstanceModificationsResult:
    ...
    if child_valid_db_instance_modifications_message is not None:
        ...
        out["valid_db_instance_modifications_message"] = (
            aws_sdk_neptune.types.valid_db_instance_modifications_message.deserialize_query(
