...
class DBClusterSnapshot(TypedDict):
    ...
    snapshot_create_time: NotRequired["aws_sdk_neptune.types.t_stamp.TStamp"]
    """<p>Provides the time when the snapshot was taken, in Universal Coordinated Time (UTC).</p>"""
    engine: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>Specifies the name of the database engine.</p>"""
    allocated_storage: NotRequired["aws_sdk_neptune.types.integer.Integer"]
    """<p>Specifies the allocated storage size in gibibytes (GiB).</p>"""
    status: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>Specifies the status of this DB cluster snapshot.</p>"""
    port: NotRequired["aws_sdk_neptune.types.integer.Integer"]
    ...
    snapshot_type: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>Provides the type of the DB cluster snapshot.</p>"""
    percent_progress: NotRequired["aws_sdk_neptune.types.integer.Integer"]
    ...
    db_cluster_snapshot_arn: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>The Amazon Resource Name (ARN) for the DB cluster snapshot.</p>"""
    source_db_cluster_snapshot_arn: NotRequired["aws_sdk_neptune.types.string.String"]
...
def deserialize_query(el: Element) -> DBClusterSnapshot:
    ...
    if child_snapshot_create_time is not None:
        ...
        out["snapshot_create_time"] = aws_sdk_neptune.types.t_stamp.deserialize_query(
