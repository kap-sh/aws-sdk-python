...
if TYPE_CHECKING:
    ...
    import aws_sdk_neptune.types.db_instance_status_info_list
    import aws_sdk_neptune.types.db_parameter_group_status_list
    import aws_sdk_neptune.types.db_security_group_membership_list
    import aws_sdk_neptune.types.db_subnet_group
    import aws_sdk_neptune.types.domain_membership_list
    import aws_sdk_neptune.types.endpoint
    ...
    import aws_sdk_neptune.types.option_group_membership_list
    import aws_sdk_neptune.types.pending_modified_values
    import aws_sdk_neptune.types.read_replica_db_cluster_identifier_list
    import aws_sdk_neptune.types.read_replica_db_instance_identifier_list
...
class DBInstance(TypedDict):
    ...
    db_instance_status: NotRequired["aws_sdk_neptune.types.string.String"]
    ...
    endpoint: NotRequired["aws_sdk_neptune.types.endpoint.Endpoint"]
    """<p>Specifies the connection endpoint.</p>"""
    allocated_storage: NotRequired["aws_sdk_neptune.types.integer.Integer"]
    """<p>Not supported by Neptune.</p>"""
    instance_create_time: NotRequired["aws_sdk_neptune.types.t_stamp.TStamp"]
    ...
    backup_retention_period: NotRequired["aws_sdk_neptune.types.integer.Integer"]
    """<p>Specifies the number of days for which automatic DB snapshots are retained.</p>"""
    db_security_groups: NotRequired[
        "aws_sdk_neptune.types.db_security_group_membership_list.DBSecurityGroupMembershipList"
    ]
    ...
    db_parameter_groups: NotRequired[
        "aws_sdk_neptune.types.db_parameter_group_status_list.DBParameterGroupStatusList"
    ]
    ...
    pending_modified_values: NotRequired[
        "aws_sdk_neptune.types.pending_modified_values.PendingModifiedValues"
    ]
    ...
    auto_minor_version_upgrade: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    ...
    read_replica_db_instance_identifiers: NotRequired[
        "aws_sdk_neptune.types.read_replica_db_instance_identifier_list.ReadReplicaDBInstanceIdentifierList"
    ]
    ...
    read_replica_db_cluster_identifiers: NotRequired[
        "aws_sdk_neptune.types.read_replica_db_cluster_identifier_list.ReadReplicaDBClusterIdentifierList"
    ]
    ...
    option_group_memberships: NotRequired[
        "aws_sdk_neptune.types.option_group_membership_list.OptionGroupMembershipList"
    ]
    """<p> <i>(Not supported by Neptune)</i> </p>"""
    character_set_name: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p> <i>(Not supported by Neptune)</i> </p>"""
    secondary_availability_zone: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>If present, specifies the name of the secondary Availability Zone for a DB instance with multi-AZ support.</p>"""
    publicly_accessible: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    ...
    status_infos: NotRequired[
        "aws_sdk_neptune.types.db_instance_status_info_list.DBInstanceStatusInfoList"
    ]
    ...
    db_instance_port: NotRequired["aws_sdk_neptune.types.integer.Integer"]
    ...
    """<p> Not supported: The encryption for DB instances is managed by the DB cluster.</p>"""
    dbi_resource_id: NotRequired["aws_sdk_neptune.types.string.String"]
    ...
    ca_certificate_identifier: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>The identifier of the CA certificate for this DB instance.</p>"""
    domain_memberships: NotRequired[
        "aws_sdk_neptune.types.domain_membership_list.DomainMembershipList"
    ]
    """<p>Not supported</p>"""
    copy_tags_to_snapshot: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    ...
    enhanced_monitoring_resource_arn: NotRequired["aws_sdk_neptune.types.string.String"]
    ...
    db_instance_arn: NotRequired["aws_sdk_neptune.types.string.String"]
...
def serialize_query(
    ...
    if "endpoint" in value:
        ...
        aws_sdk_neptune.types.endpoint.serialize_query(
    ...
    if "db_security_groups" in value:
        ...
        aws_sdk_neptune.types.db_security_group_membership_list.serialize_query(
    ...
    if "db_parameter_groups" in value:
        ...
        aws_sdk_neptune.types.db_parameter_group_status_list.serialize_query(
    ...
    if "pending_modified_values" in value:
        ...
        aws_sdk_neptune.types.pending_modified_values.serialize_query(
    ...
    if "read_replica_db_instance_identifiers" in value:
        ...
        aws_sdk_neptune.types.read_replica_db_instance_identifier_list.serialize_query(
    ...
    if "read_replica_db_cluster_identifiers" in value:
        ...
        aws_sdk_neptune.types.read_replica_db_cluster_identifier_list.serialize_query(
    ...
    if "option_group_memberships" in value:
        ...
        aws_sdk_neptune.types.option_group_membership_list.serialize_query(
    ...
    if "status_infos" in value:
        ...
        aws_sdk_neptune.types.db_instance_status_info_list.serialize_query(
    ...
    if "domain_memberships" in value:
        ...
        aws_sdk_neptune.types.domain_membership_list.serialize_query(
...
def deserialize_query(el: Element) -> DBInstance:
    ...
    if child_endpoint is not None:
        ...
        out["endpoint"] = aws_sdk_neptune.types.endpoint.deserialize_query(
            child_endpoint
        )
    ...
    if child_instance_create_time is not None:
        ...
        out["instance_create_time"] = aws_sdk_neptune.types.t_stamp.deserialize_query(
    ...
    if child_db_security_groups is not None:
        ...
        out["db_security_groups"] = (
            aws_sdk_neptune.types.db_security_group_membership_list.deserialize_query(
    ...
    if child_db_parameter_groups is not None:
        ...
        out["db_parameter_groups"] = (
            aws_sdk_neptune.types.db_parameter_group_status_list.deserialize_query(
    ...
    if child_pending_modified_values is not None:
        ...
        out["pending_modified_values"] = (
            aws_sdk_neptune.types.pending_modified_values.deserialize_query(
    ...
    if child_read_replica_db_instance_identifiers is not None:
        ...
        out["read_replica_db_instance_identifiers"] = (
            aws_sdk_neptune.types.read_replica_db_instance_identifier_list.deserialize_query(
    ...
    if child_read_replica_db_cluster_identifiers is not None:
        ...
        out["read_replica_db_cluster_identifiers"] = (
            aws_sdk_neptune.types.read_replica_db_cluster_identifier_list.deserialize_query(
    ...
    if child_option_group_memberships is not None:
        ...
        out["option_group_memberships"] = (
            aws_sdk_neptune.types.option_group_membership_list.deserialize_query(
    ...
    if child_status_infos is not None:
        ...
        out["status_infos"] = (
            aws_sdk_neptune.types.db_instance_status_info_list.deserialize_query(
                child_status_infos
            )
        )
    ...
    if child_domain_memberships is not None:
        ...
        out["domain_memberships"] = (
            aws_sdk_neptune.types.domain_membership_list.deserialize_query(
