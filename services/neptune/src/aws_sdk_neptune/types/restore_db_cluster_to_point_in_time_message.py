...
class RestoreDBClusterToPointInTimeMessage(TypedDict, closed=True):
    ...
    restore_type: NotRequired["aws_sdk_neptune.types.string.String"]
    ...
    restore_to_time: NotRequired["aws_sdk_neptune.types.t_stamp.TStamp"]
    ...
    use_latest_restorable_time: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
...
def deserialize_query(el: Element) -> RestoreDBClusterToPointInTimeMessage:
    ...
    if child_restore_to_time is not None:
        ...
        out["restore_to_time"] = aws_sdk_neptune.types.t_stamp.deserialize_query(
