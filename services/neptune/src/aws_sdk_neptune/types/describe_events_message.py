...
class DescribeEventsMessage(TypedDict):
    ...
    start_time: NotRequired["aws_sdk_neptune.types.t_stamp.TStamp"]
    ...
    end_time: NotRequired["aws_sdk_neptune.types.t_stamp.TStamp"]
    ...
    duration: NotRequired["aws_sdk_neptune.types.integer_optional.IntegerOptional"]
...
def deserialize_query(el: Element) -> DescribeEventsMessage:
    ...
    if child_start_time is not None:
        ...
        out["start_time"] = aws_sdk_neptune.types.t_stamp.deserialize_query(
            child_start_time
        )
    ...
    if child_end_time is not None:
        ...
        out["end_time"] = aws_sdk_neptune.types.t_stamp.deserialize_query(
            child_end_time
        )
