"""Generated from Smithy shape ``com.amazonaws.neptune#ValidUpgradeTargetList``."""
...
if TYPE_CHECKING:
    import aws_sdk_neptune.types.upgrade_target

ValidUpgradeTargetList: TypeAlias = list[
    "aws_sdk_neptune.types.upgrade_target.UpgradeTarget"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_neptune.types.upgrade_target.serialize_query(
...
def deserialize_query(el: Element) -> ValidUpgradeTargetList:
    ...
    for child in el.findall("UpgradeTarget"):
        out.append(aws_sdk_neptune.types.upgrade_target.deserialize_query(child))
    return out
