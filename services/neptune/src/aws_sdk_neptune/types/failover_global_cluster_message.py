...
class FailoverGlobalClusterMessage(TypedDict):
    ...
    target_db_cluster_identifier: NotRequired["aws_sdk_neptune.types.string.String"]
    ...
    switchover: NotRequired["aws_sdk_neptune.types.boolean_optional.BooleanOptional"]
