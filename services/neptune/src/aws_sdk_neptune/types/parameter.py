...
if TYPE_CHECKING:
    import aws_sdk_neptune.types.apply_method
    import aws_sdk_neptune.types.boolean
    import aws_sdk_neptune.types.string


class Parameter(TypedDict):
    parameter_name: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>Specifies the name of the parameter.</p>"""
    parameter_value: NotRequired["aws_sdk_neptune.types.string.String"]
    ...
    apply_type: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>Specifies the engine specific parameters type.</p>"""
    data_type: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>Specifies the valid data type for the parameter.</p>"""
    allowed_values: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>Specifies the valid range of values for the parameter.</p>"""
    is_modifiable: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    ...
    minimum_engine_version: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>The earliest engine version to which the parameter can apply.</p>"""
    apply_method: NotRequired["aws_sdk_neptune.types.apply_method.ApplyMethod"]
...
def serialize_query(
    ...
    if "apply_method" in value:
        ...
        aws_sdk_neptune.types.apply_method.serialize_query(
...
def deserialize_query(el: Element) -> Parameter:
    ...
    if child_apply_method is not None:
        ...
        out["apply_method"] = aws_sdk_neptune.types.apply_method.deserialize_query(
            child_apply_method
        )
    return out
