...
class DBClusterMessage(TypedDict, closed=True):
    ...
    db_clusters: NotRequired["aws_sdk_neptune.types.db_cluster_list.DBClusterList"]
...
def serialize_query(
    ...
    if "db_clusters" in value:
        ...
        aws_sdk_neptune.types.db_cluster_list.serialize_query(
...
def deserialize_query(el: Element) -> DBClusterMessage:
    ...
    if child_db_clusters is not None:
        ...
        out["db_clusters"] = aws_sdk_neptune.types.db_cluster_list.deserialize_query(
            child_db_clusters
        )
    return out
