...
class EventSubscription(TypedDict):
    customer_aws_id: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>The Amazon customer account associated with the event notification subscription.</p>"""
    cust_subscription_id: NotRequired["aws_sdk_neptune.types.string.String"]
    ...
    source_ids_list: NotRequired["aws_sdk_neptune.types.source_ids_list.SourceIdsList"]
    ...
    enabled: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    """<p>A Boolean value indicating if the subscription is enabled. True indicates the subscription is enabled.</p>"""
    event_subscription_arn: NotRequired["aws_sdk_neptune.types.string.String"]
...
def deserialize_query(el: Element) -> EventSubscription:
    ...
    if child_source_ids_list is not None:
        ...
        out["source_ids_list"] = (
            aws_sdk_neptune.types.source_ids_list.deserialize_query(
