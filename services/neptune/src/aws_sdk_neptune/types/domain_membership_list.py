...
if TYPE_CHECKING:
    import aws_sdk_neptune.types.domain_membership

DomainMembershipList: TypeAlias = list[
    "aws_sdk_neptune.types.domain_membership.DomainMembership"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_neptune.types.domain_membership.serialize_query(
...
def deserialize_query(el: Element) -> DomainMembershipList:
    ...
    for child in el.findall("DomainMembership"):
        out.append(aws_sdk_neptune.types.domain_membership.deserialize_query(child))
    return out
