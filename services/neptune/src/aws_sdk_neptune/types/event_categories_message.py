"""Generated from Smithy shape ``com.amazonaws.neptune#EventCategoriesMessage``."""
...
class EventCategoriesMessage(TypedDict):
    event_categories_map_list: NotRequired[
        "aws_sdk_neptune.types.event_categories_map_list.EventCategoriesMapList"
    ]
...
def serialize_query(
    ...
    if "event_categories_map_list" in value:
        ...
        aws_sdk_neptune.types.event_categories_map_list.serialize_query(
...
def deserialize_query(el: Element) -> EventCategoriesMessage:
    ...
    if child_event_categories_map_list is not None:
        ...
        out["event_categories_map_list"] = (
            aws_sdk_neptune.types.event_categories_map_list.deserialize_query(
