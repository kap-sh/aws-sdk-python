...
class GlobalClustersMessage(TypedDict):
    ...
    global_clusters: NotRequired[
        "aws_sdk_neptune.types.global_cluster_list.GlobalClusterList"
    ]
...
def serialize_query(
    ...
    if "global_clusters" in value:
        ...
        aws_sdk_neptune.types.global_cluster_list.serialize_query(
...
def deserialize_query(el: Element) -> GlobalClustersMessage:
    ...
    if child_global_clusters is not None:
        ...
        out["global_clusters"] = (
            aws_sdk_neptune.types.global_cluster_list.deserialize_query(
