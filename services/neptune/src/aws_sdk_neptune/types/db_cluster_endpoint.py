"""Generated from Smithy shape ``com.amazonaws.neptune#DBClusterEndpoint``."""
...
class DBClusterEndpoint(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> DBClusterEndpoint:
    out: DBClusterEndpoint = {}  # type: ignore[typeddict-item]
