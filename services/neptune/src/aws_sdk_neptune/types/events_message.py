...
if TYPE_CHECKING:
    import aws_sdk_neptune.types.event_list
...
class EventsMessage(TypedDict):
    ...
    events: NotRequired["aws_sdk_neptune.types.event_list.EventList"]
...
def serialize_query(
    ...
    if "events" in value:
        ...
        aws_sdk_neptune.types.event_list.serialize_query(
...
def deserialize_query(el: Element) -> EventsMessage:
    ...
    if child_events is not None:
        ...
        out["events"] = aws_sdk_neptune.types.event_list.deserialize_query(child_events)
    return out
