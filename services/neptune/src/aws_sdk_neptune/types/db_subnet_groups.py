...
DBSubnetGroups: TypeAlias = list["aws_sdk_neptune.types.db_subnet_group.DBSubnetGroup"]
...
def deserialize_query(el: Element) -> DBSubnetGroups:
    ...
    for child in el.findall("DBSubnetGroup"):
        out.append(aws_sdk_neptune.types.db_subnet_group.deserialize_query(child))
    return out
