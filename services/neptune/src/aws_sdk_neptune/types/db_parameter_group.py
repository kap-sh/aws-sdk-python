"""Generated from Smithy shape ``com.amazonaws.neptune#DBParameterGroup``."""
...
class DBParameterGroup(TypedDict, closed=True):
    ...
    db_parameter_group_arn: NotRequired["aws_sdk_neptune.types.string.String"]
