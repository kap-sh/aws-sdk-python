"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeOrderableDBInstanceOptionsMessage``."""
...
class DescribeOrderableDBInstanceOptionsMessage(TypedDict, closed=True):
    ...
    vpc: NotRequired["aws_sdk_neptune.types.boolean_optional.BooleanOptional"]
