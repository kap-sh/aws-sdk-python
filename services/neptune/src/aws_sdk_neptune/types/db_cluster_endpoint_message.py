"""Generated from Smithy shape ``com.amazonaws.neptune#DBClusterEndpointMessage``."""
...
if TYPE_CHECKING:
    import aws_sdk_neptune.types.db_cluster_endpoint_list
    import aws_sdk_neptune.types.string


class DBClusterEndpointMessage(TypedDict):
    ...
    db_cluster_endpoints: NotRequired[
        "aws_sdk_neptune.types.db_cluster_endpoint_list.DBClusterEndpointList"
    ]
...
def serialize_query(
    ...
    if "db_cluster_endpoints" in value:
        ...
        aws_sdk_neptune.types.db_cluster_endpoint_list.serialize_query(
...
def deserialize_query(el: Element) -> DBClusterEndpointMessage:
    ...
    if child_db_cluster_endpoints is not None:
        ...
        out["db_cluster_endpoints"] = (
            aws_sdk_neptune.types.db_cluster_endpoint_list.deserialize_query(
