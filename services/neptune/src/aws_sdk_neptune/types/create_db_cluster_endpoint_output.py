"""Generated from Smithy shape ``com.amazonaws.neptune#CreateDBClusterEndpointOutput``."""
...
class CreateDBClusterEndpointOutput(TypedDict, closed=True):
    ...
    custom_endpoint_type: NotRequired["aws_sdk_neptune.types.string.String"]
    ...
    db_cluster_endpoint_arn: NotRequired["aws_sdk_neptune.types.string.String"]
    """<p>The Amazon Resource Name (ARN) for the endpoint.</p>"""


# --- awsQuery ser/de ---
def serialize_query(
    value: CreateDBClusterEndpointOutput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> CreateDBClusterEndpointOutput:
    out: CreateDBClusterEndpointOutput = {}  # type: ignore[typeddict-item]
