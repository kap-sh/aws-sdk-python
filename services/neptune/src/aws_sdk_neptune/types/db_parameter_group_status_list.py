"""Generated from Smithy shape ``com.amazonaws.neptune#DBParameterGroupStatusList``."""
...
if TYPE_CHECKING:
    import aws_sdk_neptune.types.db_parameter_group_status

DBParameterGroupStatusList: TypeAlias = list[
    "aws_sdk_neptune.types.db_parameter_group_status.DBParameterGroupStatus"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_neptune.types.db_parameter_group_status.serialize_query(
...
def deserialize_query(el: Element) -> DBParameterGroupStatusList:
    ...
    for child in el.findall("DBParameterGroup"):
        out.append(
            aws_sdk_neptune.types.db_parameter_group_status.deserialize_query(child)
        )
    return out
