...
if TYPE_CHECKING:
    import aws_sdk_neptune.types.availability_zone_list
...
class OrderableDBInstanceOption(TypedDict):
    ...
    availability_zones: NotRequired[
        "aws_sdk_neptune.types.availability_zone_list.AvailabilityZoneList"
    ]
    """<p>A list of Availability Zones for a DB instance.</p>"""
    multi_az_capable: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    """<p>Indicates whether a DB instance is Multi-AZ capable.</p>"""
    read_replica_capable: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    """<p>Indicates whether a DB instance can have a Read Replica.</p>"""
    vpc: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    """<p>Indicates whether a DB instance is in a VPC.</p>"""
    supports_storage_encryption: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    ...
    supports_iops: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    """<p>Indicates whether a DB instance supports provisioned IOPS.</p>"""
    supports_enhanced_monitoring: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    ...
    supports_performance_insights: NotRequired["aws_sdk_neptune.types.boolean.Boolean"]
    """<p> <i>(Not supported by Neptune)</i> </p>"""
    min_storage_size: NotRequired[
        "aws_sdk_neptune.types.integer_optional.IntegerOptional"
    ]
    """<p>Minimum storage size for a DB instance.</p>"""
    max_storage_size: NotRequired[
        "aws_sdk_neptune.types.integer_optional.IntegerOptional"
    ]
    ...
    min_iops_per_gib: NotRequired[
        "aws_sdk_neptune.types.double_optional.DoubleOptional"
    ]
    """<p>Minimum provisioned IOPS per GiB for a DB instance.</p>"""
    max_iops_per_gib: NotRequired[
        "aws_sdk_neptune.types.double_optional.DoubleOptional"
    ]
...
def serialize_query(
    ...
    if "availability_zones" in value:
        ...
        aws_sdk_neptune.types.availability_zone_list.serialize_query(
...
def deserialize_query(el: Element) -> OrderableDBInstanceOption:
    ...
    if child_availability_zones is not None:
        ...
        out["availability_zones"] = (
            aws_sdk_neptune.types.availability_zone_list.deserialize_query(
