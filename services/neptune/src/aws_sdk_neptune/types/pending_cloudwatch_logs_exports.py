...
class PendingCloudwatchLogsExports(TypedDict, closed=True):
    log_types_to_enable: NotRequired["aws_sdk_neptune.types.log_type_list.LogTypeList"]
    ...
    log_types_to_disable: NotRequired["aws_sdk_neptune.types.log_type_list.LogTypeList"]
