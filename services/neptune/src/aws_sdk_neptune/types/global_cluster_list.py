...
GlobalClusterList: TypeAlias = list[
    "aws_sdk_neptune.types.global_cluster.GlobalCluster"
]
...
def deserialize_query(el: Element) -> GlobalClusterList:
    ...
    for child in el.findall("GlobalClusterMember"):
        out.append(aws_sdk_neptune.types.global_cluster.deserialize_query(child))
    return out
