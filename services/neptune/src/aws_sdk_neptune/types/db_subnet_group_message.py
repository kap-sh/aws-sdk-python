...
class DBSubnetGroupMessage(TypedDict):
    ...
    db_subnet_groups: NotRequired[
        "aws_sdk_neptune.types.db_subnet_groups.DBSubnetGroups"
    ]
...
def serialize_query(
    ...
    if "db_subnet_groups" in value:
        ...
        aws_sdk_neptune.types.db_subnet_groups.serialize_query(
...
def deserialize_query(el: Element) -> DBSubnetGroupMessage:
    ...
    if child_db_subnet_groups is not None:
        ...
        out["db_subnet_groups"] = (
            aws_sdk_neptune.types.db_subnet_groups.deserialize_query(
