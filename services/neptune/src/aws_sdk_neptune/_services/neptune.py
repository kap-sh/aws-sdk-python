...
from aws_sdk_neptune._services._aws_config import aws_config
...
class NeptuneClientConfig(TypedDict, total=False, closed=True):
...
class NeptuneClient:
    ...
    def __init__(
        ...
        self._config = NeptuneClientConfig(
            {
