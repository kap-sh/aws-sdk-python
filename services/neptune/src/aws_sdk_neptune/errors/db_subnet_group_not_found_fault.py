"""Generated from Smithy shape ``com.amazonaws.neptune#DBSubnetGroupNotFoundFault``."""
...
class DBSubnetGroupNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#DBSubnetGroupNotFoundFault``."""
