"""Generated from Smithy shape ``com.amazonaws.neptune#InvalidDBClusterEndpointStateFault``."""
...
class InvalidDBClusterEndpointStateFault_(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: InvalidDBClusterEndpointStateFault_,
...
def deserialize_query(el: Element) -> InvalidDBClusterEndpointStateFault_:
    out: InvalidDBClusterEndpointStateFault_ = {}  # type: ignore[typeddict-item]
...
class InvalidDBClusterEndpointStateFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#InvalidDBClusterEndpointStateFault``."""
