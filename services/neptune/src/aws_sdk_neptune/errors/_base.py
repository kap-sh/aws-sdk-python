...
class NeptuneError(Exception):
    """Base class for all Neptune service errors."""


class ServiceError(NeptuneError):
...
class DeserializationError(NeptuneError):
...
class WaiterFailedError(NeptuneError):
...
class WaiterTimeoutError(NeptuneError):
