"""Generated from Smithy shape ``com.amazonaws.neptune#DBSecurityGroupNotFoundFault``."""
...
class DBSecurityGroupNotFoundFault_(TypedDict):
...
class DBSecurityGroupNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#DBSecurityGroupNotFoundFault``."""
