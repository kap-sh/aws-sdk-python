"""Generated from Smithy shape ``com.amazonaws.neptune#DBClusterAlreadyExistsFault``."""
...
class DBClusterAlreadyExistsFault_(TypedDict):
...
class DBClusterAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#DBClusterAlreadyExistsFault``."""
