"""Generated from Smithy shape ``com.amazonaws.neptune#DBClusterSnapshotNotFoundFault``."""
...
class DBClusterSnapshotNotFoundFault_(TypedDict, closed=True):
...
class DBClusterSnapshotNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#DBClusterSnapshotNotFoundFault``."""
