"""Generated from Smithy shape ``com.amazonaws.neptune#InsufficientStorageClusterCapacityFault``."""
...
class InsufficientStorageClusterCapacityFault_(TypedDict):
...
class InsufficientStorageClusterCapacityFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#InsufficientStorageClusterCapacityFault``."""
