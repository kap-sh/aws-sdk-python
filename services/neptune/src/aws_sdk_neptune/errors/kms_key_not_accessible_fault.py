"""Generated from Smithy shape ``com.amazonaws.neptune#KMSKeyNotAccessibleFault``."""
...
class KMSKeyNotAccessibleFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#KMSKeyNotAccessibleFault``."""
