"""Generated from Smithy shape ``com.amazonaws.neptune#GlobalClusterAlreadyExistsFault``."""
...
class GlobalClusterAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#GlobalClusterAlreadyExistsFault``."""
