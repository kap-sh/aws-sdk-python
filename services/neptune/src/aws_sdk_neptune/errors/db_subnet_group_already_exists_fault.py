"""Generated from Smithy shape ``com.amazonaws.neptune#DBSubnetGroupAlreadyExistsFault``."""
...
class DBSubnetGroupAlreadyExistsFault_(TypedDict):
...
class DBSubnetGroupAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#DBSubnetGroupAlreadyExistsFault``."""
