"""Generated from Smithy shape ``com.amazonaws.neptune#StorageTypeNotSupportedFault``."""
...
class StorageTypeNotSupportedFault_(TypedDict):
...
class StorageTypeNotSupportedFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#StorageTypeNotSupportedFault``."""

    code: str | None = "StorageTypeNotSupportedFault"

    def __init__(self, data: StorageTypeNotSupportedFault_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_query(cls, el: Element) -> "StorageTypeNotSupportedFault":
