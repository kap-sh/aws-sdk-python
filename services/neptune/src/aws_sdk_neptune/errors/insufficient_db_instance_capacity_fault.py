"""Generated from Smithy shape ``com.amazonaws.neptune#InsufficientDBInstanceCapacityFault``."""
...
class InsufficientDBInstanceCapacityFault_(TypedDict):
...
class InsufficientDBInstanceCapacityFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#InsufficientDBInstanceCapacityFault``."""
