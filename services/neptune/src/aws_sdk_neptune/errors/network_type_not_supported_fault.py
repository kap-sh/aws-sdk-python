"""Generated from Smithy shape ``com.amazonaws.neptune#NetworkTypeNotSupportedFault``."""
...
class NetworkTypeNotSupportedFault_(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: NetworkTypeNotSupportedFault_, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "message" in value:
        pairs.append((f"{prefix}.message", str(value["message"])))


def deserialize_query(el: Element) -> NetworkTypeNotSupportedFault_:
    out: NetworkTypeNotSupportedFault_ = {}  # type: ignore[typeddict-item]
...
class NetworkTypeNotSupportedFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#NetworkTypeNotSupportedFault``."""
