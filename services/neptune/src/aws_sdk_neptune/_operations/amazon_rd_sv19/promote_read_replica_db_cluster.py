"""Generated from Smithy shape ``com.amazonaws.neptune#PromoteReadReplicaDBCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.promote_read_replica_db_cluster_result.PromoteReadReplicaDBClusterResult = aws_sdk_neptune.types.promote_read_replica_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.promote_read_replica_db_cluster_message.PromoteReadReplicaDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.promote_read_replica_db_cluster_message.serialize_query(
        input_, pairs, ""
    )
