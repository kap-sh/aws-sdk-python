...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBSubnetGroupAlreadyExistsFault":
            import aws_sdk_neptune.errors.db_subnet_group_already_exists_fault

            raise aws_sdk_neptune.errors.db_subnet_group_already_exists_fault.DBSubnetGroupAlreadyExistsFault.from_query(
                root
            )
        ...
        case "DBSubnetGroupQuotaExceededFault":
            import aws_sdk_neptune.errors.db_subnet_group_quota_exceeded_fault

            raise aws_sdk_neptune.errors.db_subnet_group_quota_exceeded_fault.DBSubnetGroupQuotaExceededFault.from_query(
                root
            )
        case "DBSubnetQuotaExceededFault":
            import aws_sdk_neptune.errors.db_subnet_quota_exceeded_fault

            raise aws_sdk_neptune.errors.db_subnet_quota_exceeded_fault.DBSubnetQuotaExceededFault.from_query(
                root
            )
        case "InvalidSubnet":
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.create_db_subnet_group_result.CreateDBSubnetGroupResult = aws_sdk_neptune.types.create_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.create_db_subnet_group_message.CreateDBSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.create_db_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
