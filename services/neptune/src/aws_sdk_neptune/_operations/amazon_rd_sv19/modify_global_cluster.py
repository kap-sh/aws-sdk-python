...
def handle_response(
    ...
    out: aws_sdk_neptune.types.modify_global_cluster_result.ModifyGlobalClusterResult = aws_sdk_neptune.types.modify_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.modify_global_cluster_message.ModifyGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
