...
def handle_response(
    ...
    out: aws_sdk_neptune.types.tag_list_message.TagListMessage = (
        aws_sdk_neptune.types.tag_list_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.list_tags_for_resource_message.ListTagsForResourceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_tags_for_resource(
    ...
    input_: aws_sdk_neptune.types.list_tags_for_resource_message.ListTagsForResourceMessage,
) -> tuple[aws_sdk_neptune.types.tag_list_message.TagListMessage, zapros.Response]:
