"""Generated from Smithy shape ``com.amazonaws.neptune#RemoveFromGlobalCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.remove_from_global_cluster_result.RemoveFromGlobalClusterResult = aws_sdk_neptune.types.remove_from_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.remove_from_global_cluster_message.RemoveFromGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.remove_from_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
