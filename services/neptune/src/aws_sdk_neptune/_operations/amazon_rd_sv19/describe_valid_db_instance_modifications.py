...
def handle_response(
    ...
    out: aws_sdk_neptune.types.describe_valid_db_instance_modifications_result.DescribeValidDBInstanceModificationsResult = aws_sdk_neptune.types.describe_valid_db_instance_modifications_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_valid_db_instance_modifications_message.DescribeValidDBInstanceModificationsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_valid_db_instance_modifications_message.serialize_query(
        input_, pairs, ""
    )
