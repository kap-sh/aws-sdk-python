...
def handle_response(
    ...
    out: aws_sdk_neptune.types.db_cluster_message.DBClusterMessage = (
        aws_sdk_neptune.types.db_cluster_message.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_neptune.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> zapros.Request:
    ...
    aws_sdk_neptune.types.describe_db_clusters_message.serialize_query(input, pairs, "")
...
def describe_db_clusters(
    ...
    input: aws_sdk_neptune.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> tuple[aws_sdk_neptune.types.db_cluster_message.DBClusterMessage, zapros.Response]:
