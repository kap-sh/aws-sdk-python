"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteGlobalCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.delete_global_cluster_result.DeleteGlobalClusterResult = aws_sdk_neptune.types.delete_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.delete_global_cluster_message.DeleteGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.delete_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
