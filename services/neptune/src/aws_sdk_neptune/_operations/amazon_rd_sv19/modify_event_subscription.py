...
def handle_response(
    ...
    out: aws_sdk_neptune.types.modify_event_subscription_result.ModifyEventSubscriptionResult = aws_sdk_neptune.types.modify_event_subscription_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.modify_event_subscription_message.ModifyEventSubscriptionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.modify_event_subscription_message.serialize_query(
        input_, pairs, ""
    )
