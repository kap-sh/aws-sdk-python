...
def handle_response(
    ...
    out: aws_sdk_neptune.types.delete_db_cluster_snapshot_result.DeleteDBClusterSnapshotResult = aws_sdk_neptune.types.delete_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.delete_db_cluster_snapshot_message.DeleteDBClusterSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.delete_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
