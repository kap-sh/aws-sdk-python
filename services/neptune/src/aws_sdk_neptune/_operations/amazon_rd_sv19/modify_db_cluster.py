...
def build_request(
    ...
    input: aws_sdk_neptune.types.modify_db_cluster_message.ModifyDBClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_neptune.types.modify_db_cluster_message.serialize_query(input, pairs, "")
