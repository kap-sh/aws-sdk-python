...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetAlreadyInUse":
            import aws_sdk_neptune.errors.subnet_already_in_use

            raise aws_sdk_neptune.errors.subnet_already_in_use.SubnetAlreadyInUse.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.modify_db_subnet_group_result.ModifyDBSubnetGroupResult = aws_sdk_neptune.types.modify_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.modify_db_subnet_group_message.ModifyDBSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.modify_db_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
