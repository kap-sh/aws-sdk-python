"""Generated from Smithy shape ``com.amazonaws.neptune#RebootDBInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.reboot_db_instance_result.RebootDBInstanceResult = (
        aws_sdk_neptune.types.reboot_db_instance_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.reboot_db_instance_message.RebootDBInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.reboot_db_instance_message.serialize_query(input_, pairs, "")
