"""Generated from Smithy shape ``com.amazonaws.neptune#CreateDBParameterGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.create_db_parameter_group_result.CreateDBParameterGroupResult = aws_sdk_neptune.types.create_db_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.create_db_parameter_group_message.CreateDBParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.create_db_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
