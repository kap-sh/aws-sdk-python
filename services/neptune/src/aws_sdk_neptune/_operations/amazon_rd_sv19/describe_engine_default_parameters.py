"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeEngineDefaultParameters``."""
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.describe_engine_default_parameters_result.DescribeEngineDefaultParametersResult = aws_sdk_neptune.types.describe_engine_default_parameters_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_engine_default_parameters_message.DescribeEngineDefaultParametersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_engine_default_parameters_message.serialize_query(
        input_, pairs, ""
    )
