...
import aws_sdk_neptune.errors.db_cluster_endpoint_already_exists_fault
import aws_sdk_neptune.errors.db_cluster_endpoint_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBClusterEndpointAlreadyExistsFault":
            raise aws_sdk_neptune.errors.db_cluster_endpoint_already_exists_fault.DBClusterEndpointAlreadyExistsFault.from_query(
                root
            )
        case "DBClusterEndpointQuotaExceededFault":
            raise aws_sdk_neptune.errors.db_cluster_endpoint_quota_exceeded_fault.DBClusterEndpointQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.create_db_cluster_endpoint_output.CreateDBClusterEndpointOutput = aws_sdk_neptune.types.create_db_cluster_endpoint_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.create_db_cluster_endpoint_message.CreateDBClusterEndpointMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.create_db_cluster_endpoint_message.serialize_query(
        input_, pairs, ""
    )
