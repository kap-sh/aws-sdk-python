...
def handle_response(
    ...
    out: aws_sdk_neptune.types.db_cluster_snapshot_message.DBClusterSnapshotMessage = (
        aws_sdk_neptune.types.db_cluster_snapshot_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_db_cluster_snapshots_message.DescribeDBClusterSnapshotsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_db_cluster_snapshots_message.serialize_query(
        input_, pairs, ""
    )
