...
def handle_response(
    ...
    out: aws_sdk_neptune.types.add_source_identifier_to_subscription_result.AddSourceIdentifierToSubscriptionResult = aws_sdk_neptune.types.add_source_identifier_to_subscription_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.add_source_identifier_to_subscription_message.AddSourceIdentifierToSubscriptionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.add_source_identifier_to_subscription_message.serialize_query(
        input_, pairs, ""
    )
