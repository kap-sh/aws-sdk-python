"""Generated from Smithy shape ``com.amazonaws.neptune#RemoveTagsFromResource``."""
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.remove_tags_from_resource_message.RemoveTagsFromResourceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.remove_tags_from_resource_message.serialize_query(
        input_, pairs, ""
    )
