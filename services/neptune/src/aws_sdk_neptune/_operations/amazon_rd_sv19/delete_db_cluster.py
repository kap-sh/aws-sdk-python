...
def build_request(
    ...
    input: aws_sdk_neptune.types.delete_db_cluster_message.DeleteDBClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_neptune.types.delete_db_cluster_message.serialize_query(input, pairs, "")
