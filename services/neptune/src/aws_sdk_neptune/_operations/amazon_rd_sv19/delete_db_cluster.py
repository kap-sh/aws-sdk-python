"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteDBCluster``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBClusterSnapshotAlreadyExistsFault":
            import aws_sdk_neptune.errors.db_cluster_snapshot_already_exists_fault

            raise aws_sdk_neptune.errors.db_cluster_snapshot_already_exists_fault.DBClusterSnapshotAlreadyExistsFault.from_query(
                root
            )
        ...
        case "SnapshotQuotaExceededFault":
            import aws_sdk_neptune.errors.snapshot_quota_exceeded_fault

            raise aws_sdk_neptune.errors.snapshot_quota_exceeded_fault.SnapshotQuotaExceededFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteDBClusterResult")
    out: aws_sdk_neptune.types.delete_db_cluster_result.DeleteDBClusterResult = (
        aws_sdk_neptune.types.delete_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.delete_db_cluster_message.DeleteDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteDBCluster"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_neptune.types.delete_db_cluster_message

    aws_sdk_neptune.types.delete_db_cluster_message.serialize_query(input_, pairs, "")
