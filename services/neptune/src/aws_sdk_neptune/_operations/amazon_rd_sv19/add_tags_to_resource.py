"""Generated from Smithy shape ``com.amazonaws.neptune#AddTagsToResource``."""
...
def build_request(
    ...
    input: aws_sdk_neptune.types.add_tags_to_resource_message.AddTagsToResourceMessage,
) -> zapros.Request:
    ...
    aws_sdk_neptune.types.add_tags_to_resource_message.serialize_query(input, pairs, "")
