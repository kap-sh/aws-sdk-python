"""Generated from Smithy shape ``com.amazonaws.neptune#DescribePendingMaintenanceActions``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceNotFoundFault":
            import aws_sdk_neptune.errors.resource_not_found_fault

            raise aws_sdk_neptune.errors.resource_not_found_fault.ResourceNotFoundFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.pending_maintenance_actions_message.PendingMaintenanceActionsMessage = aws_sdk_neptune.types.pending_maintenance_actions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_pending_maintenance_actions_message.DescribePendingMaintenanceActionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_pending_maintenance_actions_message.serialize_query(
        input_, pairs, ""
    )
