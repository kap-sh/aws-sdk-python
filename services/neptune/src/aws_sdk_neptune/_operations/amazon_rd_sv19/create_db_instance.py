...
def build_request(
    ...
    input: aws_sdk_neptune.types.create_db_instance_message.CreateDBInstanceMessage,
) -> zapros.Request:
    ...
    aws_sdk_neptune.types.create_db_instance_message.serialize_query(input, pairs, "")
