...
def handle_response(
    ...
    out: aws_sdk_neptune.types.db_parameter_groups_message.DBParameterGroupsMessage = (
        aws_sdk_neptune.types.db_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_db_parameter_groups_message.DescribeDBParameterGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_db_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
