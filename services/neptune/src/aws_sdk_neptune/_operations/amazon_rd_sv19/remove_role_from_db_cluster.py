"""Generated from Smithy shape ``com.amazonaws.neptune#RemoveRoleFromDBCluster``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBClusterRoleNotFoundFault":
            import aws_sdk_neptune.errors.db_cluster_role_not_found_fault

            raise aws_sdk_neptune.errors.db_cluster_role_not_found_fault.DBClusterRoleNotFoundFault.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.remove_role_from_db_cluster_message.RemoveRoleFromDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.remove_role_from_db_cluster_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_remove_role_from_db_cluster(
