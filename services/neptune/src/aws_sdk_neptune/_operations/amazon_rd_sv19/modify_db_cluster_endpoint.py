...
def handle_response(
    ...
    out: aws_sdk_neptune.types.modify_db_cluster_endpoint_output.ModifyDBClusterEndpointOutput = aws_sdk_neptune.types.modify_db_cluster_endpoint_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.modify_db_cluster_endpoint_message.ModifyDBClusterEndpointMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
