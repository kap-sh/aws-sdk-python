...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBSubnetStateFault":
            import aws_sdk_neptune.errors.invalid_db_subnet_state_fault

            raise aws_sdk_neptune.errors.invalid_db_subnet_state_fault.InvalidDBSubnetStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.delete_db_subnet_group_message.DeleteDBSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
