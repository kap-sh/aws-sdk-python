"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeGlobalClusters``."""
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_global_clusters_message.DescribeGlobalClustersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_global_clusters_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_global_clusters(
    ...
    aws_sdk_neptune.types.global_clusters_message.GlobalClustersMessage, zapros.Response
]:
