...
def handle_response(
    ...
    out: aws_sdk_neptune.types.copy_db_cluster_snapshot_result.CopyDBClusterSnapshotResult = aws_sdk_neptune.types.copy_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.copy_db_cluster_snapshot_message.CopyDBClusterSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.copy_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
