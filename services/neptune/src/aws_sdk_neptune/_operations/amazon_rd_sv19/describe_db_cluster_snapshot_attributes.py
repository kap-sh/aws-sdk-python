"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeDBClusterSnapshotAttributes``."""
...
import aws_sdk_neptune.types.db_cluster_snapshot_attributes_result
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeDBClusterSnapshotAttributesResult")
    out: aws_sdk_neptune.types.describe_db_cluster_snapshot_attributes_result.DescribeDBClusterSnapshotAttributesResult = aws_sdk_neptune.types.describe_db_cluster_snapshot_attributes_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_db_cluster_snapshot_attributes_message.DescribeDBClusterSnapshotAttributesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeDBClusterSnapshotAttributes"))
    pairs.append(("Version", "2014-10-31"))
    aws_sdk_neptune.types.describe_db_cluster_snapshot_attributes_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_db_cluster_snapshot_attributes(
