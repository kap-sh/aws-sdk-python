...
def handle_response(
    ...
    out: aws_sdk_neptune.types.switchover_global_cluster_result.SwitchoverGlobalClusterResult = aws_sdk_neptune.types.switchover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.switchover_global_cluster_message.SwitchoverGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
