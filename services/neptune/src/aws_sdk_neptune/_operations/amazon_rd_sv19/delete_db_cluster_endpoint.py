...
import aws_sdk_neptune.errors.db_cluster_endpoint_not_found_fault
import aws_sdk_neptune.errors.invalid_db_cluster_endpoint_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBClusterEndpointNotFoundFault":
            raise aws_sdk_neptune.errors.db_cluster_endpoint_not_found_fault.DBClusterEndpointNotFoundFault.from_query(
                root
            )
        case "InvalidDBClusterEndpointStateFault":
            raise aws_sdk_neptune.errors.invalid_db_cluster_endpoint_state_fault.InvalidDBClusterEndpointStateFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.delete_db_cluster_endpoint_output.DeleteDBClusterEndpointOutput = aws_sdk_neptune.types.delete_db_cluster_endpoint_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.delete_db_cluster_endpoint_message.DeleteDBClusterEndpointMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.delete_db_cluster_endpoint_message.serialize_query(
        input_, pairs, ""
    )
