...
def handle_response(
    ...
    out: aws_sdk_neptune.types.db_cluster_parameter_groups_message.DBClusterParameterGroupsMessage = aws_sdk_neptune.types.db_cluster_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_db_cluster_parameter_groups_message.DescribeDBClusterParameterGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_db_cluster_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
