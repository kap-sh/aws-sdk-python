...
def build_request(
    ...
    input_: aws_sdk_neptune.types.delete_db_cluster_parameter_group_message.DeleteDBClusterParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.delete_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
