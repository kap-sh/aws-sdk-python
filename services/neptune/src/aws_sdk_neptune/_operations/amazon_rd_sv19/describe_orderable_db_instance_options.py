...
def handle_response(
    ...
    out: aws_sdk_neptune.types.orderable_db_instance_options_message.OrderableDBInstanceOptionsMessage = aws_sdk_neptune.types.orderable_db_instance_options_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_orderable_db_instance_options_message.DescribeOrderableDBInstanceOptionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_orderable_db_instance_options_message.serialize_query(
        input_, pairs, ""
    )
