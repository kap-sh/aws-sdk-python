...
def handle_response(
    ...
    out: aws_sdk_neptune.types.failover_db_cluster_result.FailoverDBClusterResult = (
        aws_sdk_neptune.types.failover_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.failover_db_cluster_message.FailoverDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.failover_db_cluster_message.serialize_query(input_, pairs, "")
