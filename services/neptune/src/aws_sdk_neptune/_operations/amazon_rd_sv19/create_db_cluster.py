...
def build_request(
    ...
    input: aws_sdk_neptune.types.create_db_cluster_message.CreateDBClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_neptune.types.create_db_cluster_message.serialize_query(input, pairs, "")
