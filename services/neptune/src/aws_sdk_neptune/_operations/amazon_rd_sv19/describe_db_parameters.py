...
def handle_response(
    ...
    out: aws_sdk_neptune.types.db_parameter_group_details.DBParameterGroupDetails = (
        aws_sdk_neptune.types.db_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_db_parameters_message.DescribeDBParametersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_db_parameters_message.serialize_query(
        input_, pairs, ""
    )
