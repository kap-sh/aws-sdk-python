...
def handle_response(
    ...
    out: aws_sdk_neptune.types.restore_db_cluster_from_snapshot_result.RestoreDBClusterFromSnapshotResult = aws_sdk_neptune.types.restore_db_cluster_from_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.restore_db_cluster_from_snapshot_message.RestoreDBClusterFromSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
