...
def handle_response(
    ...
    out: aws_sdk_neptune.types.db_cluster_endpoint_message.DBClusterEndpointMessage = (
        aws_sdk_neptune.types.db_cluster_endpoint_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_db_cluster_endpoints_message.DescribeDBClusterEndpointsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_db_cluster_endpoints_message.serialize_query(
        input_, pairs, ""
    )
