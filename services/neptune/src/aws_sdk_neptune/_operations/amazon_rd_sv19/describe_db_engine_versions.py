...
def handle_response(
    ...
    out: aws_sdk_neptune.types.db_engine_version_message.DBEngineVersionMessage = (
        aws_sdk_neptune.types.db_engine_version_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_db_engine_versions_message.DescribeDBEngineVersionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_db_engine_versions_message.serialize_query(
        input_, pairs, ""
    )
