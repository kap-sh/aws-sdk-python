"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeDBSubnetGroups``."""
...
import aws_sdk_neptune.types.db_subnet_groups
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.db_subnet_group_message.DBSubnetGroupMessage = (
        aws_sdk_neptune.types.db_subnet_group_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.describe_db_subnet_groups_message.DescribeDBSubnetGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_neptune.types.describe_db_subnet_groups_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_db_subnet_groups(
    ...
    aws_sdk_neptune.types.db_subnet_group_message.DBSubnetGroupMessage, zapros.Response
]:
