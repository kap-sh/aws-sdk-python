"""Generated from Smithy shape ``com.amazonaws.neptune#ApplyPendingMaintenanceAction``."""
...
def handle_response(
    ...
    out: aws_sdk_neptune.types.apply_pending_maintenance_action_result.ApplyPendingMaintenanceActionResult = aws_sdk_neptune.types.apply_pending_maintenance_action_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_neptune.types.apply_pending_maintenance_action_message.ApplyPendingMaintenanceActionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ApplyPendingMaintenanceAction"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_neptune.types.apply_pending_maintenance_action_message

    aws_sdk_neptune.types.apply_pending_maintenance_action_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_apply_pending_maintenance_action(
