...
def handle_response(
    ...
    out: capo_qapps.types.get_q_app_session_metadata_output.GetQAppSessionMetadataOutput = capo_qapps.types.get_q_app_session_metadata_output.deserialize_json(
