...
def handle_response(
    ...
    out: capo_qapps.types.predict_q_app_output.PredictQAppOutput = (
        capo_qapps.types.predict_q_app_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qapps.types.predict_q_app_input.serialize_json(input_)
    ).encode()
...
def predict_q_app(
    ...
    input_: capo_qapps.types.predict_q_app_input.PredictQAppInput,
) -> tuple[capo_qapps.types.predict_q_app_output.PredictQAppOutput, zapros.Response]:
