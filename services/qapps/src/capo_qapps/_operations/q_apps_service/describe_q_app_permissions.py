...
def handle_response(
    ...
    out: capo_qapps.types.describe_q_app_permissions_output.DescribeQAppPermissionsOutput = capo_qapps.types.describe_q_app_permissions_output.deserialize_json(
