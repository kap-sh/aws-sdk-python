...
def handle_response(
    ...
    out: capo_qapps.types.start_q_app_session_output.StartQAppSessionOutput = (
        capo_qapps.types.start_q_app_session_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qapps.types.start_q_app_session_input.serialize_json(input_)
    ).encode()
...
def start_q_app_session(
    ...
    capo_qapps.types.start_q_app_session_output.StartQAppSessionOutput, zapros.Response
]:
