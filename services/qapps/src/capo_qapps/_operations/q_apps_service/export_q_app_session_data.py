...
import capo_qapps.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_qapps.errors.conflict_exception.ConflictException.from_json(data)
...
def handle_response(
    ...
    out: capo_qapps.types.export_q_app_session_data_output.ExportQAppSessionDataOutput = capo_qapps.types.export_q_app_session_data_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qapps.types.export_q_app_session_data_input.serialize_json(input_)
    ).encode()
