...
def handle_response(
    ...
    out: capo_qapps.types.update_q_app_session_output.UpdateQAppSessionOutput = (
        capo_qapps.types.update_q_app_session_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qapps.types.update_q_app_session_input.serialize_json(input_)
    ).encode()
