...
def handle_response(
    ...
    out: capo_qapps.types.create_library_item_output.CreateLibraryItemOutput = (
        capo_qapps.types.create_library_item_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qapps.types.create_library_item_input.serialize_json(input_)
    ).encode()
...
def create_library_item(
    ...
    capo_qapps.types.create_library_item_output.CreateLibraryItemOutput, zapros.Response
]:
