...
class QAppsError(Exception):
    """Base class for all QApps service errors."""


class ServiceError(QAppsError):
...
class SerializationError(QAppsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(QAppsError):
...
class WaiterFailedError(QAppsError):
...
class WaiterTimeoutError(QAppsError):
