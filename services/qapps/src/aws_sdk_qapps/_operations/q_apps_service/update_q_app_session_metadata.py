"""Generated from Smithy shape ``com.amazonaws.qapps#UpdateQAppSessionMetadata``."""
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.update_q_app_session_metadata_output.UpdateQAppSessionMetadataOutput = aws_sdk_qapps.types.update_q_app_session_metadata_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.update_q_app_session_metadata_input.UpdateQAppSessionMetadataInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/runtime.updateQAppSessionMetadata"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.update_q_app_session_metadata_input.serialize_json(input)
    ).encode()
...
async def async_update_q_app_session_metadata(
