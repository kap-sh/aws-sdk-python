...
def build_request(
    ...
    input_: aws_sdk_qapps.types.update_q_app_session_metadata_input.UpdateQAppSessionMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.update_q_app_session_metadata_input.serialize_json(input_)
    ).encode()
