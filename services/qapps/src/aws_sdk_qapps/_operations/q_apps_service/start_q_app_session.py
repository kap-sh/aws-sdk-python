"""Generated from Smithy shape ``com.amazonaws.qapps#StartQAppSession``."""
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.start_q_app_session_output.StartQAppSessionOutput = (
        aws_sdk_qapps.types.start_q_app_session_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.start_q_app_session_input.StartQAppSessionInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/runtime.startQAppSession"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.start_q_app_session_input.serialize_json(input)
    ).encode()
...
async def async_start_q_app_session(
