"""Generated from Smithy shape ``com.amazonaws.qapps#UpdateQAppSession``."""
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.update_q_app_session_output.UpdateQAppSessionOutput = (
        aws_sdk_qapps.types.update_q_app_session_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.update_q_app_session_input.UpdateQAppSessionInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/runtime.updateQAppSession"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.update_q_app_session_input.serialize_json(input)
    ).encode()
...
async def async_update_q_app_session(
