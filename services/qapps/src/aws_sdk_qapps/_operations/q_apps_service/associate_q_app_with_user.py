...
def build_request(
    ...
    input_: aws_sdk_qapps.types.associate_q_app_with_user_input.AssociateQAppWithUserInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.associate_q_app_with_user_input.serialize_json(input_)
    ).encode()
