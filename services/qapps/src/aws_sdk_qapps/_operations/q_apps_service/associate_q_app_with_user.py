...
def build_request(
    ...
    input: aws_sdk_qapps.types.associate_q_app_with_user_input.AssociateQAppWithUserInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.associate_q_app_with_user_input.serialize_json(input)
    ).encode()
