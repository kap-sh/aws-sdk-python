"""Generated from Smithy shape ``com.amazonaws.qapps#ImportDocument``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ContentTooLargeException":
            import aws_sdk_qapps.errors.content_too_large_exception

            raise aws_sdk_qapps.errors.content_too_large_exception.ContentTooLargeException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.import_document_output.ImportDocumentOutput = (
        aws_sdk_qapps.types.import_document_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.import_document_input.ImportDocumentInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/apps.importDocument"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.import_document_input.serialize_json(input)
    ).encode()
...
def import_document(
    ...
    aws_sdk_qapps.types.import_document_output.ImportDocumentOutput, zapros.Response
]:
