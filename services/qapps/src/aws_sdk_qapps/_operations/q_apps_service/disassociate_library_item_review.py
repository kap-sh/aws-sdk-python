...
def build_request(
    ...
    input: aws_sdk_qapps.types.disassociate_library_item_review_input.DisassociateLibraryItemReviewInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.disassociate_library_item_review_input.serialize_json(input)
    ).encode()
