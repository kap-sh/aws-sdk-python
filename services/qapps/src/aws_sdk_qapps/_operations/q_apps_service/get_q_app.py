...
import aws_sdk_qapps.types.app_definition
...
def build_request(
    ...
    input_: aws_sdk_qapps.types.get_q_app_input.GetQAppInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "app_version" in input_:
        params["appVersion"] = str(input_["app_version"])
...
def get_q_app(
    options: OperationOptions, input_: aws_sdk_qapps.types.get_q_app_input.GetQAppInput
