"""Generated from Smithy shape ``com.amazonaws.qapps#ListCategories``."""
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.list_categories_output.ListCategoriesOutput = (
        aws_sdk_qapps.types.list_categories_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.list_categories_input.ListCategoriesInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/catalog.listCategories"
    params: dict[str, str] = {}
...
def list_categories(
    ...
    aws_sdk_qapps.types.list_categories_output.ListCategoriesOutput, zapros.Response
]:
...
async def async_list_categories(
