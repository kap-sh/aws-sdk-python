...
def handle_response(
    ...
    out: aws_sdk_qapps.types.update_q_app_permissions_output.UpdateQAppPermissionsOutput = aws_sdk_qapps.types.update_q_app_permissions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qapps.types.update_q_app_permissions_input.UpdateQAppPermissionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.update_q_app_permissions_input.serialize_json(input_)
    ).encode()
