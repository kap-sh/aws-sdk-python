...
def build_request(
    ...
    input: aws_sdk_qapps.types.update_q_app_permissions_input.UpdateQAppPermissionsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.update_q_app_permissions_input.serialize_json(input)
    ).encode()
