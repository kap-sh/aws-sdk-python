...
def build_request(
    ...
    input_: aws_sdk_qapps.types.associate_library_item_review_input.AssociateLibraryItemReviewInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.associate_library_item_review_input.serialize_json(input_)
    ).encode()
