"""Generated from Smithy shape ``com.amazonaws.qapps#AssociateLibraryItemReview``."""
...
def build_request(
    ...
    input: aws_sdk_qapps.types.associate_library_item_review_input.AssociateLibraryItemReviewInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/catalog.associateItemRating"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.associate_library_item_review_input.serialize_json(input)
    ).encode()
...
async def async_associate_library_item_review(
