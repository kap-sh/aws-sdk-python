...
def handle_response(
    ...
    out: aws_sdk_qapps.types.list_q_app_session_data_output.ListQAppSessionDataOutput = aws_sdk_qapps.types.list_q_app_session_data_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qapps.types.list_q_app_session_data_input.ListQAppSessionDataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
