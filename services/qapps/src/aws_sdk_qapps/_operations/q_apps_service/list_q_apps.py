...
def handle_response(
    ...
    out: aws_sdk_qapps.types.list_q_apps_output.ListQAppsOutput = (
        aws_sdk_qapps.types.list_q_apps_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qapps.types.list_q_apps_input.ListQAppsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_q_apps(
    ...
    input_: aws_sdk_qapps.types.list_q_apps_input.ListQAppsInput,
) -> tuple[aws_sdk_qapps.types.list_q_apps_output.ListQAppsOutput, zapros.Response]:
