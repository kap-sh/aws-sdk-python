...
def handle_response(
    ...
    out: aws_sdk_qapps.types.update_q_app_output.UpdateQAppOutput = (
        aws_sdk_qapps.types.update_q_app_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qapps.types.update_q_app_input.UpdateQAppInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.update_q_app_input.serialize_json(input_)
    ).encode()
...
def update_q_app(
    ...
    input_: aws_sdk_qapps.types.update_q_app_input.UpdateQAppInput,
) -> tuple[aws_sdk_qapps.types.update_q_app_output.UpdateQAppOutput, zapros.Response]:
