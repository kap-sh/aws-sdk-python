"""Generated from Smithy shape ``com.amazonaws.qapps#UpdateLibraryItem``."""
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.update_library_item_output.UpdateLibraryItemOutput = (
        aws_sdk_qapps.types.update_library_item_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.update_library_item_input.UpdateLibraryItemInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/catalog.updateItem"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.update_library_item_input.serialize_json(input)
    ).encode()
