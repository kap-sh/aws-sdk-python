"""Generated from Smithy shape ``com.amazonaws.qapps#DeleteQApp``."""
...
def build_request(
    ...
    input: aws_sdk_qapps.types.delete_q_app_input.DeleteQAppInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/apps.delete"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.delete_q_app_input.serialize_json(input)
    ).encode()
