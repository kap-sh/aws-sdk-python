"""Generated from Smithy shape ``com.amazonaws.qapps#PredictQApp``."""
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.predict_q_app_output.PredictQAppOutput = (
        aws_sdk_qapps.types.predict_q_app_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.predict_q_app_input.PredictQAppInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/apps.predictQApp"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.predict_q_app_input.serialize_json(input)
    ).encode()
...
def predict_q_app(
    ...
    input: aws_sdk_qapps.types.predict_q_app_input.PredictQAppInput,
) -> tuple[aws_sdk_qapps.types.predict_q_app_output.PredictQAppOutput, zapros.Response]:
