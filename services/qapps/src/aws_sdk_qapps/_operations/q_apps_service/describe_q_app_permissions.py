"""Generated from Smithy shape ``com.amazonaws.qapps#DescribeQAppPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.describe_q_app_permissions_output.DescribeQAppPermissionsOutput = aws_sdk_qapps.types.describe_q_app_permissions_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.describe_q_app_permissions_input.DescribeQAppPermissionsInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/apps.describeQAppPermissions"
    params: dict[str, str] = {}
    if "app_id" in input:
...
async def async_describe_q_app_permissions(
