...
def handle_response(
    ...
    out: aws_sdk_qapps.types.get_library_item_output.GetLibraryItemOutput = (
        aws_sdk_qapps.types.get_library_item_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.get_library_item_input.GetLibraryItemInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "library_item_id" in input:
        params["libraryItemId"] = str(input["library_item_id"])
    if "app_id" in input:
...
def get_library_item(
    ...
    aws_sdk_qapps.types.get_library_item_output.GetLibraryItemOutput, zapros.Response
]:
