...
def handle_response(
    ...
    out: aws_sdk_qapps.types.create_q_app_output.CreateQAppOutput = (
        aws_sdk_qapps.types.create_q_app_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qapps.types.create_q_app_input.CreateQAppInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.create_q_app_input.serialize_json(input_)
    ).encode()
...
def create_q_app(
    ...
    input_: aws_sdk_qapps.types.create_q_app_input.CreateQAppInput,
) -> tuple[aws_sdk_qapps.types.create_q_app_output.CreateQAppOutput, zapros.Response]:
