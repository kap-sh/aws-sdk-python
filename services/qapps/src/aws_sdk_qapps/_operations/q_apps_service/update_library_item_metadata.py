...
def build_request(
    ...
    input_: aws_sdk_qapps.types.update_library_item_metadata_input.UpdateLibraryItemMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.update_library_item_metadata_input.serialize_json(input_)
    ).encode()
