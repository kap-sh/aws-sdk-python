"""Generated from Smithy shape ``com.amazonaws.qapps#CreateLibraryItem``."""
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.create_library_item_output.CreateLibraryItemOutput = (
        aws_sdk_qapps.types.create_library_item_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.create_library_item_input.CreateLibraryItemInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/catalog.createItem"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.create_library_item_input.serialize_json(input)
    ).encode()
