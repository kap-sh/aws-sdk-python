"""Generated from Smithy shape ``com.amazonaws.qapps#GetQAppSessionMetadata``."""
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.get_q_app_session_metadata_output.GetQAppSessionMetadataOutput = aws_sdk_qapps.types.get_q_app_session_metadata_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.get_q_app_session_metadata_input.GetQAppSessionMetadataInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/runtime.getQAppSessionMetadata"
    params: dict[str, str] = {}
...
async def async_get_q_app_session_metadata(
