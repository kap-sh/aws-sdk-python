"""Generated from Smithy shape ``com.amazonaws.qapps#CreatePresignedUrl``."""
...
def handle_response(
    ...
    out: aws_sdk_qapps.types.create_presigned_url_output.CreatePresignedUrlOutput = (
        aws_sdk_qapps.types.create_presigned_url_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qapps.types.create_presigned_url_input.CreatePresignedUrlInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/apps.createPresignedUrl"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.create_presigned_url_input.serialize_json(input)
    ).encode()
...
async def async_create_presigned_url(
