"""Generated from Smithy shape ``com.amazonaws.qapps#DisassociateQAppFromUser``."""
...
def build_request(
    ...
    input: aws_sdk_qapps.types.disassociate_q_app_from_user_input.DisassociateQAppFromUserInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/apps.uninstall"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.disassociate_q_app_from_user_input.serialize_json(input)
    ).encode()
...
async def async_disassociate_q_app_from_user(
