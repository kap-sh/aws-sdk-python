...
def build_request(
    ...
    input_: aws_sdk_qapps.types.disassociate_q_app_from_user_input.DisassociateQAppFromUserInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.disassociate_q_app_from_user_input.serialize_json(input_)
    ).encode()
