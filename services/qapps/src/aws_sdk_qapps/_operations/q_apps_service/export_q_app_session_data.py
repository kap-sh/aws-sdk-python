...
def build_request(
    ...
    input_: aws_sdk_qapps.types.export_q_app_session_data_input.ExportQAppSessionDataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qapps.types.export_q_app_session_data_input.serialize_json(input_)
    ).encode()
