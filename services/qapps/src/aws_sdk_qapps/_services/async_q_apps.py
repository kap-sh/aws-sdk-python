...
from aws_sdk_qapps._services._aws_config import aaws_config
...
class AsyncQAppsClientConfig(TypedDict, total=False, closed=True):
...
class AsyncQAppsClient:
    ...
    def __init__(
        ...
        self._config = AsyncQAppsClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncQAppsClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncQAppsClientConfig = config_overrides or {}
    ...
    async def associate_library_item_review(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.associate_library_item_review(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', library_item_id='cb9ecf72-8563-450d-9db9-994f98297316')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.associate_library_item_review_input.AssociateLibraryItemReviewInput]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.associate_library_item_review.async_associate_library_item_review(
    ...
    async def associate_q_app_with_user(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.associate_q_app_with_user(app_id='393e77fb-0a30-4f47-ad30-75d71aeaed8a', instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.associate_q_app_with_user_input.AssociateQAppWithUserInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.associate_q_app_with_user.async_associate_q_app_with_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_create_category(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.batch_create_category(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', categories=[{'id': '549abfe0-f5c4-45a2-bb9b-c05987a49c6d', 'title': 'HR'}, {'id': '18cbebaa-196a-4aa5-a840-88d548e07f8f', 'title': 'Marketing'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.batch_create_category_input.BatchCreateCategoryInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.batch_create_category.async_batch_create_category(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_delete_category(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.batch_delete_category(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', categories=['9c871ed4-1c41-4065-aefe-321cd4b61cf8'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.batch_delete_category_input.BatchDeleteCategoryInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.batch_delete_category.async_batch_delete_category(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_category(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.batch_update_category(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', categories=[{'id': '549abfe0-f5c4-45a2-bb9b-c05987a49c6d', 'title': 'HR Management'}, {'id': '18cbebaa-196a-4aa5-a840-88d548e07f8f', 'title': 'Sales'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.batch_update_category_input.BatchUpdateCategoryInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.batch_update_category.async_batch_update_category(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_library_item(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_library_item(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', app_id='7a11f34b-42d4-4bc8-b668-ae4a788dae1e', app_version=6, categories=['9c871ed4-1c41-4065-aefe-321cd4b61cf8'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.create_library_item_input.CreateLibraryItemInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.create_library_item_output.CreateLibraryItemOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.create_library_item.async_create_library_item(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_presigned_url(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_presigned_url(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', file_contents_sha256='wXY7GD8m4fmHhdtuQyBdXzNQpdCseVwBcOBIlzfm+kg=', file_name='myFile.txt', card_id='82f69028-22a9-4bea-8727-0eabf58e9fed', app_id='4263767c-d889-4cb2-a8f6-8b649bc66af0', scope='SESSION', session_id='4f0e5b87-9d38-41cd-9eb4-ebce2f2917cc')
            Upload a file into a application

            >>> await client.create_presigned_url(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', file_contents_sha256='wXY7GD8m4fmHhdtuQyBdXzNQpdCseVwBcOBIlzfm+kg=', file_name='anApplicationFile.txt', app_id='4263767c-d889-4cb2-a8f6-8b649bc66af0', card_id='7a11f34b-42d4-4bc8-b668-ae4a788dae1e', scope='APPLICATION')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.create_presigned_url_input.CreatePresignedUrlInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.create_presigned_url_output.CreatePresignedUrlOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.create_presigned_url.async_create_presigned_url(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.create_q_app.async_create_q_app(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_library_item(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_library_item(instance_id='3642ba81-344c-42fd-a480-9119a5a5f26b', library_item_id='72088fd4-78b6-43da-bfb8-8621323c3cfb')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.delete_library_item_input.DeleteLibraryItemInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.delete_library_item.async_delete_library_item(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_q_app(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_q_app(app_id='393e77fb-0a30-4f47-ad30-75d71aeaed8a', instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.delete_q_app_input.DeleteQAppInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.delete_q_app.async_delete_q_app(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_q_app_permissions(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_q_app_permissions(instance_id='01793661-ad73-4c7d-8eaa-1c95a10151c2', app_id='fe0acf86-49e5-4def-a0c2-40ce0cafee14')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.describe_q_app_permissions_input.DescribeQAppPermissionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.describe_q_app_permissions_output.DescribeQAppPermissionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.describe_q_app_permissions.async_describe_q_app_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_library_item_review(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.disassociate_library_item_review(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', library_item_id='cb9ecf72-8563-450d-9db9-994f98297316')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.disassociate_library_item_review_input.DisassociateLibraryItemReviewInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.disassociate_library_item_review.async_disassociate_library_item_review(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_q_app_from_user(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.disassociate_q_app_from_user(app_id='393e77fb-0a30-4f47-ad30-75d71aeaed8a', instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.disassociate_q_app_from_user_input.DisassociateQAppFromUserInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.disassociate_q_app_from_user.async_disassociate_q_app_from_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_q_app_session_data(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.export_q_app_session_data_input.ExportQAppSessionDataInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.export_q_app_session_data_output.ExportQAppSessionDataOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.export_q_app_session_data.async_export_q_app_session_data(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_library_item(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_library_item(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', library_item_id='18cbebaa-196a-4aa5-a840-88d548e07f8f')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.get_library_item_input.GetLibraryItemInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.get_library_item_output.GetLibraryItemOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.get_library_item.async_get_library_item(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_q_app(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_q_app(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', app_id='3d110749-efc3-427c-87e8-15e966e5c168')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.get_q_app_input.GetQAppInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.get_q_app_output.GetQAppOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.get_q_app.async_get_q_app(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_q_app_session(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_q_app_session(instance_id='288ae830-1df2-4871-b6c0-4314d74dadef', session_id='1fca878e-64c5-4dc4-b1d9-c93effed4e82')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.get_q_app_session_input.GetQAppSessionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.get_q_app_session_output.GetQAppSessionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.get_q_app_session.async_get_q_app_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_q_app_session_metadata(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_q_app_session_metadata(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', session_id='56ae47c3-10bc-4c2c-8b27-9b9fe23b3edb')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.get_q_app_session_metadata_input.GetQAppSessionMetadataInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.get_q_app_session_metadata_output.GetQAppSessionMetadataOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.get_q_app_session_metadata.async_get_q_app_session_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_document(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.import_document(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', file_contents_base64='data:text/plain;base64,SomeFileEncodedInBase64', file_name='myFile.txt', card_id='82f69028-22a9-4bea-8727-0eabf58e9fed', app_id='4263767c-d889-4cb2-a8f6-8b649bc66af0', scope='SESSION', session_id='4f0e5b87-9d38-41cd-9eb4-ebce2f2917cc')
            Upload a file into a application

            >>> await client.import_document(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', file_contents_base64='data:text/plain;base64,SomeFileEncodedInBase64', file_name='anApplicationFile.txt', app_id='4263767c-d889-4cb2-a8f6-8b649bc66af0', card_id='7a11f34b-42d4-4bc8-b668-ae4a788dae1e', scope='APPLICATION')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.import_document_input.ImportDocumentInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.import_document_output.ImportDocumentOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.import_document.async_import_document(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_categories(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_categories(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.list_categories_input.ListCategoriesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.list_categories_output.ListCategoriesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.list_categories.async_list_categories(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_library_items(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_library_items(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', limit=3)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.list_library_items_input.ListLibraryItemsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.list_library_items_output.ListLibraryItemsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.list_library_items.async_list_library_items(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_library_items(
        self,
        instance_id: "aws_sdk_qapps.types.instance_id.InstanceId",
        *,
        config_overrides: Optional[AsyncQAppsClientConfig] = None,
        ...
        category_id: Optional["aws_sdk_qapps.types.uuid.UUID"] = None,
    ) -> "AsyncIterator[aws_sdk_qapps.types.library_item_member.LibraryItemMember]":
        _token = next_token
        while True:
            _response = await self.list_library_items(
                instance_id,
    ...
    async def list_q_apps(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_q_apps(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', limit=3)
            Retrieve the next page of Amazon Q Apps

            >>> await client.list_q_apps(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', limit=3, next_token='bXlzdGVyaW91c1BhZ2luYXRpb25Ub2tlbg==')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.list_q_apps_input.ListQAppsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.list_q_apps_output.ListQAppsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.list_q_apps.async_list_q_apps(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_qapps.types.user_app_item.UserAppItem]":
        _token = next_token
        while True:
            _response = await self.list_q_apps(
                instance_id,
                config_overrides=config_overrides,
                limit=limit,
                next_token=_token,
    ...
    async def list_q_app_session_data(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.list_q_app_session_data_input.ListQAppSessionDataInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.list_q_app_session_data_output.ListQAppSessionDataOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.list_q_app_session_data.async_list_q_app_session_data(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_tags_for_resource(resource_arn='arn:aws:qapps:us-west-2:123456789012:application/3642ba81-344c-42fd-a480-9119a5a5f26b/qapp/7212ff04-de7b-4831-bd80-45d6975ba1b0')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def predict_q_app(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.predict_q_app_input.PredictQAppInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.predict_q_app_output.PredictQAppOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.predict_q_app.async_predict_q_app(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_q_app_session(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.start_q_app_session(instance_id='4cc5e4c2-d2a2-4188-a114-9ca125b4aedc', app_id='65e7dce7-226a-47f9-b689-22850becef89', app_version=1, initial_values=[{'cardId': '6fb5b404-3b7b-48a4-8a8b-56406922a606', 'value': 'What is the circumference of Earth?'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.start_q_app_session_input.StartQAppSessionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.start_q_app_session_output.StartQAppSessionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.start_q_app_session.async_start_q_app_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_q_app_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.stop_q_app_session_input.StopQAppSessionInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.stop_q_app_session.async_stop_q_app_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.tag_resource(resource_arn='arn:aws:qapps:us-west-2:123456789012:application/3642ba81-344c-42fd-a480-9119a5a5f26b/qapp/7212ff04-de7b-4831-bd80-45d6975ba1b0', tags={'department': 'HR'})
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.untag_resource(resource_arn='arn:aws:qapps:us-west-2:123456789012:application/3642ba81-344c-42fd-a480-9119a5a5f26b/qapp/7212ff04-de7b-4831-bd80-45d6975ba1b0', tag_keys=['department'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_library_item(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_library_item(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', library_item_id='cb9ecf72-8563-450d-9db9-994f98297316', status='DISABLED')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.update_library_item_input.UpdateLibraryItemInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.update_library_item_output.UpdateLibraryItemOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.update_library_item.async_update_library_item(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_library_item_metadata(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_library_item_metadata(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', library_item_id='cb9ecf72-8563-450d-9db9-994f98297316', is_verified=True)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.update_library_item_metadata_input.UpdateLibraryItemMetadataInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.update_library_item_metadata.async_update_library_item_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_q_app(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_q_app(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', app_id='7212ff04-de7b-4831-bd80-45d6975ba1b0', title='This is the new title')
            Updating the app so it has a single q-query card

            >>> await client.update_q_app(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', app_id='7212ff04-de7b-4831-bd80-45d6975ba1b0', app_definition={'cards': [{'qQuery': {'type': 'q-query', 'title': 'Trip Ideas', 'id': '18870b94-1e63-40e0-8c12-669c90ac5acc', 'prompt': 'Recommend me an itinerary for a trip'}}]})
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.update_q_app_input.UpdateQAppInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.update_q_app_output.UpdateQAppOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.update_q_app.async_update_q_app(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_q_app_permissions(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_q_app_permissions(instance_id='01793661-ad73-4c7d-8eaa-1c95a10151c2', app_id='fe0acf86-49e5-4def-a0c2-40ce0cafee14', grant_permissions=[{'action': 'read', 'principal': 'user2@example.com'}])
            Revoke permissions for the app

            >>> await client.update_q_app_permissions(instance_id='01793661-ad73-4c7d-8eaa-1c95a10151c2', app_id='fe0acf86-49e5-4def-a0c2-40ce0cafee14', revoke_permissions=[{'action': 'read', 'principal': 'user2@example.com'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.update_q_app_permissions_input.UpdateQAppPermissionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.update_q_app_permissions_output.UpdateQAppPermissionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.update_q_app_permissions.async_update_q_app_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_q_app_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.update_q_app_session_input.UpdateQAppSessionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.update_q_app_session_output.UpdateQAppSessionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.update_q_app_session.async_update_q_app_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_q_app_session_metadata(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_q_app_session_metadata(instance_id='0b95c9c4-89cc-4aa8-9aae-aa91cbec699f', session_id='56ae47c3-10bc-4c2c-8b27-9b9fe23b3edb', session_name='Trip itinerary collection session', sharing_configuration={'enabled': True, 'acceptResponses': True, 'revealCards': False})
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_qapps.types.update_q_app_session_metadata_input.UpdateQAppSessionMetadataInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_qapps.types.update_q_app_session_metadata_output.UpdateQAppSessionMetadataOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_qapps._operations.q_apps_service.update_q_app_session_metadata.async_update_q_app_session_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
