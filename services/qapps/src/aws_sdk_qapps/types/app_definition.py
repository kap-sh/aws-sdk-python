...
def serialize_json(value: AppDefinition) -> dict:
    ...
    out["cards"] = aws_sdk_qapps.types.card_model_list.serialize_json(value["cards"])
...
def deserialize_json(data: dict) -> AppDefinition:
    ...
    if "cards" in data:
        ...
        out["cards"] = aws_sdk_qapps.types.card_model_list.deserialize_json(
            data["cards"]
        )
    else:
