...
if TYPE_CHECKING:
    import aws_sdk_qapps.types.form_input_card_metadata_schema


class FormInputCardMetadata(TypedDict):
    schema: "aws_sdk_qapps.types.form_input_card_metadata_schema.FormInputCardMetadataSchema"
