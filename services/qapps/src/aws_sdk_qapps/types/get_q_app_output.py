...
class GetQAppOutput(TypedDict):
    ...
    app_definition: "aws_sdk_qapps.types.app_definition.AppDefinition"
...
def serialize_json(value: GetQAppOutput) -> dict:
    ...
    out["appDefinition"] = aws_sdk_qapps.types.app_definition.serialize_json(
...
def deserialize_json(data: dict) -> GetQAppOutput:
    ...
    if "appDefinition" in data:
        ...
        out["app_definition"] = aws_sdk_qapps.types.app_definition.deserialize_json(
            data["appDefinition"]
        )
    else:
