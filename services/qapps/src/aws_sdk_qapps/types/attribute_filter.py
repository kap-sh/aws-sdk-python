...
if TYPE_CHECKING:
    ...
    import aws_sdk_qapps.types.attribute_filters
    import aws_sdk_qapps.types.document_attribute


class AttributeFilter(TypedDict):
    and_all_filters: NotRequired[
        "aws_sdk_qapps.types.attribute_filters.AttributeFilters"
    ]
...
def serialize_json(value: AttributeFilter) -> dict:
    ...
    if "and_all_filters" in value:
        ...
        out["andAllFilters"] = aws_sdk_qapps.types.attribute_filters.serialize_json(
            value["and_all_filters"]
        )
    if "or_all_filters" in value:
        import aws_sdk_qapps.types.attribute_filters

        out["orAllFilters"] = aws_sdk_qapps.types.attribute_filters.serialize_json(
            value["or_all_filters"]
        )
    if "not_filter" in value:
        import aws_sdk_qapps.types.attribute_filter

        out["notFilter"] = aws_sdk_qapps.types.attribute_filter.serialize_json(
            value["not_filter"]
        )
    if "equals_to" in value:
        import aws_sdk_qapps.types.document_attribute

        out["equalsTo"] = aws_sdk_qapps.types.document_attribute.serialize_json(
            value["equals_to"]
        )
    if "contains_all" in value:
        import aws_sdk_qapps.types.document_attribute

        out["containsAll"] = aws_sdk_qapps.types.document_attribute.serialize_json(
            value["contains_all"]
        )
    if "contains_any" in value:
        import aws_sdk_qapps.types.document_attribute

        out["containsAny"] = aws_sdk_qapps.types.document_attribute.serialize_json(
            value["contains_any"]
        )
    if "greater_than" in value:
        import aws_sdk_qapps.types.document_attribute

        out["greaterThan"] = aws_sdk_qapps.types.document_attribute.serialize_json(
            value["greater_than"]
        )
    if "greater_than_or_equals" in value:
        ...
        out["greaterThanOrEquals"] = (
            aws_sdk_qapps.types.document_attribute.serialize_json(
    ...
    if "less_than" in value:
        ...
        out["lessThan"] = aws_sdk_qapps.types.document_attribute.serialize_json(
            value["less_than"]
        )
    if "less_than_or_equals" in value:
        import aws_sdk_qapps.types.document_attribute

        out["lessThanOrEquals"] = aws_sdk_qapps.types.document_attribute.serialize_json(
...
def deserialize_json(data: dict) -> AttributeFilter:
    ...
    if "andAllFilters" in data:
        ...
        out["and_all_filters"] = aws_sdk_qapps.types.attribute_filters.deserialize_json(
            data["andAllFilters"]
        )
    if "orAllFilters" in data:
        import aws_sdk_qapps.types.attribute_filters

        out["or_all_filters"] = aws_sdk_qapps.types.attribute_filters.deserialize_json(
            data["orAllFilters"]
        )
    if "notFilter" in data:
        import aws_sdk_qapps.types.attribute_filter

        out["not_filter"] = aws_sdk_qapps.types.attribute_filter.deserialize_json(
            data["notFilter"]
        )
    if "equalsTo" in data:
        import aws_sdk_qapps.types.document_attribute

        out["equals_to"] = aws_sdk_qapps.types.document_attribute.deserialize_json(
            data["equalsTo"]
        )
    if "containsAll" in data:
        import aws_sdk_qapps.types.document_attribute

        out["contains_all"] = aws_sdk_qapps.types.document_attribute.deserialize_json(
            data["containsAll"]
        )
    if "containsAny" in data:
        import aws_sdk_qapps.types.document_attribute

        out["contains_any"] = aws_sdk_qapps.types.document_attribute.deserialize_json(
            data["containsAny"]
        )
    if "greaterThan" in data:
        import aws_sdk_qapps.types.document_attribute

        out["greater_than"] = aws_sdk_qapps.types.document_attribute.deserialize_json(
            data["greaterThan"]
        )
    if "greaterThanOrEquals" in data:
        ...
        out["greater_than_or_equals"] = (
            aws_sdk_qapps.types.document_attribute.deserialize_json(
    ...
    if "lessThan" in data:
        ...
        out["less_than"] = aws_sdk_qapps.types.document_attribute.deserialize_json(
            data["lessThan"]
        )
