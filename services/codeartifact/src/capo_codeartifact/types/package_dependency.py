...
class PackageDependency(TypedDict, closed=True):
    ...
    dependency_type: NotRequired["capo_codeartifact.types.string.String"]
    ...
    version_requirement: NotRequired["capo_codeartifact.types.string.String"]
