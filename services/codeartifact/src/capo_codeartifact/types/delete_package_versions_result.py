...
# --- restJson1 ser/de ---
def serialize_json(value: DeletePackageVersionsResult) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DeletePackageVersionsResult:
    out: DeletePackageVersionsResult = {}  # type: ignore[typeddict-item]
