...
def serialize_json(value: UpdatePackageGroupOriginConfigurationRequest) -> dict:
    ...
    if "restrictions" in value:
        ...
        out["restrictions"] = (
            capo_codeartifact.types.origin_restrictions.serialize_json(
                value["restrictions"]
            )
        )
    if "add_allowed_repositories" in value:
        ...
        out["addAllowedRepositories"] = (
            capo_codeartifact.types.package_group_allowed_repository_list.serialize_json(
...
def deserialize_json(data: dict) -> UpdatePackageGroupOriginConfigurationRequest:
    ...
    if "restrictions" in data:
        ...
        out["restrictions"] = (
            capo_codeartifact.types.origin_restrictions.deserialize_json(
                data["restrictions"]
            )
        )
    if "addAllowedRepositories" in data:
        ...
        out["add_allowed_repositories"] = (
            capo_codeartifact.types.package_group_allowed_repository_list.deserialize_json(
