...
class codeartifactError(Exception):
    """Base class for all codeartifact service errors."""


class ServiceError(codeartifactError):
...
class SerializationError(codeartifactError):
    """Raised when a value cannot be serialized."""


class DeserializationError(codeartifactError):
...
class WaiterFailedError(codeartifactError):
...
class WaiterTimeoutError(codeartifactError):
