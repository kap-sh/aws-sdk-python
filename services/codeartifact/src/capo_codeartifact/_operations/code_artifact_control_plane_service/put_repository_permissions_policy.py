"""Generated from Smithy shape ``com.amazonaws.codeartifact#PutRepositoryPermissionsPolicy``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.put_repository_permissions_policy_result.PutRepositoryPermissionsPolicyResult = capo_codeartifact.types.put_repository_permissions_policy_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.put_repository_permissions_policy_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_repository_permissions_policy(
