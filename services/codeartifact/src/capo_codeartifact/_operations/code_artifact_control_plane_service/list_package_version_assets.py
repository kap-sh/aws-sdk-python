...
def handle_response(
    ...
    out: capo_codeartifact.types.list_package_version_assets_result.ListPackageVersionAssetsResult = capo_codeartifact.types.list_package_version_assets_result.deserialize_json(
