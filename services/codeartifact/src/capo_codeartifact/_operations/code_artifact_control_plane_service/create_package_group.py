"""Generated from Smithy shape ``com.amazonaws.codeartifact#CreatePackageGroup``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.create_package_group_result.CreatePackageGroupResult = capo_codeartifact.types.create_package_group_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.create_package_group_request.serialize_json(input_)
    ).encode()
...
async def async_create_package_group(
