"""Generated from Smithy shape ``com.amazonaws.codeartifact#DescribePackageVersion``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.describe_package_version_result.DescribePackageVersionResult = capo_codeartifact.types.describe_package_version_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/package/version"
    params: dict[str, str] = {}
    if "domain" in input_:
...
async def async_describe_package_version(
