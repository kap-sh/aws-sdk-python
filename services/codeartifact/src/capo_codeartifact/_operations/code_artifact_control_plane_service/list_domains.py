"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListDomains``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.list_domains_result.ListDomainsResult = (
        capo_codeartifact.types.list_domains_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.list_domains_request.serialize_json(input_)
    ).encode()
...
def list_domains(
    ...
    capo_codeartifact.types.list_domains_result.ListDomainsResult, zapros.Response
]:
