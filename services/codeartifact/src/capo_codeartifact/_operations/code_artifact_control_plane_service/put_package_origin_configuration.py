...
def handle_response(
    ...
    out: capo_codeartifact.types.put_package_origin_configuration_result.PutPackageOriginConfigurationResult = capo_codeartifact.types.put_package_origin_configuration_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.put_package_origin_configuration_request.serialize_json(
            input_
        )
    ).encode()
