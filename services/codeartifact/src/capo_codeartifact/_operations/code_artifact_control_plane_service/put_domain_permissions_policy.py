"""Generated from Smithy shape ``com.amazonaws.codeartifact#PutDomainPermissionsPolicy``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.put_domain_permissions_policy_result.PutDomainPermissionsPolicyResult = capo_codeartifact.types.put_domain_permissions_policy_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.put_domain_permissions_policy_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_domain_permissions_policy(
