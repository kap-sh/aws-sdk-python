...
def handle_response(
    ...
    out: capo_codeartifact.types.get_domain_permissions_policy_result.GetDomainPermissionsPolicyResult = capo_codeartifact.types.get_domain_permissions_policy_result.deserialize_json(
