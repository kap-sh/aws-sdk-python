...
def handle_response(
    ...
    out: capo_codeartifact.types.create_domain_result.CreateDomainResult = (
        capo_codeartifact.types.create_domain_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.create_domain_request.serialize_json(input_)
    ).encode()
...
def create_domain(
    ...
    capo_codeartifact.types.create_domain_result.CreateDomainResult, zapros.Response
]:
