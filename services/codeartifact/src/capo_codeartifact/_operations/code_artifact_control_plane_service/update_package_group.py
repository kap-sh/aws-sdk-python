...
def handle_response(
    ...
    out: capo_codeartifact.types.update_package_group_result.UpdatePackageGroupResult = capo_codeartifact.types.update_package_group_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.update_package_group_request.serialize_json(input_)
    ).encode()
