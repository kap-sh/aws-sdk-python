...
def handle_response(
    ...
    out: capo_codeartifact.types.get_authorization_token_result.GetAuthorizationTokenResult = capo_codeartifact.types.get_authorization_token_result.deserialize_json(
