"""Generated from Smithy shape ``com.amazonaws.codeartifact#DeleteDomain``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.delete_domain_result.DeleteDomainResult = (
        capo_codeartifact.types.delete_domain_result.deserialize_json(
...
def delete_domain(
    ...
    capo_codeartifact.types.delete_domain_result.DeleteDomainResult, zapros.Response
]:
