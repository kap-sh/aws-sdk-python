...
def handle_response(
    ...
    out: capo_codeartifact.types.associate_external_connection_result.AssociateExternalConnectionResult = capo_codeartifact.types.associate_external_connection_result.deserialize_json(
