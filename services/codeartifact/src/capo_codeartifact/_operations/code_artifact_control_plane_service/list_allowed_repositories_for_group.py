...
def handle_response(
    ...
    out: capo_codeartifact.types.list_allowed_repositories_for_group_result.ListAllowedRepositoriesForGroupResult = capo_codeartifact.types.list_allowed_repositories_for_group_result.deserialize_json(
