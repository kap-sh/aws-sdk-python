"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListPackages``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.list_packages_result.ListPackagesResult = (
        capo_codeartifact.types.list_packages_result.deserialize_json(
...
def list_packages(
    ...
    capo_codeartifact.types.list_packages_result.ListPackagesResult, zapros.Response
]:
