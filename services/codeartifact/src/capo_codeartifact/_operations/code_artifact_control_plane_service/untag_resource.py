...
def handle_response(
    ...
    out: capo_codeartifact.types.untag_resource_result.UntagResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.untag_resource_request.serialize_json(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_codeartifact.types.untag_resource_result.UntagResourceResult, zapros.Response
]:
