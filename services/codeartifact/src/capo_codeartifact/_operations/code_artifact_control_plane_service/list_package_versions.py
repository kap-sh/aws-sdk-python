"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListPackageVersions``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.list_package_versions_result.ListPackageVersionsResult = capo_codeartifact.types.list_package_versions_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/package/versions"
    params: dict[str, str] = {}
    if "domain" in input_:
    ...
    if "origin_type" in input_:
        params["originType"] = str(input_["origin_type"])
...
async def async_list_package_versions(
