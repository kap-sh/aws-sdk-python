...
def handle_response(
    ...
    out: capo_codeartifact.types.list_associated_packages_result.ListAssociatedPackagesResult = capo_codeartifact.types.list_associated_packages_result.deserialize_json(
