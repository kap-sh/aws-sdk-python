...
def handle_response(
    ...
    out: capo_codeartifact.types.list_package_version_dependencies_result.ListPackageVersionDependenciesResult = capo_codeartifact.types.list_package_version_dependencies_result.deserialize_json(
