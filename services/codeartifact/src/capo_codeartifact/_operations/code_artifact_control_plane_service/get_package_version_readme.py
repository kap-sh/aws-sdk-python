"""Generated from Smithy shape ``com.amazonaws.codeartifact#GetPackageVersionReadme``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.get_package_version_readme_result.GetPackageVersionReadmeResult = capo_codeartifact.types.get_package_version_readme_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/package/version/readme"
    params: dict[str, str] = {}
    if "domain" in input_:
...
async def async_get_package_version_readme(
