"""Generated from Smithy shape ``com.amazonaws.codeartifact#DescribeDomain``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.describe_domain_result.DescribeDomainResult = (
        capo_codeartifact.types.describe_domain_result.deserialize_json(
...
def describe_domain(
    ...
    capo_codeartifact.types.describe_domain_result.DescribeDomainResult, zapros.Response
]:
