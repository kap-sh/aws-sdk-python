...
def handle_response(
    ...
    out: capo_codeartifact.types.list_tags_for_resource_result.ListTagsForResourceResult = capo_codeartifact.types.list_tags_for_resource_result.deserialize_json(
