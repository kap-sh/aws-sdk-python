...
def handle_response(
    ...
    out: capo_codeartifact.types.update_repository_result.UpdateRepositoryResult = (
        capo_codeartifact.types.update_repository_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.update_repository_request.serialize_json(input_)
    ).encode()
