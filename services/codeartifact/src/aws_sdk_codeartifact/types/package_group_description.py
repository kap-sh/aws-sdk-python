"""Generated from Smithy shape ``com.amazonaws.codeartifact#PackageGroupDescription``."""
...
class PackageGroupDescription(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: PackageGroupDescription) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
    if "pattern" in value:
