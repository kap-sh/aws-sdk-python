"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListPackageVersionAssetsRequest``."""
...
class ListPackageVersionAssetsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListPackageVersionAssetsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListPackageVersionAssetsRequest:
    out: ListPackageVersionAssetsRequest = {}  # type: ignore[typeddict-item]
    return out
