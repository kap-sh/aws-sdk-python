"""Generated from Smithy shape ``com.amazonaws.codeartifact#CreateRepositoryResult``."""
...
class CreateRepositoryResult(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateRepositoryResult) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateRepositoryResult:
    out: CreateRepositoryResult = {}  # type: ignore[typeddict-item]
