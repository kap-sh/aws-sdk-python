...
if TYPE_CHECKING:
    import aws_sdk_codeartifact.types.error_message
    import aws_sdk_codeartifact.types.package_version_error_code


class PackageVersionError(TypedDict):
    error_code: NotRequired[
        "aws_sdk_codeartifact.types.package_version_error_code.PackageVersionErrorCode"
    ]
    ...
    error_message: NotRequired["aws_sdk_codeartifact.types.error_message.ErrorMessage"]
...
def serialize_json(value: PackageVersionError) -> dict:
    ...
    if "error_code" in value:
        ...
        out["errorCode"] = (
            aws_sdk_codeartifact.types.package_version_error_code.serialize_json(
                value["error_code"]
            )
        )
...
def deserialize_json(data: dict) -> PackageVersionError:
    ...
    if "errorCode" in data:
        ...
        out["error_code"] = (
            aws_sdk_codeartifact.types.package_version_error_code.deserialize_json(
                data["errorCode"]
            )
        )
