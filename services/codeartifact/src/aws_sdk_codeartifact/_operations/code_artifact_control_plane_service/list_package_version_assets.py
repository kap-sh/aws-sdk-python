"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListPackageVersionAssets``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_package_version_assets_result.ListPackageVersionAssetsResult = aws_sdk_codeartifact.types.list_package_version_assets_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.list_package_version_assets_request.ListPackageVersionAssetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/package/version/assets"
    params: dict[str, str] = {}
    if "domain" in input_:
...
async def async_list_package_version_assets(
