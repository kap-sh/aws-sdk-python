...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.describe_package_version_result.DescribePackageVersionResult = aws_sdk_codeartifact.types.describe_package_version_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.describe_package_version_request.DescribePackageVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
