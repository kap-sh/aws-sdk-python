...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.get_package_version_asset_request.GetPackageVersionAssetRequest,
) -> zapros.Request:
    ...
    if "asset" in input:
        params["asset"] = str(input["asset"])
    if "package_version_revision" in input:
        params["revision"] = str(input["package_version_revision"])
