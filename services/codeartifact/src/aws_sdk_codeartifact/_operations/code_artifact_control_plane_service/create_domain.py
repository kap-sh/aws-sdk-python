"""Generated from Smithy shape ``com.amazonaws.codeartifact#CreateDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.create_domain_result.CreateDomainResult = (
        aws_sdk_codeartifact.types.create_domain_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.create_domain_request.CreateDomainRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/domain"
    params: dict[str, str] = {}
    if "domain" in input:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.create_domain_request.serialize_json(input)
    ).encode()
...
def create_domain(
    ...
    aws_sdk_codeartifact.types.create_domain_result.CreateDomainResult, zapros.Response
]:
