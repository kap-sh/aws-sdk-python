"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListAllowedRepositoriesForGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_allowed_repositories_for_group_result.ListAllowedRepositoriesForGroupResult = aws_sdk_codeartifact.types.list_allowed_repositories_for_group_result.deserialize_json(
