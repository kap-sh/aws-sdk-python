"""Generated from Smithy shape ``com.amazonaws.codeartifact#DeleteRepository``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.delete_repository_result.DeleteRepositoryResult = (
        aws_sdk_codeartifact.types.delete_repository_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.delete_repository_request.DeleteRepositoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
