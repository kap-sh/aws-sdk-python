...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_sub_package_groups_result.ListSubPackageGroupsResult = aws_sdk_codeartifact.types.list_sub_package_groups_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.list_sub_package_groups_request.ListSubPackageGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
