...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.update_package_group_origin_configuration_result.UpdatePackageGroupOriginConfigurationResult = aws_sdk_codeartifact.types.update_package_group_origin_configuration_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.update_package_group_origin_configuration_request.UpdatePackageGroupOriginConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
