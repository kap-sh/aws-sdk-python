...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.create_repository_request.CreateRepositoryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.create_repository_request.serialize_json(input)
    ).encode()
