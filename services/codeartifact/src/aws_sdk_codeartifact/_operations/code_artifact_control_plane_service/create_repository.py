...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.create_repository_result.CreateRepositoryResult = (
        aws_sdk_codeartifact.types.create_repository_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.create_repository_request.CreateRepositoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.create_repository_request.serialize_json(input_)
    ).encode()
