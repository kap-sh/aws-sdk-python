"""Generated from Smithy shape ``com.amazonaws.codeartifact#GetAuthorizationToken``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.get_authorization_token_result.GetAuthorizationTokenResult = aws_sdk_codeartifact.types.get_authorization_token_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.get_authorization_token_request.GetAuthorizationTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/authorization-token"
    params: dict[str, str] = {}
    if "domain" in input_:
        params["domain"] = str(input_["domain"])
    if "domain_owner" in input_:
        params["domain-owner"] = str(input_["domain_owner"])
    if "duration_seconds" in input_:
        params["duration"] = str(input_["duration_seconds"])
