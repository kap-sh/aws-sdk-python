"""Generated from Smithy shape ``com.amazonaws.codeartifact#DescribePackageGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.describe_package_group_result.DescribePackageGroupResult = aws_sdk_codeartifact.types.describe_package_group_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.describe_package_group_request.DescribePackageGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_package_group(
