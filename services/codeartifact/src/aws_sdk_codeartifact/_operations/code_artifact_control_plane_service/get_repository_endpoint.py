...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.get_repository_endpoint_result.GetRepositoryEndpointResult = aws_sdk_codeartifact.types.get_repository_endpoint_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.get_repository_endpoint_request.GetRepositoryEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
