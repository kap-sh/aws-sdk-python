...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.get_package_version_readme_result.GetPackageVersionReadmeResult = aws_sdk_codeartifact.types.get_package_version_readme_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.get_package_version_readme_request.GetPackageVersionReadmeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
