...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.update_package_versions_status_result.UpdatePackageVersionsStatusResult = aws_sdk_codeartifact.types.update_package_versions_status_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.update_package_versions_status_request.UpdatePackageVersionsStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.update_package_versions_status_request.serialize_json(
            input_
        )
    ).encode()
