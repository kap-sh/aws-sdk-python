...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.create_package_group_request.CreatePackageGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.create_package_group_request.serialize_json(input)
    ).encode()
