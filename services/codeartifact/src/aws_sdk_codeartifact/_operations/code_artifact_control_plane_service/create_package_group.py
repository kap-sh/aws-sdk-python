...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.create_package_group_result.CreatePackageGroupResult = aws_sdk_codeartifact.types.create_package_group_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.create_package_group_request.CreatePackageGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.create_package_group_request.serialize_json(input_)
    ).encode()
