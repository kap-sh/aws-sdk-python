"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListAssociatedPackages``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_associated_packages_result.ListAssociatedPackagesResult = aws_sdk_codeartifact.types.list_associated_packages_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.list_associated_packages_request.ListAssociatedPackagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/list-associated-packages"
    params: dict[str, str] = {}
    if "domain" in input_:
    ...
    if "preview" in input_:
        params["preview"] = str(input_["preview"])
...
async def async_list_associated_packages(
