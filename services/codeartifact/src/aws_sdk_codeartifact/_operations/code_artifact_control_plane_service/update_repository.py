...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.update_repository_request.UpdateRepositoryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.update_repository_request.serialize_json(input)
    ).encode()
