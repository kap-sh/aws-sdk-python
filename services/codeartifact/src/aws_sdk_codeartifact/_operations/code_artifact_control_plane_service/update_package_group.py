"""Generated from Smithy shape ``com.amazonaws.codeartifact#UpdatePackageGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.update_package_group_result.UpdatePackageGroupResult = aws_sdk_codeartifact.types.update_package_group_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.update_package_group_request.UpdatePackageGroupRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/package-group"
    params: dict[str, str] = {}
    if "domain" in input:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.update_package_group_request.serialize_json(input)
    ).encode()
...
async def async_update_package_group(
