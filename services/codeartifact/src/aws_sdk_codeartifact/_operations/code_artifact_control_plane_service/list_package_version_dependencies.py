"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListPackageVersionDependencies``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_package_version_dependencies_result.ListPackageVersionDependenciesResult = aws_sdk_codeartifact.types.list_package_version_dependencies_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.list_package_version_dependencies_request.ListPackageVersionDependenciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/package/version/dependencies"
    params: dict[str, str] = {}
    if "domain" in input_:
...
async def async_list_package_version_dependencies(
