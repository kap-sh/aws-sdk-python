"""Generated from Smithy shape ``com.amazonaws.codeartifact#DescribePackage``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.describe_package_result.DescribePackageResult = (
        aws_sdk_codeartifact.types.describe_package_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.describe_package_request.DescribePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
