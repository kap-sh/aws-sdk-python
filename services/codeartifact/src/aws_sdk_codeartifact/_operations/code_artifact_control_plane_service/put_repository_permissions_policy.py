...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.put_repository_permissions_policy_result.PutRepositoryPermissionsPolicyResult = aws_sdk_codeartifact.types.put_repository_permissions_policy_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.put_repository_permissions_policy_request.PutRepositoryPermissionsPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
