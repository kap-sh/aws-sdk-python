"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListTagsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_tags_for_resource_result.ListTagsForResourceResult = aws_sdk_codeartifact.types.list_tags_for_resource_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/tags"
    params: dict[str, str] = {}
