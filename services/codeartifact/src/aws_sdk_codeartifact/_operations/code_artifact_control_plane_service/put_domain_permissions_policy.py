...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.put_domain_permissions_policy_result.PutDomainPermissionsPolicyResult = aws_sdk_codeartifact.types.put_domain_permissions_policy_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.put_domain_permissions_policy_request.PutDomainPermissionsPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.put_domain_permissions_policy_request.serialize_json(
            input_
        )
    ).encode()
