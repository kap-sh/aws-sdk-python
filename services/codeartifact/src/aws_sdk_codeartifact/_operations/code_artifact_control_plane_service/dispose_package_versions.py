"""Generated from Smithy shape ``com.amazonaws.codeartifact#DisposePackageVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.dispose_package_versions_result.DisposePackageVersionsResult = aws_sdk_codeartifact.types.dispose_package_versions_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.dispose_package_versions_request.DisposePackageVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/package/versions/dispose"
    params: dict[str, str] = {}
    if "domain" in input_:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.dispose_package_versions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_dispose_package_versions(
