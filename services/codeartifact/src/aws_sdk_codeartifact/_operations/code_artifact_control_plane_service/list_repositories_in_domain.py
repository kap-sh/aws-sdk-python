...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.list_repositories_in_domain_request.ListRepositoriesInDomainRequest,
) -> zapros.Request:
    ...
    if "administrator_account" in input:
        params["administrator-account"] = str(input["administrator_account"])
    if "repository_prefix" in input:
        params["repository-prefix"] = str(input["repository_prefix"])
