"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListRepositoriesInDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_repositories_in_domain_result.ListRepositoriesInDomainResult = aws_sdk_codeartifact.types.list_repositories_in_domain_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.list_repositories_in_domain_request.ListRepositoriesInDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/domain/repositories"
    params: dict[str, str] = {}
    if "domain" in input_:
        params["domain"] = str(input_["domain"])
    if "domain_owner" in input_:
        params["domain-owner"] = str(input_["domain_owner"])
    if "administrator_account" in input_:
        params["administrator-account"] = str(input_["administrator_account"])
    if "repository_prefix" in input_:
        params["repository-prefix"] = str(input_["repository_prefix"])
...
async def async_list_repositories_in_domain(
