"""Generated from Smithy shape ``com.amazonaws.codeartifact#DescribeRepository``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.describe_repository_result.DescribeRepositoryResult = aws_sdk_codeartifact.types.describe_repository_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.describe_repository_request.DescribeRepositoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_repository(
