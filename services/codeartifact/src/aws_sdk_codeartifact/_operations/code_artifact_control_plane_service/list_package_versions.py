...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_package_versions_result.ListPackageVersionsResult = aws_sdk_codeartifact.types.list_package_versions_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.list_package_versions_request.ListPackageVersionsRequest,
) -> zapros.Request:
    ...
    if "origin_type" in input:
        params["originType"] = str(input["origin_type"])
