"""Generated from Smithy shape ``com.amazonaws.codeartifact#GetRepositoryPermissionsPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.get_repository_permissions_policy_result.GetRepositoryPermissionsPolicyResult = aws_sdk_codeartifact.types.get_repository_permissions_policy_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.get_repository_permissions_policy_request.GetRepositoryPermissionsPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/repository/permissions/policy"
    params: dict[str, str] = {}
    if "domain" in input_:
...
async def async_get_repository_permissions_policy(
