...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.delete_domain_permissions_policy_result.DeleteDomainPermissionsPolicyResult = aws_sdk_codeartifact.types.delete_domain_permissions_policy_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.delete_domain_permissions_policy_request.DeleteDomainPermissionsPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
