...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_repositories_result.ListRepositoriesResult = (
        aws_sdk_codeartifact.types.list_repositories_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.list_repositories_request.ListRepositoriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
