...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.disassociate_external_connection_result.DisassociateExternalConnectionResult = aws_sdk_codeartifact.types.disassociate_external_connection_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.disassociate_external_connection_request.DisassociateExternalConnectionRequest,
) -> zapros.Request:
    ...
    if "external_connection" in input:
        params["external-connection"] = str(input["external_connection"])
