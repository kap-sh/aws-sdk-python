"""Generated from Smithy shape ``com.amazonaws.codeartifact#DeletePackage``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.delete_package_result.DeletePackageResult = (
        aws_sdk_codeartifact.types.delete_package_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.delete_package_request.DeletePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
