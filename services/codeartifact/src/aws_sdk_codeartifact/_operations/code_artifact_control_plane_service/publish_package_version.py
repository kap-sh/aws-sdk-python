...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.publish_package_version_result.PublishPackageVersionResult = aws_sdk_codeartifact.types.publish_package_version_result.deserialize_json(
