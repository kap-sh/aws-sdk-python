...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.delete_package_group_result.DeletePackageGroupResult = aws_sdk_codeartifact.types.delete_package_group_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.delete_package_group_request.DeletePackageGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
