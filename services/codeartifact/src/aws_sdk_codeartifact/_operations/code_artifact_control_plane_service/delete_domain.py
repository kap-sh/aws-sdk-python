...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.delete_domain_result.DeleteDomainResult = (
        aws_sdk_codeartifact.types.delete_domain_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.delete_domain_request.DeleteDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_domain(
    ...
    aws_sdk_codeartifact.types.delete_domain_result.DeleteDomainResult, zapros.Response
]:
