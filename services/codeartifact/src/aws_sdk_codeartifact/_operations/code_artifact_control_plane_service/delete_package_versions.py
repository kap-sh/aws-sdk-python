...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.delete_package_versions_request.DeletePackageVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.delete_package_versions_request.serialize_json(
            input_
        )
    ).encode()
