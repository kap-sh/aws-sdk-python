"""Generated from Smithy shape ``com.amazonaws.codeartifact#DeletePackageVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.delete_package_versions_result.DeletePackageVersionsResult = aws_sdk_codeartifact.types.delete_package_versions_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.delete_package_versions_request.DeletePackageVersionsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/package/versions/delete"
    params: dict[str, str] = {}
    if "domain" in input:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.delete_package_versions_request.serialize_json(input)
    ).encode()
...
async def async_delete_package_versions(
