...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.get_associated_package_group_result.GetAssociatedPackageGroupResult = aws_sdk_codeartifact.types.get_associated_package_group_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.get_associated_package_group_request.GetAssociatedPackageGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
