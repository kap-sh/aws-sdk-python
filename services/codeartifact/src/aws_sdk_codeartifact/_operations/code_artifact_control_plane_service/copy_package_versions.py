...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.copy_package_versions_result.CopyPackageVersionsResult = aws_sdk_codeartifact.types.copy_package_versions_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.copy_package_versions_request.CopyPackageVersionsRequest,
) -> zapros.Request:
    ...
    if "source_repository" in input:
        params["source-repository"] = str(input["source_repository"])
    if "destination_repository" in input:
        params["destination-repository"] = str(input["destination_repository"])
    if "format" in input:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.copy_package_versions_request.serialize_json(input)
    ).encode()
