"""Generated from Smithy shape ``com.amazonaws.codeartifact#PutPackageOriginConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.put_package_origin_configuration_result.PutPackageOriginConfigurationResult = aws_sdk_codeartifact.types.put_package_origin_configuration_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.put_package_origin_configuration_request.PutPackageOriginConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/package"
    params: dict[str, str] = {}
    if "domain" in input_:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.put_package_origin_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_package_origin_configuration(
