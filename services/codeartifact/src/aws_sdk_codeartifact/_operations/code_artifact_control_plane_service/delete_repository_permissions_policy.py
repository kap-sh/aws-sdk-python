"""Generated from Smithy shape ``com.amazonaws.codeartifact#DeleteRepositoryPermissionsPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.delete_repository_permissions_policy_result.DeleteRepositoryPermissionsPolicyResult = aws_sdk_codeartifact.types.delete_repository_permissions_policy_result.deserialize_json(
