"""Generated from Smithy shape ``com.amazonaws.codeartifact#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.untag_resource_result.UntagResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/untag"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.untag_resource_request.serialize_json(input_)
    ).encode()
