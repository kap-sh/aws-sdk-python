...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_package_groups_result.ListPackageGroupsResult = aws_sdk_codeartifact.types.list_package_groups_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.list_package_groups_request.ListPackageGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
