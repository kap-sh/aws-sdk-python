...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.describe_domain_result.DescribeDomainResult = (
        aws_sdk_codeartifact.types.describe_domain_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.describe_domain_request.DescribeDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
