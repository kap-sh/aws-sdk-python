"""Generated from Smithy shape ``com.amazonaws.codeartifact#GetDomainPermissionsPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.get_domain_permissions_policy_result.GetDomainPermissionsPolicyResult = aws_sdk_codeartifact.types.get_domain_permissions_policy_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codeartifact.types.get_domain_permissions_policy_request.GetDomainPermissionsPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_domain_permissions_policy(
