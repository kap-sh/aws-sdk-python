...
def handle_response(
    ...
    out: aws_sdk_codeartifact.types.list_domains_result.ListDomainsResult = (
        aws_sdk_codeartifact.types.list_domains_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_codeartifact.types.list_domains_request.ListDomainsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeartifact.types.list_domains_request.serialize_json(input)
    ).encode()
...
def list_domains(
    ...
    aws_sdk_codeartifact.types.list_domains_result.ListDomainsResult, zapros.Response
]:
