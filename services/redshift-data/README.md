...
```
pip install aws-sdk-redshift-data
```

## Usage

```python
from aws_sdk_redshift_data import AsyncRedshiftDataClient
...
```python
from aws_sdk_redshift_data import AsyncRedshiftDataClient
from aws_sdk_redshift_data.error import ActiveSessionsExceededException
