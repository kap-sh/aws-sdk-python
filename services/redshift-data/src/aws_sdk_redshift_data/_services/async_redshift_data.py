...
from aws_sdk_redshift_data._auth._zapros_handler import AuthMiddleware
from aws_sdk_redshift_data._pagination import resolve_path as _resolve_path
from aws_sdk_redshift_data._services._aws_config import aaws_config
...
if TYPE_CHECKING:
    ...
    import aws_sdk_redshift_data.types.cancel_statement_request
    import aws_sdk_redshift_data.types.cancel_statement_response
    ...
    import aws_sdk_redshift_data.types.describe_statement_request
    import aws_sdk_redshift_data.types.describe_statement_response
    import aws_sdk_redshift_data.types.describe_table_request
    import aws_sdk_redshift_data.types.describe_table_response
    ...
    import aws_sdk_redshift_data.types.get_statement_result_request
    import aws_sdk_redshift_data.types.get_statement_result_response
    import aws_sdk_redshift_data.types.get_statement_result_v2_request
    import aws_sdk_redshift_data.types.get_statement_result_v2_response
    import aws_sdk_redshift_data.types.list_databases_request
    import aws_sdk_redshift_data.types.list_databases_response
    ...
    import aws_sdk_redshift_data.types.list_statements_request
    import aws_sdk_redshift_data.types.list_statements_response
    import aws_sdk_redshift_data.types.list_tables_request
    import aws_sdk_redshift_data.types.list_tables_response
...
class AsyncRedshiftDataClient:
    ...
    async def batch_execute_statement(
        ...
        *,
        ...
        secret_arn: Optional["aws_sdk_redshift_data.types.secret_arn.SecretArn"] = None,
        db_user: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        database: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        ...
        client_token: Optional[
            "aws_sdk_redshift_data.types.client_token.ClientToken"
        ] = None,
        ...
        session_id: Optional["aws_sdk_redshift_data.types.uuid.UUID"] = None,
        ...
        Raises:
            aws_sdk_redshift_data.errors.active_sessions_exceeded_exception.ActiveSessionsExceededException: <p>The Amazon Redshift Data API operation failed because the maximum number of active sessions exceeded.</p>
            aws_sdk_redshift_data.errors.active_statements_exceeded_exception.ActiveStatementsExceededException: <p>The number of active statements exceeds the limit.</p>
            aws_sdk_redshift_data.errors.batch_execute_statement_exception.BatchExecuteStatementException: <p>An SQL statement encountered an environmental error while running.</p>
            aws_sdk_redshift_data.errors.internal_server_exception.InternalServerException: <p>The Amazon Redshift Data API operation failed due to invalid input. </p>
            aws_sdk_redshift_data.errors.resource_not_found_exception.ResourceNotFoundException: <p>The Amazon Redshift Data API operation failed due to a missing resource. </p>
            aws_sdk_redshift_data.errors.validation_exception.ValidationException: <p>The Amazon Redshift Data API operation failed due to invalid input. </p>
            aws_sdk_redshift_data.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.batch_execute_statement_input.BatchExecuteStatementInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.batch_execute_statement_output.BatchExecuteStatementOutput"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.batch_execute_statement

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.batch_execute_statement.async_batch_execute_statement(
    ...
    async def cancel_statement(
        ...
        *,
        ...
        "aws_sdk_redshift_data.types.cancel_statement_response.CancelStatementResponse"
    ):
        ...
        Raises:
            aws_sdk_redshift_data.errors.database_connection_exception.DatabaseConnectionException: <p>Connection to a database failed.</p>
            aws_sdk_redshift_data.errors.internal_server_exception.InternalServerException: <p>The Amazon Redshift Data API operation failed due to invalid input. </p>
            aws_sdk_redshift_data.errors.query_timeout_exception.QueryTimeoutException: <p>The Amazon Redshift Data API operation failed due to timeout.</p>
            aws_sdk_redshift_data.errors.resource_not_found_exception.ResourceNotFoundException: <p>The Amazon Redshift Data API operation failed due to a missing resource. </p>
            aws_sdk_redshift_data.errors.validation_exception.ValidationException: <p>The Amazon Redshift Data API operation failed due to invalid input. </p>
            aws_sdk_redshift_data.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.cancel_statement_request.CancelStatementRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.cancel_statement_response.CancelStatementResponse"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.cancel_statement

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.cancel_statement.async_cancel_statement(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_statement(
        ...
        *,
        config_overrides: Optional[AsyncRedshiftDataClientConfig] = None,
    ) -> "aws_sdk_redshift_data.types.describe_statement_response.DescribeStatementResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.describe_statement_request.DescribeStatementRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.describe_statement_response.DescribeStatementResponse"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.describe_statement

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.describe_statement.async_describe_statement(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_table(
        ...
        *,
        ...
        secret_arn: Optional["aws_sdk_redshift_data.types.secret_arn.SecretArn"] = None,
        db_user: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        connected_database: Optional[
            "aws_sdk_redshift_data.types.string.String"
        ] = None,
        schema: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        table: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        next_token: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        max_results: Optional["aws_sdk_redshift_data.types.page_size.PageSize"] = None,
        workgroup_name: Optional[
            "aws_sdk_redshift_data.types.workgroup_name_string.WorkgroupNameString"
        ] = None,
    ) -> "aws_sdk_redshift_data.types.describe_table_response.DescribeTableResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.describe_table_request.DescribeTableRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.describe_table_response.DescribeTableResponse"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.describe_table

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.describe_table.async_describe_table(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_redshift_data.types.column_metadata.ColumnMetadata]":
        _token = next_token
        while True:
    ...
    async def execute_statement(
        ...
        *,
        ...
        Raises:
            aws_sdk_redshift_data.errors.active_sessions_exceeded_exception.ActiveSessionsExceededException: <p>The Amazon Redshift Data API operation failed because the maximum number of active sessions exceeded.</p>
            aws_sdk_redshift_data.errors.active_statements_exceeded_exception.ActiveStatementsExceededException: <p>The number of active statements exceeds the limit.</p>
            aws_sdk_redshift_data.errors.execute_statement_exception.ExecuteStatementException: <p>The SQL statement encountered an environmental error while running.</p>
            aws_sdk_redshift_data.errors.internal_server_exception.InternalServerException: <p>The Amazon Redshift Data API operation failed due to invalid input. </p>
            aws_sdk_redshift_data.errors.resource_not_found_exception.ResourceNotFoundException: <p>The Amazon Redshift Data API operation failed due to a missing resource. </p>
            aws_sdk_redshift_data.errors.validation_exception.ValidationException: <p>The Amazon Redshift Data API operation failed due to invalid input. </p>
            aws_sdk_redshift_data.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.execute_statement_input.ExecuteStatementInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.execute_statement_output.ExecuteStatementOutput"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.execute_statement

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.execute_statement.async_execute_statement(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_statement_result(
        ...
        *,
        config_overrides: Optional[AsyncRedshiftDataClientConfig] = None,
        next_token: Optional["aws_sdk_redshift_data.types.string.String"] = None,
    ) -> "aws_sdk_redshift_data.types.get_statement_result_response.GetStatementResultResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.get_statement_result_request.GetStatementResultRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.get_statement_result_response.GetStatementResultResponse"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.get_statement_result

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.get_statement_result.async_get_statement_result(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_statement_result(
        ...
        *,
        config_overrides: Optional[AsyncRedshiftDataClientConfig] = None,
        next_token: Optional["aws_sdk_redshift_data.types.string.String"] = None,
    ) -> "AsyncIterator[aws_sdk_redshift_data.types.field_list.FieldList]":
        _token = next_token
        while True:
    ...
    async def get_statement_result_v2(
        ...
        *,
        config_overrides: Optional[AsyncRedshiftDataClientConfig] = None,
        next_token: Optional["aws_sdk_redshift_data.types.string.String"] = None,
    ) -> "aws_sdk_redshift_data.types.get_statement_result_v2_response.GetStatementResultV2Response":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.get_statement_result_v2_request.GetStatementResultV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.get_statement_result_v2_response.GetStatementResultV2Response"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.get_statement_result_v2

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.get_statement_result_v2.async_get_statement_result_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_statement_result_v2(
        ...
        *,
        config_overrides: Optional[AsyncRedshiftDataClientConfig] = None,
        next_token: Optional["aws_sdk_redshift_data.types.string.String"] = None,
    ) -> "AsyncIterator[aws_sdk_redshift_data.types.query_records.QueryRecords]":
        _token = next_token
        while True:
    ...
    async def list_databases(
        ...
        *,
    ...
    ) -> "aws_sdk_redshift_data.types.list_databases_response.ListDatabasesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.list_databases_request.ListDatabasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.list_databases_response.ListDatabasesResponse"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.list_databases

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.list_databases.async_list_databases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_redshift_data.types.string.String]":
        _token = next_token
        while True:
    ...
    async def list_schemas(
        ...
        *,
        ...
        schema_pattern: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        next_token: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        max_results: Optional["aws_sdk_redshift_data.types.page_size.PageSize"] = None,
        workgroup_name: Optional[
            "aws_sdk_redshift_data.types.workgroup_name_string.WorkgroupNameString"
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.list_schemas_request.ListSchemasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.list_schemas_response.ListSchemasResponse"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.list_schemas

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.list_schemas.async_list_schemas(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_statements(
        ...
        *,
        ...
        max_results: Optional[
            "aws_sdk_redshift_data.types.list_statements_limit.ListStatementsLimit"
        ] = None,
        statement_name: Optional[
            "aws_sdk_redshift_data.types.statement_name_string.StatementNameString"
        ] = None,
        status: Optional[
            "aws_sdk_redshift_data.types.status_string.StatusString"
        ] = None,
    ...
    ) -> "aws_sdk_redshift_data.types.list_statements_response.ListStatementsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.list_statements_request.ListStatementsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.list_statements_response.ListStatementsResponse"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.list_statements

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.list_statements.async_list_statements(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_redshift_data.types.statement_data.StatementData]":
        _token = next_token
        while True:
    ...
    async def list_tables(
        ...
        *,
        ...
        schema_pattern: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        table_pattern: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        next_token: Optional["aws_sdk_redshift_data.types.string.String"] = None,
        max_results: Optional["aws_sdk_redshift_data.types.page_size.PageSize"] = None,
        workgroup_name: Optional[
            "aws_sdk_redshift_data.types.workgroup_name_string.WorkgroupNameString"
        ] = None,
    ) -> "aws_sdk_redshift_data.types.list_tables_response.ListTablesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_redshift_data.types.list_tables_request.ListTablesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_redshift_data.types.list_tables_response.ListTablesResponse"
        ]:
            import aws_sdk_redshift_data._operations.redshift_data.list_tables

            (
                output,
                http_response,
            ) = await aws_sdk_redshift_data._operations.redshift_data.list_tables.async_list_tables(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_redshift_data.types.table_member.TableMember]":
        _token = next_token
        while True:
