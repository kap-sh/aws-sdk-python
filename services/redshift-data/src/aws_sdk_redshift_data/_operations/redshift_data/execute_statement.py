...
def build_request(
    ...
    input_: aws_sdk_redshift_data.types.execute_statement_input.ExecuteStatementInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_data.types.execute_statement_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
