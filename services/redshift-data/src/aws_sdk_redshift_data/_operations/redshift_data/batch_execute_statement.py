"""Generated from Smithy shape ``com.amazonaws.redshiftdata#BatchExecuteStatement``."""
...
if TYPE_CHECKING:
    import aws_sdk_redshift_data.types.batch_execute_statement_input
    import aws_sdk_redshift_data.types.batch_execute_statement_output
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BatchExecuteStatementException":
            import aws_sdk_redshift_data.errors.batch_execute_statement_exception

            raise aws_sdk_redshift_data.errors.batch_execute_statement_exception.BatchExecuteStatementException.from_aws_json_1_1(
                data
            )
...
) -> aws_sdk_redshift_data.types.batch_execute_statement_output.BatchExecuteStatementOutput:
    import aws_sdk_redshift_data.types.batch_execute_statement_output

    out: aws_sdk_redshift_data.types.batch_execute_statement_output.BatchExecuteStatementOutput = aws_sdk_redshift_data.types.batch_execute_statement_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_data.types.batch_execute_statement_input.BatchExecuteStatementInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftData.BatchExecuteStatement"
    import aws_sdk_redshift_data.types.batch_execute_statement_input

    body: bytes | None = json.dumps(
        aws_sdk_redshift_data.types.batch_execute_statement_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
