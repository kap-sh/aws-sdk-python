...
class RedshiftDataError(Exception):
    """Base class for all RedshiftData service errors."""


class ServiceError(RedshiftDataError):
...
class SerializationError(RedshiftDataError):
    """Raised when a value cannot be serialized."""


class DeserializationError(RedshiftDataError):
...
class WaiterFailedError(RedshiftDataError):
...
class WaiterTimeoutError(RedshiftDataError):
