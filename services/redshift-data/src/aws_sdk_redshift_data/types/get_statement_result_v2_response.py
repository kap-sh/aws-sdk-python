...
if TYPE_CHECKING:
    import aws_sdk_redshift_data.types.column_metadata_list
    import aws_sdk_redshift_data.types.formatted_sql_records
...
class GetStatementResultV2Response(TypedDict, closed=True):
    ...
    column_metadata: NotRequired[
        "aws_sdk_redshift_data.types.column_metadata_list.ColumnMetadataList"
    ]
    """<p>The properties (metadata) of a column.</p>"""
    total_num_rows: "aws_sdk_redshift_data.types.long.Long"
...
def serialize_aws_json_1_1(value: GetStatementResultV2Response) -> dict:
    ...
    out["Records"] = (
        aws_sdk_redshift_data.types.formatted_sql_records.serialize_aws_json_1_1(
            value["records"]
        )
    )
    if "column_metadata" in value:
        ...
        out["ColumnMetadata"] = (
            aws_sdk_redshift_data.types.column_metadata_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetStatementResultV2Response:
    ...
    if "Records" in data:
        ...
        out["records"] = (
            aws_sdk_redshift_data.types.formatted_sql_records.deserialize_aws_json_1_1(
                data["Records"]
            )
        )
    else:
    ...
    if "ColumnMetadata" in data:
        ...
        out["column_metadata"] = (
            aws_sdk_redshift_data.types.column_metadata_list.deserialize_aws_json_1_1(
                data["ColumnMetadata"]
            )
        )
