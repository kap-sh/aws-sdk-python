...
if TYPE_CHECKING:
    import aws_sdk_redshift_data.types.bool
    import aws_sdk_redshift_data.types.integer
    import aws_sdk_redshift_data.types.string


class ColumnMetadata(TypedDict):
    is_case_sensitive: "aws_sdk_redshift_data.types.bool.bool"
    """<p>A value that indicates whether the column is case-sensitive. </p>"""
    is_currency: "aws_sdk_redshift_data.types.bool.bool"
    """<p>A value that indicates whether the column contains currency values.</p>"""
    is_signed: "aws_sdk_redshift_data.types.bool.bool"
    """<p>A value that indicates whether an integer column is signed.</p>"""
    label: NotRequired["aws_sdk_redshift_data.types.string.String"]
    """<p>The label for the column. </p>"""
    name: NotRequired["aws_sdk_redshift_data.types.string.String"]
    """<p>The name of the column. </p>"""
    nullable: "aws_sdk_redshift_data.types.integer.Integer"
    """<p>A value that indicates whether the column is nullable. </p>"""
    precision: "aws_sdk_redshift_data.types.integer.Integer"
    """<p>The precision value of a decimal number column, or the column length for a non-numeric column. </p>"""
    scale: "aws_sdk_redshift_data.types.integer.Integer"
    """<p>The scale value of a decimal number column. </p>"""
    schema_name: NotRequired["aws_sdk_redshift_data.types.string.String"]
    ...
    type_name: NotRequired["aws_sdk_redshift_data.types.string.String"]
    """<p>The database-specific data type of the column. </p>"""
    length: "aws_sdk_redshift_data.types.integer.Integer"
    """<p>The length of the column.</p>"""
    column_default: NotRequired["aws_sdk_redshift_data.types.string.String"]
