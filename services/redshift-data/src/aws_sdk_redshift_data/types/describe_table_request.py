"""Generated from Smithy shape ``com.amazonaws.redshiftdata#DescribeTableRequest``."""
...
class DescribeTableRequest(TypedDict):
    ...
    table: NotRequired["aws_sdk_redshift_data.types.string.String"]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeTableRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeTableRequest:
    ...
    if "Database" in data:
        ...
        raise DeserializationError("DescribeTableRequest.database required")
