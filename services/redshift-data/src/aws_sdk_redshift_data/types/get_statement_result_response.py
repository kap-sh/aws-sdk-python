...
class GetStatementResultResponse(TypedDict):
    records: "aws_sdk_redshift_data.types.sql_records.SqlRecords"
...
def serialize_aws_json_1_1(value: GetStatementResultResponse) -> dict:
    ...
    out["Records"] = aws_sdk_redshift_data.types.sql_records.serialize_aws_json_1_1(
        value["records"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> GetStatementResultResponse:
    ...
    if "Records" in data:
        ...
        out["records"] = (
            aws_sdk_redshift_data.types.sql_records.deserialize_aws_json_1_1(
                data["Records"]
            )
        )
    else:
