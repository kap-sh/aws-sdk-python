"""Generated from Smithy shape ``com.amazonaws.redshiftdata#GetStatementResultRequest``."""
...
class GetStatementResultRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetStatementResultRequest) -> dict:
    out: dict = {}
    out["Id"] = value["id"]
...
def deserialize_aws_json_1_1(data: dict) -> GetStatementResultRequest:
    out: GetStatementResultRequest = {}  # type: ignore[typeddict-item]
    if "Id" in data:
        out["id"] = data["Id"]
    else:
        raise DeserializationError("GetStatementResultRequest.id required")
