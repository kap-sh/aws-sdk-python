...
class StatementData(TypedDict, closed=True):
    ...
    query_strings: NotRequired[
        "capo_redshift_data.types.statement_string_list.StatementStringList"
    ]
...
def serialize_aws_json_1_1(value: StatementData) -> dict:
    ...
    if "query_strings" in value:
        ...
        out["QueryStrings"] = (
            capo_redshift_data.types.statement_string_list.serialize_aws_json_1_1(
                value["query_strings"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> StatementData:
    ...
    if "QueryStrings" in data:
        ...
        out["query_strings"] = (
            capo_redshift_data.types.statement_string_list.deserialize_aws_json_1_1(
                data["QueryStrings"]
            )
        )
