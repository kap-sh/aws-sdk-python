"""Generated from Smithy shape ``com.amazonaws.redshiftdata#ExecuteStatementOutput``."""
...
class ExecuteStatementOutput(TypedDict, closed=True):
    id: NotRequired["capo_redshift_data.types.uuid.UUID"]
    ...
    db_groups: NotRequired["capo_redshift_data.types.db_group_list.DbGroupList"]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ExecuteStatementOutput) -> dict:
    out: dict = {}
    if "id" in value:
        out["Id"] = value["id"]
    ...
    if "db_groups" in value:
        ...
        out["DbGroups"] = capo_redshift_data.types.db_group_list.serialize_aws_json_1_1(
            value["db_groups"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ExecuteStatementOutput:
    ...
    if "DbGroups" in data:
        ...
        out["db_groups"] = (
            capo_redshift_data.types.db_group_list.deserialize_aws_json_1_1(
                data["DbGroups"]
            )
        )
    if "Database" in data:
