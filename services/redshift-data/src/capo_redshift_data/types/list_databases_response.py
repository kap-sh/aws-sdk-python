...
if TYPE_CHECKING:
    import capo_redshift_data.types.database_list
    import capo_redshift_data.types.string


class ListDatabasesResponse(TypedDict, closed=True):
    databases: NotRequired["capo_redshift_data.types.database_list.DatabaseList"]
...
def serialize_aws_json_1_1(value: ListDatabasesResponse) -> dict:
    ...
    if "databases" in value:
        ...
        out["Databases"] = (
            capo_redshift_data.types.database_list.serialize_aws_json_1_1(
                value["databases"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDatabasesResponse:
    ...
    if "Databases" in data:
        ...
        out["databases"] = (
            capo_redshift_data.types.database_list.deserialize_aws_json_1_1(
                data["Databases"]
            )
        )
