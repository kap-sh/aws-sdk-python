...
if TYPE_CHECKING:
    ...
    import capo_redshift_data.types.table_list


class ListTablesResponse(TypedDict, closed=True):
    tables: NotRequired["capo_redshift_data.types.table_list.TableList"]
...
def serialize_aws_json_1_1(value: ListTablesResponse) -> dict:
    ...
    if "tables" in value:
        ...
        out["Tables"] = capo_redshift_data.types.table_list.serialize_aws_json_1_1(
            value["tables"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListTablesResponse:
    ...
    if "Tables" in data:
        ...
        out["tables"] = capo_redshift_data.types.table_list.deserialize_aws_json_1_1(
            data["Tables"]
        )
