"""Generated from Smithy shape ``com.amazonaws.s3outposts#ListOutpostsWithS3``."""
...
def handle_response(
    ...
    out: capo_s3outposts.types.list_outposts_with_s3_result.ListOutpostsWithS3Result = (
        capo_s3outposts.types.list_outposts_with_s3_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/S3Outposts/ListOutpostsWithS3"
    params: dict[str, str] = {}
...
async def async_list_outposts_with_s3(
