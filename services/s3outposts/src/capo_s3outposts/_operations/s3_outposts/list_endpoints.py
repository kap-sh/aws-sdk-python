"""Generated from Smithy shape ``com.amazonaws.s3outposts#ListEndpoints``."""
...
def handle_response(
    ...
    out: capo_s3outposts.types.list_endpoints_result.ListEndpointsResult = (
        capo_s3outposts.types.list_endpoints_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/S3Outposts/ListEndpoints"
    params: dict[str, str] = {}
...
def list_endpoints(
    ...
    capo_s3outposts.types.list_endpoints_result.ListEndpointsResult, zapros.Response
]:
