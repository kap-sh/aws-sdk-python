...
if TYPE_CHECKING:
    import capo_s3outposts.types.cidr_block
    ...
    import capo_s3outposts.types.vpc_id


class Endpoint(TypedDict, closed=True):
    endpoint_arn: NotRequired["capo_s3outposts.types.endpoint_arn.EndpointArn"]
    """<p>The Amazon Resource Name (ARN) of the endpoint.</p>"""
    outposts_id: NotRequired["capo_s3outposts.types.outpost_id.OutpostId"]
    """<p>The ID of the Outposts.</p>"""
    cidr_block: NotRequired["capo_s3outposts.types.cidr_block.CidrBlock"]
    """<p>The VPC CIDR committed by this endpoint.</p>"""
    status: NotRequired["capo_s3outposts.types.endpoint_status.EndpointStatus"]
    """<p>The status of the endpoint.</p>"""
    creation_time: NotRequired["capo_s3outposts.types.creation_time.CreationTime"]
    """<p>The time the endpoint was created.</p>"""
    network_interfaces: NotRequired[
        "capo_s3outposts.types.network_interfaces.NetworkInterfaces"
    ]
    """<p>The network interface of the endpoint.</p>"""
    vpc_id: NotRequired["capo_s3outposts.types.vpc_id.VpcId"]
    """<p>The ID of the VPC used for the endpoint.</p>"""
    subnet_id: NotRequired["capo_s3outposts.types.subnet_id.SubnetId"]
    """<p>The ID of the subnet used for the endpoint.</p>"""
    security_group_id: NotRequired[
        "capo_s3outposts.types.security_group_id.SecurityGroupId"
    ]
    ...
    failed_reason: NotRequired["capo_s3outposts.types.failed_reason.FailedReason"]
...
def serialize_json(value: Endpoint) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = capo_s3outposts.types.endpoint_status.serialize_json(
            value["status"]
        )
    if "creation_time" in value:
        import capo_s3outposts.types.creation_time

        out["CreationTime"] = capo_s3outposts.types.creation_time.serialize_json(
            value["creation_time"]
        )
    if "network_interfaces" in value:
        ...
        out["NetworkInterfaces"] = (
            capo_s3outposts.types.network_interfaces.serialize_json(
    ...
    if "access_type" in value:
        ...
        out["AccessType"] = capo_s3outposts.types.endpoint_access_type.serialize_json(
            value["access_type"]
        )
    ...
    if "failed_reason" in value:
        ...
        out["FailedReason"] = capo_s3outposts.types.failed_reason.serialize_json(
            value["failed_reason"]
        )
    return out
...
def deserialize_json(data: dict) -> Endpoint:
    ...
    if "NetworkInterfaces" in data:
        ...
        out["network_interfaces"] = (
            capo_s3outposts.types.network_interfaces.deserialize_json(
    ...
    if "AccessType" in data:
        ...
        out["access_type"] = (
            capo_s3outposts.types.endpoint_access_type.deserialize_json(
                data["AccessType"]
            )
        )
