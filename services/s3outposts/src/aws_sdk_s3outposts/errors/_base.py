...
class S3OutpostsError(Exception):
    """Base class for all S3Outposts service errors."""


class ServiceError(S3OutpostsError):
...
class SerializationError(S3OutpostsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(S3OutpostsError):
...
class WaiterFailedError(S3OutpostsError):
...
class WaiterTimeoutError(S3OutpostsError):
