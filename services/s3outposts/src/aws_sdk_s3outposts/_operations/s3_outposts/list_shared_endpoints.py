...
def handle_response(
    ...
    out: aws_sdk_s3outposts.types.list_shared_endpoints_result.ListSharedEndpointsResult = aws_sdk_s3outposts.types.list_shared_endpoints_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3outposts.types.list_shared_endpoints_request.ListSharedEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
