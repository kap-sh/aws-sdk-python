...
def handle_response(
    ...
    out: aws_sdk_s3outposts.types.list_endpoints_result.ListEndpointsResult = (
        aws_sdk_s3outposts.types.list_endpoints_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3outposts.types.list_endpoints_request.ListEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_endpoints(
    ...
    aws_sdk_s3outposts.types.list_endpoints_result.ListEndpointsResult, zapros.Response
]:
