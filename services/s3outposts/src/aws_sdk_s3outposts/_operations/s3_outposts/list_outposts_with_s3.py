...
def handle_response(
    ...
    out: aws_sdk_s3outposts.types.list_outposts_with_s3_result.ListOutpostsWithS3Result = aws_sdk_s3outposts.types.list_outposts_with_s3_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3outposts.types.list_outposts_with_s3_request.ListOutpostsWithS3Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
