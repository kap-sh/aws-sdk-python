...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_s3outposts.errors.conflict_exception

            raise aws_sdk_s3outposts.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_s3outposts.types.create_endpoint_result.CreateEndpointResult = (
        aws_sdk_s3outposts.types.create_endpoint_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_s3outposts.types.create_endpoint_request.CreateEndpointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3outposts.types.create_endpoint_request.serialize_json(input)
    ).encode()
