...
from ._services.async_s3_outposts import AsyncS3OutpostsClient as AsyncS3OutpostsClient
from ._services.s3_outposts import S3OutpostsClient as S3OutpostsClient
