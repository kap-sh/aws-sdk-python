...
class AsyncCognitoSyncClientConfig(TypedDict, total=False):
...
class AsyncCognitoSyncClient:
    ...
    def __init__(
        ...
        self.config = AsyncCognitoSyncClientConfig(
            {
    ...
    async def bulk_publish(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.bulk_publish_request.BulkPublishRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.bulk_publish_response.BulkPublishResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.bulk_publish.async_bulk_publish(
    ...
    async def delete_dataset(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.delete_dataset_request.DeleteDatasetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.delete_dataset_response.DeleteDatasetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.delete_dataset.async_delete_dataset(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_dataset(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.describe_dataset_request.DescribeDatasetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.describe_dataset_response.DescribeDatasetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.describe_dataset.async_describe_dataset(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_identity_pool_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.describe_identity_pool_usage_request.DescribeIdentityPoolUsageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.describe_identity_pool_usage_response.DescribeIdentityPoolUsageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.describe_identity_pool_usage.async_describe_identity_pool_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_identity_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.describe_identity_usage_request.DescribeIdentityUsageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.describe_identity_usage_response.DescribeIdentityUsageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.describe_identity_usage.async_describe_identity_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_bulk_publish_details(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.get_bulk_publish_details_request.GetBulkPublishDetailsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.get_bulk_publish_details_response.GetBulkPublishDetailsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.get_bulk_publish_details.async_get_bulk_publish_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_cognito_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.get_cognito_events_request.GetCognitoEventsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.get_cognito_events_response.GetCognitoEventsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.get_cognito_events.async_get_cognito_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_identity_pool_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.get_identity_pool_configuration_request.GetIdentityPoolConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.get_identity_pool_configuration_response.GetIdentityPoolConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.get_identity_pool_configuration.async_get_identity_pool_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_datasets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.list_datasets_request.ListDatasetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.list_datasets_response.ListDatasetsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.list_datasets.async_list_datasets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_identity_pool_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.list_identity_pool_usage_request.ListIdentityPoolUsageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.list_identity_pool_usage_response.ListIdentityPoolUsageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.list_identity_pool_usage.async_list_identity_pool_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.list_records_request.ListRecordsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.list_records_response.ListRecordsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.list_records.async_list_records(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.register_device_request.RegisterDeviceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.register_device_response.RegisterDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.register_device.async_register_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_cognito_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.set_cognito_events_request.SetCognitoEventsRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.set_cognito_events.async_set_cognito_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_identity_pool_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.set_identity_pool_configuration_request.SetIdentityPoolConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.set_identity_pool_configuration_response.SetIdentityPoolConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.set_identity_pool_configuration.async_set_identity_pool_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def subscribe_to_dataset(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.subscribe_to_dataset_request.SubscribeToDatasetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.subscribe_to_dataset_response.SubscribeToDatasetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.subscribe_to_dataset.async_subscribe_to_dataset(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def unsubscribe_from_dataset(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.unsubscribe_from_dataset_request.UnsubscribeFromDatasetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.unsubscribe_from_dataset_response.UnsubscribeFromDatasetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.unsubscribe_from_dataset.async_unsubscribe_from_dataset(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_sync.types.update_records_request.UpdateRecordsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_sync.types.update_records_response.UpdateRecordsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_sync._operations.aws_cognito_sync_service.update_records.async_update_records(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
