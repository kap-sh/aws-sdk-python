...
if TYPE_CHECKING:
    import aws_sdk_cognito_sync.types.bulk_publish_status
...
class GetBulkPublishDetailsResponse(TypedDict):
    identity_pool_id: NotRequired[
        "aws_sdk_cognito_sync.types.identity_pool_id.IdentityPoolId"
    ]
    """A name-spaced GUID (for example, us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito. GUID generation is unique within a region."""
    bulk_publish_start_time: NotRequired["aws_sdk_cognito_sync.types.date.Date"]
    """The date/time at which the last bulk publish was initiated."""
    bulk_publish_complete_time: NotRequired["aws_sdk_cognito_sync.types.date.Date"]
    """If BulkPublishStatus is SUCCEEDED, the time the last bulk publish operation completed."""
    bulk_publish_status: NotRequired[
        "aws_sdk_cognito_sync.types.bulk_publish_status.BulkPublishStatus"
    ]
    ...
    failure_message: NotRequired["aws_sdk_cognito_sync.types.string.String"]
...
def serialize_json(value: GetBulkPublishDetailsResponse) -> dict:
    ...
    if "bulk_publish_start_time" in value:
        ...
        out["BulkPublishStartTime"] = aws_sdk_cognito_sync.types.date.serialize_json(
            value["bulk_publish_start_time"]
        )
    if "bulk_publish_complete_time" in value:
        import aws_sdk_cognito_sync.types.date

        out["BulkPublishCompleteTime"] = aws_sdk_cognito_sync.types.date.serialize_json(
    ...
    if "bulk_publish_status" in value:
        ...
        out["BulkPublishStatus"] = (
            aws_sdk_cognito_sync.types.bulk_publish_status.serialize_json(
...
def deserialize_json(data: dict) -> GetBulkPublishDetailsResponse:
    ...
    if "BulkPublishStatus" in data:
        ...
        out["bulk_publish_status"] = (
            aws_sdk_cognito_sync.types.bulk_publish_status.deserialize_json(
