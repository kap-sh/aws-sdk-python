...
class ListRecordsResponse(TypedDict):
    ...
    dataset_sync_count: NotRequired["aws_sdk_cognito_sync.types.long.Long"]
    """Server sync count for this dataset."""
    last_modified_by: NotRequired["aws_sdk_cognito_sync.types.string.String"]
    """The user/device that made the last change to this record."""
    merged_dataset_names: NotRequired[
        "aws_sdk_cognito_sync.types.merged_dataset_name_list.MergedDatasetNameList"
    ]
    """Names of merged datasets."""
    dataset_exists: "aws_sdk_cognito_sync.types.boolean.Boolean"
    """Indicates whether the dataset exists."""
    dataset_deleted_after_requested_sync_count: (
        "aws_sdk_cognito_sync.types.boolean.Boolean"
    )
    """A boolean value specifying whether to delete the dataset locally."""
    sync_session_token: NotRequired["aws_sdk_cognito_sync.types.string.String"]
...
def serialize_json(value: ListRecordsResponse) -> dict:
    ...
    if "merged_dataset_names" in value:
        ...
        out["MergedDatasetNames"] = (
            aws_sdk_cognito_sync.types.merged_dataset_name_list.serialize_json(
...
def deserialize_json(data: dict) -> ListRecordsResponse:
    ...
    if "MergedDatasetNames" in data:
        ...
        out["merged_dataset_names"] = (
            aws_sdk_cognito_sync.types.merged_dataset_name_list.deserialize_json(
