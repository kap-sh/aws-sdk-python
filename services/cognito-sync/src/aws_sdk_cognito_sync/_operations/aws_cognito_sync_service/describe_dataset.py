...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.describe_dataset_response.DescribeDatasetResponse = aws_sdk_cognito_sync.types.describe_dataset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cognito_sync.types.describe_dataset_request.DescribeDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
