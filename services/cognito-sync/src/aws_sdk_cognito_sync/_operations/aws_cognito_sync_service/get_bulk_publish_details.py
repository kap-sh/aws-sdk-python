...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.get_bulk_publish_details_response.GetBulkPublishDetailsResponse = aws_sdk_cognito_sync.types.get_bulk_publish_details_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cognito_sync.types.get_bulk_publish_details_request.GetBulkPublishDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
