"""Generated from Smithy shape ``com.amazonaws.cognitosync#SetIdentityPoolConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentModificationException":
            import aws_sdk_cognito_sync.errors.concurrent_modification_exception

            raise aws_sdk_cognito_sync.errors.concurrent_modification_exception.ConcurrentModificationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.set_identity_pool_configuration_response.SetIdentityPoolConfigurationResponse = aws_sdk_cognito_sync.types.set_identity_pool_configuration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cognito_sync.types.set_identity_pool_configuration_request.SetIdentityPoolConfigurationRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/identitypools/{IdentityPoolId}/configuration"
    url = url.replace(
        "{IdentityPoolId}", quote(str(input["identity_pool_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_sync.types.set_identity_pool_configuration_request.serialize_json(
            input
        )
    ).encode()
...
async def async_set_identity_pool_configuration(
