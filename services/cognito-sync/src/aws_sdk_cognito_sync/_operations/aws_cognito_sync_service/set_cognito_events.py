...
def build_request(
    ...
    input_: aws_sdk_cognito_sync.types.set_cognito_events_request.SetCognitoEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_sync.types.set_cognito_events_request.serialize_json(input_)
    ).encode()
