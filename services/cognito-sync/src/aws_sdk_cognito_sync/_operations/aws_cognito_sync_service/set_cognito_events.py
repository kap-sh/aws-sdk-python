...
def build_request(
    ...
    input: aws_sdk_cognito_sync.types.set_cognito_events_request.SetCognitoEventsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_sync.types.set_cognito_events_request.serialize_json(input)
    ).encode()
