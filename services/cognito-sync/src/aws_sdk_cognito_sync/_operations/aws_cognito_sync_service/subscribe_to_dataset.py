...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.subscribe_to_dataset_response.SubscribeToDatasetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_sync.types.subscribe_to_dataset_request.SubscribeToDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
