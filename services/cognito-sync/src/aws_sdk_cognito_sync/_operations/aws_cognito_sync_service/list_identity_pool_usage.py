"""Generated from Smithy shape ``com.amazonaws.cognitosync#ListIdentityPoolUsage``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.list_identity_pool_usage_response.ListIdentityPoolUsageResponse = aws_sdk_cognito_sync.types.list_identity_pool_usage_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cognito_sync.types.list_identity_pool_usage_request.ListIdentityPoolUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/identitypools"
    params: dict[str, str] = {}
...
async def async_list_identity_pool_usage(
