...
def build_request(
    ...
    input_: aws_sdk_cognito_sync.types.register_device_request.RegisterDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_sync.types.register_device_request.serialize_json(input_)
    ).encode()
