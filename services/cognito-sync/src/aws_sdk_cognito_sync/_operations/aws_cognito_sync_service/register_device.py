"""Generated from Smithy shape ``com.amazonaws.cognitosync#RegisterDevice``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidConfigurationException":
            import aws_sdk_cognito_sync.errors.invalid_configuration_exception

            raise aws_sdk_cognito_sync.errors.invalid_configuration_exception.InvalidConfigurationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.register_device_response.RegisterDeviceResponse = (
        aws_sdk_cognito_sync.types.register_device_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cognito_sync.types.register_device_request.RegisterDeviceRequest,
) -> zapros.Request:
    ...
    url = url.replace("{IdentityId}", quote(str(input["identity_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_cognito_sync.types.register_device_request

    body: bytes | None = json.dumps(
        aws_sdk_cognito_sync.types.register_device_request.serialize_json(input)
    ).encode()
