"""Generated from Smithy shape ``com.amazonaws.cognitosync#ListDatasets``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.list_datasets_response.ListDatasetsResponse = (
        aws_sdk_cognito_sync.types.list_datasets_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cognito_sync.types.list_datasets_request.ListDatasetsRequest,
) -> zapros.Request:
