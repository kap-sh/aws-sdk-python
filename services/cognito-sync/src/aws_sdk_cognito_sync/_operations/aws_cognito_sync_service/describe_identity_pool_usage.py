...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.describe_identity_pool_usage_response.DescribeIdentityPoolUsageResponse = aws_sdk_cognito_sync.types.describe_identity_pool_usage_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cognito_sync.types.describe_identity_pool_usage_request.DescribeIdentityPoolUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
