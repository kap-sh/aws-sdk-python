...
def build_request(
    ...
    input_: aws_sdk_cognito_sync.types.list_records_request.ListRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "last_sync_count" in input_:
        params["lastSyncCount"] = str(input_["last_sync_count"])
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "max_results" in input_:
        params["maxResults"] = str(input_["max_results"])
    if "sync_session_token" in input_:
        params["syncSessionToken"] = str(input_["sync_session_token"])
