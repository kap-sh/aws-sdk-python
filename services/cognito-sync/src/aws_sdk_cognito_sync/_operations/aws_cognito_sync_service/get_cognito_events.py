"""Generated from Smithy shape ``com.amazonaws.cognitosync#GetCognitoEvents``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.get_cognito_events_response.GetCognitoEventsResponse = aws_sdk_cognito_sync.types.get_cognito_events_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cognito_sync.types.get_cognito_events_request.GetCognitoEventsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/identitypools/{IdentityPoolId}/events"
    url = url.replace(
...
async def async_get_cognito_events(
