...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.unsubscribe_from_dataset_response.UnsubscribeFromDatasetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_sync.types.unsubscribe_from_dataset_request.UnsubscribeFromDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
