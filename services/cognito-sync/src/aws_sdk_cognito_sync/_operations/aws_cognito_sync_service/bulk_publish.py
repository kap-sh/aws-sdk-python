...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AlreadyStreamedException":
            import aws_sdk_cognito_sync.errors.already_streamed_exception

            raise aws_sdk_cognito_sync.errors.already_streamed_exception.AlreadyStreamedException.from_json(
                data
            )
        case "DuplicateRequestException":
            import aws_sdk_cognito_sync.errors.duplicate_request_exception

            raise aws_sdk_cognito_sync.errors.duplicate_request_exception.DuplicateRequestException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.bulk_publish_response.BulkPublishResponse = (
        aws_sdk_cognito_sync.types.bulk_publish_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cognito_sync.types.bulk_publish_request.BulkPublishRequest,
) -> zapros.Request:
