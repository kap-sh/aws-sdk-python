...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.delete_dataset_response.DeleteDatasetResponse = (
        aws_sdk_cognito_sync.types.delete_dataset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cognito_sync.types.delete_dataset_request.DeleteDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
