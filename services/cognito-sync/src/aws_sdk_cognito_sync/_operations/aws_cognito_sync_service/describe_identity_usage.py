...
def handle_response(
    ...
    out: aws_sdk_cognito_sync.types.describe_identity_usage_response.DescribeIdentityUsageResponse = aws_sdk_cognito_sync.types.describe_identity_usage_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_cognito_sync.types.describe_identity_usage_request.DescribeIdentityUsageRequest,
) -> zapros.Request:
