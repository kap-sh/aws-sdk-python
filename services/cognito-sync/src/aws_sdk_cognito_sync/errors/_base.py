...
class CognitoSyncError(Exception):
    """Base class for all CognitoSync service errors."""


class ServiceError(CognitoSyncError):
...
class SerializationError(CognitoSyncError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CognitoSyncError):
...
class WaiterFailedError(CognitoSyncError):
...
class WaiterTimeoutError(CognitoSyncError):
