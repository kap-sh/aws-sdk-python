...
from ._services.async_cognito_sync import (
    AsyncCognitoSyncClient as AsyncCognitoSyncClient,
)
from ._services.cognito_sync import CognitoSyncClient as CognitoSyncClient
