...
from capo_cognito_sync._services._aws_config import aws_config
...
class CognitoSyncClientConfig(TypedDict, total=False, closed=True):
...
class CognitoSyncClient:
    ...
    def bulk_publish(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.bulk_publish_request.BulkPublishRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.bulk_publish_response.BulkPublishResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.bulk_publish.bulk_publish(
    ...
    def delete_dataset(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.delete_dataset_request.DeleteDatasetRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.delete_dataset_response.DeleteDatasetResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.delete_dataset.delete_dataset(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_dataset(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.describe_dataset_request.DescribeDatasetRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.describe_dataset_response.DescribeDatasetResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.describe_dataset.describe_dataset(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_identity_pool_usage(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.describe_identity_pool_usage_request.DescribeIdentityPoolUsageRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.describe_identity_pool_usage_response.DescribeIdentityPoolUsageResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.describe_identity_pool_usage.describe_identity_pool_usage(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_identity_usage(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.describe_identity_usage_request.DescribeIdentityUsageRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.describe_identity_usage_response.DescribeIdentityUsageResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.describe_identity_usage.describe_identity_usage(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_bulk_publish_details(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.get_bulk_publish_details_request.GetBulkPublishDetailsRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.get_bulk_publish_details_response.GetBulkPublishDetailsResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.get_bulk_publish_details.get_bulk_publish_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_cognito_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.get_cognito_events_request.GetCognitoEventsRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.get_cognito_events_response.GetCognitoEventsResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.get_cognito_events.get_cognito_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_identity_pool_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.get_identity_pool_configuration_request.GetIdentityPoolConfigurationRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.get_identity_pool_configuration_response.GetIdentityPoolConfigurationResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.get_identity_pool_configuration.get_identity_pool_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_datasets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.list_datasets_request.ListDatasetsRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.list_datasets_response.ListDatasetsResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.list_datasets.list_datasets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_identity_pool_usage(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.list_identity_pool_usage_request.ListIdentityPoolUsageRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.list_identity_pool_usage_response.ListIdentityPoolUsageResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.list_identity_pool_usage.list_identity_pool_usage(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_records(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.list_records_request.ListRecordsRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.list_records_response.ListRecordsResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.list_records.list_records(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_device(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.register_device_request.RegisterDeviceRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.register_device_response.RegisterDeviceResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.register_device.register_device(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_cognito_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.set_cognito_events_request.SetCognitoEventsRequest]",
        ) -> OperationResponse[None]:
            import capo_cognito_sync._operations.aws_cognito_sync_service.set_cognito_events

            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.set_cognito_events.set_cognito_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_identity_pool_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.set_identity_pool_configuration_request.SetIdentityPoolConfigurationRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.set_identity_pool_configuration_response.SetIdentityPoolConfigurationResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.set_identity_pool_configuration.set_identity_pool_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def subscribe_to_dataset(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.subscribe_to_dataset_request.SubscribeToDatasetRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.subscribe_to_dataset_response.SubscribeToDatasetResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.subscribe_to_dataset.subscribe_to_dataset(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def unsubscribe_from_dataset(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.unsubscribe_from_dataset_request.UnsubscribeFromDatasetRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.unsubscribe_from_dataset_response.UnsubscribeFromDatasetResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.unsubscribe_from_dataset.unsubscribe_from_dataset(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_records(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_sync.types.update_records_request.UpdateRecordsRequest]",
        ) -> OperationResponse[
            "capo_cognito_sync.types.update_records_response.UpdateRecordsResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_sync._operations.aws_cognito_sync_service.update_records.update_records(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
