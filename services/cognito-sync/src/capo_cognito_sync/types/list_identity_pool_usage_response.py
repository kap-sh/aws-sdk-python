...
class ListIdentityPoolUsageResponse(TypedDict, closed=True):
    identity_pool_usages: NotRequired[
        "capo_cognito_sync.types.identity_pool_usage_list.IdentityPoolUsageList"
    ]
    """Usage information for the identity pools."""
    max_results: "capo_cognito_sync.types.integer.Integer"
...
def serialize_json(value: ListIdentityPoolUsageResponse) -> dict:
    ...
    if "identity_pool_usages" in value:
        ...
        out["IdentityPoolUsages"] = (
            capo_cognito_sync.types.identity_pool_usage_list.serialize_json(
...
def deserialize_json(data: dict) -> ListIdentityPoolUsageResponse:
    ...
    if "IdentityPoolUsages" in data:
        ...
        out["identity_pool_usages"] = (
            capo_cognito_sync.types.identity_pool_usage_list.deserialize_json(
