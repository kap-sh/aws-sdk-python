"""Generated from Smithy shape ``com.amazonaws.cognitosync#BulkPublish``."""
...
import capo_cognito_sync.errors.already_streamed_exception
import capo_cognito_sync.errors.duplicate_request_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AlreadyStreamedException":
            raise capo_cognito_sync.errors.already_streamed_exception.AlreadyStreamedException.from_json(
                data
            )
        case "DuplicateRequestException":
            raise capo_cognito_sync.errors.duplicate_request_exception.DuplicateRequestException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_cognito_sync.types.bulk_publish_response.BulkPublishResponse = (
        capo_cognito_sync.types.bulk_publish_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_cognito_sync.types.bulk_publish_request.BulkPublishRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/identitypools/{IdentityPoolId}/bulkpublish"
    url = url.replace(
...
def bulk_publish(
    ...
    capo_cognito_sync.types.bulk_publish_response.BulkPublishResponse, zapros.Response
]:
