...
def handle_response(
    ...
    out: capo_cognito_sync.types.list_datasets_response.ListDatasetsResponse = (
        capo_cognito_sync.types.list_datasets_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_cognito_sync.types.list_datasets_request.ListDatasetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_datasets(
    ...
    capo_cognito_sync.types.list_datasets_response.ListDatasetsResponse, zapros.Response
]:
