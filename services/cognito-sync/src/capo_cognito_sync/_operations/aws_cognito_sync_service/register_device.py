...
import capo_cognito_sync.errors.invalid_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidConfigurationException":
            raise capo_cognito_sync.errors.invalid_configuration_exception.InvalidConfigurationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_cognito_sync.types.register_device_response.RegisterDeviceResponse = (
        capo_cognito_sync.types.register_device_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_cognito_sync.types.register_device_request.RegisterDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_sync.types.register_device_request.serialize_json(input_)
    ).encode()
