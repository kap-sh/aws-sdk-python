"""Generated from Smithy shape ``com.amazonaws.cognitosync#GetBulkPublishDetails``."""
...
def handle_response(
    ...
    out: capo_cognito_sync.types.get_bulk_publish_details_response.GetBulkPublishDetailsResponse = capo_cognito_sync.types.get_bulk_publish_details_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_cognito_sync.types.get_bulk_publish_details_request.GetBulkPublishDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_bulk_publish_details(
