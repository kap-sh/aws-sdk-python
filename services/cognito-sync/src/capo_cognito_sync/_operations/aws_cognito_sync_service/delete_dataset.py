"""Generated from Smithy shape ``com.amazonaws.cognitosync#DeleteDataset``."""
...
import capo_cognito_sync.errors.resource_conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceConflictException":
            raise capo_cognito_sync.errors.resource_conflict_exception.ResourceConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_cognito_sync.types.delete_dataset_response.DeleteDatasetResponse = (
        capo_cognito_sync.types.delete_dataset_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_cognito_sync.types.delete_dataset_request.DeleteDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
