...
def handle_response(
    ...
    out: capo_cognito_sync.types.list_identity_pool_usage_response.ListIdentityPoolUsageResponse = capo_cognito_sync.types.list_identity_pool_usage_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_cognito_sync.types.list_identity_pool_usage_request.ListIdentityPoolUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
