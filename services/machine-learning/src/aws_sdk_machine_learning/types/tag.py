...
if TYPE_CHECKING:
    import aws_sdk_machine_learning.types.tag_key
    import aws_sdk_machine_learning.types.tag_value


class Tag(TypedDict, closed=True):
    key: NotRequired["aws_sdk_machine_learning.types.tag_key.TagKey"]
    """<p>A unique identifier for the tag. Valid characters include Unicode letters, digits, white space, _, ., /, =, +, -, %, and @.</p>"""
    value: NotRequired["aws_sdk_machine_learning.types.tag_value.TagValue"]
