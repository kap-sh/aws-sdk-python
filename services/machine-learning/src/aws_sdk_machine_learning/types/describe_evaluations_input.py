"""Generated from Smithy shape ``com.amazonaws.machinelearning#DescribeEvaluationsInput``."""
...
class DescribeEvaluationsInput(TypedDict, closed=True):
    ...
    """<p>A two-value parameter that determines the sequence of the resulting list of <code>Evaluation</code>.</p> <ul> <li> <p> <code>asc</code> - Arranges the list in ascending order (A-Z, 0-9).</p> </li> <li> <p> <code>dsc</code> - Arranges the list in descending order (Z-A, 9-0).</p> </li> </ul> <p>Results are sorted by <code>FilterVariable</code>.</p>"""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeEvaluationsInput) -> dict:
    out: dict = {}
    if "filter_variable" in value:
        import aws_sdk_machine_learning.types.evaluation_filter_variable

        out["FilterVariable"] = (
            aws_sdk_machine_learning.types.evaluation_filter_variable.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeEvaluationsInput:
    ...
    if "FilterVariable" in data:
        ...
        out["filter_variable"] = (
            aws_sdk_machine_learning.types.evaluation_filter_variable.deserialize_aws_json_1_1(
                data["FilterVariable"]
            )
        )
    if "EQ" in data:
