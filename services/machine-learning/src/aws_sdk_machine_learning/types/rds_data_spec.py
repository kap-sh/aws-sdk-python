...
if TYPE_CHECKING:
    ...
    import aws_sdk_machine_learning.types.edp_security_group_ids
    import aws_sdk_machine_learning.types.edp_service_role
    import aws_sdk_machine_learning.types.edp_subnet_id
    import aws_sdk_machine_learning.types.rds_database
    import aws_sdk_machine_learning.types.rds_database_credentials
...
class RDSDataSpec(TypedDict, closed=True):
    database_information: "aws_sdk_machine_learning.types.rds_database.RDSDatabase"
    ...
    database_credentials: (
        "aws_sdk_machine_learning.types.rds_database_credentials.RDSDatabaseCredentials"
    )
    ...
    resource_role: "aws_sdk_machine_learning.types.edp_resource_role.EDPResourceRole"
    ...
    service_role: "aws_sdk_machine_learning.types.edp_service_role.EDPServiceRole"
    ...
    subnet_id: "aws_sdk_machine_learning.types.edp_subnet_id.EDPSubnetId"
    ...
    security_group_ids: (
        "aws_sdk_machine_learning.types.edp_security_group_ids.EDPSecurityGroupIds"
    )
...
def serialize_aws_json_1_1(value: RDSDataSpec) -> dict:
    ...
    out["DatabaseCredentials"] = (
        aws_sdk_machine_learning.types.rds_database_credentials.serialize_aws_json_1_1(
    ...
    out["SecurityGroupIds"] = (
        aws_sdk_machine_learning.types.edp_security_group_ids.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RDSDataSpec:
    ...
    if "DatabaseCredentials" in data:
        ...
        out["database_credentials"] = (
            aws_sdk_machine_learning.types.rds_database_credentials.deserialize_aws_json_1_1(
    ...
    if "SecurityGroupIds" in data:
        ...
        out["security_group_ids"] = (
            aws_sdk_machine_learning.types.edp_security_group_ids.deserialize_aws_json_1_1(
