...
if TYPE_CHECKING:
    ...
    import aws_sdk_machine_learning.types.integer_type
    import aws_sdk_machine_learning.types.realtime_endpoint_status
...
class RealtimeEndpointInfo(TypedDict, closed=True):
    ...
    endpoint_url: NotRequired["aws_sdk_machine_learning.types.vip_url.VipURL"]
    ...
    endpoint_status: NotRequired[
        "aws_sdk_machine_learning.types.realtime_endpoint_status.RealtimeEndpointStatus"
    ]
...
def serialize_aws_json_1_1(value: RealtimeEndpointInfo) -> dict:
    ...
    if "endpoint_status" in value:
        ...
        out["EndpointStatus"] = (
            aws_sdk_machine_learning.types.realtime_endpoint_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RealtimeEndpointInfo:
    ...
    if "EndpointStatus" in data:
        ...
        out["endpoint_status"] = (
            aws_sdk_machine_learning.types.realtime_endpoint_status.deserialize_aws_json_1_1(
                data["EndpointStatus"]
            )
        )
    return out
