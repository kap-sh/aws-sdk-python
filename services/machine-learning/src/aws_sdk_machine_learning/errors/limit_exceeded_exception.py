"""Generated from Smithy shape ``com.amazonaws.machinelearning#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.machinelearning#LimitExceededException``."""
