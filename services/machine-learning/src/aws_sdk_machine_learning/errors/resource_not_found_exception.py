"""Generated from Smithy shape ``com.amazonaws.machinelearning#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.machinelearning#ResourceNotFoundException``."""
