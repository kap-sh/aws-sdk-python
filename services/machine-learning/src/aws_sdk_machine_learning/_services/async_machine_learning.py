...
from aws_sdk_machine_learning._services._aws_config import aaws_config
...
class AsyncMachineLearningClientConfig(TypedDict, total=False):
...
class AsyncMachineLearningClient:
    ...
    async def add_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.add_tags_input.AddTagsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.add_tags_output.AddTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.add_tags.async_add_tags(
    ...
    async def create_batch_prediction(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.create_batch_prediction_input.CreateBatchPredictionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.create_batch_prediction_output.CreateBatchPredictionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.create_batch_prediction.async_create_batch_prediction(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_data_source_from_rds(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.create_data_source_from_rds_input.CreateDataSourceFromRDSInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.create_data_source_from_rds_output.CreateDataSourceFromRDSOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.create_data_source_from_rds.async_create_data_source_from_rds(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_data_source_from_redshift(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.create_data_source_from_redshift_input.CreateDataSourceFromRedshiftInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.create_data_source_from_redshift_output.CreateDataSourceFromRedshiftOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.create_data_source_from_redshift.async_create_data_source_from_redshift(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_data_source_from_s3(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.create_data_source_from_s3_input.CreateDataSourceFromS3Input]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.create_data_source_from_s3_output.CreateDataSourceFromS3Output"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.create_data_source_from_s3.async_create_data_source_from_s3(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_evaluation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.create_evaluation_input.CreateEvaluationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.create_evaluation_output.CreateEvaluationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.create_evaluation.async_create_evaluation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_ml_model(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.create_ml_model_input.CreateMLModelInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.create_ml_model_output.CreateMLModelOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.create_ml_model.async_create_ml_model(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_realtime_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.create_realtime_endpoint_input.CreateRealtimeEndpointInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.create_realtime_endpoint_output.CreateRealtimeEndpointOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.create_realtime_endpoint.async_create_realtime_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_batch_prediction(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.delete_batch_prediction_input.DeleteBatchPredictionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.delete_batch_prediction_output.DeleteBatchPredictionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.delete_batch_prediction.async_delete_batch_prediction(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_data_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.delete_data_source_input.DeleteDataSourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.delete_data_source_output.DeleteDataSourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.delete_data_source.async_delete_data_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_evaluation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.delete_evaluation_input.DeleteEvaluationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.delete_evaluation_output.DeleteEvaluationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.delete_evaluation.async_delete_evaluation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_ml_model(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.delete_ml_model_input.DeleteMLModelInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.delete_ml_model_output.DeleteMLModelOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.delete_ml_model.async_delete_ml_model(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_realtime_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.delete_realtime_endpoint_input.DeleteRealtimeEndpointInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.delete_realtime_endpoint_output.DeleteRealtimeEndpointOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.delete_realtime_endpoint.async_delete_realtime_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.delete_tags_input.DeleteTagsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.delete_tags_output.DeleteTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.delete_tags.async_delete_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_batch_predictions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.describe_batch_predictions_input.DescribeBatchPredictionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.describe_batch_predictions_output.DescribeBatchPredictionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.describe_batch_predictions.async_describe_batch_predictions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_batch_predictions(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_machine_learning.types.batch_prediction.BatchPrediction]"
    ):
        _token = next_token
        while True:
    ...
    async def describe_data_sources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.describe_data_sources_input.DescribeDataSourcesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.describe_data_sources_output.DescribeDataSourcesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.describe_data_sources.async_describe_data_sources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_data_sources(
        ...
        *,
        ...
        limit: Optional["aws_sdk_machine_learning.types.page_limit.PageLimit"] = None,
    ) -> "AsyncIterator[aws_sdk_machine_learning.types.data_source.DataSource]":
        _token = next_token
        while True:
    ...
    async def describe_evaluations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.describe_evaluations_input.DescribeEvaluationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.describe_evaluations_output.DescribeEvaluationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.describe_evaluations.async_describe_evaluations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_evaluations(
        ...
        *,
        ...
        limit: Optional["aws_sdk_machine_learning.types.page_limit.PageLimit"] = None,
    ) -> "AsyncIterator[aws_sdk_machine_learning.types.evaluation.Evaluation]":
        _token = next_token
        while True:
    ...
    async def describe_ml_models(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.describe_ml_models_input.DescribeMLModelsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.describe_ml_models_output.DescribeMLModelsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.describe_ml_models.async_describe_ml_models(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_ml_models(
        ...
        *,
        ...
        limit: Optional["aws_sdk_machine_learning.types.page_limit.PageLimit"] = None,
    ) -> "AsyncIterator[aws_sdk_machine_learning.types.ml_model.MLModel]":
        _token = next_token
        while True:
    ...
    async def describe_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.describe_tags_input.DescribeTagsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.describe_tags_output.DescribeTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.describe_tags.async_describe_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_batch_prediction(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.get_batch_prediction_input.GetBatchPredictionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.get_batch_prediction_output.GetBatchPredictionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.get_batch_prediction.async_get_batch_prediction(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_data_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.get_data_source_input.GetDataSourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.get_data_source_output.GetDataSourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.get_data_source.async_get_data_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_evaluation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.get_evaluation_input.GetEvaluationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.get_evaluation_output.GetEvaluationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.get_evaluation.async_get_evaluation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_ml_model(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.get_ml_model_input.GetMLModelInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.get_ml_model_output.GetMLModelOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.get_ml_model.async_get_ml_model(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def predict(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.predict_input.PredictInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.predict_output.PredictOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.predict.async_predict(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_batch_prediction(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.update_batch_prediction_input.UpdateBatchPredictionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.update_batch_prediction_output.UpdateBatchPredictionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.update_batch_prediction.async_update_batch_prediction(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_data_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.update_data_source_input.UpdateDataSourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.update_data_source_output.UpdateDataSourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.update_data_source.async_update_data_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_evaluation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.update_evaluation_input.UpdateEvaluationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.update_evaluation_output.UpdateEvaluationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.update_evaluation.async_update_evaluation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_ml_model(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_machine_learning.types.update_ml_model_input.UpdateMLModelInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_machine_learning.types.update_ml_model_output.UpdateMLModelOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_machine_learning._operations.amazon_ml_20141212.update_ml_model.async_update_ml_model(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
