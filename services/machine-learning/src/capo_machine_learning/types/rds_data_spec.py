"""Generated from Smithy shape ``com.amazonaws.machinelearning#RDSDataSpec``."""
...
if TYPE_CHECKING:
    ...
    import capo_machine_learning.types.edp_subnet_id
...
class RDSDataSpec(TypedDict, closed=True):
    database_information: "capo_machine_learning.types.rds_database.RDSDatabase"
    ...
    database_credentials: (
        "capo_machine_learning.types.rds_database_credentials.RDSDatabaseCredentials"
    )
    """<p>The AWS Identity and Access Management (IAM) credentials that are used connect to the Amazon RDS database.</p>"""
    s3_staging_location: "capo_machine_learning.types.s3_url.S3Url"
    ...
    security_group_ids: (
        "capo_machine_learning.types.edp_security_group_ids.EDPSecurityGroupIds"
    )
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: RDSDataSpec) -> dict:
    out: dict = {}
    import capo_machine_learning.types.rds_database
    ...
    out["DatabaseCredentials"] = (
        capo_machine_learning.types.rds_database_credentials.serialize_aws_json_1_1(
    ...
    out["SecurityGroupIds"] = (
        capo_machine_learning.types.edp_security_group_ids.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RDSDataSpec:
    ...
    if "DatabaseCredentials" in data:
        ...
        out["database_credentials"] = (
            capo_machine_learning.types.rds_database_credentials.deserialize_aws_json_1_1(
    ...
    if "SecurityGroupIds" in data:
        ...
        out["security_group_ids"] = (
            capo_machine_learning.types.edp_security_group_ids.deserialize_aws_json_1_1(
                data["SecurityGroupIds"]
            )
        )
    else:
        raise DeserializationError("RDSDataSpec.security_group_ids required")
    return out
