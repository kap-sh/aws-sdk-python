...
if TYPE_CHECKING:
    ...
    import capo_machine_learning.types.redshift_select_sql_query
    import capo_machine_learning.types.s3_url


class RedshiftDataSpec(TypedDict, closed=True):
    database_information: (
        "capo_machine_learning.types.redshift_database.RedshiftDatabase"
    )
    """<p>Describes the <code>DatabaseName</code> and <code>ClusterIdentifier</code> for an Amazon Redshift <code>DataSource</code>.</p>"""
    select_sql_query: (
        "capo_machine_learning.types.redshift_select_sql_query.RedshiftSelectSqlQuery"
    )
    """<p>Describes the SQL Query to execute on an Amazon Redshift database for an Amazon Redshift <code>DataSource</code>.</p>"""
    database_credentials: "capo_machine_learning.types.redshift_database_credentials.RedshiftDatabaseCredentials"
...
def serialize_aws_json_1_1(value: RedshiftDataSpec) -> dict:
    ...
    out["DatabaseInformation"] = (
        capo_machine_learning.types.redshift_database.serialize_aws_json_1_1(
    ...
    out["DatabaseCredentials"] = (
        capo_machine_learning.types.redshift_database_credentials.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RedshiftDataSpec:
    ...
    if "DatabaseInformation" in data:
        ...
        out["database_information"] = (
            capo_machine_learning.types.redshift_database.deserialize_aws_json_1_1(
    ...
    if "DatabaseCredentials" in data:
        ...
        out["database_credentials"] = (
            capo_machine_learning.types.redshift_database_credentials.deserialize_aws_json_1_1(
