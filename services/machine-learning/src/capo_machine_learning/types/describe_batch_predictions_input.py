...
def serialize_aws_json_1_1(value: DescribeBatchPredictionsInput) -> dict:
    ...
    if "filter_variable" in value:
        ...
        out["FilterVariable"] = (
            capo_machine_learning.types.batch_prediction_filter_variable.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeBatchPredictionsInput:
    ...
    if "FilterVariable" in data:
        ...
        out["filter_variable"] = (
            capo_machine_learning.types.batch_prediction_filter_variable.deserialize_aws_json_1_1(
                data["FilterVariable"]
            )
        )
    if "EQ" in data:
