...
class DescribeBatchPredictionsOutput(TypedDict, closed=True):
    results: NotRequired[
        "capo_machine_learning.types.batch_predictions.BatchPredictions"
    ]
...
def serialize_aws_json_1_1(value: DescribeBatchPredictionsOutput) -> dict:
    ...
    if "results" in value:
        ...
        out["Results"] = (
            capo_machine_learning.types.batch_predictions.serialize_aws_json_1_1(
                value["results"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeBatchPredictionsOutput:
    ...
    if "Results" in data:
        ...
        out["results"] = (
            capo_machine_learning.types.batch_predictions.deserialize_aws_json_1_1(
                data["Results"]
            )
        )
