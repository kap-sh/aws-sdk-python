...
class S3DataSpec(TypedDict, closed=True):
    data_location_s3: "capo_machine_learning.types.s3_url.S3Url"
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: S3DataSpec) -> dict:
    out: dict = {}
    ...
    if "data_schema_location_s3" in value:
        out["DataSchemaLocationS3"] = value["data_schema_location_s3"]
    return out
