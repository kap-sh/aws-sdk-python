...
class DescribeDataSourcesInput(TypedDict, closed=True):
    ...
    eq: NotRequired["capo_machine_learning.types.comparator_value.ComparatorValue"]
    ...
    gt: NotRequired["capo_machine_learning.types.comparator_value.ComparatorValue"]
    ...
    lt: NotRequired["capo_machine_learning.types.comparator_value.ComparatorValue"]
    ...
    ge: NotRequired["capo_machine_learning.types.comparator_value.ComparatorValue"]
    ...
    le: NotRequired["capo_machine_learning.types.comparator_value.ComparatorValue"]
    ...
    ne: NotRequired["capo_machine_learning.types.comparator_value.ComparatorValue"]
    ...
    prefix: NotRequired["capo_machine_learning.types.comparator_value.ComparatorValue"]
    ...
    sort_order: NotRequired["capo_machine_learning.types.sort_order.SortOrder"]
    ...
    limit: NotRequired["capo_machine_learning.types.page_limit.PageLimit"]
...
def serialize_aws_json_1_1(value: DescribeDataSourcesInput) -> dict:
    ...
    if "filter_variable" in value:
        ...
        out["FilterVariable"] = (
            capo_machine_learning.types.data_source_filter_variable.serialize_aws_json_1_1(
    ...
    if "sort_order" in value:
        ...
        out["SortOrder"] = (
            capo_machine_learning.types.sort_order.serialize_aws_json_1_1(
                value["sort_order"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeDataSourcesInput:
    ...
    if "FilterVariable" in data:
        ...
        out["filter_variable"] = (
            capo_machine_learning.types.data_source_filter_variable.deserialize_aws_json_1_1(
                data["FilterVariable"]
            )
        )
    if "EQ" in data:
    ...
    if "SortOrder" in data:
        ...
        out["sort_order"] = (
            capo_machine_learning.types.sort_order.deserialize_aws_json_1_1(
                data["SortOrder"]
            )
        )
