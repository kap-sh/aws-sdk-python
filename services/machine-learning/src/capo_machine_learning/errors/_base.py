...
class MachineLearningError(Exception):
    """Base class for all MachineLearning service errors."""


class ServiceError(MachineLearningError):
...
class SerializationError(MachineLearningError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MachineLearningError):
...
class WaiterFailedError(MachineLearningError):
...
class WaiterTimeoutError(MachineLearningError):
