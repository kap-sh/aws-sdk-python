...
def build_request(
    ...
    input_: aws_sdk_mturk.types.get_qualification_type_request.GetQualificationTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.get_qualification_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
