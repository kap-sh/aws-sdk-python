...
def handle_response(
    ...
    out: aws_sdk_mturk.types.get_qualification_type_response.GetQualificationTypeResponse = aws_sdk_mturk.types.get_qualification_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_mturk.types.get_qualification_type_request.GetQualificationTypeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.get_qualification_type_request.serialize_aws_json_1_1(input)
    ).encode()
