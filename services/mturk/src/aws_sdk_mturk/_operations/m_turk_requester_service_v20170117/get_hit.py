...
def handle_response(
    ...
    out: aws_sdk_mturk.types.get_hit_response.GetHITResponse = (
        aws_sdk_mturk.types.get_hit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.get_hit_request.GetHITRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.get_hit_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_hit(
    options: OperationOptions, input_: aws_sdk_mturk.types.get_hit_request.GetHITRequest
) -> tuple[aws_sdk_mturk.types.get_hit_response.GetHITResponse, zapros.Response]:
