...
def build_request(
    ...
    input: aws_sdk_mturk.types.get_hit_request.GetHITRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.get_hit_request.serialize_aws_json_1_1(input)
    ).encode()
...
def get_hit(
    options: OperationOptions, input: aws_sdk_mturk.types.get_hit_request.GetHITRequest
