"""Generated from Smithy shape ``com.amazonaws.mturk#UpdateHITReviewStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.update_hit_review_status_response.UpdateHITReviewStatusResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.update_hit_review_status_request.UpdateHITReviewStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.update_hit_review_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_hit_review_status(
