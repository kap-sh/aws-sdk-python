...
def handle_response(
    ...
    out: aws_sdk_mturk.types.list_hi_ts_response.ListHITsResponse = (
        aws_sdk_mturk.types.list_hi_ts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.list_hi_ts_request.ListHITsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_hi_ts_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_hi_ts(
    ...
    input_: aws_sdk_mturk.types.list_hi_ts_request.ListHITsRequest,
) -> tuple[aws_sdk_mturk.types.list_hi_ts_response.ListHITsResponse, zapros.Response]:
