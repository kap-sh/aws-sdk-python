...
def handle_response(
    ...
    out: aws_sdk_mturk.types.delete_hit_response.DeleteHITResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.delete_hit_request.DeleteHITRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.delete_hit_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_hit(
    ...
    input_: aws_sdk_mturk.types.delete_hit_request.DeleteHITRequest,
) -> tuple[aws_sdk_mturk.types.delete_hit_response.DeleteHITResponse, zapros.Response]:
