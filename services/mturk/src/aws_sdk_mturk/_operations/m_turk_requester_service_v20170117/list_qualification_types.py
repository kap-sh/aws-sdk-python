"""Generated from Smithy shape ``com.amazonaws.mturk#ListQualificationTypes``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.list_qualification_types_response.ListQualificationTypesResponse = aws_sdk_mturk.types.list_qualification_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.list_qualification_types_request.ListQualificationTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_qualification_types_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_qualification_types(
