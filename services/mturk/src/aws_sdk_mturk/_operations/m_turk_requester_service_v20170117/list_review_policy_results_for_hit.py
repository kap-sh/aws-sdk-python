"""Generated from Smithy shape ``com.amazonaws.mturk#ListReviewPolicyResultsForHIT``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.list_review_policy_results_for_hit_response.ListReviewPolicyResultsForHITResponse = aws_sdk_mturk.types.list_review_policy_results_for_hit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.list_review_policy_results_for_hit_request.ListReviewPolicyResultsForHITRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_review_policy_results_for_hit(
