"""Generated from Smithy shape ``com.amazonaws.mturk#UpdateExpirationForHIT``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.update_expiration_for_hit_response.UpdateExpirationForHITResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.update_expiration_for_hit_request.UpdateExpirationForHITRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_expiration_for_hit(
