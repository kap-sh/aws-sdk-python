...
def handle_response(
    ...
    out: aws_sdk_mturk.types.create_worker_block_response.CreateWorkerBlockResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.create_worker_block_request.CreateWorkerBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.create_worker_block_request.serialize_aws_json_1_1(input_)
    ).encode()
