...
def build_request(
    ...
    input: aws_sdk_mturk.types.create_worker_block_request.CreateWorkerBlockRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.create_worker_block_request.serialize_aws_json_1_1(input)
    ).encode()
