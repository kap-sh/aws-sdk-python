...
def handle_response(
    ...
    out: aws_sdk_mturk.types.delete_qualification_type_response.DeleteQualificationTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.delete_qualification_type_request.DeleteQualificationTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.delete_qualification_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
