...
def handle_response(
    ...
    out: aws_sdk_mturk.types.disassociate_qualification_from_worker_response.DisassociateQualificationFromWorkerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.disassociate_qualification_from_worker_request.DisassociateQualificationFromWorkerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
