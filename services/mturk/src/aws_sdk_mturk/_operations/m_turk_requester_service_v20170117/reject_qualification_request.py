"""Generated from Smithy shape ``com.amazonaws.mturk#RejectQualificationRequest``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.reject_qualification_request_response.RejectQualificationRequestResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.reject_qualification_request_request.RejectQualificationRequestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.reject_qualification_request_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_reject_qualification_request(
