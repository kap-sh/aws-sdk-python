...
def handle_response(
    ...
    out: aws_sdk_mturk.types.get_qualification_score_response.GetQualificationScoreResponse = aws_sdk_mturk.types.get_qualification_score_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.get_qualification_score_request.GetQualificationScoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.get_qualification_score_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
