...
def handle_response(
    ...
    out: aws_sdk_mturk.types.list_qualification_requests_response.ListQualificationRequestsResponse = aws_sdk_mturk.types.list_qualification_requests_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.list_qualification_requests_request.ListQualificationRequestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_qualification_requests_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
