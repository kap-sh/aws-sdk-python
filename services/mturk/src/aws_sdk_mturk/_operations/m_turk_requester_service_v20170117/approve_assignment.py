...
def handle_response(
    ...
    out: aws_sdk_mturk.types.approve_assignment_response.ApproveAssignmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.approve_assignment_request.ApproveAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.approve_assignment_request.serialize_aws_json_1_1(input_)
    ).encode()
