...
def build_request(
    ...
    input: aws_sdk_mturk.types.approve_assignment_request.ApproveAssignmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.approve_assignment_request.serialize_aws_json_1_1(input)
    ).encode()
