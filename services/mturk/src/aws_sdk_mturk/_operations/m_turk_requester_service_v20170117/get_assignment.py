...
def handle_response(
    ...
    out: aws_sdk_mturk.types.get_assignment_response.GetAssignmentResponse = (
        aws_sdk_mturk.types.get_assignment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.get_assignment_request.GetAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.get_assignment_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_assignment(
    ...
    aws_sdk_mturk.types.get_assignment_response.GetAssignmentResponse, zapros.Response
]:
