...
import aws_sdk_mturk.types.hit_list
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.list_hi_ts_for_qualification_type_response.ListHITsForQualificationTypeResponse = aws_sdk_mturk.types.list_hi_ts_for_qualification_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.list_hi_ts_for_qualification_type_request.ListHITsForQualificationTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_hi_ts_for_qualification_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
