...
def handle_response(
    ...
    out: aws_sdk_mturk.types.create_additional_assignments_for_hit_response.CreateAdditionalAssignmentsForHITResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.create_additional_assignments_for_hit_request.CreateAdditionalAssignmentsForHITRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
