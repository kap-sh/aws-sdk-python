"""Generated from Smithy shape ``com.amazonaws.mturk#GetAccountBalance``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.get_account_balance_response.GetAccountBalanceResponse = (
        aws_sdk_mturk.types.get_account_balance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.get_account_balance_request.GetAccountBalanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
