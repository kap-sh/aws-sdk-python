...
def handle_response(
    ...
    out: aws_sdk_mturk.types.reject_assignment_response.RejectAssignmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.reject_assignment_request.RejectAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.reject_assignment_request.serialize_aws_json_1_1(input_)
    ).encode()
