...
def handle_response(
    ...
    out: aws_sdk_mturk.types.update_qualification_type_response.UpdateQualificationTypeResponse = aws_sdk_mturk.types.update_qualification_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.update_qualification_type_request.UpdateQualificationTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
