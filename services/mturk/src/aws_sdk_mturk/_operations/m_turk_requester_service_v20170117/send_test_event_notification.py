"""Generated from Smithy shape ``com.amazonaws.mturk#SendTestEventNotification``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.send_test_event_notification_response.SendTestEventNotificationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.send_test_event_notification_request.SendTestEventNotificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.send_test_event_notification_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_send_test_event_notification(
