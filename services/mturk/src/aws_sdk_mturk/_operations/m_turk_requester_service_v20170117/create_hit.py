...
def handle_response(
    ...
    out: aws_sdk_mturk.types.create_hit_response.CreateHITResponse = (
        aws_sdk_mturk.types.create_hit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.create_hit_request.CreateHITRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.create_hit_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_hit(
    ...
    input_: aws_sdk_mturk.types.create_hit_request.CreateHITRequest,
) -> tuple[aws_sdk_mturk.types.create_hit_response.CreateHITResponse, zapros.Response]:
