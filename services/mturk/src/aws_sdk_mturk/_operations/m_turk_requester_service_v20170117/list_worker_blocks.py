...
def build_request(
    ...
    input: aws_sdk_mturk.types.list_worker_blocks_request.ListWorkerBlocksRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_worker_blocks_request.serialize_aws_json_1_1(input)
    ).encode()
