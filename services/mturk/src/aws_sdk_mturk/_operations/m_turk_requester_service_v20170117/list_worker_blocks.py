...
def handle_response(
    ...
    out: aws_sdk_mturk.types.list_worker_blocks_response.ListWorkerBlocksResponse = (
        aws_sdk_mturk.types.list_worker_blocks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.list_worker_blocks_request.ListWorkerBlocksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_worker_blocks_request.serialize_aws_json_1_1(input_)
    ).encode()
