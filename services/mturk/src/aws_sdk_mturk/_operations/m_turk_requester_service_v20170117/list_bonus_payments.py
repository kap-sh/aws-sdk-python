...
def handle_response(
    ...
    out: aws_sdk_mturk.types.list_bonus_payments_response.ListBonusPaymentsResponse = (
        aws_sdk_mturk.types.list_bonus_payments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.list_bonus_payments_request.ListBonusPaymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_bonus_payments_request.serialize_aws_json_1_1(input_)
    ).encode()
