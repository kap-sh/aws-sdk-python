...
def build_request(
    ...
    input: aws_sdk_mturk.types.list_bonus_payments_request.ListBonusPaymentsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_bonus_payments_request.serialize_aws_json_1_1(input)
    ).encode()
