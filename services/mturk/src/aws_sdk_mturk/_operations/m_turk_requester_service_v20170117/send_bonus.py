...
def handle_response(
    ...
    out: aws_sdk_mturk.types.send_bonus_response.SendBonusResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.send_bonus_request.SendBonusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.send_bonus_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def send_bonus(
    ...
    input_: aws_sdk_mturk.types.send_bonus_request.SendBonusRequest,
) -> tuple[aws_sdk_mturk.types.send_bonus_response.SendBonusResponse, zapros.Response]:
