"""Generated from Smithy shape ``com.amazonaws.mturk#ListWorkersWithQualificationType``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.list_workers_with_qualification_type_response.ListWorkersWithQualificationTypeResponse = aws_sdk_mturk.types.list_workers_with_qualification_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.list_workers_with_qualification_type_request.ListWorkersWithQualificationTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_workers_with_qualification_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_workers_with_qualification_type(
