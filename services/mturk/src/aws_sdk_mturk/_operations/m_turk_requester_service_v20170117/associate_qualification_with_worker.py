...
def handle_response(
    ...
    out: aws_sdk_mturk.types.associate_qualification_with_worker_response.AssociateQualificationWithWorkerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.associate_qualification_with_worker_request.AssociateQualificationWithWorkerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.associate_qualification_with_worker_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
