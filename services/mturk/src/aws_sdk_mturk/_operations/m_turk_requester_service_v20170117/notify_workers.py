"""Generated from Smithy shape ``com.amazonaws.mturk#NotifyWorkers``."""
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.notify_workers_request.NotifyWorkersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.notify_workers_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def notify_workers(
    ...
    aws_sdk_mturk.types.notify_workers_response.NotifyWorkersResponse, zapros.Response
]:
...
async def async_notify_workers(
