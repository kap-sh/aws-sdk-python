"""Generated from Smithy shape ``com.amazonaws.mturk#UpdateHITTypeOfHIT``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.update_hit_type_of_hit_response.UpdateHITTypeOfHITResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_mturk.types.update_hit_type_of_hit_request.UpdateHITTypeOfHITRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.update_hit_type_of_hit_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_update_hit_type_of_hit(
