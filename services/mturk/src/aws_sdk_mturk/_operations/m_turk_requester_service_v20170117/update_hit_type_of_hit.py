...
def build_request(
    ...
    input_: aws_sdk_mturk.types.update_hit_type_of_hit_request.UpdateHITTypeOfHITRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.update_hit_type_of_hit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
