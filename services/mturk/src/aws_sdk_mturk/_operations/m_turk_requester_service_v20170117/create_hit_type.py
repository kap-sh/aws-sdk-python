"""Generated from Smithy shape ``com.amazonaws.mturk#CreateHITType``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.create_hit_type_response.CreateHITTypeResponse = (
        aws_sdk_mturk.types.create_hit_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.create_hit_type_request.CreateHITTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.create_hit_type_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_hit_type(
    ...
    aws_sdk_mturk.types.create_hit_type_response.CreateHITTypeResponse, zapros.Response
]:
...
async def async_create_hit_type(
