...
def build_request(
    ...
    input: aws_sdk_mturk.types.delete_worker_block_request.DeleteWorkerBlockRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.delete_worker_block_request.serialize_aws_json_1_1(input)
    ).encode()
