"""Generated from Smithy shape ``com.amazonaws.mturk#GetFileUploadURL``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.get_file_upload_url_response.GetFileUploadURLResponse = (
        aws_sdk_mturk.types.get_file_upload_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_mturk.types.get_file_upload_url_request.GetFileUploadURLRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.get_file_upload_url_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_get_file_upload_url(
