...
def handle_response(
    ...
    out: aws_sdk_mturk.types.accept_qualification_request_response.AcceptQualificationRequestResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.accept_qualification_request_request.AcceptQualificationRequestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
