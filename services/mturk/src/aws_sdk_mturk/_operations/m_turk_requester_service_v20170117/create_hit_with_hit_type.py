...
def handle_response(
    ...
    out: aws_sdk_mturk.types.create_hit_with_hit_type_response.CreateHITWithHITTypeResponse = aws_sdk_mturk.types.create_hit_with_hit_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.create_hit_with_hit_type_request.CreateHITWithHITTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.create_hit_with_hit_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
