"""Generated from Smithy shape ``com.amazonaws.mturk#ListAssignmentsForHIT``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.list_assignments_for_hit_response.ListAssignmentsForHITResponse = aws_sdk_mturk.types.list_assignments_for_hit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.list_assignments_for_hit_request.ListAssignmentsForHITRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_assignments_for_hit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_assignments_for_hit(
