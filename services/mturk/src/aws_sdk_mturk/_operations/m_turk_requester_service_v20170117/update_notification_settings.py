"""Generated from Smithy shape ``com.amazonaws.mturk#UpdateNotificationSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_mturk.types.update_notification_settings_response.UpdateNotificationSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mturk.types.update_notification_settings_request.UpdateNotificationSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
