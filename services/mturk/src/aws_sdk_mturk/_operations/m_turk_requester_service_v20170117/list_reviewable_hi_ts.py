...
def build_request(
    ...
    input: aws_sdk_mturk.types.list_reviewable_hi_ts_request.ListReviewableHITsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mturk.types.list_reviewable_hi_ts_request.serialize_aws_json_1_1(input)
    ).encode()
