...
HITList: TypeAlias = list["aws_sdk_mturk.types.hit.HIT"]
...
def serialize_aws_json_1_1(value: HITList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_mturk.types.hit.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> HITList:
    ...
    out: HITList = []
    for item in data:
        out.append(aws_sdk_mturk.types.hit.deserialize_aws_json_1_1(item))
    return out
