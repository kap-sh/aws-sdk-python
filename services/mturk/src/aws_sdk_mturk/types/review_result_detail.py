...
class ReviewResultDetail(TypedDict):
    ...
    subject_type: NotRequired["aws_sdk_mturk.types.string.String"]
    """<p> The type of the object from the SubjectId field.</p>"""
    question_id: NotRequired["aws_sdk_mturk.types.entity_id.EntityId"]
    ...
    value: NotRequired["aws_sdk_mturk.types.string.String"]
