...
class SendTestEventNotificationRequest(TypedDict):
    notification: (
...
def serialize_aws_json_1_1(value: SendTestEventNotificationRequest) -> dict:
    ...
    out["TestEventType"] = aws_sdk_mturk.types.event_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SendTestEventNotificationRequest:
    ...
    if "TestEventType" in data:
        ...
        out["test_event_type"] = (
            aws_sdk_mturk.types.event_type.deserialize_aws_json_1_1(
                data["TestEventType"]
            )
        )
    else:
