...
class UpdateExpirationForHITRequest(TypedDict):
...
def serialize_aws_json_1_1(value: UpdateExpirationForHITRequest) -> dict:
    ...
    out["ExpireAt"] = aws_sdk_mturk.types.timestamp.serialize_aws_json_1_1(
        value["expire_at"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UpdateExpirationForHITRequest:
    ...
    if "ExpireAt" in data:
        ...
        out["expire_at"] = aws_sdk_mturk.types.timestamp.deserialize_aws_json_1_1(
            data["ExpireAt"]
        )
    else:
