...
class Assignment(TypedDict, closed=True):
    ...
    auto_approval_time: NotRequired["aws_sdk_mturk.types.timestamp.Timestamp"]
    ...
    accept_time: NotRequired["aws_sdk_mturk.types.timestamp.Timestamp"]
    ...
    approval_time: NotRequired["aws_sdk_mturk.types.timestamp.Timestamp"]
    ...
    rejection_time: NotRequired["aws_sdk_mturk.types.timestamp.Timestamp"]
    ...
    deadline: NotRequired["aws_sdk_mturk.types.timestamp.Timestamp"]
...
def serialize_aws_json_1_1(value: Assignment) -> dict:
    ...
    if "assignment_status" in value:
        ...
        out["AssignmentStatus"] = (
            aws_sdk_mturk.types.assignment_status.serialize_aws_json_1_1(
    ...
    if "auto_approval_time" in value:
        ...
        out["AutoApprovalTime"] = aws_sdk_mturk.types.timestamp.serialize_aws_json_1_1(
            value["auto_approval_time"]
        )
    if "accept_time" in value:
        import aws_sdk_mturk.types.timestamp

        out["AcceptTime"] = aws_sdk_mturk.types.timestamp.serialize_aws_json_1_1(
            value["accept_time"]
        )
    ...
    if "approval_time" in value:
        ...
        out["ApprovalTime"] = aws_sdk_mturk.types.timestamp.serialize_aws_json_1_1(
            value["approval_time"]
        )
    if "rejection_time" in value:
        import aws_sdk_mturk.types.timestamp

        out["RejectionTime"] = aws_sdk_mturk.types.timestamp.serialize_aws_json_1_1(
            value["rejection_time"]
        )
    if "deadline" in value:
        import aws_sdk_mturk.types.timestamp

        out["Deadline"] = aws_sdk_mturk.types.timestamp.serialize_aws_json_1_1(
            value["deadline"]
        )
    if "answer" in value:
...
def deserialize_aws_json_1_1(data: dict) -> Assignment:
    ...
    if "AssignmentStatus" in data:
        ...
        out["assignment_status"] = (
            aws_sdk_mturk.types.assignment_status.deserialize_aws_json_1_1(
    ...
    if "AutoApprovalTime" in data:
        ...
        out["auto_approval_time"] = (
            aws_sdk_mturk.types.timestamp.deserialize_aws_json_1_1(
    ...
    if "AcceptTime" in data:
        ...
        out["accept_time"] = aws_sdk_mturk.types.timestamp.deserialize_aws_json_1_1(
            data["AcceptTime"]
        )
    ...
    if "ApprovalTime" in data:
        ...
        out["approval_time"] = aws_sdk_mturk.types.timestamp.deserialize_aws_json_1_1(
            data["ApprovalTime"]
        )
    if "RejectionTime" in data:
        import aws_sdk_mturk.types.timestamp

        out["rejection_time"] = aws_sdk_mturk.types.timestamp.deserialize_aws_json_1_1(
            data["RejectionTime"]
        )
    if "Deadline" in data:
        import aws_sdk_mturk.types.timestamp

        out["deadline"] = aws_sdk_mturk.types.timestamp.deserialize_aws_json_1_1(
            data["Deadline"]
        )
    if "Answer" in data:
