...
class ListReviewableHITsRequest(TypedDict):
    ...
    status: NotRequired["aws_sdk_mturk.types.reviewable_hit_status.ReviewableHITStatus"]
...
def serialize_aws_json_1_1(value: ListReviewableHITsRequest) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_mturk.types.reviewable_hit_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListReviewableHITsRequest:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_mturk.types.reviewable_hit_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
