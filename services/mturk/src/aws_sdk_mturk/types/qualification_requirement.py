...
if TYPE_CHECKING:
    ...
    import aws_sdk_mturk.types.comparator
    import aws_sdk_mturk.types.hit_access_actions
    import aws_sdk_mturk.types.integer_list
    import aws_sdk_mturk.types.locale_list
    import aws_sdk_mturk.types.string


class QualificationRequirement(TypedDict):
    qualification_type_id: "aws_sdk_mturk.types.string.String"
    """<p> The ID of the Qualification type for the requirement.</p>"""
    comparator: "aws_sdk_mturk.types.comparator.Comparator"
    ...
    integer_values: NotRequired["aws_sdk_mturk.types.integer_list.IntegerList"]
    ...
    locale_values: NotRequired["aws_sdk_mturk.types.locale_list.LocaleList"]
    """<p> The locale value to compare against the Qualification's value. The local value must be a valid ISO 3166 country code or supports ISO 3166-2 subdivisions. LocaleValue can only be used with a Worker_Locale QualificationType ID. LocaleValue can only be used with the EqualTo, NotEqualTo, In, and NotIn comparators. You must only use a single LocaleValue element when using the EqualTo or NotEqualTo comparators. When performing a set comparison by using the In or the NotIn comparator, you can use up to 30 LocaleValue elements in a QualificationRequirement data structure. </p>"""
    required_to_preview: NotRequired["aws_sdk_mturk.types.boolean.Boolean"]
    ...
    actions_guarded: NotRequired[
        "aws_sdk_mturk.types.hit_access_actions.HITAccessActions"
    ]
...
def serialize_aws_json_1_1(value: QualificationRequirement) -> dict:
    ...
    out["Comparator"] = aws_sdk_mturk.types.comparator.serialize_aws_json_1_1(
        value["comparator"]
    )
    if "integer_values" in value:
        import aws_sdk_mturk.types.integer_list

        out["IntegerValues"] = aws_sdk_mturk.types.integer_list.serialize_aws_json_1_1(
            value["integer_values"]
        )
    if "locale_values" in value:
        import aws_sdk_mturk.types.locale_list

        out["LocaleValues"] = aws_sdk_mturk.types.locale_list.serialize_aws_json_1_1(
            value["locale_values"]
        )
    ...
    if "actions_guarded" in value:
        ...
        out["ActionsGuarded"] = (
            aws_sdk_mturk.types.hit_access_actions.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> QualificationRequirement:
    ...
    if "Comparator" in data:
        ...
        out["comparator"] = aws_sdk_mturk.types.comparator.deserialize_aws_json_1_1(
            data["Comparator"]
        )
    else:
    ...
    if "IntegerValues" in data:
        ...
        out["integer_values"] = (
            aws_sdk_mturk.types.integer_list.deserialize_aws_json_1_1(
                data["IntegerValues"]
            )
        )
    if "LocaleValues" in data:
        ...
        out["locale_values"] = aws_sdk_mturk.types.locale_list.deserialize_aws_json_1_1(
            data["LocaleValues"]
        )
    ...
    if "ActionsGuarded" in data:
        ...
        out["actions_guarded"] = (
            aws_sdk_mturk.types.hit_access_actions.deserialize_aws_json_1_1(
                data["ActionsGuarded"]
            )
        )
    return out
