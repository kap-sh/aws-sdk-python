...
class ListHITsResponse(TypedDict):
    ...
    hi_ts: NotRequired["aws_sdk_mturk.types.hit_list.HITList"]
...
def serialize_aws_json_1_1(value: ListHITsResponse) -> dict:
    ...
    if "hi_ts" in value:
        ...
        out["HITs"] = aws_sdk_mturk.types.hit_list.serialize_aws_json_1_1(
            value["hi_ts"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListHITsResponse:
    ...
    if "HITs" in data:
        ...
        out["hi_ts"] = aws_sdk_mturk.types.hit_list.deserialize_aws_json_1_1(
            data["HITs"]
        )
    return out
