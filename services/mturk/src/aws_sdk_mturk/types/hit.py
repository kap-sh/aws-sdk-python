...
if TYPE_CHECKING:
    ...
    import aws_sdk_mturk.types.hit_review_status
    import aws_sdk_mturk.types.hit_status
...
class HIT(TypedDict):
    ...
    hit_group_id: NotRequired["aws_sdk_mturk.types.entity_id.EntityId"]
    ...
    title: NotRequired["aws_sdk_mturk.types.string.String"]
    ...
    hit_status: NotRequired["aws_sdk_mturk.types.hit_status.HITStatus"]
    ...
    reward: NotRequired["aws_sdk_mturk.types.currency_amount.CurrencyAmount"]
    ...
    expiration: NotRequired["aws_sdk_mturk.types.timestamp.Timestamp"]
    """<p>The date and time the HIT expires.</p>"""
    assignment_duration_in_seconds: NotRequired["aws_sdk_mturk.types.long.Long"]
    ...
    hit_review_status: NotRequired[
        "aws_sdk_mturk.types.hit_review_status.HITReviewStatus"
    ]
    ...
    number_of_assignments_pending: NotRequired["aws_sdk_mturk.types.integer.Integer"]
    ...
    number_of_assignments_available: NotRequired["aws_sdk_mturk.types.integer.Integer"]
    """<p> The number of assignments for this HIT that are available for Workers to accept.</p>"""
    number_of_assignments_completed: NotRequired["aws_sdk_mturk.types.integer.Integer"]
...
def serialize_aws_json_1_1(value: HIT) -> dict:
    ...
    if "hit_status" in value:
        ...
        out["HITStatus"] = aws_sdk_mturk.types.hit_status.serialize_aws_json_1_1(
            value["hit_status"]
        )
    ...
    if "expiration" in value:
        ...
        out["Expiration"] = aws_sdk_mturk.types.timestamp.serialize_aws_json_1_1(
            value["expiration"]
        )
    ...
    if "hit_review_status" in value:
        ...
        out["HITReviewStatus"] = (
            aws_sdk_mturk.types.hit_review_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> HIT:
    ...
    if "HITStatus" in data:
        ...
        out["hit_status"] = aws_sdk_mturk.types.hit_status.deserialize_aws_json_1_1(
            data["HITStatus"]
        )
    ...
    if "Expiration" in data:
        ...
        out["expiration"] = aws_sdk_mturk.types.timestamp.deserialize_aws_json_1_1(
            data["Expiration"]
        )
    ...
    if "HITReviewStatus" in data:
        ...
        out["hit_review_status"] = (
            aws_sdk_mturk.types.hit_review_status.deserialize_aws_json_1_1(
