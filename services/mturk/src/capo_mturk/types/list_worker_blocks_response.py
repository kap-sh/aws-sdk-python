...
class ListWorkerBlocksResponse(TypedDict, closed=True):
    ...
    worker_blocks: NotRequired["capo_mturk.types.worker_block_list.WorkerBlockList"]
...
def serialize_aws_json_1_1(value: ListWorkerBlocksResponse) -> dict:
    ...
    if "worker_blocks" in value:
        ...
        out["WorkerBlocks"] = capo_mturk.types.worker_block_list.serialize_aws_json_1_1(
            value["worker_blocks"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListWorkerBlocksResponse:
    ...
    if "WorkerBlocks" in data:
        ...
        out["worker_blocks"] = (
            capo_mturk.types.worker_block_list.deserialize_aws_json_1_1(
                data["WorkerBlocks"]
            )
        )
    return out
