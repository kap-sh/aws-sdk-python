...
if TYPE_CHECKING:
    import capo_mturk.types.notify_workers_failure_status_list


class NotifyWorkersResponse(TypedDict, closed=True):
    notify_workers_failure_statuses: NotRequired[
        "capo_mturk.types.notify_workers_failure_status_list.NotifyWorkersFailureStatusList"
    ]
...
def serialize_aws_json_1_1(value: NotifyWorkersResponse) -> dict:
    ...
    if "notify_workers_failure_statuses" in value:
        ...
        out["NotifyWorkersFailureStatuses"] = (
            capo_mturk.types.notify_workers_failure_status_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> NotifyWorkersResponse:
    ...
    if "NotifyWorkersFailureStatuses" in data:
        ...
        out["notify_workers_failure_statuses"] = (
            capo_mturk.types.notify_workers_failure_status_list.deserialize_aws_json_1_1(
