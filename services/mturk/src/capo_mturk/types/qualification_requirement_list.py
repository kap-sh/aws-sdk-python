...
if TYPE_CHECKING:
    import capo_mturk.types.qualification_requirement

QualificationRequirementList: TypeAlias = list[
    "capo_mturk.types.qualification_requirement.QualificationRequirement"
]
...
def serialize_aws_json_1_1(value: QualificationRequirementList) -> list:
    ...
    for item in value:
        out.append(
            capo_mturk.types.qualification_requirement.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> QualificationRequirementList:
    ...
    for item in data:
        out.append(
            capo_mturk.types.qualification_requirement.deserialize_aws_json_1_1(item)
        )
    return out
