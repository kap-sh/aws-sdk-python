...
class ListReviewPolicyResultsForHITResponse(TypedDict, closed=True):
    hit_id: NotRequired["capo_mturk.types.entity_id.EntityId"]
    """<p>The HITId of the HIT for which results have been returned.</p>"""
    assignment_review_policy: NotRequired["capo_mturk.types.review_policy.ReviewPolicy"]
    """<p> The name of the Assignment-level Review Policy. This contains only the PolicyName element. </p>"""
    hit_review_policy: NotRequired["capo_mturk.types.review_policy.ReviewPolicy"]
    """<p>The name of the HIT-level Review Policy. This contains only the PolicyName element.</p>"""
    assignment_review_report: NotRequired["capo_mturk.types.review_report.ReviewReport"]
    """<p> Contains both ReviewResult and ReviewAction elements for an Assignment. </p>"""
    hit_review_report: NotRequired["capo_mturk.types.review_report.ReviewReport"]
...
def serialize_aws_json_1_1(value: ListReviewPolicyResultsForHITResponse) -> dict:
    ...
    if "assignment_review_policy" in value:
        ...
        out["AssignmentReviewPolicy"] = (
            capo_mturk.types.review_policy.serialize_aws_json_1_1(
    ...
    if "hit_review_policy" in value:
        ...
        out["HITReviewPolicy"] = capo_mturk.types.review_policy.serialize_aws_json_1_1(
    ...
    if "assignment_review_report" in value:
        ...
        out["AssignmentReviewReport"] = (
            capo_mturk.types.review_report.serialize_aws_json_1_1(
    ...
    if "hit_review_report" in value:
        ...
        out["HITReviewReport"] = capo_mturk.types.review_report.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListReviewPolicyResultsForHITResponse:
    ...
    if "AssignmentReviewPolicy" in data:
        ...
        out["assignment_review_policy"] = (
            capo_mturk.types.review_policy.deserialize_aws_json_1_1(
    ...
    if "AssignmentReviewReport" in data:
        ...
        out["assignment_review_report"] = (
            capo_mturk.types.review_report.deserialize_aws_json_1_1(
