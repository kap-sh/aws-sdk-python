...
class GetAccountBalanceResponse(TypedDict, closed=True):
    available_balance: NotRequired["capo_mturk.types.currency_amount.CurrencyAmount"]
    on_hold_balance: NotRequired["capo_mturk.types.currency_amount.CurrencyAmount"]
