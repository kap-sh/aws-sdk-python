"""Generated from Smithy shape ``com.amazonaws.mturk#ListReviewableHITsResponse``."""
...
class ListReviewableHITsResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListReviewableHITsResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListReviewableHITsResponse:
    out: ListReviewableHITsResponse = {}  # type: ignore[typeddict-item]
