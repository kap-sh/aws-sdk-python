"""Generated from Smithy shape ``com.amazonaws.mturk#ApproveAssignment``."""
...
def handle_response(
    ...
    out: capo_mturk.types.approve_assignment_response.ApproveAssignmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.approve_assignment_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_approve_assignment(
