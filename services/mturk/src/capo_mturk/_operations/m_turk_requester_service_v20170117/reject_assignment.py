"""Generated from Smithy shape ``com.amazonaws.mturk#RejectAssignment``."""
...
def handle_response(
    ...
    out: capo_mturk.types.reject_assignment_response.RejectAssignmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.reject_assignment_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_reject_assignment(
