"""Generated from Smithy shape ``com.amazonaws.mturk#GetQualificationType``."""
...
def handle_response(
    ...
    out: capo_mturk.types.get_qualification_type_response.GetQualificationTypeResponse = capo_mturk.types.get_qualification_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.get_qualification_type_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_qualification_type(
