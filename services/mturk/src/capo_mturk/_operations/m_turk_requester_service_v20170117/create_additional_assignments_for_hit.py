"""Generated from Smithy shape ``com.amazonaws.mturk#CreateAdditionalAssignmentsForHIT``."""
...
def handle_response(
    ...
    out: capo_mturk.types.create_additional_assignments_for_hit_response.CreateAdditionalAssignmentsForHITResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.create_additional_assignments_for_hit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_additional_assignments_for_hit(
