"""Generated from Smithy shape ``com.amazonaws.mturk#DeleteHIT``."""
...
def handle_response(
    ...
    out: capo_mturk.types.delete_hit_response.DeleteHITResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.delete_hit_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_hit(
    ...
    input_: capo_mturk.types.delete_hit_request.DeleteHITRequest,
) -> tuple[capo_mturk.types.delete_hit_response.DeleteHITResponse, zapros.Response]:
