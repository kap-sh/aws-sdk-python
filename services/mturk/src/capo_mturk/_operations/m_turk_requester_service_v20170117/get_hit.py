"""Generated from Smithy shape ``com.amazonaws.mturk#GetHIT``."""
...
def handle_response(
    ...
    out: capo_mturk.types.get_hit_response.GetHITResponse = (
        capo_mturk.types.get_hit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_mturk.types.get_hit_request.GetHITRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.get_hit_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_hit(
    options: OperationOptions, input_: capo_mturk.types.get_hit_request.GetHITRequest
) -> tuple[capo_mturk.types.get_hit_response.GetHITResponse, zapros.Response]:
