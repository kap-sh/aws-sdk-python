"""Generated from Smithy shape ``com.amazonaws.mturk#CreateWorkerBlock``."""
...
def handle_response(
    ...
    out: capo_mturk.types.create_worker_block_response.CreateWorkerBlockResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.create_worker_block_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_worker_block(
