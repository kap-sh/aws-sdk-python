"""Generated from Smithy shape ``com.amazonaws.mturk#GetAssignment``."""
...
def handle_response(
    ...
    out: capo_mturk.types.get_assignment_response.GetAssignmentResponse = (
        capo_mturk.types.get_assignment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.get_assignment_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_assignment(
    ...
    capo_mturk.types.get_assignment_response.GetAssignmentResponse, zapros.Response
]:
