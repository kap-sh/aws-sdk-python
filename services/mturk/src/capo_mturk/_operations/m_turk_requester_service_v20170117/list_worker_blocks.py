"""Generated from Smithy shape ``com.amazonaws.mturk#ListWorkerBlocks``."""
...
import capo_mturk.types.worker_block_list
...
def handle_response(
    ...
    out: capo_mturk.types.list_worker_blocks_response.ListWorkerBlocksResponse = (
        capo_mturk.types.list_worker_blocks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.list_worker_blocks_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_worker_blocks(
