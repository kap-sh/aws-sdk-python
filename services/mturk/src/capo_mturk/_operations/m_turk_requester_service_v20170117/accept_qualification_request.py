"""Generated from Smithy shape ``com.amazonaws.mturk#AcceptQualificationRequest``."""
...
def handle_response(
    ...
    out: capo_mturk.types.accept_qualification_request_response.AcceptQualificationRequestResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.accept_qualification_request_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_accept_qualification_request(
