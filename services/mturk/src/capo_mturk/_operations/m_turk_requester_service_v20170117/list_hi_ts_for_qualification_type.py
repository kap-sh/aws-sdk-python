"""Generated from Smithy shape ``com.amazonaws.mturk#ListHITsForQualificationType``."""
...
def handle_response(
    ...
    out: capo_mturk.types.list_hi_ts_for_qualification_type_response.ListHITsForQualificationTypeResponse = capo_mturk.types.list_hi_ts_for_qualification_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.list_hi_ts_for_qualification_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_hi_ts_for_qualification_type(
