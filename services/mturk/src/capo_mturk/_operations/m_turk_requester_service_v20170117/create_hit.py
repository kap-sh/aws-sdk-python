"""Generated from Smithy shape ``com.amazonaws.mturk#CreateHIT``."""
...
def handle_response(
    ...
    out: capo_mturk.types.create_hit_response.CreateHITResponse = (
        capo_mturk.types.create_hit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.create_hit_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_hit(
    ...
    input_: capo_mturk.types.create_hit_request.CreateHITRequest,
) -> tuple[capo_mturk.types.create_hit_response.CreateHITResponse, zapros.Response]:
