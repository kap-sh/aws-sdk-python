...
class MTurkError(Exception):
    """Base class for all MTurk service errors."""


class ServiceError(MTurkError):
...
class SerializationError(MTurkError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MTurkError):
...
class WaiterFailedError(MTurkError):
...
class WaiterTimeoutError(MTurkError):
