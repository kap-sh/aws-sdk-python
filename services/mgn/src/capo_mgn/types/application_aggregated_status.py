...
if TYPE_CHECKING:
    import capo_mgn.types.application_health_status
    import capo_mgn.types.application_progress_status
    import capo_mgn.types.iso8601_datetime_string
    import capo_mgn.types.positive_integer


class ApplicationAggregatedStatus(TypedDict, closed=True):
    ...
    health_status: NotRequired[
        "capo_mgn.types.application_health_status.ApplicationHealthStatus"
    ]
    """<p>Application aggregated status health status.</p>"""
    progress_status: NotRequired[
        "capo_mgn.types.application_progress_status.ApplicationProgressStatus"
    ]
    """<p>Application aggregated status progress status.</p>"""
    total_source_servers: "capo_mgn.types.positive_integer.PositiveInteger"
