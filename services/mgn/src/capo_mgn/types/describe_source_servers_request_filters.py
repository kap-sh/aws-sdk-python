...
class DescribeSourceServersRequestFilters(TypedDict, closed=True):
    source_server_i_ds: NotRequired[
        "capo_mgn.types.describe_source_servers_request_filters_i_ds.DescribeSourceServersRequestFiltersIDs"
    ]
    ...
    replication_types: NotRequired["capo_mgn.types.replication_types.ReplicationTypes"]
    """<p>Request to filter Source Servers list by replication type.</p>"""
    life_cycle_states: NotRequired["capo_mgn.types.life_cycle_states.LifeCycleStates"]
    """<p>Request to filter Source Servers list by life cycle states.</p>"""
    application_i_ds: NotRequired[
        "capo_mgn.types.describe_source_servers_request_application_i_ds.DescribeSourceServersRequestApplicationIDs"
    ]
...
def serialize_json(value: DescribeSourceServersRequestFilters) -> dict:
    ...
    if "source_server_i_ds" in value:
        ...
        out["sourceServerIDs"] = (
            capo_mgn.types.describe_source_servers_request_filters_i_ds.serialize_json(
    ...
    if "replication_types" in value:
        ...
        out["replicationTypes"] = capo_mgn.types.replication_types.serialize_json(
            value["replication_types"]
        )
    if "life_cycle_states" in value:
        import capo_mgn.types.life_cycle_states

        out["lifeCycleStates"] = capo_mgn.types.life_cycle_states.serialize_json(
    ...
    if "application_i_ds" in value:
        ...
        out["applicationIDs"] = (
            capo_mgn.types.describe_source_servers_request_application_i_ds.serialize_json(
...
def deserialize_json(data: dict) -> DescribeSourceServersRequestFilters:
    ...
    if "sourceServerIDs" in data:
        ...
        out["source_server_i_ds"] = (
            capo_mgn.types.describe_source_servers_request_filters_i_ds.deserialize_json(
    ...
    if "applicationIDs" in data:
        ...
        out["application_i_ds"] = (
            capo_mgn.types.describe_source_servers_request_application_i_ds.deserialize_json(
                data["applicationIDs"]
            )
        )
    return out
