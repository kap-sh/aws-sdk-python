...
class DataReplicationInfoReplicatedDisk(TypedDict, closed=True):
    ...
    total_storage_bytes: "capo_mgn.types.positive_integer.PositiveInteger"
    """<p>Request to query total amount of data replicated in bytes.</p>"""
    replicated_storage_bytes: "capo_mgn.types.positive_integer.PositiveInteger"
    """<p>Request to query amount of data replicated in bytes.</p>"""
    rescanned_storage_bytes: "capo_mgn.types.positive_integer.PositiveInteger"
    """<p>Request to query amount of data rescanned in bytes.</p>"""
    backlogged_storage_bytes: "capo_mgn.types.positive_integer.PositiveInteger"
