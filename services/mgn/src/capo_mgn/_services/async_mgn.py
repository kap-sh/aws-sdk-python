...
from capo_mgn._resources.application_migration_service.job_resource import (
    AsyncJobResource,
)
...
from capo_mgn._resources.application_migration_service.wave_resource import (
    AsyncWaveResource,
)
from capo_mgn._services._aws_config import aaws_config
...
class AsyncmgnClientConfig(TypedDict, total=False, closed=True):
...
class AsyncmgnClient:
    ...
    async def initialize_service(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mgn.types.initialize_service_request.InitializeServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_mgn.types.initialize_service_response.InitializeServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mgn._operations.application_migration_service.initialize_service.async_initialize_service(
    ...
    async def list_import_file_enrichments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mgn.types.list_import_file_enrichments_request.ListImportFileEnrichmentsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mgn.types.list_import_file_enrichments_response.ListImportFileEnrichmentsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mgn._operations.application_migration_service.list_import_file_enrichments.async_list_import_file_enrichments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_import_file_enrichments(
        ...
        *,
        ...
        max_results: Optional["capo_mgn.types.max_results_type.MaxResultsType"] = None,
        next_token: Optional["capo_mgn.types.pagination_token.PaginationToken"] = None,
    ) -> "AsyncIterator[capo_mgn.types.import_file_enrichment.ImportFileEnrichment]":
        _token = next_token
        while True:
    ...
    async def list_managed_accounts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mgn.types.list_managed_accounts_request.ListManagedAccountsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mgn.types.list_managed_accounts_response.ListManagedAccountsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mgn._operations.application_migration_service.list_managed_accounts.async_list_managed_accounts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_managed_accounts(
        ...
        *,
        ...
        max_results: Optional["capo_mgn.types.max_results_type.MaxResultsType"] = None,
        next_token: Optional["capo_mgn.types.pagination_token.PaginationToken"] = None,
    ) -> "AsyncIterator[capo_mgn.types.managed_account.ManagedAccount]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mgn.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_mgn.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mgn._operations.application_migration_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_import_file_enrichment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mgn.types.start_import_file_enrichment_request.StartImportFileEnrichmentRequest]",
        ) -> AsyncOperationResponse[
            "capo_mgn.types.start_import_file_enrichment_response.StartImportFileEnrichmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mgn._operations.application_migration_service.start_import_file_enrichment.async_start_import_file_enrichment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mgn.types.tag_resource_request.TagResourceRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_mgn._operations.application_migration_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mgn.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_mgn._operations.application_migration_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
