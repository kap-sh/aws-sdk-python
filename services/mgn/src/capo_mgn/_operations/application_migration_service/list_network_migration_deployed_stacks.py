"""Generated from Smithy shape ``com.amazonaws.mgn#ListNetworkMigrationDeployedStacks``."""
...
import capo_mgn.types.network_migration_deployed_stacks_list
...
def handle_response(
    ...
    out: capo_mgn.types.list_network_migration_deployed_stacks_response.ListNetworkMigrationDeployedStacksResponse = capo_mgn.types.list_network_migration_deployed_stacks_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_network_migration_deployed_stacks_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_network_migration_deployed_stacks(
