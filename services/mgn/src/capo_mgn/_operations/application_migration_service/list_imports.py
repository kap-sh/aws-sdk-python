...
def handle_response(
    ...
    out: capo_mgn.types.list_imports_response.ListImportsResponse = (
        capo_mgn.types.list_imports_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_imports_request.serialize_json(input_)
    ).encode()
...
def list_imports(
    ...
    input_: capo_mgn.types.list_imports_request.ListImportsRequest,
) -> tuple[capo_mgn.types.list_imports_response.ListImportsResponse, zapros.Response]:
