"""Generated from Smithy shape ``com.amazonaws.mgn#DescribeReplicationConfigurationTemplates``."""
...
def handle_response(
    ...
    out: capo_mgn.types.describe_replication_configuration_templates_response.DescribeReplicationConfigurationTemplatesResponse = capo_mgn.types.describe_replication_configuration_templates_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.describe_replication_configuration_templates_request.serialize_json(
            input_
        )
    ).encode()
