...
def handle_response(
    ...
    out: capo_mgn.types.delete_wave_response.DeleteWaveResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.delete_wave_request.serialize_json(input_)
    ).encode()
...
def delete_wave(
    ...
    input_: capo_mgn.types.delete_wave_request.DeleteWaveRequest,
) -> tuple[capo_mgn.types.delete_wave_response.DeleteWaveResponse, zapros.Response]:
