"""Generated from Smithy shape ``com.amazonaws.mgn#UpdateNetworkMigrationMapperSegment``."""
...
def handle_response(
    ...
    out: capo_mgn.types.network_migration_mapper_segment.NetworkMigrationMapperSegment = capo_mgn.types.network_migration_mapper_segment.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.update_network_migration_mapper_segment_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_network_migration_mapper_segment(
