...
import capo_mgn.types.network_migration_code_generations_list
...
def handle_response(
    ...
    out: capo_mgn.types.list_network_migration_code_generations_response.ListNetworkMigrationCodeGenerationsResponse = capo_mgn.types.list_network_migration_code_generations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_network_migration_code_generations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_network_migration_code_generations(
