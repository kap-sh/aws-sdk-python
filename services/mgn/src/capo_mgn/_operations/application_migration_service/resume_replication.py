...
def handle_response(
    ...
    out: capo_mgn.types.source_server.SourceServer = (
        capo_mgn.types.source_server.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_mgn.types.source_server.SourceServer = (
        capo_mgn.types.source_server.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.resume_replication_request.serialize_json(input_)
    ).encode()
...
def resume_replication(
    ...
    input_: capo_mgn.types.resume_replication_request.ResumeReplicationRequest,
) -> tuple[capo_mgn.types.source_server.SourceServer, zapros.Response]:
...
async def async_resume_replication(
