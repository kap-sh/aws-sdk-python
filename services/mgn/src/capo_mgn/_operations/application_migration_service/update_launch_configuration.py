...
def handle_response(
    ...
    out: capo_mgn.types.launch_configuration.LaunchConfiguration = (
        capo_mgn.types.launch_configuration.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.update_launch_configuration_request.serialize_json(input_)
    ).encode()
...
def update_launch_configuration(
    ...
    input_: capo_mgn.types.update_launch_configuration_request.UpdateLaunchConfigurationRequest,
) -> tuple[capo_mgn.types.launch_configuration.LaunchConfiguration, zapros.Response]:
