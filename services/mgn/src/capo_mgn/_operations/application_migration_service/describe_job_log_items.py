"""Generated from Smithy shape ``com.amazonaws.mgn#DescribeJobLogItems``."""
...
def handle_response(
    ...
    out: capo_mgn.types.describe_job_log_items_response.DescribeJobLogItemsResponse = (
        capo_mgn.types.describe_job_log_items_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.describe_job_log_items_request.serialize_json(input_)
    ).encode()
...
async def async_describe_job_log_items(
