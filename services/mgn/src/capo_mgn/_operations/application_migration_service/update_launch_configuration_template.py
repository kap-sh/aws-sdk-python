...
def handle_response(
    ...
    out: capo_mgn.types.launch_configuration_template.LaunchConfigurationTemplate = (
        capo_mgn.types.launch_configuration_template.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.update_launch_configuration_template_request.serialize_json(
            input_
        )
    ).encode()
