"""Generated from Smithy shape ``com.amazonaws.mgn#StartNetworkMigrationCodeGeneration``."""
...
def handle_response(
    ...
    out: capo_mgn.types.start_network_migration_code_generation_response.StartNetworkMigrationCodeGenerationResponse = capo_mgn.types.start_network_migration_code_generation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.start_network_migration_code_generation_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_network_migration_code_generation(
