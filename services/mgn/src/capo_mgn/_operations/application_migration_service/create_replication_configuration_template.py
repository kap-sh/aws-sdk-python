"""Generated from Smithy shape ``com.amazonaws.mgn#CreateReplicationConfigurationTemplate``."""
...
def handle_response(
    ...
    out: capo_mgn.types.replication_configuration_template.ReplicationConfigurationTemplate = capo_mgn.types.replication_configuration_template.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.create_replication_configuration_template_request.serialize_json(
            input_
        )
    ).encode()
