...
import capo_mgn.types.connectors_list
...
def handle_response(
    ...
    out: capo_mgn.types.list_connectors_response.ListConnectorsResponse = (
        capo_mgn.types.list_connectors_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_connectors_request.serialize_json(input_)
    ).encode()
...
def list_connectors(
    ...
    capo_mgn.types.list_connectors_response.ListConnectorsResponse, zapros.Response
]:
