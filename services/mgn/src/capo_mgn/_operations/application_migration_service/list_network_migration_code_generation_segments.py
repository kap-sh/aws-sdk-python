"""Generated from Smithy shape ``com.amazonaws.mgn#ListNetworkMigrationCodeGenerationSegments``."""
...
def handle_response(
    ...
    out: capo_mgn.types.list_network_migration_code_generation_segments_response.ListNetworkMigrationCodeGenerationSegmentsResponse = capo_mgn.types.list_network_migration_code_generation_segments_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_network_migration_code_generation_segments_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_network_migration_code_generation_segments(
