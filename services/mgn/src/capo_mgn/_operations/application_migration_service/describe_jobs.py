"""Generated from Smithy shape ``com.amazonaws.mgn#DescribeJobs``."""
...
def handle_response(
    ...
    out: capo_mgn.types.describe_jobs_response.DescribeJobsResponse = (
        capo_mgn.types.describe_jobs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.describe_jobs_request.serialize_json(input_)
    ).encode()
...
def describe_jobs(
    ...
    input_: capo_mgn.types.describe_jobs_request.DescribeJobsRequest,
) -> tuple[capo_mgn.types.describe_jobs_response.DescribeJobsResponse, zapros.Response]:
