...
def handle_response(
    ...
    out: capo_mgn.types.list_waves_response.ListWavesResponse = (
        capo_mgn.types.list_waves_response.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_mgn.types.list_waves_response.ListWavesResponse = (
        capo_mgn.types.list_waves_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_waves_request.serialize_json(input_)
    ).encode()
...
def list_waves(
    ...
    input_: capo_mgn.types.list_waves_request.ListWavesRequest,
) -> tuple[capo_mgn.types.list_waves_response.ListWavesResponse, zapros.Response]:
