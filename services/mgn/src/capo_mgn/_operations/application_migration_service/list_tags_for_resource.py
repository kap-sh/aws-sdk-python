...
import capo_mgn.errors.internal_server_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalServerException":
            raise capo_mgn.errors.internal_server_exception.InternalServerException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_mgn.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_mgn.types.list_tags_for_resource_response.deserialize_json(
