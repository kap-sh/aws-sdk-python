...
import capo_mgn.types.applications_list
...
def handle_response(
    ...
    out: capo_mgn.types.list_applications_response.ListApplicationsResponse = (
        capo_mgn.types.list_applications_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_applications_request.serialize_json(input_)
    ).encode()
...
def list_applications(
    ...
    capo_mgn.types.list_applications_response.ListApplicationsResponse, zapros.Response
]:
