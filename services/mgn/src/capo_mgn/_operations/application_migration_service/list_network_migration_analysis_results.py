"""Generated from Smithy shape ``com.amazonaws.mgn#ListNetworkMigrationAnalysisResults``."""
...
import capo_mgn.types.network_migration_analysis_results_list
...
def handle_response(
    ...
    out: capo_mgn.types.list_network_migration_analysis_results_response.ListNetworkMigrationAnalysisResultsResponse = capo_mgn.types.list_network_migration_analysis_results_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_network_migration_analysis_results_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_network_migration_analysis_results(
