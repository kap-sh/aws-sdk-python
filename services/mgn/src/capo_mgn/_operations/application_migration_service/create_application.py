...
def handle_response(
    ...
    out: capo_mgn.types.application.Application = (
        capo_mgn.types.application.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_mgn.types.application.Application = (
        capo_mgn.types.application.deserialize_json(json.loads(await response.aread()))
    )
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.create_application_request.serialize_json(input_)
    ).encode()
...
def create_application(
    ...
    input_: capo_mgn.types.create_application_request.CreateApplicationRequest,
) -> tuple[capo_mgn.types.application.Application, zapros.Response]:
