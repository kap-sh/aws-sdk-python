...
def handle_response(
    ...
    out: capo_mgn.types.replication_configuration.ReplicationConfiguration = (
        capo_mgn.types.replication_configuration.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.update_replication_configuration_request.serialize_json(input_)
    ).encode()
...
def update_replication_configuration(
    ...
    capo_mgn.types.replication_configuration.ReplicationConfiguration, zapros.Response
]:
...
async def async_update_replication_configuration(
