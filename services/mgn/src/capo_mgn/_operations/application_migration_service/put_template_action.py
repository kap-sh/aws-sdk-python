...
def handle_response(
    ...
    out: capo_mgn.types.template_action_document.TemplateActionDocument = (
        capo_mgn.types.template_action_document.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.put_template_action_request.serialize_json(input_)
    ).encode()
...
def put_template_action(
    ...
    capo_mgn.types.template_action_document.TemplateActionDocument, zapros.Response
]:
...
async def async_put_template_action(
