"""Generated from Smithy shape ``com.amazonaws.mgn#ListNetworkMigrationMapperSegments``."""
...
def handle_response(
    ...
    out: capo_mgn.types.list_network_migration_mapper_segments_response.ListNetworkMigrationMapperSegmentsResponse = capo_mgn.types.list_network_migration_mapper_segments_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_network_migration_mapper_segments_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_network_migration_mapper_segments(
