...
def handle_response(
    ...
    out: capo_mgn.types.list_network_migration_executions_response.ListNetworkMigrationExecutionsResponse = capo_mgn.types.list_network_migration_executions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_network_migration_executions_request.serialize_json(input_)
    ).encode()
