"""Generated from Smithy shape ``com.amazonaws.mgn#GetNetworkMigrationMapperSegmentConstruct``."""
...
def handle_response(
    ...
    out: capo_mgn.types.get_network_migration_mapper_segment_construct_response.GetNetworkMigrationMapperSegmentConstructResponse = capo_mgn.types.get_network_migration_mapper_segment_construct_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.get_network_migration_mapper_segment_construct_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_network_migration_mapper_segment_construct(
