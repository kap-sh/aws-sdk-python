...
def build_request(
    ...
    input_: aws_sdk_mgn.types.retry_data_replication_request.RetryDataReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.retry_data_replication_request.serialize_json(input_)
    ).encode()
