...
def build_request(
    ...
    input: aws_sdk_mgn.types.retry_data_replication_request.RetryDataReplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.retry_data_replication_request.serialize_json(input)
    ).encode()
