...
def build_request(
    ...
    input_: aws_sdk_mgn.types.delete_vcenter_client_request.DeleteVcenterClientRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.delete_vcenter_client_request.serialize_json(input_)
    ).encode()
...
async def async_delete_vcenter_client(
