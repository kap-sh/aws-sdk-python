...
def build_request(
    ...
    input_: aws_sdk_mgn.types.delete_network_migration_definition_request.DeleteNetworkMigrationDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.delete_network_migration_definition_request.serialize_json(
            input_
        )
    ).encode()
