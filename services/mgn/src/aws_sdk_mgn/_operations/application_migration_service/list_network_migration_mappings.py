...
def build_request(
    ...
    input: aws_sdk_mgn.types.list_network_migration_mappings_request.ListNetworkMigrationMappingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_network_migration_mappings_request.serialize_json(input)
    ).encode()
