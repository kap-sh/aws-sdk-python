...
def handle_response(
    ...
    out: aws_sdk_mgn.types.start_test_response.StartTestResponse = (
        aws_sdk_mgn.types.start_test_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.start_test_request.StartTestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_test_request.serialize_json(input_)
    ).encode()
...
def start_test(
    ...
    input_: aws_sdk_mgn.types.start_test_request.StartTestRequest,
) -> tuple[aws_sdk_mgn.types.start_test_response.StartTestResponse, zapros.Response]:
