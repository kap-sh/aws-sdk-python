...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_export_errors_response.ListExportErrorsResponse = (
        aws_sdk_mgn.types.list_export_errors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_export_errors_request.ListExportErrorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_export_errors_request.serialize_json(input_)
    ).encode()
...
async def async_list_export_errors(
