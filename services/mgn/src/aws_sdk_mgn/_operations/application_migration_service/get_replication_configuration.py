...
def build_request(
    ...
    input_: aws_sdk_mgn.types.get_replication_configuration_request.GetReplicationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.get_replication_configuration_request.serialize_json(input_)
    ).encode()
