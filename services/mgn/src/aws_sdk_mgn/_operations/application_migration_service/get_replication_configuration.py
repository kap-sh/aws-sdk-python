...
def build_request(
    ...
    input: aws_sdk_mgn.types.get_replication_configuration_request.GetReplicationConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.get_replication_configuration_request.serialize_json(input)
    ).encode()
