...
def build_request(
    ...
    input_: aws_sdk_mgn.types.update_launch_configuration_template_request.UpdateLaunchConfigurationTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.update_launch_configuration_template_request.serialize_json(
            input_
        )
    ).encode()
