...
def handle_response(
    ...
    out: aws_sdk_mgn.types.start_network_migration_code_generation_response.StartNetworkMigrationCodeGenerationResponse = aws_sdk_mgn.types.start_network_migration_code_generation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.start_network_migration_code_generation_request.StartNetworkMigrationCodeGenerationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_network_migration_code_generation_request.serialize_json(
            input_
        )
    ).encode()
