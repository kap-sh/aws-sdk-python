...
def handle_response(
    ...
    out: aws_sdk_mgn.types.launch_configuration_template.LaunchConfigurationTemplate = (
        aws_sdk_mgn.types.launch_configuration_template.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.create_launch_configuration_template_request.CreateLaunchConfigurationTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.create_launch_configuration_template_request.serialize_json(
            input_
        )
    ).encode()
