...
def handle_response(
    ...
    out: aws_sdk_mgn.types.start_network_migration_mapping_update_response.StartNetworkMigrationMappingUpdateResponse = aws_sdk_mgn.types.start_network_migration_mapping_update_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.start_network_migration_mapping_update_request.StartNetworkMigrationMappingUpdateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_network_migration_mapping_update_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_network_migration_mapping_update(
