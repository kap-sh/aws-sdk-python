...
def build_request(
    ...
    input: aws_sdk_mgn.types.remove_source_server_action_request.RemoveSourceServerActionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.remove_source_server_action_request.serialize_json(input)
    ).encode()
