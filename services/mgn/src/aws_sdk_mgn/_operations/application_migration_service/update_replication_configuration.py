...
def handle_response(
    ...
    out: aws_sdk_mgn.types.replication_configuration.ReplicationConfiguration = (
        aws_sdk_mgn.types.replication_configuration.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mgn.types.update_replication_configuration_request.UpdateReplicationConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.update_replication_configuration_request.serialize_json(input)
    ).encode()
