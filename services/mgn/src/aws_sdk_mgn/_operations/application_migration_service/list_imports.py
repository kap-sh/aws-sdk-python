...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_imports_response.ListImportsResponse = (
        aws_sdk_mgn.types.list_imports_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_imports_request.ListImportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_imports_request.serialize_json(input_)
    ).encode()
...
def list_imports(
    ...
    aws_sdk_mgn.types.list_imports_response.ListImportsResponse, zapros.Response
]:
