...
def handle_response(
    ...
    out: aws_sdk_mgn.types.start_network_migration_deployer_job_response.StartNetworkMigrationDeployerJobResponse = aws_sdk_mgn.types.start_network_migration_deployer_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.start_network_migration_deployment_request.StartNetworkMigrationDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_network_migration_deployment_request.serialize_json(
            input_
        )
    ).encode()
