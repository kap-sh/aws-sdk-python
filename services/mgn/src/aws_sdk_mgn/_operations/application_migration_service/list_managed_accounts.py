...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_managed_accounts_response.ListManagedAccountsResponse = aws_sdk_mgn.types.list_managed_accounts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_managed_accounts_request.ListManagedAccountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_managed_accounts_request.serialize_json(input_)
    ).encode()
...
async def async_list_managed_accounts(
