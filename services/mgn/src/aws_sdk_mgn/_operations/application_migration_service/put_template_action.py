...
def handle_response(
    ...
    out: aws_sdk_mgn.types.template_action_document.TemplateActionDocument = (
        aws_sdk_mgn.types.template_action_document.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.put_template_action_request.PutTemplateActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.put_template_action_request.serialize_json(input_)
    ).encode()
...
def put_template_action(
    ...
    aws_sdk_mgn.types.template_action_document.TemplateActionDocument, zapros.Response
]:
