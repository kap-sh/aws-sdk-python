...
def build_request(
    ...
    input: aws_sdk_mgn.types.start_import_file_enrichment_request.StartImportFileEnrichmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_import_file_enrichment_request.serialize_json(input)
    ).encode()
