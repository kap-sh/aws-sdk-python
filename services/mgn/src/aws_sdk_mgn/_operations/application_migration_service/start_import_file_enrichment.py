...
def build_request(
    ...
    input_: aws_sdk_mgn.types.start_import_file_enrichment_request.StartImportFileEnrichmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_import_file_enrichment_request.serialize_json(input_)
    ).encode()
