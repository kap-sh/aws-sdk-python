...
def handle_response(
    ...
    out: aws_sdk_mgn.types.start_network_migration_analysis_response.StartNetworkMigrationAnalysisResponse = aws_sdk_mgn.types.start_network_migration_analysis_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mgn.types.start_network_migration_analysis_request.StartNetworkMigrationAnalysisRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_network_migration_analysis_request.serialize_json(input)
    ).encode()
