...
def build_request(
    ...
    input_: aws_sdk_mgn.types.start_network_migration_analysis_request.StartNetworkMigrationAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_network_migration_analysis_request.serialize_json(
            input_
        )
    ).encode()
