...
import aws_sdk_mgn.types.template_action_documents
...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_template_actions_response.ListTemplateActionsResponse = aws_sdk_mgn.types.list_template_actions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_template_actions_request.ListTemplateActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_template_actions_request.serialize_json(input_)
    ).encode()
...
async def async_list_template_actions(
