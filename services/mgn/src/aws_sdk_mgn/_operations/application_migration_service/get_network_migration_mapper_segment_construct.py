...
def handle_response(
    ...
    out: aws_sdk_mgn.types.get_network_migration_mapper_segment_construct_response.GetNetworkMigrationMapperSegmentConstructResponse = aws_sdk_mgn.types.get_network_migration_mapper_segment_construct_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.get_network_migration_mapper_segment_construct_request.GetNetworkMigrationMapperSegmentConstructRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
