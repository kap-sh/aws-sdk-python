...
import aws_sdk_mgn.types.import_errors
...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_import_errors_response.ListImportErrorsResponse = (
        aws_sdk_mgn.types.list_import_errors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_import_errors_request.ListImportErrorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_import_errors_request.serialize_json(input_)
    ).encode()
...
async def async_list_import_errors(
