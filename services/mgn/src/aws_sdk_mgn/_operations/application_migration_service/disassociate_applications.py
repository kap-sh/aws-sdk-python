...
def build_request(
    ...
    input: aws_sdk_mgn.types.disassociate_applications_request.DisassociateApplicationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.disassociate_applications_request.serialize_json(input)
    ).encode()
