...
def build_request(
    ...
    input_: aws_sdk_mgn.types.disassociate_applications_request.DisassociateApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.disassociate_applications_request.serialize_json(input_)
    ).encode()
