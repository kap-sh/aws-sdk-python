...
def build_request(
    ...
    input: aws_sdk_mgn.types.terminate_target_instances_request.TerminateTargetInstancesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.terminate_target_instances_request.serialize_json(input)
    ).encode()
