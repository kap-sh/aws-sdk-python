...
def handle_response(
    ...
    out: aws_sdk_mgn.types.terminate_target_instances_response.TerminateTargetInstancesResponse = aws_sdk_mgn.types.terminate_target_instances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.terminate_target_instances_request.TerminateTargetInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.terminate_target_instances_request.serialize_json(input_)
    ).encode()
