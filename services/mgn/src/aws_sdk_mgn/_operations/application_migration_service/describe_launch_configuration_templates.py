...
import aws_sdk_mgn.types.launch_configuration_templates
...
def handle_response(
    ...
    out: aws_sdk_mgn.types.describe_launch_configuration_templates_response.DescribeLaunchConfigurationTemplatesResponse = aws_sdk_mgn.types.describe_launch_configuration_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.describe_launch_configuration_templates_request.DescribeLaunchConfigurationTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.describe_launch_configuration_templates_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_describe_launch_configuration_templates(
