...
import aws_sdk_mgn.types.network_migration_deployer_job_list
...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_network_migration_deployer_job_response.ListNetworkMigrationDeployerJobResponse = aws_sdk_mgn.types.list_network_migration_deployer_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_network_migration_deployments_request.ListNetworkMigrationDeploymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_network_migration_deployments_request.serialize_json(
            input_
        )
    ).encode()
