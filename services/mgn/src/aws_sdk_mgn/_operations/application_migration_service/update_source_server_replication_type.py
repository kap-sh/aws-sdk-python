...
def handle_response(
    ...
    out: aws_sdk_mgn.types.source_server.SourceServer = (
        aws_sdk_mgn.types.source_server.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_mgn.types.source_server.SourceServer = (
        aws_sdk_mgn.types.source_server.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.update_source_server_replication_type_request.UpdateSourceServerReplicationTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.update_source_server_replication_type_request.serialize_json(
            input_
        )
    ).encode()
...
def update_source_server_replication_type(
    ...
    input_: aws_sdk_mgn.types.update_source_server_replication_type_request.UpdateSourceServerReplicationTypeRequest,
) -> tuple[aws_sdk_mgn.types.source_server.SourceServer, zapros.Response]:
...
async def async_update_source_server_replication_type(
