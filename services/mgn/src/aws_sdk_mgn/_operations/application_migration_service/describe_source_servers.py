...
def handle_response(
    ...
    out: aws_sdk_mgn.types.describe_source_servers_response.DescribeSourceServersResponse = aws_sdk_mgn.types.describe_source_servers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.describe_source_servers_request.DescribeSourceServersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.describe_source_servers_request.serialize_json(input_)
    ).encode()
