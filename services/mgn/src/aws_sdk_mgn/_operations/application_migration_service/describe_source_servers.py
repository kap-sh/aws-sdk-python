...
def build_request(
    ...
    input: aws_sdk_mgn.types.describe_source_servers_request.DescribeSourceServersRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.describe_source_servers_request.serialize_json(input)
    ).encode()
