...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_network_migration_definitions_response.ListNetworkMigrationDefinitionsResponse = aws_sdk_mgn.types.list_network_migration_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_network_migration_definitions_request.ListNetworkMigrationDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_network_migration_definitions_request.serialize_json(
            input_
        )
    ).encode()
