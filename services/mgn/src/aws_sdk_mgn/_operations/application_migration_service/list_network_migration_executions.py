...
import aws_sdk_mgn.types.network_migration_executions_list
...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_network_migration_executions_response.ListNetworkMigrationExecutionsResponse = aws_sdk_mgn.types.list_network_migration_executions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_network_migration_executions_request.ListNetworkMigrationExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_network_migration_executions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_network_migration_executions(
