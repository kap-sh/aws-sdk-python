...
def build_request(
    ...
    input: aws_sdk_mgn.types.associate_source_servers_request.AssociateSourceServersRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.associate_source_servers_request.serialize_json(input)
    ).encode()
