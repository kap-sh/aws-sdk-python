...
def build_request(
    ...
    input_: aws_sdk_mgn.types.associate_source_servers_request.AssociateSourceServersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.associate_source_servers_request.serialize_json(input_)
    ).encode()
...
async def async_associate_source_servers(
