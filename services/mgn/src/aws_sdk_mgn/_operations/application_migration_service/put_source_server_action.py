...
def build_request(
    ...
    input: aws_sdk_mgn.types.put_source_server_action_request.PutSourceServerActionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.put_source_server_action_request.serialize_json(input)
    ).encode()
