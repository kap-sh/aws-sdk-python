...
def handle_response(
    ...
    out: aws_sdk_mgn.types.source_server_action_document.SourceServerActionDocument = (
        aws_sdk_mgn.types.source_server_action_document.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.put_source_server_action_request.PutSourceServerActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.put_source_server_action_request.serialize_json(input_)
    ).encode()
