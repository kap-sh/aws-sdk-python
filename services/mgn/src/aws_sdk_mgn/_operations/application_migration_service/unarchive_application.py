...
def build_request(
    ...
    input_: aws_sdk_mgn.types.unarchive_application_request.UnarchiveApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.unarchive_application_request.serialize_json(input_)
    ).encode()
