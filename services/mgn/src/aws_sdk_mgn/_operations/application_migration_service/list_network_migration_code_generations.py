...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_network_migration_code_generations_response.ListNetworkMigrationCodeGenerationsResponse = aws_sdk_mgn.types.list_network_migration_code_generations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_network_migration_code_generations_request.ListNetworkMigrationCodeGenerationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_network_migration_code_generations_request.serialize_json(
            input_
        )
    ).encode()
