...
import aws_sdk_mgn.types.network_migration_mapper_segments_list
...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_network_migration_mapper_segments_response.ListNetworkMigrationMapperSegmentsResponse = aws_sdk_mgn.types.list_network_migration_mapper_segments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_network_migration_mapper_segments_request.ListNetworkMigrationMapperSegmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_network_migration_mapper_segments_request.serialize_json(
            input_
        )
    ).encode()
