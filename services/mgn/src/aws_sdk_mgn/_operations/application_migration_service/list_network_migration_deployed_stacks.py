...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_network_migration_deployed_stacks_response.ListNetworkMigrationDeployedStacksResponse = aws_sdk_mgn.types.list_network_migration_deployed_stacks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_network_migration_deployed_stacks_request.ListNetworkMigrationDeployedStacksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
