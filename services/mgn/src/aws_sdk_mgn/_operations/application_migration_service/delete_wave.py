...
def build_request(
    ...
    input_: aws_sdk_mgn.types.delete_wave_request.DeleteWaveRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.delete_wave_request.serialize_json(input_)
    ).encode()
...
def delete_wave(
    ...
    input_: aws_sdk_mgn.types.delete_wave_request.DeleteWaveRequest,
) -> tuple[aws_sdk_mgn.types.delete_wave_response.DeleteWaveResponse, zapros.Response]:
