...
def build_request(
    ...
    input_: aws_sdk_mgn.types.remove_template_action_request.RemoveTemplateActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.remove_template_action_request.serialize_json(input_)
    ).encode()
...
async def async_remove_template_action(
