...
def build_request(
    ...
    input: aws_sdk_mgn.types.remove_template_action_request.RemoveTemplateActionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.remove_template_action_request.serialize_json(input)
    ).encode()
