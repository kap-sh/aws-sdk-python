...
def build_request(
    ...
    input_: aws_sdk_mgn.types.finalize_cutover_request.FinalizeCutoverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.finalize_cutover_request.serialize_json(input_)
    ).encode()
...
async def async_finalize_cutover(
