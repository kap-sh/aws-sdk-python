...
def build_request(
    ...
    input_: aws_sdk_mgn.types.create_replication_configuration_template_request.CreateReplicationConfigurationTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.create_replication_configuration_template_request.serialize_json(
            input_
        )
    ).encode()
