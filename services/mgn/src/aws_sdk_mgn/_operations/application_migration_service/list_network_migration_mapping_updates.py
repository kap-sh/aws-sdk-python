...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_network_migration_mapping_updates_response.ListNetworkMigrationMappingUpdatesResponse = aws_sdk_mgn.types.list_network_migration_mapping_updates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_network_migration_mapping_updates_request.ListNetworkMigrationMappingUpdatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_network_migration_mapping_updates_request.serialize_json(
            input_
        )
    ).encode()
