...
def handle_response(
    ...
    out: aws_sdk_mgn.types.describe_replication_configuration_templates_response.DescribeReplicationConfigurationTemplatesResponse = aws_sdk_mgn.types.describe_replication_configuration_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.describe_replication_configuration_templates_request.DescribeReplicationConfigurationTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.describe_replication_configuration_templates_request.serialize_json(
            input_
        )
    ).encode()
