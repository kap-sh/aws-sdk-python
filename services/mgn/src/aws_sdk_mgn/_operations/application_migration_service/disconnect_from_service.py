...
def build_request(
    ...
    input: aws_sdk_mgn.types.disconnect_from_service_request.DisconnectFromServiceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.disconnect_from_service_request.serialize_json(input)
    ).encode()
