...
def build_request(
    ...
    input_: aws_sdk_mgn.types.disconnect_from_service_request.DisconnectFromServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.disconnect_from_service_request.serialize_json(input_)
    ).encode()
