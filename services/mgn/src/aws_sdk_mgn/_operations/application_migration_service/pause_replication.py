...
def build_request(
    ...
    input_: aws_sdk_mgn.types.pause_replication_request.PauseReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.pause_replication_request.serialize_json(input_)
    ).encode()
...
async def async_pause_replication(
