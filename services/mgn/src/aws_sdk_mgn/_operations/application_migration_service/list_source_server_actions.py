...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_source_server_actions_response.ListSourceServerActionsResponse = aws_sdk_mgn.types.list_source_server_actions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_source_server_actions_request.ListSourceServerActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_source_server_actions_request.serialize_json(input_)
    ).encode()
