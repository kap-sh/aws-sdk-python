...
def build_request(
    ...
    input: aws_sdk_mgn.types.list_source_server_actions_request.ListSourceServerActionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_source_server_actions_request.serialize_json(input)
    ).encode()
