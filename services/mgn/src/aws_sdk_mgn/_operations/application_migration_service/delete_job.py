...
def build_request(
    ...
    input_: aws_sdk_mgn.types.delete_job_request.DeleteJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.delete_job_request.serialize_json(input_)
    ).encode()
...
def delete_job(
    ...
    input_: aws_sdk_mgn.types.delete_job_request.DeleteJobRequest,
) -> tuple[aws_sdk_mgn.types.delete_job_response.DeleteJobResponse, zapros.Response]:
