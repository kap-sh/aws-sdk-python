...
import aws_sdk_mgn.types.waves_list
...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_waves_response.ListWavesResponse = (
        aws_sdk_mgn.types.list_waves_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_waves_request.ListWavesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_waves_request.serialize_json(input_)
    ).encode()
...
def list_waves(
    ...
    input_: aws_sdk_mgn.types.list_waves_request.ListWavesRequest,
) -> tuple[aws_sdk_mgn.types.list_waves_response.ListWavesResponse, zapros.Response]:
