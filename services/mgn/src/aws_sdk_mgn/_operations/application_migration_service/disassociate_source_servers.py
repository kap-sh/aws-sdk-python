...
def build_request(
    ...
    input: aws_sdk_mgn.types.disassociate_source_servers_request.DisassociateSourceServersRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.disassociate_source_servers_request.serialize_json(input)
    ).encode()
