...
def build_request(
    ...
    input_: aws_sdk_mgn.types.disassociate_source_servers_request.DisassociateSourceServersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.disassociate_source_servers_request.serialize_json(input_)
    ).encode()
