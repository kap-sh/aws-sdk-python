...
def handle_response(
    ...
    out: aws_sdk_mgn.types.describe_job_log_items_response.DescribeJobLogItemsResponse = aws_sdk_mgn.types.describe_job_log_items_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.describe_job_log_items_request.DescribeJobLogItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.describe_job_log_items_request.serialize_json(input_)
    ).encode()
