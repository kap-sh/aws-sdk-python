...
def build_request(
    ...
    input: aws_sdk_mgn.types.describe_job_log_items_request.DescribeJobLogItemsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.describe_job_log_items_request.serialize_json(input)
    ).encode()
