...
def handle_response(
    ...
    out: aws_sdk_mgn.types.application.Application = (
        aws_sdk_mgn.types.application.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_mgn.types.application.Application = (
        aws_sdk_mgn.types.application.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.archive_application_request.ArchiveApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.archive_application_request.serialize_json(input_)
    ).encode()
...
def archive_application(
    ...
    input_: aws_sdk_mgn.types.archive_application_request.ArchiveApplicationRequest,
) -> tuple[aws_sdk_mgn.types.application.Application, zapros.Response]:
...
async def async_archive_application(
