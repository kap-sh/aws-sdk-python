...
def build_request(
    ...
    input_: aws_sdk_mgn.types.get_network_migration_definition_request.GetNetworkMigrationDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.get_network_migration_definition_request.serialize_json(
            input_
        )
    ).encode()
