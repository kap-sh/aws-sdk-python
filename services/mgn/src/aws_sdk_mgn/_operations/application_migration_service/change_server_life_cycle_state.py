...
def build_request(
    ...
    input_: aws_sdk_mgn.types.change_server_life_cycle_state_request.ChangeServerLifeCycleStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.change_server_life_cycle_state_request.serialize_json(input_)
    ).encode()
