...
def build_request(
    ...
    input: aws_sdk_mgn.types.change_server_life_cycle_state_request.ChangeServerLifeCycleStateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.change_server_life_cycle_state_request.serialize_json(input)
    ).encode()
