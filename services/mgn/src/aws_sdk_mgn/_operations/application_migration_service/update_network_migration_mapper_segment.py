...
def handle_response(
    ...
    out: aws_sdk_mgn.types.network_migration_mapper_segment.NetworkMigrationMapperSegment = aws_sdk_mgn.types.network_migration_mapper_segment.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.update_network_migration_mapper_segment_request.UpdateNetworkMigrationMapperSegmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.update_network_migration_mapper_segment_request.serialize_json(
            input_
        )
    ).encode()
