...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_network_migration_analysis_results_response.ListNetworkMigrationAnalysisResultsResponse = aws_sdk_mgn.types.list_network_migration_analysis_results_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_network_migration_analysis_results_request.ListNetworkMigrationAnalysisResultsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_network_migration_analysis_results_request.serialize_json(
            input_
        )
    ).encode()
