...
def build_request(
    ...
    input: aws_sdk_mgn.types.start_network_migration_mapping_request.StartNetworkMigrationMappingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_network_migration_mapping_request.serialize_json(input)
    ).encode()
