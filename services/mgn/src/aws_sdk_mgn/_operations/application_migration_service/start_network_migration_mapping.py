...
def handle_response(
    ...
    out: aws_sdk_mgn.types.start_network_migration_mapping_response.StartNetworkMigrationMappingResponse = aws_sdk_mgn.types.start_network_migration_mapping_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.start_network_migration_mapping_request.StartNetworkMigrationMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_network_migration_mapping_request.serialize_json(input_)
    ).encode()
