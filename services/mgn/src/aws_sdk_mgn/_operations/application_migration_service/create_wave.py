...
def handle_response(response: zapros.Response) -> aws_sdk_mgn.types.wave.Wave:
    out: aws_sdk_mgn.types.wave.Wave = aws_sdk_mgn.types.wave.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.create_wave_request.CreateWaveRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.create_wave_request.serialize_json(input_)
    ).encode()
...
def create_wave(
    ...
    input_: aws_sdk_mgn.types.create_wave_request.CreateWaveRequest,
) -> tuple[aws_sdk_mgn.types.wave.Wave, zapros.Response]:
