...
def handle_response(
    ...
    out: aws_sdk_mgn.types.start_export_response.StartExportResponse = (
        aws_sdk_mgn.types.start_export_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.start_export_request.StartExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_export_request.serialize_json(input_)
    ).encode()
...
def start_export(
    ...
    aws_sdk_mgn.types.start_export_response.StartExportResponse, zapros.Response
]:
