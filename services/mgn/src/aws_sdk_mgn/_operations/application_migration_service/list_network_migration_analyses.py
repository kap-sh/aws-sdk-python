...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_network_migration_analyses_response.ListNetworkMigrationAnalysesResponse = aws_sdk_mgn.types.list_network_migration_analyses_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_network_migration_analyses_request.ListNetworkMigrationAnalysesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_network_migration_analyses_request.serialize_json(input_)
    ).encode()
...
async def async_list_network_migration_analyses(
