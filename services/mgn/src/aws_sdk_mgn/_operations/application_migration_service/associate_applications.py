...
def build_request(
    ...
    input: aws_sdk_mgn.types.associate_applications_request.AssociateApplicationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.associate_applications_request.serialize_json(input)
    ).encode()
