...
def handle_response(
    ...
    out: aws_sdk_mgn.types.start_cutover_response.StartCutoverResponse = (
        aws_sdk_mgn.types.start_cutover_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.start_cutover_request.StartCutoverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.start_cutover_request.serialize_json(input_)
    ).encode()
...
def start_cutover(
    ...
    aws_sdk_mgn.types.start_cutover_response.StartCutoverResponse, zapros.Response
]:
