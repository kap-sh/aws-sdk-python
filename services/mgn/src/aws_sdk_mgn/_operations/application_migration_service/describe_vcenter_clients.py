...
def handle_response(
    ...
    out: aws_sdk_mgn.types.describe_vcenter_clients_response.DescribeVcenterClientsResponse = aws_sdk_mgn.types.describe_vcenter_clients_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.describe_vcenter_clients_request.DescribeVcenterClientsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
