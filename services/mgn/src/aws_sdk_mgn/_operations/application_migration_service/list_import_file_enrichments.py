...
def handle_response(
    ...
    out: aws_sdk_mgn.types.list_import_file_enrichments_response.ListImportFileEnrichmentsResponse = aws_sdk_mgn.types.list_import_file_enrichments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mgn.types.list_import_file_enrichments_request.ListImportFileEnrichmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_import_file_enrichments_request.serialize_json(input_)
    ).encode()
...
async def async_list_import_file_enrichments(
