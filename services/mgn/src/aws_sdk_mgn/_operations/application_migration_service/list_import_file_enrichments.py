...
def build_request(
    ...
    input: aws_sdk_mgn.types.list_import_file_enrichments_request.ListImportFileEnrichmentsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mgn.types.list_import_file_enrichments_request.serialize_json(input)
    ).encode()
