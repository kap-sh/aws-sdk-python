...
class ConnectorResource:
    ...
    def create(
        ...
        *,
    ...
    ) -> "aws_sdk_mgn.types.connector.Connector":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mgn.types.create_connector_request.CreateConnectorRequest]",
        ) -> OperationResponse["aws_sdk_mgn.types.connector.Connector"]:
            import aws_sdk_mgn._operations.application_migration_service.create_connector

            output, http_response = (
                aws_sdk_mgn._operations.application_migration_service.create_connector.create_connector(
    ...
    def update(
        ...
        *,
        config_overrides: Optional[mgnClientConfig] = None,
        name: Optional["aws_sdk_mgn.types.connector_name.ConnectorName"] = None,
        ssm_command_config: Optional[
            "aws_sdk_mgn.types.connector_ssm_command_config.ConnectorSsmCommandConfig"
        ] = None,
    ) -> "aws_sdk_mgn.types.connector.Connector":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mgn.types.update_connector_request.UpdateConnectorRequest]",
        ) -> OperationResponse["aws_sdk_mgn.types.connector.Connector"]:
            import aws_sdk_mgn._operations.application_migration_service.update_connector

            output, http_response = (
                aws_sdk_mgn._operations.application_migration_service.update_connector.update_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mgn.types.delete_connector_request.DeleteConnectorRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_mgn._operations.application_migration_service.delete_connector

            output, http_response = (
                aws_sdk_mgn._operations.application_migration_service.delete_connector.delete_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
        config_overrides: Optional[mgnClientConfig] = None,
        filters: Optional[
            "aws_sdk_mgn.types.list_connectors_request_filters.ListConnectorsRequestFilters"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mgn.types.list_connectors_request.ListConnectorsRequest]",
        ) -> OperationResponse[
            "aws_sdk_mgn.types.list_connectors_response.ListConnectorsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mgn._operations.application_migration_service.list_connectors.list_connectors(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncConnectorResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mgn.types.create_connector_request.CreateConnectorRequest]",
        ) -> AsyncOperationResponse["aws_sdk_mgn.types.connector.Connector"]:
            import aws_sdk_mgn._operations.application_migration_service.create_connector

            (
                output,
                http_response,
            ) = await aws_sdk_mgn._operations.application_migration_service.create_connector.async_create_connector(
                req.options, req.input
            )
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mgn.types.update_connector_request.UpdateConnectorRequest]",
        ) -> AsyncOperationResponse["aws_sdk_mgn.types.connector.Connector"]:
            import aws_sdk_mgn._operations.application_migration_service.update_connector
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mgn._operations.application_migration_service.update_connector.async_update_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mgn.types.delete_connector_request.DeleteConnectorRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mgn._operations.application_migration_service.delete_connector.async_delete_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mgn.types.list_connectors_request.ListConnectorsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mgn.types.list_connectors_response.ListConnectorsResponse"
        ]:
            import aws_sdk_mgn._operations.application_migration_service.list_connectors
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mgn._operations.application_migration_service.list_connectors.async_list_connectors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
