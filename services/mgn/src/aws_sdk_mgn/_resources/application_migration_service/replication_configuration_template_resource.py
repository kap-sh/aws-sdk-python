...
class ReplicationConfigurationTemplateResource:
    ...
    def create(self, staging_area_subnet_id: "aws_sdk_mgn.types.subnet_id.SubnetID", associate_default_security_group: bool, replication_servers_security_groups_i_ds: "aws_sdk_mgn.types.replication_servers_security_groups_i_ds.ReplicationServersSecurityGroupsIDs", replication_server_instance_type: "aws_sdk_mgn.types.ec2_instance_type.EC2InstanceType", use_dedicated_replication_server: bool, default_large_staging_disk_type: "aws_sdk_mgn.types.replication_configuration_default_large_staging_disk_type.ReplicationConfigurationDefaultLargeStagingDiskType", ebs_encryption: "aws_sdk_mgn.types.replication_configuration_ebs_encryption.ReplicationConfigurationEbsEncryption", bandwidth_throttling: "aws_sdk_mgn.types.bandwidth_throttling.BandwidthThrottling", data_plane_routing: "aws_sdk_mgn.types.replication_configuration_data_plane_routing.ReplicationConfigurationDataPlaneRouting", create_public_ip: bool, staging_area_tags: "aws_sdk_mgn.types.tags_map.TagsMap", *, config_overrides: Optional[mgnClientConfig] = None, ebs_encryption_key_arn: Optional["aws_sdk_mgn.types.arn.ARN"] = None, use_fips_endpoint: Optional[bool] = None, tags: Optional["aws_sdk_mgn.types.tags_map.TagsMap"] = None, internet_protocol: Optional["aws_sdk_mgn.types.internet_protocol.InternetProtocol"] = None, store_snapshot_on_local_zone: Optional[bool] = None) -> "aws_sdk_mgn.types.replication_configuration_template.ReplicationConfigurationTemplate":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.create_replication_configuration_template_request.CreateReplicationConfigurationTemplateRequest]') -> OperationResponse["aws_sdk_mgn.types.replication_configuration_template.ReplicationConfigurationTemplate"]:
            import aws_sdk_mgn._operations.application_migration_service.create_replication_configuration_template
            output, http_response = aws_sdk_mgn._operations.application_migration_service.create_replication_configuration_template.create_replication_configuration_template(req.options, req.input)
    ...
    def update(self, replication_configuration_template_id: "aws_sdk_mgn.types.replication_configuration_template_id.ReplicationConfigurationTemplateID", *, config_overrides: Optional[mgnClientConfig] = None, arn: Optional["aws_sdk_mgn.types.arn.ARN"] = None, staging_area_subnet_id: Optional["aws_sdk_mgn.types.subnet_id.SubnetID"] = None, associate_default_security_group: Optional[bool] = None, replication_servers_security_groups_i_ds: Optional["aws_sdk_mgn.types.replication_servers_security_groups_i_ds.ReplicationServersSecurityGroupsIDs"] = None, replication_server_instance_type: Optional["aws_sdk_mgn.types.ec2_instance_type.EC2InstanceType"] = None, use_dedicated_replication_server: Optional[bool] = None, default_large_staging_disk_type: Optional["aws_sdk_mgn.types.replication_configuration_default_large_staging_disk_type.ReplicationConfigurationDefaultLargeStagingDiskType"] = None, ebs_encryption: Optional["aws_sdk_mgn.types.replication_configuration_ebs_encryption.ReplicationConfigurationEbsEncryption"] = None, ebs_encryption_key_arn: Optional["aws_sdk_mgn.types.arn.ARN"] = None, bandwidth_throttling: Optional["aws_sdk_mgn.types.bandwidth_throttling.BandwidthThrottling"] = None, data_plane_routing: Optional["aws_sdk_mgn.types.replication_configuration_data_plane_routing.ReplicationConfigurationDataPlaneRouting"] = None, create_public_ip: Optional[bool] = None, staging_area_tags: Optional["aws_sdk_mgn.types.tags_map.TagsMap"] = None, use_fips_endpoint: Optional[bool] = None, internet_protocol: Optional["aws_sdk_mgn.types.internet_protocol.InternetProtocol"] = None, store_snapshot_on_local_zone: Optional[bool] = None) -> "aws_sdk_mgn.types.replication_configuration_template.ReplicationConfigurationTemplate":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.update_replication_configuration_template_request.UpdateReplicationConfigurationTemplateRequest]') -> OperationResponse["aws_sdk_mgn.types.replication_configuration_template.ReplicationConfigurationTemplate"]:
            import aws_sdk_mgn._operations.application_migration_service.update_replication_configuration_template
            output, http_response = aws_sdk_mgn._operations.application_migration_service.update_replication_configuration_template.update_replication_configuration_template(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        input["replication_configuration_template_id"] = replication_configuration_template_id
        if arn is not None:
            input["arn"] = arn
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete(self, replication_configuration_template_id: "aws_sdk_mgn.types.replication_configuration_template_id.ReplicationConfigurationTemplateID", *, config_overrides: Optional[mgnClientConfig] = None) -> "aws_sdk_mgn.types.delete_replication_configuration_template_response.DeleteReplicationConfigurationTemplateResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.delete_replication_configuration_template_request.DeleteReplicationConfigurationTemplateRequest]') -> OperationResponse["aws_sdk_mgn.types.delete_replication_configuration_template_response.DeleteReplicationConfigurationTemplateResponse"]:
            import aws_sdk_mgn._operations.application_migration_service.delete_replication_configuration_template
            output, http_response = aws_sdk_mgn._operations.application_migration_service.delete_replication_configuration_template.delete_replication_configuration_template(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list(self, *, config_overrides: Optional[mgnClientConfig] = None, replication_configuration_template_i_ds: Optional["aws_sdk_mgn.types.replication_configuration_template_i_ds.ReplicationConfigurationTemplateIDs"] = None, max_results: Optional["aws_sdk_mgn.types.max_results_type.MaxResultsType"] = None, next_token: Optional["aws_sdk_mgn.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_mgn.types.describe_replication_configuration_templates_response.DescribeReplicationConfigurationTemplatesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.describe_replication_configuration_templates_request.DescribeReplicationConfigurationTemplatesRequest]') -> OperationResponse["aws_sdk_mgn.types.describe_replication_configuration_templates_response.DescribeReplicationConfigurationTemplatesResponse"]:
            import aws_sdk_mgn._operations.application_migration_service.describe_replication_configuration_templates
            output, http_response = aws_sdk_mgn._operations.application_migration_service.describe_replication_configuration_templates.describe_replication_configuration_templates(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        if replication_configuration_template_i_ds is not None:
            input["replication_configuration_template_i_ds"] = replication_configuration_template_i_ds
...
class AsyncReplicationConfigurationTemplateResource:
    def __init__(self, service: AsyncmgnClient) -> None:
        self._service = service
    async def create(self, staging_area_subnet_id: "aws_sdk_mgn.types.subnet_id.SubnetID", associate_default_security_group: bool, replication_servers_security_groups_i_ds: "aws_sdk_mgn.types.replication_servers_security_groups_i_ds.ReplicationServersSecurityGroupsIDs", replication_server_instance_type: "aws_sdk_mgn.types.ec2_instance_type.EC2InstanceType", use_dedicated_replication_server: bool, default_large_staging_disk_type: "aws_sdk_mgn.types.replication_configuration_default_large_staging_disk_type.ReplicationConfigurationDefaultLargeStagingDiskType", ebs_encryption: "aws_sdk_mgn.types.replication_configuration_ebs_encryption.ReplicationConfigurationEbsEncryption", bandwidth_throttling: "aws_sdk_mgn.types.bandwidth_throttling.BandwidthThrottling", data_plane_routing: "aws_sdk_mgn.types.replication_configuration_data_plane_routing.ReplicationConfigurationDataPlaneRouting", create_public_ip: bool, staging_area_tags: "aws_sdk_mgn.types.tags_map.TagsMap", *, config_overrides: Optional[AsyncmgnClientConfig] = None, ebs_encryption_key_arn: Optional["aws_sdk_mgn.types.arn.ARN"] = None, use_fips_endpoint: Optional[bool] = None, tags: Optional["aws_sdk_mgn.types.tags_map.TagsMap"] = None, internet_protocol: Optional["aws_sdk_mgn.types.internet_protocol.InternetProtocol"] = None, store_snapshot_on_local_zone: Optional[bool] = None) -> "aws_sdk_mgn.types.replication_configuration_template.ReplicationConfigurationTemplate":
        """<p>Creates a new ReplicationConfigurationTemplate.</p>
        ...
        Args:
            ...
            store_snapshot_on_local_zone: <p>Request to store snapshot on local zone during Replication Settings template creation.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_mgn.types.create_replication_configuration_template_request.CreateReplicationConfigurationTemplateRequest]') -> AsyncOperationResponse["aws_sdk_mgn.types.replication_configuration_template.ReplicationConfigurationTemplate"]:
            import aws_sdk_mgn._operations.application_migration_service.create_replication_configuration_template
            output, http_response = await aws_sdk_mgn._operations.application_migration_service.create_replication_configuration_template.async_create_replication_configuration_template(req.options, req.input)
        ...
        return response.output
    async def update(self, replication_configuration_template_id: "aws_sdk_mgn.types.replication_configuration_template_id.ReplicationConfigurationTemplateID", *, config_overrides: Optional[AsyncmgnClientConfig] = None, arn: Optional["aws_sdk_mgn.types.arn.ARN"] = None, staging_area_subnet_id: Optional["aws_sdk_mgn.types.subnet_id.SubnetID"] = None, associate_default_security_group: Optional[bool] = None, replication_servers_security_groups_i_ds: Optional["aws_sdk_mgn.types.replication_servers_security_groups_i_ds.ReplicationServersSecurityGroupsIDs"] = None, replication_server_instance_type: Optional["aws_sdk_mgn.types.ec2_instance_type.EC2InstanceType"] = None, use_dedicated_replication_server: Optional[bool] = None, default_large_staging_disk_type: Optional["aws_sdk_mgn.types.replication_configuration_default_large_staging_disk_type.ReplicationConfigurationDefaultLargeStagingDiskType"] = None, ebs_encryption: Optional["aws_sdk_mgn.types.replication_configuration_ebs_encryption.ReplicationConfigurationEbsEncryption"] = None, ebs_encryption_key_arn: Optional["aws_sdk_mgn.types.arn.ARN"] = None, bandwidth_throttling: Optional["aws_sdk_mgn.types.bandwidth_throttling.BandwidthThrottling"] = None, data_plane_routing: Optional["aws_sdk_mgn.types.replication_configuration_data_plane_routing.ReplicationConfigurationDataPlaneRouting"] = None, create_public_ip: Optional[bool] = None, staging_area_tags: Optional["aws_sdk_mgn.types.tags_map.TagsMap"] = None, use_fips_endpoint: Optional[bool] = None, internet_protocol: Optional["aws_sdk_mgn.types.internet_protocol.InternetProtocol"] = None, store_snapshot_on_local_zone: Optional[bool] = None) -> "aws_sdk_mgn.types.replication_configuration_template.ReplicationConfigurationTemplate":
        """<p>Updates multiple ReplicationConfigurationTemplates by ID.</p>
        ...
        Args:
            ...
            store_snapshot_on_local_zone: <p>Update replication configuration template store snapshot on local zone request.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_mgn.types.update_replication_configuration_template_request.UpdateReplicationConfigurationTemplateRequest]') -> AsyncOperationResponse["aws_sdk_mgn.types.replication_configuration_template.ReplicationConfigurationTemplate"]:
            import aws_sdk_mgn._operations.application_migration_service.update_replication_configuration_template
            output, http_response = await aws_sdk_mgn._operations.application_migration_service.update_replication_configuration_template.async_update_replication_configuration_template(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete(self, replication_configuration_template_id: "aws_sdk_mgn.types.replication_configuration_template_id.ReplicationConfigurationTemplateID", *, config_overrides: Optional[AsyncmgnClientConfig] = None) -> "aws_sdk_mgn.types.delete_replication_configuration_template_response.DeleteReplicationConfigurationTemplateResponse":
        """<p>Deletes a single Replication Configuration Template by ID</p>

        Args:
            replication_configuration_template_id: <p>Request to delete Replication Configuration Template from service by Replication Configuration Template ID.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_mgn.types.delete_replication_configuration_template_request.DeleteReplicationConfigurationTemplateRequest]') -> AsyncOperationResponse["aws_sdk_mgn.types.delete_replication_configuration_template_response.DeleteReplicationConfigurationTemplateResponse"]:
            import aws_sdk_mgn._operations.application_migration_service.delete_replication_configuration_template
            output, http_response = await aws_sdk_mgn._operations.application_migration_service.delete_replication_configuration_template.async_delete_replication_configuration_template(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def list(self, *, config_overrides: Optional[AsyncmgnClientConfig] = None, replication_configuration_template_i_ds: Optional["aws_sdk_mgn.types.replication_configuration_template_i_ds.ReplicationConfigurationTemplateIDs"] = None, max_results: Optional["aws_sdk_mgn.types.max_results_type.MaxResultsType"] = None, next_token: Optional["aws_sdk_mgn.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_mgn.types.describe_replication_configuration_templates_response.DescribeReplicationConfigurationTemplatesResponse":
        """<p>Lists all ReplicationConfigurationTemplates, filtered by Source Server IDs.</p>
        ...
        Args:
            ...
            next_token: <p>Request to describe Replication Configuration template by next token.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_mgn.types.describe_replication_configuration_templates_request.DescribeReplicationConfigurationTemplatesRequest]') -> AsyncOperationResponse["aws_sdk_mgn.types.describe_replication_configuration_templates_response.DescribeReplicationConfigurationTemplatesResponse"]:
            import aws_sdk_mgn._operations.application_migration_service.describe_replication_configuration_templates
            output, http_response = await aws_sdk_mgn._operations.application_migration_service.describe_replication_configuration_templates.async_describe_replication_configuration_templates(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
