...
from aws_sdk_mgn._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class mgnClientConfig(TypedDict, total=False):
...
class mgnClient:
    ...
    def __init__(self, http_handler: BaseHandler | None = None, operation_interceptors: Iterable[Interceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_dual_stack: bool | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = mgnClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_dual_stack": use_dual_stack, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[mgnClientConfig] = None) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
    ...
    def initialize_service(self, *, config_overrides: Optional[mgnClientConfig] = None) -> "aws_sdk_mgn.types.initialize_service_response.InitializeServiceResponse":
        """<p>Initialize Application Migration Service.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.initialize_service_request.InitializeServiceRequest]') -> OperationResponse["aws_sdk_mgn.types.initialize_service_response.InitializeServiceResponse"]:
            import aws_sdk_mgn._operations.application_migration_service.initialize_service
            output, http_response = aws_sdk_mgn._operations.application_migration_service.initialize_service.initialize_service(req.options, req.input)
    ...
    def list_import_file_enrichments(self, *, config_overrides: Optional[mgnClientConfig] = None, filters: Optional["aws_sdk_mgn.types.list_import_file_enrichments_filters.ListImportFileEnrichmentsFilters"] = None, max_results: Optional["aws_sdk_mgn.types.max_results_type.MaxResultsType"] = None, next_token: Optional["aws_sdk_mgn.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_mgn.types.list_import_file_enrichments_response.ListImportFileEnrichmentsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.list_import_file_enrichments_request.ListImportFileEnrichmentsRequest]') -> OperationResponse["aws_sdk_mgn.types.list_import_file_enrichments_response.ListImportFileEnrichmentsResponse"]:
            import aws_sdk_mgn._operations.application_migration_service.list_import_file_enrichments
            output, http_response = aws_sdk_mgn._operations.application_migration_service.list_import_file_enrichments.list_import_file_enrichments(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_import_file_enrichments(self, *, config_overrides: Optional[mgnClientConfig] = None, filters: Optional["aws_sdk_mgn.types.list_import_file_enrichments_filters.ListImportFileEnrichmentsFilters"] = None, max_results: Optional["aws_sdk_mgn.types.max_results_type.MaxResultsType"] = None, next_token: Optional["aws_sdk_mgn.types.pagination_token.PaginationToken"] = None) -> "Iterator[aws_sdk_mgn.types.import_file_enrichment.ImportFileEnrichment]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_managed_accounts(self, *, config_overrides: Optional[mgnClientConfig] = None, max_results: Optional["aws_sdk_mgn.types.max_results_type.MaxResultsType"] = None, next_token: Optional["aws_sdk_mgn.types.pagination_token.PaginationToken"] = None) -> "aws_sdk_mgn.types.list_managed_accounts_response.ListManagedAccountsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.list_managed_accounts_request.ListManagedAccountsRequest]') -> OperationResponse["aws_sdk_mgn.types.list_managed_accounts_response.ListManagedAccountsResponse"]:
            import aws_sdk_mgn._operations.application_migration_service.list_managed_accounts
            output, http_response = aws_sdk_mgn._operations.application_migration_service.list_managed_accounts.list_managed_accounts(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_managed_accounts(self, *, config_overrides: Optional[mgnClientConfig] = None, max_results: Optional["aws_sdk_mgn.types.max_results_type.MaxResultsType"] = None, next_token: Optional["aws_sdk_mgn.types.pagination_token.PaginationToken"] = None) -> "Iterator[aws_sdk_mgn.types.managed_account.ManagedAccount]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_tags_for_resource(self, resource_arn: "aws_sdk_mgn.types.arn.ARN", *, config_overrides: Optional[mgnClientConfig] = None) -> "aws_sdk_mgn.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        """<p>List all tags for your Application Migration Service resources.</p>

        Args:
            resource_arn: <p>List tags for resource request by ARN.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> OperationResponse["aws_sdk_mgn.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_mgn._operations.application_migration_service.list_tags_for_resource
            output, http_response = aws_sdk_mgn._operations.application_migration_service.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def start_import_file_enrichment(self, s3_bucket_source: "aws_sdk_mgn.types.enrichment_source_s3_configuration.EnrichmentSourceS3Configuration", s3_bucket_target: "aws_sdk_mgn.types.enrichment_target_s3_configuration.EnrichmentTargetS3Configuration", *, config_overrides: Optional[mgnClientConfig] = None, client_token: Optional["aws_sdk_mgn.types.client_idempotency_token.ClientIdempotencyToken"] = None, ip_assignment_strategy: Optional["aws_sdk_mgn.types.ip_assignment_strategy.IpAssignmentStrategy"] = None) -> "aws_sdk_mgn.types.start_import_file_enrichment_response.StartImportFileEnrichmentResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.start_import_file_enrichment_request.StartImportFileEnrichmentRequest]') -> OperationResponse["aws_sdk_mgn.types.start_import_file_enrichment_response.StartImportFileEnrichmentResponse"]:
            import aws_sdk_mgn._operations.application_migration_service.start_import_file_enrichment
            output, http_response = aws_sdk_mgn._operations.application_migration_service.start_import_file_enrichment.start_import_file_enrichment(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def tag_resource(self, resource_arn: "aws_sdk_mgn.types.arn.ARN", tags: "aws_sdk_mgn.types.tags_map.TagsMap", *, config_overrides: Optional[mgnClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.tag_resource_request.TagResourceRequest]') -> OperationResponse[None]:
            import aws_sdk_mgn._operations.application_migration_service.tag_resource
            output, http_response = aws_sdk_mgn._operations.application_migration_service.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: "aws_sdk_mgn.types.arn.ARN", tag_keys: "aws_sdk_mgn.types.tag_keys.TagKeys", *, config_overrides: Optional[mgnClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_mgn.types.untag_resource_request.UntagResourceRequest]') -> OperationResponse[None]:
            import aws_sdk_mgn._operations.application_migration_service.untag_resource
            output, http_response = aws_sdk_mgn._operations.application_migration_service.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
