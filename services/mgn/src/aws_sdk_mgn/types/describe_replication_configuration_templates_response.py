...
class DescribeReplicationConfigurationTemplatesResponse(TypedDict):
    items: NotRequired[
        "aws_sdk_mgn.types.replication_configuration_templates.ReplicationConfigurationTemplates"
    ]
...
def serialize_json(value: DescribeReplicationConfigurationTemplatesResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            aws_sdk_mgn.types.replication_configuration_templates.serialize_json(
                value["items"]
            )
        )
...
def deserialize_json(data: dict) -> DescribeReplicationConfigurationTemplatesResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_mgn.types.replication_configuration_templates.deserialize_json(
                data["items"]
            )
        )
