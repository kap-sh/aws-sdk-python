...
class VcenterClient(TypedDict, closed=True):
    ...
    hostname: NotRequired["aws_sdk_mgn.types.bounded_string.BoundedString"]
    """<p>Hostname of vCenter client .</p>"""
    vcenter_uuid: NotRequired["aws_sdk_mgn.types.bounded_string.BoundedString"]
    """<p>Vcenter UUID of vCenter client.</p>"""
    datacenter_name: NotRequired["aws_sdk_mgn.types.bounded_string.BoundedString"]
    ...
    source_server_tags: NotRequired["aws_sdk_mgn.types.tags_map.TagsMap"]
...
def serialize_json(value: VcenterClient) -> dict:
    ...
    if "source_server_tags" in value:
        ...
        out["sourceServerTags"] = aws_sdk_mgn.types.tags_map.serialize_json(
...
def deserialize_json(data: dict) -> VcenterClient:
    ...
    if "sourceServerTags" in data:
        ...
        out["source_server_tags"] = aws_sdk_mgn.types.tags_map.deserialize_json(
