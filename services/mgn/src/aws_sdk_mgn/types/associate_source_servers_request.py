...
def serialize_json(value: AssociateSourceServersRequest) -> dict:
    ...
    import aws_sdk_mgn.types.associate_source_servers_request_source_server_i_ds
    out["sourceServerIDs"] = aws_sdk_mgn.types.associate_source_servers_request_source_server_i_ds.serialize_json(value["source_server_i_ds"])
...
def deserialize_json(data: dict) -> AssociateSourceServersRequest:
    ...
    if "applicationID" in data:
        ...
        raise DeserializationError("AssociateSourceServersRequest.application_id required")
    if "sourceServerIDs" in data:
        import aws_sdk_mgn.types.associate_source_servers_request_source_server_i_ds
        out["source_server_i_ds"] = aws_sdk_mgn.types.associate_source_servers_request_source_server_i_ds.deserialize_json(data["sourceServerIDs"])
    else:
        raise DeserializationError("AssociateSourceServersRequest.source_server_i_ds required")
