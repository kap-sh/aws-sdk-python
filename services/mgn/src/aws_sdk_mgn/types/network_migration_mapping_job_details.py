"""Generated from Smithy shape ``com.amazonaws.mgn#NetworkMigrationMappingJobDetails``."""
...
class NetworkMigrationMappingJobDetails(TypedDict, closed=True):
    job_id: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: NetworkMigrationMappingJobDetails) -> dict:
    out: dict = {}
    if "job_id" in value:
...
def deserialize_json(data: dict) -> NetworkMigrationMappingJobDetails:
    out: NetworkMigrationMappingJobDetails = {}  # type: ignore[typeddict-item]
    if "jobID" in data:
