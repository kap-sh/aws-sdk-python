...
class ListNetworkMigrationAnalysesRequest(TypedDict):
...
def serialize_json(value: ListNetworkMigrationAnalysesRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_analyses_filters.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListNetworkMigrationAnalysesRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_analyses_filters.deserialize_json(
                data["filters"]
            )
        )
