...
class DescribeSourceServersRequestFilters(TypedDict, closed=True):
    ...
    replication_types: NotRequired[
        "aws_sdk_mgn.types.replication_types.ReplicationTypes"
    ]
    """<p>Request to filter Source Servers list by replication type.</p>"""
    life_cycle_states: NotRequired[
        "aws_sdk_mgn.types.life_cycle_states.LifeCycleStates"
    ]
    """<p>Request to filter Source Servers list by life cycle states.</p>"""
    application_i_ds: NotRequired[
        "aws_sdk_mgn.types.describe_source_servers_request_application_i_ds.DescribeSourceServersRequestApplicationIDs"
    ]
...
def serialize_json(value: DescribeSourceServersRequestFilters) -> dict:
    ...
    if "source_server_i_ds" in value:
        ...
        out["sourceServerIDs"] = (
            aws_sdk_mgn.types.describe_source_servers_request_filters_i_ds.serialize_json(
    ...
    if "replication_types" in value:
        ...
        out["replicationTypes"] = aws_sdk_mgn.types.replication_types.serialize_json(
            value["replication_types"]
        )
    if "life_cycle_states" in value:
        import aws_sdk_mgn.types.life_cycle_states

        out["lifeCycleStates"] = aws_sdk_mgn.types.life_cycle_states.serialize_json(
            value["life_cycle_states"]
        )
    if "application_i_ds" in value:
        import aws_sdk_mgn.types.describe_source_servers_request_application_i_ds

        out["applicationIDs"] = (
            aws_sdk_mgn.types.describe_source_servers_request_application_i_ds.serialize_json(
...
def deserialize_json(data: dict) -> DescribeSourceServersRequestFilters:
    ...
    if "sourceServerIDs" in data:
        ...
        out["source_server_i_ds"] = (
            aws_sdk_mgn.types.describe_source_servers_request_filters_i_ds.deserialize_json(
    ...
    if "replicationTypes" in data:
        ...
        out["replication_types"] = aws_sdk_mgn.types.replication_types.deserialize_json(
            data["replicationTypes"]
        )
    if "lifeCycleStates" in data:
        import aws_sdk_mgn.types.life_cycle_states

        out["life_cycle_states"] = aws_sdk_mgn.types.life_cycle_states.deserialize_json(
    ...
    if "applicationIDs" in data:
        ...
        out["application_i_ds"] = (
            aws_sdk_mgn.types.describe_source_servers_request_application_i_ds.deserialize_json(
                data["applicationIDs"]
            )
        )
    return out
