...
class ListNetworkMigrationMappingUpdatesRequest(TypedDict):
...
def serialize_json(value: ListNetworkMigrationMappingUpdatesRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_mapping_updates_filters.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListNetworkMigrationMappingUpdatesRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_mapping_updates_filters.deserialize_json(
                data["filters"]
            )
        )
