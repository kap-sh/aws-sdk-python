...
class ListNetworkMigrationMapperSegmentConstructsRequest(TypedDict):
...
def serialize_json(value: ListNetworkMigrationMapperSegmentConstructsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_mapper_segment_constructs_filters.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListNetworkMigrationMapperSegmentConstructsRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_mapper_segment_constructs_filters.deserialize_json(
                data["filters"]
            )
        )
