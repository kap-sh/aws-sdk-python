...
class ListNetworkMigrationDeployerJobResponse(TypedDict):
    items: NotRequired[
        "aws_sdk_mgn.types.network_migration_deployer_job_list.NetworkMigrationDeployerJobList"
    ]
...
def serialize_json(value: ListNetworkMigrationDeployerJobResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            aws_sdk_mgn.types.network_migration_deployer_job_list.serialize_json(
                value["items"]
            )
        )
...
def deserialize_json(data: dict) -> ListNetworkMigrationDeployerJobResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_mgn.types.network_migration_deployer_job_list.deserialize_json(
                data["items"]
            )
        )
