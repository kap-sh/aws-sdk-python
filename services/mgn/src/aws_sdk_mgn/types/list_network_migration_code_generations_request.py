...
class ListNetworkMigrationCodeGenerationsRequest(TypedDict):
...
def serialize_json(value: ListNetworkMigrationCodeGenerationsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_code_generations_filters.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListNetworkMigrationCodeGenerationsRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_code_generations_filters.deserialize_json(
                data["filters"]
            )
        )
