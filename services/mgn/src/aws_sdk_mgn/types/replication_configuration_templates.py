"""Generated from Smithy shape ``com.amazonaws.mgn#ReplicationConfigurationTemplates``."""
...
def serialize_json(value: ReplicationConfigurationTemplates) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_mgn.types.replication_configuration_template.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> ReplicationConfigurationTemplates:
    ...
    for item in data:
        out.append(
            aws_sdk_mgn.types.replication_configuration_template.deserialize_json(item)
        )
    return out
