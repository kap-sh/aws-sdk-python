...
class ListNetworkMigrationCodeGenerationSegmentsRequest(TypedDict):
...
def serialize_json(value: ListNetworkMigrationCodeGenerationSegmentsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_code_generation_segments_filters.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListNetworkMigrationCodeGenerationSegmentsRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_code_generation_segments_filters.deserialize_json(
                data["filters"]
            )
        )
