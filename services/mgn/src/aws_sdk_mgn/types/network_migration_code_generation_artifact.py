...
if TYPE_CHECKING:
    ...
    import aws_sdk_mgn.types.network_migration_code_generation_artifact_id
    import aws_sdk_mgn.types.network_migration_code_generation_artifact_sub_type
    import aws_sdk_mgn.types.network_migration_code_generation_artifact_type
    import aws_sdk_mgn.types.s3_configuration


class NetworkMigrationCodeGenerationArtifact(TypedDict):
    artifact_id: NotRequired[
        "aws_sdk_mgn.types.network_migration_code_generation_artifact_id.NetworkMigrationCodeGenerationArtifactID"
    ]
    """<p>The unique identifier of the artifact.</p>"""
    artifact_type: NotRequired[
        "aws_sdk_mgn.types.network_migration_code_generation_artifact_type.NetworkMigrationCodeGenerationArtifactType"
    ]
    """<p>The type of the artifact, such as CLOUDFORMATION_TEMPLATE or TERRAFORM_MODULE.</p>"""
    artifact_sub_type: NotRequired[
        "aws_sdk_mgn.types.network_migration_code_generation_artifact_sub_type.NetworkMigrationCodeGenerationArtifactSubType"
    ]
