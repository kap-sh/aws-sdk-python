...
class GetNetworkMigrationMapperSegmentConstructResponse(TypedDict):
    construct: NotRequired["aws_sdk_mgn.types.network_migration_mapper_segment_construct.NetworkMigrationMapperSegmentConstruct"]
...
def serialize_json(value: GetNetworkMigrationMapperSegmentConstructResponse) -> dict:
    ...
    if "construct" in value:
        import aws_sdk_mgn.types.network_migration_mapper_segment_construct
        out["construct"] = aws_sdk_mgn.types.network_migration_mapper_segment_construct.serialize_json(value["construct"])
    return out
...
def deserialize_json(data: dict) -> GetNetworkMigrationMapperSegmentConstructResponse:
    ...
    if "construct" in data:
        import aws_sdk_mgn.types.network_migration_mapper_segment_construct
        out["construct"] = aws_sdk_mgn.types.network_migration_mapper_segment_construct.deserialize_json(data["construct"])
    return out