...
if TYPE_CHECKING:
    ...
    import aws_sdk_mgn.types.execution_stage
    import aws_sdk_mgn.types.execution_stage_activity
...
class NetworkMigrationExecution(TypedDict, closed=True):
    ...
    status: NotRequired["aws_sdk_mgn.types.execution_status.ExecutionStatus"]
    """<p>The current status of the execution.</p>"""
    stage: NotRequired["aws_sdk_mgn.types.execution_stage.ExecutionStage"]
    """<p>The current stage of the execution in the migration workflow.</p>"""
    activity: NotRequired[
        "aws_sdk_mgn.types.execution_stage_activity.ExecutionStageActivity"
    ]
