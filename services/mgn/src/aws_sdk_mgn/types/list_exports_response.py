...
class ListExportsResponse(TypedDict):
    items: NotRequired["aws_sdk_mgn.types.exports_list.ExportsList"]
...
def serialize_json(value: ListExportsResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = aws_sdk_mgn.types.exports_list.serialize_json(value["items"])
...
def deserialize_json(data: dict) -> ListExportsResponse:
    ...
    if "items" in data:
        ...
        out["items"] = aws_sdk_mgn.types.exports_list.deserialize_json(data["items"])
