...
class DescribeLaunchConfigurationTemplatesRequest(TypedDict):
    launch_configuration_template_i_ds: NotRequired["aws_sdk_mgn.types.launch_configuration_template_i_ds.LaunchConfigurationTemplateIDs"]
...
def serialize_json(value: DescribeLaunchConfigurationTemplatesRequest) -> dict:
    ...
    if "launch_configuration_template_i_ds" in value:
        import aws_sdk_mgn.types.launch_configuration_template_i_ds
        out["launchConfigurationTemplateIDs"] = aws_sdk_mgn.types.launch_configuration_template_i_ds.serialize_json(value["launch_configuration_template_i_ds"])
...
def deserialize_json(data: dict) -> DescribeLaunchConfigurationTemplatesRequest:
    ...
    if "launchConfigurationTemplateIDs" in data:
        import aws_sdk_mgn.types.launch_configuration_template_i_ds
        out["launch_configuration_template_i_ds"] = aws_sdk_mgn.types.launch_configuration_template_i_ds.deserialize_json(data["launchConfigurationTemplateIDs"])
