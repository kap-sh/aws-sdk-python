...
class CreateLaunchConfigurationTemplateRequest(TypedDict):
    post_launch_actions: NotRequired["aws_sdk_mgn.types.post_launch_actions.PostLaunchActions"]
    ...
    launch_disposition: NotRequired["aws_sdk_mgn.types.launch_disposition.LaunchDisposition"]
    """<p>Launch disposition.</p>"""
    target_instance_type_right_sizing_method: NotRequired["aws_sdk_mgn.types.target_instance_type_right_sizing_method.TargetInstanceTypeRightSizingMethod"]
    ...
    small_volume_conf: NotRequired["aws_sdk_mgn.types.launch_template_disk_conf.LaunchTemplateDiskConf"]
    """<p>Small volume config.</p>"""
    large_volume_conf: NotRequired["aws_sdk_mgn.types.launch_template_disk_conf.LaunchTemplateDiskConf"]
    """<p>Large volume config.</p>"""
    enable_parameters_encryption: NotRequired["bool"]
    """<p>Enable parameters encryption.</p>"""
    parameters_encryption_key: NotRequired["aws_sdk_mgn.types.kms_key_arn.KmsKeyArn"]
...
def serialize_json(value: CreateLaunchConfigurationTemplateRequest) -> dict:
    ...
    if "post_launch_actions" in value:
        import aws_sdk_mgn.types.post_launch_actions
        out["postLaunchActions"] = aws_sdk_mgn.types.post_launch_actions.serialize_json(value["post_launch_actions"])
    ...
    if "licensing" in value:
        import aws_sdk_mgn.types.licensing
        out["licensing"] = aws_sdk_mgn.types.licensing.serialize_json(value["licensing"])
    ...
    if "small_volume_conf" in value:
        import aws_sdk_mgn.types.launch_template_disk_conf
        out["smallVolumeConf"] = aws_sdk_mgn.types.launch_template_disk_conf.serialize_json(value["small_volume_conf"])
    if "large_volume_conf" in value:
        import aws_sdk_mgn.types.launch_template_disk_conf
        out["largeVolumeConf"] = aws_sdk_mgn.types.launch_template_disk_conf.serialize_json(value["large_volume_conf"])
...
def deserialize_json(data: dict) -> CreateLaunchConfigurationTemplateRequest:
    ...
    if "postLaunchActions" in data:
        import aws_sdk_mgn.types.post_launch_actions
        out["post_launch_actions"] = aws_sdk_mgn.types.post_launch_actions.deserialize_json(data["postLaunchActions"])
    ...
    if "licensing" in data:
        import aws_sdk_mgn.types.licensing
        out["licensing"] = aws_sdk_mgn.types.licensing.deserialize_json(data["licensing"])
    if "bootMode" in data:
    ...
    if "smallVolumeConf" in data:
        import aws_sdk_mgn.types.launch_template_disk_conf
        out["small_volume_conf"] = aws_sdk_mgn.types.launch_template_disk_conf.deserialize_json(data["smallVolumeConf"])
    if "largeVolumeConf" in data:
        import aws_sdk_mgn.types.launch_template_disk_conf
        out["large_volume_conf"] = aws_sdk_mgn.types.launch_template_disk_conf.deserialize_json(data["largeVolumeConf"])
