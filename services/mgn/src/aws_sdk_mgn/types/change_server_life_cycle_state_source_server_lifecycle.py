...
class ChangeServerLifeCycleStateSourceServerLifecycle(TypedDict):
...
def deserialize_json(data: dict) -> ChangeServerLifeCycleStateSourceServerLifecycle:
    ...
    if "state" in data:
        ...
        raise DeserializationError("ChangeServerLifeCycleStateSourceServerLifecycle.state required")
    return out