"""Generated from Smithy shape ``com.amazonaws.mgn#ImportTaskSummaryApplications``."""
...
class ImportTaskSummaryApplications(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ImportTaskSummaryApplications) -> dict:
    out: dict = {}
