...
class ListWavesResponse(TypedDict):
    items: NotRequired["aws_sdk_mgn.types.waves_list.WavesList"]
    """<p>Waves list.</p>"""
...
def serialize_json(value: ListWavesResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = aws_sdk_mgn.types.waves_list.serialize_json(value["items"])
...
def deserialize_json(data: dict) -> ListWavesResponse:
    ...
    if "items" in data:
        ...
        out["items"] = aws_sdk_mgn.types.waves_list.deserialize_json(data["items"])
