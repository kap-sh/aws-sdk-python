...
class ListNetworkMigrationAnalysisResultsRequest(TypedDict):
...
def serialize_json(value: ListNetworkMigrationAnalysisResultsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_analysis_results_filters.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListNetworkMigrationAnalysisResultsRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_mgn.types.list_network_migration_analysis_results_filters.deserialize_json(
                data["filters"]
            )
        )
