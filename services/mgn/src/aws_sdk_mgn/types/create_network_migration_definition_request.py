...
class CreateNetworkMigrationDefinitionRequest(TypedDict):
    ...
    description: NotRequired["aws_sdk_mgn.types.network_migration_definition_description.NetworkMigrationDefinitionDescription"]
    """<p>A description of the network migration definition.</p>"""
    source_configurations: NotRequired["aws_sdk_mgn.types.source_configuration_list.SourceConfigurationList"]
    ...
    target_deployment: NotRequired["aws_sdk_mgn.types.target_deployment.TargetDeployment"]
...
def serialize_json(value: CreateNetworkMigrationDefinitionRequest) -> dict:
    ...
    if "source_configurations" in value:
        import aws_sdk_mgn.types.source_configuration_list
        out["sourceConfigurations"] = aws_sdk_mgn.types.source_configuration_list.serialize_json(value["source_configurations"])
    import aws_sdk_mgn.types.target_s3_configuration
    out["targetS3Configuration"] = aws_sdk_mgn.types.target_s3_configuration.serialize_json(value["target_s3_configuration"])
    import aws_sdk_mgn.types.target_network
    out["targetNetwork"] = aws_sdk_mgn.types.target_network.serialize_json(value["target_network"])
    ...
    if "scope_tags" in value:
        import aws_sdk_mgn.types.scope_tags_map
        out["scopeTags"] = aws_sdk_mgn.types.scope_tags_map.serialize_json(value["scope_tags"])
    return out
...
def deserialize_json(data: dict) -> CreateNetworkMigrationDefinitionRequest:
    ...
    if "name" in data:
        ...
        raise DeserializationError("CreateNetworkMigrationDefinitionRequest.name required")
    if "description" in data:
        out["description"] = data["description"]
    if "sourceConfigurations" in data:
        import aws_sdk_mgn.types.source_configuration_list
        out["source_configurations"] = aws_sdk_mgn.types.source_configuration_list.deserialize_json(data["sourceConfigurations"])
    if "targetS3Configuration" in data:
        import aws_sdk_mgn.types.target_s3_configuration
        out["target_s3_configuration"] = aws_sdk_mgn.types.target_s3_configuration.deserialize_json(data["targetS3Configuration"])
    else:
        raise DeserializationError("CreateNetworkMigrationDefinitionRequest.target_s3_configuration required")
    if "targetNetwork" in data:
        import aws_sdk_mgn.types.target_network
        out["target_network"] = aws_sdk_mgn.types.target_network.deserialize_json(data["targetNetwork"])
    else:
        raise DeserializationError("CreateNetworkMigrationDefinitionRequest.target_network required")
    ...
    if "scopeTags" in data:
        import aws_sdk_mgn.types.scope_tags_map
        out["scope_tags"] = aws_sdk_mgn.types.scope_tags_map.deserialize_json(data["scopeTags"])
    return out