...
class DescribeReplicationConfigurationTemplatesRequest(TypedDict):
    replication_configuration_template_i_ds: NotRequired["aws_sdk_mgn.types.replication_configuration_template_i_ds.ReplicationConfigurationTemplateIDs"]
...
def serialize_json(value: DescribeReplicationConfigurationTemplatesRequest) -> dict:
    ...
    if "replication_configuration_template_i_ds" in value:
        import aws_sdk_mgn.types.replication_configuration_template_i_ds
        out["replicationConfigurationTemplateIDs"] = aws_sdk_mgn.types.replication_configuration_template_i_ds.serialize_json(value["replication_configuration_template_i_ds"])
...
def deserialize_json(data: dict) -> DescribeReplicationConfigurationTemplatesRequest:
    ...
    if "replicationConfigurationTemplateIDs" in data:
        import aws_sdk_mgn.types.replication_configuration_template_i_ds
        out["replication_configuration_template_i_ds"] = aws_sdk_mgn.types.replication_configuration_template_i_ds.deserialize_json(data["replicationConfigurationTemplateIDs"])
