"""Generated from Smithy shape ``com.amazonaws.mgn#NetworkMigrationCodeGenerationJobDetails``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_mgn.types.code_generation_output_format_status_details_map
...
class NetworkMigrationCodeGenerationJobDetails(TypedDict, closed=True):
    job_id: NotRequired[
    ...
    code_generation_output_format_status_details_map: NotRequired[
        "aws_sdk_mgn.types.code_generation_output_format_status_details_map.CodeGenerationOutputFormatStatusDetailsMap"
    ]
    """<p>A map of output format types to their status details.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: NetworkMigrationCodeGenerationJobDetails) -> dict:
    out: dict = {}
    if "job_id" in value:
    ...
    if "code_generation_output_format_status_details_map" in value:
        import aws_sdk_mgn.types.code_generation_output_format_status_details_map

        out["codeGenerationOutputFormatStatusDetailsMap"] = (
            aws_sdk_mgn.types.code_generation_output_format_status_details_map.serialize_json(
                value["code_generation_output_format_status_details_map"]
            )
        )
    return out


def deserialize_json(data: dict) -> NetworkMigrationCodeGenerationJobDetails:
    out: NetworkMigrationCodeGenerationJobDetails = {}  # type: ignore[typeddict-item]
    if "jobID" in data:
    ...
    if "codeGenerationOutputFormatStatusDetailsMap" in data:
        import aws_sdk_mgn.types.code_generation_output_format_status_details_map

        out["code_generation_output_format_status_details_map"] = (
            aws_sdk_mgn.types.code_generation_output_format_status_details_map.deserialize_json(
                data["codeGenerationOutputFormatStatusDetailsMap"]
            )
        )
    return out
