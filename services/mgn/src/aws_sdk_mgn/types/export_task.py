...
if TYPE_CHECKING:
    ...
    import aws_sdk_mgn.types.export_status
...
class ExportTask(TypedDict, closed=True):
    ...
    s3_key: NotRequired["aws_sdk_mgn.types.s3_key.S3Key"]
    ...
    summary: NotRequired["aws_sdk_mgn.types.export_task_summary.ExportTaskSummary"]
