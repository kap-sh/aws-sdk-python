...
def serialize_aws_json_1_0(value: EdiConfiguration) -> dict:
    ...
    if "capability_direction" in value:
        ...
        out["capabilityDirection"] = (
            aws_sdk_b2bi.types.capability_direction.serialize_aws_json_1_0(
                value["capability_direction"]
            )
        )
    import aws_sdk_b2bi.types.edi_type

    out["type"] = aws_sdk_b2bi.types.edi_type.serialize_aws_json_1_0(value["type"])
    import aws_sdk_b2bi.types.s3_location

    out["inputLocation"] = aws_sdk_b2bi.types.s3_location.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> EdiConfiguration:
    ...
    if "capabilityDirection" in data:
        ...
        out["capability_direction"] = (
            aws_sdk_b2bi.types.capability_direction.deserialize_aws_json_1_0(
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_b2bi.types.edi_type.deserialize_aws_json_1_0(data["type"])
    else:
        raise DeserializationError("EdiConfiguration.type required")
    if "inputLocation" in data:
        import aws_sdk_b2bi.types.s3_location

        out["input_location"] = aws_sdk_b2bi.types.s3_location.deserialize_aws_json_1_0(
            data["inputLocation"]
        )
    else:
