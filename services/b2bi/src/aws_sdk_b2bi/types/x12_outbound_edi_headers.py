...
if TYPE_CHECKING:
    import aws_sdk_b2bi.types.x12_control_numbers
    import aws_sdk_b2bi.types.x12_delimiters
    import aws_sdk_b2bi.types.x12_functional_group_headers
    import aws_sdk_b2bi.types.x12_gs05_time_format
    import aws_sdk_b2bi.types.x12_interchange_control_headers
    import aws_sdk_b2bi.types.x12_validate_edi


class X12OutboundEdiHeaders(TypedDict):
    interchange_control_headers: NotRequired[
        "aws_sdk_b2bi.types.x12_interchange_control_headers.X12InterchangeControlHeaders"
    ]
    ...
    functional_group_headers: NotRequired[
        "aws_sdk_b2bi.types.x12_functional_group_headers.X12FunctionalGroupHeaders"
    ]
    """<p>The functional group headers for the X12 object.</p>"""
    delimiters: NotRequired["aws_sdk_b2bi.types.x12_delimiters.X12Delimiters"]
    """<p>The delimiters, for example semicolon (<code>;</code>), that separates sections of the headers for the X12 object.</p>"""
    validate_edi: NotRequired["aws_sdk_b2bi.types.x12_validate_edi.X12ValidateEdi"]
    ...
    control_numbers: NotRequired[
        "aws_sdk_b2bi.types.x12_control_numbers.X12ControlNumbers"
    ]
    ...
    gs05_time_format: NotRequired[
        "aws_sdk_b2bi.types.x12_gs05_time_format.X12GS05TimeFormat"
    ]
...
def serialize_aws_json_1_0(value: X12OutboundEdiHeaders) -> dict:
    ...
    if "interchange_control_headers" in value:
        ...
        out["interchangeControlHeaders"] = (
            aws_sdk_b2bi.types.x12_interchange_control_headers.serialize_aws_json_1_0(
    ...
    if "functional_group_headers" in value:
        ...
        out["functionalGroupHeaders"] = (
            aws_sdk_b2bi.types.x12_functional_group_headers.serialize_aws_json_1_0(
    ...
    if "delimiters" in value:
        ...
        out["delimiters"] = aws_sdk_b2bi.types.x12_delimiters.serialize_aws_json_1_0(
            value["delimiters"]
        )
    ...
    if "control_numbers" in value:
        ...
        out["controlNumbers"] = (
            aws_sdk_b2bi.types.x12_control_numbers.serialize_aws_json_1_0(
    ...
    if "gs05_time_format" in value:
        ...
        out["gs05TimeFormat"] = (
            aws_sdk_b2bi.types.x12_gs05_time_format.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> X12OutboundEdiHeaders:
    ...
    if "interchangeControlHeaders" in data:
        ...
        out["interchange_control_headers"] = (
            aws_sdk_b2bi.types.x12_interchange_control_headers.deserialize_aws_json_1_0(
    ...
    if "functionalGroupHeaders" in data:
        ...
        out["functional_group_headers"] = (
            aws_sdk_b2bi.types.x12_functional_group_headers.deserialize_aws_json_1_0(
    ...
    if "delimiters" in data:
        ...
        out["delimiters"] = aws_sdk_b2bi.types.x12_delimiters.deserialize_aws_json_1_0(
            data["delimiters"]
        )
    ...
    if "controlNumbers" in data:
        ...
        out["control_numbers"] = (
            aws_sdk_b2bi.types.x12_control_numbers.deserialize_aws_json_1_0(
                data["controlNumbers"]
            )
        )
    if "gs05TimeFormat" in data:
        ...
        out["gs05_time_format"] = (
            aws_sdk_b2bi.types.x12_gs05_time_format.deserialize_aws_json_1_0(
                data["gs05TimeFormat"]
            )
        )
    return out
