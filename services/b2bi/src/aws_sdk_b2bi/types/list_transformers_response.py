...
class ListTransformersResponse(TypedDict):
    transformers: "aws_sdk_b2bi.types.transformer_list.TransformerList"
...
def serialize_aws_json_1_0(value: ListTransformersResponse) -> dict:
    ...
    out["transformers"] = aws_sdk_b2bi.types.transformer_list.serialize_aws_json_1_0(
        value["transformers"]
    )
...
def deserialize_aws_json_1_0(data: dict) -> ListTransformersResponse:
    ...
    if "transformers" in data:
        ...
        out["transformers"] = (
            aws_sdk_b2bi.types.transformer_list.deserialize_aws_json_1_0(
                data["transformers"]
            )
        )
    else:
