...
class ListCapabilitiesResponse(TypedDict, closed=True):
    capabilities: "aws_sdk_b2bi.types.capability_list.CapabilityList"
...
def serialize_aws_json_1_0(value: ListCapabilitiesResponse) -> dict:
    ...
    out["capabilities"] = aws_sdk_b2bi.types.capability_list.serialize_aws_json_1_0(
        value["capabilities"]
    )
...
def deserialize_aws_json_1_0(data: dict) -> ListCapabilitiesResponse:
    ...
    if "capabilities" in data:
        ...
        out["capabilities"] = (
            aws_sdk_b2bi.types.capability_list.deserialize_aws_json_1_0(
                data["capabilities"]
            )
        )
    else:
