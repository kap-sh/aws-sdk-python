...
if TYPE_CHECKING:
    import aws_sdk_b2bi.types.element_position
...
def serialize_aws_json_1_0(value: X12ElementRequirementValidationRule) -> dict:
    ...
    out["requirement"] = aws_sdk_b2bi.types.element_requirement.serialize_aws_json_1_0(
        value["requirement"]
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> X12ElementRequirementValidationRule:
    ...
    if "requirement" in data:
        ...
        out["requirement"] = (
            aws_sdk_b2bi.types.element_requirement.deserialize_aws_json_1_0(
                data["requirement"]
            )
        )
    else:
