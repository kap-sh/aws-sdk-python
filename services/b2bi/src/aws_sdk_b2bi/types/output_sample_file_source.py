...
class _OutputSampleFileSource_fileLocation(TypedDict):
    fileLocation: "aws_sdk_b2bi.types.s3_location.S3Location"
...
def serialize_aws_json_1_0(value: OutputSampleFileSource) -> dict:
    if "fileLocation" in value:
        ...
        return {
            "fileLocation": aws_sdk_b2bi.types.s3_location.serialize_aws_json_1_0(
                value["fileLocation"]
            )
        }
    else:
...
def deserialize_aws_json_1_0(data: dict) -> OutputSampleFileSource:
    if "fileLocation" in data:
        ...
        return {
            "fileLocation": aws_sdk_b2bi.types.s3_location.deserialize_aws_json_1_0(
                data["fileLocation"]
            )
        }
    else:
