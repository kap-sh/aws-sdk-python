...
def serialize_aws_json_1_0(value: TestConversionRequest) -> dict:
    ...
    out["source"] = aws_sdk_b2bi.types.conversion_source.serialize_aws_json_1_0(
        value["source"]
    )
    import aws_sdk_b2bi.types.conversion_target

    out["target"] = aws_sdk_b2bi.types.conversion_target.serialize_aws_json_1_0(
        value["target"]
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> TestConversionRequest:
    ...
    if "source" in data:
        ...
        out["source"] = aws_sdk_b2bi.types.conversion_source.deserialize_aws_json_1_0(
            data["source"]
        )
    else:
    ...
    if "target" in data:
        ...
        out["target"] = aws_sdk_b2bi.types.conversion_target.deserialize_aws_json_1_0(
            data["target"]
        )
    else:
