...
PartnershipList: TypeAlias = list[
    "aws_sdk_b2bi.types.partnership_summary.PartnershipSummary"
]
...
def serialize_aws_json_1_0(value: PartnershipList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_b2bi.types.partnership_summary.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> PartnershipList:
    ...
    for item in data:
        out.append(
            aws_sdk_b2bi.types.partnership_summary.deserialize_aws_json_1_0(item)
        )
    return out
