...
class _EdiType_x12Details(TypedDict):
    x12Details: "aws_sdk_b2bi.types.x12_details.X12Details"
...
def serialize_aws_json_1_0(value: EdiType) -> dict:
    if "x12Details" in value:
        ...
        return {
            "x12Details": aws_sdk_b2bi.types.x12_details.serialize_aws_json_1_0(
                value["x12Details"]
            )
        }
    else:
...
def deserialize_aws_json_1_0(data: dict) -> EdiType:
    if "x12Details" in data:
        ...
        return {
            "x12Details": aws_sdk_b2bi.types.x12_details.deserialize_aws_json_1_0(
                data["x12Details"]
            )
        }
    else:
