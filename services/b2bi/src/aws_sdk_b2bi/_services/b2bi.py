...
from aws_sdk_b2bi._services._aws_config import aws_config
...
class b2biClientConfig(TypedDict, total=False):
...
class b2biClient:
    ...
    def create_starter_mapping_template(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.create_starter_mapping_template_request.CreateStarterMappingTemplateRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.create_starter_mapping_template_response.CreateStarterMappingTemplateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.create_starter_mapping_template.create_starter_mapping_template(
    ...
    def generate_mapping(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.generate_mapping_request.GenerateMappingRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.generate_mapping_response.GenerateMappingResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.generate_mapping.generate_mapping(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_transformer_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.get_transformer_job_request.GetTransformerJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.get_transformer_job_response.GetTransformerJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.get_transformer_job.get_transformer_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_transformer_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.start_transformer_job_request.StartTransformerJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.start_transformer_job_response.StartTransformerJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.start_transformer_job.start_transformer_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_b2bi._operations.b2_bi.tag_resource

            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_conversion(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.test_conversion_request.TestConversionRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.test_conversion_response.TestConversionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.test_conversion.test_conversion(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_mapping(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.test_mapping_request.TestMappingRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.test_mapping_response.TestMappingResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.test_mapping.test_mapping(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_parsing(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.test_parsing_request.TestParsingRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.test_parsing_response.TestParsingResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.test_parsing.test_parsing(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_b2bi._operations.b2_bi.untag_resource

            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
