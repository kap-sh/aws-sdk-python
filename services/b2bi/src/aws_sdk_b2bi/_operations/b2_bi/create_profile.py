"""Generated from Smithy shape ``com.amazonaws.b2bi#CreateProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.create_profile_response.CreateProfileResponse = (
        aws_sdk_b2bi.types.create_profile_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.create_profile_request.CreateProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/profiles"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "B2BI.CreateProfile"
    import aws_sdk_b2bi.types.create_profile_request

    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.create_profile_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_profile(
    ...
    aws_sdk_b2bi.types.create_profile_response.CreateProfileResponse, zapros.Response
]:
