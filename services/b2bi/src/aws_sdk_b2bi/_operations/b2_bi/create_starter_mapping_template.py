"""Generated from Smithy shape ``com.amazonaws.b2bi#CreateStarterMappingTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.create_starter_mapping_template_response.CreateStarterMappingTemplateResponse = aws_sdk_b2bi.types.create_starter_mapping_template_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.create_starter_mapping_template_request.CreateStarterMappingTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/createmappingstarttemplate"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "B2BI.CreateStarterMappingTemplate"
    import aws_sdk_b2bi.types.create_starter_mapping_template_request

    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.create_starter_mapping_template_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_starter_mapping_template(
