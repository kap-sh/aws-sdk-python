"""Generated from Smithy shape ``com.amazonaws.b2bi#StartTransformerJob``."""
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.start_transformer_job_response.StartTransformerJobResponse = aws_sdk_b2bi.types.start_transformer_job_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/transformer-jobs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "B2BI.StartTransformerJob"
    import aws_sdk_b2bi.types.start_transformer_job_request
