...
import aws_sdk_b2bi.types.capability_list
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.list_capabilities_response.ListCapabilitiesResponse = (
        aws_sdk_b2bi.types.list_capabilities_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.list_capabilities_request.ListCapabilitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
