...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.generate_mapping_response.GenerateMappingResponse = (
        aws_sdk_b2bi.types.generate_mapping_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.generate_mapping_request.GenerateMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.generate_mapping_request.serialize_aws_json_1_0(input_)
    ).encode()
