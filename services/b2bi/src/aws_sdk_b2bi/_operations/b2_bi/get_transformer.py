"""Generated from Smithy shape ``com.amazonaws.b2bi#GetTransformer``."""
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.get_transformer_response.GetTransformerResponse = (
        aws_sdk_b2bi.types.get_transformer_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.get_transformer_request.GetTransformerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "B2BI.GetTransformer"
    body: bytes | None = b""
...
def get_transformer(
    ...
    aws_sdk_b2bi.types.get_transformer_response.GetTransformerResponse, zapros.Response
]:
...
async def async_get_transformer(
