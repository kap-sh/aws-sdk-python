"""Generated from Smithy shape ``com.amazonaws.b2bi#UpdateTransformer``."""
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.update_transformer_response.UpdateTransformerResponse = (
        aws_sdk_b2bi.types.update_transformer_response.deserialize_aws_json_1_0(
