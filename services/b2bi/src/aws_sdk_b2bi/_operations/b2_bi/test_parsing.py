...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.test_parsing_response.TestParsingResponse = (
        aws_sdk_b2bi.types.test_parsing_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.test_parsing_request.TestParsingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.test_parsing_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def test_parsing(
    ...
    aws_sdk_b2bi.types.test_parsing_response.TestParsingResponse, zapros.Response
]:
