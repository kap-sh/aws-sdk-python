...
def build_request(
    ...
    input: aws_sdk_b2bi.types.create_transformer_request.CreateTransformerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.create_transformer_request.serialize_aws_json_1_0(input)
    ).encode()
