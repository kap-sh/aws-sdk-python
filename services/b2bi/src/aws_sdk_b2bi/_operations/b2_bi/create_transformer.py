...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.create_transformer_response.CreateTransformerResponse = (
        aws_sdk_b2bi.types.create_transformer_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.create_transformer_request.CreateTransformerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.create_transformer_request.serialize_aws_json_1_0(input_)
    ).encode()
