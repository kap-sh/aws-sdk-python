"""Generated from Smithy shape ``com.amazonaws.b2bi#UpdateProfile``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_b2bi.errors.conflict_exception

            raise aws_sdk_b2bi.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_b2bi.errors.service_quota_exceeded_exception

            raise aws_sdk_b2bi.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.update_profile_response.UpdateProfileResponse = (
        aws_sdk_b2bi.types.update_profile_response.deserialize_aws_json_1_0(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_b2bi._auth._sigv4.build_sigv4_auth_scheme("b2bi", options.region)
        )
        if sigv4_config is not None:
            return aws_sdk_b2bi._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input: aws_sdk_b2bi.types.update_profile_request.UpdateProfileRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/profiles/{profileId}"
    url = url.replace("{profileId}", quote(str(input["profile_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "B2BI.UpdateProfile"
    import aws_sdk_b2bi.types.update_profile_request

    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.update_profile_request.serialize_aws_json_1_0(input)
    ).encode()
...
def update_profile(
    ...
    aws_sdk_b2bi.types.update_profile_response.UpdateProfileResponse, zapros.Response
]:
