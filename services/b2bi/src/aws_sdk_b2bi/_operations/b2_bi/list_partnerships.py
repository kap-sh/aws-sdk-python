"""Generated from Smithy shape ``com.amazonaws.b2bi#ListPartnerships``."""
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.list_partnerships_response.ListPartnershipsResponse = (
        aws_sdk_b2bi.types.list_partnerships_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.list_partnerships_request.ListPartnershipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "profile_id" in input_:
        params["profileId"] = str(input_["profile_id"])
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "max_results" in input_:
        params["maxResults"] = str(input_["max_results"])
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "B2BI.ListPartnerships"
    body: bytes | None = b""
...
async def async_list_partnerships(
