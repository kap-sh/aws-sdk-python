"""Generated from Smithy shape ``com.amazonaws.b2bi#UpdatePartnership``."""
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.update_partnership_response.UpdatePartnershipResponse = (
        aws_sdk_b2bi.types.update_partnership_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.update_partnership_request.UpdatePartnershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "B2BI.UpdatePartnership"
    import aws_sdk_b2bi.types.update_partnership_request

    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.update_partnership_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_update_partnership(
