...
def build_request(
    ...
    input: aws_sdk_b2bi.types.update_partnership_request.UpdatePartnershipRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.update_partnership_request.serialize_aws_json_1_0(input)
    ).encode()
