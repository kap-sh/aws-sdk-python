"""Generated from Smithy shape ``com.amazonaws.b2bi#CreatePartnership``."""
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.create_partnership_response.CreatePartnershipResponse = (
        aws_sdk_b2bi.types.create_partnership_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.create_partnership_request.CreatePartnershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/partnerships"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "B2BI.CreatePartnership"
    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.create_partnership_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_create_partnership(
