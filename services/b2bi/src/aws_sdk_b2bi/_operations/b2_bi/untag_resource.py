"""Generated from Smithy shape ``com.amazonaws.b2bi#UntagResource``."""
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "B2BI.UntagResource"
    body: bytes | None = b""
