...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.test_mapping_response.TestMappingResponse = (
        aws_sdk_b2bi.types.test_mapping_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.test_mapping_request.TestMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.test_mapping_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def test_mapping(
    ...
    aws_sdk_b2bi.types.test_mapping_response.TestMappingResponse, zapros.Response
]:
