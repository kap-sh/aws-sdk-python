...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.get_profile_response.GetProfileResponse = (
        aws_sdk_b2bi.types.get_profile_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.get_profile_request.GetProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_profile(
    ...
    input_: aws_sdk_b2bi.types.get_profile_request.GetProfileRequest,
) -> tuple[aws_sdk_b2bi.types.get_profile_response.GetProfileResponse, zapros.Response]:
