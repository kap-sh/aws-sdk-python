...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.test_conversion_response.TestConversionResponse = (
        aws_sdk_b2bi.types.test_conversion_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.test_conversion_request.TestConversionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.test_conversion_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def test_conversion(
    ...
    aws_sdk_b2bi.types.test_conversion_response.TestConversionResponse, zapros.Response
]:
