"""Generated from Smithy shape ``com.amazonaws.b2bi#ListTagsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_b2bi.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "B2BI.ListTagsForResource"
    body: bytes | None = b""
