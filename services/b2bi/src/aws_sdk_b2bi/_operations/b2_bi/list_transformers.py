"""Generated from Smithy shape ``com.amazonaws.b2bi#ListTransformers``."""
...
import aws_sdk_b2bi.types.transformer_list
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.list_transformers_response.ListTransformersResponse = (
        aws_sdk_b2bi.types.list_transformers_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.list_transformers_request.ListTransformersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/transformers"
    params: dict[str, str] = {}
    ...
    headers["X-Amz-Target"] = "B2BI.ListTransformers"
    body: bytes | None = b""
...
async def async_list_transformers(
