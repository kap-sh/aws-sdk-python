"""Generated from Smithy shape ``com.amazonaws.b2bi#CreateCapability``."""
...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.create_capability_response.CreateCapabilityResponse = (
        aws_sdk_b2bi.types.create_capability_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.create_capability_request.CreateCapabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/capabilities"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "B2BI.CreateCapability"
    import aws_sdk_b2bi.types.create_capability_request

    body: bytes | None = json.dumps(
        aws_sdk_b2bi.types.create_capability_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_create_capability(
