...
def handle_response(
    ...
    out: aws_sdk_b2bi.types.list_profiles_response.ListProfilesResponse = (
        aws_sdk_b2bi.types.list_profiles_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_b2bi.types.list_profiles_request.ListProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_profiles(
    ...
    aws_sdk_b2bi.types.list_profiles_response.ListProfilesResponse, zapros.Response
]:
