...
if TYPE_CHECKING:
    import aws_sdk_b2bi.types.create_transformer_request
    import aws_sdk_b2bi.types.create_transformer_response
    import aws_sdk_b2bi.types.delete_transformer_request
    import aws_sdk_b2bi.types.edi_type
    import aws_sdk_b2bi.types.file_format
    import aws_sdk_b2bi.types.file_location
    import aws_sdk_b2bi.types.get_transformer_request
    import aws_sdk_b2bi.types.get_transformer_response
    import aws_sdk_b2bi.types.input_conversion
    import aws_sdk_b2bi.types.list_transformers_request
    import aws_sdk_b2bi.types.list_transformers_response
    ...
    import aws_sdk_b2bi.types.update_transformer_response
...
class Transformer:
    ...
    def create(
        ...
        *,
        ...
        file_format: Optional["aws_sdk_b2bi.types.file_format.FileFormat"] = None,
        mapping_template: Optional[
            "aws_sdk_b2bi.types.mapping_template.MappingTemplate"
        ] = None,
        edi_type: Optional["aws_sdk_b2bi.types.edi_type.EdiType"] = None,
        sample_document: Optional[
            "aws_sdk_b2bi.types.file_location.FileLocation"
        ] = None,
        input_conversion: Optional[
            "aws_sdk_b2bi.types.input_conversion.InputConversion"
        ] = None,
        mapping: Optional["aws_sdk_b2bi.types.mapping.Mapping"] = None,
        ...
        Raises:
            aws_sdk_b2bi.errors.access_denied_exception.AccessDeniedException: <p>You do not have sufficient access to perform this action.</p>
            aws_sdk_b2bi.errors.conflict_exception.ConflictException: <p>A conflict exception is thrown when you attempt to delete a resource (such as a profile or a capability) that is being used by other resources.</p>
            aws_sdk_b2bi.errors.internal_server_exception.InternalServerException: <p>This exception is thrown when an error occurs in the Amazon Web Services B2B Data Interchange service.</p>
            aws_sdk_b2bi.errors.resource_not_found_exception.ResourceNotFoundException: <p>Occurs when the requested resource does not exist, or cannot be found. In some cases, the resource exists in a region other than the region specified in the API call.</p>
            aws_sdk_b2bi.errors.service_quota_exceeded_exception.ServiceQuotaExceededException: <p>Occurs when the calling command attempts to exceed one of the service quotas, for example trying to create a capability when you already have the maximum number of capabilities allowed.</p>
            aws_sdk_b2bi.errors.throttling_exception.ThrottlingException: <p>The request was denied due to throttling: the data speed and rendering may be limited depending on various parameters and conditions.</p>
            aws_sdk_b2bi.errors.validation_exception.ValidationException: <p>Occurs when a B2BI object cannot be validated against a request from another object. This exception can be thrown during standard EDI validation or when custom validation rules fail, such as when element length constraints are violated, invalid codes are used in code list validations, or required elements are missing based on configured element requirement rules.</p>
            aws_sdk_b2bi.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.create_transformer_request.CreateTransformerRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.create_transformer_response.CreateTransformerResponse"
        ]:
            import aws_sdk_b2bi._operations.b2_bi.create_transformer

            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.create_transformer.create_transformer(
    ...
    def read(
        ...
        *,
        config_overrides: Optional[b2biClientConfig] = None,
    ) -> "aws_sdk_b2bi.types.get_transformer_response.GetTransformerResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.get_transformer_request.GetTransformerRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.get_transformer_response.GetTransformerResponse"
        ]:
            import aws_sdk_b2bi._operations.b2_bi.get_transformer

            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.get_transformer.get_transformer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        config_overrides: Optional[b2biClientConfig] = None,
        name: Optional["aws_sdk_b2bi.types.transformer_name.TransformerName"] = None,
        status: Optional[
            "aws_sdk_b2bi.types.transformer_status.TransformerStatus"
        ] = None,
        file_format: Optional["aws_sdk_b2bi.types.file_format.FileFormat"] = None,
        mapping_template: Optional[
            "aws_sdk_b2bi.types.mapping_template.MappingTemplate"
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.update_transformer_request.UpdateTransformerRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.update_transformer_response.UpdateTransformerResponse"
        ]:
            import aws_sdk_b2bi._operations.b2_bi.update_transformer

            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.update_transformer.update_transformer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.delete_transformer_request.DeleteTransformerRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_b2bi._operations.b2_bi.delete_transformer

            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.delete_transformer.delete_transformer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_b2bi.types.list_transformers_response.ListTransformersResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_b2bi.types.list_transformers_request.ListTransformersRequest]",
        ) -> OperationResponse[
            "aws_sdk_b2bi.types.list_transformers_response.ListTransformersResponse"
        ]:
            import aws_sdk_b2bi._operations.b2_bi.list_transformers

            output, http_response = (
                aws_sdk_b2bi._operations.b2_bi.list_transformers.list_transformers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncTransformer:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_b2bi.types.create_transformer_request.CreateTransformerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_b2bi.types.create_transformer_response.CreateTransformerResponse"
        ]:
            import aws_sdk_b2bi._operations.b2_bi.create_transformer
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_b2bi._operations.b2_bi.create_transformer.async_create_transformer(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_b2bi.types.get_transformer_request.GetTransformerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_b2bi.types.get_transformer_response.GetTransformerResponse"
        ]:
            import aws_sdk_b2bi._operations.b2_bi.get_transformer
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_b2bi._operations.b2_bi.get_transformer.async_get_transformer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_b2bi.types.update_transformer_request.UpdateTransformerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_b2bi.types.update_transformer_response.UpdateTransformerResponse"
        ]:
            import aws_sdk_b2bi._operations.b2_bi.update_transformer
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_b2bi._operations.b2_bi.update_transformer.async_update_transformer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_b2bi.types.delete_transformer_request.DeleteTransformerRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_b2bi._operations.b2_bi.delete_transformer.async_delete_transformer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_b2bi.types.list_transformers_request.ListTransformersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_b2bi.types.list_transformers_response.ListTransformersResponse"
        ]:
            import aws_sdk_b2bi._operations.b2_bi.list_transformers
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_b2bi._operations.b2_bi.list_transformers.async_list_transformers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
