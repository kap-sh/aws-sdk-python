...
class b2biError(Exception):
    """Base class for all b2bi service errors."""


class ServiceError(b2biError):
...
class SerializationError(b2biError):
    """Raised when a value cannot be serialized."""


class DeserializationError(b2biError):
...
class WaiterFailedError(b2biError):
...
class WaiterTimeoutError(b2biError):
