...
if TYPE_CHECKING:
    import capo_b2bi.types.starting_functional_group_control_number
    import capo_b2bi.types.starting_interchange_control_number
    import capo_b2bi.types.starting_transaction_set_control_number


class X12ControlNumbers(TypedDict, closed=True):
    starting_interchange_control_number: NotRequired[
        "capo_b2bi.types.starting_interchange_control_number.StartingInterchangeControlNumber"
    ]
    ...
    starting_functional_group_control_number: NotRequired[
        "capo_b2bi.types.starting_functional_group_control_number.StartingFunctionalGroupControlNumber"
    ]
    ...
    starting_transaction_set_control_number: NotRequired[
        "capo_b2bi.types.starting_transaction_set_control_number.StartingTransactionSetControlNumber"
    ]
