"""Generated from Smithy shape ``com.amazonaws.b2bi#CreateTransformerResponse``."""
...
class CreateTransformerResponse(TypedDict, closed=True):
    ...
    transformer_arn: "capo_b2bi.types.resource_arn.ResourceArn"
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CreateTransformerResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> CreateTransformerResponse:
    out: CreateTransformerResponse = {}  # type: ignore[typeddict-item]
    if "transformerId" in data:
        out["transformer_id"] = data["transformerId"]
    else:
        raise DeserializationError("CreateTransformerResponse.transformer_id required")
    if "transformerArn" in data:
        out["transformer_arn"] = data["transformerArn"]
    else:
        raise DeserializationError("CreateTransformerResponse.transformer_arn required")
    if "name" in data:
        out["name"] = data["name"]
    else:
        raise DeserializationError("CreateTransformerResponse.name required")
    if "status" in data:
        import capo_b2bi.types.transformer_status
        ...
        raise DeserializationError("CreateTransformerResponse.status required")
    if "createdAt" in data:
        ...
        raise DeserializationError("CreateTransformerResponse.created_at required")
