...
if TYPE_CHECKING:
    import capo_b2bi.types.x12_advanced_options


class AdvancedOptions(TypedDict, closed=True):
    x12: NotRequired["capo_b2bi.types.x12_advanced_options.X12AdvancedOptions"]
...
def serialize_aws_json_1_0(value: AdvancedOptions) -> dict:
    ...
    if "x12" in value:
        ...
        out["x12"] = capo_b2bi.types.x12_advanced_options.serialize_aws_json_1_0(
            value["x12"]
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> AdvancedOptions:
    ...
    if "x12" in data:
        ...
        out["x12"] = capo_b2bi.types.x12_advanced_options.deserialize_aws_json_1_0(
            data["x12"]
        )
    return out
