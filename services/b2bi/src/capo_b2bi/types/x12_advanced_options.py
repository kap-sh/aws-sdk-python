...
class X12AdvancedOptions(TypedDict, closed=True):
    split_options: NotRequired["capo_b2bi.types.x12_split_options.X12SplitOptions"]
    ...
    validation_options: NotRequired[
        "capo_b2bi.types.x12_validation_options.X12ValidationOptions"
    ]
...
def serialize_aws_json_1_0(value: X12AdvancedOptions) -> dict:
    ...
    if "split_options" in value:
        ...
        out["splitOptions"] = capo_b2bi.types.x12_split_options.serialize_aws_json_1_0(
            value["split_options"]
        )
    if "validation_options" in value:
        ...
        out["validationOptions"] = (
            capo_b2bi.types.x12_validation_options.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> X12AdvancedOptions:
    ...
    if "splitOptions" in data:
        ...
        out["split_options"] = (
            capo_b2bi.types.x12_split_options.deserialize_aws_json_1_0(
                data["splitOptions"]
            )
        )
    if "validationOptions" in data:
        ...
        out["validation_options"] = (
            capo_b2bi.types.x12_validation_options.deserialize_aws_json_1_0(
