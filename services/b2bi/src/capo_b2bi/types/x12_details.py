...
class X12Details(TypedDict, closed=True):
    transaction_set: NotRequired[
        "capo_b2bi.types.x12_transaction_set.X12TransactionSet"
    ]
    ...
    version: NotRequired["capo_b2bi.types.x12_version.X12Version"]
...
def serialize_aws_json_1_0(value: X12Details) -> dict:
    ...
    if "transaction_set" in value:
        ...
        out["transactionSet"] = (
            capo_b2bi.types.x12_transaction_set.serialize_aws_json_1_0(
    ...
    if "version" in value:
        ...
        out["version"] = capo_b2bi.types.x12_version.serialize_aws_json_1_0(
            value["version"]
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> X12Details:
    ...
    if "transactionSet" in data:
        ...
        out["transaction_set"] = (
            capo_b2bi.types.x12_transaction_set.deserialize_aws_json_1_0(
                data["transactionSet"]
            )
        )
    if "version" in data:
