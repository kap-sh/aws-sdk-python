...
def handle_response(
    ...
    out: capo_b2bi.types.update_profile_response.UpdateProfileResponse = (
        capo_b2bi.types.update_profile_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_b2bi.types.update_profile_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_profile(
    ...
    capo_b2bi.types.update_profile_response.UpdateProfileResponse, zapros.Response
]:
