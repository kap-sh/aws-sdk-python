"""Generated from Smithy shape ``com.amazonaws.b2bi#GenerateMapping``."""
...
def handle_response(
    ...
    out: capo_b2bi.types.generate_mapping_response.GenerateMappingResponse = (
        capo_b2bi.types.generate_mapping_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/generate-mapping"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "B2BI.GenerateMapping"
    body: bytes | None = json.dumps(
        capo_b2bi.types.generate_mapping_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def generate_mapping(
    ...
    capo_b2bi.types.generate_mapping_response.GenerateMappingResponse, zapros.Response
]:
...
async def async_generate_mapping(
