...
def handle_response(
    ...
    out: capo_b2bi.types.update_partnership_response.UpdatePartnershipResponse = (
        capo_b2bi.types.update_partnership_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_b2bi.types.update_partnership_request.serialize_aws_json_1_0(input_)
    ).encode()
