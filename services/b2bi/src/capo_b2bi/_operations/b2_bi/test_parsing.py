"""Generated from Smithy shape ``com.amazonaws.b2bi#TestParsing``."""
...
def handle_response(
    ...
    out: capo_b2bi.types.test_parsing_response.TestParsingResponse = (
        capo_b2bi.types.test_parsing_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/testparsing"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "B2BI.TestParsing"
    body: bytes | None = json.dumps(
        capo_b2bi.types.test_parsing_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def test_parsing(
    ...
    input_: capo_b2bi.types.test_parsing_request.TestParsingRequest,
) -> tuple[capo_b2bi.types.test_parsing_response.TestParsingResponse, zapros.Response]:
