...
import capo_b2bi.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_b2bi.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_b2bi.types.create_capability_response.CreateCapabilityResponse = (
        capo_b2bi.types.create_capability_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_b2bi.types.create_capability_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_capability(
    ...
    capo_b2bi.types.create_capability_response.CreateCapabilityResponse, zapros.Response
]:
