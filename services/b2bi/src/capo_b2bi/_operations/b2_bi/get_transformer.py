...
def handle_response(
    ...
    out: capo_b2bi.types.get_transformer_response.GetTransformerResponse = (
        capo_b2bi.types.get_transformer_response.deserialize_aws_json_1_0(
...
def get_transformer(
    ...
    capo_b2bi.types.get_transformer_response.GetTransformerResponse, zapros.Response
]:
