...
def handle_response(
    ...
    out: capo_b2bi.types.list_partnerships_response.ListPartnershipsResponse = (
        capo_b2bi.types.list_partnerships_response.deserialize_aws_json_1_0(
...
def list_partnerships(
    ...
    capo_b2bi.types.list_partnerships_response.ListPartnershipsResponse, zapros.Response
]:
