...
class ListSessionsResponse(TypedDict, closed=True):
    ...
    sessions: NotRequired["aws_sdk_athena.types.sessions_list.SessionsList"]
...
def serialize_aws_json_1_1(value: ListSessionsResponse) -> dict:
    ...
    if "sessions" in value:
        ...
        out["Sessions"] = aws_sdk_athena.types.sessions_list.serialize_aws_json_1_1(
            value["sessions"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListSessionsResponse:
    ...
    if "Sessions" in data:
        ...
        out["sessions"] = aws_sdk_athena.types.sessions_list.deserialize_aws_json_1_1(
            data["Sessions"]
        )
    return out
