...
if TYPE_CHECKING:
    import aws_sdk_athena.types.executor_id
    import aws_sdk_athena.types.executor_state
    import aws_sdk_athena.types.executor_type
    import aws_sdk_athena.types.long


class ExecutorsSummary(TypedDict):
    executor_id: "aws_sdk_athena.types.executor_id.ExecutorId"
    """<p>The UUID of the executor.</p>"""
    executor_type: NotRequired["aws_sdk_athena.types.executor_type.ExecutorType"]
    """<p>The type of executor used for the application (<code>COORDINATOR</code>, <code>GATEWAY</code>, or <code>WORKER</code>).</p>"""
    start_date_time: NotRequired["aws_sdk_athena.types.long.Long"]
    """<p>The date and time that the executor started.</p>"""
    termination_date_time: NotRequired["aws_sdk_athena.types.long.Long"]
    """<p>The date and time that the executor was terminated.</p>"""
    executor_state: NotRequired["aws_sdk_athena.types.executor_state.ExecutorState"]
    ...
    executor_size: NotRequired["aws_sdk_athena.types.long.Long"]
...
def serialize_aws_json_1_1(value: ExecutorsSummary) -> dict:
    ...
    if "executor_type" in value:
        ...
        out["ExecutorType"] = aws_sdk_athena.types.executor_type.serialize_aws_json_1_1(
            value["executor_type"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ExecutorsSummary:
    ...
    if "ExecutorType" in data:
        ...
        out["executor_type"] = (
            aws_sdk_athena.types.executor_type.deserialize_aws_json_1_1(
                data["ExecutorType"]
            )
        )
