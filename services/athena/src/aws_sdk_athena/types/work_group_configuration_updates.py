...
if TYPE_CHECKING:
    ...
    import aws_sdk_athena.types.managed_query_results_configuration_updates
    ...
    import aws_sdk_athena.types.result_configuration_updates
    import aws_sdk_athena.types.role_arn


class WorkGroupConfigurationUpdates(TypedDict):
    ...
    managed_query_results_configuration_updates: NotRequired[
        "aws_sdk_athena.types.managed_query_results_configuration_updates.ManagedQueryResultsConfigurationUpdates"
    ]
...
def serialize_aws_json_1_1(value: WorkGroupConfigurationUpdates) -> dict:
    ...
    if "result_configuration_updates" in value:
        ...
        out["ResultConfigurationUpdates"] = (
            aws_sdk_athena.types.result_configuration_updates.serialize_aws_json_1_1(
    ...
    if "managed_query_results_configuration_updates" in value:
        ...
        out["ManagedQueryResultsConfigurationUpdates"] = (
            aws_sdk_athena.types.managed_query_results_configuration_updates.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> WorkGroupConfigurationUpdates:
    ...
    if "ResultConfigurationUpdates" in data:
        ...
        out["result_configuration_updates"] = (
            aws_sdk_athena.types.result_configuration_updates.deserialize_aws_json_1_1(
    ...
    if "ManagedQueryResultsConfigurationUpdates" in data:
        ...
        out["managed_query_results_configuration_updates"] = (
            aws_sdk_athena.types.managed_query_results_configuration_updates.deserialize_aws_json_1_1(
