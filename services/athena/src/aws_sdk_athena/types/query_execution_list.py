...
QueryExecutionList: TypeAlias = list[
    "aws_sdk_athena.types.query_execution.QueryExecution"
]
...
def serialize_aws_json_1_1(value: QueryExecutionList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_athena.types.query_execution.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> QueryExecutionList:
    ...
    for item in data:
        out.append(aws_sdk_athena.types.query_execution.deserialize_aws_json_1_1(item))
    return out
