...
if TYPE_CHECKING:
    import aws_sdk_athena.types.acl_configuration
    import aws_sdk_athena.types.aws_account_id
...
class ResultConfigurationUpdates(TypedDict):
    ...
    remove_output_location: NotRequired[
    ...
    expected_bucket_owner: NotRequired[
        "aws_sdk_athena.types.aws_account_id.AwsAccountId"
    ]
    ...
    acl_configuration: NotRequired[
        "aws_sdk_athena.types.acl_configuration.AclConfiguration"
    ]
...
def serialize_aws_json_1_1(value: ResultConfigurationUpdates) -> dict:
    ...
    if "acl_configuration" in value:
        ...
        out["AclConfiguration"] = (
            aws_sdk_athena.types.acl_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ResultConfigurationUpdates:
    ...
    if "AclConfiguration" in data:
        ...
        out["acl_configuration"] = (
            aws_sdk_athena.types.acl_configuration.deserialize_aws_json_1_1(
