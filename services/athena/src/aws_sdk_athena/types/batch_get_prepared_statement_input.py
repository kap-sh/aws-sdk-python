...
class BatchGetPreparedStatementInput(TypedDict):
    prepared_statement_names: (
        "aws_sdk_athena.types.prepared_statement_name_list.PreparedStatementNameList"
    )
...
def serialize_aws_json_1_1(value: BatchGetPreparedStatementInput) -> dict:
    ...
    out["PreparedStatementNames"] = (
        aws_sdk_athena.types.prepared_statement_name_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchGetPreparedStatementInput:
    ...
    if "PreparedStatementNames" in data:
        ...
        out["prepared_statement_names"] = (
            aws_sdk_athena.types.prepared_statement_name_list.deserialize_aws_json_1_1(
