...
class ListNotebookSessionsResponse(TypedDict):
    notebook_sessions_list: (
        "aws_sdk_athena.types.notebook_sessions_list.NotebookSessionsList"
    )
...
def serialize_aws_json_1_1(value: ListNotebookSessionsResponse) -> dict:
    ...
    out["NotebookSessionsList"] = (
        aws_sdk_athena.types.notebook_sessions_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListNotebookSessionsResponse:
    ...
    if "NotebookSessionsList" in data:
        ...
        out["notebook_sessions_list"] = (
            aws_sdk_athena.types.notebook_sessions_list.deserialize_aws_json_1_1(
