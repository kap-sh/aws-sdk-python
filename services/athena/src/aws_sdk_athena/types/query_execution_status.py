...
if TYPE_CHECKING:
    ...
    import aws_sdk_athena.types.query_execution_state
...
class QueryExecutionStatus(TypedDict, closed=True):
    ...
    submission_date_time: NotRequired["aws_sdk_athena.types.date.Date"]
    """<p>The date and time that the query was submitted.</p>"""
    completion_date_time: NotRequired["aws_sdk_athena.types.date.Date"]
    """<p>The date and time that the query completed.</p>"""
    athena_error: NotRequired["aws_sdk_athena.types.athena_error.AthenaError"]
...
def serialize_aws_json_1_1(value: QueryExecutionStatus) -> dict:
    ...
    if "state" in value:
        ...
        out["State"] = (
            aws_sdk_athena.types.query_execution_state.serialize_aws_json_1_1(
                value["state"]
            )
        )
    ...
    if "submission_date_time" in value:
        ...
        out["SubmissionDateTime"] = aws_sdk_athena.types.date.serialize_aws_json_1_1(
            value["submission_date_time"]
        )
    if "completion_date_time" in value:
        import aws_sdk_athena.types.date

        out["CompletionDateTime"] = aws_sdk_athena.types.date.serialize_aws_json_1_1(
            value["completion_date_time"]
        )
    if "athena_error" in value:
        import aws_sdk_athena.types.athena_error

        out["AthenaError"] = aws_sdk_athena.types.athena_error.serialize_aws_json_1_1(
            value["athena_error"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> QueryExecutionStatus:
    ...
    if "State" in data:
        ...
        out["state"] = (
            aws_sdk_athena.types.query_execution_state.deserialize_aws_json_1_1(
                data["State"]
            )
        )
    ...
    if "AthenaError" in data:
        ...
        out["athena_error"] = (
            aws_sdk_athena.types.athena_error.deserialize_aws_json_1_1(
                data["AthenaError"]
            )
        )
    return out
