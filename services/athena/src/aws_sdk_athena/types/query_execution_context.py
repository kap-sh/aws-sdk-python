...
class QueryExecutionContext(TypedDict, closed=True):
    database: NotRequired["aws_sdk_athena.types.database_string.DatabaseString"]
    """<p>The name of the database used in the query execution. The database must exist in the catalog.</p>"""
    catalog: NotRequired["aws_sdk_athena.types.catalog_name_string.CatalogNameString"]
