"""Generated from Smithy shape ``com.amazonaws.athena#UpdateNamedQuery``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.update_named_query_output.UpdateNamedQueryOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.update_named_query_input.UpdateNamedQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.UpdateNamedQuery"
    import aws_sdk_athena.types.update_named_query_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.update_named_query_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_named_query(
