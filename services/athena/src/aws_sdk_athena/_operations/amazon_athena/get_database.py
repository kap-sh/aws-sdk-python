"""Generated from Smithy shape ``com.amazonaws.athena#GetDatabase``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MetadataException":
            import aws_sdk_athena.errors.metadata_exception

            raise aws_sdk_athena.errors.metadata_exception.MetadataException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_database_output.GetDatabaseOutput = (
        aws_sdk_athena.types.get_database_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_database_input.GetDatabaseInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetDatabase"
    import aws_sdk_athena.types.get_database_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_database_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_database(
    ...
    input_: aws_sdk_athena.types.get_database_input.GetDatabaseInput,
) -> tuple[aws_sdk_athena.types.get_database_output.GetDatabaseOutput, zapros.Response]:
