"""Generated from Smithy shape ``com.amazonaws.athena#ListCapacityReservations``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_capacity_reservations_output.ListCapacityReservationsOutput = aws_sdk_athena.types.list_capacity_reservations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_capacity_reservations_input.ListCapacityReservationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ListCapacityReservations"
    import aws_sdk_athena.types.list_capacity_reservations_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_capacity_reservations_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_capacity_reservations(
