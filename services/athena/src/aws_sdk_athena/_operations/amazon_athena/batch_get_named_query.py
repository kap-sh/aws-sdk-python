"""Generated from Smithy shape ``com.amazonaws.athena#BatchGetNamedQuery``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.batch_get_named_query_output.BatchGetNamedQueryOutput = (
        aws_sdk_athena.types.batch_get_named_query_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.batch_get_named_query_input.BatchGetNamedQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.batch_get_named_query_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_get_named_query(
