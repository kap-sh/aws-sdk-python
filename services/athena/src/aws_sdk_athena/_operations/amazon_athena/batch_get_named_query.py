...
def build_request(
    ...
    input: aws_sdk_athena.types.batch_get_named_query_input.BatchGetNamedQueryInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.batch_get_named_query_input.serialize_aws_json_1_1(input)
    ).encode()
