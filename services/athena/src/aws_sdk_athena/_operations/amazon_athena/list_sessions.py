"""Generated from Smithy shape ``com.amazonaws.athena#ListSessions``."""
...
import aws_sdk_athena.types.sessions_list
...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_sessions_response.ListSessionsResponse = (
        aws_sdk_athena.types.list_sessions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_sessions_request.ListSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ListSessions"
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_sessions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_sessions(
    ...
    aws_sdk_athena.types.list_sessions_response.ListSessionsResponse, zapros.Response
]:
