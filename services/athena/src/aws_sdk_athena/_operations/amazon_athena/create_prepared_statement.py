...
def handle_response(
    ...
    out: aws_sdk_athena.types.create_prepared_statement_output.CreatePreparedStatementOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.create_prepared_statement_input.CreatePreparedStatementInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.create_prepared_statement_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
