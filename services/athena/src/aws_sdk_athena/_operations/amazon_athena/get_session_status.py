...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_session_status_response.GetSessionStatusResponse = (
        aws_sdk_athena.types.get_session_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_session_status_request.GetSessionStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_session_status_request.serialize_aws_json_1_1(input_)
    ).encode()
