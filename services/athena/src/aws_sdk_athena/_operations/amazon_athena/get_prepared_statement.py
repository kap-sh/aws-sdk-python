"""Generated from Smithy shape ``com.amazonaws.athena#GetPreparedStatement``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_prepared_statement_output.GetPreparedStatementOutput = aws_sdk_athena.types.get_prepared_statement_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_prepared_statement_input.GetPreparedStatementInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetPreparedStatement"
    import aws_sdk_athena.types.get_prepared_statement_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_prepared_statement_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_prepared_statement(
