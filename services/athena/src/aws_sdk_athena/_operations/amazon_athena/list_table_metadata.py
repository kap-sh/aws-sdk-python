...
def build_request(
    ...
    input: aws_sdk_athena.types.list_table_metadata_input.ListTableMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_table_metadata_input.serialize_aws_json_1_1(input)
    ).encode()
