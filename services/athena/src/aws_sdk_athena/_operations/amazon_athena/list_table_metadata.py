...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_table_metadata_output.ListTableMetadataOutput = (
        aws_sdk_athena.types.list_table_metadata_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_table_metadata_input.ListTableMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_table_metadata_input.serialize_aws_json_1_1(input_)
    ).encode()
