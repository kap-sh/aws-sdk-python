...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_resource_dashboard_response.GetResourceDashboardResponse = aws_sdk_athena.types.get_resource_dashboard_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_resource_dashboard_request.GetResourceDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_resource_dashboard_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
