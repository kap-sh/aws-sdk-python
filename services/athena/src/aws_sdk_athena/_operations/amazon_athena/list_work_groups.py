...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_work_groups_output.ListWorkGroupsOutput = (
        aws_sdk_athena.types.list_work_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_work_groups_input.ListWorkGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_work_groups_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_work_groups(
    ...
    aws_sdk_athena.types.list_work_groups_output.ListWorkGroupsOutput, zapros.Response
]:
