"""Generated from Smithy shape ``com.amazonaws.athena#GetWorkGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_work_group_output.GetWorkGroupOutput = (
        aws_sdk_athena.types.get_work_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_work_group_input.GetWorkGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_work_group_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_work_group(
    ...
    aws_sdk_athena.types.get_work_group_output.GetWorkGroupOutput, zapros.Response
]:
...
async def async_get_work_group(
