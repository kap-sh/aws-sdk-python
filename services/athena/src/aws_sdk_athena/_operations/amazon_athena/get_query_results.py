...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_query_results_output.GetQueryResultsOutput = (
        aws_sdk_athena.types.get_query_results_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_query_results_input.GetQueryResultsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_query_results_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_query_results(
    ...
    aws_sdk_athena.types.get_query_results_output.GetQueryResultsOutput, zapros.Response
]:
