...
def handle_response(
    ...
    out: aws_sdk_athena.types.stop_calculation_execution_response.StopCalculationExecutionResponse = aws_sdk_athena.types.stop_calculation_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.stop_calculation_execution_request.StopCalculationExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.stop_calculation_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
