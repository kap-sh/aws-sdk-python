"""Generated from Smithy shape ``com.amazonaws.athena#ImportNotebook``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.import_notebook_output.ImportNotebookOutput = (
        aws_sdk_athena.types.import_notebook_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.import_notebook_input.ImportNotebookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ImportNotebook"
    import aws_sdk_athena.types.import_notebook_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.import_notebook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def import_notebook(
    ...
    aws_sdk_athena.types.import_notebook_output.ImportNotebookOutput, zapros.Response
]:
...
async def async_import_notebook(
