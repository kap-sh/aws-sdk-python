"""Generated from Smithy shape ``com.amazonaws.athena#DeleteCapacityReservation``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.delete_capacity_reservation_output.DeleteCapacityReservationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.delete_capacity_reservation_input.DeleteCapacityReservationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.DeleteCapacityReservation"
    import aws_sdk_athena.types.delete_capacity_reservation_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.delete_capacity_reservation_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_capacity_reservation(
