...
def handle_response(
    ...
    out: aws_sdk_athena.types.create_named_query_output.CreateNamedQueryOutput = (
        aws_sdk_athena.types.create_named_query_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.create_named_query_input.CreateNamedQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.create_named_query_input.serialize_aws_json_1_1(input_)
    ).encode()
