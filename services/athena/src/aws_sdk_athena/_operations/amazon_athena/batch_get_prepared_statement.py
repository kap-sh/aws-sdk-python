...
def handle_response(
    ...
    out: aws_sdk_athena.types.batch_get_prepared_statement_output.BatchGetPreparedStatementOutput = aws_sdk_athena.types.batch_get_prepared_statement_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.batch_get_prepared_statement_input.BatchGetPreparedStatementInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.batch_get_prepared_statement_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
