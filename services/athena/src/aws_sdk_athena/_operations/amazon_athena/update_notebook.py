"""Generated from Smithy shape ``com.amazonaws.athena#UpdateNotebook``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.update_notebook_output.UpdateNotebookOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.update_notebook_input.UpdateNotebookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.UpdateNotebook"
    import aws_sdk_athena.types.update_notebook_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.update_notebook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_notebook(
    ...
    aws_sdk_athena.types.update_notebook_output.UpdateNotebookOutput, zapros.Response
]:
...
async def async_update_notebook(
