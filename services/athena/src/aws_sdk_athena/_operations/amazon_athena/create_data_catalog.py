...
def build_request(
    ...
    input: aws_sdk_athena.types.create_data_catalog_input.CreateDataCatalogInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.create_data_catalog_input.serialize_aws_json_1_1(input)
    ).encode()
