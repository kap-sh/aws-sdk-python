...
def handle_response(
    ...
    out: aws_sdk_athena.types.create_data_catalog_output.CreateDataCatalogOutput = (
        aws_sdk_athena.types.create_data_catalog_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.create_data_catalog_input.CreateDataCatalogInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.create_data_catalog_input.serialize_aws_json_1_1(input_)
    ).encode()
