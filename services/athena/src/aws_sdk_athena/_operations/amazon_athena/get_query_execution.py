...
def build_request(
    ...
    input: aws_sdk_athena.types.get_query_execution_input.GetQueryExecutionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_query_execution_input.serialize_aws_json_1_1(input)
    ).encode()
