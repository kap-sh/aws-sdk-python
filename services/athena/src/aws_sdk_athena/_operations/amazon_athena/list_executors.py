"""Generated from Smithy shape ``com.amazonaws.athena#ListExecutors``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_executors_response.ListExecutorsResponse = (
        aws_sdk_athena.types.list_executors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_executors_request.ListExecutorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ListExecutors"
    import aws_sdk_athena.types.list_executors_request

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_executors_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_executors(
    ...
    aws_sdk_athena.types.list_executors_response.ListExecutorsResponse, zapros.Response
]:
...
async def async_list_executors(
