"""Generated from Smithy shape ``com.amazonaws.athena#DeleteWorkGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.delete_work_group_output.DeleteWorkGroupOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.delete_work_group_input.DeleteWorkGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.delete_work_group_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_work_group(
    ...
    aws_sdk_athena.types.delete_work_group_output.DeleteWorkGroupOutput, zapros.Response
]:
...
async def async_delete_work_group(
