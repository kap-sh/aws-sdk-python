"""Generated from Smithy shape ``com.amazonaws.athena#UpdateWorkGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.update_work_group_output.UpdateWorkGroupOutput = {}  # type: ignore[typeddict-item]
    return out
