...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_engine_versions_output.ListEngineVersionsOutput = (
        aws_sdk_athena.types.list_engine_versions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_engine_versions_input.ListEngineVersionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_engine_versions_input.serialize_aws_json_1_1(input_)
    ).encode()
