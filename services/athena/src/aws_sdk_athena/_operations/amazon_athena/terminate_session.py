...
def build_request(
    ...
    input: aws_sdk_athena.types.terminate_session_request.TerminateSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.terminate_session_request.serialize_aws_json_1_1(input)
    ).encode()
