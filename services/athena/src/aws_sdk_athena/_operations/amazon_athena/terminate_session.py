"""Generated from Smithy shape ``com.amazonaws.athena#TerminateSession``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.terminate_session_response.TerminateSessionResponse = (
        aws_sdk_athena.types.terminate_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.terminate_session_request.TerminateSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.TerminateSession"
    import aws_sdk_athena.types.terminate_session_request

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.terminate_session_request.serialize_aws_json_1_1(input_)
    ).encode()
