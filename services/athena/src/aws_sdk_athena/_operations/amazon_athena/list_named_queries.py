"""Generated from Smithy shape ``com.amazonaws.athena#ListNamedQueries``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_named_queries_output.ListNamedQueriesOutput = (
        aws_sdk_athena.types.list_named_queries_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_named_queries_input.ListNamedQueriesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_named_queries_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_named_queries(
