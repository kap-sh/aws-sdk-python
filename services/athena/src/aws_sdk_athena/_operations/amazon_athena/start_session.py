...
def build_request(
    ...
    input_: aws_sdk_athena.types.start_session_request.StartSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.start_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_session(
    ...
    aws_sdk_athena.types.start_session_response.StartSessionResponse, zapros.Response
]:
