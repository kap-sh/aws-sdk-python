...
def handle_response(
    ...
    out: aws_sdk_athena.types.put_capacity_assignment_configuration_output.PutCapacityAssignmentConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.put_capacity_assignment_configuration_input.PutCapacityAssignmentConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.put_capacity_assignment_configuration_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
