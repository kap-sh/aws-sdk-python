...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_data_catalogs_output.ListDataCatalogsOutput = (
        aws_sdk_athena.types.list_data_catalogs_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_data_catalogs_input.ListDataCatalogsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_data_catalogs_input.serialize_aws_json_1_1(input_)
    ).encode()
