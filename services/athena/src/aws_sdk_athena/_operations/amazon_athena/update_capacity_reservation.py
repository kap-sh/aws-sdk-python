...
def handle_response(
    ...
    out: aws_sdk_athena.types.update_capacity_reservation_output.UpdateCapacityReservationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.update_capacity_reservation_input.UpdateCapacityReservationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.update_capacity_reservation_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
