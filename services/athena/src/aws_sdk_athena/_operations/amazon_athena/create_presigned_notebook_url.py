...
def handle_response(
    ...
    out: aws_sdk_athena.types.create_presigned_notebook_url_response.CreatePresignedNotebookUrlResponse = aws_sdk_athena.types.create_presigned_notebook_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.create_presigned_notebook_url_request.CreatePresignedNotebookUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.create_presigned_notebook_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
