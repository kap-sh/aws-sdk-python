"""Generated from Smithy shape ``com.amazonaws.athena#DeleteNotebook``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.delete_notebook_output.DeleteNotebookOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.delete_notebook_input.DeleteNotebookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.DeleteNotebook"
    import aws_sdk_athena.types.delete_notebook_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.delete_notebook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_notebook(
    ...
    aws_sdk_athena.types.delete_notebook_output.DeleteNotebookOutput, zapros.Response
]:
...
async def async_delete_notebook(
