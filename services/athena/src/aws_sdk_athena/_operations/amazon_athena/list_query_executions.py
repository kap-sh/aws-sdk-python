...
def build_request(
    ...
    input: aws_sdk_athena.types.list_query_executions_input.ListQueryExecutionsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_query_executions_input.serialize_aws_json_1_1(input)
    ).encode()
