...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_query_executions_output.ListQueryExecutionsOutput = (
        aws_sdk_athena.types.list_query_executions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_query_executions_input.ListQueryExecutionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_query_executions_input.serialize_aws_json_1_1(input_)
    ).encode()
