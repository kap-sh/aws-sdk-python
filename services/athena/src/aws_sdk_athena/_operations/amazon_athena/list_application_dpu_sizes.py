"""Generated from Smithy shape ``com.amazonaws.athena#ListApplicationDPUSizes``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_application_dpu_sizes_output.ListApplicationDPUSizesOutput = aws_sdk_athena.types.list_application_dpu_sizes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_application_dpu_sizes_input.ListApplicationDPUSizesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ListApplicationDPUSizes"
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_application_dpu_sizes_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_application_dpu_sizes(
