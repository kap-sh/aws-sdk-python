"""Generated from Smithy shape ``com.amazonaws.athena#DeleteNamedQuery``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.delete_named_query_output.DeleteNamedQueryOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.delete_named_query_input.DeleteNamedQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.delete_named_query_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_named_query(
