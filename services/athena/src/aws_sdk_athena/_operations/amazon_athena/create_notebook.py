...
def handle_response(
    ...
    out: aws_sdk_athena.types.create_notebook_output.CreateNotebookOutput = (
        aws_sdk_athena.types.create_notebook_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.create_notebook_input.CreateNotebookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.create_notebook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_notebook(
    ...
    aws_sdk_athena.types.create_notebook_output.CreateNotebookOutput, zapros.Response
]:
