"""Generated from Smithy shape ``com.amazonaws.athena#GetCalculationExecutionCode``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_calculation_execution_code_response.GetCalculationExecutionCodeResponse = aws_sdk_athena.types.get_calculation_execution_code_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_calculation_execution_code_request.GetCalculationExecutionCodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetCalculationExecutionCode"
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_calculation_execution_code_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_calculation_execution_code(
