...
def build_request(
    ...
    input: aws_sdk_athena.types.delete_data_catalog_input.DeleteDataCatalogInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.delete_data_catalog_input.serialize_aws_json_1_1(input)
    ).encode()
