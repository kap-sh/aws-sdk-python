...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_data_catalog_output.GetDataCatalogOutput = (
        aws_sdk_athena.types.get_data_catalog_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_data_catalog_input.GetDataCatalogInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_data_catalog_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_data_catalog(
    ...
    aws_sdk_athena.types.get_data_catalog_output.GetDataCatalogOutput, zapros.Response
]:
