"""Generated from Smithy shape ``com.amazonaws.athena#ListDatabases``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_databases_output.ListDatabasesOutput = (
        aws_sdk_athena.types.list_databases_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_databases_input.ListDatabasesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_databases_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_databases(
    ...
    aws_sdk_athena.types.list_databases_output.ListDatabasesOutput, zapros.Response
]:
