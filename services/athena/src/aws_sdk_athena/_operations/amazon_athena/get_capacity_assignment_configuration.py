"""Generated from Smithy shape ``com.amazonaws.athena#GetCapacityAssignmentConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_capacity_assignment_configuration_output.GetCapacityAssignmentConfigurationOutput = aws_sdk_athena.types.get_capacity_assignment_configuration_output.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_athena._auth._sigv4.build_sigv4_auth_scheme(
                "athena", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_athena._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_capacity_assignment_configuration_input.GetCapacityAssignmentConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetCapacityAssignmentConfiguration"
    import aws_sdk_athena.types.get_capacity_assignment_configuration_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_capacity_assignment_configuration_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_capacity_assignment_configuration(
