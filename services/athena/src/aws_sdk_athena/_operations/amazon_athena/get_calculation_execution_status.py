"""Generated from Smithy shape ``com.amazonaws.athena#GetCalculationExecutionStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_calculation_execution_status_response.GetCalculationExecutionStatusResponse = aws_sdk_athena.types.get_calculation_execution_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_calculation_execution_status_request.GetCalculationExecutionStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetCalculationExecutionStatus"
    import aws_sdk_athena.types.get_calculation_execution_status_request

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_calculation_execution_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_calculation_execution_status(
