...
def handle_response(
    ...
    out: aws_sdk_athena.types.start_query_execution_output.StartQueryExecutionOutput = (
        aws_sdk_athena.types.start_query_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.start_query_execution_input.StartQueryExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.start_query_execution_input.serialize_aws_json_1_1(input_)
    ).encode()
