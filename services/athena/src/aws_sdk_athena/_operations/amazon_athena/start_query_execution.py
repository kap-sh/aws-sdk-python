...
def build_request(
    ...
    input: aws_sdk_athena.types.start_query_execution_input.StartQueryExecutionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.start_query_execution_input.serialize_aws_json_1_1(input)
    ).encode()
