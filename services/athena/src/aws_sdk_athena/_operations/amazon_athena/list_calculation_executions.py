"""Generated from Smithy shape ``com.amazonaws.athena#ListCalculationExecutions``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_calculation_executions_response.ListCalculationExecutionsResponse = aws_sdk_athena.types.list_calculation_executions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_calculation_executions_request.ListCalculationExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ListCalculationExecutions"
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_calculation_executions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_calculation_executions(
