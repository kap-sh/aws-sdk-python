...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_capacity_reservation_output.GetCapacityReservationOutput = aws_sdk_athena.types.get_capacity_reservation_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_capacity_reservation_input.GetCapacityReservationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_capacity_reservation_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
