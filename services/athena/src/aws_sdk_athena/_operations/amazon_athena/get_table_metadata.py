...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_table_metadata_output.GetTableMetadataOutput = (
        aws_sdk_athena.types.get_table_metadata_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_table_metadata_input.GetTableMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_table_metadata_input.serialize_aws_json_1_1(input_)
    ).encode()
