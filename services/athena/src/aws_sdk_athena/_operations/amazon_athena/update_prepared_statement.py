...
def handle_response(
    ...
    out: aws_sdk_athena.types.update_prepared_statement_output.UpdatePreparedStatementOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.update_prepared_statement_input.UpdatePreparedStatementInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.update_prepared_statement_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
