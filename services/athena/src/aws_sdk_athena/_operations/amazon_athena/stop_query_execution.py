"""Generated from Smithy shape ``com.amazonaws.athena#StopQueryExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.stop_query_execution_output.StopQueryExecutionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.stop_query_execution_input.StopQueryExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.stop_query_execution_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_stop_query_execution(
