...
def handle_response(
    ...
    out: aws_sdk_athena.types.update_notebook_metadata_output.UpdateNotebookMetadataOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.update_notebook_metadata_input.UpdateNotebookMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.update_notebook_metadata_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
