...
def handle_response(
    ...
    out: aws_sdk_athena.types.create_capacity_reservation_output.CreateCapacityReservationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.create_capacity_reservation_input.CreateCapacityReservationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.create_capacity_reservation_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
