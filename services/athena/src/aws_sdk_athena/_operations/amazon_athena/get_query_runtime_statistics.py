...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_query_runtime_statistics_output.GetQueryRuntimeStatisticsOutput = aws_sdk_athena.types.get_query_runtime_statistics_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_query_runtime_statistics_input.GetQueryRuntimeStatisticsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_query_runtime_statistics_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
