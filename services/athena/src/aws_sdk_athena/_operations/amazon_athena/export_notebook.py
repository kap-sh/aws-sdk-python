"""Generated from Smithy shape ``com.amazonaws.athena#ExportNotebook``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.export_notebook_output.ExportNotebookOutput = (
        aws_sdk_athena.types.export_notebook_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.export_notebook_input.ExportNotebookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ExportNotebook"
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.export_notebook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def export_notebook(
    ...
    aws_sdk_athena.types.export_notebook_output.ExportNotebookOutput, zapros.Response
]:
...
async def async_export_notebook(
