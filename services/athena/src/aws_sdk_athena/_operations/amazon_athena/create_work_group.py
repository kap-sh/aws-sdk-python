...
def handle_response(
    ...
    out: aws_sdk_athena.types.create_work_group_output.CreateWorkGroupOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_athena.types.create_work_group_input.CreateWorkGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.create_work_group_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_work_group(
    ...
    aws_sdk_athena.types.create_work_group_output.CreateWorkGroupOutput, zapros.Response
]:
