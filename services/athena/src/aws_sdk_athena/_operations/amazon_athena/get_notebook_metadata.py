...
def build_request(
    ...
    input: aws_sdk_athena.types.get_notebook_metadata_input.GetNotebookMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_notebook_metadata_input.serialize_aws_json_1_1(input)
    ).encode()
