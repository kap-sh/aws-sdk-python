"""Generated from Smithy shape ``com.amazonaws.athena#GetNotebookMetadata``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_notebook_metadata_output.GetNotebookMetadataOutput = (
        aws_sdk_athena.types.get_notebook_metadata_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_notebook_metadata_input.GetNotebookMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetNotebookMetadata"
    import aws_sdk_athena.types.get_notebook_metadata_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_notebook_metadata_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_notebook_metadata(
