"""Generated from Smithy shape ``com.amazonaws.athena#ListNotebookSessions``."""
...
import aws_sdk_athena.types.notebook_sessions_list
...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_notebook_sessions_response.ListNotebookSessionsResponse = aws_sdk_athena.types.list_notebook_sessions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_notebook_sessions_request.ListNotebookSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ListNotebookSessions"
    import aws_sdk_athena.types.list_notebook_sessions_request

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_notebook_sessions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_notebook_sessions(
