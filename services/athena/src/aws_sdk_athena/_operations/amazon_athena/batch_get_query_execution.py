...
def handle_response(
    ...
    out: aws_sdk_athena.types.batch_get_query_execution_output.BatchGetQueryExecutionOutput = aws_sdk_athena.types.batch_get_query_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.batch_get_query_execution_input.BatchGetQueryExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.batch_get_query_execution_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
