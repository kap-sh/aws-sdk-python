"""Generated from Smithy shape ``com.amazonaws.athena#ListNotebookMetadata``."""
...
import aws_sdk_athena.types.notebook_metadata_array
...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_notebook_metadata_output.ListNotebookMetadataOutput = aws_sdk_athena.types.list_notebook_metadata_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_notebook_metadata_input.ListNotebookMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ListNotebookMetadata"
    import aws_sdk_athena.types.list_notebook_metadata_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_notebook_metadata_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_notebook_metadata(
