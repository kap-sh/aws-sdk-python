...
def build_request(
    ...
    input: aws_sdk_athena.types.list_notebook_metadata_input.ListNotebookMetadataInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_notebook_metadata_input.serialize_aws_json_1_1(input)
    ).encode()
