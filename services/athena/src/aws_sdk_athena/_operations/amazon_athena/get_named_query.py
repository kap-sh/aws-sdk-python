...
def handle_response(
    ...
    out: aws_sdk_athena.types.get_named_query_output.GetNamedQueryOutput = (
        aws_sdk_athena.types.get_named_query_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.get_named_query_input.GetNamedQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_athena.types.get_named_query_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_named_query(
    ...
    aws_sdk_athena.types.get_named_query_output.GetNamedQueryOutput, zapros.Response
]:
