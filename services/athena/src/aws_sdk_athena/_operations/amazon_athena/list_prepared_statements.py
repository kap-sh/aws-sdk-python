"""Generated from Smithy shape ``com.amazonaws.athena#ListPreparedStatements``."""
...
def handle_response(
    ...
    out: aws_sdk_athena.types.list_prepared_statements_output.ListPreparedStatementsOutput = aws_sdk_athena.types.list_prepared_statements_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_athena.types.list_prepared_statements_input.ListPreparedStatementsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ListPreparedStatements"
    import aws_sdk_athena.types.list_prepared_statements_input

    body: bytes | None = json.dumps(
        aws_sdk_athena.types.list_prepared_statements_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_prepared_statements(
