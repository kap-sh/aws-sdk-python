...
class AthenaError(Exception):
    """Base class for all Athena service errors."""
...
class SerializationError(AthenaError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AthenaError):
...
class WaiterFailedError(AthenaError):
...
class WaiterTimeoutError(AthenaError):
