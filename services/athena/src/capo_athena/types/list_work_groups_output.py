...
class ListWorkGroupsOutput(TypedDict, closed=True):
    work_groups: NotRequired["capo_athena.types.work_groups_list.WorkGroupsList"]
...
def serialize_aws_json_1_1(value: ListWorkGroupsOutput) -> dict:
    ...
    if "work_groups" in value:
        ...
        out["WorkGroups"] = capo_athena.types.work_groups_list.serialize_aws_json_1_1(
            value["work_groups"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListWorkGroupsOutput:
    ...
    if "WorkGroups" in data:
        ...
        out["work_groups"] = (
            capo_athena.types.work_groups_list.deserialize_aws_json_1_1(
                data["WorkGroups"]
            )
        )
