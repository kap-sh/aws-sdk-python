...
def handle_response(
    ...
    out: capo_athena.types.export_notebook_output.ExportNotebookOutput = (
        capo_athena.types.export_notebook_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.export_notebook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def export_notebook(
    ...
    capo_athena.types.export_notebook_output.ExportNotebookOutput, zapros.Response
]:
