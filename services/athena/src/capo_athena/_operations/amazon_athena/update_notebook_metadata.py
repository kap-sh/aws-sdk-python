"""Generated from Smithy shape ``com.amazonaws.athena#UpdateNotebookMetadata``."""
...
def handle_response(
    ...
    out: capo_athena.types.update_notebook_metadata_output.UpdateNotebookMetadataOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.UpdateNotebookMetadata"
    body: bytes | None = json.dumps(
        capo_athena.types.update_notebook_metadata_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_notebook_metadata(
