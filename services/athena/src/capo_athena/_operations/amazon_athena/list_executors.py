...
def handle_response(
    ...
    out: capo_athena.types.list_executors_response.ListExecutorsResponse = (
        capo_athena.types.list_executors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.list_executors_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_executors(
    ...
    capo_athena.types.list_executors_response.ListExecutorsResponse, zapros.Response
]:
