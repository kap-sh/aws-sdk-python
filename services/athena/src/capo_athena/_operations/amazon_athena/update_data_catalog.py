"""Generated from Smithy shape ``com.amazonaws.athena#UpdateDataCatalog``."""
...
def handle_response(
    ...
    out: capo_athena.types.update_data_catalog_output.UpdateDataCatalogOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.UpdateDataCatalog"
    body: bytes | None = json.dumps(
        capo_athena.types.update_data_catalog_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_data_catalog(
