...
def handle_response(
    ...
    out: capo_athena.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.untag_resource_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_athena.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
