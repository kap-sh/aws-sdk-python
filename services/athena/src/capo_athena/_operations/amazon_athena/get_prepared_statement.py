...
def handle_response(
    ...
    out: capo_athena.types.get_prepared_statement_output.GetPreparedStatementOutput = (
        capo_athena.types.get_prepared_statement_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.get_prepared_statement_input.serialize_aws_json_1_1(input_)
    ).encode()
