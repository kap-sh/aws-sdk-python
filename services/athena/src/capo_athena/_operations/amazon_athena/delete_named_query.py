...
def handle_response(
    ...
    out: capo_athena.types.delete_named_query_output.DeleteNamedQueryOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.delete_named_query_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_named_query(
    ...
    capo_athena.types.delete_named_query_output.DeleteNamedQueryOutput, zapros.Response
]:
