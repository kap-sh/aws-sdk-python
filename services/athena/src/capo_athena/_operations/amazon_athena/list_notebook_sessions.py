...
def handle_response(
    ...
    out: capo_athena.types.list_notebook_sessions_response.ListNotebookSessionsResponse = capo_athena.types.list_notebook_sessions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.list_notebook_sessions_request.serialize_aws_json_1_1(input_)
    ).encode()
