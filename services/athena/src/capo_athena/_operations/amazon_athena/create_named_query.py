"""Generated from Smithy shape ``com.amazonaws.athena#CreateNamedQuery``."""
...
def handle_response(
    ...
    out: capo_athena.types.create_named_query_output.CreateNamedQueryOutput = (
        capo_athena.types.create_named_query_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.create_named_query_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_named_query(
    ...
    capo_athena.types.create_named_query_output.CreateNamedQueryOutput, zapros.Response
]:
...
async def async_create_named_query(
