"""Generated from Smithy shape ``com.amazonaws.athena#StartSession``."""
...
import capo_athena.errors.resource_not_found_exception
import capo_athena.errors.session_already_exists_exception
import capo_athena.errors.too_many_requests_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_athena.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
        case "SessionAlreadyExistsException":
            raise capo_athena.errors.session_already_exists_exception.SessionAlreadyExistsException.from_aws_json_1_1(
                data
            )
        case "TooManyRequestsException":
            raise capo_athena.errors.too_many_requests_exception.TooManyRequestsException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_athena.types.start_session_response.StartSessionResponse = (
        capo_athena.types.start_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.StartSession"
    body: bytes | None = json.dumps(
        capo_athena.types.start_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_session(
    ...
    capo_athena.types.start_session_response.StartSessionResponse, zapros.Response
]:
