"""Generated from Smithy shape ``com.amazonaws.athena#UpdatePreparedStatement``."""
...
def handle_response(
    ...
    out: capo_athena.types.update_prepared_statement_output.UpdatePreparedStatementOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.UpdatePreparedStatement"
    body: bytes | None = json.dumps(
        capo_athena.types.update_prepared_statement_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_prepared_statement(
