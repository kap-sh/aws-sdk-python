"""Generated from Smithy shape ``com.amazonaws.athena#GetQueryRuntimeStatistics``."""
...
def handle_response(
    ...
    out: capo_athena.types.get_query_runtime_statistics_output.GetQueryRuntimeStatisticsOutput = capo_athena.types.get_query_runtime_statistics_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetQueryRuntimeStatistics"
    body: bytes | None = json.dumps(
        capo_athena.types.get_query_runtime_statistics_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_query_runtime_statistics(
