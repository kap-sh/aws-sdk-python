...
def handle_response(
    ...
    out: capo_athena.types.get_work_group_output.GetWorkGroupOutput = (
        capo_athena.types.get_work_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.get_work_group_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_work_group(
    ...
    input_: capo_athena.types.get_work_group_input.GetWorkGroupInput,
) -> tuple[capo_athena.types.get_work_group_output.GetWorkGroupOutput, zapros.Response]:
