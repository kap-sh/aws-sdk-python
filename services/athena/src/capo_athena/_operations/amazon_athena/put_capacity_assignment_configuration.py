"""Generated from Smithy shape ``com.amazonaws.athena#PutCapacityAssignmentConfiguration``."""
...
def handle_response(
    ...
    out: capo_athena.types.put_capacity_assignment_configuration_output.PutCapacityAssignmentConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.PutCapacityAssignmentConfiguration"
    body: bytes | None = json.dumps(
        capo_athena.types.put_capacity_assignment_configuration_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_capacity_assignment_configuration(
