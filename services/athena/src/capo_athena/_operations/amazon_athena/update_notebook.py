...
def handle_response(
    ...
    out: capo_athena.types.update_notebook_output.UpdateNotebookOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.update_notebook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_notebook(
    ...
    capo_athena.types.update_notebook_output.UpdateNotebookOutput, zapros.Response
]:
