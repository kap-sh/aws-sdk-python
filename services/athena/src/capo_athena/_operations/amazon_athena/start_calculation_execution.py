"""Generated from Smithy shape ``com.amazonaws.athena#StartCalculationExecution``."""
...
def handle_response(
    ...
    out: capo_athena.types.start_calculation_execution_response.StartCalculationExecutionResponse = capo_athena.types.start_calculation_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.StartCalculationExecution"
    body: bytes | None = json.dumps(
        capo_athena.types.start_calculation_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_calculation_execution(
