"""Generated from Smithy shape ``com.amazonaws.athena#DeletePreparedStatement``."""
...
def handle_response(
    ...
    out: capo_athena.types.delete_prepared_statement_output.DeletePreparedStatementOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.DeletePreparedStatement"
    body: bytes | None = json.dumps(
        capo_athena.types.delete_prepared_statement_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_prepared_statement(
