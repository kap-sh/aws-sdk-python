...
import capo_athena.errors.metadata_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MetadataException":
            raise capo_athena.errors.metadata_exception.MetadataException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_athena.types.get_database_output.GetDatabaseOutput = (
        capo_athena.types.get_database_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.get_database_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_database(
    ...
    input_: capo_athena.types.get_database_input.GetDatabaseInput,
) -> tuple[capo_athena.types.get_database_output.GetDatabaseOutput, zapros.Response]:
