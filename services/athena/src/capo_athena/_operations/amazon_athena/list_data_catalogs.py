"""Generated from Smithy shape ``com.amazonaws.athena#ListDataCatalogs``."""
...
def handle_response(
    ...
    out: capo_athena.types.list_data_catalogs_output.ListDataCatalogsOutput = (
        capo_athena.types.list_data_catalogs_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ListDataCatalogs"
    body: bytes | None = json.dumps(
        capo_athena.types.list_data_catalogs_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_data_catalogs(
    ...
    capo_athena.types.list_data_catalogs_output.ListDataCatalogsOutput, zapros.Response
]:
...
async def async_list_data_catalogs(
