"""Generated from Smithy shape ``com.amazonaws.athena#StartQueryExecution``."""
...
def handle_response(
    ...
    out: capo_athena.types.start_query_execution_output.StartQueryExecutionOutput = (
        capo_athena.types.start_query_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.start_query_execution_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_start_query_execution(
