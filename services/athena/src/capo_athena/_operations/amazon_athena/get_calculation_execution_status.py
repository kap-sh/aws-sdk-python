...
def handle_response(
    ...
    out: capo_athena.types.get_calculation_execution_status_response.GetCalculationExecutionStatusResponse = capo_athena.types.get_calculation_execution_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.get_calculation_execution_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
