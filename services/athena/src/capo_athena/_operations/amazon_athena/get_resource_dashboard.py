"""Generated from Smithy shape ``com.amazonaws.athena#GetResourceDashboard``."""
...
def handle_response(
    ...
    out: capo_athena.types.get_resource_dashboard_response.GetResourceDashboardResponse = capo_athena.types.get_resource_dashboard_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetResourceDashboard"
    body: bytes | None = json.dumps(
        capo_athena.types.get_resource_dashboard_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_resource_dashboard(
