...
def handle_response(
    ...
    out: capo_athena.types.delete_capacity_reservation_output.DeleteCapacityReservationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.delete_capacity_reservation_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
