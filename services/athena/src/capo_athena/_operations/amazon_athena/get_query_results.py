"""Generated from Smithy shape ``com.amazonaws.athena#GetQueryResults``."""
...
def handle_response(
    ...
    out: capo_athena.types.get_query_results_output.GetQueryResultsOutput = (
        capo_athena.types.get_query_results_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.get_query_results_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_query_results(
    ...
    capo_athena.types.get_query_results_output.GetQueryResultsOutput, zapros.Response
]:
