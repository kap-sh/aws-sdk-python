"""Generated from Smithy shape ``com.amazonaws.athena#CreatePreparedStatement``."""
...
def handle_response(
    ...
    out: capo_athena.types.create_prepared_statement_output.CreatePreparedStatementOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.CreatePreparedStatement"
    body: bytes | None = json.dumps(
        capo_athena.types.create_prepared_statement_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_prepared_statement(
