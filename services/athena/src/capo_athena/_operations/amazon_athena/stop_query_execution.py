...
def handle_response(
    ...
    out: capo_athena.types.stop_query_execution_output.StopQueryExecutionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.stop_query_execution_input.serialize_aws_json_1_1(input_)
    ).encode()
