"""Generated from Smithy shape ``com.amazonaws.athena#CreatePresignedNotebookUrl``."""
...
def handle_response(
    ...
    out: capo_athena.types.create_presigned_notebook_url_response.CreatePresignedNotebookUrlResponse = capo_athena.types.create_presigned_notebook_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.CreatePresignedNotebookUrl"
    body: bytes | None = json.dumps(
        capo_athena.types.create_presigned_notebook_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_presigned_notebook_url(
