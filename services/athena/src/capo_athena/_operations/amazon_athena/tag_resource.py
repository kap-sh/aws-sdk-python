"""Generated from Smithy shape ``com.amazonaws.athena#TagResource``."""
...
def handle_response(
    ...
    out: capo_athena.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.tag_resource_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: capo_athena.types.tag_resource_input.TagResourceInput,
) -> tuple[capo_athena.types.tag_resource_output.TagResourceOutput, zapros.Response]:
