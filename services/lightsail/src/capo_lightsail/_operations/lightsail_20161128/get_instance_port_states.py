"""Generated from Smithy shape ``com.amazonaws.lightsail#GetInstancePortStates``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_instance_port_states_result.GetInstancePortStatesResult = capo_lightsail.types.get_instance_port_states_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetInstancePortStates"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetInstancePortStates"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_instance_port_states_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_instance_port_states(
