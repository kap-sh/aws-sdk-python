"""Generated from Smithy shape ``com.amazonaws.lightsail#DeleteRelationalDatabaseSnapshot``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.delete_relational_database_snapshot_result.DeleteRelationalDatabaseSnapshotResult = capo_lightsail.types.delete_relational_database_snapshot_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/ls/api/2016-11-28/DeleteRelationalDatabaseSnapshot"
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.DeleteRelationalDatabaseSnapshot"
    body: bytes | None = json.dumps(
        capo_lightsail.types.delete_relational_database_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_relational_database_snapshot(
