"""Generated from Smithy shape ``com.amazonaws.lightsail#TagResource``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.tag_resource_result.TagResourceResult = (
        capo_lightsail.types.tag_resource_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/TagResource"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.TagResource"
    body: bytes | None = json.dumps(
        capo_lightsail.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: capo_lightsail.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_lightsail.types.tag_resource_result.TagResourceResult, zapros.Response]:
