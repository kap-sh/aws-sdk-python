"""Generated from Smithy shape ``com.amazonaws.lightsail#GetRegions``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_regions_result.GetRegionsResult = (
        capo_lightsail.types.get_regions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetRegions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetRegions"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_regions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_regions(
    ...
    input_: capo_lightsail.types.get_regions_request.GetRegionsRequest,
) -> tuple[capo_lightsail.types.get_regions_result.GetRegionsResult, zapros.Response]:
