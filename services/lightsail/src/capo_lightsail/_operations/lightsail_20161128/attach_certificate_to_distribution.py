"""Generated from Smithy shape ``com.amazonaws.lightsail#AttachCertificateToDistribution``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.attach_certificate_to_distribution_result.AttachCertificateToDistributionResult = capo_lightsail.types.attach_certificate_to_distribution_result.deserialize_aws_json_1_1(
...
async def async_attach_certificate_to_distribution(
