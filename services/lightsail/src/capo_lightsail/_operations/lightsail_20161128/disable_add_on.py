"""Generated from Smithy shape ``com.amazonaws.lightsail#DisableAddOn``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.disable_add_on_result.DisableAddOnResult = (
        capo_lightsail.types.disable_add_on_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/DisableAddOn"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.DisableAddOn"
    body: bytes | None = json.dumps(
        capo_lightsail.types.disable_add_on_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def disable_add_on(
    ...
    capo_lightsail.types.disable_add_on_result.DisableAddOnResult, zapros.Response
]:
...
async def async_disable_add_on(
