"""Generated from Smithy shape ``com.amazonaws.lightsail#UnpeerVpc``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.unpeer_vpc_result.UnpeerVpcResult = (
        capo_lightsail.types.unpeer_vpc_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/UnpeerVpc"
    params: dict[str, str] = {}
...
def unpeer_vpc(
    ...
    input_: capo_lightsail.types.unpeer_vpc_request.UnpeerVpcRequest,
) -> tuple[capo_lightsail.types.unpeer_vpc_result.UnpeerVpcResult, zapros.Response]:
