"""Generated from Smithy shape ``com.amazonaws.lightsail#GetOperation``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_operation_result.GetOperationResult = (
        capo_lightsail.types.get_operation_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetOperation"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetOperation"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_operation_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_operation(
    ...
    capo_lightsail.types.get_operation_result.GetOperationResult, zapros.Response
]:
