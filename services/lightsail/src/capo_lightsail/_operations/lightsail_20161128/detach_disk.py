"""Generated from Smithy shape ``com.amazonaws.lightsail#DetachDisk``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.detach_disk_result.DetachDiskResult = (
        capo_lightsail.types.detach_disk_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/DetachDisk"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.DetachDisk"
    body: bytes | None = json.dumps(
        capo_lightsail.types.detach_disk_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def detach_disk(
    ...
    input_: capo_lightsail.types.detach_disk_request.DetachDiskRequest,
) -> tuple[capo_lightsail.types.detach_disk_result.DetachDiskResult, zapros.Response]:
