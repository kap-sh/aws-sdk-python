"""Generated from Smithy shape ``com.amazonaws.lightsail#UpdateLoadBalancerAttribute``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.update_load_balancer_attribute_result.UpdateLoadBalancerAttributeResult = capo_lightsail.types.update_load_balancer_attribute_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/UpdateLoadBalancerAttribute"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.UpdateLoadBalancerAttribute"
    body: bytes | None = json.dumps(
        capo_lightsail.types.update_load_balancer_attribute_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_load_balancer_attribute(
