"""Generated from Smithy shape ``com.amazonaws.lightsail#GetContainerAPIMetadata``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_container_api_metadata_result.GetContainerAPIMetadataResult = capo_lightsail.types.get_container_api_metadata_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/container-api-metadata"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetContainerAPIMetadata"
    body: bytes | None = b""
...
async def async_get_container_api_metadata(
