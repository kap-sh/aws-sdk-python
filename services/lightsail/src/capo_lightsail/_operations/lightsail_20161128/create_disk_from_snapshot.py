"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateDiskFromSnapshot``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.create_disk_from_snapshot_result.CreateDiskFromSnapshotResult = capo_lightsail.types.create_disk_from_snapshot_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/CreateDiskFromSnapshot"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateDiskFromSnapshot"
    body: bytes | None = json.dumps(
        capo_lightsail.types.create_disk_from_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_disk_from_snapshot(
