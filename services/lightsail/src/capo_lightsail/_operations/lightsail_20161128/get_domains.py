"""Generated from Smithy shape ``com.amazonaws.lightsail#GetDomains``."""
...
import capo_lightsail.types.domain_list
...
def handle_response(
    ...
    out: capo_lightsail.types.get_domains_result.GetDomainsResult = (
        capo_lightsail.types.get_domains_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetDomains"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetDomains"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_domains_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_domains(
    ...
    input_: capo_lightsail.types.get_domains_request.GetDomainsRequest,
) -> tuple[capo_lightsail.types.get_domains_result.GetDomainsResult, zapros.Response]:
