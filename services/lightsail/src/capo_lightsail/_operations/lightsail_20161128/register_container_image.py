"""Generated from Smithy shape ``com.amazonaws.lightsail#RegisterContainerImage``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.register_container_image_result.RegisterContainerImageResult = capo_lightsail.types.register_container_image_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Lightsail_20161128.RegisterContainerImage"
    body: bytes | None = json.dumps(
        capo_lightsail.types.register_container_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_container_image(
