...
def handle_response(
    ...
    out: capo_lightsail.types.get_container_service_metric_data_result.GetContainerServiceMetricDataResult = capo_lightsail.types.get_container_service_metric_data_result.deserialize_aws_json_1_1(
