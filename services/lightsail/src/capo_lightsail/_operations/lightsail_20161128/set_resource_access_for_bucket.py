"""Generated from Smithy shape ``com.amazonaws.lightsail#SetResourceAccessForBucket``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.set_resource_access_for_bucket_result.SetResourceAccessForBucketResult = capo_lightsail.types.set_resource_access_for_bucket_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/SetResourceAccessForBucket"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.SetResourceAccessForBucket"
    body: bytes | None = json.dumps(
        capo_lightsail.types.set_resource_access_for_bucket_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_set_resource_access_for_bucket(
