"""Generated from Smithy shape ``com.amazonaws.lightsail#DeleteLoadBalancerTlsCertificate``."""
...
import capo_lightsail.errors.account_setup_in_progress_exception
import capo_lightsail.errors.invalid_input_exception
import capo_lightsail.errors.not_found_exception
import capo_lightsail.errors.operation_failure_exception
import capo_lightsail.errors.region_setup_in_progress_exception
import capo_lightsail.errors.service_exception
import capo_lightsail.errors.unauthenticated_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccountSetupInProgressException":
            raise capo_lightsail.errors.account_setup_in_progress_exception.AccountSetupInProgressException.from_aws_json_1_1(
                data
            )
        ...
        case "RegionSetupInProgressException":
            raise capo_lightsail.errors.region_setup_in_progress_exception.RegionSetupInProgressException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_lightsail.types.delete_load_balancer_tls_certificate_result.DeleteLoadBalancerTlsCertificateResult = capo_lightsail.types.delete_load_balancer_tls_certificate_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/ls/api/2016-11-28/DeleteLoadBalancerTlsCertificate"
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.DeleteLoadBalancerTlsCertificate"
    body: bytes | None = json.dumps(
        capo_lightsail.types.delete_load_balancer_tls_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_load_balancer_tls_certificate(
