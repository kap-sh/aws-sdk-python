"""Generated from Smithy shape ``com.amazonaws.lightsail#AttachDisk``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.attach_disk_result.AttachDiskResult = (
        capo_lightsail.types.attach_disk_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/AttachDisk"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.AttachDisk"
    body: bytes | None = json.dumps(
        capo_lightsail.types.attach_disk_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def attach_disk(
    ...
    input_: capo_lightsail.types.attach_disk_request.AttachDiskRequest,
) -> tuple[capo_lightsail.types.attach_disk_result.AttachDiskResult, zapros.Response]:
