"""Generated from Smithy shape ``com.amazonaws.lightsail#DeleteLoadBalancer``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.delete_load_balancer_result.DeleteLoadBalancerResult = (
        capo_lightsail.types.delete_load_balancer_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/DeleteLoadBalancer"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.DeleteLoadBalancer"
    body: bytes | None = json.dumps(
        capo_lightsail.types.delete_load_balancer_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_load_balancer(
