"""Generated from Smithy shape ``com.amazonaws.lightsail#DeleteContainerImage``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.delete_container_image_result.DeleteContainerImageResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{image}", quote(str(input_["image"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.DeleteContainerImage"
    body: bytes | None = b""
...
async def async_delete_container_image(
