"""Generated from Smithy shape ``com.amazonaws.lightsail#GetActiveNames``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_active_names_result.GetActiveNamesResult = (
        capo_lightsail.types.get_active_names_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetActiveNames"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetActiveNames"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_active_names_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_active_names(
    ...
    capo_lightsail.types.get_active_names_result.GetActiveNamesResult, zapros.Response
]:
...
async def async_get_active_names(
