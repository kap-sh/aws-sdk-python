"""Generated from Smithy shape ``com.amazonaws.lightsail#GetStaticIps``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_static_ips_result.GetStaticIpsResult = (
        capo_lightsail.types.get_static_ips_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetStaticIps"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetStaticIps"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_static_ips_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_static_ips(
    ...
    capo_lightsail.types.get_static_ips_result.GetStaticIpsResult, zapros.Response
]:
...
async def async_get_static_ips(
