"""Generated from Smithy shape ``com.amazonaws.lightsail#GetRelationalDatabaseLogStreams``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_relational_database_log_streams_result.GetRelationalDatabaseLogStreamsResult = capo_lightsail.types.get_relational_database_log_streams_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetRelationalDatabaseLogStreams"
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetRelationalDatabaseLogStreams"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_relational_database_log_streams_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_relational_database_log_streams(
