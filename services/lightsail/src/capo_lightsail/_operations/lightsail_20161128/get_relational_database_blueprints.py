"""Generated from Smithy shape ``com.amazonaws.lightsail#GetRelationalDatabaseBlueprints``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_relational_database_blueprints_result.GetRelationalDatabaseBlueprintsResult = capo_lightsail.types.get_relational_database_blueprints_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetRelationalDatabaseBlueprints"
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetRelationalDatabaseBlueprints"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_relational_database_blueprints_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_relational_database_blueprints(
