"""Generated from Smithy shape ``com.amazonaws.lightsail#GetKeyPairs``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_key_pairs_result.GetKeyPairsResult = (
        capo_lightsail.types.get_key_pairs_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetKeyPairs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetKeyPairs"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_key_pairs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_key_pairs(
    ...
    capo_lightsail.types.get_key_pairs_result.GetKeyPairsResult, zapros.Response
]:
