...
def handle_response(
    ...
    out: capo_lightsail.types.get_distribution_latest_cache_reset_result.GetDistributionLatestCacheResetResult = capo_lightsail.types.get_distribution_latest_cache_reset_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_distribution_latest_cache_reset_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
