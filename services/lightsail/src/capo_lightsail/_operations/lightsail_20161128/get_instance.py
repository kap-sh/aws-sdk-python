"""Generated from Smithy shape ``com.amazonaws.lightsail#GetInstance``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_instance_result.GetInstanceResult = (
        capo_lightsail.types.get_instance_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetInstance"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetInstance"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_instance_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_instance(
    ...
    input_: capo_lightsail.types.get_instance_request.GetInstanceRequest,
) -> tuple[capo_lightsail.types.get_instance_result.GetInstanceResult, zapros.Response]:
