"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateDomain``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.create_domain_result.CreateDomainResult = (
        capo_lightsail.types.create_domain_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/CreateDomain"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateDomain"
    body: bytes | None = json.dumps(
        capo_lightsail.types.create_domain_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_domain(
    ...
    capo_lightsail.types.create_domain_result.CreateDomainResult, zapros.Response
]:
