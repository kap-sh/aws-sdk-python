...
def handle_response(
    ...
    out: capo_lightsail.types.delete_domain_result.DeleteDomainResult = (
        capo_lightsail.types.delete_domain_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.delete_domain_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_domain(
    ...
    capo_lightsail.types.delete_domain_result.DeleteDomainResult, zapros.Response
]:
