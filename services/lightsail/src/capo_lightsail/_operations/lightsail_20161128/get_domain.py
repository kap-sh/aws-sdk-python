"""Generated from Smithy shape ``com.amazonaws.lightsail#GetDomain``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_domain_result.GetDomainResult = (
        capo_lightsail.types.get_domain_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetDomain"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetDomain"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_domain_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_domain(
    ...
    input_: capo_lightsail.types.get_domain_request.GetDomainRequest,
) -> tuple[capo_lightsail.types.get_domain_result.GetDomainResult, zapros.Response]:
