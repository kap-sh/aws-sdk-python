"""Generated from Smithy shape ``com.amazonaws.lightsail#PutInstancePublicPorts``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.put_instance_public_ports_result.PutInstancePublicPortsResult = capo_lightsail.types.put_instance_public_ports_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/PutInstancePublicPorts"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.PutInstancePublicPorts"
    body: bytes | None = json.dumps(
        capo_lightsail.types.put_instance_public_ports_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_instance_public_ports(
