"""Generated from Smithy shape ``com.amazonaws.lightsail#StartInstance``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.start_instance_result.StartInstanceResult = (
        capo_lightsail.types.start_instance_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/StartInstance"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.StartInstance"
    body: bytes | None = json.dumps(
        capo_lightsail.types.start_instance_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_instance(
    ...
    capo_lightsail.types.start_instance_result.StartInstanceResult, zapros.Response
]:
...
async def async_start_instance(
