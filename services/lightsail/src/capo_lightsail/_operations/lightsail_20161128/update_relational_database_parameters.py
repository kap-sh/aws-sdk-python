"""Generated from Smithy shape ``com.amazonaws.lightsail#UpdateRelationalDatabaseParameters``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.update_relational_database_parameters_result.UpdateRelationalDatabaseParametersResult = capo_lightsail.types.update_relational_database_parameters_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Lightsail_20161128.UpdateRelationalDatabaseParameters"
    body: bytes | None = json.dumps(
        capo_lightsail.types.update_relational_database_parameters_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_relational_database_parameters(
