"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateGUISessionAccessDetails``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.create_gui_session_access_details_result.CreateGUISessionAccessDetailsResult = capo_lightsail.types.create_gui_session_access_details_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateGUISessionAccessDetails"
    body: bytes | None = json.dumps(
        capo_lightsail.types.create_gui_session_access_details_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_gui_session_access_details(
