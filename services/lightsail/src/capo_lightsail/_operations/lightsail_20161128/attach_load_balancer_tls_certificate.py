"""Generated from Smithy shape ``com.amazonaws.lightsail#AttachLoadBalancerTlsCertificate``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.attach_load_balancer_tls_certificate_result.AttachLoadBalancerTlsCertificateResult = capo_lightsail.types.attach_load_balancer_tls_certificate_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/ls/api/2016-11-28/AttachLoadBalancerTlsCertificate"
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.AttachLoadBalancerTlsCertificate"
    body: bytes | None = json.dumps(
        capo_lightsail.types.attach_load_balancer_tls_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_attach_load_balancer_tls_certificate(
