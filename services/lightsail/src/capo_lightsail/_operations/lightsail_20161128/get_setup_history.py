"""Generated from Smithy shape ``com.amazonaws.lightsail#GetSetupHistory``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_setup_history_result.GetSetupHistoryResult = (
        capo_lightsail.types.get_setup_history_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/get-setup-history"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetSetupHistory"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_setup_history_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_setup_history(
    ...
    capo_lightsail.types.get_setup_history_result.GetSetupHistoryResult, zapros.Response
]:
...
async def async_get_setup_history(
