"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateInstances``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.create_instances_result.CreateInstancesResult = (
        capo_lightsail.types.create_instances_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/CreateInstances"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateInstances"
    body: bytes | None = json.dumps(
        capo_lightsail.types.create_instances_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_instances(
    ...
    capo_lightsail.types.create_instances_result.CreateInstancesResult, zapros.Response
]:
...
async def async_create_instances(
