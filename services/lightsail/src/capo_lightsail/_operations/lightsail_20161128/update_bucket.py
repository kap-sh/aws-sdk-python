"""Generated from Smithy shape ``com.amazonaws.lightsail#UpdateBucket``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.update_bucket_result.UpdateBucketResult = (
        capo_lightsail.types.update_bucket_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/UpdateBucket"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.UpdateBucket"
    body: bytes | None = json.dumps(
        capo_lightsail.types.update_bucket_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_bucket(
    ...
    capo_lightsail.types.update_bucket_result.UpdateBucketResult, zapros.Response
]:
