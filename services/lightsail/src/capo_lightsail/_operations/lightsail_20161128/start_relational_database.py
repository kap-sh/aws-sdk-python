"""Generated from Smithy shape ``com.amazonaws.lightsail#StartRelationalDatabase``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.start_relational_database_result.StartRelationalDatabaseResult = capo_lightsail.types.start_relational_database_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/StartRelationalDatabase"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.StartRelationalDatabase"
    body: bytes | None = json.dumps(
        capo_lightsail.types.start_relational_database_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_relational_database(
