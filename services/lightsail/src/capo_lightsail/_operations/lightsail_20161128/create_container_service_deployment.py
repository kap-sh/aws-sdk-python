"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateContainerServiceDeployment``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.create_container_service_deployment_result.CreateContainerServiceDeploymentResult = capo_lightsail.types.create_container_service_deployment_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateContainerServiceDeployment"
    body: bytes | None = json.dumps(
        capo_lightsail.types.create_container_service_deployment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_container_service_deployment(
