"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateContainerServiceRegistryLogin``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.create_container_service_registry_login_result.CreateContainerServiceRegistryLoginResult = capo_lightsail.types.create_container_service_registry_login_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/container-registry-login"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateContainerServiceRegistryLogin"
    body: bytes | None = b""
...
async def async_create_container_service_registry_login(
