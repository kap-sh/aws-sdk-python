"""Generated from Smithy shape ``com.amazonaws.lightsail#GetStaticIp``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_static_ip_result.GetStaticIpResult = (
        capo_lightsail.types.get_static_ip_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetStaticIp"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetStaticIp"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_static_ip_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_static_ip(
    ...
    capo_lightsail.types.get_static_ip_result.GetStaticIpResult, zapros.Response
]:
