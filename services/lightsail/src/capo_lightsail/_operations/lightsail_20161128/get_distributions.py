"""Generated from Smithy shape ``com.amazonaws.lightsail#GetDistributions``."""
...
import capo_lightsail.types.distribution_list
...
def handle_response(
    ...
    out: capo_lightsail.types.get_distributions_result.GetDistributionsResult = (
        capo_lightsail.types.get_distributions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetDistributions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetDistributions"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_distributions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_distributions(
