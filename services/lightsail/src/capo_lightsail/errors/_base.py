...
class LightsailError(Exception):
    """Base class for all Lightsail service errors."""


class ServiceError(LightsailError):
...
class SerializationError(LightsailError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LightsailError):
...
class WaiterFailedError(LightsailError):
...
class WaiterTimeoutError(LightsailError):
