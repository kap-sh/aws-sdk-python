...
DiskList: TypeAlias = list["capo_lightsail.types.disk.Disk"]
...
def serialize_aws_json_1_1(value: DiskList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_lightsail.types.disk.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> DiskList:
    ...
    out: DiskList = []
    for item in data:
        out.append(capo_lightsail.types.disk.deserialize_aws_json_1_1(item))
    return out
