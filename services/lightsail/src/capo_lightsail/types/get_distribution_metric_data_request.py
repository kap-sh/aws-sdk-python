...
class GetDistributionMetricDataRequest(TypedDict, closed=True):
    ...
    r"""<p>The end of the time interval for which to get metric data.</p> <p>Constraints:</p> <ul> <li> <p>Specified in Coordinated Universal Time (UTC).</p> </li> <li> <p>Specified in the Unix time format.</p> <p>For example, if you wish to use an end time of October 1, 2018, at 9 PM UTC, specify <code>1538427600</code> as the end time.</p> </li> </ul> <p>You can convert a human-friendly time to Unix time format using a converter like <a href=\"https://www.epochconverter.com/\">Epoch converter</a>.</p>"""
...
def serialize_aws_json_1_1(value: GetDistributionMetricDataRequest) -> dict:
    ...
    out["metricName"] = (
        capo_lightsail.types.distribution_metric_name.serialize_aws_json_1_1(
            value["metric_name"]
        )
    )
    import capo_lightsail.types.timestamp

    out["startTime"] = capo_lightsail.types.timestamp.serialize_aws_json_1_1(
        value["start_time"]
    )
    import capo_lightsail.types.timestamp

    out["endTime"] = capo_lightsail.types.timestamp.serialize_aws_json_1_1(
        value["end_time"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> GetDistributionMetricDataRequest:
    ...
    if "metricName" in data:
        ...
        out["metric_name"] = (
            capo_lightsail.types.distribution_metric_name.deserialize_aws_json_1_1(
                data["metricName"]
            )
        )
    else:
