"""Generated from Smithy shape ``com.amazonaws.lightsail#GetRelationalDatabaseBlueprintsRequest``."""
...
class GetRelationalDatabaseBlueprintsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetRelationalDatabaseBlueprintsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetRelationalDatabaseBlueprintsRequest:
    out: GetRelationalDatabaseBlueprintsRequest = {}  # type: ignore[typeddict-item]
