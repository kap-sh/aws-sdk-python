...
class HostKeyAttributes(TypedDict, closed=True):
    algorithm: NotRequired["capo_lightsail.types.string.string"]
    ...
    public_key: NotRequired["capo_lightsail.types.string.string"]
    """<p>The public SSH host key or the RDP certificate.</p>"""
    witnessed_at: NotRequired["capo_lightsail.types.iso_date.IsoDate"]
    """<p>The time that the SSH host key or RDP certificate was recorded by Lightsail.</p>"""
    fingerprint_sha1: NotRequired["capo_lightsail.types.string.string"]
    ...
    fingerprint_sha256: NotRequired["capo_lightsail.types.string.string"]
    ...
    not_valid_before: NotRequired["capo_lightsail.types.iso_date.IsoDate"]
    """<p>The returned RDP certificate is valid after this point in time.</p> <p>This value is listed only for RDP certificates.</p>"""
    not_valid_after: NotRequired["capo_lightsail.types.iso_date.IsoDate"]
...
def serialize_aws_json_1_1(value: HostKeyAttributes) -> dict:
    ...
    if "witnessed_at" in value:
        ...
        out["witnessedAt"] = capo_lightsail.types.iso_date.serialize_aws_json_1_1(
            value["witnessed_at"]
        )
    ...
    if "not_valid_before" in value:
        ...
        out["notValidBefore"] = capo_lightsail.types.iso_date.serialize_aws_json_1_1(
            value["not_valid_before"]
        )
    if "not_valid_after" in value:
        import capo_lightsail.types.iso_date

        out["notValidAfter"] = capo_lightsail.types.iso_date.serialize_aws_json_1_1(
