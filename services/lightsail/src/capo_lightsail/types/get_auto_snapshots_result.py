...
class GetAutoSnapshotsResult(TypedDict, closed=True):
    ...
    auto_snapshots: NotRequired[
        "capo_lightsail.types.auto_snapshot_details_list.AutoSnapshotDetailsList"
    ]
...
def serialize_aws_json_1_1(value: GetAutoSnapshotsResult) -> dict:
    ...
    if "auto_snapshots" in value:
        ...
        out["autoSnapshots"] = (
            capo_lightsail.types.auto_snapshot_details_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetAutoSnapshotsResult:
    ...
    if "autoSnapshots" in data:
        ...
        out["auto_snapshots"] = (
            capo_lightsail.types.auto_snapshot_details_list.deserialize_aws_json_1_1(
                data["autoSnapshots"]
            )
        )
    return out
