...
class ContainerServiceHealthCheckConfig(TypedDict, closed=True):
    healthy_threshold: NotRequired["capo_lightsail.types.integer.integer"]
    ...
    unhealthy_threshold: NotRequired["capo_lightsail.types.integer.integer"]
    ...
    timeout_seconds: NotRequired["capo_lightsail.types.integer.integer"]
    ...
    interval_seconds: NotRequired["capo_lightsail.types.integer.integer"]
    ...
    success_codes: NotRequired["capo_lightsail.types.string.string"]
