"""Generated from Smithy shape ``com.amazonaws.lightsail#DeleteKeyPairResult``."""
...
class DeleteKeyPairResult(TypedDict, closed=True):
    operation: NotRequired["capo_lightsail.types.operation.Operation"]
    """<p>An array of objects that describe the result of the action, such as the status of the request, the timestamp of the request, and the resources affected by the request.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteKeyPairResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteKeyPairResult:
