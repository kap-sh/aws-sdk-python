...
class Bucket(TypedDict, closed=True):
    ...
    r"""<p>The tag keys and optional values for the bucket. For more information, see <a href=\"https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-tags\">Tags in Amazon Lightsail</a> in the <i>Amazon Lightsail Developer Guide</i>.</p>"""
    ...
    r"""<p>An array of objects that describe Lightsail instances that have access to the bucket.</p> <p>Use the <a href=\"https://docs.aws.amazon.com/lightsail/2016-11-28/api-reference/API_SetResourceAccessForBucket.html\">SetResourceAccessForBucket</a> action to update the instances that have access to a bucket.</p>"""
    ...
    r"""<p>An array of cross-origin resource sharing (CORS) rules that identify origins and the HTTP methods that can be executed on your bucket. This field is only included in the response when CORS configuration is requested or when updating CORS configuration. For more information, see <a href=\"https://docs.aws.amazon.com/lightsail/latest/userguide/configure-cors.html\">Configuring cross-origin resource sharing (CORS)</a>.</p>"""
