"""Generated from Smithy shape ``com.amazonaws.lightsail#GetDiskSnapshotsRequest``."""
...
class GetDiskSnapshotsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetDiskSnapshotsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetDiskSnapshotsRequest:
    out: GetDiskSnapshotsRequest = {}  # type: ignore[typeddict-item]
