...
class LoadBalancerTlsCertificateDnsRecordCreationState(TypedDict, closed=True):
    code: NotRequired[
        "capo_lightsail.types.load_balancer_tls_certificate_dns_record_creation_state_code.LoadBalancerTlsCertificateDnsRecordCreationStateCode"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "code" in value:
        ...
        out["code"] = (
            capo_lightsail.types.load_balancer_tls_certificate_dns_record_creation_state_code.serialize_aws_json_1_1(
                value["code"]
            )
        )
    if "message" in value:
...
def deserialize_aws_json_1_1(
    ...
    if "code" in data:
        ...
        out["code"] = (
            capo_lightsail.types.load_balancer_tls_certificate_dns_record_creation_state_code.deserialize_aws_json_1_1(
                data["code"]
            )
        )
    if "message" in data:
