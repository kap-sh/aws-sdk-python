"""Generated from Smithy shape ``com.amazonaws.lightsail#InstancePortInfo``."""
...
class InstancePortInfo(TypedDict, closed=True):
    ...
    access_from: NotRequired["capo_lightsail.types.string.string"]
    ...
    access_type: NotRequired["capo_lightsail.types.port_access_type.PortAccessType"]
    """<p>The type of access (<code>Public</code> or <code>Private</code>).</p>"""
    common_name: NotRequired["capo_lightsail.types.string.string"]
    """<p>The common name of the port information.</p>"""
    access_direction: NotRequired[
        "capo_lightsail.types.access_direction.AccessDirection"
    ]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: InstancePortInfo) -> dict:
    out: dict = {}
    ...
    if "access_from" in value:
        out["accessFrom"] = value["access_from"]
    if "access_type" in value:
        import capo_lightsail.types.port_access_type

        out["accessType"] = (
            capo_lightsail.types.port_access_type.serialize_aws_json_1_1(
                value["access_type"]
            )
        )
    if "common_name" in value:
        out["commonName"] = value["common_name"]
    if "access_direction" in value:
        import capo_lightsail.types.access_direction

        out["accessDirection"] = (
            capo_lightsail.types.access_direction.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InstancePortInfo:
    ...
    if "accessType" in data:
        ...
        out["access_type"] = (
            capo_lightsail.types.port_access_type.deserialize_aws_json_1_1(
                data["accessType"]
            )
        )
    ...
    if "accessDirection" in data:
        ...
        out["access_direction"] = (
            capo_lightsail.types.access_direction.deserialize_aws_json_1_1(
