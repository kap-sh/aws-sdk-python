...
class LoadBalancerTlsCertificateDomainValidationRecord(TypedDict, closed=True):
    ...
    type: NotRequired["capo_lightsail.types.non_empty_string.NonEmptyString"]
    """<p>The type of validation record. For example, <code>CNAME</code> for domain validation.</p>"""
    value: NotRequired["capo_lightsail.types.non_empty_string.NonEmptyString"]
    """<p>The value for that type.</p>"""
    validation_status: NotRequired[
        "capo_lightsail.types.load_balancer_tls_certificate_domain_status.LoadBalancerTlsCertificateDomainStatus"
    ]
    ...
    dns_record_creation_state: NotRequired[
        "capo_lightsail.types.load_balancer_tls_certificate_dns_record_creation_state.LoadBalancerTlsCertificateDnsRecordCreationState"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "validation_status" in value:
        ...
        out["validationStatus"] = (
            capo_lightsail.types.load_balancer_tls_certificate_domain_status.serialize_aws_json_1_1(
    ...
    if "dns_record_creation_state" in value:
        ...
        out["dnsRecordCreationState"] = (
            capo_lightsail.types.load_balancer_tls_certificate_dns_record_creation_state.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "validationStatus" in data:
        ...
        out["validation_status"] = (
            capo_lightsail.types.load_balancer_tls_certificate_domain_status.deserialize_aws_json_1_1(
    ...
    if "dnsRecordCreationState" in data:
        ...
        out["dns_record_creation_state"] = (
            capo_lightsail.types.load_balancer_tls_certificate_dns_record_creation_state.deserialize_aws_json_1_1(
