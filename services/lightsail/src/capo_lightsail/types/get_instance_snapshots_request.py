"""Generated from Smithy shape ``com.amazonaws.lightsail#GetInstanceSnapshotsRequest``."""
...
class GetInstanceSnapshotsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetInstanceSnapshotsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetInstanceSnapshotsRequest:
    out: GetInstanceSnapshotsRequest = {}  # type: ignore[typeddict-item]
