...
ContainerServicePublicDomains: TypeAlias = dict[
    ...
    "capo_lightsail.types.container_service_public_domains_list.ContainerServicePublicDomainsList",
]
...
def serialize_aws_json_1_1(input_to_serialize: ContainerServicePublicDomains) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            capo_lightsail.types.container_service_public_domains_list.serialize_aws_json_1_1(
                value
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ContainerServicePublicDomains:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            capo_lightsail.types.container_service_public_domains_list.deserialize_aws_json_1_1(
                value
            )
        )
    return out
