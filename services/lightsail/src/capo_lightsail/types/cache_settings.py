...
class CacheSettings(TypedDict, closed=True):
    default_ttl: NotRequired["capo_lightsail.types.long.long"]
    ...
    minimum_ttl: NotRequired["capo_lightsail.types.long.long"]
    ...
    maximum_ttl: NotRequired["capo_lightsail.types.long.long"]
    ...
    forwarded_cookies: NotRequired["capo_lightsail.types.cookie_object.CookieObject"]
    ...
    forwarded_headers: NotRequired["capo_lightsail.types.header_object.HeaderObject"]
    ...
    forwarded_query_strings: NotRequired[
        "capo_lightsail.types.query_string_object.QueryStringObject"
    ]
...
def serialize_aws_json_1_1(value: CacheSettings) -> dict:
    ...
    if "forwarded_cookies" in value:
        ...
        out["forwardedCookies"] = (
            capo_lightsail.types.cookie_object.serialize_aws_json_1_1(
    ...
    if "forwarded_headers" in value:
        ...
        out["forwardedHeaders"] = (
            capo_lightsail.types.header_object.serialize_aws_json_1_1(
    ...
    if "forwarded_query_strings" in value:
        ...
        out["forwardedQueryStrings"] = (
            capo_lightsail.types.query_string_object.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CacheSettings:
    ...
    if "forwardedCookies" in data:
        ...
        out["forwarded_cookies"] = (
            capo_lightsail.types.cookie_object.deserialize_aws_json_1_1(
    ...
    if "forwardedHeaders" in data:
        ...
        out["forwarded_headers"] = (
            capo_lightsail.types.header_object.deserialize_aws_json_1_1(
    ...
    if "forwardedQueryStrings" in data:
        ...
        out["forwarded_query_strings"] = (
            capo_lightsail.types.query_string_object.deserialize_aws_json_1_1(
