...
class GetContainerLogResult(TypedDict, closed=True):
    log_events: NotRequired[
        "capo_lightsail.types.container_service_log_event_list.ContainerServiceLogEventList"
    ]
...
def serialize_aws_json_1_1(value: GetContainerLogResult) -> dict:
    ...
    if "log_events" in value:
        ...
        out["logEvents"] = (
            capo_lightsail.types.container_service_log_event_list.serialize_aws_json_1_1(
                value["log_events"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetContainerLogResult:
    ...
    if "logEvents" in data:
        ...
        out["log_events"] = (
            capo_lightsail.types.container_service_log_event_list.deserialize_aws_json_1_1(
                data["logEvents"]
            )
        )
