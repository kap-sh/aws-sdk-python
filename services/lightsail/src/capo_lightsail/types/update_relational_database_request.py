...
class UpdateRelationalDatabaseRequest(TypedDict, closed=True):
    ...
    rotate_master_user_password: NotRequired["capo_lightsail.types.boolean.boolean"]
    ...
    preferred_backup_window: NotRequired["capo_lightsail.types.string.string"]
    ...
    preferred_maintenance_window: NotRequired["capo_lightsail.types.string.string"]
    ...
    enable_backup_retention: NotRequired["capo_lightsail.types.boolean.boolean"]
    ...
    disable_backup_retention: NotRequired["capo_lightsail.types.boolean.boolean"]
    ...
    apply_immediately: NotRequired["capo_lightsail.types.boolean.boolean"]
    ...
    relational_database_blueprint_id: NotRequired["capo_lightsail.types.string.string"]
