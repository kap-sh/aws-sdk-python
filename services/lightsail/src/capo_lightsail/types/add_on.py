...
if TYPE_CHECKING:
    ...
    import capo_lightsail.types.time_of_day
...
class AddOn(TypedDict, closed=True):
    ...
    snapshot_time_of_day: NotRequired["capo_lightsail.types.time_of_day.TimeOfDay"]
    ...
    next_snapshot_time_of_day: NotRequired["capo_lightsail.types.time_of_day.TimeOfDay"]
    ...
    threshold: NotRequired["capo_lightsail.types.string.string"]
    ...
    duration: NotRequired["capo_lightsail.types.string.string"]
