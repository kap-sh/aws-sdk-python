...
NotificationTriggerList: TypeAlias = list["capo_lightsail.types.alarm_state.AlarmState"]
...
def serialize_aws_json_1_1(value: NotificationTriggerList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_lightsail.types.alarm_state.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> NotificationTriggerList:
    ...
    for item in data:
        out.append(capo_lightsail.types.alarm_state.deserialize_aws_json_1_1(item))
    return out
