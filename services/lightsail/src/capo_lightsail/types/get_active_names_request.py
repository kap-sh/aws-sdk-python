"""Generated from Smithy shape ``com.amazonaws.lightsail#GetActiveNamesRequest``."""
...
class GetActiveNamesRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetActiveNamesRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetActiveNamesRequest:
    out: GetActiveNamesRequest = {}  # type: ignore[typeddict-item]
