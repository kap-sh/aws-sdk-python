"""Generated from Smithy shape ``com.amazonaws.lightsail#DeleteDistributionResult``."""
...
class DeleteDistributionResult(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteDistributionResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteDistributionResult:
    out: DeleteDistributionResult = {}  # type: ignore[typeddict-item]
