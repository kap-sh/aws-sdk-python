...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_load_balancer_tls_certificates_result.GetLoadBalancerTlsCertificatesResult = aws_sdk_lightsail.types.get_load_balancer_tls_certificates_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_load_balancer_tls_certificates_request.GetLoadBalancerTlsCertificatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_load_balancer_tls_certificates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
