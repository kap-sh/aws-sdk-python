...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.disable_add_on_result.DisableAddOnResult = (
        aws_sdk_lightsail.types.disable_add_on_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.disable_add_on_request.DisableAddOnRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.disable_add_on_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def disable_add_on(
    ...
    aws_sdk_lightsail.types.disable_add_on_result.DisableAddOnResult, zapros.Response
]:
