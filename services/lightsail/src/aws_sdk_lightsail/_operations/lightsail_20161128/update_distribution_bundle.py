...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.update_distribution_bundle_result.UpdateDistributionBundleResult = aws_sdk_lightsail.types.update_distribution_bundle_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.update_distribution_bundle_request.UpdateDistributionBundleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.update_distribution_bundle_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
