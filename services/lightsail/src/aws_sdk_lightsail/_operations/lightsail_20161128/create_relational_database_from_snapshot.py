...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_relational_database_from_snapshot_result.CreateRelationalDatabaseFromSnapshotResult = aws_sdk_lightsail.types.create_relational_database_from_snapshot_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_relational_database_from_snapshot_request.CreateRelationalDatabaseFromSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_relational_database_from_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
