...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_bucket_result.CreateBucketResult = (
        aws_sdk_lightsail.types.create_bucket_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_bucket_request.CreateBucketRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_bucket_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_bucket(
    ...
    aws_sdk_lightsail.types.create_bucket_result.CreateBucketResult, zapros.Response
]:
