"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateLoadBalancer``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_load_balancer_result.CreateLoadBalancerResult = aws_sdk_lightsail.types.create_load_balancer_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_load_balancer_request.CreateLoadBalancerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/CreateLoadBalancer"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_load_balancer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
