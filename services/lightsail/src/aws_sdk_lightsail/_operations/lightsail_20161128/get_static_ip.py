...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_static_ip_result.GetStaticIpResult = (
        aws_sdk_lightsail.types.get_static_ip_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_static_ip_request.GetStaticIpRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_static_ip_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_static_ip(
    ...
    aws_sdk_lightsail.types.get_static_ip_result.GetStaticIpResult, zapros.Response
]:
