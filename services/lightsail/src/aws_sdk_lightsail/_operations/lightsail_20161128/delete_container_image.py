...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_container_image_result.DeleteContainerImageResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_container_image_request.DeleteContainerImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
