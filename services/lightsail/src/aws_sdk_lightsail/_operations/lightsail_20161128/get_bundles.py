"""Generated from Smithy shape ``com.amazonaws.lightsail#GetBundles``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_bundles_result.GetBundlesResult = (
        aws_sdk_lightsail.types.get_bundles_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_bundles_request.GetBundlesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetBundles"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_bundles_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_bundles(
    ...
    aws_sdk_lightsail.types.get_bundles_result.GetBundlesResult, zapros.Response
]:
