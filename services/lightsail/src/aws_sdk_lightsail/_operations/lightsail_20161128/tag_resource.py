...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.tag_resource_result.TagResourceResult = (
        aws_sdk_lightsail.types.tag_resource_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_lightsail.types.tag_resource_result.TagResourceResult, zapros.Response
]:
