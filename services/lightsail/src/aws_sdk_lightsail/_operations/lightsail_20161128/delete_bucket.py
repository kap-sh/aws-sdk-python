"""Generated from Smithy shape ``com.amazonaws.lightsail#DeleteBucket``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_bucket_result.DeleteBucketResult = (
        aws_sdk_lightsail.types.delete_bucket_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_bucket_request.DeleteBucketRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/DeleteBucket"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.DeleteBucket"
    import aws_sdk_lightsail.types.delete_bucket_request

    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_bucket_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_bucket(
    ...
    aws_sdk_lightsail.types.delete_bucket_result.DeleteBucketResult, zapros.Response
]:
