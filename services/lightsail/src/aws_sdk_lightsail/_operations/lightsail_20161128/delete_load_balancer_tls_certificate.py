...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_load_balancer_tls_certificate_result.DeleteLoadBalancerTlsCertificateResult = aws_sdk_lightsail.types.delete_load_balancer_tls_certificate_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_load_balancer_tls_certificate_request.DeleteLoadBalancerTlsCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_load_balancer_tls_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
