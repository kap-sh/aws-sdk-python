...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.release_static_ip_result.ReleaseStaticIpResult = (
        aws_sdk_lightsail.types.release_static_ip_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.release_static_ip_request.ReleaseStaticIpRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.release_static_ip_request.serialize_aws_json_1_1(input_)
    ).encode()
