...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_bucket_access_keys_result.GetBucketAccessKeysResult = aws_sdk_lightsail.types.get_bucket_access_keys_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_bucket_access_keys_request.GetBucketAccessKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_bucket_access_keys_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
