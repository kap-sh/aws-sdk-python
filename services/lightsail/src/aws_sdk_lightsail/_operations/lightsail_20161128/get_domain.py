...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_domain_result.GetDomainResult = (
        aws_sdk_lightsail.types.get_domain_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_domain_request.GetDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_domain_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_domain(
    ...
    input_: aws_sdk_lightsail.types.get_domain_request.GetDomainRequest,
) -> tuple[aws_sdk_lightsail.types.get_domain_result.GetDomainResult, zapros.Response]:
