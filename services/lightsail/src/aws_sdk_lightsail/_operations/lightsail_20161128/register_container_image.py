...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.register_container_image_result.RegisterContainerImageResult = aws_sdk_lightsail.types.register_container_image_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.register_container_image_request.RegisterContainerImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.register_container_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
