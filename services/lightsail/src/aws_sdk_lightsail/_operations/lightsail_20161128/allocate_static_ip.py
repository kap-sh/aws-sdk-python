...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.allocate_static_ip_request.AllocateStaticIpRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.allocate_static_ip_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
