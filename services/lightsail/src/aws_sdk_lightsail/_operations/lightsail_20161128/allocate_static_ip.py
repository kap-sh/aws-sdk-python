"""Generated from Smithy shape ``com.amazonaws.lightsail#AllocateStaticIp``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.allocate_static_ip_result.AllocateStaticIpResult = (
        aws_sdk_lightsail.types.allocate_static_ip_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_lightsail.types.allocate_static_ip_request.AllocateStaticIpRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/AllocateStaticIp"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.allocate_static_ip_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_allocate_static_ip(
