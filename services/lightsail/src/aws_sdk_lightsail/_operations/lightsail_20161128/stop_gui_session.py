...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.stop_gui_session_result.StopGUISessionResult = (
        aws_sdk_lightsail.types.stop_gui_session_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.stop_gui_session_request.StopGUISessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.stop_gui_session_request.serialize_aws_json_1_1(input_)
    ).encode()
