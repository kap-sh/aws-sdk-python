...
def build_request(
    ...
    input: aws_sdk_lightsail.types.stop_gui_session_request.StopGUISessionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.stop_gui_session_request.serialize_aws_json_1_1(input)
    ).encode()
