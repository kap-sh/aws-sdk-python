...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.unpeer_vpc_result.UnpeerVpcResult = (
        aws_sdk_lightsail.types.unpeer_vpc_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.unpeer_vpc_request.UnpeerVpcRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def unpeer_vpc(
    ...
    input_: aws_sdk_lightsail.types.unpeer_vpc_request.UnpeerVpcRequest,
) -> tuple[aws_sdk_lightsail.types.unpeer_vpc_result.UnpeerVpcResult, zapros.Response]:
