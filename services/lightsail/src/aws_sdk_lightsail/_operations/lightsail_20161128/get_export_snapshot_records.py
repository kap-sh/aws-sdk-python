...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_export_snapshot_records_result.GetExportSnapshotRecordsResult = aws_sdk_lightsail.types.get_export_snapshot_records_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_export_snapshot_records_request.GetExportSnapshotRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_export_snapshot_records_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
