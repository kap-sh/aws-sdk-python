...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_relational_database_blueprints_result.GetRelationalDatabaseBlueprintsResult = aws_sdk_lightsail.types.get_relational_database_blueprints_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_relational_database_blueprints_request.GetRelationalDatabaseBlueprintsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_relational_database_blueprints_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
