...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_disk_result.DeleteDiskResult = (
        aws_sdk_lightsail.types.delete_disk_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_disk_request.DeleteDiskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_disk_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_disk(
    ...
    aws_sdk_lightsail.types.delete_disk_result.DeleteDiskResult, zapros.Response
]:
