"""Generated from Smithy shape ``com.amazonaws.lightsail#OpenInstancePublicPorts``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.open_instance_public_ports_result.OpenInstancePublicPortsResult = aws_sdk_lightsail.types.open_instance_public_ports_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.open_instance_public_ports_request.OpenInstancePublicPortsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/OpenInstancePublicPorts"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.open_instance_public_ports_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_open_instance_public_ports(
