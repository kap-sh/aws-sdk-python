...
def build_request(
    ...
    input: aws_sdk_lightsail.types.get_distributions_request.GetDistributionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_distributions_request.serialize_aws_json_1_1(input)
    ).encode()
