...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_distributions_result.GetDistributionsResult = (
        aws_sdk_lightsail.types.get_distributions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_distributions_request.GetDistributionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_distributions_request.serialize_aws_json_1_1(input_)
    ).encode()
