...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.attach_load_balancer_tls_certificate_result.AttachLoadBalancerTlsCertificateResult = aws_sdk_lightsail.types.attach_load_balancer_tls_certificate_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.attach_load_balancer_tls_certificate_request.AttachLoadBalancerTlsCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.attach_load_balancer_tls_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
