"""Generated from Smithy shape ``com.amazonaws.lightsail#GetRelationalDatabaseLogEvents``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_relational_database_log_events_result.GetRelationalDatabaseLogEventsResult = aws_sdk_lightsail.types.get_relational_database_log_events_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_relational_database_log_events_request.GetRelationalDatabaseLogEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetRelationalDatabaseLogEvents"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_relational_database_log_events_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_relational_database_log_events(
