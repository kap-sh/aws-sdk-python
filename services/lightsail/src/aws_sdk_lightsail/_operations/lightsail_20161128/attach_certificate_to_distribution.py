...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.attach_certificate_to_distribution_result.AttachCertificateToDistributionResult = aws_sdk_lightsail.types.attach_certificate_to_distribution_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.attach_certificate_to_distribution_request.AttachCertificateToDistributionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.attach_certificate_to_distribution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
