...
def build_request(
    ...
    input: aws_sdk_lightsail.types.get_container_services_request.GetContainerServicesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "service_name" in input:
        params["serviceName"] = str(input["service_name"])
