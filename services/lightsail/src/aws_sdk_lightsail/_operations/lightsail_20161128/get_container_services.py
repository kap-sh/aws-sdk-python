"""Generated from Smithy shape ``com.amazonaws.lightsail#GetContainerServices``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.container_services_list_result.ContainerServicesListResult = aws_sdk_lightsail.types.container_services_list_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_container_services_request.GetContainerServicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "service_name" in input_:
        params["serviceName"] = str(input_["service_name"])
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetContainerServices"
    body: bytes | None = b""
...
async def async_get_container_services(
