...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_bucket_access_key_result.DeleteBucketAccessKeyResult = aws_sdk_lightsail.types.delete_bucket_access_key_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_bucket_access_key_request.DeleteBucketAccessKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_bucket_access_key_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
