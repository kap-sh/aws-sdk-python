"""Generated from Smithy shape ``com.amazonaws.lightsail#GetKeyPair``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_key_pair_result.GetKeyPairResult = (
        aws_sdk_lightsail.types.get_key_pair_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_key_pair_request.GetKeyPairRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetKeyPair"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetKeyPair"
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_key_pair_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_key_pair(
    ...
    aws_sdk_lightsail.types.get_key_pair_result.GetKeyPairResult, zapros.Response
]:
