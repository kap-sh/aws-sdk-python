...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_bucket_metric_data_result.GetBucketMetricDataResult = aws_sdk_lightsail.types.get_bucket_metric_data_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_bucket_metric_data_request.GetBucketMetricDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_bucket_metric_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
