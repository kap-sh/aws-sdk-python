"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateDistribution``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_distribution_result.CreateDistributionResult = (
        aws_sdk_lightsail.types.create_distribution_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_distribution_request.CreateDistributionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/CreateDistribution"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateDistribution"
    import aws_sdk_lightsail.types.create_distribution_request

    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_distribution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
