"""Generated from Smithy shape ``com.amazonaws.lightsail#ImportKeyPair``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.import_key_pair_result.ImportKeyPairResult = (
        aws_sdk_lightsail.types.import_key_pair_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.import_key_pair_request.ImportKeyPairRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/ImportKeyPair"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.import_key_pair_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def import_key_pair(
    ...
    aws_sdk_lightsail.types.import_key_pair_result.ImportKeyPairResult, zapros.Response
]:
