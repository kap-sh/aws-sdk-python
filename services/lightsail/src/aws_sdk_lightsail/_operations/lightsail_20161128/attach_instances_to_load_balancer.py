"""Generated from Smithy shape ``com.amazonaws.lightsail#AttachInstancesToLoadBalancer``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.attach_instances_to_load_balancer_result.AttachInstancesToLoadBalancerResult = aws_sdk_lightsail.types.attach_instances_to_load_balancer_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.attach_instances_to_load_balancer_request.AttachInstancesToLoadBalancerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/AttachInstancesToLoadBalancer"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.attach_instances_to_load_balancer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_attach_instances_to_load_balancer(
