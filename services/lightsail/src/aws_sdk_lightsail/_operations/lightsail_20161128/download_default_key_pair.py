"""Generated from Smithy shape ``com.amazonaws.lightsail#DownloadDefaultKeyPair``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.download_default_key_pair_result.DownloadDefaultKeyPairResult = aws_sdk_lightsail.types.download_default_key_pair_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.download_default_key_pair_request.DownloadDefaultKeyPairRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/DownloadDefaultKeyPair"
    params: dict[str, str] = {}
...
async def async_download_default_key_pair(
