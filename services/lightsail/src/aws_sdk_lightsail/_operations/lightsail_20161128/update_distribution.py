...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.update_distribution_request.UpdateDistributionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.update_distribution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
