...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_alarms_result.GetAlarmsResult = (
        aws_sdk_lightsail.types.get_alarms_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_lightsail.types.get_alarms_request.GetAlarmsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "alarm_name" in input:
        params["alarmName"] = str(input["alarm_name"])
    if "page_token" in input:
        params["pageToken"] = str(input["page_token"])
    if "monitored_resource_name" in input:
        params["monitoredResourceName"] = str(input["monitored_resource_name"])
...
def get_alarms(
    ...
    input: aws_sdk_lightsail.types.get_alarms_request.GetAlarmsRequest,
) -> tuple[aws_sdk_lightsail.types.get_alarms_result.GetAlarmsResult, zapros.Response]:
