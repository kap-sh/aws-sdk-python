...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.set_ip_address_type_result.SetIpAddressTypeResult = (
        aws_sdk_lightsail.types.set_ip_address_type_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.set_ip_address_type_request.SetIpAddressTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.set_ip_address_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
