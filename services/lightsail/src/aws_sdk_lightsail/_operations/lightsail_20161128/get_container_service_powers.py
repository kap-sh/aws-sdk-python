"""Generated from Smithy shape ``com.amazonaws.lightsail#GetContainerServicePowers``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_container_service_powers_result.GetContainerServicePowersResult = aws_sdk_lightsail.types.get_container_service_powers_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_container_service_powers_request.GetContainerServicePowersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/container-service-powers"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetContainerServicePowers"
    body: bytes | None = b""
...
async def async_get_container_service_powers(
