...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_relational_database_events_result.GetRelationalDatabaseEventsResult = aws_sdk_lightsail.types.get_relational_database_events_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_relational_database_events_request.GetRelationalDatabaseEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_relational_database_events_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
