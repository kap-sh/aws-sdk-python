...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_relational_database_metric_data_result.GetRelationalDatabaseMetricDataResult = aws_sdk_lightsail.types.get_relational_database_metric_data_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_relational_database_metric_data_request.GetRelationalDatabaseMetricDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_relational_database_metric_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
