"""Generated from Smithy shape ``com.amazonaws.lightsail#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.untag_resource_result.UntagResourceResult = (
        aws_sdk_lightsail.types.untag_resource_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/UntagResource"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    aws_sdk_lightsail.types.untag_resource_result.UntagResourceResult, zapros.Response
]:
