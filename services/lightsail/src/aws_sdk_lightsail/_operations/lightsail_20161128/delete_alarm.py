...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_alarm_result.DeleteAlarmResult = (
        aws_sdk_lightsail.types.delete_alarm_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_alarm_request.DeleteAlarmRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_alarm(
    ...
    aws_sdk_lightsail.types.delete_alarm_result.DeleteAlarmResult, zapros.Response
]:
