...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_auto_snapshots_result.GetAutoSnapshotsResult = (
        aws_sdk_lightsail.types.get_auto_snapshots_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_lightsail.types.get_auto_snapshots_request.GetAutoSnapshotsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_auto_snapshots_request.serialize_aws_json_1_1(input)
    ).encode()
