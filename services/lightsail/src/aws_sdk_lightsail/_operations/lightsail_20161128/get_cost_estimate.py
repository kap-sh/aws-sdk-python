...
def build_request(
    ...
    input: aws_sdk_lightsail.types.get_cost_estimate_request.GetCostEstimateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_cost_estimate_request.serialize_aws_json_1_1(input)
    ).encode()
