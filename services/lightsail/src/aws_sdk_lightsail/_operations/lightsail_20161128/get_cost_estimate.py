...
import aws_sdk_lightsail.types.resources_budget_estimate
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_cost_estimate_result.GetCostEstimateResult = (
        aws_sdk_lightsail.types.get_cost_estimate_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_cost_estimate_request.GetCostEstimateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_cost_estimate_request.serialize_aws_json_1_1(input_)
    ).encode()
