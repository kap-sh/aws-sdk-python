...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_operation_result.GetOperationResult = (
        aws_sdk_lightsail.types.get_operation_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_operation_request.GetOperationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_operation_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_operation(
    ...
    aws_sdk_lightsail.types.get_operation_result.GetOperationResult, zapros.Response
]:
