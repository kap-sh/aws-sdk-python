...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_gui_session_access_details_result.CreateGUISessionAccessDetailsResult = aws_sdk_lightsail.types.create_gui_session_access_details_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_gui_session_access_details_request.CreateGUISessionAccessDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_gui_session_access_details_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
