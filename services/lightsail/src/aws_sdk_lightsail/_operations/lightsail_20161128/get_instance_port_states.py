...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_instance_port_states_result.GetInstancePortStatesResult = aws_sdk_lightsail.types.get_instance_port_states_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_instance_port_states_request.GetInstancePortStatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_instance_port_states_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
