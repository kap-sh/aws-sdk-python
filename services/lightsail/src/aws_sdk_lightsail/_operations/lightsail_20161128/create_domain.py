...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_domain_result.CreateDomainResult = (
        aws_sdk_lightsail.types.create_domain_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_domain_request.CreateDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_domain_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_domain(
    ...
    aws_sdk_lightsail.types.create_domain_result.CreateDomainResult, zapros.Response
]:
