...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_regions_result.GetRegionsResult = (
        aws_sdk_lightsail.types.get_regions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_regions_request.GetRegionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_regions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_regions(
    ...
    aws_sdk_lightsail.types.get_regions_result.GetRegionsResult, zapros.Response
]:
