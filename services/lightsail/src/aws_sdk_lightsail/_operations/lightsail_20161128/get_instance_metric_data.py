...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_instance_metric_data_result.GetInstanceMetricDataResult = aws_sdk_lightsail.types.get_instance_metric_data_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_instance_metric_data_request.GetInstanceMetricDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_instance_metric_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
