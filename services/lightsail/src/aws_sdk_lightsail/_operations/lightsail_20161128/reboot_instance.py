"""Generated from Smithy shape ``com.amazonaws.lightsail#RebootInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.reboot_instance_result.RebootInstanceResult = (
        aws_sdk_lightsail.types.reboot_instance_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.reboot_instance_request.RebootInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/RebootInstance"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.RebootInstance"
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.reboot_instance_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def reboot_instance(
    ...
    aws_sdk_lightsail.types.reboot_instance_result.RebootInstanceResult, zapros.Response
]:
...
async def async_reboot_instance(
