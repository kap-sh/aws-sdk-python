...
def build_request(
    ...
    input: aws_sdk_lightsail.types.reboot_instance_request.RebootInstanceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.reboot_instance_request.serialize_aws_json_1_1(input)
    ).encode()
