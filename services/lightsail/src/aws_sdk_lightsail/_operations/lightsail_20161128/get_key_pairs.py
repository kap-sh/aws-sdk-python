...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_key_pairs_result.GetKeyPairsResult = (
        aws_sdk_lightsail.types.get_key_pairs_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_key_pairs_request.GetKeyPairsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_key_pairs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_key_pairs(
    ...
    aws_sdk_lightsail.types.get_key_pairs_result.GetKeyPairsResult, zapros.Response
]:
