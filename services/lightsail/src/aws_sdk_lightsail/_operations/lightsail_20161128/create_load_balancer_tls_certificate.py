"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateLoadBalancerTlsCertificate``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_load_balancer_tls_certificate_result.CreateLoadBalancerTlsCertificateResult = aws_sdk_lightsail.types.create_load_balancer_tls_certificate_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_load_balancer_tls_certificate_request.CreateLoadBalancerTlsCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/ls/api/2016-11-28/CreateLoadBalancerTlsCertificate"
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateLoadBalancerTlsCertificate"
    import aws_sdk_lightsail.types.create_load_balancer_tls_certificate_request

    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_load_balancer_tls_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_load_balancer_tls_certificate(
