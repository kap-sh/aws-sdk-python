"""Generated from Smithy shape ``com.amazonaws.lightsail#GetRelationalDatabases``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_relational_databases_result.GetRelationalDatabasesResult = aws_sdk_lightsail.types.get_relational_databases_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_relational_databases_request.GetRelationalDatabasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetRelationalDatabases"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_relational_databases_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_relational_databases(
