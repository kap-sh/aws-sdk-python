...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_known_host_keys_result.DeleteKnownHostKeysResult = aws_sdk_lightsail.types.delete_known_host_keys_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_known_host_keys_request.DeleteKnownHostKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_known_host_keys_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
