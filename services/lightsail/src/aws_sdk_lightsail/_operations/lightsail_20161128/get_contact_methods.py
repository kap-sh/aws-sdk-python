"""Generated from Smithy shape ``com.amazonaws.lightsail#GetContactMethods``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_contact_methods_result.GetContactMethodsResult = (
        aws_sdk_lightsail.types.get_contact_methods_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_contact_methods_request.GetContactMethodsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetContactMethods"
    params: dict[str, str] = {}
    if "protocols" in input_:
        params["protocols"] = str(input_["protocols"])
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetContactMethods"
    body: bytes | None = b""
...
async def async_get_contact_methods(
