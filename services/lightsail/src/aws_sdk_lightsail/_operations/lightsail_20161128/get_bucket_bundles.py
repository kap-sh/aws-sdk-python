...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_bucket_bundles_result.GetBucketBundlesResult = (
        aws_sdk_lightsail.types.get_bucket_bundles_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_lightsail.types.get_bucket_bundles_request.GetBucketBundlesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_bucket_bundles_request.serialize_aws_json_1_1(input)
    ).encode()
