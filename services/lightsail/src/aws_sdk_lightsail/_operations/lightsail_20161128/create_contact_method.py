...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_contact_method_result.CreateContactMethodResult = aws_sdk_lightsail.types.create_contact_method_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_contact_method_request.CreateContactMethodRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_contact_method_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
