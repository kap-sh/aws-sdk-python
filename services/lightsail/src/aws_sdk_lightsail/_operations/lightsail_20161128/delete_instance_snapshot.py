"""Generated from Smithy shape ``com.amazonaws.lightsail#DeleteInstanceSnapshot``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_instance_snapshot_result.DeleteInstanceSnapshotResult = aws_sdk_lightsail.types.delete_instance_snapshot_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_instance_snapshot_request.DeleteInstanceSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/DeleteInstanceSnapshot"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_instance_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_instance_snapshot(
