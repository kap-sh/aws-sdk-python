"""Generated from Smithy shape ``com.amazonaws.lightsail#GetDistributionBundles``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_distribution_bundles_result.GetDistributionBundlesResult = aws_sdk_lightsail.types.get_distribution_bundles_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_distribution_bundles_request.GetDistributionBundlesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetDistributionBundles"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetDistributionBundles"
    body: bytes | None = b""
...
async def async_get_distribution_bundles(
