"""Generated from Smithy shape ``com.amazonaws.lightsail#GetDisks``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_disks_result.GetDisksResult = (
        aws_sdk_lightsail.types.get_disks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_disks_request.GetDisksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetDisks"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetDisks"
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_disks_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_disks(
    ...
    input_: aws_sdk_lightsail.types.get_disks_request.GetDisksRequest,
) -> tuple[aws_sdk_lightsail.types.get_disks_result.GetDisksResult, zapros.Response]:
