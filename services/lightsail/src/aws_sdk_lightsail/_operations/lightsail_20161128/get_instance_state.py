...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_instance_state_result.GetInstanceStateResult = (
        aws_sdk_lightsail.types.get_instance_state_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_lightsail.types.get_instance_state_request.GetInstanceStateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_instance_state_request.serialize_aws_json_1_1(input)
    ).encode()
