"""Generated from Smithy shape ``com.amazonaws.lightsail#GetBuckets``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_buckets_result.GetBucketsResult = (
        aws_sdk_lightsail.types.get_buckets_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_buckets_request.GetBucketsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetBuckets"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetBuckets"
    import aws_sdk_lightsail.types.get_buckets_request

    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_buckets_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_buckets(
    ...
    aws_sdk_lightsail.types.get_buckets_result.GetBucketsResult, zapros.Response
]:
