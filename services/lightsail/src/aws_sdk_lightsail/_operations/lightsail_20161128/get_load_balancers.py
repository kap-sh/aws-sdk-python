...
def build_request(
    ...
    input: aws_sdk_lightsail.types.get_load_balancers_request.GetLoadBalancersRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_load_balancers_request.serialize_aws_json_1_1(input)
    ).encode()
