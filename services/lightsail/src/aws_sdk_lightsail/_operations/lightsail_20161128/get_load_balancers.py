"""Generated from Smithy shape ``com.amazonaws.lightsail#GetLoadBalancers``."""
...
import aws_sdk_lightsail.types.load_balancer_list
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_load_balancers_result.GetLoadBalancersResult = (
        aws_sdk_lightsail.types.get_load_balancers_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_load_balancers_request.GetLoadBalancersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetLoadBalancers"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetLoadBalancers"
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_load_balancers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_load_balancers(
