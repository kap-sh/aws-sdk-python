...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_key_pair_result.CreateKeyPairResult = (
        aws_sdk_lightsail.types.create_key_pair_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_key_pair_request.CreateKeyPairRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_key_pair_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_key_pair(
    ...
    aws_sdk_lightsail.types.create_key_pair_result.CreateKeyPairResult, zapros.Response
]:
