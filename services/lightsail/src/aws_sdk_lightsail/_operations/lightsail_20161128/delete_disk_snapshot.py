...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_disk_snapshot_result.DeleteDiskSnapshotResult = aws_sdk_lightsail.types.delete_disk_snapshot_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_disk_snapshot_request.DeleteDiskSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_disk_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
