...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_container_api_metadata_result.GetContainerAPIMetadataResult = aws_sdk_lightsail.types.get_container_api_metadata_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_container_api_metadata_request.GetContainerAPIMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
