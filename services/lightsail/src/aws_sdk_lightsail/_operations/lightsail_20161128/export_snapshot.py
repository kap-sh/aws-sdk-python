"""Generated from Smithy shape ``com.amazonaws.lightsail#ExportSnapshot``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.export_snapshot_result.ExportSnapshotResult = (
        aws_sdk_lightsail.types.export_snapshot_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.export_snapshot_request.ExportSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/ExportSnapshot"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.export_snapshot_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def export_snapshot(
    ...
    aws_sdk_lightsail.types.export_snapshot_result.ExportSnapshotResult, zapros.Response
]:
...
async def async_export_snapshot(
