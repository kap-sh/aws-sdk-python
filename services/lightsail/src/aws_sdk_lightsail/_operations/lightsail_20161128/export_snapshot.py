...
def build_request(
    ...
    input: aws_sdk_lightsail.types.export_snapshot_request.ExportSnapshotRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.export_snapshot_request.serialize_aws_json_1_1(input)
    ).encode()
