...
def build_request(
    ...
    input: aws_sdk_lightsail.types.attach_static_ip_request.AttachStaticIpRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.attach_static_ip_request.serialize_aws_json_1_1(input)
    ).encode()
