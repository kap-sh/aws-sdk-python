"""Generated from Smithy shape ``com.amazonaws.lightsail#SendContactMethodVerification``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.send_contact_method_verification_result.SendContactMethodVerificationResult = aws_sdk_lightsail.types.send_contact_method_verification_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.send_contact_method_verification_request.SendContactMethodVerificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/SendContactMethodVerification"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.SendContactMethodVerification"
    import aws_sdk_lightsail.types.send_contact_method_verification_request

    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.send_contact_method_verification_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_send_contact_method_verification(
