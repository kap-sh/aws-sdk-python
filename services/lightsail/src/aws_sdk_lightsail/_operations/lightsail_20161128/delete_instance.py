...
def build_request(
    ...
    input: aws_sdk_lightsail.types.delete_instance_request.DeleteInstanceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_instance_request.serialize_aws_json_1_1(input)
    ).encode()
