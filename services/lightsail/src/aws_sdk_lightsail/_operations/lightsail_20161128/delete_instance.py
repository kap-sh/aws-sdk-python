...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_instance_result.DeleteInstanceResult = (
        aws_sdk_lightsail.types.delete_instance_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_instance_request.DeleteInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_instance_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_instance(
    ...
    aws_sdk_lightsail.types.delete_instance_result.DeleteInstanceResult, zapros.Response
]:
