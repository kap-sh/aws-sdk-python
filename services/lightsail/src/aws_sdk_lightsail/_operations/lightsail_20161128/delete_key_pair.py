...
def build_request(
    ...
    input: aws_sdk_lightsail.types.delete_key_pair_request.DeleteKeyPairRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_key_pair_request.serialize_aws_json_1_1(input)
    ).encode()
