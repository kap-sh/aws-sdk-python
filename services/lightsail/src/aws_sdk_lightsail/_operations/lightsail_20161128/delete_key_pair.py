...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_key_pair_result.DeleteKeyPairResult = (
        aws_sdk_lightsail.types.delete_key_pair_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_key_pair_request.DeleteKeyPairRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_key_pair_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_key_pair(
    ...
    aws_sdk_lightsail.types.delete_key_pair_result.DeleteKeyPairResult, zapros.Response
]:
