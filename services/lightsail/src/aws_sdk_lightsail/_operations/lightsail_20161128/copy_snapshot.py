...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.copy_snapshot_result.CopySnapshotResult = (
        aws_sdk_lightsail.types.copy_snapshot_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.copy_snapshot_request.CopySnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.copy_snapshot_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def copy_snapshot(
    ...
    aws_sdk_lightsail.types.copy_snapshot_result.CopySnapshotResult, zapros.Response
]:
