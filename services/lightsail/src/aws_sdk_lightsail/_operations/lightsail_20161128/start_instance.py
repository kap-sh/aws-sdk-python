...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.start_instance_result.StartInstanceResult = (
        aws_sdk_lightsail.types.start_instance_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.start_instance_request.StartInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.start_instance_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_instance(
    ...
    aws_sdk_lightsail.types.start_instance_result.StartInstanceResult, zapros.Response
]:
