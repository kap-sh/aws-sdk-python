...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.detach_instances_from_load_balancer_result.DetachInstancesFromLoadBalancerResult = aws_sdk_lightsail.types.detach_instances_from_load_balancer_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.detach_instances_from_load_balancer_request.DetachInstancesFromLoadBalancerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.detach_instances_from_load_balancer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
