"""Generated from Smithy shape ``com.amazonaws.lightsail#GetRelationalDatabaseMasterUserPassword``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_relational_database_master_user_password_result.GetRelationalDatabaseMasterUserPasswordResult = aws_sdk_lightsail.types.get_relational_database_master_user_password_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_relational_database_master_user_password_request.GetRelationalDatabaseMasterUserPasswordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/ls/api/2016-11-28/GetRelationalDatabaseMasterUserPassword"
    )
    params: dict[str, str] = {}
...
async def async_get_relational_database_master_user_password(
