...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.set_resource_access_for_bucket_result.SetResourceAccessForBucketResult = aws_sdk_lightsail.types.set_resource_access_for_bucket_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.set_resource_access_for_bucket_request.SetResourceAccessForBucketRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.set_resource_access_for_bucket_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
