...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_disk_result.CreateDiskResult = (
        aws_sdk_lightsail.types.create_disk_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_disk_request.CreateDiskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_disk_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_disk(
    ...
    aws_sdk_lightsail.types.create_disk_result.CreateDiskResult, zapros.Response
]:
