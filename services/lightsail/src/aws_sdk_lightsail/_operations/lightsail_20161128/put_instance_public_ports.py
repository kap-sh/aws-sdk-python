...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.put_instance_public_ports_result.PutInstancePublicPortsResult = aws_sdk_lightsail.types.put_instance_public_ports_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.put_instance_public_ports_request.PutInstancePublicPortsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.put_instance_public_ports_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
