...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_certificate_request.CreateCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
