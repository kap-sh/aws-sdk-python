"""Generated from Smithy shape ``com.amazonaws.lightsail#DeleteContainerService``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_container_service_result.DeleteContainerServiceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.delete_container_service_request.DeleteContainerServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Lightsail_20161128.DeleteContainerService"
    body: bytes | None = b""
...
async def async_delete_container_service(
