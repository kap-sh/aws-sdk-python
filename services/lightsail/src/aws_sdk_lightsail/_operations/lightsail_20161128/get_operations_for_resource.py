...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_operations_for_resource_result.GetOperationsForResourceResult = aws_sdk_lightsail.types.get_operations_for_resource_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_operations_for_resource_request.GetOperationsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_operations_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
