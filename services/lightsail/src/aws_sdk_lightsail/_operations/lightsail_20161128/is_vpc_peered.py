"""Generated from Smithy shape ``com.amazonaws.lightsail#IsVpcPeered``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.is_vpc_peered_result.IsVpcPeeredResult = (
        aws_sdk_lightsail.types.is_vpc_peered_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.is_vpc_peered_request.IsVpcPeeredRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/IsVpcPeered"
    params: dict[str, str] = {}
...
def is_vpc_peered(
    ...
    aws_sdk_lightsail.types.is_vpc_peered_result.IsVpcPeeredResult, zapros.Response
]:
