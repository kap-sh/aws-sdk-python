...
def build_request(
    ...
    input: aws_sdk_lightsail.types.create_instances_request.CreateInstancesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_instances_request.serialize_aws_json_1_1(input)
    ).encode()
