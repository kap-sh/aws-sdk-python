...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.start_gui_session_result.StartGUISessionResult = (
        aws_sdk_lightsail.types.start_gui_session_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.start_gui_session_request.StartGUISessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.start_gui_session_request.serialize_aws_json_1_1(input_)
    ).encode()
