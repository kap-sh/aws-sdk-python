...
def build_request(
    ...
    input: aws_sdk_lightsail.types.start_gui_session_request.StartGUISessionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.start_gui_session_request.serialize_aws_json_1_1(input)
    ).encode()
