...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_static_ips_result.GetStaticIpsResult = (
        aws_sdk_lightsail.types.get_static_ips_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_static_ips_request.GetStaticIpsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_static_ips_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_static_ips(
    ...
    aws_sdk_lightsail.types.get_static_ips_result.GetStaticIpsResult, zapros.Response
]:
