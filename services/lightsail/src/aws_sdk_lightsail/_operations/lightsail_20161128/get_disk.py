"""Generated from Smithy shape ``com.amazonaws.lightsail#GetDisk``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_disk_result.GetDiskResult = (
        aws_sdk_lightsail.types.get_disk_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_disk_request.GetDiskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetDisk"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_disk_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_disk(
    ...
    input_: aws_sdk_lightsail.types.get_disk_request.GetDiskRequest,
) -> tuple[aws_sdk_lightsail.types.get_disk_result.GetDiskResult, zapros.Response]:
