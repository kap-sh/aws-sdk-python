...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.setup_instance_https_result.SetupInstanceHttpsResult = aws_sdk_lightsail.types.setup_instance_https_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.setup_instance_https_request.SetupInstanceHttpsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.setup_instance_https_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
