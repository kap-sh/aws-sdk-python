...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.update_instance_metadata_options_result.UpdateInstanceMetadataOptionsResult = aws_sdk_lightsail.types.update_instance_metadata_options_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.update_instance_metadata_options_request.UpdateInstanceMetadataOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
