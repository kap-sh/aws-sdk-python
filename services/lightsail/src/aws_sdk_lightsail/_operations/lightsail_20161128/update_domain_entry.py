...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.update_domain_entry_result.UpdateDomainEntryResult = (
        aws_sdk_lightsail.types.update_domain_entry_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.update_domain_entry_request.UpdateDomainEntryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.update_domain_entry_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
