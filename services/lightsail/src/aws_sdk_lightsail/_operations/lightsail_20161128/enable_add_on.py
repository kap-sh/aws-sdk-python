...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.enable_add_on_result.EnableAddOnResult = (
        aws_sdk_lightsail.types.enable_add_on_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.enable_add_on_request.EnableAddOnRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.enable_add_on_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def enable_add_on(
    ...
    aws_sdk_lightsail.types.enable_add_on_result.EnableAddOnResult, zapros.Response
]:
