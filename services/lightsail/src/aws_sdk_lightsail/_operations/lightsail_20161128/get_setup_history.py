...
def build_request(
    ...
    input: aws_sdk_lightsail.types.get_setup_history_request.GetSetupHistoryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_setup_history_request.serialize_aws_json_1_1(input)
    ).encode()
