...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_setup_history_result.GetSetupHistoryResult = (
        aws_sdk_lightsail.types.get_setup_history_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_setup_history_request.GetSetupHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_setup_history_request.serialize_aws_json_1_1(input_)
    ).encode()
