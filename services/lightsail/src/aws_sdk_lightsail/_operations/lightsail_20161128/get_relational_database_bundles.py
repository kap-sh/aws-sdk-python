"""Generated from Smithy shape ``com.amazonaws.lightsail#GetRelationalDatabaseBundles``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_relational_database_bundles_result.GetRelationalDatabaseBundlesResult = aws_sdk_lightsail.types.get_relational_database_bundles_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_relational_database_bundles_request.GetRelationalDatabaseBundlesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetRelationalDatabaseBundles"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_relational_database_bundles_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_relational_database_bundles(
