"""Generated from Smithy shape ``com.amazonaws.lightsail#DetachStaticIp``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.detach_static_ip_result.DetachStaticIpResult = (
        aws_sdk_lightsail.types.detach_static_ip_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.detach_static_ip_request.DetachStaticIpRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/DetachStaticIp"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.detach_static_ip_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_detach_static_ip(
