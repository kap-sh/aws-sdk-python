...
def build_request(
    ...
    input: aws_sdk_lightsail.types.detach_static_ip_request.DetachStaticIpRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.detach_static_ip_request.serialize_aws_json_1_1(input)
    ).encode()
