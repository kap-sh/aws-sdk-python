...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_container_images_result.GetContainerImagesResult = aws_sdk_lightsail.types.get_container_images_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_container_images_request.GetContainerImagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
