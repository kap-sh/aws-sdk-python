"""Generated from Smithy shape ``com.amazonaws.lightsail#GetBlueprints``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_blueprints_result.GetBlueprintsResult = (
        aws_sdk_lightsail.types.get_blueprints_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_blueprints_request.GetBlueprintsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetBlueprints"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetBlueprints"
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_blueprints_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_blueprints(
    ...
    aws_sdk_lightsail.types.get_blueprints_result.GetBlueprintsResult, zapros.Response
]:
