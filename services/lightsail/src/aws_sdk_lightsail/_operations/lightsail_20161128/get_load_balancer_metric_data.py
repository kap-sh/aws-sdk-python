"""Generated from Smithy shape ``com.amazonaws.lightsail#GetLoadBalancerMetricData``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_load_balancer_metric_data_result.GetLoadBalancerMetricDataResult = aws_sdk_lightsail.types.get_load_balancer_metric_data_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_load_balancer_metric_data_request.GetLoadBalancerMetricDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetLoadBalancerMetricData"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_load_balancer_metric_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_load_balancer_metric_data(
