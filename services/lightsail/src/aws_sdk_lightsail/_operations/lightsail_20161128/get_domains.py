...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_domains_result.GetDomainsResult = (
        aws_sdk_lightsail.types.get_domains_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_domains_request.GetDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_domains_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_domains(
    ...
    aws_sdk_lightsail.types.get_domains_result.GetDomainsResult, zapros.Response
]:
