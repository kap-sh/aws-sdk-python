...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.start_relational_database_result.StartRelationalDatabaseResult = aws_sdk_lightsail.types.start_relational_database_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.start_relational_database_request.StartRelationalDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.start_relational_database_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
