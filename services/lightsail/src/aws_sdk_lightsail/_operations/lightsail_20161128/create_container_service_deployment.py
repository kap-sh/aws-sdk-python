...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_container_service_deployment_result.CreateContainerServiceDeploymentResult = aws_sdk_lightsail.types.create_container_service_deployment_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_container_service_deployment_request.CreateContainerServiceDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_container_service_deployment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
