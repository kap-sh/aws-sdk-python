"""Generated from Smithy shape ``com.amazonaws.lightsail#GetContainerServiceDeployments``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_container_service_deployments_result.GetContainerServiceDeploymentsResult = aws_sdk_lightsail.types.get_container_service_deployments_result.deserialize_aws_json_1_1(
