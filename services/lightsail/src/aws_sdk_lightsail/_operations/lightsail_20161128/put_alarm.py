...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.put_alarm_result.PutAlarmResult = (
        aws_sdk_lightsail.types.put_alarm_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.put_alarm_request.PutAlarmRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.put_alarm_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_alarm(
    ...
    input_: aws_sdk_lightsail.types.put_alarm_request.PutAlarmRequest,
) -> tuple[aws_sdk_lightsail.types.put_alarm_result.PutAlarmResult, zapros.Response]:
