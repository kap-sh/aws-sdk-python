"""Generated from Smithy shape ``com.amazonaws.lightsail#GetInstances``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_instances_result.GetInstancesResult = (
        aws_sdk_lightsail.types.get_instances_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_instances_request.GetInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetInstances"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_instances_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_instances(
    ...
    aws_sdk_lightsail.types.get_instances_result.GetInstancesResult, zapros.Response
]:
