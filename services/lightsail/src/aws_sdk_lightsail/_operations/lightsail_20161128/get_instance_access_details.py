"""Generated from Smithy shape ``com.amazonaws.lightsail#GetInstanceAccessDetails``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_instance_access_details_result.GetInstanceAccessDetailsResult = aws_sdk_lightsail.types.get_instance_access_details_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_instance_access_details_request.GetInstanceAccessDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetInstanceAccessDetails"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_instance_access_details_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_instance_access_details(
