...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.close_instance_public_ports_result.CloseInstancePublicPortsResult = aws_sdk_lightsail.types.close_instance_public_ports_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.close_instance_public_ports_request.CloseInstancePublicPortsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.close_instance_public_ports_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
