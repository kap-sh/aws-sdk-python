"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateContainerService``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_container_service_result.CreateContainerServiceResult = aws_sdk_lightsail.types.create_container_service_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_container_service_request.CreateContainerServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/container-services"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateContainerService"
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_container_service_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_container_service(
