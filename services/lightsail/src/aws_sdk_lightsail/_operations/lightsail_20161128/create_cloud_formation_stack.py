"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateCloudFormationStack``."""
...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_cloud_formation_stack_result.CreateCloudFormationStackResult = aws_sdk_lightsail.types.create_cloud_formation_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_cloud_formation_stack_request.CreateCloudFormationStackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/CreateCloudFormationStack"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_cloud_formation_stack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_cloud_formation_stack(
