...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_relational_database_result.CreateRelationalDatabaseResult = aws_sdk_lightsail.types.create_relational_database_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_relational_database_request.CreateRelationalDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.create_relational_database_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
