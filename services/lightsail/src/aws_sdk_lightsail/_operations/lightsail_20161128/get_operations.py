...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.get_operations_result.GetOperationsResult = (
        aws_sdk_lightsail.types.get_operations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.get_operations_request.GetOperationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.get_operations_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_operations(
    ...
    aws_sdk_lightsail.types.get_operations_result.GetOperationsResult, zapros.Response
]:
