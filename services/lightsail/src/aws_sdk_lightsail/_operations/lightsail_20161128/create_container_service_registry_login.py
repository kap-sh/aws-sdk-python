...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.create_container_service_registry_login_result.CreateContainerServiceRegistryLoginResult = aws_sdk_lightsail.types.create_container_service_registry_login_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.create_container_service_registry_login_request.CreateContainerServiceRegistryLoginRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
