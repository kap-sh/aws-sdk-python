...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.delete_certificate_result.DeleteCertificateResult = (
        aws_sdk_lightsail.types.delete_certificate_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_lightsail.types.delete_certificate_request.DeleteCertificateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.delete_certificate_request.serialize_aws_json_1_1(input)
    ).encode()
