...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.stop_instance_result.StopInstanceResult = (
        aws_sdk_lightsail.types.stop_instance_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.stop_instance_request.StopInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.stop_instance_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_instance(
    ...
    aws_sdk_lightsail.types.stop_instance_result.StopInstanceResult, zapros.Response
]:
