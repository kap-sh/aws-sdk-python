...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.update_relational_database_parameters_result.UpdateRelationalDatabaseParametersResult = aws_sdk_lightsail.types.update_relational_database_parameters_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.update_relational_database_parameters_request.UpdateRelationalDatabaseParametersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.update_relational_database_parameters_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
