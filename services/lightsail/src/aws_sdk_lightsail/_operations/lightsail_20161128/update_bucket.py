...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.update_bucket_result.UpdateBucketResult = (
        aws_sdk_lightsail.types.update_bucket_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.update_bucket_request.UpdateBucketRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.update_bucket_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_bucket(
    ...
    aws_sdk_lightsail.types.update_bucket_result.UpdateBucketResult, zapros.Response
]:
