...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.update_load_balancer_attribute_result.UpdateLoadBalancerAttributeResult = aws_sdk_lightsail.types.update_load_balancer_attribute_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.update_load_balancer_attribute_request.UpdateLoadBalancerAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.update_load_balancer_attribute_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
