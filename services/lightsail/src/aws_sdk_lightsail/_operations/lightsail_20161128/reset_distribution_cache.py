...
def handle_response(
    ...
    out: aws_sdk_lightsail.types.reset_distribution_cache_result.ResetDistributionCacheResult = aws_sdk_lightsail.types.reset_distribution_cache_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_lightsail.types.reset_distribution_cache_request.ResetDistributionCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lightsail.types.reset_distribution_cache_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
