...
if TYPE_CHECKING:
    ...
    import aws_sdk_lightsail.types.instance_health_state
...
class InstanceHealthSummary(TypedDict, closed=True):
    ...
    instance_health: NotRequired[
        "aws_sdk_lightsail.types.instance_health_state.InstanceHealthState"
    ]
    """<p>Describes the overall instance health. Valid values are below.</p>"""
    instance_health_reason: NotRequired[
        "aws_sdk_lightsail.types.instance_health_reason.InstanceHealthReason"
    ]
...
def serialize_aws_json_1_1(value: InstanceHealthSummary) -> dict:
    ...
    if "instance_health" in value:
        ...
        out["instanceHealth"] = (
            aws_sdk_lightsail.types.instance_health_state.serialize_aws_json_1_1(
    ...
    if "instance_health_reason" in value:
        ...
        out["instanceHealthReason"] = (
            aws_sdk_lightsail.types.instance_health_reason.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InstanceHealthSummary:
    ...
    if "instanceHealth" in data:
        ...
        out["instance_health"] = (
            aws_sdk_lightsail.types.instance_health_state.deserialize_aws_json_1_1(
                data["instanceHealth"]
            )
        )
    if "instanceHealthReason" in data:
        ...
        out["instance_health_reason"] = (
            aws_sdk_lightsail.types.instance_health_reason.deserialize_aws_json_1_1(
