...
if TYPE_CHECKING:
    ...
    import aws_sdk_lightsail.types.domain_entry_options
    import aws_sdk_lightsail.types.domain_entry_type
...
class DomainEntry(TypedDict, closed=True):
    ...
    target: NotRequired["aws_sdk_lightsail.types.string.string"]
    ...
    is_alias: NotRequired["aws_sdk_lightsail.types.boolean.boolean"]
    ...
    type: NotRequired["aws_sdk_lightsail.types.domain_entry_type.DomainEntryType"]
    ...
    options: NotRequired[
        "aws_sdk_lightsail.types.domain_entry_options.DomainEntryOptions"
    ]
...
def serialize_aws_json_1_1(value: DomainEntry) -> dict:
    ...
    if "options" in value:
        ...
        out["options"] = (
            aws_sdk_lightsail.types.domain_entry_options.serialize_aws_json_1_1(
                value["options"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DomainEntry:
    ...
    if "options" in data:
        ...
        out["options"] = (
            aws_sdk_lightsail.types.domain_entry_options.deserialize_aws_json_1_1(
                data["options"]
            )
        )
    return out
