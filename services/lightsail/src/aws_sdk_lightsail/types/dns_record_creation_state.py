...
def serialize_aws_json_1_1(value: DnsRecordCreationState) -> dict:
    ...
    if "code" in value:
        ...
        out["code"] = (
            aws_sdk_lightsail.types.dns_record_creation_state_code.serialize_aws_json_1_1(
                value["code"]
            )
        )
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> DnsRecordCreationState:
    ...
    if "code" in data:
        ...
        out["code"] = (
            aws_sdk_lightsail.types.dns_record_creation_state_code.deserialize_aws_json_1_1(
                data["code"]
            )
        )
    if "message" in data:
