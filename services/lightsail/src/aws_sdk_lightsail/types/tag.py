...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.tag_key
    import aws_sdk_lightsail.types.tag_value


class Tag(TypedDict, closed=True):
    key: NotRequired["aws_sdk_lightsail.types.tag_key.TagKey"]
    ...
    value: NotRequired["aws_sdk_lightsail.types.tag_value.TagValue"]
