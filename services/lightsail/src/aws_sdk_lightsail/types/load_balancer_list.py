...
LoadBalancerList: TypeAlias = list["aws_sdk_lightsail.types.load_balancer.LoadBalancer"]
...
def serialize_aws_json_1_1(value: LoadBalancerList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_lightsail.types.load_balancer.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> LoadBalancerList:
    ...
    for item in data:
        out.append(aws_sdk_lightsail.types.load_balancer.deserialize_aws_json_1_1(item))
    return out
