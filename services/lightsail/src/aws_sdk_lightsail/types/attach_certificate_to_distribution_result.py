"""Generated from Smithy shape ``com.amazonaws.lightsail#AttachCertificateToDistributionResult``."""
...
class AttachCertificateToDistributionResult(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AttachCertificateToDistributionResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> AttachCertificateToDistributionResult:
    out: AttachCertificateToDistributionResult = {}  # type: ignore[typeddict-item]
