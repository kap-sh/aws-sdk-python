...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.container_service_state_detail_code
    import aws_sdk_lightsail.types.string


class ContainerServiceStateDetail(TypedDict):
    code: NotRequired[
        "aws_sdk_lightsail.types.container_service_state_detail_code.ContainerServiceStateDetailCode"
    ]
...
def serialize_aws_json_1_1(value: ContainerServiceStateDetail) -> dict:
    ...
    if "code" in value:
        ...
        out["code"] = (
            aws_sdk_lightsail.types.container_service_state_detail_code.serialize_aws_json_1_1(
                value["code"]
            )
        )
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> ContainerServiceStateDetail:
    ...
    if "code" in data:
        ...
        out["code"] = (
            aws_sdk_lightsail.types.container_service_state_detail_code.deserialize_aws_json_1_1(
                data["code"]
            )
        )
    if "message" in data:
