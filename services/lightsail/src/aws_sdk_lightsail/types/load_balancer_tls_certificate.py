...
if TYPE_CHECKING:
    ...
    import aws_sdk_lightsail.types.load_balancer_tls_certificate_domain_validation_record_list
    import aws_sdk_lightsail.types.load_balancer_tls_certificate_failure_reason
    import aws_sdk_lightsail.types.load_balancer_tls_certificate_renewal_summary
    import aws_sdk_lightsail.types.load_balancer_tls_certificate_revocation_reason
    import aws_sdk_lightsail.types.load_balancer_tls_certificate_status
...
class LoadBalancerTlsCertificate(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_lightsail.types.load_balancer_tls_certificate_status.LoadBalancerTlsCertificateStatus"
    ]
    ...
    domain_validation_records: NotRequired[
        "aws_sdk_lightsail.types.load_balancer_tls_certificate_domain_validation_record_list.LoadBalancerTlsCertificateDomainValidationRecordList"
    ]
    """<p>An array of LoadBalancerTlsCertificateDomainValidationRecord objects describing the records.</p>"""
    failure_reason: NotRequired[
        "aws_sdk_lightsail.types.load_balancer_tls_certificate_failure_reason.LoadBalancerTlsCertificateFailureReason"
    ]
    ...
    issuer: NotRequired["aws_sdk_lightsail.types.non_empty_string.NonEmptyString"]
    ...
    renewal_summary: NotRequired[
        "aws_sdk_lightsail.types.load_balancer_tls_certificate_renewal_summary.LoadBalancerTlsCertificateRenewalSummary"
    ]
    """<p>An object that describes the status of the certificate renewal managed by Lightsail.</p>"""
    revocation_reason: NotRequired[
        "aws_sdk_lightsail.types.load_balancer_tls_certificate_revocation_reason.LoadBalancerTlsCertificateRevocationReason"
    ]
    ...
    serial: NotRequired["aws_sdk_lightsail.types.non_empty_string.NonEmptyString"]
    """<p>The serial number of the certificate.</p>"""
    signature_algorithm: NotRequired[
        "aws_sdk_lightsail.types.non_empty_string.NonEmptyString"
    ]
    """<p>The algorithm that was used to sign the certificate.</p>"""
    subject: NotRequired["aws_sdk_lightsail.types.non_empty_string.NonEmptyString"]
...
def serialize_aws_json_1_1(value: LoadBalancerTlsCertificate) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = (
            aws_sdk_lightsail.types.load_balancer_tls_certificate_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    ...
    if "domain_validation_records" in value:
        ...
        out["domainValidationRecords"] = (
            aws_sdk_lightsail.types.load_balancer_tls_certificate_domain_validation_record_list.serialize_aws_json_1_1(
    ...
    if "failure_reason" in value:
        ...
        out["failureReason"] = (
            aws_sdk_lightsail.types.load_balancer_tls_certificate_failure_reason.serialize_aws_json_1_1(
    ...
    if "renewal_summary" in value:
        ...
        out["renewalSummary"] = (
            aws_sdk_lightsail.types.load_balancer_tls_certificate_renewal_summary.serialize_aws_json_1_1(
    ...
    if "revocation_reason" in value:
        ...
        out["revocationReason"] = (
            aws_sdk_lightsail.types.load_balancer_tls_certificate_revocation_reason.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LoadBalancerTlsCertificate:
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_lightsail.types.load_balancer_tls_certificate_status.deserialize_aws_json_1_1(
                data["status"]
            )
        )
    ...
    if "domainValidationRecords" in data:
        ...
        out["domain_validation_records"] = (
            aws_sdk_lightsail.types.load_balancer_tls_certificate_domain_validation_record_list.deserialize_aws_json_1_1(
    ...
    if "failureReason" in data:
        ...
        out["failure_reason"] = (
            aws_sdk_lightsail.types.load_balancer_tls_certificate_failure_reason.deserialize_aws_json_1_1(
                data["failureReason"]
            )
        )
    if "issuedAt" in data:
    ...
    if "renewalSummary" in data:
        ...
        out["renewal_summary"] = (
            aws_sdk_lightsail.types.load_balancer_tls_certificate_renewal_summary.deserialize_aws_json_1_1(
                data["renewalSummary"]
            )
        )
    if "revocationReason" in data:
        ...
        out["revocation_reason"] = (
            aws_sdk_lightsail.types.load_balancer_tls_certificate_revocation_reason.deserialize_aws_json_1_1(
