...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.container_service_ecr_image_puller_role


class PrivateRegistryAccess(TypedDict):
    ecr_image_puller_role: NotRequired[
        "aws_sdk_lightsail.types.container_service_ecr_image_puller_role.ContainerServiceECRImagePullerRole"
    ]
...
def serialize_aws_json_1_1(value: PrivateRegistryAccess) -> dict:
    ...
    if "ecr_image_puller_role" in value:
        ...
        out["ecrImagePullerRole"] = (
            aws_sdk_lightsail.types.container_service_ecr_image_puller_role.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> PrivateRegistryAccess:
    ...
    if "ecrImagePullerRole" in data:
        ...
        out["ecr_image_puller_role"] = (
            aws_sdk_lightsail.types.container_service_ecr_image_puller_role.deserialize_aws_json_1_1(
