...
class InstancePortInfo(TypedDict):
    ...
    access_from: NotRequired["aws_sdk_lightsail.types.string.string"]
    ...
    access_type: NotRequired["aws_sdk_lightsail.types.port_access_type.PortAccessType"]
    """<p>The type of access (<code>Public</code> or <code>Private</code>).</p>"""
    common_name: NotRequired["aws_sdk_lightsail.types.string.string"]
    """<p>The common name of the port information.</p>"""
    access_direction: NotRequired[
        "aws_sdk_lightsail.types.access_direction.AccessDirection"
    ]
...
def serialize_aws_json_1_1(value: InstancePortInfo) -> dict:
    ...
    if "access_type" in value:
        ...
        out["accessType"] = (
            aws_sdk_lightsail.types.port_access_type.serialize_aws_json_1_1(
                value["access_type"]
            )
        )
    ...
    if "access_direction" in value:
        ...
        out["accessDirection"] = (
            aws_sdk_lightsail.types.access_direction.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InstancePortInfo:
    ...
    if "accessType" in data:
        ...
        out["access_type"] = (
            aws_sdk_lightsail.types.port_access_type.deserialize_aws_json_1_1(
                data["accessType"]
            )
        )
    ...
    if "accessDirection" in data:
        ...
        out["access_direction"] = (
            aws_sdk_lightsail.types.access_direction.deserialize_aws_json_1_1(
