"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateDiskFromSnapshotResult``."""
...
class CreateDiskFromSnapshotResult(TypedDict, closed=True):
    operations: NotRequired["aws_sdk_lightsail.types.operation_list.OperationList"]
    """<p>An array of objects that describe the result of the action, such as the status of the request, the timestamp of the request, and the resources affected by the request.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateDiskFromSnapshotResult) -> dict:
    out: dict = {}
