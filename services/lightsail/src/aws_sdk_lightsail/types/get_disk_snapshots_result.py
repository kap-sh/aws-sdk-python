...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.disk_snapshot_list
    import aws_sdk_lightsail.types.string


class GetDiskSnapshotsResult(TypedDict):
    disk_snapshots: NotRequired[
        "aws_sdk_lightsail.types.disk_snapshot_list.DiskSnapshotList"
    ]
...
def serialize_aws_json_1_1(value: GetDiskSnapshotsResult) -> dict:
    ...
    if "disk_snapshots" in value:
        ...
        out["diskSnapshots"] = (
            aws_sdk_lightsail.types.disk_snapshot_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetDiskSnapshotsResult:
    ...
    if "diskSnapshots" in data:
        ...
        out["disk_snapshots"] = (
            aws_sdk_lightsail.types.disk_snapshot_list.deserialize_aws_json_1_1(
                data["diskSnapshots"]
            )
        )
