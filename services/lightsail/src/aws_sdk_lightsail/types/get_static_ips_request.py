"""Generated from Smithy shape ``com.amazonaws.lightsail#GetStaticIpsRequest``."""
...
class GetStaticIpsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetStaticIpsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetStaticIpsRequest:
    out: GetStaticIpsRequest = {}  # type: ignore[typeddict-item]
