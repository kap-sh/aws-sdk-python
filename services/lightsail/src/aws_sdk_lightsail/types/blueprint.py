...
if TYPE_CHECKING:
    ...
    import aws_sdk_lightsail.types.blueprint_type
...
class Blueprint(TypedDict):
    ...
    group: NotRequired["aws_sdk_lightsail.types.non_empty_string.NonEmptyString"]
    """<p>The group name of the blueprint (<code>amazon-linux</code>).</p>"""
    type: NotRequired["aws_sdk_lightsail.types.blueprint_type.BlueprintType"]
    ...
    min_power: NotRequired["aws_sdk_lightsail.types.integer.integer"]
    ...
    version_code: NotRequired["aws_sdk_lightsail.types.string.string"]
    """<p>The version code.</p>"""
    product_url: NotRequired["aws_sdk_lightsail.types.string.string"]
    """<p>The product URL to learn more about the image or blueprint.</p>"""
    license_url: NotRequired["aws_sdk_lightsail.types.string.string"]
    """<p>The end-user license agreement URL for the image or blueprint.</p>"""
    platform: NotRequired["aws_sdk_lightsail.types.instance_platform.InstancePlatform"]
...
def serialize_aws_json_1_1(value: Blueprint) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = aws_sdk_lightsail.types.blueprint_type.serialize_aws_json_1_1(
            value["type"]
        )
    ...
    if "platform" in value:
        ...
        out["platform"] = (
            aws_sdk_lightsail.types.instance_platform.serialize_aws_json_1_1(
                value["platform"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> Blueprint:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_lightsail.types.blueprint_type.deserialize_aws_json_1_1(
            data["type"]
        )
    ...
    if "platform" in data:
        ...
        out["platform"] = (
            aws_sdk_lightsail.types.instance_platform.deserialize_aws_json_1_1(
                data["platform"]
            )
        )
