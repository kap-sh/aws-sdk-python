...
class GetLoadBalancersResult(TypedDict):
    load_balancers: NotRequired[
        "aws_sdk_lightsail.types.load_balancer_list.LoadBalancerList"
    ]
...
def serialize_aws_json_1_1(value: GetLoadBalancersResult) -> dict:
    ...
    if "load_balancers" in value:
        ...
        out["loadBalancers"] = (
            aws_sdk_lightsail.types.load_balancer_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetLoadBalancersResult:
    ...
    if "loadBalancers" in data:
        ...
        out["load_balancers"] = (
            aws_sdk_lightsail.types.load_balancer_list.deserialize_aws_json_1_1(
                data["loadBalancers"]
            )
        )
