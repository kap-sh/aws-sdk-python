...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.relational_database_bundle

RelationalDatabaseBundleList: TypeAlias = list[
    "aws_sdk_lightsail.types.relational_database_bundle.RelationalDatabaseBundle"
]
...
def serialize_aws_json_1_1(value: RelationalDatabaseBundleList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_lightsail.types.relational_database_bundle.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> RelationalDatabaseBundleList:
    ...
    for item in data:
        out.append(
            aws_sdk_lightsail.types.relational_database_bundle.deserialize_aws_json_1_1(
                item
            )
        )
    return out
