...
if TYPE_CHECKING:
    ...
    import aws_sdk_lightsail.types.port_info_source_type
...
class InstanceEntry(TypedDict, closed=True):
    ...
    port_info_source: "aws_sdk_lightsail.types.port_info_source_type.PortInfoSourceType"
...
def serialize_aws_json_1_1(value: InstanceEntry) -> dict:
    ...
    out["portInfoSource"] = (
        aws_sdk_lightsail.types.port_info_source_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InstanceEntry:
    ...
    if "portInfoSource" in data:
        ...
        out["port_info_source"] = (
            aws_sdk_lightsail.types.port_info_source_type.deserialize_aws_json_1_1(
                data["portInfoSource"]
            )
        )
    else:
