...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.load_balancer_tls_certificate_summary

LoadBalancerTlsCertificateSummaryList: TypeAlias = list[
    "aws_sdk_lightsail.types.load_balancer_tls_certificate_summary.LoadBalancerTlsCertificateSummary"
]
...
def serialize_aws_json_1_1(value: LoadBalancerTlsCertificateSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_lightsail.types.load_balancer_tls_certificate_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> LoadBalancerTlsCertificateSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_lightsail.types.load_balancer_tls_certificate_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
