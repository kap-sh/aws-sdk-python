...
if TYPE_CHECKING:
    ...
    import aws_sdk_lightsail.types.renewal_status
    import aws_sdk_lightsail.types.renewal_status_reason
...
class RenewalSummary(TypedDict):
    ...
    renewal_status: NotRequired["aws_sdk_lightsail.types.renewal_status.RenewalStatus"]
    ...
    renewal_status_reason: NotRequired[
        "aws_sdk_lightsail.types.renewal_status_reason.RenewalStatusReason"
    ]
    """<p>The reason for the renewal status of the certificate.</p>"""
    updated_at: NotRequired["aws_sdk_lightsail.types.iso_date.IsoDate"]
...
def serialize_aws_json_1_1(value: RenewalSummary) -> dict:
    ...
    if "renewal_status" in value:
        ...
        out["renewalStatus"] = (
            aws_sdk_lightsail.types.renewal_status.serialize_aws_json_1_1(
    ...
    if "updated_at" in value:
        ...
        out["updatedAt"] = aws_sdk_lightsail.types.iso_date.serialize_aws_json_1_1(
            value["updated_at"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> RenewalSummary:
    ...
    if "renewalStatus" in data:
        ...
        out["renewal_status"] = (
            aws_sdk_lightsail.types.renewal_status.deserialize_aws_json_1_1(
                data["renewalStatus"]
            )
        )
    ...
    if "updatedAt" in data:
        ...
        out["updated_at"] = aws_sdk_lightsail.types.iso_date.deserialize_aws_json_1_1(
            data["updatedAt"]
        )
    return out
