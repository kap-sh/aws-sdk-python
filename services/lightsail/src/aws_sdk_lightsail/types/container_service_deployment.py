...
if TYPE_CHECKING:
    ...
    import aws_sdk_lightsail.types.container_service_deployment_state
    import aws_sdk_lightsail.types.container_service_endpoint
...
class ContainerServiceDeployment(TypedDict, closed=True):
    ...
    state: NotRequired[
        "aws_sdk_lightsail.types.container_service_deployment_state.ContainerServiceDeploymentState"
    ]
    ...
    public_endpoint: NotRequired[
        "aws_sdk_lightsail.types.container_service_endpoint.ContainerServiceEndpoint"
    ]
...
def serialize_aws_json_1_1(value: ContainerServiceDeployment) -> dict:
    ...
    if "state" in value:
        ...
        out["state"] = (
            aws_sdk_lightsail.types.container_service_deployment_state.serialize_aws_json_1_1(
                value["state"]
            )
        )
    ...
    if "public_endpoint" in value:
        ...
        out["publicEndpoint"] = (
            aws_sdk_lightsail.types.container_service_endpoint.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ContainerServiceDeployment:
    ...
    if "state" in data:
        ...
        out["state"] = (
            aws_sdk_lightsail.types.container_service_deployment_state.deserialize_aws_json_1_1(
                data["state"]
            )
        )
    ...
    if "publicEndpoint" in data:
        ...
        out["public_endpoint"] = (
            aws_sdk_lightsail.types.container_service_endpoint.deserialize_aws_json_1_1(
                data["publicEndpoint"]
            )
        )
