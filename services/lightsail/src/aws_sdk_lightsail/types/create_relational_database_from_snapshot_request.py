...
class CreateRelationalDatabaseFromSnapshotRequest(TypedDict):
    ...
    relational_database_bundle_id: NotRequired["aws_sdk_lightsail.types.string.string"]
    ...
    restore_time: NotRequired["aws_sdk_lightsail.types.iso_date.IsoDate"]
    ...
    use_latest_restorable_time: NotRequired["aws_sdk_lightsail.types.boolean.boolean"]
...
def serialize_aws_json_1_1(value: CreateRelationalDatabaseFromSnapshotRequest) -> dict:
    ...
    if "restore_time" in value:
        ...
        out["restoreTime"] = aws_sdk_lightsail.types.iso_date.serialize_aws_json_1_1(
            value["restore_time"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> CreateRelationalDatabaseFromSnapshotRequest:
    ...
    if "restoreTime" in data:
        ...
        out["restore_time"] = aws_sdk_lightsail.types.iso_date.deserialize_aws_json_1_1(
            data["restoreTime"]
        )
