"""Generated from Smithy shape ``com.amazonaws.lightsail#GetRelationalDatabaseBlueprintsResult``."""
...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.relational_database_blueprint_list
    import aws_sdk_lightsail.types.string


class GetRelationalDatabaseBlueprintsResult(TypedDict, closed=True):
    blueprints: NotRequired[
        "aws_sdk_lightsail.types.relational_database_blueprint_list.RelationalDatabaseBlueprintList"
    ]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetRelationalDatabaseBlueprintsResult) -> dict:
    out: dict = {}
    if "blueprints" in value:
        import aws_sdk_lightsail.types.relational_database_blueprint_list

        out["blueprints"] = (
            aws_sdk_lightsail.types.relational_database_blueprint_list.serialize_aws_json_1_1(
                value["blueprints"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetRelationalDatabaseBlueprintsResult:
    ...
    if "blueprints" in data:
        ...
        out["blueprints"] = (
            aws_sdk_lightsail.types.relational_database_blueprint_list.deserialize_aws_json_1_1(
                data["blueprints"]
            )
        )
