...
if TYPE_CHECKING:
    ...
    import aws_sdk_lightsail.types.origin_ip_address_type_enum
    import aws_sdk_lightsail.types.origin_protocol_policy_enum
    import aws_sdk_lightsail.types.region_name
    import aws_sdk_lightsail.types.resource_name


class InputOrigin(TypedDict):
    ...
    protocol_policy: NotRequired[
        "aws_sdk_lightsail.types.origin_protocol_policy_enum.OriginProtocolPolicyEnum"
    ]
    ...
    response_timeout: NotRequired["aws_sdk_lightsail.types.integer.integer"]
    ...
    ip_address_type: NotRequired[
        "aws_sdk_lightsail.types.origin_ip_address_type_enum.OriginIpAddressTypeEnum"
    ]
...
def serialize_aws_json_1_1(value: InputOrigin) -> dict:
    ...
    if "protocol_policy" in value:
        ...
        out["protocolPolicy"] = (
            aws_sdk_lightsail.types.origin_protocol_policy_enum.serialize_aws_json_1_1(
    ...
    if "ip_address_type" in value:
        ...
        out["ipAddressType"] = (
            aws_sdk_lightsail.types.origin_ip_address_type_enum.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InputOrigin:
    ...
    if "protocolPolicy" in data:
        ...
        out["protocol_policy"] = (
            aws_sdk_lightsail.types.origin_protocol_policy_enum.deserialize_aws_json_1_1(
                data["protocolPolicy"]
            )
        )
    ...
    if "ipAddressType" in data:
        ...
        out["ip_address_type"] = (
            aws_sdk_lightsail.types.origin_ip_address_type_enum.deserialize_aws_json_1_1(
                data["ipAddressType"]
            )
        )
    return out
