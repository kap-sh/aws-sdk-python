...
class AccessKeyLastUsed(TypedDict, closed=True):
    last_used_date: NotRequired["aws_sdk_lightsail.types.iso_date.IsoDate"]
    ...
    region: NotRequired["aws_sdk_lightsail.types.string.string"]
    ...
    service_name: NotRequired["aws_sdk_lightsail.types.string.string"]
...
def serialize_aws_json_1_1(value: AccessKeyLastUsed) -> dict:
    ...
    if "last_used_date" in value:
        ...
        out["lastUsedDate"] = aws_sdk_lightsail.types.iso_date.serialize_aws_json_1_1(
