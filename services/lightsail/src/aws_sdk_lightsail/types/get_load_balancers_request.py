"""Generated from Smithy shape ``com.amazonaws.lightsail#GetLoadBalancersRequest``."""
...
class GetLoadBalancersRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetLoadBalancersRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetLoadBalancersRequest:
    out: GetLoadBalancersRequest = {}  # type: ignore[typeddict-item]
