...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.key_pair_list
    import aws_sdk_lightsail.types.string


class GetKeyPairsResult(TypedDict):
    key_pairs: NotRequired["aws_sdk_lightsail.types.key_pair_list.KeyPairList"]
...
def serialize_aws_json_1_1(value: GetKeyPairsResult) -> dict:
    ...
    if "key_pairs" in value:
        ...
        out["keyPairs"] = aws_sdk_lightsail.types.key_pair_list.serialize_aws_json_1_1(
            value["key_pairs"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetKeyPairsResult:
    ...
    if "keyPairs" in data:
        ...
        out["key_pairs"] = (
            aws_sdk_lightsail.types.key_pair_list.deserialize_aws_json_1_1(
                data["keyPairs"]
            )
        )
