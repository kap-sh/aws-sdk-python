...
if TYPE_CHECKING:
    ...
    import aws_sdk_lightsail.types.monitored_resource_info
...
class Alarm(TypedDict):
    ...
    monitored_resource_info: NotRequired[
        "aws_sdk_lightsail.types.monitored_resource_info.MonitoredResourceInfo"
    ]
    ...
    evaluation_periods: NotRequired["aws_sdk_lightsail.types.integer.integer"]
    """<p>The number of periods over which data is compared to the specified threshold.</p>"""
    period: NotRequired["aws_sdk_lightsail.types.metric_period.MetricPeriod"]
    """<p>The period, in seconds, over which the statistic is applied.</p>"""
    threshold: NotRequired["aws_sdk_lightsail.types.double.double"]
    ...
    statistic: NotRequired["aws_sdk_lightsail.types.metric_statistic.MetricStatistic"]
    ...
    metric_name: NotRequired["aws_sdk_lightsail.types.metric_name.MetricName"]
    """<p>The name of the metric associated with the alarm.</p>"""
    state: NotRequired["aws_sdk_lightsail.types.alarm_state.AlarmState"]
...
def serialize_aws_json_1_1(value: Alarm) -> dict:
    ...
    if "monitored_resource_info" in value:
        ...
        out["monitoredResourceInfo"] = (
            aws_sdk_lightsail.types.monitored_resource_info.serialize_aws_json_1_1(
    ...
    if "statistic" in value:
        ...
        out["statistic"] = (
            aws_sdk_lightsail.types.metric_statistic.serialize_aws_json_1_1(
                value["statistic"]
            )
        )
    ...
    if "state" in value:
        ...
        out["state"] = aws_sdk_lightsail.types.alarm_state.serialize_aws_json_1_1(
            value["state"]
        )
    if "unit" in value:
        import aws_sdk_lightsail.types.metric_unit
...
def deserialize_aws_json_1_1(data: dict) -> Alarm:
    ...
    if "monitoredResourceInfo" in data:
        ...
        out["monitored_resource_info"] = (
            aws_sdk_lightsail.types.monitored_resource_info.deserialize_aws_json_1_1(
    ...
    if "statistic" in data:
        ...
        out["statistic"] = (
            aws_sdk_lightsail.types.metric_statistic.deserialize_aws_json_1_1(
                data["statistic"]
            )
        )
    ...
    if "state" in data:
        ...
        out["state"] = aws_sdk_lightsail.types.alarm_state.deserialize_aws_json_1_1(
            data["state"]
        )
    if "unit" in data:
        import aws_sdk_lightsail.types.metric_unit
