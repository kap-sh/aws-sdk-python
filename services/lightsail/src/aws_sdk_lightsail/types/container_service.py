...
if TYPE_CHECKING:
    ...
    import aws_sdk_lightsail.types.container_service_state
    import aws_sdk_lightsail.types.container_service_state_detail
    import aws_sdk_lightsail.types.iso_date
    import aws_sdk_lightsail.types.non_empty_string
    import aws_sdk_lightsail.types.private_registry_access
...
class ContainerService(TypedDict):
    ...
    state: NotRequired[
        "aws_sdk_lightsail.types.container_service_state.ContainerServiceState"
    ]
    ...
    state_detail: NotRequired[
        "aws_sdk_lightsail.types.container_service_state_detail.ContainerServiceStateDetail"
    ]
    ...
    private_domain_name: NotRequired["aws_sdk_lightsail.types.string.string"]
    ...
    url: NotRequired["aws_sdk_lightsail.types.string.string"]
    ...
    private_registry_access: NotRequired[
        "aws_sdk_lightsail.types.private_registry_access.PrivateRegistryAccess"
    ]
...
def serialize_aws_json_1_1(value: ContainerService) -> dict:
    ...
    if "state" in value:
        ...
        out["state"] = (
            aws_sdk_lightsail.types.container_service_state.serialize_aws_json_1_1(
                value["state"]
            )
        )
    if "state_detail" in value:
        ...
        out["stateDetail"] = (
            aws_sdk_lightsail.types.container_service_state_detail.serialize_aws_json_1_1(
                value["state_detail"]
            )
        )
    if "scale" in value:
    ...
    if "private_registry_access" in value:
        ...
        out["privateRegistryAccess"] = (
            aws_sdk_lightsail.types.private_registry_access.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ContainerService:
    ...
    if "state" in data:
        ...
        out["state"] = (
            aws_sdk_lightsail.types.container_service_state.deserialize_aws_json_1_1(
                data["state"]
            )
        )
    if "stateDetail" in data:
        ...
        out["state_detail"] = (
            aws_sdk_lightsail.types.container_service_state_detail.deserialize_aws_json_1_1(
                data["stateDetail"]
            )
        )
    if "scale" in data:
    ...
    if "privateRegistryAccess" in data:
        ...
        out["private_registry_access"] = (
            aws_sdk_lightsail.types.private_registry_access.deserialize_aws_json_1_1(
