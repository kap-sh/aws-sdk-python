...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.domain_validation_record

DomainValidationRecordList: TypeAlias = list[
    "aws_sdk_lightsail.types.domain_validation_record.DomainValidationRecord"
]
...
def serialize_aws_json_1_1(value: DomainValidationRecordList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_lightsail.types.domain_validation_record.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> DomainValidationRecordList:
    ...
    for item in data:
        out.append(
            aws_sdk_lightsail.types.domain_validation_record.deserialize_aws_json_1_1(
                item
            )
        )
    return out
