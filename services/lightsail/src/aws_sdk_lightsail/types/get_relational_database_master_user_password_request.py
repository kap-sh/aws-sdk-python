...
def serialize_aws_json_1_1(
    ...
    if "password_version" in value:
        ...
        out["passwordVersion"] = (
            aws_sdk_lightsail.types.relational_database_password_version.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "passwordVersion" in data:
        ...
        out["password_version"] = (
            aws_sdk_lightsail.types.relational_database_password_version.deserialize_aws_json_1_1(
