...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.availability_zone

AvailabilityZoneList: TypeAlias = list[
    "aws_sdk_lightsail.types.availability_zone.AvailabilityZone"
]
...
def serialize_aws_json_1_1(value: AvailabilityZoneList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_lightsail.types.availability_zone.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AvailabilityZoneList:
    ...
    for item in data:
        out.append(
            aws_sdk_lightsail.types.availability_zone.deserialize_aws_json_1_1(item)
        )
    return out
