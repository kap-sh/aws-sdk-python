"""Generated from Smithy shape ``com.amazonaws.lightsail#DetachCertificateFromDistributionResult``."""
...
class DetachCertificateFromDistributionResult(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DetachCertificateFromDistributionResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DetachCertificateFromDistributionResult:
    out: DetachCertificateFromDistributionResult = {}  # type: ignore[typeddict-item]
