...
if TYPE_CHECKING:
    import aws_sdk_lightsail.types.availability_zone_list
    import aws_sdk_lightsail.types.region_name
    import aws_sdk_lightsail.types.string


class Region(TypedDict):
    continent_code: NotRequired["aws_sdk_lightsail.types.string.string"]
    ...
    display_name: NotRequired["aws_sdk_lightsail.types.string.string"]
    """<p>The display name (<code>Ohio</code>).</p>"""
    name: NotRequired["aws_sdk_lightsail.types.region_name.RegionName"]
    """<p>The region name (<code>us-east-2</code>).</p>"""
    availability_zones: NotRequired[
        "aws_sdk_lightsail.types.availability_zone_list.AvailabilityZoneList"
    ]
...
def serialize_aws_json_1_1(value: Region) -> dict:
    ...
    if "name" in value:
        ...
        out["name"] = aws_sdk_lightsail.types.region_name.serialize_aws_json_1_1(
            value["name"]
        )
    if "availability_zones" in value:
        ...
        out["availabilityZones"] = (
            aws_sdk_lightsail.types.availability_zone_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Region:
    ...
    if "name" in data:
        ...
        out["name"] = aws_sdk_lightsail.types.region_name.deserialize_aws_json_1_1(
            data["name"]
        )
    if "availabilityZones" in data:
        ...
        out["availability_zones"] = (
            aws_sdk_lightsail.types.availability_zone_list.deserialize_aws_json_1_1(
