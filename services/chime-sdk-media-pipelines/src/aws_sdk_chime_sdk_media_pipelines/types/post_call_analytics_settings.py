...
if TYPE_CHECKING:
    import aws_sdk_chime_sdk_media_pipelines.types.content_redaction_output
...
def serialize_json(value: PostCallAnalyticsSettings) -> dict:
    ...
    if "content_redaction_output" in value:
        ...
        out["ContentRedactionOutput"] = (
            aws_sdk_chime_sdk_media_pipelines.types.content_redaction_output.serialize_json(
...
def deserialize_json(data: dict) -> PostCallAnalyticsSettings:
    ...
    if "ContentRedactionOutput" in data:
        ...
        out["content_redaction_output"] = (
            aws_sdk_chime_sdk_media_pipelines.types.content_redaction_output.deserialize_json(
