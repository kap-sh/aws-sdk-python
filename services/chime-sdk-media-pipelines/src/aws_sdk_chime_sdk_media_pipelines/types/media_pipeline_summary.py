"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#MediaPipelineSummary``."""
...
class MediaPipelineSummary(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: MediaPipelineSummary) -> dict:
    out: dict = {}
