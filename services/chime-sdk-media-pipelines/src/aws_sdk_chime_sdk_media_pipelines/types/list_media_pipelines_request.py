"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#ListMediaPipelinesRequest``."""
...
class ListMediaPipelinesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListMediaPipelinesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListMediaPipelinesRequest:
    out: ListMediaPipelinesRequest = {}  # type: ignore[typeddict-item]
    return out
