...
if TYPE_CHECKING:
    ...
    import aws_sdk_chime_sdk_media_pipelines.types.media_pipeline_task_status


class VoiceToneAnalysisTask(TypedDict):
    ...
    voice_tone_analysis_task_status: NotRequired[
        "aws_sdk_chime_sdk_media_pipelines.types.media_pipeline_task_status.MediaPipelineTaskStatus"
    ]
...
def serialize_json(value: VoiceToneAnalysisTask) -> dict:
    ...
    if "voice_tone_analysis_task_status" in value:
        ...
        out["VoiceToneAnalysisTaskStatus"] = (
            aws_sdk_chime_sdk_media_pipelines.types.media_pipeline_task_status.serialize_json(
...
def deserialize_json(data: dict) -> VoiceToneAnalysisTask:
    ...
    if "VoiceToneAnalysisTaskStatus" in data:
        ...
        out["voice_tone_analysis_task_status"] = (
            aws_sdk_chime_sdk_media_pipelines.types.media_pipeline_task_status.deserialize_json(
