...
class ListMediaPipelineKinesisVideoStreamPoolsResponse(TypedDict):
    kinesis_video_stream_pools: NotRequired[
        "aws_sdk_chime_sdk_media_pipelines.types.kinesis_video_stream_pool_summary_list.KinesisVideoStreamPoolSummaryList"
    ]
...
def serialize_json(value: ListMediaPipelineKinesisVideoStreamPoolsResponse) -> dict:
    ...
    if "kinesis_video_stream_pools" in value:
        ...
        out["KinesisVideoStreamPools"] = (
            aws_sdk_chime_sdk_media_pipelines.types.kinesis_video_stream_pool_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListMediaPipelineKinesisVideoStreamPoolsResponse:
    ...
    if "KinesisVideoStreamPools" in data:
        ...
        out["kinesis_video_stream_pools"] = (
            aws_sdk_chime_sdk_media_pipelines.types.kinesis_video_stream_pool_summary_list.deserialize_json(
