...
if TYPE_CHECKING:
    import aws_sdk_chime_sdk_media_pipelines.types.channel_definitions
    import aws_sdk_chime_sdk_media_pipelines.types.number_of_channels


class StreamChannelDefinition(TypedDict):
    number_of_channels: (
        "aws_sdk_chime_sdk_media_pipelines.types.number_of_channels.NumberOfChannels"
    )
    """<p>The number of channels in a streaming channel.</p>"""
    channel_definitions: NotRequired[
        "aws_sdk_chime_sdk_media_pipelines.types.channel_definitions.ChannelDefinitions"
    ]
...
def serialize_json(value: StreamChannelDefinition) -> dict:
    ...
    if "channel_definitions" in value:
        ...
        out["ChannelDefinitions"] = (
            aws_sdk_chime_sdk_media_pipelines.types.channel_definitions.serialize_json(
...
def deserialize_json(data: dict) -> StreamChannelDefinition:
    ...
    if "ChannelDefinitions" in data:
        ...
        out["channel_definitions"] = (
            aws_sdk_chime_sdk_media_pipelines.types.channel_definitions.deserialize_json(
