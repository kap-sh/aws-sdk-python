...
class MediaStreamPipeline(TypedDict):
    ...
    sources: NotRequired[
        "aws_sdk_chime_sdk_media_pipelines.types.media_stream_source_list.MediaStreamSourceList"
    ]
    """<p>The media stream pipeline's data sources.</p>"""
    sinks: NotRequired[
        "aws_sdk_chime_sdk_media_pipelines.types.media_stream_sink_list.MediaStreamSinkList"
    ]
