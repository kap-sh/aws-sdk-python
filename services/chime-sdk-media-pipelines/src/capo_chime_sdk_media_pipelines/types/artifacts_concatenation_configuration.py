...
class ArtifactsConcatenationConfiguration(TypedDict, closed=True):
    audio: "capo_chime_sdk_media_pipelines.types.audio_concatenation_configuration.AudioConcatenationConfiguration"
    """<p>The configuration for the audio artifacts concatenation.</p>"""
    video: "capo_chime_sdk_media_pipelines.types.video_concatenation_configuration.VideoConcatenationConfiguration"
    """<p>The configuration for the video artifacts concatenation.</p>"""
    content: "capo_chime_sdk_media_pipelines.types.content_concatenation_configuration.ContentConcatenationConfiguration"
    """<p>The configuration for the content artifacts concatenation.</p>"""
    data_channel: "capo_chime_sdk_media_pipelines.types.data_channel_concatenation_configuration.DataChannelConcatenationConfiguration"
    """<p>The configuration for the data channel artifacts concatenation.</p>"""
    transcription_messages: "capo_chime_sdk_media_pipelines.types.transcription_messages_concatenation_configuration.TranscriptionMessagesConcatenationConfiguration"
    """<p>The configuration for the transcription messages artifacts concatenation.</p>"""
    meeting_events: "capo_chime_sdk_media_pipelines.types.meeting_events_concatenation_configuration.MeetingEventsConcatenationConfiguration"
    """<p>The configuration for the meeting events artifacts concatenation.</p>"""
    composited_video: "capo_chime_sdk_media_pipelines.types.composited_video_concatenation_configuration.CompositedVideoConcatenationConfiguration"
...
def serialize_json(value: ArtifactsConcatenationConfiguration) -> dict:
    ...
    out["Audio"] = (
        capo_chime_sdk_media_pipelines.types.audio_concatenation_configuration.serialize_json(
            value["audio"]
        )
    )
    import capo_chime_sdk_media_pipelines.types.video_concatenation_configuration
    ...
    out["Video"] = (
        capo_chime_sdk_media_pipelines.types.video_concatenation_configuration.serialize_json(
            value["video"]
        )
    )
    import capo_chime_sdk_media_pipelines.types.content_concatenation_configuration
    ...
    out["Content"] = (
        capo_chime_sdk_media_pipelines.types.content_concatenation_configuration.serialize_json(
            value["content"]
        )
    )
    import capo_chime_sdk_media_pipelines.types.data_channel_concatenation_configuration
    ...
    out["DataChannel"] = (
        capo_chime_sdk_media_pipelines.types.data_channel_concatenation_configuration.serialize_json(
            value["data_channel"]
        )
    )
    import capo_chime_sdk_media_pipelines.types.transcription_messages_concatenation_configuration
    ...
    out["TranscriptionMessages"] = (
        capo_chime_sdk_media_pipelines.types.transcription_messages_concatenation_configuration.serialize_json(
    ...
    out["MeetingEvents"] = (
        capo_chime_sdk_media_pipelines.types.meeting_events_concatenation_configuration.serialize_json(
    ...
    out["CompositedVideo"] = (
        capo_chime_sdk_media_pipelines.types.composited_video_concatenation_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ArtifactsConcatenationConfiguration:
    ...
    if "Audio" in data:
        ...
        out["audio"] = (
            capo_chime_sdk_media_pipelines.types.audio_concatenation_configuration.deserialize_json(
                data["Audio"]
            )
        )
    else:
    ...
    if "Video" in data:
        ...
        out["video"] = (
            capo_chime_sdk_media_pipelines.types.video_concatenation_configuration.deserialize_json(
                data["Video"]
            )
        )
    else:
    ...
    if "Content" in data:
        ...
        out["content"] = (
            capo_chime_sdk_media_pipelines.types.content_concatenation_configuration.deserialize_json(
                data["Content"]
            )
        )
    else:
    ...
    if "DataChannel" in data:
        ...
        out["data_channel"] = (
            capo_chime_sdk_media_pipelines.types.data_channel_concatenation_configuration.deserialize_json(
                data["DataChannel"]
            )
        )
    else:
    ...
    if "TranscriptionMessages" in data:
        ...
        out["transcription_messages"] = (
            capo_chime_sdk_media_pipelines.types.transcription_messages_concatenation_configuration.deserialize_json(
    ...
    if "MeetingEvents" in data:
        ...
        out["meeting_events"] = (
            capo_chime_sdk_media_pipelines.types.meeting_events_concatenation_configuration.deserialize_json(
                data["MeetingEvents"]
            )
        )
    else:
    ...
    if "CompositedVideo" in data:
        ...
        out["composited_video"] = (
            capo_chime_sdk_media_pipelines.types.composited_video_concatenation_configuration.deserialize_json(
