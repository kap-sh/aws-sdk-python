...
if TYPE_CHECKING:
    ...
    import capo_chime_sdk_media_pipelines.types.border_thickness
    import capo_chime_sdk_media_pipelines.types.corner_radius
...
class VideoAttribute(TypedDict, closed=True):
    corner_radius: NotRequired[
        "capo_chime_sdk_media_pipelines.types.corner_radius.CornerRadius"
    ]
    """<p>Sets the corner radius of all video tiles.</p>"""
    border_color: NotRequired[
        "capo_chime_sdk_media_pipelines.types.border_color.BorderColor"
    ]
    """<p>Defines the border color of all video tiles.</p>"""
    highlight_color: NotRequired[
        "capo_chime_sdk_media_pipelines.types.highlight_color.HighlightColor"
    ]
    """<p>Defines the highlight color for the active video tile.</p>"""
    border_thickness: NotRequired[
        "capo_chime_sdk_media_pipelines.types.border_thickness.BorderThickness"
    ]
...
def serialize_json(value: VideoAttribute) -> dict:
    ...
    if "border_color" in value:
        ...
        out["BorderColor"] = (
            capo_chime_sdk_media_pipelines.types.border_color.serialize_json(
                value["border_color"]
            )
        )
    if "highlight_color" in value:
        ...
        out["HighlightColor"] = (
            capo_chime_sdk_media_pipelines.types.highlight_color.serialize_json(
...
def deserialize_json(data: dict) -> VideoAttribute:
    ...
    if "BorderColor" in data:
        ...
        out["border_color"] = (
            capo_chime_sdk_media_pipelines.types.border_color.deserialize_json(
                data["BorderColor"]
            )
        )
    if "HighlightColor" in data:
        ...
        out["highlight_color"] = (
            capo_chime_sdk_media_pipelines.types.highlight_color.deserialize_json(
                data["HighlightColor"]
            )
        )
