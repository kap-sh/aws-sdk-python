...
if TYPE_CHECKING:
    import capo_chime_sdk_media_pipelines.types.tag_key
    import capo_chime_sdk_media_pipelines.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_chime_sdk_media_pipelines.types.tag_key.TagKey"
    """<p>The key half of a tag.</p>"""
    value: "capo_chime_sdk_media_pipelines.types.tag_value.TagValue"
