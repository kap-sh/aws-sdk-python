"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#StopVoiceToneAnalysisTaskRequest``."""
...
class StopVoiceToneAnalysisTaskRequest(TypedDict, closed=True):
