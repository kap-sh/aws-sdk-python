...
class ListMediaPipelinesResponse(TypedDict, closed=True):
    media_pipelines: NotRequired[
        "capo_chime_sdk_media_pipelines.types.media_pipeline_list.MediaPipelineList"
    ]
...
def serialize_json(value: ListMediaPipelinesResponse) -> dict:
    ...
    if "media_pipelines" in value:
        ...
        out["MediaPipelines"] = (
            capo_chime_sdk_media_pipelines.types.media_pipeline_list.serialize_json(
...
def deserialize_json(data: dict) -> ListMediaPipelinesResponse:
    ...
    if "MediaPipelines" in data:
        ...
        out["media_pipelines"] = (
            capo_chime_sdk_media_pipelines.types.media_pipeline_list.deserialize_json(
                data["MediaPipelines"]
            )
        )
