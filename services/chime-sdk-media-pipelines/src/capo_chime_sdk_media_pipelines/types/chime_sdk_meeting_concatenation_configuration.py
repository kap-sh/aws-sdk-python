...
class ChimeSdkMeetingConcatenationConfiguration(TypedDict, closed=True):
    artifacts_configuration: "capo_chime_sdk_media_pipelines.types.artifacts_concatenation_configuration.ArtifactsConcatenationConfiguration"
...
def serialize_json(value: ChimeSdkMeetingConcatenationConfiguration) -> dict:
    ...
    out["ArtifactsConfiguration"] = (
        capo_chime_sdk_media_pipelines.types.artifacts_concatenation_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ChimeSdkMeetingConcatenationConfiguration:
    ...
    if "ArtifactsConfiguration" in data:
        ...
        out["artifacts_configuration"] = (
            capo_chime_sdk_media_pipelines.types.artifacts_concatenation_configuration.deserialize_json(
