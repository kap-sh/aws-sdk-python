...
class ChimeSDKMediaPipelinesError(Exception):
    """Base class for all ChimeSDKMediaPipelines service errors."""


class ServiceError(ChimeSDKMediaPipelinesError):
...
class SerializationError(ChimeSDKMediaPipelinesError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ChimeSDKMediaPipelinesError):
...
class WaiterFailedError(ChimeSDKMediaPipelinesError):
...
class WaiterTimeoutError(ChimeSDKMediaPipelinesError):
