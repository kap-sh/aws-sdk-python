"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#ListMediaPipelines``."""
...
import capo_chime_sdk_media_pipelines.types.media_pipeline_list
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.list_media_pipelines_response.ListMediaPipelinesResponse = capo_chime_sdk_media_pipelines.types.list_media_pipelines_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sdk-media-pipelines"
    params: dict[str, str] = {}
...
async def async_list_media_pipelines(
