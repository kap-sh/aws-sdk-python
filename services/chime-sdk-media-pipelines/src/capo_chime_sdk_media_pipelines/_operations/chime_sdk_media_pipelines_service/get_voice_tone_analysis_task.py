...
import capo_chime_sdk_media_pipelines.types.voice_tone_analysis_task
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.get_voice_tone_analysis_task_response.GetVoiceToneAnalysisTaskResponse = capo_chime_sdk_media_pipelines.types.get_voice_tone_analysis_task_response.deserialize_json(
