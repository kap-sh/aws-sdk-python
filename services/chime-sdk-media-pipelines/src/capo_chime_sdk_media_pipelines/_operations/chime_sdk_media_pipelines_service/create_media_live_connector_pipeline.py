...
import capo_chime_sdk_media_pipelines.errors.resource_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceLimitExceededException":
            raise capo_chime_sdk_media_pipelines.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.create_media_live_connector_pipeline_response.CreateMediaLiveConnectorPipelineResponse = capo_chime_sdk_media_pipelines.types.create_media_live_connector_pipeline_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_chime_sdk_media_pipelines._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_media_pipelines.types.create_media_live_connector_pipeline_request.serialize_json(
            input_
        )
    ).encode()
