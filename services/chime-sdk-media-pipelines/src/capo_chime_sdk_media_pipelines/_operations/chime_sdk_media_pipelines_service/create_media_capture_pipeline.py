"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#CreateMediaCapturePipeline``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.create_media_capture_pipeline_response.CreateMediaCapturePipelineResponse = capo_chime_sdk_media_pipelines.types.create_media_capture_pipeline_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sdk-media-capture-pipelines"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chime_sdk_media_pipelines.types.create_media_capture_pipeline_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_media_capture_pipeline(
