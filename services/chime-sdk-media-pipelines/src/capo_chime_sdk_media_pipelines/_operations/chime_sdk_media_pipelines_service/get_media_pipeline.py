...
import capo_chime_sdk_media_pipelines.types.media_pipeline
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.get_media_pipeline_response.GetMediaPipelineResponse = capo_chime_sdk_media_pipelines.types.get_media_pipeline_response.deserialize_json(
