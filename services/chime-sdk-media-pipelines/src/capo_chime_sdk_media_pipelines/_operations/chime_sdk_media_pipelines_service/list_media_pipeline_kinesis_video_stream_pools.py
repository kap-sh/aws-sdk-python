"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#ListMediaPipelineKinesisVideoStreamPools``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.list_media_pipeline_kinesis_video_stream_pools_response.ListMediaPipelineKinesisVideoStreamPoolsResponse = capo_chime_sdk_media_pipelines.types.list_media_pipeline_kinesis_video_stream_pools_response.deserialize_json(
...
async def async_list_media_pipeline_kinesis_video_stream_pools(
