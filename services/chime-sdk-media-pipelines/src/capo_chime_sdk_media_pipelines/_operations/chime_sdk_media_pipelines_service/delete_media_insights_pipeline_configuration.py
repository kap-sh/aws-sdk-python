"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#DeleteMediaInsightsPipelineConfiguration``."""
...
async def async_delete_media_insights_pipeline_configuration(
