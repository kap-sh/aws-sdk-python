"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#GetSpeakerSearchTask``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.get_speaker_search_task_response.GetSpeakerSearchTaskResponse = capo_chime_sdk_media_pipelines.types.get_speaker_search_task_response.deserialize_json(
