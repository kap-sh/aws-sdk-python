...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.create_media_insights_pipeline_response.CreateMediaInsightsPipelineResponse = capo_chime_sdk_media_pipelines.types.create_media_insights_pipeline_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_media_pipelines.types.create_media_insights_pipeline_request.serialize_json(
            input_
        )
    ).encode()
