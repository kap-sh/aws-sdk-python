"""Generated from Smithy shape ``com.amazonaws.omics#ListAnnotationStoreVersions``."""
...
import aws_sdk_omics.types.annotation_store_version_items
...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_annotation_store_versions_response.ListAnnotationStoreVersionsResponse = aws_sdk_omics.types.list_annotation_store_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_annotation_store_versions_request.ListAnnotationStoreVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/annotationStore/{name}/versions"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_annotation_store_versions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_annotation_store_versions(
