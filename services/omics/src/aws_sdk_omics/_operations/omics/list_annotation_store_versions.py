...
def build_request(
    ...
    input: aws_sdk_omics.types.list_annotation_store_versions_request.ListAnnotationStoreVersionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_annotation_store_versions_request.serialize_json(input)
    ).encode()
