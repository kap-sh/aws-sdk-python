"""Generated from Smithy shape ``com.amazonaws.omics#CreateAnnotationStore``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.create_annotation_store_response.CreateAnnotationStoreResponse = aws_sdk_omics.types.create_annotation_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.create_annotation_store_request.CreateAnnotationStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/annotationStore"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_omics.types.create_annotation_store_request

    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_annotation_store_request.serialize_json(input_)
    ).encode()
...
async def async_create_annotation_store(
