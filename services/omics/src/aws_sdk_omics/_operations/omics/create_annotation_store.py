...
def build_request(
    ...
    input: aws_sdk_omics.types.create_annotation_store_request.CreateAnnotationStoreRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_annotation_store_request.serialize_json(input)
    ).encode()
