...
def handle_response(
    ...
    out: aws_sdk_omics.types.put_s3_access_policy_response.PutS3AccessPolicyResponse = (
        aws_sdk_omics.types.put_s3_access_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.put_s3_access_policy_request.PutS3AccessPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.put_s3_access_policy_request.serialize_json(input_)
    ).encode()
