...
def build_request(
    ...
    input: aws_sdk_omics.types.start_reference_import_job_request.StartReferenceImportJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_reference_import_job_request.serialize_json(input)
    ).encode()
