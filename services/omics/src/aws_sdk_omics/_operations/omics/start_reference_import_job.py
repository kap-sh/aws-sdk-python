"""Generated from Smithy shape ``com.amazonaws.omics#StartReferenceImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.start_reference_import_job_response.StartReferenceImportJobResponse = aws_sdk_omics.types.start_reference_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.start_reference_import_job_request.StartReferenceImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/referencestore/{referenceStoreId}/importjob"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_reference_import_job_request.serialize_json(input_)
    ).encode()
...
async def async_start_reference_import_job(
