...
def build_request(
    ...
    input: aws_sdk_omics.types.create_reference_store_request.CreateReferenceStoreRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_reference_store_request.serialize_json(input)
    ).encode()
