...
def handle_response(
    ...
    out: aws_sdk_omics.types.create_reference_store_response.CreateReferenceStoreResponse = aws_sdk_omics.types.create_reference_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.create_reference_store_request.CreateReferenceStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_reference_store_request.serialize_json(input_)
    ).encode()
