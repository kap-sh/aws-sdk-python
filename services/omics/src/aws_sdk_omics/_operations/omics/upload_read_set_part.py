"""Generated from Smithy shape ``com.amazonaws.omics#UploadReadSetPart``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.upload_read_set_part_response.UploadReadSetPartResponse = (
        aws_sdk_omics.types.upload_read_set_part_response.deserialize_json(
