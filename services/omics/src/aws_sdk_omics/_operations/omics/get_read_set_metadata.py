"""Generated from Smithy shape ``com.amazonaws.omics#GetReadSetMetadata``."""
...
if TYPE_CHECKING:
    import aws_sdk_omics.types.get_read_set_metadata_request
    import aws_sdk_omics.types.get_read_set_metadata_response
...
) -> aws_sdk_omics.types.get_read_set_metadata_response.GetReadSetMetadataResponse:
    import aws_sdk_omics.types.get_read_set_metadata_response

    out: aws_sdk_omics.types.get_read_set_metadata_response.GetReadSetMetadataResponse = aws_sdk_omics.types.get_read_set_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_read_set_metadata_request.GetReadSetMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_read_set_metadata(
