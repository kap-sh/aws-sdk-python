...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_workflow_version_request.GetWorkflowVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "export" in input_:
        params["export"] = str(input_["export"])
    if "workflow_owner_id" in input_:
        params["workflowOwnerId"] = str(input_["workflow_owner_id"])
