"""Generated from Smithy shape ``com.amazonaws.omics#GetWorkflowVersion``."""
...
if TYPE_CHECKING:
    import aws_sdk_omics.types.get_workflow_version_request
    import aws_sdk_omics.types.get_workflow_version_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_omics.errors.service_quota_exceeded_exception

            raise aws_sdk_omics.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
) -> aws_sdk_omics.types.get_workflow_version_response.GetWorkflowVersionResponse:
    import aws_sdk_omics.types.get_workflow_version_response

    out: aws_sdk_omics.types.get_workflow_version_response.GetWorkflowVersionResponse = aws_sdk_omics.types.get_workflow_version_response.deserialize_json(
...
def get_signer(
...
) -> aws_sdk_omics._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_omics._auth._sigv4.build_sigv4_auth_scheme(
                "omics", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_omics._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input: aws_sdk_omics.types.get_workflow_version_request.GetWorkflowVersionRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workflow/{workflowId}/version/{versionName}"
    url = url.replace("{workflowId}", quote(str(input["workflow_id"]), safe=""))
    url = url.replace("{versionName}", quote(str(input["version_name"]), safe=""))
    params: dict[str, str] = {}
    if "type" in input:
        params["type"] = str(input["type"])
    if "export" in input:
        params["export"] = str(input["export"])
    if "workflow_owner_id" in input:
        params["workflowOwnerId"] = str(input["workflow_owner_id"])
...
async def async_get_workflow_version(
