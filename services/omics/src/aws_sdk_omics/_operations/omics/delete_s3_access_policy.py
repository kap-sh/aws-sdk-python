"""Generated from Smithy shape ``com.amazonaws.omics#DeleteS3AccessPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.delete_s3_access_policy_response.DeleteS3AccessPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_omics.types.delete_s3_access_policy_request.DeleteS3AccessPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_s3_access_policy(
