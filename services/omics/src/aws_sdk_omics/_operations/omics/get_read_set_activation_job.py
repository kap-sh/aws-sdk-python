"""Generated from Smithy shape ``com.amazonaws.omics#GetReadSetActivationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_read_set_activation_job_response.GetReadSetActivationJobResponse = aws_sdk_omics.types.get_read_set_activation_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_read_set_activation_job_request.GetReadSetActivationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/activationjob/{id}"
    )
...
async def async_get_read_set_activation_job(
