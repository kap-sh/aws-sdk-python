"""Generated from Smithy shape ``com.amazonaws.omics#DeleteReference``."""
...
if TYPE_CHECKING:
    import aws_sdk_omics.types.delete_reference_request
    import aws_sdk_omics.types.delete_reference_response
...
def handle_response(
    ...
    out: aws_sdk_omics.types.delete_reference_response.DeleteReferenceResponse = {}  # type: ignore[typeddict-item]
    return out
