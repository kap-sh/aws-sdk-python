"""Generated from Smithy shape ``com.amazonaws.omics#ListMultipartReadSetUploads``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotSupportedOperationException":
            import aws_sdk_omics.errors.not_supported_operation_exception

            raise aws_sdk_omics.errors.not_supported_operation_exception.NotSupportedOperationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_multipart_read_set_uploads_response.ListMultipartReadSetUploadsResponse = aws_sdk_omics.types.list_multipart_read_set_uploads_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_multipart_read_set_uploads_request.ListMultipartReadSetUploadsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/uploads"
    url = url.replace(
...
async def async_list_multipart_read_set_uploads(
