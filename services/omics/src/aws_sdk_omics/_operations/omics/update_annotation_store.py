"""Generated from Smithy shape ``com.amazonaws.omics#UpdateAnnotationStore``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.update_annotation_store_response.UpdateAnnotationStoreResponse = aws_sdk_omics.types.update_annotation_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.update_annotation_store_request.UpdateAnnotationStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/annotationStore/{name}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.update_annotation_store_request.serialize_json(input_)
    ).encode()
...
async def async_update_annotation_store(
