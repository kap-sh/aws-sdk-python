...
def build_request(
    ...
    input: aws_sdk_omics.types.update_annotation_store_request.UpdateAnnotationStoreRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.update_annotation_store_request.serialize_json(input)
    ).encode()
