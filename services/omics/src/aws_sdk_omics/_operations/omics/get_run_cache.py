"""Generated from Smithy shape ``com.amazonaws.omics#GetRunCache``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_run_cache_response.GetRunCacheResponse = (
        aws_sdk_omics.types.get_run_cache_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_run_cache_request.GetRunCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/runCache/{id}"
...
def get_run_cache(
    ...
    aws_sdk_omics.types.get_run_cache_response.GetRunCacheResponse, zapros.Response
]:
