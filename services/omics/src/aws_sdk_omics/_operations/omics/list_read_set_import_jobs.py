"""Generated from Smithy shape ``com.amazonaws.omics#ListReadSetImportJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_read_set_import_jobs_response.ListReadSetImportJobsResponse = aws_sdk_omics.types.list_read_set_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_read_set_import_jobs_request.ListReadSetImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/importjobs"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_read_set_import_jobs_request.serialize_json(input_)
    ).encode()
...
async def async_list_read_set_import_jobs(
