...
def build_request(
    ...
    input: aws_sdk_omics.types.list_annotation_stores_request.ListAnnotationStoresRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_annotation_stores_request.serialize_json(input)
    ).encode()
