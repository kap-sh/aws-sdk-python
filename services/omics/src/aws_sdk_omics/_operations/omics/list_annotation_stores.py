...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_annotation_stores_response.ListAnnotationStoresResponse = aws_sdk_omics.types.list_annotation_stores_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_annotation_stores_request.ListAnnotationStoresRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_annotation_stores_request.serialize_json(input_)
    ).encode()
