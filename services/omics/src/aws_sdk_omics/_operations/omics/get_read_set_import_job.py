"""Generated from Smithy shape ``com.amazonaws.omics#GetReadSetImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_read_set_import_job_response.GetReadSetImportJobResponse = aws_sdk_omics.types.get_read_set_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_read_set_import_job_request.GetReadSetImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/importjob/{id}"
...
async def async_get_read_set_import_job(
