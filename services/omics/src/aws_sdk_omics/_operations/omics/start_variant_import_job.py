...
def handle_response(
    ...
    out: aws_sdk_omics.types.start_variant_import_response.StartVariantImportResponse = aws_sdk_omics.types.start_variant_import_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.start_variant_import_request.StartVariantImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_variant_import_request.serialize_json(input_)
    ).encode()
