...
def handle_response(
    ...
    out: aws_sdk_omics.types.complete_multipart_read_set_upload_response.CompleteMultipartReadSetUploadResponse = aws_sdk_omics.types.complete_multipart_read_set_upload_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.complete_multipart_read_set_upload_request.CompleteMultipartReadSetUploadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.complete_multipart_read_set_upload_request.serialize_json(
            input_
        )
    ).encode()
