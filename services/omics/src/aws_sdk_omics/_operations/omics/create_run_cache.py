...
def handle_response(
    ...
    out: aws_sdk_omics.types.create_run_cache_response.CreateRunCacheResponse = (
        aws_sdk_omics.types.create_run_cache_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.create_run_cache_request.CreateRunCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_run_cache_request.serialize_json(input_)
    ).encode()
