...
def handle_response(
    ...
    out: aws_sdk_omics.types.abort_multipart_read_set_upload_response.AbortMultipartReadSetUploadResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_omics.types.abort_multipart_read_set_upload_request.AbortMultipartReadSetUploadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
