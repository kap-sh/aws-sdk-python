"""Generated from Smithy shape ``com.amazonaws.omics#GetReferenceStore``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_reference_store_response.GetReferenceStoreResponse = (
        aws_sdk_omics.types.get_reference_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_reference_store_request.GetReferenceStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/referencestore/{id}"
...
async def async_get_reference_store(
