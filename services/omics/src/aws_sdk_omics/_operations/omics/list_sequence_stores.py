...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_sequence_stores_response.ListSequenceStoresResponse = aws_sdk_omics.types.list_sequence_stores_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_sequence_stores_request.ListSequenceStoresRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_sequence_stores_request.serialize_json(input_)
    ).encode()
