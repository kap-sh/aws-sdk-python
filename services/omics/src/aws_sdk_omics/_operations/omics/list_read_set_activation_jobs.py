...
def build_request(
    ...
    input: aws_sdk_omics.types.list_read_set_activation_jobs_request.ListReadSetActivationJobsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_read_set_activation_jobs_request.serialize_json(input)
    ).encode()
