...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_read_set_activation_jobs_response.ListReadSetActivationJobsResponse = aws_sdk_omics.types.list_read_set_activation_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_read_set_activation_jobs_request.ListReadSetActivationJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_read_set_activation_jobs_request.serialize_json(input_)
    ).encode()
