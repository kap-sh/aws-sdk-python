"""Generated from Smithy shape ``com.amazonaws.omics#GetVariantStore``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_variant_store_response.GetVariantStoreResponse = (
        aws_sdk_omics.types.get_variant_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_variant_store_request.GetVariantStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_variant_store(
