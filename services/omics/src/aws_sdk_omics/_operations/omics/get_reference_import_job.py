"""Generated from Smithy shape ``com.amazonaws.omics#GetReferenceImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_reference_import_job_response.GetReferenceImportJobResponse = aws_sdk_omics.types.get_reference_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_reference_import_job_request.GetReferenceImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/referencestore/{referenceStoreId}/importjob/{id}"
...
async def async_get_reference_import_job(
