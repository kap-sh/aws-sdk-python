"""Generated from Smithy shape ``com.amazonaws.omics#ListRuns``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_runs_response.ListRunsResponse = (
        aws_sdk_omics.types.list_runs_response.deserialize_json(
