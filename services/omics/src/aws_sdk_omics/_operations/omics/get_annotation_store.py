"""Generated from Smithy shape ``com.amazonaws.omics#GetAnnotationStore``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_annotation_store_response.GetAnnotationStoreResponse = aws_sdk_omics.types.get_annotation_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_annotation_store_request.GetAnnotationStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_annotation_store(
