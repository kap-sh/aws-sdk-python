...
def handle_response(
    ...
    out: aws_sdk_omics.types.delete_annotation_store_response.DeleteAnnotationStoreResponse = aws_sdk_omics.types.delete_annotation_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.delete_annotation_store_request.DeleteAnnotationStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
