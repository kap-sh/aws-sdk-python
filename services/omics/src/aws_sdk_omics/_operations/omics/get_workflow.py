"""Generated from Smithy shape ``com.amazonaws.omics#GetWorkflow``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_workflow_response.GetWorkflowResponse = (
        aws_sdk_omics.types.get_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_workflow_request.GetWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workflow/{id}"
...
def get_workflow(
    ...
    aws_sdk_omics.types.get_workflow_response.GetWorkflowResponse, zapros.Response
]:
