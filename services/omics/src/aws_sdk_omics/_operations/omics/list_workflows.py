...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_workflows_response.ListWorkflowsResponse = (
        aws_sdk_omics.types.list_workflows_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_workflows_request.ListWorkflowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_workflows(
    ...
    aws_sdk_omics.types.list_workflows_response.ListWorkflowsResponse, zapros.Response
]:
