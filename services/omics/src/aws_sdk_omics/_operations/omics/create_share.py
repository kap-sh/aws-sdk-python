"""Generated from Smithy shape ``com.amazonaws.omics#CreateShare``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.create_share_response.CreateShareResponse = (
        aws_sdk_omics.types.create_share_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.create_share_request.CreateShareRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/share"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_share_request.serialize_json(input_)
    ).encode()
...
def create_share(
    ...
    aws_sdk_omics.types.create_share_response.CreateShareResponse, zapros.Response
]:
