"""Generated from Smithy shape ``com.amazonaws.omics#ListWorkflowVersions``."""
...
if TYPE_CHECKING:
    import aws_sdk_omics.types.list_workflow_versions_request
    import aws_sdk_omics.types.list_workflow_versions_response
...
) -> aws_sdk_omics.types.list_workflow_versions_response.ListWorkflowVersionsResponse:
    import aws_sdk_omics.types.list_workflow_versions_response

    out: aws_sdk_omics.types.list_workflow_versions_response.ListWorkflowVersionsResponse = aws_sdk_omics.types.list_workflow_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_workflow_versions_request.ListWorkflowVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_workflow_versions(
