"""Generated from Smithy shape ``com.amazonaws.omics#GetAnnotationStoreVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_annotation_store_version_response.GetAnnotationStoreVersionResponse = aws_sdk_omics.types.get_annotation_store_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_omics.types.get_annotation_store_version_request.GetAnnotationStoreVersionRequest,
) -> zapros.Request:
...
async def async_get_annotation_store_version(
