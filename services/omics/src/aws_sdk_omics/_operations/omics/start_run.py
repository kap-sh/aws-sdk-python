...
def handle_response(
    ...
    out: aws_sdk_omics.types.start_run_response.StartRunResponse = (
        aws_sdk_omics.types.start_run_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.start_run_request.StartRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_run_request.serialize_json(input_)
    ).encode()
...
def start_run(
    ...
    input_: aws_sdk_omics.types.start_run_request.StartRunRequest,
) -> tuple[aws_sdk_omics.types.start_run_response.StartRunResponse, zapros.Response]:
