...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_read_set_upload_parts_response.ListReadSetUploadPartsResponse = aws_sdk_omics.types.list_read_set_upload_parts_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_omics.types.list_read_set_upload_parts_request.ListReadSetUploadPartsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_read_set_upload_parts_request.serialize_json(input)
    ).encode()
