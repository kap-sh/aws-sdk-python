"""Generated from Smithy shape ``com.amazonaws.omics#ListShares``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_shares_response.ListSharesResponse = (
        aws_sdk_omics.types.list_shares_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_shares_request.ListSharesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/shares"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_shares_request.serialize_json(input_)
    ).encode()
...
def list_shares(
    ...
    aws_sdk_omics.types.list_shares_response.ListSharesResponse, zapros.Response
]:
