...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_variant_import_response.GetVariantImportResponse = (
        aws_sdk_omics.types.get_variant_import_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_variant_import_request.GetVariantImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
