...
def handle_response(
    ...
    out: aws_sdk_omics.types.start_read_set_export_job_response.StartReadSetExportJobResponse = aws_sdk_omics.types.start_read_set_export_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.start_read_set_export_job_request.StartReadSetExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_read_set_export_job_request.serialize_json(input_)
    ).encode()
