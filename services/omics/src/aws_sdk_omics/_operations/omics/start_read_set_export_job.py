...
def build_request(
    ...
    input: aws_sdk_omics.types.start_read_set_export_job_request.StartReadSetExportJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_read_set_export_job_request.serialize_json(input)
    ).encode()
