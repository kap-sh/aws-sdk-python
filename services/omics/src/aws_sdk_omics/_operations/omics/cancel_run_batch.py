...
def handle_response(
    ...
    out: aws_sdk_omics.types.cancel_run_batch_response.CancelRunBatchResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_omics.types.cancel_run_batch_request.CancelRunBatchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.cancel_run_batch_request.serialize_json(input_)
    ).encode()
