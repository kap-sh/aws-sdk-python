...
def build_request(
    ...
    input: aws_sdk_omics.types.start_annotation_import_request.StartAnnotationImportRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_annotation_import_request.serialize_json(input)
    ).encode()
