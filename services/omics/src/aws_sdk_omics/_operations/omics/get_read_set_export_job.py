"""Generated from Smithy shape ``com.amazonaws.omics#GetReadSetExportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_read_set_export_job_response.GetReadSetExportJobResponse = aws_sdk_omics.types.get_read_set_export_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_read_set_export_job_request.GetReadSetExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/exportjob/{id}"
    url = url.replace(
...
async def async_get_read_set_export_job(
