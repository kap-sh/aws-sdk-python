...
def handle_response(
    ...
    out: aws_sdk_omics.types.delete_variant_store_response.DeleteVariantStoreResponse = aws_sdk_omics.types.delete_variant_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.delete_variant_store_request.DeleteVariantStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
