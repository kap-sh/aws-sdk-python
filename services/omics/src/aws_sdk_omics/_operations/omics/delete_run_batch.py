"""Generated from Smithy shape ``com.amazonaws.omics#DeleteRunBatch``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.delete_run_batch_response.DeleteRunBatchResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_omics.types.delete_run_batch_request.DeleteRunBatchRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.delete_run_batch_request.serialize_json(input)
    ).encode()
...
async def async_delete_run_batch(
