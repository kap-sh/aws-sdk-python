"""Generated from Smithy shape ``com.amazonaws.omics#ListVariantImportJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_variant_import_jobs_response.ListVariantImportJobsResponse = aws_sdk_omics.types.list_variant_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_variant_import_jobs_request.ListVariantImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/import/variants"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_variant_import_jobs_request.serialize_json(input_)
    ).encode()
...
async def async_list_variant_import_jobs(
