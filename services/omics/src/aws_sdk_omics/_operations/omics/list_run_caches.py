...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_run_caches_response.ListRunCachesResponse = (
        aws_sdk_omics.types.list_run_caches_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_run_caches_request.ListRunCachesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_run_caches(
    ...
    aws_sdk_omics.types.list_run_caches_response.ListRunCachesResponse, zapros.Response
]:
