...
def handle_response(
    ...
    out: aws_sdk_omics.types.create_multipart_read_set_upload_response.CreateMultipartReadSetUploadResponse = aws_sdk_omics.types.create_multipart_read_set_upload_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.create_multipart_read_set_upload_request.CreateMultipartReadSetUploadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
