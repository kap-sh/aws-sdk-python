"""Generated from Smithy shape ``com.amazonaws.omics#GetSequenceStore``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_sequence_store_response.GetSequenceStoreResponse = (
        aws_sdk_omics.types.get_sequence_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_sequence_store_request.GetSequenceStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_sequence_store(
