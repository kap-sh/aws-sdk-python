...
def build_request(
    ...
    input: aws_sdk_omics.types.list_annotation_import_jobs_request.ListAnnotationImportJobsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_annotation_import_jobs_request.serialize_json(input)
    ).encode()
