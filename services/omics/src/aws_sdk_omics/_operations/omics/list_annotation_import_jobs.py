...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_annotation_import_jobs_response.ListAnnotationImportJobsResponse = aws_sdk_omics.types.list_annotation_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_annotation_import_jobs_request.ListAnnotationImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_annotation_import_jobs_request.serialize_json(input_)
    ).encode()
