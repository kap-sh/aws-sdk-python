...
def build_request(
    ...
    input: aws_sdk_omics.types.batch_delete_read_set_request.BatchDeleteReadSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.batch_delete_read_set_request.serialize_json(input)
    ).encode()
