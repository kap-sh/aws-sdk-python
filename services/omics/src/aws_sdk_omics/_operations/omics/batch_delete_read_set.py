...
if TYPE_CHECKING:
    import aws_sdk_omics.types.batch_delete_read_set_request
    import aws_sdk_omics.types.batch_delete_read_set_response
...
) -> aws_sdk_omics.types.batch_delete_read_set_response.BatchDeleteReadSetResponse:
    import aws_sdk_omics.types.batch_delete_read_set_response

    out: aws_sdk_omics.types.batch_delete_read_set_response.BatchDeleteReadSetResponse = aws_sdk_omics.types.batch_delete_read_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.batch_delete_read_set_request.BatchDeleteReadSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.batch_delete_read_set_request.serialize_json(input_)
    ).encode()
