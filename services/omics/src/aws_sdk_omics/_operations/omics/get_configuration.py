...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_configuration_response.GetConfigurationResponse = (
        aws_sdk_omics.types.get_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_configuration_request.GetConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
