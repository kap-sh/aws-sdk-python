...
def handle_response(
    ...
    out: aws_sdk_omics.types.accept_share_response.AcceptShareResponse = (
        aws_sdk_omics.types.accept_share_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.accept_share_request.AcceptShareRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def accept_share(
    ...
    aws_sdk_omics.types.accept_share_response.AcceptShareResponse, zapros.Response
]:
