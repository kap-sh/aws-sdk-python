"""Generated from Smithy shape ``com.amazonaws.omics#CreateWorkflowVersion``."""
...
import aws_sdk_omics.types.create_workflow_version_request
import aws_sdk_omics.types.create_workflow_version_response
...
) -> aws_sdk_omics.types.create_workflow_version_response.CreateWorkflowVersionResponse:
    out: aws_sdk_omics.types.create_workflow_version_response.CreateWorkflowVersionResponse = aws_sdk_omics.types.create_workflow_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.create_workflow_version_request.CreateWorkflowVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workflow/{workflowId}/version"
    url = url.replace("{workflowId}", quote(str(input_["workflow_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_workflow_version_request.serialize_json(input_)
    ).encode()
...
async def async_create_workflow_version(
