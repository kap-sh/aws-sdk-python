...
def build_request(
    ...
    input: aws_sdk_omics.types.create_workflow_version_request.CreateWorkflowVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_workflow_version_request.serialize_json(input)
    ).encode()
