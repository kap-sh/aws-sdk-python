"""Generated from Smithy shape ``com.amazonaws.omics#ListVariantStores``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_variant_stores_response.ListVariantStoresResponse = (
        aws_sdk_omics.types.list_variant_stores_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_variant_stores_request.ListVariantStoresRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/variantStores"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_variant_stores_request.serialize_json(input_)
    ).encode()
...
async def async_list_variant_stores(
