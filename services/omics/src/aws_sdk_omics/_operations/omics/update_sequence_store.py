...
def build_request(
    ...
    input: aws_sdk_omics.types.update_sequence_store_request.UpdateSequenceStoreRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.update_sequence_store_request.serialize_json(input)
    ).encode()
