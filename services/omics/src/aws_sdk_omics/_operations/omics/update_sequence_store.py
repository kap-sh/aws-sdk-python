"""Generated from Smithy shape ``com.amazonaws.omics#UpdateSequenceStore``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.update_sequence_store_response.UpdateSequenceStoreResponse = aws_sdk_omics.types.update_sequence_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.update_sequence_store_request.UpdateSequenceStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{id}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.update_sequence_store_request.serialize_json(input_)
    ).encode()
...
async def async_update_sequence_store(
