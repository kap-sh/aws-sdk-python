"""Generated from Smithy shape ``com.amazonaws.omics#StartReadSetImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.start_read_set_import_job_response.StartReadSetImportJobResponse = aws_sdk_omics.types.start_read_set_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.start_read_set_import_job_request.StartReadSetImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/importjob"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_read_set_import_job_request.serialize_json(input_)
    ).encode()
...
async def async_start_read_set_import_job(
