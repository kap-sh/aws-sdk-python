...
def build_request(
    ...
    input: aws_sdk_omics.types.start_read_set_import_job_request.StartReadSetImportJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_read_set_import_job_request.serialize_json(input)
    ).encode()
