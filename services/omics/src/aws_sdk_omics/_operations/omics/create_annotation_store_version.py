...
def handle_response(
    ...
    out: aws_sdk_omics.types.create_annotation_store_version_response.CreateAnnotationStoreVersionResponse = aws_sdk_omics.types.create_annotation_store_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.create_annotation_store_version_request.CreateAnnotationStoreVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_annotation_store_version_request.serialize_json(
            input_
        )
    ).encode()
