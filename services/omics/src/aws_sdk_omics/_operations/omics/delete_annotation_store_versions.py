...
import aws_sdk_omics.types.version_delete_error_list
...
def handle_response(
    ...
    out: aws_sdk_omics.types.delete_annotation_store_versions_response.DeleteAnnotationStoreVersionsResponse = aws_sdk_omics.types.delete_annotation_store_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.delete_annotation_store_versions_request.DeleteAnnotationStoreVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
