...
def handle_response(
    ...
    out: aws_sdk_omics.types.cancel_annotation_import_response.CancelAnnotationImportResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_omics.types.cancel_annotation_import_request.CancelAnnotationImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
