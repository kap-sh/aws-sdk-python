...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_batch_response.ListBatchResponse = (
        aws_sdk_omics.types.list_batch_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_batch_request.ListBatchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_batch(
    ...
    input_: aws_sdk_omics.types.list_batch_request.ListBatchRequest,
) -> tuple[aws_sdk_omics.types.list_batch_response.ListBatchResponse, zapros.Response]:
