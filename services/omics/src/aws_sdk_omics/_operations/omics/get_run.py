...
import aws_sdk_omics.types.configuration_details
...
import aws_sdk_omics.types.run_log_location
import aws_sdk_omics.types.run_resource_digests
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_run_response.GetRunResponse = (
        aws_sdk_omics.types.get_run_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_run_request.GetRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_run(
    options: OperationOptions, input_: aws_sdk_omics.types.get_run_request.GetRunRequest
) -> tuple[aws_sdk_omics.types.get_run_response.GetRunResponse, zapros.Response]:
