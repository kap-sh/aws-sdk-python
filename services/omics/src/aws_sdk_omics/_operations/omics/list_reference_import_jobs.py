...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_reference_import_jobs_response.ListReferenceImportJobsResponse = aws_sdk_omics.types.list_reference_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_reference_import_jobs_request.ListReferenceImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_reference_import_jobs_request.serialize_json(input_)
    ).encode()
