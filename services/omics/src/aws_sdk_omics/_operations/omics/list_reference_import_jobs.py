...
def build_request(
    ...
    input: aws_sdk_omics.types.list_reference_import_jobs_request.ListReferenceImportJobsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_reference_import_jobs_request.serialize_json(input)
    ).encode()
