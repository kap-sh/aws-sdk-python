...
def handle_response(
    ...
    out: aws_sdk_omics.types.create_variant_store_response.CreateVariantStoreResponse = aws_sdk_omics.types.create_variant_store_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_omics.types.create_variant_store_request.CreateVariantStoreRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_variant_store_request.serialize_json(input)
    ).encode()
