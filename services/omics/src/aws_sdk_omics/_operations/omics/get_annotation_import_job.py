...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_annotation_import_response.GetAnnotationImportResponse = aws_sdk_omics.types.get_annotation_import_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_annotation_import_request.GetAnnotationImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
