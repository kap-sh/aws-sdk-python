...
if TYPE_CHECKING:
    import aws_sdk_omics.types.list_read_sets_request
    import aws_sdk_omics.types.list_read_sets_response
...
) -> aws_sdk_omics.types.list_read_sets_response.ListReadSetsResponse:
    import aws_sdk_omics.types.list_read_sets_response

    out: aws_sdk_omics.types.list_read_sets_response.ListReadSetsResponse = (
        aws_sdk_omics.types.list_read_sets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_read_sets_request.ListReadSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_read_sets_request.serialize_json(input_)
    ).encode()
...
def list_read_sets(
    ...
    aws_sdk_omics.types.list_read_sets_response.ListReadSetsResponse, zapros.Response
]:
