...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_reference_stores_response.ListReferenceStoresResponse = aws_sdk_omics.types.list_reference_stores_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_omics.types.list_reference_stores_request.ListReferenceStoresRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_reference_stores_request.serialize_json(input)
    ).encode()
