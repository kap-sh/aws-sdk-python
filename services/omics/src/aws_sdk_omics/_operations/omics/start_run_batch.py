"""Generated from Smithy shape ``com.amazonaws.omics#StartRunBatch``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.start_run_batch_response.StartRunBatchResponse = (
        aws_sdk_omics.types.start_run_batch_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.start_run_batch_request.StartRunBatchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/runBatch"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_omics.types.start_run_batch_request

    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_run_batch_request.serialize_json(input_)
    ).encode()
...
def start_run_batch(
    ...
    aws_sdk_omics.types.start_run_batch_response.StartRunBatchResponse, zapros.Response
]:
...
async def async_start_run_batch(
