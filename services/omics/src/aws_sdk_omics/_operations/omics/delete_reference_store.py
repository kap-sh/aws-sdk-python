...
def handle_response(
    ...
    out: aws_sdk_omics.types.delete_reference_store_response.DeleteReferenceStoreResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_omics.types.delete_reference_store_request.DeleteReferenceStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
