...
import aws_sdk_omics.types.get_reference_metadata_request
import aws_sdk_omics.types.get_reference_metadata_response
...
) -> aws_sdk_omics.types.get_reference_metadata_response.GetReferenceMetadataResponse:
    out: aws_sdk_omics.types.get_reference_metadata_response.GetReferenceMetadataResponse = aws_sdk_omics.types.get_reference_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_reference_metadata_request.GetReferenceMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
