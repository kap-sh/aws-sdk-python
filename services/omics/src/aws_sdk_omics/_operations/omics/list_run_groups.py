"""Generated from Smithy shape ``com.amazonaws.omics#ListRunGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.list_run_groups_response.ListRunGroupsResponse = (
        aws_sdk_omics.types.list_run_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_run_groups_request.ListRunGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_run_groups(
    ...
    aws_sdk_omics.types.list_run_groups_response.ListRunGroupsResponse, zapros.Response
]:
...
async def async_list_run_groups(
