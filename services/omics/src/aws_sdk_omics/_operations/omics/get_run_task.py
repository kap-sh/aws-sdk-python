...
import aws_sdk_omics.types.get_run_task_request
import aws_sdk_omics.types.get_run_task_response
...
) -> aws_sdk_omics.types.get_run_task_response.GetRunTaskResponse:
    out: aws_sdk_omics.types.get_run_task_response.GetRunTaskResponse = (
        aws_sdk_omics.types.get_run_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_run_task_request.GetRunTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_run_task(
    ...
    aws_sdk_omics.types.get_run_task_response.GetRunTaskResponse, zapros.Response
]:
