...
def handle_response(
    ...
    out: aws_sdk_omics.types.create_sequence_store_response.CreateSequenceStoreResponse = aws_sdk_omics.types.create_sequence_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.create_sequence_store_request.CreateSequenceStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_sequence_store_request.serialize_json(input_)
    ).encode()
