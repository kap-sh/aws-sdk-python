"""Generated from Smithy shape ``com.amazonaws.omics#ListReferences``."""
...
if TYPE_CHECKING:
    import aws_sdk_omics.types.list_references_request
    import aws_sdk_omics.types.list_references_response
...
) -> aws_sdk_omics.types.list_references_response.ListReferencesResponse:
    import aws_sdk_omics.types.list_references_response

    out: aws_sdk_omics.types.list_references_response.ListReferencesResponse = (
        aws_sdk_omics.types.list_references_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_references_request.ListReferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/referencestore/{referenceStoreId}/references"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.list_references_request.serialize_json(input_)
    ).encode()
...
def list_references(
    ...
    aws_sdk_omics.types.list_references_response.ListReferencesResponse, zapros.Response
]:
...
async def async_list_references(
