...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_share_response.GetShareResponse = (
        aws_sdk_omics.types.get_share_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_share_request.GetShareRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_share(
    ...
    input_: aws_sdk_omics.types.get_share_request.GetShareRequest,
) -> tuple[aws_sdk_omics.types.get_share_response.GetShareResponse, zapros.Response]:
