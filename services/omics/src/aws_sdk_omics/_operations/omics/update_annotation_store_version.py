"""Generated from Smithy shape ``com.amazonaws.omics#UpdateAnnotationStoreVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.update_annotation_store_version_response.UpdateAnnotationStoreVersionResponse = aws_sdk_omics.types.update_annotation_store_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_omics.types.update_annotation_store_version_request.UpdateAnnotationStoreVersionRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/annotationStore/{name}/version/{versionName}"
...
async def async_update_annotation_store_version(
