...
def handle_response(
    ...
    out: aws_sdk_omics.types.delete_sequence_store_response.DeleteSequenceStoreResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_omics.types.delete_sequence_store_request.DeleteSequenceStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
