...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_batch_response.GetBatchResponse = (
        aws_sdk_omics.types.get_batch_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_omics.types.get_batch_request.GetBatchRequest,
) -> zapros.Request:
...
def get_batch(
    ...
    input: aws_sdk_omics.types.get_batch_request.GetBatchRequest,
) -> tuple[aws_sdk_omics.types.get_batch_response.GetBatchResponse, zapros.Response]:
