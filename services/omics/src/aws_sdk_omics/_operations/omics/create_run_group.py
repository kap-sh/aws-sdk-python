...
def handle_response(
    ...
    out: aws_sdk_omics.types.create_run_group_response.CreateRunGroupResponse = (
        aws_sdk_omics.types.create_run_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.create_run_group_request.CreateRunGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.create_run_group_request.serialize_json(input_)
    ).encode()
