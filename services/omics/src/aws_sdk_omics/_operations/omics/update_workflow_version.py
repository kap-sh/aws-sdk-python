...
def build_request(
    ...
    input: aws_sdk_omics.types.update_workflow_version_request.UpdateWorkflowVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.update_workflow_version_request.serialize_json(input)
    ).encode()
