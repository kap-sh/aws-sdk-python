...
if TYPE_CHECKING:
    import aws_sdk_omics.types.update_workflow_version_request
...
def build_request(
    ...
    input_: aws_sdk_omics.types.update_workflow_version_request.UpdateWorkflowVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.update_workflow_version_request.serialize_json(input_)
    ).encode()
