...
def handle_response(
    ...
    out: aws_sdk_omics.types.delete_share_response.DeleteShareResponse = (
        aws_sdk_omics.types.delete_share_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.delete_share_request.DeleteShareRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_share(
    ...
    aws_sdk_omics.types.delete_share_response.DeleteShareResponse, zapros.Response
]:
