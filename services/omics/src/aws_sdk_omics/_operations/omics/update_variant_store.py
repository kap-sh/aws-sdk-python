"""Generated from Smithy shape ``com.amazonaws.omics#UpdateVariantStore``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.update_variant_store_response.UpdateVariantStoreResponse = aws_sdk_omics.types.update_variant_store_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.update_variant_store_request.UpdateVariantStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/variantStore/{name}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.update_variant_store_request.serialize_json(input_)
    ).encode()
...
async def async_update_variant_store(
