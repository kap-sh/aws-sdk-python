...
def handle_response(
    ...
    out: aws_sdk_omics.types.start_read_set_activation_job_response.StartReadSetActivationJobResponse = aws_sdk_omics.types.start_read_set_activation_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.start_read_set_activation_job_request.StartReadSetActivationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_read_set_activation_job_request.serialize_json(input_)
    ).encode()
