...
def build_request(
    ...
    input: aws_sdk_omics.types.start_read_set_activation_job_request.StartReadSetActivationJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.start_read_set_activation_job_request.serialize_json(input)
    ).encode()
