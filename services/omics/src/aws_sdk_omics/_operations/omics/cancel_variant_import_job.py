"""Generated from Smithy shape ``com.amazonaws.omics#CancelVariantImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.cancel_variant_import_response.CancelVariantImportResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_omics.types.cancel_variant_import_request.CancelVariantImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/import/variant/{jobId}"
...
async def async_cancel_variant_import_job(
