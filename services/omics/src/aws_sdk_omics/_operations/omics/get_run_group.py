"""Generated from Smithy shape ``com.amazonaws.omics#GetRunGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_omics.types.get_run_group_response.GetRunGroupResponse = (
        aws_sdk_omics.types.get_run_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.get_run_group_request.GetRunGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/runGroup/{id}"
...
def get_run_group(
    ...
    aws_sdk_omics.types.get_run_group_response.GetRunGroupResponse, zapros.Response
]:
