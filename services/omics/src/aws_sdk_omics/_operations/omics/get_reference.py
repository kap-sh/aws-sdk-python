"""Generated from Smithy shape ``com.amazonaws.omics#GetReference``."""
...
if TYPE_CHECKING:
    import aws_sdk_omics.types.get_reference_request
    import aws_sdk_omics.types.get_reference_response
...
) -> aws_sdk_omics.types.get_reference_response.GetReferenceResponse:
    _iter = cast(
        Any, response.async_iter_bytes() if is_async else response.iter_bytes()
    )
    out: aws_sdk_omics.types.get_reference_response.GetReferenceResponse = {
        "payload": _iter
    }
    return out
...
def build_request(
    ...
    input: aws_sdk_omics.types.get_reference_request.GetReferenceRequest,
) -> zapros.Request:
...
def get_reference(
    ...
    aws_sdk_omics.types.get_reference_response.GetReferenceResponse, zapros.Response
]:
