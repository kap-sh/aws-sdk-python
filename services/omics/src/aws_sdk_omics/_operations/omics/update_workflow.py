"""Generated from Smithy shape ``com.amazonaws.omics#UpdateWorkflow``."""
...
def build_request(
    ...
    input_: aws_sdk_omics.types.update_workflow_request.UpdateWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_omics.types.update_workflow_request.serialize_json(input_)
    ).encode()
