"""Generated from Smithy shape ``com.amazonaws.omics#ListRunTasks``."""
...
import aws_sdk_omics.types.list_run_tasks_request
import aws_sdk_omics.types.list_run_tasks_response
...
) -> aws_sdk_omics.types.list_run_tasks_response.ListRunTasksResponse:
    out: aws_sdk_omics.types.list_run_tasks_response.ListRunTasksResponse = (
        aws_sdk_omics.types.list_run_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_omics.types.list_run_tasks_request.ListRunTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/run/{id}/task"
...
def list_run_tasks(
    ...
    aws_sdk_omics.types.list_run_tasks_response.ListRunTasksResponse, zapros.Response
]:
...
async def async_list_run_tasks(
