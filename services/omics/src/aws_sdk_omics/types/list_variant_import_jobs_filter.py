...
# --- restJson1 ser/de ---
def serialize_json(value: ListVariantImportJobsFilter) -> dict:
    out: dict = {}
    if "status" in value:
...
def deserialize_json(data: dict) -> ListVariantImportJobsFilter:
    out: ListVariantImportJobsFilter = {}  # type: ignore[typeddict-item]
    if "status" in data:
