...
if TYPE_CHECKING:
    import aws_sdk_omics.types.run_resource_digest
    import aws_sdk_omics.types.run_resource_digest_key

RunResourceDigests: TypeAlias = dict[
    "aws_sdk_omics.types.run_resource_digest_key.RunResourceDigestKey",
    "aws_sdk_omics.types.run_resource_digest.RunResourceDigest",
]
