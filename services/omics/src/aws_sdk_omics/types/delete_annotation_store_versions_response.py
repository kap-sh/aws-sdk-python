...
class DeleteAnnotationStoreVersionsResponse(TypedDict):
    errors: NotRequired[
        "aws_sdk_omics.types.version_delete_error_list.VersionDeleteErrorList"
    ]
...
def serialize_json(value: DeleteAnnotationStoreVersionsResponse) -> dict:
    ...
    if "errors" in value:
        ...
        out["errors"] = aws_sdk_omics.types.version_delete_error_list.serialize_json(
            value["errors"]
        )
    return out
...
def deserialize_json(data: dict) -> DeleteAnnotationStoreVersionsResponse:
    ...
    if "errors" in data:
        ...
        out["errors"] = aws_sdk_omics.types.version_delete_error_list.deserialize_json(
            data["errors"]
        )
    return out
