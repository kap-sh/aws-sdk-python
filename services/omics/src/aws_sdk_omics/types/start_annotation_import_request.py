...
class StartAnnotationImportRequest(TypedDict, closed=True):
    ...
    items: (
        "aws_sdk_omics.types.annotation_import_item_sources.AnnotationImportItemSources"
    )
    """<p>Items to import.</p>"""
    version_name: NotRequired["aws_sdk_omics.types.version_name.VersionName"]
    """<p> The name of the annotation store version. </p>"""
    format_options: NotRequired["aws_sdk_omics.types.format_options.FormatOptions"]
...
def serialize_json(value: StartAnnotationImportRequest) -> dict:
    ...
    out["items"] = aws_sdk_omics.types.annotation_import_item_sources.serialize_json(
        value["items"]
    )
...
def deserialize_json(data: dict) -> StartAnnotationImportRequest:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_omics.types.annotation_import_item_sources.deserialize_json(
                data["items"]
            )
        )
    else:
