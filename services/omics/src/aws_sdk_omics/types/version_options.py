...
if TYPE_CHECKING:
    import aws_sdk_omics.types.tsv_version_options


class _VersionOptions_tsvVersionOptions(TypedDict):
    tsvVersionOptions: "aws_sdk_omics.types.tsv_version_options.TsvVersionOptions"
...
def serialize_json(value: VersionOptions) -> dict:
    if "tsvVersionOptions" in value:
        ...
        return {
            "tsvVersionOptions": aws_sdk_omics.types.tsv_version_options.serialize_json(
...
def deserialize_json(data: dict) -> VersionOptions:
    if "tsvVersionOptions" in data:
        ...
        return {
            "tsvVersionOptions": aws_sdk_omics.types.tsv_version_options.deserialize_json(
