...
class OmicsError(Exception):
    """Base class for all Omics service errors."""


class ServiceError(OmicsError):
...
class SerializationError(OmicsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(OmicsError):
...
class WaiterFailedError(OmicsError):
...
class WaiterTimeoutError(OmicsError):
